...
extension AwsJsonRpc1_0DataPlaneClientTypes.MetricDatum {

    static func write(value: AwsJsonRpc1_0DataPlaneClientTypes.MetricDatum?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["StatisticValues"].write(value.statisticValues, with: AwsJsonRpc1_0DataPlaneClientTypes.StatisticSet.write(value:to:))
