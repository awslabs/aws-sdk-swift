...
public struct PutObjectInput: Swift.Sendable {
    ...
    public var checksumAlgorithm: AwsJsonRpc1_0DataPlaneClientTypes.ChecksumAlgorithm?
    ...
    public init(
        ...
        checksumAlgorithm: AwsJsonRpc1_0DataPlaneClientTypes.ChecksumAlgorithm? = nil,
