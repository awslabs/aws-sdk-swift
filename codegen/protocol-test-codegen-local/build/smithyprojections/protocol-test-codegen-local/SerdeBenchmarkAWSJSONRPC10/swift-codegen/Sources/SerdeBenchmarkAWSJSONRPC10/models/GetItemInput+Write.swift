...
extension GetItemInput {
    ...
    static func write(value: GetItemInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Key"].writeMap(value.key, valueWritingClosure: AwsJsonRpc1_0DataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
