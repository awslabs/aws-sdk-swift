...
extension AwsJsonRpc1_0DataPlaneClientTypes.MetricDataResult {

    static func read(from reader: SmithyJSON.Reader) throws -> AwsJsonRpc1_0DataPlaneClientTypes.MetricDataResult {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = AwsJsonRpc1_0DataPlaneClientTypes.MetricDataResult()
