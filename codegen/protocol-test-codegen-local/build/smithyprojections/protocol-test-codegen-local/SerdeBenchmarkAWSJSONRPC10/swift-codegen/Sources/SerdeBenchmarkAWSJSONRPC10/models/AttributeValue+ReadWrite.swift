...
extension AwsJsonRpc1_0DataPlaneClientTypes.AttributeValue {

    static func write(value: AwsJsonRpc1_0DataPlaneClientTypes.AttributeValue?, to writer: SmithyJSON.Writer) throws {
        ...
        switch value {
            ...
            case let .l(l):
                try writer["L"].writeList(l, memberWritingClosure: AwsJsonRpc1_0DataPlaneClientTypes.AttributeValue.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .m(m):
                try writer["M"].writeMap(m, valueWritingClosure: AwsJsonRpc1_0DataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
            case let .n(n):
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AwsJsonRpc1_0DataPlaneClientTypes.AttributeValue {
        ...
        switch name {
            ...
            case "M":
                return .m(try reader["M"].readMap(valueReadingClosure: AwsJsonRpc1_0DataPlaneClientTypes.AttributeValue.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false))
            case "L":
                return .l(try reader["L"].readList(memberReadingClosure: AwsJsonRpc1_0DataPlaneClientTypes.AttributeValue.read(from:), memberNodeInfo: "member", isFlattened: false))
            case "NULL":
