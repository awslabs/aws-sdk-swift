...
extension HeadObjectOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> HeadObjectOutput {
        ...
        value.archiveStatus = try reader["ArchiveStatus"].readIfPresent()
        ...
        value.contentRange = try reader["ContentRange"].readIfPresent()
        ...
        value.objectLockRetainUntilDate = try reader["ObjectLockRetainUntilDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
