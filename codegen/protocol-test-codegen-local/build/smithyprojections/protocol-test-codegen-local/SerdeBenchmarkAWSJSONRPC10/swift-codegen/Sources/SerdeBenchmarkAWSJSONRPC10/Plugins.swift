...
public class AwsJsonRpc1_0DataPlaneClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: inout ClientRuntime.ClientConfiguration) async throws {
        if var config = clientConfiguration as? AwsJsonRpc1_0DataPlaneClient.AwsJsonRpc1_0DataPlaneClientConfig {
...
public class DefaultAWSAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public func configureClient(clientConfiguration: inout ClientRuntime.ClientConfiguration) async throws {
        if var config = clientConfiguration as? AwsJsonRpc1_0DataPlaneClient.AwsJsonRpc1_0DataPlaneClientConfig {
            config.authSchemeResolver = DefaultJsonRpc10DataPlaneAuthSchemeResolver()
...
public class AwsJsonRpc1_0DataPlaneClientAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public init(authSchemes: SmithyHTTPAuthAPI.AuthSchemes? = nil, authSchemePreference: [String]? = nil, authSchemeResolver: JsonRpc10DataPlaneAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentity.AWSCredentialIdentityResolver)? = nil, bearerTokenIdentityResolver: (any SmithyIdentity.BearerTokenIdentityResolver)? = nil) {
