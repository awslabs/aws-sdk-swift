...
extension PutItemInput {
    ...
    static func write(value: PutItemInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Expected"].writeMap(value.expected, valueWritingClosure: AwsJsonRpc1_0DataPlaneClientTypes.ExpectedAttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        ...
        try writer["ExpressionAttributeValues"].writeMap(value.expressionAttributeValues, valueWritingClosure: AwsJsonRpc1_0DataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Item"].writeMap(value.item, valueWritingClosure: AwsJsonRpc1_0DataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
