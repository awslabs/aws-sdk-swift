...
class GetItemRequestTest: HttpRequestTestBase {
    ...
    func testawsJson1_0_GetItemInput_Baseline() async throws {
        ...
        for i in 0..<20000 {
            do {
                _ = try await client.getItem(input: input)
        ...
        logSerdeBenchmarkResult(calculateAndFormatMetrics(from: measurements, testID: "awsJson1_0_GetItemInput_Baseline"))
    }
}
