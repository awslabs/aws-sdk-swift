...
public class AwsRestJsonDataPlaneClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: inout ClientRuntime.ClientConfiguration) async throws {
        if var config = clientConfiguration as? AwsRestJsonDataPlaneClient.AwsRestJsonDataPlaneClientConfig {
...
public class DefaultAWSAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public func configureClient(clientConfiguration: inout ClientRuntime.ClientConfiguration) async throws {
        if var config = clientConfiguration as? AwsRestJsonDataPlaneClient.AwsRestJsonDataPlaneClientConfig {
            config.authSchemeResolver = DefaultRestJsonDataPlaneAuthSchemeResolver()
...
public class AwsRestJsonDataPlaneClientAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public init(authSchemes: SmithyHTTPAuthAPI.AuthSchemes? = nil, authSchemePreference: [String]? = nil, authSchemeResolver: RestJsonDataPlaneAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentity.AWSCredentialIdentityResolver)? = nil, bearerTokenIdentityResolver: (any SmithyIdentity.BearerTokenIdentityResolver)? = nil) {
