...
extension GetItemInput {
    ...
    static func write(value: GetItemInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Key"].writeMap(value.key, valueWritingClosure: AwsRestJsonDataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
