...
public final class AwsRestJsonDataPlaneClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "AwsRestJsonDataPlaneClient"
    let client: ClientRuntime.SdkHttpClient
    let config: AwsRestJsonDataPlaneClient.AwsRestJsonDataPlaneClientConfig
    let serviceName = "AwsRestJsonDataPlane"

    @available(*, deprecated, message: "Use AwsRestJsonDataPlaneClient.AwsRestJsonDataPlaneClientConfig instead")
    public typealias Config = AwsRestJsonDataPlaneClient.AwsRestJsonDataPlaneClientConfiguration

    public required init(config: AwsRestJsonDataPlaneClient.AwsRestJsonDataPlaneClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: AwsRestJsonDataPlaneClient.AwsRestJsonDataPlaneClientConfig) instead")
    public convenience init(config: AwsRestJsonDataPlaneClient.AwsRestJsonDataPlaneClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try AwsRestJsonDataPlaneClient.AwsRestJsonDataPlaneClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await AwsRestJsonDataPlaneClient.AwsRestJsonDataPlaneClientConfig()
        self.init(config: config)
    }
}
...
extension AwsRestJsonDataPlaneClient {
    ...
    /// Client configuration for AwsRestJsonDataPlaneClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct AwsRestJsonDataPlaneClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultRestJsonDataPlaneAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: AwsRestJsonDataPlaneClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultRestJsonDataPlaneAuthSchemeResolver(),
        ...
        public var partitionID: String? {
            return "\(AwsRestJsonDataPlaneClient.clientName) - \(region ?? "")"
        }
    ...
    @available(*, deprecated, message: "Use AwsRestJsonDataPlaneClientConfig instead. This class will be removed in a future version.")
    public final class AwsRestJsonDataPlaneClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> AwsRestJsonDataPlaneClientConfig {
            return try AwsRestJsonDataPlaneClientConfig(
    ...
    public static func builder() -> ClientRuntime.ClientBuilder<AwsRestJsonDataPlaneClient> {
        return ClientRuntime.ClientBuilder<AwsRestJsonDataPlaneClient>(defaultPlugins: [
...
extension AwsRestJsonDataPlaneClient {
    /// Performs the `CopyObject` operation on the `AwsRestJsonDataPlane` service.
    ///
    ...
    public func copyObject(input: CopyObjectInput) async throws -> CopyObjectOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningName(value: "awsrestjsondataplane")
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CopyObjectInput, CopyObjectOutput>(serviceID: serviceName, version: AwsRestJsonDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsRestJsonDataPlane")
    ...
    /// Performs the `GetItem` operation on the `AwsRestJsonDataPlane` service.
    ///
    ...
    public func getItem(input: GetItemInput) async throws -> GetItemOutput {
        ...
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetItemInput, GetItemOutput>(contentType: "application/json"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetItemInput, GetItemOutput>(serviceID: serviceName, version: AwsRestJsonDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsRestJsonDataPlane")
    ...
    /// Performs the `GetMetricData` operation on the `AwsRestJsonDataPlane` service.
    ///
    ...
    public func getMetricData(input: GetMetricDataInput) async throws -> GetMetricDataOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetMetricDataInput, GetMetricDataOutput>(serviceID: serviceName, version: AwsRestJsonDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsRestJsonDataPlane")
    ...
    /// Performs the `GetObject` operation on the `AwsRestJsonDataPlane` service.
    ///
    ...
    public func getObject(input: GetObjectInput) async throws -> GetObjectOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetObjectInput, GetObjectOutput>(serviceID: serviceName, version: AwsRestJsonDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsRestJsonDataPlane")
    ...
    /// Performs the `HeadObject` operation on the `AwsRestJsonDataPlane` service.
    ///
    ...
    public func headObject(input: HeadObjectInput) async throws -> HeadObjectOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<HeadObjectInput, HeadObjectOutput>(serviceID: serviceName, version: AwsRestJsonDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsRestJsonDataPlane")
    ...
    /// Performs the `Healthcheck` operation on the `AwsRestJsonDataPlane` service.
    ///
    ...
    public func healthcheck(input: HealthcheckInput) async throws -> HealthcheckOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<HealthcheckInput, HealthcheckOutput>(serviceID: serviceName, version: AwsRestJsonDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsRestJsonDataPlane")
    ...
    /// Performs the `PutItem` operation on the `AwsRestJsonDataPlane` service.
    ///
    ...
    public func putItem(input: PutItemInput) async throws -> PutItemOutput {
        ...
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutItemInput, PutItemOutput>(contentType: "application/json"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutItemInput, PutItemOutput>(serviceID: serviceName, version: AwsRestJsonDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsRestJsonDataPlane")
    ...
    /// Performs the `PutMetricData` operation on the `AwsRestJsonDataPlane` service.
    ///
    /// As seen in Amazon CloudWatch.
    ///
    ...
    public func putMetricData(input: PutMetricDataInput) async throws -> PutMetricDataOutput {
        ...
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutMetricDataInput, PutMetricDataOutput>(contentType: "application/json"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutMetricDataInput, PutMetricDataOutput>(serviceID: serviceName, version: AwsRestJsonDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsRestJsonDataPlane")
    ...
    /// Performs the `PutObject` operation on the `AwsRestJsonDataPlane` service.
    ///
    /// As seen in Amazon S3. Object I/O is HTTP payload I/O, and is more of a function of network and checksum performance than serde. It is here because it's an important operation, for completeness.
    ///
    ...
    public func putObject(input: PutObjectInput) async throws -> PutObjectOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutObjectInput, PutObjectOutput>(serviceID: serviceName, version: AwsRestJsonDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsRestJsonDataPlane")
