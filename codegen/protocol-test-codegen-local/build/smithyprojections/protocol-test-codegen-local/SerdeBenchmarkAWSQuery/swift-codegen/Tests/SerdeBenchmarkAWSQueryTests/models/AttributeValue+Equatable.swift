...
extension AwsQueryDataPlaneClientTypes.AttributeValue: Swift.Equatable {

    public static func ==(lhs: AwsQueryDataPlaneClientTypes.AttributeValue, rhs: AwsQueryDataPlaneClientTypes.AttributeValue) -> Bool {
        switch (lhs, rhs) {
