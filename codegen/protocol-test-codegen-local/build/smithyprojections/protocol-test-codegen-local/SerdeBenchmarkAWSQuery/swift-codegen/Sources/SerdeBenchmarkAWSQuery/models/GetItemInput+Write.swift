...
extension GetItemInput {
    ...
    static func write(value: GetItemInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Key"].writeMap(value.key, valueWritingClosure: AwsQueryDataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        ...
        try writer["Action"].write("GetItem")
