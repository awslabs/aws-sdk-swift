...
public class AwsQueryDataPlaneClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: inout ClientRuntime.ClientConfiguration) async throws {
        if var config = clientConfiguration as? AwsQueryDataPlaneClient.AwsQueryDataPlaneClientConfig {
...
public class DefaultAWSAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public func configureClient(clientConfiguration: inout ClientRuntime.ClientConfiguration) async throws {
        if var config = clientConfiguration as? AwsQueryDataPlaneClient.AwsQueryDataPlaneClientConfig {
            config.authSchemeResolver = DefaultQueryDataPlaneAuthSchemeResolver()
...
public class AwsQueryDataPlaneClientAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public init(authSchemes: SmithyHTTPAuthAPI.AuthSchemes? = nil, authSchemePreference: [String]? = nil, authSchemeResolver: QueryDataPlaneAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentity.AWSCredentialIdentityResolver)? = nil, bearerTokenIdentityResolver: (any SmithyIdentity.BearerTokenIdentityResolver)? = nil) {
