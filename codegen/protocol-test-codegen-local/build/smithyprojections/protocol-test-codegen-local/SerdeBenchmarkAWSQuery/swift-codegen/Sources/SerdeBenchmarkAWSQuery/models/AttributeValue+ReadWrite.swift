...
extension AwsQueryDataPlaneClientTypes.AttributeValue {

    static func write(value: AwsQueryDataPlaneClientTypes.AttributeValue?, to writer: SmithyFormURL.Writer) throws {
        ...
        switch value {
            ...
            case let .l(l):
                try writer["L"].writeList(l, memberWritingClosure: AwsQueryDataPlaneClientTypes.AttributeValue.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .m(m):
                try writer["M"].writeMap(m, valueWritingClosure: AwsQueryDataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
            case let .n(n):
    ...
    static func read(from reader: SmithyXML.Reader) throws -> AwsQueryDataPlaneClientTypes.AttributeValue {
        ...
        switch name {
            ...
            case "M":
                return .m(try reader["M"].readMap(valueReadingClosure: AwsQueryDataPlaneClientTypes.AttributeValue.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false))
            case "L":
                return .l(try reader["L"].readList(memberReadingClosure: AwsQueryDataPlaneClientTypes.AttributeValue.read(from:), memberNodeInfo: "member", isFlattened: false))
            case "NULL":
