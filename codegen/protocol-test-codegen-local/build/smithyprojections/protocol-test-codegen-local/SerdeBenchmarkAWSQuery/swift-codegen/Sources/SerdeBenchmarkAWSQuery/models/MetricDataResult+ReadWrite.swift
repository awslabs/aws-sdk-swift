...
extension AwsQueryDataPlaneClientTypes.MetricDataResult {

    static func read(from reader: SmithyXML.Reader) throws -> AwsQueryDataPlaneClientTypes.MetricDataResult {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = AwsQueryDataPlaneClientTypes.MetricDataResult()
