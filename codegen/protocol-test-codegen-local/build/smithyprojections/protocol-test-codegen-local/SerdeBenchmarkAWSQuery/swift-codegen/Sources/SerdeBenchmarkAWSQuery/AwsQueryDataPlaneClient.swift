...
public final class AwsQueryDataPlaneClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "AwsQueryDataPlaneClient"
    let client: ClientRuntime.SdkHttpClient
    let config: AwsQueryDataPlaneClient.AwsQueryDataPlaneClientConfig
    let serviceName = "AwsQueryDataPlane"

    @available(*, deprecated, message: "Use AwsQueryDataPlaneClient.AwsQueryDataPlaneClientConfig instead")
    public typealias Config = AwsQueryDataPlaneClient.AwsQueryDataPlaneClientConfiguration

    public required init(config: AwsQueryDataPlaneClient.AwsQueryDataPlaneClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: AwsQueryDataPlaneClient.AwsQueryDataPlaneClientConfig) instead")
    public convenience init(config: AwsQueryDataPlaneClient.AwsQueryDataPlaneClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try AwsQueryDataPlaneClient.AwsQueryDataPlaneClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await AwsQueryDataPlaneClient.AwsQueryDataPlaneClientConfig()
        self.init(config: config)
    }
}

extension AwsQueryDataPlaneClient {

    /// Client configuration for AwsQueryDataPlaneClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct AwsQueryDataPlaneClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultQueryDataPlaneAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: AwsQueryDataPlaneClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultQueryDataPlaneAuthSchemeResolver(),
        ...
        public var partitionID: String? {
            return "\(AwsQueryDataPlaneClient.clientName) - \(region ?? "")"
        }
    ...
    @available(*, deprecated, message: "Use AwsQueryDataPlaneClientConfig instead. This class will be removed in a future version.")
    public final class AwsQueryDataPlaneClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> AwsQueryDataPlaneClientConfig {
            return try AwsQueryDataPlaneClientConfig(
    ...
    public static func builder() -> ClientRuntime.ClientBuilder<AwsQueryDataPlaneClient> {
        return ClientRuntime.ClientBuilder<AwsQueryDataPlaneClient>(defaultPlugins: [
...
extension AwsQueryDataPlaneClient {
    /// Performs the `CopyObject` operation on the `AwsQueryDataPlane` service.
    ///
    ...
    public func copyObject(input: CopyObjectInput) async throws -> CopyObjectOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningName(value: "awsquerydataplane")
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<CopyObjectInput, CopyObjectOutput, SmithyFormURL.Writer>(rootNodeInfo: "", inputWritingClosure: CopyObjectInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<CopyObjectInput, CopyObjectOutput>(contentType: "application/x-www-form-urlencoded"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CopyObjectInput, CopyObjectOutput>(serviceID: serviceName, version: AwsQueryDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsQueryDataPlane")
    ...
    /// Performs the `GetItem` operation on the `AwsQueryDataPlane` service.
    ///
    ...
    public func getItem(input: GetItemInput) async throws -> GetItemOutput {
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<GetItemInput, GetItemOutput, SmithyFormURL.Writer>(rootNodeInfo: "", inputWritingClosure: GetItemInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetItemInput, GetItemOutput>(contentType: "application/x-www-form-urlencoded"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetItemInput, GetItemOutput>(serviceID: serviceName, version: AwsQueryDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsQueryDataPlane")
    ...
    /// Performs the `GetMetricData` operation on the `AwsQueryDataPlane` service.
    ///
    ...
    public func getMetricData(input: GetMetricDataInput) async throws -> GetMetricDataOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetMetricDataInput, GetMetricDataOutput>(serviceID: serviceName, version: AwsQueryDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsQueryDataPlane")
    ...
    /// Performs the `GetObject` operation on the `AwsQueryDataPlane` service.
    ///
    ...
    public func getObject(input: GetObjectInput) async throws -> GetObjectOutput {
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<GetObjectInput, GetObjectOutput, SmithyFormURL.Writer>(rootNodeInfo: "", inputWritingClosure: GetObjectInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetObjectInput, GetObjectOutput>(contentType: "application/x-www-form-urlencoded"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetObjectInput, GetObjectOutput>(serviceID: serviceName, version: AwsQueryDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsQueryDataPlane")
    ...
    /// Performs the `HeadObject` operation on the `AwsQueryDataPlane` service.
    ///
    ...
    public func headObject(input: HeadObjectInput) async throws -> HeadObjectOutput {
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<HeadObjectInput, HeadObjectOutput, SmithyFormURL.Writer>(rootNodeInfo: "", inputWritingClosure: HeadObjectInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<HeadObjectInput, HeadObjectOutput>(contentType: "application/x-www-form-urlencoded"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<HeadObjectInput, HeadObjectOutput>(serviceID: serviceName, version: AwsQueryDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsQueryDataPlane")
    ...
    /// Performs the `Healthcheck` operation on the `AwsQueryDataPlane` service.
    ///
    ...
    public func healthcheck(input: HealthcheckInput) async throws -> HealthcheckOutput {
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<HealthcheckInput, HealthcheckOutput, SmithyFormURL.Writer>(rootNodeInfo: "", inputWritingClosure: HealthcheckInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<HealthcheckInput, HealthcheckOutput>(contentType: "application/x-www-form-urlencoded"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<HealthcheckInput, HealthcheckOutput>(serviceID: serviceName, version: AwsQueryDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsQueryDataPlane")
    ...
    /// Performs the `PutItem` operation on the `AwsQueryDataPlane` service.
    ///
    ...
    public func putItem(input: PutItemInput) async throws -> PutItemOutput {
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<PutItemInput, PutItemOutput, SmithyFormURL.Writer>(rootNodeInfo: "", inputWritingClosure: PutItemInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutItemInput, PutItemOutput>(contentType: "application/x-www-form-urlencoded"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutItemInput, PutItemOutput>(serviceID: serviceName, version: AwsQueryDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsQueryDataPlane")
    ...
    /// Performs the `PutMetricData` operation on the `AwsQueryDataPlane` service.
    ///
    /// As seen in Amazon CloudWatch.
    ///
    ...
    public func putMetricData(input: PutMetricDataInput) async throws -> PutMetricDataOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutMetricDataInput, PutMetricDataOutput>(serviceID: serviceName, version: AwsQueryDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsQueryDataPlane")
    ...
    /// Performs the `PutObject` operation on the `AwsQueryDataPlane` service.
    ///
    /// As seen in Amazon S3. Object I/O is HTTP payload I/O, and is more of a function of network and checksum performance than serde. It is here because it's an important operation, for completeness.
    ///
    ...
    public func putObject(input: PutObjectInput) async throws -> PutObjectOutput {
        ...
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutObjectInput, PutObjectOutput>(contentType: "application/x-www-form-urlencoded"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutObjectInput, PutObjectOutput>(serviceID: serviceName, version: AwsQueryDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AwsQueryDataPlane")
