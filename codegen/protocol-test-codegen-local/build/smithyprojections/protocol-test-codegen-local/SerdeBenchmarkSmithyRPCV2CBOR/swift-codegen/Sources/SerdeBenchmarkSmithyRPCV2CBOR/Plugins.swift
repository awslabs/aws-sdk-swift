...
public class SmithyRpcV2CborDataPlaneClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: inout ClientRuntime.ClientConfiguration) async throws {
        if var config = clientConfiguration as? SmithyRpcV2CborDataPlaneClient.SmithyRpcV2CborDataPlaneClientConfig {
...
public class DefaultAWSAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public func configureClient(clientConfiguration: inout ClientRuntime.ClientConfiguration) async throws {
        if var config = clientConfiguration as? SmithyRpcV2CborDataPlaneClient.SmithyRpcV2CborDataPlaneClientConfig {
            config.authSchemeResolver = DefaultRpcCborDataPlaneAuthSchemeResolver()
...
public class SmithyRpcV2CborDataPlaneClientAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public init(authSchemes: SmithyHTTPAuthAPI.AuthSchemes? = nil, authSchemePreference: [String]? = nil, authSchemeResolver: RpcCborDataPlaneAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentity.AWSCredentialIdentityResolver)? = nil, bearerTokenIdentityResolver: (any SmithyIdentity.BearerTokenIdentityResolver)? = nil) {
