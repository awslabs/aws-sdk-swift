...
extension SmithyRpcV2CborDataPlaneClientTypes.AttributeValue {

    static func write(value: SmithyRpcV2CborDataPlaneClientTypes.AttributeValue?, to writer: SmithyCBOR.Writer) throws {
        ...
        switch value {
            ...
            case let .l(l):
                try writer["L"].writeList(l, memberWritingClosure: SmithyRpcV2CborDataPlaneClientTypes.AttributeValue.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .m(m):
                try writer["M"].writeMap(m, valueWritingClosure: SmithyRpcV2CborDataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
            case let .n(n):
    ...
    static func read(from reader: SmithyCBOR.Reader) throws -> SmithyRpcV2CborDataPlaneClientTypes.AttributeValue {
        ...
        switch name {
            ...
            case "M":
                return .m(try reader["M"].readMap(valueReadingClosure: SmithyRpcV2CborDataPlaneClientTypes.AttributeValue.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false))
            case "L":
                return .l(try reader["L"].readList(memberReadingClosure: SmithyRpcV2CborDataPlaneClientTypes.AttributeValue.read(from:), memberNodeInfo: "member", isFlattened: false))
            case "NULL":
