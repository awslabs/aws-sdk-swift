...
extension GetItemInput {
    ...
    static func write(value: GetItemInput?, to writer: SmithyCBOR.Writer) throws {
        ...
        try writer["Key"].writeMap(value.key, valueWritingClosure: SmithyRpcV2CborDataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
