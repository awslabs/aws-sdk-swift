...
extension SmithyRpcV2CborDataPlaneClientTypes.MetricDatum {

    static func write(value: SmithyRpcV2CborDataPlaneClientTypes.MetricDatum?, to writer: SmithyCBOR.Writer) throws {
        ...
        try writer["StatisticValues"].write(value.statisticValues, with: SmithyRpcV2CborDataPlaneClientTypes.StatisticSet.write(value:to:))
