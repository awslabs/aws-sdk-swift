...
public struct PutObjectInput: Swift.Sendable {
    ...
    public var checksumAlgorithm: SmithyRpcV2CborDataPlaneClientTypes.ChecksumAlgorithm?
    ...
    public init(
        ...
        checksumAlgorithm: SmithyRpcV2CborDataPlaneClientTypes.ChecksumAlgorithm? = nil,
