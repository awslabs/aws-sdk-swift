...
public final class SmithyRpcV2CborDataPlaneClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "SmithyRpcV2CborDataPlaneClient"
    let client: ClientRuntime.SdkHttpClient
    let config: SmithyRpcV2CborDataPlaneClient.SmithyRpcV2CborDataPlaneClientConfig
    let serviceName = "SmithyRpcV2CborDataPlane"

    @available(*, deprecated, message: "Use SmithyRpcV2CborDataPlaneClient.SmithyRpcV2CborDataPlaneClientConfig instead")
    public typealias Config = SmithyRpcV2CborDataPlaneClient.SmithyRpcV2CborDataPlaneClientConfiguration

    public required init(config: SmithyRpcV2CborDataPlaneClient.SmithyRpcV2CborDataPlaneClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: SmithyRpcV2CborDataPlaneClient.SmithyRpcV2CborDataPlaneClientConfig) instead")
    public convenience init(config: SmithyRpcV2CborDataPlaneClient.SmithyRpcV2CborDataPlaneClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try SmithyRpcV2CborDataPlaneClient.SmithyRpcV2CborDataPlaneClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await SmithyRpcV2CborDataPlaneClient.SmithyRpcV2CborDataPlaneClientConfig()
        self.init(config: config)
    }
}
...
extension SmithyRpcV2CborDataPlaneClient {
    ...
    /// Client configuration for SmithyRpcV2CborDataPlaneClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct SmithyRpcV2CborDataPlaneClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultRpcCborDataPlaneAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: SmithyRpcV2CborDataPlaneClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultRpcCborDataPlaneAuthSchemeResolver(),
        ...
        public var partitionID: String? {
            return "\(SmithyRpcV2CborDataPlaneClient.clientName) - \(region ?? "")"
        }
    ...
    @available(*, deprecated, message: "Use SmithyRpcV2CborDataPlaneClientConfig instead. This class will be removed in a future version.")
    public final class SmithyRpcV2CborDataPlaneClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> SmithyRpcV2CborDataPlaneClientConfig {
            return try SmithyRpcV2CborDataPlaneClientConfig(
    ...
    public static func builder() -> ClientRuntime.ClientBuilder<SmithyRpcV2CborDataPlaneClient> {
        return ClientRuntime.ClientBuilder<SmithyRpcV2CborDataPlaneClient>(defaultPlugins: [
...
extension SmithyRpcV2CborDataPlaneClient {
    /// Performs the `CopyObject` operation on the `SmithyRpcV2CborDataPlane` service.
    ///
    ...
    public func copyObject(input: CopyObjectInput) async throws -> CopyObjectOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningName(value: "smithyrpcv2cbordataplane")
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<CopyObjectInput, CopyObjectOutput, SmithyCBOR.Writer>(rootNodeInfo: "", inputWritingClosure: CopyObjectInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CopyObjectInput, CopyObjectOutput>(overrides: ["smithy-protocol": "rpc-v2-cbor", "Accept": "application/cbor"]))
        builder.interceptors.add(ClientRuntime.CborValidateResponseHeaderMiddleware<CopyObjectInput, CopyObjectOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<CopyObjectInput, CopyObjectOutput>(contentType: "application/cbor"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<CopyObjectInput, CopyObjectOutput>())
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CopyObjectInput, CopyObjectOutput>(serviceID: serviceName, version: SmithyRpcV2CborDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SmithyRpcV2CborDataPlane")
    ...
    /// Performs the `GetItem` operation on the `SmithyRpcV2CborDataPlane` service.
    ///
    ...
    public func getItem(input: GetItemInput) async throws -> GetItemOutput {
        ...
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetItemInput, GetItemOutput>(contentType: "application/cbor"))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<GetItemInput, GetItemOutput, SmithyCBOR.Writer>(rootNodeInfo: "", inputWritingClosure: GetItemInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetItemInput, GetItemOutput>(overrides: ["smithy-protocol": "rpc-v2-cbor", "Accept": "application/cbor"]))
        builder.interceptors.add(ClientRuntime.CborValidateResponseHeaderMiddleware<GetItemInput, GetItemOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetItemInput, GetItemOutput>(contentType: "application/cbor"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetItemInput, GetItemOutput>())
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetItemInput, GetItemOutput>(serviceID: serviceName, version: SmithyRpcV2CborDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SmithyRpcV2CborDataPlane")
    ...
    /// Performs the `GetMetricData` operation on the `SmithyRpcV2CborDataPlane` service.
    ///
    ...
    public func getMetricData(input: GetMetricDataInput) async throws -> GetMetricDataOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetMetricDataInput, GetMetricDataOutput>(serviceID: serviceName, version: SmithyRpcV2CborDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SmithyRpcV2CborDataPlane")
    ...
    /// Performs the `GetObject` operation on the `SmithyRpcV2CborDataPlane` service.
    ///
    ...
    public func getObject(input: GetObjectInput) async throws -> GetObjectOutput {
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<GetObjectInput, GetObjectOutput, SmithyCBOR.Writer>(rootNodeInfo: "", inputWritingClosure: GetObjectInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetObjectInput, GetObjectOutput>(overrides: ["smithy-protocol": "rpc-v2-cbor", "Accept": "application/cbor"]))
        builder.interceptors.add(ClientRuntime.CborValidateResponseHeaderMiddleware<GetObjectInput, GetObjectOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetObjectInput, GetObjectOutput>(contentType: "application/cbor"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetObjectInput, GetObjectOutput>())
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetObjectInput, GetObjectOutput>(serviceID: serviceName, version: SmithyRpcV2CborDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SmithyRpcV2CborDataPlane")
    ...
    /// Performs the `HeadObject` operation on the `SmithyRpcV2CborDataPlane` service.
    ///
    ...
    public func headObject(input: HeadObjectInput) async throws -> HeadObjectOutput {
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<HeadObjectInput, HeadObjectOutput, SmithyCBOR.Writer>(rootNodeInfo: "", inputWritingClosure: HeadObjectInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<HeadObjectInput, HeadObjectOutput>(overrides: ["smithy-protocol": "rpc-v2-cbor", "Accept": "application/cbor"]))
        builder.interceptors.add(ClientRuntime.CborValidateResponseHeaderMiddleware<HeadObjectInput, HeadObjectOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<HeadObjectInput, HeadObjectOutput>(contentType: "application/cbor"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<HeadObjectInput, HeadObjectOutput>())
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<HeadObjectInput, HeadObjectOutput>(serviceID: serviceName, version: SmithyRpcV2CborDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SmithyRpcV2CborDataPlane")
    ...
    /// Performs the `Healthcheck` operation on the `SmithyRpcV2CborDataPlane` service.
    ///
    ...
    public func healthcheck(input: HealthcheckInput) async throws -> HealthcheckOutput {
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<HealthcheckInput, HealthcheckOutput, SmithyCBOR.Writer>(rootNodeInfo: "", inputWritingClosure: HealthcheckInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<HealthcheckInput, HealthcheckOutput>(overrides: ["smithy-protocol": "rpc-v2-cbor", "Accept": "application/cbor"]))
        builder.interceptors.add(ClientRuntime.CborValidateResponseHeaderMiddleware<HealthcheckInput, HealthcheckOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<HealthcheckInput, HealthcheckOutput>())
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<HealthcheckInput, HealthcheckOutput>(serviceID: serviceName, version: SmithyRpcV2CborDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SmithyRpcV2CborDataPlane")
    ...
    /// Performs the `PutItem` operation on the `SmithyRpcV2CborDataPlane` service.
    ///
    ...
    public func putItem(input: PutItemInput) async throws -> PutItemOutput {
        ...
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutItemInput, PutItemOutput>(contentType: "application/cbor"))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<PutItemInput, PutItemOutput, SmithyCBOR.Writer>(rootNodeInfo: "", inputWritingClosure: PutItemInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutItemInput, PutItemOutput>(overrides: ["smithy-protocol": "rpc-v2-cbor", "Accept": "application/cbor"]))
        builder.interceptors.add(ClientRuntime.CborValidateResponseHeaderMiddleware<PutItemInput, PutItemOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutItemInput, PutItemOutput>(contentType: "application/cbor"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<PutItemInput, PutItemOutput>())
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutItemInput, PutItemOutput>(serviceID: serviceName, version: SmithyRpcV2CborDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SmithyRpcV2CborDataPlane")
    ...
    /// Performs the `PutMetricData` operation on the `SmithyRpcV2CborDataPlane` service.
    ///
    /// As seen in Amazon CloudWatch.
    ///
    ...
    public func putMetricData(input: PutMetricDataInput) async throws -> PutMetricDataOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutMetricDataInput, PutMetricDataOutput>(serviceID: serviceName, version: SmithyRpcV2CborDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SmithyRpcV2CborDataPlane")
    ...
    /// Performs the `PutObject` operation on the `SmithyRpcV2CborDataPlane` service.
    ///
    /// As seen in Amazon S3. Object I/O is HTTP payload I/O, and is more of a function of network and checksum performance than serde. It is here because it's an important operation, for completeness.
    ///
    ...
    public func putObject(input: PutObjectInput) async throws -> PutObjectOutput {
        ...
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutObjectInput, PutObjectOutput>(contentType: "application/cbor"))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<PutObjectInput, PutObjectOutput, SmithyCBOR.Writer>(rootNodeInfo: "", inputWritingClosure: PutObjectInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutObjectInput, PutObjectOutput>(overrides: ["smithy-protocol": "rpc-v2-cbor", "Accept": "application/cbor"]))
        builder.interceptors.add(ClientRuntime.CborValidateResponseHeaderMiddleware<PutObjectInput, PutObjectOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutObjectInput, PutObjectOutput>(contentType: "application/cbor"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<PutObjectInput, PutObjectOutput>())
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutObjectInput, PutObjectOutput>(serviceID: serviceName, version: SmithyRpcV2CborDataPlaneClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SmithyRpcV2CborDataPlane")
