...
import Foundation
@testable import SerdeBenchmarkAWSRestXML
import Smithy
...
class CopyObjectRequestTest: HttpRequestTestBase {
    ...
    ///
    func testrestXml_CopyObjectRequest_Baseline() async throws {
        ...
        var config = try await AwsRestXmlDataPlaneClient.AwsRestXmlDataPlaneClientConfig(
        ...
        let client = AwsRestXmlDataPlaneClient(config: config)
        ...
        logSerdeBenchmarkResult(calculateAndFormatMetrics(from: measurements, testID: "restXml_CopyObjectRequest_Baseline"))
    }
    /// Serialization of a large set of headers.
    func testrestXml_CopyObjectRequest_M() async throws {
        let expected = buildExpectedHttpRequest(
            method: .put,
        ...
        logSerdeBenchmarkResult(calculateAndFormatMetrics(from: measurements, testID: "restXml_CopyObjectRequest_M"))
    }
}
