...
extension AwsRestXmlDataPlaneClientTypes.AttributeValue: Swift.Equatable {

    public static func ==(lhs: AwsRestXmlDataPlaneClientTypes.AttributeValue, rhs: AwsRestXmlDataPlaneClientTypes.AttributeValue) -> Bool {
        switch (lhs, rhs) {
