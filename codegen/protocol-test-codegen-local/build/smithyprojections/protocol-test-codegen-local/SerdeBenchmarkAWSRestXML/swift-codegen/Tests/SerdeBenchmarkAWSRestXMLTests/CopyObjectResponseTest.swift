...
class CopyObjectResponseTest: HttpResponseTestBase {
    ...
    ///
    func testrestXml_CopyObjectOutput_Baseline() async throws {
        ...
        logSerdeBenchmarkResult(calculateAndFormatMetrics(from: measurements, testID: "restXml_CopyObjectOutput_Baseline"))
    ...
    func testrestXml_CopyObjectOutput_M() async throws {
        guard let httpResponse = buildHttpResponse(
            code: 200,
            headers: [
        ...
        logSerdeBenchmarkResult(calculateAndFormatMetrics(from: measurements, testID: "restXml_CopyObjectOutput_M"))
