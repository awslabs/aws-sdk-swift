...
extension PutItemInput {
    ...
    static func write(value: PutItemInput?, to writer: SmithyXML.Writer) throws {
        ...
        try writer["Expected"].writeMap(value.expected, valueWritingClosure: AwsRestXmlDataPlaneClientTypes.ExpectedAttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        ...
        try writer["ExpressionAttributeValues"].writeMap(value.expressionAttributeValues, valueWritingClosure: AwsRestXmlDataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Item"].writeMap(value.item, valueWritingClosure: AwsRestXmlDataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
