...
public class AwsRestXmlDataPlaneClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: inout ClientRuntime.ClientConfiguration) async throws {
        if var config = clientConfiguration as? AwsRestXmlDataPlaneClient.AwsRestXmlDataPlaneClientConfig {
...
public class DefaultAWSAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public func configureClient(clientConfiguration: inout ClientRuntime.ClientConfiguration) async throws {
        if var config = clientConfiguration as? AwsRestXmlDataPlaneClient.AwsRestXmlDataPlaneClientConfig {
            config.authSchemeResolver = DefaultRestXmlDataPlaneAuthSchemeResolver()
...
public class AwsRestXmlDataPlaneClientAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public init(authSchemes: SmithyHTTPAuthAPI.AuthSchemes? = nil, authSchemePreference: [String]? = nil, authSchemeResolver: RestXmlDataPlaneAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentity.AWSCredentialIdentityResolver)? = nil, bearerTokenIdentityResolver: (any SmithyIdentity.BearerTokenIdentityResolver)? = nil) {
