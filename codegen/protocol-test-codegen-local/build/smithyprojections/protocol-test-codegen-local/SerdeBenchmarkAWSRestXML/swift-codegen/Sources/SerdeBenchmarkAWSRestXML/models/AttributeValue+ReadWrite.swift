...
extension AwsRestXmlDataPlaneClientTypes.AttributeValue {

    static func write(value: AwsRestXmlDataPlaneClientTypes.AttributeValue?, to writer: SmithyXML.Writer) throws {
        ...
        switch value {
            ...
            case let .l(l):
                try writer["L"].writeList(l, memberWritingClosure: AwsRestXmlDataPlaneClientTypes.AttributeValue.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .m(m):
                try writer["M"].writeMap(m, valueWritingClosure: AwsRestXmlDataPlaneClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
            case let .n(n):
    ...
    static func read(from reader: SmithyXML.Reader) throws -> AwsRestXmlDataPlaneClientTypes.AttributeValue {
        ...
        switch name {
            ...
            case "M":
                return .m(try reader["M"].readMap(valueReadingClosure: AwsRestXmlDataPlaneClientTypes.AttributeValue.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false))
            case "L":
                return .l(try reader["L"].readList(memberReadingClosure: AwsRestXmlDataPlaneClientTypes.AttributeValue.read(from:), memberNodeInfo: "member", isFlattened: false))
            case "NULL":
