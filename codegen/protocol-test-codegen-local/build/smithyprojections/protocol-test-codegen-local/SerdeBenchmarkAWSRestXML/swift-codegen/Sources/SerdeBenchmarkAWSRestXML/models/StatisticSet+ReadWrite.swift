...
extension AwsRestXmlDataPlaneClientTypes.StatisticSet {

    static func write(value: AwsRestXmlDataPlaneClientTypes.StatisticSet?, to writer: SmithyXML.Writer) throws {
