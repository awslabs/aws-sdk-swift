...
class TestUtils {
    companion object {
         ...
         */
        fun executeDirectedCodegen(
            modelFile: String,
            serviceShapeIdWithNamespace: String,
            protocol: ShapeId,
        ): TestContext {
            val manifest = MockManifest()
            ...
            val service =
                model
                    .getShape(ShapeId.from(serviceShapeIdWithNamespace))
                    .get()
                    .asServiceShape()
                    .get()
        ...
        fun getSmithyResource(smithyTestResourceName: String): URL? =
            TestUtils::class.java.classLoader.getResource("software.amazon.smithy.aws.swift.codegen/$smithyTestResourceName")
        ...
        fun getClientFileContents(
            namespace: String,
            filename: String,
            manifest: MockManifest,
        ): String = getFileContents(manifest, "$namespace/$filename")
 ...
 */
fun String.toSmithyModel(
    sourceLocation: String? = null,
    serviceShapeId: String? = null,
): Model {
...
): TestContext = newTestContext(MockManifest(), serviceShapeId, generator)
