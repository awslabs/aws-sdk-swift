...
stack.serializeStep.intercept(position: .before, middleware: AWSJSONRuntime.XAmzTargetMiddleware<TestInputShapeName, TestOutputShapeName, ExampleOperationOutputError>(xAmzTarget: "ExampleServiceShapeName.ExampleOperation"))
"""
