...
stack.initializeStep.intercept(position: .before, id: "GlacierAccountIdAutoFill") { (context, input, next) -> Swift.Result<Runtime.OperationOutput<TestOutputShapeName>, Runtime.SdkError<ExampleOperationOutputError>> in
