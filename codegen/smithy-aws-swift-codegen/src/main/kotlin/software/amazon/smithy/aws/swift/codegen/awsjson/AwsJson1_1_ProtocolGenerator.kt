...
import software.amazon.smithy.aws.swift.codegen.AWSErrorFromHttpAwsJSONResponseGenerator
...
class AwsJson1_1_ProtocolGenerator : AWSHttpBindingProtocolGenerator() {
    ...
    override val errorFromHttpResponseGenerator: ErrorFromHttpResponseGenerator = AWSErrorFromHttpAwsJSONResponseGenerator()
