...
class HeadObjectNotFoundTest: HttpResponseTestBase {
    ...
    func testHeadObjectEmptyBody() async throws {
        do {
            ...
            let headObjectOutputError = try HeadObjectOutputError(httpResponse: httpResponse)

            if case .notFound(let actual) = headObjectOutputError {
