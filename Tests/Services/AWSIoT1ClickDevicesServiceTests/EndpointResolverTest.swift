...
class EndpointResolverTest: CrtXCBaseTestCase {
    ...
    func testResolve1() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://devices.iot1click-fips.us-west-2.api.aws", headers: headers, properties: properties)
    ...
    func testResolve2() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://devices.iot1click-fips.us-west-2.amazonaws.com", headers: headers, properties: properties)
    ...
    func testResolve3() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://devices.iot1click.us-west-2.api.aws", headers: headers, properties: properties)
    ...
    func testResolve4() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://devices.iot1click.us-west-2.amazonaws.com", headers: headers, properties: properties)
