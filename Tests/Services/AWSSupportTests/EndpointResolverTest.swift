...
class EndpointResolverTest: CrtXCBaseTestCase {
    ...
    func testResolve4() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://support-fips.us-gov-west-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve6() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://support.us-gov-west-1.api.aws", headers: headers, properties: properties)
