...
class EndpointResolverTest: CrtXCBaseTestCase {
    ...
    func testResolve1() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://honeycode-fips.us-west-2.api.aws", headers: headers, properties: properties)
    ...
    func testResolve2() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://honeycode-fips.us-west-2.amazonaws.com", headers: headers, properties: properties)
    ...
    func testResolve3() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://honeycode.us-west-2.api.aws", headers: headers, properties: properties)
