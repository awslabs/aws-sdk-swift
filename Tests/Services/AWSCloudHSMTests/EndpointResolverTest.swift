...
class EndpointResolverTest: CrtXCBaseTestCase {
    ...
    func testResolve1() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://cloudhsm-fips.us-gov-west-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve2() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://cloudhsm-fips.us-gov-west-1.amazonaws.com", headers: headers, properties: properties)
    ...
    func testResolve3() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://cloudhsm.us-gov-west-1.api.aws", headers: headers, properties: properties)
