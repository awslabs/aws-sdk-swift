...
class EndpointResolverTest: CrtXCBaseTestCase {
    ...
    func testResolve2() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://health-fips.us-gov-west-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve3() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://health-fips.us-gov-west-1.amazonaws.com", headers: headers, properties: properties)
    ...
    func testResolve4() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://health.us-gov-west-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve5() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://health.us-gov-west-1.amazonaws.com", headers: headers, properties: properties)
