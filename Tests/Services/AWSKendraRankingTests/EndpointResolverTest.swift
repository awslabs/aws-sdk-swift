...
class EndpointResolverTest: CrtXCBaseTestCase {
    ...
    func testResolve3() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://kendra-ranking-fips.cn-north-1.api.amazonwebservices.com.cn", headers: headers, properties: properties)
    ...
    func testResolve4() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://kendra-ranking.cn-north-1.api.amazonwebservices.com.cn", headers: headers, properties: properties)
    ...
    func testResolve5() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://kendra-ranking-fips.us-gov-east-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve6() throws {
        ...
        let headers = Headers()
        let expected = try ClientRuntime.Endpoint(urlString: "https://kendra-ranking.us-gov-east-1.api.aws", headers: headers, properties: properties)
