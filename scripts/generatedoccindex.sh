...
BASEURL=$(echo $VERSION | sed 's/^\///' | sed 's/\/$//')
sed -i '' "s#{{BASEURL}}#$BASEURL#g" docs/$VERSION/awssdkswift/documentation/awssdkswift/index.html
sed -i '' "s#{{BASEURL}}#$BASEURL#g" docs/$VERSION/awssdkswift/index.html
