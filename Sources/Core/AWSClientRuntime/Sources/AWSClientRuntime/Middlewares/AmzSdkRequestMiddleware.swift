...
public class AmzSdkRequestMiddleware<InputType, OperationStackOutput> {
    ...
    private func addHeader(builder: SdkHttpRequestBuilder, context: Context) {
        self.attempt += 1
...
extension AmzSdkRequestMiddleware: HttpInterceptor {
    ...
    public func modifyBeforeSigning(context: some MutableRequest<InputType, SdkHttpRequest>) async throws {
