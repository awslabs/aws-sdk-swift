...
let validMessageWithAllHeaders = Message(
    headers: [
...
let validMessageEmptyPayload = Message(
    headers: [
...
let validMessageNoHeaders = Message(
...
let validInitialResponseMessage: Message = Message(
    headers: [
