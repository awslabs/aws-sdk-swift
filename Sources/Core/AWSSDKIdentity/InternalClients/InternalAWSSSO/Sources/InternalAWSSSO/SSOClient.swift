...
package final class SSOClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "SSOClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: SSOClient.SSOClientConfig
    let serviceName = "SSO"

    @available(*, deprecated, message: "Use SSOClient.SSOClientConfig instead")
    public typealias Config = SSOClient.SSOClientConfiguration
    public typealias Configuration = SSOClient.SSOClientConfig

    public required init(config: SSOClient.SSOClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: SSOClient.SSOClientConfig) instead")
    public convenience init(config: SSOClient.SSOClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try SSOClient.SSOClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await SSOClient.SSOClientConfig()
        self.init(config: config)
    }
}
...
extension SSOClient {
    ...
    /// Client configuration for SSOClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct SSOClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "SSO")
    ...
    @available(*, deprecated, message: "Use SSOClientConfig instead. This class will be removed in a future version.")
    public final class SSOClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> SSOClientConfig {
            return try SSOClientConfig(
