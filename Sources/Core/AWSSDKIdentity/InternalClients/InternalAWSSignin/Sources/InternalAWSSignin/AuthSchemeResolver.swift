...
package struct SigninAuthSchemeResolverParameters: SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
...
package protocol SigninAuthSchemeResolver: SmithyHTTPAuthAPI.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service Signin must conform to.
}

package struct DefaultSigninAuthSchemeResolver: SigninAuthSchemeResolver {
