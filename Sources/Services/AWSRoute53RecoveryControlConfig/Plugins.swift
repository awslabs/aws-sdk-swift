...
public class Route53RecoveryControlConfigClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? Route53RecoveryControlConfigClient.Route53RecoveryControlConfigClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? Route53RecoveryControlConfigClient.Route53RecoveryControlConfigClientConfiguration {
            config.authSchemeResolver = DefaultRoute53RecoveryControlConfigAuthSchemeResolver()
...
public class Route53RecoveryControlConfigClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: Route53RecoveryControlConfigAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
