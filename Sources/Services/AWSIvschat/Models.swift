...
extension CreateChatTokenInput {
    ...
    static func write(value: CreateChatTokenInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["capabilities"].writeList(value.capabilities, memberWritingClosure: IvschatClientTypes.ChatTokenCapability.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateRoomOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateRoomOutput {
        ...
        value.createTime = try reader["createTime"].readTimestampIfPresent(format: .dateTime)
        value.id = try reader["id"].readIfPresent()
        value.loggingConfigurationIdentifiers = try reader["loggingConfigurationIdentifiers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
