...
extension IvschatClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> IvschatClient.IvschatClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> IvschatClient {
            let configuration = try await resolve(plugins: self.plugins)
            return IvschatClient(config: configuration)
        }
    }
...
extension IvschatClient.IvschatClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
