...
extension CreateGrantInput {
    ...
    static func write(value: CreateGrantInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["GrantTokens"].writeList(value.grantTokens, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DecryptInput {
    ...
    static func write(value: DecryptInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["EncryptionContext"].writeMap(value.encryptionContext, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["GrantTokens"].writeList(value.grantTokens, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["KeyId"].write(value.keyId)
...
extension GetKeyRotationStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetKeyRotationStatusOutput {
        ...
        value.onDemandRotationStartDate = try reader["OnDemandRotationStartDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension GetParametersForImportOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetParametersForImportOutput {
        ...
        value.keyId = try reader["KeyId"].readIfPresent()
        value.parametersValidTo = try reader["ParametersValidTo"].readTimestampIfPresent(format: .epochSeconds)
        value.publicKey = try reader["PublicKey"].readIfPresent()
        return value
    }
}
...
extension GetPublicKeyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetPublicKeyOutput {
        ...
        value.encryptionAlgorithms = try reader["EncryptionAlgorithms"].readListIfPresent(memberReadingClosure: KMSClientTypes.EncryptionAlgorithmSpec.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.keyId = try reader["KeyId"].readIfPresent()
        value.keySpec = try reader["KeySpec"].readIfPresent()
        value.keyUsage = try reader["KeyUsage"].readIfPresent()
        value.publicKey = try reader["PublicKey"].readIfPresent()
        value.signingAlgorithms = try reader["SigningAlgorithms"].readListIfPresent(memberReadingClosure: KMSClientTypes.SigningAlgorithmSpec.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension KMSClientTypes.GrantConstraints {
    ...
    static func write(value: KMSClientTypes.GrantConstraints?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["EncryptionContextEquals"].writeMap(value.encryptionContextEquals, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["EncryptionContextSubset"].writeMap(value.encryptionContextSubset, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KMSClientTypes.GrantConstraints {
        ...
        value.encryptionContextSubset = try reader["EncryptionContextSubset"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.encryptionContextEquals = try reader["EncryptionContextEquals"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension KMSClientTypes.GrantListEntry {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KMSClientTypes.GrantListEntry {
        ...
        value.operations = try reader["Operations"].readListIfPresent(memberReadingClosure: KMSClientTypes.GrantOperation.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension KMSClientTypes.KeyMetadata {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KMSClientTypes.KeyMetadata {
        ...
        value.validTo = try reader["ValidTo"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.macAlgorithms = try reader["MacAlgorithms"].readListIfPresent(memberReadingClosure: KMSClientTypes.MacAlgorithmSpec.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ReEncryptInput {
    ...
    static func write(value: ReEncryptInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["DestinationEncryptionContext"].writeMap(value.destinationEncryptionContext, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        ...
        try writer["SourceEncryptionContext"].writeMap(value.sourceEncryptionContext, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension KMSClientTypes.RotationsListEntry {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KMSClientTypes.RotationsListEntry {
        ...
        value.keyId = try reader["KeyId"].readIfPresent()
        value.rotationDate = try reader["RotationDate"].readTimestampIfPresent(format: .epochSeconds)
