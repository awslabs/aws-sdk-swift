...
extension KMSClient {
    ...
    public func getKeyLastUsage(input: GetKeyLastUsageInput) async throws -> GetKeyLastUsageOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetKeyLastUsageInput, GetKeyLastUsageOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GetKeyLastUsageInput, GetKeyLastUsageOutput>(GetKeyLastUsageInput.urlPathProvider(_:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetKeyLastUsageOutput>(GetKeyLastUsageOutput.httpOutput(from:), GetKeyLastUsageOutputError.httpError(from:)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<GetKeyLastUsageInput, GetKeyLastUsageOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: GetKeyLastUsageInput.write(value:to:)))
