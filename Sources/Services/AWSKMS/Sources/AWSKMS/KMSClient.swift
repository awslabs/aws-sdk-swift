...
extension KMSClient {
    ...
    ///
    /// * The public key (or "wrapping key") of an asymmetric key pair that KMS generates. You will use this public key to encrypt ("wrap") your key material while it's in transit to KMS.
    ///
