...
extension KMSClient {
    ...
    public struct KMSClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "KMS")
...
extension KMSClient {
    /// Performs the `CancelKeyDeletion` operation on the `KMS` service.
    ///
    ...
    public func cancelKeyDeletion(input: CancelKeyDeletionInput) async throws -> CancelKeyDeletionOutput {
        ...
        let operation = KMSClient.cancelKeyDeletionOperation
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("KMS", config.ignoreConfiguredEndpointURLs)
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CancelKeyDeletionInput, CancelKeyDeletionOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
    ...
    /// Performs the `ConnectCustomKeyStore` operation on the `KMS` service.
    ///
    ...
    public func connectCustomKeyStore(input: ConnectCustomKeyStoreInput) async throws -> ConnectCustomKeyStoreOutput {
        ...
        let operation = KMSClient.connectCustomKeyStoreOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ConnectCustomKeyStoreInput, ConnectCustomKeyStoreOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    ///
    ///
    /// For details, see [Controlling access to aliases](https://docs.aws.amazon.com/kms/latest/developerguide/alias-access.html) in the Key Management Service Developer Guide. Related operations:
    ///
    /// * [DeleteAlias]
    ///
    /// * [ListAliases]
    ...
    ///
    /// * For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.
    /// - `LimitExceededException` : The request was rejected because a length constraint or quota was exceeded. For more information, see [Quotas](https://docs.aws.amazon.com/kms/latest/developerguide/limits.html) in the Key Management Service Developer Guide.
    /// - `NotFoundException` : The request was rejected because the specified entity or resource could not be found.
    public func createAlias(input: CreateAliasInput) async throws -> CreateAliasOutput {
        ...
        let operation = KMSClient.createAliasOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateAliasInput, CreateAliasOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func createCustomKeyStore(input: CreateCustomKeyStoreInput) async throws -> CreateCustomKeyStoreOutput {
        ...
        let operation = KMSClient.createCustomKeyStoreOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateCustomKeyStoreInput, CreateCustomKeyStoreOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func createGrant(input: CreateGrantInput) async throws -> CreateGrantOutput {
        ...
        let operation = KMSClient.createGrantOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateGrantInput, CreateGrantOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func createKey(input: CreateKeyInput) async throws -> CreateKeyOutput {
        ...
        let operation = KMSClient.createKeyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateKeyInput, CreateKeyOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `Decrypt` operation on the `KMS` service.
    ///
    ...
    public func decrypt(input: DecryptInput) async throws -> DecryptOutput {
        ...
        let operation = KMSClient.decryptOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DecryptInput, DecryptOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `DeleteAlias` operation on the `KMS` service.
    ///
    ...
    public func deleteAlias(input: DeleteAliasInput) async throws -> DeleteAliasOutput {
        ...
        let operation = KMSClient.deleteAliasOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAliasInput, DeleteAliasOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func deleteCustomKeyStore(input: DeleteCustomKeyStoreInput) async throws -> DeleteCustomKeyStoreOutput {
        ...
        let operation = KMSClient.deleteCustomKeyStoreOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteCustomKeyStoreInput, DeleteCustomKeyStoreOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `DeleteImportedKeyMaterial` operation on the `KMS` service.
    ///
    /// Deletes key material that was previously imported. This operation makes the specified KMS key temporarily unusable. To restore the usability of the KMS key, reimport the same key material. For more information about importing key material into KMS, see [Importing Key Material](https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys.html) in the Key Management Service Developer Guide. When the specified KMS key is in the PendingDeletion state, this operation does not change the KMS key's state. Otherwise, it changes the KMS key's state to PendingImport. Considerations for multi-Region symmetric encryption keys
    ///
    ...
    public func deleteImportedKeyMaterial(input: DeleteImportedKeyMaterialInput) async throws -> DeleteImportedKeyMaterialOutput {
        ...
        let operation = KMSClient.deleteImportedKeyMaterialOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteImportedKeyMaterialInput, DeleteImportedKeyMaterialOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `DeriveSharedSecret` operation on the `KMS` service.
    ///
    ...
    ///
    /// * Alice calls [CreateKey] to create an asymmetric KMS key pair with a KeyUsage value of KEY_AGREEMENT. The asymmetric KMS key must use a NIST-standard elliptic curve (ECC) or SM2 (China Regions only) key spec.
    ///
    /// * Bob creates an elliptic curve key pair. Bob can call [CreateKey] to create an asymmetric KMS key pair or generate a key pair outside of KMS. Bob's key pair must use the same NIST-standard elliptic curve (ECC) or SM2 (China Regions ony) curve as Alice.
    ///
    ...
    public func deriveSharedSecret(input: DeriveSharedSecretInput) async throws -> DeriveSharedSecretOutput {
        ...
        let operation = KMSClient.deriveSharedSecretOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeriveSharedSecretInput, DeriveSharedSecretOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func describeCustomKeyStores(input: DescribeCustomKeyStoresInput) async throws -> DescribeCustomKeyStoresOutput {
        ...
        let operation = KMSClient.describeCustomKeyStoresOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeCustomKeyStoresInput, DescribeCustomKeyStoresOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func describeKey(input: DescribeKeyInput) async throws -> DescribeKeyOutput {
        ...
        let operation = KMSClient.describeKeyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeKeyInput, DescribeKeyOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `DisableKey` operation on the `KMS` service.
    ///
    ...
    public func disableKey(input: DisableKeyInput) async throws -> DisableKeyOutput {
        ...
        let operation = KMSClient.disableKeyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DisableKeyInput, DisableKeyOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func disableKeyRotation(input: DisableKeyRotationInput) async throws -> DisableKeyRotationOutput {
        ...
        let operation = KMSClient.disableKeyRotationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DisableKeyRotationInput, DisableKeyRotationOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `DisconnectCustomKeyStore` operation on the `KMS` service.
    ///
    ...
    public func disconnectCustomKeyStore(input: DisconnectCustomKeyStoreInput) async throws -> DisconnectCustomKeyStoreOutput {
        ...
        let operation = KMSClient.disconnectCustomKeyStoreOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DisconnectCustomKeyStoreInput, DisconnectCustomKeyStoreOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `EnableKey` operation on the `KMS` service.
    ///
    ...
    public func enableKey(input: EnableKeyInput) async throws -> EnableKeyOutput {
        ...
        let operation = KMSClient.enableKeyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<EnableKeyInput, EnableKeyOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func enableKeyRotation(input: EnableKeyRotationInput) async throws -> EnableKeyRotationOutput {
        ...
        let operation = KMSClient.enableKeyRotationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<EnableKeyRotationInput, EnableKeyRotationOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func encrypt(input: EncryptInput) async throws -> EncryptOutput {
        ...
        let operation = KMSClient.encryptOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<EncryptInput, EncryptOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func generateDataKey(input: GenerateDataKeyInput) async throws -> GenerateDataKeyOutput {
        ...
        let operation = KMSClient.generateDataKeyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GenerateDataKeyInput, GenerateDataKeyOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func generateDataKeyPair(input: GenerateDataKeyPairInput) async throws -> GenerateDataKeyPairOutput {
        ...
        let operation = KMSClient.generateDataKeyPairOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GenerateDataKeyPairInput, GenerateDataKeyPairOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `GenerateDataKeyPairWithoutPlaintext` operation on the `KMS` service.
    ///
    ...
    public func generateDataKeyPairWithoutPlaintext(input: GenerateDataKeyPairWithoutPlaintextInput) async throws -> GenerateDataKeyPairWithoutPlaintextOutput {
        ...
        let operation = KMSClient.generateDataKeyPairWithoutPlaintextOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GenerateDataKeyPairWithoutPlaintextInput, GenerateDataKeyPairWithoutPlaintextOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `GenerateDataKeyWithoutPlaintext` operation on the `KMS` service.
    ///
    ...
    public func generateDataKeyWithoutPlaintext(input: GenerateDataKeyWithoutPlaintextInput) async throws -> GenerateDataKeyWithoutPlaintextOutput {
        ...
        let operation = KMSClient.generateDataKeyWithoutPlaintextOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GenerateDataKeyWithoutPlaintextInput, GenerateDataKeyWithoutPlaintextOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `GenerateMac` operation on the `KMS` service.
    ///
    ...
    public func generateMac(input: GenerateMacInput) async throws -> GenerateMacOutput {
        ...
        let operation = KMSClient.generateMacOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GenerateMacInput, GenerateMacOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `GenerateRandom` operation on the `KMS` service.
    ///
    ...
    public func generateRandom(input: GenerateRandomInput) async throws -> GenerateRandomOutput {
        ...
        let operation = KMSClient.generateRandomOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GenerateRandomInput, GenerateRandomOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `GetKeyLastUsage` operation on the `KMS` service.
    ///
    ...
    ///
    ///
    /// For multi-Region KMS keys, primary and replica keys track last usage independently. Each key in a multi-Region key set maintains its own usage information. The ReEncrypt operation uses two keys: a source key for decryption and a destination key for encryption. Usage information is recorded for both keys independently, each with the CloudTrail event ID from the respective key owner's account. Do not use GetKeyLastUsage as the sole indicator when scheduling a key for deletion. Instead, first [disable the key](https://docs.aws.amazon.com/kms/latest/developerguide/enabling-keys.html) and monitor CloudTrail for DisabledException entries, as there could be infrequent workflows that are dependent on the key. By looking for this exception, you can identify potential dependencies and workload failures before they occur. Cross-account use: No. You cannot perform this operation on a KMS key in a different Amazon Web Services account. Required permissions: [kms:GetKeyLastUsage](https://docs.aws.amazon.com/kms/latest/developerguide/kms-api-permissions-reference.html) (key policy) Related operations:
    ///
    /// * [DescribeKey]
    ///
    /// * [DisableKey]
    ...
    /// Eventual consistency: The KMS API follows an eventual consistency model. For more information, see [KMS eventual consistency](https://docs.aws.amazon.com/kms/latest/developerguide/accessing-kms.html#programming-eventual-consistency).
    ///
    /// - Parameter input: [no documentation found] (Type: `GetKeyLastUsageInput`)
    ///
    /// - Returns: [no documentation found] (Type: `GetKeyLastUsageOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `KMSInternalException` : The request was rejected because an internal exception occurred. The request can be retried.
    /// - `NotFoundException` : The request was rejected because the specified entity or resource could not be found.
    public func getKeyLastUsage(input: GetKeyLastUsageInput) async throws -> GetKeyLastUsageOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = KMSClient.getKeyLastUsageOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getKeyLastUsage")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetKeyLastUsageInput, GetKeyLastUsageOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetKeyLastUsageInput, GetKeyLastUsageOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetKeyLastUsageInput, GetKeyLastUsageOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<GetKeyLastUsageOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("KMS", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetKeyLastUsageOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetKeyLastUsageInput, GetKeyLastUsageOutput>(overrides: ["X-Amz-Target": "TrentService.GetKeyLastUsage"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetKeyLastUsageInput, GetKeyLastUsageOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetKeyLastUsageOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetKeyLastUsageInput, GetKeyLastUsageOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetKeyLastUsageInput, GetKeyLastUsageOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetKeyLastUsageInput, GetKeyLastUsageOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetKeyLastUsage")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `GetKeyPolicy` operation on the `KMS` service.
    ///
    ...
    public func getKeyPolicy(input: GetKeyPolicyInput) async throws -> GetKeyPolicyOutput {
        ...
        let operation = KMSClient.getKeyPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetKeyPolicyInput, GetKeyPolicyOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func getKeyRotationStatus(input: GetKeyRotationStatusInput) async throws -> GetKeyRotationStatusOutput {
        ...
        let operation = KMSClient.getKeyRotationStatusOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetKeyRotationStatusInput, GetKeyRotationStatusOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func getParametersForImport(input: GetParametersForImportInput) async throws -> GetParametersForImportOutput {
        ...
        let operation = KMSClient.getParametersForImportOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetParametersForImportInput, GetParametersForImportOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `GetPublicKey` operation on the `KMS` service.
    ///
    ...
    public func getPublicKey(input: GetPublicKeyInput) async throws -> GetPublicKeyOutput {
        ...
        let operation = KMSClient.getPublicKeyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetPublicKeyInput, GetPublicKeyOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// - `IncorrectKeyMaterialException` : The request was rejected because the key material in the request is, expired, invalid, or does not meet expectations. For example, it is not the same key material that was previously imported or KMS expected new key material but the key material being imported is already associated with the KMS key.
    /// - `InvalidArnException` : The request was rejected because a specified ARN, or an ARN in a key policy, is not valid.
    /// - `InvalidCiphertextException` : From the [Decrypt] or [ReEncrypt] operation, the request was rejected because the specified ciphertext, or additional authenticated data incorporated into the ciphertext, such as the encryption context, is corrupted, missing, or otherwise invalid. From the [ImportKeyMaterial] operation, the request was rejected because KMS could not decrypt the encrypted (wrapped) key material.
    ...
    public func importKeyMaterial(input: ImportKeyMaterialInput) async throws -> ImportKeyMaterialOutput {
        ...
        let operation = KMSClient.importKeyMaterialOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ImportKeyMaterialInput, ImportKeyMaterialOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func listAliases(input: ListAliasesInput) async throws -> ListAliasesOutput {
        ...
        let operation = KMSClient.listAliasesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAliasesInput, ListAliasesOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func listGrants(input: ListGrantsInput) async throws -> ListGrantsOutput {
        ...
        let operation = KMSClient.listGrantsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListGrantsInput, ListGrantsOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `ListKeyPolicies` operation on the `KMS` service.
    ///
    ...
    public func listKeyPolicies(input: ListKeyPoliciesInput) async throws -> ListKeyPoliciesOutput {
        ...
        let operation = KMSClient.listKeyPoliciesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListKeyPoliciesInput, ListKeyPoliciesOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func listKeyRotations(input: ListKeyRotationsInput) async throws -> ListKeyRotationsOutput {
        ...
        let operation = KMSClient.listKeyRotationsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListKeyRotationsInput, ListKeyRotationsOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `ListKeys` operation on the `KMS` service.
    ///
    ...
    public func listKeys(input: ListKeysInput) async throws -> ListKeysOutput {
        ...
        let operation = KMSClient.listKeysOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListKeysInput, ListKeysOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func listResourceTags(input: ListResourceTagsInput) async throws -> ListResourceTagsOutput {
        ...
        let operation = KMSClient.listResourceTagsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListResourceTagsInput, ListResourceTagsOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `ListRetirableGrants` operation on the `KMS` service.
    ///
    /// Returns information about all grants in the Amazon Web Services account and Region that have the specified retiring principal or retiring service principal. You can specify any principal in your Amazon Web Services account. The grants that are returned include grants for KMS keys in your Amazon Web Services account and other Amazon Web Services accounts. You might use this operation to determine which grants you may retire. To retire a grant, use the [RetireGrant] operation. For detailed information about grants, including grant terminology, see [Grants in KMS](https://docs.aws.amazon.com/kms/latest/developerguide/grants.html) in the Key Management Service Developer Guide . For examples of creating grants in several programming languages, see [Use CreateGrant with an Amazon Web Services SDK or CLI](https://docs.aws.amazon.com/kms/latest/developerguide/example_kms_CreateGrant_section.html). Cross-account use: You must specify a principal in your Amazon Web Services account. This operation returns a list of grants where the retiring principal specified in the ListRetirableGrants request is the same retiring principal on the grant. This can include grants on KMS keys owned by other Amazon Web Services accounts, but you do not need kms:ListRetirableGrants permission (or any other additional permission) in any Amazon Web Services account other than your own. Required permissions: [kms:ListRetirableGrants](https://docs.aws.amazon.com/kms/latest/developerguide/kms-api-permissions-reference.html) (IAM policy) in your Amazon Web Services account. When listing retirable grants by RetiringPrincipal, KMS authorizes ListRetirableGrants requests by evaluating the caller account's kms:ListRetirableGrants permissions. The authorized resource in ListRetirableGrants calls is the retiring principal specified in the request. KMS does not evaluate the caller's permissions to verify their access to any KMS keys or grants that might be returned by the ListRetirableGrants call. The RetiringServicePrincipal filter is only usable by callers in a service principal. Related operations:
    ///
    /// * [CreateGrant]
    ///
    /// * [ListGrants]
    ...
    public func listRetirableGrants(input: ListRetirableGrantsInput) async throws -> ListRetirableGrantsOutput {
        ...
        let operation = KMSClient.listRetirableGrantsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListRetirableGrantsInput, ListRetirableGrantsOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `PutKeyPolicy` operation on the `KMS` service.
    ///
    ...
    public func putKeyPolicy(input: PutKeyPolicyInput) async throws -> PutKeyPolicyOutput {
        ...
        let operation = KMSClient.putKeyPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutKeyPolicyInput, PutKeyPolicyOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func reEncrypt(input: ReEncryptInput) async throws -> ReEncryptOutput {
        ...
        let operation = KMSClient.reEncryptOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ReEncryptInput, ReEncryptOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func replicateKey(input: ReplicateKeyInput) async throws -> ReplicateKeyOutput {
        ...
        let operation = KMSClient.replicateKeyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ReplicateKeyInput, ReplicateKeyOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func retireGrant(input: RetireGrantInput) async throws -> RetireGrantOutput {
        ...
        let operation = KMSClient.retireGrantOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RetireGrantInput, RetireGrantOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `RevokeGrant` operation on the `KMS` service.
    ///
    /// Deletes the specified grant. You revoke a grant to terminate the permissions that the grant allows. For more information, see [Retiring and revoking grants](https://docs.aws.amazon.com/kms/latest/developerguide/grant-delete.html) in the Key Management Service Developer Guide . When you create, retire, or revoke a grant, there might be a brief delay, usually less than five minutes, until the grant is available throughout KMS. This state is known as eventual consistency. For details, see [Eventual consistency](https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#terms-eventual-consistency) in the Key Management Service Developer Guide . For detailed information about grants, including grant terminology, see [Grants in KMS](https://docs.aws.amazon.com/kms/latest/developerguide/grants.html) in the Key Management Service Developer Guide . For examples of creating grants in several programming languages, see [Use CreateGrant with an Amazon Web Services SDK or CLI](https://docs.aws.amazon.com/kms/latest/developerguide/example_kms_CreateGrant_section.html). Cross-account use: Yes. To perform this operation on a KMS key in a different Amazon Web Services account, specify the key ARN in the value of the KeyId parameter. Required permissions: [kms:RevokeGrant](https://docs.aws.amazon.com/kms/latest/developerguide/kms-api-permissions-reference.html) (key policy). Related operations:
    ///
    /// * [CreateGrant]
    ///
    /// * [ListGrants]
    ...
    public func revokeGrant(input: RevokeGrantInput) async throws -> RevokeGrantOutput {
        ...
        let operation = KMSClient.revokeGrantOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RevokeGrantInput, RevokeGrantOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func rotateKeyOnDemand(input: RotateKeyOnDemandInput) async throws -> RotateKeyOnDemandOutput {
        ...
        let operation = KMSClient.rotateKeyOnDemandOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RotateKeyOnDemandInput, RotateKeyOnDemandOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `ScheduleKeyDeletion` operation on the `KMS` service.
    ///
    ...
    public func scheduleKeyDeletion(input: ScheduleKeyDeletionInput) async throws -> ScheduleKeyDeletionOutput {
        ...
        let operation = KMSClient.scheduleKeyDeletionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ScheduleKeyDeletionInput, ScheduleKeyDeletionOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `Sign` operation on the `KMS` service.
    ///
    ...
    public func sign(input: SignInput) async throws -> SignOutput {
        ...
        let operation = KMSClient.signOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SignInput, SignOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput {
        ...
        let operation = KMSClient.tagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TagResourceInput, TagResourceOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput {
        ...
        let operation = KMSClient.untagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UntagResourceInput, UntagResourceOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `UpdateAlias` operation on the `KMS` service.
    ///
    ...
    public func updateAlias(input: UpdateAliasInput) async throws -> UpdateAliasOutput {
        ...
        let operation = KMSClient.updateAliasOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateAliasInput, UpdateAliasOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `UpdateCustomKeyStore` operation on the `KMS` service.
    ///
    ...
    public func updateCustomKeyStore(input: UpdateCustomKeyStoreInput) async throws -> UpdateCustomKeyStoreOutput {
        ...
        let operation = KMSClient.updateCustomKeyStoreOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateCustomKeyStoreInput, UpdateCustomKeyStoreOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `UpdateKeyDescription` operation on the `KMS` service.
    ///
    ...
    public func updateKeyDescription(input: UpdateKeyDescriptionInput) async throws -> UpdateKeyDescriptionOutput {
        ...
        let operation = KMSClient.updateKeyDescriptionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateKeyDescriptionInput, UpdateKeyDescriptionOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    public func updatePrimaryRegion(input: UpdatePrimaryRegionInput) async throws -> UpdatePrimaryRegionOutput {
        ...
        let operation = KMSClient.updatePrimaryRegionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdatePrimaryRegionInput, UpdatePrimaryRegionOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `Verify` operation on the `KMS` service.
    ///
    ...
    public func verify(input: VerifyInput) async throws -> VerifyOutput {
        ...
        let operation = KMSClient.verifyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<VerifyInput, VerifyOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
    ...
    /// Performs the `VerifyMac` operation on the `KMS` service.
    ///
    ...
    public func verifyMac(input: VerifyMacInput) async throws -> VerifyMacOutput {
        ...
        let operation = KMSClient.verifyMacOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "KMS"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<VerifyMacInput, VerifyMacOutput>(serviceID: serviceName, version: KMSClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "KMS")
