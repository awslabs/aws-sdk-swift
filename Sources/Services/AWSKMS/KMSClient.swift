...
extension KMSClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> KMSClient.KMSClientConfiguration {
        let clientConfiguration = try await KMSClient.KMSClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> KMSClient {
            let configuration = try await resolve(plugins: self.plugins)
            return KMSClient(config: configuration)
        }
    }
...
extension KMSClient.KMSClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
