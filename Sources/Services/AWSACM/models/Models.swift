...
extension ACMClientTypes.CertificateDetail {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ACMClientTypes.CertificateDetail {
        ...
        value.subjectAlternativeNames = try reader["SubjectAlternativeNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.inUseBy = try reader["InUseBy"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ACMClientTypes.CertificateSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ACMClientTypes.CertificateSummary {
        ...
        value.certificateArn = try reader["CertificateArn"].readIfPresent()
        value.domainName = try reader["DomainName"].readIfPresent()
        value.subjectAlternativeNameSummaries = try reader["SubjectAlternativeNameSummaries"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.hasAdditionalSubjectAlternativeNames = try reader["HasAdditionalSubjectAlternativeNames"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
        value.type = try reader["Type"].readIfPresent()
        value.keyAlgorithm = try reader["KeyAlgorithm"].readIfPresent()
        value.keyUsages = try reader["KeyUsages"].readListIfPresent(memberReadingClosure: ACMClientTypes.KeyUsageName.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.extendedKeyUsages = try reader["ExtendedKeyUsages"].readListIfPresent(memberReadingClosure: ACMClientTypes.ExtendedKeyUsageName.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ACMClientTypes.DomainValidation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ACMClientTypes.DomainValidation {
        ...
        value.domainName = try reader["DomainName"].readIfPresent()
        value.validationEmails = try reader["ValidationEmails"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ListCertificatesInput {
    ...
    static func write(value: ListCertificatesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CertificateStatuses"].writeList(value.certificateStatuses, memberWritingClosure: ACMClientTypes.CertificateStatus.write(value:to:), memberNodeInfo: "member", isFlattened: false)
