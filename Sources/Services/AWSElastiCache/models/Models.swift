...
extension AddTagsToResourceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AddTagsToResourceOutput {
        ...
        value.tagList = try reader["TagList"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.Tag.readingClosure(from:), memberNodeInfo: "Tag", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.Authentication: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.Authentication {
...
extension ElastiCacheClientTypes.AuthenticationMode: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.AuthenticationMode {
        var value = ElastiCacheClientTypes.AuthenticationMode()
        value.type = try reader["Type"].readIfPresent()
        value.passwords = try reader["Passwords"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension AuthorizeCacheSecurityGroupIngressOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AuthorizeCacheSecurityGroupIngressOutput {
        let reader = responseReader["AuthorizeCacheSecurityGroupIngressResult"]
        var value = AuthorizeCacheSecurityGroupIngressOutput()
        value.cacheSecurityGroup = try reader["CacheSecurityGroup"].readIfPresent(readingClosure: ElastiCacheClientTypes.CacheSecurityGroup.readingClosure(from:))
        return value
    }
}
...
extension ElastiCacheClientTypes.AvailabilityZone: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
    }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.AvailabilityZone {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let cacheClusterIds = cacheClusterIds {
            if !cacheClusterIds.isEmpty {
                ...
                var cacheClusterIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CacheClusterIds"))
                try cacheClusterIdsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let replicationGroupIds = replicationGroupIds {
            if !replicationGroupIds.isEmpty {
                ...
                var replicationGroupIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ReplicationGroupIds"))
                try replicationGroupIdsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
...
extension BatchApplyUpdateActionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> BatchApplyUpdateActionOutput {
        let reader = responseReader["BatchApplyUpdateActionResult"]
        var value = BatchApplyUpdateActionOutput()
        value.processedUpdateActions = try reader["ProcessedUpdateActions"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.ProcessedUpdateAction.readingClosure(from:), memberNodeInfo: "ProcessedUpdateAction", isFlattened: false)
        value.unprocessedUpdateActions = try reader["UnprocessedUpdateActions"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.UnprocessedUpdateAction.readingClosure(from:), memberNodeInfo: "UnprocessedUpdateAction", isFlattened: false)
        return value
    }
}
...
extension BatchStopUpdateActionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> BatchStopUpdateActionOutput {
...
extension ElastiCacheClientTypes.CacheCluster: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let cacheNodes = cacheNodes {
            if !cacheNodes.isEmpty {
                ...
                var cacheNodesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CacheNodes"))
                try cacheNodesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let cacheSecurityGroups = cacheSecurityGroups {
            if !cacheSecurityGroups.isEmpty {
                ...
                var cacheSecurityGroupsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CacheSecurityGroups"))
                try cacheSecurityGroupsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let ipDiscovery = ipDiscovery {
            try container.encode(ipDiscovery, forKey: ClientRuntime.Key("IpDiscovery"))
        }
        if let logDeliveryConfigurations = logDeliveryConfigurations {
            if !logDeliveryConfigurations.isEmpty {
                ...
                var logDeliveryConfigurationsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("LogDeliveryConfigurations"))
                try logDeliveryConfigurationsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheCluster {
        var value = ElastiCacheClientTypes.CacheCluster()
        value.cacheClusterId = try reader["CacheClusterId"].readIfPresent()
        value.configurationEndpoint = try reader["ConfigurationEndpoint"].readIfPresent(readingClosure: ElastiCacheClientTypes.Endpoint.readingClosure(from:))
        ...
        value.pendingModifiedValues = try reader["PendingModifiedValues"].readIfPresent(readingClosure: ElastiCacheClientTypes.PendingModifiedValues.readingClosure(from:))
        value.notificationConfiguration = try reader["NotificationConfiguration"].readIfPresent(readingClosure: ElastiCacheClientTypes.NotificationConfiguration.readingClosure(from:))
        value.cacheSecurityGroups = try reader["CacheSecurityGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.CacheSecurityGroupMembership.readingClosure(from:), memberNodeInfo: "CacheSecurityGroup", isFlattened: false)
        value.cacheParameterGroup = try reader["CacheParameterGroup"].readIfPresent(readingClosure: ElastiCacheClientTypes.CacheParameterGroupStatus.readingClosure(from:))
        value.cacheSubnetGroupName = try reader["CacheSubnetGroupName"].readIfPresent()
        value.cacheNodes = try reader["CacheNodes"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.CacheNode.readingClosure(from:), memberNodeInfo: "CacheNode", isFlattened: false)
        value.autoMinorVersionUpgrade = try reader["AutoMinorVersionUpgrade"].readIfPresent()
        value.securityGroups = try reader["SecurityGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.SecurityGroupMembership.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.logDeliveryConfigurations = try reader["LogDeliveryConfigurations"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.LogDeliveryConfiguration.readingClosure(from:), memberNodeInfo: "LogDeliveryConfiguration", isFlattened: false)
...
extension ElastiCacheClientTypes.CacheEngineVersion: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheEngineVersion {
...
extension ElastiCacheClientTypes.CacheNode: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheNode {
        ...
        value.endpoint = try reader["Endpoint"].readIfPresent(readingClosure: ElastiCacheClientTypes.Endpoint.readingClosure(from:))
...
extension ElastiCacheClientTypes.CacheNodeTypeSpecificParameter: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let cacheNodeTypeSpecificValues = cacheNodeTypeSpecificValues {
            if !cacheNodeTypeSpecificValues.isEmpty {
                ...
                var cacheNodeTypeSpecificValuesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CacheNodeTypeSpecificValues"))
                try cacheNodeTypeSpecificValuesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheNodeTypeSpecificParameter {
        ...
        value.cacheNodeTypeSpecificValues = try reader["CacheNodeTypeSpecificValues"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.CacheNodeTypeSpecificValue.readingClosure(from:), memberNodeInfo: "CacheNodeTypeSpecificValue", isFlattened: false)
...
extension ElastiCacheClientTypes.CacheNodeTypeSpecificValue: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheNodeType = "CacheNodeType"
        case value = "Value"
    }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheNodeTypeSpecificValue {
...
extension ElastiCacheClientTypes.CacheNodeUpdateStatus: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheNodeId = "CacheNodeId"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheNodeUpdateStatus {
...
extension ElastiCacheClientTypes.CacheParameterGroup: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
        case cacheParameterGroupFamily = "CacheParameterGroupFamily"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheParameterGroup {
...
extension ElastiCacheClientTypes.CacheParameterGroupStatus: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let cacheNodeIdsToReboot = cacheNodeIdsToReboot {
            if !cacheNodeIdsToReboot.isEmpty {
                ...
                var cacheNodeIdsToRebootContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CacheNodeIdsToReboot"))
                try cacheNodeIdsToRebootContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let cacheParameterGroupName = cacheParameterGroupName {
            try container.encode(cacheParameterGroupName, forKey: ClientRuntime.Key("CacheParameterGroupName"))
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheParameterGroupStatus {
        ...
        value.cacheNodeIdsToReboot = try reader["CacheNodeIdsToReboot"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "CacheNodeId", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.CacheSecurityGroup: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
        case cacheSecurityGroupName = "CacheSecurityGroupName"
        case description = "Description"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheSecurityGroup {
        ...
        value.description = try reader["Description"].readIfPresent()
        value.ec2SecurityGroups = try reader["EC2SecurityGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.EC2SecurityGroup.readingClosure(from:), memberNodeInfo: "EC2SecurityGroup", isFlattened: false)
        value.arn = try reader["ARN"].readIfPresent()
        return value
    }
}
...
extension ElastiCacheClientTypes.CacheSecurityGroupMembership: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheSecurityGroupName = "CacheSecurityGroupName"
        case status = "Status"
    }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheSecurityGroupMembership {
...
extension ElastiCacheClientTypes.CacheSubnetGroup: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let supportedNetworkTypes = supportedNetworkTypes {
            if !supportedNetworkTypes.isEmpty {
                ...
                for (index0, networktype0) in supportedNetworkTypes.enumerated() {
                    try supportedNetworkTypesContainer.encode(networktype0, forKey: ClientRuntime.Key("member.\(index0.advanced(by: 1))"))
                }
            }
            else {
                var supportedNetworkTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("SupportedNetworkTypes"))
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheSubnetGroup {
        ...
        value.subnets = try reader["Subnets"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.Subnet.readingClosure(from:), memberNodeInfo: "Subnet", isFlattened: false)
        value.arn = try reader["ARN"].readIfPresent()
        value.supportedNetworkTypes = try reader["SupportedNetworkTypes"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.NetworkType.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.CacheUsageLimits: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheUsageLimits {
        var value = ElastiCacheClientTypes.CacheUsageLimits()
        value.dataStorage = try reader["DataStorage"].readIfPresent(readingClosure: ElastiCacheClientTypes.DataStorage.readingClosure(from:))
        value.ecpuPerSecond = try reader["ECPUPerSecond"].readIfPresent(readingClosure: ElastiCacheClientTypes.ECPUPerSecond.readingClosure(from:))
        return value
    }
}
...
extension ElastiCacheClientTypes.CloudWatchLogsDestinationDetails: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CloudWatchLogsDestinationDetails {
...
extension CompleteMigrationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CompleteMigrationOutput {
        let reader = responseReader["CompleteMigrationResult"]
        var value = CompleteMigrationOutput()
        value.replicationGroup = try reader["ReplicationGroup"].readIfPresent(readingClosure: ElastiCacheClientTypes.ReplicationGroup.readingClosure(from:))
        return value
    }
}
...
extension ElastiCacheClientTypes.ConfigureShard: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let preferredAvailabilityZones = preferredAvailabilityZones {
            if !preferredAvailabilityZones.isEmpty {
                ...
                var preferredAvailabilityZonesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("PreferredAvailabilityZones"))
                try preferredAvailabilityZonesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let preferredOutpostArns = preferredOutpostArns {
            if !preferredOutpostArns.isEmpty {
                ...
                var preferredOutpostArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("PreferredOutpostArns"))
                try preferredOutpostArnsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    }

    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ConfigureShard {
        ...
        value.preferredAvailabilityZones = try reader["PreferredAvailabilityZones"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "PreferredAvailabilityZone", isFlattened: false)
        value.preferredOutpostArns = try reader["PreferredOutpostArns"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "PreferredOutpostArn", isFlattened: false)
        return value
    }
}
...
extension CopyServerlessCacheSnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CopyServerlessCacheSnapshotOutput {
        let reader = responseReader["CopyServerlessCacheSnapshotResult"]
        var value = CopyServerlessCacheSnapshotOutput()
        value.serverlessCacheSnapshot = try reader["ServerlessCacheSnapshot"].readIfPresent(readingClosure: ElastiCacheClientTypes.ServerlessCacheSnapshot.readingClosure(from:))
        return value
    }
}
...
extension CopySnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CopySnapshotOutput {
        let reader = responseReader["CopySnapshotResult"]
        var value = CopySnapshotOutput()
        value.snapshot = try reader["Snapshot"].readIfPresent(readingClosure: ElastiCacheClientTypes.Snapshot.readingClosure(from:))
        return value
    }
}
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let snapshotArns = snapshotArns {
            if !snapshotArns.isEmpty {
                ...
                var snapshotArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("SnapshotArns"))
                try snapshotArnsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
...
extension CreateCacheClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateCacheClusterOutput {
        let reader = responseReader["CreateCacheClusterResult"]
        var value = CreateCacheClusterOutput()
        value.cacheCluster = try reader["CacheCluster"].readIfPresent(readingClosure: ElastiCacheClientTypes.CacheCluster.readingClosure(from:))
        return value
    }
}
...
extension CreateCacheParameterGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateCacheParameterGroupOutput {
        let reader = responseReader["CreateCacheParameterGroupResult"]
        var value = CreateCacheParameterGroupOutput()
        value.cacheParameterGroup = try reader["CacheParameterGroup"].readIfPresent(readingClosure: ElastiCacheClientTypes.CacheParameterGroup.readingClosure(from:))
        return value
    }
}
...
extension CreateCacheSecurityGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateCacheSecurityGroupOutput {
...
extension CreateCacheSubnetGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateCacheSubnetGroupOutput {
        let reader = responseReader["CreateCacheSubnetGroupResult"]
        var value = CreateCacheSubnetGroupOutput()
        value.cacheSubnetGroup = try reader["CacheSubnetGroup"].readIfPresent(readingClosure: ElastiCacheClientTypes.CacheSubnetGroup.readingClosure(from:))
        return value
    }
}
...
extension CreateGlobalReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateGlobalReplicationGroupOutput {
        let reader = responseReader["CreateGlobalReplicationGroupResult"]
        var value = CreateGlobalReplicationGroupOutput()
        value.globalReplicationGroup = try reader["GlobalReplicationGroup"].readIfPresent(readingClosure: ElastiCacheClientTypes.GlobalReplicationGroup.readingClosure(from:))
        return value
    }
}
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let nodeGroupConfiguration = nodeGroupConfiguration {
            if !nodeGroupConfiguration.isEmpty {
                ...
                var nodeGroupConfigurationContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NodeGroupConfiguration"))
                try nodeGroupConfigurationContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let notificationTopicArn = notificationTopicArn {
            try container.encode(notificationTopicArn, forKey: ClientRuntime.Key("NotificationTopicArn"))
        ...
        if let preferredCacheClusterAZs = preferredCacheClusterAZs {
            if !preferredCacheClusterAZs.isEmpty {
                ...
                var preferredCacheClusterAZsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("PreferredCacheClusterAZs"))
                try preferredCacheClusterAZsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let preferredMaintenanceWindow = preferredMaintenanceWindow {
            try container.encode(preferredMaintenanceWindow, forKey: ClientRuntime.Key("PreferredMaintenanceWindow"))
        ...
        if let userGroupIds = userGroupIds {
            if !userGroupIds.isEmpty {
                ...
                var userGroupIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("UserGroupIds"))
                try userGroupIdsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
...
extension CreateReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateReplicationGroupOutput {
...
extension CreateServerlessCacheOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateServerlessCacheOutput {
        let reader = responseReader["CreateServerlessCacheResult"]
        var value = CreateServerlessCacheOutput()
        value.serverlessCache = try reader["ServerlessCache"].readIfPresent(readingClosure: ElastiCacheClientTypes.ServerlessCache.readingClosure(from:))
        return value
    }
}
...
extension CreateServerlessCacheSnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateServerlessCacheSnapshotOutput {
...
extension CreateSnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateSnapshotOutput {
...
extension CreateUserGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateUserGroupOutput {
        let reader = responseReader["CreateUserGroupResult"]
        var value = CreateUserGroupOutput()
        value.arn = try reader["ARN"].readIfPresent()
        value.engine = try reader["Engine"].readIfPresent()
        value.minimumEngineVersion = try reader["MinimumEngineVersion"].readIfPresent()
        value.pendingChanges = try reader["PendingChanges"].readIfPresent(readingClosure: ElastiCacheClientTypes.UserGroupPendingChanges.readingClosure(from:))
        value.replicationGroups = try reader["ReplicationGroups"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.serverlessCaches = try reader["ServerlessCaches"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["Status"].readIfPresent()
        value.userGroupId = try reader["UserGroupId"].readIfPresent()
        value.userIds = try reader["UserIds"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CreateUserOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateUserOutput {
        ...
        value.authentication = try reader["Authentication"].readIfPresent(readingClosure: ElastiCacheClientTypes.Authentication.readingClosure(from:))
        value.engine = try reader["Engine"].readIfPresent()
        value.minimumEngineVersion = try reader["MinimumEngineVersion"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
        value.userGroupIds = try reader["UserGroupIds"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ElastiCacheClientTypes.CustomerNodeEndpoint: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CustomerNodeEndpoint {
...
extension ElastiCacheClientTypes.DataStorage: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.DataStorage {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let globalNodeGroupsToRemove = globalNodeGroupsToRemove {
            if !globalNodeGroupsToRemove.isEmpty {
                ...
                var globalNodeGroupsToRemoveContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("GlobalNodeGroupsToRemove"))
                try globalNodeGroupsToRemoveContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let globalNodeGroupsToRetain = globalNodeGroupsToRetain {
            if !globalNodeGroupsToRetain.isEmpty {
                ...
                var globalNodeGroupsToRetainContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("GlobalNodeGroupsToRetain"))
                try globalNodeGroupsToRetainContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let globalReplicationGroupId = globalReplicationGroupId {
            try container.encode(globalReplicationGroupId, forKey: ClientRuntime.Key("GlobalReplicationGroupId"))
...
extension DecreaseNodeGroupsInGlobalReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DecreaseNodeGroupsInGlobalReplicationGroupOutput {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let replicaConfiguration = replicaConfiguration {
            if !replicaConfiguration.isEmpty {
                ...
                var replicaConfigurationContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ReplicaConfiguration"))
                try replicaConfigurationContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let replicasToRemove = replicasToRemove {
            if !replicasToRemove.isEmpty {
                ...
                var replicasToRemoveContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ReplicasToRemove"))
                try replicasToRemoveContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let replicationGroupId = replicationGroupId {
            try container.encode(replicationGroupId, forKey: ClientRuntime.Key("ReplicationGroupId"))
...
extension DecreaseReplicaCountOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DecreaseReplicaCountOutput {
...
extension DeleteCacheClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteCacheClusterOutput {
...
extension DeleteCacheParameterGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteCacheParameterGroupOutput {
        let reader = responseReader["DeleteCacheParameterGroupResult"]
        var value = DeleteCacheParameterGroupOutput()
        return value
    }
}
...
extension DeleteCacheSecurityGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteCacheSecurityGroupOutput {
        let reader = responseReader["DeleteCacheSecurityGroupResult"]
        var value = DeleteCacheSecurityGroupOutput()
        return value
    }
}
...
extension DeleteCacheSubnetGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteCacheSubnetGroupOutput {
        let reader = responseReader["DeleteCacheSubnetGroupResult"]
        var value = DeleteCacheSubnetGroupOutput()
        return value
    }
}
...
extension DeleteGlobalReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteGlobalReplicationGroupOutput {
...
extension DeleteReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteReplicationGroupOutput {
...
extension DeleteServerlessCacheOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteServerlessCacheOutput {
...
extension DeleteServerlessCacheSnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteServerlessCacheSnapshotOutput {
...
extension DeleteSnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteSnapshotOutput {
...
extension DeleteUserGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteUserGroupOutput {
...
extension DeleteUserOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteUserOutput {
...
extension DescribeCacheClustersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeCacheClustersOutput {
        let reader = responseReader["DescribeCacheClustersResult"]
        var value = DescribeCacheClustersOutput()
        value.cacheClusters = try reader["CacheClusters"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.CacheCluster.readingClosure(from:), memberNodeInfo: "CacheCluster", isFlattened: false)
...
extension DescribeCacheEngineVersionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeCacheEngineVersionsOutput {
        let reader = responseReader["DescribeCacheEngineVersionsResult"]
        var value = DescribeCacheEngineVersionsOutput()
        value.cacheEngineVersions = try reader["CacheEngineVersions"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.CacheEngineVersion.readingClosure(from:), memberNodeInfo: "CacheEngineVersion", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeCacheParameterGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeCacheParameterGroupsOutput {
        let reader = responseReader["DescribeCacheParameterGroupsResult"]
        var value = DescribeCacheParameterGroupsOutput()
        value.cacheParameterGroups = try reader["CacheParameterGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.CacheParameterGroup.readingClosure(from:), memberNodeInfo: "CacheParameterGroup", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeCacheParametersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeCacheParametersOutput {
        let reader = responseReader["DescribeCacheParametersResult"]
        var value = DescribeCacheParametersOutput()
        value.cacheNodeTypeSpecificParameters = try reader["CacheNodeTypeSpecificParameters"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.CacheNodeTypeSpecificParameter.readingClosure(from:), memberNodeInfo: "CacheNodeTypeSpecificParameter", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        value.parameters = try reader["Parameters"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.Parameter.readingClosure(from:), memberNodeInfo: "Parameter", isFlattened: false)
        return value
    }
}
...
extension DescribeCacheSecurityGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeCacheSecurityGroupsOutput {
        let reader = responseReader["DescribeCacheSecurityGroupsResult"]
        var value = DescribeCacheSecurityGroupsOutput()
        value.cacheSecurityGroups = try reader["CacheSecurityGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.CacheSecurityGroup.readingClosure(from:), memberNodeInfo: "CacheSecurityGroup", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeCacheSubnetGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeCacheSubnetGroupsOutput {
        let reader = responseReader["DescribeCacheSubnetGroupsResult"]
        var value = DescribeCacheSubnetGroupsOutput()
        value.cacheSubnetGroups = try reader["CacheSubnetGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.CacheSubnetGroup.readingClosure(from:), memberNodeInfo: "CacheSubnetGroup", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeEngineDefaultParametersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEngineDefaultParametersOutput {
        ...
        value.engineDefaults = try reader["EngineDefaults"].readIfPresent(readingClosure: ElastiCacheClientTypes.EngineDefaults.readingClosure(from:))
        return value
    }
}
...
extension DescribeEventsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEventsOutput {
        ...
        value.events = try reader["Events"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.Event.readingClosure(from:), memberNodeInfo: "Event", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeGlobalReplicationGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeGlobalReplicationGroupsOutput {
        let reader = responseReader["DescribeGlobalReplicationGroupsResult"]
        var value = DescribeGlobalReplicationGroupsOutput()
        value.globalReplicationGroups = try reader["GlobalReplicationGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.GlobalReplicationGroup.readingClosure(from:), memberNodeInfo: "GlobalReplicationGroup", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeReplicationGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeReplicationGroupsOutput {
        let reader = responseReader["DescribeReplicationGroupsResult"]
        var value = DescribeReplicationGroupsOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.replicationGroups = try reader["ReplicationGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.ReplicationGroup.readingClosure(from:), memberNodeInfo: "ReplicationGroup", isFlattened: false)
        return value
    }
}
...
extension DescribeReservedCacheNodesOfferingsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeReservedCacheNodesOfferingsOutput {
        let reader = responseReader["DescribeReservedCacheNodesOfferingsResult"]
        var value = DescribeReservedCacheNodesOfferingsOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.reservedCacheNodesOfferings = try reader["ReservedCacheNodesOfferings"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.ReservedCacheNodesOffering.readingClosure(from:), memberNodeInfo: "ReservedCacheNodesOffering", isFlattened: false)
        return value
    }
}
...
extension DescribeReservedCacheNodesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeReservedCacheNodesOutput {
        let reader = responseReader["DescribeReservedCacheNodesResult"]
        var value = DescribeReservedCacheNodesOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.reservedCacheNodes = try reader["ReservedCacheNodes"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.ReservedCacheNode.readingClosure(from:), memberNodeInfo: "ReservedCacheNode", isFlattened: false)
        return value
    }
}
...
extension DescribeServerlessCacheSnapshotsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeServerlessCacheSnapshotsOutput {
        ...
        value.serverlessCacheSnapshots = try reader["ServerlessCacheSnapshots"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.ServerlessCacheSnapshot.readingClosure(from:), memberNodeInfo: "ServerlessCacheSnapshot", isFlattened: false)
        return value
    }
}
...
extension DescribeServerlessCachesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeServerlessCachesOutput {
        let reader = responseReader["DescribeServerlessCachesResult"]
        var value = DescribeServerlessCachesOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.serverlessCaches = try reader["ServerlessCaches"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.ServerlessCache.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let serviceUpdateStatus = serviceUpdateStatus {
            if !serviceUpdateStatus.isEmpty {
                ...
                var serviceUpdateStatusContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ServiceUpdateStatus"))
                try serviceUpdateStatusContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
...
extension DescribeServiceUpdatesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeServiceUpdatesOutput {
        let reader = responseReader["DescribeServiceUpdatesResult"]
        var value = DescribeServiceUpdatesOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.serviceUpdates = try reader["ServiceUpdates"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.ServiceUpdate.readingClosure(from:), memberNodeInfo: "ServiceUpdate", isFlattened: false)
        return value
    }
}
...
extension DescribeSnapshotsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeSnapshotsOutput {
        let reader = responseReader["DescribeSnapshotsResult"]
        var value = DescribeSnapshotsOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.snapshots = try reader["Snapshots"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.Snapshot.readingClosure(from:), memberNodeInfo: "Snapshot", isFlattened: false)
        return value
    }
}
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let updateActionStatus = updateActionStatus {
            if !updateActionStatus.isEmpty {
                ...
                var updateActionStatusContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("UpdateActionStatus"))
                try updateActionStatusContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
...
extension DescribeUpdateActionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeUpdateActionsOutput {
        let reader = responseReader["DescribeUpdateActionsResult"]
        var value = DescribeUpdateActionsOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.updateActions = try reader["UpdateActions"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.UpdateAction.readingClosure(from:), memberNodeInfo: "UpdateAction", isFlattened: false)
        return value
    }
}
...
extension DescribeUserGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeUserGroupsOutput {
        let reader = responseReader["DescribeUserGroupsResult"]
        var value = DescribeUserGroupsOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.userGroups = try reader["UserGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.UserGroup.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeUsersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeUsersOutput {
        let reader = responseReader["DescribeUsersResult"]
        var value = DescribeUsersOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.users = try reader["Users"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.User.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.DestinationDetails: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.DestinationDetails {
        var value = ElastiCacheClientTypes.DestinationDetails()
        value.cloudWatchLogsDetails = try reader["CloudWatchLogsDetails"].readIfPresent(readingClosure: ElastiCacheClientTypes.CloudWatchLogsDestinationDetails.readingClosure(from:))
        value.kinesisFirehoseDetails = try reader["KinesisFirehoseDetails"].readIfPresent(readingClosure: ElastiCacheClientTypes.KinesisFirehoseDestinationDetails.readingClosure(from:))
        return value
    }
}
...
extension DisassociateGlobalReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DisassociateGlobalReplicationGroupOutput {
...
extension ElastiCacheClientTypes.EC2SecurityGroup: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case ec2SecurityGroupName = "EC2SecurityGroupName"
        case ec2SecurityGroupOwnerId = "EC2SecurityGroupOwnerId"
        case status = "Status"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.EC2SecurityGroup {
...
extension ElastiCacheClientTypes.ECPUPerSecond: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ECPUPerSecond {
...
extension ElastiCacheClientTypes.Endpoint: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.Endpoint {
...
extension ElastiCacheClientTypes.EngineDefaults: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let cacheNodeTypeSpecificParameters = cacheNodeTypeSpecificParameters {
            if !cacheNodeTypeSpecificParameters.isEmpty {
                ...
                var cacheNodeTypeSpecificParametersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CacheNodeTypeSpecificParameters"))
                try cacheNodeTypeSpecificParametersContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let cacheParameterGroupFamily = cacheParameterGroupFamily {
            try container.encode(cacheParameterGroupFamily, forKey: ClientRuntime.Key("CacheParameterGroupFamily"))
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.EngineDefaults {
...
extension ElastiCacheClientTypes.Event: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case date = "Date"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.Event {
...
extension ExportServerlessCacheSnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ExportServerlessCacheSnapshotOutput {
...
extension FailoverGlobalReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> FailoverGlobalReplicationGroupOutput {
...
extension ElastiCacheClientTypes.Filter: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case values = "Values"
    }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.Filter {
...
extension ElastiCacheClientTypes.GlobalNodeGroup: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.GlobalNodeGroup {
...
extension ElastiCacheClientTypes.GlobalReplicationGroup: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
        case atRestEncryptionEnabled = "AtRestEncryptionEnabled"
        case authTokenEnabled = "AuthTokenEnabled"
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let globalNodeGroups = globalNodeGroups {
            if !globalNodeGroups.isEmpty {
                ...
                var globalNodeGroupsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("GlobalNodeGroups"))
                try globalNodeGroupsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let globalReplicationGroupDescription = globalReplicationGroupDescription {
            try container.encode(globalReplicationGroupDescription, forKey: ClientRuntime.Key("GlobalReplicationGroupDescription"))
        ...
        if let members = members {
            if !members.isEmpty {
                ...
                var membersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Members"))
                try membersContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let status = status {
            try container.encode(status, forKey: ClientRuntime.Key("Status"))
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.GlobalReplicationGroup {
        ...
        value.engine = try reader["Engine"].readIfPresent()
        value.engineVersion = try reader["EngineVersion"].readIfPresent()
        value.members = try reader["Members"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.GlobalReplicationGroupMember.readingClosure(from:), memberNodeInfo: "GlobalReplicationGroupMember", isFlattened: false)
        value.clusterEnabled = try reader["ClusterEnabled"].readIfPresent()
        value.globalNodeGroups = try reader["GlobalNodeGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.GlobalNodeGroup.readingClosure(from:), memberNodeInfo: "GlobalNodeGroup", isFlattened: false)
        value.authTokenEnabled = try reader["AuthTokenEnabled"].readIfPresent()
        value.transitEncryptionEnabled = try reader["TransitEncryptionEnabled"].readIfPresent()
        value.atRestEncryptionEnabled = try reader["AtRestEncryptionEnabled"].readIfPresent()
        value.arn = try reader["ARN"].readIfPresent()
...
extension ElastiCacheClientTypes.GlobalReplicationGroupInfo: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case globalReplicationGroupId = "GlobalReplicationGroupId"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.GlobalReplicationGroupInfo {
...
extension ElastiCacheClientTypes.GlobalReplicationGroupMember: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.GlobalReplicationGroupMember {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let regionalConfigurations = regionalConfigurations {
            if !regionalConfigurations.isEmpty {
                ...
                var regionalConfigurationsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("RegionalConfigurations"))
                try regionalConfigurationsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
...
extension IncreaseNodeGroupsInGlobalReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> IncreaseNodeGroupsInGlobalReplicationGroupOutput {
...
extension IncreaseReplicaCountOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> IncreaseReplicaCountOutput {
...
extension ElastiCacheClientTypes {
    public enum IpDiscovery: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Codable, Swift.Hashable {
        case ipv4
        case ipv6
        case sdkUnknown(Swift.String)
        ...
        public init(from decoder: Swift.Decoder) throws {
            let container = try decoder.singleValueContainer()
            let rawValue = try container.decode(RawValue.self)
            self = IpDiscovery(rawValue: rawValue) ?? IpDiscovery.sdkUnknown(rawValue)
        }
    }
}

extension ElastiCacheClientTypes.KinesisFirehoseDestinationDetails: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.KinesisFirehoseDestinationDetails {
...
extension ListAllowedNodeTypeModificationsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListAllowedNodeTypeModificationsOutput {
        let reader = responseReader["ListAllowedNodeTypeModificationsResult"]
        var value = ListAllowedNodeTypeModificationsOutput()
        value.scaleDownModifications = try reader["ScaleDownModifications"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.scaleUpModifications = try reader["ScaleUpModifications"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.LogDeliveryConfiguration: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.LogDeliveryConfiguration {
        ...
        value.destinationDetails = try reader["DestinationDetails"].readIfPresent(readingClosure: ElastiCacheClientTypes.DestinationDetails.readingClosure(from:))
...
extension ElastiCacheClientTypes.LogDeliveryConfigurationRequest: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case destinationDetails = "DestinationDetails"
        case destinationType = "DestinationType"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.LogDeliveryConfigurationRequest {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let cacheNodeIdsToRemove = cacheNodeIdsToRemove {
            if !cacheNodeIdsToRemove.isEmpty {
                ...
                var cacheNodeIdsToRemoveContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CacheNodeIdsToRemove"))
                try cacheNodeIdsToRemoveContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let cacheNodeType = cacheNodeType {
            try container.encode(cacheNodeType, forKey: ClientRuntime.Key("CacheNodeType"))
        ...
        if let newAvailabilityZones = newAvailabilityZones {
            if !newAvailabilityZones.isEmpty {
                ...
                var newAvailabilityZonesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NewAvailabilityZones"))
                try newAvailabilityZonesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let notificationTopicArn = notificationTopicArn {
            try container.encode(notificationTopicArn, forKey: ClientRuntime.Key("NotificationTopicArn"))
...
extension ModifyCacheClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyCacheClusterOutput {
...
extension ModifyCacheParameterGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyCacheParameterGroupOutput {
...
extension ModifyCacheSubnetGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyCacheSubnetGroupOutput {
...
extension ModifyGlobalReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyGlobalReplicationGroupOutput {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let userGroupIdsToAdd = userGroupIdsToAdd {
            if !userGroupIdsToAdd.isEmpty {
                ...
                var userGroupIdsToAddContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("UserGroupIdsToAdd"))
                try userGroupIdsToAddContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let userGroupIdsToRemove = userGroupIdsToRemove {
            if !userGroupIdsToRemove.isEmpty {
                ...
                var userGroupIdsToRemoveContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("UserGroupIdsToRemove"))
                try userGroupIdsToRemoveContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
...
extension ModifyReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyReplicationGroupOutput {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let nodeGroupsToRemove = nodeGroupsToRemove {
            if !nodeGroupsToRemove.isEmpty {
                ...
                var nodeGroupsToRemoveContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NodeGroupsToRemove"))
                try nodeGroupsToRemoveContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let nodeGroupsToRetain = nodeGroupsToRetain {
            if !nodeGroupsToRetain.isEmpty {
                ...
                var nodeGroupsToRetainContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NodeGroupsToRetain"))
                try nodeGroupsToRetainContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let replicationGroupId = replicationGroupId {
            try container.encode(replicationGroupId, forKey: ClientRuntime.Key("ReplicationGroupId"))
        ...
        if let reshardingConfiguration = reshardingConfiguration {
            if !reshardingConfiguration.isEmpty {
                ...
                var reshardingConfigurationContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ReshardingConfiguration"))
                try reshardingConfigurationContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
...
extension ModifyReplicationGroupShardConfigurationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyReplicationGroupShardConfigurationOutput {
...
extension ModifyServerlessCacheOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyServerlessCacheOutput {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let userIdsToAdd = userIdsToAdd {
            if !userIdsToAdd.isEmpty {
                ...
                var userIdsToAddContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("UserIdsToAdd"))
                try userIdsToAddContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let userIdsToRemove = userIdsToRemove {
            if !userIdsToRemove.isEmpty {
                ...
                var userIdsToRemoveContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("UserIdsToRemove"))
                try userIdsToRemoveContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
...
extension ModifyUserGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyUserGroupOutput {
...
extension ModifyUserOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyUserOutput {
...
extension ElastiCacheClientTypes {
    public enum NetworkType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Codable, Swift.Hashable {
        case dualStack
        case ipv4
        case ipv6
        case sdkUnknown(Swift.String)
        ...
        public init(from decoder: Swift.Decoder) throws {
            let container = try decoder.singleValueContainer()
            let rawValue = try container.decode(RawValue.self)
            self = NetworkType(rawValue: rawValue) ?? NetworkType.sdkUnknown(rawValue)
        }
    }
}
...
extension ElastiCacheClientTypes.NodeGroup: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case nodeGroupId = "NodeGroupId"
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let nodeGroupMembers = nodeGroupMembers {
            if !nodeGroupMembers.isEmpty {
                ...
                var nodeGroupMembersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NodeGroupMembers"))
                try nodeGroupMembersContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.NodeGroup {
        var value = ElastiCacheClientTypes.NodeGroup()
        value.nodeGroupId = try reader["NodeGroupId"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
        value.primaryEndpoint = try reader["PrimaryEndpoint"].readIfPresent(readingClosure: ElastiCacheClientTypes.Endpoint.readingClosure(from:))
        value.readerEndpoint = try reader["ReaderEndpoint"].readIfPresent(readingClosure: ElastiCacheClientTypes.Endpoint.readingClosure(from:))
        value.slots = try reader["Slots"].readIfPresent()
        value.nodeGroupMembers = try reader["NodeGroupMembers"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.NodeGroupMember.readingClosure(from:), memberNodeInfo: "NodeGroupMember", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.NodeGroupConfiguration: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case nodeGroupId = "NodeGroupId"
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let replicaAvailabilityZones = replicaAvailabilityZones {
            if !replicaAvailabilityZones.isEmpty {
                ...
                var replicaAvailabilityZonesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ReplicaAvailabilityZones"))
                try replicaAvailabilityZonesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let replicaOutpostArns = replicaOutpostArns {
            if !replicaOutpostArns.isEmpty {
                ...
                var replicaOutpostArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ReplicaOutpostArns"))
                try replicaOutpostArnsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let slots = slots {
            try container.encode(slots, forKey: ClientRuntime.Key("Slots"))
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.NodeGroupConfiguration {
        ...
        value.replicaAvailabilityZones = try reader["ReplicaAvailabilityZones"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "AvailabilityZone", isFlattened: false)
        value.primaryOutpostArn = try reader["PrimaryOutpostArn"].readIfPresent()
        value.replicaOutpostArns = try reader["ReplicaOutpostArns"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "OutpostArn", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.NodeGroupMember: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheClusterId = "CacheClusterId"
        case cacheNodeId = "CacheNodeId"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.NodeGroupMember {
        var value = ElastiCacheClientTypes.NodeGroupMember()
        value.cacheClusterId = try reader["CacheClusterId"].readIfPresent()
        value.cacheNodeId = try reader["CacheNodeId"].readIfPresent()
        value.readEndpoint = try reader["ReadEndpoint"].readIfPresent(readingClosure: ElastiCacheClientTypes.Endpoint.readingClosure(from:))
        value.preferredAvailabilityZone = try reader["PreferredAvailabilityZone"].readIfPresent()
        value.preferredOutpostArn = try reader["PreferredOutpostArn"].readIfPresent()
...
extension ElastiCacheClientTypes.NodeGroupMemberUpdateStatus: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheClusterId = "CacheClusterId"
        case cacheNodeId = "CacheNodeId"
        case nodeDeletionDate = "NodeDeletionDate"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.NodeGroupMemberUpdateStatus {
...
extension ElastiCacheClientTypes.NodeGroupUpdateStatus: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case nodeGroupId = "NodeGroupId"
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let nodeGroupMemberUpdateStatus = nodeGroupMemberUpdateStatus {
            if !nodeGroupMemberUpdateStatus.isEmpty {
                ...
                var nodeGroupMemberUpdateStatusContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NodeGroupMemberUpdateStatus"))
                try nodeGroupMemberUpdateStatusContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    }

    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.NodeGroupUpdateStatus {
        var value = ElastiCacheClientTypes.NodeGroupUpdateStatus()
        value.nodeGroupId = try reader["NodeGroupId"].readIfPresent()
        value.nodeGroupMemberUpdateStatus = try reader["NodeGroupMemberUpdateStatus"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.NodeGroupMemberUpdateStatus.readingClosure(from:), memberNodeInfo: "NodeGroupMemberUpdateStatus", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.NodeSnapshot: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheClusterId = "CacheClusterId"
        case cacheNodeCreateTime = "CacheNodeCreateTime"
        case cacheNodeId = "CacheNodeId"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.NodeSnapshot {
        var value = ElastiCacheClientTypes.NodeSnapshot()
        value.cacheClusterId = try reader["CacheClusterId"].readIfPresent()
        value.nodeGroupId = try reader["NodeGroupId"].readIfPresent()
        value.cacheNodeId = try reader["CacheNodeId"].readIfPresent()
        value.nodeGroupConfiguration = try reader["NodeGroupConfiguration"].readIfPresent(readingClosure: ElastiCacheClientTypes.NodeGroupConfiguration.readingClosure(from:))
...
extension ElastiCacheClientTypes.NotificationConfiguration: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.NotificationConfiguration {
...
extension ElastiCacheClientTypes.Parameter: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case allowedValues = "AllowedValues"
        case changeType = "ChangeType"
        case dataType = "DataType"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.Parameter {
...
extension ElastiCacheClientTypes.ParameterNameValue: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case parameterName = "ParameterName"
        case parameterValue = "ParameterValue"
    }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ParameterNameValue {
...
extension ElastiCacheClientTypes.PendingLogDeliveryConfiguration: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case destinationDetails = "DestinationDetails"
        case destinationType = "DestinationType"
        case logFormat = "LogFormat"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.PendingLogDeliveryConfiguration {
...
extension ElastiCacheClientTypes.PendingModifiedValues: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.PendingModifiedValues {
        var value = ElastiCacheClientTypes.PendingModifiedValues()
        value.numCacheNodes = try reader["NumCacheNodes"].readIfPresent()
        value.cacheNodeIdsToRemove = try reader["CacheNodeIdsToRemove"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "CacheNodeId", isFlattened: false)
        value.engineVersion = try reader["EngineVersion"].readIfPresent()
        value.cacheNodeType = try reader["CacheNodeType"].readIfPresent()
        value.authTokenStatus = try reader["AuthTokenStatus"].readIfPresent()
        value.logDeliveryConfigurations = try reader["LogDeliveryConfigurations"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.PendingLogDeliveryConfiguration.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.transitEncryptionEnabled = try reader["TransitEncryptionEnabled"].readIfPresent()
        value.transitEncryptionMode = try reader["TransitEncryptionMode"].readIfPresent()
        return value
    }
...
extension ElastiCacheClientTypes.ProcessedUpdateAction: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheClusterId = "CacheClusterId"
        case replicationGroupId = "ReplicationGroupId"
        case serviceUpdateName = "ServiceUpdateName"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ProcessedUpdateAction {
...
extension PurchaseReservedCacheNodesOfferingOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PurchaseReservedCacheNodesOfferingOutput {
        let reader = responseReader["PurchaseReservedCacheNodesOfferingResult"]
        var value = PurchaseReservedCacheNodesOfferingOutput()
        value.reservedCacheNode = try reader["ReservedCacheNode"].readIfPresent(readingClosure: ElastiCacheClientTypes.ReservedCacheNode.readingClosure(from:))
        return value
    }
}
...
extension RebalanceSlotsInGlobalReplicationGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RebalanceSlotsInGlobalReplicationGroupOutput {
...
extension RebootCacheClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RebootCacheClusterOutput {
...
extension ElastiCacheClientTypes.RecurringCharge: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.RecurringCharge {
...
extension ElastiCacheClientTypes.RegionalConfiguration: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case replicationGroupId = "ReplicationGroupId"
        case replicationGroupRegion = "ReplicationGroupRegion"
        case reshardingConfiguration = "ReshardingConfiguration"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.RegionalConfiguration {
        var value = ElastiCacheClientTypes.RegionalConfiguration()
        value.replicationGroupId = try reader["ReplicationGroupId"].readIfPresent()
        value.replicationGroupRegion = try reader["ReplicationGroupRegion"].readIfPresent()
        value.reshardingConfiguration = try reader["ReshardingConfiguration"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.ReshardingConfiguration.readingClosure(from:), memberNodeInfo: "ReshardingConfiguration", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.ReplicationGroup: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
        case atRestEncryptionEnabled = "AtRestEncryptionEnabled"
        case authTokenEnabled = "AuthTokenEnabled"
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let memberClusters = memberClusters {
            if !memberClusters.isEmpty {
                ...
                var memberClustersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("MemberClusters"))
                try memberClustersContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let memberClustersOutpostArns = memberClustersOutpostArns {
            if !memberClustersOutpostArns.isEmpty {
                ...
                var memberClustersOutpostArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("MemberClustersOutpostArns"))
                try memberClustersOutpostArnsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let nodeGroups = nodeGroups {
            if !nodeGroups.isEmpty {
                ...
                var nodeGroupsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NodeGroups"))
                try nodeGroupsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let pendingModifiedValues = pendingModifiedValues {
            try container.encode(pendingModifiedValues, forKey: ClientRuntime.Key("PendingModifiedValues"))
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ReplicationGroup {
        var value = ElastiCacheClientTypes.ReplicationGroup()
        value.replicationGroupId = try reader["ReplicationGroupId"].readIfPresent()
        value.description = try reader["Description"].readIfPresent()
        value.globalReplicationGroupInfo = try reader["GlobalReplicationGroupInfo"].readIfPresent(readingClosure: ElastiCacheClientTypes.GlobalReplicationGroupInfo.readingClosure(from:))
        value.status = try reader["Status"].readIfPresent()
        value.pendingModifiedValues = try reader["PendingModifiedValues"].readIfPresent(readingClosure: ElastiCacheClientTypes.ReplicationGroupPendingModifiedValues.readingClosure(from:))
        value.memberClusters = try reader["MemberClusters"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "ClusterId", isFlattened: false)
        value.nodeGroups = try reader["NodeGroups"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.NodeGroup.readingClosure(from:), memberNodeInfo: "NodeGroup", isFlattened: false)
        ...
        value.transitEncryptionEnabled = try reader["TransitEncryptionEnabled"].readIfPresent()
        value.atRestEncryptionEnabled = try reader["AtRestEncryptionEnabled"].readIfPresent()
        value.memberClustersOutpostArns = try reader["MemberClustersOutpostArns"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "ReplicationGroupOutpostArn", isFlattened: false)
...
extension ElastiCacheClientTypes.ReplicationGroupPendingModifiedValues: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case authTokenStatus = "AuthTokenStatus"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ReplicationGroupPendingModifiedValues {
        ...
        value.resharding = try reader["Resharding"].readIfPresent(readingClosure: ElastiCacheClientTypes.ReshardingStatus.readingClosure(from:))
        value.authTokenStatus = try reader["AuthTokenStatus"].readIfPresent()
        value.userGroups = try reader["UserGroups"].readIfPresent(readingClosure: ElastiCacheClientTypes.UserGroupsUpdateStatus.readingClosure(from:))
        value.logDeliveryConfigurations = try reader["LogDeliveryConfigurations"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.PendingLogDeliveryConfiguration.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.transitEncryptionEnabled = try reader["TransitEncryptionEnabled"].readIfPresent()
        value.transitEncryptionMode = try reader["TransitEncryptionMode"].readIfPresent()
        value.clusterMode = try reader["ClusterMode"].readIfPresent()
...
extension ElastiCacheClientTypes.ReservedCacheNode: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheNodeCount = "CacheNodeCount"
        case cacheNodeType = "CacheNodeType"
        case duration = "Duration"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ReservedCacheNode {
        ...
        value.recurringCharges = try reader["RecurringCharges"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.RecurringCharge.readingClosure(from:), memberNodeInfo: "RecurringCharge", isFlattened: false)
...
extension ElastiCacheClientTypes.ReservedCacheNodesOffering: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheNodeType = "CacheNodeType"
        case duration = "Duration"
        case fixedPrice = "FixedPrice"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ReservedCacheNodesOffering {
...
extension ResetCacheParameterGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ResetCacheParameterGroupOutput {
...
extension ElastiCacheClientTypes.ReshardingConfiguration: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case nodeGroupId = "NodeGroupId"
        case preferredAvailabilityZones = "PreferredAvailabilityZones"
    }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ReshardingConfiguration {
        var value = ElastiCacheClientTypes.ReshardingConfiguration()
        value.nodeGroupId = try reader["NodeGroupId"].readIfPresent()
        value.preferredAvailabilityZones = try reader["PreferredAvailabilityZones"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "AvailabilityZone", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.ReshardingStatus: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ReshardingStatus {
        var value = ElastiCacheClientTypes.ReshardingStatus()
        value.slotMigration = try reader["SlotMigration"].readIfPresent(readingClosure: ElastiCacheClientTypes.SlotMigration.readingClosure(from:))
        return value
    }
}
...
extension RevokeCacheSecurityGroupIngressOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RevokeCacheSecurityGroupIngressOutput {
...
extension ElastiCacheClientTypes.SecurityGroupMembership: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.SecurityGroupMembership {
...
extension ElastiCacheClientTypes.ServerlessCache: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
        case cacheUsageLimits = "CacheUsageLimits"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ServerlessCache {
        ...
        value.cacheUsageLimits = try reader["CacheUsageLimits"].readIfPresent(readingClosure: ElastiCacheClientTypes.CacheUsageLimits.readingClosure(from:))
        value.kmsKeyId = try reader["KmsKeyId"].readIfPresent()
        value.securityGroupIds = try reader["SecurityGroupIds"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "SecurityGroupId", isFlattened: false)
        value.endpoint = try reader["Endpoint"].readIfPresent(readingClosure: ElastiCacheClientTypes.Endpoint.readingClosure(from:))
        value.readerEndpoint = try reader["ReaderEndpoint"].readIfPresent(readingClosure: ElastiCacheClientTypes.Endpoint.readingClosure(from:))
        value.arn = try reader["ARN"].readIfPresent()
        value.userGroupId = try reader["UserGroupId"].readIfPresent()
        value.subnetIds = try reader["SubnetIds"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "SubnetId", isFlattened: false)
        value.snapshotRetentionLimit = try reader["SnapshotRetentionLimit"].readIfPresent()
...
extension ElastiCacheClientTypes.ServerlessCacheConfiguration: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case engine = "Engine"
        case majorEngineVersion = "MajorEngineVersion"
        case serverlessCacheName = "ServerlessCacheName"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ServerlessCacheConfiguration {
...
extension ElastiCacheClientTypes.ServerlessCacheSnapshot: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ServerlessCacheSnapshot {
        ...
        value.serverlessCacheConfiguration = try reader["ServerlessCacheConfiguration"].readIfPresent(readingClosure: ElastiCacheClientTypes.ServerlessCacheConfiguration.readingClosure(from:))
        return value
    }
}
...
extension ElastiCacheClientTypes.ServiceUpdate: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ServiceUpdate {
...
extension ElastiCacheClientTypes.SlotMigration: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.SlotMigration {
...
extension ElastiCacheClientTypes.Snapshot: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
        case autoMinorVersionUpgrade = "AutoMinorVersionUpgrade"
        case automaticFailover = "AutomaticFailover"
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let nodeSnapshots = nodeSnapshots {
            if !nodeSnapshots.isEmpty {
                ...
                var nodeSnapshotsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NodeSnapshots"))
                try nodeSnapshotsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let numCacheNodes = numCacheNodes {
            try container.encode(numCacheNodes, forKey: ClientRuntime.Key("NumCacheNodes"))
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.Snapshot {
        ...
        value.automaticFailover = try reader["AutomaticFailover"].readIfPresent()
        value.nodeSnapshots = try reader["NodeSnapshots"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.NodeSnapshot.readingClosure(from:), memberNodeInfo: "NodeSnapshot", isFlattened: false)
        value.kmsKeyId = try reader["KmsKeyId"].readIfPresent()
        value.arn = try reader["ARN"].readIfPresent()
        value.dataTiering = try reader["DataTiering"].readIfPresent()
        return value
...
extension StartMigrationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> StartMigrationOutput {
...
extension ElastiCacheClientTypes.Subnet: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.Subnet {
        var value = ElastiCacheClientTypes.Subnet()
        value.subnetIdentifier = try reader["SubnetIdentifier"].readIfPresent()
        value.subnetAvailabilityZone = try reader["SubnetAvailabilityZone"].readIfPresent(readingClosure: ElastiCacheClientTypes.AvailabilityZone.readingClosure(from:))
        value.subnetOutpost = try reader["SubnetOutpost"].readIfPresent(readingClosure: ElastiCacheClientTypes.SubnetOutpost.readingClosure(from:))
        value.supportedNetworkTypes = try reader["SupportedNetworkTypes"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.NetworkType.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.SubnetOutpost: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.SubnetOutpost {
...
extension ElastiCacheClientTypes.Tag: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.Tag {
...
extension TestFailoverOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TestFailoverOutput {
...
extension TestMigrationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TestMigrationOutput {
...
extension ElastiCacheClientTypes.TimeRangeFilter: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case endTime = "EndTime"
        case startTime = "StartTime"
    }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.TimeRangeFilter {
...
extension ElastiCacheClientTypes.UnprocessedUpdateAction: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheClusterId = "CacheClusterId"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.UnprocessedUpdateAction {
...
extension ElastiCacheClientTypes.UpdateAction: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cacheClusterId = "CacheClusterId"
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let cacheNodeUpdateStatus = cacheNodeUpdateStatus {
            if !cacheNodeUpdateStatus.isEmpty {
                ...
                var cacheNodeUpdateStatusContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CacheNodeUpdateStatus"))
                try cacheNodeUpdateStatusContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let engine = engine {
            try container.encode(engine, forKey: ClientRuntime.Key("Engine"))
        ...
        if let nodeGroupUpdateStatus = nodeGroupUpdateStatus {
            if !nodeGroupUpdateStatus.isEmpty {
                ...
                var nodeGroupUpdateStatusContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NodeGroupUpdateStatus"))
                try nodeGroupUpdateStatusContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.UpdateAction {
        ...
        value.nodeGroupUpdateStatus = try reader["NodeGroupUpdateStatus"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.NodeGroupUpdateStatus.readingClosure(from:), memberNodeInfo: "NodeGroupUpdateStatus", isFlattened: false)
        value.cacheNodeUpdateStatus = try reader["CacheNodeUpdateStatus"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.CacheNodeUpdateStatus.readingClosure(from:), memberNodeInfo: "CacheNodeUpdateStatus", isFlattened: false)
        value.estimatedUpdateTime = try reader["EstimatedUpdateTime"].readIfPresent()
        value.engine = try reader["Engine"].readIfPresent()
        return value
    }
...
extension ElastiCacheClientTypes.User: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
        case accessString = "AccessString"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.User {
...
extension ElastiCacheClientTypes.UserGroup: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "ARN"
        case engine = "Engine"
        case minimumEngineVersion = "MinimumEngineVersion"
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.UserGroup {
...
extension ElastiCacheClientTypes.UserGroupPendingChanges: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case userIdsToAdd = "UserIdsToAdd"
        case userIdsToRemove = "UserIdsToRemove"
    }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.UserGroupPendingChanges {
        var value = ElastiCacheClientTypes.UserGroupPendingChanges()
        value.userIdsToRemove = try reader["UserIdsToRemove"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.userIdsToAdd = try reader["UserIdsToAdd"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.UserGroupsUpdateStatus: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case userGroupIdsToAdd = "UserGroupIdsToAdd"
        case userGroupIdsToRemove = "UserGroupIdsToRemove"
    }
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.UserGroupsUpdateStatus {
        var value = ElastiCacheClientTypes.UserGroupsUpdateStatus()
        value.userGroupIdsToAdd = try reader["UserGroupIdsToAdd"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.userGroupIdsToRemove = try reader["UserGroupIdsToRemove"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
