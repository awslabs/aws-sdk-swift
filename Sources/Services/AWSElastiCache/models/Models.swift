...
extension AuthorizeCacheSecurityGroupIngressOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AuthorizeCacheSecurityGroupIngressOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension BatchApplyUpdateActionInput {
    ...
    static func write(value: BatchApplyUpdateActionInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["CacheClusterIds"].writeList(value.cacheClusterIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ReplicationGroupIds"].writeList(value.replicationGroupIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension BatchApplyUpdateActionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchApplyUpdateActionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension BatchStopUpdateActionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchStopUpdateActionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ElastiCacheClientTypes.CacheParameterGroupStatus {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheParameterGroupStatus {
        ...
        value.cacheNodeIdsToReboot = try reader["CacheNodeIdsToReboot"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "CacheNodeId", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.CacheSubnetGroup {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheSubnetGroup {
        ...
        value.arn = try reader["ARN"].readIfPresent()
        value.supportedNetworkTypes = try reader["SupportedNetworkTypes"].readListIfPresent(memberReadingClosure: ElastiCacheClientTypes.NetworkType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CompleteMigrationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CompleteMigrationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension CopyServerlessCacheSnapshotOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CopyServerlessCacheSnapshotOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension CreateCacheClusterInput {
    ...
    static func write(value: CreateCacheClusterInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["CacheSecurityGroupNames"].writeList(value.cacheSecurityGroupNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "CacheSecurityGroupName", isFlattened: false)
        ...
        try writer["SnapshotArns"].writeList(value.snapshotArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "SnapshotArn", isFlattened: false)
...
extension CreateCacheClusterOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCacheClusterOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension CreateCacheParameterGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCacheParameterGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension CreateCacheSecurityGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCacheSecurityGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension CreateCacheSubnetGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCacheSubnetGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension CreateGlobalReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateGlobalReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension CreateReplicationGroupInput {
    ...
    static func write(value: CreateReplicationGroupInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Port"].write(value.port)
        try writer["PreferredCacheClusterAZs"].writeList(value.preferredCacheClusterAZs, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "AvailabilityZone", isFlattened: false)
        try writer["PreferredMaintenanceWindow"].write(value.preferredMaintenanceWindow)
...
extension CreateReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension CreateServerlessCacheInput {
    ...
    static func write(value: CreateServerlessCacheInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["SnapshotArnsToRestore"].writeList(value.snapshotArnsToRestore, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "SnapshotArn", isFlattened: false)
        try writer["SnapshotRetentionLimit"].write(value.snapshotRetentionLimit)
...
extension CreateServerlessCacheOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateServerlessCacheOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension CreateServerlessCacheSnapshotOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateServerlessCacheSnapshotOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension CreateUserGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateUserGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
        ...
        value.replicationGroups = try reader["ReplicationGroups"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.serverlessCaches = try reader["ServerlessCaches"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["Status"].readIfPresent()
...
extension CreateUserOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateUserOutput {
        ...
        value.minimumEngineVersion = try reader["MinimumEngineVersion"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
        value.userGroupIds = try reader["UserGroupIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DecreaseNodeGroupsInGlobalReplicationGroupInput {
    ...
    static func write(value: DecreaseNodeGroupsInGlobalReplicationGroupInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["GlobalNodeGroupsToRemove"].writeList(value.globalNodeGroupsToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "GlobalNodeGroupId", isFlattened: false)
        try writer["GlobalNodeGroupsToRetain"].writeList(value.globalNodeGroupsToRetain, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "GlobalNodeGroupId", isFlattened: false)
        try writer["GlobalReplicationGroupId"].write(value.globalReplicationGroupId)
...
extension DecreaseNodeGroupsInGlobalReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DecreaseNodeGroupsInGlobalReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DecreaseReplicaCountInput {
    ...
    static func write(value: DecreaseReplicaCountInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["ReplicasToRemove"].writeList(value.replicasToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ReplicationGroupId"].write(value.replicationGroupId)
...
extension DecreaseReplicaCountOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DecreaseReplicaCountOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DeleteCacheClusterOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCacheClusterOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DeleteCacheParameterGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCacheParameterGroupOutput {
...
extension DeleteCacheSecurityGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCacheSecurityGroupOutput {
...
extension DeleteCacheSubnetGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCacheSubnetGroupOutput {
...
extension DeleteGlobalReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteGlobalReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DeleteReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DeleteServerlessCacheOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteServerlessCacheOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DeleteServerlessCacheSnapshotOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteServerlessCacheSnapshotOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DeleteUserGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteUserGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeCacheClustersOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCacheClustersOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeCacheEngineVersionsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCacheEngineVersionsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeCacheParameterGroupsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCacheParameterGroupsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeCacheParametersOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCacheParametersOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeCacheSecurityGroupsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCacheSecurityGroupsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeCacheSubnetGroupsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCacheSubnetGroupsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeGlobalReplicationGroupsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeGlobalReplicationGroupsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeReplicationGroupsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeReplicationGroupsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeReservedCacheNodesOfferingsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeReservedCacheNodesOfferingsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeReservedCacheNodesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeReservedCacheNodesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeServerlessCacheSnapshotsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeServerlessCacheSnapshotsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeServerlessCachesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeServerlessCachesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeServiceUpdatesInput {
    ...
    static func write(value: DescribeServiceUpdatesInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["MaxRecords"].write(value.maxRecords)
        try writer["ServiceUpdateName"].write(value.serviceUpdateName)
        try writer["ServiceUpdateStatus"].writeList(value.serviceUpdateStatus, memberWritingClosure: ElastiCacheClientTypes.ServiceUpdateStatus.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeUpdateActionsInput {
    ...
    static func write(value: DescribeUpdateActionsInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["UpdateActionStatus"].writeList(value.updateActionStatus, memberWritingClosure: ElastiCacheClientTypes.UpdateActionStatus.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeUpdateActionsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeUpdateActionsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DescribeUserGroupsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeUserGroupsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DisassociateGlobalReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DisassociateGlobalReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ExportServerlessCacheSnapshotOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ExportServerlessCacheSnapshotOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension FailoverGlobalReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> FailoverGlobalReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension IncreaseNodeGroupsInGlobalReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> IncreaseNodeGroupsInGlobalReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension IncreaseReplicaCountOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> IncreaseReplicaCountOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ListAllowedNodeTypeModificationsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAllowedNodeTypeModificationsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
        let reader = responseReader["ListAllowedNodeTypeModificationsResult"]
        var value = ListAllowedNodeTypeModificationsOutput()
        value.scaleDownModifications = try reader["ScaleDownModifications"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.scaleUpModifications = try reader["ScaleUpModifications"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ModifyCacheClusterInput {
    ...
    static func write(value: ModifyCacheClusterInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["IpDiscovery"].write(value.ipDiscovery)
        try writer["LogDeliveryConfigurations"].writeList(value.logDeliveryConfigurations, memberWritingClosure: ElastiCacheClientTypes.LogDeliveryConfigurationRequest.write(value:to:), memberNodeInfo: "LogDeliveryConfigurationRequest", isFlattened: false)
        try writer["NewAvailabilityZones"].writeList(value.newAvailabilityZones, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "PreferredAvailabilityZone", isFlattened: false)
        try writer["NotificationTopicArn"].write(value.notificationTopicArn)
...
extension ModifyCacheClusterOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ModifyCacheClusterOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ModifyCacheParameterGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ModifyCacheParameterGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ModifyCacheSubnetGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ModifyCacheSubnetGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ModifyGlobalReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ModifyGlobalReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ModifyReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ModifyReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ModifyReplicationGroupShardConfigurationInput {
    ...
    static func write(value: ModifyReplicationGroupShardConfigurationInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["ApplyImmediately"].write(value.applyImmediately)
        try writer["NodeGroupCount"].write(value.nodeGroupCount)
        try writer["NodeGroupsToRemove"].writeList(value.nodeGroupsToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "NodeGroupToRemove", isFlattened: false)
        try writer["NodeGroupsToRetain"].writeList(value.nodeGroupsToRetain, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "NodeGroupToRetain", isFlattened: false)
        try writer["ReplicationGroupId"].write(value.replicationGroupId)
...
extension ModifyReplicationGroupShardConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ModifyReplicationGroupShardConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ModifyServerlessCacheOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ModifyServerlessCacheOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ModifyUserGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ModifyUserGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ModifyUserOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ModifyUserOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ElastiCacheClientTypes.NodeGroupConfiguration {
    ...
    static func write(value: ElastiCacheClientTypes.NodeGroupConfiguration?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["ReplicaAvailabilityZones"].writeList(value.replicaAvailabilityZones, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "AvailabilityZone", isFlattened: false)
        try writer["ReplicaCount"].write(value.replicaCount)
        try writer["ReplicaOutpostArns"].writeList(value.replicaOutpostArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "OutpostArn", isFlattened: false)
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.NodeGroupConfiguration {
        ...
        value.replicaAvailabilityZones = try reader["ReplicaAvailabilityZones"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "AvailabilityZone", isFlattened: false)
        value.primaryOutpostArn = try reader["PrimaryOutpostArn"].readIfPresent()
        value.replicaOutpostArns = try reader["ReplicaOutpostArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "OutpostArn", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.PendingModifiedValues {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.PendingModifiedValues {
        ...
        value.numCacheNodes = try reader["NumCacheNodes"].readIfPresent()
        value.cacheNodeIdsToRemove = try reader["CacheNodeIdsToRemove"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "CacheNodeId", isFlattened: false)
        value.engineVersion = try reader["EngineVersion"].readIfPresent()
        value.cacheNodeType = try reader["CacheNodeType"].readIfPresent()
...
extension PurchaseReservedCacheNodesOfferingOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PurchaseReservedCacheNodesOfferingOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension RebalanceSlotsInGlobalReplicationGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> RebalanceSlotsInGlobalReplicationGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension RebootCacheClusterOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> RebootCacheClusterOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ElastiCacheClientTypes.ReplicationGroup {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ReplicationGroup {
        ...
        value.memberClusters = try reader["MemberClusters"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "ClusterId", isFlattened: false)
        ...
        value.transitEncryptionEnabled = try reader["TransitEncryptionEnabled"].readIfPresent()
        value.atRestEncryptionEnabled = try reader["AtRestEncryptionEnabled"].readIfPresent()
        value.memberClustersOutpostArns = try reader["MemberClustersOutpostArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "ReplicationGroupOutpostArn", isFlattened: false)
...
extension ResetCacheParameterGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ResetCacheParameterGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension RevokeCacheSecurityGroupIngressOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> RevokeCacheSecurityGroupIngressOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ElastiCacheClientTypes.ServerlessCache {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ServerlessCache {
        ...
        value.kmsKeyId = try reader["KmsKeyId"].readIfPresent()
        value.securityGroupIds = try reader["SecurityGroupIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "SecurityGroupId", isFlattened: false)
        value.endpoint = try reader["Endpoint"].readIfPresent(with: ElastiCacheClientTypes.Endpoint.read(from:))
        value.readerEndpoint = try reader["ReaderEndpoint"].readIfPresent(with: ElastiCacheClientTypes.Endpoint.read(from:))
        value.arn = try reader["ARN"].readIfPresent()
        value.userGroupId = try reader["UserGroupId"].readIfPresent()
        value.subnetIds = try reader["SubnetIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "SubnetId", isFlattened: false)
        value.snapshotRetentionLimit = try reader["SnapshotRetentionLimit"].readIfPresent()
...
extension TestFailoverOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> TestFailoverOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension TestMigrationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> TestMigrationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension ElastiCacheClientTypes.UserGroupPendingChanges {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.UserGroupPendingChanges {
        ...
        value.userIdsToRemove = try reader["UserIdsToRemove"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.userIdsToAdd = try reader["UserIdsToAdd"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElastiCacheClientTypes.UserGroupsUpdateStatus {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.UserGroupsUpdateStatus {
        ...
        value.userGroupIdsToAdd = try reader["UserGroupIdsToAdd"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.userGroupIdsToRemove = try reader["UserGroupIdsToRemove"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
