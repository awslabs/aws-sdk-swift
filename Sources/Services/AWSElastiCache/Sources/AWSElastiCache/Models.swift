...
extension ElastiCacheClientTypes.ReplicationGroup {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ReplicationGroup {
        ...
        value.authTokenLastModifiedDate = try reader["AuthTokenLastModifiedDate"].readTimestampIfPresent(format: .dateTime)
        ...
        value.replicationGroupCreateTime = try reader["ReplicationGroupCreateTime"].readTimestampIfPresent(format: .dateTime)
...
extension ElastiCacheClientTypes.ServerlessCacheSnapshot {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ServerlessCacheSnapshot {
        ...
        value.expiryTime = try reader["ExpiryTime"].readTimestampIfPresent(format: .dateTime)
...
extension ElastiCacheClientTypes.Snapshot {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.Snapshot {
        ...
        value.preferredAvailabilityZone = try reader["PreferredAvailabilityZone"].readIfPresent()
        value.preferredOutpostArn = try reader["PreferredOutpostArn"].readIfPresent()
        value.cacheClusterCreateTime = try reader["CacheClusterCreateTime"].readTimestampIfPresent(format: .dateTime)
...
extension ElastiCacheClientTypes.NodeSnapshot {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.NodeSnapshot {
        ...
        value.cacheNodeCreateTime = try reader["CacheNodeCreateTime"].readTimestampIfPresent(format: .dateTime)
...
extension ElastiCacheClientTypes.ServiceUpdate {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.ServiceUpdate {
        ...
        value.serviceUpdateName = try reader["ServiceUpdateName"].readIfPresent()
        value.serviceUpdateReleaseDate = try reader["ServiceUpdateReleaseDate"].readTimestampIfPresent(format: .dateTime)
        value.serviceUpdateEndDate = try reader["ServiceUpdateEndDate"].readTimestampIfPresent(format: .dateTime)
        value.serviceUpdateSeverity = try reader["ServiceUpdateSeverity"].readIfPresent()
        value.serviceUpdateRecommendedApplyByDate = try reader["ServiceUpdateRecommendedApplyByDate"].readTimestampIfPresent(format: .dateTime)
...
extension ElastiCacheClientTypes.UpdateAction {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.UpdateAction {
        ...
        value.serviceUpdateRecommendedApplyByDate = try reader["ServiceUpdateRecommendedApplyByDate"].readTimestampIfPresent(format: .dateTime)
        value.serviceUpdateType = try reader["ServiceUpdateType"].readIfPresent()
        value.updateActionAvailableDate = try reader["UpdateActionAvailableDate"].readTimestampIfPresent(format: .dateTime)
        value.updateActionStatus = try reader["UpdateActionStatus"].readIfPresent()
        value.nodesUpdated = try reader["NodesUpdated"].readIfPresent()
        value.updateActionStatusModifiedDate = try reader["UpdateActionStatusModifiedDate"].readTimestampIfPresent(format: .dateTime)
...
extension ElastiCacheClientTypes.CacheNodeUpdateStatus {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElastiCacheClientTypes.CacheNodeUpdateStatus {
        ...
        value.nodeDeletionDate = try reader["NodeDeletionDate"].readTimestampIfPresent(format: .dateTime)
        value.nodeUpdateStartDate = try reader["NodeUpdateStartDate"].readTimestampIfPresent(format: .dateTime)
        value.nodeUpdateEndDate = try reader["NodeUpdateEndDate"].readTimestampIfPresent(format: .dateTime)
        value.nodeUpdateInitiatedBy = try reader["NodeUpdateInitiatedBy"].readIfPresent()
        value.nodeUpdateInitiatedDate = try reader["NodeUpdateInitiatedDate"].readTimestampIfPresent(format: .dateTime)
        value.nodeUpdateStatusModifiedDate = try reader["NodeUpdateStatusModifiedDate"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
