...
extension SsmSapClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SsmSapClient.SsmSapClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> SsmSapClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SsmSapClient(config: configuration)
        }
    }
...
extension SsmSapClient.SsmSapClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
