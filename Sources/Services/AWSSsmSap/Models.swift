...
extension UpdateApplicationSettingsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> UpdateApplicationSettingsOutput {
        ...
        value.operationIds = try reader["OperationIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SsmSapClientTypes.Application {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SsmSapClientTypes.Application {
        ...
        value.components = try reader["Components"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension SsmSapClientTypes.Component {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SsmSapClientTypes.Component {
        ...
        value.childComponents = try reader["ChildComponents"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.databases = try reader["Databases"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension SsmSapClientTypes.Operation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SsmSapClientTypes.Operation {
        ...
        value.status = try reader["Status"].readIfPresent()
        value.statusMessage = try reader["StatusMessage"].readIfPresent()
        value.properties = try reader["Properties"].readMapIfPresent(valueReadingClosure: optionalFormOf(readingClosure: Swift.String.read(from:)), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
