...
public struct SsmSapAuthSchemeResolverParameters: SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
...
public protocol SsmSapAuthSchemeResolver: SmithyHTTPAuthAPI.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service SsmSap must conform to.
}

public struct DefaultSsmSapAuthSchemeResolver: SsmSapAuthSchemeResolver {
    ...
    public func resolveAuthScheme(params: SmithyHTTPAuthAPI.AuthSchemeResolverParameters) throws -> [SmithyHTTPAuthAPI.AuthOption] {
        ...
        guard let serviceParams = params as? SsmSapAuthSchemeResolverParameters else {
        ...
        switch serviceParams.operation {
            default:
                ...
                sigv4Option.signingProperties.set(key: SmithyHTTPAuthAPI.SigningPropertyKeys.signingName, value: "ssm-sap")
    ...
    public func constructParameters(context: Smithy.Context) throws -> SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
        ...
        return SsmSapAuthSchemeResolverParameters(authSchemePreference: authSchemePreference, operation: opName, region: opRegion)
    }
}
