...
public class IoTSecureTunnelingClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? IoTSecureTunnelingClient.IoTSecureTunnelingClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? IoTSecureTunnelingClient.IoTSecureTunnelingClientConfiguration {
            config.authSchemeResolver = DefaultIoTSecureTunnelingAuthSchemeResolver()
...
public class IoTSecureTunnelingClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: IoTSecureTunnelingAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
