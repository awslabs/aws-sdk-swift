...
public final class ManagedBlockchainQueryClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: ManagedBlockchainQueryClient.ManagedBlockchainQueryClientConfig) instead")
    public convenience init(config: ManagedBlockchainQueryClient.ManagedBlockchainQueryClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ManagedBlockchainQueryClient.ManagedBlockchainQueryClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ManagedBlockchainQueryClient.ManagedBlockchainQueryClientConfig()
        self.init(config: config)
    }
}
...
extension ManagedBlockchainQueryClient {
    ...
    /// Client configuration for ManagedBlockchainQueryClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ManagedBlockchainQueryClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "ManagedBlockchain Query")
    ...
    @available(*, deprecated, message: "Use ManagedBlockchainQueryClientConfig instead. This class will be removed in a future version.")
    public final class ManagedBlockchainQueryClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ManagedBlockchainQueryClientConfig {
            return try ManagedBlockchainQueryClientConfig(
...
extension ManagedBlockchainQueryClient {
    ...
    public func batchGetTokenBalance(input: BatchGetTokenBalanceInput) async throws -> BatchGetTokenBalanceOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ManagedBlockchain Query"))
