...
public final class BedrockDataAutomationRuntimeClient: AWSClientRuntime.AWSServiceClient {
    ...
    public required init(config: BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfiguration) {
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    public convenience init(region: Swift.String) throws {
        let config = try BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfiguration(region: region)
        self.init(config: config)
    }

    public convenience required init() async throws {
        let config = try await BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfiguration()
        self.init(config: config)
    }
}
...
extension BedrockDataAutomationRuntimeClient {
    ...
    public struct BedrockDataAutomationRuntimeClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Sendable {
