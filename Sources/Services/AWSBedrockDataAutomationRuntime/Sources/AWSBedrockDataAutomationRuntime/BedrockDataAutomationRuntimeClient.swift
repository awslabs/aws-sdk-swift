...
public final class BedrockDataAutomationRuntimeClient: AWSClientRuntime.AWSServiceClient, Sendable {
...
extension BedrockDataAutomationRuntimeClient {
    ...
    public final class BedrockDataAutomationRuntimeClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, @unchecked Sendable {
        ...
        private init(
            ...
            self.logger = telemetryProvider.loggerProvider.getLogger(name: BedrockDataAutomationRuntimeClient.clientName)
        }
        ...
        public convenience init(region: Swift.String) throws {
            self.init(
                ...
                nil,
                DefaultBedrockDataAutomationRuntimeAuthSchemeResolver(),
