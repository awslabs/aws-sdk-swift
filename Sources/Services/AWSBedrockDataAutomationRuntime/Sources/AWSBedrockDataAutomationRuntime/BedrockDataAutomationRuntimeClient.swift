...
public final class BedrockDataAutomationRuntimeClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "BedrockDataAutomationRuntimeClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfig
    let serviceName = "Bedrock Data Automation Runtime"

    @available(*, deprecated, message: "Use BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfig instead")
    public typealias Config = BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfiguration
    public typealias Configuration = BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfig

    public required init(config: BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfig) instead")
    public convenience init(config: BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await BedrockDataAutomationRuntimeClient.BedrockDataAutomationRuntimeClientConfig()
        self.init(config: config)
    }
}
...
extension BedrockDataAutomationRuntimeClient {
    ...
    /// Client configuration for BedrockDataAutomationRuntimeClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct BedrockDataAutomationRuntimeClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Bedrock Data Automation Runtime")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultBedrockDataAutomationRuntimeAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: BedrockDataAutomationRuntimeClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultBedrockDataAutomationRuntimeAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use BedrockDataAutomationRuntimeClientConfig instead. This class will be removed in a future version.")
    public final class BedrockDataAutomationRuntimeClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> BedrockDataAutomationRuntimeClientConfig {
            return try BedrockDataAutomationRuntimeClientConfig(
    ...
    public static func builder() -> ClientRuntime.ClientBuilder<BedrockDataAutomationRuntimeClient> {
        return ClientRuntime.ClientBuilder<BedrockDataAutomationRuntimeClient>(defaultPlugins: [
...
extension BedrockDataAutomationRuntimeClient {
    ...
    public func getDataAutomationStatus(input: GetDataAutomationStatusInput) async throws -> GetDataAutomationStatusOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getDataAutomationStatus")
                      ...
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetDataAutomationStatusInput, GetDataAutomationStatusOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GetDataAutomationStatusInput, GetDataAutomationStatusOutput>(GetDataAutomationStatusInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetDataAutomationStatusInput, GetDataAutomationStatusOutput>())
        ...
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetDataAutomationStatusInput, GetDataAutomationStatusOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetDataAutomationStatusInput, GetDataAutomationStatusOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(SmithyRetries.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Bedrock Data Automation Runtime"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDataAutomationStatusInput, GetDataAutomationStatusOutput>(serviceID: serviceName, version: BedrockDataAutomationRuntimeClient.version, config: config))
        ...
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetDataAutomationStatus")
    ...
    /// - `ThrottlingException` : This exception will be thrown when customer reached API TPS limit.
    /// - `ValidationException` : This exception will be thrown when customer provided invalid parameters.
    public func invokeDataAutomationAsync(input: InvokeDataAutomationAsyncInput) async throws -> InvokeDataAutomationAsyncOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "invokeDataAutomationAsync")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<InvokeDataAutomationAsyncInput, InvokeDataAutomationAsyncOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.IdempotencyTokenMiddleware<InvokeDataAutomationAsyncInput, InvokeDataAutomationAsyncOutput>(keyPath: \.clientToken))
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<InvokeDataAutomationAsyncInput, InvokeDataAutomationAsyncOutput>(InvokeDataAutomationAsyncInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<InvokeDataAutomationAsyncInput, InvokeDataAutomationAsyncOutput>())
        ...
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<InvokeDataAutomationAsyncInput, InvokeDataAutomationAsyncOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<InvokeDataAutomationAsyncInput, InvokeDataAutomationAsyncOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(SmithyRetries.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Bedrock Data Automation Runtime"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<InvokeDataAutomationAsyncInput, InvokeDataAutomationAsyncOutput>(serviceID: serviceName, version: BedrockDataAutomationRuntimeClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "BedrockDataAutomationRuntime")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "InvokeDataAutomationAsync")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListTagsForResource` operation on the `BedrockDataAutomationRuntime` service.
    ///
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Bedrock Data Automation Runtime"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput>(serviceID: serviceName, version: BedrockDataAutomationRuntimeClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "BedrockDataAutomationRuntime")
    ...
    /// Performs the `TagResource` operation on the `BedrockDataAutomationRuntime` service.
    ///
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Bedrock Data Automation Runtime"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TagResourceInput, TagResourceOutput>(serviceID: serviceName, version: BedrockDataAutomationRuntimeClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "BedrockDataAutomationRuntime")
    ...
    /// Performs the `UntagResource` operation on the `BedrockDataAutomationRuntime` service.
    ///
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Bedrock Data Automation Runtime"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UntagResourceInput, UntagResourceOutput>(serviceID: serviceName, version: BedrockDataAutomationRuntimeClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "BedrockDataAutomationRuntime")
