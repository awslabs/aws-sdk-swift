...
public class WAFRegionalClient: Client {
...
extension WAFRegionalClient {
    public class WAFRegionalClientConfiguration: AWSDefaultClientConfiguration & AWSRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
    ...
    public static func builder() -> ClientBuilder<WAFRegionalClient> {
        return ClientBuilder<WAFRegionalClient>(defaultPlugins: [
