...
extension CleanRoomsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CleanRoomsClient.CleanRoomsClientConfiguration {
        let clientConfiguration = try await CleanRoomsClient.CleanRoomsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CleanRoomsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CleanRoomsClient(config: configuration)
        }
    }
...
extension CleanRoomsClient.CleanRoomsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
