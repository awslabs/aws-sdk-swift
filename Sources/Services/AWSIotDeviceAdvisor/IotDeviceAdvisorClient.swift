...
extension IotDeviceAdvisorClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> IotDeviceAdvisorClient.IotDeviceAdvisorClientConfiguration {
        let clientConfiguration = try await IotDeviceAdvisorClient.IotDeviceAdvisorClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> IotDeviceAdvisorClient {
            let configuration = try await resolve(plugins: self.plugins)
            return IotDeviceAdvisorClient(config: configuration)
        }
    }
...
extension IotDeviceAdvisorClient.IotDeviceAdvisorClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
