...
public class IotDeviceAdvisorClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? IotDeviceAdvisorClient.IotDeviceAdvisorClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? IotDeviceAdvisorClient.IotDeviceAdvisorClientConfiguration {
            config.authSchemeResolver = DefaultIotDeviceAdvisorAuthSchemeResolver()
...
public class IotDeviceAdvisorClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: IotDeviceAdvisorAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
