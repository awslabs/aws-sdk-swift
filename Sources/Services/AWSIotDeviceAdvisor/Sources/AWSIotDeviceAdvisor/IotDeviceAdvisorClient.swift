...
public final class IotDeviceAdvisorClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: IotDeviceAdvisorClient.IotDeviceAdvisorClientConfig) instead")
    public convenience init(config: IotDeviceAdvisorClient.IotDeviceAdvisorClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try IotDeviceAdvisorClient.IotDeviceAdvisorClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await IotDeviceAdvisorClient.IotDeviceAdvisorClientConfig()
        self.init(config: config)
    }
}
...
extension IotDeviceAdvisorClient {
    ...
    /// Client configuration for IotDeviceAdvisorClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct IotDeviceAdvisorClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "IotDeviceAdvisor")
    ...
    @available(*, deprecated, message: "Use IotDeviceAdvisorClientConfig instead. This class will be removed in a future version.")
    public final class IotDeviceAdvisorClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> IotDeviceAdvisorClientConfig {
            return try IotDeviceAdvisorClientConfig(
...
extension IotDeviceAdvisorClient {
    ...
    public func createSuiteDefinition(input: CreateSuiteDefinitionInput) async throws -> CreateSuiteDefinitionOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "IotDeviceAdvisor"))
