...
extension MobileClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MobileClient.MobileClientConfiguration {
        let clientConfiguration = try await MobileClient.MobileClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MobileClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MobileClient(config: configuration)
        }
    }
...
extension MobileClient.MobileClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
