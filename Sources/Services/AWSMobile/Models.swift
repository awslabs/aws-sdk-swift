...
extension MobileClientTypes.BundleDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MobileClientTypes.BundleDetails {
        ...
        value.availablePlatforms = try reader["availablePlatforms"].readListIfPresent(memberReadingClosure: MobileClientTypes.Platform.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
