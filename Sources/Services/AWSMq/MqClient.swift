...
extension MqClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MqClient.MqClientConfiguration {
        let clientConfiguration = try await MqClient.MqClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MqClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MqClient(config: configuration)
        }
    }
...
extension MqClient.MqClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
