...
public class MqClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? MqClient.MqClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? MqClient.MqClientConfiguration {
            config.authSchemeResolver = DefaultMqAuthSchemeResolver()
...
public class MqClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: MqAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
