...
extension AmplifyBackendClient {
    ...
    public func cloneBackend(input: CloneBackendInput) async throws -> CloneBackendOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CloneBackendInput, CloneBackendOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CloneBackendInput, CloneBackendOutput> = provider.create()
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CloneBackendInput, CloneBackendOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createBackend(input: CreateBackendInput) async throws -> CreateBackendOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateBackendInput, CreateBackendOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateBackendInput, CreateBackendOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateBackendInput, CreateBackendOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createBackendAPI(input: CreateBackendAPIInput) async throws -> CreateBackendAPIOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateBackendAPIInput, CreateBackendAPIOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateBackendAPIInput, CreateBackendAPIOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateBackendAPIInput, CreateBackendAPIOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createBackendAuth(input: CreateBackendAuthInput) async throws -> CreateBackendAuthOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateBackendAuthInput, CreateBackendAuthOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateBackendAuthInput, CreateBackendAuthOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateBackendAuthInput, CreateBackendAuthOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createBackendConfig(input: CreateBackendConfigInput) async throws -> CreateBackendConfigOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateBackendConfigInput, CreateBackendConfigOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateBackendConfigInput, CreateBackendConfigOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateBackendConfigInput, CreateBackendConfigOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createBackendStorage(input: CreateBackendStorageInput) async throws -> CreateBackendStorageOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateBackendStorageInput, CreateBackendStorageOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateBackendStorageInput, CreateBackendStorageOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateBackendStorageInput, CreateBackendStorageOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createToken(input: CreateTokenInput) async throws -> CreateTokenOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateTokenInput, CreateTokenOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateTokenInput, CreateTokenOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateTokenInput, CreateTokenOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deleteBackend(input: DeleteBackendInput) async throws -> DeleteBackendOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteBackendInput, DeleteBackendOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteBackendInput, DeleteBackendOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteBackendInput, DeleteBackendOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deleteBackendAPI(input: DeleteBackendAPIInput) async throws -> DeleteBackendAPIOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteBackendAPIInput, DeleteBackendAPIOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteBackendAPIInput, DeleteBackendAPIOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteBackendAPIInput, DeleteBackendAPIOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deleteBackendAuth(input: DeleteBackendAuthInput) async throws -> DeleteBackendAuthOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteBackendAuthInput, DeleteBackendAuthOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteBackendAuthInput, DeleteBackendAuthOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteBackendAuthInput, DeleteBackendAuthOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deleteBackendStorage(input: DeleteBackendStorageInput) async throws -> DeleteBackendStorageOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteBackendStorageInput, DeleteBackendStorageOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteBackendStorageInput, DeleteBackendStorageOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteBackendStorageInput, DeleteBackendStorageOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deleteToken(input: DeleteTokenInput) async throws -> DeleteTokenOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteTokenInput, DeleteTokenOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteTokenInput, DeleteTokenOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteTokenInput, DeleteTokenOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func generateBackendAPIModels(input: GenerateBackendAPIModelsInput) async throws -> GenerateBackendAPIModelsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GenerateBackendAPIModelsInput, GenerateBackendAPIModelsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GenerateBackendAPIModelsInput, GenerateBackendAPIModelsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GenerateBackendAPIModelsInput, GenerateBackendAPIModelsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getBackend(input: GetBackendInput) async throws -> GetBackendOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetBackendInput, GetBackendOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetBackendInput, GetBackendOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBackendInput, GetBackendOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getBackendAPI(input: GetBackendAPIInput) async throws -> GetBackendAPIOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetBackendAPIInput, GetBackendAPIOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetBackendAPIInput, GetBackendAPIOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBackendAPIInput, GetBackendAPIOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getBackendAPIModels(input: GetBackendAPIModelsInput) async throws -> GetBackendAPIModelsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetBackendAPIModelsInput, GetBackendAPIModelsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetBackendAPIModelsInput, GetBackendAPIModelsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBackendAPIModelsInput, GetBackendAPIModelsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getBackendAuth(input: GetBackendAuthInput) async throws -> GetBackendAuthOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetBackendAuthInput, GetBackendAuthOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetBackendAuthInput, GetBackendAuthOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBackendAuthInput, GetBackendAuthOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getBackendJob(input: GetBackendJobInput) async throws -> GetBackendJobOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetBackendJobInput, GetBackendJobOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetBackendJobInput, GetBackendJobOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBackendJobInput, GetBackendJobOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getBackendStorage(input: GetBackendStorageInput) async throws -> GetBackendStorageOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetBackendStorageInput, GetBackendStorageOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetBackendStorageInput, GetBackendStorageOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBackendStorageInput, GetBackendStorageOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getToken(input: GetTokenInput) async throws -> GetTokenOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetTokenInput, GetTokenOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetTokenInput, GetTokenOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetTokenInput, GetTokenOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func importBackendAuth(input: ImportBackendAuthInput) async throws -> ImportBackendAuthOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ImportBackendAuthInput, ImportBackendAuthOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ImportBackendAuthInput, ImportBackendAuthOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ImportBackendAuthInput, ImportBackendAuthOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func importBackendStorage(input: ImportBackendStorageInput) async throws -> ImportBackendStorageOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ImportBackendStorageInput, ImportBackendStorageOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ImportBackendStorageInput, ImportBackendStorageOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ImportBackendStorageInput, ImportBackendStorageOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func listBackendJobs(input: ListBackendJobsInput) async throws -> ListBackendJobsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListBackendJobsInput, ListBackendJobsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListBackendJobsInput, ListBackendJobsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListBackendJobsInput, ListBackendJobsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func listS3Buckets(input: ListS3BucketsInput) async throws -> ListS3BucketsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListS3BucketsInput, ListS3BucketsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListS3BucketsInput, ListS3BucketsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListS3BucketsInput, ListS3BucketsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func removeAllBackends(input: RemoveAllBackendsInput) async throws -> RemoveAllBackendsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<RemoveAllBackendsInput, RemoveAllBackendsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<RemoveAllBackendsInput, RemoveAllBackendsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RemoveAllBackendsInput, RemoveAllBackendsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func removeBackendConfig(input: RemoveBackendConfigInput) async throws -> RemoveBackendConfigOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<RemoveBackendConfigInput, RemoveBackendConfigOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<RemoveBackendConfigInput, RemoveBackendConfigOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RemoveBackendConfigInput, RemoveBackendConfigOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func updateBackendAPI(input: UpdateBackendAPIInput) async throws -> UpdateBackendAPIOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateBackendAPIInput, UpdateBackendAPIOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateBackendAPIInput, UpdateBackendAPIOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateBackendAPIInput, UpdateBackendAPIOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func updateBackendAuth(input: UpdateBackendAuthInput) async throws -> UpdateBackendAuthOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateBackendAuthInput, UpdateBackendAuthOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateBackendAuthInput, UpdateBackendAuthOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateBackendAuthInput, UpdateBackendAuthOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func updateBackendConfig(input: UpdateBackendConfigInput) async throws -> UpdateBackendConfigOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateBackendConfigInput, UpdateBackendConfigOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateBackendConfigInput, UpdateBackendConfigOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateBackendConfigInput, UpdateBackendConfigOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func updateBackendJob(input: UpdateBackendJobInput) async throws -> UpdateBackendJobOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateBackendJobInput, UpdateBackendJobOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateBackendJobInput, UpdateBackendJobOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateBackendJobInput, UpdateBackendJobOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func updateBackendStorage(input: UpdateBackendStorageInput) async throws -> UpdateBackendStorageOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateBackendStorageInput, UpdateBackendStorageOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateBackendStorageInput, UpdateBackendStorageOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateBackendStorageInput, UpdateBackendStorageOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
