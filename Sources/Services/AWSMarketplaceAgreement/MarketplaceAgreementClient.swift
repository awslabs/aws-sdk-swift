...
extension MarketplaceAgreementClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MarketplaceAgreementClient.MarketplaceAgreementClientConfiguration {
        let clientConfiguration = try await MarketplaceAgreementClient.MarketplaceAgreementClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MarketplaceAgreementClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MarketplaceAgreementClient(config: configuration)
        }
    }
...
extension MarketplaceAgreementClient.MarketplaceAgreementClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
