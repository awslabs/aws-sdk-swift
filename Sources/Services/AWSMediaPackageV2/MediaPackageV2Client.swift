...
extension MediaPackageV2Client {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MediaPackageV2Client.MediaPackageV2ClientConfiguration {
        let clientConfiguration = try await MediaPackageV2Client.MediaPackageV2ClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MediaPackageV2Client {
            let configuration = try await resolve(plugins: self.plugins)
            return MediaPackageV2Client(config: configuration)
        }
    }
...
extension MediaPackageV2Client.MediaPackageV2ClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
