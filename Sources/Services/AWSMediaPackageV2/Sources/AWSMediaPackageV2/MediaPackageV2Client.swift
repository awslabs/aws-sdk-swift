...
public final class MediaPackageV2Client: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "MediaPackageV2Client"
    let client: ClientRuntime.SdkHttpClient
    public let config: MediaPackageV2Client.MediaPackageV2ClientConfig
    let serviceName = "MediaPackageV2"

    @available(*, deprecated, message: "Use MediaPackageV2Client.MediaPackageV2ClientConfig instead")
    public typealias Config = MediaPackageV2Client.MediaPackageV2ClientConfiguration
    public typealias Configuration = MediaPackageV2Client.MediaPackageV2ClientConfig

    public required init(config: MediaPackageV2Client.MediaPackageV2ClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: MediaPackageV2Client.MediaPackageV2ClientConfig) instead")
    public convenience init(config: MediaPackageV2Client.MediaPackageV2ClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try MediaPackageV2Client.MediaPackageV2ClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await MediaPackageV2Client.MediaPackageV2ClientConfig()
        self.init(config: config)
    }
}
...
extension MediaPackageV2Client {
    ...
    /// Client configuration for MediaPackageV2Client
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct MediaPackageV2ClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "MediaPackageV2")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: MediaPackageV2Client.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultMediaPackageV2AuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use MediaPackageV2ClientConfig instead. This class will be removed in a future version.")
    public final class MediaPackageV2ClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> MediaPackageV2ClientConfig {
            return try MediaPackageV2ClientConfig(
...
extension MediaPackageV2Client {
    ...
    public func cancelHarvestJob(input: CancelHarvestJobInput) async throws -> CancelHarvestJobOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("MediaPackageV2", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CancelHarvestJobOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "MediaPackageV2"))
    ...
    public func createChannelGroup(input: CreateChannelGroupInput) async throws -> CreateChannelGroupOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateChannelGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func deleteChannelGroup(input: DeleteChannelGroupInput) async throws -> DeleteChannelGroupOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteChannelGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func deleteOriginEndpointPolicy(input: DeleteOriginEndpointPolicyInput) async throws -> DeleteOriginEndpointPolicyOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteOriginEndpointPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func getChannelGroup(input: GetChannelGroupInput) async throws -> GetChannelGroupOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetChannelGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func getHarvestJob(input: GetHarvestJobInput) async throws -> GetHarvestJobOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetHarvestJobOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func getOriginEndpoint(input: GetOriginEndpointInput) async throws -> GetOriginEndpointOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetOriginEndpointOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func getOriginEndpointPolicy(input: GetOriginEndpointPolicyInput) async throws -> GetOriginEndpointPolicyOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetOriginEndpointPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func listChannelGroups(input: ListChannelGroupsInput) async throws -> ListChannelGroupsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListChannelGroupsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func putOriginEndpointPolicy(input: PutOriginEndpointPolicyInput) async throws -> PutOriginEndpointPolicyOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutOriginEndpointPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    /// Performs the `ResetChannelState` operation on the `MediaPackageV2` service.
    ///
    ...
    /// - `ThrottlingException` : The request throughput limit was exceeded.
    /// - `ValidationException` : The input failed to meet the constraints specified by the AWS service.
    public func resetChannelState(input: ResetChannelStateInput) async throws -> ResetChannelStateOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "resetChannelState")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ResetChannelStateInput, ResetChannelStateOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ResetChannelStateInput, ResetChannelStateOutput>(ResetChannelStateInput.urlPathProvider(_:)))
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ResetChannelStateOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ResetChannelStateOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ResetChannelStateInput, ResetChannelStateOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ResetChannelStateInput, ResetChannelStateOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(SmithyRetries.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "MediaPackageV2"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ResetChannelStateInput, ResetChannelStateOutput>(serviceID: serviceName, version: MediaPackageV2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "MediaPackageV2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ResetChannelState")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ResetOriginEndpointState` operation on the `MediaPackageV2` service.
    ///
    ...
    /// - `ThrottlingException` : The request throughput limit was exceeded.
    /// - `ValidationException` : The input failed to meet the constraints specified by the AWS service.
    public func resetOriginEndpointState(input: ResetOriginEndpointStateInput) async throws -> ResetOriginEndpointStateOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "resetOriginEndpointState")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ResetOriginEndpointStateInput, ResetOriginEndpointStateOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ResetOriginEndpointStateInput, ResetOriginEndpointStateOutput>(ResetOriginEndpointStateInput.urlPathProvider(_:)))
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ResetOriginEndpointStateOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ResetOriginEndpointStateOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ResetOriginEndpointStateInput, ResetOriginEndpointStateOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ResetOriginEndpointStateInput, ResetOriginEndpointStateOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(SmithyRetries.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "MediaPackageV2"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ResetOriginEndpointStateInput, ResetOriginEndpointStateOutput>(serviceID: serviceName, version: MediaPackageV2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "MediaPackageV2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ResetOriginEndpointState")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func updateChannelGroup(input: UpdateChannelGroupInput) async throws -> UpdateChannelGroupOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateChannelGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
