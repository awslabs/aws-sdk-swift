...
extension MediaPackageV2ClientTypes.SpekeKeyProvider {
    ...
    static func write(value: MediaPackageV2ClientTypes.SpekeKeyProvider?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DrmSystems"].writeList(value.drmSystems, memberWritingClosure: MediaPackageV2ClientTypes.DrmSystem.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MediaPackageV2ClientTypes.SpekeKeyProvider {
        ...
        value.drmSystems = try reader["DrmSystems"].readListIfPresent(memberReadingClosure: MediaPackageV2ClientTypes.DrmSystem.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension MediaPackageV2ClientTypes.Scte {
    ...
    static func write(value: MediaPackageV2ClientTypes.Scte?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ScteFilter"].writeList(value.scteFilter, memberWritingClosure: MediaPackageV2ClientTypes.ScteFilter.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MediaPackageV2ClientTypes.Scte {
        ...
        value.scteFilter = try reader["ScteFilter"].readListIfPresent(memberReadingClosure: MediaPackageV2ClientTypes.ScteFilter.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
