...
extension OrganizationsClient {
    /// Paginate over `[ListAccountsWithInvalidEffectivePolicyOutput]` results.
    ///
    /// When this operation is called, an `AsyncSequence` is created. AsyncSequences are lazy so no service
    /// calls are made until the sequence is iterated over. This also means there is no guarantee that the request is valid
    /// until then. If there are errors in your request, you will see the failures only after you start iterating.
    /// - Parameters:
    ///     - input: A `[ListAccountsWithInvalidEffectivePolicyInput]` to start pagination
    /// - Returns: An `AsyncSequence` that can iterate over `ListAccountsWithInvalidEffectivePolicyOutput`
    public func listAccountsWithInvalidEffectivePolicyPaginated(input: ListAccountsWithInvalidEffectivePolicyInput) -> ClientRuntime.PaginatorSequence<ListAccountsWithInvalidEffectivePolicyInput, ListAccountsWithInvalidEffectivePolicyOutput> {
        return ClientRuntime.PaginatorSequence<ListAccountsWithInvalidEffectivePolicyInput, ListAccountsWithInvalidEffectivePolicyOutput>(input: input, inputKey: \.nextToken, outputKey: \.nextToken, paginationFunction: self.listAccountsWithInvalidEffectivePolicy(input:))
    }
}

extension ListAccountsWithInvalidEffectivePolicyInput: ClientRuntime.PaginateToken {
    public func usingPaginationToken(_ token: Swift.String) -> ListAccountsWithInvalidEffectivePolicyInput {
        return ListAccountsWithInvalidEffectivePolicyInput(
            maxResults: self.maxResults,
            nextToken: token,
...
extension PaginatorSequence where OperationStackInput == ListAccountsWithInvalidEffectivePolicyInput, OperationStackOutput == ListAccountsWithInvalidEffectivePolicyOutput {
    /// This paginator transforms the `AsyncSequence` returned by `listAccountsWithInvalidEffectivePolicyPaginated`
    /// to access the nested member `[OrganizationsClientTypes.Account]`
    /// - Returns: `[OrganizationsClientTypes.Account]`
    public func accounts() async throws -> [OrganizationsClientTypes.Account] {
...
extension OrganizationsClient {
    /// Paginate over `[ListEffectivePolicyValidationErrorsOutput]` results.
    ///
    /// When this operation is called, an `AsyncSequence` is created. AsyncSequences are lazy so no service
    /// calls are made until the sequence is iterated over. This also means there is no guarantee that the request is valid
    /// until then. If there are errors in your request, you will see the failures only after you start iterating.
    /// - Parameters:
    ///     - input: A `[ListEffectivePolicyValidationErrorsInput]` to start pagination
    /// - Returns: An `AsyncSequence` that can iterate over `ListEffectivePolicyValidationErrorsOutput`
    public func listEffectivePolicyValidationErrorsPaginated(input: ListEffectivePolicyValidationErrorsInput) -> ClientRuntime.PaginatorSequence<ListEffectivePolicyValidationErrorsInput, ListEffectivePolicyValidationErrorsOutput> {
        return ClientRuntime.PaginatorSequence<ListEffectivePolicyValidationErrorsInput, ListEffectivePolicyValidationErrorsOutput>(input: input, inputKey: \.nextToken, outputKey: \.nextToken, paginationFunction: self.listEffectivePolicyValidationErrors(input:))
    }
}

extension ListEffectivePolicyValidationErrorsInput: ClientRuntime.PaginateToken {
    public func usingPaginationToken(_ token: Swift.String) -> ListEffectivePolicyValidationErrorsInput {
        return ListEffectivePolicyValidationErrorsInput(
            accountId: self.accountId,
            maxResults: self.maxResults,
            nextToken: token,
            policyType: self.policyType
...
extension PaginatorSequence where OperationStackInput == ListEffectivePolicyValidationErrorsInput, OperationStackOutput == ListEffectivePolicyValidationErrorsOutput {
    /// This paginator transforms the `AsyncSequence` returned by `listEffectivePolicyValidationErrorsPaginated`
    /// to access the nested member `[OrganizationsClientTypes.EffectivePolicyValidationError]`
    /// - Returns: `[OrganizationsClientTypes.EffectivePolicyValidationError]`
    public func effectivePolicyValidationErrors() async throws -> [OrganizationsClientTypes.EffectivePolicyValidationError] {
        return try await self.asyncCompactMap { item in item.effectivePolicyValidationErrors }
    }
}
extension OrganizationsClient {
