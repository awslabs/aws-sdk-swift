...
public final class ConnectCampaignsV2Client: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: ConnectCampaignsV2Client.ConnectCampaignsV2ClientConfig) instead")
    public convenience init(config: ConnectCampaignsV2Client.ConnectCampaignsV2ClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ConnectCampaignsV2Client.ConnectCampaignsV2ClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ConnectCampaignsV2Client.ConnectCampaignsV2ClientConfig()
        self.init(config: config)
    }
}
...
extension ConnectCampaignsV2Client {
    ...
    /// Client configuration for ConnectCampaignsV2Client
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ConnectCampaignsV2ClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "ConnectCampaignsV2")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultConnectCampaignsV2AuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ConnectCampaignsV2Client.clientName)
        }
    ...
    @available(*, deprecated, message: "Use ConnectCampaignsV2ClientConfig instead. This class will be removed in a future version.")
    public final class ConnectCampaignsV2ClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ConnectCampaignsV2ClientConfig {
            return try ConnectCampaignsV2ClientConfig(
...
extension ConnectCampaignsV2Client {
    ...
    ///
    /// - Parameter input: The request for CreateCampaign API. (Type: `CreateCampaignInput`)
    ///
    ...
    public func createCampaign(input: CreateCampaignInput) async throws -> CreateCampaignOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ConnectCampaignsV2"))
    ...
    ///
    /// - Parameter input: The request for DeleteCampaign API. (Type: `DeleteCampaignInput`)
    ///
    ...
    ///
    /// - Parameter input: The request for DeleteCampaignChannelSubtypeConfig API. (Type: `DeleteCampaignChannelSubtypeConfigInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteCampaignChannelSubtypeConfigOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for DeleteCampaignCommunicationLimits API. (Type: `DeleteCampaignCommunicationLimitsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteCampaignCommunicationLimitsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for DeleteCampaignCommunicationTime API. (Type: `DeleteCampaignCommunicationTimeInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteCampaignCommunicationTimeOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// Performs the `DeleteCampaignEntryLimits` operation on the `ConnectCampaignsV2` service.
    ///
    /// Deletes the entry limits config for a campaign. This API is idempotent.
    ///
    /// - Parameter input: The request for DeleteCampaignEntryLimits API. (Type: `DeleteCampaignEntryLimitsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteCampaignEntryLimitsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ResourceNotFoundException` : The specified resource was not found.
    /// - `ValidationException` : The input fails to satisfy the constraints specified by an AWS service.
    public func deleteCampaignEntryLimits(input: DeleteCampaignEntryLimitsInput) async throws -> DeleteCampaignEntryLimitsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteCampaignEntryLimits")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteCampaignEntryLimitsInput, DeleteCampaignEntryLimitsOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<DeleteCampaignEntryLimitsInput, DeleteCampaignEntryLimitsOutput>(DeleteCampaignEntryLimitsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DeleteCampaignEntryLimitsInput, DeleteCampaignEntryLimitsOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteCampaignEntryLimitsOutput>(DeleteCampaignEntryLimitsOutput.httpOutput(from:), DeleteCampaignEntryLimitsOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<DeleteCampaignEntryLimitsInput, DeleteCampaignEntryLimitsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<DeleteCampaignEntryLimitsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("ConnectCampaignsV2", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteCampaignEntryLimitsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DeleteCampaignEntryLimitsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DeleteCampaignEntryLimitsInput, DeleteCampaignEntryLimitsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DeleteCampaignEntryLimitsInput, DeleteCampaignEntryLimitsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ConnectCampaignsV2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteCampaignEntryLimitsInput, DeleteCampaignEntryLimitsOutput>(serviceID: serviceName, version: ConnectCampaignsV2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ConnectCampaignsV2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DeleteCampaignEntryLimits")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    ///
    /// - Parameter input: The request for DeleteConnectInstanceConfig API. (Type: `DeleteConnectInstanceConfigInput`)
    ///
    ...
    ///
    /// - Parameter input: The request for DeleteConnectInstanceIntegration API. (Type: `DeleteConnectInstanceIntegrationInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteConnectInstanceIntegrationOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for DescribeCampaign API. (Type: `DescribeCampaignInput`)
    ///
    /// - Returns: The response for DescribeCampaign API. (Type: `DescribeCampaignOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for GetCampaignState API. (Type: `GetCampaignStateInput`)
    ///
    /// - Returns: The response for GetCampaignState API. (Type: `GetCampaignStateOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for GetCampaignStateBatch API. (Type: `GetCampaignStateBatchInput`)
    ///
    /// - Returns: The response for GetCampaignStateBatch API. (Type: `GetCampaignStateBatchOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for GetConnectInstanceConfig API. (Type: `GetConnectInstanceConfigInput`)
    ///
    /// - Returns: The response for GetConnectInstanceConfig API. (Type: `GetConnectInstanceConfigOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// Performs the `GetInstanceCommunicationLimits` operation on the `ConnectCampaignsV2` service.
    ///
    /// Get the instance communication limits.
    ///
    /// - Parameter input: The request for GetInstanceCommunicationLimits API. (Type: `GetInstanceCommunicationLimitsInput`)
    ///
    /// - Returns: The response for GetInstanceCommunicationLimits API. (Type: `GetInstanceCommunicationLimitsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ResourceNotFoundException` : The specified resource was not found.
    /// - `ValidationException` : The input fails to satisfy the constraints specified by an AWS service.
    public func getInstanceCommunicationLimits(input: GetInstanceCommunicationLimitsInput) async throws -> GetInstanceCommunicationLimitsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getInstanceCommunicationLimits")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetInstanceCommunicationLimitsInput, GetInstanceCommunicationLimitsOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GetInstanceCommunicationLimitsInput, GetInstanceCommunicationLimitsOutput>(GetInstanceCommunicationLimitsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetInstanceCommunicationLimitsInput, GetInstanceCommunicationLimitsOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetInstanceCommunicationLimitsOutput>(GetInstanceCommunicationLimitsOutput.httpOutput(from:), GetInstanceCommunicationLimitsOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetInstanceCommunicationLimitsInput, GetInstanceCommunicationLimitsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<GetInstanceCommunicationLimitsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("ConnectCampaignsV2", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetInstanceCommunicationLimitsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetInstanceCommunicationLimitsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetInstanceCommunicationLimitsInput, GetInstanceCommunicationLimitsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetInstanceCommunicationLimitsInput, GetInstanceCommunicationLimitsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ConnectCampaignsV2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetInstanceCommunicationLimitsInput, GetInstanceCommunicationLimitsOutput>(serviceID: serviceName, version: ConnectCampaignsV2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ConnectCampaignsV2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetInstanceCommunicationLimits")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    ///
    /// - Parameter input: The request for GetInstanceOnboardingJobStatus API. (Type: `GetInstanceOnboardingJobStatusInput`)
    ///
    /// - Returns: The response for GetInstanceOnboardingJobStatus API. (Type: `GetInstanceOnboardingJobStatusOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for ListCampaigns API. (Type: `ListCampaignsInput`)
    ///
    /// - Returns: The response for ListCampaigns API. (Type: `ListCampaignsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for ListConnectInstanceIntegrations API. (Type: `ListConnectInstanceIntegrationsInput`)
    ///
    /// - Returns: The response for ListConnectInstanceIntegrations API. (Type: `ListConnectInstanceIntegrationsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for ListTagsForResource API. (Type: `ListTagsForResourceInput`)
    ///
    /// - Returns: The request for ListTagsForResource API. (Type: `ListTagsForResourceOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for PauseCampaign API. (Type: `PauseCampaignInput`)
    ///
    ...
    ///
    /// - Parameter input: The request for PutConnectInstanceIntegration API. (Type: `PutConnectInstanceIntegrationInput`)
    ///
    /// - Returns: [no documentation found] (Type: `PutConnectInstanceIntegrationOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// Performs the `PutInstanceCommunicationLimits` operation on the `ConnectCampaignsV2` service.
    ///
    /// Put the instance communication limits. This API is idempotent.
    ///
    /// - Parameter input: The request for PutInstanceCommunicationLimits API. (Type: `PutInstanceCommunicationLimitsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `PutInstanceCommunicationLimitsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ResourceNotFoundException` : The specified resource was not found.
    /// - `ValidationException` : The input fails to satisfy the constraints specified by an AWS service.
    public func putInstanceCommunicationLimits(input: PutInstanceCommunicationLimitsInput) async throws -> PutInstanceCommunicationLimitsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "putInstanceCommunicationLimits")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<PutInstanceCommunicationLimitsInput, PutInstanceCommunicationLimitsOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<PutInstanceCommunicationLimitsInput, PutInstanceCommunicationLimitsOutput>(PutInstanceCommunicationLimitsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<PutInstanceCommunicationLimitsInput, PutInstanceCommunicationLimitsOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutInstanceCommunicationLimitsInput, PutInstanceCommunicationLimitsOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<PutInstanceCommunicationLimitsInput, PutInstanceCommunicationLimitsOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: PutInstanceCommunicationLimitsInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<PutInstanceCommunicationLimitsInput, PutInstanceCommunicationLimitsOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<PutInstanceCommunicationLimitsOutput>(PutInstanceCommunicationLimitsOutput.httpOutput(from:), PutInstanceCommunicationLimitsOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<PutInstanceCommunicationLimitsInput, PutInstanceCommunicationLimitsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<PutInstanceCommunicationLimitsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("ConnectCampaignsV2", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutInstanceCommunicationLimitsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<PutInstanceCommunicationLimitsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<PutInstanceCommunicationLimitsInput, PutInstanceCommunicationLimitsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<PutInstanceCommunicationLimitsInput, PutInstanceCommunicationLimitsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ConnectCampaignsV2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutInstanceCommunicationLimitsInput, PutInstanceCommunicationLimitsOutput>(serviceID: serviceName, version: ConnectCampaignsV2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ConnectCampaignsV2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "PutInstanceCommunicationLimits")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    ///
    /// - Parameter input: The request for PutOutboundRequestBatch API. (Type: `PutOutboundRequestBatchInput`)
    ///
    /// - Returns: The response for PutOutboundRequestBatch API. (Type: `PutOutboundRequestBatchOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for PutProfileOutboundRequestBatch API (Type: `PutProfileOutboundRequestBatchInput`)
    ///
    /// - Returns: The response for PutProfileOutboundRequestBatch API (Type: `PutProfileOutboundRequestBatchOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for ResumeCampaign API. (Type: `ResumeCampaignInput`)
    ///
    ...
    ///
    /// - Parameter input: The request for StartCampaign API. (Type: `StartCampaignInput`)
    ///
    ...
    /// Stops a campaign for the specified Amazon Connect account.
    ///
    /// - Parameter input: The request for StopCampaign API. (Type: `StopCampaignInput`)
    ///
    ...
    /// Tag a resource.
    ///
    /// - Parameter input: The request for TagResource API. (Type: `TagResourceInput`)
    ///
    ...
    /// Untag a resource.
    ///
    /// - Parameter input: The request for UntagResource API. (Type: `UntagResourceInput`)
    ///
    ...
    ///
    /// - Parameter input: The request for UpdateCampaignChannelSubtypeConfig API. (Type: `UpdateCampaignChannelSubtypeConfigInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateCampaignChannelSubtypeConfigOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for UpdateCampaignCommunicationLimits API. (Type: `UpdateCampaignCommunicationLimitsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateCampaignCommunicationLimitsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for UpdateCampaignCommunicationTime API. (Type: `UpdateCampaignCommunicationTimeInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateCampaignCommunicationTimeOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// Performs the `UpdateCampaignEntryLimits` operation on the `ConnectCampaignsV2` service.
    ///
    /// Updates the entry limits config for a campaign. This API is idempotent.
    ///
    /// - Parameter input: The request for UpdateCampaignEntryLimits API. (Type: `UpdateCampaignEntryLimitsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateCampaignEntryLimitsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ResourceNotFoundException` : The specified resource was not found.
    /// - `ValidationException` : The input fails to satisfy the constraints specified by an AWS service.
    public func updateCampaignEntryLimits(input: UpdateCampaignEntryLimitsInput) async throws -> UpdateCampaignEntryLimitsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "updateCampaignEntryLimits")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateCampaignEntryLimitsInput, UpdateCampaignEntryLimitsOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<UpdateCampaignEntryLimitsInput, UpdateCampaignEntryLimitsOutput>(UpdateCampaignEntryLimitsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<UpdateCampaignEntryLimitsInput, UpdateCampaignEntryLimitsOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<UpdateCampaignEntryLimitsInput, UpdateCampaignEntryLimitsOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<UpdateCampaignEntryLimitsInput, UpdateCampaignEntryLimitsOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: UpdateCampaignEntryLimitsInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<UpdateCampaignEntryLimitsInput, UpdateCampaignEntryLimitsOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<UpdateCampaignEntryLimitsOutput>(UpdateCampaignEntryLimitsOutput.httpOutput(from:), UpdateCampaignEntryLimitsOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<UpdateCampaignEntryLimitsInput, UpdateCampaignEntryLimitsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<UpdateCampaignEntryLimitsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("ConnectCampaignsV2", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateCampaignEntryLimitsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<UpdateCampaignEntryLimitsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<UpdateCampaignEntryLimitsInput, UpdateCampaignEntryLimitsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<UpdateCampaignEntryLimitsInput, UpdateCampaignEntryLimitsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ConnectCampaignsV2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateCampaignEntryLimitsInput, UpdateCampaignEntryLimitsOutput>(serviceID: serviceName, version: ConnectCampaignsV2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ConnectCampaignsV2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "UpdateCampaignEntryLimits")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    ///
    /// - Parameter input: The request for UpdateCampaignFlowAssociation API. (Type: `UpdateCampaignFlowAssociationInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateCampaignFlowAssociationOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for UpdateCampaignName API. (Type: `UpdateCampaignNameInput`)
    ///
    ...
    ///
    /// - Parameter input: The request for UpdateCampaignSchedule API. (Type: `UpdateCampaignScheduleInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateCampaignScheduleOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    ///
    /// - Parameter input: The request for UpdateCampaignSource API. (Type: `UpdateCampaignSourceInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateCampaignSourceOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
