...
<<<<<<< HEAD
        ...
        operation.finalizeStep.intercept(position: .before, middleware: AWSClientRuntime.SigV4Middleware<BatchPutMetricsOutput, BatchPutMetricsOutputError>(config: sigv4Config))
