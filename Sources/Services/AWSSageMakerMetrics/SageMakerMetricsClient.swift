...
extension SageMakerMetricsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SageMakerMetricsClient.SageMakerMetricsClientConfiguration {
        let clientConfiguration = try await SageMakerMetricsClient.SageMakerMetricsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SageMakerMetricsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SageMakerMetricsClient(config: configuration)
        }
    }
...
extension SageMakerMetricsClient.SageMakerMetricsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
