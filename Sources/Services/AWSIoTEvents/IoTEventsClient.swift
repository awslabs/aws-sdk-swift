...
extension IoTEventsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> IoTEventsClient.IoTEventsClientConfiguration {
        let clientConfiguration = try await IoTEventsClient.IoTEventsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> IoTEventsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return IoTEventsClient(config: configuration)
        }
    }
...
extension IoTEventsClient.IoTEventsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
