...
public struct IoT1ClickDevicesServiceAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol IoT1ClickDevicesServiceAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
    ...
    public func resolveAuthScheme(params: ClientRuntime.AuthSchemeResolverParameters) throws -> [AuthOption] {
        ...
        switch serviceParams.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "iot1click")
