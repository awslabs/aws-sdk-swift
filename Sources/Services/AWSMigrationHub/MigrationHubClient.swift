...
extension MigrationHubClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MigrationHubClient.MigrationHubClientConfiguration {
        let clientConfiguration = try await MigrationHubClient.MigrationHubClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MigrationHubClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MigrationHubClient(config: configuration)
        }
    }
...
extension MigrationHubClient.MigrationHubClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
