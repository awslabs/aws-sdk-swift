...
extension MigrationHubClientTypes.MigrationTask {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MigrationHubClientTypes.MigrationTask {
        ...
        value.updateDateTime = try reader["UpdateDateTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension MigrationHubClientTypes {
    ...
    public enum ResourceAttributeType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case biosId
        case fqdn
        case ipv4Address
        case ipv6Address
