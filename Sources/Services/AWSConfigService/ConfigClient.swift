...
extension ConfigClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ConfigClient.ConfigClientConfiguration {
        let clientConfiguration = try await ConfigClient.ConfigClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ConfigClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ConfigClient(config: configuration)
        }
    }
...
extension ConfigClient.ConfigClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
