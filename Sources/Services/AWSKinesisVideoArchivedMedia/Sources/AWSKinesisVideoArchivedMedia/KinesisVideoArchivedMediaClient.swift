...
public final class KinesisVideoArchivedMediaClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "KinesisVideoArchivedMediaClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: KinesisVideoArchivedMediaClient.KinesisVideoArchivedMediaClientConfig
    let serviceName = "Kinesis Video Archived Media"

    @available(*, deprecated, message: "Use KinesisVideoArchivedMediaClient.KinesisVideoArchivedMediaClientConfig instead")
    public typealias Config = KinesisVideoArchivedMediaClient.KinesisVideoArchivedMediaClientConfiguration
    public typealias Configuration = KinesisVideoArchivedMediaClient.KinesisVideoArchivedMediaClientConfig

    public required init(config: KinesisVideoArchivedMediaClient.KinesisVideoArchivedMediaClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: KinesisVideoArchivedMediaClient.KinesisVideoArchivedMediaClientConfig) instead")
    public convenience init(config: KinesisVideoArchivedMediaClient.KinesisVideoArchivedMediaClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try KinesisVideoArchivedMediaClient.KinesisVideoArchivedMediaClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await KinesisVideoArchivedMediaClient.KinesisVideoArchivedMediaClientConfig()
        self.init(config: config)
    }
}
...
extension KinesisVideoArchivedMediaClient {
    ...
    /// Client configuration for KinesisVideoArchivedMediaClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct KinesisVideoArchivedMediaClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Kinesis Video Archived Media")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: KinesisVideoArchivedMediaClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultKinesisVideoArchivedMediaAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use KinesisVideoArchivedMediaClientConfig instead. This class will be removed in a future version.")
    public final class KinesisVideoArchivedMediaClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> KinesisVideoArchivedMediaClientConfig {
            return try KinesisVideoArchivedMediaClientConfig(
...
extension KinesisVideoArchivedMediaClient {
    ...
    public func getClip(input: GetClipInput) async throws -> GetClipOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Kinesis Video Archived Media", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetClipOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Kinesis Video Archived Media"))
    ...
    public func getDASHStreamingSessionURL(input: GetDASHStreamingSessionURLInput) async throws -> GetDASHStreamingSessionURLOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetDASHStreamingSessionURLOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func getHLSStreamingSessionURL(input: GetHLSStreamingSessionURLInput) async throws -> GetHLSStreamingSessionURLOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetHLSStreamingSessionURLOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func getImages(input: GetImagesInput) async throws -> GetImagesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetImagesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func getMediaForFragmentList(input: GetMediaForFragmentListInput) async throws -> GetMediaForFragmentListOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetMediaForFragmentListOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func listFragments(input: ListFragmentsInput) async throws -> ListFragmentsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListFragmentsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
