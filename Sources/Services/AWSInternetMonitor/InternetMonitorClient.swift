...
extension InternetMonitorClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> InternetMonitorClient.InternetMonitorClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> InternetMonitorClient {
            let configuration = try await resolve(plugins: self.plugins)
            return InternetMonitorClient(config: configuration)
        }
    }
...
extension InternetMonitorClient.InternetMonitorClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
