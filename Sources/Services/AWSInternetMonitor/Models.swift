...
extension UpdateMonitorInput {
    ...
    static func write(value: UpdateMonitorInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["InternetMeasurementsLogDelivery"].write(value.internetMeasurementsLogDelivery, with: InternetMonitorClientTypes.InternetMeasurementsLogDelivery.write(value:to:))
        try writer["MaxCityNetworksToMonitor"].write(value.maxCityNetworksToMonitor)
        try writer["ResourcesToAdd"].writeList(value.resourcesToAdd, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ResourcesToRemove"].writeList(value.resourcesToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GetQueryResultsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetQueryResultsOutput {
        ...
        value.data = try reader["Data"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
...
extension InternetMonitorClientTypes.ImpactedLocation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> InternetMonitorClientTypes.ImpactedLocation {
        ...
        value.ipv4Prefixes = try reader["Ipv4Prefixes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
