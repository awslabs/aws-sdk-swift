...
extension CreateIdentityPoolInput {
    ...
    static func write(value: CreateIdentityPoolInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["IdentityPoolTags"].writeMap(value.identityPoolTags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["OpenIdConnectProviderARNs"].writeList(value.openIdConnectProviderARNs, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SamlProviderARNs"].writeList(value.samlProviderARNs, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SupportedLoginProviders"].writeMap(value.supportedLoginProviders, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension DeleteIdentitiesInput {
    ...
    static func write(value: DeleteIdentitiesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["IdentityIdsToDelete"].writeList(value.identityIdsToDelete, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetCredentialsForIdentityInput {
    ...
    static func write(value: GetCredentialsForIdentityInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["IdentityId"].write(value.identityId)
        try writer["Logins"].writeMap(value.logins, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension GetOpenIdTokenForDeveloperIdentityInput {
    ...
    static func write(value: GetOpenIdTokenForDeveloperIdentityInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["IdentityPoolId"].write(value.identityPoolId)
        try writer["Logins"].writeMap(value.logins, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["PrincipalTags"].writeMap(value.principalTags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension SetIdentityPoolRolesInput {
    ...
    static func write(value: SetIdentityPoolRolesInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Roles"].writeMap(value.roles, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension UnlinkIdentityInput {
    ...
    static func write(value: UnlinkIdentityInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["IdentityId"].write(value.identityId)
        try writer["Logins"].writeMap(value.logins, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["LoginsToRemove"].writeList(value.loginsToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension CreateIdentityPoolOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateIdentityPoolOutput {
        ...
        value.identityPoolTags = try reader["IdentityPoolTags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.openIdConnectProviderARNs = try reader["OpenIdConnectProviderARNs"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.samlProviderARNs = try reader["SamlProviderARNs"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.supportedLoginProviders = try reader["SupportedLoginProviders"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension DescribeIdentityOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeIdentityOutput {
        ...
        value.logins = try reader["Logins"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetIdentityPoolRolesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetIdentityPoolRolesOutput {
        ...
        value.roles = try reader["Roles"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension GetPrincipalTagAttributeMapOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetPrincipalTagAttributeMapOutput {
        ...
        value.principalTags = try reader["PrincipalTags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension LookupDeveloperIdentityOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> LookupDeveloperIdentityOutput {
        ...
        value.developerUserIdentifierList = try reader["DeveloperUserIdentifierList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.identityId = try reader["IdentityId"].readIfPresent()
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
