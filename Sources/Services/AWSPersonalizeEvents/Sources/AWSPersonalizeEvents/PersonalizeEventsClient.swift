...
public final class PersonalizeEventsClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: PersonalizeEventsClient.PersonalizeEventsClientConfig) instead")
    public convenience init(config: PersonalizeEventsClient.PersonalizeEventsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try PersonalizeEventsClient.PersonalizeEventsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await PersonalizeEventsClient.PersonalizeEventsClientConfig()
        self.init(config: config)
    }
}
...
extension PersonalizeEventsClient {
    ...
    /// Client configuration for PersonalizeEventsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct PersonalizeEventsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Personalize Events")
    ...
    @available(*, deprecated, message: "Use PersonalizeEventsClientConfig instead. This class will be removed in a future version.")
    public final class PersonalizeEventsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> PersonalizeEventsClientConfig {
            return try PersonalizeEventsClientConfig(
...
extension PersonalizeEventsClient {
    ...
    public func putActionInteractions(input: PutActionInteractionsInput) async throws -> PutActionInteractionsOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Personalize Events"))
