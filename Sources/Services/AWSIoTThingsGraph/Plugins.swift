...
public class IoTThingsGraphClientEndpointPlugin: Plugin {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? IoTThingsGraphClient.IoTThingsGraphClientConfiguration {
            config.authSchemeResolver = DefaultIoTThingsGraphAuthSchemeResolver()
...
public class IoTThingsGraphClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: IoTThingsGraphAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
