...
extension CreateTokenInput {
    ...
    static func write(value: CreateTokenInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["scope"].writeList(value.scope, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension CreateTokenWithIAMOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateTokenWithIAMOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        ...
        value.refreshToken = try reader["refreshToken"].readIfPresent()
        value.scope = try reader["scope"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.tokenType = try reader["tokenType"].readIfPresent()
        return value
    }
}
...
extension RegisterClientInput {
    ...
    static func write(value: RegisterClientInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["grantTypes"].writeList(value.grantTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["scopes"].writeList(value.scopes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension RegisterClientOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> RegisterClientOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension StartDeviceAuthorizationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> StartDeviceAuthorizationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
