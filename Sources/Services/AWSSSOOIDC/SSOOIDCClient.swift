...
extension SSOOIDCClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SSOOIDCClient.SSOOIDCClientConfiguration {
        let clientConfiguration = try await SSOOIDCClient.SSOOIDCClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SSOOIDCClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SSOOIDCClient(config: configuration)
        }
    }
...
extension SSOOIDCClient.SSOOIDCClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
