...
extension MediaPackageVodClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MediaPackageVodClient.MediaPackageVodClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> MediaPackageVodClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MediaPackageVodClient(config: configuration)
        }
    }
...
extension MediaPackageVodClient.MediaPackageVodClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
