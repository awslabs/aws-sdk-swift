...
extension NetworkFirewallClientTypes.AnalysisResult {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NetworkFirewallClientTypes.AnalysisResult {
        ...
        value.identifiedRuleIds = try reader["IdentifiedRuleIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AssociateFirewallPolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AssociateFirewallPolicyOutput {
...
extension AssociateSubnetsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AssociateSubnetsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateFirewallOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateFirewallOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateFirewallPolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateFirewallPolicyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateRuleGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateRuleGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateTLSInspectionConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateTLSInspectionConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteFirewallOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteFirewallOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteFirewallPolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteFirewallPolicyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteRuleGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteRuleGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteTLSInspectionConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteTLSInspectionConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeFirewallOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeFirewallOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeFirewallPolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeFirewallPolicyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeRuleGroupMetadataOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeRuleGroupMetadataOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeRuleGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeRuleGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeTLSInspectionConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeTLSInspectionConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DisassociateSubnetsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DisassociateSubnetsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension NetworkFirewallClientTypes.FirewallPolicy {
    ...
    static func write(value: NetworkFirewallClientTypes.FirewallPolicy?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["StatefulDefaultActions"].writeList(value.statefulDefaultActions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["StatelessDefaultActions"].writeList(value.statelessDefaultActions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["StatelessFragmentDefaultActions"].writeList(value.statelessFragmentDefaultActions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NetworkFirewallClientTypes.FirewallPolicy {
        ...
        value.statelessDefaultActions = try reader["StatelessDefaultActions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.statelessFragmentDefaultActions = try reader["StatelessFragmentDefaultActions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.statefulDefaultActions = try reader["StatefulDefaultActions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension NetworkFirewallClientTypes.FirewallStatus {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NetworkFirewallClientTypes.FirewallStatus {
        ...
        value.status = try reader["Status"].readIfPresent()
        value.configurationSyncStateSummary = try reader["ConfigurationSyncStateSummary"].readIfPresent()
...
extension NetworkFirewallClientTypes.IPSet {
    ...
    static func write(value: NetworkFirewallClientTypes.IPSet?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Definition"].writeList(value.definition, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NetworkFirewallClientTypes.IPSet {
        ...
        value.definition = try reader["Definition"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListFirewallPoliciesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListFirewallPoliciesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListFirewallsInput {
    ...
    static func write(value: ListFirewallsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["MaxResults"].write(value.maxResults)
        try writer["NextToken"].write(value.nextToken)
        try writer["VpcIds"].writeList(value.vpcIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ListFirewallsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListFirewallsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListRuleGroupsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListRuleGroupsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListTLSInspectionConfigurationsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListTLSInspectionConfigurationsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension NetworkFirewallClientTypes.LogDestinationConfig {
    ...
    static func write(value: NetworkFirewallClientTypes.LogDestinationConfig?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["LogDestination"].writeMap(value.logDestination, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NetworkFirewallClientTypes.LogDestinationConfig {
        ...
        value.logDestination = try reader["LogDestination"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension NetworkFirewallClientTypes.MatchAttributes {
    ...
    static func write(value: NetworkFirewallClientTypes.MatchAttributes?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Protocols"].writeList(value.protocols, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NetworkFirewallClientTypes.MatchAttributes {
        ...
        value.protocols = try reader["Protocols"].readListIfPresent(memberReadingClosure: Swift.Int.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension NetworkFirewallClientTypes.RuleOption {
    ...
    static func write(value: NetworkFirewallClientTypes.RuleOption?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Settings"].writeList(value.settings, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NetworkFirewallClientTypes.RuleOption {
        ...
        value.settings = try reader["Settings"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension NetworkFirewallClientTypes.RulesSourceList {
    ...
    static func write(value: NetworkFirewallClientTypes.RulesSourceList?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["TargetTypes"].writeList(value.targetTypes, memberWritingClosure: NetworkFirewallClientTypes.TargetType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NetworkFirewallClientTypes.RulesSourceList {
        ...
        value.targetTypes = try reader["TargetTypes"].readListIfPresent(memberReadingClosure: NetworkFirewallClientTypes.TargetType.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension NetworkFirewallClientTypes.TCPFlagField {
    ...
    static func write(value: NetworkFirewallClientTypes.TCPFlagField?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Flags"].writeList(value.flags, memberWritingClosure: NetworkFirewallClientTypes.TCPFlag.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Masks"].writeList(value.masks, memberWritingClosure: NetworkFirewallClientTypes.TCPFlag.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NetworkFirewallClientTypes.TCPFlagField {
        ...
        value.flags = try reader["Flags"].readListIfPresent(memberReadingClosure: NetworkFirewallClientTypes.TCPFlag.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.masks = try reader["Masks"].readListIfPresent(memberReadingClosure: NetworkFirewallClientTypes.TCPFlag.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension UpdateFirewallDeleteProtectionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateFirewallDeleteProtectionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateFirewallDescriptionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateFirewallDescriptionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateFirewallEncryptionConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateFirewallEncryptionConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateFirewallPolicyChangeProtectionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateFirewallPolicyChangeProtectionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateFirewallPolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateFirewallPolicyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateRuleGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateRuleGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateSubnetChangeProtectionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateSubnetChangeProtectionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateTLSInspectionConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateTLSInspectionConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
