...
public struct UpdateInProgressException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
public struct NamespaceNotFoundException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
extension ECSClientTypes {
    ...
    public struct CapacityProviderStrategyItem: Swift.Sendable {
        ...
        ///
        ///
        /// Examples: Equal Distribution: Two capacity providers both with weight 1 will split tasks evenly after base requirements are met. Weighted Distribution: If capacityProviderA has weight 1 and capacityProviderB has weight 4, then for every 1 task on A, 4 tasks will run on B.
...
public struct ClusterContainsContainerInstancesException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
public struct ClusterContainsServicesException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
public struct ClusterContainsTasksException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
public struct TargetNotConnectedException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
public struct ServiceNotFoundException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
public struct AttributeLimitExceededException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
public struct MissingVersionException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
public struct NoUpdateAvailableException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
extension ECSClientTypes {
    ...
    public enum DeploymentLifecycleHookAction: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case `continue`
        case rollback
        case sdkUnknown(Swift.String)

        public static var allCases: [DeploymentLifecycleHookAction] {
            return [
                .continue,
                .rollback
            ]
...
public struct ContinueServiceDeploymentInput: Swift.Sendable {
    ...
    public init(
        action: ECSClientTypes.DeploymentLifecycleHookAction? = nil,
        hookId: Swift.String? = nil,
...
public struct ContinueServiceDeploymentOutput: Swift.Sendable {
...
extension ECSClientTypes {
    ...
    ///
    ///
    /// For more detailed information about task lifecycle states, see [Task lifecycle](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-lifecycle-explanation.html) in the Amazon Elastic Container Service Developer Guide. The following are notes about container health check support:
    ///
...
extension ECSClientTypes {
    ...
    public struct ContainerDefinition: Swift.Sendable {
        ...
        /// Linux-specific modifications that are applied to the default Docker container configuration, such as Linux kernel capabilities. For more information see [KernelCapabilities](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_KernelCapabilities.html). This parameter is not supported for Windows containers.
...
public struct PutAccountSettingDefaultInput: Swift.Sendable {
    ...
    /// This member is required.
    public var name: ECSClientTypes.SettingName?
    /// The account setting value for the specified principal ARN. Accepted values are enabled, disabled, on, enhanced, and off. When you specify fargateTaskRetirementWaitPeriod for the name, the following are the valid values:
    ///
    /// * 0 - Amazon Web Services sends the notification, and immediately retires the affected tasks.
    ///
    /// * 7 - Amazon Web Services sends the notification, and waits 7 calendar days to retire the tasks.
...
extension ECSClientTypes {
    ...
    public enum DeploymentLifecycleHookStage: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        ...
        case preProductionTrafficShift
        case preScaleUp
        ...
        public var rawValue: Swift.String {
            ...
            case .preProductionTrafficShift: return "PRE_PRODUCTION_TRAFFIC_SHIFT"
...
extension ECSClientTypes {
    ...
    public enum DeploymentLifecycleHookTargetType: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case awsLambda
        case pause
        case sdkUnknown(Swift.String)

        public static var allCases: [DeploymentLifecycleHookTargetType] {
            return [
                .awsLambda,
                .pause
            ]
...
extension ECSClientTypes {
    ...
    public struct DeploymentLifecycleHookTimeoutConfiguration: Swift.Sendable {
...
extension ECSClientTypes {
    ...
    public struct DeploymentLifecycleHook: Swift.Sendable {
        ...
        public var targetType: ECSClientTypes.DeploymentLifecycleHookTargetType?
        ...
        public var timeoutConfiguration: ECSClientTypes.DeploymentLifecycleHookTimeoutConfiguration?
        ...
        public init(
            ...
            roleArn: Swift.String? = nil,
            targetType: ECSClientTypes.DeploymentLifecycleHookTargetType? = nil,
            timeoutConfiguration: ECSClientTypes.DeploymentLifecycleHookTimeoutConfiguration? = nil
        ) {
...
extension ECSClientTypes {
    ...
    public enum DeploymentLifecycleHookStatus: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case awaitingAction
        case failed
        case inProgress
        case succeeded
        ...
        public static var allCases: [DeploymentLifecycleHookStatus] {
            return [
                .awaitingAction,
                .failed,
                .inProgress,
        ...
        public var rawValue: Swift.String {
            switch self {
            case .awaitingAction: return "AWAITING_ACTION"
            case .failed: return "FAILED"
            case .inProgress: return "IN_PROGRESS"
...
extension ECSClientTypes {
    ...
    /// The details of a deployment lifecycle hook that is active during a service deployment. You can view lifecycle hook details by calling [DescribeServiceDeployments](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_DescribeServiceDeployments.html).
    public struct DeploymentLifecycleHookDetail: Swift.Sendable {
        ...
        public var timeoutAction: ECSClientTypes.DeploymentLifecycleHookAction?

        public init(
            expiresAt: Foundation.Date? = nil,
            hookId: Swift.String? = nil,
            status: ECSClientTypes.DeploymentLifecycleHookStatus? = nil,
            targetArn: Swift.String? = nil,
            targetType: ECSClientTypes.DeploymentLifecycleHookTargetType? = nil,
            timeoutAction: ECSClientTypes.DeploymentLifecycleHookAction? = nil
        ) {
...
extension ECSClientTypes {
    ...
    public struct ServiceDeployment: Swift.Sendable {
        ...
        public var lifecycleHookDetails: [ECSClientTypes.DeploymentLifecycleHookDetail]?
        ...
        public init(
            ...
            finishedAt: Foundation.Date? = nil,
            lifecycleHookDetails: [ECSClientTypes.DeploymentLifecycleHookDetail]? = nil,
...
public struct ServiceNotActiveException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
public struct UpdateServiceInput: Swift.Sendable {
    ...
    ///
    ///
    /// For information about Amazon Web Services CDK considerations, see [Amazon Web Services CDK considerations](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/update-service-parameters.html). This parameter doesn't trigger a new service deployment.
    public var capacityProviderStrategy: [ECSClientTypes.CapacityProviderStrategyItem]?
...
public struct TaskSetNotFoundException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
