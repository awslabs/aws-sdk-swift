...
extension ECSClientTypes.Cluster {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.Cluster {
        ...
        value.capacityProviders = try reader["capacityProviders"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ECSClientTypes.Container {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.Container {
        ...
        value.gpuIds = try reader["gpuIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ECSClientTypes.ContainerDefinition {
    ...
    static func write(value: ECSClientTypes.ContainerDefinition?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["credentialSpecs"].writeList(value.credentialSpecs, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["dnsSearchDomains"].writeList(value.dnsSearchDomains, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["dnsServers"].writeList(value.dnsServers, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["dockerLabels"].writeMap(value.dockerLabels, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["dockerSecurityOptions"].writeList(value.dockerSecurityOptions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["links"].writeList(value.links, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.ContainerDefinition {
        ...
        value.memory = try reader["memory"].readIfPresent()
        value.memoryReservation = try reader["memoryReservation"].readIfPresent()
        value.links = try reader["links"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.dnsServers = try reader["dnsServers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.dnsSearchDomains = try reader["dnsSearchDomains"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.dockerSecurityOptions = try reader["dockerSecurityOptions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.interactive = try reader["interactive"].readIfPresent()
        value.pseudoTerminal = try reader["pseudoTerminal"].readIfPresent()
        value.dockerLabels = try reader["dockerLabels"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        ...
        value.credentialSpecs = try reader["credentialSpecs"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CreateCapacityProviderOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCapacityProviderOutput {
...
extension CreateTaskSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateTaskSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteAccountSettingOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteAccountSettingOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteAttributesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteAttributesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteCapacityProviderOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCapacityProviderOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteTaskDefinitionsInput {
    ...
    static func write(value: DeleteTaskDefinitionsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["taskDefinitions"].writeList(value.taskDefinitions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DeleteTaskDefinitionsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteTaskDefinitionsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteTaskSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteTaskSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECSClientTypes.DeploymentAlarms {
    ...
    static func write(value: ECSClientTypes.DeploymentAlarms?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["alarmNames"].writeList(value.alarmNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.DeploymentAlarms {
        ...
        value.alarmNames = try reader["alarmNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DeregisterContainerInstanceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeregisterContainerInstanceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeregisterTaskDefinitionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeregisterTaskDefinitionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeCapacityProvidersInput {
    ...
    static func write(value: DescribeCapacityProvidersInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["capacityProviders"].writeList(value.capacityProviders, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["include"].writeList(value.include, memberWritingClosure: ECSClientTypes.CapacityProviderField.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeCapacityProvidersOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCapacityProvidersOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeClustersInput {
    ...
    static func write(value: DescribeClustersInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["include"].writeList(value.include, memberWritingClosure: ECSClientTypes.ClusterField.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeContainerInstancesInput {
    ...
    static func write(value: DescribeContainerInstancesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["cluster"].write(value.cluster)
        try writer["containerInstances"].writeList(value.containerInstances, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["include"].writeList(value.include, memberWritingClosure: ECSClientTypes.ContainerInstanceField.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeContainerInstancesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeContainerInstancesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeServicesInput {
    ...
    static func write(value: DescribeServicesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["cluster"].write(value.cluster)
        try writer["include"].writeList(value.include, memberWritingClosure: ECSClientTypes.ServiceField.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeServicesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeServicesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeTaskDefinitionInput {
    ...
    static func write(value: DescribeTaskDefinitionInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["include"].writeList(value.include, memberWritingClosure: ECSClientTypes.TaskDefinitionField.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["taskDefinition"].write(value.taskDefinition)
    }
}
...
extension DescribeTaskDefinitionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeTaskDefinitionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeTaskSetsInput {
    ...
    static func write(value: DescribeTaskSetsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["cluster"].write(value.cluster)
        try writer["include"].writeList(value.include, memberWritingClosure: ECSClientTypes.TaskSetField.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["service"].write(value.service)
        try writer["taskSets"].writeList(value.taskSets, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeTaskSetsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeTaskSetsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeTasksInput {
    ...
    static func write(value: DescribeTasksInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["cluster"].write(value.cluster)
        try writer["include"].writeList(value.include, memberWritingClosure: ECSClientTypes.TaskField.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["tasks"].writeList(value.tasks, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeTasksOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeTasksOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECSClientTypes.Device {
    ...
    static func write(value: ECSClientTypes.Device?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["permissions"].writeList(value.permissions, memberWritingClosure: ECSClientTypes.DeviceCgroupPermission.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.Device {
        ...
        value.permissions = try reader["permissions"].readListIfPresent(memberReadingClosure: ECSClientTypes.DeviceCgroupPermission.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DiscoverPollEndpointOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DiscoverPollEndpointOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECSClientTypes.DockerVolumeConfiguration {
    ...
    static func write(value: ECSClientTypes.DockerVolumeConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["driverOpts"].writeMap(value.driverOpts, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.DockerVolumeConfiguration {
        ...
        value.driverOpts = try reader["driverOpts"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ExecuteCommandOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ExecuteCommandOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetTaskProtectionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetTaskProtectionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECSClientTypes.InstanceHealthCheckResult {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.InstanceHealthCheckResult {
        ...
        value.lastStatusChange = try reader["lastStatusChange"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension ECSClientTypes.KernelCapabilities {
    ...
    static func write(value: ECSClientTypes.KernelCapabilities?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["add"].writeList(value.add, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["drop"].writeList(value.drop, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.KernelCapabilities {
        ...
        value.add = try reader["add"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.drop = try reader["drop"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
public struct ListAccountSettingsInput {
    ...
    public init(
        effectiveSettings: Swift.Bool? = nil,
        maxResults: Swift.Int? = nil,
        name: ECSClientTypes.SettingName? = nil,
        nextToken: Swift.String? = nil,
        principalArn: Swift.String? = nil,
...
extension ListAccountSettingsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAccountSettingsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListAttributesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAttributesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListClustersOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListClustersOutput {
        ...
        value.clusterArns = try reader["clusterArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListContainerInstancesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListContainerInstancesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = ListContainerInstancesOutput()
        value.containerInstanceArns = try reader["containerInstanceArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListServicesByNamespaceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListServicesByNamespaceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListTaskDefinitionFamiliesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListTaskDefinitionFamiliesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = ListTaskDefinitionFamiliesOutput()
        value.families = try reader["families"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListTaskDefinitionsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListTaskDefinitionsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = ListTaskDefinitionsOutput()
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.taskDefinitionArns = try reader["taskDefinitionArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListTasksOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListTasksOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.taskArns = try reader["taskArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ECSClientTypes.ManagedAgent {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.ManagedAgent {
        ...
        value.lastStartedAt = try reader["lastStartedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.name = try reader["name"].readIfPresent()
        value.reason = try reader["reason"].readIfPresent()
        value.lastStatus = try reader["lastStatus"].readIfPresent()
        return value
...
extension PutAccountSettingDefaultOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutAccountSettingDefaultOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension PutAccountSettingOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutAccountSettingOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension PutAttributesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutAttributesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension PutClusterCapacityProvidersOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutClusterCapacityProvidersOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension RegisterContainerInstanceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> RegisterContainerInstanceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension RegisterTaskDefinitionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> RegisterTaskDefinitionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECSClientTypes.Resource {
    ...
    static func write(value: ECSClientTypes.Resource?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["name"].write(value.name)
        try writer["stringSetValue"].writeList(value.stringSetValue, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["type"].write(value.type)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.Resource {
        ...
        value.stringSetValue = try reader["stringSetValue"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension RunTaskOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> RunTaskOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension StartTaskOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> StartTaskOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension StopTaskOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> StopTaskOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SubmitAttachmentStateChangesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> SubmitAttachmentStateChangesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SubmitContainerStateChangeOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> SubmitContainerStateChangeOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SubmitTaskStateChangeOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> SubmitTaskStateChangeOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECSClientTypes.Task {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.Task {
        ...
        value.connectivityAt = try reader["connectivityAt"].readTimestampIfPresent(format: .epochSeconds)
        value.containerInstanceArn = try reader["containerInstanceArn"].readIfPresent()
        ...
        value.enableExecuteCommand = try reader["enableExecuteCommand"].readIfPresent() ?? false
        value.executionStoppedAt = try reader["executionStoppedAt"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.platformVersion = try reader["platformVersion"].readIfPresent()
        value.platformFamily = try reader["platformFamily"].readIfPresent()
        value.pullStartedAt = try reader["pullStartedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.pullStoppedAt = try reader["pullStoppedAt"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.stoppedAt = try reader["stoppedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.stoppedReason = try reader["stoppedReason"].readIfPresent()
        value.stoppingAt = try reader["stoppingAt"].readTimestampIfPresent(format: .epochSeconds)
        value.tags = try reader["tags"].readListIfPresent(memberReadingClosure: ECSClientTypes.Tag.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.taskArn = try reader["taskArn"].readIfPresent()
...
extension ECSClientTypes.TaskDefinition {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECSClientTypes.TaskDefinition {
        ...
        value.compatibilities = try reader["compatibilities"].readListIfPresent(memberReadingClosure: ECSClientTypes.Compatibility.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.runtimePlatform = try reader["runtimePlatform"].readIfPresent(with: ECSClientTypes.RuntimePlatform.read(from:))
        value.requiresCompatibilities = try reader["requiresCompatibilities"].readListIfPresent(memberReadingClosure: ECSClientTypes.Compatibility.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.cpu = try reader["cpu"].readIfPresent()
        value.memory = try reader["memory"].readIfPresent()
        value.inferenceAccelerators = try reader["inferenceAccelerators"].readListIfPresent(memberReadingClosure: ECSClientTypes.InferenceAccelerator.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.registeredAt = try reader["registeredAt"].readTimestampIfPresent(format: .epochSeconds)
        value.deregisteredAt = try reader["deregisteredAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension UpdateCapacityProviderOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateCapacityProviderOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateClusterSettingsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateClusterSettingsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateContainerAgentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateContainerAgentOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateContainerInstancesStateOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateContainerInstancesStateOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
public struct UpdateServiceInput {
    ...
    public init(
        ...
        enableECSManagedTags: Swift.Bool? = nil,
        enableExecuteCommand: Swift.Bool? = nil,
        forceNewDeployment: Swift.Bool? = nil,
        healthCheckGracePeriodSeconds: Swift.Int? = nil,
        loadBalancers: [ECSClientTypes.LoadBalancer]? = nil,
        networkConfiguration: ECSClientTypes.NetworkConfiguration? = nil,
        placementConstraints: [ECSClientTypes.PlacementConstraint]? = nil,
...
extension UpdateServicePrimaryTaskSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateServicePrimaryTaskSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
public struct UpdateTaskProtectionInput {
    ...
    public init(
        ...
        protectionEnabled: Swift.Bool? = nil,
        tasks: [Swift.String]? = nil
    )
    {
        self.cluster = cluster
...
extension UpdateTaskProtectionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateTaskProtectionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateTaskSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateTaskSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
