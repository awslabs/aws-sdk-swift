...
public final class ChimeClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "ChimeClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: ChimeClient.ChimeClientConfig
    let serviceName = "Chime"

    @available(*, deprecated, message: "Use ChimeClient.ChimeClientConfig instead")
    public typealias Config = ChimeClient.ChimeClientConfiguration
    public typealias Configuration = ChimeClient.ChimeClientConfig

    public required init(config: ChimeClient.ChimeClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: ChimeClient.ChimeClientConfig) instead")
    public convenience init(config: ChimeClient.ChimeClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ChimeClient.ChimeClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ChimeClient.ChimeClientConfig()
        self.init(config: config)
    }
}
...
extension ChimeClient {
    ...
    /// Client configuration for ChimeClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ChimeClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Chime")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultChimeAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ChimeClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use ChimeClientConfig instead. This class will be removed in a future version.")
    public final class ChimeClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ChimeClientConfig {
            return try ChimeClientConfig(
...
extension ChimeClient {
    ...
    public func associatePhoneNumberWithUser(input: AssociatePhoneNumberWithUserInput) async throws -> AssociatePhoneNumberWithUserOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Chime"))
