...
public class ChimeClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await ChimeClientConfiguration(region: region)
    ...
    public class ChimeClientConfiguration: ChimeClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("ChimeClient")
