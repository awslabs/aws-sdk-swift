...
extension CodeCatalystClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CodeCatalystClient.CodeCatalystClientConfiguration {
        let clientConfiguration = try await CodeCatalystClient.CodeCatalystClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CodeCatalystClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CodeCatalystClient(config: configuration)
        }
    }
...
extension CodeCatalystClient.CodeCatalystClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
