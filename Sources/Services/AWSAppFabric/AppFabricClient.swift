...
extension AppFabricClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> AppFabricClient.AppFabricClientConfiguration {
        let clientConfiguration = try await AppFabricClient.AppFabricClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> AppFabricClient {
            let configuration = try await resolve(plugins: self.plugins)
            return AppFabricClient(config: configuration)
        }
    }
...
extension AppFabricClient.AppFabricClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
