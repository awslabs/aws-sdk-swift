...
@testable import AWSPartnerCentralChannel
import XCTest
...
class EndpointResolverTest: XCTestCase {
    ...
    func testResolve3() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://partnercentral-channel-fips.global.api.aws", headers: headers, properties: properties)
    ...
    func testResolve4() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://partnercentral-channel.global.api.aws", headers: headers, properties: properties)
    ...
    func testResolve5() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://partnercentral-channel-fips.global.api.amazonwebservices.com.cn", headers: headers, properties: properties)
    ...
    func testResolve6() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://partnercentral-channel.global.api.amazonwebservices.com.cn", headers: headers, properties: properties)
    ...
    func testResolve7() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://partnercentral-channel-fips.us-gov.api.aws", headers: headers, properties: properties)
    ...
    func testResolve8() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://partnercentral-channel.us-gov.api.aws", headers: headers, properties: properties)
