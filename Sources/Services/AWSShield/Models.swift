...
extension DescribeDRTAccessOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeDRTAccessOutput {
        ...
        value.logBucketList = try reader["LogBucketList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ShieldClientTypes.ProtectionGroup {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ShieldClientTypes.ProtectionGroup {
        ...
        value.members = try reader["Members"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ShieldClientTypes.InclusionProtectionGroupFilters {
    ...
    static func write(value: ShieldClientTypes.InclusionProtectionGroupFilters?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Aggregations"].writeList(value.aggregations, memberWritingClosure: ShieldClientTypes.ProtectionGroupAggregation.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension ShieldClientTypes.InclusionProtectionFilters {
    ...
    static func write(value: ShieldClientTypes.InclusionProtectionFilters?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ProtectionNames"].writeList(value.protectionNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ResourceArns"].writeList(value.resourceArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ResourceTypes"].writeList(value.resourceTypes, memberWritingClosure: ShieldClientTypes.ProtectedResourceType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
