...
extension AssociateResourceOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> AssociateResourceOutput {
        ...
        value.applicationArn = try reader["applicationArn"].readIfPresent()
        value.options = try reader["options"].readListIfPresent(memberReadingClosure: ServiceCatalogAppRegistryClientTypes.AssociationOption.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension GetApplicationOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetApplicationOutput {
        ...
        value.applicationTag = try reader["applicationTag"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ListAssociatedAttributeGroupsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAssociatedAttributeGroupsOutput {
        ...
        value.attributeGroups = try reader["attributeGroups"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
