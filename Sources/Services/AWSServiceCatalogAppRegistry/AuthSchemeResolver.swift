...
public struct ServiceCatalogAppRegistryAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ServiceCatalogAppRegistryAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultServiceCatalogAppRegistryAuthSchemeResolver: ServiceCatalogAppRegistryAuthSchemeResolver {
    public func resolveAuthScheme(params: ClientRuntime.AuthSchemeResolverParameters) throws -> [AuthOption] {
        ...
        switch serviceParams.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "servicecatalog")
    ...
    public func constructParameters(context: HttpContext) throws -> ClientRuntime.AuthSchemeResolverParameters {
        ...
        return ServiceCatalogAppRegistryAuthSchemeResolverParameters(operation: opName, region: opRegion)
    }
}
