...
public struct UxcAuthSchemeResolverParameters: SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
...
public protocol UxcAuthSchemeResolver: SmithyHTTPAuthAPI.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service Uxc must conform to.
}

public struct DefaultUxcAuthSchemeResolver: UxcAuthSchemeResolver {
    ...
    public func resolveAuthScheme(params: SmithyHTTPAuthAPI.AuthSchemeResolverParameters) throws -> [SmithyHTTPAuthAPI.AuthOption] {
        ...
        guard let serviceParams = params as? UxcAuthSchemeResolverParameters else {
        ...
        switch serviceParams.operation {
            default:
                ...
                sigv4Option.signingProperties.set(key: SmithyHTTPAuthAPI.SigningPropertyKeys.signingName, value: "uxc")
    ...
    public func constructParameters(context: Smithy.Context) throws -> SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
        ...
        return UxcAuthSchemeResolverParameters(authSchemePreference: authSchemePreference, operation: opName, region: opRegion)
    }
}
