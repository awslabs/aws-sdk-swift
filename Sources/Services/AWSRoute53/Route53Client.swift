...
extension Route53Client {
    public class Route53ClientConfiguration: AWSDefaultClientConfiguration & AWSRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
        ...
        public convenience init(region: String) throws {
            self.init(nil, nil, try AWSClientConfigDefaultsProvider.appID(), try AWSClientConfigDefaultsProvider.awsCredentialIdentityResolver(), try AWSClientConfigDefaultsProvider.retryMode(), region, region, try DefaultEndpointResolver(), ClientRuntime.DefaultTelemetry.provider, try AWSClientConfigDefaultsProvider.retryStrategyOptions(), AWSClientConfigDefaultsProvider.clientLogMode, nil, AWSClientConfigDefaultsProvider.idempotencyTokenGenerator, AWSClientConfigDefaultsProvider.httpClientEngine, AWSClientConfigDefaultsProvider.httpClientConfiguration, [SigV4AuthScheme()], DefaultRoute53AuthSchemeResolver())
        }
...
extension Route53Client {
    ...
    public func activateKeySigningKey(input: ActivateKeySigningKeyInput) async throws -> ActivateKeySigningKeyOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .build()
        let builder = OrchestratorBuilder<ActivateKeySigningKeyInput, ActivateKeySigningKeyOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<ActivateKeySigningKeyInput, ActivateKeySigningKeyOutput>(\.hostedZoneId))
        ...
        builder.applyEndpoint(EndpointResolverMiddleware<ActivateKeySigningKeyOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ActivateKeySigningKeyOutput>(responseClosure(ActivateKeySigningKeyOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ActivateKeySigningKeyOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func associateVPCWithHostedZone(input: AssociateVPCWithHostedZoneInput) async throws -> AssociateVPCWithHostedZoneOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<AssociateVPCWithHostedZoneInput, AssociateVPCWithHostedZoneOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<AssociateVPCWithHostedZoneInput, AssociateVPCWithHostedZoneOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<AssociateVPCWithHostedZoneOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<AssociateVPCWithHostedZoneInput, AssociateVPCWithHostedZoneOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<AssociateVPCWithHostedZoneInput, AssociateVPCWithHostedZoneOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("AssociateVPCWithHostedZoneRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: AssociateVPCWithHostedZoneInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<AssociateVPCWithHostedZoneOutput>(responseClosure(AssociateVPCWithHostedZoneOutput.httpBinding, responseDocumentBinding), responseErrorClosure(AssociateVPCWithHostedZoneOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func changeCidrCollection(input: ChangeCidrCollectionInput) async throws -> ChangeCidrCollectionOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ChangeCidrCollectionInput, ChangeCidrCollectionOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ChangeCidrCollectionOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<ChangeCidrCollectionInput, ChangeCidrCollectionOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<ChangeCidrCollectionInput, ChangeCidrCollectionOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("ChangeCidrCollectionRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: ChangeCidrCollectionInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ChangeCidrCollectionOutput>(responseClosure(ChangeCidrCollectionOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ChangeCidrCollectionOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func changeResourceRecordSets(input: ChangeResourceRecordSetsInput) async throws -> ChangeResourceRecordSetsOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ChangeResourceRecordSetsInput, ChangeResourceRecordSetsOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<ChangeResourceRecordSetsInput, ChangeResourceRecordSetsOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ChangeResourceRecordSetsOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<ChangeResourceRecordSetsInput, ChangeResourceRecordSetsOutput>(contentType: "application/xml"))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ChangeResourceRecordSetsOutput>(responseClosure(ChangeResourceRecordSetsOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ChangeResourceRecordSetsOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func changeTagsForResource(input: ChangeTagsForResourceInput) async throws -> ChangeTagsForResourceOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ChangeTagsForResourceInput, ChangeTagsForResourceOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ChangeTagsForResourceOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<ChangeTagsForResourceInput, ChangeTagsForResourceOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<ChangeTagsForResourceInput, ChangeTagsForResourceOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("ChangeTagsForResourceRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: ChangeTagsForResourceInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ChangeTagsForResourceOutput>(responseClosure(ChangeTagsForResourceOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ChangeTagsForResourceOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func createCidrCollection(input: CreateCidrCollectionInput) async throws -> CreateCidrCollectionOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateCidrCollectionInput, CreateCidrCollectionOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CreateCidrCollectionOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<CreateCidrCollectionInput, CreateCidrCollectionOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateCidrCollectionInput, CreateCidrCollectionOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("CreateCidrCollectionRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: CreateCidrCollectionInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateCidrCollectionOutput>(responseClosure(CreateCidrCollectionOutput.httpBinding, responseDocumentBinding), responseErrorClosure(CreateCidrCollectionOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func createHealthCheck(input: CreateHealthCheckInput) async throws -> CreateHealthCheckOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateHealthCheckInput, CreateHealthCheckOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CreateHealthCheckOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<CreateHealthCheckInput, CreateHealthCheckOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateHealthCheckInput, CreateHealthCheckOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("CreateHealthCheckRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: CreateHealthCheckInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateHealthCheckOutput>(responseClosure(CreateHealthCheckOutput.httpBinding, responseDocumentBinding), responseErrorClosure(CreateHealthCheckOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func createHostedZone(input: CreateHostedZoneInput) async throws -> CreateHostedZoneOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateHostedZoneInput, CreateHostedZoneOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CreateHostedZoneOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateHostedZoneOutput>(responseClosure(CreateHostedZoneOutput.httpBinding, responseDocumentBinding), responseErrorClosure(CreateHostedZoneOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func createKeySigningKey(input: CreateKeySigningKeyInput) async throws -> CreateKeySigningKeyOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateKeySigningKeyInput, CreateKeySigningKeyOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CreateKeySigningKeyOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<CreateKeySigningKeyInput, CreateKeySigningKeyOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateKeySigningKeyInput, CreateKeySigningKeyOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("CreateKeySigningKeyRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: CreateKeySigningKeyInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateKeySigningKeyOutput>(responseClosure(CreateKeySigningKeyOutput.httpBinding, responseDocumentBinding), responseErrorClosure(CreateKeySigningKeyOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func createQueryLoggingConfig(input: CreateQueryLoggingConfigInput) async throws -> CreateQueryLoggingConfigOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateQueryLoggingConfigInput, CreateQueryLoggingConfigOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CreateQueryLoggingConfigOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<CreateQueryLoggingConfigInput, CreateQueryLoggingConfigOutput>(contentType: "application/xml"))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateQueryLoggingConfigOutput>(responseClosure(CreateQueryLoggingConfigOutput.httpBinding, responseDocumentBinding), responseErrorClosure(CreateQueryLoggingConfigOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func createReusableDelegationSet(input: CreateReusableDelegationSetInput) async throws -> CreateReusableDelegationSetOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateReusableDelegationSetInput, CreateReusableDelegationSetOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CreateReusableDelegationSetOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<CreateReusableDelegationSetInput, CreateReusableDelegationSetOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateReusableDelegationSetInput, CreateReusableDelegationSetOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("CreateReusableDelegationSetRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: CreateReusableDelegationSetInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateReusableDelegationSetOutput>(responseClosure(CreateReusableDelegationSetOutput.httpBinding, responseDocumentBinding), responseErrorClosure(CreateReusableDelegationSetOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func createTrafficPolicy(input: CreateTrafficPolicyInput) async throws -> CreateTrafficPolicyOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateTrafficPolicyInput, CreateTrafficPolicyOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CreateTrafficPolicyOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<CreateTrafficPolicyInput, CreateTrafficPolicyOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateTrafficPolicyInput, CreateTrafficPolicyOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("CreateTrafficPolicyRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: CreateTrafficPolicyInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateTrafficPolicyOutput>(responseClosure(CreateTrafficPolicyOutput.httpBinding, responseDocumentBinding), responseErrorClosure(CreateTrafficPolicyOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func createTrafficPolicyInstance(input: CreateTrafficPolicyInstanceInput) async throws -> CreateTrafficPolicyInstanceOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateTrafficPolicyInstanceInput, CreateTrafficPolicyInstanceOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CreateTrafficPolicyInstanceOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<CreateTrafficPolicyInstanceInput, CreateTrafficPolicyInstanceOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateTrafficPolicyInstanceInput, CreateTrafficPolicyInstanceOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("CreateTrafficPolicyInstanceRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: CreateTrafficPolicyInstanceInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateTrafficPolicyInstanceOutput>(responseClosure(CreateTrafficPolicyInstanceOutput.httpBinding, responseDocumentBinding), responseErrorClosure(CreateTrafficPolicyInstanceOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func createTrafficPolicyVersion(input: CreateTrafficPolicyVersionInput) async throws -> CreateTrafficPolicyVersionOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateTrafficPolicyVersionInput, CreateTrafficPolicyVersionOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CreateTrafficPolicyVersionOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<CreateTrafficPolicyVersionInput, CreateTrafficPolicyVersionOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateTrafficPolicyVersionInput, CreateTrafficPolicyVersionOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("CreateTrafficPolicyVersionRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: CreateTrafficPolicyVersionInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateTrafficPolicyVersionOutput>(responseClosure(CreateTrafficPolicyVersionOutput.httpBinding, responseDocumentBinding), responseErrorClosure(CreateTrafficPolicyVersionOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func createVPCAssociationAuthorization(input: CreateVPCAssociationAuthorizationInput) async throws -> CreateVPCAssociationAuthorizationOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateVPCAssociationAuthorizationInput, CreateVPCAssociationAuthorizationOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<CreateVPCAssociationAuthorizationInput, CreateVPCAssociationAuthorizationOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CreateVPCAssociationAuthorizationOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<CreateVPCAssociationAuthorizationInput, CreateVPCAssociationAuthorizationOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateVPCAssociationAuthorizationInput, CreateVPCAssociationAuthorizationOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("CreateVPCAssociationAuthorizationRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: CreateVPCAssociationAuthorizationInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateVPCAssociationAuthorizationOutput>(responseClosure(CreateVPCAssociationAuthorizationOutput.httpBinding, responseDocumentBinding), responseErrorClosure(CreateVPCAssociationAuthorizationOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func deactivateKeySigningKey(input: DeactivateKeySigningKeyInput) async throws -> DeactivateKeySigningKeyOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeactivateKeySigningKeyInput, DeactivateKeySigningKeyOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<DeactivateKeySigningKeyInput, DeactivateKeySigningKeyOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeactivateKeySigningKeyOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeactivateKeySigningKeyOutput>(responseClosure(DeactivateKeySigningKeyOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DeactivateKeySigningKeyOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func deleteCidrCollection(input: DeleteCidrCollectionInput) async throws -> DeleteCidrCollectionOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteCidrCollectionInput, DeleteCidrCollectionOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteCidrCollectionOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteCidrCollectionOutput>(responseClosure(DeleteCidrCollectionOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DeleteCidrCollectionOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func deleteHealthCheck(input: DeleteHealthCheckInput) async throws -> DeleteHealthCheckOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteHealthCheckInput, DeleteHealthCheckOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteHealthCheckOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteHealthCheckOutput>(responseClosure(DeleteHealthCheckOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DeleteHealthCheckOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func deleteHostedZone(input: DeleteHostedZoneInput) async throws -> DeleteHostedZoneOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteHostedZoneInput, DeleteHostedZoneOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<DeleteHostedZoneInput, DeleteHostedZoneOutput>(\.id))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteHostedZoneOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteHostedZoneOutput>(responseClosure(DeleteHostedZoneOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DeleteHostedZoneOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func deleteKeySigningKey(input: DeleteKeySigningKeyInput) async throws -> DeleteKeySigningKeyOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteKeySigningKeyInput, DeleteKeySigningKeyOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<DeleteKeySigningKeyInput, DeleteKeySigningKeyOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteKeySigningKeyOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteKeySigningKeyOutput>(responseClosure(DeleteKeySigningKeyOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DeleteKeySigningKeyOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func deleteQueryLoggingConfig(input: DeleteQueryLoggingConfigInput) async throws -> DeleteQueryLoggingConfigOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteQueryLoggingConfigInput, DeleteQueryLoggingConfigOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteQueryLoggingConfigOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteQueryLoggingConfigOutput>(responseClosure(DeleteQueryLoggingConfigOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DeleteQueryLoggingConfigOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func deleteReusableDelegationSet(input: DeleteReusableDelegationSetInput) async throws -> DeleteReusableDelegationSetOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteReusableDelegationSetInput, DeleteReusableDelegationSetOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<DeleteReusableDelegationSetInput, DeleteReusableDelegationSetOutput>(\.id))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteReusableDelegationSetOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteReusableDelegationSetOutput>(responseClosure(DeleteReusableDelegationSetOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DeleteReusableDelegationSetOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func deleteTrafficPolicy(input: DeleteTrafficPolicyInput) async throws -> DeleteTrafficPolicyOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteTrafficPolicyInput, DeleteTrafficPolicyOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteTrafficPolicyOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteTrafficPolicyOutput>(responseClosure(DeleteTrafficPolicyOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DeleteTrafficPolicyOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func deleteTrafficPolicyInstance(input: DeleteTrafficPolicyInstanceInput) async throws -> DeleteTrafficPolicyInstanceOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteTrafficPolicyInstanceInput, DeleteTrafficPolicyInstanceOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteTrafficPolicyInstanceOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteTrafficPolicyInstanceOutput>(responseClosure(DeleteTrafficPolicyInstanceOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DeleteTrafficPolicyInstanceOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func deleteVPCAssociationAuthorization(input: DeleteVPCAssociationAuthorizationInput) async throws -> DeleteVPCAssociationAuthorizationOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteVPCAssociationAuthorizationInput, DeleteVPCAssociationAuthorizationOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<DeleteVPCAssociationAuthorizationInput, DeleteVPCAssociationAuthorizationOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteVPCAssociationAuthorizationOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<DeleteVPCAssociationAuthorizationInput, DeleteVPCAssociationAuthorizationOutput>(contentType: "application/xml"))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteVPCAssociationAuthorizationOutput>(responseClosure(DeleteVPCAssociationAuthorizationOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DeleteVPCAssociationAuthorizationOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func disableHostedZoneDNSSEC(input: DisableHostedZoneDNSSECInput) async throws -> DisableHostedZoneDNSSECOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DisableHostedZoneDNSSECInput, DisableHostedZoneDNSSECOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<DisableHostedZoneDNSSECInput, DisableHostedZoneDNSSECOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DisableHostedZoneDNSSECOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DisableHostedZoneDNSSECOutput>(responseClosure(DisableHostedZoneDNSSECOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DisableHostedZoneDNSSECOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func disassociateVPCFromHostedZone(input: DisassociateVPCFromHostedZoneInput) async throws -> DisassociateVPCFromHostedZoneOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DisassociateVPCFromHostedZoneInput, DisassociateVPCFromHostedZoneOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<DisassociateVPCFromHostedZoneInput, DisassociateVPCFromHostedZoneOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DisassociateVPCFromHostedZoneOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<DisassociateVPCFromHostedZoneInput, DisassociateVPCFromHostedZoneOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<DisassociateVPCFromHostedZoneInput, DisassociateVPCFromHostedZoneOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("DisassociateVPCFromHostedZoneRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: DisassociateVPCFromHostedZoneInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DisassociateVPCFromHostedZoneOutput>(responseClosure(DisassociateVPCFromHostedZoneOutput.httpBinding, responseDocumentBinding), responseErrorClosure(DisassociateVPCFromHostedZoneOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func enableHostedZoneDNSSEC(input: EnableHostedZoneDNSSECInput) async throws -> EnableHostedZoneDNSSECOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<EnableHostedZoneDNSSECInput, EnableHostedZoneDNSSECOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<EnableHostedZoneDNSSECInput, EnableHostedZoneDNSSECOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<EnableHostedZoneDNSSECOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<EnableHostedZoneDNSSECOutput>(responseClosure(EnableHostedZoneDNSSECOutput.httpBinding, responseDocumentBinding), responseErrorClosure(EnableHostedZoneDNSSECOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getAccountLimit(input: GetAccountLimitInput) async throws -> GetAccountLimitOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetAccountLimitInput, GetAccountLimitOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetAccountLimitOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetAccountLimitOutput>(responseClosure(GetAccountLimitOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetAccountLimitOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getChange(input: GetChangeInput) async throws -> GetChangeOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetChangeInput, GetChangeOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetChangeOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetChangeOutput>(responseClosure(GetChangeOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetChangeOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getCheckerIpRanges(input: GetCheckerIpRangesInput) async throws -> GetCheckerIpRangesOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetCheckerIpRangesInput, GetCheckerIpRangesOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetCheckerIpRangesOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetCheckerIpRangesOutput>(responseClosure(GetCheckerIpRangesOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetCheckerIpRangesOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getDNSSEC(input: GetDNSSECInput) async throws -> GetDNSSECOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetDNSSECInput, GetDNSSECOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<GetDNSSECInput, GetDNSSECOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetDNSSECOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetDNSSECOutput>(responseClosure(GetDNSSECOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetDNSSECOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getGeoLocation(input: GetGeoLocationInput) async throws -> GetGeoLocationOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetGeoLocationInput, GetGeoLocationOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetGeoLocationOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetGeoLocationOutput>(responseClosure(GetGeoLocationOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetGeoLocationOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getHealthCheck(input: GetHealthCheckInput) async throws -> GetHealthCheckOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetHealthCheckInput, GetHealthCheckOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetHealthCheckOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetHealthCheckOutput>(responseClosure(GetHealthCheckOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetHealthCheckOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getHealthCheckCount(input: GetHealthCheckCountInput) async throws -> GetHealthCheckCountOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetHealthCheckCountInput, GetHealthCheckCountOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetHealthCheckCountOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetHealthCheckCountOutput>(responseClosure(GetHealthCheckCountOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetHealthCheckCountOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getHealthCheckLastFailureReason(input: GetHealthCheckLastFailureReasonInput) async throws -> GetHealthCheckLastFailureReasonOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetHealthCheckLastFailureReasonInput, GetHealthCheckLastFailureReasonOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetHealthCheckLastFailureReasonOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetHealthCheckLastFailureReasonOutput>(responseClosure(GetHealthCheckLastFailureReasonOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetHealthCheckLastFailureReasonOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getHealthCheckStatus(input: GetHealthCheckStatusInput) async throws -> GetHealthCheckStatusOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetHealthCheckStatusInput, GetHealthCheckStatusOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetHealthCheckStatusOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetHealthCheckStatusOutput>(responseClosure(GetHealthCheckStatusOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetHealthCheckStatusOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getHostedZone(input: GetHostedZoneInput) async throws -> GetHostedZoneOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetHostedZoneInput, GetHostedZoneOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<GetHostedZoneInput, GetHostedZoneOutput>(\.id))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetHostedZoneOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetHostedZoneOutput>(responseClosure(GetHostedZoneOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetHostedZoneOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getHostedZoneCount(input: GetHostedZoneCountInput) async throws -> GetHostedZoneCountOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetHostedZoneCountInput, GetHostedZoneCountOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetHostedZoneCountOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetHostedZoneCountOutput>(responseClosure(GetHostedZoneCountOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetHostedZoneCountOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getHostedZoneLimit(input: GetHostedZoneLimitInput) async throws -> GetHostedZoneLimitOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetHostedZoneLimitInput, GetHostedZoneLimitOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<GetHostedZoneLimitInput, GetHostedZoneLimitOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetHostedZoneLimitOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetHostedZoneLimitOutput>(responseClosure(GetHostedZoneLimitOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetHostedZoneLimitOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getQueryLoggingConfig(input: GetQueryLoggingConfigInput) async throws -> GetQueryLoggingConfigOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetQueryLoggingConfigInput, GetQueryLoggingConfigOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetQueryLoggingConfigOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetQueryLoggingConfigOutput>(responseClosure(GetQueryLoggingConfigOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetQueryLoggingConfigOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getReusableDelegationSet(input: GetReusableDelegationSetInput) async throws -> GetReusableDelegationSetOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetReusableDelegationSetInput, GetReusableDelegationSetOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<GetReusableDelegationSetInput, GetReusableDelegationSetOutput>(\.id))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetReusableDelegationSetOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetReusableDelegationSetOutput>(responseClosure(GetReusableDelegationSetOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetReusableDelegationSetOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getReusableDelegationSetLimit(input: GetReusableDelegationSetLimitInput) async throws -> GetReusableDelegationSetLimitOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetReusableDelegationSetLimitInput, GetReusableDelegationSetLimitOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<GetReusableDelegationSetLimitInput, GetReusableDelegationSetLimitOutput>(\.delegationSetId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetReusableDelegationSetLimitOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetReusableDelegationSetLimitOutput>(responseClosure(GetReusableDelegationSetLimitOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetReusableDelegationSetLimitOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getTrafficPolicy(input: GetTrafficPolicyInput) async throws -> GetTrafficPolicyOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetTrafficPolicyInput, GetTrafficPolicyOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetTrafficPolicyOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetTrafficPolicyOutput>(responseClosure(GetTrafficPolicyOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetTrafficPolicyOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getTrafficPolicyInstance(input: GetTrafficPolicyInstanceInput) async throws -> GetTrafficPolicyInstanceOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetTrafficPolicyInstanceInput, GetTrafficPolicyInstanceOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetTrafficPolicyInstanceOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetTrafficPolicyInstanceOutput>(responseClosure(GetTrafficPolicyInstanceOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetTrafficPolicyInstanceOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func getTrafficPolicyInstanceCount(input: GetTrafficPolicyInstanceCountInput) async throws -> GetTrafficPolicyInstanceCountOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetTrafficPolicyInstanceCountInput, GetTrafficPolicyInstanceCountOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetTrafficPolicyInstanceCountOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetTrafficPolicyInstanceCountOutput>(responseClosure(GetTrafficPolicyInstanceCountOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetTrafficPolicyInstanceCountOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listCidrBlocks(input: ListCidrBlocksInput) async throws -> ListCidrBlocksOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListCidrBlocksInput, ListCidrBlocksOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListCidrBlocksOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListCidrBlocksOutput>(responseClosure(ListCidrBlocksOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListCidrBlocksOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listCidrCollections(input: ListCidrCollectionsInput) async throws -> ListCidrCollectionsOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListCidrCollectionsInput, ListCidrCollectionsOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListCidrCollectionsOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListCidrCollectionsOutput>(responseClosure(ListCidrCollectionsOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListCidrCollectionsOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listCidrLocations(input: ListCidrLocationsInput) async throws -> ListCidrLocationsOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListCidrLocationsInput, ListCidrLocationsOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListCidrLocationsOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListCidrLocationsOutput>(responseClosure(ListCidrLocationsOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListCidrLocationsOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listGeoLocations(input: ListGeoLocationsInput) async throws -> ListGeoLocationsOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListGeoLocationsInput, ListGeoLocationsOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListGeoLocationsOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListGeoLocationsOutput>(responseClosure(ListGeoLocationsOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListGeoLocationsOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listHealthChecks(input: ListHealthChecksInput) async throws -> ListHealthChecksOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListHealthChecksInput, ListHealthChecksOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListHealthChecksOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListHealthChecksOutput>(responseClosure(ListHealthChecksOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListHealthChecksOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listHostedZones(input: ListHostedZonesInput) async throws -> ListHostedZonesOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListHostedZonesInput, ListHostedZonesOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListHostedZonesOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListHostedZonesOutput>(responseClosure(ListHostedZonesOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListHostedZonesOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listHostedZonesByName(input: ListHostedZonesByNameInput) async throws -> ListHostedZonesByNameOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListHostedZonesByNameInput, ListHostedZonesByNameOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListHostedZonesByNameOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListHostedZonesByNameOutput>(responseClosure(ListHostedZonesByNameOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListHostedZonesByNameOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listHostedZonesByVPC(input: ListHostedZonesByVPCInput) async throws -> ListHostedZonesByVPCOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListHostedZonesByVPCInput, ListHostedZonesByVPCOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListHostedZonesByVPCOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListHostedZonesByVPCOutput>(responseClosure(ListHostedZonesByVPCOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListHostedZonesByVPCOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listQueryLoggingConfigs(input: ListQueryLoggingConfigsInput) async throws -> ListQueryLoggingConfigsOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListQueryLoggingConfigsInput, ListQueryLoggingConfigsOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListQueryLoggingConfigsOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListQueryLoggingConfigsOutput>(responseClosure(ListQueryLoggingConfigsOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListQueryLoggingConfigsOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listResourceRecordSets(input: ListResourceRecordSetsInput) async throws -> ListResourceRecordSetsOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListResourceRecordSetsInput, ListResourceRecordSetsOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<ListResourceRecordSetsInput, ListResourceRecordSetsOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListResourceRecordSetsOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListResourceRecordSetsOutput>(responseClosure(ListResourceRecordSetsOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListResourceRecordSetsOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listReusableDelegationSets(input: ListReusableDelegationSetsInput) async throws -> ListReusableDelegationSetsOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListReusableDelegationSetsInput, ListReusableDelegationSetsOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListReusableDelegationSetsOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListReusableDelegationSetsOutput>(responseClosure(ListReusableDelegationSetsOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListReusableDelegationSetsOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput {
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListTagsForResourceOutput>(responseClosure(ListTagsForResourceOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListTagsForResourceOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listTagsForResources(input: ListTagsForResourcesInput) async throws -> ListTagsForResourcesOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListTagsForResourcesInput, ListTagsForResourcesOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListTagsForResourcesOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListTagsForResourcesOutput>(responseClosure(ListTagsForResourcesOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListTagsForResourcesOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listTrafficPolicies(input: ListTrafficPoliciesInput) async throws -> ListTrafficPoliciesOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListTrafficPoliciesInput, ListTrafficPoliciesOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListTrafficPoliciesOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListTrafficPoliciesOutput>(responseClosure(ListTrafficPoliciesOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListTrafficPoliciesOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listTrafficPolicyInstances(input: ListTrafficPolicyInstancesInput) async throws -> ListTrafficPolicyInstancesOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListTrafficPolicyInstancesInput, ListTrafficPolicyInstancesOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListTrafficPolicyInstancesOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListTrafficPolicyInstancesOutput>(responseClosure(ListTrafficPolicyInstancesOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListTrafficPolicyInstancesOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listTrafficPolicyInstancesByHostedZone(input: ListTrafficPolicyInstancesByHostedZoneInput) async throws -> ListTrafficPolicyInstancesByHostedZoneOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListTrafficPolicyInstancesByHostedZoneInput, ListTrafficPolicyInstancesByHostedZoneOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListTrafficPolicyInstancesByHostedZoneOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
    ...
    public func listTrafficPolicyInstancesByPolicy(input: ListTrafficPolicyInstancesByPolicyInput) async throws -> ListTrafficPolicyInstancesByPolicyOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListTrafficPolicyInstancesByPolicyInput, ListTrafficPolicyInstancesByPolicyOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListTrafficPolicyInstancesByPolicyOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListTrafficPolicyInstancesByPolicyOutput>(responseClosure(ListTrafficPolicyInstancesByPolicyOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListTrafficPolicyInstancesByPolicyOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listTrafficPolicyVersions(input: ListTrafficPolicyVersionsInput) async throws -> ListTrafficPolicyVersionsOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListTrafficPolicyVersionsInput, ListTrafficPolicyVersionsOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListTrafficPolicyVersionsOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListTrafficPolicyVersionsOutput>(responseClosure(ListTrafficPolicyVersionsOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListTrafficPolicyVersionsOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func listVPCAssociationAuthorizations(input: ListVPCAssociationAuthorizationsInput) async throws -> ListVPCAssociationAuthorizationsOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListVPCAssociationAuthorizationsInput, ListVPCAssociationAuthorizationsOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<ListVPCAssociationAuthorizationsInput, ListVPCAssociationAuthorizationsOutput>(\.hostedZoneId))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListVPCAssociationAuthorizationsOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListVPCAssociationAuthorizationsOutput>(responseClosure(ListVPCAssociationAuthorizationsOutput.httpBinding, responseDocumentBinding), responseErrorClosure(ListVPCAssociationAuthorizationsOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func testDNSAnswer(input: TestDNSAnswerInput) async throws -> TestDNSAnswerOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<TestDNSAnswerInput, TestDNSAnswerOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<TestDNSAnswerOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<TestDNSAnswerOutput>(responseClosure(TestDNSAnswerOutput.httpBinding, responseDocumentBinding), responseErrorClosure(TestDNSAnswerOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func updateHealthCheck(input: UpdateHealthCheckInput) async throws -> UpdateHealthCheckOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<UpdateHealthCheckInput, UpdateHealthCheckOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<UpdateHealthCheckOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<UpdateHealthCheckInput, UpdateHealthCheckOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<UpdateHealthCheckInput, UpdateHealthCheckOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("UpdateHealthCheckRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: UpdateHealthCheckInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<UpdateHealthCheckOutput>(responseClosure(UpdateHealthCheckOutput.httpBinding, responseDocumentBinding), responseErrorClosure(UpdateHealthCheckOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func updateHostedZoneComment(input: UpdateHostedZoneCommentInput) async throws -> UpdateHostedZoneCommentOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<UpdateHostedZoneCommentInput, UpdateHostedZoneCommentOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        builder.interceptors.add(Route53TrimHostedZoneMiddleware<UpdateHostedZoneCommentInput, UpdateHostedZoneCommentOutput>(\.id))
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<UpdateHostedZoneCommentOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<UpdateHostedZoneCommentInput, UpdateHostedZoneCommentOutput>(contentType: "application/xml"))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<UpdateHostedZoneCommentOutput>(responseClosure(UpdateHostedZoneCommentOutput.httpBinding, responseDocumentBinding), responseErrorClosure(UpdateHostedZoneCommentOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func updateTrafficPolicyComment(input: UpdateTrafficPolicyCommentInput) async throws -> UpdateTrafficPolicyCommentOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<UpdateTrafficPolicyCommentInput, UpdateTrafficPolicyCommentOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<UpdateTrafficPolicyCommentOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<UpdateTrafficPolicyCommentInput, UpdateTrafficPolicyCommentOutput>(contentType: "application/xml"))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<UpdateTrafficPolicyCommentOutput>(responseClosure(UpdateTrafficPolicyCommentOutput.httpBinding, responseDocumentBinding), responseErrorClosure(UpdateTrafficPolicyCommentOutputError.httpBinding, responseDocumentBinding)))
    ...
    public func updateTrafficPolicyInstance(input: UpdateTrafficPolicyInstanceInput) async throws -> UpdateTrafficPolicyInstanceOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<UpdateTrafficPolicyInstanceInput, UpdateTrafficPolicyInstanceOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<UpdateTrafficPolicyInstanceOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        ...
        builder.interceptors.add(ContentTypeMiddleware<UpdateTrafficPolicyInstanceInput, UpdateTrafficPolicyInstanceOutput>(contentType: "application/xml"))
        builder.serialize(ClientRuntime.BodyMiddleware<UpdateTrafficPolicyInstanceInput, UpdateTrafficPolicyInstanceOutput, SmithyXML.Writer>(documentWritingClosure: SmithyXML.XMLReadWrite.documentWritingClosure(rootNodeInfo: .init("UpdateTrafficPolicyInstanceRequest", namespaceDef: .init(prefix: "", uri: "https://route53.amazonaws.com/doc/2013-04-01/"))), inputWritingClosure: UpdateTrafficPolicyInstanceInput.writingClosure(_:to:)))
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<UpdateTrafficPolicyInstanceOutput>(responseClosure(UpdateTrafficPolicyInstanceOutput.httpBinding, responseDocumentBinding), responseErrorClosure(UpdateTrafficPolicyInstanceOutputError.httpBinding, responseDocumentBinding)))
