...
extension Route53Client {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> Route53Client.Route53ClientConfiguration {
        let clientConfiguration = try await Route53Client.Route53ClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> Route53Client {
            let configuration = try await resolve(plugins: self.plugins)
            return Route53Client(config: configuration)
        }
    }
...
extension Route53Client.Route53ClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
