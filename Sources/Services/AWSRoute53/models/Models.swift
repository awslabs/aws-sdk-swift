...
extension Route53ClientTypes.AccountLimit: Swift.Decodable {
...
extension Route53ClientTypes.AlarmIdentifier: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case region = "Region"
    }
...
extension Route53ClientTypes.AliasTarget: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.AliasTarget?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("DNSName")].write(value.dnsName)
        try writer[.init("EvaluateTargetHealth")].write(value.evaluateTargetHealth)
        try writer[.init("HostedZoneId")].write(value.hostedZoneId)
    }
...
extension AssociateVPCWithHostedZoneInput {
    ...
    static func writingClosure(_ value: AssociateVPCWithHostedZoneInput?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("VPC")].write(value.vpc, writingClosure: Route53ClientTypes.VPC.writingClosure(_:to:))
    }
}
...
extension Route53ClientTypes.Change: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case action = "Action"
    ...
    static func writingClosure(_ value: Route53ClientTypes.Change?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("Action")].write(value.action)
        try writer[.init("ResourceRecordSet")].write(value.resourceRecordSet, writingClosure: Route53ClientTypes.ResourceRecordSet.writingClosure(_:to:))
    }
...
extension Route53ClientTypes.ChangeBatch: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.ChangeBatch?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("Changes")].writeList(value.changes, memberWritingClosure: Route53ClientTypes.Change.writingClosure(_:to:), memberNodeInfo: .init("Change"), isFlattened: false)
        try writer[.init("Comment")].write(value.comment)
    }
...
extension ChangeCidrCollectionInput {
    ...
    static func writingClosure(_ value: ChangeCidrCollectionInput?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("Changes")].writeList(value.changes, memberWritingClosure: Route53ClientTypes.CidrCollectionChange.writingClosure(_:to:), memberNodeInfo: .init("member"), isFlattened: false)
        try writer[.init("CollectionVersion")].write(value.collectionVersion)
    }
}
...
extension Route53ClientTypes.ChangeInfo: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case comment = "Comment"
        case id = "Id"
        case status = "Status"
    ...
    static func writingClosure(_ value: Route53ClientTypes.ChangeInfo?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("SubmittedAt")].writeTimestamp(value.submittedAt, format: .dateTime)
    }
...
extension ChangeResourceRecordSetsInput {
    ...
    static func writingClosure(_ value: ChangeResourceRecordSetsInput?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("ChangeBatch")].write(value.changeBatch, writingClosure: Route53ClientTypes.ChangeBatch.writingClosure(_:to:))
    }
}
...
extension ChangeTagsForResourceInput {
    ...
    static func writingClosure(_ value: ChangeTagsForResourceInput?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("AddTags")].writeList(value.addTags, memberWritingClosure: Route53ClientTypes.Tag.writingClosure(_:to:), memberNodeInfo: .init("Tag"), isFlattened: false)
        try writer[.init("RemoveTagKeys")].writeList(value.removeTagKeys, memberWritingClosure: Swift.String.writingClosure(_:to:), memberNodeInfo: .init("Key"), isFlattened: false)
    }
}
...
extension Route53ClientTypes.CidrBlockSummary: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.CidrBlockSummary?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("CidrBlock")].write(value.cidrBlock)
        try writer[.init("LocationName")].write(value.locationName)
    }
...
extension Route53ClientTypes.CidrCollection: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
        case id = "Id"
        case name = "Name"
    ...
    static func writingClosure(_ value: Route53ClientTypes.CidrCollection?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("Id")].write(value.id)
        try writer[.init("Name")].write(value.name)
        try writer[.init("Version")].write(value.version)
    }
...
extension Route53ClientTypes.CidrCollectionChange: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case action = "Action"
    ...
    static func writingClosure(_ value: Route53ClientTypes.CidrCollectionChange?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("Action")].write(value.action)
        try writer[.init("CidrList")].writeList(value.cidrList, memberWritingClosure: Swift.String.writingClosure(_:to:), memberNodeInfo: .init("Cidr"), isFlattened: false)
        try writer[.init("LocationName")].write(value.locationName)
    }
...
extension Route53ClientTypes.CidrRoutingConfig: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.CidrRoutingConfig?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("CollectionId")].write(value.collectionId)
        try writer[.init("LocationName")].write(value.locationName)
    }
...
extension Route53ClientTypes.CloudWatchAlarmConfiguration: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.CloudWatchAlarmConfiguration?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("ComparisonOperator")].write(value.comparisonOperator)
        try writer[.init("Dimensions")].writeList(value.dimensions, memberWritingClosure: Route53ClientTypes.Dimension.writingClosure(_:to:), memberNodeInfo: .init("Dimension"), isFlattened: false)
        try writer[.init("EvaluationPeriods")].write(value.evaluationPeriods)
        try writer[.init("MetricName")].write(value.metricName)
        try writer[.init("Namespace")].write(value.namespace)
        try writer[.init("Period")].write(value.period)
        try writer[.init("Statistic")].write(value.statistic)
        try writer[.init("Threshold")].write(value.threshold)
    }
...
extension Route53ClientTypes.CollectionSummary: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
        case id = "Id"
        case name = "Name"
...
extension CreateCidrCollectionInput {
    ...
    static func writingClosure(_ value: CreateCidrCollectionInput?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("CallerReference")].write(value.callerReference)
        try writer[.init("Name")].write(value.name)
    }
}
...
extension CreateHealthCheckInput {
    ...
    static func writingClosure(_ value: CreateHealthCheckInput?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("CallerReference")].write(value.callerReference)
        try writer[.init("HealthCheckConfig")].write(value.healthCheckConfig, writingClosure: Route53ClientTypes.HealthCheckConfig.writingClosure(_:to:))
    }
}
...
extension CreateHostedZoneInput {
    ...
    static func writingClosure(_ value: CreateHostedZoneInput?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("CallerReference")].write(value.callerReference)
        try writer[.init("DelegationSetId")].write(value.delegationSetId)
        try writer[.init("HostedZoneConfig")].write(value.hostedZoneConfig, writingClosure: Route53ClientTypes.HostedZoneConfig.writingClosure(_:to:))
        try writer[.init("Name")].write(value.name)
        try writer[.init("VPC")].write(value.vpc, writingClosure: Route53ClientTypes.VPC.writingClosure(_:to:))
    }
}
...
extension CreateKeySigningKeyInput {
    ...
    static func writingClosure(_ value: CreateKeySigningKeyInput?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("CallerReference")].write(value.callerReference)
        try writer[.init("HostedZoneId")].write(value.hostedZoneId)
        try writer[.init("KeyManagementServiceArn")].write(value.keyManagementServiceArn)
        try writer[.init("Name")].write(value.name)
        try writer[.init("Status")].write(value.status)
    }
}
...
extension CreateQueryLoggingConfigInput {
    ...
    static func writingClosure(_ value: CreateQueryLoggingConfigInput?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("CloudWatchLogsLogGroupArn")].write(value.cloudWatchLogsLogGroupArn)
        try writer[.init("HostedZoneId")].write(value.hostedZoneId)
    }
}
...
extension CreateTrafficPolicyInput {
    ...
    static func writingClosure(_ value: CreateTrafficPolicyInput?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("Comment")].write(value.comment)
        try writer[.init("Document")].write(value.document)
        try writer[.init("Name")].write(value.name)
    }
}
...
extension CreateTrafficPolicyInstanceInput {
    ...
    static func writingClosure(_ value: CreateTrafficPolicyInstanceInput?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("HostedZoneId")].write(value.hostedZoneId)
        try writer[.init("Name")].write(value.name)
        try writer[.init("TTL")].write(value.ttl)
        try writer[.init("TrafficPolicyId")].write(value.trafficPolicyId)
        try writer[.init("TrafficPolicyVersion")].write(value.trafficPolicyVersion)
    }
}
...
extension Route53ClientTypes.DNSSECStatus: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.DNSSECStatus?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("ServeSignature")].write(value.serveSignature)
        try writer[.init("StatusMessage")].write(value.statusMessage)
    }
...
extension Route53ClientTypes.DelegationSet: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case callerReference = "CallerReference"
        case id = "Id"
    ...
    static func writingClosure(_ value: Route53ClientTypes.DelegationSet?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("CallerReference")].write(value.callerReference)
        try writer[.init("Id")].write(value.id)
        try writer[.init("NameServers")].writeList(value.nameServers, memberWritingClosure: Swift.String.writingClosure(_:to:), memberNodeInfo: .init("NameServer"), isFlattened: false)
    }
...
extension Route53ClientTypes.Dimension: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case value = "Value"
    }
...
extension Route53ClientTypes.GeoLocation: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.GeoLocation?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("ContinentCode")].write(value.continentCode)
        try writer[.init("CountryCode")].write(value.countryCode)
        try writer[.init("SubdivisionCode")].write(value.subdivisionCode)
    }
...
extension Route53ClientTypes.GeoLocationDetails: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case continentCode = "ContinentCode"
    ...
    static func writingClosure(_ value: Route53ClientTypes.GeoLocationDetails?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("ContinentCode")].write(value.continentCode)
        try writer[.init("ContinentName")].write(value.continentName)
        try writer[.init("CountryCode")].write(value.countryCode)
        try writer[.init("CountryName")].write(value.countryName)
        try writer[.init("SubdivisionCode")].write(value.subdivisionCode)
        try writer[.init("SubdivisionName")].write(value.subdivisionName)
    }
...
extension Route53ClientTypes.HealthCheck: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case callerReference = "CallerReference"
    ...
    static func writingClosure(_ value: Route53ClientTypes.HealthCheck?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("CallerReference")].write(value.callerReference)
        try writer[.init("CloudWatchAlarmConfiguration")].write(value.cloudWatchAlarmConfiguration, writingClosure: Route53ClientTypes.CloudWatchAlarmConfiguration.writingClosure(_:to:))
        try writer[.init("HealthCheckConfig")].write(value.healthCheckConfig, writingClosure: Route53ClientTypes.HealthCheckConfig.writingClosure(_:to:))
        try writer[.init("HealthCheckVersion")].write(value.healthCheckVersion)
        try writer[.init("Id")].write(value.id)
        try writer[.init("LinkedService")].write(value.linkedService, writingClosure: Route53ClientTypes.LinkedService.writingClosure(_:to:))
    }
...
extension Route53ClientTypes.HealthCheckConfig: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.HealthCheckConfig?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("AlarmIdentifier")].write(value.alarmIdentifier, writingClosure: Route53ClientTypes.AlarmIdentifier.writingClosure(_:to:))
        try writer[.init("ChildHealthChecks")].writeList(value.childHealthChecks, memberWritingClosure: Swift.String.writingClosure(_:to:), memberNodeInfo: .init("ChildHealthCheck"), isFlattened: false)
        try writer[.init("Disabled")].write(value.disabled)
        try writer[.init("EnableSNI")].write(value.enableSNI)
        try writer[.init("FailureThreshold")].write(value.failureThreshold)
        try writer[.init("FullyQualifiedDomainName")].write(value.fullyQualifiedDomainName)
        try writer[.init("HealthThreshold")].write(value.healthThreshold)
        try writer[.init("IPAddress")].write(value.ipAddress)
        try writer[.init("InsufficientDataHealthStatus")].write(value.insufficientDataHealthStatus)
        try writer[.init("Inverted")].write(value.inverted)
        try writer[.init("MeasureLatency")].write(value.measureLatency)
        try writer[.init("Port")].write(value.port)
        try writer[.init("Regions")].writeList(value.regions, memberWritingClosure: Route53ClientTypes.HealthCheckRegion.writingClosure(_:to:), memberNodeInfo: .init("Region"), isFlattened: false)
        try writer[.init("RequestInterval")].write(value.requestInterval)
        try writer[.init("ResourcePath")].write(value.resourcePath)
        try writer[.init("RoutingControlArn")].write(value.routingControlArn)
        try writer[.init("SearchString")].write(value.searchString)
        try writer[.init("Type")].write(value.type)
    }
...
extension Route53ClientTypes.HealthCheckObservation: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case ipAddress = "IPAddress"
        case region = "Region"
    ...
    static func writingClosure(_ value: Route53ClientTypes.HealthCheckObservation?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("IPAddress")].write(value.ipAddress)
        try writer[.init("Region")].write(value.region)
        try writer[.init("StatusReport")].write(value.statusReport, writingClosure: Route53ClientTypes.StatusReport.writingClosure(_:to:))
    }
...
extension Route53ClientTypes.HostedZone: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case callerReference = "CallerReference"
        case config = "Config"
        case id = "Id"
    ...
    static func writingClosure(_ value: Route53ClientTypes.HostedZone?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("CallerReference")].write(value.callerReference)
        try writer[.init("Config")].write(value.config, writingClosure: Route53ClientTypes.HostedZoneConfig.writingClosure(_:to:))
        try writer[.init("Id")].write(value.id)
        try writer[.init("LinkedService")].write(value.linkedService, writingClosure: Route53ClientTypes.LinkedService.writingClosure(_:to:))
        try writer[.init("Name")].write(value.name)
        try writer[.init("ResourceRecordSetCount")].write(value.resourceRecordSetCount)
    }
...
extension Route53ClientTypes.HostedZoneConfig: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case comment = "Comment"
    ...
    static func writingClosure(_ value: Route53ClientTypes.HostedZoneConfig?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("Comment")].write(value.comment)
        try writer[.init("PrivateZone")].write(value.privateZone)
    }
...
extension Route53ClientTypes.HostedZoneLimit: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case type = "Type"
        case value = "Value"
    }
...
extension Route53ClientTypes.HostedZoneOwner: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.HostedZoneOwner?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("OwningAccount")].write(value.owningAccount)
        try writer[.init("OwningService")].write(value.owningService)
    }
...
extension Route53ClientTypes.HostedZoneSummary: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case hostedZoneId = "HostedZoneId"
        case name = "Name"
        case owner = "Owner"
    ...
    static func writingClosure(_ value: Route53ClientTypes.HostedZoneSummary?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("HostedZoneId")].write(value.hostedZoneId)
        try writer[.init("Name")].write(value.name)
        try writer[.init("Owner")].write(value.owner, writingClosure: Route53ClientTypes.HostedZoneOwner.writingClosure(_:to:))
    }
...
extension Route53ClientTypes.KeySigningKey: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.KeySigningKey?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("CreatedDate")].writeTimestamp(value.createdDate, format: .dateTime)
        try writer[.init("DNSKEYRecord")].write(value.dnskeyRecord)
        try writer[.init("DSRecord")].write(value.dsRecord)
        try writer[.init("DigestAlgorithmMnemonic")].write(value.digestAlgorithmMnemonic)
        try writer[.init("DigestAlgorithmType")].write(value.digestAlgorithmType)
        try writer[.init("DigestValue")].write(value.digestValue)
        try writer[.init("Flag")].write(value.flag)
        try writer[.init("KeyTag")].write(value.keyTag)
        try writer[.init("KmsArn")].write(value.kmsArn)
        try writer[.init("LastModifiedDate")].writeTimestamp(value.lastModifiedDate, format: .dateTime)
        try writer[.init("Name")].write(value.name)
        try writer[.init("PublicKey")].write(value.publicKey)
        try writer[.init("SigningAlgorithmMnemonic")].write(value.signingAlgorithmMnemonic)
        try writer[.init("SigningAlgorithmType")].write(value.signingAlgorithmType)
        try writer[.init("Status")].write(value.status)
        try writer[.init("StatusMessage")].write(value.statusMessage)
    }
...
extension Route53ClientTypes.LinkedService: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.LinkedService?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("ServicePrincipal")].write(value.servicePrincipal)
    }
...
extension ListTagsForResourcesInput {
    ...
    static func writingClosure(_ value: ListTagsForResourcesInput?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("ResourceIds")].writeList(value.resourceIds, memberWritingClosure: Swift.String.writingClosure(_:to:), memberNodeInfo: .init("ResourceId"), isFlattened: false)
    }
}
...
extension Route53ClientTypes.LocationSummary: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case locationName = "LocationName"
    }
...
extension Route53ClientTypes.QueryLoggingConfig: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cloudWatchLogsLogGroupArn = "CloudWatchLogsLogGroupArn"
        case hostedZoneId = "HostedZoneId"
        case id = "Id"
...
extension Route53ClientTypes.ResourceRecord: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case value = "Value"
    }
...
extension Route53ClientTypes.ResourceRecordSet: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.ResourceRecordSet?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("AliasTarget")].write(value.aliasTarget, writingClosure: Route53ClientTypes.AliasTarget.writingClosure(_:to:))
        ...
        try writer[.init("Name")].write(value.name)
        try writer[.init("Region")].write(value.region)
        try writer[.init("ResourceRecords")].writeList(value.resourceRecords, memberWritingClosure: Route53ClientTypes.ResourceRecord.writingClosure(_:to:), memberNodeInfo: .init("ResourceRecord"), isFlattened: false)
        try writer[.init("SetIdentifier")].write(value.setIdentifier)
        try writer[.init("TTL")].write(value.ttl)
        try writer[.init("TrafficPolicyInstanceId")].write(value.trafficPolicyInstanceId)
        try writer[.init("Type")].write(value.type)
        try writer[.init("Weight")].write(value.weight)
    }
...
extension Route53ClientTypes.ResourceTagSet: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.ResourceTagSet?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("ResourceId")].write(value.resourceId)
        try writer[.init("ResourceType")].write(value.resourceType)
        try writer[.init("Tags")].writeList(value.tags, memberWritingClosure: Route53ClientTypes.Tag.writingClosure(_:to:), memberNodeInfo: .init("Tag"), isFlattened: false)
    }
...
extension Route53ClientTypes.ReusableDelegationSetLimit: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case type = "Type"
        case value = "Value"
    }
...
extension Route53ClientTypes.StatusReport: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static func writingClosure(_ value: Route53ClientTypes.StatusReport?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("CheckedTime")].writeTimestamp(value.checkedTime, format: .dateTime)
        try writer[.init("Status")].write(value.status)
    }
...
extension Route53ClientTypes.Tag: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
...
extension Route53ClientTypes.TrafficPolicy: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case comment = "Comment"
        case document = "Document"
        case id = "Id"
...
extension Route53ClientTypes.TrafficPolicyInstance: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case hostedZoneId = "HostedZoneId"
        case id = "Id"
        case message = "Message"
    ...
    static func writingClosure(_ value: Route53ClientTypes.TrafficPolicyInstance?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("Name")].write(value.name)
        try writer[.init("State")].write(value.state)
        try writer[.init("TTL")].write(value.ttl)
        try writer[.init("TrafficPolicyId")].write(value.trafficPolicyId)
        try writer[.init("TrafficPolicyType")].write(value.trafficPolicyType)
        try writer[.init("TrafficPolicyVersion")].write(value.trafficPolicyVersion)
    }
...
extension Route53ClientTypes.TrafficPolicySummary: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case id = "Id"
    ...
    static func writingClosure(_ value: Route53ClientTypes.TrafficPolicySummary?, to writer: SmithyXML.Writer) throws {
        guard let value else { writer.detach(); return }
        try writer[.init("Id")].write(value.id)
        try writer[.init("LatestVersion")].write(value.latestVersion)
        try writer[.init("Name")].write(value.name)
        try writer[.init("TrafficPolicyCount")].write(value.trafficPolicyCount)
        try writer[.init("Type")].write(value.type)
    }
...
extension UpdateHealthCheckInput {
    ...
    static func writingClosure(_ value: UpdateHealthCheckInput?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("Port")].write(value.port)
        try writer[.init("Regions")].writeList(value.regions, memberWritingClosure: Route53ClientTypes.HealthCheckRegion.writingClosure(_:to:), memberNodeInfo: .init("Region"), isFlattened: false)
        try writer[.init("ResetElements")].writeList(value.resetElements, memberWritingClosure: Route53ClientTypes.ResettableElementName.writingClosure(_:to:), memberNodeInfo: .init("ResettableElementName"), isFlattened: false)
        try writer[.init("ResourcePath")].write(value.resourcePath)
        try writer[.init("SearchString")].write(value.searchString)
    }
}
...
extension Route53ClientTypes.VPC: Swift.Decodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case vpcId = "VPCId"
    ...
    static func writingClosure(_ value: Route53ClientTypes.VPC?, to writer: SmithyXML.Writer) throws {
        ...
        try writer[.init("VPCRegion")].write(value.vpcRegion)
    }
