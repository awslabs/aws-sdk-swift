...
extension DocDBElasticClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> DocDBElasticClient.DocDBElasticClientConfiguration {
        let clientConfiguration = try await DocDBElasticClient.DocDBElasticClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> DocDBElasticClient {
            let configuration = try await resolve(plugins: self.plugins)
            return DocDBElasticClient(config: configuration)
        }
    }
...
extension DocDBElasticClient.DocDBElasticClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
