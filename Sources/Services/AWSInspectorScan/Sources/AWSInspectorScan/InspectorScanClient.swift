...
extension InspectorScanClient {
    ...
    public func scanSbom(input: ScanSbomInput) async throws -> ScanSbomOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ScanSbomInput, ScanSbomOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
