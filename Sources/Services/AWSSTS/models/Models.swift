...
extension AssumeRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AssumeRoleOutput {
        let reader = responseReader["AssumeRoleResult"]
        var value = AssumeRoleOutput()
        value.assumedRoleUser = try reader["AssumedRoleUser"].readIfPresent(readingClosure: STSClientTypes.AssumedRoleUser.readingClosure(from:))
        value.credentials = try reader["Credentials"].readIfPresent(readingClosure: STSClientTypes.Credentials.readingClosure(from:))
...
extension AssumeRoleWithSAMLOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AssumeRoleWithSAMLOutput {
...
extension AssumeRoleWithWebIdentityOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AssumeRoleWithWebIdentityOutput {
...
extension STSClientTypes.AssumedRoleUser: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> STSClientTypes.AssumedRoleUser {
...
extension STSClientTypes.Credentials: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> STSClientTypes.Credentials {
...
extension DecodeAuthorizationMessageOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DecodeAuthorizationMessageOutput {
...
extension STSClientTypes.FederatedUser: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> STSClientTypes.FederatedUser {
...
extension GetAccessKeyInfoOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetAccessKeyInfoOutput {
...
extension GetCallerIdentityInput {
    public func presign(config: STSClient.STSClientConfiguration, expiration: Foundation.TimeInterval) async throws -> ClientRuntime.SdkHttpRequest? {
        ...
        operation.deserializeStep.intercept(position: .after, middleware: ClientRuntime.DeserializeMiddleware<GetCallerIdentityOutput>(responseClosure(GetCallerIdentityOutput.responseOutputBinding(httpResponse:reader:), responseDocumentBinding()), responseErrorClosure(GetCallerIdentityOutputError.responseErrorBinding(httpResponse:reader:), responseDocumentBinding())))
...
extension GetCallerIdentityOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetCallerIdentityOutput {
...
extension GetFederationTokenOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetFederationTokenOutput {
        let reader = responseReader["GetFederationTokenResult"]
        var value = GetFederationTokenOutput()
        value.credentials = try reader["Credentials"].readIfPresent(readingClosure: STSClientTypes.Credentials.readingClosure(from:))
        value.federatedUser = try reader["FederatedUser"].readIfPresent(readingClosure: STSClientTypes.FederatedUser.readingClosure(from:))
        value.packedPolicySize = try reader["PackedPolicySize"].readIfPresent()
        return value
    }
}
...
extension GetSessionTokenOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetSessionTokenOutput {
...
extension STSClientTypes.PolicyDescriptorType: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> STSClientTypes.PolicyDescriptorType {
...
extension STSClientTypes.ProvidedContext: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> STSClientTypes.ProvidedContext {
...
extension STSClientTypes.Tag: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> STSClientTypes.Tag {
