...
extension AssumeRoleOutput {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseOutputBinding<AssumeRoleOutput, SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            let responseReader = try await responseDocumentClosure(httpResponse)
            let reader = responseReader["AssumeRoleResult"]
            var value = AssumeRoleOutput()
            value.assumedRoleUser = try reader["AssumedRoleUser"].readIfPresent(readingClosure: STSClientTypes.AssumedRoleUser.readingClosure)
            value.credentials = try reader["Credentials"].readIfPresent(readingClosure: STSClientTypes.Credentials.readingClosure)
...
public struct AssumeRoleOutput {
...
enum AssumeRoleOutputError {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseErrorBinding<SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            ...
            switch code {
                case "ExpiredTokenException": return try await ExpiredTokenException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                ...
                case "PackedPolicyTooLarge": return try await PackedPolicyTooLargeException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "RegionDisabledException": return try await RegionDisabledException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
...
public struct AssumeRoleWithSAMLInput {
...
extension AssumeRoleWithSAMLOutput {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseOutputBinding<AssumeRoleWithSAMLOutput, SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            let responseReader = try await responseDocumentClosure(httpResponse)
...
public struct AssumeRoleWithSAMLOutput {
...
enum AssumeRoleWithSAMLOutputError {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseErrorBinding<SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            ...
            switch code {
                case "ExpiredTokenException": return try await ExpiredTokenException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "IDPRejectedClaim": return try await IDPRejectedClaimException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "InvalidIdentityToken": return try await InvalidIdentityTokenException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "MalformedPolicyDocument": return try await MalformedPolicyDocumentException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "PackedPolicyTooLarge": return try await PackedPolicyTooLargeException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "RegionDisabledException": return try await RegionDisabledException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                default: return try await AWSClientRuntime.UnknownAWSHTTPServiceError.makeError(httpResponse: httpResponse, message: message, requestID: requestID, typeName: code)
...
public struct AssumeRoleWithWebIdentityInput {
...
extension AssumeRoleWithWebIdentityOutput {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseOutputBinding<AssumeRoleWithWebIdentityOutput, SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            let responseReader = try await responseDocumentClosure(httpResponse)
...
public struct AssumeRoleWithWebIdentityOutput {
    /// The Amazon Resource Name (ARN) and the assumed role ID, which are identifiers that you can use to refer to the resulting temporary security credentials. For example, you can reference these credentials as a principal in a resource-based policy by using the ARN or assumed role ID. The ARN and ID include the RoleSessionName that you specified when you called AssumeRole.
    public var assumedRoleUser: STSClientTypes.AssumedRoleUser?
...
enum AssumeRoleWithWebIdentityOutputError {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseErrorBinding<SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            ...
            switch code {
                case "ExpiredTokenException": return try await ExpiredTokenException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "IDPCommunicationError": return try await IDPCommunicationErrorException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "IDPRejectedClaim": return try await IDPRejectedClaimException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "InvalidIdentityToken": return try await InvalidIdentityTokenException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "MalformedPolicyDocument": return try await MalformedPolicyDocumentException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                case "PackedPolicyTooLarge": return try await PackedPolicyTooLargeException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
...
extension STSClientTypes.AssumedRoleUser: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
    ...
    static var readingClosure: SmithyReadWrite.ReadingClosure<STSClientTypes.AssumedRoleUser, SmithyXML.Reader> {
        return { reader in
...
extension STSClientTypes.Credentials: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static var readingClosure: SmithyReadWrite.ReadingClosure<STSClientTypes.Credentials, SmithyXML.Reader> {
        return { reader in
            guard reader.content != nil else { return nil }
...
public struct DecodeAuthorizationMessageInput {
...
extension DecodeAuthorizationMessageOutput {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseOutputBinding<DecodeAuthorizationMessageOutput, SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            let responseReader = try await responseDocumentClosure(httpResponse)
...
public struct DecodeAuthorizationMessageOutput {
...
enum DecodeAuthorizationMessageOutputError {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseErrorBinding<SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            ...
            let message: String? = try reader["Message"].readIfPresent()
            switch code {
                case "InvalidAuthorizationMessageException": return try await InvalidAuthorizationMessageException.responseErrorBinding(httpResponse: httpResponse, reader: reader, message: message, requestID: requestID)
                default: return try await AWSClientRuntime.UnknownAWSHTTPServiceError.makeError(httpResponse: httpResponse, message: message, requestID: requestID, typeName: code)
            }
        }
    }
...
extension STSClientTypes.FederatedUser: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
    ...
    static var readingClosure: SmithyReadWrite.ReadingClosure<STSClientTypes.FederatedUser, SmithyXML.Reader> {
        return { reader in
            guard reader.content != nil else { return nil }
...
public struct GetAccessKeyInfoInput {
...
extension GetAccessKeyInfoOutput {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseOutputBinding<GetAccessKeyInfoOutput, SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            let responseReader = try await responseDocumentClosure(httpResponse)
...
public struct GetAccessKeyInfoOutput {
...
extension GetCallerIdentityInput {
    public func presign(config: STSClient.STSClientConfiguration, expiration: Foundation.TimeInterval) async throws -> ClientRuntime.SdkHttpRequest? {
        ...
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware<GetCallerIdentityOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<GetCallerIdentityInput, GetCallerIdentityOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<GetCallerIdentityOutput>())
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<GetCallerIdentityInput, GetCallerIdentityOutput>())
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<GetCallerIdentityOutput>())
        operation.deserializeStep.intercept(position: .after, middleware: ClientRuntime.DeserializeMiddleware<GetCallerIdentityOutput>(responseClosure(GetCallerIdentityOutput.httpBinding, responseDocumentBinding), responseErrorClosure(GetCallerIdentityOutputError.httpBinding, responseDocumentBinding)))
        operation.deserializeStep.intercept(position: .after, middleware: ClientRuntime.LoggerMiddleware<GetCallerIdentityInput, GetCallerIdentityOutput>(clientLogMode: config.clientLogMode))
...
public struct GetCallerIdentityInput {
...
extension GetCallerIdentityOutput {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseOutputBinding<GetCallerIdentityOutput, SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            let responseReader = try await responseDocumentClosure(httpResponse)
...
public struct GetCallerIdentityOutput {
...
extension GetFederationTokenOutput {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseOutputBinding<GetFederationTokenOutput, SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            let responseReader = try await responseDocumentClosure(httpResponse)
            let reader = responseReader["GetFederationTokenResult"]
            var value = GetFederationTokenOutput()
            value.credentials = try reader["Credentials"].readIfPresent(readingClosure: STSClientTypes.Credentials.readingClosure)
            value.federatedUser = try reader["FederatedUser"].readIfPresent(readingClosure: STSClientTypes.FederatedUser.readingClosure)
            value.packedPolicySize = try reader["PackedPolicySize"].readIfPresent()
            return value
        }
    }
...
public struct GetSessionTokenInput {
...
extension GetSessionTokenOutput {
    ...
    static var httpBinding: ClientRuntime.HTTPResponseOutputBinding<GetSessionTokenOutput, SmithyXML.Reader> {
        { httpResponse, responseDocumentClosure in
            let responseReader = try await responseDocumentClosure(httpResponse)
...
public struct GetSessionTokenOutput {
    /// The temporary security credentials, which include an access key ID, a secret access key, and a security (or session) token. The size of the security token that STS API operations return is not fixed. We strongly recommend that you make no assumptions about the maximum size.
    public var credentials: STSClientTypes.Credentials?
...
extension STSClientTypes.PolicyDescriptorType: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
    }
    ...
    static var readingClosure: SmithyReadWrite.ReadingClosure<STSClientTypes.PolicyDescriptorType, SmithyXML.Reader> {
        return { reader in
            guard reader.content != nil else { return nil }
...
extension STSClientTypes.ProvidedContext: Swift.Encodable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    static var readingClosure: SmithyReadWrite.ReadingClosure<STSClientTypes.ProvidedContext, SmithyXML.Reader> {
        return { reader in
            guard reader.content != nil else { return nil }
...
extension STSClientTypes.Tag: Swift.Encodable {
    ...
    static var readingClosure: SmithyReadWrite.ReadingClosure<STSClientTypes.Tag, SmithyXML.Reader> {
        return { reader in
            guard reader.content != nil else { return nil }
