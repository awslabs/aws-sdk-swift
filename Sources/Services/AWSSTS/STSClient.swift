...
extension STSClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> STSClient.STSClientConfiguration {
        let clientConfiguration = try await STSClient.STSClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> STSClient {
            let configuration = try await resolve(plugins: self.plugins)
            return STSClient(config: configuration)
        }
    }
...
extension STSClient.STSClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
