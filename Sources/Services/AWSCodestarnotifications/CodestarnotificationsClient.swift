...
extension CodestarnotificationsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CodestarnotificationsClient.CodestarnotificationsClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> CodestarnotificationsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CodestarnotificationsClient(config: configuration)
        }
    }
...
extension CodestarnotificationsClient.CodestarnotificationsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
