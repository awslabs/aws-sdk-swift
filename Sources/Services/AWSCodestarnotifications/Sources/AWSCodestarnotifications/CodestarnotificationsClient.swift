...
public final class CodestarnotificationsClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: CodestarnotificationsClient.CodestarnotificationsClientConfig) instead")
    public convenience init(config: CodestarnotificationsClient.CodestarnotificationsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try CodestarnotificationsClient.CodestarnotificationsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await CodestarnotificationsClient.CodestarnotificationsClientConfig()
        self.init(config: config)
    }
}
...
extension CodestarnotificationsClient {
    ...
    /// Client configuration for CodestarnotificationsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct CodestarnotificationsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "codestar notifications")
    ...
    @available(*, deprecated, message: "Use CodestarnotificationsClientConfig instead. This class will be removed in a future version.")
    public final class CodestarnotificationsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> CodestarnotificationsClientConfig {
            return try CodestarnotificationsClientConfig(
...
extension CodestarnotificationsClient {
    ...
    public func createNotificationRule(input: CreateNotificationRuleInput) async throws -> CreateNotificationRuleOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "codestar notifications"))
