...
extension GetActionRecommendationsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetActionRecommendationsOutput {
...
extension GetPersonalizedRankingInput {
    ...
    static func write(value: GetPersonalizedRankingInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["filterArn"].write(value.filterArn)
        try writer["filterValues"].writeMap(value.filterValues, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["inputList"].writeList(value.inputList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["metadataColumns"].writeMap(value.metadataColumns, valueWritingClosure: listWritingClosure(memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["userId"].write(value.userId)
    }
}
...
extension GetPersonalizedRankingOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetPersonalizedRankingOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension PersonalizeRuntimeClientTypes.PredictedItem {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PersonalizeRuntimeClientTypes.PredictedItem {
        ...
        value.reason = try reader["reason"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
