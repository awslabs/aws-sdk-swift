...
public final class PersonalizeRuntimeClient: AWSClientRuntime.AWSServiceClient {
    ...
    public let config: PersonalizeRuntimeClient.PersonalizeRuntimeClientConfig
    ...
    public typealias Configuration = PersonalizeRuntimeClient.PersonalizeRuntimeClientConfig
...
extension PersonalizeRuntimeClient {
    ...
    public struct PersonalizeRuntimeClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Personalize Runtime")
...
extension PersonalizeRuntimeClient {
    ...
    public func getActionRecommendations(input: GetActionRecommendationsInput) async throws -> GetActionRecommendationsOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Personalize Runtime"))
