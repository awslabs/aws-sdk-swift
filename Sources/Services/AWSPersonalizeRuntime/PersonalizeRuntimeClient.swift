...
public class PersonalizeRuntimeClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await PersonalizeRuntimeClientConfiguration(region: region)
    ...
    public class PersonalizeRuntimeClientConfiguration: PersonalizeRuntimeClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("PersonalizeRuntimeClient")
        ...
        public var partitionID: String? {
            return "PersonalizeRuntimeClient - \(region ?? "")"
        }
    }
}
...
extension PersonalizeRuntimeClient: PersonalizeRuntimeClientProtocol {
    ...
    public func getPersonalizedRanking(input: GetPersonalizedRankingInput) async throws -> GetPersonalizedRankingOutputResponse
    {
        ...
        operation.finalizeStep.intercept(position: .after, middleware: ClientRuntime.RetryerMiddleware<GetPersonalizedRankingOutputResponse, GetPersonalizedRankingOutputError>(retryer: config.retryer))
