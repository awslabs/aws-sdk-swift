...
extension PersonalizeRuntimeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> PersonalizeRuntimeClient.PersonalizeRuntimeClientConfiguration {
        let clientConfiguration = try await PersonalizeRuntimeClient.PersonalizeRuntimeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> PersonalizeRuntimeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return PersonalizeRuntimeClient(config: configuration)
        }
    }
...
extension PersonalizeRuntimeClient.PersonalizeRuntimeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
