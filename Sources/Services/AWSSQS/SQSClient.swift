...
extension SQSClient {
    ...
    public func addPermission(input: AddPermissionInput) async throws -> AddPermissionOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .build()
        let builder = OrchestratorBuilder<AddPermissionInput, AddPermissionOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        builder.applyEndpoint(EndpointResolverMiddleware<AddPermissionOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<AddPermissionOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<AddPermissionInput, AddPermissionOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<AddPermissionInput, AddPermissionOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<AddPermissionOutput>())
        ...
        builder.deserialize(ClientRuntime.DeserializeMiddleware<AddPermissionOutput>(responseClosure(decoder: decoder), responseErrorClosure(AddPermissionOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<AddPermissionOutput>(clientLogMode: config.clientLogMode))
    ...
    public func cancelMessageMoveTask(input: CancelMessageMoveTaskInput) async throws -> CancelMessageMoveTaskOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CancelMessageMoveTaskInput, CancelMessageMoveTaskOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<CancelMessageMoveTaskOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CancelMessageMoveTaskOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<CancelMessageMoveTaskInput, CancelMessageMoveTaskOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<CancelMessageMoveTaskInput, CancelMessageMoveTaskOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<CancelMessageMoveTaskOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<CancelMessageMoveTaskOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CancelMessageMoveTaskOutput>(responseClosure(decoder: decoder), responseErrorClosure(CancelMessageMoveTaskOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<CancelMessageMoveTaskOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func changeMessageVisibility(input: ChangeMessageVisibilityInput) async throws -> ChangeMessageVisibilityOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ChangeMessageVisibilityInput, ChangeMessageVisibilityOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ChangeMessageVisibilityOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ChangeMessageVisibilityOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<ChangeMessageVisibilityInput, ChangeMessageVisibilityOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<ChangeMessageVisibilityInput, ChangeMessageVisibilityOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ChangeMessageVisibilityOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<ChangeMessageVisibilityOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ChangeMessageVisibilityOutput>(responseClosure(decoder: decoder), responseErrorClosure(ChangeMessageVisibilityOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ChangeMessageVisibilityOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func changeMessageVisibilityBatch(input: ChangeMessageVisibilityBatchInput) async throws -> ChangeMessageVisibilityBatchOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ChangeMessageVisibilityBatchInput, ChangeMessageVisibilityBatchOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ChangeMessageVisibilityBatchOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ChangeMessageVisibilityBatchOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<ChangeMessageVisibilityBatchInput, ChangeMessageVisibilityBatchOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<ChangeMessageVisibilityBatchInput, ChangeMessageVisibilityBatchOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ChangeMessageVisibilityBatchOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<ChangeMessageVisibilityBatchOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ChangeMessageVisibilityBatchOutput>(responseClosure(decoder: decoder), responseErrorClosure(ChangeMessageVisibilityBatchOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ChangeMessageVisibilityBatchOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func createQueue(input: CreateQueueInput) async throws -> CreateQueueOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<CreateQueueInput, CreateQueueOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateQueueOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<CreateQueueInput, CreateQueueOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<CreateQueueInput, CreateQueueOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<CreateQueueOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<CreateQueueOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateQueueOutput>(responseClosure(decoder: decoder), responseErrorClosure(CreateQueueOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<CreateQueueOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func deleteMessage(input: DeleteMessageInput) async throws -> DeleteMessageOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteMessageInput, DeleteMessageOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteMessageOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteMessageOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<DeleteMessageInput, DeleteMessageOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<DeleteMessageInput, DeleteMessageOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<DeleteMessageOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<DeleteMessageOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteMessageOutput>(responseClosure(decoder: decoder), responseErrorClosure(DeleteMessageOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<DeleteMessageOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func deleteMessageBatch(input: DeleteMessageBatchInput) async throws -> DeleteMessageBatchOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteMessageBatchInput, DeleteMessageBatchOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<DeleteMessageBatchOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteMessageBatchOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<DeleteMessageBatchInput, DeleteMessageBatchOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<DeleteMessageBatchInput, DeleteMessageBatchOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<DeleteMessageBatchOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<DeleteMessageBatchOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteMessageBatchOutput>(responseClosure(decoder: decoder), responseErrorClosure(DeleteMessageBatchOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<DeleteMessageBatchOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func deleteQueue(input: DeleteQueueInput) async throws -> DeleteQueueOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<DeleteQueueInput, DeleteQueueOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteQueueOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<DeleteQueueInput, DeleteQueueOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<DeleteQueueInput, DeleteQueueOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<DeleteQueueOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<DeleteQueueOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteQueueOutput>(responseClosure(decoder: decoder), responseErrorClosure(DeleteQueueOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<DeleteQueueOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func getQueueAttributes(input: GetQueueAttributesInput) async throws -> GetQueueAttributesOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetQueueAttributesInput, GetQueueAttributesOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetQueueAttributesOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetQueueAttributesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<GetQueueAttributesInput, GetQueueAttributesOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<GetQueueAttributesInput, GetQueueAttributesOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetQueueAttributesOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<GetQueueAttributesOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetQueueAttributesOutput>(responseClosure(decoder: decoder), responseErrorClosure(GetQueueAttributesOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetQueueAttributesOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func getQueueUrl(input: GetQueueUrlInput) async throws -> GetQueueUrlOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<GetQueueUrlInput, GetQueueUrlOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<GetQueueUrlOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetQueueUrlOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<GetQueueUrlInput, GetQueueUrlOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<GetQueueUrlInput, GetQueueUrlOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetQueueUrlOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<GetQueueUrlOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetQueueUrlOutput>(responseClosure(decoder: decoder), responseErrorClosure(GetQueueUrlOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetQueueUrlOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func listDeadLetterSourceQueues(input: ListDeadLetterSourceQueuesInput) async throws -> ListDeadLetterSourceQueuesOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListDeadLetterSourceQueuesInput, ListDeadLetterSourceQueuesOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListDeadLetterSourceQueuesOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListDeadLetterSourceQueuesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<ListDeadLetterSourceQueuesInput, ListDeadLetterSourceQueuesOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<ListDeadLetterSourceQueuesInput, ListDeadLetterSourceQueuesOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListDeadLetterSourceQueuesOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<ListDeadLetterSourceQueuesOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListDeadLetterSourceQueuesOutput>(responseClosure(decoder: decoder), responseErrorClosure(ListDeadLetterSourceQueuesOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListDeadLetterSourceQueuesOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func listMessageMoveTasks(input: ListMessageMoveTasksInput) async throws -> ListMessageMoveTasksOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListMessageMoveTasksInput, ListMessageMoveTasksOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListMessageMoveTasksOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListMessageMoveTasksOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<ListMessageMoveTasksInput, ListMessageMoveTasksOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<ListMessageMoveTasksInput, ListMessageMoveTasksOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListMessageMoveTasksOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<ListMessageMoveTasksOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListMessageMoveTasksOutput>(responseClosure(decoder: decoder), responseErrorClosure(ListMessageMoveTasksOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListMessageMoveTasksOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func listQueueTags(input: ListQueueTagsInput) async throws -> ListQueueTagsOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListQueueTagsInput, ListQueueTagsOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ListQueueTagsOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListQueueTagsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<ListQueueTagsInput, ListQueueTagsOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<ListQueueTagsInput, ListQueueTagsOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListQueueTagsOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<ListQueueTagsOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListQueueTagsOutput>(responseClosure(decoder: decoder), responseErrorClosure(ListQueueTagsOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListQueueTagsOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func listQueues(input: ListQueuesInput) async throws -> ListQueuesOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ListQueuesInput, ListQueuesOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListQueuesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<ListQueuesInput, ListQueuesOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<ListQueuesInput, ListQueuesOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListQueuesOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<ListQueuesOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListQueuesOutput>(responseClosure(decoder: decoder), responseErrorClosure(ListQueuesOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListQueuesOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func purgeQueue(input: PurgeQueueInput) async throws -> PurgeQueueOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<PurgeQueueInput, PurgeQueueOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<PurgeQueueOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PurgeQueueOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<PurgeQueueInput, PurgeQueueOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<PurgeQueueInput, PurgeQueueOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<PurgeQueueOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<PurgeQueueOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<PurgeQueueOutput>(responseClosure(decoder: decoder), responseErrorClosure(PurgeQueueOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<PurgeQueueOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func receiveMessage(input: ReceiveMessageInput) async throws -> ReceiveMessageOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<ReceiveMessageInput, ReceiveMessageOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<ReceiveMessageOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ReceiveMessageOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<ReceiveMessageInput, ReceiveMessageOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<ReceiveMessageInput, ReceiveMessageOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ReceiveMessageOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<ReceiveMessageOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ReceiveMessageOutput>(responseClosure(decoder: decoder), responseErrorClosure(ReceiveMessageOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ReceiveMessageOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func removePermission(input: RemovePermissionInput) async throws -> RemovePermissionOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<RemovePermissionInput, RemovePermissionOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<RemovePermissionOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RemovePermissionOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<RemovePermissionInput, RemovePermissionOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<RemovePermissionInput, RemovePermissionOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<RemovePermissionOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<RemovePermissionOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<RemovePermissionOutput>(responseClosure(decoder: decoder), responseErrorClosure(RemovePermissionOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<RemovePermissionOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func sendMessage(input: SendMessageInput) async throws -> SendMessageOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<SendMessageInput, SendMessageOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<SendMessageOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SendMessageOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<SendMessageInput, SendMessageOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<SendMessageInput, SendMessageOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<SendMessageOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<SendMessageOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<SendMessageOutput>(responseClosure(decoder: decoder), responseErrorClosure(SendMessageOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<SendMessageOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func sendMessageBatch(input: SendMessageBatchInput) async throws -> SendMessageBatchOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<SendMessageBatchInput, SendMessageBatchOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<SendMessageBatchOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SendMessageBatchOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<SendMessageBatchInput, SendMessageBatchOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<SendMessageBatchInput, SendMessageBatchOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<SendMessageBatchOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<SendMessageBatchOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<SendMessageBatchOutput>(responseClosure(decoder: decoder), responseErrorClosure(SendMessageBatchOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<SendMessageBatchOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func setQueueAttributes(input: SetQueueAttributesInput) async throws -> SetQueueAttributesOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<SetQueueAttributesInput, SetQueueAttributesOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<SetQueueAttributesOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SetQueueAttributesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<SetQueueAttributesInput, SetQueueAttributesOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<SetQueueAttributesInput, SetQueueAttributesOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<SetQueueAttributesOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<SetQueueAttributesOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<SetQueueAttributesOutput>(responseClosure(decoder: decoder), responseErrorClosure(SetQueueAttributesOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<SetQueueAttributesOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func startMessageMoveTask(input: StartMessageMoveTaskInput) async throws -> StartMessageMoveTaskOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<StartMessageMoveTaskInput, StartMessageMoveTaskOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<StartMessageMoveTaskOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<StartMessageMoveTaskOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<StartMessageMoveTaskInput, StartMessageMoveTaskOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<StartMessageMoveTaskInput, StartMessageMoveTaskOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<StartMessageMoveTaskOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<StartMessageMoveTaskOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<StartMessageMoveTaskOutput>(responseClosure(decoder: decoder), responseErrorClosure(StartMessageMoveTaskOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<StartMessageMoveTaskOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func tagQueue(input: TagQueueInput) async throws -> TagQueueOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<TagQueueInput, TagQueueOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<TagQueueOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TagQueueOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<TagQueueInput, TagQueueOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<TagQueueInput, TagQueueOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<TagQueueOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<TagQueueOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<TagQueueOutput>(responseClosure(decoder: decoder), responseErrorClosure(TagQueueOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<TagQueueOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
    ...
    public func untagQueue(input: UntagQueueInput) async throws -> UntagQueueOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = OrchestratorBuilder<UntagQueueInput, UntagQueueOutput, SdkHttpRequest, HttpResponse, HttpContext>()
        ...
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        builder.applyEndpoint(EndpointResolverMiddleware<UntagQueueOutput>(endpointResolver: config.endpointResolver, endpointParams: endpointParams))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UntagQueueOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<UntagQueueInput, UntagQueueOutput, ClientRuntime.JSONWriter>(documentWritingClosure: ClientRuntime.JSONReadWrite.documentWritingClosure(encoder: encoder), inputWritingClosure: JSONReadWrite.writingClosure()))
        builder.interceptors.add(ContentTypeMiddleware<UntagQueueInput, UntagQueueOutput>(contentType: "application/x-amz-json-1.0"))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<UntagQueueOutput>())
        builder.retryStrategy(ClientRuntime.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfo(for:))
        builder.applySigner(ClientRuntime.SignerMiddleware<UntagQueueOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<UntagQueueOutput>(responseClosure(decoder: decoder), responseErrorClosure(UntagQueueOutputError.self, decoder: decoder)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<UntagQueueOutput>(clientLogMode: config.clientLogMode))
        let op = builder.attributes(context)
            .executeRequest(client)
            .build()
        return try await op.execute(input: input)
