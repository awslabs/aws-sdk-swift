...
extension SQSClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SQSClient.SQSClientConfiguration {
        let clientConfiguration = try await SQSClient.SQSClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SQSClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SQSClient(config: configuration)
        }
    }
...
extension SQSClient.SQSClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
