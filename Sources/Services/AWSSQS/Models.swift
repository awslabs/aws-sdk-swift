...
extension SQSClientTypes {
    ...
    public enum QueueAttributeName: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case all
...
extension SQSClientTypes {
    ...
    public enum MessageSystemAttributeNameForSends: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case awstraceheader
        case sdkUnknown(Swift.String)
...
extension AddPermissionInput {
    ...
    static func write(value: AddPermissionInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["AWSAccountIds"].writeList(value.awsAccountIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: true)
        try writer["Actions"].writeList(value.actions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: true)
...
extension CreateQueueInput {
    ...
    static func write(value: CreateQueueInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Attributes"].writeMap(value.attributes, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: true)
        try writer["QueueName"].write(value.queueName)
        try writer["tags"].writeMap(value.tags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: true)
    }
}
...
extension UntagQueueInput {
    ...
    static func write(value: UntagQueueInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["QueueUrl"].write(value.queueUrl)
        try writer["TagKeys"].writeList(value.tagKeys, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: true)
    }
}
...
extension GetQueueAttributesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetQueueAttributesOutput {
        ...
        value.attributes = try reader["Attributes"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: true)
        return value
    }
}
...
extension ListDeadLetterSourceQueuesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListDeadLetterSourceQueuesOutput {
        ...
        value.queueUrls = try reader["queueUrls"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: true)
        return value
    }
}
...
extension ListQueueTagsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListQueueTagsOutput {
        ...
        value.tags = try reader["Tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: true)
        return value
    }
}
...
extension SQSClientTypes.MessageAttributeValue {
    ...
    static func write(value: SQSClientTypes.MessageAttributeValue?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["BinaryListValues"].writeList(value.binaryListValues, memberWritingClosure: Foundation.Data.write(value:to:), memberNodeInfo: "member", isFlattened: true)
        try writer["BinaryValue"].write(value.binaryValue)
        try writer["DataType"].write(value.dataType)
        try writer["StringListValues"].writeList(value.stringListValues, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: true)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SQSClientTypes.MessageAttributeValue {
        ...
        value.stringListValues = try reader["StringListValues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: true)
        value.binaryListValues = try reader["BinaryListValues"].readListIfPresent(memberReadingClosure: Foundation.Data.read(from:), memberNodeInfo: "member", isFlattened: true)
