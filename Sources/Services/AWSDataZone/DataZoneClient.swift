...
extension DataZoneClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> DataZoneClient.DataZoneClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> DataZoneClient {
            let configuration = try await resolve(plugins: self.plugins)
            return DataZoneClient(config: configuration)
        }
    }
...
extension DataZoneClient.DataZoneClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
