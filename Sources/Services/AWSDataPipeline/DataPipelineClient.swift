...
extension DataPipelineClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> DataPipelineClient.DataPipelineClientConfiguration {
        let clientConfiguration = try await DataPipelineClient.DataPipelineClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> DataPipelineClient {
            let configuration = try await resolve(plugins: self.plugins)
            return DataPipelineClient(config: configuration)
        }
    }
...
extension DataPipelineClient.DataPipelineClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
