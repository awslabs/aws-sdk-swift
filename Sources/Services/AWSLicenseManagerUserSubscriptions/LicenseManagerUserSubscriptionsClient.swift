...
extension LicenseManagerUserSubscriptionsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> LicenseManagerUserSubscriptionsClient.LicenseManagerUserSubscriptionsClientConfiguration {
        let clientConfiguration = try await LicenseManagerUserSubscriptionsClient.LicenseManagerUserSubscriptionsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> LicenseManagerUserSubscriptionsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return LicenseManagerUserSubscriptionsClient(config: configuration)
        }
    }
...
extension LicenseManagerUserSubscriptionsClient.LicenseManagerUserSubscriptionsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
