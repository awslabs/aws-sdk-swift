...
extension PinpointEmailClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> PinpointEmailClient.PinpointEmailClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> PinpointEmailClient {
            let configuration = try await resolve(plugins: self.plugins)
            return PinpointEmailClient(config: configuration)
        }
    }
...
extension PinpointEmailClient.PinpointEmailClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
