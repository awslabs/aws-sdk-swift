...
extension ComprehendClientTypes.DocumentClassifierProperties {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ComprehendClientTypes.DocumentClassifierProperties {
        ...
        value.submitTime = try reader["SubmitTime"].readTimestampIfPresent(format: .epochSeconds)
        value.endTime = try reader["EndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.trainingStartTime = try reader["TrainingStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.trainingEndTime = try reader["TrainingEndTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension ComprehendClientTypes.DocumentClassifierSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ComprehendClientTypes.DocumentClassifierSummary {
        ...
        value.latestVersionCreatedAt = try reader["LatestVersionCreatedAt"].readTimestampIfPresent(format: .epochSeconds)
