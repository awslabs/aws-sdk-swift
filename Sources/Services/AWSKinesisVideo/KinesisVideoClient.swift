...
extension KinesisVideoClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> KinesisVideoClient.KinesisVideoClientConfiguration {
        let clientConfiguration = try await KinesisVideoClient.KinesisVideoClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> KinesisVideoClient {
            let configuration = try await resolve(plugins: self.plugins)
            return KinesisVideoClient(config: configuration)
        }
    }
...
extension KinesisVideoClient.KinesisVideoClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
