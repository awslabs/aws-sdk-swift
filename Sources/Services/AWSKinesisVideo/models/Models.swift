...
extension KinesisVideoClientTypes.ChannelInfo {
    ...
    static func write(value: KinesisVideoClientTypes.ChannelInfo?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ChannelARN"].write(value.channelARN)
        try writer["ChannelName"].write(value.channelName)
        try writer["ChannelStatus"].write(value.channelStatus)
...
extension KinesisVideoClientTypes.ChannelNameCondition {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KinesisVideoClientTypes.ChannelNameCondition {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = KinesisVideoClientTypes.ChannelNameCondition()
        value.comparisonOperator = try reader["ComparisonOperator"].readIfPresent()
        value.comparisonValue = try reader["ComparisonValue"].readIfPresent()
        return value
    }
}
...
extension CreateSignalingChannelOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateSignalingChannelOutput {
...
extension DeleteEdgeConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteEdgeConfigurationOutput {
...
extension DeleteSignalingChannelOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteSignalingChannelOutput {
...
extension DescribeEdgeConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeEdgeConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeImageGenerationConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeImageGenerationConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeMappedResourceConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeMappedResourceConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeMediaStorageConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeMediaStorageConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeNotificationConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeNotificationConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeSignalingChannelOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeSignalingChannelOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension KinesisVideoClientTypes.EdgeAgentStatus {
    ...
    static func write(value: KinesisVideoClientTypes.EdgeAgentStatus?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["LastRecorderStatus"].write(value.lastRecorderStatus, with: KinesisVideoClientTypes.LastRecorderStatus.write(value:to:))
        try writer["LastUploaderStatus"].write(value.lastUploaderStatus, with: KinesisVideoClientTypes.LastUploaderStatus.write(value:to:))
    }
...
extension GetDataEndpointOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetDataEndpointOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetSignalingChannelEndpointOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetSignalingChannelEndpointOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension KinesisVideoClientTypes.ImageGenerationConfiguration {
    ...
    static func write(value: KinesisVideoClientTypes.ImageGenerationConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["FormatConfig"].writeMap(value.formatConfig, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KinesisVideoClientTypes.ImageGenerationConfiguration {
        ...
        value.formatConfig = try reader["FormatConfig"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension KinesisVideoClientTypes.LastRecorderStatus {
    ...
    static func write(value: KinesisVideoClientTypes.LastRecorderStatus?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["JobStatusDetails"].write(value.jobStatusDetails)
        try writer["LastCollectedTime"].writeTimestamp(value.lastCollectedTime, format: .epochSeconds)
        try writer["LastUpdatedTime"].writeTimestamp(value.lastUpdatedTime, format: .epochSeconds)
        try writer["RecorderStatus"].write(value.recorderStatus)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KinesisVideoClientTypes.LastRecorderStatus {
        ...
        value.lastCollectedTime = try reader["LastCollectedTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lastUpdatedTime = try reader["LastUpdatedTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension KinesisVideoClientTypes.LastUploaderStatus {
    ...
    static func write(value: KinesisVideoClientTypes.LastUploaderStatus?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["JobStatusDetails"].write(value.jobStatusDetails)
        try writer["LastCollectedTime"].writeTimestamp(value.lastCollectedTime, format: .epochSeconds)
        try writer["LastUpdatedTime"].writeTimestamp(value.lastUpdatedTime, format: .epochSeconds)
        try writer["UploaderStatus"].write(value.uploaderStatus)
    }
...
extension KinesisVideoClientTypes.ListEdgeAgentConfigurationsEdgeConfig {
    ...
    static func write(value: KinesisVideoClientTypes.ListEdgeAgentConfigurationsEdgeConfig?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CreationTime"].writeTimestamp(value.creationTime, format: .epochSeconds)
        try writer["EdgeConfig"].write(value.edgeConfig, with: KinesisVideoClientTypes.EdgeConfig.write(value:to:))
        try writer["FailedStatusDetails"].write(value.failedStatusDetails)
        try writer["LastUpdatedTime"].writeTimestamp(value.lastUpdatedTime, format: .epochSeconds)
        try writer["StreamARN"].write(value.streamARN)
        try writer["StreamName"].write(value.streamName)
...
extension ListEdgeAgentConfigurationsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListEdgeAgentConfigurationsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListSignalingChannelsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListSignalingChannelsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension KinesisVideoClientTypes.MappedResourceConfigurationListItem {
    ...
    static func write(value: KinesisVideoClientTypes.MappedResourceConfigurationListItem?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension KinesisVideoClientTypes.ResourceEndpointListItem {
    ...
    static func write(value: KinesisVideoClientTypes.ResourceEndpointListItem?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Protocol"].write(value.`protocol`)
        try writer["ResourceEndpoint"].write(value.resourceEndpoint)
    }
...
extension KinesisVideoClientTypes.SingleMasterChannelEndpointConfiguration {
    ...
    static func write(value: KinesisVideoClientTypes.SingleMasterChannelEndpointConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Protocols"].writeList(value.protocols, memberWritingClosure: KinesisVideoClientTypes.ChannelProtocol.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Role"].write(value.role)
    }

    static func read(from reader: SmithyJSON.Reader) throws -> KinesisVideoClientTypes.SingleMasterChannelEndpointConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = KinesisVideoClientTypes.SingleMasterChannelEndpointConfiguration()
        value.protocols = try reader["Protocols"].readListIfPresent(memberReadingClosure: KinesisVideoClientTypes.ChannelProtocol.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension StartEdgeConfigurationUpdateOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> StartEdgeConfigurationUpdateOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension KinesisVideoClientTypes.StreamInfo {
    ...
    static func write(value: KinesisVideoClientTypes.StreamInfo?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CreationTime"].writeTimestamp(value.creationTime, format: .epochSeconds)
        try writer["DataRetentionInHours"].write(value.dataRetentionInHours)
        try writer["DeviceName"].write(value.deviceName)
...
extension KinesisVideoClientTypes.StreamNameCondition {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KinesisVideoClientTypes.StreamNameCondition {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = KinesisVideoClientTypes.StreamNameCondition()
        value.comparisonOperator = try reader["ComparisonOperator"].readIfPresent()
        value.comparisonValue = try reader["ComparisonValue"].readIfPresent()
        return value
    }
...
extension KinesisVideoClientTypes.Tag {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KinesisVideoClientTypes.Tag {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = KinesisVideoClientTypes.Tag()
...
extension TagStreamOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> TagStreamOutput {
...
extension UntagStreamOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UntagStreamOutput {
...
extension UpdateDataRetentionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateDataRetentionOutput {
...
extension UpdateImageGenerationConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateImageGenerationConfigurationOutput {
...
extension UpdateMediaStorageConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateMediaStorageConfigurationOutput {
...
extension UpdateNotificationConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateNotificationConfigurationOutput {
...
extension UpdateSignalingChannelOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateSignalingChannelOutput {
...
extension UpdateStreamOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateStreamOutput {
