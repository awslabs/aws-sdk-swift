...
extension MachineLearningClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MachineLearningClient.MachineLearningClientConfiguration {
        let clientConfiguration = try await MachineLearningClient.MachineLearningClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MachineLearningClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MachineLearningClient(config: configuration)
        }
    }
...
extension MachineLearningClient.MachineLearningClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
