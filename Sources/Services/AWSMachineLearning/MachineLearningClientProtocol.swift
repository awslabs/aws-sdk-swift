...
public protocol MachineLearningClientProtocol {
    ...
    /// - `InternalServerException` : An error on the server occurred when trying to process a request.
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    func createBatchPrediction(input: CreateBatchPredictionInput) async throws -> CreateBatchPredictionOutputResponse
    ...
    /// - `InternalServerException` : An error on the server occurred when trying to process a request.
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    func createDataSourceFromRDS(input: CreateDataSourceFromRDSInput) async throws -> CreateDataSourceFromRDSOutputResponse
    ...
    /// - `InternalServerException` : An error on the server occurred when trying to process a request.
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    func createDataSourceFromRedshift(input: CreateDataSourceFromRedshiftInput) async throws -> CreateDataSourceFromRedshiftOutputResponse
    ...
    /// - `InternalServerException` : An error on the server occurred when trying to process a request.
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    func createDataSourceFromS3(input: CreateDataSourceFromS3Input) async throws -> CreateDataSourceFromS3OutputResponse
    ...
    /// - `InternalServerException` : An error on the server occurred when trying to process a request.
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    func createEvaluation(input: CreateEvaluationInput) async throws -> CreateEvaluationOutputResponse
    ...
    /// - `InternalServerException` : An error on the server occurred when trying to process a request.
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    func createMLModel(input: CreateMLModelInput) async throws -> CreateMLModelOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func createRealtimeEndpoint(input: CreateRealtimeEndpointInput) async throws -> CreateRealtimeEndpointOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func deleteBatchPrediction(input: DeleteBatchPredictionInput) async throws -> DeleteBatchPredictionOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func deleteEvaluation(input: DeleteEvaluationInput) async throws -> DeleteEvaluationOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func deleteMLModel(input: DeleteMLModelInput) async throws -> DeleteMLModelOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func deleteRealtimeEndpoint(input: DeleteRealtimeEndpointInput) async throws -> DeleteRealtimeEndpointOutputResponse
    ...
    /// - `InternalServerException` : An error on the server occurred when trying to process a request.
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    func describeBatchPredictions(input: DescribeBatchPredictionsInput) async throws -> DescribeBatchPredictionsOutputResponse
    ...
    /// - `InternalServerException` : An error on the server occurred when trying to process a request.
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    func describeDataSources(input: DescribeDataSourcesInput) async throws -> DescribeDataSourcesOutputResponse
    ...
    /// - `InternalServerException` : An error on the server occurred when trying to process a request.
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    func describeEvaluations(input: DescribeEvaluationsInput) async throws -> DescribeEvaluationsOutputResponse
    ...
    /// - `InternalServerException` : An error on the server occurred when trying to process a request.
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    func describeMLModels(input: DescribeMLModelsInput) async throws -> DescribeMLModelsOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func getBatchPrediction(input: GetBatchPredictionInput) async throws -> GetBatchPredictionOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func getEvaluation(input: GetEvaluationInput) async throws -> GetEvaluationOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func getMLModel(input: GetMLModelInput) async throws -> GetMLModelOutputResponse
    ...
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func predict(input: PredictInput) async throws -> PredictOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func updateBatchPrediction(input: UpdateBatchPredictionInput) async throws -> UpdateBatchPredictionOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func updateEvaluation(input: UpdateEvaluationInput) async throws -> UpdateEvaluationOutputResponse
    ...
    /// - `InvalidInputException` : An error on the client occurred. Typically, the cause is an invalid input value.
    /// - `ResourceNotFoundException` : A specified resource cannot be located.
    func updateMLModel(input: UpdateMLModelInput) async throws -> UpdateMLModelOutputResponse
}
