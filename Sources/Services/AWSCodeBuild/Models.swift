...
extension BatchGetReportGroupsInput {
    ...
    static func write(value: BatchGetReportGroupsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["reportGroupArns"].writeList(value.reportGroupArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension BatchDeleteBuildsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchDeleteBuildsOutput {
        ...
        value.buildsDeleted = try reader["buildsDeleted"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension BatchGetBuildBatchesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchGetBuildBatchesOutput {
        ...
        value.buildBatchesNotFound = try reader["buildBatchesNotFound"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BatchGetBuildsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchGetBuildsOutput {
        ...
        value.buildsNotFound = try reader["buildsNotFound"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BatchGetFleetsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchGetFleetsOutput {
        ...
        value.fleetsNotFound = try reader["fleetsNotFound"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BatchGetProjectsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchGetProjectsOutput {
        ...
        value.projectsNotFound = try reader["projectsNotFound"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BatchGetReportGroupsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchGetReportGroupsOutput {
        ...
        value.reportGroupsNotFound = try reader["reportGroupsNotFound"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BatchGetReportsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchGetReportsOutput {
        ...
        value.reportsNotFound = try reader["reportsNotFound"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListProjectsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListProjectsOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.projects = try reader["projects"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListReportGroupsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListReportGroupsOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.reportGroups = try reader["reportGroups"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListReportsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListReportsOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.reports = try reader["reports"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodeBuildClientTypes.BuildGroup {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeBuildClientTypes.BuildGroup {
        ...
        value.dependsOn = try reader["dependsOn"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CodeBuildClientTypes.BatchRestrictions {
    ...
    static func write(value: CodeBuildClientTypes.BatchRestrictions?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["computeTypesAllowed"].writeList(value.computeTypesAllowed, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeBuildClientTypes.BatchRestrictions {
        ...
        value.computeTypesAllowed = try reader["computeTypesAllowed"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodeBuildClientTypes.ProjectCache {
    ...
    static func write(value: CodeBuildClientTypes.ProjectCache?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["location"].write(value.location)
        try writer["modes"].writeList(value.modes, memberWritingClosure: CodeBuildClientTypes.CacheMode.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["type"].write(value.type)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeBuildClientTypes.ProjectCache {
        ...
        value.type = try reader["type"].readIfPresent()
        value.location = try reader["location"].readIfPresent()
        value.modes = try reader["modes"].readListIfPresent(memberReadingClosure: CodeBuildClientTypes.CacheMode.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodeBuildClientTypes.Build {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeBuildClientTypes.Build {
        ...
        value.reportArns = try reader["reportArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.fileSystemLocations = try reader["fileSystemLocations"].readListIfPresent(memberReadingClosure: CodeBuildClientTypes.ProjectFileSystemLocation.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CodeBuildClientTypes.TestReportSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeBuildClientTypes.TestReportSummary {
        ...
        value.statusCounts = try reader["statusCounts"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
