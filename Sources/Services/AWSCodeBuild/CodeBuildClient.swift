...
extension CodeBuildClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CodeBuildClient.CodeBuildClientConfiguration {
        let clientConfiguration = try await CodeBuildClient.CodeBuildClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CodeBuildClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CodeBuildClient(config: configuration)
        }
    }
...
extension CodeBuildClient.CodeBuildClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
