...
extension ConnectContactLensClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ConnectContactLensClient.ConnectContactLensClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> ConnectContactLensClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ConnectContactLensClient(config: configuration)
        }
    }
...
extension ConnectContactLensClient.ConnectContactLensClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
