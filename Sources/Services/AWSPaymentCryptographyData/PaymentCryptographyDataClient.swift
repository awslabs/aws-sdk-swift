...
extension PaymentCryptographyDataClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> PaymentCryptographyDataClient.PaymentCryptographyDataClientConfiguration {
        let clientConfiguration = try await PaymentCryptographyDataClient.PaymentCryptographyDataClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> PaymentCryptographyDataClient {
            let configuration = try await resolve(plugins: self.plugins)
            return PaymentCryptographyDataClient(config: configuration)
        }
    }
...
extension PaymentCryptographyDataClient.PaymentCryptographyDataClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
