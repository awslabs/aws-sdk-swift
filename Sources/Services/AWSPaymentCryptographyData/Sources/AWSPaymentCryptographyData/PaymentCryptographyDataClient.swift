...
public final class PaymentCryptographyDataClient: AWSClientRuntime.AWSServiceClient {
    ...
    public convenience init(config: PaymentCryptographyDataClient.PaymentCryptographyDataClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try PaymentCryptographyDataClient.PaymentCryptographyDataClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await PaymentCryptographyDataClient.PaymentCryptographyDataClientConfig()
        self.init(config: config)
    }
}
...
extension PaymentCryptographyDataClient {
    ...
    /// Client configuration for PaymentCryptographyDataClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct PaymentCryptographyDataClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
    ...
    @available(*, deprecated, message: "Use PaymentCryptographyDataClientConfig instead. This class will be removed in a future version.")
    public final class PaymentCryptographyDataClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> PaymentCryptographyDataClientConfig {
            return try PaymentCryptographyDataClientConfig(
...
extension PaymentCryptographyDataClient {
    ...
    /// Performs the `GenerateAuthRequestCryptogram` operation on the `PaymentCryptographyData` service.
    ///
    /// Generates an Authorization Request Cryptogram (ARQC) for an EMV chip payment card authorization. For more information, see [Generate auth request cryptogram](https://docs.aws.amazon.com/payment-cryptography/latest/userguide/data-operations.generateauthrequestcryptogram.html) in the Amazon Web Services Payment Cryptography User Guide. ARQC generation uses an Issuer Master Key (IMK) for application cryptograms (TR31_E0_EMV_MKEY_APP_CRYPTOGRAMS) to derive a session key, which is then used to generate the cryptogram from the provided transaction data (when applicable). To use this operation, you must first create or import an IMK-AC key by calling [CreateKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_CreateKey.html) or [ImportKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_ImportKey.html). The KeyModesOfUse should be set to DeriveKey for the IMK-AC encryption key. This operation is intended for development and testing scenarios only. It is not recommended to use this operation as a substitute for card-based cryptogram generation in production payment flows. For information about valid keys for this operation, see [Understanding key attributes](https://docs.aws.amazon.com/payment-cryptography/latest/userguide/keys-validattributes.html) and [Key types for specific data operations](https://docs.aws.amazon.com/payment-cryptography/latest/userguide/crypto-ops-validkeys-ops.html) in the Amazon Web Services Payment Cryptography User Guide. Cross-account use: This operation supports cross-account use when the key has a resource-based policy that grants access. For more information, see [Resource-based policies](https://docs.aws.amazon.com/payment-cryptography/latest/userguide/security_iam_resource-based-policies.html). Related operations:
    ///
    /// * [VerifyAuthRequestCryptogram]
    ///
    /// - Parameter input: [no documentation found] (Type: `GenerateAuthRequestCryptogramInput`)
    ///
    /// - Returns: [no documentation found] (Type: `GenerateAuthRequestCryptogramOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request was denied due to an invalid request error.
    public func generateAuthRequestCryptogram(input: GenerateAuthRequestCryptogramInput) async throws -> GenerateAuthRequestCryptogramOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "generateAuthRequestCryptogram")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GenerateAuthRequestCryptogramInput, GenerateAuthRequestCryptogramOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GenerateAuthRequestCryptogramInput, GenerateAuthRequestCryptogramOutput>(GenerateAuthRequestCryptogramInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GenerateAuthRequestCryptogramInput, GenerateAuthRequestCryptogramOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GenerateAuthRequestCryptogramInput, GenerateAuthRequestCryptogramOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<GenerateAuthRequestCryptogramInput, GenerateAuthRequestCryptogramOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: GenerateAuthRequestCryptogramInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GenerateAuthRequestCryptogramInput, GenerateAuthRequestCryptogramOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GenerateAuthRequestCryptogramOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "PaymentCryptographyData")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GenerateAuthRequestCryptogram")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
