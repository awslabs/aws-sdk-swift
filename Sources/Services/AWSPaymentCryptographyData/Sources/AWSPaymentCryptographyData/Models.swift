...
public struct VerificationFailedException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
extension VerificationFailedException {
    ...
    static func makeError(baseError: ClientRuntime.RestJSONError) throws -> VerificationFailedException {
        let reader = baseError.errorBodyReader
