...
extension CompleteAttachmentUploadInput {
    ...
    static func write(value: CompleteAttachmentUploadInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["AttachmentIds"].writeList(value.attachmentIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateParticipantConnectionInput {
    ...
    static func write(value: CreateParticipantConnectionInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Type"].writeList(value.type, memberWritingClosure: ConnectParticipantClientTypes.ConnectionType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
