...
extension ConnectParticipantClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ConnectParticipantClient.ConnectParticipantClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> ConnectParticipantClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ConnectParticipantClient(config: configuration)
        }
    }
...
extension ConnectParticipantClient.ConnectParticipantClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
