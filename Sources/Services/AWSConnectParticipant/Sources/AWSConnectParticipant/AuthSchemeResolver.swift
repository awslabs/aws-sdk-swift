...
public struct ConnectParticipantAuthSchemeResolverParameters: SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
...
public protocol ConnectParticipantAuthSchemeResolver: SmithyHTTPAuthAPI.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service ConnectParticipant must conform to.
}

public struct DefaultConnectParticipantAuthSchemeResolver: ConnectParticipantAuthSchemeResolver {
    ...
    public func resolveAuthScheme(params: SmithyHTTPAuthAPI.AuthSchemeResolverParameters) throws -> [SmithyHTTPAuthAPI.AuthOption] {
        ...
        guard let serviceParams = params as? ConnectParticipantAuthSchemeResolverParameters else {
    ...
    public func constructParameters(context: Smithy.Context) throws -> SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
        ...
        return ConnectParticipantAuthSchemeResolverParameters(authSchemePreference: authSchemePreference, operation: opName, region: opRegion)
    }
}
