...
extension ElementalInferenceClientTypes {
    ...
    public struct ClippingConfig: Swift.Sendable {
        ...
        public var dataSourceConfiguration: ElementalInferenceClientTypes.DataSourceConfiguration?

        public init(
            callbackMetadata: Swift.String? = nil,
            dataSourceConfiguration: ElementalInferenceClientTypes.DataSourceConfiguration? = nil
        ) {
...
extension ElementalInferenceClientTypes {
    ...
    public struct Competitor: Swift.Sendable {
...
extension ElementalInferenceClientTypes {
    ...
    public enum DataSourceSport: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case americanFootball
        case basketball
        case sdkUnknown(Swift.String)

        public static var allCases: [DataSourceSport] {
            return [
                .americanFootball,
                .basketball
            ]
...
public struct GatewayTimedOutException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
    ...
    public internal(set) var properties = Properties()
    public static var typeName: Swift.String { "GatewayTimedOutException" }
    public static var fault: ClientRuntime.ErrorFault { .server }
    public static var isRetryable: Swift.Bool { true }
    public static var isThrottling: Swift.Bool { false }
    public var httpResponse = SmithyHTTPAPI.HTTPResponse()
...
extension ElementalInferenceClientTypes {
    ...
    public struct SearchFilter: Swift.Sendable {
        ...
        /// This member is required.
        public var name: ElementalInferenceClientTypes.FilterName?
        ...
        public init(
            name: ElementalInferenceClientTypes.FilterName? = nil,
...
public struct SearchFixturesInput: Swift.Sendable {
    ...
    public var filters: [ElementalInferenceClientTypes.SearchFilter]?
    ...
    /// This member is required.
    public var sport: ElementalInferenceClientTypes.DataSourceSport?
    ...
    public init(
        ...
        filters: [ElementalInferenceClientTypes.SearchFilter]? = nil,
        maxResults: Swift.Int? = nil,
        nextToken: Swift.String? = nil,
        sport: ElementalInferenceClientTypes.DataSourceSport? = nil,
...
extension ElementalInferenceClientTypes {
    ...
    /// Contains information about one fixture. It is used in the SearchFixtures response. Elemental Inference relays the information in this structure from the data source, so that you can identify the fixture that matches your source media.
    public struct FixtureSummary: Swift.Sendable {
...
public struct SearchFixturesOutput: Swift.Sendable {
    ...
    public init(
        fixtures: [ElementalInferenceClientTypes.FixtureSummary]? = nil,
        nextToken: Swift.String? = nil
    ) {
...
extension SearchFixturesInput {

    static func urlPathProvider(_ value: SearchFixturesInput) -> Swift.String? {
        return "/v1/fixtures"
    }
}
...
extension SearchFixturesInput {
    ...
    static func write(value: SearchFixturesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["endDate"].write(value.endDate)
        try writer["filters"].writeList(value.filters, memberWritingClosure: ElementalInferenceClientTypes.SearchFilter.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["maxResults"].write(value.maxResults)
        try writer["nextToken"].write(value.nextToken)
        try writer["sport"].write(value.sport)
...
extension SearchFixturesOutput {

    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> SearchFixturesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = SearchFixturesOutput()
        value.fixtures = try reader["fixtures"].readListIfPresent(memberReadingClosure: ElementalInferenceClientTypes.FixtureSummary.read(from:), memberNodeInfo: "member", isFlattened: false) ?? []
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
enum SearchFixturesOutputError {
...
extension GatewayTimedOutException {

    static func makeError(baseError: ClientRuntime.RestJSONError) throws -> GatewayTimedOutException {
        let reader = baseError.errorBodyReader
        var value = GatewayTimedOutException()
        value.properties.message = try reader["message"].readIfPresent() ?? ""
        value.httpResponse = baseError.httpResponse
        value.requestID = baseError.requestID
        value.message = baseError.message
...
extension ElementalInferenceClientTypes.ClippingConfig {
    ...
    static func write(value: ElementalInferenceClientTypes.ClippingConfig?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["dataSourceConfiguration"].write(value.dataSourceConfiguration, with: ElementalInferenceClientTypes.DataSourceConfiguration.write(value:to:))
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ElementalInferenceClientTypes.ClippingConfig {
        ...
        value.dataSourceConfiguration = try reader["dataSourceConfiguration"].readIfPresent(with: ElementalInferenceClientTypes.DataSourceConfiguration.read(from:))
        return value
    }
}

extension ElementalInferenceClientTypes.Competitor {

    static func read(from reader: SmithyJSON.Reader) throws -> ElementalInferenceClientTypes.Competitor {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = ElementalInferenceClientTypes.Competitor()
        value.name = try reader["name"].readIfPresent()
        value.isHome = try reader["isHome"].readIfPresent()
        return value
    }
}
...
extension ElementalInferenceClientTypes.DataSourceConfiguration {

    static func write(value: ElementalInferenceClientTypes.DataSourceConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["fixtureId"].write(value.fixtureId)
    }

    static func read(from reader: SmithyJSON.Reader) throws -> ElementalInferenceClientTypes.DataSourceConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = ElementalInferenceClientTypes.DataSourceConfiguration()
...
extension ElementalInferenceClientTypes.FixtureSummary {

    static func read(from reader: SmithyJSON.Reader) throws -> ElementalInferenceClientTypes.FixtureSummary {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = ElementalInferenceClientTypes.FixtureSummary()
        value.fixtureId = try reader["fixtureId"].readIfPresent() ?? ""
        value.name = try reader["name"].readIfPresent() ?? ""
...
extension ElementalInferenceClientTypes.SearchFilter {

    static func write(value: ElementalInferenceClientTypes.SearchFilter?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["name"].write(value.name)
