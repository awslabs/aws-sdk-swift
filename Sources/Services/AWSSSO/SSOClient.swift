...
extension SSOClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SSOClient.SSOClientConfiguration {
        let clientConfiguration = try await SSOClient.SSOClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SSOClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SSOClient(config: configuration)
        }
    }
...
extension SSOClient.SSOClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
