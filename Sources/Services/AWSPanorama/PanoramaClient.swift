...
extension PanoramaClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> PanoramaClient.PanoramaClientConfiguration {
        let clientConfiguration = try await PanoramaClient.PanoramaClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> PanoramaClient {
            let configuration = try await resolve(plugins: self.plugins)
            return PanoramaClient(config: configuration)
        }
    }
...
extension PanoramaClient.PanoramaClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
