...
public final class MPAClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: MPAClient.MPAClientConfig) instead")
    public convenience init(config: MPAClient.MPAClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try MPAClient.MPAClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await MPAClient.MPAClientConfig()
        self.init(config: config)
    }
}
...
extension MPAClient {
    ...
    /// Client configuration for MPAClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct MPAClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "MPA")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultMPAAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: MPAClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use MPAClientConfig instead. This class will be removed in a future version.")
    public final class MPAClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> MPAClientConfig {
            return try MPAClientConfig(
...
extension MPAClient {
    ...
    public func cancelSession(input: CancelSessionInput) async throws -> CancelSessionOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "MPA"))
