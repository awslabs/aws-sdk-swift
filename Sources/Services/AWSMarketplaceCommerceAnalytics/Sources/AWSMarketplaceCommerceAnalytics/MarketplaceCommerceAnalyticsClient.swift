...
public final class MarketplaceCommerceAnalyticsClient: AWSClientRuntime.AWSServiceClient {
    ...
    public let config: MarketplaceCommerceAnalyticsClient.MarketplaceCommerceAnalyticsClientConfig
    ...
    public typealias Configuration = MarketplaceCommerceAnalyticsClient.MarketplaceCommerceAnalyticsClientConfig
...
extension MarketplaceCommerceAnalyticsClient {
    ...
    public struct MarketplaceCommerceAnalyticsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Marketplace Commerce Analytics")
...
extension MarketplaceCommerceAnalyticsClient {
    ...
    public func generateDataSet(input: GenerateDataSetInput) async throws -> GenerateDataSetOutput {
        ...
        let operation = MarketplaceCommerceAnalyticsClient.generateDataSetOperation
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GenerateDataSetInput, GenerateDataSetOutput>(overrides: ["X-Amz-Target": "MarketplaceCommerceAnalytics20150701.GenerateDataSet"]))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Marketplace Commerce Analytics"))
    ...
    public func startSupportDataExport(input: StartSupportDataExportInput) async throws -> StartSupportDataExportOutput {
        ...
        let operation = MarketplaceCommerceAnalyticsClient.startSupportDataExportOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<StartSupportDataExportInput, StartSupportDataExportOutput>(overrides: ["X-Amz-Target": "MarketplaceCommerceAnalytics20150701.StartSupportDataExport"]))
