...
extension MarketplaceCommerceAnalyticsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MarketplaceCommerceAnalyticsClient.MarketplaceCommerceAnalyticsClientConfiguration {
        let clientConfiguration = try await MarketplaceCommerceAnalyticsClient.MarketplaceCommerceAnalyticsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MarketplaceCommerceAnalyticsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MarketplaceCommerceAnalyticsClient(config: configuration)
        }
    }
...
extension MarketplaceCommerceAnalyticsClient.MarketplaceCommerceAnalyticsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
