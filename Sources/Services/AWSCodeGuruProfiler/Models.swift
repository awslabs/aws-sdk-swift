...
extension BatchGetFrameMetricDataOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchGetFrameMetricDataOutput {
        ...
        value.unprocessedEndTimes = try reader["unprocessedEndTimes"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: CodeGuruProfilerClientTypes.TimestampStructure.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension GetRecommendationsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetRecommendationsOutput {
        ...
        value.profileEndTime = try reader["profileEndTime"].readTimestampIfPresent(format: .dateTime)
        value.profileStartTime = try reader["profileStartTime"].readTimestampIfPresent(format: .dateTime)
...
extension ListProfilingGroupsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListProfilingGroupsOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.profilingGroupNames = try reader["profilingGroupNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CodeGuruProfilerClientTypes.Channel {
    ...
    static func write(value: CodeGuruProfilerClientTypes.Channel?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["eventPublishers"].writeList(value.eventPublishers, memberWritingClosure: CodeGuruProfilerClientTypes.EventPublisher.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeGuruProfilerClientTypes.Channel {
        ...
        value.eventPublishers = try reader["eventPublishers"].readListIfPresent(memberReadingClosure: CodeGuruProfilerClientTypes.EventPublisher.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodeGuruProfilerClientTypes.TimestampStructure {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeGuruProfilerClientTypes.TimestampStructure {
        ...
        value.value = try reader["value"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
...
extension CodeGuruProfilerClientTypes.FrameMetric {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeGuruProfilerClientTypes.FrameMetric {
        ...
        value.threadStates = try reader["threadStates"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodeGuruProfilerClientTypes.AgentConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeGuruProfilerClientTypes.AgentConfiguration {
        ...
        value.agentParameters = try reader["agentParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension CodeGuruProfilerClientTypes.ProfilingStatus {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeGuruProfilerClientTypes.ProfilingStatus {
        ...
        value.latestAgentProfileReportedAt = try reader["latestAgentProfileReportedAt"].readTimestampIfPresent(format: .dateTime)
        ...
        value.latestAgentOrchestratedAt = try reader["latestAgentOrchestratedAt"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
...
extension CodeGuruProfilerClientTypes.AggregatedProfileTime {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeGuruProfilerClientTypes.AggregatedProfileTime {
        ...
        value.start = try reader["start"].readTimestampIfPresent(format: .dateTime)
...
extension CodeGuruProfilerClientTypes.Pattern {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeGuruProfilerClientTypes.Pattern {
        ...
        value.targetFrames = try reader["targetFrames"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
        value.thresholdPercent = try reader["thresholdPercent"].readIfPresent() ?? 0
        value.countersToAggregate = try reader["countersToAggregate"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
