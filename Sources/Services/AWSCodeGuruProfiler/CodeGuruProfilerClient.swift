...
extension CodeGuruProfilerClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CodeGuruProfilerClient.CodeGuruProfilerClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> CodeGuruProfilerClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CodeGuruProfilerClient(config: configuration)
        }
    }
...
extension CodeGuruProfilerClient.CodeGuruProfilerClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
