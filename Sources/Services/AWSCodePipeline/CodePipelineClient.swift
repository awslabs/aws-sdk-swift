...
extension CodePipelineClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CodePipelineClient.CodePipelineClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> CodePipelineClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CodePipelineClient(config: configuration)
        }
    }
...
extension CodePipelineClient.CodePipelineClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
