...
extension PollForJobsInput {
    ...
    static func write(value: PollForJobsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["queryParam"].writeMap(value.queryParam, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension GetPipelineStateOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetPipelineStateOutput {
        ...
        value.updated = try reader["updated"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension PutApprovalResultOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> PutApprovalResultOutput {
        ...
        value.approvedAt = try reader["approvedAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension CodePipelineClientTypes.GitPullRequestFilter {
    ...
    static func write(value: CodePipelineClientTypes.GitPullRequestFilter?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["events"].writeList(value.events, memberWritingClosure: CodePipelineClientTypes.GitPullRequestEventType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodePipelineClientTypes.GitPullRequestFilter {
        ...
        value.events = try reader["events"].readListIfPresent(memberReadingClosure: CodePipelineClientTypes.GitPullRequestEventType.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CodePipelineClientTypes.GitFilePathFilterCriteria {
    ...
    static func write(value: CodePipelineClientTypes.GitFilePathFilterCriteria?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["excludes"].writeList(value.excludes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["includes"].writeList(value.includes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodePipelineClientTypes.GitFilePathFilterCriteria {
        ...
        value.includes = try reader["includes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.excludes = try reader["excludes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodePipelineClientTypes.ActionTypePermissions {
    ...
    static func write(value: CodePipelineClientTypes.ActionTypePermissions?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["allowedAccounts"].writeList(value.allowedAccounts, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodePipelineClientTypes.ActionTypePermissions {
        ...
        value.allowedAccounts = try reader["allowedAccounts"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodePipelineClientTypes.JobWorkerExecutorConfiguration {
    ...
    static func write(value: CodePipelineClientTypes.JobWorkerExecutorConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["pollingAccounts"].writeList(value.pollingAccounts, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["pollingServicePrincipals"].writeList(value.pollingServicePrincipals, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodePipelineClientTypes.JobWorkerExecutorConfiguration {
        ...
        value.pollingAccounts = try reader["pollingAccounts"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.pollingServicePrincipals = try reader["pollingServicePrincipals"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodePipelineClientTypes.PipelineMetadata {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodePipelineClientTypes.PipelineMetadata {
        ...
        value.created = try reader["created"].readTimestampIfPresent(format: .epochSeconds)
        value.updated = try reader["updated"].readTimestampIfPresent(format: .epochSeconds)
        value.pollingDisabledAt = try reader["pollingDisabledAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension CodePipelineClientTypes.TransitionState {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodePipelineClientTypes.TransitionState {
        ...
        value.lastChangedAt = try reader["lastChangedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension CodePipelineClientTypes.ActionExecutionInput {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodePipelineClientTypes.ActionExecutionInput {
        ...
        value.actionTypeId = try reader["actionTypeId"].readIfPresent(with: CodePipelineClientTypes.ActionTypeId.read(from:))
        value.configuration = try reader["configuration"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.resolvedConfiguration = try reader["resolvedConfiguration"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.roleArn = try reader["roleArn"].readIfPresent()
        value.region = try reader["region"].readIfPresent()
...
extension CodePipelineClientTypes.ListWebhookItem {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodePipelineClientTypes.ListWebhookItem {
        ...
        value.lastTriggered = try reader["lastTriggered"].readTimestampIfPresent(format: .epochSeconds)
