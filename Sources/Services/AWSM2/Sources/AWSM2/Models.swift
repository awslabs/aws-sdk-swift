...
public struct GetSignedBluinsightsUrlInput: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct AlternateKey: Swift.Sendable {
...
public struct CancelBatchJobExecutionInput: Swift.Sendable {
...
public struct CancelBatchJobExecutionOutput: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public enum Definition: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct PoAttributes: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct PsAttributes: Swift.Sendable {
        /// The character set encoding of the data set.
        public var encoding: Swift.String?
        /// The format of the data set records.
        /// This member is required.
...
extension M2ClientTypes {
    ...
    public struct PrimaryKey: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct VsamAttributes: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public enum DatasetOrgAttributes: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct RecordLength: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct DataSetImportItem: Swift.Sendable {
        /// The data set.
        /// This member is required.
...
extension M2ClientTypes {
    ...
    public enum DataSetImportConfig: Swift.Sendable {
        /// The Amazon S3 location of the data sets.
        case s3location(Swift.String)
        /// The data sets.
...
public struct CreateDataSetImportTaskInput: Swift.Sendable {
...
public struct CreateDataSetImportTaskOutput: Swift.Sendable {
...
public struct DeleteApplicationFromEnvironmentInput: Swift.Sendable {
    /// The unique identifier of the application you want to delete.
    /// This member is required.
    public var applicationId: Swift.String?
...
public struct DeleteApplicationFromEnvironmentOutput: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public enum DeploymentLifecycle: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case deploying
        case deployUpdate
        case failed
        case succeeded
...
extension M2ClientTypes {
    ...
    public struct DeployedVersionSummary: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public enum ApplicationVersionLifecycle: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case available
        case creating
        case failed
        case sdkUnknown(Swift.String)
...
extension M2ClientTypes {
    ...
    public enum ApplicationLifecycle: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case available
        case created
        case creating
        case deleting
...
public struct GetApplicationVersionInput: Swift.Sendable {
    /// The unique identifier of the application.
    /// This member is required.
    public var applicationId: Swift.String?
...
public struct GetApplicationVersionOutput: Swift.Sendable {
    /// The specific version of the application.
    /// This member is required.
    public var applicationVersion: Swift.Int?
    /// The timestamp when the application version was created.
...
public struct GetBatchJobExecutionInput: Swift.Sendable {
    /// The identifier of the application.
    /// This member is required.
    public var applicationId: Swift.String?
    /// The unique identifier of the batch job execution.
...
extension M2ClientTypes {
    ...
    public struct FileBatchJobIdentifier: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct RestartBatchJobIdentifier: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public enum JobIdentifier: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct S3BatchJobIdentifier: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct ScriptBatchJobIdentifier: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    /// Identifies a specific batch job.
    public enum BatchJobIdentifier: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public enum BatchJobType: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case jes2
        case jes3
        case vse
        case sdkUnknown(Swift.String)
...
extension M2ClientTypes {
    ...
    public enum BatchJobExecutionStatus: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case cancelled
        case cancelling
        case dispatch
        case failed
...
public struct GetBatchJobExecutionOutput: Swift.Sendable {
    /// The identifier of the application.
    /// This member is required.
    public var applicationId: Swift.String?
...
public struct GetDataSetDetailsInput: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    /// The required attributes for a generation data group data set. A generation data set is one of a collection of successive, historically related, catalogued data sets that together are known as a generation data group (GDG). Use this structure when you want to import a GDG. For more information on GDG, see [Generation data sets](https://www.ibm.com/docs/en/zos/2.3.0?topic=guide-generation-data-sets).
    public struct GdgDetailAttributes: Swift.Sendable {
        /// The maximum number of generation data sets, up to 255, in a GDG.
        public var limit: Swift.Int
        /// The disposition of the data set in the catalog.
        public var rollDisposition: Swift.String?
...
extension M2ClientTypes {
    ...
    /// The supported properties for a PO type data set.
    public struct PoDetailAttributes: Swift.Sendable {
        /// The character set encoding of the data set.
        /// This member is required.
        public var encoding: Swift.String?
        /// The format of the data set records.
...
extension M2ClientTypes {
    ...
    /// The supported properties for a PS type data set.
    public struct PsDetailAttributes: Swift.Sendable {
        /// The character set encoding of the data set.
        /// This member is required.
        public var encoding: Swift.String?
        /// The format of the data set records.
...
extension M2ClientTypes {
    ...
    /// The attributes of a VSAM type data set.
    public struct VsamDetailAttributes: Swift.Sendable {
        /// The alternate key definitions, if any. A legacy dataset might not have any alternate key defined, but if those alternate keys definitions exist, provide them as some applications will make use of them.
        public var alternateKeys: [M2ClientTypes.AlternateKey]?
...
extension M2ClientTypes {
    ...
    /// Additional details about the data set. Different attributes correspond to different data set organizations. The values are populated based on datasetOrg, storageType and backend (Blu Age or Micro Focus).
    public enum DatasetDetailOrgAttributes: Swift.Sendable {
        /// The details of a VSAM data set.
...
public struct GetDataSetDetailsOutput: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public enum DataSetTaskLifecycle: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case completed
        case creating
        case failed
        case running
...
extension M2ClientTypes {
    ...
    public struct DataSetImportSummary: Swift.Sendable {
...
public struct GetDataSetImportTaskOutput: Swift.Sendable {
    /// The status of the task.
    /// This member is required.
    public var status: M2ClientTypes.DataSetTaskLifecycle?
    /// A summary of the status of the task.
...
extension M2ClientTypes {
    ...
    public enum ApplicationDeploymentLifecycle: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case deployed
        case deploying
        case sdkUnknown(Swift.String)
...
public struct ListBatchJobDefinitionsInput: Swift.Sendable {
    /// The identifier of the application.
    /// This member is required.
    public var applicationId: Swift.String?
...
extension M2ClientTypes {
    ...
    public struct FileBatchJobDefinition: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct ScriptBatchJobDefinition: Swift.Sendable {
        /// The name of the script containing the batch job definition.
        /// This member is required.
        public var scriptName: Swift.String?
...
extension M2ClientTypes {
    ...
    public enum BatchJobDefinition: Swift.Sendable {
...
public struct ListBatchJobDefinitionsOutput: Swift.Sendable {
...
public struct ListBatchJobExecutionsInput: Swift.Sendable {
    /// The unique identifier of the application.
    /// This member is required.
    public var applicationId: Swift.String?
...
extension M2ClientTypes {
    ...
    public struct BatchJobExecutionSummary: Swift.Sendable {
...
public struct ListBatchJobExecutionsOutput: Swift.Sendable {
...
public struct ListBatchJobRestartPointsInput: Swift.Sendable {
    /// The unique identifier of the application.
    /// This member is required.
    public var applicationId: Swift.String?
...
extension M2ClientTypes {
    ...
    public struct JobStep: Swift.Sendable {
...
public struct ListBatchJobRestartPointsOutput: Swift.Sendable {
...
public struct ListDataSetImportHistoryInput: Swift.Sendable {
    /// The unique identifier of the application.
    /// This member is required.
    public var applicationId: Swift.String?
    /// The maximum number of objects to return.
...
extension M2ClientTypes {
    ...
    public struct DataSetImportTask: Swift.Sendable {
...
public struct ListDataSetImportHistoryOutput: Swift.Sendable {
...
public struct StartBatchJobInput: Swift.Sendable {
...
public struct StartBatchJobOutput: Swift.Sendable {
    /// The unique identifier of this execution of the batch job.
    /// This member is required.
    public var executionId: Swift.String?
...
extension M2ClientTypes {
    ...
    public struct HighAvailabilityConfig: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct FsxStorageConfiguration: Swift.Sendable {
        /// The file system identifier.
        /// This member is required.
        public var fileSystemId: Swift.String?
        /// The mount point for the file system.
...
extension M2ClientTypes {
    ...
    public enum StorageConfiguration: Swift.Sendable {
        /// Defines the storage configuration for an Amazon EFS file system.
...
extension M2ClientTypes {
    ...
    public struct PendingMaintenance: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public enum EnvironmentLifecycle: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case available
        case creating
        case deleting
        case failed
...
public struct GetSignedBluinsightsUrlOutput: Swift.Sendable {
...
extension M2ClientTypes {
    ...
    public struct EngineVersionsSummary: Swift.Sendable {
...
extension ExecutionTimeoutException {
    ...
    static func makeError(baseError: ClientRuntime.RestJSONError) throws -> ExecutionTimeoutException {
        let reader = baseError.errorBodyReader
