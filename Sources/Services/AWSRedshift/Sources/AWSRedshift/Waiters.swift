...
extension RedshiftClient {
    ...
    static func clusterAvailableWaiterConfig() throws -> ClientRuntime.WaiterConfiguration<DescribeClustersInput, DescribeClustersOutput> {
        let acceptors: [ClientRuntime.WaiterConfiguration<DescribeClustersInput, DescribeClustersOutput>.Acceptor] = [
        ...
        return try ClientRuntime.WaiterConfiguration<DescribeClustersInput, DescribeClustersOutput>(acceptors: acceptors, minDelay: 60.0, maxDelay: 120.0)
    }
    ...
    public func waitUntilClusterAvailable(options: ClientRuntime.WaiterOptions, input: DescribeClustersInput) async throws -> ClientRuntime.WaiterOutcome<DescribeClustersOutput> {
        let waiter = ClientRuntime.Waiter(config: try Self.clusterAvailableWaiterConfig(), operation: self.describeClusters(input:))
        return try await waiter.waitUntil(options: options, input: input)
    }

    static func clusterDeletedWaiterConfig() throws -> ClientRuntime.WaiterConfiguration<DescribeClustersInput, DescribeClustersOutput> {
        let acceptors: [ClientRuntime.WaiterConfiguration<DescribeClustersInput, DescribeClustersOutput>.Acceptor] = [
            .init(state: .success, matcher: { (input: DescribeClustersInput, result: Swift.Result<DescribeClustersOutput, Swift.Error>) -> Bool in
                guard case .failure(let error) = result else { return false }
                return (error as? ClientRuntime.ServiceError)?.typeName == "ClusterNotFound"
    ...
    /// or there is an error not handled by any `Acceptor.`
    /// `WaiterTimeoutError` if the waiter times out.
    public func waitUntilClusterDeleted(options: ClientRuntime.WaiterOptions, input: DescribeClustersInput) async throws -> ClientRuntime.WaiterOutcome<DescribeClustersOutput> {
        let waiter = ClientRuntime.Waiter(config: try Self.clusterDeletedWaiterConfig(), operation: self.describeClusters(input:))
        return try await waiter.waitUntil(options: options, input: input)
    }

    static func clusterRestoredWaiterConfig() throws -> ClientRuntime.WaiterConfiguration<DescribeClustersInput, DescribeClustersOutput> {
        let acceptors: [ClientRuntime.WaiterConfiguration<DescribeClustersInput, DescribeClustersOutput>.Acceptor] = [
            .init(state: .success, matcher: { (input: DescribeClustersInput, result: Swift.Result<DescribeClustersOutput, Swift.Error>) -> Bool in
    ...
    /// or there is an error not handled by any `Acceptor.`
    /// `WaiterTimeoutError` if the waiter times out.
    public func waitUntilClusterRestored(options: ClientRuntime.WaiterOptions, input: DescribeClustersInput) async throws -> ClientRuntime.WaiterOutcome<DescribeClustersOutput> {
        let waiter = ClientRuntime.Waiter(config: try Self.clusterRestoredWaiterConfig(), operation: self.describeClusters(input:))
        return try await waiter.waitUntil(options: options, input: input)
    }

    static func snapshotAvailableWaiterConfig() throws -> ClientRuntime.WaiterConfiguration<DescribeClusterSnapshotsInput, DescribeClusterSnapshotsOutput> {
        let acceptors: [ClientRuntime.WaiterConfiguration<DescribeClusterSnapshotsInput, DescribeClusterSnapshotsOutput>.Acceptor] = [
        ...
        return try ClientRuntime.WaiterConfiguration<DescribeClusterSnapshotsInput, DescribeClusterSnapshotsOutput>(acceptors: acceptors, minDelay: 15.0, maxDelay: 120.0)
    }
    ...
    /// or there is an error not handled by any `Acceptor.`
    /// `WaiterTimeoutError` if the waiter times out.
    public func waitUntilSnapshotAvailable(options: ClientRuntime.WaiterOptions, input: DescribeClusterSnapshotsInput) async throws -> ClientRuntime.WaiterOutcome<DescribeClusterSnapshotsOutput> {
        let waiter = ClientRuntime.Waiter(config: try Self.snapshotAvailableWaiterConfig(), operation: self.describeClusterSnapshots(input:))
        return try await waiter.waitUntil(options: options, input: input)
    }
}
