...
public final class EC2InstanceConnectClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: EC2InstanceConnectClient.EC2InstanceConnectClientConfig) instead")
    public convenience init(config: EC2InstanceConnectClient.EC2InstanceConnectClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try EC2InstanceConnectClient.EC2InstanceConnectClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await EC2InstanceConnectClient.EC2InstanceConnectClientConfig()
        self.init(config: config)
    }
}
...
extension EC2InstanceConnectClient {
    ...
    /// Client configuration for EC2InstanceConnectClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct EC2InstanceConnectClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "EC2 Instance Connect")
    ...
    @available(*, deprecated, message: "Use EC2InstanceConnectClientConfig instead. This class will be removed in a future version.")
    public final class EC2InstanceConnectClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> EC2InstanceConnectClientConfig {
            return try EC2InstanceConnectClientConfig(
...
extension EC2InstanceConnectClient {
    ...
    public func sendSSHPublicKey(input: SendSSHPublicKeyInput) async throws -> SendSSHPublicKeyOutput {
        ...
        let operation = EC2InstanceConnectClient.sendSSHPublicKeyOperation
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "EC2 Instance Connect"))
    ...
    public func sendSerialConsoleSSHPublicKey(input: SendSerialConsoleSSHPublicKeyInput) async throws -> SendSerialConsoleSSHPublicKeyOutput {
        ...
        let operation = EC2InstanceConnectClient.sendSerialConsoleSSHPublicKeyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
