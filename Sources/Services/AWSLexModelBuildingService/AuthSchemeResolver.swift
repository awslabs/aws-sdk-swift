...
public struct LexModelBuildingServiceAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol LexModelBuildingServiceAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
