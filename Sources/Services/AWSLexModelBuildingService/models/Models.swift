...
extension LexModelBuildingClientTypes.BotChannelAssociation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LexModelBuildingClientTypes.BotChannelAssociation {
        ...
        value.botConfiguration = try reader["botConfiguration"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension LexModelBuildingClientTypes.BuiltinIntentMetadata {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LexModelBuildingClientTypes.BuiltinIntentMetadata {
        ...
        value.supportedLocales = try reader["supportedLocales"].readListIfPresent(memberReadingClosure: LexModelBuildingClientTypes.Locale.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension LexModelBuildingClientTypes.EnumerationValue {
    ...
    static func write(value: LexModelBuildingClientTypes.EnumerationValue?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["synonyms"].writeList(value.synonyms, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LexModelBuildingClientTypes.EnumerationValue {
        ...
        value.synonyms = try reader["synonyms"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetImportOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetImportOutput {
        ...
        value.createdDate = try reader["createdDate"].readTimestampIfPresent(format: .epochSeconds)
        value.failureReason = try reader["failureReason"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension GetMigrationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetMigrationOutput {
        ...
        value.migrationTimestamp = try reader["migrationTimestamp"].readTimestampIfPresent(format: .epochSeconds)
...
extension LexModelBuildingClientTypes.MigrationAlert {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LexModelBuildingClientTypes.MigrationAlert {
        ...
        value.details = try reader["details"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.referenceURLs = try reader["referenceURLs"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension LexModelBuildingClientTypes.UtteranceData {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LexModelBuildingClientTypes.UtteranceData {
        ...
        value.firstUtteredDate = try reader["firstUtteredDate"].readTimestampIfPresent(format: .epochSeconds)
        value.lastUtteredDate = try reader["lastUtteredDate"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
