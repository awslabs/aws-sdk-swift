...
extension KafkaConnectClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> KafkaConnectClient.KafkaConnectClientConfiguration {
        let clientConfiguration = try await KafkaConnectClient.KafkaConnectClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> KafkaConnectClient {
            let configuration = try await resolve(plugins: self.plugins)
            return KafkaConnectClient(config: configuration)
        }
    }
...
extension KafkaConnectClient.KafkaConnectClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
