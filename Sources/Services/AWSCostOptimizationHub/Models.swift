...
extension CostOptimizationHubClientTypes.Filter {
    ...
    static func write(value: CostOptimizationHubClientTypes.Filter?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["actionTypes"].writeList(value.actionTypes, memberWritingClosure: CostOptimizationHubClientTypes.ActionType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["implementationEfforts"].writeList(value.implementationEfforts, memberWritingClosure: CostOptimizationHubClientTypes.ImplementationEffort.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["resourceTypes"].writeList(value.resourceTypes, memberWritingClosure: CostOptimizationHubClientTypes.ResourceType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
