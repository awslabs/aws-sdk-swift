...
extension RAMClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> RAMClient.RAMClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> RAMClient {
            let configuration = try await resolve(plugins: self.plugins)
            return RAMClient(config: configuration)
        }
    }
...
extension RAMClient.RAMClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
