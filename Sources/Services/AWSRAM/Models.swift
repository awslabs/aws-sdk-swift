...
extension CreateResourceShareInput {
    ...
    static func write(value: CreateResourceShareInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["clientToken"].write(value.clientToken)
        try writer["name"].write(value.name)
        try writer["permissionArns"].writeList(value.permissionArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["principals"].writeList(value.principals, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["resourceArns"].writeList(value.resourceArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["sources"].writeList(value.sources, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["tags"].writeList(value.tags, memberWritingClosure: RAMClientTypes.Tag.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GetResourceShareAssociationsInput {
    ...
    static func write(value: GetResourceShareAssociationsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["resourceShareArns"].writeList(value.resourceShareArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetResourceShareInvitationsInput {
    ...
    static func write(value: GetResourceShareInvitationsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["nextToken"].write(value.nextToken)
        try writer["resourceShareArns"].writeList(value.resourceShareArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["resourceShareInvitationArns"].writeList(value.resourceShareInvitationArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ListReplacePermissionAssociationsWorkInput {
    ...
    static func write(value: ListReplacePermissionAssociationsWorkInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["workIds"].writeList(value.workIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetResourcePoliciesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetResourcePoliciesOutput {
        ...
        value.policies = try reader["policies"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
