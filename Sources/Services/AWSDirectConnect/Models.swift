...
extension ListVirtualInterfaceTestHistoryInput {
    ...
    static func write(value: ListVirtualInterfaceTestHistoryInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["bgpPeers"].writeList(value.bgpPeers, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["maxResults"].write(value.maxResults)
        try writer["nextToken"].write(value.nextToken)
...
extension DirectConnectClientTypes.Location {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DirectConnectClientTypes.Location {
        ...
        value.region = try reader["region"].readIfPresent()
        value.availablePortSpeeds = try reader["availablePortSpeeds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.availableProviders = try reader["availableProviders"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.availableMacSecPortSpeeds = try reader["availableMacSecPortSpeeds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DirectConnectClientTypes.VirtualInterfaceTestHistory {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DirectConnectClientTypes.VirtualInterfaceTestHistory {
        ...
        value.virtualInterfaceId = try reader["virtualInterfaceId"].readIfPresent()
        value.bgpPeers = try reader["bgpPeers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["status"].readIfPresent()
        value.ownerAccount = try reader["ownerAccount"].readIfPresent()
