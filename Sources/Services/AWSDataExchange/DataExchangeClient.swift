...
extension DataExchangeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> DataExchangeClient.DataExchangeClientConfiguration {
        let clientConfiguration = try await DataExchangeClient.DataExchangeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> DataExchangeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return DataExchangeClient(config: configuration)
        }
    }
...
extension DataExchangeClient.DataExchangeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
