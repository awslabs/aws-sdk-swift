...
extension SSMContactsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SSMContactsClient.SSMContactsClientConfiguration {
        let clientConfiguration = try await SSMContactsClient.SSMContactsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SSMContactsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SSMContactsClient(config: configuration)
        }
    }
...
extension SSMContactsClient.SSMContactsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
