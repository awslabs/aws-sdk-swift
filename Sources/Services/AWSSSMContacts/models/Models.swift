...
extension SSMContactsClientTypes.DependentEntity {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSMContactsClientTypes.DependentEntity {
        ...
        value.dependentResourceIds = try reader["DependentResourceIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeEngagementOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeEngagementOutput {
        ...
        value.stopTime = try reader["StopTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension DescribePageOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribePageOutput {
        ...
        value.publicContent = try reader["PublicContent"].readIfPresent()
        value.publicSubject = try reader["PublicSubject"].readIfPresent()
        value.readTime = try reader["ReadTime"].readTimestampIfPresent(format: .epochSeconds)
        value.sender = try reader["Sender"].readIfPresent()
        value.sentTime = try reader["SentTime"].readTimestampIfPresent(format: .epochSeconds)
        value.subject = try reader["Subject"].readIfPresent()
        return value
    }
}
...
extension GetRotationOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetRotationOutput {
        ...
        value.contactIds = try reader["ContactIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.name = try reader["Name"].readIfPresent()
...
extension GetRotationOverrideOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetRotationOverrideOutput {
        ...
        value.newContactIds = try reader["NewContactIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.rotationArn = try reader["RotationArn"].readIfPresent()
        value.rotationOverrideId = try reader["RotationOverrideId"].readIfPresent()
        value.startTime = try reader["StartTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
...
extension ListPreviewRotationShiftsInput {
    ...
    static func write(value: ListPreviewRotationShiftsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Recurrence"].write(value.recurrence, with: SSMContactsClientTypes.RecurrenceSettings.write(value:to:))
        try writer["RotationStartTime"].writeTimestamp(value.rotationStartTime, format: .epochSeconds)
        try writer["StartTime"].writeTimestamp(value.startTime, format: .epochSeconds)
        try writer["TimeZoneId"].write(value.timeZoneId)
    }
}
...
extension SSMContactsClientTypes.Plan {
    ...
    static func write(value: SSMContactsClientTypes.Plan?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["RotationIds"].writeList(value.rotationIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSMContactsClientTypes.Plan {
        ...
        value.rotationIds = try reader["RotationIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SSMContactsClientTypes.Receipt {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSMContactsClientTypes.Receipt {
        ...
        value.receiptTime = try reader["ReceiptTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension SSMContactsClientTypes.RecurrenceSettings {
    ...
    static func write(value: SSMContactsClientTypes.RecurrenceSettings?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ShiftCoverages"].writeMap(value.shiftCoverages, valueWritingClosure: listWritingClosure(memberWritingClosure: SSMContactsClientTypes.CoverageTime.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSMContactsClientTypes.RecurrenceSettings {
        ...
        value.shiftCoverages = try reader["ShiftCoverages"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: SSMContactsClientTypes.CoverageTime.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension SSMContactsClientTypes.ShiftDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSMContactsClientTypes.ShiftDetails {
        ...
        value.overriddenContactIds = try reader["OverriddenContactIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
