...
public final class S3ControlClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "S3ControlClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: S3ControlClient.S3ControlClientConfig
    let serviceName = "S3 Control"

    @available(*, deprecated, message: "Use S3ControlClient.S3ControlClientConfig instead")
    public typealias Config = S3ControlClient.S3ControlClientConfiguration
    public typealias Configuration = S3ControlClient.S3ControlClientConfig

    public required init(config: S3ControlClient.S3ControlClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: S3ControlClient.S3ControlClientConfig) instead")
    public convenience init(config: S3ControlClient.S3ControlClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try S3ControlClient.S3ControlClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await S3ControlClient.S3ControlClientConfig()
        self.init(config: config)
    }
}
...
extension S3ControlClient {
    ...
    /// Client configuration for S3ControlClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct S3ControlClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultS3ControlAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: S3ControlClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultS3ControlAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use S3ControlClientConfig instead. This class will be removed in a future version.")
    public final class S3ControlClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> S3ControlClientConfig {
            return try S3ControlClientConfig(
                ...
                useArnRegion: self.useArnRegion,
...
extension S3ControlClient {
    ...
    public func associateAccessGrantsIdentityCenter(input: AssociateAccessGrantsIdentityCenterInput) async throws -> AssociateAccessGrantsIdentityCenterOutput {
        ...
        let operation = S3ControlClient.associateAccessGrantsIdentityCenterOperation
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("S3 Control", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(accountId: input.accountId, endpoint: configuredEndpoint, region: config.region, requiresAccountId: true, useArnRegion: config.useArnRegion, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<AssociateAccessGrantsIdentityCenterOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<AssociateAccessGrantsIdentityCenterInput, AssociateAccessGrantsIdentityCenterOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
    ...
    public func createAccessGrant(input: CreateAccessGrantInput) async throws -> CreateAccessGrantOutput {
        ...
        let operation = S3ControlClient.createAccessGrantOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateAccessGrantInput, CreateAccessGrantOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func createAccessGrantsInstance(input: CreateAccessGrantsInstanceInput) async throws -> CreateAccessGrantsInstanceOutput {
        ...
        let operation = S3ControlClient.createAccessGrantsInstanceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateAccessGrantsInstanceOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateAccessGrantsInstanceInput, CreateAccessGrantsInstanceOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func createAccessGrantsLocation(input: CreateAccessGrantsLocationInput) async throws -> CreateAccessGrantsLocationOutput {
        ...
        let operation = S3ControlClient.createAccessGrantsLocationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateAccessGrantsLocationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateAccessGrantsLocationInput, CreateAccessGrantsLocationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func createAccessPoint(input: CreateAccessPointInput) async throws -> CreateAccessPointOutput {
        ...
        let operation = S3ControlClient.createAccessPointOperation
        let context = Smithy.ContextBuilder()
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("S3 Control", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(accessPointName: input.name, accountId: input.accountId, bucket: input.bucket, endpoint: configuredEndpoint, region: config.region, requiresAccountId: true, useArnRegion: config.useArnRegion, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateAccessPointInput, CreateAccessPointOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func createAccessPointForObjectLambda(input: CreateAccessPointForObjectLambdaInput) async throws -> CreateAccessPointForObjectLambdaOutput {
        ...
        let operation = S3ControlClient.createAccessPointForObjectLambdaOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateAccessPointForObjectLambdaOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateAccessPointForObjectLambdaInput, CreateAccessPointForObjectLambdaOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func createBucket(input: CreateBucketInput) async throws -> CreateBucketOutput {
        ...
        let operation = S3ControlClient.createBucketOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("S3 Control", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(bucket: input.bucket, endpoint: configuredEndpoint, outpostId: input.outpostId, region: config.region, useArnRegion: config.useArnRegion, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateBucketOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateBucketInput, CreateBucketOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func createJob(input: CreateJobInput) async throws -> CreateJobOutput {
        ...
        let operation = S3ControlClient.createJobOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateJobInput, CreateJobOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func createMultiRegionAccessPoint(input: CreateMultiRegionAccessPointInput) async throws -> CreateMultiRegionAccessPointOutput {
        ...
        let operation = S3ControlClient.createMultiRegionAccessPointOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateMultiRegionAccessPointOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateMultiRegionAccessPointInput, CreateMultiRegionAccessPointOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func createStorageLensGroup(input: CreateStorageLensGroupInput) async throws -> CreateStorageLensGroupOutput {
        ...
        let operation = S3ControlClient.createStorageLensGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateStorageLensGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateStorageLensGroupInput, CreateStorageLensGroupOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteAccessGrant(input: DeleteAccessGrantInput) async throws -> DeleteAccessGrantOutput {
        ...
        let operation = S3ControlClient.deleteAccessGrantOperation
        let context = Smithy.ContextBuilder()
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAccessGrantInput, DeleteAccessGrantOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteAccessGrantsInstance(input: DeleteAccessGrantsInstanceInput) async throws -> DeleteAccessGrantsInstanceOutput {
        ...
        let operation = S3ControlClient.deleteAccessGrantsInstanceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAccessGrantsInstanceOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAccessGrantsInstanceInput, DeleteAccessGrantsInstanceOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteAccessGrantsInstanceResourcePolicy(input: DeleteAccessGrantsInstanceResourcePolicyInput) async throws -> DeleteAccessGrantsInstanceResourcePolicyOutput {
        ...
        let operation = S3ControlClient.deleteAccessGrantsInstanceResourcePolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAccessGrantsInstanceResourcePolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAccessGrantsInstanceResourcePolicyInput, DeleteAccessGrantsInstanceResourcePolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteAccessGrantsLocation(input: DeleteAccessGrantsLocationInput) async throws -> DeleteAccessGrantsLocationOutput {
        ...
        let operation = S3ControlClient.deleteAccessGrantsLocationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAccessGrantsLocationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAccessGrantsLocationInput, DeleteAccessGrantsLocationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteAccessPoint(input: DeleteAccessPointInput) async throws -> DeleteAccessPointOutput {
        ...
        let operation = S3ControlClient.deleteAccessPointOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("S3 Control", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(accessPointName: input.name, accountId: input.accountId, endpoint: configuredEndpoint, region: config.region, requiresAccountId: true, useArnRegion: config.useArnRegion, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAccessPointInput, DeleteAccessPointOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteAccessPointForObjectLambda(input: DeleteAccessPointForObjectLambdaInput) async throws -> DeleteAccessPointForObjectLambdaOutput {
        ...
        let operation = S3ControlClient.deleteAccessPointForObjectLambdaOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAccessPointForObjectLambdaOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAccessPointForObjectLambdaInput, DeleteAccessPointForObjectLambdaOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteAccessPointPolicy(input: DeleteAccessPointPolicyInput) async throws -> DeleteAccessPointPolicyOutput {
        ...
        let operation = S3ControlClient.deleteAccessPointPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAccessPointPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAccessPointPolicyInput, DeleteAccessPointPolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteAccessPointPolicyForObjectLambda(input: DeleteAccessPointPolicyForObjectLambdaInput) async throws -> DeleteAccessPointPolicyForObjectLambdaOutput {
        ...
        let operation = S3ControlClient.deleteAccessPointPolicyForObjectLambdaOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAccessPointPolicyForObjectLambdaOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAccessPointPolicyForObjectLambdaInput, DeleteAccessPointPolicyForObjectLambdaOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteAccessPointScope(input: DeleteAccessPointScopeInput) async throws -> DeleteAccessPointScopeOutput {
        ...
        let operation = S3ControlClient.deleteAccessPointScopeOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteAccessPointScope")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<DeleteAccessPointScopeInput, DeleteAccessPointScopeOutput>(DeleteAccessPointScopeInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DeleteAccessPointScopeInput, DeleteAccessPointScopeOutput>())
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("S3 Control", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(accessPointName: input.name, accountId: input.accountId, endpoint: configuredEndpoint, region: config.region, requiresAccountId: true, useArnRegion: config.useArnRegion, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false, useS3ExpressControlEndpoint: true)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAccessPointScopeOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DeleteAccessPointScopeOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DeleteAccessPointScopeInput, DeleteAccessPointScopeOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DeleteAccessPointScopeInput, DeleteAccessPointScopeOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAccessPointScopeInput, DeleteAccessPointScopeOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DeleteAccessPointScope")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func deleteBucket(input: DeleteBucketInput) async throws -> DeleteBucketOutput {
        ...
        let operation = S3ControlClient.deleteBucketOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("S3 Control", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(accountId: input.accountId, bucket: input.bucket, endpoint: configuredEndpoint, region: config.region, requiresAccountId: true, useArnRegion: config.useArnRegion, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteBucketOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteBucketInput, DeleteBucketOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteBucketLifecycleConfiguration(input: DeleteBucketLifecycleConfigurationInput) async throws -> DeleteBucketLifecycleConfigurationOutput {
        ...
        let operation = S3ControlClient.deleteBucketLifecycleConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteBucketLifecycleConfigurationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteBucketLifecycleConfigurationInput, DeleteBucketLifecycleConfigurationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteBucketPolicy(input: DeleteBucketPolicyInput) async throws -> DeleteBucketPolicyOutput {
        ...
        let operation = S3ControlClient.deleteBucketPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteBucketPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteBucketPolicyInput, DeleteBucketPolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteBucketReplication(input: DeleteBucketReplicationInput) async throws -> DeleteBucketReplicationOutput {
        ...
        let operation = S3ControlClient.deleteBucketReplicationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteBucketReplicationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteBucketReplicationInput, DeleteBucketReplicationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteBucketTagging(input: DeleteBucketTaggingInput) async throws -> DeleteBucketTaggingOutput {
        ...
        let operation = S3ControlClient.deleteBucketTaggingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteBucketTaggingOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteBucketTaggingInput, DeleteBucketTaggingOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteJobTagging(input: DeleteJobTaggingInput) async throws -> DeleteJobTaggingOutput {
        ...
        let operation = S3ControlClient.deleteJobTaggingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteJobTaggingOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteJobTaggingInput, DeleteJobTaggingOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteMultiRegionAccessPoint(input: DeleteMultiRegionAccessPointInput) async throws -> DeleteMultiRegionAccessPointOutput {
        ...
        let operation = S3ControlClient.deleteMultiRegionAccessPointOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteMultiRegionAccessPointOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteMultiRegionAccessPointInput, DeleteMultiRegionAccessPointOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deletePublicAccessBlock(input: DeletePublicAccessBlockInput) async throws -> DeletePublicAccessBlockOutput {
        ...
        let operation = S3ControlClient.deletePublicAccessBlockOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeletePublicAccessBlockOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeletePublicAccessBlockInput, DeletePublicAccessBlockOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteStorageLensConfiguration(input: DeleteStorageLensConfigurationInput) async throws -> DeleteStorageLensConfigurationOutput {
        ...
        let operation = S3ControlClient.deleteStorageLensConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteStorageLensConfigurationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteStorageLensConfigurationInput, DeleteStorageLensConfigurationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteStorageLensConfigurationTagging(input: DeleteStorageLensConfigurationTaggingInput) async throws -> DeleteStorageLensConfigurationTaggingOutput {
        ...
        let operation = S3ControlClient.deleteStorageLensConfigurationTaggingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteStorageLensConfigurationTaggingOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteStorageLensConfigurationTaggingInput, DeleteStorageLensConfigurationTaggingOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func deleteStorageLensGroup(input: DeleteStorageLensGroupInput) async throws -> DeleteStorageLensGroupOutput {
        ...
        let operation = S3ControlClient.deleteStorageLensGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteStorageLensGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteStorageLensGroupInput, DeleteStorageLensGroupOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func describeJob(input: DescribeJobInput) async throws -> DescribeJobOutput {
        ...
        let operation = S3ControlClient.describeJobOperation
        let context = Smithy.ContextBuilder()
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeJobInput, DescribeJobOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func describeMultiRegionAccessPointOperation(input: DescribeMultiRegionAccessPointOperationInput) async throws -> DescribeMultiRegionAccessPointOperationOutput {
        ...
        let operation = S3ControlClient.describeMultiRegionAccessPointOperationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeMultiRegionAccessPointOperationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeMultiRegionAccessPointOperationInput, DescribeMultiRegionAccessPointOperationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func dissociateAccessGrantsIdentityCenter(input: DissociateAccessGrantsIdentityCenterInput) async throws -> DissociateAccessGrantsIdentityCenterOutput {
        ...
        let operation = S3ControlClient.dissociateAccessGrantsIdentityCenterOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DissociateAccessGrantsIdentityCenterOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DissociateAccessGrantsIdentityCenterInput, DissociateAccessGrantsIdentityCenterOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessGrant(input: GetAccessGrantInput) async throws -> GetAccessGrantOutput {
        ...
        let operation = S3ControlClient.getAccessGrantOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessGrantInput, GetAccessGrantOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessGrantsInstance(input: GetAccessGrantsInstanceInput) async throws -> GetAccessGrantsInstanceOutput {
        ...
        let operation = S3ControlClient.getAccessGrantsInstanceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessGrantsInstanceOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessGrantsInstanceInput, GetAccessGrantsInstanceOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessGrantsInstanceForPrefix(input: GetAccessGrantsInstanceForPrefixInput) async throws -> GetAccessGrantsInstanceForPrefixOutput {
        ...
        let operation = S3ControlClient.getAccessGrantsInstanceForPrefixOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessGrantsInstanceForPrefixOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessGrantsInstanceForPrefixInput, GetAccessGrantsInstanceForPrefixOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessGrantsInstanceResourcePolicy(input: GetAccessGrantsInstanceResourcePolicyInput) async throws -> GetAccessGrantsInstanceResourcePolicyOutput {
        ...
        let operation = S3ControlClient.getAccessGrantsInstanceResourcePolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessGrantsInstanceResourcePolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessGrantsInstanceResourcePolicyInput, GetAccessGrantsInstanceResourcePolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessGrantsLocation(input: GetAccessGrantsLocationInput) async throws -> GetAccessGrantsLocationOutput {
        ...
        let operation = S3ControlClient.getAccessGrantsLocationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessGrantsLocationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessGrantsLocationInput, GetAccessGrantsLocationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessPoint(input: GetAccessPointInput) async throws -> GetAccessPointOutput {
        ...
        let operation = S3ControlClient.getAccessPointOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessPointInput, GetAccessPointOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessPointConfigurationForObjectLambda(input: GetAccessPointConfigurationForObjectLambdaInput) async throws -> GetAccessPointConfigurationForObjectLambdaOutput {
        ...
        let operation = S3ControlClient.getAccessPointConfigurationForObjectLambdaOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessPointConfigurationForObjectLambdaOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessPointConfigurationForObjectLambdaInput, GetAccessPointConfigurationForObjectLambdaOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessPointForObjectLambda(input: GetAccessPointForObjectLambdaInput) async throws -> GetAccessPointForObjectLambdaOutput {
        ...
        let operation = S3ControlClient.getAccessPointForObjectLambdaOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessPointForObjectLambdaOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessPointForObjectLambdaInput, GetAccessPointForObjectLambdaOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessPointPolicy(input: GetAccessPointPolicyInput) async throws -> GetAccessPointPolicyOutput {
        ...
        let operation = S3ControlClient.getAccessPointPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessPointPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessPointPolicyInput, GetAccessPointPolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessPointPolicyForObjectLambda(input: GetAccessPointPolicyForObjectLambdaInput) async throws -> GetAccessPointPolicyForObjectLambdaOutput {
        ...
        let operation = S3ControlClient.getAccessPointPolicyForObjectLambdaOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessPointPolicyForObjectLambdaOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessPointPolicyForObjectLambdaInput, GetAccessPointPolicyForObjectLambdaOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessPointPolicyStatus(input: GetAccessPointPolicyStatusInput) async throws -> GetAccessPointPolicyStatusOutput {
        ...
        let operation = S3ControlClient.getAccessPointPolicyStatusOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessPointPolicyStatusOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessPointPolicyStatusInput, GetAccessPointPolicyStatusOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessPointPolicyStatusForObjectLambda(input: GetAccessPointPolicyStatusForObjectLambdaInput) async throws -> GetAccessPointPolicyStatusForObjectLambdaOutput {
        ...
        let operation = S3ControlClient.getAccessPointPolicyStatusForObjectLambdaOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessPointPolicyStatusForObjectLambdaOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessPointPolicyStatusForObjectLambdaInput, GetAccessPointPolicyStatusForObjectLambdaOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getAccessPointScope(input: GetAccessPointScopeInput) async throws -> GetAccessPointScopeOutput {
        ...
        let operation = S3ControlClient.getAccessPointScopeOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getAccessPointScope")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GetAccessPointScopeInput, GetAccessPointScopeOutput>(GetAccessPointScopeInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetAccessPointScopeInput, GetAccessPointScopeOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAccessPointScopeOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetAccessPointScopeOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetAccessPointScopeInput, GetAccessPointScopeOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetAccessPointScopeInput, GetAccessPointScopeOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccessPointScopeInput, GetAccessPointScopeOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetAccessPointScope")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func getBucket(input: GetBucketInput) async throws -> GetBucketOutput {
        ...
        let operation = S3ControlClient.getBucketOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetBucketOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBucketInput, GetBucketOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getBucketLifecycleConfiguration(input: GetBucketLifecycleConfigurationInput) async throws -> GetBucketLifecycleConfigurationOutput {
        ...
        let operation = S3ControlClient.getBucketLifecycleConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetBucketLifecycleConfigurationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBucketLifecycleConfigurationInput, GetBucketLifecycleConfigurationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getBucketPolicy(input: GetBucketPolicyInput) async throws -> GetBucketPolicyOutput {
        ...
        let operation = S3ControlClient.getBucketPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetBucketPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBucketPolicyInput, GetBucketPolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getBucketReplication(input: GetBucketReplicationInput) async throws -> GetBucketReplicationOutput {
        ...
        let operation = S3ControlClient.getBucketReplicationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetBucketReplicationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBucketReplicationInput, GetBucketReplicationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getBucketTagging(input: GetBucketTaggingInput) async throws -> GetBucketTaggingOutput {
        ...
        let operation = S3ControlClient.getBucketTaggingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetBucketTaggingOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBucketTaggingInput, GetBucketTaggingOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getBucketVersioning(input: GetBucketVersioningInput) async throws -> GetBucketVersioningOutput {
        ...
        let operation = S3ControlClient.getBucketVersioningOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetBucketVersioningOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBucketVersioningInput, GetBucketVersioningOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getDataAccess(input: GetDataAccessInput) async throws -> GetDataAccessOutput {
        ...
        let operation = S3ControlClient.getDataAccessOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetDataAccessOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDataAccessInput, GetDataAccessOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getJobTagging(input: GetJobTaggingInput) async throws -> GetJobTaggingOutput {
        ...
        let operation = S3ControlClient.getJobTaggingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetJobTaggingOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetJobTaggingInput, GetJobTaggingOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getMultiRegionAccessPoint(input: GetMultiRegionAccessPointInput) async throws -> GetMultiRegionAccessPointOutput {
        ...
        let operation = S3ControlClient.getMultiRegionAccessPointOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetMultiRegionAccessPointOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetMultiRegionAccessPointInput, GetMultiRegionAccessPointOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getMultiRegionAccessPointPolicy(input: GetMultiRegionAccessPointPolicyInput) async throws -> GetMultiRegionAccessPointPolicyOutput {
        ...
        let operation = S3ControlClient.getMultiRegionAccessPointPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetMultiRegionAccessPointPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetMultiRegionAccessPointPolicyInput, GetMultiRegionAccessPointPolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getMultiRegionAccessPointPolicyStatus(input: GetMultiRegionAccessPointPolicyStatusInput) async throws -> GetMultiRegionAccessPointPolicyStatusOutput {
        ...
        let operation = S3ControlClient.getMultiRegionAccessPointPolicyStatusOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetMultiRegionAccessPointPolicyStatusOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetMultiRegionAccessPointPolicyStatusInput, GetMultiRegionAccessPointPolicyStatusOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getMultiRegionAccessPointRoutes(input: GetMultiRegionAccessPointRoutesInput) async throws -> GetMultiRegionAccessPointRoutesOutput {
        ...
        let operation = S3ControlClient.getMultiRegionAccessPointRoutesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetMultiRegionAccessPointRoutesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetMultiRegionAccessPointRoutesInput, GetMultiRegionAccessPointRoutesOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getPublicAccessBlock(input: GetPublicAccessBlockInput) async throws -> GetPublicAccessBlockOutput {
        ...
        let operation = S3ControlClient.getPublicAccessBlockOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetPublicAccessBlockOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetPublicAccessBlockInput, GetPublicAccessBlockOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getStorageLensConfiguration(input: GetStorageLensConfigurationInput) async throws -> GetStorageLensConfigurationOutput {
        ...
        let operation = S3ControlClient.getStorageLensConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetStorageLensConfigurationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetStorageLensConfigurationInput, GetStorageLensConfigurationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getStorageLensConfigurationTagging(input: GetStorageLensConfigurationTaggingInput) async throws -> GetStorageLensConfigurationTaggingOutput {
        ...
        let operation = S3ControlClient.getStorageLensConfigurationTaggingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetStorageLensConfigurationTaggingOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetStorageLensConfigurationTaggingInput, GetStorageLensConfigurationTaggingOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func getStorageLensGroup(input: GetStorageLensGroupInput) async throws -> GetStorageLensGroupOutput {
        ...
        let operation = S3ControlClient.getStorageLensGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetStorageLensGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetStorageLensGroupInput, GetStorageLensGroupOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listAccessGrants(input: ListAccessGrantsInput) async throws -> ListAccessGrantsOutput {
        ...
        let operation = S3ControlClient.listAccessGrantsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAccessGrantsInput, ListAccessGrantsOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listAccessGrantsInstances(input: ListAccessGrantsInstancesInput) async throws -> ListAccessGrantsInstancesOutput {
        ...
        let operation = S3ControlClient.listAccessGrantsInstancesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAccessGrantsInstancesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAccessGrantsInstancesInput, ListAccessGrantsInstancesOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listAccessGrantsLocations(input: ListAccessGrantsLocationsInput) async throws -> ListAccessGrantsLocationsOutput {
        ...
        let operation = S3ControlClient.listAccessGrantsLocationsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAccessGrantsLocationsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAccessGrantsLocationsInput, ListAccessGrantsLocationsOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listAccessPoints(input: ListAccessPointsInput) async throws -> ListAccessPointsOutput {
        ...
        let operation = S3ControlClient.listAccessPointsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAccessPointsInput, ListAccessPointsOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listAccessPointsForDirectoryBuckets(input: ListAccessPointsForDirectoryBucketsInput) async throws -> ListAccessPointsForDirectoryBucketsOutput {
        ...
        let operation = S3ControlClient.listAccessPointsForDirectoryBucketsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listAccessPointsForDirectoryBuckets")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ListAccessPointsForDirectoryBucketsInput, ListAccessPointsForDirectoryBucketsOutput>(ListAccessPointsForDirectoryBucketsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListAccessPointsForDirectoryBucketsInput, ListAccessPointsForDirectoryBucketsOutput>())
        builder.serialize(ClientRuntime.HeaderMiddleware<ListAccessPointsForDirectoryBucketsInput, ListAccessPointsForDirectoryBucketsOutput>(ListAccessPointsForDirectoryBucketsInput.headerProvider(_:)))
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("S3 Control", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(accountId: input.accountId, endpoint: configuredEndpoint, region: config.region, requiresAccountId: true, useArnRegion: config.useArnRegion, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false, useS3ExpressControlEndpoint: true)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAccessPointsForDirectoryBucketsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListAccessPointsForDirectoryBucketsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListAccessPointsForDirectoryBucketsInput, ListAccessPointsForDirectoryBucketsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListAccessPointsForDirectoryBucketsInput, ListAccessPointsForDirectoryBucketsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAccessPointsForDirectoryBucketsInput, ListAccessPointsForDirectoryBucketsOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListAccessPointsForDirectoryBuckets")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func listAccessPointsForObjectLambda(input: ListAccessPointsForObjectLambdaInput) async throws -> ListAccessPointsForObjectLambdaOutput {
        ...
        let operation = S3ControlClient.listAccessPointsForObjectLambdaOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAccessPointsForObjectLambdaOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAccessPointsForObjectLambdaInput, ListAccessPointsForObjectLambdaOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listCallerAccessGrants(input: ListCallerAccessGrantsInput) async throws -> ListCallerAccessGrantsOutput {
        ...
        let operation = S3ControlClient.listCallerAccessGrantsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListCallerAccessGrantsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListCallerAccessGrantsInput, ListCallerAccessGrantsOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listJobs(input: ListJobsInput) async throws -> ListJobsOutput {
        ...
        let operation = S3ControlClient.listJobsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListJobsInput, ListJobsOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listMultiRegionAccessPoints(input: ListMultiRegionAccessPointsInput) async throws -> ListMultiRegionAccessPointsOutput {
        ...
        let operation = S3ControlClient.listMultiRegionAccessPointsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListMultiRegionAccessPointsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListMultiRegionAccessPointsInput, ListMultiRegionAccessPointsOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listRegionalBuckets(input: ListRegionalBucketsInput) async throws -> ListRegionalBucketsOutput {
        ...
        let operation = S3ControlClient.listRegionalBucketsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("S3 Control", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(accountId: input.accountId, endpoint: configuredEndpoint, outpostId: input.outpostId, region: config.region, requiresAccountId: true, useArnRegion: config.useArnRegion, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListRegionalBucketsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListRegionalBucketsInput, ListRegionalBucketsOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listStorageLensConfigurations(input: ListStorageLensConfigurationsInput) async throws -> ListStorageLensConfigurationsOutput {
        ...
        let operation = S3ControlClient.listStorageLensConfigurationsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListStorageLensConfigurationsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListStorageLensConfigurationsInput, ListStorageLensConfigurationsOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listStorageLensGroups(input: ListStorageLensGroupsInput) async throws -> ListStorageLensGroupsOutput {
        ...
        let operation = S3ControlClient.listStorageLensGroupsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListStorageLensGroupsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListStorageLensGroupsInput, ListStorageLensGroupsOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput {
        ...
        let operation = S3ControlClient.listTagsForResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("S3 Control", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(accountId: input.accountId, endpoint: configuredEndpoint, region: config.region, requiresAccountId: true, resourceArn: input.resourceArn, useArnRegion: config.useArnRegion, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListTagsForResourceOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListTagsForResourceOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putAccessGrantsInstanceResourcePolicy(input: PutAccessGrantsInstanceResourcePolicyInput) async throws -> PutAccessGrantsInstanceResourcePolicyOutput {
        ...
        let operation = S3ControlClient.putAccessGrantsInstanceResourcePolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutAccessGrantsInstanceResourcePolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccessGrantsInstanceResourcePolicyInput, PutAccessGrantsInstanceResourcePolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putAccessPointConfigurationForObjectLambda(input: PutAccessPointConfigurationForObjectLambdaInput) async throws -> PutAccessPointConfigurationForObjectLambdaOutput {
        ...
        let operation = S3ControlClient.putAccessPointConfigurationForObjectLambdaOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutAccessPointConfigurationForObjectLambdaOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccessPointConfigurationForObjectLambdaInput, PutAccessPointConfigurationForObjectLambdaOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putAccessPointPolicy(input: PutAccessPointPolicyInput) async throws -> PutAccessPointPolicyOutput {
        ...
        let operation = S3ControlClient.putAccessPointPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutAccessPointPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccessPointPolicyInput, PutAccessPointPolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putAccessPointPolicyForObjectLambda(input: PutAccessPointPolicyForObjectLambdaInput) async throws -> PutAccessPointPolicyForObjectLambdaOutput {
        ...
        let operation = S3ControlClient.putAccessPointPolicyForObjectLambdaOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutAccessPointPolicyForObjectLambdaOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccessPointPolicyForObjectLambdaInput, PutAccessPointPolicyForObjectLambdaOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putAccessPointScope(input: PutAccessPointScopeInput) async throws -> PutAccessPointScopeOutput {
        ...
        let operation = S3ControlClient.putAccessPointScopeOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "putAccessPointScope")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<PutAccessPointScopeInput, PutAccessPointScopeOutput>(PutAccessPointScopeInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<PutAccessPointScopeInput, PutAccessPointScopeOutput>())
        builder.serialize(ClientRuntime.HeaderMiddleware<PutAccessPointScopeInput, PutAccessPointScopeOutput>(PutAccessPointScopeInput.headerProvider(_:)))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutAccessPointScopeInput, PutAccessPointScopeOutput>(contentType: "application/xml"))
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutAccessPointScopeOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<PutAccessPointScopeOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<PutAccessPointScopeInput, PutAccessPointScopeOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<PutAccessPointScopeInput, PutAccessPointScopeOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccessPointScopeInput, PutAccessPointScopeOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "PutAccessPointScope")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func putBucketLifecycleConfiguration(input: PutBucketLifecycleConfigurationInput) async throws -> PutBucketLifecycleConfigurationOutput {
        ...
        let operation = S3ControlClient.putBucketLifecycleConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutBucketLifecycleConfigurationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutBucketLifecycleConfigurationInput, PutBucketLifecycleConfigurationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putBucketPolicy(input: PutBucketPolicyInput) async throws -> PutBucketPolicyOutput {
        ...
        let operation = S3ControlClient.putBucketPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutBucketPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutBucketPolicyInput, PutBucketPolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putBucketReplication(input: PutBucketReplicationInput) async throws -> PutBucketReplicationOutput {
        ...
        let operation = S3ControlClient.putBucketReplicationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutBucketReplicationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutBucketReplicationInput, PutBucketReplicationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putBucketTagging(input: PutBucketTaggingInput) async throws -> PutBucketTaggingOutput {
        ...
        let operation = S3ControlClient.putBucketTaggingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutBucketTaggingOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutBucketTaggingInput, PutBucketTaggingOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putBucketVersioning(input: PutBucketVersioningInput) async throws -> PutBucketVersioningOutput {
        ...
        let operation = S3ControlClient.putBucketVersioningOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutBucketVersioningOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutBucketVersioningInput, PutBucketVersioningOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putJobTagging(input: PutJobTaggingInput) async throws -> PutJobTaggingOutput {
        ...
        let operation = S3ControlClient.putJobTaggingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutJobTaggingOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutJobTaggingInput, PutJobTaggingOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putMultiRegionAccessPointPolicy(input: PutMultiRegionAccessPointPolicyInput) async throws -> PutMultiRegionAccessPointPolicyOutput {
        ...
        let operation = S3ControlClient.putMultiRegionAccessPointPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutMultiRegionAccessPointPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutMultiRegionAccessPointPolicyInput, PutMultiRegionAccessPointPolicyOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putPublicAccessBlock(input: PutPublicAccessBlockInput) async throws -> PutPublicAccessBlockOutput {
        ...
        let operation = S3ControlClient.putPublicAccessBlockOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutPublicAccessBlockOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutPublicAccessBlockInput, PutPublicAccessBlockOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putStorageLensConfiguration(input: PutStorageLensConfigurationInput) async throws -> PutStorageLensConfigurationOutput {
        ...
        let operation = S3ControlClient.putStorageLensConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutStorageLensConfigurationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutStorageLensConfigurationInput, PutStorageLensConfigurationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func putStorageLensConfigurationTagging(input: PutStorageLensConfigurationTaggingInput) async throws -> PutStorageLensConfigurationTaggingOutput {
        ...
        let operation = S3ControlClient.putStorageLensConfigurationTaggingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutStorageLensConfigurationTaggingOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutStorageLensConfigurationTaggingInput, PutStorageLensConfigurationTaggingOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func submitMultiRegionAccessPointRoutes(input: SubmitMultiRegionAccessPointRoutesInput) async throws -> SubmitMultiRegionAccessPointRoutesOutput {
        ...
        let operation = S3ControlClient.submitMultiRegionAccessPointRoutesOperation
        let context = Smithy.ContextBuilder()
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SubmitMultiRegionAccessPointRoutesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SubmitMultiRegionAccessPointRoutesInput, SubmitMultiRegionAccessPointRoutesOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput {
        ...
        let operation = S3ControlClient.tagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TagResourceInput, TagResourceOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput {
        ...
        let operation = S3ControlClient.untagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UntagResourceInput, UntagResourceOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func updateAccessGrantsLocation(input: UpdateAccessGrantsLocationInput) async throws -> UpdateAccessGrantsLocationOutput {
        ...
        let operation = S3ControlClient.updateAccessGrantsLocationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateAccessGrantsLocationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateAccessGrantsLocationInput, UpdateAccessGrantsLocationOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func updateJobPriority(input: UpdateJobPriorityInput) async throws -> UpdateJobPriorityOutput {
        ...
        let operation = S3ControlClient.updateJobPriorityOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateJobPriorityOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateJobPriorityInput, UpdateJobPriorityOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func updateJobStatus(input: UpdateJobStatusInput) async throws -> UpdateJobStatusOutput {
        ...
        let operation = S3ControlClient.updateJobStatusOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateJobStatusOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateJobStatusInput, UpdateJobStatusOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
    ...
    public func updateStorageLensGroup(input: UpdateStorageLensGroupInput) async throws -> UpdateStorageLensGroupOutput {
        ...
        let operation = S3ControlClient.updateStorageLensGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateStorageLensGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateStorageLensGroupInput, UpdateStorageLensGroupOutput>(serviceID: serviceName, version: S3ControlClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "S3Control")
