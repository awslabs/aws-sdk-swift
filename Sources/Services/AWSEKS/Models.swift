...
extension ListAccessEntriesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAccessEntriesOutput {
        ...
        value.accessEntries = try reader["accessEntries"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListAddonsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAddonsOutput {
        ...
        value.addons = try reader["addons"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListClustersOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListClustersOutput {
        ...
        value.clusters = try reader["clusters"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListFargateProfilesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListFargateProfilesOutput {
        ...
        value.fargateProfileNames = try reader["fargateProfileNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListNodegroupsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListNodegroupsOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.nodegroups = try reader["nodegroups"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListUpdatesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListUpdatesOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.updateIds = try reader["updateIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension UnsupportedAvailabilityZoneException {
    ...
    static func makeError(baseError: AWSClientRuntime.RestJSONError) throws -> UnsupportedAvailabilityZoneException {
        ...
        value.properties.message = try reader["message"].readIfPresent()
        value.properties.nodegroupName = try reader["nodegroupName"].readIfPresent()
        value.properties.validZones = try reader["validZones"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.httpResponse = baseError.httpResponse
        value.requestID = baseError.requestID
        value.message = baseError.message
        return value
...
extension EKSClientTypes.AssociatedAccessPolicy {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EKSClientTypes.AssociatedAccessPolicy {
        ...
        value.associatedAt = try reader["associatedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension EKSClientTypes.AccessScope {
    ...
    static func write(value: EKSClientTypes.AccessScope?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["namespaces"].writeList(value.namespaces, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["type"].write(value.type)
    }
...
extension EKSClientTypes.AccessEntry {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EKSClientTypes.AccessEntry {
        ...
        value.clusterName = try reader["clusterName"].readIfPresent()
        value.principalArn = try reader["principalArn"].readIfPresent()
        value.kubernetesGroups = try reader["kubernetesGroups"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension EKSClientTypes.ConnectorConfigResponse {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EKSClientTypes.ConnectorConfigResponse {
        ...
        value.activationExpiry = try reader["activationExpiry"].readTimestampIfPresent(format: .epochSeconds)
...
extension EKSClientTypes.LogSetup {
    ...
    static func write(value: EKSClientTypes.LogSetup?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["types"].writeList(value.types, memberWritingClosure: EKSClientTypes.LogType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }

    static func read(from reader: SmithyJSON.Reader) throws -> EKSClientTypes.LogSetup {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = EKSClientTypes.LogSetup()
        value.types = try reader["types"].readListIfPresent(memberReadingClosure: EKSClientTypes.LogType.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension EKSClientTypes.EksAnywhereSubscription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EKSClientTypes.EksAnywhereSubscription {
        ...
        value.arn = try reader["arn"].readIfPresent()
        value.createdAt = try reader["createdAt"].readTimestampIfPresent(format: .epochSeconds)
        value.effectiveDate = try reader["effectiveDate"].readTimestampIfPresent(format: .epochSeconds)
        value.expirationDate = try reader["expirationDate"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.licenseArns = try reader["licenseArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension EKSClientTypes.RemoteAccessConfig {
    ...
    static func write(value: EKSClientTypes.RemoteAccessConfig?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["sourceSecurityGroups"].writeList(value.sourceSecurityGroups, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EKSClientTypes.RemoteAccessConfig {
        ...
        value.sourceSecurityGroups = try reader["sourceSecurityGroups"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension EKSClientTypes.Compatibility {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EKSClientTypes.Compatibility {
        ...
        value.platformVersions = try reader["platformVersions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension EKSClientTypes.Insight {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EKSClientTypes.Insight {
        ...
        value.lastRefreshTime = try reader["lastRefreshTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lastTransitionTime = try reader["lastTransitionTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.additionalInfo = try reader["additionalInfo"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension EKSClientTypes.ClientStat {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EKSClientTypes.ClientStat {
        ...
        value.lastRequestTime = try reader["lastRequestTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
