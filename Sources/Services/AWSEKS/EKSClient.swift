...
extension EKSClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> EKSClient.EKSClientConfiguration {
        let clientConfiguration = try await EKSClient.EKSClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> EKSClient {
            let configuration = try await resolve(plugins: self.plugins)
            return EKSClient(config: configuration)
        }
    }
...
extension EKSClient.EKSClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
