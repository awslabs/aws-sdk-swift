...
extension AssociateLicenseOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AssociateLicenseOutput {
...
extension GrafanaClientTypes.AuthenticationDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GrafanaClientTypes.AuthenticationDescription {
        ...
        value.providers = try reader["providers"].readListIfPresent(memberReadingClosure: GrafanaClientTypes.AuthenticationProviderTypes.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateWorkspaceApiKeyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateWorkspaceApiKeyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateWorkspaceInput {
    ...
    static func write(value: CreateWorkspaceInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["authenticationProviders"].writeList(value.authenticationProviders, memberWritingClosure: GrafanaClientTypes.AuthenticationProviderTypes.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["workspaceDataSources"].writeList(value.workspaceDataSources, memberWritingClosure: GrafanaClientTypes.DataSourceType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["workspaceDescription"].write(value.workspaceDescription)
        try writer["workspaceName"].write(value.workspaceName)
        try writer["workspaceNotificationDestinations"].writeList(value.workspaceNotificationDestinations, memberWritingClosure: GrafanaClientTypes.NotificationDestinationType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["workspaceOrganizationalUnits"].writeList(value.workspaceOrganizationalUnits, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DeleteWorkspaceApiKeyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteWorkspaceApiKeyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeWorkspaceAuthenticationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeWorkspaceAuthenticationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeWorkspaceConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeWorkspaceConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DisassociateLicenseOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DisassociateLicenseOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListVersionsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListVersionsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = ListVersionsOutput()
        value.grafanaVersions = try reader["grafanaVersions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension GrafanaClientTypes.NetworkAccessConfiguration {
    ...
    static func write(value: GrafanaClientTypes.NetworkAccessConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["vpceIds"].writeList(value.vpceIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GrafanaClientTypes.NetworkAccessConfiguration {
        ...
        value.prefixListIds = try reader["prefixListIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.vpceIds = try reader["vpceIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GrafanaClientTypes.RoleValues {
    ...
    static func write(value: GrafanaClientTypes.RoleValues?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["admin"].writeList(value.admin, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["editor"].writeList(value.editor, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GrafanaClientTypes.RoleValues {
        ...
        value.editor = try reader["editor"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.admin = try reader["admin"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GrafanaClientTypes.SamlConfiguration {
    ...
    static func write(value: GrafanaClientTypes.SamlConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["allowedOrganizations"].writeList(value.allowedOrganizations, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GrafanaClientTypes.SamlConfiguration {
        ...
        value.allowedOrganizations = try reader["allowedOrganizations"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension UpdatePermissionsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdatePermissionsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateWorkspaceAuthenticationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateWorkspaceAuthenticationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateWorkspaceConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateWorkspaceConfigurationOutput {
...
extension UpdateWorkspaceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateWorkspaceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GrafanaClientTypes.WorkspaceDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GrafanaClientTypes.WorkspaceDescription {
        ...
        value.dataSources = try reader["dataSources"].readListIfPresent(memberReadingClosure: GrafanaClientTypes.DataSourceType.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.description = try reader["description"].readIfPresent()
        value.endpoint = try reader["endpoint"].readIfPresent()
        value.grafanaVersion = try reader["grafanaVersion"].readIfPresent()
        value.id = try reader["id"].readIfPresent()
        value.modified = try reader["modified"].readTimestampIfPresent(format: .epochSeconds)
        value.name = try reader["name"].readIfPresent()
        value.organizationRoleName = try reader["organizationRoleName"].readIfPresent()
        value.notificationDestinations = try reader["notificationDestinations"].readListIfPresent(memberReadingClosure: GrafanaClientTypes.NotificationDestinationType.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.licenseExpiration = try reader["licenseExpiration"].readTimestampIfPresent(format: .epochSeconds)
        value.freeTrialExpiration = try reader["freeTrialExpiration"].readTimestampIfPresent(format: .epochSeconds)
