...
extension GrafanaClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> GrafanaClient.GrafanaClientConfiguration {
        let clientConfiguration = try await GrafanaClient.GrafanaClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> GrafanaClient {
            let configuration = try await resolve(plugins: self.plugins)
            return GrafanaClient(config: configuration)
        }
    }
...
extension GrafanaClient.GrafanaClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
