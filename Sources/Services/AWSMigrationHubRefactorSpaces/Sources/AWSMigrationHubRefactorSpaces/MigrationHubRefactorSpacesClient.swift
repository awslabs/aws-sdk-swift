...
public final class MigrationHubRefactorSpacesClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: MigrationHubRefactorSpacesClient.MigrationHubRefactorSpacesClientConfig) instead")
    public convenience init(config: MigrationHubRefactorSpacesClient.MigrationHubRefactorSpacesClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try MigrationHubRefactorSpacesClient.MigrationHubRefactorSpacesClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await MigrationHubRefactorSpacesClient.MigrationHubRefactorSpacesClientConfig()
        self.init(config: config)
    }
}
...
extension MigrationHubRefactorSpacesClient {
    ...
    /// Client configuration for MigrationHubRefactorSpacesClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct MigrationHubRefactorSpacesClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Migration Hub Refactor Spaces")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultMigrationHubRefactorSpacesAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: MigrationHubRefactorSpacesClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use MigrationHubRefactorSpacesClientConfig instead. This class will be removed in a future version.")
    public final class MigrationHubRefactorSpacesClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> MigrationHubRefactorSpacesClientConfig {
            return try MigrationHubRefactorSpacesClientConfig(
...
extension MigrationHubRefactorSpacesClient {
    ...
    public func createApplication(input: CreateApplicationInput) async throws -> CreateApplicationOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Migration Hub Refactor Spaces"))
