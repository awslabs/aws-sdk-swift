...
public class MigrationHubRefactorSpacesClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? MigrationHubRefactorSpacesClient.MigrationHubRefactorSpacesClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? MigrationHubRefactorSpacesClient.MigrationHubRefactorSpacesClientConfiguration {
            config.authSchemeResolver = DefaultMigrationHubRefactorSpacesAuthSchemeResolver()
...
public class MigrationHubRefactorSpacesClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: MigrationHubRefactorSpacesAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
