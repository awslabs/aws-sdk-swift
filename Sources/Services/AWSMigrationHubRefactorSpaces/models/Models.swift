...
extension MigrationHubRefactorSpacesClientTypes.EnvironmentVpc {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MigrationHubRefactorSpacesClientTypes.EnvironmentVpc {
        ...
        value.cidrBlocks = try reader["CidrBlocks"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension MigrationHubRefactorSpacesClientTypes.ErrorResponse {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MigrationHubRefactorSpacesClientTypes.ErrorResponse {
        ...
        value.additionalDetails = try reader["AdditionalDetails"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension GetRouteOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetRouteOutput {
        ...
        value.lastUpdatedTime = try reader["LastUpdatedTime"].readTimestampIfPresent(format: .epochSeconds)
        value.methods = try reader["Methods"].readListIfPresent(memberReadingClosure: MigrationHubRefactorSpacesClientTypes.HttpMethod.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.ownerAccountId = try reader["OwnerAccountId"].readIfPresent()
        value.pathResourceToId = try reader["PathResourceToId"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.routeId = try reader["RouteId"].readIfPresent()
        value.routeType = try reader["RouteType"].readIfPresent()
        value.serviceId = try reader["ServiceId"].readIfPresent()
