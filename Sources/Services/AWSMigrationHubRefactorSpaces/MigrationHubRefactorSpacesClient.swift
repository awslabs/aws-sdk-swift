...
extension MigrationHubRefactorSpacesClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MigrationHubRefactorSpacesClient.MigrationHubRefactorSpacesClientConfiguration {
        let clientConfiguration = try await MigrationHubRefactorSpacesClient.MigrationHubRefactorSpacesClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MigrationHubRefactorSpacesClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MigrationHubRefactorSpacesClient(config: configuration)
        }
    }
...
extension MigrationHubRefactorSpacesClient.MigrationHubRefactorSpacesClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
