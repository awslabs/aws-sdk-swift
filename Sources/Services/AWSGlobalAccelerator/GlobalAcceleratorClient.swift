...
extension GlobalAcceleratorClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> GlobalAcceleratorClient.GlobalAcceleratorClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> GlobalAcceleratorClient {
            let configuration = try await resolve(plugins: self.plugins)
            return GlobalAcceleratorClient(config: configuration)
        }
    }
...
extension GlobalAcceleratorClient.GlobalAcceleratorClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
