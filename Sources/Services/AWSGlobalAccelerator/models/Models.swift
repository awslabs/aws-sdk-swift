...
extension GlobalAcceleratorClientTypes.Accelerator {
    ...
    static func write(value: GlobalAcceleratorClientTypes.Accelerator?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["DualStackDnsName"].write(value.dualStackDnsName)
        try writer["Enabled"].write(value.enabled)
        try writer["Events"].writeList(value.events, memberWritingClosure: GlobalAcceleratorClientTypes.AcceleratorEvent.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["IpAddressType"].write(value.ipAddressType)
        try writer["IpSets"].writeList(value.ipSets, memberWritingClosure: GlobalAcceleratorClientTypes.IpSet.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GlobalAcceleratorClientTypes.AcceleratorAttributes {
    ...
    static func write(value: GlobalAcceleratorClientTypes.AcceleratorAttributes?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension GlobalAcceleratorClientTypes.AcceleratorEvent {
    ...
    static func write(value: GlobalAcceleratorClientTypes.AcceleratorEvent?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension AddCustomRoutingEndpointsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AddCustomRoutingEndpointsOutput {
...
extension AddEndpointsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AddEndpointsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension AdvertiseByoipCidrOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AdvertiseByoipCidrOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension AllowCustomRoutingTrafficInput {
    ...
    static func write(value: AllowCustomRoutingTrafficInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["DestinationAddresses"].writeList(value.destinationAddresses, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["DestinationPorts"].writeList(value.destinationPorts, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["EndpointGroupArn"].write(value.endpointGroupArn)
...
extension AllowCustomRoutingTrafficOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AllowCustomRoutingTrafficOutput {
...
extension GlobalAcceleratorClientTypes.Attachment {
    ...
    static func write(value: GlobalAcceleratorClientTypes.Attachment?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AttachmentArn"].write(value.attachmentArn)
        try writer["CreatedTime"].writeTimestamp(value.createdTime, format: .epochSeconds)
        try writer["LastModifiedTime"].writeTimestamp(value.lastModifiedTime, format: .epochSeconds)
        try writer["Name"].write(value.name)
        try writer["Principals"].writeList(value.principals, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GlobalAcceleratorClientTypes.Attachment {
        ...
        value.name = try reader["Name"].readIfPresent()
        value.principals = try reader["Principals"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension GlobalAcceleratorClientTypes.ByoipCidr {
    ...
    static func write(value: GlobalAcceleratorClientTypes.ByoipCidr?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Cidr"].write(value.cidr)
        try writer["Events"].writeList(value.events, memberWritingClosure: GlobalAcceleratorClientTypes.ByoipCidrEvent.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GlobalAcceleratorClientTypes.ByoipCidrEvent {
    ...
    static func write(value: GlobalAcceleratorClientTypes.ByoipCidrEvent?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Message"].write(value.message)
        try writer["Timestamp"].writeTimestamp(value.timestamp, format: .epochSeconds)
    }
...
extension GlobalAcceleratorClientTypes.CidrAuthorizationContext {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GlobalAcceleratorClientTypes.CidrAuthorizationContext {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = GlobalAcceleratorClientTypes.CidrAuthorizationContext()
        value.message = try reader["Message"].readIfPresent()
...
extension CreateAcceleratorInput {
    ...
    static func write(value: CreateAcceleratorInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["IpAddressType"].write(value.ipAddressType)
        try writer["IpAddresses"].writeList(value.ipAddresses, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Name"].write(value.name)
...
extension CreateAcceleratorOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateAcceleratorOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateCrossAccountAttachmentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCrossAccountAttachmentOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateCustomRoutingAcceleratorOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCustomRoutingAcceleratorOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateCustomRoutingEndpointGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCustomRoutingEndpointGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateCustomRoutingListenerOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCustomRoutingListenerOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateEndpointGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateEndpointGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GlobalAcceleratorClientTypes.CrossAccountResource {
    ...
    static func write(value: GlobalAcceleratorClientTypes.CrossAccountResource?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AttachmentArn"].write(value.attachmentArn)
        try writer["Cidr"].write(value.cidr)
        try writer["EndpointId"].write(value.endpointId)
...
extension GlobalAcceleratorClientTypes.CustomRoutingAccelerator {
    ...
    static func write(value: GlobalAcceleratorClientTypes.CustomRoutingAccelerator?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AcceleratorArn"].write(value.acceleratorArn)
        try writer["CreatedTime"].writeTimestamp(value.createdTime, format: .epochSeconds)
        try writer["DnsName"].write(value.dnsName)
...
extension GlobalAcceleratorClientTypes.CustomRoutingAcceleratorAttributes {
    ...
    static func write(value: GlobalAcceleratorClientTypes.CustomRoutingAcceleratorAttributes?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["FlowLogsEnabled"].write(value.flowLogsEnabled)
        try writer["FlowLogsS3Bucket"].write(value.flowLogsS3Bucket)
        try writer["FlowLogsS3Prefix"].write(value.flowLogsS3Prefix)
...
extension GlobalAcceleratorClientTypes.CustomRoutingDestinationConfiguration {
    ...
    static func write(value: GlobalAcceleratorClientTypes.CustomRoutingDestinationConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Protocols"].writeList(value.protocols, memberWritingClosure: GlobalAcceleratorClientTypes.CustomRoutingProtocol.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ToPort"].write(value.toPort)
    }

    static func read(from reader: SmithyJSON.Reader) throws -> GlobalAcceleratorClientTypes.CustomRoutingDestinationConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = GlobalAcceleratorClientTypes.CustomRoutingDestinationConfiguration()
        value.fromPort = try reader["FromPort"].readIfPresent()
        value.toPort = try reader["ToPort"].readIfPresent()
        value.protocols = try reader["Protocols"].readListIfPresent(memberReadingClosure: GlobalAcceleratorClientTypes.CustomRoutingProtocol.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GlobalAcceleratorClientTypes.CustomRoutingDestinationDescription {
    ...
    static func write(value: GlobalAcceleratorClientTypes.CustomRoutingDestinationDescription?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["FromPort"].write(value.fromPort)
        try writer["Protocols"].writeList(value.protocols, memberWritingClosure: GlobalAcceleratorClientTypes.ModelProtocol.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ToPort"].write(value.toPort)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GlobalAcceleratorClientTypes.CustomRoutingDestinationDescription {
        ...
        value.fromPort = try reader["FromPort"].readIfPresent()
        value.toPort = try reader["ToPort"].readIfPresent()
        value.protocols = try reader["Protocols"].readListIfPresent(memberReadingClosure: GlobalAcceleratorClientTypes.ModelProtocol.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GlobalAcceleratorClientTypes.CustomRoutingEndpointConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GlobalAcceleratorClientTypes.CustomRoutingEndpointConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = GlobalAcceleratorClientTypes.CustomRoutingEndpointConfiguration()
        value.endpointId = try reader["EndpointId"].readIfPresent()
        value.attachmentArn = try reader["AttachmentArn"].readIfPresent()
        return value
    }
...
extension GlobalAcceleratorClientTypes.CustomRoutingEndpointDescription {
    ...
    static func write(value: GlobalAcceleratorClientTypes.CustomRoutingEndpointDescription?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["EndpointId"].write(value.endpointId)
    }
...
extension GlobalAcceleratorClientTypes.CustomRoutingEndpointGroup {
    ...
    static func write(value: GlobalAcceleratorClientTypes.CustomRoutingEndpointGroup?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DestinationDescriptions"].writeList(value.destinationDescriptions, memberWritingClosure: GlobalAcceleratorClientTypes.CustomRoutingDestinationDescription.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["EndpointDescriptions"].writeList(value.endpointDescriptions, memberWritingClosure: GlobalAcceleratorClientTypes.CustomRoutingEndpointDescription.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["EndpointGroupArn"].write(value.endpointGroupArn)
        try writer["EndpointGroupRegion"].write(value.endpointGroupRegion)
    }
...
extension GlobalAcceleratorClientTypes.CustomRoutingListener {
    ...
    static func write(value: GlobalAcceleratorClientTypes.CustomRoutingListener?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ListenerArn"].write(value.listenerArn)
        try writer["PortRanges"].writeList(value.portRanges, memberWritingClosure: GlobalAcceleratorClientTypes.PortRange.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
...
extension DeleteAcceleratorOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteAcceleratorOutput {
...
extension DeleteCrossAccountAttachmentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCrossAccountAttachmentOutput {
...
extension DeleteCustomRoutingAcceleratorOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCustomRoutingAcceleratorOutput {
...
extension DeleteCustomRoutingEndpointGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCustomRoutingEndpointGroupOutput {
...
extension DeleteCustomRoutingListenerOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCustomRoutingListenerOutput {
...
extension DeleteEndpointGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteEndpointGroupOutput {
...
extension DenyCustomRoutingTrafficOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DenyCustomRoutingTrafficOutput {
...
extension DeprovisionByoipCidrOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeprovisionByoipCidrOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeAcceleratorAttributesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeAcceleratorAttributesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeAcceleratorOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeAcceleratorOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeCrossAccountAttachmentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCrossAccountAttachmentOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeCustomRoutingAcceleratorAttributesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCustomRoutingAcceleratorAttributesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeCustomRoutingAcceleratorOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCustomRoutingAcceleratorOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeCustomRoutingEndpointGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCustomRoutingEndpointGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeCustomRoutingListenerOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCustomRoutingListenerOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeEndpointGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeEndpointGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeListenerOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeListenerOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GlobalAcceleratorClientTypes.DestinationPortMapping {
    ...
    static func write(value: GlobalAcceleratorClientTypes.DestinationPortMapping?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AcceleratorArn"].write(value.acceleratorArn)
        try writer["AcceleratorSocketAddresses"].writeList(value.acceleratorSocketAddresses, memberWritingClosure: GlobalAcceleratorClientTypes.SocketAddress.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["DestinationSocketAddress"].write(value.destinationSocketAddress, with: GlobalAcceleratorClientTypes.SocketAddress.write(value:to:))
        try writer["DestinationTrafficState"].write(value.destinationTrafficState)
        try writer["EndpointGroupArn"].write(value.endpointGroupArn)
        try writer["EndpointGroupRegion"].write(value.endpointGroupRegion)
        try writer["EndpointId"].write(value.endpointId)
        try writer["IpAddressType"].write(value.ipAddressType)
...
extension GlobalAcceleratorClientTypes.EndpointConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GlobalAcceleratorClientTypes.EndpointConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = GlobalAcceleratorClientTypes.EndpointConfiguration()
        value.endpointId = try reader["EndpointId"].readIfPresent()
...
extension GlobalAcceleratorClientTypes.EndpointDescription {
    ...
    static func write(value: GlobalAcceleratorClientTypes.EndpointDescription?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ClientIPPreservationEnabled"].write(value.clientIPPreservationEnabled)
        try writer["EndpointId"].write(value.endpointId)
        try writer["HealthReason"].write(value.healthReason)
        try writer["HealthState"].write(value.healthState)
        try writer["Weight"].write(value.weight)
    }
...
extension GlobalAcceleratorClientTypes.EndpointGroup {
    ...
    static func write(value: GlobalAcceleratorClientTypes.EndpointGroup?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["EndpointDescriptions"].writeList(value.endpointDescriptions, memberWritingClosure: GlobalAcceleratorClientTypes.EndpointDescription.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["EndpointGroupArn"].write(value.endpointGroupArn)
        try writer["EndpointGroupRegion"].write(value.endpointGroupRegion)
        try writer["HealthCheckIntervalSeconds"].write(value.healthCheckIntervalSeconds)
        try writer["HealthCheckPath"].write(value.healthCheckPath)
...
extension GlobalAcceleratorClientTypes.EndpointIdentifier {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GlobalAcceleratorClientTypes.EndpointIdentifier {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = GlobalAcceleratorClientTypes.EndpointIdentifier()
        value.endpointId = try reader["EndpointId"].readIfPresent()
        value.clientIPPreservationEnabled = try reader["ClientIPPreservationEnabled"].readIfPresent()
        return value
    }
...
extension GlobalAcceleratorClientTypes.IpSet {
    ...
    static func write(value: GlobalAcceleratorClientTypes.IpSet?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["IpAddressFamily"].write(value.ipAddressFamily)
        try writer["IpAddresses"].writeList(value.ipAddresses, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GlobalAcceleratorClientTypes.IpSet {
        ...
        value.ipAddresses = try reader["IpAddresses"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ListAcceleratorsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAcceleratorsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListByoipCidrsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListByoipCidrsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCrossAccountAttachmentsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCrossAccountAttachmentsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCrossAccountResourceAccountsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCrossAccountResourceAccountsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = ListCrossAccountResourceAccountsOutput()
        value.resourceOwnerAwsAccountIds = try reader["ResourceOwnerAwsAccountIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListCrossAccountResourcesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCrossAccountResourcesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCustomRoutingAcceleratorsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCustomRoutingAcceleratorsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCustomRoutingEndpointGroupsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCustomRoutingEndpointGroupsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCustomRoutingListenersOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCustomRoutingListenersOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCustomRoutingPortMappingsByDestinationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCustomRoutingPortMappingsByDestinationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCustomRoutingPortMappingsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCustomRoutingPortMappingsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListEndpointGroupsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListEndpointGroupsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GlobalAcceleratorClientTypes.Listener {
    ...
    static func write(value: GlobalAcceleratorClientTypes.Listener?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ClientAffinity"].write(value.clientAffinity)
        try writer["ListenerArn"].write(value.listenerArn)
        try writer["PortRanges"].writeList(value.portRanges, memberWritingClosure: GlobalAcceleratorClientTypes.PortRange.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GlobalAcceleratorClientTypes.PortMapping {
    ...
    static func write(value: GlobalAcceleratorClientTypes.PortMapping?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AcceleratorPort"].write(value.acceleratorPort)
        try writer["DestinationSocketAddress"].write(value.destinationSocketAddress, with: GlobalAcceleratorClientTypes.SocketAddress.write(value:to:))
        try writer["DestinationTrafficState"].write(value.destinationTrafficState)
        try writer["EndpointGroupArn"].write(value.endpointGroupArn)
        try writer["EndpointId"].write(value.endpointId)
...
extension ProvisionByoipCidrOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ProvisionByoipCidrOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension RemoveCustomRoutingEndpointsInput {
    ...
    static func write(value: RemoveCustomRoutingEndpointsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["EndpointGroupArn"].write(value.endpointGroupArn)
        try writer["EndpointIds"].writeList(value.endpointIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension RemoveCustomRoutingEndpointsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> RemoveCustomRoutingEndpointsOutput {
...
extension RemoveEndpointsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> RemoveEndpointsOutput {
...
extension GlobalAcceleratorClientTypes.SocketAddress {
    ...
    static func write(value: GlobalAcceleratorClientTypes.SocketAddress?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension UpdateAcceleratorAttributesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateAcceleratorAttributesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateAcceleratorOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateAcceleratorOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateCrossAccountAttachmentInput {
    ...
    static func write(value: UpdateCrossAccountAttachmentInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AddPrincipals"].writeList(value.addPrincipals, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["AttachmentArn"].write(value.attachmentArn)
        try writer["Name"].write(value.name)
        try writer["RemovePrincipals"].writeList(value.removePrincipals, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension UpdateCrossAccountAttachmentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateCrossAccountAttachmentOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateCustomRoutingAcceleratorAttributesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateCustomRoutingAcceleratorAttributesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateCustomRoutingAcceleratorOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateCustomRoutingAcceleratorOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateCustomRoutingListenerOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateCustomRoutingListenerOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateEndpointGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateEndpointGroupOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension WithdrawByoipCidrOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> WithdrawByoipCidrOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
