...
extension PaginatorSequence where OperationStackInput == ListRecommendedActionsInput, OperationStackOutput == ListRecommendedActionsOutput {
    ...
    /// to access the nested member `[BCMRecommendedActionsClientTypes.RecommendedAction]`
    /// - Returns: `[BCMRecommendedActionsClientTypes.RecommendedAction]`
    public func recommendedActions() async throws -> [BCMRecommendedActionsClientTypes.RecommendedAction] {
