...
public class BCMRecommendedActionsClient: AWSClientRuntime.AWSServiceClient {
    ...
    public required init(config: BCMRecommendedActionsClient.BCMRecommendedActionsClientConfiguration) {
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    public convenience init(region: Swift.String) throws {
        let config = try BCMRecommendedActionsClient.BCMRecommendedActionsClientConfiguration(region: region)
        self.init(config: config)
    }

    public convenience required init() async throws {
        let config = try await BCMRecommendedActionsClient.BCMRecommendedActionsClientConfiguration()
        self.init(config: config)
    }
}
...
extension BCMRecommendedActionsClient {
    ...
    public struct BCMRecommendedActionsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Sendable {
