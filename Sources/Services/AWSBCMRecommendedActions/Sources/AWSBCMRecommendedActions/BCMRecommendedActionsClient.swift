...
extension BCMRecommendedActionsClient {
    ...
    public class BCMRecommendedActionsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        ...
        private init(
            ...
            self.logger = telemetryProvider.loggerProvider.getLogger(name: BCMRecommendedActionsClient.clientName)
        }
        ...
        public convenience init(region: Swift.String) throws {
            self.init(
                ...
                nil,
                DefaultBCMRecommendedActionsAuthSchemeResolver(),
