...
public final class BCMRecommendedActionsClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: BCMRecommendedActionsClient.BCMRecommendedActionsClientConfig) instead")
    public convenience init(config: BCMRecommendedActionsClient.BCMRecommendedActionsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try BCMRecommendedActionsClient.BCMRecommendedActionsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await BCMRecommendedActionsClient.BCMRecommendedActionsClientConfig()
        self.init(config: config)
    }
}
...
extension BCMRecommendedActionsClient {
    ...
    /// Client configuration for BCMRecommendedActionsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct BCMRecommendedActionsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "BCM Recommended Actions")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultBCMRecommendedActionsAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: BCMRecommendedActionsClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultBCMRecommendedActionsAuthSchemeResolver(),
        ...
        public var partitionID: String? {
            return "\(BCMRecommendedActionsClient.clientName) - \(region ?? "")"
        }
    ...
    @available(*, deprecated, message: "Use BCMRecommendedActionsClientConfig instead. This class will be removed in a future version.")
    public final class BCMRecommendedActionsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> BCMRecommendedActionsClientConfig {
            return try BCMRecommendedActionsClientConfig(
    ...
    public static func builder() -> ClientRuntime.ClientBuilder<BCMRecommendedActionsClient> {
        return ClientRuntime.ClientBuilder<BCMRecommendedActionsClient>(defaultPlugins: [
...
extension BCMRecommendedActionsClient {
    /// Performs the `ListRecommendedActions` operation on the `BCMRecommendedActions` service.
    ///
    ...
    public func listRecommendedActions(input: ListRecommendedActionsInput) async throws -> ListRecommendedActionsOutput {
        ...
        let operation = BCMRecommendedActionsClient.listRecommendedActionsOperation
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningName(value: "bcm-recommended-actions")
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "BCM Recommended Actions"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListRecommendedActionsInput, ListRecommendedActionsOutput>(serviceID: serviceName, version: BCMRecommendedActionsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "BCMRecommendedActions")
