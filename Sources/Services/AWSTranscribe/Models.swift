...
extension CreateVocabularyInput {
    ...
    static func write(value: CreateVocabularyInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["LanguageCode"].write(value.languageCode)
        try writer["Phrases"].writeList(value.phrases, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Tags"].writeList(value.tags, memberWritingClosure: TranscribeClientTypes.Tag.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["VocabularyFileUri"].write(value.vocabularyFileUri)
    }
}
...
extension CreateVocabularyFilterInput {
    ...
    static func write(value: CreateVocabularyFilterInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Words"].writeList(value.words, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension StartMedicalScribeJobInput {
    ...
    static func write(value: StartMedicalScribeJobInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["DataAccessRoleArn"].write(value.dataAccessRoleArn)
        try writer["KMSEncryptionContext"].writeMap(value.kmsEncryptionContext, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Media"].write(value.media, with: TranscribeClientTypes.Media.write(value:to:))
...
extension TranscribeClientTypes.SentimentFilter {
    ...
    static func write(value: TranscribeClientTypes.SentimentFilter?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Sentiments"].writeList(value.sentiments, memberWritingClosure: TranscribeClientTypes.SentimentValue.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TranscribeClientTypes.SentimentFilter {
        ...
        value.sentiments = try reader["Sentiments"].readListIfPresent(memberReadingClosure: TranscribeClientTypes.SentimentValue.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension TranscribeClientTypes.CallAnalyticsJobSettings {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TranscribeClientTypes.CallAnalyticsJobSettings {
        ...
        value.languageOptions = try reader["LanguageOptions"].readListIfPresent(memberReadingClosure: TranscribeClientTypes.LanguageCode.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension TranscribeClientTypes.ContentRedaction {
    ...
    static func write(value: TranscribeClientTypes.ContentRedaction?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["PiiEntityTypes"].writeList(value.piiEntityTypes, memberWritingClosure: TranscribeClientTypes.PiiEntityType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TranscribeClientTypes.ContentRedaction {
        ...
        value.piiEntityTypes = try reader["PiiEntityTypes"].readListIfPresent(memberReadingClosure: TranscribeClientTypes.PiiEntityType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension TranscribeClientTypes.ToxicityDetectionSettings {
    ...
    static func write(value: TranscribeClientTypes.ToxicityDetectionSettings?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ToxicityCategories"].writeList(value.toxicityCategories, memberWritingClosure: TranscribeClientTypes.ToxicityCategory.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TranscribeClientTypes.ToxicityDetectionSettings {
        ...
        value.toxicityCategories = try reader["ToxicityCategories"].readListIfPresent(memberReadingClosure: TranscribeClientTypes.ToxicityCategory.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension TranscribeClientTypes.SubtitlesOutput {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TranscribeClientTypes.SubtitlesOutput {
        ...
        value.subtitleFileUris = try reader["SubtitleFileUris"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
