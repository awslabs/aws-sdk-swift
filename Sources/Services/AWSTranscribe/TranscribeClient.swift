...
extension TranscribeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> TranscribeClient.TranscribeClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> TranscribeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return TranscribeClient(config: configuration)
        }
    }
...
extension TranscribeClient.TranscribeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
