...
public struct KinesisVideoMediaAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol KinesisVideoMediaAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
