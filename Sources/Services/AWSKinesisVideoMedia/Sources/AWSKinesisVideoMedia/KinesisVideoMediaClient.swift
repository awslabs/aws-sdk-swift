...
extension KinesisVideoMediaClient {
    ...
    public func getMedia(input: GetMediaInput) async throws -> GetMediaOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetMediaInput, GetMediaOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
