...
public class KinesisVideoMediaClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if var config = clientConfiguration as? KinesisVideoMediaClient.KinesisVideoMediaClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if var config = clientConfiguration as? KinesisVideoMediaClient.KinesisVideoMediaClientConfiguration {
            config.authSchemeResolver = DefaultKinesisVideoMediaAuthSchemeResolver()
...
public class KinesisVideoMediaClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [ClientRuntime.AuthScheme]? = nil, authSchemeResolver: KinesisVideoMediaAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any AWSClientRuntime.AWSCredentialIdentityResolver)? = nil) {
