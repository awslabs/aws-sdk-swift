...
extension CreateEnvironmentInput {
    ...
    static func write(value: CreateEnvironmentInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["AirflowConfigurationOptions"].writeMap(value.airflowConfigurationOptions, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ListEnvironmentsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListEnvironmentsOutput {
        ...
        value.environments = try reader["Environments"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension MWAAClientTypes.Environment {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MWAAClientTypes.Environment {
        ...
        value.airflowConfigurationOptions = try reader["AirflowConfigurationOptions"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
