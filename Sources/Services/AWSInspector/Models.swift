...
extension AddAttributesToFindingsInput {
    ...
    static func write(value: AddAttributesToFindingsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["findingArns"].writeList(value.findingArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeAssessmentRunsInput {
    ...
    static func write(value: DescribeAssessmentRunsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["assessmentRunArns"].writeList(value.assessmentRunArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeAssessmentTargetsInput {
    ...
    static func write(value: DescribeAssessmentTargetsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["assessmentTargetArns"].writeList(value.assessmentTargetArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeAssessmentTemplatesInput {
    ...
    static func write(value: DescribeAssessmentTemplatesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["assessmentTemplateArns"].writeList(value.assessmentTemplateArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeExclusionsInput {
    ...
    static func write(value: DescribeExclusionsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["exclusionArns"].writeList(value.exclusionArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeResourceGroupsInput {
    ...
    static func write(value: DescribeResourceGroupsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["resourceGroupArns"].writeList(value.resourceGroupArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension RemoveAttributesFromFindingsInput {
    ...
    static func write(value: RemoveAttributesFromFindingsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["attributeKeys"].writeList(value.attributeKeys, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["findingArns"].writeList(value.findingArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ListAssessmentRunsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAssessmentRunsOutput {
        ...
        value.assessmentRunArns = try reader["assessmentRunArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListAssessmentTargetsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAssessmentTargetsOutput {
        ...
        value.assessmentTargetArns = try reader["assessmentTargetArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListAssessmentTemplatesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAssessmentTemplatesOutput {
        ...
        value.assessmentTemplateArns = try reader["assessmentTemplateArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListExclusionsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListExclusionsOutput {
        ...
        value.exclusionArns = try reader["exclusionArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListFindingsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListFindingsOutput {
        ...
        value.findingArns = try reader["findingArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension AssessmentRunInProgressException {
    ...
    static func makeError(baseError: AWSClientRuntime.AWSJSONError) throws -> AssessmentRunInProgressException {
        ...
        value.properties.assessmentRunArns = try reader["assessmentRunArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension InspectorClientTypes.AssessmentRun {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> InspectorClientTypes.AssessmentRun {
        ...
        value.findingCounts = try reader["findingCounts"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension InspectorClientTypes.FindingFilter {
    ...
    static func write(value: InspectorClientTypes.FindingFilter?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["agentIds"].writeList(value.agentIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["attributes"].writeList(value.attributes, memberWritingClosure: InspectorClientTypes.Attribute.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["autoScalingGroups"].writeList(value.autoScalingGroups, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
