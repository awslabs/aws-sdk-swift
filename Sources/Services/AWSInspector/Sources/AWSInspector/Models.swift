...
extension InspectorClientTypes {
    ...
    public enum AccessDeniedErrorCode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension InspectorClientTypes {
    ...
    public enum InvalidInputErrorCode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension InspectorClientTypes {
    ...
    public enum NoSuchEntityErrorCode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension InspectorClientTypes {
    ...
    public enum FailedItemErrorCode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case accessDenied
        case duplicateArn
        case internalError
        case invalidArn
...
extension InspectorClientTypes {
    ...
    public enum AgentHealthCode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case idle
        case running
        case shutdown
        case throttled
...
extension InspectorClientTypes {
    ...
    public enum AgentHealth: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case healthy
        case unhealthy
        case unknown
        case sdkUnknown(Swift.String)
...
extension InspectorClientTypes {
    ...
    public enum InspectorEvent: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension InspectorClientTypes {
    ...
    public enum AssessmentRunNotificationSnsStatusCode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case accessDenied
        case internalError
        case success
...
extension InspectorClientTypes {
    ...
    public enum AssessmentRunState: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case canceled
        case collectingData
        case completed
...
extension InspectorClientTypes {
    ...
    public enum InvalidCrossAccountRoleErrorCode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension InspectorClientTypes {
    ...
    public enum LimitExceededErrorCode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension InspectorClientTypes {
    ...
    public enum ScopeType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case instanceId
...
extension InspectorClientTypes {
    ...
    public enum ReportFileFormat: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case html
        case pdf
        case sdkUnknown(Swift.String)
...
extension InspectorClientTypes {
    ...
    public enum ReportStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case completed
        case failed
        case workInProgress
        case sdkUnknown(Swift.String)
...
extension InspectorClientTypes {
    ...
    public enum PreviewStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case completed
        case workInProgress
        case sdkUnknown(Swift.String)
...
extension InspectorClientTypes {
    ...
    public enum StopAction: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case skipEvaluation
...
extension DescribeCrossAccountAccessRoleOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeCrossAccountAccessRoleOutput {
        ...
        value.registeredAt = try reader["registeredAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension GetExclusionsPreviewOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetExclusionsPreviewOutput {
        ...
        value.previewStatus = try reader["previewStatus"].readIfPresent()
        return value
    }
}
...
extension InternalException {
    ...
    static func makeError(baseError: AWSClientRuntime.AWSJSONError) throws -> InternalException {
        ...
        value.properties.canRetry = try reader["canRetry"].readIfPresent()
...
extension AssessmentRunInProgressException {
    ...
    static func makeError(baseError: AWSClientRuntime.AWSJSONError) throws -> AssessmentRunInProgressException {
        ...
        value.properties.assessmentRunArnsTruncated = try reader["assessmentRunArnsTruncated"].readIfPresent()
        value.properties.canRetry = try reader["canRetry"].readIfPresent()
        value.properties.message = try reader["message"].readIfPresent()
        value.httpResponse = baseError.httpResponse
        value.requestID = baseError.requestID
...
extension AgentsAlreadyRunningAssessmentException {
    ...
    static func makeError(baseError: AWSClientRuntime.AWSJSONError) throws -> AgentsAlreadyRunningAssessmentException {
        ...
        value.properties.agentsTruncated = try reader["agentsTruncated"].readIfPresent()
        value.properties.canRetry = try reader["canRetry"].readIfPresent()
        value.properties.message = try reader["message"].readIfPresent()
        value.httpResponse = baseError.httpResponse
        value.requestID = baseError.requestID
...
extension InspectorClientTypes.FailedItemDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> InspectorClientTypes.FailedItemDetails {
        ...
        value.retryable = try reader["retryable"].readIfPresent()
        return value
    }
}
...
extension InspectorClientTypes.AssessmentRun {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> InspectorClientTypes.AssessmentRun {
        ...
        value.stateChangedAt = try reader["stateChangedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.dataCollected = try reader["dataCollected"].readIfPresent()
...
extension InspectorClientTypes.AssessmentTemplate {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> InspectorClientTypes.AssessmentTemplate {
        ...
        value.assessmentRunCount = try reader["assessmentRunCount"].readIfPresent()
        value.createdAt = try reader["createdAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension InspectorClientTypes.AssessmentRunAgent {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> InspectorClientTypes.AssessmentRunAgent {
        ...
        value.agentHealthCode = try reader["agentHealthCode"].readIfPresent()
...
extension InspectorClientTypes.EventSubscription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> InspectorClientTypes.EventSubscription {
        ...
        value.event = try reader["event"].readIfPresent()
        value.subscribedAt = try reader["subscribedAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
