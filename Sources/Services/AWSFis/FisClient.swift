...
extension FisClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> FisClient.FisClientConfiguration {
        let clientConfiguration = try await FisClient.FisClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> FisClient {
            let configuration = try await resolve(plugins: self.plugins)
            return FisClient(config: configuration)
        }
    }
...
extension FisClient.FisClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
