...
public final class FirehoseClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: FirehoseClient.FirehoseClientConfig) instead")
    public convenience init(config: FirehoseClient.FirehoseClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try FirehoseClient.FirehoseClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await FirehoseClient.FirehoseClientConfig()
        self.init(config: config)
    }
}
...
extension FirehoseClient {
    ...
    /// Client configuration for FirehoseClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct FirehoseClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Firehose")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: FirehoseClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultFirehoseAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use FirehoseClientConfig instead. This class will be removed in a future version.")
    public final class FirehoseClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> FirehoseClientConfig {
            return try FirehoseClientConfig(
...
extension FirehoseClient {
    /// Performs the `CreateDeliveryStream` operation on the `Firehose` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `CreateDeliveryStreamInput`)
    ///
    /// - Returns: [no documentation found] (Type: `CreateDeliveryStreamOutput`)
    ///
    ...
    public func createDeliveryStream(input: CreateDeliveryStreamInput) async throws -> CreateDeliveryStreamOutput {
        ...
        let operation = FirehoseClient.createDeliveryStreamOperation
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Firehose", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateDeliveryStreamOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateDeliveryStreamInput, CreateDeliveryStreamOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.CreateDeliveryStream"]))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateDeliveryStreamInput, CreateDeliveryStreamOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
    ...
    /// Performs the `DeleteDeliveryStream` operation on the `Firehose` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DeleteDeliveryStreamInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteDeliveryStreamOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func deleteDeliveryStream(input: DeleteDeliveryStreamInput) async throws -> DeleteDeliveryStreamOutput {
        ...
        let operation = FirehoseClient.deleteDeliveryStreamOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteDeliveryStreamOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteDeliveryStreamInput, DeleteDeliveryStreamOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.DeleteDeliveryStream"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteDeliveryStreamInput, DeleteDeliveryStreamOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
    ...
    /// Performs the `DescribeDeliveryStream` operation on the `Firehose` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeDeliveryStreamInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeDeliveryStreamOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeDeliveryStream(input: DescribeDeliveryStreamInput) async throws -> DescribeDeliveryStreamOutput {
        ...
        let operation = FirehoseClient.describeDeliveryStreamOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeDeliveryStreamOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeDeliveryStreamInput, DescribeDeliveryStreamOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.DescribeDeliveryStream"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeDeliveryStreamInput, DescribeDeliveryStreamOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
    ...
    /// Performs the `ListDeliveryStreams` operation on the `Firehose` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `ListDeliveryStreamsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListDeliveryStreamsOutput`)
    public func listDeliveryStreams(input: ListDeliveryStreamsInput) async throws -> ListDeliveryStreamsOutput {
        ...
        let operation = FirehoseClient.listDeliveryStreamsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListDeliveryStreamsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListDeliveryStreamsInput, ListDeliveryStreamsOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.ListDeliveryStreams"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListDeliveryStreamsInput, ListDeliveryStreamsOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
    ...
    /// Performs the `ListTagsForDeliveryStream` operation on the `Firehose` service.
    ///
    /// Lists the tags for the specified Firehose stream. This operation has a limit of five transactions per second per account.
    ///
    /// - Parameter input: [no documentation found] (Type: `ListTagsForDeliveryStreamInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListTagsForDeliveryStreamOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func listTagsForDeliveryStream(input: ListTagsForDeliveryStreamInput) async throws -> ListTagsForDeliveryStreamOutput {
        ...
        let operation = FirehoseClient.listTagsForDeliveryStreamOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListTagsForDeliveryStreamOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListTagsForDeliveryStreamInput, ListTagsForDeliveryStreamOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.ListTagsForDeliveryStream"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListTagsForDeliveryStreamInput, ListTagsForDeliveryStreamOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
    ...
    /// Performs the `PutRecord` operation on the `Firehose` service.
    ///
    ...
    public func putRecord(input: PutRecordInput) async throws -> PutRecordOutput {
        ...
        let operation = FirehoseClient.putRecordOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutRecordInput, PutRecordOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.PutRecord"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutRecordInput, PutRecordOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
    ...
    /// Performs the `PutRecordBatch` operation on the `Firehose` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `PutRecordBatchInput`)
    ///
    /// - Returns: [no documentation found] (Type: `PutRecordBatchOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func putRecordBatch(input: PutRecordBatchInput) async throws -> PutRecordBatchOutput {
        ...
        let operation = FirehoseClient.putRecordBatchOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutRecordBatchOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutRecordBatchInput, PutRecordBatchOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.PutRecordBatch"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutRecordBatchInput, PutRecordBatchOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
    ...
    /// Performs the `StartDeliveryStreamEncryption` operation on the `Firehose` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `StartDeliveryStreamEncryptionInput`)
    ///
    /// - Returns: [no documentation found] (Type: `StartDeliveryStreamEncryptionOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func startDeliveryStreamEncryption(input: StartDeliveryStreamEncryptionInput) async throws -> StartDeliveryStreamEncryptionOutput {
        ...
        let operation = FirehoseClient.startDeliveryStreamEncryptionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<StartDeliveryStreamEncryptionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<StartDeliveryStreamEncryptionInput, StartDeliveryStreamEncryptionOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.StartDeliveryStreamEncryption"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<StartDeliveryStreamEncryptionInput, StartDeliveryStreamEncryptionOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
    ...
    /// Performs the `StopDeliveryStreamEncryption` operation on the `Firehose` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `StopDeliveryStreamEncryptionInput`)
    ///
    /// - Returns: [no documentation found] (Type: `StopDeliveryStreamEncryptionOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func stopDeliveryStreamEncryption(input: StopDeliveryStreamEncryptionInput) async throws -> StopDeliveryStreamEncryptionOutput {
        ...
        let operation = FirehoseClient.stopDeliveryStreamEncryptionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<StopDeliveryStreamEncryptionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<StopDeliveryStreamEncryptionInput, StopDeliveryStreamEncryptionOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.StopDeliveryStreamEncryption"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<StopDeliveryStreamEncryptionInput, StopDeliveryStreamEncryptionOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
    ...
    /// Performs the `TagDeliveryStream` operation on the `Firehose` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `TagDeliveryStreamInput`)
    ///
    /// - Returns: [no documentation found] (Type: `TagDeliveryStreamOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func tagDeliveryStream(input: TagDeliveryStreamInput) async throws -> TagDeliveryStreamOutput {
        ...
        let operation = FirehoseClient.tagDeliveryStreamOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<TagDeliveryStreamOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<TagDeliveryStreamInput, TagDeliveryStreamOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.TagDeliveryStream"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TagDeliveryStreamInput, TagDeliveryStreamOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
    ...
    /// Performs the `UntagDeliveryStream` operation on the `Firehose` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `UntagDeliveryStreamInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UntagDeliveryStreamOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func untagDeliveryStream(input: UntagDeliveryStreamInput) async throws -> UntagDeliveryStreamOutput {
        ...
        let operation = FirehoseClient.untagDeliveryStreamOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UntagDeliveryStreamOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UntagDeliveryStreamInput, UntagDeliveryStreamOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.UntagDeliveryStream"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UntagDeliveryStreamInput, UntagDeliveryStreamOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
    ...
    /// Performs the `UpdateDestination` operation on the `Firehose` service.
    ///
    ...
    public func updateDestination(input: UpdateDestinationInput) async throws -> UpdateDestinationOutput {
        ...
        let operation = FirehoseClient.updateDestinationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateDestinationInput, UpdateDestinationOutput>(overrides: ["X-Amz-Target": "Firehose_20150804.UpdateDestination"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Firehose"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateDestinationInput, UpdateDestinationOutput>(serviceID: serviceName, version: FirehoseClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Firehose")
