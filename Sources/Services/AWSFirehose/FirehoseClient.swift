...
extension FirehoseClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> FirehoseClient.FirehoseClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> FirehoseClient {
            let configuration = try await resolve(plugins: self.plugins)
            return FirehoseClient(config: configuration)
        }
    }
...
extension FirehoseClient.FirehoseClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
