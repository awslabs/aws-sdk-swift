...
extension LaunchWizardClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> LaunchWizardClient.LaunchWizardClientConfiguration {
        let clientConfiguration = try await LaunchWizardClient.LaunchWizardClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> LaunchWizardClient {
            let configuration = try await resolve(plugins: self.plugins)
            return LaunchWizardClient(config: configuration)
        }
    }
...
extension LaunchWizardClient.LaunchWizardClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
