...
public class CloudTrailDataClient {
    ...
    public class CloudTrailDataClientConfiguration: CloudTrailDataClientConfigurationProtocol {
        ...
        public convenience init(
            ...
            let runtimeConfig = try ClientRuntime.DefaultSDKRuntimeConfiguration("CloudTrailDataClient")
            try self.init(
...
extension CloudTrailDataClient: CloudTrailDataClientProtocol {
    ...
    public func putAuditEvents(input: PutAuditEventsInput) async throws -> PutAuditEventsOutputResponse
    {
        ...
        operation.deserializeStep.intercept(position: .before, middleware: ClientRuntime.LoggerMiddleware<PutAuditEventsOutputResponse, PutAuditEventsOutputError>(clientLogMode: config.clientLogMode))
