...
extension CloudTrailDataClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CloudTrailDataClient.CloudTrailDataClientConfiguration {
        let clientConfiguration = try await CloudTrailDataClient.CloudTrailDataClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CloudTrailDataClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CloudTrailDataClient(config: configuration)
        }
    }
...
extension CloudTrailDataClient.CloudTrailDataClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
