...
public final class CloudTrailDataClient: AWSClientRuntime.AWSServiceClient {
    ...
    public let config: CloudTrailDataClient.CloudTrailDataClientConfig
    let serviceName = "CloudTrail Data"

    @available(*, deprecated, message: "Use CloudTrailDataClient.CloudTrailDataClientConfig instead")
    public typealias Config = CloudTrailDataClient.CloudTrailDataClientConfiguration
    public typealias Configuration = CloudTrailDataClient.CloudTrailDataClientConfig

    public required init(config: CloudTrailDataClient.CloudTrailDataClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: CloudTrailDataClient.CloudTrailDataClientConfig) instead")
    public convenience init(config: CloudTrailDataClient.CloudTrailDataClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try CloudTrailDataClient.CloudTrailDataClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await CloudTrailDataClient.CloudTrailDataClientConfig()
        self.init(config: config)
    }
}
...
extension CloudTrailDataClient {
    ...
    /// Client configuration for CloudTrailDataClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct CloudTrailDataClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "CloudTrail Data")
    ...
    @available(*, deprecated, message: "Use CloudTrailDataClientConfig instead. This class will be removed in a future version.")
    public final class CloudTrailDataClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> CloudTrailDataClientConfig {
            return try CloudTrailDataClientConfig(
...
extension CloudTrailDataClient {
    ...
    public func putAuditEvents(input: PutAuditEventsInput) async throws -> PutAuditEventsOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudTrail Data"))
