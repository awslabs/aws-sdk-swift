...
public final class MediaStoreDataClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: MediaStoreDataClient.MediaStoreDataClientConfig) instead")
    public convenience init(config: MediaStoreDataClient.MediaStoreDataClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try MediaStoreDataClient.MediaStoreDataClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await MediaStoreDataClient.MediaStoreDataClientConfig()
        self.init(config: config)
    }
}
...
extension MediaStoreDataClient {
    ...
    /// Client configuration for MediaStoreDataClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct MediaStoreDataClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "MediaStore Data")
    ...
    @available(*, deprecated, message: "Use MediaStoreDataClientConfig instead. This class will be removed in a future version.")
    public final class MediaStoreDataClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> MediaStoreDataClientConfig {
            return try MediaStoreDataClientConfig(
...
extension MediaStoreDataClient {
    ...
    public func deleteObject(input: DeleteObjectInput) async throws -> DeleteObjectOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "MediaStore Data"))
