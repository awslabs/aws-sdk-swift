...
extension MediaStoreDataClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MediaStoreDataClient.MediaStoreDataClientConfiguration {
        let clientConfiguration = try await MediaStoreDataClient.MediaStoreDataClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MediaStoreDataClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MediaStoreDataClient(config: configuration)
        }
    }
...
extension MediaStoreDataClient.MediaStoreDataClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
