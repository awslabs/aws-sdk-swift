...
extension FSxClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> FSxClient.FSxClientConfiguration {
        let clientConfiguration = try await FSxClient.FSxClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> FSxClient {
            let configuration = try await resolve(plugins: self.plugins)
            return FSxClient(config: configuration)
        }
    }
...
extension FSxClient.FSxClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
