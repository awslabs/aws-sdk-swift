...
public class NeptuneClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await NeptuneClientConfiguration(region: region)
    ...
    public class NeptuneClientConfiguration: NeptuneClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("NeptuneClient")
