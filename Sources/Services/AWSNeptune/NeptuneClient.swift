...
extension NeptuneClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> NeptuneClient.NeptuneClientConfiguration {
        let clientConfiguration = try await NeptuneClient.NeptuneClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> NeptuneClient {
            let configuration = try await resolve(plugins: self.plugins)
            return NeptuneClient(config: configuration)
        }
    }
...
extension NeptuneClient.NeptuneClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
