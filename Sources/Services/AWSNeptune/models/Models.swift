...
extension CreateDBClusterEndpointOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateDBClusterEndpointOutput {
        ...
        value.excludedMembers = try reader["ExcludedMembers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.staticMembers = try reader["StaticMembers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateDBInstanceInput {
    ...
    static func write(value: CreateDBInstanceInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["DBSecurityGroups"].writeList(value.dbSecurityGroups, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "DBSecurityGroupName", isFlattened: false)
        try writer["DBSubnetGroupName"].write(value.dbSubnetGroupName)
        try writer["DeletionProtection"].write(value.deletionProtection)
...
extension NeptuneClientTypes.DBInstance {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> NeptuneClientTypes.DBInstance {
        ...
        value.readReplicaDBInstanceIdentifiers = try reader["ReadReplicaDBInstanceIdentifiers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "ReadReplicaDBInstanceIdentifier", isFlattened: false)
        value.readReplicaDBClusterIdentifiers = try reader["ReadReplicaDBClusterIdentifiers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "ReadReplicaDBClusterIdentifier", isFlattened: false)
        value.licenseModel = try reader["LicenseModel"].readIfPresent()
        value.iops = try reader["Iops"].readIfPresent()
