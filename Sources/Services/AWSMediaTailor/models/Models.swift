...
extension MediaTailorClientTypes {
    ...
    public enum AdMarkupType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case daterange
        case scte35Enhanced
        case sdkUnknown(Swift.String)
...
extension MediaTailorClientTypes.Alert {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MediaTailorClientTypes.Alert {
        ...
        value.relatedResourceArns = try reader["RelatedResourceArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension MediaTailorClientTypes {
    ...
    public enum AlertCategory: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case info
...
extension MediaTailorClientTypes.Channel {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MediaTailorClientTypes.Channel {
        ...
        value.audiences = try reader["Audiences"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ConfigureLogsForChannelOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ConfigureLogsForChannelOutput {
        ...
        value.channelName = try reader["ChannelName"].readIfPresent()
        value.logTypes = try reader["LogTypes"].readListIfPresent(memberReadingClosure: MediaTailorClientTypes.LogType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension MediaTailorClientTypes {
    ...
    public enum FillPolicy: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case fullAvailOnly
        case partialAvail
        case sdkUnknown(Swift.String)
...
extension GetPlaybackConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetPlaybackConfigurationOutput {
        ...
        value.configurationAliases = try reader["ConfigurationAliases"].readMapIfPresent(valueReadingClosure: mapReadingClosure(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension MediaTailorClientTypes.HlsPlaylistSettings {
    ...
    static func write(value: MediaTailorClientTypes.HlsPlaylistSettings?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AdMarkupType"].writeList(value.adMarkupType, memberWritingClosure: MediaTailorClientTypes.AdMarkupType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ManifestWindowSeconds"].write(value.manifestWindowSeconds)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MediaTailorClientTypes.HlsPlaylistSettings {
        ...
        value.manifestWindowSeconds = try reader["ManifestWindowSeconds"].readIfPresent()
        value.adMarkupType = try reader["AdMarkupType"].readListIfPresent(memberReadingClosure: MediaTailorClientTypes.AdMarkupType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension MediaTailorClientTypes {
    ...
    public enum InsertionMode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case playerSelect
        case stitchedOnly
        case sdkUnknown(Swift.String)
...
extension MediaTailorClientTypes {
    ...
    public enum OriginManifestType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case multiPeriod
        case singlePeriod
        case sdkUnknown(Swift.String)
...
extension MediaTailorClientTypes {
    ...
    public enum PlaybackMode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case linear
        case loop
        case sdkUnknown(Swift.String)
...
extension MediaTailorClientTypes.PrefetchRetrieval {
    ...
    static func write(value: MediaTailorClientTypes.PrefetchRetrieval?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DynamicVariables"].writeMap(value.dynamicVariables, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["EndTime"].writeTimestamp(value.endTime, format: .epochSeconds)
        try writer["StartTime"].writeTimestamp(value.startTime, format: .epochSeconds)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MediaTailorClientTypes.PrefetchRetrieval {
        ...
        value.dynamicVariables = try reader["DynamicVariables"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.endTime = try reader["EndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.startTime = try reader["StartTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
...
extension MediaTailorClientTypes {
    ...
    public enum RelativePosition: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case afterProgram
        case beforeProgram
        case sdkUnknown(Swift.String)
...
extension MediaTailorClientTypes.ScheduleAdBreak {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MediaTailorClientTypes.ScheduleAdBreak {
        ...
        value.approximateStartTime = try reader["ApproximateStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.sourceLocationName = try reader["SourceLocationName"].readIfPresent()
        value.vodSourceName = try reader["VodSourceName"].readIfPresent()
        return value
    }
...
extension MediaTailorClientTypes {
    ...
    public enum ScheduleEntryType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case alternateMedia
        case fillerSlate
        case program
        case sdkUnknown(Swift.String)
