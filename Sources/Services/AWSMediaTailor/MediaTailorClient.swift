...
extension MediaTailorClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MediaTailorClient.MediaTailorClientConfiguration {
        let clientConfiguration = try await MediaTailorClient.MediaTailorClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MediaTailorClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MediaTailorClient(config: configuration)
        }
    }
...
extension MediaTailorClient.MediaTailorClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
