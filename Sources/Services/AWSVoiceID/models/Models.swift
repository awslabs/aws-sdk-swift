...
extension VoiceIDClientTypes.AuthenticationResult {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> VoiceIDClientTypes.AuthenticationResult {
        ...
        value.audioAggregationStartedAt = try reader["AudioAggregationStartedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.audioAggregationEndedAt = try reader["AudioAggregationEndedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension VoiceIDClientTypes.EnrollmentJobFraudDetectionConfig {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> VoiceIDClientTypes.EnrollmentJobFraudDetectionConfig {
        ...
        value.watchlistIds = try reader["WatchlistIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension VoiceIDClientTypes.FraudDetectionResult {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> VoiceIDClientTypes.FraudDetectionResult {
        ...
        value.decision = try reader["Decision"].readIfPresent()
        value.reasons = try reader["Reasons"].readListIfPresent(memberReadingClosure: VoiceIDClientTypes.FraudDetectionReason.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension VoiceIDClientTypes.Speaker {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> VoiceIDClientTypes.Speaker {
        ...
        value.createdAt = try reader["CreatedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.updatedAt = try reader["UpdatedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.lastAccessedAt = try reader["LastAccessedAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
