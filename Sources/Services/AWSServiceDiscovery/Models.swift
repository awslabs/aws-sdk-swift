...
extension DiscoverInstancesInput {
    ...
    static func write(value: DiscoverInstancesInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["OptionalParameters"].writeMap(value.optionalParameters, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["QueryParameters"].writeMap(value.queryParameters, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GetInstancesHealthStatusInput {
    ...
    static func write(value: GetInstancesHealthStatusInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Instances"].writeList(value.instances, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["MaxResults"].write(value.maxResults)
...
extension GetInstancesHealthStatusOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetInstancesHealthStatusOutput {
        ...
        value.status = try reader["Status"].readMapIfPresent(valueReadingClosure: ServiceDiscoveryClientTypes.HealthStatus.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension ServiceDiscoveryClientTypes.Operation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ServiceDiscoveryClientTypes.Operation {
        ...
        value.createDate = try reader["CreateDate"].readTimestampIfPresent(format: .epochSeconds)
        value.updateDate = try reader["UpdateDate"].readTimestampIfPresent(format: .epochSeconds)
