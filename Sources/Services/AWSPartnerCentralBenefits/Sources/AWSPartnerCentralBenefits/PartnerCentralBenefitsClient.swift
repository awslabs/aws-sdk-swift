...
public final class PartnerCentralBenefitsClient: AWSClientRuntime.AWSServiceClient, Sendable {
...
extension PartnerCentralBenefitsClient {
    ...
    public final class PartnerCentralBenefitsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, @unchecked Sendable {
        ...
        private init(
            ...
            self.logger = telemetryProvider.loggerProvider.getLogger(name: PartnerCentralBenefitsClient.clientName)
        }
        ...
        public convenience init(region: Swift.String) throws {
            self.init(
                ...
                nil,
                DefaultPartnerCentralBenefitsAuthSchemeResolver(),
