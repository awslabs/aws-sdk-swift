...
extension ListAppsInput {
    ...
    static func queryItemProvider(_ value: ListAppsInput) throws -> [Smithy.URIQueryItem] {
        ...
        if let toLastAssessmentTime = value.toLastAssessmentTime {
            let toLastAssessmentTimeQueryItem = Smithy.URIQueryItem(name: "toLastAssessmentTime".urlPercentEncoding(), value: Swift.String(TimestampFormatter(format: .dateTime).string(from: toLastAssessmentTime)).urlPercentEncoding())
            items.append(toLastAssessmentTimeQueryItem)
        }
        if let fromLastAssessmentTime = value.fromLastAssessmentTime {
            let fromLastAssessmentTimeQueryItem = Smithy.URIQueryItem(name: "fromLastAssessmentTime".urlPercentEncoding(), value: Swift.String(TimestampFormatter(format: .dateTime).string(from: fromLastAssessmentTime)).urlPercentEncoding())
...
extension CreateAppVersionResourceInput {
    ...
    static func write(value: CreateAppVersionResourceInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["additionalInfo"].writeMap(value.additionalInfo, valueWritingClosure: listWritingClosure(memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["appArn"].write(value.appArn)
        try writer["appComponents"].writeList(value.appComponents, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension ImportResourcesToDraftAppVersionInput {
    ...
    static func write(value: ImportResourcesToDraftAppVersionInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["sourceArns"].writeList(value.sourceArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension RemoveDraftAppVersionResourceMappingsInput {
    ...
    static func write(value: RemoveDraftAppVersionResourceMappingsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["appArn"].write(value.appArn)
        try writer["appRegistryAppNames"].writeList(value.appRegistryAppNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["eksSourceNames"].writeList(value.eksSourceNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["logicalStackNames"].writeList(value.logicalStackNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["resourceGroupNames"].writeList(value.resourceGroupNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["resourceNames"].writeList(value.resourceNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["terraformSourceNames"].writeList(value.terraformSourceNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeAppVersionOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeAppVersionOutput {
        ...
        value.additionalInfo = try reader["additionalInfo"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.appArn = try reader["appArn"].readIfPresent()
        value.appVersion = try reader["appVersion"].readIfPresent()
        return value
    }
...
extension ImportResourcesToDraftAppVersionOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ImportResourcesToDraftAppVersionOutput {
        ...
        value.sourceArns = try reader["sourceArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["status"].readIfPresent()
...
extension ResiliencehubClientTypes.PermissionModel {
    ...
    static func write(value: ResiliencehubClientTypes.PermissionModel?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["crossAccountRoleArns"].writeList(value.crossAccountRoleArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ResiliencehubClientTypes.PermissionModel {
        ...
        value.crossAccountRoleArns = try reader["crossAccountRoleArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ResiliencehubClientTypes.RecommendationTemplate {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ResiliencehubClientTypes.RecommendationTemplate {
        ...
        value.recommendationTypes = try reader["recommendationTypes"].readListIfPresent(memberReadingClosure: ResiliencehubClientTypes.RenderRecommendationType.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ResiliencehubClientTypes.ResiliencyScore {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ResiliencehubClientTypes.ResiliencyScore {
        ...
        value.disruptionScore = try reader["disruptionScore"].readMapIfPresent(valueReadingClosure: Swift.Double.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ResiliencehubClientTypes.AlarmRecommendation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ResiliencehubClientTypes.AlarmRecommendation {
        ...
        value.appComponentNames = try reader["appComponentNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ResiliencehubClientTypes.ConfigRecommendation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ResiliencehubClientTypes.ConfigRecommendation {
        ...
        value.name = try reader["name"].readIfPresent()
        value.description = try reader["description"].readIfPresent()
        value.suggestedChanges = try reader["suggestedChanges"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ResiliencehubClientTypes.TestRecommendation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ResiliencehubClientTypes.TestRecommendation {
        ...
        value.items = try reader["items"].readListIfPresent(memberReadingClosure: ResiliencehubClientTypes.RecommendationItem.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.prerequisite = try reader["prerequisite"].readIfPresent()
        value.dependsOnAlarms = try reader["dependsOnAlarms"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.recommendationStatus = try reader["recommendationStatus"].readIfPresent()
        return value
    }
}
