...
extension DescribeDimensionKeysOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeDimensionKeysOutput {
        ...
        value.alignedEndTime = try reader["AlignedEndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.alignedStartTime = try reader["AlignedStartTime"].readTimestampIfPresent(format: .epochSeconds)
