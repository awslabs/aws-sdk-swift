...
extension DescribeDimensionKeysInput {
    ...
    static func write(value: DescribeDimensionKeysInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AdditionalMetrics"].writeList(value.additionalMetrics, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["EndTime"].writeTimestamp(value.endTime, format: .epochSeconds)
...
extension PIClientTypes.DimensionKeyDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PIClientTypes.DimensionKeyDescription {
        ...
        value.additionalMetrics = try reader["AdditionalMetrics"].readMapIfPresent(valueReadingClosure: Swift.Double.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.partitions = try reader["Partitions"].readListIfPresent(memberReadingClosure: Swift.Double.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetDimensionKeyDetailsInput {
    ...
    static func write(value: GetDimensionKeyDetailsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Identifier"].write(value.identifier)
        try writer["RequestedDimensions"].writeList(value.requestedDimensions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ServiceType"].write(value.serviceType)
    }
}
...
extension ListAvailableResourceMetricsInput {
    ...
    static func write(value: ListAvailableResourceMetricsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Identifier"].write(value.identifier)
        try writer["MaxResults"].write(value.maxResults)
        try writer["MetricTypes"].writeList(value.metricTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["NextToken"].write(value.nextToken)
        try writer["ServiceType"].write(value.serviceType)
    }
}
