...
extension TextractClientTypes {
    ...
    public enum AdapterVersionStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case active
        case atRisk
        case creationError
...
extension TextractClientTypes {
    ...
    public enum SelectionStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case notSelected
        case selected
        case sdkUnknown(Swift.String)
...
extension TextractClientTypes {
    ...
    public enum ValueType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case date
        case sdkUnknown(Swift.String)
...
extension TextractClientTypes {
    ...
    public enum AutoUpdate: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case disabled
        case enabled
        case sdkUnknown(Swift.String)
...
extension ListAdaptersInput {
    ...
    static func write(value: ListAdaptersInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AfterCreationTime"].writeTimestamp(value.afterCreationTime, format: .epochSeconds)
        try writer["BeforeCreationTime"].writeTimestamp(value.beforeCreationTime, format: .epochSeconds)
        try writer["MaxResults"].write(value.maxResults)
        try writer["NextToken"].write(value.nextToken)
    }
}
...
extension GetAdapterOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetAdapterOutput {
        ...
        value.featureTypes = try reader["FeatureTypes"].readListIfPresent(memberReadingClosure: TextractClientTypes.FeatureType.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension TextractClientTypes.Block {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TextractClientTypes.Block {
        ...
        value.entityTypes = try reader["EntityTypes"].readListIfPresent(memberReadingClosure: TextractClientTypes.EntityType.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension TextractClientTypes.HumanLoopActivationOutput {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TextractClientTypes.HumanLoopActivationOutput {
        ...
        value.humanLoopActivationReasons = try reader["HumanLoopActivationReasons"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension TextractClientTypes.Warning {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TextractClientTypes.Warning {
        ...
        value.pages = try reader["Pages"].readListIfPresent(memberReadingClosure: Swift.Int.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension TextractClientTypes.LendingSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TextractClientTypes.LendingSummary {
        ...
        value.undetectedDocumentTypes = try reader["UndetectedDocumentTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
