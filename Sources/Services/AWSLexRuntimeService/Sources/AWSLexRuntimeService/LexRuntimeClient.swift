...
public final class LexRuntimeClient: AWSClientRuntime.AWSServiceClient {
    ...
    public let config: LexRuntimeClient.LexRuntimeClientConfig
    let serviceName = "Lex Runtime"

    @available(*, deprecated, message: "Use LexRuntimeClient.LexRuntimeClientConfig instead")
    public typealias Config = LexRuntimeClient.LexRuntimeClientConfiguration
    public typealias Configuration = LexRuntimeClient.LexRuntimeClientConfig

    public required init(config: LexRuntimeClient.LexRuntimeClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: LexRuntimeClient.LexRuntimeClientConfig) instead")
    public convenience init(config: LexRuntimeClient.LexRuntimeClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try LexRuntimeClient.LexRuntimeClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await LexRuntimeClient.LexRuntimeClientConfig()
        self.init(config: config)
    }
}
...
extension LexRuntimeClient {
    ...
    /// Client configuration for LexRuntimeClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct LexRuntimeClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Lex Runtime Service")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: LexRuntimeClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultLexRuntimeServiceAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use LexRuntimeClientConfig instead. This class will be removed in a future version.")
    public final class LexRuntimeClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> LexRuntimeClientConfig {
            return try LexRuntimeClientConfig(
...
extension LexRuntimeClient {
    ...
    public func deleteSession(input: DeleteSessionInput) async throws -> DeleteSessionOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Lex Runtime", config.ignoreConfiguredEndpointURLs)
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Lex Runtime Service"))
    ...
    public func postContent(input: PostContentInput) async throws -> PostContentOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PostContentOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func postText(input: PostTextInput) async throws -> PostTextOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PostTextOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
