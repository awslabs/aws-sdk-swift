...
extension LexRuntimeClientTypes.DialogAction {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LexRuntimeClientTypes.DialogAction {
        ...
        value.slots = try reader["slots"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GetSessionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetSessionOutput {
        ...
        value.sessionAttributes = try reader["sessionAttributes"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.sessionId = try reader["sessionId"].readIfPresent()
        return value
    }
}
...
extension PostTextInput {
    ...
    static func write(value: PostTextInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["requestAttributes"].writeMap(value.requestAttributes, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
