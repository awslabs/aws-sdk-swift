...
extension AthenaClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> AthenaClient.AthenaClientConfiguration {
        let clientConfiguration = try await AthenaClient.AthenaClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> AthenaClient {
            let configuration = try await resolve(plugins: self.plugins)
            return AthenaClient(config: configuration)
        }
    }
...
extension AthenaClient.AthenaClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
