...
public class RTBFabricClientEndpointPlugin: Plugin {
    ...
    public func configureClient<Config: ClientRuntime.ClientConfiguration>(clientConfiguration: inout Config) async throws {
        guard var config = clientConfiguration as? RTBFabricClient.RTBFabricClientConfig else { return }
...
public class DefaultAWSAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public func configureClient<Config: ClientRuntime.ClientConfiguration>(clientConfiguration: inout Config) async throws {
        if var config = clientConfiguration as? RTBFabricClient.RTBFabricClientConfig {
            config.authSchemeResolver = DefaultRTBFabricAuthSchemeResolver()
...
public class RTBFabricClientAuthSchemePlugin: ClientRuntime.Plugin {
