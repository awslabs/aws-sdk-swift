...
extension GetCapacityTaskOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> GetCapacityTaskOutput {
        ...
        value.completionDate = try reader["CompletionDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension OutpostsClientTypes.Order {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> OutpostsClientTypes.Order {
        ...
        value.orderSubmissionDate = try reader["OrderSubmissionDate"].readTimestampIfPresent(format: .epochSeconds)
        value.orderFulfilledDate = try reader["OrderFulfilledDate"].readTimestampIfPresent(format: .epochSeconds)
