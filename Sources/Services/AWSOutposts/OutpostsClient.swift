...
extension OutpostsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> OutpostsClient.OutpostsClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> OutpostsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return OutpostsClient(config: configuration)
        }
    }
...
extension OutpostsClient.OutpostsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
