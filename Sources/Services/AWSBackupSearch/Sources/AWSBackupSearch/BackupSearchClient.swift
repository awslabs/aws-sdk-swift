...
public final class BackupSearchClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "BackupSearchClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: BackupSearchClient.BackupSearchClientConfig
    let serviceName = "BackupSearch"

    @available(*, deprecated, message: "Use BackupSearchClient.BackupSearchClientConfig instead")
    public typealias Config = BackupSearchClient.BackupSearchClientConfiguration
    public typealias Configuration = BackupSearchClient.BackupSearchClientConfig

    public required init(config: BackupSearchClient.BackupSearchClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: BackupSearchClient.BackupSearchClientConfig) instead")
    public convenience init(config: BackupSearchClient.BackupSearchClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try BackupSearchClient.BackupSearchClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await BackupSearchClient.BackupSearchClientConfig()
        self.init(config: config)
    }
}
...
extension BackupSearchClient {
    ...
    /// Client configuration for BackupSearchClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct BackupSearchClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "BackupSearch")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultBackupSearchAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: BackupSearchClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use BackupSearchClientConfig instead. This class will be removed in a future version.")
    public final class BackupSearchClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> BackupSearchClientConfig {
            return try BackupSearchClientConfig(
...
extension BackupSearchClient {
    ...
    public func getSearchJob(input: GetSearchJobInput) async throws -> GetSearchJobOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "BackupSearch"))
