...
public struct ExceedsLimitException: ClientRuntime.ModeledError, AWSClientRuntime.AWSServiceError, ClientRuntime.HTTPError, Swift.Error, Swift.Sendable {
...
extension ExceedsLimitException {
    ...
    static func makeError(baseError: ClientRuntime.RestJSONError) throws -> ExceedsLimitException {
        let reader = baseError.errorBodyReader
...
extension EntityResolutionClientTypes.ResolutionTechniques {
    ...
    static func write(value: EntityResolutionClientTypes.ResolutionTechniques?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ruleConditionProperties"].write(value.ruleConditionProperties, with: EntityResolutionClientTypes.RuleConditionProperties.write(value:to:))
    }
