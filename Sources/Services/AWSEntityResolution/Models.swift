...
extension AddPolicyStatementInput {
    ...
    static func write(value: AddPolicyStatementInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["principal"].writeList(value.principal, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetMatchIdInput {
    ...
    static func write(value: GetMatchIdInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["record"].writeMap(value.record, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension BatchDeleteUniqueIdOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchDeleteUniqueIdOutput {
        ...
        value.disconnectedUniqueIds = try reader["disconnectedUniqueIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension EntityResolutionClientTypes.Rule {
    ...
    static func write(value: EntityResolutionClientTypes.Rule?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["matchingKeys"].writeList(value.matchingKeys, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EntityResolutionClientTypes.Rule {
        ...
        value.matchingKeys = try reader["matchingKeys"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension EntityResolutionClientTypes.ProviderIntermediateDataAccessConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EntityResolutionClientTypes.ProviderIntermediateDataAccessConfiguration {
        ...
        value.requiredBucketActions = try reader["requiredBucketActions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension EntityResolutionClientTypes.ProviderComponentSchema {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EntityResolutionClientTypes.ProviderComponentSchema {
        ...
        value.schemas = try reader["schemas"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
