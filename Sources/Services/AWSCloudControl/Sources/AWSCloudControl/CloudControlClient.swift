...
public final class CloudControlClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: CloudControlClient.CloudControlClientConfig) instead")
    public convenience init(config: CloudControlClient.CloudControlClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try CloudControlClient.CloudControlClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await CloudControlClient.CloudControlClientConfig()
        self.init(config: config)
    }
}
...
extension CloudControlClient {
    ...
    /// Client configuration for CloudControlClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct CloudControlClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "CloudControl")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: CloudControlClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultCloudControlAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use CloudControlClientConfig instead. This class will be removed in a future version.")
    public final class CloudControlClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> CloudControlClientConfig {
            return try CloudControlClientConfig(
...
extension CloudControlClient {
    /// Performs the `CancelResourceRequest` operation on the `CloudControl` service.
    ///
    ...
    public func cancelResourceRequest(input: CancelResourceRequestInput) async throws -> CancelResourceRequestOutput {
        ...
        let operation = CloudControlClient.cancelResourceRequestOperation
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("CloudControl", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CancelResourceRequestOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CancelResourceRequestInput, CancelResourceRequestOutput>(overrides: ["X-Amz-Target": "CloudApiService.CancelResourceRequest"]))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudControl"))
    ...
    /// Performs the `CreateResource` operation on the `CloudControl` service.
    ///
    ...
    public func createResource(input: CreateResourceInput) async throws -> CreateResourceOutput {
        ...
        let operation = CloudControlClient.createResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateResourceInput, CreateResourceOutput>(overrides: ["X-Amz-Target": "CloudApiService.CreateResource"]))
    ...
    /// Performs the `DeleteResource` operation on the `CloudControl` service.
    ///
    ...
    public func deleteResource(input: DeleteResourceInput) async throws -> DeleteResourceOutput {
        ...
        let operation = CloudControlClient.deleteResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteResourceInput, DeleteResourceOutput>(overrides: ["X-Amz-Target": "CloudApiService.DeleteResource"]))
    ...
    /// Performs the `GetResource` operation on the `CloudControl` service.
    ///
    ...
    public func getResource(input: GetResourceInput) async throws -> GetResourceOutput {
        ...
        let operation = CloudControlClient.getResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetResourceInput, GetResourceOutput>(overrides: ["X-Amz-Target": "CloudApiService.GetResource"]))
    ...
    /// Performs the `GetResourceRequestStatus` operation on the `CloudControl` service.
    ///
    ...
    public func getResourceRequestStatus(input: GetResourceRequestStatusInput) async throws -> GetResourceRequestStatusOutput {
        ...
        let operation = CloudControlClient.getResourceRequestStatusOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetResourceRequestStatusOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetResourceRequestStatusInput, GetResourceRequestStatusOutput>(overrides: ["X-Amz-Target": "CloudApiService.GetResourceRequestStatus"]))
    ...
    /// Performs the `ListResourceRequests` operation on the `CloudControl` service.
    ///
    ...
    public func listResourceRequests(input: ListResourceRequestsInput) async throws -> ListResourceRequestsOutput {
        ...
        let operation = CloudControlClient.listResourceRequestsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListResourceRequestsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListResourceRequestsInput, ListResourceRequestsOutput>(overrides: ["X-Amz-Target": "CloudApiService.ListResourceRequests"]))
    ...
    /// Performs the `ListResources` operation on the `CloudControl` service.
    ///
    ...
    public func listResources(input: ListResourcesInput) async throws -> ListResourcesOutput {
        ...
        let operation = CloudControlClient.listResourcesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListResourcesInput, ListResourcesOutput>(overrides: ["X-Amz-Target": "CloudApiService.ListResources"]))
    ...
    /// Performs the `UpdateResource` operation on the `CloudControl` service.
    ///
    ...
    public func updateResource(input: UpdateResourceInput) async throws -> UpdateResourceOutput {
        ...
        let operation = CloudControlClient.updateResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateResourceInput, UpdateResourceOutput>(overrides: ["X-Amz-Target": "CloudApiService.UpdateResource"]))
