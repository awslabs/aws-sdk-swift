...
extension TimestreamQueryClientTypes {
    ...
    public enum QueryPricingModel: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case bytesScanned
        case computeUnits
        case sdkUnknown(Swift.String)
...
extension TimestreamQueryClientTypes.ScheduledQuery {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TimestreamQueryClientTypes.ScheduledQuery {
        ...
        value.previousInvocationTime = try reader["PreviousInvocationTime"].readTimestampIfPresent(format: .epochSeconds)
        value.nextInvocationTime = try reader["NextInvocationTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension TimestreamQueryClientTypes {
    ...
    public enum ScheduledQueryRunStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension TimestreamQueryClientTypes.ScheduledQueryRunSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TimestreamQueryClientTypes.ScheduledQueryRunSummary {
        ...
        value.invocationTime = try reader["InvocationTime"].readTimestampIfPresent(format: .epochSeconds)
        value.triggerTime = try reader["TriggerTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension TimestreamQueryClientTypes {
    ...
    public enum ScheduledQueryState: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case disabled
        case enabled
        case sdkUnknown(Swift.String)
