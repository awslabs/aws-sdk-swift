...
extension TimestreamQueryClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> TimestreamQueryClient.TimestreamQueryClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> TimestreamQueryClient {
            let configuration = try await resolve(plugins: self.plugins)
            return TimestreamQueryClient(config: configuration)
        }
    }
...
extension TimestreamQueryClient.TimestreamQueryClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
