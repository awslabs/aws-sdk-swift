...
extension SendInvitesInput {
    ...
    static func write(value: SendInvitesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["accessorIds"].writeList(value.accessorIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GetSpaceOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetSpaceOutput {
        ...
        value.createDateTime = try reader["createDateTime"].readTimestampIfPresent(format: .dateTime)
        value.customerRoleArn = try reader["customerRoleArn"].readIfPresent()
        value.deleteDateTime = try reader["deleteDateTime"].readTimestampIfPresent(format: .dateTime)
        value.description = try reader["description"].readIfPresent()
        value.groupAdmins = try reader["groupAdmins"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.userAdmins = try reader["userAdmins"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
