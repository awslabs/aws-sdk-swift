...
public final class RepostspaceClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: RepostspaceClient.RepostspaceClientConfig) instead")
    public convenience init(config: RepostspaceClient.RepostspaceClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try RepostspaceClient.RepostspaceClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await RepostspaceClient.RepostspaceClientConfig()
        self.init(config: config)
    }
}
...
extension RepostspaceClient {
    ...
    /// Client configuration for RepostspaceClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct RepostspaceClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "repostspace")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultRepostspaceAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: RepostspaceClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use RepostspaceClientConfig instead. This class will be removed in a future version.")
    public final class RepostspaceClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> RepostspaceClientConfig {
            return try RepostspaceClientConfig(
...
extension RepostspaceClient {
    ...
    public func batchAddChannelRoleToAccessors(input: BatchAddChannelRoleToAccessorsInput) async throws -> BatchAddChannelRoleToAccessorsOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "repostspace"))
