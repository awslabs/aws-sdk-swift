...
public final class DirectoryServiceDataClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: DirectoryServiceDataClient.DirectoryServiceDataClientConfig) instead")
    public convenience init(config: DirectoryServiceDataClient.DirectoryServiceDataClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try DirectoryServiceDataClient.DirectoryServiceDataClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await DirectoryServiceDataClient.DirectoryServiceDataClientConfig()
        self.init(config: config)
    }
}
...
extension DirectoryServiceDataClient {
    ...
    /// Client configuration for DirectoryServiceDataClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct DirectoryServiceDataClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Directory Service Data")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultDirectoryServiceDataAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: DirectoryServiceDataClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultDirectoryServiceDataAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use DirectoryServiceDataClientConfig instead. This class will be removed in a future version.")
    public final class DirectoryServiceDataClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> DirectoryServiceDataClientConfig {
            return try DirectoryServiceDataClientConfig(
...
extension DirectoryServiceDataClient {
    ...
    public func addGroupMember(input: AddGroupMemberInput) async throws -> AddGroupMemberOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Directory Service Data", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<AddGroupMemberOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Directory Service Data"))
    ...
    public func listGroupsForMember(input: ListGroupsForMemberInput) async throws -> ListGroupsForMemberOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListGroupsForMemberOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func removeGroupMember(input: RemoveGroupMemberInput) async throws -> RemoveGroupMemberOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<RemoveGroupMemberOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func searchGroups(input: SearchGroupsInput) async throws -> SearchGroupsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SearchGroupsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func searchUsers(input: SearchUsersInput) async throws -> SearchUsersOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SearchUsersOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
