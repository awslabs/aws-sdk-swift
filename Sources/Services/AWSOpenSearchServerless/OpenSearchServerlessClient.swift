...
extension OpenSearchServerlessClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> OpenSearchServerlessClient.OpenSearchServerlessClientConfiguration {
        let clientConfiguration = try await OpenSearchServerlessClient.OpenSearchServerlessClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> OpenSearchServerlessClient {
            let configuration = try await resolve(plugins: self.plugins)
            return OpenSearchServerlessClient(config: configuration)
        }
    }
...
extension OpenSearchServerlessClient.OpenSearchServerlessClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
