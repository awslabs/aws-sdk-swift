...
extension StartLoaderJobInput {
    ...
    static func write(value: StartLoaderJobInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["dependencies"].writeList(value.dependencies, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["parserConfiguration"].writeMap(value.parserConfiguration, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GetEngineStatusOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetEngineStatusOutput {
        ...
        value.features = try reader["features"].readMapIfPresent(valueReadingClosure: SmithyReadWrite.Document.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.gremlin = try reader["gremlin"].readIfPresent(with: NeptunedataClientTypes.QueryLanguageVersion.read(from:))
        value.labMode = try reader["labMode"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        ...
        value.settings = try reader["settings"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GetPropertygraphStreamOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetPropertygraphStreamOutput {
        ...
        value.lastEventId = try reader["lastEventId"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension StartLoaderJobOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> StartLoaderJobOutput {
        ...
        value.payload = try reader["payload"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.status = try reader["status"].readIfPresent()
        return value
    }
}
...
extension NeptunedataClientTypes.PropertygraphRecord {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NeptunedataClientTypes.PropertygraphRecord {
        ...
        value.eventId = try reader["eventId"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension NeptunedataClientTypes.PropertygraphSummaryValueMap {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NeptunedataClientTypes.PropertygraphSummaryValueMap {
        ...
        value.version = try reader["version"].readIfPresent()
        value.lastStatisticsComputationTime = try reader["lastStatisticsComputationTime"].readTimestampIfPresent(format: .dateTime)
...
extension NeptunedataClientTypes.PropertygraphSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NeptunedataClientTypes.PropertygraphSummary {
        ...
        value.nodeLabels = try reader["nodeLabels"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.edgeLabels = try reader["edgeLabels"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.nodeProperties = try reader["nodeProperties"].readListIfPresent(memberReadingClosure: mapReadingClosure(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
        value.edgeProperties = try reader["edgeProperties"].readListIfPresent(memberReadingClosure: mapReadingClosure(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
...
extension NeptunedataClientTypes.EdgeStructure {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NeptunedataClientTypes.EdgeStructure {
        ...
        value.edgeProperties = try reader["edgeProperties"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension NeptunedataClientTypes.NodeStructure {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NeptunedataClientTypes.NodeStructure {
        ...
        value.count = try reader["count"].readIfPresent()
        value.nodeProperties = try reader["nodeProperties"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.distinctOutgoingEdgeLabels = try reader["distinctOutgoingEdgeLabels"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension NeptunedataClientTypes.RDFGraphSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NeptunedataClientTypes.RDFGraphSummary {
        ...
        value.classes = try reader["classes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.predicates = try reader["predicates"].readListIfPresent(memberReadingClosure: mapReadingClosure(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
...
extension NeptunedataClientTypes.SubjectStructure {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NeptunedataClientTypes.SubjectStructure {
        ...
        value.count = try reader["count"].readIfPresent()
        value.predicates = try reader["predicates"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension NeptunedataClientTypes.LoaderIdResult {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NeptunedataClientTypes.LoaderIdResult {
        ...
        value.loadIds = try reader["loadIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
