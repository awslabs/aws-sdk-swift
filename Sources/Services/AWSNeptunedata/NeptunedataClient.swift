...
extension NeptunedataClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> NeptunedataClient.NeptunedataClientConfiguration {
        let clientConfiguration = try await NeptunedataClient.NeptunedataClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> NeptunedataClient {
            let configuration = try await resolve(plugins: self.plugins)
            return NeptunedataClient(config: configuration)
        }
    }
...
extension NeptunedataClient.NeptunedataClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
