...
extension HealthClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> HealthClient.HealthClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> HealthClient {
            let configuration = try await resolve(plugins: self.plugins)
            return HealthClient(config: configuration)
        }
    }
...
extension HealthClient.HealthClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
