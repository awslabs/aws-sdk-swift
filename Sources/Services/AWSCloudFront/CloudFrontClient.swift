...
extension CloudFrontClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CloudFrontClient.CloudFrontClientConfiguration {
        let clientConfiguration = try await CloudFrontClient.CloudFrontClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CloudFrontClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CloudFrontClient(config: configuration)
        }
    }
...
extension CloudFrontClient.CloudFrontClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
