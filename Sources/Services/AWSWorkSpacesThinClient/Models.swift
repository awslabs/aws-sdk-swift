...
extension WorkSpacesThinClientClientTypes.MaintenanceWindow {
    ...
    static func write(value: WorkSpacesThinClientClientTypes.MaintenanceWindow?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["daysOfTheWeek"].writeList(value.daysOfTheWeek, memberWritingClosure: WorkSpacesThinClientClientTypes.DayOfWeek.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkSpacesThinClientClientTypes.MaintenanceWindow {
        ...
        value.daysOfTheWeek = try reader["daysOfTheWeek"].readListIfPresent(memberReadingClosure: WorkSpacesThinClientClientTypes.DayOfWeek.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension WorkSpacesThinClientClientTypes.Device {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkSpacesThinClientClientTypes.Device {
        ...
        value.lastConnectedAt = try reader["lastConnectedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.lastPostureAt = try reader["lastPostureAt"].readTimestampIfPresent(format: .epochSeconds)
        value.createdAt = try reader["createdAt"].readTimestampIfPresent(format: .epochSeconds)
        value.updatedAt = try reader["updatedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.arn = try reader["arn"].readIfPresent()
...
extension WorkSpacesThinClientClientTypes.SoftwareSet {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkSpacesThinClientClientTypes.SoftwareSet {
        ...
        value.releasedAt = try reader["releasedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.supportedUntil = try reader["supportedUntil"].readTimestampIfPresent(format: .epochSeconds)
