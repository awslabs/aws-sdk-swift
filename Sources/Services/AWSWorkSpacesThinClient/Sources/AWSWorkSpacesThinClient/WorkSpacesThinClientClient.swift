...
public final class WorkSpacesThinClientClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "WorkSpacesThinClientClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: WorkSpacesThinClientClient.WorkSpacesThinClientClientConfig
    let serviceName = "WorkSpaces Thin Client"

    @available(*, deprecated, message: "Use WorkSpacesThinClientClient.WorkSpacesThinClientClientConfig instead")
    public typealias Config = WorkSpacesThinClientClient.WorkSpacesThinClientClientConfiguration
    public typealias Configuration = WorkSpacesThinClientClient.WorkSpacesThinClientClientConfig

    public required init(config: WorkSpacesThinClientClient.WorkSpacesThinClientClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: WorkSpacesThinClientClient.WorkSpacesThinClientClientConfig) instead")
    public convenience init(config: WorkSpacesThinClientClient.WorkSpacesThinClientClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try WorkSpacesThinClientClient.WorkSpacesThinClientClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await WorkSpacesThinClientClient.WorkSpacesThinClientClientConfig()
        self.init(config: config)
    }
}
...
extension WorkSpacesThinClientClient {
    ...
    /// Client configuration for WorkSpacesThinClientClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct WorkSpacesThinClientClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "WorkSpaces Thin Client")
    ...
    @available(*, deprecated, message: "Use WorkSpacesThinClientClientConfig instead. This class will be removed in a future version.")
    public final class WorkSpacesThinClientClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> WorkSpacesThinClientClientConfig {
            return try WorkSpacesThinClientClientConfig(
...
extension WorkSpacesThinClientClient {
    ...
    public func createEnvironment(input: CreateEnvironmentInput) async throws -> CreateEnvironmentOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "WorkSpaces Thin Client"))
