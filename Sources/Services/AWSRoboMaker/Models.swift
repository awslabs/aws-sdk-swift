...
extension CreateRobotApplicationVersionInput {
    ...
    static func write(value: CreateRobotApplicationVersionInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["s3Etags"].writeList(value.s3Etags, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension CreateWorldGenerationJobInput {
    ...
    static func write(value: CreateWorldGenerationJobInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["worldTags"].writeMap(value.worldTags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension BatchDeleteWorldsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchDeleteWorldsOutput {
        ...
        value.unprocessedWorlds = try reader["unprocessedWorlds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BatchDescribeSimulationJobOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchDescribeSimulationJobOutput {
        ...
        value.unprocessedJobs = try reader["unprocessedJobs"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CreateWorldGenerationJobOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateWorldGenerationJobOutput {
        ...
        value.worldTags = try reader["worldTags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension DescribeFleetOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeFleetOutput {
        ...
        value.lastDeploymentTime = try reader["lastDeploymentTime"].readTimestampIfPresent(format: .epochSeconds)
        value.name = try reader["name"].readIfPresent()
...
extension DescribeWorldExportJobOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeWorldExportJobOutput {
        ...
        value.status = try reader["status"].readIfPresent()
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.worlds = try reader["worlds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension RoboMakerClientTypes.RobotDeployment {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RoboMakerClientTypes.RobotDeployment {
        ...
        value.deploymentFinishTime = try reader["deploymentFinishTime"].readTimestampIfPresent(format: .epochSeconds)
        value.status = try reader["status"].readIfPresent()
...
extension RoboMakerClientTypes.FailedCreateSimulationJobRequest {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RoboMakerClientTypes.FailedCreateSimulationJobRequest {
        ...
        value.failureReason = try reader["failureReason"].readIfPresent()
        value.failureCode = try reader["failureCode"].readIfPresent()
        value.failedAt = try reader["failedAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension RoboMakerClientTypes.SimulationJobSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RoboMakerClientTypes.SimulationJobSummary {
        ...
        value.name = try reader["name"].readIfPresent()
        value.status = try reader["status"].readIfPresent()
        value.simulationApplicationNames = try reader["simulationApplicationNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.robotApplicationNames = try reader["robotApplicationNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.dataSourceNames = try reader["dataSourceNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.computeType = try reader["computeType"].readIfPresent()
        return value
    }
}
...
extension RoboMakerClientTypes.FinishedWorldsSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RoboMakerClientTypes.FinishedWorldsSummary {
        ...
        value.succeededWorlds = try reader["succeededWorlds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
