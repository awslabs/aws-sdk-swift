...
public final class S3TablesClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: S3TablesClient.S3TablesClientConfig) instead")
    public convenience init(config: S3TablesClient.S3TablesClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try S3TablesClient.S3TablesClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await S3TablesClient.S3TablesClientConfig()
        self.init(config: config)
    }
}
...
extension S3TablesClient {
    ...
    /// Client configuration for S3TablesClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct S3TablesClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "S3Tables")
    ...
    @available(*, deprecated, message: "Use S3TablesClientConfig instead. This class will be removed in a future version.")
    public final class S3TablesClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> S3TablesClientConfig {
            return try S3TablesClientConfig(
...
extension S3TablesClient {
    ...
    public func createNamespace(input: CreateNamespaceInput) async throws -> CreateNamespaceOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "S3Tables"))
