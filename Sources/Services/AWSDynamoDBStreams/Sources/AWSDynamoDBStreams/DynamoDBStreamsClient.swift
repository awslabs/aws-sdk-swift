...
public final class DynamoDBStreamsClient: AWSClientRuntime.AWSServiceClient {
    ...
    public let config: DynamoDBStreamsClient.DynamoDBStreamsClientConfig
    let serviceName = "DynamoDB Streams"
    let retryStrategy: SmithyRetries.DefaultRetryStrategy

    @available(*, deprecated, message: "Use DynamoDBStreamsClient.DynamoDBStreamsClientConfig instead")
    public typealias Config = DynamoDBStreamsClient.DynamoDBStreamsClientConfiguration
    public typealias Configuration = DynamoDBStreamsClient.DynamoDBStreamsClientConfig

    public required init(config: DynamoDBStreamsClient.DynamoDBStreamsClientConfig) {
    ...
    @available(*, deprecated, message: "Use init(config: DynamoDBStreamsClient.DynamoDBStreamsClientConfig) instead")
    public convenience init(config: DynamoDBStreamsClient.DynamoDBStreamsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try DynamoDBStreamsClient.DynamoDBStreamsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await DynamoDBStreamsClient.DynamoDBStreamsClientConfig()
        self.init(config: config)
    }
}
...
extension DynamoDBStreamsClient {
    ...
    /// Client configuration for DynamoDBStreamsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct DynamoDBStreamsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "DynamoDB Streams")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultDynamoDBStreamsAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: DynamoDBStreamsClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultDynamoDBStreamsAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use DynamoDBStreamsClientConfig instead. This class will be removed in a future version.")
    public final class DynamoDBStreamsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> DynamoDBStreamsClientConfig {
            return try DynamoDBStreamsClientConfig(
...
extension DynamoDBStreamsClient {
    /// Performs the `DescribeStream` operation on the `DynamoDBStreams` service.
    ///
    ...
    public func describeStream(input: DescribeStreamInput) async throws -> DescribeStreamOutput {
        ...
        let operation = DynamoDBStreamsClient.describeStreamOperation
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("DynamoDB Streams", config.ignoreConfiguredEndpointURLs)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeStreamInput, DescribeStreamOutput>(overrides: ["X-Amz-Target": "DynamoDBStreams_20120810.DescribeStream"]))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "DynamoDB Streams"))
    ...
    /// Performs the `GetRecords` operation on the `DynamoDBStreams` service.
    ///
    ...
    public func getRecords(input: GetRecordsInput) async throws -> GetRecordsOutput {
        ...
        let operation = DynamoDBStreamsClient.getRecordsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetRecordsInput, GetRecordsOutput>(overrides: ["X-Amz-Target": "DynamoDBStreams_20120810.GetRecords"]))
    ...
    /// Performs the `GetShardIterator` operation on the `DynamoDBStreams` service.
    ///
    ...
    public func getShardIterator(input: GetShardIteratorInput) async throws -> GetShardIteratorOutput {
        ...
        let operation = DynamoDBStreamsClient.getShardIteratorOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetShardIteratorInput, GetShardIteratorOutput>(overrides: ["X-Amz-Target": "DynamoDBStreams_20120810.GetShardIterator"]))
    ...
    /// Performs the `ListStreams` operation on the `DynamoDBStreams` service.
    ///
    ...
    public func listStreams(input: ListStreamsInput) async throws -> ListStreamsOutput {
        ...
        let operation = DynamoDBStreamsClient.listStreamsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListStreamsInput, ListStreamsOutput>(overrides: ["X-Amz-Target": "DynamoDBStreams_20120810.ListStreams"]))
