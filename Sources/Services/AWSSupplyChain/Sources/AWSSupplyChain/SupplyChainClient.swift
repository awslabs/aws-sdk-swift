...
public final class SupplyChainClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: SupplyChainClient.SupplyChainClientConfig) instead")
    public convenience init(config: SupplyChainClient.SupplyChainClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try SupplyChainClient.SupplyChainClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await SupplyChainClient.SupplyChainClientConfig()
        self.init(config: config)
    }
}
...
extension SupplyChainClient {
    ...
    /// Client configuration for SupplyChainClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct SupplyChainClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "SupplyChain")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultSupplyChainAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: SupplyChainClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use SupplyChainClientConfig instead. This class will be removed in a future version.")
    public final class SupplyChainClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> SupplyChainClientConfig {
            return try SupplyChainClientConfig(
...
extension SupplyChainClient {
    ...
    public func createBillOfMaterialsImportJob(input: CreateBillOfMaterialsImportJobInput) async throws -> CreateBillOfMaterialsImportJobOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SupplyChain"))
