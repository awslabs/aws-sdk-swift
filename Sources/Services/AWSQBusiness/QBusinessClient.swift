...
extension QBusinessClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> QBusinessClient.QBusinessClientConfiguration {
        let clientConfiguration = try await QBusinessClient.QBusinessClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> QBusinessClient {
            let configuration = try await resolve(plugins: self.plugins)
            return QBusinessClient(config: configuration)
        }
    }
...
extension QBusinessClient.QBusinessClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
