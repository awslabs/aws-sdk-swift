...
public class ChimeSDKMediaPipelinesClientEndpointPlugin: Plugin {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ChimeSDKMediaPipelinesClient.ChimeSDKMediaPipelinesClientConfiguration {
            config.authSchemeResolver = DefaultChimeSDKMediaPipelinesAuthSchemeResolver()
...
public class ChimeSDKMediaPipelinesClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: ChimeSDKMediaPipelinesAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
