...
extension ChimeSDKMediaPipelinesClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ChimeSDKMediaPipelinesClient.ChimeSDKMediaPipelinesClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> ChimeSDKMediaPipelinesClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ChimeSDKMediaPipelinesClient(config: configuration)
        }
    }
...
extension ChimeSDKMediaPipelinesClient.ChimeSDKMediaPipelinesClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
