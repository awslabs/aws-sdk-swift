...
extension CodeartifactClientTypes.AssetSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeartifactClientTypes.AssetSummary {
        ...
        value.hashes = try reader["hashes"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension CopyPackageVersionsInput {
    ...
    static func write(value: CopyPackageVersionsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["versionRevisions"].writeMap(value.versionRevisions, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ListAllowedRepositoriesForGroupOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAllowedRepositoriesForGroupOutput {
        ...
        value.allowedRepositories = try reader["allowedRepositories"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension UpdatePackageGroupOriginConfigurationInput {
    ...
    static func write(value: UpdatePackageGroupOriginConfigurationInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["restrictions"].writeMap(value.restrictions, valueWritingClosure: CodeartifactClientTypes.PackageGroupOriginRestrictionMode.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
