...
public struct DefaultCodeartifactAuthSchemeResolver: CodeartifactAuthSchemeResolver {
    ...
    public func resolveAuthScheme(params: SmithyHTTPAuthAPI.AuthSchemeResolverParameters) throws -> [SmithyHTTPAuthAPI.AuthOption] {
        ...
        switch serviceParams.operation {
            default:
                ...
                sigv4Option.signingProperties.set(key: SmithyHTTPAuthAPI.SigningPropertyKeys.signingName, value: "codeartifact")
    ...
    public func constructParameters(context: Smithy.Context) throws -> SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
        ...
        return CodeartifactAuthSchemeResolverParameters(authSchemePreference: authSchemePreference, operation: opName, region: opRegion)
    }
}
