...
extension CodeartifactClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CodeartifactClient.CodeartifactClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> CodeartifactClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CodeartifactClient(config: configuration)
        }
    }
...
extension CodeartifactClient.CodeartifactClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
