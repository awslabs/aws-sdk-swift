...
public class CodeartifactClientEndpointPlugin: Plugin {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? CodeartifactClient.CodeartifactClientConfiguration {
            config.authSchemeResolver = DefaultCodeartifactAuthSchemeResolver()
...
public class CodeartifactClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: CodeartifactAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
