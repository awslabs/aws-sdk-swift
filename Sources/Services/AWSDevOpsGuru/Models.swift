...
extension DevOpsGuruClientTypes.AnomalyReportedTimeRange {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DevOpsGuruClientTypes.AnomalyReportedTimeRange {
        ...
        value.openTime = try reader["OpenTime"].readTimestampIfPresent(format: .epochSeconds)
        value.closeTime = try reader["CloseTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DevOpsGuruClientTypes.AnomalousLogGroup {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DevOpsGuruClientTypes.AnomalousLogGroup {
        ...
        value.impactStartTime = try reader["ImpactStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.impactEndTime = try reader["ImpactEndTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension DevOpsGuruClientTypes.LogAnomalyClass {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DevOpsGuruClientTypes.LogAnomalyClass {
        ...
        value.logEventTimestamp = try reader["LogEventTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DevOpsGuruClientTypes.ProactiveInsightSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DevOpsGuruClientTypes.ProactiveInsightSummary {
        ...
        value.associatedResourceArns = try reader["AssociatedResourceArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DevOpsGuruClientTypes.ServiceCollection {
    ...
    static func write(value: DevOpsGuruClientTypes.ServiceCollection?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ServiceNames"].writeList(value.serviceNames, memberWritingClosure: DevOpsGuruClientTypes.ServiceName.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DevOpsGuruClientTypes.ServiceCollection {
        ...
        value.serviceNames = try reader["ServiceNames"].readListIfPresent(memberReadingClosure: DevOpsGuruClientTypes.ServiceName.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DevOpsGuruClientTypes.NotificationFilterConfig {
    ...
    static func write(value: DevOpsGuruClientTypes.NotificationFilterConfig?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["MessageTypes"].writeList(value.messageTypes, memberWritingClosure: DevOpsGuruClientTypes.NotificationMessageType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DevOpsGuruClientTypes.NotificationFilterConfig {
        ...
        value.messageTypes = try reader["MessageTypes"].readListIfPresent(memberReadingClosure: DevOpsGuruClientTypes.NotificationMessageType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
