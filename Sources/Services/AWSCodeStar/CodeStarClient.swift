...
extension CodeStarClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CodeStarClient.CodeStarClientConfiguration {
        let clientConfiguration = try await CodeStarClient.CodeStarClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CodeStarClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CodeStarClient(config: configuration)
        }
    }
...
extension CodeStarClient.CodeStarClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
