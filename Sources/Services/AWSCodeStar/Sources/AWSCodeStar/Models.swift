...
extension CodeStarClientTypes.Toolchain: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Toolchain(roleArn: \(Swift.String(describing: roleArn)), source: \(Swift.String(describing: source)), stackParameters: [keys: \(Swift.String(describing: stackParameters?.keys)), values: \"CONTENT_REDACTED\"])"}
}
...
extension CodeStarClientTypes.Toolchain {
    ...
    static func write(value: CodeStarClientTypes.Toolchain?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["stackParameters"].writeMap(value.stackParameters, valueWritingClosure: SmithyReadWrite.WritingClosures.writeString(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
