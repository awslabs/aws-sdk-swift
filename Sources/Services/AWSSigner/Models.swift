...
extension GetRevocationStatusInput {
    ...
    static func queryItemProvider(_ value: GetRevocationStatusInput) throws -> [Smithy.URIQueryItem] {
        ...
        let signatureTimestampQueryItem = Smithy.URIQueryItem(name: "signatureTimestamp".urlPercentEncoding(), value: Swift.String(TimestampFormatter(format: .dateTime).string(from: signatureTimestamp)).urlPercentEncoding())
...
extension ListSigningJobsInput {
    ...
    static func queryItemProvider(_ value: ListSigningJobsInput) throws -> [Smithy.URIQueryItem] {
        ...
        if let signatureExpiresBefore = value.signatureExpiresBefore {
            let signatureExpiresBeforeQueryItem = Smithy.URIQueryItem(name: "signatureExpiresBefore".urlPercentEncoding(), value: Swift.String(TimestampFormatter(format: .dateTime).string(from: signatureExpiresBefore)).urlPercentEncoding())
        ...
        if let signatureExpiresAfter = value.signatureExpiresAfter {
            let signatureExpiresAfterQueryItem = Smithy.URIQueryItem(name: "signatureExpiresAfter".urlPercentEncoding(), value: Swift.String(TimestampFormatter(format: .dateTime).string(from: signatureExpiresAfter)).urlPercentEncoding())
...
extension DescribeSigningJobOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeSigningJobOutput {
        ...
        value.signingParameters = try reader["signingParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GetRevocationStatusOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetRevocationStatusOutput {
        ...
        value.revokedEntities = try reader["revokedEntities"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SignerClientTypes.HashAlgorithmOptions {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SignerClientTypes.HashAlgorithmOptions {
        ...
        value.allowedValues = try reader["allowedValues"].readListIfPresent(memberReadingClosure: SignerClientTypes.HashAlgorithm.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension SignerClientTypes.EncryptionAlgorithmOptions {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SignerClientTypes.EncryptionAlgorithmOptions {
        ...
        value.allowedValues = try reader["allowedValues"].readListIfPresent(memberReadingClosure: SignerClientTypes.EncryptionAlgorithm.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.defaultValue = try reader["defaultValue"].readIfPresent()
        return value
    }
}
...
extension SignerClientTypes.SigningImageFormat {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SignerClientTypes.SigningImageFormat {
        ...
        value.supportedFormats = try reader["supportedFormats"].readListIfPresent(memberReadingClosure: SignerClientTypes.ImageFormat.read(from:), memberNodeInfo: "member", isFlattened: false)
