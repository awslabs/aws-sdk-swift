...
extension SignerClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SignerClient.SignerClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> SignerClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SignerClient(config: configuration)
        }
    }
...
extension SignerClient.SignerClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
