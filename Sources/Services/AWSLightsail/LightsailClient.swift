...
public class LightsailClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await LightsailClientConfiguration(region: region)
    ...
    public class LightsailClientConfiguration: LightsailClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("LightsailClient")
