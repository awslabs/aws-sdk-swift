...
extension DescribeAcceleratorOfferingsInput {
    ...
    static func write(value: DescribeAcceleratorOfferingsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["acceleratorTypes"].writeList(value.acceleratorTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeAcceleratorOfferingsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeAcceleratorOfferingsOutput {
...
extension DescribeAcceleratorTypesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeAcceleratorTypesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeAcceleratorsInput {
    ...
    static func write(value: DescribeAcceleratorsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["acceleratorIds"].writeList(value.acceleratorIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeAcceleratorsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeAcceleratorsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
