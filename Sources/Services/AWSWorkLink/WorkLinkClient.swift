...
extension WorkLinkClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> WorkLinkClient.WorkLinkClientConfiguration {
        let clientConfiguration = try await WorkLinkClient.WorkLinkClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> WorkLinkClient {
            let configuration = try await resolve(plugins: self.plugins)
            return WorkLinkClient(config: configuration)
        }
    }
...
extension WorkLinkClient.WorkLinkClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
