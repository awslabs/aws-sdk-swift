...
public class OpsWorksClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await OpsWorksClientConfiguration(region: region)
    ...
    public class OpsWorksClientConfiguration: OpsWorksClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("OpsWorksClient")
