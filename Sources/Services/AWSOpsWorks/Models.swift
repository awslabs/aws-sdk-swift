...
extension OpsWorksClientTypes {
    ...
    public enum AppAttributesKeys: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension OpsWorksClientTypes {
    ...
    public enum AutoScalingType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case load
        case timer
        case sdkUnknown(Swift.String)
...
extension OpsWorksClientTypes {
    ...
    public enum StackAttributesKeys: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case color
        case sdkUnknown(Swift.String)
...
extension OpsWorksClientTypes {
    ...
    public enum RootDeviceType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case ebs
        case instanceStore
        case sdkUnknown(Swift.String)
...
extension OpsWorksClientTypes {
    ...
    public enum CloudWatchLogsEncoding: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case ascii
        case big5
        case big5hkscs
        case cp037
...
extension OpsWorksClientTypes {
    ...
    public enum CloudWatchLogsInitialPosition: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case endOfFile
        case startOfFile
        case sdkUnknown(Swift.String)
...
extension OpsWorksClientTypes {
    ...
    public enum CloudWatchLogsTimeZone: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case local
        case utc
        case sdkUnknown(Swift.String)
...
extension OpsWorksClientTypes {
    ...
    public enum DeploymentCommandName: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case configure
        case deploy
        case executeRecipes
...
extension OpsWorksClientTypes {
    ...
    public enum LayerAttributesKeys: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case bundlerversion
        case ecsclusterarn
...
extension OpsWorksClientTypes {
    ...
    public enum LayerType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case awsFlowRuby
        case custom
        case dbMaster
        case ecsCluster
...
extension OpsWorksClientTypes {
    ...
    public enum VirtualizationType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case hvm
        case paravirtual
        case sdkUnknown(Swift.String)
...
extension CloneStackInput {
    ...
    static func write(value: CloneStackInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["CloneAppIds"].writeList(value.cloneAppIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeAppsInput {
    ...
    static func write(value: DescribeAppsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AppIds"].writeList(value.appIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["StackId"].write(value.stackId)
    }
}
...
extension DescribeCommandsInput {
    ...
    static func write(value: DescribeCommandsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CommandIds"].writeList(value.commandIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeDeploymentsInput {
    ...
    static func write(value: DescribeDeploymentsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AppId"].write(value.appId)
        try writer["DeploymentIds"].writeList(value.deploymentIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["StackId"].write(value.stackId)
    }
}
...
extension DescribeEcsClustersInput {
    ...
    static func write(value: DescribeEcsClustersInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["EcsClusterArns"].writeList(value.ecsClusterArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeRaidArraysInput {
    ...
    static func write(value: DescribeRaidArraysInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["InstanceId"].write(value.instanceId)
        try writer["RaidArrayIds"].writeList(value.raidArrayIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["StackId"].write(value.stackId)
    }
}
...
extension DescribeRdsDbInstancesInput {
    ...
    static func write(value: DescribeRdsDbInstancesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["RdsDbInstanceArns"].writeList(value.rdsDbInstanceArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["StackId"].write(value.stackId)
    }
}
...
extension DescribeServiceErrorsInput {
    ...
    static func write(value: DescribeServiceErrorsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["InstanceId"].write(value.instanceId)
        try writer["ServiceErrorIds"].writeList(value.serviceErrorIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["StackId"].write(value.stackId)
    }
}
...
extension DescribeStacksInput {
    ...
    static func write(value: DescribeStacksInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["StackIds"].writeList(value.stackIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeUserProfilesInput {
    ...
    static func write(value: DescribeUserProfilesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["IamUserArns"].writeList(value.iamUserArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeVolumesInput {
    ...
    static func write(value: DescribeVolumesInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["StackId"].write(value.stackId)
        try writer["VolumeIds"].writeList(value.volumeIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension OpsWorksClientTypes.App {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> OpsWorksClientTypes.App {
        ...
        value.domains = try reader["Domains"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension OpsWorksClientTypes.Deployment {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> OpsWorksClientTypes.Deployment {
        ...
        value.instanceIds = try reader["InstanceIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension OpsWorksClientTypes.DeploymentCommand {
    ...
    static func write(value: OpsWorksClientTypes.DeploymentCommand?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Args"].writeMap(value.args, valueWritingClosure: listWritingClosure(memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Name"].write(value.name)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> OpsWorksClientTypes.DeploymentCommand {
        ...
        value.name = try reader["Name"].readIfPresent()
        value.args = try reader["Args"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension OpsWorksClientTypes.ElasticLoadBalancer {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> OpsWorksClientTypes.ElasticLoadBalancer {
        ...
        value.availabilityZones = try reader["AvailabilityZones"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.ec2InstanceIds = try reader["Ec2InstanceIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension OpsWorksClientTypes.Instance {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> OpsWorksClientTypes.Instance {
        ...
        value.layerIds = try reader["LayerIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension OpsWorksClientTypes.Layer {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> OpsWorksClientTypes.Layer {
        ...
        value.customJson = try reader["CustomJson"].readIfPresent()
        value.customSecurityGroupIds = try reader["CustomSecurityGroupIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.defaultSecurityGroupNames = try reader["DefaultSecurityGroupNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.packages = try reader["Packages"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension OpsWorksClientTypes.Recipes {
    ...
    static func write(value: OpsWorksClientTypes.Recipes?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Configure"].writeList(value.configure, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Deploy"].writeList(value.deploy, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Setup"].writeList(value.setup, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Shutdown"].writeList(value.shutdown, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Undeploy"].writeList(value.undeploy, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }

    static func read(from reader: SmithyJSON.Reader) throws -> OpsWorksClientTypes.Recipes {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = OpsWorksClientTypes.Recipes()
        value.setup = try reader["Setup"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.configure = try reader["Configure"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.deploy = try reader["Deploy"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.undeploy = try reader["Undeploy"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.shutdown = try reader["Shutdown"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension OpsWorksClientTypes.AutoScalingThresholds {
    ...
    static func write(value: OpsWorksClientTypes.AutoScalingThresholds?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Alarms"].writeList(value.alarms, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> OpsWorksClientTypes.AutoScalingThresholds {
        ...
        value.alarms = try reader["Alarms"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension OpsWorksClientTypes.WeeklyAutoScalingSchedule {
    ...
    static func write(value: OpsWorksClientTypes.WeeklyAutoScalingSchedule?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Friday"].writeMap(value.friday, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Monday"].writeMap(value.monday, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Saturday"].writeMap(value.saturday, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Sunday"].writeMap(value.sunday, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Thursday"].writeMap(value.thursday, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Tuesday"].writeMap(value.tuesday, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Wednesday"].writeMap(value.wednesday, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> OpsWorksClientTypes.WeeklyAutoScalingSchedule {
        ...
        value.monday = try reader["Monday"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.tuesday = try reader["Tuesday"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.wednesday = try reader["Wednesday"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.thursday = try reader["Thursday"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.friday = try reader["Friday"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.saturday = try reader["Saturday"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.sunday = try reader["Sunday"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
