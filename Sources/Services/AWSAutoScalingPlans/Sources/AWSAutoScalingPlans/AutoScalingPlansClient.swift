...
public final class AutoScalingPlansClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "AutoScalingPlansClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: AutoScalingPlansClient.AutoScalingPlansClientConfig
    let serviceName = "Auto Scaling Plans"
    let retryStrategy: SmithyRetries.DefaultRetryStrategy

    @available(*, deprecated, message: "Use AutoScalingPlansClient.AutoScalingPlansClientConfig instead")
    public typealias Config = AutoScalingPlansClient.AutoScalingPlansClientConfiguration
    public typealias Configuration = AutoScalingPlansClient.AutoScalingPlansClientConfig

    public required init(config: AutoScalingPlansClient.AutoScalingPlansClientConfig) {
    ...
    @available(*, deprecated, message: "Use init(config: AutoScalingPlansClient.AutoScalingPlansClientConfig) instead")
    public convenience init(config: AutoScalingPlansClient.AutoScalingPlansClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try AutoScalingPlansClient.AutoScalingPlansClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await AutoScalingPlansClient.AutoScalingPlansClientConfig()
        self.init(config: config)
    }
}
...
extension AutoScalingPlansClient {
    ...
    /// Client configuration for AutoScalingPlansClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct AutoScalingPlansClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Auto Scaling Plans")
    ...
    @available(*, deprecated, message: "Use AutoScalingPlansClientConfig instead. This class will be removed in a future version.")
    public final class AutoScalingPlansClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> AutoScalingPlansClientConfig {
            return try AutoScalingPlansClientConfig(
...
extension AutoScalingPlansClient {
    ...
    public func createScalingPlan(input: CreateScalingPlanInput) async throws -> CreateScalingPlanOutput {
        ...
        let operation = AutoScalingPlansClient.createScalingPlanOperation
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateScalingPlanInput, CreateScalingPlanOutput>(overrides: ["X-Amz-Target": "AnyScaleScalingPlannerFrontendService.CreateScalingPlan"]))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling Plans"))
    ...
    public func deleteScalingPlan(input: DeleteScalingPlanInput) async throws -> DeleteScalingPlanOutput {
        ...
        let operation = AutoScalingPlansClient.deleteScalingPlanOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteScalingPlanInput, DeleteScalingPlanOutput>(overrides: ["X-Amz-Target": "AnyScaleScalingPlannerFrontendService.DeleteScalingPlan"]))
    ...
    public func describeScalingPlanResources(input: DescribeScalingPlanResourcesInput) async throws -> DescribeScalingPlanResourcesOutput {
        ...
        let operation = AutoScalingPlansClient.describeScalingPlanResourcesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeScalingPlanResourcesInput, DescribeScalingPlanResourcesOutput>(overrides: ["X-Amz-Target": "AnyScaleScalingPlannerFrontendService.DescribeScalingPlanResources"]))
    ...
    public func describeScalingPlans(input: DescribeScalingPlansInput) async throws -> DescribeScalingPlansOutput {
        ...
        let operation = AutoScalingPlansClient.describeScalingPlansOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeScalingPlansInput, DescribeScalingPlansOutput>(overrides: ["X-Amz-Target": "AnyScaleScalingPlannerFrontendService.DescribeScalingPlans"]))
    ...
    public func getScalingPlanResourceForecastData(input: GetScalingPlanResourceForecastDataInput) async throws -> GetScalingPlanResourceForecastDataOutput {
        ...
        let operation = AutoScalingPlansClient.getScalingPlanResourceForecastDataOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetScalingPlanResourceForecastDataInput, GetScalingPlanResourceForecastDataOutput>(overrides: ["X-Amz-Target": "AnyScaleScalingPlannerFrontendService.GetScalingPlanResourceForecastData"]))
    ...
    public func updateScalingPlan(input: UpdateScalingPlanInput) async throws -> UpdateScalingPlanOutput {
        ...
        let operation = AutoScalingPlansClient.updateScalingPlanOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateScalingPlanInput, UpdateScalingPlanOutput>(overrides: ["X-Amz-Target": "AnyScaleScalingPlannerFrontendService.UpdateScalingPlan"]))
