...
extension WorkMailClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> WorkMailClient.WorkMailClientConfiguration {
        let clientConfiguration = try await WorkMailClient.WorkMailClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> WorkMailClient {
            let configuration = try await resolve(plugins: self.plugins)
            return WorkMailClient(config: configuration)
        }
    }
...
extension WorkMailClient.WorkMailClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
