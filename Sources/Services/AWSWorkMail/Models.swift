...
extension GetAccessControlEffectOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetAccessControlEffectOutput {
        ...
        value.matchedRules = try reader["MatchedRules"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension WorkMailClientTypes.ImpersonationRule {
    ...
    static func write(value: WorkMailClientTypes.ImpersonationRule?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Name"].write(value.name)
        try writer["NotTargetUsers"].writeList(value.notTargetUsers, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["TargetUsers"].writeList(value.targetUsers, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkMailClientTypes.ImpersonationRule {
        ...
        value.description = try reader["Description"].readIfPresent()
        value.effect = try reader["Effect"].readIfPresent()
        value.targetUsers = try reader["TargetUsers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.notTargetUsers = try reader["NotTargetUsers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension WorkMailClientTypes.AccessControlRule {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkMailClientTypes.AccessControlRule {
        ...
        value.effect = try reader["Effect"].readIfPresent()
        value.description = try reader["Description"].readIfPresent()
        value.ipRanges = try reader["IpRanges"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.notIpRanges = try reader["NotIpRanges"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.notActions = try reader["NotActions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.notUserIds = try reader["NotUserIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.dateCreated = try reader["DateCreated"].readTimestampIfPresent(format: .epochSeconds)
        value.dateModified = try reader["DateModified"].readTimestampIfPresent(format: .epochSeconds)
        value.impersonationRoleIds = try reader["ImpersonationRoleIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.notImpersonationRoleIds = try reader["NotImpersonationRoleIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension WorkMailClientTypes.Permission {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkMailClientTypes.Permission {
        ...
        value.permissionValues = try reader["PermissionValues"].readListIfPresent(memberReadingClosure: WorkMailClientTypes.PermissionType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension WorkMailClientTypes.MobileDeviceAccessRule {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkMailClientTypes.MobileDeviceAccessRule {
        ...
        value.description = try reader["Description"].readIfPresent()
        value.effect = try reader["Effect"].readIfPresent()
        value.deviceTypes = try reader["DeviceTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.notDeviceTypes = try reader["NotDeviceTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.deviceModels = try reader["DeviceModels"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.notDeviceModels = try reader["NotDeviceModels"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.deviceOperatingSystems = try reader["DeviceOperatingSystems"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.notDeviceOperatingSystems = try reader["NotDeviceOperatingSystems"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.deviceUserAgents = try reader["DeviceUserAgents"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.notDeviceUserAgents = try reader["NotDeviceUserAgents"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.dateCreated = try reader["DateCreated"].readTimestampIfPresent(format: .epochSeconds)
        value.dateModified = try reader["DateModified"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
