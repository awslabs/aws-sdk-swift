...
extension DescribeComputeEnvironmentsInput {
    ...
    static func write(value: DescribeComputeEnvironmentsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["computeEnvironments"].writeList(value.computeEnvironments, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeJobDefinitionsInput {
    ...
    static func write(value: DescribeJobDefinitionsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["jobDefinitions"].writeList(value.jobDefinitions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["maxResults"].write(value.maxResults)
        try writer["nextToken"].write(value.nextToken)
...
extension DescribeJobQueuesInput {
    ...
    static func write(value: DescribeJobQueuesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["jobQueues"].writeList(value.jobQueues, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["maxResults"].write(value.maxResults)
        try writer["nextToken"].write(value.nextToken)
    }
}
...
extension DescribeJobsInput {
    ...
    static func write(value: DescribeJobsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["jobs"].writeList(value.jobs, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension BatchClientTypes.JobDefinition {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BatchClientTypes.JobDefinition {
        ...
        value.platformCapabilities = try reader["platformCapabilities"].readListIfPresent(memberReadingClosure: BatchClientTypes.PlatformCapability.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension BatchClientTypes.EksMetadata {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BatchClientTypes.EksMetadata {
        ...
        value.labels = try reader["labels"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension BatchClientTypes.EksContainerResourceRequirements {
    ...
    static func write(value: BatchClientTypes.EksContainerResourceRequirements?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["limits"].writeMap(value.limits, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["requests"].writeMap(value.requests, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BatchClientTypes.EksContainerResourceRequirements {
        ...
        value.limits = try reader["limits"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.requests = try reader["requests"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension BatchClientTypes.LogConfiguration {
    ...
    static func write(value: BatchClientTypes.LogConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["options"].writeMap(value.options, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BatchClientTypes.LogConfiguration {
        ...
        value.options = try reader["options"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension BatchClientTypes.Tmpfs {
    ...
    static func write(value: BatchClientTypes.Tmpfs?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["containerPath"].write(value.containerPath)
        try writer["mountOptions"].writeList(value.mountOptions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BatchClientTypes.Tmpfs {
        ...
        value.mountOptions = try reader["mountOptions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BatchClientTypes.Device {
    ...
    static func write(value: BatchClientTypes.Device?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["permissions"].writeList(value.permissions, memberWritingClosure: BatchClientTypes.DeviceCgroupPermission.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BatchClientTypes.Device {
        ...
        value.containerPath = try reader["containerPath"].readIfPresent()
        value.permissions = try reader["permissions"].readListIfPresent(memberReadingClosure: BatchClientTypes.DeviceCgroupPermission.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BatchClientTypes.NodeProperties {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BatchClientTypes.NodeProperties {
        ...
        value.mainNode = try reader["mainNode"].readIfPresent()
...
extension BatchClientTypes.JobStateTimeLimitAction {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BatchClientTypes.JobStateTimeLimitAction {
        ...
        value.state = try reader["state"].readIfPresent()
        value.maxTimeSeconds = try reader["maxTimeSeconds"].readIfPresent()
        value.action = try reader["action"].readIfPresent()
        return value
    }
}
...
extension BatchClientTypes.ArrayPropertiesDetail {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BatchClientTypes.ArrayPropertiesDetail {
        ...
        value.statusSummary = try reader["statusSummary"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.size = try reader["size"].readIfPresent()
