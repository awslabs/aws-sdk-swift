...
extension DataSyncClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> DataSyncClient.DataSyncClientConfiguration {
        let clientConfiguration = try await DataSyncClient.DataSyncClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> DataSyncClient {
            let configuration = try await resolve(plugins: self.plugins)
            return DataSyncClient(config: configuration)
        }
    }
...
extension DataSyncClient.DataSyncClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
