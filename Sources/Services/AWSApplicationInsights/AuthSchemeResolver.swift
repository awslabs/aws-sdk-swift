...
public struct ApplicationInsightsAuthSchemeResolverParameters: SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol ApplicationInsightsAuthSchemeResolver: SmithyHTTPAuthAPI.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service ApplicationInsights must conform to.
}

public struct DefaultApplicationInsightsAuthSchemeResolver: ApplicationInsightsAuthSchemeResolver {
    public func resolveAuthScheme(params: SmithyHTTPAuthAPI.AuthSchemeResolverParameters) throws -> [AuthOption] {
        ...
        guard let serviceParams = params as? ApplicationInsightsAuthSchemeResolverParameters else {
        ...
        switch serviceParams.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: SigningPropertyKeys.signingName, value: "applicationinsights")
    ...
    public func constructParameters(context: Smithy.Context) throws -> SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
        ...
        return ApplicationInsightsAuthSchemeResolverParameters(operation: opName, region: opRegion)
    }
}
