...
extension PaymentCryptographyClientTypes {
    ...
    public enum KeyClass: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension PaymentCryptographyClientTypes {
    ...
    public enum KeyUsage: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension PaymentCryptographyClientTypes {
    ...
    public enum KeyOrigin: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension PaymentCryptographyClientTypes {
    ...
    public enum KeyExportability: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case exportable
        case nonExportable
        case sensitive
        case sdkUnknown(Swift.String)
...
extension PaymentCryptographyClientTypes {
    ...
    public enum Tr34KeyBlockFormat: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case x9Tr342012
        case sdkUnknown(Swift.String)
...
extension PaymentCryptographyClientTypes {
    ...
    public enum WrappedKeyMaterialFormat: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case keyCryptogram
        case tr31KeyBlock
        case tr34KeyBlock
        case sdkUnknown(Swift.String)
...
extension PaymentCryptographyClientTypes {
    ...
    public enum KeyMaterialType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case keyCryptogram
...
extension GetParametersForExportOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetParametersForExportOutput {
        ...
        value.parametersValidUntilTimestamp = try reader["ParametersValidUntilTimestamp"].readTimestampIfPresent(format: .epochSeconds)
...
extension PaymentCryptographyClientTypes.Key {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PaymentCryptographyClientTypes.Key {
        ...
        value.usageStartTimestamp = try reader["UsageStartTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.usageStopTimestamp = try reader["UsageStopTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.deletePendingTimestamp = try reader["DeletePendingTimestamp"].readTimestampIfPresent(format: .epochSeconds)
