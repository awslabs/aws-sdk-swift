...
public class AppMeshClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [ClientRuntime.AuthScheme]? = nil, authSchemeResolver: AppMeshAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any AWSClientRuntime.AWSCredentialIdentityResolver)? = nil) {
