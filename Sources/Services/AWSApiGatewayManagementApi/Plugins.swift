...
public class ApiGatewayManagementApiClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfiguration {
            config.authSchemeResolver = DefaultApiGatewayManagementApiAuthSchemeResolver()
...
public class ApiGatewayManagementApiClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: ApiGatewayManagementApiAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
