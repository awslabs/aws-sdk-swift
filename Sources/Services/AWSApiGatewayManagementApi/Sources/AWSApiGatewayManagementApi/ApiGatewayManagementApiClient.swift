...
public final class ApiGatewayManagementApiClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "ApiGatewayManagementApiClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfig
    let serviceName = "ApiGatewayManagementApi"

    @available(*, deprecated, message: "Use ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfig instead")
    public typealias Config = ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfiguration
    public typealias Configuration = ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfig

    public required init(config: ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfig) instead")
    public convenience init(config: ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ApiGatewayManagementApiClient.ApiGatewayManagementApiClientConfig()
        self.init(config: config)
    }
}
...
extension ApiGatewayManagementApiClient {
    ...
    /// Client configuration for ApiGatewayManagementApiClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ApiGatewayManagementApiClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "ApiGatewayManagementApi")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ApiGatewayManagementApiClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultApiGatewayManagementApiAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use ApiGatewayManagementApiClientConfig instead. This class will be removed in a future version.")
    public final class ApiGatewayManagementApiClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ApiGatewayManagementApiClientConfig {
            return try ApiGatewayManagementApiClientConfig(
...
extension ApiGatewayManagementApiClient {
    ...
    public func deleteConnection(input: DeleteConnectionInput) async throws -> DeleteConnectionOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ApiGatewayManagementApi"))
    ...
    public func postToConnection(input: PostToConnectionInput) async throws -> PostToConnectionOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PostToConnectionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
