...
extension GlacierClient {
    public class GlacierClientConfiguration: AWSDefaultClientConfiguration & AWSRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
        ...
        public convenience init(region: String) throws {
            self.init(nil, nil, try AWSClientConfigDefaultsProvider.appID(), try AWSClientConfigDefaultsProvider.awsCredentialIdentityResolver(), try AWSClientConfigDefaultsProvider.retryMode(), region, region, try DefaultEndpointResolver(), ClientRuntime.DefaultTelemetry.provider, try AWSClientConfigDefaultsProvider.retryStrategyOptions(), AWSClientConfigDefaultsProvider.clientLogMode, nil, AWSClientConfigDefaultsProvider.idempotencyTokenGenerator, AWSClientConfigDefaultsProvider.httpClientEngine, AWSClientConfigDefaultsProvider.httpClientConfiguration, [SigV4AuthScheme()], DefaultGlacierAuthSchemeResolver())
        }
...
extension GlacierClient {
    ...
    public func abortMultipartUpload(input: AbortMultipartUploadInput) async throws -> AbortMultipartUploadOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<AbortMultipartUploadOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AbortMultipartUploadOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<AbortMultipartUploadOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func abortVaultLock(input: AbortVaultLockInput) async throws -> AbortVaultLockOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<AbortVaultLockOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AbortVaultLockOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<AbortVaultLockOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func addTagsToVault(input: AddTagsToVaultInput) async throws -> AddTagsToVaultOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<AddTagsToVaultOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<AddTagsToVaultOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<AddTagsToVaultOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<AddTagsToVaultOutput>())
    ...
    public func completeMultipartUpload(input: CompleteMultipartUploadInput) async throws -> CompleteMultipartUploadOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<CompleteMultipartUploadOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<CompleteMultipartUploadOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func completeVaultLock(input: CompleteVaultLockInput) async throws -> CompleteVaultLockOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<CompleteVaultLockOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CompleteVaultLockOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<CompleteVaultLockOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func createVault(input: CreateVaultInput) async throws -> CreateVaultOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<CreateVaultOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<CreateVaultOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<CreateVaultOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func deleteArchive(input: DeleteArchiveInput) async throws -> DeleteArchiveOutput {
        ...
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<DeleteArchiveOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func deleteVault(input: DeleteVaultInput) async throws -> DeleteVaultOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<DeleteVaultOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<DeleteVaultOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<DeleteVaultOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func deleteVaultAccessPolicy(input: DeleteVaultAccessPolicyInput) async throws -> DeleteVaultAccessPolicyOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<DeleteVaultAccessPolicyOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<DeleteVaultAccessPolicyOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func deleteVaultNotifications(input: DeleteVaultNotificationsInput) async throws -> DeleteVaultNotificationsOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<DeleteVaultNotificationsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<DeleteVaultNotificationsOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func describeJob(input: DescribeJobInput) async throws -> DescribeJobOutput {
        ...
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<DescribeJobOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func describeVault(input: DescribeVaultInput) async throws -> DescribeVaultOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<DescribeVaultOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<DescribeVaultOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<DescribeVaultOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func getDataRetrievalPolicy(input: GetDataRetrievalPolicyInput) async throws -> GetDataRetrievalPolicyOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<GetDataRetrievalPolicyOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<GetDataRetrievalPolicyOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<GetDataRetrievalPolicyOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func getJobOutput(input: GetJobOutputInput) async throws -> GetJobOutputOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<GetJobOutputOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<GetJobOutputOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<GetJobOutputOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func getVaultAccessPolicy(input: GetVaultAccessPolicyInput) async throws -> GetVaultAccessPolicyOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<GetVaultAccessPolicyOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<GetVaultAccessPolicyOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<GetVaultAccessPolicyOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func getVaultLock(input: GetVaultLockInput) async throws -> GetVaultLockOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<GetVaultLockOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<GetVaultLockOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<GetVaultLockOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func getVaultNotifications(input: GetVaultNotificationsInput) async throws -> GetVaultNotificationsOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<GetVaultNotificationsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<GetVaultNotificationsOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<GetVaultNotificationsOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func initiateJob(input: InitiateJobInput) async throws -> InitiateJobOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<InitiateJobOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<InitiateJobOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<InitiateJobOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<InitiateJobOutput>())
    ...
    public func initiateMultipartUpload(input: InitiateMultipartUploadInput) async throws -> InitiateMultipartUploadOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<InitiateMultipartUploadOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<InitiateMultipartUploadOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func initiateVaultLock(input: InitiateVaultLockInput) async throws -> InitiateVaultLockOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<InitiateVaultLockOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<InitiateVaultLockOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<InitiateVaultLockOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<InitiateVaultLockOutput>())
    ...
    public func listJobs(input: ListJobsInput) async throws -> ListJobsOutput {
        ...
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<ListJobsOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func listMultipartUploads(input: ListMultipartUploadsInput) async throws -> ListMultipartUploadsOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<ListMultipartUploadsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ListMultipartUploadsOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<ListMultipartUploadsOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func listParts(input: ListPartsInput) async throws -> ListPartsOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<ListPartsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ListPartsOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<ListPartsOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func listProvisionedCapacity(input: ListProvisionedCapacityInput) async throws -> ListProvisionedCapacityOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<ListProvisionedCapacityOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<ListProvisionedCapacityOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func listTagsForVault(input: ListTagsForVaultInput) async throws -> ListTagsForVaultOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<ListTagsForVaultOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ListTagsForVaultOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<ListTagsForVaultOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func listVaults(input: ListVaultsInput) async throws -> ListVaultsOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<ListVaultsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<ListVaultsOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<ListVaultsOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func purchaseProvisionedCapacity(input: PurchaseProvisionedCapacityInput) async throws -> PurchaseProvisionedCapacityOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<PurchaseProvisionedCapacityOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<PurchaseProvisionedCapacityOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
    ...
    public func removeTagsFromVault(input: RemoveTagsFromVaultInput) async throws -> RemoveTagsFromVaultOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<RemoveTagsFromVaultOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<RemoveTagsFromVaultOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<RemoveTagsFromVaultOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<RemoveTagsFromVaultOutput>())
    ...
    public func setDataRetrievalPolicy(input: SetDataRetrievalPolicyInput) async throws -> SetDataRetrievalPolicyOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<SetDataRetrievalPolicyOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SetDataRetrievalPolicyOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<SetDataRetrievalPolicyOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<SetDataRetrievalPolicyOutput>())
    ...
    public func setVaultAccessPolicy(input: SetVaultAccessPolicyInput) async throws -> SetVaultAccessPolicyOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<SetVaultAccessPolicyOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SetVaultAccessPolicyOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<SetVaultAccessPolicyOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<SetVaultAccessPolicyOutput>())
    ...
    public func setVaultNotifications(input: SetVaultNotificationsInput) async throws -> SetVaultNotificationsOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<SetVaultNotificationsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<SetVaultNotificationsOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<SetVaultNotificationsOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<SetVaultNotificationsOutput>())
    ...
    public func uploadArchive(input: UploadArchiveInput) async throws -> UploadArchiveOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<UploadArchiveOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<UploadArchiveOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<UploadArchiveOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<UploadArchiveOutput>())
    ...
    public func uploadMultipartPart(input: UploadMultipartPartInput) async throws -> UploadMultipartPartOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<UploadMultipartPartOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        operation.buildStep.intercept(position: .before, middleware: ClientRuntime.AuthSchemeMiddleware<UploadMultipartPartOutput>())
        operation.buildStep.intercept(position: .after, middleware: ClientRuntime.MutateHeadersMiddleware<UploadMultipartPartOutput>(additional: ["X-Amz-Glacier-Version": "2012-06-01"]))
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<UploadMultipartPartOutput>())
