...
extension GlacierClientTypes.S3Location {
    ...
    static func write(value: GlacierClientTypes.S3Location?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Tagging"].writeMap(value.tagging, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GlacierClientTypes.S3Location {
        ...
        value.tagging = try reader["Tagging"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GlacierClientTypes.VaultNotificationConfig {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GlacierClientTypes.VaultNotificationConfig {
        ...
        value.snsTopic = try reader["SNSTopic"].readIfPresent()
        value.events = try reader["Events"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
