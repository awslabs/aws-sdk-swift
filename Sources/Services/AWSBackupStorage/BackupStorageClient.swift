...
extension BackupStorageClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> BackupStorageClient.BackupStorageClientConfiguration {
        let clientConfiguration = try await BackupStorageClient.BackupStorageClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> BackupStorageClient {
            let configuration = try await resolve(plugins: self.plugins)
            return BackupStorageClient(config: configuration)
        }
    }
...
extension BackupStorageClient.BackupStorageClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
