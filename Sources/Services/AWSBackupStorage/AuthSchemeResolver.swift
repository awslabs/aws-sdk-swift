...
public struct BackupStorageAuthSchemeResolverParameters: SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol BackupStorageAuthSchemeResolver: SmithyHTTPAuthAPI.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service BackupStorage must conform to.
}

public struct DefaultBackupStorageAuthSchemeResolver: BackupStorageAuthSchemeResolver {
    public func resolveAuthScheme(params: SmithyHTTPAuthAPI.AuthSchemeResolverParameters) throws -> [AuthOption] {
        ...
        guard let serviceParams = params as? BackupStorageAuthSchemeResolverParameters else {
        ...
        switch serviceParams.operation {
            case "notifyObjectComplete":
                ...
                sigV4Option.signingProperties.set(key: SigningPropertyKeys.signingName, value: "backup-storage")
    ...
    public func constructParameters(context: Smithy.Context) throws -> SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
        ...
        return BackupStorageAuthSchemeResolverParameters(operation: opName, region: opRegion)
    }
}
