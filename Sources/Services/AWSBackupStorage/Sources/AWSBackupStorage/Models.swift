...
extension ListObjectsInput {
    ...
    static func queryItemProvider(_ value: ListObjectsInput) throws -> [Smithy.URIQueryItem] {
        ...
        if let createdAfter = value.createdAfter {
            let createdAfterQueryItem = Smithy.URIQueryItem(name: "created-after".urlPercentEncoding(), value: Swift.String(SmithyTimestamps.TimestampFormatter(format: .dateTime).string(from: createdAfter)).urlPercentEncoding())
        ...
        if let createdBefore = value.createdBefore {
            let createdBeforeQueryItem = Smithy.URIQueryItem(name: "created-before".urlPercentEncoding(), value: Swift.String(SmithyTimestamps.TimestampFormatter(format: .dateTime).string(from: createdBefore)).urlPercentEncoding())
