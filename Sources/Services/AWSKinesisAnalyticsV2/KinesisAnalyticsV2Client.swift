...
public class KinesisAnalyticsV2Client {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await KinesisAnalyticsV2ClientConfiguration(region: region)
    ...
    public class KinesisAnalyticsV2ClientConfiguration: KinesisAnalyticsV2ClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("KinesisAnalyticsV2Client")
