...
extension OpenSearchClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> OpenSearchClient.OpenSearchClientConfiguration {
        let clientConfiguration = try await OpenSearchClient.OpenSearchClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> OpenSearchClient {
            let configuration = try await resolve(plugins: self.plugins)
            return OpenSearchClient(config: configuration)
        }
    }
...
extension OpenSearchClient.OpenSearchClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
