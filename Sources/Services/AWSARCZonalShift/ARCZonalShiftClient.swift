...
public class ARCZonalShiftClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await ARCZonalShiftClientConfiguration(region: region)
    ...
    public class ARCZonalShiftClientConfiguration: ARCZonalShiftClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("ARCZonalShiftClient")
