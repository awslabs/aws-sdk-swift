...
public final class ARCZonalShiftClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: ARCZonalShiftClient.ARCZonalShiftClientConfig) instead")
    public convenience init(config: ARCZonalShiftClient.ARCZonalShiftClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ARCZonalShiftClient.ARCZonalShiftClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ARCZonalShiftClient.ARCZonalShiftClientConfig()
        self.init(config: config)
    }
}
...
extension ARCZonalShiftClient {
    ...
    /// Client configuration for ARCZonalShiftClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ARCZonalShiftClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "ARC Zonal Shift")
    ...
    @available(*, deprecated, message: "Use ARCZonalShiftClientConfig instead. This class will be removed in a future version.")
    public final class ARCZonalShiftClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ARCZonalShiftClientConfig {
            return try ARCZonalShiftClientConfig(
...
extension ARCZonalShiftClient {
    ...
    public func cancelPracticeRun(input: CancelPracticeRunInput) async throws -> CancelPracticeRunOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ARC Zonal Shift"))
