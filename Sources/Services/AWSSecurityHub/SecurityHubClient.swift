...
extension SecurityHubClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SecurityHubClient.SecurityHubClientConfiguration {
        let clientConfiguration = try await SecurityHubClient.SecurityHubClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SecurityHubClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SecurityHubClient(config: configuration)
        }
    }
...
extension SecurityHubClient.SecurityHubClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
