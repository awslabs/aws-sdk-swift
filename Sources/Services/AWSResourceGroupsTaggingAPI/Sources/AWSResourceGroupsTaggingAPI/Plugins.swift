...
public class ResourceGroupsTaggingAPIClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ResourceGroupsTaggingAPIClient.ResourceGroupsTaggingAPIClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ResourceGroupsTaggingAPIClient.ResourceGroupsTaggingAPIClientConfiguration {
            config.authSchemeResolver = DefaultResourceGroupsTaggingAPIAuthSchemeResolver()
...
public class ResourceGroupsTaggingAPIClientAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public init(authSchemes: SmithyHTTPAuthAPI.AuthSchemes? = nil, authSchemeResolver: ResourceGroupsTaggingAPIAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentity.AWSCredentialIdentityResolver)? = nil, bearerTokenIdentityResolver: (any SmithyIdentity.BearerTokenIdentityResolver)? = nil) {
