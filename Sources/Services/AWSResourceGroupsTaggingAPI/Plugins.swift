...
public class ResourceGroupsTaggingAPIClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if var config = clientConfiguration as? ResourceGroupsTaggingAPIClient.ResourceGroupsTaggingAPIClientConfiguration {
...
public class ResourceGroupsTaggingAPIClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [ClientRuntime.AuthScheme]? = nil, authSchemeResolver: ResourceGroupsTaggingAPIAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any AWSClientRuntime.AWSCredentialIdentityResolver)? = nil) {
