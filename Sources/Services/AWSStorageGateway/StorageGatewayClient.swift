...
public class StorageGatewayClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await StorageGatewayClientConfiguration(region: region)
    ...
    public class StorageGatewayClientConfiguration: StorageGatewayClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("StorageGatewayClient")
