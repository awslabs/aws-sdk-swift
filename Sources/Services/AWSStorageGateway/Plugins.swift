...
public class StorageGatewayClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [ClientRuntime.AuthScheme]? = nil, authSchemeResolver: StorageGatewayAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any AWSClientRuntime.AWSCredentialIdentityResolver)? = nil) {
