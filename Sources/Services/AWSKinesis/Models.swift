...
extension DisableEnhancedMonitoringOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DisableEnhancedMonitoringOutput {
        ...
        value.currentShardLevelMetrics = try reader["CurrentShardLevelMetrics"].readListIfPresent(memberReadingClosure: KinesisClientTypes.MetricsName.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.desiredShardLevelMetrics = try reader["DesiredShardLevelMetrics"].readListIfPresent(memberReadingClosure: KinesisClientTypes.MetricsName.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ListStreamsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListStreamsOutput {
        ...
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.streamNames = try reader["StreamNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension KinesisClientTypes.StreamDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KinesisClientTypes.StreamDescription {
        ...
        value.streamCreationTimestamp = try reader["StreamCreationTimestamp"].readTimestampIfPresent(format: .epochSeconds)
...
extension KinesisClientTypes.EnhancedMetrics {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KinesisClientTypes.EnhancedMetrics {
        ...
        value.shardLevelMetrics = try reader["ShardLevelMetrics"].readListIfPresent(memberReadingClosure: KinesisClientTypes.MetricsName.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension KinesisClientTypes.ConsumerDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KinesisClientTypes.ConsumerDescription {
        ...
        value.consumerCreationTimestamp = try reader["ConsumerCreationTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.streamARN = try reader["StreamARN"].readIfPresent()
        return value
    }
}
...
extension KinesisClientTypes.Record {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KinesisClientTypes.Record {
        ...
        value.sequenceNumber = try reader["SequenceNumber"].readIfPresent()
        value.approximateArrivalTimestamp = try reader["ApproximateArrivalTimestamp"].readTimestampIfPresent(format: .epochSeconds)
...
extension KinesisClientTypes.ChildShard {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KinesisClientTypes.ChildShard {
        ...
        value.shardId = try reader["ShardId"].readIfPresent()
        value.parentShards = try reader["ParentShards"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.hashKeyRange = try reader["HashKeyRange"].readIfPresent(with: KinesisClientTypes.HashKeyRange.read(from:))
        return value
    }
}
