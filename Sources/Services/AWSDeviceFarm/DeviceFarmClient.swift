...
extension DeviceFarmClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> DeviceFarmClient.DeviceFarmClientConfiguration {
        let clientConfiguration = try await DeviceFarmClient.DeviceFarmClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> DeviceFarmClient {
            let configuration = try await resolve(plugins: self.plugins)
            return DeviceFarmClient(config: configuration)
        }
    }
...
extension DeviceFarmClient.DeviceFarmClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
