...
extension ListUniqueProblemsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListUniqueProblemsOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.uniqueProblems = try reader["uniqueProblems"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: DeviceFarmClientTypes.UniqueProblem.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension DeviceFarmClientTypes.InstanceProfile {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeviceFarmClientTypes.InstanceProfile {
        ...
        value.excludeAppPackagesFromCleanup = try reader["excludeAppPackagesFromCleanup"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DeviceFarmClientTypes.AccountSettings {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeviceFarmClientTypes.AccountSettings {
        ...
        value.unmeteredDevices = try reader["unmeteredDevices"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.unmeteredRemoteAccessDevices = try reader["unmeteredRemoteAccessDevices"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        ...
        value.maxSlots = try reader["maxSlots"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.defaultJobTimeoutMinutes = try reader["defaultJobTimeoutMinutes"].readIfPresent()
        value.skipAppResign = try reader["skipAppResign"].readIfPresent()
        return value
    }
...
extension DeviceFarmClientTypes.CustomerArtifactPaths {
    ...
    static func write(value: DeviceFarmClientTypes.CustomerArtifactPaths?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["androidPaths"].writeList(value.androidPaths, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["deviceHostPaths"].writeList(value.deviceHostPaths, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["iosPaths"].writeList(value.iosPaths, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeviceFarmClientTypes.CustomerArtifactPaths {
        ...
        value.iosPaths = try reader["iosPaths"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.androidPaths = try reader["androidPaths"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.deviceHostPaths = try reader["deviceHostPaths"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DeviceFarmClientTypes.ScheduleRunConfiguration {
    ...
    static func write(value: DeviceFarmClientTypes.ScheduleRunConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["auxiliaryApps"].writeList(value.auxiliaryApps, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["billingMethod"].write(value.billingMethod)
