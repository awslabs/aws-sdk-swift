...
extension CreateLifecyclePolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateLifecyclePolicyOutput {
...
extension DLMClientTypes.CreateRule {
    ...
    static func write(value: DLMClientTypes.CreateRule?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Times"].writeList(value.times, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DLMClientTypes.CreateRule {
        ...
        value.times = try reader["Times"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DeleteLifecyclePolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteLifecyclePolicyOutput {
...
extension DLMClientTypes.EventParameters {
    ...
    static func write(value: DLMClientTypes.EventParameters?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["SnapshotOwner"].writeList(value.snapshotOwner, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DLMClientTypes.EventParameters {
        ...
        value.snapshotOwner = try reader["SnapshotOwner"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DLMClientTypes.Exclusions {
    ...
    static func write(value: DLMClientTypes.Exclusions?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ExcludeVolumeTypes"].writeList(value.excludeVolumeTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DLMClientTypes.Exclusions {
        ...
        value.excludeVolumeTypes = try reader["ExcludeVolumeTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension GetLifecyclePoliciesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetLifecyclePoliciesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetLifecyclePolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetLifecyclePolicyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension InvalidRequestException {
    ...
    static func makeError(baseError: AWSClientRuntime.RestJSONError) throws -> InvalidRequestException {
        ...
        value.properties.code = try reader["Code"].readIfPresent()
        value.properties.message = try reader["Message"].readIfPresent()
        value.properties.mutuallyExclusiveParameters = try reader["MutuallyExclusiveParameters"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.properties.requiredParameters = try reader["RequiredParameters"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.httpResponse = baseError.httpResponse
        value.requestID = baseError.requestID
        value.message = baseError.message
        return value
...
extension DLMClientTypes.LifecyclePolicy {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DLMClientTypes.LifecyclePolicy {
        ...
        value.dateModified = try reader["DateModified"].readTimestampIfPresent(format: .dateTime)
...
extension DLMClientTypes.PolicyDetails {
    ...
    static func write(value: DLMClientTypes.PolicyDetails?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["PolicyType"].write(value.policyType)
        try writer["ResourceLocations"].writeList(value.resourceLocations, memberWritingClosure: DLMClientTypes.ResourceLocationValues.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ResourceType"].write(value.resourceType)
        try writer["ResourceTypes"].writeList(value.resourceTypes, memberWritingClosure: DLMClientTypes.ResourceTypeValues.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["RetainInterval"].write(value.retainInterval)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DLMClientTypes.PolicyDetails {
        ...
        value.policyType = try reader["PolicyType"].readIfPresent()
        value.resourceTypes = try reader["ResourceTypes"].readListIfPresent(memberReadingClosure: DLMClientTypes.ResourceTypeValues.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.resourceLocations = try reader["ResourceLocations"].readListIfPresent(memberReadingClosure: DLMClientTypes.ResourceLocationValues.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ResourceNotFoundException {
    ...
    static func makeError(baseError: AWSClientRuntime.RestJSONError) throws -> ResourceNotFoundException {
        ...
        value.properties.code = try reader["Code"].readIfPresent()
        value.properties.message = try reader["Message"].readIfPresent()
        value.properties.resourceIds = try reader["ResourceIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.properties.resourceType = try reader["ResourceType"].readIfPresent()
        value.httpResponse = baseError.httpResponse
        value.requestID = baseError.requestID
        value.message = baseError.message
...
extension DLMClientTypes.Script {
    ...
    static func write(value: DLMClientTypes.Script?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Stages"].writeList(value.stages, memberWritingClosure: DLMClientTypes.StageValues.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }

    static func read(from reader: SmithyJSON.Reader) throws -> DLMClientTypes.Script {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = DLMClientTypes.Script()
        value.stages = try reader["Stages"].readListIfPresent(memberReadingClosure: DLMClientTypes.StageValues.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DLMClientTypes.ShareRule {
    ...
    static func write(value: DLMClientTypes.ShareRule?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["TargetAccounts"].writeList(value.targetAccounts, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DLMClientTypes.ShareRule {
        ...
        value.targetAccounts = try reader["TargetAccounts"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension UpdateLifecyclePolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateLifecyclePolicyOutput {
