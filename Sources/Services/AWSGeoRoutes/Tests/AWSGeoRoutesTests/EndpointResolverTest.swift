...
class EndpointResolverTest: XCTestCase {
    ...
    func testResolve24() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://geo-routes-fips.eusc-de-east-1.amazonaws.eu", headers: headers, properties: properties)
    ...
    func testResolve25() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://geo-routes.eusc-de-east-1.amazonaws.eu", headers: headers, properties: properties)
