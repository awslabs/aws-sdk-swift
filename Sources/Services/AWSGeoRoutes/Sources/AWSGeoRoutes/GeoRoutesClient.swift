...
public final class GeoRoutesClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: GeoRoutesClient.GeoRoutesClientConfig) instead")
    public convenience init(config: GeoRoutesClient.GeoRoutesClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try GeoRoutesClient.GeoRoutesClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await GeoRoutesClient.GeoRoutesClientConfig()
        self.init(config: config)
    }
}
...
extension GeoRoutesClient {
    ...
    /// Client configuration for GeoRoutesClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct GeoRoutesClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Geo Routes")
    ...
    @available(*, deprecated, message: "Use GeoRoutesClientConfig instead. This class will be removed in a future version.")
    public final class GeoRoutesClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> GeoRoutesClientConfig {
            return try GeoRoutesClientConfig(
...
extension GeoRoutesClient {
    ...
    public func calculateIsolines(input: CalculateIsolinesInput) async throws -> CalculateIsolinesOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Geo Routes"))
