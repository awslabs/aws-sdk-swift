...
public class EventBridgeClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await EventBridgeClientConfiguration(region: region)
    ...
    public class EventBridgeClientConfiguration: EventBridgeClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("EventBridgeClient")
