...
extension EventBridgeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> EventBridgeClient.EventBridgeClientConfiguration {
        let clientConfiguration = try await EventBridgeClient.EventBridgeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> EventBridgeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return EventBridgeClient(config: configuration)
        }
    }
...
extension EventBridgeClient.EventBridgeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
