...
public struct EventBridgeAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
...
public protocol EventBridgeAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
