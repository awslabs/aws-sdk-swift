...
extension EventBridgeClientTypes.RedshiftDataParameters {
    ...
    static func write(value: EventBridgeClientTypes.RedshiftDataParameters?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Sqls"].writeList(value.sqls, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EventBridgeClientTypes.RedshiftDataParameters {
        ...
        value.sqls = try reader["Sqls"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
