...
extension CloudDirectoryClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CloudDirectoryClient.CloudDirectoryClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> CloudDirectoryClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CloudDirectoryClient(config: configuration)
        }
    }
...
extension CloudDirectoryClient.CloudDirectoryClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
