...
public class CloudDirectoryClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await CloudDirectoryClientConfiguration(region: region)
    ...
    public class CloudDirectoryClientConfiguration: CloudDirectoryClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("CloudDirectoryClient")
