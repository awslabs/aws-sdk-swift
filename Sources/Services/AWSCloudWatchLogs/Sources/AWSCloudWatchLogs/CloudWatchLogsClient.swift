...
public final class CloudWatchLogsClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "CloudWatchLogsClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: CloudWatchLogsClient.CloudWatchLogsClientConfig
    let serviceName = "CloudWatch Logs"
    let retryStrategy: SmithyRetries.DefaultRetryStrategy

    @available(*, deprecated, message: "Use CloudWatchLogsClient.CloudWatchLogsClientConfig instead")
    public typealias Config = CloudWatchLogsClient.CloudWatchLogsClientConfiguration
    public typealias Configuration = CloudWatchLogsClient.CloudWatchLogsClientConfig

    public required init(config: CloudWatchLogsClient.CloudWatchLogsClientConfig) {
    ...
    @available(*, deprecated, message: "Use init(config: CloudWatchLogsClient.CloudWatchLogsClientConfig) instead")
    public convenience init(config: CloudWatchLogsClient.CloudWatchLogsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try CloudWatchLogsClient.CloudWatchLogsClientConfig(region: region)
...
extension CloudWatchLogsClient {
    ...
    /// Client configuration for CloudWatchLogsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct CloudWatchLogsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "CloudWatch Logs")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: CloudWatchLogsClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultCloudWatchLogsAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use CloudWatchLogsClientConfig instead. This class will be removed in a future version.")
    public final class CloudWatchLogsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> CloudWatchLogsClientConfig {
            return try CloudWatchLogsClientConfig(
...
extension CloudWatchLogsClient {
    /// Performs the `AssociateKmsKey` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func associateKmsKey(input: AssociateKmsKeyInput) async throws -> AssociateKmsKeyOutput {
        ...
        let operation = CloudWatchLogsClient.associateKmsKeyOperation
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<AssociateKmsKeyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<AssociateKmsKeyInput, AssociateKmsKeyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.AssociateKmsKey"]))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<AssociateKmsKeyInput, AssociateKmsKeyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
    ...
    public func associateSourceToS3TableIntegration(input: AssociateSourceToS3TableIntegrationInput) async throws -> AssociateSourceToS3TableIntegrationOutput {
        ...
        let operation = CloudWatchLogsClient.associateSourceToS3TableIntegrationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<AssociateSourceToS3TableIntegrationInput, AssociateSourceToS3TableIntegrationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.AssociateSourceToS3TableIntegration"]))
    ...
    public func cancelExportTask(input: CancelExportTaskInput) async throws -> CancelExportTaskOutput {
        ...
        let operation = CloudWatchLogsClient.cancelExportTaskOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CancelExportTaskInput, CancelExportTaskOutput>(overrides: ["X-Amz-Target": "Logs_20140328.CancelExportTask"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CancelExportTaskInput, CancelExportTaskOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func cancelImportTask(input: CancelImportTaskInput) async throws -> CancelImportTaskOutput {
        ...
        let operation = CloudWatchLogsClient.cancelImportTaskOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CancelImportTaskInput, CancelImportTaskOutput>(overrides: ["X-Amz-Target": "Logs_20140328.CancelImportTask"]))
    ...
    public func createDelivery(input: CreateDeliveryInput) async throws -> CreateDeliveryOutput {
        ...
        let operation = CloudWatchLogsClient.createDeliveryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateDeliveryOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateDeliveryInput, CreateDeliveryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.CreateDelivery"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateDeliveryInput, CreateDeliveryOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func createExportTask(input: CreateExportTaskInput) async throws -> CreateExportTaskOutput {
        ...
        let operation = CloudWatchLogsClient.createExportTaskOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateExportTaskOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateExportTaskInput, CreateExportTaskOutput>(overrides: ["X-Amz-Target": "Logs_20140328.CreateExportTask"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateExportTaskInput, CreateExportTaskOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func createImportTask(input: CreateImportTaskInput) async throws -> CreateImportTaskOutput {
        ...
        let operation = CloudWatchLogsClient.createImportTaskOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateImportTaskInput, CreateImportTaskOutput>(overrides: ["X-Amz-Target": "Logs_20140328.CreateImportTask"]))
    ...
    public func createLogAnomalyDetector(input: CreateLogAnomalyDetectorInput) async throws -> CreateLogAnomalyDetectorOutput {
        ...
        let operation = CloudWatchLogsClient.createLogAnomalyDetectorOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateLogAnomalyDetectorOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateLogAnomalyDetectorInput, CreateLogAnomalyDetectorOutput>(overrides: ["X-Amz-Target": "Logs_20140328.CreateLogAnomalyDetector"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateLogAnomalyDetectorInput, CreateLogAnomalyDetectorOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `CreateLogGroup` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func createLogGroup(input: CreateLogGroupInput) async throws -> CreateLogGroupOutput {
        ...
        let operation = CloudWatchLogsClient.createLogGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateLogGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateLogGroupInput, CreateLogGroupOutput>(overrides: ["X-Amz-Target": "Logs_20140328.CreateLogGroup"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateLogGroupInput, CreateLogGroupOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `CreateLogStream` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func createLogStream(input: CreateLogStreamInput) async throws -> CreateLogStreamOutput {
        ...
        let operation = CloudWatchLogsClient.createLogStreamOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateLogStreamOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateLogStreamInput, CreateLogStreamOutput>(overrides: ["X-Amz-Target": "Logs_20140328.CreateLogStream"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateLogStreamInput, CreateLogStreamOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    ///
    /// - Returns: [no documentation found] (Type: `CreateLookupTableOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    /// - `ValidationException` : One of the parameters for the request is not valid.
    public func createLookupTable(input: CreateLookupTableInput) async throws -> CreateLookupTableOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.createLookupTableOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "createLookupTable")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<CreateLookupTableInput, CreateLookupTableOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<CreateLookupTableInput, CreateLookupTableOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<CreateLookupTableInput, CreateLookupTableOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<CreateLookupTableOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("CloudWatch Logs", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateLookupTableOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateLookupTableInput, CreateLookupTableOutput>(overrides: ["X-Amz-Target": "Logs_20140328.CreateLookupTable"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<CreateLookupTableInput, CreateLookupTableOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<CreateLookupTableOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<CreateLookupTableInput, CreateLookupTableOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<CreateLookupTableInput, CreateLookupTableOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateLookupTableInput, CreateLookupTableOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "CreateLookupTable")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func createScheduledQuery(input: CreateScheduledQueryInput) async throws -> CreateScheduledQueryOutput {
        ...
        let operation = CloudWatchLogsClient.createScheduledQueryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateScheduledQueryInput, CreateScheduledQueryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.CreateScheduledQuery"]))
    ...
    public func deleteAccountPolicy(input: DeleteAccountPolicyInput) async throws -> DeleteAccountPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.deleteAccountPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAccountPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteAccountPolicyInput, DeleteAccountPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteAccountPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAccountPolicyInput, DeleteAccountPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteDataProtectionPolicy` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteDataProtectionPolicy(input: DeleteDataProtectionPolicyInput) async throws -> DeleteDataProtectionPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.deleteDataProtectionPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteDataProtectionPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteDataProtectionPolicyInput, DeleteDataProtectionPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteDataProtectionPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteDataProtectionPolicyInput, DeleteDataProtectionPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteDelivery` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteDelivery(input: DeleteDeliveryInput) async throws -> DeleteDeliveryOutput {
        ...
        let operation = CloudWatchLogsClient.deleteDeliveryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteDeliveryOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteDeliveryInput, DeleteDeliveryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteDelivery"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteDeliveryInput, DeleteDeliveryOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteDeliveryDestination` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteDeliveryDestination(input: DeleteDeliveryDestinationInput) async throws -> DeleteDeliveryDestinationOutput {
        ...
        let operation = CloudWatchLogsClient.deleteDeliveryDestinationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteDeliveryDestinationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteDeliveryDestinationInput, DeleteDeliveryDestinationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteDeliveryDestination"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteDeliveryDestinationInput, DeleteDeliveryDestinationOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteDeliveryDestinationPolicy` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteDeliveryDestinationPolicy(input: DeleteDeliveryDestinationPolicyInput) async throws -> DeleteDeliveryDestinationPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.deleteDeliveryDestinationPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteDeliveryDestinationPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteDeliveryDestinationPolicyInput, DeleteDeliveryDestinationPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteDeliveryDestinationPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteDeliveryDestinationPolicyInput, DeleteDeliveryDestinationPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteDeliverySource` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteDeliverySource(input: DeleteDeliverySourceInput) async throws -> DeleteDeliverySourceOutput {
        ...
        let operation = CloudWatchLogsClient.deleteDeliverySourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteDeliverySourceOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteDeliverySourceInput, DeleteDeliverySourceOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteDeliverySource"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteDeliverySourceInput, DeleteDeliverySourceOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteDestination` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteDestination(input: DeleteDestinationInput) async throws -> DeleteDestinationOutput {
        ...
        let operation = CloudWatchLogsClient.deleteDestinationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteDestinationInput, DeleteDestinationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteDestination"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteDestinationInput, DeleteDestinationOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func deleteIndexPolicy(input: DeleteIndexPolicyInput) async throws -> DeleteIndexPolicyOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.deleteIndexPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteIndexPolicy")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DeleteIndexPolicyInput, DeleteIndexPolicyOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteIndexPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteIndexPolicyInput, DeleteIndexPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteIndexPolicy"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DeleteIndexPolicyInput, DeleteIndexPolicyOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DeleteIndexPolicyOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DeleteIndexPolicyInput, DeleteIndexPolicyOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DeleteIndexPolicyInput, DeleteIndexPolicyOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteIndexPolicyInput, DeleteIndexPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DeleteIndexPolicy")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `DeleteIntegration` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteIntegration(input: DeleteIntegrationInput) async throws -> DeleteIntegrationOutput {
        ...
        let operation = CloudWatchLogsClient.deleteIntegrationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteIntegrationInput, DeleteIntegrationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteIntegration"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteIntegrationInput, DeleteIntegrationOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteLogAnomalyDetector` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteLogAnomalyDetector(input: DeleteLogAnomalyDetectorInput) async throws -> DeleteLogAnomalyDetectorOutput {
        ...
        let operation = CloudWatchLogsClient.deleteLogAnomalyDetectorOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteLogAnomalyDetectorOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteLogAnomalyDetectorInput, DeleteLogAnomalyDetectorOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteLogAnomalyDetector"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteLogAnomalyDetectorInput, DeleteLogAnomalyDetectorOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteLogGroup` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteLogGroup(input: DeleteLogGroupInput) async throws -> DeleteLogGroupOutput {
        ...
        let operation = CloudWatchLogsClient.deleteLogGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteLogGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteLogGroupInput, DeleteLogGroupOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteLogGroup"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteLogGroupInput, DeleteLogGroupOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteLogStream` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteLogStream(input: DeleteLogStreamInput) async throws -> DeleteLogStreamOutput {
        ...
        let operation = CloudWatchLogsClient.deleteLogStreamOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteLogStreamOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteLogStreamInput, DeleteLogStreamOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteLogStream"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteLogStreamInput, DeleteLogStreamOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteLookupTable` operation on the `CloudWatchLogs` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DeleteLookupTableInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteLookupTableOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func deleteLookupTable(input: DeleteLookupTableInput) async throws -> DeleteLookupTableOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.deleteLookupTableOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteLookupTable")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DeleteLookupTableInput, DeleteLookupTableOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<DeleteLookupTableInput, DeleteLookupTableOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<DeleteLookupTableInput, DeleteLookupTableOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<DeleteLookupTableOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("CloudWatch Logs", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteLookupTableOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteLookupTableInput, DeleteLookupTableOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteLookupTable"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DeleteLookupTableInput, DeleteLookupTableOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DeleteLookupTableOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DeleteLookupTableInput, DeleteLookupTableOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DeleteLookupTableInput, DeleteLookupTableOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteLookupTableInput, DeleteLookupTableOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DeleteLookupTable")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `DeleteMetricFilter` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteMetricFilter(input: DeleteMetricFilterInput) async throws -> DeleteMetricFilterOutput {
        ...
        let operation = CloudWatchLogsClient.deleteMetricFilterOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteMetricFilterOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteMetricFilterInput, DeleteMetricFilterOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteMetricFilter"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteMetricFilterInput, DeleteMetricFilterOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteQueryDefinition` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteQueryDefinition(input: DeleteQueryDefinitionInput) async throws -> DeleteQueryDefinitionOutput {
        ...
        let operation = CloudWatchLogsClient.deleteQueryDefinitionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteQueryDefinitionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteQueryDefinitionInput, DeleteQueryDefinitionOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteQueryDefinition"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteQueryDefinitionInput, DeleteQueryDefinitionOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteResourcePolicy` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteResourcePolicy(input: DeleteResourcePolicyInput) async throws -> DeleteResourcePolicyOutput {
        ...
        let operation = CloudWatchLogsClient.deleteResourcePolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteResourcePolicyInput, DeleteResourcePolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteResourcePolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteResourcePolicyInput, DeleteResourcePolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DeleteRetentionPolicy` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func deleteRetentionPolicy(input: DeleteRetentionPolicyInput) async throws -> DeleteRetentionPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.deleteRetentionPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteRetentionPolicyInput, DeleteRetentionPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteRetentionPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteRetentionPolicyInput, DeleteRetentionPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func deleteScheduledQuery(input: DeleteScheduledQueryInput) async throws -> DeleteScheduledQueryOutput {
        ...
        let operation = CloudWatchLogsClient.deleteScheduledQueryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteScheduledQueryInput, DeleteScheduledQueryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteScheduledQuery"]))
    ...
    public func deleteSubscriptionFilter(input: DeleteSubscriptionFilterInput) async throws -> DeleteSubscriptionFilterOutput {
        ...
        let operation = CloudWatchLogsClient.deleteSubscriptionFilterOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteSubscriptionFilterOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteSubscriptionFilterInput, DeleteSubscriptionFilterOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteSubscriptionFilter"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteSubscriptionFilterInput, DeleteSubscriptionFilterOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func deleteTransformer(input: DeleteTransformerInput) async throws -> DeleteTransformerOutput {
        ...
        let operation = CloudWatchLogsClient.deleteTransformerOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteTransformerInput, DeleteTransformerOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DeleteTransformer"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DeleteTransformerInput, DeleteTransformerOutput>(contentType: "application/x-amz-json-1.1"))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteTransformerInput, DeleteTransformerOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeAccountPolicies` operation on the `CloudWatchLogs` service.
    ///
    /// Returns a list of all CloudWatch Logs account policies in the account. To use this operation, you must be signed on with the correct permissions depending on the type of policy that you are retrieving information for.
    ///
    ...
    public func describeAccountPolicies(input: DescribeAccountPoliciesInput) async throws -> DescribeAccountPoliciesOutput {
        ...
        let operation = CloudWatchLogsClient.describeAccountPoliciesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeAccountPoliciesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeAccountPoliciesInput, DescribeAccountPoliciesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeAccountPolicies"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeAccountPoliciesInput, DescribeAccountPoliciesOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeConfigurationTemplates` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func describeConfigurationTemplates(input: DescribeConfigurationTemplatesInput) async throws -> DescribeConfigurationTemplatesOutput {
        ...
        let operation = CloudWatchLogsClient.describeConfigurationTemplatesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeConfigurationTemplatesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeConfigurationTemplatesInput, DescribeConfigurationTemplatesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeConfigurationTemplates"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeConfigurationTemplatesInput, DescribeConfigurationTemplatesOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func describeDeliveries(input: DescribeDeliveriesInput) async throws -> DescribeDeliveriesOutput {
        ...
        let operation = CloudWatchLogsClient.describeDeliveriesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeDeliveriesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeDeliveriesInput, DescribeDeliveriesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeDeliveries"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeDeliveriesInput, DescribeDeliveriesOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeDeliveryDestinations` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func describeDeliveryDestinations(input: DescribeDeliveryDestinationsInput) async throws -> DescribeDeliveryDestinationsOutput {
        ...
        let operation = CloudWatchLogsClient.describeDeliveryDestinationsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeDeliveryDestinationsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeDeliveryDestinationsInput, DescribeDeliveryDestinationsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeDeliveryDestinations"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeDeliveryDestinationsInput, DescribeDeliveryDestinationsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeDeliverySources` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func describeDeliverySources(input: DescribeDeliverySourcesInput) async throws -> DescribeDeliverySourcesOutput {
        ...
        let operation = CloudWatchLogsClient.describeDeliverySourcesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeDeliverySourcesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeDeliverySourcesInput, DescribeDeliverySourcesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeDeliverySources"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeDeliverySourcesInput, DescribeDeliverySourcesOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeDestinations` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func describeDestinations(input: DescribeDestinationsInput) async throws -> DescribeDestinationsOutput {
        ...
        let operation = CloudWatchLogsClient.describeDestinationsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeDestinationsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeDestinationsInput, DescribeDestinationsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeDestinations"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeDestinationsInput, DescribeDestinationsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeExportTasks` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func describeExportTasks(input: DescribeExportTasksInput) async throws -> DescribeExportTasksOutput {
        ...
        let operation = CloudWatchLogsClient.describeExportTasksOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeExportTasksInput, DescribeExportTasksOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeExportTasks"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeExportTasksInput, DescribeExportTasksOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func describeFieldIndexes(input: DescribeFieldIndexesInput) async throws -> DescribeFieldIndexesOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.describeFieldIndexesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "describeFieldIndexes")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DescribeFieldIndexesInput, DescribeFieldIndexesOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeFieldIndexesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeFieldIndexesInput, DescribeFieldIndexesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeFieldIndexes"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DescribeFieldIndexesInput, DescribeFieldIndexesOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DescribeFieldIndexesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DescribeFieldIndexesInput, DescribeFieldIndexesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DescribeFieldIndexesInput, DescribeFieldIndexesOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeFieldIndexesInput, DescribeFieldIndexesOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DescribeFieldIndexes")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func describeImportTaskBatches(input: DescribeImportTaskBatchesInput) async throws -> DescribeImportTaskBatchesOutput {
        ...
        let operation = CloudWatchLogsClient.describeImportTaskBatchesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeImportTaskBatchesInput, DescribeImportTaskBatchesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeImportTaskBatches"]))
    ...
    public func describeImportTasks(input: DescribeImportTasksInput) async throws -> DescribeImportTasksOutput {
        ...
        let operation = CloudWatchLogsClient.describeImportTasksOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeImportTasksInput, DescribeImportTasksOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeImportTasks"]))
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func describeIndexPolicies(input: DescribeIndexPoliciesInput) async throws -> DescribeIndexPoliciesOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.describeIndexPoliciesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "describeIndexPolicies")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DescribeIndexPoliciesInput, DescribeIndexPoliciesOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeIndexPoliciesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeIndexPoliciesInput, DescribeIndexPoliciesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeIndexPolicies"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DescribeIndexPoliciesInput, DescribeIndexPoliciesOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DescribeIndexPoliciesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DescribeIndexPoliciesInput, DescribeIndexPoliciesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DescribeIndexPoliciesInput, DescribeIndexPoliciesOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeIndexPoliciesInput, DescribeIndexPoliciesOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DescribeIndexPolicies")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func describeLogGroups(input: DescribeLogGroupsInput) async throws -> DescribeLogGroupsOutput {
        ...
        let operation = CloudWatchLogsClient.describeLogGroupsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeLogGroupsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeLogGroupsInput, DescribeLogGroupsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeLogGroups"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeLogGroupsInput, DescribeLogGroupsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeLogStreams` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func describeLogStreams(input: DescribeLogStreamsInput) async throws -> DescribeLogStreamsOutput {
        ...
        let operation = CloudWatchLogsClient.describeLogStreamsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeLogStreamsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeLogStreamsInput, DescribeLogStreamsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeLogStreams"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeLogStreamsInput, DescribeLogStreamsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeLookupTables` operation on the `CloudWatchLogs` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeLookupTablesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeLookupTablesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func describeLookupTables(input: DescribeLookupTablesInput) async throws -> DescribeLookupTablesOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.describeLookupTablesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "describeLookupTables")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DescribeLookupTablesInput, DescribeLookupTablesOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<DescribeLookupTablesInput, DescribeLookupTablesOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<DescribeLookupTablesInput, DescribeLookupTablesOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<DescribeLookupTablesOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("CloudWatch Logs", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeLookupTablesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeLookupTablesInput, DescribeLookupTablesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeLookupTables"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DescribeLookupTablesInput, DescribeLookupTablesOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DescribeLookupTablesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DescribeLookupTablesInput, DescribeLookupTablesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DescribeLookupTablesInput, DescribeLookupTablesOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeLookupTablesInput, DescribeLookupTablesOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DescribeLookupTables")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `DescribeMetricFilters` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func describeMetricFilters(input: DescribeMetricFiltersInput) async throws -> DescribeMetricFiltersOutput {
        ...
        let operation = CloudWatchLogsClient.describeMetricFiltersOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeMetricFiltersOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeMetricFiltersInput, DescribeMetricFiltersOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeMetricFilters"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeMetricFiltersInput, DescribeMetricFiltersOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func describeQueries(input: DescribeQueriesInput) async throws -> DescribeQueriesOutput {
        ...
        let operation = CloudWatchLogsClient.describeQueriesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeQueriesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeQueriesInput, DescribeQueriesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeQueries"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeQueriesInput, DescribeQueriesOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeQueryDefinitions` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func describeQueryDefinitions(input: DescribeQueryDefinitionsInput) async throws -> DescribeQueryDefinitionsOutput {
        ...
        let operation = CloudWatchLogsClient.describeQueryDefinitionsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeQueryDefinitionsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeQueryDefinitionsInput, DescribeQueryDefinitionsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeQueryDefinitions"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeQueryDefinitionsInput, DescribeQueryDefinitionsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeResourcePolicies` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func describeResourcePolicies(input: DescribeResourcePoliciesInput) async throws -> DescribeResourcePoliciesOutput {
        ...
        let operation = CloudWatchLogsClient.describeResourcePoliciesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeResourcePoliciesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeResourcePoliciesInput, DescribeResourcePoliciesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeResourcePolicies"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeResourcePoliciesInput, DescribeResourcePoliciesOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DescribeSubscriptionFilters` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func describeSubscriptionFilters(input: DescribeSubscriptionFiltersInput) async throws -> DescribeSubscriptionFiltersOutput {
        ...
        let operation = CloudWatchLogsClient.describeSubscriptionFiltersOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeSubscriptionFiltersOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeSubscriptionFiltersInput, DescribeSubscriptionFiltersOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DescribeSubscriptionFilters"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeSubscriptionFiltersInput, DescribeSubscriptionFiltersOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `DisassociateKmsKey` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func disassociateKmsKey(input: DisassociateKmsKeyInput) async throws -> DisassociateKmsKeyOutput {
        ...
        let operation = CloudWatchLogsClient.disassociateKmsKeyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DisassociateKmsKeyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DisassociateKmsKeyInput, DisassociateKmsKeyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DisassociateKmsKey"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DisassociateKmsKeyInput, DisassociateKmsKeyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func disassociateSourceFromS3TableIntegration(input: DisassociateSourceFromS3TableIntegrationInput) async throws -> DisassociateSourceFromS3TableIntegrationOutput {
        ...
        let operation = CloudWatchLogsClient.disassociateSourceFromS3TableIntegrationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DisassociateSourceFromS3TableIntegrationInput, DisassociateSourceFromS3TableIntegrationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.DisassociateSourceFromS3TableIntegration"]))
    ...
    public func filterLogEvents(input: FilterLogEventsInput) async throws -> FilterLogEventsOutput {
        ...
        let operation = CloudWatchLogsClient.filterLogEventsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<FilterLogEventsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<FilterLogEventsInput, FilterLogEventsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.FilterLogEvents"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<FilterLogEventsInput, FilterLogEventsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `GetDataProtectionPolicy` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func getDataProtectionPolicy(input: GetDataProtectionPolicyInput) async throws -> GetDataProtectionPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.getDataProtectionPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetDataProtectionPolicyInput, GetDataProtectionPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetDataProtectionPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDataProtectionPolicyInput, GetDataProtectionPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `GetDelivery` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func getDelivery(input: GetDeliveryInput) async throws -> GetDeliveryOutput {
        ...
        let operation = CloudWatchLogsClient.getDeliveryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetDeliveryOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetDeliveryInput, GetDeliveryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetDelivery"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDeliveryInput, GetDeliveryOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `GetDeliveryDestination` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func getDeliveryDestination(input: GetDeliveryDestinationInput) async throws -> GetDeliveryDestinationOutput {
        ...
        let operation = CloudWatchLogsClient.getDeliveryDestinationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetDeliveryDestinationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetDeliveryDestinationInput, GetDeliveryDestinationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetDeliveryDestination"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDeliveryDestinationInput, GetDeliveryDestinationOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `GetDeliveryDestinationPolicy` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func getDeliveryDestinationPolicy(input: GetDeliveryDestinationPolicyInput) async throws -> GetDeliveryDestinationPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.getDeliveryDestinationPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetDeliveryDestinationPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetDeliveryDestinationPolicyInput, GetDeliveryDestinationPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetDeliveryDestinationPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDeliveryDestinationPolicyInput, GetDeliveryDestinationPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `GetDeliverySource` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func getDeliverySource(input: GetDeliverySourceInput) async throws -> GetDeliverySourceOutput {
        ...
        let operation = CloudWatchLogsClient.getDeliverySourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetDeliverySourceOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetDeliverySourceInput, GetDeliverySourceOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetDeliverySource"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDeliverySourceInput, GetDeliverySourceOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `GetIntegration` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func getIntegration(input: GetIntegrationInput) async throws -> GetIntegrationOutput {
        ...
        let operation = CloudWatchLogsClient.getIntegrationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetIntegrationInput, GetIntegrationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetIntegration"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetIntegrationInput, GetIntegrationOutput>(contentType: "application/x-amz-json-1.1"))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetIntegrationInput, GetIntegrationOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `GetLogAnomalyDetector` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func getLogAnomalyDetector(input: GetLogAnomalyDetectorInput) async throws -> GetLogAnomalyDetectorOutput {
        ...
        let operation = CloudWatchLogsClient.getLogAnomalyDetectorOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetLogAnomalyDetectorOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetLogAnomalyDetectorInput, GetLogAnomalyDetectorOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetLogAnomalyDetector"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetLogAnomalyDetectorInput, GetLogAnomalyDetectorOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `GetLogEvents` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func getLogEvents(input: GetLogEventsInput) async throws -> GetLogEventsOutput {
        ...
        let operation = CloudWatchLogsClient.getLogEventsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetLogEventsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetLogEventsInput, GetLogEventsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetLogEvents"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetLogEventsInput, GetLogEventsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func getLogFields(input: GetLogFieldsInput) async throws -> GetLogFieldsOutput {
        ...
        let operation = CloudWatchLogsClient.getLogFieldsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetLogFieldsInput, GetLogFieldsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetLogFields"]))
    ...
    public func getLogGroupFields(input: GetLogGroupFieldsInput) async throws -> GetLogGroupFieldsOutput {
        ...
        let operation = CloudWatchLogsClient.getLogGroupFieldsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetLogGroupFieldsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetLogGroupFieldsInput, GetLogGroupFieldsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetLogGroupFields"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetLogGroupFieldsInput, GetLogGroupFieldsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// - `LimitExceededException` : You have reached the maximum number of resources that can be created.
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    public func getLogObject(input: GetLogObjectInput) async throws -> GetLogObjectOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.getLogObjectOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getLogObject")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetLogObjectOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetLogObjectInput, GetLogObjectOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetLogObject"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetLogObjectInput, GetLogObjectOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetLogObjectOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetLogObjectInput, GetLogObjectOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetLogObjectInput, GetLogObjectOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetLogObjectInput, GetLogObjectOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetLogObject")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `GetLogRecord` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func getLogRecord(input: GetLogRecordInput) async throws -> GetLogRecordOutput {
        ...
        let operation = CloudWatchLogsClient.getLogRecordOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetLogRecordOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetLogRecordInput, GetLogRecordOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetLogRecord"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetLogRecordInput, GetLogRecordOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `GetLookupTable` operation on the `CloudWatchLogs` service.
    ///
    /// Retrieves the full content of a lookup table, including the CSV data.
    ///
    /// - Parameter input: [no documentation found] (Type: `GetLookupTableInput`)
    ///
    /// - Returns: [no documentation found] (Type: `GetLookupTableOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func getLookupTable(input: GetLookupTableInput) async throws -> GetLookupTableOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.getLookupTableOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getLookupTable")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetLookupTableInput, GetLookupTableOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetLookupTableInput, GetLookupTableOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetLookupTableInput, GetLookupTableOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<GetLookupTableOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("CloudWatch Logs", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetLookupTableOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetLookupTableInput, GetLookupTableOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetLookupTable"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetLookupTableInput, GetLookupTableOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetLookupTableOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetLookupTableInput, GetLookupTableOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetLookupTableInput, GetLookupTableOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetLookupTableInput, GetLookupTableOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetLookupTable")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func getQueryResults(input: GetQueryResultsInput) async throws -> GetQueryResultsOutput {
        ...
        let operation = CloudWatchLogsClient.getQueryResultsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetQueryResultsInput, GetQueryResultsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetQueryResults"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetQueryResultsInput, GetQueryResultsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func getScheduledQuery(input: GetScheduledQueryInput) async throws -> GetScheduledQueryOutput {
        ...
        let operation = CloudWatchLogsClient.getScheduledQueryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetScheduledQueryInput, GetScheduledQueryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetScheduledQuery"]))
    ...
    public func getScheduledQueryHistory(input: GetScheduledQueryHistoryInput) async throws -> GetScheduledQueryHistoryOutput {
        ...
        let operation = CloudWatchLogsClient.getScheduledQueryHistoryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetScheduledQueryHistoryInput, GetScheduledQueryHistoryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetScheduledQueryHistory"]))
    ...
    ///
    /// - Returns: [no documentation found] (Type: `GetStorageTierPolicyOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func getStorageTierPolicy(input: GetStorageTierPolicyInput) async throws -> GetStorageTierPolicyOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.getStorageTierPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getStorageTierPolicy")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetStorageTierPolicyInput, GetStorageTierPolicyOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetStorageTierPolicyInput, GetStorageTierPolicyOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetStorageTierPolicyInput, GetStorageTierPolicyOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<GetStorageTierPolicyOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("CloudWatch Logs", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetStorageTierPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetStorageTierPolicyInput, GetStorageTierPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetStorageTierPolicy"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetStorageTierPolicyInput, GetStorageTierPolicyOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetStorageTierPolicyOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetStorageTierPolicyInput, GetStorageTierPolicyOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetStorageTierPolicyInput, GetStorageTierPolicyOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetStorageTierPolicyInput, GetStorageTierPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetStorageTierPolicy")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func getTransformer(input: GetTransformerInput) async throws -> GetTransformerOutput {
        ...
        let operation = CloudWatchLogsClient.getTransformerOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetTransformerInput, GetTransformerOutput>(overrides: ["X-Amz-Target": "Logs_20140328.GetTransformer"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetTransformerInput, GetTransformerOutput>(contentType: "application/x-amz-json-1.1"))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetTransformerInput, GetTransformerOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func listAggregateLogGroupSummaries(input: ListAggregateLogGroupSummariesInput) async throws -> ListAggregateLogGroupSummariesOutput {
        ...
        let operation = CloudWatchLogsClient.listAggregateLogGroupSummariesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListAggregateLogGroupSummariesInput, ListAggregateLogGroupSummariesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.ListAggregateLogGroupSummaries"]))
    ...
    public func listAnomalies(input: ListAnomaliesInput) async throws -> ListAnomaliesOutput {
        ...
        let operation = CloudWatchLogsClient.listAnomaliesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAnomaliesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListAnomaliesInput, ListAnomaliesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.ListAnomalies"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAnomaliesInput, ListAnomaliesOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `ListIntegrations` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func listIntegrations(input: ListIntegrationsInput) async throws -> ListIntegrationsOutput {
        ...
        let operation = CloudWatchLogsClient.listIntegrationsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListIntegrationsInput, ListIntegrationsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.ListIntegrations"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListIntegrationsInput, ListIntegrationsOutput>(contentType: "application/x-amz-json-1.1"))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListIntegrationsInput, ListIntegrationsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `ListLogAnomalyDetectors` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func listLogAnomalyDetectors(input: ListLogAnomalyDetectorsInput) async throws -> ListLogAnomalyDetectorsOutput {
        ...
        let operation = CloudWatchLogsClient.listLogAnomalyDetectorsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListLogAnomalyDetectorsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListLogAnomalyDetectorsInput, ListLogAnomalyDetectorsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.ListLogAnomalyDetectors"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListLogAnomalyDetectorsInput, ListLogAnomalyDetectorsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    ///
    /// Returns a list of log groups in the Region in your account. If you are performing this action in a monitoring account, you can choose to also return log groups from source accounts that are linked to the monitoring account. For more information about using cross-account observability to set up monitoring accounts and source accounts, see [ CloudWatch cross-account observability](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account.html). You can optionally filter the results by log group class, log group name pattern, field indexes, data sources, field index names, or log group tags. If you specify more than one filter type, the results include log groups that satisfy all filters. This operation is paginated. By default, your first use of this operation returns 50 results, and includes a token to use in a subsequent operation to return more results.
    ///
    ...
    /// - `InvalidParameterException` : A parameter is specified incorrectly.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func listLogGroups(input: ListLogGroupsInput) async throws -> ListLogGroupsOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.listLogGroupsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listLogGroups")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListLogGroupsInput, ListLogGroupsOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListLogGroupsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListLogGroupsInput, ListLogGroupsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.ListLogGroups"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListLogGroupsInput, ListLogGroupsOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListLogGroupsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListLogGroupsInput, ListLogGroupsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListLogGroupsInput, ListLogGroupsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListLogGroupsInput, ListLogGroupsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListLogGroups")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListLogGroupsForQuery` operation on the `CloudWatchLogs` service.
    ///
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func listLogGroupsForQuery(input: ListLogGroupsForQueryInput) async throws -> ListLogGroupsForQueryOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.listLogGroupsForQueryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listLogGroupsForQuery")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListLogGroupsForQueryInput, ListLogGroupsForQueryOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListLogGroupsForQueryOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListLogGroupsForQueryInput, ListLogGroupsForQueryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.ListLogGroupsForQuery"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListLogGroupsForQueryInput, ListLogGroupsForQueryOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListLogGroupsForQueryOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListLogGroupsForQueryInput, ListLogGroupsForQueryOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListLogGroupsForQueryInput, ListLogGroupsForQueryOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListLogGroupsForQueryInput, ListLogGroupsForQueryOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListLogGroupsForQuery")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func listScheduledQueries(input: ListScheduledQueriesInput) async throws -> ListScheduledQueriesOutput {
        ...
        let operation = CloudWatchLogsClient.listScheduledQueriesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListScheduledQueriesInput, ListScheduledQueriesOutput>(overrides: ["X-Amz-Target": "Logs_20140328.ListScheduledQueries"]))
    ...
    public func listSourcesForS3TableIntegration(input: ListSourcesForS3TableIntegrationInput) async throws -> ListSourcesForS3TableIntegrationOutput {
        ...
        let operation = CloudWatchLogsClient.listSourcesForS3TableIntegrationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListSourcesForS3TableIntegrationInput, ListSourcesForS3TableIntegrationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.ListSourcesForS3TableIntegration"]))
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput {
        ...
        let operation = CloudWatchLogsClient.listTagsForResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput>(overrides: ["X-Amz-Target": "Logs_20140328.ListTagsForResource"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `ListTagsLogGroup` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func listTagsLogGroup(input: ListTagsLogGroupInput) async throws -> ListTagsLogGroupOutput {
        ...
        let operation = CloudWatchLogsClient.listTagsLogGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListTagsLogGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListTagsLogGroupInput, ListTagsLogGroupOutput>(overrides: ["X-Amz-Target": "Logs_20140328.ListTagsLogGroup"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListTagsLogGroupInput, ListTagsLogGroupOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func putAccountPolicy(input: PutAccountPolicyInput) async throws -> PutAccountPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.putAccountPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutAccountPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutAccountPolicyInput, PutAccountPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutAccountPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccountPolicyInput, PutAccountPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func putBearerTokenAuthentication(input: PutBearerTokenAuthenticationInput) async throws -> PutBearerTokenAuthenticationOutput {
        ...
        let operation = CloudWatchLogsClient.putBearerTokenAuthenticationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `PutDataProtectionPolicy` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func putDataProtectionPolicy(input: PutDataProtectionPolicyInput) async throws -> PutDataProtectionPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.putDataProtectionPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutDataProtectionPolicyInput, PutDataProtectionPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutDataProtectionPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutDataProtectionPolicyInput, PutDataProtectionPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func putDeliveryDestination(input: PutDeliveryDestinationInput) async throws -> PutDeliveryDestinationOutput {
        ...
        let operation = CloudWatchLogsClient.putDeliveryDestinationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutDeliveryDestinationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutDeliveryDestinationInput, PutDeliveryDestinationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutDeliveryDestination"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutDeliveryDestinationInput, PutDeliveryDestinationOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `PutDeliveryDestinationPolicy` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func putDeliveryDestinationPolicy(input: PutDeliveryDestinationPolicyInput) async throws -> PutDeliveryDestinationPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.putDeliveryDestinationPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutDeliveryDestinationPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutDeliveryDestinationPolicyInput, PutDeliveryDestinationPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutDeliveryDestinationPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutDeliveryDestinationPolicyInput, PutDeliveryDestinationPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func putDeliverySource(input: PutDeliverySourceInput) async throws -> PutDeliverySourceOutput {
        ...
        let operation = CloudWatchLogsClient.putDeliverySourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutDeliverySourceOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutDeliverySourceInput, PutDeliverySourceOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutDeliverySource"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutDeliverySourceInput, PutDeliverySourceOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `PutDestination` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func putDestination(input: PutDestinationInput) async throws -> PutDestinationOutput {
        ...
        let operation = CloudWatchLogsClient.putDestinationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutDestinationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutDestinationInput, PutDestinationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutDestination"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutDestinationInput, PutDestinationOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `PutDestinationPolicy` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func putDestinationPolicy(input: PutDestinationPolicyInput) async throws -> PutDestinationPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.putDestinationPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutDestinationPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutDestinationPolicyInput, PutDestinationPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutDestinationPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutDestinationPolicyInput, PutDestinationPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func putIndexPolicy(input: PutIndexPolicyInput) async throws -> PutIndexPolicyOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.putIndexPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "putIndexPolicy")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<PutIndexPolicyInput, PutIndexPolicyOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutIndexPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutIndexPolicyInput, PutIndexPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutIndexPolicy"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutIndexPolicyInput, PutIndexPolicyOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<PutIndexPolicyOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<PutIndexPolicyInput, PutIndexPolicyOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<PutIndexPolicyInput, PutIndexPolicyOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutIndexPolicyInput, PutIndexPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "PutIndexPolicy")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `PutIntegration` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func putIntegration(input: PutIntegrationInput) async throws -> PutIntegrationOutput {
        ...
        let operation = CloudWatchLogsClient.putIntegrationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutIntegrationInput, PutIntegrationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutIntegration"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutIntegrationInput, PutIntegrationOutput>(contentType: "application/x-amz-json-1.1"))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutIntegrationInput, PutIntegrationOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `PutLogEvents` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func putLogEvents(input: PutLogEventsInput) async throws -> PutLogEventsOutput {
        ...
        let operation = CloudWatchLogsClient.putLogEventsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutLogEventsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutLogEventsInput, PutLogEventsOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutLogEvents"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutLogEventsInput, PutLogEventsOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func putLogGroupDeletionProtection(input: PutLogGroupDeletionProtectionInput) async throws -> PutLogGroupDeletionProtectionOutput {
        ...
        let operation = CloudWatchLogsClient.putLogGroupDeletionProtectionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutLogGroupDeletionProtectionInput, PutLogGroupDeletionProtectionOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutLogGroupDeletionProtection"]))
    ...
    public func putMetricFilter(input: PutMetricFilterInput) async throws -> PutMetricFilterOutput {
        ...
        let operation = CloudWatchLogsClient.putMetricFilterOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutMetricFilterOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutMetricFilterInput, PutMetricFilterOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutMetricFilter"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutMetricFilterInput, PutMetricFilterOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `PutQueryDefinition` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func putQueryDefinition(input: PutQueryDefinitionInput) async throws -> PutQueryDefinitionOutput {
        ...
        let operation = CloudWatchLogsClient.putQueryDefinitionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutQueryDefinitionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutQueryDefinitionInput, PutQueryDefinitionOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutQueryDefinition"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutQueryDefinitionInput, PutQueryDefinitionOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func putResourcePolicy(input: PutResourcePolicyInput) async throws -> PutResourcePolicyOutput {
        ...
        let operation = CloudWatchLogsClient.putResourcePolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutResourcePolicyInput, PutResourcePolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutResourcePolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutResourcePolicyInput, PutResourcePolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `PutRetentionPolicy` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func putRetentionPolicy(input: PutRetentionPolicyInput) async throws -> PutRetentionPolicyOutput {
        ...
        let operation = CloudWatchLogsClient.putRetentionPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutRetentionPolicyInput, PutRetentionPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutRetentionPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutRetentionPolicyInput, PutRetentionPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    ///
    /// - Returns: [no documentation found] (Type: `PutStorageTierPolicyOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func putStorageTierPolicy(input: PutStorageTierPolicyInput) async throws -> PutStorageTierPolicyOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.putStorageTierPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "putStorageTierPolicy")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<PutStorageTierPolicyInput, PutStorageTierPolicyOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<PutStorageTierPolicyInput, PutStorageTierPolicyOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<PutStorageTierPolicyInput, PutStorageTierPolicyOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<PutStorageTierPolicyOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("CloudWatch Logs", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutStorageTierPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutStorageTierPolicyInput, PutStorageTierPolicyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutStorageTierPolicy"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutStorageTierPolicyInput, PutStorageTierPolicyOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<PutStorageTierPolicyOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<PutStorageTierPolicyInput, PutStorageTierPolicyOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<PutStorageTierPolicyInput, PutStorageTierPolicyOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutStorageTierPolicyInput, PutStorageTierPolicyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "PutStorageTierPolicy")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `PutSubscriptionFilter` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func putSubscriptionFilter(input: PutSubscriptionFilterInput) async throws -> PutSubscriptionFilterOutput {
        ...
        let operation = CloudWatchLogsClient.putSubscriptionFilterOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutSubscriptionFilterOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutSubscriptionFilterInput, PutSubscriptionFilterOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutSubscriptionFilter"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutSubscriptionFilterInput, PutSubscriptionFilterOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `PutTransformer` operation on the `CloudWatchLogs` service.
    ///
    ...
    /// - `ResourceNotFoundException` : The specified resource does not exist.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func putTransformer(input: PutTransformerInput) async throws -> PutTransformerOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.putTransformerOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "putTransformer")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<PutTransformerInput, PutTransformerOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutTransformerOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutTransformerInput, PutTransformerOutput>(overrides: ["X-Amz-Target": "Logs_20140328.PutTransformer"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutTransformerInput, PutTransformerOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<PutTransformerOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<PutTransformerInput, PutTransformerOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<PutTransformerInput, PutTransformerOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutTransformerInput, PutTransformerOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "PutTransformer")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `StartLiveTail` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func startLiveTail(input: StartLiveTailInput) async throws -> StartLiveTailOutput {
        ...
        let operation = CloudWatchLogsClient.startLiveTailOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<StartLiveTailOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<StartLiveTailInput, StartLiveTailOutput>(overrides: ["X-Amz-Target": "Logs_20140328.StartLiveTail"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<StartLiveTailInput, StartLiveTailOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    ///
    /// * Or the queryString must include a SOURCE command to select log groups for the query. The SOURCE command can select log groups based on log group name prefix, account ID, and log class, or select data sources using dataSource syntax in LogsQL, PPL, and SQL. In LogsQL, the SOURCE command also supports filtering by log group tags. For more information about the SOURCE command, see [SOURCE](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CWL_QuerySyntax-Source.html).
    ///
    ///
    ...
    public func startQuery(input: StartQueryInput) async throws -> StartQueryOutput {
        ...
        let operation = CloudWatchLogsClient.startQueryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<StartQueryInput, StartQueryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.StartQuery"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<StartQueryInput, StartQueryOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    public func stopQuery(input: StopQueryInput) async throws -> StopQueryOutput {
        ...
        let operation = CloudWatchLogsClient.stopQueryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<StopQueryOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<StopQueryInput, StopQueryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.StopQuery"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<StopQueryInput, StopQueryOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `TagLogGroup` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func tagLogGroup(input: TagLogGroupInput) async throws -> TagLogGroupOutput {
        ...
        let operation = CloudWatchLogsClient.tagLogGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<TagLogGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<TagLogGroupInput, TagLogGroupOutput>(overrides: ["X-Amz-Target": "Logs_20140328.TagLogGroup"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TagLogGroupInput, TagLogGroupOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `TagResource` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput {
        ...
        let operation = CloudWatchLogsClient.tagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<TagResourceInput, TagResourceOutput>(overrides: ["X-Amz-Target": "Logs_20140328.TagResource"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TagResourceInput, TagResourceOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `TestMetricFilter` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func testMetricFilter(input: TestMetricFilterInput) async throws -> TestMetricFilterOutput {
        ...
        let operation = CloudWatchLogsClient.testMetricFilterOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<TestMetricFilterOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<TestMetricFilterInput, TestMetricFilterOutput>(overrides: ["X-Amz-Target": "Logs_20140328.TestMetricFilter"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TestMetricFilterInput, TestMetricFilterOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `TestTransformer` operation on the `CloudWatchLogs` service.
    ///
    ...
    /// - `InvalidParameterException` : A parameter is specified incorrectly.
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    public func testTransformer(input: TestTransformerInput) async throws -> TestTransformerOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.testTransformerOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "testTransformer")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<TestTransformerInput, TestTransformerOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<TestTransformerOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<TestTransformerInput, TestTransformerOutput>(overrides: ["X-Amz-Target": "Logs_20140328.TestTransformer"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<TestTransformerInput, TestTransformerOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<TestTransformerOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<TestTransformerInput, TestTransformerOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<TestTransformerInput, TestTransformerOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TestTransformerInput, TestTransformerOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "TestTransformer")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `UntagLogGroup` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func untagLogGroup(input: UntagLogGroupInput) async throws -> UntagLogGroupOutput {
        ...
        let operation = CloudWatchLogsClient.untagLogGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UntagLogGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UntagLogGroupInput, UntagLogGroupOutput>(overrides: ["X-Amz-Target": "Logs_20140328.UntagLogGroup"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UntagLogGroupInput, UntagLogGroupOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `UntagResource` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput {
        ...
        let operation = CloudWatchLogsClient.untagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UntagResourceInput, UntagResourceOutput>(overrides: ["X-Amz-Target": "Logs_20140328.UntagResource"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UntagResourceInput, UntagResourceOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `UpdateAnomaly` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func updateAnomaly(input: UpdateAnomalyInput) async throws -> UpdateAnomalyOutput {
        ...
        let operation = CloudWatchLogsClient.updateAnomalyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateAnomalyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateAnomalyInput, UpdateAnomalyOutput>(overrides: ["X-Amz-Target": "Logs_20140328.UpdateAnomaly"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateAnomalyInput, UpdateAnomalyOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `UpdateDeliveryConfiguration` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func updateDeliveryConfiguration(input: UpdateDeliveryConfigurationInput) async throws -> UpdateDeliveryConfigurationOutput {
        ...
        let operation = CloudWatchLogsClient.updateDeliveryConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateDeliveryConfigurationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateDeliveryConfigurationInput, UpdateDeliveryConfigurationOutput>(overrides: ["X-Amz-Target": "Logs_20140328.UpdateDeliveryConfiguration"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateDeliveryConfigurationInput, UpdateDeliveryConfigurationOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    /// Performs the `UpdateLogAnomalyDetector` operation on the `CloudWatchLogs` service.
    ///
    ...
    public func updateLogAnomalyDetector(input: UpdateLogAnomalyDetectorInput) async throws -> UpdateLogAnomalyDetectorOutput {
        ...
        let operation = CloudWatchLogsClient.updateLogAnomalyDetectorOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateLogAnomalyDetectorOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateLogAnomalyDetectorInput, UpdateLogAnomalyDetectorOutput>(overrides: ["X-Amz-Target": "Logs_20140328.UpdateLogAnomalyDetector"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateLogAnomalyDetectorInput, UpdateLogAnomalyDetectorOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
    ...
    ///
    /// - Returns: [no documentation found] (Type: `UpdateLookupTableOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ServiceUnavailableException` : The service cannot complete the request.
    /// - `ValidationException` : One of the parameters for the request is not valid.
    public func updateLookupTable(input: UpdateLookupTableInput) async throws -> UpdateLookupTableOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CloudWatchLogsClient.updateLookupTableOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "updateLookupTable")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<UpdateLookupTableInput, UpdateLookupTableOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<UpdateLookupTableInput, UpdateLookupTableOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<UpdateLookupTableInput, UpdateLookupTableOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<UpdateLookupTableOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("CloudWatch Logs", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateLookupTableOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateLookupTableInput, UpdateLookupTableOutput>(overrides: ["X-Amz-Target": "Logs_20140328.UpdateLookupTable"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<UpdateLookupTableInput, UpdateLookupTableOutput>(contentType: "application/x-amz-json-1.1"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<UpdateLookupTableOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<UpdateLookupTableInput, UpdateLookupTableOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<UpdateLookupTableInput, UpdateLookupTableOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudWatch Logs"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateLookupTableInput, UpdateLookupTableOutput>(serviceID: serviceName, version: CloudWatchLogsClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CloudWatchLogs")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "UpdateLookupTable")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func updateScheduledQuery(input: UpdateScheduledQueryInput) async throws -> UpdateScheduledQueryOutput {
        ...
        let operation = CloudWatchLogsClient.updateScheduledQueryOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateScheduledQueryInput, UpdateScheduledQueryOutput>(overrides: ["X-Amz-Target": "Logs_20140328.UpdateScheduledQuery"]))
