...
extension DescribeAccountPoliciesInput {
    ...
    static func write(value: DescribeAccountPoliciesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["accountIdentifiers"].writeList(value.accountIdentifiers, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["policyName"].write(value.policyName)
        try writer["policyType"].write(value.policyType)
    }
}
...
extension TestMetricFilterInput {
    ...
    static func write(value: TestMetricFilterInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["filterPattern"].write(value.filterPattern)
        try writer["logEventMessages"].writeList(value.logEventMessages, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetLogAnomalyDetectorOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetLogAnomalyDetectorOutput {
        ...
        value.logGroupArnList = try reader["logGroupArnList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetLogRecordOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetLogRecordOutput {
        ...
        value.logRecord = try reader["logRecord"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension GetQueryResultsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetQueryResultsOutput {
        ...
        value.results = try reader["results"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: CloudWatchLogsClientTypes.ResultField.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
...
extension CloudWatchLogsClientTypes.LogGroup {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudWatchLogsClientTypes.LogGroup {
        ...
        value.inheritedProperties = try reader["inheritedProperties"].readListIfPresent(memberReadingClosure: CloudWatchLogsClientTypes.InheritedProperty.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CloudWatchLogsClientTypes.MetricTransformation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudWatchLogsClientTypes.MetricTransformation {
        ...
        value.dimensions = try reader["dimensions"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension CloudWatchLogsClientTypes.QueryDefinition {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudWatchLogsClientTypes.QueryDefinition {
        ...
        value.logGroupNames = try reader["logGroupNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudWatchLogsClientTypes.Anomaly {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudWatchLogsClientTypes.Anomaly {
        ...
        value.histogram = try reader["histogram"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension CloudWatchLogsClientTypes.PatternToken {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudWatchLogsClientTypes.PatternToken {
        ...
        value.enumerations = try reader["enumerations"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension CloudWatchLogsClientTypes.LiveTailSessionStart {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudWatchLogsClientTypes.LiveTailSessionStart {
        ...
        value.logGroupIdentifiers = try reader["logGroupIdentifiers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.logStreamNames = try reader["logStreamNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.logStreamNamePrefixes = try reader["logStreamNamePrefixes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CloudWatchLogsClientTypes.MetricFilterMatchRecord {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudWatchLogsClientTypes.MetricFilterMatchRecord {
        ...
        value.extractedValues = try reader["extractedValues"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
