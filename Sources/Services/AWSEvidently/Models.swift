...
extension GetExperimentResultsInput {
    ...
    static func write(value: GetExperimentResultsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["reportNames"].writeList(value.reportNames, memberWritingClosure: EvidentlyClientTypes.ExperimentReportName.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["resultStats"].writeList(value.resultStats, memberWritingClosure: EvidentlyClientTypes.ExperimentResultRequestType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["startTime"].writeTimestamp(value.startTime, format: .epochSeconds)
        try writer["treatmentNames"].writeList(value.treatmentNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension UpdateFeatureInput {
    ...
    static func write(value: UpdateFeatureInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["entityOverrides"].writeMap(value.entityOverrides, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["evaluationStrategy"].write(value.evaluationStrategy)
        try writer["removeVariations"].writeList(value.removeVariations, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension EvidentlyClientTypes.Treatment {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EvidentlyClientTypes.Treatment {
        ...
        value.name = try reader["name"].readIfPresent()
        value.description = try reader["description"].readIfPresent()
        value.featureVariations = try reader["featureVariations"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension EvidentlyClientTypes.Feature {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EvidentlyClientTypes.Feature {
        ...
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.entityOverrides = try reader["entityOverrides"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension EvidentlyClientTypes.SegmentOverride {
    ...
    static func write(value: EvidentlyClientTypes.SegmentOverride?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["segment"].write(value.segment)
        try writer["weights"].writeMap(value.weights, valueWritingClosure: Swift.Int.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EvidentlyClientTypes.SegmentOverride {
        ...
        value.weights = try reader["weights"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
