...
extension EvidentlyClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> EvidentlyClient.EvidentlyClientConfiguration {
        let clientConfiguration = try await EvidentlyClient.EvidentlyClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> EvidentlyClient {
            let configuration = try await resolve(plugins: self.plugins)
            return EvidentlyClient(config: configuration)
        }
    }
...
extension EvidentlyClient.EvidentlyClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
