...
extension SESClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SESClient.SESClientConfiguration {
        let clientConfiguration = try await SESClient.SESClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SESClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SESClient(config: configuration)
        }
    }
...
extension SESClient.SESClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
