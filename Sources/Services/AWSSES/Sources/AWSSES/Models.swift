...
extension SESClientTypes.MessageDsn {
    ...
    static func write(value: SESClientTypes.MessageDsn?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["ArrivalDate"].writeTimestamp(value.arrivalDate, format: .dateTime)
...
extension SESClientTypes.RecipientDsnFields {
    ...
    static func write(value: SESClientTypes.RecipientDsnFields?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["LastAttemptDate"].writeTimestamp(value.lastAttemptDate, format: .dateTime)
