...
extension CreateSipMediaApplicationCallInput {
    ...
    static func write(value: CreateSipMediaApplicationCallInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ArgumentsMap"].writeMap(value.argumentsMap, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ListAvailableVoiceConnectorRegionsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAvailableVoiceConnectorRegionsOutput {
        ...
        value.voiceConnectorRegions = try reader["VoiceConnectorRegions"].readListIfPresent(memberReadingClosure: ChimeSDKVoiceClientTypes.VoiceConnectorAwsRegion.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ChimeSDKVoiceClientTypes.ProxySession {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ChimeSDKVoiceClientTypes.ProxySession {
        ...
        value.capabilities = try reader["Capabilities"].readListIfPresent(memberReadingClosure: ChimeSDKVoiceClientTypes.Capability.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.createdTimestamp = try reader["CreatedTimestamp"].readTimestampIfPresent(format: .dateTime)
        value.updatedTimestamp = try reader["UpdatedTimestamp"].readTimestampIfPresent(format: .dateTime)
...
extension ChimeSDKVoiceClientTypes.VoiceProfile {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ChimeSDKVoiceClientTypes.VoiceProfile {
        ...
        value.createdTimestamp = try reader["CreatedTimestamp"].readTimestampIfPresent(format: .dateTime)
        value.updatedTimestamp = try reader["UpdatedTimestamp"].readTimestampIfPresent(format: .dateTime)
        value.expirationTimestamp = try reader["ExpirationTimestamp"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
...
extension ChimeSDKVoiceClientTypes.SipMediaApplicationAlexaSkillConfiguration {
    ...
    static func write(value: ChimeSDKVoiceClientTypes.SipMediaApplicationAlexaSkillConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AlexaSkillIds"].writeList(value.alexaSkillIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ChimeSDKVoiceClientTypes.SipMediaApplicationAlexaSkillConfiguration {
        ...
        value.alexaSkillStatus = try reader["AlexaSkillStatus"].readIfPresent()
        value.alexaSkillIds = try reader["AlexaSkillIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ChimeSDKVoiceClientTypes.SpeakerSearchTask {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ChimeSDKVoiceClientTypes.SpeakerSearchTask {
        ...
        value.createdTimestamp = try reader["CreatedTimestamp"].readTimestampIfPresent(format: .dateTime)
        value.updatedTimestamp = try reader["UpdatedTimestamp"].readTimestampIfPresent(format: .dateTime)
        value.startedTimestamp = try reader["StartedTimestamp"].readTimestampIfPresent(format: .dateTime)
...
extension ChimeSDKVoiceClientTypes.PhoneNumberCountry {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ChimeSDKVoiceClientTypes.PhoneNumberCountry {
        ...
        value.supportedPhoneNumberTypes = try reader["SupportedPhoneNumberTypes"].readListIfPresent(memberReadingClosure: ChimeSDKVoiceClientTypes.PhoneNumberType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
