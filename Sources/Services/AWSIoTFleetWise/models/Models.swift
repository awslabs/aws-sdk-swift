...
extension IoTFleetWiseClientTypes.CampaignSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> IoTFleetWiseClientTypes.CampaignSummary {
        ...
        value.lastModificationTime = try reader["lastModificationTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension IoTFleetWiseClientTypes {
    ...
    public enum Compression: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case off
        case snappy
        case sdkUnknown(Swift.String)
...
extension CreateCampaignInput {
    ...
    static func write(value: CreateCampaignInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["dataExtraDimensions"].writeList(value.dataExtraDimensions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["description"].write(value.description)
...
extension CreateModelManifestInput {
    ...
    static func write(value: CreateModelManifestInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["description"].write(value.description)
        try writer["nodes"].writeList(value.nodes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["signalCatalogArn"].write(value.signalCatalogArn)
        try writer["tags"].writeList(value.tags, memberWritingClosure: IoTFleetWiseClientTypes.Tag.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension IoTFleetWiseClientTypes {
    ...
    public enum DiagnosticsMode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case off
        case sendActiveDtcs
        case sdkUnknown(Swift.String)
...
extension GetCampaignOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetCampaignOutput {
        ...
        value.dataExtraDimensions = try reader["dataExtraDimensions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.description = try reader["description"].readIfPresent()
        value.diagnosticsMode = try reader["diagnosticsMode"].readIfPresent()
        value.expiryTime = try reader["expiryTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lastModificationTime = try reader["lastModificationTime"].readTimestampIfPresent(format: .epochSeconds)
        value.name = try reader["name"].readIfPresent()
...
extension ListFleetsForVehicleOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListFleetsForVehicleOutput {
        ...
        value.fleets = try reader["fleets"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListVehiclesInFleetOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListVehiclesInFleetOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.vehicles = try reader["vehicles"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension IoTFleetWiseClientTypes {
    ...
    public enum ManifestStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case active
        case draft
        case invalid
        case validating
...
extension IoTFleetWiseClientTypes {
    ...
    public enum NetworkInterfaceFailureReason: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension IoTFleetWiseClientTypes {
    ...
    public enum NetworkInterfaceType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case canInterface
        case obdInterface
...
extension IoTFleetWiseClientTypes {
    ...
    public enum NodeDataEncoding: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case binary
        case typed
        case sdkUnknown(Swift.String)
...
extension IoTFleetWiseClientTypes {
    ...
    public enum NodeDataType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case boolean
        case booleanArray
        case double
        case doubleArray
...
extension IoTFleetWiseClientTypes {
    ...
    public enum ROS2PrimitiveType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case bool
        case byte
        case char
        case float32
...
extension IoTFleetWiseClientTypes {
    ...
    public enum SignalDecoderFailureReason: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension IoTFleetWiseClientTypes {
    ...
    public enum SignalDecoderType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case canSignal
        case messageSignal
        case obdSignal
        case sdkUnknown(Swift.String)
...
extension IoTFleetWiseClientTypes {
    ...
    public enum SignalNodeType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case actuator
        case attribute
        case branch
        case customProperty
...
extension IoTFleetWiseClientTypes {
    ...
    public enum SpoolingMode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case off
        case toDisk
        case sdkUnknown(Swift.String)
...
extension IoTFleetWiseClientTypes {
    ...
    public enum StorageCompressionFormat: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case gzip
        case `none`
        case sdkUnknown(Swift.String)
...
extension IoTFleetWiseClientTypes {
    ...
    public enum StructuredMessageListType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension IoTFleetWiseClientTypes {
    ...
    public enum TriggerMode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case always
        case risingEdge
        case sdkUnknown(Swift.String)
...
extension IoTFleetWiseClientTypes {
    ...
    public enum UpdateCampaignAction: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case approve
        case resume
        case suspend
        case update
...
extension UpdateDecoderManifestInput {
    ...
    static func write(value: UpdateDecoderManifestInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["networkInterfacesToRemove"].writeList(value.networkInterfacesToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["signalDecodersToRemove"].writeList(value.signalDecodersToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension IoTFleetWiseClientTypes {
    ...
    public enum UpdateMode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case merge
        case overwrite
        case sdkUnknown(Swift.String)
...
extension UpdateModelManifestInput {
    ...
    static func write(value: UpdateModelManifestInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["description"].write(value.description)
        try writer["nodesToAdd"].writeList(value.nodesToAdd, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["nodesToRemove"].writeList(value.nodesToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["status"].write(value.status)
    }
}
...
extension IoTFleetWiseClientTypes {
    ...
    public enum VehicleAssociationBehavior: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case createIotThing
...
extension IoTFleetWiseClientTypes {
    ...
    public enum VehicleMiddlewareProtocol: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case ros2
        case sdkUnknown(Swift.String)
...
extension IoTFleetWiseClientTypes {
    ...
    public enum VehicleState: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case created
        case deleting
        case healthy
        case ready
