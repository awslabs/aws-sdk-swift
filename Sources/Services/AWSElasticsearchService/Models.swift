...
extension CreateElasticsearchDomainInput {
    ...
    static func write(value: CreateElasticsearchDomainInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["AdvancedOptions"].writeMap(value.advancedOptions, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension DescribeVpcEndpointsInput {
    ...
    static func write(value: DescribeVpcEndpointsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["VpcEndpointIds"].writeList(value.vpcEndpointIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension CancelDomainConfigChangeOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CancelDomainConfigChangeOutput {
        ...
        value.cancelledChangeIds = try reader["CancelledChangeIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ListElasticsearchInstanceTypesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListElasticsearchInstanceTypesOutput {
        ...
        value.elasticsearchInstanceTypes = try reader["ElasticsearchInstanceTypes"].readListIfPresent(memberReadingClosure: ElasticsearchClientTypes.ESPartitionInstanceType.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension ListElasticsearchVersionsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListElasticsearchVersionsOutput {
        ...
        value.elasticsearchVersions = try reader["ElasticsearchVersions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension ElasticsearchClientTypes.ServiceSoftwareOptions {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ElasticsearchClientTypes.ServiceSoftwareOptions {
        ...
        value.automatedUpdateDate = try reader["AutomatedUpdateDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension ElasticsearchClientTypes.ElasticsearchDomainStatus {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ElasticsearchClientTypes.ElasticsearchDomainStatus {
        ...
        value.advancedOptions = try reader["AdvancedOptions"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ElasticsearchClientTypes.ChangeProgressStatusDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ElasticsearchClientTypes.ChangeProgressStatusDetails {
        ...
        value.startTime = try reader["StartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.status = try reader["Status"].readIfPresent()
        value.pendingProperties = try reader["PendingProperties"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.completedProperties = try reader["CompletedProperties"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ElasticsearchClientTypes.AutoTuneMaintenanceSchedule {
    ...
    static func write(value: ElasticsearchClientTypes.AutoTuneMaintenanceSchedule?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["StartAt"].writeTimestamp(value.startAt, format: .epochSeconds)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ElasticsearchClientTypes.AutoTuneMaintenanceSchedule {
        ...
        value.startAt = try reader["StartAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension ElasticsearchClientTypes.AdditionalLimit {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ElasticsearchClientTypes.AdditionalLimit {
        ...
        value.limitValues = try reader["LimitValues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticsearchClientTypes.UpgradeStepItem {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ElasticsearchClientTypes.UpgradeStepItem {
        ...
        value.issues = try reader["Issues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
