...
extension DirectoryClient {
    public class DirectoryClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        ...
        public convenience init(useFIPS: Swift.Bool? = nil, useDualStack: Swift.Bool? = nil, appID: Swift.String? = nil, awsCredentialIdentityResolver: (any SmithyIdentity.AWSCredentialIdentityResolver)? = nil, awsRetryMode: AWSClientRuntime.AWSRetryMode? = nil, region: Swift.String? = nil, signingRegion: Swift.String? = nil, endpointResolver: EndpointResolver? = nil, telemetryProvider: ClientRuntime.TelemetryProvider? = nil, retryStrategyOptions: SmithyRetriesAPI.RetryStrategyOptions? = nil, clientLogMode: ClientRuntime.ClientLogMode? = nil, endpoint: Swift.String? = nil, idempotencyTokenGenerator: ClientRuntime.IdempotencyTokenGenerator? = nil, httpClientEngine: SmithyHTTPAPI.HTTPClient? = nil, httpClientConfiguration: ClientRuntime.HttpClientConfiguration? = nil, authSchemes: SmithyHTTPAuthAPI.AuthSchemes? = nil, authSchemeResolver: SmithyHTTPAuthAPI.AuthSchemeResolver? = nil, bearerTokenIdentityResolver: (any SmithyIdentity.BearerTokenIdentityResolver)? = nil, interceptorProviders: [ClientRuntime.InterceptorProvider]? = nil, httpInterceptorProviders: [ClientRuntime.HttpInterceptorProvider]? = nil) throws {
            self.init(useFIPS, useDualStack, try appID ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.appID(), try awsCredentialIdentityResolver ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.awsCredentialIdentityResolver(awsCredentialIdentityResolver), try awsRetryMode ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.retryMode(), region, signingRegion, try endpointResolver ?? DefaultEndpointResolver(), telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider, try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(), clientLogMode ?? AWSClientConfigDefaultsProvider.clientLogMode(), endpoint, idempotencyTokenGenerator ?? AWSClientConfigDefaultsProvider.idempotencyTokenGenerator(), httpClientEngine ?? AWSClientConfigDefaultsProvider.httpClientEngine(), httpClientConfiguration ?? AWSClientConfigDefaultsProvider.httpClientConfiguration(), authSchemes ?? [AWSSDKHTTPAuth.SigV4AuthScheme()], authSchemeResolver ?? DefaultDirectoryServiceAuthSchemeResolver(), try bearerTokenIdentityResolver ?? AWSSDKIdentity.DefaultBearerTokenIdentityResolverChain(), interceptorProviders ?? [], httpInterceptorProviders ?? [])
        }
...
extension DirectoryClient {
    ...
    public func acceptSharedDirectory(input: AcceptSharedDirectoryInput) async throws -> AcceptSharedDirectoryOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<AcceptSharedDirectoryInput, AcceptSharedDirectoryOutput> = provider.create()
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<AcceptSharedDirectoryInput, AcceptSharedDirectoryOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func addIpRoutes(input: AddIpRoutesInput) async throws -> AddIpRoutesOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<AddIpRoutesInput, AddIpRoutesOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<AddIpRoutesInput, AddIpRoutesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func addRegion(input: AddRegionInput) async throws -> AddRegionOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<AddRegionInput, AddRegionOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<AddRegionInput, AddRegionOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func cancelSchemaExtension(input: CancelSchemaExtensionInput) async throws -> CancelSchemaExtensionOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CancelSchemaExtensionInput, CancelSchemaExtensionOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CancelSchemaExtensionInput, CancelSchemaExtensionOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func connectDirectory(input: ConnectDirectoryInput) async throws -> ConnectDirectoryOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ConnectDirectoryInput, ConnectDirectoryOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ConnectDirectoryInput, ConnectDirectoryOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createComputer(input: CreateComputerInput) async throws -> CreateComputerOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateComputerInput, CreateComputerOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateComputerInput, CreateComputerOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createConditionalForwarder(input: CreateConditionalForwarderInput) async throws -> CreateConditionalForwarderOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateConditionalForwarderInput, CreateConditionalForwarderOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateConditionalForwarderInput, CreateConditionalForwarderOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createLogSubscription(input: CreateLogSubscriptionInput) async throws -> CreateLogSubscriptionOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateLogSubscriptionInput, CreateLogSubscriptionOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateLogSubscriptionInput, CreateLogSubscriptionOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createMicrosoftAD(input: CreateMicrosoftADInput) async throws -> CreateMicrosoftADOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateMicrosoftADInput, CreateMicrosoftADOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateMicrosoftADInput, CreateMicrosoftADOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createTrust(input: CreateTrustInput) async throws -> CreateTrustOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateTrustInput, CreateTrustOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateTrustInput, CreateTrustOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deleteConditionalForwarder(input: DeleteConditionalForwarderInput) async throws -> DeleteConditionalForwarderOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteConditionalForwarderInput, DeleteConditionalForwarderOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteConditionalForwarderInput, DeleteConditionalForwarderOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deleteLogSubscription(input: DeleteLogSubscriptionInput) async throws -> DeleteLogSubscriptionOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteLogSubscriptionInput, DeleteLogSubscriptionOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteLogSubscriptionInput, DeleteLogSubscriptionOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deleteTrust(input: DeleteTrustInput) async throws -> DeleteTrustOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteTrustInput, DeleteTrustOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteTrustInput, DeleteTrustOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deregisterCertificate(input: DeregisterCertificateInput) async throws -> DeregisterCertificateOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeregisterCertificateInput, DeregisterCertificateOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeregisterCertificateInput, DeregisterCertificateOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deregisterEventTopic(input: DeregisterEventTopicInput) async throws -> DeregisterEventTopicOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeregisterEventTopicInput, DeregisterEventTopicOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeregisterEventTopicInput, DeregisterEventTopicOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeClientAuthenticationSettings(input: DescribeClientAuthenticationSettingsInput) async throws -> DescribeClientAuthenticationSettingsOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeClientAuthenticationSettingsInput, DescribeClientAuthenticationSettingsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeClientAuthenticationSettingsInput, DescribeClientAuthenticationSettingsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeConditionalForwarders(input: DescribeConditionalForwardersInput) async throws -> DescribeConditionalForwardersOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeConditionalForwardersInput, DescribeConditionalForwardersOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeConditionalForwardersInput, DescribeConditionalForwardersOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeDirectories(input: DescribeDirectoriesInput) async throws -> DescribeDirectoriesOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeDirectoriesInput, DescribeDirectoriesOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeDirectoriesInput, DescribeDirectoriesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeDomainControllers(input: DescribeDomainControllersInput) async throws -> DescribeDomainControllersOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeDomainControllersInput, DescribeDomainControllersOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeDomainControllersInput, DescribeDomainControllersOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeEventTopics(input: DescribeEventTopicsInput) async throws -> DescribeEventTopicsOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeEventTopicsInput, DescribeEventTopicsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeEventTopicsInput, DescribeEventTopicsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeLDAPSSettings(input: DescribeLDAPSSettingsInput) async throws -> DescribeLDAPSSettingsOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeLDAPSSettingsInput, DescribeLDAPSSettingsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeLDAPSSettingsInput, DescribeLDAPSSettingsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeRegions(input: DescribeRegionsInput) async throws -> DescribeRegionsOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeRegionsInput, DescribeRegionsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeSettings(input: DescribeSettingsInput) async throws -> DescribeSettingsOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeSettingsInput, DescribeSettingsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeSettingsInput, DescribeSettingsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeSharedDirectories(input: DescribeSharedDirectoriesInput) async throws -> DescribeSharedDirectoriesOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeSharedDirectoriesInput, DescribeSharedDirectoriesOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeSharedDirectoriesInput, DescribeSharedDirectoriesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeTrusts(input: DescribeTrustsInput) async throws -> DescribeTrustsOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeTrustsInput, DescribeTrustsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeTrustsInput, DescribeTrustsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func describeUpdateDirectory(input: DescribeUpdateDirectoryInput) async throws -> DescribeUpdateDirectoryOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeUpdateDirectoryInput, DescribeUpdateDirectoryOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeUpdateDirectoryInput, DescribeUpdateDirectoryOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func disableClientAuthentication(input: DisableClientAuthenticationInput) async throws -> DisableClientAuthenticationOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DisableClientAuthenticationInput, DisableClientAuthenticationOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DisableClientAuthenticationInput, DisableClientAuthenticationOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func disableLDAPS(input: DisableLDAPSInput) async throws -> DisableLDAPSOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DisableLDAPSInput, DisableLDAPSOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DisableLDAPSInput, DisableLDAPSOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func disableRadius(input: DisableRadiusInput) async throws -> DisableRadiusOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DisableRadiusInput, DisableRadiusOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DisableRadiusInput, DisableRadiusOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func disableSso(input: DisableSsoInput) async throws -> DisableSsoOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DisableSsoInput, DisableSsoOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DisableSsoInput, DisableSsoOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func enableClientAuthentication(input: EnableClientAuthenticationInput) async throws -> EnableClientAuthenticationOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<EnableClientAuthenticationInput, EnableClientAuthenticationOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<EnableClientAuthenticationInput, EnableClientAuthenticationOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func enableLDAPS(input: EnableLDAPSInput) async throws -> EnableLDAPSOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<EnableLDAPSInput, EnableLDAPSOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<EnableLDAPSInput, EnableLDAPSOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func enableRadius(input: EnableRadiusInput) async throws -> EnableRadiusOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<EnableRadiusInput, EnableRadiusOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<EnableRadiusInput, EnableRadiusOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func enableSso(input: EnableSsoInput) async throws -> EnableSsoOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<EnableSsoInput, EnableSsoOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<EnableSsoInput, EnableSsoOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getDirectoryLimits(input: GetDirectoryLimitsInput) async throws -> GetDirectoryLimitsOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetDirectoryLimitsInput, GetDirectoryLimitsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDirectoryLimitsInput, GetDirectoryLimitsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getSnapshotLimits(input: GetSnapshotLimitsInput) async throws -> GetSnapshotLimitsOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetSnapshotLimitsInput, GetSnapshotLimitsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetSnapshotLimitsInput, GetSnapshotLimitsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func listIpRoutes(input: ListIpRoutesInput) async throws -> ListIpRoutesOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListIpRoutesInput, ListIpRoutesOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListIpRoutesInput, ListIpRoutesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func listLogSubscriptions(input: ListLogSubscriptionsInput) async throws -> ListLogSubscriptionsOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListLogSubscriptionsInput, ListLogSubscriptionsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListLogSubscriptionsInput, ListLogSubscriptionsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func listSchemaExtensions(input: ListSchemaExtensionsInput) async throws -> ListSchemaExtensionsOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListSchemaExtensionsInput, ListSchemaExtensionsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListSchemaExtensionsInput, ListSchemaExtensionsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func registerCertificate(input: RegisterCertificateInput) async throws -> RegisterCertificateOutput {
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RegisterCertificateInput, RegisterCertificateOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func registerEventTopic(input: RegisterEventTopicInput) async throws -> RegisterEventTopicOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<RegisterEventTopicInput, RegisterEventTopicOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RegisterEventTopicInput, RegisterEventTopicOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func rejectSharedDirectory(input: RejectSharedDirectoryInput) async throws -> RejectSharedDirectoryOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<RejectSharedDirectoryInput, RejectSharedDirectoryOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RejectSharedDirectoryInput, RejectSharedDirectoryOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func removeIpRoutes(input: RemoveIpRoutesInput) async throws -> RemoveIpRoutesOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<RemoveIpRoutesInput, RemoveIpRoutesOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RemoveIpRoutesInput, RemoveIpRoutesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func removeRegion(input: RemoveRegionInput) async throws -> RemoveRegionOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<RemoveRegionInput, RemoveRegionOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RemoveRegionInput, RemoveRegionOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func shareDirectory(input: ShareDirectoryInput) async throws -> ShareDirectoryOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ShareDirectoryInput, ShareDirectoryOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ShareDirectoryInput, ShareDirectoryOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func startSchemaExtension(input: StartSchemaExtensionInput) async throws -> StartSchemaExtensionOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<StartSchemaExtensionInput, StartSchemaExtensionOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<StartSchemaExtensionInput, StartSchemaExtensionOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func unshareDirectory(input: UnshareDirectoryInput) async throws -> UnshareDirectoryOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UnshareDirectoryInput, UnshareDirectoryOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UnshareDirectoryInput, UnshareDirectoryOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func updateConditionalForwarder(input: UpdateConditionalForwarderInput) async throws -> UpdateConditionalForwarderOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateConditionalForwarderInput, UpdateConditionalForwarderOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateConditionalForwarderInput, UpdateConditionalForwarderOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func updateDirectorySetup(input: UpdateDirectorySetupInput) async throws -> UpdateDirectorySetupOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateDirectorySetupInput, UpdateDirectorySetupOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateDirectorySetupInput, UpdateDirectorySetupOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func updateNumberOfDomainControllers(input: UpdateNumberOfDomainControllersInput) async throws -> UpdateNumberOfDomainControllersOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateNumberOfDomainControllersInput, UpdateNumberOfDomainControllersOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateNumberOfDomainControllersInput, UpdateNumberOfDomainControllersOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func updateRadius(input: UpdateRadiusInput) async throws -> UpdateRadiusOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateRadiusInput, UpdateRadiusOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateRadiusInput, UpdateRadiusOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func updateTrust(input: UpdateTrustInput) async throws -> UpdateTrustOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateTrustInput, UpdateTrustOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateTrustInput, UpdateTrustOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func verifyTrust(input: VerifyTrustInput) async throws -> VerifyTrustOutput {
        ...
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<VerifyTrustInput, VerifyTrustOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<VerifyTrustInput, VerifyTrustOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
