...
extension DirectoryClientTypes.ConditionalForwarder {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DirectoryClientTypes.ConditionalForwarder {
        ...
        value.dnsIpAddrs = try reader["DnsIpAddrs"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateTrustInput {
    ...
    static func write(value: CreateTrustInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ConditionalForwarderIpAddrs"].writeList(value.conditionalForwarderIpAddrs, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["DirectoryId"].write(value.directoryId)
        try writer["RemoteDomainName"].write(value.remoteDomainName)
...
extension DescribeConditionalForwardersInput {
    ...
    static func write(value: DescribeConditionalForwardersInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DirectoryId"].write(value.directoryId)
        try writer["RemoteDomainNames"].writeList(value.remoteDomainNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeDomainControllersInput {
    ...
    static func write(value: DescribeDomainControllersInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DirectoryId"].write(value.directoryId)
        try writer["DomainControllerIds"].writeList(value.domainControllerIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Limit"].write(value.limit)
        try writer["NextToken"].write(value.nextToken)
    }
}
...
extension DescribeEventTopicsInput {
    ...
    static func write(value: DescribeEventTopicsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DirectoryId"].write(value.directoryId)
        try writer["TopicNames"].writeList(value.topicNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeSharedDirectoriesInput {
    ...
    static func write(value: DescribeSharedDirectoriesInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["SharedDirectoryIds"].writeList(value.sharedDirectoryIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeTrustsInput {
    ...
    static func write(value: DescribeTrustsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Limit"].write(value.limit)
        try writer["NextToken"].write(value.nextToken)
        try writer["TrustIds"].writeList(value.trustIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DirectoryClientTypes.DirectoryConnectSettings {
    ...
    static func write(value: DirectoryClientTypes.DirectoryConnectSettings?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CustomerDnsIps"].writeList(value.customerDnsIps, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DirectoryClientTypes.DirectoryConnectSettingsDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DirectoryClientTypes.DirectoryConnectSettingsDescription {
        ...
        value.connectIps = try reader["ConnectIps"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DirectoryClientTypes.RadiusSettings {
    ...
    static func write(value: DirectoryClientTypes.RadiusSettings?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["RadiusServers"].writeList(value.radiusServers, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DirectoryClientTypes.RadiusSettings {
        ...
        value.radiusServers = try reader["RadiusServers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DirectoryClientTypes.RegionsInfo {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DirectoryClientTypes.RegionsInfo {
        ...
        value.additionalRegions = try reader["AdditionalRegions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension RemoveIpRoutesInput {
    ...
    static func write(value: RemoveIpRoutesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CidrIps"].writeList(value.cidrIps, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["DirectoryId"].write(value.directoryId)
    }
}
...
extension DirectoryClientTypes.SettingEntry {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DirectoryClientTypes.SettingEntry {
        ...
        value.requestDetailedStatus = try reader["RequestDetailedStatus"].readMapIfPresent(valueReadingClosure: DirectoryClientTypes.DirectoryConfigurationStatus.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
