...
extension EFSClientTypes.PosixUser {
    ...
    static func write(value: EFSClientTypes.PosixUser?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["SecondaryGids"].writeList(value.secondaryGids, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EFSClientTypes.PosixUser {
        ...
        value.secondaryGids = try reader["SecondaryGids"].readListIfPresent(memberReadingClosure: Swift.Int.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension EFSClientTypes.Destination {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EFSClientTypes.Destination {
        ...
        value.lastReplicatedTimestamp = try reader["LastReplicatedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension EFSClientTypes.ResourceIdPreference {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EFSClientTypes.ResourceIdPreference {
        ...
        value.resources = try reader["Resources"].readListIfPresent(memberReadingClosure: EFSClientTypes.Resource.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
