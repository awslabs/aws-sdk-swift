...
extension EFSClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> EFSClient.EFSClientConfiguration {
        let clientConfiguration = try await EFSClient.EFSClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> EFSClient {
            let configuration = try await resolve(plugins: self.plugins)
            return EFSClient(config: configuration)
        }
    }
...
extension EFSClient.EFSClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
