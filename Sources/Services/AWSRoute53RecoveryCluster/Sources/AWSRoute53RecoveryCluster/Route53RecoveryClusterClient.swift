...
public final class Route53RecoveryClusterClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "Route53RecoveryClusterClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: Route53RecoveryClusterClient.Route53RecoveryClusterClientConfig
    let serviceName = "Route53 Recovery Cluster"
    let retryStrategy: SmithyRetries.DefaultRetryStrategy

    @available(*, deprecated, message: "Use Route53RecoveryClusterClient.Route53RecoveryClusterClientConfig instead")
    public typealias Config = Route53RecoveryClusterClient.Route53RecoveryClusterClientConfiguration
    public typealias Configuration = Route53RecoveryClusterClient.Route53RecoveryClusterClientConfig

    public required init(config: Route53RecoveryClusterClient.Route53RecoveryClusterClientConfig) {
    ...
    @available(*, deprecated, message: "Use init(config: Route53RecoveryClusterClient.Route53RecoveryClusterClientConfig) instead")
    public convenience init(config: Route53RecoveryClusterClient.Route53RecoveryClusterClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try Route53RecoveryClusterClient.Route53RecoveryClusterClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await Route53RecoveryClusterClient.Route53RecoveryClusterClientConfig()
        self.init(config: config)
    }
}
...
extension Route53RecoveryClusterClient {
    ...
    /// Client configuration for Route53RecoveryClusterClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct Route53RecoveryClusterClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Route53 Recovery Cluster")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: Route53RecoveryClusterClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use Route53RecoveryClusterClientConfig instead. This class will be removed in a future version.")
    public final class Route53RecoveryClusterClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> Route53RecoveryClusterClientConfig {
            return try Route53RecoveryClusterClientConfig(
...
extension Route53RecoveryClusterClient {
    /// Performs the `GetRoutingControlState` operation on the `Route53RecoveryCluster` service.
    ///
    ...
    public func getRoutingControlState(input: GetRoutingControlStateInput) async throws -> GetRoutingControlStateOutput {
        ...
        let operation = Route53RecoveryClusterClient.getRoutingControlStateOperation
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Route53 Recovery Cluster", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetRoutingControlStateOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetRoutingControlStateInput, GetRoutingControlStateOutput>(overrides: ["X-Amz-Target": "ToggleCustomerAPI.GetRoutingControlState"]))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Route53 Recovery Cluster"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetRoutingControlStateInput, GetRoutingControlStateOutput>(serviceID: serviceName, version: Route53RecoveryClusterClient.version, config: config))
    ...
    /// Performs the `ListRoutingControls` operation on the `Route53RecoveryCluster` service.
    ///
    ...
    public func listRoutingControls(input: ListRoutingControlsInput) async throws -> ListRoutingControlsOutput {
        ...
        let operation = Route53RecoveryClusterClient.listRoutingControlsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListRoutingControlsInput, ListRoutingControlsOutput>(overrides: ["X-Amz-Target": "ToggleCustomerAPI.ListRoutingControls"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Route53 Recovery Cluster"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListRoutingControlsInput, ListRoutingControlsOutput>(serviceID: serviceName, version: Route53RecoveryClusterClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Route53RecoveryCluster")
    ...
    /// Performs the `UpdateRoutingControlState` operation on the `Route53RecoveryCluster` service.
    ///
    ...
    public func updateRoutingControlState(input: UpdateRoutingControlStateInput) async throws -> UpdateRoutingControlStateOutput {
        ...
        let operation = Route53RecoveryClusterClient.updateRoutingControlStateOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateRoutingControlStateOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateRoutingControlStateInput, UpdateRoutingControlStateOutput>(overrides: ["X-Amz-Target": "ToggleCustomerAPI.UpdateRoutingControlState"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Route53 Recovery Cluster"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateRoutingControlStateInput, UpdateRoutingControlStateOutput>(serviceID: serviceName, version: Route53RecoveryClusterClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Route53RecoveryCluster")
    ...
    /// Performs the `UpdateRoutingControlStates` operation on the `Route53RecoveryCluster` service.
    ///
    ...
    public func updateRoutingControlStates(input: UpdateRoutingControlStatesInput) async throws -> UpdateRoutingControlStatesOutput {
        ...
        let operation = Route53RecoveryClusterClient.updateRoutingControlStatesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateRoutingControlStatesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateRoutingControlStatesInput, UpdateRoutingControlStatesOutput>(overrides: ["X-Amz-Target": "ToggleCustomerAPI.UpdateRoutingControlStates"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Route53 Recovery Cluster"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateRoutingControlStatesInput, UpdateRoutingControlStatesOutput>(serviceID: serviceName, version: Route53RecoveryClusterClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Route53RecoveryCluster")
