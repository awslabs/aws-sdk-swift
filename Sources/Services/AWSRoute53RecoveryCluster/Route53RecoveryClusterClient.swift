...
extension Route53RecoveryClusterClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> Route53RecoveryClusterClient.Route53RecoveryClusterClientConfiguration {
        let clientConfiguration = try await Route53RecoveryClusterClient.Route53RecoveryClusterClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> Route53RecoveryClusterClient {
            let configuration = try await resolve(plugins: self.plugins)
            return Route53RecoveryClusterClient(config: configuration)
        }
    }
...
extension Route53RecoveryClusterClient.Route53RecoveryClusterClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
