...
public class Route53RecoveryClusterClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await Route53RecoveryClusterClientConfiguration(region: region)
    ...
    public class Route53RecoveryClusterClientConfiguration: Route53RecoveryClusterClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("Route53RecoveryClusterClient")
