...
extension SFNClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SFNClient.SFNClientConfiguration {
        let clientConfiguration = try await SFNClient.SFNClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SFNClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SFNClient(config: configuration)
        }
    }
...
extension SFNClient.SFNClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
