...
extension IvsClientTypes.PlaybackRestrictionPolicy {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> IvsClientTypes.PlaybackRestrictionPolicy {
        ...
        value.arn = try reader["arn"].readIfPresent()
        value.allowedCountries = try reader["allowedCountries"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension IvsClientTypes.RenditionConfiguration {
    ...
    static func write(value: IvsClientTypes.RenditionConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["renditions"].writeList(value.renditions, memberWritingClosure: IvsClientTypes.RenditionConfigurationRendition.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> IvsClientTypes.RenditionConfiguration {
        ...
        value.renditions = try reader["renditions"].readListIfPresent(memberReadingClosure: IvsClientTypes.RenditionConfigurationRendition.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension IvsClientTypes.ThumbnailConfiguration {
    ...
    static func write(value: IvsClientTypes.ThumbnailConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["storage"].writeList(value.storage, memberWritingClosure: IvsClientTypes.ThumbnailConfigurationStorage.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> IvsClientTypes.ThumbnailConfiguration {
        ...
        value.storage = try reader["storage"].readListIfPresent(memberReadingClosure: IvsClientTypes.ThumbnailConfigurationStorage.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
