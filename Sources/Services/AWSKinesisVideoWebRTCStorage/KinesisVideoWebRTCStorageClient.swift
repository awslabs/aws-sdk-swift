...
extension KinesisVideoWebRTCStorageClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> KinesisVideoWebRTCStorageClient.KinesisVideoWebRTCStorageClientConfiguration {
        let clientConfiguration = try await KinesisVideoWebRTCStorageClient.KinesisVideoWebRTCStorageClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> KinesisVideoWebRTCStorageClient {
            let configuration = try await resolve(plugins: self.plugins)
            return KinesisVideoWebRTCStorageClient(config: configuration)
        }
    }
...
extension KinesisVideoWebRTCStorageClient.KinesisVideoWebRTCStorageClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
