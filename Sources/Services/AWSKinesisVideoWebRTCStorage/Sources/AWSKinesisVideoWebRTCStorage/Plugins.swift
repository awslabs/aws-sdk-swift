...
public class KinesisVideoWebRTCStorageClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? KinesisVideoWebRTCStorageClient.KinesisVideoWebRTCStorageClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? KinesisVideoWebRTCStorageClient.KinesisVideoWebRTCStorageClientConfiguration {
            config.authSchemeResolver = DefaultKinesisVideoWebRTCStorageAuthSchemeResolver()
...
public class KinesisVideoWebRTCStorageClientAuthSchemePlugin: ClientRuntime.Plugin {
    ...
    public init(authSchemes: SmithyHTTPAuthAPI.AuthSchemes? = nil, authSchemeResolver: KinesisVideoWebRTCStorageAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentity.AWSCredentialIdentityResolver)? = nil, bearerTokenIdentityResolver: (any SmithyIdentity.BearerTokenIdentityResolver)? = nil) {
