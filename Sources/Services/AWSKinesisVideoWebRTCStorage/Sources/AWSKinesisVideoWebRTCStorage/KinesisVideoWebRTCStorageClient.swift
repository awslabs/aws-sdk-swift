...
extension KinesisVideoWebRTCStorageClient {
    ...
    public func joinStorageSession(input: JoinStorageSessionInput) async throws -> JoinStorageSessionOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<JoinStorageSessionInput, JoinStorageSessionOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
