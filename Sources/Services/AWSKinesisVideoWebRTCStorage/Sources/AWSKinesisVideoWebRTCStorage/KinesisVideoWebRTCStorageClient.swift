...
public final class KinesisVideoWebRTCStorageClient: AWSClientRuntime.AWSServiceClient {
    ...
    public convenience init(config: KinesisVideoWebRTCStorageClient.KinesisVideoWebRTCStorageClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try KinesisVideoWebRTCStorageClient.KinesisVideoWebRTCStorageClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await KinesisVideoWebRTCStorageClient.KinesisVideoWebRTCStorageClientConfig()
        self.init(config: config)
    }
}
...
extension KinesisVideoWebRTCStorageClient {
    ...
    /// Client configuration for KinesisVideoWebRTCStorageClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct KinesisVideoWebRTCStorageClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
    ...
    @available(*, deprecated, message: "Use KinesisVideoWebRTCStorageClientConfig instead. This class will be removed in a future version.")
    public final class KinesisVideoWebRTCStorageClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> KinesisVideoWebRTCStorageClientConfig {
            return try KinesisVideoWebRTCStorageClientConfig(
