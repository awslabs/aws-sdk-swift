...
class EndpointResolverTest: XCTestCase {
    ...
    func testResolve4() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://iam-fips.global.api.aws", headers: headers, properties: properties)
    ...
    func testResolve6() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://iam.global.api.aws", headers: headers, properties: properties)
    ...
    func testResolve8() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://iam-fips.api.amazonwebservices.com.cn", headers: headers, properties: properties)
    ...
    func testResolve9() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://iam-fips.amazonaws.com.cn", headers: headers, properties: properties)
    ...
    func testResolve10() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://iam.global.api.amazonwebservices.com.cn", headers: headers, properties: properties)
    ...
    func testResolve12() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://iam.us-gov.api.aws", headers: headers, properties: properties)
    ...
    func testResolve20() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://iam-fips.cloud.adc-e.uk", headers: headers, properties: properties)
    ...
    func testResolve22() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://iam-fips.csp.hci.ic.gov", headers: headers, properties: properties)
    ...
    func testResolve24() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://iam-fips.amazonaws.eu", headers: headers, properties: properties)
    ...
    func testResolve25() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://iam.eusc-de-east-1.amazonaws.eu", headers: headers, properties: properties)
