...
extension IAMClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> IAMClient.IAMClientConfiguration {
        let clientConfiguration = try await IAMClient.IAMClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> IAMClient {
            let configuration = try await resolve(plugins: self.plugins)
            return IAMClient(config: configuration)
        }
    }
...
extension IAMClient.IAMClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
