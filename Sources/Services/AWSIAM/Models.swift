...
extension CreateOpenIDConnectProviderInput {
    ...
    static func write(value: CreateOpenIDConnectProviderInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["ClientIDList"].writeList(value.clientIDList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Tags"].writeList(value.tags, memberWritingClosure: IAMClientTypes.Tag.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ThumbprintList"].writeList(value.thumbprintList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GetAccountAuthorizationDetailsInput {
    ...
    static func write(value: GetAccountAuthorizationDetailsInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["Filter"].writeList(value.filter, memberWritingClosure: IAMClientTypes.EntityType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GetContextKeysForCustomPolicyInput {
    ...
    static func write(value: GetContextKeysForCustomPolicyInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["PolicyInputList"].writeList(value.policyInputList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension ListPoliciesGrantingServiceAccessInput {
    ...
    static func write(value: ListPoliciesGrantingServiceAccessInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Arn"].write(value.arn)
        try writer["Marker"].write(value.marker)
        try writer["ServiceNamespaces"].writeList(value.serviceNamespaces, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension SimulateCustomPolicyInput {
    ...
    static func write(value: SimulateCustomPolicyInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["ActionNames"].writeList(value.actionNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["Marker"].write(value.marker)
        try writer["MaxItems"].write(value.maxItems)
        try writer["PermissionsBoundaryPolicyInputList"].writeList(value.permissionsBoundaryPolicyInputList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["PolicyInputList"].writeList(value.policyInputList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GetAccountSummaryOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetAccountSummaryOutput {
        ...
        value.summaryMap = try reader["SummaryMap"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension GetContextKeysForCustomPolicyOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetContextKeysForCustomPolicyOutput {
        ...
        value.contextKeyNames = try reader["ContextKeyNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetMFADeviceOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetMFADeviceOutput {
        ...
        value.certifications = try reader["Certifications"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GetOpenIDConnectProviderOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetOpenIDConnectProviderOutput {
        ...
        value.clientIDList = try reader["ClientIDList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.createDate = try reader["CreateDate"].readTimestampIfPresent(format: .dateTime)
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: IAMClientTypes.Tag.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.thumbprintList = try reader["ThumbprintList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ListAccountAliasesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAccountAliasesOutput {
        ...
        value.accountAliases = try reader["AccountAliases"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
...
extension IAMClientTypes.UserDetail {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> IAMClientTypes.UserDetail {
        ...
        value.groupList = try reader["GroupList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension IAMClientTypes.EvaluationResult {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> IAMClientTypes.EvaluationResult {
        ...
        value.missingContextValues = try reader["MissingContextValues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.evalDecisionDetails = try reader["EvalDecisionDetails"].readMapIfPresent(valueReadingClosure: IAMClientTypes.PolicyEvaluationDecisionType.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
