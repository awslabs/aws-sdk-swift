...
extension IAMClientTypes.AccessDetail: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.AccessDetail {
...
extension IAMClientTypes.AccessKey: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.AccessKey {
...
extension IAMClientTypes.AccessKeyLastUsed: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.AccessKeyLastUsed {
...
extension IAMClientTypes.AccessKeyMetadata: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.AccessKeyMetadata {
...
extension AddClientIDToOpenIDConnectProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AddClientIDToOpenIDConnectProviderOutput {
        let reader = responseReader["AddClientIDToOpenIDConnectProviderResult"]
        var value = AddClientIDToOpenIDConnectProviderOutput()
        return value
    }
}
...
extension AddRoleToInstanceProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AddRoleToInstanceProfileOutput {
        let reader = responseReader["AddRoleToInstanceProfileResult"]
        var value = AddRoleToInstanceProfileOutput()
        return value
    }
}
...
extension AddUserToGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AddUserToGroupOutput {
        let reader = responseReader["AddUserToGroupResult"]
        var value = AddUserToGroupOutput()
        return value
    }
}
...
extension AttachGroupPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AttachGroupPolicyOutput {
        let reader = responseReader["AttachGroupPolicyResult"]
        var value = AttachGroupPolicyOutput()
        return value
    }
}
...
extension AttachRolePolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AttachRolePolicyOutput {
        let reader = responseReader["AttachRolePolicyResult"]
        var value = AttachRolePolicyOutput()
        return value
    }
}
...
extension AttachUserPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AttachUserPolicyOutput {
        let reader = responseReader["AttachUserPolicyResult"]
        var value = AttachUserPolicyOutput()
        return value
    }
}
...
extension IAMClientTypes.AttachedPermissionsBoundary: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.AttachedPermissionsBoundary {
...
extension IAMClientTypes.AttachedPolicy: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.AttachedPolicy {
...
extension ChangePasswordOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ChangePasswordOutput {
        let reader = responseReader["ChangePasswordResult"]
        var value = ChangePasswordOutput()
        return value
    }
}
...
extension IAMClientTypes.ContextEntry: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.ContextEntry {
        var value = IAMClientTypes.ContextEntry()
        value.contextKeyName = try reader["ContextKeyName"].readIfPresent()
        value.contextKeyValues = try reader["ContextKeyValues"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateAccessKeyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateAccessKeyOutput {
        let reader = responseReader["CreateAccessKeyResult"]
        var value = CreateAccessKeyOutput()
        value.accessKey = try reader["AccessKey"].readIfPresent(readingClosure: IAMClientTypes.AccessKey.readingClosure(from:))
        return value
    }
}
...
extension CreateAccountAliasOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateAccountAliasOutput {
        let reader = responseReader["CreateAccountAliasResult"]
        var value = CreateAccountAliasOutput()
        return value
    }
}
...
extension CreateGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateGroupOutput {
        let reader = responseReader["CreateGroupResult"]
        var value = CreateGroupOutput()
        value.group = try reader["Group"].readIfPresent(readingClosure: IAMClientTypes.Group.readingClosure(from:))
        return value
    }
}
...
extension CreateInstanceProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateInstanceProfileOutput {
        let reader = responseReader["CreateInstanceProfileResult"]
        var value = CreateInstanceProfileOutput()
        value.instanceProfile = try reader["InstanceProfile"].readIfPresent(readingClosure: IAMClientTypes.InstanceProfile.readingClosure(from:))
        return value
    }
}
...
extension CreateLoginProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateLoginProfileOutput {
        let reader = responseReader["CreateLoginProfileResult"]
        var value = CreateLoginProfileOutput()
        value.loginProfile = try reader["LoginProfile"].readIfPresent(readingClosure: IAMClientTypes.LoginProfile.readingClosure(from:))
        return value
    }
}
...
extension CreateOpenIDConnectProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateOpenIDConnectProviderOutput {
        ...
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: IAMClientTypes.Tag.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CreatePolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreatePolicyOutput {
        let reader = responseReader["CreatePolicyResult"]
        var value = CreatePolicyOutput()
        value.policy = try reader["Policy"].readIfPresent(readingClosure: IAMClientTypes.Policy.readingClosure(from:))
        return value
    }
}
...
extension CreatePolicyVersionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreatePolicyVersionOutput {
        let reader = responseReader["CreatePolicyVersionResult"]
        var value = CreatePolicyVersionOutput()
        value.policyVersion = try reader["PolicyVersion"].readIfPresent(readingClosure: IAMClientTypes.PolicyVersion.readingClosure(from:))
        return value
    }
}
...
extension CreateRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateRoleOutput {
        let reader = responseReader["CreateRoleResult"]
        var value = CreateRoleOutput()
        value.role = try reader["Role"].readIfPresent(readingClosure: IAMClientTypes.Role.readingClosure(from:))
        return value
    }
}
...
extension CreateSAMLProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateSAMLProviderOutput {
...
extension CreateServiceLinkedRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateServiceLinkedRoleOutput {
...
extension CreateServiceSpecificCredentialOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateServiceSpecificCredentialOutput {
        let reader = responseReader["CreateServiceSpecificCredentialResult"]
        var value = CreateServiceSpecificCredentialOutput()
        value.serviceSpecificCredential = try reader["ServiceSpecificCredential"].readIfPresent(readingClosure: IAMClientTypes.ServiceSpecificCredential.readingClosure(from:))
        return value
    }
}
...
extension CreateUserOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateUserOutput {
        ...
        value.user = try reader["User"].readIfPresent(readingClosure: IAMClientTypes.User.readingClosure(from:))
        return value
    }
}
...
extension CreateVirtualMFADeviceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateVirtualMFADeviceOutput {
        let reader = responseReader["CreateVirtualMFADeviceResult"]
        var value = CreateVirtualMFADeviceOutput()
        value.virtualMFADevice = try reader["VirtualMFADevice"].readIfPresent(readingClosure: IAMClientTypes.VirtualMFADevice.readingClosure(from:))
        return value
    }
}
...
extension DeactivateMFADeviceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeactivateMFADeviceOutput {
        let reader = responseReader["DeactivateMFADeviceResult"]
        var value = DeactivateMFADeviceOutput()
        return value
    }
}
...
extension DeleteAccessKeyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteAccessKeyOutput {
        let reader = responseReader["DeleteAccessKeyResult"]
        var value = DeleteAccessKeyOutput()
        return value
    }
}
...
extension DeleteAccountAliasOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteAccountAliasOutput {
        let reader = responseReader["DeleteAccountAliasResult"]
        var value = DeleteAccountAliasOutput()
        return value
    }
}
...
extension DeleteAccountPasswordPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteAccountPasswordPolicyOutput {
        let reader = responseReader["DeleteAccountPasswordPolicyResult"]
        var value = DeleteAccountPasswordPolicyOutput()
        return value
    }
}
...
extension DeleteGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteGroupOutput {
        let reader = responseReader["DeleteGroupResult"]
...
extension DeleteGroupPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteGroupPolicyOutput {
        let reader = responseReader["DeleteGroupPolicyResult"]
        var value = DeleteGroupPolicyOutput()
        return value
    }
}
...
extension DeleteInstanceProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteInstanceProfileOutput {
        let reader = responseReader["DeleteInstanceProfileResult"]
...
extension DeleteLoginProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteLoginProfileOutput {
        let reader = responseReader["DeleteLoginProfileResult"]
        var value = DeleteLoginProfileOutput()
        return value
    }
}
...
extension DeleteOpenIDConnectProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteOpenIDConnectProviderOutput {
        let reader = responseReader["DeleteOpenIDConnectProviderResult"]
        var value = DeleteOpenIDConnectProviderOutput()
        return value
    }
}
...
extension DeletePolicyVersionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeletePolicyVersionOutput {
        let reader = responseReader["DeletePolicyVersionResult"]
        var value = DeletePolicyVersionOutput()
        return value
    }
}
...
extension DeleteRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteRoleOutput {
        let reader = responseReader["DeleteRoleResult"]
        var value = DeleteRoleOutput()
        return value
    }
}
...
extension DeleteRolePermissionsBoundaryOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteRolePermissionsBoundaryOutput {
        let reader = responseReader["DeleteRolePermissionsBoundaryResult"]
        var value = DeleteRolePermissionsBoundaryOutput()
        return value
    }
}
...
extension DeleteRolePolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteRolePolicyOutput {
        let reader = responseReader["DeleteRolePolicyResult"]
        var value = DeleteRolePolicyOutput()
        return value
    }
}
...
extension DeleteSAMLProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteSAMLProviderOutput {
        let reader = responseReader["DeleteSAMLProviderResult"]
        var value = DeleteSAMLProviderOutput()
        return value
    }
}
...
extension DeleteSSHPublicKeyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteSSHPublicKeyOutput {
        let reader = responseReader["DeleteSSHPublicKeyResult"]
        var value = DeleteSSHPublicKeyOutput()
        return value
    }
}
...
extension DeleteServerCertificateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteServerCertificateOutput {
        let reader = responseReader["DeleteServerCertificateResult"]
        var value = DeleteServerCertificateOutput()
        return value
    }
}
...
extension DeleteServiceLinkedRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteServiceLinkedRoleOutput {
...
extension DeleteServiceSpecificCredentialOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteServiceSpecificCredentialOutput {
        let reader = responseReader["DeleteServiceSpecificCredentialResult"]
        var value = DeleteServiceSpecificCredentialOutput()
        return value
    }
}
...
extension DeleteSigningCertificateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteSigningCertificateOutput {
        let reader = responseReader["DeleteSigningCertificateResult"]
        var value = DeleteSigningCertificateOutput()
        return value
    }
}
...
extension DeleteUserPermissionsBoundaryOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteUserPermissionsBoundaryOutput {
        let reader = responseReader["DeleteUserPermissionsBoundaryResult"]
        var value = DeleteUserPermissionsBoundaryOutput()
        return value
    }
}
...
extension DeleteUserPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteUserPolicyOutput {
        let reader = responseReader["DeleteUserPolicyResult"]
        var value = DeleteUserPolicyOutput()
        return value
    }
}
...
extension DeleteVirtualMFADeviceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteVirtualMFADeviceOutput {
        let reader = responseReader["DeleteVirtualMFADeviceResult"]
        var value = DeleteVirtualMFADeviceOutput()
        return value
    }
}
...
extension IAMClientTypes.DeletionTaskFailureReasonType: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.DeletionTaskFailureReasonType {
        var value = IAMClientTypes.DeletionTaskFailureReasonType()
        value.reason = try reader["Reason"].readIfPresent()
        value.roleUsageList = try reader["RoleUsageList"].readListIfPresent(memberReadingClosure: IAMClientTypes.RoleUsageType.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DetachGroupPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DetachGroupPolicyOutput {
        let reader = responseReader["DetachGroupPolicyResult"]
        var value = DetachGroupPolicyOutput()
        return value
    }
}
...
extension DetachRolePolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DetachRolePolicyOutput {
        let reader = responseReader["DetachRolePolicyResult"]
        var value = DetachRolePolicyOutput()
        return value
    }
}
...
extension DetachUserPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DetachUserPolicyOutput {
        let reader = responseReader["DetachUserPolicyResult"]
        var value = DetachUserPolicyOutput()
        return value
    }
}
...
extension EnableMFADeviceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> EnableMFADeviceOutput {
        let reader = responseReader["EnableMFADeviceResult"]
        var value = EnableMFADeviceOutput()
        return value
    }
}
...
extension IAMClientTypes.EntityDetails: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.EntityDetails {
        var value = IAMClientTypes.EntityDetails()
        value.entityInfo = try reader["EntityInfo"].readIfPresent(readingClosure: IAMClientTypes.EntityInfo.readingClosure(from:))
...
extension IAMClientTypes.EntityInfo: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.EntityInfo {
...
extension IAMClientTypes.ErrorDetails: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.ErrorDetails {
...
extension IAMClientTypes.EvaluationResult: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.EvaluationResult {
        ...
        value.matchedStatements = try reader["MatchedStatements"].readListIfPresent(memberReadingClosure: IAMClientTypes.Statement.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.missingContextValues = try reader["MissingContextValues"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.organizationsDecisionDetail = try reader["OrganizationsDecisionDetail"].readIfPresent(readingClosure: IAMClientTypes.OrganizationsDecisionDetail.readingClosure(from:))
        value.permissionsBoundaryDecisionDetail = try reader["PermissionsBoundaryDecisionDetail"].readIfPresent(readingClosure: IAMClientTypes.PermissionsBoundaryDecisionDetail.readingClosure(from:))
        value.evalDecisionDetails = try reader["EvalDecisionDetails"].readMapIfPresent(valueReadingClosure: IAMClientTypes.PolicyEvaluationDecisionType.readingClosure(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.resourceSpecificResults = try reader["ResourceSpecificResults"].readListIfPresent(memberReadingClosure: IAMClientTypes.ResourceSpecificResult.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GenerateCredentialReportOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GenerateCredentialReportOutput {
...
extension GenerateOrganizationsAccessReportOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GenerateOrganizationsAccessReportOutput {
...
extension GenerateServiceLastAccessedDetailsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GenerateServiceLastAccessedDetailsOutput {
...
extension GetAccessKeyLastUsedOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetAccessKeyLastUsedOutput {
        let reader = responseReader["GetAccessKeyLastUsedResult"]
        var value = GetAccessKeyLastUsedOutput()
        value.accessKeyLastUsed = try reader["AccessKeyLastUsed"].readIfPresent(readingClosure: IAMClientTypes.AccessKeyLastUsed.readingClosure(from:))
        value.userName = try reader["UserName"].readIfPresent()
        return value
    }
}
...
extension GetAccountAuthorizationDetailsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetAccountAuthorizationDetailsOutput {
        let reader = responseReader["GetAccountAuthorizationDetailsResult"]
        var value = GetAccountAuthorizationDetailsOutput()
        value.groupDetailList = try reader["GroupDetailList"].readListIfPresent(memberReadingClosure: IAMClientTypes.GroupDetail.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        value.policies = try reader["Policies"].readListIfPresent(memberReadingClosure: IAMClientTypes.ManagedPolicyDetail.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.roleDetailList = try reader["RoleDetailList"].readListIfPresent(memberReadingClosure: IAMClientTypes.RoleDetail.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.userDetailList = try reader["UserDetailList"].readListIfPresent(memberReadingClosure: IAMClientTypes.UserDetail.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetAccountPasswordPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetAccountPasswordPolicyOutput {
        let reader = responseReader["GetAccountPasswordPolicyResult"]
        var value = GetAccountPasswordPolicyOutput()
        value.passwordPolicy = try reader["PasswordPolicy"].readIfPresent(readingClosure: IAMClientTypes.PasswordPolicy.readingClosure(from:))
        return value
    }
}
...
extension GetAccountSummaryOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetAccountSummaryOutput {
        let reader = responseReader["GetAccountSummaryResult"]
        var value = GetAccountSummaryOutput()
        value.summaryMap = try reader["SummaryMap"].readMapIfPresent(valueReadingClosure: Swift.Int.readingClosure(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension GetContextKeysForCustomPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetContextKeysForCustomPolicyOutput {
        let reader = responseReader["GetContextKeysForCustomPolicyResult"]
        var value = GetContextKeysForCustomPolicyOutput()
        value.contextKeyNames = try reader["ContextKeyNames"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetContextKeysForPrincipalPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetContextKeysForPrincipalPolicyOutput {
...
extension GetCredentialReportOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetCredentialReportOutput {
...
extension GetGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetGroupOutput {
        let reader = responseReader["GetGroupResult"]
        var value = GetGroupOutput()
        value.group = try reader["Group"].readIfPresent(readingClosure: IAMClientTypes.Group.readingClosure(from:))
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        value.users = try reader["Users"].readListIfPresent(memberReadingClosure: IAMClientTypes.User.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetGroupPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetGroupPolicyOutput {
...
extension GetInstanceProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetInstanceProfileOutput {
...
extension GetLoginProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetLoginProfileOutput {
...
extension GetMFADeviceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetMFADeviceOutput {
        let reader = responseReader["GetMFADeviceResult"]
        var value = GetMFADeviceOutput()
        value.certifications = try reader["Certifications"].readMapIfPresent(valueReadingClosure: Swift.String.readingClosure(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GetOpenIDConnectProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetOpenIDConnectProviderOutput {
        let reader = responseReader["GetOpenIDConnectProviderResult"]
        var value = GetOpenIDConnectProviderOutput()
        value.clientIDList = try reader["ClientIDList"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.createDate = try reader["CreateDate"].readTimestampIfPresent(format: .dateTime)
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: IAMClientTypes.Tag.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.thumbprintList = try reader["ThumbprintList"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension GetOrganizationsAccessReportOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetOrganizationsAccessReportOutput {
        let reader = responseReader["GetOrganizationsAccessReportResult"]
        var value = GetOrganizationsAccessReportOutput()
        value.accessDetails = try reader["AccessDetails"].readListIfPresent(memberReadingClosure: IAMClientTypes.AccessDetail.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.errorDetails = try reader["ErrorDetails"].readIfPresent(readingClosure: IAMClientTypes.ErrorDetails.readingClosure(from:))
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
...
extension GetPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetPolicyOutput {
...
extension GetPolicyVersionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetPolicyVersionOutput {
...
extension GetRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetRoleOutput {
...
extension GetRolePolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetRolePolicyOutput {
...
extension GetSAMLProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetSAMLProviderOutput {
...
extension GetSSHPublicKeyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetSSHPublicKeyOutput {
        let reader = responseReader["GetSSHPublicKeyResult"]
        var value = GetSSHPublicKeyOutput()
        value.sshPublicKey = try reader["SSHPublicKey"].readIfPresent(readingClosure: IAMClientTypes.SSHPublicKey.readingClosure(from:))
        return value
    }
}
...
extension GetServerCertificateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetServerCertificateOutput {
        let reader = responseReader["GetServerCertificateResult"]
        var value = GetServerCertificateOutput()
        value.serverCertificate = try reader["ServerCertificate"].readIfPresent(readingClosure: IAMClientTypes.ServerCertificate.readingClosure(from:))
        return value
    }
}
...
extension GetServiceLastAccessedDetailsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetServiceLastAccessedDetailsOutput {
        let reader = responseReader["GetServiceLastAccessedDetailsResult"]
        var value = GetServiceLastAccessedDetailsOutput()
        value.error = try reader["Error"].readIfPresent(readingClosure: IAMClientTypes.ErrorDetails.readingClosure(from:))
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.jobCompletionDate = try reader["JobCompletionDate"].readTimestampIfPresent(format: .dateTime)
        value.jobCreationDate = try reader["JobCreationDate"].readTimestampIfPresent(format: .dateTime)
        value.jobStatus = try reader["JobStatus"].readIfPresent()
        ...
        value.marker = try reader["Marker"].readIfPresent()
        value.servicesLastAccessed = try reader["ServicesLastAccessed"].readListIfPresent(memberReadingClosure: IAMClientTypes.ServiceLastAccessed.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetServiceLastAccessedDetailsWithEntitiesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetServiceLastAccessedDetailsWithEntitiesOutput {
        ...
        value.entityDetailsList = try reader["EntityDetailsList"].readListIfPresent(memberReadingClosure: IAMClientTypes.EntityDetails.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.error = try reader["Error"].readIfPresent(readingClosure: IAMClientTypes.ErrorDetails.readingClosure(from:))
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.jobCompletionDate = try reader["JobCompletionDate"].readTimestampIfPresent(format: .dateTime)
        value.jobCreationDate = try reader["JobCreationDate"].readTimestampIfPresent(format: .dateTime)
...
extension GetServiceLinkedRoleDeletionStatusOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetServiceLinkedRoleDeletionStatusOutput {
        let reader = responseReader["GetServiceLinkedRoleDeletionStatusResult"]
        var value = GetServiceLinkedRoleDeletionStatusOutput()
        value.reason = try reader["Reason"].readIfPresent(readingClosure: IAMClientTypes.DeletionTaskFailureReasonType.readingClosure(from:))
        value.status = try reader["Status"].readIfPresent()
        return value
    }
}
...
extension GetUserOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetUserOutput {
...
extension GetUserPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetUserPolicyOutput {
...
extension IAMClientTypes.Group: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.Group {
...
extension IAMClientTypes.GroupDetail: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.GroupDetail {
        ...
        value.arn = try reader["Arn"].readIfPresent()
        value.createDate = try reader["CreateDate"].readTimestampIfPresent(format: .dateTime)
        value.groupPolicyList = try reader["GroupPolicyList"].readListIfPresent(memberReadingClosure: IAMClientTypes.PolicyDetail.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.attachedManagedPolicies = try reader["AttachedManagedPolicies"].readListIfPresent(memberReadingClosure: IAMClientTypes.AttachedPolicy.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension IAMClientTypes.InstanceProfile: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.InstanceProfile {
        ...
        value.arn = try reader["Arn"].readIfPresent()
        value.createDate = try reader["CreateDate"].readTimestampIfPresent(format: .dateTime)
        value.roles = try reader["Roles"].readListIfPresent(memberReadingClosure: IAMClientTypes.Role.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: IAMClientTypes.Tag.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListAccessKeysOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListAccessKeysOutput {
        let reader = responseReader["ListAccessKeysResult"]
        var value = ListAccessKeysOutput()
        value.accessKeyMetadata = try reader["AccessKeyMetadata"].readListIfPresent(memberReadingClosure: IAMClientTypes.AccessKeyMetadata.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
...
extension ListAccountAliasesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListAccountAliasesOutput {
        let reader = responseReader["ListAccountAliasesResult"]
        var value = ListAccountAliasesOutput()
        value.accountAliases = try reader["AccountAliases"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
...
extension ListAttachedGroupPoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListAttachedGroupPoliciesOutput {
        let reader = responseReader["ListAttachedGroupPoliciesResult"]
        var value = ListAttachedGroupPoliciesOutput()
        value.attachedPolicies = try reader["AttachedPolicies"].readListIfPresent(memberReadingClosure: IAMClientTypes.AttachedPolicy.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
...
extension ListAttachedRolePoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListAttachedRolePoliciesOutput {
...
extension ListAttachedUserPoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListAttachedUserPoliciesOutput {
...
extension ListEntitiesForPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListEntitiesForPolicyOutput {
        let reader = responseReader["ListEntitiesForPolicyResult"]
        var value = ListEntitiesForPolicyOutput()
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        value.policyGroups = try reader["PolicyGroups"].readListIfPresent(memberReadingClosure: IAMClientTypes.PolicyGroup.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.policyRoles = try reader["PolicyRoles"].readListIfPresent(memberReadingClosure: IAMClientTypes.PolicyRole.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.policyUsers = try reader["PolicyUsers"].readListIfPresent(memberReadingClosure: IAMClientTypes.PolicyUser.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListGroupPoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListGroupPoliciesOutput {
...
extension ListGroupsForUserOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListGroupsForUserOutput {
        let reader = responseReader["ListGroupsForUserResult"]
        var value = ListGroupsForUserOutput()
        value.groups = try reader["Groups"].readListIfPresent(memberReadingClosure: IAMClientTypes.Group.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
...
extension ListGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListGroupsOutput {
...
extension ListInstanceProfileTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListInstanceProfileTagsOutput {
...
extension ListInstanceProfilesForRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListInstanceProfilesForRoleOutput {
        let reader = responseReader["ListInstanceProfilesForRoleResult"]
        var value = ListInstanceProfilesForRoleOutput()
        value.instanceProfiles = try reader["InstanceProfiles"].readListIfPresent(memberReadingClosure: IAMClientTypes.InstanceProfile.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
...
extension ListInstanceProfilesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListInstanceProfilesOutput {
...
extension ListMFADeviceTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListMFADeviceTagsOutput {
...
extension ListMFADevicesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListMFADevicesOutput {
        let reader = responseReader["ListMFADevicesResult"]
        var value = ListMFADevicesOutput()
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.mfaDevices = try reader["MFADevices"].readListIfPresent(memberReadingClosure: IAMClientTypes.MFADevice.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension ListOpenIDConnectProviderTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListOpenIDConnectProviderTagsOutput {
...
extension ListOpenIDConnectProvidersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListOpenIDConnectProvidersOutput {
        let reader = responseReader["ListOpenIDConnectProvidersResult"]
        var value = ListOpenIDConnectProvidersOutput()
        value.openIDConnectProviderList = try reader["OpenIDConnectProviderList"].readListIfPresent(memberReadingClosure: IAMClientTypes.OpenIDConnectProviderListEntry.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension IAMClientTypes.ListPoliciesGrantingServiceAccessEntry: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.ListPoliciesGrantingServiceAccessEntry {
        var value = IAMClientTypes.ListPoliciesGrantingServiceAccessEntry()
        value.serviceNamespace = try reader["ServiceNamespace"].readIfPresent()
        value.policies = try reader["Policies"].readListIfPresent(memberReadingClosure: IAMClientTypes.PolicyGrantingServiceAccess.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListPoliciesGrantingServiceAccessOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListPoliciesGrantingServiceAccessOutput {
        let reader = responseReader["ListPoliciesGrantingServiceAccessResult"]
        var value = ListPoliciesGrantingServiceAccessOutput()
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        value.policiesGrantingServiceAccess = try reader["PoliciesGrantingServiceAccess"].readListIfPresent(memberReadingClosure: IAMClientTypes.ListPoliciesGrantingServiceAccessEntry.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListPoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListPoliciesOutput {
        let reader = responseReader["ListPoliciesResult"]
        var value = ListPoliciesOutput()
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        value.policies = try reader["Policies"].readListIfPresent(memberReadingClosure: IAMClientTypes.Policy.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListPolicyTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListPolicyTagsOutput {
...
extension ListPolicyVersionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListPolicyVersionsOutput {
        let reader = responseReader["ListPolicyVersionsResult"]
        var value = ListPolicyVersionsOutput()
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        value.versions = try reader["Versions"].readListIfPresent(memberReadingClosure: IAMClientTypes.PolicyVersion.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListRolePoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListRolePoliciesOutput {
...
extension ListRoleTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListRoleTagsOutput {
...
extension ListRolesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListRolesOutput {
...
extension ListSAMLProviderTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListSAMLProviderTagsOutput {
...
extension ListSAMLProvidersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListSAMLProvidersOutput {
        let reader = responseReader["ListSAMLProvidersResult"]
        var value = ListSAMLProvidersOutput()
        value.samlProviderList = try reader["SAMLProviderList"].readListIfPresent(memberReadingClosure: IAMClientTypes.SAMLProviderListEntry.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListSSHPublicKeysOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListSSHPublicKeysOutput {
        let reader = responseReader["ListSSHPublicKeysResult"]
        var value = ListSSHPublicKeysOutput()
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        value.sshPublicKeys = try reader["SSHPublicKeys"].readListIfPresent(memberReadingClosure: IAMClientTypes.SSHPublicKeyMetadata.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListServerCertificateTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListServerCertificateTagsOutput {
...
extension ListServerCertificatesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListServerCertificatesOutput {
        let reader = responseReader["ListServerCertificatesResult"]
        var value = ListServerCertificatesOutput()
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        value.serverCertificateMetadataList = try reader["ServerCertificateMetadataList"].readListIfPresent(memberReadingClosure: IAMClientTypes.ServerCertificateMetadata.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListServiceSpecificCredentialsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListServiceSpecificCredentialsOutput {
        let reader = responseReader["ListServiceSpecificCredentialsResult"]
        var value = ListServiceSpecificCredentialsOutput()
        value.serviceSpecificCredentials = try reader["ServiceSpecificCredentials"].readListIfPresent(memberReadingClosure: IAMClientTypes.ServiceSpecificCredentialMetadata.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListSigningCertificatesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListSigningCertificatesOutput {
        let reader = responseReader["ListSigningCertificatesResult"]
        var value = ListSigningCertificatesOutput()
        value.certificates = try reader["Certificates"].readListIfPresent(memberReadingClosure: IAMClientTypes.SigningCertificate.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
...
extension ListUserPoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListUserPoliciesOutput {
...
extension ListUserTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListUserTagsOutput {
...
extension ListUsersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListUsersOutput {
...
extension ListVirtualMFADevicesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListVirtualMFADevicesOutput {
        let reader = responseReader["ListVirtualMFADevicesResult"]
        var value = ListVirtualMFADevicesOutput()
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        value.virtualMFADevices = try reader["VirtualMFADevices"].readListIfPresent(memberReadingClosure: IAMClientTypes.VirtualMFADevice.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension IAMClientTypes.LoginProfile: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.LoginProfile {
...
extension IAMClientTypes.MFADevice: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.MFADevice {
...
extension IAMClientTypes.ManagedPolicyDetail: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.ManagedPolicyDetail {
        ...
        value.policyVersionList = try reader["PolicyVersionList"].readListIfPresent(memberReadingClosure: IAMClientTypes.PolicyVersion.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension IAMClientTypes.OpenIDConnectProviderListEntry: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.OpenIDConnectProviderListEntry {
...
extension IAMClientTypes.OrganizationsDecisionDetail: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.OrganizationsDecisionDetail {
...
extension IAMClientTypes.PasswordPolicy: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.PasswordPolicy {
...
extension IAMClientTypes.PermissionsBoundaryDecisionDetail: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.PermissionsBoundaryDecisionDetail {
...
extension IAMClientTypes.Policy: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.Policy {
...
extension IAMClientTypes.PolicyDetail: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.PolicyDetail {
...
extension IAMClientTypes.PolicyGrantingServiceAccess: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.PolicyGrantingServiceAccess {
...
extension IAMClientTypes.PolicyGroup: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.PolicyGroup {
...
extension IAMClientTypes.PolicyRole: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.PolicyRole {
...
extension IAMClientTypes.PolicyUser: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.PolicyUser {
...
extension IAMClientTypes.PolicyVersion: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.PolicyVersion {
...
extension IAMClientTypes.Position: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.Position {
...
extension PutGroupPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutGroupPolicyOutput {
        let reader = responseReader["PutGroupPolicyResult"]
        var value = PutGroupPolicyOutput()
        return value
    }
}
...
extension PutRolePermissionsBoundaryOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutRolePermissionsBoundaryOutput {
        let reader = responseReader["PutRolePermissionsBoundaryResult"]
        var value = PutRolePermissionsBoundaryOutput()
        return value
    }
}
...
extension PutRolePolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutRolePolicyOutput {
        let reader = responseReader["PutRolePolicyResult"]
        var value = PutRolePolicyOutput()
        return value
    }
}
...
extension PutUserPermissionsBoundaryOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutUserPermissionsBoundaryOutput {
        let reader = responseReader["PutUserPermissionsBoundaryResult"]
        var value = PutUserPermissionsBoundaryOutput()
        return value
    }
}
...
extension PutUserPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutUserPolicyOutput {
        let reader = responseReader["PutUserPolicyResult"]
        var value = PutUserPolicyOutput()
        return value
    }
}
...
extension RemoveClientIDFromOpenIDConnectProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RemoveClientIDFromOpenIDConnectProviderOutput {
        let reader = responseReader["RemoveClientIDFromOpenIDConnectProviderResult"]
        var value = RemoveClientIDFromOpenIDConnectProviderOutput()
        return value
    }
}
...
extension RemoveRoleFromInstanceProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RemoveRoleFromInstanceProfileOutput {
        let reader = responseReader["RemoveRoleFromInstanceProfileResult"]
        var value = RemoveRoleFromInstanceProfileOutput()
        return value
    }
}
...
extension RemoveUserFromGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RemoveUserFromGroupOutput {
        let reader = responseReader["RemoveUserFromGroupResult"]
        var value = RemoveUserFromGroupOutput()
        return value
    }
}
...
extension ResetServiceSpecificCredentialOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ResetServiceSpecificCredentialOutput {
...
extension IAMClientTypes.ResourceSpecificResult: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.ResourceSpecificResult {
...
extension ResyncMFADeviceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ResyncMFADeviceOutput {
        let reader = responseReader["ResyncMFADeviceResult"]
        var value = ResyncMFADeviceOutput()
        return value
    }
}
...
extension IAMClientTypes.Role: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.Role {
        ...
        value.permissionsBoundary = try reader["PermissionsBoundary"].readIfPresent(readingClosure: IAMClientTypes.AttachedPermissionsBoundary.readingClosure(from:))
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: IAMClientTypes.Tag.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.roleLastUsed = try reader["RoleLastUsed"].readIfPresent(readingClosure: IAMClientTypes.RoleLastUsed.readingClosure(from:))
        return value
    }
}
...
extension IAMClientTypes.RoleDetail: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.RoleDetail {
        ...
        value.createDate = try reader["CreateDate"].readTimestampIfPresent(format: .dateTime)
        value.assumeRolePolicyDocument = try reader["AssumeRolePolicyDocument"].readIfPresent()
        value.instanceProfileList = try reader["InstanceProfileList"].readListIfPresent(memberReadingClosure: IAMClientTypes.InstanceProfile.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.rolePolicyList = try reader["RolePolicyList"].readListIfPresent(memberReadingClosure: IAMClientTypes.PolicyDetail.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.attachedManagedPolicies = try reader["AttachedManagedPolicies"].readListIfPresent(memberReadingClosure: IAMClientTypes.AttachedPolicy.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.permissionsBoundary = try reader["PermissionsBoundary"].readIfPresent(readingClosure: IAMClientTypes.AttachedPermissionsBoundary.readingClosure(from:))
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: IAMClientTypes.Tag.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.roleLastUsed = try reader["RoleLastUsed"].readIfPresent(readingClosure: IAMClientTypes.RoleLastUsed.readingClosure(from:))
...
extension IAMClientTypes.RoleLastUsed: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.RoleLastUsed {
...
extension IAMClientTypes.RoleUsageType: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.RoleUsageType {
        var value = IAMClientTypes.RoleUsageType()
        value.region = try reader["Region"].readIfPresent()
        value.resources = try reader["Resources"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension IAMClientTypes.SAMLProviderListEntry: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.SAMLProviderListEntry {
...
extension IAMClientTypes.SSHPublicKey: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.SSHPublicKey {
...
extension IAMClientTypes.SSHPublicKeyMetadata: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.SSHPublicKeyMetadata {
...
extension IAMClientTypes.ServerCertificate: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.ServerCertificate {
        var value = IAMClientTypes.ServerCertificate()
        value.serverCertificateMetadata = try reader["ServerCertificateMetadata"].readIfPresent(readingClosure: IAMClientTypes.ServerCertificateMetadata.readingClosure(from:))
...
extension IAMClientTypes.ServerCertificateMetadata: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.ServerCertificateMetadata {
...
extension IAMClientTypes.ServiceLastAccessed: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.ServiceLastAccessed {
        ...
        value.totalAuthenticatedEntities = try reader["TotalAuthenticatedEntities"].readIfPresent()
        value.trackedActionsLastAccessed = try reader["TrackedActionsLastAccessed"].readListIfPresent(memberReadingClosure: IAMClientTypes.TrackedActionLastAccessed.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension IAMClientTypes.ServiceSpecificCredential: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.ServiceSpecificCredential {
...
extension IAMClientTypes.ServiceSpecificCredentialMetadata: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.ServiceSpecificCredentialMetadata {
...
extension SetDefaultPolicyVersionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetDefaultPolicyVersionOutput {
        let reader = responseReader["SetDefaultPolicyVersionResult"]
        var value = SetDefaultPolicyVersionOutput()
        return value
    }
}
...
extension SetSecurityTokenServicePreferencesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetSecurityTokenServicePreferencesOutput {
        let reader = responseReader["SetSecurityTokenServicePreferencesResult"]
        var value = SetSecurityTokenServicePreferencesOutput()
        return value
    }
}
...
extension IAMClientTypes.SigningCertificate: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.SigningCertificate {
...
extension SimulateCustomPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SimulateCustomPolicyOutput {
        let reader = responseReader["SimulateCustomPolicyResult"]
        var value = SimulateCustomPolicyOutput()
        value.evaluationResults = try reader["EvaluationResults"].readListIfPresent(memberReadingClosure: IAMClientTypes.EvaluationResult.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.isTruncated = try reader["IsTruncated"].readIfPresent() ?? false
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
...
extension SimulatePrincipalPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SimulatePrincipalPolicyOutput {
...
extension IAMClientTypes.Statement: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.Statement {
        ...
        value.startPosition = try reader["StartPosition"].readIfPresent(readingClosure: IAMClientTypes.Position.readingClosure(from:))
        value.endPosition = try reader["EndPosition"].readIfPresent(readingClosure: IAMClientTypes.Position.readingClosure(from:))
        return value
    }
}
...
extension IAMClientTypes.Tag: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.Tag {
...
extension TagInstanceProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TagInstanceProfileOutput {
        let reader = responseReader["TagInstanceProfileResult"]
        var value = TagInstanceProfileOutput()
        return value
    }
}
...
extension TagMFADeviceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TagMFADeviceOutput {
        let reader = responseReader["TagMFADeviceResult"]
        var value = TagMFADeviceOutput()
        return value
    }
}
...
extension TagOpenIDConnectProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TagOpenIDConnectProviderOutput {
        let reader = responseReader["TagOpenIDConnectProviderResult"]
        var value = TagOpenIDConnectProviderOutput()
        return value
    }
}
...
extension TagPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TagPolicyOutput {
        let reader = responseReader["TagPolicyResult"]
        var value = TagPolicyOutput()
        return value
    }
}
...
extension TagRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TagRoleOutput {
        let reader = responseReader["TagRoleResult"]
        var value = TagRoleOutput()
        return value
    }
}
...
extension TagSAMLProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TagSAMLProviderOutput {
        let reader = responseReader["TagSAMLProviderResult"]
        var value = TagSAMLProviderOutput()
        return value
    }
}
...
extension TagServerCertificateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TagServerCertificateOutput {
        let reader = responseReader["TagServerCertificateResult"]
        var value = TagServerCertificateOutput()
        return value
    }
}
...
extension TagUserOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TagUserOutput {
        let reader = responseReader["TagUserResult"]
        var value = TagUserOutput()
        return value
    }
}
...
extension IAMClientTypes.TrackedActionLastAccessed: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.TrackedActionLastAccessed {
...
extension UntagInstanceProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UntagInstanceProfileOutput {
        let reader = responseReader["UntagInstanceProfileResult"]
        var value = UntagInstanceProfileOutput()
        return value
    }
}
...
extension UntagMFADeviceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UntagMFADeviceOutput {
        let reader = responseReader["UntagMFADeviceResult"]
        var value = UntagMFADeviceOutput()
        return value
    }
}
...
extension UntagOpenIDConnectProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UntagOpenIDConnectProviderOutput {
        let reader = responseReader["UntagOpenIDConnectProviderResult"]
        var value = UntagOpenIDConnectProviderOutput()
        return value
    }
}
...
extension UntagPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UntagPolicyOutput {
        let reader = responseReader["UntagPolicyResult"]
        var value = UntagPolicyOutput()
        return value
    }
}
...
extension UntagRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UntagRoleOutput {
        let reader = responseReader["UntagRoleResult"]
        var value = UntagRoleOutput()
        return value
    }
}
...
extension UntagSAMLProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UntagSAMLProviderOutput {
        let reader = responseReader["UntagSAMLProviderResult"]
        var value = UntagSAMLProviderOutput()
        return value
    }
}
...
extension UntagServerCertificateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UntagServerCertificateOutput {
        let reader = responseReader["UntagServerCertificateResult"]
        var value = UntagServerCertificateOutput()
        return value
    }
}
...
extension UntagUserOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UntagUserOutput {
        let reader = responseReader["UntagUserResult"]
        var value = UntagUserOutput()
        return value
    }
}
...
extension UpdateAccessKeyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateAccessKeyOutput {
        let reader = responseReader["UpdateAccessKeyResult"]
        var value = UpdateAccessKeyOutput()
        return value
    }
}
...
extension UpdateAccountPasswordPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateAccountPasswordPolicyOutput {
        let reader = responseReader["UpdateAccountPasswordPolicyResult"]
        var value = UpdateAccountPasswordPolicyOutput()
        return value
    }
}
...
extension UpdateAssumeRolePolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateAssumeRolePolicyOutput {
        let reader = responseReader["UpdateAssumeRolePolicyResult"]
        var value = UpdateAssumeRolePolicyOutput()
        return value
    }
}
...
extension UpdateGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateGroupOutput {
        let reader = responseReader["UpdateGroupResult"]
...
extension UpdateLoginProfileOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateLoginProfileOutput {
        let reader = responseReader["UpdateLoginProfileResult"]
        var value = UpdateLoginProfileOutput()
        return value
    }
}
...
extension UpdateOpenIDConnectProviderThumbprintOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateOpenIDConnectProviderThumbprintOutput {
        let reader = responseReader["UpdateOpenIDConnectProviderThumbprintResult"]
        var value = UpdateOpenIDConnectProviderThumbprintOutput()
        return value
    }
}
...
extension UpdateRoleDescriptionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateRoleDescriptionOutput {
...
extension UpdateRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateRoleOutput {
        let reader = responseReader["UpdateRoleResult"]
        var value = UpdateRoleOutput()
        return value
    }
}
...
extension UpdateSAMLProviderOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateSAMLProviderOutput {
...
extension UpdateSSHPublicKeyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateSSHPublicKeyOutput {
        let reader = responseReader["UpdateSSHPublicKeyResult"]
        var value = UpdateSSHPublicKeyOutput()
        return value
    }
}
...
extension UpdateServerCertificateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateServerCertificateOutput {
        let reader = responseReader["UpdateServerCertificateResult"]
        var value = UpdateServerCertificateOutput()
        return value
    }
}
...
extension UpdateServiceSpecificCredentialOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateServiceSpecificCredentialOutput {
        let reader = responseReader["UpdateServiceSpecificCredentialResult"]
        var value = UpdateServiceSpecificCredentialOutput()
        return value
    }
}
...
extension UpdateSigningCertificateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateSigningCertificateOutput {
        let reader = responseReader["UpdateSigningCertificateResult"]
        var value = UpdateSigningCertificateOutput()
        return value
    }
}
...
extension UpdateUserOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateUserOutput {
        let reader = responseReader["UpdateUserResult"]
...
extension UploadSSHPublicKeyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UploadSSHPublicKeyOutput {
...
extension UploadServerCertificateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UploadServerCertificateOutput {
...
extension UploadSigningCertificateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UploadSigningCertificateOutput {
        let reader = responseReader["UploadSigningCertificateResult"]
        var value = UploadSigningCertificateOutput()
        value.certificate = try reader["Certificate"].readIfPresent(readingClosure: IAMClientTypes.SigningCertificate.readingClosure(from:))
        return value
    }
}
...
extension IAMClientTypes.User: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.User {
...
extension IAMClientTypes.UserDetail: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.UserDetail {
        ...
        value.arn = try reader["Arn"].readIfPresent()
        value.createDate = try reader["CreateDate"].readTimestampIfPresent(format: .dateTime)
        value.userPolicyList = try reader["UserPolicyList"].readListIfPresent(memberReadingClosure: IAMClientTypes.PolicyDetail.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.groupList = try reader["GroupList"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.attachedManagedPolicies = try reader["AttachedManagedPolicies"].readListIfPresent(memberReadingClosure: IAMClientTypes.AttachedPolicy.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.permissionsBoundary = try reader["PermissionsBoundary"].readIfPresent(readingClosure: IAMClientTypes.AttachedPermissionsBoundary.readingClosure(from:))
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: IAMClientTypes.Tag.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
...
extension IAMClientTypes.VirtualMFADevice: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> IAMClientTypes.VirtualMFADevice {
