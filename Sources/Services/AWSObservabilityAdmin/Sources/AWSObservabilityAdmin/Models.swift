...
public struct DeleteDatasetIntegrationOutput: Swift.Sendable {
...
extension ObservabilityAdminClientTypes {
    ...
    public struct SourceContextGraphConfiguration: Swift.Sendable {
...
extension ObservabilityAdminClientTypes {
    ...
    public struct CentralizationRuleSource: Swift.Sendable {
        ...
        /// Configuration that enables centralization of the context graph for the selected sources. Including this configuration in a rule's source opts the rule into centralizing the context graph for the selected sources.
        public var sourceContextGraphConfiguration: ObservabilityAdminClientTypes.SourceContextGraphConfiguration?
        ...
        public init(
            ...
            sourceContextGraphConfiguration: ObservabilityAdminClientTypes.SourceContextGraphConfiguration? = nil,
            ...
            self.scope = scope
            self.sourceContextGraphConfiguration = sourceContextGraphConfiguration
...
extension ObservabilityAdminClientTypes {
    ...
    /// The status of context graph centralization for a centralization rule. This status is independent of the overall RuleHealth for log delivery. Returns Provisioning while the context graph is being set up, Healthy once it is active, or Unhealthy if provisioning failed.
    public enum ContextGraphStatus: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case healthy
        case provisioning
        case unhealthy
        case sdkUnknown(Swift.String)

        public static var allCases: [ContextGraphStatus] {
            return [
                .healthy,
                .provisioning,
                .unhealthy
...
extension ObservabilityAdminClientTypes {
    ...
    public struct CentralizationRuleSummary: Swift.Sendable {
        ...
        public var contextGraphStatus: ObservabilityAdminClientTypes.ContextGraphStatus?
        ...
        public init(
            contextGraphStatus: ObservabilityAdminClientTypes.ContextGraphStatus? = nil,
            ...
            self.contextGraphStatus = contextGraphStatus
...
public struct CreateDatasetIntegrationInput: Swift.Sendable {
...
public struct CreateDatasetIntegrationOutput: Swift.Sendable {
...
extension ObservabilityAdminClientTypes {
    ...
    public struct DatasetIntegrationSummary: Swift.Sendable {
...
public struct DeleteDatasetIntegrationInput: Swift.Sendable {
...
public struct GetDatasetIntegrationInput: Swift.Sendable {
...
public struct GetDatasetIntegrationOutput: Swift.Sendable {
    /// The Amazon Resource Name (ARN) of the dataset integration.
    public var arn: Swift.String?
    /// The timestamp when the dataset integration was created.
    public var createdAt: Foundation.Date?
...
public struct ListDatasetIntegrationsInput: Swift.Sendable {
...
public struct ListDatasetIntegrationsOutput: Swift.Sendable {
    /// The dataset integrations in your account.
    /// This member is required.
    public var datasetIntegrationSummaries: [ObservabilityAdminClientTypes.DatasetIntegrationSummary]?
    /// A token to resume pagination of results.
    public var nextToken: Swift.String?

    public init(
        datasetIntegrationSummaries: [ObservabilityAdminClientTypes.DatasetIntegrationSummary]? = nil,
        nextToken: Swift.String? = nil
    ) {
        self.datasetIntegrationSummaries = datasetIntegrationSummaries
        self.nextToken = nextToken
    }
}
...
public struct UpdateDatasetIntegrationInput: Swift.Sendable {
...
public struct UpdateDatasetIntegrationOutput: Swift.Sendable {
...
extension CreateDatasetIntegrationInput {

    static func urlPathProvider(_ value: CreateDatasetIntegrationInput) -> Swift.String? {
        return "/CreateDatasetIntegration"
    }
}
...
extension DeleteDatasetIntegrationInput {

    static func urlPathProvider(_ value: DeleteDatasetIntegrationInput) -> Swift.String? {
        return "/DeleteDatasetIntegration"
    }
}
...
extension GetDatasetIntegrationInput {

    static func urlPathProvider(_ value: GetDatasetIntegrationInput) -> Swift.String? {
        return "/GetDatasetIntegration"
    }
}
...
extension ListDatasetIntegrationsInput {

    static func urlPathProvider(_ value: ListDatasetIntegrationsInput) -> Swift.String? {
        return "/ListDatasetIntegrations"
    }
}
...
extension UpdateDatasetIntegrationInput {

    static func urlPathProvider(_ value: UpdateDatasetIntegrationInput) -> Swift.String? {
        return "/UpdateDatasetIntegration"
    }
}
...
extension CreateDatasetIntegrationInput {
    ...
    static func write(value: CreateDatasetIntegrationInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension DeleteDatasetIntegrationInput {
    ...
    static func write(value: DeleteDatasetIntegrationInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension GetDatasetIntegrationInput {
    ...
    static func write(value: GetDatasetIntegrationInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Arn"].write(value.arn)
    }
}
...
extension ListDatasetIntegrationsInput {
    ...
    static func write(value: ListDatasetIntegrationsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["MaxResults"].write(value.maxResults)
        try writer["NextToken"].write(value.nextToken)
    }
...
extension UpdateDatasetIntegrationInput {
    ...
    static func write(value: UpdateDatasetIntegrationInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Arn"].write(value.arn)
        try writer["RoleArn"].write(value.roleArn)
    }
...
extension CreateDatasetIntegrationOutput {

    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> CreateDatasetIntegrationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = CreateDatasetIntegrationOutput()
...
extension DeleteDatasetIntegrationOutput {

    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> DeleteDatasetIntegrationOutput {
        return DeleteDatasetIntegrationOutput()
    }
}
...
extension GetCentralizationRuleForOrganizationOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> GetCentralizationRuleForOrganizationOutput {
        ...
        value.contextGraphStatus = try reader["ContextGraphStatus"].readIfPresent()
...
extension GetDatasetIntegrationOutput {

    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> GetDatasetIntegrationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = GetDatasetIntegrationOutput()
        value.arn = try reader["Arn"].readIfPresent()
...
extension ListDatasetIntegrationsOutput {

    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> ListDatasetIntegrationsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = ListDatasetIntegrationsOutput()
        value.datasetIntegrationSummaries = try reader["DatasetIntegrationSummaries"].readListIfPresent(memberReadingClosure: ObservabilityAdminClientTypes.DatasetIntegrationSummary.read(from:), memberNodeInfo: "member", isFlattened: false) ?? []
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension UpdateDatasetIntegrationOutput {

    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> UpdateDatasetIntegrationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = UpdateDatasetIntegrationOutput()
        value.arn = try reader["Arn"].readIfPresent() ?? ""
        value.createdAt = try reader["CreatedAt"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds) ?? SmithyTimestamps.TimestampFormatter(format: .dateTime).date(from: "1970-01-01T00:00:00Z")
        value.roleArn = try reader["RoleArn"].readIfPresent() ?? ""
        value.updatedAt = try reader["UpdatedAt"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds) ?? SmithyTimestamps.TimestampFormatter(format: .dateTime).date(from: "1970-01-01T00:00:00Z")
...
enum CreateDatasetIntegrationOutputError {
...
enum DeleteDatasetIntegrationOutputError {
...
enum GetDatasetIntegrationOutputError {
...
enum ListDatasetIntegrationsOutputError {
...
enum UpdateDatasetIntegrationOutputError {
...
extension ObservabilityAdminClientTypes.CentralizationRuleSource {
    ...
    static func write(value: ObservabilityAdminClientTypes.CentralizationRuleSource?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["SourceContextGraphConfiguration"].write(value.sourceContextGraphConfiguration, with: ObservabilityAdminClientTypes.SourceContextGraphConfiguration.write(value:to:))
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ObservabilityAdminClientTypes.CentralizationRuleSource {
        ...
        value.sourceContextGraphConfiguration = try reader["SourceContextGraphConfiguration"].readIfPresent(with: ObservabilityAdminClientTypes.SourceContextGraphConfiguration.read(from:))
        return value
    }
}
...
extension ObservabilityAdminClientTypes.DatasetIntegrationSummary {

    static func read(from reader: SmithyJSON.Reader) throws -> ObservabilityAdminClientTypes.DatasetIntegrationSummary {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = ObservabilityAdminClientTypes.DatasetIntegrationSummary()
        value.arn = try reader["Arn"].readIfPresent() ?? ""
        value.roleArn = try reader["RoleArn"].readIfPresent()
        value.createdAt = try reader["CreatedAt"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        value.updatedAt = try reader["UpdatedAt"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
...
extension ObservabilityAdminClientTypes.SourceContextGraphConfiguration {

    static func write(value: ObservabilityAdminClientTypes.SourceContextGraphConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard value != nil else { return }
        _ = writer[""]  // create an empty structure
    }

    static func read(from reader: SmithyJSON.Reader) throws -> ObservabilityAdminClientTypes.SourceContextGraphConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        return ObservabilityAdminClientTypes.SourceContextGraphConfiguration()
    }
}
