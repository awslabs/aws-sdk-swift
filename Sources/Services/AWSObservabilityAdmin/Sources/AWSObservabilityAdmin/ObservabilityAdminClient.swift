...
public final class ObservabilityAdminClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: ObservabilityAdminClient.ObservabilityAdminClientConfig) instead")
    public convenience init(config: ObservabilityAdminClient.ObservabilityAdminClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ObservabilityAdminClient.ObservabilityAdminClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ObservabilityAdminClient.ObservabilityAdminClientConfig()
        self.init(config: config)
    }
}
...
extension ObservabilityAdminClient {
    ...
    /// Client configuration for ObservabilityAdminClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ObservabilityAdminClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "ObservabilityAdmin")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultObservabilityAdminAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ObservabilityAdminClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use ObservabilityAdminClientConfig instead. This class will be removed in a future version.")
    public final class ObservabilityAdminClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ObservabilityAdminClientConfig {
            return try ObservabilityAdminClientConfig(
...
extension ObservabilityAdminClient {
    ...
    public func createCentralizationRuleForOrganization(input: CreateCentralizationRuleForOrganizationInput) async throws -> CreateCentralizationRuleForOrganizationOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ObservabilityAdmin"))
    ...
    /// Performs the `CreateDatasetIntegration` operation on the `ObservabilityAdmin` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `CreateDatasetIntegrationInput`)
    ///
    /// - Returns: [no documentation found] (Type: `CreateDatasetIntegrationOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `TooManyRequestsException` : The request throughput limit was exceeded.
    /// - `ValidationException` : Indicates input validation failed. Check your request parameters and retry the request.
    public func createDatasetIntegration(input: CreateDatasetIntegrationInput) async throws -> CreateDatasetIntegrationOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "createDatasetIntegration")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateDatasetIntegrationInput, CreateDatasetIntegrationOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<CreateDatasetIntegrationInput, CreateDatasetIntegrationOutput>(CreateDatasetIntegrationInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<CreateDatasetIntegrationInput, CreateDatasetIntegrationOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<CreateDatasetIntegrationInput, CreateDatasetIntegrationOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateDatasetIntegrationInput, CreateDatasetIntegrationOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: CreateDatasetIntegrationInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<CreateDatasetIntegrationInput, CreateDatasetIntegrationOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<CreateDatasetIntegrationOutput>(CreateDatasetIntegrationOutput.httpOutput(from:), CreateDatasetIntegrationOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<CreateDatasetIntegrationInput, CreateDatasetIntegrationOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<CreateDatasetIntegrationOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("ObservabilityAdmin", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateDatasetIntegrationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<CreateDatasetIntegrationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<CreateDatasetIntegrationInput, CreateDatasetIntegrationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<CreateDatasetIntegrationInput, CreateDatasetIntegrationOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ObservabilityAdmin"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateDatasetIntegrationInput, CreateDatasetIntegrationOutput>(serviceID: serviceName, version: ObservabilityAdminClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ObservabilityAdmin")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "CreateDatasetIntegration")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `DeleteDatasetIntegration` operation on the `ObservabilityAdmin` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DeleteDatasetIntegrationInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteDatasetIntegrationOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `TooManyRequestsException` : The request throughput limit was exceeded.
    /// - `ValidationException` : Indicates input validation failed. Check your request parameters and retry the request.
    public func deleteDatasetIntegration(input: DeleteDatasetIntegrationInput) async throws -> DeleteDatasetIntegrationOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteDatasetIntegration")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteDatasetIntegrationInput, DeleteDatasetIntegrationOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<DeleteDatasetIntegrationInput, DeleteDatasetIntegrationOutput>(DeleteDatasetIntegrationInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DeleteDatasetIntegrationInput, DeleteDatasetIntegrationOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DeleteDatasetIntegrationInput, DeleteDatasetIntegrationOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<DeleteDatasetIntegrationInput, DeleteDatasetIntegrationOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: DeleteDatasetIntegrationInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<DeleteDatasetIntegrationInput, DeleteDatasetIntegrationOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<DeleteDatasetIntegrationOutput>(DeleteDatasetIntegrationOutput.httpOutput(from:), DeleteDatasetIntegrationOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<DeleteDatasetIntegrationInput, DeleteDatasetIntegrationOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<DeleteDatasetIntegrationOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("ObservabilityAdmin", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteDatasetIntegrationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DeleteDatasetIntegrationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DeleteDatasetIntegrationInput, DeleteDatasetIntegrationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DeleteDatasetIntegrationInput, DeleteDatasetIntegrationOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ObservabilityAdmin"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteDatasetIntegrationInput, DeleteDatasetIntegrationOutput>(serviceID: serviceName, version: ObservabilityAdminClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ObservabilityAdmin")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DeleteDatasetIntegration")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `GetDatasetIntegration` operation on the `ObservabilityAdmin` service.
    ///
    /// Returns the dataset integration for the caller's account in the current region.
    ///
    /// - Parameter input: [no documentation found] (Type: `GetDatasetIntegrationInput`)
    ///
    /// - Returns: [no documentation found] (Type: `GetDatasetIntegrationOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `TooManyRequestsException` : The request throughput limit was exceeded.
    /// - `ValidationException` : Indicates input validation failed. Check your request parameters and retry the request.
    public func getDatasetIntegration(input: GetDatasetIntegrationInput) async throws -> GetDatasetIntegrationOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getDatasetIntegration")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetDatasetIntegrationInput, GetDatasetIntegrationOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GetDatasetIntegrationInput, GetDatasetIntegrationOutput>(GetDatasetIntegrationInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetDatasetIntegrationInput, GetDatasetIntegrationOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetDatasetIntegrationInput, GetDatasetIntegrationOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<GetDatasetIntegrationInput, GetDatasetIntegrationOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: GetDatasetIntegrationInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetDatasetIntegrationInput, GetDatasetIntegrationOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetDatasetIntegrationOutput>(GetDatasetIntegrationOutput.httpOutput(from:), GetDatasetIntegrationOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetDatasetIntegrationInput, GetDatasetIntegrationOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<GetDatasetIntegrationOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("ObservabilityAdmin", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetDatasetIntegrationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetDatasetIntegrationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetDatasetIntegrationInput, GetDatasetIntegrationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetDatasetIntegrationInput, GetDatasetIntegrationOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ObservabilityAdmin"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDatasetIntegrationInput, GetDatasetIntegrationOutput>(serviceID: serviceName, version: ObservabilityAdminClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ObservabilityAdmin")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetDatasetIntegration")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListDatasetIntegrations` operation on the `ObservabilityAdmin` service.
    ///
    /// Returns the dataset integrations in your account.
    ///
    /// - Parameter input: [no documentation found] (Type: `ListDatasetIntegrationsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListDatasetIntegrationsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `TooManyRequestsException` : The request throughput limit was exceeded.
    /// - `ValidationException` : Indicates input validation failed. Check your request parameters and retry the request.
    public func listDatasetIntegrations(input: ListDatasetIntegrationsInput) async throws -> ListDatasetIntegrationsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listDatasetIntegrations")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListDatasetIntegrationsInput, ListDatasetIntegrationsOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ListDatasetIntegrationsInput, ListDatasetIntegrationsOutput>(ListDatasetIntegrationsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListDatasetIntegrationsInput, ListDatasetIntegrationsOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListDatasetIntegrationsInput, ListDatasetIntegrationsOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<ListDatasetIntegrationsInput, ListDatasetIntegrationsOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: ListDatasetIntegrationsInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListDatasetIntegrationsInput, ListDatasetIntegrationsOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListDatasetIntegrationsOutput>(ListDatasetIntegrationsOutput.httpOutput(from:), ListDatasetIntegrationsOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListDatasetIntegrationsInput, ListDatasetIntegrationsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<ListDatasetIntegrationsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("ObservabilityAdmin", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListDatasetIntegrationsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListDatasetIntegrationsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListDatasetIntegrationsInput, ListDatasetIntegrationsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListDatasetIntegrationsInput, ListDatasetIntegrationsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ObservabilityAdmin"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListDatasetIntegrationsInput, ListDatasetIntegrationsOutput>(serviceID: serviceName, version: ObservabilityAdminClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ObservabilityAdmin")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListDatasetIntegrations")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `UpdateDatasetIntegration` operation on the `ObservabilityAdmin` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `UpdateDatasetIntegrationInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateDatasetIntegrationOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `TooManyRequestsException` : The request throughput limit was exceeded.
    /// - `ValidationException` : Indicates input validation failed. Check your request parameters and retry the request.
    public func updateDatasetIntegration(input: UpdateDatasetIntegrationInput) async throws -> UpdateDatasetIntegrationOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "updateDatasetIntegration")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateDatasetIntegrationInput, UpdateDatasetIntegrationOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<UpdateDatasetIntegrationInput, UpdateDatasetIntegrationOutput>(UpdateDatasetIntegrationInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<UpdateDatasetIntegrationInput, UpdateDatasetIntegrationOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<UpdateDatasetIntegrationInput, UpdateDatasetIntegrationOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<UpdateDatasetIntegrationInput, UpdateDatasetIntegrationOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: UpdateDatasetIntegrationInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<UpdateDatasetIntegrationInput, UpdateDatasetIntegrationOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<UpdateDatasetIntegrationOutput>(UpdateDatasetIntegrationOutput.httpOutput(from:), UpdateDatasetIntegrationOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<UpdateDatasetIntegrationInput, UpdateDatasetIntegrationOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<UpdateDatasetIntegrationOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("ObservabilityAdmin", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateDatasetIntegrationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<UpdateDatasetIntegrationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<UpdateDatasetIntegrationInput, UpdateDatasetIntegrationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<UpdateDatasetIntegrationInput, UpdateDatasetIntegrationOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ObservabilityAdmin"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateDatasetIntegrationInput, UpdateDatasetIntegrationOutput>(serviceID: serviceName, version: ObservabilityAdminClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ObservabilityAdmin")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "UpdateDatasetIntegration")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
