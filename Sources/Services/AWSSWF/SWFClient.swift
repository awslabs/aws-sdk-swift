...
extension SWFClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SWFClient.SWFClientConfiguration {
        let clientConfiguration = try await SWFClient.SWFClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SWFClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SWFClient(config: configuration)
        }
    }
...
extension SWFClient.SWFClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
