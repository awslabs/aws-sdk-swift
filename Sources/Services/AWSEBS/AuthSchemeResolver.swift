...
public struct EBSAuthSchemeResolverParameters: SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol EBSAuthSchemeResolver: SmithyHTTPAuthAPI.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service EBS must conform to.
}

public struct DefaultEBSAuthSchemeResolver: EBSAuthSchemeResolver {
    public func resolveAuthScheme(params: SmithyHTTPAuthAPI.AuthSchemeResolverParameters) throws -> [AuthOption] {
        ...
        guard let serviceParams = params as? EBSAuthSchemeResolverParameters else {
        ...
        switch serviceParams.operation {
            case "putSnapshotBlock":
                ...
                sigV4Option.signingProperties.set(key: SigningPropertyKeys.signingName, value: "ebs")
    ...
    public func constructParameters(context: Smithy.Context) throws -> SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
        ...
        return EBSAuthSchemeResolverParameters(operation: opName, region: opRegion)
    }
}
