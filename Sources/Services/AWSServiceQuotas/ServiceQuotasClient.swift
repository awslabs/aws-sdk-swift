...
extension ServiceQuotasClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ServiceQuotasClient.ServiceQuotasClientConfiguration {
        let clientConfiguration = try await ServiceQuotasClient.ServiceQuotasClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ServiceQuotasClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ServiceQuotasClient(config: configuration)
        }
    }
...
extension ServiceQuotasClient.ServiceQuotasClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
