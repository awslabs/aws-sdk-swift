...
public struct CloudFrontKeyValueStoreAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol CloudFrontKeyValueStoreAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
...
public struct DefaultCloudFrontKeyValueStoreAuthSchemeResolver: CloudFrontKeyValueStoreAuthSchemeResolver {
    public func resolveAuthScheme(params: ClientRuntime.AuthSchemeResolverParameters) throws -> [AuthOption] {
        ...
        switch serviceParams.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "cloudfront-keyvaluestore")
    ...
    public func constructParameters(context: HttpContext) throws -> ClientRuntime.AuthSchemeResolverParameters {
        ...
        return CloudFrontKeyValueStoreAuthSchemeResolverParameters(operation: opName, region: opRegion)
    }
}
