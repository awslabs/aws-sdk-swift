...
extension CloudFrontKeyValueStoreClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CloudFrontKeyValueStoreClient.CloudFrontKeyValueStoreClientConfiguration {
        let clientConfiguration = try await CloudFrontKeyValueStoreClient.CloudFrontKeyValueStoreClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CloudFrontKeyValueStoreClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CloudFrontKeyValueStoreClient(config: configuration)
        }
    }
...
extension CloudFrontKeyValueStoreClient.CloudFrontKeyValueStoreClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
