...
extension CloudFrontKeyValueStoreClient {
    ...
    public struct CloudFrontKeyValueStoreClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "CloudFront KeyValueStore")
...
extension CloudFrontKeyValueStoreClient {
    ...
    public func deleteKey(input: DeleteKeyInput) async throws -> DeleteKeyOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudFront KeyValueStore"))
