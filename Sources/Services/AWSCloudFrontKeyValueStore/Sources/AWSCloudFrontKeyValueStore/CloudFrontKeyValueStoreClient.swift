...
public final class CloudFrontKeyValueStoreClient: AWSClientRuntime.AWSServiceClient, Sendable {
...
extension CloudFrontKeyValueStoreClient {
    ...
    public final class CloudFrontKeyValueStoreClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, @unchecked Sendable {
        ...
        public convenience init(region: Swift.String) throws {
            self.init(
                ...
                nil,
                DefaultCloudFrontKeyValueStoreAuthSchemeResolver(),
