...
extension RedshiftServerlessClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> RedshiftServerlessClient.RedshiftServerlessClientConfiguration {
        let clientConfiguration = try await RedshiftServerlessClient.RedshiftServerlessClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> RedshiftServerlessClient {
            let configuration = try await resolve(plugins: self.plugins)
            return RedshiftServerlessClient(config: configuration)
        }
    }
...
extension RedshiftServerlessClient.RedshiftServerlessClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
