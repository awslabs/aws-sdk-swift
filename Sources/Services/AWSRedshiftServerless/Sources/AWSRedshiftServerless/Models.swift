...
extension RedshiftServerlessClientTypes.ScheduledActionResponse {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RedshiftServerlessClientTypes.ScheduledActionResponse {
        ...
        value.nextInvocations = try reader["nextInvocations"].readListIfPresent(memberReadingClosure: SmithyReadWrite.timestampReadingClosure(format: .epochSeconds), memberNodeInfo: "member", isFlattened: false)
