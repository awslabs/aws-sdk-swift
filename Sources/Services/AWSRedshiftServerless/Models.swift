...
extension CreateCustomDomainAssociationOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateCustomDomainAssociationOutput {
        ...
        value.customDomainCertificateExpiryTime = try reader["customDomainCertificateExpiryTime"].readTimestampIfPresent(format: .dateTime)
...
extension GetCredentialsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetCredentialsOutput {
        ...
        value.nextRefreshTime = try reader["nextRefreshTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension RedshiftServerlessClientTypes.Snapshot {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RedshiftServerlessClientTypes.Snapshot {
        ...
        value.accountsWithRestoreAccess = try reader["accountsWithRestoreAccess"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.accountsWithProvisionedRestoreAccess = try reader["accountsWithProvisionedRestoreAccess"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension RedshiftServerlessClientTypes.Namespace {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RedshiftServerlessClientTypes.Namespace {
        ...
        value.iamRoles = try reader["iamRoles"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.logExports = try reader["logExports"].readListIfPresent(memberReadingClosure: RedshiftServerlessClientTypes.LogExport.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["status"].readIfPresent()
...
extension RedshiftServerlessClientTypes.ScheduledActionResponse {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RedshiftServerlessClientTypes.ScheduledActionResponse {
        ...
        value.nextInvocations = try reader["nextInvocations"].readListIfPresent(memberReadingClosure: timestampReadingClosure(format: .epochSeconds), memberNodeInfo: "member", isFlattened: false)
...
extension RedshiftServerlessClientTypes.Schedule {
    ...
    static func write(value: RedshiftServerlessClientTypes.Schedule?, to writer: SmithyJSON.Writer) throws {
        ...
        switch value {
            case let .at(at):
                try writer["at"].writeTimestamp(at, format: .epochSeconds)
            case let .cron(cron):
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RedshiftServerlessClientTypes.Schedule {
        ...
        switch name {
            case "at":
                return .at(try reader["at"].readTimestamp(format: .epochSeconds))
            case "cron":
...
extension RedshiftServerlessClientTypes.Workgroup {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RedshiftServerlessClientTypes.Workgroup {
        ...
        value.crossAccountVpcs = try reader["crossAccountVpcs"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension RedshiftServerlessClientTypes.RecoveryPoint {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RedshiftServerlessClientTypes.RecoveryPoint {
        ...
        value.recoveryPointId = try reader["recoveryPointId"].readIfPresent()
        value.recoveryPointCreateTime = try reader["recoveryPointCreateTime"].readTimestampIfPresent(format: .dateTime)
