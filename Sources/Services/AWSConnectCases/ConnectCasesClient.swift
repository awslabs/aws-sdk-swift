...
extension ConnectCasesClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ConnectCasesClient.ConnectCasesClientConfiguration {
        let clientConfiguration = try await ConnectCasesClient.ConnectCasesClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ConnectCasesClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ConnectCasesClient(config: configuration)
        }
    }
...
extension ConnectCasesClient.ConnectCasesClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
