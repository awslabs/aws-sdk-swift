...
public final class ConnectCasesClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "ConnectCasesClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: ConnectCasesClient.ConnectCasesClientConfig
    let serviceName = "ConnectCases"

    @available(*, deprecated, message: "Use ConnectCasesClient.ConnectCasesClientConfig instead")
    public typealias Config = ConnectCasesClient.ConnectCasesClientConfiguration
    public typealias Configuration = ConnectCasesClient.ConnectCasesClientConfig

    public required init(config: ConnectCasesClient.ConnectCasesClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: ConnectCasesClient.ConnectCasesClientConfig) instead")
    public convenience init(config: ConnectCasesClient.ConnectCasesClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ConnectCasesClient.ConnectCasesClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ConnectCasesClient.ConnectCasesClientConfig()
        self.init(config: config)
    }
}
...
extension ConnectCasesClient {
    ...
    /// Client configuration for ConnectCasesClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ConnectCasesClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "ConnectCases")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ConnectCasesClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use ConnectCasesClientConfig instead. This class will be removed in a future version.")
    public final class ConnectCasesClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ConnectCasesClientConfig {
            return try ConnectCasesClientConfig(
...
extension ConnectCasesClient {
    ...
    public func batchGetCaseRule(input: BatchGetCaseRuleInput) async throws -> BatchGetCaseRuleOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ConnectCases"))
