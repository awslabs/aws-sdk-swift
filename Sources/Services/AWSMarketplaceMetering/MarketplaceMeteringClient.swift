...
extension MarketplaceMeteringClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MarketplaceMeteringClient.MarketplaceMeteringClientConfiguration {
        let clientConfiguration = try await MarketplaceMeteringClient.MarketplaceMeteringClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MarketplaceMeteringClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MarketplaceMeteringClient(config: configuration)
        }
    }
...
extension MarketplaceMeteringClient.MarketplaceMeteringClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
