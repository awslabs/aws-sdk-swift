...
extension GetTableObjectsInput {
    ...
    static func write(value: GetTableObjectsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["QueryAsOfTime"].writeTimestamp(value.queryAsOfTime, format: .epochSeconds)
        try writer["TableName"].write(value.tableName)
        try writer["TransactionId"].write(value.transactionId)
    }
}
...
extension GetTemporaryGluePartitionCredentialsInput {
    ...
    static func write(value: GetTemporaryGluePartitionCredentialsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Permissions"].writeList(value.permissions, memberWritingClosure: LakeFormationClientTypes.Permission.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SupportedPermissionTypes"].writeList(value.supportedPermissionTypes, memberWritingClosure: LakeFormationClientTypes.PermissionType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GrantPermissionsInput {
    ...
    static func write(value: GrantPermissionsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["CatalogId"].write(value.catalogId)
        try writer["Permissions"].writeList(value.permissions, memberWritingClosure: LakeFormationClientTypes.Permission.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["PermissionsWithGrantOption"].writeList(value.permissionsWithGrantOption, memberWritingClosure: LakeFormationClientTypes.Permission.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Principal"].write(value.principal, with: LakeFormationClientTypes.DataLakePrincipal.write(value:to:))
        try writer["Resource"].write(value.resource, with: LakeFormationClientTypes.Resource.write(value:to:))
    }
}
...
extension UpdateLFTagInput {
    ...
    static func write(value: UpdateLFTagInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["CatalogId"].write(value.catalogId)
        try writer["TagKey"].write(value.tagKey)
        try writer["TagValuesToAdd"].writeList(value.tagValuesToAdd, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["TagValuesToDelete"].writeList(value.tagValuesToDelete, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension UpdateTableStorageOptimizerInput {
    ...
    static func write(value: UpdateTableStorageOptimizerInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["CatalogId"].write(value.catalogId)
        try writer["DatabaseName"].write(value.databaseName)
        try writer["StorageOptimizerConfig"].writeMap(value.storageOptimizerConfig, valueWritingClosure: mapWritingClosure(valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["TableName"].write(value.tableName)
    }
}
...
extension GetQueryStatisticsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetQueryStatisticsOutput {
        ...
        value.querySubmissionTime = try reader["QuerySubmissionTime"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
...
extension GetTemporaryGlueTableCredentialsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetTemporaryGlueTableCredentialsOutput {
        ...
        value.secretAccessKey = try reader["SecretAccessKey"].readIfPresent()
        value.sessionToken = try reader["SessionToken"].readIfPresent()
        value.vendedS3Path = try reader["VendedS3Path"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension LakeFormationClientTypes.BatchPermissionsRequestEntry {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LakeFormationClientTypes.BatchPermissionsRequestEntry {
        ...
        value.permissions = try reader["Permissions"].readListIfPresent(memberReadingClosure: LakeFormationClientTypes.Permission.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.permissionsWithGrantOption = try reader["PermissionsWithGrantOption"].readListIfPresent(memberReadingClosure: LakeFormationClientTypes.Permission.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension LakeFormationClientTypes.TableWithColumnsResource {
    ...
    static func write(value: LakeFormationClientTypes.TableWithColumnsResource?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CatalogId"].write(value.catalogId)
        try writer["ColumnNames"].writeList(value.columnNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LakeFormationClientTypes.TableWithColumnsResource {
        ...
        value.databaseName = try reader["DatabaseName"].readIfPresent()
        value.name = try reader["Name"].readIfPresent()
        value.columnNames = try reader["ColumnNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension LakeFormationClientTypes.ColumnWildcard {
    ...
    static func write(value: LakeFormationClientTypes.ColumnWildcard?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ExcludedColumnNames"].writeList(value.excludedColumnNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LakeFormationClientTypes.ColumnWildcard {
        ...
        value.excludedColumnNames = try reader["ExcludedColumnNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension LakeFormationClientTypes.TransactionDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LakeFormationClientTypes.TransactionDescription {
        ...
        value.transactionId = try reader["TransactionId"].readIfPresent()
        value.transactionStatus = try reader["TransactionStatus"].readIfPresent()
        value.transactionStartTime = try reader["TransactionStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.transactionEndTime = try reader["TransactionEndTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension LakeFormationClientTypes.DataLakeSettings {
    ...
    static func write(value: LakeFormationClientTypes.DataLakeSettings?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["AuthorizedSessionTagValueList"].writeList(value.authorizedSessionTagValueList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["TrustedResourceOwners"].writeList(value.trustedResourceOwners, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LakeFormationClientTypes.DataLakeSettings {
        ...
        value.trustedResourceOwners = try reader["TrustedResourceOwners"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.authorizedSessionTagValueList = try reader["AuthorizedSessionTagValueList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension LakeFormationClientTypes.DetailsMap {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LakeFormationClientTypes.DetailsMap {
        ...
        value.resourceShare = try reader["ResourceShare"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension LakeFormationClientTypes.PartitionObjects {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LakeFormationClientTypes.PartitionObjects {
        ...
        value.partitionValues = try reader["PartitionValues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension LakeFormationClientTypes.StorageOptimizer {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LakeFormationClientTypes.StorageOptimizer {
        ...
        value.config = try reader["Config"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.errorMessage = try reader["ErrorMessage"].readIfPresent()
...
extension LakeFormationClientTypes.FilterCondition {
    ...
    static func write(value: LakeFormationClientTypes.FilterCondition?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["StringValueList"].writeList(value.stringValueList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
