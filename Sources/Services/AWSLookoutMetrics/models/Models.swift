...
extension LookoutMetricsClientTypes.AlertFilters {
    ...
    static func write(value: LookoutMetricsClientTypes.AlertFilters?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["MetricList"].writeList(value.metricList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LookoutMetricsClientTypes.AlertFilters {
        ...
        value.metricList = try reader["MetricList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension LookoutMetricsClientTypes.AttributeValue {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LookoutMetricsClientTypes.AttributeValue {
        ...
        value.ss = try reader["SS"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.ns = try reader["NS"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.bs = try reader["BS"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CreateMetricSetInput {
    ...
    static func write(value: CreateMetricSetInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["DimensionList"].writeList(value.dimensionList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeMetricSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeMetricSetOutput {
        ...
        value.dimensionList = try reader["DimensionList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.lastModificationTime = try reader["LastModificationTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension LookoutMetricsClientTypes.DimensionFilter {
    ...
    static func write(value: LookoutMetricsClientTypes.DimensionFilter?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["DimensionValueList"].writeList(value.dimensionValueList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LookoutMetricsClientTypes.DimensionFilter {
        ...
        value.dimensionName = try reader["DimensionName"].readIfPresent()
        value.dimensionValueList = try reader["DimensionValueList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetSampleDataOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetSampleDataOutput {
        ...
        value.headerValues = try reader["HeaderValues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.sampleRows = try reader["SampleRows"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListAnomalyGroupTimeSeriesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAnomalyGroupTimeSeriesOutput {
        ...
        value.timestampList = try reader["TimestampList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension LookoutMetricsClientTypes.TimeSeries {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LookoutMetricsClientTypes.TimeSeries {
        ...
        value.metricValueList = try reader["MetricValueList"].readListIfPresent(memberReadingClosure: Swift.Double.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension LookoutMetricsClientTypes.VpcConfiguration {
    ...
    static func write(value: LookoutMetricsClientTypes.VpcConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["SecurityGroupIdList"].writeList(value.securityGroupIdList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SubnetIdList"].writeList(value.subnetIdList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LookoutMetricsClientTypes.VpcConfiguration {
        ...
        value.subnetIdList = try reader["SubnetIdList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.securityGroupIdList = try reader["SecurityGroupIdList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
