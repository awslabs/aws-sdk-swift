...
extension QConnectClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> QConnectClient.QConnectClientConfiguration {
        let clientConfiguration = try await QConnectClient.QConnectClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> QConnectClient {
            let configuration = try await resolve(plugins: self.plugins)
            return QConnectClient(config: configuration)
        }
    }
...
extension QConnectClient.QConnectClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
