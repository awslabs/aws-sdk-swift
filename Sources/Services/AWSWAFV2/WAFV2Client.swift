...
extension WAFV2Client {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> WAFV2Client.WAFV2ClientConfiguration {
        let clientConfiguration = try await WAFV2Client.WAFV2ClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> WAFV2Client {
            let configuration = try await resolve(plugins: self.plugins)
            return WAFV2Client(config: configuration)
        }
    }
...
extension WAFV2Client.WAFV2ClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
