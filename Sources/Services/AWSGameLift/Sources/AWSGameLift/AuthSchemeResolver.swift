...
public struct GameLiftAuthSchemeResolverParameters: SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
...
public protocol GameLiftAuthSchemeResolver: SmithyHTTPAuthAPI.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service GameLift must conform to.
}

public struct DefaultGameLiftAuthSchemeResolver: GameLiftAuthSchemeResolver {
    ...
    public func resolveAuthScheme(params: SmithyHTTPAuthAPI.AuthSchemeResolverParameters) throws -> [SmithyHTTPAuthAPI.AuthOption] {
        ...
        guard let serviceParams = params as? GameLiftAuthSchemeResolverParameters else {
        ...
        switch serviceParams.operation {
            default:
                ...
                sigv4Option.signingProperties.set(key: SmithyHTTPAuthAPI.SigningPropertyKeys.signingName, value: "gamelift")
    ...
    public func constructParameters(context: Smithy.Context) throws -> SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
        ...
        return GameLiftAuthSchemeResolverParameters(authSchemePreference: authSchemePreference, operation: opName, region: opRegion)
    }
}
