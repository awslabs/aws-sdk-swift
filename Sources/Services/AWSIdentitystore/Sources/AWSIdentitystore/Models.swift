...
extension DescribeGroupOutput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeGroupOutput(createdAt: \(Swift.String(describing: createdAt)), createdBy: \(Swift.String(describing: createdBy)), externalIds: \(Swift.String(describing: externalIds)), groupId: \(Swift.String(describing: groupId)), identityStoreId: \(Swift.String(describing: identityStoreId)), updatedAt: \(Swift.String(describing: updatedAt)), updatedBy: \(Swift.String(describing: updatedBy)), description: \"CONTENT_REDACTED\", displayName: \"CONTENT_REDACTED\")"}
}
...
extension IdentitystoreClientTypes.Group: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Group(createdAt: \(Swift.String(describing: createdAt)), createdBy: \(Swift.String(describing: createdBy)), externalIds: \(Swift.String(describing: externalIds)), groupId: \(Swift.String(describing: groupId)), identityStoreId: \(Swift.String(describing: identityStoreId)), updatedAt: \(Swift.String(describing: updatedAt)), updatedBy: \(Swift.String(describing: updatedBy)), description: \"CONTENT_REDACTED\", displayName: \"CONTENT_REDACTED\")"}
}
...
extension CreateUserInput {
    ...
    static func write(value: CreateUserInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Extensions"].writeMap(value.extensions, valueWritingClosure: SmithyReadWrite.WritingClosures.writeDocument(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["IdentityStoreId"].write(value.identityStoreId)
        ...
        try writer["Website"].write(value.website)
    }
}
...
extension DescribeUserInput {
    ...
    static func write(value: DescribeUserInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Extensions"].writeList(value.extensions, memberWritingClosure: SmithyReadWrite.WritingClosures.writeString(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["IdentityStoreId"].write(value.identityStoreId)
        try writer["UserId"].write(value.userId)
    }
}
...
extension DescribeUserOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> DescribeUserOutput {
        ...
        value.extensions = try reader["Extensions"].readMapIfPresent(valueReadingClosure: SmithyReadWrite.ReadingClosures.readDocument(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.externalIds = try reader["ExternalIds"].readListIfPresent(memberReadingClosure: IdentitystoreClientTypes.ExternalId.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.identityStoreId = try reader["IdentityStoreId"].readIfPresent() ?? ""
...
extension IdentitystoreClientTypes.Photo {

    static func write(value: IdentitystoreClientTypes.Photo?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> IdentitystoreClientTypes.Photo {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = IdentitystoreClientTypes.Photo()
        value.value = try reader["Value"].readIfPresent() ?? ""
        value.type = try reader["Type"].readIfPresent()
