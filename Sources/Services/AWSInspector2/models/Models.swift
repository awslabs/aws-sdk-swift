...
extension AssociateMemberOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AssociateMemberOutput {
...
extension Inspector2ClientTypes.AtigData {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.AtigData {
        ...
        value.firstSeen = try reader["firstSeen"].readTimestampIfPresent(format: .epochSeconds)
        value.lastSeen = try reader["lastSeen"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.ttps = try reader["ttps"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension Inspector2ClientTypes.AwsEc2InstanceDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.AwsEc2InstanceDetails {
        ...
        value.launchedAt = try reader["launchedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension Inspector2ClientTypes.AwsLambdaFunctionDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.AwsLambdaFunctionDetails {
        ...
        value.layers = try reader["layers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.architectures = try reader["architectures"].readListIfPresent(memberReadingClosure: Inspector2ClientTypes.Architecture.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension BatchGetAccountStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchGetAccountStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension BatchGetCodeSnippetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchGetCodeSnippetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension BatchGetFindingDetailsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchGetFindingDetailsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension BatchGetFreeTrialInfoOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchGetFreeTrialInfoOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension BatchGetMemberEc2DeepInspectionStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchGetMemberEc2DeepInspectionStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension BatchUpdateMemberEc2DeepInspectionStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchUpdateMemberEc2DeepInspectionStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CancelFindingsReportOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CancelFindingsReportOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CancelSbomExportOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CancelSbomExportOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension Inspector2ClientTypes.CisScan {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.CisScan {
        ...
        value.scanDate = try reader["scanDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension Inspector2ClientTypes.CisaData {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.CisaData {
        ...
        value.dateAdded = try reader["dateAdded"].readTimestampIfPresent(format: .epochSeconds)
        value.dateDue = try reader["dateDue"].readTimestampIfPresent(format: .epochSeconds)
...
extension Inspector2ClientTypes.CodeVulnerabilityDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.CodeVulnerabilityDetails {
        ...
        value.cwes = try reader["cwes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension Inspector2ClientTypes.CoveredResource {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.CoveredResource {
        ...
        value.lastScannedAt = try reader["lastScannedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension CreateCisScanConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCisScanConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateFindingsReportOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateFindingsReportOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateSbomExportOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateSbomExportOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteCisScanConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCisScanConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DisableDelegatedAdminAccountOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DisableDelegatedAdminAccountOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DisableInput {
    ...
    static func write(value: DisableInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["accountIds"].writeList(value.accountIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["resourceTypes"].writeList(value.resourceTypes, memberWritingClosure: Inspector2ClientTypes.ResourceScanType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DisableOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DisableOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension Inspector2ClientTypes.Ec2InstanceAggregationResponse {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.Ec2InstanceAggregationResponse {
        ...
        value.instanceTags = try reader["instanceTags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.accountId = try reader["accountId"].readIfPresent()
        value.severityCounts = try reader["severityCounts"].readIfPresent(with: Inspector2ClientTypes.SeverityCounts.read(from:))
...
extension Inspector2ClientTypes.EcrContainerImageMetadata {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.EcrContainerImageMetadata {
        ...
        value.imagePulledAt = try reader["imagePulledAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension EnableDelegatedAdminAccountOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> EnableDelegatedAdminAccountOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension EnableOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> EnableOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension Inspector2ClientTypes.ExploitabilityDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.ExploitabilityDetails {
        ...
        value.lastKnownExploitAt = try reader["lastKnownExploitAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension Inspector2ClientTypes.FindingDetail {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.FindingDetail {
        ...
        value.ttps = try reader["ttps"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.tools = try reader["tools"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension GetCisScanReportOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetCisScanReportOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetCisScanResultDetailsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetCisScanResultDetailsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetDelegatedAdminAccountOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetDelegatedAdminAccountOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetEc2DeepInspectionConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetEc2DeepInspectionConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = GetEc2DeepInspectionConfigurationOutput()
        value.errorMessage = try reader["errorMessage"].readIfPresent()
        value.orgPackagePaths = try reader["orgPackagePaths"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.packagePaths = try reader["packagePaths"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["status"].readIfPresent()
        return value
    }
}
...
extension GetEncryptionKeyInput {
    ...
    static func queryItemProvider(_ value: GetEncryptionKeyInput) throws -> [ClientRuntime.SDKURLQueryItem] {
        ...
        let scanTypeQueryItem = ClientRuntime.SDKURLQueryItem(name: "scanType".urlPercentEncoding(), value: Swift.String(scanType.rawValue).urlPercentEncoding())
...
extension GetEncryptionKeyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetEncryptionKeyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetFindingsReportStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetFindingsReportStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetSbomExportOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetSbomExportOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension Inspector2ClientTypes.LambdaFunctionAggregationResponse {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.LambdaFunctionAggregationResponse {
        ...
        value.functionName = try reader["functionName"].readIfPresent()
        value.runtime = try reader["runtime"].readIfPresent()
        value.lambdaTags = try reader["lambdaTags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.accountId = try reader["accountId"].readIfPresent()
        value.severityCounts = try reader["severityCounts"].readIfPresent(with: Inspector2ClientTypes.SeverityCounts.read(from:))
        value.lastModifiedAt = try reader["lastModifiedAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
...
extension Inspector2ClientTypes.LambdaFunctionMetadata {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.LambdaFunctionMetadata {
        ...
        value.functionTags = try reader["functionTags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.layers = try reader["layers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.functionName = try reader["functionName"].readIfPresent()
        value.runtime = try reader["runtime"].readIfPresent()
        return value
...
extension ListAccountPermissionsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAccountPermissionsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCisScanConfigurationsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCisScanConfigurationsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCisScanResultsAggregatedByChecksOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCisScanResultsAggregatedByChecksOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCisScanResultsAggregatedByTargetResourceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCisScanResultsAggregatedByTargetResourceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCisScansOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCisScansOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCoverageStatisticsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCoverageStatisticsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListDelegatedAdminAccountsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListDelegatedAdminAccountsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListFindingAggregationsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListFindingAggregationsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListUsageTotalsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListUsageTotalsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ResetEncryptionKeyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ResetEncryptionKeyOutput {
...
extension SearchVulnerabilitiesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> SearchVulnerabilitiesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SendCisSessionHealthOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> SendCisSessionHealthOutput {
...
extension SendCisSessionTelemetryOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> SendCisSessionTelemetryOutput {
...
extension StartCisSessionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> StartCisSessionOutput {
...
extension StopCisSessionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> StopCisSessionOutput {
...
extension UpdateCisScanConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateCisScanConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateEc2DeepInspectionConfigurationInput {
    ...
    static func write(value: UpdateEc2DeepInspectionConfigurationInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["activateDeepInspection"].write(value.activateDeepInspection)
        try writer["packagePaths"].writeList(value.packagePaths, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension UpdateEc2DeepInspectionConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateEc2DeepInspectionConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateEncryptionKeyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateEncryptionKeyOutput {
...
extension UpdateOrgEc2DeepInspectionConfigurationInput {
    ...
    static func write(value: UpdateOrgEc2DeepInspectionConfigurationInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["orgPackagePaths"].writeList(value.orgPackagePaths, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension UpdateOrgEc2DeepInspectionConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateOrgEc2DeepInspectionConfigurationOutput {
...
extension Inspector2ClientTypes.Vulnerability {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.Vulnerability {
        ...
        value.referenceUrls = try reader["referenceUrls"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.exploitObserved = try reader["exploitObserved"].readIfPresent(with: Inspector2ClientTypes.ExploitObserved.read(from:))
        value.detectionPlatforms = try reader["detectionPlatforms"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension Inspector2ClientTypes.WeeklySchedule {
    ...
    static func write(value: Inspector2ClientTypes.WeeklySchedule?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["days"].writeList(value.days, memberWritingClosure: Inspector2ClientTypes.Day.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["startTime"].write(value.startTime, with: Inspector2ClientTypes.Time.write(value:to:))
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Inspector2ClientTypes.WeeklySchedule {
        ...
        value.startTime = try reader["startTime"].readIfPresent(with: Inspector2ClientTypes.Time.read(from:))
        value.days = try reader["days"].readListIfPresent(memberReadingClosure: Inspector2ClientTypes.Day.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
