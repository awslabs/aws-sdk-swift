...
extension IoTWirelessClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> IoTWirelessClient.IoTWirelessClientConfiguration {
        let clientConfiguration = try await IoTWirelessClient.IoTWirelessClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> IoTWirelessClient {
            let configuration = try await resolve(plugins: self.plugins)
            return IoTWirelessClient(config: configuration)
        }
    }
...
extension IoTWirelessClient.IoTWirelessClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
