...
extension BCMDataExportsClientTypes.DataQuery {
    ...
    static func write(value: BCMDataExportsClientTypes.DataQuery?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["TableConfigurations"].writeMap(value.tableConfigurations, valueWritingClosure: mapWritingClosure(valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BCMDataExportsClientTypes.DataQuery {
        ...
        value.tableConfigurations = try reader["TableConfigurations"].readMapIfPresent(valueReadingClosure: mapReadingClosure(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension BCMDataExportsClientTypes.ExportStatus {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BCMDataExportsClientTypes.ExportStatus {
        ...
        value.createdAt = try reader["CreatedAt"].readTimestampIfPresent(format: .dateTime)
        value.lastUpdatedAt = try reader["LastUpdatedAt"].readTimestampIfPresent(format: .dateTime)
        value.lastRefreshedAt = try reader["LastRefreshedAt"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
...
extension GetExecutionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetExecutionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetTableInput {
    ...
    static func write(value: GetTableInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["TableProperties"].writeMap(value.tableProperties, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension GetTableOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetTableOutput {
        ...
        value.tableProperties = try reader["TableProperties"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension ListExecutionsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListExecutionsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension BCMDataExportsClientTypes.TablePropertyDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BCMDataExportsClientTypes.TablePropertyDescription {
        ...
        value.name = try reader["Name"].readIfPresent()
        value.validValues = try reader["ValidValues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
