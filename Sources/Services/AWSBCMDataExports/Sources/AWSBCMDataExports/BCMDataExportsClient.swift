...
public final class BCMDataExportsClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: BCMDataExportsClient.BCMDataExportsClientConfig) instead")
    public convenience init(config: BCMDataExportsClient.BCMDataExportsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try BCMDataExportsClient.BCMDataExportsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await BCMDataExportsClient.BCMDataExportsClientConfig()
        self.init(config: config)
    }
}
...
extension BCMDataExportsClient {
    ...
    /// Client configuration for BCMDataExportsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct BCMDataExportsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "BCM Data Exports")
    ...
    @available(*, deprecated, message: "Use BCMDataExportsClientConfig instead. This class will be removed in a future version.")
    public final class BCMDataExportsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> BCMDataExportsClientConfig {
            return try BCMDataExportsClientConfig(
...
extension BCMDataExportsClient {
    ...
    public func createExport(input: CreateExportInput) async throws -> CreateExportOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "BCM Data Exports"))
