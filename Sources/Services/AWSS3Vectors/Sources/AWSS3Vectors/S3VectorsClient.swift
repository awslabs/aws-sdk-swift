...
public final class S3VectorsClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: S3VectorsClient.S3VectorsClientConfig) instead")
    public convenience init(config: S3VectorsClient.S3VectorsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try S3VectorsClient.S3VectorsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await S3VectorsClient.S3VectorsClientConfig()
        self.init(config: config)
    }
}
...
extension S3VectorsClient {
    ...
    /// Client configuration for S3VectorsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct S3VectorsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "S3Vectors")
    ...
    @available(*, deprecated, message: "Use S3VectorsClientConfig instead. This class will be removed in a future version.")
    public final class S3VectorsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> S3VectorsClientConfig {
            return try S3VectorsClientConfig(
