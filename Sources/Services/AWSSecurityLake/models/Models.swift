...
extension SecurityLakeClientTypes.AwsLogSourceConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecurityLakeClientTypes.AwsLogSourceConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SecurityLakeClientTypes.AwsLogSourceConfiguration()
        value.accounts = try reader["accounts"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.sourceVersion = try reader["sourceVersion"].readIfPresent() ?? "latest"
        return value
    }
}
...
extension CreateAwsLogSourceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateAwsLogSourceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = CreateAwsLogSourceOutput()
        value.failed = try reader["failed"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CreateCustomLogSourceInput {
    ...
    static func write(value: CreateCustomLogSourceInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["eventClasses"].writeList(value.eventClasses, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["sourceName"].write(value.sourceName)
        try writer["sourceVersion"].write(value.sourceVersion)
    }
}
...
extension CreateCustomLogSourceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateCustomLogSourceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateDataLakeExceptionSubscriptionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateDataLakeExceptionSubscriptionOutput {
...
extension CreateDataLakeOrganizationConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateDataLakeOrganizationConfigurationOutput {
...
extension CreateDataLakeOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateDataLakeOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateSubscriberInput {
    ...
    static func write(value: CreateSubscriberInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["accessTypes"].writeList(value.accessTypes, memberWritingClosure: SecurityLakeClientTypes.AccessType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateSubscriberNotificationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateSubscriberNotificationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateSubscriberOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateSubscriberOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SecurityLakeClientTypes.CustomLogSourceConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecurityLakeClientTypes.CustomLogSourceConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SecurityLakeClientTypes.CustomLogSourceConfiguration()
        value.crawlerConfiguration = try reader["crawlerConfiguration"].readIfPresent(with: SecurityLakeClientTypes.CustomLogSourceCrawlerConfiguration.read(from:))
        value.providerIdentity = try reader["providerIdentity"].readIfPresent(with: SecurityLakeClientTypes.AwsIdentity.read(from:))
        return value
    }
}
...
extension SecurityLakeClientTypes.CustomLogSourceCrawlerConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecurityLakeClientTypes.CustomLogSourceCrawlerConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SecurityLakeClientTypes.CustomLogSourceCrawlerConfiguration()
...
extension SecurityLakeClientTypes.DataLakeConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecurityLakeClientTypes.DataLakeConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SecurityLakeClientTypes.DataLakeConfiguration()
        value.region = try reader["region"].readIfPresent()
...
extension SecurityLakeClientTypes.DataLakeException {
    ...
    static func write(value: SecurityLakeClientTypes.DataLakeException?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["exception"].write(value.exception)
        try writer["region"].write(value.region)
...
extension SecurityLakeClientTypes.DataLakeResource {
    ...
    static func write(value: SecurityLakeClientTypes.DataLakeResource?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["createStatus"].write(value.createStatus)
        try writer["dataLakeArn"].write(value.dataLakeArn)
        try writer["encryptionConfiguration"].write(value.encryptionConfiguration, with: SecurityLakeClientTypes.DataLakeEncryptionConfiguration.write(value:to:))
        try writer["lifecycleConfiguration"].write(value.lifecycleConfiguration, with: SecurityLakeClientTypes.DataLakeLifecycleConfiguration.write(value:to:))
        try writer["region"].write(value.region)
        try writer["replicationConfiguration"].write(value.replicationConfiguration, with: SecurityLakeClientTypes.DataLakeReplicationConfiguration.write(value:to:))
        try writer["s3BucketArn"].write(value.s3BucketArn)
        try writer["updateStatus"].write(value.updateStatus, with: SecurityLakeClientTypes.DataLakeUpdateStatus.write(value:to:))
    }
...
extension SecurityLakeClientTypes.DataLakeSource {
    ...
    static func write(value: SecurityLakeClientTypes.DataLakeSource?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["account"].write(value.account)
        try writer["eventClasses"].writeList(value.eventClasses, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["sourceName"].write(value.sourceName)
        try writer["sourceStatuses"].writeList(value.sourceStatuses, memberWritingClosure: SecurityLakeClientTypes.DataLakeSourceStatus.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecurityLakeClientTypes.DataLakeSource {
        ...
        value.sourceName = try reader["sourceName"].readIfPresent()
        value.eventClasses = try reader["eventClasses"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension SecurityLakeClientTypes.DataLakeSourceStatus {
    ...
    static func write(value: SecurityLakeClientTypes.DataLakeSourceStatus?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension SecurityLakeClientTypes.DataLakeUpdateException {
    ...
    static func write(value: SecurityLakeClientTypes.DataLakeUpdateException?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension SecurityLakeClientTypes.DataLakeUpdateStatus {
    ...
    static func write(value: SecurityLakeClientTypes.DataLakeUpdateStatus?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["exception"].write(value.exception, with: SecurityLakeClientTypes.DataLakeUpdateException.write(value:to:))
...
extension DeleteAwsLogSourceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteAwsLogSourceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteCustomLogSourceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCustomLogSourceOutput {
...
extension DeleteDataLakeExceptionSubscriptionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteDataLakeExceptionSubscriptionOutput {
...
extension DeleteDataLakeOrganizationConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteDataLakeOrganizationConfigurationOutput {
...
extension DeleteDataLakeOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteDataLakeOutput {
...
extension DeleteSubscriberNotificationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteSubscriberNotificationOutput {
...
extension DeleteSubscriberOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteSubscriberOutput {
...
extension DeregisterDataLakeDelegatedAdministratorOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeregisterDataLakeDelegatedAdministratorOutput {
...
extension GetDataLakeExceptionSubscriptionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetDataLakeExceptionSubscriptionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetDataLakeOrganizationConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetDataLakeOrganizationConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetDataLakeSourcesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetDataLakeSourcesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetSubscriberOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetSubscriberOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SecurityLakeClientTypes.HttpsNotificationConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecurityLakeClientTypes.HttpsNotificationConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SecurityLakeClientTypes.HttpsNotificationConfiguration()
        value.endpoint = try reader["endpoint"].readIfPresent()
        value.authorizationApiKeyName = try reader["authorizationApiKeyName"].readIfPresent()
        value.authorizationApiKeyValue = try reader["authorizationApiKeyValue"].readIfPresent()
...
extension ListDataLakeExceptionsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListDataLakeExceptionsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListDataLakesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListDataLakesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListLogSourcesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListLogSourcesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListSubscribersOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListSubscribersOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SecurityLakeClientTypes.LogSource {
    ...
    static func write(value: SecurityLakeClientTypes.LogSource?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["account"].write(value.account)
        try writer["region"].write(value.region)
        try writer["sources"].writeList(value.sources, memberWritingClosure: SecurityLakeClientTypes.LogSourceResource.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension SecurityLakeClientTypes.NotificationConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecurityLakeClientTypes.NotificationConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        let name = reader.children.filter { $0.hasContent && $0.nodeInfo.name != "__type" }.first?.nodeInfo.name
        switch name {
            case "sqsNotificationConfiguration":
                return .sqsnotificationconfiguration(try reader["sqsNotificationConfiguration"].read(with: SecurityLakeClientTypes.SqsNotificationConfiguration.read(from:)))
            case "httpsNotificationConfiguration":
                return .httpsnotificationconfiguration(try reader["httpsNotificationConfiguration"].read(with: SecurityLakeClientTypes.HttpsNotificationConfiguration.read(from:)))
            default:
                return .sdkUnknown(name ?? "")
        }
    }
...
extension RegisterDataLakeDelegatedAdministratorOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> RegisterDataLakeDelegatedAdministratorOutput {
...
extension SecurityLakeClientTypes.SqsNotificationConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecurityLakeClientTypes.SqsNotificationConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        return SecurityLakeClientTypes.SqsNotificationConfiguration()
    }
}
...
extension SecurityLakeClientTypes.SubscriberResource {
    ...
    static func write(value: SecurityLakeClientTypes.SubscriberResource?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["accessTypes"].writeList(value.accessTypes, memberWritingClosure: SecurityLakeClientTypes.AccessType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["s3BucketArn"].write(value.s3BucketArn)
        try writer["sources"].writeList(value.sources, memberWritingClosure: SecurityLakeClientTypes.LogSourceResource.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["subscriberArn"].write(value.subscriberArn)
        try writer["subscriberDescription"].write(value.subscriberDescription)
        try writer["subscriberEndpoint"].write(value.subscriberEndpoint)
        try writer["subscriberId"].write(value.subscriberId)
        try writer["subscriberIdentity"].write(value.subscriberIdentity, with: SecurityLakeClientTypes.AwsIdentity.write(value:to:))
        try writer["subscriberName"].write(value.subscriberName)
        try writer["subscriberStatus"].write(value.subscriberStatus)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecurityLakeClientTypes.SubscriberResource {
        ...
        value.sources = try reader["sources"].readListIfPresent(memberReadingClosure: SecurityLakeClientTypes.LogSourceResource.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.accessTypes = try reader["accessTypes"].readListIfPresent(memberReadingClosure: SecurityLakeClientTypes.AccessType.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.roleArn = try reader["roleArn"].readIfPresent()
        value.s3BucketArn = try reader["s3BucketArn"].readIfPresent()
        value.subscriberEndpoint = try reader["subscriberEndpoint"].readIfPresent()
...
extension UpdateDataLakeExceptionSubscriptionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateDataLakeExceptionSubscriptionOutput {
...
extension UpdateDataLakeOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateDataLakeOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateSubscriberNotificationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateSubscriberNotificationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateSubscriberOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateSubscriberOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
