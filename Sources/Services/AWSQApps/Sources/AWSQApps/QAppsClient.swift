...
public final class QAppsClient: AWSClientRuntime.AWSServiceClient {
    ...
    public let config: QAppsClient.QAppsClientConfig
    let serviceName = "QApps"

    @available(*, deprecated, message: "Use QAppsClient.QAppsClientConfig instead")
    public typealias Config = QAppsClient.QAppsClientConfiguration
    public typealias Configuration = QAppsClient.QAppsClientConfig

    public required init(config: QAppsClient.QAppsClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: QAppsClient.QAppsClientConfig) instead")
    public convenience init(config: QAppsClient.QAppsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try QAppsClient.QAppsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await QAppsClient.QAppsClientConfig()
        self.init(config: config)
    }
}
...
extension QAppsClient {
    ...
    /// Client configuration for QAppsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct QAppsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "QApps")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultQAppsAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: QAppsClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use QAppsClientConfig instead. This class will be removed in a future version.")
    public final class QAppsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> QAppsClientConfig {
            return try QAppsClientConfig(
...
extension QAppsClient {
    ...
    public func associateLibraryItemReview(input: AssociateLibraryItemReviewInput) async throws -> AssociateLibraryItemReviewOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "QApps"))
