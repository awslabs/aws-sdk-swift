...
class EndpointResolverTest: XCTestCase {
    ...
    func testResolve1() throws {
        ...
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://ingest.timestream-fips.us-east-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve3() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://ingest.timestream.us-east-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve11() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://ingest.timestream-fips.us-gov-east-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve13() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://ingest.timestream.us-gov-east-1.api.aws", headers: headers, properties: properties)
