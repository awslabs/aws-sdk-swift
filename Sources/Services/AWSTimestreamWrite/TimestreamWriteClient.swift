...
extension TimestreamWriteClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> TimestreamWriteClient.TimestreamWriteClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> TimestreamWriteClient {
            let configuration = try await resolve(plugins: self.plugins)
            return TimestreamWriteClient(config: configuration)
        }
    }
...
extension TimestreamWriteClient.TimestreamWriteClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
