...
public final class TimestreamWriteClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: TimestreamWriteClient.TimestreamWriteClientConfig) instead")
    public convenience init(config: TimestreamWriteClient.TimestreamWriteClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try TimestreamWriteClient.TimestreamWriteClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await TimestreamWriteClient.TimestreamWriteClientConfig()
        self.init(config: config)
    }
}
...
extension TimestreamWriteClient {
    ...
    /// Client configuration for TimestreamWriteClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct TimestreamWriteClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Timestream Write")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: TimestreamWriteClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultTimestreamWriteAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use TimestreamWriteClientConfig instead. This class will be removed in a future version.")
    public final class TimestreamWriteClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> TimestreamWriteClientConfig {
            return try TimestreamWriteClientConfig(
...
extension TimestreamWriteClient {
    /// Performs the `CreateBatchLoadTask` operation on the `TimestreamWrite` service.
    ///
    ...
    public func createBatchLoadTask(input: CreateBatchLoadTaskInput) async throws -> CreateBatchLoadTaskOutput {
        ...
        let operation = TimestreamWriteClient.createBatchLoadTaskOperation
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Timestream Write", config.ignoreConfiguredEndpointURLs)
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Timestream Write"))
    ...
    /// Performs the `CreateDatabase` operation on the `TimestreamWrite` service.
    ///
    ...
    public func createDatabase(input: CreateDatabaseInput) async throws -> CreateDatabaseOutput {
        ...
        let operation = TimestreamWriteClient.createDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `CreateTable` operation on the `TimestreamWrite` service.
    ///
    ...
    public func createTable(input: CreateTableInput) async throws -> CreateTableOutput {
        ...
        let operation = TimestreamWriteClient.createTableOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteDatabase` operation on the `TimestreamWrite` service.
    ///
    ...
    public func deleteDatabase(input: DeleteDatabaseInput) async throws -> DeleteDatabaseOutput {
        ...
        let operation = TimestreamWriteClient.deleteDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteTable` operation on the `TimestreamWrite` service.
    ///
    ...
    public func deleteTable(input: DeleteTableInput) async throws -> DeleteTableOutput {
        ...
        let operation = TimestreamWriteClient.deleteTableOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeBatchLoadTask` operation on the `TimestreamWrite` service.
    ///
    ...
    public func describeBatchLoadTask(input: DescribeBatchLoadTaskInput) async throws -> DescribeBatchLoadTaskOutput {
        ...
        let operation = TimestreamWriteClient.describeBatchLoadTaskOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeDatabase` operation on the `TimestreamWrite` service.
    ///
    ...
    public func describeDatabase(input: DescribeDatabaseInput) async throws -> DescribeDatabaseOutput {
        ...
        let operation = TimestreamWriteClient.describeDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeEndpoints` operation on the `TimestreamWrite` service.
    ///
    ...
    public func describeEndpoints(input: DescribeEndpointsInput) async throws -> DescribeEndpointsOutput {
        ...
        let operation = TimestreamWriteClient.describeEndpointsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeTable` operation on the `TimestreamWrite` service.
    ///
    ...
    public func describeTable(input: DescribeTableInput) async throws -> DescribeTableOutput {
        ...
        let operation = TimestreamWriteClient.describeTableOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListBatchLoadTasks` operation on the `TimestreamWrite` service.
    ///
    ...
    public func listBatchLoadTasks(input: ListBatchLoadTasksInput) async throws -> ListBatchLoadTasksOutput {
        ...
        let operation = TimestreamWriteClient.listBatchLoadTasksOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListDatabases` operation on the `TimestreamWrite` service.
    ///
    ...
    public func listDatabases(input: ListDatabasesInput) async throws -> ListDatabasesOutput {
        ...
        let operation = TimestreamWriteClient.listDatabasesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListTables` operation on the `TimestreamWrite` service.
    ///
    ...
    public func listTables(input: ListTablesInput) async throws -> ListTablesOutput {
        ...
        let operation = TimestreamWriteClient.listTablesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListTagsForResource` operation on the `TimestreamWrite` service.
    ///
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput {
        ...
        let operation = TimestreamWriteClient.listTagsForResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ResumeBatchLoadTask` operation on the `TimestreamWrite` service.
    ///
    ///
    ///
    ...
    public func resumeBatchLoadTask(input: ResumeBatchLoadTaskInput) async throws -> ResumeBatchLoadTaskOutput {
        ...
        let operation = TimestreamWriteClient.resumeBatchLoadTaskOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `TagResource` operation on the `TimestreamWrite` service.
    ///
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput {
        ...
        let operation = TimestreamWriteClient.tagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UntagResource` operation on the `TimestreamWrite` service.
    ///
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput {
        ...
        let operation = TimestreamWriteClient.untagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UpdateDatabase` operation on the `TimestreamWrite` service.
    ///
    ...
    public func updateDatabase(input: UpdateDatabaseInput) async throws -> UpdateDatabaseOutput {
        ...
        let operation = TimestreamWriteClient.updateDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UpdateTable` operation on the `TimestreamWrite` service.
    ///
    ...
    public func updateTable(input: UpdateTableInput) async throws -> UpdateTableOutput {
        ...
        let operation = TimestreamWriteClient.updateTableOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `WriteRecords` operation on the `TimestreamWrite` service.
    ///
    ...
    public func writeRecords(input: WriteRecordsInput) async throws -> WriteRecordsOutput {
        ...
        let operation = TimestreamWriteClient.writeRecordsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
