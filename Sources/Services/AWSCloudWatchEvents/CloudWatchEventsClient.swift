...
extension CloudWatchEventsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CloudWatchEventsClient.CloudWatchEventsClientConfiguration {
        let clientConfiguration = try await CloudWatchEventsClient.CloudWatchEventsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CloudWatchEventsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CloudWatchEventsClient(config: configuration)
        }
    }
...
extension CloudWatchEventsClient.CloudWatchEventsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
