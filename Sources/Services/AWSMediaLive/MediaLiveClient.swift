...
extension MediaLiveClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MediaLiveClient.MediaLiveClientConfiguration {
        let clientConfiguration = try await MediaLiveClient.MediaLiveClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MediaLiveClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MediaLiveClient(config: configuration)
        }
    }
...
extension MediaLiveClient.MediaLiveClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
