...
extension SecretsManagerClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SecretsManagerClient.SecretsManagerClientConfiguration {
        let clientConfiguration = try await SecretsManagerClient.SecretsManagerClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SecretsManagerClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SecretsManagerClient(config: configuration)
        }
    }
...
extension SecretsManagerClient.SecretsManagerClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
