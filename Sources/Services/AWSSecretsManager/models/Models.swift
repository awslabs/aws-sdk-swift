...
extension BatchGetSecretValueInput {
    ...
    static func write(value: BatchGetSecretValueInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["SecretIdList"].writeList(value.secretIdList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DeleteSecretOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteSecretOutput {
        ...
        value.arn = try reader["ARN"].readIfPresent()
        value.deletionDate = try reader["DeletionDate"].readTimestampIfPresent(format: .epochSeconds)
        value.name = try reader["Name"].readIfPresent()
        return value
    }
}
...
extension DescribeSecretOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeSecretOutput {
        ...
        value.deletedDate = try reader["DeletedDate"].readTimestampIfPresent(format: .epochSeconds)
        value.description = try reader["Description"].readIfPresent()
        value.kmsKeyId = try reader["KmsKeyId"].readIfPresent()
        value.lastAccessedDate = try reader["LastAccessedDate"].readTimestampIfPresent(format: .epochSeconds)
        value.lastChangedDate = try reader["LastChangedDate"].readTimestampIfPresent(format: .epochSeconds)
        value.lastRotatedDate = try reader["LastRotatedDate"].readTimestampIfPresent(format: .epochSeconds)
        value.name = try reader["Name"].readIfPresent()
        value.nextRotationDate = try reader["NextRotationDate"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.versionIdsToStages = try reader["VersionIdsToStages"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension GetSecretValueOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetSecretValueOutput {
        ...
        value.versionId = try reader["VersionId"].readIfPresent()
        value.versionStages = try reader["VersionStages"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension RemoveRegionsFromReplicationInput {
    ...
    static func write(value: RemoveRegionsFromReplicationInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["RemoveReplicaRegions"].writeList(value.removeReplicaRegions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SecretId"].write(value.secretId)
    }
}
...
extension SecretsManagerClientTypes.SecretListEntry {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecretsManagerClientTypes.SecretListEntry {
        ...
        value.nextRotationDate = try reader["NextRotationDate"].readTimestampIfPresent(format: .epochSeconds)
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: SecretsManagerClientTypes.Tag.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.secretVersionsToStages = try reader["SecretVersionsToStages"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.owningService = try reader["OwningService"].readIfPresent()
        value.createdDate = try reader["CreatedDate"].readTimestampIfPresent(format: .epochSeconds)
        value.primaryRegion = try reader["PrimaryRegion"].readIfPresent()
        return value
...
extension SecretsManagerClientTypes.SecretVersionsListEntry {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SecretsManagerClientTypes.SecretVersionsListEntry {
        ...
        value.lastAccessedDate = try reader["LastAccessedDate"].readTimestampIfPresent(format: .epochSeconds)
        value.createdDate = try reader["CreatedDate"].readTimestampIfPresent(format: .epochSeconds)
        value.kmsKeyIds = try reader["KmsKeyIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
