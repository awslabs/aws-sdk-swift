...
extension MediaConvertClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MediaConvertClient.MediaConvertClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> MediaConvertClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MediaConvertClient(config: configuration)
        }
    }
...
extension MediaConvertClient.MediaConvertClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
