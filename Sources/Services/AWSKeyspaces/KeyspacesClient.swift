...
extension KeyspacesClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> KeyspacesClient.KeyspacesClientConfiguration {
        let clientConfiguration = try await KeyspacesClient.KeyspacesClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> KeyspacesClient {
            let configuration = try await resolve(plugins: self.plugins)
            return KeyspacesClient(config: configuration)
        }
    }
...
extension KeyspacesClient.KeyspacesClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
