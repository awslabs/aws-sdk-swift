...
extension AddPermissionInput {
    ...
    static func write(value: AddPermissionInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["AWSAccountId"].writeList(value.awsAccountId, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ActionName"].writeList(value.actionName, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension ListPhoneNumbersOptedOutOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListPhoneNumbersOptedOutOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.phoneNumbers = try reader["phoneNumbers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SNSClientTypes.PhoneNumberInformation {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> SNSClientTypes.PhoneNumberInformation {
        ...
        value.numberCapabilities = try reader["NumberCapabilities"].readListIfPresent(memberReadingClosure: SNSClientTypes.NumberCapability.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
