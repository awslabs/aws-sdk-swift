...
extension AddPermissionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AddPermissionOutput {
        let reader = responseReader["AddPermissionResult"]
...
extension SNSClientTypes.BatchResultErrorEntry: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.BatchResultErrorEntry {
...
extension CheckIfPhoneNumberIsOptedOutOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CheckIfPhoneNumberIsOptedOutOutput {
...
extension ConfirmSubscriptionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ConfirmSubscriptionOutput {
...
extension CreatePlatformApplicationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreatePlatformApplicationOutput {
...
extension CreatePlatformEndpointOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreatePlatformEndpointOutput {
...
extension CreateSMSSandboxPhoneNumberOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateSMSSandboxPhoneNumberOutput {
        let reader = responseReader["CreateSMSSandboxPhoneNumberResult"]
        var value = CreateSMSSandboxPhoneNumberOutput()
        return value
    }
}
...
extension CreateTopicOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateTopicOutput {
...
extension DeleteEndpointOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteEndpointOutput {
        let reader = responseReader["DeleteEndpointResult"]
...
extension DeletePlatformApplicationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeletePlatformApplicationOutput {
        let reader = responseReader["DeletePlatformApplicationResult"]
        var value = DeletePlatformApplicationOutput()
        return value
    }
}
...
extension DeleteSMSSandboxPhoneNumberOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteSMSSandboxPhoneNumberOutput {
        let reader = responseReader["DeleteSMSSandboxPhoneNumberResult"]
        var value = DeleteSMSSandboxPhoneNumberOutput()
        return value
    }
}
...
extension DeleteTopicOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteTopicOutput {
        let reader = responseReader["DeleteTopicResult"]
...
extension SNSClientTypes.Endpoint: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.Endpoint {
        var value = SNSClientTypes.Endpoint()
        value.endpointArn = try reader["EndpointArn"].readIfPresent()
        value.attributes = try reader["Attributes"].readMapIfPresent(valueReadingClosure: Swift.String.readingClosure(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension GetDataProtectionPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetDataProtectionPolicyOutput {
...
extension GetEndpointAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetEndpointAttributesOutput {
...
extension GetPlatformApplicationAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetPlatformApplicationAttributesOutput {
...
extension GetSMSAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetSMSAttributesOutput {
...
extension GetSMSSandboxAccountStatusOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetSMSSandboxAccountStatusOutput {
...
extension GetSubscriptionAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetSubscriptionAttributesOutput {
...
extension GetTopicAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetTopicAttributesOutput {
...
extension ListEndpointsByPlatformApplicationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListEndpointsByPlatformApplicationOutput {
        let reader = responseReader["ListEndpointsByPlatformApplicationResult"]
        var value = ListEndpointsByPlatformApplicationOutput()
        value.endpoints = try reader["Endpoints"].readListIfPresent(memberReadingClosure: SNSClientTypes.Endpoint.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ListOriginationNumbersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListOriginationNumbersOutput {
        let reader = responseReader["ListOriginationNumbersResult"]
        var value = ListOriginationNumbersOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.phoneNumbers = try reader["PhoneNumbers"].readListIfPresent(memberReadingClosure: SNSClientTypes.PhoneNumberInformation.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListPhoneNumbersOptedOutOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListPhoneNumbersOptedOutOutput {
        let reader = responseReader["ListPhoneNumbersOptedOutResult"]
        var value = ListPhoneNumbersOptedOutOutput()
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.phoneNumbers = try reader["phoneNumbers"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListPlatformApplicationsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListPlatformApplicationsOutput {
        let reader = responseReader["ListPlatformApplicationsResult"]
        var value = ListPlatformApplicationsOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.platformApplications = try reader["PlatformApplications"].readListIfPresent(memberReadingClosure: SNSClientTypes.PlatformApplication.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListSMSSandboxPhoneNumbersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListSMSSandboxPhoneNumbersOutput {
        let reader = responseReader["ListSMSSandboxPhoneNumbersResult"]
        var value = ListSMSSandboxPhoneNumbersOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.phoneNumbers = try reader["PhoneNumbers"].readListIfPresent(memberReadingClosure: SNSClientTypes.SMSSandboxPhoneNumber.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListSubscriptionsByTopicOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListSubscriptionsByTopicOutput {
        let reader = responseReader["ListSubscriptionsByTopicResult"]
        var value = ListSubscriptionsByTopicOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.subscriptions = try reader["Subscriptions"].readListIfPresent(memberReadingClosure: SNSClientTypes.Subscription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListSubscriptionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListSubscriptionsOutput {
...
extension ListTagsForResourceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListTagsForResourceOutput {
        ...
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: SNSClientTypes.Tag.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListTopicsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListTopicsOutput {
        let reader = responseReader["ListTopicsResult"]
        var value = ListTopicsOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.topics = try reader["Topics"].readListIfPresent(memberReadingClosure: SNSClientTypes.Topic.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SNSClientTypes.MessageAttributeValue: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.MessageAttributeValue {
...
extension OptInPhoneNumberOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> OptInPhoneNumberOutput {
        let reader = responseReader["OptInPhoneNumberResult"]
        var value = OptInPhoneNumberOutput()
        return value
    }
}
...
extension SNSClientTypes.PhoneNumberInformation: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.PhoneNumberInformation {
        ...
        value.numberCapabilities = try reader["NumberCapabilities"].readListIfPresent(memberReadingClosure: SNSClientTypes.NumberCapability.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SNSClientTypes.PlatformApplication: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.PlatformApplication {
...
extension PublishBatchOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PublishBatchOutput {
        let reader = responseReader["PublishBatchResult"]
        var value = PublishBatchOutput()
        value.failed = try reader["Failed"].readListIfPresent(memberReadingClosure: SNSClientTypes.BatchResultErrorEntry.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.successful = try reader["Successful"].readListIfPresent(memberReadingClosure: SNSClientTypes.PublishBatchResultEntry.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SNSClientTypes.PublishBatchRequestEntry: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.PublishBatchRequestEntry {
        ...
        value.messageAttributes = try reader["MessageAttributes"].readMapIfPresent(valueReadingClosure: SNSClientTypes.MessageAttributeValue.readingClosure(from:), keyNodeInfo: "Name", valueNodeInfo: "Value", isFlattened: false)
...
extension SNSClientTypes.PublishBatchResultEntry: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.PublishBatchResultEntry {
...
extension PublishOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PublishOutput {
...
extension PutDataProtectionPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutDataProtectionPolicyOutput {
        let reader = responseReader["PutDataProtectionPolicyResult"]
...
extension RemovePermissionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RemovePermissionOutput {
        let reader = responseReader["RemovePermissionResult"]
...
extension SNSClientTypes.SMSSandboxPhoneNumber: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.SMSSandboxPhoneNumber {
...
extension SetEndpointAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetEndpointAttributesOutput {
        let reader = responseReader["SetEndpointAttributesResult"]
        var value = SetEndpointAttributesOutput()
        return value
    }
}
...
extension SetPlatformApplicationAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetPlatformApplicationAttributesOutput {
        let reader = responseReader["SetPlatformApplicationAttributesResult"]
        var value = SetPlatformApplicationAttributesOutput()
        return value
    }
}
...
extension SetSMSAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetSMSAttributesOutput {
        let reader = responseReader["SetSMSAttributesResult"]
        var value = SetSMSAttributesOutput()
        return value
    }
}
...
extension SetSubscriptionAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetSubscriptionAttributesOutput {
        let reader = responseReader["SetSubscriptionAttributesResult"]
        var value = SetSubscriptionAttributesOutput()
        return value
    }
}
...
extension SetTopicAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetTopicAttributesOutput {
        let reader = responseReader["SetTopicAttributesResult"]
        var value = SetTopicAttributesOutput()
        return value
    }
}
...
extension SubscribeOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SubscribeOutput {
...
extension SNSClientTypes.Subscription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.Subscription {
...
extension SNSClientTypes.Tag: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.Tag {
...
extension SNSClientTypes.Topic: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> SNSClientTypes.Topic {
...
extension UnsubscribeOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UnsubscribeOutput {
        let reader = responseReader["UnsubscribeResult"]
...
extension VerifySMSSandboxPhoneNumberOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> VerifySMSSandboxPhoneNumberOutput {
        let reader = responseReader["VerifySMSSandboxPhoneNumberResult"]
        var value = VerifySMSSandboxPhoneNumberOutput()
        return value
    }
}
