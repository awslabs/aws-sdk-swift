...
extension SNSClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SNSClient.SNSClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> SNSClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SNSClient(config: configuration)
        }
    }
...
extension SNSClient.SNSClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
