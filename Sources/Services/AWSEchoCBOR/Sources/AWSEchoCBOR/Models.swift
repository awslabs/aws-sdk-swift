...
extension EchoCBORClientTypes {
    ...
    public struct ComplexStructure: Swift.Sendable {
        ...
        @Indirect public var complexStructMember: EchoCBORClientTypes.ComplexStructure?
        public var doubleMember: Swift.Double?
        public var floatMember: Swift.Float?
        public var integerMember: Swift.Int?
        public var listOfComplexObjectMember: [EchoCBORClientTypes.ComplexStructure]?
        ...
        public init(
            ...
            complexStructMember: EchoCBORClientTypes.ComplexStructure? = nil,
            doubleMember: Swift.Double? = nil,
            floatMember: Swift.Float? = nil,
            integerMember: Swift.Int? = nil,
            listOfComplexObjectMember: [EchoCBORClientTypes.ComplexStructure]? = nil,
...
public struct EchoOperationInput: Swift.Sendable {
    public var blobMember: Foundation.Data?
    public var booleanMember: Swift.Bool?
    public var complexStructMember: EchoCBORClientTypes.ComplexStructure?
    public var doubleMember: Swift.Double?
    public var floatMember: Swift.Float?
    public var integerMember: Swift.Int?
    public var listOfComplexObjectMember: [EchoCBORClientTypes.ComplexStructure]?
...
extension EchoOperationInput {
    ...
    static func urlPathProvider(_ value: EchoOperationInput) -> Swift.String? {
        return "/service/EchoService/operation/EchoOperation"
    }
}

extension EchoOperationInput {

    static func write(value: EchoOperationInput?, to writer: SmithyCBOR.Writer) throws {
        guard let value else { return }
        try writer["blobMember"].write(value.blobMember)
        try writer["booleanMember"].write(value.booleanMember)
        try writer["complexStructMember"].write(value.complexStructMember, with: EchoCBORClientTypes.ComplexStructure.write(value:to:))
        ...
        try writer["listOfComplexObjectMember"].writeList(value.listOfComplexObjectMember, memberWritingClosure: EchoCBORClientTypes.ComplexStructure.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension EchoOperationOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> EchoOperationOutput {
        ...
        value.complexStructMember = try reader["complexStructMember"].readIfPresent(with: EchoCBORClientTypes.ComplexStructure.read(from:))
        ...
        value.listOfComplexObjectMember = try reader["listOfComplexObjectMember"].readListIfPresent(memberReadingClosure: EchoCBORClientTypes.ComplexStructure.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension EchoCBORClientTypes.ComplexStructure {

    static func write(value: EchoCBORClientTypes.ComplexStructure?, to writer: SmithyCBOR.Writer) throws {
        guard let value else { return }
        try writer["blobMember"].write(value.blobMember)
        try writer["booleanMember"].write(value.booleanMember)
        try writer["complexStructMember"].write(value.complexStructMember, with: EchoCBORClientTypes.ComplexStructure.write(value:to:))
    ...
    static func read(from reader: SmithyCBOR.Reader) throws -> EchoCBORClientTypes.ComplexStructure {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = EchoCBORClientTypes.ComplexStructure()
        value.booleanMember = try reader["booleanMember"].readIfPresent()
        value.stringMember = try reader["stringMember"].readIfPresent()
        value.integerMember = try reader["integerMember"].readIfPresent()
        value.longMember = try reader["longMember"].readIfPresent()
...
public enum EchoCBORClientTypes {}
