...
extension BedrockClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> BedrockClient.BedrockClientConfiguration {
        let clientConfiguration = try await BedrockClient.BedrockClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> BedrockClient {
            let configuration = try await resolve(plugins: self.plugins)
            return BedrockClient(config: configuration)
        }
    }
...
extension BedrockClient.BedrockClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
