...
public struct BedrockAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol BedrockAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
