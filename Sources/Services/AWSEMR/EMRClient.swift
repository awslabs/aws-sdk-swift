...
extension EMRClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> EMRClient.EMRClientConfiguration {
        let clientConfiguration = try await EMRClient.EMRClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> EMRClient {
            let configuration = try await resolve(plugins: self.plugins)
            return EMRClient(config: configuration)
        }
    }
...
extension EMRClient.EMRClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
