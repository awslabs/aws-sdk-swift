...
extension MemoryDBClientTypes {
    ...
    public enum AZStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case multiaz
        case singleaz
...
extension CreateClusterInput {
    ...
    static func write(value: CreateClusterInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["SnapshotArns"].writeList(value.snapshotArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeServiceUpdatesInput {
    ...
    static func write(value: DescribeServiceUpdatesInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Status"].writeList(value.status, memberWritingClosure: MemoryDBClientTypes.ServiceUpdateStatus.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ResetParameterGroupInput {
    ...
    static func write(value: ResetParameterGroupInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ParameterGroupName"].write(value.parameterGroupName)
        try writer["ParameterNames"].writeList(value.parameterNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ListAllowedNodeTypeUpdatesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAllowedNodeTypeUpdatesOutput {
        ...
        value.scaleDownNodeTypes = try reader["ScaleDownNodeTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.scaleUpNodeTypes = try reader["ScaleUpNodeTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension MemoryDBClientTypes.ShardDetail {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MemoryDBClientTypes.ShardDetail {
        ...
        value.snapshotCreationTime = try reader["SnapshotCreationTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension MemoryDBClientTypes.ACLPendingChanges {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MemoryDBClientTypes.ACLPendingChanges {
        ...
        value.userNamesToRemove = try reader["UserNamesToRemove"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.userNamesToAdd = try reader["UserNamesToAdd"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension MemoryDBClientTypes.User {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MemoryDBClientTypes.User {
        ...
        value.aclNames = try reader["ACLNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.minimumEngineVersion = try reader["MinimumEngineVersion"].readIfPresent()
...
extension MemoryDBClientTypes.ServiceUpdate {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MemoryDBClientTypes.ServiceUpdate {
        ...
        value.clusterName = try reader["ClusterName"].readIfPresent()
        value.serviceUpdateName = try reader["ServiceUpdateName"].readIfPresent()
        value.releaseDate = try reader["ReleaseDate"].readTimestampIfPresent(format: .epochSeconds)
        value.description = try reader["Description"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
        value.type = try reader["Type"].readIfPresent()
        value.nodesUpdated = try reader["NodesUpdated"].readIfPresent()
        value.autoUpdateStartDate = try reader["AutoUpdateStartDate"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
