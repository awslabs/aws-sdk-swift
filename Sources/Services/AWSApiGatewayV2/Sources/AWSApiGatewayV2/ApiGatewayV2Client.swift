...
public final class ApiGatewayV2Client: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "ApiGatewayV2Client"
    let client: ClientRuntime.SdkHttpClient
    public let config: ApiGatewayV2Client.ApiGatewayV2ClientConfig
    let serviceName = "ApiGatewayV2"

    @available(*, deprecated, message: "Use ApiGatewayV2Client.ApiGatewayV2ClientConfig instead")
    public typealias Config = ApiGatewayV2Client.ApiGatewayV2ClientConfiguration
    public typealias Configuration = ApiGatewayV2Client.ApiGatewayV2ClientConfig

    public required init(config: ApiGatewayV2Client.ApiGatewayV2ClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: ApiGatewayV2Client.ApiGatewayV2ClientConfig) instead")
    public convenience init(config: ApiGatewayV2Client.ApiGatewayV2ClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ApiGatewayV2Client.ApiGatewayV2ClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ApiGatewayV2Client.ApiGatewayV2ClientConfig()
        self.init(config: config)
    }
}
...
extension ApiGatewayV2Client {
    ...
    /// Client configuration for ApiGatewayV2Client
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ApiGatewayV2ClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "ApiGatewayV2")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ApiGatewayV2Client.clientName)
        }
    ...
    @available(*, deprecated, message: "Use ApiGatewayV2ClientConfig instead. This class will be removed in a future version.")
    public final class ApiGatewayV2ClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ApiGatewayV2ClientConfig {
            return try ApiGatewayV2ClientConfig(
...
extension ApiGatewayV2Client {
    ...
    public func createApi(input: CreateApiInput) async throws -> CreateApiOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ApiGatewayV2"))
