...
extension CreateApiOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateApiOutput {
        ...
        value.importInfo = try reader["importInfo"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateAuthorizerOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateAuthorizerOutput {
        ...
        value.identitySource = try reader["identitySource"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateIntegrationOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateIntegrationOutput {
        ...
        value.requestParameters = try reader["requestParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.requestTemplates = try reader["requestTemplates"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.responseParameters = try reader["responseParameters"].readMapIfPresent(valueReadingClosure: mapReadingClosure(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension CreateIntegrationResponseOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateIntegrationResponseOutput {
        ...
        value.responseParameters = try reader["responseParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.responseTemplates = try reader["responseTemplates"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.templateSelectionExpression = try reader["templateSelectionExpression"].readIfPresent()
        return value
    }
}
...
extension CreateRouteOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateRouteOutput {
        ...
        value.authorizationScopes = try reader["authorizationScopes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.requestModels = try reader["requestModels"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension CreateRouteResponseOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateRouteResponseOutput {
        ...
        value.modelSelectionExpression = try reader["modelSelectionExpression"].readIfPresent()
        value.responseModels = try reader["responseModels"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension CreateStageOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateStageOutput {
        ...
        value.stageVariables = try reader["stageVariables"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension ApiGatewayV2ClientTypes.Cors {
    ...
    static func write(value: ApiGatewayV2ClientTypes.Cors?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["allowHeaders"].writeList(value.allowHeaders, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["allowMethods"].writeList(value.allowMethods, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["allowOrigins"].writeList(value.allowOrigins, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["exposeHeaders"].writeList(value.exposeHeaders, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ApiGatewayV2ClientTypes.Cors {
        ...
        value.allowHeaders = try reader["allowHeaders"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.allowMethods = try reader["allowMethods"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.allowOrigins = try reader["allowOrigins"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.exposeHeaders = try reader["exposeHeaders"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ApiGatewayV2ClientTypes.JWTConfiguration {
    ...
    static func write(value: ApiGatewayV2ClientTypes.JWTConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["audience"].writeList(value.audience, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ApiGatewayV2ClientTypes.JWTConfiguration {
        ...
        value.audience = try reader["audience"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ApiGatewayV2ClientTypes.DomainNameConfiguration {
    ...
    static func write(value: ApiGatewayV2ClientTypes.DomainNameConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["certificateUploadDate"].writeTimestamp(value.certificateUploadDate, format: .dateTime)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ApiGatewayV2ClientTypes.DomainNameConfiguration {
        ...
        value.certificateUploadDate = try reader["certificateUploadDate"].readTimestampIfPresent(format: .dateTime)
...
extension ApiGatewayV2ClientTypes.MutualTlsAuthentication {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ApiGatewayV2ClientTypes.MutualTlsAuthentication {
        ...
        value.truststoreWarnings = try reader["truststoreWarnings"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
