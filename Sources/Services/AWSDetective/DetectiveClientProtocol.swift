...
public protocol DetectiveClientProtocol {
    ...
    /// - `TooManyRequestsException` : The request cannot be completed because too many other requests are occurring at the same time.
    /// - `ValidationException` : The request parameters are invalid.
    func getInvestigation(input: GetInvestigationInput) async throws -> GetInvestigationOutput
    ...
    /// - `TooManyRequestsException` : The request cannot be completed because too many other requests are occurring at the same time.
    /// - `ValidationException` : The request parameters are invalid.
    func listIndicators(input: ListIndicatorsInput) async throws -> ListIndicatorsOutput
    ...
    /// - `TooManyRequestsException` : The request cannot be completed because too many other requests are occurring at the same time.
    /// - `ValidationException` : The request parameters are invalid.
    func listInvestigations(input: ListInvestigationsInput) async throws -> ListInvestigationsOutput
    ...
    /// - `TooManyRequestsException` : The request cannot be completed because too many other requests are occurring at the same time.
    /// - `ValidationException` : The request parameters are invalid.
    func startInvestigation(input: StartInvestigationInput) async throws -> StartInvestigationOutput
    ...
    /// - `TooManyRequestsException` : The request cannot be completed because too many other requests are occurring at the same time.
    /// - `ValidationException` : The request parameters are invalid.
    func updateInvestigationState(input: UpdateInvestigationStateInput) async throws -> UpdateInvestigationStateOutput
