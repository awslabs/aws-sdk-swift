...
extension DetectiveClientTypes.Administrator {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DetectiveClientTypes.Administrator {
        ...
        value.delegationTime = try reader["DelegationTime"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
...
extension BatchGetGraphMemberDatasourcesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchGetGraphMemberDatasourcesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
...
extension BatchGetMembershipDatasourcesInput {
    ...
    static func write(value: BatchGetMembershipDatasourcesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["GraphArns"].writeList(value.graphArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension BatchGetMembershipDatasourcesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchGetMembershipDatasourcesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DetectiveClientTypes.DatasourcePackageUsageInfo {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DetectiveClientTypes.DatasourcePackageUsageInfo {
        ...
        value.volumeUsageUpdateTime = try reader["VolumeUsageUpdateTime"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
...
extension DisassociateMembershipOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DisassociateMembershipOutput {
...
extension GetInvestigationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetInvestigationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        ...
        value.scopeEndTime = try reader["ScopeEndTime"].readTimestampIfPresent(format: .dateTime)
        value.scopeStartTime = try reader["ScopeStartTime"].readTimestampIfPresent(format: .dateTime)
...
extension ListDatasourcePackagesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListDatasourcePackagesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListIndicatorsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListIndicatorsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListInvestigationsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListInvestigationsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DetectiveClientTypes.MemberDetail {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DetectiveClientTypes.MemberDetail {
        ...
        value.invitedTime = try reader["InvitedTime"].readTimestampIfPresent(format: .dateTime)
        value.updatedTime = try reader["UpdatedTime"].readTimestampIfPresent(format: .dateTime)
        value.volumeUsageInBytes = try reader["VolumeUsageInBytes"].readIfPresent()
        value.volumeUsageUpdatedTime = try reader["VolumeUsageUpdatedTime"].readTimestampIfPresent(format: .dateTime)
        value.percentOfGraphUtilization = try reader["PercentOfGraphUtilization"].readIfPresent()
        value.percentOfGraphUtilizationUpdatedTime = try reader["PercentOfGraphUtilizationUpdatedTime"].readTimestampIfPresent(format: .dateTime)
        ...
        value.datasourcePackageIngestStates = try reader["DatasourcePackageIngestStates"].readMapIfPresent(valueReadingClosure: DetectiveClientTypes.DatasourcePackageIngestState.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension ServiceQuotaExceededException {
    ...
    static func makeError(baseError: AWSClientRuntime.RestJSONError) throws -> ServiceQuotaExceededException {
        ...
        value.properties.message = try reader["Message"].readIfPresent()
        value.properties.resources = try reader["Resources"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.httpResponse = baseError.httpResponse
        value.requestID = baseError.requestID
        value.message = baseError.message
        return value
...
extension StartInvestigationInput {
    ...
    static func write(value: StartInvestigationInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["EntityArn"].write(value.entityArn)
        try writer["GraphArn"].write(value.graphArn)
        try writer["ScopeEndTime"].writeTimestamp(value.scopeEndTime, format: .dateTime)
        try writer["ScopeStartTime"].writeTimestamp(value.scopeStartTime, format: .dateTime)
    }
}
...
extension StartInvestigationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> StartInvestigationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension StartMonitoringMemberOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> StartMonitoringMemberOutput {
...
extension UpdateDatasourcePackagesInput {
    ...
    static func write(value: UpdateDatasourcePackagesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DatasourcePackages"].writeList(value.datasourcePackages, memberWritingClosure: DetectiveClientTypes.DatasourcePackage.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["GraphArn"].write(value.graphArn)
    }
}
...
extension UpdateDatasourcePackagesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateDatasourcePackagesOutput {
...
extension UpdateInvestigationStateOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateInvestigationStateOutput {
