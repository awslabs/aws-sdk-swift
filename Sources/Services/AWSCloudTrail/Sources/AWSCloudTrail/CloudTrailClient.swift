...
public final class CloudTrailClient: AWSClientRuntime.AWSServiceClient, Sendable {
...
extension CloudTrailClient {
    ...
    public final class CloudTrailClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, @unchecked Sendable {
...
extension CloudTrailClient {
    ...
    public func getEventConfiguration(input: GetEventConfigurationInput) async throws -> GetEventConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetEventConfigurationInput, GetEventConfigurationOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GetEventConfigurationInput, GetEventConfigurationOutput>(GetEventConfigurationInput.urlPathProvider(_:)))
    ...
    public func putEventConfiguration(input: PutEventConfigurationInput) async throws -> PutEventConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<PutEventConfigurationInput, PutEventConfigurationOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<PutEventConfigurationInput, PutEventConfigurationOutput>(PutEventConfigurationInput.urlPathProvider(_:)))
    ...
    public func searchSampleQueries(input: SearchSampleQueriesInput) async throws -> SearchSampleQueriesOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<SearchSampleQueriesInput, SearchSampleQueriesOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<SearchSampleQueriesInput, SearchSampleQueriesOutput>(SearchSampleQueriesInput.urlPathProvider(_:)))
    ...
    public func startDashboardRefresh(input: StartDashboardRefreshInput) async throws -> StartDashboardRefreshOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<StartDashboardRefreshInput, StartDashboardRefreshOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<StartDashboardRefreshInput, StartDashboardRefreshOutput>(StartDashboardRefreshInput.urlPathProvider(_:)))
