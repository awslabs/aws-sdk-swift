...
extension DescribeTrailsInput {
    ...
    static func write(value: DescribeTrailsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["trailNameList"].writeList(value.trailNameList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ListTagsInput {
    ...
    static func write(value: ListTagsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["NextToken"].write(value.nextToken)
        try writer["ResourceIdList"].writeList(value.resourceIdList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension StartImportInput {
    ...
    static func write(value: StartImportInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["EndEventTime"].writeTimestamp(value.endEventTime, format: .epochSeconds)
        try writer["ImportId"].write(value.importId)
        try writer["ImportSource"].write(value.importSource, with: CloudTrailClientTypes.ImportSource.write(value:to:))
        try writer["StartEventTime"].writeTimestamp(value.startEventTime, format: .epochSeconds)
    }
}
...
extension StartQueryInput {
    ...
    static func write(value: StartQueryInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["QueryAlias"].write(value.queryAlias)
        try writer["QueryParameters"].writeList(value.queryParameters, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateEventDataStoreOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateEventDataStoreOutput {
        ...
        value.updatedTimestamp = try reader["UpdatedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension GetImportOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetImportOutput {
        ...
        value.createdTimestamp = try reader["CreatedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.destinations = try reader["Destinations"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.endEventTime = try reader["EndEventTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.startEventTime = try reader["StartEventTime"].readTimestampIfPresent(format: .epochSeconds)
        value.updatedTimestamp = try reader["UpdatedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension GetQueryResultsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetQueryResultsOutput {
        ...
        value.queryResultRows = try reader["QueryResultRows"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: mapReadingClosure(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
...
extension GetTrailStatusOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetTrailStatusOutput {
        ...
        value.latestCloudWatchLogsDeliveryTime = try reader["LatestCloudWatchLogsDeliveryTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.latestDeliveryTime = try reader["LatestDeliveryTime"].readTimestampIfPresent(format: .epochSeconds)
        value.latestDigestDeliveryError = try reader["LatestDigestDeliveryError"].readIfPresent()
        value.latestDigestDeliveryTime = try reader["LatestDigestDeliveryTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.latestNotificationTime = try reader["LatestNotificationTime"].readTimestampIfPresent(format: .epochSeconds)
        value.startLoggingTime = try reader["StartLoggingTime"].readTimestampIfPresent(format: .epochSeconds)
        value.stopLoggingTime = try reader["StopLoggingTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension ListInsightsMetricDataOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListInsightsMetricDataOutput {
        ...
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.timestamps = try reader["Timestamps"].readListIfPresent(memberReadingClosure: timestampReadingClosure(format: .epochSeconds), memberNodeInfo: "member", isFlattened: false)
        value.values = try reader["Values"].readListIfPresent(memberReadingClosure: Swift.Double.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudTrailClientTypes.AdvancedFieldSelector {
    ...
    static func write(value: CloudTrailClientTypes.AdvancedFieldSelector?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["EndsWith"].writeList(value.endsWith, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["NotEndsWith"].writeList(value.notEndsWith, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["NotStartsWith"].writeList(value.notStartsWith, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["StartsWith"].writeList(value.startsWith, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudTrailClientTypes.AdvancedFieldSelector {
        ...
        value.startsWith = try reader["StartsWith"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.endsWith = try reader["EndsWith"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.notStartsWith = try reader["NotStartsWith"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.notEndsWith = try reader["NotEndsWith"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudTrailClientTypes.IngestionStatus {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudTrailClientTypes.IngestionStatus {
        ...
        value.latestIngestionSuccessTime = try reader["LatestIngestionSuccessTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.latestIngestionAttemptTime = try reader["LatestIngestionAttemptTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension CloudTrailClientTypes.EventSelector {
    ...
    static func write(value: CloudTrailClientTypes.EventSelector?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ExcludeManagementEventSources"].writeList(value.excludeManagementEventSources, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudTrailClientTypes.EventSelector {
        ...
        value.excludeManagementEventSources = try reader["ExcludeManagementEventSources"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudTrailClientTypes.PublicKey {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudTrailClientTypes.PublicKey {
        ...
        value.value = try reader["Value"].readIfPresent()
        value.validityStartTime = try reader["ValidityStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.validityEndTime = try reader["ValidityEndTime"].readTimestampIfPresent(format: .epochSeconds)
