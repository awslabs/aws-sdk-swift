...
extension SageMakerA2IRuntimeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfiguration {
        let clientConfiguration = try await SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SageMakerA2IRuntimeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SageMakerA2IRuntimeClient(config: configuration)
        }
    }
...
extension SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
