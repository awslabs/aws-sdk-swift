...
public final class SageMakerA2IRuntimeClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "SageMakerA2IRuntimeClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfig
    let serviceName = "SageMaker A2I Runtime"

    @available(*, deprecated, message: "Use SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfig instead")
    public typealias Config = SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfiguration
    public typealias Configuration = SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfig

    public required init(config: SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfig) instead")
    public convenience init(config: SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await SageMakerA2IRuntimeClient.SageMakerA2IRuntimeClientConfig()
        self.init(config: config)
    }
}
...
extension SageMakerA2IRuntimeClient {
    ...
    /// Client configuration for SageMakerA2IRuntimeClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct SageMakerA2IRuntimeClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "SageMaker A2I Runtime")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultSageMakerA2IRuntimeAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: SageMakerA2IRuntimeClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultSageMakerA2IRuntimeAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use SageMakerA2IRuntimeClientConfig instead. This class will be removed in a future version.")
    public final class SageMakerA2IRuntimeClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> SageMakerA2IRuntimeClientConfig {
            return try SageMakerA2IRuntimeClientConfig(
...
extension SageMakerA2IRuntimeClient {
    ...
    public func deleteHumanLoop(input: DeleteHumanLoopInput) async throws -> DeleteHumanLoopOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("SageMaker A2I Runtime", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteHumanLoopOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SageMaker A2I Runtime"))
    ...
    public func describeHumanLoop(input: DescribeHumanLoopInput) async throws -> DescribeHumanLoopOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeHumanLoopOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func listHumanLoops(input: ListHumanLoopsInput) async throws -> ListHumanLoopsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListHumanLoopsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func startHumanLoop(input: StartHumanLoopInput) async throws -> StartHumanLoopOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<StartHumanLoopOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func stopHumanLoop(input: StopHumanLoopInput) async throws -> StopHumanLoopOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<StopHumanLoopOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
