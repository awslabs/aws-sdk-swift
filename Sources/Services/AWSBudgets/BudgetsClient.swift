...
extension BudgetsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> BudgetsClient.BudgetsClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> BudgetsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return BudgetsClient(config: configuration)
        }
    }
...
extension BudgetsClient.BudgetsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
