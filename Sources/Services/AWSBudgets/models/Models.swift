...
extension BudgetsClientTypes.Action {
    ...
    static func write(value: BudgetsClientTypes.Action?, to writer: SmithyJSON.Writer) throws {
...
extension BudgetsClientTypes.ActionHistory {
    ...
    static func write(value: BudgetsClientTypes.ActionHistory?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ActionHistoryDetails"].write(value.actionHistoryDetails, with: BudgetsClientTypes.ActionHistoryDetails.write(value:to:))
...
extension BudgetsClientTypes.ActionHistoryDetails {
    ...
    static func write(value: BudgetsClientTypes.ActionHistoryDetails?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Action"].write(value.action, with: BudgetsClientTypes.Action.write(value:to:))
...
extension BudgetsClientTypes.Budget {
    ...
    static func write(value: BudgetsClientTypes.Budget?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["CostFilters"].writeMap(value.costFilters, valueWritingClosure: listWritingClosure(memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BudgetsClientTypes.Budget {
        ...
        value.costFilters = try reader["CostFilters"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension BudgetsClientTypes.BudgetNotificationsForAccount {
    ...
    static func write(value: BudgetsClientTypes.BudgetNotificationsForAccount?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["BudgetName"].write(value.budgetName)
        try writer["Notifications"].writeList(value.notifications, memberWritingClosure: BudgetsClientTypes.Notification.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
...
extension BudgetsClientTypes.BudgetPerformanceHistory {
    ...
    static func write(value: BudgetsClientTypes.BudgetPerformanceHistory?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["BudgetName"].write(value.budgetName)
        try writer["BudgetType"].write(value.budgetType)
        try writer["BudgetedAndActualAmountsList"].writeList(value.budgetedAndActualAmountsList, memberWritingClosure: BudgetsClientTypes.BudgetedAndActualAmounts.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["CostFilters"].writeMap(value.costFilters, valueWritingClosure: listWritingClosure(memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["CostTypes"].write(value.costTypes, with: BudgetsClientTypes.CostTypes.write(value:to:))
        try writer["TimeUnit"].write(value.timeUnit)
    }
...
extension BudgetsClientTypes.BudgetedAndActualAmounts {
    ...
    static func write(value: BudgetsClientTypes.BudgetedAndActualAmounts?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ActualAmount"].write(value.actualAmount, with: BudgetsClientTypes.Spend.write(value:to:))
        try writer["BudgetedAmount"].write(value.budgetedAmount, with: BudgetsClientTypes.Spend.write(value:to:))
        try writer["TimePeriod"].write(value.timePeriod, with: BudgetsClientTypes.TimePeriod.write(value:to:))
    }
...
extension CreateBudgetActionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateBudgetActionOutput {
...
extension CreateNotificationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateNotificationOutput {
...
extension DeleteBudgetActionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteBudgetActionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteNotificationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteNotificationOutput {
...
extension DescribeBudgetActionHistoriesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeBudgetActionHistoriesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeBudgetActionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeBudgetActionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeBudgetActionsForAccountOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeBudgetActionsForAccountOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeBudgetActionsForBudgetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeBudgetActionsForBudgetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeBudgetNotificationsForAccountOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeBudgetNotificationsForAccountOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeBudgetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeBudgetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeBudgetPerformanceHistoryOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeBudgetPerformanceHistoryOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeBudgetsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeBudgetsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeNotificationsForBudgetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeNotificationsForBudgetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeSubscribersForNotificationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeSubscribersForNotificationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ExecuteBudgetActionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ExecuteBudgetActionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension BudgetsClientTypes.IamActionDefinition {
    ...
    static func write(value: BudgetsClientTypes.IamActionDefinition?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Roles"].writeList(value.roles, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Users"].writeList(value.users, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BudgetsClientTypes.IamActionDefinition {
        ...
        value.roles = try reader["Roles"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.users = try reader["Users"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BudgetsClientTypes.NotificationWithSubscribers {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BudgetsClientTypes.NotificationWithSubscribers {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = BudgetsClientTypes.NotificationWithSubscribers()
        value.notification = try reader["Notification"].readIfPresent(with: BudgetsClientTypes.Notification.read(from:))
        value.subscribers = try reader["Subscribers"].readListIfPresent(memberReadingClosure: BudgetsClientTypes.Subscriber.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension UpdateBudgetActionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateBudgetActionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension UpdateNotificationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateNotificationOutput {
