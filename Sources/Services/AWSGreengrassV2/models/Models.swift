...
extension GreengrassV2ClientTypes.AssociatedClientDevice {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GreengrassV2ClientTypes.AssociatedClientDevice {
        ...
        value.thingName = try reader["thingName"].readIfPresent()
        value.associationTimestamp = try reader["associationTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension BatchAssociateClientDeviceWithCoreDeviceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchAssociateClientDeviceWithCoreDeviceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension BatchDisassociateClientDeviceFromCoreDeviceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchDisassociateClientDeviceFromCoreDeviceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CancelDeploymentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CancelDeploymentOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GreengrassV2ClientTypes.CloudComponentStatus {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GreengrassV2ClientTypes.CloudComponentStatus {
        ...
        value.message = try reader["message"].readIfPresent()
        value.errors = try reader["errors"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GreengrassV2ClientTypes.ComponentConfigurationUpdate {
    ...
    static func write(value: GreengrassV2ClientTypes.ComponentConfigurationUpdate?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["reset"].writeList(value.reset, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GreengrassV2ClientTypes.ComponentConfigurationUpdate {
        ...
        value.reset = try reader["reset"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GreengrassV2ClientTypes.CoreDevice {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GreengrassV2ClientTypes.CoreDevice {
        ...
        value.lastStatusUpdateTimestamp = try reader["lastStatusUpdateTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension CreateComponentVersionOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateComponentVersionOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteCoreDeviceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteCoreDeviceOutput {
...
extension GreengrassV2ClientTypes.EffectiveDeployment {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GreengrassV2ClientTypes.EffectiveDeployment {
        ...
        value.creationTimestamp = try reader["creationTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.modifiedTimestamp = try reader["modifiedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
...
extension GreengrassV2ClientTypes.EffectiveDeploymentStatusDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GreengrassV2ClientTypes.EffectiveDeploymentStatusDetails {
        ...
        value.errorStack = try reader["errorStack"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.errorTypes = try reader["errorTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetComponentVersionArtifactOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetComponentVersionArtifactOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetCoreDeviceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetCoreDeviceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GreengrassV2ClientTypes.InstalledComponent {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GreengrassV2ClientTypes.InstalledComponent {
        ...
        value.lastStatusChangeTimestamp = try reader["lastStatusChangeTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.lastReportedTimestamp = try reader["lastReportedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.lastInstallationSource = try reader["lastInstallationSource"].readIfPresent()
        value.lifecycleStatusCodes = try reader["lifecycleStatusCodes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GreengrassV2ClientTypes.LambdaExecutionParameters {
    ...
    static func write(value: GreengrassV2ClientTypes.LambdaExecutionParameters?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["execArgs"].writeList(value.execArgs, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension ListClientDevicesAssociatedWithCoreDeviceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListClientDevicesAssociatedWithCoreDeviceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListComponentVersionsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListComponentVersionsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListCoreDevicesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCoreDevicesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListEffectiveDeploymentsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListEffectiveDeploymentsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListInstalledComponentsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListInstalledComponentsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ResolveComponentCandidatesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ResolveComponentCandidatesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
