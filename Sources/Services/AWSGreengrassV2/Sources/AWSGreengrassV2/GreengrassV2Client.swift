...
extension GreengrassV2Client {
    ...
    public func batchAssociateClientDeviceWithCoreDevice(input: BatchAssociateClientDeviceWithCoreDeviceInput) async throws -> BatchAssociateClientDeviceWithCoreDeviceOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<BatchAssociateClientDeviceWithCoreDeviceInput, BatchAssociateClientDeviceWithCoreDeviceOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<BatchAssociateClientDeviceWithCoreDeviceInput, BatchAssociateClientDeviceWithCoreDeviceOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<BatchAssociateClientDeviceWithCoreDeviceInput, BatchAssociateClientDeviceWithCoreDeviceOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func batchDisassociateClientDeviceFromCoreDevice(input: BatchDisassociateClientDeviceFromCoreDeviceInput) async throws -> BatchDisassociateClientDeviceFromCoreDeviceOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<BatchDisassociateClientDeviceFromCoreDeviceInput, BatchDisassociateClientDeviceFromCoreDeviceOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<BatchDisassociateClientDeviceFromCoreDeviceInput, BatchDisassociateClientDeviceFromCoreDeviceOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<BatchDisassociateClientDeviceFromCoreDeviceInput, BatchDisassociateClientDeviceFromCoreDeviceOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func cancelDeployment(input: CancelDeploymentInput) async throws -> CancelDeploymentOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CancelDeploymentInput, CancelDeploymentOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CancelDeploymentInput, CancelDeploymentOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CancelDeploymentInput, CancelDeploymentOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createComponentVersion(input: CreateComponentVersionInput) async throws -> CreateComponentVersionOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateComponentVersionInput, CreateComponentVersionOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateComponentVersionInput, CreateComponentVersionOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateComponentVersionInput, CreateComponentVersionOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func deleteCoreDevice(input: DeleteCoreDeviceInput) async throws -> DeleteCoreDeviceOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteCoreDeviceInput, DeleteCoreDeviceOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteCoreDeviceInput, DeleteCoreDeviceOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteCoreDeviceInput, DeleteCoreDeviceOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getComponentVersionArtifact(input: GetComponentVersionArtifactInput) async throws -> GetComponentVersionArtifactOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetComponentVersionArtifactInput, GetComponentVersionArtifactOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetComponentVersionArtifactInput, GetComponentVersionArtifactOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetComponentVersionArtifactInput, GetComponentVersionArtifactOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getCoreDevice(input: GetCoreDeviceInput) async throws -> GetCoreDeviceOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetCoreDeviceInput, GetCoreDeviceOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetCoreDeviceInput, GetCoreDeviceOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetCoreDeviceInput, GetCoreDeviceOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func listClientDevicesAssociatedWithCoreDevice(input: ListClientDevicesAssociatedWithCoreDeviceInput) async throws -> ListClientDevicesAssociatedWithCoreDeviceOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListClientDevicesAssociatedWithCoreDeviceInput, ListClientDevicesAssociatedWithCoreDeviceOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListClientDevicesAssociatedWithCoreDeviceInput, ListClientDevicesAssociatedWithCoreDeviceOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListClientDevicesAssociatedWithCoreDeviceInput, ListClientDevicesAssociatedWithCoreDeviceOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func listComponentVersions(input: ListComponentVersionsInput) async throws -> ListComponentVersionsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListComponentVersionsInput, ListComponentVersionsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListComponentVersionsInput, ListComponentVersionsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListComponentVersionsInput, ListComponentVersionsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func listCoreDevices(input: ListCoreDevicesInput) async throws -> ListCoreDevicesOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListCoreDevicesInput, ListCoreDevicesOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListCoreDevicesInput, ListCoreDevicesOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListCoreDevicesInput, ListCoreDevicesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func listEffectiveDeployments(input: ListEffectiveDeploymentsInput) async throws -> ListEffectiveDeploymentsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListEffectiveDeploymentsInput, ListEffectiveDeploymentsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListEffectiveDeploymentsInput, ListEffectiveDeploymentsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListEffectiveDeploymentsInput, ListEffectiveDeploymentsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func listInstalledComponents(input: ListInstalledComponentsInput) async throws -> ListInstalledComponentsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListInstalledComponentsInput, ListInstalledComponentsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListInstalledComponentsInput, ListInstalledComponentsOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListInstalledComponentsInput, ListInstalledComponentsOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func resolveComponentCandidates(input: ResolveComponentCandidatesInput) async throws -> ResolveComponentCandidatesOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ResolveComponentCandidatesInput, ResolveComponentCandidatesOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ResolveComponentCandidatesInput, ResolveComponentCandidatesOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ResolveComponentCandidatesInput, ResolveComponentCandidatesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
