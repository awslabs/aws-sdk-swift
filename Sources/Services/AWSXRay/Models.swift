...
extension BatchGetTracesInput {
    ...
    static func write(value: BatchGetTracesInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["TraceIds"].writeList(value.traceIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetInsightSummariesInput {
    ...
    static func write(value: GetInsightSummariesInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["NextToken"].write(value.nextToken)
        try writer["StartTime"].writeTimestamp(value.startTime, format: .epochSeconds)
        try writer["States"].writeList(value.states, memberWritingClosure: XRayClientTypes.InsightState.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension PutTraceSegmentsInput {
    ...
    static func write(value: PutTraceSegmentsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["TraceSegmentDocuments"].writeList(value.traceSegmentDocuments, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension BatchGetTracesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchGetTracesOutput {
        ...
        value.unprocessedTraceIds = try reader["UnprocessedTraceIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetInsightImpactGraphOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetInsightImpactGraphOutput {
        ...
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.serviceGraphEndTime = try reader["ServiceGraphEndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.serviceGraphStartTime = try reader["ServiceGraphStartTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension GetSamplingTargetsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetSamplingTargetsOutput {
        ...
        value.lastRuleModification = try reader["LastRuleModification"].readTimestampIfPresent(format: .epochSeconds)
...
extension GetTraceSummariesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetTraceSummariesOutput {
        ...
        value.approximateTime = try reader["ApproximateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.nextToken = try reader["NextToken"].readIfPresent()
...
extension XRayClientTypes.Insight {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> XRayClientTypes.Insight {
        ...
        value.categories = try reader["Categories"].readListIfPresent(memberReadingClosure: XRayClientTypes.InsightCategory.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension XRayClientTypes.SamplingTargetDocument {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> XRayClientTypes.SamplingTargetDocument {
        ...
        value.reservoirQuotaTTL = try reader["ReservoirQuotaTTL"].readTimestampIfPresent(format: .epochSeconds)
...
extension XRayClientTypes.TraceSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> XRayClientTypes.TraceSummary {
        ...
        value.annotations = try reader["Annotations"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: XRayClientTypes.ValueWithServiceIds.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        ...
        value.matchedEventTime = try reader["MatchedEventTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
