...
extension IoTFleetHubClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> IoTFleetHubClient.IoTFleetHubClientConfiguration {
        let clientConfiguration = try await IoTFleetHubClient.IoTFleetHubClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> IoTFleetHubClient {
            let configuration = try await resolve(plugins: self.plugins)
            return IoTFleetHubClient(config: configuration)
        }
    }
...
extension IoTFleetHubClient.IoTFleetHubClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
