...
extension RbinClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> RbinClient.RbinClientConfiguration {
        let clientConfiguration = try await RbinClient.RbinClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> RbinClient {
            let configuration = try await resolve(plugins: self.plugins)
            return RbinClient(config: configuration)
        }
    }
...
extension RbinClient.RbinClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
