...
extension OdbClient {
    ...
    public struct OdbClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "odb")
...
extension OdbClient {
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `CreateAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `CreateAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func createAutonomousDatabase(input: CreateAutonomousDatabaseInput) async throws -> CreateAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.createAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "createAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.IdempotencyTokenMiddleware<CreateAutonomousDatabaseInput, CreateAutonomousDatabaseOutput>(keyPath: \.clientToken))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<CreateAutonomousDatabaseInput, CreateAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<CreateAutonomousDatabaseInput, CreateAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<CreateAutonomousDatabaseInput, CreateAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<CreateAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateAutonomousDatabaseInput, CreateAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.CreateAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<CreateAutonomousDatabaseInput, CreateAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<CreateAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<CreateAutonomousDatabaseInput, CreateAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<CreateAutonomousDatabaseInput, CreateAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateAutonomousDatabaseInput, CreateAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "CreateAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `CreateAutonomousDatabaseBackup` operation on the `Odb` service.
    ///
    /// Creates a new backup of the specified Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `CreateAutonomousDatabaseBackupInput`)
    ///
    /// - Returns: [no documentation found] (Type: `CreateAutonomousDatabaseBackupOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func createAutonomousDatabaseBackup(input: CreateAutonomousDatabaseBackupInput) async throws -> CreateAutonomousDatabaseBackupOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.createAutonomousDatabaseBackupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "createAutonomousDatabaseBackup")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.IdempotencyTokenMiddleware<CreateAutonomousDatabaseBackupInput, CreateAutonomousDatabaseBackupOutput>(keyPath: \.clientToken))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<CreateAutonomousDatabaseBackupInput, CreateAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<CreateAutonomousDatabaseBackupInput, CreateAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<CreateAutonomousDatabaseBackupInput, CreateAutonomousDatabaseBackupOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<CreateAutonomousDatabaseBackupOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateAutonomousDatabaseBackupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateAutonomousDatabaseBackupInput, CreateAutonomousDatabaseBackupOutput>(overrides: ["X-Amz-Target": "Odb.CreateAutonomousDatabaseBackup"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<CreateAutonomousDatabaseBackupInput, CreateAutonomousDatabaseBackupOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<CreateAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<CreateAutonomousDatabaseBackupInput, CreateAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<CreateAutonomousDatabaseBackupInput, CreateAutonomousDatabaseBackupOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateAutonomousDatabaseBackupInput, CreateAutonomousDatabaseBackupOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "CreateAutonomousDatabaseBackup")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `CreateAutonomousDatabaseWallet` operation on the `Odb` service.
    ///
    /// Creates a new wallet for the specified Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `CreateAutonomousDatabaseWalletInput`)
    ///
    /// - Returns: [no documentation found] (Type: `CreateAutonomousDatabaseWalletOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func createAutonomousDatabaseWallet(input: CreateAutonomousDatabaseWalletInput) async throws -> CreateAutonomousDatabaseWalletOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.createAutonomousDatabaseWalletOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "createAutonomousDatabaseWallet")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.IdempotencyTokenMiddleware<CreateAutonomousDatabaseWalletInput, CreateAutonomousDatabaseWalletOutput>(keyPath: \.clientToken))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<CreateAutonomousDatabaseWalletInput, CreateAutonomousDatabaseWalletOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<CreateAutonomousDatabaseWalletInput, CreateAutonomousDatabaseWalletOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<CreateAutonomousDatabaseWalletInput, CreateAutonomousDatabaseWalletOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<CreateAutonomousDatabaseWalletOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateAutonomousDatabaseWalletOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateAutonomousDatabaseWalletInput, CreateAutonomousDatabaseWalletOutput>(overrides: ["X-Amz-Target": "Odb.CreateAutonomousDatabaseWallet"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<CreateAutonomousDatabaseWalletInput, CreateAutonomousDatabaseWalletOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<CreateAutonomousDatabaseWalletOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<CreateAutonomousDatabaseWalletInput, CreateAutonomousDatabaseWalletOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<CreateAutonomousDatabaseWalletInput, CreateAutonomousDatabaseWalletOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateAutonomousDatabaseWalletInput, CreateAutonomousDatabaseWalletOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "CreateAutonomousDatabaseWallet")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `DeleteAutonomousDatabase` operation on the `Odb` service.
    ///
    /// Deletes the specified Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `DeleteAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func deleteAutonomousDatabase(input: DeleteAutonomousDatabaseInput) async throws -> DeleteAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.deleteAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DeleteAutonomousDatabaseInput, DeleteAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<DeleteAutonomousDatabaseInput, DeleteAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<DeleteAutonomousDatabaseInput, DeleteAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<DeleteAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteAutonomousDatabaseInput, DeleteAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.DeleteAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DeleteAutonomousDatabaseInput, DeleteAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DeleteAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DeleteAutonomousDatabaseInput, DeleteAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DeleteAutonomousDatabaseInput, DeleteAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAutonomousDatabaseInput, DeleteAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DeleteAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `DeleteAutonomousDatabaseBackup` operation on the `Odb` service.
    ///
    /// Deletes the specified Autonomous Database backup.
    ///
    /// - Parameter input: [no documentation found] (Type: `DeleteAutonomousDatabaseBackupInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteAutonomousDatabaseBackupOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func deleteAutonomousDatabaseBackup(input: DeleteAutonomousDatabaseBackupInput) async throws -> DeleteAutonomousDatabaseBackupOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.deleteAutonomousDatabaseBackupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteAutonomousDatabaseBackup")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DeleteAutonomousDatabaseBackupInput, DeleteAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<DeleteAutonomousDatabaseBackupInput, DeleteAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<DeleteAutonomousDatabaseBackupInput, DeleteAutonomousDatabaseBackupOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<DeleteAutonomousDatabaseBackupOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAutonomousDatabaseBackupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteAutonomousDatabaseBackupInput, DeleteAutonomousDatabaseBackupOutput>(overrides: ["X-Amz-Target": "Odb.DeleteAutonomousDatabaseBackup"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DeleteAutonomousDatabaseBackupInput, DeleteAutonomousDatabaseBackupOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DeleteAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DeleteAutonomousDatabaseBackupInput, DeleteAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DeleteAutonomousDatabaseBackupInput, DeleteAutonomousDatabaseBackupOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAutonomousDatabaseBackupInput, DeleteAutonomousDatabaseBackupOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DeleteAutonomousDatabaseBackup")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `FailoverAutonomousDatabase` operation on the `Odb` service.
    ///
    /// Initiates a failover of the specified Autonomous Database to a standby peer database.
    ///
    /// - Parameter input: [no documentation found] (Type: `FailoverAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `FailoverAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func failoverAutonomousDatabase(input: FailoverAutonomousDatabaseInput) async throws -> FailoverAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.failoverAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "failoverAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<FailoverAutonomousDatabaseInput, FailoverAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<FailoverAutonomousDatabaseInput, FailoverAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<FailoverAutonomousDatabaseInput, FailoverAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<FailoverAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<FailoverAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<FailoverAutonomousDatabaseInput, FailoverAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.FailoverAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<FailoverAutonomousDatabaseInput, FailoverAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<FailoverAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<FailoverAutonomousDatabaseInput, FailoverAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<FailoverAutonomousDatabaseInput, FailoverAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<FailoverAutonomousDatabaseInput, FailoverAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "FailoverAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `GetAutonomousDatabase` operation on the `Odb` service.
    ///
    /// Gets information about a specific Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `GetAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `GetAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func getAutonomousDatabase(input: GetAutonomousDatabaseInput) async throws -> GetAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.getAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetAutonomousDatabaseInput, GetAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetAutonomousDatabaseInput, GetAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetAutonomousDatabaseInput, GetAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<GetAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetAutonomousDatabaseInput, GetAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.GetAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetAutonomousDatabaseInput, GetAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetAutonomousDatabaseInput, GetAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetAutonomousDatabaseInput, GetAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAutonomousDatabaseInput, GetAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `GetAutonomousDatabaseBackup` operation on the `Odb` service.
    ///
    /// Gets information about a specific Autonomous Database backup.
    ///
    /// - Parameter input: [no documentation found] (Type: `GetAutonomousDatabaseBackupInput`)
    ///
    /// - Returns: [no documentation found] (Type: `GetAutonomousDatabaseBackupOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func getAutonomousDatabaseBackup(input: GetAutonomousDatabaseBackupInput) async throws -> GetAutonomousDatabaseBackupOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.getAutonomousDatabaseBackupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getAutonomousDatabaseBackup")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetAutonomousDatabaseBackupInput, GetAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetAutonomousDatabaseBackupInput, GetAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetAutonomousDatabaseBackupInput, GetAutonomousDatabaseBackupOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<GetAutonomousDatabaseBackupOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAutonomousDatabaseBackupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetAutonomousDatabaseBackupInput, GetAutonomousDatabaseBackupOutput>(overrides: ["X-Amz-Target": "Odb.GetAutonomousDatabaseBackup"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetAutonomousDatabaseBackupInput, GetAutonomousDatabaseBackupOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetAutonomousDatabaseBackupInput, GetAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetAutonomousDatabaseBackupInput, GetAutonomousDatabaseBackupOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAutonomousDatabaseBackupInput, GetAutonomousDatabaseBackupOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetAutonomousDatabaseBackup")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `GetAutonomousDatabaseWalletDetails` operation on the `Odb` service.
    ///
    /// Gets the wallet details for the specified Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `GetAutonomousDatabaseWalletDetailsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `GetAutonomousDatabaseWalletDetailsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func getAutonomousDatabaseWalletDetails(input: GetAutonomousDatabaseWalletDetailsInput) async throws -> GetAutonomousDatabaseWalletDetailsOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.getAutonomousDatabaseWalletDetailsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getAutonomousDatabaseWalletDetails")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetAutonomousDatabaseWalletDetailsInput, GetAutonomousDatabaseWalletDetailsOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetAutonomousDatabaseWalletDetailsInput, GetAutonomousDatabaseWalletDetailsOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetAutonomousDatabaseWalletDetailsInput, GetAutonomousDatabaseWalletDetailsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<GetAutonomousDatabaseWalletDetailsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetAutonomousDatabaseWalletDetailsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetAutonomousDatabaseWalletDetailsInput, GetAutonomousDatabaseWalletDetailsOutput>(overrides: ["X-Amz-Target": "Odb.GetAutonomousDatabaseWalletDetails"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetAutonomousDatabaseWalletDetailsInput, GetAutonomousDatabaseWalletDetailsOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetAutonomousDatabaseWalletDetailsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetAutonomousDatabaseWalletDetailsInput, GetAutonomousDatabaseWalletDetailsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetAutonomousDatabaseWalletDetailsInput, GetAutonomousDatabaseWalletDetailsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAutonomousDatabaseWalletDetailsInput, GetAutonomousDatabaseWalletDetailsOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetAutonomousDatabaseWalletDetails")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListAutonomousDatabaseBackups` operation on the `Odb` service.
    ///
    /// Lists the backups of the specified Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `ListAutonomousDatabaseBackupsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListAutonomousDatabaseBackupsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func listAutonomousDatabaseBackups(input: ListAutonomousDatabaseBackupsInput) async throws -> ListAutonomousDatabaseBackupsOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.listAutonomousDatabaseBackupsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listAutonomousDatabaseBackups")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListAutonomousDatabaseBackupsInput, ListAutonomousDatabaseBackupsOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListAutonomousDatabaseBackupsInput, ListAutonomousDatabaseBackupsOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListAutonomousDatabaseBackupsInput, ListAutonomousDatabaseBackupsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<ListAutonomousDatabaseBackupsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAutonomousDatabaseBackupsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListAutonomousDatabaseBackupsInput, ListAutonomousDatabaseBackupsOutput>(overrides: ["X-Amz-Target": "Odb.ListAutonomousDatabaseBackups"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListAutonomousDatabaseBackupsInput, ListAutonomousDatabaseBackupsOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListAutonomousDatabaseBackupsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListAutonomousDatabaseBackupsInput, ListAutonomousDatabaseBackupsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListAutonomousDatabaseBackupsInput, ListAutonomousDatabaseBackupsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAutonomousDatabaseBackupsInput, ListAutonomousDatabaseBackupsOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListAutonomousDatabaseBackups")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListAutonomousDatabaseCharacterSets` operation on the `Odb` service.
    ///
    /// Lists the available character sets for Autonomous Databases.
    ///
    /// - Parameter input: [no documentation found] (Type: `ListAutonomousDatabaseCharacterSetsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListAutonomousDatabaseCharacterSetsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func listAutonomousDatabaseCharacterSets(input: ListAutonomousDatabaseCharacterSetsInput) async throws -> ListAutonomousDatabaseCharacterSetsOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.listAutonomousDatabaseCharacterSetsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listAutonomousDatabaseCharacterSets")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListAutonomousDatabaseCharacterSetsInput, ListAutonomousDatabaseCharacterSetsOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListAutonomousDatabaseCharacterSetsInput, ListAutonomousDatabaseCharacterSetsOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListAutonomousDatabaseCharacterSetsInput, ListAutonomousDatabaseCharacterSetsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<ListAutonomousDatabaseCharacterSetsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAutonomousDatabaseCharacterSetsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListAutonomousDatabaseCharacterSetsInput, ListAutonomousDatabaseCharacterSetsOutput>(overrides: ["X-Amz-Target": "Odb.ListAutonomousDatabaseCharacterSets"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListAutonomousDatabaseCharacterSetsInput, ListAutonomousDatabaseCharacterSetsOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListAutonomousDatabaseCharacterSetsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListAutonomousDatabaseCharacterSetsInput, ListAutonomousDatabaseCharacterSetsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListAutonomousDatabaseCharacterSetsInput, ListAutonomousDatabaseCharacterSetsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAutonomousDatabaseCharacterSetsInput, ListAutonomousDatabaseCharacterSetsOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListAutonomousDatabaseCharacterSets")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListAutonomousDatabaseClones` operation on the `Odb` service.
    ///
    /// Lists the clones of the specified Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `ListAutonomousDatabaseClonesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListAutonomousDatabaseClonesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func listAutonomousDatabaseClones(input: ListAutonomousDatabaseClonesInput) async throws -> ListAutonomousDatabaseClonesOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.listAutonomousDatabaseClonesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listAutonomousDatabaseClones")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListAutonomousDatabaseClonesInput, ListAutonomousDatabaseClonesOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListAutonomousDatabaseClonesInput, ListAutonomousDatabaseClonesOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListAutonomousDatabaseClonesInput, ListAutonomousDatabaseClonesOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<ListAutonomousDatabaseClonesOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAutonomousDatabaseClonesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListAutonomousDatabaseClonesInput, ListAutonomousDatabaseClonesOutput>(overrides: ["X-Amz-Target": "Odb.ListAutonomousDatabaseClones"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListAutonomousDatabaseClonesInput, ListAutonomousDatabaseClonesOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListAutonomousDatabaseClonesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListAutonomousDatabaseClonesInput, ListAutonomousDatabaseClonesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListAutonomousDatabaseClonesInput, ListAutonomousDatabaseClonesOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAutonomousDatabaseClonesInput, ListAutonomousDatabaseClonesOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListAutonomousDatabaseClones")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListAutonomousDatabasePeers` operation on the `Odb` service.
    ///
    /// Lists the peer databases of the specified Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `ListAutonomousDatabasePeersInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListAutonomousDatabasePeersOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func listAutonomousDatabasePeers(input: ListAutonomousDatabasePeersInput) async throws -> ListAutonomousDatabasePeersOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.listAutonomousDatabasePeersOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listAutonomousDatabasePeers")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListAutonomousDatabasePeersInput, ListAutonomousDatabasePeersOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListAutonomousDatabasePeersInput, ListAutonomousDatabasePeersOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListAutonomousDatabasePeersInput, ListAutonomousDatabasePeersOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<ListAutonomousDatabasePeersOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAutonomousDatabasePeersOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListAutonomousDatabasePeersInput, ListAutonomousDatabasePeersOutput>(overrides: ["X-Amz-Target": "Odb.ListAutonomousDatabasePeers"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListAutonomousDatabasePeersInput, ListAutonomousDatabasePeersOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListAutonomousDatabasePeersOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListAutonomousDatabasePeersInput, ListAutonomousDatabasePeersOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListAutonomousDatabasePeersInput, ListAutonomousDatabasePeersOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAutonomousDatabasePeersInput, ListAutonomousDatabasePeersOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListAutonomousDatabasePeers")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListAutonomousDatabaseVersions` operation on the `Odb` service.
    ///
    /// Lists the available Oracle Database software versions for Autonomous Databases.
    ///
    /// - Parameter input: [no documentation found] (Type: `ListAutonomousDatabaseVersionsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListAutonomousDatabaseVersionsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func listAutonomousDatabaseVersions(input: ListAutonomousDatabaseVersionsInput) async throws -> ListAutonomousDatabaseVersionsOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.listAutonomousDatabaseVersionsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listAutonomousDatabaseVersions")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListAutonomousDatabaseVersionsInput, ListAutonomousDatabaseVersionsOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListAutonomousDatabaseVersionsInput, ListAutonomousDatabaseVersionsOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListAutonomousDatabaseVersionsInput, ListAutonomousDatabaseVersionsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<ListAutonomousDatabaseVersionsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAutonomousDatabaseVersionsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListAutonomousDatabaseVersionsInput, ListAutonomousDatabaseVersionsOutput>(overrides: ["X-Amz-Target": "Odb.ListAutonomousDatabaseVersions"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListAutonomousDatabaseVersionsInput, ListAutonomousDatabaseVersionsOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListAutonomousDatabaseVersionsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListAutonomousDatabaseVersionsInput, ListAutonomousDatabaseVersionsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListAutonomousDatabaseVersionsInput, ListAutonomousDatabaseVersionsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAutonomousDatabaseVersionsInput, ListAutonomousDatabaseVersionsOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListAutonomousDatabaseVersions")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListAutonomousDatabases` operation on the `Odb` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `ListAutonomousDatabasesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListAutonomousDatabasesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func listAutonomousDatabases(input: ListAutonomousDatabasesInput) async throws -> ListAutonomousDatabasesOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.listAutonomousDatabasesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listAutonomousDatabases")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListAutonomousDatabasesInput, ListAutonomousDatabasesOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListAutonomousDatabasesInput, ListAutonomousDatabasesOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListAutonomousDatabasesInput, ListAutonomousDatabasesOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<ListAutonomousDatabasesOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListAutonomousDatabasesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListAutonomousDatabasesInput, ListAutonomousDatabasesOutput>(overrides: ["X-Amz-Target": "Odb.ListAutonomousDatabases"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListAutonomousDatabasesInput, ListAutonomousDatabasesOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListAutonomousDatabasesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListAutonomousDatabasesInput, ListAutonomousDatabasesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListAutonomousDatabasesInput, ListAutonomousDatabasesOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListAutonomousDatabasesInput, ListAutonomousDatabasesOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListAutonomousDatabases")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListFlexComponents` operation on the `Odb` service.
    ///
    /// Returns information about the flex components that are available for an Exadata infrastructure.
    ///
    /// - Parameter input: [no documentation found] (Type: `ListFlexComponentsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListFlexComponentsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func listFlexComponents(input: ListFlexComponentsInput) async throws -> ListFlexComponentsOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.listFlexComponentsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listFlexComponents")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListFlexComponentsInput, ListFlexComponentsOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ListFlexComponentsInput, ListFlexComponentsOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListFlexComponentsInput, ListFlexComponentsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<ListFlexComponentsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListFlexComponentsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListFlexComponentsInput, ListFlexComponentsOutput>(overrides: ["X-Amz-Target": "Odb.ListFlexComponents"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListFlexComponentsInput, ListFlexComponentsOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListFlexComponentsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListFlexComponentsInput, ListFlexComponentsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListFlexComponentsInput, ListFlexComponentsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListFlexComponentsInput, ListFlexComponentsOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListFlexComponents")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `RebootAutonomousDatabase` operation on the `Odb` service.
    ///
    /// Reboots the specified Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `RebootAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `RebootAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func rebootAutonomousDatabase(input: RebootAutonomousDatabaseInput) async throws -> RebootAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.rebootAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "rebootAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<RebootAutonomousDatabaseInput, RebootAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<RebootAutonomousDatabaseInput, RebootAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<RebootAutonomousDatabaseInput, RebootAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<RebootAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<RebootAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<RebootAutonomousDatabaseInput, RebootAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.RebootAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<RebootAutonomousDatabaseInput, RebootAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<RebootAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<RebootAutonomousDatabaseInput, RebootAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<RebootAutonomousDatabaseInput, RebootAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RebootAutonomousDatabaseInput, RebootAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "RebootAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `RestoreAutonomousDatabase` operation on the `Odb` service.
    ///
    /// Restores the specified Autonomous Database to a point in time.
    ///
    /// - Parameter input: [no documentation found] (Type: `RestoreAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `RestoreAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func restoreAutonomousDatabase(input: RestoreAutonomousDatabaseInput) async throws -> RestoreAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.restoreAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "restoreAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<RestoreAutonomousDatabaseInput, RestoreAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<RestoreAutonomousDatabaseInput, RestoreAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<RestoreAutonomousDatabaseInput, RestoreAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<RestoreAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<RestoreAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<RestoreAutonomousDatabaseInput, RestoreAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.RestoreAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<RestoreAutonomousDatabaseInput, RestoreAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<RestoreAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<RestoreAutonomousDatabaseInput, RestoreAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<RestoreAutonomousDatabaseInput, RestoreAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RestoreAutonomousDatabaseInput, RestoreAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "RestoreAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ShrinkAutonomousDatabase` operation on the `Odb` service.
    ///
    /// Shrinks the storage of the specified Autonomous Database to reclaim unused space.
    ///
    /// - Parameter input: [no documentation found] (Type: `ShrinkAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ShrinkAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func shrinkAutonomousDatabase(input: ShrinkAutonomousDatabaseInput) async throws -> ShrinkAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.shrinkAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "shrinkAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ShrinkAutonomousDatabaseInput, ShrinkAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<ShrinkAutonomousDatabaseInput, ShrinkAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ShrinkAutonomousDatabaseInput, ShrinkAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<ShrinkAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ShrinkAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ShrinkAutonomousDatabaseInput, ShrinkAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.ShrinkAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ShrinkAutonomousDatabaseInput, ShrinkAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ShrinkAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ShrinkAutonomousDatabaseInput, ShrinkAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ShrinkAutonomousDatabaseInput, ShrinkAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ShrinkAutonomousDatabaseInput, ShrinkAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ShrinkAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `StartAutonomousDatabase` operation on the `Odb` service.
    ///
    /// Starts the specified Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `StartAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `StartAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func startAutonomousDatabase(input: StartAutonomousDatabaseInput) async throws -> StartAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.startAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "startAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<StartAutonomousDatabaseInput, StartAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<StartAutonomousDatabaseInput, StartAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<StartAutonomousDatabaseInput, StartAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<StartAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<StartAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<StartAutonomousDatabaseInput, StartAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.StartAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<StartAutonomousDatabaseInput, StartAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<StartAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<StartAutonomousDatabaseInput, StartAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<StartAutonomousDatabaseInput, StartAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<StartAutonomousDatabaseInput, StartAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "StartAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `StopAutonomousDatabase` operation on the `Odb` service.
    ///
    /// Stops the specified Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `StopAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `StopAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func stopAutonomousDatabase(input: StopAutonomousDatabaseInput) async throws -> StopAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.stopAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "stopAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<StopAutonomousDatabaseInput, StopAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<StopAutonomousDatabaseInput, StopAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<StopAutonomousDatabaseInput, StopAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<StopAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<StopAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<StopAutonomousDatabaseInput, StopAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.StopAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<StopAutonomousDatabaseInput, StopAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<StopAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<StopAutonomousDatabaseInput, StopAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<StopAutonomousDatabaseInput, StopAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<StopAutonomousDatabaseInput, StopAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "StopAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `SwitchoverAutonomousDatabase` operation on the `Odb` service.
    ///
    /// Performs a switchover of the specified Autonomous Database to a standby peer database.
    ///
    /// - Parameter input: [no documentation found] (Type: `SwitchoverAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `SwitchoverAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func switchoverAutonomousDatabase(input: SwitchoverAutonomousDatabaseInput) async throws -> SwitchoverAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.switchoverAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "switchoverAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<SwitchoverAutonomousDatabaseInput, SwitchoverAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<SwitchoverAutonomousDatabaseInput, SwitchoverAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<SwitchoverAutonomousDatabaseInput, SwitchoverAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<SwitchoverAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SwitchoverAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<SwitchoverAutonomousDatabaseInput, SwitchoverAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.SwitchoverAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<SwitchoverAutonomousDatabaseInput, SwitchoverAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<SwitchoverAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<SwitchoverAutonomousDatabaseInput, SwitchoverAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<SwitchoverAutonomousDatabaseInput, SwitchoverAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SwitchoverAutonomousDatabaseInput, SwitchoverAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "SwitchoverAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `UpdateAutonomousDatabase` operation on the `Odb` service.
    ///
    /// Updates the properties of an Autonomous Database.
    ///
    /// - Parameter input: [no documentation found] (Type: `UpdateAutonomousDatabaseInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateAutonomousDatabaseOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func updateAutonomousDatabase(input: UpdateAutonomousDatabaseInput) async throws -> UpdateAutonomousDatabaseOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.updateAutonomousDatabaseOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "updateAutonomousDatabase")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<UpdateAutonomousDatabaseInput, UpdateAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<UpdateAutonomousDatabaseInput, UpdateAutonomousDatabaseOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<UpdateAutonomousDatabaseInput, UpdateAutonomousDatabaseOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<UpdateAutonomousDatabaseOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateAutonomousDatabaseOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateAutonomousDatabaseInput, UpdateAutonomousDatabaseOutput>(overrides: ["X-Amz-Target": "Odb.UpdateAutonomousDatabase"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<UpdateAutonomousDatabaseInput, UpdateAutonomousDatabaseOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<UpdateAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<UpdateAutonomousDatabaseInput, UpdateAutonomousDatabaseOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<UpdateAutonomousDatabaseInput, UpdateAutonomousDatabaseOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateAutonomousDatabaseInput, UpdateAutonomousDatabaseOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "UpdateAutonomousDatabase")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `UpdateAutonomousDatabaseBackup` operation on the `Odb` service.
    ///
    /// Updates the properties of an Autonomous Database backup.
    ///
    /// - Parameter input: [no documentation found] (Type: `UpdateAutonomousDatabaseBackupInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateAutonomousDatabaseBackupOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has failed validation because it is missing required fields or has invalid inputs.
    public func updateAutonomousDatabaseBackup(input: UpdateAutonomousDatabaseBackupInput) async throws -> UpdateAutonomousDatabaseBackupOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = OdbClient.updateAutonomousDatabaseBackupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "updateAutonomousDatabaseBackup")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<UpdateAutonomousDatabaseBackupInput, UpdateAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<UpdateAutonomousDatabaseBackupInput, UpdateAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<UpdateAutonomousDatabaseBackupInput, UpdateAutonomousDatabaseBackupOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<UpdateAutonomousDatabaseBackupOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("odb", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateAutonomousDatabaseBackupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UpdateAutonomousDatabaseBackupInput, UpdateAutonomousDatabaseBackupOutput>(overrides: ["X-Amz-Target": "Odb.UpdateAutonomousDatabaseBackup"]))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<UpdateAutonomousDatabaseBackupInput, UpdateAutonomousDatabaseBackupOutput>(contentType: "application/x-amz-json-1.0"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<UpdateAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<UpdateAutonomousDatabaseBackupInput, UpdateAutonomousDatabaseBackupOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<UpdateAutonomousDatabaseBackupInput, UpdateAutonomousDatabaseBackupOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "odb"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateAutonomousDatabaseBackupInput, UpdateAutonomousDatabaseBackupOutput>(serviceID: serviceName, version: OdbClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "Odb")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "UpdateAutonomousDatabaseBackup")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
