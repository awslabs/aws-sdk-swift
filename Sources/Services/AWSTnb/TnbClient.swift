...
extension TnbClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> TnbClient.TnbClientConfiguration {
        let clientConfiguration = try await TnbClient.TnbClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> TnbClient {
            let configuration = try await resolve(plugins: self.plugins)
            return TnbClient(config: configuration)
        }
    }
...
extension TnbClient.TnbClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
