...
extension GetSolNetworkPackageOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetSolNetworkPackageOutput {
        ...
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.vnfPkgIds = try reader["vnfPkgIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension TnbClientTypes.GetSolNetworkOperationTaskDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TnbClientTypes.GetSolNetworkOperationTaskDetails {
        ...
        value.taskContext = try reader["taskContext"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
