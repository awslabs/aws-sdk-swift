...
extension BatchDeleteRumMetricDefinitionsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchDeleteRumMetricDefinitionsOutput {
        ...
        value.metricDefinitionIds = try reader["MetricDefinitionIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension RUMClientTypes.MetricDefinitionRequest {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RUMClientTypes.MetricDefinitionRequest {
        ...
        value.dimensionKeys = try reader["DimensionKeys"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension RUMClientTypes.AppMonitorConfiguration {
    ...
    static func write(value: RUMClientTypes.AppMonitorConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ExcludedPages"].writeList(value.excludedPages, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["FavoritePages"].writeList(value.favoritePages, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["GuestRoleArn"].write(value.guestRoleArn)
        try writer["IdentityPoolId"].write(value.identityPoolId)
        try writer["IncludedPages"].writeList(value.includedPages, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SessionSampleRate"].write(value.sessionSampleRate)
        try writer["Telemetries"].writeList(value.telemetries, memberWritingClosure: RUMClientTypes.Telemetry.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RUMClientTypes.AppMonitorConfiguration {
        ...
        value.excludedPages = try reader["ExcludedPages"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.includedPages = try reader["IncludedPages"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.favoritePages = try reader["FavoritePages"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.telemetries = try reader["Telemetries"].readListIfPresent(memberReadingClosure: RUMClientTypes.Telemetry.read(from:), memberNodeInfo: "member", isFlattened: false)
