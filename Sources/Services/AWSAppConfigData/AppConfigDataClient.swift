...
public class AppConfigDataClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await AppConfigDataClientConfiguration(region: region)
    ...
    public class AppConfigDataClientConfiguration: AppConfigDataClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("AppConfigDataClient")
