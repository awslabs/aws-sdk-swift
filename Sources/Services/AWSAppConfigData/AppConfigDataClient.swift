...
extension AppConfigDataClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> AppConfigDataClient.AppConfigDataClientConfiguration {
        let clientConfiguration = try await AppConfigDataClient.AppConfigDataClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> AppConfigDataClient {
            let configuration = try await resolve(plugins: self.plugins)
            return AppConfigDataClient(config: configuration)
        }
    }
...
extension AppConfigDataClient.AppConfigDataClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
