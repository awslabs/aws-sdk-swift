...
public class AppConfigDataClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? AppConfigDataClient.AppConfigDataClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? AppConfigDataClient.AppConfigDataClientConfiguration {
            config.authSchemeResolver = DefaultAppConfigDataAuthSchemeResolver()
...
public class AppConfigDataClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: AppConfigDataAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
