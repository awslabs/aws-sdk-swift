...
public class PinpointSMSVoiceV2ClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? PinpointSMSVoiceV2Client.PinpointSMSVoiceV2ClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? PinpointSMSVoiceV2Client.PinpointSMSVoiceV2ClientConfiguration {
            config.authSchemeResolver = DefaultPinpointSMSVoiceV2AuthSchemeResolver()
...
public class PinpointSMSVoiceV2ClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: PinpointSMSVoiceV2AuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
