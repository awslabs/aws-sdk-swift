...
extension CodeCommitClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CodeCommitClient.CodeCommitClientConfiguration {
        let clientConfiguration = try await CodeCommitClient.CodeCommitClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CodeCommitClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CodeCommitClient(config: configuration)
        }
    }
...
extension CodeCommitClient.CodeCommitClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
