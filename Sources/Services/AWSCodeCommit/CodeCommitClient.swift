...
public class CodeCommitClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await CodeCommitClientConfiguration(region: region)
    ...
    public class CodeCommitClientConfiguration: CodeCommitClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("CodeCommitClient")
