...
extension ECRClientTypes.AwsEcrContainerImageDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECRClientTypes.AwsEcrContainerImageDetails {
        ...
        value.pushedAt = try reader["pushedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension BatchGetImageInput {
    ...
    static func write(value: BatchGetImageInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["acceptedMediaTypes"].writeList(value.acceptedMediaTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["imageIds"].writeList(value.imageIds, memberWritingClosure: ECRClientTypes.ImageIdentifier.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["registryId"].write(value.registryId)
        try writer["repositoryName"].write(value.repositoryName)
    }
...
extension BatchGetImageOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchGetImageOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension BatchGetRepositoryScanningConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> BatchGetRepositoryScanningConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreatePullThroughCacheRuleOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreatePullThroughCacheRuleOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteLifecyclePolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteLifecyclePolicyOutput {
        ...
        value.lastEvaluatedAt = try reader["lastEvaluatedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension DeletePullThroughCacheRuleOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeletePullThroughCacheRuleOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteRegistryPolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteRegistryPolicyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeImageReplicationStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeImageReplicationStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeImageScanFindingsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeImageScanFindingsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribePullThroughCacheRulesInput {
    ...
    static func write(value: DescribePullThroughCacheRulesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ecrRepositoryPrefixes"].writeList(value.ecrRepositoryPrefixes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["maxResults"].write(value.maxResults)
        try writer["nextToken"].write(value.nextToken)
        try writer["registryId"].write(value.registryId)
    }
...
extension DescribePullThroughCacheRulesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribePullThroughCacheRulesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECRClientTypes.EnhancedImageScanFinding {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECRClientTypes.EnhancedImageScanFinding {
        ...
        value.lastObservedAt = try reader["lastObservedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension ECRClientTypes {
    ...
    public enum FindingSeverity: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case critical
        case high
        case informational
        case low
...
extension GetAuthorizationTokenInput {
    ...
    static func write(value: GetAuthorizationTokenInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["registryIds"].writeList(value.registryIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetDownloadUrlForLayerOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetDownloadUrlForLayerOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetLifecyclePolicyPreviewOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetLifecyclePolicyPreviewOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetRegistryPolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetRegistryPolicyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetRegistryScanningConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetRegistryScanningConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECRClientTypes {
    ...
    public enum ImageActionType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case expire
        case sdkUnknown(Swift.String)
...
extension ECRClientTypes.ImageDetail {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECRClientTypes.ImageDetail {
        ...
        value.lastRecordedPullTime = try reader["lastRecordedPullTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension ECRClientTypes.ImageScanFindings {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ECRClientTypes.ImageScanFindings {
        ...
        value.imageScanCompletedAt = try reader["imageScanCompletedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.vulnerabilitySourceUpdatedAt = try reader["vulnerabilitySourceUpdatedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.findingSeverityCounts = try reader["findingSeverityCounts"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ECRClientTypes {
    ...
    public enum ImageTagMutability: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case immutable
        case mutable
        case sdkUnknown(Swift.String)
...
extension ECRClientTypes {
    ...
    public enum LifecyclePolicyPreviewStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case complete
        case expired
        case failed
        case inProgress
...
extension PutImageScanningConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutImageScanningConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension PutImageTagMutabilityOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutImageTagMutabilityOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension PutLifecyclePolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutLifecyclePolicyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension PutRegistryPolicyOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutRegistryPolicyOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension PutRegistryScanningConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutRegistryScanningConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension PutReplicationConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutReplicationConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECRClientTypes {
    ...
    public enum RepositoryFilterType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case prefixMatch
        case sdkUnknown(Swift.String)
...
extension ECRClientTypes {
    ...
    public enum ScanFrequency: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case continuousScan
        case manual
        case scanOnPush
        case sdkUnknown(Swift.String)
...
extension ECRClientTypes {
    ...
    public enum ScanningConfigurationFailureCode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension ECRClientTypes {
    ...
    public enum ScanningRepositoryFilterType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case wildcard
        case sdkUnknown(Swift.String)
...
extension StartImageScanOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> StartImageScanOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension StartLifecyclePolicyPreviewOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> StartLifecyclePolicyPreviewOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECRClientTypes {
    ...
    public enum TagStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case any
        case tagged
        case untagged
        case sdkUnknown(Swift.String)
...
extension UpdatePullThroughCacheRuleOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdatePullThroughCacheRuleOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ECRClientTypes {
    ...
    public enum UpstreamRegistry: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension ValidatePullThroughCacheRuleOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ValidatePullThroughCacheRuleOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
