...
extension CreateLinkInput {
    ...
    static func write(value: CreateLinkInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ResourceTypes"].writeList(value.resourceTypes, memberWritingClosure: OAMClientTypes.ResourceType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
