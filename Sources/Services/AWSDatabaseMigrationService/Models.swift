...
extension CreateEventSubscriptionInput {
    ...
    static func write(value: CreateEventSubscriptionInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["SourceIds"].writeList(value.sourceIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DeleteFleetAdvisorDatabasesInput {
    ...
    static func write(value: DeleteFleetAdvisorDatabasesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DatabaseIds"].writeList(value.databaseIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ExportMetadataModelAssessmentInput {
    ...
    static func write(value: ExportMetadataModelAssessmentInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AssessmentReportTypes"].writeList(value.assessmentReportTypes, memberWritingClosure: DatabaseMigrationClientTypes.AssessmentReportType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension ListTagsForResourceInput {
    ...
    static func write(value: ListTagsForResourceInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ResourceArn"].write(value.resourceArn)
        try writer["ResourceArnList"].writeList(value.resourceArnList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension StartReplicationTaskAssessmentRunInput {
    ...
    static func write(value: StartReplicationTaskAssessmentRunInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Exclude"].writeList(value.exclude, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["IncludeOnly"].writeList(value.includeOnly, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ReplicationTaskArn"].write(value.replicationTaskArn)
...
extension DeleteFleetAdvisorDatabasesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DeleteFleetAdvisorDatabasesOutput {
        ...
        value.databaseIds = try reader["DatabaseIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeApplicableIndividualAssessmentsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeApplicableIndividualAssessmentsOutput {
        ...
        value.individualAssessmentNames = try reader["IndividualAssessmentNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeSchemasOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeSchemasOutput {
        ...
        value.marker = try reader["Marker"].readIfPresent()
        value.schemas = try reader["Schemas"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DatabaseMigrationClientTypes.PendingMaintenanceAction {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.PendingMaintenanceAction {
        ...
        value.autoAppliedAfterDate = try reader["AutoAppliedAfterDate"].readTimestampIfPresent(format: .epochSeconds)
        value.forcedApplyDate = try reader["ForcedApplyDate"].readTimestampIfPresent(format: .epochSeconds)
        value.optInStatus = try reader["OptInStatus"].readIfPresent()
        value.currentApplyDate = try reader["CurrentApplyDate"].readTimestampIfPresent(format: .epochSeconds)
        value.description = try reader["Description"].readIfPresent()
        return value
    }
}
...
extension DatabaseMigrationClientTypes.ReplicationTaskAssessmentRun {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.ReplicationTaskAssessmentRun {
        ...
        value.replicationTaskArn = try reader["ReplicationTaskArn"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
        value.replicationTaskAssessmentRunCreationDate = try reader["ReplicationTaskAssessmentRunCreationDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension DatabaseMigrationClientTypes.DataProvider {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.DataProvider {
        ...
        value.dataProviderCreationTime = try reader["DataProviderCreationTime"].readTimestampIfPresent(format: .dateTime)
        value.description = try reader["Description"].readIfPresent()
...
extension DatabaseMigrationClientTypes.OracleSettings {
    ...
    static func write(value: DatabaseMigrationClientTypes.OracleSettings?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ExtraArchivedLogDestIds"].writeList(value.extraArchivedLogDestIds, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.OracleSettings {
        ...
        value.extraArchivedLogDestIds = try reader["ExtraArchivedLogDestIds"].readListIfPresent(memberReadingClosure: Swift.Int.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DatabaseMigrationClientTypes.EventSubscription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.EventSubscription {
        ...
        value.sourceIdsList = try reader["SourceIdsList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.eventCategoriesList = try reader["EventCategoriesList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DatabaseMigrationClientTypes.InstanceProfile {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.InstanceProfile {
        ...
        value.description = try reader["Description"].readIfPresent()
        value.instanceProfileCreationTime = try reader["InstanceProfileCreationTime"].readTimestampIfPresent(format: .dateTime)
        value.subnetGroupIdentifier = try reader["SubnetGroupIdentifier"].readIfPresent()
        value.vpcSecurityGroups = try reader["VpcSecurityGroups"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DatabaseMigrationClientTypes.MigrationProject {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.MigrationProject {
        ...
        value.migrationProjectCreationTime = try reader["MigrationProjectCreationTime"].readTimestampIfPresent(format: .dateTime)
...
extension DatabaseMigrationClientTypes.ReplicationConfig {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.ReplicationConfig {
        ...
        value.replicationConfigCreateTime = try reader["ReplicationConfigCreateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.replicationConfigUpdateTime = try reader["ReplicationConfigUpdateTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DatabaseMigrationClientTypes.ReplicationInstance {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.ReplicationInstance {
        ...
        value.instanceCreateTime = try reader["InstanceCreateTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.replicationInstancePublicIpAddresses = try reader["ReplicationInstancePublicIpAddresses"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.replicationInstancePrivateIpAddresses = try reader["ReplicationInstancePrivateIpAddresses"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.replicationInstanceIpv6Addresses = try reader["ReplicationInstanceIpv6Addresses"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.freeUntil = try reader["FreeUntil"].readTimestampIfPresent(format: .epochSeconds)
        value.dnsNameServers = try reader["DnsNameServers"].readIfPresent()
        value.networkType = try reader["NetworkType"].readIfPresent()
        return value
    }
...
extension DatabaseMigrationClientTypes.ReplicationSubnetGroup {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.ReplicationSubnetGroup {
        ...
        value.supportedNetworkTypes = try reader["SupportedNetworkTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DatabaseMigrationClientTypes.ReplicationTask {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.ReplicationTask {
        ...
        value.replicationTaskCreationDate = try reader["ReplicationTaskCreationDate"].readTimestampIfPresent(format: .epochSeconds)
        value.replicationTaskStartDate = try reader["ReplicationTaskStartDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension DatabaseMigrationClientTypes.ReplicationTaskStats {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.ReplicationTaskStats {
        ...
        value.freshStartDate = try reader["FreshStartDate"].readTimestampIfPresent(format: .epochSeconds)
        value.startDate = try reader["StartDate"].readTimestampIfPresent(format: .epochSeconds)
        value.stopDate = try reader["StopDate"].readTimestampIfPresent(format: .epochSeconds)
        value.fullLoadStartDate = try reader["FullLoadStartDate"].readTimestampIfPresent(format: .epochSeconds)
        value.fullLoadFinishDate = try reader["FullLoadFinishDate"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DatabaseMigrationClientTypes.Certificate {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.Certificate {
        ...
        value.certificateCreationDate = try reader["CertificateCreationDate"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.validFromDate = try reader["ValidFromDate"].readTimestampIfPresent(format: .epochSeconds)
        value.validToDate = try reader["ValidToDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension DatabaseMigrationClientTypes.EndpointSetting {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.EndpointSetting {
        ...
        value.enumValues = try reader["EnumValues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DatabaseMigrationClientTypes.EngineVersion {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.EngineVersion {
        ...
        value.launchDate = try reader["LaunchDate"].readTimestampIfPresent(format: .epochSeconds)
        value.autoUpgradeDate = try reader["AutoUpgradeDate"].readTimestampIfPresent(format: .epochSeconds)
        value.deprecationDate = try reader["DeprecationDate"].readTimestampIfPresent(format: .epochSeconds)
        value.forceUpgradeDate = try reader["ForceUpgradeDate"].readTimestampIfPresent(format: .epochSeconds)
        value.availableUpgrades = try reader["AvailableUpgrades"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DatabaseMigrationClientTypes.EventCategoryGroup {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.EventCategoryGroup {
        ...
        value.sourceType = try reader["SourceType"].readIfPresent()
        value.eventCategories = try reader["EventCategories"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DatabaseMigrationClientTypes.RefreshSchemasStatus {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.RefreshSchemasStatus {
        ...
        value.replicationInstanceArn = try reader["ReplicationInstanceArn"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
        value.lastRefreshDate = try reader["LastRefreshDate"].readTimestampIfPresent(format: .epochSeconds)
        value.lastFailureMessage = try reader["LastFailureMessage"].readIfPresent()
        return value
    }
}
...
extension DatabaseMigrationClientTypes.Replication {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.Replication {
        ...
        value.cdcStartTime = try reader["CdcStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.cdcStartPosition = try reader["CdcStartPosition"].readIfPresent()
        value.cdcStopPosition = try reader["CdcStopPosition"].readIfPresent()
        value.recoveryCheckpoint = try reader["RecoveryCheckpoint"].readIfPresent()
        value.replicationCreateTime = try reader["ReplicationCreateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.replicationUpdateTime = try reader["ReplicationUpdateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.replicationLastStopTime = try reader["ReplicationLastStopTime"].readTimestampIfPresent(format: .epochSeconds)
        value.replicationDeprovisionTime = try reader["ReplicationDeprovisionTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DatabaseMigrationClientTypes.ProvisionData {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.ProvisionData {
        ...
        value.dateProvisioned = try reader["DateProvisioned"].readTimestampIfPresent(format: .epochSeconds)
        value.isNewProvisioningAvailable = try reader["IsNewProvisioningAvailable"].readIfPresent() ?? false
        value.dateNewProvisioningDataAvailable = try reader["DateNewProvisioningDataAvailable"].readTimestampIfPresent(format: .epochSeconds)
...
extension DatabaseMigrationClientTypes.TableStatistics {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.TableStatistics {
        ...
        value.fullLoadStartTime = try reader["FullLoadStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.fullLoadEndTime = try reader["FullLoadEndTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension DatabaseMigrationClientTypes.ReplicationTaskAssessmentResult {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.ReplicationTaskAssessmentResult {
        ...
        value.replicationTaskIdentifier = try reader["ReplicationTaskIdentifier"].readIfPresent()
        value.replicationTaskArn = try reader["ReplicationTaskArn"].readIfPresent()
        value.replicationTaskLastAssessmentDate = try reader["ReplicationTaskLastAssessmentDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension DatabaseMigrationClientTypes.ReplicationTaskIndividualAssessment {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DatabaseMigrationClientTypes.ReplicationTaskIndividualAssessment {
        ...
        value.status = try reader["Status"].readIfPresent()
        value.replicationTaskIndividualAssessmentStartDate = try reader["ReplicationTaskIndividualAssessmentStartDate"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
