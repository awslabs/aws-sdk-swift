...
extension CloudSearchClientTypes.AccessPoliciesStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.AccessPoliciesStatus {
        var value = CloudSearchClientTypes.AccessPoliciesStatus()
        value.options = try reader["Options"].readIfPresent()
        value.status = try reader["Status"].readIfPresent(readingClosure: CloudSearchClientTypes.OptionStatus.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.AnalysisOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.AnalysisOptions {
...
extension CloudSearchClientTypes.AnalysisScheme: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.AnalysisScheme {
        ...
        value.analysisOptions = try reader["AnalysisOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.AnalysisOptions.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.AnalysisSchemeStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.AnalysisSchemeStatus {
        var value = CloudSearchClientTypes.AnalysisSchemeStatus()
        value.options = try reader["Options"].readIfPresent(readingClosure: CloudSearchClientTypes.AnalysisScheme.readingClosure(from:))
        value.status = try reader["Status"].readIfPresent(readingClosure: CloudSearchClientTypes.OptionStatus.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.AvailabilityOptionsStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.AvailabilityOptionsStatus {
...
extension BuildSuggestersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> BuildSuggestersOutput {
        let reader = responseReader["BuildSuggestersResult"]
        var value = BuildSuggestersOutput()
        value.fieldNames = try reader["FieldNames"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CreateDomainOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateDomainOutput {
        let reader = responseReader["CreateDomainResult"]
        var value = CreateDomainOutput()
        value.domainStatus = try reader["DomainStatus"].readIfPresent(readingClosure: CloudSearchClientTypes.DomainStatus.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.DateArrayOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.DateArrayOptions {
...
extension CloudSearchClientTypes.DateOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.DateOptions {
...
extension DefineAnalysisSchemeOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DefineAnalysisSchemeOutput {
        let reader = responseReader["DefineAnalysisSchemeResult"]
        var value = DefineAnalysisSchemeOutput()
        value.analysisScheme = try reader["AnalysisScheme"].readIfPresent(readingClosure: CloudSearchClientTypes.AnalysisSchemeStatus.readingClosure(from:))
        return value
    }
}
...
extension DefineExpressionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DefineExpressionOutput {
        let reader = responseReader["DefineExpressionResult"]
        var value = DefineExpressionOutput()
        value.expression = try reader["Expression"].readIfPresent(readingClosure: CloudSearchClientTypes.ExpressionStatus.readingClosure(from:))
        return value
    }
}
...
extension DefineIndexFieldOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DefineIndexFieldOutput {
        let reader = responseReader["DefineIndexFieldResult"]
        var value = DefineIndexFieldOutput()
        value.indexField = try reader["IndexField"].readIfPresent(readingClosure: CloudSearchClientTypes.IndexFieldStatus.readingClosure(from:))
        return value
    }
}
...
extension DefineSuggesterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DefineSuggesterOutput {
        let reader = responseReader["DefineSuggesterResult"]
        var value = DefineSuggesterOutput()
        value.suggester = try reader["Suggester"].readIfPresent(readingClosure: CloudSearchClientTypes.SuggesterStatus.readingClosure(from:))
        return value
    }
}
...
extension DeleteAnalysisSchemeOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteAnalysisSchemeOutput {
...
extension DeleteDomainOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteDomainOutput {
...
extension DeleteExpressionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteExpressionOutput {
...
extension DeleteIndexFieldOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteIndexFieldOutput {
...
extension DeleteSuggesterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteSuggesterOutput {
...
extension DescribeAnalysisSchemesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAnalysisSchemesOutput {
        let reader = responseReader["DescribeAnalysisSchemesResult"]
        var value = DescribeAnalysisSchemesOutput()
        value.analysisSchemes = try reader["AnalysisSchemes"].readListIfPresent(memberReadingClosure: CloudSearchClientTypes.AnalysisSchemeStatus.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeAvailabilityOptionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAvailabilityOptionsOutput {
        let reader = responseReader["DescribeAvailabilityOptionsResult"]
        var value = DescribeAvailabilityOptionsOutput()
        value.availabilityOptions = try reader["AvailabilityOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.AvailabilityOptionsStatus.readingClosure(from:))
        return value
    }
}
...
extension DescribeDomainEndpointOptionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeDomainEndpointOptionsOutput {
        let reader = responseReader["DescribeDomainEndpointOptionsResult"]
        var value = DescribeDomainEndpointOptionsOutput()
        value.domainEndpointOptions = try reader["DomainEndpointOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.DomainEndpointOptionsStatus.readingClosure(from:))
        return value
    }
}
...
extension DescribeDomainsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeDomainsOutput {
        let reader = responseReader["DescribeDomainsResult"]
        var value = DescribeDomainsOutput()
        value.domainStatusList = try reader["DomainStatusList"].readListIfPresent(memberReadingClosure: CloudSearchClientTypes.DomainStatus.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeExpressionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeExpressionsOutput {
        let reader = responseReader["DescribeExpressionsResult"]
        var value = DescribeExpressionsOutput()
        value.expressions = try reader["Expressions"].readListIfPresent(memberReadingClosure: CloudSearchClientTypes.ExpressionStatus.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeIndexFieldsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeIndexFieldsOutput {
        let reader = responseReader["DescribeIndexFieldsResult"]
        var value = DescribeIndexFieldsOutput()
        value.indexFields = try reader["IndexFields"].readListIfPresent(memberReadingClosure: CloudSearchClientTypes.IndexFieldStatus.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeScalingParametersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeScalingParametersOutput {
        let reader = responseReader["DescribeScalingParametersResult"]
        var value = DescribeScalingParametersOutput()
        value.scalingParameters = try reader["ScalingParameters"].readIfPresent(readingClosure: CloudSearchClientTypes.ScalingParametersStatus.readingClosure(from:))
        return value
    }
}
...
extension DescribeServiceAccessPoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeServiceAccessPoliciesOutput {
        let reader = responseReader["DescribeServiceAccessPoliciesResult"]
        var value = DescribeServiceAccessPoliciesOutput()
        value.accessPolicies = try reader["AccessPolicies"].readIfPresent(readingClosure: CloudSearchClientTypes.AccessPoliciesStatus.readingClosure(from:))
        return value
    }
}
...
extension DescribeSuggestersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeSuggestersOutput {
        let reader = responseReader["DescribeSuggestersResult"]
        var value = DescribeSuggestersOutput()
        value.suggesters = try reader["Suggesters"].readListIfPresent(memberReadingClosure: CloudSearchClientTypes.SuggesterStatus.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudSearchClientTypes.DocumentSuggesterOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.DocumentSuggesterOptions {
...
extension CloudSearchClientTypes.DomainEndpointOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.DomainEndpointOptions {
...
extension CloudSearchClientTypes.DomainEndpointOptionsStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.DomainEndpointOptionsStatus {
        var value = CloudSearchClientTypes.DomainEndpointOptionsStatus()
        value.options = try reader["Options"].readIfPresent(readingClosure: CloudSearchClientTypes.DomainEndpointOptions.readingClosure(from:))
        value.status = try reader["Status"].readIfPresent(readingClosure: CloudSearchClientTypes.OptionStatus.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.DomainStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.DomainStatus {
        ...
        value.docService = try reader["DocService"].readIfPresent(readingClosure: CloudSearchClientTypes.ServiceEndpoint.readingClosure(from:))
        value.searchService = try reader["SearchService"].readIfPresent(readingClosure: CloudSearchClientTypes.ServiceEndpoint.readingClosure(from:))
        ...
        value.limits = try reader["Limits"].readIfPresent(readingClosure: CloudSearchClientTypes.Limits.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.DoubleArrayOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.DoubleArrayOptions {
...
extension CloudSearchClientTypes.DoubleOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.DoubleOptions {
...
extension CloudSearchClientTypes.Expression: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.Expression {
...
extension CloudSearchClientTypes.ExpressionStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.ExpressionStatus {
        var value = CloudSearchClientTypes.ExpressionStatus()
        value.options = try reader["Options"].readIfPresent(readingClosure: CloudSearchClientTypes.Expression.readingClosure(from:))
        value.status = try reader["Status"].readIfPresent(readingClosure: CloudSearchClientTypes.OptionStatus.readingClosure(from:))
        return value
    }
}
...
extension IndexDocumentsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> IndexDocumentsOutput {
...
extension CloudSearchClientTypes.IndexField: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.IndexField {
        ...
        value.intOptions = try reader["IntOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.IntOptions.readingClosure(from:))
        value.doubleOptions = try reader["DoubleOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.DoubleOptions.readingClosure(from:))
        value.literalOptions = try reader["LiteralOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.LiteralOptions.readingClosure(from:))
        value.textOptions = try reader["TextOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.TextOptions.readingClosure(from:))
        value.dateOptions = try reader["DateOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.DateOptions.readingClosure(from:))
        value.latLonOptions = try reader["LatLonOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.LatLonOptions.readingClosure(from:))
        value.intArrayOptions = try reader["IntArrayOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.IntArrayOptions.readingClosure(from:))
        value.doubleArrayOptions = try reader["DoubleArrayOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.DoubleArrayOptions.readingClosure(from:))
        value.literalArrayOptions = try reader["LiteralArrayOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.LiteralArrayOptions.readingClosure(from:))
        value.textArrayOptions = try reader["TextArrayOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.TextArrayOptions.readingClosure(from:))
        value.dateArrayOptions = try reader["DateArrayOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.DateArrayOptions.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.IndexFieldStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.IndexFieldStatus {
        var value = CloudSearchClientTypes.IndexFieldStatus()
        value.options = try reader["Options"].readIfPresent(readingClosure: CloudSearchClientTypes.IndexField.readingClosure(from:))
        value.status = try reader["Status"].readIfPresent(readingClosure: CloudSearchClientTypes.OptionStatus.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.IntArrayOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.IntArrayOptions {
...
extension CloudSearchClientTypes.IntOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.IntOptions {
...
extension CloudSearchClientTypes.LatLonOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.LatLonOptions {
...
extension CloudSearchClientTypes.Limits: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.Limits {
...
extension ListDomainNamesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListDomainNamesOutput {
        let reader = responseReader["ListDomainNamesResult"]
        var value = ListDomainNamesOutput()
        value.domainNames = try reader["DomainNames"].readMapIfPresent(valueReadingClosure: Swift.String.readingClosure(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension CloudSearchClientTypes.LiteralArrayOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.LiteralArrayOptions {
...
extension CloudSearchClientTypes.LiteralOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.LiteralOptions {
...
extension CloudSearchClientTypes.OptionStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.OptionStatus {
...
extension CloudSearchClientTypes.ScalingParameters: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.ScalingParameters {
...
extension CloudSearchClientTypes.ScalingParametersStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.ScalingParametersStatus {
        var value = CloudSearchClientTypes.ScalingParametersStatus()
        value.options = try reader["Options"].readIfPresent(readingClosure: CloudSearchClientTypes.ScalingParameters.readingClosure(from:))
        value.status = try reader["Status"].readIfPresent(readingClosure: CloudSearchClientTypes.OptionStatus.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.ServiceEndpoint: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.ServiceEndpoint {
...
extension CloudSearchClientTypes.Suggester: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.Suggester {
        var value = CloudSearchClientTypes.Suggester()
        value.suggesterName = try reader["SuggesterName"].readIfPresent()
        value.documentSuggesterOptions = try reader["DocumentSuggesterOptions"].readIfPresent(readingClosure: CloudSearchClientTypes.DocumentSuggesterOptions.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.SuggesterStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.SuggesterStatus {
        var value = CloudSearchClientTypes.SuggesterStatus()
        value.options = try reader["Options"].readIfPresent(readingClosure: CloudSearchClientTypes.Suggester.readingClosure(from:))
        value.status = try reader["Status"].readIfPresent(readingClosure: CloudSearchClientTypes.OptionStatus.readingClosure(from:))
        return value
    }
}
...
extension CloudSearchClientTypes.TextArrayOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.TextArrayOptions {
...
extension CloudSearchClientTypes.TextOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudSearchClientTypes.TextOptions {
...
extension UpdateAvailabilityOptionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateAvailabilityOptionsOutput {
...
extension UpdateDomainEndpointOptionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateDomainEndpointOptionsOutput {
...
extension UpdateScalingParametersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateScalingParametersOutput {
...
extension UpdateServiceAccessPoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateServiceAccessPoliciesOutput {
