...
extension DescribeAnalysisSchemesInput {
    ...
    static func write(value: DescribeAnalysisSchemesInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AnalysisSchemeNames"].writeList(value.analysisSchemeNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeExpressionsInput {
    ...
    static func write(value: DescribeExpressionsInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Deployed"].write(value.deployed)
        try writer["DomainName"].write(value.domainName)
        try writer["ExpressionNames"].writeList(value.expressionNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeIndexFieldsInput {
    ...
    static func write(value: DescribeIndexFieldsInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Deployed"].write(value.deployed)
        try writer["DomainName"].write(value.domainName)
        try writer["FieldNames"].writeList(value.fieldNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeSuggestersInput {
    ...
    static func write(value: DescribeSuggestersInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Deployed"].write(value.deployed)
        try writer["DomainName"].write(value.domainName)
        try writer["SuggesterNames"].writeList(value.suggesterNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension BuildSuggestersOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BuildSuggestersOutput {
        ...
        value.fieldNames = try reader["FieldNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListDomainNamesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListDomainNamesOutput {
        ...
        value.domainNames = try reader["DomainNames"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
