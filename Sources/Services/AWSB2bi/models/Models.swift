...
extension B2biClientTypes.CapabilitySummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> B2biClientTypes.CapabilitySummary {
        ...
        value.modifiedAt = try reader["modifiedAt"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
...
extension CreatePartnershipOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreatePartnershipOutput {
        ...
        value.capabilities = try reader["capabilities"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.createdAt = try reader["createdAt"].readTimestampIfPresent(format: .dateTime)
