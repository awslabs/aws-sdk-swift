...
public final class AppflowClient: AWSClientRuntime.AWSServiceClient {
    ...
    public let config: AppflowClient.AppflowClientConfig
    let serviceName = "Appflow"

    @available(*, deprecated, message: "Use AppflowClient.AppflowClientConfig instead")
    public typealias Config = AppflowClient.AppflowClientConfiguration
    public typealias Configuration = AppflowClient.AppflowClientConfig

    public required init(config: AppflowClient.AppflowClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: AppflowClient.AppflowClientConfig) instead")
    public convenience init(config: AppflowClient.AppflowClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try AppflowClient.AppflowClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await AppflowClient.AppflowClientConfig()
        self.init(config: config)
    }
}
...
extension AppflowClient {
    ...
    /// Client configuration for AppflowClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct AppflowClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Appflow")
    ...
    @available(*, deprecated, message: "Use AppflowClientConfig instead. This class will be removed in a future version.")
    public final class AppflowClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> AppflowClientConfig {
            return try AppflowClientConfig(
...
extension AppflowClient {
    ...
    public func cancelFlowExecutions(input: CancelFlowExecutionsInput) async throws -> CancelFlowExecutionsOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Appflow"))
