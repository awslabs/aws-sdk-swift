...
extension AppflowClientTypes.SAPODataParallelismConfig {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AppflowClientTypes.SAPODataParallelismConfig {
        ...
        value.maxParallelism = try reader["maxParallelism"].readIfPresent()
        return value
    }
}
...
extension AppflowClientTypes.ExecutionDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AppflowClientTypes.ExecutionDetails {
        ...
        value.mostRecentExecutionTime = try reader["mostRecentExecutionTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension AppflowClientTypes.ExecutionRecord {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AppflowClientTypes.ExecutionRecord {
        ...
        value.lastUpdatedAt = try reader["lastUpdatedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.dataPullStartTime = try reader["dataPullStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.dataPullEndTime = try reader["dataPullEndTime"].readTimestampIfPresent(format: .epochSeconds)
