...
extension ManagedBlockchainClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ManagedBlockchainClient.ManagedBlockchainClientConfiguration {
        let clientConfiguration = try await ManagedBlockchainClient.ManagedBlockchainClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ManagedBlockchainClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ManagedBlockchainClient(config: configuration)
        }
    }
...
extension ManagedBlockchainClient.ManagedBlockchainClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
