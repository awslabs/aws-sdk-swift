...
extension CognitoSyncClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CognitoSyncClient.CognitoSyncClientConfiguration {
        let clientConfiguration = try await CognitoSyncClient.CognitoSyncClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CognitoSyncClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CognitoSyncClient(config: configuration)
        }
    }
...
extension CognitoSyncClient.CognitoSyncClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
