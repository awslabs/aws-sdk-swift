...
extension MarketplaceDeploymentClient {
    ...
    public func putDeploymentParameter(input: PutDeploymentParameterInput) async throws -> PutDeploymentParameterOutput {
        ...
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.UserAgentMiddleware<PutDeploymentParameterOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
        ...
        operation.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware<PutDeploymentParameterOutput>())
