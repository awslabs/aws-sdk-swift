...
public final class SecurityIRClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: SecurityIRClient.SecurityIRClientConfig) instead")
    public convenience init(config: SecurityIRClient.SecurityIRClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try SecurityIRClient.SecurityIRClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await SecurityIRClient.SecurityIRClientConfig()
        self.init(config: config)
    }
}
...
extension SecurityIRClient {
    ...
    /// Client configuration for SecurityIRClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct SecurityIRClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Security IR")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultSecurityIRAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: SecurityIRClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use SecurityIRClientConfig instead. This class will be removed in a future version.")
    public final class SecurityIRClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> SecurityIRClientConfig {
            return try SecurityIRClientConfig(
