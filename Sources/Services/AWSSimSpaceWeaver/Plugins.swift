...
public class SimSpaceWeaverClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [ClientRuntime.AuthScheme]? = nil, authSchemeResolver: SimSpaceWeaverAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any AWSClientRuntime.AWSCredentialIdentityResolver)? = nil) {
