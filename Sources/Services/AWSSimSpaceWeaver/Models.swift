...
extension SimSpaceWeaverClientTypes.LaunchOverrides {
    ...
    static func write(value: SimSpaceWeaverClientTypes.LaunchOverrides?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["LaunchCommands"].writeList(value.launchCommands, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SimSpaceWeaverClientTypes.LaunchOverrides {
        ...
        value.launchCommands = try reader["LaunchCommands"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
