...
extension GetStatementResultOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetStatementResultOutput {
        ...
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.records = try reader["Records"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: RedshiftDataClientTypes.Field.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
...
extension RedshiftDataClientTypes.StatementData {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RedshiftDataClientTypes.StatementData {
        ...
        value.id = try reader["Id"].readIfPresent()
        value.queryString = try reader["QueryString"].readIfPresent()
        value.queryStrings = try reader["QueryStrings"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.secretArn = try reader["SecretArn"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
