...
struct ActiveStatementsExceededExceptionBody {
...
struct BatchExecuteStatementExceptionBody {
    let message: Swift.String?
...
struct CancelStatementOutputBody {
...
struct DatabaseConnectionExceptionBody {
    let message: Swift.String?
}
...
struct DescribeStatementInputBody {
    let id: Swift.String?
}
...
struct DescribeStatementOutputBody {
    let id: Swift.String?
    let secretArn: Swift.String?
    let dbUser: Swift.String?
    let database: Swift.String?
...
struct ExecuteStatementExceptionBody {
    let message: Swift.String?
    let statementId: Swift.String?
}
...
struct GetStatementResultInputBody {
    let id: Swift.String?
    let nextToken: Swift.String?
}
...
struct GetStatementResultOutputBody {
