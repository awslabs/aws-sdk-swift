...
extension RedshiftDataClientTypes {
    ...
    public enum ResultFormatString: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        ...
        public static var allCases: [ResultFormatString] {
            return [
                .csv,
                .json
            ]
...
public struct DescribeStatementInput: Swift.Sendable {
...
extension RedshiftDataClientTypes {
    ...
    public enum StatusString: Swift.Sendable, Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case aborted
        case all
        case failed
        case finished
...
extension RedshiftDataClientTypes {
    ...
    public struct SubStatementData: Swift.Sendable {
        /// The date and time (UTC) the statement was created.
        public var createdAt: Foundation.Date?
...
public struct DescribeStatementOutput: Swift.Sendable {
...
extension RedshiftDataClientTypes {
    ...
    public enum Field: Swift.Sendable {
...
extension RedshiftDataClientTypes {
    ...
    public enum QueryRecords: Swift.Sendable {
        /// The results of the SQL statement in CSV format.
        case csvrecords(Swift.String)
        case sdkUnknown(Swift.String)
    }
}

public struct GetStatementResultInput: Swift.Sendable {
...
public struct GetStatementResultOutput: Swift.Sendable {
    /// The properties (metadata) of a column.
...
public struct GetStatementResultV2Input: Swift.Sendable {
    /// The identifier of the SQL statement whose results are to be fetched. This value is a universally unique identifier (UUID) generated by Amazon Redshift Data API. A suffix indicates then number of the SQL statement. For example, d9b6c0c9-0747-4bf4-b142-e8883122f766:2 has a suffix of :2 that indicates the second SQL statement of a batch query. This identifier is returned by BatchExecuteStatment, ExecuteStatment, and ListStatements.
    /// This member is required.
    public var id: Swift.String?
    /// A value that indicates the starting point for the next set of response records in a subsequent request. If a value is returned in a response, you can retrieve the next set of records by providing this returned NextToken value in the next NextToken parameter and retrying the command. If the NextToken field is empty, all response records have been retrieved for the request.
...
public struct GetStatementResultV2Output: Swift.Sendable {
    /// The properties (metadata) of a column.
    public var columnMetadata: [RedshiftDataClientTypes.ColumnMetadata]?
    /// A value that indicates the starting point for the next set of response records in a subsequent request. If a value is returned in a response, you can retrieve the next set of records by providing this returned NextToken value in the next NextToken parameter and retrying the command. If the NextToken field is empty, all response records have been retrieved for the request.
    public var nextToken: Swift.String?
    /// The results of the SQL statement in CSV format.
    /// This member is required.
    public var records: [RedshiftDataClientTypes.QueryRecords]?
    /// The data format of the result of the SQL statement.
    public var resultFormat: RedshiftDataClientTypes.ResultFormatString?
...
extension RedshiftDataClientTypes {
    ...
    public struct StatementData: Swift.Sendable {
        /// The date and time (UTC) the statement was created.
        public var createdAt: Foundation.Date?
        /// The SQL statement identifier. This value is a universally unique identifier (UUID) generated by Amazon Redshift Data API.
        /// This member is required.
...
extension RedshiftDataClientTypes {
    ...
    public struct TableMember: Swift.Sendable {
...
extension GetStatementResultV2Input {

    static func urlPathProvider(_ value: GetStatementResultV2Input) -> Swift.String? {
        return "/"
    }
}
...
extension GetStatementResultV2Input {
    ...
    static func write(value: GetStatementResultV2Input?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Id"].write(value.id)
        try writer["NextToken"].write(value.nextToken)
    }
...
extension GetStatementResultV2Output {

    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> GetStatementResultV2Output {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = GetStatementResultV2Output()
        value.columnMetadata = try reader["ColumnMetadata"].readListIfPresent(memberReadingClosure: RedshiftDataClientTypes.ColumnMetadata.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.records = try reader["Records"].readListIfPresent(memberReadingClosure: RedshiftDataClientTypes.QueryRecords.read(from:), memberNodeInfo: "member", isFlattened: false) ?? []
        value.resultFormat = try reader["ResultFormat"].readIfPresent()
        value.totalNumRows = try reader["TotalNumRows"].readIfPresent() ?? 0
        return value
    }
...
enum GetStatementResultV2OutputError {
...
extension RedshiftDataClientTypes.QueryRecords {

    static func read(from reader: SmithyJSON.Reader) throws -> RedshiftDataClientTypes.QueryRecords {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        let name = reader.children.filter { $0.hasContent && $0.nodeInfo.name != "__type" }.first?.nodeInfo.name
        switch name {
            case "CSVRecords":
                return .csvrecords(try reader["CSVRecords"].read())
            default:
                return .sdkUnknown(name ?? "")
        }
    }
