...
extension CloudSearchDomainClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CloudSearchDomainClient.CloudSearchDomainClientConfiguration {
        let clientConfiguration = try await CloudSearchDomainClient.CloudSearchDomainClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CloudSearchDomainClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CloudSearchDomainClient(config: configuration)
        }
    }
...
extension CloudSearchDomainClient.CloudSearchDomainClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
