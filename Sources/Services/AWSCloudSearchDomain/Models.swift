...
extension CloudSearchDomainClientTypes.Hit {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CloudSearchDomainClientTypes.Hit {
        ...
        value.fields = try reader["fields"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.exprs = try reader["exprs"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.highlights = try reader["highlights"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
