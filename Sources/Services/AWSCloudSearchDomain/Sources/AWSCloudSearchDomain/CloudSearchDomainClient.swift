...
public final class CloudSearchDomainClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: CloudSearchDomainClient.CloudSearchDomainClientConfig) instead")
    public convenience init(config: CloudSearchDomainClient.CloudSearchDomainClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try CloudSearchDomainClient.CloudSearchDomainClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await CloudSearchDomainClient.CloudSearchDomainClientConfig()
        self.init(config: config)
    }
}
...
extension CloudSearchDomainClient {
    ...
    /// Client configuration for CloudSearchDomainClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct CloudSearchDomainClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "CloudSearch Domain")
    ...
    @available(*, deprecated, message: "Use CloudSearchDomainClientConfig instead. This class will be removed in a future version.")
    public final class CloudSearchDomainClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> CloudSearchDomainClientConfig {
            return try CloudSearchDomainClientConfig(
...
extension CloudSearchDomainClient {
    ...
    public func search(input: SearchInput) async throws -> SearchOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "CloudSearch Domain"))
