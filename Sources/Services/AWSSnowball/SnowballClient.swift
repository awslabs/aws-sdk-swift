...
extension SnowballClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SnowballClient.SnowballClientConfiguration {
        let clientConfiguration = try await SnowballClient.SnowballClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SnowballClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SnowballClient(config: configuration)
        }
    }
...
extension SnowballClient.SnowballClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
