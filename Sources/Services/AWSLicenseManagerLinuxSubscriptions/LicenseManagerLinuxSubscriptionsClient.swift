...
extension LicenseManagerLinuxSubscriptionsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> LicenseManagerLinuxSubscriptionsClient.LicenseManagerLinuxSubscriptionsClientConfiguration {
        let clientConfiguration = try await LicenseManagerLinuxSubscriptionsClient.LicenseManagerLinuxSubscriptionsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> LicenseManagerLinuxSubscriptionsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return LicenseManagerLinuxSubscriptionsClient(config: configuration)
        }
    }
...
extension LicenseManagerLinuxSubscriptionsClient.LicenseManagerLinuxSubscriptionsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
