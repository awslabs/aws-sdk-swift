...
extension GetServiceSettingsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetServiceSettingsOutput {
        ...
        value.homeRegions = try reader["HomeRegions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.statusMessage = try reader["StatusMessage"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension LicenseManagerLinuxSubscriptionsClientTypes.Instance {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LicenseManagerLinuxSubscriptionsClientTypes.Instance {
        ...
        value.productCode = try reader["ProductCode"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
