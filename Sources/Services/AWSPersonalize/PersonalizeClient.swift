...
public class PersonalizeClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await PersonalizeClientConfiguration(region: region)
    ...
    public class PersonalizeClientConfiguration: PersonalizeClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("PersonalizeClient")
