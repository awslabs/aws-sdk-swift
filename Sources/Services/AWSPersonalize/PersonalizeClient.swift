...
extension PersonalizeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> PersonalizeClient.PersonalizeClientConfiguration {
        let clientConfiguration = try await PersonalizeClient.PersonalizeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> PersonalizeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return PersonalizeClient(config: configuration)
        }
    }
...
extension PersonalizeClient.PersonalizeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
