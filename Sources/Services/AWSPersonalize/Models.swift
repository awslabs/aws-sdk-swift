...
extension UpdateMetricAttributionInput {
    ...
    static func write(value: UpdateMetricAttributionInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["metricAttributionArn"].write(value.metricAttributionArn)
        try writer["metricsOutputConfig"].write(value.metricsOutputConfig, with: PersonalizeClientTypes.MetricAttributionOutput.write(value:to:))
        try writer["removeMetrics"].writeList(value.removeMetrics, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetSolutionMetricsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetSolutionMetricsOutput {
        ...
        value.metrics = try reader["metrics"].readMapIfPresent(valueReadingClosure: Swift.Double.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.solutionVersionArn = try reader["solutionVersionArn"].readIfPresent()
        return value
    }
}
...
extension PersonalizeClientTypes.Algorithm {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PersonalizeClientTypes.Algorithm {
        ...
        value.defaultHyperParameters = try reader["defaultHyperParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        ...
        value.defaultResourceConfig = try reader["defaultResourceConfig"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension PersonalizeClientTypes.BatchInferenceJobConfig {
    ...
    static func write(value: PersonalizeClientTypes.BatchInferenceJobConfig?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["itemExplorationConfig"].writeMap(value.itemExplorationConfig, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PersonalizeClientTypes.BatchInferenceJobConfig {
        ...
        value.itemExplorationConfig = try reader["itemExplorationConfig"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension PersonalizeClientTypes.FeatureTransformation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PersonalizeClientTypes.FeatureTransformation {
        ...
        value.defaultParameters = try reader["defaultParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.creationDateTime = try reader["creationDateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lastUpdatedDateTime = try reader["lastUpdatedDateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.status = try reader["status"].readIfPresent()
        return value
...
extension PersonalizeClientTypes.Recommender {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PersonalizeClientTypes.Recommender {
        ...
        value.modelMetrics = try reader["modelMetrics"].readMapIfPresent(valueReadingClosure: Swift.Double.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension PersonalizeClientTypes.TrainingDataConfig {
    ...
    static func write(value: PersonalizeClientTypes.TrainingDataConfig?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["excludedDatasetColumns"].writeMap(value.excludedDatasetColumns, valueWritingClosure: listWritingClosure(memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PersonalizeClientTypes.TrainingDataConfig {
        ...
        value.excludedDatasetColumns = try reader["excludedDatasetColumns"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension PersonalizeClientTypes.SolutionConfig {
    ...
    static func write(value: PersonalizeClientTypes.SolutionConfig?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["featureTransformationParameters"].writeMap(value.featureTransformationParameters, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PersonalizeClientTypes.SolutionConfig {
        ...
        value.algorithmHyperParameters = try reader["algorithmHyperParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.featureTransformationParameters = try reader["featureTransformationParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension PersonalizeClientTypes.AutoMLConfig {
    ...
    static func write(value: PersonalizeClientTypes.AutoMLConfig?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["recipeList"].writeList(value.recipeList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PersonalizeClientTypes.AutoMLConfig {
        ...
        value.recipeList = try reader["recipeList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
