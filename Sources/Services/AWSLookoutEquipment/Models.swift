...
extension LookoutEquipmentClientTypes {
    ...
    public enum AutoPromotionResult: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension LookoutEquipmentClientTypes {
    ...
    public enum DataUploadFrequency: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case pt10m
        case pt15m
        case pt1h
        case pt30m
...
extension LookoutEquipmentClientTypes {
    ...
    public enum ModelQuality: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension LookoutEquipmentClientTypes {
    ...
    public enum InferenceSchedulerStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case pending
        case running
        case stopped
        case stopping
...
extension LookoutEquipmentClientTypes {
    ...
    public enum LabelRating: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case anomaly
        case neutral
        case noAnomaly
        case sdkUnknown(Swift.String)
...
extension LookoutEquipmentClientTypes {
    ...
    public enum TargetSamplingRate: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case pt10m
        case pt10s
        case pt15m
        case pt15s
...
extension LookoutEquipmentClientTypes {
    ...
    public enum ModelPromoteMode: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case managed
        case manual
        case sdkUnknown(Swift.String)
...
extension LookoutEquipmentClientTypes {
    ...
    public enum RetrainingSchedulerStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case pending
        case running
        case stopped
        case stopping
...
extension LookoutEquipmentClientTypes {
    ...
    public enum LatestInferenceResult: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case anomalous
        case normal
        case sdkUnknown(Swift.String)
...
extension LookoutEquipmentClientTypes {
    ...
    public enum ModelVersionSourceType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case `import`
        case retraining
        case training
        case sdkUnknown(Swift.String)
...
extension LookoutEquipmentClientTypes {
    ...
    public enum InferenceDataImportStrategy: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case addWhenEmpty
        case noImport
        case overwrite
        case sdkUnknown(Swift.String)
...
extension LookoutEquipmentClientTypes {
    ...
    public enum InferenceExecutionStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case failed
        case inProgress
        case success
        case sdkUnknown(Swift.String)
...
extension LookoutEquipmentClientTypes {
    ...
    public enum StatisticalIssueStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
...
extension LookoutEquipmentClientTypes {
    ...
    public enum Monotonicity: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case decreasing
        case increasing
        case `static`
        case sdkUnknown(Swift.String)
...
extension CreateLabelGroupInput {
    ...
    static func write(value: CreateLabelGroupInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ClientToken"].write(value.clientToken)
        try writer["FaultCodes"].writeList(value.faultCodes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["LabelGroupName"].write(value.labelGroupName)
        try writer["Tags"].writeList(value.tags, memberWritingClosure: LookoutEquipmentClientTypes.Tag.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension CreateModelInput {
    ...
    static func write(value: CreateModelInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["DatasetName"].write(value.datasetName)
        try writer["DatasetSchema"].write(value.datasetSchema, with: LookoutEquipmentClientTypes.DatasetSchema.write(value:to:))
        try writer["EvaluationDataEndTime"].writeTimestamp(value.evaluationDataEndTime, format: .epochSeconds)
        try writer["EvaluationDataStartTime"].writeTimestamp(value.evaluationDataStartTime, format: .epochSeconds)
        ...
        try writer["ServerSideKmsKeyId"].write(value.serverSideKmsKeyId)
        try writer["Tags"].writeList(value.tags, memberWritingClosure: LookoutEquipmentClientTypes.Tag.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["TrainingDataEndTime"].writeTimestamp(value.trainingDataEndTime, format: .epochSeconds)
        try writer["TrainingDataStartTime"].writeTimestamp(value.trainingDataStartTime, format: .epochSeconds)
    }
}
...
extension ListInferenceEventsInput {
    ...
    static func write(value: ListInferenceEventsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["InferenceSchedulerName"].write(value.inferenceSchedulerName)
        try writer["IntervalEndTime"].writeTimestamp(value.intervalEndTime, format: .epochSeconds)
        try writer["IntervalStartTime"].writeTimestamp(value.intervalStartTime, format: .epochSeconds)
        try writer["MaxResults"].write(value.maxResults)
        try writer["NextToken"].write(value.nextToken)
    }
}
...
extension ListInferenceExecutionsInput {
    ...
    static func write(value: ListInferenceExecutionsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DataEndTimeBefore"].writeTimestamp(value.dataEndTimeBefore, format: .epochSeconds)
        try writer["DataStartTimeAfter"].writeTimestamp(value.dataStartTimeAfter, format: .epochSeconds)
        try writer["InferenceSchedulerName"].write(value.inferenceSchedulerName)
        try writer["MaxResults"].write(value.maxResults)
        try writer["NextToken"].write(value.nextToken)
        try writer["Status"].write(value.status)
...
extension ListModelVersionsInput {
    ...
    static func write(value: ListModelVersionsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CreatedAtEndTime"].writeTimestamp(value.createdAtEndTime, format: .epochSeconds)
        try writer["CreatedAtStartTime"].writeTimestamp(value.createdAtStartTime, format: .epochSeconds)
...
extension DescribeDataIngestionJobOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeDataIngestionJobOutput {
        ...
        value.dataEndTime = try reader["DataEndTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.dataStartTime = try reader["DataStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.datasetArn = try reader["DatasetArn"].readIfPresent()
...
extension DescribeLabelGroupOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeLabelGroupOutput {
        ...
        value.createdAt = try reader["CreatedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.faultCodes = try reader["FaultCodes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.labelGroupArn = try reader["LabelGroupArn"].readIfPresent()
        value.labelGroupName = try reader["LabelGroupName"].readIfPresent()
        value.updatedAt = try reader["UpdatedAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
...
extension DescribeModelOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeModelOutput {
        ...
        value.accumulatedInferenceDataEndTime = try reader["AccumulatedInferenceDataEndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.accumulatedInferenceDataStartTime = try reader["AccumulatedInferenceDataStartTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.datasetArn = try reader["DatasetArn"].readIfPresent()
        value.datasetName = try reader["DatasetName"].readIfPresent()
        value.evaluationDataEndTime = try reader["EvaluationDataEndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.evaluationDataStartTime = try reader["EvaluationDataStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.failedReason = try reader["FailedReason"].readIfPresent()
        value.importJobEndTime = try reader["ImportJobEndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.importJobStartTime = try reader["ImportJobStartTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.latestScheduledRetrainingStartTime = try reader["LatestScheduledRetrainingStartTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.modelName = try reader["ModelName"].readIfPresent()
        value.modelQuality = try reader["ModelQuality"].readIfPresent()
        value.modelVersionActivatedAt = try reader["ModelVersionActivatedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.nextScheduledRetrainingStartDate = try reader["NextScheduledRetrainingStartDate"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.previousModelVersionActivatedAt = try reader["PreviousModelVersionActivatedAt"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.status = try reader["Status"].readIfPresent()
        value.trainingDataEndTime = try reader["TrainingDataEndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.trainingDataStartTime = try reader["TrainingDataStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.trainingExecutionEndTime = try reader["TrainingExecutionEndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.trainingExecutionStartTime = try reader["TrainingExecutionStartTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DescribeRetrainingSchedulerOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeRetrainingSchedulerOutput {
        ...
        value.retrainingStartDate = try reader["RetrainingStartDate"].readTimestampIfPresent(format: .epochSeconds)
        value.status = try reader["Status"].readIfPresent()
        value.updatedAt = try reader["UpdatedAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
...
extension LookoutEquipmentClientTypes.InferenceExecutionSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LookoutEquipmentClientTypes.InferenceExecutionSummary {
        ...
        value.inferenceSchedulerName = try reader["InferenceSchedulerName"].readIfPresent()
        value.inferenceSchedulerArn = try reader["InferenceSchedulerArn"].readIfPresent()
        value.scheduledStartTime = try reader["ScheduledStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.dataStartTime = try reader["DataStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.dataEndTime = try reader["DataEndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.dataInputConfiguration = try reader["DataInputConfiguration"].readIfPresent(with: LookoutEquipmentClientTypes.InferenceInputConfiguration.read(from:))
        value.dataOutputConfiguration = try reader["DataOutputConfiguration"].readIfPresent(with: LookoutEquipmentClientTypes.InferenceOutputConfiguration.read(from:))
