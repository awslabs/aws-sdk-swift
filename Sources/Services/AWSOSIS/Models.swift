...
extension OSISClientTypes.Pipeline {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> OSISClientTypes.Pipeline {
        ...
        value.ingestEndpointUrls = try reader["IngestEndpointUrls"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
