...
extension SavingsplansClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SavingsplansClient.SavingsplansClientConfiguration {
        let clientConfiguration = try await SavingsplansClient.SavingsplansClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SavingsplansClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SavingsplansClient(config: configuration)
        }
    }
...
extension SavingsplansClient.SavingsplansClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
