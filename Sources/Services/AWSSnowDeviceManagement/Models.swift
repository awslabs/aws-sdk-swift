...
extension DescribeDeviceOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeDeviceOutput {
        ...
        value.lastReachedOutAt = try reader["lastReachedOutAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension DescribeExecutionOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeExecutionOutput {
        ...
        value.lastUpdatedAt = try reader["lastUpdatedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.managedDeviceId = try reader["managedDeviceId"].readIfPresent()
        value.startedAt = try reader["startedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension DescribeTaskOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeTaskOutput {
        ...
        value.completedAt = try reader["completedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.createdAt = try reader["createdAt"].readTimestampIfPresent(format: .epochSeconds)
        value.description = try reader["description"].readIfPresent()
        value.lastUpdatedAt = try reader["lastUpdatedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.state = try reader["state"].readIfPresent()
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.targets = try reader["targets"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.taskArn = try reader["taskArn"].readIfPresent()
        value.taskId = try reader["taskId"].readIfPresent()
        return value
    }
...
extension SnowDeviceManagementClientTypes.EbsInstanceBlockDevice {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SnowDeviceManagementClientTypes.EbsInstanceBlockDevice {
        ...
        value.attachTime = try reader["attachTime"].readTimestampIfPresent(format: .epochSeconds)
