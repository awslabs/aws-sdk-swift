...
public final class SnowDeviceManagementClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: SnowDeviceManagementClient.SnowDeviceManagementClientConfig) instead")
    public convenience init(config: SnowDeviceManagementClient.SnowDeviceManagementClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try SnowDeviceManagementClient.SnowDeviceManagementClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await SnowDeviceManagementClient.SnowDeviceManagementClientConfig()
        self.init(config: config)
    }
}
...
extension SnowDeviceManagementClient {
    ...
    /// Client configuration for SnowDeviceManagementClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct SnowDeviceManagementClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Snow Device Management")
    ...
    @available(*, deprecated, message: "Use SnowDeviceManagementClientConfig instead. This class will be removed in a future version.")
    public final class SnowDeviceManagementClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> SnowDeviceManagementClientConfig {
            return try SnowDeviceManagementClientConfig(
...
extension SnowDeviceManagementClient {
    ...
    public func cancelTask(input: CancelTaskInput) async throws -> CancelTaskOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Snow Device Management"))
