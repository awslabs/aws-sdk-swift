...
extension SnowDeviceManagementClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SnowDeviceManagementClient.SnowDeviceManagementClientConfiguration {
        let clientConfiguration = try await SnowDeviceManagementClient.SnowDeviceManagementClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SnowDeviceManagementClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SnowDeviceManagementClient(config: configuration)
        }
    }
...
extension SnowDeviceManagementClient.SnowDeviceManagementClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
