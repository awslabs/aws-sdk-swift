...
extension CreateEnvironmentInput {
    ...
    static func write(value: CreateEnvironmentInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["dataBundles"].writeList(value.dataBundles, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateKxVolumeOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateKxVolumeOutput {
        ...
        value.availabilityZoneIds = try reader["availabilityZoneIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.azMode = try reader["azMode"].readIfPresent()
        value.createdTimestamp = try reader["createdTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.description = try reader["description"].readIfPresent()
        value.environmentId = try reader["environmentId"].readIfPresent()
...
extension FinspaceClientTypes.FederationParameters {
    ...
    static func write(value: FinspaceClientTypes.FederationParameters?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["attributeMap"].writeMap(value.attributeMap, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> FinspaceClientTypes.FederationParameters {
        ...
        value.attributeMap = try reader["attributeMap"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension FinspaceClientTypes.KxDatabaseCacheConfiguration {
    ...
    static func write(value: FinspaceClientTypes.KxDatabaseCacheConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["dataviewName"].write(value.dataviewName)
        try writer["dbPaths"].writeList(value.dbPaths, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> FinspaceClientTypes.KxDatabaseCacheConfiguration {
        ...
        value.dbPaths = try reader["dbPaths"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.dataviewName = try reader["dataviewName"].readIfPresent()
        return value
    }
}
...
extension FinspaceClientTypes.KxDataviewActiveVersion {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> FinspaceClientTypes.KxDataviewActiveVersion {
        ...
        value.changesetId = try reader["changesetId"].readIfPresent()
        value.segmentConfigurations = try reader["segmentConfigurations"].readListIfPresent(memberReadingClosure: FinspaceClientTypes.KxDataviewSegmentConfiguration.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.attachedClusters = try reader["attachedClusters"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.createdTimestamp = try reader["createdTimestamp"].readTimestampIfPresent(format: .epochSeconds)
...
extension FinspaceClientTypes.TickerplantLogConfiguration {
    ...
    static func write(value: FinspaceClientTypes.TickerplantLogConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["tickerplantLogVolumes"].writeList(value.tickerplantLogVolumes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> FinspaceClientTypes.TickerplantLogConfiguration {
        ...
        value.tickerplantLogVolumes = try reader["tickerplantLogVolumes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
