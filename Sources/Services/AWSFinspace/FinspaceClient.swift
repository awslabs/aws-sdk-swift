...
extension FinspaceClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> FinspaceClient.FinspaceClientConfiguration {
        let clientConfiguration = try await FinspaceClient.FinspaceClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> FinspaceClient {
            let configuration = try await resolve(plugins: self.plugins)
            return FinspaceClient(config: configuration)
        }
    }
...
extension FinspaceClient.FinspaceClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
