...
public final class GeoPlacesClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "GeoPlacesClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: GeoPlacesClient.GeoPlacesClientConfig
    let serviceName = "Geo Places"

    @available(*, deprecated, message: "Use GeoPlacesClient.GeoPlacesClientConfig instead")
    public typealias Config = GeoPlacesClient.GeoPlacesClientConfiguration
    public typealias Configuration = GeoPlacesClient.GeoPlacesClientConfig

    public required init(config: GeoPlacesClient.GeoPlacesClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: GeoPlacesClient.GeoPlacesClientConfig) instead")
    public convenience init(config: GeoPlacesClient.GeoPlacesClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try GeoPlacesClient.GeoPlacesClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await GeoPlacesClient.GeoPlacesClientConfig()
        self.init(config: config)
    }
}
...
extension GeoPlacesClient {
    ...
    /// Client configuration for GeoPlacesClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct GeoPlacesClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Geo Places")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultGeoPlacesAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: GeoPlacesClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultGeoPlacesAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use GeoPlacesClientConfig instead. This class will be removed in a future version.")
    public final class GeoPlacesClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> GeoPlacesClientConfig {
            return try GeoPlacesClientConfig(
...
extension GeoPlacesClient {
    ...
    public func autocomplete(input: AutocompleteInput) async throws -> AutocompleteOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Geo Places", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<AutocompleteOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Geo Places"))
    ...
    public func geocode(input: GeocodeInput) async throws -> GeocodeOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GeocodeOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func reverseGeocode(input: ReverseGeocodeInput) async throws -> ReverseGeocodeOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ReverseGeocodeOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func searchNearby(input: SearchNearbyInput) async throws -> SearchNearbyOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SearchNearbyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func searchText(input: SearchTextInput) async throws -> SearchTextOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SearchTextOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
