...
public final class GeoPlacesClient: AWSClientRuntime.AWSServiceClient, Sendable {
...
extension GeoPlacesClient {
    ...
    public final class GeoPlacesClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, @unchecked Sendable {
        ...
        public convenience init(region: Swift.String) throws {
            self.init(
                ...
                nil,
                DefaultGeoPlacesAuthSchemeResolver(),
