...
extension ForecastqueryClient {
    ...
    public struct ForecastqueryClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "forecastquery")
...
extension ForecastqueryClient {
    ...
    public func queryForecast(input: QueryForecastInput) async throws -> QueryForecastOutput {
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<QueryForecastInput, QueryForecastOutput>(overrides: ["X-Amz-Target": "AmazonForecastRuntime.QueryForecast"]))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "forecastquery"))
    ...
    public func queryWhatIfForecast(input: QueryWhatIfForecastInput) async throws -> QueryWhatIfForecastOutput {
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<QueryWhatIfForecastInput, QueryWhatIfForecastOutput>(overrides: ["X-Amz-Target": "AmazonForecastRuntime.QueryWhatIfForecast"]))
