...
extension HealthLakeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> HealthLakeClient.HealthLakeClientConfiguration {
        let clientConfiguration = try await HealthLakeClient.HealthLakeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> HealthLakeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return HealthLakeClient(config: configuration)
        }
    }
...
extension HealthLakeClient.HealthLakeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
