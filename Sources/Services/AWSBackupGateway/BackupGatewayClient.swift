...
extension BackupGatewayClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> BackupGatewayClient.BackupGatewayClientConfiguration {
        let clientConfiguration = try await BackupGatewayClient.BackupGatewayClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> BackupGatewayClient {
            let configuration = try await resolve(plugins: self.plugins)
            return BackupGatewayClient(config: configuration)
        }
    }
...
extension BackupGatewayClient.BackupGatewayClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
