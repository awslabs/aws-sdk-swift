...
extension SSOAdminClientTypes.AccessControlAttributeValue {
    ...
    static func write(value: SSOAdminClientTypes.AccessControlAttributeValue?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Source"].writeList(value.source, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSOAdminClientTypes.AccessControlAttributeValue {
        ...
        value.source = try reader["Source"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SSOAdminClientTypes.AccountAssignment {
    ...
    static func write(value: SSOAdminClientTypes.AccountAssignment?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension SSOAdminClientTypes.AccountAssignmentForPrincipal {
    ...
    static func write(value: SSOAdminClientTypes.AccountAssignmentForPrincipal?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AccountId"].write(value.accountId)
        try writer["PermissionSetArn"].write(value.permissionSetArn)
        try writer["PrincipalId"].write(value.principalId)
...
extension SSOAdminClientTypes.AccountAssignmentOperationStatus {
    ...
    static func write(value: SSOAdminClientTypes.AccountAssignmentOperationStatus?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension SSOAdminClientTypes.AccountAssignmentOperationStatusMetadata {
    ...
    static func write(value: SSOAdminClientTypes.AccountAssignmentOperationStatusMetadata?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CreatedDate"].writeTimestamp(value.createdDate, format: .epochSeconds)
        try writer["RequestId"].write(value.requestId)
        try writer["Status"].write(value.status)
...
extension SSOAdminClientTypes.Application {
    ...
    static func write(value: SSOAdminClientTypes.Application?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension SSOAdminClientTypes.ApplicationAssignment {
    ...
    static func write(value: SSOAdminClientTypes.ApplicationAssignment?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ApplicationArn"].write(value.applicationArn)
        try writer["PrincipalId"].write(value.principalId)
        try writer["PrincipalType"].write(value.principalType)
...
extension SSOAdminClientTypes.ApplicationAssignmentForPrincipal {
    ...
    static func write(value: SSOAdminClientTypes.ApplicationAssignmentForPrincipal?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ApplicationArn"].write(value.applicationArn)
        try writer["PrincipalId"].write(value.principalId)
        try writer["PrincipalType"].write(value.principalType)
...
extension SSOAdminClientTypes.ApplicationProvider {
    ...
    static func write(value: SSOAdminClientTypes.ApplicationProvider?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ApplicationProviderArn"].write(value.applicationProviderArn)
        try writer["DisplayData"].write(value.displayData, with: SSOAdminClientTypes.DisplayData.write(value:to:))
        try writer["FederationProtocol"].write(value.federationProtocol)
        try writer["ResourceServerConfig"].write(value.resourceServerConfig, with: SSOAdminClientTypes.ResourceServerConfig.write(value:to:))
    }
...
extension AttachCustomerManagedPolicyReferenceToPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AttachCustomerManagedPolicyReferenceToPermissionSetOutput {
...
extension AttachManagedPolicyToPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AttachManagedPolicyToPermissionSetOutput {
...
extension SSOAdminClientTypes.AttachedManagedPolicy {
    ...
    static func write(value: SSOAdminClientTypes.AttachedManagedPolicy?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension SSOAdminClientTypes.AuthenticationMethodItem {
    ...
    static func write(value: SSOAdminClientTypes.AuthenticationMethodItem?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension SSOAdminClientTypes.AuthorizationCodeGrant {
    ...
    static func write(value: SSOAdminClientTypes.AuthorizationCodeGrant?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["RedirectUris"].writeList(value.redirectUris, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSOAdminClientTypes.AuthorizationCodeGrant {
        ...
        value.redirectUris = try reader["RedirectUris"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SSOAdminClientTypes.AuthorizedTokenIssuer {
    ...
    static func write(value: SSOAdminClientTypes.AuthorizedTokenIssuer?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AuthorizedAudiences"].writeList(value.authorizedAudiences, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSOAdminClientTypes.AuthorizedTokenIssuer {
        ...
        value.authorizedAudiences = try reader["AuthorizedAudiences"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CreateAccountAssignmentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateAccountAssignmentOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
...
extension CreateApplicationAssignmentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateApplicationAssignmentOutput {
...
extension CreateInstanceAccessControlAttributeConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateInstanceAccessControlAttributeConfigurationOutput {
...
extension CreateInstanceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateInstanceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreatePermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreatePermissionSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension CreateTrustedTokenIssuerOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateTrustedTokenIssuerOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteAccountAssignmentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteAccountAssignmentOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DeleteApplicationAccessScopeOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteApplicationAccessScopeOutput {
...
extension DeleteApplicationAssignmentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteApplicationAssignmentOutput {
...
extension DeleteApplicationAuthenticationMethodOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteApplicationAuthenticationMethodOutput {
...
extension DeleteApplicationGrantOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteApplicationGrantOutput {
...
extension DeleteInlinePolicyFromPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteInlinePolicyFromPermissionSetOutput {
...
extension DeleteInstanceAccessControlAttributeConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteInstanceAccessControlAttributeConfigurationOutput {
...
extension DeleteInstanceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteInstanceOutput {
...
extension DeletePermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeletePermissionSetOutput {
...
extension DeletePermissionsBoundaryFromPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeletePermissionsBoundaryFromPermissionSetOutput {
...
extension DeleteTrustedTokenIssuerOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeleteTrustedTokenIssuerOutput {
...
extension DescribeAccountAssignmentCreationStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeAccountAssignmentCreationStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeAccountAssignmentDeletionStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeAccountAssignmentDeletionStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeApplicationAssignmentOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeApplicationAssignmentOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeApplicationProviderOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeApplicationProviderOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeInstanceAccessControlAttributeConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeInstanceAccessControlAttributeConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeInstanceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeInstanceOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribePermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribePermissionSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribePermissionSetProvisioningStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribePermissionSetProvisioningStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DescribeTrustedTokenIssuerOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeTrustedTokenIssuerOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension DetachCustomerManagedPolicyReferenceFromPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DetachCustomerManagedPolicyReferenceFromPermissionSetOutput {
...
extension DetachManagedPolicyFromPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DetachManagedPolicyFromPermissionSetOutput {
...
extension SSOAdminClientTypes.DisplayData {
    ...
    static func write(value: SSOAdminClientTypes.DisplayData?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Description"].write(value.description)
...
extension GetApplicationAccessScopeOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetApplicationAccessScopeOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = GetApplicationAccessScopeOutput()
        value.authorizedTargets = try reader["AuthorizedTargets"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension GetApplicationAssignmentConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetApplicationAssignmentConfigurationOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetApplicationAuthenticationMethodOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetApplicationAuthenticationMethodOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetApplicationGrantOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetApplicationGrantOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetInlinePolicyForPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetInlinePolicyForPermissionSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension GetPermissionsBoundaryForPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetPermissionsBoundaryForPermissionSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SSOAdminClientTypes.GrantItem {
    ...
    static func write(value: SSOAdminClientTypes.GrantItem?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
...
extension SSOAdminClientTypes.InstanceMetadata {
    ...
    static func write(value: SSOAdminClientTypes.InstanceMetadata?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CreatedDate"].writeTimestamp(value.createdDate, format: .epochSeconds)
...
extension ListAccountAssignmentCreationStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAccountAssignmentCreationStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListAccountAssignmentDeletionStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAccountAssignmentDeletionStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SSOAdminClientTypes.ListAccountAssignmentsFilter {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSOAdminClientTypes.ListAccountAssignmentsFilter {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SSOAdminClientTypes.ListAccountAssignmentsFilter()
        value.accountId = try reader["AccountId"].readIfPresent()
        return value
    }
}
...
extension ListAccountAssignmentsForPrincipalOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAccountAssignmentsForPrincipalOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListAccountAssignmentsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAccountAssignmentsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListAccountsForProvisionedPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListAccountsForProvisionedPermissionSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListApplicationAccessScopesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListApplicationAccessScopesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SSOAdminClientTypes.ListApplicationAssignmentsFilter {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSOAdminClientTypes.ListApplicationAssignmentsFilter {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SSOAdminClientTypes.ListApplicationAssignmentsFilter()
        value.applicationArn = try reader["ApplicationArn"].readIfPresent()
        return value
    }
}
...
extension ListApplicationAssignmentsForPrincipalOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListApplicationAssignmentsForPrincipalOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListApplicationAssignmentsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListApplicationAssignmentsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListApplicationAuthenticationMethodsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListApplicationAuthenticationMethodsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListApplicationGrantsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListApplicationGrantsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListApplicationProvidersOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListApplicationProvidersOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SSOAdminClientTypes.ListApplicationsFilter {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSOAdminClientTypes.ListApplicationsFilter {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SSOAdminClientTypes.ListApplicationsFilter()
        value.applicationAccount = try reader["ApplicationAccount"].readIfPresent()
        value.applicationProvider = try reader["ApplicationProvider"].readIfPresent()
        return value
    }
}
...
extension ListCustomerManagedPolicyReferencesInPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListCustomerManagedPolicyReferencesInPermissionSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListInstancesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListInstancesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListManagedPoliciesInPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListManagedPoliciesInPermissionSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListPermissionSetProvisioningStatusOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListPermissionSetProvisioningStatusOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListPermissionSetsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListPermissionSetsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = ListPermissionSetsOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.permissionSets = try reader["PermissionSets"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListPermissionSetsProvisionedToAccountOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListPermissionSetsProvisionedToAccountOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension ListTrustedTokenIssuersOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListTrustedTokenIssuersOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension SSOAdminClientTypes.OidcJwtUpdateConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSOAdminClientTypes.OidcJwtUpdateConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SSOAdminClientTypes.OidcJwtUpdateConfiguration()
        value.claimAttributePath = try reader["ClaimAttributePath"].readIfPresent()
        value.identityStoreAttributePath = try reader["IdentityStoreAttributePath"].readIfPresent()
        value.jwksRetrievalOption = try reader["JwksRetrievalOption"].readIfPresent()
        return value
...
extension SSOAdminClientTypes.OperationStatusFilter {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSOAdminClientTypes.OperationStatusFilter {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SSOAdminClientTypes.OperationStatusFilter()
        value.status = try reader["Status"].readIfPresent()
        return value
    }
}
...
extension SSOAdminClientTypes.PermissionSet {
    ...
    static func write(value: SSOAdminClientTypes.PermissionSet?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CreatedDate"].writeTimestamp(value.createdDate, format: .epochSeconds)
        try writer["Description"].write(value.description)
        try writer["Name"].write(value.name)
...
extension SSOAdminClientTypes.PermissionSetProvisioningStatus {
    ...
    static func write(value: SSOAdminClientTypes.PermissionSetProvisioningStatus?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AccountId"].write(value.accountId)
        try writer["CreatedDate"].writeTimestamp(value.createdDate, format: .epochSeconds)
        try writer["FailureReason"].write(value.failureReason)
...
extension SSOAdminClientTypes.PermissionSetProvisioningStatusMetadata {
    ...
    static func write(value: SSOAdminClientTypes.PermissionSetProvisioningStatusMetadata?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CreatedDate"].writeTimestamp(value.createdDate, format: .epochSeconds)
        try writer["RequestId"].write(value.requestId)
        try writer["Status"].write(value.status)
...
extension ProvisionPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ProvisionPermissionSetOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension PutApplicationAccessScopeOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutApplicationAccessScopeOutput {
...
extension PutApplicationAssignmentConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutApplicationAssignmentConfigurationOutput {
...
extension PutApplicationAuthenticationMethodOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutApplicationAuthenticationMethodOutput {
...
extension PutApplicationGrantOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutApplicationGrantOutput {
...
extension PutInlinePolicyToPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutInlinePolicyToPermissionSetOutput {
...
extension PutPermissionsBoundaryToPermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> PutPermissionsBoundaryToPermissionSetOutput {
...
extension SSOAdminClientTypes.ResourceServerConfig {
    ...
    static func write(value: SSOAdminClientTypes.ResourceServerConfig?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Scopes"].writeMap(value.scopes, valueWritingClosure: SSOAdminClientTypes.ResourceServerScopeDetails.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
...
extension SSOAdminClientTypes.ResourceServerScopeDetails {
    ...
    static func write(value: SSOAdminClientTypes.ResourceServerScopeDetails?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DetailedTitle"].write(value.detailedTitle)
...
extension SSOAdminClientTypes.ScopeDetails {
    ...
    static func write(value: SSOAdminClientTypes.ScopeDetails?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AuthorizedTargets"].writeList(value.authorizedTargets, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Scope"].write(value.scope)
    }
...
extension SSOAdminClientTypes.TrustedTokenIssuerMetadata {
    ...
    static func write(value: SSOAdminClientTypes.TrustedTokenIssuerMetadata?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Name"].write(value.name)
        try writer["TrustedTokenIssuerArn"].write(value.trustedTokenIssuerArn)
        try writer["TrustedTokenIssuerType"].write(value.trustedTokenIssuerType)
...
extension SSOAdminClientTypes.TrustedTokenIssuerUpdateConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSOAdminClientTypes.TrustedTokenIssuerUpdateConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        let name = reader.children.filter { $0.hasContent && $0.nodeInfo.name != "__type" }.first?.nodeInfo.name
        switch name {
            case "OidcJwtConfiguration":
                return .oidcjwtconfiguration(try reader["OidcJwtConfiguration"].read(with: SSOAdminClientTypes.OidcJwtUpdateConfiguration.read(from:)))
            default:
                return .sdkUnknown(name ?? "")
        }
    }
...
extension SSOAdminClientTypes.UpdateApplicationPortalOptions {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SSOAdminClientTypes.UpdateApplicationPortalOptions {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = SSOAdminClientTypes.UpdateApplicationPortalOptions()
        value.signInOptions = try reader["SignInOptions"].readIfPresent(with: SSOAdminClientTypes.SignInOptions.read(from:))
        return value
    }
}
...
extension UpdateInstanceAccessControlAttributeConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateInstanceAccessControlAttributeConfigurationOutput {
...
extension UpdateInstanceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateInstanceOutput {
...
extension UpdatePermissionSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdatePermissionSetOutput {
...
extension UpdateTrustedTokenIssuerOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateTrustedTokenIssuerOutput {
