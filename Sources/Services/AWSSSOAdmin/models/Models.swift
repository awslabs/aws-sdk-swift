...
struct AttachCustomerManagedPolicyReferenceToPermissionSetInputBody {
...
struct AttachManagedPolicyToPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
...
struct CreateAccountAssignmentInputBody {
    let instanceArn: Swift.String?
...
struct CreateAccountAssignmentOutputBody {
...
struct CreateApplicationAssignmentInputBody {
...
struct CreateInstanceAccessControlAttributeConfigurationInputBody {
    let instanceArn: Swift.String?
...
struct CreatePermissionSetInputBody {
    let name: Swift.String?
    let description: Swift.String?
    let instanceArn: Swift.String?
...
struct CreatePermissionSetOutputBody {
...
struct CreateTrustedTokenIssuerInputBody {
    let instanceArn: Swift.String?
    let name: Swift.String?
...
struct CreateTrustedTokenIssuerOutputBody {
...
struct DeleteAccountAssignmentInputBody {
    let instanceArn: Swift.String?
    let targetId: Swift.String?
    let targetType: SSOAdminClientTypes.TargetType?
    let permissionSetArn: Swift.String?
...
struct DeleteAccountAssignmentOutputBody {
...
struct DeleteApplicationAccessScopeInputBody {
    let applicationArn: Swift.String?
...
struct DeleteApplicationAssignmentInputBody {
    let applicationArn: Swift.String?
    let principalId: Swift.String?
    let principalType: SSOAdminClientTypes.PrincipalType?
}
...
struct DeleteApplicationAuthenticationMethodInputBody {
    let applicationArn: Swift.String?
...
struct DeleteApplicationGrantInputBody {
    let applicationArn: Swift.String?
...
struct DeleteInlinePolicyFromPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
}
...
struct DeleteInstanceAccessControlAttributeConfigurationInputBody {
    let instanceArn: Swift.String?
}
...
struct DeletePermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
}
...
struct DeletePermissionsBoundaryFromPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
}
...
struct DeleteTrustedTokenIssuerInputBody {
    let trustedTokenIssuerArn: Swift.String?
}
...
struct DescribeAccountAssignmentCreationStatusInputBody {
    let instanceArn: Swift.String?
...
struct DescribeAccountAssignmentCreationStatusOutputBody {
    let accountAssignmentCreationStatus: SSOAdminClientTypes.AccountAssignmentOperationStatus?
}
...
struct DescribeAccountAssignmentDeletionStatusInputBody {
    let instanceArn: Swift.String?
...
struct DescribeAccountAssignmentDeletionStatusOutputBody {
    let accountAssignmentDeletionStatus: SSOAdminClientTypes.AccountAssignmentOperationStatus?
}
...
struct DescribeApplicationAssignmentInputBody {
    let applicationArn: Swift.String?
    let principalId: Swift.String?
    let principalType: SSOAdminClientTypes.PrincipalType?
}
...
struct DescribeApplicationAssignmentOutputBody {
    let principalType: SSOAdminClientTypes.PrincipalType?
    let principalId: Swift.String?
    let applicationArn: Swift.String?
}
...
struct DescribeApplicationProviderInputBody {
    let applicationProviderArn: Swift.String?
}
...
struct DescribeApplicationProviderOutputBody {
    let applicationProviderArn: Swift.String?
...
struct DescribeInstanceAccessControlAttributeConfigurationInputBody {
    let instanceArn: Swift.String?
}
...
struct DescribeInstanceAccessControlAttributeConfigurationOutputBody {
...
struct DescribePermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
}
...
struct DescribePermissionSetOutputBody {
    let permissionSet: SSOAdminClientTypes.PermissionSet?
}
...
struct DescribePermissionSetProvisioningStatusInputBody {
    let instanceArn: Swift.String?
...
struct DescribePermissionSetProvisioningStatusOutputBody {
...
struct DescribeTrustedTokenIssuerInputBody {
    let trustedTokenIssuerArn: Swift.String?
}
...
struct DescribeTrustedTokenIssuerOutputBody {
    let trustedTokenIssuerArn: Swift.String?
    let name: Swift.String?
    let trustedTokenIssuerType: SSOAdminClientTypes.TrustedTokenIssuerType?
    let trustedTokenIssuerConfiguration: SSOAdminClientTypes.TrustedTokenIssuerConfiguration?
...
struct DetachCustomerManagedPolicyReferenceFromPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
    let customerManagedPolicyReference: SSOAdminClientTypes.CustomerManagedPolicyReference?
}
...
struct DetachManagedPolicyFromPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
    let managedPolicyArn: Swift.String?
}
...
struct GetApplicationAccessScopeInputBody {
    let applicationArn: Swift.String?
    let scope: Swift.String?
}
...
struct GetApplicationAccessScopeOutputBody {
    let scope: Swift.String?
...
struct GetApplicationAssignmentConfigurationInputBody {
    let applicationArn: Swift.String?
}
...
struct GetApplicationAssignmentConfigurationOutputBody {
...
struct GetApplicationAuthenticationMethodInputBody {
    let applicationArn: Swift.String?
    let authenticationMethodType: SSOAdminClientTypes.AuthenticationMethodType?
}
...
struct GetApplicationAuthenticationMethodOutputBody {
...
struct GetApplicationGrantInputBody {
    let applicationArn: Swift.String?
    let grantType: SSOAdminClientTypes.GrantType?
}
...
struct GetApplicationGrantOutputBody {
...
struct GetInlinePolicyForPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
}
...
struct GetInlinePolicyForPermissionSetOutputBody {
...
struct GetPermissionsBoundaryForPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
}
...
struct GetPermissionsBoundaryForPermissionSetOutputBody {
...
struct ListAccountAssignmentCreationStatusInputBody {
    let instanceArn: Swift.String?
...
struct ListAccountAssignmentCreationStatusOutputBody {
...
struct ListAccountAssignmentDeletionStatusInputBody {
    let instanceArn: Swift.String?
    let maxResults: Swift.Int?
    let nextToken: Swift.String?
    let filter: SSOAdminClientTypes.OperationStatusFilter?
...
struct ListAccountAssignmentDeletionStatusOutputBody {
...
struct ListAccountAssignmentsForPrincipalInputBody {
    let instanceArn: Swift.String?
    let principalId: Swift.String?
    let principalType: SSOAdminClientTypes.PrincipalType?
...
struct ListAccountAssignmentsForPrincipalOutputBody {
...
struct ListAccountAssignmentsInputBody {
    let instanceArn: Swift.String?
...
struct ListAccountAssignmentsOutputBody {
...
struct ListAccountsForProvisionedPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
...
struct ListAccountsForProvisionedPermissionSetOutputBody {
...
struct ListApplicationAccessScopesInputBody {
    let applicationArn: Swift.String?
    let maxResults: Swift.Int?
    let nextToken: Swift.String?
}
...
struct ListApplicationAccessScopesOutputBody {
...
struct ListApplicationAssignmentsForPrincipalInputBody {
    let instanceArn: Swift.String?
    let principalId: Swift.String?
    let principalType: SSOAdminClientTypes.PrincipalType?
...
struct ListApplicationAssignmentsForPrincipalOutputBody {
...
struct ListApplicationAssignmentsInputBody {
    let applicationArn: Swift.String?
    let maxResults: Swift.Int?
    let nextToken: Swift.String?
}
...
struct ListApplicationAssignmentsOutputBody {
...
struct ListApplicationAuthenticationMethodsInputBody {
    let applicationArn: Swift.String?
    let nextToken: Swift.String?
}
...
struct ListApplicationAuthenticationMethodsOutputBody {
...
struct ListApplicationGrantsInputBody {
    let applicationArn: Swift.String?
    let nextToken: Swift.String?
}
...
struct ListApplicationGrantsOutputBody {
...
struct ListApplicationProvidersInputBody {
    let maxResults: Swift.Int?
    let nextToken: Swift.String?
}
...
struct ListApplicationProvidersOutputBody {
...
struct ListCustomerManagedPolicyReferencesInPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
    let maxResults: Swift.Int?
    let nextToken: Swift.String?
...
struct ListCustomerManagedPolicyReferencesInPermissionSetOutputBody {
...
struct ListManagedPoliciesInPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
    let maxResults: Swift.Int?
    let nextToken: Swift.String?
...
struct ListManagedPoliciesInPermissionSetOutputBody {
...
struct ListPermissionSetProvisioningStatusInputBody {
    let instanceArn: Swift.String?
    let maxResults: Swift.Int?
    let nextToken: Swift.String?
    let filter: SSOAdminClientTypes.OperationStatusFilter?
...
struct ListPermissionSetProvisioningStatusOutputBody {
...
struct ListPermissionSetsInputBody {
    let instanceArn: Swift.String?
    let nextToken: Swift.String?
    let maxResults: Swift.Int?
}
...
struct ListPermissionSetsOutputBody {
...
struct ListPermissionSetsProvisionedToAccountInputBody {
    let instanceArn: Swift.String?
    let accountId: Swift.String?
    let provisioningStatus: SSOAdminClientTypes.ProvisioningStatus?
    let maxResults: Swift.Int?
...
struct ListPermissionSetsProvisionedToAccountOutputBody {
    let nextToken: Swift.String?
    let permissionSets: [Swift.String]?
}
...
struct ListTrustedTokenIssuersInputBody {
    let instanceArn: Swift.String?
    let maxResults: Swift.Int?
    let nextToken: Swift.String?
}
...
struct ListTrustedTokenIssuersOutputBody {
...
struct ProvisionPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
    let targetId: Swift.String?
...
struct ProvisionPermissionSetOutputBody {
    let permissionSetProvisioningStatus: SSOAdminClientTypes.PermissionSetProvisioningStatus?
}
...
struct PutApplicationAccessScopeInputBody {
    let scope: Swift.String?
    let authorizedTargets: [Swift.String]?
    let applicationArn: Swift.String?
}
...
struct PutApplicationAssignmentConfigurationInputBody {
    let applicationArn: Swift.String?
    let assignmentRequired: Swift.Bool?
}
...
struct PutApplicationAuthenticationMethodInputBody {
    let applicationArn: Swift.String?
    let authenticationMethodType: SSOAdminClientTypes.AuthenticationMethodType?
    let authenticationMethod: SSOAdminClientTypes.AuthenticationMethod?
}
...
struct PutApplicationGrantInputBody {
    let applicationArn: Swift.String?
    let grantType: SSOAdminClientTypes.GrantType?
    let grant: SSOAdminClientTypes.Grant?
}
...
struct PutInlinePolicyToPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
    let inlinePolicy: Swift.String?
}
...
struct PutPermissionsBoundaryToPermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
    let permissionsBoundary: SSOAdminClientTypes.PermissionsBoundary?
}
...
struct UpdateInstanceAccessControlAttributeConfigurationInputBody {
    let instanceArn: Swift.String?
    let instanceAccessControlAttributeConfiguration: SSOAdminClientTypes.InstanceAccessControlAttributeConfiguration?
}
...
struct UpdatePermissionSetInputBody {
    let instanceArn: Swift.String?
    let permissionSetArn: Swift.String?
    let description: Swift.String?
    let sessionDuration: Swift.String?
...
struct UpdateTrustedTokenIssuerInputBody {
    let trustedTokenIssuerArn: Swift.String?
    let name: Swift.String?
