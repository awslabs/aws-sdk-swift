...
extension AccessAnalyzerClientTypes.RdsDbSnapshotAttributeValue {
    ...
    static func write(value: AccessAnalyzerClientTypes.RdsDbSnapshotAttributeValue?, to writer: SmithyJSON.Writer) throws {
        ...
        switch value {
            case let .accountids(accountids):
                try writer["accountIds"].writeList(accountids, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .sdkUnknown(sdkUnknown):
                try writer["sdkUnknown"].write(sdkUnknown)
        }
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AccessAnalyzerClientTypes.RdsDbSnapshotAttributeValue {
        ...
        switch name {
            case "accountIds":
                return .accountids(try reader["accountIds"].readList(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false))
            default:
                return .sdkUnknown(name ?? "")
        }
    }
...
extension AccessAnalyzerClientTypes.KmsKeyConfiguration {
    ...
    static func write(value: AccessAnalyzerClientTypes.KmsKeyConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["keyPolicies"].writeMap(value.keyPolicies, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AccessAnalyzerClientTypes.KmsKeyConfiguration {
        ...
        value.keyPolicies = try reader["keyPolicies"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension AccessAnalyzerClientTypes.KmsGrantConfiguration {
    ...
    static func write(value: AccessAnalyzerClientTypes.KmsGrantConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["operations"].writeList(value.operations, memberWritingClosure: AccessAnalyzerClientTypes.KmsGrantOperation.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AccessAnalyzerClientTypes.KmsGrantConfiguration {
        ...
        value.operations = try reader["operations"].readListIfPresent(memberReadingClosure: AccessAnalyzerClientTypes.KmsGrantOperation.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AccessAnalyzerClientTypes.AnalyzedResource {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AccessAnalyzerClientTypes.AnalyzedResource {
        ...
        value.sharedVia = try reader["sharedVia"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["status"].readIfPresent()
        value.resourceOwnerAccount = try reader["resourceOwnerAccount"].readIfPresent()
        value.error = try reader["error"].readIfPresent()
        return value
...
extension AccessAnalyzerClientTypes.Criterion {
    ...
    static func write(value: AccessAnalyzerClientTypes.Criterion?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["contains"].writeList(value.contains, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AccessAnalyzerClientTypes.Criterion {
        ...
        value.contains = try reader["contains"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AccessAnalyzerClientTypes.Finding {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AccessAnalyzerClientTypes.Finding {
        ...
        value.id = try reader["id"].readIfPresent()
        value.principal = try reader["principal"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.action = try reader["action"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.resource = try reader["resource"].readIfPresent()
        value.isPublic = try reader["isPublic"].readIfPresent()
        value.resourceType = try reader["resourceType"].readIfPresent()
        value.condition = try reader["condition"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.createdAt = try reader["createdAt"].readTimestampIfPresent(format: .dateTime)
        value.analyzedAt = try reader["analyzedAt"].readTimestampIfPresent(format: .dateTime)
        value.updatedAt = try reader["updatedAt"].readTimestampIfPresent(format: .dateTime)
        value.status = try reader["status"].readIfPresent()
