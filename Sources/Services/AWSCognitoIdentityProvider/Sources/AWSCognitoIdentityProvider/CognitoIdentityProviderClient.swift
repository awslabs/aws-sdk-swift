...
public final class CognitoIdentityProviderClient: AWSClientRuntime.AWSServiceClient {
    ...
    public typealias Configuration = CognitoIdentityProviderClient.CognitoIdentityProviderClientConfig

    public required init(config: CognitoIdentityProviderClient.CognitoIdentityProviderClientConfig) {
    ...
    public convenience init(config: CognitoIdentityProviderClient.CognitoIdentityProviderClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try CognitoIdentityProviderClient.CognitoIdentityProviderClientConfig(region: region)
...
extension CognitoIdentityProviderClient {
    ...
    /// Client configuration for CognitoIdentityProviderClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct CognitoIdentityProviderClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: CognitoIdentityProviderClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use CognitoIdentityProviderClientConfig instead. This class will be removed in a future version.")
    public final class CognitoIdentityProviderClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> CognitoIdentityProviderClientConfig {
            return try CognitoIdentityProviderClientConfig(
...
extension CognitoIdentityProviderClient {
    /// Performs the `AddCustomAttributes` operation on the `CognitoIdentityProvider` service.
    ///
    /// Adds additional user attributes to the user pool schema. Custom attributes can be mutable or immutable and have a custom: or dev: prefix. For more information, see [Custom attributes](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-attributes.html#user-pool-settings-custom-attributes). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    ...
    public func addCustomAttributes(input: AddCustomAttributesInput) async throws -> AddCustomAttributesOutput {
        ...
        let operation = CognitoIdentityProviderClient.addCustomAttributesOperation
    ...
    public func addUserPoolClientSecret(input: AddUserPoolClientSecretInput) async throws -> AddUserPoolClientSecretOutput {
        ...
        let operation = CognitoIdentityProviderClient.addUserPoolClientSecretOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminAddUserToGroup` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminAddUserToGroup(input: AdminAddUserToGroupInput) async throws -> AdminAddUserToGroupOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminAddUserToGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminConfirmSignUp` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminConfirmSignUp(input: AdminConfirmSignUpInput) async throws -> AdminConfirmSignUpOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminConfirmSignUpOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func adminCreateUser(input: AdminCreateUserInput) async throws -> AdminCreateUserOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminCreateUserOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func adminDeleteUser(input: AdminDeleteUserInput) async throws -> AdminDeleteUserOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminDeleteUserOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminDeleteUserAttributes` operation on the `CognitoIdentityProvider` service.
    ///
    /// Deletes attribute values from a user. This operation doesn't affect tokens for existing user sessions. The next ID token that the user receives will no longer have the deleted attributes. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func adminDeleteUserAttributes(input: AdminDeleteUserAttributesInput) async throws -> AdminDeleteUserAttributesOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminDeleteUserAttributesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func adminDisableProviderForUser(input: AdminDisableProviderForUserInput) async throws -> AdminDisableProviderForUserOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminDisableProviderForUserOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminDisableUser` operation on the `CognitoIdentityProvider` service.
    ///
    /// Deactivates a user profile and revokes all access tokens for the user. A deactivated user can't sign in, but still appears in the responses to ListUsers API requests. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func adminDisableUser(input: AdminDisableUserInput) async throws -> AdminDisableUserOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminDisableUserOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminEnableUser` operation on the `CognitoIdentityProvider` service.
    ///
    /// Activates sign-in for a user profile that previously had sign-in access disabled. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func adminEnableUser(input: AdminEnableUserInput) async throws -> AdminEnableUserOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminEnableUserOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminForgetDevice` operation on the `CognitoIdentityProvider` service.
    ///
    /// Forgets, or deletes, a remembered device from a user's profile. After you forget the device, the user can no longer complete device authentication with that device and when applicable, must submit MFA codes again. For more information, see [Working with devices](https://docs.aws.amazon.com/cognito/latest/developerguide/amazon-cognito-user-pools-device-tracking.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func adminForgetDevice(input: AdminForgetDeviceInput) async throws -> AdminForgetDeviceOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminForgetDeviceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminGetDevice` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminGetDevice(input: AdminGetDeviceInput) async throws -> AdminGetDeviceOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminGetDeviceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminGetUser` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given a username, returns details about a user profile in a user pool. You can specify alias attributes in the Username request parameter. This operation contributes to your monthly active user (MAU) count for the purpose of billing. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func adminGetUser(input: AdminGetUserInput) async throws -> AdminGetUserOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminGetUserOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminInitiateAuth` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminInitiateAuth(input: AdminInitiateAuthInput) async throws -> AdminInitiateAuthOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminInitiateAuthOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func adminLinkProviderForUser(input: AdminLinkProviderForUserInput) async throws -> AdminLinkProviderForUserOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminLinkProviderForUserOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminListDevices` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminListDevices(input: AdminListDevicesInput) async throws -> AdminListDevicesOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminListDevicesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminListGroupsForUser` operation on the `CognitoIdentityProvider` service.
    ///
    /// Lists the groups that a user belongs to. User pool groups are identifiers that you can reference from the contents of ID and access tokens, and set preferred IAM roles for identity-pool authentication. For more information, see [Adding groups to a user pool](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-user-groups.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func adminListGroupsForUser(input: AdminListGroupsForUserInput) async throws -> AdminListGroupsForUserOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminListGroupsForUserOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminListUserAuthEvents` operation on the `CognitoIdentityProvider` service.
    ///
    /// Requests a history of user activity and any risks detected as part of Amazon Cognito threat protection. For more information, see [Viewing user event history](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-adaptive-authentication.html#user-pool-settings-adaptive-authentication-event-user-history). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func adminListUserAuthEvents(input: AdminListUserAuthEventsInput) async throws -> AdminListUserAuthEventsOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminListUserAuthEventsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminRemoveUserFromGroup` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminRemoveUserFromGroup(input: AdminRemoveUserFromGroupInput) async throws -> AdminRemoveUserFromGroupOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminRemoveUserFromGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminResetUserPassword` operation on the `CognitoIdentityProvider` service.
    ///
    /// Begins the password reset process. Sets the requested user’s account into a RESET_REQUIRED status, and sends them a password-reset code. Your user pool also sends the user a notification with a reset code and the information that their password has been reset. At sign-in, your application or the managed login session receives a challenge to complete the reset by confirming the code and setting a new password. To use this API operation, your user pool must have self-service account recovery configured. This action might generate an SMS text message. Starting June 1, 2021, US telecom carriers require you to register an origination phone number before you can send SMS messages to US phone numbers. If you use SMS text messages in Amazon Cognito, you must register a phone number with [Amazon Pinpoint](https://console.aws.amazon.com/pinpoint/home/). Amazon Cognito uses the registered number automatically. Otherwise, Amazon Cognito users who must receive SMS messages might not be able to sign up, activate their accounts, or sign in. If you have never used SMS text messages with Amazon Cognito or any other Amazon Web Services service, Amazon Simple Notification Service might place your account in the SMS sandbox. In [sandbox mode](https://docs.aws.amazon.com/sns/latest/dg/sns-sms-sandbox.html) , you can send messages only to verified phone numbers. After you test your app while in the sandbox environment, you can move out of the sandbox and into production. For more information, see [ SMS message settings for Amazon Cognito user pools](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-sms-settings.html) in the Amazon Cognito Developer Guide. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func adminResetUserPassword(input: AdminResetUserPasswordInput) async throws -> AdminResetUserPasswordOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminResetUserPasswordOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminRespondToAuthChallenge` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminRespondToAuthChallenge(input: AdminRespondToAuthChallengeInput) async throws -> AdminRespondToAuthChallengeOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminRespondToAuthChallengeOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminSetUserMFAPreference` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminSetUserMFAPreference(input: AdminSetUserMFAPreferenceInput) async throws -> AdminSetUserMFAPreferenceOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminSetUserMFAPreferenceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminSetUserPassword` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminSetUserPassword(input: AdminSetUserPasswordInput) async throws -> AdminSetUserPasswordOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminSetUserPasswordOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminSetUserSettings` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminSetUserSettings(input: AdminSetUserSettingsInput) async throws -> AdminSetUserSettingsOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminSetUserSettingsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func adminUpdateAuthEventFeedback(input: AdminUpdateAuthEventFeedbackInput) async throws -> AdminUpdateAuthEventFeedbackOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminUpdateAuthEventFeedbackOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminUpdateDeviceStatus` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminUpdateDeviceStatus(input: AdminUpdateDeviceStatusInput) async throws -> AdminUpdateDeviceStatusOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminUpdateDeviceStatusOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func adminUpdateUserAttributes(input: AdminUpdateUserAttributesInput) async throws -> AdminUpdateUserAttributesOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminUpdateUserAttributesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AdminUserGlobalSignOut` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func adminUserGlobalSignOut(input: AdminUserGlobalSignOutInput) async throws -> AdminUserGlobalSignOutOutput {
        ...
        let operation = CognitoIdentityProviderClient.adminUserGlobalSignOutOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `AssociateSoftwareToken` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func associateSoftwareToken(input: AssociateSoftwareTokenInput) async throws -> AssociateSoftwareTokenOutput {
        ...
        let operation = CognitoIdentityProviderClient.associateSoftwareTokenOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ChangePassword` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func changePassword(input: ChangePasswordInput) async throws -> ChangePasswordOutput {
        ...
        let operation = CognitoIdentityProviderClient.changePasswordOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `CompleteWebAuthnRegistration` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func completeWebAuthnRegistration(input: CompleteWebAuthnRegistrationInput) async throws -> CompleteWebAuthnRegistrationOutput {
        ...
        let operation = CognitoIdentityProviderClient.completeWebAuthnRegistrationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ConfirmDevice` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func confirmDevice(input: ConfirmDeviceInput) async throws -> ConfirmDeviceOutput {
        ...
        let operation = CognitoIdentityProviderClient.confirmDeviceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ConfirmForgotPassword` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func confirmForgotPassword(input: ConfirmForgotPasswordInput) async throws -> ConfirmForgotPasswordOutput {
        ...
        let operation = CognitoIdentityProviderClient.confirmForgotPasswordOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ConfirmSignUp` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func confirmSignUp(input: ConfirmSignUpInput) async throws -> ConfirmSignUpOutput {
        ...
        let operation = CognitoIdentityProviderClient.confirmSignUpOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `CreateGroup` operation on the `CognitoIdentityProvider` service.
    ///
    /// Creates a new group in the specified user pool. For more information about user pool groups, see [Adding groups to a user pool](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-user-groups.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func createGroup(input: CreateGroupInput) async throws -> CreateGroupOutput {
        ...
        let operation = CognitoIdentityProviderClient.createGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `CreateIdentityProvider` operation on the `CognitoIdentityProvider` service.
    ///
    /// Adds a configuration and trust relationship between a third-party identity provider (IdP) and a user pool. Amazon Cognito accepts sign-in with third-party identity providers through managed login and OIDC relying-party libraries. For more information, see [Third-party IdP sign-in](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-identity-federation.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func createIdentityProvider(input: CreateIdentityProviderInput) async throws -> CreateIdentityProviderOutput {
        ...
        let operation = CognitoIdentityProviderClient.createIdentityProviderOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `CreateManagedLoginBranding` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func createManagedLoginBranding(input: CreateManagedLoginBrandingInput) async throws -> CreateManagedLoginBrandingOutput {
        ...
        let operation = CognitoIdentityProviderClient.createManagedLoginBrandingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `CreateResourceServer` operation on the `CognitoIdentityProvider` service.
    ///
    /// Creates a new OAuth2.0 resource server and defines custom scopes within it. Resource servers are associated with custom scopes and machine-to-machine (M2M) authorization. For more information, see [Access control with resource servers](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-define-resource-servers.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func createResourceServer(input: CreateResourceServerInput) async throws -> CreateResourceServerOutput {
        ...
        let operation = CognitoIdentityProviderClient.createResourceServerOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `CreateTerms` operation on the `CognitoIdentityProvider` service.
    ///
    /// Creates terms documents for the requested app client. When Terms and conditions and Privacy policy documents are configured, the app client displays links to them in the sign-up page of managed login for the app client. You can provide URLs for terms documents in the languages that are supported by [managed login localization](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-managed-login.html#managed-login-localization). Amazon Cognito directs users to the terms documents for their current language, with fallback to default if no document exists for the language. Each request accepts one type of terms document and a map of language-to-link for that document type. You must provide both types of terms documents in at least one language before Amazon Cognito displays your terms documents. Supply each type in separate requests. For more information, see [Terms documents](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-managed-login.html#managed-login-terms-documents). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    /// - `TooManyRequestsException` : This exception is thrown when the user has made too many requests for a given operation.
    public func createTerms(input: CreateTermsInput) async throws -> CreateTermsOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CognitoIdentityProviderClient.createTermsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "createTerms")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<CreateTermsInput, CreateTermsOutput>())
        ...
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CognitoIdentityProvider")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "CreateTerms")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `CreateUserImportJob` operation on the `CognitoIdentityProvider` service.
    ///
    /// Creates a user import job. You can import users into user pools from a comma-separated values (CSV) file without adding Amazon Cognito MAU costs to your Amazon Web Services bill. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func createUserImportJob(input: CreateUserImportJobInput) async throws -> CreateUserImportJobOutput {
        ...
        let operation = CognitoIdentityProviderClient.createUserImportJobOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `CreateUserPool` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func createUserPool(input: CreateUserPoolInput) async throws -> CreateUserPoolOutput {
        ...
        let operation = CognitoIdentityProviderClient.createUserPoolOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `CreateUserPoolClient` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func createUserPoolClient(input: CreateUserPoolClientInput) async throws -> CreateUserPoolClientOutput {
        ...
        let operation = CognitoIdentityProviderClient.createUserPoolClientOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `CreateUserPoolDomain` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func createUserPoolDomain(input: CreateUserPoolDomainInput) async throws -> CreateUserPoolDomainOutput {
        ...
        let operation = CognitoIdentityProviderClient.createUserPoolDomainOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteGroup` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func deleteGroup(input: DeleteGroupInput) async throws -> DeleteGroupOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteIdentityProvider` operation on the `CognitoIdentityProvider` service.
    ///
    /// Deletes a user pool identity provider (IdP). After you delete an IdP, users can no longer sign in to your user pool through that IdP. For more information about user pool IdPs, see [Third-party IdP sign-in](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-identity-federation.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func deleteIdentityProvider(input: DeleteIdentityProviderInput) async throws -> DeleteIdentityProviderOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteIdentityProviderOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteManagedLoginBranding` operation on the `CognitoIdentityProvider` service.
    ///
    /// Deletes a managed login branding style. When you delete a style, you delete the branding association for an app client. When an app client doesn't have a style assigned, your managed login pages for that app client are nonfunctional until you create a new style or switch the domain branding version. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func deleteManagedLoginBranding(input: DeleteManagedLoginBrandingInput) async throws -> DeleteManagedLoginBrandingOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteManagedLoginBrandingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteResourceServer` operation on the `CognitoIdentityProvider` service.
    ///
    /// Deletes a resource server. After you delete a resource server, users can no longer generate access tokens with scopes that are associate with that resource server. Resource servers are associated with custom scopes and machine-to-machine (M2M) authorization. For more information, see [Access control with resource servers](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-define-resource-servers.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func deleteResourceServer(input: DeleteResourceServerInput) async throws -> DeleteResourceServerOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteResourceServerOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteTerms` operation on the `CognitoIdentityProvider` service.
    ///
    /// Deletes the terms documents with the requested ID from your app client. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func deleteTerms(input: DeleteTermsInput) async throws -> DeleteTermsOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteTermsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteTerms")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DeleteTermsInput, DeleteTermsOutput>())
        ...
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CognitoIdentityProvider")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DeleteTerms")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `DeleteUser` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func deleteUser(input: DeleteUserInput) async throws -> DeleteUserOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteUserOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteUserAttributes` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func deleteUserAttributes(input: DeleteUserAttributesInput) async throws -> DeleteUserAttributesOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteUserAttributesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func deleteUserPool(input: DeleteUserPoolInput) async throws -> DeleteUserPoolOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteUserPoolOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteUserPoolClient` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func deleteUserPoolClient(input: DeleteUserPoolClientInput) async throws -> DeleteUserPoolClientOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteUserPoolClientOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func deleteUserPoolClientSecret(input: DeleteUserPoolClientSecretInput) async throws -> DeleteUserPoolClientSecretOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteUserPoolClientSecretOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteUserPoolDomain` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func deleteUserPoolDomain(input: DeleteUserPoolDomainInput) async throws -> DeleteUserPoolDomainOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteUserPoolDomainOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DeleteWebAuthnCredential` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func deleteWebAuthnCredential(input: DeleteWebAuthnCredentialInput) async throws -> DeleteWebAuthnCredentialOutput {
        ...
        let operation = CognitoIdentityProviderClient.deleteWebAuthnCredentialOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeIdentityProvider` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func describeIdentityProvider(input: DescribeIdentityProviderInput) async throws -> DescribeIdentityProviderOutput {
        ...
        let operation = CognitoIdentityProviderClient.describeIdentityProviderOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeManagedLoginBranding` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func describeManagedLoginBranding(input: DescribeManagedLoginBrandingInput) async throws -> DescribeManagedLoginBrandingOutput {
        ...
        let operation = CognitoIdentityProviderClient.describeManagedLoginBrandingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeManagedLoginBrandingByClient` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func describeManagedLoginBrandingByClient(input: DescribeManagedLoginBrandingByClientInput) async throws -> DescribeManagedLoginBrandingByClientOutput {
        ...
        let operation = CognitoIdentityProviderClient.describeManagedLoginBrandingByClientOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeResourceServer` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func describeResourceServer(input: DescribeResourceServerInput) async throws -> DescribeResourceServerOutput {
        ...
        let operation = CognitoIdentityProviderClient.describeResourceServerOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeRiskConfiguration` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func describeRiskConfiguration(input: DescribeRiskConfigurationInput) async throws -> DescribeRiskConfigurationOutput {
        ...
        let operation = CognitoIdentityProviderClient.describeRiskConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeTerms` operation on the `CognitoIdentityProvider` service.
    ///
    /// Returns details for the requested terms documents ID. For more information, see [Terms documents](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-managed-login.html#managed-login-terms-documents). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func describeTerms(input: DescribeTermsInput) async throws -> DescribeTermsOutput {
        ...
        let operation = CognitoIdentityProviderClient.describeTermsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "describeTerms")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DescribeTermsInput, DescribeTermsOutput>())
        ...
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CognitoIdentityProvider")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DescribeTerms")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func describeUserImportJob(input: DescribeUserImportJobInput) async throws -> DescribeUserImportJobOutput {
        ...
        let operation = CognitoIdentityProviderClient.describeUserImportJobOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeUserPool` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given a user pool ID, returns configuration information. This operation is useful when you want to inspect an existing user pool and programmatically replicate the configuration to another user pool. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func describeUserPool(input: DescribeUserPoolInput) async throws -> DescribeUserPoolOutput {
        ...
        let operation = CognitoIdentityProviderClient.describeUserPoolOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `DescribeUserPoolClient` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given an app client ID, returns configuration information. This operation is useful when you want to inspect an existing app client and programmatically replicate the configuration to another app client. For more information about app clients, see [App clients](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-client-apps.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func describeUserPoolClient(input: DescribeUserPoolClientInput) async throws -> DescribeUserPoolClientOutput {
        ...
        let operation = CognitoIdentityProviderClient.describeUserPoolClientOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func describeUserPoolDomain(input: DescribeUserPoolDomainInput) async throws -> DescribeUserPoolDomainOutput {
        ...
        let operation = CognitoIdentityProviderClient.describeUserPoolDomainOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ForgetDevice` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func forgetDevice(input: ForgetDeviceInput) async throws -> ForgetDeviceOutput {
        ...
        let operation = CognitoIdentityProviderClient.forgetDeviceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ForgotPassword` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func forgotPassword(input: ForgotPasswordInput) async throws -> ForgotPasswordOutput {
        ...
        let operation = CognitoIdentityProviderClient.forgotPasswordOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func getCSVHeader(input: GetCSVHeaderInput) async throws -> GetCSVHeaderOutput {
        ...
        let operation = CognitoIdentityProviderClient.getCSVHeaderOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `GetDevice` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func getDevice(input: GetDeviceInput) async throws -> GetDeviceOutput {
        ...
        let operation = CognitoIdentityProviderClient.getDeviceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `GetGroup` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given a user pool ID and a group name, returns information about the user group. For more information about user pool groups, see [Adding groups to a user pool](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-user-groups.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func getGroup(input: GetGroupInput) async throws -> GetGroupOutput {
        ...
        let operation = CognitoIdentityProviderClient.getGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `GetIdentityProviderByIdentifier` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func getIdentityProviderByIdentifier(input: GetIdentityProviderByIdentifierInput) async throws -> GetIdentityProviderByIdentifierOutput {
        ...
        let operation = CognitoIdentityProviderClient.getIdentityProviderByIdentifierOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `GetLogDeliveryConfiguration` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given a user pool ID, returns the logging configuration. User pools can export message-delivery error and threat-protection activity logs to external Amazon Web Services services. For more information, see [Exporting user pool logs](https://docs.aws.amazon.com/cognito/latest/developerguide/exporting-quotas-and-usage.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func getLogDeliveryConfiguration(input: GetLogDeliveryConfigurationInput) async throws -> GetLogDeliveryConfigurationOutput {
        ...
        let operation = CognitoIdentityProviderClient.getLogDeliveryConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func getSigningCertificate(input: GetSigningCertificateInput) async throws -> GetSigningCertificateOutput {
        ...
        let operation = CognitoIdentityProviderClient.getSigningCertificateOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func getTokensFromRefreshToken(input: GetTokensFromRefreshTokenInput) async throws -> GetTokensFromRefreshTokenOutput {
        ...
        let operation = CognitoIdentityProviderClient.getTokensFromRefreshTokenOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func getUICustomization(input: GetUICustomizationInput) async throws -> GetUICustomizationOutput {
        ...
        let operation = CognitoIdentityProviderClient.getUICustomizationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `GetUser` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func getUser(input: GetUserInput) async throws -> GetUserOutput {
        ...
        let operation = CognitoIdentityProviderClient.getUserOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `GetUserAttributeVerificationCode` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func getUserAttributeVerificationCode(input: GetUserAttributeVerificationCodeInput) async throws -> GetUserAttributeVerificationCodeOutput {
        ...
        let operation = CognitoIdentityProviderClient.getUserAttributeVerificationCodeOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `GetUserAuthFactors` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func getUserAuthFactors(input: GetUserAuthFactorsInput) async throws -> GetUserAuthFactorsOutput {
        ...
        let operation = CognitoIdentityProviderClient.getUserAuthFactorsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `GetUserPoolMfaConfig` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func getUserPoolMfaConfig(input: GetUserPoolMfaConfigInput) async throws -> GetUserPoolMfaConfigOutput {
        ...
        let operation = CognitoIdentityProviderClient.getUserPoolMfaConfigOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `GlobalSignOut` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func globalSignOut(input: GlobalSignOutInput) async throws -> GlobalSignOutOutput {
        ...
        let operation = CognitoIdentityProviderClient.globalSignOutOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `InitiateAuth` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func initiateAuth(input: InitiateAuthInput) async throws -> InitiateAuthOutput {
        ...
        let operation = CognitoIdentityProviderClient.initiateAuthOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListDevices` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func listDevices(input: ListDevicesInput) async throws -> ListDevicesOutput {
        ...
        let operation = CognitoIdentityProviderClient.listDevicesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListGroups` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given a user pool ID, returns user pool groups and their details. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func listGroups(input: ListGroupsInput) async throws -> ListGroupsOutput {
        ...
        let operation = CognitoIdentityProviderClient.listGroupsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListIdentityProviders` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given a user pool ID, returns information about configured identity providers (IdPs). For more information about IdPs, see [Third-party IdP sign-in](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-identity-federation.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func listIdentityProviders(input: ListIdentityProvidersInput) async throws -> ListIdentityProvidersOutput {
        ...
        let operation = CognitoIdentityProviderClient.listIdentityProvidersOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListResourceServers` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given a user pool ID, returns all resource servers and their details. For more information about resource servers, see [Access control with resource servers](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-define-resource-servers.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func listResourceServers(input: ListResourceServersInput) async throws -> ListResourceServersOutput {
        ...
        let operation = CognitoIdentityProviderClient.listResourceServersOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListTagsForResource` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput {
        ...
        let operation = CognitoIdentityProviderClient.listTagsForResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListTerms` operation on the `CognitoIdentityProvider` service.
    ///
    /// Returns details about all terms documents for the requested user pool. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func listTerms(input: ListTermsInput) async throws -> ListTermsOutput {
        ...
        let operation = CognitoIdentityProviderClient.listTermsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listTerms")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListTermsInput, ListTermsOutput>())
        ...
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CognitoIdentityProvider")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListTerms")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListUserImportJobs` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func listUserImportJobs(input: ListUserImportJobsInput) async throws -> ListUserImportJobsOutput {
        ...
        let operation = CognitoIdentityProviderClient.listUserImportJobsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func listUserPoolClientSecrets(input: ListUserPoolClientSecretsInput) async throws -> ListUserPoolClientSecretsOutput {
        ...
        let operation = CognitoIdentityProviderClient.listUserPoolClientSecretsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListUserPoolClients` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given a user pool ID, lists app clients. App clients are sets of rules for the access that you want a user pool to grant to one application. For more information, see [App clients](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-client-apps.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func listUserPoolClients(input: ListUserPoolClientsInput) async throws -> ListUserPoolClientsOutput {
        ...
        let operation = CognitoIdentityProviderClient.listUserPoolClientsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListUserPools` operation on the `CognitoIdentityProvider` service.
    ///
    /// Lists user pools and their details in the current Amazon Web Services account. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func listUserPools(input: ListUserPoolsInput) async throws -> ListUserPoolsOutput {
        ...
        let operation = CognitoIdentityProviderClient.listUserPoolsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func listUsers(input: ListUsersInput) async throws -> ListUsersOutput {
        ...
        let operation = CognitoIdentityProviderClient.listUsersOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListUsersInGroup` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given a user pool ID and a group name, returns a list of users in the group. For more information about user pool groups, see [Adding groups to a user pool](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-user-groups.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func listUsersInGroup(input: ListUsersInGroupInput) async throws -> ListUsersInGroupOutput {
        ...
        let operation = CognitoIdentityProviderClient.listUsersInGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ListWebAuthnCredentials` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func listWebAuthnCredentials(input: ListWebAuthnCredentialsInput) async throws -> ListWebAuthnCredentialsOutput {
        ...
        let operation = CognitoIdentityProviderClient.listWebAuthnCredentialsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `ResendConfirmationCode` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func resendConfirmationCode(input: ResendConfirmationCodeInput) async throws -> ResendConfirmationCodeOutput {
        ...
        let operation = CognitoIdentityProviderClient.resendConfirmationCodeOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `RespondToAuthChallenge` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func respondToAuthChallenge(input: RespondToAuthChallengeInput) async throws -> RespondToAuthChallengeOutput {
        ...
        let operation = CognitoIdentityProviderClient.respondToAuthChallengeOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `RevokeToken` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func revokeToken(input: RevokeTokenInput) async throws -> RevokeTokenOutput {
        ...
        let operation = CognitoIdentityProviderClient.revokeTokenOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func setLogDeliveryConfiguration(input: SetLogDeliveryConfigurationInput) async throws -> SetLogDeliveryConfigurationOutput {
        ...
        let operation = CognitoIdentityProviderClient.setLogDeliveryConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `SetRiskConfiguration` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func setRiskConfiguration(input: SetRiskConfigurationInput) async throws -> SetRiskConfigurationOutput {
        ...
        let operation = CognitoIdentityProviderClient.setRiskConfigurationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `SetUICustomization` operation on the `CognitoIdentityProvider` service.
    ///
    /// Configures UI branding settings for domains with the hosted UI (classic) branding version. Your user pool must have a domain. Configure a domain with . Set the default configuration for all clients with a ClientId of ALL. When the ClientId value is an app client ID, the settings you pass in this request apply to that app client and override the default ALL configuration. Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func setUICustomization(input: SetUICustomizationInput) async throws -> SetUICustomizationOutput {
        ...
        let operation = CognitoIdentityProviderClient.setUICustomizationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `SetUserMFAPreference` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func setUserMFAPreference(input: SetUserMFAPreferenceInput) async throws -> SetUserMFAPreferenceOutput {
        ...
        let operation = CognitoIdentityProviderClient.setUserMFAPreferenceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `SetUserPoolMfaConfig` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func setUserPoolMfaConfig(input: SetUserPoolMfaConfigInput) async throws -> SetUserPoolMfaConfigOutput {
        ...
        let operation = CognitoIdentityProviderClient.setUserPoolMfaConfigOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `SetUserSettings` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func setUserSettings(input: SetUserSettingsInput) async throws -> SetUserSettingsOutput {
        ...
        let operation = CognitoIdentityProviderClient.setUserSettingsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `SignUp` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func signUp(input: SignUpInput) async throws -> SignUpOutput {
        ...
        let operation = CognitoIdentityProviderClient.signUpOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `StartUserImportJob` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func startUserImportJob(input: StartUserImportJobInput) async throws -> StartUserImportJobOutput {
        ...
        let operation = CognitoIdentityProviderClient.startUserImportJobOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `StartWebAuthnRegistration` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func startWebAuthnRegistration(input: StartWebAuthnRegistrationInput) async throws -> StartWebAuthnRegistrationOutput {
        ...
        let operation = CognitoIdentityProviderClient.startWebAuthnRegistrationOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `StopUserImportJob` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func stopUserImportJob(input: StopUserImportJobInput) async throws -> StopUserImportJobOutput {
        ...
        let operation = CognitoIdentityProviderClient.stopUserImportJobOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `TagResource` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput {
        ...
        let operation = CognitoIdentityProviderClient.tagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UntagResource` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput {
        ...
        let operation = CognitoIdentityProviderClient.untagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UpdateAuthEventFeedback` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func updateAuthEventFeedback(input: UpdateAuthEventFeedbackInput) async throws -> UpdateAuthEventFeedbackOutput {
        ...
        let operation = CognitoIdentityProviderClient.updateAuthEventFeedbackOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UpdateDeviceStatus` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func updateDeviceStatus(input: UpdateDeviceStatusInput) async throws -> UpdateDeviceStatusOutput {
        ...
        let operation = CognitoIdentityProviderClient.updateDeviceStatusOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UpdateGroup` operation on the `CognitoIdentityProvider` service.
    ///
    /// Given the name of a user pool group, updates any of the properties for precedence, IAM role, or description. For more information about user pool groups, see [Adding groups to a user pool](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-user-groups.html). Amazon Cognito evaluates Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you must use IAM credentials to authorize requests, and you must grant yourself the corresponding IAM permission in a policy. Learn more
    ///
    /// * [Signing Amazon Web Services API Requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-signing.html)
    ///
    /// * [Using the Amazon Cognito user pools API and user pool endpoints](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pools-API-operations.html)
    ...
    public func updateGroup(input: UpdateGroupInput) async throws -> UpdateGroupOutput {
        ...
        let operation = CognitoIdentityProviderClient.updateGroupOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UpdateIdentityProvider` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func updateIdentityProvider(input: UpdateIdentityProviderInput) async throws -> UpdateIdentityProviderOutput {
        ...
        let operation = CognitoIdentityProviderClient.updateIdentityProviderOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UpdateManagedLoginBranding` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func updateManagedLoginBranding(input: UpdateManagedLoginBrandingInput) async throws -> UpdateManagedLoginBrandingOutput {
        ...
        let operation = CognitoIdentityProviderClient.updateManagedLoginBrandingOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func updateResourceServer(input: UpdateResourceServerInput) async throws -> UpdateResourceServerOutput {
        ...
        let operation = CognitoIdentityProviderClient.updateResourceServerOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UpdateTerms` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    /// - `TermsExistsException` : Terms document names must be unique to the app client. This exception is thrown when you attempt to create terms documents with a duplicate TermsName.
    /// - `TooManyRequestsException` : This exception is thrown when the user has made too many requests for a given operation.
    public func updateTerms(input: UpdateTermsInput) async throws -> UpdateTermsOutput {
        var config = config
        let plugins: [any ClientRuntime.Plugin] = [SmithyAWSJSON.Plugin(), AWSClientRuntime.UnknownAWSHTTPServiceErrorPlugin()]
        for plugin in plugins {
            try await plugin.configureClient(clientConfiguration: &config)
        }
        let operation = CognitoIdentityProviderClient.updateTermsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "updateTerms")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<UpdateTermsInput, UpdateTermsOutput>())
        ...
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "CognitoIdentityProvider")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "UpdateTerms")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `UpdateUserAttributes` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func updateUserAttributes(input: UpdateUserAttributesInput) async throws -> UpdateUserAttributesOutput {
        ...
        let operation = CognitoIdentityProviderClient.updateUserAttributesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func updateUserPool(input: UpdateUserPoolInput) async throws -> UpdateUserPoolOutput {
        ...
        let operation = CognitoIdentityProviderClient.updateUserPoolOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UpdateUserPoolClient` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func updateUserPoolClient(input: UpdateUserPoolClientInput) async throws -> UpdateUserPoolClientOutput {
        ...
        let operation = CognitoIdentityProviderClient.updateUserPoolClientOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `UpdateUserPoolDomain` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func updateUserPoolDomain(input: UpdateUserPoolDomainInput) async throws -> UpdateUserPoolDomainOutput {
        ...
        let operation = CognitoIdentityProviderClient.updateUserPoolDomainOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `VerifySoftwareToken` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func verifySoftwareToken(input: VerifySoftwareTokenInput) async throws -> VerifySoftwareTokenOutput {
        ...
        let operation = CognitoIdentityProviderClient.verifySoftwareTokenOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    /// Performs the `VerifyUserAttribute` operation on the `CognitoIdentityProvider` service.
    ///
    ...
    public func verifyUserAttribute(input: VerifyUserAttributeInput) async throws -> VerifyUserAttributeOutput {
        ...
        let operation = CognitoIdentityProviderClient.verifyUserAttributeOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
