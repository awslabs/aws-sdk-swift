...
extension AdminGetUserOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> AdminGetUserOutput {
        ...
        value.userCreateDate = try reader["UserCreateDate"].readTimestampIfPresent(format: .epochSeconds)
        value.userLastModifiedDate = try reader["UserLastModifiedDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension CognitoIdentityProviderClientTypes.DeviceType {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CognitoIdentityProviderClientTypes.DeviceType {
        ...
        value.deviceCreateDate = try reader["DeviceCreateDate"].readTimestampIfPresent(format: .epochSeconds)
        value.deviceLastModifiedDate = try reader["DeviceLastModifiedDate"].readTimestampIfPresent(format: .epochSeconds)
        value.deviceLastAuthenticatedDate = try reader["DeviceLastAuthenticatedDate"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension CognitoIdentityProviderClientTypes.EventFeedbackType {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CognitoIdentityProviderClientTypes.EventFeedbackType {
        ...
        value.feedbackDate = try reader["FeedbackDate"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
