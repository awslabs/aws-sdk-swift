...
extension AdminConfirmSignUpInput {
    ...
    static func write(value: AdminConfirmSignUpInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ClientMetadata"].writeMap(value.clientMetadata, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["UserPoolId"].write(value.userPoolId)
        try writer["Username"].write(value.username)
    }
}
...
extension AdminCreateUserInput {
    ...
    static func write(value: AdminCreateUserInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ClientMetadata"].writeMap(value.clientMetadata, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["DesiredDeliveryMediums"].writeList(value.desiredDeliveryMediums, memberWritingClosure: CognitoIdentityProviderClientTypes.DeliveryMediumType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension AdminDeleteUserAttributesInput {
    ...
    static func write(value: AdminDeleteUserAttributesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["UserAttributeNames"].writeList(value.userAttributeNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["UserPoolId"].write(value.userPoolId)
        try writer["Username"].write(value.username)
    }
}
...
extension AdminInitiateAuthInput {
    ...
    static func write(value: AdminInitiateAuthInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["AuthParameters"].writeMap(value.authParameters, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension AdminRespondToAuthChallengeInput {
    ...
    static func write(value: AdminRespondToAuthChallengeInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ChallengeResponses"].writeMap(value.challengeResponses, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["ClientId"].write(value.clientId)
        try writer["ClientMetadata"].writeMap(value.clientMetadata, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["ContextData"].write(value.contextData, with: CognitoIdentityProviderClientTypes.ContextDataType.write(value:to:))
...
extension AdminGetUserOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> AdminGetUserOutput {
        ...
        value.userMFASettingList = try reader["UserMFASettingList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AdminInitiateAuthOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> AdminInitiateAuthOutput {
        ...
        value.challengeParameters = try reader["ChallengeParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GetCSVHeaderOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetCSVHeaderOutput {
        ...
        value.csvHeader = try reader["CSVHeader"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CognitoIdentityProviderClientTypes.IdentityProviderType {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CognitoIdentityProviderClientTypes.IdentityProviderType {
        ...
        value.providerDetails = try reader["ProviderDetails"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.attributeMapping = try reader["AttributeMapping"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.idpIdentifiers = try reader["IdpIdentifiers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.lastModifiedDate = try reader["LastModifiedDate"].readTimestampIfPresent(format: .epochSeconds)
        value.creationDate = try reader["CreationDate"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
...
extension CognitoIdentityProviderClientTypes.UserPoolType {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CognitoIdentityProviderClientTypes.UserPoolType {
        ...
        value.autoVerifiedAttributes = try reader["AutoVerifiedAttributes"].readListIfPresent(memberReadingClosure: CognitoIdentityProviderClientTypes.VerifiedAttributeType.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.aliasAttributes = try reader["AliasAttributes"].readListIfPresent(memberReadingClosure: CognitoIdentityProviderClientTypes.AliasAttributeType.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.usernameAttributes = try reader["UsernameAttributes"].readListIfPresent(memberReadingClosure: CognitoIdentityProviderClientTypes.UsernameAttributeType.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.userPoolTags = try reader["UserPoolTags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension CognitoIdentityProviderClientTypes.UserAttributeUpdateSettingsType {
    ...
    static func write(value: CognitoIdentityProviderClientTypes.UserAttributeUpdateSettingsType?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AttributesRequireVerificationBeforeUpdate"].writeList(value.attributesRequireVerificationBeforeUpdate, memberWritingClosure: CognitoIdentityProviderClientTypes.VerifiedAttributeType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CognitoIdentityProviderClientTypes.UserAttributeUpdateSettingsType {
        ...
        value.attributesRequireVerificationBeforeUpdate = try reader["AttributesRequireVerificationBeforeUpdate"].readListIfPresent(memberReadingClosure: CognitoIdentityProviderClientTypes.VerifiedAttributeType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CognitoIdentityProviderClientTypes.UserPoolClientType {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CognitoIdentityProviderClientTypes.UserPoolClientType {
        ...
        value.readAttributes = try reader["ReadAttributes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.writeAttributes = try reader["WriteAttributes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.explicitAuthFlows = try reader["ExplicitAuthFlows"].readListIfPresent(memberReadingClosure: CognitoIdentityProviderClientTypes.ExplicitAuthFlowsType.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.supportedIdentityProviders = try reader["SupportedIdentityProviders"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.callbackURLs = try reader["CallbackURLs"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.logoutURLs = try reader["LogoutURLs"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.defaultRedirectURI = try reader["DefaultRedirectURI"].readIfPresent()
        value.allowedOAuthFlows = try reader["AllowedOAuthFlows"].readListIfPresent(memberReadingClosure: CognitoIdentityProviderClientTypes.OAuthFlowType.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.allowedOAuthScopes = try reader["AllowedOAuthScopes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CognitoIdentityProviderClientTypes.RiskExceptionConfigurationType {
    ...
    static func write(value: CognitoIdentityProviderClientTypes.RiskExceptionConfigurationType?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["BlockedIPRangeList"].writeList(value.blockedIPRangeList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SkippedIPRangeList"].writeList(value.skippedIPRangeList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CognitoIdentityProviderClientTypes.RiskExceptionConfigurationType {
        ...
        value.blockedIPRangeList = try reader["BlockedIPRangeList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.skippedIPRangeList = try reader["SkippedIPRangeList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CognitoIdentityProviderClientTypes.CompromisedCredentialsRiskConfigurationType {
    ...
    static func write(value: CognitoIdentityProviderClientTypes.CompromisedCredentialsRiskConfigurationType?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["EventFilter"].writeList(value.eventFilter, memberWritingClosure: CognitoIdentityProviderClientTypes.EventFilterType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CognitoIdentityProviderClientTypes.CompromisedCredentialsRiskConfigurationType {
        ...
        value.eventFilter = try reader["EventFilter"].readListIfPresent(memberReadingClosure: CognitoIdentityProviderClientTypes.EventFilterType.read(from:), memberNodeInfo: "member", isFlattened: false)
