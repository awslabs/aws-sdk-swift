...
extension CognitoIdentityProviderClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CognitoIdentityProviderClient.CognitoIdentityProviderClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> CognitoIdentityProviderClient {
...
extension CognitoIdentityProviderClient.CognitoIdentityProviderClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
