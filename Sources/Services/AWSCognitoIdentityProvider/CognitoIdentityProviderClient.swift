...
public class CognitoIdentityProviderClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await CognitoIdentityProviderClientConfiguration(region: region)
    ...
    public class CognitoIdentityProviderClientConfiguration: CognitoIdentityProviderClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("CognitoIdentityProviderClient")
