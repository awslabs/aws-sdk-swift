...
public class CognitoIdentityProviderClientEndpointPlugin: Plugin {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? CognitoIdentityProviderClient.CognitoIdentityProviderClientConfiguration {
            config.authSchemeResolver = DefaultCognitoIdentityProviderAuthSchemeResolver()
...
public class CognitoIdentityProviderClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: CognitoIdentityProviderAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
