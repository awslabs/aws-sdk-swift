...
extension KinesisAnalyticsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> KinesisAnalyticsClient.KinesisAnalyticsClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> KinesisAnalyticsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return KinesisAnalyticsClient(config: configuration)
        }
    }
...
extension KinesisAnalyticsClient.KinesisAnalyticsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
