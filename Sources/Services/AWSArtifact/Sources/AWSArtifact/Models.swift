...
extension ArtifactClientTypes.ReportDetail {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ArtifactClientTypes.ReportDetail {
        ...
        value.periodStart = try reader["periodStart"].readTimestampIfPresent(format: .dateTime)
        value.periodEnd = try reader["periodEnd"].readTimestampIfPresent(format: .dateTime)
        value.createdAt = try reader["createdAt"].readTimestampIfPresent(format: .dateTime)
        value.lastModifiedAt = try reader["lastModifiedAt"].readTimestampIfPresent(format: .dateTime)
        value.deletedAt = try reader["deletedAt"].readTimestampIfPresent(format: .dateTime)
