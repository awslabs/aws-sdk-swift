...
extension CreateOriginEndpointOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> CreateOriginEndpointOutput {
        ...
        value.whitelist = try reader["whitelist"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension MediaPackageClientTypes.DashPackage {
    ...
    static func write(value: MediaPackageClientTypes.DashPackage?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["periodTriggers"].writeList(value.periodTriggers, memberWritingClosure: MediaPackageClientTypes.__PeriodTriggersElement.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MediaPackageClientTypes.DashPackage {
        ...
        value.periodTriggers = try reader["periodTriggers"].readListIfPresent(memberReadingClosure: MediaPackageClientTypes.__PeriodTriggersElement.read(from:), memberNodeInfo: "member", isFlattened: false)
