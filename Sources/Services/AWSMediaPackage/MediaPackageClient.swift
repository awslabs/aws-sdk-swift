...
extension MediaPackageClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MediaPackageClient.MediaPackageClientConfiguration {
        let clientConfiguration = try await MediaPackageClient.MediaPackageClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MediaPackageClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MediaPackageClient(config: configuration)
        }
    }
...
extension MediaPackageClient.MediaPackageClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
