...
extension SupportAppClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SupportAppClient.SupportAppClientConfiguration {
        let clientConfiguration = try await SupportAppClient.SupportAppClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SupportAppClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SupportAppClient(config: configuration)
        }
    }
...
extension SupportAppClient.SupportAppClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
