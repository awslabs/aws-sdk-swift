...
extension CreateCustomMetadataInput {
    ...
    static func write(value: CreateCustomMetadataInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CustomMetadata"].writeMap(value.customMetadata, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension SearchResourcesInput {
    ...
    static func write(value: SearchResourcesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AdditionalResponseFields"].writeList(value.additionalResponseFields, memberWritingClosure: WorkDocsClientTypes.AdditionalResponseFieldType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["OrganizationId"].write(value.organizationId)
        try writer["QueryScopes"].writeList(value.queryScopes, memberWritingClosure: WorkDocsClientTypes.SearchQueryScopeType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GetDocumentOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetDocumentOutput {
        ...
        value.customMetadata = try reader["CustomMetadata"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension EntityNotExistsException {
    ...
    static func makeError(baseError: AWSClientRuntime.RestJSONError) throws -> EntityNotExistsException {
        ...
        value.properties.entityIds = try reader["EntityIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.properties.message = try reader["Message"].readIfPresent()
        value.httpResponse = baseError.httpResponse
        value.requestID = baseError.requestID
        value.message = baseError.message
...
extension WorkDocsClientTypes.DocumentVersionMetadata {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkDocsClientTypes.DocumentVersionMetadata {
        ...
        value.createdTimestamp = try reader["CreatedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.modifiedTimestamp = try reader["ModifiedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.contentCreatedTimestamp = try reader["ContentCreatedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.contentModifiedTimestamp = try reader["ContentModifiedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.creatorId = try reader["CreatorId"].readIfPresent()
        value.thumbnail = try reader["Thumbnail"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.source = try reader["Source"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension WorkDocsClientTypes.UploadMetadata {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkDocsClientTypes.UploadMetadata {
        ...
        value.signedHeaders = try reader["SignedHeaders"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension WorkDocsClientTypes.Filters {
    ...
    static func write(value: WorkDocsClientTypes.Filters?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AncestorIds"].writeList(value.ancestorIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ContentCategories"].writeList(value.contentCategories, memberWritingClosure: WorkDocsClientTypes.ContentCategoryType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["ResourceTypes"].writeList(value.resourceTypes, memberWritingClosure: WorkDocsClientTypes.SearchResourceType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SearchCollectionTypes"].writeList(value.searchCollectionTypes, memberWritingClosure: WorkDocsClientTypes.SearchCollectionType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
