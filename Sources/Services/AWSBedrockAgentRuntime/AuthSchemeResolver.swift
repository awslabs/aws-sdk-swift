...
public struct BedrockAgentRuntimeAuthSchemeResolverParameters: SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol BedrockAgentRuntimeAuthSchemeResolver: SmithyHTTPAuthAPI.AuthSchemeResolver {
    // Intentionally empty.
    // This is the parent protocol that all auth scheme resolver implementations of
    // the service BedrockAgentRuntime must conform to.
}

public struct DefaultBedrockAgentRuntimeAuthSchemeResolver: BedrockAgentRuntimeAuthSchemeResolver {
    public func resolveAuthScheme(params: SmithyHTTPAuthAPI.AuthSchemeResolverParameters) throws -> [AuthOption] {
        ...
        guard let serviceParams = params as? BedrockAgentRuntimeAuthSchemeResolverParameters else {
        ...
        switch serviceParams.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: SigningPropertyKeys.signingName, value: "bedrock")
    ...
    public func constructParameters(context: Smithy.Context) throws -> SmithyHTTPAuthAPI.AuthSchemeResolverParameters {
        ...
        return BedrockAgentRuntimeAuthSchemeResolverParameters(operation: opName, region: opRegion)
    }
}
