...
extension DynamoDBClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> DynamoDBClient.DynamoDBClientConfiguration {
        let clientConfiguration = try await DynamoDBClient.DynamoDBClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> DynamoDBClient {
            let configuration = try await resolve(plugins: self.plugins)
            return DynamoDBClient(config: configuration)
        }
    }
...
extension DynamoDBClient.DynamoDBClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
