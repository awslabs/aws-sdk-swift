...
extension DynamoDBClient {
    ...
    public class DynamoDBClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        ...
        private init(
            ...
            _ accountId: Swift.String?,
            _ accountIdEndpointMode: Swift.String?,
...
extension DynamoDBClient {
    ...
    public func batchExecuteStatement(input: BatchExecuteStatementInput) async throws -> BatchExecuteStatementOutput {
        ...
        let endpointParams = EndpointParams(accountId: config.accountId, accountIdEndpointMode: config.accountIdEndpointMode, endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
