...
public struct EndpointParams {
    ...
    public let resourceArnList: Swift.Array<Swift.String>?
    ...
    public init(
        ...
        resourceArnList: Swift.Array<Swift.String>? = nil,
...
extension EndpointParams: ClientRuntime.EndpointsRequestContextProviding {
    ...
    public var context: ClientRuntime.EndpointsRequestContext {
        get throws {
            ...
            try context.add(name: "ResourceArnList", value: self.resourceArnList)
