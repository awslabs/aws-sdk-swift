...
public protocol DynamoDBClientProtocol {
    ...
    func importTable(input: ImportTableInput) async throws -> ImportTableOutputResponse
...
public protocol DynamoDBClientConfigurationProtocol : AWSClientRuntime.AWSClientConfiguration {
