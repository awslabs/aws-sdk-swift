...
extension BatchWriteItemInput {
    ...
    static func write(value: BatchWriteItemInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["RequestItems"].writeMap(value.requestItems, valueWritingClosure: listWritingClosure(memberWritingClosure: DynamoDBClientTypes.WriteRequest.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["ReturnConsumedCapacity"].write(value.returnConsumedCapacity)
...
extension DeleteItemInput {
    ...
    static func write(value: DeleteItemInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ExpressionAttributeNames"].writeMap(value.expressionAttributeNames, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ExportTableToPointInTimeInput {
    ...
    static func write(value: ExportTableToPointInTimeInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ExportTime"].writeTimestamp(value.exportTime, format: .epochSeconds)
...
extension GetItemInput {
    ...
    static func write(value: GetItemInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AttributesToGet"].writeList(value.attributesToGet, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ConsistentRead"].write(value.consistentRead)
        try writer["ExpressionAttributeNames"].writeMap(value.expressionAttributeNames, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Key"].writeMap(value.key, valueWritingClosure: DynamoDBClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ListBackupsInput {
    ...
    static func write(value: ListBackupsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Limit"].write(value.limit)
        try writer["TableName"].write(value.tableName)
        try writer["TimeRangeLowerBound"].writeTimestamp(value.timeRangeLowerBound, format: .epochSeconds)
        try writer["TimeRangeUpperBound"].writeTimestamp(value.timeRangeUpperBound, format: .epochSeconds)
    }
}
...
extension RestoreTableToPointInTimeInput {
    ...
    static func write(value: RestoreTableToPointInTimeInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["OnDemandThroughputOverride"].write(value.onDemandThroughputOverride, with: DynamoDBClientTypes.OnDemandThroughput.write(value:to:))
        try writer["ProvisionedThroughputOverride"].write(value.provisionedThroughputOverride, with: DynamoDBClientTypes.ProvisionedThroughput.write(value:to:))
        try writer["RestoreDateTime"].writeTimestamp(value.restoreDateTime, format: .epochSeconds)
        try writer["SSESpecificationOverride"].write(value.sseSpecificationOverride, with: DynamoDBClientTypes.SSESpecification.write(value:to:))
...
extension BatchGetItemOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchGetItemOutput {
        ...
        value.consumedCapacity = try reader["ConsumedCapacity"].readListIfPresent(memberReadingClosure: DynamoDBClientTypes.ConsumedCapacity.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.responses = try reader["Responses"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: mapReadingClosure(valueReadingClosure: DynamoDBClientTypes.AttributeValue.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension BatchWriteItemOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> BatchWriteItemOutput {
        ...
        value.consumedCapacity = try reader["ConsumedCapacity"].readListIfPresent(memberReadingClosure: DynamoDBClientTypes.ConsumedCapacity.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.itemCollectionMetrics = try reader["ItemCollectionMetrics"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: DynamoDBClientTypes.ItemCollectionMetrics.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.unprocessedItems = try reader["UnprocessedItems"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: DynamoDBClientTypes.WriteRequest.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension DescribeContributorInsightsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeContributorInsightsOutput {
        ...
        value.contributorInsightsRuleList = try reader["ContributorInsightsRuleList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.lastUpdateDateTime = try reader["LastUpdateDateTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension ExecuteStatementOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ExecuteStatementOutput {
        ...
        value.consumedCapacity = try reader["ConsumedCapacity"].readIfPresent(with: DynamoDBClientTypes.ConsumedCapacity.read(from:))
        value.items = try reader["Items"].readListIfPresent(memberReadingClosure: mapReadingClosure(valueReadingClosure: DynamoDBClientTypes.AttributeValue.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
...
extension ListTablesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListTablesOutput {
        ...
        value.tableNames = try reader["TableNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DynamoDBClientTypes.AttributeValue {
    ...
    static func write(value: DynamoDBClientTypes.AttributeValue?, to writer: SmithyJSON.Writer) throws {
        ...
        switch value {
            ...
            case let .bs(bs):
                try writer["BS"].writeList(bs, memberWritingClosure: Foundation.Data.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .l(l):
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.AttributeValue {
        ...
        switch name {
            ...
            case "SS":
                return .ss(try reader["SS"].readList(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false))
            case "NS":
...
extension DynamoDBClientTypes.KeysAndAttributes {
    ...
    static func write(value: DynamoDBClientTypes.KeysAndAttributes?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ConsistentRead"].write(value.consistentRead)
        try writer["ExpressionAttributeNames"].writeMap(value.expressionAttributeNames, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["Keys"].writeList(value.keys, memberWritingClosure: mapWritingClosure(valueWritingClosure: DynamoDBClientTypes.AttributeValue.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
        try writer["ProjectionExpression"].write(value.projectionExpression)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.KeysAndAttributes {
        ...
        value.keys = try reader["Keys"].readListIfPresent(memberReadingClosure: mapReadingClosure(valueReadingClosure: DynamoDBClientTypes.AttributeValue.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
        value.attributesToGet = try reader["AttributesToGet"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.expressionAttributeNames = try reader["ExpressionAttributeNames"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension DynamoDBClientTypes.ItemCollectionMetrics {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.ItemCollectionMetrics {
        ...
        value.sizeEstimateRangeGB = try reader["SizeEstimateRangeGB"].readListIfPresent(memberReadingClosure: Swift.Double.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DynamoDBClientTypes.BackupDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.BackupDetails {
        ...
        value.backupCreationDateTime = try reader["BackupCreationDateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.backupExpiryDateTime = try reader["BackupExpiryDateTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DynamoDBClientTypes.ReplicaDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.ReplicaDescription {
        ...
        value.replicaInaccessibleDateTime = try reader["ReplicaInaccessibleDateTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension DynamoDBClientTypes.ArchivalSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.ArchivalSummary {
        ...
        value.archivalDateTime = try reader["ArchivalDateTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension DynamoDBClientTypes.SSEDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.SSEDescription {
        ...
        value.inaccessibleEncryptionDateTime = try reader["InaccessibleEncryptionDateTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DynamoDBClientTypes.RestoreSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.RestoreSummary {
        ...
        value.restoreDateTime = try reader["RestoreDateTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension DynamoDBClientTypes.ProvisionedThroughputDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.ProvisionedThroughputDescription {
        ...
        value.lastIncreaseDateTime = try reader["LastIncreaseDateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lastDecreaseDateTime = try reader["LastDecreaseDateTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension DynamoDBClientTypes.Projection {
    ...
    static func write(value: DynamoDBClientTypes.Projection?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["NonKeyAttributes"].writeList(value.nonKeyAttributes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.Projection {
        ...
        value.nonKeyAttributes = try reader["NonKeyAttributes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DynamoDBClientTypes.BillingModeSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.BillingModeSummary {
        ...
        value.lastUpdateToPayPerRequestDateTime = try reader["LastUpdateToPayPerRequestDateTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DynamoDBClientTypes.SourceTableDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.SourceTableDetails {
        ...
        value.tableSizeBytes = try reader["TableSizeBytes"].readIfPresent()
        value.keySchema = try reader["KeySchema"].readListIfPresent(memberReadingClosure: DynamoDBClientTypes.KeySchemaElement.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.tableCreationDateTime = try reader["TableCreationDateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.provisionedThroughput = try reader["ProvisionedThroughput"].readIfPresent(with: DynamoDBClientTypes.ProvisionedThroughput.read(from:))
        value.onDemandThroughput = try reader["OnDemandThroughput"].readIfPresent(with: DynamoDBClientTypes.OnDemandThroughput.read(from:))
        value.itemCount = try reader["ItemCount"].readIfPresent()
        value.billingMode = try reader["BillingMode"].readIfPresent()
...
extension DynamoDBClientTypes.PointInTimeRecoveryDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.PointInTimeRecoveryDescription {
        ...
        value.earliestRestorableDateTime = try reader["EarliestRestorableDateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.latestRestorableDateTime = try reader["LatestRestorableDateTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DynamoDBClientTypes.ExportDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.ExportDescription {
        ...
        value.tableArn = try reader["TableArn"].readIfPresent()
        value.tableId = try reader["TableId"].readIfPresent()
        value.exportTime = try reader["ExportTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension DynamoDBClientTypes.IncrementalExportSpecification {
    ...
    static func write(value: DynamoDBClientTypes.IncrementalExportSpecification?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ExportFromTime"].writeTimestamp(value.exportFromTime, format: .epochSeconds)
        try writer["ExportToTime"].writeTimestamp(value.exportToTime, format: .epochSeconds)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.IncrementalExportSpecification {
        ...
        value.exportFromTime = try reader["ExportFromTime"].readTimestampIfPresent(format: .epochSeconds)
        value.exportToTime = try reader["ExportToTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension DynamoDBClientTypes.CsvOptions {
    ...
    static func write(value: DynamoDBClientTypes.CsvOptions?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["HeaderList"].writeList(value.headerList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DynamoDBClientTypes.CsvOptions {
        ...
        value.headerList = try reader["HeaderList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
