...
extension Macie2Client {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> Macie2Client.Macie2ClientConfiguration {
        let clientConfiguration = try await Macie2Client.Macie2ClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> Macie2Client {
            let configuration = try await resolve(plugins: self.plugins)
            return Macie2Client(config: configuration)
        }
    }
...
extension Macie2Client.Macie2ClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
