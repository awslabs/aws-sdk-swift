...
public class Macie2Client {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await Macie2ClientConfiguration(region: region)
    ...
    public class Macie2ClientConfiguration: Macie2ClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("Macie2Client")
