...
extension CreateComponentTypeInput {
    ...
    static func write(value: CreateComponentTypeInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["extendsFrom"].writeList(value.extendsFrom, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateSceneInput {
    ...
    static func write(value: CreateSceneInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["sceneMetadata"].writeMap(value.sceneMetadata, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["tags"].writeMap(value.tags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension GetPropertyValueInput {
    ...
    static func write(value: GetPropertyValueInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["selectedProperties"].writeList(value.selectedProperties, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GetComponentTypeOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetComponentTypeOutput {
        ...
        value.extendsFrom = try reader["extendsFrom"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension GetSceneOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetSceneOutput {
        ...
        value.generatedSceneMetadata = try reader["generatedSceneMetadata"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.sceneId = try reader["sceneId"].readIfPresent()
        value.sceneMetadata = try reader["sceneMetadata"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.updateDateTime = try reader["updateDateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.workspaceId = try reader["workspaceId"].readIfPresent()
        return value
    }
...
extension GetWorkspaceOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetWorkspaceOutput {
        ...
        value.creationDateTime = try reader["creationDateTime"].readTimestampIfPresent(format: .epochSeconds)
        value.description = try reader["description"].readIfPresent()
        value.linkedServices = try reader["linkedServices"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension IoTTwinMakerClientTypes.EntityPropertyReference {
    ...
    static func write(value: IoTTwinMakerClientTypes.EntityPropertyReference?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["componentPath"].write(value.componentPath)
        try writer["entityId"].write(value.entityId)
        try writer["externalIdProperty"].writeMap(value.externalIdProperty, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> IoTTwinMakerClientTypes.EntityPropertyReference {
        ...
        value.externalIdProperty = try reader["externalIdProperty"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.entityId = try reader["entityId"].readIfPresent()
...
extension IoTTwinMakerClientTypes.Row {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> IoTTwinMakerClientTypes.Row {
        ...
        value.rowData = try reader["rowData"].readListIfPresent(memberReadingClosure: SmithyReadWrite.Document.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension IoTTwinMakerClientTypes.BundleInformation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> IoTTwinMakerClientTypes.BundleInformation {
        ...
        value.bundleNames = try reader["bundleNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
