...
extension CreateChannelInput {
    ...
    static func write(value: CreateChannelInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ModeratorArns"].writeList(value.moderatorArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Name"].write(value.name)
...
extension ChimeSDKMessagingClientTypes.MessageAttributeValue {
    ...
    static func write(value: ChimeSDKMessagingClientTypes.MessageAttributeValue?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["StringValues"].writeList(value.stringValues, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ChimeSDKMessagingClientTypes.MessageAttributeValue {
        ...
        value.stringValues = try reader["StringValues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
