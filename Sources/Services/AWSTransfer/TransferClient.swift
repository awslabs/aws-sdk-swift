...
extension TransferClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> TransferClient.TransferClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> TransferClient {
            let configuration = try await resolve(plugins: self.plugins)
            return TransferClient(config: configuration)
        }
    }
...
extension TransferClient.TransferClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
