...
extension LexRuntimeV2Client {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> LexRuntimeV2Client.LexRuntimeV2ClientConfiguration {
        let clientConfiguration = try await LexRuntimeV2Client.LexRuntimeV2ClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> LexRuntimeV2Client {
            let configuration = try await resolve(plugins: self.plugins)
            return LexRuntimeV2Client(config: configuration)
        }
    }
...
extension LexRuntimeV2Client.LexRuntimeV2ClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
