...
extension DataBrewClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> DataBrewClient.DataBrewClientConfiguration {
        let clientConfiguration = try await DataBrewClient.DataBrewClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> DataBrewClient {
            let configuration = try await resolve(plugins: self.plugins)
            return DataBrewClient(config: configuration)
        }
    }
...
extension DataBrewClient.DataBrewClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
