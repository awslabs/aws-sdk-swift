...
extension BatchDeleteRecipeVersionInput {
    ...
    static func write(value: BatchDeleteRecipeVersionInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["RecipeVersions"].writeList(value.recipeVersions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeScheduleOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeScheduleOutput {
        ...
        value.jobNames = try reader["JobNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.lastModifiedBy = try reader["LastModifiedBy"].readIfPresent()
        value.lastModifiedDate = try reader["LastModifiedDate"].readTimestampIfPresent(format: .epochSeconds)
        value.name = try reader["Name"].readIfPresent()
        value.resourceArn = try reader["ResourceArn"].readIfPresent()
...
extension DataBrewClientTypes.ExcelOptions {
    ...
    static func write(value: DataBrewClientTypes.ExcelOptions?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["HeaderRow"].write(value.headerRow)
        try writer["SheetIndexes"].writeList(value.sheetIndexes, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SheetNames"].writeList(value.sheetNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DataBrewClientTypes.ExcelOptions {
        ...
        value.sheetNames = try reader["SheetNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.sheetIndexes = try reader["SheetIndexes"].readListIfPresent(memberReadingClosure: Swift.Int.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.headerRow = try reader["HeaderRow"].readIfPresent()
        return value
    }
}
...
extension DataBrewClientTypes.FilterExpression {
    ...
    static func write(value: DataBrewClientTypes.FilterExpression?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ValuesMap"].writeMap(value.valuesMap, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DataBrewClientTypes.FilterExpression {
        ...
        value.valuesMap = try reader["ValuesMap"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension DataBrewClientTypes.AllowedStatistics {
    ...
    static func write(value: DataBrewClientTypes.AllowedStatistics?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Statistics"].writeList(value.statistics, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DataBrewClientTypes.AllowedStatistics {
        ...
        value.statistics = try reader["Statistics"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DataBrewClientTypes.StatisticsConfiguration {
    ...
    static func write(value: DataBrewClientTypes.StatisticsConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["IncludedStatistics"].writeList(value.includedStatistics, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DataBrewClientTypes.StatisticsConfiguration {
        ...
        value.includedStatistics = try reader["IncludedStatistics"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DataBrewClientTypes.Rule {
    ...
    static func write(value: DataBrewClientTypes.Rule?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Name"].write(value.name)
        try writer["SubstitutionMap"].writeMap(value.substitutionMap, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DataBrewClientTypes.Rule {
        ...
        value.substitutionMap = try reader["SubstitutionMap"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension DataBrewClientTypes.ViewFrame {
    ...
    static func write(value: DataBrewClientTypes.ViewFrame?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["HiddenColumns"].writeList(value.hiddenColumns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
