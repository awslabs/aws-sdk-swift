...
extension WorkSpacesClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> WorkSpacesClient.WorkSpacesClientConfiguration {
        let clientConfiguration = try await WorkSpacesClient.WorkSpacesClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> WorkSpacesClient {
            let configuration = try await resolve(plugins: self.plugins)
            return WorkSpacesClient(config: configuration)
        }
    }
...
extension WorkSpacesClient.WorkSpacesClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
