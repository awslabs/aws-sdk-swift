...
extension PricingClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> PricingClient.PricingClientConfiguration {
        let clientConfiguration = try await PricingClient.PricingClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> PricingClient {
            let configuration = try await resolve(plugins: self.plugins)
            return PricingClient(config: configuration)
        }
    }
...
extension PricingClient.PricingClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
