...
public class PricingClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [ClientRuntime.AuthScheme]? = nil, authSchemeResolver: PricingAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any AWSClientRuntime.AWSCredentialIdentityResolver)? = nil) {
