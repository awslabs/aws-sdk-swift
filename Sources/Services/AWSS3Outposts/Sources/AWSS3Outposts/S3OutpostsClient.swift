...
public final class S3OutpostsClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "S3OutpostsClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: S3OutpostsClient.S3OutpostsClientConfig
    let serviceName = "S3Outposts"

    @available(*, deprecated, message: "Use S3OutpostsClient.S3OutpostsClientConfig instead")
    public typealias Config = S3OutpostsClient.S3OutpostsClientConfiguration
    public typealias Configuration = S3OutpostsClient.S3OutpostsClientConfig

    public required init(config: S3OutpostsClient.S3OutpostsClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: S3OutpostsClient.S3OutpostsClientConfig) instead")
    public convenience init(config: S3OutpostsClient.S3OutpostsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try S3OutpostsClient.S3OutpostsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await S3OutpostsClient.S3OutpostsClientConfig()
        self.init(config: config)
    }
}
...
extension S3OutpostsClient {
    ...
    /// Client configuration for S3OutpostsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct S3OutpostsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "S3Outposts")
    ...
    @available(*, deprecated, message: "Use S3OutpostsClientConfig instead. This class will be removed in a future version.")
    public final class S3OutpostsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> S3OutpostsClientConfig {
            return try S3OutpostsClientConfig(
...
extension S3OutpostsClient {
    ...
    public func createEndpoint(input: CreateEndpointInput) async throws -> CreateEndpointOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "S3Outposts"))
