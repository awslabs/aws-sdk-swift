...
public final class TaxSettingsClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: TaxSettingsClient.TaxSettingsClientConfig) instead")
    public convenience init(config: TaxSettingsClient.TaxSettingsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try TaxSettingsClient.TaxSettingsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await TaxSettingsClient.TaxSettingsClientConfig()
        self.init(config: config)
    }
}
...
extension TaxSettingsClient {
    ...
    /// Client configuration for TaxSettingsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct TaxSettingsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "TaxSettings")
    ...
    @available(*, deprecated, message: "Use TaxSettingsClientConfig instead. This class will be removed in a future version.")
    public final class TaxSettingsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> TaxSettingsClientConfig {
            return try TaxSettingsClientConfig(
...
extension TaxSettingsClient {
    ...
    public func batchDeleteTaxRegistration(input: BatchDeleteTaxRegistrationInput) async throws -> BatchDeleteTaxRegistrationOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "TaxSettings"))
