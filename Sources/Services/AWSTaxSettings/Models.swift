...
extension TaxSettingsClientTypes.MalaysiaAdditionalInfo {
    ...
    static func write(value: TaxSettingsClientTypes.MalaysiaAdditionalInfo?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["serviceTaxCodes"].writeList(value.serviceTaxCodes, memberWritingClosure: TaxSettingsClientTypes.MalaysiaServiceTaxCode.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TaxSettingsClientTypes.MalaysiaAdditionalInfo {
        ...
        value.serviceTaxCodes = try reader["serviceTaxCodes"].readListIfPresent(memberReadingClosure: TaxSettingsClientTypes.MalaysiaServiceTaxCode.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
