...
extension CreateDbClusterInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateDbClusterInput(allocatedStorage: \(Swift.String(describing: allocatedStorage)), bucket: \(Swift.String(describing: bucket)), dbInstanceType: \(Swift.String(describing: dbInstanceType)), dbParameterGroupIdentifier: \(Swift.String(describing: dbParameterGroupIdentifier)), dbStorageType: \(Swift.String(describing: dbStorageType)), deploymentType: \(Swift.String(describing: deploymentType)), failoverMode: \(Swift.String(describing: failoverMode)), logDeliveryConfiguration: \(Swift.String(describing: logDeliveryConfiguration)), maintenanceSchedule: \(Swift.String(describing: maintenanceSchedule)), name: \(Swift.String(describing: name)), networkType: \(Swift.String(describing: networkType)), organization: \(Swift.String(describing: organization)), port: \(Swift.String(describing: port)), publiclyAccessible: \(Swift.String(describing: publiclyAccessible)), tags: \(Swift.String(describing: tags)), vpcSecurityGroupIds: \(Swift.String(describing: vpcSecurityGroupIds)), vpcSubnetIds: \(Swift.String(describing: vpcSubnetIds)), password: \"CONTENT_REDACTED\", username: \"CONTENT_REDACTED\")"}
}
...
extension CreateDbInstanceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateDbInstanceInput(allocatedStorage: \(Swift.String(describing: allocatedStorage)), bucket: \(Swift.String(describing: bucket)), dbInstanceType: \(Swift.String(describing: dbInstanceType)), dbParameterGroupIdentifier: \(Swift.String(describing: dbParameterGroupIdentifier)), dbStorageType: \(Swift.String(describing: dbStorageType)), deploymentType: \(Swift.String(describing: deploymentType)), logDeliveryConfiguration: \(Swift.String(describing: logDeliveryConfiguration)), maintenanceSchedule: \(Swift.String(describing: maintenanceSchedule)), name: \(Swift.String(describing: name)), networkType: \(Swift.String(describing: networkType)), organization: \(Swift.String(describing: organization)), port: \(Swift.String(describing: port)), publiclyAccessible: \(Swift.String(describing: publiclyAccessible)), tags: \(Swift.String(describing: tags)), vpcSecurityGroupIds: \(Swift.String(describing: vpcSecurityGroupIds)), vpcSubnetIds: \(Swift.String(describing: vpcSubnetIds)), password: \"CONTENT_REDACTED\", username: \"CONTENT_REDACTED\")"}
}
...
extension CreateDbClusterInput {
    ...
    static func write(value: CreateDbClusterInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["maintenanceSchedule"].write(value.maintenanceSchedule, with: TimestreamInfluxDBClientTypes.MaintenanceSchedule.write(value:to:))
...
extension CreateDbInstanceOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> CreateDbInstanceOutput {
        ...
        value.lastMaintenanceTime = try reader["lastMaintenanceTime"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.dateTime)
        ...
        value.maintenanceSchedule = try reader["maintenanceSchedule"].readIfPresent(with: TimestreamInfluxDBClientTypes.MaintenanceSchedule.read(from:))
        value.name = try reader["name"].readIfPresent() ?? ""
        value.networkType = try reader["networkType"].readIfPresent()
        value.nextMaintenanceTime = try reader["nextMaintenanceTime"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.dateTime)
...
extension GetDbClusterOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> GetDbClusterOutput {
        ...
        value.allocatedStorage = try reader["allocatedStorage"].readIfPresent()
        value.arn = try reader["arn"].readIfPresent() ?? ""
        value.clusterConfiguration = try reader["clusterConfiguration"].readIfPresent(with: TimestreamInfluxDBClientTypes.ClusterConfiguration.read(from:))
        value.dbInstanceType = try reader["dbInstanceType"].readIfPresent()
        value.dbParameterGroupIdentifier = try reader["dbParameterGroupIdentifier"].readIfPresent()
        value.dbStorageType = try reader["dbStorageType"].readIfPresent()
        value.deploymentType = try reader["deploymentType"].readIfPresent()
...
extension TimestreamInfluxDBClientTypes.ClusterConfiguration {

    static func read(from reader: SmithyJSON.Reader) throws -> TimestreamInfluxDBClientTypes.ClusterConfiguration {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = TimestreamInfluxDBClientTypes.ClusterConfiguration()
        value.ingestQueryInstances = try reader["ingestQueryInstances"].readIfPresent()
        value.queryOnlyInstances = try reader["queryOnlyInstances"].readIfPresent()
        value.dedicatedCompactor = try reader["dedicatedCompactor"].readIfPresent()
        return value
    }
}
...
extension TimestreamInfluxDBClientTypes.MaintenanceSchedule {

    static func write(value: TimestreamInfluxDBClientTypes.MaintenanceSchedule?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["preferredMaintenanceWindow"].write(value.preferredMaintenanceWindow)
        try writer["timezone"].write(value.timezone)
    }

    static func read(from reader: SmithyJSON.Reader) throws -> TimestreamInfluxDBClientTypes.MaintenanceSchedule {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = TimestreamInfluxDBClientTypes.MaintenanceSchedule()
