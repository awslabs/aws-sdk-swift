...
public class TimestreamInfluxDBClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? TimestreamInfluxDBClient.TimestreamInfluxDBClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? TimestreamInfluxDBClient.TimestreamInfluxDBClientConfiguration {
            config.authSchemeResolver = DefaultTimestreamInfluxDBAuthSchemeResolver()
...
public class TimestreamInfluxDBClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: TimestreamInfluxDBAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
