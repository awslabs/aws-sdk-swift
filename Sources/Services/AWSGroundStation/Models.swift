...
extension CreateMissionProfileInput {
    ...
    static func write(value: CreateMissionProfileInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["contactPostPassDurationSeconds"].write(value.contactPostPassDurationSeconds)
        try writer["contactPrePassDurationSeconds"].write(value.contactPrePassDurationSeconds)
        try writer["dataflowEdges"].writeList(value.dataflowEdges, memberWritingClosure: listWritingClosure(memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
...
extension ListContactsInput {
    ...
    static func write(value: ListContactsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["statusList"].writeList(value.statusList, memberWritingClosure: GroundStationClientTypes.ContactStatus.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ListEphemeridesInput {
    ...
    static func write(value: ListEphemeridesInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["satelliteId"].write(value.satelliteId)
        try writer["startTime"].writeTimestamp(value.startTime, format: .epochSeconds)
        try writer["statusList"].writeList(value.statusList, memberWritingClosure: GroundStationClientTypes.EphemerisStatus.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeContactOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeContactOutput {
        ...
        value.postPassEndTime = try reader["postPassEndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.prePassStartTime = try reader["prePassStartTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.visibilityEndTime = try reader["visibilityEndTime"].readTimestampIfPresent(format: .epochSeconds)
        value.visibilityStartTime = try reader["visibilityStartTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension GetMissionProfileOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetMissionProfileOutput {
        ...
        value.contactPostPassDurationSeconds = try reader["contactPostPassDurationSeconds"].readIfPresent()
        value.contactPrePassDurationSeconds = try reader["contactPrePassDurationSeconds"].readIfPresent()
        value.dataflowEdges = try reader["dataflowEdges"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
...
extension GetSatelliteOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetSatelliteOutput {
        ...
        value.groundStations = try reader["groundStations"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension GroundStationClientTypes.EndpointDetails {
    ...
    static func write(value: GroundStationClientTypes.EndpointDetails?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["healthReasons"].writeList(value.healthReasons, memberWritingClosure: GroundStationClientTypes.CapabilityHealthReason.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GroundStationClientTypes.EndpointDetails {
        ...
        value.healthReasons = try reader["healthReasons"].readListIfPresent(memberReadingClosure: GroundStationClientTypes.CapabilityHealthReason.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GroundStationClientTypes.EphemerisMetaData {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> GroundStationClientTypes.EphemerisMetaData {
        ...
        value.ephemerisId = try reader["ephemerisId"].readIfPresent()
        value.epoch = try reader["epoch"].readTimestampIfPresent(format: .epochSeconds)
        value.name = try reader["name"].readIfPresent()
        return value
    }
}
...
extension GroundStationClientTypes.DiscoveryData {
    ...
    static func write(value: GroundStationClientTypes.DiscoveryData?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["capabilityArns"].writeList(value.capabilityArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["privateIpAddresses"].writeList(value.privateIpAddresses, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["publicIpAddresses"].writeList(value.publicIpAddresses, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GroundStationClientTypes.AgentDetails {
    ...
    static func write(value: GroundStationClientTypes.AgentDetails?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["agentCpuCores"].writeList(value.agentCpuCores, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["reservedCpuCores"].writeList(value.reservedCpuCores, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GroundStationClientTypes.AggregateStatus {
    ...
    static func write(value: GroundStationClientTypes.AggregateStatus?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["signatureMap"].writeMap(value.signatureMap, valueWritingClosure: Swift.Bool.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["status"].write(value.status)
    }
}
