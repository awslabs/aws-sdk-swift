...
extension TranscribeStreamingClient {
    ...
    public func startCallAnalyticsStreamTranscription(input: StartCallAnalyticsStreamTranscriptionInput) async throws -> StartCallAnalyticsStreamTranscriptionOutput {
        ...
        let builder = OrchestratorBuilder<StartCallAnalyticsStreamTranscriptionInput, StartCallAnalyticsStreamTranscriptionOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
    ...
    public func startMedicalStreamTranscription(input: StartMedicalStreamTranscriptionInput) async throws -> StartMedicalStreamTranscriptionOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .build()
        try context.setupBidirectionalStreaming()
        let builder = OrchestratorBuilder<StartMedicalStreamTranscriptionInput, StartMedicalStreamTranscriptionOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
    ...
    public func startStreamTranscription(input: StartStreamTranscriptionInput) async throws -> StartStreamTranscriptionOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .build()
        try context.setupBidirectionalStreaming()
        let builder = OrchestratorBuilder<StartStreamTranscriptionInput, StartStreamTranscriptionOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
