...
extension TranscribeStreamingClient {
    ...
    public func startCallAnalyticsStreamTranscription(input: StartCallAnalyticsStreamTranscriptionInput) async throws -> StartCallAnalyticsStreamTranscriptionOutput {
        ...
        let builder = OrchestratorBuilder<StartCallAnalyticsStreamTranscriptionInput, StartCallAnalyticsStreamTranscriptionOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
    ...
    public func startMedicalStreamTranscription(input: StartMedicalStreamTranscriptionInput) async throws -> StartMedicalStreamTranscriptionOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .build()
        try context.setupBidirectionalStreaming()
        let builder = OrchestratorBuilder<StartMedicalStreamTranscriptionInput, StartMedicalStreamTranscriptionOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
    ...
    public func startStreamTranscription(input: StartStreamTranscriptionInput) async throws -> StartStreamTranscriptionOutput {
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .build()
        try context.setupBidirectionalStreaming()
        let builder = OrchestratorBuilder<StartStreamTranscriptionInput, StartStreamTranscriptionOutput, ClientRuntime.SdkHttpRequest, ClientRuntime.HttpResponse, ClientRuntime.HttpContext>()
