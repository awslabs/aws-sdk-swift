...
extension TranscribeStreamingClient {
    ...
    public struct TranscribeStreamingClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Transcribe Streaming")
...
extension TranscribeStreamingClient {
    ...
    public func getMedicalScribeStream(input: GetMedicalScribeStreamInput) async throws -> GetMedicalScribeStreamOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Transcribe Streaming"))
