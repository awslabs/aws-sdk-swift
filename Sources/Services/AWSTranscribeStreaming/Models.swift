    ...
    static var marshal: SmithyEventStreamsAPI.MarshalClosure<TranscribeStreamingClientTypes.AudioStream> {
        { (self) in
            ...
            case .configurationevent(let value):
                ...
                try writer["ChannelDefinitions"].write(value.channelDefinitions, with: listWritingClosure(memberWritingClosure: TranscribeStreamingClientTypes.ChannelDefinition.write(value:to:), memberNodeInfo: "member", isFlattened: false))
