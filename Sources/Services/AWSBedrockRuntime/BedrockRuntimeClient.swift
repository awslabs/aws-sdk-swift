...
extension BedrockRuntimeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> BedrockRuntimeClient.BedrockRuntimeClientConfiguration {
        let clientConfiguration = try await BedrockRuntimeClient.BedrockRuntimeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> BedrockRuntimeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return BedrockRuntimeClient(config: configuration)
        }
    }
...
extension BedrockRuntimeClient.BedrockRuntimeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
