...
extension CodeConnectionsClientTypes.Connection: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        let providerTypeDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.ProviderType.self, forKey: .providerType)
        ...
        let connectionStatusDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.ConnectionStatus.self, forKey: .connectionStatus)
...
struct CreateConnectionInputBody {
    let providerType: CodeConnectionsClientTypes.ProviderType?
    let connectionName: Swift.String?
    let tags: [CodeConnectionsClientTypes.Tag]?
...
extension CreateConnectionInputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        let connectionNameDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .connectionName)
        connectionName = connectionNameDecoded
        let tagsContainer = try containerValues.decodeIfPresent([CodeConnectionsClientTypes.Tag?].self, forKey: .tags)
        var tagsDecoded0:[CodeConnectionsClientTypes.Tag]? = nil
        if let tagsContainer = tagsContainer {
            tagsDecoded0 = [CodeConnectionsClientTypes.Tag]()
...
struct CreateHostInputBody {
    ...
    let vpcConfiguration: CodeConnectionsClientTypes.VpcConfiguration?
    let tags: [CodeConnectionsClientTypes.Tag]?
}
...
extension CreateHostInputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        let vpcConfigurationDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.VpcConfiguration.self, forKey: .vpcConfiguration)
...
struct CreateRepositoryLinkOutputBody {
    let repositoryLinkInfo: CodeConnectionsClientTypes.RepositoryLinkInfo?
}
...
extension CreateRepositoryLinkOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let repositoryLinkInfoDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.RepositoryLinkInfo.self, forKey: .repositoryLinkInfo)
...
struct CreateSyncConfigurationInputBody {
    ...
    let syncType: CodeConnectionsClientTypes.SyncConfigurationType?
    let publishDeploymentStatus: CodeConnectionsClientTypes.PublishDeploymentStatus?
    let triggerResourceUpdateOn: CodeConnectionsClientTypes.TriggerResourceUpdateOn?
}
...
extension CreateSyncConfigurationInputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        let syncTypeDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.SyncConfigurationType.self, forKey: .syncType)
        syncType = syncTypeDecoded
        let publishDeploymentStatusDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.PublishDeploymentStatus.self, forKey: .publishDeploymentStatus)
        publishDeploymentStatus = publishDeploymentStatusDecoded
        let triggerResourceUpdateOnDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.TriggerResourceUpdateOn.self, forKey: .triggerResourceUpdateOn)
...
struct CreateSyncConfigurationOutputBody {
    let syncConfiguration: CodeConnectionsClientTypes.SyncConfiguration?
}
...
extension CreateSyncConfigurationOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let syncConfigurationDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.SyncConfiguration.self, forKey: .syncConfiguration)
...
struct GetConnectionOutputBody {
    let connection: CodeConnectionsClientTypes.Connection?
}
...
extension GetConnectionOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let connectionDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.Connection.self, forKey: .connection)
...
struct GetRepositorySyncStatusOutputBody {
    let latestSync: CodeConnectionsClientTypes.RepositorySyncAttempt?
}
...
extension GetRepositorySyncStatusOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let latestSyncDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.RepositorySyncAttempt.self, forKey: .latestSync)
...
struct GetResourceSyncStatusOutputBody {
    let desiredState: CodeConnectionsClientTypes.Revision?
    let latestSuccessfulSync: CodeConnectionsClientTypes.ResourceSyncAttempt?
    let latestSync: CodeConnectionsClientTypes.ResourceSyncAttempt?
}
...
extension GetResourceSyncStatusOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let desiredStateDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.Revision.self, forKey: .desiredState)
        desiredState = desiredStateDecoded
        let latestSuccessfulSyncDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.ResourceSyncAttempt.self, forKey: .latestSuccessfulSync)
        latestSuccessfulSync = latestSuccessfulSyncDecoded
        let latestSyncDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.ResourceSyncAttempt.self, forKey: .latestSync)
        latestSync = latestSyncDecoded
    }
}
...
struct GetSyncBlockerSummaryOutputBody {
    let syncBlockerSummary: CodeConnectionsClientTypes.SyncBlockerSummary?
}
...
extension GetSyncBlockerSummaryOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let syncBlockerSummaryDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.SyncBlockerSummary.self, forKey: .syncBlockerSummary)
...
extension CodeConnectionsClientTypes.Host: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case hostArn = "HostArn"
        case name = "Name"
        case providerEndpoint = "ProviderEndpoint"
...
struct ListConnectionsInputBody {
    let providerTypeFilter: CodeConnectionsClientTypes.ProviderType?
...
extension ListConnectionsInputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let providerTypeFilterDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.ProviderType.self, forKey: .providerTypeFilter)
...
struct ListConnectionsOutputBody {
    let connections: [CodeConnectionsClientTypes.Connection]?
    let nextToken: Swift.String?
}
...
extension ListConnectionsOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let connectionsContainer = try containerValues.decodeIfPresent([CodeConnectionsClientTypes.Connection?].self, forKey: .connections)
        var connectionsDecoded0:[CodeConnectionsClientTypes.Connection]? = nil
        if let connectionsContainer = connectionsContainer {
            connectionsDecoded0 = [CodeConnectionsClientTypes.Connection]()
...
struct ListHostsOutputBody {
    let hosts: [CodeConnectionsClientTypes.Host]?
    let nextToken: Swift.String?
}
...
extension ListHostsOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let hostsContainer = try containerValues.decodeIfPresent([CodeConnectionsClientTypes.Host?].self, forKey: .hosts)
        var hostsDecoded0:[CodeConnectionsClientTypes.Host]? = nil
        if let hostsContainer = hostsContainer {
            hostsDecoded0 = [CodeConnectionsClientTypes.Host]()
...
struct ListRepositoryLinksOutputBody {
    let repositoryLinks: [CodeConnectionsClientTypes.RepositoryLinkInfo]?
    let nextToken: Swift.String?
}
...
extension ListRepositoryLinksOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let repositoryLinksContainer = try containerValues.decodeIfPresent([CodeConnectionsClientTypes.RepositoryLinkInfo?].self, forKey: .repositoryLinks)
        var repositoryLinksDecoded0:[CodeConnectionsClientTypes.RepositoryLinkInfo]? = nil
        if let repositoryLinksContainer = repositoryLinksContainer {
            repositoryLinksDecoded0 = [CodeConnectionsClientTypes.RepositoryLinkInfo]()
...
struct ListRepositorySyncDefinitionsOutputBody {
    let repositorySyncDefinitions: [CodeConnectionsClientTypes.RepositorySyncDefinition]?
    let nextToken: Swift.String?
}
...
extension ListRepositorySyncDefinitionsOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let repositorySyncDefinitionsContainer = try containerValues.decodeIfPresent([CodeConnectionsClientTypes.RepositorySyncDefinition?].self, forKey: .repositorySyncDefinitions)
        var repositorySyncDefinitionsDecoded0:[CodeConnectionsClientTypes.RepositorySyncDefinition]? = nil
        if let repositorySyncDefinitionsContainer = repositorySyncDefinitionsContainer {
            repositorySyncDefinitionsDecoded0 = [CodeConnectionsClientTypes.RepositorySyncDefinition]()
...
struct ListSyncConfigurationsOutputBody {
    let syncConfigurations: [CodeConnectionsClientTypes.SyncConfiguration]?
    let nextToken: Swift.String?
}
...
extension ListSyncConfigurationsOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let syncConfigurationsContainer = try containerValues.decodeIfPresent([CodeConnectionsClientTypes.SyncConfiguration?].self, forKey: .syncConfigurations)
        var syncConfigurationsDecoded0:[CodeConnectionsClientTypes.SyncConfiguration]? = nil
        if let syncConfigurationsContainer = syncConfigurationsContainer {
            syncConfigurationsDecoded0 = [CodeConnectionsClientTypes.SyncConfiguration]()
...
extension CodeConnectionsClientTypes.RepositoryLinkInfo: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case connectionArn = "ConnectionArn"
        case encryptionKeyArn = "EncryptionKeyArn"
        case ownerId = "OwnerId"
...
extension CodeConnectionsClientTypes.RepositorySyncAttempt: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case events = "Events"
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        let statusDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.RepositorySyncStatus.self, forKey: .status)
        status = statusDecoded
        let eventsContainer = try containerValues.decodeIfPresent([CodeConnectionsClientTypes.RepositorySyncEvent?].self, forKey: .events)
        var eventsDecoded0:[CodeConnectionsClientTypes.RepositorySyncEvent]? = nil
        if let eventsContainer = eventsContainer {
            eventsDecoded0 = [CodeConnectionsClientTypes.RepositorySyncEvent]()
...
extension CodeConnectionsClientTypes.RepositorySyncDefinition: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case branch = "Branch"
...
extension CodeConnectionsClientTypes.RepositorySyncEvent: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case event = "Event"
...
extension CodeConnectionsClientTypes.ResourceSyncAttempt: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case events = "Events"
    ...
    public init(from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let eventsContainer = try containerValues.decodeIfPresent([CodeConnectionsClientTypes.ResourceSyncEvent?].self, forKey: .events)
        var eventsDecoded0:[CodeConnectionsClientTypes.ResourceSyncEvent]? = nil
        if let eventsContainer = eventsContainer {
            eventsDecoded0 = [CodeConnectionsClientTypes.ResourceSyncEvent]()
            for structure0 in eventsContainer {
                if let structure0 = structure0 {
                    eventsDecoded0?.append(structure0)
                }
        ...
        events = eventsDecoded0
        let initialRevisionDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.Revision.self, forKey: .initialRevision)
        initialRevision = initialRevisionDecoded
        let startedAtDecoded = try containerValues.decodeTimestampIfPresent(.epochSeconds, forKey: .startedAt)
        startedAt = startedAtDecoded
        let statusDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.ResourceSyncStatus.self, forKey: .status)
        status = statusDecoded
        let targetRevisionDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.Revision.self, forKey: .targetRevision)
...
extension CodeConnectionsClientTypes.ResourceSyncEvent: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case event = "Event"
        case externalId = "ExternalId"
        case time = "Time"
...
extension CodeConnectionsClientTypes.Revision: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case branch = "Branch"
        case directory = "Directory"
        case ownerId = "OwnerId"
...
extension CodeConnectionsClientTypes.SyncBlocker: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        id = idDecoded
        let typeDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.BlockerType.self, forKey: .type)
        type = typeDecoded
        let statusDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.BlockerStatus.self, forKey: .status)
        status = statusDecoded
        ...
        let contextsContainer = try containerValues.decodeIfPresent([CodeConnectionsClientTypes.SyncBlockerContext?].self, forKey: .contexts)
        var contextsDecoded0:[CodeConnectionsClientTypes.SyncBlockerContext]? = nil
        if let contextsContainer = contextsContainer {
            contextsDecoded0 = [CodeConnectionsClientTypes.SyncBlockerContext]()
...
extension CodeConnectionsClientTypes.SyncBlockerContext: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
...
extension CodeConnectionsClientTypes.SyncBlockerSummary: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        let latestBlockersContainer = try containerValues.decodeIfPresent([CodeConnectionsClientTypes.SyncBlocker?].self, forKey: .latestBlockers)
        var latestBlockersDecoded0:[CodeConnectionsClientTypes.SyncBlocker]? = nil
        if let latestBlockersContainer = latestBlockersContainer {
            latestBlockersDecoded0 = [CodeConnectionsClientTypes.SyncBlocker]()
...
extension CodeConnectionsClientTypes.SyncConfiguration: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case branch = "Branch"
        case configFile = "ConfigFile"
        case ownerId = "OwnerId"
...
extension CodeConnectionsClientTypes.Tag: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
...
struct UpdateSyncBlockerOutputBody {
    ...
    let syncBlocker: CodeConnectionsClientTypes.SyncBlocker?
}
...
extension UpdateSyncBlockerOutputBody: Swift.Decodable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        let parentResourceNameDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .parentResourceName)
        parentResourceName = parentResourceNameDecoded
        let syncBlockerDecoded = try containerValues.decodeIfPresent(CodeConnectionsClientTypes.SyncBlocker.self, forKey: .syncBlocker)
...
extension CodeConnectionsClientTypes.VpcConfiguration: Swift.Codable {
    enum CodingKeys: Swift.String, Swift.CodingKey {
