...
extension NimbleClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> NimbleClient.NimbleClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> NimbleClient {
            let configuration = try await resolve(plugins: self.plugins)
            return NimbleClient(config: configuration)
        }
    }
...
extension NimbleClient.NimbleClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
