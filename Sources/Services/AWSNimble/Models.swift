...
extension NimbleClientTypes.EulaAcceptance {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NimbleClientTypes.EulaAcceptance {
        ...
        value.acceptedAt = try reader["acceptedAt"].readTimestampIfPresent(format: .dateTime)
...
extension NimbleClientTypes.LaunchProfile {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NimbleClientTypes.LaunchProfile {
        ...
        value.launchProfileProtocolVersions = try reader["launchProfileProtocolVersions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.studioComponentIds = try reader["studioComponentIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension NimbleClientTypes.StreamConfigurationSessionStorage {
    ...
    static func write(value: NimbleClientTypes.StreamConfigurationSessionStorage?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["mode"].writeList(value.mode, memberWritingClosure: NimbleClientTypes.StreamingSessionStorageMode.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NimbleClientTypes.StreamConfigurationSessionStorage {
        ...
        value.mode = try reader["mode"].readListIfPresent(memberReadingClosure: NimbleClientTypes.StreamingSessionStorageMode.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension NimbleClientTypes.StreamingImage {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NimbleClientTypes.StreamingImage {
        ...
        value.eulaIds = try reader["eulaIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.name = try reader["name"].readIfPresent()
...
extension NimbleClientTypes.StreamingSession {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NimbleClientTypes.StreamingSession {
        ...
        value.streamingImageId = try reader["streamingImageId"].readIfPresent()
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.terminateAt = try reader["terminateAt"].readTimestampIfPresent(format: .dateTime)
        value.updatedAt = try reader["updatedAt"].readTimestampIfPresent(format: .dateTime)
        value.updatedBy = try reader["updatedBy"].readIfPresent()
        ...
        value.stopAt = try reader["stopAt"].readTimestampIfPresent(format: .dateTime)
...
extension NimbleClientTypes.StreamingSessionStream {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NimbleClientTypes.StreamingSessionStream {
        ...
        value.createdAt = try reader["createdAt"].readTimestampIfPresent(format: .dateTime)
        value.createdBy = try reader["createdBy"].readIfPresent()
        value.expiresAt = try reader["expiresAt"].readTimestampIfPresent(format: .dateTime)
        value.ownedBy = try reader["ownedBy"].readIfPresent()
        value.state = try reader["state"].readIfPresent()
        value.statusCode = try reader["statusCode"].readIfPresent()
...
extension NimbleClientTypes.StudioComponent {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> NimbleClientTypes.StudioComponent {
        ...
        value.createdBy = try reader["createdBy"].readIfPresent()
        value.description = try reader["description"].readIfPresent()
        value.ec2SecurityGroupIds = try reader["ec2SecurityGroupIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
