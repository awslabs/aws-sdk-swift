...
extension AppConfigClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> AppConfigClient.AppConfigClientConfiguration {
        let clientConfiguration = try await AppConfigClient.AppConfigClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> AppConfigClient {
            let configuration = try await resolve(plugins: self.plugins)
            return AppConfigClient(config: configuration)
        }
    }
...
extension AppConfigClient.AppConfigClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
