...
@testable import AWSMWAAServerless
import XCTest
...
class EndpointResolverTest: XCTestCase {
    ...
    func testResolve3() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://airflow-serverless-fips.us-east-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve4() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://airflow-serverless.us-east-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve5() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://airflow-serverless-fips.cn-northwest-1.api.amazonwebservices.com.cn", headers: headers, properties: properties)
    ...
    func testResolve6() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://airflow-serverless.cn-northwest-1.api.amazonwebservices.com.cn", headers: headers, properties: properties)
    ...
    func testResolve7() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://airflow-serverless-fips.us-gov-west-1.api.aws", headers: headers, properties: properties)
    ...
    func testResolve8() throws {
        ...
        let headers = SmithyHTTPAPI.Headers()
        let expected = try SmithyHTTPAPI.Endpoint(urlString: "https://airflow-serverless.us-gov-west-1.api.aws", headers: headers, properties: properties)
