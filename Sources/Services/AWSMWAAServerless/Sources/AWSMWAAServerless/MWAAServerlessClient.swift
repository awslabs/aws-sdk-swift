...
public final class MWAAServerlessClient: AWSClientRuntime.AWSServiceClient, Sendable {
...
extension MWAAServerlessClient {
    ...
    public final class MWAAServerlessClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, @unchecked Sendable {
        ...
        private init(
            ...
            self.logger = telemetryProvider.loggerProvider.getLogger(name: MWAAServerlessClient.clientName)
        }
        ...
        public convenience init(region: Swift.String) throws {
            self.init(
                ...
                nil,
                DefaultMWAAServerlessAuthSchemeResolver(),
