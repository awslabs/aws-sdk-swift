...
extension TranslateClientTypes.ParallelDataProperties {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TranslateClientTypes.ParallelDataProperties {
        ...
        value.targetLanguageCodes = try reader["TargetLanguageCodes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.latestUpdateAttemptAt = try reader["LatestUpdateAttemptAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension TranslateClientTypes.TextTranslationJobProperties {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> TranslateClientTypes.TextTranslationJobProperties {
        ...
        value.sourceLanguageCode = try reader["SourceLanguageCode"].readIfPresent()
        value.targetLanguageCodes = try reader["TargetLanguageCodes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.terminologyNames = try reader["TerminologyNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.parallelDataNames = try reader["ParallelDataNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.message = try reader["Message"].readIfPresent()
        value.submittedTime = try reader["SubmittedTime"].readTimestampIfPresent(format: .epochSeconds)
