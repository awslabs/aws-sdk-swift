...
extension SageMakerRuntimeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SageMakerRuntimeClient.SageMakerRuntimeClientConfiguration {
        let clientConfiguration = try await SageMakerRuntimeClient.SageMakerRuntimeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SageMakerRuntimeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SageMakerRuntimeClient(config: configuration)
        }
    }
...
extension SageMakerRuntimeClient.SageMakerRuntimeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
