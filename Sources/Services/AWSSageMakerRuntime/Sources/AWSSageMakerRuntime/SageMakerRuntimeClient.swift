...
public final class SageMakerRuntimeClient: AWSClientRuntime.AWSServiceClient {
    ...
    public let config: SageMakerRuntimeClient.SageMakerRuntimeClientConfig
    let serviceName = "SageMaker Runtime"
    let retryStrategy: SmithyRetries.DefaultRetryStrategy

    @available(*, deprecated, message: "Use SageMakerRuntimeClient.SageMakerRuntimeClientConfig instead")
    public typealias Config = SageMakerRuntimeClient.SageMakerRuntimeClientConfiguration
    public typealias Configuration = SageMakerRuntimeClient.SageMakerRuntimeClientConfig

    public required init(config: SageMakerRuntimeClient.SageMakerRuntimeClientConfig) {
    ...
    @available(*, deprecated, message: "Use init(config: SageMakerRuntimeClient.SageMakerRuntimeClientConfig) instead")
    public convenience init(config: SageMakerRuntimeClient.SageMakerRuntimeClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try SageMakerRuntimeClient.SageMakerRuntimeClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await SageMakerRuntimeClient.SageMakerRuntimeClientConfig()
        self.init(config: config)
    }
}
...
extension SageMakerRuntimeClient {
    ...
    /// Client configuration for SageMakerRuntimeClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct SageMakerRuntimeClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "SageMaker Runtime")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultSageMakerRuntimeAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: SageMakerRuntimeClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultSageMakerRuntimeAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use SageMakerRuntimeClientConfig instead. This class will be removed in a future version.")
    public final class SageMakerRuntimeClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> SageMakerRuntimeClientConfig {
            return try SageMakerRuntimeClientConfig(
...
extension SageMakerRuntimeClient {
    ...
    public func invokeEndpoint(input: InvokeEndpointInput) async throws -> InvokeEndpointOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("SageMaker Runtime", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<InvokeEndpointOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SageMaker Runtime"))
    ...
    public func invokeEndpointAsync(input: InvokeEndpointAsyncInput) async throws -> InvokeEndpointAsyncOutput {
        ...
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<InvokeEndpointAsyncInput, InvokeEndpointAsyncOutput>(contentType: "application/octet-stream"))
        builder.serialize(ClientRuntime.BlobBodyMiddleware<InvokeEndpointAsyncInput, InvokeEndpointAsyncOutput>(keyPath: \.body))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<InvokeEndpointAsyncInput, InvokeEndpointAsyncOutput>())
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<InvokeEndpointAsyncOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func invokeEndpointWithResponseStream(input: InvokeEndpointWithResponseStreamInput) async throws -> InvokeEndpointWithResponseStreamOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<InvokeEndpointWithResponseStreamOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
