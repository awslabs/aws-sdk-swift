...
public final class RDSDataClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "RDSDataClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: RDSDataClient.RDSDataClientConfig
    let serviceName = "RDS Data"

    @available(*, deprecated, message: "Use RDSDataClient.RDSDataClientConfig instead")
    public typealias Config = RDSDataClient.RDSDataClientConfiguration
    public typealias Configuration = RDSDataClient.RDSDataClientConfig

    public required init(config: RDSDataClient.RDSDataClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: RDSDataClient.RDSDataClientConfig) instead")
    public convenience init(config: RDSDataClient.RDSDataClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try RDSDataClient.RDSDataClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await RDSDataClient.RDSDataClientConfig()
        self.init(config: config)
    }
}
...
extension RDSDataClient {
    ...
    /// Client configuration for RDSDataClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct RDSDataClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "RDS Data")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: RDSDataClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use RDSDataClientConfig instead. This class will be removed in a future version.")
    public final class RDSDataClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> RDSDataClientConfig {
            return try RDSDataClientConfig(
...
extension RDSDataClient {
    ...
    public func batchExecuteStatement(input: BatchExecuteStatementInput) async throws -> BatchExecuteStatementOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "RDS Data"))
