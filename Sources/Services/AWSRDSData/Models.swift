...
extension BatchExecuteStatementInput {
    ...
    static func write(value: BatchExecuteStatementInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["parameterSets"].writeList(value.parameterSets, memberWritingClosure: listWritingClosure(memberWritingClosure: RDSDataClientTypes.SqlParameter.write(value:to:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
...
extension ExecuteStatementOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ExecuteStatementOutput {
        ...
        value.records = try reader["records"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: RDSDataClientTypes.Field.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension RDSDataClientTypes.ArrayValue {
    ...
    static func write(value: RDSDataClientTypes.ArrayValue?, to writer: SmithyJSON.Writer) throws {
        ...
        switch value {
            ...
            case let .booleanvalues(booleanvalues):
                try writer["booleanValues"].writeList(booleanvalues, memberWritingClosure: Swift.Bool.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .doublevalues(doublevalues):
                try writer["doubleValues"].writeList(doublevalues, memberWritingClosure: Swift.Double.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .longvalues(longvalues):
                try writer["longValues"].writeList(longvalues, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .stringvalues(stringvalues):
                try writer["stringValues"].writeList(stringvalues, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .sdkUnknown(sdkUnknown):
                try writer["sdkUnknown"].write(sdkUnknown)
        }
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> RDSDataClientTypes.ArrayValue {
        ...
        switch name {
            case "booleanValues":
                return .booleanvalues(try reader["booleanValues"].readList(memberReadingClosure: Swift.Bool.read(from:), memberNodeInfo: "member", isFlattened: false))
            case "longValues":
                return .longvalues(try reader["longValues"].readList(memberReadingClosure: Swift.Int.read(from:), memberNodeInfo: "member", isFlattened: false))
            case "doubleValues":
                return .doublevalues(try reader["doubleValues"].readList(memberReadingClosure: Swift.Double.read(from:), memberNodeInfo: "member", isFlattened: false))
            case "stringValues":
