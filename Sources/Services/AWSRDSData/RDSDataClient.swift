...
extension RDSDataClient {
    ...
    public struct ServiceSpecificConfiguration: AWSServiceSpecificConfiguration {
        ...
        public typealias AWSAuthSchemeResolver = RDSDataAuthSchemeResolver

        public var serviceName: String { "RDS Data" }
        public var clientName: String { "RDSDataClient" }
        public var authSchemeResolver: RDSDataAuthSchemeResolver
        public var endpointResolver: EndpointResolver

        public init(endpointResolver: EndpointResolver? = nil, authSchemeResolver: RDSDataAuthSchemeResolver? = nil) throws {
            self.endpointResolver = try endpointResolver ?? DefaultEndpointResolver()
            self.authSchemeResolver = authSchemeResolver ?? DefaultRDSDataAuthSchemeResolver()
        }
    }
}
