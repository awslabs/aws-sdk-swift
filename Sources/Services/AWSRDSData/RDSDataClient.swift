...
extension RDSDataClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> RDSDataClient.RDSDataClientConfiguration {
        let clientConfiguration = try await RDSDataClient.RDSDataClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> RDSDataClient {
            let configuration = try await resolve(plugins: self.plugins)
            return RDSDataClient(config: configuration)
        }
    }
...
extension RDSDataClient.RDSDataClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
