...
extension SageMakerFeatureStoreRuntimeClientTypes.BatchGetRecordIdentifier {
    ...
    static func write(value: SageMakerFeatureStoreRuntimeClientTypes.BatchGetRecordIdentifier?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["FeatureNames"].writeList(value.featureNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["RecordIdentifiersValueAsString"].writeList(value.recordIdentifiersValueAsString, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SageMakerFeatureStoreRuntimeClientTypes.BatchGetRecordIdentifier {
        ...
        value.featureGroupName = try reader["FeatureGroupName"].readIfPresent()
        value.recordIdentifiersValueAsString = try reader["RecordIdentifiersValueAsString"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.featureNames = try reader["FeatureNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SageMakerFeatureStoreRuntimeClientTypes.FeatureValue {
    ...
    static func write(value: SageMakerFeatureStoreRuntimeClientTypes.FeatureValue?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ValueAsStringList"].writeList(value.valueAsStringList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SageMakerFeatureStoreRuntimeClientTypes.FeatureValue {
        ...
        value.valueAsStringList = try reader["ValueAsStringList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension PutRecordInput {
    ...
    static func write(value: PutRecordInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["TargetStores"].writeList(value.targetStores, memberWritingClosure: SageMakerFeatureStoreRuntimeClientTypes.TargetStore.write(value:to:), memberNodeInfo: "member", isFlattened: false)
