...
extension SageMakerFeatureStoreRuntimeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SageMakerFeatureStoreRuntimeClient.SageMakerFeatureStoreRuntimeClientConfiguration {
        let clientConfiguration = try await SageMakerFeatureStoreRuntimeClient.SageMakerFeatureStoreRuntimeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SageMakerFeatureStoreRuntimeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SageMakerFeatureStoreRuntimeClient(config: configuration)
        }
    }
...
extension SageMakerFeatureStoreRuntimeClient.SageMakerFeatureStoreRuntimeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
