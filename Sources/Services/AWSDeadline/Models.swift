...
extension CreateQueueInput {
    ...
    static func write(value: CreateQueueInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["allowedStorageProfileIds"].writeList(value.allowedStorageProfileIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["requiredFileSystemLocationNames"].writeList(value.requiredFileSystemLocationNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["roleArn"].write(value.roleArn)
        try writer["tags"].writeMap(value.tags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension SearchJobsInput {
    ...
    static func write(value: SearchJobsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["queueIds"].writeList(value.queueIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension StartSessionsStatisticsAggregationInput {
    ...
    static func write(value: StartSessionsStatisticsAggregationInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["groupBy"].writeList(value.groupBy, memberWritingClosure: DeadlineClientTypes.UsageGroupByField.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["statistics"].writeList(value.statistics, memberWritingClosure: DeadlineClientTypes.UsageStatistic.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension UpdateQueueInput {
    ...
    static func write(value: UpdateQueueInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["allowedStorageProfileIdsToAdd"].writeList(value.allowedStorageProfileIdsToAdd, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["allowedStorageProfileIdsToRemove"].writeList(value.allowedStorageProfileIdsToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["defaultBudgetAction"].write(value.defaultBudgetAction)
        try writer["description"].write(value.description)
        try writer["displayName"].write(value.displayName)
        try writer["jobAttachmentSettings"].write(value.jobAttachmentSettings, with: DeadlineClientTypes.JobAttachmentSettings.write(value:to:))
        try writer["jobRunAsUser"].write(value.jobRunAsUser, with: DeadlineClientTypes.JobRunAsUser.write(value:to:))
        try writer["requiredFileSystemLocationNamesToAdd"].writeList(value.requiredFileSystemLocationNamesToAdd, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["requiredFileSystemLocationNamesToRemove"].writeList(value.requiredFileSystemLocationNamesToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["roleArn"].write(value.roleArn)
    }
}
...
extension GetBudgetOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetBudgetOutput {
        ...
        value.approximateDollarLimit = try reader["approximateDollarLimit"].readIfPresent()
        value.budgetId = try reader["budgetId"].readIfPresent()
        value.createdAt = try reader["createdAt"].readTimestampIfPresent(format: .dateTime)
        value.createdBy = try reader["createdBy"].readIfPresent()
        value.description = try reader["description"].readIfPresent()
        value.displayName = try reader["displayName"].readIfPresent()
        value.queueStoppedAt = try reader["queueStoppedAt"].readTimestampIfPresent(format: .dateTime)
...
extension GetFleetOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetFleetOutput {
        ...
        value.minWorkerCount = try reader["minWorkerCount"].readIfPresent()
        value.roleArn = try reader["roleArn"].readIfPresent()
        value.status = try reader["status"].readIfPresent()
        value.targetWorkerCount = try reader["targetWorkerCount"].readIfPresent()
        value.updatedAt = try reader["updatedAt"].readTimestampIfPresent(format: .dateTime)
        value.updatedBy = try reader["updatedBy"].readIfPresent()
        value.workerCount = try reader["workerCount"].readIfPresent()
        return value
    }
}
...
extension GetJobOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetJobOutput {
        ...
        value.taskRunStatusCounts = try reader["taskRunStatusCounts"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.updatedAt = try reader["updatedAt"].readTimestampIfPresent(format: .dateTime)
        value.updatedBy = try reader["updatedBy"].readIfPresent()
        return value
    }
...
extension GetQueueOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetQueueOutput {
        ...
        value.allowedStorageProfileIds = try reader["allowedStorageProfileIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.blockedReason = try reader["blockedReason"].readIfPresent()
        value.createdAt = try reader["createdAt"].readTimestampIfPresent(format: .dateTime)
        value.createdBy = try reader["createdBy"].readIfPresent()
        value.defaultBudgetAction = try reader["defaultBudgetAction"].readIfPresent()
        value.description = try reader["description"].readIfPresent()
        value.displayName = try reader["displayName"].readIfPresent()
        value.farmId = try reader["farmId"].readIfPresent()
        ...
        value.queueId = try reader["queueId"].readIfPresent()
        value.requiredFileSystemLocationNames = try reader["requiredFileSystemLocationNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.roleArn = try reader["roleArn"].readIfPresent()
        value.status = try reader["status"].readIfPresent()
        value.updatedAt = try reader["updatedAt"].readTimestampIfPresent(format: .dateTime)
        value.updatedBy = try reader["updatedBy"].readIfPresent()
...
extension GetSessionActionOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetSessionActionOutput {
        ...
        value.startedAt = try reader["startedAt"].readTimestampIfPresent(format: .dateTime)
        value.status = try reader["status"].readIfPresent()
        value.workerUpdatedAt = try reader["workerUpdatedAt"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
...
extension GetStorageProfileOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetStorageProfileOutput {
        ...
        value.osFamily = try reader["osFamily"].readIfPresent()
        value.storageProfileId = try reader["storageProfileId"].readIfPresent()
        value.updatedAt = try reader["updatedAt"].readTimestampIfPresent(format: .dateTime)
        value.updatedBy = try reader["updatedBy"].readIfPresent()
        return value
...
extension UpdateWorkerScheduleOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> UpdateWorkerScheduleOutput {
        ...
        value.cancelSessionActions = try reader["cancelSessionActions"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.desiredWorkerStatus = try reader["desiredWorkerStatus"].readIfPresent()
        value.updateIntervalSeconds = try reader["updateIntervalSeconds"].readIfPresent()
        return value
    }
}
...
extension DeadlineClientTypes.StepDetailsEntity {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.StepDetailsEntity {
        ...
        value.schemaVersion = try reader["schemaVersion"].readIfPresent()
        value.template = try reader["template"].readIfPresent()
        value.dependencies = try reader["dependencies"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DeadlineClientTypes.ManifestProperties {
    ...
    static func write(value: DeadlineClientTypes.ManifestProperties?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["outputRelativeDirectories"].writeList(value.outputRelativeDirectories, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.ManifestProperties {
        ...
        value.rootPathFormat = try reader["rootPathFormat"].readIfPresent()
        value.outputRelativeDirectories = try reader["outputRelativeDirectories"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DeadlineClientTypes.PathMappingRule {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.PathMappingRule {
        ...
        value.sourcePathFormat = try reader["sourcePathFormat"].readIfPresent()
...
extension DeadlineClientTypes.JobRunAsUser {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.JobRunAsUser {
        ...
        value.runAs = try reader["runAs"].readIfPresent()
        return value
    }
}
...
extension DeadlineClientTypes.ConsumedUsages {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.ConsumedUsages {
        ...
        value.approximateDollarUsage = try reader["approximateDollarUsage"].readIfPresent()
        return value
    }
}
...
extension DeadlineClientTypes.ServiceManagedEc2InstanceCapabilities {
    ...
    static func write(value: DeadlineClientTypes.ServiceManagedEc2InstanceCapabilities?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["allowedInstanceTypes"].writeList(value.allowedInstanceTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["excludedInstanceTypes"].writeList(value.excludedInstanceTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.ServiceManagedEc2InstanceCapabilities {
        ...
        value.osFamily = try reader["osFamily"].readIfPresent()
        value.cpuArchitectureType = try reader["cpuArchitectureType"].readIfPresent()
        value.rootEbsVolume = try reader["rootEbsVolume"].readIfPresent(with: DeadlineClientTypes.Ec2EbsVolume.read(from:))
        value.allowedInstanceTypes = try reader["allowedInstanceTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.excludedInstanceTypes = try reader["excludedInstanceTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DeadlineClientTypes.CustomerManagedWorkerCapabilities {
    ...
    static func write(value: DeadlineClientTypes.CustomerManagedWorkerCapabilities?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["acceleratorTypes"].writeList(value.acceleratorTypes, memberWritingClosure: DeadlineClientTypes.AcceleratorType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["cpuArchitectureType"].write(value.cpuArchitectureType)
        try writer["customAmounts"].writeList(value.customAmounts, memberWritingClosure: DeadlineClientTypes.FleetAmountCapability.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["customAttributes"].writeList(value.customAttributes, memberWritingClosure: DeadlineClientTypes.FleetAttributeCapability.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["memoryMiB"].write(value.memoryMiB, with: DeadlineClientTypes.MemoryMiBRange.write(value:to:))
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.CustomerManagedWorkerCapabilities {
        ...
        value.vCpuCount = try reader["vCpuCount"].readIfPresent(with: DeadlineClientTypes.VCpuCountRange.read(from:))
        value.memoryMiB = try reader["memoryMiB"].readIfPresent(with: DeadlineClientTypes.MemoryMiBRange.read(from:))
        value.acceleratorTypes = try reader["acceleratorTypes"].readListIfPresent(memberReadingClosure: DeadlineClientTypes.AcceleratorType.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DeadlineClientTypes.IpAddresses {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.IpAddresses {
        ...
        value.ipV4Addresses = try reader["ipV4Addresses"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.ipV6Addresses = try reader["ipV6Addresses"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DeadlineClientTypes.Statistics {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.Statistics {
        ...
        value.aggregationStartTime = try reader["aggregationStartTime"].readTimestampIfPresent(format: .dateTime)
        value.aggregationEndTime = try reader["aggregationEndTime"].readTimestampIfPresent(format: .dateTime)
        return value
    }
}
...
extension DeadlineClientTypes.DependencyCounts {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.DependencyCounts {
        ...
        value.dependenciesResolved = try reader["dependenciesResolved"].readIfPresent()
        value.dependenciesUnresolved = try reader["dependenciesUnresolved"].readIfPresent()
        value.consumersResolved = try reader["consumersResolved"].readIfPresent()
        value.consumersUnresolved = try reader["consumersUnresolved"].readIfPresent()
        return value
    }
}
...
extension DeadlineClientTypes.StepAttributeCapability {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.StepAttributeCapability {
        ...
        value.name = try reader["name"].readIfPresent()
        value.anyOf = try reader["anyOf"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.allOf = try reader["allOf"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DeadlineClientTypes.FarmMember {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> DeadlineClientTypes.FarmMember {
        ...
        value.membershipLevel = try reader["membershipLevel"].readIfPresent()
        return value
    }
}
    ...
    static func write(value: DeadlineClientTypes.SessionsStatisticsResources?, to writer: SmithyJSON.Writer) throws {
        ...
        switch value {
            case let .fleetids(fleetids):
                try writer["fleetIds"].writeList(fleetids, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .queueids(queueids):
                try writer["queueIds"].writeList(queueids, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .sdkUnknown(sdkUnknown):
                try writer["sdkUnknown"].write(sdkUnknown)
        }
    }
