    ...
    public class QLDBSessionClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        ...
        public convenience init(
            ...
            self.init(
                ...
                authSchemeResolver ?? DefaultQLDBSessionAuthSchemeResolver(authSchemePreference: authSchemePreference ?? []),
        ...
        public convenience init(region: Swift.String) throws {
            self.init(
                ...
                nil,
                DefaultQLDBSessionAuthSchemeResolver(authSchemePreference: []),
...
extension QLDBSessionClient {
    ...
    public func sendCommand(input: SendCommandInput) async throws -> SendCommandOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("QLDB Session", config.ignoreConfiguredEndpointURLs)
