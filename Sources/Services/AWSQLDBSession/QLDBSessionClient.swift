...
extension QLDBSessionClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> QLDBSessionClient.QLDBSessionClientConfiguration {
        let clientConfiguration = try await QLDBSessionClient.QLDBSessionClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> QLDBSessionClient {
            let configuration = try await resolve(plugins: self.plugins)
            return QLDBSessionClient(config: configuration)
        }
    }
...
extension QLDBSessionClient.QLDBSessionClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
