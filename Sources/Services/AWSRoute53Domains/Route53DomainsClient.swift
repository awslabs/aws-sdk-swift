...
extension Route53DomainsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> Route53DomainsClient.Route53DomainsClientConfiguration {
        let clientConfiguration = try await Route53DomainsClient.Route53DomainsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> Route53DomainsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return Route53DomainsClient(config: configuration)
        }
    }
...
extension Route53DomainsClient.Route53DomainsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
