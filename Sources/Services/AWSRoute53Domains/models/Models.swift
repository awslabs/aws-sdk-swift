...
extension DeleteTagsForDomainInput {
    ...
    static func write(value: DeleteTagsForDomainInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DomainName"].write(value.domainName)
        try writer["TagsToDelete"].writeList(value.tagsToDelete, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetDomainDetailOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetDomainDetailOutput {
        ...
        value.statusList = try reader["StatusList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ListOperationsInput {
    ...
    static func write(value: ListOperationsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Status"].writeList(value.status, memberWritingClosure: Route53DomainsClientTypes.OperationStatus.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SubmittedSince"].writeTimestamp(value.submittedSince, format: .epochSeconds)
        try writer["Type"].writeList(value.type, memberWritingClosure: Route53DomainsClientTypes.OperationType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension Route53DomainsClientTypes.Nameserver {
    ...
    static func write(value: Route53DomainsClientTypes.Nameserver?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["GlueIps"].writeList(value.glueIps, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Name"].write(value.name)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> Route53DomainsClientTypes.Nameserver {
        ...
        value.name = try reader["Name"].readIfPresent()
        value.glueIps = try reader["GlueIps"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
