...
extension DescribeCasesInput {
    ...
    static func write(value: DescribeCasesInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["caseIdList"].writeList(value.caseIdList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeServicesInput {
    ...
    static func write(value: DescribeServicesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["language"].write(value.language)
        try writer["serviceCodeList"].writeList(value.serviceCodeList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension DescribeTrustedAdvisorCheckRefreshStatusesInput {
    ...
    static func write(value: DescribeTrustedAdvisorCheckRefreshStatusesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["checkIds"].writeList(value.checkIds, memberWritingClosure: sparseFormOf(writingClosure: Swift.String.write(value:to:)), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension SupportClientTypes.CaseDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SupportClientTypes.CaseDetails {
        ...
        value.ccEmailAddresses = try reader["ccEmailAddresses"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension SupportClientTypes.TrustedAdvisorResourceDetail {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SupportClientTypes.TrustedAdvisorResourceDetail {
        ...
        value.metadata = try reader["metadata"].readListIfPresent(memberReadingClosure: optionalFormOf(readingClosure: Swift.String.read(from:)), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
