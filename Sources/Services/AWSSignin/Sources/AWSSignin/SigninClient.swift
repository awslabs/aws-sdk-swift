...
public final class SigninClient: AWSClientRuntime.AWSServiceClient, Sendable {
...
extension SigninClient {
    ...
    public final class SigninClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, @unchecked Sendable {
        ...
        private init(
            ...
            self.logger = telemetryProvider.loggerProvider.getLogger(name: SigninClient.clientName)
        }
        ...
        public convenience init(region: Swift.String) throws {
            self.init(
                ...
                nil,
                DefaultSigninAuthSchemeResolver(),
