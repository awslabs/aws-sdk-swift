...
extension WAFClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> WAFClient.WAFClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> WAFClient {
            let configuration = try await resolve(plugins: self.plugins)
            return WAFClient(config: configuration)
        }
    }
...
extension WAFClient.WAFClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
