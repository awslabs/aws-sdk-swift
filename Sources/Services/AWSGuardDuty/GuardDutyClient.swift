...
extension GuardDutyClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> GuardDutyClient.GuardDutyClientConfiguration {
        let clientConfiguration = try await GuardDutyClient.GuardDutyClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> GuardDutyClient {
            let configuration = try await resolve(plugins: self.plugins)
            return GuardDutyClient(config: configuration)
        }
    }
...
extension GuardDutyClient.GuardDutyClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
