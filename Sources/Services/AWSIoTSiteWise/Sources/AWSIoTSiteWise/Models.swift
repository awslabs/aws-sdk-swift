...
extension DescribeAccessPolicyOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> DescribeAccessPolicyOutput {
        ...
        value.accessPolicyArn = try reader["accessPolicyArn"].readIfPresent()
        value.accessPolicyCreationDate = try reader["accessPolicyCreationDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        value.accessPolicyId = try reader["accessPolicyId"].readIfPresent()
        value.accessPolicyIdentity = try reader["accessPolicyIdentity"].readIfPresent(with: IoTSiteWiseClientTypes.Identity.read(from:))
        value.accessPolicyLastUpdateDate = try reader["accessPolicyLastUpdateDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
...
extension DescribeAssetOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> DescribeAssetOutput {
        ...
        value.assetCreationDate = try reader["assetCreationDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        ...
        value.assetId = try reader["assetId"].readIfPresent()
        value.assetLastUpdateDate = try reader["assetLastUpdateDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        value.assetModelId = try reader["assetModelId"].readIfPresent()
...
extension DescribeAssetModelOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> DescribeAssetModelOutput {
        ...
        value.assetModelCreationDate = try reader["assetModelCreationDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        ...
        value.assetModelId = try reader["assetModelId"].readIfPresent()
        value.assetModelLastUpdateDate = try reader["assetModelLastUpdateDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
...
extension DescribeBulkImportJobOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> DescribeBulkImportJobOutput {
        ...
        value.jobCreationDate = try reader["jobCreationDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        value.jobId = try reader["jobId"].readIfPresent()
        value.jobLastUpdateDate = try reader["jobLastUpdateDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        value.jobName = try reader["jobName"].readIfPresent()
...
extension DescribeDashboardOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> DescribeDashboardOutput {
        ...
        value.dashboardArn = try reader["dashboardArn"].readIfPresent()
        value.dashboardCreationDate = try reader["dashboardCreationDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        ...
        value.dashboardId = try reader["dashboardId"].readIfPresent()
        value.dashboardLastUpdateDate = try reader["dashboardLastUpdateDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
...
extension DescribePortalOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> DescribePortalOutput {
        ...
        value.portalCreationDate = try reader["portalCreationDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        value.portalDescription = try reader["portalDescription"].readIfPresent()
        value.portalId = try reader["portalId"].readIfPresent()
        value.portalLastUpdateDate = try reader["portalLastUpdateDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
...
extension DescribeProjectOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> DescribeProjectOutput {
        ...
        value.portalId = try reader["portalId"].readIfPresent()
        value.projectArn = try reader["projectArn"].readIfPresent()
        value.projectCreationDate = try reader["projectCreationDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        value.projectDescription = try reader["projectDescription"].readIfPresent()
        value.projectId = try reader["projectId"].readIfPresent()
        value.projectLastUpdateDate = try reader["projectLastUpdateDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
...
extension DescribeTimeSeriesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HTTPResponse) async throws -> DescribeTimeSeriesOutput {
        ...
        value.timeSeriesCreationDate = try reader["timeSeriesCreationDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        value.timeSeriesId = try reader["timeSeriesId"].readIfPresent()
        value.timeSeriesLastUpdateDate = try reader["timeSeriesLastUpdateDate"].readTimestampIfPresent(format: SmithyTimestamps.TimestampFormat.epochSeconds)
        return value
    }
}
