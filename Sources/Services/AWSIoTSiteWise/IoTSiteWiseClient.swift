...
public class IoTSiteWiseClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await IoTSiteWiseClientConfiguration(region: region)
    ...
    public class IoTSiteWiseClientConfiguration: IoTSiteWiseClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("IoTSiteWiseClient")
