...
extension DeleteDashboardsInput {
    ...
    static func write(value: DeleteDashboardsInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["DashboardNames"].writeList(value.dashboardNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeAlarmHistoryInput {
    ...
    static func write(value: DescribeAlarmHistoryInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["AlarmTypes"].writeList(value.alarmTypes, memberWritingClosure: CloudWatchClientTypes.AlarmType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeAnomalyDetectorsInput {
    ...
    static func write(value: DescribeAnomalyDetectorsInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AnomalyDetectorTypes"].writeList(value.anomalyDetectorTypes, memberWritingClosure: CloudWatchClientTypes.AnomalyDetectorType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Dimensions"].writeList(value.dimensions, memberWritingClosure: CloudWatchClientTypes.Dimension.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GetMetricStatisticsInput {
    ...
    static func write(value: GetMetricStatisticsInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Dimensions"].writeList(value.dimensions, memberWritingClosure: CloudWatchClientTypes.Dimension.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["EndTime"].writeTimestamp(value.endTime, format: .dateTime)
        try writer["ExtendedStatistics"].writeList(value.extendedStatistics, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["MetricName"].write(value.metricName)
        try writer["Namespace"].write(value.namespace)
        try writer["Period"].write(value.period)
        try writer["StartTime"].writeTimestamp(value.startTime, format: .dateTime)
        try writer["Statistics"].writeList(value.statistics, memberWritingClosure: CloudWatchClientTypes.Statistic.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Unit"].write(value.unit)
...
extension PutCompositeAlarmInput {
    ...
    static func write(value: PutCompositeAlarmInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["AlarmActions"].writeList(value.alarmActions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["AlarmDescription"].write(value.alarmDescription)
        try writer["AlarmName"].write(value.alarmName)
        try writer["AlarmRule"].write(value.alarmRule)
        try writer["InsufficientDataActions"].writeList(value.insufficientDataActions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["OKActions"].writeList(value.okActions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension GetInsightRuleReportOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetInsightRuleReportOutput {
        ...
        value.keyLabels = try reader["KeyLabels"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ListMetricsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListMetricsOutput {
        ...
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.owningAccounts = try reader["OwningAccounts"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudWatchClientTypes.CompositeAlarm {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.CompositeAlarm {
        ...
        value.alarmActions = try reader["AlarmActions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.insufficientDataActions = try reader["InsufficientDataActions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.okActions = try reader["OKActions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CloudWatchClientTypes.Datapoint {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.Datapoint {
        ...
        value.maximum = try reader["Maximum"].readIfPresent()
        value.unit = try reader["Unit"].readIfPresent()
        value.extendedStatistics = try reader["ExtendedStatistics"].readMapIfPresent(valueReadingClosure: Swift.Double.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension CloudWatchClientTypes.MetricStreamStatisticsConfiguration {
    ...
    static func write(value: CloudWatchClientTypes.MetricStreamStatisticsConfiguration?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AdditionalStatistics"].writeList(value.additionalStatistics, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricStreamStatisticsConfiguration {
        ...
        value.additionalStatistics = try reader["AdditionalStatistics"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudWatchClientTypes.MetricDatum {
    ...
    static func write(value: CloudWatchClientTypes.MetricDatum?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["Counts"].writeList(value.counts, memberWritingClosure: Swift.Double.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Dimensions"].writeList(value.dimensions, memberWritingClosure: CloudWatchClientTypes.Dimension.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["MetricName"].write(value.metricName)
