...
extension CloudWatchClient {
    ...
    /// __Possible Exceptions:__
    /// - `InvalidNextToken` : The next token specified is invalid.
    public func getMetricData(input: GetMetricDataInput, testCase: String = "") async throws -> GetMetricDataOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<GetMetricDataInput, GetMetricDataOutput, SmithyFormURL.Writer>(rootNodeInfo: "", inputWritingClosure: GetMetricDataInput.write(value:to:), testCase))
    ...
    /// - `InternalServiceFault` : Request processing has failed due to some unknown error, exception, or failure.
    /// - `InvalidParameterValueException` : The value of an input parameter is bad or out-of-range.
    public func listMetrics(input: ListMetricsInput, testCase: String = "") async throws -> ListMetricsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<ListMetricsInput, ListMetricsOutput, SmithyFormURL.Writer>(rootNodeInfo: "", inputWritingClosure: ListMetricsInput.write(value:to:), testCase))
    ...
    /// - `InvalidParameterValueException` : The value of an input parameter is bad or out-of-range.
    /// - `MissingRequiredParameterException` : An input parameter that is required is missing.
    public func putMetricData(input: PutMetricDataInput, testCase: String = "") async throws -> PutMetricDataOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.serialize(ClientRuntime.BodyMiddleware<PutMetricDataInput, PutMetricDataOutput, SmithyFormURL.Writer>(rootNodeInfo: "", inputWritingClosure: PutMetricDataInput.write(value:to:), testCase))
