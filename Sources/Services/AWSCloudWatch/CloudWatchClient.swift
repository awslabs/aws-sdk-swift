...
extension CloudWatchClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CloudWatchClient.CloudWatchClientConfiguration {
        let clientConfiguration = try await CloudWatchClient.CloudWatchClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CloudWatchClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CloudWatchClient(config: configuration)
        }
    }
...
extension CloudWatchClient.CloudWatchClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
