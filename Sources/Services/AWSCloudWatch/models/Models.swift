...
extension CloudWatchClientTypes.AlarmHistoryItem: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.AlarmHistoryItem {
...
extension CloudWatchClientTypes.AnomalyDetector: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.AnomalyDetector {
        var value = CloudWatchClientTypes.AnomalyDetector()
        value.namespace = try reader["Namespace"].readIfPresent()
        value.metricName = try reader["MetricName"].readIfPresent()
        value.dimensions = try reader["Dimensions"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.Dimension.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.stat = try reader["Stat"].readIfPresent()
        value.configuration = try reader["Configuration"].readIfPresent(readingClosure: CloudWatchClientTypes.AnomalyDetectorConfiguration.readingClosure(from:))
        value.stateValue = try reader["StateValue"].readIfPresent()
        value.singleMetricAnomalyDetector = try reader["SingleMetricAnomalyDetector"].readIfPresent(readingClosure: CloudWatchClientTypes.SingleMetricAnomalyDetector.readingClosure(from:))
        value.metricMathAnomalyDetector = try reader["MetricMathAnomalyDetector"].readIfPresent(readingClosure: CloudWatchClientTypes.MetricMathAnomalyDetector.readingClosure(from:))
        return value
    }
}
...
extension CloudWatchClientTypes.AnomalyDetectorConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.AnomalyDetectorConfiguration {
        var value = CloudWatchClientTypes.AnomalyDetectorConfiguration()
        value.excludedTimeRanges = try reader["ExcludedTimeRanges"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.Range.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CloudWatchClientTypes.CompositeAlarm: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.CompositeAlarm {
        var value = CloudWatchClientTypes.CompositeAlarm()
        value.actionsEnabled = try reader["ActionsEnabled"].readIfPresent()
        value.alarmActions = try reader["AlarmActions"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.insufficientDataActions = try reader["InsufficientDataActions"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.okActions = try reader["OKActions"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CloudWatchClientTypes.DashboardEntry: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.DashboardEntry {
...
extension CloudWatchClientTypes.DashboardValidationMessage: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.DashboardValidationMessage {
...
extension CloudWatchClientTypes.Datapoint: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.Datapoint {
        ...
        value.extendedStatistics = try reader["ExtendedStatistics"].readMapIfPresent(valueReadingClosure: Swift.Double.readingClosure(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension DeleteAlarmsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteAlarmsOutput {
        let reader = responseReader["DeleteAlarmsResult"]
        var value = DeleteAlarmsOutput()
        return value
    }
}
...
extension DeleteAnomalyDetectorOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteAnomalyDetectorOutput {
        let reader = responseReader["DeleteAnomalyDetectorResult"]
        var value = DeleteAnomalyDetectorOutput()
        return value
    }
}
...
extension DeleteDashboardsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteDashboardsOutput {
        let reader = responseReader["DeleteDashboardsResult"]
        var value = DeleteDashboardsOutput()
        return value
    }
}
...
extension DeleteInsightRulesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteInsightRulesOutput {
        let reader = responseReader["DeleteInsightRulesResult"]
        var value = DeleteInsightRulesOutput()
        value.failures = try reader["Failures"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.PartialFailure.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DeleteMetricStreamOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteMetricStreamOutput {
        let reader = responseReader["DeleteMetricStreamResult"]
        var value = DeleteMetricStreamOutput()
        return value
    }
}
...
extension DescribeAlarmHistoryOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAlarmHistoryOutput {
        let reader = responseReader["DescribeAlarmHistoryResult"]
        var value = DescribeAlarmHistoryOutput()
        value.alarmHistoryItems = try reader["AlarmHistoryItems"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.AlarmHistoryItem.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeAlarmsForMetricOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAlarmsForMetricOutput {
        let reader = responseReader["DescribeAlarmsForMetricResult"]
        var value = DescribeAlarmsForMetricOutput()
        value.metricAlarms = try reader["MetricAlarms"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MetricAlarm.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeAlarmsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAlarmsOutput {
        let reader = responseReader["DescribeAlarmsResult"]
        var value = DescribeAlarmsOutput()
        value.compositeAlarms = try reader["CompositeAlarms"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.CompositeAlarm.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.metricAlarms = try reader["MetricAlarms"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MetricAlarm.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
...
extension DescribeAnomalyDetectorsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAnomalyDetectorsOutput {
        let reader = responseReader["DescribeAnomalyDetectorsResult"]
        var value = DescribeAnomalyDetectorsOutput()
        value.anomalyDetectors = try reader["AnomalyDetectors"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.AnomalyDetector.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension DescribeInsightRulesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeInsightRulesOutput {
        let reader = responseReader["DescribeInsightRulesResult"]
        var value = DescribeInsightRulesOutput()
        value.insightRules = try reader["InsightRules"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.InsightRule.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension CloudWatchClientTypes.Dimension: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.Dimension {
...
extension CloudWatchClientTypes.DimensionFilter: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.DimensionFilter {
...
extension DisableAlarmActionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DisableAlarmActionsOutput {
        let reader = responseReader["DisableAlarmActionsResult"]
        var value = DisableAlarmActionsOutput()
        return value
    }
}
...
extension DisableInsightRulesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DisableInsightRulesOutput {
...
extension EnableAlarmActionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> EnableAlarmActionsOutput {
        let reader = responseReader["EnableAlarmActionsResult"]
        var value = EnableAlarmActionsOutput()
        return value
    }
}
...
extension EnableInsightRulesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> EnableInsightRulesOutput {
...
extension GetDashboardOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetDashboardOutput {
...
extension GetInsightRuleReportOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetInsightRuleReportOutput {
        ...
        value.contributors = try reader["Contributors"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.InsightRuleContributor.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.keyLabels = try reader["KeyLabels"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.metricDatapoints = try reader["MetricDatapoints"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.InsightRuleMetricDatapoint.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetMetricDataOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetMetricDataOutput {
        let reader = responseReader["GetMetricDataResult"]
        var value = GetMetricDataOutput()
        value.messages = try reader["Messages"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MessageData.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.metricDataResults = try reader["MetricDataResults"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MetricDataResult.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension GetMetricStatisticsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetMetricStatisticsOutput {
        let reader = responseReader["GetMetricStatisticsResult"]
        var value = GetMetricStatisticsOutput()
        value.datapoints = try reader["Datapoints"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.Datapoint.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension GetMetricStreamOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetMetricStreamOutput {
        ...
        value.excludeFilters = try reader["ExcludeFilters"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MetricStreamFilter.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.firehoseArn = try reader["FirehoseArn"].readIfPresent()
        value.includeFilters = try reader["IncludeFilters"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MetricStreamFilter.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.statisticsConfigurations = try reader["StatisticsConfigurations"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MetricStreamStatisticsConfiguration.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension GetMetricWidgetImageOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetMetricWidgetImageOutput {
...
extension CloudWatchClientTypes.InsightRule: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.InsightRule {
...
extension CloudWatchClientTypes.InsightRuleContributor: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.InsightRuleContributor {
        var value = CloudWatchClientTypes.InsightRuleContributor()
        value.keys = try reader["Keys"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.approximateAggregateValue = try reader["ApproximateAggregateValue"].readIfPresent()
        value.datapoints = try reader["Datapoints"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.InsightRuleContributorDatapoint.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudWatchClientTypes.InsightRuleContributorDatapoint: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.InsightRuleContributorDatapoint {
...
extension CloudWatchClientTypes.InsightRuleMetricDatapoint: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.InsightRuleMetricDatapoint {
...
extension CloudWatchClientTypes.LabelOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.LabelOptions {
...
extension ListDashboardsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListDashboardsOutput {
        let reader = responseReader["ListDashboardsResult"]
        var value = ListDashboardsOutput()
        value.dashboardEntries = try reader["DashboardEntries"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.DashboardEntry.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension ListManagedInsightRulesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListManagedInsightRulesOutput {
        let reader = responseReader["ListManagedInsightRulesResult"]
        var value = ListManagedInsightRulesOutput()
        value.managedRules = try reader["ManagedRules"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.ManagedRuleDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension ListMetricStreamsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListMetricStreamsOutput {
        let reader = responseReader["ListMetricStreamsResult"]
        var value = ListMetricStreamsOutput()
        value.entries = try reader["Entries"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MetricStreamEntry.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension ListMetricsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListMetricsOutput {
        let reader = responseReader["ListMetricsResult"]
        var value = ListMetricsOutput()
        value.metrics = try reader["Metrics"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.Metric.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.owningAccounts = try reader["OwningAccounts"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListTagsForResourceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListTagsForResourceOutput {
        ...
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.Tag.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudWatchClientTypes.ManagedRule: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.ManagedRule {
...
extension CloudWatchClientTypes.ManagedRuleDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.ManagedRuleDescription {
        var value = CloudWatchClientTypes.ManagedRuleDescription()
        value.templateName = try reader["TemplateName"].readIfPresent()
        value.resourceARN = try reader["ResourceARN"].readIfPresent()
        value.ruleState = try reader["RuleState"].readIfPresent(readingClosure: CloudWatchClientTypes.ManagedRuleState.readingClosure(from:))
        return value
    }
}
...
extension CloudWatchClientTypes.ManagedRuleState: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.ManagedRuleState {
...
extension CloudWatchClientTypes.MessageData: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MessageData {
...
extension CloudWatchClientTypes.Metric: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.Metric {
...
extension CloudWatchClientTypes.MetricAlarm: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricAlarm {
        ...
        value.metrics = try reader["Metrics"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MetricDataQuery.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CloudWatchClientTypes.MetricDataQuery: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricDataQuery {
        var value = CloudWatchClientTypes.MetricDataQuery()
        value.id = try reader["Id"].readIfPresent()
        value.metricStat = try reader["MetricStat"].readIfPresent(readingClosure: CloudWatchClientTypes.MetricStat.readingClosure(from:))
...
extension CloudWatchClientTypes.MetricDataResult: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricDataResult {
...
extension CloudWatchClientTypes.MetricDatum: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricDatum {
        var value = CloudWatchClientTypes.MetricDatum()
        value.metricName = try reader["MetricName"].readIfPresent()
        value.dimensions = try reader["Dimensions"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.Dimension.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.timestamp = try reader["Timestamp"].readTimestampIfPresent(format: .dateTime)
        value.value = try reader["Value"].readIfPresent()
        value.statisticValues = try reader["StatisticValues"].readIfPresent(readingClosure: CloudWatchClientTypes.StatisticSet.readingClosure(from:))
        value.values = try reader["Values"].readListIfPresent(memberReadingClosure: Swift.Double.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.counts = try reader["Counts"].readListIfPresent(memberReadingClosure: Swift.Double.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.unit = try reader["Unit"].readIfPresent()
...
extension CloudWatchClientTypes.MetricMathAnomalyDetector: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricMathAnomalyDetector {
        var value = CloudWatchClientTypes.MetricMathAnomalyDetector()
        value.metricDataQueries = try reader["MetricDataQueries"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MetricDataQuery.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudWatchClientTypes.MetricStat: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricStat {
        var value = CloudWatchClientTypes.MetricStat()
        value.metric = try reader["Metric"].readIfPresent(readingClosure: CloudWatchClientTypes.Metric.readingClosure(from:))
        value.period = try reader["Period"].readIfPresent()
        value.stat = try reader["Stat"].readIfPresent()
        value.unit = try reader["Unit"].readIfPresent()
        return value
...
extension CloudWatchClientTypes.MetricStreamEntry: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricStreamEntry {
...
extension CloudWatchClientTypes.MetricStreamFilter: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricStreamFilter {
        var value = CloudWatchClientTypes.MetricStreamFilter()
        value.namespace = try reader["Namespace"].readIfPresent()
        value.metricNames = try reader["MetricNames"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudWatchClientTypes.MetricStreamStatisticsConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricStreamStatisticsConfiguration {
        var value = CloudWatchClientTypes.MetricStreamStatisticsConfiguration()
        value.includeMetrics = try reader["IncludeMetrics"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.MetricStreamStatisticsMetric.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.additionalStatistics = try reader["AdditionalStatistics"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CloudWatchClientTypes.MetricStreamStatisticsMetric: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.MetricStreamStatisticsMetric {
...
extension CloudWatchClientTypes.PartialFailure: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.PartialFailure {
...
extension PutAnomalyDetectorOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutAnomalyDetectorOutput {
        let reader = responseReader["PutAnomalyDetectorResult"]
        var value = PutAnomalyDetectorOutput()
        return value
    }
}
...
extension PutCompositeAlarmOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutCompositeAlarmOutput {
        let reader = responseReader["PutCompositeAlarmResult"]
        var value = PutCompositeAlarmOutput()
        return value
    }
}
...
extension PutDashboardOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutDashboardOutput {
        let reader = responseReader["PutDashboardResult"]
        var value = PutDashboardOutput()
        value.dashboardValidationMessages = try reader["DashboardValidationMessages"].readListIfPresent(memberReadingClosure: CloudWatchClientTypes.DashboardValidationMessage.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension PutInsightRuleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutInsightRuleOutput {
        let reader = responseReader["PutInsightRuleResult"]
        var value = PutInsightRuleOutput()
        return value
    }
}
...
extension PutManagedInsightRulesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutManagedInsightRulesOutput {
...
extension PutMetricAlarmOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutMetricAlarmOutput {
        let reader = responseReader["PutMetricAlarmResult"]
        var value = PutMetricAlarmOutput()
        return value
    }
}
...
extension PutMetricDataOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutMetricDataOutput {
        let reader = responseReader["PutMetricDataResult"]
        var value = PutMetricDataOutput()
        return value
    }
}
...
extension PutMetricStreamOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutMetricStreamOutput {
...
extension CloudWatchClientTypes.Range: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.Range {
...
extension SetAlarmStateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetAlarmStateOutput {
        let reader = responseReader["SetAlarmStateResult"]
        var value = SetAlarmStateOutput()
        return value
    }
}
...
extension CloudWatchClientTypes.SingleMetricAnomalyDetector: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.SingleMetricAnomalyDetector {
...
extension StartMetricStreamsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> StartMetricStreamsOutput {
        let reader = responseReader["StartMetricStreamsResult"]
        var value = StartMetricStreamsOutput()
        return value
    }
}
...
extension CloudWatchClientTypes.StatisticSet: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.StatisticSet {
...
extension StopMetricStreamsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> StopMetricStreamsOutput {
        let reader = responseReader["StopMetricStreamsResult"]
        var value = StopMetricStreamsOutput()
        return value
    }
}
...
extension CloudWatchClientTypes.Tag: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> CloudWatchClientTypes.Tag {
...
extension TagResourceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TagResourceOutput {
        let reader = responseReader["TagResourceResult"]
...
extension UntagResourceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UntagResourceOutput {
        let reader = responseReader["UntagResourceResult"]
