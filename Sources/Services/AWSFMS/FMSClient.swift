...
extension FMSClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> FMSClient.FMSClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> FMSClient {
            let configuration = try await resolve(plugins: self.plugins)
            return FMSClient(config: configuration)
        }
    }
...
extension FMSClient.FMSClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
