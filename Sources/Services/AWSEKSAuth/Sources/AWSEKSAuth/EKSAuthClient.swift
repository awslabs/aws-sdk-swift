...
public final class EKSAuthClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "EKSAuthClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: EKSAuthClient.EKSAuthClientConfig
    let serviceName = "EKS Auth"

    @available(*, deprecated, message: "Use EKSAuthClient.EKSAuthClientConfig instead")
    public typealias Config = EKSAuthClient.EKSAuthClientConfiguration
    public typealias Configuration = EKSAuthClient.EKSAuthClientConfig

    public required init(config: EKSAuthClient.EKSAuthClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: EKSAuthClient.EKSAuthClientConfig) instead")
    public convenience init(config: EKSAuthClient.EKSAuthClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try EKSAuthClient.EKSAuthClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await EKSAuthClient.EKSAuthClientConfig()
        self.init(config: config)
    }
}
...
extension EKSAuthClient {
    ...
    /// Client configuration for EKSAuthClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct EKSAuthClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "EKS Auth")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: EKSAuthClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultEKSAuthAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use EKSAuthClientConfig instead. This class will be removed in a future version.")
    public final class EKSAuthClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> EKSAuthClientConfig {
            return try EKSAuthClientConfig(
...
extension EKSAuthClient {
    ...
    public func assumeRoleForPodIdentity(input: AssumeRoleForPodIdentityInput) async throws -> AssumeRoleForPodIdentityOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("EKS Auth", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<AssumeRoleForPodIdentityOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "EKS Auth"))
