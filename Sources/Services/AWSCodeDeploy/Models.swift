...
extension AddTagsToOnPremisesInstancesInput {
    ...
    static func write(value: AddTagsToOnPremisesInstancesInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["instanceNames"].writeList(value.instanceNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension BatchGetDeploymentGroupsInput {
    ...
    static func write(value: BatchGetDeploymentGroupsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["applicationName"].write(value.applicationName)
        try writer["deploymentGroupNames"].writeList(value.deploymentGroupNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension BatchGetDeploymentTargetsInput {
    ...
    static func write(value: BatchGetDeploymentTargetsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["deploymentId"].write(value.deploymentId)
        try writer["targetIds"].writeList(value.targetIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ListDeploymentInstancesInput {
    ...
    static func write(value: ListDeploymentInstancesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["deploymentId"].write(value.deploymentId)
        try writer["instanceStatusFilter"].writeList(value.instanceStatusFilter, memberWritingClosure: CodeDeployClientTypes.InstanceStatus.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["instanceTypeFilter"].writeList(value.instanceTypeFilter, memberWritingClosure: CodeDeployClientTypes.InstanceType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["nextToken"].write(value.nextToken)
    }
}
...
extension ListDeploymentsInput {
    ...
    static func write(value: ListDeploymentsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["deploymentGroupName"].write(value.deploymentGroupName)
        try writer["externalId"].write(value.externalId)
        try writer["includeOnlyStatuses"].writeList(value.includeOnlyStatuses, memberWritingClosure: CodeDeployClientTypes.DeploymentStatus.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["nextToken"].write(value.nextToken)
    }
}
...
extension ListDeploymentTargetsInput {
    ...
    static func write(value: ListDeploymentTargetsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["deploymentId"].write(value.deploymentId)
        try writer["nextToken"].write(value.nextToken)
        try writer["targetFilters"].writeMap(value.targetFilters, valueWritingClosure: listWritingClosure(memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension ListApplicationsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListApplicationsOutput {
        ...
        value.applications = try reader["applications"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListDeploymentConfigsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListDeploymentConfigsOutput {
        ...
        value.deploymentConfigsList = try reader["deploymentConfigsList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListDeploymentGroupsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListDeploymentGroupsOutput {
        ...
        value.applicationName = try reader["applicationName"].readIfPresent()
        value.deploymentGroups = try reader["deploymentGroups"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListDeploymentInstancesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListDeploymentInstancesOutput {
        ...
        value.instancesList = try reader["instancesList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListDeploymentsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListDeploymentsOutput {
        ...
        value.deployments = try reader["deployments"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension ListDeploymentTargetsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListDeploymentTargetsOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.targetIds = try reader["targetIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListGitHubAccountTokenNamesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListGitHubAccountTokenNamesOutput {
        ...
        value.nextToken = try reader["nextToken"].readIfPresent()
        value.tokenNameList = try reader["tokenNameList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListOnPremisesInstancesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListOnPremisesInstancesOutput {
        ...
        value.instanceNames = try reader["instanceNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["nextToken"].readIfPresent()
        return value
    }
}
...
extension CodeDeployClientTypes.OnPremisesTagSet {
    ...
    static func write(value: CodeDeployClientTypes.OnPremisesTagSet?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["onPremisesTagSetList"].writeList(value.onPremisesTagSetList, memberWritingClosure: listWritingClosure(memberWritingClosure: CodeDeployClientTypes.TagFilter.write(value:to:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeDeployClientTypes.OnPremisesTagSet {
        ...
        value.onPremisesTagSetList = try reader["onPremisesTagSetList"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: CodeDeployClientTypes.TagFilter.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodeDeployClientTypes.EC2TagSet {
    ...
    static func write(value: CodeDeployClientTypes.EC2TagSet?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ec2TagSetList"].writeList(value.ec2TagSetList, memberWritingClosure: listWritingClosure(memberWritingClosure: CodeDeployClientTypes.EC2TagFilter.write(value:to:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeDeployClientTypes.EC2TagSet {
        ...
        value.ec2TagSetList = try reader["ec2TagSetList"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: CodeDeployClientTypes.EC2TagFilter.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodeDeployClientTypes.TrafficRoute {
    ...
    static func write(value: CodeDeployClientTypes.TrafficRoute?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["listenerArns"].writeList(value.listenerArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeDeployClientTypes.TrafficRoute {
        ...
        value.listenerArns = try reader["listenerArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodeDeployClientTypes.AutoRollbackConfiguration {
    ...
    static func write(value: CodeDeployClientTypes.AutoRollbackConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["events"].writeList(value.events, memberWritingClosure: CodeDeployClientTypes.AutoRollbackEvent.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeDeployClientTypes.AutoRollbackConfiguration {
        ...
        value.events = try reader["events"].readListIfPresent(memberReadingClosure: CodeDeployClientTypes.AutoRollbackEvent.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodeDeployClientTypes.TriggerConfig {
    ...
    static func write(value: CodeDeployClientTypes.TriggerConfig?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["triggerEvents"].writeList(value.triggerEvents, memberWritingClosure: CodeDeployClientTypes.TriggerEventType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeDeployClientTypes.TriggerConfig {
        ...
        value.triggerEvents = try reader["triggerEvents"].readListIfPresent(memberReadingClosure: CodeDeployClientTypes.TriggerEventType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CodeDeployClientTypes.DeploymentInfo {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeDeployClientTypes.DeploymentInfo {
        ...
        value.deploymentStatusMessages = try reader["deploymentStatusMessages"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.computePlatform = try reader["computePlatform"].readIfPresent()
...
extension CodeDeployClientTypes.RelatedDeployments {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeDeployClientTypes.RelatedDeployments {
        ...
        value.autoUpdateOutdatedInstancesDeploymentIds = try reader["autoUpdateOutdatedInstancesDeploymentIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
