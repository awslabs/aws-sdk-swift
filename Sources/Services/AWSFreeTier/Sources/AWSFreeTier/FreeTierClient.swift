...
public final class FreeTierClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: FreeTierClient.FreeTierClientConfig) instead")
    public convenience init(config: FreeTierClient.FreeTierClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try FreeTierClient.FreeTierClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await FreeTierClient.FreeTierClientConfig()
        self.init(config: config)
    }
}
...
extension FreeTierClient {
    ...
    /// Client configuration for FreeTierClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct FreeTierClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "FreeTier")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: FreeTierClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use FreeTierClientConfig instead. This class will be removed in a future version.")
    public final class FreeTierClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> FreeTierClientConfig {
            return try FreeTierClientConfig(
...
extension FreeTierClient {
    ...
    public func getAccountActivity(input: GetAccountActivityInput) async throws -> GetAccountActivityOutput {
        ...
        let operation = FreeTierClient.getAccountActivityOperation
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "FreeTier"))
    ...
    public func getAccountPlanState(input: GetAccountPlanStateInput) async throws -> GetAccountPlanStateOutput {
        ...
        let operation = FreeTierClient.getAccountPlanStateOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func getFreeTierUsage(input: GetFreeTierUsageInput) async throws -> GetFreeTierUsageOutput {
        ...
        let operation = FreeTierClient.getFreeTierUsageOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func listAccountActivities(input: ListAccountActivitiesInput) async throws -> ListAccountActivitiesOutput {
        ...
        let operation = FreeTierClient.listAccountActivitiesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
    ...
    public func upgradeAccountPlan(input: UpgradeAccountPlanInput) async throws -> UpgradeAccountPlanOutput {
        ...
        let operation = FreeTierClient.upgradeAccountPlanOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
