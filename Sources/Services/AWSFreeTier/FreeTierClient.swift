...
extension FreeTierClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> FreeTierClient.FreeTierClientConfiguration {
        let clientConfiguration = try await FreeTierClient.FreeTierClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> FreeTierClient {
            let configuration = try await resolve(plugins: self.plugins)
            return FreeTierClient(config: configuration)
        }
    }
...
extension FreeTierClient.FreeTierClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
