...
extension MarketplaceCatalogClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MarketplaceCatalogClient.MarketplaceCatalogClientConfiguration {
        let clientConfiguration = try await MarketplaceCatalogClient.MarketplaceCatalogClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MarketplaceCatalogClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MarketplaceCatalogClient(config: configuration)
        }
    }
...
extension MarketplaceCatalogClient.MarketplaceCatalogClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
