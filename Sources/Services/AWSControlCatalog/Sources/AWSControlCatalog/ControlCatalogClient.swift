...
public final class ControlCatalogClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "ControlCatalogClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: ControlCatalogClient.ControlCatalogClientConfig
    let serviceName = "ControlCatalog"

    @available(*, deprecated, message: "Use ControlCatalogClient.ControlCatalogClientConfig instead")
    public typealias Config = ControlCatalogClient.ControlCatalogClientConfiguration
    public typealias Configuration = ControlCatalogClient.ControlCatalogClientConfig

    public required init(config: ControlCatalogClient.ControlCatalogClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: ControlCatalogClient.ControlCatalogClientConfig) instead")
    public convenience init(config: ControlCatalogClient.ControlCatalogClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ControlCatalogClient.ControlCatalogClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ControlCatalogClient.ControlCatalogClientConfig()
        self.init(config: config)
    }
}
...
extension ControlCatalogClient {
    ...
    /// Client configuration for ControlCatalogClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ControlCatalogClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "ControlCatalog")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultControlCatalogAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ControlCatalogClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultControlCatalogAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use ControlCatalogClientConfig instead. This class will be removed in a future version.")
    public final class ControlCatalogClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ControlCatalogClientConfig {
            return try ControlCatalogClientConfig(
...
extension ControlCatalogClient {
    ...
    public func getControl(input: GetControlInput) async throws -> GetControlOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("ControlCatalog", config.ignoreConfiguredEndpointURLs)
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ControlCatalog"))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetControlInput, GetControlOutput>(serviceID: serviceName, version: ControlCatalogClient.version, config: config))
    ...
    public func listCommonControls(input: ListCommonControlsInput) async throws -> ListCommonControlsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListCommonControlsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ControlCatalog"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListCommonControlsInput, ListCommonControlsOutput>(serviceID: serviceName, version: ControlCatalogClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ControlCatalog")
    ...
    /// Performs the `ListControlMappings` operation on the `ControlCatalog` service.
    ///
    ...
    /// - `ThrottlingException` : The request was denied due to request throttling.
    /// - `ValidationException` : The request has invalid or missing parameters.
    public func listControlMappings(input: ListControlMappingsInput) async throws -> ListControlMappingsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listControlMappings")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListControlMappingsInput, ListControlMappingsOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ListControlMappingsInput, ListControlMappingsOutput>(ListControlMappingsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListControlMappingsInput, ListControlMappingsOutput>())
        builder.serialize(ClientRuntime.QueryItemMiddleware<ListControlMappingsInput, ListControlMappingsOutput>(ListControlMappingsInput.queryItemProvider(_:)))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListControlMappingsInput, ListControlMappingsOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<ListControlMappingsInput, ListControlMappingsOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: ListControlMappingsInput.write(value:to:)))
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListControlMappingsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListControlMappingsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListControlMappingsInput, ListControlMappingsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListControlMappingsInput, ListControlMappingsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(SmithyRetries.DefaultRetryStrategy(options: config.retryStrategyOptions))
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ControlCatalog"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListControlMappingsInput, ListControlMappingsOutput>(serviceID: serviceName, version: ControlCatalogClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ControlCatalog")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListControlMappings")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func listControls(input: ListControlsInput) async throws -> ListControlsOutput {
        ...
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListControlsInput, ListControlsOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<ListControlsInput, ListControlsOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: ListControlsInput.write(value:to:)))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ControlCatalog"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListControlsInput, ListControlsOutput>(serviceID: serviceName, version: ControlCatalogClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ControlCatalog")
    ...
    public func listDomains(input: ListDomainsInput) async throws -> ListDomainsOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ControlCatalog"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListDomainsInput, ListDomainsOutput>(serviceID: serviceName, version: ControlCatalogClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ControlCatalog")
    ...
    public func listObjectives(input: ListObjectivesInput) async throws -> ListObjectivesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListObjectivesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "ControlCatalog"))
        builder.longPollingBackoffProvider(AWSClientRuntime.LongPollingBackoffProvider.backoffDelay(context:errorInfo:attemptCount:))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListObjectivesInput, ListObjectivesOutput>(serviceID: serviceName, version: ControlCatalogClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ControlCatalog")
