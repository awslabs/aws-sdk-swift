...
extension CreateDBClusterInput {
    ...
    static func write(value: CreateDBClusterInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Tags"].writeList(value.tags, memberWritingClosure: DocDBClientTypes.Tag.write(value:to:), memberNodeInfo: "Tag", isFlattened: false)
        try writer["VpcSecurityGroupIds"].writeList(value.vpcSecurityGroupIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "VpcSecurityGroupId", isFlattened: false)
...
extension CreateDBSubnetGroupInput {
    ...
    static func write(value: CreateDBSubnetGroupInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["DBSubnetGroupName"].write(value.dbSubnetGroupName)
        try writer["SubnetIds"].writeList(value.subnetIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "SubnetIdentifier", isFlattened: false)
        try writer["Tags"].writeList(value.tags, memberWritingClosure: DocDBClientTypes.Tag.write(value:to:), memberNodeInfo: "Tag", isFlattened: false)
...
extension CreateEventSubscriptionInput {
    ...
    static func write(value: CreateEventSubscriptionInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["SourceIds"].writeList(value.sourceIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "SourceId", isFlattened: false)
...
extension DocDBClientTypes.DBCluster {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBCluster {
        ...
        value.availabilityZones = try reader["AvailabilityZones"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "AvailabilityZone", isFlattened: false)
        ...
        value.readReplicaIdentifiers = try reader["ReadReplicaIdentifiers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "ReadReplicaIdentifier", isFlattened: false)
        ...
        value.enabledCloudwatchLogsExports = try reader["EnabledCloudwatchLogsExports"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DocDBClientTypes.DBClusterSnapshotAttribute {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBClusterSnapshotAttribute {
        ...
        value.attributeValues = try reader["AttributeValues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "AttributeValue", isFlattened: false)
        return value
    }
}
...
extension DocDBClientTypes.DBEngineVersion {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBEngineVersion {
        ...
        value.exportableLogTypes = try reader["ExportableLogTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.supportsLogExportsToCloudwatchLogs = try reader["SupportsLogExportsToCloudwatchLogs"].readIfPresent()
        value.supportedCACertificateIdentifiers = try reader["SupportedCACertificateIdentifiers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeCertificatesOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeCertificatesOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
...
extension DocDBClientTypes.Event {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.Event {
        ...
        value.message = try reader["Message"].readIfPresent()
        value.eventCategories = try reader["EventCategories"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "EventCategory", isFlattened: false)
...
extension DocDBClientTypes.EventSubscription {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.EventSubscription {
        ...
        value.sourceType = try reader["SourceType"].readIfPresent()
        value.sourceIdsList = try reader["SourceIdsList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "SourceId", isFlattened: false)
        value.eventCategoriesList = try reader["EventCategoriesList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "EventCategory", isFlattened: false)
...
extension DocDBClientTypes.GlobalClusterMember {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.GlobalClusterMember {
        ...
        value.dbClusterArn = try reader["DBClusterArn"].readIfPresent()
        value.readers = try reader["Readers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ModifyDBClusterSnapshotAttributeInput {
    ...
    static func write(value: ModifyDBClusterSnapshotAttributeInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["DBClusterSnapshotIdentifier"].write(value.dbClusterSnapshotIdentifier)
        try writer["ValuesToAdd"].writeList(value.valuesToAdd, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "AttributeValue", isFlattened: false)
        try writer["ValuesToRemove"].writeList(value.valuesToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "AttributeValue", isFlattened: false)
...
extension DocDBClientTypes.PendingCloudwatchLogsExports {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.PendingCloudwatchLogsExports {
        ...
        value.logTypesToEnable = try reader["LogTypesToEnable"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.logTypesToDisable = try reader["LogTypesToDisable"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension RestoreDBClusterToPointInTimeInput {
    ...
    static func write(value: RestoreDBClusterToPointInTimeInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["KmsKeyId"].write(value.kmsKeyId)
        try writer["Port"].write(value.port)
        try writer["RestoreToTime"].writeTimestamp(value.restoreToTime, format: .dateTime)
...
extension SwitchoverGlobalClusterOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> SwitchoverGlobalClusterOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyXML.Reader.from(data: data)
