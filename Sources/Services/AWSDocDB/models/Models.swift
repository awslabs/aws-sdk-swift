...
extension AddSourceIdentifierToSubscriptionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AddSourceIdentifierToSubscriptionOutput {
        let reader = responseReader["AddSourceIdentifierToSubscriptionResult"]
        var value = AddSourceIdentifierToSubscriptionOutput()
        value.eventSubscription = try reader["EventSubscription"].readIfPresent(readingClosure: DocDBClientTypes.EventSubscription.readingClosure(from:))
        return value
    }
}
...
extension AddTagsToResourceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AddTagsToResourceOutput {
...
extension ApplyPendingMaintenanceActionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ApplyPendingMaintenanceActionOutput {
        let reader = responseReader["ApplyPendingMaintenanceActionResult"]
        var value = ApplyPendingMaintenanceActionOutput()
        value.resourcePendingMaintenanceActions = try reader["ResourcePendingMaintenanceActions"].readIfPresent(readingClosure: DocDBClientTypes.ResourcePendingMaintenanceActions.readingClosure(from:))
        return value
    }
}
...
extension DocDBClientTypes.AvailabilityZone: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.AvailabilityZone {
...
extension DocDBClientTypes.Certificate: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.Certificate {
...
extension DocDBClientTypes.CertificateDetails: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.CertificateDetails {
...
extension DocDBClientTypes.CloudwatchLogsExportConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.CloudwatchLogsExportConfiguration {
        var value = DocDBClientTypes.CloudwatchLogsExportConfiguration()
        value.enableLogTypes = try reader["EnableLogTypes"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.disableLogTypes = try reader["DisableLogTypes"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CopyDBClusterParameterGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CopyDBClusterParameterGroupOutput {
        let reader = responseReader["CopyDBClusterParameterGroupResult"]
        var value = CopyDBClusterParameterGroupOutput()
        value.dbClusterParameterGroup = try reader["DBClusterParameterGroup"].readIfPresent(readingClosure: DocDBClientTypes.DBClusterParameterGroup.readingClosure(from:))
        return value
    }
}
...
extension CopyDBClusterSnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CopyDBClusterSnapshotOutput {
        let reader = responseReader["CopyDBClusterSnapshotResult"]
        var value = CopyDBClusterSnapshotOutput()
        value.dbClusterSnapshot = try reader["DBClusterSnapshot"].readIfPresent(readingClosure: DocDBClientTypes.DBClusterSnapshot.readingClosure(from:))
        return value
    }
}
...
extension CreateDBClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateDBClusterOutput {
        let reader = responseReader["CreateDBClusterResult"]
        var value = CreateDBClusterOutput()
        value.dbCluster = try reader["DBCluster"].readIfPresent(readingClosure: DocDBClientTypes.DBCluster.readingClosure(from:))
        return value
    }
}
...
extension CreateDBClusterParameterGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateDBClusterParameterGroupOutput {
...
extension CreateDBClusterSnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateDBClusterSnapshotOutput {
...
extension CreateDBInstanceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateDBInstanceOutput {
        let reader = responseReader["CreateDBInstanceResult"]
        var value = CreateDBInstanceOutput()
        value.dbInstance = try reader["DBInstance"].readIfPresent(readingClosure: DocDBClientTypes.DBInstance.readingClosure(from:))
        return value
    }
}
...
extension CreateDBSubnetGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateDBSubnetGroupOutput {
        let reader = responseReader["CreateDBSubnetGroupResult"]
        var value = CreateDBSubnetGroupOutput()
        value.dbSubnetGroup = try reader["DBSubnetGroup"].readIfPresent(readingClosure: DocDBClientTypes.DBSubnetGroup.readingClosure(from:))
        return value
    }
}
...
extension CreateEventSubscriptionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateEventSubscriptionOutput {
...
extension CreateGlobalClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateGlobalClusterOutput {
        let reader = responseReader["CreateGlobalClusterResult"]
        var value = CreateGlobalClusterOutput()
        value.globalCluster = try reader["GlobalCluster"].readIfPresent(readingClosure: DocDBClientTypes.GlobalCluster.readingClosure(from:))
        return value
    }
}
...
extension DocDBClientTypes.DBCluster: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBCluster {
        var value = DocDBClientTypes.DBCluster()
        value.availabilityZones = try reader["AvailabilityZones"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "AvailabilityZone", isFlattened: false)
        ...
        value.readReplicaIdentifiers = try reader["ReadReplicaIdentifiers"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "ReadReplicaIdentifier", isFlattened: false)
        value.dbClusterMembers = try reader["DBClusterMembers"].readListIfPresent(memberReadingClosure: DocDBClientTypes.DBClusterMember.readingClosure(from:), memberNodeInfo: "DBClusterMember", isFlattened: false)
        value.vpcSecurityGroups = try reader["VpcSecurityGroups"].readListIfPresent(memberReadingClosure: DocDBClientTypes.VpcSecurityGroupMembership.readingClosure(from:), memberNodeInfo: "VpcSecurityGroupMembership", isFlattened: false)
        ...
        value.associatedRoles = try reader["AssociatedRoles"].readListIfPresent(memberReadingClosure: DocDBClientTypes.DBClusterRole.readingClosure(from:), memberNodeInfo: "DBClusterRole", isFlattened: false)
        ...
        value.enabledCloudwatchLogsExports = try reader["EnabledCloudwatchLogsExports"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DocDBClientTypes.DBClusterMember: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBClusterMember {
...
extension DocDBClientTypes.DBClusterParameterGroup: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBClusterParameterGroup {
...
extension DocDBClientTypes.DBClusterRole: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBClusterRole {
...
extension DocDBClientTypes.DBClusterSnapshot: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBClusterSnapshot {
...
extension DocDBClientTypes.DBClusterSnapshotAttribute: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBClusterSnapshotAttribute {
        var value = DocDBClientTypes.DBClusterSnapshotAttribute()
        value.attributeName = try reader["AttributeName"].readIfPresent()
        value.attributeValues = try reader["AttributeValues"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "AttributeValue", isFlattened: false)
        return value
    }
}
...
extension DocDBClientTypes.DBClusterSnapshotAttributesResult: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBClusterSnapshotAttributesResult {
        var value = DocDBClientTypes.DBClusterSnapshotAttributesResult()
        value.dbClusterSnapshotIdentifier = try reader["DBClusterSnapshotIdentifier"].readIfPresent()
        value.dbClusterSnapshotAttributes = try reader["DBClusterSnapshotAttributes"].readListIfPresent(memberReadingClosure: DocDBClientTypes.DBClusterSnapshotAttribute.readingClosure(from:), memberNodeInfo: "DBClusterSnapshotAttribute", isFlattened: false)
        return value
    }
}
...
extension DocDBClientTypes.DBEngineVersion: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBEngineVersion {
        ...
        value.validUpgradeTarget = try reader["ValidUpgradeTarget"].readListIfPresent(memberReadingClosure: DocDBClientTypes.UpgradeTarget.readingClosure(from:), memberNodeInfo: "UpgradeTarget", isFlattened: false)
        value.exportableLogTypes = try reader["ExportableLogTypes"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.supportsLogExportsToCloudwatchLogs = try reader["SupportsLogExportsToCloudwatchLogs"].readIfPresent()
        value.supportedCACertificateIdentifiers = try reader["SupportedCACertificateIdentifiers"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DocDBClientTypes.DBInstance: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBInstance {
        ...
        value.endpoint = try reader["Endpoint"].readIfPresent(readingClosure: DocDBClientTypes.Endpoint.readingClosure(from:))
        ...
        value.dbSubnetGroup = try reader["DBSubnetGroup"].readIfPresent(readingClosure: DocDBClientTypes.DBSubnetGroup.readingClosure(from:))
        value.preferredMaintenanceWindow = try reader["PreferredMaintenanceWindow"].readIfPresent()
        value.pendingModifiedValues = try reader["PendingModifiedValues"].readIfPresent(readingClosure: DocDBClientTypes.PendingModifiedValues.readingClosure(from:))
        value.latestRestorableTime = try reader["LatestRestorableTime"].readTimestampIfPresent(format: .dateTime)
        value.engineVersion = try reader["EngineVersion"].readIfPresent()
        ...
        value.statusInfos = try reader["StatusInfos"].readListIfPresent(memberReadingClosure: DocDBClientTypes.DBInstanceStatusInfo.readingClosure(from:), memberNodeInfo: "DBInstanceStatusInfo", isFlattened: false)
        value.dbClusterIdentifier = try reader["DBClusterIdentifier"].readIfPresent()
        value.storageEncrypted = try reader["StorageEncrypted"].readIfPresent()
        value.kmsKeyId = try reader["KmsKeyId"].readIfPresent()
        ...
        value.enabledCloudwatchLogsExports = try reader["EnabledCloudwatchLogsExports"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.certificateDetails = try reader["CertificateDetails"].readIfPresent(readingClosure: DocDBClientTypes.CertificateDetails.readingClosure(from:))
        return value
    }
}
...
extension DocDBClientTypes.DBInstanceStatusInfo: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBInstanceStatusInfo {
...
extension DocDBClientTypes.DBSubnetGroup: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.DBSubnetGroup {
        ...
        value.subnets = try reader["Subnets"].readListIfPresent(memberReadingClosure: DocDBClientTypes.Subnet.readingClosure(from:), memberNodeInfo: "Subnet", isFlattened: false)
...
extension DeleteDBClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteDBClusterOutput {
...
extension DeleteDBClusterParameterGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteDBClusterParameterGroupOutput {
        let reader = responseReader["DeleteDBClusterParameterGroupResult"]
        var value = DeleteDBClusterParameterGroupOutput()
        return value
    }
}
...
extension DeleteDBClusterSnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteDBClusterSnapshotOutput {
...
extension DeleteDBInstanceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteDBInstanceOutput {
...
extension DeleteDBSubnetGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteDBSubnetGroupOutput {
        let reader = responseReader["DeleteDBSubnetGroupResult"]
        var value = DeleteDBSubnetGroupOutput()
        return value
    }
}
...
extension DeleteEventSubscriptionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteEventSubscriptionOutput {
...
extension DeleteGlobalClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteGlobalClusterOutput {
...
extension DescribeCertificatesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeCertificatesOutput {
        let reader = responseReader["DescribeCertificatesResult"]
        var value = DescribeCertificatesOutput()
        value.certificates = try reader["Certificates"].readListIfPresent(memberReadingClosure: DocDBClientTypes.Certificate.readingClosure(from:), memberNodeInfo: "Certificate", isFlattened: false)
...
extension DescribeDBClusterParameterGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeDBClusterParameterGroupsOutput {
        let reader = responseReader["DescribeDBClusterParameterGroupsResult"]
        var value = DescribeDBClusterParameterGroupsOutput()
        value.dbClusterParameterGroups = try reader["DBClusterParameterGroups"].readListIfPresent(memberReadingClosure: DocDBClientTypes.DBClusterParameterGroup.readingClosure(from:), memberNodeInfo: "DBClusterParameterGroup", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeDBClusterParametersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeDBClusterParametersOutput {
        let reader = responseReader["DescribeDBClusterParametersResult"]
        var value = DescribeDBClusterParametersOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.parameters = try reader["Parameters"].readListIfPresent(memberReadingClosure: DocDBClientTypes.Parameter.readingClosure(from:), memberNodeInfo: "Parameter", isFlattened: false)
        return value
    }
}
...
extension DescribeDBClusterSnapshotAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeDBClusterSnapshotAttributesOutput {
        let reader = responseReader["DescribeDBClusterSnapshotAttributesResult"]
        var value = DescribeDBClusterSnapshotAttributesOutput()
        value.dbClusterSnapshotAttributesResult = try reader["DBClusterSnapshotAttributesResult"].readIfPresent(readingClosure: DocDBClientTypes.DBClusterSnapshotAttributesResult.readingClosure(from:))
        return value
    }
}
...
extension DescribeDBClusterSnapshotsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeDBClusterSnapshotsOutput {
        let reader = responseReader["DescribeDBClusterSnapshotsResult"]
        var value = DescribeDBClusterSnapshotsOutput()
        value.dbClusterSnapshots = try reader["DBClusterSnapshots"].readListIfPresent(memberReadingClosure: DocDBClientTypes.DBClusterSnapshot.readingClosure(from:), memberNodeInfo: "DBClusterSnapshot", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeDBClustersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeDBClustersOutput {
        let reader = responseReader["DescribeDBClustersResult"]
        var value = DescribeDBClustersOutput()
        value.dbClusters = try reader["DBClusters"].readListIfPresent(memberReadingClosure: DocDBClientTypes.DBCluster.readingClosure(from:), memberNodeInfo: "DBCluster", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeDBEngineVersionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeDBEngineVersionsOutput {
        let reader = responseReader["DescribeDBEngineVersionsResult"]
        var value = DescribeDBEngineVersionsOutput()
        value.dbEngineVersions = try reader["DBEngineVersions"].readListIfPresent(memberReadingClosure: DocDBClientTypes.DBEngineVersion.readingClosure(from:), memberNodeInfo: "DBEngineVersion", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeDBInstancesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeDBInstancesOutput {
        let reader = responseReader["DescribeDBInstancesResult"]
        var value = DescribeDBInstancesOutput()
        value.dbInstances = try reader["DBInstances"].readListIfPresent(memberReadingClosure: DocDBClientTypes.DBInstance.readingClosure(from:), memberNodeInfo: "DBInstance", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeDBSubnetGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeDBSubnetGroupsOutput {
        let reader = responseReader["DescribeDBSubnetGroupsResult"]
        var value = DescribeDBSubnetGroupsOutput()
        value.dbSubnetGroups = try reader["DBSubnetGroups"].readListIfPresent(memberReadingClosure: DocDBClientTypes.DBSubnetGroup.readingClosure(from:), memberNodeInfo: "DBSubnetGroup", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeEngineDefaultClusterParametersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEngineDefaultClusterParametersOutput {
        ...
        value.engineDefaults = try reader["EngineDefaults"].readIfPresent(readingClosure: DocDBClientTypes.EngineDefaults.readingClosure(from:))
        return value
    }
}
...
extension DescribeEventCategoriesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEventCategoriesOutput {
        let reader = responseReader["DescribeEventCategoriesResult"]
        var value = DescribeEventCategoriesOutput()
        value.eventCategoriesMapList = try reader["EventCategoriesMapList"].readListIfPresent(memberReadingClosure: DocDBClientTypes.EventCategoriesMap.readingClosure(from:), memberNodeInfo: "EventCategoriesMap", isFlattened: false)
        return value
    }
}
...
extension DescribeEventSubscriptionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEventSubscriptionsOutput {
        let reader = responseReader["DescribeEventSubscriptionsResult"]
        var value = DescribeEventSubscriptionsOutput()
        value.eventSubscriptionsList = try reader["EventSubscriptionsList"].readListIfPresent(memberReadingClosure: DocDBClientTypes.EventSubscription.readingClosure(from:), memberNodeInfo: "EventSubscription", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeEventsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEventsOutput {
        let reader = responseReader["DescribeEventsResult"]
        var value = DescribeEventsOutput()
        value.events = try reader["Events"].readListIfPresent(memberReadingClosure: DocDBClientTypes.Event.readingClosure(from:), memberNodeInfo: "Event", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeGlobalClustersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeGlobalClustersOutput {
        let reader = responseReader["DescribeGlobalClustersResult"]
        var value = DescribeGlobalClustersOutput()
        value.globalClusters = try reader["GlobalClusters"].readListIfPresent(memberReadingClosure: DocDBClientTypes.GlobalCluster.readingClosure(from:), memberNodeInfo: "GlobalClusterMember", isFlattened: false)
        value.marker = try reader["Marker"].readIfPresent()
        return value
    }
}
...
extension DescribeOrderableDBInstanceOptionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeOrderableDBInstanceOptionsOutput {
        let reader = responseReader["DescribeOrderableDBInstanceOptionsResult"]
        var value = DescribeOrderableDBInstanceOptionsOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.orderableDBInstanceOptions = try reader["OrderableDBInstanceOptions"].readListIfPresent(memberReadingClosure: DocDBClientTypes.OrderableDBInstanceOption.readingClosure(from:), memberNodeInfo: "OrderableDBInstanceOption", isFlattened: false)
        return value
    }
}
...
extension DescribePendingMaintenanceActionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribePendingMaintenanceActionsOutput {
        let reader = responseReader["DescribePendingMaintenanceActionsResult"]
        var value = DescribePendingMaintenanceActionsOutput()
        value.marker = try reader["Marker"].readIfPresent()
        value.pendingMaintenanceActions = try reader["PendingMaintenanceActions"].readListIfPresent(memberReadingClosure: DocDBClientTypes.ResourcePendingMaintenanceActions.readingClosure(from:), memberNodeInfo: "ResourcePendingMaintenanceActions", isFlattened: false)
        return value
    }
}
...
extension DocDBClientTypes.Endpoint: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.Endpoint {
...
extension DocDBClientTypes.EngineDefaults: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.EngineDefaults {
...
extension DocDBClientTypes.Event: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.Event {
        var value = DocDBClientTypes.Event()
        value.sourceIdentifier = try reader["SourceIdentifier"].readIfPresent()
        value.sourceType = try reader["SourceType"].readIfPresent()
        value.message = try reader["Message"].readIfPresent()
        value.eventCategories = try reader["EventCategories"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "EventCategory", isFlattened: false)
...
extension DocDBClientTypes.EventCategoriesMap: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.EventCategoriesMap {
...
extension DocDBClientTypes.EventSubscription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.EventSubscription {
        ...
        value.sourceType = try reader["SourceType"].readIfPresent()
        value.sourceIdsList = try reader["SourceIdsList"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "SourceId", isFlattened: false)
        value.eventCategoriesList = try reader["EventCategoriesList"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "EventCategory", isFlattened: false)
...
extension FailoverDBClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> FailoverDBClusterOutput {
...
extension DocDBClientTypes.Filter: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.Filter {
        var value = DocDBClientTypes.Filter()
        value.name = try reader["Name"].readIfPresent()
        value.values = try reader["Values"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "Value", isFlattened: false)
        return value
    }
}
...
extension DocDBClientTypes.GlobalCluster: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.GlobalCluster {
        ...
        value.storageEncrypted = try reader["StorageEncrypted"].readIfPresent()
        value.deletionProtection = try reader["DeletionProtection"].readIfPresent()
        value.globalClusterMembers = try reader["GlobalClusterMembers"].readListIfPresent(memberReadingClosure: DocDBClientTypes.GlobalClusterMember.readingClosure(from:), memberNodeInfo: "GlobalClusterMember", isFlattened: false)
        return value
    }
}
...
extension DocDBClientTypes.GlobalClusterMember: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.GlobalClusterMember {
        var value = DocDBClientTypes.GlobalClusterMember()
        value.dbClusterArn = try reader["DBClusterArn"].readIfPresent()
        value.readers = try reader["Readers"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ListTagsForResourceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListTagsForResourceOutput {
        ...
        value.tagList = try reader["TagList"].readListIfPresent(memberReadingClosure: DocDBClientTypes.Tag.readingClosure(from:), memberNodeInfo: "Tag", isFlattened: false)
        return value
    }
}
...
extension ModifyDBClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyDBClusterOutput {
...
extension ModifyDBClusterParameterGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyDBClusterParameterGroupOutput {
...
extension ModifyDBClusterSnapshotAttributeOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyDBClusterSnapshotAttributeOutput {
...
extension ModifyDBInstanceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyDBInstanceOutput {
...
extension ModifyDBSubnetGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyDBSubnetGroupOutput {
...
extension ModifyEventSubscriptionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyEventSubscriptionOutput {
...
extension ModifyGlobalClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ModifyGlobalClusterOutput {
...
extension DocDBClientTypes.OrderableDBInstanceOption: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.OrderableDBInstanceOption {
        var value = DocDBClientTypes.OrderableDBInstanceOption()
        value.engine = try reader["Engine"].readIfPresent()
        value.engineVersion = try reader["EngineVersion"].readIfPresent()
        value.dbInstanceClass = try reader["DBInstanceClass"].readIfPresent()
        value.licenseModel = try reader["LicenseModel"].readIfPresent()
        value.availabilityZones = try reader["AvailabilityZones"].readListIfPresent(memberReadingClosure: DocDBClientTypes.AvailabilityZone.readingClosure(from:), memberNodeInfo: "AvailabilityZone", isFlattened: false)
...
extension DocDBClientTypes.Parameter: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.Parameter {
...
extension DocDBClientTypes.PendingCloudwatchLogsExports: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.PendingCloudwatchLogsExports {
        var value = DocDBClientTypes.PendingCloudwatchLogsExports()
        value.logTypesToEnable = try reader["LogTypesToEnable"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.logTypesToDisable = try reader["LogTypesToDisable"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DocDBClientTypes.PendingMaintenanceAction: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.PendingMaintenanceAction {
...
extension DocDBClientTypes.PendingModifiedValues: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.PendingModifiedValues {
        ...
        value.caCertificateIdentifier = try reader["CACertificateIdentifier"].readIfPresent()
        value.dbSubnetGroupName = try reader["DBSubnetGroupName"].readIfPresent()
        value.pendingCloudwatchLogsExports = try reader["PendingCloudwatchLogsExports"].readIfPresent(readingClosure: DocDBClientTypes.PendingCloudwatchLogsExports.readingClosure(from:))
        return value
    }
}
...
extension RebootDBInstanceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RebootDBInstanceOutput {
...
extension RemoveFromGlobalClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RemoveFromGlobalClusterOutput {
...
extension RemoveSourceIdentifierFromSubscriptionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RemoveSourceIdentifierFromSubscriptionOutput {
...
extension RemoveTagsFromResourceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RemoveTagsFromResourceOutput {
...
extension ResetDBClusterParameterGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ResetDBClusterParameterGroupOutput {
...
extension DocDBClientTypes.ResourcePendingMaintenanceActions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.ResourcePendingMaintenanceActions {
        ...
        value.pendingMaintenanceActionDetails = try reader["PendingMaintenanceActionDetails"].readListIfPresent(memberReadingClosure: DocDBClientTypes.PendingMaintenanceAction.readingClosure(from:), memberNodeInfo: "PendingMaintenanceAction", isFlattened: false)
        return value
    }
}
...
extension RestoreDBClusterFromSnapshotOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RestoreDBClusterFromSnapshotOutput {
...
extension RestoreDBClusterToPointInTimeOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RestoreDBClusterToPointInTimeOutput {
...
extension StartDBClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> StartDBClusterOutput {
...
extension StopDBClusterOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> StopDBClusterOutput {
...
extension DocDBClientTypes.Subnet: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.Subnet {
        var value = DocDBClientTypes.Subnet()
        value.subnetIdentifier = try reader["SubnetIdentifier"].readIfPresent()
        value.subnetAvailabilityZone = try reader["SubnetAvailabilityZone"].readIfPresent(readingClosure: DocDBClientTypes.AvailabilityZone.readingClosure(from:))
...
extension DocDBClientTypes.Tag: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.Tag {
...
extension DocDBClientTypes.UpgradeTarget: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.UpgradeTarget {
...
extension DocDBClientTypes.VpcSecurityGroupMembership: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> DocDBClientTypes.VpcSecurityGroupMembership {
