...
extension ChimeSDKMeetingsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ChimeSDKMeetingsClient.ChimeSDKMeetingsClientConfiguration {
        let clientConfiguration = try await ChimeSDKMeetingsClient.ChimeSDKMeetingsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ChimeSDKMeetingsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ChimeSDKMeetingsClient(config: configuration)
        }
    }
...
extension ChimeSDKMeetingsClient.ChimeSDKMeetingsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
