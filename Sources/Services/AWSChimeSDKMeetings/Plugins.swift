...
public class ChimeSDKMeetingsClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ChimeSDKMeetingsClient.ChimeSDKMeetingsClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ChimeSDKMeetingsClient.ChimeSDKMeetingsClientConfiguration {
            config.authSchemeResolver = DefaultChimeSDKMeetingsAuthSchemeResolver()
...
public class ChimeSDKMeetingsClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: ChimeSDKMeetingsAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
