...
public class GreengrassClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await GreengrassClientConfiguration(region: region)
    ...
    public class GreengrassClientConfiguration: GreengrassClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("GreengrassClient")
