...
public class ServerlessApplicationRepositoryClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await ServerlessApplicationRepositoryClientConfiguration(region: region)
    ...
    public class ServerlessApplicationRepositoryClientConfiguration: ServerlessApplicationRepositoryClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("ServerlessApplicationRepositoryClient")
