...
public class ServerlessApplicationRepositoryClientEndpointPlugin: Plugin {
...
public class ServerlessApplicationRepositoryClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: ServerlessApplicationRepositoryAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
