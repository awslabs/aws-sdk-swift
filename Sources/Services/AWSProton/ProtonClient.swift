...
extension ProtonClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ProtonClient.ProtonClientConfiguration {
        let clientConfiguration = try await ProtonClient.ProtonClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ProtonClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ProtonClient(config: configuration)
        }
    }
...
extension ProtonClient.ProtonClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
