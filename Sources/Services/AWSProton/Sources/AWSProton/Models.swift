...
extension ProtonClientTypes.EnvironmentAccountConnection {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ProtonClientTypes.EnvironmentAccountConnection {
        ...
        value.requestedAt = try reader["requestedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension ProtonClientTypes.Component {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ProtonClientTypes.Component {
        ...
        value.lastModifiedAt = try reader["lastModifiedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.lastDeploymentAttemptedAt = try reader["lastDeploymentAttemptedAt"].readTimestampIfPresent(format: .epochSeconds)
        value.lastDeploymentSucceededAt = try reader["lastDeploymentSucceededAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension ProtonClientTypes.Deployment {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ProtonClientTypes.Deployment {
        ...
        value.targetResourceCreatedAt = try reader["targetResourceCreatedAt"].readTimestampIfPresent(format: .epochSeconds)
