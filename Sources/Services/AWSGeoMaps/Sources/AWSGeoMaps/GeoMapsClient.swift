...
public final class GeoMapsClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: GeoMapsClient.GeoMapsClientConfig) instead")
    public convenience init(config: GeoMapsClient.GeoMapsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try GeoMapsClient.GeoMapsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await GeoMapsClient.GeoMapsClientConfig()
        self.init(config: config)
    }
}
...
extension GeoMapsClient {
    ...
    /// Client configuration for GeoMapsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct GeoMapsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Geo Maps")
    ...
    @available(*, deprecated, message: "Use GeoMapsClientConfig instead. This class will be removed in a future version.")
    public final class GeoMapsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> GeoMapsClientConfig {
            return try GeoMapsClientConfig(
...
extension GeoMapsClient {
    ...
    public func getGlyphs(input: GetGlyphsInput) async throws -> GetGlyphsOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Geo Maps"))
