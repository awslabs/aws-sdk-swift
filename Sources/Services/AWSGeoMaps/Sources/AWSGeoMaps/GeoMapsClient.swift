...
public final class GeoMapsClient: AWSClientRuntime.AWSServiceClient, Sendable {
...
extension GeoMapsClient {
    ...
    public final class GeoMapsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, @unchecked Sendable {
        ...
        public convenience init(region: Swift.String) throws {
            self.init(
                ...
                nil,
                DefaultGeoMapsAuthSchemeResolver(),
