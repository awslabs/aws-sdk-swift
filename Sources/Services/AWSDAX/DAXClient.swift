...
extension DAXClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> DAXClient.DAXClientConfiguration {
        let clientConfiguration = try await DAXClient.DAXClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> DAXClient {
            let configuration = try await resolve(plugins: self.plugins)
            return DAXClient(config: configuration)
        }
    }
...
extension DAXClient.DAXClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
