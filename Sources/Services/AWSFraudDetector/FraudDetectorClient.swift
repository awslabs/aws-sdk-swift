...
public class FraudDetectorClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await FraudDetectorClientConfiguration(region: region)
    ...
    public class FraudDetectorClientConfiguration: FraudDetectorClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("FraudDetectorClient")
