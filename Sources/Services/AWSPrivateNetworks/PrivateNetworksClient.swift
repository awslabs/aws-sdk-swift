...
extension PrivateNetworksClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> PrivateNetworksClient.PrivateNetworksClientConfiguration {
        let clientConfiguration = try await PrivateNetworksClient.PrivateNetworksClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> PrivateNetworksClient {
            let configuration = try await resolve(plugins: self.plugins)
            return PrivateNetworksClient(config: configuration)
        }
    }
...
extension PrivateNetworksClient.PrivateNetworksClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
