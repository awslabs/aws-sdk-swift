...
extension ComposeEnvironmentsInput {
    ...
    static func write(value: ComposeEnvironmentsInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["VersionLabels"].writeList(value.versionLabels, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeApplicationsInput {
    ...
    static func write(value: DescribeApplicationsInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["ApplicationNames"].writeList(value.applicationNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeEnvironmentHealthInput {
    ...
    static func write(value: DescribeEnvironmentHealthInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AttributeNames"].writeList(value.attributeNames, memberWritingClosure: ElasticBeanstalkClientTypes.EnvironmentHealthAttribute.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["EnvironmentId"].write(value.environmentId)
        try writer["EnvironmentName"].write(value.environmentName)
...
extension DescribeEnvironmentsInput {
    ...
    static func write(value: DescribeEnvironmentsInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["ApplicationName"].write(value.applicationName)
        try writer["EnvironmentIds"].writeList(value.environmentIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["EnvironmentNames"].writeList(value.environmentNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeInstancesHealthInput {
    ...
    static func write(value: DescribeInstancesHealthInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AttributeNames"].writeList(value.attributeNames, memberWritingClosure: ElasticBeanstalkClientTypes.InstancesHealthAttribute.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["EnvironmentId"].write(value.environmentId)
        try writer["EnvironmentName"].write(value.environmentName)
        try writer["NextToken"].write(value.nextToken)
...
extension UpdateTagsForResourceInput {
    ...
    static func write(value: UpdateTagsForResourceInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["TagsToRemove"].writeList(value.tagsToRemove, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeEnvironmentHealthOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeEnvironmentHealthOutput {
        ...
        value.causes = try reader["Causes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ListAvailableSolutionStacksOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListAvailableSolutionStacksOutput {
        ...
        value.solutionStacks = try reader["SolutionStacks"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.ApplicationDescription {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ApplicationDescription {
        ...
        value.dateCreated = try reader["DateCreated"].readTimestampIfPresent(format: .dateTime)
        value.dateUpdated = try reader["DateUpdated"].readTimestampIfPresent(format: .dateTime)
        value.versions = try reader["Versions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.configurationTemplates = try reader["ConfigurationTemplates"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.resourceLifecycleConfig = try reader["ResourceLifecycleConfig"].readIfPresent(with: ElasticBeanstalkClientTypes.ApplicationResourceLifecycleConfig.read(from:))
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.PlatformSummary {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.PlatformSummary {
        ...
        value.supportedTierList = try reader["SupportedTierList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.supportedAddonList = try reader["SupportedAddonList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ElasticBeanstalkClientTypes.ConfigurationOptionDescription {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ConfigurationOptionDescription {
        ...
        value.valueOptions = try reader["ValueOptions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ElasticBeanstalkClientTypes.SystemStatus {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.SystemStatus {
        ...
        value.loadAverage = try reader["LoadAverage"].readListIfPresent(memberReadingClosure: Swift.Double.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.SolutionStackDescription {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.SolutionStackDescription {
        ...
        value.solutionStackName = try reader["SolutionStackName"].readIfPresent()
        value.permittedFileTypes = try reader["PermittedFileTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
