...
extension ElasticBeanstalkClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ElasticBeanstalkClient.ElasticBeanstalkClientConfiguration {
        let clientConfiguration = try await ElasticBeanstalkClient.ElasticBeanstalkClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ElasticBeanstalkClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ElasticBeanstalkClient(config: configuration)
        }
    }
...
extension ElasticBeanstalkClient.ElasticBeanstalkClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
