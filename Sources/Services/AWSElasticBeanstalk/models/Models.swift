...
extension AbortEnvironmentUpdateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AbortEnvironmentUpdateOutput {
        let reader = responseReader["AbortEnvironmentUpdateResult"]
        var value = AbortEnvironmentUpdateOutput()
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.ApplicationDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ApplicationDescription {
        ...
        value.versions = try reader["Versions"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.configurationTemplates = try reader["ConfigurationTemplates"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.resourceLifecycleConfig = try reader["ResourceLifecycleConfig"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ApplicationResourceLifecycleConfig.readingClosure(from:))
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.ApplicationMetrics: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ApplicationMetrics {
        ...
        value.statusCodes = try reader["StatusCodes"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.StatusCodes.readingClosure(from:))
        value.latency = try reader["Latency"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.Latency.readingClosure(from:))
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.ApplicationResourceLifecycleConfig: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ApplicationResourceLifecycleConfig {
        ...
        value.versionLifecycleConfig = try reader["VersionLifecycleConfig"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ApplicationVersionLifecycleConfig.readingClosure(from:))
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.ApplicationVersionDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ApplicationVersionDescription {
        ...
        value.sourceBuildInformation = try reader["SourceBuildInformation"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.SourceBuildInformation.readingClosure(from:))
        value.buildArn = try reader["BuildArn"].readIfPresent()
        value.sourceBundle = try reader["SourceBundle"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.S3Location.readingClosure(from:))
        value.dateCreated = try reader["DateCreated"].readTimestampIfPresent(format: .dateTime)
        value.dateUpdated = try reader["DateUpdated"].readTimestampIfPresent(format: .dateTime)
...
extension ElasticBeanstalkClientTypes.ApplicationVersionLifecycleConfig: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ApplicationVersionLifecycleConfig {
        var value = ElasticBeanstalkClientTypes.ApplicationVersionLifecycleConfig()
        value.maxCountRule = try reader["MaxCountRule"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.MaxCountRule.readingClosure(from:))
        value.maxAgeRule = try reader["MaxAgeRule"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.MaxAgeRule.readingClosure(from:))
        return value
    }
}
...
extension ApplyEnvironmentManagedActionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ApplyEnvironmentManagedActionOutput {
...
extension AssociateEnvironmentOperationsRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AssociateEnvironmentOperationsRoleOutput {
        let reader = responseReader["AssociateEnvironmentOperationsRoleResult"]
        var value = AssociateEnvironmentOperationsRoleOutput()
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.AutoScalingGroup: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.AutoScalingGroup {
...
extension ElasticBeanstalkClientTypes.BuildConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.BuildConfiguration {
...
extension ElasticBeanstalkClientTypes.Builder: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.Builder {
...
extension ElasticBeanstalkClientTypes.CPUUtilization: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.CPUUtilization {
...
extension CheckDNSAvailabilityOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CheckDNSAvailabilityOutput {
...
extension ComposeEnvironmentsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ComposeEnvironmentsOutput {
        let reader = responseReader["ComposeEnvironmentsResult"]
        var value = ComposeEnvironmentsOutput()
        value.environments = try reader["Environments"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.EnvironmentDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ElasticBeanstalkClientTypes.ConfigurationOptionDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ConfigurationOptionDescription {
        ...
        value.valueOptions = try reader["ValueOptions"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.regex = try reader["Regex"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.OptionRestrictionRegex.readingClosure(from:))
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.ConfigurationOptionSetting: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ConfigurationOptionSetting {
...
extension ElasticBeanstalkClientTypes.ConfigurationSettingsDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ConfigurationSettingsDescription {
        ...
        value.dateCreated = try reader["DateCreated"].readTimestampIfPresent(format: .dateTime)
        value.dateUpdated = try reader["DateUpdated"].readTimestampIfPresent(format: .dateTime)
        value.optionSettings = try reader["OptionSettings"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.ConfigurationOptionSetting.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CreateApplicationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateApplicationOutput {
        let reader = responseReader["CreateApplicationResult"]
        var value = CreateApplicationOutput()
        value.application = try reader["Application"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ApplicationDescription.readingClosure(from:))
        return value
    }
}
...
extension CreateApplicationVersionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateApplicationVersionOutput {
        let reader = responseReader["CreateApplicationVersionResult"]
        var value = CreateApplicationVersionOutput()
        value.applicationVersion = try reader["ApplicationVersion"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ApplicationVersionDescription.readingClosure(from:))
        return value
    }
}
...
extension CreateConfigurationTemplateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateConfigurationTemplateOutput {
...
extension CreateEnvironmentOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateEnvironmentOutput {
        ...
        value.environmentLinks = try reader["EnvironmentLinks"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.EnvironmentLink.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.environmentName = try reader["EnvironmentName"].readIfPresent()
        ...
        value.platformArn = try reader["PlatformArn"].readIfPresent()
        value.resources = try reader["Resources"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.EnvironmentResourcesDescription.readingClosure(from:))
        value.solutionStackName = try reader["SolutionStackName"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
        value.templateName = try reader["TemplateName"].readIfPresent()
        value.tier = try reader["Tier"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.EnvironmentTier.readingClosure(from:))
        value.versionLabel = try reader["VersionLabel"].readIfPresent()
        return value
    }
}
...
extension CreatePlatformVersionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreatePlatformVersionOutput {
        let reader = responseReader["CreatePlatformVersionResult"]
        var value = CreatePlatformVersionOutput()
        value.builder = try reader["Builder"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.Builder.readingClosure(from:))
        value.platformSummary = try reader["PlatformSummary"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.PlatformSummary.readingClosure(from:))
        return value
    }
}
...
extension CreateStorageLocationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateStorageLocationOutput {
...
extension ElasticBeanstalkClientTypes.CustomAmi: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.CustomAmi {
...
extension DeleteApplicationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteApplicationOutput {
        let reader = responseReader["DeleteApplicationResult"]
...
extension DeleteApplicationVersionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteApplicationVersionOutput {
        let reader = responseReader["DeleteApplicationVersionResult"]
        var value = DeleteApplicationVersionOutput()
        return value
    }
}
...
extension DeleteConfigurationTemplateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteConfigurationTemplateOutput {
        let reader = responseReader["DeleteConfigurationTemplateResult"]
        var value = DeleteConfigurationTemplateOutput()
        return value
    }
}
...
extension DeleteEnvironmentConfigurationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteEnvironmentConfigurationOutput {
        let reader = responseReader["DeleteEnvironmentConfigurationResult"]
        var value = DeleteEnvironmentConfigurationOutput()
        return value
    }
}
...
extension DeletePlatformVersionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeletePlatformVersionOutput {
...
extension ElasticBeanstalkClientTypes.Deployment: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.Deployment {
...
extension DescribeAccountAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAccountAttributesOutput {
        let reader = responseReader["DescribeAccountAttributesResult"]
        var value = DescribeAccountAttributesOutput()
        value.resourceQuotas = try reader["ResourceQuotas"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ResourceQuotas.readingClosure(from:))
        return value
    }
}
...
extension DescribeApplicationVersionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeApplicationVersionsOutput {
        let reader = responseReader["DescribeApplicationVersionsResult"]
        var value = DescribeApplicationVersionsOutput()
        value.applicationVersions = try reader["ApplicationVersions"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.ApplicationVersionDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension DescribeApplicationsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeApplicationsOutput {
        let reader = responseReader["DescribeApplicationsResult"]
        var value = DescribeApplicationsOutput()
        value.applications = try reader["Applications"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.ApplicationDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeConfigurationOptionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeConfigurationOptionsOutput {
        let reader = responseReader["DescribeConfigurationOptionsResult"]
        var value = DescribeConfigurationOptionsOutput()
        value.options = try reader["Options"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.ConfigurationOptionDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.platformArn = try reader["PlatformArn"].readIfPresent()
        value.solutionStackName = try reader["SolutionStackName"].readIfPresent()
        return value
    }
...
extension DescribeConfigurationSettingsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeConfigurationSettingsOutput {
        let reader = responseReader["DescribeConfigurationSettingsResult"]
        var value = DescribeConfigurationSettingsOutput()
        value.configurationSettings = try reader["ConfigurationSettings"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.ConfigurationSettingsDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeEnvironmentHealthOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEnvironmentHealthOutput {
        let reader = responseReader["DescribeEnvironmentHealthResult"]
        var value = DescribeEnvironmentHealthOutput()
        value.applicationMetrics = try reader["ApplicationMetrics"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ApplicationMetrics.readingClosure(from:))
        value.causes = try reader["Causes"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.color = try reader["Color"].readIfPresent()
        value.environmentName = try reader["EnvironmentName"].readIfPresent()
        value.healthStatus = try reader["HealthStatus"].readIfPresent()
        value.instancesHealth = try reader["InstancesHealth"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.InstanceHealthSummary.readingClosure(from:))
...
extension DescribeEnvironmentManagedActionHistoryOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEnvironmentManagedActionHistoryOutput {
        ...
        value.managedActionHistoryItems = try reader["ManagedActionHistoryItems"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.ManagedActionHistoryItem.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension DescribeEnvironmentManagedActionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEnvironmentManagedActionsOutput {
        let reader = responseReader["DescribeEnvironmentManagedActionsResult"]
        var value = DescribeEnvironmentManagedActionsOutput()
        value.managedActions = try reader["ManagedActions"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.ManagedAction.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeEnvironmentResourcesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEnvironmentResourcesOutput {
        let reader = responseReader["DescribeEnvironmentResourcesResult"]
        var value = DescribeEnvironmentResourcesOutput()
        value.environmentResources = try reader["EnvironmentResources"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.EnvironmentResourceDescription.readingClosure(from:))
        return value
    }
}
...
extension DescribeEnvironmentsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEnvironmentsOutput {
...
extension DescribeEventsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeEventsOutput {
        ...
        value.events = try reader["Events"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.EventDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension DescribeInstancesHealthOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeInstancesHealthOutput {
        let reader = responseReader["DescribeInstancesHealthResult"]
        var value = DescribeInstancesHealthOutput()
        value.instanceHealthList = try reader["InstanceHealthList"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.SingleInstanceHealth.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.refreshedAt = try reader["RefreshedAt"].readTimestampIfPresent(format: .dateTime)
        return value
    }
...
extension DescribePlatformVersionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribePlatformVersionOutput {
        let reader = responseReader["DescribePlatformVersionResult"]
        var value = DescribePlatformVersionOutput()
        value.platformDescription = try reader["PlatformDescription"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.PlatformDescription.readingClosure(from:))
        return value
    }
}
...
extension DisassociateEnvironmentOperationsRoleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DisassociateEnvironmentOperationsRoleOutput {
        let reader = responseReader["DisassociateEnvironmentOperationsRoleResult"]
        var value = DisassociateEnvironmentOperationsRoleOutput()
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.EnvironmentDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.EnvironmentDescription {
...
extension ElasticBeanstalkClientTypes.EnvironmentInfoDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.EnvironmentInfoDescription {
...
extension ElasticBeanstalkClientTypes.EnvironmentLink: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.EnvironmentLink {
...
extension ElasticBeanstalkClientTypes.EnvironmentResourceDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.EnvironmentResourceDescription {
        var value = ElasticBeanstalkClientTypes.EnvironmentResourceDescription()
        value.environmentName = try reader["EnvironmentName"].readIfPresent()
        value.autoScalingGroups = try reader["AutoScalingGroups"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.AutoScalingGroup.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.instances = try reader["Instances"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.Instance.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.launchConfigurations = try reader["LaunchConfigurations"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.LaunchConfiguration.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.launchTemplates = try reader["LaunchTemplates"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.LaunchTemplate.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.loadBalancers = try reader["LoadBalancers"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.LoadBalancer.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.triggers = try reader["Triggers"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.Trigger.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.queues = try reader["Queues"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.Queue.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.EnvironmentResourcesDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.EnvironmentResourcesDescription {
        var value = ElasticBeanstalkClientTypes.EnvironmentResourcesDescription()
        value.loadBalancer = try reader["LoadBalancer"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.LoadBalancerDescription.readingClosure(from:))
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.EnvironmentTier: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.EnvironmentTier {
...
extension ElasticBeanstalkClientTypes.EventDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.EventDescription {
...
extension ElasticBeanstalkClientTypes.Instance: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.Instance {
...
extension ElasticBeanstalkClientTypes.InstanceHealthSummary: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.InstanceHealthSummary {
...
extension ElasticBeanstalkClientTypes.Latency: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.Latency {
...
extension ElasticBeanstalkClientTypes.LaunchConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.LaunchConfiguration {
...
extension ElasticBeanstalkClientTypes.LaunchTemplate: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.LaunchTemplate {
...
extension ListAvailableSolutionStacksOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListAvailableSolutionStacksOutput {
        let reader = responseReader["ListAvailableSolutionStacksResult"]
        var value = ListAvailableSolutionStacksOutput()
        value.solutionStackDetails = try reader["SolutionStackDetails"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.SolutionStackDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.solutionStacks = try reader["SolutionStacks"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListPlatformBranchesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListPlatformBranchesOutput {
        let reader = responseReader["ListPlatformBranchesResult"]
        var value = ListPlatformBranchesOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.platformBranchSummaryList = try reader["PlatformBranchSummaryList"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.PlatformBranchSummary.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListPlatformVersionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListPlatformVersionsOutput {
        let reader = responseReader["ListPlatformVersionsResult"]
        var value = ListPlatformVersionsOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.platformSummaryList = try reader["PlatformSummaryList"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.PlatformSummary.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ListTagsForResourceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ListTagsForResourceOutput {
        ...
        value.resourceTags = try reader["ResourceTags"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.Tag.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.Listener: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.Listener {
...
extension ElasticBeanstalkClientTypes.LoadBalancer: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.LoadBalancer {
...
extension ElasticBeanstalkClientTypes.LoadBalancerDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.LoadBalancerDescription {
        ...
        value.listeners = try reader["Listeners"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.Listener.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.ManagedAction: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ManagedAction {
...
extension ElasticBeanstalkClientTypes.ManagedActionHistoryItem: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ManagedActionHistoryItem {
...
extension ElasticBeanstalkClientTypes.MaxAgeRule: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.MaxAgeRule {
...
extension ElasticBeanstalkClientTypes.MaxCountRule: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.MaxCountRule {
...
extension ElasticBeanstalkClientTypes.OptionRestrictionRegex: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.OptionRestrictionRegex {
...
extension ElasticBeanstalkClientTypes.OptionSpecification: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.OptionSpecification {
...
extension ElasticBeanstalkClientTypes.PlatformBranchSummary: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.PlatformBranchSummary {
        ...
        value.supportedTierList = try reader["SupportedTierList"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.PlatformDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.PlatformDescription {
        ...
        value.programmingLanguages = try reader["ProgrammingLanguages"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.PlatformProgrammingLanguage.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.frameworks = try reader["Frameworks"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.PlatformFramework.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.customAmiList = try reader["CustomAmiList"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.CustomAmi.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.supportedTierList = try reader["SupportedTierList"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.supportedAddonList = try reader["SupportedAddonList"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ElasticBeanstalkClientTypes.PlatformFilter: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.PlatformFilter {
...
extension ElasticBeanstalkClientTypes.PlatformFramework: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.PlatformFramework {
...
extension ElasticBeanstalkClientTypes.PlatformProgrammingLanguage: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.PlatformProgrammingLanguage {
...
extension ElasticBeanstalkClientTypes.PlatformSummary: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.PlatformSummary {
...
extension ElasticBeanstalkClientTypes.Queue: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.Queue {
...
extension RebuildEnvironmentOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RebuildEnvironmentOutput {
        let reader = responseReader["RebuildEnvironmentResult"]
        var value = RebuildEnvironmentOutput()
        return value
    }
}
...
extension RequestEnvironmentInfoOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RequestEnvironmentInfoOutput {
        let reader = responseReader["RequestEnvironmentInfoResult"]
        var value = RequestEnvironmentInfoOutput()
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.ResourceQuota: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ResourceQuota {
...
extension ElasticBeanstalkClientTypes.ResourceQuotas: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ResourceQuotas {
        var value = ElasticBeanstalkClientTypes.ResourceQuotas()
        value.applicationQuota = try reader["ApplicationQuota"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ResourceQuota.readingClosure(from:))
        value.applicationVersionQuota = try reader["ApplicationVersionQuota"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ResourceQuota.readingClosure(from:))
        value.environmentQuota = try reader["EnvironmentQuota"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ResourceQuota.readingClosure(from:))
        value.configurationTemplateQuota = try reader["ConfigurationTemplateQuota"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ResourceQuota.readingClosure(from:))
        value.customPlatformQuota = try reader["CustomPlatformQuota"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ResourceQuota.readingClosure(from:))
        return value
    }
}
...
extension RestartAppServerOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RestartAppServerOutput {
        let reader = responseReader["RestartAppServerResult"]
        var value = RestartAppServerOutput()
        return value
    }
}
...
extension RetrieveEnvironmentInfoOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RetrieveEnvironmentInfoOutput {
        let reader = responseReader["RetrieveEnvironmentInfoResult"]
        var value = RetrieveEnvironmentInfoOutput()
        value.environmentInfo = try reader["EnvironmentInfo"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.EnvironmentInfoDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.S3Location: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.S3Location {
...
extension ElasticBeanstalkClientTypes.SearchFilter: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.SearchFilter {
...
extension ElasticBeanstalkClientTypes.SingleInstanceHealth: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.SingleInstanceHealth {
        ...
        value.applicationMetrics = try reader["ApplicationMetrics"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.ApplicationMetrics.readingClosure(from:))
        value.system = try reader["System"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.SystemStatus.readingClosure(from:))
        value.deployment = try reader["Deployment"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.Deployment.readingClosure(from:))
...
extension ElasticBeanstalkClientTypes.SolutionStackDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.SolutionStackDescription {
        var value = ElasticBeanstalkClientTypes.SolutionStackDescription()
        value.solutionStackName = try reader["SolutionStackName"].readIfPresent()
        value.permittedFileTypes = try reader["PermittedFileTypes"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.SourceBuildInformation: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.SourceBuildInformation {
...
extension ElasticBeanstalkClientTypes.SourceConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.SourceConfiguration {
...
extension ElasticBeanstalkClientTypes.StatusCodes: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.StatusCodes {
...
extension SwapEnvironmentCNAMEsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SwapEnvironmentCNAMEsOutput {
        let reader = responseReader["SwapEnvironmentCNAMEsResult"]
        var value = SwapEnvironmentCNAMEsOutput()
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.SystemStatus: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.SystemStatus {
        var value = ElasticBeanstalkClientTypes.SystemStatus()
        value.cpuUtilization = try reader["CPUUtilization"].readIfPresent(readingClosure: ElasticBeanstalkClientTypes.CPUUtilization.readingClosure(from:))
        value.loadAverage = try reader["LoadAverage"].readListIfPresent(memberReadingClosure: Swift.Double.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.Tag: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.Tag {
...
extension TerminateEnvironmentOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TerminateEnvironmentOutput {
...
extension ElasticBeanstalkClientTypes.Trigger: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.Trigger {
...
extension UpdateApplicationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateApplicationOutput {
...
extension UpdateApplicationResourceLifecycleOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateApplicationResourceLifecycleOutput {
...
extension UpdateApplicationVersionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateApplicationVersionOutput {
...
extension UpdateConfigurationTemplateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateConfigurationTemplateOutput {
...
extension UpdateEnvironmentOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateEnvironmentOutput {
...
extension UpdateTagsForResourceOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateTagsForResourceOutput {
        let reader = responseReader["UpdateTagsForResourceResult"]
        var value = UpdateTagsForResourceOutput()
        return value
    }
}
...
extension ValidateConfigurationSettingsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ValidateConfigurationSettingsOutput {
        let reader = responseReader["ValidateConfigurationSettingsResult"]
        var value = ValidateConfigurationSettingsOutput()
        value.messages = try reader["Messages"].readListIfPresent(memberReadingClosure: ElasticBeanstalkClientTypes.ValidationMessage.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticBeanstalkClientTypes.ValidationMessage: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticBeanstalkClientTypes.ValidationMessage {
