...
extension ForecastClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ForecastClient.ForecastClientConfiguration {
        let clientConfiguration = try await ForecastClient.ForecastClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ForecastClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ForecastClient(config: configuration)
        }
    }
...
extension ForecastClient.ForecastClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
