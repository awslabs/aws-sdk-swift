...
extension CreateAutoPredictorInput {
    ...
    static func write(value: CreateAutoPredictorInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ForecastDimensions"].writeList(value.forecastDimensions, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ForecastFrequency"].write(value.forecastFrequency)
        try writer["ForecastHorizon"].write(value.forecastHorizon)
        try writer["ForecastTypes"].writeList(value.forecastTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension CreatePredictorInput {
    ...
    static func write(value: CreatePredictorInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["PredictorName"].write(value.predictorName)
        try writer["Tags"].writeList(value.tags, memberWritingClosure: ForecastClientTypes.Tag.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["TrainingParameters"].writeMap(value.trainingParameters, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension DescribeAutoPredictorOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeAutoPredictorOutput {
        ...
        value.datasetImportJobArns = try reader["DatasetImportJobArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.forecastDimensions = try reader["ForecastDimensions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.forecastTypes = try reader["ForecastTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeDatasetGroupOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeDatasetGroupOutput {
        ...
        value.creationTime = try reader["CreationTime"].readTimestampIfPresent(format: .epochSeconds)
        value.datasetArns = try reader["DatasetArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.datasetGroupArn = try reader["DatasetGroupArn"].readIfPresent()
...
extension DescribeMonitorOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeMonitorOutput {
        ...
        value.lastEvaluationTime = try reader["LastEvaluationTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lastModificationTime = try reader["LastModificationTime"].readTimestampIfPresent(format: .epochSeconds)
        value.message = try reader["Message"].readIfPresent()
        value.monitorArn = try reader["MonitorArn"].readIfPresent()
...
extension DescribePredictorOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribePredictorOutput {
        ...
        value.autoMLAlgorithmArns = try reader["AutoMLAlgorithmArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.predictorName = try reader["PredictorName"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
        value.trainingParameters = try reader["TrainingParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension DescribeWhatIfForecastExportOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeWhatIfForecastExportOutput {
        ...
        value.message = try reader["Message"].readIfPresent()
        value.status = try reader["Status"].readIfPresent()
        value.whatIfForecastArns = try reader["WhatIfForecastArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.whatIfForecastExportArn = try reader["WhatIfForecastExportArn"].readIfPresent()
...
extension ForecastClientTypes.AdditionalDataset {
    ...
    static func write(value: ForecastClientTypes.AdditionalDataset?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Configuration"].writeMap(value.configuration, valueWritingClosure: listWritingClosure(memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ForecastClientTypes.AdditionalDataset {
        ...
        value.configuration = try reader["Configuration"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension ForecastClientTypes.AttributeConfig {
    ...
    static func write(value: ForecastClientTypes.AttributeConfig?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Transformations"].writeMap(value.transformations, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ForecastClientTypes.AttributeConfig {
        ...
        value.transformations = try reader["Transformations"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension ForecastClientTypes.FeaturizationMethod {
    ...
    static func write(value: ForecastClientTypes.FeaturizationMethod?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["FeaturizationMethodParameters"].writeMap(value.featurizationMethodParameters, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ForecastClientTypes.FeaturizationMethod {
        ...
        value.featurizationMethodParameters = try reader["FeaturizationMethodParameters"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension ForecastClientTypes.TestWindowSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ForecastClientTypes.TestWindowSummary {
        ...
        value.testWindowStart = try reader["TestWindowStart"].readTimestampIfPresent(format: .epochSeconds)
        value.testWindowEnd = try reader["TestWindowEnd"].readTimestampIfPresent(format: .epochSeconds)
        value.status = try reader["Status"].readIfPresent()
        value.message = try reader["Message"].readIfPresent()
        return value
    }
...
extension ForecastClientTypes.PredictorMonitorEvaluation {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ForecastClientTypes.PredictorMonitorEvaluation {
        ...
        value.resourceArn = try reader["ResourceArn"].readIfPresent()
        value.monitorArn = try reader["MonitorArn"].readIfPresent()
        value.evaluationTime = try reader["EvaluationTime"].readTimestampIfPresent(format: .epochSeconds)
        value.evaluationState = try reader["EvaluationState"].readIfPresent()
        value.windowStartDatetime = try reader["WindowStartDatetime"].readTimestampIfPresent(format: .epochSeconds)
        value.windowEndDatetime = try reader["WindowEndDatetime"].readTimestampIfPresent(format: .epochSeconds)
