...
extension PcaConnectorAdClientTypes.PrivateKeyAttributesV2 {
    ...
    static func write(value: PcaConnectorAdClientTypes.PrivateKeyAttributesV2?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["CryptoProviders"].writeList(value.cryptoProviders, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PcaConnectorAdClientTypes.PrivateKeyAttributesV2 {
        ...
        value.cryptoProviders = try reader["CryptoProviders"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension PcaConnectorAdClientTypes.TemplateV2 {
    ...
    static func write(value: PcaConnectorAdClientTypes.TemplateV2?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["SupersededTemplates"].writeList(value.supersededTemplates, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> PcaConnectorAdClientTypes.TemplateV2 {
        ...
        value.supersededTemplates = try reader["SupersededTemplates"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
