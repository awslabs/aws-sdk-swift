...
extension PcaConnectorAdClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> PcaConnectorAdClient.PcaConnectorAdClientConfiguration {
        let clientConfiguration = try await PcaConnectorAdClient.PcaConnectorAdClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> PcaConnectorAdClient {
            let configuration = try await resolve(plugins: self.plugins)
            return PcaConnectorAdClient(config: configuration)
        }
    }
...
extension PcaConnectorAdClient.PcaConnectorAdClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
