...
extension ResourceGroupsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ResourceGroupsClient.ResourceGroupsClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> ResourceGroupsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ResourceGroupsClient(config: configuration)
        }
    }
...
extension ResourceGroupsClient.ResourceGroupsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
