...
public final class TrustedAdvisorClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: TrustedAdvisorClient.TrustedAdvisorClientConfig) instead")
    public convenience init(config: TrustedAdvisorClient.TrustedAdvisorClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try TrustedAdvisorClient.TrustedAdvisorClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await TrustedAdvisorClient.TrustedAdvisorClientConfig()
        self.init(config: config)
    }
}
...
extension TrustedAdvisorClient {
    ...
    /// Client configuration for TrustedAdvisorClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct TrustedAdvisorClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "TrustedAdvisor")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: TrustedAdvisorClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultTrustedAdvisorAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use TrustedAdvisorClientConfig instead. This class will be removed in a future version.")
    public final class TrustedAdvisorClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> TrustedAdvisorClientConfig {
            return try TrustedAdvisorClientConfig(
...
extension TrustedAdvisorClient {
    ...
    public func batchUpdateRecommendationResourceExclusion(input: BatchUpdateRecommendationResourceExclusionInput) async throws -> BatchUpdateRecommendationResourceExclusionOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("TrustedAdvisor", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<BatchUpdateRecommendationResourceExclusionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "TrustedAdvisor"))
    ...
    public func getOrganizationRecommendation(input: GetOrganizationRecommendationInput) async throws -> GetOrganizationRecommendationOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetOrganizationRecommendationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func listChecks(input: ListChecksInput) async throws -> ListChecksOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListChecksOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func listOrganizationRecommendationAccounts(input: ListOrganizationRecommendationAccountsInput) async throws -> ListOrganizationRecommendationAccountsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListOrganizationRecommendationAccountsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func listOrganizationRecommendationResources(input: ListOrganizationRecommendationResourcesInput) async throws -> ListOrganizationRecommendationResourcesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListOrganizationRecommendationResourcesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func listOrganizationRecommendations(input: ListOrganizationRecommendationsInput) async throws -> ListOrganizationRecommendationsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListOrganizationRecommendationsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func listRecommendationResources(input: ListRecommendationResourcesInput) async throws -> ListRecommendationResourcesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListRecommendationResourcesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    /// Performs the `ListRecommendationsForResource` operation on the `TrustedAdvisor` service.
    ///
    /// List all Trusted Advisor recommendations for a given AWS resource ARN.
    ///
    /// - Parameter input: [no documentation found] (Type: `ListRecommendationsForResourceInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ListRecommendationsForResourceOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ThrottlingException` : Exception to notify that requests are being throttled
    /// - `ValidationException` : Exception that the request failed to satisfy service constraints
    public func listRecommendationsForResource(input: ListRecommendationsForResourceInput) async throws -> ListRecommendationsForResourceOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listRecommendationsForResource")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListRecommendationsForResourceInput, ListRecommendationsForResourceOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ListRecommendationsForResourceInput, ListRecommendationsForResourceOutput>(ListRecommendationsForResourceInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListRecommendationsForResourceInput, ListRecommendationsForResourceOutput>())
        builder.serialize(ClientRuntime.QueryItemMiddleware<ListRecommendationsForResourceInput, ListRecommendationsForResourceOutput>(ListRecommendationsForResourceInput.queryItemProvider(_:)))
        builder.deserialize(ClientRuntime.DeserializeMiddleware<ListRecommendationsForResourceOutput>(ListRecommendationsForResourceOutput.httpOutput(from:), ListRecommendationsForResourceOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<ListRecommendationsForResourceInput, ListRecommendationsForResourceOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<ListRecommendationsForResourceOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("TrustedAdvisor", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListRecommendationsForResourceOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListRecommendationsForResourceOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListRecommendationsForResourceInput, ListRecommendationsForResourceOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListRecommendationsForResourceInput, ListRecommendationsForResourceOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "TrustedAdvisor"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListRecommendationsForResourceInput, ListRecommendationsForResourceOutput>(serviceID: serviceName, version: TrustedAdvisorClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "TrustedAdvisor")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListRecommendationsForResource")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func updateOrganizationRecommendationLifecycle(input: UpdateOrganizationRecommendationLifecycleInput) async throws -> UpdateOrganizationRecommendationLifecycleOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateOrganizationRecommendationLifecycleOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func updateRecommendationLifecycle(input: UpdateRecommendationLifecycleInput) async throws -> UpdateRecommendationLifecycleOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateRecommendationLifecycleOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
