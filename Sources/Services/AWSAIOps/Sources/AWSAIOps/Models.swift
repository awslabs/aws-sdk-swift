...
public struct TagResourceInput: Swift.Sendable {
    /// The Amazon Resource Name (ARN) of the resource that you want to apply the tags to. You can use the [ListInvestigationGroups](https://docs.aws.amazon.com/operationalinvestigations/latest/AmazonQDeveloperOperationalInvestigationsAPIReference/API_ListInvestigationGroups.html) operation to find the ARNs of investigation groups.
    /// This member is required.
    public var resourceArn: Swift.String?
...
public struct UntagResourceInput: Swift.Sendable {
    /// The Amazon Resource Name (ARN) of the resource that you want to remove the tags from. You can use the [ListInvestigationGroups](https://docs.aws.amazon.com/operationalinvestigations/latest/AmazonQDeveloperOperationalInvestigationsAPIReference/API_ListInvestigationGroups.html) operation to find the ARNs of investigation groups.
    /// This member is required.
    public var resourceArn: Swift.String?
