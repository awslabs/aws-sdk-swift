...
public final class AIOpsClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: AIOpsClient.AIOpsClientConfig) instead")
    public convenience init(config: AIOpsClient.AIOpsClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try AIOpsClient.AIOpsClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await AIOpsClient.AIOpsClientConfig()
        self.init(config: config)
    }
}
...
extension AIOpsClient {
    ...
    /// Client configuration for AIOpsClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct AIOpsClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "AIOps")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultAIOpsAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: AIOpsClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use AIOpsClientConfig instead. This class will be removed in a future version.")
    public final class AIOpsClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> AIOpsClientConfig {
            return try AIOpsClientConfig(
...
extension AIOpsClient {
    ...
    public func createInvestigationGroup(input: CreateInvestigationGroupInput) async throws -> CreateInvestigationGroupOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "AIOps"))
