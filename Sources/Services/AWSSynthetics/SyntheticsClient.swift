...
extension SyntheticsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SyntheticsClient.SyntheticsClientConfiguration {
        let clientConfiguration = try await SyntheticsClient.SyntheticsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SyntheticsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SyntheticsClient(config: configuration)
        }
    }
...
extension SyntheticsClient.SyntheticsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
