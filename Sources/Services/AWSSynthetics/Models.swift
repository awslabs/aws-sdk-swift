...
extension SyntheticsClientTypes.BaseScreenshot {
    ...
    static func write(value: SyntheticsClientTypes.BaseScreenshot?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["IgnoreCoordinates"].writeList(value.ignoreCoordinates, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SyntheticsClientTypes.BaseScreenshot {
        ...
        value.ignoreCoordinates = try reader["IgnoreCoordinates"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SyntheticsClientTypes.CanaryTimeline {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SyntheticsClientTypes.CanaryTimeline {
        ...
        value.lastStarted = try reader["LastStarted"].readTimestampIfPresent(format: .epochSeconds)
        value.lastStopped = try reader["LastStopped"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension SyntheticsClientTypes.CanaryRunTimeline {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SyntheticsClientTypes.CanaryRunTimeline {
        ...
        value.completed = try reader["Completed"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
