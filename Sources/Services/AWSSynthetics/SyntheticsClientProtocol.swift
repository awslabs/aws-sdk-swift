...
public protocol SyntheticsClientProtocol {
    ...
    func listAssociatedGroups(input: ListAssociatedGroupsInput) async throws -> ListAssociatedGroupsOutputResponse
...
public protocol SyntheticsClientConfigurationProtocol : AWSClientRuntime.AWSClientConfiguration {
