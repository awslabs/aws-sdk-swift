...
extension ComprehendMedicalClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ComprehendMedicalClient.ComprehendMedicalClientConfiguration {
        let clientConfiguration = try await ComprehendMedicalClient.ComprehendMedicalClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ComprehendMedicalClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ComprehendMedicalClient(config: configuration)
        }
    }
...
extension ComprehendMedicalClient.ComprehendMedicalClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
