...
extension AttachLoadBalancerTargetGroupsInput {
    ...
    static func write(value: AttachLoadBalancerTargetGroupsInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AutoScalingGroupName"].write(value.autoScalingGroupName)
        try writer["TargetGroupARNs"].writeList(value.targetGroupARNs, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateAutoScalingGroupInput {
    ...
    static func write(value: CreateAutoScalingGroupInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["TargetGroupARNs"].writeList(value.targetGroupARNs, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["TerminationPolicies"].writeList(value.terminationPolicies, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["TrafficSources"].writeList(value.trafficSources, memberWritingClosure: AutoScalingClientTypes.TrafficSourceIdentifier.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateLaunchConfigurationInput {
    ...
    static func write(value: CreateLaunchConfigurationInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["ClassicLinkVPCSecurityGroups"].writeList(value.classicLinkVPCSecurityGroups, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeAutoScalingGroupsInput {
    ...
    static func write(value: DescribeAutoScalingGroupsInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AutoScalingGroupNames"].writeList(value.autoScalingGroupNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeInstanceRefreshesInput {
    ...
    static func write(value: DescribeInstanceRefreshesInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AutoScalingGroupName"].write(value.autoScalingGroupName)
        try writer["InstanceRefreshIds"].writeList(value.instanceRefreshIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["MaxRecords"].write(value.maxRecords)
        try writer["NextToken"].write(value.nextToken)
...
extension DescribeLaunchConfigurationsInput {
    ...
    static func write(value: DescribeLaunchConfigurationsInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["LaunchConfigurationNames"].writeList(value.launchConfigurationNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["MaxRecords"].write(value.maxRecords)
        try writer["NextToken"].write(value.nextToken)
...
extension DescribeLifecycleHooksInput {
    ...
    static func write(value: DescribeLifecycleHooksInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AutoScalingGroupName"].write(value.autoScalingGroupName)
        try writer["LifecycleHookNames"].writeList(value.lifecycleHookNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribePoliciesInput {
    ...
    static func write(value: DescribePoliciesInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["PolicyTypes"].writeList(value.policyTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeScalingActivitiesInput {
    ...
    static func write(value: DescribeScalingActivitiesInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["ActivityIds"].writeList(value.activityIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["AutoScalingGroupName"].write(value.autoScalingGroupName)
...
extension PutNotificationConfigurationInput {
    ...
    static func write(value: PutNotificationConfigurationInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AutoScalingGroupName"].write(value.autoScalingGroupName)
        try writer["NotificationTypes"].writeList(value.notificationTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["TopicARN"].write(value.topicARN)
...
extension ResumeProcessesInput {
    ...
    static func write(value: ResumeProcessesInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AutoScalingGroupName"].write(value.autoScalingGroupName)
        try writer["ScalingProcesses"].writeList(value.scalingProcesses, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeAutoScalingNotificationTypesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeAutoScalingNotificationTypesOutput {
        ...
        value.autoScalingNotificationTypes = try reader["AutoScalingNotificationTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeLifecycleHookTypesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeLifecycleHookTypesOutput {
        ...
        value.lifecycleHookTypes = try reader["LifecycleHookTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeTerminationPolicyTypesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeTerminationPolicyTypesOutput {
        ...
        value.terminationPolicyTypes = try reader["TerminationPolicyTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension AutoScalingClientTypes.AutoScalingGroup {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.AutoScalingGroup {
        ...
        value.loadBalancerNames = try reader["LoadBalancerNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.targetGroupARNs = try reader["TargetGroupARNs"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.TagDescription.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.terminationPolicies = try reader["TerminationPolicies"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AutoScalingClientTypes.InstanceRequirements {
    ...
    static func write(value: AutoScalingClientTypes.InstanceRequirements?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["AcceleratorManufacturers"].writeList(value.acceleratorManufacturers, memberWritingClosure: AutoScalingClientTypes.AcceleratorManufacturer.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["AcceleratorNames"].writeList(value.acceleratorNames, memberWritingClosure: AutoScalingClientTypes.AcceleratorName.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["AcceleratorTypes"].writeList(value.acceleratorTypes, memberWritingClosure: AutoScalingClientTypes.AcceleratorType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["CpuManufacturers"].writeList(value.cpuManufacturers, memberWritingClosure: AutoScalingClientTypes.CpuManufacturer.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["InstanceGenerations"].writeList(value.instanceGenerations, memberWritingClosure: AutoScalingClientTypes.InstanceGeneration.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["LocalStorage"].write(value.localStorage)
        try writer["LocalStorageTypes"].writeList(value.localStorageTypes, memberWritingClosure: AutoScalingClientTypes.LocalStorageType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstanceRequirements {
        ...
        value.cpuManufacturers = try reader["CpuManufacturers"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.CpuManufacturer.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.instanceGenerations = try reader["InstanceGenerations"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.InstanceGeneration.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.localStorageTypes = try reader["LocalStorageTypes"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.LocalStorageType.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.acceleratorTypes = try reader["AcceleratorTypes"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.AcceleratorType.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.acceleratorManufacturers = try reader["AcceleratorManufacturers"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.AcceleratorManufacturer.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.acceleratorNames = try reader["AcceleratorNames"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.AcceleratorName.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AutoScalingClientTypes.RefreshPreferences {
    ...
    static func write(value: AutoScalingClientTypes.RefreshPreferences?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["CheckpointPercentages"].writeList(value.checkpointPercentages, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.RefreshPreferences {
        ...
        value.checkpointPercentages = try reader["CheckpointPercentages"].readListIfPresent(memberReadingClosure: Swift.Int.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AutoScalingClientTypes.LaunchConfiguration {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LaunchConfiguration {
        ...
        value.classicLinkVPCSecurityGroups = try reader["ClassicLinkVPCSecurityGroups"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AutoScalingClientTypes.LoadForecast {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LoadForecast {
        ...
        value.timestamps = try reader["Timestamps"].readListIfPresent(memberReadingClosure: timestampReadingClosure(format: .dateTime), memberNodeInfo: "member", isFlattened: false)
