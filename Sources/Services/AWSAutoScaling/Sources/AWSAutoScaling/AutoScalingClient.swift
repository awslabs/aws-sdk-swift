...
public final class AutoScalingClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: AutoScalingClient.AutoScalingClientConfig) instead")
    public convenience init(config: AutoScalingClient.AutoScalingClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try AutoScalingClient.AutoScalingClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await AutoScalingClient.AutoScalingClientConfig()
        self.init(config: config)
    }
}
...
extension AutoScalingClient {
    ...
    /// Client configuration for AutoScalingClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct AutoScalingClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Auto Scaling")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: AutoScalingClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultAutoScalingAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use AutoScalingClientConfig instead. This class will be removed in a future version.")
    public final class AutoScalingClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> AutoScalingClientConfig {
            return try AutoScalingClientConfig(
...
extension AutoScalingClient {
    /// Performs the `AttachInstances` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `AttachInstancesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `AttachInstancesOutput`)
    ///
    ...
    public func attachInstances(input: AttachInstancesInput) async throws -> AttachInstancesOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Auto Scaling", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<AttachInstancesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<AttachInstancesInput, AttachInstancesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
    ...
    /// Performs the `AttachLoadBalancerTargetGroups` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `AttachLoadBalancerTargetGroupsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `AttachLoadBalancerTargetGroupsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func attachLoadBalancerTargetGroups(input: AttachLoadBalancerTargetGroupsInput) async throws -> AttachLoadBalancerTargetGroupsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<AttachLoadBalancerTargetGroupsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<AttachLoadBalancerTargetGroupsInput, AttachLoadBalancerTargetGroupsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `AttachLoadBalancers` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `AttachLoadBalancersInput`)
    ///
    /// - Returns: [no documentation found] (Type: `AttachLoadBalancersOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func attachLoadBalancers(input: AttachLoadBalancersInput) async throws -> AttachLoadBalancersOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<AttachLoadBalancersOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<AttachLoadBalancersInput, AttachLoadBalancersOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `AttachTrafficSources` operation on the `AutoScaling` service.
    ///
    ...
    ///
    ///
    /// This operation is additive and does not detach existing traffic sources from the Auto Scaling group. After the operation completes, use the [DescribeTrafficSources](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeTrafficSources.html) API to return details about the state of the attachments between traffic sources and your Auto Scaling group. To detach a traffic source from the Auto Scaling group, call the [DetachTrafficSources](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DetachTrafficSources.html) API.
    ///
    /// - Parameter input: [no documentation found] (Type: `AttachTrafficSourcesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `AttachTrafficSourcesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func attachTrafficSources(input: AttachTrafficSourcesInput) async throws -> AttachTrafficSourcesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<AttachTrafficSourcesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<AttachTrafficSourcesInput, AttachTrafficSourcesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `BatchDeleteScheduledAction` operation on the `AutoScaling` service.
    ///
    /// Deletes one or more scheduled actions for the specified Auto Scaling group.
    ///
    /// - Parameter input: [no documentation found] (Type: `BatchDeleteScheduledActionInput`)
    ///
    /// - Returns: [no documentation found] (Type: `BatchDeleteScheduledActionOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func batchDeleteScheduledAction(input: BatchDeleteScheduledActionInput) async throws -> BatchDeleteScheduledActionOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<BatchDeleteScheduledActionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<BatchDeleteScheduledActionInput, BatchDeleteScheduledActionOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `BatchPutScheduledUpdateGroupAction` operation on the `AutoScaling` service.
    ///
    /// Creates or updates one or more scheduled scaling actions for an Auto Scaling group.
    ///
    /// - Parameter input: [no documentation found] (Type: `BatchPutScheduledUpdateGroupActionInput`)
    ///
    /// - Returns: [no documentation found] (Type: `BatchPutScheduledUpdateGroupActionOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func batchPutScheduledUpdateGroupAction(input: BatchPutScheduledUpdateGroupActionInput) async throws -> BatchPutScheduledUpdateGroupActionOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<BatchPutScheduledUpdateGroupActionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<BatchPutScheduledUpdateGroupActionInput, BatchPutScheduledUpdateGroupActionOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `CancelInstanceRefresh` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `CancelInstanceRefreshInput`)
    ///
    /// - Returns: [no documentation found] (Type: `CancelInstanceRefreshOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func cancelInstanceRefresh(input: CancelInstanceRefreshInput) async throws -> CancelInstanceRefreshOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CancelInstanceRefreshOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CancelInstanceRefreshInput, CancelInstanceRefreshOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `CompleteLifecycleAction` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `CompleteLifecycleActionInput`)
    ///
    /// - Returns: [no documentation found] (Type: `CompleteLifecycleActionOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func completeLifecycleAction(input: CompleteLifecycleActionInput) async throws -> CompleteLifecycleActionOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CompleteLifecycleActionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CompleteLifecycleActionInput, CompleteLifecycleActionOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `CreateAutoScalingGroup` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `CreateAutoScalingGroupInput`)
    ///
    /// - Returns: [no documentation found] (Type: `CreateAutoScalingGroupOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func createAutoScalingGroup(input: CreateAutoScalingGroupInput) async throws -> CreateAutoScalingGroupOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateAutoScalingGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateAutoScalingGroupInput, CreateAutoScalingGroupOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    public func createLaunchConfiguration(input: CreateLaunchConfigurationInput) async throws -> CreateLaunchConfigurationOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateLaunchConfigurationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateLaunchConfigurationInput, CreateLaunchConfigurationOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `CreateOrUpdateTags` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `CreateOrUpdateTagsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `CreateOrUpdateTagsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func createOrUpdateTags(input: CreateOrUpdateTagsInput) async throws -> CreateOrUpdateTagsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateOrUpdateTagsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateOrUpdateTagsInput, CreateOrUpdateTagsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DeleteAutoScalingGroup` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DeleteAutoScalingGroupInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteAutoScalingGroupOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func deleteAutoScalingGroup(input: DeleteAutoScalingGroupInput) async throws -> DeleteAutoScalingGroupOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteAutoScalingGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteAutoScalingGroupInput, DeleteAutoScalingGroupOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DeleteLaunchConfiguration` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DeleteLaunchConfigurationInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteLaunchConfigurationOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func deleteLaunchConfiguration(input: DeleteLaunchConfigurationInput) async throws -> DeleteLaunchConfigurationOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteLaunchConfigurationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteLaunchConfigurationInput, DeleteLaunchConfigurationOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DeleteLifecycleHook` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DeleteLifecycleHookInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteLifecycleHookOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func deleteLifecycleHook(input: DeleteLifecycleHookInput) async throws -> DeleteLifecycleHookOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteLifecycleHookOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteLifecycleHookInput, DeleteLifecycleHookOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DeleteNotificationConfiguration` operation on the `AutoScaling` service.
    ///
    ...
    public func deleteNotificationConfiguration(input: DeleteNotificationConfigurationInput) async throws -> DeleteNotificationConfigurationOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteNotificationConfigurationInput, DeleteNotificationConfigurationOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DeletePolicy` operation on the `AutoScaling` service.
    ///
    ...
    public func deletePolicy(input: DeletePolicyInput) async throws -> DeletePolicyOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeletePolicyInput, DeletePolicyOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DeleteScheduledAction` operation on the `AutoScaling` service.
    ///
    ...
    public func deleteScheduledAction(input: DeleteScheduledActionInput) async throws -> DeleteScheduledActionOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteScheduledActionInput, DeleteScheduledActionOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DeleteTags` operation on the `AutoScaling` service.
    ///
    ...
    public func deleteTags(input: DeleteTagsInput) async throws -> DeleteTagsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteTagsInput, DeleteTagsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DeleteWarmPool` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DeleteWarmPoolInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeleteWarmPoolOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func deleteWarmPool(input: DeleteWarmPoolInput) async throws -> DeleteWarmPoolOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteWarmPoolOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteWarmPoolInput, DeleteWarmPoolOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeAccountLimits` operation on the `AutoScaling` service.
    ///
    ...
    public func describeAccountLimits(input: DescribeAccountLimitsInput) async throws -> DescribeAccountLimitsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeAccountLimitsInput, DescribeAccountLimitsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeAdjustmentTypes` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeAdjustmentTypesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeAdjustmentTypesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeAdjustmentTypes(input: DescribeAdjustmentTypesInput) async throws -> DescribeAdjustmentTypesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeAdjustmentTypesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeAdjustmentTypesInput, DescribeAdjustmentTypesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeAutoScalingGroups` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeAutoScalingGroupsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeAutoScalingGroupsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeAutoScalingGroups(input: DescribeAutoScalingGroupsInput) async throws -> DescribeAutoScalingGroupsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeAutoScalingGroupsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeAutoScalingGroupsInput, DescribeAutoScalingGroupsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeAutoScalingInstances` operation on the `AutoScaling` service.
    ///
    /// Gets information about the Auto Scaling instances in the account and Region.
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeAutoScalingInstancesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeAutoScalingInstancesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeAutoScalingInstances(input: DescribeAutoScalingInstancesInput) async throws -> DescribeAutoScalingInstancesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeAutoScalingInstancesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeAutoScalingInstancesInput, DescribeAutoScalingInstancesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeAutoScalingNotificationTypes` operation on the `AutoScaling` service.
    ///
    /// Describes the notification types that are supported by Amazon EC2 Auto Scaling.
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeAutoScalingNotificationTypesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeAutoScalingNotificationTypesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeAutoScalingNotificationTypes(input: DescribeAutoScalingNotificationTypesInput) async throws -> DescribeAutoScalingNotificationTypesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeAutoScalingNotificationTypesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeAutoScalingNotificationTypesInput, DescribeAutoScalingNotificationTypesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeInstanceRefreshes` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeInstanceRefreshesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeInstanceRefreshesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeInstanceRefreshes(input: DescribeInstanceRefreshesInput) async throws -> DescribeInstanceRefreshesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeInstanceRefreshesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeInstanceRefreshesInput, DescribeInstanceRefreshesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeLaunchConfigurations` operation on the `AutoScaling` service.
    ///
    /// Gets information about the launch configurations in the account and Region.
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeLaunchConfigurationsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeLaunchConfigurationsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeLaunchConfigurations(input: DescribeLaunchConfigurationsInput) async throws -> DescribeLaunchConfigurationsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeLaunchConfigurationsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeLaunchConfigurationsInput, DescribeLaunchConfigurationsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeLifecycleHookTypes` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeLifecycleHookTypesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeLifecycleHookTypesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeLifecycleHookTypes(input: DescribeLifecycleHookTypesInput) async throws -> DescribeLifecycleHookTypesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeLifecycleHookTypesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeLifecycleHookTypesInput, DescribeLifecycleHookTypesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeLifecycleHooks` operation on the `AutoScaling` service.
    ///
    /// Gets information about the lifecycle hooks for the specified Auto Scaling group.
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeLifecycleHooksInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeLifecycleHooksOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeLifecycleHooks(input: DescribeLifecycleHooksInput) async throws -> DescribeLifecycleHooksOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeLifecycleHooksOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeLifecycleHooksInput, DescribeLifecycleHooksOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeLoadBalancerTargetGroups` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeLoadBalancerTargetGroupsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeLoadBalancerTargetGroupsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeLoadBalancerTargetGroups(input: DescribeLoadBalancerTargetGroupsInput) async throws -> DescribeLoadBalancerTargetGroupsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeLoadBalancerTargetGroupsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeLoadBalancerTargetGroupsInput, DescribeLoadBalancerTargetGroupsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeLoadBalancers` operation on the `AutoScaling` service.
    ///
    ...
    public func describeLoadBalancers(input: DescribeLoadBalancersInput) async throws -> DescribeLoadBalancersOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeLoadBalancersInput, DescribeLoadBalancersOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeMetricCollectionTypes` operation on the `AutoScaling` service.
    ///
    /// Describes the available CloudWatch metrics for Amazon EC2 Auto Scaling.
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeMetricCollectionTypesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeMetricCollectionTypesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeMetricCollectionTypes(input: DescribeMetricCollectionTypesInput) async throws -> DescribeMetricCollectionTypesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeMetricCollectionTypesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeMetricCollectionTypesInput, DescribeMetricCollectionTypesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeNotificationConfigurations` operation on the `AutoScaling` service.
    ///
    /// Gets information about the Amazon SNS notifications that are configured for one or more Auto Scaling groups.
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeNotificationConfigurationsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeNotificationConfigurationsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeNotificationConfigurations(input: DescribeNotificationConfigurationsInput) async throws -> DescribeNotificationConfigurationsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeNotificationConfigurationsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeNotificationConfigurationsInput, DescribeNotificationConfigurationsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribePolicies` operation on the `AutoScaling` service.
    ///
    /// Gets information about the scaling policies in the account and Region.
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribePoliciesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribePoliciesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describePolicies(input: DescribePoliciesInput) async throws -> DescribePoliciesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribePoliciesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribePoliciesInput, DescribePoliciesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeScalingActivities` operation on the `AutoScaling` service.
    ///
    ...
    public func describeScalingActivities(input: DescribeScalingActivitiesInput) async throws -> DescribeScalingActivitiesOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeScalingActivitiesInput, DescribeScalingActivitiesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeScalingProcessTypes` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeScalingProcessTypesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeScalingProcessTypesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeScalingProcessTypes(input: DescribeScalingProcessTypesInput) async throws -> DescribeScalingProcessTypesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeScalingProcessTypesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeScalingProcessTypesInput, DescribeScalingProcessTypesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeScheduledActions` operation on the `AutoScaling` service.
    ///
    ...
    public func describeScheduledActions(input: DescribeScheduledActionsInput) async throws -> DescribeScheduledActionsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeScheduledActionsInput, DescribeScheduledActionsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeTags` operation on the `AutoScaling` service.
    ///
    ...
    public func describeTags(input: DescribeTagsInput) async throws -> DescribeTagsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeTagsInput, DescribeTagsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeTerminationPolicyTypes` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeTerminationPolicyTypesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeTerminationPolicyTypesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeTerminationPolicyTypes(input: DescribeTerminationPolicyTypesInput) async throws -> DescribeTerminationPolicyTypesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeTerminationPolicyTypesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeTerminationPolicyTypesInput, DescribeTerminationPolicyTypesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeTrafficSources` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeTrafficSourcesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeTrafficSourcesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeTrafficSources(input: DescribeTrafficSourcesInput) async throws -> DescribeTrafficSourcesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeTrafficSourcesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeTrafficSourcesInput, DescribeTrafficSourcesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DescribeWarmPool` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeWarmPoolInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeWarmPoolOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeWarmPool(input: DescribeWarmPoolInput) async throws -> DescribeWarmPoolOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeWarmPoolOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeWarmPoolInput, DescribeWarmPoolOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DetachInstances` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DetachInstancesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DetachInstancesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func detachInstances(input: DetachInstancesInput) async throws -> DetachInstancesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DetachInstancesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DetachInstancesInput, DetachInstancesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DetachLoadBalancerTargetGroups` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DetachLoadBalancerTargetGroupsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DetachLoadBalancerTargetGroupsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func detachLoadBalancerTargetGroups(input: DetachLoadBalancerTargetGroupsInput) async throws -> DetachLoadBalancerTargetGroupsOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DetachLoadBalancerTargetGroupsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DetachLoadBalancerTargetGroupsInput, DetachLoadBalancerTargetGroupsOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DetachLoadBalancers` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DetachLoadBalancersInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DetachLoadBalancersOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func detachLoadBalancers(input: DetachLoadBalancersInput) async throws -> DetachLoadBalancersOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DetachLoadBalancersOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DetachLoadBalancersInput, DetachLoadBalancersOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DetachTrafficSources` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DetachTrafficSourcesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DetachTrafficSourcesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func detachTrafficSources(input: DetachTrafficSourcesInput) async throws -> DetachTrafficSourcesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DetachTrafficSourcesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DetachTrafficSourcesInput, DetachTrafficSourcesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `DisableMetricsCollection` operation on the `AutoScaling` service.
    ///
    /// Disables group metrics collection for the specified Auto Scaling group.
    ///
    /// - Parameter input: [no documentation found] (Type: `DisableMetricsCollectionInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DisableMetricsCollectionOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func disableMetricsCollection(input: DisableMetricsCollectionInput) async throws -> DisableMetricsCollectionOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DisableMetricsCollectionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DisableMetricsCollectionInput, DisableMetricsCollectionOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `EnableMetricsCollection` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `EnableMetricsCollectionInput`)
    ///
    /// - Returns: [no documentation found] (Type: `EnableMetricsCollectionOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func enableMetricsCollection(input: EnableMetricsCollectionInput) async throws -> EnableMetricsCollectionOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<EnableMetricsCollectionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<EnableMetricsCollectionInput, EnableMetricsCollectionOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `EnterStandby` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `EnterStandbyInput`)
    ///
    /// - Returns: [no documentation found] (Type: `EnterStandbyOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func enterStandby(input: EnterStandbyInput) async throws -> EnterStandbyOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<EnterStandbyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<EnterStandbyInput, EnterStandbyOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `ExecutePolicy` operation on the `AutoScaling` service.
    ///
    /// Executes the specified policy. This can be useful for testing the design of your scaling policy.
    ///
    /// - Parameter input: [no documentation found] (Type: `ExecutePolicyInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ExecutePolicyOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func executePolicy(input: ExecutePolicyInput) async throws -> ExecutePolicyOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ExecutePolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ExecutePolicyInput, ExecutePolicyOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `ExitStandby` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `ExitStandbyInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ExitStandbyOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func exitStandby(input: ExitStandbyInput) async throws -> ExitStandbyOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ExitStandbyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ExitStandbyInput, ExitStandbyOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `GetPredictiveScalingForecast` operation on the `AutoScaling` service.
    ///
    ...
    public func getPredictiveScalingForecast(input: GetPredictiveScalingForecastInput) async throws -> GetPredictiveScalingForecastOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetPredictiveScalingForecastInput, GetPredictiveScalingForecastOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `LaunchInstances` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `LaunchInstancesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `LaunchInstancesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    /// - `IdempotentCallInProgressFault` : The service is currently processing another request with the same client token. Retry the request with the same client token—the in-flight operation will complete and return its result.
    /// - `IdempotentParameterMismatchError` : Indicates that the parameters in the current request do not match the parameters from a previous request with the same client token within the idempotency window.
    /// - `ResourceContentionFault` : You already have a pending update to an Amazon EC2 Auto Scaling resource (for example, an Auto Scaling group, instance, or load balancer).
    public func launchInstances(input: LaunchInstancesInput) async throws -> LaunchInstancesOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "launchInstances")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<LaunchInstancesInput, LaunchInstancesOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.IdempotencyTokenMiddleware<LaunchInstancesInput, LaunchInstancesOutput>(keyPath: \.clientToken))
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<LaunchInstancesInput, LaunchInstancesOutput>(LaunchInstancesInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<LaunchInstancesInput, LaunchInstancesOutput>())
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<LaunchInstancesInput, LaunchInstancesOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<LaunchInstancesOutput>(LaunchInstancesOutput.httpOutput(from:), LaunchInstancesOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<LaunchInstancesInput, LaunchInstancesOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<LaunchInstancesOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Auto Scaling", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<LaunchInstancesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.serialize(ClientRuntime.BodyMiddleware<LaunchInstancesInput, LaunchInstancesOutput, SmithyFormURL.Writer>(rootNodeInfo: "", inputWritingClosure: LaunchInstancesInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<LaunchInstancesInput, LaunchInstancesOutput>(contentType: "application/x-www-form-urlencoded"))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<LaunchInstancesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<LaunchInstancesInput, LaunchInstancesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<LaunchInstancesInput, LaunchInstancesOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<LaunchInstancesInput, LaunchInstancesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "LaunchInstances")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `PutLifecycleHook` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `PutLifecycleHookInput`)
    ///
    /// - Returns: [no documentation found] (Type: `PutLifecycleHookOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func putLifecycleHook(input: PutLifecycleHookInput) async throws -> PutLifecycleHookOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutLifecycleHookOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutLifecycleHookInput, PutLifecycleHookOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `PutNotificationConfiguration` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `PutNotificationConfigurationInput`)
    ///
    /// - Returns: [no documentation found] (Type: `PutNotificationConfigurationOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func putNotificationConfiguration(input: PutNotificationConfigurationInput) async throws -> PutNotificationConfigurationOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutNotificationConfigurationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutNotificationConfigurationInput, PutNotificationConfigurationOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `PutScalingPolicy` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Returns: Contains the output of PutScalingPolicy. (Type: `PutScalingPolicyOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func putScalingPolicy(input: PutScalingPolicyInput) async throws -> PutScalingPolicyOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutScalingPolicyInput, PutScalingPolicyOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `PutScheduledUpdateGroupAction` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `PutScheduledUpdateGroupActionInput`)
    ///
    /// - Returns: [no documentation found] (Type: `PutScheduledUpdateGroupActionOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func putScheduledUpdateGroupAction(input: PutScheduledUpdateGroupActionInput) async throws -> PutScheduledUpdateGroupActionOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutScheduledUpdateGroupActionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutScheduledUpdateGroupActionInput, PutScheduledUpdateGroupActionOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `PutWarmPool` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `PutWarmPoolInput`)
    ///
    /// - Returns: [no documentation found] (Type: `PutWarmPoolOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func putWarmPool(input: PutWarmPoolInput) async throws -> PutWarmPoolOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutWarmPoolOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutWarmPoolInput, PutWarmPoolOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `RecordLifecycleActionHeartbeat` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `RecordLifecycleActionHeartbeatInput`)
    ///
    /// - Returns: [no documentation found] (Type: `RecordLifecycleActionHeartbeatOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func recordLifecycleActionHeartbeat(input: RecordLifecycleActionHeartbeatInput) async throws -> RecordLifecycleActionHeartbeatOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<RecordLifecycleActionHeartbeatOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RecordLifecycleActionHeartbeatInput, RecordLifecycleActionHeartbeatOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `ResumeProcesses` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `ResumeProcessesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `ResumeProcessesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func resumeProcesses(input: ResumeProcessesInput) async throws -> ResumeProcessesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ResumeProcessesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ResumeProcessesInput, ResumeProcessesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `RollbackInstanceRefresh` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `RollbackInstanceRefreshInput`)
    ///
    /// - Returns: [no documentation found] (Type: `RollbackInstanceRefreshOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func rollbackInstanceRefresh(input: RollbackInstanceRefreshInput) async throws -> RollbackInstanceRefreshOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<RollbackInstanceRefreshOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RollbackInstanceRefreshInput, RollbackInstanceRefreshOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `SetDesiredCapacity` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `SetDesiredCapacityInput`)
    ///
    /// - Returns: [no documentation found] (Type: `SetDesiredCapacityOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func setDesiredCapacity(input: SetDesiredCapacityInput) async throws -> SetDesiredCapacityOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SetDesiredCapacityOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SetDesiredCapacityInput, SetDesiredCapacityOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `SetInstanceHealth` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `SetInstanceHealthInput`)
    ///
    /// - Returns: [no documentation found] (Type: `SetInstanceHealthOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func setInstanceHealth(input: SetInstanceHealthInput) async throws -> SetInstanceHealthOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SetInstanceHealthOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SetInstanceHealthInput, SetInstanceHealthOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `SetInstanceProtection` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `SetInstanceProtectionInput`)
    ///
    /// - Returns: [no documentation found] (Type: `SetInstanceProtectionOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func setInstanceProtection(input: SetInstanceProtectionInput) async throws -> SetInstanceProtectionOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SetInstanceProtectionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SetInstanceProtectionInput, SetInstanceProtectionOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `StartInstanceRefresh` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `StartInstanceRefreshInput`)
    ///
    /// - Returns: [no documentation found] (Type: `StartInstanceRefreshOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func startInstanceRefresh(input: StartInstanceRefreshInput) async throws -> StartInstanceRefreshOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<StartInstanceRefreshOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<StartInstanceRefreshInput, StartInstanceRefreshOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    public func suspendProcesses(input: SuspendProcessesInput) async throws -> SuspendProcessesOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SuspendProcessesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SuspendProcessesInput, SuspendProcessesOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `TerminateInstanceInAutoScalingGroup` operation on the `AutoScaling` service.
    ///
    /// Terminates the specified instance and optionally adjusts the desired group size. This operation cannot be called on instances in a warm pool. This call simply makes a termination request. The instances are not terminated immediately. When an instance is terminated, the instance status changes to terminated. You can't connect to or start an instance after you've terminated it. If you do not specify the option to decrement the desired capacity, Amazon EC2 Auto Scaling launches instances to replace the ones that are terminated. To terminate multiple instances in a single call, use the InstanceIds and AutoScalingGroupName parameters instead of InstanceId. When terminating multiple instances, the response populates Activities instead of Activity. By default, Amazon EC2 Auto Scaling balances instances across all Availability Zones. If you decrement the desired capacity, your Auto Scaling group can become unbalanced between Availability Zones. Amazon EC2 Auto Scaling tries to rebalance the group, and rebalancing might terminate instances in other zones. For more information, see [Manual scaling](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-scaling-manually.html) in the Amazon EC2 Auto Scaling User Guide.
    ///
    /// - Parameter input: [no documentation found] (Type: `TerminateInstanceInAutoScalingGroupInput`)
    ///
    /// - Returns: [no documentation found] (Type: `TerminateInstanceInAutoScalingGroupOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func terminateInstanceInAutoScalingGroup(input: TerminateInstanceInAutoScalingGroupInput) async throws -> TerminateInstanceInAutoScalingGroupOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<TerminateInstanceInAutoScalingGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TerminateInstanceInAutoScalingGroupInput, TerminateInstanceInAutoScalingGroupOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
    ...
    /// Performs the `UpdateAutoScalingGroup` operation on the `AutoScaling` service.
    ///
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `UpdateAutoScalingGroupInput`)
    ///
    /// - Returns: [no documentation found] (Type: `UpdateAutoScalingGroupOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func updateAutoScalingGroup(input: UpdateAutoScalingGroupInput) async throws -> UpdateAutoScalingGroupOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateAutoScalingGroupOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateAutoScalingGroupInput, UpdateAutoScalingGroupOutput>(serviceID: serviceName, version: AutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "AutoScaling")
