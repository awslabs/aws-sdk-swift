...
extension AutoScalingClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> AutoScalingClient.AutoScalingClientConfiguration {
        let clientConfiguration = try await AutoScalingClient.AutoScalingClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> AutoScalingClient {
            let configuration = try await resolve(plugins: self.plugins)
            return AutoScalingClient(config: configuration)
        }
    }
...
extension AutoScalingClient.AutoScalingClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
