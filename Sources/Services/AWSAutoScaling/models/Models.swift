...
extension AutoScalingClientTypes.AcceleratorCountRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.AcceleratorCountRequest {
...
extension AutoScalingClientTypes.AcceleratorTotalMemoryMiBRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.AcceleratorTotalMemoryMiBRequest {
...
extension AutoScalingClientTypes.Activity: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.Activity {
...
extension AutoScalingClientTypes.AdjustmentType: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.AdjustmentType {
...
extension AutoScalingClientTypes.Alarm: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.Alarm {
...
extension AutoScalingClientTypes.AlarmSpecification: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.AlarmSpecification {
        var value = AutoScalingClientTypes.AlarmSpecification()
        value.alarms = try reader["Alarms"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension AttachInstancesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AttachInstancesOutput {
        let reader = responseReader["AttachInstancesResult"]
        var value = AttachInstancesOutput()
        return value
    }
}
...
extension AttachLoadBalancerTargetGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AttachLoadBalancerTargetGroupsOutput {
        let reader = responseReader["AttachLoadBalancerTargetGroupsResult"]
        var value = AttachLoadBalancerTargetGroupsOutput()
        return value
    }
}
...
extension AttachLoadBalancersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AttachLoadBalancersOutput {
        let reader = responseReader["AttachLoadBalancersResult"]
        var value = AttachLoadBalancersOutput()
        return value
    }
}
...
extension AttachTrafficSourcesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AttachTrafficSourcesOutput {
        let reader = responseReader["AttachTrafficSourcesResult"]
        var value = AttachTrafficSourcesOutput()
        return value
    }
}
...
extension AutoScalingClientTypes.AutoScalingGroup: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.AutoScalingGroup {
        ...
        value.launchTemplate = try reader["LaunchTemplate"].readIfPresent(readingClosure: AutoScalingClientTypes.LaunchTemplateSpecification.readingClosure(from:))
        value.mixedInstancesPolicy = try reader["MixedInstancesPolicy"].readIfPresent(readingClosure: AutoScalingClientTypes.MixedInstancesPolicy.readingClosure(from:))
        ...
        value.loadBalancerNames = try reader["LoadBalancerNames"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.targetGroupARNs = try reader["TargetGroupARNs"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.instances = try reader["Instances"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.Instance.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.createdTime = try reader["CreatedTime"].readTimestampIfPresent(format: .dateTime)
        value.suspendedProcesses = try reader["SuspendedProcesses"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.SuspendedProcess.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.enabledMetrics = try reader["EnabledMetrics"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.EnabledMetric.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["Status"].readIfPresent()
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.TagDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.terminationPolicies = try reader["TerminationPolicies"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.warmPoolConfiguration = try reader["WarmPoolConfiguration"].readIfPresent(readingClosure: AutoScalingClientTypes.WarmPoolConfiguration.readingClosure(from:))
        ...
        value.trafficSources = try reader["TrafficSources"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.TrafficSourceIdentifier.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.instanceMaintenancePolicy = try reader["InstanceMaintenancePolicy"].readIfPresent(readingClosure: AutoScalingClientTypes.InstanceMaintenancePolicy.readingClosure(from:))
        return value
    }
}
...
extension AutoScalingClientTypes.AutoScalingInstanceDetails: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.AutoScalingInstanceDetails {
...
extension AutoScalingClientTypes.BaselineEbsBandwidthMbpsRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.BaselineEbsBandwidthMbpsRequest {
...
extension BatchDeleteScheduledActionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> BatchDeleteScheduledActionOutput {
        let reader = responseReader["BatchDeleteScheduledActionResult"]
        var value = BatchDeleteScheduledActionOutput()
        value.failedScheduledActions = try reader["FailedScheduledActions"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.FailedScheduledUpdateGroupActionRequest.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BatchPutScheduledUpdateGroupActionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> BatchPutScheduledUpdateGroupActionOutput {
        let reader = responseReader["BatchPutScheduledUpdateGroupActionResult"]
        var value = BatchPutScheduledUpdateGroupActionOutput()
        value.failedScheduledUpdateGroupActions = try reader["FailedScheduledUpdateGroupActions"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.FailedScheduledUpdateGroupActionRequest.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension AutoScalingClientTypes.BlockDeviceMapping: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.BlockDeviceMapping {
        ...
        value.ebs = try reader["Ebs"].readIfPresent(readingClosure: AutoScalingClientTypes.Ebs.readingClosure(from:))
...
extension CancelInstanceRefreshOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CancelInstanceRefreshOutput {
...
extension AutoScalingClientTypes.CapacityForecast: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.CapacityForecast {
        ...
        value.values = try reader["Values"].readListIfPresent(memberReadingClosure: Swift.Double.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CompleteLifecycleActionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CompleteLifecycleActionOutput {
        let reader = responseReader["CompleteLifecycleActionResult"]
        var value = CompleteLifecycleActionOutput()
        return value
    }
}
...
extension CreateAutoScalingGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateAutoScalingGroupOutput {
        let reader = responseReader["CreateAutoScalingGroupResult"]
        var value = CreateAutoScalingGroupOutput()
        return value
    }
}
...
extension CreateLaunchConfigurationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateLaunchConfigurationOutput {
        let reader = responseReader["CreateLaunchConfigurationResult"]
        var value = CreateLaunchConfigurationOutput()
        return value
    }
}
...
extension CreateOrUpdateTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateOrUpdateTagsOutput {
        let reader = responseReader["CreateOrUpdateTagsResult"]
        var value = CreateOrUpdateTagsOutput()
        return value
    }
}
...
extension AutoScalingClientTypes.CustomizedMetricSpecification: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.CustomizedMetricSpecification {
        var value = AutoScalingClientTypes.CustomizedMetricSpecification()
        value.metricName = try reader["MetricName"].readIfPresent()
        value.namespace = try reader["Namespace"].readIfPresent()
        value.dimensions = try reader["Dimensions"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.MetricDimension.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.statistic = try reader["Statistic"].readIfPresent()
        value.unit = try reader["Unit"].readIfPresent()
        value.metrics = try reader["Metrics"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.TargetTrackingMetricDataQuery.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DeleteAutoScalingGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteAutoScalingGroupOutput {
        let reader = responseReader["DeleteAutoScalingGroupResult"]
        var value = DeleteAutoScalingGroupOutput()
        return value
    }
}
...
extension DeleteLaunchConfigurationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteLaunchConfigurationOutput {
        let reader = responseReader["DeleteLaunchConfigurationResult"]
        var value = DeleteLaunchConfigurationOutput()
        return value
    }
}
...
extension DeleteLifecycleHookOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteLifecycleHookOutput {
        let reader = responseReader["DeleteLifecycleHookResult"]
        var value = DeleteLifecycleHookOutput()
        return value
    }
}
...
extension DeleteNotificationConfigurationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteNotificationConfigurationOutput {
        let reader = responseReader["DeleteNotificationConfigurationResult"]
        var value = DeleteNotificationConfigurationOutput()
        return value
    }
}
...
extension DeletePolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeletePolicyOutput {
        let reader = responseReader["DeletePolicyResult"]
...
extension DeleteScheduledActionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteScheduledActionOutput {
        let reader = responseReader["DeleteScheduledActionResult"]
...
extension DeleteTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteTagsOutput {
        let reader = responseReader["DeleteTagsResult"]
...
extension DeleteWarmPoolOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteWarmPoolOutput {
        let reader = responseReader["DeleteWarmPoolResult"]
        var value = DeleteWarmPoolOutput()
        return value
    }
}
...
extension DescribeAdjustmentTypesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAdjustmentTypesOutput {
        let reader = responseReader["DescribeAdjustmentTypesResult"]
        var value = DescribeAdjustmentTypesOutput()
        value.adjustmentTypes = try reader["AdjustmentTypes"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.AdjustmentType.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeAutoScalingGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAutoScalingGroupsOutput {
        let reader = responseReader["DescribeAutoScalingGroupsResult"]
        var value = DescribeAutoScalingGroupsOutput()
        value.autoScalingGroups = try reader["AutoScalingGroups"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.AutoScalingGroup.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeAutoScalingInstancesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAutoScalingInstancesOutput {
        let reader = responseReader["DescribeAutoScalingInstancesResult"]
        var value = DescribeAutoScalingInstancesOutput()
        value.autoScalingInstances = try reader["AutoScalingInstances"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.AutoScalingInstanceDetails.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension DescribeAutoScalingNotificationTypesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAutoScalingNotificationTypesOutput {
        let reader = responseReader["DescribeAutoScalingNotificationTypesResult"]
        var value = DescribeAutoScalingNotificationTypesOutput()
        value.autoScalingNotificationTypes = try reader["AutoScalingNotificationTypes"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeInstanceRefreshesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeInstanceRefreshesOutput {
        let reader = responseReader["DescribeInstanceRefreshesResult"]
        var value = DescribeInstanceRefreshesOutput()
        value.instanceRefreshes = try reader["InstanceRefreshes"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.InstanceRefresh.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension DescribeLaunchConfigurationsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeLaunchConfigurationsOutput {
        let reader = responseReader["DescribeLaunchConfigurationsResult"]
        var value = DescribeLaunchConfigurationsOutput()
        value.launchConfigurations = try reader["LaunchConfigurations"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.LaunchConfiguration.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension DescribeLifecycleHookTypesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeLifecycleHookTypesOutput {
        let reader = responseReader["DescribeLifecycleHookTypesResult"]
        var value = DescribeLifecycleHookTypesOutput()
        value.lifecycleHookTypes = try reader["LifecycleHookTypes"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeLifecycleHooksOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeLifecycleHooksOutput {
        let reader = responseReader["DescribeLifecycleHooksResult"]
        var value = DescribeLifecycleHooksOutput()
        value.lifecycleHooks = try reader["LifecycleHooks"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.LifecycleHook.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeLoadBalancerTargetGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeLoadBalancerTargetGroupsOutput {
        let reader = responseReader["DescribeLoadBalancerTargetGroupsResult"]
        var value = DescribeLoadBalancerTargetGroupsOutput()
        value.loadBalancerTargetGroups = try reader["LoadBalancerTargetGroups"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.LoadBalancerTargetGroupState.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension DescribeLoadBalancersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeLoadBalancersOutput {
        ...
        value.loadBalancers = try reader["LoadBalancers"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.LoadBalancerState.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension DescribeMetricCollectionTypesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeMetricCollectionTypesOutput {
        let reader = responseReader["DescribeMetricCollectionTypesResult"]
        var value = DescribeMetricCollectionTypesOutput()
        value.granularities = try reader["Granularities"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.MetricGranularityType.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.metrics = try reader["Metrics"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.MetricCollectionType.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeNotificationConfigurationsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeNotificationConfigurationsOutput {
        let reader = responseReader["DescribeNotificationConfigurationsResult"]
        var value = DescribeNotificationConfigurationsOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.notificationConfigurations = try reader["NotificationConfigurations"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.NotificationConfiguration.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribePoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribePoliciesOutput {
        let reader = responseReader["DescribePoliciesResult"]
        var value = DescribePoliciesOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.scalingPolicies = try reader["ScalingPolicies"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.ScalingPolicy.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeScalingActivitiesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeScalingActivitiesOutput {
        let reader = responseReader["DescribeScalingActivitiesResult"]
        var value = DescribeScalingActivitiesOutput()
        value.activities = try reader["Activities"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.Activity.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextToken = try reader["NextToken"].readIfPresent()
        return value
    }
}
...
extension DescribeScalingProcessTypesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeScalingProcessTypesOutput {
        let reader = responseReader["DescribeScalingProcessTypesResult"]
        var value = DescribeScalingProcessTypesOutput()
        value.processes = try reader["Processes"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.ProcessType.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeScheduledActionsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeScheduledActionsOutput {
        let reader = responseReader["DescribeScheduledActionsResult"]
        var value = DescribeScheduledActionsOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.scheduledUpdateGroupActions = try reader["ScheduledUpdateGroupActions"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.ScheduledUpdateGroupAction.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeTerminationPolicyTypesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeTerminationPolicyTypesOutput {
        let reader = responseReader["DescribeTerminationPolicyTypesResult"]
        var value = DescribeTerminationPolicyTypesOutput()
        value.terminationPolicyTypes = try reader["TerminationPolicyTypes"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeTrafficSourcesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeTrafficSourcesOutput {
        let reader = responseReader["DescribeTrafficSourcesResult"]
        var value = DescribeTrafficSourcesOutput()
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.trafficSources = try reader["TrafficSources"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.TrafficSourceState.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeWarmPoolOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeWarmPoolOutput {
...
extension AutoScalingClientTypes.DesiredConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.DesiredConfiguration {
...
extension DetachInstancesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DetachInstancesOutput {
...
extension DetachLoadBalancerTargetGroupsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DetachLoadBalancerTargetGroupsOutput {
        let reader = responseReader["DetachLoadBalancerTargetGroupsResult"]
        var value = DetachLoadBalancerTargetGroupsOutput()
        return value
    }
}
...
extension DetachLoadBalancersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DetachLoadBalancersOutput {
        let reader = responseReader["DetachLoadBalancersResult"]
        var value = DetachLoadBalancersOutput()
        return value
    }
}
...
extension DetachTrafficSourcesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DetachTrafficSourcesOutput {
        let reader = responseReader["DetachTrafficSourcesResult"]
        var value = DetachTrafficSourcesOutput()
        return value
    }
}
...
extension DisableMetricsCollectionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DisableMetricsCollectionOutput {
        let reader = responseReader["DisableMetricsCollectionResult"]
        var value = DisableMetricsCollectionOutput()
        return value
    }
}
...
extension AutoScalingClientTypes.Ebs: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.Ebs {
...
extension EnableMetricsCollectionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> EnableMetricsCollectionOutput {
        let reader = responseReader["EnableMetricsCollectionResult"]
        var value = EnableMetricsCollectionOutput()
        return value
    }
}
...
extension AutoScalingClientTypes.EnabledMetric: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.EnabledMetric {
...
extension EnterStandbyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> EnterStandbyOutput {
...
extension ExecutePolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ExecutePolicyOutput {
        let reader = responseReader["ExecutePolicyResult"]
        var value = ExecutePolicyOutput()
        return value
    }
}
...
extension ExitStandbyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ExitStandbyOutput {
...
extension AutoScalingClientTypes.FailedScheduledUpdateGroupActionRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.FailedScheduledUpdateGroupActionRequest {
...
extension AutoScalingClientTypes.Filter: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.Filter {
...
extension GetPredictiveScalingForecastOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> GetPredictiveScalingForecastOutput {
        let reader = responseReader["GetPredictiveScalingForecastResult"]
        var value = GetPredictiveScalingForecastOutput()
        value.capacityForecast = try reader["CapacityForecast"].readIfPresent(readingClosure: AutoScalingClientTypes.CapacityForecast.readingClosure(from:))
        value.loadForecast = try reader["LoadForecast"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.LoadForecast.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AutoScalingClientTypes.Instance: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.Instance {
...
extension AutoScalingClientTypes.InstanceMaintenancePolicy: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstanceMaintenancePolicy {
...
extension AutoScalingClientTypes.InstanceMetadataOptions: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstanceMetadataOptions {
...
extension AutoScalingClientTypes.InstanceMonitoring: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstanceMonitoring {
...
extension AutoScalingClientTypes.InstanceRefresh: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstanceRefresh {
        ...
        value.progressDetails = try reader["ProgressDetails"].readIfPresent(readingClosure: AutoScalingClientTypes.InstanceRefreshProgressDetails.readingClosure(from:))
        value.preferences = try reader["Preferences"].readIfPresent(readingClosure: AutoScalingClientTypes.RefreshPreferences.readingClosure(from:))
        value.desiredConfiguration = try reader["DesiredConfiguration"].readIfPresent(readingClosure: AutoScalingClientTypes.DesiredConfiguration.readingClosure(from:))
        value.rollbackDetails = try reader["RollbackDetails"].readIfPresent(readingClosure: AutoScalingClientTypes.RollbackDetails.readingClosure(from:))
        return value
    }
}
...
extension AutoScalingClientTypes.InstanceRefreshLivePoolProgress: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstanceRefreshLivePoolProgress {
...
extension AutoScalingClientTypes.InstanceRefreshProgressDetails: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstanceRefreshProgressDetails {
        var value = AutoScalingClientTypes.InstanceRefreshProgressDetails()
        value.livePoolProgress = try reader["LivePoolProgress"].readIfPresent(readingClosure: AutoScalingClientTypes.InstanceRefreshLivePoolProgress.readingClosure(from:))
        value.warmPoolProgress = try reader["WarmPoolProgress"].readIfPresent(readingClosure: AutoScalingClientTypes.InstanceRefreshWarmPoolProgress.readingClosure(from:))
        return value
    }
}
...
extension AutoScalingClientTypes.InstanceRefreshWarmPoolProgress: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstanceRefreshWarmPoolProgress {
...
extension AutoScalingClientTypes.InstanceRequirements: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstanceRequirements {
        var value = AutoScalingClientTypes.InstanceRequirements()
        value.vCpuCount = try reader["VCpuCount"].readIfPresent(readingClosure: AutoScalingClientTypes.VCpuCountRequest.readingClosure(from:))
        value.memoryMiB = try reader["MemoryMiB"].readIfPresent(readingClosure: AutoScalingClientTypes.MemoryMiBRequest.readingClosure(from:))
        value.cpuManufacturers = try reader["CpuManufacturers"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.CpuManufacturer.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.memoryGiBPerVCpu = try reader["MemoryGiBPerVCpu"].readIfPresent(readingClosure: AutoScalingClientTypes.MemoryGiBPerVCpuRequest.readingClosure(from:))
        value.excludedInstanceTypes = try reader["ExcludedInstanceTypes"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.instanceGenerations = try reader["InstanceGenerations"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.InstanceGeneration.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.networkInterfaceCount = try reader["NetworkInterfaceCount"].readIfPresent(readingClosure: AutoScalingClientTypes.NetworkInterfaceCountRequest.readingClosure(from:))
        value.localStorage = try reader["LocalStorage"].readIfPresent()
        value.localStorageTypes = try reader["LocalStorageTypes"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.LocalStorageType.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.totalLocalStorageGB = try reader["TotalLocalStorageGB"].readIfPresent(readingClosure: AutoScalingClientTypes.TotalLocalStorageGBRequest.readingClosure(from:))
        value.baselineEbsBandwidthMbps = try reader["BaselineEbsBandwidthMbps"].readIfPresent(readingClosure: AutoScalingClientTypes.BaselineEbsBandwidthMbpsRequest.readingClosure(from:))
        value.acceleratorTypes = try reader["AcceleratorTypes"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.AcceleratorType.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.acceleratorCount = try reader["AcceleratorCount"].readIfPresent(readingClosure: AutoScalingClientTypes.AcceleratorCountRequest.readingClosure(from:))
        value.acceleratorManufacturers = try reader["AcceleratorManufacturers"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.AcceleratorManufacturer.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.acceleratorNames = try reader["AcceleratorNames"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.AcceleratorName.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.acceleratorTotalMemoryMiB = try reader["AcceleratorTotalMemoryMiB"].readIfPresent(readingClosure: AutoScalingClientTypes.AcceleratorTotalMemoryMiBRequest.readingClosure(from:))
        value.networkBandwidthGbps = try reader["NetworkBandwidthGbps"].readIfPresent(readingClosure: AutoScalingClientTypes.NetworkBandwidthGbpsRequest.readingClosure(from:))
        value.allowedInstanceTypes = try reader["AllowedInstanceTypes"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension AutoScalingClientTypes.InstanceReusePolicy: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstanceReusePolicy {
...
extension AutoScalingClientTypes.InstancesDistribution: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.InstancesDistribution {
...
extension AutoScalingClientTypes.LaunchConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LaunchConfiguration {
        ...
        value.classicLinkVPCSecurityGroups = try reader["ClassicLinkVPCSecurityGroups"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.blockDeviceMappings = try reader["BlockDeviceMappings"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.BlockDeviceMapping.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.instanceMonitoring = try reader["InstanceMonitoring"].readIfPresent(readingClosure: AutoScalingClientTypes.InstanceMonitoring.readingClosure(from:))
        ...
        value.metadataOptions = try reader["MetadataOptions"].readIfPresent(readingClosure: AutoScalingClientTypes.InstanceMetadataOptions.readingClosure(from:))
        return value
    }
}
...
extension AutoScalingClientTypes.LaunchTemplate: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LaunchTemplate {
        var value = AutoScalingClientTypes.LaunchTemplate()
        value.launchTemplateSpecification = try reader["LaunchTemplateSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.LaunchTemplateSpecification.readingClosure(from:))
        value.overrides = try reader["Overrides"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.LaunchTemplateOverrides.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension AutoScalingClientTypes.LaunchTemplateOverrides: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LaunchTemplateOverrides {
        var value = AutoScalingClientTypes.LaunchTemplateOverrides()
        value.instanceType = try reader["InstanceType"].readIfPresent()
        value.weightedCapacity = try reader["WeightedCapacity"].readIfPresent()
        value.launchTemplateSpecification = try reader["LaunchTemplateSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.LaunchTemplateSpecification.readingClosure(from:))
        value.instanceRequirements = try reader["InstanceRequirements"].readIfPresent(readingClosure: AutoScalingClientTypes.InstanceRequirements.readingClosure(from:))
        return value
    }
}
...
extension AutoScalingClientTypes.LaunchTemplateSpecification: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LaunchTemplateSpecification {
...
extension AutoScalingClientTypes.LifecycleHook: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LifecycleHook {
...
extension AutoScalingClientTypes.LifecycleHookSpecification: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LifecycleHookSpecification {
...
extension AutoScalingClientTypes.LoadBalancerState: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LoadBalancerState {
...
extension AutoScalingClientTypes.LoadBalancerTargetGroupState: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LoadBalancerTargetGroupState {
...
extension AutoScalingClientTypes.LoadForecast: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.LoadForecast {
        var value = AutoScalingClientTypes.LoadForecast()
        value.timestamps = try reader["Timestamps"].readListIfPresent(memberReadingClosure: SmithyXML.timestampReadingClosure(format: .dateTime), memberNodeInfo: "member", isFlattened: false)
        value.values = try reader["Values"].readListIfPresent(memberReadingClosure: Swift.Double.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.metricSpecification = try reader["MetricSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.PredictiveScalingMetricSpecification.readingClosure(from:))
        return value
    }
}
...
extension AutoScalingClientTypes.MemoryGiBPerVCpuRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.MemoryGiBPerVCpuRequest {
...
extension AutoScalingClientTypes.MemoryMiBRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.MemoryMiBRequest {
...
extension AutoScalingClientTypes.Metric: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.Metric {
...
extension AutoScalingClientTypes.MetricCollectionType: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.MetricCollectionType {
...
extension AutoScalingClientTypes.MetricDataQuery: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.MetricDataQuery {
        var value = AutoScalingClientTypes.MetricDataQuery()
        value.id = try reader["Id"].readIfPresent()
        value.expression = try reader["Expression"].readIfPresent()
        value.metricStat = try reader["MetricStat"].readIfPresent(readingClosure: AutoScalingClientTypes.MetricStat.readingClosure(from:))
...
extension AutoScalingClientTypes.MetricDimension: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.MetricDimension {
...
extension AutoScalingClientTypes.MetricGranularityType: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.MetricGranularityType {
...
extension AutoScalingClientTypes.MetricStat: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.MetricStat {
        var value = AutoScalingClientTypes.MetricStat()
        value.metric = try reader["Metric"].readIfPresent(readingClosure: AutoScalingClientTypes.Metric.readingClosure(from:))
...
extension AutoScalingClientTypes.MixedInstancesPolicy: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.MixedInstancesPolicy {
        var value = AutoScalingClientTypes.MixedInstancesPolicy()
        value.launchTemplate = try reader["LaunchTemplate"].readIfPresent(readingClosure: AutoScalingClientTypes.LaunchTemplate.readingClosure(from:))
        value.instancesDistribution = try reader["InstancesDistribution"].readIfPresent(readingClosure: AutoScalingClientTypes.InstancesDistribution.readingClosure(from:))
        return value
    }
}
...
extension AutoScalingClientTypes.NetworkBandwidthGbpsRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.NetworkBandwidthGbpsRequest {
...
extension AutoScalingClientTypes.NetworkInterfaceCountRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.NetworkInterfaceCountRequest {
...
extension AutoScalingClientTypes.NotificationConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.NotificationConfiguration {
...
extension AutoScalingClientTypes.PredefinedMetricSpecification: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.PredefinedMetricSpecification {
...
extension AutoScalingClientTypes.PredictiveScalingConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.PredictiveScalingConfiguration {
        var value = AutoScalingClientTypes.PredictiveScalingConfiguration()
        value.metricSpecifications = try reader["MetricSpecifications"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.PredictiveScalingMetricSpecification.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AutoScalingClientTypes.PredictiveScalingCustomizedCapacityMetric: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.PredictiveScalingCustomizedCapacityMetric {
        var value = AutoScalingClientTypes.PredictiveScalingCustomizedCapacityMetric()
        value.metricDataQueries = try reader["MetricDataQueries"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.MetricDataQuery.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension AutoScalingClientTypes.PredictiveScalingCustomizedLoadMetric: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.PredictiveScalingCustomizedLoadMetric {
...
extension AutoScalingClientTypes.PredictiveScalingCustomizedScalingMetric: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.PredictiveScalingCustomizedScalingMetric {
...
extension AutoScalingClientTypes.PredictiveScalingMetricSpecification: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.PredictiveScalingMetricSpecification {
        ...
        value.predefinedMetricPairSpecification = try reader["PredefinedMetricPairSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.PredictiveScalingPredefinedMetricPair.readingClosure(from:))
        value.predefinedScalingMetricSpecification = try reader["PredefinedScalingMetricSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.PredictiveScalingPredefinedScalingMetric.readingClosure(from:))
        value.predefinedLoadMetricSpecification = try reader["PredefinedLoadMetricSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.PredictiveScalingPredefinedLoadMetric.readingClosure(from:))
        value.customizedScalingMetricSpecification = try reader["CustomizedScalingMetricSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.PredictiveScalingCustomizedScalingMetric.readingClosure(from:))
        value.customizedLoadMetricSpecification = try reader["CustomizedLoadMetricSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.PredictiveScalingCustomizedLoadMetric.readingClosure(from:))
        value.customizedCapacityMetricSpecification = try reader["CustomizedCapacityMetricSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.PredictiveScalingCustomizedCapacityMetric.readingClosure(from:))
        return value
    }
}
...
extension AutoScalingClientTypes.PredictiveScalingPredefinedLoadMetric: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.PredictiveScalingPredefinedLoadMetric {
...
extension AutoScalingClientTypes.PredictiveScalingPredefinedMetricPair: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.PredictiveScalingPredefinedMetricPair {
...
extension AutoScalingClientTypes.PredictiveScalingPredefinedScalingMetric: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.PredictiveScalingPredefinedScalingMetric {
...
extension AutoScalingClientTypes.ProcessType: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.ProcessType {
...
extension PutLifecycleHookOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutLifecycleHookOutput {
        let reader = responseReader["PutLifecycleHookResult"]
        var value = PutLifecycleHookOutput()
        return value
    }
}
...
extension PutNotificationConfigurationOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutNotificationConfigurationOutput {
        let reader = responseReader["PutNotificationConfigurationResult"]
        var value = PutNotificationConfigurationOutput()
        return value
    }
}
...
extension PutScalingPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutScalingPolicyOutput {
        let reader = responseReader["PutScalingPolicyResult"]
        var value = PutScalingPolicyOutput()
        value.alarms = try reader["Alarms"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.Alarm.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension PutScheduledUpdateGroupActionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutScheduledUpdateGroupActionOutput {
        let reader = responseReader["PutScheduledUpdateGroupActionResult"]
        var value = PutScheduledUpdateGroupActionOutput()
        return value
    }
}
...
extension PutWarmPoolOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> PutWarmPoolOutput {
        let reader = responseReader["PutWarmPoolResult"]
        var value = PutWarmPoolOutput()
        return value
    }
}
...
extension RecordLifecycleActionHeartbeatOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RecordLifecycleActionHeartbeatOutput {
        let reader = responseReader["RecordLifecycleActionHeartbeatResult"]
        var value = RecordLifecycleActionHeartbeatOutput()
        return value
    }
}
...
extension AutoScalingClientTypes.RefreshPreferences: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.RefreshPreferences {
        var value = AutoScalingClientTypes.RefreshPreferences()
        value.minHealthyPercentage = try reader["MinHealthyPercentage"].readIfPresent()
        value.instanceWarmup = try reader["InstanceWarmup"].readIfPresent()
        value.checkpointPercentages = try reader["CheckpointPercentages"].readListIfPresent(memberReadingClosure: Swift.Int.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.alarmSpecification = try reader["AlarmSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.AlarmSpecification.readingClosure(from:))
        value.maxHealthyPercentage = try reader["MaxHealthyPercentage"].readIfPresent()
        return value
    }
}
...
extension ResumeProcessesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ResumeProcessesOutput {
        let reader = responseReader["ResumeProcessesResult"]
        var value = ResumeProcessesOutput()
        return value
    }
}
...
extension AutoScalingClientTypes.RollbackDetails: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.RollbackDetails {
        ...
        value.progressDetailsOnRollback = try reader["ProgressDetailsOnRollback"].readIfPresent(readingClosure: AutoScalingClientTypes.InstanceRefreshProgressDetails.readingClosure(from:))
        return value
    }
}
...
extension RollbackInstanceRefreshOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RollbackInstanceRefreshOutput {
...
extension AutoScalingClientTypes.ScalingPolicy: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.ScalingPolicy {
        ...
        value.stepAdjustments = try reader["StepAdjustments"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.StepAdjustment.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.alarms = try reader["Alarms"].readListIfPresent(memberReadingClosure: AutoScalingClientTypes.Alarm.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.targetTrackingConfiguration = try reader["TargetTrackingConfiguration"].readIfPresent(readingClosure: AutoScalingClientTypes.TargetTrackingConfiguration.readingClosure(from:))
        value.enabled = try reader["Enabled"].readIfPresent()
        value.predictiveScalingConfiguration = try reader["PredictiveScalingConfiguration"].readIfPresent(readingClosure: AutoScalingClientTypes.PredictiveScalingConfiguration.readingClosure(from:))
        return value
    }
}
...
extension AutoScalingClientTypes.ScheduledUpdateGroupAction: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.ScheduledUpdateGroupAction {
...
extension AutoScalingClientTypes.ScheduledUpdateGroupActionRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.ScheduledUpdateGroupActionRequest {
...
extension SetDesiredCapacityOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetDesiredCapacityOutput {
        let reader = responseReader["SetDesiredCapacityResult"]
        var value = SetDesiredCapacityOutput()
        return value
    }
}
...
extension SetInstanceHealthOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetInstanceHealthOutput {
        let reader = responseReader["SetInstanceHealthResult"]
        var value = SetInstanceHealthOutput()
        return value
    }
}
...
extension SetInstanceProtectionOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetInstanceProtectionOutput {
        let reader = responseReader["SetInstanceProtectionResult"]
        var value = SetInstanceProtectionOutput()
        return value
    }
}
...
extension StartInstanceRefreshOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> StartInstanceRefreshOutput {
...
extension AutoScalingClientTypes.StepAdjustment: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.StepAdjustment {
...
extension SuspendProcessesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SuspendProcessesOutput {
        let reader = responseReader["SuspendProcessesResult"]
        var value = SuspendProcessesOutput()
        return value
    }
}
...
extension AutoScalingClientTypes.SuspendedProcess: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.SuspendedProcess {
...
extension AutoScalingClientTypes.Tag: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.Tag {
...
extension AutoScalingClientTypes.TagDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.TagDescription {
...
extension AutoScalingClientTypes.TargetTrackingConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.TargetTrackingConfiguration {
        var value = AutoScalingClientTypes.TargetTrackingConfiguration()
        value.predefinedMetricSpecification = try reader["PredefinedMetricSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.PredefinedMetricSpecification.readingClosure(from:))
        value.customizedMetricSpecification = try reader["CustomizedMetricSpecification"].readIfPresent(readingClosure: AutoScalingClientTypes.CustomizedMetricSpecification.readingClosure(from:))
        value.targetValue = try reader["TargetValue"].readIfPresent()
...
extension AutoScalingClientTypes.TargetTrackingMetricDataQuery: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.TargetTrackingMetricDataQuery {
        var value = AutoScalingClientTypes.TargetTrackingMetricDataQuery()
        value.id = try reader["Id"].readIfPresent()
        value.expression = try reader["Expression"].readIfPresent()
        value.metricStat = try reader["MetricStat"].readIfPresent(readingClosure: AutoScalingClientTypes.TargetTrackingMetricStat.readingClosure(from:))
        value.label = try reader["Label"].readIfPresent()
        value.returnData = try reader["ReturnData"].readIfPresent()
        return value
    }
...
extension AutoScalingClientTypes.TargetTrackingMetricStat: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.TargetTrackingMetricStat {
...
extension TerminateInstanceInAutoScalingGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> TerminateInstanceInAutoScalingGroupOutput {
        let reader = responseReader["TerminateInstanceInAutoScalingGroupResult"]
        var value = TerminateInstanceInAutoScalingGroupOutput()
        value.activity = try reader["Activity"].readIfPresent(readingClosure: AutoScalingClientTypes.Activity.readingClosure(from:))
        return value
    }
}
...
extension AutoScalingClientTypes.TotalLocalStorageGBRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.TotalLocalStorageGBRequest {
...
extension AutoScalingClientTypes.TrafficSourceIdentifier: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.TrafficSourceIdentifier {
...
extension AutoScalingClientTypes.TrafficSourceState: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.TrafficSourceState {
...
extension UpdateAutoScalingGroupOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> UpdateAutoScalingGroupOutput {
        let reader = responseReader["UpdateAutoScalingGroupResult"]
        var value = UpdateAutoScalingGroupOutput()
        return value
    }
}
...
extension AutoScalingClientTypes.VCpuCountRequest: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.VCpuCountRequest {
...
extension AutoScalingClientTypes.WarmPoolConfiguration: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> AutoScalingClientTypes.WarmPoolConfiguration {
        ...
        value.status = try reader["Status"].readIfPresent()
        value.instanceReusePolicy = try reader["InstanceReusePolicy"].readIfPresent(readingClosure: AutoScalingClientTypes.InstanceReusePolicy.readingClosure(from:))
        return value
    }
}
