...
extension IVSRealTimeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> IVSRealTimeClient.IVSRealTimeClientConfiguration {
        let clientConfiguration = try await IVSRealTimeClient.IVSRealTimeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> IVSRealTimeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return IVSRealTimeClient(config: configuration)
        }
    }
...
extension IVSRealTimeClient.IVSRealTimeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
