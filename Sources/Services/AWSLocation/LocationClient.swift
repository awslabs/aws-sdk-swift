...
extension LocationClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> LocationClient.LocationClientConfiguration {
        let clientConfiguration = try await LocationClient.LocationClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> LocationClient {
            let configuration = try await resolve(plugins: self.plugins)
            return LocationClient(config: configuration)
        }
    }
...
extension LocationClient.LocationClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
