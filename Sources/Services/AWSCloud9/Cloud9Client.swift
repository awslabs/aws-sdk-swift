...
extension Cloud9Client {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> Cloud9Client.Cloud9ClientConfiguration {
        let clientConfiguration = try await Cloud9Client.Cloud9ClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> Cloud9Client {
            let configuration = try await resolve(plugins: self.plugins)
            return Cloud9Client(config: configuration)
        }
    }
...
extension Cloud9Client.Cloud9ClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
