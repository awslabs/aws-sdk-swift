...
public final class NetworkFlowMonitorClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "NetworkFlowMonitorClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: NetworkFlowMonitorClient.NetworkFlowMonitorClientConfig
    let serviceName = "NetworkFlowMonitor"

    @available(*, deprecated, message: "Use NetworkFlowMonitorClient.NetworkFlowMonitorClientConfig instead")
    public typealias Config = NetworkFlowMonitorClient.NetworkFlowMonitorClientConfiguration
    public typealias Configuration = NetworkFlowMonitorClient.NetworkFlowMonitorClientConfig

    public required init(config: NetworkFlowMonitorClient.NetworkFlowMonitorClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: NetworkFlowMonitorClient.NetworkFlowMonitorClientConfig) instead")
    public convenience init(config: NetworkFlowMonitorClient.NetworkFlowMonitorClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try NetworkFlowMonitorClient.NetworkFlowMonitorClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await NetworkFlowMonitorClient.NetworkFlowMonitorClientConfig()
        self.init(config: config)
    }
}
...
extension NetworkFlowMonitorClient {
    ...
    /// Client configuration for NetworkFlowMonitorClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct NetworkFlowMonitorClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "NetworkFlowMonitor")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultNetworkFlowMonitorAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: NetworkFlowMonitorClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use NetworkFlowMonitorClientConfig instead. This class will be removed in a future version.")
    public final class NetworkFlowMonitorClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> NetworkFlowMonitorClientConfig {
            return try NetworkFlowMonitorClientConfig(
...
extension NetworkFlowMonitorClient {
    ...
    public func createMonitor(input: CreateMonitorInput) async throws -> CreateMonitorOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "NetworkFlowMonitor"))
