...
extension CostandUsageReportClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CostandUsageReportClient.CostandUsageReportClientConfiguration {
        let clientConfiguration = try await CostandUsageReportClient.CostandUsageReportClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CostandUsageReportClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CostandUsageReportClient(config: configuration)
        }
    }
...
extension CostandUsageReportClient.CostandUsageReportClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
