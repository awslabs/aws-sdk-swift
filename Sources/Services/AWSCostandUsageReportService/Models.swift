...
extension CostandUsageReportClientTypes.ReportDefinition {
    ...
    static func write(value: CostandUsageReportClientTypes.ReportDefinition?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AdditionalArtifacts"].writeList(value.additionalArtifacts, memberWritingClosure: CostandUsageReportClientTypes.AdditionalArtifact.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["AdditionalSchemaElements"].writeList(value.additionalSchemaElements, memberWritingClosure: CostandUsageReportClientTypes.SchemaElement.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CostandUsageReportClientTypes.ReportDefinition {
        ...
        value.additionalSchemaElements = try reader["AdditionalSchemaElements"].readListIfPresent(memberReadingClosure: CostandUsageReportClientTypes.SchemaElement.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.additionalArtifacts = try reader["AdditionalArtifacts"].readListIfPresent(memberReadingClosure: CostandUsageReportClientTypes.AdditionalArtifact.read(from:), memberNodeInfo: "member", isFlattened: false)
