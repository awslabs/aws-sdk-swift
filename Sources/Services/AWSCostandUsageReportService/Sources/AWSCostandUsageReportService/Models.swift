...
extension DuplicateReportNameException {
    ...
    static func makeError(baseError: ClientRuntime.AWSJSONError) throws -> DuplicateReportNameException {
        let reader = baseError.errorBodyReader
...
extension ReportLimitReachedException {
    ...
    static func makeError(baseError: ClientRuntime.AWSJSONError) throws -> ReportLimitReachedException {
        let reader = baseError.errorBodyReader
