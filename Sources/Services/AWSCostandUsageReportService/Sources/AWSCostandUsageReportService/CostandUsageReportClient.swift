...
public final class CostandUsageReportClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: CostandUsageReportClient.CostandUsageReportClientConfig) instead")
    public convenience init(config: CostandUsageReportClient.CostandUsageReportClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try CostandUsageReportClient.CostandUsageReportClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await CostandUsageReportClient.CostandUsageReportClientConfig()
        self.init(config: config)
    }
}
...
extension CostandUsageReportClient {
    ...
    /// Client configuration for CostandUsageReportClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct CostandUsageReportClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Cost and Usage Report Service")
    ...
    @available(*, deprecated, message: "Use CostandUsageReportClientConfig instead. This class will be removed in a future version.")
    public final class CostandUsageReportClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> CostandUsageReportClientConfig {
            return try CostandUsageReportClientConfig(
...
extension CostandUsageReportClient {
    ...
    public func deleteReportDefinition(input: DeleteReportDefinitionInput) async throws -> DeleteReportDefinitionOutput {
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteReportDefinitionInput, DeleteReportDefinitionOutput>(overrides: ["X-Amz-Target": "AWSOrigamiServiceGatewayService.DeleteReportDefinition"]))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Cost and Usage Report Service"))
    ...
    public func describeReportDefinitions(input: DescribeReportDefinitionsInput) async throws -> DescribeReportDefinitionsOutput {
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeReportDefinitionsInput, DescribeReportDefinitionsOutput>(overrides: ["X-Amz-Target": "AWSOrigamiServiceGatewayService.DescribeReportDefinitions"]))
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput {
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput>(overrides: ["X-Amz-Target": "AWSOrigamiServiceGatewayService.ListTagsForResource"]))
    ...
    public func modifyReportDefinition(input: ModifyReportDefinitionInput) async throws -> ModifyReportDefinitionOutput {
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ModifyReportDefinitionInput, ModifyReportDefinitionOutput>(overrides: ["X-Amz-Target": "AWSOrigamiServiceGatewayService.ModifyReportDefinition"]))
    ...
    public func putReportDefinition(input: PutReportDefinitionInput) async throws -> PutReportDefinitionOutput {
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutReportDefinitionInput, PutReportDefinitionOutput>(overrides: ["X-Amz-Target": "AWSOrigamiServiceGatewayService.PutReportDefinition"]))
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput {
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<TagResourceInput, TagResourceOutput>(overrides: ["X-Amz-Target": "AWSOrigamiServiceGatewayService.TagResource"]))
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput {
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UntagResourceInput, UntagResourceOutput>(overrides: ["X-Amz-Target": "AWSOrigamiServiceGatewayService.UntagResource"]))
