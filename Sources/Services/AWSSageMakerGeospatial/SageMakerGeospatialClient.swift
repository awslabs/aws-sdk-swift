...
extension SageMakerGeospatialClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SageMakerGeospatialClient.SageMakerGeospatialClientConfiguration {
        let clientConfiguration = try await SageMakerGeospatialClient.SageMakerGeospatialClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SageMakerGeospatialClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SageMakerGeospatialClient(config: configuration)
        }
    }
...
extension SageMakerGeospatialClient.SageMakerGeospatialClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
