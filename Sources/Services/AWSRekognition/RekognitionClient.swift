...
extension RekognitionClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> RekognitionClient.RekognitionClientConfiguration {
        let clientConfiguration = try await RekognitionClient.RekognitionClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> RekognitionClient {
            let configuration = try await resolve(plugins: self.plugins)
            return RekognitionClient(config: configuration)
        }
    }
...
extension RekognitionClient.RekognitionClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
