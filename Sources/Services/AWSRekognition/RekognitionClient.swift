...
public class RekognitionClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await RekognitionClientConfiguration(region: region)
    ...
    public class RekognitionClientConfiguration: RekognitionClientConfigurationProtocol {
        ...
        public init(
            ...
            let runtimeConfig = try runtimeConfig ?? ClientRuntime.DefaultSDKRuntimeConfiguration("RekognitionClient")
