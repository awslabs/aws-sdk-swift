...
extension AppSyncClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> AppSyncClient.AppSyncClientConfiguration {
        let clientConfiguration = try await AppSyncClient.AppSyncClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> AppSyncClient {
            let configuration = try await resolve(plugins: self.plugins)
            return AppSyncClient(config: configuration)
        }
    }
...
extension AppSyncClient.AppSyncClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
