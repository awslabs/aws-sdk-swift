...
public class MailManagerClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? MailManagerClient.MailManagerClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? MailManagerClient.MailManagerClientConfiguration {
            config.authSchemeResolver = DefaultMailManagerAuthSchemeResolver()
...
public class MailManagerClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: MailManagerAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
