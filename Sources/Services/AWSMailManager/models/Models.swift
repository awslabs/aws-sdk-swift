...
extension MailManagerClientTypes.ExportStatus {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MailManagerClientTypes.ExportStatus {
        ...
        value.submissionTimestamp = try reader["SubmissionTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.completionTimestamp = try reader["CompletionTimestamp"].readTimestampIfPresent(format: .epochSeconds)
...
extension GetArchiveExportOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetArchiveExportOutput {
        ...
        value.fromTimestamp = try reader["FromTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        value.maxResults = try reader["MaxResults"].readIfPresent()
        value.status = try reader["Status"].readIfPresent(with: MailManagerClientTypes.ExportStatus.read(from:))
        value.toTimestamp = try reader["ToTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension GetRuleSetOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetRuleSetOutput {
        ...
        value.lastModificationDate = try reader["LastModificationDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension MailManagerClientTypes.IngressPointPasswordConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MailManagerClientTypes.IngressPointPasswordConfiguration {
        ...
        value.previousSmtpPasswordExpiryTimestamp = try reader["PreviousSmtpPasswordExpiryTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension MailManagerClientTypes.ReplaceRecipientAction {
    ...
    static func write(value: MailManagerClientTypes.ReplaceRecipientAction?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ReplaceWith"].writeList(value.replaceWith, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MailManagerClientTypes.ReplaceRecipientAction {
        ...
        value.replaceWith = try reader["ReplaceWith"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension MailManagerClientTypes.Row {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MailManagerClientTypes.Row {
        ...
        value.receivedTimestamp = try reader["ReceivedTimestamp"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.receivedHeaders = try reader["ReceivedHeaders"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension MailManagerClientTypes.RuleDmarcExpression {
    ...
    static func write(value: MailManagerClientTypes.RuleDmarcExpression?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Operator"].write(value.`operator`)
        try writer["Values"].writeList(value.values, memberWritingClosure: MailManagerClientTypes.RuleDmarcPolicy.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MailManagerClientTypes.RuleDmarcExpression {
        ...
        value.`operator` = try reader["Operator"].readIfPresent()
        value.values = try reader["Values"].readListIfPresent(memberReadingClosure: MailManagerClientTypes.RuleDmarcPolicy.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension MailManagerClientTypes.RuleVerdictExpression {
    ...
    static func write(value: MailManagerClientTypes.RuleVerdictExpression?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["Operator"].write(value.`operator`)
        try writer["Values"].writeList(value.values, memberWritingClosure: MailManagerClientTypes.RuleVerdict.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MailManagerClientTypes.RuleVerdictExpression {
        ...
        value.`operator` = try reader["Operator"].readIfPresent()
        value.values = try reader["Values"].readListIfPresent(memberReadingClosure: MailManagerClientTypes.RuleVerdict.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension StartArchiveExportInput {
    ...
    static func write(value: StartArchiveExportInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["FromTimestamp"].writeTimestamp(value.fromTimestamp, format: .epochSeconds)
        try writer["MaxResults"].write(value.maxResults)
        try writer["ToTimestamp"].writeTimestamp(value.toTimestamp, format: .epochSeconds)
    }
}
