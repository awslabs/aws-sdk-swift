...
extension MigrationHubConfigClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MigrationHubConfigClient.MigrationHubConfigClientConfiguration {
        let clientConfiguration = try await MigrationHubConfigClient.MigrationHubConfigClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MigrationHubConfigClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MigrationHubConfigClient(config: configuration)
        }
    }
...
extension MigrationHubConfigClient.MigrationHubConfigClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
