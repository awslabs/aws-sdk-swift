...
public final class MigrationHubConfigClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "MigrationHubConfigClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: MigrationHubConfigClient.MigrationHubConfigClientConfig
    let serviceName = "MigrationHub Config"
    let retryStrategy: SmithyRetries.DefaultRetryStrategy

    @available(*, deprecated, message: "Use MigrationHubConfigClient.MigrationHubConfigClientConfig instead")
    public typealias Config = MigrationHubConfigClient.MigrationHubConfigClientConfiguration
    public typealias Configuration = MigrationHubConfigClient.MigrationHubConfigClientConfig

    public required init(config: MigrationHubConfigClient.MigrationHubConfigClientConfig) {
    ...
    @available(*, deprecated, message: "Use init(config: MigrationHubConfigClient.MigrationHubConfigClientConfig) instead")
    public convenience init(config: MigrationHubConfigClient.MigrationHubConfigClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try MigrationHubConfigClient.MigrationHubConfigClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await MigrationHubConfigClient.MigrationHubConfigClientConfig()
        self.init(config: config)
    }
}
...
extension MigrationHubConfigClient {
    ...
    /// Client configuration for MigrationHubConfigClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct MigrationHubConfigClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "MigrationHub Config")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: MigrationHubConfigClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultMigrationHubConfigAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use MigrationHubConfigClientConfig instead. This class will be removed in a future version.")
    public final class MigrationHubConfigClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> MigrationHubConfigClientConfig {
            return try MigrationHubConfigClientConfig(
...
extension MigrationHubConfigClient {
    ...
    public func createHomeRegionControl(input: CreateHomeRegionControlInput) async throws -> CreateHomeRegionControlOutput {
        ...
        let operation = MigrationHubConfigClient.createHomeRegionControlOperation
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("MigrationHub Config", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateHomeRegionControlOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<CreateHomeRegionControlInput, CreateHomeRegionControlOutput>(overrides: ["X-Amz-Target": "AWSMigrationHubMultiAccountService.CreateHomeRegionControl"]))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "MigrationHub Config"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateHomeRegionControlInput, CreateHomeRegionControlOutput>(serviceID: serviceName, version: MigrationHubConfigClient.version, config: config))
    ...
    public func deleteHomeRegionControl(input: DeleteHomeRegionControlInput) async throws -> DeleteHomeRegionControlOutput {
        ...
        let operation = MigrationHubConfigClient.deleteHomeRegionControlOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteHomeRegionControlOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteHomeRegionControlInput, DeleteHomeRegionControlOutput>(overrides: ["X-Amz-Target": "AWSMigrationHubMultiAccountService.DeleteHomeRegionControl"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "MigrationHub Config"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteHomeRegionControlInput, DeleteHomeRegionControlOutput>(serviceID: serviceName, version: MigrationHubConfigClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "MigrationHubConfig")
    ...
    public func describeHomeRegionControls(input: DescribeHomeRegionControlsInput) async throws -> DescribeHomeRegionControlsOutput {
        ...
        let operation = MigrationHubConfigClient.describeHomeRegionControlsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeHomeRegionControlsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeHomeRegionControlsInput, DescribeHomeRegionControlsOutput>(overrides: ["X-Amz-Target": "AWSMigrationHubMultiAccountService.DescribeHomeRegionControls"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "MigrationHub Config"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeHomeRegionControlsInput, DescribeHomeRegionControlsOutput>(serviceID: serviceName, version: MigrationHubConfigClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "MigrationHubConfig")
    ...
    public func getHomeRegion(input: GetHomeRegionInput) async throws -> GetHomeRegionOutput {
        ...
        let operation = MigrationHubConfigClient.getHomeRegionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetHomeRegionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetHomeRegionInput, GetHomeRegionOutput>(overrides: ["X-Amz-Target": "AWSMigrationHubMultiAccountService.GetHomeRegion"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "MigrationHub Config"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetHomeRegionInput, GetHomeRegionOutput>(serviceID: serviceName, version: MigrationHubConfigClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "MigrationHubConfig")
