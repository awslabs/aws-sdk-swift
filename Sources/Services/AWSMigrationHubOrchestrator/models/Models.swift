...
extension CreateWorkflowInput {
    ...
    static func write(value: CreateWorkflowInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["stepTargets"].writeList(value.stepTargets, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["tags"].writeMap(value.tags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension CreateWorkflowOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateWorkflowOutput {
        ...
        value.stepTargets = try reader["stepTargets"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.templateId = try reader["templateId"].readIfPresent()
...
extension CreateWorkflowStepGroupOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreateWorkflowStepGroupOutput {
        ...
        value.id = try reader["id"].readIfPresent()
        value.name = try reader["name"].readIfPresent()
        value.next = try reader["next"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.previous = try reader["previous"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CreateWorkflowStepInput {
    ...
    static func write(value: CreateWorkflowStepInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["stepTarget"].writeList(value.stepTarget, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["workflowId"].write(value.workflowId)
...
extension GetWorkflowStepOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetWorkflowStepOutput {
        ...
        value.stepTarget = try reader["stepTarget"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func write(value: MigrationHubOrchestratorClientTypes.StepInput?, to writer: SmithyJSON.Writer) throws {
        ...
        switch value {
            ...
            case let .listofstringsvalue(listofstringsvalue):
                try writer["listOfStringsValue"].writeList(listofstringsvalue, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .mapofstringvalue(mapofstringvalue):
                try writer["mapOfStringValue"].writeMap(mapofstringvalue, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MigrationHubOrchestratorClientTypes.StepInput {
        ...
        switch name {
            ...
            case "listOfStringsValue":
                return .listofstringsvalue(try reader["listOfStringsValue"].readList(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false))
            case "mapOfStringValue":
                return .mapofstringvalue(try reader["mapOfStringValue"].readMap(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false))
            default:
    ...
    static func write(value: MigrationHubOrchestratorClientTypes.WorkflowStepOutputUnion?, to writer: SmithyJSON.Writer) throws {
        ...
        switch value {
            ...
            case let .listofstringvalue(listofstringvalue):
                try writer["listOfStringValue"].writeList(listofstringvalue, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
            case let .stringvalue(stringvalue):
                try writer["stringValue"].write(stringvalue)
            case let .sdkUnknown(sdkUnknown):
                try writer["sdkUnknown"].write(sdkUnknown)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MigrationHubOrchestratorClientTypes.WorkflowStepOutputUnion {
        ...
        switch name {
            ...
            case "listOfStringValue":
                return .listofstringvalue(try reader["listOfStringValue"].readList(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false))
            default:
                return .sdkUnknown(name ?? "")
        }
    }
