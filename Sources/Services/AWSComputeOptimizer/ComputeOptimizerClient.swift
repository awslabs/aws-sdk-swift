...
extension ComputeOptimizerClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ComputeOptimizerClient.ComputeOptimizerClientConfiguration {
        let clientConfiguration = try await ComputeOptimizerClient.ComputeOptimizerClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ComputeOptimizerClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ComputeOptimizerClient(config: configuration)
        }
    }
...
extension ComputeOptimizerClient.ComputeOptimizerClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
