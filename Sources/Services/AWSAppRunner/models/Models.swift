...
extension AppRunnerClientTypes {
    ...
    public enum AutoScalingConfigurationStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case active
        case inactive
...
extension AppRunnerClientTypes {
    ...
    public enum CertificateValidationRecordStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case failed
...
extension AppRunnerClientTypes.CodeConfigurationValues {
    ...
    static func write(value: AppRunnerClientTypes.CodeConfigurationValues?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["RuntimeEnvironmentSecrets"].writeMap(value.runtimeEnvironmentSecrets, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["RuntimeEnvironmentVariables"].writeMap(value.runtimeEnvironmentVariables, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AppRunnerClientTypes.CodeConfigurationValues {
        ...
        value.runtimeEnvironmentVariables = try reader["RuntimeEnvironmentVariables"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.runtimeEnvironmentSecrets = try reader["RuntimeEnvironmentSecrets"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension AppRunnerClientTypes {
    ...
    public enum ConfigurationSource: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case api
        case repository
        case sdkUnknown(Swift.String)
...
extension AppRunnerClientTypes {
    ...
    public enum CustomDomainAssociationStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case active
...
extension AppRunnerClientTypes {
    ...
    public enum EgressType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case `default`
        case vpc
        case sdkUnknown(Swift.String)
...
extension AppRunnerClientTypes {
    ...
    public enum ImageRepositoryType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case ecr
        case ecrPublic
        case sdkUnknown(Swift.String)
...
extension ListServicesForAutoScalingConfigurationOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListServicesForAutoScalingConfigurationOutput {
        ...
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.serviceArnList = try reader["ServiceArnList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension AppRunnerClientTypes {
    ...
    public enum ObservabilityConfigurationStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case active
        case inactive
        case sdkUnknown(Swift.String)
...
extension AppRunnerClientTypes {
    ...
    public enum SourceCodeVersionType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case branch
        case sdkUnknown(Swift.String)
...
extension AppRunnerClientTypes {
    ...
    public enum TracingVendor: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case awsxray
        case sdkUnknown(Swift.String)
...
extension AppRunnerClientTypes {
    ...
    public enum VpcConnectorStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case active
        case inactive
        case sdkUnknown(Swift.String)
...
extension AppRunnerClientTypes {
    ...
    public enum VpcIngressConnectionStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case available
        case deleted
        case failedCreation
        case failedDeletion
