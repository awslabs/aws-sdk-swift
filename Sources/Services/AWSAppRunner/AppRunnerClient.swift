...
extension AppRunnerClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> AppRunnerClient.AppRunnerClientConfiguration {
        let clientConfiguration = try await AppRunnerClient.AppRunnerClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> AppRunnerClient {
            let configuration = try await resolve(plugins: self.plugins)
            return AppRunnerClient(config: configuration)
        }
    }
...
extension AppRunnerClient.AppRunnerClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
