...
extension ListDatasetEntriesOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListDatasetEntriesOutput {
        ...
        value.datasetEntries = try reader["DatasetEntries"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension LookoutVisionClientTypes.ModelDescription {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> LookoutVisionClientTypes.ModelDescription {
        ...
        value.evaluationEndTimestamp = try reader["EvaluationEndTimestamp"].readTimestampIfPresent(format: .epochSeconds)
...
extension LookoutVisionClientTypes {
    ...
    public enum ModelHostingStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case hosted
        case hostingFailed
...
extension LookoutVisionClientTypes {
    ...
    public enum ModelPackagingJobStatus: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Hashable {
        case created
        case failed
        case running
        case succeeded
