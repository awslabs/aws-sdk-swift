...
extension LookoutVisionClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> LookoutVisionClient.LookoutVisionClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> LookoutVisionClient {
            let configuration = try await resolve(plugins: self.plugins)
            return LookoutVisionClient(config: configuration)
        }
    }
...
extension LookoutVisionClient.LookoutVisionClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
