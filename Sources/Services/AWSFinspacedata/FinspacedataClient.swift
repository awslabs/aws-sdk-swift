...
extension FinspacedataClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> FinspacedataClient.FinspacedataClientConfiguration {
        let clientConfiguration = try await FinspacedataClient.FinspacedataClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> FinspacedataClient {
            let configuration = try await resolve(plugins: self.plugins)
            return FinspacedataClient(config: configuration)
        }
    }
...
extension FinspacedataClient.FinspacedataClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
