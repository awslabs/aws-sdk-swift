...
extension GetChangesetOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetChangesetOutput {
        ...
        value.formatParams = try reader["formatParams"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.sourceParams = try reader["sourceParams"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension GetDataViewOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetDataViewOutput {
        ...
        value.lastModifiedTime = try reader["lastModifiedTime"].readIfPresent() ?? 0
        value.partitionColumns = try reader["partitionColumns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.sortColumns = try reader["sortColumns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["status"].readIfPresent()
        return value
    }
}
...
extension FinspacedataClientTypes.SchemaDefinition {
    ...
    static func write(value: FinspacedataClientTypes.SchemaDefinition?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["primaryKeyColumns"].writeList(value.primaryKeyColumns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> FinspacedataClientTypes.SchemaDefinition {
        ...
        value.primaryKeyColumns = try reader["primaryKeyColumns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension FinspacedataClientTypes.DataViewDestinationTypeParams {
    ...
    static func write(value: FinspacedataClientTypes.DataViewDestinationTypeParams?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["s3DestinationExportFileFormatOptions"].writeMap(value.s3DestinationExportFileFormatOptions, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> FinspacedataClientTypes.DataViewDestinationTypeParams {
        ...
        value.s3DestinationExportFileFormatOptions = try reader["s3DestinationExportFileFormatOptions"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension FinspacedataClientTypes.PermissionGroup {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> FinspacedataClientTypes.PermissionGroup {
        ...
        value.applicationPermissions = try reader["applicationPermissions"].readListIfPresent(memberReadingClosure: FinspacedataClientTypes.ApplicationPermission.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.createTime = try reader["createTime"].readIfPresent() ?? 0
        value.lastModifiedTime = try reader["lastModifiedTime"].readIfPresent() ?? 0
