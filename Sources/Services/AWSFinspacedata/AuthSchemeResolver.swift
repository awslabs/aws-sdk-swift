...
public struct FinspacedataAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol FinspacedataAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
    ...
    public func resolveAuthScheme(params: ClientRuntime.AuthSchemeResolverParameters) throws -> [AuthOption] {
        ...
        switch serviceParams.operation {
            default:
                ...
                sigV4Option.signingProperties.set(key: AttributeKeys.signingName, value: "finspace-api")
