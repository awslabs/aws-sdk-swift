...
extension CreateConfiguredAudienceModelInput {
    ...
    static func write(value: CreateConfiguredAudienceModelInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["sharedAudienceMetrics"].writeList(value.sharedAudienceMetrics, memberWritingClosure: CleanRoomsMLClientTypes.SharedAudienceMetrics.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["tags"].writeMap(value.tags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension GetConfiguredAudienceModelOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetConfiguredAudienceModelOutput {
        ...
        value.sharedAudienceMetrics = try reader["sharedAudienceMetrics"].readListIfPresent(memberReadingClosure: CleanRoomsMLClientTypes.SharedAudienceMetrics.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["status"].readIfPresent()
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.updateTime = try reader["updateTime"].readTimestampIfPresent(format: .dateTime)
        return value
...
extension CleanRoomsMLClientTypes.AudienceSizeConfig {
    ...
    static func write(value: CleanRoomsMLClientTypes.AudienceSizeConfig?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["audienceSizeBins"].writeList(value.audienceSizeBins, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CleanRoomsMLClientTypes.AudienceSizeConfig {
        ...
        value.audienceSizeBins = try reader["audienceSizeBins"].readListIfPresent(memberReadingClosure: Swift.Int.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension CleanRoomsMLClientTypes.ColumnSchema {
    ...
    static func write(value: CleanRoomsMLClientTypes.ColumnSchema?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["columnTypes"].writeList(value.columnTypes, memberWritingClosure: CleanRoomsMLClientTypes.ColumnType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CleanRoomsMLClientTypes.ColumnSchema {
        ...
        value.columnTypes = try reader["columnTypes"].readListIfPresent(memberReadingClosure: CleanRoomsMLClientTypes.ColumnType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
