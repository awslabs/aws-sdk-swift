...
extension CleanRoomsMLClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CleanRoomsMLClient.CleanRoomsMLClientConfiguration {
        let clientConfiguration = try await CleanRoomsMLClient.CleanRoomsMLClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> CleanRoomsMLClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CleanRoomsMLClient(config: configuration)
        }
    }
...
extension CleanRoomsMLClient.CleanRoomsMLClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
