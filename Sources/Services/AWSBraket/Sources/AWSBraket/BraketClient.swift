...
public final class BraketClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: BraketClient.BraketClientConfig) instead")
    public convenience init(config: BraketClient.BraketClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try BraketClient.BraketClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await BraketClient.BraketClientConfig()
        self.init(config: config)
    }
}
...
extension BraketClient {
    ...
    /// Client configuration for BraketClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct BraketClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Braket")
    ...
    @available(*, deprecated, message: "Use BraketClientConfig instead. This class will be removed in a future version.")
    public final class BraketClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> BraketClientConfig {
            return try BraketClientConfig(
...
extension BraketClient {
    ...
    public func cancelJob(input: CancelJobInput) async throws -> CancelJobOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Braket"))
