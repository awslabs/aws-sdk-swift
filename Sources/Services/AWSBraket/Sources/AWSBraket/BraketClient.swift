...
extension BraketClient {
    ...
    public func cancelQuantumTask(input: CancelQuantumTaskInput) async throws -> CancelQuantumTaskOutput {
        ...
        config.httpInterceptorProviders.forEach { (provider: any ClientRuntime.HttpInterceptorProvider) -> Void in
            let i: any ClientRuntime.HttpInterceptor<CancelQuantumTaskInput, CancelQuantumTaskOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CancelQuantumTaskInput, CancelQuantumTaskOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func createQuantumTask(input: CreateQuantumTaskInput) async throws -> CreateQuantumTaskOutput {
        ...
        config.httpInterceptorProviders.forEach { (provider: any ClientRuntime.HttpInterceptorProvider) -> Void in
            let i: any ClientRuntime.HttpInterceptor<CreateQuantumTaskInput, CreateQuantumTaskOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateQuantumTaskInput, CreateQuantumTaskOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func getQuantumTask(input: GetQuantumTaskInput) async throws -> GetQuantumTaskOutput {
        ...
        config.httpInterceptorProviders.forEach { (provider: any ClientRuntime.HttpInterceptorProvider) -> Void in
            let i: any ClientRuntime.HttpInterceptor<GetQuantumTaskInput, GetQuantumTaskOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetQuantumTaskInput, GetQuantumTaskOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func searchDevices(input: SearchDevicesInput) async throws -> SearchDevicesOutput {
        ...
        config.httpInterceptorProviders.forEach { (provider: any ClientRuntime.HttpInterceptorProvider) -> Void in
            let i: any ClientRuntime.HttpInterceptor<SearchDevicesInput, SearchDevicesOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SearchDevicesInput, SearchDevicesOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
    ...
    public func searchQuantumTasks(input: SearchQuantumTasksInput) async throws -> SearchQuantumTasksOutput {
        ...
        config.httpInterceptorProviders.forEach { (provider: any ClientRuntime.HttpInterceptorProvider) -> Void in
            let i: any ClientRuntime.HttpInterceptor<SearchQuantumTasksInput, SearchQuantumTasksOutput> = provider.create()
            builder.interceptors.add(i)
        }
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SearchQuantumTasksInput, SearchQuantumTasksOutput>(metadata: AWSClientRuntime.AWSUserAgentMetadata.fromConfig(serviceID: serviceName, version: "1.0", config: config)))
