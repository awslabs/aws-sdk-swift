...
extension BraketClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> BraketClient.BraketClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> BraketClient {
            let configuration = try await resolve(plugins: self.plugins)
            return BraketClient(config: configuration)
        }
    }
...
extension BraketClient.BraketClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
