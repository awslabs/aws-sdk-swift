...
public protocol ElasticLoadBalancingv2ClientProtocol {
    ...
    /// __Possible Exceptions:__
    /// - `TrustStoreNotFoundException` : The specified trust store does not exist.
    func describeTrustStoreAssociations(input: DescribeTrustStoreAssociationsInput) async throws -> DescribeTrustStoreAssociationsOutput
    ...
    /// - `TrustStoreNotFoundException` : The specified trust store does not exist.
    func describeTrustStoreRevocations(input: DescribeTrustStoreRevocationsInput) async throws -> DescribeTrustStoreRevocationsOutput
    ...
    /// __Possible Exceptions:__
    /// - `TrustStoreNotFoundException` : The specified trust store does not exist.
    func describeTrustStores(input: DescribeTrustStoresInput) async throws -> DescribeTrustStoresOutput
    ...
    /// __Possible Exceptions:__
    /// - `TrustStoreNotFoundException` : The specified trust store does not exist.
    func getTrustStoreCaCertificatesBundle(input: GetTrustStoreCaCertificatesBundleInput) async throws -> GetTrustStoreCaCertificatesBundleOutput
