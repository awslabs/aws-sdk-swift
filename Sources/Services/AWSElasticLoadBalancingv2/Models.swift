...
extension DescribeRulesInput {
    ...
    static func write(value: DescribeRulesInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Marker"].write(value.marker)
        try writer["PageSize"].write(value.pageSize)
        try writer["RuleArns"].writeList(value.ruleArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeTargetHealthInput {
    ...
    static func write(value: DescribeTargetHealthInput?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["Include"].writeList(value.include, memberWritingClosure: ElasticLoadBalancingv2ClientTypes.DescribeTargetHealthInputIncludeEnum.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["TargetGroupArn"].write(value.targetGroupArn)
        try writer["Targets"].writeList(value.targets, memberWritingClosure: ElasticLoadBalancingv2ClientTypes.TargetDescription.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeTrustStoreRevocationsInput {
    ...
    static func write(value: DescribeTrustStoreRevocationsInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Marker"].write(value.marker)
        try writer["PageSize"].write(value.pageSize)
        try writer["RevocationIds"].writeList(value.revocationIds, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["TrustStoreArn"].write(value.trustStoreArn)
...
extension DescribeTrustStoresInput {
    ...
    static func write(value: DescribeTrustStoresInput?, to writer: SmithyFormURL.Writer) throws {
        ...
        try writer["Names"].writeList(value.names, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["PageSize"].write(value.pageSize)
        try writer["TrustStoreArns"].writeList(value.trustStoreArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension ElasticLoadBalancingv2ClientTypes.Listener {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingv2ClientTypes.Listener {
        ...
        value.alpnPolicy = try reader["AlpnPolicy"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ElasticLoadBalancingv2ClientTypes.AuthenticateCognitoActionConfig {
    ...
    static func write(value: ElasticLoadBalancingv2ClientTypes.AuthenticateCognitoActionConfig?, to writer: SmithyFormURL.Writer) throws {
        guard let value else { return }
        try writer["AuthenticationRequestExtraParams"].writeMap(value.authenticationRequestExtraParams, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingv2ClientTypes.AuthenticateCognitoActionConfig {
        ...
        value.authenticationRequestExtraParams = try reader["AuthenticationRequestExtraParams"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ElasticLoadBalancingv2ClientTypes.TargetGroup {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingv2ClientTypes.TargetGroup {
        ...
        value.loadBalancerArns = try reader["LoadBalancerArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ElasticLoadBalancingv2ClientTypes.SslPolicy {
    ...
    static func read(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingv2ClientTypes.SslPolicy {
        ...
        value.sslProtocols = try reader["SslProtocols"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.name = try reader["Name"].readIfPresent()
        value.supportedLoadBalancerTypes = try reader["SupportedLoadBalancerTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
