...
public final class ResourceExplorer2Client: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: ResourceExplorer2Client.ResourceExplorer2ClientConfig) instead")
    public convenience init(config: ResourceExplorer2Client.ResourceExplorer2ClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ResourceExplorer2Client.ResourceExplorer2ClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ResourceExplorer2Client.ResourceExplorer2ClientConfig()
        self.init(config: config)
    }
}
...
extension ResourceExplorer2Client {
    ...
    /// Client configuration for ResourceExplorer2Client
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ResourceExplorer2ClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Resource Explorer 2")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ResourceExplorer2Client.clientName)
        }
    ...
    @available(*, deprecated, message: "Use ResourceExplorer2ClientConfig instead. This class will be removed in a future version.")
    public final class ResourceExplorer2ClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ResourceExplorer2ClientConfig {
            return try ResourceExplorer2ClientConfig(
...
extension ResourceExplorer2Client {
    ...
    public func associateDefaultView(input: AssociateDefaultViewInput) async throws -> AssociateDefaultViewOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Resource Explorer 2"))
