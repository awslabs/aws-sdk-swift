...
extension BatchGetViewInput {
    ...
    static func write(value: BatchGetViewInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ViewArns"].writeList(value.viewArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ListIndexesForMembersInput {
    ...
    static func write(value: ListIndexesForMembersInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AccountIdList"].writeList(value.accountIdList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["MaxResults"].write(value.maxResults)
        try writer["NextToken"].write(value.nextToken)
    }
}
...
extension GetIndexOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetIndexOutput {
        ...
        value.createdAt = try reader["CreatedAt"].readTimestampIfPresent(format: .dateTime)
        value.lastUpdatedAt = try reader["LastUpdatedAt"].readTimestampIfPresent(format: .dateTime)
        value.replicatingFrom = try reader["ReplicatingFrom"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.replicatingTo = try reader["ReplicatingTo"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.state = try reader["State"].readIfPresent()
...
extension ListViewsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> ListViewsOutput {
        ...
        value.nextToken = try reader["NextToken"].readIfPresent()
        value.views = try reader["Views"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ResourceExplorer2ClientTypes.Resource {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ResourceExplorer2ClientTypes.Resource {
        ...
        value.resourceType = try reader["ResourceType"].readIfPresent()
        value.service = try reader["Service"].readIfPresent()
        value.lastReportedAt = try reader["LastReportedAt"].readTimestampIfPresent(format: .dateTime)
