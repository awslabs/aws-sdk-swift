...
extension CodeGuruReviewerClientTypes.RecommendationFeedback {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeGuruReviewerClientTypes.RecommendationFeedback {
        ...
        value.reactions = try reader["Reactions"].readListIfPresent(memberReadingClosure: CodeGuruReviewerClientTypes.Reaction.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension CodeGuruReviewerClientTypes.RuleMetadata {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> CodeGuruReviewerClientTypes.RuleMetadata {
        ...
        value.ruleTags = try reader["RuleTags"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
