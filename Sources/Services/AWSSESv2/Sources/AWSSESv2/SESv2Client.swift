...
public final class SESv2Client: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "SESv2Client"
    let client: ClientRuntime.SdkHttpClient
    public let config: SESv2Client.SESv2ClientConfig
    let serviceName = "SESv2"
    let retryStrategy: SmithyRetries.DefaultRetryStrategy

    @available(*, deprecated, message: "Use SESv2Client.SESv2ClientConfig instead")
    public typealias Config = SESv2Client.SESv2ClientConfiguration
    public typealias Configuration = SESv2Client.SESv2ClientConfig

    public required init(config: SESv2Client.SESv2ClientConfig) {
    ...
    @available(*, deprecated, message: "Use init(config: SESv2Client.SESv2ClientConfig) instead")
    public convenience init(config: SESv2Client.SESv2ClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try SESv2Client.SESv2ClientConfig(region: region)
...
extension SESv2Client {
    ...
    /// Client configuration for SESv2Client
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct SESv2ClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "SESv2")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultSESv2AuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: SESv2Client.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultSESv2AuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use SESv2ClientConfig instead. This class will be removed in a future version.")
    public final class SESv2ClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> SESv2ClientConfig {
            return try SESv2ClientConfig(
...
extension SESv2Client {
    ...
    public func batchGetMetricData(input: BatchGetMetricDataInput) async throws -> BatchGetMetricDataOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<BatchGetMetricDataOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<BatchGetMetricDataInput, BatchGetMetricDataOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
    ...
    public func cancelExportJob(input: CancelExportJobInput) async throws -> CancelExportJobOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CancelExportJobOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CancelExportJobInput, CancelExportJobOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createConfigurationSet(input: CreateConfigurationSetInput) async throws -> CreateConfigurationSetOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateConfigurationSetInput, CreateConfigurationSetOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createConfigurationSetEventDestination(input: CreateConfigurationSetEventDestinationInput) async throws -> CreateConfigurationSetEventDestinationOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateConfigurationSetEventDestinationInput, CreateConfigurationSetEventDestinationOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createContact(input: CreateContactInput) async throws -> CreateContactOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateContactInput, CreateContactOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createContactList(input: CreateContactListInput) async throws -> CreateContactListOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateContactListOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateContactListInput, CreateContactListOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createCustomVerificationEmailTemplate(input: CreateCustomVerificationEmailTemplateInput) async throws -> CreateCustomVerificationEmailTemplateOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateCustomVerificationEmailTemplateInput, CreateCustomVerificationEmailTemplateOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createDedicatedIpPool(input: CreateDedicatedIpPoolInput) async throws -> CreateDedicatedIpPoolOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateDedicatedIpPoolInput, CreateDedicatedIpPoolOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createDeliverabilityTestReport(input: CreateDeliverabilityTestReportInput) async throws -> CreateDeliverabilityTestReportOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateDeliverabilityTestReportInput, CreateDeliverabilityTestReportOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createEmailIdentity(input: CreateEmailIdentityInput) async throws -> CreateEmailIdentityOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateEmailIdentityInput, CreateEmailIdentityOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createEmailIdentityPolicy(input: CreateEmailIdentityPolicyInput) async throws -> CreateEmailIdentityPolicyOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateEmailIdentityPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateEmailIdentityPolicyInput, CreateEmailIdentityPolicyOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createEmailTemplate(input: CreateEmailTemplateInput) async throws -> CreateEmailTemplateOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateEmailTemplateInput, CreateEmailTemplateOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createExportJob(input: CreateExportJobInput) async throws -> CreateExportJobOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateExportJobInput, CreateExportJobOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func createImportJob(input: CreateImportJobInput) async throws -> CreateImportJobOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateImportJobInput, CreateImportJobOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// - `LimitExceededException` : There are too many instances of the specified resource type.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func createMultiRegionEndpoint(input: CreateMultiRegionEndpointInput) async throws -> CreateMultiRegionEndpointOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "createMultiRegionEndpoint")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<CreateMultiRegionEndpointInput, CreateMultiRegionEndpointOutput>(CreateMultiRegionEndpointInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<CreateMultiRegionEndpointInput, CreateMultiRegionEndpointOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<CreateMultiRegionEndpointInput, CreateMultiRegionEndpointOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateMultiRegionEndpointInput, CreateMultiRegionEndpointOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: CreateMultiRegionEndpointInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateMultiRegionEndpointOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<CreateMultiRegionEndpointOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<CreateMultiRegionEndpointInput, CreateMultiRegionEndpointOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<CreateMultiRegionEndpointInput, CreateMultiRegionEndpointOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateMultiRegionEndpointInput, CreateMultiRegionEndpointOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "CreateMultiRegionEndpoint")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// - `LimitExceededException` : There are too many instances of the specified resource type.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func createTenant(input: CreateTenantInput) async throws -> CreateTenantOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "createTenant")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<CreateTenantInput, CreateTenantOutput>(CreateTenantInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<CreateTenantInput, CreateTenantOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<CreateTenantInput, CreateTenantOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateTenantInput, CreateTenantOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: CreateTenantInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateTenantOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<CreateTenantOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<CreateTenantInput, CreateTenantOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<CreateTenantInput, CreateTenantOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateTenantInput, CreateTenantOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "CreateTenant")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `CreateTenantResourceAssociation` operation on the `SESv2` service.
    ///
    ...
    /// - `NotFoundException` : The resource you attempted to access doesn't exist.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func createTenantResourceAssociation(input: CreateTenantResourceAssociationInput) async throws -> CreateTenantResourceAssociationOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "createTenantResourceAssociation")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<CreateTenantResourceAssociationInput, CreateTenantResourceAssociationOutput>(CreateTenantResourceAssociationInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<CreateTenantResourceAssociationInput, CreateTenantResourceAssociationOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<CreateTenantResourceAssociationInput, CreateTenantResourceAssociationOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<CreateTenantResourceAssociationInput, CreateTenantResourceAssociationOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: CreateTenantResourceAssociationInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateTenantResourceAssociationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<CreateTenantResourceAssociationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<CreateTenantResourceAssociationInput, CreateTenantResourceAssociationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<CreateTenantResourceAssociationInput, CreateTenantResourceAssociationOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<CreateTenantResourceAssociationInput, CreateTenantResourceAssociationOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "CreateTenantResourceAssociation")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func deleteConfigurationSet(input: DeleteConfigurationSetInput) async throws -> DeleteConfigurationSetOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteConfigurationSetInput, DeleteConfigurationSetOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func deleteConfigurationSetEventDestination(input: DeleteConfigurationSetEventDestinationInput) async throws -> DeleteConfigurationSetEventDestinationOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteConfigurationSetEventDestinationInput, DeleteConfigurationSetEventDestinationOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func deleteContact(input: DeleteContactInput) async throws -> DeleteContactOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteContactInput, DeleteContactOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func deleteContactList(input: DeleteContactListInput) async throws -> DeleteContactListOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteContactListOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteContactListInput, DeleteContactListOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func deleteCustomVerificationEmailTemplate(input: DeleteCustomVerificationEmailTemplateInput) async throws -> DeleteCustomVerificationEmailTemplateOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteCustomVerificationEmailTemplateInput, DeleteCustomVerificationEmailTemplateOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func deleteDedicatedIpPool(input: DeleteDedicatedIpPoolInput) async throws -> DeleteDedicatedIpPoolOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteDedicatedIpPoolInput, DeleteDedicatedIpPoolOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func deleteEmailIdentity(input: DeleteEmailIdentityInput) async throws -> DeleteEmailIdentityOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteEmailIdentityInput, DeleteEmailIdentityOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func deleteEmailIdentityPolicy(input: DeleteEmailIdentityPolicyInput) async throws -> DeleteEmailIdentityPolicyOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteEmailIdentityPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteEmailIdentityPolicyInput, DeleteEmailIdentityPolicyOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func deleteEmailTemplate(input: DeleteEmailTemplateInput) async throws -> DeleteEmailTemplateOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteEmailTemplateInput, DeleteEmailTemplateOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// - `NotFoundException` : The resource you attempted to access doesn't exist.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func deleteMultiRegionEndpoint(input: DeleteMultiRegionEndpointInput) async throws -> DeleteMultiRegionEndpointOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .delete)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteMultiRegionEndpoint")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<DeleteMultiRegionEndpointInput, DeleteMultiRegionEndpointOutput>(DeleteMultiRegionEndpointInput.urlPathProvider(_:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteMultiRegionEndpointOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DeleteMultiRegionEndpointOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DeleteMultiRegionEndpointInput, DeleteMultiRegionEndpointOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DeleteMultiRegionEndpointInput, DeleteMultiRegionEndpointOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteMultiRegionEndpointInput, DeleteMultiRegionEndpointOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DeleteMultiRegionEndpoint")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func deleteSuppressedDestination(input: DeleteSuppressedDestinationInput) async throws -> DeleteSuppressedDestinationOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteSuppressedDestinationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteSuppressedDestinationInput, DeleteSuppressedDestinationOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// Performs the `DeleteTenant` operation on the `SESv2` service.
    ///
    ...
    /// - `NotFoundException` : The resource you attempted to access doesn't exist.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func deleteTenant(input: DeleteTenantInput) async throws -> DeleteTenantOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteTenant")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<DeleteTenantInput, DeleteTenantOutput>(DeleteTenantInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DeleteTenantInput, DeleteTenantOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DeleteTenantInput, DeleteTenantOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<DeleteTenantInput, DeleteTenantOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: DeleteTenantInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteTenantOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DeleteTenantOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DeleteTenantInput, DeleteTenantOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DeleteTenantInput, DeleteTenantOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteTenantInput, DeleteTenantOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "DeleteTenant")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `DeleteTenantResourceAssociation` operation on the `SESv2` service.
    ///
    ...
    /// - `NotFoundException` : The resource you attempted to access doesn't exist.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func deleteTenantResourceAssociation(input: DeleteTenantResourceAssociationInput) async throws -> DeleteTenantResourceAssociationOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "deleteTenantResourceAssociation")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<DeleteTenantResourceAssociationInput, DeleteTenantResourceAssociationOutput>(DeleteTenantResourceAssociationInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<DeleteTenantResourceAssociationInput, DeleteTenantResourceAssociationOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<DeleteTenantResourceAssociationInput, DeleteTenantResourceAssociationOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<DeleteTenantResourceAssociationInput, DeleteTenantResourceAssociationOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: DeleteTenantResourceAssociationInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteTenantResourceAssociationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<DeleteTenantResourceAssociationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<DeleteTenantResourceAssociationInput, DeleteTenantResourceAssociationOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<DeleteTenantResourceAssociationInput, DeleteTenantResourceAssociationOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteTenantResourceAssociationInput, DeleteTenantResourceAssociationOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getAccount(input: GetAccountInput) async throws -> GetAccountOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetAccountInput, GetAccountOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getBlacklistReports(input: GetBlacklistReportsInput) async throws -> GetBlacklistReportsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetBlacklistReportsInput, GetBlacklistReportsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getConfigurationSet(input: GetConfigurationSetInput) async throws -> GetConfigurationSetOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetConfigurationSetInput, GetConfigurationSetOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getConfigurationSetEventDestinations(input: GetConfigurationSetEventDestinationsInput) async throws -> GetConfigurationSetEventDestinationsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetConfigurationSetEventDestinationsInput, GetConfigurationSetEventDestinationsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getContact(input: GetContactInput) async throws -> GetContactOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetContactInput, GetContactOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getContactList(input: GetContactListInput) async throws -> GetContactListOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetContactListOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetContactListInput, GetContactListOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getCustomVerificationEmailTemplate(input: GetCustomVerificationEmailTemplateInput) async throws -> GetCustomVerificationEmailTemplateOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetCustomVerificationEmailTemplateInput, GetCustomVerificationEmailTemplateOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getDedicatedIp(input: GetDedicatedIpInput) async throws -> GetDedicatedIpOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDedicatedIpInput, GetDedicatedIpOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getDedicatedIpPool(input: GetDedicatedIpPoolInput) async throws -> GetDedicatedIpPoolOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetDedicatedIpPoolOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDedicatedIpPoolInput, GetDedicatedIpPoolOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getDedicatedIps(input: GetDedicatedIpsInput) async throws -> GetDedicatedIpsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDedicatedIpsInput, GetDedicatedIpsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getDeliverabilityDashboardOptions(input: GetDeliverabilityDashboardOptionsInput) async throws -> GetDeliverabilityDashboardOptionsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDeliverabilityDashboardOptionsInput, GetDeliverabilityDashboardOptionsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getDeliverabilityTestReport(input: GetDeliverabilityTestReportInput) async throws -> GetDeliverabilityTestReportOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDeliverabilityTestReportInput, GetDeliverabilityTestReportOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getDomainDeliverabilityCampaign(input: GetDomainDeliverabilityCampaignInput) async throws -> GetDomainDeliverabilityCampaignOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDomainDeliverabilityCampaignInput, GetDomainDeliverabilityCampaignOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getDomainStatisticsReport(input: GetDomainStatisticsReportInput) async throws -> GetDomainStatisticsReportOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetDomainStatisticsReportInput, GetDomainStatisticsReportOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// Performs the `GetEmailAddressInsights` operation on the `SESv2` service.
    ///
    ...
    ///
    /// - Parameter input: A request to return validation insights about an email address. (Type: `GetEmailAddressInsightsInput`)
    ///
    /// - Returns: Validation insights about an email address. (Type: `GetEmailAddressInsightsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    /// - `BadRequestException` : The input you provided is invalid.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func getEmailAddressInsights(input: GetEmailAddressInsightsInput) async throws -> GetEmailAddressInsightsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getEmailAddressInsights")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GetEmailAddressInsightsInput, GetEmailAddressInsightsOutput>(GetEmailAddressInsightsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetEmailAddressInsightsInput, GetEmailAddressInsightsOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetEmailAddressInsightsInput, GetEmailAddressInsightsOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<GetEmailAddressInsightsInput, GetEmailAddressInsightsOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: GetEmailAddressInsightsInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<GetEmailAddressInsightsInput, GetEmailAddressInsightsOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<GetEmailAddressInsightsOutput>(GetEmailAddressInsightsOutput.httpOutput(from:), GetEmailAddressInsightsOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<GetEmailAddressInsightsInput, GetEmailAddressInsightsOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<GetEmailAddressInsightsOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("SESv2", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetEmailAddressInsightsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetEmailAddressInsightsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetEmailAddressInsightsInput, GetEmailAddressInsightsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetEmailAddressInsightsInput, GetEmailAddressInsightsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetEmailAddressInsightsInput, GetEmailAddressInsightsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetEmailAddressInsights")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func getEmailIdentity(input: GetEmailIdentityInput) async throws -> GetEmailIdentityOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetEmailIdentityInput, GetEmailIdentityOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getEmailIdentityPolicies(input: GetEmailIdentityPoliciesInput) async throws -> GetEmailIdentityPoliciesOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetEmailIdentityPoliciesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetEmailIdentityPoliciesInput, GetEmailIdentityPoliciesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getEmailTemplate(input: GetEmailTemplateInput) async throws -> GetEmailTemplateOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetEmailTemplateInput, GetEmailTemplateOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getExportJob(input: GetExportJobInput) async throws -> GetExportJobOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetExportJobInput, GetExportJobOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getImportJob(input: GetImportJobInput) async throws -> GetImportJobOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetImportJobInput, GetImportJobOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func getMessageInsights(input: GetMessageInsightsInput) async throws -> GetMessageInsightsOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetMessageInsightsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetMessageInsightsInput, GetMessageInsightsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// - `NotFoundException` : The resource you attempted to access doesn't exist.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func getMultiRegionEndpoint(input: GetMultiRegionEndpointInput) async throws -> GetMultiRegionEndpointOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getMultiRegionEndpoint")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GetMultiRegionEndpointInput, GetMultiRegionEndpointOutput>(GetMultiRegionEndpointInput.urlPathProvider(_:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetMultiRegionEndpointOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetMultiRegionEndpointOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetMultiRegionEndpointInput, GetMultiRegionEndpointOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetMultiRegionEndpointInput, GetMultiRegionEndpointOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetMultiRegionEndpointInput, GetMultiRegionEndpointOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetMultiRegionEndpoint")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `GetReputationEntity` operation on the `SESv2` service.
    ///
    ...
    /// - `NotFoundException` : The resource you attempted to access doesn't exist.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func getReputationEntity(input: GetReputationEntityInput) async throws -> GetReputationEntityOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getReputationEntity")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GetReputationEntityInput, GetReputationEntityOutput>(GetReputationEntityInput.urlPathProvider(_:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetReputationEntityOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetReputationEntityOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetReputationEntityInput, GetReputationEntityOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetReputationEntityInput, GetReputationEntityOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetReputationEntityInput, GetReputationEntityOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetReputationEntity")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func getSuppressedDestination(input: GetSuppressedDestinationInput) async throws -> GetSuppressedDestinationOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetSuppressedDestinationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetSuppressedDestinationInput, GetSuppressedDestinationOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// - `NotFoundException` : The resource you attempted to access doesn't exist.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func getTenant(input: GetTenantInput) async throws -> GetTenantOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "getTenant")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<GetTenantInput, GetTenantOutput>(GetTenantInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<GetTenantInput, GetTenantOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<GetTenantInput, GetTenantOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<GetTenantInput, GetTenantOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: GetTenantInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetTenantOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<GetTenantOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<GetTenantInput, GetTenantOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<GetTenantInput, GetTenantOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<GetTenantInput, GetTenantOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "GetTenant")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func listConfigurationSets(input: ListConfigurationSetsInput) async throws -> ListConfigurationSetsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListConfigurationSetsInput, ListConfigurationSetsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listContactLists(input: ListContactListsInput) async throws -> ListContactListsOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListContactListsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListContactListsInput, ListContactListsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listContacts(input: ListContactsInput) async throws -> ListContactsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListContactsInput, ListContactsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listCustomVerificationEmailTemplates(input: ListCustomVerificationEmailTemplatesInput) async throws -> ListCustomVerificationEmailTemplatesOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListCustomVerificationEmailTemplatesInput, ListCustomVerificationEmailTemplatesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listDedicatedIpPools(input: ListDedicatedIpPoolsInput) async throws -> ListDedicatedIpPoolsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListDedicatedIpPoolsInput, ListDedicatedIpPoolsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listDeliverabilityTestReports(input: ListDeliverabilityTestReportsInput) async throws -> ListDeliverabilityTestReportsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListDeliverabilityTestReportsInput, ListDeliverabilityTestReportsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listDomainDeliverabilityCampaigns(input: ListDomainDeliverabilityCampaignsInput) async throws -> ListDomainDeliverabilityCampaignsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListDomainDeliverabilityCampaignsInput, ListDomainDeliverabilityCampaignsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listEmailIdentities(input: ListEmailIdentitiesInput) async throws -> ListEmailIdentitiesOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListEmailIdentitiesInput, ListEmailIdentitiesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listEmailTemplates(input: ListEmailTemplatesInput) async throws -> ListEmailTemplatesOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListEmailTemplatesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListEmailTemplatesInput, ListEmailTemplatesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listExportJobs(input: ListExportJobsInput) async throws -> ListExportJobsOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListExportJobsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListExportJobsInput, ListExportJobsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listImportJobs(input: ListImportJobsInput) async throws -> ListImportJobsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListImportJobsInput, ListImportJobsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// - `BadRequestException` : The input you provided is invalid.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func listMultiRegionEndpoints(input: ListMultiRegionEndpointsInput) async throws -> ListMultiRegionEndpointsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .get)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listMultiRegionEndpoints")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ListMultiRegionEndpointsInput, ListMultiRegionEndpointsOutput>(ListMultiRegionEndpointsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListMultiRegionEndpointsInput, ListMultiRegionEndpointsOutput>())
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListMultiRegionEndpointsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListMultiRegionEndpointsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListMultiRegionEndpointsInput, ListMultiRegionEndpointsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListMultiRegionEndpointsInput, ListMultiRegionEndpointsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListMultiRegionEndpointsInput, ListMultiRegionEndpointsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListMultiRegionEndpoints")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func listRecommendations(input: ListRecommendationsInput) async throws -> ListRecommendationsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListRecommendationsInput, ListRecommendationsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// Performs the `ListReputationEntities` operation on the `SESv2` service.
    ///
    ...
    /// - `BadRequestException` : The input you provided is invalid.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func listReputationEntities(input: ListReputationEntitiesInput) async throws -> ListReputationEntitiesOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listReputationEntities")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ListReputationEntitiesInput, ListReputationEntitiesOutput>(ListReputationEntitiesInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListReputationEntitiesInput, ListReputationEntitiesOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListReputationEntitiesInput, ListReputationEntitiesOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<ListReputationEntitiesInput, ListReputationEntitiesOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: ListReputationEntitiesInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListReputationEntitiesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListReputationEntitiesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListReputationEntitiesInput, ListReputationEntitiesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListReputationEntitiesInput, ListReputationEntitiesOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListReputationEntitiesInput, ListReputationEntitiesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListReputationEntities")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListResourceTenants` operation on the `SESv2` service.
    ///
    ...
    /// - `NotFoundException` : The resource you attempted to access doesn't exist.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func listResourceTenants(input: ListResourceTenantsInput) async throws -> ListResourceTenantsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listResourceTenants")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ListResourceTenantsInput, ListResourceTenantsOutput>(ListResourceTenantsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListResourceTenantsInput, ListResourceTenantsOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListResourceTenantsInput, ListResourceTenantsOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<ListResourceTenantsInput, ListResourceTenantsOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: ListResourceTenantsInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListResourceTenantsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListResourceTenantsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListResourceTenantsInput, ListResourceTenantsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListResourceTenantsInput, ListResourceTenantsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListResourceTenantsInput, ListResourceTenantsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListResourceTenants")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func listSuppressedDestinations(input: ListSuppressedDestinationsInput) async throws -> ListSuppressedDestinationsOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListSuppressedDestinationsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListSuppressedDestinationsInput, ListSuppressedDestinationsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// Performs the `ListTenantResources` operation on the `SESv2` service.
    ///
    ...
    /// - `NotFoundException` : The resource you attempted to access doesn't exist.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func listTenantResources(input: ListTenantResourcesInput) async throws -> ListTenantResourcesOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listTenantResources")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ListTenantResourcesInput, ListTenantResourcesOutput>(ListTenantResourcesInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListTenantResourcesInput, ListTenantResourcesOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListTenantResourcesInput, ListTenantResourcesOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<ListTenantResourcesInput, ListTenantResourcesOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: ListTenantResourcesInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListTenantResourcesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListTenantResourcesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListTenantResourcesInput, ListTenantResourcesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListTenantResourcesInput, ListTenantResourcesOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListTenantResourcesInput, ListTenantResourcesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListTenantResources")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `ListTenants` operation on the `SESv2` service.
    ///
    ...
    /// - `BadRequestException` : The input you provided is invalid.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func listTenants(input: ListTenantsInput) async throws -> ListTenantsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "listTenants")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<ListTenantsInput, ListTenantsOutput>(ListTenantsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<ListTenantsInput, ListTenantsOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<ListTenantsInput, ListTenantsOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<ListTenantsInput, ListTenantsOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: ListTenantsInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListTenantsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<ListTenantsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<ListTenantsInput, ListTenantsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<ListTenantsInput, ListTenantsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListTenantsInput, ListTenantsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "ListTenants")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func putAccountDedicatedIpWarmupAttributes(input: PutAccountDedicatedIpWarmupAttributesInput) async throws -> PutAccountDedicatedIpWarmupAttributesOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccountDedicatedIpWarmupAttributesInput, PutAccountDedicatedIpWarmupAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putAccountDetails(input: PutAccountDetailsInput) async throws -> PutAccountDetailsOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutAccountDetailsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccountDetailsInput, PutAccountDetailsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    ///
    /// - Returns: An HTTP 200 response if the request succeeds, or an error response if the request fails. (Type: `PutAccountPricingAttributesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    /// - `ConflictException` : If there is already an ongoing account details update under review.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func putAccountPricingAttributes(input: PutAccountPricingAttributesInput) async throws -> PutAccountPricingAttributesOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "putAccountPricingAttributes")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
                      ...
                      .withSigV4aSigningRegionSet(value: config.sigV4aSigningRegionSet)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<PutAccountPricingAttributesInput, PutAccountPricingAttributesOutput, SmithyHTTPAPI.HTTPRequest, SmithyHTTPAPI.HTTPResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<PutAccountPricingAttributesInput, PutAccountPricingAttributesOutput>(PutAccountPricingAttributesInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<PutAccountPricingAttributesInput, PutAccountPricingAttributesOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutAccountPricingAttributesInput, PutAccountPricingAttributesOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<PutAccountPricingAttributesInput, PutAccountPricingAttributesOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: PutAccountPricingAttributesInput.write(value:to:)))
        builder.interceptors.add(ClientRuntime.ContentLengthMiddleware<PutAccountPricingAttributesInput, PutAccountPricingAttributesOutput>())
        builder.deserialize(ClientRuntime.DeserializeMiddleware<PutAccountPricingAttributesOutput>(PutAccountPricingAttributesOutput.httpOutput(from:), PutAccountPricingAttributesOutputError.httpError(from:)))
        builder.interceptors.add(ClientRuntime.LoggerMiddleware<PutAccountPricingAttributesInput, PutAccountPricingAttributesOutput>(clientLogMode: config.clientLogMode))
        builder.clockSkewProvider(AWSClientRuntime.AWSClockSkewProvider.provider())
        builder.applySigner(ClientRuntime.SignerMiddleware<PutAccountPricingAttributesOutput>())
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("SESv2", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutAccountPricingAttributesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<PutAccountPricingAttributesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<PutAccountPricingAttributesInput, PutAccountPricingAttributesOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<PutAccountPricingAttributesInput, PutAccountPricingAttributesOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccountPricingAttributesInput, PutAccountPricingAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "PutAccountPricingAttributes")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func putAccountSendingAttributes(input: PutAccountSendingAttributesInput) async throws -> PutAccountSendingAttributesOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccountSendingAttributesInput, PutAccountSendingAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putAccountSuppressionAttributes(input: PutAccountSuppressionAttributesInput) async throws -> PutAccountSuppressionAttributesOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutAccountSuppressionAttributesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccountSuppressionAttributesInput, PutAccountSuppressionAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putAccountVdmAttributes(input: PutAccountVdmAttributesInput) async throws -> PutAccountVdmAttributesOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutAccountVdmAttributesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutAccountVdmAttributesInput, PutAccountVdmAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// Performs the `PutConfigurationSetArchivingOptions` operation on the `SESv2` service.
    ///
    ...
    /// - `NotFoundException` : The resource you attempted to access doesn't exist.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func putConfigurationSetArchivingOptions(input: PutConfigurationSetArchivingOptionsInput) async throws -> PutConfigurationSetArchivingOptionsOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "putConfigurationSetArchivingOptions")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<PutConfigurationSetArchivingOptionsInput, PutConfigurationSetArchivingOptionsOutput>(PutConfigurationSetArchivingOptionsInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<PutConfigurationSetArchivingOptionsInput, PutConfigurationSetArchivingOptionsOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<PutConfigurationSetArchivingOptionsInput, PutConfigurationSetArchivingOptionsOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<PutConfigurationSetArchivingOptionsInput, PutConfigurationSetArchivingOptionsOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: PutConfigurationSetArchivingOptionsInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutConfigurationSetArchivingOptionsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<PutConfigurationSetArchivingOptionsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<PutConfigurationSetArchivingOptionsInput, PutConfigurationSetArchivingOptionsOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<PutConfigurationSetArchivingOptionsInput, PutConfigurationSetArchivingOptionsOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutConfigurationSetArchivingOptionsInput, PutConfigurationSetArchivingOptionsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "PutConfigurationSetArchivingOptions")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    public func putConfigurationSetDeliveryOptions(input: PutConfigurationSetDeliveryOptionsInput) async throws -> PutConfigurationSetDeliveryOptionsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutConfigurationSetDeliveryOptionsInput, PutConfigurationSetDeliveryOptionsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putConfigurationSetReputationOptions(input: PutConfigurationSetReputationOptionsInput) async throws -> PutConfigurationSetReputationOptionsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutConfigurationSetReputationOptionsInput, PutConfigurationSetReputationOptionsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putConfigurationSetSendingOptions(input: PutConfigurationSetSendingOptionsInput) async throws -> PutConfigurationSetSendingOptionsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutConfigurationSetSendingOptionsInput, PutConfigurationSetSendingOptionsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putConfigurationSetSuppressionOptions(input: PutConfigurationSetSuppressionOptionsInput) async throws -> PutConfigurationSetSuppressionOptionsOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutConfigurationSetSuppressionOptionsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutConfigurationSetSuppressionOptionsInput, PutConfigurationSetSuppressionOptionsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putConfigurationSetTrackingOptions(input: PutConfigurationSetTrackingOptionsInput) async throws -> PutConfigurationSetTrackingOptionsOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutConfigurationSetTrackingOptionsInput, PutConfigurationSetTrackingOptionsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putConfigurationSetVdmOptions(input: PutConfigurationSetVdmOptionsInput) async throws -> PutConfigurationSetVdmOptionsOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutConfigurationSetVdmOptionsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutConfigurationSetVdmOptionsInput, PutConfigurationSetVdmOptionsOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putDedicatedIpInPool(input: PutDedicatedIpInPoolInput) async throws -> PutDedicatedIpInPoolOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutDedicatedIpInPoolInput, PutDedicatedIpInPoolOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putDedicatedIpPoolScalingAttributes(input: PutDedicatedIpPoolScalingAttributesInput) async throws -> PutDedicatedIpPoolScalingAttributesOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutDedicatedIpPoolScalingAttributesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutDedicatedIpPoolScalingAttributesInput, PutDedicatedIpPoolScalingAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putDedicatedIpWarmupAttributes(input: PutDedicatedIpWarmupAttributesInput) async throws -> PutDedicatedIpWarmupAttributesOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutDedicatedIpWarmupAttributesInput, PutDedicatedIpWarmupAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putDeliverabilityDashboardOption(input: PutDeliverabilityDashboardOptionInput) async throws -> PutDeliverabilityDashboardOptionOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutDeliverabilityDashboardOptionInput, PutDeliverabilityDashboardOptionOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putEmailIdentityConfigurationSetAttributes(input: PutEmailIdentityConfigurationSetAttributesInput) async throws -> PutEmailIdentityConfigurationSetAttributesOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutEmailIdentityConfigurationSetAttributesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutEmailIdentityConfigurationSetAttributesInput, PutEmailIdentityConfigurationSetAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putEmailIdentityDkimAttributes(input: PutEmailIdentityDkimAttributesInput) async throws -> PutEmailIdentityDkimAttributesOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutEmailIdentityDkimAttributesInput, PutEmailIdentityDkimAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putEmailIdentityDkimSigningAttributes(input: PutEmailIdentityDkimSigningAttributesInput) async throws -> PutEmailIdentityDkimSigningAttributesOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutEmailIdentityDkimSigningAttributesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutEmailIdentityDkimSigningAttributesInput, PutEmailIdentityDkimSigningAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putEmailIdentityFeedbackAttributes(input: PutEmailIdentityFeedbackAttributesInput) async throws -> PutEmailIdentityFeedbackAttributesOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutEmailIdentityFeedbackAttributesInput, PutEmailIdentityFeedbackAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putEmailIdentityMailFromAttributes(input: PutEmailIdentityMailFromAttributesInput) async throws -> PutEmailIdentityMailFromAttributesOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutEmailIdentityMailFromAttributesInput, PutEmailIdentityMailFromAttributesOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func putSuppressedDestination(input: PutSuppressedDestinationInput) async throws -> PutSuppressedDestinationOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutSuppressedDestinationOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutSuppressedDestinationInput, PutSuppressedDestinationOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func sendBulkEmail(input: SendBulkEmailInput) async throws -> SendBulkEmailOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<SendBulkEmailOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SendBulkEmailInput, SendBulkEmailOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func sendCustomVerificationEmail(input: SendCustomVerificationEmailInput) async throws -> SendCustomVerificationEmailOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SendCustomVerificationEmailInput, SendCustomVerificationEmailOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func sendEmail(input: SendEmailInput) async throws -> SendEmailOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<SendEmailInput, SendEmailOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TagResourceInput, TagResourceOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func testRenderEmailTemplate(input: TestRenderEmailTemplateInput) async throws -> TestRenderEmailTemplateOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<TestRenderEmailTemplateOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TestRenderEmailTemplateInput, TestRenderEmailTemplateOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UntagResourceInput, UntagResourceOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func updateConfigurationSetEventDestination(input: UpdateConfigurationSetEventDestinationInput) async throws -> UpdateConfigurationSetEventDestinationOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateConfigurationSetEventDestinationInput, UpdateConfigurationSetEventDestinationOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func updateContact(input: UpdateContactInput) async throws -> UpdateContactOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateContactInput, UpdateContactOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func updateContactList(input: UpdateContactListInput) async throws -> UpdateContactListOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateContactListOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateContactListInput, UpdateContactListOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func updateCustomVerificationEmailTemplate(input: UpdateCustomVerificationEmailTemplateInput) async throws -> UpdateCustomVerificationEmailTemplateOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateCustomVerificationEmailTemplateInput, UpdateCustomVerificationEmailTemplateOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func updateEmailIdentityPolicy(input: UpdateEmailIdentityPolicyInput) async throws -> UpdateEmailIdentityPolicyOutput {
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateEmailIdentityPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateEmailIdentityPolicyInput, UpdateEmailIdentityPolicyOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    public func updateEmailTemplate(input: UpdateEmailTemplateInput) async throws -> UpdateEmailTemplateOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateEmailTemplateInput, UpdateEmailTemplateOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
    ...
    /// Performs the `UpdateReputationEntityCustomerManagedStatus` operation on the `SESv2` service.
    ///
    ...
    /// - `ConflictException` : If there is already an ongoing account details update under review.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func updateReputationEntityCustomerManagedStatus(input: UpdateReputationEntityCustomerManagedStatusInput) async throws -> UpdateReputationEntityCustomerManagedStatusOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "updateReputationEntityCustomerManagedStatus")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<UpdateReputationEntityCustomerManagedStatusInput, UpdateReputationEntityCustomerManagedStatusOutput>(UpdateReputationEntityCustomerManagedStatusInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<UpdateReputationEntityCustomerManagedStatusInput, UpdateReputationEntityCustomerManagedStatusOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<UpdateReputationEntityCustomerManagedStatusInput, UpdateReputationEntityCustomerManagedStatusOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<UpdateReputationEntityCustomerManagedStatusInput, UpdateReputationEntityCustomerManagedStatusOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: UpdateReputationEntityCustomerManagedStatusInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateReputationEntityCustomerManagedStatusOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<UpdateReputationEntityCustomerManagedStatusOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<UpdateReputationEntityCustomerManagedStatusInput, UpdateReputationEntityCustomerManagedStatusOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<UpdateReputationEntityCustomerManagedStatusInput, UpdateReputationEntityCustomerManagedStatusOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateReputationEntityCustomerManagedStatusInput, UpdateReputationEntityCustomerManagedStatusOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "UpdateReputationEntityCustomerManagedStatus")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
    ...
    /// Performs the `UpdateReputationEntityPolicy` operation on the `SESv2` service.
    ///
    ...
    /// - `ConflictException` : If there is already an ongoing account details update under review.
    /// - `TooManyRequestsException` : Too many requests have been made to the operation.
    public func updateReputationEntityPolicy(input: UpdateReputationEntityPolicyInput) async throws -> UpdateReputationEntityPolicyOutput {
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .put)
                      .withServiceName(value: serviceName)
                      .withOperation(value: "updateReputationEntityPolicy")
                      .withUnsignedPayloadTrait(value: false)
                      .withSmithyDefaultConfig(config)
                      .withIdentityResolver(value: config.awsCredentialIdentityResolver, schemeID: "aws.auth#sigv4a")
                      .withRegion(value: config.region)
        ...
        builder.interceptors.add(ClientRuntime.URLPathMiddleware<UpdateReputationEntityPolicyInput, UpdateReputationEntityPolicyOutput>(UpdateReputationEntityPolicyInput.urlPathProvider(_:)))
        builder.interceptors.add(ClientRuntime.URLHostMiddleware<UpdateReputationEntityPolicyInput, UpdateReputationEntityPolicyOutput>())
        builder.interceptors.add(ClientRuntime.ContentTypeMiddleware<UpdateReputationEntityPolicyInput, UpdateReputationEntityPolicyOutput>(contentType: "application/json"))
        builder.serialize(ClientRuntime.BodyMiddleware<UpdateReputationEntityPolicyInput, UpdateReputationEntityPolicyOutput, SmithyJSON.Writer>(rootNodeInfo: "", inputWritingClosure: UpdateReputationEntityPolicyInput.write(value:to:)))
        ...
        context.set(key: Smithy.AttributeKey<EndpointParams>(name: "EndpointParams"), value: endpointParamsBlock(context))
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<UpdateReputationEntityPolicyOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.selectAuthScheme(ClientRuntime.AuthSchemeMiddleware<UpdateReputationEntityPolicyOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkInvocationIdMiddleware<UpdateReputationEntityPolicyInput, UpdateReputationEntityPolicyOutput>())
        builder.interceptors.add(AWSClientRuntime.AmzSdkRequestMiddleware<UpdateReputationEntityPolicyInput, UpdateReputationEntityPolicyOutput>(maxRetries: config.retryStrategyOptions.maxRetriesBase))
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "SESv2"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UpdateReputationEntityPolicyInput, UpdateReputationEntityPolicyOutput>(serviceID: serviceName, version: SESv2Client.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "SESv2")
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.method, value: "UpdateReputationEntityPolicy")
        let op = builder.attributes(context)
            .telemetry(ClientRuntime.OrchestratorTelemetry(
                telemetryProvider: config.telemetryProvider,
                metricsAttributes: metricsAttributes,
