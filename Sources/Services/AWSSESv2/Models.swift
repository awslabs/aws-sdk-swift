...
extension PutAccountDetailsInput {
    ...
    static func write(value: PutAccountDetailsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AdditionalContactEmailAddresses"].writeList(value.additionalContactEmailAddresses, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension PutAccountSuppressionAttributesInput {
    ...
    static func write(value: PutAccountSuppressionAttributesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["SuppressedReasons"].writeList(value.suppressedReasons, memberWritingClosure: SESv2ClientTypes.SuppressionListReason.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetBlacklistReportsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetBlacklistReportsOutput {
        ...
        value.blacklistReport = try reader["BlacklistReport"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: SESv2ClientTypes.BlacklistEntry.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension SESv2ClientTypes.MetricDataResult {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SESv2ClientTypes.MetricDataResult {
        ...
        value.values = try reader["Values"].readListIfPresent(memberReadingClosure: Swift.Int.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SESv2ClientTypes.SuppressionAttributes {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SESv2ClientTypes.SuppressionAttributes {
        ...
        value.suppressedReasons = try reader["SuppressedReasons"].readListIfPresent(memberReadingClosure: SESv2ClientTypes.SuppressionListReason.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SESv2ClientTypes.AccountDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SESv2ClientTypes.AccountDetails {
        ...
        value.additionalContactEmailAddresses = try reader["AdditionalContactEmailAddresses"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension SESv2ClientTypes.EventDestination {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SESv2ClientTypes.EventDestination {
        ...
        value.matchingEventTypes = try reader["MatchingEventTypes"].readListIfPresent(memberReadingClosure: SESv2ClientTypes.EventType.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension SESv2ClientTypes.MessageInsightsFilters {
    ...
    static func write(value: SESv2ClientTypes.MessageInsightsFilters?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Destination"].writeList(value.destination, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["FromEmailAddress"].writeList(value.fromEmailAddress, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Isp"].writeList(value.isp, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["LastDeliveryEvent"].writeList(value.lastDeliveryEvent, memberWritingClosure: SESv2ClientTypes.DeliveryEventType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["LastEngagementEvent"].writeList(value.lastEngagementEvent, memberWritingClosure: SESv2ClientTypes.EngagementEventType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Subject"].writeList(value.subject, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SESv2ClientTypes.MessageInsightsFilters {
        ...
        value.fromEmailAddress = try reader["FromEmailAddress"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.destination = try reader["Destination"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.subject = try reader["Subject"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.isp = try reader["Isp"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.lastDeliveryEvent = try reader["LastDeliveryEvent"].readListIfPresent(memberReadingClosure: SESv2ClientTypes.DeliveryEventType.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.lastEngagementEvent = try reader["LastEngagementEvent"].readListIfPresent(memberReadingClosure: SESv2ClientTypes.EngagementEventType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension SESv2ClientTypes.MetricsDataSource {
    ...
    static func write(value: SESv2ClientTypes.MetricsDataSource?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Dimensions"].writeMap(value.dimensions, valueWritingClosure: listWritingClosure(memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["EndDate"].writeTimestamp(value.endDate, format: .epochSeconds)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> SESv2ClientTypes.MetricsDataSource {
        ...
        value.dimensions = try reader["Dimensions"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension SESv2ClientTypes.EventDestinationDefinition {
    ...
    static func write(value: SESv2ClientTypes.EventDestinationDefinition?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["MatchingEventTypes"].writeList(value.matchingEventTypes, memberWritingClosure: SESv2ClientTypes.EventType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
