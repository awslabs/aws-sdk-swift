...
public final class PcaConnectorScepClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "PcaConnectorScepClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: PcaConnectorScepClient.PcaConnectorScepClientConfig
    let serviceName = "Pca Connector Scep"

    @available(*, deprecated, message: "Use PcaConnectorScepClient.PcaConnectorScepClientConfig instead")
    public typealias Config = PcaConnectorScepClient.PcaConnectorScepClientConfiguration
    public typealias Configuration = PcaConnectorScepClient.PcaConnectorScepClientConfig

    public required init(config: PcaConnectorScepClient.PcaConnectorScepClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: PcaConnectorScepClient.PcaConnectorScepClientConfig) instead")
    public convenience init(config: PcaConnectorScepClient.PcaConnectorScepClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try PcaConnectorScepClient.PcaConnectorScepClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await PcaConnectorScepClient.PcaConnectorScepClientConfig()
        self.init(config: config)
    }
}
...
extension PcaConnectorScepClient {
    ...
    /// Client configuration for PcaConnectorScepClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct PcaConnectorScepClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Pca Connector Scep")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultPcaConnectorScepAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: PcaConnectorScepClient.clientName)
        }
        ...
        public init(region: Swift.String) throws {
            try self.init(
                ...
                authSchemePreference: nil,
                authSchemeResolver: DefaultPcaConnectorScepAuthSchemeResolver(),
    ...
    @available(*, deprecated, message: "Use PcaConnectorScepClientConfig instead. This class will be removed in a future version.")
    public final class PcaConnectorScepClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> PcaConnectorScepClientConfig {
            return try PcaConnectorScepClientConfig(
...
extension PcaConnectorScepClient {
    ...
    public func createChallenge(input: CreateChallengeInput) async throws -> CreateChallengeOutput {
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Pca Connector Scep", config.ignoreConfiguredEndpointURLs)
        let endpointParamsBlock = { [config] (context: Smithy.Context) in
            EndpointParams(endpoint: configuredEndpoint, region: config.region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
        }
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<CreateChallengeOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Pca Connector Scep"))
    ...
    public func deleteChallenge(input: DeleteChallengeInput) async throws -> DeleteChallengeOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeleteChallengeOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func getChallengeMetadata(input: GetChallengeMetadataInput) async throws -> GetChallengeMetadataOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetChallengeMetadataOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func getChallengePassword(input: GetChallengePasswordInput) async throws -> GetChallengePasswordOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetChallengePasswordOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
    ...
    public func listChallengeMetadata(input: ListChallengeMetadataInput) async throws -> ListChallengeMetadataOutput {
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<ListChallengeMetadataOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
