...
extension CustomerProfilesClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> CustomerProfilesClient.CustomerProfilesClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> CustomerProfilesClient {
            let configuration = try await resolve(plugins: self.plugins)
            return CustomerProfilesClient(config: configuration)
        }
    }
...
extension CustomerProfilesClient.CustomerProfilesClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
