...
extension DrsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> DrsClient.DrsClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> DrsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return DrsClient(config: configuration)
        }
    }
...
extension DrsClient.DrsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
