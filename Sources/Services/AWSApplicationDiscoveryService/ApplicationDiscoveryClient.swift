...
extension ApplicationDiscoveryClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ApplicationDiscoveryClient.ApplicationDiscoveryClientConfiguration {
        let clientConfiguration = try await ApplicationDiscoveryClient.ApplicationDiscoveryClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ApplicationDiscoveryClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ApplicationDiscoveryClient(config: configuration)
        }
    }
...
extension ApplicationDiscoveryClient.ApplicationDiscoveryClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
