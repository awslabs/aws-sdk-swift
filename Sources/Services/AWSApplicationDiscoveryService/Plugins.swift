...
public class ApplicationDiscoveryClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ApplicationDiscoveryClient.ApplicationDiscoveryClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? ApplicationDiscoveryClient.ApplicationDiscoveryClientConfiguration {
            config.authSchemeResolver = DefaultApplicationDiscoveryServiceAuthSchemeResolver()
...
public class ApplicationDiscoveryClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: ApplicationDiscoveryServiceAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
