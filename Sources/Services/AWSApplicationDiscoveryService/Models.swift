...
extension AssociateConfigurationItemsToApplicationInput {
    ...
    static func write(value: AssociateConfigurationItemsToApplicationInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["configurationIds"].writeList(value.configurationIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension BatchDeleteImportDataInput {
    ...
    static func write(value: BatchDeleteImportDataInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["importTaskIds"].writeList(value.importTaskIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension ListServerNeighborsInput {
    ...
    static func write(value: ListServerNeighborsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["maxResults"].write(value.maxResults)
        try writer["neighborConfigurationIds"].writeList(value.neighborConfigurationIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["nextToken"].write(value.nextToken)
...
extension StartExportTaskInput {
    ...
    static func write(value: StartExportTaskInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["exportDataFormat"].writeList(value.exportDataFormat, memberWritingClosure: ApplicationDiscoveryClientTypes.ExportDataFormat.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["filters"].writeList(value.filters, memberWritingClosure: ApplicationDiscoveryClientTypes.ExportFilter.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeConfigurationsOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> DescribeConfigurationsOutput {
        ...
        value.configurations = try reader["configurations"].readListIfPresent(memberReadingClosure: mapReadingClosure(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension StartContinuousExportOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> StartContinuousExportOutput {
        ...
        value.schemaStorageConfig = try reader["schemaStorageConfig"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension ApplicationDiscoveryClientTypes.BatchDeleteConfigurationTask {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ApplicationDiscoveryClientTypes.BatchDeleteConfigurationTask {
        ...
        value.requestedConfigurations = try reader["requestedConfigurations"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.deletedConfigurations = try reader["deletedConfigurations"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ApplicationDiscoveryClientTypes.ExportInfo {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ApplicationDiscoveryClientTypes.ExportInfo {
        ...
        value.exportRequestTime = try reader["exportRequestTime"].readTimestampIfPresent(format: .epochSeconds)
        value.isTruncated = try reader["isTruncated"].readIfPresent() ?? false
        value.requestedStartTime = try reader["requestedStartTime"].readTimestampIfPresent(format: .epochSeconds)
        value.requestedEndTime = try reader["requestedEndTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension ApplicationDiscoveryClientTypes.ImportTask {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ApplicationDiscoveryClientTypes.ImportTask {
        ...
        value.status = try reader["status"].readIfPresent()
        value.importRequestTime = try reader["importRequestTime"].readTimestampIfPresent(format: .epochSeconds)
        value.importCompletionTime = try reader["importCompletionTime"].readTimestampIfPresent(format: .epochSeconds)
        value.importDeletedTime = try reader["importDeletedTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension ApplicationDiscoveryClientTypes.ConfigurationTag {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ApplicationDiscoveryClientTypes.ConfigurationTag {
        ...
        value.timeOfCreation = try reader["timeOfCreation"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
