...
extension HoneycodeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> HoneycodeClient.HoneycodeClientConfiguration {
        let clientConfiguration = try await HoneycodeClient.HoneycodeClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> HoneycodeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return HoneycodeClient(config: configuration)
        }
    }
...
extension HoneycodeClient.HoneycodeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
