...
extension MarketplaceEntitlementClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MarketplaceEntitlementClient.MarketplaceEntitlementClientConfiguration {
        let clientConfiguration = try await MarketplaceEntitlementClient.MarketplaceEntitlementClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MarketplaceEntitlementClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MarketplaceEntitlementClient(config: configuration)
        }
    }
...
extension MarketplaceEntitlementClient.MarketplaceEntitlementClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
