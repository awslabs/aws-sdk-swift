...
public struct MarketplaceEntitlementServiceAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol MarketplaceEntitlementServiceAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
