...
extension IoT1ClickProjectsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> IoT1ClickProjectsClient.IoT1ClickProjectsClientConfiguration {
        let clientConfiguration = try await IoT1ClickProjectsClient.IoT1ClickProjectsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> IoT1ClickProjectsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return IoT1ClickProjectsClient(config: configuration)
        }
    }
...
extension IoT1ClickProjectsClient.IoT1ClickProjectsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
