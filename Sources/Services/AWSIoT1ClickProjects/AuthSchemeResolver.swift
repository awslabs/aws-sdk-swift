...
public struct IoT1ClickProjectsAuthSchemeResolverParameters: ClientRuntime.AuthSchemeResolverParameters {
    public let operation: String
    // Region is used for SigV4 auth scheme
    public let region: String?
}

public protocol IoT1ClickProjectsAuthSchemeResolver: ClientRuntime.AuthSchemeResolver {
    // Intentionally empty.
