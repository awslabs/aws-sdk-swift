...
extension AssociateDeviceWithPlacementOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> AssociateDeviceWithPlacementOutput {
...
extension CreatePlacementOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> CreatePlacementOutput {
...
extension DeletePlacementOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DeletePlacementOutput {
...
extension DescribePlacementOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribePlacementOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
...
extension IoT1ClickProjectsClientTypes.DeviceTemplate {
    ...
    static func write(value: IoT1ClickProjectsClientTypes.DeviceTemplate?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["callbackOverrides"].writeMap(value.callbackOverrides, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> IoT1ClickProjectsClientTypes.DeviceTemplate {
        ...
        value.callbackOverrides = try reader["callbackOverrides"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension DisassociateDeviceFromPlacementOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DisassociateDeviceFromPlacementOutput {
...
extension GetDevicesInPlacementOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetDevicesInPlacementOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
        var value = GetDevicesInPlacementOutput()
        value.devices = try reader["devices"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension ListPlacementsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> ListPlacementsOutput {
        let data = try await httpResponse.data()
        let responseReader = try SmithyJSON.Reader.from(data: data)
        let reader = responseReader
...
extension IoT1ClickProjectsClientTypes.PlacementTemplate {
    ...
    static func write(value: IoT1ClickProjectsClientTypes.PlacementTemplate?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["defaultAttributes"].writeMap(value.defaultAttributes, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> IoT1ClickProjectsClientTypes.PlacementTemplate {
        ...
        value.defaultAttributes = try reader["defaultAttributes"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension UpdatePlacementOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdatePlacementOutput {
