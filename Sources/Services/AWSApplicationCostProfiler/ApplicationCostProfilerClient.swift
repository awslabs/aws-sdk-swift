...
extension ApplicationCostProfilerClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ApplicationCostProfilerClient.ApplicationCostProfilerClientConfiguration {
        let clientConfiguration = try await ApplicationCostProfilerClient.ApplicationCostProfilerClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ApplicationCostProfilerClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ApplicationCostProfilerClient(config: configuration)
        }
    }
...
extension ApplicationCostProfilerClient.ApplicationCostProfilerClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
