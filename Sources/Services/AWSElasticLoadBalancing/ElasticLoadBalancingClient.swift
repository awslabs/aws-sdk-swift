...
extension ElasticLoadBalancingClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ElasticLoadBalancingClient.ElasticLoadBalancingClientConfiguration {
        let clientConfiguration = try await ElasticLoadBalancingClient.ElasticLoadBalancingClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> ElasticLoadBalancingClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ElasticLoadBalancingClient(config: configuration)
        }
    }
...
extension ElasticLoadBalancingClient.ElasticLoadBalancingClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
