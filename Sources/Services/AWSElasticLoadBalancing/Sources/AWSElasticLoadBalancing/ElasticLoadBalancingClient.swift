...
public final class ElasticLoadBalancingClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: ElasticLoadBalancingClient.ElasticLoadBalancingClientConfig) instead")
    public convenience init(config: ElasticLoadBalancingClient.ElasticLoadBalancingClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ElasticLoadBalancingClient.ElasticLoadBalancingClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ElasticLoadBalancingClient.ElasticLoadBalancingClientConfig()
        self.init(config: config)
    }
}
...
extension ElasticLoadBalancingClient {
    ...
    /// Client configuration for ElasticLoadBalancingClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ElasticLoadBalancingClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Elastic Load Balancing")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ElasticLoadBalancingClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use ElasticLoadBalancingClientConfig instead. This class will be removed in a future version.")
    public final class ElasticLoadBalancingClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ElasticLoadBalancingClientConfig {
            return try ElasticLoadBalancingClientConfig(
...
extension ElasticLoadBalancingClient {
    ...
    public func addTags(input: AddTagsInput) async throws -> AddTagsOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Elastic Load Balancing"))
