...
extension ElasticLoadBalancingClientTypes.AccessLog: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.AccessLog {
...
extension ElasticLoadBalancingClientTypes.AdditionalAttribute: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.AdditionalAttribute {
...
extension ElasticLoadBalancingClientTypes.AppCookieStickinessPolicy: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.AppCookieStickinessPolicy {
...
extension ApplySecurityGroupsToLoadBalancerOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ApplySecurityGroupsToLoadBalancerOutput {
...
extension AttachLoadBalancerToSubnetsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> AttachLoadBalancerToSubnetsOutput {
        let reader = responseReader["AttachLoadBalancerToSubnetsResult"]
        var value = AttachLoadBalancerToSubnetsOutput()
        value.subnets = try reader["Subnets"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticLoadBalancingClientTypes.BackendServerDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.BackendServerDescription {
        ...
        value.policyNames = try reader["PolicyNames"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ConfigureHealthCheckOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> ConfigureHealthCheckOutput {
        let reader = responseReader["ConfigureHealthCheckResult"]
        var value = ConfigureHealthCheckOutput()
        value.healthCheck = try reader["HealthCheck"].readIfPresent(readingClosure: ElasticLoadBalancingClientTypes.HealthCheck.readingClosure(from:))
        return value
    }
}
...
extension ElasticLoadBalancingClientTypes.ConnectionDraining: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.ConnectionDraining {
...
extension ElasticLoadBalancingClientTypes.ConnectionSettings: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.ConnectionSettings {
...
extension CreateAppCookieStickinessPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateAppCookieStickinessPolicyOutput {
        let reader = responseReader["CreateAppCookieStickinessPolicyResult"]
        var value = CreateAppCookieStickinessPolicyOutput()
        return value
    }
}
...
extension CreateLBCookieStickinessPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateLBCookieStickinessPolicyOutput {
        let reader = responseReader["CreateLBCookieStickinessPolicyResult"]
        var value = CreateLBCookieStickinessPolicyOutput()
        return value
    }
}
...
extension CreateLoadBalancerListenersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateLoadBalancerListenersOutput {
        let reader = responseReader["CreateLoadBalancerListenersResult"]
        var value = CreateLoadBalancerListenersOutput()
        return value
    }
}
...
extension CreateLoadBalancerPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> CreateLoadBalancerPolicyOutput {
        let reader = responseReader["CreateLoadBalancerPolicyResult"]
        var value = CreateLoadBalancerPolicyOutput()
        return value
    }
}
...
extension ElasticLoadBalancingClientTypes.CrossZoneLoadBalancing: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.CrossZoneLoadBalancing {
...
extension DeleteLoadBalancerListenersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteLoadBalancerListenersOutput {
        let reader = responseReader["DeleteLoadBalancerListenersResult"]
        var value = DeleteLoadBalancerListenersOutput()
        return value
    }
}
...
extension DeleteLoadBalancerPolicyOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeleteLoadBalancerPolicyOutput {
        let reader = responseReader["DeleteLoadBalancerPolicyResult"]
        var value = DeleteLoadBalancerPolicyOutput()
        return value
    }
}
...
extension DeregisterInstancesFromLoadBalancerOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DeregisterInstancesFromLoadBalancerOutput {
        let reader = responseReader["DeregisterInstancesFromLoadBalancerResult"]
        var value = DeregisterInstancesFromLoadBalancerOutput()
        value.instances = try reader["Instances"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.Instance.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeAccountLimitsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeAccountLimitsOutput {
        ...
        value.limits = try reader["Limits"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.Limit.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeInstanceHealthOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeInstanceHealthOutput {
        let reader = responseReader["DescribeInstanceHealthResult"]
        var value = DescribeInstanceHealthOutput()
        value.instanceStates = try reader["InstanceStates"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.InstanceState.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeLoadBalancerAttributesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeLoadBalancerAttributesOutput {
        ...
        value.loadBalancerAttributes = try reader["LoadBalancerAttributes"].readIfPresent(readingClosure: ElasticLoadBalancingClientTypes.LoadBalancerAttributes.readingClosure(from:))
        return value
    }
}
...
extension DescribeLoadBalancerPoliciesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeLoadBalancerPoliciesOutput {
        let reader = responseReader["DescribeLoadBalancerPoliciesResult"]
        var value = DescribeLoadBalancerPoliciesOutput()
        value.policyDescriptions = try reader["PolicyDescriptions"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.PolicyDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeLoadBalancerPolicyTypesOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeLoadBalancerPolicyTypesOutput {
        let reader = responseReader["DescribeLoadBalancerPolicyTypesResult"]
        var value = DescribeLoadBalancerPolicyTypesOutput()
        value.policyTypeDescriptions = try reader["PolicyTypeDescriptions"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.PolicyTypeDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DescribeLoadBalancersOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeLoadBalancersOutput {
        ...
        value.loadBalancerDescriptions = try reader["LoadBalancerDescriptions"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.LoadBalancerDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.nextMarker = try reader["NextMarker"].readIfPresent()
        return value
    }
}
...
extension DescribeTagsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DescribeTagsOutput {
        ...
        value.tagDescriptions = try reader["TagDescriptions"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.TagDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension DetachLoadBalancerFromSubnetsOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DetachLoadBalancerFromSubnetsOutput {
...
extension DisableAvailabilityZonesForLoadBalancerOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> DisableAvailabilityZonesForLoadBalancerOutput {
        ...
        value.availabilityZones = try reader["AvailabilityZones"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension EnableAvailabilityZonesForLoadBalancerOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> EnableAvailabilityZonesForLoadBalancerOutput {
...
extension ElasticLoadBalancingClientTypes.HealthCheck: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.HealthCheck {
...
extension ElasticLoadBalancingClientTypes.Instance: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.Instance {
...
extension ElasticLoadBalancingClientTypes.InstanceState: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.InstanceState {
...
extension ElasticLoadBalancingClientTypes.LBCookieStickinessPolicy: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.LBCookieStickinessPolicy {
...
extension ElasticLoadBalancingClientTypes.Limit: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.Limit {
...
extension ElasticLoadBalancingClientTypes.Listener: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.Listener {
...
extension ElasticLoadBalancingClientTypes.ListenerDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.ListenerDescription {
        var value = ElasticLoadBalancingClientTypes.ListenerDescription()
        value.listener = try reader["Listener"].readIfPresent(readingClosure: ElasticLoadBalancingClientTypes.Listener.readingClosure(from:))
        value.policyNames = try reader["PolicyNames"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticLoadBalancingClientTypes.LoadBalancerAttributes: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.LoadBalancerAttributes {
        var value = ElasticLoadBalancingClientTypes.LoadBalancerAttributes()
        value.crossZoneLoadBalancing = try reader["CrossZoneLoadBalancing"].readIfPresent(readingClosure: ElasticLoadBalancingClientTypes.CrossZoneLoadBalancing.readingClosure(from:))
        value.accessLog = try reader["AccessLog"].readIfPresent(readingClosure: ElasticLoadBalancingClientTypes.AccessLog.readingClosure(from:))
        value.connectionDraining = try reader["ConnectionDraining"].readIfPresent(readingClosure: ElasticLoadBalancingClientTypes.ConnectionDraining.readingClosure(from:))
        value.connectionSettings = try reader["ConnectionSettings"].readIfPresent(readingClosure: ElasticLoadBalancingClientTypes.ConnectionSettings.readingClosure(from:))
        value.additionalAttributes = try reader["AdditionalAttributes"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.AdditionalAttribute.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticLoadBalancingClientTypes.LoadBalancerDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.LoadBalancerDescription {
        ...
        value.listenerDescriptions = try reader["ListenerDescriptions"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.ListenerDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.policies = try reader["Policies"].readIfPresent(readingClosure: ElasticLoadBalancingClientTypes.Policies.readingClosure(from:))
        value.backendServerDescriptions = try reader["BackendServerDescriptions"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.BackendServerDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.availabilityZones = try reader["AvailabilityZones"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.subnets = try reader["Subnets"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.vpcId = try reader["VPCId"].readIfPresent()
        value.instances = try reader["Instances"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.Instance.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.healthCheck = try reader["HealthCheck"].readIfPresent(readingClosure: ElasticLoadBalancingClientTypes.HealthCheck.readingClosure(from:))
        value.sourceSecurityGroup = try reader["SourceSecurityGroup"].readIfPresent(readingClosure: ElasticLoadBalancingClientTypes.SourceSecurityGroup.readingClosure(from:))
        value.securityGroups = try reader["SecurityGroups"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ElasticLoadBalancingClientTypes.Policies: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.Policies {
        var value = ElasticLoadBalancingClientTypes.Policies()
        value.appCookieStickinessPolicies = try reader["AppCookieStickinessPolicies"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.AppCookieStickinessPolicy.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.lbCookieStickinessPolicies = try reader["LBCookieStickinessPolicies"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.LBCookieStickinessPolicy.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        value.otherPolicies = try reader["OtherPolicies"].readListIfPresent(memberReadingClosure: Swift.String.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticLoadBalancingClientTypes.PolicyAttribute: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.PolicyAttribute {
...
extension ElasticLoadBalancingClientTypes.PolicyAttributeDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.PolicyAttributeDescription {
...
extension ElasticLoadBalancingClientTypes.PolicyAttributeTypeDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.PolicyAttributeTypeDescription {
...
extension ElasticLoadBalancingClientTypes.PolicyDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.PolicyDescription {
        var value = ElasticLoadBalancingClientTypes.PolicyDescription()
        value.policyName = try reader["PolicyName"].readIfPresent()
        value.policyTypeName = try reader["PolicyTypeName"].readIfPresent()
        value.policyAttributeDescriptions = try reader["PolicyAttributeDescriptions"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.PolicyAttributeDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticLoadBalancingClientTypes.PolicyTypeDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.PolicyTypeDescription {
        var value = ElasticLoadBalancingClientTypes.PolicyTypeDescription()
        value.policyTypeName = try reader["PolicyTypeName"].readIfPresent()
        value.description = try reader["Description"].readIfPresent()
        value.policyAttributeTypeDescriptions = try reader["PolicyAttributeTypeDescriptions"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.PolicyAttributeTypeDescription.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension RegisterInstancesWithLoadBalancerOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> RegisterInstancesWithLoadBalancerOutput {
...
extension SetLoadBalancerListenerSSLCertificateOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetLoadBalancerListenerSSLCertificateOutput {
        let reader = responseReader["SetLoadBalancerListenerSSLCertificateResult"]
        var value = SetLoadBalancerListenerSSLCertificateOutput()
        return value
    }
}
...
extension SetLoadBalancerPoliciesForBackendServerOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetLoadBalancerPoliciesForBackendServerOutput {
        let reader = responseReader["SetLoadBalancerPoliciesForBackendServerResult"]
        var value = SetLoadBalancerPoliciesForBackendServerOutput()
        return value
    }
}
...
extension SetLoadBalancerPoliciesOfListenerOutput {
    ...
    static func responseOutputBinding(httpResponse: ClientRuntime.HttpResponse, reader responseReader: SmithyXML.Reader) async throws -> SetLoadBalancerPoliciesOfListenerOutput {
        let reader = responseReader["SetLoadBalancerPoliciesOfListenerResult"]
        var value = SetLoadBalancerPoliciesOfListenerOutput()
        return value
    }
}
...
extension ElasticLoadBalancingClientTypes.SourceSecurityGroup: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.SourceSecurityGroup {
...
extension ElasticLoadBalancingClientTypes.Tag: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.Tag {
...
extension ElasticLoadBalancingClientTypes.TagDescription: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.TagDescription {
        var value = ElasticLoadBalancingClientTypes.TagDescription()
        value.loadBalancerName = try reader["LoadBalancerName"].readIfPresent()
        value.tags = try reader["Tags"].readListIfPresent(memberReadingClosure: ElasticLoadBalancingClientTypes.Tag.readingClosure(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ElasticLoadBalancingClientTypes.TagKeyOnly: Swift.Encodable {
    ...
    static func readingClosure(from reader: SmithyXML.Reader) throws -> ElasticLoadBalancingClientTypes.TagKeyOnly {
