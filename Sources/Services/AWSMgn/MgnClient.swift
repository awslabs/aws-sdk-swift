...
extension MgnClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> MgnClient.MgnClientConfiguration {
        let clientConfiguration = try await MgnClient.MgnClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> MgnClient {
            let configuration = try await resolve(plugins: self.plugins)
            return MgnClient(config: configuration)
        }
    }
...
extension MgnClient.MgnClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
