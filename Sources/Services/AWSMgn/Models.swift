...
extension PutSourceServerActionOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> PutSourceServerActionOutput {
        ...
        value.parameters = try reader["parameters"].readMapIfPresent(valueReadingClosure: listReadingClosure(memberReadingClosure: MgnClientTypes.SsmParameterStoreParameter.read(from:), memberNodeInfo: "member", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension MgnClientTypes.VcenterClient {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> MgnClientTypes.VcenterClient {
        ...
        value.sourceServerTags = try reader["sourceServerTags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
