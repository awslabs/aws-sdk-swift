...
extension ImagebuilderClientTypes.Component {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ImagebuilderClientTypes.Component {
        ...
        value.supportedOsVersions = try reader["supportedOsVersions"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ImagebuilderClientTypes.ComponentParameterDetail {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ImagebuilderClientTypes.ComponentParameterDetail {
        ...
        value.name = try reader["name"].readIfPresent()
        value.type = try reader["type"].readIfPresent()
        value.defaultValue = try reader["defaultValue"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.description = try reader["description"].readIfPresent()
        return value
    }
}
...
extension ImagebuilderClientTypes.Distribution {
    ...
    static func write(value: ImagebuilderClientTypes.Distribution?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["licenseConfigurationArns"].writeList(value.licenseConfigurationArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ImagebuilderClientTypes.Distribution {
        ...
        value.licenseConfigurationArns = try reader["licenseConfigurationArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ImagebuilderClientTypes.ContainerDistributionConfiguration {
    ...
    static func write(value: ImagebuilderClientTypes.ContainerDistributionConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["containerTags"].writeList(value.containerTags, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["description"].write(value.description)
        try writer["targetRepository"].write(value.targetRepository, with: ImagebuilderClientTypes.TargetContainerRepository.write(value:to:))
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ImagebuilderClientTypes.ContainerDistributionConfiguration {
        ...
        value.description = try reader["description"].readIfPresent()
        value.containerTags = try reader["containerTags"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.targetRepository = try reader["targetRepository"].readIfPresent(with: ImagebuilderClientTypes.TargetContainerRepository.read(from:))
        return value
    }
}
...
extension ImagebuilderClientTypes.AmiDistributionConfiguration {
    ...
    static func write(value: ImagebuilderClientTypes.AmiDistributionConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["amiTags"].writeMap(value.amiTags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["description"].write(value.description)
        try writer["kmsKeyId"].write(value.kmsKeyId)
        ...
        try writer["name"].write(value.name)
        try writer["targetAccountIds"].writeList(value.targetAccountIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ImagebuilderClientTypes.AmiDistributionConfiguration {
        ...
        value.name = try reader["name"].readIfPresent()
        value.description = try reader["description"].readIfPresent()
        value.targetAccountIds = try reader["targetAccountIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.amiTags = try reader["amiTags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.kmsKeyId = try reader["kmsKeyId"].readIfPresent()
...
extension ImagebuilderClientTypes.LaunchPermissionConfiguration {
    ...
    static func write(value: ImagebuilderClientTypes.LaunchPermissionConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["organizationArns"].writeList(value.organizationArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["organizationalUnitArns"].writeList(value.organizationalUnitArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["userGroups"].writeList(value.userGroups, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ImagebuilderClientTypes.LaunchPermissionConfiguration {
        ...
        value.userIds = try reader["userIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.userGroups = try reader["userGroups"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.organizationArns = try reader["organizationArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.organizationalUnitArns = try reader["organizationalUnitArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ImagebuilderClientTypes.Container {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ImagebuilderClientTypes.Container {
        ...
        value.region = try reader["region"].readIfPresent()
        value.imageUris = try reader["imageUris"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension ImagebuilderClientTypes.LifecyclePolicyResourceSelection {
    ...
    static func write(value: ImagebuilderClientTypes.LifecyclePolicyResourceSelection?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["tagMap"].writeMap(value.tagMap, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ImagebuilderClientTypes.LifecyclePolicyResourceSelection {
        ...
        value.tagMap = try reader["tagMap"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension ImagebuilderClientTypes.LifecyclePolicyDetailExclusionRulesAmis {
    ...
    static func write(value: ImagebuilderClientTypes.LifecyclePolicyDetailExclusionRulesAmis?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["sharedAccounts"].writeList(value.sharedAccounts, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["tagMap"].writeMap(value.tagMap, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ImagebuilderClientTypes.LifecyclePolicyDetailExclusionRulesAmis {
        ...
        value.sharedAccounts = try reader["sharedAccounts"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension ImagebuilderClientTypes.PackageVulnerabilityDetails {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> ImagebuilderClientTypes.PackageVulnerabilityDetails {
        ...
        value.relatedVulnerabilities = try reader["relatedVulnerabilities"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
