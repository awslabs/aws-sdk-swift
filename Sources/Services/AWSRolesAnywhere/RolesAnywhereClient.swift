...
extension RolesAnywhereClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> RolesAnywhereClient.RolesAnywhereClientConfiguration {
        let clientConfiguration = try await RolesAnywhereClient.RolesAnywhereClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> RolesAnywhereClient {
            let configuration = try await resolve(plugins: self.plugins)
            return RolesAnywhereClient(config: configuration)
        }
    }
...
extension RolesAnywhereClient.RolesAnywhereClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
