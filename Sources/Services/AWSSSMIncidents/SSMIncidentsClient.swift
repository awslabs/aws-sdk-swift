...
extension SSMIncidentsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> SSMIncidentsClient.SSMIncidentsClientConfiguration {
        let clientConfiguration = try await SSMIncidentsClient.SSMIncidentsClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> SSMIncidentsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return SSMIncidentsClient(config: configuration)
        }
    }
...
extension SSMIncidentsClient.SSMIncidentsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
