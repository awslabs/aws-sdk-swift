...
public class AmplifyUIBuilderClientEndpointPlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? AmplifyUIBuilderClient.AmplifyUIBuilderClientConfiguration {
...
public class DefaultAWSAuthSchemePlugin: Plugin {
    ...
    public func configureClient(clientConfiguration: ClientRuntime.ClientConfiguration) throws {
        if let config = clientConfiguration as? AmplifyUIBuilderClient.AmplifyUIBuilderClientConfiguration {
            config.authSchemeResolver = DefaultAmplifyUIBuilderAuthSchemeResolver()
...
public class AmplifyUIBuilderClientAuthSchemePlugin: Plugin {
    ...
    public init(authSchemes: [SmithyHTTPAuthAPI.AuthScheme]? = nil, authSchemeResolver: AmplifyUIBuilderAuthSchemeResolver? = nil, awsCredentialIdentityResolver: (any SmithyIdentityAPI.AWSCredentialIdentityResolver)? = nil) {
