...
extension GetMetadataOutput {
    ...
    static func httpOutput(from httpResponse: SmithyHTTPAPI.HttpResponse) async throws -> GetMetadataOutput {
        ...
        value.features = try reader["features"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension AmplifyUIBuilderClientTypes.Component {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AmplifyUIBuilderClientTypes.Component {
        ...
        value.overrides = try reader["overrides"].readMapIfPresent(valueReadingClosure: mapReadingClosure(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension AmplifyUIBuilderClientTypes.ComponentDataConfiguration {
    ...
    static func write(value: AmplifyUIBuilderClientTypes.ComponentDataConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["identifiers"].writeList(value.identifiers, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["model"].write(value.model)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AmplifyUIBuilderClientTypes.ComponentDataConfiguration {
        ...
        value.identifiers = try reader["identifiers"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension AmplifyUIBuilderClientTypes.ComponentVariant {
    ...
    static func write(value: AmplifyUIBuilderClientTypes.ComponentVariant?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["overrides"].writeMap(value.overrides, valueWritingClosure: mapWritingClosure(valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["variantValues"].writeMap(value.variantValues, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AmplifyUIBuilderClientTypes.ComponentVariant {
        ...
        value.variantValues = try reader["variantValues"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.overrides = try reader["overrides"].readMapIfPresent(valueReadingClosure: mapReadingClosure(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension AmplifyUIBuilderClientTypes.FieldValidationConfiguration {
    ...
    static func write(value: AmplifyUIBuilderClientTypes.FieldValidationConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["numValues"].writeList(value.numValues, memberWritingClosure: Swift.Int.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["strValues"].writeList(value.strValues, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["type"].write(value.type)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AmplifyUIBuilderClientTypes.FieldValidationConfiguration {
        ...
        value.type = try reader["type"].readIfPresent()
        value.strValues = try reader["strValues"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.numValues = try reader["numValues"].readListIfPresent(memberReadingClosure: Swift.Int.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AmplifyUIBuilderClientTypes.FileUploaderFieldConfig {
    ...
    static func write(value: AmplifyUIBuilderClientTypes.FileUploaderFieldConfig?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["acceptedFileTypes"].writeList(value.acceptedFileTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AmplifyUIBuilderClientTypes.FileUploaderFieldConfig {
        ...
        value.acceptedFileTypes = try reader["acceptedFileTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AmplifyUIBuilderClientTypes.CodegenGenericDataRelationshipType {
    ...
    static func write(value: AmplifyUIBuilderClientTypes.CodegenGenericDataRelationshipType?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["associatedFields"].writeList(value.associatedFields, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["relatedModelFields"].writeList(value.relatedModelFields, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AmplifyUIBuilderClientTypes.CodegenGenericDataRelationshipType {
        ...
        value.relatedModelFields = try reader["relatedModelFields"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.associatedFields = try reader["associatedFields"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension AmplifyUIBuilderClientTypes.CodegenGenericDataModel {
    ...
    static func write(value: AmplifyUIBuilderClientTypes.CodegenGenericDataModel?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["primaryKeys"].writeList(value.primaryKeys, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AmplifyUIBuilderClientTypes.CodegenGenericDataModel {
        ...
        value.primaryKeys = try reader["primaryKeys"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension AmplifyUIBuilderClientTypes.ReactStartCodegenJobData {
    ...
    static func write(value: AmplifyUIBuilderClientTypes.ReactStartCodegenJobData?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["dependencies"].writeMap(value.dependencies, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> AmplifyUIBuilderClientTypes.ReactStartCodegenJobData {
        ...
        value.dependencies = try reader["dependencies"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
