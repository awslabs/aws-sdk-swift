...
extension VPCLatticeClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> VPCLatticeClient.VPCLatticeClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> VPCLatticeClient {
            let configuration = try await resolve(plugins: self.plugins)
            return VPCLatticeClient(config: configuration)
        }
    }
...
extension VPCLatticeClient.VPCLatticeClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
