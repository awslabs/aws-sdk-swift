...
public final class ApplicationAutoScalingClient: AWSClientRuntime.AWSServiceClient {
    ...
    public let config: ApplicationAutoScalingClient.ApplicationAutoScalingClientConfig
    let serviceName = "Application Auto Scaling"
    let retryStrategy: SmithyRetries.DefaultRetryStrategy

    @available(*, deprecated, message: "Use ApplicationAutoScalingClient.ApplicationAutoScalingClientConfig instead")
    public typealias Config = ApplicationAutoScalingClient.ApplicationAutoScalingClientConfiguration
    public typealias Configuration = ApplicationAutoScalingClient.ApplicationAutoScalingClientConfig

    public required init(config: ApplicationAutoScalingClient.ApplicationAutoScalingClientConfig) {
    ...
    @available(*, deprecated, message: "Use init(config: ApplicationAutoScalingClient.ApplicationAutoScalingClientConfig) instead")
    public convenience init(config: ApplicationAutoScalingClient.ApplicationAutoScalingClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ApplicationAutoScalingClient.ApplicationAutoScalingClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ApplicationAutoScalingClient.ApplicationAutoScalingClientConfig()
        self.init(config: config)
    }
}
...
extension ApplicationAutoScalingClient {
    ...
    /// Client configuration for ApplicationAutoScalingClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ApplicationAutoScalingClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "Application Auto Scaling")
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ApplicationAutoScalingClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use ApplicationAutoScalingClientConfig instead. This class will be removed in a future version.")
    public final class ApplicationAutoScalingClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ApplicationAutoScalingClientConfig {
            return try ApplicationAutoScalingClientConfig(
...
extension ApplicationAutoScalingClient {
    ...
    public func deleteScalingPolicy(input: DeleteScalingPolicyInput) async throws -> DeleteScalingPolicyOutput {
        ...
        let operation = ApplicationAutoScalingClient.deleteScalingPolicyOperation
        ...
        let configuredEndpoint = try config.endpoint ?? AWSClientRuntime.AWSClientConfigDefaultsProvider.configuredEndpoint("Application Auto Scaling", config.ignoreConfiguredEndpointURLs)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteScalingPolicyInput, DeleteScalingPolicyOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.DeleteScalingPolicy"]))
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteScalingPolicyInput, DeleteScalingPolicyOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
    ...
    public func deleteScheduledAction(input: DeleteScheduledActionInput) async throws -> DeleteScheduledActionOutput {
        ...
        let operation = ApplicationAutoScalingClient.deleteScheduledActionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeleteScheduledActionInput, DeleteScheduledActionOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.DeleteScheduledAction"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteScheduledActionInput, DeleteScheduledActionOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DeregisterScalableTargetInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DeregisterScalableTargetOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func deregisterScalableTarget(input: DeregisterScalableTargetInput) async throws -> DeregisterScalableTargetOutput {
        ...
        let operation = ApplicationAutoScalingClient.deregisterScalableTargetOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DeregisterScalableTargetOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DeregisterScalableTargetInput, DeregisterScalableTargetOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.DeregisterScalableTarget"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeregisterScalableTargetInput, DeregisterScalableTargetOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeScalableTargetsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeScalableTargetsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeScalableTargets(input: DescribeScalableTargetsInput) async throws -> DescribeScalableTargetsOutput {
        ...
        let operation = ApplicationAutoScalingClient.describeScalableTargetsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeScalableTargetsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeScalableTargetsInput, DescribeScalableTargetsOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.DescribeScalableTargets"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeScalableTargetsInput, DescribeScalableTargetsOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeScalingActivitiesInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeScalingActivitiesOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeScalingActivities(input: DescribeScalingActivitiesInput) async throws -> DescribeScalingActivitiesOutput {
        ...
        let operation = ApplicationAutoScalingClient.describeScalingActivitiesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeScalingActivitiesOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeScalingActivitiesInput, DescribeScalingActivitiesOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.DescribeScalingActivities"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeScalingActivitiesInput, DescribeScalingActivitiesOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    public func describeScalingPolicies(input: DescribeScalingPoliciesInput) async throws -> DescribeScalingPoliciesOutput {
        ...
        let operation = ApplicationAutoScalingClient.describeScalingPoliciesOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeScalingPoliciesInput, DescribeScalingPoliciesOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.DescribeScalingPolicies"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeScalingPoliciesInput, DescribeScalingPoliciesOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `DescribeScheduledActionsInput`)
    ///
    /// - Returns: [no documentation found] (Type: `DescribeScheduledActionsOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func describeScheduledActions(input: DescribeScheduledActionsInput) async throws -> DescribeScheduledActionsOutput {
        ...
        let operation = ApplicationAutoScalingClient.describeScheduledActionsOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<DescribeScheduledActionsOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<DescribeScheduledActionsInput, DescribeScheduledActionsOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.DescribeScheduledActions"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DescribeScheduledActionsInput, DescribeScheduledActionsOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `GetPredictiveScalingForecastInput`)
    ///
    /// - Returns: [no documentation found] (Type: `GetPredictiveScalingForecastOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func getPredictiveScalingForecast(input: GetPredictiveScalingForecastInput) async throws -> GetPredictiveScalingForecastOutput {
        ...
        let operation = ApplicationAutoScalingClient.getPredictiveScalingForecastOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<GetPredictiveScalingForecastOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<GetPredictiveScalingForecastInput, GetPredictiveScalingForecastOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.GetPredictiveScalingForecast"]))
    ...
    public func listTagsForResource(input: ListTagsForResourceInput) async throws -> ListTagsForResourceOutput {
        ...
        let operation = ApplicationAutoScalingClient.listTagsForResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.ListTagsForResource"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    public func putScalingPolicy(input: PutScalingPolicyInput) async throws -> PutScalingPolicyOutput {
        ...
        let operation = ApplicationAutoScalingClient.putScalingPolicyOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutScalingPolicyInput, PutScalingPolicyOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.PutScalingPolicy"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutScalingPolicyInput, PutScalingPolicyOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `PutScheduledActionInput`)
    ///
    /// - Returns: [no documentation found] (Type: `PutScheduledActionOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func putScheduledAction(input: PutScheduledActionInput) async throws -> PutScheduledActionOutput {
        ...
        let operation = ApplicationAutoScalingClient.putScheduledActionOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<PutScheduledActionOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<PutScheduledActionInput, PutScheduledActionOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.PutScheduledAction"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<PutScheduledActionInput, PutScheduledActionOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    ///
    /// - Parameter input: [no documentation found] (Type: `RegisterScalableTargetInput`)
    ///
    /// - Returns: [no documentation found] (Type: `RegisterScalableTargetOutput`)
    ///
    /// - Throws: One of the exceptions listed below __Possible Exceptions__.
    ///
    /// __Possible Exceptions:__
    ...
    public func registerScalableTarget(input: RegisterScalableTargetInput) async throws -> RegisterScalableTargetOutput {
        ...
        let operation = ApplicationAutoScalingClient.registerScalableTargetOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.applyEndpoint(AWSClientRuntime.AWSEndpointResolverMiddleware<RegisterScalableTargetOutput, EndpointParams>(paramsBlock: endpointParamsBlock, resolverBlock: { [config] in try config.endpointResolver.resolve(params: $0) }))
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<RegisterScalableTargetInput, RegisterScalableTargetOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.RegisterScalableTarget"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<RegisterScalableTargetInput, RegisterScalableTargetOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    public func tagResource(input: TagResourceInput) async throws -> TagResourceOutput {
        ...
        let operation = ApplicationAutoScalingClient.tagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<TagResourceInput, TagResourceOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.TagResource"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<TagResourceInput, TagResourceOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
    ...
    public func untagResource(input: UntagResourceInput) async throws -> UntagResourceOutput {
        ...
        let operation = ApplicationAutoScalingClient.untagResourceOperation
        let context = Smithy.ContextBuilder()
                      .withMethod(value: .post)
                      .withServiceName(value: serviceName)
        ...
        builder.interceptors.add(ClientRuntime.MutateHeadersMiddleware<UntagResourceInput, UntagResourceOutput>(overrides: ["X-Amz-Target": "AnyScaleFrontendService.UntagResource"]))
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "Application Auto Scaling"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<UntagResourceInput, UntagResourceOutput>(serviceID: serviceName, version: ApplicationAutoScalingClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "ApplicationAutoScaling")
