...
public final class WorkSpacesWebClient: AWSClientRuntime.AWSServiceClient {
    public static let clientName = "WorkSpacesWebClient"
    let client: ClientRuntime.SdkHttpClient
    public let config: WorkSpacesWebClient.WorkSpacesWebClientConfig
    let serviceName = "WorkSpaces Web"

    @available(*, deprecated, message: "Use WorkSpacesWebClient.WorkSpacesWebClientConfig instead")
    public typealias Config = WorkSpacesWebClient.WorkSpacesWebClientConfiguration
    public typealias Configuration = WorkSpacesWebClient.WorkSpacesWebClientConfig

    public required init(config: WorkSpacesWebClient.WorkSpacesWebClientConfig) {
        ClientRuntime.initialize()
        client = ClientRuntime.SdkHttpClient(engine: config.httpClientEngine, config: config.httpClientConfiguration)
        self.config = config
    }

    @available(*, deprecated, message: "Use init(config: WorkSpacesWebClient.WorkSpacesWebClientConfig) instead")
    public convenience init(config: WorkSpacesWebClient.WorkSpacesWebClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try WorkSpacesWebClient.WorkSpacesWebClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await WorkSpacesWebClient.WorkSpacesWebClientConfig()
        self.init(config: config)
    }
}
...
extension WorkSpacesWebClient {
    ...
    /// Client configuration for WorkSpacesWebClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct WorkSpacesWebClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "WorkSpaces Web")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultWorkSpacesWebAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: WorkSpacesWebClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use WorkSpacesWebClientConfig instead. This class will be removed in a future version.")
    public final class WorkSpacesWebClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> WorkSpacesWebClientConfig {
            return try WorkSpacesWebClientConfig(
...
extension WorkSpacesWebClient {
    ...
    public func associateBrowserSettings(input: AssociateBrowserSettingsInput) async throws -> AssociateBrowserSettingsOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "WorkSpaces Web"))
