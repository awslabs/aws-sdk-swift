...
extension CreateTrustStoreInput {
    ...
    static func write(value: CreateTrustStoreInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["certificateList"].writeList(value.certificateList, memberWritingClosure: Foundation.Data.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["clientToken"].write(value.clientToken)
        try writer["tags"].writeList(value.tags, memberWritingClosure: WorkSpacesWebClientTypes.Tag.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension UpdateTrustStoreInput {
    ...
    static func write(value: UpdateTrustStoreInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["certificatesToAdd"].writeList(value.certificatesToAdd, memberWritingClosure: Foundation.Data.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["certificatesToDelete"].writeList(value.certificatesToDelete, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["clientToken"].write(value.clientToken)
    }
}
...
extension WorkSpacesWebClientTypes.BrowserSettings {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkSpacesWebClientTypes.BrowserSettings {
        ...
        value.browserSettingsArn = try reader["browserSettingsArn"].readIfPresent()
        value.associatedPortalArns = try reader["associatedPortalArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.additionalEncryptionContext = try reader["additionalEncryptionContext"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension WorkSpacesWebClientTypes.IdentityProvider {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkSpacesWebClientTypes.IdentityProvider {
        ...
        value.identityProviderDetails = try reader["identityProviderDetails"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension WorkSpacesWebClientTypes.Certificate {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> WorkSpacesWebClientTypes.Certificate {
        ...
        value.notValidBefore = try reader["notValidBefore"].readTimestampIfPresent(format: .epochSeconds)
        value.notValidAfter = try reader["notValidAfter"].readTimestampIfPresent(format: .epochSeconds)
