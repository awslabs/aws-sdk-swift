...
extension PaginatorSequence where OperationStackInput == ListAssociationsInput, OperationStackOutput == ListAssociationsOutput {
    ...
    /// to access the nested member `[ChatbotClientTypes.AssociationListing]`
    /// - Returns: `[ChatbotClientTypes.AssociationListing]`
    public func associations() async throws -> [ChatbotClientTypes.AssociationListing] {
