...
extension ChatbotClient {
    ...
    public func createChimeWebhookConfiguration(input: CreateChimeWebhookConfigurationInput) async throws -> CreateChimeWebhookConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateChimeWebhookConfigurationInput, CreateChimeWebhookConfigurationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateChimeWebhookConfigurationInput, CreateChimeWebhookConfigurationOutput> = provider.create()
    ...
    public func createMicrosoftTeamsChannelConfiguration(input: CreateMicrosoftTeamsChannelConfigurationInput) async throws -> CreateMicrosoftTeamsChannelConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateMicrosoftTeamsChannelConfigurationInput, CreateMicrosoftTeamsChannelConfigurationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<CreateMicrosoftTeamsChannelConfigurationInput, CreateMicrosoftTeamsChannelConfigurationOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func createSlackChannelConfiguration(input: CreateSlackChannelConfigurationInput) async throws -> CreateSlackChannelConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<CreateSlackChannelConfigurationInput, CreateSlackChannelConfigurationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
    ...
    public func deleteChimeWebhookConfiguration(input: DeleteChimeWebhookConfigurationInput) async throws -> DeleteChimeWebhookConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteChimeWebhookConfigurationInput, DeleteChimeWebhookConfigurationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteChimeWebhookConfigurationInput, DeleteChimeWebhookConfigurationOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func deleteMicrosoftTeamsChannelConfiguration(input: DeleteMicrosoftTeamsChannelConfigurationInput) async throws -> DeleteMicrosoftTeamsChannelConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteMicrosoftTeamsChannelConfigurationInput, DeleteMicrosoftTeamsChannelConfigurationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteMicrosoftTeamsChannelConfigurationInput, DeleteMicrosoftTeamsChannelConfigurationOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func deleteMicrosoftTeamsConfiguredTeam(input: DeleteMicrosoftTeamsConfiguredTeamInput) async throws -> DeleteMicrosoftTeamsConfiguredTeamOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteMicrosoftTeamsConfiguredTeamInput, DeleteMicrosoftTeamsConfiguredTeamOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteMicrosoftTeamsConfiguredTeamInput, DeleteMicrosoftTeamsConfiguredTeamOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func deleteMicrosoftTeamsUserIdentity(input: DeleteMicrosoftTeamsUserIdentityInput) async throws -> DeleteMicrosoftTeamsUserIdentityOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteMicrosoftTeamsUserIdentityInput, DeleteMicrosoftTeamsUserIdentityOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteMicrosoftTeamsUserIdentityInput, DeleteMicrosoftTeamsUserIdentityOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func deleteSlackChannelConfiguration(input: DeleteSlackChannelConfigurationInput) async throws -> DeleteSlackChannelConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteSlackChannelConfigurationInput, DeleteSlackChannelConfigurationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
    ...
    public func deleteSlackUserIdentity(input: DeleteSlackUserIdentityInput) async throws -> DeleteSlackUserIdentityOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteSlackUserIdentityInput, DeleteSlackUserIdentityOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteSlackUserIdentityInput, DeleteSlackUserIdentityOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func deleteSlackWorkspaceAuthorization(input: DeleteSlackWorkspaceAuthorizationInput) async throws -> DeleteSlackWorkspaceAuthorizationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DeleteSlackWorkspaceAuthorizationInput, DeleteSlackWorkspaceAuthorizationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DeleteSlackWorkspaceAuthorizationInput, DeleteSlackWorkspaceAuthorizationOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func describeChimeWebhookConfigurations(input: DescribeChimeWebhookConfigurationsInput) async throws -> DescribeChimeWebhookConfigurationsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DescribeChimeWebhookConfigurationsInput, DescribeChimeWebhookConfigurationsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeChimeWebhookConfigurationsInput, DescribeChimeWebhookConfigurationsOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func describeSlackChannelConfigurations(input: DescribeSlackChannelConfigurationsInput) async throws -> DescribeSlackChannelConfigurationsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DescribeSlackChannelConfigurationsInput, DescribeSlackChannelConfigurationsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeSlackChannelConfigurationsInput, DescribeSlackChannelConfigurationsOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func describeSlackUserIdentities(input: DescribeSlackUserIdentitiesInput) async throws -> DescribeSlackUserIdentitiesOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DescribeSlackUserIdentitiesInput, DescribeSlackUserIdentitiesOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeSlackUserIdentitiesInput, DescribeSlackUserIdentitiesOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func describeSlackWorkspaces(input: DescribeSlackWorkspacesInput) async throws -> DescribeSlackWorkspacesOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<DescribeSlackWorkspacesInput, DescribeSlackWorkspacesOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<DescribeSlackWorkspacesInput, DescribeSlackWorkspacesOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func getAccountPreferences(input: GetAccountPreferencesInput) async throws -> GetAccountPreferencesOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetAccountPreferencesInput, GetAccountPreferencesOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetAccountPreferencesInput, GetAccountPreferencesOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func getMicrosoftTeamsChannelConfiguration(input: GetMicrosoftTeamsChannelConfigurationInput) async throws -> GetMicrosoftTeamsChannelConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<GetMicrosoftTeamsChannelConfigurationInput, GetMicrosoftTeamsChannelConfigurationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<GetMicrosoftTeamsChannelConfigurationInput, GetMicrosoftTeamsChannelConfigurationOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func listMicrosoftTeamsChannelConfigurations(input: ListMicrosoftTeamsChannelConfigurationsInput) async throws -> ListMicrosoftTeamsChannelConfigurationsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListMicrosoftTeamsChannelConfigurationsInput, ListMicrosoftTeamsChannelConfigurationsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListMicrosoftTeamsChannelConfigurationsInput, ListMicrosoftTeamsChannelConfigurationsOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func listMicrosoftTeamsConfiguredTeams(input: ListMicrosoftTeamsConfiguredTeamsInput) async throws -> ListMicrosoftTeamsConfiguredTeamsOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListMicrosoftTeamsConfiguredTeamsInput, ListMicrosoftTeamsConfiguredTeamsOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListMicrosoftTeamsConfiguredTeamsInput, ListMicrosoftTeamsConfiguredTeamsOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func listMicrosoftTeamsUserIdentities(input: ListMicrosoftTeamsUserIdentitiesInput) async throws -> ListMicrosoftTeamsUserIdentitiesOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<ListMicrosoftTeamsUserIdentitiesInput, ListMicrosoftTeamsUserIdentitiesOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<ListMicrosoftTeamsUserIdentitiesInput, ListMicrosoftTeamsUserIdentitiesOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func updateAccountPreferences(input: UpdateAccountPreferencesInput) async throws -> UpdateAccountPreferencesOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateAccountPreferencesInput, UpdateAccountPreferencesOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateAccountPreferencesInput, UpdateAccountPreferencesOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func updateChimeWebhookConfiguration(input: UpdateChimeWebhookConfigurationInput) async throws -> UpdateChimeWebhookConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateChimeWebhookConfigurationInput, UpdateChimeWebhookConfigurationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateChimeWebhookConfigurationInput, UpdateChimeWebhookConfigurationOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func updateMicrosoftTeamsChannelConfiguration(input: UpdateMicrosoftTeamsChannelConfigurationInput) async throws -> UpdateMicrosoftTeamsChannelConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateMicrosoftTeamsChannelConfigurationInput, UpdateMicrosoftTeamsChannelConfigurationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
            let i: any ClientRuntime.HttpInterceptor<UpdateMicrosoftTeamsChannelConfigurationInput, UpdateMicrosoftTeamsChannelConfigurationOutput> = provider.create()
            builder.interceptors.add(i)
        }
    ...
    public func updateSlackChannelConfiguration(input: UpdateSlackChannelConfigurationInput) async throws -> UpdateSlackChannelConfigurationOutput {
        let context = Smithy.ContextBuilder()
                      ...
                      .withSigningRegion(value: config.signingRegion)
                      .build()
        let builder = ClientRuntime.OrchestratorBuilder<UpdateSlackChannelConfigurationInput, UpdateSlackChannelConfigurationOutput, SmithyHTTPAPI.SdkHttpRequest, SmithyHTTPAPI.HttpResponse>()
        config.interceptorProviders.forEach { provider in
            builder.interceptors.add(provider.create())
        }
        config.httpInterceptorProviders.forEach { provider in
