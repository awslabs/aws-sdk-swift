...
public final class ChatbotClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: ChatbotClient.ChatbotClientConfig) instead")
    public convenience init(config: ChatbotClient.ChatbotClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try ChatbotClient.ChatbotClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await ChatbotClient.ChatbotClientConfig()
        self.init(config: config)
    }
}
...
extension ChatbotClient {
    ...
    /// Client configuration for ChatbotClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct ChatbotClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "chatbot")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultChatbotAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: ChatbotClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use ChatbotClientConfig instead. This class will be removed in a future version.")
    public final class ChatbotClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> ChatbotClientConfig {
            return try ChatbotClientConfig(
...
extension ChatbotClient {
    ...
    public func associateToConfiguration(input: AssociateToConfigurationInput) async throws -> AssociateToConfigurationOutput {
        ...
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "chatbot"))
