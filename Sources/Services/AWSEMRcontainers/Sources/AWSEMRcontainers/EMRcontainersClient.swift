...
public final class EMRcontainersClient: AWSClientRuntime.AWSServiceClient {
    ...
    @available(*, deprecated, message: "Use init(config: EMRcontainersClient.EMRcontainersClientConfig) instead")
    public convenience init(config: EMRcontainersClient.EMRcontainersClientConfiguration) {
        do {
    ...
    public convenience init(region: Swift.String) throws {
        let config = try EMRcontainersClient.EMRcontainersClientConfig(region: region)
        self.init(config: config)
    }

    public convenience init() async throws {
        let config = try await EMRcontainersClient.EMRcontainersClientConfig()
        self.init(config: config)
    }
}
...
extension EMRcontainersClient {
    ...
    /// Client configuration for EMRcontainersClient
    ///
    /// Conforms to `Sendable` for safe concurrent access across threads.
    public struct EMRcontainersClientConfig: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration, Swift.Sendable {
        ...
        public init(
            ...
            self.retryStrategyOptions = try retryStrategyOptions ?? AWSClientConfigDefaultsProvider.retryStrategyOptions(awsRetryMode, maxAttempts, sdkID: "EMR containers")
            ...
            self.authSchemeResolver = authSchemeResolver ?? DefaultEMRcontainersAuthSchemeResolver()
            ...
            self.logger = (telemetryProvider ?? ClientRuntime.DefaultTelemetry.provider).loggerProvider.getLogger(name: EMRcontainersClient.clientName)
        }
    ...
    @available(*, deprecated, message: "Use EMRcontainersClientConfig instead. This class will be removed in a future version.")
    public final class EMRcontainersClientConfiguration: AWSClientRuntime.AWSDefaultClientConfiguration & AWSClientRuntime.AWSRegionClientConfiguration & ClientRuntime.DefaultClientConfiguration & ClientRuntime.DefaultHttpClientConfiguration {
        public var useFIPS: Swift.Bool?
        public var useDualStack: Swift.Bool?
        public var appID: Swift.String?
        public var awsCredentialIdentityResolver: any SmithyIdentity.AWSCredentialIdentityResolver
        ...
        public func toSendable() throws -> EMRcontainersClientConfig {
            return try EMRcontainersClientConfig(
...
extension EMRcontainersClient {
    ...
    /// Performs the `DeleteSecurityConfiguration` operation on the `EMRcontainers` service.
    ///
    ...
    public func deleteSecurityConfiguration(input: DeleteSecurityConfigurationInput) async throws -> DeleteSecurityConfigurationOutput {
        ...
        builder.retryStrategy(self.retryStrategy)
        builder.retryErrorInfoProvider(AWSClientRuntime.AWSRetryErrorInfoProvider.errorInfoProvider(sdkID: "EMR containers"))
        builder.interceptors.add(AWSClientRuntime.UserAgentMiddleware<DeleteSecurityConfigurationInput, DeleteSecurityConfigurationOutput>(serviceID: serviceName, version: EMRcontainersClient.version, config: config))
        var metricsAttributes = Smithy.Attributes()
        metricsAttributes.set(key: ClientRuntime.OrchestratorMetricsAttributesKeys.service, value: "EMRcontainers")
