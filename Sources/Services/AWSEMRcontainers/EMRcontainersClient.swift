...
public class EMRcontainersClient {
    ...
    public convenience init(region: Swift.String) async throws {
        let config = try await EMRcontainersClientConfiguration(region: region)
...
extension EMRcontainersClient: EMRcontainersClientProtocol {
    ...
    public func cancelJobRun(input: CancelJobRunInput) async throws -> CancelJobRunOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<CancelJobRunOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func createJobTemplate(input: CreateJobTemplateInput) async throws -> CreateJobTemplateOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<CreateJobTemplateOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func createManagedEndpoint(input: CreateManagedEndpointInput) async throws -> CreateManagedEndpointOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<CreateManagedEndpointOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func createVirtualCluster(input: CreateVirtualClusterInput) async throws -> CreateVirtualClusterOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<CreateVirtualClusterOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func deleteJobTemplate(input: DeleteJobTemplateInput) async throws -> DeleteJobTemplateOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<DeleteJobTemplateOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func deleteManagedEndpoint(input: DeleteManagedEndpointInput) async throws -> DeleteManagedEndpointOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<DeleteManagedEndpointOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func deleteVirtualCluster(input: DeleteVirtualClusterInput) async throws -> DeleteVirtualClusterOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<DeleteVirtualClusterOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func describeJobTemplate(input: DescribeJobTemplateInput) async throws -> DescribeJobTemplateOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<DescribeJobTemplateOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func describeManagedEndpoint(input: DescribeManagedEndpointInput) async throws -> DescribeManagedEndpointOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<DescribeManagedEndpointOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func describeVirtualCluster(input: DescribeVirtualClusterInput) async throws -> DescribeVirtualClusterOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<DescribeVirtualClusterOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func listJobTemplates(input: ListJobTemplatesInput) async throws -> ListJobTemplatesOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<ListJobTemplatesOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func listManagedEndpoints(input: ListManagedEndpointsInput) async throws -> ListManagedEndpointsOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<ListManagedEndpointsOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
...
>>>>>>> b36b3a7d69 (feat: codegen and integration (#925))
    ...
    public func listVirtualClusters(input: ListVirtualClustersInput) async throws -> ListVirtualClustersOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<ListVirtualClustersOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
        let endpointParams = EndpointParams(endpoint: config.endpoint, region: region, useDualStack: config.useDualStack ?? false, useFIPS: config.useFIPS ?? false)
