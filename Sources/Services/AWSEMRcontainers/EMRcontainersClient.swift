...
extension EMRcontainersClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> EMRcontainersClient.EMRcontainersClientConfiguration {
        let clientConfiguration = try await EMRcontainersClient.EMRcontainersClientConfiguration()
    ...
    public class Builder {
        ...
        public func build() async throws -> EMRcontainersClient {
            let configuration = try await resolve(plugins: self.plugins)
            return EMRcontainersClient(config: configuration)
        }
    }
...
extension EMRcontainersClient.EMRcontainersClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
