...
extension EMRcontainersClientTypes.JobRun {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EMRcontainersClientTypes.JobRun {
        ...
        value.finishedAt = try reader["finishedAt"].readTimestampIfPresent(format: .dateTime)
        value.stateDetails = try reader["stateDetails"].readIfPresent()
        value.failureReason = try reader["failureReason"].readIfPresent()
        value.tags = try reader["tags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension EMRcontainersClientTypes.JobTemplateData {
    ...
    static func write(value: EMRcontainersClientTypes.JobTemplateData?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["jobTags"].writeMap(value.jobTags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> EMRcontainersClientTypes.JobTemplateData {
        ...
        value.jobTags = try reader["jobTags"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension StartJobRunInput {
    ...
    static func write(value: StartJobRunInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["jobTemplateParameters"].writeMap(value.jobTemplateParameters, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["name"].write(value.name)
        try writer["releaseLabel"].write(value.releaseLabel)
