...
extension KendraClientTypes.AlfrescoConfiguration {
    ...
    static func write(value: KendraClientTypes.AlfrescoConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["EntityFilter"].writeList(value.entityFilter, memberWritingClosure: KendraClientTypes.AlfrescoEntity.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ExclusionPatterns"].writeList(value.exclusionPatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["InclusionPatterns"].writeList(value.inclusionPatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.AlfrescoConfiguration {
        ...
        value.entityFilter = try reader["EntityFilter"].readListIfPresent(memberReadingClosure: KendraClientTypes.AlfrescoEntity.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.inclusionPatterns = try reader["InclusionPatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.exclusionPatterns = try reader["ExclusionPatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension KendraClientTypes.AttributeSuggestionsGetConfig {
    ...
    static func write(value: KendraClientTypes.AttributeSuggestionsGetConfig?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["AdditionalResponseAttributes"].writeList(value.additionalResponseAttributes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension BatchDeleteDocumentInput {
    ...
    static func write(value: BatchDeleteDocumentInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["DocumentIdList"].writeList(value.documentIdList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["IndexId"].write(value.indexId)
    }
}
...
extension BatchDeleteFeaturedResultsSetInput {
    ...
    static func write(value: BatchDeleteFeaturedResultsSetInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["FeaturedResultsSetIds"].writeList(value.featuredResultsSetIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["IndexId"].write(value.indexId)
    }
}
...
extension KendraClientTypes.ColumnConfiguration {
    ...
    static func write(value: KendraClientTypes.ColumnConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ChangeDetectingColumns"].writeList(value.changeDetectingColumns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.ColumnConfiguration {
        ...
        value.changeDetectingColumns = try reader["ChangeDetectingColumns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension KendraClientTypes.ConfluenceSpaceConfiguration {
    ...
    static func write(value: KendraClientTypes.ConfluenceSpaceConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ExcludeSpaces"].writeList(value.excludeSpaces, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["IncludeSpaces"].writeList(value.includeSpaces, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.ConfluenceSpaceConfiguration {
        ...
        value.includeSpaces = try reader["IncludeSpaces"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.excludeSpaces = try reader["ExcludeSpaces"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension KendraClientTypes.ContentSourceConfiguration {
    ...
    static func write(value: KendraClientTypes.ContentSourceConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DataSourceIds"].writeList(value.dataSourceIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["DirectPutContent"].write(value.directPutContent)
        try writer["FaqIds"].writeList(value.faqIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.ContentSourceConfiguration {
        ...
        value.dataSourceIds = try reader["DataSourceIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.faqIds = try reader["FaqIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension DescribeFeaturedResultsSetOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeFeaturedResultsSetOutput {
        ...
        value.queryTexts = try reader["QueryTexts"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["Status"].readIfPresent()
        return value
    }
}
...
extension DescribeQuerySuggestionsConfigOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeQuerySuggestionsConfigOutput {
        ...
        value.lastClearTime = try reader["LastClearTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lastSuggestionsBuildTime = try reader["LastSuggestionsBuildTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension DisassociatePersonasFromEntitiesInput {
    ...
    static func write(value: DisassociatePersonasFromEntitiesInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["EntityIds"].writeList(value.entityIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["Id"].write(value.id)
        try writer["IndexId"].write(value.indexId)
    }
}
...
extension KendraClientTypes.DocumentAttributeValue {
    ...
    static func write(value: KendraClientTypes.DocumentAttributeValue?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["DateValue"].writeTimestamp(value.dateValue, format: .epochSeconds)
        try writer["LongValue"].write(value.longValue)
        try writer["StringListValue"].writeList(value.stringListValue, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.DocumentAttributeValue {
        ...
        value.stringListValue = try reader["StringListValue"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.longValue = try reader["LongValue"].readIfPresent()
        value.dateValue = try reader["DateValue"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension GetQuerySuggestionsInput {
    ...
    static func write(value: GetQuerySuggestionsInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["QueryText"].write(value.queryText)
        try writer["SuggestionTypes"].writeList(value.suggestionTypes, memberWritingClosure: KendraClientTypes.SuggestionType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension GetSnapshotsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetSnapshotsOutput {
        ...
        value.snapshotsData = try reader["SnapshotsData"].readListIfPresent(memberReadingClosure: listReadingClosure(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false), memberNodeInfo: "member", isFlattened: false)
        value.snapshotsDataHeader = try reader["SnapshotsDataHeader"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension KendraClientTypes.GitHubConfiguration {
    ...
    static func write(value: KendraClientTypes.GitHubConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ExclusionFileNamePatterns"].writeList(value.exclusionFileNamePatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ExclusionFileTypePatterns"].writeList(value.exclusionFileTypePatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ExclusionFolderNamePatterns"].writeList(value.exclusionFolderNamePatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["InclusionFileNamePatterns"].writeList(value.inclusionFileNamePatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["InclusionFileTypePatterns"].writeList(value.inclusionFileTypePatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["InclusionFolderNamePatterns"].writeList(value.inclusionFolderNamePatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["RepositoryFilter"].writeList(value.repositoryFilter, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.GitHubConfiguration {
        ...
        value.repositoryFilter = try reader["RepositoryFilter"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.inclusionFolderNamePatterns = try reader["InclusionFolderNamePatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.inclusionFileTypePatterns = try reader["InclusionFileTypePatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.inclusionFileNamePatterns = try reader["InclusionFileNamePatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.exclusionFolderNamePatterns = try reader["ExclusionFolderNamePatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.exclusionFileTypePatterns = try reader["ExclusionFileTypePatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.exclusionFileNamePatterns = try reader["ExclusionFileNamePatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.vpcConfiguration = try reader["VpcConfiguration"].readIfPresent(with: KendraClientTypes.DataSourceVpcConfiguration.read(from:))
...
extension KendraClientTypes.GoogleDriveConfiguration {
    ...
    static func write(value: KendraClientTypes.GoogleDriveConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ExcludeMimeTypes"].writeList(value.excludeMimeTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ExcludeSharedDrives"].writeList(value.excludeSharedDrives, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ExcludeUserAccounts"].writeList(value.excludeUserAccounts, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ExclusionPatterns"].writeList(value.exclusionPatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["FieldMappings"].writeList(value.fieldMappings, memberWritingClosure: KendraClientTypes.DataSourceToIndexFieldMapping.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["InclusionPatterns"].writeList(value.inclusionPatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SecretArn"].write(value.secretArn)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.GoogleDriveConfiguration {
        ...
        value.exclusionPatterns = try reader["ExclusionPatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.fieldMappings = try reader["FieldMappings"].readListIfPresent(memberReadingClosure: KendraClientTypes.DataSourceToIndexFieldMapping.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.excludeMimeTypes = try reader["ExcludeMimeTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.excludeUserAccounts = try reader["ExcludeUserAccounts"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.excludeSharedDrives = try reader["ExcludeSharedDrives"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension KendraClientTypes.GroupOrderingIdSummary {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.GroupOrderingIdSummary {
        ...
        value.receivedAt = try reader["ReceivedAt"].readTimestampIfPresent(format: .epochSeconds)
...
extension KendraClientTypes.JiraConfiguration {
    ...
    static func write(value: KendraClientTypes.JiraConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["IssueSubEntityFilter"].writeList(value.issueSubEntityFilter, memberWritingClosure: KendraClientTypes.IssueSubEntity.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["IssueType"].writeList(value.issueType, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["JiraAccountUrl"].write(value.jiraAccountUrl)
        try writer["Project"].writeList(value.project, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        ...
        try writer["SecretArn"].write(value.secretArn)
        try writer["Status"].writeList(value.status, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["UseChangeLog"].write(value.useChangeLog)
        try writer["VpcConfiguration"].write(value.vpcConfiguration, with: KendraClientTypes.DataSourceVpcConfiguration.write(value:to:))
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.JiraConfiguration {
        ...
        value.secretArn = try reader["SecretArn"].readIfPresent()
        value.useChangeLog = try reader["UseChangeLog"].readIfPresent() ?? false
        value.project = try reader["Project"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.issueType = try reader["IssueType"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.status = try reader["Status"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.issueSubEntityFilter = try reader["IssueSubEntityFilter"].readListIfPresent(memberReadingClosure: KendraClientTypes.IssueSubEntity.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension KendraClientTypes.OneDriveUsers {
    ...
    static func write(value: KendraClientTypes.OneDriveUsers?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["OneDriveUserList"].writeList(value.oneDriveUserList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.OneDriveUsers {
        ...
        value.oneDriveUserList = try reader["OneDriveUserList"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension QueryInput {
    ...
    static func write(value: QueryInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["QueryText"].write(value.queryText)
        try writer["RequestedDocumentAttributes"].writeList(value.requestedDocumentAttributes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension KendraClientTypes.QuipConfiguration {
    ...
    static func write(value: KendraClientTypes.QuipConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ExclusionPatterns"].writeList(value.exclusionPatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["FolderIds"].writeList(value.folderIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["InclusionPatterns"].writeList(value.inclusionPatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.QuipConfiguration {
        ...
        value.crawlAttachments = try reader["CrawlAttachments"].readIfPresent() ?? false
        value.folderIds = try reader["FolderIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension KendraClientTypes.Relevance {
    ...
    static func write(value: KendraClientTypes.Relevance?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ValueImportanceMap"].writeMap(value.valueImportanceMap, valueWritingClosure: Swift.Int.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.Relevance {
        ...
        value.valueImportanceMap = try reader["ValueImportanceMap"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension KendraClientTypes.SalesforceChatterFeedConfiguration {
    ...
    static func write(value: KendraClientTypes.SalesforceChatterFeedConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["FieldMappings"].writeList(value.fieldMappings, memberWritingClosure: KendraClientTypes.DataSourceToIndexFieldMapping.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["IncludeFilterTypes"].writeList(value.includeFilterTypes, memberWritingClosure: KendraClientTypes.SalesforceChatterFeedIncludeFilterType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.SalesforceChatterFeedConfiguration {
        ...
        value.fieldMappings = try reader["FieldMappings"].readListIfPresent(memberReadingClosure: KendraClientTypes.DataSourceToIndexFieldMapping.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.includeFilterTypes = try reader["IncludeFilterTypes"].readListIfPresent(memberReadingClosure: KendraClientTypes.SalesforceChatterFeedIncludeFilterType.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension KendraClientTypes.SalesforceConfiguration {
    ...
    static func write(value: KendraClientTypes.SalesforceConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["CrawlAttachments"].write(value.crawlAttachments)
        try writer["ExcludeAttachmentFilePatterns"].writeList(value.excludeAttachmentFilePatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["IncludeAttachmentFilePatterns"].writeList(value.includeAttachmentFilePatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.SalesforceConfiguration {
        ...
        value.includeAttachmentFilePatterns = try reader["IncludeAttachmentFilePatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.excludeAttachmentFilePatterns = try reader["ExcludeAttachmentFilePatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension KendraClientTypes.SalesforceKnowledgeArticleConfiguration {
    ...
    static func write(value: KendraClientTypes.SalesforceKnowledgeArticleConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["IncludedStates"].writeList(value.includedStates, memberWritingClosure: KendraClientTypes.SalesforceKnowledgeArticleState.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.SalesforceKnowledgeArticleConfiguration {
        ...
        value.includedStates = try reader["IncludedStates"].readListIfPresent(memberReadingClosure: KendraClientTypes.SalesforceKnowledgeArticleState.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension KendraClientTypes.SeedUrlConfiguration {
    ...
    static func write(value: KendraClientTypes.SeedUrlConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["SeedUrls"].writeList(value.seedUrls, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.SeedUrlConfiguration {
        ...
        value.seedUrls = try reader["SeedUrls"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension KendraClientTypes.SharePointConfiguration {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.SharePointConfiguration {
        ...
        value.urls = try reader["Urls"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.secretArn = try reader["SecretArn"].readIfPresent()
        value.crawlAttachments = try reader["CrawlAttachments"].readIfPresent() ?? false
        value.useChangeLog = try reader["UseChangeLog"].readIfPresent() ?? false
        value.inclusionPatterns = try reader["InclusionPatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension KendraClientTypes.SiteMapsConfiguration {
    ...
    static func write(value: KendraClientTypes.SiteMapsConfiguration?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["SiteMaps"].writeList(value.siteMaps, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.SiteMapsConfiguration {
        ...
        value.siteMaps = try reader["SiteMaps"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension KendraClientTypes.SlackConfiguration {
    ...
    static func write(value: KendraClientTypes.SlackConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["PrivateChannelFilter"].writeList(value.privateChannelFilter, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["PublicChannelFilter"].writeList(value.publicChannelFilter, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["SecretArn"].write(value.secretArn)
        try writer["SinceCrawlDate"].write(value.sinceCrawlDate)
        try writer["SlackEntityList"].writeList(value.slackEntityList, memberWritingClosure: KendraClientTypes.SlackEntity.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.SlackConfiguration {
        ...
        value.secretArn = try reader["SecretArn"].readIfPresent()
        value.vpcConfiguration = try reader["VpcConfiguration"].readIfPresent(with: KendraClientTypes.DataSourceVpcConfiguration.read(from:))
        value.slackEntityList = try reader["SlackEntityList"].readListIfPresent(memberReadingClosure: KendraClientTypes.SlackEntity.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.useChangeLog = try reader["UseChangeLog"].readIfPresent() ?? false
        ...
        value.privateChannelFilter = try reader["PrivateChannelFilter"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.publicChannelFilter = try reader["PublicChannelFilter"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.inclusionPatterns = try reader["InclusionPatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.exclusionPatterns = try reader["ExclusionPatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.fieldMappings = try reader["FieldMappings"].readListIfPresent(memberReadingClosure: KendraClientTypes.DataSourceToIndexFieldMapping.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
...
extension KendraClientTypes.WebCrawlerConfiguration {
    ...
    static func write(value: KendraClientTypes.WebCrawlerConfiguration?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ProxyConfiguration"].write(value.proxyConfiguration, with: KendraClientTypes.ProxyConfiguration.write(value:to:))
        try writer["UrlExclusionPatterns"].writeList(value.urlExclusionPatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["UrlInclusionPatterns"].writeList(value.urlInclusionPatterns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> KendraClientTypes.WebCrawlerConfiguration {
        ...
        value.urlInclusionPatterns = try reader["UrlInclusionPatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.urlExclusionPatterns = try reader["UrlExclusionPatterns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.proxyConfiguration = try reader["ProxyConfiguration"].readIfPresent(with: KendraClientTypes.ProxyConfiguration.read(from:))
