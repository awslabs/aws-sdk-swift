...
extension ConnectCampaignsClient {
    ...
    static func resolve(plugins: [any Plugin]) async throws -> ConnectCampaignsClient.ConnectCampaignsClientConfiguration {
    ...
    public class Builder {
        ...
        public func build() async throws -> ConnectCampaignsClient {
            let configuration = try await resolve(plugins: self.plugins)
            return ConnectCampaignsClient(config: configuration)
        }
    }
...
extension ConnectCampaignsClient.ConnectCampaignsClientConfiguration: AwsDefaultClientConfiguration & AwsRegionClientConfiguration & DefaultClientConfiguration & DefaultHttpClientConfiguration {
}
