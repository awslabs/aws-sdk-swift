...
extension BackupClientTypes.AdvancedBackupSetting {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.AdvancedBackupSetting {
        ...
        value.backupOptions = try reader["BackupOptions"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension BackupClientTypes.BackupJob {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.BackupJob {
        ...
        value.expectedCompletionDate = try reader["ExpectedCompletionDate"].readTimestampIfPresent(format: .epochSeconds)
        value.startBy = try reader["StartBy"].readTimestampIfPresent(format: .epochSeconds)
        value.resourceType = try reader["ResourceType"].readIfPresent()
        ...
        value.initiationDate = try reader["InitiationDate"].readTimestampIfPresent(format: .epochSeconds)
...
extension BackupClientTypes.BackupPlansListMember {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.BackupPlansListMember {
        ...
        value.lastExecutionDate = try reader["LastExecutionDate"].readTimestampIfPresent(format: .epochSeconds)
        value.advancedBackupSettings = try reader["AdvancedBackupSettings"].readListIfPresent(memberReadingClosure: BackupClientTypes.AdvancedBackupSetting.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BackupClientTypes.BackupSelection {
    ...
    static func write(value: BackupClientTypes.BackupSelection?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["NotResources"].writeList(value.notResources, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.BackupSelection {
        ...
        value.notResources = try reader["NotResources"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension BackupClientTypes.BackupVaultListMember {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.BackupVaultListMember {
        ...
        value.lockDate = try reader["LockDate"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension BackupClientTypes.CalculatedLifecycle {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.CalculatedLifecycle {
        ...
        value.moveToColdStorageAt = try reader["MoveToColdStorageAt"].readTimestampIfPresent(format: .epochSeconds)
        value.deleteAt = try reader["DeleteAt"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension BackupClientTypes.ControlScope {
    ...
    static func write(value: BackupClientTypes.ControlScope?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ComplianceResourceIds"].writeList(value.complianceResourceIds, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["ComplianceResourceTypes"].writeList(value.complianceResourceTypes, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.ControlScope {
        ...
        value.complianceResourceIds = try reader["ComplianceResourceIds"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.complianceResourceTypes = try reader["ComplianceResourceTypes"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension BackupClientTypes.CopyJob {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.CopyJob {
        ...
        value.childJobsInState = try reader["ChildJobsInState"].readMapIfPresent(valueReadingClosure: Swift.Int.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.resourceName = try reader["ResourceName"].readIfPresent()
        value.messageCategory = try reader["MessageCategory"].readIfPresent()
        return value
    }
...
extension CreateBackupPlanInput {
    ...
    static func write(value: CreateBackupPlanInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["BackupPlanTags"].writeMap(value.backupPlanTags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension CreateBackupVaultInput {
    ...
    static func write(value: CreateBackupVaultInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["BackupVaultTags"].writeMap(value.backupVaultTags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["CreatorRequestId"].write(value.creatorRequestId)
...
extension CreateFrameworkInput {
    ...
    static func write(value: CreateFrameworkInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["FrameworkTags"].writeMap(value.frameworkTags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension CreateReportPlanInput {
    ...
    static func write(value: CreateReportPlanInput?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ReportPlanTags"].writeMap(value.reportPlanTags, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension BackupClientTypes.DateRange {
    ...
    static func write(value: BackupClientTypes.DateRange?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ToDate"].writeTimestamp(value.toDate, format: .epochSeconds)
    }

    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.DateRange {
        guard reader.hasContent else { throw SmithyReadWrite.ReaderError.requiredValueNotPresent }
        var value = BackupClientTypes.DateRange()
        value.fromDate = try reader["FromDate"].readTimestampIfPresent(format: .epochSeconds)
        value.toDate = try reader["ToDate"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension DescribeGlobalSettingsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeGlobalSettingsOutput {
        ...
        value.globalSettings = try reader["GlobalSettings"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
...
extension DescribeProtectedResourceOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeProtectedResourceOutput {
        ...
        value.lastBackupTime = try reader["LastBackupTime"].readTimestampIfPresent(format: .epochSeconds)
        ...
        value.latestRestoreJobCreationDate = try reader["LatestRestoreJobCreationDate"].readTimestampIfPresent(format: .epochSeconds)
        value.latestRestoreRecoveryPointCreationDate = try reader["LatestRestoreRecoveryPointCreationDate"].readTimestampIfPresent(format: .epochSeconds)
        value.resourceArn = try reader["ResourceArn"].readIfPresent()
        value.resourceName = try reader["ResourceName"].readIfPresent()
        value.resourceType = try reader["ResourceType"].readIfPresent()
        return value
...
extension DescribeRecoveryPointOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeRecoveryPointOutput {
        ...
        value.isParent = try reader["IsParent"].readIfPresent() ?? false
        value.lastRestoreTime = try reader["LastRestoreTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lifecycle = try reader["Lifecycle"].readIfPresent(with: BackupClientTypes.Lifecycle.read(from:))
...
extension DescribeRegionSettingsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeRegionSettingsOutput {
        ...
        value.resourceTypeManagementPreference = try reader["ResourceTypeManagementPreference"].readMapIfPresent(valueReadingClosure: Swift.Bool.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        value.resourceTypeOptInPreference = try reader["ResourceTypeOptInPreference"].readMapIfPresent(valueReadingClosure: Swift.Bool.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension DescribeRestoreJobOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> DescribeRestoreJobOutput {
        ...
        value.percentDone = try reader["PercentDone"].readIfPresent()
        value.recoveryPointArn = try reader["RecoveryPointArn"].readIfPresent()
        value.recoveryPointCreationDate = try reader["RecoveryPointCreationDate"].readTimestampIfPresent(format: .epochSeconds)
        value.resourceType = try reader["ResourceType"].readIfPresent()
...
extension GetBackupVaultNotificationsOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetBackupVaultNotificationsOutput {
        ...
        value.backupVaultArn = try reader["BackupVaultArn"].readIfPresent()
        value.backupVaultEvents = try reader["BackupVaultEvents"].readListIfPresent(memberReadingClosure: BackupClientTypes.BackupVaultEvent.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.backupVaultName = try reader["BackupVaultName"].readIfPresent()
...
extension GetLegalHoldOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetLegalHoldOutput {
        ...
        value.cancellationDate = try reader["CancellationDate"].readTimestampIfPresent(format: .epochSeconds)
        value.creationDate = try reader["CreationDate"].readTimestampIfPresent(format: .epochSeconds)
        value.description = try reader["Description"].readIfPresent()
        value.legalHoldArn = try reader["LegalHoldArn"].readIfPresent()
        value.legalHoldId = try reader["LegalHoldId"].readIfPresent()
        value.recoveryPointSelection = try reader["RecoveryPointSelection"].readIfPresent(with: BackupClientTypes.RecoveryPointSelection.read(from:))
        value.retainRecordUntil = try reader["RetainRecordUntil"].readTimestampIfPresent(format: .epochSeconds)
        value.status = try reader["Status"].readIfPresent()
        value.title = try reader["Title"].readIfPresent()
        return value
    }
...
extension GetRecoveryPointRestoreMetadataOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetRecoveryPointRestoreMetadataOutput {
        ...
        value.recoveryPointArn = try reader["RecoveryPointArn"].readIfPresent()
        value.resourceType = try reader["ResourceType"].readIfPresent()
        value.restoreMetadata = try reader["RestoreMetadata"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension GetRestoreTestingInferredMetadataOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> GetRestoreTestingInferredMetadataOutput {
        ...
        value.inferredMetadata = try reader["InferredMetadata"].readMapIfPresent(valueReadingClosure: Swift.String.read(from:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        return value
    }
}
...
extension PutBackupVaultNotificationsInput {
    ...
    static func write(value: PutBackupVaultNotificationsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["BackupVaultEvents"].writeList(value.backupVaultEvents, memberWritingClosure: BackupClientTypes.BackupVaultEvent.write(value:to:), memberNodeInfo: "member", isFlattened: false)
...
extension BackupClientTypes.RecoveryPointSelection {
    ...
    static func write(value: BackupClientTypes.RecoveryPointSelection?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ResourceIdentifiers"].writeList(value.resourceIdentifiers, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["VaultNames"].writeList(value.vaultNames, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.RecoveryPointSelection {
        ...
        value.vaultNames = try reader["VaultNames"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension BackupClientTypes.ReportDeliveryChannel {
    ...
    static func write(value: BackupClientTypes.ReportDeliveryChannel?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["Formats"].writeList(value.formats, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.ReportDeliveryChannel {
        ...
        value.formats = try reader["Formats"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        return value
    }
}
...
extension BackupClientTypes.ReportPlan {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.ReportPlan {
        ...
        value.deploymentStatus = try reader["DeploymentStatus"].readIfPresent()
        value.creationTime = try reader["CreationTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lastAttemptedExecutionTime = try reader["LastAttemptedExecutionTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lastSuccessfulExecutionTime = try reader["LastSuccessfulExecutionTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
...
extension BackupClientTypes.ReportSetting {
    ...
    static func write(value: BackupClientTypes.ReportSetting?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["FrameworkArns"].writeList(value.frameworkArns, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["NumberOfFrameworks"].write(value.numberOfFrameworks)
        try writer["OrganizationUnits"].writeList(value.organizationUnits, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.ReportSetting {
        ...
        value.reportTemplate = try reader["ReportTemplate"].readIfPresent()
        value.frameworkArns = try reader["FrameworkArns"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        ...
        value.organizationUnits = try reader["OrganizationUnits"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension BackupClientTypes.RestoreTestingPlanForGet {
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.RestoreTestingPlanForGet {
        ...
        value.creationTime = try reader["CreationTime"].readTimestampIfPresent(format: .epochSeconds)
        value.creatorRequestId = try reader["CreatorRequestId"].readIfPresent()
        value.lastExecutionTime = try reader["LastExecutionTime"].readTimestampIfPresent(format: .epochSeconds)
        value.lastUpdateTime = try reader["LastUpdateTime"].readTimestampIfPresent(format: .epochSeconds)
...
extension BackupClientTypes.RestoreTestingRecoveryPointSelection {
    ...
    static func write(value: BackupClientTypes.RestoreTestingRecoveryPointSelection?, to writer: SmithyJSON.Writer) throws {
        ...
        try writer["ExcludeVaults"].writeList(value.excludeVaults, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["IncludeVaults"].writeList(value.includeVaults, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
        try writer["RecoveryPointTypes"].writeList(value.recoveryPointTypes, memberWritingClosure: BackupClientTypes.RestoreTestingRecoveryPointType.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    ...
    static func read(from reader: SmithyJSON.Reader) throws -> BackupClientTypes.RestoreTestingRecoveryPointSelection {
        ...
        value.excludeVaults = try reader["ExcludeVaults"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.includeVaults = try reader["IncludeVaults"].readListIfPresent(memberReadingClosure: Swift.String.read(from:), memberNodeInfo: "member", isFlattened: false)
        value.recoveryPointTypes = try reader["RecoveryPointTypes"].readListIfPresent(memberReadingClosure: BackupClientTypes.RestoreTestingRecoveryPointType.read(from:), memberNodeInfo: "member", isFlattened: false)
...
extension UntagResourceInput {
    ...
    static func write(value: UntagResourceInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["TagKeyList"].writeList(value.tagKeyList, memberWritingClosure: Swift.String.write(value:to:), memberNodeInfo: "member", isFlattened: false)
    }
}
...
extension UpdateGlobalSettingsInput {
    ...
    static func write(value: UpdateGlobalSettingsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["GlobalSettings"].writeMap(value.globalSettings, valueWritingClosure: Swift.String.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension UpdateRegionSettingsInput {
    ...
    static func write(value: UpdateRegionSettingsInput?, to writer: SmithyJSON.Writer) throws {
        guard let value else { return }
        try writer["ResourceTypeManagementPreference"].writeMap(value.resourceTypeManagementPreference, valueWritingClosure: Swift.Bool.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
        try writer["ResourceTypeOptInPreference"].writeMap(value.resourceTypeOptInPreference, valueWritingClosure: Swift.Bool.write(value:to:), keyNodeInfo: "key", valueNodeInfo: "value", isFlattened: false)
    }
}
...
extension UpdateRestoreTestingPlanOutput {
    ...
    static func httpOutput(from httpResponse: ClientRuntime.HttpResponse) async throws -> UpdateRestoreTestingPlanOutput {
        ...
        value.restoreTestingPlanArn = try reader["RestoreTestingPlanArn"].readIfPresent()
        value.restoreTestingPlanName = try reader["RestoreTestingPlanName"].readIfPresent()
        value.updateTime = try reader["UpdateTime"].readTimestampIfPresent(format: .epochSeconds)
        return value
    }
}
