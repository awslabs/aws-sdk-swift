...
public protocol BackupClientProtocol {
    ...
    /// - `MissingParameterValueException` : Indicates that a required parameter is missing.
    /// - `ServiceUnavailableException` : The request failed due to a temporary failure of the server.
    func createLogicallyAirGappedBackupVault(input: CreateLogicallyAirGappedBackupVaultInput) async throws -> CreateLogicallyAirGappedBackupVaultOutputResponse
    ...
    /// - `ResourceNotFoundException` : A resource that is required for the action doesn't exist.
    /// - `ServiceUnavailableException` : The request failed due to a temporary failure of the server.
    func listProtectedResourcesByBackupVault(input: ListProtectedResourcesByBackupVaultInput) async throws -> ListProtectedResourcesByBackupVaultOutputResponse
