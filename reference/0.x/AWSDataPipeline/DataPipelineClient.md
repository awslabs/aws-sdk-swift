...
### `activatePipeline(input:completion:)`
...
### `deactivatePipeline(input:completion:)`
...
### `describeObjects(input:completion:)`
...
### `describePipelines(input:completion:)`
...
### `evaluateExpression(input:completion:)`
...
### `getPipelineDefinition(input:completion:)`
...
{"taskObject":
{"attemptId": "@SayHello\_2012-12-12T00:00:00\_Attempt=1",
"objects":
{"@SayHello\_2012-12-12T00:00:00\_Attempt=1":
{"fields":
\[
{"key": "@componentParent",
"refValue": "SayHello"},
...
"stringValue": "workerGroup"},
{"key": "@instanceParent",
"refValue": "@SayHello\_2012-12-12T00:00:00"},
{"key": "type",
"stringValue": "ShellCommandActivity"},
{"key": "@status",
"stringValue": "WAITING\_FOR\_RUNNER"},
{"key": "@version",
"stringValue": "1"},
{"key": "schedule",
"refValue": "Schedule"},
...
"stringValue": "df-0937003356ZJEXAMPLE"}
\],
"id": "@SayHello\_2012-12-12T00:00:00\_Attempt=1",
"name": "@SayHello\_2012-12-12T00:00:00\_Attempt=1"}
},
"pipelineId": "df-0937003356ZJEXAMPLE",
...
### `putPipelineDefinition(input:completion:)`
...
{"\_\_type": "com.amazon.setl.webservice\#InvalidRequestException",
...
{"hasMoreResults": false,
"ids":
\["@SayHello\_1\_2012-09-25T17:00:00"\]
}
</response>
</examples>
...
### `reportTaskProgress(input:completion:)`
...
### `reportTaskRunnerHeartbeat(input:completion:)`
...
### `setTaskStatus(input:completion:)`
...
### `validatePipelineDefinition(input:completion:)`
...
\[
{"errors":
\["INVALID\_FIELD\_VALUE:  'startDateTime' value must be a literal datetime value."\],
"id": "Schedule"}
\]
}
