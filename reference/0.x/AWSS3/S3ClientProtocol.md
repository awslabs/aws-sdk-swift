...
### deleteBucketEncryption(input:completion:)
...
### deleteBucketLifecycle(input:completion:)
...
This implementation of the GET action uses the acl subresource to return the access control list (ACL) of a bucket. To use GET to return the ACL of the bucket, you must have READ\_ACP access to the bucket. If READ\_ACP permission is granted to the anonymous user, you can return the ACL of the bucket without using an authorization header. Related Resources
...
### getBucketEncryption(input:completion:)
...
### getBucketLocation(input:completion:)
...
### getBucketMetricsConfiguration(input:completion:)
...
### getBucketNotificationConfiguration(input:completion:)
...
### getBucketRequestPayment(input:completion:)
...
### getBucketVersioning(input:completion:)
...
Gets an object's current Legal Hold status. For more information, see [Locking Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html). This action is not supported by Amazon S3 on Outposts.
...
Retrieves an object's retention settings. For more information, see [Locking Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html). This action is not supported by Amazon S3 on Outposts.
...
### getObjectTorrent(input:completion:)
...
### listBucketIntelligentTieringConfigurations(input:completion:)
...
### listObjectVersions(input:completion:)
...
### putBucketAccelerateConfiguration(input:completion:)
...
``` swift
func putBucketAccelerateConfiguration(input: PutBucketAccelerateConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketAccelerateConfigurationOutputResponse, PutBucketAccelerateConfigurationOutputError>) -> Void)
```
...
### putBucketAcl(input:completion:)

Sets the permissions on an existing bucket using access control lists (ACL). For more information, see [Using ACLs](https://docs.aws.amazon.com/AmazonS3/latest/dev/S3_ACLs_UsingACLs.html). To set the ACL of a bucket, you must have WRITE\_ACP permission. You can use one of the following two ways to set a bucket's permissions:

``` swift
func putBucketAcl(input: PutBucketAclInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketAclOutputResponse, PutBucketAclOutputError>) -> Void)
```
...
### putBucketAnalyticsConfiguration(input:completion:)
...
``` swift
func putBucketAnalyticsConfiguration(input: PutBucketAnalyticsConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketAnalyticsConfigurationOutputResponse, PutBucketAnalyticsConfigurationOutputError>) -> Void)
```
...
### putBucketCors(input:completion:)
...
``` swift
func putBucketCors(input: PutBucketCorsInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketCorsOutputResponse, PutBucketCorsOutputError>) -> Void)
```
...
### putBucketEncryption(input:completion:)
...
``` swift
func putBucketEncryption(input: PutBucketEncryptionInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketEncryptionOutputResponse, PutBucketEncryptionOutputError>) -> Void)
```
...
### putBucketIntelligentTieringConfiguration(input:completion:)
...
``` swift
func putBucketIntelligentTieringConfiguration(input: PutBucketIntelligentTieringConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketIntelligentTieringConfigurationOutputResponse, PutBucketIntelligentTieringConfigurationOutputError>) -> Void)
```
...
### putBucketInventoryConfiguration(input:completion:)
...
``` swift
func putBucketInventoryConfiguration(input: PutBucketInventoryConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketInventoryConfigurationOutputResponse, PutBucketInventoryConfigurationOutputError>) -> Void)
```
...
### putBucketLogging(input:completion:)
...
``` swift
func putBucketLogging(input: PutBucketLoggingInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketLoggingOutputResponse, PutBucketLoggingOutputError>) -> Void)
```
...
### putBucketMetricsConfiguration(input:completion:)

Sets a metrics configuration (specified by the metrics configuration ID) for the bucket. You can have up to 1,000 metrics configurations per bucket. If you're updating an existing metrics configuration, note that this is a full replacement of the existing metrics configuration. If you don't include the elements you want to keep, they are erased. To use this operation, you must have permissions to perform the s3:PutMetricsConfiguration action. The bucket owner has this permission by default. The bucket owner can grant this permission to others. For more information about permissions, see [Permissions Related to Bucket Subresource Operations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-with-s3-actions.html#using-with-s3-actions-related-to-bucket-subresources) and [Managing Access Permissions to Your Amazon S3 Resources](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-access-control.html). For information about CloudWatch request metrics for Amazon S3, see [Monitoring Metrics with Amazon CloudWatch](https://docs.aws.amazon.com/AmazonS3/latest/dev/cloudwatch-monitoring.html). The following operations are related to PutBucketMetricsConfiguration:

``` swift
func putBucketMetricsConfiguration(input: PutBucketMetricsConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketMetricsConfigurationOutputResponse, PutBucketMetricsConfigurationOutputError>) -> Void)
```
...
### putBucketNotificationConfiguration(input:completion:)
...
``` swift
func putBucketNotificationConfiguration(input: PutBucketNotificationConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketNotificationConfigurationOutputResponse, PutBucketNotificationConfigurationOutputError>) -> Void)
```

  - [GetBucketNotificationConfiguration](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketNotificationConfiguration.html)

### putBucketOwnershipControls(input:completion:)

Creates or modifies OwnershipControls for an Amazon S3 bucket. To use this operation, you must have the s3:PutBucketOwnershipControls permission. For more information about Amazon S3 permissions, see [Specifying Permissions in a Policy](https://docs.aws.amazon.com/AmazonS3/latest/dev/using-with-s3-actions.html). For information about Amazon S3 Object Ownership, see [Using Object Ownership](https://docs.aws.amazon.com/AmazonS3/latest/dev/about-object-ownership.html). The following operations are related to PutBucketOwnershipControls:

``` swift
func putBucketOwnershipControls(input: PutBucketOwnershipControlsInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketOwnershipControlsOutputResponse, PutBucketOwnershipControlsOutputError>) -> Void)
```
...
### putBucketReplication(input:completion:)
...
``` swift
func putBucketReplication(input: PutBucketReplicationInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketReplicationOutputResponse, PutBucketReplicationOutputError>) -> Void)
```
...
### putBucketRequestPayment(input:completion:)
...
``` swift
func putBucketRequestPayment(input: PutBucketRequestPaymentInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketRequestPaymentOutputResponse, PutBucketRequestPaymentOutputError>) -> Void)
```
...
### putBucketVersioning(input:completion:)
...
``` swift
func putBucketVersioning(input: PutBucketVersioningInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketVersioningOutputResponse, PutBucketVersioningOutputError>) -> Void)
```
...
### putBucketWebsite(input:completion:)
...
``` swift
func putBucketWebsite(input: PutBucketWebsiteInput, completion: @escaping (ClientRuntime.SdkResult<PutBucketWebsiteOutputResponse, PutBucketWebsiteOutputError>) -> Void)
```
...
``` swift
func putObjectAcl(input: PutObjectAclInput, completion: @escaping (ClientRuntime.SdkResult<PutObjectAclOutputResponse, PutObjectAclOutputError>) -> Void)
```
...
### putObjectLegalHold(input:completion:)
...
``` swift
func putObjectLegalHold(input: PutObjectLegalHoldInput, completion: @escaping (ClientRuntime.SdkResult<PutObjectLegalHoldOutputResponse, PutObjectLegalHoldOutputError>) -> Void)
```

### putObjectLockConfiguration(input:completion:)

Places an Object Lock configuration on the specified bucket. The rule specified in the Object Lock configuration will be applied by default to every new object placed in the specified bucket. For more information, see [Locking Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html).

``` swift
func putObjectLockConfiguration(input: PutObjectLockConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<PutObjectLockConfigurationOutputResponse, PutObjectLockConfigurationOutputError>) -> Void)
```
...
### putObjectRetention(input:completion:)
...
``` swift
func putObjectRetention(input: PutObjectRetentionInput, completion: @escaping (ClientRuntime.SdkResult<PutObjectRetentionOutputResponse, PutObjectRetentionOutputError>) -> Void)
```

### putObjectTagging(input:completion:)
...
``` swift
func putObjectTagging(input: PutObjectTaggingInput, completion: @escaping (ClientRuntime.SdkResult<PutObjectTaggingOutputResponse, PutObjectTaggingOutputError>) -> Void)
```
...
### restoreObject(input:completion:)
...
``` swift
func restoreObject(input: RestoreObjectInput, completion: @escaping (ClientRuntime.SdkResult<RestoreObjectOutputResponse, RestoreObjectOutputError>) -> Void)
```
...
### selectObjectContent(input:completion:)
...
``` swift
func selectObjectContent(input: SelectObjectContentInput, completion: @escaping (ClientRuntime.SdkResult<SelectObjectContentOutputResponse, SelectObjectContentOutputError>) -> Void)
```
...
Working with the Response Body Given the response size is unknown, Amazon S3 Select streams the response as a series of messages and includes a Transfer-Encoding header with chunked as its value in the response. For more information, see [Appendix: SelectObjectContent Response](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTSelectObjectAppendix.html). GetObject Support The SelectObjectContent action does not support the following GetObject functionality. For more information, see [GetObject](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetObject.html).
  ...
  - GLACIER, DEEP\_ARCHIVE and REDUCED\_REDUNDANCY storage classes: You cannot specify the GLACIER, DEEP\_ARCHIVE, or REDUCED\_REDUNDANCY storage classes. For more information, about storage classes see [Storage Classes](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#storage-class-intro) in the Amazon S3 User Guide.
...
``` swift
func uploadPart(input: UploadPartInput, completion: @escaping (ClientRuntime.SdkResult<UploadPartOutputResponse, UploadPartOutputError>) -> Void)
```
...
### uploadPartCopy(input:completion:)
...
``` swift
func uploadPartCopy(input: UploadPartCopyInput, completion: @escaping (ClientRuntime.SdkResult<UploadPartCopyOutputResponse, UploadPartCopyOutputError>) -> Void)
```
  ...
  - For information about copying objects using a single atomic action vs. the multipart upload, see [Operations on Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectOperations.html) in the Amazon S3 User Guide.
...
### writeGetObjectResponse(input:completion:)
...
``` swift
func writeGetObjectResponse(input: WriteGetObjectResponseInput, completion: @escaping (ClientRuntime.SdkResult<WriteGetObjectResponseOutputResponse, WriteGetObjectResponseOutputError>) -> Void)
```
