...
```
  ...
  - [Storage Gateway endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/sg.html): Provides a list of each Region and the endpoints available for use with Storage Gateway.
