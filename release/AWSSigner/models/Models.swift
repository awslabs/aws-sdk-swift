...
public struct AddProfilePermissionInput: Swift.Equatable {
    ...
    var profileVersion: Swift.String?
...
public struct DescribeSigningJobOutputResponse: Swift.Equatable {
    ...
    var jobInvoker: Swift.String?
    /// The AWS account ID of the job owner.
    var jobOwner: Swift.String?
    /// A list of any overrides that were applied to the signing operation.
    var overrides: SignerClientTypes.SigningPlatformOverrides?
    /// A human-readable name for the signing platform associated with the signing job.
    var platformDisplayName: Swift.String?
    /// The microcontroller platform to which your signed code image will be distributed.
    var platformId: Swift.String?
    /// The name of the profile that initiated the signing operation.
    var profileName: Swift.String?
    /// The version of the signing profile used to initiate the signing job.
    var profileVersion: Swift.String?
    /// The IAM principal that requested the signing job.
    var requestedBy: Swift.String?
    /// A revocation record if the signature generated by the signing job has been revoked. Contains a timestamp and the ID of the IAM entity that revoked the signature.
    var revocationRecord: SignerClientTypes.SigningJobRevocationRecord?
    /// Thr expiration timestamp for the signature generated by the signing job.
    var signatureExpiresAt: ClientRuntime.Date?
    /// Name of the S3 bucket where the signed code image is saved by code signing.
    var signedObject: SignerClientTypes.SignedObject?
    /// The Amazon Resource Name (ARN) of your code signing certificate.
    var signingMaterial: SignerClientTypes.SigningMaterial?
    /// Map of user-assigned key-value pairs used during signing. These values contain any information that you specified for use in your signing job.
    var signingParameters: [Swift.String:Swift.String]?
    /// The object that contains the name of your S3 bucket or your raw code.
    var source: SignerClientTypes.Source?
    /// Status of the signing job.
    var status: SignerClientTypes.SigningStatus?
...
extension SignerClientTypes {
    ...
    public struct Destination: Swift.Equatable {
        ...
        var s3: SignerClientTypes.S3Destination?
...
extension SignerClientTypes {
    ...
    public struct EncryptionAlgorithmOptions: Swift.Equatable {
        ...
        /// This member is required.
        var allowedValues: [SignerClientTypes.EncryptionAlgorithm]?
        /// The default encryption algorithm that is used by a code signing job.
        /// This member is required.
        var defaultValue: SignerClientTypes.EncryptionAlgorithm?
...
public struct GetSigningPlatformOutputResponse: Swift.Equatable {
    ...
    var category: SignerClientTypes.Category?
    /// The display name of the target signing platform.
    var displayName: Swift.String?
    /// The maximum size (in MB) of the payload that can be signed by the target platform.
    var maxSizeInMB: Swift.Int
    /// A list of partner entities that use the target signing platform.
    var partner: Swift.String?
    /// The ID of the target signing platform.
    var platformId: Swift.String?
    /// A flag indicating whether signatures generated for the signing platform can be revoked.
    var revocationSupported: Swift.Bool
    /// A list of configurations applied to the target platform at signing.
    var signingConfiguration: SignerClientTypes.SigningConfiguration?
    /// The format of the target platform's signing image.
    var signingImageFormat: SignerClientTypes.SigningImageFormat?
...
public struct GetSigningProfileOutputResponse: Swift.Equatable {
    ...
    var profileVersionArn: Swift.String?
    /// Revocation information for a signing profile.
    var revocationRecord: SignerClientTypes.SigningProfileRevocationRecord?
    /// The validity period for a signing job.
    var signatureValidityPeriod: SignerClientTypes.SignatureValidityPeriod?
    /// The ARN of the certificate that the target profile uses for signing operations.
    var signingMaterial: SignerClientTypes.SigningMaterial?
    /// A map of key-value pairs for signing operations that is attached to the target signing profile.
    var signingParameters: [Swift.String:Swift.String]?
    /// The status of the target signing profile.
    var status: SignerClientTypes.SigningProfileStatus?
...
extension SignerClientTypes {
    ...
    public struct HashAlgorithmOptions: Swift.Equatable {
        ...
        /// This member is required.
        var allowedValues: [SignerClientTypes.HashAlgorithm]?
        /// The default hash algorithm that is used in a code signing job.
        /// This member is required.
        var defaultValue: SignerClientTypes.HashAlgorithm?
...
public struct ListProfilePermissionsOutputResponse: Swift.Equatable {
    ...
    var permissions: [SignerClientTypes.Permission]?
    /// Total size of the policy associated with the Signing Profile in bytes.
    var policySizeBytes: Swift.Int
...
public struct ListSigningJobsInput: Swift.Equatable {
    ...
    var signatureExpiresAfter: ClientRuntime.Date?
    /// Filters results to return only signing jobs with signatures expiring before a specified timestamp.
    var signatureExpiresBefore: ClientRuntime.Date?
...
public struct ListSigningJobsOutputResponse: Swift.Equatable {
    ...
    var jobs: [SignerClientTypes.SigningJob]?
    /// String for specifying the next set of paginated results.
    var nextToken: Swift.String?
...
public struct ListSigningPlatformsOutputResponse: Swift.Equatable {
    ...
    var platforms: [SignerClientTypes.SigningPlatform]?
...
public struct ListSigningProfilesInput: Swift.Equatable {
    ...
    var includeCanceled: Swift.Bool
    ...
    var statuses: [SignerClientTypes.SigningProfileStatus]?
...
public struct ListSigningProfilesOutputResponse: Swift.Equatable {
    ...
    var profiles: [SignerClientTypes.SigningProfile]?
...
public struct RevokeSigningProfileInput: Swift.Equatable {
    ...
    /// This member is required.
    var effectiveTime: ClientRuntime.Date?
...
extension SignerClientTypes {
    ...
    public struct SignatureValidityPeriod: Swift.Equatable {
        ...
        var type: SignerClientTypes.ValidityType?
...
extension SignerClientTypes {
    ...
    public struct SignedObject: Swift.Equatable {
        /// The S3SignedObject.
        var s3: SignerClientTypes.S3SignedObject?
...
extension SignerClientTypes {
    ...
    public struct SigningConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var encryptionAlgorithmOptions: SignerClientTypes.EncryptionAlgorithmOptions?
        /// The hash algorithm options that are available for a code signing job.
        /// This member is required.
        var hashAlgorithmOptions: SignerClientTypes.HashAlgorithmOptions?
...
extension SignerClientTypes {
    ...
    public struct SigningConfigurationOverrides: Swift.Equatable {
        ...
        var encryptionAlgorithm: SignerClientTypes.EncryptionAlgorithm?
        /// A specified override of the default hash algorithm that is used in a code signing job.
        var hashAlgorithm: SignerClientTypes.HashAlgorithm?
...
extension SignerClientTypes {
    ...
    public struct SigningImageFormat: Swift.Equatable {
        ...
        /// This member is required.
        var defaultFormat: SignerClientTypes.ImageFormat?
        /// The supported formats of a code signing image.
        /// This member is required.
        var supportedFormats: [SignerClientTypes.ImageFormat]?
...
extension SignerClientTypes {
    ...
    public struct SigningPlatformOverrides: Swift.Equatable {
        /// A signing configuration that overrides the default encryption or hash algorithm of a signing job.
        var signingConfiguration: SignerClientTypes.SigningConfigurationOverrides?
        /// A signed image is a JSON object. When overriding the default signing platform configuration, a customer can select either of two signing formats, JSONEmbedded or JSONDetached. (A third format value, JSON, is reserved for future use.) With JSONEmbedded, the signing image has the payload embedded in it. With JSONDetached, the payload is not be embedded in the signing image.
        var signingImageFormat: SignerClientTypes.ImageFormat?
...
extension SignerClientTypes {
    ...
    public struct SigningProfileRevocationRecord: Swift.Equatable {
        ...
        var revocationEffectiveFrom: ClientRuntime.Date?
...
extension SignerClientTypes {
    ...
    public struct Source: Swift.Equatable {
        /// The S3Source object.
        var s3: SignerClientTypes.S3Source?
...
public struct StartSigningJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var destination: SignerClientTypes.Destination?
    /// The name of the signing profile.
    /// This member is required.
    var profileName: Swift.String?
