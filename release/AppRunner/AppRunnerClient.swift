...
public class AppRunnerClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try AppRunnerClientConfiguration(region: unwrappedRegion)
    ...
    public class AppRunnerClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("AppRunnerClient")
...
public struct AppRunnerClientLogHandlerFactory: SDKLogHandlerFactory {
