...
public protocol AppRunnerClientProtocol {
    ...
    func associateCustomDomain(input: AssociateCustomDomainInput, completion: @escaping (SdkResult<AssociateCustomDomainOutput, AssociateCustomDomainOutputError>) -> Void)
    ...
    func createAutoScalingConfiguration(input: CreateAutoScalingConfigurationInput, completion: @escaping (SdkResult<CreateAutoScalingConfigurationOutput, CreateAutoScalingConfigurationOutputError>) -> Void)
    ...
    func deleteAutoScalingConfiguration(input: DeleteAutoScalingConfigurationInput, completion: @escaping (SdkResult<DeleteAutoScalingConfigurationOutput, DeleteAutoScalingConfigurationOutputError>) -> Void)
    ...
    func describeAutoScalingConfiguration(input: DescribeAutoScalingConfigurationInput, completion: @escaping (SdkResult<DescribeAutoScalingConfigurationOutput, DescribeAutoScalingConfigurationOutputError>) -> Void)
    /// <p>Return a description of custom domain names that are associated with an AWS App Runner service.</p>
    func describeCustomDomains(input: DescribeCustomDomainsInput, completion: @escaping (SdkResult<DescribeCustomDomainsOutput, DescribeCustomDomainsOutputError>) -> Void)
    /// <p>Return a full description of an AWS App Runner service.</p>
    func describeService(input: DescribeServiceInput, completion: @escaping (SdkResult<DescribeServiceOutput, DescribeServiceOutputError>) -> Void)
    ...
    func disassociateCustomDomain(input: DisassociateCustomDomainInput, completion: @escaping (SdkResult<DisassociateCustomDomainOutput, DisassociateCustomDomainOutputError>) -> Void)
    ...
    func listAutoScalingConfigurations(input: ListAutoScalingConfigurationsInput, completion: @escaping (SdkResult<ListAutoScalingConfigurationsOutput, ListAutoScalingConfigurationsOutputError>) -> Void)
    ...
    ///          <p>This is an asynchronous operation. On a successful call, you can use the returned <code>OperationId</code> and the <a>ListOperations</a>
    ///       call to track the operation's progress.</p>
    func pauseService(input: PauseServiceInput, completion: @escaping (SdkResult<PauseServiceOutput, PauseServiceOutputError>) -> Void)
    /// <p>Resume an active AWS App Runner service. App Runner provisions compute capacity for the service.</p>
    ///          <p>This is an asynchronous operation. On a successful call, you can use the returned <code>OperationId</code> and the <a>ListOperations</a>
    ///       call to track the operation's progress.</p>
    func resumeService(input: ResumeServiceInput, completion: @escaping (SdkResult<ResumeServiceOutput, ResumeServiceOutputError>) -> Void)
