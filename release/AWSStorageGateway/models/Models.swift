...
public struct ActivateGatewayInput: Swift.Equatable {
    ...
    var activationKey: Swift.String?
    ...
    /// This member is required.
    var gatewayRegion: Swift.String?
    /// A value that indicates the time zone you want to set for the gateway. The time zone is of the format "GMT-hr:mm" or "GMT+hr:mm". For example, GMT-4:00 indicates the time is 4 hours behind GMT. GMT+2:00 indicates the time is 2 hours ahead of GMT. The time zone is used, for example, for scheduling snapshots and your gateway's maintenance schedule.
    /// This member is required.
    var gatewayTimezone: Swift.String?
    ...
    var mediumChangerType: Swift.String?
    ...
    var tags: [StorageGatewayClientTypes.Tag]?
    ...
    var tapeDriveType: Swift.String?
...
public struct AssociateFileSystemInput: Swift.Equatable {
    ...
    var auditDestinationARN: Swift.String?
    /// The refresh cache information for the file share or FSx file systems.
    var cacheAttributes: StorageGatewayClientTypes.CacheAttributes?
    ...
    var endpointNetworkConfiguration: StorageGatewayClientTypes.EndpointNetworkConfiguration?
    /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
    /// This member is required.
    var gatewayARN: Swift.String?
    /// The Amazon Resource Name (ARN) of the Amazon FSx file system to associate with the FSx File Gateway.
    /// This member is required.
    var locationARN: Swift.String?
...
public struct AssociateFileSystemOutputResponse: Swift.Equatable {
    ...
    var fileSystemAssociationARN: Swift.String?
...
extension StorageGatewayClientTypes {
    ...
    public struct AutomaticTapeCreationPolicyInfo: Swift.Equatable {
        ...
        var automaticTapeCreationRules: [StorageGatewayClientTypes.AutomaticTapeCreationRule]?
        /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
        var gatewayARN: Swift.String?
...
extension StorageGatewayClientTypes {
    ...
    public struct AutomaticTapeCreationRule: Swift.Equatable {
        ...
        /// This member is required.
        var tapeBarcodePrefix: Swift.String?
        /// The size, in bytes, of the virtual tape capacity.
        /// This member is required.
        var tapeSizeInBytes: Swift.Int?
...
extension StorageGatewayClientTypes {
    ...
    public struct BandwidthRateLimitInterval: Swift.Equatable {
        ...
        var averageDownloadRateLimitInBitsPerSec: Swift.Int?
        /// The average upload rate limit component of the bandwidth rate limit interval, in bits per second. This field does not appear in the response if the upload rate limit is not set.
        var averageUploadRateLimitInBitsPerSec: Swift.Int?
        /// The days of the week component of the bandwidth rate limit interval, represented as ordinal numbers from 0 to 6, where 0 represents Sunday and 6 represents Saturday.
        /// This member is required.
        var daysOfWeek: [Swift.Int]?
        /// The hour of the day to end the bandwidth rate limit interval.
        /// This member is required.
        var endHourOfDay: Swift.Int?
        ...
        /// This member is required.
        var endMinuteOfHour: Swift.Int?
        /// The hour of the day to start the bandwidth rate limit interval.
        /// This member is required.
        var startHourOfDay: Swift.Int?
        /// The minute of the hour to start the bandwidth rate limit interval. The interval begins at the start of that minute. To begin an interval exactly at the start of the hour, use the value 0.
        /// This member is required.
        var startMinuteOfHour: Swift.Int?
...
extension StorageGatewayClientTypes {
    ...
    public struct CacheAttributes: Swift.Equatable {
        ...
        var cacheStaleTimeoutInSeconds: Swift.Int?
...
extension StorageGatewayClientTypes {
    ...
    public struct CachediSCSIVolume: Swift.Equatable {
        ...
        var sourceSnapshotId: Swift.String?
        /// The name of the iSCSI target used by an initiator to connect to a volume and used as a suffix for the target ARN. For example, specifying TargetName as myvolume results in the target ARN of arn:aws:storagegateway:us-east-2:111122223333:gateway/sgw-12A3456B/target/iqn.1997-05.com.amazon:myvolume. The target name must be unique across all volumes on a gateway. If you don't specify a value, Storage Gateway uses the value that was previously used for this volume as the new target name.
        var targetName: Swift.String?
        ...
        var volumeAttachmentStatus: Swift.String?
        /// The unique identifier of the volume, e.g., vol-AE4B946D.
        var volumeId: Swift.String?
        /// Represents the percentage complete if the volume is restoring or bootstrapping that represents the percent of data transferred. This field does not appear in the response if the cached volume is not restoring or bootstrapping.
        var volumeProgress: Swift.Double?
        /// The size, in bytes, of the volume capacity.
        var volumeSizeInBytes: Swift.Int
        /// One of the VolumeStatus values that indicates the state of the storage volume.
        var volumeStatus: Swift.String?
        ...
        var volumeUsedInBytes: Swift.Int?
        /// An [VolumeiSCSIAttributes] object that represents a collection of iSCSI attributes for one stored volume.
        var volumeiSCSIAttributes: StorageGatewayClientTypes.VolumeiSCSIAttributes?
...
extension StorageGatewayClientTypes {
    ...
    public struct ChapInfo: Swift.Equatable {
        ...
        var initiatorName: Swift.String?
        /// The secret key that the initiator (for example, the Windows client) must provide to participate in mutual CHAP with the target.
        var secretToAuthenticateInitiator: Swift.String?
        /// The secret key that the target must provide to participate in mutual CHAP with the initiator (e.g., Windows client).
        var secretToAuthenticateTarget: Swift.String?
...
public struct CreateCachediSCSIVolumeInput: Swift.Equatable {
    ...
    var sourceVolumeARN: Swift.String?
...
public struct CreateNFSFileShareInput: Swift.Equatable {
    ...
    var bucketRegion: Swift.String?
    /// Specifies refresh cache information for the file share.
    var cacheAttributes: StorageGatewayClientTypes.CacheAttributes?
    /// The list of clients that are allowed to access the S3 File Gateway. The list must contain either valid IP addresses or valid CIDR blocks.
    var clientList: [Swift.String]?
    ...
    var defaultStorageClass: Swift.String?
    ...
    var fileShareName: Swift.String?
    ...
    var guessMIMETypeEnabled: Swift.Bool?
    /// Set to true to use Amazon S3 server-side encryption with your own KMS key, or false to use a key managed by Amazon S3. Optional. Valid Values: true | false
    var kMSEncrypted: Swift.Bool?
    /// The Amazon Resource Name (ARN) of a symmetric customer master key (CMK) used for Amazon S3 server-side encryption. Storage Gateway does not support asymmetric CMKs. This value can only be set when KMSEncrypted is true. Optional.
    var kMSKey: Swift.String?
    ...
    var nFSFileShareDefaults: StorageGatewayClientTypes.NFSFileShareDefaults?
    ...
    var notificationPolicy: Swift.String?
    /// A value that sets the access control list (ACL) permission for objects in the S3 bucket that a S3 File Gateway puts objects into. The default value is private.
    var objectACL: StorageGatewayClientTypes.ObjectACL?
    ...
    var vPCEndpointDNSName: Swift.String?
...
public struct CreateSMBFileShareInput: Swift.Equatable {
    ...
    var accessBasedEnumeration: Swift.Bool?
    ...
    var adminUserList: [Swift.String]?
    /// The Amazon Resource Name (ARN) of the storage used for audit logs.
    var auditDestinationARN: Swift.String?
    ...
    var authentication: Swift.String?
    ...
    var caseSensitivity: StorageGatewayClientTypes.CaseSensitivity?
    /// A unique string value that you supply that is used by S3 File Gateway to ensure idempotent file share creation.
    /// This member is required.
    var clientToken: Swift.String?
    /// The default storage class for objects put into an Amazon S3 bucket by the S3 File Gateway. The default value is S3_INTELLIGENT_TIERING. Optional. Valid Values: S3_STANDARD | S3_INTELLIGENT_TIERING | S3_STANDARD_IA | S3_ONEZONE_IA
    ...
    var invalidUserList: [Swift.String]?
    /// Set to true to use Amazon S3 server-side encryption with your own KMS key, or false to use a key managed by Amazon S3. Optional. Valid Values: true | false
    var kMSEncrypted: Swift.Bool?
    /// The Amazon Resource Name (ARN) of a symmetric customer master key (CMK) used for Amazon S3 server-side encryption. Storage Gateway does not support asymmetric CMKs. This value can only be set when KMSEncrypted is true. Optional.
    var kMSKey: Swift.String?
    ...
    var validUserList: [Swift.String]?
...
public struct CreateSnapshotFromVolumeRecoveryPointInput: Swift.Equatable {
    ...
    /// This member is required.
    var snapshotDescription: Swift.String?
...
public struct CreateSnapshotFromVolumeRecoveryPointOutputResponse: Swift.Equatable {
    ...
    var volumeRecoveryPointTime: Swift.String?
...
public struct CreateStorediSCSIVolumeInput: Swift.Equatable {
    ...
    /// This member is required.
    var preserveExistingData: Swift.Bool
...
public struct CreateTapePoolInput: Swift.Equatable {
    ...
    /// This member is required.
    var poolName: Swift.String?
    /// Tape retention lock time is set in days. Tape retention lock can be enabled for up to 100 years (36,500 days).
    var retentionLockTimeInDays: Swift.Int?
    /// Tape retention lock can be configured in two modes. When configured in governance mode, Amazon Web Services accounts with specific IAM permissions are authorized to remove the tape retention lock from archived virtual tapes. When configured in compliance mode, the tape retention lock cannot be removed by any user, including the root Amazon Web Services account.
    var retentionLockType: StorageGatewayClientTypes.RetentionLockType?
    ...
    /// This member is required.
    var storageClass: StorageGatewayClientTypes.TapeStorageClass?
...
public struct CreateTapesInput: Swift.Equatable {
    ...
    /// This member is required.
    var numTapesToCreate: Swift.Int?
    /// The ID of the pool that you want to add your tape to for archiving. The tape in this pool is archived in the S3 storage class that is associated with the pool. When you use your backup application to eject the tape, the tape is archived directly into the storage class (S3 Glacier or S3 Glacier Deep Archive) that corresponds to the pool. Valid Values: GLACIER | DEEP_ARCHIVE
    var poolId: Swift.String?
...
public struct DeleteBandwidthRateLimitInput: Swift.Equatable {
    ...
    /// This member is required.
    var bandwidthType: Swift.String?
    /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
    /// This member is required.
    var gatewayARN: Swift.String?
...
public struct DescribeAvailabilityMonitorTestOutputResponse: Swift.Equatable {
    ...
    var status: StorageGatewayClientTypes.AvailabilityMonitorTestStatus?
...
public struct DescribeBandwidthRateLimitScheduleOutputResponse: Swift.Equatable {
    ...
    var bandwidthRateLimitIntervals: [StorageGatewayClientTypes.BandwidthRateLimitInterval]?
    /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
    var gatewayARN: Swift.String?
...
public struct DescribeCacheOutputResponse: Swift.Equatable {
    ...
    var cacheAllocatedInBytes: Swift.Int
    ...
    var cacheDirtyPercentage: Swift.Double
    /// Percent of application read operations from the file shares that are served from cache. The sample is taken at the end of the reporting period.
    var cacheHitPercentage: Swift.Double
    /// Percent of application read operations from the file shares that are not served from cache. The sample is taken at the end of the reporting period.
    var cacheMissPercentage: Swift.Double
    /// Percent use of the gateway's cache storage. This metric applies only to the gateway-cached volume setup. The sample is taken at the end of the reporting period.
    var cacheUsedPercentage: Swift.Double
    /// An array of strings that identify disks that are to be configured as working storage. Each string has a minimum length of 1 and maximum length of 300. You can get the disk IDs from the [ListLocalDisks] API.
    var diskIds: [Swift.String]?
    /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
    var gatewayARN: Swift.String?
...
public struct DescribeCachediSCSIVolumesOutputResponse: Swift.Equatable {
    ...
    var cachediSCSIVolumes: [StorageGatewayClientTypes.CachediSCSIVolume]?
...
public struct DescribeChapCredentialsOutputResponse: Swift.Equatable {
    ...
    var chapCredentials: [StorageGatewayClientTypes.ChapInfo]?
...
public struct DescribeFileSystemAssociationsInput: Swift.Equatable {
    ...
    /// This member is required.
    var fileSystemAssociationARNList: [Swift.String]?
...
public struct DescribeFileSystemAssociationsOutputResponse: Swift.Equatable {
    ...
    var fileSystemAssociationInfoList: [StorageGatewayClientTypes.FileSystemAssociationInfo]?
...
public struct DescribeGatewayInformationOutputResponse: Swift.Equatable {
    ...
    var cloudWatchLogGroupARN: Swift.String?
    /// Date after which this gateway will not receive software updates for new features and bug fixes.
    var deprecationDate: Swift.String?
    /// The ID of the Amazon EC2 instance that was used to launch the gateway.
    var ec2InstanceId: Swift.String?
    /// The Amazon Web Services Region where the Amazon EC2 instance is located.
    var ec2InstanceRegion: Swift.String?
    /// The type of endpoint for your gateway. Valid Values: STANDARD | FIPS
    var endpointType: Swift.String?
    /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
    var gatewayARN: Swift.String?
    /// Specifies the size of the gateway's metadata cache.
    var gatewayCapacity: StorageGatewayClientTypes.GatewayCapacity?
    /// The unique identifier assigned to your gateway during activation. This ID becomes part of the gateway Amazon Resource Name (ARN), which you use as input for other operations.
    var gatewayId: Swift.String?
    /// The name you configured for your gateway.
    var gatewayName: Swift.String?
    /// A [NetworkInterface] array that contains descriptions of the gateway network interfaces.
    var gatewayNetworkInterfaces: [StorageGatewayClientTypes.NetworkInterface]?
    /// A value that indicates the operating state of the gateway.
    var gatewayState: Swift.String?
    /// A value that indicates the time zone configured for the gateway.
    var gatewayTimezone: Swift.String?
    /// The type of the gateway.
    var gatewayType: Swift.String?
    /// The type of hardware or software platform on which the gateway is running.
    var hostEnvironment: StorageGatewayClientTypes.HostEnvironment?
    /// A unique identifier for the specific instance of the host platform running the gateway. This value is only available for certain host environments, and its format depends on the host environment type.
    var hostEnvironmentId: Swift.String?
    /// The date on which the last software update was applied to the gateway. If the gateway has never been updated, this field does not return a value in the response.
    var lastSoftwareUpdate: Swift.String?
    /// The date on which an update to the gateway is available. This date is in the time zone of the gateway. If the gateway is not available for an update this field is not returned in the response.
    var nextUpdateAvailabilityDate: Swift.String?
    /// Date after which this gateway will not receive software updates for new features.
    var softwareUpdatesEndDate: Swift.String?
    /// A list of the metadata cache sizes that the gateway can support based on its current hardware specifications.
    var supportedGatewayCapacities: [StorageGatewayClientTypes.GatewayCapacity]?
    /// A list of up to 50 tags assigned to the gateway, sorted alphabetically by key name. Each tag is a key-value pair. For a gateway with more than 10 tags assigned, you can view all tags using the ListTagsForResource API operation.
    var tags: [StorageGatewayClientTypes.Tag]?
    /// The configuration settings for the virtual private cloud (VPC) endpoint for your gateway.
    var vPCEndpoint: Swift.String?
...
public struct DescribeMaintenanceStartTimeOutputResponse: Swift.Equatable {
    ...
    var dayOfWeek: Swift.Int?
    /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
    var gatewayARN: Swift.String?
    /// The hour component of the maintenance start time represented as hh, where hh is the hour (0 to 23). The hour of the day is in the time zone of the gateway.
    var hourOfDay: Swift.Int?
    /// The minute component of the maintenance start time represented as mm, where mm is the minute (0 to 59). The minute of the hour is in the time zone of the gateway.
    var minuteOfHour: Swift.Int?
...
public struct DescribeNFSFileSharesInput: Swift.Equatable {
    ...
    /// This member is required.
    var fileShareARNList: [Swift.String]?
...
public struct DescribeNFSFileSharesOutputResponse: Swift.Equatable {
    ...
    var nFSFileShareInfoList: [StorageGatewayClientTypes.NFSFileShareInfo]?
...
public struct DescribeSMBFileSharesOutputResponse: Swift.Equatable {
    /// An array containing a description for each requested file share.
    var sMBFileShareInfoList: [StorageGatewayClientTypes.SMBFileShareInfo]?
...
public struct DescribeSMBSettingsOutputResponse: Swift.Equatable {
    ...
    var activeDirectoryStatus: StorageGatewayClientTypes.ActiveDirectoryStatus?
    ...
    var fileSharesVisible: Swift.Bool?
    /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
    var gatewayARN: Swift.String?
    ...
    var sMBGuestPasswordSet: Swift.Bool?
    /// A list of Active Directory users and groups that have special permissions for SMB file shares on the gateway.
    var sMBLocalGroups: StorageGatewayClientTypes.SMBLocalGroups?
    ...
    var sMBSecurityStrategy: StorageGatewayClientTypes.SMBSecurityStrategy?
...
public struct DescribeSnapshotScheduleOutputResponse: Swift.Equatable {
    ...
    var recurrenceInHours: Swift.Int?
    /// The hour of the day at which the snapshot schedule begins represented as hh, where hh is the hour (0 to 23). The hour of the day is in the time zone of the gateway.
    var startAt: Swift.Int?
...
public struct DescribeStorediSCSIVolumesOutputResponse: Swift.Equatable {
    ...
    var storediSCSIVolumes: [StorageGatewayClientTypes.StorediSCSIVolume]?
...
public struct DescribeTapeArchivesOutputResponse: Swift.Equatable {
    ...
    var tapeArchives: [StorageGatewayClientTypes.TapeArchive]?
...
public struct DescribeTapeRecoveryPointsOutputResponse: Swift.Equatable {
    ...
    var tapeRecoveryPointInfos: [StorageGatewayClientTypes.TapeRecoveryPointInfo]?
...
public struct DescribeTapesOutputResponse: Swift.Equatable {
    ...
    var tapes: [StorageGatewayClientTypes.Tape]?
...
public struct DescribeUploadBufferOutputResponse: Swift.Equatable {
    ...
    var uploadBufferAllocatedInBytes: Swift.Int
    /// The total number of bytes being used in the gateway's upload buffer.
    var uploadBufferUsedInBytes: Swift.Int
...
public struct DescribeVTLDevicesInput: Swift.Equatable {
    ...
    var vTLDeviceARNs: [Swift.String]?
...
public struct DescribeVTLDevicesOutputResponse: Swift.Equatable {
    ...
    var vTLDevices: [StorageGatewayClientTypes.VTLDevice]?
...
public struct DescribeWorkingStorageOutputResponse: Swift.Equatable {
    ...
    var workingStorageAllocatedInBytes: Swift.Int
    /// The total working storage in bytes in use by the gateway. If no working storage is configured for the gateway, this field returns 0.
    var workingStorageUsedInBytes: Swift.Int
...
extension StorageGatewayClientTypes {
    ...
    public struct DeviceiSCSIAttributes: Swift.Equatable {
        ...
        var chapEnabled: Swift.Bool
        /// The network interface identifier of the VTL device.
        var networkInterfaceId: Swift.String?
        /// The port used to communicate with iSCSI VTL device targets.
        var networkInterfacePort: Swift.Int
...
extension StorageGatewayClientTypes {
    ...
    public struct Disk: Swift.Equatable {
        ...
        var diskAllocationResource: Swift.String?
        ...
        var diskAllocationType: Swift.String?
        /// A list of values that represents attributes of a local disk.
        var diskAttributeList: [Swift.String]?
        /// The unique device ID or other distinguishing data that identifies a local disk.
        var diskId: Swift.String?
        /// The device node of a local disk as assigned by the virtualization environment.
        var diskNode: Swift.String?
        /// The path of a local disk in the gateway virtual machine (VM).
        var diskPath: Swift.String?
        /// The local disk size in bytes.
        var diskSizeInBytes: Swift.Int
        /// A value that represents the status of a local disk.
        var diskStatus: Swift.String?
...
extension StorageGatewayClientTypes {
    ...
    public struct FileShareInfo: Swift.Equatable {
        ...
        var fileShareId: Swift.String?
        /// The status of the file share. Valid Values: CREATING | UPDATING | AVAILABLE | DELETING
        var fileShareStatus: Swift.String?
        /// The type of the file share.
        var fileShareType: StorageGatewayClientTypes.FileShareType?
        /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
        var gatewayARN: Swift.String?
...
extension StorageGatewayClientTypes {
    ...
    public struct FileSystemAssociationInfo: Swift.Equatable {
        ...
        var fileSystemAssociationStatus: Swift.String?
        ...
        var fileSystemAssociationStatusDetails: [StorageGatewayClientTypes.FileSystemAssociationStatusDetail]?
        /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
        var gatewayARN: Swift.String?
...
extension StorageGatewayClientTypes.FileSystemAssociationStatusDetail: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension StorageGatewayClientTypes {
    ...
    public struct FileSystemAssociationSummary: Swift.Equatable {
        ...
        var fileSystemAssociationId: Swift.String?
...
extension StorageGatewayClientTypes {
    ...
    public struct GatewayInfo: Swift.Equatable {
        ...
        var gatewayOperationalState: Swift.String?
        /// The type of the gateway.
        var gatewayType: Swift.String?
        /// The type of hardware or software platform on which the gateway is running.
        var hostEnvironment: StorageGatewayClientTypes.HostEnvironment?
...
public struct JoinDomainInput: Swift.Equatable {
    ...
    var domainControllers: [Swift.String]?
    ...
    var organizationalUnit: Swift.String?
...
public struct ListAutomaticTapeCreationPoliciesOutputResponse: Swift.Equatable {
    ...
    var automaticTapeCreationPolicyInfos: [StorageGatewayClientTypes.AutomaticTapeCreationPolicyInfo]?
...
public struct ListFileSharesOutputResponse: Swift.Equatable {
    ...
    var fileShareInfoList: [StorageGatewayClientTypes.FileShareInfo]?
...
public struct ListFileSystemAssociationsOutputResponse: Swift.Equatable {
    ...
    var fileSystemAssociationSummaryList: [StorageGatewayClientTypes.FileSystemAssociationSummary]?
    /// If the request includes Marker, the response returns that value in this field.
    var marker: Swift.String?
...
public struct ListGatewaysOutputResponse: Swift.Equatable {
    ...
    var gateways: [StorageGatewayClientTypes.GatewayInfo]?
...
public struct ListLocalDisksOutputResponse: Swift.Equatable {
    ...
    var disks: [StorageGatewayClientTypes.Disk]?
    /// The Amazon Resource Name (ARN) of the gateway. Use the [ListGateways] operation to return a list of gateways for your account and Amazon Web Services Region.
    var gatewayARN: Swift.String?
...
public struct ListTapePoolsOutputResponse: Swift.Equatable {
    ...
    var poolInfos: [StorageGatewayClientTypes.PoolInfo]?
...
public struct ListTapesOutputResponse: Swift.Equatable {
    ...
    var tapeInfos: [StorageGatewayClientTypes.TapeInfo]?
...
public struct ListVolumeRecoveryPointsOutputResponse: Swift.Equatable {
    ...
    var volumeRecoveryPointInfos: [StorageGatewayClientTypes.VolumeRecoveryPointInfo]?
...
public struct ListVolumesOutputResponse: Swift.Equatable {
    ...
    var volumeInfos: [StorageGatewayClientTypes.VolumeInfo]?
...
extension StorageGatewayClientTypes {
    ...
    public struct NFSFileShareDefaults: Swift.Equatable {
        ...
        var directoryMode: Swift.String?
        /// The Unix file mode in the form "nnnn". For example, 0666 represents the default file mode inside the file share. The default value is 0666.
        var fileMode: Swift.String?
        /// The default group ID for the file share (unless the files have another group ID specified). The default value is nfsnobody.
        var groupId: Swift.Int?
        /// The default owner ID for files in the file share (unless the files have another owner ID specified). The default value is nfsnobody.
        var ownerId: Swift.Int?
...
public struct NotifyWhenUploadedOutputResponse: Swift.Equatable {
    ...
    var notificationId: Swift.String?
...
extension StorageGatewayClientTypes {
    ...
    public struct PoolInfo: Swift.Equatable {
        ...
        var poolStatus: StorageGatewayClientTypes.PoolStatus?
        /// Tape retention lock time is set in days. Tape retention lock can be enabled for up to 100 years (36,500 days).
        var retentionLockTimeInDays: Swift.Int?
...
extension StorageGatewayClientTypes.SMBLocalGroups: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension StorageGatewayClientTypes {
    ...
    public struct SMBLocalGroups: Swift.Equatable {
        ...
        var gatewayAdmins: [Swift.String]?
...
public struct SetLocalConsolePasswordInput: Swift.Equatable {
    ...
    /// This member is required.
    var localConsolePassword: Swift.String?
...
extension StorageGatewayClientTypes {
    ...
    public struct StorageGatewayError: Swift.Equatable {
        ...
        var errorCode: StorageGatewayClientTypes.ErrorCode?
        /// Human-readable text that provides detail about the error that occurred.
        var errorDetails: [Swift.String:Swift.String]?
...
extension StorageGatewayClientTypes {
    ...
    public struct StorediSCSIVolume: Swift.Equatable {
        ...
        var preservedExistingData: Swift.Bool
...
extension StorageGatewayClientTypes {
    ...
    public struct Tape: Swift.Equatable {
        ...
        var poolEntryDate: ClientRuntime.Date?
...
extension StorageGatewayClientTypes {
    ...
    public struct TapeRecoveryPointInfo: Swift.Equatable {
        ...
        var tapeRecoveryPointTime: ClientRuntime.Date?
...
extension UpdateSMBLocalGroupsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case gatewayARN = "GatewayARN"
        case sMBLocalGroups = "SMBLocalGroups"
    }
...
extension StorageGatewayClientTypes {
    ...
    public struct VTLDevice: Swift.Equatable {
        ...
        var deviceiSCSIAttributes: StorageGatewayClientTypes.DeviceiSCSIAttributes?
        /// Specifies the unique Amazon Resource Name (ARN) of the device (tape drive or media changer).
        var vTLDeviceARN: Swift.String?
        /// Specifies the model number of device that the VTL device emulates.
        var vTLDeviceProductIdentifier: Swift.String?
        /// Specifies the type of device that the VTL device emulates.
        var vTLDeviceType: Swift.String?
        /// Specifies the vendor of the device that the VTL device object emulates.
        var vTLDeviceVendor: Swift.String?
