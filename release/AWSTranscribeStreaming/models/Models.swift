...
extension TranscribeStreamingClientTypes {
    ...
    ///       <a href="https://docs.aws.amazon.com/transcribe/latest/dg/input.html">Speech input. For information
    ///       on audio encoding formats in Amazon Transcribe Medical, see
    ///       <a href="https://docs.aws.amazon.com/transcribe/latest/dg/input-med.html">Speech input.
...
extension TranscribeStreamingClientTypes {
    ...
    public enum AudioStream: Swift.Equatable {
        ...
        ///       events.
        ///          For information on audio encoding formats in Amazon Transcribe, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/input.html">Speech input. For
        ///       information on audio encoding formats in Amazon Transcribe Medical, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/input-med.html">Speech input.
        ///          For more information on stream encoding in Amazon Transcribe, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/event-stream.html">Event stream encoding. For
        ///       information on stream encoding in Amazon Transcribe Medical, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/event-stream-med.html">Event stream encoding.
...
extension StartStreamTranscriptionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartStreamTranscriptionInput(audioStream: \(Swift.String(describing: audioStream)), contentIdentificationType: \(Swift.String(describing: contentIdentificationType)), contentRedactionType: \(Swift.String(describing: contentRedactionType)), enableChannelIdentification: \(Swift.String(describing: enableChannelIdentification)), enablePartialResultsStabilization: \(Swift.String(describing: enablePartialResultsStabilization)), languageCode: \(Swift.String(describing: languageCode)), mediaEncoding: \(Swift.String(describing: mediaEncoding)), mediaSampleRateHertz: \(Swift.String(describing: mediaSampleRateHertz)), numberOfChannels: \(Swift.String(describing: numberOfChannels)), partialResultsStability: \(Swift.String(describing: partialResultsStability)), piiEntityTypes: \(Swift.String(describing: piiEntityTypes)), sessionId: \(Swift.String(describing: sessionId)), showSpeakerLabel: \(Swift.String(describing: showSpeakerLabel)), vocabularyFilterMethod: \(Swift.String(describing: vocabularyFilterMethod)), vocabularyFilterName: \(Swift.String(describing: vocabularyFilterName)), vocabularyName: \(Swift.String(describing: vocabularyName)))"}
}
...
extension StartStreamTranscriptionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartStreamTranscriptionOutputResponse(contentIdentificationType: \(Swift.String(describing: contentIdentificationType)), contentRedactionType: \(Swift.String(describing: contentRedactionType)), enableChannelIdentification: \(Swift.String(describing: enableChannelIdentification)), enablePartialResultsStabilization: \(Swift.String(describing: enablePartialResultsStabilization)), languageCode: \(Swift.String(describing: languageCode)), mediaEncoding: \(Swift.String(describing: mediaEncoding)), mediaSampleRateHertz: \(Swift.String(describing: mediaSampleRateHertz)), numberOfChannels: \(Swift.String(describing: numberOfChannels)), partialResultsStability: \(Swift.String(describing: partialResultsStability)), piiEntityTypes: \(Swift.String(describing: piiEntityTypes)), requestId: \(Swift.String(describing: requestId)), sessionId: \(Swift.String(describing: sessionId)), showSpeakerLabel: \(Swift.String(describing: showSpeakerLabel)), transcriptResultStream: \(Swift.String(describing: transcriptResultStream)), vocabularyFilterMethod: \(Swift.String(describing: vocabularyFilterMethod)), vocabularyFilterName: \(Swift.String(describing: vocabularyFilterName)), vocabularyName: \(Swift.String(describing: vocabularyName)))"}
}
