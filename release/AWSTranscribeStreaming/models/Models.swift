...
extension TranscribeStreamingClientTypes.Alternative: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Alternative(entities: \(Swift.String(describing: entities)), items: \(Swift.String(describing: items)), transcript: \(Swift.String(describing: transcript)))"}
}
...
extension TranscribeStreamingClientTypes.Entity: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TranscribeStreamingClientTypes.Entity: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Entity(category: \(Swift.String(describing: category)), confidence: \(Swift.String(describing: confidence)), content: \(Swift.String(describing: content)), endTime: \(Swift.String(describing: endTime)), startTime: \(Swift.String(describing: startTime)), type: \(Swift.String(describing: type)))"}
}
...
extension TranscribeStreamingClientTypes.LanguageWithScore: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TranscribeStreamingClientTypes.LanguageWithScore: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LanguageWithScore(languageCode: \(Swift.String(describing: languageCode)), score: \(Swift.String(describing: score)))"}
}
...
extension TranscribeStreamingClientTypes.Result: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Result(alternatives: \(Swift.String(describing: alternatives)), channelId: \(Swift.String(describing: channelId)), endTime: \(Swift.String(describing: endTime)), isPartial: \(Swift.String(describing: isPartial)), languageCode: \(Swift.String(describing: languageCode)), languageIdentification: \(Swift.String(describing: languageIdentification)), resultId: \(Swift.String(describing: resultId)), startTime: \(Swift.String(describing: startTime)))"}
}
...
public struct StartMedicalStreamTranscriptionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartMedicalStreamTranscriptionInputURLHostMiddleware"
    ...
    public typealias MInput = StartMedicalStreamTranscriptionInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartMedicalStreamTranscriptionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartMedicalStreamTranscriptionOutputError>
}

public struct StartMedicalStreamTranscriptionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartMedicalStreamTranscriptionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/medical-stream-transcription"
...
extension StartStreamTranscriptionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartStreamTranscriptionInput(audioStream: \(Swift.String(describing: audioStream)), contentIdentificationType: \(Swift.String(describing: contentIdentificationType)), contentRedactionType: \(Swift.String(describing: contentRedactionType)), enableChannelIdentification: \(Swift.String(describing: enableChannelIdentification)), enablePartialResultsStabilization: \(Swift.String(describing: enablePartialResultsStabilization)), identifyLanguage: \(Swift.String(describing: identifyLanguage)), languageCode: \(Swift.String(describing: languageCode)), languageModelName: \(Swift.String(describing: languageModelName)), languageOptions: \(Swift.String(describing: languageOptions)), mediaEncoding: \(Swift.String(describing: mediaEncoding)), mediaSampleRateHertz: \(Swift.String(describing: mediaSampleRateHertz)), numberOfChannels: \(Swift.String(describing: numberOfChannels)), partialResultsStability: \(Swift.String(describing: partialResultsStability)), piiEntityTypes: \(Swift.String(describing: piiEntityTypes)), preferredLanguage: \(Swift.String(describing: preferredLanguage)), sessionId: \(Swift.String(describing: sessionId)), showSpeakerLabel: \(Swift.String(describing: showSpeakerLabel)), vocabularyFilterMethod: \(Swift.String(describing: vocabularyFilterMethod)), vocabularyFilterName: \(Swift.String(describing: vocabularyFilterName)), vocabularyName: \(Swift.String(describing: vocabularyName)))"}
}
...
public struct StartStreamTranscriptionInputHeadersMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        if let contentRedactionType = input.operationInput.contentRedactionType {
            input.builder.withHeader(name: "x-amzn-transcribe-content-redaction-type", value: Swift.String(contentRedactionType.rawValue))
        }
        if input.operationInput.enableChannelIdentification != false {
            input.builder.withHeader(name: "x-amzn-transcribe-enable-channel-identification", value: Swift.String(input.operationInput.enableChannelIdentification))
        }
        ...
        if input.operationInput.identifyLanguage != false {
            input.builder.withHeader(name: "x-amzn-transcribe-identify-language", value: Swift.String(input.operationInput.identifyLanguage))
        }
        if let languageCode = input.operationInput.languageCode {
            input.builder.withHeader(name: "x-amzn-transcribe-language-code", value: Swift.String(languageCode.rawValue))
        }
        if let languageModelName = input.operationInput.languageModelName {
            input.builder.withHeader(name: "x-amzn-transcribe-language-model-name", value: Swift.String(languageModelName))
        }
        if let languageOptions = input.operationInput.languageOptions {
            input.builder.withHeader(name: "x-amzn-transcribe-language-options", value: Swift.String(languageOptions))
        }
        if let mediaEncoding = input.operationInput.mediaEncoding {
            input.builder.withHeader(name: "x-amzn-transcribe-media-encoding", value: Swift.String(mediaEncoding.rawValue))
        }
        ...
        if let piiEntityTypes = input.operationInput.piiEntityTypes {
            input.builder.withHeader(name: "x-amzn-transcribe-pii-entity-types", value: Swift.String(piiEntityTypes))
        }
        if let preferredLanguage = input.operationInput.preferredLanguage {
            input.builder.withHeader(name: "x-amzn-transcribe-preferred-language", value: Swift.String(preferredLanguage.rawValue))
        }
        if let sessionId = input.operationInput.sessionId {
            input.builder.withHeader(name: "x-amzn-transcribe-session-id", value: Swift.String(sessionId))
        }
...
public struct StartStreamTranscriptionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartStreamTranscriptionInputURLHostMiddleware"
    ...
    public typealias MInput = StartStreamTranscriptionInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartStreamTranscriptionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartStreamTranscriptionOutputError>
}

public struct StartStreamTranscriptionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartStreamTranscriptionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/stream-transcription"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension StartStreamTranscriptionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartStreamTranscriptionOutputResponse(contentIdentificationType: \(Swift.String(describing: contentIdentificationType)), contentRedactionType: \(Swift.String(describing: contentRedactionType)), enableChannelIdentification: \(Swift.String(describing: enableChannelIdentification)), enablePartialResultsStabilization: \(Swift.String(describing: enablePartialResultsStabilization)), identifyLanguage: \(Swift.String(describing: identifyLanguage)), languageCode: \(Swift.String(describing: languageCode)), languageModelName: \(Swift.String(describing: languageModelName)), languageOptions: \(Swift.String(describing: languageOptions)), mediaEncoding: \(Swift.String(describing: mediaEncoding)), mediaSampleRateHertz: \(Swift.String(describing: mediaSampleRateHertz)), numberOfChannels: \(Swift.String(describing: numberOfChannels)), partialResultsStability: \(Swift.String(describing: partialResultsStability)), piiEntityTypes: \(Swift.String(describing: piiEntityTypes)), preferredLanguage: \(Swift.String(describing: preferredLanguage)), requestId: \(Swift.String(describing: requestId)), sessionId: \(Swift.String(describing: sessionId)), showSpeakerLabel: \(Swift.String(describing: showSpeakerLabel)), transcriptResultStream: \(Swift.String(describing: transcriptResultStream)), vocabularyFilterMethod: \(Swift.String(describing: vocabularyFilterMethod)), vocabularyFilterName: \(Swift.String(describing: vocabularyFilterName)), vocabularyName: \(Swift.String(describing: vocabularyName)))"}
}
