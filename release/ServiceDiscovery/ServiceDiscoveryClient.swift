...
public class ServiceDiscoveryClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try ServiceDiscoveryClientConfiguration(region: unwrappedRegion)
    ...
    public class ServiceDiscoveryClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("ServiceDiscoveryClient")
...
public struct ServiceDiscoveryClientLogHandlerFactory: SDKLogHandlerFactory {
