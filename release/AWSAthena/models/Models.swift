...
public struct BatchGetNamedQueryInput: Swift.Equatable {
    ...
    var namedQueryIds: [Swift.String]?
...
public struct BatchGetNamedQueryOutputResponse: Swift.Equatable {
    ...
    var namedQueries: [AthenaClientTypes.NamedQuery]?
    /// Information about provided query IDs.
    var unprocessedNamedQueryIds: [AthenaClientTypes.UnprocessedNamedQueryId]?
...
public struct BatchGetQueryExecutionInput: Swift.Equatable {
    ...
    /// This member is required.
    var queryExecutionIds: [Swift.String]?
...
public struct BatchGetQueryExecutionOutputResponse: Swift.Equatable {
    ...
    var queryExecutions: [AthenaClientTypes.QueryExecution]?
    /// Information about the query executions that failed to run.
    var unprocessedQueryExecutionIds: [AthenaClientTypes.UnprocessedQueryExecutionId]?
...
extension AthenaClientTypes {
    ...
    public struct ColumnInfo: Swift.Equatable {
        ...
        var caseSensitive: Swift.Bool
        /// The catalog to which the query results belong.
        var catalogName: Swift.String?
        /// A column label.
        ...
        var nullable: AthenaClientTypes.ColumnNullable?
...
public struct CreateDataCatalogInput: Swift.Equatable {
    ...
    var tags: [AthenaClientTypes.Tag]?
    /// The type of data catalog to create: LAMBDA for a federated catalog, HIVE for an external hive metastore, or GLUE for an Glue Data Catalog.
    /// This member is required.
    var type: AthenaClientTypes.DataCatalogType?
...
public struct CreatePreparedStatementInput: Swift.Equatable {
    ...
    /// This member is required.
    var queryStatement: Swift.String?
...
public struct CreateWorkGroupInput: Swift.Equatable {
    ...
    var configuration: AthenaClientTypes.WorkGroupConfiguration?
...
public struct DeleteWorkGroupInput: Swift.Equatable {
    ...
    var recursiveDeleteOption: Swift.Bool?
...
extension AthenaClientTypes {
    ...
    public struct EncryptionConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var encryptionOption: AthenaClientTypes.EncryptionOption?
...
extension AthenaClientTypes {
    ...
    public struct EngineVersion: Swift.Equatable {
        ...
        var effectiveEngineVersion: Swift.String?
        /// The engine version requested by the user. Possible values are determined by the output of ListEngineVersions, including Auto. The default is Auto.
        var selectedEngineVersion: Swift.String?
...
public struct GetDataCatalogOutputResponse: Swift.Equatable {
    ...
    var dataCatalog: AthenaClientTypes.DataCatalog?
...
public struct GetDatabaseOutputResponse: Swift.Equatable {
    ...
    var database: AthenaClientTypes.Database?
...
public struct GetNamedQueryOutputResponse: Swift.Equatable {
    ...
    var namedQuery: AthenaClientTypes.NamedQuery?
...
public struct GetPreparedStatementOutputResponse: Swift.Equatable {
    ...
    var preparedStatement: AthenaClientTypes.PreparedStatement?
...
public struct GetQueryExecutionInput: Swift.Equatable {
    ...
    /// This member is required.
    var queryExecutionId: Swift.String?
...
public struct GetQueryExecutionOutputResponse: Swift.Equatable {
    ...
    var queryExecution: AthenaClientTypes.QueryExecution?
...
public struct GetQueryResultsOutputResponse: Swift.Equatable {
    ...
    var resultSet: AthenaClientTypes.ResultSet?
    /// The number of rows inserted with a CREATE TABLE AS SELECT statement.
    var updateCount: Swift.Int?
...
public struct GetTableMetadataOutputResponse: Swift.Equatable {
    ...
    var tableMetadata: AthenaClientTypes.TableMetadata?
...
public struct GetWorkGroupOutputResponse: Swift.Equatable {
    ...
    var workGroup: AthenaClientTypes.WorkGroup?
...
public struct ListDataCatalogsOutputResponse: Swift.Equatable {
    ...
    var dataCatalogsSummary: [AthenaClientTypes.DataCatalogSummary]?
    /// A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the NextToken from the response object of the previous page call.
    var nextToken: Swift.String?
...
public struct ListDatabasesOutputResponse: Swift.Equatable {
    ...
    var databaseList: [AthenaClientTypes.Database]?
    /// A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the NextToken from the response object of the previous page call.
    var nextToken: Swift.String?
...
public struct ListEngineVersionsOutputResponse: Swift.Equatable {
    ...
    var engineVersions: [AthenaClientTypes.EngineVersion]?
    /// A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the NextToken from the response object of the previous page call.
    var nextToken: Swift.String?
...
public struct ListPreparedStatementsOutputResponse: Swift.Equatable {
    ...
    var preparedStatements: [AthenaClientTypes.PreparedStatementSummary]?
...
public struct ListTableMetadataOutputResponse: Swift.Equatable {
    ...
    var tableMetadataList: [AthenaClientTypes.TableMetadata]?
...
public struct ListWorkGroupsOutputResponse: Swift.Equatable {
    ...
    var workGroups: [AthenaClientTypes.WorkGroupSummary]?
...
extension AthenaClientTypes {
    ...
    public struct PreparedStatement: Swift.Equatable {
        ...
        var statementName: Swift.String?
        /// The name of the workgroup to which the prepared statement belongs.
        var workGroupName: Swift.String?
...
extension AthenaClientTypes {
    ...
    public struct QueryExecution: Swift.Equatable {
        ...
        var engineVersion: AthenaClientTypes.EngineVersion?
        /// The SQL query statements which the query execution ran.
        var query: Swift.String?
        /// The database in which the query execution occurred.
        var queryExecutionContext: AthenaClientTypes.QueryExecutionContext?
        /// The unique identifier for each query execution.
        var queryExecutionId: Swift.String?
        /// The location in Amazon S3 where query results were stored and the encryption option, if any, used for query results. These are known as "client-side settings". If workgroup settings override client-side settings, then the query uses the location for the query results and the encryption configuration that are specified for the workgroup.
        var resultConfiguration: AthenaClientTypes.ResultConfiguration?
        /// The type of query statement that was run. DDL indicates DDL query statements. DML indicates DML (Data Manipulation Language) query statements, such as CREATE TABLE AS SELECT. UTILITY indicates query statements other than DDL and DML, such as SHOW CREATE TABLE, or DESCRIBE TABLE.
        var statementType: AthenaClientTypes.StatementType?
        /// Query execution statistics, such as the amount of data scanned, the amount of time that the query took to process, and the type of statement that was run.
        var statistics: AthenaClientTypes.QueryExecutionStatistics?
        /// The completion date, current state, submission time, and state change reason (if applicable) for the query execution.
        var status: AthenaClientTypes.QueryExecutionStatus?
...
extension AthenaClientTypes {
    ...
    public struct QueryExecutionStatistics: Swift.Equatable {
        ...
        var dataManifestLocation: Swift.String?
        /// The number of bytes in the data that was queried.
        var dataScannedInBytes: Swift.Int?
        /// The number of milliseconds that the query took to execute.
        var engineExecutionTimeInMillis: Swift.Int?
        /// The number of milliseconds that Athena took to plan the query processing flow. This includes the time spent retrieving table partitions from the data source. Note that because the query engine performs the query planning, query planning time is a subset of engine processing time.
        var queryPlanningTimeInMillis: Swift.Int?
        /// The number of milliseconds that the query was in your query queue waiting for resources. Note that if transient errors occur, Athena might automatically add the query back to the queue.
        var queryQueueTimeInMillis: Swift.Int?
        /// The number of milliseconds that Athena took to finalize and publish the query results after the query engine finished running the query.
        var serviceProcessingTimeInMillis: Swift.Int?
        /// The number of milliseconds that Athena took to run the query.
        var totalExecutionTimeInMillis: Swift.Int?
...
extension AthenaClientTypes {
    ...
    public struct QueryExecutionStatus: Swift.Equatable {
        ...
        var completionDateTime: ClientRuntime.Date?
        /// The state of query execution. QUEUED indicates that the query has been submitted to the service, and Athena will execute the query as soon as resources are available. RUNNING indicates that the query is in execution phase. SUCCEEDED indicates that the query completed without errors. FAILED indicates that the query experienced an error and did not complete processing. CANCELLED indicates that a user input interrupted query execution. Athena automatically retries your queries in cases of certain transient errors. As a result, you may see the query state transition from RUNNING or FAILED to QUEUED.
        var state: AthenaClientTypes.QueryExecutionState?
        /// Further detail about the status of the query.
        var stateChangeReason: Swift.String?
        /// The date and time that the query was submitted.
        var submissionDateTime: ClientRuntime.Date?
...
extension AthenaClientTypes {
    ...
    public struct ResultConfiguration: Swift.Equatable {
        ...
        var encryptionConfiguration: AthenaClientTypes.EncryptionConfiguration?
...
extension AthenaClientTypes {
    ...
    public struct ResultConfigurationUpdates: Swift.Equatable {
        ...
        var removeEncryptionConfiguration: Swift.Bool?
        ...
        var removeOutputLocation: Swift.Bool?
...
extension AthenaClientTypes {
    ...
    public struct ResultSet: Swift.Equatable {
        ...
        var resultSetMetadata: AthenaClientTypes.ResultSetMetadata?
        /// The rows in the table.
        var rows: [AthenaClientTypes.Row]?
...
extension AthenaClientTypes {
    ...
    public struct ResultSetMetadata: Swift.Equatable {
        ...
        var columnInfo: [AthenaClientTypes.ColumnInfo]?
...
extension AthenaClientTypes {
    ...
    public struct Row: Swift.Equatable {
        ...
        var data: [AthenaClientTypes.Datum]?
...
extension AthenaClientTypes {
    ...
    public struct TableMetadata: Swift.Equatable {
        ...
        var columns: [AthenaClientTypes.Column]?
        /// The time that the table was created.
        var createTime: ClientRuntime.Date?
        /// The last time the table was accessed.
        var lastAccessTime: ClientRuntime.Date?
        ...
        var partitionKeys: [AthenaClientTypes.Column]?
        /// The type of table. In Athena, only EXTERNAL_TABLE is supported.
        var tableType: Swift.String?
...
public struct UpdateWorkGroupInput: Swift.Equatable {
    ...
    var configurationUpdates: AthenaClientTypes.WorkGroupConfigurationUpdates?
    /// The workgroup description.
    var description: Swift.String?
    /// The workgroup state that will be updated for the given workgroup.
    var state: AthenaClientTypes.WorkGroupState?
...
extension AthenaClientTypes {
    ...
    public struct WorkGroupConfiguration: Swift.Equatable {
        ...
        var bytesScannedCutoffPerQuery: Swift.Int?
...
extension AthenaClientTypes {
    ...
    public struct WorkGroupConfigurationUpdates: Swift.Equatable {
        ...
        var removeBytesScannedCutoffPerQuery: Swift.Bool?
        ...
        var resultConfigurationUpdates: AthenaClientTypes.ResultConfigurationUpdates?
