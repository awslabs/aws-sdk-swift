...
extension AmplifyBackendClientTypes.BackendAPIAppSyncAuthSettings: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let expirationTimeDecoded = try containerValues.decode(Swift.Double.self, forKey: .expirationTime)
...
extension AmplifyBackendClientTypes {
    ...
    public struct BackendAPIAppSyncAuthSettings: Swift.Equatable {
        ...
        public init (
            ...
            expirationTime: Swift.Double = 0.0,
...
extension AmplifyBackendClientTypes.CreateBackendAuthIdentityPoolConfig: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let unauthenticatedLoginDecoded = try containerValues.decode(Swift.Bool.self, forKey: .unauthenticatedLogin)
...
extension AmplifyBackendClientTypes {
    ...
    public struct CreateBackendAuthIdentityPoolConfig: Swift.Equatable {
        ...
        public init (
            ...
            unauthenticatedLogin: Swift.Bool = false
        )
        {
...
extension AmplifyBackendClientTypes.CreateBackendAuthPasswordPolicyConfig: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let minimumLengthDecoded = try containerValues.decode(Swift.Double.self, forKey: .minimumLength)
...
extension AmplifyBackendClientTypes {
    ...
    public struct CreateBackendAuthPasswordPolicyConfig: Swift.Equatable {
        ...
        public init (
            ...
            minimumLength: Swift.Double = 0.0
        )
        {
...
extension DeleteTokenOutputResponseBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let isSuccessDecoded = try containerValues.decode(Swift.Bool.self, forKey: .isSuccess)
...
extension GatewayTimeoutException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct GatewayTimeoutException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
public struct RemoveAllBackendsInput: Swift.Equatable {
    ...
    public init (
        appId: Swift.String? = nil,
        cleanAmplifyApp: Swift.Bool = false
    )
    {
        self.appId = appId
...
extension RemoveAllBackendsInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let cleanAmplifyAppDecoded = try containerValues.decode(Swift.Bool.self, forKey: .cleanAmplifyApp)
...
extension AmplifyBackendClientTypes.SocialProviderSettings: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SocialProviderSettings(facebook: \(Swift.String(describing: facebook)), google: \(Swift.String(describing: google)), loginWithAmazon: \(Swift.String(describing: loginWithAmazon)))"}
}
