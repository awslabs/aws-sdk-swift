...
public protocol NetworkFirewallClientProtocol {
    ...
    ///          firewalls. </p>
    func associateFirewallPolicy(input: AssociateFirewallPolicyInput, completion: @escaping (SdkResult<AssociateFirewallPolicyOutputResponse, AssociateFirewallPolicyOutputError>) -> Void)
    ...
    func associateSubnets(input: AssociateSubnetsInput, completion: @escaping (SdkResult<AssociateSubnetsOutputResponse, AssociateSubnetsOutputError>) -> Void)
    ...
    func createFirewall(input: CreateFirewallInput, completion: @escaping (SdkResult<CreateFirewallOutputResponse, CreateFirewallOutputError>) -> Void)
    ...
    func createFirewallPolicy(input: CreateFirewallPolicyInput, completion: @escaping (SdkResult<CreateFirewallPolicyOutputResponse, CreateFirewallPolicyOutputError>) -> Void)
    ...
    func deleteFirewall(input: DeleteFirewallInput, completion: @escaping (SdkResult<DeleteFirewallOutputResponse, DeleteFirewallOutputError>) -> Void)
    /// <p>Deletes the specified <a>FirewallPolicy</a>. </p>
    func deleteFirewallPolicy(input: DeleteFirewallPolicyInput, completion: @escaping (SdkResult<DeleteFirewallPolicyOutputResponse, DeleteFirewallPolicyOutputError>) -> Void)
    ...
    func describeFirewall(input: DescribeFirewallInput, completion: @escaping (SdkResult<DescribeFirewallOutputResponse, DescribeFirewallOutputError>) -> Void)
    /// <p>Returns the data objects for the specified firewall policy. </p>
    func describeFirewallPolicy(input: DescribeFirewallPolicyInput, completion: @escaping (SdkResult<DescribeFirewallPolicyOutputResponse, DescribeFirewallPolicyOutputError>) -> Void)
    /// <p>Returns the logging configuration for the specified firewall. </p>
    func describeLoggingConfiguration(input: DescribeLoggingConfigurationInput, completion: @escaping (SdkResult<DescribeLoggingConfigurationOutputResponse, DescribeLoggingConfigurationOutputError>) -> Void)
    ...
    func describeRuleGroup(input: DescribeRuleGroupInput, completion: @escaping (SdkResult<DescribeRuleGroupOutputResponse, DescribeRuleGroupOutputError>) -> Void)
    ...
    ///           were providing.
    ///       </p>
    func disassociateSubnets(input: DisassociateSubnetsInput, completion: @escaping (SdkResult<DisassociateSubnetsOutputResponse, DisassociateSubnetsOutputError>) -> Void)
    ...
    func listFirewallPolicies(input: ListFirewallPoliciesInput, completion: @escaping (SdkResult<ListFirewallPoliciesOutputResponse, ListFirewallPoliciesOutputError>) -> Void)
    ...
    func listFirewalls(input: ListFirewallsInput, completion: @escaping (SdkResult<ListFirewallsOutputResponse, ListFirewallsOutputError>) -> Void)
    ...
    ///          that's in use. </p>
    func updateFirewallDeleteProtection(input: UpdateFirewallDeleteProtectionInput, completion: @escaping (SdkResult<UpdateFirewallDeleteProtectionOutputResponse, UpdateFirewallDeleteProtectionOutputError>) -> Void)
    ...
    func updateFirewallDescription(input: UpdateFirewallDescriptionInput, completion: @escaping (SdkResult<UpdateFirewallDescriptionOutputResponse, UpdateFirewallDescriptionOutputError>) -> Void)
    /// <p>Updates the properties of the specified firewall policy.</p>
    func updateFirewallPolicy(input: UpdateFirewallPolicyInput, completion: @escaping (SdkResult<UpdateFirewallPolicyOutputResponse, UpdateFirewallPolicyOutputError>) -> Void)
    /// <p></p>
    func updateFirewallPolicyChangeProtection(input: UpdateFirewallPolicyChangeProtectionInput, completion: @escaping (SdkResult<UpdateFirewallPolicyChangeProtectionOutputResponse, UpdateFirewallPolicyChangeProtectionOutputError>) -> Void)
    ...
    func updateLoggingConfiguration(input: UpdateLoggingConfigurationInput, completion: @escaping (SdkResult<UpdateLoggingConfigurationOutputResponse, UpdateLoggingConfigurationOutputError>) -> Void)
    ...
    /// <p></p>
    func updateSubnetChangeProtection(input: UpdateSubnetChangeProtectionInput, completion: @escaping (SdkResult<UpdateSubnetChangeProtectionOutputResponse, UpdateSubnetChangeProtectionOutputError>) -> Void)
}
