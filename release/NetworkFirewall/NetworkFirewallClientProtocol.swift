...
public protocol NetworkFirewallClientProtocol {
    ...
    ///          firewalls. </p>
    func associateFirewallPolicy(input: AssociateFirewallPolicyInput, completion: @escaping (SdkResult<AssociateFirewallPolicyOutput, AssociateFirewallPolicyOutputError>) -> Void)
    ...
    func associateSubnets(input: AssociateSubnetsInput, completion: @escaping (SdkResult<AssociateSubnetsOutput, AssociateSubnetsOutputError>) -> Void)
    ...
    func createFirewall(input: CreateFirewallInput, completion: @escaping (SdkResult<CreateFirewallOutput, CreateFirewallOutputError>) -> Void)
    ...
    func createFirewallPolicy(input: CreateFirewallPolicyInput, completion: @escaping (SdkResult<CreateFirewallPolicyOutput, CreateFirewallPolicyOutputError>) -> Void)
    ...
    func deleteFirewall(input: DeleteFirewallInput, completion: @escaping (SdkResult<DeleteFirewallOutput, DeleteFirewallOutputError>) -> Void)
    /// <p>Deletes the specified <a>FirewallPolicy</a>. </p>
    func deleteFirewallPolicy(input: DeleteFirewallPolicyInput, completion: @escaping (SdkResult<DeleteFirewallPolicyOutput, DeleteFirewallPolicyOutputError>) -> Void)
    ...
    func describeFirewall(input: DescribeFirewallInput, completion: @escaping (SdkResult<DescribeFirewallOutput, DescribeFirewallOutputError>) -> Void)
    /// <p>Returns the data objects for the specified firewall policy. </p>
    func describeFirewallPolicy(input: DescribeFirewallPolicyInput, completion: @escaping (SdkResult<DescribeFirewallPolicyOutput, DescribeFirewallPolicyOutputError>) -> Void)
    /// <p>Returns the logging configuration for the specified firewall. </p>
    func describeLoggingConfiguration(input: DescribeLoggingConfigurationInput, completion: @escaping (SdkResult<DescribeLoggingConfigurationOutput, DescribeLoggingConfigurationOutputError>) -> Void)
    ...
    func describeRuleGroup(input: DescribeRuleGroupInput, completion: @escaping (SdkResult<DescribeRuleGroupOutput, DescribeRuleGroupOutputError>) -> Void)
    ...
    ///           were providing.
    ///       </p>
    func disassociateSubnets(input: DisassociateSubnetsInput, completion: @escaping (SdkResult<DisassociateSubnetsOutput, DisassociateSubnetsOutputError>) -> Void)
    ...
    func listFirewallPolicies(input: ListFirewallPoliciesInput, completion: @escaping (SdkResult<ListFirewallPoliciesOutput, ListFirewallPoliciesOutputError>) -> Void)
    ...
    func listFirewalls(input: ListFirewallsInput, completion: @escaping (SdkResult<ListFirewallsOutput, ListFirewallsOutputError>) -> Void)
    ...
    ///          that's in use. </p>
    func updateFirewallDeleteProtection(input: UpdateFirewallDeleteProtectionInput, completion: @escaping (SdkResult<UpdateFirewallDeleteProtectionOutput, UpdateFirewallDeleteProtectionOutputError>) -> Void)
    ...
    func updateFirewallDescription(input: UpdateFirewallDescriptionInput, completion: @escaping (SdkResult<UpdateFirewallDescriptionOutput, UpdateFirewallDescriptionOutputError>) -> Void)
    /// <p>Updates the properties of the specified firewall policy.</p>
    func updateFirewallPolicy(input: UpdateFirewallPolicyInput, completion: @escaping (SdkResult<UpdateFirewallPolicyOutput, UpdateFirewallPolicyOutputError>) -> Void)
    /// <p></p>
    func updateFirewallPolicyChangeProtection(input: UpdateFirewallPolicyChangeProtectionInput, completion: @escaping (SdkResult<UpdateFirewallPolicyChangeProtectionOutput, UpdateFirewallPolicyChangeProtectionOutputError>) -> Void)
    ...
    func updateLoggingConfiguration(input: UpdateLoggingConfigurationInput, completion: @escaping (SdkResult<UpdateLoggingConfigurationOutput, UpdateLoggingConfigurationOutputError>) -> Void)
    ...
    /// <p></p>
    func updateSubnetChangeProtection(input: UpdateSubnetChangeProtectionInput, completion: @escaping (SdkResult<UpdateSubnetChangeProtectionOutput, UpdateSubnetChangeProtectionOutputError>) -> Void)
}
