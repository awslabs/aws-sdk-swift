...
public protocol GlacierClientProtocol {
    ...
    ///          </p>
    func getJobOutput(input: GetJobOutputInput, completion: @escaping (SdkResult<GetJobOutputOutputResponse, GetJobOutputOutputError>) -> Void)
    ...
    ///             <i>Amazon Glacier Developer Guide</i>. </p>
    func uploadArchive(input: UploadArchiveInput, completion: @escaping (SdkResult<UploadArchiveOutputResponse, UploadArchiveOutputError>) -> Void)
    ...
    ///             <i>Amazon Glacier Developer Guide</i>.</p>
    func uploadMultipartPart(input: UploadMultipartPartInput, completion: @escaping (SdkResult<UploadMultipartPartOutputResponse, UploadMultipartPartOutputError>) -> Void)
}
