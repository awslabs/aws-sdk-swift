...
public enum AbortMultipartUploadOutputError: Swift.Error, Equatable {
...
public enum AbortVaultLockOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum AddTagsToVaultOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
...
public enum CompleteMultipartUploadOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum CompleteVaultLockOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum CreateVaultOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case limitExceededException(LimitExceededException)
    case missingParameterValueException(MissingParameterValueException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum DeleteVaultAccessPolicyOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum DeleteVaultNotificationsOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum DeleteVaultOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum DescribeVaultOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum GetDataRetrievalPolicyOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case serviceUnavailableException(ServiceUnavailableException)
    case unknown(UnknownAWSHttpServiceError)
...
public enum GetJobOutputOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum GetVaultAccessPolicyOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
    ...
    public init (httpResponse: HttpResponse, decoder: ResponseDecoder? = nil) throws {
        if case .data(let data) = httpResponse.body,
            ...
            if let responseDecoder = decoder {
                let output: VaultAccessPolicy = try responseDecoder.decode(responseBody: data)
                self.policy = output
            } else {
                self.policy = nil
            }
...
public enum GetVaultLockOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum GetVaultNotificationsOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
extension GetVaultNotificationsOutputResponse: HttpResponseBinding {
    public init (httpResponse: HttpResponse, decoder: ResponseDecoder? = nil) throws {
        if case .data(let data) = httpResponse.body,
            let data = data {
            if let responseDecoder = decoder {
                let output: VaultNotificationConfig = try responseDecoder.decode(responseBody: data)
    ...
    Self.MError == H.MiddlewareError
    {
        if let jobParameters = input.operationInput.jobParameters {
            do {
                ...
                let jobParametersbody = HttpBody.data(jobParametersdata)
...
public enum InitiateJobOutputError: Swift.Error, Equatable {
...
public enum InitiateMultipartUploadOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
    ...
    Self.MError == H.MiddlewareError
    {
        if let policy = input.operationInput.policy {
            do {
                ...
                let policybody = HttpBody.data(policydata)
...
public enum InitiateVaultLockOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum ListMultipartUploadsOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum ListPartsOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum ListProvisionedCapacityOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case serviceUnavailableException(ServiceUnavailableException)
    case unknown(UnknownAWSHttpServiceError)
...
public enum ListTagsForVaultOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum ListVaultsOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum PurchaseProvisionedCapacityOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case limitExceededException(LimitExceededException)
    case missingParameterValueException(MissingParameterValueException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum RemoveTagsFromVaultOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum SetDataRetrievalPolicyOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case serviceUnavailableException(ServiceUnavailableException)
    case unknown(UnknownAWSHttpServiceError)
...
public enum SetVaultAccessPolicyOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
    ...
    Self.MError == H.MiddlewareError
    {
        if let vaultNotificationConfig = input.operationInput.vaultNotificationConfig {
            do {
                ...
                let vaultNotificationConfigbody = HttpBody.data(vaultNotificationConfigdata)
...
public enum SetVaultNotificationsOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case resourceNotFoundException(ResourceNotFoundException)
    case serviceUnavailableException(ServiceUnavailableException)
...
public enum UploadArchiveOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
...
public enum UploadMultipartPartOutputError: Swift.Error, Equatable {
    case invalidParameterValueException(InvalidParameterValueException)
    case missingParameterValueException(MissingParameterValueException)
    case requestTimeoutException(RequestTimeoutException)
    case resourceNotFoundException(ResourceNotFoundException)
