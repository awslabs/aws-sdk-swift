...
public extension GlacierClient {
    ...
    {
        typealias abortVaultLockContinuation = CheckedContinuation<AbortVaultLockOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: abortVaultLockContinuation) in
            abortVaultLock(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias addTagsToVaultContinuation = CheckedContinuation<AddTagsToVaultOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: addTagsToVaultContinuation) in
            addTagsToVault(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias completeVaultLockContinuation = CheckedContinuation<CompleteVaultLockOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: completeVaultLockContinuation) in
            completeVaultLock(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createVaultContinuation = CheckedContinuation<CreateVaultOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createVaultContinuation) in
            createVault(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteVaultContinuation = CheckedContinuation<DeleteVaultOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteVaultContinuation) in
            deleteVault(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteVaultAccessPolicyContinuation = CheckedContinuation<DeleteVaultAccessPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteVaultAccessPolicyContinuation) in
            deleteVaultAccessPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteVaultNotificationsContinuation = CheckedContinuation<DeleteVaultNotificationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteVaultNotificationsContinuation) in
            deleteVaultNotifications(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeVaultContinuation = CheckedContinuation<DescribeVaultOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeVaultContinuation) in
            describeVault(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getDataRetrievalPolicyContinuation = CheckedContinuation<GetDataRetrievalPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getDataRetrievalPolicyContinuation) in
            getDataRetrievalPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getJobOutputContinuation = CheckedContinuation<GetJobOutputOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getJobOutputContinuation) in
            getJobOutput(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getVaultAccessPolicyContinuation = CheckedContinuation<GetVaultAccessPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getVaultAccessPolicyContinuation) in
            getVaultAccessPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getVaultLockContinuation = CheckedContinuation<GetVaultLockOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getVaultLockContinuation) in
            getVaultLock(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getVaultNotificationsContinuation = CheckedContinuation<GetVaultNotificationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getVaultNotificationsContinuation) in
            getVaultNotifications(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias initiateJobContinuation = CheckedContinuation<InitiateJobOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: initiateJobContinuation) in
            initiateJob(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias initiateMultipartUploadContinuation = CheckedContinuation<InitiateMultipartUploadOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: initiateMultipartUploadContinuation) in
            initiateMultipartUpload(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias initiateVaultLockContinuation = CheckedContinuation<InitiateVaultLockOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: initiateVaultLockContinuation) in
            initiateVaultLock(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listProvisionedCapacityContinuation = CheckedContinuation<ListProvisionedCapacityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listProvisionedCapacityContinuation) in
            listProvisionedCapacity(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listTagsForVaultContinuation = CheckedContinuation<ListTagsForVaultOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTagsForVaultContinuation) in
            listTagsForVault(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listVaultsContinuation = CheckedContinuation<ListVaultsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listVaultsContinuation) in
            listVaults(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias purchaseProvisionedCapacityContinuation = CheckedContinuation<PurchaseProvisionedCapacityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: purchaseProvisionedCapacityContinuation) in
            purchaseProvisionedCapacity(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias removeTagsFromVaultContinuation = CheckedContinuation<RemoveTagsFromVaultOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: removeTagsFromVaultContinuation) in
            removeTagsFromVault(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias setDataRetrievalPolicyContinuation = CheckedContinuation<SetDataRetrievalPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: setDataRetrievalPolicyContinuation) in
            setDataRetrievalPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias setVaultAccessPolicyContinuation = CheckedContinuation<SetVaultAccessPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: setVaultAccessPolicyContinuation) in
            setVaultAccessPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias setVaultNotificationsContinuation = CheckedContinuation<SetVaultNotificationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: setVaultNotificationsContinuation) in
            setVaultNotifications(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias uploadArchiveContinuation = CheckedContinuation<UploadArchiveOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: uploadArchiveContinuation) in
            uploadArchive(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias uploadMultipartPartContinuation = CheckedContinuation<UploadMultipartPartOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: uploadMultipartPartContinuation) in
            uploadMultipartPart(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
