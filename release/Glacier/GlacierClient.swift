...
extension GlacierClient: GlacierClientProtocol {
    ...
    public func abortMultipartUpload(input: AbortMultipartUploadInput, completion: @escaping (ClientRuntime.SdkResult<AbortMultipartUploadOutputResponse, AbortMultipartUploadOutputError>) -> Void)
    {
        ...
        guard let vaultName = input.vaultName else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component vaultName unexpectedly nil"))))
            return
        }
        guard let uploadId = input.uploadId else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component uploadId unexpectedly nil"))))
            return
        }
    ...
    public func completeVaultLock(input: CompleteVaultLockInput, completion: @escaping (ClientRuntime.SdkResult<CompleteVaultLockOutputResponse, CompleteVaultLockOutputError>) -> Void)
    {
        ...
        guard let lockId = input.lockId else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component lockId unexpectedly nil"))))
            return
        }
    ...
    public func deleteArchive(input: DeleteArchiveInput, completion: @escaping (ClientRuntime.SdkResult<DeleteArchiveOutputResponse, DeleteArchiveOutputError>) -> Void)
    {
        ...
        guard let archiveId = input.archiveId else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component archiveId unexpectedly nil"))))
            return
        }
