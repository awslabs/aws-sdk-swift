...
extension GlacierClient: GlacierClientProtocol {
    ...
    ///          </p>
    public func getJobOutput(input: GetJobOutputInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetJobOutputOutputResponse, GetJobOutputOutputError>) -> Void)
    {
        guard let accountId = input.accountId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component accountId unexpectedly nil"))))
            return
    ...
    ///             <i>Amazon Glacier Developer Guide</i>. </p>
    public func uploadArchive(input: UploadArchiveInput, streamSource: StreamSource, completion: @escaping (SdkResult<UploadArchiveOutputResponse, UploadArchiveOutputError>) -> Void)
    {
        guard let accountId = input.accountId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component accountId unexpectedly nil"))))
            return
    ...
    ///             <i>Amazon Glacier Developer Guide</i>.</p>
    public func uploadMultipartPart(input: UploadMultipartPartInput, streamSource: StreamSource, completion: @escaping (SdkResult<UploadMultipartPartOutputResponse, UploadMultipartPartOutputError>) -> Void)
    {
        guard let accountId = input.accountId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component accountId unexpectedly nil"))))
            return
