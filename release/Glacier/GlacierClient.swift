...
extension GlacierClient: GlacierClientProtocol {
    ...
    public func uploadArchive(input: UploadArchiveInput, completion: @escaping (ClientRuntime.SdkResult<UploadArchiveOutputResponse, UploadArchiveOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .after, middleware: ContentTypeMiddleware<UploadArchiveInput, UploadArchiveOutputResponse, UploadArchiveOutputError>(contentType: "application/json"))
    ...
    public func uploadMultipartPart(input: UploadMultipartPartInput, completion: @escaping (ClientRuntime.SdkResult<UploadMultipartPartOutputResponse, UploadMultipartPartOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .after, middleware: ContentTypeMiddleware<UploadMultipartPartInput, UploadMultipartPartOutputResponse, UploadMultipartPartOutputError>(contentType: "application/json"))
