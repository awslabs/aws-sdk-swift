...
public protocol SsmClientProtocol {
    ...
    func associateOpsItemRelatedItem(input: AssociateOpsItemRelatedItemInput, completion: @escaping (SdkResult<AssociateOpsItemRelatedItemOutputResponse, AssociateOpsItemRelatedItemOutputError>) -> Void)
    ...
    func cancelCommand(input: CancelCommandInput, completion: @escaping (SdkResult<CancelCommandOutputResponse, CancelCommandOutputError>) -> Void)
    ...
    ///    completion.)</p>
    func cancelMaintenanceWindowExecution(input: CancelMaintenanceWindowExecutionInput, completion: @escaping (SdkResult<CancelMaintenanceWindowExecutionOutputResponse, CancelMaintenanceWindowExecutionOutputError>) -> Void)
    ...
    ///          </note>
    func createActivation(input: CreateActivationInput, completion: @escaping (SdkResult<CreateActivationOutputResponse, CreateActivationOutputError>) -> Void)
    ...
    ///    service. </p>
    func createAssociation(input: CreateAssociationInput, completion: @escaping (SdkResult<CreateAssociationOutputResponse, CreateAssociationOutputError>) -> Void)
    ...
    func createAssociationBatch(input: CreateAssociationBatchInput, completion: @escaping (SdkResult<CreateAssociationBatchOutputResponse, CreateAssociationBatchOutputError>) -> Void)
    ...
    func createDocument(input: CreateDocumentInput, completion: @escaping (SdkResult<CreateDocumentOutputResponse, CreateDocumentOutputError>) -> Void)
    ...
    ///     after 5 PM.</p>
    ///          </note>
    func createMaintenanceWindow(input: CreateMaintenanceWindowInput, completion: @escaping (SdkResult<CreateMaintenanceWindowOutputResponse, CreateMaintenanceWindowOutputError>) -> Void)
    ...
    ///     <i>AWS Systems Manager User Guide</i>. </p>
    func createOpsItem(input: CreateOpsItemInput, completion: @escaping (SdkResult<CreateOpsItemOutputResponse, CreateOpsItemOutputError>) -> Void)
    ...
    func createOpsMetadata(input: CreateOpsMetadataInput, completion: @escaping (SdkResult<CreateOpsMetadataOutputResponse, CreateOpsMetadataOutputError>) -> Void)
    ...
    ///          </note>
    func createPatchBaseline(input: CreatePatchBaselineInput, completion: @escaping (SdkResult<CreatePatchBaselineOutputResponse, CreatePatchBaselineOutputError>) -> Void)
    ...
    ///          </note>
    func createResourceDataSync(input: CreateResourceDataSyncInput, completion: @escaping (SdkResult<CreateResourceDataSyncOutputResponse, CreateResourceDataSyncOutputError>) -> Void)
    ...
    ///    instances.</p>
    func deleteActivation(input: DeleteActivationInput, completion: @escaping (SdkResult<DeleteActivationOutputResponse, DeleteActivationOutputError>) -> Void)
    ...
    ///    instance.</p>
    func deleteAssociation(input: DeleteAssociationInput, completion: @escaping (SdkResult<DeleteAssociationOutputResponse, DeleteAssociationOutputError>) -> Void)
    ...
    func deleteInventory(input: DeleteInventoryInput, completion: @escaping (SdkResult<DeleteInventoryOutputResponse, DeleteInventoryOutputError>) -> Void)
    /// <p>Deletes a maintenance window.</p>
    func deleteMaintenanceWindow(input: DeleteMaintenanceWindowInput, completion: @escaping (SdkResult<DeleteMaintenanceWindowOutputResponse, DeleteMaintenanceWindowOutputError>) -> Void)
    /// <p>Delete OpsMetadata related to an application.</p>
    func deleteOpsMetadata(input: DeleteOpsMetadataInput, completion: @escaping (SdkResult<DeleteOpsMetadataOutputResponse, DeleteOpsMetadataOutputError>) -> Void)
    /// <p>Delete a parameter from the system.</p>
    func deleteParameter(input: DeleteParameterInput, completion: @escaping (SdkResult<DeleteParameterOutputResponse, DeleteParameterOutputError>) -> Void)
    /// <p>Delete a list of parameters.</p>
    func deleteParameters(input: DeleteParametersInput, completion: @escaping (SdkResult<DeleteParametersOutputResponse, DeleteParametersOutputError>) -> Void)
    /// <p>Deletes a patch baseline.</p>
    func deletePatchBaseline(input: DeletePatchBaselineInput, completion: @escaping (SdkResult<DeletePatchBaselineOutputResponse, DeletePatchBaselineOutputError>) -> Void)
    ...
    func deleteResourceDataSync(input: DeleteResourceDataSyncInput, completion: @escaping (SdkResult<DeleteResourceDataSyncOutputResponse, DeleteResourceDataSyncOutputError>) -> Void)
    ...
    func deregisterManagedInstance(input: DeregisterManagedInstanceInput, completion: @escaping (SdkResult<DeregisterManagedInstanceOutputResponse, DeregisterManagedInstanceOutputError>) -> Void)
    /// <p>Removes a patch group from a patch baseline.</p>
    func deregisterPatchBaselineForPatchGroup(input: DeregisterPatchBaselineForPatchGroupInput, completion: @escaping (SdkResult<DeregisterPatchBaselineForPatchGroupOutputResponse, DeregisterPatchBaselineForPatchGroupOutputError>) -> Void)
    /// <p>Removes a target from a maintenance window.</p>
    func deregisterTargetFromMaintenanceWindow(input: DeregisterTargetFromMaintenanceWindowInput, completion: @escaping (SdkResult<DeregisterTargetFromMaintenanceWindowOutputResponse, DeregisterTargetFromMaintenanceWindowOutputError>) -> Void)
    /// <p>Removes a task from a maintenance window.</p>
    func deregisterTaskFromMaintenanceWindow(input: DeregisterTaskFromMaintenanceWindowInput, completion: @escaping (SdkResult<DeregisterTaskFromMaintenanceWindowOutputResponse, DeregisterTaskFromMaintenanceWindowOutputError>) -> Void)
    ...
    func describeActivations(input: DescribeActivationsInput, completion: @escaping (SdkResult<DescribeActivationsOutputResponse, DescribeActivationsOutputError>) -> Void)
    ...
    ///    instance ID. </p>
    func describeAssociation(input: DescribeAssociationInput, completion: @escaping (SdkResult<DescribeAssociationOutputResponse, DescribeAssociationOutputError>) -> Void)
    /// <p>Use this API action to view all executions for a specific association ID. </p>
    func describeAssociationExecutions(input: DescribeAssociationExecutionsInput, completion: @escaping (SdkResult<DescribeAssociationExecutionsOutputResponse, DescribeAssociationExecutionsOutputError>) -> Void)
    /// <p>Use this API action to view information about a specific execution of a specific
    ///    association.</p>
    func describeAssociationExecutionTargets(input: DescribeAssociationExecutionTargetsInput, completion: @escaping (SdkResult<DescribeAssociationExecutionTargetsOutputResponse, DescribeAssociationExecutionTargetsOutputError>) -> Void)
    /// <p>Provides details about all active and terminated Automation executions.</p>
    func describeAutomationExecutions(input: DescribeAutomationExecutionsInput, completion: @escaping (SdkResult<DescribeAutomationExecutionsOutputResponse, DescribeAutomationExecutionsOutputError>) -> Void)
    /// <p>Information about all active and terminated step executions in an Automation
    ///    workflow.</p>
    func describeAutomationStepExecutions(input: DescribeAutomationStepExecutionsInput, completion: @escaping (SdkResult<DescribeAutomationStepExecutionsOutputResponse, DescribeAutomationStepExecutionsOutputError>) -> Void)
    /// <p>Lists all patches eligible to be included in a patch baseline.</p>
    func describeAvailablePatches(input: DescribeAvailablePatchesInput, completion: @escaping (SdkResult<DescribeAvailablePatchesOutputResponse, DescribeAvailablePatchesOutputError>) -> Void)
    /// <p>Describes the specified Systems Manager document.</p>
    func describeDocument(input: DescribeDocumentInput, completion: @escaping (SdkResult<DescribeDocumentOutputResponse, DescribeDocumentOutputError>) -> Void)
    ...
    func describeDocumentPermission(input: DescribeDocumentPermissionInput, completion: @escaping (SdkResult<DescribeDocumentPermissionOutputResponse, DescribeDocumentPermissionOutputError>) -> Void)
    /// <p>All associations for the instance(s).</p>
    func describeEffectiveInstanceAssociations(input: DescribeEffectiveInstanceAssociationsInput, completion: @escaping (SdkResult<DescribeEffectiveInstanceAssociationsOutputResponse, DescribeEffectiveInstanceAssociationsOutputError>) -> Void)
    ...
    func describeEffectivePatchesForPatchBaseline(input: DescribeEffectivePatchesForPatchBaselineInput, completion: @escaping (SdkResult<DescribeEffectivePatchesForPatchBaselineOutputResponse, DescribeEffectivePatchesForPatchBaselineOutputError>) -> Void)
    /// <p>The status of the associations for the instance(s).</p>
    func describeInstanceAssociationsStatus(input: DescribeInstanceAssociationsStatusInput, completion: @escaping (SdkResult<DescribeInstanceAssociationsStatusOutputResponse, DescribeInstanceAssociationsStatusOutputError>) -> Void)
    ...
    ///     instances.</p>
    ///          </note>
    func describeInstanceInformation(input: DescribeInstanceInformationInput, completion: @escaping (SdkResult<DescribeInstanceInformationOutputResponse, DescribeInstanceInformationOutputError>) -> Void)
    ...
    func describeInstancePatches(input: DescribeInstancePatchesInput, completion: @escaping (SdkResult<DescribeInstancePatchesOutputResponse, DescribeInstancePatchesOutputError>) -> Void)
    /// <p>Retrieves the high-level patch state of one or more instances.</p>
    func describeInstancePatchStates(input: DescribeInstancePatchStatesInput, completion: @escaping (SdkResult<DescribeInstancePatchStatesOutputResponse, DescribeInstancePatchStatesOutputError>) -> Void)
    /// <p>Retrieves the high-level patch state for the instances in the specified patch group.</p>
    func describeInstancePatchStatesForPatchGroup(input: DescribeInstancePatchStatesForPatchGroupInput, completion: @escaping (SdkResult<DescribeInstancePatchStatesForPatchGroupOutputResponse, DescribeInstancePatchStatesForPatchGroupOutputError>) -> Void)
    /// <p>Describes a specific delete inventory operation.</p>
    func describeInventoryDeletions(input: DescribeInventoryDeletionsInput, completion: @escaping (SdkResult<DescribeInventoryDeletionsOutputResponse, DescribeInventoryDeletionsOutputError>) -> Void)
    ...
    func describeMaintenanceWindowExecutions(input: DescribeMaintenanceWindowExecutionsInput, completion: @escaping (SdkResult<DescribeMaintenanceWindowExecutionsOutputResponse, DescribeMaintenanceWindowExecutionsOutputError>) -> Void)
    ...
    func describeMaintenanceWindowExecutionTaskInvocations(input: DescribeMaintenanceWindowExecutionTaskInvocationsInput, completion: @escaping (SdkResult<DescribeMaintenanceWindowExecutionTaskInvocationsOutputResponse, DescribeMaintenanceWindowExecutionTaskInvocationsOutputError>) -> Void)
    /// <p>For a given maintenance window execution, lists the tasks that were run.</p>
    func describeMaintenanceWindowExecutionTasks(input: DescribeMaintenanceWindowExecutionTasksInput, completion: @escaping (SdkResult<DescribeMaintenanceWindowExecutionTasksOutputResponse, DescribeMaintenanceWindowExecutionTasksOutputError>) -> Void)
    /// <p>Retrieves the maintenance windows in an AWS account.</p>
    func describeMaintenanceWindows(input: DescribeMaintenanceWindowsInput, completion: @escaping (SdkResult<DescribeMaintenanceWindowsOutputResponse, DescribeMaintenanceWindowsOutputError>) -> Void)
    /// <p>Retrieves information about upcoming executions of a maintenance window.</p>
    func describeMaintenanceWindowSchedule(input: DescribeMaintenanceWindowScheduleInput, completion: @escaping (SdkResult<DescribeMaintenanceWindowScheduleOutputResponse, DescribeMaintenanceWindowScheduleOutputError>) -> Void)
    /// <p>Retrieves information about the maintenance window targets or tasks that an instance is
    ///    associated with.</p>
    func describeMaintenanceWindowsForTarget(input: DescribeMaintenanceWindowsForTargetInput, completion: @escaping (SdkResult<DescribeMaintenanceWindowsForTargetOutputResponse, DescribeMaintenanceWindowsForTargetOutputError>) -> Void)
    /// <p>Lists the targets registered with the maintenance window.</p>
    func describeMaintenanceWindowTargets(input: DescribeMaintenanceWindowTargetsInput, completion: @escaping (SdkResult<DescribeMaintenanceWindowTargetsOutputResponse, DescribeMaintenanceWindowTargetsOutputError>) -> Void)
    ...
    ///          </note>
    func describeMaintenanceWindowTasks(input: DescribeMaintenanceWindowTasksInput, completion: @escaping (SdkResult<DescribeMaintenanceWindowTasksOutputResponse, DescribeMaintenanceWindowTasksOutputError>) -> Void)
    ...
    ///    information, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the
    ///     <i>AWS Systems Manager User Guide</i>. </p>
    func describeOpsItems(input: DescribeOpsItemsInput, completion: @escaping (SdkResult<DescribeOpsItemsOutputResponse, DescribeOpsItemsOutputError>) -> Void)
    ...
    func describePatchBaselines(input: DescribePatchBaselinesInput, completion: @escaping (SdkResult<DescribePatchBaselinesOutputResponse, DescribePatchBaselinesOutputError>) -> Void)
    /// <p>Lists all patch groups that have been registered with patch baselines.</p>
    func describePatchGroups(input: DescribePatchGroupsInput, completion: @escaping (SdkResult<DescribePatchGroupsOutputResponse, DescribePatchGroupsOutputError>) -> Void)
    /// <p>Returns high-level aggregated patch compliance state for a patch group.</p>
    func describePatchGroupState(input: DescribePatchGroupStateInput, completion: @escaping (SdkResult<DescribePatchGroupStateOutputResponse, DescribePatchGroupStateOutputError>) -> Void)
    ...
    ///             </dd>
    ///          </dl>
    func describePatchProperties(input: DescribePatchPropertiesInput, completion: @escaping (SdkResult<DescribePatchPropertiesOutputResponse, DescribePatchPropertiesOutputError>) -> Void)
    ...
    func disassociateOpsItemRelatedItem(input: DisassociateOpsItemRelatedItemInput, completion: @escaping (SdkResult<DisassociateOpsItemRelatedItemOutputResponse, DisassociateOpsItemRelatedItemOutputError>) -> Void)
    /// <p>Get detailed information about a particular Automation execution.</p>
    func getAutomationExecution(input: GetAutomationExecutionInput, completion: @escaping (SdkResult<GetAutomationExecutionOutputResponse, GetAutomationExecutionOutputError>) -> Void)
    ...
    func getCalendarState(input: GetCalendarStateInput, completion: @escaping (SdkResult<GetCalendarStateOutputResponse, GetCalendarStateOutputError>) -> Void)
    ...
    ///     <a>ListCommands</a>.</p>
    func getCommandInvocation(input: GetCommandInvocationInput, completion: @escaping (SdkResult<GetCommandInvocationOutputResponse, GetCommandInvocationOutputError>) -> Void)
    ...
    func getConnectionStatus(input: GetConnectionStatusInput, completion: @escaping (SdkResult<GetConnectionStatusOutputResponse, GetConnectionStatusOutputError>) -> Void)
    ...
    ///    returned.</p>
    func getDefaultPatchBaseline(input: GetDefaultPatchBaselineInput, completion: @escaping (SdkResult<GetDefaultPatchBaselineOutputResponse, GetDefaultPatchBaselineOutputError>) -> Void)
    ...
    func getDeployablePatchSnapshotForInstance(input: GetDeployablePatchSnapshotForInstanceInput, completion: @escaping (SdkResult<GetDeployablePatchSnapshotForInstanceOutputResponse, GetDeployablePatchSnapshotForInstanceOutputError>) -> Void)
    ...
    func getInventory(input: GetInventoryInput, completion: @escaping (SdkResult<GetInventoryOutputResponse, GetInventoryOutputError>) -> Void)
    ...
    func getInventorySchema(input: GetInventorySchemaInput, completion: @escaping (SdkResult<GetInventorySchemaOutputResponse, GetInventorySchemaOutputError>) -> Void)
    /// <p>Retrieves a maintenance window.</p>
    func getMaintenanceWindow(input: GetMaintenanceWindowInput, completion: @escaping (SdkResult<GetMaintenanceWindowOutputResponse, GetMaintenanceWindowOutputError>) -> Void)
    /// <p>Retrieves details about a specific a maintenance window execution.</p>
    func getMaintenanceWindowExecution(input: GetMaintenanceWindowExecutionInput, completion: @escaping (SdkResult<GetMaintenanceWindowExecutionOutputResponse, GetMaintenanceWindowExecutionOutputError>) -> Void)
    /// <p>Retrieves the details about a specific task run as part of a maintenance window
    ///    execution.</p>
    func getMaintenanceWindowExecutionTask(input: GetMaintenanceWindowExecutionTaskInput, completion: @escaping (SdkResult<GetMaintenanceWindowExecutionTaskOutputResponse, GetMaintenanceWindowExecutionTaskOutputError>) -> Void)
    /// <p>Retrieves information about a specific task running on a specific target.</p>
    func getMaintenanceWindowExecutionTaskInvocation(input: GetMaintenanceWindowExecutionTaskInvocationInput, completion: @escaping (SdkResult<GetMaintenanceWindowExecutionTaskInvocationOutputResponse, GetMaintenanceWindowExecutionTaskInvocationOutputError>) -> Void)
    /// <p>Lists the tasks in a maintenance window.</p>
    ///          <note>
    ///             <p>For maintenance window tasks without a specified target, you cannot supply values for
    ///      <code>--max-errors</code> and <code>--max-concurrency</code>. Instead, the system inserts a
    ...
    ///     These values do not affect the running of your task and can be ignored.</p>
    ///          </note>
    func getMaintenanceWindowTask(input: GetMaintenanceWindowTaskInput, completion: @escaping (SdkResult<GetMaintenanceWindowTaskOutputResponse, GetMaintenanceWindowTaskOutputError>) -> Void)
    ...
    ///    information, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the
    ///     <i>AWS Systems Manager User Guide</i>. </p>
    func getOpsItem(input: GetOpsItemInput, completion: @escaping (SdkResult<GetOpsItemOutputResponse, GetOpsItemOutputError>) -> Void)
    /// <p>View operational metadata related to an application in Application Manager.</p>
    func getOpsMetadata(input: GetOpsMetadataInput, completion: @escaping (SdkResult<GetOpsMetadataOutputResponse, GetOpsMetadataOutputError>) -> Void)
    /// <p>View a summary of OpsItems based on specified filters and aggregators.</p>
    func getOpsSummary(input: GetOpsSummaryInput, completion: @escaping (SdkResult<GetOpsSummaryOutputResponse, GetOpsSummaryOutputError>) -> Void)
    ...
    func getParameter(input: GetParameterInput, completion: @escaping (SdkResult<GetParameterOutputResponse, GetParameterOutputError>) -> Void)
    /// <p>Retrieves the history of all changes to a parameter.</p>
    func getParameterHistory(input: GetParameterHistoryInput, completion: @escaping (SdkResult<GetParameterHistoryOutputResponse, GetParameterHistoryOutputError>) -> Void)
    /// <p>Get details of a parameter. Don't confuse this API action with the <a>GetParameter</a> API action.</p>
    func getParameters(input: GetParametersInput, completion: @escaping (SdkResult<GetParametersOutputResponse, GetParametersOutputError>) -> Void)
    ...
    ///      <code>NextToken</code> in a subsequent call to get the next set of results.</p>
    ///          </note>
    func getParametersByPath(input: GetParametersByPathInput, completion: @escaping (SdkResult<GetParametersByPathOutputResponse, GetParametersByPathOutputError>) -> Void)
    /// <p>Retrieves information about a patch baseline.</p>
    func getPatchBaseline(input: GetPatchBaselineInput, completion: @escaping (SdkResult<GetPatchBaselineOutputResponse, GetPatchBaselineOutputError>) -> Void)
    /// <p>Retrieves the patch baseline that should be used for the specified patch group.</p>
    func getPatchBaselineForPatchGroup(input: GetPatchBaselineForPatchGroupInput, completion: @escaping (SdkResult<GetPatchBaselineForPatchGroupOutputResponse, GetPatchBaselineForPatchGroupOutputError>) -> Void)
    /// <p>
    ...
    func getServiceSetting(input: GetServiceSettingInput, completion: @escaping (SdkResult<GetServiceSettingOutputResponse, GetServiceSettingOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func labelParameterVersion(input: LabelParameterVersionInput, completion: @escaping (SdkResult<LabelParameterVersionOutputResponse, LabelParameterVersionOutputError>) -> Void)
    ...
    ///    filter.</p>
    func listAssociations(input: ListAssociationsInput, completion: @escaping (SdkResult<ListAssociationsOutputResponse, ListAssociationsOutputError>) -> Void)
    /// <p>Retrieves all versions of an association for a specific association ID.</p>
    func listAssociationVersions(input: ListAssociationVersionsInput, completion: @escaping (SdkResult<ListAssociationVersionsOutputResponse, ListAssociationVersionsOutputError>) -> Void)
    ...
    func listCommandInvocations(input: ListCommandInvocationsInput, completion: @escaping (SdkResult<ListCommandInvocationsOutputResponse, ListCommandInvocationsOutputError>) -> Void)
    /// <p>Lists the commands requested by users of the AWS account.</p>
    func listCommands(input: ListCommandsInput, completion: @escaping (SdkResult<ListCommandsOutputResponse, ListCommandsOutputError>) -> Void)
    ...
    func listComplianceItems(input: ListComplianceItemsInput, completion: @escaping (SdkResult<ListComplianceItemsOutputResponse, ListComplianceItemsOutputError>) -> Void)
    ...
    func listComplianceSummaries(input: ListComplianceSummariesInput, completion: @escaping (SdkResult<ListComplianceSummariesOutputResponse, ListComplianceSummariesOutputError>) -> Void)
    /// <p>Information about approval reviews for a version of an SSM document.</p>
    func listDocumentMetadataHistory(input: ListDocumentMetadataHistoryInput, completion: @escaping (SdkResult<ListDocumentMetadataHistoryOutputResponse, ListDocumentMetadataHistoryOutputError>) -> Void)
    ...
    func listDocuments(input: ListDocumentsInput, completion: @escaping (SdkResult<ListDocumentsOutputResponse, ListDocumentsOutputError>) -> Void)
    /// <p>List all versions for a document.</p>
    func listDocumentVersions(input: ListDocumentVersionsInput, completion: @escaping (SdkResult<ListDocumentVersionsOutputResponse, ListDocumentVersionsOutputError>) -> Void)
    /// <p>A list of inventory items returned by the request.</p>
    func listInventoryEntries(input: ListInventoryEntriesInput, completion: @escaping (SdkResult<ListInventoryEntriesOutputResponse, ListInventoryEntriesOutputError>) -> Void)
    ...
    func listOpsItemEvents(input: ListOpsItemEventsInput, completion: @escaping (SdkResult<ListOpsItemEventsOutputResponse, ListOpsItemEventsOutputError>) -> Void)
    /// <p>Lists all related-item resources associated with an OpsItem.</p>
    func listOpsItemRelatedItems(input: ListOpsItemRelatedItemsInput, completion: @escaping (SdkResult<ListOpsItemRelatedItemsOutputResponse, ListOpsItemRelatedItemsOutputError>) -> Void)
    /// <p>Systems Manager calls this API action when displaying all Application Manager OpsMetadata objects or
    ///    blobs.</p>
    func listOpsMetadata(input: ListOpsMetadataInput, completion: @escaping (SdkResult<ListOpsMetadataOutputResponse, ListOpsMetadataOutputError>) -> Void)
    ...
    func listResourceComplianceSummaries(input: ListResourceComplianceSummariesInput, completion: @escaping (SdkResult<ListResourceComplianceSummariesOutputResponse, ListResourceComplianceSummariesOutputError>) -> Void)
    ...
    func listResourceDataSync(input: ListResourceDataSyncInput, completion: @escaping (SdkResult<ListResourceDataSyncOutputResponse, ListResourceDataSyncOutputError>) -> Void)
    ...
    func modifyDocumentPermission(input: ModifyDocumentPermissionInput, completion: @escaping (SdkResult<ModifyDocumentPermissionOutputResponse, ModifyDocumentPermissionOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func putComplianceItems(input: PutComplianceItemsInput, completion: @escaping (SdkResult<PutComplianceItemsOutputResponse, PutComplianceItemsOutputError>) -> Void)
    ...
    func putInventory(input: PutInventoryInput, completion: @escaping (SdkResult<PutInventoryOutputResponse, PutInventoryOutputError>) -> Void)
    /// <p>Add a parameter to the system.</p>
    func putParameter(input: PutParameterInput, completion: @escaping (SdkResult<PutParameterOutputResponse, PutParameterOutputError>) -> Void)
    ...
    func registerDefaultPatchBaseline(input: RegisterDefaultPatchBaselineInput, completion: @escaping (SdkResult<RegisterDefaultPatchBaselineOutputResponse, RegisterDefaultPatchBaselineOutputError>) -> Void)
    /// <p>Registers a patch baseline for a patch group.</p>
    func registerPatchBaselineForPatchGroup(input: RegisterPatchBaselineForPatchGroupInput, completion: @escaping (SdkResult<RegisterPatchBaselineForPatchGroupOutputResponse, RegisterPatchBaselineForPatchGroupOutputError>) -> Void)
    /// <p>Registers a target with a maintenance window.</p>
    func registerTargetWithMaintenanceWindow(input: RegisterTargetWithMaintenanceWindowInput, completion: @escaping (SdkResult<RegisterTargetWithMaintenanceWindowOutputResponse, RegisterTargetWithMaintenanceWindowOutputError>) -> Void)
    /// <p>Adds a new task to a maintenance window.</p>
    func registerTaskWithMaintenanceWindow(input: RegisterTaskWithMaintenanceWindowInput, completion: @escaping (SdkResult<RegisterTaskWithMaintenanceWindowOutputResponse, RegisterTaskWithMaintenanceWindowOutputError>) -> Void)
    ...
    ///    service team. </p>
    func resetServiceSetting(input: ResetServiceSettingInput, completion: @escaping (SdkResult<ResetServiceSettingOutputResponse, ResetServiceSettingOutputError>) -> Void)
    ...
    ///          </note>
    func resumeSession(input: ResumeSessionInput, completion: @escaping (SdkResult<ResumeSessionOutputResponse, ResumeSessionOutputError>) -> Void)
    /// <p>Sends a signal to an Automation execution to change the current behavior or status of the
    ///    execution. </p>
    func sendAutomationSignal(input: SendAutomationSignalInput, completion: @escaping (SdkResult<SendAutomationSignalOutputResponse, SendAutomationSignalOutputError>) -> Void)
    ...
    func startAssociationsOnce(input: StartAssociationsOnceInput, completion: @escaping (SdkResult<StartAssociationsOnceOutputResponse, StartAssociationsOnceOutputError>) -> Void)
    /// <p>Initiates execution of an Automation document.</p>
    func startAutomationExecution(input: StartAutomationExecutionInput, completion: @escaping (SdkResult<StartAutomationExecutionOutputResponse, StartAutomationExecutionOutputError>) -> Void)
    /// <p>Creates a change request for Change Manager. The runbooks (Automation documents) specified in the
    ///    change request run only after all required approvals for the change request have been
    ///    received.</p>
    func startChangeRequestExecution(input: StartChangeRequestExecutionInput, completion: @escaping (SdkResult<StartChangeRequestExecutionOutputResponse, StartChangeRequestExecutionOutputError>) -> Void)
    ...
    ///          </note>
    func startSession(input: StartSessionInput, completion: @escaping (SdkResult<StartSessionOutputResponse, StartSessionOutputError>) -> Void)
    /// <p>Stop an Automation that is currently running.</p>
    func stopAutomationExecution(input: StopAutomationExecutionInput, completion: @escaping (SdkResult<StopAutomationExecutionOutputResponse, StopAutomationExecutionOutputError>) -> Void)
    ...
    func terminateSession(input: TerminateSessionInput, completion: @escaping (SdkResult<TerminateSessionOutputResponse, TerminateSessionOutputError>) -> Void)
    /// <p>Remove a label or labels from a parameter.</p>
    func unlabelParameterVersion(input: UnlabelParameterVersionInput, completion: @escaping (SdkResult<UnlabelParameterVersionOutputResponse, UnlabelParameterVersionOutputError>) -> Void)
    ...
    ///     targets.</p>
    ///          </important>
    func updateAssociation(input: UpdateAssociationInput, completion: @escaping (SdkResult<UpdateAssociationOutputResponse, UpdateAssociationOutputError>) -> Void)
    /// <p>Updates the status of the Systems Manager document associated with the specified instance.</p>
    func updateAssociationStatus(input: UpdateAssociationStatusInput, completion: @escaping (SdkResult<UpdateAssociationStatusOutputResponse, UpdateAssociationStatusOutputError>) -> Void)
    ...
    func updateDocumentDefaultVersion(input: UpdateDocumentDefaultVersionInput, completion: @escaping (SdkResult<UpdateDocumentDefaultVersionOutputResponse, UpdateDocumentDefaultVersionOutputError>) -> Void)
    /// <p>Updates information related to approval reviews for a specific version of a document.</p>
    func updateDocumentMetadata(input: UpdateDocumentMetadataInput, completion: @escaping (SdkResult<UpdateDocumentMetadataOutputResponse, UpdateDocumentMetadataOutputError>) -> Void)
    ...
    ///     after 5 PM.</p>
    ///          </note>
    func updateMaintenanceWindow(input: UpdateMaintenanceWindowInput, completion: @escaping (SdkResult<UpdateMaintenanceWindowOutputResponse, UpdateMaintenanceWindowOutputError>) -> Void)
    ...
    ///          </note>
    func updateMaintenanceWindowTarget(input: UpdateMaintenanceWindowTargetInput, completion: @escaping (SdkResult<UpdateMaintenanceWindowTargetOutputResponse, UpdateMaintenanceWindowTargetOutputError>) -> Void)
    ...
    ///          </important>
    func updateMaintenanceWindowTask(input: UpdateMaintenanceWindowTaskInput, completion: @escaping (SdkResult<UpdateMaintenanceWindowTaskOutputResponse, UpdateMaintenanceWindowTaskOutputError>) -> Void)
    ...
    func updateManagedInstanceRole(input: UpdateManagedInstanceRoleInput, completion: @escaping (SdkResult<UpdateManagedInstanceRoleOutputResponse, UpdateManagedInstanceRoleOutputError>) -> Void)
    ...
    ///    information, see <a href="https://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html">AWS Systems Manager OpsCenter</a> in the
    ///     <i>AWS Systems Manager User Guide</i>. </p>
    func updateOpsItem(input: UpdateOpsItemInput, completion: @escaping (SdkResult<UpdateOpsItemOutputResponse, UpdateOpsItemOutputError>) -> Void)
    /// <p>Systems Manager calls this API action when you edit OpsMetadata in Application Manager.</p>
    func updateOpsMetadata(input: UpdateOpsMetadataInput, completion: @escaping (SdkResult<UpdateOpsMetadataOutputResponse, UpdateOpsMetadataOutputError>) -> Void)
    ...
    ///     supported operating system type, see <a href="http://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html">PatchFilter</a>.</p>
    ///          </note>
    func updatePatchBaseline(input: UpdatePatchBaselineInput, completion: @escaping (SdkResult<UpdatePatchBaselineOutputResponse, UpdatePatchBaselineOutputError>) -> Void)
    ...
    ///          </note>
    func updateResourceDataSync(input: UpdateResourceDataSyncInput, completion: @escaping (SdkResult<UpdateResourceDataSyncOutputResponse, UpdateResourceDataSyncOutputError>) -> Void)
    /// <p>
    ///             <code>ServiceSetting</code> is an account-level setting for an AWS service. This setting
    ///    defines how a user interacts with or uses a service or a feature of a service. For example, if an
    ///    AWS service charges money to the account based on feature or service usage, then the AWS service
    ...
    func updateServiceSetting(input: UpdateServiceSettingInput, completion: @escaping (SdkResult<UpdateServiceSettingOutputResponse, UpdateServiceSettingOutputError>) -> Void)
}
