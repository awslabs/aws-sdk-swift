...
public class SsmClient {
    ...
    let config: SsmClientConfiguration
    let serviceName = "SSM"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: SsmClientConfiguration) {
    ...
    public class SsmClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "SsmClient")
        }
        ...
        public static func `default`() throws -> SsmClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try SsmClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
