...
public protocol MacieClientProtocol {
    ...
    ///       account.</p>
    func associateMemberAccount(input: AssociateMemberAccountInput, completion: @escaping (SdkResult<AssociateMemberAccountOutputResponse, AssociateMemberAccountOutputError>) -> Void)
    ...
    ///       account. </p>
    func associateS3Resources(input: AssociateS3ResourcesInput, completion: @escaping (SdkResult<AssociateS3ResourcesOutputResponse, AssociateS3ResourcesOutputError>) -> Void)
    /// <p>Removes the specified member account from Amazon Macie Classic.</p>
    func disassociateMemberAccount(input: DisassociateMemberAccountInput, completion: @escaping (SdkResult<DisassociateMemberAccountOutputResponse, DisassociateMemberAccountOutputError>) -> Void)
    ...
    func disassociateS3Resources(input: DisassociateS3ResourcesInput, completion: @escaping (SdkResult<DisassociateS3ResourcesOutputResponse, DisassociateS3ResourcesOutputError>) -> Void)
    ...
    func listS3Resources(input: ListS3ResourcesInput, completion: @escaping (SdkResult<ListS3ResourcesOutputResponse, ListS3ResourcesOutputError>) -> Void)
    ...
    func updateS3Resources(input: UpdateS3ResourcesInput, completion: @escaping (SdkResult<UpdateS3ResourcesOutputResponse, UpdateS3ResourcesOutputError>) -> Void)
}
