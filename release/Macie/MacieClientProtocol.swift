...
public protocol MacieClientProtocol {
    ...
    ///       account.</p>
    func associateMemberAccount(input: AssociateMemberAccountInput, completion: @escaping (SdkResult<AssociateMemberAccountOutput, AssociateMemberAccountOutputError>) -> Void)
    ...
    ///       account. </p>
    func associateS3Resources(input: AssociateS3ResourcesInput, completion: @escaping (SdkResult<AssociateS3ResourcesOutput, AssociateS3ResourcesOutputError>) -> Void)
    /// <p>Removes the specified member account from Amazon Macie Classic.</p>
    func disassociateMemberAccount(input: DisassociateMemberAccountInput, completion: @escaping (SdkResult<DisassociateMemberAccountOutput, DisassociateMemberAccountOutputError>) -> Void)
    ...
    func disassociateS3Resources(input: DisassociateS3ResourcesInput, completion: @escaping (SdkResult<DisassociateS3ResourcesOutput, DisassociateS3ResourcesOutputError>) -> Void)
    /// <p>Lists all Amazon Macie Classic member accounts for the current Macie Classic administrator account.</p>
    func listMemberAccounts(input: ListMemberAccountsInput, completion: @escaping (SdkResult<ListMemberAccountsOutput, ListMemberAccountsOutputError>) -> Void)
    ...
    func listS3Resources(input: ListS3ResourcesInput, completion: @escaping (SdkResult<ListS3ResourcesOutput, ListS3ResourcesOutputError>) -> Void)
    ...
    func updateS3Resources(input: UpdateS3ResourcesInput, completion: @escaping (SdkResult<UpdateS3ResourcesOutput, UpdateS3ResourcesOutputError>) -> Void)
}
