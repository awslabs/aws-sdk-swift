...
extension InternalDependencyException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InternalDependencyException(message: \(Swift.String(describing: message)))"}
}
...
extension InvokeEndpointAsyncInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvokeEndpointAsyncInput(accept: \(Swift.String(describing: accept)), contentType: \(Swift.String(describing: contentType)), customAttributes: \(Swift.String(describing: customAttributes)), endpointName: \(Swift.String(describing: endpointName)), inferenceId: \(Swift.String(describing: inferenceId)), inputLocation: \(Swift.String(describing: inputLocation)), requestTTLSeconds: \(Swift.String(describing: requestTTLSeconds)))"}
}

extension InvokeEndpointAsyncInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct InvokeEndpointAsyncInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeEndpointAsyncInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<InvokeEndpointAsyncInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<InvokeEndpointAsyncOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    Self.MError == H.MiddlewareError
    {
        if let accept = input.operationInput.accept {
            input.builder.withHeader(name: "X-Amzn-SageMaker-Accept", value: Swift.String(accept))
        }
        if let contentType = input.operationInput.contentType {
            input.builder.withHeader(name: "X-Amzn-SageMaker-Content-Type", value: Swift.String(contentType))
        }
        ...
        if let inputLocation = input.operationInput.inputLocation {
            input.builder.withHeader(name: "X-Amzn-SageMaker-InputLocation", value: Swift.String(inputLocation))
        }
        if let requestTTLSeconds = input.operationInput.requestTTLSeconds {
            input.builder.withHeader(name: "X-Amzn-SageMaker-RequestTTLSeconds", value: Swift.String(requestTTLSeconds))
        }
        return next.handle(context: context, input: input)
    }

    public typealias MInput = ClientRuntime.SerializeStepInput<InvokeEndpointAsyncInput>
    public typealias MOutput = ClientRuntime.OperationOutput<InvokeEndpointAsyncOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<InvokeEndpointAsyncOutputError>
}

public struct InvokeEndpointAsyncInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeEndpointAsyncInputQueryItemMiddleware"
...
public struct InvokeEndpointAsyncInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeEndpointAsyncInputURLHostMiddleware"
    ...
    public typealias MInput = InvokeEndpointAsyncInput
    public typealias MOutput = ClientRuntime.OperationOutput<InvokeEndpointAsyncOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<InvokeEndpointAsyncOutputError>
}

public struct InvokeEndpointAsyncInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeEndpointAsyncInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let endpointName = input.endpointName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("endpointName is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/endpoints/\(endpointName.urlPercentEncoding())/async-invocations"
...
extension InvokeEndpointAsyncOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvokeEndpointAsyncOutputResponse(inferenceId: \(Swift.String(describing: inferenceId)), outputLocation: \(Swift.String(describing: outputLocation)))"}
}
...
public struct InvokeEndpointInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeEndpointInputURLHostMiddleware"
    ...
    public typealias MInput = InvokeEndpointInput
    public typealias MOutput = ClientRuntime.OperationOutput<InvokeEndpointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<InvokeEndpointOutputError>
}

public struct InvokeEndpointInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeEndpointInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/endpoints/\(endpointName.urlPercentEncoding())/invocations"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ModelNotReadyException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModelNotReadyException(message: \(Swift.String(describing: message)))"}
}
