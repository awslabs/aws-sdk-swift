...
public protocol IotDataPlaneClientProtocol {
    ...
    func deleteThingShadow(input: DeleteThingShadowInput, completion: @escaping (SdkResult<DeleteThingShadowOutput, DeleteThingShadowOutputError>) -> Void)
    ...
    func getThingShadow(input: GetThingShadowInput, completion: @escaping (SdkResult<GetThingShadowOutput, GetThingShadowOutputError>) -> Void)
    /// <p>Lists the shadows for the specified thing.</p>
    func listNamedShadowsForThing(input: ListNamedShadowsForThingInput, completion: @escaping (SdkResult<ListNamedShadowsForThingOutput, ListNamedShadowsForThingOutputError>) -> Void)
    ...
    ///        AWS IoT Developer Guide.</p>
    func publish(input: PublishInput, completion: @escaping (SdkResult<PublishOutput, PublishOutputError>) -> Void)
    ...
    ///         AWS IoT Developer Guide.</p>
    func updateThingShadow(input: UpdateThingShadowInput, completion: @escaping (SdkResult<UpdateThingShadowOutput, UpdateThingShadowOutputError>) -> Void)
}
