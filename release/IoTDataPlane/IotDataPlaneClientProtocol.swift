...
public protocol IotDataPlaneClientProtocol {
    ...
    func deleteThingShadow(input: DeleteThingShadowInput, completion: @escaping (SdkResult<DeleteThingShadowOutputResponse, DeleteThingShadowOutputError>) -> Void)
    ...
    func getThingShadow(input: GetThingShadowInput, completion: @escaping (SdkResult<GetThingShadowOutputResponse, GetThingShadowOutputError>) -> Void)
    /// <p>Lists the shadows for the specified thing.</p>
    func listNamedShadowsForThing(input: ListNamedShadowsForThingInput, completion: @escaping (SdkResult<ListNamedShadowsForThingOutputResponse, ListNamedShadowsForThingOutputError>) -> Void)
    ...
    ///         AWS IoT Developer Guide.</p>
    func updateThingShadow(input: UpdateThingShadowInput, completion: @escaping (SdkResult<UpdateThingShadowOutputResponse, UpdateThingShadowOutputError>) -> Void)
}
