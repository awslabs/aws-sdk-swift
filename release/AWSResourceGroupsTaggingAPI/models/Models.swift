...
extension ResourceGroupsTaggingApiClientTypes {
    ...
    public struct ComplianceDetails: Swift.Equatable {
        ...
        var complianceStatus: Swift.Bool?
        /// These are keys defined in the effective policy that are on the resource with either incorrect case treatment or noncompliant values.
        var keysWithNoncompliantValues: [Swift.String]?
        /// These tag keys on the resource are noncompliant with the effective tag policy.
        var noncompliantKeys: [Swift.String]?
...
public struct DescribeReportCreationOutputResponse: Swift.Equatable {
    ...
    var s3Location: Swift.String?
    /// The date and time that the report was started.
    var startDate: Swift.String?
...
extension ResourceGroupsTaggingApiClientTypes {
    ...
    public struct FailureInfo: Swift.Equatable {
        ...
        var errorCode: ResourceGroupsTaggingApiClientTypes.ErrorCode?
...
public struct GetComplianceSummaryInput: Swift.Equatable {
    ...
    var groupBy: [ResourceGroupsTaggingApiClientTypes.GroupByAttribute]?
    ...
    var paginationToken: Swift.String?
    ...
    var regionFilters: [Swift.String]?
    ...
    var resourceTypeFilters: [Swift.String]?
    ...
    var tagKeyFilters: [Swift.String]?
    ...
    var targetIdFilters: [Swift.String]?
...
public struct GetComplianceSummaryOutputResponse: Swift.Equatable {
    ...
    var summaryList: [ResourceGroupsTaggingApiClientTypes.Summary]?
...
public struct GetResourcesInput: Swift.Equatable {
    ...
    var excludeCompliantResources: Swift.Bool?
    ...
    var includeComplianceDetails: Swift.Bool?
    /// Specifies a PaginationToken response value from a previous request to indicate that you want the next page of results. Leave this parameter empty in your initial request.
    var paginationToken: Swift.String?
    ...
    var resourceARNList: [Swift.String]?
    ...
    var resourceTypeFilters: [Swift.String]?
    /// Specifies the maximum number of results to be returned in each page. A query can return fewer than this maximum, even if there are more results still to return. You should always check the PaginationToken response value to see if there are more results. You can specify a minimum of 1 and a maximum value of 100.
    var resourcesPerPage: Swift.Int?
    ...
    var tagFilters: [ResourceGroupsTaggingApiClientTypes.TagFilter]?
...
public struct GetResourcesOutputResponse: Swift.Equatable {
    ...
    var resourceTagMappingList: [ResourceGroupsTaggingApiClientTypes.ResourceTagMapping]?
...
extension ResourceGroupsTaggingApiClientTypes {
    ...
    public struct ResourceTagMapping: Swift.Equatable {
        /// Information that shows whether a resource is compliant with the effective tag policy, including details on any noncompliant tag keys.
        var complianceDetails: ResourceGroupsTaggingApiClientTypes.ComplianceDetails?
        /// The ARN of the resource.
        var resourceARN: Swift.String?
        /// The tags that have been applied to one or more Amazon Web Services resources.
        var tags: [ResourceGroupsTaggingApiClientTypes.Tag]?
...
extension ResourceGroupsTaggingApiClientTypes {
    ...
    public struct Summary: Swift.Equatable {
        ...
        var lastUpdated: Swift.String?
        /// The count of noncompliant resources.
        var nonCompliantResources: Swift.Int
        ...
        var targetIdType: ResourceGroupsTaggingApiClientTypes.TargetIdType?
...
public struct TagResourcesOutputResponse: Swift.Equatable {
    ...
    var failedResourcesMap: [Swift.String:ResourceGroupsTaggingApiClientTypes.FailureInfo]?
