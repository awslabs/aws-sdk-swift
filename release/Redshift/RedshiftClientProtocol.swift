...
public protocol RedshiftClientProtocol {
    ...
    ///         </p>
    func acceptReservedNodeExchange(input: AcceptReservedNodeExchangeInput, completion: @escaping (SdkResult<AcceptReservedNodeExchangeOutput, AcceptReservedNodeExchangeOutputError>) -> Void)
    ...
    func addPartner(input: AddPartnerInput, completion: @escaping (SdkResult<AddPartnerOutput, AddPartnerOutputError>) -> Void)
    ...
    func authorizeClusterSecurityGroupIngress(input: AuthorizeClusterSecurityGroupIngressInput, completion: @escaping (SdkResult<AuthorizeClusterSecurityGroupIngressOutput, AuthorizeClusterSecurityGroupIngressOutputError>) -> Void)
    /// <p>Grants access to a cluster.</p>
    func authorizeEndpointAccess(input: AuthorizeEndpointAccessInput, completion: @escaping (SdkResult<AuthorizeEndpointAccessOutput, AuthorizeEndpointAccessOutputError>) -> Void)
    ...
    func authorizeSnapshotAccess(input: AuthorizeSnapshotAccessInput, completion: @escaping (SdkResult<AuthorizeSnapshotAccessOutput, AuthorizeSnapshotAccessOutputError>) -> Void)
    /// <p>Deletes a set of cluster snapshots.</p>
    func batchDeleteClusterSnapshots(input: BatchDeleteClusterSnapshotsInput, completion: @escaping (SdkResult<BatchDeleteClusterSnapshotsOutput, BatchDeleteClusterSnapshotsOutputError>) -> Void)
    /// <p>Modifies the settings for a set of cluster snapshots.</p>
    func batchModifyClusterSnapshots(input: BatchModifyClusterSnapshotsInput, completion: @escaping (SdkResult<BatchModifyClusterSnapshotsOutput, BatchModifyClusterSnapshotsOutputError>) -> Void)
    /// <p>Cancels a resize operation for a cluster.</p>
    func cancelResize(input: CancelResizeInput, completion: @escaping (SdkResult<CancelResizeOutput, CancelResizeOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-snapshots.html">Amazon Redshift Snapshots</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func copyClusterSnapshot(input: CopyClusterSnapshotInput, completion: @escaping (SdkResult<CopyClusterSnapshotOutput, CopyClusterSnapshotOutputError>) -> Void)
    ...
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func createClusterParameterGroup(input: CreateClusterParameterGroupInput, completion: @escaping (SdkResult<CreateClusterParameterGroupOutput, CreateClusterParameterGroupOutputError>) -> Void)
    ...
    func createClusterSecurityGroup(input: CreateClusterSecurityGroupInput, completion: @escaping (SdkResult<CreateClusterSecurityGroupOutput, CreateClusterSecurityGroupOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-snapshots.html">Amazon Redshift Snapshots</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func createClusterSnapshot(input: CreateClusterSnapshotInput, completion: @escaping (SdkResult<CreateClusterSnapshotOutput, CreateClusterSnapshotOutputError>) -> Void)
    ...
    /// <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func createClusterSubnetGroup(input: CreateClusterSubnetGroupInput, completion: @escaping (SdkResult<CreateClusterSubnetGroupOutput, CreateClusterSubnetGroupOutputError>) -> Void)
    /// <p>Creates a Redshift-managed VPC endpoint.</p>
    func createEndpointAccess(input: CreateEndpointAccessInput, completion: @escaping (SdkResult<CreateEndpointAccessOutput, CreateEndpointAccessOutputError>) -> Void)
    ...
    ///             in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func createHsmClientCertificate(input: CreateHsmClientCertificateInput, completion: @escaping (SdkResult<CreateHsmClientCertificateOutput, CreateHsmClientCertificateOutputError>) -> Void)
    ...
    func createHsmConfiguration(input: CreateHsmConfigurationInput, completion: @escaping (SdkResult<CreateHsmConfigurationOutput, CreateHsmConfigurationOutputError>) -> Void)
    ...
    ///         </p>
    func createScheduledAction(input: CreateScheduledActionInput, completion: @escaping (SdkResult<CreateScheduledActionOutput, CreateScheduledActionOutputError>) -> Void)
    ...
    /// </p>
    func createSnapshotCopyGrant(input: CreateSnapshotCopyGrantInput, completion: @escaping (SdkResult<CreateSnapshotCopyGrantOutput, CreateSnapshotCopyGrantOutputError>) -> Void)
    ...
    func createSnapshotSchedule(input: CreateSnapshotScheduleInput, completion: @escaping (SdkResult<CreateSnapshotScheduleOutput, CreateSnapshotScheduleOutputError>) -> Void)
    ...
    func createUsageLimit(input: CreateUsageLimitInput, completion: @escaping (SdkResult<CreateUsageLimitOutput, CreateUsageLimitOutputError>) -> Void)
    ...
    ///                 cluster.</p>
    ///         </note>
    func deleteClusterParameterGroup(input: DeleteClusterParameterGroupInput, completion: @escaping (SdkResult<DeleteClusterParameterGroupOutput, DeleteClusterParameterGroupOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-security-groups.html">Amazon Redshift Cluster Security Groups</a> in the
    /// <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func deleteClusterSecurityGroup(input: DeleteClusterSecurityGroupInput, completion: @escaping (SdkResult<DeleteClusterSecurityGroupOutput, DeleteClusterSecurityGroupOutputError>) -> Void)
    ...
    ///             snapshot.</p>
    func deleteClusterSnapshot(input: DeleteClusterSnapshotInput, completion: @escaping (SdkResult<DeleteClusterSnapshotOutput, DeleteClusterSnapshotOutputError>) -> Void)
    /// <p>Deletes the specified cluster subnet group.</p>
    func deleteClusterSubnetGroup(input: DeleteClusterSubnetGroupInput, completion: @escaping (SdkResult<DeleteClusterSubnetGroupOutput, DeleteClusterSubnetGroupOutputError>) -> Void)
    /// <p>Deletes a Redshift-managed VPC endpoint.</p>
    func deleteEndpointAccess(input: DeleteEndpointAccessInput, completion: @escaping (SdkResult<DeleteEndpointAccessOutput, DeleteEndpointAccessOutputError>) -> Void)
    ...
    func deleteHsmClientCertificate(input: DeleteHsmClientCertificateInput, completion: @escaping (SdkResult<DeleteHsmClientCertificateOutput, DeleteHsmClientCertificateOutputError>) -> Void)
    /// <p>Deletes the specified Amazon Redshift HSM configuration.</p>
    func deleteHsmConfiguration(input: DeleteHsmConfigurationInput, completion: @escaping (SdkResult<DeleteHsmConfigurationOutput, DeleteHsmConfigurationOutputError>) -> Void)
    ...
    func deletePartner(input: DeletePartnerInput, completion: @escaping (SdkResult<DeletePartnerOutput, DeletePartnerOutputError>) -> Void)
    ...
    func deleteSnapshotCopyGrant(input: DeleteSnapshotCopyGrantInput, completion: @escaping (SdkResult<DeleteSnapshotCopyGrantOutput, DeleteSnapshotCopyGrantOutputError>) -> Void)
    /// <p>Deletes a snapshot schedule.</p>
    func deleteSnapshotSchedule(input: DeleteSnapshotScheduleInput, completion: @escaping (SdkResult<DeleteSnapshotScheduleOutput, DeleteSnapshotScheduleOutputError>) -> Void)
    ...
    func deleteUsageLimit(input: DeleteUsageLimitInput, completion: @escaping (SdkResult<DeleteUsageLimitOutput, DeleteUsageLimitOutputError>) -> Void)
    ...
    func describeClusterDbRevisions(input: DescribeClusterDbRevisionsInput, completion: @escaping (SdkResult<DescribeClusterDbRevisionsOutput, DescribeClusterDbRevisionsOutputError>) -> Void)
    ...
    ///             them.</p>
    func describeClusterParameterGroups(input: DescribeClusterParameterGroupsInput, completion: @escaping (SdkResult<DescribeClusterParameterGroupsOutput, DescribeClusterParameterGroupsOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-parameter-groups.html">Amazon Redshift Parameter Groups</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func describeClusterParameters(input: DescribeClusterParametersInput, completion: @escaping (SdkResult<DescribeClusterParametersOutput, DescribeClusterParametersOutputError>) -> Void)
    ...
    ///             returned regardless of whether they have tag keys or values associated with
    ///             them.</p>
    func describeClusterSecurityGroups(input: DescribeClusterSecurityGroupsInput, completion: @escaping (SdkResult<DescribeClusterSecurityGroupsOutput, DescribeClusterSecurityGroupsOutputError>) -> Void)
    ...
    ///             regardless of whether they have tag keys or values associated with them.</p>
    func describeClusterSnapshots(input: DescribeClusterSnapshotsInput, completion: @escaping (SdkResult<DescribeClusterSnapshotsOutput, DescribeClusterSnapshotsOutputError>) -> Void)
    ...
    ///             returned regardless of whether they have tag keys or values associated with
    ///             them.</p>
    func describeClusterSubnetGroups(input: DescribeClusterSubnetGroupsInput, completion: @escaping (SdkResult<DescribeClusterSubnetGroupsOutput, DescribeClusterSubnetGroupsOutputError>) -> Void)
    /// <p>Returns a list of all the available maintenance tracks.</p>
    func describeClusterTracks(input: DescribeClusterTracksInput, completion: @escaping (SdkResult<DescribeClusterTracksOutput, DescribeClusterTracksOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-clusters.html">Amazon Redshift Clusters</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func describeClusterVersions(input: DescribeClusterVersionsInput, completion: @escaping (SdkResult<DescribeClusterVersionsOutput, DescribeClusterVersionsOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-parameter-groups.html">Amazon Redshift Parameter Groups</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func describeDefaultClusterParameters(input: DescribeDefaultClusterParametersInput, completion: @escaping (SdkResult<DescribeDefaultClusterParametersOutput, DescribeDefaultClusterParametersOutputError>) -> Void)
    /// <p>Describes a Redshift-managed VPC endpoint.</p>
    func describeEndpointAccess(input: DescribeEndpointAccessInput, completion: @escaping (SdkResult<DescribeEndpointAccessOutput, DescribeEndpointAccessOutputError>) -> Void)
    /// <p>Describes an endpoint authorization.</p>
    func describeEndpointAuthorization(input: DescribeEndpointAuthorizationInput, completion: @escaping (SdkResult<DescribeEndpointAuthorizationOutput, DescribeEndpointAuthorizationOutputError>) -> Void)
    ...
    ///             them.</p>
    func describeHsmClientCertificates(input: DescribeHsmClientCertificatesInput, completion: @escaping (SdkResult<DescribeHsmClientCertificatesOutput, DescribeHsmClientCertificatesOutputError>) -> Void)
    ...
    ///             returned regardless of whether they have tag keys or values associated with
    ///             them.</p>
    func describeHsmConfigurations(input: DescribeHsmConfigurationsInput, completion: @escaping (SdkResult<DescribeHsmConfigurationsOutput, DescribeHsmConfigurationsOutputError>) -> Void)
    ...
    func describeLoggingStatus(input: DescribeLoggingStatusInput, completion: @escaping (SdkResult<DescribeLoggingStatusOutput, DescribeLoggingStatusOutputError>) -> Void)
    ...
    func describeNodeConfigurationOptions(input: DescribeNodeConfigurationOptionsInput, completion: @escaping (SdkResult<DescribeNodeConfigurationOptionsOutput, DescribeNodeConfigurationOptionsOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-clusters.html">Amazon Redshift Clusters</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func describeOrderableClusterOptions(input: DescribeOrderableClusterOptionsInput, completion: @escaping (SdkResult<DescribeOrderableClusterOptionsOutput, DescribeOrderableClusterOptionsOutputError>) -> Void)
    /// <p>Returns information about the partner integrations defined for a cluster.</p>
    func describePartners(input: DescribePartnersInput, completion: @escaping (SdkResult<DescribePartnersOutput, DescribePartnersOutputError>) -> Void)
    ...
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func describeReservedNodeOfferings(input: DescribeReservedNodeOfferingsInput, completion: @escaping (SdkResult<DescribeReservedNodeOfferingsOutput, DescribeReservedNodeOfferingsOutputError>) -> Void)
    /// <p>Returns the descriptions of the reserved nodes.</p>
    func describeReservedNodes(input: DescribeReservedNodesInput, completion: @escaping (SdkResult<DescribeReservedNodesOutput, DescribeReservedNodesOutputError>) -> Void)
    ...
    func describeResize(input: DescribeResizeInput, completion: @escaping (SdkResult<DescribeResizeOutput, DescribeResizeOutputError>) -> Void)
    ...
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.
    /// </p>
    func describeSnapshotCopyGrants(input: DescribeSnapshotCopyGrantsInput, completion: @escaping (SdkResult<DescribeSnapshotCopyGrantsOutput, DescribeSnapshotCopyGrantsOutputError>) -> Void)
    /// <p>Returns a list of snapshot schedules. </p>
    func describeSnapshotSchedules(input: DescribeSnapshotSchedulesInput, completion: @escaping (SdkResult<DescribeSnapshotSchedulesOutput, DescribeSnapshotSchedulesOutputError>) -> Void)
    /// <p>Returns account level backups storage size and provisional storage.</p>
    func describeStorage(input: DescribeStorageInput, completion: @escaping (SdkResult<DescribeStorageOutput, DescribeStorageOutputError>) -> Void)
    ...
    func describeTableRestoreStatus(input: DescribeTableRestoreStatusInput, completion: @escaping (SdkResult<DescribeTableRestoreStatusOutput, DescribeTableRestoreStatusOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeUsageLimits(input: DescribeUsageLimitsInput, completion: @escaping (SdkResult<DescribeUsageLimitsOutput, DescribeUsageLimitsOutputError>) -> Void)
    /// <p>Stops logging information, such as queries and connection attempts, for the
    ///             specified Amazon Redshift cluster.</p>
    func disableLogging(input: DisableLoggingInput, completion: @escaping (SdkResult<DisableLoggingOutput, DisableLoggingOutputError>) -> Void)
    ...
    func disableSnapshotCopy(input: DisableSnapshotCopyInput, completion: @escaping (SdkResult<DisableSnapshotCopyOutput, DisableSnapshotCopyOutputError>) -> Void)
    /// <p>Starts logging information, such as queries and connection attempts, for the
    ///             specified Amazon Redshift cluster.</p>
    func enableLogging(input: EnableLoggingInput, completion: @escaping (SdkResult<EnableLoggingOutput, EnableLoggingOutputError>) -> Void)
    /// <p>Enables the automatic copy of snapshots from one region to another region for a
    ///             specified cluster.</p>
    func enableSnapshotCopy(input: EnableSnapshotCopyInput, completion: @escaping (SdkResult<EnableSnapshotCopyOutput, EnableSnapshotCopyOutputError>) -> Void)
    ...
    func getClusterCredentials(input: GetClusterCredentialsInput, completion: @escaping (SdkResult<GetClusterCredentialsOutput, GetClusterCredentialsOutputError>) -> Void)
    ...
    func getReservedNodeExchangeOfferings(input: GetReservedNodeExchangeOfferingsInput, completion: @escaping (SdkResult<GetReservedNodeExchangeOfferingsOutput, GetReservedNodeExchangeOfferingsOutputError>) -> Void)
    /// <p>Modifies whether a cluster can use AQUA (Advanced Query Accelerator). </p>
    func modifyAquaConfiguration(input: ModifyAquaConfigurationInput, completion: @escaping (SdkResult<ModifyAquaConfigurationOutput, ModifyAquaConfigurationOutputError>) -> Void)
    ...
    func modifyClusterDbRevision(input: ModifyClusterDbRevisionInput, completion: @escaping (SdkResult<ModifyClusterDbRevisionOutput, ModifyClusterDbRevisionOutputError>) -> Void)
    ...
    func modifyClusterIamRoles(input: ModifyClusterIamRolesInput, completion: @escaping (SdkResult<ModifyClusterIamRolesOutput, ModifyClusterIamRolesOutputError>) -> Void)
    /// <p>Modifies the maintenance settings of a cluster.</p>
    func modifyClusterMaintenance(input: ModifyClusterMaintenanceInput, completion: @escaping (SdkResult<ModifyClusterMaintenanceOutput, ModifyClusterMaintenanceOutputError>) -> Void)
    /// <p>Modifies the parameters of a parameter group.</p>
    ///         <p>
    /// For more information about parameters and parameter groups, go to
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-parameter-groups.html">Amazon Redshift Parameter Groups</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func modifyClusterParameterGroup(input: ModifyClusterParameterGroupInput, completion: @escaping (SdkResult<ModifyClusterParameterGroupOutput, ModifyClusterParameterGroupOutputError>) -> Void)
    ...
    func modifyClusterSnapshot(input: ModifyClusterSnapshotInput, completion: @escaping (SdkResult<ModifyClusterSnapshotOutput, ModifyClusterSnapshotOutputError>) -> Void)
    /// <p>Modifies a snapshot schedule for a cluster.</p>
    func modifyClusterSnapshotSchedule(input: ModifyClusterSnapshotScheduleInput, completion: @escaping (SdkResult<ModifyClusterSnapshotScheduleOutput, ModifyClusterSnapshotScheduleOutputError>) -> Void)
    ...
    func modifyClusterSubnetGroup(input: ModifyClusterSubnetGroupInput, completion: @escaping (SdkResult<ModifyClusterSubnetGroupOutput, ModifyClusterSubnetGroupOutputError>) -> Void)
    /// <p>Modifies a Redshift-managed VPC endpoint.</p>
    func modifyEndpointAccess(input: ModifyEndpointAccessInput, completion: @escaping (SdkResult<ModifyEndpointAccessOutput, ModifyEndpointAccessOutputError>) -> Void)
    ...
    ///             </p>
    func modifyScheduledAction(input: ModifyScheduledActionInput, completion: @escaping (SdkResult<ModifyScheduledActionOutput, ModifyScheduledActionOutputError>) -> Void)
    ...
    ///             period. </p>
    func modifySnapshotCopyRetentionPeriod(input: ModifySnapshotCopyRetentionPeriodInput, completion: @escaping (SdkResult<ModifySnapshotCopyRetentionPeriodOutput, ModifySnapshotCopyRetentionPeriodOutputError>) -> Void)
    /// <p>Modifies a snapshot schedule. Any schedule associated with a cluster is modified
    ///             asynchronously.</p>
    func modifySnapshotSchedule(input: ModifySnapshotScheduleInput, completion: @escaping (SdkResult<ModifySnapshotScheduleOutput, ModifySnapshotScheduleOutputError>) -> Void)
    /// <p>Modifies a usage limit in a cluster.
    ///             You can't modify the feature type or period of a usage limit.</p>
    func modifyUsageLimit(input: ModifyUsageLimitInput, completion: @escaping (SdkResult<ModifyUsageLimitOutput, ModifyUsageLimitOutputError>) -> Void)
    /// <p>Pauses a cluster.</p>
    func pauseCluster(input: PauseClusterInput, completion: @escaping (SdkResult<PauseClusterOutput, PauseClusterOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/purchase-reserved-node-instance.html">Purchasing Reserved Nodes</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func purchaseReservedNodeOffering(input: PurchaseReservedNodeOfferingInput, completion: @escaping (SdkResult<PurchaseReservedNodeOfferingOutput, PurchaseReservedNodeOfferingOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-clusters.html">Amazon Redshift Clusters</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>. </p>
    func rebootCluster(input: RebootClusterInput, completion: @escaping (SdkResult<RebootClusterOutput, RebootClusterOutputError>) -> Void)
    ...
    func resetClusterParameterGroup(input: ResetClusterParameterGroupInput, completion: @escaping (SdkResult<ResetClusterParameterGroupOutput, ResetClusterParameterGroupOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func resizeCluster(input: ResizeClusterInput, completion: @escaping (SdkResult<ResizeClusterOutput, ResizeClusterOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-snapshots.html">Amazon Redshift Snapshots</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func restoreFromClusterSnapshot(input: RestoreFromClusterSnapshotInput, completion: @escaping (SdkResult<RestoreFromClusterSnapshotOutput, RestoreFromClusterSnapshotOutputError>) -> Void)
    ...
    func restoreTableFromClusterSnapshot(input: RestoreTableFromClusterSnapshotInput, completion: @escaping (SdkResult<RestoreTableFromClusterSnapshotOutput, RestoreTableFromClusterSnapshotOutputError>) -> Void)
    /// <p>Resumes a paused cluster.</p>
    func resumeCluster(input: ResumeClusterInput, completion: @escaping (SdkResult<ResumeClusterOutput, ResumeClusterOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-security-groups.html">Amazon Redshift Cluster Security Groups</a> in the
    /// <i>Amazon Redshift Cluster Management Guide</i>. </p>
    func revokeClusterSecurityGroupIngress(input: RevokeClusterSecurityGroupIngressInput, completion: @escaping (SdkResult<RevokeClusterSecurityGroupIngressOutput, RevokeClusterSecurityGroupIngressOutputError>) -> Void)
    /// <p>Revokes access to a cluster.</p>
    func revokeEndpointAccess(input: RevokeEndpointAccessInput, completion: @escaping (SdkResult<RevokeEndpointAccessOutput, RevokeEndpointAccessOutputError>) -> Void)
    ...
    /// <a href="https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-snapshots.html">Amazon Redshift Snapshots</a>
    /// in the <i>Amazon Redshift Cluster Management Guide</i>.</p>
    func revokeSnapshotAccess(input: RevokeSnapshotAccessInput, completion: @escaping (SdkResult<RevokeSnapshotAccessOutput, RevokeSnapshotAccessOutputError>) -> Void)
    /// <p>Rotates the encryption keys for a cluster.</p>
    func rotateEncryptionKey(input: RotateEncryptionKeyInput, completion: @escaping (SdkResult<RotateEncryptionKeyOutput, RotateEncryptionKeyOutputError>) -> Void)
    /// <p>Updates the status of a partner integration.</p>
    func updatePartnerStatus(input: UpdatePartnerStatusInput, completion: @escaping (SdkResult<UpdatePartnerStatusOutput, UpdatePartnerStatusOutputError>) -> Void)
}
