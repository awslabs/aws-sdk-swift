...
extension ManagedBlockchainClientTypes {
    ...
    public struct ApprovalThresholdPolicy: Swift.Equatable {
        ...
        var proposalDurationInHours: Swift.Int?
        /// Determines whether the vote percentage must be greater than the ThresholdPercentage or must be greater than or equal to the ThreholdPercentage to be approved.
        var thresholdComparator: ManagedBlockchainClientTypes.ThresholdComparator?
        /// The percentage of votes among all members that must be YES for a proposal to be approved. For example, a ThresholdPercentage value of 50 indicates 50%. The ThresholdComparator determines the precise comparison. If a ThresholdPercentage value of 50 is specified on a network with 10 members, along with a ThresholdComparator value of GREATER_THAN, this indicates that 6 YES votes are required for the proposal to be approved.
        var thresholdPercentage: Swift.Int?
...
public struct CreateMemberInput: Swift.Equatable {
    ...
    /// This member is required.
    var memberConfiguration: ManagedBlockchainClientTypes.MemberConfiguration?
    /// The unique identifier of the network in which the member is created.
    /// This member is required.
    var networkId: Swift.String?
...
public struct CreateNetworkInput: Swift.Equatable {
    ...
    /// This member is required.
    var framework: ManagedBlockchainClientTypes.Framework?
    /// Configuration properties of the blockchain framework relevant to the network configuration.
    var frameworkConfiguration: ManagedBlockchainClientTypes.NetworkFrameworkConfiguration?
    /// The version of the blockchain framework that the network uses.
    /// This member is required.
    var frameworkVersion: Swift.String?
    ...
    /// This member is required.
    var votingPolicy: ManagedBlockchainClientTypes.VotingPolicy?
...
public struct CreateNodeInput: Swift.Equatable {
    ...
    /// This member is required.
    var nodeConfiguration: ManagedBlockchainClientTypes.NodeConfiguration?
...
public struct CreateProposalInput: Swift.Equatable {
    ...
    /// This member is required.
    var actions: ManagedBlockchainClientTypes.ProposalActions?
    /// A unique, case-sensitive identifier that you provide to ensure the idempotency of the operation. An idempotent operation completes no more than one time. This identifier is required only if you make a service request directly using an HTTP client. It is generated automatically if you use an AWS SDK or the AWS CLI.
    /// This member is required.
    var clientRequestToken: Swift.String?
...
public struct GetMemberOutputResponse: Swift.Equatable {
    ...
    var member: ManagedBlockchainClientTypes.Member?
...
public struct GetNetworkOutputResponse: Swift.Equatable {
    ...
    var network: ManagedBlockchainClientTypes.Network?
...
public struct GetNodeOutputResponse: Swift.Equatable {
    ...
    var node: ManagedBlockchainClientTypes.Node?
...
public struct GetProposalOutputResponse: Swift.Equatable {
    ...
    var proposal: ManagedBlockchainClientTypes.Proposal?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct Invitation: Swift.Equatable {
        ...
        var networkSummary: ManagedBlockchainClientTypes.NetworkSummary?
        ...
        var status: ManagedBlockchainClientTypes.InvitationStatus?
...
public struct ListInvitationsOutputResponse: Swift.Equatable {
    ...
    var invitations: [ManagedBlockchainClientTypes.Invitation]?
    /// The pagination token that indicates the next set of results to retrieve.
    var nextToken: Swift.String?
...
public struct ListMembersInput: Swift.Equatable {
    ...
    var status: ManagedBlockchainClientTypes.MemberStatus?
...
public struct ListMembersOutputResponse: Swift.Equatable {
    ...
    var members: [ManagedBlockchainClientTypes.MemberSummary]?
    /// The pagination token that indicates the next set of results to retrieve.
    var nextToken: Swift.String?
...
public struct ListNetworksInput: Swift.Equatable {
    ...
    var status: ManagedBlockchainClientTypes.NetworkStatus?
...
public struct ListNetworksOutputResponse: Swift.Equatable {
    ...
    var networks: [ManagedBlockchainClientTypes.NetworkSummary]?
    /// The pagination token that indicates the next set of results to retrieve.
    var nextToken: Swift.String?
...
public struct ListNodesInput: Swift.Equatable {
    ...
    var status: ManagedBlockchainClientTypes.NodeStatus?
...
public struct ListNodesOutputResponse: Swift.Equatable {
    ...
    var nodes: [ManagedBlockchainClientTypes.NodeSummary]?
...
public struct ListProposalVotesOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// The list of votes.
    var proposalVotes: [ManagedBlockchainClientTypes.VoteSummary]?
...
public struct ListProposalsOutputResponse: Swift.Equatable {
    ...
    var proposals: [ManagedBlockchainClientTypes.ProposalSummary]?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct LogConfigurations: Swift.Equatable {
        ...
        var cloudwatch: ManagedBlockchainClientTypes.LogConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct Member: Swift.Equatable {
        ...
        var frameworkAttributes: ManagedBlockchainClientTypes.MemberFrameworkAttributes?
        /// The unique identifier of the member.
        var id: Swift.String?
        ...
        var logPublishingConfiguration: ManagedBlockchainClientTypes.MemberLogPublishingConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var frameworkConfiguration: ManagedBlockchainClientTypes.MemberFrameworkConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberFabricAttributes: Swift.Equatable {
        ...
        var adminUsername: Swift.String?
        /// The endpoint used to access the member's certificate authority.
        var caEndpoint: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberFabricConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var adminPassword: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberFabricLogPublishingConfiguration: Swift.Equatable {
        ...
        var caLogs: ManagedBlockchainClientTypes.LogConfigurations?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberFrameworkAttributes: Swift.Equatable {
        ...
        var fabric: ManagedBlockchainClientTypes.MemberFabricAttributes?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberFrameworkConfiguration: Swift.Equatable {
        ...
        var fabric: ManagedBlockchainClientTypes.MemberFabricConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberLogPublishingConfiguration: Swift.Equatable {
        /// Configuration properties for logging events associated with a member of a Managed Blockchain network using the Hyperledger Fabric framework.
        var fabric: ManagedBlockchainClientTypes.MemberFabricLogPublishingConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct Network: Swift.Equatable {
        ...
        var frameworkAttributes: ManagedBlockchainClientTypes.NetworkFrameworkAttributes?
        /// The version of the blockchain framework that the network uses.
        var frameworkVersion: Swift.String?
        /// The unique identifier of the network.
        var id: Swift.String?
        ...
        var vpcEndpointServiceName: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NetworkFabricAttributes: Swift.Equatable {
        ...
        var edition: ManagedBlockchainClientTypes.Edition?
        /// The endpoint of the ordering service for the network.
        var orderingServiceEndpoint: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NetworkFrameworkAttributes: Swift.Equatable {
        ...
        var ethereum: ManagedBlockchainClientTypes.NetworkEthereumAttributes?
        /// Attributes of Hyperledger Fabric for a Managed Blockchain network that uses Hyperledger Fabric.
        var fabric: ManagedBlockchainClientTypes.NetworkFabricAttributes?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NetworkFrameworkConfiguration: Swift.Equatable {
        ...
        var fabric: ManagedBlockchainClientTypes.NetworkFabricConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct Node: Swift.Equatable {
        ...
        var frameworkAttributes: ManagedBlockchainClientTypes.NodeFrameworkAttributes?
        /// The unique identifier of the node.
        var id: Swift.String?
        ...
        var logPublishingConfiguration: ManagedBlockchainClientTypes.NodeLogPublishingConfiguration?
        ...
        var stateDB: ManagedBlockchainClientTypes.StateDBType?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NodeEthereumAttributes: Swift.Equatable {
        ...
        var webSocketEndpoint: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NodeFabricAttributes: Swift.Equatable {
        ...
        var peerEndpoint: Swift.String?
        /// The endpoint that identifies the peer node for peer channel-based event services.
        var peerEventEndpoint: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NodeFabricLogPublishingConfiguration: Swift.Equatable {
        ...
        var chaincodeLogs: ManagedBlockchainClientTypes.LogConfigurations?
        /// Configuration properties for a peer node log. Peer node logs contain messages generated when your client submits transaction proposals to peer nodes, requests to join channels, enrolls an admin peer, and lists the chaincode instances on a peer node.
        var peerLogs: ManagedBlockchainClientTypes.LogConfigurations?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NodeFrameworkAttributes: Swift.Equatable {
        ...
        var ethereum: ManagedBlockchainClientTypes.NodeEthereumAttributes?
        /// Attributes of Hyperledger Fabric for a peer node on a Managed Blockchain network that uses Hyperledger Fabric.
        var fabric: ManagedBlockchainClientTypes.NodeFabricAttributes?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NodeLogPublishingConfiguration: Swift.Equatable {
        ...
        var fabric: ManagedBlockchainClientTypes.NodeFabricLogPublishingConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct Proposal: Swift.Equatable {
        ...
        var noVoteCount: Swift.Int?
        /// The number of votes remaining to be cast on the proposal by members. In other words, the number of members minus the sum of YES votes and NO votes.
        var outstandingVoteCount: Swift.Int?
        /// The unique identifier of the proposal.
        var proposalId: Swift.String?
        /// The unique identifier of the member that created the proposal.
        var proposedByMemberId: Swift.String?
        /// The name of the member that created the proposal.
        var proposedByMemberName: Swift.String?
        ...
        var status: ManagedBlockchainClientTypes.ProposalStatus?
        /// Tags assigned to the proposal. Each tag consists of a key and optional value. For more information about tags, see [Tagging Resources](https://docs.aws.amazon.com/managed-blockchain/latest/ethereum-dev/tagging-resources.html) in the Amazon Managed Blockchain Ethereum Developer Guide, or [Tagging Resources](https://docs.aws.amazon.com/managed-blockchain/latest/hyperledger-fabric-dev/tagging-resources.html) in the Amazon Managed Blockchain Hyperledger Fabric Developer Guide.
        var tags: [Swift.String:Swift.String]?
        /// The current total of YES votes cast on the proposal by members.
        var yesVoteCount: Swift.Int?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct ProposalActions: Swift.Equatable {
        ...
        var invitations: [ManagedBlockchainClientTypes.InviteAction]?
        ...
        var removals: [ManagedBlockchainClientTypes.RemoveAction]?
...
public struct VoteOnProposalInput: Swift.Equatable {
    ...
    /// This member is required.
    var vote: ManagedBlockchainClientTypes.VoteValue?
    /// The unique identifier of the member casting the vote.
    /// This member is required.
    var voterMemberId: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct VotingPolicy: Swift.Equatable {
        ...
        var approvalThresholdPolicy: ManagedBlockchainClientTypes.ApprovalThresholdPolicy?
