...
public protocol IvsClientProtocol {
    ...
    func getStreamSession(input: GetStreamSessionInput, completion: @escaping (ClientRuntime.SdkResult<GetStreamSessionOutputResponse, GetStreamSessionOutputError>) -> Void)
    ...
    func listStreamSessions(input: ListStreamSessionsInput, completion: @escaping (ClientRuntime.SdkResult<ListStreamSessionsOutputResponse, ListStreamSessionsOutputError>) -> Void)
