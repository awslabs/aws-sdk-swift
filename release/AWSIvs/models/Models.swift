...
public struct BatchGetChannelOutputResponse: Swift.Equatable {
    ///
    var channels: [IvsClientTypes.Channel]?
    /// Each error object is related to a specific ARN in the request.
    var errors: [IvsClientTypes.BatchError]?
...
public struct BatchGetStreamKeyOutputResponse: Swift.Equatable {
    ...
    var errors: [IvsClientTypes.BatchError]?
    ///
    var streamKeys: [IvsClientTypes.StreamKey]?
...
extension IvsClientTypes {
    ...
    public struct Channel: Swift.Equatable {
        ...
        var authorized: Swift.Bool
        /// Channel ingest endpoint, part of the definition of an ingest server, used when you set up streaming software.
        var ingestEndpoint: Swift.String?
        /// Channel latency mode. Use NORMAL to broadcast and deliver live video up to Full HD. Use LOW for near-real-time interaction with viewers. Default: LOW. (Note: In the Amazon IVS console, LOW and NORMAL correspond to Ultra-low and Standard, respectively.)
        var latencyMode: IvsClientTypes.ChannelLatencyMode?
        /// Channel name.
        var name: Swift.String?
        /// Channel playback URL.
        var playbackUrl: Swift.String?
        /// Recording-configuration ARN. A value other than an empty string indicates that recording is enabled. Default: "" (empty string, recording is disabled).
        var recordingConfigurationArn: Swift.String?
        ...
        var type: IvsClientTypes.ChannelType?
...
public struct CreateChannelOutputResponse: Swift.Equatable {
    ///
    var channel: IvsClientTypes.Channel?
    ///
    var streamKey: IvsClientTypes.StreamKey?
...
public struct CreateRecordingConfigurationInput: Swift.Equatable {
    ...
    /// This member is required.
    var destinationConfiguration: IvsClientTypes.DestinationConfiguration?
...
public struct CreateRecordingConfigurationOutputResponse: Swift.Equatable {
    ///
    var recordingConfiguration: IvsClientTypes.RecordingConfiguration?
...
extension IvsClientTypes {
    ...
    public struct DestinationConfiguration: Swift.Equatable {
        ...
        var s3: IvsClientTypes.S3DestinationConfiguration?
...
public struct GetPlaybackKeyPairOutputResponse: Swift.Equatable {
    ///
    var keyPair: IvsClientTypes.PlaybackKeyPair?
...
public struct GetStreamOutputResponse: Swift.Equatable {
    ///
    var stream: IvsClientTypes.Stream?
...
public struct GetStreamSessionOutputResponse: Swift.Equatable {
    ...
    var streamSession: IvsClientTypes.StreamSession?
...
public struct ImportPlaybackKeyPairInput: Swift.Equatable {
    ...
    /// This member is required.
    var publicKeyMaterial: Swift.String?
...
extension IvsClientTypes {
    ...
    public struct IngestConfiguration: Swift.Equatable {
        ...
        var audio: IvsClientTypes.AudioConfiguration?
        /// Encoder settings for video.
        var video: IvsClientTypes.VideoConfiguration?
...
public struct ListChannelsInput: Swift.Equatable {
    ...
    var filterByName: Swift.String?
    /// Filters the channel list to match the specified recording-configuration ARN.
    var filterByRecordingConfigurationArn: Swift.String?
...
public struct ListChannelsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var channels: [IvsClientTypes.ChannelSummary]?
...
public struct ListPlaybackKeyPairsOutputResponse: Swift.Equatable {
    /// List of key pairs.
    /// This member is required.
    var keyPairs: [IvsClientTypes.PlaybackKeyPairSummary]?
...
public struct ListRecordingConfigurationsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var recordingConfigurations: [IvsClientTypes.RecordingConfigurationSummary]?
...
public struct ListStreamKeysOutputResponse: Swift.Equatable {
    ...
    /// List of stream keys.
    /// This member is required.
    var streamKeys: [IvsClientTypes.StreamKeySummary]?
...
public struct ListStreamSessionsOutputResponse: Swift.Equatable {
    ...
    ///
    /// This member is required.
    var streamSessions: [IvsClientTypes.StreamSessionSummary]?
...
public struct ListStreamsInput: Swift.Equatable {
    ...
    var filterBy: IvsClientTypes.StreamFilters?
    /// Maximum number of streams to return. Default: 50.
    var maxResults: Swift.Int
    /// The first stream to retrieve. This is used for pagination; see the nextToken response field.
    var nextToken: Swift.String?
...
public struct ListStreamsOutputResponse: Swift.Equatable {
    ...
    /// List of streams.
    /// This member is required.
    var streams: [IvsClientTypes.StreamSummary]?
...
extension IvsClientTypes {
    ...
    public struct RecordingConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var state: IvsClientTypes.RecordingConfigurationState?
        /// Array of 1-50 maps, each of the form string:string (key:value).
        var tags: [Swift.String:Swift.String]?
...
extension IvsClientTypes {
    ...
    public struct Stream: Swift.Equatable {
        ...
        var channelArn: Swift.String?
        /// The stream’s health.
        var health: IvsClientTypes.StreamHealth?
...
extension IvsClientTypes {
    ...
    public struct StreamSession: Swift.Equatable {
        ...
        var ingestConfiguration: IvsClientTypes.IngestConfiguration?
        ...
        var truncatedEvents: [IvsClientTypes.StreamEvent]?
...
extension IvsClientTypes {
    ...
    public struct VideoConfiguration: Swift.Equatable {
        ...
        var avcLevel: Swift.String?
        /// Indicates to the decoder the requirements for decoding the stream. For definitions of the valid values, see the H.264 specification.
        var avcProfile: Swift.String?
        /// Codec used for the video encoding.
        var codec: Swift.String?
        /// Software or hardware used to encode the video.
        var encoder: Swift.String?
        /// The expected ingest bitrate (bits per second). This is configured in the encoder.
        var targetBitrate: Swift.Int
        /// The expected ingest framerate. This is configured in the encoder.
        var targetFramerate: Swift.Int
        /// Video-resolution height in pixels.
        var videoHeight: Swift.Int
        /// Video-resolution width in pixels.
        var videoWidth: Swift.Int
