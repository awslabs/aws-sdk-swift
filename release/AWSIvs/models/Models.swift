...
extension IvsClientTypes.AudioConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case channels
        case codec
        case sampleRate
...
extension IvsClientTypes.AudioConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AudioConfiguration(channels: \(Swift.String(describing: channels)), codec: \(Swift.String(describing: codec)), sampleRate: \(Swift.String(describing: sampleRate)), targetBitrate: \(Swift.String(describing: targetBitrate)))"}
}
...
public struct BatchGetChannelInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchGetChannelInputURLHostMiddleware"
...
public struct BatchGetStreamKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchGetStreamKeyInputURLHostMiddleware"
...
public struct CreateRecordingConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRecordingConfigurationInputURLHostMiddleware"
...
public struct CreateStreamKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStreamKeyInputURLHostMiddleware"
...
public struct DeletePlaybackKeyPairInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePlaybackKeyPairInputURLHostMiddleware"
...
public struct DeleteRecordingConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecordingConfigurationInputURLHostMiddleware"
...
public struct DeleteStreamKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStreamKeyInputURLHostMiddleware"
...
public struct GetChannelInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetChannelInputURLHostMiddleware"
...
public struct GetPlaybackKeyPairInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPlaybackKeyPairInputURLHostMiddleware"
...
public struct GetRecordingConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRecordingConfigurationInputURLHostMiddleware"
...
public struct GetStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStreamInputURLHostMiddleware"
...
public struct GetStreamKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStreamKeyInputURLHostMiddleware"
...
public struct GetStreamSessionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStreamSessionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetStreamSessionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetStreamSessionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetStreamSessionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetStreamSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetStreamSessionOutputError>
}

extension GetStreamSessionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetStreamSessionInput(channelArn: \(Swift.String(describing: channelArn)), streamId: \(Swift.String(describing: streamId)))"}
}

extension GetStreamSessionInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case channelArn
        case streamId
    }
...
public struct GetStreamSessionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStreamSessionInputHeadersMiddleware"
...
public struct GetStreamSessionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStreamSessionInputQueryItemMiddleware"
...
public struct GetStreamSessionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStreamSessionInputURLHostMiddleware"
    ...
    public typealias MInput = GetStreamSessionInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetStreamSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetStreamSessionOutputError>
}

public struct GetStreamSessionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStreamSessionInputURLPathMiddleware"
...
extension GetStreamSessionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetStreamSessionOutputResponse(streamSession: \(Swift.String(describing: streamSession)))"}
}
...
struct GetStreamSessionOutputResponseBody: Swift.Equatable {
    public let streamSession: IvsClientTypes.StreamSession?
}
...
public struct ImportPlaybackKeyPairInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ImportPlaybackKeyPairInputURLHostMiddleware"
...
extension IvsClientTypes.IngestConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case audio
        case video
    }
...
extension IvsClientTypes.IngestConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IngestConfiguration(audio: \(Swift.String(describing: audio)), video: \(Swift.String(describing: video)))"}
}
...
public struct ListPlaybackKeyPairsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlaybackKeyPairsInputURLHostMiddleware"
...
public struct ListRecordingConfigurationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecordingConfigurationsInputURLHostMiddleware"
...
public struct ListStreamKeysInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStreamKeysInputURLHostMiddleware"
...
public struct ListStreamSessionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStreamSessionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListStreamSessionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListStreamSessionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListStreamSessionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListStreamSessionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListStreamSessionsOutputError>
}

extension ListStreamSessionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListStreamSessionsInput(channelArn: \(Swift.String(describing: channelArn)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListStreamSessionsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case channelArn
        case maxResults
        case nextToken
...
public struct ListStreamSessionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStreamSessionsInputHeadersMiddleware"
...
public struct ListStreamSessionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStreamSessionsInputQueryItemMiddleware"
...
public struct ListStreamSessionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStreamSessionsInputURLHostMiddleware"
    ...
    public typealias MInput = ListStreamSessionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListStreamSessionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListStreamSessionsOutputError>
}

public struct ListStreamSessionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStreamSessionsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/ListStreamSessions"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListStreamSessionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListStreamSessionsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), streamSessions: \(Swift.String(describing: streamSessions)))"}
}
...
struct ListStreamSessionsOutputResponseBody: Swift.Equatable {
    public let streamSessions: [IvsClientTypes.StreamSessionSummary]?
    public let nextToken: Swift.String?
}
...
extension ListStreamsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListStreamsInput(filterBy: \(Swift.String(describing: filterBy)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListStreamsInputBody: Swift.Equatable {
    public let filterBy: IvsClientTypes.StreamFilters?
    public let nextToken: Swift.String?
    public let maxResults: Swift.Int
}
...
public struct PutMetadataInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutMetadataInputURLHostMiddleware"
...
public struct StopStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopStreamInputURLHostMiddleware"
...
extension IvsClientTypes.Stream: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Stream(channelArn: \(Swift.String(describing: channelArn)), health: \(Swift.String(describing: health)), playbackUrl: \(Swift.String(describing: playbackUrl)), startTime: \(Swift.String(describing: startTime)), state: \(Swift.String(describing: state)), streamId: \(Swift.String(describing: streamId)), viewerCount: \(Swift.String(describing: viewerCount)))"}
}
...
extension IvsClientTypes.StreamEvent: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case eventTime
        case name
        case type
...
extension IvsClientTypes.StreamEvent: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamEvent(eventTime: \(Swift.String(describing: eventTime)), name: \(Swift.String(describing: name)), type: \(Swift.String(describing: type)))"}
}
...
extension IvsClientTypes.StreamFilters: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case health
    }
...
extension IvsClientTypes.StreamFilters: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamFilters(health: \(Swift.String(describing: health)))"}
}
...
extension IvsClientTypes.StreamSession: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case channel
        case endTime
...
extension IvsClientTypes.StreamSession: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamSession(channel: \(Swift.String(describing: channel)), endTime: \(Swift.String(describing: endTime)), ingestConfiguration: \(Swift.String(describing: ingestConfiguration)), recordingConfiguration: \(Swift.String(describing: recordingConfiguration)), startTime: \(Swift.String(describing: startTime)), streamId: \(Swift.String(describing: streamId)), truncatedEvents: \(Swift.String(describing: truncatedEvents)))"}
}
...
extension IvsClientTypes.StreamSessionSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case endTime
        case hasErrorEvent
        case startTime
...
extension IvsClientTypes.StreamSessionSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamSessionSummary(endTime: \(Swift.String(describing: endTime)), hasErrorEvent: \(Swift.String(describing: hasErrorEvent)), startTime: \(Swift.String(describing: startTime)), streamId: \(Swift.String(describing: streamId)))"}
}
...
extension IvsClientTypes.StreamSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamSummary(channelArn: \(Swift.String(describing: channelArn)), health: \(Swift.String(describing: health)), startTime: \(Swift.String(describing: startTime)), state: \(Swift.String(describing: state)), streamId: \(Swift.String(describing: streamId)), viewerCount: \(Swift.String(describing: viewerCount)))"}
}
...
extension IvsClientTypes.VideoConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case avcLevel
        case avcProfile
        case codec
...
extension IvsClientTypes.VideoConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "VideoConfiguration(avcLevel: \(Swift.String(describing: avcLevel)), avcProfile: \(Swift.String(describing: avcProfile)), codec: \(Swift.String(describing: codec)), encoder: \(Swift.String(describing: encoder)), targetBitrate: \(Swift.String(describing: targetBitrate)), targetFramerate: \(Swift.String(describing: targetFramerate)), videoHeight: \(Swift.String(describing: videoHeight)), videoWidth: \(Swift.String(describing: videoWidth)))"}
}
