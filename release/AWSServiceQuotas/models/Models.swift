...
public struct DeleteServiceQuotaIncreaseRequestFromTemplateInput: Swift.Equatable {
    ...
    /// This member is required.
    var quotaCode: Swift.String?
    /// The service identifier.
    /// This member is required.
    var serviceCode: Swift.String?
...
extension ServiceQuotasClientTypes {
    ...
    public struct ErrorReason: Swift.Equatable {
        ...
        var errorCode: ServiceQuotasClientTypes.ErrorCode?
        /// The error message.
...
public struct GetAWSDefaultServiceQuotaOutputResponse: Swift.Equatable {
    ...
    var quota: ServiceQuotasClientTypes.ServiceQuota?
...
public struct GetAssociationForServiceQuotaTemplateOutputResponse: Swift.Equatable {
    ...
    var serviceQuotaTemplateAssociationStatus: ServiceQuotasClientTypes.ServiceQuotaTemplateAssociationStatus?
...
public struct GetRequestedServiceQuotaChangeOutputResponse: Swift.Equatable {
    ...
    var requestedQuota: ServiceQuotasClientTypes.RequestedServiceQuotaChange?
...
public struct GetServiceQuotaIncreaseRequestFromTemplateOutputResponse: Swift.Equatable {
    /// Information about the quota increase request.
    var serviceQuotaIncreaseRequestInTemplate: ServiceQuotasClientTypes.ServiceQuotaIncreaseRequestInTemplate?
...
public struct ListAWSDefaultServiceQuotasOutputResponse: Swift.Equatable {
    ...
    var quotas: [ServiceQuotasClientTypes.ServiceQuota]?
...
public struct ListRequestedServiceQuotaChangeHistoryByQuotaInput: Swift.Equatable {
    ...
    var status: ServiceQuotasClientTypes.RequestStatus?
...
public struct ListRequestedServiceQuotaChangeHistoryByQuotaOutputResponse: Swift.Equatable {
    ...
    var requestedQuotas: [ServiceQuotasClientTypes.RequestedServiceQuotaChange]?
...
public struct ListServiceQuotaIncreaseRequestsInTemplateOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// Information about the quota increase requests.
    var serviceQuotaIncreaseRequestInTemplateList: [ServiceQuotasClientTypes.ServiceQuotaIncreaseRequestInTemplate]?
...
public struct ListServicesOutputResponse: Swift.Equatable {
    ...
    var services: [ServiceQuotasClientTypes.ServiceInfo]?
...
public struct ListTagsForResourceOutputResponse: Swift.Equatable {
    ...
    var tags: [ServiceQuotasClientTypes.Tag]?
...
extension ServiceQuotasClientTypes {
    ...
    public struct MetricInfo: Swift.Equatable {
        ...
        var metricDimensions: [Swift.String:Swift.String]?
        /// The name of the metric.
        var metricName: Swift.String?
        /// The namespace of the metric.
        var metricNamespace: Swift.String?
        /// The metric statistic that we recommend you use when determining quota usage.
        var metricStatisticRecommendation: Swift.String?
...
extension ServiceQuotasClientTypes {
    ...
    public struct QuotaPeriod: Swift.Equatable {
        /// The time unit.
        var periodUnit: ServiceQuotasClientTypes.PeriodUnit?
        /// The value.
        var periodValue: Swift.Int?
...
extension ServiceQuotasClientTypes {
    ...
    public struct RequestedServiceQuotaChange: Swift.Equatable {
        /// The case ID.
        var caseId: Swift.String?
        /// The date and time when the quota increase request was received and the case ID was created.
        var created: ClientRuntime.Date?
        /// The new, increased value for the quota.
        var desiredValue: Swift.Double?
        /// Indicates whether the quota is global.
        var globalQuota: Swift.Bool
        /// The unique identifier.
        var id: Swift.String?
        /// The date and time of the most recent change.
        var lastUpdated: ClientRuntime.Date?
        /// The Amazon Resource Name (ARN) of the quota.
        var quotaArn: Swift.String?
        /// The quota identifier.
        var quotaCode: Swift.String?
        /// The quota name.
        var quotaName: Swift.String?
        /// The IAM identity of the requester.
        var requester: Swift.String?
        /// The service identifier.
        var serviceCode: Swift.String?
        /// The service name.
...
extension ServiceQuotasClientTypes {
    ...
    public struct ServiceQuota: Swift.Equatable {
        ...
        var adjustable: Swift.Bool
        /// The error code and error reason.
        var errorReason: ServiceQuotasClientTypes.ErrorReason?
        /// Indicates whether the quota is global.
        var globalQuota: Swift.Bool
        /// The period of time.
        var period: ServiceQuotasClientTypes.QuotaPeriod?
        /// The Amazon Resource Name (ARN) of the quota.
        var quotaArn: Swift.String?
        /// The quota identifier.
        var quotaCode: Swift.String?
        ...
        var usageMetric: ServiceQuotasClientTypes.MetricInfo?
        /// The quota value.
