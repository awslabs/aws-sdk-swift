...
public protocol TimestreamQueryClientProtocol {
    ...
    func createScheduledQuery(input: CreateScheduledQueryInput, completion: @escaping (ClientRuntime.SdkResult<CreateScheduledQueryOutputResponse, CreateScheduledQueryOutputError>) -> Void)
    /// Deletes a given scheduled query. This is an irreversible operation.
    func deleteScheduledQuery(input: DeleteScheduledQueryInput, completion: @escaping (ClientRuntime.SdkResult<DeleteScheduledQueryOutputResponse, DeleteScheduledQueryOutputError>) -> Void)
    ...
    func describeScheduledQuery(input: DescribeScheduledQueryInput, completion: @escaping (ClientRuntime.SdkResult<DescribeScheduledQueryOutputResponse, DescribeScheduledQueryOutputError>) -> Void)
    /// You can use this API to run a scheduled query manually.
    func executeScheduledQuery(input: ExecuteScheduledQueryInput, completion: @escaping (ClientRuntime.SdkResult<ExecuteScheduledQueryOutputResponse, ExecuteScheduledQueryOutputError>) -> Void)
    /// Gets a list of all scheduled queries in the caller's Amazon account and Region. ListScheduledQueries is eventually consistent.
    func listScheduledQueries(input: ListScheduledQueriesInput, completion: @escaping (ClientRuntime.SdkResult<ListScheduledQueriesOutputResponse, ListScheduledQueriesOutputError>) -> Void)
    ...
    func prepareQuery(input: PrepareQueryInput, completion: @escaping (ClientRuntime.SdkResult<PrepareQueryOutputResponse, PrepareQueryOutputError>) -> Void)
    ...
    func updateScheduledQuery(input: UpdateScheduledQueryInput, completion: @escaping (ClientRuntime.SdkResult<UpdateScheduledQueryOutputResponse, UpdateScheduledQueryOutputError>) -> Void)
}
