...
public struct CancelQueryOutputResponse: Swift.Equatable {
    ...
    var cancellationMessage: Swift.String?
...
extension TimestreamQueryClientTypes {
    ...
    public struct ColumnInfo: Swift.Equatable {
        ...
        /// This member is required.
        var type: Box<TimestreamQueryClientTypes.ModelType>?
...
public struct CreateScheduledQueryInput: Swift.Equatable {
    ...
    /// This member is required.
    var errorReportConfiguration: TimestreamQueryClientTypes.ErrorReportConfiguration?
    ...
    /// This member is required.
    var notificationConfiguration: TimestreamQueryClientTypes.NotificationConfiguration?
    ...
    /// This member is required.
    var scheduleConfiguration: TimestreamQueryClientTypes.ScheduleConfiguration?
    /// The ARN for the IAM role that Timestream will assume when running the scheduled query.
    /// This member is required.
    var scheduledQueryExecutionRoleArn: Swift.String?
    /// A list of key-value pairs to label the scheduled query.
    var tags: [TimestreamQueryClientTypes.Tag]?
    /// Configuration used for writing the result of a query.
    var targetConfiguration: TimestreamQueryClientTypes.TargetConfiguration?
...
extension TimestreamQueryClientTypes {
    ...
    public struct Datum: Swift.Equatable {
        ...
        var arrayValue: [TimestreamQueryClientTypes.Datum]?
        /// Indicates if the data point is null.
        var nullValue: Swift.Bool?
        /// Indicates if the data point is a row.
        var rowValue: TimestreamQueryClientTypes.Row?
        /// Indicates if the data point is a scalar value such as integer, string, double, or Boolean.
        var scalarValue: Swift.String?
        /// Indicates if the data point is a timeseries data type.
        var timeSeriesValue: [TimestreamQueryClientTypes.TimeSeriesDataPoint]?
...
public struct DeleteScheduledQueryInput: Swift.Equatable {
    ...
    /// This member is required.
    var scheduledQueryArn: Swift.String?
...
public struct DescribeEndpointsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var endpoints: [TimestreamQueryClientTypes.Endpoint]?
...
public struct DescribeScheduledQueryOutputResponse: Swift.Equatable {
    /// The scheduled query.
    /// This member is required.
    var scheduledQuery: TimestreamQueryClientTypes.ScheduledQueryDescription?
...
extension TimestreamQueryClientTypes {
    ...
    public struct DimensionMapping: Swift.Equatable {
        ...
        /// This member is required.
        var dimensionValueType: TimestreamQueryClientTypes.DimensionValueType?
...
extension TimestreamQueryClientTypes {
    ...
    public struct ErrorReportConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var s3Configuration: TimestreamQueryClientTypes.S3Configuration?
...
extension TimestreamQueryClientTypes {
    ...
    public struct ErrorReportLocation: Swift.Equatable {
        ...
        var s3ReportLocation: TimestreamQueryClientTypes.S3ReportLocation?
...
public struct ExecuteScheduledQueryInput: Swift.Equatable {
    ...
    /// This member is required.
    var invocationTime: ClientRuntime.Date?
...
extension TimestreamQueryClientTypes {
    ...
    public struct ExecutionStats: Swift.Equatable {
        ...
        var bytesMetered: Swift.Int
        /// Data writes metered for records ingested in a single scheduled query run.
        var dataWrites: Swift.Int
        /// Total time, measured in milliseconds, that was needed for the scheduled query run to complete.
        var executionTimeInMillis: Swift.Int
        /// Number of rows present in the output from running a query before ingestion to destination data source.
        var queryResultRows: Swift.Int
        /// The number of records ingested for a single scheduled query run.
        var recordsIngested: Swift.Int
...
public struct ListScheduledQueriesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var scheduledQueries: [TimestreamQueryClientTypes.ScheduledQuery]?
...
extension TimestreamQueryClientTypes {
    ...
    public struct MixedMeasureMapping: Swift.Equatable {
        ...
        /// This member is required.
        var measureValueType: TimestreamQueryClientTypes.MeasureValueType?
        /// Required when measureValueType is MULTI. Attribute mappings for MULTI value measures.
        var multiMeasureAttributeMappings: [TimestreamQueryClientTypes.MultiMeasureAttributeMapping]?
        /// This field refers to the source column from which measure-value is to be read for result materialization.
        var sourceColumn: Swift.String?
        /// Target measure name to be used. If not provided, the target measure name by default would be measure-name if provided, or sourceColumn otherwise.
        var targetMeasureName: Swift.String?
...
extension TimestreamQueryClientTypes {
    ...
    public struct MultiMeasureAttributeMapping: Swift.Equatable {
        ...
        /// This member is required.
        var measureValueType: TimestreamQueryClientTypes.ScalarMeasureValueType?
        /// Source column from where the attribute value is to be read.
        /// This member is required.
        var sourceColumn: Swift.String?
        /// Custom name to be used for attribute name in derived table. If not provided, source column name would be used.
        var targetMultiMeasureAttributeName: Swift.String?
...
extension TimestreamQueryClientTypes {
    ...
    public struct MultiMeasureMappings: Swift.Equatable {
        ...
        var targetMultiMeasureName: Swift.String?
...
extension TimestreamQueryClientTypes {
    ...
    public struct NotificationConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var snsConfiguration: TimestreamQueryClientTypes.SnsConfiguration?
...
extension TimestreamQueryClientTypes {
    ...
    public struct ParameterMapping: Swift.Equatable {
        ...
        /// This member is required.
        var type: TimestreamQueryClientTypes.ModelType?
...
public struct PrepareQueryOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var columns: [TimestreamQueryClientTypes.SelectColumn]?
    /// A list of parameters used in the submitted query string.
    /// This member is required.
    var parameters: [TimestreamQueryClientTypes.ParameterMapping]?
...
public struct QueryOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var columnInfo: [TimestreamQueryClientTypes.ColumnInfo]?
    ...
    var queryStatus: TimestreamQueryClientTypes.QueryStatus?
    /// The result set rows returned by the query.
    /// This member is required.
    var rows: [TimestreamQueryClientTypes.Row]?
...
extension TimestreamQueryClientTypes {
    ...
    public struct QueryStatus: Swift.Equatable {
        ...
        var cumulativeBytesMetered: Swift.Int
        /// The amount of data scanned by the query in bytes. This is a cumulative sum and represents the total amount of bytes scanned since the query was started.
        var cumulativeBytesScanned: Swift.Int
...
extension TimestreamQueryClientTypes {
    ...
    public struct Row: Swift.Equatable {
        ...
        /// This member is required.
        var data: [TimestreamQueryClientTypes.Datum]?
...
extension TimestreamQueryClientTypes {
    ...
    public struct S3Configuration: Swift.Equatable {
        ...
        var encryptionOption: TimestreamQueryClientTypes.S3EncryptionOption?
...
extension TimestreamQueryClientTypes {
    ...
    public struct ScheduledQuery: Swift.Equatable {
        ...
        var lastRunStatus: TimestreamQueryClientTypes.ScheduledQueryRunStatus?
        /// The name of the scheduled query.
        /// This member is required.
        var name: Swift.String?
        /// The next time the scheduled query is to be run.
        var nextInvocationTime: ClientRuntime.Date?
        /// The last time the scheduled query was run.
        var previousInvocationTime: ClientRuntime.Date?
        /// State of scheduled query.
        /// This member is required.
        var state: TimestreamQueryClientTypes.ScheduledQueryState?
        /// Target data source where final scheduled query result will be written.
        var targetDestination: TimestreamQueryClientTypes.TargetDestination?
...
extension TimestreamQueryClientTypes {
    ...
    public struct ScheduledQueryDescription: Swift.Equatable {
        ...
        var lastRunSummary: TimestreamQueryClientTypes.ScheduledQueryRunSummary?
        /// Name of the scheduled query.
        /// This member is required.
        var name: Swift.String?
        ...
        var recentlyFailedRuns: [TimestreamQueryClientTypes.ScheduledQueryRunSummary]?
...
extension TimestreamQueryClientTypes {
    ...
    public struct ScheduledQueryRunSummary: Swift.Equatable {
        ...
        var errorReportLocation: TimestreamQueryClientTypes.ErrorReportLocation?
        /// Runtime statistics for a scheduled run.
        var executionStats: TimestreamQueryClientTypes.ExecutionStats?
        /// Error message for the scheduled query in case of failure. You might have to look at the error report to get more detailed error reasons.
        var failureReason: Swift.String?
        /// InvocationTime for this run. This is the time at which the query is scheduled to run. Parameter @scheduled_runtime can be used in the query to get the value.
        var invocationTime: ClientRuntime.Date?
        /// The status of a scheduled query run.
        var runStatus: TimestreamQueryClientTypes.ScheduledQueryRunStatus?
        /// The actual time when the query was run.
        var triggerTime: ClientRuntime.Date?
...
extension TimestreamQueryClientTypes {
    ...
    public struct TargetConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var timestreamConfiguration: TimestreamQueryClientTypes.TimestreamConfiguration?
...
extension TimestreamQueryClientTypes {
    ...
    public struct TargetDestination: Swift.Equatable {
        ...
        var timestreamDestination: TimestreamQueryClientTypes.TimestreamDestination?
...
extension TimestreamQueryClientTypes {
    ...
    public struct TimestreamConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var dimensionMappings: [TimestreamQueryClientTypes.DimensionMapping]?
        /// Name of the measure column.
        var measureNameColumn: Swift.String?
        /// Specifies how to map measures to multi-measure records.
        var mixedMeasureMappings: [TimestreamQueryClientTypes.MixedMeasureMapping]?
        /// Multi-measure mappings.
        var multiMeasureMappings: TimestreamQueryClientTypes.MultiMeasureMappings?
        /// Name of Timestream table that the query result will be written to. The table should be within the same database that is provided in Timestream configuration.
        /// This member is required.
        var tableName: Swift.String?
        /// Column from query result that should be used as the time column in destination table. Column type for this should be TIMESTAMP.
        /// This member is required.
        var timeColumn: Swift.String?
...
extension TimestreamQueryClientTypes {
    ...
    public struct ModelType: Swift.Equatable {
        ...
        var arrayColumnInfo: TimestreamQueryClientTypes.ColumnInfo?
        /// Indicates if the column is a row.
        var rowColumnInfo: [TimestreamQueryClientTypes.ColumnInfo]?
        /// Indicates if the column is of type string, integer, Boolean, double, timestamp, date, time.
        var scalarType: TimestreamQueryClientTypes.ScalarType?
        /// Indicates if the column is a timeseries data type.
        var timeSeriesMeasureValueColumnInfo: TimestreamQueryClientTypes.ColumnInfo?
