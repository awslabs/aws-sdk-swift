...
public struct CancelQueryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelQueryInputURLHostMiddleware"
...
public struct CreateScheduledQueryInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateScheduledQueryInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateScheduledQueryInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateScheduledQueryOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateScheduledQueryInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateScheduledQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateScheduledQueryOutputError>
}

extension CreateScheduledQueryInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateScheduledQueryInput(clientToken: \(Swift.String(describing: clientToken)), errorReportConfiguration: \(Swift.String(describing: errorReportConfiguration)), kmsKeyId: \(Swift.String(describing: kmsKeyId)), name: \(Swift.String(describing: name)), notificationConfiguration: \(Swift.String(describing: notificationConfiguration)), queryString: \(Swift.String(describing: queryString)), scheduleConfiguration: \(Swift.String(describing: scheduleConfiguration)), scheduledQueryExecutionRoleArn: \(Swift.String(describing: scheduledQueryExecutionRoleArn)), tags: \(Swift.String(describing: tags)), targetConfiguration: \(Swift.String(describing: targetConfiguration)))"}
}

extension CreateScheduledQueryInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateScheduledQueryInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateScheduledQueryInputHeadersMiddleware"
...
public struct CreateScheduledQueryInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateScheduledQueryInputQueryItemMiddleware"
...
public struct CreateScheduledQueryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateScheduledQueryInputURLHostMiddleware"
    ...
    public typealias MInput = CreateScheduledQueryInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateScheduledQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateScheduledQueryOutputError>
}

public struct CreateScheduledQueryInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateScheduledQueryInputURLPathMiddleware"
...
struct CreateScheduledQueryInputBody: Swift.Equatable {
    ...
    public let scheduleConfiguration: TimestreamQueryClientTypes.ScheduleConfiguration?
    public let notificationConfiguration: TimestreamQueryClientTypes.NotificationConfiguration?
    public let targetConfiguration: TimestreamQueryClientTypes.TargetConfiguration?
    public let clientToken: Swift.String?
    public let scheduledQueryExecutionRoleArn: Swift.String?
    public let tags: [TimestreamQueryClientTypes.Tag]?
    public let kmsKeyId: Swift.String?
    public let errorReportConfiguration: TimestreamQueryClientTypes.ErrorReportConfiguration?
}
...
extension CreateScheduledQueryOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateScheduledQueryOutputResponse(arn: \(Swift.String(describing: arn)))"}
}
...
public struct DeleteScheduledQueryInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteScheduledQueryInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteScheduledQueryInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteScheduledQueryOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteScheduledQueryInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteScheduledQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteScheduledQueryOutputError>
}

extension DeleteScheduledQueryInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteScheduledQueryInput(scheduledQueryArn: \(Swift.String(describing: scheduledQueryArn)))"}
}

extension DeleteScheduledQueryInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DeleteScheduledQueryInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteScheduledQueryInputHeadersMiddleware"
...
public struct DeleteScheduledQueryInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteScheduledQueryInputQueryItemMiddleware"
...
public struct DeleteScheduledQueryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteScheduledQueryInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteScheduledQueryInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteScheduledQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteScheduledQueryOutputError>
}

public struct DeleteScheduledQueryInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteScheduledQueryInputURLPathMiddleware"
...
struct DeleteScheduledQueryInputBody: Swift.Equatable {
    public let scheduledQueryArn: Swift.String?
}
...
extension DeleteScheduledQueryOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteScheduledQueryOutputResponse()"}
}
...
struct DeleteScheduledQueryOutputResponseBody: Swift.Equatable {
}

extension DeleteScheduledQueryOutputResponseBody: Swift.Decodable {
...
public struct DescribeScheduledQueryInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScheduledQueryInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeScheduledQueryInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeScheduledQueryOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeScheduledQueryInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeScheduledQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeScheduledQueryOutputError>
}

extension DescribeScheduledQueryInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeScheduledQueryInput(scheduledQueryArn: \(Swift.String(describing: scheduledQueryArn)))"}
}

extension DescribeScheduledQueryInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case scheduledQueryArn = "ScheduledQueryArn"
    }
...
public struct DescribeScheduledQueryInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScheduledQueryInputHeadersMiddleware"
...
public struct DescribeScheduledQueryInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScheduledQueryInputQueryItemMiddleware"
...
public struct DescribeScheduledQueryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScheduledQueryInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeScheduledQueryInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeScheduledQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeScheduledQueryOutputError>
}

public struct DescribeScheduledQueryInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScheduledQueryInputURLPathMiddleware"
...
extension DescribeScheduledQueryOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeScheduledQueryOutputResponse(scheduledQuery: \(Swift.String(describing: scheduledQuery)))"}
}
...
struct DescribeScheduledQueryOutputResponseBody: Swift.Equatable {
    public let scheduledQuery: TimestreamQueryClientTypes.ScheduledQueryDescription?
}
...
extension TimestreamQueryClientTypes.DimensionMapping: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.DimensionMapping: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DimensionMapping(dimensionValueType: \(Swift.String(describing: dimensionValueType)), name: \(Swift.String(describing: name)))"}
}
...
extension TimestreamQueryClientTypes.ErrorReportConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.ErrorReportConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ErrorReportConfiguration(s3Configuration: \(Swift.String(describing: s3Configuration)))"}
}
...
extension TimestreamQueryClientTypes.ErrorReportLocation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.ErrorReportLocation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ErrorReportLocation(s3ReportLocation: \(Swift.String(describing: s3ReportLocation)))"}
}
...
public struct ExecuteScheduledQueryInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExecuteScheduledQueryInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ExecuteScheduledQueryInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ExecuteScheduledQueryOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ExecuteScheduledQueryInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ExecuteScheduledQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExecuteScheduledQueryOutputError>
}

extension ExecuteScheduledQueryInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExecuteScheduledQueryInput(clientToken: \(Swift.String(describing: clientToken)), invocationTime: \(Swift.String(describing: invocationTime)), scheduledQueryArn: \(Swift.String(describing: scheduledQueryArn)))"}
}

extension ExecuteScheduledQueryInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientToken = "ClientToken"
...
public struct ExecuteScheduledQueryInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExecuteScheduledQueryInputHeadersMiddleware"
...
public struct ExecuteScheduledQueryInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExecuteScheduledQueryInputQueryItemMiddleware"
...
public struct ExecuteScheduledQueryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExecuteScheduledQueryInputURLHostMiddleware"
    ...
    public typealias MInput = ExecuteScheduledQueryInput
    public typealias MOutput = ClientRuntime.OperationOutput<ExecuteScheduledQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExecuteScheduledQueryOutputError>
}

public struct ExecuteScheduledQueryInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExecuteScheduledQueryInputURLPathMiddleware"
...
extension ExecuteScheduledQueryOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExecuteScheduledQueryOutputResponse()"}
}
...
struct ExecuteScheduledQueryOutputResponseBody: Swift.Equatable {
}

extension ExecuteScheduledQueryOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension TimestreamQueryClientTypes.ExecutionStats: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.ExecutionStats: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExecutionStats(bytesMetered: \(Swift.String(describing: bytesMetered)), dataWrites: \(Swift.String(describing: dataWrites)), executionTimeInMillis: \(Swift.String(describing: executionTimeInMillis)), queryResultRows: \(Swift.String(describing: queryResultRows)), recordsIngested: \(Swift.String(describing: recordsIngested)))"}
}
...
public struct ListScheduledQueriesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListScheduledQueriesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListScheduledQueriesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListScheduledQueriesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListScheduledQueriesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListScheduledQueriesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListScheduledQueriesOutputError>
}

extension ListScheduledQueriesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListScheduledQueriesInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListScheduledQueriesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ListScheduledQueriesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListScheduledQueriesInputHeadersMiddleware"
...
public struct ListScheduledQueriesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListScheduledQueriesInputQueryItemMiddleware"
...
public struct ListScheduledQueriesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListScheduledQueriesInputURLHostMiddleware"
    ...
    public typealias MInput = ListScheduledQueriesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListScheduledQueriesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListScheduledQueriesOutputError>
}

public struct ListScheduledQueriesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListScheduledQueriesInputURLPathMiddleware"
...
extension ListScheduledQueriesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListScheduledQueriesOutputResponse(nextToken: \(Swift.String(describing: nextToken)), scheduledQueries: \(Swift.String(describing: scheduledQueries)))"}
}
...
struct ListScheduledQueriesOutputResponseBody: Swift.Equatable {
    public let scheduledQueries: [TimestreamQueryClientTypes.ScheduledQuery]?
    public let nextToken: Swift.String?
}
...
extension TimestreamQueryClientTypes.MixedMeasureMapping: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.MixedMeasureMapping: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MixedMeasureMapping(measureName: \(Swift.String(describing: measureName)), measureValueType: \(Swift.String(describing: measureValueType)), multiMeasureAttributeMappings: \(Swift.String(describing: multiMeasureAttributeMappings)), sourceColumn: \(Swift.String(describing: sourceColumn)), targetMeasureName: \(Swift.String(describing: targetMeasureName)))"}
}
...
extension TimestreamQueryClientTypes.MultiMeasureAttributeMapping: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case measureValueType = "MeasureValueType"
        case sourceColumn = "SourceColumn"
...
extension TimestreamQueryClientTypes.MultiMeasureAttributeMapping: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MultiMeasureAttributeMapping(measureValueType: \(Swift.String(describing: measureValueType)), sourceColumn: \(Swift.String(describing: sourceColumn)), targetMultiMeasureAttributeName: \(Swift.String(describing: targetMultiMeasureAttributeName)))"}
}
...
extension TimestreamQueryClientTypes.MultiMeasureMappings: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case multiMeasureAttributeMappings = "MultiMeasureAttributeMappings"
...
extension TimestreamQueryClientTypes.MultiMeasureMappings: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MultiMeasureMappings(multiMeasureAttributeMappings: \(Swift.String(describing: multiMeasureAttributeMappings)), targetMultiMeasureName: \(Swift.String(describing: targetMultiMeasureName)))"}
}
...
extension TimestreamQueryClientTypes.NotificationConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.NotificationConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "NotificationConfiguration(snsConfiguration: \(Swift.String(describing: snsConfiguration)))"}
}
...
extension TimestreamQueryClientTypes.ParameterMapping: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case type = "Type"
    }
...
extension TimestreamQueryClientTypes.ParameterMapping: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ParameterMapping(name: \(Swift.String(describing: name)), type: \(Swift.String(describing: type)))"}
}
...
public struct PrepareQueryInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PrepareQueryInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PrepareQueryInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PrepareQueryOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PrepareQueryInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PrepareQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PrepareQueryOutputError>
}

extension PrepareQueryInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PrepareQueryInput(queryString: \(Swift.String(describing: queryString)), validateOnly: \(Swift.String(describing: validateOnly)))"}
}

extension PrepareQueryInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case queryString = "QueryString"
...
public struct PrepareQueryInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PrepareQueryInputHeadersMiddleware"
...
public struct PrepareQueryInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PrepareQueryInputQueryItemMiddleware"
...
public struct PrepareQueryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PrepareQueryInputURLHostMiddleware"
    ...
    public typealias MInput = PrepareQueryInput
    public typealias MOutput = ClientRuntime.OperationOutput<PrepareQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PrepareQueryOutputError>
}

public struct PrepareQueryInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PrepareQueryInputURLPathMiddleware"
...
struct PrepareQueryInputBody: Swift.Equatable {
    public let queryString: Swift.String?
    public let validateOnly: Swift.Bool?
}
...
extension PrepareQueryOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PrepareQueryOutputResponse(columns: \(Swift.String(describing: columns)), parameters: \(Swift.String(describing: parameters)), queryString: \(Swift.String(describing: queryString)))"}
}
...
struct PrepareQueryOutputResponseBody: Swift.Equatable {
    public let queryString: Swift.String?
    public let columns: [TimestreamQueryClientTypes.SelectColumn]?
    public let parameters: [TimestreamQueryClientTypes.ParameterMapping]?
}
...
public struct QueryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "QueryInputURLHostMiddleware"
...
extension ResourceNotFoundException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceNotFoundException(message: \(Swift.String(describing: message)), scheduledQueryArn: \(Swift.String(describing: scheduledQueryArn)))"}
}
...
extension TimestreamQueryClientTypes.S3Configuration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.S3Configuration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3Configuration(bucketName: \(Swift.String(describing: bucketName)), encryptionOption: \(Swift.String(describing: encryptionOption)), objectKeyPrefix: \(Swift.String(describing: objectKeyPrefix)))"}
}
...
extension TimestreamQueryClientTypes.S3ReportLocation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bucketName = "BucketName"
...
extension TimestreamQueryClientTypes.S3ReportLocation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3ReportLocation(bucketName: \(Swift.String(describing: bucketName)), objectKey: \(Swift.String(describing: objectKey)))"}
}
...
extension TimestreamQueryClientTypes.ScheduleConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.ScheduleConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ScheduleConfiguration(scheduleExpression: \(Swift.String(describing: scheduleExpression)))"}
}
...
extension TimestreamQueryClientTypes.ScheduledQuery: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
...
extension TimestreamQueryClientTypes.ScheduledQuery: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ScheduledQuery(arn: \(Swift.String(describing: arn)), creationTime: \(Swift.String(describing: creationTime)), errorReportConfiguration: \(Swift.String(describing: errorReportConfiguration)), lastRunStatus: \(Swift.String(describing: lastRunStatus)), name: \(Swift.String(describing: name)), nextInvocationTime: \(Swift.String(describing: nextInvocationTime)), previousInvocationTime: \(Swift.String(describing: previousInvocationTime)), state: \(Swift.String(describing: state)), targetDestination: \(Swift.String(describing: targetDestination)))"}
}
...
extension TimestreamQueryClientTypes.ScheduledQueryDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
        case creationTime = "CreationTime"
        case errorReportConfiguration = "ErrorReportConfiguration"
...
extension TimestreamQueryClientTypes.ScheduledQueryRunSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.ScheduledQueryRunSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ScheduledQueryRunSummary(errorReportLocation: \(Swift.String(describing: errorReportLocation)), executionStats: \(Swift.String(describing: executionStats)), failureReason: \(Swift.String(describing: failureReason)), invocationTime: \(Swift.String(describing: invocationTime)), runStatus: \(Swift.String(describing: runStatus)), triggerTime: \(Swift.String(describing: triggerTime)))"}
}
...
extension TimestreamQueryClientTypes.SelectColumn: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.SelectColumn: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SelectColumn(aliased: \(Swift.String(describing: aliased)), databaseName: \(Swift.String(describing: databaseName)), name: \(Swift.String(describing: name)), tableName: \(Swift.String(describing: tableName)), type: \(Swift.String(describing: type)))"}
}
...
extension TimestreamQueryClientTypes.SnsConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.SnsConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SnsConfiguration(topicArn: \(Swift.String(describing: topicArn)))"}
}
...
extension TimestreamQueryClientTypes.Tag: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
...
extension TimestreamQueryClientTypes.Tag: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension TimestreamQueryClientTypes.TargetConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.TargetConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TargetConfiguration(timestreamConfiguration: \(Swift.String(describing: timestreamConfiguration)))"}
}
...
extension TimestreamQueryClientTypes.TargetDestination: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TimestreamQueryClientTypes.TargetDestination: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TargetDestination(timestreamDestination: \(Swift.String(describing: timestreamDestination)))"}
}
...
extension TimestreamQueryClientTypes.TimestreamConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case databaseName = "DatabaseName"
...
extension TimestreamQueryClientTypes.TimestreamConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TimestreamConfiguration(databaseName: \(Swift.String(describing: databaseName)), dimensionMappings: \(Swift.String(describing: dimensionMappings)), measureNameColumn: \(Swift.String(describing: measureNameColumn)), mixedMeasureMappings: \(Swift.String(describing: mixedMeasureMappings)), multiMeasureMappings: \(Swift.String(describing: multiMeasureMappings)), tableName: \(Swift.String(describing: tableName)), timeColumn: \(Swift.String(describing: timeColumn)))"}
}
...
extension TimestreamQueryClientTypes.TimestreamDestination: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case databaseName = "DatabaseName"
        case tableName = "TableName"
    }
...
extension TimestreamQueryClientTypes.TimestreamDestination: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TimestreamDestination(databaseName: \(Swift.String(describing: databaseName)), tableName: \(Swift.String(describing: tableName)))"}
}
...
public struct UpdateScheduledQueryInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateScheduledQueryInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateScheduledQueryInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateScheduledQueryOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateScheduledQueryInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateScheduledQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateScheduledQueryOutputError>
}

extension UpdateScheduledQueryInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateScheduledQueryInput(scheduledQueryArn: \(Swift.String(describing: scheduledQueryArn)), state: \(Swift.String(describing: state)))"}
}

extension UpdateScheduledQueryInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case scheduledQueryArn = "ScheduledQueryArn"
        case state = "State"
    }
...
public struct UpdateScheduledQueryInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateScheduledQueryInputHeadersMiddleware"
...
public struct UpdateScheduledQueryInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateScheduledQueryInputQueryItemMiddleware"
...
public struct UpdateScheduledQueryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateScheduledQueryInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateScheduledQueryInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateScheduledQueryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateScheduledQueryOutputError>
}

public struct UpdateScheduledQueryInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateScheduledQueryInputURLPathMiddleware"
...
struct UpdateScheduledQueryInputBody: Swift.Equatable {
    public let scheduledQueryArn: Swift.String?
    public let state: TimestreamQueryClientTypes.ScheduledQueryState?
}
...
extension UpdateScheduledQueryOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateScheduledQueryOutputResponse()"}
}
...
struct UpdateScheduledQueryOutputResponseBody: Swift.Equatable {
}

extension UpdateScheduledQueryOutputResponseBody: Swift.Decodable {
