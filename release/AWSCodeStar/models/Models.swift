...
public struct AssociateTeamMemberInput: Swift.Equatable {
    ...
    /// This member is required.
    var projectRole: Swift.String?
    /// Whether the team member is allowed to use an SSH public/private key pair to remotely access project resources, for example Amazon EC2 instances.
    var remoteAccessAllowed: Swift.Bool
...
extension CodeStarClientTypes {
    ...
    public struct Code: Swift.Equatable {
        ...
        /// This member is required.
        var destination: CodeStarClientTypes.CodeDestination?
        /// The location where the source code files provided with the project request are stored. AWS CodeStar retrieves the files during project creation.
        /// This member is required.
        var source: CodeStarClientTypes.CodeSource?
...
extension CodeStarClientTypes {
    ...
    public struct CodeDestination: Swift.Equatable {
        /// Information about the AWS CodeCommit repository to be created in AWS CodeStar. This is where the source code files provided with the project request will be uploaded after project creation.
        var codeCommit: CodeStarClientTypes.CodeCommitCodeDestination?
        /// Information about the GitHub repository to be created in AWS CodeStar. This is where the source code files provided with the project request will be uploaded after project creation.
        var gitHub: CodeStarClientTypes.GitHubCodeDestination?
...
extension CodeStarClientTypes {
    ...
    public struct CodeSource: Swift.Equatable {
        ...
        /// This member is required.
        var s3: CodeStarClientTypes.S3Location?
...
public struct CreateProjectInput: Swift.Equatable {
    ...
    var sourceCode: [CodeStarClientTypes.Code]?
    /// The tags created for the project.
    var tags: [Swift.String:Swift.String]?
    /// The name of the toolchain template file submitted with the project request. If this parameter is specified, the request must also include the sourceCode parameter.
    var toolchain: CodeStarClientTypes.Toolchain?
...
public struct CreateProjectOutputResponse: Swift.Equatable {
    ...
    var projectTemplateId: Swift.String?
...
public struct DescribeProjectOutputResponse: Swift.Equatable {
    ...
    var status: CodeStarClientTypes.ProjectStatus?
...
extension CodeStarClientTypes {
    ...
    public struct GitHubCodeDestination: Swift.Equatable {
        ...
        /// This member is required.
        var privateRepository: Swift.Bool
...
public struct ListProjectsOutputResponse: Swift.Equatable {
    ...
    /// A list of projects.
    /// This member is required.
    var projects: [CodeStarClientTypes.ProjectSummary]?
...
public struct ListResourcesOutputResponse: Swift.Equatable {
    ...
    var resources: [CodeStarClientTypes.Resource]?
...
public struct ListTeamMembersOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var teamMembers: [CodeStarClientTypes.TeamMember]?
...
public struct ListUserProfilesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var userProfiles: [CodeStarClientTypes.UserProfileSummary]?
...
extension CodeStarClientTypes {
    ...
    public struct Toolchain: Swift.Equatable {
        ...
        /// This member is required.
        var source: CodeStarClientTypes.ToolchainSource?
        /// The list of parameter overrides to be passed into the toolchain template during stack provisioning, if any.
        var stackParameters: [Swift.String:Swift.String]?
