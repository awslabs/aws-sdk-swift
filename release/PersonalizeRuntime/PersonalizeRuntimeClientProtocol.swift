...
public protocol PersonalizeRuntimeClientProtocol {
    ...
    ///          </note>
    func getPersonalizedRanking(input: GetPersonalizedRankingInput, completion: @escaping (SdkResult<GetPersonalizedRankingOutput, GetPersonalizedRankingOutputError>) -> Void)
    ...
    ///          </note>
    func getRecommendations(input: GetRecommendationsInput, completion: @escaping (SdkResult<GetRecommendationsOutput, GetRecommendationsOutputError>) -> Void)
}
