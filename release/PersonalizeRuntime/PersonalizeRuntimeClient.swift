...
extension PersonalizeRuntimeClient: PersonalizeRuntimeClientProtocol {
    ...
    ///          </note>
    public func getPersonalizedRanking(input: GetPersonalizedRankingInput, completion: @escaping (SdkResult<GetPersonalizedRankingOutput, GetPersonalizedRankingOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<GetPersonalizedRankingInput, GetPersonalizedRankingOutput, GetPersonalizedRankingOutputError>(id: "getPersonalizedRanking")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetPersonalizedRankingInput, GetPersonalizedRankingOutput, GetPersonalizedRankingOutputError>(contentType: "application/json"))
    ...
    ///          </note>
    public func getRecommendations(input: GetRecommendationsInput, completion: @escaping (SdkResult<GetRecommendationsOutput, GetRecommendationsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "personalize")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetRecommendationsInput, GetRecommendationsOutput, GetRecommendationsOutputError>(id: "getRecommendations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetRecommendationsInput, GetRecommendationsOutput, GetRecommendationsOutputError>(contentType: "application/json"))
