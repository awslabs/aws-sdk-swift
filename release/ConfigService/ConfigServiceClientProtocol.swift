...
/// 				Guide</i>.</p>
public protocol ConfigServiceClientProtocol {
    ...
    ///             </ul>
    ///          </note>
    func batchGetAggregateResourceConfig(input: BatchGetAggregateResourceConfigInput, completion: @escaping (SdkResult<BatchGetAggregateResourceConfigOutput, BatchGetAggregateResourceConfigOutputError>) -> Void)
    ...
    ///             </ul>
    /// 		       </note>
    func batchGetResourceConfig(input: BatchGetResourceConfigInput, completion: @escaping (SdkResult<BatchGetResourceConfigOutput, BatchGetResourceConfigOutputError>) -> Void)
    /// <p>Deletes the authorization granted to the specified
    /// 			configuration aggregator account in a specified region.</p>
    func deleteAggregationAuthorization(input: DeleteAggregationAuthorizationInput, completion: @escaping (SdkResult<DeleteAggregationAuthorizationOutput, DeleteAggregationAuthorizationOutputError>) -> Void)
    ...
    func deleteConfigRule(input: DeleteConfigRuleInput, completion: @escaping (SdkResult<DeleteConfigRuleOutput, DeleteConfigRuleOutputError>) -> Void)
    /// <p>Deletes the specified configuration aggregator and the
    /// 			aggregated data associated with the aggregator.</p>
    func deleteConfigurationAggregator(input: DeleteConfigurationAggregatorInput, completion: @escaping (SdkResult<DeleteConfigurationAggregatorOutput, DeleteConfigurationAggregatorOutputError>) -> Void)
    ...
    func deleteConfigurationRecorder(input: DeleteConfigurationRecorderInput, completion: @escaping (SdkResult<DeleteConfigurationRecorderOutput, DeleteConfigurationRecorderOutputError>) -> Void)
    ...
    func deleteConformancePack(input: DeleteConformancePackInput, completion: @escaping (SdkResult<DeleteConformancePackOutput, DeleteConformancePackOutputError>) -> Void)
    ...
    func deleteDeliveryChannel(input: DeleteDeliveryChannelInput, completion: @escaping (SdkResult<DeleteDeliveryChannelOutput, DeleteDeliveryChannelOutputError>) -> Void)
    ...
    func deleteEvaluationResults(input: DeleteEvaluationResultsInput, completion: @escaping (SdkResult<DeleteEvaluationResultsOutput, DeleteEvaluationResultsOutputError>) -> Void)
    ...
    func deleteOrganizationConfigRule(input: DeleteOrganizationConfigRuleInput, completion: @escaping (SdkResult<DeleteOrganizationConfigRuleOutput, DeleteOrganizationConfigRuleOutputError>) -> Void)
    ...
    /// 				You cannot update a conformance pack while it is in this state. </p>
    func deleteOrganizationConformancePack(input: DeleteOrganizationConformancePackInput, completion: @escaping (SdkResult<DeleteOrganizationConformancePackOutput, DeleteOrganizationConformancePackOutputError>) -> Void)
    /// <p>Deletes pending authorization requests for a specified
    /// 			aggregator account in a specified region.</p>
    func deletePendingAggregationRequest(input: DeletePendingAggregationRequestInput, completion: @escaping (SdkResult<DeletePendingAggregationRequestOutput, DeletePendingAggregationRequestOutputError>) -> Void)
    /// <p>Deletes the remediation configuration.</p>
    func deleteRemediationConfiguration(input: DeleteRemediationConfigurationInput, completion: @escaping (SdkResult<DeleteRemediationConfigurationOutput, DeleteRemediationConfigurationOutputError>) -> Void)
    ...
    ///          </note>
    func deleteRemediationExceptions(input: DeleteRemediationExceptionsInput, completion: @escaping (SdkResult<DeleteRemediationExceptionsOutput, DeleteRemediationExceptionsOutputError>) -> Void)
    ...
    /// 			 </p>
    func deleteResourceConfig(input: DeleteResourceConfigInput, completion: @escaping (SdkResult<DeleteResourceConfigOutput, DeleteResourceConfigOutputError>) -> Void)
    /// <p>Deletes the retention configuration.</p>
    func deleteRetentionConfiguration(input: DeleteRetentionConfigurationInput, completion: @escaping (SdkResult<DeleteRetentionConfigurationOutput, DeleteRetentionConfigurationOutputError>) -> Void)
    /// <p>Deletes the stored query for a single AWS account and a single AWS Region.</p>
    func deleteStoredQuery(input: DeleteStoredQueryInput, completion: @escaping (SdkResult<DeleteStoredQueryOutput, DeleteStoredQueryOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func deliverConfigSnapshot(input: DeliverConfigSnapshotInput, completion: @escaping (SdkResult<DeliverConfigSnapshotOutput, DeliverConfigSnapshotOutputError>) -> Void)
    ...
    /// 				page.</p>
    /// 		       </note>
    func describeAggregateComplianceByConfigRules(input: DescribeAggregateComplianceByConfigRulesInput, completion: @escaping (SdkResult<DescribeAggregateComplianceByConfigRulesOutput, DescribeAggregateComplianceByConfigRulesOutputError>) -> Void)
    ...
    ///          </note>
    func describeAggregateComplianceByConformancePacks(input: DescribeAggregateComplianceByConformancePacksInput, completion: @escaping (SdkResult<DescribeAggregateComplianceByConformancePacksOutput, DescribeAggregateComplianceByConformancePacksOutputError>) -> Void)
    /// <p>Returns a list of authorizations granted to various aggregator
    /// 			accounts and regions.</p>
    func describeAggregationAuthorizations(input: DescribeAggregationAuthorizationsInput, completion: @escaping (SdkResult<DescribeAggregationAuthorizationsOutput, DescribeAggregationAuthorizationsOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func describeComplianceByConfigRule(input: DescribeComplianceByConfigRuleInput, completion: @escaping (SdkResult<DescribeComplianceByConfigRuleOutput, DescribeComplianceByConfigRuleOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func describeComplianceByResource(input: DescribeComplianceByResourceInput, completion: @escaping (SdkResult<DescribeComplianceByResourceOutput, DescribeComplianceByResourceOutputError>) -> Void)
    ...
    func describeConfigRuleEvaluationStatus(input: DescribeConfigRuleEvaluationStatusInput, completion: @escaping (SdkResult<DescribeConfigRuleEvaluationStatusOutput, DescribeConfigRuleEvaluationStatusOutputError>) -> Void)
    /// <p>Returns details about your AWS Config rules.</p>
    func describeConfigRules(input: DescribeConfigRulesInput, completion: @escaping (SdkResult<DescribeConfigRulesOutput, DescribeConfigRulesOutputError>) -> Void)
    ...
    /// 			with the account. </p>
    func describeConfigurationAggregators(input: DescribeConfigurationAggregatorsInput, completion: @escaping (SdkResult<DescribeConfigurationAggregatorsOutput, DescribeConfigurationAggregatorsOutputError>) -> Void)
    ...
    func describeConfigurationAggregatorSourcesStatus(input: DescribeConfigurationAggregatorSourcesStatusInput, completion: @escaping (SdkResult<DescribeConfigurationAggregatorSourcesStatusOutput, DescribeConfigurationAggregatorSourcesStatusOutputError>) -> Void)
    ...
    /// 		       </note>
    func describeConfigurationRecorders(input: DescribeConfigurationRecordersInput, completion: @escaping (SdkResult<DescribeConfigurationRecordersOutput, DescribeConfigurationRecordersOutputError>) -> Void)
    ...
    /// 				per region in your account.</p>
    /// 		       </note>
    func describeConfigurationRecorderStatus(input: DescribeConfigurationRecorderStatusInput, completion: @escaping (SdkResult<DescribeConfigurationRecorderStatusOutput, DescribeConfigurationRecorderStatusOutputError>) -> Void)
    /// <p>Returns compliance details for each rule in that conformance pack.</p>
    /// 		       <note>
    ///             <p>You must provide exact rule names.</p>
    ///          </note>
    func describeConformancePackCompliance(input: DescribeConformancePackComplianceInput, completion: @escaping (SdkResult<DescribeConformancePackComplianceOutput, DescribeConformancePackComplianceOutputError>) -> Void)
    /// <p>Returns a list of one or more conformance packs.</p>
    func describeConformancePacks(input: DescribeConformancePacksInput, completion: @escaping (SdkResult<DescribeConformancePacksOutput, DescribeConformancePacksOutputError>) -> Void)
    ...
    ///          </note>
    func describeConformancePackStatus(input: DescribeConformancePackStatusInput, completion: @escaping (SdkResult<DescribeConformancePackStatusOutput, DescribeConformancePackStatusOutputError>) -> Void)
    ...
    /// 		       </note>
    func describeDeliveryChannels(input: DescribeDeliveryChannelsInput, completion: @escaping (SdkResult<DescribeDeliveryChannelsOutput, DescribeDeliveryChannelsOutputError>) -> Void)
    ...
    /// 				region in your account.</p>
    /// 		       </note>
    func describeDeliveryChannelStatus(input: DescribeDeliveryChannelStatusInput, completion: @escaping (SdkResult<DescribeDeliveryChannelStatusOutput, DescribeDeliveryChannelStatusOutputError>) -> Void)
    ...
    ///          </note>
    func describeOrganizationConfigRules(input: DescribeOrganizationConfigRulesInput, completion: @escaping (SdkResult<DescribeOrganizationConfigRulesOutput, DescribeOrganizationConfigRulesOutputError>) -> Void)
    ...
    /// 			It is only applicable, when you request all the organization config rules.</p>
    /// 			      </note>
    func describeOrganizationConfigRuleStatuses(input: DescribeOrganizationConfigRuleStatusesInput, completion: @escaping (SdkResult<DescribeOrganizationConfigRuleStatusesOutput, DescribeOrganizationConfigRuleStatusesOutputError>) -> Void)
    ...
    ///          </note>
    func describeOrganizationConformancePacks(input: DescribeOrganizationConformancePacksInput, completion: @escaping (SdkResult<DescribeOrganizationConformancePacksOutput, DescribeOrganizationConformancePacksOutputError>) -> Void)
    ...
    ///          </note>
    func describeOrganizationConformancePackStatuses(input: DescribeOrganizationConformancePackStatusesInput, completion: @escaping (SdkResult<DescribeOrganizationConformancePackStatusesOutput, DescribeOrganizationConformancePackStatusesOutputError>) -> Void)
    /// <p>Returns a list of all pending aggregation requests.</p>
    func describePendingAggregationRequests(input: DescribePendingAggregationRequestsInput, completion: @escaping (SdkResult<DescribePendingAggregationRequestsOutput, DescribePendingAggregationRequestsOutputError>) -> Void)
    /// <p>Returns the details of one or more remediation configurations.</p>
    func describeRemediationConfigurations(input: DescribeRemediationConfigurationsInput, completion: @escaping (SdkResult<DescribeRemediationConfigurationsOutput, DescribeRemediationConfigurationsOutputError>) -> Void)
    ...
    ///          </note>
    func describeRemediationExceptions(input: DescribeRemediationExceptionsInput, completion: @escaping (SdkResult<DescribeRemediationExceptionsOutput, DescribeRemediationExceptionsOutputError>) -> Void)
    ...
    /// 			When you specify the limit and the next token, you receive a paginated response.</p>
    func describeRemediationExecutionStatus(input: DescribeRemediationExecutionStatusInput, completion: @escaping (SdkResult<DescribeRemediationExecutionStatusOutput, DescribeRemediationExecutionStatusOutputError>) -> Void)
    ...
    /// 		       </note>
    func describeRetentionConfigurations(input: DescribeRetentionConfigurationsInput, completion: @escaping (SdkResult<DescribeRetentionConfigurationsOutput, DescribeRetentionConfigurationsOutputError>) -> Void)
    ...
    /// 				page.</p>
    /// 		       </note>
    func getAggregateComplianceDetailsByConfigRule(input: GetAggregateComplianceDetailsByConfigRuleInput, completion: @escaping (SdkResult<GetAggregateComplianceDetailsByConfigRuleOutput, GetAggregateComplianceDetailsByConfigRuleOutputError>) -> Void)
    ...
    /// 				page.</p>
    /// 		       </note>
    func getAggregateConfigRuleComplianceSummary(input: GetAggregateConfigRuleComplianceSummaryInput, completion: @escaping (SdkResult<GetAggregateConfigRuleComplianceSummaryOutput, GetAggregateConfigRuleComplianceSummaryOutputError>) -> Void)
    ...
    ///          </note>
    func getAggregateConformancePackComplianceSummary(input: GetAggregateConformancePackComplianceSummaryInput, completion: @escaping (SdkResult<GetAggregateConformancePackComplianceSummaryOutput, GetAggregateConformancePackComplianceSummaryOutputError>) -> Void)
    ...
    func getAggregateDiscoveredResourceCounts(input: GetAggregateDiscoveredResourceCountsInput, completion: @escaping (SdkResult<GetAggregateDiscoveredResourceCountsOutput, GetAggregateDiscoveredResourceCountsOutputError>) -> Void)
    /// <p>Returns configuration item that is aggregated for your specific resource in a specific source account and region.</p>
    func getAggregateResourceConfig(input: GetAggregateResourceConfigInput, completion: @escaping (SdkResult<GetAggregateResourceConfigOutput, GetAggregateResourceConfigOutputError>) -> Void)
    /// <p>Returns the evaluation results for the specified AWS Config
    /// 			rule. The results indicate which AWS resources were evaluated by the
    /// 			rule, when each resource was last evaluated, and whether each
    /// 			resource complies with the rule.</p>
    func getComplianceDetailsByConfigRule(input: GetComplianceDetailsByConfigRuleInput, completion: @escaping (SdkResult<GetComplianceDetailsByConfigRuleOutput, GetComplianceDetailsByConfigRuleOutputError>) -> Void)
    ...
    func getComplianceDetailsByResource(input: GetComplianceDetailsByResourceInput, completion: @escaping (SdkResult<GetComplianceDetailsByResourceOutput, GetComplianceDetailsByResourceOutputError>) -> Void)
    /// <p>Returns the number of AWS Config rules that are compliant and
    /// 			noncompliant, up to a maximum of 25 for each.</p>
    func getComplianceSummaryByConfigRule(input: GetComplianceSummaryByConfigRuleInput, completion: @escaping (SdkResult<GetComplianceSummaryByConfigRuleOutput, GetComplianceSummaryByConfigRuleOutputError>) -> Void)
    ...
    func getComplianceSummaryByResourceType(input: GetComplianceSummaryByResourceTypeInput, completion: @escaping (SdkResult<GetComplianceSummaryByResourceTypeOutput, GetComplianceSummaryByResourceTypeOutputError>) -> Void)
    /// <p>Returns compliance details of a conformance pack for all AWS resources that are monitered by conformance pack.</p>
    func getConformancePackComplianceDetails(input: GetConformancePackComplianceDetailsInput, completion: @escaping (SdkResult<GetConformancePackComplianceDetailsOutput, GetConformancePackComplianceDetailsOutputError>) -> Void)
    ...
    func getConformancePackComplianceSummary(input: GetConformancePackComplianceSummaryInput, completion: @escaping (SdkResult<GetConformancePackComplianceSummaryOutput, GetConformancePackComplianceSummaryOutputError>) -> Void)
    ...
    /// 			</p>
    /// 		       </note>
    func getDiscoveredResourceCounts(input: GetDiscoveredResourceCountsInput, completion: @escaping (SdkResult<GetDiscoveredResourceCountsOutput, GetDiscoveredResourceCountsOutputError>) -> Void)
    /// <p>Returns detailed status for each member account within an organization for a given organization config rule.</p>
    func getOrganizationConfigRuleDetailedStatus(input: GetOrganizationConfigRuleDetailedStatusInput, completion: @escaping (SdkResult<GetOrganizationConfigRuleDetailedStatusOutput, GetOrganizationConfigRuleDetailedStatusOutputError>) -> Void)
    /// <p>Returns detailed status for each member account within an organization for a given organization conformance pack.</p>
    func getOrganizationConformancePackDetailedStatus(input: GetOrganizationConformancePackDetailedStatusInput, completion: @escaping (SdkResult<GetOrganizationConformancePackDetailedStatusOutput, GetOrganizationConformancePackDetailedStatusOutputError>) -> Void)
    ...
    /// 		       </note>
    func getResourceConfigHistory(input: GetResourceConfigHistoryInput, completion: @escaping (SdkResult<GetResourceConfigHistoryOutput, GetResourceConfigHistoryOutputError>) -> Void)
    /// <p>Returns the details of a specific stored query.</p>
    func getStoredQuery(input: GetStoredQueryInput, completion: @escaping (SdkResult<GetStoredQueryOutput, GetStoredQueryOutputError>) -> Void)
    ...
    func listAggregateDiscoveredResources(input: ListAggregateDiscoveredResourcesInput, completion: @escaping (SdkResult<ListAggregateDiscoveredResourcesOutput, ListAggregateDiscoveredResourcesOutputError>) -> Void)
    ...
    func listStoredQueries(input: ListStoredQueriesInput, completion: @escaping (SdkResult<ListStoredQueriesOutput, ListStoredQueriesOutputError>) -> Void)
    ...
    func putAggregationAuthorization(input: PutAggregationAuthorizationInput, completion: @escaping (SdkResult<PutAggregationAuthorizationOutput, PutAggregationAuthorizationOutputError>) -> Void)
    ...
    func putConfigRule(input: PutConfigRuleInput, completion: @escaping (SdkResult<PutConfigRuleOutput, PutConfigRuleOutputError>) -> Void)
    ...
    /// 		       </note>
    func putConfigurationAggregator(input: PutConfigurationAggregatorInput, completion: @escaping (SdkResult<PutConfigurationAggregatorOutput, PutConfigurationAggregatorOutputError>) -> Void)
    ...
    /// 				types.</p>
    /// 		       </note>
    func putConfigurationRecorder(input: PutConfigurationRecorderInput, completion: @escaping (SdkResult<PutConfigurationRecorderOutput, PutConfigurationRecorderOutputError>) -> Void)
    ...
    ///          </note>
    func putConformancePack(input: PutConformancePackInput, completion: @escaping (SdkResult<PutConformancePackOutput, PutConformancePackOutputError>) -> Void)
    ...
    ///
    /// 		       </note>
    func putDeliveryChannel(input: PutDeliveryChannelInput, completion: @escaping (SdkResult<PutDeliveryChannelOutput, PutDeliveryChannelOutputError>) -> Void)
    ...
    func putEvaluations(input: PutEvaluationsInput, completion: @escaping (SdkResult<PutEvaluationsOutput, PutEvaluationsOutputError>) -> Void)
    ...
    func putExternalEvaluation(input: PutExternalEvaluationInput, completion: @escaping (SdkResult<PutExternalEvaluationOutput, PutExternalEvaluationOutputError>) -> Void)
    ...
    /// 			      </note>
    func putOrganizationConfigRule(input: PutOrganizationConfigRuleInput, completion: @escaping (SdkResult<PutOrganizationConfigRuleOutput, PutOrganizationConfigRuleOutputError>) -> Void)
    ...
    ///          </note>
    func putOrganizationConformancePack(input: PutOrganizationConformancePackInput, completion: @escaping (SdkResult<PutOrganizationConformancePackOutput, PutOrganizationConformancePackOutputError>) -> Void)
    ...
    ///          </note>
    func putRemediationConfigurations(input: PutRemediationConfigurationsInput, completion: @escaping (SdkResult<PutRemediationConfigurationsOutput, PutRemediationConfigurationsOutputError>) -> Void)
    ...
    /// 			Remediation exceptions blocks auto-remediation until the exception is cleared.</p>
    ///          </note>
    func putRemediationExceptions(input: PutRemediationExceptionsInput, completion: @escaping (SdkResult<PutRemediationExceptionsOutput, PutRemediationExceptionsOutputError>) -> Void)
    ...
    ///          </note>
    func putResourceConfig(input: PutResourceConfigInput, completion: @escaping (SdkResult<PutResourceConfigOutput, PutResourceConfigOutputError>) -> Void)
    ...
    /// 				configuration per region in your account.</p>
    /// 		       </note>
    func putRetentionConfiguration(input: PutRetentionConfigurationInput, completion: @escaping (SdkResult<PutRetentionConfigurationOutput, PutRetentionConfigurationOutputError>) -> Void)
    ...
    func putStoredQuery(input: PutStoredQueryInput, completion: @escaping (SdkResult<PutStoredQueryOutput, PutStoredQueryOutputError>) -> Void)
    ...
    func selectAggregateResourceConfig(input: SelectAggregateResourceConfigInput, completion: @escaping (SdkResult<SelectAggregateResourceConfigOutput, SelectAggregateResourceConfigOutputError>) -> Void)
    ...
    ///                <b>Query Components</b>
    ///             </a> section in the AWS Config Developer Guide.</p>
    func selectResourceConfig(input: SelectResourceConfigInput, completion: @escaping (SdkResult<SelectResourceConfigOutput, SelectResourceConfigOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ol>
    func startConfigRulesEvaluation(input: StartConfigRulesEvaluationInput, completion: @escaping (SdkResult<StartConfigRulesEvaluationOutput, StartConfigRulesEvaluationOutputError>) -> Void)
    ...
    func startConfigurationRecorder(input: StartConfigurationRecorderInput, completion: @escaping (SdkResult<StartConfigurationRecorderOutput, StartConfigurationRecorderOutputError>) -> Void)
    ...
    func startRemediationExecution(input: StartRemediationExecutionInput, completion: @escaping (SdkResult<StartRemediationExecutionOutput, StartRemediationExecutionOutputError>) -> Void)
    /// <p>Stops recording configurations of the AWS resources you have selected to record in your AWS account.</p>
    func stopConfigurationRecorder(input: StopConfigurationRecorderInput, completion: @escaping (SdkResult<StopConfigurationRecorderOutput, StopConfigurationRecorderOutputError>) -> Void)
