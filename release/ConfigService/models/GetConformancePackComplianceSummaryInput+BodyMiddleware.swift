...
public struct GetConformancePackComplianceSummaryInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetConformancePackComplianceSummaryOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetConformancePackComplianceSummaryOutput>
