...
public struct SelectAggregateResourceConfigInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<SelectAggregateResourceConfigOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<SelectAggregateResourceConfigOutput>
