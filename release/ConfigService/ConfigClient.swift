...
public class ConfigClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try ConfigClientConfiguration(region: unwrappedRegion)
    ...
    public class ConfigClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("ConfigClient")
