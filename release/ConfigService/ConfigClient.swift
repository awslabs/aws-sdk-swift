...
public class ConfigClient {
    ...
    let config: ConfigClientConfiguration
    let serviceName = "Config"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: ConfigClientConfiguration) {
    ...
    public class ConfigClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "ConfigClient")
        }
        ...
        public static func `default`() throws -> ConfigClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try ConfigClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}

public struct ConfigClientLogHandlerFactory: SDKLogHandlerFactory {
