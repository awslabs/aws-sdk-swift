...
public enum AddTagsToStreamOutputError: Swift.Error, Equatable {
...
public enum DecreaseStreamRetentionPeriodOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
...
public enum DeregisterStreamConsumerOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceNotFoundException(ResourceNotFoundException)
    case unknown(UnknownAWSHttpServiceError)
...
public enum DescribeLimitsOutputError: Swift.Error, Equatable {
    case limitExceededException(LimitExceededException)
    case unknown(UnknownAWSHttpServiceError)
}
...
public enum DescribeStreamConsumerOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceNotFoundException(ResourceNotFoundException)
    case unknown(UnknownAWSHttpServiceError)
...
public enum DescribeStreamSummaryOutputError: Swift.Error, Equatable {
    case limitExceededException(LimitExceededException)
    case resourceNotFoundException(ResourceNotFoundException)
    case unknown(UnknownAWSHttpServiceError)
}
...
public enum DisableEnhancedMonitoringOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
...
public enum EnableEnhancedMonitoringOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
...
public enum IncreaseStreamRetentionPeriodOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
...
public enum ListShardsOutputError: Swift.Error, Equatable {
...
public enum ListStreamConsumersOutputError: Swift.Error, Equatable {
    case expiredNextTokenException(ExpiredNextTokenException)
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
...
public enum MergeShardsOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
...
public enum PutRecordsOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case kMSAccessDeniedException(KMSAccessDeniedException)
    case kMSDisabledException(KMSDisabledException)
    case kMSInvalidStateException(KMSInvalidStateException)
...
public enum RegisterStreamConsumerOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
...
public enum RemoveTagsFromStreamOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
...
public enum SplitShardOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
...
public enum StartStreamEncryptionOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case kMSAccessDeniedException(KMSAccessDeniedException)
    case kMSDisabledException(KMSDisabledException)
    case kMSInvalidStateException(KMSInvalidStateException)
...
public enum StopStreamEncryptionOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
...
public enum SubscribeToShardEventStream: Equatable {
    ...
    /// <p>The resource is not available for this operation. For successful operation, the
    ///             resource must be in the <code>ACTIVE</code> state.</p>
    case resourceinuseexception(ClientRuntime.ResourceInUseException)
    /// <p>The request was rejected because the specified customer master key (CMK) isn't
    ///             enabled.</p>
    case kmsdisabledexception(ClientRuntime.KMSDisabledException)
    /// <p>The request was rejected because the state of the specified resource isn't valid
    ///             for this request. For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">How Key State Affects Use of a
    ///                 Customer Master Key</a> in the <i>AWS Key Management Service Developer
    ///                 Guide</i>.</p>
    case kmsinvalidstateexception(ClientRuntime.KMSInvalidStateException)
    /// <p>The ciphertext references a key that doesn't exist or that you don't have access
    ///             to.</p>
    case kmsaccessdeniedexception(ClientRuntime.KMSAccessDeniedException)
    /// <p>The request was rejected because the specified entity or resource can't be
    ///             found.</p>
    case kmsnotfoundexception(ClientRuntime.KMSNotFoundException)
    /// <p>The AWS access key ID needs a subscription for the service.</p>
    case kmsoptinrequired(ClientRuntime.KMSOptInRequired)
    /// <p>The request was denied due to request throttling. For more information about
    ///             throttling, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/limits.html#requests-per-second">Limits</a> in
    ///             the <i>AWS Key Management Service Developer Guide</i>.</p>
    case kmsthrottlingexception(ClientRuntime.KMSThrottlingException)
    /// <p>The processing of the request failed because of an unknown error, exception, or
    ///             failure.</p>
    case internalfailureexception(ClientRuntime.InternalFailureException)
    case sdkUnknown(String)
}
...
public enum SubscribeToShardOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
...
public enum UpdateShardCountOutputError: Swift.Error, Equatable {
    case invalidArgumentException(InvalidArgumentException)
    case limitExceededException(LimitExceededException)
    case resourceInUseException(ResourceInUseException)
    case resourceNotFoundException(ResourceNotFoundException)
