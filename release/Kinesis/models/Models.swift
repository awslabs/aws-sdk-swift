...
extension KinesisClientTypes.InternalFailureException: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case message
    }
...
extension KinesisClientTypes.InternalFailureException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension KinesisClientTypes.SubscribeToShardEventStream: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let internalfailureexceptionDecoded = try values.decodeIfPresent(KinesisClientTypes.InternalFailureException.self, forKey: .internalfailureexception)
...
extension KinesisClientTypes {
    ...
    public enum SubscribeToShardEventStream: Swift.Equatable {
        ...
        /// <p>The processing of the request failed because of an unknown error, exception, or
        ///             failure.</p>
        case internalfailureexception(KinesisClientTypes.InternalFailureException)
        case sdkUnknown(Swift.String)
    }
