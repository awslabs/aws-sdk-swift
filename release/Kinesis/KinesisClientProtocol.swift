...
public protocol KinesisClientProtocol {
    ...
    ///             account.</p>
    func addTagsToStream(input: AddTagsToStreamInput, completion: @escaping (SdkResult<AddTagsToStreamOutput, AddTagsToStreamOutputError>) -> Void)
    ...
    ///             account.</p>
    func createStream(input: CreateStreamInput, completion: @escaping (SdkResult<CreateStreamOutput, CreateStreamOutputError>) -> Void)
    ...
    func decreaseStreamRetentionPeriod(input: DecreaseStreamRetentionPeriodInput, completion: @escaping (SdkResult<DecreaseStreamRetentionPeriodOutput, DecreaseStreamRetentionPeriodOutputError>) -> Void)
    ...
    ///             account.</p>
    func deleteStream(input: DeleteStreamInput, completion: @escaping (SdkResult<DeleteStreamOutput, DeleteStreamOutputError>) -> Void)
    ...
    func deregisterStreamConsumer(input: DeregisterStreamConsumerInput, completion: @escaping (SdkResult<DeregisterStreamConsumerOutput, DeregisterStreamConsumerOutputError>) -> Void)
    ...
    func describeLimits(input: DescribeLimitsInput, completion: @escaping (SdkResult<DescribeLimitsOutput, DescribeLimitsOutputError>) -> Void)
    ...
    func describeStreamConsumer(input: DescribeStreamConsumerInput, completion: @escaping (SdkResult<DescribeStreamConsumerOutput, DescribeStreamConsumerOutputError>) -> Void)
    ...
    ///             per account.</p>
    func describeStreamSummary(input: DescribeStreamSummaryInput, completion: @escaping (SdkResult<DescribeStreamSummaryOutput, DescribeStreamSummaryOutputError>) -> Void)
    /// <p>Disables enhanced monitoring.</p>
    func disableEnhancedMonitoring(input: DisableEnhancedMonitoringInput, completion: @escaping (SdkResult<DisableEnhancedMonitoringOutput, DisableEnhancedMonitoringOutputError>) -> Void)
    /// <p>Enables enhanced Kinesis data stream monitoring for shard-level metrics.</p>
    func enableEnhancedMonitoring(input: EnableEnhancedMonitoringInput, completion: @escaping (SdkResult<EnableEnhancedMonitoringOutput, EnableEnhancedMonitoringOutputError>) -> Void)
    ...
    func increaseStreamRetentionPeriod(input: IncreaseStreamRetentionPeriodInput, completion: @escaping (SdkResult<IncreaseStreamRetentionPeriodOutput, IncreaseStreamRetentionPeriodOutputError>) -> Void)
    ...
    ///                 IAM</a>.</p>
    ///         </important>
    func listShards(input: ListShardsInput, completion: @escaping (SdkResult<ListShardsOutput, ListShardsOutputError>) -> Void)
    ...
    func listStreamConsumers(input: ListStreamConsumersInput, completion: @escaping (SdkResult<ListStreamConsumersOutput, ListStreamConsumersOutputError>) -> Void)
    ...
    func listTagsForStream(input: ListTagsForStreamInput, completion: @escaping (SdkResult<ListTagsForStreamOutput, ListTagsForStreamOutputError>) -> Void)
    ...
    ///             account.</p>
    func mergeShards(input: MergeShardsInput, completion: @escaping (SdkResult<MergeShardsOutput, MergeShardsOutputError>) -> Void)
    ...
    func putRecord(input: PutRecordInput, completion: @escaping (SdkResult<PutRecordOutput, PutRecordOutputError>) -> Void)
    ...
    ///         <p>By default, data records are accessible for 24 hours from the time that they are
    ///             added to a stream. You can use <a>IncreaseStreamRetentionPeriod</a> or <a>DecreaseStreamRetentionPeriod</a> to modify this retention period.</p>
    func putRecords(input: PutRecordsInput, completion: @escaping (SdkResult<PutRecordsOutput, PutRecordsOutputError>) -> Void)
    ...
    func registerStreamConsumer(input: RegisterStreamConsumerInput, completion: @escaping (SdkResult<RegisterStreamConsumerOutput, RegisterStreamConsumerOutputError>) -> Void)
    ...
    ///             account.</p>
    func removeTagsFromStream(input: RemoveTagsFromStreamInput, completion: @escaping (SdkResult<RemoveTagsFromStreamOutput, RemoveTagsFromStreamOutputError>) -> Void)
    ...
    ///             account.</p>
    func splitShard(input: SplitShardInput, completion: @escaping (SdkResult<SplitShardOutput, SplitShardOutputError>) -> Void)
    ...
    func startStreamEncryption(input: StartStreamEncryptionInput, completion: @escaping (SdkResult<StartStreamEncryptionOutput, StartStreamEncryptionOutputError>) -> Void)
    ...
    func stopStreamEncryption(input: StopStreamEncryptionInput, completion: @escaping (SdkResult<StopStreamEncryptionOutput, StopStreamEncryptionOutputError>) -> Void)
    ...
    ///         <p>For an example of how to use this operations, see <a href="/streams/latest/dev/building-enhanced-consumers-api.html">Enhanced Fan-Out
    ///                 Using the Kinesis Data Streams API</a>.</p>
    func subscribeToShard(input: SubscribeToShardInput, streamSink: StreamSink, completion: @escaping (SdkResult<SubscribeToShardOutput, SubscribeToShardOutputError>) -> Void)
    ...
    func updateShardCount(input: UpdateShardCountInput, completion: @escaping (SdkResult<UpdateShardCountOutput, UpdateShardCountOutputError>) -> Void)
}
