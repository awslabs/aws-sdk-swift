...
public protocol KinesisClientProtocol {
    ...
    ///             account.</p>
    func addTagsToStream(input: AddTagsToStreamInput, completion: @escaping (SdkResult<AddTagsToStreamOutputResponse, AddTagsToStreamOutputError>) -> Void)
    ...
    func decreaseStreamRetentionPeriod(input: DecreaseStreamRetentionPeriodInput, completion: @escaping (SdkResult<DecreaseStreamRetentionPeriodOutputResponse, DecreaseStreamRetentionPeriodOutputError>) -> Void)
    ...
    func deregisterStreamConsumer(input: DeregisterStreamConsumerInput, completion: @escaping (SdkResult<DeregisterStreamConsumerOutputResponse, DeregisterStreamConsumerOutputError>) -> Void)
    ...
    func describeLimits(input: DescribeLimitsInput, completion: @escaping (SdkResult<DescribeLimitsOutputResponse, DescribeLimitsOutputError>) -> Void)
    ...
    func describeStreamConsumer(input: DescribeStreamConsumerInput, completion: @escaping (SdkResult<DescribeStreamConsumerOutputResponse, DescribeStreamConsumerOutputError>) -> Void)
    ...
    ///             per account.</p>
    func describeStreamSummary(input: DescribeStreamSummaryInput, completion: @escaping (SdkResult<DescribeStreamSummaryOutputResponse, DescribeStreamSummaryOutputError>) -> Void)
    /// <p>Disables enhanced monitoring.</p>
    func disableEnhancedMonitoring(input: DisableEnhancedMonitoringInput, completion: @escaping (SdkResult<DisableEnhancedMonitoringOutputResponse, DisableEnhancedMonitoringOutputError>) -> Void)
    /// <p>Enables enhanced Kinesis data stream monitoring for shard-level metrics.</p>
    func enableEnhancedMonitoring(input: EnableEnhancedMonitoringInput, completion: @escaping (SdkResult<EnableEnhancedMonitoringOutputResponse, EnableEnhancedMonitoringOutputError>) -> Void)
    ...
    func increaseStreamRetentionPeriod(input: IncreaseStreamRetentionPeriodInput, completion: @escaping (SdkResult<IncreaseStreamRetentionPeriodOutputResponse, IncreaseStreamRetentionPeriodOutputError>) -> Void)
    ...
    ///                 IAM</a>.</p>
    ///         </important>
    func listShards(input: ListShardsInput, completion: @escaping (SdkResult<ListShardsOutputResponse, ListShardsOutputError>) -> Void)
    ...
    func listStreamConsumers(input: ListStreamConsumersInput, completion: @escaping (SdkResult<ListStreamConsumersOutputResponse, ListStreamConsumersOutputError>) -> Void)
    ...
    func listTagsForStream(input: ListTagsForStreamInput, completion: @escaping (SdkResult<ListTagsForStreamOutputResponse, ListTagsForStreamOutputError>) -> Void)
    ...
    ///             account.</p>
    func mergeShards(input: MergeShardsInput, completion: @escaping (SdkResult<MergeShardsOutputResponse, MergeShardsOutputError>) -> Void)
    ...
    ///         <p>By default, data records are accessible for 24 hours from the time that they are
    ///             added to a stream. You can use <a>IncreaseStreamRetentionPeriod</a> or <a>DecreaseStreamRetentionPeriod</a> to modify this retention period.</p>
    func putRecords(input: PutRecordsInput, completion: @escaping (SdkResult<PutRecordsOutputResponse, PutRecordsOutputError>) -> Void)
    ...
    func registerStreamConsumer(input: RegisterStreamConsumerInput, completion: @escaping (SdkResult<RegisterStreamConsumerOutputResponse, RegisterStreamConsumerOutputError>) -> Void)
    ...
    ///             account.</p>
    func removeTagsFromStream(input: RemoveTagsFromStreamInput, completion: @escaping (SdkResult<RemoveTagsFromStreamOutputResponse, RemoveTagsFromStreamOutputError>) -> Void)
    ...
    ///             account.</p>
    func splitShard(input: SplitShardInput, completion: @escaping (SdkResult<SplitShardOutputResponse, SplitShardOutputError>) -> Void)
    ...
    func startStreamEncryption(input: StartStreamEncryptionInput, completion: @escaping (SdkResult<StartStreamEncryptionOutputResponse, StartStreamEncryptionOutputError>) -> Void)
    ...
    func stopStreamEncryption(input: StopStreamEncryptionInput, completion: @escaping (SdkResult<StopStreamEncryptionOutputResponse, StopStreamEncryptionOutputError>) -> Void)
    ...
    ///         <p>For an example of how to use this operations, see <a href="/streams/latest/dev/building-enhanced-consumers-api.html">Enhanced Fan-Out
    ///                 Using the Kinesis Data Streams API</a>.</p>
    func subscribeToShard(input: SubscribeToShardInput, streamSink: StreamSink, completion: @escaping (SdkResult<SubscribeToShardOutputResponse, SubscribeToShardOutputError>) -> Void)
    ...
    func updateShardCount(input: UpdateShardCountInput, completion: @escaping (SdkResult<UpdateShardCountOutputResponse, UpdateShardCountOutputError>) -> Void)
}
