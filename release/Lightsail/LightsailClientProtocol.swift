...
public protocol LightsailClientProtocol {
    ...
    func allocateStaticIp(input: AllocateStaticIpInput, completion: @escaping (SdkResult<AllocateStaticIpOutput, AllocateStaticIpOutputError>) -> Void)
    ...
    ///          </important>
    func attachCertificateToDistribution(input: AttachCertificateToDistributionInput, completion: @escaping (SdkResult<AttachCertificateToDistributionOutput, AttachCertificateToDistributionOutputError>) -> Void)
    ...
    func attachDisk(input: AttachDiskInput, completion: @escaping (SdkResult<AttachDiskOutput, AttachDiskOutputError>) -> Void)
    ...
    func attachInstancesToLoadBalancer(input: AttachInstancesToLoadBalancerInput, completion: @escaping (SdkResult<AttachInstancesToLoadBalancerOutput, AttachInstancesToLoadBalancerOutputError>) -> Void)
    ...
    ///       control via resource tags applied to the resource identified by <code>load balancer
    ///         name</code>. For more information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func attachLoadBalancerTlsCertificate(input: AttachLoadBalancerTlsCertificateInput, completion: @escaping (SdkResult<AttachLoadBalancerTlsCertificateOutput, AttachLoadBalancerTlsCertificateOutputError>) -> Void)
    /// <p>Attaches a static IP address to a specific Amazon Lightsail instance.</p>
    func attachStaticIp(input: AttachStaticIpInput, completion: @escaping (SdkResult<AttachStaticIpOutput, AttachStaticIpOutputError>) -> Void)
    ...
    func closeInstancePublicPorts(input: CloseInstancePublicPortsInput, completion: @escaping (SdkResult<CloseInstancePublicPortsOutput, CloseInstancePublicPortsOutputError>) -> Void)
    ...
    ///         distributions are located in the <code>us-east-1</code> Region.</p>
    ///          </important>
    func createCertificate(input: CreateCertificateInput, completion: @escaping (SdkResult<CreateCertificateOutput, CreateCertificateOutputError>) -> Void)
    ...
    ///          </important>
    func createCloudFormationStack(input: CreateCloudFormationStackInput, completion: @escaping (SdkResult<CreateCloudFormationStackOutput, CreateCloudFormationStackOutputError>) -> Void)
    ...
    func createContactMethod(input: CreateContactMethodInput, completion: @escaping (SdkResult<CreateContactMethodOutput, CreateContactMethodOutputError>) -> Void)
    ...
    ///         Guide</i>.</p>
    func createContainerService(input: CreateContainerServiceInput, completion: @escaping (SdkResult<CreateContainerServiceOutput, CreateContainerServiceOutputError>) -> Void)
    ...
    func createContainerServiceDeployment(input: CreateContainerServiceDeploymentInput, completion: @escaping (SdkResult<CreateContainerServiceDeploymentOutput, CreateContainerServiceDeploymentOutputError>) -> Void)
    ...
    ///          </note>
    func createContainerServiceRegistryLogin(input: CreateContainerServiceRegistryLoginInput, completion: @escaping (SdkResult<CreateContainerServiceRegistryLoginOutput, CreateContainerServiceRegistryLoginOutputError>) -> Void)
    ...
    func createDisk(input: CreateDiskInput, completion: @escaping (SdkResult<CreateDiskOutput, CreateDiskOutputError>) -> Void)
    ...
    ///         name</code>. For more information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func createDiskFromSnapshot(input: CreateDiskFromSnapshotInput, completion: @escaping (SdkResult<CreateDiskFromSnapshotOutput, CreateDiskFromSnapshotOutputError>) -> Void)
    ...
    func createDiskSnapshot(input: CreateDiskSnapshotInput, completion: @escaping (SdkResult<CreateDiskSnapshotOutput, CreateDiskSnapshotOutputError>) -> Void)
    ...
    func createDistribution(input: CreateDistributionInput, completion: @escaping (SdkResult<CreateDistributionOutput, CreateDistributionOutputError>) -> Void)
    ...
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func createDomainEntry(input: CreateDomainEntryInput, completion: @escaping (SdkResult<CreateDomainEntryOutput, CreateDomainEntryOutputError>) -> Void)
    ...
    ///       tags. For more information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func createInstances(input: CreateInstancesInput, completion: @escaping (SdkResult<CreateInstancesOutput, CreateInstancesOutputError>) -> Void)
    ...
    func createInstancesFromSnapshot(input: CreateInstancesFromSnapshotInput, completion: @escaping (SdkResult<CreateInstancesFromSnapshotOutput, CreateInstancesFromSnapshotOutputError>) -> Void)
    ...
    ///       request tags. For more information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func createInstanceSnapshot(input: CreateInstanceSnapshotInput, completion: @escaping (SdkResult<CreateInstanceSnapshotOutput, CreateInstanceSnapshotOutputError>) -> Void)
    ...
    ///       control via resource tags applied to the resource identified by <code>load balancer
    ///         name</code>. For more information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func createLoadBalancerTlsCertificate(input: CreateLoadBalancerTlsCertificateInput, completion: @escaping (SdkResult<CreateLoadBalancerTlsCertificateOutput, CreateLoadBalancerTlsCertificateOutputError>) -> Void)
    ...
    func createRelationalDatabase(input: CreateRelationalDatabaseInput, completion: @escaping (SdkResult<CreateRelationalDatabaseOutput, CreateRelationalDatabaseOutputError>) -> Void)
    ...
    func createRelationalDatabaseFromSnapshot(input: CreateRelationalDatabaseFromSnapshotInput, completion: @escaping (SdkResult<CreateRelationalDatabaseFromSnapshotOutput, CreateRelationalDatabaseFromSnapshotOutputError>) -> Void)
    ...
    func createRelationalDatabaseSnapshot(input: CreateRelationalDatabaseSnapshotInput, completion: @escaping (SdkResult<CreateRelationalDatabaseSnapshotOutput, CreateRelationalDatabaseSnapshotOutputError>) -> Void)
    ...
    func deleteAlarm(input: DeleteAlarmInput, completion: @escaping (SdkResult<DeleteAlarmOutput, DeleteAlarmOutputError>) -> Void)
    ...
    func deleteAutoSnapshot(input: DeleteAutoSnapshotInput, completion: @escaping (SdkResult<DeleteAutoSnapshotOutput, DeleteAutoSnapshotOutputError>) -> Void)
    ...
    ///       However, SMS text messaging is not supported in some AWS Regions, and SMS text messages
    ///       cannot be sent to some countries/regions. For more information, see <a href="https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-notifications">Notifications in Amazon Lightsail</a>.</p>
    func deleteContactMethod(input: DeleteContactMethodInput, completion: @escaping (SdkResult<DeleteContactMethodOutput, DeleteContactMethodOutputError>) -> Void)
    /// <p>Deletes a container image that is registered to your Amazon Lightsail container
    ///       service.</p>
    func deleteContainerImage(input: DeleteContainerImageInput, completion: @escaping (SdkResult<DeleteContainerImageOutput, DeleteContainerImageOutputError>) -> Void)
    /// <p>Deletes your Amazon Lightsail container service.</p>
    func deleteContainerService(input: DeleteContainerServiceInput, completion: @escaping (SdkResult<DeleteContainerServiceOutput, DeleteContainerServiceOutputError>) -> Void)
    ...
    ///       applied to the resource identified by <code>disk name</code>. For more information, see the
    ///         <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func deleteDisk(input: DeleteDiskInput, completion: @escaping (SdkResult<DeleteDiskOutput, DeleteDiskOutputError>) -> Void)
    ...
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func deleteDiskSnapshot(input: DeleteDiskSnapshotInput, completion: @escaping (SdkResult<DeleteDiskSnapshotOutput, DeleteDiskSnapshotOutputError>) -> Void)
    /// <p>Deletes your Amazon Lightsail content delivery network (CDN) distribution.</p>
    func deleteDistribution(input: DeleteDistributionInput, completion: @escaping (SdkResult<DeleteDistributionOutput, DeleteDistributionOutputError>) -> Void)
    ...
    ///       resource tags applied to the resource identified by <code>domain name</code>. For more
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func deleteDomainEntry(input: DeleteDomainEntryInput, completion: @escaping (SdkResult<DeleteDomainEntryOutput, DeleteDomainEntryOutputError>) -> Void)
    ...
    func deleteInstanceSnapshot(input: DeleteInstanceSnapshotInput, completion: @escaping (SdkResult<DeleteInstanceSnapshotOutput, DeleteInstanceSnapshotOutputError>) -> Void)
    ...
    ///           client</a>.</p>
    ///          </important>
    func deleteKnownHostKeys(input: DeleteKnownHostKeysInput, completion: @escaping (SdkResult<DeleteKnownHostKeysOutput, DeleteKnownHostKeysOutputError>) -> Void)
    ...
    ///       control via resource tags applied to the resource identified by <code>load balancer
    ///         name</code>. For more information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func deleteLoadBalancerTlsCertificate(input: DeleteLoadBalancerTlsCertificateInput, completion: @escaping (SdkResult<DeleteLoadBalancerTlsCertificateOutput, DeleteLoadBalancerTlsCertificateOutputError>) -> Void)
    ...
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func deleteRelationalDatabase(input: DeleteRelationalDatabaseInput, completion: @escaping (SdkResult<DeleteRelationalDatabaseOutput, DeleteRelationalDatabaseOutputError>) -> Void)
    ...
    ///       more information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func deleteRelationalDatabaseSnapshot(input: DeleteRelationalDatabaseSnapshotInput, completion: @escaping (SdkResult<DeleteRelationalDatabaseSnapshotOutput, DeleteRelationalDatabaseSnapshotOutputError>) -> Void)
    ...
    func detachCertificateFromDistribution(input: DetachCertificateFromDistributionInput, completion: @escaping (SdkResult<DetachCertificateFromDistributionOutput, DetachCertificateFromDistributionOutputError>) -> Void)
    ...
    ///       applied to the resource identified by <code>disk name</code>. For more information, see the
    ///         <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func detachDisk(input: DetachDiskInput, completion: @escaping (SdkResult<DetachDiskOutput, DetachDiskOutputError>) -> Void)
    ...
    ///       control via resource tags applied to the resource identified by <code>load balancer
    ///         name</code>. For more information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func detachInstancesFromLoadBalancer(input: DetachInstancesFromLoadBalancerInput, completion: @escaping (SdkResult<DetachInstancesFromLoadBalancerOutput, DetachInstancesFromLoadBalancerOutputError>) -> Void)
    /// <p>Detaches a static IP from the Amazon Lightsail instance to which it is attached.</p>
    func detachStaticIp(input: DetachStaticIpInput, completion: @escaping (SdkResult<DetachStaticIpOutput, DetachStaticIpOutputError>) -> Void)
    ...
    func disableAddOn(input: DisableAddOnInput, completion: @escaping (SdkResult<DisableAddOnOutput, DisableAddOnOutputError>) -> Void)
    /// <p>Downloads the default SSH key pair from the user's account.</p>
    func downloadDefaultKeyPair(input: DownloadDefaultKeyPairInput, completion: @escaping (SdkResult<DownloadDefaultKeyPairOutput, DownloadDefaultKeyPairOutputError>) -> Void)
    ...
    func enableAddOn(input: EnableAddOnInput, completion: @escaping (SdkResult<EnableAddOnOutput, EnableAddOnOutputError>) -> Void)
    ...
    ///          </note>
    func exportSnapshot(input: ExportSnapshotInput, completion: @escaping (SdkResult<ExportSnapshotOutput, ExportSnapshotOutputError>) -> Void)
    /// <p>Returns the names of all active (not deleted) resources.</p>
    func getActiveNames(input: GetActiveNamesInput, completion: @escaping (SdkResult<GetActiveNamesOutput, GetActiveNamesOutputError>) -> Void)
    ...
    ///       on the Amazon Lightsail console. For more information, see <a href="https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-alarms">Alarms
    ///         in Amazon Lightsail</a>.</p>
    func getAlarms(input: GetAlarmsInput, completion: @escaping (SdkResult<GetAlarmsOutput, GetAlarmsOutputError>) -> Void)
    ...
    func getAutoSnapshots(input: GetAutoSnapshotsInput, completion: @escaping (SdkResult<GetAutoSnapshotsOutput, GetAutoSnapshotsOutputError>) -> Void)
    ...
    ///          </note>
    func getBlueprints(input: GetBlueprintsInput, completion: @escaping (SdkResult<GetBlueprintsOutput, GetBlueprintsOutputError>) -> Void)
    ...
    func getBundles(input: GetBundlesInput, completion: @escaping (SdkResult<GetBundlesOutput, GetBundlesOutputError>) -> Void)
    ...
    ///          </note>
    func getCertificates(input: GetCertificatesInput, completion: @escaping (SdkResult<GetCertificatesOutput, GetCertificatesOutputError>) -> Void)
    ...
    ///       snapshot.</p>
    func getCloudFormationStackRecords(input: GetCloudFormationStackRecordsInput, completion: @escaping (SdkResult<GetCloudFormationStackRecordsOutput, GetCloudFormationStackRecordsOutputError>) -> Void)
    ...
    ///       However, SMS text messaging is not supported in some AWS Regions, and SMS text messages
    ///       cannot be sent to some countries/regions. For more information, see <a href="https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-notifications">Notifications in Amazon Lightsail</a>.</p>
    func getContactMethods(input: GetContactMethodsInput, completion: @escaping (SdkResult<GetContactMethodsOutput, GetContactMethodsOutputError>) -> Void)
    ...
    func getContainerAPIMetadata(input: GetContainerAPIMetadataInput, completion: @escaping (SdkResult<GetContainerAPIMetadataOutput, GetContainerAPIMetadataOutputError>) -> Void)
    ...
    ///          </note>
    func getContainerImages(input: GetContainerImagesInput, completion: @escaping (SdkResult<GetContainerImagesOutput, GetContainerImagesOutputError>) -> Void)
    ...
    ///          </note>
    func getContainerLog(input: GetContainerLogInput, completion: @escaping (SdkResult<GetContainerLogOutput, GetContainerLogOutputError>) -> Void)
    ...
    ///           endpoints and quotas</a> in the <i>AWS General Reference</i>.</p>
    ///          </note>
    func getContainerServiceDeployments(input: GetContainerServiceDeploymentsInput, completion: @escaping (SdkResult<GetContainerServiceDeploymentsOutput, GetContainerServiceDeploymentsOutputError>) -> Void)
    ...
    func getContainerServiceMetricData(input: GetContainerServiceMetricDataInput, completion: @escaping (SdkResult<GetContainerServiceMetricDataOutput, GetContainerServiceMetricDataOutputError>) -> Void)
    ...
    ///       container service.</p>
    func getContainerServicePowers(input: GetContainerServicePowersInput, completion: @escaping (SdkResult<GetContainerServicePowersOutput, GetContainerServicePowersOutputError>) -> Void)
    /// <p>Returns information about one or more of your Amazon Lightsail container services.</p>
    func getContainerServices(input: GetContainerServicesInput, completion: @escaping (SdkResult<GetContainerServicesOutput, GetContainerServicesOutputError>) -> Void)
    /// <p>Returns information about a specific block storage disk.</p>
    func getDisk(input: GetDiskInput, completion: @escaping (SdkResult<GetDiskOutput, GetDiskOutputError>) -> Void)
    /// <p>Returns information about all block storage disks in your AWS account and region.</p>
    func getDisks(input: GetDisksInput, completion: @escaping (SdkResult<GetDisksOutput, GetDisksOutputError>) -> Void)
    /// <p>Returns information about a specific block storage disk snapshot.</p>
    func getDiskSnapshot(input: GetDiskSnapshotInput, completion: @escaping (SdkResult<GetDiskSnapshotOutput, GetDiskSnapshotOutputError>) -> Void)
    /// <p>Returns information about all block storage disk snapshots in your AWS account and
    ///       region.</p>
    func getDiskSnapshots(input: GetDiskSnapshotsInput, completion: @escaping (SdkResult<GetDiskSnapshotsOutput, GetDiskSnapshotsOutputError>) -> Void)
    ...
    ///       your dsitribution.</p>
    func getDistributionBundles(input: GetDistributionBundlesInput, completion: @escaping (SdkResult<GetDistributionBundlesOutput, GetDistributionBundlesOutputError>) -> Void)
    ...
    func getDistributionLatestCacheReset(input: GetDistributionLatestCacheResetInput, completion: @escaping (SdkResult<GetDistributionLatestCacheResetOutput, GetDistributionLatestCacheResetOutputError>) -> Void)
    ...
    func getDistributionMetricData(input: GetDistributionMetricDataInput, completion: @escaping (SdkResult<GetDistributionMetricDataOutput, GetDistributionMetricDataOutputError>) -> Void)
    /// <p>Returns information about one or more of your Amazon Lightsail content delivery network
    ///       (CDN) distributions.</p>
    func getDistributions(input: GetDistributionsInput, completion: @escaping (SdkResult<GetDistributionsOutput, GetDistributionsOutputError>) -> Void)
    ...
    func getDomains(input: GetDomainsInput, completion: @escaping (SdkResult<GetDomainsOutput, GetDomainsOutputError>) -> Void)
    ...
    func getExportSnapshotRecords(input: GetExportSnapshotRecordsInput, completion: @escaping (SdkResult<GetExportSnapshotRecordsOutput, GetExportSnapshotRecordsOutputError>) -> Void)
    ...
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func getInstanceAccessDetails(input: GetInstanceAccessDetailsInput, completion: @escaping (SdkResult<GetInstanceAccessDetailsOutput, GetInstanceAccessDetailsOutputError>) -> Void)
    /// <p>Returns the data points for the specified Amazon Lightsail instance metric, given an
    ///       instance name.</p>
    ///          <p>Metrics report the utilization of your resources, and the error counts generated by them.
    ///       Monitor and collect metric data regularly to maintain the reliability, availability, and
    ///       performance of your resources.</p>
    func getInstanceMetricData(input: GetInstanceMetricDataInput, completion: @escaping (SdkResult<GetInstanceMetricDataOutput, GetInstanceMetricDataOutputError>) -> Void)
    ...
    func getInstancePortStates(input: GetInstancePortStatesInput, completion: @escaping (SdkResult<GetInstancePortStatesOutput, GetInstancePortStatesOutputError>) -> Void)
    /// <p>Returns information about all Amazon Lightsail virtual private servers, or
    ///         <i>instances</i>.</p>
    func getInstances(input: GetInstancesInput, completion: @escaping (SdkResult<GetInstancesOutput, GetInstancesOutputError>) -> Void)
    /// <p>Returns information about a specific instance snapshot.</p>
    func getInstanceSnapshot(input: GetInstanceSnapshotInput, completion: @escaping (SdkResult<GetInstanceSnapshotOutput, GetInstanceSnapshotOutputError>) -> Void)
    /// <p>Returns all instance snapshots for the user's account.</p>
    func getInstanceSnapshots(input: GetInstanceSnapshotsInput, completion: @escaping (SdkResult<GetInstanceSnapshotsOutput, GetInstanceSnapshotsOutputError>) -> Void)
    /// <p>Returns the state of a specific instance. Works on one instance at a time.</p>
    func getInstanceState(input: GetInstanceStateInput, completion: @escaping (SdkResult<GetInstanceStateOutput, GetInstanceStateOutputError>) -> Void)
    /// <p>Returns information about a specific key pair.</p>
    func getKeyPair(input: GetKeyPairInput, completion: @escaping (SdkResult<GetKeyPairOutput, GetKeyPairOutputError>) -> Void)
    /// <p>Returns information about all key pairs in the user's account.</p>
    func getKeyPairs(input: GetKeyPairsInput, completion: @escaping (SdkResult<GetKeyPairsOutput, GetKeyPairsOutputError>) -> Void)
    /// <p>Returns information about the specified Lightsail load balancer.</p>
    func getLoadBalancer(input: GetLoadBalancerInput, completion: @escaping (SdkResult<GetLoadBalancerOutput, GetLoadBalancerOutputError>) -> Void)
    /// <p>Returns information about health metrics for your Lightsail load balancer.</p>
    ///          <p>Metrics report the utilization of your resources, and the error counts generated by them.
    ///       Monitor and collect metric data regularly to maintain the reliability, availability, and
    ///       performance of your resources.</p>
    func getLoadBalancerMetricData(input: GetLoadBalancerMetricDataInput, completion: @escaping (SdkResult<GetLoadBalancerMetricDataOutput, GetLoadBalancerMetricDataOutputError>) -> Void)
    /// <p>Returns information about all load balancers in an account.</p>
    func getLoadBalancers(input: GetLoadBalancersInput, completion: @escaping (SdkResult<GetLoadBalancersOutput, GetLoadBalancersOutputError>) -> Void)
    ...
    func getLoadBalancerTlsCertificates(input: GetLoadBalancerTlsCertificatesInput, completion: @escaping (SdkResult<GetLoadBalancerTlsCertificatesOutput, GetLoadBalancerTlsCertificatesOutputError>) -> Void)
    ...
    func getOperations(input: GetOperationsInput, completion: @escaping (SdkResult<GetOperationsOutput, GetOperationsOutputError>) -> Void)
    /// <p>Gets operations for a specific resource (e.g., an instance or a static IP).</p>
    func getOperationsForResource(input: GetOperationsForResourceInput, completion: @escaping (SdkResult<GetOperationsForResourceOutput, GetOperationsForResourceOutputError>) -> Void)
    ...
    ///       region.</p>
    func getRegions(input: GetRegionsInput, completion: @escaping (SdkResult<GetRegionsOutput, GetRegionsOutputError>) -> Void)
    /// <p>Returns information about a specific database in Amazon Lightsail.</p>
    func getRelationalDatabase(input: GetRelationalDatabaseInput, completion: @escaping (SdkResult<GetRelationalDatabaseOutput, GetRelationalDatabaseOutputError>) -> Void)
    ...
    ///       engine.</p>
    func getRelationalDatabaseBlueprints(input: GetRelationalDatabaseBlueprintsInput, completion: @escaping (SdkResult<GetRelationalDatabaseBlueprintsOutput, GetRelationalDatabaseBlueprintsOutputError>) -> Void)
    ...
    ///       specifications.</p>
    func getRelationalDatabaseBundles(input: GetRelationalDatabaseBundlesInput, completion: @escaping (SdkResult<GetRelationalDatabaseBundlesOutput, GetRelationalDatabaseBundlesOutputError>) -> Void)
    /// <p>Returns a list of events for a specific database in Amazon Lightsail.</p>
    func getRelationalDatabaseEvents(input: GetRelationalDatabaseEventsInput, completion: @escaping (SdkResult<GetRelationalDatabaseEventsOutput, GetRelationalDatabaseEventsOutputError>) -> Void)
    /// <p>Returns a list of log events for a database in Amazon Lightsail.</p>
    func getRelationalDatabaseLogEvents(input: GetRelationalDatabaseLogEventsInput, completion: @escaping (SdkResult<GetRelationalDatabaseLogEventsOutput, GetRelationalDatabaseLogEventsOutputError>) -> Void)
    /// <p>Returns a list of available log streams for a specific database in Amazon Lightsail.</p>
    func getRelationalDatabaseLogStreams(input: GetRelationalDatabaseLogStreamsInput, completion: @escaping (SdkResult<GetRelationalDatabaseLogStreamsOutput, GetRelationalDatabaseLogStreamsOutputError>) -> Void)
    ...
    func getRelationalDatabaseMasterUserPassword(input: GetRelationalDatabaseMasterUserPasswordInput, completion: @escaping (SdkResult<GetRelationalDatabaseMasterUserPasswordOutput, GetRelationalDatabaseMasterUserPasswordOutputError>) -> Void)
    /// <p>Returns the data points of the specified metric for a database in Amazon Lightsail.</p>
    ///          <p>Metrics report the utilization of your resources, and the error counts generated by them.
    ///       Monitor and collect metric data regularly to maintain the reliability, availability, and
    ///       performance of your resources.</p>
    func getRelationalDatabaseMetricData(input: GetRelationalDatabaseMetricDataInput, completion: @escaping (SdkResult<GetRelationalDatabaseMetricDataOutput, GetRelationalDatabaseMetricDataOutputError>) -> Void)
    ...
    func getRelationalDatabaseParameters(input: GetRelationalDatabaseParametersInput, completion: @escaping (SdkResult<GetRelationalDatabaseParametersOutput, GetRelationalDatabaseParametersOutputError>) -> Void)
    /// <p>Returns information about all of your databases in Amazon Lightsail.</p>
    func getRelationalDatabases(input: GetRelationalDatabasesInput, completion: @escaping (SdkResult<GetRelationalDatabasesOutput, GetRelationalDatabasesOutputError>) -> Void)
    /// <p>Returns information about a specific database snapshot in Amazon Lightsail.</p>
    func getRelationalDatabaseSnapshot(input: GetRelationalDatabaseSnapshotInput, completion: @escaping (SdkResult<GetRelationalDatabaseSnapshotOutput, GetRelationalDatabaseSnapshotOutputError>) -> Void)
    /// <p>Returns information about all of your database snapshots in Amazon Lightsail.</p>
    func getRelationalDatabaseSnapshots(input: GetRelationalDatabaseSnapshotsInput, completion: @escaping (SdkResult<GetRelationalDatabaseSnapshotsOutput, GetRelationalDatabaseSnapshotsOutputError>) -> Void)
    /// <p>Returns information about an Amazon Lightsail static IP.</p>
    func getStaticIp(input: GetStaticIpInput, completion: @escaping (SdkResult<GetStaticIpOutput, GetStaticIpOutputError>) -> Void)
    /// <p>Returns information about all static IPs in the user's account.</p>
    func getStaticIps(input: GetStaticIpsInput, completion: @escaping (SdkResult<GetStaticIpsOutput, GetStaticIpsOutputError>) -> Void)
    ...
    func isVpcPeered(input: IsVpcPeeredInput, completion: @escaping (SdkResult<IsVpcPeeredOutput, IsVpcPeeredOutputError>) -> Void)
    ...
    ///       resource tags applied to the resource identified by <code>instanceName</code>. For more
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func openInstancePublicPorts(input: OpenInstancePublicPortsInput, completion: @escaping (SdkResult<OpenInstancePublicPortsOutput, OpenInstancePublicPortsOutputError>) -> Void)
    /// <p>Tries to peer the Lightsail VPC with the user's default VPC.</p>
    func peerVpc(input: PeerVpcInput, completion: @escaping (SdkResult<PeerVpcOutput, PeerVpcOutputError>) -> Void)
    ...
    func putAlarm(input: PutAlarmInput, completion: @escaping (SdkResult<PutAlarmOutput, PutAlarmOutputError>) -> Void)
    /// <p>Opens ports for a specific Amazon Lightsail instance, and specifies the IP addresses
    ...
    ///       resource tags applied to the resource identified by <code>instanceName</code>. For more
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func putInstancePublicPorts(input: PutInstancePublicPortsInput, completion: @escaping (SdkResult<PutInstancePublicPortsOutput, PutInstancePublicPortsOutputError>) -> Void)
    ...
    ///       via resource tags applied to the resource identified by relationalDatabaseName. For more
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func rebootRelationalDatabase(input: RebootRelationalDatabaseInput, completion: @escaping (SdkResult<RebootRelationalDatabaseOutput, RebootRelationalDatabaseOutputError>) -> Void)
    ...
    ///         in the <i>Lightsail Dev Guide</i>.</p>
    ///          </note>
    func registerContainerImage(input: RegisterContainerImageInput, completion: @escaping (SdkResult<RegisterContainerImageOutput, RegisterContainerImageOutputError>) -> Void)
    /// <p>Deletes a specific static IP from your account.</p>
    func releaseStaticIp(input: ReleaseStaticIpInput, completion: @escaping (SdkResult<ReleaseStaticIpOutput, ReleaseStaticIpOutputError>) -> Void)
    ...
    func resetDistributionCache(input: ResetDistributionCacheInput, completion: @escaping (SdkResult<ResetDistributionCacheOutput, ResetDistributionCacheOutputError>) -> Void)
    ...
    ///          </important>
    func sendContactMethodVerification(input: SendContactMethodVerificationInput, completion: @escaping (SdkResult<SendContactMethodVerificationOutput, SendContactMethodVerificationOutputError>) -> Void)
    ...
    ///       IPv4 only.</p>
    func setIpAddressType(input: SetIpAddressTypeInput, completion: @escaping (SdkResult<SetIpAddressTypeOutput, SetIpAddressTypeOutputError>) -> Void)
    ...
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func startRelationalDatabase(input: StartRelationalDatabaseInput, completion: @escaping (SdkResult<StartRelationalDatabaseOutput, StartRelationalDatabaseOutputError>) -> Void)
    ...
    ///       resource tags applied to the resource identified by relationalDatabaseName. For more
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func stopRelationalDatabase(input: StopRelationalDatabaseInput, completion: @escaping (SdkResult<StopRelationalDatabaseOutput, StopRelationalDatabaseOutputError>) -> Void)
    ...
    ///       on the Amazon Lightsail console. For more information, see <a href="https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-alarms">Alarms
    ///         in Amazon Lightsail</a>.</p>
    func testAlarm(input: TestAlarmInput, completion: @escaping (SdkResult<TestAlarmOutput, TestAlarmOutputError>) -> Void)
    /// <p>Attempts to unpeer the Lightsail VPC from the user's default VPC.</p>
    func unpeerVpc(input: UnpeerVpcInput, completion: @escaping (SdkResult<UnpeerVpcOutput, UnpeerVpcOutputError>) -> Void)
    ...
    func updateContainerService(input: UpdateContainerServiceInput, completion: @escaping (SdkResult<UpdateContainerServiceOutput, UpdateContainerServiceOutputError>) -> Void)
    ...
    func updateDistribution(input: UpdateDistributionInput, completion: @escaping (SdkResult<UpdateDistributionOutput, UpdateDistributionOutputError>) -> Void)
    ...
    func updateDistributionBundle(input: UpdateDistributionBundleInput, completion: @escaping (SdkResult<UpdateDistributionBundleOutput, UpdateDistributionBundleOutputError>) -> Void)
    ...
    ///       resource tags applied to the resource identified by <code>domain name</code>. For more
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func updateDomainEntry(input: UpdateDomainEntryInput, completion: @escaping (SdkResult<UpdateDomainEntryOutput, UpdateDomainEntryOutputError>) -> Void)
    ...
    ///       control via resource tags applied to the resource identified by <code>load balancer
    ///         name</code>. For more information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func updateLoadBalancerAttribute(input: UpdateLoadBalancerAttributeInput, completion: @escaping (SdkResult<UpdateLoadBalancerAttributeOutput, UpdateLoadBalancerAttributeOutputError>) -> Void)
    ...
    ///       via resource tags applied to the resource identified by relationalDatabaseName. For more
    ///       information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func updateRelationalDatabase(input: UpdateRelationalDatabaseInput, completion: @escaping (SdkResult<UpdateRelationalDatabaseOutput, UpdateRelationalDatabaseOutputError>) -> Void)
    ...
    ///       control via resource tags applied to the resource identified by relationalDatabaseName. For
    ///       more information, see the <a href="https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags">Lightsail Dev Guide</a>.</p>
    func updateRelationalDatabaseParameters(input: UpdateRelationalDatabaseParametersInput, completion: @escaping (SdkResult<UpdateRelationalDatabaseParametersOutput, UpdateRelationalDatabaseParametersOutputError>) -> Void)
}
