...
public struct CreateInstancesFromSnapshotInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<CreateInstancesFromSnapshotOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<CreateInstancesFromSnapshotOutput>
