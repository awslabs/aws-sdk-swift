...
public protocol MigrationHubClientProtocol {
    ...
    ///             </li>
    ///          </ul>
    func associateCreatedArtifact(input: AssociateCreatedArtifactInput, completion: @escaping (SdkResult<AssociateCreatedArtifactOutput, AssociateCreatedArtifactOutputError>) -> Void)
    /// <p>Associates a discovered resource ID from Application Discovery Service with a migration
    ///          task.</p>
    func associateDiscoveredResource(input: AssociateDiscoveredResourceInput, completion: @escaping (SdkResult<AssociateDiscoveredResourceOutput, AssociateDiscoveredResourceOutputError>) -> Void)
    ...
    ///          the AWS account.</p>
    func createProgressUpdateStream(input: CreateProgressUpdateStreamInput, completion: @escaping (SdkResult<CreateProgressUpdateStreamOutput, CreateProgressUpdateStreamOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteProgressUpdateStream(input: DeleteProgressUpdateStreamInput, completion: @escaping (SdkResult<DeleteProgressUpdateStreamOutput, DeleteProgressUpdateStreamOutputError>) -> Void)
    /// <p>Gets the migration status of an application.</p>
    func describeApplicationState(input: DescribeApplicationStateInput, completion: @escaping (SdkResult<DescribeApplicationStateOutput, DescribeApplicationStateOutputError>) -> Void)
    /// <p>Retrieves a list of all attributes associated with a specific migration task.</p>
    func describeMigrationTask(input: DescribeMigrationTaskInput, completion: @escaping (SdkResult<DescribeMigrationTaskOutput, DescribeMigrationTaskOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func disassociateCreatedArtifact(input: DisassociateCreatedArtifactInput, completion: @escaping (SdkResult<DisassociateCreatedArtifactOutput, DisassociateCreatedArtifactOutputError>) -> Void)
    /// <p>Disassociate an Application Discovery Service discovered resource from a migration
    ///          task.</p>
    func disassociateDiscoveredResource(input: DisassociateDiscoveredResourceInput, completion: @escaping (SdkResult<DisassociateDiscoveredResourceOutput, DisassociateDiscoveredResourceOutputError>) -> Void)
    ...
    func importMigrationTask(input: ImportMigrationTaskInput, completion: @escaping (SdkResult<ImportMigrationTaskOutput, ImportMigrationTaskOutputError>) -> Void)
    ...
    func listApplicationStates(input: ListApplicationStatesInput, completion: @escaping (SdkResult<ListApplicationStatesOutput, ListApplicationStatesOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func listCreatedArtifacts(input: ListCreatedArtifactsInput, completion: @escaping (SdkResult<ListCreatedArtifactsOutput, ListCreatedArtifactsOutputError>) -> Void)
    /// <p>Lists discovered resources associated with the given <code>MigrationTask</code>.</p>
    func listDiscoveredResources(input: ListDiscoveredResourcesInput, completion: @escaping (SdkResult<ListDiscoveredResourcesOutput, ListDiscoveredResourcesOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func listMigrationTasks(input: ListMigrationTasksInput, completion: @escaping (SdkResult<ListMigrationTasksOutput, ListMigrationTasksOutputError>) -> Void)
    /// <p>Lists progress update streams associated with the user account making this call.</p>
    func listProgressUpdateStreams(input: ListProgressUpdateStreamsInput, completion: @escaping (SdkResult<ListProgressUpdateStreamsOutput, ListProgressUpdateStreamsOutputError>) -> Void)
    ...
    ///          COMPLETED</code>.</p>
    func notifyApplicationState(input: NotifyApplicationStateInput, completion: @escaping (SdkResult<NotifyApplicationStateOutput, NotifyApplicationStateOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func notifyMigrationTaskState(input: NotifyMigrationTaskStateInput, completion: @escaping (SdkResult<NotifyMigrationTaskStateOutput, NotifyMigrationTaskStateOutputError>) -> Void)
    ...
    ///          </note>
    func putResourceAttributes(input: PutResourceAttributesInput, completion: @escaping (SdkResult<PutResourceAttributesOutput, PutResourceAttributesOutputError>) -> Void)
}
