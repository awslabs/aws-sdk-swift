...
public struct AcceptEulasInput: Swift.Equatable {
    ...
    /// <p>The studio ID.</p>
    public let studioId: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct ActiveDirectoryConfiguration: Swift.Equatable {
        ...
        public let computerAttributes: [NimbleClientTypes.ActiveDirectoryComputerAttribute]?
...
extension NimbleClientTypes {
    ...
    public struct ComputeFarmConfiguration: Swift.Equatable {
        ...
        public let activeDirectoryUser: Swift.String?
...
public struct CreateStreamingSessionStreamInput: Swift.Equatable {
    ...
    public init (
        clientToken: Swift.String? = nil,
        expirationInSeconds: Swift.Int = 0,
...
extension CreateStreamingSessionStreamInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let expirationInSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .expirationInSeconds)
...
public struct DeleteStudioComponentInput: Swift.Equatable {
    ...
    public let studioComponentId: Swift.String?
    /// <p>The studio ID.</p>
    public let studioId: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct Eula: Swift.Equatable {
        ...
        /// <p>The EULA ID.</p>
        public let eulaId: Swift.String?
...
extension NimbleClientTypes {
    public struct EulaAcceptance: Swift.Equatable {
        ...
        public let acceptedAt: ClientRuntime.Date?
        /// <p>The ID of the person who accepted the EULA.</p>
        public let acceptedBy: Swift.String?
        /// <p>The ID of the acceptee.</p>
        public let accepteeId: Swift.String?
        /// <p>The EULA acceptance ID.</p>
        public let eulaAcceptanceId: Swift.String?
        /// <p>The EULA ID.</p>
        public let eulaId: Swift.String?
...
public struct GetLaunchProfileInitializationInput: Swift.Equatable {
    ...
    public let launchPurpose: Swift.String?
    /// <p>The platform.</p>
...
extension NimbleClientTypes {
    public struct LaunchProfile: Swift.Equatable {
        ...
        public let state: NimbleClientTypes.LaunchProfileState?
        /// <p>The status code.</p>
        public let statusCode: NimbleClientTypes.LaunchProfileStatusCode?
        /// <p>The status message for the launch profile.</p>
        public let statusMessage: Swift.String?
        /// <p>A configuration for a streaming session.</p>
        public let streamConfiguration: NimbleClientTypes.StreamConfiguration?
        /// <p>Unique identifiers for a collection of studio components that can be used with this launch profile.</p>
        public let studioComponentIds: [Swift.String]?
        /// <p>A collection of labels, in the form of key:value pairs, that apply to this resource.</p>
        public let tags: [Swift.String:Swift.String]?
...
extension NimbleClientTypes {
    public struct LaunchProfileInitialization: Swift.Equatable {
        ...
        public let activeDirectory: NimbleClientTypes.LaunchProfileInitializationActiveDirectory?
        /// <p>The EC2 security groups that control access to the studio component.</p>
        public let ec2SecurityGroupIds: [Swift.String]?
        /// <p>The launch profile ID.</p>
        public let launchProfileId: Swift.String?
        /// <p>The version number of the protocol that is used by the launch profile. The only valid version is "2021-03-31".</p>
        public let launchProfileProtocolVersion: Swift.String?
        /// <p>The launch purpose.</p>
        public let launchPurpose: Swift.String?
        /// <p>The name for the launch profile.</p>
        public let name: Swift.String?
        /// <p>The platform of the launch platform, either WINDOWS or LINUX.</p>
        public let platform: NimbleClientTypes.LaunchProfilePlatform?
        /// <p>The system initializtion scripts.</p>
        public let systemInitializationScripts: [NimbleClientTypes.LaunchProfileInitializationScript]?
        /// <p>The user initializtion scripts.</p>
        public let userInitializationScripts: [NimbleClientTypes.LaunchProfileInitializationScript]?
...
extension NimbleClientTypes {
    public struct LaunchProfileInitializationActiveDirectory: Swift.Equatable {
        ...
        public let studioComponentId: Swift.String?
        /// <p>The name for the studio component.</p>
        public let studioComponentName: Swift.String?
...
extension ListStreamingSessionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListStreamingSessionsInput(createdBy: \(Swift.String(describing: createdBy)), nextToken: \(Swift.String(describing: nextToken)), sessionIds: \(Swift.String(describing: sessionIds)), studioId: \(Swift.String(describing: studioId)))"}
}
...
public struct ListStreamingSessionsInput: Swift.Equatable {
    ...
    public let sessionIds: Swift.String?
    /// <p>The studio ID.</p>
    public let studioId: Swift.String?
...
extension NimbleClientTypes {
    public struct NewStudioMember: Swift.Equatable {
        /// <p>The persona.</p>
        public let persona: NimbleClientTypes.StudioPersona?
        /// <p>The principal ID.</p>
        public let principalId: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct SharedFileSystemConfiguration: Swift.Equatable {
        ...
        public let linuxMountPoint: Swift.String?
        /// <p>The name of the file share.</p>
        public let shareName: Swift.String?
        /// <p>The mount location for a shared file system on a Windows virtual workstation.</p>
        public let windowsMountDrive: Swift.String?
...
extension NimbleClientTypes.StreamConfiguration: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let maxSessionLengthInMinutesDecoded = try containerValues.decode(Swift.Int.self, forKey: .maxSessionLengthInMinutes)
...
extension NimbleClientTypes {
    ...
    public struct StreamConfiguration: Swift.Equatable {
        ...
        public let clipboardMode: NimbleClientTypes.StreamingClipboardMode?
        /// <p>The EC2 instance types that users can select from when launching a streaming session with this launch profile.</p>
        public let ec2InstanceTypes: [NimbleClientTypes.StreamingInstanceType]?
...
extension NimbleClientTypes {
    public struct StreamingImage: Swift.Equatable {
        ...
        public let encryptionConfiguration: NimbleClientTypes.StreamingImageEncryptionConfiguration?
        ...
        public let platform: Swift.String?
        /// <p>The current state.</p>
        public let state: NimbleClientTypes.StreamingImageState?
        /// <p>The status code.</p>
        public let statusCode: NimbleClientTypes.StreamingImageStatusCode?
...
extension NimbleClientTypes {
    public struct StreamingImageEncryptionConfiguration: Swift.Equatable {
        ...
        public let keyType: NimbleClientTypes.StreamingImageEncryptionConfigurationKeyType?
...
extension NimbleClientTypes.StreamingSession: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamingSession(arn: \(Swift.String(describing: arn)), createdAt: \(Swift.String(describing: createdAt)), createdBy: \(Swift.String(describing: createdBy)), ec2InstanceType: \(Swift.String(describing: ec2InstanceType)), launchProfileId: \(Swift.String(describing: launchProfileId)), sessionId: \(Swift.String(describing: sessionId)), state: \(Swift.String(describing: state)), statusCode: \(Swift.String(describing: statusCode)), statusMessage: \(Swift.String(describing: statusMessage)), streamingImageId: \(Swift.String(describing: streamingImageId)), tags: \(Swift.String(describing: tags)), terminateAt: \(Swift.String(describing: terminateAt)), updatedAt: \(Swift.String(describing: updatedAt)), updatedBy: \(Swift.String(describing: updatedBy)))"}
}
...
extension NimbleClientTypes {
    public struct StreamingSession: Swift.Equatable {
        ...
        public let createdBy: Swift.String?
        /// <p>The EC2 Instance type used for the streaming session.</p>
        public let ec2InstanceType: Swift.String?
        /// <p>The ID of the launch profile used to control access from the streaming session.</p>
        public let launchProfileId: Swift.String?
        /// <p>The session ID.</p>
        public let sessionId: Swift.String?
        /// <p>The current state.</p>
        public let state: NimbleClientTypes.StreamingSessionState?
        /// <p>The status code.</p>
        public let statusCode: NimbleClientTypes.StreamingSessionStatusCode?
        ...
        public let terminateAt: ClientRuntime.Date?
        /// <p>The Unix epoch timestamp in seconds for when the resource was updated.</p>
        public let updatedAt: ClientRuntime.Date?
        /// <p>The user ID of the user that most recently updated the resource.</p>
        public let updatedBy: Swift.String?
...
extension NimbleClientTypes.StreamingSessionStream: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamingSessionStream(createdAt: \(Swift.String(describing: createdAt)), createdBy: \(Swift.String(describing: createdBy)), expiresAt: \(Swift.String(describing: expiresAt)), state: \(Swift.String(describing: state)), statusCode: \(Swift.String(describing: statusCode)), streamId: \(Swift.String(describing: streamId)), url: \(Swift.String(describing: url)))"}
}
...
extension NimbleClientTypes {
    public struct StreamingSessionStream: Swift.Equatable {
        ...
        /// <p>The current state.</p>
        public let state: NimbleClientTypes.StreamingSessionStreamState?
        /// <p>The streaming session stream status code.</p>
        public let statusCode: NimbleClientTypes.StreamingSessionStreamStatusCode?
        /// <p>The stream ID.</p>
        public let streamId: Swift.String?
...
extension NimbleClientTypes {
    public struct Studio: Swift.Equatable {
        ...
        public let state: NimbleClientTypes.StudioState?
        /// <p>Status codes that provide additional detail on the studio state.</p>
        public let statusCode: NimbleClientTypes.StudioStatusCode?
        ...
        public let studioUrl: Swift.String?
        /// <p>A collection of labels, in the form of key:value pairs, that apply to this resource.</p>
        public let tags: [Swift.String:Swift.String]?
        /// <p>The Unix epoch timestamp in seconds for when the resource was updated.</p>
        public let updatedAt: ClientRuntime.Date?
...
extension NimbleClientTypes {
    ...
    public struct StudioComponent: Swift.Equatable {
        ...
        public let scriptParameters: [NimbleClientTypes.ScriptParameterKeyValue]?
        /// <p>The current state.</p>
        public let state: NimbleClientTypes.StudioComponentState?
        /// <p>The status code.</p>
        public let statusCode: NimbleClientTypes.StudioComponentStatusCode?
...
extension NimbleClientTypes {
    ...
    public struct StudioComponentConfiguration: Swift.Equatable {
        /// <p>The configuration for a Microsoft Active Directory (Microsoft AD) studio resource.</p>
        public let activeDirectoryConfiguration: NimbleClientTypes.ActiveDirectoryConfiguration?
        /// <p>The configuration for a render farm that is associated with a studio resource.</p>
        public let computeFarmConfiguration: NimbleClientTypes.ComputeFarmConfiguration?
        /// <p>The configuration for a license service that is associated with a studio resource.</p>
        public let licenseServiceConfiguration: NimbleClientTypes.LicenseServiceConfiguration?
        /// <p>The configuration for a shared file storage system that is associated with a studio resource.</p>
        public let sharedFileSystemConfiguration: NimbleClientTypes.SharedFileSystemConfiguration?
...
extension NimbleClientTypes {
    ...
    public struct StudioComponentInitializationScript: Swift.Equatable {
        ...
        public let runContext: NimbleClientTypes.StudioComponentInitializationScriptRunContext?
        /// <p>The initialization script.</p>
        public let script: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct StudioEncryptionConfiguration: Swift.Equatable {
        ...
        public let keyArn: Swift.String?
        /// <p>The type of KMS key that is used to encrypt studio data.</p>
        public let keyType: NimbleClientTypes.StudioEncryptionConfigurationKeyType?
