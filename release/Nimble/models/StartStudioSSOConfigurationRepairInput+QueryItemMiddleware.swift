...
public struct StartStudioSSOConfigurationRepairInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<StartStudioSSOConfigurationRepairOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<StartStudioSSOConfigurationRepairOutput>
