...
public class NimbleClient {
    ...
    public class NimbleClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("NimbleClient")
...
public struct NimbleClientLogHandlerFactory: SDKLogHandlerFactory {
