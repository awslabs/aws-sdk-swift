...
public struct AssociateEntityToThingInput: Swift.Equatable {
    ...
    var namespaceVersion: Swift.Int?
...
public struct CreateFlowTemplateInput: Swift.Equatable {
    ...
    var compatibleNamespaceVersion: Swift.Int?
    /// The workflow DefinitionDocument.
    /// This member is required.
    var definition: IoTThingsGraphClientTypes.DefinitionDocument?
...
public struct CreateFlowTemplateOutputResponse: Swift.Equatable {
    ...
    var summary: IoTThingsGraphClientTypes.FlowTemplateSummary?
...
public struct CreateSystemInstanceInput: Swift.Equatable {
    ...
    var flowActionsRoleArn: Swift.String?
    ...
    var greengrassGroupName: Swift.String?
    /// An object that specifies whether cloud metrics are collected in a deployment and, if so, what role is used to collect metrics.
    var metricsConfiguration: IoTThingsGraphClientTypes.MetricsConfiguration?
    ...
    var tags: [IoTThingsGraphClientTypes.Tag]?
    /// The target type of the deployment. Valid values are GREENGRASS and CLOUD.
    /// This member is required.
    var target: IoTThingsGraphClientTypes.DeploymentTarget?
...
public struct CreateSystemInstanceOutputResponse: Swift.Equatable {
    ...
    var summary: IoTThingsGraphClientTypes.SystemInstanceSummary?
...
public struct CreateSystemTemplateOutputResponse: Swift.Equatable {
    ...
    var summary: IoTThingsGraphClientTypes.SystemTemplateSummary?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct DefinitionDocument: Swift.Equatable {
        ...
        /// This member is required.
        var language: IoTThingsGraphClientTypes.DefinitionLanguage?
...
public struct DeleteNamespaceOutputResponse: Swift.Equatable {
    ...
    var namespaceArn: Swift.String?
    /// The name of the namespace to be deleted.
    var namespaceName: Swift.String?
...
public struct DeploySystemInstanceOutputResponse: Swift.Equatable {
    ...
    var greengrassDeploymentId: Swift.String?
...
public struct DescribeNamespaceOutputResponse: Swift.Equatable {
    ...
    var trackingNamespaceName: Swift.String?
    /// The version of the public namespace that the latest version is tracking.
    var trackingNamespaceVersion: Swift.Int?
...
public struct DissociateEntityFromThingInput: Swift.Equatable {
    ...
    /// This member is required.
    var entityType: IoTThingsGraphClientTypes.EntityType?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct EntityDescription: Swift.Equatable {
        ...
        var id: Swift.String?
        /// The entity type.
        var type: IoTThingsGraphClientTypes.EntityType?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct EntityFilter: Swift.Equatable {
        ...
        var name: IoTThingsGraphClientTypes.EntityFilterName?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct FlowExecutionMessage: Swift.Equatable {
        ...
        var eventType: IoTThingsGraphClientTypes.FlowExecutionEventType?
        /// The unique identifier of the message.
        var messageId: Swift.String?
        /// A string containing information about the flow event.
        var payload: Swift.String?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct FlowExecutionSummary: Swift.Equatable {
        ...
        var flowExecutionId: Swift.String?
        /// The ID of the flow.
        var flowTemplateId: Swift.String?
        /// The current status of the flow execution.
        var status: IoTThingsGraphClientTypes.FlowExecutionStatus?
        /// The ID of the system instance that contains the flow.
        var systemInstanceId: Swift.String?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct FlowTemplateDescription: Swift.Equatable {
        ...
        var validatedNamespaceVersion: Swift.Int?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct FlowTemplateFilter: Swift.Equatable {
        ...
        /// This member is required.
        var name: IoTThingsGraphClientTypes.FlowTemplateFilterName?
        /// An array of string values for the search filter field. Multiple values function as AND criteria in the search.
        /// This member is required.
        var value: [Swift.String]?
...
public struct GetEntitiesOutputResponse: Swift.Equatable {
    ...
    var descriptions: [IoTThingsGraphClientTypes.EntityDescription]?
...
public struct GetFlowTemplateOutputResponse: Swift.Equatable {
    ...
    var description: IoTThingsGraphClientTypes.FlowTemplateDescription?
...
public struct GetFlowTemplateRevisionsOutputResponse: Swift.Equatable {
    ...
    var summaries: [IoTThingsGraphClientTypes.FlowTemplateSummary]?
...
public struct GetNamespaceDeletionStatusOutputResponse: Swift.Equatable {
    ...
    var errorCode: IoTThingsGraphClientTypes.NamespaceDeletionStatusErrorCodes?
    /// An error code returned by the namespace deletion task.
    ...
    var status: IoTThingsGraphClientTypes.NamespaceDeletionStatus?
...
public struct GetSystemInstanceOutputResponse: Swift.Equatable {
    ...
    var description: IoTThingsGraphClientTypes.SystemInstanceDescription?
...
public struct GetSystemTemplateOutputResponse: Swift.Equatable {
    ...
    var description: IoTThingsGraphClientTypes.SystemTemplateDescription?
...
public struct GetSystemTemplateRevisionsOutputResponse: Swift.Equatable {
    ...
    var summaries: [IoTThingsGraphClientTypes.SystemTemplateSummary]?
...
public struct GetUploadStatusOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var uploadStatus: IoTThingsGraphClientTypes.UploadStatus?
...
public struct ListFlowExecutionMessagesOutputResponse: Swift.Equatable {
    ...
    var messages: [IoTThingsGraphClientTypes.FlowExecutionMessage]?
    /// The string to specify as nextToken when you request the next page of results.
    var nextToken: Swift.String?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct MetricsConfiguration: Swift.Equatable {
        ...
        var cloudMetricEnabled: Swift.Bool
        /// The ARN of the role that is used to collect cloud metrics.
        var metricRuleRoleArn: Swift.String?
...
public struct SearchEntitiesInput: Swift.Equatable {
    ...
    /// This member is required.
    var entityTypes: [IoTThingsGraphClientTypes.EntityType]?
    ...
    var filters: [IoTThingsGraphClientTypes.EntityFilter]?
    /// The maximum number of results to return in the response.
    var maxResults: Swift.Int?
    /// The version of the user's namespace. Defaults to the latest version of the user's namespace.
    var namespaceVersion: Swift.Int?
...
public struct SearchFlowExecutionsOutputResponse: Swift.Equatable {
    ...
    var summaries: [IoTThingsGraphClientTypes.FlowExecutionSummary]?
...
public struct SearchFlowTemplatesInput: Swift.Equatable {
    ...
    var filters: [IoTThingsGraphClientTypes.FlowTemplateFilter]?
    /// The maximum number of results to return in the response.
    var maxResults: Swift.Int?
    /// The string that specifies the next page of results. Use this when you're paginating results.
    var nextToken: Swift.String?
...
public struct SearchSystemInstancesInput: Swift.Equatable {
    ...
    var filters: [IoTThingsGraphClientTypes.SystemInstanceFilter]?
    /// The maximum number of results to return in the response.
    var maxResults: Swift.Int?
    /// The string that specifies the next page of results. Use this when you're paginating results.
    var nextToken: Swift.String?
...
public struct SearchSystemInstancesOutputResponse: Swift.Equatable {
    ...
    var summaries: [IoTThingsGraphClientTypes.SystemInstanceSummary]?
...
public struct SearchSystemTemplatesInput: Swift.Equatable {
    ...
    var filters: [IoTThingsGraphClientTypes.SystemTemplateFilter]?
    /// The maximum number of results to return in the response.
    var maxResults: Swift.Int?
    /// The string that specifies the next page of results. Use this when you're paginating results.
    var nextToken: Swift.String?
...
public struct SearchThingsOutputResponse: Swift.Equatable {
    ...
    var things: [IoTThingsGraphClientTypes.Thing]?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct SystemInstanceDescription: Swift.Equatable {
        ...
        var validatedDependencyRevisions: [IoTThingsGraphClientTypes.DependencyRevision]?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct SystemInstanceFilter: Swift.Equatable {
        /// The name of the search filter field.
        var name: IoTThingsGraphClientTypes.SystemInstanceFilterName?
        /// An array of string values for the search filter field. Multiple values function as AND criteria in the search.
        var value: [Swift.String]?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct SystemInstanceSummary: Swift.Equatable {
        ...
        var greengrassGroupId: Swift.String?
        /// The ID of the Greengrass group where the system instance is deployed.
        var greengrassGroupName: Swift.String?
        /// The version of the Greengrass group where the system instance is deployed.
        var greengrassGroupVersionId: Swift.String?
        /// The ID of the system instance.
        var id: Swift.String?
        /// The status of the system instance.
        var status: IoTThingsGraphClientTypes.SystemInstanceDeploymentStatus?
...
extension IoTThingsGraphClientTypes {
    ...
    public struct SystemTemplateFilter: Swift.Equatable {
        ...
        /// This member is required.
        var name: IoTThingsGraphClientTypes.SystemTemplateFilterName?
        /// An array of string values for the search filter field. Multiple values function as AND criteria in the search.
        /// This member is required.
        var value: [Swift.String]?
...
public struct UploadEntityDefinitionsInput: Swift.Equatable {
    ...
    var deprecateExistingEntities: Swift.Bool
    /// The DefinitionDocument that defines the updated entities.
    var document: IoTThingsGraphClientTypes.DefinitionDocument?
    ...
    var syncWithPublicNamespace: Swift.Bool
