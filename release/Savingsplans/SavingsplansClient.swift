...
extension SavingsplansClient: SavingsplansClientProtocol {
    ...
    public func createSavingsPlan(input: CreateSavingsPlanInput, completion: @escaping (SdkResult<CreateSavingsPlanOutput, CreateSavingsPlanOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<CreateSavingsPlanInput, CreateSavingsPlanOutput, CreateSavingsPlanOutputError>(id: "createSavingsPlan")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateSavingsPlanOutput>, SdkError<CreateSavingsPlanOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateSavingsPlanInput, CreateSavingsPlanOutput, CreateSavingsPlanOutputError>(contentType: "application/json"))
    ...
    public func deleteQueuedSavingsPlan(input: DeleteQueuedSavingsPlanInput, completion: @escaping (SdkResult<DeleteQueuedSavingsPlanOutput, DeleteQueuedSavingsPlanOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "savingsplans")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteQueuedSavingsPlanInput, DeleteQueuedSavingsPlanOutput, DeleteQueuedSavingsPlanOutputError>(id: "deleteQueuedSavingsPlan")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteQueuedSavingsPlanInput, DeleteQueuedSavingsPlanOutput, DeleteQueuedSavingsPlanOutputError>(contentType: "application/json"))
    ...
    public func describeSavingsPlanRates(input: DescribeSavingsPlanRatesInput, completion: @escaping (SdkResult<DescribeSavingsPlanRatesOutput, DescribeSavingsPlanRatesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "savingsplans")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeSavingsPlanRatesInput, DescribeSavingsPlanRatesOutput, DescribeSavingsPlanRatesOutputError>(id: "describeSavingsPlanRates")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeSavingsPlanRatesInput, DescribeSavingsPlanRatesOutput, DescribeSavingsPlanRatesOutputError>(contentType: "application/json"))
    ...
    public func describeSavingsPlans(input: DescribeSavingsPlansInput, completion: @escaping (SdkResult<DescribeSavingsPlansOutput, DescribeSavingsPlansOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "savingsplans")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeSavingsPlansInput, DescribeSavingsPlansOutput, DescribeSavingsPlansOutputError>(id: "describeSavingsPlans")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeSavingsPlansInput, DescribeSavingsPlansOutput, DescribeSavingsPlansOutputError>(contentType: "application/json"))
    ...
    public func describeSavingsPlansOfferingRates(input: DescribeSavingsPlansOfferingRatesInput, completion: @escaping (SdkResult<DescribeSavingsPlansOfferingRatesOutput, DescribeSavingsPlansOfferingRatesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "savingsplans")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeSavingsPlansOfferingRatesInput, DescribeSavingsPlansOfferingRatesOutput, DescribeSavingsPlansOfferingRatesOutputError>(id: "describeSavingsPlansOfferingRates")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeSavingsPlansOfferingRatesInput, DescribeSavingsPlansOfferingRatesOutput, DescribeSavingsPlansOfferingRatesOutputError>(contentType: "application/json"))
    ...
    public func describeSavingsPlansOfferings(input: DescribeSavingsPlansOfferingsInput, completion: @escaping (SdkResult<DescribeSavingsPlansOfferingsOutput, DescribeSavingsPlansOfferingsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "savingsplans")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeSavingsPlansOfferingsInput, DescribeSavingsPlansOfferingsOutput, DescribeSavingsPlansOfferingsOutputError>(id: "describeSavingsPlansOfferings")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeSavingsPlansOfferingsInput, DescribeSavingsPlansOfferingsOutput, DescribeSavingsPlansOfferingsOutputError>(contentType: "application/json"))
