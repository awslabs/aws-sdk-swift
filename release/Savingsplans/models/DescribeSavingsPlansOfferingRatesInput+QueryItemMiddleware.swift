...
public struct DescribeSavingsPlansOfferingRatesInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DescribeSavingsPlansOfferingRatesOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DescribeSavingsPlansOfferingRatesOutput>
