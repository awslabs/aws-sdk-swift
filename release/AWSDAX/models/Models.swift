...
extension DaxClientTypes {
    ...
    public struct Cluster: Swift.Equatable {
        ...
        var activeNodes: Swift.Int?
        /// The Amazon Resource Name (ARN) that uniquely identifies the cluster.
        var clusterArn: Swift.String?
        /// The endpoint for this DAX cluster, consisting of a DNS name, a port number, and a URL. Applications should use the URL to configure the DAX client to find their cluster.
        var clusterDiscoveryEndpoint: DaxClientTypes.Endpoint?
        /// The type of encryption supported by the cluster's endpoint. Values are:
        ///
        /// * NONE for no encryption TLS for Transport Layer Security
        var clusterEndpointEncryptionType: DaxClientTypes.ClusterEndpointEncryptionType?
        ...
        var nodeIdsToRemove: [Swift.String]?
        /// The node type for the nodes in the cluster. (All nodes in a DAX cluster are of the same type.)
        var nodeType: Swift.String?
        /// A list of nodes that are currently in the cluster.
        var nodes: [DaxClientTypes.Node]?
        /// Describes a notification topic and its status. Notification topics are used for publishing DAX events to subscribers using Amazon Simple Notification Service (SNS).
        var notificationConfiguration: DaxClientTypes.NotificationConfiguration?
        /// The parameter group being used by nodes in the cluster.
        var parameterGroup: DaxClientTypes.ParameterGroupStatus?
        /// A range of time when maintenance of DAX cluster software will be performed. For example: sun:01:00-sun:09:00. Cluster maintenance normally takes less than 30 minutes, and is performed automatically within the maintenance window.
        var preferredMaintenanceWindow: Swift.String?
        /// The description of the server-side encryption status on the specified DAX cluster.
        var sSEDescription: DaxClientTypes.SSEDescription?
        /// A list of security groups, and the status of each, for the nodes in the cluster.
        var securityGroups: [DaxClientTypes.SecurityGroupMembership]?
        /// The current status of the cluster.
        var status: Swift.String?
        /// The subnet group where the DAX cluster is running.
        var subnetGroup: Swift.String?
        /// The total number of nodes in the cluster.
        var totalNodes: Swift.Int?
...
public struct CreateClusterInput: Swift.Equatable {
    ...
    var sSESpecification: DaxClientTypes.SSESpecification?
...
public struct CreateClusterOutputResponse: Swift.Equatable {
    ...
    var cluster: DaxClientTypes.Cluster?
...
public struct CreateParameterGroupOutputResponse: Swift.Equatable {
    ...
    var parameterGroup: DaxClientTypes.ParameterGroup?
...
public struct CreateSubnetGroupOutputResponse: Swift.Equatable {
    ...
    var subnetGroup: DaxClientTypes.SubnetGroup?
...
public struct DecreaseReplicationFactorInput: Swift.Equatable {
    ...
    /// This member is required.
    var newReplicationFactor: Swift.Int
...
public struct DeleteParameterGroupOutputResponse: Swift.Equatable {
    ...
    var deletionMessage: Swift.String?
...
public struct DescribeClustersOutputResponse: Swift.Equatable {
    ...
    var clusters: [DaxClientTypes.Cluster]?
...
public struct DescribeDefaultParametersOutputResponse: Swift.Equatable {
    ...
    var parameters: [DaxClientTypes.Parameter]?
...
public struct DescribeEventsInput: Swift.Equatable {
    ...
    var sourceType: DaxClientTypes.SourceType?
...
public struct DescribeEventsOutputResponse: Swift.Equatable {
    ...
    var events: [DaxClientTypes.Event]?
    /// Provides an identifier to allow retrieval of paginated results.
    var nextToken: Swift.String?
...
public struct DescribeParameterGroupsInput: Swift.Equatable {
    ...
    var parameterGroupNames: [Swift.String]?
...
public struct DescribeParameterGroupsOutputResponse: Swift.Equatable {
    ...
    var parameterGroups: [DaxClientTypes.ParameterGroup]?
...
public struct DescribeSubnetGroupsInput: Swift.Equatable {
    ...
    var subnetGroupNames: [Swift.String]?
...
public struct DescribeSubnetGroupsOutputResponse: Swift.Equatable {
    ...
    var subnetGroups: [DaxClientTypes.SubnetGroup]?
...
extension DaxClientTypes {
    ...
    public struct Node: Swift.Equatable {
        ...
        var endpoint: DaxClientTypes.Endpoint?
        /// The date and time (in UNIX epoch format) when the node was launched.
        var nodeCreateTime: ClientRuntime.Date?
        /// A system-generated identifier for the node.
        var nodeId: Swift.String?
        /// The current status of the node. For example: available.
        var nodeStatus: Swift.String?
...
extension DaxClientTypes {
    ...
    public struct Parameter: Swift.Equatable {
        ...
        var changeType: DaxClientTypes.ChangeType?
        /// The data type of the parameter. For example, integer:
        var dataType: Swift.String?
        /// A description of the parameter
        var description: Swift.String?
        /// Whether the customer is allowed to modify the parameter.
        var isModifiable: DaxClientTypes.IsModifiable?
        /// A list of node types, and specific parameter values for each node.
        var nodeTypeSpecificValues: [DaxClientTypes.NodeTypeSpecificValue]?
        /// The name of the parameter.
        var parameterName: Swift.String?
        /// Determines whether the parameter can be applied to any nodes, or only nodes of a particular type.
        var parameterType: DaxClientTypes.ParameterType?
...
extension DaxClientTypes {
    ...
    public struct ParameterGroupStatus: Swift.Equatable {
        ...
        var nodeIdsToReboot: [Swift.String]?
...
extension DaxClientTypes {
    ...
    public struct SSEDescription: Swift.Equatable {
        ...
        var status: DaxClientTypes.SSEStatus?
...
extension DaxClientTypes {
    ...
    public struct SecurityGroupMembership: Swift.Equatable {
        ...
        var securityGroupIdentifier: Swift.String?
...
extension DaxClientTypes {
    ...
    public struct SubnetGroup: Swift.Equatable {
        ...
        var subnets: [DaxClientTypes.Subnet]?
...
public struct UpdateParameterGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var parameterNameValues: [DaxClientTypes.ParameterNameValue]?
