...
extension CancelTaskInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CancelTaskInput(taskId: \(Swift.String(describing: taskId)))"}
}

extension CancelTaskInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct CancelTaskInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelTaskInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CancelTaskInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CancelTaskOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CancelTaskInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CancelTaskOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelTaskOutputError>
}

public struct CancelTaskInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelTaskInputQueryItemMiddleware"
...
public struct CancelTaskInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelTaskInputURLHostMiddleware"
    ...
    public typealias MInput = CancelTaskInput
    public typealias MOutput = ClientRuntime.OperationOutput<CancelTaskOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelTaskOutputError>
}

public struct CancelTaskInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelTaskInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/task/\(taskId.urlPercentEncoding())/cancel"
...
extension CancelTaskOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CancelTaskOutputResponse(taskId: \(Swift.String(describing: taskId)))"}
}
...
extension SnowDeviceManagementClientTypes.Capacity: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case available
        case name
        case total
...
extension SnowDeviceManagementClientTypes.Capacity: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Capacity(available: \(Swift.String(describing: available)), name: \(Swift.String(describing: name)), total: \(Swift.String(describing: total)), unit: \(Swift.String(describing: unit)), used: \(Swift.String(describing: used)))"}
}
...
extension SnowDeviceManagementClientTypes.Command: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case reboot
        case sdkUnknown
        case unlock
...
extension SnowDeviceManagementClientTypes.CpuOptions: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case coreCount
        case threadsPerCore
    }
...
extension SnowDeviceManagementClientTypes.CpuOptions: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CpuOptions(coreCount: \(Swift.String(describing: coreCount)), threadsPerCore: \(Swift.String(describing: threadsPerCore)))"}
}
...
extension CreateTaskInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateTaskInput(clientToken: \(Swift.String(describing: clientToken)), command: \(Swift.String(describing: command)), description: \(Swift.String(describing: description)), tags: \(Swift.String(describing: tags)), targets: \(Swift.String(describing: targets)))"}
}
...
struct CreateTaskInputBody: Swift.Equatable {
    ...
    public let command: SnowDeviceManagementClientTypes.Command?
...
extension CreateTaskOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateTaskOutputResponse(taskArn: \(Swift.String(describing: taskArn)), taskId: \(Swift.String(describing: taskId)))"}
}
...
public struct DescribeDeviceEc2InstancesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeDeviceEc2InstancesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeDeviceEc2InstancesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeDeviceEc2InstancesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeDeviceEc2InstancesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeDeviceEc2InstancesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeDeviceEc2InstancesOutputError>
}

extension DescribeDeviceEc2InstancesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeDeviceEc2InstancesInput(instanceIds: \(Swift.String(describing: instanceIds)), managedDeviceId: \(Swift.String(describing: managedDeviceId)))"}
}

extension DescribeDeviceEc2InstancesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case instanceIds
    }
...
public struct DescribeDeviceEc2InstancesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeDeviceEc2InstancesInputHeadersMiddleware"
...
public struct DescribeDeviceEc2InstancesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeDeviceEc2InstancesInputQueryItemMiddleware"
...
public struct DescribeDeviceEc2InstancesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeDeviceEc2InstancesInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeDeviceEc2InstancesInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeDeviceEc2InstancesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeDeviceEc2InstancesOutputError>
}

public struct DescribeDeviceEc2InstancesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeDeviceEc2InstancesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let managedDeviceId = input.managedDeviceId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("managedDeviceId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/managed-device/\(managedDeviceId.urlPercentEncoding())/resources/ec2/describe"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeDeviceEc2InstancesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeDeviceEc2InstancesOutputResponse(instances: \(Swift.String(describing: instances)))"}
}
...
struct DescribeDeviceEc2InstancesOutputResponseBody: Swift.Equatable {
    public let instances: [SnowDeviceManagementClientTypes.InstanceSummary]?
}
...
extension DescribeDeviceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeDeviceInput(managedDeviceId: \(Swift.String(describing: managedDeviceId)))"}
}
...
public struct DescribeDeviceInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/managed-device/\(managedDeviceId.urlPercentEncoding())/describe"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeDeviceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeDeviceOutputResponse(associatedWithJob: \(Swift.String(describing: associatedWithJob)), deviceCapacities: \(Swift.String(describing: deviceCapacities)), deviceState: \(Swift.String(describing: deviceState)), deviceType: \(Swift.String(describing: deviceType)), lastReachedOutAt: \(Swift.String(describing: lastReachedOutAt)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), managedDeviceArn: \(Swift.String(describing: managedDeviceArn)), managedDeviceId: \(Swift.String(describing: managedDeviceId)), physicalNetworkInterfaces: \(Swift.String(describing: physicalNetworkInterfaces)), software: \(Swift.String(describing: software)), tags: \(Swift.String(describing: tags)))"}
}
...
struct DescribeDeviceOutputResponseBody: Swift.Equatable {
    public let lastReachedOutAt: ClientRuntime.Date?
    public let lastUpdatedAt: ClientRuntime.Date?
    public let tags: [Swift.String:Swift.String]?
    public let managedDeviceId: Swift.String?
    public let managedDeviceArn: Swift.String?
    public let deviceType: Swift.String?
    public let associatedWithJob: Swift.String?
    public let deviceState: SnowDeviceManagementClientTypes.UnlockState?
    public let physicalNetworkInterfaces: [SnowDeviceManagementClientTypes.PhysicalNetworkInterface]?
    public let deviceCapacities: [SnowDeviceManagementClientTypes.Capacity]?
    public let software: SnowDeviceManagementClientTypes.SoftwareInformation?
}
...
extension DescribeExecutionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeExecutionInput(managedDeviceId: \(Swift.String(describing: managedDeviceId)), taskId: \(Swift.String(describing: taskId)))"}
}
...
public struct DescribeExecutionInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/task/\(taskId.urlPercentEncoding())/execution/\(managedDeviceId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeExecutionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeExecutionOutputResponse(executionId: \(Swift.String(describing: executionId)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), managedDeviceId: \(Swift.String(describing: managedDeviceId)), startedAt: \(Swift.String(describing: startedAt)), state: \(Swift.String(describing: state)), taskId: \(Swift.String(describing: taskId)))"}
}
...
struct DescribeExecutionOutputResponseBody: Swift.Equatable {
    ...
    public let managedDeviceId: Swift.String?
    public let state: SnowDeviceManagementClientTypes.ExecutionState?
...
extension DescribeTaskInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeTaskInput(taskId: \(Swift.String(describing: taskId)))"}
}
...
public struct DescribeTaskInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/task/\(taskId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeTaskOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeTaskOutputResponse(completedAt: \(Swift.String(describing: completedAt)), createdAt: \(Swift.String(describing: createdAt)), description: \(Swift.String(describing: description)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), state: \(Swift.String(describing: state)), tags: \(Swift.String(describing: tags)), targets: \(Swift.String(describing: targets)), taskArn: \(Swift.String(describing: taskArn)), taskId: \(Swift.String(describing: taskId)))"}
}
...
struct DescribeTaskOutputResponseBody: Swift.Equatable {
    ...
    public let taskArn: Swift.String?
    public let targets: [Swift.String]?
    public let state: SnowDeviceManagementClientTypes.TaskState?
...
extension SnowDeviceManagementClientTypes.DeviceSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case associatedWithJob
        case managedDeviceArn
        case managedDeviceId
...
extension SnowDeviceManagementClientTypes.DeviceSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeviceSummary(associatedWithJob: \(Swift.String(describing: associatedWithJob)), managedDeviceArn: \(Swift.String(describing: managedDeviceArn)), managedDeviceId: \(Swift.String(describing: managedDeviceId)), tags: \(Swift.String(describing: tags)))"}
}
...
extension SnowDeviceManagementClientTypes.EbsInstanceBlockDevice: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case attachTime
...
extension SnowDeviceManagementClientTypes.EbsInstanceBlockDevice: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EbsInstanceBlockDevice(attachTime: \(Swift.String(describing: attachTime)), deleteOnTermination: \(Swift.String(describing: deleteOnTermination)), status: \(Swift.String(describing: status)), volumeId: \(Swift.String(describing: volumeId)))"}
}
...
extension SnowDeviceManagementClientTypes.ExecutionSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case executionId
        case managedDeviceId
        case state
...
extension SnowDeviceManagementClientTypes.ExecutionSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExecutionSummary(executionId: \(Swift.String(describing: executionId)), managedDeviceId: \(Swift.String(describing: managedDeviceId)), state: \(Swift.String(describing: state)), taskId: \(Swift.String(describing: taskId)))"}
}
...
extension SnowDeviceManagementClientTypes.Instance: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case amiLaunchIndex
...
extension SnowDeviceManagementClientTypes.Instance: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Instance(amiLaunchIndex: \(Swift.String(describing: amiLaunchIndex)), blockDeviceMappings: \(Swift.String(describing: blockDeviceMappings)), cpuOptions: \(Swift.String(describing: cpuOptions)), createdAt: \(Swift.String(describing: createdAt)), imageId: \(Swift.String(describing: imageId)), instanceId: \(Swift.String(describing: instanceId)), instanceType: \(Swift.String(describing: instanceType)), privateIpAddress: \(Swift.String(describing: privateIpAddress)), publicIpAddress: \(Swift.String(describing: publicIpAddress)), rootDeviceName: \(Swift.String(describing: rootDeviceName)), securityGroups: \(Swift.String(describing: securityGroups)), state: \(Swift.String(describing: state)), updatedAt: \(Swift.String(describing: updatedAt)))"}
}
...
extension SnowDeviceManagementClientTypes.InstanceBlockDeviceMapping: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case deviceName
        case ebs
    }
...
extension SnowDeviceManagementClientTypes.InstanceBlockDeviceMapping: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InstanceBlockDeviceMapping(deviceName: \(Swift.String(describing: deviceName)), ebs: \(Swift.String(describing: ebs)))"}
}
...
extension SnowDeviceManagementClientTypes.InstanceState: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case code
        case name
    }
...
extension SnowDeviceManagementClientTypes.InstanceState: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension SnowDeviceManagementClientTypes.InstanceSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case instance
        case lastUpdatedAt
    }
...
extension SnowDeviceManagementClientTypes.InstanceSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InstanceSummary(instance: \(Swift.String(describing: instance)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)))"}
}
...
extension ListDeviceResourcesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListDeviceResourcesInput(managedDeviceId: \(Swift.String(describing: managedDeviceId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), type: \(Swift.String(describing: type)))"}
}

extension ListDeviceResourcesInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListDeviceResourcesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDeviceResourcesInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListDeviceResourcesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListDeviceResourcesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListDeviceResourcesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListDeviceResourcesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListDeviceResourcesOutputError>
}

public struct ListDeviceResourcesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDeviceResourcesInputQueryItemMiddleware"
...
public struct ListDeviceResourcesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDeviceResourcesInputURLHostMiddleware"
    ...
    public typealias MInput = ListDeviceResourcesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListDeviceResourcesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListDeviceResourcesOutputError>
}

public struct ListDeviceResourcesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDeviceResourcesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/managed-device/\(managedDeviceId.urlPercentEncoding())/resources"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListDeviceResourcesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListDeviceResourcesOutputResponse(nextToken: \(Swift.String(describing: nextToken)), resources: \(Swift.String(describing: resources)))"}
}
...
struct ListDeviceResourcesOutputResponseBody: Swift.Equatable {
    public let resources: [SnowDeviceManagementClientTypes.ResourceSummary]?
...
extension ListDevicesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListDevicesInput(jobId: \(Swift.String(describing: jobId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListDevicesOutputResponseBody: Swift.Equatable {
    public let devices: [SnowDeviceManagementClientTypes.DeviceSummary]?
    public let nextToken: Swift.String?
}
...
extension ListExecutionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListExecutionsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), state: \(Swift.String(describing: state)), taskId: \(Swift.String(describing: taskId)))"}
}
...
struct ListExecutionsOutputResponseBody: Swift.Equatable {
    public let executions: [SnowDeviceManagementClientTypes.ExecutionSummary]?
    public let nextToken: Swift.String?
}
...
extension ListTasksInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListTasksInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), state: \(Swift.String(describing: state)))"}
}
...
struct ListTasksOutputResponseBody: Swift.Equatable {
    public let tasks: [SnowDeviceManagementClientTypes.TaskSummary]?
    public let nextToken: Swift.String?
}
...
extension SnowDeviceManagementClientTypes.PhysicalNetworkInterface: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case defaultGateway
        case ipAddress
...
extension SnowDeviceManagementClientTypes.PhysicalNetworkInterface: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PhysicalNetworkInterface(defaultGateway: \(Swift.String(describing: defaultGateway)), ipAddress: \(Swift.String(describing: ipAddress)), ipAddressAssignment: \(Swift.String(describing: ipAddressAssignment)), macAddress: \(Swift.String(describing: macAddress)), netmask: \(Swift.String(describing: netmask)), physicalConnectorType: \(Swift.String(describing: physicalConnectorType)), physicalNetworkInterfaceId: \(Swift.String(describing: physicalNetworkInterfaceId)))"}
}
...
extension SnowDeviceManagementClientTypes.Reboot: Swift.Codable, ClientRuntime.Reflection {
...
extension SnowDeviceManagementClientTypes.Reboot: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Reboot()"}
}
...
extension SnowDeviceManagementClientTypes.ResourceSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
        case id
        case resourceType
...
extension SnowDeviceManagementClientTypes.ResourceSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceSummary(arn: \(Swift.String(describing: arn)), id: \(Swift.String(describing: id)), resourceType: \(Swift.String(describing: resourceType)))"}
}
...
extension SnowDeviceManagementClientTypes.SecurityGroupIdentifier: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case groupId
        case groupName
    }
...
extension SnowDeviceManagementClientTypes.SecurityGroupIdentifier: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SecurityGroupIdentifier(groupId: \(Swift.String(describing: groupId)), groupName: \(Swift.String(describing: groupName)))"}
}
...
extension SnowDeviceManagementClientTypes.SoftwareInformation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case installState
...
extension SnowDeviceManagementClientTypes.SoftwareInformation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SoftwareInformation(installState: \(Swift.String(describing: installState)), installedVersion: \(Swift.String(describing: installedVersion)), installingVersion: \(Swift.String(describing: installingVersion)))"}
}
...
extension SnowDeviceManagementClientTypes.TaskSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case state
        case tags
        case taskArn
...
extension SnowDeviceManagementClientTypes.TaskSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TaskSummary(state: \(Swift.String(describing: state)), tags: \(Swift.String(describing: tags)), taskArn: \(Swift.String(describing: taskArn)), taskId: \(Swift.String(describing: taskId)))"}
}
...
extension SnowDeviceManagementClientTypes.Unlock: Swift.Codable, ClientRuntime.Reflection {
...
extension SnowDeviceManagementClientTypes.Unlock: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Unlock()"}
}
