...
public protocol RedshiftDataClientProtocol {
    ...
    func cancelStatement(input: CancelStatementInput, completion: @escaping (SdkResult<CancelStatementOutput, CancelStatementOutputError>) -> Void)
    ...
    ///       statement. </p>
    func describeStatement(input: DescribeStatementInput, completion: @escaping (SdkResult<DescribeStatementOutput, DescribeStatementOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeTable(input: DescribeTableInput, completion: @escaping (SdkResult<DescribeTableOutput, DescribeTableOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func executeStatement(input: ExecuteStatementInput, completion: @escaping (SdkResult<ExecuteStatementOutput, ExecuteStatementOutputError>) -> Void)
    /// <p>Fetches the temporarily cached result of an SQL statement.
    ///        A token is returned to page through the statement results. </p>
    func getStatementResult(input: GetStatementResultInput, completion: @escaping (SdkResult<GetStatementResultOutput, GetStatementResultOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func listDatabases(input: ListDatabasesInput, completion: @escaping (SdkResult<ListDatabasesOutput, ListDatabasesOutputError>) -> Void)
    ...
    func listStatements(input: ListStatementsInput, completion: @escaping (SdkResult<ListStatementsOutput, ListStatementsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func listTables(input: ListTablesInput, completion: @escaping (SdkResult<ListTablesOutput, ListTablesOutputError>) -> Void)
}
