...
public protocol FraudDetectorClientProtocol {
    ...
    func batchCreateVariable(input: BatchCreateVariableInput, completion: @escaping (SdkResult<BatchCreateVariableOutputResponse, BatchCreateVariableOutputError>) -> Void)
    /// <p>Gets a batch of variables.</p>
    func batchGetVariable(input: BatchGetVariableInput, completion: @escaping (SdkResult<BatchGetVariableOutputResponse, BatchGetVariableOutputError>) -> Void)
    /// <p>Cancels the specified batch prediction job.</p>
    func cancelBatchPredictionJob(input: CancelBatchPredictionJobInput, completion: @escaping (SdkResult<CancelBatchPredictionJobOutputResponse, CancelBatchPredictionJobOutputError>) -> Void)
    /// <p>Creates a batch prediction job.</p>
    func createBatchPredictionJob(input: CreateBatchPredictionJobInput, completion: @escaping (SdkResult<CreateBatchPredictionJobOutputResponse, CreateBatchPredictionJobOutputError>) -> Void)
    /// <p>Creates a detector version. The detector version starts in a <code>DRAFT</code> status.</p>
    func createDetectorVersion(input: CreateDetectorVersionInput, completion: @escaping (SdkResult<CreateDetectorVersionOutputResponse, CreateDetectorVersionOutputError>) -> Void)
    ...
    ///         </p>
    func createModelVersion(input: CreateModelVersionInput, completion: @escaping (SdkResult<CreateModelVersionOutputResponse, CreateModelVersionOutputError>) -> Void)
    ...
    func createVariable(input: CreateVariableInput, completion: @escaping (SdkResult<CreateVariableOutputResponse, CreateVariableOutputError>) -> Void)
    /// <p>Deletes a batch prediction job.</p>
    func deleteBatchPredictionJob(input: DeleteBatchPredictionJobInput, completion: @escaping (SdkResult<DeleteBatchPredictionJobOutputResponse, DeleteBatchPredictionJobOutputError>) -> Void)
    ...
    func deleteDetectorVersion(input: DeleteDetectorVersionInput, completion: @escaping (SdkResult<DeleteDetectorVersionOutputResponse, DeleteDetectorVersionOutputError>) -> Void)
    ...
    func deleteEntityType(input: DeleteEntityTypeInput, completion: @escaping (SdkResult<DeleteEntityTypeOutputResponse, DeleteEntityTypeOutputError>) -> Void)
    ...
    func deleteEvent(input: DeleteEventInput, completion: @escaping (SdkResult<DeleteEventOutputResponse, DeleteEventOutputError>) -> Void)
    /// <p>Deletes an event type.</p>
    /// 	        <p>You cannot delete an event type that is used in a detector or a model.</p>
    /// 	        <p>When you delete an entity type, Amazon Fraud Detector permanently deletes that entity type and the data is no longer stored in Amazon Fraud Detector.</p>
    func deleteEventType(input: DeleteEventTypeInput, completion: @escaping (SdkResult<DeleteEventTypeOutputResponse, DeleteEventTypeOutputError>) -> Void)
    ...
    func deleteExternalModel(input: DeleteExternalModelInput, completion: @escaping (SdkResult<DeleteExternalModelOutputResponse, DeleteExternalModelOutputError>) -> Void)
    /// <p>Deletes a label.</p>
    ...
    func deleteLabel(input: DeleteLabelInput, completion: @escaping (SdkResult<DeleteLabelOutputResponse, DeleteLabelOutputError>) -> Void)
    /// <p>Deletes a model.</p>
    ...
    func deleteModelVersion(input: DeleteModelVersionInput, completion: @escaping (SdkResult<DeleteModelVersionOutputResponse, DeleteModelVersionOutputError>) -> Void)
    ...
    func deleteOutcome(input: DeleteOutcomeInput, completion: @escaping (SdkResult<DeleteOutcomeOutputResponse, DeleteOutcomeOutputError>) -> Void)
    ...
    func deleteVariable(input: DeleteVariableInput, completion: @escaping (SdkResult<DeleteVariableOutputResponse, DeleteVariableOutputError>) -> Void)
    ...
    func describeModelVersions(input: DescribeModelVersionsInput, completion: @escaping (SdkResult<DescribeModelVersionsOutputResponse, DescribeModelVersionsOutputError>) -> Void)
    ...
    func getBatchPredictionJobs(input: GetBatchPredictionJobsInput, completion: @escaping (SdkResult<GetBatchPredictionJobsOutputResponse, GetBatchPredictionJobsOutputError>) -> Void)
    ...
    func getDetectors(input: GetDetectorsInput, completion: @escaping (SdkResult<GetDetectorsOutputResponse, GetDetectorsOutputError>) -> Void)
    /// <p>Gets a particular detector version. </p>
    func getDetectorVersion(input: GetDetectorVersionInput, completion: @escaping (SdkResult<GetDetectorVersionOutputResponse, GetDetectorVersionOutputError>) -> Void)
    ...
    ///          fetches the records from the beginning. </p>
    func getEntityTypes(input: GetEntityTypesInput, completion: @escaping (SdkResult<GetEntityTypesOutputResponse, GetEntityTypesOutputError>) -> Void)
    ...
    func getEventPrediction(input: GetEventPredictionInput, completion: @escaping (SdkResult<GetEventPredictionOutputResponse, GetEventPredictionOutputError>) -> Void)
    ...
    ///          fetches the records from the beginning. </p>
    func getEventTypes(input: GetEventTypesInput, completion: @escaping (SdkResult<GetEventTypesOutputResponse, GetEventTypesOutputError>) -> Void)
    ...
    func getExternalModels(input: GetExternalModelsInput, completion: @escaping (SdkResult<GetExternalModelsOutputResponse, GetExternalModelsOutputError>) -> Void)
    ...
    func getKMSEncryptionKey(input: GetKMSEncryptionKeyInput, completion: @escaping (SdkResult<GetKMSEncryptionKeyOutputResponse, GetKMSEncryptionKeyOutputError>) -> Void)
    ...
    ///          fetches the records from the beginning. </p>
    func getLabels(input: GetLabelsInput, completion: @escaping (SdkResult<GetLabelsOutputResponse, GetLabelsOutputError>) -> Void)
    ...
    func getModelVersion(input: GetModelVersionInput, completion: @escaping (SdkResult<GetModelVersionOutputResponse, GetModelVersionOutputError>) -> Void)
    ...
    ///          fetches the records from the beginning. </p>
    func getOutcomes(input: GetOutcomesInput, completion: @escaping (SdkResult<GetOutcomesOutputResponse, GetOutcomesOutputError>) -> Void)
    ...
    func getRules(input: GetRulesInput, completion: @escaping (SdkResult<GetRulesOutputResponse, GetRulesOutputError>) -> Void)
    ...
    ///          fetches the records from the beginning. </p>
    func getVariables(input: GetVariablesInput, completion: @escaping (SdkResult<GetVariablesOutputResponse, GetVariablesOutputError>) -> Void)
    ...
    func putDetector(input: PutDetectorInput, completion: @escaping (SdkResult<PutDetectorOutputResponse, PutDetectorOutputError>) -> Void)
    ...
    func putEntityType(input: PutEntityTypeInput, completion: @escaping (SdkResult<PutEntityTypeOutputResponse, PutEntityTypeOutputError>) -> Void)
    ...
    func putEventType(input: PutEventTypeInput, completion: @escaping (SdkResult<PutEventTypeOutputResponse, PutEventTypeOutputError>) -> Void)
    ...
    func putExternalModel(input: PutExternalModelInput, completion: @escaping (SdkResult<PutExternalModelOutputResponse, PutExternalModelOutputError>) -> Void)
    ...
    func putKMSEncryptionKey(input: PutKMSEncryptionKeyInput, completion: @escaping (SdkResult<PutKMSEncryptionKeyOutputResponse, PutKMSEncryptionKeyOutputError>) -> Void)
    ...
    func putLabel(input: PutLabelInput, completion: @escaping (SdkResult<PutLabelOutputResponse, PutLabelOutputError>) -> Void)
    /// <p>Creates or updates an outcome. </p>
    func putOutcome(input: PutOutcomeInput, completion: @escaping (SdkResult<PutOutcomeOutputResponse, PutOutcomeOutputError>) -> Void)
    ...
    func updateDetectorVersion(input: UpdateDetectorVersionInput, completion: @escaping (SdkResult<UpdateDetectorVersionOutputResponse, UpdateDetectorVersionOutputError>) -> Void)
    ...
    func updateDetectorVersionMetadata(input: UpdateDetectorVersionMetadataInput, completion: @escaping (SdkResult<UpdateDetectorVersionMetadataOutputResponse, UpdateDetectorVersionMetadataOutputError>) -> Void)
    ...
    func updateDetectorVersionStatus(input: UpdateDetectorVersionStatusInput, completion: @escaping (SdkResult<UpdateDetectorVersionStatusOutputResponse, UpdateDetectorVersionStatusOutputError>) -> Void)
    ...
    func updateModelVersion(input: UpdateModelVersionInput, completion: @escaping (SdkResult<UpdateModelVersionOutputResponse, UpdateModelVersionOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ol>
    func updateModelVersionStatus(input: UpdateModelVersionStatusInput, completion: @escaping (SdkResult<UpdateModelVersionStatusOutputResponse, UpdateModelVersionStatusOutputError>) -> Void)
    /// <p>Updates a rule's metadata. The description attribute can be updated.</p>
    func updateRuleMetadata(input: UpdateRuleMetadataInput, completion: @escaping (SdkResult<UpdateRuleMetadataOutputResponse, UpdateRuleMetadataOutputError>) -> Void)
    ...
    func updateRuleVersion(input: UpdateRuleVersionInput, completion: @escaping (SdkResult<UpdateRuleVersionOutputResponse, UpdateRuleVersionOutputError>) -> Void)
    /// <p>Updates a variable.</p>
    func updateVariable(input: UpdateVariableInput, completion: @escaping (SdkResult<UpdateVariableOutputResponse, UpdateVariableOutputError>) -> Void)
}
