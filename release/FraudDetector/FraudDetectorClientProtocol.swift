...
public protocol FraudDetectorClientProtocol {
    ...
    func batchCreateVariable(input: BatchCreateVariableInput, completion: @escaping (SdkResult<BatchCreateVariableOutput, BatchCreateVariableOutputError>) -> Void)
    /// <p>Gets a batch of variables.</p>
    func batchGetVariable(input: BatchGetVariableInput, completion: @escaping (SdkResult<BatchGetVariableOutput, BatchGetVariableOutputError>) -> Void)
    /// <p>Cancels the specified batch prediction job.</p>
    func cancelBatchPredictionJob(input: CancelBatchPredictionJobInput, completion: @escaping (SdkResult<CancelBatchPredictionJobOutput, CancelBatchPredictionJobOutputError>) -> Void)
    /// <p>Creates a batch prediction job.</p>
    func createBatchPredictionJob(input: CreateBatchPredictionJobInput, completion: @escaping (SdkResult<CreateBatchPredictionJobOutput, CreateBatchPredictionJobOutputError>) -> Void)
    /// <p>Creates a detector version. The detector version starts in a <code>DRAFT</code> status.</p>
    func createDetectorVersion(input: CreateDetectorVersionInput, completion: @escaping (SdkResult<CreateDetectorVersionOutput, CreateDetectorVersionOutputError>) -> Void)
    ...
    ///         </p>
    func createModelVersion(input: CreateModelVersionInput, completion: @escaping (SdkResult<CreateModelVersionOutput, CreateModelVersionOutputError>) -> Void)
    ...
    func createVariable(input: CreateVariableInput, completion: @escaping (SdkResult<CreateVariableOutput, CreateVariableOutputError>) -> Void)
    /// <p>Deletes a batch prediction job.</p>
    func deleteBatchPredictionJob(input: DeleteBatchPredictionJobInput, completion: @escaping (SdkResult<DeleteBatchPredictionJobOutput, DeleteBatchPredictionJobOutputError>) -> Void)
    ...
    func deleteDetector(input: DeleteDetectorInput, completion: @escaping (SdkResult<DeleteDetectorOutput, DeleteDetectorOutputError>) -> Void)
    ...
    func deleteDetectorVersion(input: DeleteDetectorVersionInput, completion: @escaping (SdkResult<DeleteDetectorVersionOutput, DeleteDetectorVersionOutputError>) -> Void)
    ...
    func deleteEntityType(input: DeleteEntityTypeInput, completion: @escaping (SdkResult<DeleteEntityTypeOutput, DeleteEntityTypeOutputError>) -> Void)
    ...
    func deleteEvent(input: DeleteEventInput, completion: @escaping (SdkResult<DeleteEventOutput, DeleteEventOutputError>) -> Void)
    /// <p>Deletes an event type.</p>
    /// 	        <p>You cannot delete an event type that is used in a detector or a model.</p>
    /// 	        <p>When you delete an entity type, Amazon Fraud Detector permanently deletes that entity type and the data is no longer stored in Amazon Fraud Detector.</p>
    func deleteEventType(input: DeleteEventTypeInput, completion: @escaping (SdkResult<DeleteEventTypeOutput, DeleteEventTypeOutputError>) -> Void)
    ...
    func deleteExternalModel(input: DeleteExternalModelInput, completion: @escaping (SdkResult<DeleteExternalModelOutput, DeleteExternalModelOutputError>) -> Void)
    /// <p>Deletes a label.</p>
    ...
    func deleteLabel(input: DeleteLabelInput, completion: @escaping (SdkResult<DeleteLabelOutput, DeleteLabelOutputError>) -> Void)
    /// <p>Deletes a model.</p>
    ...
    func deleteModelVersion(input: DeleteModelVersionInput, completion: @escaping (SdkResult<DeleteModelVersionOutput, DeleteModelVersionOutputError>) -> Void)
    ...
    func deleteOutcome(input: DeleteOutcomeInput, completion: @escaping (SdkResult<DeleteOutcomeOutput, DeleteOutcomeOutputError>) -> Void)
    ...
    func deleteVariable(input: DeleteVariableInput, completion: @escaping (SdkResult<DeleteVariableOutput, DeleteVariableOutputError>) -> Void)
    ...
    func describeModelVersions(input: DescribeModelVersionsInput, completion: @escaping (SdkResult<DescribeModelVersionsOutput, DescribeModelVersionsOutputError>) -> Void)
    ...
    func getBatchPredictionJobs(input: GetBatchPredictionJobsInput, completion: @escaping (SdkResult<GetBatchPredictionJobsOutput, GetBatchPredictionJobsOutputError>) -> Void)
    ...
    func getDetectors(input: GetDetectorsInput, completion: @escaping (SdkResult<GetDetectorsOutput, GetDetectorsOutputError>) -> Void)
    /// <p>Gets a particular detector version. </p>
    func getDetectorVersion(input: GetDetectorVersionInput, completion: @escaping (SdkResult<GetDetectorVersionOutput, GetDetectorVersionOutputError>) -> Void)
    ...
    ///          fetches the records from the beginning. </p>
    func getEntityTypes(input: GetEntityTypesInput, completion: @escaping (SdkResult<GetEntityTypesOutput, GetEntityTypesOutputError>) -> Void)
    ...
    func getEventPrediction(input: GetEventPredictionInput, completion: @escaping (SdkResult<GetEventPredictionOutput, GetEventPredictionOutputError>) -> Void)
    ...
    ///          fetches the records from the beginning. </p>
    func getEventTypes(input: GetEventTypesInput, completion: @escaping (SdkResult<GetEventTypesOutput, GetEventTypesOutputError>) -> Void)
    ...
    func getExternalModels(input: GetExternalModelsInput, completion: @escaping (SdkResult<GetExternalModelsOutput, GetExternalModelsOutputError>) -> Void)
    ...
    func getKMSEncryptionKey(input: GetKMSEncryptionKeyInput, completion: @escaping (SdkResult<GetKMSEncryptionKeyOutput, GetKMSEncryptionKeyOutputError>) -> Void)
    ...
    ///          fetches the records from the beginning. </p>
    func getLabels(input: GetLabelsInput, completion: @escaping (SdkResult<GetLabelsOutput, GetLabelsOutputError>) -> Void)
    ...
    func getModelVersion(input: GetModelVersionInput, completion: @escaping (SdkResult<GetModelVersionOutput, GetModelVersionOutputError>) -> Void)
    ...
    ///          fetches the records from the beginning. </p>
    func getOutcomes(input: GetOutcomesInput, completion: @escaping (SdkResult<GetOutcomesOutput, GetOutcomesOutputError>) -> Void)
    ...
    func getRules(input: GetRulesInput, completion: @escaping (SdkResult<GetRulesOutput, GetRulesOutputError>) -> Void)
    ...
    ///          fetches the records from the beginning. </p>
    func getVariables(input: GetVariablesInput, completion: @escaping (SdkResult<GetVariablesOutput, GetVariablesOutputError>) -> Void)
    ...
    func putDetector(input: PutDetectorInput, completion: @escaping (SdkResult<PutDetectorOutput, PutDetectorOutputError>) -> Void)
    ...
    func putEntityType(input: PutEntityTypeInput, completion: @escaping (SdkResult<PutEntityTypeOutput, PutEntityTypeOutputError>) -> Void)
    ...
    func putEventType(input: PutEventTypeInput, completion: @escaping (SdkResult<PutEventTypeOutput, PutEventTypeOutputError>) -> Void)
    ...
    func putExternalModel(input: PutExternalModelInput, completion: @escaping (SdkResult<PutExternalModelOutput, PutExternalModelOutputError>) -> Void)
    ...
    func putKMSEncryptionKey(input: PutKMSEncryptionKeyInput, completion: @escaping (SdkResult<PutKMSEncryptionKeyOutput, PutKMSEncryptionKeyOutputError>) -> Void)
    ...
    func putLabel(input: PutLabelInput, completion: @escaping (SdkResult<PutLabelOutput, PutLabelOutputError>) -> Void)
    /// <p>Creates or updates an outcome. </p>
    func putOutcome(input: PutOutcomeInput, completion: @escaping (SdkResult<PutOutcomeOutput, PutOutcomeOutputError>) -> Void)
    ...
    func updateDetectorVersion(input: UpdateDetectorVersionInput, completion: @escaping (SdkResult<UpdateDetectorVersionOutput, UpdateDetectorVersionOutputError>) -> Void)
    ...
    func updateDetectorVersionMetadata(input: UpdateDetectorVersionMetadataInput, completion: @escaping (SdkResult<UpdateDetectorVersionMetadataOutput, UpdateDetectorVersionMetadataOutputError>) -> Void)
    ...
    func updateDetectorVersionStatus(input: UpdateDetectorVersionStatusInput, completion: @escaping (SdkResult<UpdateDetectorVersionStatusOutput, UpdateDetectorVersionStatusOutputError>) -> Void)
    ...
    func updateModelVersion(input: UpdateModelVersionInput, completion: @escaping (SdkResult<UpdateModelVersionOutput, UpdateModelVersionOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ol>
    func updateModelVersionStatus(input: UpdateModelVersionStatusInput, completion: @escaping (SdkResult<UpdateModelVersionStatusOutput, UpdateModelVersionStatusOutputError>) -> Void)
    /// <p>Updates a rule's metadata. The description attribute can be updated.</p>
    func updateRuleMetadata(input: UpdateRuleMetadataInput, completion: @escaping (SdkResult<UpdateRuleMetadataOutput, UpdateRuleMetadataOutputError>) -> Void)
    ...
    func updateRuleVersion(input: UpdateRuleVersionInput, completion: @escaping (SdkResult<UpdateRuleVersionOutput, UpdateRuleVersionOutputError>) -> Void)
    /// <p>Updates a variable.</p>
    func updateVariable(input: UpdateVariableInput, completion: @escaping (SdkResult<UpdateVariableOutput, UpdateVariableOutputError>) -> Void)
}
