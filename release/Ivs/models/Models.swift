...
extension IvsClientTypes {
    ...
    public struct Channel: Swift.Equatable {
        ...
        public let ingestEndpoint: Swift.String?
...
extension ChannelNotBroadcasting: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct ChannelNotBroadcasting: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension IvsClientTypes {
    ...
    public struct DestinationConfiguration: Swift.Equatable {
        ...
        public let s3: IvsClientTypes.S3DestinationConfiguration?
...
extension PendingVerification: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct PendingVerification: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension IvsClientTypes {
    ...
    public struct RecordingConfiguration: Swift.Equatable {
        ...
        public let state: IvsClientTypes.RecordingConfigurationState?
        /// <p>Array of 1-50 maps, each of the form <code>string:string (key:value)</code>.</p>
        public let tags: [Swift.String:Swift.String]?
...
extension IvsClientTypes {
    ...
    public struct Stream: Swift.Equatable {
        ...
        public let health: IvsClientTypes.StreamHealth?
        ...
        public let state: IvsClientTypes.StreamState?
...
extension StreamUnavailable: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct StreamUnavailable: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
