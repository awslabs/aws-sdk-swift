...
public protocol IvsClientProtocol {
    ...
    func batchGetChannel(input: BatchGetChannelInput, completion: @escaping (SdkResult<BatchGetChannelOutput, BatchGetChannelOutputError>) -> Void)
    /// <p>Performs <a>GetStreamKey</a> on multiple ARNs simultaneously.</p>
    func batchGetStreamKey(input: BatchGetStreamKeyInput, completion: @escaping (SdkResult<BatchGetStreamKeyOutput, BatchGetStreamKeyOutputError>) -> Void)
    ...
    ///       correct region.</p>
    func createRecordingConfiguration(input: CreateRecordingConfigurationInput, completion: @escaping (SdkResult<CreateRecordingConfigurationOutput, CreateRecordingConfigurationOutputError>) -> Void)
    ...
    func createStreamKey(input: CreateStreamKeyInput, completion: @escaping (SdkResult<CreateStreamKeyOutput, CreateStreamKeyOutputError>) -> Void)
    ...
    func deletePlaybackKeyPair(input: DeletePlaybackKeyPairInput, completion: @escaping (SdkResult<DeletePlaybackKeyPairOutput, DeletePlaybackKeyPairOutputError>) -> Void)
    ...
    func deleteRecordingConfiguration(input: DeleteRecordingConfigurationInput, completion: @escaping (SdkResult<DeleteRecordingConfigurationOutput, DeleteRecordingConfigurationOutputError>) -> Void)
    /// <p>Deletes the stream key for the specified ARN, so it can no longer be used to
    ///       stream.</p>
    func deleteStreamKey(input: DeleteStreamKeyInput, completion: @escaping (SdkResult<DeleteStreamKeyOutput, DeleteStreamKeyOutputError>) -> Void)
    /// <p>Gets the channel configuration for the specified channel ARN. See also <a>BatchGetChannel</a>.</p>
    func getChannel(input: GetChannelInput, completion: @escaping (SdkResult<GetChannelOutput, GetChannelOutputError>) -> Void)
    ...
    ///       Guide</i>.</p>
    func getPlaybackKeyPair(input: GetPlaybackKeyPairInput, completion: @escaping (SdkResult<GetPlaybackKeyPairOutput, GetPlaybackKeyPairOutputError>) -> Void)
    /// <p>Gets the recording configuration for the specified ARN.</p>
    func getRecordingConfiguration(input: GetRecordingConfigurationInput, completion: @escaping (SdkResult<GetRecordingConfigurationOutput, GetRecordingConfigurationOutputError>) -> Void)
    /// <p>Gets information about the active (live) stream on a specified channel.</p>
    func getStream(input: GetStreamInput, completion: @escaping (SdkResult<GetStreamOutput, GetStreamOutputError>) -> Void)
    /// <p>Gets stream-key information for a specified ARN.</p>
    func getStreamKey(input: GetStreamKeyInput, completion: @escaping (SdkResult<GetStreamKeyOutput, GetStreamKeyOutputError>) -> Void)
    ...
    func importPlaybackKeyPair(input: ImportPlaybackKeyPairInput, completion: @escaping (SdkResult<ImportPlaybackKeyPairOutput, ImportPlaybackKeyPairOutputError>) -> Void)
    ...
    ///         Channels</a> in the <i>Amazon IVS User Guide</i>.</p>
    func listPlaybackKeyPairs(input: ListPlaybackKeyPairsInput, completion: @escaping (SdkResult<ListPlaybackKeyPairsOutput, ListPlaybackKeyPairsOutputError>) -> Void)
    ...
    func listRecordingConfigurations(input: ListRecordingConfigurationsInput, completion: @escaping (SdkResult<ListRecordingConfigurationsOutput, ListRecordingConfigurationsOutputError>) -> Void)
    /// <p>Gets summary information about stream keys for the specified channel.</p>
    func listStreamKeys(input: ListStreamKeysInput, completion: @escaping (SdkResult<ListStreamKeysOutput, ListStreamKeysOutputError>) -> Void)
    ...
    func putMetadata(input: PutMetadataInput, completion: @escaping (SdkResult<PutMetadataOutput, PutMetadataOutputError>) -> Void)
    ...
    ///          </note>
    func stopStream(input: StopStreamInput, completion: @escaping (SdkResult<StopStreamOutput, StopStreamOutputError>) -> Void)
