...
public struct AddFlowMediaStreamsInput: Swift.Equatable {
    ...
    /// This member is required.
    var mediaStreams: [MediaConnectClientTypes.AddMediaStreamRequest]?
...
public struct AddFlowMediaStreamsOutputResponse: Swift.Equatable {
    ...
    var mediaStreams: [MediaConnectClientTypes.MediaStream]?
...
public struct AddFlowOutputsInput: Swift.Equatable {
    ...
    /// This member is required.
    var outputs: [MediaConnectClientTypes.AddOutputRequest]?
...
public struct AddFlowOutputsOutputResponse: Swift.Equatable {
    ...
    var outputs: [MediaConnectClientTypes.Output]?
...
public struct AddFlowSourcesOutputResponse: Swift.Equatable {
    ...
    var sources: [MediaConnectClientTypes.Source]?
...
public struct AddFlowVpcInterfacesInput: Swift.Equatable {
    ...
    /// This member is required.
    var vpcInterfaces: [MediaConnectClientTypes.VpcInterfaceRequest]?
...
public struct AddFlowVpcInterfacesOutputResponse: Swift.Equatable {
    ...
    var vpcInterfaces: [MediaConnectClientTypes.VpcInterface]?
...
extension MediaConnectClientTypes {
    ...
    public struct AddMediaStreamRequest: Swift.Equatable {
        ...
        var attributes: MediaConnectClientTypes.MediaStreamAttributesRequest?
        /// The sample rate (in Hz) for the stream. If the media stream type is video or ancillary data, set this value to 90000. If the media stream type is audio, set this value to either 48000 or 96000.
        var clockRate: Swift.Int?
        /// A description that can help you quickly identify what your media stream is used for.
        var description: Swift.String?
        /// A unique identifier for the media stream.
        /// This member is required.
        var mediaStreamId: Swift.Int?
        /// A name that helps you distinguish one media stream from another.
        /// This member is required.
        var mediaStreamName: Swift.String?
        /// The type of media stream.
        /// This member is required.
        var mediaStreamType: MediaConnectClientTypes.MediaStreamType?
        /// The resolution of the video.
        var videoFormat: Swift.String?
...
extension MediaConnectClientTypes {
    ...
    public struct AddOutputRequest: Swift.Equatable {
        ...
        /// This member is required.
        var `protocol`: MediaConnectClientTypes.ModelProtocol?
        /// The range of IP addresses that should be allowed to initiate output requests to this flow. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block; for example, 10.0.0.0/16.
        var cidrAllowList: [Swift.String]?
        /// A description of the output. This description appears only on the AWS Elemental MediaConnect console and will not be seen by the end user.
        var description: Swift.String?
        /// The IP address from which video will be sent to output destinations.
        var destination: Swift.String?
        /// The type of key used for the encryption. If no keyType is provided, the service will use the default setting (static-key).
        var encryption: MediaConnectClientTypes.Encryption?
        /// The maximum latency in milliseconds for Zixi-based streams.
        var maxLatency: Swift.Int?
        /// The media streams that are associated with the output, and the parameters for those associations.
        var mediaStreamOutputConfigurations: [MediaConnectClientTypes.MediaStreamOutputConfigurationRequest]?
        /// The minimum latency in milliseconds for SRT-based streams. In streams that use the SRT protocol, this value that you set on your MediaConnect source or output represents the minimal potential latency of that connection. The latency of the stream is set to the highest number between the sender’s minimum latency and the receiver’s minimum latency.
        var minLatency: Swift.Int?
        /// The name of the output. This value must be unique within the current flow.
        var name: Swift.String?
        /// The port to use when content is distributed to this output.
        var port: Swift.Int?
        /// The remote ID for the Zixi-pull output stream.
        var remoteId: Swift.String?
        /// The smoothing latency in milliseconds for RIST, RTP, and RTP-FEC streams.
        var smoothingLatency: Swift.Int?
        /// The stream ID that you want to use for this transport. This parameter applies only to Zixi-based streams.
        var streamId: Swift.String?
        /// The name of the VPC interface attachment to use for this output.
        var vpcInterfaceAttachment: MediaConnectClientTypes.VpcInterfaceAttachment?
...
public struct CreateFlowInput: Swift.Equatable {
    ...
    var entitlements: [MediaConnectClientTypes.GrantEntitlementRequest]?
    ...
    var source: MediaConnectClientTypes.SetSourceRequest?
    /// The settings for source failover
    var sourceFailoverConfig: MediaConnectClientTypes.FailoverConfig?
    var sources: [MediaConnectClientTypes.SetSourceRequest]?
...
public struct CreateFlowOutputResponse: Swift.Equatable {
    ...
    var flow: MediaConnectClientTypes.Flow?
...
public struct DeleteFlowOutputResponse: Swift.Equatable {
    ...
    var status: MediaConnectClientTypes.Status?
...
public struct DescribeFlowOutputResponse: Swift.Equatable {
    ...
    var messages: MediaConnectClientTypes.Messages?
...
public struct DescribeOfferingOutputResponse: Swift.Equatable {
    ...
    var offering: MediaConnectClientTypes.Offering?
...
public struct DescribeReservationOutputResponse: Swift.Equatable {
    ...
    var reservation: MediaConnectClientTypes.Reservation?
...
extension MediaConnectClientTypes {
    ...
    public struct DestinationConfigurationRequest: Swift.Equatable {
        ...
        /// This member is required.
        var interface: MediaConnectClientTypes.InterfaceRequest?
...
extension MediaConnectClientTypes {
    ...
    public struct EncodingParameters: Swift.Equatable {
        ...
        /// This member is required.
        var compressionFactor: Swift.Double?
        /// A setting on the encoder that drives compression settings. This property only applies to video media streams associated with outputs that use the ST 2110 JPEG XS protocol, with a flow source that uses the CDI protocol.
        /// This member is required.
        var encoderProfile: MediaConnectClientTypes.EncoderProfile?
...
extension MediaConnectClientTypes {
    ...
    public struct Encryption: Swift.Equatable {
        ...
        var algorithm: MediaConnectClientTypes.Algorithm?
        ...
        var keyType: MediaConnectClientTypes.KeyType?
...
extension MediaConnectClientTypes {
    ...
    public struct Entitlement: Swift.Equatable {
        ...
        var dataTransferSubscriberFeePercent: Swift.Int?
        ...
        /// This member is required.
        var entitlementArn: Swift.String?
        /// An indication of whether the entitlement is enabled.
        var entitlementStatus: MediaConnectClientTypes.EntitlementStatus?
        /// The name of the entitlement.
        /// This member is required.
        var name: Swift.String?
        /// The AWS account IDs that you want to share your content with. The receiving accounts (subscribers) will be allowed to create their own flow using your content as the source.
        /// This member is required.
        var subscribers: [Swift.String]?
...
extension MediaConnectClientTypes {
    ...
    public struct FailoverConfig: Swift.Equatable {
        ...
        var failoverMode: MediaConnectClientTypes.FailoverMode?
        /// Search window time to look for dash-7 packets
        var recoveryWindow: Swift.Int?
        /// The priority you want to assign to a source. You can have a primary stream and a backup stream or two equally prioritized streams.
        var sourcePriority: MediaConnectClientTypes.SourcePriority?
        var state: MediaConnectClientTypes.State?
...
extension MediaConnectClientTypes {
    ...
    public struct Flow: Swift.Equatable {
        ...
        var description: Swift.String?
        /// The IP address from which video will be sent to output destinations.
        var egressIp: Swift.String?
        /// The entitlements in this flow.
        /// This member is required.
        var entitlements: [MediaConnectClientTypes.Entitlement]?
        ...
        /// The settings for the source of the flow.
        /// This member is required.
        var source: MediaConnectClientTypes.Source?
        /// The settings for source failover
        var sourceFailoverConfig: MediaConnectClientTypes.FailoverConfig?
        var sources: [MediaConnectClientTypes.Source]?
...
extension MediaConnectClientTypes {
    ...
    public struct Fmtp: Swift.Equatable {
        ...
        var channelOrder: Swift.String?
        /// The format that is used for the representation of color.
        var colorimetry: MediaConnectClientTypes.Colorimetry?
        /// The frame rate for the video stream, in frames/second. For example: 60000/1001. If you specify a whole number, MediaConnect uses a ratio of N/1. For example, if you specify 60, MediaConnect uses 60/1 as the exactFramerate.
        var exactFramerate: Swift.String?
        /// The pixel aspect ratio (PAR) of the video.
        var par: Swift.String?
        /// The encoding range of the video.
        var range: MediaConnectClientTypes.Range?
        /// The type of compression that was used to smooth the video’s appearance
        var scanMode: MediaConnectClientTypes.ScanMode?
        /// The transfer characteristic system (TCS) that is used in the video.
        var tcs: MediaConnectClientTypes.Tcs?
...
extension MediaConnectClientTypes {
    ...
    public struct InputConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var inputIp: Swift.String?
        /// The port that the flow listens on for an incoming media stream.
        /// This member is required.
        var inputPort: Swift.Int?
...
public struct ListEntitlementsOutputResponse: Swift.Equatable {
    ...
    var entitlements: [MediaConnectClientTypes.ListedEntitlement]?
    /// The token that identifies which batch of results that you want to see. For example, you submit a ListEntitlements request with MaxResults set at 5. The service returns the first batch of results (up to 5) and a NextToken value. To see the next batch of results, you can submit the ListEntitlements request a second time and specify the NextToken value.
    var nextToken: Swift.String?
...
public struct ListFlowsOutputResponse: Swift.Equatable {
    ...
    var flows: [MediaConnectClientTypes.ListedFlow]?
    /// The token that identifies which batch of results that you want to see. For example, you submit a ListFlows request with MaxResults set at 5. The service returns the first batch of results (up to 5) and a NextToken value. To see the next batch of results, you can submit the ListFlows request a second time and specify the NextToken value.
    var nextToken: Swift.String?
...
public struct ListOfferingsOutputResponse: Swift.Equatable {
    ...
    var offerings: [MediaConnectClientTypes.Offering]?
...
public struct ListReservationsOutputResponse: Swift.Equatable {
    ...
    var reservations: [MediaConnectClientTypes.Reservation]?
...
extension MediaConnectClientTypes {
    ...
    public struct ListedEntitlement: Swift.Equatable {
        ...
        /// The name of the entitlement.
        /// This member is required.
        var entitlementName: Swift.String?
...
extension MediaConnectClientTypes {
    ...
    public struct ListedFlow: Swift.Equatable {
        ...
        /// This member is required.
        var sourceType: MediaConnectClientTypes.SourceType?
        /// The current status of the flow.
        /// This member is required.
        var status: MediaConnectClientTypes.Status?
...
extension MediaConnectClientTypes {
    ...
    public struct MediaStream: Swift.Equatable {
        ...
        var attributes: MediaConnectClientTypes.MediaStreamAttributes?
...
extension MediaConnectClientTypes {
    ...
    public struct MediaStreamAttributes: Swift.Equatable {
        ...
        /// This member is required.
        var fmtp: MediaConnectClientTypes.Fmtp?
        /// The audio language, in a format that is recognized by the receiver.
        var lang: Swift.String?
...
extension MediaConnectClientTypes {
    ...
    public struct MediaStreamAttributesRequest: Swift.Equatable {
        /// The settings that you want to use to define the media stream.
        var fmtp: MediaConnectClientTypes.FmtpRequest?
        /// The audio language, in a format that is recognized by the receiver.
        var lang: Swift.String?
...
extension MediaConnectClientTypes {
    ...
    public struct MediaStreamOutputConfiguration: Swift.Equatable {
        ...
        var destinationConfigurations: [MediaConnectClientTypes.DestinationConfiguration]?
        /// The format that was used to encode the data. For ancillary data streams, set the encoding name to smpte291. For audio streams, set the encoding name to pcm. For video, 2110 streams, set the encoding name to raw. For video, JPEG XS streams, set the encoding name to jxsv.
        /// This member is required.
        var encodingName: MediaConnectClientTypes.EncodingName?
        /// Encoding parameters
        var encodingParameters: MediaConnectClientTypes.EncodingParameters?
...
extension MediaConnectClientTypes {
    ...
    public struct MediaStreamOutputConfigurationRequest: Swift.Equatable {
        ...
        var destinationConfigurations: [MediaConnectClientTypes.DestinationConfigurationRequest]?
        /// The format that will be used to encode the data. For ancillary data streams, set the encoding name to smpte291. For audio streams, set the encoding name to pcm. For video, 2110 streams, set the encoding name to raw. For video, JPEG XS streams, set the encoding name to jxsv.
        /// This member is required.
        var encodingName: MediaConnectClientTypes.EncodingName?
        /// A collection of parameters that determine how MediaConnect will convert the content. These fields only apply to outputs on flows that have a CDI source.
        var encodingParameters: MediaConnectClientTypes.EncodingParametersRequest?
...
extension MediaConnectClientTypes {
    ...
    public struct MediaStreamSourceConfiguration: Swift.Equatable {
        ...
        var encodingName: MediaConnectClientTypes.EncodingName?
        /// The transport parameters that are associated with an incoming media stream.
        var inputConfigurations: [MediaConnectClientTypes.InputConfiguration]?
        /// The name of the media stream.
        /// This member is required.
        var mediaStreamName: Swift.String?
...
extension MediaConnectClientTypes {
    ...
    public struct MediaStreamSourceConfigurationRequest: Swift.Equatable {
        ...
        var encodingName: MediaConnectClientTypes.EncodingName?
        /// The transport parameters that you want to associate with the media stream.
        var inputConfigurations: [MediaConnectClientTypes.InputConfigurationRequest]?
        /// The name of the media stream.
        /// This member is required.
        var mediaStreamName: Swift.String?
...
extension MediaConnectClientTypes {
    ...
    public struct Offering: Swift.Equatable {
        ...
        /// This member is required.
        var durationUnits: MediaConnectClientTypes.DurationUnits?
        /// The Amazon Resource Name (ARN) that MediaConnect assigns to the offering.
        /// This member is required.
        var offeringArn: Swift.String?
        /// A description of the offering.
        /// This member is required.
        var offeringDescription: Swift.String?
        /// The cost of a single unit. This value, in combination with priceUnits, makes up the rate.
        /// This member is required.
        var pricePerUnit: Swift.String?
        /// The unit of measurement that is used for billing. This value, in combination with pricePerUnit, makes up the rate.
        /// This member is required.
        var priceUnits: MediaConnectClientTypes.PriceUnits?
        /// A definition of the amount of outbound bandwidth that you would be reserving if you purchase the offering.
        /// This member is required.
        var resourceSpecification: MediaConnectClientTypes.ResourceSpecification?
...
extension MediaConnectClientTypes {
    ...
    public struct Output: Swift.Equatable {
        ...
        var listenerAddress: Swift.String?
        /// The input ARN of the AWS Elemental MediaLive channel. This parameter is relevant only for outputs that were added by creating a MediaLive input.
        var mediaLiveInputArn: Swift.String?
        /// The configuration for each media stream that is associated with the output.
        var mediaStreamOutputConfigurations: [MediaConnectClientTypes.MediaStreamOutputConfiguration]?
        /// The name of the output. This value must be unique within the current flow.
        /// This member is required.
        var name: Swift.String?
        /// The ARN of the output.
        /// This member is required.
        var outputArn: Swift.String?
        /// The port to use when content is distributed to this output.
        var port: Swift.Int?
        /// Attributes related to the transport stream that are used in the output.
        var transport: MediaConnectClientTypes.Transport?
        /// The name of the VPC interface attachment to use for this output.
        var vpcInterfaceAttachment: MediaConnectClientTypes.VpcInterfaceAttachment?
...
public struct RemoveFlowVpcInterfaceInput: Swift.Equatable {
    ...
    /// This member is required.
    var vpcInterfaceName: Swift.String?
...
public struct RemoveFlowVpcInterfaceOutputResponse: Swift.Equatable {
    ...
    var nonDeletedNetworkInterfaceIds: [Swift.String]?
...
extension MediaConnectClientTypes {
    ...
    public struct Reservation: Swift.Equatable {
        ...
        /// This member is required.
        var reservationState: MediaConnectClientTypes.ReservationState?
...
extension MediaConnectClientTypes {
    ...
    public struct ResourceSpecification: Swift.Equatable {
        ...
        var reservedBitrate: Swift.Int?
        /// The type of resource and the unit that is being billed for.
        /// This member is required.
        var resourceType: MediaConnectClientTypes.ResourceType?
...
extension MediaConnectClientTypes {
    ...
    public struct SetSourceRequest: Swift.Equatable {
        ...
        var decryption: MediaConnectClientTypes.Encryption?
        /// A description for the source. This value is not used or seen outside of the current AWS Elemental MediaConnect account.
        var description: Swift.String?
        /// The ARN of the entitlement that allows you to subscribe to this flow. The entitlement is set by the flow originator, and the ARN is generated as part of the originator's flow.
        var entitlementArn: Swift.String?
        /// The port that the flow will be listening on for incoming content.
        var ingestPort: Swift.Int?
        /// The smoothing max bitrate for RIST, RTP, and RTP-FEC streams.
        var maxBitrate: Swift.Int?
        /// The maximum latency in milliseconds. This parameter applies only to RIST-based and Zixi-based streams.
        var maxLatency: Swift.Int?
        /// The size of the buffer (in milliseconds) to use to sync incoming source data.
        var maxSyncBuffer: Swift.Int?
        /// The media streams that are associated with the source, and the parameters for those associations.
        var mediaStreamSourceConfigurations: [MediaConnectClientTypes.MediaStreamSourceConfigurationRequest]?
        /// The minimum latency in milliseconds for SRT-based streams. In streams that use the SRT protocol, this value that you set on your MediaConnect source or output represents the minimal potential latency of that connection. The latency of the stream is set to the highest number between the sender’s minimum latency and the receiver’s minimum latency.
        var minLatency: Swift.Int?
        ...
        var whitelistCidr: Swift.String?
...
extension MediaConnectClientTypes {
    ...
    public struct Source: Swift.Equatable {
        ...
        var ingestIp: Swift.String?
        /// The port that the flow will be listening on for incoming content.
        var ingestPort: Swift.Int?
        /// The media streams that are associated with the source, and the parameters for those associations.
        var mediaStreamSourceConfigurations: [MediaConnectClientTypes.MediaStreamSourceConfiguration]?
        /// The name of the source.
        /// This member is required.
        var name: Swift.String?
...
extension MediaConnectClientTypes {
    ...
    public struct SourcePriority: Swift.Equatable {
        ...
        var primarySource: Swift.String?
...
public struct UpdateFlowEntitlementInput: Swift.Equatable {
    ...
    var encryption: MediaConnectClientTypes.UpdateEncryption?
...
public struct UpdateFlowEntitlementOutputResponse: Swift.Equatable {
    ...
    var entitlement: MediaConnectClientTypes.Entitlement?
...
public struct UpdateFlowInput: Swift.Equatable {
    ...
    var flowArn: Swift.String?
    /// The settings for source failover
    var sourceFailoverConfig: MediaConnectClientTypes.UpdateFailoverConfig?
...
public struct UpdateFlowMediaStreamOutputResponse: Swift.Equatable {
    ...
    var mediaStream: MediaConnectClientTypes.MediaStream?
...
public struct UpdateFlowOutputOutputResponse: Swift.Equatable {
    ...
    var output: MediaConnectClientTypes.Output?
...
public struct UpdateFlowSourceInput: Swift.Equatable {
    ...
    var decryption: MediaConnectClientTypes.UpdateEncryption?
    /// A description for the source. This value is not used or seen outside of the current AWS Elemental MediaConnect account.
    var description: Swift.String?
    /// The ARN of the entitlement that allows you to subscribe to this flow. The entitlement is set by the flow originator, and the ARN is generated as part of the originator's flow.
    var entitlementArn: Swift.String?
...
extension MediaConnectClientTypes {
    ...
    public struct VpcInterface: Swift.Equatable {
        ...
        /// This member is required.
        var networkInterfaceType: MediaConnectClientTypes.NetworkInterfaceType?
