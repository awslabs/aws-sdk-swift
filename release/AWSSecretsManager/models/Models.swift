...
public struct CreateSecretInput: Swift.Equatable {
    ...
    var addReplicaRegions: [SecretsManagerClientTypes.ReplicaRegionType]?
    ...
    var forceOverwriteReplicaSecret: Swift.Bool
    ...
    var secretBinary: ClientRuntime.Data?
    ...
    var tags: [SecretsManagerClientTypes.Tag]?
...
public struct CreateSecretOutputResponse: Swift.Equatable {
    ...
    var replicationStatus: [SecretsManagerClientTypes.ReplicationStatusType]?
...
public struct DeleteSecretInput: Swift.Equatable {
    ...
    var forceDeleteWithoutRecovery: Swift.Bool
    ...
    var recoveryWindowInDays: Swift.Int
...
public struct DescribeSecretOutputResponse: Swift.Equatable {
    ...
    var deletedDate: ClientRuntime.Date?
    /// The description of the secret.
    var description: Swift.String?
    ...
    var lastAccessedDate: ClientRuntime.Date?
    /// The last date and time that this secret was modified in any way.
    var lastChangedDate: ClientRuntime.Date?
    ...
    var lastRotatedDate: ClientRuntime.Date?
    /// The name of the secret.
    var name: Swift.String?
    ...
    var rotationEnabled: Swift.Bool
    /// The ARN of the Lambda function that Secrets Manager invokes to rotate the secret.
    var rotationLambdaARN: Swift.String?
    /// The rotation schedule and Lambda function for this secret. If the secret previously had rotation turned on, but it is now turned off, this field shows the previous rotation schedule and rotation function. If the secret never had rotation turned on, this field is omitted.
    var rotationRules: SecretsManagerClientTypes.RotationRulesType?
    ...
    var versionIdsToStages: [Swift.String:[Swift.String]]?
...
extension SecretsManagerClientTypes {
    ...
    public struct Filter: Swift.Equatable {
        ...
        var key: SecretsManagerClientTypes.FilterNameStringType?
...
public struct GetRandomPasswordInput: Swift.Equatable {
    ...
    var excludeCharacters: Swift.String?
    /// Specifies whether to exclude lowercase letters from the password. If you don't include this switch, the password can contain lowercase letters.
    var excludeLowercase: Swift.Bool
    /// Specifies whether to exclude numbers from the password. If you don't include this switch, the password can contain numbers.
    var excludeNumbers: Swift.Bool
    /// Specifies whether to exclude the following punctuation characters from the password: ! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _ ` { | } ~. If you don't include this switch, the password can contain punctuation.
    var excludePunctuation: Swift.Bool
    /// Specifies whether to exclude uppercase letters from the password. If you don't include this switch, the password can contain uppercase letters.
    var excludeUppercase: Swift.Bool
    /// Specifies whether to include the space character. If you include this switch, the password can contain space characters.
    var includeSpace: Swift.Bool
    /// The length of the password. If you don't include this parameter, the default length is 32 characters.
    var passwordLength: Swift.Int
    /// Specifies whether to include at least one upper and lowercase letter, one number, and one punctuation. If you don't include this switch, the password contains at least one of every character type.
    var requireEachIncludedType: Swift.Bool
...
public struct GetRandomPasswordOutputResponse: Swift.Equatable {
    ...
    var randomPassword: Swift.String?
...
public struct GetResourcePolicyOutputResponse: Swift.Equatable {
    ...
    var resourcePolicy: Swift.String?
...
public struct GetSecretValueOutputResponse: Swift.Equatable {
    ...
    var versionStages: [Swift.String]?
...
public struct ListSecretVersionIdsOutputResponse: Swift.Equatable {
    ...
    var versions: [SecretsManagerClientTypes.SecretVersionsListEntry]?
...
public struct ListSecretsInput: Swift.Equatable {
    ...
    var filters: [SecretsManagerClientTypes.Filter]?
    ...
    var sortOrder: SecretsManagerClientTypes.SortOrderType?
...
public struct ListSecretsOutputResponse: Swift.Equatable {
    ...
    var secretList: [SecretsManagerClientTypes.SecretListEntry]?
...
public struct RemoveRegionsFromReplicationInput: Swift.Equatable {
    ...
    /// This member is required.
    var removeReplicaRegions: [Swift.String]?
...
extension SecretsManagerClientTypes {
    ...
    public struct ReplicationStatusType: Swift.Equatable {
        ...
        var status: SecretsManagerClientTypes.StatusType?
...
extension SecretsManagerClientTypes {
    ...
    public struct RotationRulesType: Swift.Equatable {
        ...
        var automaticallyAfterDays: Swift.Int
...
extension SecretsManagerClientTypes {
    ...
    public struct SecretListEntry: Swift.Equatable {
        ...
        var secretVersionsToStages: [Swift.String:[Swift.String]]?
...
public struct UpdateSecretVersionStageInput: Swift.Equatable {
    ...
    var moveToVersionId: Swift.String?
    ...
    var removeFromVersionId: Swift.String?
...
public struct ValidateResourcePolicyOutputResponse: Swift.Equatable {
    ...
    var policyValidationPassed: Swift.Bool
    /// Validation errors if your policy didn't pass validation.
    var validationErrors: [SecretsManagerClientTypes.ValidationErrorsEntry]?
