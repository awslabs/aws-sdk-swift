...
public struct CancelRotateSecretInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelRotateSecretInputURLHostMiddleware"
    ...
    public typealias MInput = CancelRotateSecretInput
    public typealias MOutput = ClientRuntime.OperationOutput<CancelRotateSecretOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelRotateSecretOutputError>
}

public struct CancelRotateSecretInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelRotateSecretInputURLPathMiddleware"
...
public struct CreateSecretInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSecretInputURLHostMiddleware"
    ...
    public typealias MInput = CreateSecretInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateSecretOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateSecretOutputError>
}

public struct CreateSecretInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSecretInputURLPathMiddleware"
...
public struct CreateSecretInput: Swift.Equatable {
    ...
    ///
    ///
    /// This parameter requires a JSON text string argument. For information on how to format a JSON parameter for the various command line tool environments, see [Using JSON for Parameters](https://docs.aws.amazon.com/cli/latest/userguide/cli-using-param.html#cli-using-param-json) in the CLI User Guide. For example: [{"Key":"CostCenter","Value":"12345"},{"Key":"environment","Value":"production"}] If your command-line tool or SDK requires quotation marks around the parameter, you should use single quotes to avoid confusion with the double quotes required in the JSON text. The following basic restrictions apply to tags:
    ///
...
public struct DeleteSecretInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSecretInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteSecretInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteSecretOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteSecretOutputError>
}

public struct DeleteSecretInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSecretInputURLPathMiddleware"
...
public struct DescribeSecretInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSecretInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeSecretInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeSecretOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeSecretOutputError>
}

public struct DescribeSecretInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSecretInputURLPathMiddleware"
...
public struct GetRandomPasswordInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRandomPasswordInputURLHostMiddleware"
    ...
    public typealias MInput = GetRandomPasswordInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetRandomPasswordOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRandomPasswordOutputError>
}

public struct GetRandomPasswordInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRandomPasswordInputURLPathMiddleware"
...
public struct GetSecretValueInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetSecretValueInputURLHostMiddleware"
    ...
    public typealias MInput = GetSecretValueInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetSecretValueOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetSecretValueOutputError>
}

public struct GetSecretValueInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetSecretValueInputURLPathMiddleware"
...
public struct GetSecretValueInput: Swift.Equatable {
    ...
    /// This member is required.
    public var secretId: Swift.String?
    /// Specifies the unique identifier of the version of the secret that you want to retrieve. If you specify both this parameter and VersionStage, the two parameters must refer to the same secret version. If you don't specify either a VersionStage or VersionId then the default is to perform the operation on the version with the VersionStage value of AWSCURRENT. This value is typically a [UUID-type](https://wikipedia.org/wiki/Universally_unique_identifier) value with 32 hexadecimal digits.
    public var versionId: Swift.String?
...
public struct ListSecretVersionIdsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSecretVersionIdsInputURLHostMiddleware"
    ...
    public typealias MInput = ListSecretVersionIdsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListSecretVersionIdsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListSecretVersionIdsOutputError>
}

public struct ListSecretVersionIdsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSecretVersionIdsInputURLPathMiddleware"
...
public struct ListSecretsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSecretsInputURLHostMiddleware"
    ...
    public typealias MInput = ListSecretsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListSecretsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListSecretsOutputError>
}

public struct ListSecretsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSecretsInputURLPathMiddleware"
...
public struct PutSecretValueInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutSecretValueInputURLHostMiddleware"
    ...
    public typealias MInput = PutSecretValueInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutSecretValueOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutSecretValueOutputError>
}

public struct PutSecretValueInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutSecretValueInputURLPathMiddleware"
...
public struct RemoveRegionsFromReplicationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RemoveRegionsFromReplicationInputURLHostMiddleware"
    ...
    public typealias MInput = RemoveRegionsFromReplicationInput
    public typealias MOutput = ClientRuntime.OperationOutput<RemoveRegionsFromReplicationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RemoveRegionsFromReplicationOutputError>
}

public struct RemoveRegionsFromReplicationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RemoveRegionsFromReplicationInputURLPathMiddleware"
...
public struct ReplicateSecretToRegionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReplicateSecretToRegionsInputURLHostMiddleware"
    ...
    public typealias MInput = ReplicateSecretToRegionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ReplicateSecretToRegionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ReplicateSecretToRegionsOutputError>
}

public struct ReplicateSecretToRegionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReplicateSecretToRegionsInputURLPathMiddleware"
...
public struct RestoreSecretInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RestoreSecretInputURLHostMiddleware"
    ...
    public typealias MInput = RestoreSecretInput
    public typealias MOutput = ClientRuntime.OperationOutput<RestoreSecretOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RestoreSecretOutputError>
}

public struct RestoreSecretInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RestoreSecretInputURLPathMiddleware"
...
public struct RotateSecretInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RotateSecretInputURLHostMiddleware"
    ...
    public typealias MInput = RotateSecretInput
    public typealias MOutput = ClientRuntime.OperationOutput<RotateSecretOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RotateSecretOutputError>
}

public struct RotateSecretInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RotateSecretInputURLPathMiddleware"
...
extension SecretsManagerClientTypes {
    ...
    public struct SecretListEntry: Swift.Equatable {
        /// The Amazon Resource Name (ARN) of the secret. For more information about ARNs in Secrets Manager, see [Policy Resources](https://docs.aws.amazon.com/secretsmanager/latest/userguide/reference_iam-permissions.html#iam-resources) in the Amazon Web Services Secrets Manager User Guide.
        public var aRN: Swift.String?
...
public struct StopReplicationToReplicaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopReplicationToReplicaInputURLHostMiddleware"
    ...
    public typealias MInput = StopReplicationToReplicaInput
    public typealias MOutput = ClientRuntime.OperationOutput<StopReplicationToReplicaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopReplicationToReplicaOutputError>
}

public struct StopReplicationToReplicaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopReplicationToReplicaInputURLPathMiddleware"
...
public struct UntagResourceInput: Swift.Equatable {
    ...
    /// This member is required.
    public var secretId: Swift.String?
    /// A list of tag key names to remove from the secret. You don't specify the value. Both the key and its associated value are removed. This parameter to the API requires a JSON text string argument. For information on how to format a JSON parameter for the various command line tool environments, see [Using JSON for Parameters](https://docs.aws.amazon.com/cli/latest/userguide/cli-using-param.html#cli-using-param-json) in the CLI User Guide.
    /// This member is required.
...
public struct UpdateSecretInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSecretInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateSecretInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateSecretOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateSecretOutputError>
}

public struct UpdateSecretInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSecretInputURLPathMiddleware"
...
public struct UpdateSecretVersionStageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSecretVersionStageInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateSecretVersionStageInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateSecretVersionStageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateSecretVersionStageOutputError>
}

public struct UpdateSecretVersionStageInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSecretVersionStageInputURLPathMiddleware"
...
public struct ValidateResourcePolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ValidateResourcePolicyInputURLHostMiddleware"
    ...
    public typealias MInput = ValidateResourcePolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<ValidateResourcePolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ValidateResourcePolicyOutputError>
}

public struct ValidateResourcePolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ValidateResourcePolicyInputURLPathMiddleware"
...
public struct ValidateResourcePolicyInput: Swift.Equatable {
    /// A JSON-formatted string constructed according to the grammar and syntax for an Amazon Web Services resource-based policy. The policy in the string identifies who can access or manage this secret and its versions. For information on how to format a JSON parameter for the various command line tool environments, see [Using JSON for Parameters](http://docs.aws.amazon.com/cli/latest/userguide/cli-using-param.html#cli-using-param-json) in the CLI User Guide.publi
    /// This member is required.
    public var resourcePolicy: Swift.String?
