...
extension SpotFleetRequestConfigData: CustomDebugStringConvertible {
    public var debugDescription: String {
        "SpotFleetRequestConfigData(allocationStrategy: \(String(describing: allocationStrategy)), clientToken: \(String(describing: clientToken)), excessCapacityTerminationPolicy: \(String(describing: excessCapacityTerminationPolicy)), fulfilledCapacity: \(String(describing: fulfilledCapacity)), iamFleetRole: \(String(describing: iamFleetRole)), instanceInterruptionBehavior: \(String(describing: instanceInterruptionBehavior)), instancePoolsToUseCount: \(String(describing: instancePoolsToUseCount)), launchSpecifications: \(String(describing: launchSpecifications)), launchTemplateConfigs: \(String(describing: launchTemplateConfigs)), loadBalancersConfig: \(String(describing: loadBalancersConfig)), onDemandAllocationStrategy: \(String(describing: onDemandAllocationStrategy)), onDemandFulfilledCapacity: \(String(describing: onDemandFulfilledCapacity)), onDemandMaxTotalPrice: \(String(describing: onDemandMaxTotalPrice)), onDemandTargetCapacity: \(String(describing: onDemandTargetCapacity)), replaceUnhealthyInstances: \(String(describing: replaceUnhealthyInstances)), spotMaintenanceStrategies: \(String(describing: spotMaintenanceStrategies)), spotMaxTotalPrice: \(String(describing: spotMaxTotalPrice)), spotPrice: \(String(describing: spotPrice)), tagSpecifications: \(String(describing: tagSpecifications)), targetCapacity: \(String(describing: targetCapacity)), terminateInstancesWithExpiration: \(String(describing: terminateInstancesWithExpiration)), type: \(String(describing: type)), validFrom: \(String(describing: validFrom)), validUntil: \(String(describing: validUntil)))"}
}
