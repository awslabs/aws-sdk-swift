...
extension InstanceMarketOptionsRequest: Codable, Reflection {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let spotOptionsDecoded = try containerValues.decodeIfPresent(SpotMarketOptions.self, forKey: .spotOptions)
