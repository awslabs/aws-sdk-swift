...
extension ModifyVpnTunnelOptionsSpecification: Codable, Reflection {
        ...
        if let iKEVersions = iKEVersions {
            if !iKEVersions.isEmpty {
                for (index0, ikeversionsrequestlistvalue0) in iKEVersions.enumerated() {
                    var iKEVersionsContainer0 = container.nestedContainer(keyedBy: Key.self, forKey: Key("IKEVersion.\(index0.advanced(by: 1))"))
                    try iKEVersionsContainer0.encode(ikeversionsrequestlistvalue0, forKey: Key(""))
                }
            }
        }
        if let phase1DHGroupNumbers = phase1DHGroupNumbers {
            if !phase1DHGroupNumbers.isEmpty {
                for (index0, phase1dhgroupnumbersrequestlistvalue0) in phase1DHGroupNumbers.enumerated() {
                    var phase1DHGroupNumbersContainer0 = container.nestedContainer(keyedBy: Key.self, forKey: Key("Phase1DHGroupNumber.\(index0.advanced(by: 1))"))
                    try phase1DHGroupNumbersContainer0.encode(phase1dhgroupnumbersrequestlistvalue0, forKey: Key(""))
                }
            }
        }
        if let phase1EncryptionAlgorithms = phase1EncryptionAlgorithms {
            if !phase1EncryptionAlgorithms.isEmpty {
                for (index0, phase1encryptionalgorithmsrequestlistvalue0) in phase1EncryptionAlgorithms.enumerated() {
                    var phase1EncryptionAlgorithmsContainer0 = container.nestedContainer(keyedBy: Key.self, forKey: Key("Phase1EncryptionAlgorithm.\(index0.advanced(by: 1))"))
                    try phase1EncryptionAlgorithmsContainer0.encode(phase1encryptionalgorithmsrequestlistvalue0, forKey: Key(""))
                }
            }
        }
        if let phase1IntegrityAlgorithms = phase1IntegrityAlgorithms {
            if !phase1IntegrityAlgorithms.isEmpty {
                for (index0, phase1integrityalgorithmsrequestlistvalue0) in phase1IntegrityAlgorithms.enumerated() {
                    var phase1IntegrityAlgorithmsContainer0 = container.nestedContainer(keyedBy: Key.self, forKey: Key("Phase1IntegrityAlgorithm.\(index0.advanced(by: 1))"))
                    try phase1IntegrityAlgorithmsContainer0.encode(phase1integrityalgorithmsrequestlistvalue0, forKey: Key(""))
                }
            }
        }
        ...
        if let phase2DHGroupNumbers = phase2DHGroupNumbers {
            if !phase2DHGroupNumbers.isEmpty {
                for (index0, phase2dhgroupnumbersrequestlistvalue0) in phase2DHGroupNumbers.enumerated() {
                    var phase2DHGroupNumbersContainer0 = container.nestedContainer(keyedBy: Key.self, forKey: Key("Phase2DHGroupNumber.\(index0.advanced(by: 1))"))
                    try phase2DHGroupNumbersContainer0.encode(phase2dhgroupnumbersrequestlistvalue0, forKey: Key(""))
                }
            }
        }
        if let phase2EncryptionAlgorithms = phase2EncryptionAlgorithms {
            if !phase2EncryptionAlgorithms.isEmpty {
                for (index0, phase2encryptionalgorithmsrequestlistvalue0) in phase2EncryptionAlgorithms.enumerated() {
                    var phase2EncryptionAlgorithmsContainer0 = container.nestedContainer(keyedBy: Key.self, forKey: Key("Phase2EncryptionAlgorithm.\(index0.advanced(by: 1))"))
                    try phase2EncryptionAlgorithmsContainer0.encode(phase2encryptionalgorithmsrequestlistvalue0, forKey: Key(""))
                }
            }
        }
        if let phase2IntegrityAlgorithms = phase2IntegrityAlgorithms {
            if !phase2IntegrityAlgorithms.isEmpty {
                for (index0, phase2integrityalgorithmsrequestlistvalue0) in phase2IntegrityAlgorithms.enumerated() {
                    var phase2IntegrityAlgorithmsContainer0 = container.nestedContainer(keyedBy: Key.self, forKey: Key("Phase2IntegrityAlgorithm.\(index0.advanced(by: 1))"))
                    try phase2IntegrityAlgorithmsContainer0.encode(phase2integrityalgorithmsrequestlistvalue0, forKey: Key(""))
                }
            }
        }
    ...
    public init (from decoder: Decoder) throws {
        ...
        if containerValues.contains(.phase1EncryptionAlgorithms) {
            ...
            if let phase1EncryptionAlgorithmsWrappedContainer = phase1EncryptionAlgorithmsWrappedContainer {
                let phase1EncryptionAlgorithmsContainer = try phase1EncryptionAlgorithmsWrappedContainer.decodeIfPresent([Phase1EncryptionAlgorithmsRequestListValue].self, forKey: .member)
                var phase1EncryptionAlgorithmsBuffer:[Phase1EncryptionAlgorithmsRequestListValue]? = nil
                if let phase1EncryptionAlgorithmsContainer = phase1EncryptionAlgorithmsContainer {
                    phase1EncryptionAlgorithmsBuffer = [Phase1EncryptionAlgorithmsRequestListValue]()
        ...
        if containerValues.contains(.phase2EncryptionAlgorithms) {
            ...
            if let phase2EncryptionAlgorithmsWrappedContainer = phase2EncryptionAlgorithmsWrappedContainer {
                let phase2EncryptionAlgorithmsContainer = try phase2EncryptionAlgorithmsWrappedContainer.decodeIfPresent([Phase2EncryptionAlgorithmsRequestListValue].self, forKey: .member)
                var phase2EncryptionAlgorithmsBuffer:[Phase2EncryptionAlgorithmsRequestListValue]? = nil
                if let phase2EncryptionAlgorithmsContainer = phase2EncryptionAlgorithmsContainer {
                    phase2EncryptionAlgorithmsBuffer = [Phase2EncryptionAlgorithmsRequestListValue]()
        ...
        if containerValues.contains(.phase1IntegrityAlgorithms) {
            ...
            if let phase1IntegrityAlgorithmsWrappedContainer = phase1IntegrityAlgorithmsWrappedContainer {
                let phase1IntegrityAlgorithmsContainer = try phase1IntegrityAlgorithmsWrappedContainer.decodeIfPresent([Phase1IntegrityAlgorithmsRequestListValue].self, forKey: .member)
                var phase1IntegrityAlgorithmsBuffer:[Phase1IntegrityAlgorithmsRequestListValue]? = nil
                if let phase1IntegrityAlgorithmsContainer = phase1IntegrityAlgorithmsContainer {
                    phase1IntegrityAlgorithmsBuffer = [Phase1IntegrityAlgorithmsRequestListValue]()
        ...
        if containerValues.contains(.phase2IntegrityAlgorithms) {
            ...
            if let phase2IntegrityAlgorithmsWrappedContainer = phase2IntegrityAlgorithmsWrappedContainer {
                let phase2IntegrityAlgorithmsContainer = try phase2IntegrityAlgorithmsWrappedContainer.decodeIfPresent([Phase2IntegrityAlgorithmsRequestListValue].self, forKey: .member)
                var phase2IntegrityAlgorithmsBuffer:[Phase2IntegrityAlgorithmsRequestListValue]? = nil
                if let phase2IntegrityAlgorithmsContainer = phase2IntegrityAlgorithmsContainer {
                    phase2IntegrityAlgorithmsBuffer = [Phase2IntegrityAlgorithmsRequestListValue]()
        ...
        if containerValues.contains(.phase1DHGroupNumbers) {
            ...
            if let phase1DHGroupNumbersWrappedContainer = phase1DHGroupNumbersWrappedContainer {
                let phase1DHGroupNumbersContainer = try phase1DHGroupNumbersWrappedContainer.decodeIfPresent([Phase1DHGroupNumbersRequestListValue].self, forKey: .member)
                var phase1DHGroupNumbersBuffer:[Phase1DHGroupNumbersRequestListValue]? = nil
                if let phase1DHGroupNumbersContainer = phase1DHGroupNumbersContainer {
                    phase1DHGroupNumbersBuffer = [Phase1DHGroupNumbersRequestListValue]()
        ...
        if containerValues.contains(.phase2DHGroupNumbers) {
            ...
            if let phase2DHGroupNumbersWrappedContainer = phase2DHGroupNumbersWrappedContainer {
                let phase2DHGroupNumbersContainer = try phase2DHGroupNumbersWrappedContainer.decodeIfPresent([Phase2DHGroupNumbersRequestListValue].self, forKey: .member)
                var phase2DHGroupNumbersBuffer:[Phase2DHGroupNumbersRequestListValue]? = nil
                if let phase2DHGroupNumbersContainer = phase2DHGroupNumbersContainer {
                    phase2DHGroupNumbersBuffer = [Phase2DHGroupNumbersRequestListValue]()
        ...
        if containerValues.contains(.iKEVersions) {
            ...
            if let iKEVersionsWrappedContainer = iKEVersionsWrappedContainer {
                let iKEVersionsContainer = try iKEVersionsWrappedContainer.decodeIfPresent([IKEVersionsRequestListValue].self, forKey: .member)
                var iKEVersionsBuffer:[IKEVersionsRequestListValue]? = nil
                if let iKEVersionsContainer = iKEVersionsContainer {
                    iKEVersionsBuffer = [IKEVersionsRequestListValue]()
