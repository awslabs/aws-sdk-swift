...
extension VpnConnectionOptions: CustomDebugStringConvertible {
    public var debugDescription: String {
        "VpnConnectionOptions(enableAcceleration: \(String(describing: enableAcceleration)), localIpv4NetworkCidr: \(String(describing: localIpv4NetworkCidr)), localIpv6NetworkCidr: \(String(describing: localIpv6NetworkCidr)), remoteIpv4NetworkCidr: \(String(describing: remoteIpv4NetworkCidr)), remoteIpv6NetworkCidr: \(String(describing: remoteIpv6NetworkCidr)), staticRoutesOnly: \(String(describing: staticRoutesOnly)), tunnelInsideIpVersion: \(String(describing: tunnelInsideIpVersion)), tunnelOptions: \(String(describing: tunnelOptions)))"}
}
