...
extension LaunchTemplateInstanceMetadataOptions: Codable, Reflection {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let stateDecoded = try containerValues.decodeIfPresent(LaunchTemplateInstanceMetadataOptionsState.self, forKey: .state)
        state = stateDecoded
