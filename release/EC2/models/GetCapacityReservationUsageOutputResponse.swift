...
public struct GetCapacityReservationUsageOutputResponse: Equatable {
...
extension GetCapacityReservationUsageOutputResponse: CustomDebugStringConvertible {
    public var debugDescription: String {
        "GetCapacityReservationUsageOutputResponse(availableInstanceCount: \(String(describing: availableInstanceCount)), capacityReservationId: \(String(describing: capacityReservationId)), instanceType: \(String(describing: instanceType)), instanceUsages: \(String(describing: instanceUsages)), nextToken: \(String(describing: nextToken)), state: \(String(describing: state)), totalInstanceCount: \(String(describing: totalInstanceCount)))"}
}
