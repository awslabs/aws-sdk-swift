...
public struct DisableSerialConsoleAccessOutputResponse: Equatable {
...
extension DisableSerialConsoleAccessOutputResponse: CustomDebugStringConvertible {
    public var debugDescription: String {
        "DisableSerialConsoleAccessOutputResponse(serialConsoleAccessEnabled: \(String(describing: serialConsoleAccessEnabled)))"}
}
