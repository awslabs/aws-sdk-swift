...
public struct ReplaceRouteInputHeadersMiddleware: Middleware {
    public let id: String = "ReplaceRouteInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: SerializeStepInput<ReplaceRouteInput>,
                  next: H) -> Swift.Result<OperationOutput<ReplaceRouteOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = SerializeStepInput<ReplaceRouteInput>
    public typealias MOutput = OperationOutput<ReplaceRouteOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = SdkError<ReplaceRouteOutputError>
}

public struct ReplaceRouteInputQueryItemMiddleware: Middleware {
    public let id: String = "ReplaceRouteInputQueryItemMiddleware"
...
public struct ReplaceRouteInputBodyMiddleware: Middleware {
    public let id: String = "ReplaceRouteInputBodyMiddleware"
...
extension ReplaceRouteInput: Encodable, Reflection {
    public func encode(to encoder: Encoder) throws {
        ...
        if localTarget != false {
            try container.encode(localTarget, forKey: Key("LocalTarget"))
        }
        ...
        try container.encode("ReplaceRoute", forKey:Key("Action"))
