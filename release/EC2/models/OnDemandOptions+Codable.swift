...
extension OnDemandOptions: Codable, Reflection {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let capacityReservationOptionsDecoded = try containerValues.decodeIfPresent(CapacityReservationOptions.self, forKey: .capacityReservationOptions)
