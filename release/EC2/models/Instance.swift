...
extension Instance: CustomDebugStringConvertible {
    public var debugDescription: String {
        "Instance(amiLaunchIndex: \(String(describing: amiLaunchIndex)), architecture: \(String(describing: architecture)), blockDeviceMappings: \(String(describing: blockDeviceMappings)), bootMode: \(String(describing: bootMode)), capacityReservationId: \(String(describing: capacityReservationId)), capacityReservationSpecification: \(String(describing: capacityReservationSpecification)), clientToken: \(String(describing: clientToken)), cpuOptions: \(String(describing: cpuOptions)), ebsOptimized: \(String(describing: ebsOptimized)), elasticGpuAssociations: \(String(describing: elasticGpuAssociations)), elasticInferenceAcceleratorAssociations: \(String(describing: elasticInferenceAcceleratorAssociations)), enaSupport: \(String(describing: enaSupport)), enclaveOptions: \(String(describing: enclaveOptions)), hibernationOptions: \(String(describing: hibernationOptions)), hypervisor: \(String(describing: hypervisor)), iamInstanceProfile: \(String(describing: iamInstanceProfile)), imageId: \(String(describing: imageId)), instanceId: \(String(describing: instanceId)), instanceLifecycle: \(String(describing: instanceLifecycle)), instanceType: \(String(describing: instanceType)), kernelId: \(String(describing: kernelId)), keyName: \(String(describing: keyName)), launchTime: \(String(describing: launchTime)), licenses: \(String(describing: licenses)), metadataOptions: \(String(describing: metadataOptions)), monitoring: \(String(describing: monitoring)), networkInterfaces: \(String(describing: networkInterfaces)), outpostArn: \(String(describing: outpostArn)), placement: \(String(describing: placement)), platform: \(String(describing: platform)), privateDnsName: \(String(describing: privateDnsName)), privateIpAddress: \(String(describing: privateIpAddress)), productCodes: \(String(describing: productCodes)), publicDnsName: \(String(describing: publicDnsName)), publicIpAddress: \(String(describing: publicIpAddress)), ramdiskId: \(String(describing: ramdiskId)), rootDeviceName: \(String(describing: rootDeviceName)), rootDeviceType: \(String(describing: rootDeviceType)), securityGroups: \(String(describing: securityGroups)), sourceDestCheck: \(String(describing: sourceDestCheck)), spotInstanceRequestId: \(String(describing: spotInstanceRequestId)), sriovNetSupport: \(String(describing: sriovNetSupport)), state: \(String(describing: state)), stateReason: \(String(describing: stateReason)), stateTransitionReason: \(String(describing: stateTransitionReason)), subnetId: \(String(describing: subnetId)), tags: \(String(describing: tags)), virtualizationType: \(String(describing: virtualizationType)), vpcId: \(String(describing: vpcId)))"}
}
