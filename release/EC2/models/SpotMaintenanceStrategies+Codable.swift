...
extension SpotMaintenanceStrategies: Codable, Reflection {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let capacityRebalanceDecoded = try containerValues.decodeIfPresent(SpotCapacityRebalance.self, forKey: .capacityRebalance)
