...
extension Explanation: CustomDebugStringConvertible {
    public var debugDescription: String {
        "Explanation(acl: \(String(describing: acl)), aclRule: \(String(describing: aclRule)), address: \(String(describing: address)), addresses: \(String(describing: addresses)), attachedTo: \(String(describing: attachedTo)), availabilityZones: \(String(describing: availabilityZones)), cidrs: \(String(describing: cidrs)), classicLoadBalancerListener: \(String(describing: classicLoadBalancerListener)), component: \(String(describing: component)), customerGateway: \(String(describing: customerGateway)), destination: \(String(describing: destination)), destinationVpc: \(String(describing: destinationVpc)), direction: \(String(describing: direction)), elasticLoadBalancerListener: \(String(describing: elasticLoadBalancerListener)), explanationCode: \(String(describing: explanationCode)), ingressRouteTable: \(String(describing: ingressRouteTable)), internetGateway: \(String(describing: internetGateway)), loadBalancerArn: \(String(describing: loadBalancerArn)), loadBalancerListenerPort: \(String(describing: loadBalancerListenerPort)), loadBalancerTarget: \(String(describing: loadBalancerTarget)), loadBalancerTargetGroup: \(String(describing: loadBalancerTargetGroup)), loadBalancerTargetGroups: \(String(describing: loadBalancerTargetGroups)), loadBalancerTargetPort: \(String(describing: loadBalancerTargetPort)), missingComponent: \(String(describing: missingComponent)), natGateway: \(String(describing: natGateway)), networkInterface: \(String(describing: networkInterface)), packetField: \(String(describing: packetField)), port: \(String(describing: port)), portRanges: \(String(describing: portRanges)), prefixList: \(String(describing: prefixList)), protocols: \(String(describing: protocols)), routeTable: \(String(describing: routeTable)), routeTableRoute: \(String(describing: routeTableRoute)), securityGroup: \(String(describing: securityGroup)), securityGroupRule: \(String(describing: securityGroupRule)), securityGroups: \(String(describing: securityGroups)), sourceVpc: \(String(describing: sourceVpc)), state: \(String(describing: state)), subnet: \(String(describing: subnet)), subnetRouteTable: \(String(describing: subnetRouteTable)), vpc: \(String(describing: vpc)), vpcEndpoint: \(String(describing: vpcEndpoint)), vpcPeeringConnection: \(String(describing: vpcPeeringConnection)), vpnConnection: \(String(describing: vpnConnection)), vpnGateway: \(String(describing: vpnGateway)))"}
}
