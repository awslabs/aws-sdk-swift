...
extension InstanceTypeInfo: CustomDebugStringConvertible {
    public var debugDescription: String {
        "InstanceTypeInfo(autoRecoverySupported: \(String(describing: autoRecoverySupported)), bareMetal: \(String(describing: bareMetal)), burstablePerformanceSupported: \(String(describing: burstablePerformanceSupported)), currentGeneration: \(String(describing: currentGeneration)), dedicatedHostsSupported: \(String(describing: dedicatedHostsSupported)), ebsInfo: \(String(describing: ebsInfo)), fpgaInfo: \(String(describing: fpgaInfo)), freeTierEligible: \(String(describing: freeTierEligible)), gpuInfo: \(String(describing: gpuInfo)), hibernationSupported: \(String(describing: hibernationSupported)), hypervisor: \(String(describing: hypervisor)), inferenceAcceleratorInfo: \(String(describing: inferenceAcceleratorInfo)), instanceStorageInfo: \(String(describing: instanceStorageInfo)), instanceStorageSupported: \(String(describing: instanceStorageSupported)), instanceType: \(String(describing: instanceType)), memoryInfo: \(String(describing: memoryInfo)), networkInfo: \(String(describing: networkInfo)), placementGroupInfo: \(String(describing: placementGroupInfo)), processorInfo: \(String(describing: processorInfo)), supportedBootModes: \(String(describing: supportedBootModes)), supportedRootDeviceTypes: \(String(describing: supportedRootDeviceTypes)), supportedUsageClasses: \(String(describing: supportedUsageClasses)), supportedVirtualizationTypes: \(String(describing: supportedVirtualizationTypes)), vCpuInfo: \(String(describing: vCpuInfo)))"}
}
