...
extension ScheduledInstancesBlockDeviceMapping: Codable, Reflection {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let ebsDecoded = try containerValues.decodeIfPresent(ScheduledInstancesEbs.self, forKey: .ebs)
        ebs = ebsDecoded
