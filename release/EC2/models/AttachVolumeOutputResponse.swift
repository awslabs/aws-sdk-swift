...
extension AttachVolumeOutputResponse: CustomDebugStringConvertible {
    public var debugDescription: String {
        "AttachVolumeOutputResponse(attachTime: \(String(describing: attachTime)), deleteOnTermination: \(String(describing: deleteOnTermination)), device: \(String(describing: device)), instanceId: \(String(describing: instanceId)), state: \(String(describing: state)), volumeId: \(String(describing: volumeId)))"}
}
