...
struct DeleteVpcEndpointConnectionNotificationsOutputResponseBody: Equatable {
    public let unsuccessful: [UnsuccessfulItem]?
}

extension DeleteVpcEndpointConnectionNotificationsOutputResponseBody: Decodable {
