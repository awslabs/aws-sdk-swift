...
extension SpotOptionsRequest: Codable, Reflection {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let maintenanceStrategiesDecoded = try containerValues.decodeIfPresent(FleetSpotMaintenanceStrategiesRequest.self, forKey: .maintenanceStrategies)
