...
public struct EnableSerialConsoleAccessOutputResponse: Equatable {
...
extension EnableSerialConsoleAccessOutputResponse: CustomDebugStringConvertible {
    public var debugDescription: String {
        "EnableSerialConsoleAccessOutputResponse(serialConsoleAccessEnabled: \(String(describing: serialConsoleAccessEnabled)))"}
}
