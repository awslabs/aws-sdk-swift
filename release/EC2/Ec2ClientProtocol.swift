...
public protocol Ec2ClientProtocol {
    ...
    func acceptReservedInstancesExchangeQuote(input: AcceptReservedInstancesExchangeQuoteInput, completion: @escaping (SdkResult<AcceptReservedInstancesExchangeQuoteOutput, AcceptReservedInstancesExchangeQuoteOutputError>) -> Void)
    /// <p>Accepts a request to associate subnets with a transit gateway multicast domain.</p>
    func acceptTransitGatewayMulticastDomainAssociations(input: AcceptTransitGatewayMulticastDomainAssociationsInput, completion: @escaping (SdkResult<AcceptTransitGatewayMulticastDomainAssociationsOutput, AcceptTransitGatewayMulticastDomainAssociationsOutputError>) -> Void)
    ...
    func acceptTransitGatewayPeeringAttachment(input: AcceptTransitGatewayPeeringAttachmentInput, completion: @escaping (SdkResult<AcceptTransitGatewayPeeringAttachmentOutput, AcceptTransitGatewayPeeringAttachmentOutputError>) -> Void)
    ...
    func acceptTransitGatewayVpcAttachment(input: AcceptTransitGatewayVpcAttachmentInput, completion: @escaping (SdkResult<AcceptTransitGatewayVpcAttachmentOutput, AcceptTransitGatewayVpcAttachmentOutputError>) -> Void)
    /// <p>Accepts one or more interface VPC endpoint connection requests to your VPC endpoint
    ///             service.</p>
    func acceptVpcEndpointConnections(input: AcceptVpcEndpointConnectionsInput, completion: @escaping (SdkResult<AcceptVpcEndpointConnectionsOutput, AcceptVpcEndpointConnectionsOutputError>) -> Void)
    ...
    func acceptVpcPeeringConnection(input: AcceptVpcPeeringConnectionInput, completion: @escaping (SdkResult<AcceptVpcPeeringConnectionOutput, AcceptVpcPeeringConnectionOutputError>) -> Void)
    ...
    func advertiseByoipCidr(input: AdvertiseByoipCidrInput, completion: @escaping (SdkResult<AdvertiseByoipCidrOutput, AdvertiseByoipCidrOutputError>) -> Void)
    ...
    func allocateAddress(input: AllocateAddressInput, completion: @escaping (SdkResult<AllocateAddressOutput, AllocateAddressOutputError>) -> Void)
    ...
    ///         	hosts to allocate.</p>
    func allocateHosts(input: AllocateHostsInput, completion: @escaping (SdkResult<AllocateHostsOutput, AllocateHostsOutputError>) -> Void)
    ...
    func applySecurityGroupsToClientVpnTargetNetwork(input: ApplySecurityGroupsToClientVpnTargetNetworkInput, completion: @escaping (SdkResult<ApplySecurityGroupsToClientVpnTargetNetworkOutput, ApplySecurityGroupsToClientVpnTargetNetworkOutputError>) -> Void)
    ...
    func assignIpv6Addresses(input: AssignIpv6AddressesInput, completion: @escaping (SdkResult<AssignIpv6AddressesOutput, AssignIpv6AddressesOutputError>) -> Void)
    ...
    func assignPrivateIpAddresses(input: AssignPrivateIpAddressesInput, completion: @escaping (SdkResult<AssignPrivateIpAddressesOutput, AssignPrivateIpAddressesOutputError>) -> Void)
    ...
    ///           Pricing</a>.</p>
    ///          </important>
    func associateAddress(input: AssociateAddressInput, completion: @escaping (SdkResult<AssociateAddressOutput, AssociateAddressOutputError>) -> Void)
    ...
    func associateClientVpnTargetNetwork(input: AssociateClientVpnTargetNetworkInput, completion: @escaping (SdkResult<AssociateClientVpnTargetNetworkOutput, AssociateClientVpnTargetNetworkOutputError>) -> Void)
    ...
    func associateDhcpOptions(input: AssociateDhcpOptionsInput, completion: @escaping (SdkResult<AssociateDhcpOptionsOutput, AssociateDhcpOptionsOutputError>) -> Void)
    ...
    func associateEnclaveCertificateIamRole(input: AssociateEnclaveCertificateIamRoleInput, completion: @escaping (SdkResult<AssociateEnclaveCertificateIamRoleOutput, AssociateEnclaveCertificateIamRoleOutputError>) -> Void)
    ...
    func associateIamInstanceProfile(input: AssociateIamInstanceProfileInput, completion: @escaping (SdkResult<AssociateIamInstanceProfileOutput, AssociateIamInstanceProfileOutputError>) -> Void)
    ...
    func associateRouteTable(input: AssociateRouteTableInput, completion: @escaping (SdkResult<AssociateRouteTableOutput, AssociateRouteTableOutputError>) -> Void)
    ...
    func associateSubnetCidrBlock(input: AssociateSubnetCidrBlockInput, completion: @escaping (SdkResult<AssociateSubnetCidrBlockOutput, AssociateSubnetCidrBlockOutputError>) -> Void)
    ...
    func associateTransitGatewayMulticastDomain(input: AssociateTransitGatewayMulticastDomainInput, completion: @escaping (SdkResult<AssociateTransitGatewayMulticastDomainOutput, AssociateTransitGatewayMulticastDomainOutputError>) -> Void)
    ...
    func associateTransitGatewayRouteTable(input: AssociateTransitGatewayRouteTableInput, completion: @escaping (SdkResult<AssociateTransitGatewayRouteTableOutput, AssociateTransitGatewayRouteTableOutputError>) -> Void)
    ...
    ///                 <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func associateVpcCidrBlock(input: AssociateVpcCidrBlockInput, completion: @escaping (SdkResult<AssociateVpcCidrBlockOutput, AssociateVpcCidrBlockOutputError>) -> Void)
    ...
    func attachClassicLinkVpc(input: AttachClassicLinkVpcInput, completion: @escaping (SdkResult<AttachClassicLinkVpcOutput, AttachClassicLinkVpcOutputError>) -> Void)
    ...
    func attachInternetGateway(input: AttachInternetGatewayInput, completion: @escaping (SdkResult<AttachInternetGatewayOutput, AttachInternetGatewayOutputError>) -> Void)
    /// <p>Attaches a network interface to an instance.</p>
    func attachNetworkInterface(input: AttachNetworkInterfaceInput, completion: @escaping (SdkResult<AttachNetworkInterfaceOutput, AttachNetworkInterfaceOutputError>) -> Void)
    ...
    func attachVpnGateway(input: AttachVpnGatewayInput, completion: @escaping (SdkResult<AttachVpnGatewayOutput, AttachVpnGatewayOutputError>) -> Void)
    ...
    func authorizeClientVpnIngress(input: AuthorizeClientVpnIngressInput, completion: @escaping (SdkResult<AuthorizeClientVpnIngressOutput, AuthorizeClientVpnIngressOutputError>) -> Void)
    ...
    func authorizeSecurityGroupEgress(input: AuthorizeSecurityGroupEgressInput, completion: @escaping (SdkResult<AuthorizeSecurityGroupEgressOutput, AuthorizeSecurityGroupEgressOutputError>) -> Void)
    ...
    ///          <p>For more information about VPC security group limits, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/amazon-vpc-limits.html">Amazon VPC Limits</a>.</p>
    func authorizeSecurityGroupIngress(input: AuthorizeSecurityGroupIngressInput, completion: @escaping (SdkResult<AuthorizeSecurityGroupIngressOutput, AuthorizeSecurityGroupIngressOutputError>) -> Void)
    ...
    /// 			      </note>
    func bundleInstance(input: BundleInstanceInput, completion: @escaping (SdkResult<BundleInstanceOutput, BundleInstanceOutputError>) -> Void)
    /// <p>Cancels a bundling operation for an instance store-backed Windows instance.</p>
    func cancelBundleTask(input: CancelBundleTaskInput, completion: @escaping (SdkResult<CancelBundleTaskOutput, CancelBundleTaskOutputError>) -> Void)
    ...
    func cancelCapacityReservation(input: CancelCapacityReservationInput, completion: @escaping (SdkResult<CancelCapacityReservationOutput, CancelCapacityReservationOutputError>) -> Void)
    ...
    ///     EC2 CLI</a>.</p>
    func cancelConversionTask(input: CancelConversionTaskInput, completion: @escaping (SdkResult<CancelConversionTaskOutput, CancelConversionTaskOutputError>) -> Void)
    ...
    func cancelImportTask(input: CancelImportTaskInput, completion: @escaping (SdkResult<CancelImportTaskOutput, CancelImportTaskOutputError>) -> Void)
    ...
    func cancelReservedInstancesListing(input: CancelReservedInstancesListingInput, completion: @escaping (SdkResult<CancelReservedInstancesListingOutput, CancelReservedInstancesListingOutputError>) -> Void)
    ...
    func cancelSpotFleetRequests(input: CancelSpotFleetRequestsInput, completion: @escaping (SdkResult<CancelSpotFleetRequestsOutput, CancelSpotFleetRequestsOutputError>) -> Void)
    ...
    ///          </important>
    func cancelSpotInstanceRequests(input: CancelSpotInstanceRequestsInput, completion: @escaping (SdkResult<CancelSpotInstanceRequestsOutput, CancelSpotInstanceRequestsOutputError>) -> Void)
    ...
    func confirmProductInstance(input: ConfirmProductInstanceInput, completion: @escaping (SdkResult<ConfirmProductInstanceOutput, ConfirmProductInstanceOutputError>) -> Void)
    /// <p>Copies the specified Amazon FPGA Image (AFI) to the current Region.</p>
    func copyFpgaImage(input: CopyFpgaImageInput, completion: @escaping (SdkResult<CopyFpgaImageOutput, CopyFpgaImageOutputError>) -> Void)
    ...
    func createCapacityReservation(input: CreateCapacityReservationInput, completion: @escaping (SdkResult<CreateCapacityReservationOutput, CreateCapacityReservationOutputError>) -> Void)
    ...
    ///                 Guide</i>.</p>
    func createCarrierGateway(input: CreateCarrierGatewayInput, completion: @escaping (SdkResult<CreateCarrierGatewayOutput, CreateCarrierGatewayOutputError>) -> Void)
    ...
    /// 			are terminated.</p>
    func createClientVpnEndpoint(input: CreateClientVpnEndpointInput, completion: @escaping (SdkResult<CreateClientVpnEndpointOutput, CreateClientVpnEndpointOutputError>) -> Void)
    ...
    func createClientVpnRoute(input: CreateClientVpnRouteInput, completion: @escaping (SdkResult<CreateClientVpnRouteOutput, CreateClientVpnRouteOutputError>) -> Void)
    ...
    ///                 customer gateways.</p>
    ///         </important>
    func createCustomerGateway(input: CreateCustomerGatewayInput, completion: @escaping (SdkResult<CreateCustomerGatewayOutput, CreateCustomerGatewayOutputError>) -> Void)
    ...
    func createDefaultSubnet(input: CreateDefaultSubnetInput, completion: @escaping (SdkResult<CreateDefaultSubnetOutput, CreateDefaultSubnetOutputError>) -> Void)
    ...
    /// 			FAQ</a>.</p>
    func createDefaultVpc(input: CreateDefaultVpcInput, completion: @escaping (SdkResult<CreateDefaultVpcOutput, CreateDefaultVpcOutputError>) -> Void)
    ...
    /// 			<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createDhcpOptions(input: CreateDhcpOptionsInput, completion: @escaping (SdkResult<CreateDhcpOptionsOutput, CreateDhcpOptionsOutputError>) -> Void)
    ...
    func createEgressOnlyInternetGateway(input: CreateEgressOnlyInternetGatewayInput, completion: @escaping (SdkResult<CreateEgressOnlyInternetGatewayOutput, CreateEgressOnlyInternetGatewayOutputError>) -> Void)
    ...
    func createFlowLogs(input: CreateFlowLogsInput, completion: @escaping (SdkResult<CreateFlowLogsOutput, CreateFlowLogsOutputError>) -> Void)
    ...
    func createFpgaImage(input: CreateFpgaImageInput, completion: @escaping (SdkResult<CreateFpgaImageOutput, CreateFpgaImageOutputError>) -> Void)
    ...
    func createInstanceExportTask(input: CreateInstanceExportTaskInput, completion: @escaping (SdkResult<CreateInstanceExportTaskOutput, CreateInstanceExportTaskOutputError>) -> Void)
    ...
    func createInternetGateway(input: CreateInternetGatewayInput, completion: @escaping (SdkResult<CreateInternetGatewayOutput, CreateInternetGatewayOutputError>) -> Void)
    ...
    ///                 <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func createKeyPair(input: CreateKeyPairInput, completion: @escaping (SdkResult<CreateKeyPairOutput, CreateKeyPairOutputError>) -> Void)
    ...
    func createLaunchTemplate(input: CreateLaunchTemplateInput, completion: @escaping (SdkResult<CreateLaunchTemplateOutput, CreateLaunchTemplateOutputError>) -> Void)
    ...
    func createLaunchTemplateVersion(input: CreateLaunchTemplateVersionInput, completion: @escaping (SdkResult<CreateLaunchTemplateVersionOutput, CreateLaunchTemplateVersionOutputError>) -> Void)
    /// <p>Creates a static route for the specified local gateway route table.</p>
    func createLocalGatewayRoute(input: CreateLocalGatewayRouteInput, completion: @escaping (SdkResult<CreateLocalGatewayRouteOutput, CreateLocalGatewayRouteOutputError>) -> Void)
    /// <p>Associates the specified VPC with the specified local gateway route table.</p>
    func createLocalGatewayRouteTableVpcAssociation(input: CreateLocalGatewayRouteTableVpcAssociationInput, completion: @escaping (SdkResult<CreateLocalGatewayRouteTableVpcAssociationOutput, CreateLocalGatewayRouteTableVpcAssociationOutputError>) -> Void)
    ...
    func createManagedPrefixList(input: CreateManagedPrefixListInput, completion: @escaping (SdkResult<CreateManagedPrefixListOutput, CreateManagedPrefixListOutputError>) -> Void)
    ...
    ///                 <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createNatGateway(input: CreateNatGatewayInput, completion: @escaping (SdkResult<CreateNatGatewayOutput, CreateNatGatewayOutputError>) -> Void)
    ...
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createNetworkAcl(input: CreateNetworkAclInput, completion: @escaping (SdkResult<CreateNetworkAclOutput, CreateNetworkAclOutputError>) -> Void)
    ...
    func createNetworkAclEntry(input: CreateNetworkAclEntryInput, completion: @escaping (SdkResult<CreateNetworkAclEntryOutput, CreateNetworkAclEntryOutputError>) -> Void)
    ...
    func createNetworkInsightsPath(input: CreateNetworkInsightsPathInput, completion: @escaping (SdkResult<CreateNetworkInsightsPathOutput, CreateNetworkInsightsPathOutputError>) -> Void)
    ...
    ///             in the <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createNetworkInterface(input: CreateNetworkInterfaceInput, completion: @escaping (SdkResult<CreateNetworkInterfaceOutput, CreateNetworkInterfaceOutputError>) -> Void)
    ...
    func createNetworkInterfacePermission(input: CreateNetworkInterfacePermissionInput, completion: @escaping (SdkResult<CreateNetworkInterfacePermissionOutput, CreateNetworkInterfacePermissionOutputError>) -> Void)
    ...
    func createPlacementGroup(input: CreatePlacementGroupInput, completion: @escaping (SdkResult<CreatePlacementGroupOutput, CreatePlacementGroupOutputError>) -> Void)
    ...
    ///       in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func createReplaceRootVolumeTask(input: CreateReplaceRootVolumeTaskInput, completion: @escaping (SdkResult<CreateReplaceRootVolumeTaskOutput, CreateReplaceRootVolumeTaskOutputError>) -> Void)
    ...
    /// 				<i>Amazon EC2 User Guide</i>.</p>
    func createReservedInstancesListing(input: CreateReservedInstancesListingInput, completion: @escaping (SdkResult<CreateReservedInstancesListingOutput, CreateReservedInstancesListingOutputError>) -> Void)
    ...
    func createRestoreImageTask(input: CreateRestoreImageTaskInput, completion: @escaping (SdkResult<CreateRestoreImageTaskOutput, CreateRestoreImageTaskOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html">Route Tables</a> in the
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createRouteTable(input: CreateRouteTableInput, completion: @escaping (SdkResult<CreateRouteTableOutput, CreateRouteTableOutputError>) -> Void)
    ...
    ///          <p>For more information about VPC security group limits, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/amazon-vpc-limits.html">Amazon VPC Limits</a>.</p>
    func createSecurityGroup(input: CreateSecurityGroupInput, completion: @escaping (SdkResult<CreateSecurityGroupOutput, CreateSecurityGroupOutputError>) -> Void)
    ...
    ///   	Outpost.</p>
    func createSnapshots(input: CreateSnapshotsInput, completion: @escaping (SdkResult<CreateSnapshotsOutput, CreateSnapshotsOutputError>) -> Void)
    ...
    func createSpotDatafeedSubscription(input: CreateSpotDatafeedSubscriptionInput, completion: @escaping (SdkResult<CreateSpotDatafeedSubscriptionOutput, CreateSpotDatafeedSubscriptionOutputError>) -> Void)
    /// <p>Stores an AMI as a single object in an S3 bucket.</p>
    ///          <p>To use this API, you must have the required permissions. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-store-restore.html#ami-s3-permissions">Permissions for storing and restoring AMIs using S3</a> in the
    ///         <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-store-restore.html">Store and restore an AMI using
    ///         S3</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func createStoreImageTask(input: CreateStoreImageTaskInput, completion: @escaping (SdkResult<CreateStoreImageTaskOutput, CreateStoreImageTaskOutputError>) -> Void)
    ...
    ///                 <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createSubnet(input: CreateSubnetInput, completion: @escaping (SdkResult<CreateSubnetOutput, CreateSubnetOutputError>) -> Void)
    ...
    func createTrafficMirrorFilter(input: CreateTrafficMirrorFilterInput, completion: @escaping (SdkResult<CreateTrafficMirrorFilterOutput, CreateTrafficMirrorFilterOutputError>) -> Void)
    ...
    func createTrafficMirrorFilterRule(input: CreateTrafficMirrorFilterRuleInput, completion: @escaping (SdkResult<CreateTrafficMirrorFilterRuleOutput, CreateTrafficMirrorFilterRuleOutputError>) -> Void)
    ...
    func createTrafficMirrorSession(input: CreateTrafficMirrorSessionInput, completion: @escaping (SdkResult<CreateTrafficMirrorSessionOutput, CreateTrafficMirrorSessionOutputError>) -> Void)
    ...
    func createTrafficMirrorTarget(input: CreateTrafficMirrorTargetInput, completion: @escaping (SdkResult<CreateTrafficMirrorTargetOutput, CreateTrafficMirrorTargetOutputError>) -> Void)
    ...
    func createTransitGateway(input: CreateTransitGatewayInput, completion: @escaping (SdkResult<CreateTransitGatewayOutput, CreateTransitGatewayOutputError>) -> Void)
    ...
    func createTransitGatewayConnect(input: CreateTransitGatewayConnectInput, completion: @escaping (SdkResult<CreateTransitGatewayConnectOutput, CreateTransitGatewayConnectOutputError>) -> Void)
    ...
    func createTransitGatewayConnectPeer(input: CreateTransitGatewayConnectPeerInput, completion: @escaping (SdkResult<CreateTransitGatewayConnectPeerOutput, CreateTransitGatewayConnectPeerOutputError>) -> Void)
    ...
    func createTransitGatewayMulticastDomain(input: CreateTransitGatewayMulticastDomainInput, completion: @escaping (SdkResult<CreateTransitGatewayMulticastDomainOutput, CreateTransitGatewayMulticastDomainOutputError>) -> Void)
    ...
    func createTransitGatewayPeeringAttachment(input: CreateTransitGatewayPeeringAttachmentInput, completion: @escaping (SdkResult<CreateTransitGatewayPeeringAttachmentOutput, CreateTransitGatewayPeeringAttachmentOutputError>) -> Void)
    /// <p>Creates a reference (route) to a prefix list in a specified transit gateway route table.</p>
    func createTransitGatewayPrefixListReference(input: CreateTransitGatewayPrefixListReferenceInput, completion: @escaping (SdkResult<CreateTransitGatewayPrefixListReferenceOutput, CreateTransitGatewayPrefixListReferenceOutputError>) -> Void)
    /// <p>Creates a static route for the specified transit gateway route table.</p>
    func createTransitGatewayRoute(input: CreateTransitGatewayRouteInput, completion: @escaping (SdkResult<CreateTransitGatewayRouteOutput, CreateTransitGatewayRouteOutputError>) -> Void)
    /// <p>Creates a route table for the specified transit gateway.</p>
    func createTransitGatewayRouteTable(input: CreateTransitGatewayRouteTableInput, completion: @escaping (SdkResult<CreateTransitGatewayRouteTableOutput, CreateTransitGatewayRouteTableOutputError>) -> Void)
    ...
    func createTransitGatewayVpcAttachment(input: CreateTransitGatewayVpcAttachmentInput, completion: @escaping (SdkResult<CreateTransitGatewayVpcAttachmentOutput, CreateTransitGatewayVpcAttachmentOutputError>) -> Void)
    ...
    ///         <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func createVolume(input: CreateVolumeInput, completion: @escaping (SdkResult<CreateVolumeOutput, CreateVolumeOutputError>) -> Void)
    ...
    ///           <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func createVpc(input: CreateVpcInput, completion: @escaping (SdkResult<CreateVpcOutput, CreateVpcOutputError>) -> Void)
    ...
    ///             services.</p>
    func createVpcEndpoint(input: CreateVpcEndpointInput, completion: @escaping (SdkResult<CreateVpcEndpointOutput, CreateVpcEndpointOutputError>) -> Void)
    ...
    func createVpcEndpointConnectionNotification(input: CreateVpcEndpointConnectionNotificationInput, completion: @escaping (SdkResult<CreateVpcEndpointConnectionNotificationOutput, CreateVpcEndpointConnectionNotificationOutputError>) -> Void)
    ...
    ///             <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createVpcEndpointServiceConfiguration(input: CreateVpcEndpointServiceConfigurationInput, completion: @escaping (SdkResult<CreateVpcEndpointServiceConfigurationOutput, CreateVpcEndpointServiceConfigurationOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN
    ///                 User Guide</i>.</p>
    func createVpnConnection(input: CreateVpnConnectionInput, completion: @escaping (SdkResult<CreateVpnConnectionOutput, CreateVpnConnectionOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN User Guide</i>.</p>
    func createVpnConnectionRoute(input: CreateVpnConnectionRouteInput, completion: @escaping (SdkResult<CreateVpnConnectionRouteOutput, CreateVpnConnectionRouteOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN User Guide</i>.</p>
    func createVpnGateway(input: CreateVpnGatewayInput, completion: @escaping (SdkResult<CreateVpnGatewayOutput, CreateVpnGatewayOutputError>) -> Void)
    ...
    ///         </important>
    func deleteCarrierGateway(input: DeleteCarrierGatewayInput, completion: @escaping (SdkResult<DeleteCarrierGatewayOutput, DeleteCarrierGatewayOutputError>) -> Void)
    ...
    func deleteClientVpnEndpoint(input: DeleteClientVpnEndpointInput, completion: @escaping (SdkResult<DeleteClientVpnEndpointOutput, DeleteClientVpnEndpointOutputError>) -> Void)
    ...
    func deleteClientVpnRoute(input: DeleteClientVpnRouteInput, completion: @escaping (SdkResult<DeleteClientVpnRouteOutput, DeleteClientVpnRouteOutputError>) -> Void)
    /// <p>Deletes the specified customer gateway. You must delete the VPN connection before you can delete the customer gateway.</p>
    func deleteCustomerGateway(input: DeleteCustomerGatewayInput, completion: @escaping (SdkResult<DeleteCustomerGatewayOutput, DeleteCustomerGatewayOutputError>) -> Void)
    ...
    func deleteDhcpOptions(input: DeleteDhcpOptionsInput, completion: @escaping (SdkResult<DeleteDhcpOptionsOutput, DeleteDhcpOptionsOutputError>) -> Void)
    /// <p>Deletes an egress-only internet gateway.</p>
    func deleteEgressOnlyInternetGateway(input: DeleteEgressOnlyInternetGatewayInput, completion: @escaping (SdkResult<DeleteEgressOnlyInternetGatewayOutput, DeleteEgressOnlyInternetGatewayOutputError>) -> Void)
    ...
    func deleteFleets(input: DeleteFleetsInput, completion: @escaping (SdkResult<DeleteFleetsOutput, DeleteFleetsOutputError>) -> Void)
    /// <p>Deletes one or more flow logs.</p>
    func deleteFlowLogs(input: DeleteFlowLogsInput, completion: @escaping (SdkResult<DeleteFlowLogsOutput, DeleteFlowLogsOutputError>) -> Void)
    /// <p>Deletes the specified Amazon FPGA Image (AFI).</p>
    func deleteFpgaImage(input: DeleteFpgaImageInput, completion: @escaping (SdkResult<DeleteFpgaImageOutput, DeleteFpgaImageOutputError>) -> Void)
    /// <p>Deletes the specified internet gateway. You must detach the internet gateway from the
    /// 			VPC before you can delete it.</p>
    func deleteInternetGateway(input: DeleteInternetGatewayInput, completion: @escaping (SdkResult<DeleteInternetGatewayOutput, DeleteInternetGatewayOutputError>) -> Void)
    /// <p>Deletes the specified key pair, by removing the public key from Amazon EC2.</p>
    func deleteKeyPair(input: DeleteKeyPairInput, completion: @escaping (SdkResult<DeleteKeyPairOutput, DeleteKeyPairOutputError>) -> Void)
    /// <p>Deletes a launch template. Deleting a launch template deletes all of its versions.</p>
    func deleteLaunchTemplate(input: DeleteLaunchTemplateInput, completion: @escaping (SdkResult<DeleteLaunchTemplateOutput, DeleteLaunchTemplateOutputError>) -> Void)
    ...
    func deleteLaunchTemplateVersions(input: DeleteLaunchTemplateVersionsInput, completion: @escaping (SdkResult<DeleteLaunchTemplateVersionsOutput, DeleteLaunchTemplateVersionsOutputError>) -> Void)
    /// <p>Deletes the specified route from the specified local gateway route table.</p>
    func deleteLocalGatewayRoute(input: DeleteLocalGatewayRouteInput, completion: @escaping (SdkResult<DeleteLocalGatewayRouteOutput, DeleteLocalGatewayRouteOutputError>) -> Void)
    /// <p>Deletes the specified association between a VPC and local gateway route table.</p>
    func deleteLocalGatewayRouteTableVpcAssociation(input: DeleteLocalGatewayRouteTableVpcAssociationInput, completion: @escaping (SdkResult<DeleteLocalGatewayRouteTableVpcAssociationOutput, DeleteLocalGatewayRouteTableVpcAssociationOutputError>) -> Void)
    /// <p>Deletes the specified managed prefix list. You must first remove all references to the prefix list in your resources.</p>
    func deleteManagedPrefixList(input: DeleteManagedPrefixListInput, completion: @escaping (SdkResult<DeleteManagedPrefixListOutput, DeleteManagedPrefixListOutputError>) -> Void)
    ...
    func deleteNatGateway(input: DeleteNatGatewayInput, completion: @escaping (SdkResult<DeleteNatGatewayOutput, DeleteNatGatewayOutputError>) -> Void)
    ...
    func deleteNetworkAcl(input: DeleteNetworkAclInput, completion: @escaping (SdkResult<DeleteNetworkAclOutput, DeleteNetworkAclOutputError>) -> Void)
    /// <p>Deletes the specified ingress or egress entry (rule) from the specified network ACL.</p>
    func deleteNetworkAclEntry(input: DeleteNetworkAclEntryInput, completion: @escaping (SdkResult<DeleteNetworkAclEntryOutput, DeleteNetworkAclEntryOutputError>) -> Void)
    /// <p>Deletes the specified network insights analysis.</p>
    func deleteNetworkInsightsAnalysis(input: DeleteNetworkInsightsAnalysisInput, completion: @escaping (SdkResult<DeleteNetworkInsightsAnalysisOutput, DeleteNetworkInsightsAnalysisOutputError>) -> Void)
    /// <p>Deletes the specified path.</p>
    func deleteNetworkInsightsPath(input: DeleteNetworkInsightsPathInput, completion: @escaping (SdkResult<DeleteNetworkInsightsPathOutput, DeleteNetworkInsightsPathOutputError>) -> Void)
    /// <p>Deletes the specified network interface. You must detach the network interface before you can delete it.</p>
    func deleteNetworkInterface(input: DeleteNetworkInterfaceInput, completion: @escaping (SdkResult<DeleteNetworkInterfaceOutput, DeleteNetworkInterfaceOutputError>) -> Void)
    ...
    func deleteNetworkInterfacePermission(input: DeleteNetworkInterfacePermissionInput, completion: @escaping (SdkResult<DeleteNetworkInterfacePermissionOutput, DeleteNetworkInterfacePermissionOutputError>) -> Void)
    ...
    func deletePlacementGroup(input: DeletePlacementGroupInput, completion: @escaping (SdkResult<DeletePlacementGroupOutput, DeletePlacementGroupOutputError>) -> Void)
    /// <p>Deletes the queued purchases for the specified Reserved Instances.</p>
    func deleteQueuedReservedInstances(input: DeleteQueuedReservedInstancesInput, completion: @escaping (SdkResult<DeleteQueuedReservedInstancesOutput, DeleteQueuedReservedInstancesOutputError>) -> Void)
    ...
    func deleteRouteTable(input: DeleteRouteTableInput, completion: @escaping (SdkResult<DeleteRouteTableOutput, DeleteRouteTableOutputError>) -> Void)
    ...
    func deleteSecurityGroup(input: DeleteSecurityGroupInput, completion: @escaping (SdkResult<DeleteSecurityGroupOutput, DeleteSecurityGroupOutputError>) -> Void)
    ...
    func deleteSpotDatafeedSubscription(input: DeleteSpotDatafeedSubscriptionInput, completion: @escaping (SdkResult<DeleteSpotDatafeedSubscriptionOutput, DeleteSpotDatafeedSubscriptionOutputError>) -> Void)
    /// <p>Deletes the specified subnet. You must terminate all running instances in the subnet before you can delete the subnet.</p>
    func deleteSubnet(input: DeleteSubnetInput, completion: @escaping (SdkResult<DeleteSubnetOutput, DeleteSubnetOutputError>) -> Void)
    ...
    func deleteTrafficMirrorFilter(input: DeleteTrafficMirrorFilterInput, completion: @escaping (SdkResult<DeleteTrafficMirrorFilterOutput, DeleteTrafficMirrorFilterOutputError>) -> Void)
    /// <p>Deletes the specified Traffic Mirror rule.</p>
    func deleteTrafficMirrorFilterRule(input: DeleteTrafficMirrorFilterRuleInput, completion: @escaping (SdkResult<DeleteTrafficMirrorFilterRuleOutput, DeleteTrafficMirrorFilterRuleOutputError>) -> Void)
    /// <p>Deletes the specified Traffic Mirror session.</p>
    func deleteTrafficMirrorSession(input: DeleteTrafficMirrorSessionInput, completion: @escaping (SdkResult<DeleteTrafficMirrorSessionOutput, DeleteTrafficMirrorSessionOutputError>) -> Void)
    ...
    func deleteTrafficMirrorTarget(input: DeleteTrafficMirrorTargetInput, completion: @escaping (SdkResult<DeleteTrafficMirrorTargetOutput, DeleteTrafficMirrorTargetOutputError>) -> Void)
    /// <p>Deletes the specified transit gateway.</p>
    func deleteTransitGateway(input: DeleteTransitGatewayInput, completion: @escaping (SdkResult<DeleteTransitGatewayOutput, DeleteTransitGatewayOutputError>) -> Void)
    /// <p>Deletes the specified Connect attachment. You must first delete any Connect peers for
    ///             the attachment.</p>
    func deleteTransitGatewayConnect(input: DeleteTransitGatewayConnectInput, completion: @escaping (SdkResult<DeleteTransitGatewayConnectOutput, DeleteTransitGatewayConnectOutputError>) -> Void)
    /// <p>Deletes the specified Connect peer.</p>
    func deleteTransitGatewayConnectPeer(input: DeleteTransitGatewayConnectPeerInput, completion: @escaping (SdkResult<DeleteTransitGatewayConnectPeerOutput, DeleteTransitGatewayConnectPeerOutputError>) -> Void)
    /// <p>Deletes the specified transit gateway multicast domain.</p>
    func deleteTransitGatewayMulticastDomain(input: DeleteTransitGatewayMulticastDomainInput, completion: @escaping (SdkResult<DeleteTransitGatewayMulticastDomainOutput, DeleteTransitGatewayMulticastDomainOutputError>) -> Void)
    /// <p>Deletes a transit gateway peering attachment.</p>
    func deleteTransitGatewayPeeringAttachment(input: DeleteTransitGatewayPeeringAttachmentInput, completion: @escaping (SdkResult<DeleteTransitGatewayPeeringAttachmentOutput, DeleteTransitGatewayPeeringAttachmentOutputError>) -> Void)
    /// <p>Deletes a reference (route) to a prefix list in a specified transit gateway route table.</p>
    func deleteTransitGatewayPrefixListReference(input: DeleteTransitGatewayPrefixListReferenceInput, completion: @escaping (SdkResult<DeleteTransitGatewayPrefixListReferenceOutput, DeleteTransitGatewayPrefixListReferenceOutputError>) -> Void)
    /// <p>Deletes the specified route from the specified transit gateway route table.</p>
    func deleteTransitGatewayRoute(input: DeleteTransitGatewayRouteInput, completion: @escaping (SdkResult<DeleteTransitGatewayRouteOutput, DeleteTransitGatewayRouteOutputError>) -> Void)
    ...
    func deleteTransitGatewayRouteTable(input: DeleteTransitGatewayRouteTableInput, completion: @escaping (SdkResult<DeleteTransitGatewayRouteTableOutput, DeleteTransitGatewayRouteTableOutputError>) -> Void)
    /// <p>Deletes the specified VPC attachment.</p>
    func deleteTransitGatewayVpcAttachment(input: DeleteTransitGatewayVpcAttachmentInput, completion: @escaping (SdkResult<DeleteTransitGatewayVpcAttachmentOutput, DeleteTransitGatewayVpcAttachmentOutputError>) -> Void)
    ...
    func deleteVpc(input: DeleteVpcInput, completion: @escaping (SdkResult<DeleteVpcOutput, DeleteVpcOutputError>) -> Void)
    /// <p>Deletes one or more VPC endpoint connection notifications.</p>
    func deleteVpcEndpointConnectionNotifications(input: DeleteVpcEndpointConnectionNotificationsInput, completion: @escaping (SdkResult<DeleteVpcEndpointConnectionNotificationsOutput, DeleteVpcEndpointConnectionNotificationsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteVpcEndpoints(input: DeleteVpcEndpointsInput, completion: @escaping (SdkResult<DeleteVpcEndpointsOutput, DeleteVpcEndpointsOutputError>) -> Void)
    ...
    ///             the service.</p>
    func deleteVpcEndpointServiceConfigurations(input: DeleteVpcEndpointServiceConfigurationsInput, completion: @escaping (SdkResult<DeleteVpcEndpointServiceConfigurationsOutput, DeleteVpcEndpointServiceConfigurationsOutputError>) -> Void)
    ...
    func deleteVpnConnection(input: DeleteVpnConnectionInput, completion: @escaping (SdkResult<DeleteVpnConnectionOutput, DeleteVpnConnectionOutputError>) -> Void)
    ...
    func deleteVpnConnectionRoute(input: DeleteVpnConnectionRouteInput, completion: @escaping (SdkResult<DeleteVpnConnectionRouteOutput, DeleteVpnConnectionRouteOutputError>) -> Void)
    ...
    func deleteVpnGateway(input: DeleteVpnGatewayInput, completion: @escaping (SdkResult<DeleteVpnGatewayOutput, DeleteVpnGatewayOutputError>) -> Void)
    ...
    ///          address range.</p>
    func deprovisionByoipCidr(input: DeprovisionByoipCidrInput, completion: @escaping (SdkResult<DeprovisionByoipCidrOutput, DeprovisionByoipCidrOutputError>) -> Void)
    ...
    func deregisterImage(input: DeregisterImageInput, completion: @escaping (SdkResult<DeregisterImageOutput, DeregisterImageOutputError>) -> Void)
    ...
    func deregisterInstanceEventNotificationAttributes(input: DeregisterInstanceEventNotificationAttributesInput, completion: @escaping (SdkResult<DeregisterInstanceEventNotificationAttributesOutput, DeregisterInstanceEventNotificationAttributesOutputError>) -> Void)
    /// <p>Deregisters the specified members (network interfaces) from the  transit gateway multicast group.</p>
    func deregisterTransitGatewayMulticastGroupMembers(input: DeregisterTransitGatewayMulticastGroupMembersInput, completion: @escaping (SdkResult<DeregisterTransitGatewayMulticastGroupMembersOutput, DeregisterTransitGatewayMulticastGroupMembersOutputError>) -> Void)
    /// <p>Deregisters the specified sources (network interfaces) from the  transit gateway multicast group.</p>
    func deregisterTransitGatewayMulticastGroupSources(input: DeregisterTransitGatewayMulticastGroupSourcesInput, completion: @escaping (SdkResult<DeregisterTransitGatewayMulticastGroupSourcesOutput, DeregisterTransitGatewayMulticastGroupSourcesOutputError>) -> Void)
    ...
    ///          <p>An Elastic IP address is for use in either the EC2-Classic platform or in a VPC.
    /// 				For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.html">Elastic IP Addresses</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func describeAddresses(input: DescribeAddressesInput, completion: @escaping (SdkResult<DescribeAddressesOutput, DescribeAddressesOutputError>) -> Void)
    ...
    func describeAddressesAttribute(input: DescribeAddressesAttributeInput, completion: @escaping (SdkResult<DescribeAddressesAttributeOutput, DescribeAddressesAttributeOutputError>) -> Void)
    ...
    func describeAggregateIdFormat(input: DescribeAggregateIdFormatInput, completion: @escaping (SdkResult<DescribeAggregateIdFormatOutput, DescribeAggregateIdFormatOutputError>) -> Void)
    ...
    func describeAvailabilityZones(input: DescribeAvailabilityZonesInput, completion: @escaping (SdkResult<DescribeAvailabilityZonesOutput, DescribeAvailabilityZonesOutputError>) -> Void)
    ...
    ///          </note>
    func describeBundleTasks(input: DescribeBundleTasksInput, completion: @escaping (SdkResult<DescribeBundleTasksOutput, DescribeBundleTasksOutputError>) -> Void)
    ...
    func describeByoipCidrs(input: DescribeByoipCidrsInput, completion: @escaping (SdkResult<DescribeByoipCidrsOutput, DescribeByoipCidrsOutputError>) -> Void)
    ...
    func describeCapacityReservations(input: DescribeCapacityReservationsInput, completion: @escaping (SdkResult<DescribeCapacityReservationsOutput, DescribeCapacityReservationsOutputError>) -> Void)
    /// <p>Describes one or more of your carrier gateways.</p>
    func describeCarrierGateways(input: DescribeCarrierGatewaysInput, completion: @escaping (SdkResult<DescribeCarrierGatewaysOutput, DescribeCarrierGatewaysOutputError>) -> Void)
    ...
    func describeClassicLinkInstances(input: DescribeClassicLinkInstancesInput, completion: @escaping (SdkResult<DescribeClassicLinkInstancesOutput, DescribeClassicLinkInstancesOutputError>) -> Void)
    /// <p>Describes the authorization rules for a specified Client VPN endpoint.</p>
    func describeClientVpnAuthorizationRules(input: DescribeClientVpnAuthorizationRulesInput, completion: @escaping (SdkResult<DescribeClientVpnAuthorizationRulesOutput, DescribeClientVpnAuthorizationRulesOutputError>) -> Void)
    ...
    func describeClientVpnConnections(input: DescribeClientVpnConnectionsInput, completion: @escaping (SdkResult<DescribeClientVpnConnectionsOutput, DescribeClientVpnConnectionsOutputError>) -> Void)
    /// <p>Describes one or more Client VPN endpoints in the account.</p>
    func describeClientVpnEndpoints(input: DescribeClientVpnEndpointsInput, completion: @escaping (SdkResult<DescribeClientVpnEndpointsOutput, DescribeClientVpnEndpointsOutputError>) -> Void)
    /// <p>Describes the routes for the specified Client VPN endpoint.</p>
    func describeClientVpnRoutes(input: DescribeClientVpnRoutesInput, completion: @escaping (SdkResult<DescribeClientVpnRoutesOutput, DescribeClientVpnRoutesOutputError>) -> Void)
    /// <p>Describes the target networks associated with the specified Client VPN endpoint.</p>
    func describeClientVpnTargetNetworks(input: DescribeClientVpnTargetNetworksInput, completion: @escaping (SdkResult<DescribeClientVpnTargetNetworksOutput, DescribeClientVpnTargetNetworksOutputError>) -> Void)
    /// <p>Describes the specified customer-owned address pools or all of your customer-owned address pools.</p>
    func describeCoipPools(input: DescribeCoipPoolsInput, completion: @escaping (SdkResult<DescribeCoipPoolsOutput, DescribeCoipPoolsOutputError>) -> Void)
    ...
    func describeConversionTasks(input: DescribeConversionTasksInput, completion: @escaping (SdkResult<DescribeConversionTasksOutput, DescribeConversionTasksOutputError>) -> Void)
    /// <p>Describes one or more of your VPN customer gateways.</p>
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN User Guide</i>.</p>
    func describeCustomerGateways(input: DescribeCustomerGatewaysInput, completion: @escaping (SdkResult<DescribeCustomerGatewaysOutput, DescribeCustomerGatewaysOutputError>) -> Void)
    ...
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func describeDhcpOptions(input: DescribeDhcpOptionsInput, completion: @escaping (SdkResult<DescribeDhcpOptionsOutput, DescribeDhcpOptionsOutputError>) -> Void)
    /// <p>Describes one or more of your egress-only internet gateways.</p>
    func describeEgressOnlyInternetGateways(input: DescribeEgressOnlyInternetGatewaysInput, completion: @escaping (SdkResult<DescribeEgressOnlyInternetGatewaysOutput, DescribeEgressOnlyInternetGatewaysOutputError>) -> Void)
    ...
    func describeElasticGpus(input: DescribeElasticGpusInput, completion: @escaping (SdkResult<DescribeElasticGpusOutput, DescribeElasticGpusOutputError>) -> Void)
    /// <p>Describes the specified export image tasks or all of your export image tasks.</p>
    func describeExportImageTasks(input: DescribeExportImageTasksInput, completion: @escaping (SdkResult<DescribeExportImageTasksOutput, DescribeExportImageTasksOutputError>) -> Void)
    ...
    func describeFastSnapshotRestores(input: DescribeFastSnapshotRestoresInput, completion: @escaping (SdkResult<DescribeFastSnapshotRestoresOutput, DescribeFastSnapshotRestoresOutputError>) -> Void)
    ...
    func describeFleetHistory(input: DescribeFleetHistoryInput, completion: @escaping (SdkResult<DescribeFleetHistoryOutput, DescribeFleetHistoryOutputError>) -> Void)
    /// <p>Describes the running instances for the specified EC2 Fleet.</p>
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet.html#monitor-ec2-fleet">Monitoring your EC2 Fleet</a> in the <i>Amazon EC2 User Guide</i>.</p>
    func describeFleetInstances(input: DescribeFleetInstancesInput, completion: @escaping (SdkResult<DescribeFleetInstancesOutput, DescribeFleetInstancesOutputError>) -> Void)
    ...
    ///             API.</p>
    func describeFlowLogs(input: DescribeFlowLogsInput, completion: @escaping (SdkResult<DescribeFlowLogsOutput, DescribeFlowLogsOutputError>) -> Void)
    /// <p>Describes the specified attribute of the specified Amazon FPGA Image (AFI).</p>
    func describeFpgaImageAttribute(input: DescribeFpgaImageAttributeInput, completion: @escaping (SdkResult<DescribeFpgaImageAttributeOutput, DescribeFpgaImageAttributeOutputError>) -> Void)
    ...
    /// 			permissions.</p>
    func describeFpgaImages(input: DescribeFpgaImagesInput, completion: @escaping (SdkResult<DescribeFpgaImagesOutput, DescribeFpgaImagesOutputError>) -> Void)
    ...
    ///             in the <i>Amazon EC2 User Guide</i>. </p>
    func describeHostReservationOfferings(input: DescribeHostReservationOfferingsInput, completion: @escaping (SdkResult<DescribeHostReservationOfferingsOutput, DescribeHostReservationOfferingsOutputError>) -> Void)
    /// <p>Describes reservations that are associated with Dedicated Hosts in your
    ///             account.</p>
    func describeHostReservations(input: DescribeHostReservationsInput, completion: @escaping (SdkResult<DescribeHostReservationsOutput, DescribeHostReservationsOutputError>) -> Void)
    ...
    func describeHosts(input: DescribeHostsInput, completion: @escaping (SdkResult<DescribeHostsOutput, DescribeHostsOutputError>) -> Void)
    /// <p>Describes your IAM instance profile associations.</p>
    func describeIamInstanceProfileAssociations(input: DescribeIamInstanceProfileAssociationsInput, completion: @escaping (SdkResult<DescribeIamInstanceProfileAssociationsOutput, DescribeIamInstanceProfileAssociationsOutputError>) -> Void)
    ...
    func describeIdentityIdFormat(input: DescribeIdentityIdFormatInput, completion: @escaping (SdkResult<DescribeIdentityIdFormatOutput, DescribeIdentityIdFormatOutputError>) -> Void)
    ...
    ///       resource type.</p>
    func describeIdFormat(input: DescribeIdFormatInput, completion: @escaping (SdkResult<DescribeIdFormatOutput, DescribeIdFormatOutputError>) -> Void)
    /// <p>Describes the specified attribute of the specified AMI. You can specify only one attribute at a time.</p>
    func describeImageAttribute(input: DescribeImageAttributeInput, completion: @escaping (SdkResult<DescribeImageAttributeOutput, DescribeImageAttributeOutputError>) -> Void)
    ...
    func describeImportImageTasks(input: DescribeImportImageTasksInput, completion: @escaping (SdkResult<DescribeImportImageTasksOutput, DescribeImportImageTasksOutputError>) -> Void)
    /// <p>Describes your import snapshot tasks.</p>
    func describeImportSnapshotTasks(input: DescribeImportSnapshotTasksInput, completion: @escaping (SdkResult<DescribeImportSnapshotTasksOutput, DescribeImportSnapshotTasksOutputError>) -> Void)
    ...
    ///         </p>
    func describeInstanceAttribute(input: DescribeInstanceAttributeInput, completion: @escaping (SdkResult<DescribeInstanceAttributeOutput, DescribeInstanceAttributeOutputError>) -> Void)
    ...
    func describeInstanceCreditSpecifications(input: DescribeInstanceCreditSpecificationsInput, completion: @escaping (SdkResult<DescribeInstanceCreditSpecificationsOutput, DescribeInstanceCreditSpecificationsOutputError>) -> Void)
    ...
    func describeInstanceEventNotificationAttributes(input: DescribeInstanceEventNotificationAttributesInput, completion: @escaping (SdkResult<DescribeInstanceEventNotificationAttributesOutput, DescribeInstanceEventNotificationAttributesOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeInstanceStatus(input: DescribeInstanceStatusInput, completion: @escaping (SdkResult<DescribeInstanceStatusOutput, DescribeInstanceStatusOutputError>) -> Void)
    ...
    func describeInstanceTypeOfferings(input: DescribeInstanceTypeOfferingsInput, completion: @escaping (SdkResult<DescribeInstanceTypeOfferingsOutput, DescribeInstanceTypeOfferingsOutputError>) -> Void)
    ...
    func describeInstanceTypes(input: DescribeInstanceTypesInput, completion: @escaping (SdkResult<DescribeInstanceTypesOutput, DescribeInstanceTypesOutputError>) -> Void)
    /// <p>Describes one or more of your internet gateways.</p>
    func describeInternetGateways(input: DescribeInternetGatewaysInput, completion: @escaping (SdkResult<DescribeInternetGatewaysOutput, DescribeInternetGatewaysOutputError>) -> Void)
    /// <p>Describes your IPv6 address pools.</p>
    func describeIpv6Pools(input: DescribeIpv6PoolsInput, completion: @escaping (SdkResult<DescribeIpv6PoolsOutput, DescribeIpv6PoolsOutputError>) -> Void)
    ...
    /// 				in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func describeKeyPairs(input: DescribeKeyPairsInput, completion: @escaping (SdkResult<DescribeKeyPairsOutput, DescribeKeyPairsOutputError>) -> Void)
    /// <p>Describes one or more launch templates.</p>
    func describeLaunchTemplates(input: DescribeLaunchTemplatesInput, completion: @escaping (SdkResult<DescribeLaunchTemplatesOutput, DescribeLaunchTemplatesOutputError>) -> Void)
    ...
    ///             account.</p>
    func describeLaunchTemplateVersions(input: DescribeLaunchTemplateVersionsInput, completion: @escaping (SdkResult<DescribeLaunchTemplateVersionsOutput, DescribeLaunchTemplateVersionsOutputError>) -> Void)
    /// <p>Describes one or more local gateway route tables. By default, all local gateway route tables are described.
    ///          Alternatively, you can filter the results.</p>
    func describeLocalGatewayRouteTables(input: DescribeLocalGatewayRouteTablesInput, completion: @escaping (SdkResult<DescribeLocalGatewayRouteTablesOutput, DescribeLocalGatewayRouteTablesOutputError>) -> Void)
    /// <p>Describes the associations between virtual interface groups and local gateway route tables.</p>
    func describeLocalGatewayRouteTableVirtualInterfaceGroupAssociations(input: DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsInput, completion: @escaping (SdkResult<DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsOutput, DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsOutputError>) -> Void)
    /// <p>Describes the specified associations between VPCs and local gateway route tables.</p>
    func describeLocalGatewayRouteTableVpcAssociations(input: DescribeLocalGatewayRouteTableVpcAssociationsInput, completion: @escaping (SdkResult<DescribeLocalGatewayRouteTableVpcAssociationsOutput, DescribeLocalGatewayRouteTableVpcAssociationsOutputError>) -> Void)
    /// <p>Describes one or more local gateways. By default, all local gateways are described.
    ///         Alternatively, you can filter the results.</p>
    func describeLocalGateways(input: DescribeLocalGatewaysInput, completion: @escaping (SdkResult<DescribeLocalGatewaysOutput, DescribeLocalGatewaysOutputError>) -> Void)
    /// <p>Describes the specified local gateway virtual interface groups.</p>
    func describeLocalGatewayVirtualInterfaceGroups(input: DescribeLocalGatewayVirtualInterfaceGroupsInput, completion: @escaping (SdkResult<DescribeLocalGatewayVirtualInterfaceGroupsOutput, DescribeLocalGatewayVirtualInterfaceGroupsOutputError>) -> Void)
    /// <p>Describes the specified local gateway virtual interfaces.</p>
    func describeLocalGatewayVirtualInterfaces(input: DescribeLocalGatewayVirtualInterfacesInput, completion: @escaping (SdkResult<DescribeLocalGatewayVirtualInterfacesOutput, DescribeLocalGatewayVirtualInterfacesOutputError>) -> Void)
    ...
    func describeManagedPrefixLists(input: DescribeManagedPrefixListsInput, completion: @escaping (SdkResult<DescribeManagedPrefixListsOutput, DescribeManagedPrefixListsOutputError>) -> Void)
    ...
    func describeMovingAddresses(input: DescribeMovingAddressesInput, completion: @escaping (SdkResult<DescribeMovingAddressesOutput, DescribeMovingAddressesOutputError>) -> Void)
    /// <p>Describes one or more of your NAT gateways.</p>
    func describeNatGateways(input: DescribeNatGatewaysInput, completion: @escaping (SdkResult<DescribeNatGatewaysOutput, DescribeNatGatewaysOutputError>) -> Void)
    /// <p>Describes one or more of your network ACLs.</p>
    /// 		       <p>For more information, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_ACLs.html">Network ACLs</a> in the
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func describeNetworkAcls(input: DescribeNetworkAclsInput, completion: @escaping (SdkResult<DescribeNetworkAclsOutput, DescribeNetworkAclsOutputError>) -> Void)
    /// <p>Describes one or more of your network insights analyses.</p>
    func describeNetworkInsightsAnalyses(input: DescribeNetworkInsightsAnalysesInput, completion: @escaping (SdkResult<DescribeNetworkInsightsAnalysesOutput, DescribeNetworkInsightsAnalysesOutputError>) -> Void)
    /// <p>Describes one or more of your paths.</p>
    func describeNetworkInsightsPaths(input: DescribeNetworkInsightsPathsInput, completion: @escaping (SdkResult<DescribeNetworkInsightsPathsOutput, DescribeNetworkInsightsPathsOutputError>) -> Void)
    /// <p>Describes a network interface attribute. You can specify only one attribute at a time.</p>
    func describeNetworkInterfaceAttribute(input: DescribeNetworkInterfaceAttributeInput, completion: @escaping (SdkResult<DescribeNetworkInterfaceAttributeOutput, DescribeNetworkInterfaceAttributeOutputError>) -> Void)
    /// <p>Describes the permissions for your network interfaces. </p>
    func describeNetworkInterfacePermissions(input: DescribeNetworkInterfacePermissionsInput, completion: @escaping (SdkResult<DescribeNetworkInterfacePermissionsOutput, DescribeNetworkInterfacePermissionsOutputError>) -> Void)
    /// <p>Describes one or more of your network interfaces.</p>
    func describeNetworkInterfaces(input: DescribeNetworkInterfacesInput, completion: @escaping (SdkResult<DescribeNetworkInterfacesOutput, DescribeNetworkInterfacesOutputError>) -> Void)
    /// <p>Describes the specified placement groups or all of your placement groups. For more
    ///             information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html">Placement groups</a> in the
    ///                 <i>Amazon EC2 User Guide</i>.</p>
    func describePlacementGroups(input: DescribePlacementGroupsInput, completion: @escaping (SdkResult<DescribePlacementGroupsOutput, DescribePlacementGroupsOutputError>) -> Void)
    ...
    func describePrefixLists(input: DescribePrefixListsInput, completion: @escaping (SdkResult<DescribePrefixListsOutput, DescribePrefixListsOutputError>) -> Void)
    ...
    ///           | <code>vpc-cidr-block-association</code> | <code>vpc-endpoint</code> |
    ///           <code>vpc-peering-connection</code> | <code>vpn-connection</code> | <code>vpn-gateway</code>. </p>
    func describePrincipalIdFormat(input: DescribePrincipalIdFormatInput, completion: @escaping (SdkResult<DescribePrincipalIdFormatOutput, DescribePrincipalIdFormatOutputError>) -> Void)
    /// <p>Describes the specified IPv4 address pools.</p>
    func describePublicIpv4Pools(input: DescribePublicIpv4PoolsInput, completion: @escaping (SdkResult<DescribePublicIpv4PoolsOutput, DescribePublicIpv4PoolsOutputError>) -> Void)
    ...
    func describeRegions(input: DescribeRegionsInput, completion: @escaping (SdkResult<DescribeRegionsOutput, DescribeRegionsOutputError>) -> Void)
    ...
    ///       <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func describeReplaceRootVolumeTasks(input: DescribeReplaceRootVolumeTasksInput, completion: @escaping (SdkResult<DescribeReplaceRootVolumeTasksOutput, DescribeReplaceRootVolumeTasksOutputError>) -> Void)
    ...
    func describeReservedInstances(input: DescribeReservedInstancesInput, completion: @escaping (SdkResult<DescribeReservedInstancesOutput, DescribeReservedInstancesOutputError>) -> Void)
    ...
    ///         in the <i>Amazon EC2 User Guide</i>.</p>
    func describeReservedInstancesListings(input: DescribeReservedInstancesListingsInput, completion: @escaping (SdkResult<DescribeReservedInstancesListingsOutput, DescribeReservedInstancesListingsOutputError>) -> Void)
    ...
    func describeReservedInstancesModifications(input: DescribeReservedInstancesModificationsInput, completion: @escaping (SdkResult<DescribeReservedInstancesModificationsOutput, DescribeReservedInstancesModificationsOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-market-general.html">Reserved Instance Marketplace</a>
    /// 				in the <i>Amazon EC2 User Guide</i>.</p>
    func describeReservedInstancesOfferings(input: DescribeReservedInstancesOfferingsInput, completion: @escaping (SdkResult<DescribeReservedInstancesOfferingsOutput, DescribeReservedInstancesOfferingsOutputError>) -> Void)
    ...
    /// 		       <p>For more information, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html">Route Tables</a> in the
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func describeRouteTables(input: DescribeRouteTablesInput, completion: @escaping (SdkResult<DescribeRouteTablesOutput, DescribeRouteTablesOutputError>) -> Void)
    ...
    func describeScheduledInstanceAvailability(input: DescribeScheduledInstanceAvailabilityInput, completion: @escaping (SdkResult<DescribeScheduledInstanceAvailabilityOutput, DescribeScheduledInstanceAvailabilityOutputError>) -> Void)
    /// <p>Describes the specified Scheduled Instances or all your Scheduled Instances.</p>
    func describeScheduledInstances(input: DescribeScheduledInstancesInput, completion: @escaping (SdkResult<DescribeScheduledInstancesOutput, DescribeScheduledInstancesOutputError>) -> Void)
    ...
    func describeSecurityGroupReferences(input: DescribeSecurityGroupReferencesInput, completion: @escaping (SdkResult<DescribeSecurityGroupReferencesOutput, DescribeSecurityGroupReferencesOutputError>) -> Void)
    ...
    /// 				<a href="https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_SecurityGroups.html">Security Groups for Your VPC</a> in the
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func describeSecurityGroups(input: DescribeSecurityGroupsInput, completion: @escaping (SdkResult<DescribeSecurityGroupsOutput, DescribeSecurityGroupsOutputError>) -> Void)
    ...
    func describeSnapshotAttribute(input: DescribeSnapshotAttributeInput, completion: @escaping (SdkResult<DescribeSnapshotAttributeOutput, DescribeSnapshotAttributeOutputError>) -> Void)
    ...
    func describeSpotDatafeedSubscription(input: DescribeSpotDatafeedSubscriptionInput, completion: @escaping (SdkResult<DescribeSpotDatafeedSubscriptionOutput, DescribeSpotDatafeedSubscriptionOutputError>) -> Void)
    /// <p>Describes the running instances for the specified Spot Fleet.</p>
    func describeSpotFleetInstances(input: DescribeSpotFleetInstancesInput, completion: @escaping (SdkResult<DescribeSpotFleetInstancesOutput, DescribeSpotFleetInstancesOutputError>) -> Void)
    ...
    func describeSpotFleetRequestHistory(input: DescribeSpotFleetRequestHistoryInput, completion: @escaping (SdkResult<DescribeSpotFleetRequestHistoryOutput, DescribeSpotFleetRequestHistoryOutputError>) -> Void)
    ...
    func describeSpotFleetRequests(input: DescribeSpotFleetRequestsInput, completion: @escaping (SdkResult<DescribeSpotFleetRequestsOutput, DescribeSpotFleetRequestsOutputError>) -> Void)
    ...
    ///             are terminated.</p>
    func describeSpotInstanceRequests(input: DescribeSpotInstanceRequestsInput, completion: @escaping (SdkResult<DescribeSpotInstanceRequestsOutput, DescribeSpotInstanceRequestsOutputError>) -> Void)
    ...
    func describeSpotPriceHistory(input: DescribeSpotPriceHistoryInput, completion: @escaping (SdkResult<DescribeSpotPriceHistoryOutput, DescribeSpotPriceHistoryOutputError>) -> Void)
    ...
    func describeStaleSecurityGroups(input: DescribeStaleSecurityGroupsInput, completion: @escaping (SdkResult<DescribeStaleSecurityGroupsOutput, DescribeStaleSecurityGroupsOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-store-restore.html">Store and restore an AMI using
    ///         S3</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func describeStoreImageTasks(input: DescribeStoreImageTasksInput, completion: @escaping (SdkResult<DescribeStoreImageTasksOutput, DescribeStoreImageTasksOutputError>) -> Void)
    ...
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func describeSubnets(input: DescribeSubnetsInput, completion: @escaping (SdkResult<DescribeSubnetsOutput, DescribeSubnetsOutputError>) -> Void)
    ...
    func describeTrafficMirrorFilters(input: DescribeTrafficMirrorFiltersInput, completion: @escaping (SdkResult<DescribeTrafficMirrorFiltersOutput, DescribeTrafficMirrorFiltersOutputError>) -> Void)
    /// <p>Describes one or more Traffic Mirror sessions. By default, all Traffic Mirror sessions are described. Alternatively, you can filter the results.</p>
    func describeTrafficMirrorSessions(input: DescribeTrafficMirrorSessionsInput, completion: @escaping (SdkResult<DescribeTrafficMirrorSessionsOutput, DescribeTrafficMirrorSessionsOutputError>) -> Void)
    /// <p>Information about one or more Traffic Mirror targets.</p>
    func describeTrafficMirrorTargets(input: DescribeTrafficMirrorTargetsInput, completion: @escaping (SdkResult<DescribeTrafficMirrorTargetsOutput, DescribeTrafficMirrorTargetsOutputError>) -> Void)
    ...
    func describeTransitGatewayAttachments(input: DescribeTransitGatewayAttachmentsInput, completion: @escaping (SdkResult<DescribeTransitGatewayAttachmentsOutput, DescribeTransitGatewayAttachmentsOutputError>) -> Void)
    /// <p>Describes one or more Connect peers.</p>
    func describeTransitGatewayConnectPeers(input: DescribeTransitGatewayConnectPeersInput, completion: @escaping (SdkResult<DescribeTransitGatewayConnectPeersOutput, DescribeTransitGatewayConnectPeersOutputError>) -> Void)
    /// <p>Describes one or more Connect attachments.</p>
    func describeTransitGatewayConnects(input: DescribeTransitGatewayConnectsInput, completion: @escaping (SdkResult<DescribeTransitGatewayConnectsOutput, DescribeTransitGatewayConnectsOutputError>) -> Void)
    /// <p>Describes one or more transit gateway multicast domains.</p>
    func describeTransitGatewayMulticastDomains(input: DescribeTransitGatewayMulticastDomainsInput, completion: @escaping (SdkResult<DescribeTransitGatewayMulticastDomainsOutput, DescribeTransitGatewayMulticastDomainsOutputError>) -> Void)
    /// <p>Describes your transit gateway peering attachments.</p>
    func describeTransitGatewayPeeringAttachments(input: DescribeTransitGatewayPeeringAttachmentsInput, completion: @escaping (SdkResult<DescribeTransitGatewayPeeringAttachmentsOutput, DescribeTransitGatewayPeeringAttachmentsOutputError>) -> Void)
    /// <p>Describes one or more transit gateway route tables. By default, all transit gateway route tables are described.
    ///          Alternatively, you can filter the results.</p>
    func describeTransitGatewayRouteTables(input: DescribeTransitGatewayRouteTablesInput, completion: @escaping (SdkResult<DescribeTransitGatewayRouteTablesOutput, DescribeTransitGatewayRouteTablesOutputError>) -> Void)
    ...
    func describeTransitGateways(input: DescribeTransitGatewaysInput, completion: @escaping (SdkResult<DescribeTransitGatewaysOutput, DescribeTransitGatewaysOutputError>) -> Void)
    /// <p>Describes one or more VPC attachments. By default, all VPC attachments are described.
    ///          Alternatively, you can filter the results.</p>
    func describeTransitGatewayVpcAttachments(input: DescribeTransitGatewayVpcAttachmentsInput, completion: @escaping (SdkResult<DescribeTransitGatewayVpcAttachmentsOutput, DescribeTransitGatewayVpcAttachmentsOutputError>) -> Void)
    ...
    func describeVolumeAttribute(input: DescribeVolumeAttributeInput, completion: @escaping (SdkResult<DescribeVolumeAttributeOutput, DescribeVolumeAttributeOutputError>) -> Void)
    ...
    ///       <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func describeVolumesModifications(input: DescribeVolumesModificationsInput, completion: @escaping (SdkResult<DescribeVolumesModificationsOutput, DescribeVolumesModificationsOutputError>) -> Void)
    ...
    func describeVolumeStatus(input: DescribeVolumeStatusInput, completion: @escaping (SdkResult<DescribeVolumeStatusOutput, DescribeVolumeStatusOutputError>) -> Void)
    /// <p>Describes the specified attribute of the specified VPC. You can specify only one attribute at a time.</p>
    func describeVpcAttribute(input: DescribeVpcAttributeInput, completion: @escaping (SdkResult<DescribeVpcAttributeOutput, DescribeVpcAttributeOutputError>) -> Void)
    /// <p>Describes the ClassicLink status of one or more VPCs.</p>
    func describeVpcClassicLink(input: DescribeVpcClassicLinkInput, completion: @escaping (SdkResult<DescribeVpcClassicLinkOutput, DescribeVpcClassicLinkOutputError>) -> Void)
    ...
    func describeVpcClassicLinkDnsSupport(input: DescribeVpcClassicLinkDnsSupportInput, completion: @escaping (SdkResult<DescribeVpcClassicLinkDnsSupportOutput, DescribeVpcClassicLinkDnsSupportOutputError>) -> Void)
    /// <p>Describes the connection notifications for VPC endpoints and VPC endpoint
    ///             services.</p>
    func describeVpcEndpointConnectionNotifications(input: DescribeVpcEndpointConnectionNotificationsInput, completion: @escaping (SdkResult<DescribeVpcEndpointConnectionNotificationsOutput, DescribeVpcEndpointConnectionNotificationsOutputError>) -> Void)
    ...
    func describeVpcEndpointConnections(input: DescribeVpcEndpointConnectionsInput, completion: @escaping (SdkResult<DescribeVpcEndpointConnectionsOutput, DescribeVpcEndpointConnectionsOutputError>) -> Void)
    /// <p>Describes one or more of your VPC endpoints.</p>
    func describeVpcEndpoints(input: DescribeVpcEndpointsInput, completion: @escaping (SdkResult<DescribeVpcEndpointsOutput, DescribeVpcEndpointsOutputError>) -> Void)
    /// <p>Describes the VPC endpoint service configurations in your account (your services).</p>
    func describeVpcEndpointServiceConfigurations(input: DescribeVpcEndpointServiceConfigurationsInput, completion: @escaping (SdkResult<DescribeVpcEndpointServiceConfigurationsOutput, DescribeVpcEndpointServiceConfigurationsOutputError>) -> Void)
    /// <p>Describes the principals (service consumers) that are permitted to discover your VPC
    ///             endpoint service.</p>
    func describeVpcEndpointServicePermissions(input: DescribeVpcEndpointServicePermissionsInput, completion: @escaping (SdkResult<DescribeVpcEndpointServicePermissionsOutput, DescribeVpcEndpointServicePermissionsOutputError>) -> Void)
    ...
    func describeVpcEndpointServices(input: DescribeVpcEndpointServicesInput, completion: @escaping (SdkResult<DescribeVpcEndpointServicesOutput, DescribeVpcEndpointServicesOutputError>) -> Void)
    ...
    func describeVpcs(input: DescribeVpcsInput, completion: @escaping (SdkResult<DescribeVpcsOutput, DescribeVpcsOutputError>) -> Void)
    /// <p>Describes one or more of your VPN connections.</p>
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN User Guide</i>.</p>
    func describeVpnConnections(input: DescribeVpnConnectionsInput, completion: @escaping (SdkResult<DescribeVpnConnectionsOutput, DescribeVpnConnectionsOutputError>) -> Void)
    /// <p>Describes one or more of your virtual private gateways.</p>
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN User Guide</i>.</p>
    func describeVpnGateways(input: DescribeVpnGatewaysInput, completion: @escaping (SdkResult<DescribeVpnGatewaysOutput, DescribeVpnGatewaysOutputError>) -> Void)
    ...
    func detachClassicLinkVpc(input: DetachClassicLinkVpcInput, completion: @escaping (SdkResult<DetachClassicLinkVpcOutput, DetachClassicLinkVpcOutputError>) -> Void)
    ...
    func detachInternetGateway(input: DetachInternetGatewayInput, completion: @escaping (SdkResult<DetachInternetGatewayOutput, DetachInternetGatewayOutputError>) -> Void)
    /// <p>Detaches a network interface from an instance.</p>
    func detachNetworkInterface(input: DetachNetworkInterfaceInput, completion: @escaping (SdkResult<DetachNetworkInterfaceOutput, DetachNetworkInterfaceOutputError>) -> Void)
    ...
    func detachVpnGateway(input: DetachVpnGatewayInput, completion: @escaping (SdkResult<DetachVpnGatewayOutput, DetachVpnGatewayOutputError>) -> Void)
    ...
    ///       <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func disableEbsEncryptionByDefault(input: DisableEbsEncryptionByDefaultInput, completion: @escaping (SdkResult<DisableEbsEncryptionByDefaultOutput, DisableEbsEncryptionByDefaultOutputError>) -> Void)
    /// <p>Disables fast snapshot restores for the specified snapshots in the specified Availability Zones.</p>
    func disableFastSnapshotRestores(input: DisableFastSnapshotRestoresInput, completion: @escaping (SdkResult<DisableFastSnapshotRestoresOutput, DisableFastSnapshotRestoresOutputError>) -> Void)
    ...
    /// 				User Guide</i>.</p>
    func disableSerialConsoleAccess(input: DisableSerialConsoleAccessInput, completion: @escaping (SdkResult<DisableSerialConsoleAccessOutput, DisableSerialConsoleAccessOutputError>) -> Void)
    /// <p>Disables the specified resource attachment from propagating routes to the specified
    ///          propagation route table.</p>
    func disableTransitGatewayRouteTablePropagation(input: DisableTransitGatewayRouteTablePropagationInput, completion: @escaping (SdkResult<DisableTransitGatewayRouteTablePropagationOutput, DisableTransitGatewayRouteTablePropagationOutputError>) -> Void)
    /// <p>Disables a virtual private gateway (VGW) from propagating routes to a specified route table of a VPC.</p>
    func disableVgwRoutePropagation(input: DisableVgwRoutePropagationInput, completion: @escaping (SdkResult<DisableVgwRoutePropagationOutput, DisableVgwRoutePropagationOutputError>) -> Void)
    /// <p>Disables ClassicLink for a VPC. You cannot disable ClassicLink for a VPC that has EC2-Classic instances linked to it.</p>
    func disableVpcClassicLink(input: DisableVpcClassicLinkInput, completion: @escaping (SdkResult<DisableVpcClassicLinkOutput, DisableVpcClassicLinkOutputError>) -> Void)
    ...
    func disableVpcClassicLinkDnsSupport(input: DisableVpcClassicLinkDnsSupportInput, completion: @escaping (SdkResult<DisableVpcClassicLinkDnsSupportOutput, DisableVpcClassicLinkDnsSupportOutputError>) -> Void)
    ...
    func disassociateAddress(input: DisassociateAddressInput, completion: @escaping (SdkResult<DisassociateAddressOutput, DisassociateAddressOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func disassociateClientVpnTargetNetwork(input: DisassociateClientVpnTargetNetworkInput, completion: @escaping (SdkResult<DisassociateClientVpnTargetNetworkOutput, DisassociateClientVpnTargetNetworkOutputError>) -> Void)
    ...
    func disassociateEnclaveCertificateIamRole(input: DisassociateEnclaveCertificateIamRoleInput, completion: @escaping (SdkResult<DisassociateEnclaveCertificateIamRoleOutput, DisassociateEnclaveCertificateIamRoleOutputError>) -> Void)
    ...
    ///             ID.</p>
    func disassociateIamInstanceProfile(input: DisassociateIamInstanceProfileInput, completion: @escaping (SdkResult<DisassociateIamInstanceProfileOutput, DisassociateIamInstanceProfileOutputError>) -> Void)
    ...
    func disassociateRouteTable(input: DisassociateRouteTableInput, completion: @escaping (SdkResult<DisassociateRouteTableOutput, DisassociateRouteTableOutputError>) -> Void)
    ...
    func disassociateSubnetCidrBlock(input: DisassociateSubnetCidrBlockInput, completion: @escaping (SdkResult<DisassociateSubnetCidrBlockOutput, DisassociateSubnetCidrBlockOutputError>) -> Void)
    /// <p>Disassociates the specified subnets from the transit gateway multicast domain. </p>
    func disassociateTransitGatewayMulticastDomain(input: DisassociateTransitGatewayMulticastDomainInput, completion: @escaping (SdkResult<DisassociateTransitGatewayMulticastDomainOutput, DisassociateTransitGatewayMulticastDomainOutputError>) -> Void)
    /// <p>Disassociates a resource attachment from a transit gateway route table.</p>
    func disassociateTransitGatewayRouteTable(input: DisassociateTransitGatewayRouteTableInput, completion: @escaping (SdkResult<DisassociateTransitGatewayRouteTableOutput, DisassociateTransitGatewayRouteTableOutputError>) -> Void)
    ...
    func disassociateVpcCidrBlock(input: DisassociateVpcCidrBlockInput, completion: @escaping (SdkResult<DisassociateVpcCidrBlockOutput, DisassociateVpcCidrBlockOutputError>) -> Void)
    ...
    ///         instance types</a>.</p>
    func enableEbsEncryptionByDefault(input: EnableEbsEncryptionByDefaultInput, completion: @escaping (SdkResult<EnableEbsEncryptionByDefaultOutput, EnableEbsEncryptionByDefaultOutputError>) -> Void)
    ...
    func enableFastSnapshotRestores(input: EnableFastSnapshotRestoresInput, completion: @escaping (SdkResult<EnableFastSnapshotRestoresOutput, EnableFastSnapshotRestoresOutputError>) -> Void)
    ...
    /// 			in the <i>Amazon EC2 User Guide</i>.</p>
    func enableSerialConsoleAccess(input: EnableSerialConsoleAccessInput, completion: @escaping (SdkResult<EnableSerialConsoleAccessOutput, EnableSerialConsoleAccessOutputError>) -> Void)
    /// <p>Enables the specified attachment to propagate routes to the specified
    ///          propagation route table.</p>
    func enableTransitGatewayRouteTablePropagation(input: EnableTransitGatewayRouteTablePropagationInput, completion: @escaping (SdkResult<EnableTransitGatewayRouteTablePropagationOutput, EnableTransitGatewayRouteTablePropagationOutputError>) -> Void)
    /// <p>Enables a virtual private gateway (VGW) to propagate routes to the specified route table of a VPC.</p>
    func enableVgwRoutePropagation(input: EnableVgwRoutePropagationInput, completion: @escaping (SdkResult<EnableVgwRoutePropagationOutput, EnableVgwRoutePropagationOutputError>) -> Void)
    ...
    func enableVolumeIO(input: EnableVolumeIOInput, completion: @escaping (SdkResult<EnableVolumeIOOutput, EnableVolumeIOOutputError>) -> Void)
    ...
    /// 				<i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func enableVpcClassicLink(input: EnableVpcClassicLinkInput, completion: @escaping (SdkResult<EnableVpcClassicLinkOutput, EnableVpcClassicLinkOutputError>) -> Void)
    ...
    /// 				<i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    ///          <p>You must specify a VPC ID in the request.</p>
    func enableVpcClassicLinkDnsSupport(input: EnableVpcClassicLinkDnsSupportInput, completion: @escaping (SdkResult<EnableVpcClassicLinkDnsSupportOutput, EnableVpcClassicLinkDnsSupportOutputError>) -> Void)
    /// <p>Downloads the client certificate revocation list for the specified Client VPN endpoint.</p>
    func exportClientVpnClientCertificateRevocationList(input: ExportClientVpnClientCertificateRevocationListInput, completion: @escaping (SdkResult<ExportClientVpnClientCertificateRevocationListOutput, ExportClientVpnClientCertificateRevocationListOutputError>) -> Void)
    ...
    func exportClientVpnClientConfiguration(input: ExportClientVpnClientConfigurationInput, completion: @escaping (SdkResult<ExportClientVpnClientConfigurationOutput, ExportClientVpnClientConfigurationOutputError>) -> Void)
    ...
    func exportImage(input: ExportImageInput, completion: @escaping (SdkResult<ExportImageOutput, ExportImageOutputError>) -> Void)
    ...
    func exportTransitGatewayRoutes(input: ExportTransitGatewayRoutesInput, completion: @escaping (SdkResult<ExportTransitGatewayRoutesOutput, ExportTransitGatewayRoutesOutputError>) -> Void)
    ...
    func getAssociatedEnclaveCertificateIamRoles(input: GetAssociatedEnclaveCertificateIamRolesInput, completion: @escaping (SdkResult<GetAssociatedEnclaveCertificateIamRolesOutput, GetAssociatedEnclaveCertificateIamRolesOutputError>) -> Void)
    /// <p>Gets information about the IPv6 CIDR block associations for a specified IPv6 address pool.</p>
    func getAssociatedIpv6PoolCidrs(input: GetAssociatedIpv6PoolCidrsInput, completion: @escaping (SdkResult<GetAssociatedIpv6PoolCidrsOutput, GetAssociatedIpv6PoolCidrsOutputError>) -> Void)
    ...
    func getCapacityReservationUsage(input: GetCapacityReservationUsageInput, completion: @escaping (SdkResult<GetCapacityReservationUsageOutput, GetCapacityReservationUsageOutputError>) -> Void)
    /// <p>Describes the allocations from the specified customer-owned address pool.</p>
    func getCoipPoolUsage(input: GetCoipPoolUsageInput, completion: @escaping (SdkResult<GetCoipPoolUsageOutput, GetCoipPoolUsageOutputError>) -> Void)
    ...
    func getConsoleOutput(input: GetConsoleOutputInput, completion: @escaping (SdkResult<GetConsoleOutputOutput, GetConsoleOutputOutputError>) -> Void)
    /// <p>Retrieve a JPG-format screenshot of a running instance to help with
    ///             troubleshooting.</p>
    ///         <p>The returned content is Base64-encoded.</p>
    func getConsoleScreenshot(input: GetConsoleScreenshotInput, completion: @escaping (SdkResult<GetConsoleScreenshotOutput, GetConsoleScreenshotOutputError>) -> Void)
    /// <p>Describes the default credit option for CPU usage of a burstable performance instance family.</p>
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html">Burstable
    ///             performance instances</a> in the <i>Amazon EC2 User Guide</i>.</p>
    func getDefaultCreditSpecification(input: GetDefaultCreditSpecificationInput, completion: @escaping (SdkResult<GetDefaultCreditSpecificationOutput, GetDefaultCreditSpecificationOutputError>) -> Void)
    ...
    ///       in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func getEbsDefaultKmsKeyId(input: GetEbsDefaultKmsKeyIdInput, completion: @escaping (SdkResult<GetEbsDefaultKmsKeyIdOutput, GetEbsDefaultKmsKeyIdOutputError>) -> Void)
    /// <p>Describes whether EBS encryption by default is enabled for your account in the current
    ///       Region.</p>
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html">Amazon EBS encryption</a>
    ///       in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func getEbsEncryptionByDefault(input: GetEbsEncryptionByDefaultInput, completion: @escaping (SdkResult<GetEbsEncryptionByDefaultOutput, GetEbsEncryptionByDefaultOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func getFlowLogsIntegrationTemplate(input: GetFlowLogsIntegrationTemplateInput, completion: @escaping (SdkResult<GetFlowLogsIntegrationTemplateOutput, GetFlowLogsIntegrationTemplateOutputError>) -> Void)
    /// <p>Lists the resource groups to which a Capacity Reservation has been added.</p>
    func getGroupsForCapacityReservation(input: GetGroupsForCapacityReservationInput, completion: @escaping (SdkResult<GetGroupsForCapacityReservationOutput, GetGroupsForCapacityReservationOutputError>) -> Void)
    ...
    func getHostReservationPurchasePreview(input: GetHostReservationPurchasePreviewInput, completion: @escaping (SdkResult<GetHostReservationPurchasePreviewOutput, GetHostReservationPurchasePreviewOutputError>) -> Void)
    ...
    func getLaunchTemplateData(input: GetLaunchTemplateDataInput, completion: @escaping (SdkResult<GetLaunchTemplateDataOutput, GetLaunchTemplateDataOutputError>) -> Void)
    /// <p>Gets information about the resources that are associated with the specified managed prefix list.</p>
    func getManagedPrefixListAssociations(input: GetManagedPrefixListAssociationsInput, completion: @escaping (SdkResult<GetManagedPrefixListAssociationsOutput, GetManagedPrefixListAssociationsOutputError>) -> Void)
    /// <p>Gets information about the entries for a specified managed prefix list.</p>
    func getManagedPrefixListEntries(input: GetManagedPrefixListEntriesInput, completion: @escaping (SdkResult<GetManagedPrefixListEntriesOutput, GetManagedPrefixListEntriesOutputError>) -> Void)
    ...
    func getPasswordData(input: GetPasswordDataInput, completion: @escaping (SdkResult<GetPasswordDataOutput, GetPasswordDataOutputError>) -> Void)
    ...
    func getReservedInstancesExchangeQuote(input: GetReservedInstancesExchangeQuoteInput, completion: @escaping (SdkResult<GetReservedInstancesExchangeQuoteOutput, GetReservedInstancesExchangeQuoteOutputError>) -> Void)
    ...
    /// 				User Guide</i>.</p>
    func getSerialConsoleAccessStatus(input: GetSerialConsoleAccessStatusInput, completion: @escaping (SdkResult<GetSerialConsoleAccessStatusOutput, GetSerialConsoleAccessStatusOutputError>) -> Void)
    /// <p>Lists the route tables to which the specified resource attachment propagates routes.</p>
    func getTransitGatewayAttachmentPropagations(input: GetTransitGatewayAttachmentPropagationsInput, completion: @escaping (SdkResult<GetTransitGatewayAttachmentPropagationsOutput, GetTransitGatewayAttachmentPropagationsOutputError>) -> Void)
    /// <p>Gets information about the associations for the transit gateway multicast domain.</p>
    func getTransitGatewayMulticastDomainAssociations(input: GetTransitGatewayMulticastDomainAssociationsInput, completion: @escaping (SdkResult<GetTransitGatewayMulticastDomainAssociationsOutput, GetTransitGatewayMulticastDomainAssociationsOutputError>) -> Void)
    /// <p>Gets information about the prefix list references in a specified transit gateway route table.</p>
    func getTransitGatewayPrefixListReferences(input: GetTransitGatewayPrefixListReferencesInput, completion: @escaping (SdkResult<GetTransitGatewayPrefixListReferencesOutput, GetTransitGatewayPrefixListReferencesOutputError>) -> Void)
    /// <p>Gets information about the associations for the specified transit gateway route table.</p>
    func getTransitGatewayRouteTableAssociations(input: GetTransitGatewayRouteTableAssociationsInput, completion: @escaping (SdkResult<GetTransitGatewayRouteTableAssociationsOutput, GetTransitGatewayRouteTableAssociationsOutputError>) -> Void)
    /// <p>Gets information about the route table propagations for the specified transit gateway route table.</p>
    func getTransitGatewayRouteTablePropagations(input: GetTransitGatewayRouteTablePropagationsInput, completion: @escaping (SdkResult<GetTransitGatewayRouteTablePropagationsOutput, GetTransitGatewayRouteTablePropagationsOutputError>) -> Void)
    ...
    func importClientVpnClientCertificateRevocationList(input: ImportClientVpnClientCertificateRevocationListInput, completion: @escaping (SdkResult<ImportClientVpnClientCertificateRevocationListOutput, ImportClientVpnClientCertificateRevocationListOutputError>) -> Void)
    ...
    func importImage(input: ImportImageInput, completion: @escaping (SdkResult<ImportImageOutput, ImportImageOutputError>) -> Void)
    ...
    ///          <p>For information about the import manifest referenced by this API action, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/manifest.html">VM Import Manifest</a>.</p>
    func importInstance(input: ImportInstanceInput, completion: @escaping (SdkResult<ImportInstanceOutput, ImportInstanceOutputError>) -> Void)
    ...
    ///          <p>For more information about key pairs, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html">Key Pairs</a>
    /// 				in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func importKeyPair(input: ImportKeyPairInput, completion: @escaping (SdkResult<ImportKeyPairOutput, ImportKeyPairOutputError>) -> Void)
    ...
    ///    <i>VM Import/Export User Guide</i>.</p>
    func importSnapshot(input: ImportSnapshotInput, completion: @escaping (SdkResult<ImportSnapshotOutput, ImportSnapshotOutputError>) -> Void)
    ...
    ///          <p>For information about the import manifest referenced by this API action, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/manifest.html">VM Import Manifest</a>.</p>
    func importVolume(input: ImportVolumeInput, completion: @escaping (SdkResult<ImportVolumeOutput, ImportVolumeOutputError>) -> Void)
    ...
    func modifyAddressAttribute(input: ModifyAddressAttributeInput, completion: @escaping (SdkResult<ModifyAddressAttributeOutput, ModifyAddressAttributeOutputError>) -> Void)
    ...
    func modifyAvailabilityZoneGroup(input: ModifyAvailabilityZoneGroupInput, completion: @escaping (SdkResult<ModifyAvailabilityZoneGroupOutput, ModifyAvailabilityZoneGroupOutputError>) -> Void)
    ...
    func modifyCapacityReservation(input: ModifyCapacityReservationInput, completion: @escaping (SdkResult<ModifyCapacityReservationOutput, ModifyCapacityReservationOutputError>) -> Void)
    /// <p>Modifies the specified Client VPN endpoint. Modifying the DNS server resets existing client connections.</p>
    func modifyClientVpnEndpoint(input: ModifyClientVpnEndpointInput, completion: @escaping (SdkResult<ModifyClientVpnEndpointOutput, ModifyClientVpnEndpointOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html">Burstable
    ///             performance instances</a> in the <i>Amazon EC2 User Guide</i>.</p>
    func modifyDefaultCreditSpecification(input: ModifyDefaultCreditSpecificationInput, completion: @escaping (SdkResult<ModifyDefaultCreditSpecificationOutput, ModifyDefaultCreditSpecificationOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html">Amazon EBS encryption</a>
    ///       in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func modifyEbsDefaultKmsKeyId(input: ModifyEbsDefaultKmsKeyIdInput, completion: @escaping (SdkResult<ModifyEbsDefaultKmsKeyIdOutput, ModifyEbsDefaultKmsKeyIdOutputError>) -> Void)
    ...
    func modifyFleet(input: ModifyFleetInput, completion: @escaping (SdkResult<ModifyFleetOutput, ModifyFleetOutputError>) -> Void)
    /// <p>Modifies the specified attribute of the specified Amazon FPGA Image (AFI).</p>
    func modifyFpgaImageAttribute(input: ModifyFpgaImageAttributeInput, completion: @escaping (SdkResult<ModifyFpgaImageAttributeOutput, ModifyFpgaImageAttributeOutputError>) -> Void)
    ...
    func modifyHosts(input: ModifyHostsInput, completion: @escaping (SdkResult<ModifyHostsOutput, ModifyHostsOutputError>) -> Void)
    ...
    func modifyIdentityIdFormat(input: ModifyIdentityIdFormatInput, completion: @escaping (SdkResult<ModifyIdentityIdFormatOutput, ModifyIdentityIdFormatOutputError>) -> Void)
    ...
    func modifyIdFormat(input: ModifyIdFormatInput, completion: @escaping (SdkResult<ModifyIdFormatOutput, ModifyIdFormatOutputError>) -> Void)
    ...
    func modifyImageAttribute(input: ModifyImageAttributeInput, completion: @escaping (SdkResult<ModifyImageAttributeOutput, ModifyImageAttributeOutputError>) -> Void)
    ...
    func modifyInstanceAttribute(input: ModifyInstanceAttributeInput, completion: @escaping (SdkResult<ModifyInstanceAttributeOutput, ModifyInstanceAttributeOutputError>) -> Void)
    ...
    func modifyInstanceCapacityReservationAttributes(input: ModifyInstanceCapacityReservationAttributesInput, completion: @escaping (SdkResult<ModifyInstanceCapacityReservationAttributesOutput, ModifyInstanceCapacityReservationAttributesOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html">Burstable
    ///                 performance instances</a> in the <i>Amazon EC2 User Guide</i>.</p>
    func modifyInstanceCreditSpecification(input: ModifyInstanceCreditSpecificationInput, completion: @escaping (SdkResult<ModifyInstanceCreditSpecificationOutput, ModifyInstanceCreditSpecificationOutputError>) -> Void)
    /// <p>Modifies the start time for a scheduled Amazon EC2 instance event.</p>
    func modifyInstanceEventStartTime(input: ModifyInstanceEventStartTimeInput, completion: @escaping (SdkResult<ModifyInstanceEventStartTimeOutput, ModifyInstanceEventStartTimeOutputError>) -> Void)
    ...
    ///           in the <i>Amazon EC2 User Guide</i>.</p>
    func modifyInstanceMetadataOptions(input: ModifyInstanceMetadataOptionsInput, completion: @escaping (SdkResult<ModifyInstanceMetadataOptionsOutput, ModifyInstanceMetadataOptionsOutputError>) -> Void)
    ...
    func modifyInstancePlacement(input: ModifyInstancePlacementInput, completion: @escaping (SdkResult<ModifyInstancePlacementOutput, ModifyInstancePlacementOutputError>) -> Void)
    ...
    func modifyLaunchTemplate(input: ModifyLaunchTemplateInput, completion: @escaping (SdkResult<ModifyLaunchTemplateOutput, ModifyLaunchTemplateOutputError>) -> Void)
    ...
    func modifyManagedPrefixList(input: ModifyManagedPrefixListInput, completion: @escaping (SdkResult<ModifyManagedPrefixListOutput, ModifyManagedPrefixListOutputError>) -> Void)
    ...
    func modifyNetworkInterfaceAttribute(input: ModifyNetworkInterfaceAttributeInput, completion: @escaping (SdkResult<ModifyNetworkInterfaceAttributeOutput, ModifyNetworkInterfaceAttributeOutputError>) -> Void)
    ...
    /// 				Instances</a> in the <i>Amazon EC2 User Guide</i>.</p>
    func modifyReservedInstances(input: ModifyReservedInstancesInput, completion: @escaping (SdkResult<ModifyReservedInstancesOutput, ModifyReservedInstancesOutputError>) -> Void)
    ...
    ///         <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func modifySnapshotAttribute(input: ModifySnapshotAttributeInput, completion: @escaping (SdkResult<ModifySnapshotAttributeOutput, ModifySnapshotAttributeOutputError>) -> Void)
    ...
    ///        target capacity to 0.</p>
    func modifySpotFleetRequest(input: ModifySpotFleetRequestInput, completion: @escaping (SdkResult<ModifySpotFleetRequestOutput, ModifySpotFleetRequestOutputError>) -> Void)
    /// <p>Modifies a subnet attribute. You can only modify one attribute at a time.</p>
    func modifySubnetAttribute(input: ModifySubnetAttributeInput, completion: @escaping (SdkResult<ModifySubnetAttributeOutput, ModifySubnetAttributeOutputError>) -> Void)
    ...
    func modifyTrafficMirrorFilterNetworkServices(input: ModifyTrafficMirrorFilterNetworkServicesInput, completion: @escaping (SdkResult<ModifyTrafficMirrorFilterNetworkServicesOutput, ModifyTrafficMirrorFilterNetworkServicesOutputError>) -> Void)
    ...
    func modifyTrafficMirrorFilterRule(input: ModifyTrafficMirrorFilterRuleInput, completion: @escaping (SdkResult<ModifyTrafficMirrorFilterRuleOutput, ModifyTrafficMirrorFilterRuleOutputError>) -> Void)
    /// <p>Modifies a Traffic Mirror session.</p>
    func modifyTrafficMirrorSession(input: ModifyTrafficMirrorSessionInput, completion: @escaping (SdkResult<ModifyTrafficMirrorSessionOutput, ModifyTrafficMirrorSessionOutputError>) -> Void)
    ...
    func modifyTransitGateway(input: ModifyTransitGatewayInput, completion: @escaping (SdkResult<ModifyTransitGatewayOutput, ModifyTransitGatewayOutputError>) -> Void)
    /// <p>Modifies a reference (route) to a prefix list in a specified transit gateway route table.</p>
    func modifyTransitGatewayPrefixListReference(input: ModifyTransitGatewayPrefixListReferenceInput, completion: @escaping (SdkResult<ModifyTransitGatewayPrefixListReferenceOutput, ModifyTransitGatewayPrefixListReferenceOutputError>) -> Void)
    /// <p>Modifies the specified VPC attachment.</p>
    func modifyTransitGatewayVpcAttachment(input: ModifyTransitGatewayVpcAttachmentInput, completion: @escaping (SdkResult<ModifyTransitGatewayVpcAttachmentOutput, ModifyTransitGatewayVpcAttachmentOutputError>) -> Void)
    ...
    func modifyVolume(input: ModifyVolumeInput, completion: @escaping (SdkResult<ModifyVolumeOutput, ModifyVolumeOutputError>) -> Void)
    ...
    func modifyVolumeAttribute(input: ModifyVolumeAttributeInput, completion: @escaping (SdkResult<ModifyVolumeAttributeOutput, ModifyVolumeAttributeOutputError>) -> Void)
    /// <p>Modifies the specified attribute of the specified VPC.</p>
    func modifyVpcAttribute(input: ModifyVpcAttributeInput, completion: @escaping (SdkResult<ModifyVpcAttributeOutput, ModifyVpcAttributeOutputError>) -> Void)
    ...
    func modifyVpcEndpoint(input: ModifyVpcEndpointInput, completion: @escaping (SdkResult<ModifyVpcEndpointOutput, ModifyVpcEndpointOutputError>) -> Void)
    ...
    func modifyVpcEndpointConnectionNotification(input: ModifyVpcEndpointConnectionNotificationInput, completion: @escaping (SdkResult<ModifyVpcEndpointConnectionNotificationOutput, ModifyVpcEndpointConnectionNotificationOutputError>) -> Void)
    ...
    ///                 Private DNS Name Verification</a> in the
    ///             <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func modifyVpcEndpointServiceConfiguration(input: ModifyVpcEndpointServiceConfigurationInput, completion: @escaping (SdkResult<ModifyVpcEndpointServiceConfigurationOutput, ModifyVpcEndpointServiceConfigurationOutputError>) -> Void)
    ...
    func modifyVpcEndpointServicePermissions(input: ModifyVpcEndpointServicePermissionsInput, completion: @escaping (SdkResult<ModifyVpcEndpointServicePermissionsOutput, ModifyVpcEndpointServicePermissionsOutputError>) -> Void)
    ...
    func modifyVpcPeeringConnectionOptions(input: ModifyVpcPeeringConnectionOptionsInput, completion: @escaping (SdkResult<ModifyVpcPeeringConnectionOptionsOutput, ModifyVpcPeeringConnectionOptionsOutputError>) -> Void)
    ...
    /// 				<i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func modifyVpcTenancy(input: ModifyVpcTenancyInput, completion: @escaping (SdkResult<ModifyVpcTenancyOutput, ModifyVpcTenancyOutputError>) -> Void)
    ...
    func modifyVpnConnection(input: ModifyVpnConnectionInput, completion: @escaping (SdkResult<ModifyVpnConnectionOutput, ModifyVpnConnectionOutputError>) -> Void)
    ...
    func modifyVpnConnectionOptions(input: ModifyVpnConnectionOptionsInput, completion: @escaping (SdkResult<ModifyVpnConnectionOptionsOutput, ModifyVpnConnectionOptionsOutputError>) -> Void)
    /// <p>Modifies the VPN tunnel endpoint certificate.</p>
    func modifyVpnTunnelCertificate(input: ModifyVpnTunnelCertificateInput, completion: @escaping (SdkResult<ModifyVpnTunnelCertificateOutput, ModifyVpnTunnelCertificateOutputError>) -> Void)
    ...
    func modifyVpnTunnelOptions(input: ModifyVpnTunnelOptionsInput, completion: @escaping (SdkResult<ModifyVpnTunnelOptionsOutput, ModifyVpnTunnelOptionsOutputError>) -> Void)
    ...
    func monitorInstances(input: MonitorInstancesInput, completion: @escaping (SdkResult<MonitorInstancesOutput, MonitorInstancesOutputError>) -> Void)
    ...
    func moveAddressToVpc(input: MoveAddressToVpcInput, completion: @escaping (SdkResult<MoveAddressToVpcOutput, MoveAddressToVpcOutputError>) -> Void)
    ...
    func provisionByoipCidr(input: ProvisionByoipCidrInput, completion: @escaping (SdkResult<ProvisionByoipCidrOutput, ProvisionByoipCidrOutputError>) -> Void)
    ...
    ///             account.</p>
    func purchaseHostReservation(input: PurchaseHostReservationInput, completion: @escaping (SdkResult<PurchaseHostReservationOutput, PurchaseHostReservationOutputError>) -> Void)
    ...
    ///    	   <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-market-general.html">Reserved Instance Marketplace</a>
    ///    	   in the <i>Amazon EC2 User Guide</i>.</p>
    func purchaseReservedInstancesOffering(input: PurchaseReservedInstancesOfferingInput, completion: @escaping (SdkResult<PurchaseReservedInstancesOfferingOutput, PurchaseReservedInstancesOfferingOutputError>) -> Void)
    ...
    func purchaseScheduledInstances(input: PurchaseScheduledInstancesInput, completion: @escaping (SdkResult<PurchaseScheduledInstancesOutput, PurchaseScheduledInstancesOutputError>) -> Void)
    ...
    func rebootInstances(input: RebootInstancesInput, completion: @escaping (SdkResult<RebootInstancesOutput, RebootInstancesOutputError>) -> Void)
    ...
    func registerImage(input: RegisterImageInput, completion: @escaping (SdkResult<RegisterImageOutput, RegisterImageOutputError>) -> Void)
    /// <p>Registers a set of tag keys to include in scheduled event notifications for your resources.
    ///    		</p>
    ///          <p>To remove tags, use .</p>
    func registerInstanceEventNotificationAttributes(input: RegisterInstanceEventNotificationAttributesInput, completion: @escaping (SdkResult<RegisterInstanceEventNotificationAttributesOutput, RegisterInstanceEventNotificationAttributesOutputError>) -> Void)
    ...
    func registerTransitGatewayMulticastGroupMembers(input: RegisterTransitGatewayMulticastGroupMembersInput, completion: @escaping (SdkResult<RegisterTransitGatewayMulticastGroupMembersOutput, RegisterTransitGatewayMulticastGroupMembersOutputError>) -> Void)
    ...
    ///             group.</p>
    func registerTransitGatewayMulticastGroupSources(input: RegisterTransitGatewayMulticastGroupSourcesInput, completion: @escaping (SdkResult<RegisterTransitGatewayMulticastGroupSourcesOutput, RegisterTransitGatewayMulticastGroupSourcesOutputError>) -> Void)
    /// <p>Rejects a request to associate cross-account subnets with a transit gateway multicast domain.</p>
    func rejectTransitGatewayMulticastDomainAssociations(input: RejectTransitGatewayMulticastDomainAssociationsInput, completion: @escaping (SdkResult<RejectTransitGatewayMulticastDomainAssociationsOutput, RejectTransitGatewayMulticastDomainAssociationsOutputError>) -> Void)
    /// <p>Rejects a transit gateway peering attachment request.</p>
    func rejectTransitGatewayPeeringAttachment(input: RejectTransitGatewayPeeringAttachmentInput, completion: @escaping (SdkResult<RejectTransitGatewayPeeringAttachmentOutput, RejectTransitGatewayPeeringAttachmentOutputError>) -> Void)
    ...
    func rejectTransitGatewayVpcAttachment(input: RejectTransitGatewayVpcAttachmentInput, completion: @escaping (SdkResult<RejectTransitGatewayVpcAttachmentOutput, RejectTransitGatewayVpcAttachmentOutputError>) -> Void)
    /// <p>Rejects one or more VPC endpoint connection requests to your VPC endpoint
    ///             service.</p>
    func rejectVpcEndpointConnections(input: RejectVpcEndpointConnectionsInput, completion: @escaping (SdkResult<RejectVpcEndpointConnectionsOutput, RejectVpcEndpointConnectionsOutputError>) -> Void)
    ...
    func rejectVpcPeeringConnection(input: RejectVpcPeeringConnectionInput, completion: @escaping (SdkResult<RejectVpcPeeringConnectionOutput, RejectVpcPeeringConnectionOutputError>) -> Void)
    ...
    func releaseAddress(input: ReleaseAddressInput, completion: @escaping (SdkResult<ReleaseAddressOutput, ReleaseAddressOutputError>) -> Void)
    ...
    func releaseHosts(input: ReleaseHostsInput, completion: @escaping (SdkResult<ReleaseHostsOutput, ReleaseHostsOutputError>) -> Void)
    ...
    ///         <p>Use <a>DescribeIamInstanceProfileAssociations</a> to get the association
    ///             ID.</p>
    func replaceIamInstanceProfileAssociation(input: ReplaceIamInstanceProfileAssociationInput, completion: @escaping (SdkResult<ReplaceIamInstanceProfileAssociationOutput, ReplaceIamInstanceProfileAssociationOutputError>) -> Void)
    ...
    func replaceNetworkAclAssociation(input: ReplaceNetworkAclAssociationInput, completion: @escaping (SdkResult<ReplaceNetworkAclAssociationOutput, ReplaceNetworkAclAssociationOutputError>) -> Void)
    ...
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func replaceNetworkAclEntry(input: ReplaceNetworkAclEntryInput, completion: @escaping (SdkResult<ReplaceNetworkAclEntryOutput, ReplaceNetworkAclEntryOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html">Route Tables</a> in the
    ///                 <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func replaceRoute(input: ReplaceRouteInput, completion: @escaping (SdkResult<ReplaceRouteOutput, ReplaceRouteOutputError>) -> Void)
    ...
    func replaceRouteTableAssociation(input: ReplaceRouteTableAssociationInput, completion: @escaping (SdkResult<ReplaceRouteTableAssociationOutput, ReplaceRouteTableAssociationOutputError>) -> Void)
    /// <p>Replaces the specified route in the specified transit gateway route table.</p>
    func replaceTransitGatewayRoute(input: ReplaceTransitGatewayRouteInput, completion: @escaping (SdkResult<ReplaceTransitGatewayRouteOutput, ReplaceTransitGatewayRouteOutputError>) -> Void)
    ...
    func reportInstanceStatus(input: ReportInstanceStatusInput, completion: @escaping (SdkResult<ReportInstanceStatusOutput, ReportInstanceStatusOutputError>) -> Void)
    ...
    ///        in the <i>Amazon EC2 User Guide for Linux Instances</i>.</p>
    func requestSpotFleet(input: RequestSpotFleetInput, completion: @escaping (SdkResult<RequestSpotFleetOutput, RequestSpotFleetOutputError>) -> Void)
    ...
    func requestSpotInstances(input: RequestSpotInstancesInput, completion: @escaping (SdkResult<RequestSpotInstancesOutput, RequestSpotInstancesOutputError>) -> Void)
    ...
    func resetAddressAttribute(input: ResetAddressAttributeInput, completion: @escaping (SdkResult<ResetAddressAttributeOutput, ResetAddressAttributeOutputError>) -> Void)
    ...
    ///       in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func resetEbsDefaultKmsKeyId(input: ResetEbsDefaultKmsKeyIdInput, completion: @escaping (SdkResult<ResetEbsDefaultKmsKeyIdOutput, ResetEbsDefaultKmsKeyIdOutputError>) -> Void)
    ...
    func resetFpgaImageAttribute(input: ResetFpgaImageAttributeInput, completion: @escaping (SdkResult<ResetFpgaImageAttributeOutput, ResetFpgaImageAttributeOutputError>) -> Void)
    /// <p>Resets an attribute of an AMI to its default value.</p>
    ///          <note>
    ///             <p>The productCodes attribute can't be reset.</p>
    ///          </note>
    func resetImageAttribute(input: ResetImageAttributeInput, completion: @escaping (SdkResult<ResetImageAttributeOutput, ResetImageAttributeOutputError>) -> Void)
    ...
    func resetInstanceAttribute(input: ResetInstanceAttributeInput, completion: @escaping (SdkResult<ResetInstanceAttributeOutput, ResetInstanceAttributeOutputError>) -> Void)
    /// <p>Resets a network interface attribute. You can specify only one attribute at a time.</p>
    func resetNetworkInterfaceAttribute(input: ResetNetworkInterfaceAttributeInput, completion: @escaping (SdkResult<ResetNetworkInterfaceAttributeOutput, ResetNetworkInterfaceAttributeOutputError>) -> Void)
    /// <p>Resets permission settings for the specified snapshot.</p>
    ///          <p>For more information about modifying snapshot permissions, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-modifying-snapshot-permissions.html">Sharing snapshots</a> in the
    ///         <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func resetSnapshotAttribute(input: ResetSnapshotAttributeInput, completion: @escaping (SdkResult<ResetSnapshotAttributeOutput, ResetSnapshotAttributeOutputError>) -> Void)
    ...
    func restoreAddressToClassic(input: RestoreAddressToClassicInput, completion: @escaping (SdkResult<RestoreAddressToClassicOutput, RestoreAddressToClassicOutputError>) -> Void)
    /// <p>Restores the entries from a previous version of a managed prefix list to a new version of the prefix list.</p>
    func restoreManagedPrefixListVersion(input: RestoreManagedPrefixListVersionInput, completion: @escaping (SdkResult<RestoreManagedPrefixListVersionOutput, RestoreManagedPrefixListVersionOutputError>) -> Void)
    /// <p>Removes an ingress authorization rule from a Client VPN endpoint. </p>
    func revokeClientVpnIngress(input: RevokeClientVpnIngressInput, completion: @escaping (SdkResult<RevokeClientVpnIngressOutput, RevokeClientVpnIngressOutputError>) -> Void)
    ...
    func revokeSecurityGroupEgress(input: RevokeSecurityGroupEgressInput, completion: @escaping (SdkResult<RevokeSecurityGroupEgressOutput, RevokeSecurityGroupEgressOutputError>) -> Void)
    ...
    ///          <p>Rule changes are propagated to instances within the security group as quickly as possible. However, a small delay might occur.</p>
    func revokeSecurityGroupIngress(input: RevokeSecurityGroupIngressInput, completion: @escaping (SdkResult<RevokeSecurityGroupIngressOutput, RevokeSecurityGroupIngressOutputError>) -> Void)
    ...
    func runInstances(input: RunInstancesInput, completion: @escaping (SdkResult<RunInstancesOutput, RunInstancesOutputError>) -> Void)
    ...
    ///          in the <i>Amazon EC2 User Guide</i>.</p>
    func runScheduledInstances(input: RunScheduledInstancesInput, completion: @escaping (SdkResult<RunScheduledInstancesOutput, RunScheduledInstancesOutputError>) -> Void)
    /// <p>Searches for routes in the specified local gateway route table.</p>
    func searchLocalGatewayRoutes(input: SearchLocalGatewayRoutesInput, completion: @escaping (SdkResult<SearchLocalGatewayRoutesOutput, SearchLocalGatewayRoutesOutputError>) -> Void)
    /// <p>Searches one or more  transit gateway multicast groups and returns the group membership information.</p>
    func searchTransitGatewayMulticastGroups(input: SearchTransitGatewayMulticastGroupsInput, completion: @escaping (SdkResult<SearchTransitGatewayMulticastGroupsOutput, SearchTransitGatewayMulticastGroupsOutputError>) -> Void)
    /// <p>Searches for routes in the specified transit gateway route table.</p>
    func searchTransitGatewayRoutes(input: SearchTransitGatewayRoutesInput, completion: @escaping (SdkResult<SearchTransitGatewayRoutesOutput, SearchTransitGatewayRoutesOutputError>) -> Void)
    ...
    func sendDiagnosticInterrupt(input: SendDiagnosticInterruptInput, completion: @escaping (SdkResult<SendDiagnosticInterruptOutput, SendDiagnosticInterruptOutputError>) -> Void)
    ...
    ///                 <i>Amazon EC2 User Guide</i>.</p>
    func startInstances(input: StartInstancesInput, completion: @escaping (SdkResult<StartInstancesOutput, StartInstancesOutputError>) -> Void)
    /// <p>Starts analyzing the specified path. If the path is reachable, the
    ///          operation returns the shortest feasible path.</p>
    func startNetworkInsightsAnalysis(input: StartNetworkInsightsAnalysisInput, completion: @escaping (SdkResult<StartNetworkInsightsAnalysisOutput, StartNetworkInsightsAnalysisOutputError>) -> Void)
    ...
    func startVpcEndpointServicePrivateDnsVerification(input: StartVpcEndpointServicePrivateDnsVerificationInput, completion: @escaping (SdkResult<StartVpcEndpointServicePrivateDnsVerificationOutput, StartVpcEndpointServicePrivateDnsVerificationOutputError>) -> Void)
    ...
    func stopInstances(input: StopInstancesInput, completion: @escaping (SdkResult<StopInstancesOutput, StopInstancesOutputError>) -> Void)
    ...
    func terminateClientVpnConnections(input: TerminateClientVpnConnectionsInput, completion: @escaping (SdkResult<TerminateClientVpnConnectionsOutput, TerminateClientVpnConnectionsOutputError>) -> Void)
    ...
    func terminateInstances(input: TerminateInstancesInput, completion: @escaping (SdkResult<TerminateInstancesOutput, TerminateInstancesOutputError>) -> Void)
    /// <p>Unassigns one or more IPv6 addresses from a network interface.</p>
    func unassignIpv6Addresses(input: UnassignIpv6AddressesInput, completion: @escaping (SdkResult<UnassignIpv6AddressesOutput, UnassignIpv6AddressesOutputError>) -> Void)
    /// <p>Unassigns one or more secondary private IP addresses from a network interface.</p>
    func unassignPrivateIpAddresses(input: UnassignPrivateIpAddressesInput, completion: @escaping (SdkResult<UnassignPrivateIpAddressesOutput, UnassignPrivateIpAddressesOutputError>) -> Void)
    ...
    func unmonitorInstances(input: UnmonitorInstancesInput, completion: @escaping (SdkResult<UnmonitorInstancesOutput, UnmonitorInstancesOutputError>) -> Void)
    ...
    /// 			request.</p>
    func updateSecurityGroupRuleDescriptionsEgress(input: UpdateSecurityGroupRuleDescriptionsEgressInput, completion: @escaping (SdkResult<UpdateSecurityGroupRuleDescriptionsEgressOutput, UpdateSecurityGroupRuleDescriptionsEgressOutputError>) -> Void)
    ...
    /// 			description for a security group rule by omitting the description parameter in the
    /// 			request.</p>
    func updateSecurityGroupRuleDescriptionsIngress(input: UpdateSecurityGroupRuleDescriptionsIngressInput, completion: @escaping (SdkResult<UpdateSecurityGroupRuleDescriptionsIngressOutput, UpdateSecurityGroupRuleDescriptionsIngressOutputError>) -> Void)
    ...
    ///           because of BGP propagation delays.</p>
    func withdrawByoipCidr(input: WithdrawByoipCidrInput, completion: @escaping (SdkResult<WithdrawByoipCidrOutput, WithdrawByoipCidrOutputError>) -> Void)
}
