...
public protocol Ec2ClientProtocol {
    ...
    func acceptReservedInstancesExchangeQuote(input: AcceptReservedInstancesExchangeQuoteInput, completion: @escaping (SdkResult<AcceptReservedInstancesExchangeQuoteOutputResponse, AcceptReservedInstancesExchangeQuoteOutputError>) -> Void)
    /// <p>Accepts a request to associate subnets with a transit gateway multicast domain.</p>
    func acceptTransitGatewayMulticastDomainAssociations(input: AcceptTransitGatewayMulticastDomainAssociationsInput, completion: @escaping (SdkResult<AcceptTransitGatewayMulticastDomainAssociationsOutputResponse, AcceptTransitGatewayMulticastDomainAssociationsOutputError>) -> Void)
    ...
    func acceptTransitGatewayPeeringAttachment(input: AcceptTransitGatewayPeeringAttachmentInput, completion: @escaping (SdkResult<AcceptTransitGatewayPeeringAttachmentOutputResponse, AcceptTransitGatewayPeeringAttachmentOutputError>) -> Void)
    ...
    func acceptTransitGatewayVpcAttachment(input: AcceptTransitGatewayVpcAttachmentInput, completion: @escaping (SdkResult<AcceptTransitGatewayVpcAttachmentOutputResponse, AcceptTransitGatewayVpcAttachmentOutputError>) -> Void)
    /// <p>Accepts one or more interface VPC endpoint connection requests to your VPC endpoint
    ///             service.</p>
    func acceptVpcEndpointConnections(input: AcceptVpcEndpointConnectionsInput, completion: @escaping (SdkResult<AcceptVpcEndpointConnectionsOutputResponse, AcceptVpcEndpointConnectionsOutputError>) -> Void)
    ...
    func acceptVpcPeeringConnection(input: AcceptVpcPeeringConnectionInput, completion: @escaping (SdkResult<AcceptVpcPeeringConnectionOutputResponse, AcceptVpcPeeringConnectionOutputError>) -> Void)
    ...
    func allocateAddress(input: AllocateAddressInput, completion: @escaping (SdkResult<AllocateAddressOutputResponse, AllocateAddressOutputError>) -> Void)
    ...
    ///         	hosts to allocate.</p>
    func allocateHosts(input: AllocateHostsInput, completion: @escaping (SdkResult<AllocateHostsOutputResponse, AllocateHostsOutputError>) -> Void)
    ...
    func applySecurityGroupsToClientVpnTargetNetwork(input: ApplySecurityGroupsToClientVpnTargetNetworkInput, completion: @escaping (SdkResult<ApplySecurityGroupsToClientVpnTargetNetworkOutputResponse, ApplySecurityGroupsToClientVpnTargetNetworkOutputError>) -> Void)
    ...
    func assignIpv6Addresses(input: AssignIpv6AddressesInput, completion: @escaping (SdkResult<AssignIpv6AddressesOutputResponse, AssignIpv6AddressesOutputError>) -> Void)
    ...
    func assignPrivateIpAddresses(input: AssignPrivateIpAddressesInput, completion: @escaping (SdkResult<AssignPrivateIpAddressesOutputResponse, AssignPrivateIpAddressesOutputError>) -> Void)
    ...
    ///           Pricing</a>.</p>
    ///          </important>
    func associateAddress(input: AssociateAddressInput, completion: @escaping (SdkResult<AssociateAddressOutputResponse, AssociateAddressOutputError>) -> Void)
    ...
    func associateClientVpnTargetNetwork(input: AssociateClientVpnTargetNetworkInput, completion: @escaping (SdkResult<AssociateClientVpnTargetNetworkOutputResponse, AssociateClientVpnTargetNetworkOutputError>) -> Void)
    ...
    func associateDhcpOptions(input: AssociateDhcpOptionsInput, completion: @escaping (SdkResult<AssociateDhcpOptionsOutputResponse, AssociateDhcpOptionsOutputError>) -> Void)
    ...
    func associateEnclaveCertificateIamRole(input: AssociateEnclaveCertificateIamRoleInput, completion: @escaping (SdkResult<AssociateEnclaveCertificateIamRoleOutputResponse, AssociateEnclaveCertificateIamRoleOutputError>) -> Void)
    ...
    func associateIamInstanceProfile(input: AssociateIamInstanceProfileInput, completion: @escaping (SdkResult<AssociateIamInstanceProfileOutputResponse, AssociateIamInstanceProfileOutputError>) -> Void)
    ...
    func associateRouteTable(input: AssociateRouteTableInput, completion: @escaping (SdkResult<AssociateRouteTableOutputResponse, AssociateRouteTableOutputError>) -> Void)
    ...
    func associateSubnetCidrBlock(input: AssociateSubnetCidrBlockInput, completion: @escaping (SdkResult<AssociateSubnetCidrBlockOutputResponse, AssociateSubnetCidrBlockOutputError>) -> Void)
    ...
    func associateTransitGatewayMulticastDomain(input: AssociateTransitGatewayMulticastDomainInput, completion: @escaping (SdkResult<AssociateTransitGatewayMulticastDomainOutputResponse, AssociateTransitGatewayMulticastDomainOutputError>) -> Void)
    ...
    func associateTransitGatewayRouteTable(input: AssociateTransitGatewayRouteTableInput, completion: @escaping (SdkResult<AssociateTransitGatewayRouteTableOutputResponse, AssociateTransitGatewayRouteTableOutputError>) -> Void)
    ...
    ///                 <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func associateVpcCidrBlock(input: AssociateVpcCidrBlockInput, completion: @escaping (SdkResult<AssociateVpcCidrBlockOutputResponse, AssociateVpcCidrBlockOutputError>) -> Void)
    ...
    func attachClassicLinkVpc(input: AttachClassicLinkVpcInput, completion: @escaping (SdkResult<AttachClassicLinkVpcOutputResponse, AttachClassicLinkVpcOutputError>) -> Void)
    ...
    func attachInternetGateway(input: AttachInternetGatewayInput, completion: @escaping (SdkResult<AttachInternetGatewayOutputResponse, AttachInternetGatewayOutputError>) -> Void)
    /// <p>Attaches a network interface to an instance.</p>
    func attachNetworkInterface(input: AttachNetworkInterfaceInput, completion: @escaping (SdkResult<AttachNetworkInterfaceOutputResponse, AttachNetworkInterfaceOutputError>) -> Void)
    ...
    func attachVpnGateway(input: AttachVpnGatewayInput, completion: @escaping (SdkResult<AttachVpnGatewayOutputResponse, AttachVpnGatewayOutputError>) -> Void)
    ...
    func authorizeClientVpnIngress(input: AuthorizeClientVpnIngressInput, completion: @escaping (SdkResult<AuthorizeClientVpnIngressOutputResponse, AuthorizeClientVpnIngressOutputError>) -> Void)
    ...
    func authorizeSecurityGroupEgress(input: AuthorizeSecurityGroupEgressInput, completion: @escaping (SdkResult<AuthorizeSecurityGroupEgressOutputResponse, AuthorizeSecurityGroupEgressOutputError>) -> Void)
    ...
    ///          <p>For more information about VPC security group limits, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/amazon-vpc-limits.html">Amazon VPC Limits</a>.</p>
    func authorizeSecurityGroupIngress(input: AuthorizeSecurityGroupIngressInput, completion: @escaping (SdkResult<AuthorizeSecurityGroupIngressOutputResponse, AuthorizeSecurityGroupIngressOutputError>) -> Void)
    ...
    /// 			      </note>
    func bundleInstance(input: BundleInstanceInput, completion: @escaping (SdkResult<BundleInstanceOutputResponse, BundleInstanceOutputError>) -> Void)
    /// <p>Cancels a bundling operation for an instance store-backed Windows instance.</p>
    func cancelBundleTask(input: CancelBundleTaskInput, completion: @escaping (SdkResult<CancelBundleTaskOutputResponse, CancelBundleTaskOutputError>) -> Void)
    ...
    func cancelCapacityReservation(input: CancelCapacityReservationInput, completion: @escaping (SdkResult<CancelCapacityReservationOutputResponse, CancelCapacityReservationOutputError>) -> Void)
    ...
    ///     EC2 CLI</a>.</p>
    func cancelConversionTask(input: CancelConversionTaskInput, completion: @escaping (SdkResult<CancelConversionTaskOutputResponse, CancelConversionTaskOutputError>) -> Void)
    ...
    func cancelImportTask(input: CancelImportTaskInput, completion: @escaping (SdkResult<CancelImportTaskOutputResponse, CancelImportTaskOutputError>) -> Void)
    ...
    func cancelReservedInstancesListing(input: CancelReservedInstancesListingInput, completion: @escaping (SdkResult<CancelReservedInstancesListingOutputResponse, CancelReservedInstancesListingOutputError>) -> Void)
    ...
    func cancelSpotFleetRequests(input: CancelSpotFleetRequestsInput, completion: @escaping (SdkResult<CancelSpotFleetRequestsOutputResponse, CancelSpotFleetRequestsOutputError>) -> Void)
    ...
    ///          </important>
    func cancelSpotInstanceRequests(input: CancelSpotInstanceRequestsInput, completion: @escaping (SdkResult<CancelSpotInstanceRequestsOutputResponse, CancelSpotInstanceRequestsOutputError>) -> Void)
    ...
    func confirmProductInstance(input: ConfirmProductInstanceInput, completion: @escaping (SdkResult<ConfirmProductInstanceOutputResponse, ConfirmProductInstanceOutputError>) -> Void)
    /// <p>Copies the specified Amazon FPGA Image (AFI) to the current Region.</p>
    func copyFpgaImage(input: CopyFpgaImageInput, completion: @escaping (SdkResult<CopyFpgaImageOutputResponse, CopyFpgaImageOutputError>) -> Void)
    ...
    func createCapacityReservation(input: CreateCapacityReservationInput, completion: @escaping (SdkResult<CreateCapacityReservationOutputResponse, CreateCapacityReservationOutputError>) -> Void)
    ...
    ///                 Guide</i>.</p>
    func createCarrierGateway(input: CreateCarrierGatewayInput, completion: @escaping (SdkResult<CreateCarrierGatewayOutputResponse, CreateCarrierGatewayOutputError>) -> Void)
    ...
    /// 			are terminated.</p>
    func createClientVpnEndpoint(input: CreateClientVpnEndpointInput, completion: @escaping (SdkResult<CreateClientVpnEndpointOutputResponse, CreateClientVpnEndpointOutputError>) -> Void)
    ...
    func createClientVpnRoute(input: CreateClientVpnRouteInput, completion: @escaping (SdkResult<CreateClientVpnRouteOutputResponse, CreateClientVpnRouteOutputError>) -> Void)
    ...
    ///                 customer gateways.</p>
    ///         </important>
    func createCustomerGateway(input: CreateCustomerGatewayInput, completion: @escaping (SdkResult<CreateCustomerGatewayOutputResponse, CreateCustomerGatewayOutputError>) -> Void)
    ...
    func createDefaultSubnet(input: CreateDefaultSubnetInput, completion: @escaping (SdkResult<CreateDefaultSubnetOutputResponse, CreateDefaultSubnetOutputError>) -> Void)
    ...
    /// 			FAQ</a>.</p>
    func createDefaultVpc(input: CreateDefaultVpcInput, completion: @escaping (SdkResult<CreateDefaultVpcOutputResponse, CreateDefaultVpcOutputError>) -> Void)
    ...
    /// 			<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createDhcpOptions(input: CreateDhcpOptionsInput, completion: @escaping (SdkResult<CreateDhcpOptionsOutputResponse, CreateDhcpOptionsOutputError>) -> Void)
    ...
    func createEgressOnlyInternetGateway(input: CreateEgressOnlyInternetGatewayInput, completion: @escaping (SdkResult<CreateEgressOnlyInternetGatewayOutputResponse, CreateEgressOnlyInternetGatewayOutputError>) -> Void)
    ...
    func createFlowLogs(input: CreateFlowLogsInput, completion: @escaping (SdkResult<CreateFlowLogsOutputResponse, CreateFlowLogsOutputError>) -> Void)
    ...
    func createFpgaImage(input: CreateFpgaImageInput, completion: @escaping (SdkResult<CreateFpgaImageOutputResponse, CreateFpgaImageOutputError>) -> Void)
    ...
    func createInstanceExportTask(input: CreateInstanceExportTaskInput, completion: @escaping (SdkResult<CreateInstanceExportTaskOutputResponse, CreateInstanceExportTaskOutputError>) -> Void)
    ...
    func createInternetGateway(input: CreateInternetGatewayInput, completion: @escaping (SdkResult<CreateInternetGatewayOutputResponse, CreateInternetGatewayOutputError>) -> Void)
    ...
    func createLaunchTemplate(input: CreateLaunchTemplateInput, completion: @escaping (SdkResult<CreateLaunchTemplateOutputResponse, CreateLaunchTemplateOutputError>) -> Void)
    ...
    func createLaunchTemplateVersion(input: CreateLaunchTemplateVersionInput, completion: @escaping (SdkResult<CreateLaunchTemplateVersionOutputResponse, CreateLaunchTemplateVersionOutputError>) -> Void)
    /// <p>Creates a static route for the specified local gateway route table.</p>
    func createLocalGatewayRoute(input: CreateLocalGatewayRouteInput, completion: @escaping (SdkResult<CreateLocalGatewayRouteOutputResponse, CreateLocalGatewayRouteOutputError>) -> Void)
    /// <p>Associates the specified VPC with the specified local gateway route table.</p>
    func createLocalGatewayRouteTableVpcAssociation(input: CreateLocalGatewayRouteTableVpcAssociationInput, completion: @escaping (SdkResult<CreateLocalGatewayRouteTableVpcAssociationOutputResponse, CreateLocalGatewayRouteTableVpcAssociationOutputError>) -> Void)
    ...
    func createManagedPrefixList(input: CreateManagedPrefixListInput, completion: @escaping (SdkResult<CreateManagedPrefixListOutputResponse, CreateManagedPrefixListOutputError>) -> Void)
    ...
    ///                 <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createNatGateway(input: CreateNatGatewayInput, completion: @escaping (SdkResult<CreateNatGatewayOutputResponse, CreateNatGatewayOutputError>) -> Void)
    ...
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createNetworkAcl(input: CreateNetworkAclInput, completion: @escaping (SdkResult<CreateNetworkAclOutputResponse, CreateNetworkAclOutputError>) -> Void)
    ...
    func createNetworkAclEntry(input: CreateNetworkAclEntryInput, completion: @escaping (SdkResult<CreateNetworkAclEntryOutputResponse, CreateNetworkAclEntryOutputError>) -> Void)
    ...
    func createNetworkInsightsPath(input: CreateNetworkInsightsPathInput, completion: @escaping (SdkResult<CreateNetworkInsightsPathOutputResponse, CreateNetworkInsightsPathOutputError>) -> Void)
    ...
    ///             in the <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createNetworkInterface(input: CreateNetworkInterfaceInput, completion: @escaping (SdkResult<CreateNetworkInterfaceOutputResponse, CreateNetworkInterfaceOutputError>) -> Void)
    ...
    func createNetworkInterfacePermission(input: CreateNetworkInterfacePermissionInput, completion: @escaping (SdkResult<CreateNetworkInterfacePermissionOutputResponse, CreateNetworkInterfacePermissionOutputError>) -> Void)
    ...
    func createPlacementGroup(input: CreatePlacementGroupInput, completion: @escaping (SdkResult<CreatePlacementGroupOutputResponse, CreatePlacementGroupOutputError>) -> Void)
    ...
    ///       in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func createReplaceRootVolumeTask(input: CreateReplaceRootVolumeTaskInput, completion: @escaping (SdkResult<CreateReplaceRootVolumeTaskOutputResponse, CreateReplaceRootVolumeTaskOutputError>) -> Void)
    ...
    /// 				<i>Amazon EC2 User Guide</i>.</p>
    func createReservedInstancesListing(input: CreateReservedInstancesListingInput, completion: @escaping (SdkResult<CreateReservedInstancesListingOutputResponse, CreateReservedInstancesListingOutputError>) -> Void)
    ...
    func createRestoreImageTask(input: CreateRestoreImageTaskInput, completion: @escaping (SdkResult<CreateRestoreImageTaskOutputResponse, CreateRestoreImageTaskOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html">Route Tables</a> in the
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createRouteTable(input: CreateRouteTableInput, completion: @escaping (SdkResult<CreateRouteTableOutputResponse, CreateRouteTableOutputError>) -> Void)
    ...
    ///          <p>For more information about VPC security group limits, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/amazon-vpc-limits.html">Amazon VPC Limits</a>.</p>
    func createSecurityGroup(input: CreateSecurityGroupInput, completion: @escaping (SdkResult<CreateSecurityGroupOutputResponse, CreateSecurityGroupOutputError>) -> Void)
    ...
    ///   	Outpost.</p>
    func createSnapshots(input: CreateSnapshotsInput, completion: @escaping (SdkResult<CreateSnapshotsOutputResponse, CreateSnapshotsOutputError>) -> Void)
    ...
    func createSpotDatafeedSubscription(input: CreateSpotDatafeedSubscriptionInput, completion: @escaping (SdkResult<CreateSpotDatafeedSubscriptionOutputResponse, CreateSpotDatafeedSubscriptionOutputError>) -> Void)
    /// <p>Stores an AMI as a single object in an S3 bucket.</p>
    ///          <p>To use this API, you must have the required permissions. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-store-restore.html#ami-s3-permissions">Permissions for storing and restoring AMIs using S3</a> in the
    ///         <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-store-restore.html">Store and restore an AMI using
    ///         S3</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func createStoreImageTask(input: CreateStoreImageTaskInput, completion: @escaping (SdkResult<CreateStoreImageTaskOutputResponse, CreateStoreImageTaskOutputError>) -> Void)
    ...
    ///                 <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createSubnet(input: CreateSubnetInput, completion: @escaping (SdkResult<CreateSubnetOutputResponse, CreateSubnetOutputError>) -> Void)
    ...
    func createTrafficMirrorFilter(input: CreateTrafficMirrorFilterInput, completion: @escaping (SdkResult<CreateTrafficMirrorFilterOutputResponse, CreateTrafficMirrorFilterOutputError>) -> Void)
    ...
    func createTrafficMirrorFilterRule(input: CreateTrafficMirrorFilterRuleInput, completion: @escaping (SdkResult<CreateTrafficMirrorFilterRuleOutputResponse, CreateTrafficMirrorFilterRuleOutputError>) -> Void)
    ...
    func createTrafficMirrorSession(input: CreateTrafficMirrorSessionInput, completion: @escaping (SdkResult<CreateTrafficMirrorSessionOutputResponse, CreateTrafficMirrorSessionOutputError>) -> Void)
    ...
    func createTrafficMirrorTarget(input: CreateTrafficMirrorTargetInput, completion: @escaping (SdkResult<CreateTrafficMirrorTargetOutputResponse, CreateTrafficMirrorTargetOutputError>) -> Void)
    ...
    func createTransitGateway(input: CreateTransitGatewayInput, completion: @escaping (SdkResult<CreateTransitGatewayOutputResponse, CreateTransitGatewayOutputError>) -> Void)
    ...
    func createTransitGatewayConnect(input: CreateTransitGatewayConnectInput, completion: @escaping (SdkResult<CreateTransitGatewayConnectOutputResponse, CreateTransitGatewayConnectOutputError>) -> Void)
    ...
    func createTransitGatewayConnectPeer(input: CreateTransitGatewayConnectPeerInput, completion: @escaping (SdkResult<CreateTransitGatewayConnectPeerOutputResponse, CreateTransitGatewayConnectPeerOutputError>) -> Void)
    ...
    func createTransitGatewayMulticastDomain(input: CreateTransitGatewayMulticastDomainInput, completion: @escaping (SdkResult<CreateTransitGatewayMulticastDomainOutputResponse, CreateTransitGatewayMulticastDomainOutputError>) -> Void)
    ...
    func createTransitGatewayPeeringAttachment(input: CreateTransitGatewayPeeringAttachmentInput, completion: @escaping (SdkResult<CreateTransitGatewayPeeringAttachmentOutputResponse, CreateTransitGatewayPeeringAttachmentOutputError>) -> Void)
    /// <p>Creates a reference (route) to a prefix list in a specified transit gateway route table.</p>
    func createTransitGatewayPrefixListReference(input: CreateTransitGatewayPrefixListReferenceInput, completion: @escaping (SdkResult<CreateTransitGatewayPrefixListReferenceOutputResponse, CreateTransitGatewayPrefixListReferenceOutputError>) -> Void)
    /// <p>Creates a static route for the specified transit gateway route table.</p>
    func createTransitGatewayRoute(input: CreateTransitGatewayRouteInput, completion: @escaping (SdkResult<CreateTransitGatewayRouteOutputResponse, CreateTransitGatewayRouteOutputError>) -> Void)
    /// <p>Creates a route table for the specified transit gateway.</p>
    func createTransitGatewayRouteTable(input: CreateTransitGatewayRouteTableInput, completion: @escaping (SdkResult<CreateTransitGatewayRouteTableOutputResponse, CreateTransitGatewayRouteTableOutputError>) -> Void)
    ...
    func createTransitGatewayVpcAttachment(input: CreateTransitGatewayVpcAttachmentInput, completion: @escaping (SdkResult<CreateTransitGatewayVpcAttachmentOutputResponse, CreateTransitGatewayVpcAttachmentOutputError>) -> Void)
    ...
    ///         <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func createVolume(input: CreateVolumeInput, completion: @escaping (SdkResult<CreateVolumeOutputResponse, CreateVolumeOutputError>) -> Void)
    ...
    ///           <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func createVpc(input: CreateVpcInput, completion: @escaping (SdkResult<CreateVpcOutputResponse, CreateVpcOutputError>) -> Void)
    ...
    ///             services.</p>
    func createVpcEndpoint(input: CreateVpcEndpointInput, completion: @escaping (SdkResult<CreateVpcEndpointOutputResponse, CreateVpcEndpointOutputError>) -> Void)
    ...
    func createVpcEndpointConnectionNotification(input: CreateVpcEndpointConnectionNotificationInput, completion: @escaping (SdkResult<CreateVpcEndpointConnectionNotificationOutputResponse, CreateVpcEndpointConnectionNotificationOutputError>) -> Void)
    ...
    ///             <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func createVpcEndpointServiceConfiguration(input: CreateVpcEndpointServiceConfigurationInput, completion: @escaping (SdkResult<CreateVpcEndpointServiceConfigurationOutputResponse, CreateVpcEndpointServiceConfigurationOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN
    ///                 User Guide</i>.</p>
    func createVpnConnection(input: CreateVpnConnectionInput, completion: @escaping (SdkResult<CreateVpnConnectionOutputResponse, CreateVpnConnectionOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN User Guide</i>.</p>
    func createVpnConnectionRoute(input: CreateVpnConnectionRouteInput, completion: @escaping (SdkResult<CreateVpnConnectionRouteOutputResponse, CreateVpnConnectionRouteOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN User Guide</i>.</p>
    func createVpnGateway(input: CreateVpnGatewayInput, completion: @escaping (SdkResult<CreateVpnGatewayOutputResponse, CreateVpnGatewayOutputError>) -> Void)
    ...
    ///         </important>
    func deleteCarrierGateway(input: DeleteCarrierGatewayInput, completion: @escaping (SdkResult<DeleteCarrierGatewayOutputResponse, DeleteCarrierGatewayOutputError>) -> Void)
    ...
    func deleteClientVpnEndpoint(input: DeleteClientVpnEndpointInput, completion: @escaping (SdkResult<DeleteClientVpnEndpointOutputResponse, DeleteClientVpnEndpointOutputError>) -> Void)
    ...
    func deleteClientVpnRoute(input: DeleteClientVpnRouteInput, completion: @escaping (SdkResult<DeleteClientVpnRouteOutputResponse, DeleteClientVpnRouteOutputError>) -> Void)
    /// <p>Deletes the specified customer gateway. You must delete the VPN connection before you can delete the customer gateway.</p>
    func deleteCustomerGateway(input: DeleteCustomerGatewayInput, completion: @escaping (SdkResult<DeleteCustomerGatewayOutputResponse, DeleteCustomerGatewayOutputError>) -> Void)
    ...
    func deleteDhcpOptions(input: DeleteDhcpOptionsInput, completion: @escaping (SdkResult<DeleteDhcpOptionsOutputResponse, DeleteDhcpOptionsOutputError>) -> Void)
    /// <p>Deletes an egress-only internet gateway.</p>
    func deleteEgressOnlyInternetGateway(input: DeleteEgressOnlyInternetGatewayInput, completion: @escaping (SdkResult<DeleteEgressOnlyInternetGatewayOutputResponse, DeleteEgressOnlyInternetGatewayOutputError>) -> Void)
    ...
    func deleteFleets(input: DeleteFleetsInput, completion: @escaping (SdkResult<DeleteFleetsOutputResponse, DeleteFleetsOutputError>) -> Void)
    /// <p>Deletes one or more flow logs.</p>
    func deleteFlowLogs(input: DeleteFlowLogsInput, completion: @escaping (SdkResult<DeleteFlowLogsOutputResponse, DeleteFlowLogsOutputError>) -> Void)
    /// <p>Deletes the specified Amazon FPGA Image (AFI).</p>
    func deleteFpgaImage(input: DeleteFpgaImageInput, completion: @escaping (SdkResult<DeleteFpgaImageOutputResponse, DeleteFpgaImageOutputError>) -> Void)
    /// <p>Deletes the specified internet gateway. You must detach the internet gateway from the
    /// 			VPC before you can delete it.</p>
    func deleteInternetGateway(input: DeleteInternetGatewayInput, completion: @escaping (SdkResult<DeleteInternetGatewayOutputResponse, DeleteInternetGatewayOutputError>) -> Void)
    ...
    func deleteLaunchTemplate(input: DeleteLaunchTemplateInput, completion: @escaping (SdkResult<DeleteLaunchTemplateOutputResponse, DeleteLaunchTemplateOutputError>) -> Void)
    ...
    func deleteLaunchTemplateVersions(input: DeleteLaunchTemplateVersionsInput, completion: @escaping (SdkResult<DeleteLaunchTemplateVersionsOutputResponse, DeleteLaunchTemplateVersionsOutputError>) -> Void)
    /// <p>Deletes the specified route from the specified local gateway route table.</p>
    func deleteLocalGatewayRoute(input: DeleteLocalGatewayRouteInput, completion: @escaping (SdkResult<DeleteLocalGatewayRouteOutputResponse, DeleteLocalGatewayRouteOutputError>) -> Void)
    /// <p>Deletes the specified association between a VPC and local gateway route table.</p>
    func deleteLocalGatewayRouteTableVpcAssociation(input: DeleteLocalGatewayRouteTableVpcAssociationInput, completion: @escaping (SdkResult<DeleteLocalGatewayRouteTableVpcAssociationOutputResponse, DeleteLocalGatewayRouteTableVpcAssociationOutputError>) -> Void)
    /// <p>Deletes the specified managed prefix list. You must first remove all references to the prefix list in your resources.</p>
    func deleteManagedPrefixList(input: DeleteManagedPrefixListInput, completion: @escaping (SdkResult<DeleteManagedPrefixListOutputResponse, DeleteManagedPrefixListOutputError>) -> Void)
    ...
    func deleteNatGateway(input: DeleteNatGatewayInput, completion: @escaping (SdkResult<DeleteNatGatewayOutputResponse, DeleteNatGatewayOutputError>) -> Void)
    ...
    func deleteNetworkAcl(input: DeleteNetworkAclInput, completion: @escaping (SdkResult<DeleteNetworkAclOutputResponse, DeleteNetworkAclOutputError>) -> Void)
    /// <p>Deletes the specified ingress or egress entry (rule) from the specified network ACL.</p>
    func deleteNetworkAclEntry(input: DeleteNetworkAclEntryInput, completion: @escaping (SdkResult<DeleteNetworkAclEntryOutputResponse, DeleteNetworkAclEntryOutputError>) -> Void)
    /// <p>Deletes the specified network insights analysis.</p>
    func deleteNetworkInsightsAnalysis(input: DeleteNetworkInsightsAnalysisInput, completion: @escaping (SdkResult<DeleteNetworkInsightsAnalysisOutputResponse, DeleteNetworkInsightsAnalysisOutputError>) -> Void)
    /// <p>Deletes the specified path.</p>
    func deleteNetworkInsightsPath(input: DeleteNetworkInsightsPathInput, completion: @escaping (SdkResult<DeleteNetworkInsightsPathOutputResponse, DeleteNetworkInsightsPathOutputError>) -> Void)
    /// <p>Deletes the specified network interface. You must detach the network interface before you can delete it.</p>
    func deleteNetworkInterface(input: DeleteNetworkInterfaceInput, completion: @escaping (SdkResult<DeleteNetworkInterfaceOutputResponse, DeleteNetworkInterfaceOutputError>) -> Void)
    ...
    func deleteNetworkInterfacePermission(input: DeleteNetworkInterfacePermissionInput, completion: @escaping (SdkResult<DeleteNetworkInterfacePermissionOutputResponse, DeleteNetworkInterfacePermissionOutputError>) -> Void)
    ...
    func deletePlacementGroup(input: DeletePlacementGroupInput, completion: @escaping (SdkResult<DeletePlacementGroupOutputResponse, DeletePlacementGroupOutputError>) -> Void)
    /// <p>Deletes the queued purchases for the specified Reserved Instances.</p>
    func deleteQueuedReservedInstances(input: DeleteQueuedReservedInstancesInput, completion: @escaping (SdkResult<DeleteQueuedReservedInstancesOutputResponse, DeleteQueuedReservedInstancesOutputError>) -> Void)
    ...
    func deleteRouteTable(input: DeleteRouteTableInput, completion: @escaping (SdkResult<DeleteRouteTableOutputResponse, DeleteRouteTableOutputError>) -> Void)
    ...
    func deleteSecurityGroup(input: DeleteSecurityGroupInput, completion: @escaping (SdkResult<DeleteSecurityGroupOutputResponse, DeleteSecurityGroupOutputError>) -> Void)
    ...
    func deleteSpotDatafeedSubscription(input: DeleteSpotDatafeedSubscriptionInput, completion: @escaping (SdkResult<DeleteSpotDatafeedSubscriptionOutputResponse, DeleteSpotDatafeedSubscriptionOutputError>) -> Void)
    /// <p>Deletes the specified subnet. You must terminate all running instances in the subnet before you can delete the subnet.</p>
    func deleteSubnet(input: DeleteSubnetInput, completion: @escaping (SdkResult<DeleteSubnetOutputResponse, DeleteSubnetOutputError>) -> Void)
    ...
    func deleteTrafficMirrorFilter(input: DeleteTrafficMirrorFilterInput, completion: @escaping (SdkResult<DeleteTrafficMirrorFilterOutputResponse, DeleteTrafficMirrorFilterOutputError>) -> Void)
    /// <p>Deletes the specified Traffic Mirror rule.</p>
    func deleteTrafficMirrorFilterRule(input: DeleteTrafficMirrorFilterRuleInput, completion: @escaping (SdkResult<DeleteTrafficMirrorFilterRuleOutputResponse, DeleteTrafficMirrorFilterRuleOutputError>) -> Void)
    /// <p>Deletes the specified Traffic Mirror session.</p>
    func deleteTrafficMirrorSession(input: DeleteTrafficMirrorSessionInput, completion: @escaping (SdkResult<DeleteTrafficMirrorSessionOutputResponse, DeleteTrafficMirrorSessionOutputError>) -> Void)
    ...
    func deleteTrafficMirrorTarget(input: DeleteTrafficMirrorTargetInput, completion: @escaping (SdkResult<DeleteTrafficMirrorTargetOutputResponse, DeleteTrafficMirrorTargetOutputError>) -> Void)
    /// <p>Deletes the specified transit gateway.</p>
    func deleteTransitGateway(input: DeleteTransitGatewayInput, completion: @escaping (SdkResult<DeleteTransitGatewayOutputResponse, DeleteTransitGatewayOutputError>) -> Void)
    /// <p>Deletes the specified Connect attachment. You must first delete any Connect peers for
    ///             the attachment.</p>
    func deleteTransitGatewayConnect(input: DeleteTransitGatewayConnectInput, completion: @escaping (SdkResult<DeleteTransitGatewayConnectOutputResponse, DeleteTransitGatewayConnectOutputError>) -> Void)
    /// <p>Deletes the specified Connect peer.</p>
    func deleteTransitGatewayConnectPeer(input: DeleteTransitGatewayConnectPeerInput, completion: @escaping (SdkResult<DeleteTransitGatewayConnectPeerOutputResponse, DeleteTransitGatewayConnectPeerOutputError>) -> Void)
    /// <p>Deletes the specified transit gateway multicast domain.</p>
    func deleteTransitGatewayMulticastDomain(input: DeleteTransitGatewayMulticastDomainInput, completion: @escaping (SdkResult<DeleteTransitGatewayMulticastDomainOutputResponse, DeleteTransitGatewayMulticastDomainOutputError>) -> Void)
    /// <p>Deletes a transit gateway peering attachment.</p>
    func deleteTransitGatewayPeeringAttachment(input: DeleteTransitGatewayPeeringAttachmentInput, completion: @escaping (SdkResult<DeleteTransitGatewayPeeringAttachmentOutputResponse, DeleteTransitGatewayPeeringAttachmentOutputError>) -> Void)
    /// <p>Deletes a reference (route) to a prefix list in a specified transit gateway route table.</p>
    func deleteTransitGatewayPrefixListReference(input: DeleteTransitGatewayPrefixListReferenceInput, completion: @escaping (SdkResult<DeleteTransitGatewayPrefixListReferenceOutputResponse, DeleteTransitGatewayPrefixListReferenceOutputError>) -> Void)
    /// <p>Deletes the specified route from the specified transit gateway route table.</p>
    func deleteTransitGatewayRoute(input: DeleteTransitGatewayRouteInput, completion: @escaping (SdkResult<DeleteTransitGatewayRouteOutputResponse, DeleteTransitGatewayRouteOutputError>) -> Void)
    ...
    func deleteTransitGatewayRouteTable(input: DeleteTransitGatewayRouteTableInput, completion: @escaping (SdkResult<DeleteTransitGatewayRouteTableOutputResponse, DeleteTransitGatewayRouteTableOutputError>) -> Void)
    /// <p>Deletes the specified VPC attachment.</p>
    func deleteTransitGatewayVpcAttachment(input: DeleteTransitGatewayVpcAttachmentInput, completion: @escaping (SdkResult<DeleteTransitGatewayVpcAttachmentOutputResponse, DeleteTransitGatewayVpcAttachmentOutputError>) -> Void)
    ...
    func deleteVpc(input: DeleteVpcInput, completion: @escaping (SdkResult<DeleteVpcOutputResponse, DeleteVpcOutputError>) -> Void)
    /// <p>Deletes one or more VPC endpoint connection notifications.</p>
    func deleteVpcEndpointConnectionNotifications(input: DeleteVpcEndpointConnectionNotificationsInput, completion: @escaping (SdkResult<DeleteVpcEndpointConnectionNotificationsOutputResponse, DeleteVpcEndpointConnectionNotificationsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteVpcEndpoints(input: DeleteVpcEndpointsInput, completion: @escaping (SdkResult<DeleteVpcEndpointsOutputResponse, DeleteVpcEndpointsOutputError>) -> Void)
    ...
    ///             the service.</p>
    func deleteVpcEndpointServiceConfigurations(input: DeleteVpcEndpointServiceConfigurationsInput, completion: @escaping (SdkResult<DeleteVpcEndpointServiceConfigurationsOutputResponse, DeleteVpcEndpointServiceConfigurationsOutputError>) -> Void)
    ...
    func deleteVpnConnection(input: DeleteVpnConnectionInput, completion: @escaping (SdkResult<DeleteVpnConnectionOutputResponse, DeleteVpnConnectionOutputError>) -> Void)
    ...
    func deleteVpnConnectionRoute(input: DeleteVpnConnectionRouteInput, completion: @escaping (SdkResult<DeleteVpnConnectionRouteOutputResponse, DeleteVpnConnectionRouteOutputError>) -> Void)
    ...
    func deleteVpnGateway(input: DeleteVpnGatewayInput, completion: @escaping (SdkResult<DeleteVpnGatewayOutputResponse, DeleteVpnGatewayOutputError>) -> Void)
    ...
    func deregisterImage(input: DeregisterImageInput, completion: @escaping (SdkResult<DeregisterImageOutputResponse, DeregisterImageOutputError>) -> Void)
    ...
    func deregisterInstanceEventNotificationAttributes(input: DeregisterInstanceEventNotificationAttributesInput, completion: @escaping (SdkResult<DeregisterInstanceEventNotificationAttributesOutputResponse, DeregisterInstanceEventNotificationAttributesOutputError>) -> Void)
    /// <p>Deregisters the specified members (network interfaces) from the  transit gateway multicast group.</p>
    func deregisterTransitGatewayMulticastGroupMembers(input: DeregisterTransitGatewayMulticastGroupMembersInput, completion: @escaping (SdkResult<DeregisterTransitGatewayMulticastGroupMembersOutputResponse, DeregisterTransitGatewayMulticastGroupMembersOutputError>) -> Void)
    /// <p>Deregisters the specified sources (network interfaces) from the  transit gateway multicast group.</p>
    func deregisterTransitGatewayMulticastGroupSources(input: DeregisterTransitGatewayMulticastGroupSourcesInput, completion: @escaping (SdkResult<DeregisterTransitGatewayMulticastGroupSourcesOutputResponse, DeregisterTransitGatewayMulticastGroupSourcesOutputError>) -> Void)
    ...
    func describeAddressesAttribute(input: DescribeAddressesAttributeInput, completion: @escaping (SdkResult<DescribeAddressesAttributeOutputResponse, DescribeAddressesAttributeOutputError>) -> Void)
    ...
    func describeAggregateIdFormat(input: DescribeAggregateIdFormatInput, completion: @escaping (SdkResult<DescribeAggregateIdFormatOutputResponse, DescribeAggregateIdFormatOutputError>) -> Void)
    ...
    func describeAvailabilityZones(input: DescribeAvailabilityZonesInput, completion: @escaping (SdkResult<DescribeAvailabilityZonesOutputResponse, DescribeAvailabilityZonesOutputError>) -> Void)
    ...
    ///          </note>
    func describeBundleTasks(input: DescribeBundleTasksInput, completion: @escaping (SdkResult<DescribeBundleTasksOutputResponse, DescribeBundleTasksOutputError>) -> Void)
    ...
    func describeByoipCidrs(input: DescribeByoipCidrsInput, completion: @escaping (SdkResult<DescribeByoipCidrsOutputResponse, DescribeByoipCidrsOutputError>) -> Void)
    ...
    func describeCapacityReservations(input: DescribeCapacityReservationsInput, completion: @escaping (SdkResult<DescribeCapacityReservationsOutputResponse, DescribeCapacityReservationsOutputError>) -> Void)
    /// <p>Describes one or more of your carrier gateways.</p>
    func describeCarrierGateways(input: DescribeCarrierGatewaysInput, completion: @escaping (SdkResult<DescribeCarrierGatewaysOutputResponse, DescribeCarrierGatewaysOutputError>) -> Void)
    ...
    func describeClassicLinkInstances(input: DescribeClassicLinkInstancesInput, completion: @escaping (SdkResult<DescribeClassicLinkInstancesOutputResponse, DescribeClassicLinkInstancesOutputError>) -> Void)
    /// <p>Describes the authorization rules for a specified Client VPN endpoint.</p>
    func describeClientVpnAuthorizationRules(input: DescribeClientVpnAuthorizationRulesInput, completion: @escaping (SdkResult<DescribeClientVpnAuthorizationRulesOutputResponse, DescribeClientVpnAuthorizationRulesOutputError>) -> Void)
    ...
    func describeClientVpnConnections(input: DescribeClientVpnConnectionsInput, completion: @escaping (SdkResult<DescribeClientVpnConnectionsOutputResponse, DescribeClientVpnConnectionsOutputError>) -> Void)
    /// <p>Describes one or more Client VPN endpoints in the account.</p>
    func describeClientVpnEndpoints(input: DescribeClientVpnEndpointsInput, completion: @escaping (SdkResult<DescribeClientVpnEndpointsOutputResponse, DescribeClientVpnEndpointsOutputError>) -> Void)
    /// <p>Describes the routes for the specified Client VPN endpoint.</p>
    func describeClientVpnRoutes(input: DescribeClientVpnRoutesInput, completion: @escaping (SdkResult<DescribeClientVpnRoutesOutputResponse, DescribeClientVpnRoutesOutputError>) -> Void)
    /// <p>Describes the target networks associated with the specified Client VPN endpoint.</p>
    func describeClientVpnTargetNetworks(input: DescribeClientVpnTargetNetworksInput, completion: @escaping (SdkResult<DescribeClientVpnTargetNetworksOutputResponse, DescribeClientVpnTargetNetworksOutputError>) -> Void)
    /// <p>Describes the specified customer-owned address pools or all of your customer-owned address pools.</p>
    func describeCoipPools(input: DescribeCoipPoolsInput, completion: @escaping (SdkResult<DescribeCoipPoolsOutputResponse, DescribeCoipPoolsOutputError>) -> Void)
    ...
    func describeConversionTasks(input: DescribeConversionTasksInput, completion: @escaping (SdkResult<DescribeConversionTasksOutputResponse, DescribeConversionTasksOutputError>) -> Void)
    /// <p>Describes one or more of your VPN customer gateways.</p>
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN User Guide</i>.</p>
    func describeCustomerGateways(input: DescribeCustomerGatewaysInput, completion: @escaping (SdkResult<DescribeCustomerGatewaysOutputResponse, DescribeCustomerGatewaysOutputError>) -> Void)
    ...
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func describeDhcpOptions(input: DescribeDhcpOptionsInput, completion: @escaping (SdkResult<DescribeDhcpOptionsOutputResponse, DescribeDhcpOptionsOutputError>) -> Void)
    /// <p>Describes one or more of your egress-only internet gateways.</p>
    func describeEgressOnlyInternetGateways(input: DescribeEgressOnlyInternetGatewaysInput, completion: @escaping (SdkResult<DescribeEgressOnlyInternetGatewaysOutputResponse, DescribeEgressOnlyInternetGatewaysOutputError>) -> Void)
    ...
    func describeElasticGpus(input: DescribeElasticGpusInput, completion: @escaping (SdkResult<DescribeElasticGpusOutputResponse, DescribeElasticGpusOutputError>) -> Void)
    /// <p>Describes the specified export image tasks or all of your export image tasks.</p>
    func describeExportImageTasks(input: DescribeExportImageTasksInput, completion: @escaping (SdkResult<DescribeExportImageTasksOutputResponse, DescribeExportImageTasksOutputError>) -> Void)
    ...
    func describeFastSnapshotRestores(input: DescribeFastSnapshotRestoresInput, completion: @escaping (SdkResult<DescribeFastSnapshotRestoresOutputResponse, DescribeFastSnapshotRestoresOutputError>) -> Void)
    ...
    func describeFleetHistory(input: DescribeFleetHistoryInput, completion: @escaping (SdkResult<DescribeFleetHistoryOutputResponse, DescribeFleetHistoryOutputError>) -> Void)
    /// <p>Describes the running instances for the specified EC2 Fleet.</p>
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet.html#monitor-ec2-fleet">Monitoring your EC2 Fleet</a> in the <i>Amazon EC2 User Guide</i>.</p>
    func describeFleetInstances(input: DescribeFleetInstancesInput, completion: @escaping (SdkResult<DescribeFleetInstancesOutputResponse, DescribeFleetInstancesOutputError>) -> Void)
    ...
    ///             API.</p>
    func describeFlowLogs(input: DescribeFlowLogsInput, completion: @escaping (SdkResult<DescribeFlowLogsOutputResponse, DescribeFlowLogsOutputError>) -> Void)
    /// <p>Describes the specified attribute of the specified Amazon FPGA Image (AFI).</p>
    func describeFpgaImageAttribute(input: DescribeFpgaImageAttributeInput, completion: @escaping (SdkResult<DescribeFpgaImageAttributeOutputResponse, DescribeFpgaImageAttributeOutputError>) -> Void)
    ...
    /// 			permissions.</p>
    func describeFpgaImages(input: DescribeFpgaImagesInput, completion: @escaping (SdkResult<DescribeFpgaImagesOutputResponse, DescribeFpgaImagesOutputError>) -> Void)
    ...
    ///             in the <i>Amazon EC2 User Guide</i>. </p>
    func describeHostReservationOfferings(input: DescribeHostReservationOfferingsInput, completion: @escaping (SdkResult<DescribeHostReservationOfferingsOutputResponse, DescribeHostReservationOfferingsOutputError>) -> Void)
    /// <p>Describes reservations that are associated with Dedicated Hosts in your
    ///             account.</p>
    func describeHostReservations(input: DescribeHostReservationsInput, completion: @escaping (SdkResult<DescribeHostReservationsOutputResponse, DescribeHostReservationsOutputError>) -> Void)
    ...
    func describeHosts(input: DescribeHostsInput, completion: @escaping (SdkResult<DescribeHostsOutputResponse, DescribeHostsOutputError>) -> Void)
    /// <p>Describes your IAM instance profile associations.</p>
    func describeIamInstanceProfileAssociations(input: DescribeIamInstanceProfileAssociationsInput, completion: @escaping (SdkResult<DescribeIamInstanceProfileAssociationsOutputResponse, DescribeIamInstanceProfileAssociationsOutputError>) -> Void)
    ...
    func describeIdentityIdFormat(input: DescribeIdentityIdFormatInput, completion: @escaping (SdkResult<DescribeIdentityIdFormatOutputResponse, DescribeIdentityIdFormatOutputError>) -> Void)
    ...
    ///       resource type.</p>
    func describeIdFormat(input: DescribeIdFormatInput, completion: @escaping (SdkResult<DescribeIdFormatOutputResponse, DescribeIdFormatOutputError>) -> Void)
    /// <p>Describes the specified attribute of the specified AMI. You can specify only one attribute at a time.</p>
    func describeImageAttribute(input: DescribeImageAttributeInput, completion: @escaping (SdkResult<DescribeImageAttributeOutputResponse, DescribeImageAttributeOutputError>) -> Void)
    ...
    func describeImportImageTasks(input: DescribeImportImageTasksInput, completion: @escaping (SdkResult<DescribeImportImageTasksOutputResponse, DescribeImportImageTasksOutputError>) -> Void)
    /// <p>Describes your import snapshot tasks.</p>
    func describeImportSnapshotTasks(input: DescribeImportSnapshotTasksInput, completion: @escaping (SdkResult<DescribeImportSnapshotTasksOutputResponse, DescribeImportSnapshotTasksOutputError>) -> Void)
    ...
    func describeInstanceCreditSpecifications(input: DescribeInstanceCreditSpecificationsInput, completion: @escaping (SdkResult<DescribeInstanceCreditSpecificationsOutputResponse, DescribeInstanceCreditSpecificationsOutputError>) -> Void)
    ...
    func describeInstanceEventNotificationAttributes(input: DescribeInstanceEventNotificationAttributesInput, completion: @escaping (SdkResult<DescribeInstanceEventNotificationAttributesOutputResponse, DescribeInstanceEventNotificationAttributesOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeInstanceStatus(input: DescribeInstanceStatusInput, completion: @escaping (SdkResult<DescribeInstanceStatusOutputResponse, DescribeInstanceStatusOutputError>) -> Void)
    ...
    func describeInstanceTypeOfferings(input: DescribeInstanceTypeOfferingsInput, completion: @escaping (SdkResult<DescribeInstanceTypeOfferingsOutputResponse, DescribeInstanceTypeOfferingsOutputError>) -> Void)
    ...
    func describeInstanceTypes(input: DescribeInstanceTypesInput, completion: @escaping (SdkResult<DescribeInstanceTypesOutputResponse, DescribeInstanceTypesOutputError>) -> Void)
    /// <p>Describes one or more of your internet gateways.</p>
    func describeInternetGateways(input: DescribeInternetGatewaysInput, completion: @escaping (SdkResult<DescribeInternetGatewaysOutputResponse, DescribeInternetGatewaysOutputError>) -> Void)
    /// <p>Describes your IPv6 address pools.</p>
    func describeIpv6Pools(input: DescribeIpv6PoolsInput, completion: @escaping (SdkResult<DescribeIpv6PoolsOutputResponse, DescribeIpv6PoolsOutputError>) -> Void)
    ...
    /// 				in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func describeKeyPairs(input: DescribeKeyPairsInput, completion: @escaping (SdkResult<DescribeKeyPairsOutputResponse, DescribeKeyPairsOutputError>) -> Void)
    /// <p>Describes one or more launch templates.</p>
    func describeLaunchTemplates(input: DescribeLaunchTemplatesInput, completion: @escaping (SdkResult<DescribeLaunchTemplatesOutputResponse, DescribeLaunchTemplatesOutputError>) -> Void)
    ...
    ///             account.</p>
    func describeLaunchTemplateVersions(input: DescribeLaunchTemplateVersionsInput, completion: @escaping (SdkResult<DescribeLaunchTemplateVersionsOutputResponse, DescribeLaunchTemplateVersionsOutputError>) -> Void)
    /// <p>Describes one or more local gateway route tables. By default, all local gateway route tables are described.
    ///          Alternatively, you can filter the results.</p>
    func describeLocalGatewayRouteTables(input: DescribeLocalGatewayRouteTablesInput, completion: @escaping (SdkResult<DescribeLocalGatewayRouteTablesOutputResponse, DescribeLocalGatewayRouteTablesOutputError>) -> Void)
    /// <p>Describes the associations between virtual interface groups and local gateway route tables.</p>
    func describeLocalGatewayRouteTableVirtualInterfaceGroupAssociations(input: DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsInput, completion: @escaping (SdkResult<DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsOutputResponse, DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsOutputError>) -> Void)
    /// <p>Describes the specified associations between VPCs and local gateway route tables.</p>
    func describeLocalGatewayRouteTableVpcAssociations(input: DescribeLocalGatewayRouteTableVpcAssociationsInput, completion: @escaping (SdkResult<DescribeLocalGatewayRouteTableVpcAssociationsOutputResponse, DescribeLocalGatewayRouteTableVpcAssociationsOutputError>) -> Void)
    /// <p>Describes one or more local gateways. By default, all local gateways are described.
    ///         Alternatively, you can filter the results.</p>
    func describeLocalGateways(input: DescribeLocalGatewaysInput, completion: @escaping (SdkResult<DescribeLocalGatewaysOutputResponse, DescribeLocalGatewaysOutputError>) -> Void)
    /// <p>Describes the specified local gateway virtual interface groups.</p>
    func describeLocalGatewayVirtualInterfaceGroups(input: DescribeLocalGatewayVirtualInterfaceGroupsInput, completion: @escaping (SdkResult<DescribeLocalGatewayVirtualInterfaceGroupsOutputResponse, DescribeLocalGatewayVirtualInterfaceGroupsOutputError>) -> Void)
    /// <p>Describes the specified local gateway virtual interfaces.</p>
    func describeLocalGatewayVirtualInterfaces(input: DescribeLocalGatewayVirtualInterfacesInput, completion: @escaping (SdkResult<DescribeLocalGatewayVirtualInterfacesOutputResponse, DescribeLocalGatewayVirtualInterfacesOutputError>) -> Void)
    ...
    func describeManagedPrefixLists(input: DescribeManagedPrefixListsInput, completion: @escaping (SdkResult<DescribeManagedPrefixListsOutputResponse, DescribeManagedPrefixListsOutputError>) -> Void)
    ...
    func describeMovingAddresses(input: DescribeMovingAddressesInput, completion: @escaping (SdkResult<DescribeMovingAddressesOutputResponse, DescribeMovingAddressesOutputError>) -> Void)
    /// <p>Describes one or more of your NAT gateways.</p>
    func describeNatGateways(input: DescribeNatGatewaysInput, completion: @escaping (SdkResult<DescribeNatGatewaysOutputResponse, DescribeNatGatewaysOutputError>) -> Void)
    /// <p>Describes one or more of your network ACLs.</p>
    /// 		       <p>For more information, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_ACLs.html">Network ACLs</a> in the
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func describeNetworkAcls(input: DescribeNetworkAclsInput, completion: @escaping (SdkResult<DescribeNetworkAclsOutputResponse, DescribeNetworkAclsOutputError>) -> Void)
    /// <p>Describes one or more of your network insights analyses.</p>
    func describeNetworkInsightsAnalyses(input: DescribeNetworkInsightsAnalysesInput, completion: @escaping (SdkResult<DescribeNetworkInsightsAnalysesOutputResponse, DescribeNetworkInsightsAnalysesOutputError>) -> Void)
    /// <p>Describes one or more of your paths.</p>
    func describeNetworkInsightsPaths(input: DescribeNetworkInsightsPathsInput, completion: @escaping (SdkResult<DescribeNetworkInsightsPathsOutputResponse, DescribeNetworkInsightsPathsOutputError>) -> Void)
    /// <p>Describes a network interface attribute. You can specify only one attribute at a time.</p>
    func describeNetworkInterfaceAttribute(input: DescribeNetworkInterfaceAttributeInput, completion: @escaping (SdkResult<DescribeNetworkInterfaceAttributeOutputResponse, DescribeNetworkInterfaceAttributeOutputError>) -> Void)
    /// <p>Describes the permissions for your network interfaces. </p>
    func describeNetworkInterfacePermissions(input: DescribeNetworkInterfacePermissionsInput, completion: @escaping (SdkResult<DescribeNetworkInterfacePermissionsOutputResponse, DescribeNetworkInterfacePermissionsOutputError>) -> Void)
    /// <p>Describes one or more of your network interfaces.</p>
    func describeNetworkInterfaces(input: DescribeNetworkInterfacesInput, completion: @escaping (SdkResult<DescribeNetworkInterfacesOutputResponse, DescribeNetworkInterfacesOutputError>) -> Void)
    /// <p>Describes the specified placement groups or all of your placement groups. For more
    ///             information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html">Placement groups</a> in the
    ///                 <i>Amazon EC2 User Guide</i>.</p>
    func describePlacementGroups(input: DescribePlacementGroupsInput, completion: @escaping (SdkResult<DescribePlacementGroupsOutputResponse, DescribePlacementGroupsOutputError>) -> Void)
    ...
    func describePrefixLists(input: DescribePrefixListsInput, completion: @escaping (SdkResult<DescribePrefixListsOutputResponse, DescribePrefixListsOutputError>) -> Void)
    ...
    ///           | <code>vpc-cidr-block-association</code> | <code>vpc-endpoint</code> |
    ///           <code>vpc-peering-connection</code> | <code>vpn-connection</code> | <code>vpn-gateway</code>. </p>
    func describePrincipalIdFormat(input: DescribePrincipalIdFormatInput, completion: @escaping (SdkResult<DescribePrincipalIdFormatOutputResponse, DescribePrincipalIdFormatOutputError>) -> Void)
    /// <p>Describes the specified IPv4 address pools.</p>
    func describePublicIpv4Pools(input: DescribePublicIpv4PoolsInput, completion: @escaping (SdkResult<DescribePublicIpv4PoolsOutputResponse, DescribePublicIpv4PoolsOutputError>) -> Void)
    ...
    ///       <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func describeReplaceRootVolumeTasks(input: DescribeReplaceRootVolumeTasksInput, completion: @escaping (SdkResult<DescribeReplaceRootVolumeTasksOutputResponse, DescribeReplaceRootVolumeTasksOutputError>) -> Void)
    ...
    func describeReservedInstances(input: DescribeReservedInstancesInput, completion: @escaping (SdkResult<DescribeReservedInstancesOutputResponse, DescribeReservedInstancesOutputError>) -> Void)
    ...
    ///         in the <i>Amazon EC2 User Guide</i>.</p>
    func describeReservedInstancesListings(input: DescribeReservedInstancesListingsInput, completion: @escaping (SdkResult<DescribeReservedInstancesListingsOutputResponse, DescribeReservedInstancesListingsOutputError>) -> Void)
    ...
    func describeReservedInstancesModifications(input: DescribeReservedInstancesModificationsInput, completion: @escaping (SdkResult<DescribeReservedInstancesModificationsOutputResponse, DescribeReservedInstancesModificationsOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-market-general.html">Reserved Instance Marketplace</a>
    /// 				in the <i>Amazon EC2 User Guide</i>.</p>
    func describeReservedInstancesOfferings(input: DescribeReservedInstancesOfferingsInput, completion: @escaping (SdkResult<DescribeReservedInstancesOfferingsOutputResponse, DescribeReservedInstancesOfferingsOutputError>) -> Void)
    ...
    /// 		       <p>For more information, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html">Route Tables</a> in the
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func describeRouteTables(input: DescribeRouteTablesInput, completion: @escaping (SdkResult<DescribeRouteTablesOutputResponse, DescribeRouteTablesOutputError>) -> Void)
    ...
    func describeScheduledInstanceAvailability(input: DescribeScheduledInstanceAvailabilityInput, completion: @escaping (SdkResult<DescribeScheduledInstanceAvailabilityOutputResponse, DescribeScheduledInstanceAvailabilityOutputError>) -> Void)
    /// <p>Describes the specified Scheduled Instances or all your Scheduled Instances.</p>
    func describeScheduledInstances(input: DescribeScheduledInstancesInput, completion: @escaping (SdkResult<DescribeScheduledInstancesOutputResponse, DescribeScheduledInstancesOutputError>) -> Void)
    ...
    func describeSecurityGroupReferences(input: DescribeSecurityGroupReferencesInput, completion: @escaping (SdkResult<DescribeSecurityGroupReferencesOutputResponse, DescribeSecurityGroupReferencesOutputError>) -> Void)
    ...
    /// 				<a href="https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_SecurityGroups.html">Security Groups for Your VPC</a> in the
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func describeSecurityGroups(input: DescribeSecurityGroupsInput, completion: @escaping (SdkResult<DescribeSecurityGroupsOutputResponse, DescribeSecurityGroupsOutputError>) -> Void)
    ...
    func describeSnapshotAttribute(input: DescribeSnapshotAttributeInput, completion: @escaping (SdkResult<DescribeSnapshotAttributeOutputResponse, DescribeSnapshotAttributeOutputError>) -> Void)
    ...
    func describeSpotDatafeedSubscription(input: DescribeSpotDatafeedSubscriptionInput, completion: @escaping (SdkResult<DescribeSpotDatafeedSubscriptionOutputResponse, DescribeSpotDatafeedSubscriptionOutputError>) -> Void)
    /// <p>Describes the running instances for the specified Spot Fleet.</p>
    func describeSpotFleetInstances(input: DescribeSpotFleetInstancesInput, completion: @escaping (SdkResult<DescribeSpotFleetInstancesOutputResponse, DescribeSpotFleetInstancesOutputError>) -> Void)
    ...
    func describeSpotFleetRequestHistory(input: DescribeSpotFleetRequestHistoryInput, completion: @escaping (SdkResult<DescribeSpotFleetRequestHistoryOutputResponse, DescribeSpotFleetRequestHistoryOutputError>) -> Void)
    ...
    func describeSpotFleetRequests(input: DescribeSpotFleetRequestsInput, completion: @escaping (SdkResult<DescribeSpotFleetRequestsOutputResponse, DescribeSpotFleetRequestsOutputError>) -> Void)
    ...
    ///             are terminated.</p>
    func describeSpotInstanceRequests(input: DescribeSpotInstanceRequestsInput, completion: @escaping (SdkResult<DescribeSpotInstanceRequestsOutputResponse, DescribeSpotInstanceRequestsOutputError>) -> Void)
    ...
    func describeSpotPriceHistory(input: DescribeSpotPriceHistoryInput, completion: @escaping (SdkResult<DescribeSpotPriceHistoryOutputResponse, DescribeSpotPriceHistoryOutputError>) -> Void)
    ...
    func describeStaleSecurityGroups(input: DescribeStaleSecurityGroupsInput, completion: @escaping (SdkResult<DescribeStaleSecurityGroupsOutputResponse, DescribeStaleSecurityGroupsOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-store-restore.html">Store and restore an AMI using
    ///         S3</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func describeStoreImageTasks(input: DescribeStoreImageTasksInput, completion: @escaping (SdkResult<DescribeStoreImageTasksOutputResponse, DescribeStoreImageTasksOutputError>) -> Void)
    ...
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func describeSubnets(input: DescribeSubnetsInput, completion: @escaping (SdkResult<DescribeSubnetsOutputResponse, DescribeSubnetsOutputError>) -> Void)
    ...
    func describeTrafficMirrorFilters(input: DescribeTrafficMirrorFiltersInput, completion: @escaping (SdkResult<DescribeTrafficMirrorFiltersOutputResponse, DescribeTrafficMirrorFiltersOutputError>) -> Void)
    /// <p>Describes one or more Traffic Mirror sessions. By default, all Traffic Mirror sessions are described. Alternatively, you can filter the results.</p>
    func describeTrafficMirrorSessions(input: DescribeTrafficMirrorSessionsInput, completion: @escaping (SdkResult<DescribeTrafficMirrorSessionsOutputResponse, DescribeTrafficMirrorSessionsOutputError>) -> Void)
    /// <p>Information about one or more Traffic Mirror targets.</p>
    func describeTrafficMirrorTargets(input: DescribeTrafficMirrorTargetsInput, completion: @escaping (SdkResult<DescribeTrafficMirrorTargetsOutputResponse, DescribeTrafficMirrorTargetsOutputError>) -> Void)
    ...
    func describeTransitGatewayAttachments(input: DescribeTransitGatewayAttachmentsInput, completion: @escaping (SdkResult<DescribeTransitGatewayAttachmentsOutputResponse, DescribeTransitGatewayAttachmentsOutputError>) -> Void)
    /// <p>Describes one or more Connect peers.</p>
    func describeTransitGatewayConnectPeers(input: DescribeTransitGatewayConnectPeersInput, completion: @escaping (SdkResult<DescribeTransitGatewayConnectPeersOutputResponse, DescribeTransitGatewayConnectPeersOutputError>) -> Void)
    /// <p>Describes one or more Connect attachments.</p>
    func describeTransitGatewayConnects(input: DescribeTransitGatewayConnectsInput, completion: @escaping (SdkResult<DescribeTransitGatewayConnectsOutputResponse, DescribeTransitGatewayConnectsOutputError>) -> Void)
    /// <p>Describes one or more transit gateway multicast domains.</p>
    func describeTransitGatewayMulticastDomains(input: DescribeTransitGatewayMulticastDomainsInput, completion: @escaping (SdkResult<DescribeTransitGatewayMulticastDomainsOutputResponse, DescribeTransitGatewayMulticastDomainsOutputError>) -> Void)
    /// <p>Describes your transit gateway peering attachments.</p>
    func describeTransitGatewayPeeringAttachments(input: DescribeTransitGatewayPeeringAttachmentsInput, completion: @escaping (SdkResult<DescribeTransitGatewayPeeringAttachmentsOutputResponse, DescribeTransitGatewayPeeringAttachmentsOutputError>) -> Void)
    /// <p>Describes one or more transit gateway route tables. By default, all transit gateway route tables are described.
    ///          Alternatively, you can filter the results.</p>
    func describeTransitGatewayRouteTables(input: DescribeTransitGatewayRouteTablesInput, completion: @escaping (SdkResult<DescribeTransitGatewayRouteTablesOutputResponse, DescribeTransitGatewayRouteTablesOutputError>) -> Void)
    ...
    func describeTransitGateways(input: DescribeTransitGatewaysInput, completion: @escaping (SdkResult<DescribeTransitGatewaysOutputResponse, DescribeTransitGatewaysOutputError>) -> Void)
    /// <p>Describes one or more VPC attachments. By default, all VPC attachments are described.
    ///          Alternatively, you can filter the results.</p>
    func describeTransitGatewayVpcAttachments(input: DescribeTransitGatewayVpcAttachmentsInput, completion: @escaping (SdkResult<DescribeTransitGatewayVpcAttachmentsOutputResponse, DescribeTransitGatewayVpcAttachmentsOutputError>) -> Void)
    ...
    func describeVolumeAttribute(input: DescribeVolumeAttributeInput, completion: @escaping (SdkResult<DescribeVolumeAttributeOutputResponse, DescribeVolumeAttributeOutputError>) -> Void)
    ...
    ///       <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func describeVolumesModifications(input: DescribeVolumesModificationsInput, completion: @escaping (SdkResult<DescribeVolumesModificationsOutputResponse, DescribeVolumesModificationsOutputError>) -> Void)
    ...
    func describeVolumeStatus(input: DescribeVolumeStatusInput, completion: @escaping (SdkResult<DescribeVolumeStatusOutputResponse, DescribeVolumeStatusOutputError>) -> Void)
    /// <p>Describes the specified attribute of the specified VPC. You can specify only one attribute at a time.</p>
    func describeVpcAttribute(input: DescribeVpcAttributeInput, completion: @escaping (SdkResult<DescribeVpcAttributeOutputResponse, DescribeVpcAttributeOutputError>) -> Void)
    /// <p>Describes the ClassicLink status of one or more VPCs.</p>
    func describeVpcClassicLink(input: DescribeVpcClassicLinkInput, completion: @escaping (SdkResult<DescribeVpcClassicLinkOutputResponse, DescribeVpcClassicLinkOutputError>) -> Void)
    ...
    func describeVpcClassicLinkDnsSupport(input: DescribeVpcClassicLinkDnsSupportInput, completion: @escaping (SdkResult<DescribeVpcClassicLinkDnsSupportOutputResponse, DescribeVpcClassicLinkDnsSupportOutputError>) -> Void)
    /// <p>Describes the connection notifications for VPC endpoints and VPC endpoint
    ///             services.</p>
    func describeVpcEndpointConnectionNotifications(input: DescribeVpcEndpointConnectionNotificationsInput, completion: @escaping (SdkResult<DescribeVpcEndpointConnectionNotificationsOutputResponse, DescribeVpcEndpointConnectionNotificationsOutputError>) -> Void)
    ...
    func describeVpcEndpointConnections(input: DescribeVpcEndpointConnectionsInput, completion: @escaping (SdkResult<DescribeVpcEndpointConnectionsOutputResponse, DescribeVpcEndpointConnectionsOutputError>) -> Void)
    /// <p>Describes one or more of your VPC endpoints.</p>
    func describeVpcEndpoints(input: DescribeVpcEndpointsInput, completion: @escaping (SdkResult<DescribeVpcEndpointsOutputResponse, DescribeVpcEndpointsOutputError>) -> Void)
    /// <p>Describes the VPC endpoint service configurations in your account (your services).</p>
    func describeVpcEndpointServiceConfigurations(input: DescribeVpcEndpointServiceConfigurationsInput, completion: @escaping (SdkResult<DescribeVpcEndpointServiceConfigurationsOutputResponse, DescribeVpcEndpointServiceConfigurationsOutputError>) -> Void)
    /// <p>Describes the principals (service consumers) that are permitted to discover your VPC
    ///             endpoint service.</p>
    func describeVpcEndpointServicePermissions(input: DescribeVpcEndpointServicePermissionsInput, completion: @escaping (SdkResult<DescribeVpcEndpointServicePermissionsOutputResponse, DescribeVpcEndpointServicePermissionsOutputError>) -> Void)
    ...
    func describeVpcEndpointServices(input: DescribeVpcEndpointServicesInput, completion: @escaping (SdkResult<DescribeVpcEndpointServicesOutputResponse, DescribeVpcEndpointServicesOutputError>) -> Void)
    ...
    func describeVpcs(input: DescribeVpcsInput, completion: @escaping (SdkResult<DescribeVpcsOutputResponse, DescribeVpcsOutputError>) -> Void)
    /// <p>Describes one or more of your VPN connections.</p>
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN User Guide</i>.</p>
    func describeVpnConnections(input: DescribeVpnConnectionsInput, completion: @escaping (SdkResult<DescribeVpnConnectionsOutputResponse, DescribeVpnConnectionsOutputError>) -> Void)
    /// <p>Describes one or more of your virtual private gateways.</p>
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html">AWS Site-to-Site VPN</a> in the <i>AWS Site-to-Site VPN User Guide</i>.</p>
    func describeVpnGateways(input: DescribeVpnGatewaysInput, completion: @escaping (SdkResult<DescribeVpnGatewaysOutputResponse, DescribeVpnGatewaysOutputError>) -> Void)
    ...
    func detachClassicLinkVpc(input: DetachClassicLinkVpcInput, completion: @escaping (SdkResult<DetachClassicLinkVpcOutputResponse, DetachClassicLinkVpcOutputError>) -> Void)
    ...
    func detachInternetGateway(input: DetachInternetGatewayInput, completion: @escaping (SdkResult<DetachInternetGatewayOutputResponse, DetachInternetGatewayOutputError>) -> Void)
    /// <p>Detaches a network interface from an instance.</p>
    func detachNetworkInterface(input: DetachNetworkInterfaceInput, completion: @escaping (SdkResult<DetachNetworkInterfaceOutputResponse, DetachNetworkInterfaceOutputError>) -> Void)
    ...
    func detachVpnGateway(input: DetachVpnGatewayInput, completion: @escaping (SdkResult<DetachVpnGatewayOutputResponse, DetachVpnGatewayOutputError>) -> Void)
    ...
    ///       <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func disableEbsEncryptionByDefault(input: DisableEbsEncryptionByDefaultInput, completion: @escaping (SdkResult<DisableEbsEncryptionByDefaultOutputResponse, DisableEbsEncryptionByDefaultOutputError>) -> Void)
    /// <p>Disables fast snapshot restores for the specified snapshots in the specified Availability Zones.</p>
    func disableFastSnapshotRestores(input: DisableFastSnapshotRestoresInput, completion: @escaping (SdkResult<DisableFastSnapshotRestoresOutputResponse, DisableFastSnapshotRestoresOutputError>) -> Void)
    ...
    /// 				User Guide</i>.</p>
    func disableSerialConsoleAccess(input: DisableSerialConsoleAccessInput, completion: @escaping (SdkResult<DisableSerialConsoleAccessOutputResponse, DisableSerialConsoleAccessOutputError>) -> Void)
    /// <p>Disables the specified resource attachment from propagating routes to the specified
    ///          propagation route table.</p>
    func disableTransitGatewayRouteTablePropagation(input: DisableTransitGatewayRouteTablePropagationInput, completion: @escaping (SdkResult<DisableTransitGatewayRouteTablePropagationOutputResponse, DisableTransitGatewayRouteTablePropagationOutputError>) -> Void)
    /// <p>Disables a virtual private gateway (VGW) from propagating routes to a specified route table of a VPC.</p>
    func disableVgwRoutePropagation(input: DisableVgwRoutePropagationInput, completion: @escaping (SdkResult<DisableVgwRoutePropagationOutputResponse, DisableVgwRoutePropagationOutputError>) -> Void)
    /// <p>Disables ClassicLink for a VPC. You cannot disable ClassicLink for a VPC that has EC2-Classic instances linked to it.</p>
    func disableVpcClassicLink(input: DisableVpcClassicLinkInput, completion: @escaping (SdkResult<DisableVpcClassicLinkOutputResponse, DisableVpcClassicLinkOutputError>) -> Void)
    ...
    func disableVpcClassicLinkDnsSupport(input: DisableVpcClassicLinkDnsSupportInput, completion: @escaping (SdkResult<DisableVpcClassicLinkDnsSupportOutputResponse, DisableVpcClassicLinkDnsSupportOutputError>) -> Void)
    ...
    func disassociateAddress(input: DisassociateAddressInput, completion: @escaping (SdkResult<DisassociateAddressOutputResponse, DisassociateAddressOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func disassociateClientVpnTargetNetwork(input: DisassociateClientVpnTargetNetworkInput, completion: @escaping (SdkResult<DisassociateClientVpnTargetNetworkOutputResponse, DisassociateClientVpnTargetNetworkOutputError>) -> Void)
    ...
    func disassociateEnclaveCertificateIamRole(input: DisassociateEnclaveCertificateIamRoleInput, completion: @escaping (SdkResult<DisassociateEnclaveCertificateIamRoleOutputResponse, DisassociateEnclaveCertificateIamRoleOutputError>) -> Void)
    ...
    ///             ID.</p>
    func disassociateIamInstanceProfile(input: DisassociateIamInstanceProfileInput, completion: @escaping (SdkResult<DisassociateIamInstanceProfileOutputResponse, DisassociateIamInstanceProfileOutputError>) -> Void)
    ...
    func disassociateRouteTable(input: DisassociateRouteTableInput, completion: @escaping (SdkResult<DisassociateRouteTableOutputResponse, DisassociateRouteTableOutputError>) -> Void)
    ...
    func disassociateSubnetCidrBlock(input: DisassociateSubnetCidrBlockInput, completion: @escaping (SdkResult<DisassociateSubnetCidrBlockOutputResponse, DisassociateSubnetCidrBlockOutputError>) -> Void)
    /// <p>Disassociates the specified subnets from the transit gateway multicast domain. </p>
    func disassociateTransitGatewayMulticastDomain(input: DisassociateTransitGatewayMulticastDomainInput, completion: @escaping (SdkResult<DisassociateTransitGatewayMulticastDomainOutputResponse, DisassociateTransitGatewayMulticastDomainOutputError>) -> Void)
    /// <p>Disassociates a resource attachment from a transit gateway route table.</p>
    func disassociateTransitGatewayRouteTable(input: DisassociateTransitGatewayRouteTableInput, completion: @escaping (SdkResult<DisassociateTransitGatewayRouteTableOutputResponse, DisassociateTransitGatewayRouteTableOutputError>) -> Void)
    ...
    func disassociateVpcCidrBlock(input: DisassociateVpcCidrBlockInput, completion: @escaping (SdkResult<DisassociateVpcCidrBlockOutputResponse, DisassociateVpcCidrBlockOutputError>) -> Void)
    ...
    ///         instance types</a>.</p>
    func enableEbsEncryptionByDefault(input: EnableEbsEncryptionByDefaultInput, completion: @escaping (SdkResult<EnableEbsEncryptionByDefaultOutputResponse, EnableEbsEncryptionByDefaultOutputError>) -> Void)
    ...
    func enableFastSnapshotRestores(input: EnableFastSnapshotRestoresInput, completion: @escaping (SdkResult<EnableFastSnapshotRestoresOutputResponse, EnableFastSnapshotRestoresOutputError>) -> Void)
    ...
    /// 			in the <i>Amazon EC2 User Guide</i>.</p>
    func enableSerialConsoleAccess(input: EnableSerialConsoleAccessInput, completion: @escaping (SdkResult<EnableSerialConsoleAccessOutputResponse, EnableSerialConsoleAccessOutputError>) -> Void)
    /// <p>Enables the specified attachment to propagate routes to the specified
    ///          propagation route table.</p>
    func enableTransitGatewayRouteTablePropagation(input: EnableTransitGatewayRouteTablePropagationInput, completion: @escaping (SdkResult<EnableTransitGatewayRouteTablePropagationOutputResponse, EnableTransitGatewayRouteTablePropagationOutputError>) -> Void)
    /// <p>Enables a virtual private gateway (VGW) to propagate routes to the specified route table of a VPC.</p>
    func enableVgwRoutePropagation(input: EnableVgwRoutePropagationInput, completion: @escaping (SdkResult<EnableVgwRoutePropagationOutputResponse, EnableVgwRoutePropagationOutputError>) -> Void)
    ...
    func enableVolumeIO(input: EnableVolumeIOInput, completion: @escaping (SdkResult<EnableVolumeIOOutputResponse, EnableVolumeIOOutputError>) -> Void)
    ...
    /// 				<i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func enableVpcClassicLink(input: EnableVpcClassicLinkInput, completion: @escaping (SdkResult<EnableVpcClassicLinkOutputResponse, EnableVpcClassicLinkOutputError>) -> Void)
    ...
    /// 				<i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    ///          <p>You must specify a VPC ID in the request.</p>
    func enableVpcClassicLinkDnsSupport(input: EnableVpcClassicLinkDnsSupportInput, completion: @escaping (SdkResult<EnableVpcClassicLinkDnsSupportOutputResponse, EnableVpcClassicLinkDnsSupportOutputError>) -> Void)
    /// <p>Downloads the client certificate revocation list for the specified Client VPN endpoint.</p>
    func exportClientVpnClientCertificateRevocationList(input: ExportClientVpnClientCertificateRevocationListInput, completion: @escaping (SdkResult<ExportClientVpnClientCertificateRevocationListOutputResponse, ExportClientVpnClientCertificateRevocationListOutputError>) -> Void)
    ...
    func exportClientVpnClientConfiguration(input: ExportClientVpnClientConfigurationInput, completion: @escaping (SdkResult<ExportClientVpnClientConfigurationOutputResponse, ExportClientVpnClientConfigurationOutputError>) -> Void)
    ...
    func exportImage(input: ExportImageInput, completion: @escaping (SdkResult<ExportImageOutputResponse, ExportImageOutputError>) -> Void)
    ...
    func exportTransitGatewayRoutes(input: ExportTransitGatewayRoutesInput, completion: @escaping (SdkResult<ExportTransitGatewayRoutesOutputResponse, ExportTransitGatewayRoutesOutputError>) -> Void)
    ...
    func getAssociatedEnclaveCertificateIamRoles(input: GetAssociatedEnclaveCertificateIamRolesInput, completion: @escaping (SdkResult<GetAssociatedEnclaveCertificateIamRolesOutputResponse, GetAssociatedEnclaveCertificateIamRolesOutputError>) -> Void)
    /// <p>Gets information about the IPv6 CIDR block associations for a specified IPv6 address pool.</p>
    func getAssociatedIpv6PoolCidrs(input: GetAssociatedIpv6PoolCidrsInput, completion: @escaping (SdkResult<GetAssociatedIpv6PoolCidrsOutputResponse, GetAssociatedIpv6PoolCidrsOutputError>) -> Void)
    ...
    func getCapacityReservationUsage(input: GetCapacityReservationUsageInput, completion: @escaping (SdkResult<GetCapacityReservationUsageOutputResponse, GetCapacityReservationUsageOutputError>) -> Void)
    /// <p>Describes the allocations from the specified customer-owned address pool.</p>
    func getCoipPoolUsage(input: GetCoipPoolUsageInput, completion: @escaping (SdkResult<GetCoipPoolUsageOutputResponse, GetCoipPoolUsageOutputError>) -> Void)
    ...
    func getConsoleOutput(input: GetConsoleOutputInput, completion: @escaping (SdkResult<GetConsoleOutputOutputResponse, GetConsoleOutputOutputError>) -> Void)
    /// <p>Retrieve a JPG-format screenshot of a running instance to help with
    ///             troubleshooting.</p>
    ///         <p>The returned content is Base64-encoded.</p>
    func getConsoleScreenshot(input: GetConsoleScreenshotInput, completion: @escaping (SdkResult<GetConsoleScreenshotOutputResponse, GetConsoleScreenshotOutputError>) -> Void)
    /// <p>Describes the default credit option for CPU usage of a burstable performance instance family.</p>
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html">Burstable
    ///             performance instances</a> in the <i>Amazon EC2 User Guide</i>.</p>
    func getDefaultCreditSpecification(input: GetDefaultCreditSpecificationInput, completion: @escaping (SdkResult<GetDefaultCreditSpecificationOutputResponse, GetDefaultCreditSpecificationOutputError>) -> Void)
    ...
    ///       in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func getEbsDefaultKmsKeyId(input: GetEbsDefaultKmsKeyIdInput, completion: @escaping (SdkResult<GetEbsDefaultKmsKeyIdOutputResponse, GetEbsDefaultKmsKeyIdOutputError>) -> Void)
    /// <p>Describes whether EBS encryption by default is enabled for your account in the current
    ///       Region.</p>
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html">Amazon EBS encryption</a>
    ///       in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func getEbsEncryptionByDefault(input: GetEbsEncryptionByDefaultInput, completion: @escaping (SdkResult<GetEbsEncryptionByDefaultOutputResponse, GetEbsEncryptionByDefaultOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func getFlowLogsIntegrationTemplate(input: GetFlowLogsIntegrationTemplateInput, completion: @escaping (SdkResult<GetFlowLogsIntegrationTemplateOutputResponse, GetFlowLogsIntegrationTemplateOutputError>) -> Void)
    /// <p>Lists the resource groups to which a Capacity Reservation has been added.</p>
    func getGroupsForCapacityReservation(input: GetGroupsForCapacityReservationInput, completion: @escaping (SdkResult<GetGroupsForCapacityReservationOutputResponse, GetGroupsForCapacityReservationOutputError>) -> Void)
    ...
    func getHostReservationPurchasePreview(input: GetHostReservationPurchasePreviewInput, completion: @escaping (SdkResult<GetHostReservationPurchasePreviewOutputResponse, GetHostReservationPurchasePreviewOutputError>) -> Void)
    ...
    func getLaunchTemplateData(input: GetLaunchTemplateDataInput, completion: @escaping (SdkResult<GetLaunchTemplateDataOutputResponse, GetLaunchTemplateDataOutputError>) -> Void)
    /// <p>Gets information about the resources that are associated with the specified managed prefix list.</p>
    func getManagedPrefixListAssociations(input: GetManagedPrefixListAssociationsInput, completion: @escaping (SdkResult<GetManagedPrefixListAssociationsOutputResponse, GetManagedPrefixListAssociationsOutputError>) -> Void)
    /// <p>Gets information about the entries for a specified managed prefix list.</p>
    func getManagedPrefixListEntries(input: GetManagedPrefixListEntriesInput, completion: @escaping (SdkResult<GetManagedPrefixListEntriesOutputResponse, GetManagedPrefixListEntriesOutputError>) -> Void)
    ...
    func getPasswordData(input: GetPasswordDataInput, completion: @escaping (SdkResult<GetPasswordDataOutputResponse, GetPasswordDataOutputError>) -> Void)
    ...
    func getReservedInstancesExchangeQuote(input: GetReservedInstancesExchangeQuoteInput, completion: @escaping (SdkResult<GetReservedInstancesExchangeQuoteOutputResponse, GetReservedInstancesExchangeQuoteOutputError>) -> Void)
    ...
    /// 				User Guide</i>.</p>
    func getSerialConsoleAccessStatus(input: GetSerialConsoleAccessStatusInput, completion: @escaping (SdkResult<GetSerialConsoleAccessStatusOutputResponse, GetSerialConsoleAccessStatusOutputError>) -> Void)
    /// <p>Lists the route tables to which the specified resource attachment propagates routes.</p>
    func getTransitGatewayAttachmentPropagations(input: GetTransitGatewayAttachmentPropagationsInput, completion: @escaping (SdkResult<GetTransitGatewayAttachmentPropagationsOutputResponse, GetTransitGatewayAttachmentPropagationsOutputError>) -> Void)
    /// <p>Gets information about the associations for the transit gateway multicast domain.</p>
    func getTransitGatewayMulticastDomainAssociations(input: GetTransitGatewayMulticastDomainAssociationsInput, completion: @escaping (SdkResult<GetTransitGatewayMulticastDomainAssociationsOutputResponse, GetTransitGatewayMulticastDomainAssociationsOutputError>) -> Void)
    /// <p>Gets information about the prefix list references in a specified transit gateway route table.</p>
    func getTransitGatewayPrefixListReferences(input: GetTransitGatewayPrefixListReferencesInput, completion: @escaping (SdkResult<GetTransitGatewayPrefixListReferencesOutputResponse, GetTransitGatewayPrefixListReferencesOutputError>) -> Void)
    /// <p>Gets information about the associations for the specified transit gateway route table.</p>
    func getTransitGatewayRouteTableAssociations(input: GetTransitGatewayRouteTableAssociationsInput, completion: @escaping (SdkResult<GetTransitGatewayRouteTableAssociationsOutputResponse, GetTransitGatewayRouteTableAssociationsOutputError>) -> Void)
    /// <p>Gets information about the route table propagations for the specified transit gateway route table.</p>
    func getTransitGatewayRouteTablePropagations(input: GetTransitGatewayRouteTablePropagationsInput, completion: @escaping (SdkResult<GetTransitGatewayRouteTablePropagationsOutputResponse, GetTransitGatewayRouteTablePropagationsOutputError>) -> Void)
    ...
    func importClientVpnClientCertificateRevocationList(input: ImportClientVpnClientCertificateRevocationListInput, completion: @escaping (SdkResult<ImportClientVpnClientCertificateRevocationListOutputResponse, ImportClientVpnClientCertificateRevocationListOutputError>) -> Void)
    ...
    func importImage(input: ImportImageInput, completion: @escaping (SdkResult<ImportImageOutputResponse, ImportImageOutputError>) -> Void)
    ...
    ///          <p>For information about the import manifest referenced by this API action, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/manifest.html">VM Import Manifest</a>.</p>
    func importInstance(input: ImportInstanceInput, completion: @escaping (SdkResult<ImportInstanceOutputResponse, ImportInstanceOutputError>) -> Void)
    ...
    ///    <i>VM Import/Export User Guide</i>.</p>
    func importSnapshot(input: ImportSnapshotInput, completion: @escaping (SdkResult<ImportSnapshotOutputResponse, ImportSnapshotOutputError>) -> Void)
    ...
    ///          <p>For information about the import manifest referenced by this API action, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/manifest.html">VM Import Manifest</a>.</p>
    func importVolume(input: ImportVolumeInput, completion: @escaping (SdkResult<ImportVolumeOutputResponse, ImportVolumeOutputError>) -> Void)
    ...
    func modifyAddressAttribute(input: ModifyAddressAttributeInput, completion: @escaping (SdkResult<ModifyAddressAttributeOutputResponse, ModifyAddressAttributeOutputError>) -> Void)
    ...
    func modifyAvailabilityZoneGroup(input: ModifyAvailabilityZoneGroupInput, completion: @escaping (SdkResult<ModifyAvailabilityZoneGroupOutputResponse, ModifyAvailabilityZoneGroupOutputError>) -> Void)
    ...
    func modifyCapacityReservation(input: ModifyCapacityReservationInput, completion: @escaping (SdkResult<ModifyCapacityReservationOutputResponse, ModifyCapacityReservationOutputError>) -> Void)
    /// <p>Modifies the specified Client VPN endpoint. Modifying the DNS server resets existing client connections.</p>
    func modifyClientVpnEndpoint(input: ModifyClientVpnEndpointInput, completion: @escaping (SdkResult<ModifyClientVpnEndpointOutputResponse, ModifyClientVpnEndpointOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html">Burstable
    ///             performance instances</a> in the <i>Amazon EC2 User Guide</i>.</p>
    func modifyDefaultCreditSpecification(input: ModifyDefaultCreditSpecificationInput, completion: @escaping (SdkResult<ModifyDefaultCreditSpecificationOutputResponse, ModifyDefaultCreditSpecificationOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html">Amazon EBS encryption</a>
    ///       in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func modifyEbsDefaultKmsKeyId(input: ModifyEbsDefaultKmsKeyIdInput, completion: @escaping (SdkResult<ModifyEbsDefaultKmsKeyIdOutputResponse, ModifyEbsDefaultKmsKeyIdOutputError>) -> Void)
    ...
    func modifyFleet(input: ModifyFleetInput, completion: @escaping (SdkResult<ModifyFleetOutputResponse, ModifyFleetOutputError>) -> Void)
    /// <p>Modifies the specified attribute of the specified Amazon FPGA Image (AFI).</p>
    func modifyFpgaImageAttribute(input: ModifyFpgaImageAttributeInput, completion: @escaping (SdkResult<ModifyFpgaImageAttributeOutputResponse, ModifyFpgaImageAttributeOutputError>) -> Void)
    ...
    func modifyHosts(input: ModifyHostsInput, completion: @escaping (SdkResult<ModifyHostsOutputResponse, ModifyHostsOutputError>) -> Void)
    ...
    func modifyIdentityIdFormat(input: ModifyIdentityIdFormatInput, completion: @escaping (SdkResult<ModifyIdentityIdFormatOutputResponse, ModifyIdentityIdFormatOutputError>) -> Void)
    ...
    func modifyIdFormat(input: ModifyIdFormatInput, completion: @escaping (SdkResult<ModifyIdFormatOutputResponse, ModifyIdFormatOutputError>) -> Void)
    ...
    func modifyImageAttribute(input: ModifyImageAttributeInput, completion: @escaping (SdkResult<ModifyImageAttributeOutputResponse, ModifyImageAttributeOutputError>) -> Void)
    ...
    func modifyInstanceAttribute(input: ModifyInstanceAttributeInput, completion: @escaping (SdkResult<ModifyInstanceAttributeOutputResponse, ModifyInstanceAttributeOutputError>) -> Void)
    ...
    func modifyInstanceCapacityReservationAttributes(input: ModifyInstanceCapacityReservationAttributesInput, completion: @escaping (SdkResult<ModifyInstanceCapacityReservationAttributesOutputResponse, ModifyInstanceCapacityReservationAttributesOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html">Burstable
    ///                 performance instances</a> in the <i>Amazon EC2 User Guide</i>.</p>
    func modifyInstanceCreditSpecification(input: ModifyInstanceCreditSpecificationInput, completion: @escaping (SdkResult<ModifyInstanceCreditSpecificationOutputResponse, ModifyInstanceCreditSpecificationOutputError>) -> Void)
    /// <p>Modifies the start time for a scheduled Amazon EC2 instance event.</p>
    func modifyInstanceEventStartTime(input: ModifyInstanceEventStartTimeInput, completion: @escaping (SdkResult<ModifyInstanceEventStartTimeOutputResponse, ModifyInstanceEventStartTimeOutputError>) -> Void)
    ...
    ///           in the <i>Amazon EC2 User Guide</i>.</p>
    func modifyInstanceMetadataOptions(input: ModifyInstanceMetadataOptionsInput, completion: @escaping (SdkResult<ModifyInstanceMetadataOptionsOutputResponse, ModifyInstanceMetadataOptionsOutputError>) -> Void)
    ...
    func modifyInstancePlacement(input: ModifyInstancePlacementInput, completion: @escaping (SdkResult<ModifyInstancePlacementOutputResponse, ModifyInstancePlacementOutputError>) -> Void)
    ...
    func modifyLaunchTemplate(input: ModifyLaunchTemplateInput, completion: @escaping (SdkResult<ModifyLaunchTemplateOutputResponse, ModifyLaunchTemplateOutputError>) -> Void)
    ...
    func modifyManagedPrefixList(input: ModifyManagedPrefixListInput, completion: @escaping (SdkResult<ModifyManagedPrefixListOutputResponse, ModifyManagedPrefixListOutputError>) -> Void)
    ...
    func modifyNetworkInterfaceAttribute(input: ModifyNetworkInterfaceAttributeInput, completion: @escaping (SdkResult<ModifyNetworkInterfaceAttributeOutputResponse, ModifyNetworkInterfaceAttributeOutputError>) -> Void)
    ...
    /// 				Instances</a> in the <i>Amazon EC2 User Guide</i>.</p>
    func modifyReservedInstances(input: ModifyReservedInstancesInput, completion: @escaping (SdkResult<ModifyReservedInstancesOutputResponse, ModifyReservedInstancesOutputError>) -> Void)
    ...
    ///         <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func modifySnapshotAttribute(input: ModifySnapshotAttributeInput, completion: @escaping (SdkResult<ModifySnapshotAttributeOutputResponse, ModifySnapshotAttributeOutputError>) -> Void)
    ...
    ///        target capacity to 0.</p>
    func modifySpotFleetRequest(input: ModifySpotFleetRequestInput, completion: @escaping (SdkResult<ModifySpotFleetRequestOutputResponse, ModifySpotFleetRequestOutputError>) -> Void)
    /// <p>Modifies a subnet attribute. You can only modify one attribute at a time.</p>
    func modifySubnetAttribute(input: ModifySubnetAttributeInput, completion: @escaping (SdkResult<ModifySubnetAttributeOutputResponse, ModifySubnetAttributeOutputError>) -> Void)
    ...
    func modifyTrafficMirrorFilterNetworkServices(input: ModifyTrafficMirrorFilterNetworkServicesInput, completion: @escaping (SdkResult<ModifyTrafficMirrorFilterNetworkServicesOutputResponse, ModifyTrafficMirrorFilterNetworkServicesOutputError>) -> Void)
    ...
    func modifyTrafficMirrorFilterRule(input: ModifyTrafficMirrorFilterRuleInput, completion: @escaping (SdkResult<ModifyTrafficMirrorFilterRuleOutputResponse, ModifyTrafficMirrorFilterRuleOutputError>) -> Void)
    /// <p>Modifies a Traffic Mirror session.</p>
    func modifyTrafficMirrorSession(input: ModifyTrafficMirrorSessionInput, completion: @escaping (SdkResult<ModifyTrafficMirrorSessionOutputResponse, ModifyTrafficMirrorSessionOutputError>) -> Void)
    ...
    func modifyTransitGateway(input: ModifyTransitGatewayInput, completion: @escaping (SdkResult<ModifyTransitGatewayOutputResponse, ModifyTransitGatewayOutputError>) -> Void)
    /// <p>Modifies a reference (route) to a prefix list in a specified transit gateway route table.</p>
    func modifyTransitGatewayPrefixListReference(input: ModifyTransitGatewayPrefixListReferenceInput, completion: @escaping (SdkResult<ModifyTransitGatewayPrefixListReferenceOutputResponse, ModifyTransitGatewayPrefixListReferenceOutputError>) -> Void)
    /// <p>Modifies the specified VPC attachment.</p>
    func modifyTransitGatewayVpcAttachment(input: ModifyTransitGatewayVpcAttachmentInput, completion: @escaping (SdkResult<ModifyTransitGatewayVpcAttachmentOutputResponse, ModifyTransitGatewayVpcAttachmentOutputError>) -> Void)
    ...
    func modifyVolume(input: ModifyVolumeInput, completion: @escaping (SdkResult<ModifyVolumeOutputResponse, ModifyVolumeOutputError>) -> Void)
    ...
    func modifyVolumeAttribute(input: ModifyVolumeAttributeInput, completion: @escaping (SdkResult<ModifyVolumeAttributeOutputResponse, ModifyVolumeAttributeOutputError>) -> Void)
    /// <p>Modifies the specified attribute of the specified VPC.</p>
    func modifyVpcAttribute(input: ModifyVpcAttributeInput, completion: @escaping (SdkResult<ModifyVpcAttributeOutputResponse, ModifyVpcAttributeOutputError>) -> Void)
    ...
    func modifyVpcEndpoint(input: ModifyVpcEndpointInput, completion: @escaping (SdkResult<ModifyVpcEndpointOutputResponse, ModifyVpcEndpointOutputError>) -> Void)
    ...
    func modifyVpcEndpointConnectionNotification(input: ModifyVpcEndpointConnectionNotificationInput, completion: @escaping (SdkResult<ModifyVpcEndpointConnectionNotificationOutputResponse, ModifyVpcEndpointConnectionNotificationOutputError>) -> Void)
    ...
    ///                 Private DNS Name Verification</a> in the
    ///             <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func modifyVpcEndpointServiceConfiguration(input: ModifyVpcEndpointServiceConfigurationInput, completion: @escaping (SdkResult<ModifyVpcEndpointServiceConfigurationOutputResponse, ModifyVpcEndpointServiceConfigurationOutputError>) -> Void)
    ...
    func modifyVpcEndpointServicePermissions(input: ModifyVpcEndpointServicePermissionsInput, completion: @escaping (SdkResult<ModifyVpcEndpointServicePermissionsOutputResponse, ModifyVpcEndpointServicePermissionsOutputError>) -> Void)
    ...
    func modifyVpcPeeringConnectionOptions(input: ModifyVpcPeeringConnectionOptionsInput, completion: @escaping (SdkResult<ModifyVpcPeeringConnectionOptionsOutputResponse, ModifyVpcPeeringConnectionOptionsOutputError>) -> Void)
    ...
    /// 				<i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func modifyVpcTenancy(input: ModifyVpcTenancyInput, completion: @escaping (SdkResult<ModifyVpcTenancyOutputResponse, ModifyVpcTenancyOutputError>) -> Void)
    ...
    func modifyVpnConnection(input: ModifyVpnConnectionInput, completion: @escaping (SdkResult<ModifyVpnConnectionOutputResponse, ModifyVpnConnectionOutputError>) -> Void)
    ...
    func modifyVpnConnectionOptions(input: ModifyVpnConnectionOptionsInput, completion: @escaping (SdkResult<ModifyVpnConnectionOptionsOutputResponse, ModifyVpnConnectionOptionsOutputError>) -> Void)
    /// <p>Modifies the VPN tunnel endpoint certificate.</p>
    func modifyVpnTunnelCertificate(input: ModifyVpnTunnelCertificateInput, completion: @escaping (SdkResult<ModifyVpnTunnelCertificateOutputResponse, ModifyVpnTunnelCertificateOutputError>) -> Void)
    ...
    func modifyVpnTunnelOptions(input: ModifyVpnTunnelOptionsInput, completion: @escaping (SdkResult<ModifyVpnTunnelOptionsOutputResponse, ModifyVpnTunnelOptionsOutputError>) -> Void)
    ...
    func monitorInstances(input: MonitorInstancesInput, completion: @escaping (SdkResult<MonitorInstancesOutputResponse, MonitorInstancesOutputError>) -> Void)
    ...
    func moveAddressToVpc(input: MoveAddressToVpcInput, completion: @escaping (SdkResult<MoveAddressToVpcOutputResponse, MoveAddressToVpcOutputError>) -> Void)
    ...
    ///             account.</p>
    func purchaseHostReservation(input: PurchaseHostReservationInput, completion: @escaping (SdkResult<PurchaseHostReservationOutputResponse, PurchaseHostReservationOutputError>) -> Void)
    ...
    ///    	   <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-market-general.html">Reserved Instance Marketplace</a>
    ///    	   in the <i>Amazon EC2 User Guide</i>.</p>
    func purchaseReservedInstancesOffering(input: PurchaseReservedInstancesOfferingInput, completion: @escaping (SdkResult<PurchaseReservedInstancesOfferingOutputResponse, PurchaseReservedInstancesOfferingOutputError>) -> Void)
    ...
    func purchaseScheduledInstances(input: PurchaseScheduledInstancesInput, completion: @escaping (SdkResult<PurchaseScheduledInstancesOutputResponse, PurchaseScheduledInstancesOutputError>) -> Void)
    ...
    func rebootInstances(input: RebootInstancesInput, completion: @escaping (SdkResult<RebootInstancesOutputResponse, RebootInstancesOutputError>) -> Void)
    ...
    func registerImage(input: RegisterImageInput, completion: @escaping (SdkResult<RegisterImageOutputResponse, RegisterImageOutputError>) -> Void)
    /// <p>Registers a set of tag keys to include in scheduled event notifications for your resources.
    ///    		</p>
    ///          <p>To remove tags, use .</p>
    func registerInstanceEventNotificationAttributes(input: RegisterInstanceEventNotificationAttributesInput, completion: @escaping (SdkResult<RegisterInstanceEventNotificationAttributesOutputResponse, RegisterInstanceEventNotificationAttributesOutputError>) -> Void)
    ...
    func registerTransitGatewayMulticastGroupMembers(input: RegisterTransitGatewayMulticastGroupMembersInput, completion: @escaping (SdkResult<RegisterTransitGatewayMulticastGroupMembersOutputResponse, RegisterTransitGatewayMulticastGroupMembersOutputError>) -> Void)
    ...
    ///             group.</p>
    func registerTransitGatewayMulticastGroupSources(input: RegisterTransitGatewayMulticastGroupSourcesInput, completion: @escaping (SdkResult<RegisterTransitGatewayMulticastGroupSourcesOutputResponse, RegisterTransitGatewayMulticastGroupSourcesOutputError>) -> Void)
    /// <p>Rejects a request to associate cross-account subnets with a transit gateway multicast domain.</p>
    func rejectTransitGatewayMulticastDomainAssociations(input: RejectTransitGatewayMulticastDomainAssociationsInput, completion: @escaping (SdkResult<RejectTransitGatewayMulticastDomainAssociationsOutputResponse, RejectTransitGatewayMulticastDomainAssociationsOutputError>) -> Void)
    /// <p>Rejects a transit gateway peering attachment request.</p>
    func rejectTransitGatewayPeeringAttachment(input: RejectTransitGatewayPeeringAttachmentInput, completion: @escaping (SdkResult<RejectTransitGatewayPeeringAttachmentOutputResponse, RejectTransitGatewayPeeringAttachmentOutputError>) -> Void)
    ...
    func rejectTransitGatewayVpcAttachment(input: RejectTransitGatewayVpcAttachmentInput, completion: @escaping (SdkResult<RejectTransitGatewayVpcAttachmentOutputResponse, RejectTransitGatewayVpcAttachmentOutputError>) -> Void)
    /// <p>Rejects one or more VPC endpoint connection requests to your VPC endpoint
    ///             service.</p>
    func rejectVpcEndpointConnections(input: RejectVpcEndpointConnectionsInput, completion: @escaping (SdkResult<RejectVpcEndpointConnectionsOutputResponse, RejectVpcEndpointConnectionsOutputError>) -> Void)
    ...
    func rejectVpcPeeringConnection(input: RejectVpcPeeringConnectionInput, completion: @escaping (SdkResult<RejectVpcPeeringConnectionOutputResponse, RejectVpcPeeringConnectionOutputError>) -> Void)
    ...
    func releaseAddress(input: ReleaseAddressInput, completion: @escaping (SdkResult<ReleaseAddressOutputResponse, ReleaseAddressOutputError>) -> Void)
    ...
    func releaseHosts(input: ReleaseHostsInput, completion: @escaping (SdkResult<ReleaseHostsOutputResponse, ReleaseHostsOutputError>) -> Void)
    ...
    ///         <p>Use <a>DescribeIamInstanceProfileAssociations</a> to get the association
    ///             ID.</p>
    func replaceIamInstanceProfileAssociation(input: ReplaceIamInstanceProfileAssociationInput, completion: @escaping (SdkResult<ReplaceIamInstanceProfileAssociationOutputResponse, ReplaceIamInstanceProfileAssociationOutputError>) -> Void)
    ...
    func replaceNetworkAclAssociation(input: ReplaceNetworkAclAssociationInput, completion: @escaping (SdkResult<ReplaceNetworkAclAssociationOutputResponse, ReplaceNetworkAclAssociationOutputError>) -> Void)
    ...
    /// 				<i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func replaceNetworkAclEntry(input: ReplaceNetworkAclEntryInput, completion: @escaping (SdkResult<ReplaceNetworkAclEntryOutputResponse, ReplaceNetworkAclEntryOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html">Route Tables</a> in the
    ///                 <i>Amazon Virtual Private Cloud User Guide</i>.</p>
    func replaceRoute(input: ReplaceRouteInput, completion: @escaping (SdkResult<ReplaceRouteOutputResponse, ReplaceRouteOutputError>) -> Void)
    ...
    func replaceRouteTableAssociation(input: ReplaceRouteTableAssociationInput, completion: @escaping (SdkResult<ReplaceRouteTableAssociationOutputResponse, ReplaceRouteTableAssociationOutputError>) -> Void)
    /// <p>Replaces the specified route in the specified transit gateway route table.</p>
    func replaceTransitGatewayRoute(input: ReplaceTransitGatewayRouteInput, completion: @escaping (SdkResult<ReplaceTransitGatewayRouteOutputResponse, ReplaceTransitGatewayRouteOutputError>) -> Void)
    ...
    func reportInstanceStatus(input: ReportInstanceStatusInput, completion: @escaping (SdkResult<ReportInstanceStatusOutputResponse, ReportInstanceStatusOutputError>) -> Void)
    ...
    ///        in the <i>Amazon EC2 User Guide for Linux Instances</i>.</p>
    func requestSpotFleet(input: RequestSpotFleetInput, completion: @escaping (SdkResult<RequestSpotFleetOutputResponse, RequestSpotFleetOutputError>) -> Void)
    ...
    func requestSpotInstances(input: RequestSpotInstancesInput, completion: @escaping (SdkResult<RequestSpotInstancesOutputResponse, RequestSpotInstancesOutputError>) -> Void)
    ...
    func resetAddressAttribute(input: ResetAddressAttributeInput, completion: @escaping (SdkResult<ResetAddressAttributeOutputResponse, ResetAddressAttributeOutputError>) -> Void)
    ...
    ///       in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func resetEbsDefaultKmsKeyId(input: ResetEbsDefaultKmsKeyIdInput, completion: @escaping (SdkResult<ResetEbsDefaultKmsKeyIdOutputResponse, ResetEbsDefaultKmsKeyIdOutputError>) -> Void)
    ...
    func resetFpgaImageAttribute(input: ResetFpgaImageAttributeInput, completion: @escaping (SdkResult<ResetFpgaImageAttributeOutputResponse, ResetFpgaImageAttributeOutputError>) -> Void)
    /// <p>Resets an attribute of an AMI to its default value.</p>
    ///          <note>
    ///             <p>The productCodes attribute can't be reset.</p>
    ///          </note>
    func resetImageAttribute(input: ResetImageAttributeInput, completion: @escaping (SdkResult<ResetImageAttributeOutputResponse, ResetImageAttributeOutputError>) -> Void)
    ...
    func resetInstanceAttribute(input: ResetInstanceAttributeInput, completion: @escaping (SdkResult<ResetInstanceAttributeOutputResponse, ResetInstanceAttributeOutputError>) -> Void)
    /// <p>Resets a network interface attribute. You can specify only one attribute at a time.</p>
    func resetNetworkInterfaceAttribute(input: ResetNetworkInterfaceAttributeInput, completion: @escaping (SdkResult<ResetNetworkInterfaceAttributeOutputResponse, ResetNetworkInterfaceAttributeOutputError>) -> Void)
    /// <p>Resets permission settings for the specified snapshot.</p>
    ///          <p>For more information about modifying snapshot permissions, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-modifying-snapshot-permissions.html">Sharing snapshots</a> in the
    ///         <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
    func resetSnapshotAttribute(input: ResetSnapshotAttributeInput, completion: @escaping (SdkResult<ResetSnapshotAttributeOutputResponse, ResetSnapshotAttributeOutputError>) -> Void)
    ...
    func restoreAddressToClassic(input: RestoreAddressToClassicInput, completion: @escaping (SdkResult<RestoreAddressToClassicOutputResponse, RestoreAddressToClassicOutputError>) -> Void)
    /// <p>Restores the entries from a previous version of a managed prefix list to a new version of the prefix list.</p>
    func restoreManagedPrefixListVersion(input: RestoreManagedPrefixListVersionInput, completion: @escaping (SdkResult<RestoreManagedPrefixListVersionOutputResponse, RestoreManagedPrefixListVersionOutputError>) -> Void)
    /// <p>Removes an ingress authorization rule from a Client VPN endpoint. </p>
    func revokeClientVpnIngress(input: RevokeClientVpnIngressInput, completion: @escaping (SdkResult<RevokeClientVpnIngressOutputResponse, RevokeClientVpnIngressOutputError>) -> Void)
    ...
    func revokeSecurityGroupEgress(input: RevokeSecurityGroupEgressInput, completion: @escaping (SdkResult<RevokeSecurityGroupEgressOutputResponse, RevokeSecurityGroupEgressOutputError>) -> Void)
    ...
    ///          <p>Rule changes are propagated to instances within the security group as quickly as possible. However, a small delay might occur.</p>
    func revokeSecurityGroupIngress(input: RevokeSecurityGroupIngressInput, completion: @escaping (SdkResult<RevokeSecurityGroupIngressOutputResponse, RevokeSecurityGroupIngressOutputError>) -> Void)
    ...
    func runInstances(input: RunInstancesInput, completion: @escaping (SdkResult<RunInstancesOutputResponse, RunInstancesOutputError>) -> Void)
    ...
    ///          in the <i>Amazon EC2 User Guide</i>.</p>
    func runScheduledInstances(input: RunScheduledInstancesInput, completion: @escaping (SdkResult<RunScheduledInstancesOutputResponse, RunScheduledInstancesOutputError>) -> Void)
    /// <p>Searches for routes in the specified local gateway route table.</p>
    func searchLocalGatewayRoutes(input: SearchLocalGatewayRoutesInput, completion: @escaping (SdkResult<SearchLocalGatewayRoutesOutputResponse, SearchLocalGatewayRoutesOutputError>) -> Void)
    /// <p>Searches one or more  transit gateway multicast groups and returns the group membership information.</p>
    func searchTransitGatewayMulticastGroups(input: SearchTransitGatewayMulticastGroupsInput, completion: @escaping (SdkResult<SearchTransitGatewayMulticastGroupsOutputResponse, SearchTransitGatewayMulticastGroupsOutputError>) -> Void)
    /// <p>Searches for routes in the specified transit gateway route table.</p>
    func searchTransitGatewayRoutes(input: SearchTransitGatewayRoutesInput, completion: @escaping (SdkResult<SearchTransitGatewayRoutesOutputResponse, SearchTransitGatewayRoutesOutputError>) -> Void)
    ...
    func sendDiagnosticInterrupt(input: SendDiagnosticInterruptInput, completion: @escaping (SdkResult<SendDiagnosticInterruptOutputResponse, SendDiagnosticInterruptOutputError>) -> Void)
    ...
    ///                 <i>Amazon EC2 User Guide</i>.</p>
    func startInstances(input: StartInstancesInput, completion: @escaping (SdkResult<StartInstancesOutputResponse, StartInstancesOutputError>) -> Void)
    /// <p>Starts analyzing the specified path. If the path is reachable, the
    ///          operation returns the shortest feasible path.</p>
    func startNetworkInsightsAnalysis(input: StartNetworkInsightsAnalysisInput, completion: @escaping (SdkResult<StartNetworkInsightsAnalysisOutputResponse, StartNetworkInsightsAnalysisOutputError>) -> Void)
    ...
    func startVpcEndpointServicePrivateDnsVerification(input: StartVpcEndpointServicePrivateDnsVerificationInput, completion: @escaping (SdkResult<StartVpcEndpointServicePrivateDnsVerificationOutputResponse, StartVpcEndpointServicePrivateDnsVerificationOutputError>) -> Void)
    ...
    func stopInstances(input: StopInstancesInput, completion: @escaping (SdkResult<StopInstancesOutputResponse, StopInstancesOutputError>) -> Void)
    ...
    func terminateClientVpnConnections(input: TerminateClientVpnConnectionsInput, completion: @escaping (SdkResult<TerminateClientVpnConnectionsOutputResponse, TerminateClientVpnConnectionsOutputError>) -> Void)
    ...
    func terminateInstances(input: TerminateInstancesInput, completion: @escaping (SdkResult<TerminateInstancesOutputResponse, TerminateInstancesOutputError>) -> Void)
    /// <p>Unassigns one or more IPv6 addresses from a network interface.</p>
    func unassignIpv6Addresses(input: UnassignIpv6AddressesInput, completion: @escaping (SdkResult<UnassignIpv6AddressesOutputResponse, UnassignIpv6AddressesOutputError>) -> Void)
    /// <p>Unassigns one or more secondary private IP addresses from a network interface.</p>
    func unassignPrivateIpAddresses(input: UnassignPrivateIpAddressesInput, completion: @escaping (SdkResult<UnassignPrivateIpAddressesOutputResponse, UnassignPrivateIpAddressesOutputError>) -> Void)
    ...
    func unmonitorInstances(input: UnmonitorInstancesInput, completion: @escaping (SdkResult<UnmonitorInstancesOutputResponse, UnmonitorInstancesOutputError>) -> Void)
    ...
    /// 			request.</p>
    func updateSecurityGroupRuleDescriptionsEgress(input: UpdateSecurityGroupRuleDescriptionsEgressInput, completion: @escaping (SdkResult<UpdateSecurityGroupRuleDescriptionsEgressOutputResponse, UpdateSecurityGroupRuleDescriptionsEgressOutputError>) -> Void)
    ...
    /// 			description for a security group rule by omitting the description parameter in the
    /// 			request.</p>
    func updateSecurityGroupRuleDescriptionsIngress(input: UpdateSecurityGroupRuleDescriptionsIngressInput, completion: @escaping (SdkResult<UpdateSecurityGroupRuleDescriptionsIngressOutputResponse, UpdateSecurityGroupRuleDescriptionsIngressOutputError>) -> Void)
