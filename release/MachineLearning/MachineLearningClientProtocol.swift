...
public protocol MachineLearningClientProtocol {
    ...
    func createBatchPrediction(input: CreateBatchPredictionInput, completion: @escaping (SdkResult<CreateBatchPredictionOutput, CreateBatchPredictionOutputError>) -> Void)
    ...
    ///         </p>
    func createDataSourceFromRDS(input: CreateDataSourceFromRDSInput, completion: @escaping (SdkResult<CreateDataSourceFromRDSOutput, CreateDataSourceFromRDSOutputError>) -> Void)
    ...
    func createDataSourceFromRedshift(input: CreateDataSourceFromRedshiftInput, completion: @escaping (SdkResult<CreateDataSourceFromRedshiftOutput, CreateDataSourceFromRedshiftOutputError>) -> Void)
    ...
    ///             for example, will it be combined with another variable or will it be split apart into
    ///             word combinations? The recipe provides answers to these questions.</p>
    func createDataSourceFromS3(input: CreateDataSourceFromS3Input, completion: @escaping (SdkResult<CreateDataSourceFromS3Output, CreateDataSourceFromS3OutputError>) -> Void)
    ...
    func createEvaluation(input: CreateEvaluationInput, completion: @escaping (SdkResult<CreateEvaluationOutput, CreateEvaluationOutputError>) -> Void)
    ...
    ///         </p>
    func createMLModel(input: CreateMLModelInput, completion: @escaping (SdkResult<CreateMLModelOutput, CreateMLModelOutputError>) -> Void)
    ...
    func createRealtimeEndpoint(input: CreateRealtimeEndpointInput, completion: @escaping (SdkResult<CreateRealtimeEndpointOutput, CreateRealtimeEndpointOutputError>) -> Void)
    ...
    func deleteBatchPrediction(input: DeleteBatchPredictionInput, completion: @escaping (SdkResult<DeleteBatchPredictionOutput, DeleteBatchPredictionOutputError>) -> Void)
    ...
    func deleteEvaluation(input: DeleteEvaluationInput, completion: @escaping (SdkResult<DeleteEvaluationOutput, DeleteEvaluationOutputError>) -> Void)
    ...
    func deleteMLModel(input: DeleteMLModelInput, completion: @escaping (SdkResult<DeleteMLModelOutput, DeleteMLModelOutputError>) -> Void)
    /// <p>Deletes a real time endpoint of an <code>MLModel</code>.</p>
    func deleteRealtimeEndpoint(input: DeleteRealtimeEndpointInput, completion: @escaping (SdkResult<DeleteRealtimeEndpointOutput, DeleteRealtimeEndpointOutputError>) -> Void)
    ...
    func describeBatchPredictions(input: DescribeBatchPredictionsInput, completion: @escaping (SdkResult<DescribeBatchPredictionsOutput, DescribeBatchPredictionsOutputError>) -> Void)
    /// <p>Returns a list of <code>DataSource</code> that match the search criteria in the request.</p>
    func describeDataSources(input: DescribeDataSourcesInput, completion: @escaping (SdkResult<DescribeDataSourcesOutput, DescribeDataSourcesOutputError>) -> Void)
    /// <p>Returns a list of <code>DescribeEvaluations</code> that match the search criteria in the request.</p>
    func describeEvaluations(input: DescribeEvaluationsInput, completion: @escaping (SdkResult<DescribeEvaluationsOutput, DescribeEvaluationsOutputError>) -> Void)
    /// <p>Returns a list of <code>MLModel</code> that match the search criteria in the request.</p>
    func describeMLModels(input: DescribeMLModelsInput, completion: @escaping (SdkResult<DescribeMLModelsOutput, DescribeMLModelsOutputError>) -> Void)
    ...
    func getBatchPrediction(input: GetBatchPredictionInput, completion: @escaping (SdkResult<GetBatchPredictionOutput, GetBatchPredictionOutputError>) -> Void)
    ...
    func getEvaluation(input: GetEvaluationInput, completion: @escaping (SdkResult<GetEvaluationOutput, GetEvaluationOutputError>) -> Void)
    ...
    func getMLModel(input: GetMLModelInput, completion: @escaping (SdkResult<GetMLModelOutput, GetMLModelOutputError>) -> Void)
    ...
    func predict(input: PredictInput, completion: @escaping (SdkResult<PredictOutput, PredictOutputError>) -> Void)
    ...
    func updateBatchPrediction(input: UpdateBatchPredictionInput, completion: @escaping (SdkResult<UpdateBatchPredictionOutput, UpdateBatchPredictionOutputError>) -> Void)
    ...
    func updateEvaluation(input: UpdateEvaluationInput, completion: @escaping (SdkResult<UpdateEvaluationOutput, UpdateEvaluationOutputError>) -> Void)
    ...
    func updateMLModel(input: UpdateMLModelInput, completion: @escaping (SdkResult<UpdateMLModelOutput, UpdateMLModelOutputError>) -> Void)
}
