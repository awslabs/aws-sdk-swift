...
public class MachineLearningClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try MachineLearningClientConfiguration(region: unwrappedRegion)
    ...
    public class MachineLearningClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("MachineLearningClient")
...
public struct MachineLearningClientLogHandlerFactory: SDKLogHandlerFactory {
