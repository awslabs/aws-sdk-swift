...
public extension MachineLearningClient {
    ...
    {
        typealias createBatchPredictionContinuation = CheckedContinuation<CreateBatchPredictionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createBatchPredictionContinuation) in
            createBatchPrediction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createDataSourceFromRDSContinuation = CheckedContinuation<CreateDataSourceFromRDSOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createDataSourceFromRDSContinuation) in
            createDataSourceFromRDS(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createDataSourceFromRedshiftContinuation = CheckedContinuation<CreateDataSourceFromRedshiftOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createDataSourceFromRedshiftContinuation) in
            createDataSourceFromRedshift(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createDataSourceFromS3Continuation = CheckedContinuation<CreateDataSourceFromS3OutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createDataSourceFromS3Continuation) in
            createDataSourceFromS3(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createEvaluationContinuation = CheckedContinuation<CreateEvaluationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createEvaluationContinuation) in
            createEvaluation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createMLModelContinuation = CheckedContinuation<CreateMLModelOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createMLModelContinuation) in
            createMLModel(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createRealtimeEndpointContinuation = CheckedContinuation<CreateRealtimeEndpointOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createRealtimeEndpointContinuation) in
            createRealtimeEndpoint(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBatchPredictionContinuation = CheckedContinuation<DeleteBatchPredictionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBatchPredictionContinuation) in
            deleteBatchPrediction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteEvaluationContinuation = CheckedContinuation<DeleteEvaluationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteEvaluationContinuation) in
            deleteEvaluation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteMLModelContinuation = CheckedContinuation<DeleteMLModelOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteMLModelContinuation) in
            deleteMLModel(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteRealtimeEndpointContinuation = CheckedContinuation<DeleteRealtimeEndpointOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteRealtimeEndpointContinuation) in
            deleteRealtimeEndpoint(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeBatchPredictionsContinuation = CheckedContinuation<DescribeBatchPredictionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeBatchPredictionsContinuation) in
            describeBatchPredictions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeDataSourcesContinuation = CheckedContinuation<DescribeDataSourcesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeDataSourcesContinuation) in
            describeDataSources(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeEvaluationsContinuation = CheckedContinuation<DescribeEvaluationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeEvaluationsContinuation) in
            describeEvaluations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeMLModelsContinuation = CheckedContinuation<DescribeMLModelsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeMLModelsContinuation) in
            describeMLModels(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBatchPredictionContinuation = CheckedContinuation<GetBatchPredictionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBatchPredictionContinuation) in
            getBatchPrediction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getEvaluationContinuation = CheckedContinuation<GetEvaluationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getEvaluationContinuation) in
            getEvaluation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getMLModelContinuation = CheckedContinuation<GetMLModelOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getMLModelContinuation) in
            getMLModel(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias predictContinuation = CheckedContinuation<PredictOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: predictContinuation) in
    ...
    {
        typealias updateBatchPredictionContinuation = CheckedContinuation<UpdateBatchPredictionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateBatchPredictionContinuation) in
            updateBatchPrediction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateEvaluationContinuation = CheckedContinuation<UpdateEvaluationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateEvaluationContinuation) in
            updateEvaluation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateMLModelContinuation = CheckedContinuation<UpdateMLModelOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateMLModelContinuation) in
            updateMLModel(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
