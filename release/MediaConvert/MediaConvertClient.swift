...
extension MediaConvertClient: MediaConvertClientProtocol {
    ...
    public func associateCertificate(input: AssociateCertificateInput, completion: @escaping (SdkResult<AssociateCertificateOutput, AssociateCertificateOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<AssociateCertificateInput, AssociateCertificateOutput, AssociateCertificateOutputError>(id: "associateCertificate")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssociateCertificateInput, AssociateCertificateOutput, AssociateCertificateOutputError>(contentType: "application/json"))
    ...
    public func createJobTemplate(input: CreateJobTemplateInput, completion: @escaping (SdkResult<CreateJobTemplateOutput, CreateJobTemplateOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateJobTemplateInput, CreateJobTemplateOutput, CreateJobTemplateOutputError>(id: "createJobTemplate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateJobTemplateInput, CreateJobTemplateOutput, CreateJobTemplateOutputError>(contentType: "application/json"))
    ...
    public func createPreset(input: CreatePresetInput, completion: @escaping (SdkResult<CreatePresetOutput, CreatePresetOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreatePresetInput, CreatePresetOutput, CreatePresetOutputError>(id: "createPreset")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreatePresetInput, CreatePresetOutput, CreatePresetOutputError>(contentType: "application/json"))
    ...
    public func deleteJobTemplate(input: DeleteJobTemplateInput, completion: @escaping (SdkResult<DeleteJobTemplateOutput, DeleteJobTemplateOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteJobTemplateInput, DeleteJobTemplateOutput, DeleteJobTemplateOutputError>(id: "deleteJobTemplate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteJobTemplateInput, DeleteJobTemplateOutput, DeleteJobTemplateOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func deletePreset(input: DeletePresetInput, completion: @escaping (SdkResult<DeletePresetOutput, DeletePresetOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeletePresetInput, DeletePresetOutput, DeletePresetOutputError>(id: "deletePreset")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeletePresetInput, DeletePresetOutput, DeletePresetOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func deleteQueue(input: DeleteQueueInput, completion: @escaping (SdkResult<DeleteQueueOutput, DeleteQueueOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteQueueInput, DeleteQueueOutput, DeleteQueueOutputError>(id: "deleteQueue")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteQueueInput, DeleteQueueOutput, DeleteQueueOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeEndpoints(input: DescribeEndpointsInput, completion: @escaping (SdkResult<DescribeEndpointsOutput, DescribeEndpointsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeEndpointsInput, DescribeEndpointsOutput, DescribeEndpointsOutputError>(contentType: "application/json"))
    ...
    public func disassociateCertificate(input: DisassociateCertificateInput, completion: @escaping (SdkResult<DisassociateCertificateOutput, DisassociateCertificateOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DisassociateCertificateInput, DisassociateCertificateOutput, DisassociateCertificateOutputError>(id: "disassociateCertificate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DisassociateCertificateInput, DisassociateCertificateOutput, DisassociateCertificateOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getJobTemplate(input: GetJobTemplateInput, completion: @escaping (SdkResult<GetJobTemplateOutput, GetJobTemplateOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetJobTemplateInput, GetJobTemplateOutput, GetJobTemplateOutputError>(id: "getJobTemplate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetJobTemplateInput, GetJobTemplateOutput, GetJobTemplateOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getPreset(input: GetPresetInput, completion: @escaping (SdkResult<GetPresetOutput, GetPresetOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetPresetInput, GetPresetOutput, GetPresetOutputError>(id: "getPreset")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetPresetInput, GetPresetOutput, GetPresetOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getQueue(input: GetQueueInput, completion: @escaping (SdkResult<GetQueueOutput, GetQueueOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetQueueInput, GetQueueOutput, GetQueueOutputError>(id: "getQueue")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetQueueInput, GetQueueOutput, GetQueueOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listJobTemplates(input: ListJobTemplatesInput, completion: @escaping (SdkResult<ListJobTemplatesOutput, ListJobTemplatesOutputError>) -> Void)
    {
        let urlPath = "/2017-08-29/jobTemplates"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListJobTemplatesInput, ListJobTemplatesOutput, ListJobTemplatesOutputError>(id: "listJobTemplates")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListJobTemplatesInput, ListJobTemplatesOutput, ListJobTemplatesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listPresets(input: ListPresetsInput, completion: @escaping (SdkResult<ListPresetsOutput, ListPresetsOutputError>) -> Void)
    {
        let urlPath = "/2017-08-29/presets"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListPresetsInput, ListPresetsOutput, ListPresetsOutputError>(id: "listPresets")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListPresetsInput, ListPresetsOutput, ListPresetsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func updateJobTemplate(input: UpdateJobTemplateInput, completion: @escaping (SdkResult<UpdateJobTemplateOutput, UpdateJobTemplateOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateJobTemplateInput, UpdateJobTemplateOutput, UpdateJobTemplateOutputError>(id: "updateJobTemplate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateJobTemplateInput, UpdateJobTemplateOutput, UpdateJobTemplateOutputError>(contentType: "application/json"))
    ...
    public func updatePreset(input: UpdatePresetInput, completion: @escaping (SdkResult<UpdatePresetOutput, UpdatePresetOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdatePresetInput, UpdatePresetOutput, UpdatePresetOutputError>(id: "updatePreset")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdatePresetInput, UpdatePresetOutput, UpdatePresetOutputError>(contentType: "application/json"))
    ...
    public func updateQueue(input: UpdateQueueInput, completion: @escaping (SdkResult<UpdateQueueOutput, UpdateQueueOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mediaconvert")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateQueueInput, UpdateQueueOutput, UpdateQueueOutputError>(id: "updateQueue")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateQueueInput, UpdateQueueOutput, UpdateQueueOutputError>(contentType: "application/json"))
