...
extension ElasticTranscoderClientTypes {
    ...
    public struct Artwork: Swift.Equatable {
        ...
        var albumArtFormat: Swift.String?
        /// The encryption settings, if any, that you want Elastic Transcoder to apply to your artwork.
        var encryption: ElasticTranscoderClientTypes.Encryption?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct AudioParameters: Swift.Equatable {
        ...
        var audioPackingMode: Swift.String?
        /// The bit rate of the audio stream in the output file, in kilobits/second. Enter an integer between 64 and 320, inclusive.
        var bitRate: Swift.String?
        ...
        var codecOptions: ElasticTranscoderClientTypes.AudioCodecOptions?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct Captions: Swift.Equatable {
        ...
        var captionFormats: [ElasticTranscoderClientTypes.CaptionFormat]?
        /// Source files for the input sidecar captions used during the transcoding process. To omit all sidecar captions, leave CaptionSources blank.
        @available(*, deprecated)
        var captionSources: [ElasticTranscoderClientTypes.CaptionSource]?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct Clip: Swift.Equatable {
        ...
        var timeSpan: ElasticTranscoderClientTypes.TimeSpan?
...
public struct CreateJobInput: Swift.Equatable {
    ...
    var input: ElasticTranscoderClientTypes.JobInput?
    /// A section of the request body that provides information about the files that are being transcoded.
    var inputs: [ElasticTranscoderClientTypes.JobInput]?
    ...
    var output: ElasticTranscoderClientTypes.CreateJobOutput?
    /// The value, if any, that you want Elastic Transcoder to prepend to the names of all files that this job creates, including output files, thumbnails, and playlists.
    var outputKeyPrefix: Swift.String?
    /// A section of the request body that provides information about the transcoded (target) files. We recommend that you use the Outputs syntax instead of the Output syntax.
    var outputs: [ElasticTranscoderClientTypes.CreateJobOutput]?
    /// The Id of the pipeline that you want Elastic Transcoder to use for transcoding. The pipeline determines several settings, including the Amazon S3 bucket from which Elastic Transcoder gets the files to transcode and the bucket into which Elastic Transcoder puts the transcoded files.
    /// This member is required.
    var pipelineId: Swift.String?
    ...
    var playlists: [ElasticTranscoderClientTypes.CreateJobPlaylist]?
    /// User-defined metadata that you want to associate with an Elastic Transcoder job. You specify metadata in key/value pairs, and you can add up to 10 key/value pairs per job. Elastic Transcoder does not guarantee that key/value pairs are returned in the same order in which you specify them.
    var userMetadata: [Swift.String:Swift.String]?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct CreateJobOutput: Swift.Equatable {
        ...
        var albumArt: ElasticTranscoderClientTypes.JobAlbumArt?
        ...
        var captions: ElasticTranscoderClientTypes.Captions?
        /// You can create an output file that contains an excerpt from the input file. This excerpt, called a clip, can come from the beginning, middle, or end of the file. The Composition object contains settings for the clips that make up an output file. For the current release, you can only specify settings for a single clip per output file. The Composition object cannot be null.
        @available(*, deprecated)
        var composition: [ElasticTranscoderClientTypes.Clip]?
        ...
        var segmentDuration: Swift.String?
        /// The encryption settings, if any, that you want Elastic Transcoder to apply to your thumbnail.
        var thumbnailEncryption: ElasticTranscoderClientTypes.Encryption?
        ...
        var thumbnailPattern: Swift.String?
        /// Information about the watermarks that you want Elastic Transcoder to add to the video during transcoding. You can specify up to four watermarks for each output. Settings for each watermark must be defined in the preset for the current output.
        var watermarks: [ElasticTranscoderClientTypes.JobWatermark]?
...
public struct CreateJobOutputResponse: Swift.Equatable {
    ...
    var job: ElasticTranscoderClientTypes.Job?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct CreateJobPlaylist: Swift.Equatable {
        ...
        var hlsContentProtection: ElasticTranscoderClientTypes.HlsContentProtection?
        ...
        var outputKeys: [Swift.String]?
        /// The DRM settings, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.
        var playReadyDrm: ElasticTranscoderClientTypes.PlayReadyDrm?
...
public struct CreatePipelineInput: Swift.Equatable {
    ...
    var contentConfig: ElasticTranscoderClientTypes.PipelineOutputConfig?
    /// The Amazon S3 bucket in which you saved the media files that you want to transcode.
    /// This member is required.
    var inputBucket: Swift.String?
    ...
    var notifications: ElasticTranscoderClientTypes.Notifications?
    ...
    var thumbnailConfig: ElasticTranscoderClientTypes.PipelineOutputConfig?
...
public struct CreatePipelineOutputResponse: Swift.Equatable {
    ...
    var pipeline: ElasticTranscoderClientTypes.Pipeline?
    ...
    var warnings: [ElasticTranscoderClientTypes.Warning]?
...
public struct CreatePresetInput: Swift.Equatable {
    ...
    var audio: ElasticTranscoderClientTypes.AudioParameters?
    ...
    var thumbnails: ElasticTranscoderClientTypes.Thumbnails?
    /// A section of the request body that specifies the video parameters.
    var video: ElasticTranscoderClientTypes.VideoParameters?
...
public struct CreatePresetOutputResponse: Swift.Equatable {
    ...
    var preset: ElasticTranscoderClientTypes.Preset?
    /// If the preset settings don't comply with the standards for the video codec but Elastic Transcoder created the preset, this message explains the reason the preset settings don't meet the standard. Elastic Transcoder created the preset because the settings might produce acceptable output.
    var warning: Swift.String?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct DetectedProperties: Swift.Equatable {
        ...
        var durationMillis: Swift.Int?
        /// The detected file size of the input file, in bytes.
        var fileSize: Swift.Int?
        /// The detected frame rate of the input file, in frames per second.
        var frameRate: Swift.String?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct Encryption: Swift.Equatable {
        ...
        var initializationVector: Swift.String?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct HlsContentProtection: Swift.Equatable {
        ...
        var keyStoragePolicy: Swift.String?
        /// The location of the license key required to decrypt your HLS playlist. The URL must be an absolute path, and is referenced in the URI attribute of the EXT-X-KEY metadata tag in the playlist file.
        var licenseAcquisitionUrl: Swift.String?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct Job: Swift.Equatable {
        ...
        var output: ElasticTranscoderClientTypes.JobOutput?
        ...
        var outputs: [ElasticTranscoderClientTypes.JobOutput]?
        /// The Id of the pipeline that you want Elastic Transcoder to use for transcoding. The pipeline determines several settings, including the Amazon S3 bucket from which Elastic Transcoder gets the files to transcode and the bucket into which Elastic Transcoder puts the transcoded files.
        var pipelineId: Swift.String?
        ...
        var playlists: [ElasticTranscoderClientTypes.Playlist]?
        /// The status of the job: Submitted, Progressing, Complete, Canceled, or Error.
        var status: Swift.String?
        /// Details about the timing of a job.
        var timing: ElasticTranscoderClientTypes.Timing?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct JobAlbumArt: Swift.Equatable {
        ...
        var artwork: [ElasticTranscoderClientTypes.Artwork]?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct JobInput: Swift.Equatable {
        ...
        var detectedProperties: ElasticTranscoderClientTypes.DetectedProperties?
        ...
        ///
        /// If you want ttml or smpte-tt compatible captions, specify dfxp as your output format. Elastic Transcoder does not support OCR (Optical Character Recognition), does not accept pictures as a valid input for captions, and is not available for audio-only transcoding. Elastic Transcoder does not preserve text formatting (for example, italics) during the transcoding process. To remove captions or leave the captions empty, set Captions to null. To pass through existing captions unchanged, set the MergePolicy to MergeRetain, and pass in a null CaptionSources array. For more information on embedded files, see the Subtitles Wikipedia page. For more information on sidecar files, see the Extensible Metadata Platform and Sidecar file Wikipedia pages.
        var inputCaptions: ElasticTranscoderClientTypes.InputCaptions?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct JobOutput: Swift.Equatable {
        ...
        var appliedColorSpaceConversion: Swift.String?
        /// You can configure Elastic Transcoder to transcode captions, or subtitles, from one format to another. All captions must be in UTF-8. Elastic Transcoder supports two types of captions:
        ///
        /// * Embedded: Embedded captions are included in the same file as the audio and video. Elastic Transcoder supports only one embedded caption per language, to a maximum of 300 embedded captions per file. Valid input values include: CEA-608 (EIA-608, first non-empty channel only), CEA-708 (EIA-708, first non-empty channel only), and mov-text Valid outputs include: mov-text Elastic Transcoder supports a maximum of one embedded format per output.
        ///
...
extension ElasticTranscoderClientTypes {
    ...
    public struct JobWatermark: Swift.Equatable {
        ...
        var presetWatermarkId: Swift.String?
...
public struct ListJobsByPipelineInput: Swift.Equatable {
    ...
    var ascending: Swift.String?
    /// When Elastic Transcoder returns more than one page of results, use pageToken in subsequent GET requests to get each successive page of results.
    var pageToken: Swift.String?
...
public struct ListJobsByPipelineOutputResponse: Swift.Equatable {
    ...
    var jobs: [ElasticTranscoderClientTypes.Job]?
    /// A value that you use to access the second and subsequent pages of results, if any. When the jobs in the specified pipeline fit on one page or when you've reached the last page of results, the value of NextPageToken is null.
    var nextPageToken: Swift.String?
...
public struct ListPipelinesOutputResponse: Swift.Equatable {
    ...
    var pipelines: [ElasticTranscoderClientTypes.Pipeline]?
...
public struct ListPresetsOutputResponse: Swift.Equatable {
    ...
    var presets: [ElasticTranscoderClientTypes.Preset]?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct Permission: Swift.Equatable {
        ...
        ///
        /// * FULL_CONTROL: The grantee has READ, READ_ACP, and WRITE_ACP permissions for the thumbnails that Elastic Transcoder adds to the Amazon S3 bucket.
        var access: [Swift.String]?
        /// The AWS user or group that you want to have access to transcoded files and playlists. To identify the user or group, you can specify the canonical user ID for an AWS account, an origin access identity for a CloudFront distribution, the registered email address of an AWS account, or a predefined Amazon S3 group.
        var grantee: Swift.String?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct PipelineOutputConfig: Swift.Equatable {
        ...
        var permissions: [ElasticTranscoderClientTypes.Permission]?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct PresetWatermark: Swift.Equatable {
        ...
        var horizontalOffset: Swift.String?
        ...
        var verticalOffset: Swift.String?
...
public struct TestRoleOutputResponse: Swift.Equatable {
    ...
    var messages: [Swift.String]?
    /// If the operation is successful, this value is true; otherwise, the value is false.
    var success: Swift.String?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct Timing: Swift.Equatable {
        ...
        var finishTimeMillis: Swift.Int?
        /// The time the job began transcoding, in epoch milliseconds.
        var startTimeMillis: Swift.Int?
        /// The time the job was submitted to Elastic Transcoder, in epoch milliseconds.
        var submitTimeMillis: Swift.Int?
...
extension ElasticTranscoderClientTypes {
    ...
    public struct VideoParameters: Swift.Equatable {
        ...
        var codecOptions: [Swift.String:Swift.String]?
        /// The value that Elastic Transcoder adds to the metadata in the output file.
        var displayAspectRatio: Swift.String?
        ...
        var keyframesMaxDist: Swift.String?
        ...
        var sizingPolicy: Swift.String?
        /// Settings for the size, location, and opacity of graphics that you want Elastic Transcoder to overlay over videos that are transcoded using this preset. You can specify settings for up to four watermarks. Watermarks appear in the specified size and location, and with the specified opacity for the duration of the transcoded video. Watermarks can be in .png or .jpg format. If you want to display a watermark that is not rectangular, use the .png format, which supports transparency. When you create a job that uses this preset, you specify the .png or .jpg graphics that you want Elastic Transcoder to include in the transcoded videos. You can specify fewer graphics in the job than you specify watermark settings in the preset, which allows you to use the same preset for up to four watermarks that have different dimensions.
        var watermarks: [ElasticTranscoderClientTypes.PresetWatermark]?
