...
public struct CancelJobInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2012-09-25/jobs/\(id.urlPercentEncoding())"
...
public struct CreatePipelineInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2012-09-25/pipelines"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreatePresetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePresetInputURLHostMiddleware"
    ...
    public typealias MInput = CreatePresetInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreatePresetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreatePresetOutputError>
}

public struct CreatePresetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePresetInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2012-09-25/presets"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeletePipelineInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2012-09-25/pipelines/\(id.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeletePresetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePresetInputURLHostMiddleware"
    ...
    public typealias MInput = DeletePresetInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeletePresetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeletePresetOutputError>
}

public struct DeletePresetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePresetInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2012-09-25/presets/\(id.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListJobsByPipelineInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJobsByPipelineInputURLHostMiddleware"
    ...
    public typealias MInput = ListJobsByPipelineInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListJobsByPipelineOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListJobsByPipelineOutputError>
}

public struct ListJobsByPipelineInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJobsByPipelineInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let pipelineId = input.pipelineId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("pipelineId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/2012-09-25/jobsByPipeline/\(pipelineId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListJobsByStatusInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJobsByStatusInputURLHostMiddleware"
    ...
    public typealias MInput = ListJobsByStatusInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListJobsByStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListJobsByStatusOutputError>
}

public struct ListJobsByStatusInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJobsByStatusInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let status = input.status else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("status is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/2012-09-25/jobsByStatus/\(status.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListPresetsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPresetsInputURLHostMiddleware"
    ...
    public typealias MInput = ListPresetsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListPresetsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListPresetsOutputError>
}

public struct ListPresetsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPresetsInputURLPathMiddleware"
...
public struct ReadJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReadJobInputURLHostMiddleware"
    ...
    public typealias MInput = ReadJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<ReadJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ReadJobOutputError>
}

public struct ReadJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReadJobInputURLPathMiddleware"
...
public struct ReadPipelineInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReadPipelineInputURLHostMiddleware"
    ...
    public typealias MInput = ReadPipelineInput
    public typealias MOutput = ClientRuntime.OperationOutput<ReadPipelineOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ReadPipelineOutputError>
}

public struct ReadPipelineInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReadPipelineInputURLPathMiddleware"
...
public struct ReadPresetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReadPresetInputURLHostMiddleware"
    ...
    public typealias MInput = ReadPresetInput
    public typealias MOutput = ClientRuntime.OperationOutput<ReadPresetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ReadPresetOutputError>
}

public struct ReadPresetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReadPresetInputURLPathMiddleware"
...
public struct TestRoleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TestRoleInputURLHostMiddleware"
    ...
    public typealias MInput = TestRoleInput
    public typealias MOutput = ClientRuntime.OperationOutput<TestRoleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<TestRoleOutputError>
}

public struct TestRoleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TestRoleInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2012-09-25/roleTests"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdatePipelineInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePipelineInputURLHostMiddleware"
    ...
    public typealias MInput = UpdatePipelineInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdatePipelineOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdatePipelineOutputError>
}

public struct UpdatePipelineInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePipelineInputURLPathMiddleware"
...
public struct UpdatePipelineNotificationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePipelineNotificationsInputURLHostMiddleware"
    ...
    public typealias MInput = UpdatePipelineNotificationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdatePipelineNotificationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdatePipelineNotificationsOutputError>
}

public struct UpdatePipelineNotificationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePipelineNotificationsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2012-09-25/pipelines/\(id.urlPercentEncoding())/notifications"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdatePipelineStatusInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePipelineStatusInputURLHostMiddleware"
    ...
    public typealias MInput = UpdatePipelineStatusInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdatePipelineStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdatePipelineStatusOutputError>
}

public struct UpdatePipelineStatusInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePipelineStatusInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2012-09-25/pipelines/\(id.urlPercentEncoding())/status"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
