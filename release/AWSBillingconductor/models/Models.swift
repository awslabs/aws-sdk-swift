...
extension BillingconductorClientTypes.BillingGroupListElement: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        size = sizeDecoded
        let creationTimeDecoded = try containerValues.decode(Swift.Int.self, forKey: .creationTime)
...
extension BillingconductorClientTypes.CustomLineItemListElement: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let lastModifiedTimeDecoded = try containerValues.decode(Swift.Int.self, forKey: .lastModifiedTime)
        lastModifiedTime = lastModifiedTimeDecoded
        let associationSizeDecoded = try containerValues.decode(Swift.Int.self, forKey: .associationSize)
...
extension BillingconductorClientTypes.PricingRuleListElement: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let serviceDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .service)
        service = serviceDecoded
        let associatedPricingPlanCountDecoded = try containerValues.decode(Swift.Int.self, forKey: .associatedPricingPlanCount)
