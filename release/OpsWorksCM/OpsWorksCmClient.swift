...
public class OpsWorksCmClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try OpsWorksCmClientConfiguration(region: unwrappedRegion)
    ...
    public class OpsWorksCmClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("OpsWorksCmClient")
...
public struct OpsWorksCmClientLogHandlerFactory: SDKLogHandlerFactory {
