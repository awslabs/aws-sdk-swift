...
public protocol LakeFormationClientProtocol {
    ...
    func addLFTagsToResource(input: AddLFTagsToResourceInput, completion: @escaping (SdkResult<AddLFTagsToResourceOutputResponse, AddLFTagsToResourceOutputError>) -> Void)
    /// <p>Batch operation to grant permissions to the principal.</p>
    func batchGrantPermissions(input: BatchGrantPermissionsInput, completion: @escaping (SdkResult<BatchGrantPermissionsOutputResponse, BatchGrantPermissionsOutputError>) -> Void)
    /// <p>Batch operation to revoke permissions from the principal.</p>
    func batchRevokePermissions(input: BatchRevokePermissionsInput, completion: @escaping (SdkResult<BatchRevokePermissionsOutputResponse, BatchRevokePermissionsOutputError>) -> Void)
    /// <p>Creates a tag with the specified name and values.</p>
    func createLFTag(input: CreateLFTagInput, completion: @escaping (SdkResult<CreateLFTagOutputResponse, CreateLFTagOutputError>) -> Void)
    ...
    func deleteLFTag(input: DeleteLFTagInput, completion: @escaping (SdkResult<DeleteLFTagOutputResponse, DeleteLFTagOutputError>) -> Void)
    ...
    func deregisterResource(input: DeregisterResourceInput, completion: @escaping (SdkResult<DeregisterResourceOutputResponse, DeregisterResourceOutputError>) -> Void)
    ...
    func getDataLakeSettings(input: GetDataLakeSettingsInput, completion: @escaping (SdkResult<GetDataLakeSettingsOutputResponse, GetDataLakeSettingsOutputError>) -> Void)
    ...
    func getEffectivePermissionsForPath(input: GetEffectivePermissionsForPathInput, completion: @escaping (SdkResult<GetEffectivePermissionsForPathOutputResponse, GetEffectivePermissionsForPathOutputError>) -> Void)
    /// <p>Returns a tag definition.</p>
    func getLFTag(input: GetLFTagInput, completion: @escaping (SdkResult<GetLFTagOutputResponse, GetLFTagOutputError>) -> Void)
    /// <p>Returns the tags applied to a resource.</p>
    func getResourceLFTags(input: GetResourceLFTagsInput, completion: @escaping (SdkResult<GetResourceLFTagsOutputResponse, GetResourceLFTagsOutputError>) -> Void)
    ...
    func grantPermissions(input: GrantPermissionsInput, completion: @escaping (SdkResult<GrantPermissionsOutputResponse, GrantPermissionsOutputError>) -> Void)
    /// <p>Lists tags that the requester has permission to view. </p>
    func listLFTags(input: ListLFTagsInput, completion: @escaping (SdkResult<ListLFTagsOutputResponse, ListLFTagsOutputError>) -> Void)
    ...
    func putDataLakeSettings(input: PutDataLakeSettingsInput, completion: @escaping (SdkResult<PutDataLakeSettingsOutputResponse, PutDataLakeSettingsOutputError>) -> Void)
    ...
    ///          </p>
    func registerResource(input: RegisterResourceInput, completion: @escaping (SdkResult<RegisterResourceOutputResponse, RegisterResourceOutputError>) -> Void)
    ...
    func removeLFTagsFromResource(input: RemoveLFTagsFromResourceInput, completion: @escaping (SdkResult<RemoveLFTagsFromResourceOutputResponse, RemoveLFTagsFromResourceOutputError>) -> Void)
    ...
    func revokePermissions(input: RevokePermissionsInput, completion: @escaping (SdkResult<RevokePermissionsOutputResponse, RevokePermissionsOutputError>) -> Void)
    ...
    func searchDatabasesByLFTags(input: SearchDatabasesByLFTagsInput, completion: @escaping (SdkResult<SearchDatabasesByLFTagsOutputResponse, SearchDatabasesByLFTagsOutputError>) -> Void)
    ...
    func searchTablesByLFTags(input: SearchTablesByLFTagsInput, completion: @escaping (SdkResult<SearchTablesByLFTagsOutputResponse, SearchTablesByLFTagsOutputError>) -> Void)
    ...
    func updateLFTag(input: UpdateLFTagInput, completion: @escaping (SdkResult<UpdateLFTagOutputResponse, UpdateLFTagOutputError>) -> Void)
