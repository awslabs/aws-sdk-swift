...
public class LakeFormationClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try LakeFormationClientConfiguration(region: unwrappedRegion)
    ...
    public class LakeFormationClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("LakeFormationClient")
