...
public struct CreateParallelDataInput: Swift.Equatable {
    ...
    var encryptionKey: TranslateClientTypes.EncryptionKey?
    /// A custom name for the parallel data resource in Amazon Translate. You must assign a name that is unique in the account and region.
    /// This member is required.
    var name: Swift.String?
    /// Specifies the format and S3 location of the parallel data input file.
    /// This member is required.
    var parallelDataConfig: TranslateClientTypes.ParallelDataConfig?
...
public struct CreateParallelDataOutputResponse: Swift.Equatable {
    ...
    var status: TranslateClientTypes.ParallelDataStatus?
...
public struct DescribeTextTranslationJobOutputResponse: Swift.Equatable {
    ...
    var textTranslationJobProperties: TranslateClientTypes.TextTranslationJobProperties?
...
extension TranslateClientTypes {
    ...
    public struct EncryptionKey: Swift.Equatable {
        ...
        /// This member is required.
        var type: TranslateClientTypes.EncryptionKeyType?
...
public struct GetParallelDataOutputResponse: Swift.Equatable {
    ...
    var auxiliaryDataLocation: TranslateClientTypes.ParallelDataDataLocation?
    ...
    var dataLocation: TranslateClientTypes.ParallelDataDataLocation?
    /// The Amazon S3 location of a file that provides any errors or warnings that were produced by your input file. This file was created when Amazon Translate attempted to update a parallel data resource. The location is returned as a presigned URL to that has a 30 minute expiration.
    var latestUpdateAttemptAuxiliaryDataLocation: TranslateClientTypes.ParallelDataDataLocation?
    /// The properties of the parallel data resource that is being retrieved.
    var parallelDataProperties: TranslateClientTypes.ParallelDataProperties?
...
public struct GetTerminologyInput: Swift.Equatable {
    ...
    var terminologyDataFormat: TranslateClientTypes.TerminologyDataFormat?
...
public struct GetTerminologyOutputResponse: Swift.Equatable {
    ...
    var auxiliaryDataLocation: TranslateClientTypes.TerminologyDataLocation?
    ...
    var terminologyDataLocation: TranslateClientTypes.TerminologyDataLocation?
    /// The properties of the custom terminology being retrieved.
    var terminologyProperties: TranslateClientTypes.TerminologyProperties?
...
public struct ImportTerminologyInput: Swift.Equatable {
    ...
    /// This member is required.
    var mergeStrategy: TranslateClientTypes.MergeStrategy?
    /// The name of the custom terminology being imported.
    /// This member is required.
    var name: Swift.String?
    /// The terminology data for the custom terminology being imported.
    /// This member is required.
    var terminologyData: TranslateClientTypes.TerminologyData?
...
extension TranslateClientTypes {
    ...
    public struct JobDetails: Swift.Equatable {
        ...
        var documentsWithErrorsCount: Swift.Int?
        /// The number of documents used as input in a translation job.
        var inputDocumentsCount: Swift.Int?
        /// The number of documents successfully processed during a translation job.
        var translatedDocumentsCount: Swift.Int?
...
public struct ListParallelDataOutputResponse: Swift.Equatable {
    ...
    var parallelDataPropertiesList: [TranslateClientTypes.ParallelDataProperties]?
...
public struct ListTerminologiesOutputResponse: Swift.Equatable {
    ...
    var terminologyPropertiesList: [TranslateClientTypes.TerminologyProperties]?
...
public struct ListTextTranslationJobsInput: Swift.Equatable {
    ...
    var filter: TranslateClientTypes.TextTranslationJobFilter?
...
public struct ListTextTranslationJobsOutputResponse: Swift.Equatable {
    ...
    var textTranslationJobPropertiesList: [TranslateClientTypes.TextTranslationJobProperties]?
...
extension TranslateClientTypes {
    ...
    public struct ParallelDataConfig: Swift.Equatable {
        ...
        /// This member is required.
        var format: TranslateClientTypes.ParallelDataFormat?
...
extension TranslateClientTypes {
    ...
    public struct ParallelDataDataLocation: Swift.Equatable {
        ...
        /// This member is required.
        var repositoryType: Swift.String?
...
extension TranslateClientTypes {
    ...
    public struct ParallelDataProperties: Swift.Equatable {
        ...
        var failedRecordCount: Swift.Int?
        /// The number of UTF-8 characters that Amazon Translate imported from the parallel data input file. This number includes only the characters in your translation examples. It does not include characters that are used to format your file. For example, if you provided a Translation Memory Exchange (.tmx) file, this number does not include the tags.
        var importedDataSize: Swift.Int?
        /// The number of records successfully imported from the parallel data input file.
        var importedRecordCount: Swift.Int?
        /// The time at which the parallel data resource was last updated.
        var lastUpdatedAt: ClientRuntime.Date?
        /// The time that the most recent update was attempted.
        var latestUpdateAttemptAt: ClientRuntime.Date?
        /// The status of the most recent update attempt for the parallel data resource.
        var latestUpdateAttemptStatus: TranslateClientTypes.ParallelDataStatus?
        ...
        var skippedRecordCount: Swift.Int?
        /// The source language of the translations in the parallel data file.
        var sourceLanguageCode: Swift.String?
        ...
        var targetLanguageCodes: [Swift.String]?
...
public struct StartTextTranslationJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var dataAccessRoleArn: Swift.String?
    /// Specifies the format and S3 location of the input documents for the translation job.
    /// This member is required.
    var inputDataConfig: TranslateClientTypes.InputDataConfig?
    /// The name of the batch translation job to be performed.
    var jobName: Swift.String?
    /// Specifies the S3 folder to which your job output will be saved.
    /// This member is required.
    var outputDataConfig: TranslateClientTypes.OutputDataConfig?
    ...
    var parallelDataNames: [Swift.String]?
    ...
    var terminologyNames: [Swift.String]?
...
public struct StartTextTranslationJobOutputResponse: Swift.Equatable {
    ...
    var jobStatus: TranslateClientTypes.JobStatus?
...
extension TranslateClientTypes {
    ...
    public struct Term: Swift.Equatable {
        ...
        var sourceText: Swift.String?
        /// The target text of the term being translated by the custom terminology.
        var targetText: Swift.String?
...
extension TranslateClientTypes {
    ...
    public struct TerminologyData: Swift.Equatable {
        ...
        var directionality: TranslateClientTypes.Directionality?
        /// The file containing the custom terminology data. Your version of the AWS SDK performs a Base64-encoding on this field before sending a request to the AWS service. Users of the SDK should not perform Base64-encoding themselves.
        /// This member is required.
        var file: ClientRuntime.Data?
        /// The data format of the custom terminology.
        /// This member is required.
        var format: TranslateClientTypes.TerminologyDataFormat?
...
extension TranslateClientTypes {
    ...
    public struct TextTranslationJobFilter: Swift.Equatable {
        ...
        var submittedAfterTime: ClientRuntime.Date?
        /// Filters the list of jobs based on the time that the job was submitted for processing and returns only the jobs submitted before the specified time. Jobs are returned in ascending order, oldest to newest.
        var submittedBeforeTime: ClientRuntime.Date?
...
extension TranslateClientTypes {
    ...
    public struct TextTranslationJobProperties: Swift.Equatable {
        ...
        var jobDetails: TranslateClientTypes.JobDetails?
        ...
        var submittedTime: ClientRuntime.Date?
...
public struct TranslateTextInput: Swift.Equatable {
    ...
    /// This member is required.
    var targetLanguageCode: Swift.String?
...
public struct TranslateTextOutputResponse: Swift.Equatable {
    ...
    /// The translated text.
    /// This member is required.
    var translatedText: Swift.String?
