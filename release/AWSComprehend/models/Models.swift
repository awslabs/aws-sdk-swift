...
extension ComprehendClientTypes {
    ...
    public struct AugmentedManifestsListItem: Swift.Equatable {
        ...
        var annotationDataS3Uri: Swift.String?
        ...
        var documentType: ComprehendClientTypes.AugmentedManifestsDocumentTypeFormat?
        /// The Amazon S3 location of the augmented manifest file.
        /// This member is required.
        var s3Uri: Swift.String?
        /// The S3 prefix to the source files (PDFs) that are referred to in the augmented manifest file.
        var sourceDocumentsS3Uri: Swift.String?
        ...
        var split: ComprehendClientTypes.Split?
...
public struct BatchDetectDominantLanguageOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var errorList: [ComprehendClientTypes.BatchItemError]?
    /// A list of objects containing the results of the operation. The results are sorted in ascending order by the Index field and match the order of the documents in the input list. If all of the documents contain an error, the ResultList is empty.
    /// This member is required.
    var resultList: [ComprehendClientTypes.BatchDetectDominantLanguageItemResult]?
...
public struct BatchDetectEntitiesOutputResponse: Swift.Equatable {
    ...
    /// A list of objects containing the results of the operation. The results are sorted in ascending order by the Index field and match the order of the documents in the input list. If all of the documents contain an error, the ResultList is empty.
    /// This member is required.
    var resultList: [ComprehendClientTypes.BatchDetectEntitiesItemResult]?
...
public struct BatchDetectKeyPhrasesOutputResponse: Swift.Equatable {
    ...
    /// A list of objects containing the results of the operation. The results are sorted in ascending order by the Index field and match the order of the documents in the input list. If all of the documents contain an error, the ResultList is empty.
    /// This member is required.
    var resultList: [ComprehendClientTypes.BatchDetectKeyPhrasesItemResult]?
...
public struct BatchDetectSentimentOutputResponse: Swift.Equatable {
    ...
    /// A list of objects containing the results of the operation. The results are sorted in ascending order by the Index field and match the order of the documents in the input list. If all of the documents contain an error, the ResultList is empty.
    /// This member is required.
    var resultList: [ComprehendClientTypes.BatchDetectSentimentItemResult]?
...
public struct BatchDetectSyntaxOutputResponse: Swift.Equatable {
    ...
    /// A list of objects containing the results of the operation. The results are sorted in ascending order by the Index field and match the order of the documents in the input list. If all of the documents contain an error, the ResultList is empty.
    /// This member is required.
    var resultList: [ComprehendClientTypes.BatchDetectSyntaxItemResult]?
...
extension ComprehendClientTypes {
    ...
    public struct ClassifierMetadata: Swift.Equatable {
        /// Describes the result metrics for the test data associated with an documentation classifier.
        var evaluationMetrics: ComprehendClientTypes.ClassifierEvaluationMetrics?
        /// The number of labels in the input data.
        var numberOfLabels: Swift.Int?
        /// The number of documents in the input data that were used to test the classifier. Typically this is 10 to 20 percent of the input documents, up to 10,000 documents.
        var numberOfTestDocuments: Swift.Int?
        /// The number of documents in the input data that were used to train the classifier. Typically this is 80 to 90 percent of the input documents.
        var numberOfTrainedDocuments: Swift.Int?
...
public struct ClassifyDocumentOutputResponse: Swift.Equatable {
    ...
    var classes: [ComprehendClientTypes.DocumentClass]?
    /// The labels used the document being analyzed. These are used for multi-label trained models. Individual labels represent different categories that are related in some manner and are not mutually exclusive. For example, a movie can be just an action movie, or it can be an action movie, a science fiction movie, and a comedy, all at the same time.
    var labels: [ComprehendClientTypes.DocumentLabel]?
...
public struct ContainsPiiEntitiesOutputResponse: Swift.Equatable {
    ...
    var labels: [ComprehendClientTypes.EntityLabel]?
...
public struct CreateDocumentClassifierInput: Swift.Equatable {
    ...
    /// This member is required.
    var documentClassifierName: Swift.String?
    /// Specifies the format and location of the input data for the job.
    /// This member is required.
    var inputDataConfig: ComprehendClientTypes.DocumentClassifierInputDataConfig?
    /// The language of the input documents. You can specify any of the following languages supported by Amazon Comprehend: German ("de"), English ("en"), Spanish ("es"), French ("fr"), Italian ("it"), or Portuguese ("pt"). All documents must be in the same language.
    /// This member is required.
    var languageCode: ComprehendClientTypes.LanguageCode?
    /// Indicates the mode in which the classifier will be trained. The classifier can be trained in multi-class mode, which identifies one and only one class for each document, or multi-label mode, which identifies one or more labels for each document. In multi-label mode, multiple labels for an individual document are separated by a delimiter. The default delimiter between labels is a pipe (|).
    var mode: ComprehendClientTypes.DocumentClassifierMode?
    /// ID for the AWS Key Management Service (KMS) key that Amazon Comprehend uses to encrypt trained custom models. The ModelKmsKeyId can be either of the following formats:
    ///
    /// * KMS Key ID: "1234abcd-12ab-34cd-56ef-1234567890ab"
    ///
    /// * Amazon Resource Name (ARN) of a KMS Key: "arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab"
    var modelKmsKeyId: Swift.String?
    /// Enables the addition of output results configuration parameters for custom classifier jobs.
    var outputDataConfig: ComprehendClientTypes.DocumentClassifierOutputDataConfig?
    /// Tags to be associated with the document classifier being created. A tag is a key-value pair that adds as a metadata to a resource used by Amazon Comprehend. For example, a tag with "Sales" as the key might be added to a resource to indicate its use by the sales department.
    var tags: [ComprehendClientTypes.Tag]?
    ...
    ///
    /// * Amazon Resource Name (ARN) of a KMS Key: "arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab"
    var volumeKmsKeyId: Swift.String?
    ...
    var vpcConfig: ComprehendClientTypes.VpcConfig?
...
public struct CreateDocumentClassifierOutputResponse: Swift.Equatable {
    ...
    var documentClassifierArn: Swift.String?
...
public struct CreateEndpointInput: Swift.Equatable {
    ...
    /// This member is required.
    var desiredInferenceUnits: Swift.Int?
...
public struct CreateEntityRecognizerInput: Swift.Equatable {
    ...
    /// This member is required.
    var inputDataConfig: ComprehendClientTypes.EntityRecognizerInputDataConfig?
    ...
    /// This member is required.
    var recognizerName: Swift.String?
...
public struct CreateEntityRecognizerOutputResponse: Swift.Equatable {
    ...
    var entityRecognizerArn: Swift.String?
...
public struct DescribeDocumentClassificationJobOutputResponse: Swift.Equatable {
    ...
    var documentClassificationJobProperties: ComprehendClientTypes.DocumentClassificationJobProperties?
...
public struct DescribeDocumentClassifierOutputResponse: Swift.Equatable {
    ...
    var documentClassifierProperties: ComprehendClientTypes.DocumentClassifierProperties?
...
public struct DescribeDominantLanguageDetectionJobOutputResponse: Swift.Equatable {
    ...
    var dominantLanguageDetectionJobProperties: ComprehendClientTypes.DominantLanguageDetectionJobProperties?
...
public struct DescribeEndpointOutputResponse: Swift.Equatable {
    ...
    var endpointProperties: ComprehendClientTypes.EndpointProperties?
...
public struct DescribeEntitiesDetectionJobOutputResponse: Swift.Equatable {
    ...
    var entitiesDetectionJobProperties: ComprehendClientTypes.EntitiesDetectionJobProperties?
...
public struct DescribeEntityRecognizerOutputResponse: Swift.Equatable {
    ...
    var entityRecognizerProperties: ComprehendClientTypes.EntityRecognizerProperties?
...
public struct DescribeEventsDetectionJobOutputResponse: Swift.Equatable {
    ...
    var eventsDetectionJobProperties: ComprehendClientTypes.EventsDetectionJobProperties?
...
public struct DescribeKeyPhrasesDetectionJobOutputResponse: Swift.Equatable {
    ...
    var keyPhrasesDetectionJobProperties: ComprehendClientTypes.KeyPhrasesDetectionJobProperties?
...
public struct DescribePiiEntitiesDetectionJobOutputResponse: Swift.Equatable {
    ...
    var piiEntitiesDetectionJobProperties: ComprehendClientTypes.PiiEntitiesDetectionJobProperties?
...
public struct DescribeSentimentDetectionJobOutputResponse: Swift.Equatable {
    ...
    var sentimentDetectionJobProperties: ComprehendClientTypes.SentimentDetectionJobProperties?
...
public struct DescribeTopicsDetectionJobOutputResponse: Swift.Equatable {
    ...
    var topicsDetectionJobProperties: ComprehendClientTypes.TopicsDetectionJobProperties?
...
public struct DetectPiiEntitiesOutputResponse: Swift.Equatable {
    ...
    var entities: [ComprehendClientTypes.PiiEntity]?
...
extension ComprehendClientTypes {
    ...
    public struct DocumentClassificationJobFilter: Swift.Equatable {
        ...
        var jobStatus: ComprehendClientTypes.JobStatus?
        /// Filters the list of jobs based on the time that the job was submitted for processing. Returns only jobs submitted after the specified time. Jobs are returned in descending order, newest to oldest.
        var submitTimeAfter: ClientRuntime.Date?
        /// Filters the list of jobs based on the time that the job was submitted for processing. Returns only jobs submitted before the specified time. Jobs are returned in ascending order, oldest to newest.
        var submitTimeBefore: ClientRuntime.Date?
...
extension ComprehendClientTypes {
    ...
    public struct DocumentClassificationJobProperties: Swift.Equatable {
        ...
        var inputDataConfig: ComprehendClientTypes.InputDataConfig?
        ...
        var outputDataConfig: ComprehendClientTypes.OutputDataConfig?
...
extension ComprehendClientTypes {
    ...
    public struct DocumentClassifierFilter: Swift.Equatable {
        ...
        var status: ComprehendClientTypes.ModelStatus?
...
extension ComprehendClientTypes {
    ...
    public struct DocumentClassifierInputDataConfig: Swift.Equatable {
        ...
        var augmentedManifests: [ComprehendClientTypes.AugmentedManifestsListItem]?
        ...
        var dataFormat: ComprehendClientTypes.DocumentClassifierDataFormat?
        /// Indicates the delimiter used to separate each label for training a multi-label classifier. The default delimiter between labels is a pipe (|). You can use a different character as a delimiter (if it's an allowed character) by specifying it under Delimiter for labels. If the training documents use a delimiter other than the default or the delimiter you specify, the labels on that line will be combined to make a single unique label, such as LABELLABELLABEL.
        var labelDelimiter: Swift.String?
...
extension ComprehendClientTypes {
    ...
    public struct DocumentClassifierProperties: Swift.Equatable {
        ...
        var classifierMetadata: ComprehendClientTypes.ClassifierMetadata?
        /// The Amazon Resource Name (ARN) of the AWS Identity and Management (IAM) role that grants Amazon Comprehend read access to your input data.
        var dataAccessRoleArn: Swift.String?
        /// The Amazon Resource Name (ARN) that identifies the document classifier.
        var documentClassifierArn: Swift.String?
        ...
        var trainingEndTime: ClientRuntime.Date?
        /// Indicates the time when the training starts on documentation classifiers. You are billed for the time interval between this time and the value of TrainingEndTime.
        var trainingStartTime: ClientRuntime.Date?
...
extension ComprehendClientTypes {
    ...
    public struct DocumentClassifierSummary: Swift.Equatable {
        ...
        var latestVersionCreatedAt: ClientRuntime.Date?
        /// The version name you assigned to the latest document classifier version.
        var latestVersionName: Swift.String?
        /// Provides the status of the latest document classifier version.
        var latestVersionStatus: ComprehendClientTypes.ModelStatus?
        /// The number of versions you created.
        var numberOfVersions: Swift.Int?
...
extension ComprehendClientTypes {
    ...
    public struct EndpointFilter: Swift.Equatable {
        ...
        var status: ComprehendClientTypes.EndpointStatus?
...
extension ComprehendClientTypes {
    ...
    public struct EndpointProperties: Swift.Equatable {
        ...
        var currentInferenceUnits: Swift.Int?
        /// The Amazon Resource Name (ARN) of the AWS identity and Access Management (IAM) role that grants Amazon Comprehend read access to trained custom models encrypted with a customer managed key (ModelKmsKeyId).
        var dataAccessRoleArn: Swift.String?
        /// Data access role ARN to use in case the new model is encrypted with a customer KMS key.
        var desiredDataAccessRoleArn: Swift.String?
        /// The desired number of inference units to be used by the model using this endpoint. Each inference unit represents of a throughput of 100 characters per second.
        var desiredInferenceUnits: Swift.Int?
        /// ARN of the new model to use for updating an existing endpoint. This ARN is going to be different from the model ARN when the update is in progress
        var desiredModelArn: Swift.String?
        /// The Amazon Resource Number (ARN) of the endpoint.
        var endpointArn: Swift.String?
...
extension ComprehendClientTypes {
    ...
    public struct EntityLabel: Swift.Equatable {
        /// The name of the label.
        var name: ComprehendClientTypes.PiiEntityType?
        /// The level of confidence that Amazon Comprehend has in the accuracy of the detection.
        var score: Swift.Float?
...
extension ComprehendClientTypes {
    ...
    public struct EntityRecognizerDocuments: Swift.Equatable {
        ...
        var inputFormat: ComprehendClientTypes.InputFormat?
...
extension ComprehendClientTypes {
    ...
    public struct EntityRecognizerInputDataConfig: Swift.Equatable {
        ...
        var annotations: ComprehendClientTypes.EntityRecognizerAnnotations?
        /// A list of augmented manifest files that provide training data for your custom model. An augmented manifest file is a labeled dataset that is produced by Amazon SageMaker Ground Truth. This parameter is required if you set DataFormat to AUGMENTED_MANIFEST.
        var augmentedManifests: [ComprehendClientTypes.AugmentedManifestsListItem]?
        /// The format of your training data:
        ///
        ...
        ///
        /// If you don't specify a value, Amazon Comprehend uses COMPREHEND_CSV as the default.
        var dataFormat: ComprehendClientTypes.EntityRecognizerDataFormat?
        ...
        var documents: ComprehendClientTypes.EntityRecognizerDocuments?
        /// The S3 location of the CSV file that has the entity list for your custom entity recognizer.
        var entityList: ComprehendClientTypes.EntityRecognizerEntityList?
        ...
        /// This member is required.
        var entityTypes: [ComprehendClientTypes.EntityTypesListItem]?
...
extension ComprehendClientTypes {
    ...
    public struct EntityRecognizerMetadata: Swift.Equatable {
        ...
        var entityTypes: [ComprehendClientTypes.EntityRecognizerMetadataEntityTypesListItem]?
        /// Detailed information about the accuracy of an entity recognizer.
        var evaluationMetrics: ComprehendClientTypes.EntityRecognizerEvaluationMetrics?
...
extension ComprehendClientTypes {
    ...
    public struct EntityRecognizerMetadataEntityTypesListItem: Swift.Equatable {
        ...
        var evaluationMetrics: ComprehendClientTypes.EntityTypesEvaluationMetrics?
        /// Indicates the number of times the given entity type was seen in the training data.
        var numberOfTrainMentions: Swift.Int?
...
extension ComprehendClientTypes {
    ...
    public struct EntityRecognizerProperties: Swift.Equatable {
        ...
        var recognizerMetadata: ComprehendClientTypes.EntityRecognizerMetadata?
...
extension ComprehendClientTypes {
    ...
    public struct EventsDetectionJobProperties: Swift.Equatable {
        ...
        var targetEventTypes: [Swift.String]?
...
public struct ListDocumentClassificationJobsInput: Swift.Equatable {
    ...
    var filter: ComprehendClientTypes.DocumentClassificationJobFilter?
...
public struct ListDocumentClassificationJobsOutputResponse: Swift.Equatable {
    ...
    var documentClassificationJobPropertiesList: [ComprehendClientTypes.DocumentClassificationJobProperties]?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListDocumentClassifierSummariesOutputResponse: Swift.Equatable {
    ...
    var documentClassifierSummariesList: [ComprehendClientTypes.DocumentClassifierSummary]?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListDocumentClassifiersInput: Swift.Equatable {
    ...
    var filter: ComprehendClientTypes.DocumentClassifierFilter?
    /// The maximum number of results to return in each page. The default is 100.
    var maxResults: Swift.Int?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListDocumentClassifiersOutputResponse: Swift.Equatable {
    /// A list containing the properties of each job returned.
    var documentClassifierPropertiesList: [ComprehendClientTypes.DocumentClassifierProperties]?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListDominantLanguageDetectionJobsInput: Swift.Equatable {
    ...
    var filter: ComprehendClientTypes.DominantLanguageDetectionJobFilter?
    /// The maximum number of results to return in each page. The default is 100.
    var maxResults: Swift.Int?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListDominantLanguageDetectionJobsOutputResponse: Swift.Equatable {
    ...
    var dominantLanguageDetectionJobPropertiesList: [ComprehendClientTypes.DominantLanguageDetectionJobProperties]?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListEndpointsInput: Swift.Equatable {
    ...
    var filter: ComprehendClientTypes.EndpointFilter?
    /// The maximum number of results to return in each page. The default is 100.
    var maxResults: Swift.Int?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListEndpointsOutputResponse: Swift.Equatable {
    ...
    var endpointPropertiesList: [ComprehendClientTypes.EndpointProperties]?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListEntitiesDetectionJobsInput: Swift.Equatable {
    /// Filters the jobs that are returned. You can filter jobs on their name, status, or the date and time that they were submitted. You can only set one filter at a time.
    var filter: ComprehendClientTypes.EntitiesDetectionJobFilter?
    /// The maximum number of results to return in each page. The default is 100.
    var maxResults: Swift.Int?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListEntitiesDetectionJobsOutputResponse: Swift.Equatable {
    /// A list containing the properties of each job that is returned.
    var entitiesDetectionJobPropertiesList: [ComprehendClientTypes.EntitiesDetectionJobProperties]?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListEntityRecognizerSummariesOutputResponse: Swift.Equatable {
    ...
    var entityRecognizerSummariesList: [ComprehendClientTypes.EntityRecognizerSummary]?
    /// The list entity recognizer summaries.
    var nextToken: Swift.String?
...
public struct ListEntityRecognizersInput: Swift.Equatable {
    ...
    var filter: ComprehendClientTypes.EntityRecognizerFilter?
    /// The maximum number of results to return on each page. The default is 100.
    var maxResults: Swift.Int?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListEntityRecognizersOutputResponse: Swift.Equatable {
    ...
    var entityRecognizerPropertiesList: [ComprehendClientTypes.EntityRecognizerProperties]?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListEventsDetectionJobsInput: Swift.Equatable {
    /// Filters the jobs that are returned. You can filter jobs on their name, status, or the date and time that they were submitted. You can only set one filter at a time.
    var filter: ComprehendClientTypes.EventsDetectionJobFilter?
...
public struct ListEventsDetectionJobsOutputResponse: Swift.Equatable {
    /// A list containing the properties of each job that is returned.
    var eventsDetectionJobPropertiesList: [ComprehendClientTypes.EventsDetectionJobProperties]?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListKeyPhrasesDetectionJobsInput: Swift.Equatable {
    /// Filters the jobs that are returned. You can filter jobs on their name, status, or the date and time that they were submitted. You can only set one filter at a time.
    var filter: ComprehendClientTypes.KeyPhrasesDetectionJobFilter?
    /// The maximum number of results to return in each page. The default is 100.
    var maxResults: Swift.Int?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListKeyPhrasesDetectionJobsOutputResponse: Swift.Equatable {
    /// A list containing the properties of each job that is returned.
    var keyPhrasesDetectionJobPropertiesList: [ComprehendClientTypes.KeyPhrasesDetectionJobProperties]?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListPiiEntitiesDetectionJobsInput: Swift.Equatable {
    /// Filters the jobs that are returned. You can filter jobs on their name, status, or the date and time that they were submitted. You can only set one filter at a time.
    var filter: ComprehendClientTypes.PiiEntitiesDetectionJobFilter?
    /// The maximum number of results to return in each page.
    var maxResults: Swift.Int?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListPiiEntitiesDetectionJobsOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// A list containing the properties of each job that is returned.
    var piiEntitiesDetectionJobPropertiesList: [ComprehendClientTypes.PiiEntitiesDetectionJobProperties]?
...
public struct ListSentimentDetectionJobsInput: Swift.Equatable {
    /// Filters the jobs that are returned. You can filter jobs on their name, status, or the date and time that they were submitted. You can only set one filter at a time.
    var filter: ComprehendClientTypes.SentimentDetectionJobFilter?
    /// The maximum number of results to return in each page. The default is 100.
    var maxResults: Swift.Int?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListSentimentDetectionJobsOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// A list containing the properties of each job that is returned.
    var sentimentDetectionJobPropertiesList: [ComprehendClientTypes.SentimentDetectionJobProperties]?
...
public struct ListTopicsDetectionJobsInput: Swift.Equatable {
    ...
    var filter: ComprehendClientTypes.TopicsDetectionJobFilter?
    /// The maximum number of results to return in each page. The default is 100.
    var maxResults: Swift.Int?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
public struct ListTopicsDetectionJobsOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// A list containing the properties of each job that is returned.
    var topicsDetectionJobPropertiesList: [ComprehendClientTypes.TopicsDetectionJobProperties]?
...
extension ComprehendClientTypes {
    ...
    public struct PiiEntitiesDetectionJobProperties: Swift.Equatable {
        ...
        var mode: ComprehendClientTypes.PiiEntitiesDetectionMode?
        /// The output data configuration that you supplied when you created the PII entities detection job.
        var outputDataConfig: ComprehendClientTypes.PiiOutputDataConfig?
        ...
        var redactionConfig: ComprehendClientTypes.RedactionConfig?
...
extension ComprehendClientTypes {
    ...
    public struct PiiEntity: Swift.Equatable {
        ...
        var score: Swift.Float?
        /// The entity's type.
        var type: ComprehendClientTypes.PiiEntityType?
...
extension ComprehendClientTypes {
    ...
    public struct RedactionConfig: Swift.Equatable {
        ...
        var maskCharacter: Swift.String?
        /// Specifies whether the PII entity is redacted with the mask character or the entity type.
        var maskMode: ComprehendClientTypes.PiiEntitiesDetectionMaskMode?
        /// An array of the types of PII entities that Amazon Comprehend detects in the input text for your request.
        var piiEntityTypes: [ComprehendClientTypes.PiiEntityType]?
...
extension ComprehendClientTypes {
    ...
    public struct SentimentScore: Swift.Equatable {
        ...
        var mixed: Swift.Float?
        /// The level of confidence that Amazon Comprehend has in the accuracy of its detection of the NEGATIVE sentiment.
        var negative: Swift.Float?
        /// The level of confidence that Amazon Comprehend has in the accuracy of its detection of the NEUTRAL sentiment.
        var neutral: Swift.Float?
        /// The level of confidence that Amazon Comprehend has in the accuracy of its detection of the POSITIVE sentiment.
        var positive: Swift.Float?
