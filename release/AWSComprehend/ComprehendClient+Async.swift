...
public extension ComprehendClient {
    ...
    {
        typealias listDocumentClassifierSummariesContinuation = CheckedContinuation<ListDocumentClassifierSummariesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listDocumentClassifierSummariesContinuation) in
            listDocumentClassifierSummaries(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listEntityRecognizerSummariesContinuation = CheckedContinuation<ListEntityRecognizerSummariesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listEntityRecognizerSummariesContinuation) in
            listEntityRecognizerSummaries(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
