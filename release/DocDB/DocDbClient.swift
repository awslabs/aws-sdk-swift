...
public class DocDbClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try DocDbClientConfiguration(region: unwrappedRegion)
    ...
    public class DocDbClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("DocDbClient")
...
public struct DocDbClientLogHandlerFactory: SDKLogHandlerFactory {
