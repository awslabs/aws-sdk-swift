...
extension PutDestinationPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutDestinationPolicyInput(accessPolicy: \(Swift.String(describing: accessPolicy)), destinationName: \(Swift.String(describing: destinationName)), forceUpdate: \(Swift.String(describing: forceUpdate)))"}
}
