...
public struct CreateExportTaskInput: Swift.Equatable {
    ...
    var destinationPrefix: Swift.String?
    ...
    var logStreamNamePrefix: Swift.String?
    /// The name of the export task.
    var taskName: Swift.String?
...
public struct DeleteDestinationInput: Swift.Equatable {
    ...
    /// This member is required.
    var destinationName: Swift.String?
...
public struct DeleteQueryDefinitionInput: Swift.Equatable {
    ...
    /// This member is required.
    var queryDefinitionId: Swift.String?
...
public struct DescribeDestinationsInput: Swift.Equatable {
    ...
    var destinationNamePrefix: Swift.String?
...
public struct DescribeDestinationsOutputResponse: Swift.Equatable {
    /// The destinations.
    var destinations: [CloudWatchLogsClientTypes.Destination]?
...
public struct DescribeExportTasksInput: Swift.Equatable {
    ...
    var statusCode: CloudWatchLogsClientTypes.ExportTaskStatusCode?
...
public struct DescribeExportTasksOutputResponse: Swift.Equatable {
    /// The export tasks.
    var exportTasks: [CloudWatchLogsClientTypes.ExportTask]?
    /// The token for the next set of items to return. The token expires after 24 hours.
    var nextToken: Swift.String?
...
public struct DescribeLogGroupsInput: Swift.Equatable {
    ...
    var limit: Swift.Int?
    /// The prefix to match.
    var logGroupNamePrefix: Swift.String?
    /// The token for the next set of items to return. (You received this token from a previous call.)
    var nextToken: Swift.String?
...
public struct DescribeLogGroupsOutputResponse: Swift.Equatable {
    ...
    var logGroups: [CloudWatchLogsClientTypes.LogGroup]?
    /// The token for the next set of items to return. The token expires after 24 hours.
    var nextToken: Swift.String?
...
public struct DescribeMetricFiltersInput: Swift.Equatable {
    ...
    var filterNamePrefix: Swift.String?
    /// The maximum number of items returned. If you don't specify a value, the default is up to 50 items.
    var limit: Swift.Int?
    /// The name of the log group.
    var logGroupName: Swift.String?
...
public struct DescribeMetricFiltersOutputResponse: Swift.Equatable {
    /// The metric filters.
    var metricFilters: [CloudWatchLogsClientTypes.MetricFilter]?
    /// The token for the next set of items to return. The token expires after 24 hours.
    var nextToken: Swift.String?
...
public struct DescribeQueriesInput: Swift.Equatable {
    ...
    var status: CloudWatchLogsClientTypes.QueryStatus?
...
public struct DescribeQueriesOutputResponse: Swift.Equatable {
    ...
    var queries: [CloudWatchLogsClientTypes.QueryInfo]?
...
public struct DescribeQueryDefinitionsInput: Swift.Equatable {
    ...
    var queryDefinitionNamePrefix: Swift.String?
...
public struct DescribeQueryDefinitionsOutputResponse: Swift.Equatable {
    ...
    var queryDefinitions: [CloudWatchLogsClientTypes.QueryDefinition]?
...
public struct DescribeResourcePoliciesOutputResponse: Swift.Equatable {
    ...
    var resourcePolicies: [CloudWatchLogsClientTypes.ResourcePolicy]?
...
public struct DescribeSubscriptionFiltersOutputResponse: Swift.Equatable {
    ...
    var subscriptionFilters: [CloudWatchLogsClientTypes.SubscriptionFilter]?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct Destination: Swift.Equatable {
        ...
        var accessPolicy: Swift.String?
        /// The ARN of this destination.
        var arn: Swift.String?
        /// The creation time of the destination, expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC.
        var creationTime: Swift.Int?
        /// The name of the destination.
        var destinationName: Swift.String?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct ExportTask: Swift.Equatable {
        ...
        var executionInfo: CloudWatchLogsClientTypes.ExportTaskExecutionInfo?
        /// The start time, expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC. Events with a timestamp before this time are not exported.
        var from: Swift.Int?
        /// The name of the log group from which logs data was exported.
        var logGroupName: Swift.String?
        /// The status of the export task.
        var status: CloudWatchLogsClientTypes.ExportTaskStatus?
        /// The ID of the export task.
        var taskId: Swift.String?
        /// The name of the export task.
        var taskName: Swift.String?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct ExportTaskStatus: Swift.Equatable {
        ...
        var code: CloudWatchLogsClientTypes.ExportTaskStatusCode?
...
public struct FilterLogEventsInput: Swift.Equatable {
    ...
    var filterPattern: Swift.String?
    ...
    var logStreamNames: [Swift.String]?
    /// The token for the next set of events to return. (You received this token from a previous call.)
    var nextToken: Swift.String?
    /// The start of the time range, expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC. Events with a timestamp before this time are not returned.
    var startTime: Swift.Int?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct FilteredLogEvent: Swift.Equatable {
        ...
        var ingestionTime: Swift.Int?
        /// The name of the log stream to which this event belongs.
        var logStreamName: Swift.String?
        /// The data contained in the log event.
        var message: Swift.String?
        /// The time the event occurred, expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC.
        var timestamp: Swift.Int?
...
public struct GetLogEventsOutputResponse: Swift.Equatable {
    /// The events.
    var events: [CloudWatchLogsClientTypes.OutputLogEvent]?
    ...
    var nextBackwardToken: Swift.String?
    /// The token for the next set of items in the forward direction. The token expires after 24 hours. If you have reached the end of the stream, it returns the same token you passed in.
    var nextForwardToken: Swift.String?
...
public struct GetLogGroupFieldsOutputResponse: Swift.Equatable {
    ...
    var logGroupFields: [CloudWatchLogsClientTypes.LogGroupField]?
...
public struct GetLogRecordInput: Swift.Equatable {
    ...
    /// This member is required.
    var logRecordPointer: Swift.String?
...
public struct GetLogRecordOutputResponse: Swift.Equatable {
    ...
    var logRecord: [Swift.String:Swift.String]?
...
public struct GetQueryResultsOutputResponse: Swift.Equatable {
    ...
    var results: [[CloudWatchLogsClientTypes.ResultField]]?
    ...
    var statistics: CloudWatchLogsClientTypes.QueryStatistics?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct LogGroup: Swift.Equatable {
        ...
        var metricFilterCount: Swift.Int?
        ...
        var retentionInDays: Swift.Int?
        /// The number of bytes stored.
        var storedBytes: Swift.Int?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct LogStream: Swift.Equatable {
        ...
        var firstEventTimestamp: Swift.Int?
        /// The time of the most recent log event in the log stream in CloudWatch Logs. This number is expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC. The lastEventTime value updates on an eventual consistency basis. It typically updates in less than an hour from ingestion, but in rare situations might take longer.
        var lastEventTimestamp: Swift.Int?
        /// The ingestion time, expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC.
        var lastIngestionTime: Swift.Int?
        /// The name of the log stream.
        var logStreamName: Swift.String?
        ...
        var storedBytes: Swift.Int?
        /// The sequence token.
        var uploadSequenceToken: Swift.String?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct MetricFilter: Swift.Equatable {
        ...
        var metricTransformations: [CloudWatchLogsClientTypes.MetricTransformation]?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct MetricFilterMatchRecord: Swift.Equatable {
        /// The raw event data.
        var eventMessage: Swift.String?
        /// The event number.
        var eventNumber: Swift.Int
        /// The values extracted from the event data by the filter.
        var extractedValues: [Swift.String:Swift.String]?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct MetricTransformation: Swift.Equatable {
        ...
        var dimensions: [Swift.String:Swift.String]?
        ...
        /// This member is required.
        var metricValue: Swift.String?
        /// The unit to assign to the metric. If you omit this, the unit is set as None.
        var unit: CloudWatchLogsClientTypes.StandardUnit?
...
public struct PutDestinationOutputResponse: Swift.Equatable {
    /// The destination.
    var destination: CloudWatchLogsClientTypes.Destination?
...
public struct PutLogEventsInput: Swift.Equatable {
    ...
    var sequenceToken: Swift.String?
...
public struct PutLogEventsOutputResponse: Swift.Equatable {
    ...
    var nextSequenceToken: Swift.String?
    /// The rejected events.
...
public struct PutQueryDefinitionInput: Swift.Equatable {
    ...
    var logGroupNames: [Swift.String]?
...
public struct PutResourcePolicyOutputResponse: Swift.Equatable {
    /// The new policy.
    var resourcePolicy: CloudWatchLogsClientTypes.ResourcePolicy?
...
public struct PutSubscriptionFilterInput: Swift.Equatable {
    ...
    var distribution: CloudWatchLogsClientTypes.Distribution?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct QueryCompileError: Swift.Equatable {
        /// Reserved.
        var location: CloudWatchLogsClientTypes.QueryCompileErrorLocation?
        /// Reserved.
        var message: Swift.String?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct QueryCompileErrorLocation: Swift.Equatable {
        /// Reserved.
        var endCharOffset: Swift.Int?
        /// Reserved.
        var startCharOffset: Swift.Int?
...
extension CloudWatchLogsClientTypes {
    ...
    public struct QueryStatistics: Swift.Equatable {
        ...
        var bytesScanned: Swift.Double
        /// The number of log events that matched the query string.
        var recordsMatched: Swift.Double
        /// The total number of log events scanned during the query.
        var recordsScanned: Swift.Double
...
extension CloudWatchLogsClientTypes {
    ...
    public struct SearchedLogStream: Swift.Equatable {
        ...
        var searchedCompletely: Swift.Bool?
...
public struct TestMetricFilterInput: Swift.Equatable {
    ...
    /// This member is required.
    var logEventMessages: [Swift.String]?
...
public struct TestMetricFilterOutputResponse: Swift.Equatable {
    /// The matched events.
    var matches: [CloudWatchLogsClientTypes.MetricFilterMatchRecord]?
