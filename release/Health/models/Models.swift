...
extension HealthClientTypes.AffectedEntity: Swift.Codable, ClientRuntime.Reflection {
...
extension HealthClientTypes.AffectedEntity: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AffectedEntity(awsAccountId: \(Swift.String(describing: awsAccountId)), entityArn: \(Swift.String(describing: entityArn)), entityUrl: \(Swift.String(describing: entityUrl)), entityValue: \(Swift.String(describing: entityValue)), eventArn: \(Swift.String(describing: eventArn)), lastUpdatedTime: \(Swift.String(describing: lastUpdatedTime)), statusCode: \(Swift.String(describing: statusCode)), tags: \(Swift.String(describing: tags)))"}
}
...
extension HealthClientTypes {
    ...
    public struct AffectedEntity: Swift.Equatable {
        ...
        public let entityValue: Swift.String?
        ...
        ///
        public let eventArn: Swift.String?
        ...
        public let statusCode: HealthClientTypes.EntityStatusCode?
...
///
///             <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EnableHealthServiceAccessForOrganization.html">EnableHealthServiceAccessForOrganization is already in progress. Wait for the
///          action to complete before trying again. To get the current status, use the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeHealthServiceStatusForOrganization.html">DescribeHealthServiceStatusForOrganization operation.
...
extension HealthClientTypes.DateTimeRange: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case from
        case to
    }
...
extension HealthClientTypes.DateTimeRange: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DateTimeRange(from: \(Swift.String(describing: from)), to: \(Swift.String(describing: to)))"}
}

extension HealthClientTypes {
    /// A range of dates and times that is used by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html">EventFilter and <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html">EntityFilter objects. If from is set and to is set:
    ...
    public struct DateTimeRange: Swift.Equatable {
        ...
        public let from: ClientRuntime.Date?
        /// The ending date and time of a time range.
        public let to: ClientRuntime.Date?
...
public struct DescribeAffectedAccountsForOrganizationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAffectedAccountsForOrganizationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeAffectedAccountsForOrganizationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeAffectedAccountsForOrganizationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeAffectedAccountsForOrganizationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeAffectedAccountsForOrganizationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeAffectedAccountsForOrganizationOutputError>
}

extension DescribeAffectedAccountsForOrganizationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAffectedAccountsForOrganizationInput(eventArn: \(Swift.String(describing: eventArn)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeAffectedAccountsForOrganizationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case eventArn
        case maxResults
        case nextToken
...
public struct DescribeAffectedAccountsForOrganizationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAffectedAccountsForOrganizationInputHeadersMiddleware"
...
public struct DescribeAffectedAccountsForOrganizationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAffectedAccountsForOrganizationInputQueryItemMiddleware"
...
extension DescribeAffectedAccountsForOrganizationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAffectedAccountsForOrganizationOutputResponse(affectedAccounts: \(Swift.String(describing: affectedAccounts)), eventScopeCode: \(Swift.String(describing: eventScopeCode)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeAffectedAccountsForOrganizationOutputResponse: Swift.Equatable {
    ...
    public let affectedAccounts: [Swift.String]?
    ...
    ///
    ///
    public let eventScopeCode: HealthClientTypes.EventScopeCode?
    /// If the results of a search are large, only a portion of the
    /// results are returned, and a nextToken pagination token is returned in the response. To
    /// retrieve the next batch of results, reissue the search request and include the returned token.
    /// When all results have been returned, the response does not contain a pagination token value.
...
public struct DescribeAffectedEntitiesForOrganizationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAffectedEntitiesForOrganizationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeAffectedEntitiesForOrganizationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeAffectedEntitiesForOrganizationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeAffectedEntitiesForOrganizationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeAffectedEntitiesForOrganizationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeAffectedEntitiesForOrganizationOutputError>
}

extension DescribeAffectedEntitiesForOrganizationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAffectedEntitiesForOrganizationInput(locale: \(Swift.String(describing: locale)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), organizationEntityFilters: \(Swift.String(describing: organizationEntityFilters)))"}
}

extension DescribeAffectedEntitiesForOrganizationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case locale
        case maxResults
        case nextToken
...
public struct DescribeAffectedEntitiesForOrganizationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAffectedEntitiesForOrganizationInputHeadersMiddleware"
...
public struct DescribeAffectedEntitiesForOrganizationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAffectedEntitiesForOrganizationInputQueryItemMiddleware"
...
public struct DescribeAffectedEntitiesForOrganizationInput: Swift.Equatable {
    ...
    ///             eventArn.
    /// This member is required.
    public let organizationEntityFilters: [HealthClientTypes.EventAccountFilter]?
...
extension DescribeAffectedEntitiesForOrganizationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAffectedEntitiesForOrganizationOutputResponse(entities: \(Swift.String(describing: entities)), failedSet: \(Swift.String(describing: failedSet)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeAffectedEntitiesForOrganizationOutputResponse: Swift.Equatable {
    ...
    public let entities: [HealthClientTypes.AffectedEntity]?
    /// A JSON set of elements of the failed response, including the awsAccountId,
    ///             errorMessage, errorName, and eventArn.
    public let failedSet: [HealthClientTypes.OrganizationAffectedEntitiesErrorItem]?
    /// If the results of a search are large, only a portion of the
    /// results are returned, and a nextToken pagination token is returned in the response. To
    /// retrieve the next batch of results, reissue the search request and include the returned token.
    /// When all results have been returned, the response does not contain a pagination token value.
...
public struct DescribeAffectedEntitiesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAffectedEntitiesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeAffectedEntitiesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeAffectedEntitiesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeAffectedEntitiesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeAffectedEntitiesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeAffectedEntitiesOutputError>
}

extension DescribeAffectedEntitiesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAffectedEntitiesInput(filter: \(Swift.String(describing: filter)), locale: \(Swift.String(describing: locale)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeAffectedEntitiesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filter
        case locale
        case maxResults
...
public struct DescribeAffectedEntitiesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAffectedEntitiesInputHeadersMiddleware"
...
public struct DescribeAffectedEntitiesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAffectedEntitiesInputQueryItemMiddleware"
...
public struct DescribeAffectedEntitiesInput: Swift.Equatable {
    ...
    /// This member is required.
    public let filter: HealthClientTypes.EntityFilter?
    /// The locale (language) to return information in. English (en) is the default and the only supported value at this time.
    public let locale: Swift.String?
    /// The maximum number of items to return in one batch, between 10 and 100, inclusive.
    public let maxResults: Swift.Int?
...
extension DescribeAffectedEntitiesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAffectedEntitiesOutputResponse(entities: \(Swift.String(describing: entities)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeEntityAggregatesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEntityAggregatesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEntityAggregatesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEntityAggregatesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEntityAggregatesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEntityAggregatesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEntityAggregatesOutputError>
}

extension DescribeEntityAggregatesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEntityAggregatesInput(eventArns: \(Swift.String(describing: eventArns)))"}
}

extension DescribeEntityAggregatesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case eventArns
    }
...
public struct DescribeEntityAggregatesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEntityAggregatesInputHeadersMiddleware"
...
public struct DescribeEntityAggregatesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEntityAggregatesInputQueryItemMiddleware"
...
public struct DescribeEntityAggregatesInput: Swift.Equatable {
    ...
    ///
    public let eventArns: [Swift.String]?
...
extension DescribeEntityAggregatesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEntityAggregatesOutputResponse(entityAggregates: \(Swift.String(describing: entityAggregates)))"}
}
...
public struct DescribeEntityAggregatesOutputResponse: Swift.Equatable {
    ...
    public let entityAggregates: [HealthClientTypes.EntityAggregate]?
...
public struct DescribeEventAggregatesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventAggregatesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEventAggregatesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEventAggregatesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEventAggregatesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEventAggregatesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEventAggregatesOutputError>
}

extension DescribeEventAggregatesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventAggregatesInput(aggregateField: \(Swift.String(describing: aggregateField)), filter: \(Swift.String(describing: filter)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeEventAggregatesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case aggregateField
        case filter
        case maxResults
...
public struct DescribeEventAggregatesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventAggregatesInputHeadersMiddleware"
...
public struct DescribeEventAggregatesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventAggregatesInputQueryItemMiddleware"
...
public struct DescribeEventAggregatesInput: Swift.Equatable {
    ...
    /// This member is required.
    public let aggregateField: HealthClientTypes.EventAggregateField?
    /// Values to narrow the results returned.
    public let filter: HealthClientTypes.EventFilter?
    /// The maximum number of items to return in one batch, between 10 and 100, inclusive.
    public let maxResults: Swift.Int?
    /// If the results of a search are large, only a portion of the
    /// results are returned, and a nextToken pagination token is returned in the response. To
...
extension DescribeEventAggregatesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventAggregatesOutputResponse(eventAggregates: \(Swift.String(describing: eventAggregates)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeEventAggregatesOutputResponse: Swift.Equatable {
    ...
    public let eventAggregates: [HealthClientTypes.EventAggregate]?
    /// If the results of a search are large, only a portion of the
    /// results are returned, and a nextToken pagination token is returned in the response. To
    /// retrieve the next batch of results, reissue the search request and include the returned token.
    /// When all results have been returned, the response does not contain a pagination token value.
...
public struct DescribeEventDetailsForOrganizationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventDetailsForOrganizationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEventDetailsForOrganizationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEventDetailsForOrganizationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEventDetailsForOrganizationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEventDetailsForOrganizationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEventDetailsForOrganizationOutputError>
}

extension DescribeEventDetailsForOrganizationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventDetailsForOrganizationInput(locale: \(Swift.String(describing: locale)), organizationEventDetailFilters: \(Swift.String(describing: organizationEventDetailFilters)))"}
}

extension DescribeEventDetailsForOrganizationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case locale
...
public struct DescribeEventDetailsForOrganizationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventDetailsForOrganizationInputHeadersMiddleware"
...
public struct DescribeEventDetailsForOrganizationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventDetailsForOrganizationInputQueryItemMiddleware"
...
public struct DescribeEventDetailsForOrganizationInput: Swift.Equatable {
    ...
    ///             eventArn.
    /// This member is required.
    public let organizationEventDetailFilters: [HealthClientTypes.EventAccountFilter]?
...
extension DescribeEventDetailsForOrganizationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventDetailsForOrganizationOutputResponse(failedSet: \(Swift.String(describing: failedSet)), successfulSet: \(Swift.String(describing: successfulSet)))"}
}
...
public struct DescribeEventDetailsForOrganizationOutputResponse: Swift.Equatable {
    ...
    public let failedSet: [HealthClientTypes.OrganizationEventDetailsErrorItem]?
    /// Information about the events that could be retrieved.
    public let successfulSet: [HealthClientTypes.OrganizationEventDetails]?
...
public struct DescribeEventDetailsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventDetailsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEventDetailsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEventDetailsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEventDetailsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEventDetailsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEventDetailsOutputError>
}

extension DescribeEventDetailsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventDetailsInput(eventArns: \(Swift.String(describing: eventArns)), locale: \(Swift.String(describing: locale)))"}
}

extension DescribeEventDetailsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case eventArns
        case locale
    }
...
public struct DescribeEventDetailsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventDetailsInputHeadersMiddleware"
...
public struct DescribeEventDetailsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventDetailsInputQueryItemMiddleware"
...
extension DescribeEventDetailsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventDetailsOutputResponse(failedSet: \(Swift.String(describing: failedSet)), successfulSet: \(Swift.String(describing: successfulSet)))"}
}
...
public struct DescribeEventDetailsOutputResponse: Swift.Equatable {
    /// Error messages for any events that could not be retrieved.
    public let failedSet: [HealthClientTypes.EventDetailsErrorItem]?
    /// Information about the events that could be retrieved.
    public let successfulSet: [HealthClientTypes.EventDetails]?
...
public struct DescribeEventTypesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventTypesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEventTypesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEventTypesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEventTypesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEventTypesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEventTypesOutputError>
}

extension DescribeEventTypesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventTypesInput(filter: \(Swift.String(describing: filter)), locale: \(Swift.String(describing: locale)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeEventTypesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filter
        case locale
        case maxResults
...
public struct DescribeEventTypesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventTypesInputHeadersMiddleware"
...
public struct DescribeEventTypesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventTypesInputQueryItemMiddleware"
...
public struct DescribeEventTypesInput: Swift.Equatable {
    /// Values to narrow the results returned.
    public let filter: HealthClientTypes.EventTypeFilter?
    /// The locale (language) to return information in. English (en) is the default and the only supported value at this time.
    public let locale: Swift.String?
    /// The maximum number of items to return in one batch, between 10 and 100, inclusive.
    public let maxResults: Swift.Int?
...
extension DescribeEventTypesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventTypesOutputResponse(eventTypes: \(Swift.String(describing: eventTypes)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeEventTypesOutputResponse: Swift.Equatable {
    ...
    public let eventTypes: [HealthClientTypes.EventType]?
    /// If the results of a search are large, only a portion of the
    /// results are returned, and a nextToken pagination token is returned in the response. To
    /// retrieve the next batch of results, reissue the search request and include the returned token.
    /// When all results have been returned, the response does not contain a pagination token value.
...
public struct DescribeEventsForOrganizationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventsForOrganizationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEventsForOrganizationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEventsForOrganizationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEventsForOrganizationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEventsForOrganizationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEventsForOrganizationOutputError>
}

extension DescribeEventsForOrganizationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventsForOrganizationInput(filter: \(Swift.String(describing: filter)), locale: \(Swift.String(describing: locale)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeEventsForOrganizationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filter
        case locale
        case maxResults
...
public struct DescribeEventsForOrganizationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventsForOrganizationInputHeadersMiddleware"
...
public struct DescribeEventsForOrganizationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventsForOrganizationInputQueryItemMiddleware"
...
public struct DescribeEventsForOrganizationInput: Swift.Equatable {
    /// Values to narrow the results returned.
    public let filter: HealthClientTypes.OrganizationEventFilter?
    /// The locale (language) to return information in. English (en) is the default and the only supported value at this time.
    public let locale: Swift.String?
    /// The maximum number of items to return in one batch, between 10 and 100, inclusive.
    public let maxResults: Swift.Int?
...
extension DescribeEventsForOrganizationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventsForOrganizationOutputResponse(events: \(Swift.String(describing: events)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeEventsForOrganizationOutputResponse: Swift.Equatable {
    ...
    public let events: [HealthClientTypes.OrganizationEvent]?
    /// If the results of a search are large, only a portion of the
    /// results are returned, and a nextToken pagination token is returned in the response. To
    /// retrieve the next batch of results, reissue the search request and include the returned token.
    /// When all results have been returned, the response does not contain a pagination token value.
...
extension DescribeEventsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventsInput(filter: \(Swift.String(describing: filter)), locale: \(Swift.String(describing: locale)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeEventsOutputResponse: Swift.Equatable {
    /// The events that match the specified filter criteria.
    public let events: [HealthClientTypes.Event]?
    /// If the results of a search are large, only a portion of the
    /// results are returned, and a nextToken pagination token is returned in the response. To
    /// retrieve the next batch of results, reissue the search request and include the returned token.
    /// When all results have been returned, the response does not contain a pagination token value.
...
extension DescribeHealthServiceStatusForOrganizationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeHealthServiceStatusForOrganizationInput()"}
}

extension DescribeHealthServiceStatusForOrganizationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeHealthServiceStatusForOrganizationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeHealthServiceStatusForOrganizationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeHealthServiceStatusForOrganizationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeHealthServiceStatusForOrganizationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeHealthServiceStatusForOrganizationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeHealthServiceStatusForOrganizationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeHealthServiceStatusForOrganizationOutputError>
}

public struct DescribeHealthServiceStatusForOrganizationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeHealthServiceStatusForOrganizationInputQueryItemMiddleware"
...
extension DescribeHealthServiceStatusForOrganizationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeHealthServiceStatusForOrganizationOutputResponse(healthServiceAccessStatusForOrganization: \(Swift.String(describing: healthServiceAccessStatusForOrganization)))"}
}
...
public struct DescribeHealthServiceStatusForOrganizationOutputResponse: Swift.Equatable {
    ...
    public let healthServiceAccessStatusForOrganization: Swift.String?
...
extension DisableHealthServiceAccessForOrganizationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DisableHealthServiceAccessForOrganizationInput()"}
}

extension DisableHealthServiceAccessForOrganizationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DisableHealthServiceAccessForOrganizationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisableHealthServiceAccessForOrganizationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DisableHealthServiceAccessForOrganizationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DisableHealthServiceAccessForOrganizationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DisableHealthServiceAccessForOrganizationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DisableHealthServiceAccessForOrganizationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisableHealthServiceAccessForOrganizationOutputError>
}

public struct DisableHealthServiceAccessForOrganizationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisableHealthServiceAccessForOrganizationInputQueryItemMiddleware"
...
extension DisableHealthServiceAccessForOrganizationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DisableHealthServiceAccessForOrganizationOutputResponseBody: Swift.Equatable {
}

extension DisableHealthServiceAccessForOrganizationOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension EnableHealthServiceAccessForOrganizationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EnableHealthServiceAccessForOrganizationInput()"}
}

extension EnableHealthServiceAccessForOrganizationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct EnableHealthServiceAccessForOrganizationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "EnableHealthServiceAccessForOrganizationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<EnableHealthServiceAccessForOrganizationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<EnableHealthServiceAccessForOrganizationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<EnableHealthServiceAccessForOrganizationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<EnableHealthServiceAccessForOrganizationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<EnableHealthServiceAccessForOrganizationOutputError>
}

public struct EnableHealthServiceAccessForOrganizationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "EnableHealthServiceAccessForOrganizationInputQueryItemMiddleware"
...
extension EnableHealthServiceAccessForOrganizationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct EnableHealthServiceAccessForOrganizationOutputResponseBody: Swift.Equatable {
}

extension EnableHealthServiceAccessForOrganizationOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension HealthClientTypes.EntityAggregate: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case count
        case eventArn
    }
...
extension HealthClientTypes.EntityAggregate: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EntityAggregate(count: \(Swift.String(describing: count)), eventArn: \(Swift.String(describing: eventArn)))"}
}

extension HealthClientTypes {
    /// The number of entities that are affected by one or more events. Returned by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEntityAggregates.html">DescribeEntityAggregates operation.
...
extension HealthClientTypes.EntityFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case entityArns
        case entityValues
        case eventArns
...
extension HealthClientTypes.EntityFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EntityFilter(entityArns: \(Swift.String(describing: entityArns)), entityValues: \(Swift.String(describing: entityValues)), eventArns: \(Swift.String(describing: eventArns)), lastUpdatedTimes: \(Swift.String(describing: lastUpdatedTimes)), statusCodes: \(Swift.String(describing: statusCodes)), tags: \(Swift.String(describing: tags)))"}
}

extension HealthClientTypes {
    /// The values to use to filter results from the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html">EntityFilter
    ///          operation.
    public struct EntityFilter: Swift.Equatable {
        /// A list of entity ARNs (unique identifiers).
        public let entityArns: [Swift.String]?
        /// A list of IDs for affected entities.
        public let entityValues: [Swift.String]?
        /// A list of event ARNs (unique identifiers). For example: "arn:aws:health:us-east-1::event/EC2/EC2_INSTANCE_RETIREMENT_SCHEDULED/EC2_INSTANCE_RETIREMENT_SCHEDULED_ABC123-CDE456", "arn:aws:health:us-west-1::event/EBS/AWS_EBS_LOST_VOLUME/AWS_EBS_LOST_VOLUME_CHI789_JKL101"
        ///
        /// This member is required.
        public let eventArns: [Swift.String]?
        /// A list of the most recent dates and times that the entity was updated.
        public let lastUpdatedTimes: [HealthClientTypes.DateTimeRange]?
        /// A list of entity status codes (IMPAIRED, UNIMPAIRED, or
        ///             UNKNOWN).
        public let statusCodes: [HealthClientTypes.EntityStatusCode]?
        /// A map of entity tags attached to the affected entity.
        ///
        ///             Currently, the tags property isn't supported.
        ///
...
extension HealthClientTypes.Event: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
...
extension HealthClientTypes.Event: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Event(arn: \(Swift.String(describing: arn)), availabilityZone: \(Swift.String(describing: availabilityZone)), endTime: \(Swift.String(describing: endTime)), eventScopeCode: \(Swift.String(describing: eventScopeCode)), eventTypeCategory: \(Swift.String(describing: eventTypeCategory)), eventTypeCode: \(Swift.String(describing: eventTypeCode)), lastUpdatedTime: \(Swift.String(describing: lastUpdatedTime)), region: \(Swift.String(describing: region)), service: \(Swift.String(describing: service)), startTime: \(Swift.String(describing: startTime)), statusCode: \(Swift.String(describing: statusCode)))"}
}
...
extension HealthClientTypes {
    ...
    ///             eventScopeCode parameter. For more information, see <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_Event.html#AWSHealth-Type-Event-eventScopeCode">eventScopeCode.
    public struct Event: Swift.Equatable {
        ...
        public let eventTypeCategory: HealthClientTypes.EventTypeCategory?
        /// The unique identifier for the event type. The format is AWS_SERVICE_DESCRIPTION
        ///             ; for example, AWS_EC2_SYSTEM_MAINTENANCE_EVENT.
        public let eventTypeCode: Swift.String?
        ...
        ///             closed, and upcoming.
        public let statusCode: HealthClientTypes.EventStatusCode?
...
extension HealthClientTypes.EventAccountFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case awsAccountId
        case eventArn
    }
...
extension HealthClientTypes.EventAccountFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EventAccountFilter(awsAccountId: \(Swift.String(describing: awsAccountId)), eventArn: \(Swift.String(describing: eventArn)))"}
}

extension HealthClientTypes {
    /// The values used to filter results from the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventDetailsForOrganization.html">DescribeEventDetailsForOrganization and <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeAffectedEntitiesForOrganization.html">DescribeAffectedEntitiesForOrganization operations.
...
extension HealthClientTypes.EventAggregate: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case aggregateValue
        case count
    }
...
extension HealthClientTypes.EventAggregate: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EventAggregate(aggregateValue: \(Swift.String(describing: aggregateValue)), count: \(Swift.String(describing: count)))"}
}

extension HealthClientTypes {
    /// The number of events of each issue type. Returned by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventAggregates.html">DescribeEventAggregates operation.
    public struct EventAggregate: Swift.Equatable {
        /// The issue type for the associated count.
        public let aggregateValue: Swift.String?
...
extension HealthClientTypes.EventDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension HealthClientTypes.EventDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EventDescription(latestDescription: \(Swift.String(describing: latestDescription)))"}
}

extension HealthClientTypes {
    /// The detailed description of the event. Included in the information returned by the
    ///             <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventDetails.html">DescribeEventDetails operation.
    public struct EventDescription: Swift.Equatable {
        /// The most recent description of the event.
        public let latestDescription: Swift.String?
...
extension HealthClientTypes.EventDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case event
...
extension HealthClientTypes.EventDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EventDetails(event: \(Swift.String(describing: event)), eventDescription: \(Swift.String(describing: eventDescription)), eventMetadata: \(Swift.String(describing: eventMetadata)))"}
}

extension HealthClientTypes {
    /// Detailed information about an event. A combination of an <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_Event.html">Event object, an <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EventDescription.html">EventDescription object, and additional metadata about the event. Returned by
    ///          the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventDetails.html">DescribeEventDetails operation.
    public struct EventDetails: Swift.Equatable {
        /// Summary information about the event.
        public let event: HealthClientTypes.Event?
        /// The most recent description of the event.
        public let eventDescription: HealthClientTypes.EventDescription?
        /// Additional metadata about the event.
        public let eventMetadata: [Swift.String:Swift.String]?
...
extension HealthClientTypes.EventDetailsErrorItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case errorMessage
        case errorName
        case eventArn
...
extension HealthClientTypes.EventDetailsErrorItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EventDetailsErrorItem(errorMessage: \(Swift.String(describing: errorMessage)), errorName: \(Swift.String(describing: errorName)), eventArn: \(Swift.String(describing: eventArn)))"}
}

extension HealthClientTypes {
    /// Error information returned when a <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventDetails.html">DescribeEventDetails operation can't find a specified event.
...
extension HealthClientTypes.EventFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension HealthClientTypes.EventFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EventFilter(availabilityZones: \(Swift.String(describing: availabilityZones)), endTimes: \(Swift.String(describing: endTimes)), entityArns: \(Swift.String(describing: entityArns)), entityValues: \(Swift.String(describing: entityValues)), eventArns: \(Swift.String(describing: eventArns)), eventStatusCodes: \(Swift.String(describing: eventStatusCodes)), eventTypeCategories: \(Swift.String(describing: eventTypeCategories)), eventTypeCodes: \(Swift.String(describing: eventTypeCodes)), lastUpdatedTimes: \(Swift.String(describing: lastUpdatedTimes)), regions: \(Swift.String(describing: regions)), services: \(Swift.String(describing: services)), startTimes: \(Swift.String(describing: startTimes)), tags: \(Swift.String(describing: tags)))"}
}

extension HealthClientTypes {
    /// The values to use to filter results from the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEvents.html">DescribeEvents and
    ///             <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventAggregates.html">DescribeEventAggregates operations.
    public struct EventFilter: Swift.Equatable {
        /// A list of AWS Availability Zones.
        public let availabilityZones: [Swift.String]?
        /// A list of dates and times that the event ended.
        public let endTimes: [HealthClientTypes.DateTimeRange]?
        /// A list of entity ARNs (unique identifiers).
        public let entityArns: [Swift.String]?
        ...
        public let eventStatusCodes: [HealthClientTypes.EventStatusCode]?
        /// A list of event type category codes (issue, scheduledChange,
        ///          or accountNotification).
        public let eventTypeCategories: [HealthClientTypes.EventTypeCategory]?
        /// A list of unique identifiers for event types. For example, "AWS_EC2_SYSTEM_MAINTENANCE_EVENT","AWS_RDS_MAINTENANCE_SCHEDULED".
        ///
        public let eventTypeCodes: [Swift.String]?
        ...
        public let startTimes: [HealthClientTypes.DateTimeRange]?
        /// A map of entity tags attached to the affected entity.
        ///
        ///             Currently, the tags property isn't supported.
        ///
...
extension HealthClientTypes.EventType: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case category
        case code
        case service
...
extension HealthClientTypes.EventType: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EventType(category: \(Swift.String(describing: category)), code: \(Swift.String(describing: code)), service: \(Swift.String(describing: service)))"}
}
...
extension HealthClientTypes {
    ...
    ///          You can use the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventTypes.html">DescribeEventTypes API operation to return this information
    ///          about an event.
    ...
    ///          information, see <a href="https://docs.aws.amazon.com/health/latest/ug/cloudwatch-events-health.html">Monitor for AWS Health events with Amazon CloudWatch Events in the
    ///             AWS Health User Guide.
    public struct EventType: Swift.Equatable {
        /// A list of event type category codes (issue, scheduledChange,
        ///          or accountNotification).
        public let category: HealthClientTypes.EventTypeCategory?
        /// The unique identifier for the event type. The format is AWS_SERVICE_DESCRIPTION
        ///             ; for example, AWS_EC2_SYSTEM_MAINTENANCE_EVENT.
...
extension HealthClientTypes.EventTypeFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case eventTypeCategories
        case eventTypeCodes
        case services
...
extension HealthClientTypes.EventTypeFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EventTypeFilter(eventTypeCategories: \(Swift.String(describing: eventTypeCategories)), eventTypeCodes: \(Swift.String(describing: eventTypeCodes)), services: \(Swift.String(describing: services)))"}
}

extension HealthClientTypes {
    /// The values to use to filter results from the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventTypes.html">DescribeEventTypes
    ///          operation.
...
extension HealthClientTypes.OrganizationAffectedEntitiesErrorItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case awsAccountId
        case errorMessage
        case errorName
...
extension HealthClientTypes.OrganizationAffectedEntitiesErrorItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "OrganizationAffectedEntitiesErrorItem(awsAccountId: \(Swift.String(describing: awsAccountId)), errorMessage: \(Swift.String(describing: errorMessage)), errorName: \(Swift.String(describing: errorName)), eventArn: \(Swift.String(describing: eventArn)))"}
}

extension HealthClientTypes {
    /// Error information returned when a <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeAffectedEntitiesForOrganization.html">DescribeAffectedEntitiesForOrganization operation can't find or process a
    ///          specific entity.
...
extension HealthClientTypes.OrganizationEvent: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
        case endTime
        case eventScopeCode
...
extension HealthClientTypes.OrganizationEvent: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "OrganizationEvent(arn: \(Swift.String(describing: arn)), endTime: \(Swift.String(describing: endTime)), eventScopeCode: \(Swift.String(describing: eventScopeCode)), eventTypeCategory: \(Swift.String(describing: eventTypeCategory)), eventTypeCode: \(Swift.String(describing: eventTypeCode)), lastUpdatedTime: \(Swift.String(describing: lastUpdatedTime)), region: \(Swift.String(describing: region)), service: \(Swift.String(describing: service)), startTime: \(Swift.String(describing: startTime)), statusCode: \(Swift.String(describing: statusCode)))"}
}

extension HealthClientTypes {
    /// Summary information about an event, returned by the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventsForOrganization.html">DescribeEventsForOrganization operation.
...
extension HealthClientTypes.OrganizationEventDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case awsAccountId
        case event
        case eventDescription
...
extension HealthClientTypes.OrganizationEventDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "OrganizationEventDetails(awsAccountId: \(Swift.String(describing: awsAccountId)), event: \(Swift.String(describing: event)), eventDescription: \(Swift.String(describing: eventDescription)), eventMetadata: \(Swift.String(describing: eventMetadata)))"}
}

extension HealthClientTypes {
    /// Detailed information about an event. A combination of an <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_Event.html">Event object, an <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_EventDescription.html">EventDescription object, and additional metadata about the event. Returned by
    ///          the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventDetailsForOrganization.html">DescribeEventDetailsForOrganization operation.
...
extension HealthClientTypes.OrganizationEventDetailsErrorItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case awsAccountId
        case errorMessage
        case errorName
...
extension HealthClientTypes.OrganizationEventDetailsErrorItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "OrganizationEventDetailsErrorItem(awsAccountId: \(Swift.String(describing: awsAccountId)), errorMessage: \(Swift.String(describing: errorMessage)), errorName: \(Swift.String(describing: errorName)), eventArn: \(Swift.String(describing: eventArn)))"}
}

extension HealthClientTypes {
    /// Error information returned when a <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventDetailsForOrganization.html">DescribeEventDetailsForOrganization operation can't find a specified
    ///          event.
...
extension HealthClientTypes.OrganizationEventFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case awsAccountIds
        case endTime
        case entityArns
...
extension HealthClientTypes.OrganizationEventFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "OrganizationEventFilter(awsAccountIds: \(Swift.String(describing: awsAccountIds)), endTime: \(Swift.String(describing: endTime)), entityArns: \(Swift.String(describing: entityArns)), entityValues: \(Swift.String(describing: entityValues)), eventStatusCodes: \(Swift.String(describing: eventStatusCodes)), eventTypeCategories: \(Swift.String(describing: eventTypeCategories)), eventTypeCodes: \(Swift.String(describing: eventTypeCodes)), lastUpdatedTime: \(Swift.String(describing: lastUpdatedTime)), regions: \(Swift.String(describing: regions)), services: \(Swift.String(describing: services)), startTime: \(Swift.String(describing: startTime)))"}
}

extension HealthClientTypes {
    /// The values to filter results from the <a href="https://docs.aws.amazon.com/health/latest/APIReference/API_DescribeEventsForOrganization.html">DescribeEventsForOrganization operation.
    public struct OrganizationEventFilter: Swift.Equatable {
        ...
        ///          and to is set: match items where the timestamp value is equal to or before
        ///             to.
        public let endTime: HealthClientTypes.DateTimeRange?
        /// A list of entity ARNs (unique identifiers).
        public let entityArns: [Swift.String]?
        ...
        ///          and to is set: match items where the timestamp value is equal to or before
        ///             to.
        public let lastUpdatedTime: HealthClientTypes.DateTimeRange?
        /// A list of AWS Regions.
        public let regions: [Swift.String]?
        /// The AWS services associated with the event. For example, EC2, RDS.
        public let services: [Swift.String]?
        ...
        ///          and to is set: match items where the timestamp value is equal to or before
        ///             to.
        public let startTime: HealthClientTypes.DateTimeRange?
...
extension UnsupportedLocale: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UnsupportedLocale(message: \(Swift.String(describing: message)))"}
}
