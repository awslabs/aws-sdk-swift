...
public class HealthClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try HealthClientConfiguration(region: unwrappedRegion)
    ...
    public class HealthClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("HealthClient")
...
public struct HealthClientLogHandlerFactory: SDKLogHandlerFactory {
