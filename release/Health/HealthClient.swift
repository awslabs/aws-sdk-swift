...
extension HealthClient: HealthClientProtocol {
    ...
    ///          </note>
    public func describeAffectedAccountsForOrganization(input: DescribeAffectedAccountsForOrganizationInput, completion: @escaping (SdkResult<DescribeAffectedAccountsForOrganizationOutput, DescribeAffectedAccountsForOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<DescribeAffectedAccountsForOrganizationInput, DescribeAffectedAccountsForOrganizationOutput, DescribeAffectedAccountsForOrganizationOutputError>(id: "describeAffectedAccountsForOrganization")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAffectedAccountsForOrganizationInput, DescribeAffectedAccountsForOrganizationOutput, DescribeAffectedAccountsForOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeAffectedAccountsForOrganizationInput, DescribeAffectedAccountsForOrganizationOutput, DescribeAffectedAccountsForOrganizationOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeAffectedAccountsForOrganization"))
    ...
    ///             </ul>
    ///          </note>
    public func describeAffectedEntities(input: DescribeAffectedEntitiesInput, completion: @escaping (SdkResult<DescribeAffectedEntitiesOutput, DescribeAffectedEntitiesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAffectedEntitiesInput, DescribeAffectedEntitiesOutput, DescribeAffectedEntitiesOutputError>(id: "describeAffectedEntities")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAffectedEntitiesInput, DescribeAffectedEntitiesOutput, DescribeAffectedEntitiesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeAffectedEntitiesInput, DescribeAffectedEntitiesOutput, DescribeAffectedEntitiesOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeAffectedEntities"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///
    ///          </note>
    public func describeAffectedEntitiesForOrganization(input: DescribeAffectedEntitiesForOrganizationInput, completion: @escaping (SdkResult<DescribeAffectedEntitiesForOrganizationOutput, DescribeAffectedEntitiesForOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAffectedEntitiesForOrganizationInput, DescribeAffectedEntitiesForOrganizationOutput, DescribeAffectedEntitiesForOrganizationOutputError>(id: "describeAffectedEntitiesForOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAffectedEntitiesForOrganizationInput, DescribeAffectedEntitiesForOrganizationOutput, DescribeAffectedEntitiesForOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeAffectedEntitiesForOrganizationInput, DescribeAffectedEntitiesForOrganizationOutput, DescribeAffectedEntitiesForOrganizationOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeAffectedEntitiesForOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeEntityAggregates(input: DescribeEntityAggregatesInput, completion: @escaping (SdkResult<DescribeEntityAggregatesOutput, DescribeEntityAggregatesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeEntityAggregatesInput, DescribeEntityAggregatesOutput, DescribeEntityAggregatesOutputError>(id: "describeEntityAggregates")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeEntityAggregatesInput, DescribeEntityAggregatesOutput, DescribeEntityAggregatesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeEntityAggregatesInput, DescribeEntityAggregatesOutput, DescribeEntityAggregatesOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeEntityAggregates"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             <p>This API operation uses pagination. Specify the <code>nextToken</code> parameter in the next request to return more results.</p>
    ///          </note>
    public func describeEventAggregates(input: DescribeEventAggregatesInput, completion: @escaping (SdkResult<DescribeEventAggregatesOutput, DescribeEventAggregatesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeEventAggregatesInput, DescribeEventAggregatesOutput, DescribeEventAggregatesOutputError>(id: "describeEventAggregates")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeEventAggregatesInput, DescribeEventAggregatesOutput, DescribeEventAggregatesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeEventAggregatesInput, DescribeEventAggregatesOutput, DescribeEventAggregatesOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeEventAggregates"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///                   information, see <a href="https://docs.aws.amazon.com/health/latest/ug/security_iam_id-based-policy-examples.html#resource-action-based-conditions">Resource- and action-based conditions</a> in the <i>AWS Health User Guide</i>.</p>
    ///          </note>
    public func describeEventDetails(input: DescribeEventDetailsInput, completion: @escaping (SdkResult<DescribeEventDetailsOutput, DescribeEventDetailsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeEventDetailsInput, DescribeEventDetailsOutput, DescribeEventDetailsOutputError>(id: "describeEventDetails")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeEventDetailsInput, DescribeEventDetailsOutput, DescribeEventDetailsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeEventDetailsInput, DescribeEventDetailsOutput, DescribeEventDetailsOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeEventDetails"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///                   information, see <a href="https://docs.aws.amazon.com/health/latest/ug/security_iam_id-based-policy-examples.html#resource-action-based-conditions">Resource- and action-based conditions</a> in the <i>AWS Health User Guide</i>.</p>
    ///          </note>
    public func describeEventDetailsForOrganization(input: DescribeEventDetailsForOrganizationInput, completion: @escaping (SdkResult<DescribeEventDetailsForOrganizationOutput, DescribeEventDetailsForOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeEventDetailsForOrganizationInput, DescribeEventDetailsForOrganizationOutput, DescribeEventDetailsForOrganizationOutputError>(id: "describeEventDetailsForOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeEventDetailsForOrganizationInput, DescribeEventDetailsForOrganizationOutput, DescribeEventDetailsForOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeEventDetailsForOrganizationInput, DescribeEventDetailsForOrganizationOutput, DescribeEventDetailsForOrganizationOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeEventDetailsForOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             <p>This API operation uses pagination. Specify the <code>nextToken</code> parameter in the next request to return more results.</p>
    ///          </note>
    public func describeEventTypes(input: DescribeEventTypesInput, completion: @escaping (SdkResult<DescribeEventTypesOutput, DescribeEventTypesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeEventTypesInput, DescribeEventTypesOutput, DescribeEventTypesOutputError>(id: "describeEventTypes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeEventTypesInput, DescribeEventTypesOutput, DescribeEventTypesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeEventTypesInput, DescribeEventTypesOutput, DescribeEventTypesOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeEventTypes"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeEvents(input: DescribeEventsInput, completion: @escaping (SdkResult<DescribeEventsOutput, DescribeEventsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeEventsInput, DescribeEventsOutput, DescribeEventsOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeEvents"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             <p>This API operation uses pagination. Specify the <code>nextToken</code> parameter in the next request to return more results.</p>
    ///          </note>
    public func describeEventsForOrganization(input: DescribeEventsForOrganizationInput, completion: @escaping (SdkResult<DescribeEventsForOrganizationOutput, DescribeEventsForOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeEventsForOrganizationInput, DescribeEventsForOrganizationOutput, DescribeEventsForOrganizationOutputError>(id: "describeEventsForOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeEventsForOrganizationInput, DescribeEventsForOrganizationOutput, DescribeEventsForOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeEventsForOrganizationInput, DescribeEventsForOrganizationOutput, DescribeEventsForOrganizationOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeEventsForOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          management account.</p>
    public func describeHealthServiceStatusForOrganization(input: DescribeHealthServiceStatusForOrganizationInput, completion: @escaping (SdkResult<DescribeHealthServiceStatusForOrganizationOutput, DescribeHealthServiceStatusForOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeHealthServiceStatusForOrganizationInput, DescribeHealthServiceStatusForOrganizationOutput, DescribeHealthServiceStatusForOrganizationOutputError>(id: "describeHealthServiceStatusForOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeHealthServiceStatusForOrganizationInput, DescribeHealthServiceStatusForOrganizationOutput, DescribeHealthServiceStatusForOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeHealthServiceStatusForOrganizationInput, DescribeHealthServiceStatusForOrganizationOutput, DescribeHealthServiceStatusForOrganizationOutputError>(xAmzTarget: "AWSHealth_20160804.DescribeHealthServiceStatusForOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             account.</p>
    ///          </note>
    public func disableHealthServiceAccessForOrganization(input: DisableHealthServiceAccessForOrganizationInput, completion: @escaping (SdkResult<DisableHealthServiceAccessForOrganizationOutput, DisableHealthServiceAccessForOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DisableHealthServiceAccessForOrganizationInput, DisableHealthServiceAccessForOrganizationOutput, DisableHealthServiceAccessForOrganizationOutputError>(id: "disableHealthServiceAccessForOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DisableHealthServiceAccessForOrganizationInput, DisableHealthServiceAccessForOrganizationOutput, DisableHealthServiceAccessForOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DisableHealthServiceAccessForOrganizationInput, DisableHealthServiceAccessForOrganizationOutput, DisableHealthServiceAccessForOrganizationOutputError>(xAmzTarget: "AWSHealth_20160804.DisableHealthServiceAccessForOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func enableHealthServiceAccessForOrganization(input: EnableHealthServiceAccessForOrganizationInput, completion: @escaping (SdkResult<EnableHealthServiceAccessForOrganizationOutput, EnableHealthServiceAccessForOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "health")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<EnableHealthServiceAccessForOrganizationInput, EnableHealthServiceAccessForOrganizationOutput, EnableHealthServiceAccessForOrganizationOutputError>(id: "enableHealthServiceAccessForOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<EnableHealthServiceAccessForOrganizationInput, EnableHealthServiceAccessForOrganizationOutput, EnableHealthServiceAccessForOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<EnableHealthServiceAccessForOrganizationInput, EnableHealthServiceAccessForOrganizationOutput, EnableHealthServiceAccessForOrganizationOutputError>(xAmzTarget: "AWSHealth_20160804.EnableHealthServiceAccessForOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
