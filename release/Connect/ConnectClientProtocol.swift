...
public protocol ConnectClientProtocol {
    ...
    func associateApprovedOrigin(input: AssociateApprovedOriginInput, completion: @escaping (SdkResult<AssociateApprovedOriginOutput, AssociateApprovedOriginOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ...
    func associateInstanceStorageConfig(input: AssociateInstanceStorageConfigInput, completion: @escaping (SdkResult<AssociateInstanceStorageConfigOutput, AssociateInstanceStorageConfigOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Allows the specified Amazon Connect instance to access the specified Lambda function.</p>
    func associateLambdaFunction(input: AssociateLambdaFunctionInput, completion: @escaping (SdkResult<AssociateLambdaFunctionOutput, AssociateLambdaFunctionOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Allows the specified Amazon Connect instance to access the specified Amazon Lex bot.</p>
    func associateLexBot(input: AssociateLexBotInput, completion: @escaping (SdkResult<AssociateLexBotOutput, AssociateLexBotOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Associates a set of quick connects with a queue.</p>
    func associateQueueQuickConnects(input: AssociateQueueQuickConnectsInput, completion: @escaping (SdkResult<AssociateQueueQuickConnectsOutput, AssociateQueueQuickConnectsOutputError>) -> Void)
    /// <p>Associates a set of queues with a routing profile.</p>
    func associateRoutingProfileQueues(input: AssociateRoutingProfileQueuesInput, completion: @escaping (SdkResult<AssociateRoutingProfileQueuesOutput, AssociateRoutingProfileQueuesOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Associates a security key to the instance.</p>
    func associateSecurityKey(input: AssociateSecurityKeyInput, completion: @escaping (SdkResult<AssociateSecurityKeyOutput, AssociateSecurityKeyOutputError>) -> Void)
    /// <p>Creates a contact flow for the specified Amazon Connect instance.</p>
    ///          <p>You can also create and update contact flows using the <a href="https://docs.aws.amazon.com/connect/latest/adminguide/flow-language.html">Amazon Connect
    ///    Flow language</a>.</p>
    func createContactFlow(input: CreateContactFlowInput, completion: @escaping (SdkResult<CreateContactFlowOutput, CreateContactFlowOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ...
    func createIntegrationAssociation(input: CreateIntegrationAssociationInput, completion: @escaping (SdkResult<CreateIntegrationAssociationOutput, CreateIntegrationAssociationOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ...
    func createQuickConnect(input: CreateQuickConnectInput, completion: @escaping (SdkResult<CreateQuickConnectOutput, CreateQuickConnectOutputError>) -> Void)
    /// <p>Creates a new routing profile.</p>
    func createRoutingProfile(input: CreateRoutingProfileInput, completion: @escaping (SdkResult<CreateRoutingProfileOutput, CreateRoutingProfileOutputError>) -> Void)
    /// <p>Creates a use case for an AppIntegration association.</p>
    func createUseCase(input: CreateUseCaseInput, completion: @escaping (SdkResult<CreateUseCaseOutput, CreateUseCaseOutputError>) -> Void)
    ...
    func createUserHierarchyGroup(input: CreateUserHierarchyGroupInput, completion: @escaping (SdkResult<CreateUserHierarchyGroupOutput, CreateUserHierarchyGroupOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ...
    func deleteIntegrationAssociation(input: DeleteIntegrationAssociationInput, completion: @escaping (SdkResult<DeleteIntegrationAssociationOutput, DeleteIntegrationAssociationOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Deletes a quick connect.</p>
    func deleteQuickConnect(input: DeleteQuickConnectInput, completion: @escaping (SdkResult<DeleteQuickConnectOutput, DeleteQuickConnectOutputError>) -> Void)
    /// <p>Deletes a use case from an AppIntegration association.</p>
    func deleteUseCase(input: DeleteUseCaseInput, completion: @escaping (SdkResult<DeleteUseCaseOutput, DeleteUseCaseOutputError>) -> Void)
    ...
    func deleteUserHierarchyGroup(input: DeleteUserHierarchyGroupInput, completion: @escaping (SdkResult<DeleteUserHierarchyGroupOutput, DeleteUserHierarchyGroupOutputError>) -> Void)
    /// <p>Describes the specified contact flow.</p>
    ///          <p>You can also create and update contact flows using the <a href="https://docs.aws.amazon.com/connect/latest/adminguide/flow-language.html">Amazon Connect
    ///    Flow language</a>.</p>
    func describeContactFlow(input: DescribeContactFlowInput, completion: @escaping (SdkResult<DescribeContactFlowOutput, DescribeContactFlowOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Describes the hours of operation.</p>
    func describeHoursOfOperation(input: DescribeHoursOfOperationInput, completion: @escaping (SdkResult<DescribeHoursOfOperationOutput, DescribeHoursOfOperationOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ...
    func describeInstance(input: DescribeInstanceInput, completion: @escaping (SdkResult<DescribeInstanceOutput, DescribeInstanceOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ...
    func describeInstanceStorageConfig(input: DescribeInstanceStorageConfigInput, completion: @escaping (SdkResult<DescribeInstanceStorageConfigOutput, DescribeInstanceStorageConfigOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Describes the specified queue.</p>
    func describeQueue(input: DescribeQueueInput, completion: @escaping (SdkResult<DescribeQueueOutput, DescribeQueueOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Describes the quick connect.</p>
    func describeQuickConnect(input: DescribeQuickConnectInput, completion: @escaping (SdkResult<DescribeQuickConnectOutput, DescribeQuickConnectOutputError>) -> Void)
    /// <p>Describes the specified routing profile.</p>
    func describeRoutingProfile(input: DescribeRoutingProfileInput, completion: @escaping (SdkResult<DescribeRoutingProfileOutput, DescribeRoutingProfileOutputError>) -> Void)
    ...
    func describeUserHierarchyGroup(input: DescribeUserHierarchyGroupInput, completion: @escaping (SdkResult<DescribeUserHierarchyGroupOutput, DescribeUserHierarchyGroupOutputError>) -> Void)
    /// <p>Describes the hierarchy structure of the specified Amazon Connect instance.</p>
    func describeUserHierarchyStructure(input: DescribeUserHierarchyStructureInput, completion: @escaping (SdkResult<DescribeUserHierarchyStructureOutput, DescribeUserHierarchyStructureOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Revokes access to integrated applications from Amazon Connect.</p>
    func disassociateApprovedOrigin(input: DisassociateApprovedOriginInput, completion: @escaping (SdkResult<DisassociateApprovedOriginOutput, DisassociateApprovedOriginOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Removes the storage type configurations for the specified resource type and association
    ///    ID.</p>
    func disassociateInstanceStorageConfig(input: DisassociateInstanceStorageConfigInput, completion: @escaping (SdkResult<DisassociateInstanceStorageConfigOutput, DisassociateInstanceStorageConfigOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Remove the Lambda function from the dropdown options available in the relevant contact flow
    ///    blocks.</p>
    func disassociateLambdaFunction(input: DisassociateLambdaFunctionInput, completion: @escaping (SdkResult<DisassociateLambdaFunctionOutput, DisassociateLambdaFunctionOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Revokes authorization from the specified instance to access the specified Amazon Lex bot.</p>
    func disassociateLexBot(input: DisassociateLexBotInput, completion: @escaping (SdkResult<DisassociateLexBotOutput, DisassociateLexBotOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Disassociates a set of quick connects from a queue.</p>
    func disassociateQueueQuickConnects(input: DisassociateQueueQuickConnectsInput, completion: @escaping (SdkResult<DisassociateQueueQuickConnectsOutput, DisassociateQueueQuickConnectsOutputError>) -> Void)
    /// <p>Disassociates a set of queues from a routing profile.</p>
    func disassociateRoutingProfileQueues(input: DisassociateRoutingProfileQueuesInput, completion: @escaping (SdkResult<DisassociateRoutingProfileQueuesOutput, DisassociateRoutingProfileQueuesOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Deletes the specified security key.</p>
    func disassociateSecurityKey(input: DisassociateSecurityKeyInput, completion: @escaping (SdkResult<DisassociateSecurityKeyOutput, DisassociateSecurityKeyOutputError>) -> Void)
    /// <p>Retrieves the contact attributes for the specified contact.</p>
    func getContactAttributes(input: GetContactAttributesInput, completion: @escaping (SdkResult<GetContactAttributesOutput, GetContactAttributesOutputError>) -> Void)
    ...
    func getCurrentMetricData(input: GetCurrentMetricDataInput, completion: @escaping (SdkResult<GetCurrentMetricDataOutput, GetCurrentMetricDataOutputError>) -> Void)
    ...
    func listApprovedOrigins(input: ListApprovedOriginsInput, completion: @escaping (SdkResult<ListApprovedOriginsOutput, ListApprovedOriginsOutputError>) -> Void)
    ...
    func listContactFlows(input: ListContactFlowsInput, completion: @escaping (SdkResult<ListContactFlowsOutput, ListContactFlowsOutputError>) -> Void)
    ...
    func listHoursOfOperations(input: ListHoursOfOperationsInput, completion: @escaping (SdkResult<ListHoursOfOperationsOutput, ListHoursOfOperationsOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Returns a paginated list of all attribute types for the given instance.</p>
    func listInstanceAttributes(input: ListInstanceAttributesInput, completion: @escaping (SdkResult<ListInstanceAttributesOutput, ListInstanceAttributesOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ...
    ///    type.</p>
    func listInstanceStorageConfigs(input: ListInstanceStorageConfigsInput, completion: @escaping (SdkResult<ListInstanceStorageConfigsOutput, ListInstanceStorageConfigsOutputError>) -> Void)
    /// <p>Provides summary information about the AppIntegration associations for the specified Amazon Connect
    ///    instance.</p>
    func listIntegrationAssociations(input: ListIntegrationAssociationsInput, completion: @escaping (SdkResult<ListIntegrationAssociationsOutput, ListIntegrationAssociationsOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ...
    func listLambdaFunctions(input: ListLambdaFunctionsInput, completion: @escaping (SdkResult<ListLambdaFunctionsOutput, ListLambdaFunctionsOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Returns a paginated list of all the Amazon Lex bots currently associated with the
    ///    instance.</p>
    func listLexBots(input: ListLexBotsInput, completion: @escaping (SdkResult<ListLexBotsOutput, ListLexBotsOutputError>) -> Void)
    ...
    func listPhoneNumbers(input: ListPhoneNumbersInput, completion: @escaping (SdkResult<ListPhoneNumbersOutput, ListPhoneNumbersOutputError>) -> Void)
    /// <p>Provides information about the prompts for the specified Amazon Connect instance.</p>
    func listPrompts(input: ListPromptsInput, completion: @escaping (SdkResult<ListPromptsOutput, ListPromptsOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Lists the quick connects associated with a queue.</p>
    func listQueueQuickConnects(input: ListQueueQuickConnectsInput, completion: @escaping (SdkResult<ListQueueQuickConnectsOutput, ListQueueQuickConnectsOutputError>) -> Void)
    ...
    func listQuickConnects(input: ListQuickConnectsInput, completion: @escaping (SdkResult<ListQuickConnectsOutput, ListQuickConnectsOutputError>) -> Void)
    /// <p>Lists the queues associated with a routing profile.</p>
    func listRoutingProfileQueues(input: ListRoutingProfileQueuesInput, completion: @escaping (SdkResult<ListRoutingProfileQueuesOutput, ListRoutingProfileQueuesOutputError>) -> Void)
    ...
    func listRoutingProfiles(input: ListRoutingProfilesInput, completion: @escaping (SdkResult<ListRoutingProfilesOutput, ListRoutingProfilesOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Returns a paginated list of all security keys associated with the instance.</p>
    func listSecurityKeys(input: ListSecurityKeysInput, completion: @escaping (SdkResult<ListSecurityKeysOutput, ListSecurityKeysOutputError>) -> Void)
    ...
    ///     <i>Amazon Connect Administrator Guide</i>.</p>
    func listSecurityProfiles(input: ListSecurityProfilesInput, completion: @escaping (SdkResult<ListSecurityProfilesOutput, ListSecurityProfilesOutputError>) -> Void)
    ...
    func listUseCases(input: ListUseCasesInput, completion: @escaping (SdkResult<ListUseCasesOutput, ListUseCasesOutputError>) -> Void)
    ...
    ///     <i>Amazon Connect Administrator Guide</i>.</p>
    func listUserHierarchyGroups(input: ListUserHierarchyGroupsInput, completion: @escaping (SdkResult<ListUserHierarchyGroupsOutput, ListUserHierarchyGroupsOutputError>) -> Void)
    ...
    func resumeContactRecording(input: ResumeContactRecordingInput, completion: @escaping (SdkResult<ResumeContactRecordingOutput, ResumeContactRecordingOutputError>) -> Void)
    ...
    ///     Guide</i>.</p>
    func startChatContact(input: StartChatContactInput, completion: @escaping (SdkResult<StartChatContactOutput, StartChatContactOutputError>) -> Void)
    ...
    ///     behavior</a> block.</p>
    ///          <p>Only voice recordings are supported at this time.</p>
    func startContactRecording(input: StartContactRecordingInput, completion: @escaping (SdkResult<StartContactRecordingOutput, StartContactRecordingOutputError>) -> Void)
    ...
    ///          </note>
    func startOutboundVoiceContact(input: StartOutboundVoiceContactInput, completion: @escaping (SdkResult<StartOutboundVoiceContactOutput, StartOutboundVoiceContactOutputError>) -> Void)
    /// <p>Initiates a contact flow to start a new task.</p>
    func startTaskContact(input: StartTaskContactInput, completion: @escaping (SdkResult<StartTaskContactOutput, StartTaskContactOutputError>) -> Void)
    /// <p>Ends the specified contact.</p>
    func stopContact(input: StopContactInput, completion: @escaping (SdkResult<StopContactOutput, StopContactOutputError>) -> Void)
    ...
    ///
    ///          <p>Only voice recordings are supported at this time.</p>
    func stopContactRecording(input: StopContactRecordingInput, completion: @escaping (SdkResult<StopContactRecordingOutput, StopContactRecordingOutputError>) -> Void)
    ...
    ///    recording. </p>
    ///          <p>Only voice recordings are supported at this time.</p>
    func suspendContactRecording(input: SuspendContactRecordingInput, completion: @escaping (SdkResult<SuspendContactRecordingOutput, SuspendContactRecordingOutputError>) -> Void)
    ...
    func updateContactAttributes(input: UpdateContactAttributesInput, completion: @escaping (SdkResult<UpdateContactAttributesOutput, UpdateContactAttributesOutputError>) -> Void)
    /// <p>Updates the specified contact flow.</p>
    ///          <p>You can also create and update contact flows using the <a href="https://docs.aws.amazon.com/connect/latest/adminguide/flow-language.html">Amazon Connect
    ///    Flow language</a>.</p>
    func updateContactFlowContent(input: UpdateContactFlowContentInput, completion: @escaping (SdkResult<UpdateContactFlowContentOutput, UpdateContactFlowContentOutputError>) -> Void)
    /// <p>The name of the contact flow.</p>
    ///          <p>You can also create and update contact flows using the <a href="https://docs.aws.amazon.com/connect/latest/adminguide/flow-language.html">Amazon Connect
    ///    Flow language</a>.</p>
    func updateContactFlowName(input: UpdateContactFlowNameInput, completion: @escaping (SdkResult<UpdateContactFlowNameOutput, UpdateContactFlowNameOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Updates the value for the specified attribute type.</p>
    func updateInstanceAttribute(input: UpdateInstanceAttributeInput, completion: @escaping (SdkResult<UpdateInstanceAttributeOutput, UpdateInstanceAttributeOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Updates an existing configuration for a resource type. This API is idempotent.</p>
    func updateInstanceStorageConfig(input: UpdateInstanceStorageConfigInput, completion: @escaping (SdkResult<UpdateInstanceStorageConfigOutput, UpdateInstanceStorageConfigOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Updates the hours of operation for the specified queue.</p>
    func updateQueueHoursOfOperation(input: UpdateQueueHoursOfOperationInput, completion: @escaping (SdkResult<UpdateQueueHoursOfOperationOutput, UpdateQueueHoursOfOperationOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Updates the maximum number of contacts allowed in a queue before it is considered
    ///    full.</p>
    func updateQueueMaxContacts(input: UpdateQueueMaxContactsInput, completion: @escaping (SdkResult<UpdateQueueMaxContactsOutput, UpdateQueueMaxContactsOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Updates the name and description of a queue. At least <code>Name</code> or <code>Description</code> must be provided.</p>
    func updateQueueName(input: UpdateQueueNameInput, completion: @escaping (SdkResult<UpdateQueueNameOutput, UpdateQueueNameOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Updates the outbound caller ID name, number, and outbound whisper flow for a specified
    ///    queue.</p>
    func updateQueueOutboundCallerConfig(input: UpdateQueueOutboundCallerConfigInput, completion: @escaping (SdkResult<UpdateQueueOutboundCallerConfigOutput, UpdateQueueOutboundCallerConfigOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Updates the status of the queue.</p>
    func updateQueueStatus(input: UpdateQueueStatusInput, completion: @escaping (SdkResult<UpdateQueueStatusOutput, UpdateQueueStatusOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ///          <p>Updates the configuration settings for the specified quick connect.</p>
    func updateQuickConnectConfig(input: UpdateQuickConnectConfigInput, completion: @escaping (SdkResult<UpdateQuickConnectConfigOutput, UpdateQuickConnectConfigOutputError>) -> Void)
    /// <p>This API is in preview release for Amazon Connect and is subject to change.</p>
    ...
    func updateQuickConnectName(input: UpdateQuickConnectNameInput, completion: @escaping (SdkResult<UpdateQuickConnectNameOutput, UpdateQuickConnectNameOutputError>) -> Void)
    /// <p>Updates the channels that agents can handle in the Contact Control Panel (CCP) for a routing
    ///    profile.</p>
    func updateRoutingProfileConcurrency(input: UpdateRoutingProfileConcurrencyInput, completion: @escaping (SdkResult<UpdateRoutingProfileConcurrencyOutput, UpdateRoutingProfileConcurrencyOutputError>) -> Void)
    /// <p>Updates the default outbound queue of a routing profile.</p>
    func updateRoutingProfileDefaultOutboundQueue(input: UpdateRoutingProfileDefaultOutboundQueueInput, completion: @escaping (SdkResult<UpdateRoutingProfileDefaultOutboundQueueOutput, UpdateRoutingProfileDefaultOutboundQueueOutputError>) -> Void)
    ...
    func updateRoutingProfileName(input: UpdateRoutingProfileNameInput, completion: @escaping (SdkResult<UpdateRoutingProfileNameOutput, UpdateRoutingProfileNameOutputError>) -> Void)
    /// <p>Updates the properties associated with a set of queues for a routing profile.</p>
    func updateRoutingProfileQueues(input: UpdateRoutingProfileQueuesInput, completion: @escaping (SdkResult<UpdateRoutingProfileQueuesOutput, UpdateRoutingProfileQueuesOutputError>) -> Void)
    /// <p>Assigns the specified hierarchy group to the specified user.</p>
    func updateUserHierarchy(input: UpdateUserHierarchyInput, completion: @escaping (SdkResult<UpdateUserHierarchyOutput, UpdateUserHierarchyOutputError>) -> Void)
    /// <p>Updates the name of the user hierarchy group. </p>
    func updateUserHierarchyGroupName(input: UpdateUserHierarchyGroupNameInput, completion: @escaping (SdkResult<UpdateUserHierarchyGroupNameOutput, UpdateUserHierarchyGroupNameOutputError>) -> Void)
    /// <p>Updates the user hierarchy structure: add, remove, and rename user hierarchy levels.</p>
    func updateUserHierarchyStructure(input: UpdateUserHierarchyStructureInput, completion: @escaping (SdkResult<UpdateUserHierarchyStructureOutput, UpdateUserHierarchyStructureOutputError>) -> Void)
    ...
    ///          </important>
    func updateUserIdentityInfo(input: UpdateUserIdentityInfoInput, completion: @escaping (SdkResult<UpdateUserIdentityInfoOutput, UpdateUserIdentityInfoOutputError>) -> Void)
    /// <p>Updates the phone configuration settings for the specified user.</p>
    func updateUserPhoneConfig(input: UpdateUserPhoneConfigInput, completion: @escaping (SdkResult<UpdateUserPhoneConfigOutput, UpdateUserPhoneConfigOutputError>) -> Void)
    /// <p>Assigns the specified routing profile to the specified user.</p>
    func updateUserRoutingProfile(input: UpdateUserRoutingProfileInput, completion: @escaping (SdkResult<UpdateUserRoutingProfileOutput, UpdateUserRoutingProfileOutputError>) -> Void)
    /// <p>Assigns the specified security profiles to the specified user.</p>
    func updateUserSecurityProfiles(input: UpdateUserSecurityProfilesInput, completion: @escaping (SdkResult<UpdateUserSecurityProfilesOutput, UpdateUserSecurityProfilesOutputError>) -> Void)
}
