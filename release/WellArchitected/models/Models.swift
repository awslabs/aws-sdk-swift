...
extension WellArchitectedClientTypes.AnswerSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AnswerSummary(choices: \(Swift.String(describing: choices)), isApplicable: \(Swift.String(describing: isApplicable)), pillarId: \(Swift.String(describing: pillarId)), questionId: \(Swift.String(describing: questionId)), questionTitle: \(Swift.String(describing: questionTitle)), risk: \(Swift.String(describing: risk)), selectedChoices: \(Swift.String(describing: selectedChoices)))"}
}
...
extension UpdateAnswerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateAnswerInput(isApplicable: \(Swift.String(describing: isApplicable)), lensAlias: \(Swift.String(describing: lensAlias)), notes: \(Swift.String(describing: notes)), questionId: \(Swift.String(describing: questionId)), selectedChoices: \(Swift.String(describing: selectedChoices)), workloadId: \(Swift.String(describing: workloadId)))"}
}
