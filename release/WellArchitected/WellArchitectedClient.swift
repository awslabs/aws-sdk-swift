...
public class WellArchitectedClient {
    ...
    public class WellArchitectedClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("WellArchitectedClient")
