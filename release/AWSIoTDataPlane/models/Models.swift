...
public struct DeleteThingShadowInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteThingShadowInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteThingShadowInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteThingShadowOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteThingShadowOutputError>
}

public struct DeleteThingShadowInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteThingShadowInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/things/\(thingName.urlPercentEncoding())/shadow"
...
extension GetRetainedMessageInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRetainedMessageInput(topic: \(Swift.String(describing: topic)))"}
}

extension GetRetainedMessageInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetRetainedMessageInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRetainedMessageInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetRetainedMessageInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetRetainedMessageOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetRetainedMessageInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetRetainedMessageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRetainedMessageOutputError>
}

public struct GetRetainedMessageInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRetainedMessageInputQueryItemMiddleware"
...
public struct GetRetainedMessageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRetainedMessageInputURLHostMiddleware"
    ...
    public typealias MInput = GetRetainedMessageInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetRetainedMessageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRetainedMessageOutputError>
}

public struct GetRetainedMessageInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRetainedMessageInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let topic = input.topic else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("topic is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/retainedMessage/\(topic.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension GetRetainedMessageOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRetainedMessageOutputResponse(lastModifiedTime: \(Swift.String(describing: lastModifiedTime)), payload: \(Swift.String(describing: payload)), qos: \(Swift.String(describing: qos)), topic: \(Swift.String(describing: topic)))"}
}
...
public struct GetThingShadowInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetThingShadowInputURLHostMiddleware"
    ...
    public typealias MInput = GetThingShadowInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetThingShadowOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetThingShadowOutputError>
}

public struct GetThingShadowInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetThingShadowInputURLPathMiddleware"
...
public struct ListNamedShadowsForThingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListNamedShadowsForThingInputURLHostMiddleware"
    ...
    public typealias MInput = ListNamedShadowsForThingInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListNamedShadowsForThingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListNamedShadowsForThingOutputError>
}

public struct ListNamedShadowsForThingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListNamedShadowsForThingInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/api/things/shadow/ListNamedShadowsForThing/\(thingName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListRetainedMessagesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListRetainedMessagesInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListRetainedMessagesInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListRetainedMessagesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRetainedMessagesInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListRetainedMessagesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListRetainedMessagesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListRetainedMessagesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListRetainedMessagesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRetainedMessagesOutputError>
}

public struct ListRetainedMessagesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRetainedMessagesInputQueryItemMiddleware"
...
public struct ListRetainedMessagesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRetainedMessagesInputURLHostMiddleware"
    ...
    public typealias MInput = ListRetainedMessagesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListRetainedMessagesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRetainedMessagesOutputError>
}

public struct ListRetainedMessagesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRetainedMessagesInputURLPathMiddleware"
...
extension ListRetainedMessagesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListRetainedMessagesOutputResponse(nextToken: \(Swift.String(describing: nextToken)), retainedTopics: \(Swift.String(describing: retainedTopics)))"}
}
...
struct ListRetainedMessagesOutputResponseBody: Swift.Equatable {
    public let retainedTopics: [IotDataPlaneClientTypes.RetainedMessageSummary]?
    public let nextToken: Swift.String?
}
...
extension PublishInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PublishInput(payload: \(Swift.String(describing: payload)), qos: \(Swift.String(describing: qos)), retain: \(Swift.String(describing: retain)), topic: \(Swift.String(describing: topic)))"}
}
...
public struct PublishInputQueryItemMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        if input.operationInput.retain != false {
            let retainQueryItem = ClientRuntime.URLQueryItem(name: "retain".urlPercentEncoding(), value: Swift.String(input.operationInput.retain).urlPercentEncoding())
            input.builder.withQueryItem(retainQueryItem)
        }
        return next.handle(context: context, input: input)
    }
...
public struct PublishInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/topics/\(topic.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct PublishInput: Swift.Equatable {
    ...
    ///         true deletes the retained message identified by topic from IoT Core.
    public var payload: ClientRuntime.Data?
...
extension IotDataPlaneClientTypes.RetainedMessageSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case lastModifiedTime
        case payloadSize
        case qos
...
extension IotDataPlaneClientTypes.RetainedMessageSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RetainedMessageSummary(lastModifiedTime: \(Swift.String(describing: lastModifiedTime)), payloadSize: \(Swift.String(describing: payloadSize)), qos: \(Swift.String(describing: qos)), topic: \(Swift.String(describing: topic)))"}
}
...
public struct UpdateThingShadowInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateThingShadowInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateThingShadowInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateThingShadowOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateThingShadowOutputError>
}

public struct UpdateThingShadowInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateThingShadowInputURLPathMiddleware"
