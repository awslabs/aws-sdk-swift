...
public protocol KinesisVideoArchivedMediaClientProtocol {
    ...
    func getClip(input: GetClipInput, completion: @escaping (SdkResult<GetClipOutputResponse, GetClipOutputError>) -> Void)
    ...
    ///             </p>
    ///         </important>
    func getMediaForFragmentList(input: GetMediaForFragmentListInput, completion: @escaping (SdkResult<GetMediaForFragmentListOutputResponse, GetMediaForFragmentListOutputError>) -> Void)
