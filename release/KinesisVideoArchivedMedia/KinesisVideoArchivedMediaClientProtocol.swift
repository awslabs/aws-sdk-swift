...
public protocol KinesisVideoArchivedMediaClientProtocol {
    ...
    func getClip(input: GetClipInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetClipOutputResponse, GetClipOutputError>) -> Void)
    ...
    ///             </p>
    ///         </important>
    func getDASHStreamingSessionURL(input: GetDASHStreamingSessionURLInput, completion: @escaping (SdkResult<GetDASHStreamingSessionURLOutputResponse, GetDASHStreamingSessionURLOutputError>) -> Void)
    ...
    ///             </p>
    ///         </important>
    func getHLSStreamingSessionURL(input: GetHLSStreamingSessionURLInput, completion: @escaping (SdkResult<GetHLSStreamingSessionURLOutputResponse, GetHLSStreamingSessionURLOutputError>) -> Void)
    ...
    ///             </p>
    ///         </important>
    func getMediaForFragmentList(input: GetMediaForFragmentListInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetMediaForFragmentListOutputResponse, GetMediaForFragmentListOutputError>) -> Void)
    ...
    ///             </p>
    ///         </important>
    func listFragments(input: ListFragmentsInput, completion: @escaping (SdkResult<ListFragmentsOutputResponse, ListFragmentsOutputError>) -> Void)
}
