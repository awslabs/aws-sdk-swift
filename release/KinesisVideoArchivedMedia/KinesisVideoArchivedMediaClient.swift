...
extension KinesisVideoArchivedMediaClient: KinesisVideoArchivedMediaClientProtocol {
    ...
    public func getClip(input: GetClipInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetClipOutputResponse, GetClipOutputError>) -> Void)
    {
        let urlPath = "/getClip"
    ...
    ///             </p>
    ///         </important>
    public func getMediaForFragmentList(input: GetMediaForFragmentListInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetMediaForFragmentListOutputResponse, GetMediaForFragmentListOutputError>) -> Void)
    {
