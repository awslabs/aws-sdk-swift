...
public extension KinesisVideoArchivedMediaClient {
    ...
    func getClip(input: GetClipInput) async throws -> GetClipOutputResponse
    {
        typealias getClipContinuation = CheckedContinuation<GetClipOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getClipContinuation) in
            getClip(input: input) { result in
                switch result {
    ...
    ///             </p>
    ///         </important>
    func getDASHStreamingSessionURL(input: GetDASHStreamingSessionURLInput) async throws -> GetDASHStreamingSessionURLOutputResponse
    {
        typealias getDASHStreamingSessionURLContinuation = CheckedContinuation<GetDASHStreamingSessionURLOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getDASHStreamingSessionURLContinuation) in
            getDASHStreamingSessionURL(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </p>
    ///         </important>
    func getHLSStreamingSessionURL(input: GetHLSStreamingSessionURLInput) async throws -> GetHLSStreamingSessionURLOutputResponse
    {
        typealias getHLSStreamingSessionURLContinuation = CheckedContinuation<GetHLSStreamingSessionURLOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getHLSStreamingSessionURLContinuation) in
            getHLSStreamingSessionURL(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </p>
    ///         </important>
    func getMediaForFragmentList(input: GetMediaForFragmentListInput) async throws -> GetMediaForFragmentListOutputResponse
    {
        typealias getMediaForFragmentListContinuation = CheckedContinuation<GetMediaForFragmentListOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getMediaForFragmentListContinuation) in
            getMediaForFragmentList(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </p>
    ///         </important>
    func listFragments(input: ListFragmentsInput) async throws -> ListFragmentsOutputResponse
    {
        typealias listFragmentsContinuation = CheckedContinuation<ListFragmentsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listFragmentsContinuation) in
            listFragments(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
