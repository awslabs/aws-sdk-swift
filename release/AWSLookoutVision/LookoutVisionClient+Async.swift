...
public extension LookoutVisionClient {
    ...
    {
        typealias describeModelPackagingJobContinuation = CheckedContinuation<DescribeModelPackagingJobOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeModelPackagingJobContinuation) in
            describeModelPackagingJob(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listModelPackagingJobsContinuation = CheckedContinuation<ListModelPackagingJobsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listModelPackagingJobsContinuation) in
            listModelPackagingJobs(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias startModelPackagingJobContinuation = CheckedContinuation<StartModelPackagingJobOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startModelPackagingJobContinuation) in
            startModelPackagingJob(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
