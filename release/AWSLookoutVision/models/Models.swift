...
public struct CreateDatasetOutputResponse: Swift.Equatable {
    ...
    var datasetMetadata: LookoutVisionClientTypes.DatasetMetadata?
...
public struct CreateModelInput: Swift.Equatable {
    ...
    /// This member is required.
    var outputConfig: LookoutVisionClientTypes.OutputConfig?
    /// The name of the project in which you want to create a model version.
    /// This member is required.
    var projectName: Swift.String?
    /// A set of tags (key-value pairs) that you want to attach to the model.
    var tags: [LookoutVisionClientTypes.Tag]?
...
public struct CreateModelOutputResponse: Swift.Equatable {
    ...
    var modelMetadata: LookoutVisionClientTypes.ModelMetadata?
...
public struct CreateProjectOutputResponse: Swift.Equatable {
    ...
    var projectMetadata: LookoutVisionClientTypes.ProjectMetadata?
...
extension LookoutVisionClientTypes {
    ...
    public struct DatasetDescription: Swift.Equatable {
        ...
        var imageStats: LookoutVisionClientTypes.DatasetImageStats?
        /// The Unix timestamp for the date and time that the dataset was last updated.
        var lastUpdatedTimestamp: ClientRuntime.Date?
        /// The name of the project that contains the dataset.
        var projectName: Swift.String?
        /// The status of the dataset.
        var status: LookoutVisionClientTypes.DatasetStatus?
...
extension LookoutVisionClientTypes {
    ...
    public struct DatasetGroundTruthManifest: Swift.Equatable {
        ...
        var s3Object: LookoutVisionClientTypes.InputS3Object?
...
extension LookoutVisionClientTypes {
    ...
    public struct DatasetImageStats: Swift.Equatable {
        ...
        var anomaly: Swift.Int?
        /// The total number of labeled images.
        var labeled: Swift.Int?
        /// The total number of images labeled as normal.
        var normal: Swift.Int?
...
extension LookoutVisionClientTypes {
    ...
    public struct DatasetSource: Swift.Equatable {
        ...
        var groundTruthManifest: LookoutVisionClientTypes.DatasetGroundTruthManifest?
...
public struct DescribeDatasetOutputResponse: Swift.Equatable {
    ...
    var datasetDescription: LookoutVisionClientTypes.DatasetDescription?
...
public struct DescribeModelOutputResponse: Swift.Equatable {
    ...
    var modelDescription: LookoutVisionClientTypes.ModelDescription?
...
public struct DescribeModelPackagingJobOutputResponse: Swift.Equatable {
    ...
    var modelPackagingDescription: LookoutVisionClientTypes.ModelPackagingDescription?
...
public struct DescribeProjectOutputResponse: Swift.Equatable {
    ...
    var projectDescription: LookoutVisionClientTypes.ProjectDescription?
...
public struct DetectAnomaliesOutputResponse: Swift.Equatable {
    ...
    var detectAnomalyResult: LookoutVisionClientTypes.DetectAnomalyResult?
...
extension LookoutVisionClientTypes {
    ...
    public struct DetectAnomalyResult: Swift.Equatable {
        ...
        var source: LookoutVisionClientTypes.ImageSource?
...
extension LookoutVisionClientTypes {
    ...
    public struct GreengrassConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var compilerOptions: Swift.String?
        /// A description for the AWS IoT Greengrass component.
        var componentDescription: Swift.String?
        /// A name for the AWS IoT Greengrass component.
        /// This member is required.
        var componentName: Swift.String?
        /// A Version for the AWS IoT Greengrass component. If you don't provide a value, a default value of  Model Version.0.0 is used.
        var componentVersion: Swift.String?
        /// An S3 location in which Lookout for Vision stores the component artifacts.
        /// This member is required.
        var s3OutputLocation: LookoutVisionClientTypes.S3Location?
        ...
        var targetDevice: LookoutVisionClientTypes.TargetDevice?
        /// The target platform for the model. If you specify TargetPlatform, you can't specify TargetDevice.
        var targetPlatform: LookoutVisionClientTypes.TargetPlatform?
...
extension LookoutVisionClientTypes {
    ...
    public struct GreengrassOutputDetails: Swift.Equatable {
        ...
        var componentVersionArn: Swift.String?
...
public struct ListDatasetEntriesInput: Swift.Equatable {
    ...
    var afterCreationDate: ClientRuntime.Date?
    ...
    var anomalyClass: Swift.String?
    /// Only includes entries before the specified date in the response. For example, 2020-06-23T00:00:00.
    var beforeCreationDate: ClientRuntime.Date?
    ...
    var sourceRefContains: Swift.String?
...
public struct ListDatasetEntriesOutputResponse: Swift.Equatable {
    ...
    var datasetEntries: [Swift.String]?
...
public struct ListModelPackagingJobsOutputResponse: Swift.Equatable {
    ...
    var modelPackagingJobs: [LookoutVisionClientTypes.ModelPackagingJobMetadata]?
    /// If the previous response was incomplete (because there is more results to retrieve), Amazon Lookout for Vision returns a pagination token in the response. You can use this pagination token to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct ListModelsOutputResponse: Swift.Equatable {
    ...
    var models: [LookoutVisionClientTypes.ModelMetadata]?
...
public struct ListProjectsOutputResponse: Swift.Equatable {
    ...
    var projects: [LookoutVisionClientTypes.ProjectMetadata]?
...
extension LookoutVisionClientTypes {
    ...
    public struct ModelDescription: Swift.Equatable {
        ...
        var evaluationEndTimestamp: ClientRuntime.Date?
        /// The S3 location where Amazon Lookout for Vision saves the manifest file that was used to test the trained model and generate the performance scores.
        var evaluationManifest: LookoutVisionClientTypes.OutputS3Object?
        /// The S3 location where Amazon Lookout for Vision saves the performance metrics.
        var evaluationResult: LookoutVisionClientTypes.OutputS3Object?
        ...
        var performance: LookoutVisionClientTypes.ModelPerformance?
        /// The status of the model.
        var status: LookoutVisionClientTypes.ModelStatus?
...
extension LookoutVisionClientTypes {
    ...
    public struct ModelPackagingConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var greengrass: LookoutVisionClientTypes.GreengrassConfiguration?
...
extension LookoutVisionClientTypes {
    ...
    public struct ModelPackagingDescription: Swift.Equatable {
        ...
        var modelPackagingConfiguration: LookoutVisionClientTypes.ModelPackagingConfiguration?
        /// The description for the model packaging job.
        var modelPackagingJobDescription: Swift.String?
        /// The AWS service used to package the job. Currently Lookout for Vision can package jobs with AWS IoT Greengrass.
        var modelPackagingMethod: Swift.String?
        /// Information about the output of the model packaging job. For more information, see [DescribeModelPackagingJob].
        var modelPackagingOutputDetails: LookoutVisionClientTypes.ModelPackagingOutputDetails?
        /// The version of the model used in the model packaging job.
        var modelVersion: Swift.String?
        /// The name of the project that's associated with a model that's in the model package.
        var projectName: Swift.String?
        /// The status of the model packaging job.
        var status: LookoutVisionClientTypes.ModelPackagingJobStatus?
...
extension LookoutVisionClientTypes {
    ...
    public struct ModelPackagingOutputDetails: Swift.Equatable {
        ...
        var greengrass: LookoutVisionClientTypes.GreengrassOutputDetails?
...
extension LookoutVisionClientTypes {
    ...
    public struct OutputConfig: Swift.Equatable {
        ...
        /// This member is required.
        var s3Location: LookoutVisionClientTypes.S3Location?
...
extension LookoutVisionClientTypes {
    ...
    public struct ProjectDescription: Swift.Equatable {
        ...
        var datasets: [LookoutVisionClientTypes.DatasetMetadata]?
...
public struct StartModelInput: Swift.Equatable {
    ...
    /// This member is required.
    var minInferenceUnits: Swift.Int?
...
public struct StartModelOutputResponse: Swift.Equatable {
    ...
    var status: LookoutVisionClientTypes.ModelHostingStatus?
...
public struct StartModelPackagingJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var configuration: LookoutVisionClientTypes.ModelPackagingConfiguration?
...
extension LookoutVisionClientTypes {
    ...
    public struct TargetPlatform: Swift.Equatable {
        ...
        /// This member is required.
        var accelerator: LookoutVisionClientTypes.TargetPlatformAccelerator?
...
public struct UpdateDatasetEntriesInput: Swift.Equatable {
    ...
    /// This member is required.
    var changes: ClientRuntime.Data?
