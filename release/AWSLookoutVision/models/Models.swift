...
public struct CreateDatasetInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())/datasets"
...
public struct CreateModelInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())/models"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreateProjectInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2020-11-20/projects"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteDatasetInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let datasetType = input.datasetType else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("datasetType is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())/datasets/\(datasetType.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteModelInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let modelVersion = input.modelVersion else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("modelVersion is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())/models/\(modelVersion.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteProjectInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeModelPackagingJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeModelPackagingJobInput(jobName: \(Swift.String(describing: jobName)), projectName: \(Swift.String(describing: projectName)))"}
}

extension DescribeModelPackagingJobInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeModelPackagingJobInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeModelPackagingJobInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeModelPackagingJobInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeModelPackagingJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeModelPackagingJobInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeModelPackagingJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeModelPackagingJobOutputError>
}

public struct DescribeModelPackagingJobInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeModelPackagingJobInputQueryItemMiddleware"
...
public struct DescribeModelPackagingJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeModelPackagingJobInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeModelPackagingJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeModelPackagingJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeModelPackagingJobOutputError>
}

public struct DescribeModelPackagingJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeModelPackagingJobInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let jobName = input.jobName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("jobName is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())/modelpackagingjobs/\(jobName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeModelPackagingJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeModelPackagingJobOutputResponse(modelPackagingDescription: \(Swift.String(describing: modelPackagingDescription)))"}
}
...
struct DescribeModelPackagingJobOutputResponseBody: Swift.Equatable {
    public let modelPackagingDescription: LookoutVisionClientTypes.ModelPackagingDescription?
}
...
public struct DetectAnomaliesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DetectAnomaliesInputURLHostMiddleware"
    ...
    public typealias MInput = DetectAnomaliesInput
    public typealias MOutput = ClientRuntime.OperationOutput<DetectAnomaliesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DetectAnomaliesOutputError>
}

public struct DetectAnomaliesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DetectAnomaliesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())/models/\(modelVersion.urlPercentEncoding())/detect"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension LookoutVisionClientTypes.GreengrassConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension LookoutVisionClientTypes.GreengrassConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GreengrassConfiguration(compilerOptions: \(Swift.String(describing: compilerOptions)), componentDescription: \(Swift.String(describing: componentDescription)), componentName: \(Swift.String(describing: componentName)), componentVersion: \(Swift.String(describing: componentVersion)), s3OutputLocation: \(Swift.String(describing: s3OutputLocation)), tags: \(Swift.String(describing: tags)), targetDevice: \(Swift.String(describing: targetDevice)), targetPlatform: \(Swift.String(describing: targetPlatform)))"}
}
...
extension LookoutVisionClientTypes.GreengrassOutputDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case componentName = "ComponentName"
        case componentVersion = "ComponentVersion"
...
extension LookoutVisionClientTypes.GreengrassOutputDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GreengrassOutputDetails(componentName: \(Swift.String(describing: componentName)), componentVersion: \(Swift.String(describing: componentVersion)), componentVersionArn: \(Swift.String(describing: componentVersionArn)))"}
}
...
public struct ListDatasetEntriesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDatasetEntriesInputURLHostMiddleware"
    ...
    public typealias MInput = ListDatasetEntriesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListDatasetEntriesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListDatasetEntriesOutputError>
}

public struct ListDatasetEntriesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDatasetEntriesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())/datasets/\(datasetType.urlPercentEncoding())/entries"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListModelPackagingJobsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListModelPackagingJobsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), projectName: \(Swift.String(describing: projectName)))"}
}

extension ListModelPackagingJobsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListModelPackagingJobsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListModelPackagingJobsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListModelPackagingJobsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListModelPackagingJobsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListModelPackagingJobsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListModelPackagingJobsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListModelPackagingJobsOutputError>
}

public struct ListModelPackagingJobsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListModelPackagingJobsInputQueryItemMiddleware"
...
public struct ListModelPackagingJobsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListModelPackagingJobsInputURLHostMiddleware"
    ...
    public typealias MInput = ListModelPackagingJobsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListModelPackagingJobsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListModelPackagingJobsOutputError>
}

public struct ListModelPackagingJobsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListModelPackagingJobsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())/modelpackagingjobs"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListModelPackagingJobsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListModelPackagingJobsOutputResponse(modelPackagingJobs: \(Swift.String(describing: modelPackagingJobs)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListModelPackagingJobsOutputResponseBody: Swift.Equatable {
    public let modelPackagingJobs: [LookoutVisionClientTypes.ModelPackagingJobMetadata]?
    public let nextToken: Swift.String?
}
...
public struct ListTagsForResourceInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-11-20/tags/\(resourceArn.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension LookoutVisionClientTypes.ModelPackagingConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension LookoutVisionClientTypes.ModelPackagingConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModelPackagingConfiguration(greengrass: \(Swift.String(describing: greengrass)))"}
}
...
extension LookoutVisionClientTypes.ModelPackagingDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case creationTimestamp = "CreationTimestamp"
...
extension LookoutVisionClientTypes.ModelPackagingDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModelPackagingDescription(creationTimestamp: \(Swift.String(describing: creationTimestamp)), jobName: \(Swift.String(describing: jobName)), lastUpdatedTimestamp: \(Swift.String(describing: lastUpdatedTimestamp)), modelPackagingConfiguration: \(Swift.String(describing: modelPackagingConfiguration)), modelPackagingJobDescription: \(Swift.String(describing: modelPackagingJobDescription)), modelPackagingMethod: \(Swift.String(describing: modelPackagingMethod)), modelPackagingOutputDetails: \(Swift.String(describing: modelPackagingOutputDetails)), modelVersion: \(Swift.String(describing: modelVersion)), projectName: \(Swift.String(describing: projectName)), status: \(Swift.String(describing: status)), statusMessage: \(Swift.String(describing: statusMessage)))"}
}
...
extension LookoutVisionClientTypes.ModelPackagingJobMetadata: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case creationTimestamp = "CreationTimestamp"
        case jobName = "JobName"
        case lastUpdatedTimestamp = "LastUpdatedTimestamp"
...
extension LookoutVisionClientTypes.ModelPackagingJobMetadata: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModelPackagingJobMetadata(creationTimestamp: \(Swift.String(describing: creationTimestamp)), jobName: \(Swift.String(describing: jobName)), lastUpdatedTimestamp: \(Swift.String(describing: lastUpdatedTimestamp)), modelPackagingJobDescription: \(Swift.String(describing: modelPackagingJobDescription)), modelPackagingMethod: \(Swift.String(describing: modelPackagingMethod)), modelVersion: \(Swift.String(describing: modelVersion)), projectName: \(Swift.String(describing: projectName)), status: \(Swift.String(describing: status)), statusMessage: \(Swift.String(describing: statusMessage)))"}
}
...
extension LookoutVisionClientTypes.ModelPackagingOutputDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case greengrass = "Greengrass"
    }
...
extension LookoutVisionClientTypes.ModelPackagingOutputDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModelPackagingOutputDetails(greengrass: \(Swift.String(describing: greengrass)))"}
}
...
public struct StartModelInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartModelInputURLHostMiddleware"
    ...
    public typealias MInput = StartModelInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartModelOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartModelOutputError>
}

public struct StartModelInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartModelInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())/models/\(modelVersion.urlPercentEncoding())/start"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct StartModelPackagingJobInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartModelPackagingJobInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartModelPackagingJobInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartModelPackagingJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartModelPackagingJobInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartModelPackagingJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartModelPackagingJobOutputError>
}

extension StartModelPackagingJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartModelPackagingJobInput(clientToken: \(Swift.String(describing: clientToken)), configuration: \(Swift.String(describing: configuration)), description: \(Swift.String(describing: description)), jobName: \(Swift.String(describing: jobName)), modelVersion: \(Swift.String(describing: modelVersion)), projectName: \(Swift.String(describing: projectName)))"}
}

extension StartModelPackagingJobInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct StartModelPackagingJobInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartModelPackagingJobInputHeadersMiddleware"
...
public struct StartModelPackagingJobInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartModelPackagingJobInputQueryItemMiddleware"
...
public struct StartModelPackagingJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartModelPackagingJobInputURLHostMiddleware"
    ...
    public typealias MInput = StartModelPackagingJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartModelPackagingJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartModelPackagingJobOutputError>
}

public struct StartModelPackagingJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartModelPackagingJobInputURLPathMiddleware"
...
struct StartModelPackagingJobInputBody: Swift.Equatable {
    ...
    public let configuration: LookoutVisionClientTypes.ModelPackagingConfiguration?
    public let description: Swift.String?
}
...
extension StartModelPackagingJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartModelPackagingJobOutputResponse(jobName: \(Swift.String(describing: jobName)))"}
}
...
public struct StopModelInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopModelInputURLHostMiddleware"
    ...
    public typealias MInput = StopModelInput
    public typealias MOutput = ClientRuntime.OperationOutput<StopModelOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopModelOutputError>
}

public struct StopModelInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopModelInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-11-20/projects/\(projectName.urlPercentEncoding())/models/\(modelVersion.urlPercentEncoding())/stop"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension LookoutVisionClientTypes.TargetPlatform: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension LookoutVisionClientTypes.TargetPlatform: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TargetPlatform(accelerator: \(Swift.String(describing: accelerator)), arch: \(Swift.String(describing: arch)), os: \(Swift.String(describing: os)))"}
}
...
public struct UpdateDatasetEntriesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateDatasetEntriesInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateDatasetEntriesInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateDatasetEntriesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateDatasetEntriesOutputError>
}

public struct UpdateDatasetEntriesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateDatasetEntriesInputURLPathMiddleware"
