...
public protocol LookoutVisionClientProtocol {
    ...
    func describeModelPackagingJob(input: DescribeModelPackagingJobInput, completion: @escaping (ClientRuntime.SdkResult<DescribeModelPackagingJobOutputResponse, DescribeModelPackagingJobOutputError>) -> Void)
    ...
    func listModelPackagingJobs(input: ListModelPackagingJobsInput, completion: @escaping (ClientRuntime.SdkResult<ListModelPackagingJobsOutputResponse, ListModelPackagingJobsOutputError>) -> Void)
    ...
    func startModelPackagingJob(input: StartModelPackagingJobInput, completion: @escaping (ClientRuntime.SdkResult<StartModelPackagingJobOutputResponse, StartModelPackagingJobOutputError>) -> Void)
