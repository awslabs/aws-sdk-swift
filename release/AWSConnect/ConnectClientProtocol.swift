...
public protocol ConnectClientProtocol {
    ...
    func createContactFlowModule(input: CreateContactFlowModuleInput, completion: @escaping (ClientRuntime.SdkResult<CreateContactFlowModuleOutputResponse, CreateContactFlowModuleOutputError>) -> Void)
    ...
    func deleteContactFlow(input: DeleteContactFlowInput, completion: @escaping (ClientRuntime.SdkResult<DeleteContactFlowOutputResponse, DeleteContactFlowOutputError>) -> Void)
    /// Deletes the specified contact flow module.
    func deleteContactFlowModule(input: DeleteContactFlowModuleInput, completion: @escaping (ClientRuntime.SdkResult<DeleteContactFlowModuleOutputResponse, DeleteContactFlowModuleOutputError>) -> Void)
    ...
    func describeContactFlowModule(input: DescribeContactFlowModuleInput, completion: @escaping (ClientRuntime.SdkResult<DescribeContactFlowModuleOutputResponse, DescribeContactFlowModuleOutputError>) -> Void)
    ...
    func listContactFlowModules(input: ListContactFlowModulesInput, completion: @escaping (ClientRuntime.SdkResult<ListContactFlowModulesOutputResponse, ListContactFlowModulesOutputError>) -> Void)
    ...
    func listContactReferences(input: ListContactReferencesInput, completion: @escaping (ClientRuntime.SdkResult<ListContactReferencesOutputResponse, ListContactReferencesOutputError>) -> Void)
    ...
    func listSecurityProfilePermissions(input: ListSecurityProfilePermissionsInput, completion: @escaping (ClientRuntime.SdkResult<ListSecurityProfilePermissionsOutputResponse, ListSecurityProfilePermissionsOutputError>) -> Void)
    ...
    func startContactStreaming(input: StartContactStreamingInput, completion: @escaping (ClientRuntime.SdkResult<StartContactStreamingOutputResponse, StartContactStreamingOutputError>) -> Void)
    ...
    func stopContactStreaming(input: StopContactStreamingInput, completion: @escaping (ClientRuntime.SdkResult<StopContactStreamingOutputResponse, StopContactStreamingOutputError>) -> Void)
    ...
    func updateContactFlowMetadata(input: UpdateContactFlowMetadataInput, completion: @escaping (ClientRuntime.SdkResult<UpdateContactFlowMetadataOutputResponse, UpdateContactFlowMetadataOutputError>) -> Void)
    /// Updates specified contact flow module for the specified Amazon Connect instance.
    func updateContactFlowModuleContent(input: UpdateContactFlowModuleContentInput, completion: @escaping (ClientRuntime.SdkResult<UpdateContactFlowModuleContentOutputResponse, UpdateContactFlowModuleContentOutputError>) -> Void)
    /// Updates metadata about specified contact flow module.
    func updateContactFlowModuleMetadata(input: UpdateContactFlowModuleMetadataInput, completion: @escaping (ClientRuntime.SdkResult<UpdateContactFlowModuleMetadataOutputResponse, UpdateContactFlowModuleMetadataOutputError>) -> Void)
    ...
    func updateContactSchedule(input: UpdateContactScheduleInput, completion: @escaping (ClientRuntime.SdkResult<UpdateContactScheduleOutputResponse, UpdateContactScheduleOutputError>) -> Void)
