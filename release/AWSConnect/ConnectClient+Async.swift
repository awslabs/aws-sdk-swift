...
public extension ConnectClient {
    ...
    {
        typealias createContactFlowModuleContinuation = CheckedContinuation<CreateContactFlowModuleOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createContactFlowModuleContinuation) in
            createContactFlowModule(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteContactFlowContinuation = CheckedContinuation<DeleteContactFlowOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteContactFlowContinuation) in
            deleteContactFlow(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteContactFlowModuleContinuation = CheckedContinuation<DeleteContactFlowModuleOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteContactFlowModuleContinuation) in
            deleteContactFlowModule(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeContactFlowModuleContinuation = CheckedContinuation<DescribeContactFlowModuleOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeContactFlowModuleContinuation) in
            describeContactFlowModule(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listContactFlowModulesContinuation = CheckedContinuation<ListContactFlowModulesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listContactFlowModulesContinuation) in
            listContactFlowModules(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listContactReferencesContinuation = CheckedContinuation<ListContactReferencesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listContactReferencesContinuation) in
            listContactReferences(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listSecurityProfilePermissionsContinuation = CheckedContinuation<ListSecurityProfilePermissionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listSecurityProfilePermissionsContinuation) in
            listSecurityProfilePermissions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias startContactStreamingContinuation = CheckedContinuation<StartContactStreamingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startContactStreamingContinuation) in
            startContactStreaming(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias stopContactStreamingContinuation = CheckedContinuation<StopContactStreamingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopContactStreamingContinuation) in
            stopContactStreaming(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateContactFlowMetadataContinuation = CheckedContinuation<UpdateContactFlowMetadataOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateContactFlowMetadataContinuation) in
            updateContactFlowMetadata(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateContactFlowModuleContentContinuation = CheckedContinuation<UpdateContactFlowModuleContentOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateContactFlowModuleContentContinuation) in
            updateContactFlowModuleContent(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateContactFlowModuleMetadataContinuation = CheckedContinuation<UpdateContactFlowModuleMetadataOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateContactFlowModuleMetadataContinuation) in
            updateContactFlowModuleMetadata(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateContactScheduleContinuation = CheckedContinuation<UpdateContactScheduleOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateContactScheduleContinuation) in
            updateContactSchedule(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
