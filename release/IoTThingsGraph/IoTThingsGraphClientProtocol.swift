...
public protocol IoTThingsGraphClientProtocol {
    ...
    func associateEntityToThing(input: AssociateEntityToThingInput, completion: @escaping (SdkResult<AssociateEntityToThingOutput, AssociateEntityToThingOutputError>) -> Void)
    ...
    func createFlowTemplate(input: CreateFlowTemplateInput, completion: @escaping (SdkResult<CreateFlowTemplateOutput, CreateFlowTemplateOutputError>) -> Void)
    ...
    func createSystemInstance(input: CreateSystemInstanceInput, completion: @escaping (SdkResult<CreateSystemInstanceOutput, CreateSystemInstanceOutputError>) -> Void)
    /// <p>Creates a system. The system is validated against the entities in the
    ///          latest version of the user's namespace unless another namespace version is specified in the request.</p>
    func createSystemTemplate(input: CreateSystemTemplateInput, completion: @escaping (SdkResult<CreateSystemTemplateOutput, CreateSystemTemplateOutputError>) -> Void)
    ...
    func deleteFlowTemplate(input: DeleteFlowTemplateInput, completion: @escaping (SdkResult<DeleteFlowTemplateOutput, DeleteFlowTemplateOutputError>) -> Void)
    ...
    func deleteSystemInstance(input: DeleteSystemInstanceInput, completion: @escaping (SdkResult<DeleteSystemInstanceOutput, DeleteSystemInstanceOutputError>) -> Void)
    ...
    func deleteSystemTemplate(input: DeleteSystemTemplateInput, completion: @escaping (SdkResult<DeleteSystemTemplateOutput, DeleteSystemTemplateOutputError>) -> Void)
    /// <p>
    ...
    func deploySystemInstance(input: DeploySystemInstanceInput, completion: @escaping (SdkResult<DeploySystemInstanceOutput, DeploySystemInstanceOutputError>) -> Void)
    ...
    func deprecateFlowTemplate(input: DeprecateFlowTemplateInput, completion: @escaping (SdkResult<DeprecateFlowTemplateOutput, DeprecateFlowTemplateOutputError>) -> Void)
    /// <p>Deprecates the specified system.</p>
    func deprecateSystemTemplate(input: DeprecateSystemTemplateInput, completion: @escaping (SdkResult<DeprecateSystemTemplateOutput, DeprecateSystemTemplateOutputError>) -> Void)
    ...
    func dissociateEntityFromThing(input: DissociateEntityFromThingInput, completion: @escaping (SdkResult<DissociateEntityFromThingOutput, DissociateEntityFromThingOutputError>) -> Void)
    ...
    func getEntities(input: GetEntitiesInput, completion: @escaping (SdkResult<GetEntitiesOutput, GetEntitiesOutputError>) -> Void)
    ...
    func getFlowTemplate(input: GetFlowTemplateInput, completion: @escaping (SdkResult<GetFlowTemplateOutput, GetFlowTemplateOutputError>) -> Void)
    ...
    func getFlowTemplateRevisions(input: GetFlowTemplateRevisionsInput, completion: @escaping (SdkResult<GetFlowTemplateRevisionsOutput, GetFlowTemplateRevisionsOutputError>) -> Void)
    /// <p>Gets the status of a namespace deletion task.</p>
    func getNamespaceDeletionStatus(input: GetNamespaceDeletionStatusInput, completion: @escaping (SdkResult<GetNamespaceDeletionStatusOutput, GetNamespaceDeletionStatusOutputError>) -> Void)
    /// <p>Gets a system instance.</p>
    func getSystemInstance(input: GetSystemInstanceInput, completion: @escaping (SdkResult<GetSystemInstanceOutput, GetSystemInstanceOutputError>) -> Void)
    /// <p>Gets a system.</p>
    func getSystemTemplate(input: GetSystemTemplateInput, completion: @escaping (SdkResult<GetSystemTemplateOutput, GetSystemTemplateOutputError>) -> Void)
    ...
    func getSystemTemplateRevisions(input: GetSystemTemplateRevisionsInput, completion: @escaping (SdkResult<GetSystemTemplateRevisionsOutput, GetSystemTemplateRevisionsOutputError>) -> Void)
    /// <p>Gets the status of the specified upload.</p>
    func getUploadStatus(input: GetUploadStatusInput, completion: @escaping (SdkResult<GetUploadStatusOutput, GetUploadStatusOutputError>) -> Void)
    /// <p>Returns a list of objects that contain information about events in a flow execution.</p>
    func listFlowExecutionMessages(input: ListFlowExecutionMessagesInput, completion: @escaping (SdkResult<ListFlowExecutionMessagesOutput, ListFlowExecutionMessagesOutputError>) -> Void)
    ...
    func searchEntities(input: SearchEntitiesInput, completion: @escaping (SdkResult<SearchEntitiesOutput, SearchEntitiesOutputError>) -> Void)
    /// <p>Searches for AWS IoT Things Graph workflow execution instances.</p>
    func searchFlowExecutions(input: SearchFlowExecutionsInput, completion: @escaping (SdkResult<SearchFlowExecutionsOutput, SearchFlowExecutionsOutputError>) -> Void)
    /// <p>Searches for summary information about workflows.</p>
    func searchFlowTemplates(input: SearchFlowTemplatesInput, completion: @escaping (SdkResult<SearchFlowTemplatesOutput, SearchFlowTemplatesOutputError>) -> Void)
    /// <p>Searches for system instances in the user's account.</p>
    func searchSystemInstances(input: SearchSystemInstancesInput, completion: @escaping (SdkResult<SearchSystemInstancesOutput, SearchSystemInstancesOutputError>) -> Void)
    ...
    func searchSystemTemplates(input: SearchSystemTemplatesInput, completion: @escaping (SdkResult<SearchSystemTemplatesOutput, SearchSystemTemplatesOutputError>) -> Void)
    ...
    func searchThings(input: SearchThingsInput, completion: @escaping (SdkResult<SearchThingsOutput, SearchThingsOutputError>) -> Void)
    ...
    func undeploySystemInstance(input: UndeploySystemInstanceInput, completion: @escaping (SdkResult<UndeploySystemInstanceOutput, UndeploySystemInstanceOutputError>) -> Void)
    ...
    func updateFlowTemplate(input: UpdateFlowTemplateInput, completion: @escaping (SdkResult<UpdateFlowTemplateOutput, UpdateFlowTemplateOutputError>) -> Void)
    ...
    func updateSystemTemplate(input: UpdateSystemTemplateInput, completion: @escaping (SdkResult<UpdateSystemTemplateOutput, UpdateSystemTemplateOutputError>) -> Void)
    ...
    ///          </p>
    func uploadEntityDefinitions(input: UploadEntityDefinitionsInput, completion: @escaping (SdkResult<UploadEntityDefinitionsOutput, UploadEntityDefinitionsOutputError>) -> Void)
}
