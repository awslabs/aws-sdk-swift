...
public class IoTThingsGraphClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try IoTThingsGraphClientConfiguration(region: unwrappedRegion)
    ...
    public class IoTThingsGraphClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("IoTThingsGraphClient")
...
public struct IoTThingsGraphClientLogHandlerFactory: SDKLogHandlerFactory {
