...
private let servicePartitions = [
    AWSClientRuntime.Partition(
        ...
        endpoints: [
            ...
            "fips-dkr-us-east-1": ServiceEndpointMetadata(
                hostName: "ecr-fips.us-east-1.amazonaws.com",
                credentialScope: CredentialScope(region: "us-east-1")
            ),
            "fips-dkr-us-east-2": ServiceEndpointMetadata(
                hostName: "ecr-fips.us-east-2.amazonaws.com",
                credentialScope: CredentialScope(region: "us-east-2")
            ),
            "fips-dkr-us-west-1": ServiceEndpointMetadata(
                hostName: "ecr-fips.us-west-1.amazonaws.com",
                credentialScope: CredentialScope(region: "us-west-1")
            ),
            "fips-dkr-us-west-2": ServiceEndpointMetadata(
    ...
    AWSClientRuntime.Partition(
        ...
        endpoints: [
            "fips-dkr-us-gov-east-1": ServiceEndpointMetadata(
                hostName: "ecr-fips.us-gov-east-1.amazonaws.com",
                credentialScope: CredentialScope(region: "us-gov-east-1")
            ),
            "fips-dkr-us-gov-west-1": ServiceEndpointMetadata(
