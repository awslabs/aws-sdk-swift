...
public class EcrClient {
    ...
    public class EcrClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("EcrClient")
...
public struct EcrClientLogHandlerFactory: SDKLogHandlerFactory {
