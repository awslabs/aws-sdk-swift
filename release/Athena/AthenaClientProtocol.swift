...
public protocol AthenaClientProtocol {
    ...
    func batchGetNamedQuery(input: BatchGetNamedQueryInput, completion: @escaping (SdkResult<BatchGetNamedQueryOutput, BatchGetNamedQueryOutputError>) -> Void)
    ...
    func batchGetQueryExecution(input: BatchGetQueryExecutionInput, completion: @escaping (SdkResult<BatchGetQueryExecutionOutput, BatchGetQueryExecutionOutputError>) -> Void)
    ...
    func createDataCatalog(input: CreateDataCatalogInput, completion: @escaping (SdkResult<CreateDataCatalogOutput, CreateDataCatalogOutputError>) -> Void)
    ...
    ///                 Code Samples</a> in the <i>Amazon Athena User Guide</i>.</p>
    func createNamedQuery(input: CreateNamedQueryInput, completion: @escaping (SdkResult<CreateNamedQueryOutput, CreateNamedQueryOutputError>) -> Void)
    /// <p>Creates a prepared statement for use with SQL queries in Athena.</p>
    func createPreparedStatement(input: CreatePreparedStatementInput, completion: @escaping (SdkResult<CreatePreparedStatementOutput, CreatePreparedStatementOutputError>) -> Void)
    /// <p>Creates a workgroup with the specified name.</p>
    func createWorkGroup(input: CreateWorkGroupInput, completion: @escaping (SdkResult<CreateWorkGroupOutput, CreateWorkGroupOutputError>) -> Void)
    /// <p>Deletes a data catalog.</p>
    func deleteDataCatalog(input: DeleteDataCatalogInput, completion: @escaping (SdkResult<DeleteDataCatalogOutput, DeleteDataCatalogOutputError>) -> Void)
    /// <p>Deletes the named query if you have access to the workgroup in which the query was
    ///             saved.</p>
    ///         <p>For code samples using the AWS SDK for Java, see <a href="http://docs.aws.amazon.com/athena/latest/ug/code-samples.html">Examples and
    ///                 Code Samples</a> in the <i>Amazon Athena User Guide</i>.</p>
    func deleteNamedQuery(input: DeleteNamedQueryInput, completion: @escaping (SdkResult<DeleteNamedQueryOutput, DeleteNamedQueryOutputError>) -> Void)
    /// <p>Deletes the prepared statement with the specified name from the specified
    ///             workgroup.</p>
    func deletePreparedStatement(input: DeletePreparedStatementInput, completion: @escaping (SdkResult<DeletePreparedStatementOutput, DeletePreparedStatementOutputError>) -> Void)
    /// <p>Deletes the workgroup with the specified name. The primary workgroup cannot be
    ///             deleted.</p>
    func deleteWorkGroup(input: DeleteWorkGroupInput, completion: @escaping (SdkResult<DeleteWorkGroupOutput, DeleteWorkGroupOutputError>) -> Void)
    ...
    func getDataCatalog(input: GetDataCatalogInput, completion: @escaping (SdkResult<GetDataCatalogOutput, GetDataCatalogOutputError>) -> Void)
    /// <p>Returns information about a single query. Requires that you have access to the
    ///             workgroup in which the query was saved.</p>
    func getNamedQuery(input: GetNamedQueryInput, completion: @escaping (SdkResult<GetNamedQueryOutput, GetNamedQueryOutputError>) -> Void)
    /// <p>Retrieves the prepared statement with the specified name from the specified
    ///             workgroup.</p>
    func getPreparedStatement(input: GetPreparedStatementInput, completion: @escaping (SdkResult<GetPreparedStatementOutput, GetPreparedStatementOutputError>) -> Void)
    ...
    func getQueryExecution(input: GetQueryExecutionInput, completion: @escaping (SdkResult<GetQueryExecutionOutput, GetQueryExecutionOutputError>) -> Void)
    ...
    func getTableMetadata(input: GetTableMetadataInput, completion: @escaping (SdkResult<GetTableMetadataOutput, GetTableMetadataOutputError>) -> Void)
    /// <p>Returns information about the workgroup with the specified name.</p>
    func getWorkGroup(input: GetWorkGroupInput, completion: @escaping (SdkResult<GetWorkGroupOutput, GetWorkGroupOutputError>) -> Void)
    ...
    func listDataCatalogs(input: ListDataCatalogsInput, completion: @escaping (SdkResult<ListDataCatalogsOutput, ListDataCatalogsOutputError>) -> Void)
    /// <p>Returns a list of engine versions that are available to choose from, including the
    ///             Auto option.</p>
    func listEngineVersions(input: ListEngineVersionsInput, completion: @escaping (SdkResult<ListEngineVersionsOutput, ListEngineVersionsOutputError>) -> Void)
    ...
    ///         <p>For code samples using the AWS SDK for Java, see <a href="http://docs.aws.amazon.com/athena/latest/ug/code-samples.html">Examples and
    ///                 Code Samples</a> in the <i>Amazon Athena User Guide</i>.</p>
    func listNamedQueries(input: ListNamedQueriesInput, completion: @escaping (SdkResult<ListNamedQueriesOutput, ListNamedQueriesOutputError>) -> Void)
    /// <p>Lists the prepared statements in the specfied workgroup.</p>
    func listPreparedStatements(input: ListPreparedStatementsInput, completion: @escaping (SdkResult<ListPreparedStatementsOutput, ListPreparedStatementsOutputError>) -> Void)
    ...
    ///         <p>For code samples using the AWS SDK for Java, see <a href="http://docs.aws.amazon.com/athena/latest/ug/code-samples.html">Examples and
    ///                 Code Samples</a> in the <i>Amazon Athena User Guide</i>.</p>
    func listQueryExecutions(input: ListQueryExecutionsInput, completion: @escaping (SdkResult<ListQueryExecutionsOutput, ListQueryExecutionsOutputError>) -> Void)
    /// <p>Lists the metadata for the tables in the specified data catalog database.</p>
    func listTableMetadata(input: ListTableMetadataInput, completion: @escaping (SdkResult<ListTableMetadataOutput, ListTableMetadataOutputError>) -> Void)
    ...
    func listWorkGroups(input: ListWorkGroupsInput, completion: @escaping (SdkResult<ListWorkGroupsOutput, ListWorkGroupsOutputError>) -> Void)
    ...
    ///                 Code Samples</a> in the <i>Amazon Athena User Guide</i>.</p>
    func startQueryExecution(input: StartQueryExecutionInput, completion: @escaping (SdkResult<StartQueryExecutionOutput, StartQueryExecutionOutputError>) -> Void)
    /// <p>Stops a query execution. Requires you to have access to the workgroup in which the
    ///             query ran.</p>
    ///         <p>For code samples using the AWS SDK for Java, see <a href="http://docs.aws.amazon.com/athena/latest/ug/code-samples.html">Examples and
    ///                 Code Samples</a> in the <i>Amazon Athena User Guide</i>.</p>
    func stopQueryExecution(input: StopQueryExecutionInput, completion: @escaping (SdkResult<StopQueryExecutionOutput, StopQueryExecutionOutputError>) -> Void)
    ...
    func updateDataCatalog(input: UpdateDataCatalogInput, completion: @escaping (SdkResult<UpdateDataCatalogOutput, UpdateDataCatalogOutputError>) -> Void)
    /// <p>Updates a prepared statement.</p>
    func updatePreparedStatement(input: UpdatePreparedStatementInput, completion: @escaping (SdkResult<UpdatePreparedStatementOutput, UpdatePreparedStatementOutputError>) -> Void)
    /// <p>Updates the workgroup with the specified name. The workgroup's name cannot be
    ///             changed.</p>
    func updateWorkGroup(input: UpdateWorkGroupInput, completion: @escaping (SdkResult<UpdateWorkGroupOutput, UpdateWorkGroupOutputError>) -> Void)
}
