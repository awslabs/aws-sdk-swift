...
extension LexModelBuildingClientTypes {
    ...
    public struct BotAliasMetadata: Swift.Equatable {
        ...
        var botName: Swift.String?
        /// The version of the Amazon Lex bot to which the alias points.
        var botVersion: Swift.String?
        /// Checksum of the bot alias.
        var checksum: Swift.String?
        /// Settings that determine how Amazon Lex uses conversation logs for the alias.
        var conversationLogs: LexModelBuildingClientTypes.ConversationLogsResponse?
...
extension LexModelBuildingClientTypes {
    ...
    public struct BotChannelAssociation: Swift.Equatable {
        ...
        var botAlias: Swift.String?
        /// Provides information necessary to communicate with the messaging platform.
        var botConfiguration: [Swift.String:Swift.String]?
        ...
        var status: LexModelBuildingClientTypes.ChannelStatus?
        /// Specifies the type of association by indicating the type of channel being established between the Amazon Lex bot and the external messaging platform.
        var type: LexModelBuildingClientTypes.ChannelType?
...
extension LexModelBuildingClientTypes {
    ...
    public struct BotMetadata: Swift.Equatable {
        ...
        var status: LexModelBuildingClientTypes.Status?
...
extension LexModelBuildingClientTypes {
    ...
    public struct BuiltinIntentMetadata: Swift.Equatable {
        ...
        var supportedLocales: [LexModelBuildingClientTypes.Locale]?
...
extension LexModelBuildingClientTypes {
    ...
    public struct CodeHook: Swift.Equatable {
        ...
        var messageVersion: Swift.String?
...
extension LexModelBuildingClientTypes {
    ...
    public struct ConversationLogsRequest: Swift.Equatable {
        ...
        /// This member is required.
        var logSettings: [LexModelBuildingClientTypes.LogSettingsRequest]?
...
extension LexModelBuildingClientTypes {
    ...
    public struct ConversationLogsResponse: Swift.Equatable {
        ...
        var logSettings: [LexModelBuildingClientTypes.LogSettingsResponse]?
...
public struct CreateBotVersionOutputResponse: Swift.Equatable {
    ...
    var abortStatement: LexModelBuildingClientTypes.Statement?
    ...
    var childDirected: Swift.Bool?
    /// The message that Amazon Lex uses when it doesn't understand the user's request. For more information, see [PutBot].
    var clarificationPrompt: LexModelBuildingClientTypes.Prompt?
    /// The date when the bot version was created.
    var createdDate: ClientRuntime.Date?
    /// A description of the bot.
    var description: Swift.String?
    /// Indicates whether utterances entered by the user should be sent to Amazon Comprehend for sentiment analysis.
    var detectSentiment: Swift.Bool?
    /// Indicates whether the bot uses accuracy improvements. true indicates that the bot is using the improvements, otherwise, false.
    var enableModelImprovements: Swift.Bool?
    /// If status is FAILED, Amazon Lex provides the reason that it failed to build the bot.
    var failureReason: Swift.String?
    /// The maximum time in seconds that Amazon Lex retains the data gathered in a conversation. For more information, see [PutBot].
    var idleSessionTTLInSeconds: Swift.Int?
    /// An array of Intent objects. For more information, see [PutBot].
    var intents: [LexModelBuildingClientTypes.Intent]?
    /// The date when the $LATEST version of this bot was updated.
    var lastUpdatedDate: ClientRuntime.Date?
    /// Specifies the target locale for the bot.
    var locale: LexModelBuildingClientTypes.Locale?
    /// The name of the bot.
    var name: Swift.String?
...
public struct CreateIntentVersionOutputResponse: Swift.Equatable {
    ...
    var conclusionStatement: LexModelBuildingClientTypes.Statement?
    /// If defined, the prompt that Amazon Lex uses to confirm the user's intent before fulfilling it.
    var confirmationPrompt: LexModelBuildingClientTypes.Prompt?
    /// The date that the intent was created.
    var createdDate: ClientRuntime.Date?
    /// A description of the intent.
    var description: Swift.String?
    /// If defined, Amazon Lex invokes this Lambda function for each user input.
    var dialogCodeHook: LexModelBuildingClientTypes.CodeHook?
    /// If defined, Amazon Lex uses this prompt to solicit additional user activity after the intent is fulfilled.
    var followUpPrompt: LexModelBuildingClientTypes.FollowUpPrompt?
    /// Describes how the intent is fulfilled.
    var fulfillmentActivity: LexModelBuildingClientTypes.FulfillmentActivity?
    /// An array of InputContext objects that lists the contexts that must be active for Amazon Lex to choose the intent in a conversation with the user.
    var inputContexts: [LexModelBuildingClientTypes.InputContext]?
    /// Configuration information, if any, for connecting an Amazon Kendra index with the AMAZON.KendraSearchIntent intent.
    var kendraConfiguration: LexModelBuildingClientTypes.KendraConfiguration?
    /// The date that the intent was updated.
    var lastUpdatedDate: ClientRuntime.Date?
    /// The name of the intent.
    var name: Swift.String?
    /// An array of OutputContext objects that lists the contexts that the intent activates when the intent is fulfilled.
    var outputContexts: [LexModelBuildingClientTypes.OutputContext]?
    /// A unique identifier for a built-in intent.
    var parentIntentSignature: Swift.String?
    /// If the user answers "no" to the question defined in confirmationPrompt, Amazon Lex responds with this statement to acknowledge that the intent was canceled.
    var rejectionStatement: LexModelBuildingClientTypes.Statement?
    /// An array of sample utterances configured for the intent.
    var sampleUtterances: [Swift.String]?
    /// An array of slot types that defines the information required to fulfill the intent.
    var slots: [LexModelBuildingClientTypes.Slot]?
...
public struct CreateSlotTypeVersionOutputResponse: Swift.Equatable {
    ...
    var enumerationValues: [LexModelBuildingClientTypes.EnumerationValue]?
    /// The date that the slot type was updated. When you create a resource, the creation date and last update date are the same.
    var lastUpdatedDate: ClientRuntime.Date?
    /// The name of the slot type.
    var name: Swift.String?
    /// The built-in slot type used a the parent of the slot type.
    var parentSlotTypeSignature: Swift.String?
    /// Configuration information that extends the parent built-in slot type.
    var slotTypeConfigurations: [LexModelBuildingClientTypes.SlotTypeConfiguration]?
    /// The strategy that Amazon Lex uses to determine the value of the slot. For more information, see [PutSlotType].
    var valueSelectionStrategy: LexModelBuildingClientTypes.SlotValueSelectionStrategy?
...
extension LexModelBuildingClientTypes {
    ...
    public struct FollowUpPrompt: Swift.Equatable {
        ...
        /// This member is required.
        var prompt: LexModelBuildingClientTypes.Prompt?
...
extension LexModelBuildingClientTypes {
    ...
    public struct FulfillmentActivity: Swift.Equatable {
        ...
        var codeHook: LexModelBuildingClientTypes.CodeHook?
        /// How the intent should be fulfilled, either by running a Lambda function or by returning the slot data to the client application.
        /// This member is required.
        var type: LexModelBuildingClientTypes.FulfillmentActivityType?
...
public struct GetBotAliasesOutputResponse: Swift.Equatable {
    ...
    var botAliases: [LexModelBuildingClientTypes.BotAliasMetadata]?
...
public struct GetBotChannelAssociationsOutputResponse: Swift.Equatable {
    ...
    var botChannelAssociations: [LexModelBuildingClientTypes.BotChannelAssociation]?
...
public struct GetBotInput: Swift.Equatable {
    ...
    /// This member is required.
    var versionOrAlias: Swift.String?
...
public struct GetBotOutputResponse: Swift.Equatable {
    ...
    var nluIntentConfidenceThreshold: Swift.Double?
...
public struct GetBotVersionsOutputResponse: Swift.Equatable {
    ...
    var bots: [LexModelBuildingClientTypes.BotMetadata]?
    /// A pagination token for fetching the next page of bot versions. If the response to this call is truncated, Amazon Lex returns a pagination token in the response. To fetch the next page of versions, specify the pagination token in the next request.
    var nextToken: Swift.String?
...
public struct GetBuiltinIntentOutputResponse: Swift.Equatable {
    ...
    var slots: [LexModelBuildingClientTypes.BuiltinIntentSlot]?
...
public struct GetBuiltinIntentsInput: Swift.Equatable {
    ...
    var signatureContains: Swift.String?
...
public struct GetBuiltinIntentsOutputResponse: Swift.Equatable {
    ...
    var intents: [LexModelBuildingClientTypes.BuiltinIntentMetadata]?
...
public struct GetBuiltinSlotTypesOutputResponse: Swift.Equatable {
    ...
    var slotTypes: [LexModelBuildingClientTypes.BuiltinSlotTypeMetadata]?
...
public struct GetExportInput: Swift.Equatable {
    ...
    /// This member is required.
    var exportType: LexModelBuildingClientTypes.ExportType?
    /// The name of the bot to export.
    /// This member is required.
    var name: Swift.String?
    /// The type of resource to export.
    /// This member is required.
    var resourceType: LexModelBuildingClientTypes.ResourceType?
...
public struct GetExportOutputResponse: Swift.Equatable {
    ...
    var exportStatus: LexModelBuildingClientTypes.ExportStatus?
    /// The format of the exported data.
    var exportType: LexModelBuildingClientTypes.ExportType?
...
public struct GetImportOutputResponse: Swift.Equatable {
    ...
    var importStatus: LexModelBuildingClientTypes.ImportStatus?
    /// The action taken when there was a conflict between an existing resource and a resource in the import file.
    var mergeStrategy: LexModelBuildingClientTypes.MergeStrategy?
...
public struct GetIntentVersionsOutputResponse: Swift.Equatable {
    ...
    var intents: [LexModelBuildingClientTypes.IntentMetadata]?
    /// A pagination token for fetching the next page of intent versions. If the response to this call is truncated, Amazon Lex returns a pagination token in the response. To fetch the next page of versions, specify the pagination token in the next request.
    var nextToken: Swift.String?
...
public struct GetMigrationOutputResponse: Swift.Equatable {
    ...
    var alerts: [LexModelBuildingClientTypes.MigrationAlert]?
    ...
    var migrationStatus: LexModelBuildingClientTypes.MigrationStatus?
    ...
    var migrationStrategy: LexModelBuildingClientTypes.MigrationStrategy?
    /// The date and time that the migration started.
    var migrationTimestamp: ClientRuntime.Date?
    /// The locale of the Amazon Lex V1 bot migrated to Amazon Lex V2.
    var v1BotLocale: LexModelBuildingClientTypes.Locale?
    /// The name of the Amazon Lex V1 bot migrated to Amazon Lex V2.
    var v1BotName: Swift.String?
    /// The version of the Amazon Lex V1 bot migrated to Amazon Lex V2.
    var v1BotVersion: Swift.String?
    /// The unique identifier of the Amazon Lex V2 bot that the Amazon Lex V1 is being migrated to.
    var v2BotId: Swift.String?
    /// The IAM role that Amazon Lex uses to run the Amazon Lex V2 bot.
    var v2BotRole: Swift.String?
...
public struct GetMigrationsInput: Swift.Equatable {
    ...
    var migrationStatusEquals: LexModelBuildingClientTypes.MigrationStatus?
    ...
    var sortByAttribute: LexModelBuildingClientTypes.MigrationSortAttribute?
    /// The order so sort the list.
    var sortByOrder: LexModelBuildingClientTypes.SortOrder?
    ...
    var v1BotNameContains: Swift.String?
...
public struct GetMigrationsOutputResponse: Swift.Equatable {
    ...
    var migrationSummaries: [LexModelBuildingClientTypes.MigrationSummary]?
...
public struct GetSlotTypeVersionsOutputResponse: Swift.Equatable {
    ...
    var slotTypes: [LexModelBuildingClientTypes.SlotTypeMetadata]?
...
public struct GetUtterancesViewInput: Swift.Equatable {
    ...
    /// This member is required.
    var botVersions: [Swift.String]?
    /// To return utterances that were recognized and handled, use Detected. To return utterances that were not recognized, use Missed.
    /// This member is required.
    var statusType: LexModelBuildingClientTypes.StatusType?
...
public struct GetUtterancesViewOutputResponse: Swift.Equatable {
    ...
    var utterances: [LexModelBuildingClientTypes.UtteranceList]?
...
extension LexModelBuildingClientTypes {
    ...
    public struct Intent: Swift.Equatable {
        /// The name of the intent.
        /// This member is required.
        var intentName: Swift.String?
        /// The version of the intent.
        /// This member is required.
        var intentVersion: Swift.String?
...
extension LexModelBuildingClientTypes {
    ...
    public struct KendraConfiguration: Swift.Equatable {
        ...
        var queryFilterString: Swift.String?
...
public struct ListTagsForResourceOutputResponse: Swift.Equatable {
    ...
    var tags: [LexModelBuildingClientTypes.Tag]?
...
extension LexModelBuildingClientTypes {
    ...
    public struct LogSettingsRequest: Swift.Equatable {
        ...
        /// This member is required.
        var destination: LexModelBuildingClientTypes.Destination?
        /// The Amazon Resource Name (ARN) of the AWS KMS customer managed key for encrypting audio logs delivered to an S3 bucket. The key does not apply to CloudWatch Logs and is optional for S3 buckets.
        var kmsKeyArn: Swift.String?
        /// The type of logging to enable. Text logs are delivered to a CloudWatch Logs log group. Audio logs are delivered to an S3 bucket.
        /// This member is required.
        var logType: LexModelBuildingClientTypes.LogType?
...
extension LexModelBuildingClientTypes {
    ...
    public struct LogSettingsResponse: Swift.Equatable {
        ...
        var resourcePrefix: Swift.String?
...
extension LexModelBuildingClientTypes {
    ...
    public struct Message: Swift.Equatable {
        ...
        /// This member is required.
        var contentType: LexModelBuildingClientTypes.ContentType?
        /// Identifies the message group that the message belongs to. When a group is assigned to a message, Amazon Lex returns one message from each group in the response.
        var groupNumber: Swift.Int?
...
extension LexModelBuildingClientTypes {
    ...
    public struct MigrationAlert: Swift.Equatable {
        ...
        var referenceURLs: [Swift.String]?
        ...
        var type: LexModelBuildingClientTypes.MigrationAlertType?
...
extension LexModelBuildingClientTypes {
    ...
    public struct OutputContext: Swift.Equatable {
        ...
        /// This member is required.
        var timeToLiveInSeconds: Swift.Int?
        /// The number of conversation turns that the context should be active. A conversation turn is one PostContent or PostText request and the corresponding response from Amazon Lex.
        /// This member is required.
        var turnsToLive: Swift.Int?
...
extension LexModelBuildingClientTypes {
    ...
    public struct Prompt: Swift.Equatable {
        ...
        /// This member is required.
        var messages: [LexModelBuildingClientTypes.Message]?
        /// A response card. Amazon Lex uses this prompt at runtime, in the PostText API response. It substitutes session attributes and slot values for placeholders in the response card. For more information, see [ex-resp-card].
        var responseCard: Swift.String?
...
public struct PutBotAliasInput: Swift.Equatable {
    ...
    var conversationLogs: LexModelBuildingClientTypes.ConversationLogsRequest?
...
public struct PutBotInput: Swift.Equatable {
    ...
    var processBehavior: LexModelBuildingClientTypes.ProcessBehavior?
...
extension LexModelBuildingClientTypes {
    ...
    public struct Slot: Swift.Equatable {
        ...
        var defaultValueSpec: LexModelBuildingClientTypes.SlotDefaultValueSpec?
        ...
        var obfuscationSetting: LexModelBuildingClientTypes.ObfuscationSetting?
        ...
        /// This member is required.
        var slotConstraint: LexModelBuildingClientTypes.SlotConstraint?
        /// The type of the slot, either a custom slot type that you defined or one of the built-in slot types.
        var slotType: Swift.String?
        /// The version of the slot type.
        var slotTypeVersion: Swift.String?
        /// The prompt that Amazon Lex uses to elicit the slot value from the user.
        var valueElicitationPrompt: LexModelBuildingClientTypes.Prompt?
...
extension LexModelBuildingClientTypes {
    ...
    public struct SlotDefaultValueSpec: Swift.Equatable {
        ...
        /// This member is required.
        var defaultValueList: [LexModelBuildingClientTypes.SlotDefaultValue]?
...
extension LexModelBuildingClientTypes {
    ...
    public struct SlotTypeConfiguration: Swift.Equatable {
        ...
        var regexConfiguration: LexModelBuildingClientTypes.SlotTypeRegexConfiguration?
...
extension LexModelBuildingClientTypes {
    ...
    public struct UtteranceData: Swift.Equatable {
        ...
        var distinctUsers: Swift.Int?
        /// The date that the utterance was first recorded.
        var firstUtteredDate: ClientRuntime.Date?
        /// The date that the utterance was last recorded.
        var lastUtteredDate: ClientRuntime.Date?
        /// The text that was entered by the user or the text representation of an audio clip.
        var utteranceString: Swift.String?
...
extension LexModelBuildingClientTypes {
    ...
    public struct UtteranceList: Swift.Equatable {
        ...
        var utterances: [LexModelBuildingClientTypes.UtteranceData]?
