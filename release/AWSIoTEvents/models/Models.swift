...
extension IotEventsClientTypes {
    ...
    public struct Action: Swift.Equatable {
        ...
        var clearTimer: IotEventsClientTypes.ClearTimerAction?
        /// Writes to the DynamoDB table that you created. The default action payload contains all attribute-value pairs that have the information about the detector model instance and the event that triggered the action. You can customize the [payload](https://docs.aws.amazon.com/iotevents/latest/apireference/API_Payload.html). One column of the DynamoDB table receives all attribute-value pairs in the payload that you specify. For more information, see [Actions](https://docs.aws.amazon.com/iotevents/latest/developerguide/iotevents-event-actions.html) in AWS IoT Events Developer Guide.
        var dynamoDB: IotEventsClientTypes.DynamoDBAction?
        /// Writes to the DynamoDB table that you created. The default action payload contains all attribute-value pairs that have the information about the detector model instance and the event that triggered the action. You can customize the [payload](https://docs.aws.amazon.com/iotevents/latest/apireference/API_Payload.html). A separate column of the DynamoDB table receives one attribute-value pair in the payload that you specify. For more information, see [Actions](https://docs.aws.amazon.com/iotevents/latest/developerguide/iotevents-event-actions.html) in AWS IoT Events Developer Guide.
        var dynamoDBv2: IotEventsClientTypes.DynamoDBv2Action?
        /// Sends information about the detector model instance and the event that triggered the action to an Amazon Kinesis Data Firehose delivery stream.
        var firehose: IotEventsClientTypes.FirehoseAction?
        /// Sends AWS IoT Events input, which passes information about the detector model instance and the event that triggered the action.
        var iotEvents: IotEventsClientTypes.IotEventsAction?
        /// Sends information about the detector model instance and the event that triggered the action to an asset property in AWS IoT SiteWise .
        var iotSiteWise: IotEventsClientTypes.IotSiteWiseAction?
        /// Publishes an MQTT message with the given topic to the AWS IoT message broker.
        var iotTopicPublish: IotEventsClientTypes.IotTopicPublishAction?
        /// Calls a Lambda function, passing in information about the detector model instance and the event that triggered the action.
        var lambda: IotEventsClientTypes.LambdaAction?
        /// Information needed to reset the timer.
        var resetTimer: IotEventsClientTypes.ResetTimerAction?
        /// Information needed to set the timer.
        var setTimer: IotEventsClientTypes.SetTimerAction?
        /// Sets a variable to a specified value.
        var setVariable: IotEventsClientTypes.SetVariableAction?
        /// Sends an Amazon SNS message.
        var sns: IotEventsClientTypes.SNSTopicPublishAction?
        /// Sends information about the detector model instance and the event that triggered the action to an Amazon SQS queue.
        var sqs: IotEventsClientTypes.SqsAction?
...
extension IotEventsClientTypes {
    ...
    public struct AlarmCapabilities: Swift.Equatable {
        /// Specifies whether to get notified for alarm state changes.
        var acknowledgeFlow: IotEventsClientTypes.AcknowledgeFlow?
        /// Specifies the default alarm state. The configuration applies to all alarms that were created based on this alarm model.
        var initializationConfiguration: IotEventsClientTypes.InitializationConfiguration?
...
extension IotEventsClientTypes {
    ...
    public struct AlarmEventActions: Swift.Equatable {
        ...
        var alarmActions: [IotEventsClientTypes.AlarmAction]?
...
extension IotEventsClientTypes {
    ...
    public struct AlarmModelSummary: Swift.Equatable {
        ...
        var alarmModelDescription: Swift.String?
...
extension IotEventsClientTypes {
    ...
    public struct AlarmModelVersionSummary: Swift.Equatable {
        ...
        var alarmModelArn: Swift.String?
        /// The name of the alarm model.
        var alarmModelName: Swift.String?
        ...
        var status: IotEventsClientTypes.AlarmModelVersionStatus?
...
extension IotEventsClientTypes {
    ...
    public struct AlarmNotification: Swift.Equatable {
        ...
        var notificationActions: [IotEventsClientTypes.NotificationAction]?
...
extension IotEventsClientTypes {
    ...
    public struct AlarmRule: Swift.Equatable {
        ...
        var simpleRule: IotEventsClientTypes.SimpleRule?
...
extension IotEventsClientTypes {
    ...
    public struct AnalysisResult: Swift.Equatable {
        ...
        var level: IotEventsClientTypes.AnalysisResultLevel?
        ...
        var locations: [IotEventsClientTypes.AnalysisResultLocation]?
...
extension IotEventsClientTypes {
    ...
    public struct AssetPropertyTimestamp: Swift.Equatable {
        ...
        var offsetInNanos: Swift.String?
        /// The timestamp, in seconds, in the Unix epoch format. The valid range is between 1-31556889864403199.
        /// This member is required.
        var timeInSeconds: Swift.String?
...
extension IotEventsClientTypes {
    ...
    public struct AssetPropertyValue: Swift.Equatable {
        ...
        var quality: Swift.String?
        /// The timestamp associated with the asset property value. The default is the current event time.
        var timestamp: IotEventsClientTypes.AssetPropertyTimestamp?
...
extension IotEventsClientTypes {
    ...
    public struct AssetPropertyVariant: Swift.Equatable {
        ...
        var booleanValue: Swift.String?
        /// The asset property value is a double. You must use an expression, and the evaluated result should be a double.
        var doubleValue: Swift.String?
        /// The asset property value is an integer. You must use an expression, and the evaluated result should be an integer.
        var integerValue: Swift.String?
...
public struct CreateAlarmModelInput: Swift.Equatable {
    /// Contains the configuration information of alarm state changes.
    var alarmCapabilities: IotEventsClientTypes.AlarmCapabilities?
    /// Contains information about one or more alarm actions.
    var alarmEventActions: IotEventsClientTypes.AlarmEventActions?
    ...
    var alarmModelName: Swift.String?
    /// Contains information about one or more notification actions.
    var alarmNotification: IotEventsClientTypes.AlarmNotification?
    /// Defines when your alarm is invoked.
    /// This member is required.
    var alarmRule: IotEventsClientTypes.AlarmRule?
    ...
    var tags: [IotEventsClientTypes.Tag]?
...
public struct CreateDetectorModelInput: Swift.Equatable {
    ...
    /// This member is required.
    var detectorModelDefinition: IotEventsClientTypes.DetectorModelDefinition?
    /// A brief description of the detector model.
    var detectorModelDescription: Swift.String?
    /// The name of the detector model.
    /// This member is required.
    var detectorModelName: Swift.String?
    /// Information about the order in which events are evaluated and how actions are executed.
    var evaluationMethod: IotEventsClientTypes.EvaluationMethod?
...
public struct CreateDetectorModelOutputResponse: Swift.Equatable {
    ...
    var detectorModelConfiguration: IotEventsClientTypes.DetectorModelConfiguration?
...
public struct CreateInputInput: Swift.Equatable {
    ...
    /// This member is required.
    var inputDefinition: IotEventsClientTypes.InputDefinition?
    /// A brief description of the input.
    var inputDescription: Swift.String?
...
public struct CreateInputOutputResponse: Swift.Equatable {
    ...
    var inputConfiguration: IotEventsClientTypes.InputConfiguration?
...
public struct DescribeDetectorModelAnalysisOutputResponse: Swift.Equatable {
    ...
    var status: IotEventsClientTypes.AnalysisStatus?
...
public struct DescribeDetectorModelOutputResponse: Swift.Equatable {
    ...
    var detectorModel: IotEventsClientTypes.DetectorModel?
...
public struct DescribeInputOutputResponse: Swift.Equatable {
    ...
    var input: IotEventsClientTypes.Input?
...
public struct DescribeLoggingOptionsOutputResponse: Swift.Equatable {
    ...
    var loggingOptions: IotEventsClientTypes.LoggingOptions?
...
extension IotEventsClientTypes {
    ...
    public struct DetectorModelConfiguration: Swift.Equatable {
        ...
        var detectorModelArn: Swift.String?
        /// A brief description of the detector model.
        var detectorModelDescription: Swift.String?
        /// The name of the detector model.
        var detectorModelName: Swift.String?
        ...
        var status: IotEventsClientTypes.DetectorModelVersionStatus?
...
extension IotEventsClientTypes {
    ...
    public struct DetectorModelDefinition: Swift.Equatable {
        ...
        /// This member is required.
        var initialStateName: Swift.String?
        /// Information about the states of the detector.
        /// This member is required.
        var states: [IotEventsClientTypes.State]?
...
extension IotEventsClientTypes {
    ...
    public struct DynamoDBAction: Swift.Equatable {
        ...
        var hashKeyType: Swift.String?
        /// The value of the hash key (also called the partition key).
        /// This member is required.
        var hashKeyValue: Swift.String?
        ...
        var payload: IotEventsClientTypes.Payload?
        ...
        var payloadField: Swift.String?
        /// The name of the range key (also called the sort key). The rangeKeyField value must match the sort key of the target DynamoDB table.
        var rangeKeyField: Swift.String?
        ...
        var rangeKeyType: Swift.String?
        /// The value of the range key (also called the sort key).
        var rangeKeyValue: Swift.String?
...
extension IotEventsClientTypes {
    ...
    public struct EmailConfiguration: Swift.Equatable {
        ...
        var content: IotEventsClientTypes.EmailContent?
        ...
        /// This member is required.
        var recipients: IotEventsClientTypes.EmailRecipients?
...
extension IotEventsClientTypes {
    ...
    public struct EmailContent: Swift.Equatable {
        ...
        var additionalMessage: Swift.String?
...
extension IotEventsClientTypes {
    ...
    public struct EmailRecipients: Swift.Equatable {
        ...
        var to: [IotEventsClientTypes.RecipientDetail]?
...
extension IotEventsClientTypes {
    ...
    public struct Event: Swift.Equatable {
        ...
        var actions: [IotEventsClientTypes.Action]?
...
public struct GetDetectorModelAnalysisResultsOutputResponse: Swift.Equatable {
    ...
    var analysisResults: [IotEventsClientTypes.AnalysisResult]?
...
extension IotEventsClientTypes {
    ...
    public struct InitializationConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var disabledOnInitialization: Swift.Bool?
...
extension IotEventsClientTypes {
    ...
    public struct InputConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var status: IotEventsClientTypes.InputStatus?
...
extension IotEventsClientTypes {
    ...
    public struct InputDefinition: Swift.Equatable {
        ...
        /// This member is required.
        var attributes: [IotEventsClientTypes.Attribute]?
...
extension IotEventsClientTypes {
    ...
    public struct InputIdentifier: Swift.Equatable {
        ...
        var iotEventsInputIdentifier: IotEventsClientTypes.IotEventsInputIdentifier?
        /// The identifer of the input routed from AWS IoT SiteWise.
        var iotSiteWiseInputIdentifier: IotEventsClientTypes.IotSiteWiseInputIdentifier?
...
extension IotEventsClientTypes {
    ...
    public struct IotSiteWiseAction: Swift.Equatable {
        ...
        var propertyValue: IotEventsClientTypes.AssetPropertyValue?
...
extension IotEventsClientTypes {
    ...
    public struct IotSiteWiseInputIdentifier: Swift.Equatable {
        ...
        var iotSiteWiseAssetModelPropertyIdentifier: IotEventsClientTypes.IotSiteWiseAssetModelPropertyIdentifier?
...
public struct ListAlarmModelVersionsOutputResponse: Swift.Equatable {
    ...
    var alarmModelVersionSummaries: [IotEventsClientTypes.AlarmModelVersionSummary]?
    /// The token that you can use to return the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListAlarmModelsOutputResponse: Swift.Equatable {
    ...
    var alarmModelSummaries: [IotEventsClientTypes.AlarmModelSummary]?
    /// The token that you can use to return the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListDetectorModelVersionsOutputResponse: Swift.Equatable {
    ...
    var detectorModelVersionSummaries: [IotEventsClientTypes.DetectorModelVersionSummary]?
    /// The token that you can use to return the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListDetectorModelsOutputResponse: Swift.Equatable {
    ...
    var detectorModelSummaries: [IotEventsClientTypes.DetectorModelSummary]?
    /// The token that you can use to return the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListInputRoutingsInput: Swift.Equatable {
    ...
    /// This member is required.
    var inputIdentifier: IotEventsClientTypes.InputIdentifier?
    /// The maximum number of results to be returned per request.
    var maxResults: Swift.Int?
    /// The token that you can use to return the next set of results.
    var nextToken: Swift.String?
...
public struct ListInputRoutingsOutputResponse: Swift.Equatable {
    ...
    var routedResources: [IotEventsClientTypes.RoutedResource]?
...
public struct ListInputsOutputResponse: Swift.Equatable {
    ...
    var inputSummaries: [IotEventsClientTypes.InputSummary]?
    /// The token that you can use to return the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
extension IotEventsClientTypes {
    ...
    public struct LoggingOptions: Swift.Equatable {
        ...
        var detectorDebugOptions: [IotEventsClientTypes.DetectorDebugOption]?
        /// If TRUE, logging is enabled for AWS IoT Events.
        /// This member is required.
        var enabled: Swift.Bool
        /// The logging level.
        /// This member is required.
        var level: IotEventsClientTypes.LoggingLevel?
...
extension IotEventsClientTypes {
    ...
    public struct NotificationAction: Swift.Equatable {
        ...
        /// This member is required.
        var action: IotEventsClientTypes.NotificationTargetActions?
        /// Contains the configuration information of email notifications.
        var emailConfigurations: [IotEventsClientTypes.EmailConfiguration]?
        /// Contains the configuration information of SMS notifications.
        var smsConfigurations: [IotEventsClientTypes.SMSConfiguration]?
...
extension IotEventsClientTypes {
    ...
    public struct NotificationTargetActions: Swift.Equatable {
        /// Calls a Lambda function, passing in information about the detector model instance and the event that triggered the action.
        var lambdaAction: IotEventsClientTypes.LambdaAction?
...
extension IotEventsClientTypes {
    ...
    public struct OnEnterLifecycle: Swift.Equatable {
        ...
        var events: [IotEventsClientTypes.Event]?
...
extension IotEventsClientTypes {
    ...
    public struct OnInputLifecycle: Swift.Equatable {
        ...
        var transitionEvents: [IotEventsClientTypes.TransitionEvent]?
...
extension IotEventsClientTypes {
    ...
    public struct Payload: Swift.Equatable {
        ...
        /// This member is required.
        var contentExpression: Swift.String?
        /// The value of the payload type can be either STRING or JSON.
        /// This member is required.
        var type: IotEventsClientTypes.PayloadType?
...
extension IotEventsClientTypes {
    ...
    public struct RecipientDetail: Swift.Equatable {
        ...
        var ssoIdentity: IotEventsClientTypes.SSOIdentity?
...
extension IotEventsClientTypes {
    ...
    public struct SMSConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var recipients: [IotEventsClientTypes.RecipientDetail]?
        /// The sender ID.
        var senderId: Swift.String?
...
extension IotEventsClientTypes {
    ...
    public struct SetTimerAction: Swift.Equatable {
        ...
        var durationExpression: Swift.String?
...
extension IotEventsClientTypes {
    ...
    public struct SimpleRule: Swift.Equatable {
        ...
        /// This member is required.
        var comparisonOperator: IotEventsClientTypes.ComparisonOperator?
        /// The value on the left side of the comparison operator. You can specify an AWS IoT Events input attribute as an input property.
        /// This member is required.
        var inputProperty: Swift.String?
        /// The value on the right side of the comparison operator. You can enter a number or specify an AWS IoT Events input attribute.
        /// This member is required.
        var threshold: Swift.String?
...
extension IotEventsClientTypes {
    ...
    public struct State: Swift.Equatable {
        /// When entering this state, perform these actions if the condition is TRUE.
        var onEnter: IotEventsClientTypes.OnEnterLifecycle?
        /// When exiting this state, perform these actions if the specified condition is TRUE.
        var onExit: IotEventsClientTypes.OnExitLifecycle?
        /// When an input is received and the condition is TRUE, perform the specified actions.
        var onInput: IotEventsClientTypes.OnInputLifecycle?
