...
public protocol ComprehendMedicalClientProtocol {
    ...
    func describeSNOMEDCTInferenceJob(input: DescribeSNOMEDCTInferenceJobInput, completion: @escaping (ClientRuntime.SdkResult<DescribeSNOMEDCTInferenceJobOutputResponse, DescribeSNOMEDCTInferenceJobOutputError>) -> Void)
    ...
    func inferSNOMEDCT(input: InferSNOMEDCTInput, completion: @escaping (ClientRuntime.SdkResult<InferSNOMEDCTOutputResponse, InferSNOMEDCTOutputError>) -> Void)
    ...
    func listSNOMEDCTInferenceJobs(input: ListSNOMEDCTInferenceJobsInput, completion: @escaping (ClientRuntime.SdkResult<ListSNOMEDCTInferenceJobsOutputResponse, ListSNOMEDCTInferenceJobsOutputError>) -> Void)
    ...
    func startSNOMEDCTInferenceJob(input: StartSNOMEDCTInferenceJobInput, completion: @escaping (ClientRuntime.SdkResult<StartSNOMEDCTInferenceJobOutputResponse, StartSNOMEDCTInferenceJobOutputError>) -> Void)
    ...
    func stopSNOMEDCTInferenceJob(input: StopSNOMEDCTInferenceJobInput, completion: @escaping (ClientRuntime.SdkResult<StopSNOMEDCTInferenceJobOutputResponse, StopSNOMEDCTInferenceJobOutputError>) -> Void)
}
