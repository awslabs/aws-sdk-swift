...
extension ComprehendMedicalClientTypes.Characters: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ComprehendMedicalClientTypes.Characters: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Characters(originalTextCharacters: \(Swift.String(describing: originalTextCharacters)))"}
}
...
public struct DescribeSNOMEDCTInferenceJobInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSNOMEDCTInferenceJobInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeSNOMEDCTInferenceJobInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeSNOMEDCTInferenceJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeSNOMEDCTInferenceJobInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeSNOMEDCTInferenceJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeSNOMEDCTInferenceJobOutputError>
}

extension DescribeSNOMEDCTInferenceJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeSNOMEDCTInferenceJobInput(jobId: \(Swift.String(describing: jobId)))"}
}

extension DescribeSNOMEDCTInferenceJobInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case jobId = "JobId"
    }
...
public struct DescribeSNOMEDCTInferenceJobInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSNOMEDCTInferenceJobInputHeadersMiddleware"
...
public struct DescribeSNOMEDCTInferenceJobInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSNOMEDCTInferenceJobInputQueryItemMiddleware"
...
public struct DescribeSNOMEDCTInferenceJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSNOMEDCTInferenceJobInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeSNOMEDCTInferenceJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeSNOMEDCTInferenceJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeSNOMEDCTInferenceJobOutputError>
}

public struct DescribeSNOMEDCTInferenceJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSNOMEDCTInferenceJobInputURLPathMiddleware"
...
extension DescribeSNOMEDCTInferenceJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeSNOMEDCTInferenceJobOutputResponse(comprehendMedicalAsyncJobProperties: \(Swift.String(describing: comprehendMedicalAsyncJobProperties)))"}
}
...
public struct InferSNOMEDCTInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InferSNOMEDCTInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<InferSNOMEDCTInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<InferSNOMEDCTOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<InferSNOMEDCTInput>
    public typealias MOutput = ClientRuntime.OperationOutput<InferSNOMEDCTOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<InferSNOMEDCTOutputError>
}

extension InferSNOMEDCTInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InferSNOMEDCTInput(text: \(Swift.String(describing: text)))"}
}

extension InferSNOMEDCTInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case text = "Text"
    }
...
public struct InferSNOMEDCTInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InferSNOMEDCTInputHeadersMiddleware"
...
public struct InferSNOMEDCTInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InferSNOMEDCTInputQueryItemMiddleware"
...
public struct InferSNOMEDCTInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InferSNOMEDCTInputURLHostMiddleware"
    ...
    public typealias MInput = InferSNOMEDCTInput
    public typealias MOutput = ClientRuntime.OperationOutput<InferSNOMEDCTOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<InferSNOMEDCTOutputError>
}

public struct InferSNOMEDCTInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InferSNOMEDCTInputURLPathMiddleware"
...
extension InferSNOMEDCTOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InferSNOMEDCTOutputResponse(characters: \(Swift.String(describing: characters)), entities: \(Swift.String(describing: entities)), modelVersion: \(Swift.String(describing: modelVersion)), paginationToken: \(Swift.String(describing: paginationToken)), sNOMEDCTDetails: \(Swift.String(describing: sNOMEDCTDetails)))"}
}
...
struct InferSNOMEDCTOutputResponseBody: Swift.Equatable {
    public let entities: [ComprehendMedicalClientTypes.SNOMEDCTEntity]?
    public let paginationToken: Swift.String?
    public let modelVersion: Swift.String?
    public let sNOMEDCTDetails: ComprehendMedicalClientTypes.SNOMEDCTDetails?
    public let characters: ComprehendMedicalClientTypes.Characters?
}
...
public struct ListSNOMEDCTInferenceJobsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSNOMEDCTInferenceJobsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListSNOMEDCTInferenceJobsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListSNOMEDCTInferenceJobsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListSNOMEDCTInferenceJobsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListSNOMEDCTInferenceJobsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListSNOMEDCTInferenceJobsOutputError>
}

extension ListSNOMEDCTInferenceJobsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListSNOMEDCTInferenceJobsInput(filter: \(Swift.String(describing: filter)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListSNOMEDCTInferenceJobsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filter = "Filter"
        case maxResults = "MaxResults"
        case nextToken = "NextToken"
...
public struct ListSNOMEDCTInferenceJobsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSNOMEDCTInferenceJobsInputHeadersMiddleware"
...
public struct ListSNOMEDCTInferenceJobsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSNOMEDCTInferenceJobsInputQueryItemMiddleware"
...
public struct ListSNOMEDCTInferenceJobsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSNOMEDCTInferenceJobsInputURLHostMiddleware"
    ...
    public typealias MInput = ListSNOMEDCTInferenceJobsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListSNOMEDCTInferenceJobsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListSNOMEDCTInferenceJobsOutputError>
}

public struct ListSNOMEDCTInferenceJobsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSNOMEDCTInferenceJobsInputURLPathMiddleware"
...
extension ListSNOMEDCTInferenceJobsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListSNOMEDCTInferenceJobsOutputResponse(comprehendMedicalAsyncJobPropertiesList: \(Swift.String(describing: comprehendMedicalAsyncJobPropertiesList)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
extension ComprehendMedicalClientTypes.SNOMEDCTAttribute: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case beginOffset = "BeginOffset"
        case category = "Category"
        case endOffset = "EndOffset"
...
extension ComprehendMedicalClientTypes.SNOMEDCTAttribute: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SNOMEDCTAttribute(beginOffset: \(Swift.String(describing: beginOffset)), category: \(Swift.String(describing: category)), endOffset: \(Swift.String(describing: endOffset)), id: \(Swift.String(describing: id)), relationshipScore: \(Swift.String(describing: relationshipScore)), relationshipType: \(Swift.String(describing: relationshipType)), sNOMEDCTConcepts: \(Swift.String(describing: sNOMEDCTConcepts)), score: \(Swift.String(describing: score)), text: \(Swift.String(describing: text)), traits: \(Swift.String(describing: traits)), type: \(Swift.String(describing: type)))"}
}
...
extension ComprehendMedicalClientTypes.SNOMEDCTConcept: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case code = "Code"
        case description = "Description"
        case score = "Score"
...
extension ComprehendMedicalClientTypes.SNOMEDCTConcept: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SNOMEDCTConcept(code: \(Swift.String(describing: code)), description: \(Swift.String(describing: description)), score: \(Swift.String(describing: score)))"}
}
...
extension ComprehendMedicalClientTypes.SNOMEDCTDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ComprehendMedicalClientTypes.SNOMEDCTDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SNOMEDCTDetails(edition: \(Swift.String(describing: edition)), language: \(Swift.String(describing: language)), versionDate: \(Swift.String(describing: versionDate)))"}
}
...
extension ComprehendMedicalClientTypes.SNOMEDCTEntity: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case attributes = "Attributes"
        case beginOffset = "BeginOffset"
        case category = "Category"
...
extension ComprehendMedicalClientTypes.SNOMEDCTEntity: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SNOMEDCTEntity(attributes: \(Swift.String(describing: attributes)), beginOffset: \(Swift.String(describing: beginOffset)), category: \(Swift.String(describing: category)), endOffset: \(Swift.String(describing: endOffset)), id: \(Swift.String(describing: id)), sNOMEDCTConcepts: \(Swift.String(describing: sNOMEDCTConcepts)), score: \(Swift.String(describing: score)), text: \(Swift.String(describing: text)), traits: \(Swift.String(describing: traits)), type: \(Swift.String(describing: type)))"}
}
...
extension ComprehendMedicalClientTypes.SNOMEDCTTrait: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case score = "Score"
    }
...
extension ComprehendMedicalClientTypes.SNOMEDCTTrait: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SNOMEDCTTrait(name: \(Swift.String(describing: name)), score: \(Swift.String(describing: score)))"}
}
...
public struct StartSNOMEDCTInferenceJobInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartSNOMEDCTInferenceJobInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartSNOMEDCTInferenceJobInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartSNOMEDCTInferenceJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartSNOMEDCTInferenceJobInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartSNOMEDCTInferenceJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartSNOMEDCTInferenceJobOutputError>
}

extension StartSNOMEDCTInferenceJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartSNOMEDCTInferenceJobInput(clientRequestToken: \(Swift.String(describing: clientRequestToken)), dataAccessRoleArn: \(Swift.String(describing: dataAccessRoleArn)), inputDataConfig: \(Swift.String(describing: inputDataConfig)), jobName: \(Swift.String(describing: jobName)), kMSKey: \(Swift.String(describing: kMSKey)), languageCode: \(Swift.String(describing: languageCode)), outputDataConfig: \(Swift.String(describing: outputDataConfig)))"}
}

extension StartSNOMEDCTInferenceJobInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientRequestToken = "ClientRequestToken"
        case dataAccessRoleArn = "DataAccessRoleArn"
        case inputDataConfig = "InputDataConfig"
...
public struct StartSNOMEDCTInferenceJobInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartSNOMEDCTInferenceJobInputHeadersMiddleware"
...
public struct StartSNOMEDCTInferenceJobInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartSNOMEDCTInferenceJobInputQueryItemMiddleware"
...
public struct StartSNOMEDCTInferenceJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartSNOMEDCTInferenceJobInputURLHostMiddleware"
    ...
    public typealias MInput = StartSNOMEDCTInferenceJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartSNOMEDCTInferenceJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartSNOMEDCTInferenceJobOutputError>
}

public struct StartSNOMEDCTInferenceJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartSNOMEDCTInferenceJobInputURLPathMiddleware"
...
extension StartSNOMEDCTInferenceJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartSNOMEDCTInferenceJobOutputResponse(jobId: \(Swift.String(describing: jobId)))"}
}
...
public struct StopSNOMEDCTInferenceJobInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopSNOMEDCTInferenceJobInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StopSNOMEDCTInferenceJobInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StopSNOMEDCTInferenceJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StopSNOMEDCTInferenceJobInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StopSNOMEDCTInferenceJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopSNOMEDCTInferenceJobOutputError>
}

extension StopSNOMEDCTInferenceJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopSNOMEDCTInferenceJobInput(jobId: \(Swift.String(describing: jobId)))"}
}

extension StopSNOMEDCTInferenceJobInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case jobId = "JobId"
    }
...
public struct StopSNOMEDCTInferenceJobInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopSNOMEDCTInferenceJobInputHeadersMiddleware"
...
public struct StopSNOMEDCTInferenceJobInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopSNOMEDCTInferenceJobInputQueryItemMiddleware"
...
public struct StopSNOMEDCTInferenceJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopSNOMEDCTInferenceJobInputURLHostMiddleware"
    ...
    public typealias MInput = StopSNOMEDCTInferenceJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<StopSNOMEDCTInferenceJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopSNOMEDCTInferenceJobOutputError>
}

public struct StopSNOMEDCTInferenceJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopSNOMEDCTInferenceJobInputURLPathMiddleware"
...
extension StopSNOMEDCTInferenceJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopSNOMEDCTInferenceJobOutputResponse(jobId: \(Swift.String(describing: jobId)))"}
}
