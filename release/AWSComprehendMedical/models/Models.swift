...
public struct StartEntitiesDetectionV2JobInput: Swift.Equatable {
    ...
    ///       grants Amazon Comprehend Medical read access to your input data. For more information, see <a href="https://docs.aws.amazon.com/comprehend/latest/dg/access-control-managing-permissions-med.html#auth-role-permissions-med"> Role-Based Permissions Required for Asynchronous Operations.
    /// This member is required.
    public var dataAccessRoleArn: Swift.String?
