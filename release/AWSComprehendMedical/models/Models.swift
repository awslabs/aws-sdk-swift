...
extension ComprehendMedicalClientTypes {
    ...
    public struct Attribute: Swift.Equatable {
        ...
        var relationshipType: ComprehendMedicalClientTypes.RelationshipType?
        /// The level of confidence that Comprehend Medical; has that the segment of text is correctly recognized as an attribute.
        var score: Swift.Float?
        /// The segment of input text extracted as this attribute.
        var text: Swift.String?
        /// Contextual information for this attribute.
        var traits: [ComprehendMedicalClientTypes.Trait]?
        /// The type of attribute.
        var type: ComprehendMedicalClientTypes.EntitySubType?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct Characters: Swift.Equatable {
        ...
        var originalTextCharacters: Swift.Int?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct ComprehendMedicalAsyncJobFilter: Swift.Equatable {
        ...
        var jobStatus: ComprehendMedicalClientTypes.JobStatus?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct ComprehendMedicalAsyncJobProperties: Swift.Equatable {
        ...
        var inputDataConfig: ComprehendMedicalClientTypes.InputDataConfig?
        ...
        var languageCode: ComprehendMedicalClientTypes.LanguageCode?
        /// The path to the file that describes the results of a batch job.
        var manifestFilePath: Swift.String?
        /// A description of the status of a job.
        var message: Swift.String?
        /// The version of the model used to analyze the documents. The version number looks like X.X.X. You can use this information to track the model used for a particular batch of documents.
        var modelVersion: Swift.String?
        /// The output data configuration that you supplied when you created the detection job.
        var outputDataConfig: ComprehendMedicalClientTypes.OutputDataConfig?
...
public struct DescribeEntitiesDetectionV2JobOutputResponse: Swift.Equatable {
    ...
    var comprehendMedicalAsyncJobProperties: ComprehendMedicalClientTypes.ComprehendMedicalAsyncJobProperties?
...
public struct DetectEntitiesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entities: [ComprehendMedicalClientTypes.Entity]?
    /// The version of the model used to analyze the documents. The version number looks like X.X.X. You can use this information to track the model used for a particular batch of documents.
    /// This member is required.
    var modelVersion: Swift.String?
    ...
    var unmappedAttributes: [ComprehendMedicalClientTypes.UnmappedAttribute]?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct Entity: Swift.Equatable {
        ...
        var attributes: [ComprehendMedicalClientTypes.Attribute]?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct ICD10CMAttribute: Swift.Equatable {
        ...
        var category: ComprehendMedicalClientTypes.ICD10CMEntityType?
        /// The 0-based character offset in the input text that shows where the attribute ends. The offset returns the UTF-8 code point in the string.
        var endOffset: Swift.Int?
        /// The numeric identifier for this attribute. This is a monotonically increasing id unique within this response rather than a global unique identifier.
        var id: Swift.Int?
        ...
        var relationshipType: ComprehendMedicalClientTypes.ICD10CMRelationshipType?
        ...
        var traits: [ComprehendMedicalClientTypes.ICD10CMTrait]?
        /// The type of attribute. InferICD10CM detects entities of the type DX_NAME.
        var type: ComprehendMedicalClientTypes.ICD10CMAttributeType?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct ICD10CMEntity: Swift.Equatable {
        ...
        var attributes: [ComprehendMedicalClientTypes.ICD10CMAttribute]?
        /// The 0-based character offset in the input text that shows where the entity begins. The offset returns the UTF-8 code point in the string.
        var beginOffset: Swift.Int?
        /// The category of the entity. InferICD10CM detects entities in the MEDICAL_CONDITION category.
        var category: ComprehendMedicalClientTypes.ICD10CMEntityCategory?
        /// The 0-based character offset in the input text that shows where the entity ends. The offset returns the UTF-8 code point in the string.
        var endOffset: Swift.Int?
        /// The ICD-10-CM concepts that the entity could refer to, along with a score indicating the likelihood of the match.
        var iCD10CMConcepts: [ComprehendMedicalClientTypes.ICD10CMConcept]?
        /// The numeric identifier for the entity. This is a monotonically increasing id unique within this response rather than a global unique identifier.
        var id: Swift.Int?
        ...
        var type: ComprehendMedicalClientTypes.ICD10CMEntityType?
...
public struct InferICD10CMOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entities: [ComprehendMedicalClientTypes.ICD10CMEntity]?
...
public struct InferRxNormOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entities: [ComprehendMedicalClientTypes.RxNormEntity]?
    /// The version of the model used to analyze the documents, in the format n.n.n You can use this information to track the model used for a particular batch of documents.
    var modelVersion: Swift.String?
...
public struct InferSNOMEDCTOutputResponse: Swift.Equatable {
    ...
    var characters: ComprehendMedicalClientTypes.Characters?
    /// The collection of medical concept entities extracted from the input text and their associated information. For each entity, the response provides the entity text, the entity category, where the entity text begins and ends, and the level of confidence that Comprehend Medical has in the detection and analysis. Attributes and traits of the entity are also returned.
    /// This member is required.
    var entities: [ComprehendMedicalClientTypes.SNOMEDCTEntity]?
    /// The version of the model used to analyze the documents, in the format n.n.n You can use this information to track the model used for a particular batch of documents.
    var modelVersion: Swift.String?
    ...
    var sNOMEDCTDetails: ComprehendMedicalClientTypes.SNOMEDCTDetails?
...
public struct ListEntitiesDetectionV2JobsInput: Swift.Equatable {
    ...
    var filter: ComprehendMedicalClientTypes.ComprehendMedicalAsyncJobFilter?
...
public struct ListEntitiesDetectionV2JobsOutputResponse: Swift.Equatable {
    ...
    var comprehendMedicalAsyncJobPropertiesList: [ComprehendMedicalClientTypes.ComprehendMedicalAsyncJobProperties]?
    /// Identifies the next page of results to return.
    var nextToken: Swift.String?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct RxNormAttribute: Swift.Equatable {
        ...
        var traits: [ComprehendMedicalClientTypes.RxNormTrait]?
        /// The type of attribute. The types of attributes recognized by InferRxNorm are BRAND_NAME and GENERIC_NAME.
        var type: ComprehendMedicalClientTypes.RxNormAttributeType?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct RxNormEntity: Swift.Equatable {
        ...
        var attributes: [ComprehendMedicalClientTypes.RxNormAttribute]?
        /// The 0-based character offset in the input text that shows where the entity begins. The offset returns the UTF-8 code point in the string.
        var beginOffset: Swift.Int?
        /// The category of the entity. The recognized categories are GENERIC or BRAND_NAME.
        var category: ComprehendMedicalClientTypes.RxNormEntityCategory?
        /// The 0-based character offset in the input text that shows where the entity ends. The offset returns the UTF-8 code point in the string.
        var endOffset: Swift.Int?
        /// The numeric identifier for the entity. This is a monotonically increasing id unique within this response rather than a global unique identifier.
        var id: Swift.Int?
        /// The RxNorm concepts that the entity could refer to, along with a score indicating the likelihood of the match.
        var rxNormConcepts: [ComprehendMedicalClientTypes.RxNormConcept]?
        ...
        var type: ComprehendMedicalClientTypes.RxNormEntityType?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct RxNormTrait: Swift.Equatable {
        /// Provides a name or contextual description about the trait.
        var name: ComprehendMedicalClientTypes.RxNormTraitName?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct SNOMEDCTAttribute: Swift.Equatable {
        ...
        var category: ComprehendMedicalClientTypes.SNOMEDCTEntityCategory?
        /// The 0-based character offset in the input text that shows where the attribute ends. The offset returns the UTF-8 code point in the string.
        var endOffset: Swift.Int?
        /// The numeric identifier for this attribute. This is a monotonically increasing id unique within this response rather than a global unique identifier.
        var id: Swift.Int?
        ...
        var type: ComprehendMedicalClientTypes.SNOMEDCTAttributeType?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct SNOMEDCTEntity: Swift.Equatable {
        ...
        var attributes: [ComprehendMedicalClientTypes.SNOMEDCTAttribute]?
        /// The 0-based character offset in the input text that shows where the entity begins. The offset returns the UTF-8 code point in the string.
        var beginOffset: Swift.Int?
        ...
        var type: ComprehendMedicalClientTypes.SNOMEDCTEntityType?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct SNOMEDCTTrait: Swift.Equatable {
        ...
        var name: ComprehendMedicalClientTypes.SNOMEDCTTraitName?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct Trait: Swift.Equatable {
        /// Provides a name or contextual description about the trait.
        var name: ComprehendMedicalClientTypes.AttributeName?
...
extension ComprehendMedicalClientTypes {
    ...
    public struct UnmappedAttribute: Swift.Equatable {
        ...
        var attribute: ComprehendMedicalClientTypes.Attribute?
        ...
        var type: ComprehendMedicalClientTypes.EntityType?
