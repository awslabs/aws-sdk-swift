...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct Action: Swift.Equatable {
        ...
        var authenticateCognitoConfig: ElasticLoadBalancingV2ClientTypes.AuthenticateCognitoActionConfig?
        /// [HTTPS listeners] Information about an identity provider that is compliant with OpenID Connect (OIDC). Specify only when Type is authenticate-oidc.
        var authenticateOidcConfig: ElasticLoadBalancingV2ClientTypes.AuthenticateOidcActionConfig?
        /// [Application Load Balancer] Information for creating an action that returns a custom HTTP response. Specify only when Type is fixed-response.
        var fixedResponseConfig: ElasticLoadBalancingV2ClientTypes.FixedResponseActionConfig?
        /// Information for creating an action that distributes requests among one or more target groups. For Network Load Balancers, you can specify a single target group. Specify only when Type is forward. If you specify both ForwardConfig and TargetGroupArn, you can specify only one target group using ForwardConfig and it must be the same target group specified in TargetGroupArn.
        var forwardConfig: ElasticLoadBalancingV2ClientTypes.ForwardActionConfig?
        /// The order for the action. This value is required for rules with multiple actions. The action with the lowest value for order is performed first.
        var order: Swift.Int?
        /// [Application Load Balancer] Information for creating a redirect action. Specify only when Type is redirect.
        var redirectConfig: ElasticLoadBalancingV2ClientTypes.RedirectActionConfig?
        /// The Amazon Resource Name (ARN) of the target group. Specify only when Type is forward and you want to route to a single target group. To route to one or more target groups, use ForwardConfig instead.
        var targetGroupArn: Swift.String?
        /// The type of action.
        /// This member is required.
        var type: ElasticLoadBalancingV2ClientTypes.ActionTypeEnum?
...
public struct AddListenerCertificatesInput: Swift.Equatable {
    ...
    /// This member is required.
    var certificates: [ElasticLoadBalancingV2ClientTypes.Certificate]?
...
public struct AddTagsInput: Swift.Equatable {
    ...
    /// The tags.
    /// This member is required.
    var tags: [ElasticLoadBalancingV2ClientTypes.Tag]?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct AuthenticateCognitoActionConfig: Swift.Equatable {
        ...
        var authenticationRequestExtraParams: [Swift.String:Swift.String]?
        ...
        var onUnauthenticatedRequest: ElasticLoadBalancingV2ClientTypes.AuthenticateCognitoActionConditionalBehaviorEnum?
        /// The set of user claims to be requested from the IdP. The default is openid. To verify which scope values your IdP supports and how to separate multiple values, see the documentation for your IdP.
        var scope: Swift.String?
        /// The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.
        var sessionCookieName: Swift.String?
        /// The maximum duration of the authentication session, in seconds. The default is 604800 seconds (7 days).
        var sessionTimeout: Swift.Int?
        /// The Amazon Resource Name (ARN) of the Amazon Cognito user pool.
        /// This member is required.
        var userPoolArn: Swift.String?
        /// The ID of the Amazon Cognito user pool client.
        /// This member is required.
        var userPoolClientId: Swift.String?
        /// The domain prefix or fully-qualified domain name of the Amazon Cognito user pool.
        /// This member is required.
        var userPoolDomain: Swift.String?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct AuthenticateOidcActionConfig: Swift.Equatable {
        ...
        ///
        /// * authenticate - Redirect the request to the IdP authorization endpoint. This is the default value.
        var onUnauthenticatedRequest: ElasticLoadBalancingV2ClientTypes.AuthenticateOidcActionConditionalBehaviorEnum?
        /// The set of user claims to be requested from the IdP. The default is openid. To verify which scope values your IdP supports and how to separate multiple values, see the documentation for your IdP.
        var scope: Swift.String?
        /// The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.
        var sessionCookieName: Swift.String?
        ...
        /// This member is required.
        var tokenEndpoint: Swift.String?
        /// Indicates whether to use the existing client secret when modifying a rule. If you are creating a rule, you can omit this parameter or set it to false.
        var useExistingClientSecret: Swift.Bool?
        /// The user info endpoint of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.
        /// This member is required.
        var userInfoEndpoint: Swift.String?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct AvailabilityZone: Swift.Equatable {
        ...
        var loadBalancerAddresses: [ElasticLoadBalancingV2ClientTypes.LoadBalancerAddress]?
        /// [Application Load Balancers on Outposts] The ID of the Outpost.
        var outpostId: Swift.String?
        /// The ID of the subnet. You can specify one subnet per Availability Zone.
        var subnetId: Swift.String?
        /// The name of the Availability Zone.
        var zoneName: Swift.String?
...
public struct CreateListenerInput: Swift.Equatable {
    ...
    var `protocol`: ElasticLoadBalancingV2ClientTypes.ProtocolEnum?
...
public struct CreateListenerOutputResponse: Swift.Equatable {
    ...
    var listeners: [ElasticLoadBalancingV2ClientTypes.Listener]?
...
public struct CreateLoadBalancerInput: Swift.Equatable {
    ...
    var customerOwnedIpv4Pool: Swift.String?
    /// The type of IP addresses used by the subnets for your load balancer. The possible values are ipv4 (for IPv4 addresses) and dualstack (for IPv4 and IPv6 addresses).
    var ipAddressType: ElasticLoadBalancingV2ClientTypes.IpAddressType?
    ...
    var scheme: ElasticLoadBalancingV2ClientTypes.LoadBalancerSchemeEnum?
    ...
    var subnetMappings: [ElasticLoadBalancingV2ClientTypes.SubnetMapping]?
    ...
    var type: ElasticLoadBalancingV2ClientTypes.LoadBalancerTypeEnum?
...
public struct CreateLoadBalancerOutputResponse: Swift.Equatable {
    ...
    var loadBalancers: [ElasticLoadBalancingV2ClientTypes.LoadBalancer]?
...
public struct CreateRuleInput: Swift.Equatable {
    /// The actions.
    /// This member is required.
    var actions: [ElasticLoadBalancingV2ClientTypes.Action]?
    /// The conditions.
    /// This member is required.
    var conditions: [ElasticLoadBalancingV2ClientTypes.RuleCondition]?
    /// The Amazon Resource Name (ARN) of the listener.
    /// This member is required.
    var listenerArn: Swift.String?
...
public struct CreateRuleOutputResponse: Swift.Equatable {
    ...
    var rules: [ElasticLoadBalancingV2ClientTypes.Rule]?
...
public struct CreateTargetGroupInput: Swift.Equatable {
    ...
    var healthCheckEnabled: Swift.Bool?
    ...
    var healthCheckPort: Swift.String?
    /// The protocol the load balancer uses when performing health checks on targets. For Application Load Balancers, the default is HTTP. For Network Load Balancers and Gateway Load Balancers, the default is TCP. The TCP protocol is not supported for health checks if the protocol of the target group is HTTP or HTTPS. The GENEVE, TLS, UDP, and TCP_UDP protocols are not supported for health checks.
    var healthCheckProtocol: ElasticLoadBalancingV2ClientTypes.ProtocolEnum?
    ...
    var healthCheckTimeoutSeconds: Swift.Int?
    ...
    var healthyThresholdCount: Swift.Int?
    /// The type of IP address used for this target group. The possible values are ipv4 and ipv6. This is an optional parameter. If not specified, the IP address type defaults to ipv4.
    var ipAddressType: ElasticLoadBalancingV2ClientTypes.TargetGroupIpAddressTypeEnum?
    /// [HTTP/HTTPS health checks] The HTTP or gRPC codes to use when checking for a successful response from a target.
    var matcher: ElasticLoadBalancingV2ClientTypes.Matcher?
    ...
    var protocolVersion: Swift.String?
    ...
    var targetType: ElasticLoadBalancingV2ClientTypes.TargetTypeEnum?
    ...
    var unhealthyThresholdCount: Swift.Int?
...
public struct CreateTargetGroupOutputResponse: Swift.Equatable {
    ...
    var targetGroups: [ElasticLoadBalancingV2ClientTypes.TargetGroup]?
...
public struct DeregisterTargetsInput: Swift.Equatable {
    ...
    /// This member is required.
    var targets: [ElasticLoadBalancingV2ClientTypes.TargetDescription]?
...
public struct DescribeAccountLimitsOutputResponse: Swift.Equatable {
    ...
    var limits: [ElasticLoadBalancingV2ClientTypes.Limit]?
...
public struct DescribeLoadBalancerAttributesOutputResponse: Swift.Equatable {
    ...
    var attributes: [ElasticLoadBalancingV2ClientTypes.LoadBalancerAttribute]?
...
public struct DescribeLoadBalancersInput: Swift.Equatable {
    ...
    var loadBalancerArns: [Swift.String]?
    /// The marker for the next set of results. (You received this marker from a previous call.)
    var marker: Swift.String?
...
public struct DescribeSSLPoliciesInput: Swift.Equatable {
    ...
    var loadBalancerType: ElasticLoadBalancingV2ClientTypes.LoadBalancerTypeEnum?
    /// The marker for the next set of results. (You received this marker from a previous call.)
    var marker: Swift.String?
...
public struct DescribeSSLPoliciesOutputResponse: Swift.Equatable {
    ...
    var sslPolicies: [ElasticLoadBalancingV2ClientTypes.SslPolicy]?
...
public struct DescribeTagsOutputResponse: Swift.Equatable {
    ...
    var tagDescriptions: [ElasticLoadBalancingV2ClientTypes.TagDescription]?
...
public struct DescribeTargetGroupAttributesOutputResponse: Swift.Equatable {
    ...
    var attributes: [ElasticLoadBalancingV2ClientTypes.TargetGroupAttribute]?
...
public struct DescribeTargetHealthOutputResponse: Swift.Equatable {
    ...
    var targetHealthDescriptions: [ElasticLoadBalancingV2ClientTypes.TargetHealthDescription]?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct ForwardActionConfig: Swift.Equatable {
        ...
        var targetGroupStickinessConfig: ElasticLoadBalancingV2ClientTypes.TargetGroupStickinessConfig?
        /// One or more target groups. For Network Load Balancers, you can specify a single target group.
        var targetGroups: [ElasticLoadBalancingV2ClientTypes.TargetGroupTuple]?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct HttpHeaderConditionConfig: Swift.Equatable {
        ...
        var httpHeaderName: Swift.String?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct LoadBalancer: Swift.Equatable {
        ...
        var availabilityZones: [ElasticLoadBalancingV2ClientTypes.AvailabilityZone]?
        /// The ID of the Amazon Route 53 hosted zone associated with the load balancer.
        var canonicalHostedZoneId: Swift.String?
        ...
        var state: ElasticLoadBalancingV2ClientTypes.LoadBalancerState?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct LoadBalancerAddress: Swift.Equatable {
        ...
        var allocationId: Swift.String?
        /// [Network Load Balancers] The IPv6 address.
        var iPv6Address: Swift.String?
        /// The static IP address.
        var ipAddress: Swift.String?
        /// [Network Load Balancers] The private IPv4 address for an internal load balancer.
        var privateIPv4Address: Swift.String?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct LoadBalancerState: Swift.Equatable {
        ...
        var code: ElasticLoadBalancingV2ClientTypes.LoadBalancerStateEnum?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct QueryStringConditionConfig: Swift.Equatable {
        ...
        var values: [ElasticLoadBalancingV2ClientTypes.QueryStringKeyValuePair]?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct RedirectActionConfig: Swift.Equatable {
        ...
        var port: Swift.String?
        /// The query parameters, URL-encoded when necessary, but not percent-encoded. Do not include the leading "?", as it is automatically added. You can specify any of the reserved keywords.
        var query: Swift.String?
        /// The HTTP redirect code. The redirect is either permanent (HTTP 301) or temporary (HTTP 302).
        /// This member is required.
        var statusCode: ElasticLoadBalancingV2ClientTypes.RedirectActionStatusCodeEnum?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct RuleCondition: Swift.Equatable {
        ...
        var hostHeaderConfig: ElasticLoadBalancingV2ClientTypes.HostHeaderConditionConfig?
        /// Information for an HTTP header condition. Specify only when Field is http-header.
        var httpHeaderConfig: ElasticLoadBalancingV2ClientTypes.HttpHeaderConditionConfig?
        /// Information for an HTTP method condition. Specify only when Field is http-request-method.
        var httpRequestMethodConfig: ElasticLoadBalancingV2ClientTypes.HttpRequestMethodConditionConfig?
        /// Information for a path pattern condition. Specify only when Field is path-pattern.
        var pathPatternConfig: ElasticLoadBalancingV2ClientTypes.PathPatternConditionConfig?
        /// Information for a query string condition. Specify only when Field is query-string.
        var queryStringConfig: ElasticLoadBalancingV2ClientTypes.QueryStringConditionConfig?
        /// Information for a source IP condition. Specify only when Field is source-ip.
        var sourceIpConfig: ElasticLoadBalancingV2ClientTypes.SourceIpConditionConfig?
...
public struct SetRulePrioritiesInput: Swift.Equatable {
    /// The rule priorities.
    /// This member is required.
    var rulePriorities: [ElasticLoadBalancingV2ClientTypes.RulePriorityPair]?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct SslPolicy: Swift.Equatable {
        /// The ciphers.
        var ciphers: [ElasticLoadBalancingV2ClientTypes.Cipher]?
        /// The name of the policy.
        var name: Swift.String?
        /// The protocols.
        var sslProtocols: [Swift.String]?
        /// The supported load balancers.
        var supportedLoadBalancerTypes: [Swift.String]?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct TargetGroup: Swift.Equatable {
        ...
        var targetGroupName: Swift.String?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct TargetHealth: Swift.Equatable {
        ...
        var reason: ElasticLoadBalancingV2ClientTypes.TargetHealthReasonEnum?
        /// The state of the target.
        var state: ElasticLoadBalancingV2ClientTypes.TargetHealthStateEnum?
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct TargetHealthDescription: Swift.Equatable {
        ...
        var target: ElasticLoadBalancingV2ClientTypes.TargetDescription?
        /// The health information for the target.
        var targetHealth: ElasticLoadBalancingV2ClientTypes.TargetHealth?
