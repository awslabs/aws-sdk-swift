...
public struct CreateListenerInput: Swift.Equatable {
    ...
    ///       supported.
    ///          For more information, see <a href="https://docs.aws.amazon.com/elasticloadbalancing/latest/application/create-https-listener.html#describe-ssl-policies">Security policies in the Application Load Balancers Guide and
...
public struct ModifyListenerInput: Swift.Equatable {
    ...
    /// This member is required.
    public var listenerArn: Swift.String?
    /// The port for connections from clients to the load balancer. You cannot specify a port for
...
extension ElasticLoadBalancingV2ClientTypes {
    ...
    public struct TargetGroupAttribute: Swift.Equatable {
        ...
        ///             lb_cookie and app_cookie for Application Load Balancers or
