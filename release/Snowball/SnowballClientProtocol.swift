...
public protocol SnowballClientProtocol {
    ...
    ///       job to cancel it.</p>
    func cancelCluster(input: CancelClusterInput, completion: @escaping (SdkResult<CancelClusterOutput, CancelClusterOutputError>) -> Void)
    ...
    func createAddress(input: CreateAddressInput, completion: @escaping (SdkResult<CreateAddressOutput, CreateAddressOutputError>) -> Void)
    ...
    func createLongTermPricing(input: CreateLongTermPricingInput, completion: @escaping (SdkResult<CreateLongTermPricingOutput, CreateLongTermPricingOutputError>) -> Void)
    /// <p>Creates a shipping label that will be used to return the Snow device to AWS.</p>
    func createReturnShippingLabel(input: CreateReturnShippingLabelInput, completion: @escaping (SdkResult<CreateReturnShippingLabelOutput, CreateReturnShippingLabelOutputError>) -> Void)
    ...
    func describeAddress(input: DescribeAddressInput, completion: @escaping (SdkResult<DescribeAddressOutput, DescribeAddressOutputError>) -> Void)
    ...
    func describeReturnShippingLabel(input: DescribeReturnShippingLabelInput, completion: @escaping (SdkResult<DescribeReturnShippingLabelOutput, DescribeReturnShippingLabelOutputError>) -> Void)
    ...
    func getJobManifest(input: GetJobManifestInput, completion: @escaping (SdkResult<GetJobManifestOutput, GetJobManifestOutputError>) -> Void)
    ...
    ///       with that job.</p>
    func getJobUnlockCode(input: GetJobUnlockCodeInput, completion: @escaping (SdkResult<GetJobUnlockCodeOutput, GetJobUnlockCodeOutputError>) -> Void)
    ...
    func getSnowballUsage(input: GetSnowballUsageInput, completion: @escaping (SdkResult<GetSnowballUsageOutput, GetSnowballUsageOutputError>) -> Void)
    /// <p>Returns an Amazon S3 presigned URL for an update file associated with a specified
    ///       <code>JobId</code>.</p>
    func getSoftwareUpdates(input: GetSoftwareUpdatesInput, completion: @escaping (SdkResult<GetSoftwareUpdatesOutput, GetSoftwareUpdatesOutputError>) -> Void)
    ...
    func listClusterJobs(input: ListClusterJobsInput, completion: @escaping (SdkResult<ListClusterJobsOutput, ListClusterJobsOutputError>) -> Void)
    ...
    ///       Marketplace.</p>
    func listCompatibleImages(input: ListCompatibleImagesInput, completion: @escaping (SdkResult<ListCompatibleImagesOutput, ListCompatibleImagesOutputError>) -> Void)
    /// <p>Returns an array of <code>JobListEntry</code> objects of the specified length. Each
    ...
    func listLongTermPricing(input: ListLongTermPricingInput, completion: @escaping (SdkResult<ListLongTermPricingOutput, ListLongTermPricingOutputError>) -> Void)
    ...
    func updateJobShipmentState(input: UpdateJobShipmentStateInput, completion: @escaping (SdkResult<UpdateJobShipmentStateOutput, UpdateJobShipmentStateOutputError>) -> Void)
    /// <p>Updates the long term pricing type.</p>
    func updateLongTermPricing(input: UpdateLongTermPricingInput, completion: @escaping (SdkResult<UpdateLongTermPricingOutput, UpdateLongTermPricingOutputError>) -> Void)
}
