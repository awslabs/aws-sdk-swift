...
public class SnowballClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try SnowballClientConfiguration(region: unwrappedRegion)
    ...
    public class SnowballClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("SnowballClient")
...
public struct SnowballClientLogHandlerFactory: SDKLogHandlerFactory {
