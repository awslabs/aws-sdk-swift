...
public struct CreateGroupInput: Swift.Equatable {
    ...
    var configuration: [ResourceGroupsClientTypes.GroupConfigurationItem]?
    ...
    var resourceQuery: ResourceGroupsClientTypes.ResourceQuery?
...
public struct CreateGroupOutputResponse: Swift.Equatable {
    ...
    var group: ResourceGroupsClientTypes.Group?
    ...
    var groupConfiguration: ResourceGroupsClientTypes.GroupConfiguration?
...
public struct GetGroupQueryOutputResponse: Swift.Equatable {
    ...
    var groupQuery: ResourceGroupsClientTypes.GroupQuery?
...
extension ResourceGroupsClientTypes {
    ...
    public struct GroupConfiguration: Swift.Equatable {
        ...
        var proposedConfiguration: [ResourceGroupsClientTypes.GroupConfigurationItem]?
        /// The current status of an attempt to update the group configuration.
        var status: ResourceGroupsClientTypes.GroupConfigurationStatus?
...
extension ResourceGroupsClientTypes {
    ...
    public struct GroupConfigurationItem: Swift.Equatable {
        ...
        var parameters: [ResourceGroupsClientTypes.GroupConfigurationParameter]?
...
extension ResourceGroupsClientTypes {
    ...
    public struct GroupFilter: Swift.Equatable {
        ...
        /// This member is required.
        var name: ResourceGroupsClientTypes.GroupFilterName?
...
public struct GroupResourcesOutputResponse: Swift.Equatable {
    ...
    var failed: [ResourceGroupsClientTypes.FailedResource]?
...
public struct ListGroupResourcesInput: Swift.Equatable {
    ...
    var filters: [ResourceGroupsClientTypes.ResourceFilter]?
    /// The name or the ARN of the resource group
    var group: Swift.String?
...
extension ResourceGroupsClientTypes {
    ...
    public struct ListGroupResourcesItem: Swift.Equatable {
        ...
        var identifier: ResourceGroupsClientTypes.ResourceIdentifier?
        ...
        var status: ResourceGroupsClientTypes.ResourceStatus?
...
public struct ListGroupResourcesOutputResponse: Swift.Equatable {
    ...
    var queryErrors: [ResourceGroupsClientTypes.QueryError]?
    ...
    var resourceIdentifiers: [ResourceGroupsClientTypes.ResourceIdentifier]?
    /// An array of resources from which you can determine each resource's identity, type, and group membership status.
    var resources: [ResourceGroupsClientTypes.ListGroupResourcesItem]?
...
public struct ListGroupsInput: Swift.Equatable {
    ...
    var filters: [ResourceGroupsClientTypes.GroupFilter]?
    /// The total number of results that you want included on each page of the response. If you do not include this parameter, it defaults to a value that is specific to the operation. If additional items exist beyond the maximum you specify, the NextToken response element is present and has a value (is not null). Include that value as the NextToken request parameter in the next call to the operation to get the next part of the results. Note that the service might return fewer results than the maximum even when there are more results available. You should check NextToken after every operation to ensure that you receive all of the results.
    var maxResults: Swift.Int?
    /// The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value provided by a previous call's NextToken response to indicate where the output should continue from.
    var nextToken: Swift.String?
...
public struct ListGroupsOutputResponse: Swift.Equatable {
    ...
    var groupIdentifiers: [ResourceGroupsClientTypes.GroupIdentifier]?
    ...
    var groups: [ResourceGroupsClientTypes.Group]?
    /// If present, indicates that more output is available than is included in the current response. Use this value in the NextToken request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the NextToken response element comes back as null.
    var nextToken: Swift.String?
...
extension ResourceGroupsClientTypes {
    ...
    public struct QueryError: Swift.Equatable {
        ...
        var errorCode: ResourceGroupsClientTypes.QueryErrorCode?
...
extension ResourceGroupsClientTypes {
    ...
    public struct ResourceFilter: Swift.Equatable {
        /// The name of the filter. Filter names are case-sensitive.
        /// This member is required.
        var name: ResourceGroupsClientTypes.ResourceFilterName?
...
extension ResourceGroupsClientTypes {
    ...
    public struct ResourceQuery: Swift.Equatable {
        ...
        /// This member is required.
        var type: ResourceGroupsClientTypes.QueryType?
...
extension ResourceGroupsClientTypes {
    ...
    public struct ResourceStatus: Swift.Equatable {
        /// The current status.
        var name: ResourceGroupsClientTypes.ResourceStatusValue?
