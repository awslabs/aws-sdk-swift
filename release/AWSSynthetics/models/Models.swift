...
extension SyntheticsClientTypes {
    ...
    public struct ArtifactConfigInput: Swift.Equatable {
        ...
        var s3Encryption: SyntheticsClientTypes.S3EncryptionConfig?
...
extension SyntheticsClientTypes {
    ...
    public struct BaseScreenshot: Swift.Equatable {
        ...
        var ignoreCoordinates: [Swift.String]?
        /// The name of the screenshot. This is generated the first time the canary is run after the UpdateCanary operation that specified for this canary to perform visual monitoring.
        /// This member is required.
        var screenshotName: Swift.String?
...
extension SyntheticsClientTypes {
    ...
    public struct Canary: Swift.Equatable {
        /// A structure that contains the configuration for canary artifacts, including the encryption-at-rest settings for artifacts that the canary uploads to Amazon S3.
        var artifactConfig: SyntheticsClientTypes.ArtifactConfigOutput?
        /// The location in Amazon S3 where Synthetics stores artifacts from the runs of this canary. Artifacts include the log file, screenshots, and HAR files.
        var artifactS3Location: Swift.String?
        /// This structure contains information about the canary's Lambda handler and where its code is stored by CloudWatch Synthetics.
        var code: SyntheticsClientTypes.CanaryCodeOutput?
        ...
        var engineArn: Swift.String?
        /// The ARN of the IAM role used to run the canary. This role must include lambda.amazonaws.com as a principal in the trust policy.
        var executionRoleArn: Swift.String?
        /// The number of days to retain data about failed runs of this canary.
        var failureRetentionPeriodInDays: Swift.Int?
        /// The unique ID of this canary.
        var id: Swift.String?
        /// The name of the canary.
        var name: Swift.String?
        /// A structure that contains information about a canary run.
        var runConfig: SyntheticsClientTypes.CanaryRunConfigOutput?
        ...
        var runtimeVersion: Swift.String?
        /// A structure that contains information about how often the canary is to run, and when these runs are to stop.
        var schedule: SyntheticsClientTypes.CanaryScheduleOutput?
        /// A structure that contains information about the canary's status.
        var status: SyntheticsClientTypes.CanaryStatus?
        /// The number of days to retain data about successful runs of this canary.
        var successRetentionPeriodInDays: Swift.Int?
        /// The list of key-value pairs that are associated with the canary.
        var tags: [Swift.String:Swift.String]?
        /// A structure that contains information about when the canary was created, modified, and most recently run.
        var timeline: SyntheticsClientTypes.CanaryTimeline?
        /// If this canary performs visual monitoring by comparing screenshots, this structure contains the ID of the canary run to use as the baseline for screenshots, and the coordinates of any parts of the screen to ignore during the visual monitoring comparison.
        var visualReference: SyntheticsClientTypes.VisualReferenceOutput?
        ...
        var vpcConfig: SyntheticsClientTypes.VpcConfigOutput?
...
extension SyntheticsClientTypes {
    ...
    public struct CanaryLastRun: Swift.Equatable {
        /// The name of the canary.
        var canaryName: Swift.String?
        /// The results from this canary's most recent run.
        var lastRun: SyntheticsClientTypes.CanaryRun?
...
extension SyntheticsClientTypes {
    ...
    public struct CanaryRun: Swift.Equatable {
        ...
        var status: SyntheticsClientTypes.CanaryRunStatus?
        /// A structure that contains the start and end times of this run.
        var timeline: SyntheticsClientTypes.CanaryRunTimeline?
...
extension SyntheticsClientTypes {
    ...
    public struct CanaryRunStatus: Swift.Equatable {
        ...
        var state: SyntheticsClientTypes.CanaryRunState?
        ...
        var stateReasonCode: SyntheticsClientTypes.CanaryRunStateReasonCode?
...
extension SyntheticsClientTypes {
    ...
    public struct CanaryRunTimeline: Swift.Equatable {
        ...
        var completed: ClientRuntime.Date?
...
extension SyntheticsClientTypes {
    ...
    public struct CanaryStatus: Swift.Equatable {
        ...
        var state: SyntheticsClientTypes.CanaryState?
        /// If the canary has insufficient permissions to run, this field provides more details.
        var stateReason: Swift.String?
        /// If the canary cannot run or has failed, this field displays the reason.
        var stateReasonCode: SyntheticsClientTypes.CanaryStateReasonCode?
...
extension SyntheticsClientTypes {
    ...
    public struct CanaryTimeline: Swift.Equatable {
        ...
        var lastStarted: ClientRuntime.Date?
        /// The date and time that the canary's most recent run ended.
        var lastStopped: ClientRuntime.Date?
...
public struct CreateCanaryInput: Swift.Equatable {
    /// A structure that contains the configuration for canary artifacts, including the encryption-at-rest settings for artifacts that the canary uploads to Amazon S3.
    var artifactConfig: SyntheticsClientTypes.ArtifactConfigInput?
    /// The location in Amazon S3 where Synthetics stores artifacts from the test runs of this canary. Artifacts include the log file, screenshots, and HAR files. The name of the S3 bucket can't include a period (.).
    /// This member is required.
    var artifactS3Location: Swift.String?
    /// A structure that includes the entry point from which the canary should start running your script. If the script is stored in an S3 bucket, the bucket name, key, and version are also included.
    /// This member is required.
    var code: SyntheticsClientTypes.CanaryCodeInput?
    ...
    var runConfig: SyntheticsClientTypes.CanaryRunConfigInput?
    ...
    /// This member is required.
    var schedule: SyntheticsClientTypes.CanaryScheduleInput?
    ...
    var vpcConfig: SyntheticsClientTypes.VpcConfigInput?
...
public struct CreateCanaryOutputResponse: Swift.Equatable {
    ...
    var canary: SyntheticsClientTypes.Canary?
...
public struct DescribeCanariesLastRunOutputResponse: Swift.Equatable {
    ...
    var canariesLastRun: [SyntheticsClientTypes.CanaryLastRun]?
...
public struct DescribeCanariesOutputResponse: Swift.Equatable {
    ...
    var canaries: [SyntheticsClientTypes.Canary]?
    /// A token that indicates that there is more data available. You can use this token in a subsequent DescribeCanaries operation to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct DescribeRuntimeVersionsOutputResponse: Swift.Equatable {
    ...
    var runtimeVersions: [SyntheticsClientTypes.RuntimeVersion]?
...
public struct GetCanaryRunsOutputResponse: Swift.Equatable {
    ...
    var canaryRuns: [SyntheticsClientTypes.CanaryRun]?
    /// A token that indicates that there is more data available. You can use this token in a subsequent GetCanaryRuns operation to retrieve the next set of results.
    var nextToken: Swift.String?
...
extension SyntheticsClientTypes {
    ...
    public struct RuntimeVersion: Swift.Equatable {
        ...
        var releaseDate: ClientRuntime.Date?
...
extension SyntheticsClientTypes {
    ...
    public struct S3EncryptionConfig: Swift.Equatable {
        ...
        var encryptionMode: SyntheticsClientTypes.EncryptionMode?
...
public struct UpdateCanaryInput: Swift.Equatable {
    ...
    var visualReference: SyntheticsClientTypes.VisualReferenceInput?
    /// If this canary is to test an endpoint in a VPC, this structure contains information about the subnet and security groups of the VPC endpoint. For more information, see [ Running a Canary in a VPC](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_VPC.html).
    var vpcConfig: SyntheticsClientTypes.VpcConfigInput?
...
extension SyntheticsClientTypes {
    ...
    public struct VisualReferenceInput: Swift.Equatable {
        ...
        /// This member is required.
        var baseCanaryRunId: Swift.String?
        ...
        var baseScreenshots: [SyntheticsClientTypes.BaseScreenshot]?
