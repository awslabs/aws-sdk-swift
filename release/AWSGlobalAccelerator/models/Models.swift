...
extension GlobalAcceleratorClientTypes {
    ...
    public struct Accelerator: Swift.Equatable {
        ...
        var acceleratorArn: Swift.String?
        ...
        var ipAddressType: GlobalAcceleratorClientTypes.IpAddressType?
        /// The static IP addresses that Global Accelerator associates with the accelerator.
        var ipSets: [GlobalAcceleratorClientTypes.IpSet]?
        /// The date and time that the accelerator was last modified.
        var lastModifiedTime: ClientRuntime.Date?
        /// The name of the accelerator. The name must contain only alphanumeric characters or hyphens (-), and must not begin or end with a hyphen.
        var name: Swift.String?
        /// Describes the deployment status of the accelerator.
        var status: GlobalAcceleratorClientTypes.AcceleratorStatus?
...
public struct AddCustomRoutingEndpointsInput: Swift.Equatable {
    ...
    var endpointConfigurations: [GlobalAcceleratorClientTypes.CustomRoutingEndpointConfiguration]?
    /// The Amazon Resource Name (ARN) of the endpoint group for the custom routing endpoint.
    /// This member is required.
    var endpointGroupArn: Swift.String?
...
public struct AddCustomRoutingEndpointsOutputResponse: Swift.Equatable {
    ...
    var endpointDescriptions: [GlobalAcceleratorClientTypes.CustomRoutingEndpointDescription]?
    /// The Amazon Resource Name (ARN) of the endpoint group for the custom routing endpoint.
    var endpointGroupArn: Swift.String?
...
public struct AdvertiseByoipCidrOutputResponse: Swift.Equatable {
    ...
    var byoipCidr: GlobalAcceleratorClientTypes.ByoipCidr?
...
public struct AllowCustomRoutingTrafficInput: Swift.Equatable {
    ...
    var allowAllTrafficToEndpoint: Swift.Bool?
...
extension GlobalAcceleratorClientTypes {
    ...
    public struct ByoipCidr: Swift.Equatable {
        ...
        var events: [GlobalAcceleratorClientTypes.ByoipCidrEvent]?
        /// The state of the address pool.
        var state: GlobalAcceleratorClientTypes.ByoipCidrState?
...
public struct CreateAcceleratorInput: Swift.Equatable {
    ...
    var tags: [GlobalAcceleratorClientTypes.Tag]?
...
public struct CreateAcceleratorOutputResponse: Swift.Equatable {
    ...
    var accelerator: GlobalAcceleratorClientTypes.Accelerator?
...
public struct CreateCustomRoutingAcceleratorOutputResponse: Swift.Equatable {
    ...
    var accelerator: GlobalAcceleratorClientTypes.CustomRoutingAccelerator?
...
public struct CreateCustomRoutingEndpointGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var destinationConfigurations: [GlobalAcceleratorClientTypes.CustomRoutingDestinationConfiguration]?
    /// The AWS Region where the endpoint group is located. A listener can have only one endpoint group in a specific Region.
    /// This member is required.
    var endpointGroupRegion: Swift.String?
    /// A unique, case-sensitive identifier that you provide to ensure the idempotency—that is, the uniqueness—of the request.
    /// This member is required.
    var idempotencyToken: Swift.String?
    /// The Amazon Resource Name (ARN) of the listener for a custom routing endpoint.
    /// This member is required.
    var listenerArn: Swift.String?
...
public struct CreateCustomRoutingEndpointGroupOutputResponse: Swift.Equatable {
    ...
    var endpointGroup: GlobalAcceleratorClientTypes.CustomRoutingEndpointGroup?
...
public struct CreateCustomRoutingListenerInput: Swift.Equatable {
    ...
    /// This member is required.
    var portRanges: [GlobalAcceleratorClientTypes.PortRange]?
...
public struct CreateCustomRoutingListenerOutputResponse: Swift.Equatable {
    ...
    var listener: GlobalAcceleratorClientTypes.CustomRoutingListener?
...
public struct CreateEndpointGroupInput: Swift.Equatable {
    ...
    var endpointConfigurations: [GlobalAcceleratorClientTypes.EndpointConfiguration]?
    /// The AWS Region where the endpoint group is located. A listener can have only one endpoint group in a specific Region.
    /// This member is required.
    var endpointGroupRegion: Swift.String?
    /// The time—10 seconds or 30 seconds—between each health check for an endpoint. The default value is 30.
    var healthCheckIntervalSeconds: Swift.Int?
    /// If the protocol is HTTP/S, then this specifies the path that is the destination for health check targets. The default value is slash (/).
    var healthCheckPath: Swift.String?
    /// The port that AWS Global Accelerator uses to check the health of endpoints that are part of this endpoint group. The default port is the listener port that this endpoint group is associated with. If listener port is a list of ports, Global Accelerator uses the first port in the list.
    var healthCheckPort: Swift.Int?
    /// The protocol that AWS Global Accelerator uses to check the health of endpoints that are part of this endpoint group. The default value is TCP.
    var healthCheckProtocol: GlobalAcceleratorClientTypes.HealthCheckProtocol?
    /// A unique, case-sensitive identifier that you provide to ensure the idempotency—that is, the uniqueness—of the request.
    /// This member is required.
    var idempotencyToken: Swift.String?
    ...
    var portOverrides: [GlobalAcceleratorClientTypes.PortOverride]?
    /// The number of consecutive health checks required to set the state of a healthy endpoint to unhealthy, or to set an unhealthy endpoint to healthy. The default value is 3.
    var thresholdCount: Swift.Int?
    ...
    var trafficDialPercentage: Swift.Float?
...
public struct CreateEndpointGroupOutputResponse: Swift.Equatable {
    ...
    var endpointGroup: GlobalAcceleratorClientTypes.EndpointGroup?
...
public struct CreateListenerInput: Swift.Equatable {
    ...
    /// This member is required.
    var `protocol`: GlobalAcceleratorClientTypes.ModelProtocol?
    ...
    var clientAffinity: GlobalAcceleratorClientTypes.ClientAffinity?
    /// A unique, case-sensitive identifier that you provide to ensure the idempotency—that is, the uniqueness—of the request.
    /// This member is required.
    var idempotencyToken: Swift.String?
...
public struct CreateListenerOutputResponse: Swift.Equatable {
    ...
    var listener: GlobalAcceleratorClientTypes.Listener?
...
extension GlobalAcceleratorClientTypes {
    ...
    public struct CustomRoutingAccelerator: Swift.Equatable {
        ...
        var name: Swift.String?
        /// Describes the deployment status of the accelerator.
        var status: GlobalAcceleratorClientTypes.CustomRoutingAcceleratorStatus?
...
extension GlobalAcceleratorClientTypes {
    ...
    public struct CustomRoutingDestinationConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var fromPort: Swift.Int?
        /// The protocol for the endpoint group that is associated with a custom routing accelerator. The protocol can be either TCP or UDP.
        /// This member is required.
        var protocols: [GlobalAcceleratorClientTypes.CustomRoutingProtocol]?
        /// The last port, inclusive, in the range of ports for the endpoint group that is associated with a custom routing accelerator.
        /// This member is required.
        var toPort: Swift.Int?
...
extension GlobalAcceleratorClientTypes {
    ...
    public struct CustomRoutingDestinationDescription: Swift.Equatable {
        ...
        var fromPort: Swift.Int?
        /// The protocol for the endpoint group that is associated with a custom routing accelerator. The protocol can be either TCP or UDP.
        var protocols: [GlobalAcceleratorClientTypes.ModelProtocol]?
        /// The last port, inclusive, in the range of ports for the endpoint group that is associated with a custom routing accelerator.
        var toPort: Swift.Int?
...
extension GlobalAcceleratorClientTypes {
    ...
    public struct CustomRoutingEndpointGroup: Swift.Equatable {
        /// For a custom routing accelerator, describes the port range and protocol for all endpoints (virtual private cloud subnets) in an endpoint group to accept client traffic on.
        var destinationDescriptions: [GlobalAcceleratorClientTypes.CustomRoutingDestinationDescription]?
...
public struct DenyCustomRoutingTrafficInput: Swift.Equatable {
    ...
    var denyAllTrafficToEndpoint: Swift.Bool?
...
public struct DescribeAcceleratorAttributesOutputResponse: Swift.Equatable {
    ...
    var acceleratorAttributes: GlobalAcceleratorClientTypes.AcceleratorAttributes?
...
public struct DescribeCustomRoutingAcceleratorAttributesOutputResponse: Swift.Equatable {
    ...
    var acceleratorAttributes: GlobalAcceleratorClientTypes.CustomRoutingAcceleratorAttributes?
...
extension GlobalAcceleratorClientTypes {
    ...
    public struct DestinationPortMapping: Swift.Equatable {
        ...
        var acceleratorSocketAddresses: [GlobalAcceleratorClientTypes.SocketAddress]?
        /// The endpoint IP address/port combination for traffic received on the accelerator socket address.
        var destinationSocketAddress: GlobalAcceleratorClientTypes.SocketAddress?
        /// Indicates whether or not a port mapping destination can receive traffic. The value is either ALLOW, if traffic is allowed to the destination, or DENY, if traffic is not allowed to the destination.
        var destinationTrafficState: GlobalAcceleratorClientTypes.CustomRoutingDestinationTrafficState?
        /// The Amazon Resource Name (ARN) of the endpoint group.
        var endpointGroupArn: Swift.String?
...
extension GlobalAcceleratorClientTypes {
    ...
    public struct EndpointConfiguration: Swift.Equatable {
        ...
        var clientIPPreservationEnabled: Swift.Bool?
...
extension GlobalAcceleratorClientTypes {
    ...
    public struct EndpointDescription: Swift.Equatable {
        ...
        var healthReason: Swift.String?
        /// The health status of the endpoint.
        var healthState: GlobalAcceleratorClientTypes.HealthState?
        /// The weight associated with the endpoint. When you add weights to endpoints, you configure AWS Global Accelerator to route traffic based on proportions that you specify. For example, you might specify endpoint weights of 4, 5, 5, and 6 (sum=20). The result is that 4/20 of your traffic, on average, is routed to the first endpoint, 5/20 is routed both to the second and third endpoints, and 6/20 is routed to the last endpoint. For more information, see [Endpoint Weights](https://docs.aws.amazon.com/global-accelerator/latest/dg/about-endpoints-endpoint-weights.html) in the AWS Global Accelerator Developer Guide.
        var weight: Swift.Int?
...
extension GlobalAcceleratorClientTypes {
    ...
    public struct EndpointGroup: Swift.Equatable {
        /// The list of endpoint objects.
        var endpointDescriptions: [GlobalAcceleratorClientTypes.EndpointDescription]?
        /// The Amazon Resource Name (ARN) of the endpoint group.
        var endpointGroupArn: Swift.String?
        /// The AWS Region where the endpoint group is located.
        var endpointGroupRegion: Swift.String?
...
public struct ListAcceleratorsOutputResponse: Swift.Equatable {
    ...
    var accelerators: [GlobalAcceleratorClientTypes.Accelerator]?
    /// The token for the next set of results. You receive this token from a previous call.
    var nextToken: Swift.String?
...
public struct ListByoipCidrsOutputResponse: Swift.Equatable {
    ...
    var byoipCidrs: [GlobalAcceleratorClientTypes.ByoipCidr]?
    /// The token for the next page of results.
    var nextToken: Swift.String?
...
public struct ListCustomRoutingAcceleratorsOutputResponse: Swift.Equatable {
    ...
    var accelerators: [GlobalAcceleratorClientTypes.CustomRoutingAccelerator]?
    /// The token for the next set of results. You receive this token from a previous call.
    var nextToken: Swift.String?
...
public struct ListCustomRoutingEndpointGroupsOutputResponse: Swift.Equatable {
    ...
    var endpointGroups: [GlobalAcceleratorClientTypes.CustomRoutingEndpointGroup]?
    /// The token for the next set of results. You receive this token from a previous call.
    var nextToken: Swift.String?
...
public struct ListCustomRoutingListenersOutputResponse: Swift.Equatable {
    ...
    var listeners: [GlobalAcceleratorClientTypes.CustomRoutingListener]?
    /// The token for the next set of results. You receive this token from a previous call.
    var nextToken: Swift.String?
...
public struct ListCustomRoutingPortMappingsByDestinationInput: Swift.Equatable {
    ...
    /// This member is required.
    var destinationAddress: Swift.String?
    /// The ID for the virtual private cloud (VPC) subnet.
    /// This member is required.
    var endpointId: Swift.String?
...
public struct ListCustomRoutingPortMappingsByDestinationOutputResponse: Swift.Equatable {
    ...
    var destinationPortMappings: [GlobalAcceleratorClientTypes.DestinationPortMapping]?
    /// The token for the next set of results. You receive this token from a previous call.
    var nextToken: Swift.String?
...
public struct ListCustomRoutingPortMappingsOutputResponse: Swift.Equatable {
    ...
    var portMappings: [GlobalAcceleratorClientTypes.PortMapping]?
...
public struct ListEndpointGroupsOutputResponse: Swift.Equatable {
    ...
    var endpointGroups: [GlobalAcceleratorClientTypes.EndpointGroup]?
    /// The token for the next set of results. You receive this token from a previous call.
    var nextToken: Swift.String?
...
public struct ListListenersOutputResponse: Swift.Equatable {
    ...
    var listeners: [GlobalAcceleratorClientTypes.Listener]?
    /// The token for the next set of results. You receive this token from a previous call.
    var nextToken: Swift.String?
...
extension GlobalAcceleratorClientTypes {
    ...
    public struct PortOverride: Swift.Equatable {
        ...
        var endpointPort: Swift.Int?
        /// The listener port that you want to map to a specific endpoint port. This is the port that user traffic arrives to the Global Accelerator on.
        var listenerPort: Swift.Int?
...
public struct ProvisionByoipCidrInput: Swift.Equatable {
    ...
    /// This member is required.
    var cidrAuthorizationContext: GlobalAcceleratorClientTypes.CidrAuthorizationContext?
