...
public protocol SsoClientProtocol {
    ...
    ///       user.</p>
    func getRoleCredentials(input: GetRoleCredentialsInput, completion: @escaping (SdkResult<GetRoleCredentialsOutput, GetRoleCredentialsOutputError>) -> Void)
    /// <p>Lists all roles that are assigned to the user for a given AWS account.</p>
    func listAccountRoles(input: ListAccountRolesInput, completion: @escaping (SdkResult<ListAccountRolesOutput, ListAccountRolesOutputError>) -> Void)
    ...
    func listAccounts(input: ListAccountsInput, completion: @escaping (SdkResult<ListAccountsOutput, ListAccountsOutputError>) -> Void)
    /// <p>Removes the client- and server-side session that is associated with the user.</p>
    func logout(input: LogoutInput, completion: @escaping (SdkResult<LogoutOutput, LogoutOutputError>) -> Void)
}
