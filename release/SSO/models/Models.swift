...
extension SsoClientTypes.AccountInfo: Swift.Codable, ClientRuntime.Reflection {
...
extension SsoClientTypes.AccountInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AccountInfo(accountId: \(Swift.String(describing: accountId)), accountName: \(Swift.String(describing: accountName)), emailAddress: \(Swift.String(describing: emailAddress)))"}
}
...
extension GetRoleCredentialsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRoleCredentialsInput(accessToken: \(Swift.String(describing: accessToken)), accountId: \(Swift.String(describing: accountId)), roleName: \(Swift.String(describing: roleName)))"}
}

extension GetRoleCredentialsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetRoleCredentialsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRoleCredentialsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetRoleCredentialsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetRoleCredentialsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    Self.MError == H.MiddlewareError
    {
        if let accessToken = input.operationInput.accessToken {
            input.builder.withHeader(name: "x-amz-sso_bearer_token", value: Swift.String(accessToken))
        }
        return next.handle(context: context, input: input)
    }

    public typealias MInput = ClientRuntime.SerializeStepInput<GetRoleCredentialsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetRoleCredentialsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRoleCredentialsOutputError>
}

public struct GetRoleCredentialsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRoleCredentialsInputQueryItemMiddleware"
...
extension GetRoleCredentialsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRoleCredentialsOutputResponse(roleCredentials: \(Swift.String(describing: roleCredentials)))"}
}
...
public struct GetRoleCredentialsOutputResponse: Swift.Equatable {
    ...
    public let roleCredentials: SsoClientTypes.RoleCredentials?
...
extension ListAccountRolesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAccountRolesInput(accessToken: \(Swift.String(describing: accessToken)), accountId: \(Swift.String(describing: accountId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListAccountRolesInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListAccountRolesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccountRolesInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListAccountRolesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListAccountRolesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListAccountRolesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListAccountRolesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAccountRolesOutputError>
}

public struct ListAccountRolesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccountRolesInputQueryItemMiddleware"
...
extension ListAccountRolesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAccountRolesOutputResponse(nextToken: \(Swift.String(describing: nextToken)), roleList: \(Swift.String(describing: roleList)))"}
}
...
public struct ListAccountRolesOutputResponse: Swift.Equatable {
    ...
    public let roleList: [SsoClientTypes.RoleInfo]?
...
extension ListAccountsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAccountsInput(accessToken: \(Swift.String(describing: accessToken)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
extension ListAccountsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAccountsOutputResponse(accountList: \(Swift.String(describing: accountList)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct ListAccountsOutputResponse: Swift.Equatable {
    ...
    public let accountList: [SsoClientTypes.AccountInfo]?
    /// <p>The page token client that is used to retrieve the list of accounts.</p>
    public let nextToken: Swift.String?
...
extension LogoutInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LogoutInput(accessToken: \(Swift.String(describing: accessToken)))"}
}

extension LogoutInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct LogoutInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "LogoutInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<LogoutInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<LogoutOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<LogoutInput>
    public typealias MOutput = ClientRuntime.OperationOutput<LogoutOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<LogoutOutputError>
}

public struct LogoutInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "LogoutInputQueryItemMiddleware"
...
extension LogoutOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct LogoutOutputResponseBody: Swift.Equatable {
}

extension LogoutOutputResponseBody: Swift.Decodable {
...
extension SsoClientTypes.RoleCredentials: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accessKeyId
        case expiration
...
extension SsoClientTypes.RoleCredentials: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RoleCredentials(accessKeyId: \(Swift.String(describing: accessKeyId)), expiration: \(Swift.String(describing: expiration)), secretAccessKey: \(Swift.String(describing: secretAccessKey)), sessionToken: \(Swift.String(describing: sessionToken)))"}
}
...
extension SsoClientTypes.RoleInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountId
        case roleName
    }
...
extension SsoClientTypes.RoleInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RoleInfo(accountId: \(Swift.String(describing: accountId)), roleName: \(Swift.String(describing: roleName)))"}
}
