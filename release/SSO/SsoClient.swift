...
extension SsoClient: SsoClientProtocol {
    ...
    ///       user.</p>
    public func getRoleCredentials(input: GetRoleCredentialsInput, completion: @escaping (SdkResult<GetRoleCredentialsOutput, GetRoleCredentialsOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<GetRoleCredentialsInput, GetRoleCredentialsOutput, GetRoleCredentialsOutputError>(id: "getRoleCredentials")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetRoleCredentialsInput, GetRoleCredentialsOutput, GetRoleCredentialsOutputError>(contentType: "application/json"))
    ...
    public func listAccountRoles(input: ListAccountRolesInput, completion: @escaping (SdkResult<ListAccountRolesOutput, ListAccountRolesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "awsssoportal")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAccountRolesInput, ListAccountRolesOutput, ListAccountRolesOutputError>(id: "listAccountRoles")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAccountRolesInput, ListAccountRolesOutput, ListAccountRolesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func logout(input: LogoutInput, completion: @escaping (SdkResult<LogoutOutput, LogoutOutputError>) -> Void)
    {
        let urlPath = "/logout"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "awsssoportal")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<LogoutInput, LogoutOutput, LogoutOutputError>(id: "logout")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<LogoutInput, LogoutOutput, LogoutOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
