...
public protocol SageMakerA2IRuntimeClientProtocol {
    ...
    func deleteHumanLoop(input: DeleteHumanLoopInput, completion: @escaping (SdkResult<DeleteHumanLoopOutputResponse, DeleteHumanLoopOutputError>) -> Void)
    ...
    func describeHumanLoop(input: DescribeHumanLoopInput, completion: @escaping (SdkResult<DescribeHumanLoopOutputResponse, DescribeHumanLoopOutputError>) -> Void)
    ...
    func listHumanLoops(input: ListHumanLoopsInput, completion: @escaping (SdkResult<ListHumanLoopsOutputResponse, ListHumanLoopsOutputError>) -> Void)
    /// <p>Starts a human loop, provided that at least one activation condition is met.</p>
    func startHumanLoop(input: StartHumanLoopInput, completion: @escaping (SdkResult<StartHumanLoopOutputResponse, StartHumanLoopOutputError>) -> Void)
    /// <p>Stops the specified human loop.</p>
    func stopHumanLoop(input: StopHumanLoopInput, completion: @escaping (SdkResult<StopHumanLoopOutputResponse, StopHumanLoopOutputError>) -> Void)
}
