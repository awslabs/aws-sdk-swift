...
public protocol SageMakerA2IRuntimeClientProtocol {
    ...
    func deleteHumanLoop(input: DeleteHumanLoopInput, completion: @escaping (SdkResult<DeleteHumanLoopOutput, DeleteHumanLoopOutputError>) -> Void)
    ...
    func describeHumanLoop(input: DescribeHumanLoopInput, completion: @escaping (SdkResult<DescribeHumanLoopOutput, DescribeHumanLoopOutputError>) -> Void)
    ...
    func listHumanLoops(input: ListHumanLoopsInput, completion: @escaping (SdkResult<ListHumanLoopsOutput, ListHumanLoopsOutputError>) -> Void)
    /// <p>Starts a human loop, provided that at least one activation condition is met.</p>
    func startHumanLoop(input: StartHumanLoopInput, completion: @escaping (SdkResult<StartHumanLoopOutput, StartHumanLoopOutputError>) -> Void)
    /// <p>Stops the specified human loop.</p>
    func stopHumanLoop(input: StopHumanLoopInput, completion: @escaping (SdkResult<StopHumanLoopOutput, StopHumanLoopOutputError>) -> Void)
}
