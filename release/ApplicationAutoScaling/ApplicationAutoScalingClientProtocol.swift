...
public protocol ApplicationAutoScalingClientProtocol {
    ...
    ///          </note>
    func deregisterScalableTarget(input: DeregisterScalableTargetInput, completion: @escaping (SdkResult<DeregisterScalableTargetOutputResponse, DeregisterScalableTargetOutputError>) -> Void)
    ...
    func describeScalableTargets(input: DescribeScalableTargetsInput, completion: @escaping (SdkResult<DescribeScalableTargetsOutputResponse, DescribeScalableTargetsOutputError>) -> Void)
    ...
    ///             <code>ScalableDimension</code>.</p>
    func describeScalingActivities(input: DescribeScalingActivitiesInput, completion: @escaping (SdkResult<DescribeScalingActivitiesOutputResponse, DescribeScalingActivitiesOutputError>) -> Void)
    ...
    ///             are deleted.</p>
    ///          </note>
    func putScheduledAction(input: PutScheduledActionInput, completion: @escaping (SdkResult<PutScheduledActionOutputResponse, PutScheduledActionOutputError>) -> Void)
    ...
    func registerScalableTarget(input: RegisterScalableTargetInput, completion: @escaping (SdkResult<RegisterScalableTargetOutputResponse, RegisterScalableTargetOutputError>) -> Void)
}
