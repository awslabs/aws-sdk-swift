...
public protocol ApplicationAutoScalingClientProtocol {
    ...
    ///          </note>
    func deregisterScalableTarget(input: DeregisterScalableTargetInput, completion: @escaping (SdkResult<DeregisterScalableTargetOutput, DeregisterScalableTargetOutputError>) -> Void)
    ...
    func describeScalableTargets(input: DescribeScalableTargetsInput, completion: @escaping (SdkResult<DescribeScalableTargetsOutput, DescribeScalableTargetsOutputError>) -> Void)
    ...
    ///             are deleted.</p>
    ///          </note>
    func putScheduledAction(input: PutScheduledActionInput, completion: @escaping (SdkResult<PutScheduledActionOutput, PutScheduledActionOutputError>) -> Void)
    ...
    func registerScalableTarget(input: RegisterScalableTargetInput, completion: @escaping (SdkResult<RegisterScalableTargetOutput, RegisterScalableTargetOutputError>) -> Void)
}
