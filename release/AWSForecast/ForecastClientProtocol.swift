...
public protocol ForecastClientProtocol {
    ...
    func createAutoPredictor(input: CreateAutoPredictorInput, completion: @escaping (ClientRuntime.SdkResult<CreateAutoPredictorOutputResponse, CreateAutoPredictorOutputError>) -> Void)
    ...
    func createExplainability(input: CreateExplainabilityInput, completion: @escaping (ClientRuntime.SdkResult<CreateExplainabilityOutputResponse, CreateExplainabilityOutputError>) -> Void)
    ...
    func createExplainabilityExport(input: CreateExplainabilityExportInput, completion: @escaping (ClientRuntime.SdkResult<CreateExplainabilityExportOutputResponse, CreateExplainabilityExportOutputError>) -> Void)
    ...
    func deleteExplainability(input: DeleteExplainabilityInput, completion: @escaping (ClientRuntime.SdkResult<DeleteExplainabilityOutputResponse, DeleteExplainabilityOutputError>) -> Void)
    /// Deletes an Explainability export job.
    func deleteExplainabilityExport(input: DeleteExplainabilityExportInput, completion: @escaping (ClientRuntime.SdkResult<DeleteExplainabilityExportOutputResponse, DeleteExplainabilityExportOutputError>) -> Void)
    ...
    func describeAutoPredictor(input: DescribeAutoPredictorInput, completion: @escaping (ClientRuntime.SdkResult<DescribeAutoPredictorOutputResponse, DescribeAutoPredictorOutputError>) -> Void)
    ...
    func describeExplainability(input: DescribeExplainabilityInput, completion: @escaping (ClientRuntime.SdkResult<DescribeExplainabilityOutputResponse, DescribeExplainabilityOutputError>) -> Void)
    /// Describes an Explainability export created using the [CreateExplainabilityExport] operation.
    func describeExplainabilityExport(input: DescribeExplainabilityExportInput, completion: @escaping (ClientRuntime.SdkResult<DescribeExplainabilityExportOutputResponse, DescribeExplainabilityExportOutputError>) -> Void)
    ...
    func listExplainabilities(input: ListExplainabilitiesInput, completion: @escaping (ClientRuntime.SdkResult<ListExplainabilitiesOutputResponse, ListExplainabilitiesOutputError>) -> Void)
    ...
    func listExplainabilityExports(input: ListExplainabilityExportsInput, completion: @escaping (ClientRuntime.SdkResult<ListExplainabilityExportsOutputResponse, ListExplainabilityExportsOutputError>) -> Void)
