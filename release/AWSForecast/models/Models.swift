...
extension ForecastClientTypes {
    ...
    public struct AttributeConfig: Swift.Equatable {
        ...
        /// This member is required.
        var transformations: [Swift.String:Swift.String]?
...
extension ForecastClientTypes {
    ...
    public struct ContinuousParameterRange: Swift.Equatable {
        ...
        var scalingType: ForecastClientTypes.ScalingType?
...
public struct CreateAutoPredictorInput: Swift.Equatable {
    ...
    var dataConfig: ForecastClientTypes.DataConfig?
    /// An AWS Key Management Service (KMS) key and an AWS Identity and Access Management (IAM) role that Amazon Forecast can assume to access the key. You can specify this optional object in the [CreateDataset] and [CreatePredictor] requests.
    var encryptionConfig: ForecastClientTypes.EncryptionConfig?
    var explainPredictor: Swift.Bool?
    ...
    var forecastDimensions: [Swift.String]?
    ...
    var forecastFrequency: Swift.String?
    /// The number of time-steps that the model predicts. The forecast horizon is also called the prediction length.
    var forecastHorizon: Swift.Int?
    ...
    var forecastTypes: [Swift.String]?
    /// The accuracy metric used to optimize the predictor.
    var optimizationMetric: ForecastClientTypes.OptimizationMetric?
    /// A unique name for the predictor
    /// This member is required.
    var predictorName: Swift.String?
    ...
    var referencePredictorArn: Swift.String?
    ...
    var tags: [ForecastClientTypes.Tag]?
...
public struct CreateDatasetGroupInput: Swift.Equatable {
    ...
    var datasetArns: [Swift.String]?
    /// A name for the dataset group.
    /// This member is required.
    var datasetGroupName: Swift.String?
    ...
    /// This member is required.
    var domain: ForecastClientTypes.Domain?
...
public struct CreateDatasetGroupOutputResponse: Swift.Equatable {
    ...
    var datasetGroupArn: Swift.String?
...
public struct CreateDatasetImportJobInput: Swift.Equatable {
    ...
    var geolocationFormat: Swift.String?
    ...
    var useGeolocationForTimeZone: Swift.Bool
...
public struct CreateDatasetImportJobOutputResponse: Swift.Equatable {
    ...
    var datasetImportJobArn: Swift.String?
...
public struct CreateDatasetInput: Swift.Equatable {
    ...
    var dataFrequency: Swift.String?
    /// A name for the dataset.
    /// This member is required.
    var datasetName: Swift.String?
    /// The dataset type. Valid values depend on the chosen Domain.
    /// This member is required.
    var datasetType: ForecastClientTypes.DatasetType?
    ...
    /// This member is required.
    var schema: ForecastClientTypes.Schema?
...
public struct CreateExplainabilityExportInput: Swift.Equatable {
    ...
    /// This member is required.
    var destination: ForecastClientTypes.DataDestination?
    /// The Amazon Resource Name (ARN) of the Explainability to export.
    /// This member is required.
    var explainabilityArn: Swift.String?
    /// A unique name for the Explainability export.
    /// This member is required.
    var explainabilityExportName: Swift.String?
...
public struct CreateExplainabilityExportOutputResponse: Swift.Equatable {
    ...
    var explainabilityExportArn: Swift.String?
...
public struct CreateExplainabilityInput: Swift.Equatable {
    ...
    var enableVisualization: Swift.Bool?
    ...
    /// This member is required.
    var explainabilityConfig: ForecastClientTypes.ExplainabilityConfig?
    /// A unique name for the Explainability.
    /// This member is required.
    var explainabilityName: Swift.String?
...
public struct CreateForecastExportJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var forecastArn: Swift.String?
    /// The name for the forecast export job.
    /// This member is required.
    var forecastExportJobName: Swift.String?
...
public struct CreateForecastExportJobOutputResponse: Swift.Equatable {
    ...
    var forecastExportJobArn: Swift.String?
...
public struct CreatePredictorBacktestExportJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var predictorBacktestExportJobName: Swift.String?
...
public struct CreatePredictorBacktestExportJobOutputResponse: Swift.Equatable {
    ...
    var predictorBacktestExportJobArn: Swift.String?
...
public struct CreatePredictorInput: Swift.Equatable {
    ...
    var autoMLOverrideStrategy: ForecastClientTypes.AutoMLOverrideStrategy?
    /// An AWS Key Management Service (KMS) key and the AWS Identity and Access Management (IAM) role that Amazon Forecast can assume to access the key.
    var encryptionConfig: ForecastClientTypes.EncryptionConfig?
    /// Used to override the default evaluation parameters of the specified algorithm. Amazon Forecast evaluates a predictor by splitting a dataset into training data and testing data. The evaluation parameters define how to perform the split and the number of iterations.
    var evaluationParameters: ForecastClientTypes.EvaluationParameters?
    /// The featurization configuration.
    /// This member is required.
    var featurizationConfig: ForecastClientTypes.FeaturizationConfig?
    ...
    var hPOConfig: ForecastClientTypes.HyperParameterTuningJobConfig?
    /// Describes the dataset group that contains the data to use to train the predictor.
    /// This member is required.
    var inputDataConfig: ForecastClientTypes.InputDataConfig?
    /// The accuracy metric used to optimize the predictor.
    var optimizationMetric: ForecastClientTypes.OptimizationMetric?
...
extension ForecastClientTypes {
    ...
    public struct DataConfig: Swift.Equatable {
        ...
        var additionalDatasets: [ForecastClientTypes.AdditionalDataset]?
        /// Aggregation and filling options for attributes in your dataset group.
        var attributeConfigs: [ForecastClientTypes.AttributeConfig]?
...
extension ForecastClientTypes {
    ...
    public struct DataDestination: Swift.Equatable {
        ...
        /// This member is required.
        var s3Config: ForecastClientTypes.S3Config?
...
extension ForecastClientTypes {
    ...
    public struct DatasetGroupSummary: Swift.Equatable {
        ...
        var lastModificationTime: ClientRuntime.Date?
...
public struct DescribeAutoPredictorOutputResponse: Swift.Equatable {
    ...
    var datasetImportJobArns: [Swift.String]?
    /// An AWS Key Management Service (KMS) key and an AWS Identity and Access Management (IAM) role that Amazon Forecast can assume to access the key. You can specify this optional object in the [CreateDataset] and [CreatePredictor] requests.
    var encryptionConfig: ForecastClientTypes.EncryptionConfig?
    /// The estimated time remaining in minutes for the predictor training job to complete.
    var estimatedTimeRemainingInMinutes: Swift.Int?
    var explainabilityInfo: ForecastClientTypes.ExplainabilityInfo?
    ...
    var referencePredictorSummary: ForecastClientTypes.ReferencePredictorSummary?
...
public struct DescribeDatasetImportJobOutputResponse: Swift.Equatable {
    ...
    var fieldStatistics: [Swift.String:ForecastClientTypes.Statistics]?
...
public struct DescribePredictorOutputResponse: Swift.Equatable {
    ...
    var autoMLAlgorithmArns: [Swift.String]?
    ...
    var isAutoPredictor: Swift.Bool?
    /// The last time the resource was modified. The timestamp depends on the status of the job:
    ///
    /// * CREATE_PENDING - The CreationTime.
    ///
    ...
    var predictorExecutionDetails: ForecastClientTypes.PredictorExecutionDetails?
    /// The name of the predictor.
    var predictorName: Swift.String?
    /// The status of the predictor. States include:
    ///
...
extension ForecastClientTypes {
    ...
    public struct ErrorMetric: Swift.Equatable {
        ...
        var forecastType: Swift.String?
        /// The Mean Absolute Percentage Error (MAPE)
        var mAPE: Swift.Double?
        /// The Mean Absolute Scaled Error (MASE)
        var mASE: Swift.Double?
        /// The root-mean-square error (RMSE).
        var rMSE: Swift.Double?
        /// The weighted absolute percentage error (WAPE).
        var wAPE: Swift.Double?
...
extension ForecastClientTypes {
    ...
    public struct EvaluationParameters: Swift.Equatable {
        ...
        var backTestWindowOffset: Swift.Int?
        /// The number of times to split the input data. The default is 1. Valid values are 1 through 5.
        var numberOfBacktestWindows: Swift.Int?
...
extension ForecastClientTypes {
    ...
    public struct EvaluationResult: Swift.Equatable {
        ...
        var testWindows: [ForecastClientTypes.WindowSummary]?
...
extension ForecastClientTypes {
    ...
    public struct ExplainabilityConfig: Swift.Equatable {
        ...
        /// This member is required.
        var timePointGranularity: ForecastClientTypes.TimePointGranularity?
        ...
        /// This member is required.
        var timeSeriesGranularity: ForecastClientTypes.TimeSeriesGranularity?
...
extension ForecastClientTypes {
    ...
    public struct Featurization: Swift.Equatable {
        ...
        var featurizationPipeline: [ForecastClientTypes.FeaturizationMethod]?
...
extension ForecastClientTypes {
    ...
    public struct FeaturizationConfig: Swift.Equatable {
        ...
        var featurizations: [ForecastClientTypes.Featurization]?
...
extension ForecastClientTypes {
    ...
    public struct FeaturizationMethod: Swift.Equatable {
        ...
        /// This member is required.
        var featurizationMethodName: ForecastClientTypes.FeaturizationMethodName?
        ...
        ///
        /// To set a filling method to a specific value, set the fill parameter to value and define the value in a corresponding _value parameter. For example, to set backfilling to a value of 2, include the following: "backfill": "value" and "backfill_value":"2".
        var featurizationMethodParameters: [Swift.String:Swift.String]?
...
extension ForecastClientTypes {
    ...
    public struct Filter: Swift.Equatable {
        ...
        /// This member is required.
        var condition: ForecastClientTypes.FilterConditionString?
...
extension ForecastClientTypes {
    ...
    public struct ForecastSummary: Swift.Equatable {
        var createdUsingAutoPredictor: Swift.Bool?
        /// When the forecast creation task was created.
        var creationTime: ClientRuntime.Date?
...
public struct GetAccuracyMetricsOutputResponse: Swift.Equatable {
    ...
    var predictorEvaluationResults: [ForecastClientTypes.EvaluationResult]?
...
extension ForecastClientTypes {
    ...
    public struct HyperParameterTuningJobConfig: Swift.Equatable {
        ...
        var parameterRanges: ForecastClientTypes.ParameterRanges?
...
extension ForecastClientTypes {
    ...
    public struct InputDataConfig: Swift.Equatable {
        ...
        var supplementaryFeatures: [ForecastClientTypes.SupplementaryFeature]?
...
extension ForecastClientTypes {
    ...
    public struct IntegerParameterRange: Swift.Equatable {
        /// The maximum tunable value of the hyperparameter.
        /// This member is required.
        var maxValue: Swift.Int?
        /// The minimum tunable value of the hyperparameter.
        /// This member is required.
        var minValue: Swift.Int?
        /// The name of the hyperparameter to tune.
        /// This member is required.
        var name: Swift.String?
...
public struct ListDatasetGroupsOutputResponse: Swift.Equatable {
    ...
    var datasetGroups: [ForecastClientTypes.DatasetGroupSummary]?
...
public struct ListDatasetImportJobsInput: Swift.Equatable {
    ...
    var filters: [ForecastClientTypes.Filter]?
    /// The number of items to return in the response.
    var maxResults: Swift.Int?
    /// If the result of the previous request was truncated, the response includes a NextToken. To retrieve the next set of results, use the token in the next request. Tokens expire after 24 hours.
    var nextToken: Swift.String?
...
public struct ListDatasetImportJobsOutputResponse: Swift.Equatable {
    ...
    var datasetImportJobs: [ForecastClientTypes.DatasetImportJobSummary]?
    /// If the response is truncated, Amazon Forecast returns this token. To retrieve the next set of results, use the token in the next request.
    var nextToken: Swift.String?
...
public struct ListDatasetsOutputResponse: Swift.Equatable {
    ...
    var datasets: [ForecastClientTypes.DatasetSummary]?
    /// If the response is truncated, Amazon Forecast returns this token. To retrieve the next set of results, use the token in the next request.
    var nextToken: Swift.String?
...
public struct ListExplainabilitiesOutputResponse: Swift.Equatable {
    ...
    var explainabilities: [ForecastClientTypes.ExplainabilitySummary]?
...
public struct ListExplainabilityExportsOutputResponse: Swift.Equatable {
    ...
    var explainabilityExports: [ForecastClientTypes.ExplainabilityExportSummary]?
    /// Returns this token if the response is truncated. To retrieve the next set of results, use the token in the next request.
    var nextToken: Swift.String?
...
public struct ListForecastExportJobsOutputResponse: Swift.Equatable {
    ...
    var forecastExportJobs: [ForecastClientTypes.ForecastExportJobSummary]?
    /// If the response is truncated, Amazon Forecast returns this token. To retrieve the next set of results, use the token in the next request.
    var nextToken: Swift.String?
...
public struct ListForecastsOutputResponse: Swift.Equatable {
    ...
    var forecasts: [ForecastClientTypes.ForecastSummary]?
    /// If the response is truncated, Amazon Forecast returns this token. To retrieve the next set of results, use the token in the next request.
    var nextToken: Swift.String?
...
public struct ListPredictorBacktestExportJobsOutputResponse: Swift.Equatable {
    ...
    var predictorBacktestExportJobs: [ForecastClientTypes.PredictorBacktestExportJobSummary]?
...
public struct ListPredictorsOutputResponse: Swift.Equatable {
    ...
    var predictors: [ForecastClientTypes.PredictorSummary]?
...
extension ForecastClientTypes {
    ...
    public struct Metrics: Swift.Equatable {
        ...
        var averageWeightedQuantileLoss: Swift.Double?
        ...
        var errorMetrics: [ForecastClientTypes.ErrorMetric]?
        /// The root-mean-square error (RMSE).
        ...
        var weightedQuantileLosses: [ForecastClientTypes.WeightedQuantileLoss]?
...
extension ForecastClientTypes {
    ...
    public struct ParameterRanges: Swift.Equatable {
        ...
        var categoricalParameterRanges: [ForecastClientTypes.CategoricalParameterRange]?
        /// Specifies the tunable range for each continuous hyperparameter.
        var continuousParameterRanges: [ForecastClientTypes.ContinuousParameterRange]?
        /// Specifies the tunable range for each integer hyperparameter.
        var integerParameterRanges: [ForecastClientTypes.IntegerParameterRange]?
...
extension ForecastClientTypes {
    ...
    public struct PredictorExecution: Swift.Equatable {
        ...
        var testWindows: [ForecastClientTypes.TestWindowSummary]?
...
extension ForecastClientTypes {
    ...
    public struct PredictorExecutionDetails: Swift.Equatable {
        ...
        var predictorExecutions: [ForecastClientTypes.PredictorExecution]?
...
extension ForecastClientTypes {
    ...
    public struct ReferencePredictorSummary: Swift.Equatable {
        ...
        var state: ForecastClientTypes.State?
...
extension ForecastClientTypes {
    ...
    public struct Schema: Swift.Equatable {
        ...
        var attributes: [ForecastClientTypes.SchemaAttribute]?
...
extension ForecastClientTypes {
    ...
    public struct SchemaAttribute: Swift.Equatable {
        ...
        var attributeType: ForecastClientTypes.AttributeType?
...
extension ForecastClientTypes {
    ...
    public struct TestWindowSummary: Swift.Equatable {
        ...
        var testWindowEnd: ClientRuntime.Date?
        /// The time at which the test began.
        var testWindowStart: ClientRuntime.Date?
...
extension ForecastClientTypes {
    ...
    public struct WeightedQuantileLoss: Swift.Equatable {
        ...
        var lossValue: Swift.Double?
        /// The quantile. Quantiles divide a probability distribution into regions of equal probability. For example, if the distribution was divided into 5 regions of equal probability, the quantiles would be 0.2, 0.4, 0.6, and 0.8.
        var quantile: Swift.Double?
...
extension ForecastClientTypes {
    ...
    public struct WindowSummary: Swift.Equatable {
        ...
        var evaluationType: ForecastClientTypes.EvaluationType?
        /// The number of data points within the window.
        var itemCount: Swift.Int?
        /// Provides metrics used to evaluate the performance of a predictor.
        var metrics: ForecastClientTypes.Metrics?
