...
extension ForecastClientTypes.AdditionalDataset: Swift.Codable, ClientRuntime.Reflection {
...
extension ForecastClientTypes.AdditionalDataset: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AdditionalDataset(configuration: \(Swift.String(describing: configuration)), name: \(Swift.String(describing: name)))"}
}
...
extension ForecastClientTypes.AttributeConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ForecastClientTypes.AttributeConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AttributeConfig(attributeName: \(Swift.String(describing: attributeName)), transformations: \(Swift.String(describing: transformations)))"}
}
...
public struct CreateAutoPredictorInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAutoPredictorInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateAutoPredictorInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateAutoPredictorOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateAutoPredictorInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateAutoPredictorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateAutoPredictorOutputError>
}

extension CreateAutoPredictorInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAutoPredictorInput(dataConfig: \(Swift.String(describing: dataConfig)), encryptionConfig: \(Swift.String(describing: encryptionConfig)), explainPredictor: \(Swift.String(describing: explainPredictor)), forecastDimensions: \(Swift.String(describing: forecastDimensions)), forecastFrequency: \(Swift.String(describing: forecastFrequency)), forecastHorizon: \(Swift.String(describing: forecastHorizon)), forecastTypes: \(Swift.String(describing: forecastTypes)), optimizationMetric: \(Swift.String(describing: optimizationMetric)), predictorName: \(Swift.String(describing: predictorName)), referencePredictorArn: \(Swift.String(describing: referencePredictorArn)), tags: \(Swift.String(describing: tags)))"}
}

extension CreateAutoPredictorInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateAutoPredictorInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAutoPredictorInputHeadersMiddleware"
...
public struct CreateAutoPredictorInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAutoPredictorInputQueryItemMiddleware"
...
public struct CreateAutoPredictorInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAutoPredictorInputURLHostMiddleware"
    ...
    public typealias MInput = CreateAutoPredictorInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateAutoPredictorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateAutoPredictorOutputError>
}

public struct CreateAutoPredictorInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAutoPredictorInputURLPathMiddleware"
...
struct CreateAutoPredictorInputBody: Swift.Equatable {
    ...
    public let forecastDimensions: [Swift.String]?
    public let forecastFrequency: Swift.String?
    public let dataConfig: ForecastClientTypes.DataConfig?
    public let encryptionConfig: ForecastClientTypes.EncryptionConfig?
    public let referencePredictorArn: Swift.String?
    public let optimizationMetric: ForecastClientTypes.OptimizationMetric?
    public let explainPredictor: Swift.Bool?
...
extension CreateAutoPredictorOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAutoPredictorOutputResponse(predictorArn: \(Swift.String(describing: predictorArn)))"}
}
...
public struct CreateDatasetGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateDatasetGroupInputURLHostMiddleware"
...
public struct CreateDatasetImportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateDatasetImportJobInputURLHostMiddleware"
...
public struct CreateExplainabilityExportInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateExplainabilityExportInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateExplainabilityExportInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateExplainabilityExportOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateExplainabilityExportInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateExplainabilityExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateExplainabilityExportOutputError>
}

extension CreateExplainabilityExportInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateExplainabilityExportInput(destination: \(Swift.String(describing: destination)), explainabilityArn: \(Swift.String(describing: explainabilityArn)), explainabilityExportName: \(Swift.String(describing: explainabilityExportName)), tags: \(Swift.String(describing: tags)))"}
}

extension CreateExplainabilityExportInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateExplainabilityExportInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateExplainabilityExportInputHeadersMiddleware"
...
public struct CreateExplainabilityExportInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateExplainabilityExportInputQueryItemMiddleware"
...
public struct CreateExplainabilityExportInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateExplainabilityExportInputURLHostMiddleware"
    ...
    public typealias MInput = CreateExplainabilityExportInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateExplainabilityExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateExplainabilityExportOutputError>
}

public struct CreateExplainabilityExportInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateExplainabilityExportInputURLPathMiddleware"
...
struct CreateExplainabilityExportInputBody: Swift.Equatable {
    public let explainabilityExportName: Swift.String?
    public let explainabilityArn: Swift.String?
...
extension CreateExplainabilityExportOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateExplainabilityExportOutputResponse(explainabilityExportArn: \(Swift.String(describing: explainabilityExportArn)))"}
}
...
struct CreateExplainabilityExportOutputResponseBody: Swift.Equatable {
    public let explainabilityExportArn: Swift.String?
}
...
public struct CreateExplainabilityInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateExplainabilityInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateExplainabilityInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateExplainabilityOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateExplainabilityInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateExplainabilityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateExplainabilityOutputError>
}

extension CreateExplainabilityInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateExplainabilityInput(dataSource: \(Swift.String(describing: dataSource)), enableVisualization: \(Swift.String(describing: enableVisualization)), endDateTime: \(Swift.String(describing: endDateTime)), explainabilityConfig: \(Swift.String(describing: explainabilityConfig)), explainabilityName: \(Swift.String(describing: explainabilityName)), resourceArn: \(Swift.String(describing: resourceArn)), schema: \(Swift.String(describing: schema)), startDateTime: \(Swift.String(describing: startDateTime)), tags: \(Swift.String(describing: tags)))"}
}

extension CreateExplainabilityInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case dataSource = "DataSource"
...
public struct CreateExplainabilityInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateExplainabilityInputHeadersMiddleware"
...
public struct CreateExplainabilityInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateExplainabilityInputQueryItemMiddleware"
...
public struct CreateExplainabilityInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateExplainabilityInputURLHostMiddleware"
    ...
    public typealias MInput = CreateExplainabilityInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateExplainabilityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateExplainabilityOutputError>
}

public struct CreateExplainabilityInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateExplainabilityInputURLPathMiddleware"
...
struct CreateExplainabilityInputBody: Swift.Equatable {
    public let explainabilityName: Swift.String?
    public let resourceArn: Swift.String?
    public let explainabilityConfig: ForecastClientTypes.ExplainabilityConfig?
    public let dataSource: ForecastClientTypes.DataSource?
    public let schema: ForecastClientTypes.Schema?
    public let enableVisualization: Swift.Bool?
...
extension CreateExplainabilityOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateExplainabilityOutputResponse(explainabilityArn: \(Swift.String(describing: explainabilityArn)))"}
}
...
public struct CreateForecastExportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateForecastExportJobInputURLHostMiddleware"
...
public struct CreateForecastInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateForecastInputURLHostMiddleware"
...
public struct CreatePredictorBacktestExportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePredictorBacktestExportJobInputURLHostMiddleware"
...
public struct CreatePredictorInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePredictorInputURLHostMiddleware"
...
extension ForecastClientTypes.DataConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ForecastClientTypes.DataConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DataConfig(additionalDatasets: \(Swift.String(describing: additionalDatasets)), attributeConfigs: \(Swift.String(describing: attributeConfigs)), datasetGroupArn: \(Swift.String(describing: datasetGroupArn)))"}
}
...
public struct DeleteDatasetGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteDatasetGroupInputURLHostMiddleware"
...
public struct DeleteDatasetImportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteDatasetImportJobInputURLHostMiddleware"
...
public struct DeleteExplainabilityExportInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteExplainabilityExportInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteExplainabilityExportInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteExplainabilityExportOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteExplainabilityExportInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteExplainabilityExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteExplainabilityExportOutputError>
}

extension DeleteExplainabilityExportInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteExplainabilityExportInput(explainabilityExportArn: \(Swift.String(describing: explainabilityExportArn)))"}
}

extension DeleteExplainabilityExportInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case explainabilityExportArn = "ExplainabilityExportArn"
    }
...
public struct DeleteExplainabilityExportInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteExplainabilityExportInputHeadersMiddleware"
...
public struct DeleteExplainabilityExportInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteExplainabilityExportInputQueryItemMiddleware"
...
public struct DeleteExplainabilityExportInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteExplainabilityExportInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteExplainabilityExportInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteExplainabilityExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteExplainabilityExportOutputError>
}

public struct DeleteExplainabilityExportInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteExplainabilityExportInputURLPathMiddleware"
...
extension DeleteExplainabilityExportOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteExplainabilityExportOutputResponse()"}
}
...
struct DeleteExplainabilityExportOutputResponseBody: Swift.Equatable {
}

extension DeleteExplainabilityExportOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct DeleteExplainabilityInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteExplainabilityInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteExplainabilityInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteExplainabilityOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteExplainabilityInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteExplainabilityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteExplainabilityOutputError>
}

extension DeleteExplainabilityInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteExplainabilityInput(explainabilityArn: \(Swift.String(describing: explainabilityArn)))"}
}

extension DeleteExplainabilityInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case explainabilityArn = "ExplainabilityArn"
    }
...
public struct DeleteExplainabilityInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteExplainabilityInputHeadersMiddleware"
...
public struct DeleteExplainabilityInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteExplainabilityInputQueryItemMiddleware"
...
public struct DeleteExplainabilityInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteExplainabilityInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteExplainabilityInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteExplainabilityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteExplainabilityOutputError>
}

public struct DeleteExplainabilityInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteExplainabilityInputURLPathMiddleware"
...
extension DeleteExplainabilityOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteExplainabilityOutputResponse()"}
}
...
struct DeleteExplainabilityOutputResponseBody: Swift.Equatable {
}

extension DeleteExplainabilityOutputResponseBody: Swift.Decodable {
...
public struct DeleteForecastExportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteForecastExportJobInputURLHostMiddleware"
...
public struct DeleteForecastInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteForecastInputURLHostMiddleware"
...
public struct DeletePredictorBacktestExportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePredictorBacktestExportJobInputURLHostMiddleware"
...
public struct DeletePredictorInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePredictorInputURLHostMiddleware"
...
public struct DeleteResourceTreeInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteResourceTreeInputURLHostMiddleware"
...
public struct DescribeAutoPredictorInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAutoPredictorInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeAutoPredictorInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeAutoPredictorOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeAutoPredictorInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeAutoPredictorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeAutoPredictorOutputError>
}

extension DescribeAutoPredictorInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAutoPredictorInput(predictorArn: \(Swift.String(describing: predictorArn)))"}
}

extension DescribeAutoPredictorInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case predictorArn = "PredictorArn"
    }
...
public struct DescribeAutoPredictorInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAutoPredictorInputHeadersMiddleware"
...
public struct DescribeAutoPredictorInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAutoPredictorInputQueryItemMiddleware"
...
public struct DescribeAutoPredictorInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAutoPredictorInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeAutoPredictorInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeAutoPredictorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeAutoPredictorOutputError>
}

public struct DescribeAutoPredictorInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAutoPredictorInputURLPathMiddleware"
...
extension DescribeAutoPredictorOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAutoPredictorOutputResponse(creationTime: \(Swift.String(describing: creationTime)), dataConfig: \(Swift.String(describing: dataConfig)), datasetImportJobArns: \(Swift.String(describing: datasetImportJobArns)), encryptionConfig: \(Swift.String(describing: encryptionConfig)), estimatedTimeRemainingInMinutes: \(Swift.String(describing: estimatedTimeRemainingInMinutes)), explainabilityInfo: \(Swift.String(describing: explainabilityInfo)), forecastFrequency: \(Swift.String(describing: forecastFrequency)), forecastHorizon: \(Swift.String(describing: forecastHorizon)), forecastTypes: \(Swift.String(describing: forecastTypes)), lastModificationTime: \(Swift.String(describing: lastModificationTime)), message: \(Swift.String(describing: message)), optimizationMetric: \(Swift.String(describing: optimizationMetric)), predictorArn: \(Swift.String(describing: predictorArn)), predictorName: \(Swift.String(describing: predictorName)), referencePredictorSummary: \(Swift.String(describing: referencePredictorSummary)), status: \(Swift.String(describing: status)))"}
}
...
struct DescribeAutoPredictorOutputResponseBody: Swift.Equatable {
    ...
    public let dataConfig: ForecastClientTypes.DataConfig?
    public let encryptionConfig: ForecastClientTypes.EncryptionConfig?
    public let referencePredictorSummary: ForecastClientTypes.ReferencePredictorSummary?
    ...
    public let optimizationMetric: ForecastClientTypes.OptimizationMetric?
    public let explainabilityInfo: ForecastClientTypes.ExplainabilityInfo?
}
...
public struct DescribeDatasetGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeDatasetGroupInputURLHostMiddleware"
...
public struct DescribeDatasetImportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeDatasetImportJobInputURLHostMiddleware"
...
public struct DescribeExplainabilityExportInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExplainabilityExportInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeExplainabilityExportInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeExplainabilityExportOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeExplainabilityExportInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeExplainabilityExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeExplainabilityExportOutputError>
}

extension DescribeExplainabilityExportInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeExplainabilityExportInput(explainabilityExportArn: \(Swift.String(describing: explainabilityExportArn)))"}
}

extension DescribeExplainabilityExportInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case explainabilityExportArn = "ExplainabilityExportArn"
    }
...
public struct DescribeExplainabilityExportInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExplainabilityExportInputHeadersMiddleware"
...
public struct DescribeExplainabilityExportInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExplainabilityExportInputQueryItemMiddleware"
...
public struct DescribeExplainabilityExportInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExplainabilityExportInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeExplainabilityExportInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeExplainabilityExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeExplainabilityExportOutputError>
}

public struct DescribeExplainabilityExportInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExplainabilityExportInputURLPathMiddleware"
...
extension DescribeExplainabilityExportOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeExplainabilityExportOutputResponse(creationTime: \(Swift.String(describing: creationTime)), destination: \(Swift.String(describing: destination)), explainabilityArn: \(Swift.String(describing: explainabilityArn)), explainabilityExportArn: \(Swift.String(describing: explainabilityExportArn)), explainabilityExportName: \(Swift.String(describing: explainabilityExportName)), lastModificationTime: \(Swift.String(describing: lastModificationTime)), message: \(Swift.String(describing: message)), status: \(Swift.String(describing: status)))"}
}
...
public struct DescribeExplainabilityInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExplainabilityInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeExplainabilityInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeExplainabilityOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeExplainabilityInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeExplainabilityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeExplainabilityOutputError>
}

extension DescribeExplainabilityInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeExplainabilityInput(explainabilityArn: \(Swift.String(describing: explainabilityArn)))"}
}

extension DescribeExplainabilityInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case explainabilityArn = "ExplainabilityArn"
    }
...
public struct DescribeExplainabilityInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExplainabilityInputHeadersMiddleware"
...
public struct DescribeExplainabilityInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExplainabilityInputQueryItemMiddleware"
...
public struct DescribeExplainabilityInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExplainabilityInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeExplainabilityInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeExplainabilityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeExplainabilityOutputError>
}

public struct DescribeExplainabilityInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExplainabilityInputURLPathMiddleware"
...
extension DescribeExplainabilityOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeExplainabilityOutputResponse(creationTime: \(Swift.String(describing: creationTime)), dataSource: \(Swift.String(describing: dataSource)), enableVisualization: \(Swift.String(describing: enableVisualization)), endDateTime: \(Swift.String(describing: endDateTime)), estimatedTimeRemainingInMinutes: \(Swift.String(describing: estimatedTimeRemainingInMinutes)), explainabilityArn: \(Swift.String(describing: explainabilityArn)), explainabilityConfig: \(Swift.String(describing: explainabilityConfig)), explainabilityName: \(Swift.String(describing: explainabilityName)), lastModificationTime: \(Swift.String(describing: lastModificationTime)), message: \(Swift.String(describing: message)), resourceArn: \(Swift.String(describing: resourceArn)), schema: \(Swift.String(describing: schema)), startDateTime: \(Swift.String(describing: startDateTime)), status: \(Swift.String(describing: status)))"}
}
...
public struct DescribeForecastExportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeForecastExportJobInputURLHostMiddleware"
...
public struct DescribeForecastInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeForecastInputURLHostMiddleware"
...
public struct DescribePredictorBacktestExportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePredictorBacktestExportJobInputURLHostMiddleware"
...
public struct DescribePredictorInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePredictorInputURLHostMiddleware"
...
extension DescribePredictorOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribePredictorOutputResponse(algorithmArn: \(Swift.String(describing: algorithmArn)), autoMLAlgorithmArns: \(Swift.String(describing: autoMLAlgorithmArns)), autoMLOverrideStrategy: \(Swift.String(describing: autoMLOverrideStrategy)), creationTime: \(Swift.String(describing: creationTime)), datasetImportJobArns: \(Swift.String(describing: datasetImportJobArns)), encryptionConfig: \(Swift.String(describing: encryptionConfig)), estimatedTimeRemainingInMinutes: \(Swift.String(describing: estimatedTimeRemainingInMinutes)), evaluationParameters: \(Swift.String(describing: evaluationParameters)), featurizationConfig: \(Swift.String(describing: featurizationConfig)), forecastHorizon: \(Swift.String(describing: forecastHorizon)), forecastTypes: \(Swift.String(describing: forecastTypes)), hPOConfig: \(Swift.String(describing: hPOConfig)), inputDataConfig: \(Swift.String(describing: inputDataConfig)), isAutoPredictor: \(Swift.String(describing: isAutoPredictor)), lastModificationTime: \(Swift.String(describing: lastModificationTime)), message: \(Swift.String(describing: message)), optimizationMetric: \(Swift.String(describing: optimizationMetric)), performAutoML: \(Swift.String(describing: performAutoML)), performHPO: \(Swift.String(describing: performHPO)), predictorArn: \(Swift.String(describing: predictorArn)), predictorExecutionDetails: \(Swift.String(describing: predictorExecutionDetails)), predictorName: \(Swift.String(describing: predictorName)), status: \(Swift.String(describing: status)), trainingParameters: \(Swift.String(describing: trainingParameters)))"}
}
...
struct DescribePredictorOutputResponseBody: Swift.Equatable {
    ...
    public let estimatedTimeRemainingInMinutes: Swift.Int?
    public let isAutoPredictor: Swift.Bool?
    public let datasetImportJobArns: [Swift.String]?
    public let status: Swift.String?
    public let message: Swift.String?
    public let creationTime: ClientRuntime.Date?
...
extension ForecastClientTypes.ExplainabilityConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ForecastClientTypes.ExplainabilityConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExplainabilityConfig(timePointGranularity: \(Swift.String(describing: timePointGranularity)), timeSeriesGranularity: \(Swift.String(describing: timeSeriesGranularity)))"}
}
...
extension ForecastClientTypes.ExplainabilityExportSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case creationTime = "CreationTime"
        case destination = "Destination"
        case explainabilityExportArn = "ExplainabilityExportArn"
...
extension ForecastClientTypes.ExplainabilityExportSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExplainabilityExportSummary(creationTime: \(Swift.String(describing: creationTime)), destination: \(Swift.String(describing: destination)), explainabilityExportArn: \(Swift.String(describing: explainabilityExportArn)), explainabilityExportName: \(Swift.String(describing: explainabilityExportName)), lastModificationTime: \(Swift.String(describing: lastModificationTime)), message: \(Swift.String(describing: message)), status: \(Swift.String(describing: status)))"}
}
...
extension ForecastClientTypes.ExplainabilityInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case explainabilityArn = "ExplainabilityArn"
        case status = "Status"
    }
...
extension ForecastClientTypes.ExplainabilityInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExplainabilityInfo(explainabilityArn: \(Swift.String(describing: explainabilityArn)), status: \(Swift.String(describing: status)))"}
}
...
extension ForecastClientTypes.ExplainabilitySummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case creationTime = "CreationTime"
        case explainabilityArn = "ExplainabilityArn"
        case explainabilityConfig = "ExplainabilityConfig"
...
extension ForecastClientTypes.ExplainabilitySummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExplainabilitySummary(creationTime: \(Swift.String(describing: creationTime)), explainabilityArn: \(Swift.String(describing: explainabilityArn)), explainabilityConfig: \(Swift.String(describing: explainabilityConfig)), explainabilityName: \(Swift.String(describing: explainabilityName)), lastModificationTime: \(Swift.String(describing: lastModificationTime)), message: \(Swift.String(describing: message)), resourceArn: \(Swift.String(describing: resourceArn)), status: \(Swift.String(describing: status)))"}
}
...
extension ForecastClientTypes.ForecastSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ForecastSummary(createdUsingAutoPredictor: \(Swift.String(describing: createdUsingAutoPredictor)), creationTime: \(Swift.String(describing: creationTime)), datasetGroupArn: \(Swift.String(describing: datasetGroupArn)), forecastArn: \(Swift.String(describing: forecastArn)), forecastName: \(Swift.String(describing: forecastName)), lastModificationTime: \(Swift.String(describing: lastModificationTime)), message: \(Swift.String(describing: message)), predictorArn: \(Swift.String(describing: predictorArn)), status: \(Swift.String(describing: status)))"}
}
...
public struct GetAccuracyMetricsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccuracyMetricsInputURLHostMiddleware"
...
extension GetAccuracyMetricsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccuracyMetricsOutputResponse(autoMLOverrideStrategy: \(Swift.String(describing: autoMLOverrideStrategy)), isAutoPredictor: \(Swift.String(describing: isAutoPredictor)), optimizationMetric: \(Swift.String(describing: optimizationMetric)), predictorEvaluationResults: \(Swift.String(describing: predictorEvaluationResults)))"}
}
...
public struct ListDatasetGroupsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDatasetGroupsInputURLHostMiddleware"
...
public struct ListDatasetImportJobsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDatasetImportJobsInputURLHostMiddleware"
...
public struct ListExplainabilitiesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListExplainabilitiesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListExplainabilitiesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListExplainabilitiesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListExplainabilitiesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListExplainabilitiesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListExplainabilitiesOutputError>
}

extension ListExplainabilitiesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListExplainabilitiesInput(filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListExplainabilitiesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filters = "Filters"
        case maxResults = "MaxResults"
        case nextToken = "NextToken"
...
public struct ListExplainabilitiesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListExplainabilitiesInputHeadersMiddleware"
...
public struct ListExplainabilitiesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListExplainabilitiesInputQueryItemMiddleware"
...
public struct ListExplainabilitiesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListExplainabilitiesInputURLHostMiddleware"
    ...
    public typealias MInput = ListExplainabilitiesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListExplainabilitiesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListExplainabilitiesOutputError>
}

public struct ListExplainabilitiesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListExplainabilitiesInputURLPathMiddleware"
...
extension ListExplainabilitiesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListExplainabilitiesOutputResponse(explainabilities: \(Swift.String(describing: explainabilities)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListExplainabilitiesOutputResponseBody: Swift.Equatable {
    public let explainabilities: [ForecastClientTypes.ExplainabilitySummary]?
    public let nextToken: Swift.String?
}
...
public struct ListExplainabilityExportsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListExplainabilityExportsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListExplainabilityExportsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListExplainabilityExportsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListExplainabilityExportsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListExplainabilityExportsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListExplainabilityExportsOutputError>
}

extension ListExplainabilityExportsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListExplainabilityExportsInput(filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListExplainabilityExportsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filters = "Filters"
        case maxResults = "MaxResults"
        case nextToken = "NextToken"
...
public struct ListExplainabilityExportsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListExplainabilityExportsInputHeadersMiddleware"
...
public struct ListExplainabilityExportsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListExplainabilityExportsInputQueryItemMiddleware"
...
public struct ListExplainabilityExportsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListExplainabilityExportsInputURLHostMiddleware"
    ...
    public typealias MInput = ListExplainabilityExportsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListExplainabilityExportsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListExplainabilityExportsOutputError>
}

public struct ListExplainabilityExportsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListExplainabilityExportsInputURLPathMiddleware"
...
extension ListExplainabilityExportsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListExplainabilityExportsOutputResponse(explainabilityExports: \(Swift.String(describing: explainabilityExports)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListExplainabilityExportsOutputResponseBody: Swift.Equatable {
    public let explainabilityExports: [ForecastClientTypes.ExplainabilityExportSummary]?
    public let nextToken: Swift.String?
}
...
public struct ListForecastExportJobsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListForecastExportJobsInputURLHostMiddleware"
...
public struct ListForecastsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListForecastsInputURLHostMiddleware"
...
public struct ListPredictorBacktestExportJobsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPredictorBacktestExportJobsInputURLHostMiddleware"
...
public struct ListPredictorsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPredictorsInputURLHostMiddleware"
...
extension ForecastClientTypes.PredictorSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PredictorSummary(creationTime: \(Swift.String(describing: creationTime)), datasetGroupArn: \(Swift.String(describing: datasetGroupArn)), isAutoPredictor: \(Swift.String(describing: isAutoPredictor)), lastModificationTime: \(Swift.String(describing: lastModificationTime)), message: \(Swift.String(describing: message)), predictorArn: \(Swift.String(describing: predictorArn)), predictorName: \(Swift.String(describing: predictorName)), referencePredictorSummary: \(Swift.String(describing: referencePredictorSummary)), status: \(Swift.String(describing: status)))"}
}
...
extension ForecastClientTypes.ReferencePredictorSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
        case state = "State"
    }
...
extension ForecastClientTypes.ReferencePredictorSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ReferencePredictorSummary(arn: \(Swift.String(describing: arn)), state: \(Swift.String(describing: state)))"}
}
...
public struct StopResourceInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopResourceInputURLHostMiddleware"
...
public struct UpdateDatasetGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateDatasetGroupInputURLHostMiddleware"
