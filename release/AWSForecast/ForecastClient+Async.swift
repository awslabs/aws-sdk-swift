...
public extension ForecastClient {
    ...
    {
        typealias createAutoPredictorContinuation = CheckedContinuation<CreateAutoPredictorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createAutoPredictorContinuation) in
            createAutoPredictor(input: input) { result in
                switch result {
    ...
    {
        typealias createExplainabilityContinuation = CheckedContinuation<CreateExplainabilityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createExplainabilityContinuation) in
            createExplainability(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createExplainabilityExportContinuation = CheckedContinuation<CreateExplainabilityExportOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createExplainabilityExportContinuation) in
            createExplainabilityExport(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteExplainabilityContinuation = CheckedContinuation<DeleteExplainabilityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteExplainabilityContinuation) in
            deleteExplainability(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteExplainabilityExportContinuation = CheckedContinuation<DeleteExplainabilityExportOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteExplainabilityExportContinuation) in
            deleteExplainabilityExport(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeAutoPredictorContinuation = CheckedContinuation<DescribeAutoPredictorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAutoPredictorContinuation) in
            describeAutoPredictor(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeExplainabilityContinuation = CheckedContinuation<DescribeExplainabilityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeExplainabilityContinuation) in
            describeExplainability(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeExplainabilityExportContinuation = CheckedContinuation<DescribeExplainabilityExportOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeExplainabilityExportContinuation) in
            describeExplainabilityExport(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listExplainabilitiesContinuation = CheckedContinuation<ListExplainabilitiesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listExplainabilitiesContinuation) in
            listExplainabilities(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listExplainabilityExportsContinuation = CheckedContinuation<ListExplainabilityExportsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listExplainabilityExportsContinuation) in
            listExplainabilityExports(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
