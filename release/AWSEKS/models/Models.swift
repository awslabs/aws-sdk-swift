...
extension EksClientTypes {
    ...
    public struct Addon: Swift.Equatable {
        ...
        var addonArn: Swift.String?
        /// The name of the add-on.
        var addonName: Swift.String?
        /// The version of the add-on.
        var addonVersion: Swift.String?
        /// The name of the cluster.
        var clusterName: Swift.String?
        /// The date and time that the add-on was created.
        var createdAt: ClientRuntime.Date?
        /// An object that represents the health of the add-on.
        var health: EksClientTypes.AddonHealth?
        ...
        var serviceAccountRoleArn: Swift.String?
        /// The status of the add-on.
        var status: EksClientTypes.AddonStatus?
...
extension EksClientTypes {
    ...
    public struct AddonHealth: Swift.Equatable {
        ...
        var issues: [EksClientTypes.AddonIssue]?
...
extension EksClientTypes {
    ...
    public struct AddonInfo: Swift.Equatable {
        ...
        var addonVersions: [EksClientTypes.AddonVersionInfo]?
...
extension EksClientTypes {
    ...
    public struct AddonIssue: Swift.Equatable {
        ...
        var code: EksClientTypes.AddonIssueCode?
...
extension EksClientTypes {
    ...
    public struct AddonVersionInfo: Swift.Equatable {
        ...
        var architecture: [Swift.String]?
        /// An object that represents the compatibilities of a version.
        var compatibilities: [EksClientTypes.Compatibility]?
...
public struct AssociateEncryptionConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var encryptionConfig: [EksClientTypes.EncryptionConfig]?
...
public struct AssociateEncryptionConfigOutputResponse: Swift.Equatable {
    ...
    var update: EksClientTypes.Update?
...
public struct AssociateIdentityProviderConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var oidc: EksClientTypes.OidcIdentityProviderConfigRequest?
...
extension EksClientTypes {
    ...
    public struct Cluster: Swift.Equatable {
        ...
        var certificateAuthority: EksClientTypes.Certificate?
        /// Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.
        var clientRequestToken: Swift.String?
        /// The configuration used to connect to a cluster for registration.
        var connectorConfig: EksClientTypes.ConnectorConfigResponse?
        ...
        var identity: EksClientTypes.Identity?
        /// The Kubernetes network configuration for the cluster.
        var kubernetesNetworkConfig: EksClientTypes.KubernetesNetworkConfigResponse?
        /// The logging configuration for your cluster.
        var logging: EksClientTypes.Logging?
        /// The name of the cluster.
        var name: Swift.String?
        ...
        var resourcesVpcConfig: EksClientTypes.VpcConfigResponse?
        /// The Amazon Resource Name (ARN) of the IAM role that provides permissions for the Kubernetes control plane to make calls to Amazon Web Services API operations on your behalf.
        var roleArn: Swift.String?
        /// The current status of the cluster.
        var status: EksClientTypes.ClusterStatus?
...
extension EksClientTypes {
    ...
    public struct Compatibility: Swift.Equatable {
        ...
        var clusterVersion: Swift.String?
        /// The supported default version.
        var defaultVersion: Swift.Bool
        /// The supported compute platform.
        var platformVersions: [Swift.String]?
...
extension EksClientTypes {
    ...
    public struct ConnectorConfigRequest: Swift.Equatable {
        ...
        /// This member is required.
        var provider: EksClientTypes.ConnectorConfigProvider?
...
extension EksClientTypes {
    ...
    public struct ConnectorConfigResponse: Swift.Equatable {
        ...
        var activationExpiry: ClientRuntime.Date?
        /// A unique ID associated with the cluster for registration purposes.
        var activationId: Swift.String?
...
public struct CreateAddonInput: Swift.Equatable {
    ...
    var resolveConflicts: EksClientTypes.ResolveConflicts?
...
public struct CreateAddonOutputResponse: Swift.Equatable {
    /// An Amazon EKS add-on. For more information, see [Amazon EKS add-ons](https://docs.aws.amazon.com/eks/latest/userguide/eks-add-ons.html) in the Amazon EKS User Guide.
    var addon: EksClientTypes.Addon?
...
public struct CreateClusterInput: Swift.Equatable {
    ...
    var encryptionConfig: [EksClientTypes.EncryptionConfig]?
    /// The Kubernetes network configuration for the cluster.
    var kubernetesNetworkConfig: EksClientTypes.KubernetesNetworkConfigRequest?
    ...
    /// This member is required.
    var resourcesVpcConfig: EksClientTypes.VpcConfigRequest?
...
public struct CreateClusterOutputResponse: Swift.Equatable {
    ...
    var cluster: EksClientTypes.Cluster?
...
public struct CreateFargateProfileInput: Swift.Equatable {
    ...
    /// This member is required.
    var fargateProfileName: Swift.String?
    ...
    /// This member is required.
    var podExecutionRoleArn: Swift.String?
    /// The selectors to match for pods to use this Fargate profile. Each selector must have an associated namespace. Optionally, you can also specify labels for a namespace. You may specify up to five selectors in a Fargate profile.
    var selectors: [EksClientTypes.FargateProfileSelector]?
...
public struct CreateFargateProfileOutputResponse: Swift.Equatable {
    ...
    var fargateProfile: EksClientTypes.FargateProfile?
...
public struct CreateNodegroupInput: Swift.Equatable {
    ...
    var amiType: EksClientTypes.AMITypes?
    /// The capacity type for your node group.
    var capacityType: EksClientTypes.CapacityTypes?
    /// Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.
    var clientRequestToken: Swift.String?
    ...
    var instanceTypes: [Swift.String]?
    /// The Kubernetes labels to be applied to the nodes in the node group when they are created.
    var labels: [Swift.String:Swift.String]?
    /// An object representing a node group's launch template specification. If specified, then do not specify instanceTypes, diskSize, or remoteAccess and make sure that the launch template meets the requirements in launchTemplateSpecification.
    var launchTemplate: EksClientTypes.LaunchTemplateSpecification?
    ...
    /// This member is required.
    var nodeRole: Swift.String?
    /// The unique name to give your node group.
    /// This member is required.
    var nodegroupName: Swift.String?
    ...
    var releaseVersion: Swift.String?
    /// The remote access (SSH) configuration to use with your node group. If you specify launchTemplate, then don't specify remoteAccess, or the node group deployment will fail. For more information about using launch templates with Amazon EKS, see [Launch template support](https://docs.aws.amazon.com/eks/latest/userguide/launch-templates.html) in the Amazon EKS User Guide.
    var remoteAccess: EksClientTypes.RemoteAccessConfig?
    /// The scaling configuration details for the Auto Scaling group that is created for your node group.
    var scalingConfig: EksClientTypes.NodegroupScalingConfig?
    ...
    var taints: [EksClientTypes.Taint]?
    /// The node group update configuration.
    var updateConfig: EksClientTypes.NodegroupUpdateConfig?
...
public struct CreateNodegroupOutputResponse: Swift.Equatable {
    ...
    var nodegroup: EksClientTypes.Nodegroup?
...
public struct DescribeAddonVersionsInput: Swift.Equatable {
    ...
    var kubernetesVersion: Swift.String?
...
public struct DescribeAddonVersionsOutputResponse: Swift.Equatable {
    ...
    var addons: [EksClientTypes.AddonInfo]?
...
public struct DescribeIdentityProviderConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var identityProviderConfig: EksClientTypes.IdentityProviderConfig?
...
public struct DescribeIdentityProviderConfigOutputResponse: Swift.Equatable {
    ...
    var identityProviderConfig: EksClientTypes.IdentityProviderConfigResponse?
...
extension EksClientTypes {
    ...
    public struct EncryptionConfig: Swift.Equatable {
        ...
        var provider: EksClientTypes.Provider?
        /// Specifies the resources to be encrypted. The only supported value is "secrets".
        var resources: [Swift.String]?
...
extension EksClientTypes {
    ...
    public struct ErrorDetail: Swift.Equatable {
        ...
        var errorCode: EksClientTypes.ErrorCode?
...
extension EksClientTypes {
    ...
    public struct FargateProfile: Swift.Equatable {
        ...
        var fargateProfileArn: Swift.String?
        /// The name of the Fargate profile.
        var fargateProfileName: Swift.String?
        ...
        var status: EksClientTypes.FargateProfileStatus?
...
extension EksClientTypes {
    ...
    public struct IdentityProviderConfigResponse: Swift.Equatable {
        /// An object that represents an OpenID Connect (OIDC) identity provider configuration.
        var oidc: EksClientTypes.OidcIdentityProviderConfig?
...
extension EksClientTypes {
    ...
    public struct Issue: Swift.Equatable {
        ...
        var code: EksClientTypes.NodegroupIssueCode?
...
extension EksClientTypes {
    ...
    public struct KubernetesNetworkConfigRequest: Swift.Equatable {
        ...
        var serviceIpv4Cidr: Swift.String?
...
public struct ListFargateProfilesOutputResponse: Swift.Equatable {
    ...
    var fargateProfileNames: [Swift.String]?
...
public struct ListIdentityProviderConfigsOutputResponse: Swift.Equatable {
    ...
    var identityProviderConfigs: [EksClientTypes.IdentityProviderConfig]?
...
extension EksClientTypes {
    ...
    public struct LogSetup: Swift.Equatable {
        ...
        var types: [EksClientTypes.LogType]?
...
extension EksClientTypes {
    ...
    public struct Logging: Swift.Equatable {
        ...
        var clusterLogging: [EksClientTypes.LogSetup]?
...
extension EksClientTypes {
    ...
    public struct Nodegroup: Swift.Equatable {
        ...
        var health: EksClientTypes.NodegroupHealth?
        ...
        var resources: EksClientTypes.NodegroupResources?
        /// The scaling configuration details for the Auto Scaling group that is associated with your node group.
        var scalingConfig: EksClientTypes.NodegroupScalingConfig?
        /// The current status of the managed node group.
        var status: EksClientTypes.NodegroupStatus?
...
extension EksClientTypes {
    ...
    public struct NodegroupHealth: Swift.Equatable {
        ...
        var issues: [EksClientTypes.Issue]?
...
extension EksClientTypes {
    ...
    public struct NodegroupResources: Swift.Equatable {
        ...
        var autoScalingGroups: [EksClientTypes.AutoScalingGroup]?
        /// The remote access security group associated with the node group. This security group controls SSH access to the nodes.
        var remoteAccessSecurityGroup: Swift.String?
...
extension EksClientTypes {
    ...
    public struct NodegroupUpdateConfig: Swift.Equatable {
        ...
        var maxUnavailable: Swift.Int?
        /// The maximum percentage of nodes unavailable during a version update. This percentage of nodes will be updated in parallel, up to 100 nodes at once. This value or maxUnavailable is required to have a value.
        var maxUnavailablePercentage: Swift.Int?
...
extension EksClientTypes {
    ...
    public struct OidcIdentityProviderConfig: Swift.Equatable {
        ...
        var groupsClaim: Swift.String?
        /// The prefix that is prepended to group claims to prevent clashes with existing names (such as system: groups). For example, the value oidc: creates group names like oidc:engineering and oidc:infra. The prefix can't contain system:
        var groupsPrefix: Swift.String?
        /// The ARN of the configuration.
        var identityProviderConfigArn: Swift.String?
        /// The name of the configuration.
        var identityProviderConfigName: Swift.String?
        /// The URL of the OIDC identity provider that allows the API server to discover public signing keys for verifying tokens.
        var issuerUrl: Swift.String?
        /// The key-value pairs that describe required claims in the identity token. If set, each claim is verified to be present in the token with a matching value.
        var requiredClaims: [Swift.String:Swift.String]?
        /// The status of the OIDC identity provider.
        var status: EksClientTypes.ConfigStatus?
        ...
        var usernameClaim: Swift.String?
        /// The prefix that is prepended to username claims to prevent clashes with existing names. The prefix can't contain system:
        var usernamePrefix: Swift.String?
...
public struct RegisterClusterInput: Swift.Equatable {
    ...
    /// This member is required.
    var connectorConfig: EksClientTypes.ConnectorConfigRequest?
...
extension EksClientTypes {
    ...
    public struct Taint: Swift.Equatable {
        ...
        var effect: EksClientTypes.TaintEffect?
...
extension EksClientTypes {
    ...
    public struct Update: Swift.Equatable {
        ...
        var errors: [EksClientTypes.ErrorDetail]?
        /// A UUID that is used to track the update.
        var id: Swift.String?
        /// A key-value map that contains the parameters associated with the update.
        var params: [EksClientTypes.UpdateParam]?
        /// The current status of the update.
        var status: EksClientTypes.UpdateStatus?
        /// The type of the update.
        var type: EksClientTypes.UpdateType?
...
extension EksClientTypes {
    ...
    public struct UpdateLabelsPayload: Swift.Equatable {
        ...
        var addOrUpdateLabels: [Swift.String:Swift.String]?
        /// Kubernetes labels to be removed.
        var removeLabels: [Swift.String]?
...
public struct UpdateNodegroupConfigInput: Swift.Equatable {
    ...
    var labels: EksClientTypes.UpdateLabelsPayload?
    ...
    var taints: EksClientTypes.UpdateTaintsPayload?
    /// The node group update configuration.
    var updateConfig: EksClientTypes.NodegroupUpdateConfig?
...
extension EksClientTypes {
    ...
    public struct UpdateParam: Swift.Equatable {
        ...
        var type: EksClientTypes.UpdateParamType?
...
extension EksClientTypes {
    ...
    public struct UpdateTaintsPayload: Swift.Equatable {
        ...
        var addOrUpdateTaints: [EksClientTypes.Taint]?
        /// Kubernetes taints to be removed.
        var removeTaints: [EksClientTypes.Taint]?
...
extension EksClientTypes {
    ...
    public struct VpcConfigRequest: Swift.Equatable {
        ...
        var publicAccessCidrs: [Swift.String]?
...
extension EksClientTypes {
    ...
    public struct VpcConfigResponse: Swift.Equatable {
        ...
        var clusterSecurityGroupId: Swift.String?
