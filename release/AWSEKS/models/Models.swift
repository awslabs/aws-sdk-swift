...
extension RegisterClusterInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RegisterClusterInput(clientRequestToken: \(Swift.String(describing: clientRequestToken)), connectorConfig: \(Swift.String(describing: connectorConfig)), name: \(Swift.String(describing: name)), tags: \(Swift.String(describing: tags)))"}
}
...
extension ResourcePropagationDelayException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourcePropagationDelayException(message: \(Swift.String(describing: message)))"}
}
