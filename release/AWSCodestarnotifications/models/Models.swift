...
public struct CreateNotificationRuleInput: Swift.Equatable {
    ...
    var detailType: CodestarNotificationsClientTypes.DetailType?
    /// A list of event types associated with this notification rule. For a list of allowed events, see [EventTypeSummary].
    /// This member is required.
    var eventTypeIds: [Swift.String]?
    ...
    var status: CodestarNotificationsClientTypes.NotificationRuleStatus?
    /// A list of tags to apply to this notification rule. Key names cannot start with "aws".
    var tags: [Swift.String:Swift.String]?
    /// A list of Amazon Resource Names (ARNs) of SNS topics to associate with the notification rule.
    /// This member is required.
    var targets: [CodestarNotificationsClientTypes.Target]?
...
public struct DeleteTargetInput: Swift.Equatable {
    ...
    var forceUnsubscribeAll: Swift.Bool
    /// The Amazon Resource Name (ARN) of the SNS topic to delete.
    /// This member is required.
    var targetAddress: Swift.String?
...
public struct DescribeNotificationRuleOutputResponse: Swift.Equatable {
    ...
    var lastModifiedTimestamp: ClientRuntime.Date?
    ...
    var targets: [CodestarNotificationsClientTypes.TargetSummary]?
...
extension CodestarNotificationsClientTypes {
    ...
    public struct ListEventTypesFilter: Swift.Equatable {
        ...
        /// This member is required.
        var name: CodestarNotificationsClientTypes.ListEventTypesFilterName?
...
public struct ListEventTypesInput: Swift.Equatable {
    ...
    var filters: [CodestarNotificationsClientTypes.ListEventTypesFilter]?
...
extension CodestarNotificationsClientTypes {
    ...
    public struct ListNotificationRulesFilter: Swift.Equatable {
        ...
        /// This member is required.
        var name: CodestarNotificationsClientTypes.ListNotificationRulesFilterName?
...
public struct ListNotificationRulesInput: Swift.Equatable {
    ...
    var filters: [CodestarNotificationsClientTypes.ListNotificationRulesFilter]?
...
public struct ListNotificationRulesOutputResponse: Swift.Equatable {
    ...
    var notificationRules: [CodestarNotificationsClientTypes.NotificationRuleSummary]?
...
extension CodestarNotificationsClientTypes {
    ...
    public struct ListTargetsFilter: Swift.Equatable {
        ...
        /// This member is required.
        var name: CodestarNotificationsClientTypes.ListTargetsFilterName?
...
public struct ListTargetsInput: Swift.Equatable {
    ...
    var filters: [CodestarNotificationsClientTypes.ListTargetsFilter]?
    /// A non-negative integer used to limit the number of returned results. The maximum number of results that can be returned is 100.
    var maxResults: Swift.Int
    /// An enumeration token that, when provided in a request, returns the next batch of the results.
    var nextToken: Swift.String?
...
public struct SubscribeInput: Swift.Equatable {
    ...
    /// This member is required.
    var target: CodestarNotificationsClientTypes.Target?
...
extension CodestarNotificationsClientTypes {
    ...
    public struct TargetSummary: Swift.Equatable {
        ...
        var targetStatus: CodestarNotificationsClientTypes.TargetStatus?
