...
public class CloudFormationClient {
    ...
    let config: CloudFormationClientConfiguration
    let serviceName = "CloudFormation"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: CloudFormationClientConfiguration) {
    ...
    public class CloudFormationClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        public static func `default`() throws -> CloudFormationClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try CloudFormationClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
...
extension CloudFormationClient: CloudFormationClientProtocol {
    ...
    ///          </note>
    public func cancelUpdateStack(input: CancelUpdateStackInput, completion: @escaping (SdkResult<CancelUpdateStackOutput, CancelUpdateStackOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<CancelUpdateStackInput, CancelUpdateStackOutput, CancelUpdateStackOutputError>(id: "cancelUpdateStack")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CancelUpdateStackInput, CancelUpdateStackOutput, CancelUpdateStackOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func continueUpdateRollback(input: ContinueUpdateRollbackInput, completion: @escaping (SdkResult<ContinueUpdateRollbackOutput, ContinueUpdateRollbackOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ContinueUpdateRollbackInput, ContinueUpdateRollbackOutput, ContinueUpdateRollbackOutputError>(id: "continueUpdateRollback")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ContinueUpdateRollbackInput, ContinueUpdateRollbackOutput, ContinueUpdateRollbackOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func createChangeSet(input: CreateChangeSetInput, completion: @escaping (SdkResult<CreateChangeSetOutput, CreateChangeSetOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateChangeSetInput, CreateChangeSetOutput, CreateChangeSetOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func createStack(input: CreateStackInput, completion: @escaping (SdkResult<CreateStackOutput, CreateStackOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateStackInput, CreateStackOutput, CreateStackOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func createStackInstances(input: CreateStackInstancesInput, completion: @escaping (SdkResult<CreateStackInstancesOutput, CreateStackInstancesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateStackInstancesInput, CreateStackInstancesOutput, CreateStackInstancesOutputError>(id: "createStackInstances")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateStackInstancesOutput>, SdkError<CreateStackInstancesOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateStackInstancesInput, CreateStackInstancesOutput, CreateStackInstancesOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func createStackSet(input: CreateStackSetInput, completion: @escaping (SdkResult<CreateStackSetOutput, CreateStackSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateStackSetInput, CreateStackSetOutput, CreateStackSetOutputError>(id: "createStackSet")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateStackSetOutput>, SdkError<CreateStackSetOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateStackSetInput, CreateStackSetOutput, CreateStackSetOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func deleteChangeSet(input: DeleteChangeSetInput, completion: @escaping (SdkResult<DeleteChangeSetOutput, DeleteChangeSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteChangeSetInput, DeleteChangeSetOutput, DeleteChangeSetOutputError>(id: "deleteChangeSet")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteChangeSetInput, DeleteChangeSetOutput, DeleteChangeSetOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func deleteStack(input: DeleteStackInput, completion: @escaping (SdkResult<DeleteStackOutput, DeleteStackOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteStackInput, DeleteStackOutput, DeleteStackOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func deleteStackInstances(input: DeleteStackInstancesInput, completion: @escaping (SdkResult<DeleteStackInstancesOutput, DeleteStackInstancesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteStackInstancesInput, DeleteStackInstancesOutput, DeleteStackInstancesOutputError>(id: "deleteStackInstances")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<DeleteStackInstancesOutput>, SdkError<DeleteStackInstancesOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.operationId == nil {
                copiedInput.operationId = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteStackInstancesInput, DeleteStackInstancesOutput, DeleteStackInstancesOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func deleteStackSet(input: DeleteStackSetInput, completion: @escaping (SdkResult<DeleteStackSetOutput, DeleteStackSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteStackSetInput, DeleteStackSetOutput, DeleteStackSetOutputError>(id: "deleteStackSet")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteStackSetInput, DeleteStackSetOutput, DeleteStackSetOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func deregisterType(input: DeregisterTypeInput, completion: @escaping (SdkResult<DeregisterTypeOutput, DeregisterTypeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeregisterTypeInput, DeregisterTypeOutput, DeregisterTypeOutputError>(id: "deregisterType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeregisterTypeInput, DeregisterTypeOutput, DeregisterTypeOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func describeChangeSet(input: DescribeChangeSetInput, completion: @escaping (SdkResult<DescribeChangeSetOutput, DescribeChangeSetOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeChangeSetInput, DescribeChangeSetOutput, DescribeChangeSetOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func describeStackDriftDetectionStatus(input: DescribeStackDriftDetectionStatusInput, completion: @escaping (SdkResult<DescribeStackDriftDetectionStatusOutput, DescribeStackDriftDetectionStatusOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeStackDriftDetectionStatusInput, DescribeStackDriftDetectionStatusOutput, DescribeStackDriftDetectionStatusOutputError>(id: "describeStackDriftDetectionStatus")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStackDriftDetectionStatusInput, DescribeStackDriftDetectionStatusOutput, DescribeStackDriftDetectionStatusOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///          </note>
    public func describeStackEvents(input: DescribeStackEventsInput, completion: @escaping (SdkResult<DescribeStackEventsOutput, DescribeStackEventsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeStackEventsInput, DescribeStackEventsOutput, DescribeStackEventsOutputError>(id: "describeStackEvents")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStackEventsInput, DescribeStackEventsOutput, DescribeStackEventsOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func describeStackInstance(input: DescribeStackInstanceInput, completion: @escaping (SdkResult<DescribeStackInstanceOutput, DescribeStackInstanceOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeStackInstanceInput, DescribeStackInstanceOutput, DescribeStackInstanceOutputError>(id: "describeStackInstance")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStackInstanceInput, DescribeStackInstanceOutput, DescribeStackInstanceOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func describeStackResource(input: DescribeStackResourceInput, completion: @escaping (SdkResult<DescribeStackResourceOutput, DescribeStackResourceOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeStackResourceInput, DescribeStackResourceOutput, DescribeStackResourceOutputError>(id: "describeStackResource")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStackResourceInput, DescribeStackResourceOutput, DescribeStackResourceOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///          for a given stack.</p>
    public func describeStackResourceDrifts(input: DescribeStackResourceDriftsInput, completion: @escaping (SdkResult<DescribeStackResourceDriftsOutput, DescribeStackResourceDriftsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeStackResourceDriftsInput, DescribeStackResourceDriftsOutput, DescribeStackResourceDriftsOutputError>(id: "describeStackResourceDrifts")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStackResourceDriftsInput, DescribeStackResourceDriftsOutput, DescribeStackResourceDriftsOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///             request.</p>
    ///          </note>
    public func describeStackResources(input: DescribeStackResourcesInput, completion: @escaping (SdkResult<DescribeStackResourcesOutput, DescribeStackResourcesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeStackResourcesInput, DescribeStackResourcesOutput, DescribeStackResourcesOutputError>(id: "describeStackResources")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStackResourcesInput, DescribeStackResourcesOutput, DescribeStackResourcesOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func describeStackSet(input: DescribeStackSetInput, completion: @escaping (SdkResult<DescribeStackSetOutput, DescribeStackSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeStackSetInput, DescribeStackSetOutput, DescribeStackSetOutputError>(id: "describeStackSet")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStackSetInput, DescribeStackSetOutput, DescribeStackSetOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func describeStackSetOperation(input: DescribeStackSetOperationInput, completion: @escaping (SdkResult<DescribeStackSetOperationOutput, DescribeStackSetOperationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeStackSetOperationInput, DescribeStackSetOperationOutput, DescribeStackSetOperationOutputError>(id: "describeStackSetOperation")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStackSetOperationInput, DescribeStackSetOperationOutput, DescribeStackSetOperationOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func describeStacks(input: DescribeStacksInput, completion: @escaping (SdkResult<DescribeStacksOutput, DescribeStacksOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStacksInput, DescribeStacksOutput, DescribeStacksOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func describeType(input: DescribeTypeInput, completion: @escaping (SdkResult<DescribeTypeOutput, DescribeTypeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTypeInput, DescribeTypeOutput, DescribeTypeOutputError>(id: "describeType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTypeInput, DescribeTypeOutput, DescribeTypeOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func describeTypeRegistration(input: DescribeTypeRegistrationInput, completion: @escaping (SdkResult<DescribeTypeRegistrationOutput, DescribeTypeRegistrationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTypeRegistrationInput, DescribeTypeRegistrationOutput, DescribeTypeRegistrationOutputError>(id: "describeTypeRegistration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTypeRegistrationInput, DescribeTypeRegistrationOutput, DescribeTypeRegistrationOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///          itself.</p>
    public func detectStackDrift(input: DetectStackDriftInput, completion: @escaping (SdkResult<DetectStackDriftOutput, DetectStackDriftOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DetectStackDriftInput, DetectStackDriftOutput, DetectStackDriftOutputError>(id: "detectStackDrift")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetectStackDriftInput, DetectStackDriftOutput, DetectStackDriftOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func detectStackResourceDrift(input: DetectStackResourceDriftInput, completion: @escaping (SdkResult<DetectStackResourceDriftOutput, DetectStackResourceDriftOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DetectStackResourceDriftInput, DetectStackResourceDriftOutput, DetectStackResourceDriftOutputError>(id: "detectStackResourceDrift")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetectStackResourceDriftInput, DetectStackResourceDriftOutput, DetectStackResourceDriftOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///             </code>.</p>
    public func detectStackSetDrift(input: DetectStackSetDriftInput, completion: @escaping (SdkResult<DetectStackSetDriftOutput, DetectStackSetDriftOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DetectStackSetDriftInput, DetectStackSetDriftOutput, DetectStackSetDriftOutputError>(id: "detectStackSetDrift")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<DetectStackSetDriftOutput>, SdkError<DetectStackSetDriftOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.operationId == nil {
                copiedInput.operationId = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetectStackSetDriftInput, DetectStackSetDriftOutput, DetectStackSetDriftOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///          template.</p>
    public func estimateTemplateCost(input: EstimateTemplateCostInput, completion: @escaping (SdkResult<EstimateTemplateCostOutput, EstimateTemplateCostOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<EstimateTemplateCostInput, EstimateTemplateCostOutput, EstimateTemplateCostOutputError>(id: "estimateTemplateCost")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<EstimateTemplateCostInput, EstimateTemplateCostOutput, EstimateTemplateCostOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func executeChangeSet(input: ExecuteChangeSetInput, completion: @escaping (SdkResult<ExecuteChangeSetOutput, ExecuteChangeSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ExecuteChangeSetInput, ExecuteChangeSetOutput, ExecuteChangeSetOutputError>(id: "executeChangeSet")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ExecuteChangeSetInput, ExecuteChangeSetOutput, ExecuteChangeSetOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func getStackPolicy(input: GetStackPolicyInput, completion: @escaping (SdkResult<GetStackPolicyOutput, GetStackPolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetStackPolicyInput, GetStackPolicyOutput, GetStackPolicyOutputError>(id: "getStackPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetStackPolicyInput, GetStackPolicyOutput, GetStackPolicyOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///          </p>
    ///          </note>
    public func getTemplate(input: GetTemplateInput, completion: @escaping (SdkResult<GetTemplateOutput, GetTemplateOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetTemplateInput, GetTemplateOutput, GetTemplateOutputError>(id: "getTemplate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetTemplateInput, GetTemplateOutput, GetTemplateOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func getTemplateSummary(input: GetTemplateSummaryInput, completion: @escaping (SdkResult<GetTemplateSummaryOutput, GetTemplateSummaryOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetTemplateSummaryInput, GetTemplateSummaryOutput, GetTemplateSummaryOutputError>(id: "getTemplateSummary")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetTemplateSummaryInput, GetTemplateSummaryOutput, GetTemplateSummaryOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func listChangeSets(input: ListChangeSetsInput, completion: @escaping (SdkResult<ListChangeSetsOutput, ListChangeSetsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListChangeSetsInput, ListChangeSetsOutput, ListChangeSetsOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func listExports(input: ListExportsInput, completion: @escaping (SdkResult<ListExportsOutput, ListExportsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListExportsInput, ListExportsOutput, ListExportsOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func listImports(input: ListImportsInput, completion: @escaping (SdkResult<ListImportsOutput, ListImportsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListImportsInput, ListImportsOutput, ListImportsOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func listStackInstances(input: ListStackInstancesInput, completion: @escaping (SdkResult<ListStackInstancesOutput, ListStackInstancesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListStackInstancesInput, ListStackInstancesOutput, ListStackInstancesOutputError>(id: "listStackInstances")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListStackInstancesInput, ListStackInstancesOutput, ListStackInstancesOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func listStackResources(input: ListStackResourcesInput, completion: @escaping (SdkResult<ListStackResourcesOutput, ListStackResourcesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListStackResourcesInput, ListStackResourcesOutput, ListStackResourcesOutputError>(id: "listStackResources")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListStackResourcesInput, ListStackResourcesOutput, ListStackResourcesOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func listStackSetOperationResults(input: ListStackSetOperationResultsInput, completion: @escaping (SdkResult<ListStackSetOperationResultsOutput, ListStackSetOperationResultsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListStackSetOperationResultsInput, ListStackSetOperationResultsOutput, ListStackSetOperationResultsOutputError>(id: "listStackSetOperationResults")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListStackSetOperationResultsInput, ListStackSetOperationResultsOutput, ListStackSetOperationResultsOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func listStackSetOperations(input: ListStackSetOperationsInput, completion: @escaping (SdkResult<ListStackSetOperationsOutput, ListStackSetOperationsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListStackSetOperationsInput, ListStackSetOperationsOutput, ListStackSetOperationsOutputError>(id: "listStackSetOperations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListStackSetOperationsInput, ListStackSetOperationsOutput, ListStackSetOperationsOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///             </li>
    ///          </ul>
    public func listStackSets(input: ListStackSetsInput, completion: @escaping (SdkResult<ListStackSetsOutput, ListStackSetsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListStackSetsInput, ListStackSetsOutput, ListStackSetsOutputError>(id: "listStackSets")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListStackSetsInput, ListStackSetsOutput, ListStackSetsOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///          deleted).</p>
    public func listStacks(input: ListStacksInput, completion: @escaping (SdkResult<ListStacksOutput, ListStacksOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListStacksInput, ListStacksOutput, ListStacksOutputError>(id: "listStacks")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListStacksInput, ListStacksOutput, ListStacksOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func listTypeRegistrations(input: ListTypeRegistrationsInput, completion: @escaping (SdkResult<ListTypeRegistrationsOutput, ListTypeRegistrationsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListTypeRegistrationsInput, ListTypeRegistrationsOutput, ListTypeRegistrationsOutputError>(id: "listTypeRegistrations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListTypeRegistrationsInput, ListTypeRegistrationsOutput, ListTypeRegistrationsOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func listTypeVersions(input: ListTypeVersionsInput, completion: @escaping (SdkResult<ListTypeVersionsOutput, ListTypeVersionsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListTypeVersionsInput, ListTypeVersionsOutput, ListTypeVersionsOutputError>(id: "listTypeVersions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListTypeVersionsInput, ListTypeVersionsOutput, ListTypeVersionsOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func listTypes(input: ListTypesInput, completion: @escaping (SdkResult<ListTypesOutput, ListTypesOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListTypesInput, ListTypesOutput, ListTypesOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func recordHandlerProgress(input: RecordHandlerProgressInput, completion: @escaping (SdkResult<RecordHandlerProgressOutput, RecordHandlerProgressOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RecordHandlerProgressInput, RecordHandlerProgressOutput, RecordHandlerProgressOutputError>(id: "recordHandlerProgress")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RecordHandlerProgressInput, RecordHandlerProgressOutput, RecordHandlerProgressOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func registerType(input: RegisterTypeInput, completion: @escaping (SdkResult<RegisterTypeOutput, RegisterTypeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RegisterTypeInput, RegisterTypeOutput, RegisterTypeOutputError>(id: "registerType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RegisterTypeInput, RegisterTypeOutput, RegisterTypeOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func setStackPolicy(input: SetStackPolicyInput, completion: @escaping (SdkResult<SetStackPolicyOutput, SetStackPolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SetStackPolicyInput, SetStackPolicyOutput, SetStackPolicyOutputError>(id: "setStackPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SetStackPolicyInput, SetStackPolicyOutput, SetStackPolicyOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func setTypeDefaultVersion(input: SetTypeDefaultVersionInput, completion: @escaping (SdkResult<SetTypeDefaultVersionOutput, SetTypeDefaultVersionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SetTypeDefaultVersionInput, SetTypeDefaultVersionOutput, SetTypeDefaultVersionOutputError>(id: "setTypeDefaultVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SetTypeDefaultVersionInput, SetTypeDefaultVersionOutput, SetTypeDefaultVersionOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///          instance.</p>
    public func signalResource(input: SignalResourceInput, completion: @escaping (SdkResult<SignalResourceOutput, SignalResourceOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SignalResourceInput, SignalResourceOutput, SignalResourceOutputError>(id: "signalResource")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SignalResourceInput, SignalResourceOutput, SignalResourceOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func stopStackSetOperation(input: StopStackSetOperationInput, completion: @escaping (SdkResult<StopStackSetOperationOutput, StopStackSetOperationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StopStackSetOperationInput, StopStackSetOperationOutput, StopStackSetOperationOutputError>(id: "stopStackSetOperation")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StopStackSetOperationInput, StopStackSetOperationOutput, StopStackSetOperationOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func updateStack(input: UpdateStackInput, completion: @escaping (SdkResult<UpdateStackOutput, UpdateStackOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateStackInput, UpdateStackOutput, UpdateStackOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func updateStackInstances(input: UpdateStackInstancesInput, completion: @escaping (SdkResult<UpdateStackInstancesOutput, UpdateStackInstancesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateStackInstancesInput, UpdateStackInstancesOutput, UpdateStackInstancesOutputError>(id: "updateStackInstances")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateStackInstancesOutput>, SdkError<UpdateStackInstancesOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.operationId == nil {
                copiedInput.operationId = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateStackInstancesInput, UpdateStackInstancesOutput, UpdateStackInstancesOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func updateStackSet(input: UpdateStackSetInput, completion: @escaping (SdkResult<UpdateStackSetOutput, UpdateStackSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateStackSetInput, UpdateStackSetOutput, UpdateStackSetOutputError>(id: "updateStackSet")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateStackSetOutput>, SdkError<UpdateStackSetOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.operationId == nil {
                copiedInput.operationId = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateStackSetInput, UpdateStackSetOutput, UpdateStackSetOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func updateTerminationProtection(input: UpdateTerminationProtectionInput, completion: @escaping (SdkResult<UpdateTerminationProtectionOutput, UpdateTerminationProtectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateTerminationProtectionInput, UpdateTerminationProtectionOutput, UpdateTerminationProtectionOutputError>(id: "updateTerminationProtection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateTerminationProtectionInput, UpdateTerminationProtectionOutput, UpdateTerminationProtectionOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func validateTemplate(input: ValidateTemplateInput, completion: @escaping (SdkResult<ValidateTemplateOutput, ValidateTemplateOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "cloudformation")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ValidateTemplateInput, ValidateTemplateOutput, ValidateTemplateOutputError>(id: "validateTemplate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ValidateTemplateInput, ValidateTemplateOutput, ValidateTemplateOutputError>(contentType: "application/x-www-form-urlencoded"))
