...
public class CloudFormationClient {
    ...
    public class CloudFormationClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "CloudFormationClient")
        }
...
public struct CloudFormationClientLogHandlerFactory: SDKLogHandlerFactory {
...
extension CloudFormationClient: CloudFormationClientProtocol {
    ...
    ///          </note>
    public func cancelUpdateStack(input: CancelUpdateStackInput, completion: @escaping (SdkResult<CancelUpdateStackOutputResponse, CancelUpdateStackOutputError>) -> Void)
    {
        let urlPath = "/"
    ...
    public func continueUpdateRollback(input: ContinueUpdateRollbackInput, completion: @escaping (SdkResult<ContinueUpdateRollbackOutputResponse, ContinueUpdateRollbackOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func createStackInstances(input: CreateStackInstancesInput, completion: @escaping (SdkResult<CreateStackInstancesOutputResponse, CreateStackInstancesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateStackInstancesOutputResponse>, SdkError<CreateStackInstancesOutputError>> in
    ...
    public func createStackSet(input: CreateStackSetInput, completion: @escaping (SdkResult<CreateStackSetOutputResponse, CreateStackSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateStackSetOutputResponse>, SdkError<CreateStackSetOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
    ...
    public func deleteChangeSet(input: DeleteChangeSetInput, completion: @escaping (SdkResult<DeleteChangeSetOutputResponse, DeleteChangeSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func deleteStackInstances(input: DeleteStackInstancesInput, completion: @escaping (SdkResult<DeleteStackInstancesOutputResponse, DeleteStackInstancesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<DeleteStackInstancesOutputResponse>, SdkError<DeleteStackInstancesOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.operationId == nil {
                copiedInput.operationId = idempotencyTokenGenerator.generateToken()
    ...
    public func deleteStackSet(input: DeleteStackSetInput, completion: @escaping (SdkResult<DeleteStackSetOutputResponse, DeleteStackSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func deregisterType(input: DeregisterTypeInput, completion: @escaping (SdkResult<DeregisterTypeOutputResponse, DeregisterTypeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func describeStackDriftDetectionStatus(input: DescribeStackDriftDetectionStatusInput, completion: @escaping (SdkResult<DescribeStackDriftDetectionStatusOutputResponse, DescribeStackDriftDetectionStatusOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///          </note>
    public func describeStackEvents(input: DescribeStackEventsInput, completion: @escaping (SdkResult<DescribeStackEventsOutputResponse, DescribeStackEventsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func describeStackInstance(input: DescribeStackInstanceInput, completion: @escaping (SdkResult<DescribeStackInstanceOutputResponse, DescribeStackInstanceOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func describeStackResource(input: DescribeStackResourceInput, completion: @escaping (SdkResult<DescribeStackResourceOutputResponse, DescribeStackResourceOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///          for a given stack.</p>
    public func describeStackResourceDrifts(input: DescribeStackResourceDriftsInput, completion: @escaping (SdkResult<DescribeStackResourceDriftsOutputResponse, DescribeStackResourceDriftsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///             request.</p>
    ///          </note>
    public func describeStackResources(input: DescribeStackResourcesInput, completion: @escaping (SdkResult<DescribeStackResourcesOutputResponse, DescribeStackResourcesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func describeStackSet(input: DescribeStackSetInput, completion: @escaping (SdkResult<DescribeStackSetOutputResponse, DescribeStackSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func describeStackSetOperation(input: DescribeStackSetOperationInput, completion: @escaping (SdkResult<DescribeStackSetOperationOutputResponse, DescribeStackSetOperationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func describeType(input: DescribeTypeInput, completion: @escaping (SdkResult<DescribeTypeOutputResponse, DescribeTypeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func describeTypeRegistration(input: DescribeTypeRegistrationInput, completion: @escaping (SdkResult<DescribeTypeRegistrationOutputResponse, DescribeTypeRegistrationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///          itself.</p>
    public func detectStackDrift(input: DetectStackDriftInput, completion: @escaping (SdkResult<DetectStackDriftOutputResponse, DetectStackDriftOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func detectStackResourceDrift(input: DetectStackResourceDriftInput, completion: @escaping (SdkResult<DetectStackResourceDriftOutputResponse, DetectStackResourceDriftOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///             </code>.</p>
    public func detectStackSetDrift(input: DetectStackSetDriftInput, completion: @escaping (SdkResult<DetectStackSetDriftOutputResponse, DetectStackSetDriftOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<DetectStackSetDriftOutputResponse>, SdkError<DetectStackSetDriftOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.operationId == nil {
                copiedInput.operationId = idempotencyTokenGenerator.generateToken()
    ...
    ///          template.</p>
    public func estimateTemplateCost(input: EstimateTemplateCostInput, completion: @escaping (SdkResult<EstimateTemplateCostOutputResponse, EstimateTemplateCostOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func executeChangeSet(input: ExecuteChangeSetInput, completion: @escaping (SdkResult<ExecuteChangeSetOutputResponse, ExecuteChangeSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func getStackPolicy(input: GetStackPolicyInput, completion: @escaping (SdkResult<GetStackPolicyOutputResponse, GetStackPolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func getTemplateSummary(input: GetTemplateSummaryInput, completion: @escaping (SdkResult<GetTemplateSummaryOutputResponse, GetTemplateSummaryOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func listStackInstances(input: ListStackInstancesInput, completion: @escaping (SdkResult<ListStackInstancesOutputResponse, ListStackInstancesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func listStackResources(input: ListStackResourcesInput, completion: @escaping (SdkResult<ListStackResourcesOutputResponse, ListStackResourcesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func listStackSetOperationResults(input: ListStackSetOperationResultsInput, completion: @escaping (SdkResult<ListStackSetOperationResultsOutputResponse, ListStackSetOperationResultsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func listStackSetOperations(input: ListStackSetOperationsInput, completion: @escaping (SdkResult<ListStackSetOperationsOutputResponse, ListStackSetOperationsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///             </li>
    ///          </ul>
    public func listStackSets(input: ListStackSetsInput, completion: @escaping (SdkResult<ListStackSetsOutputResponse, ListStackSetsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///          deleted).</p>
    public func listStacks(input: ListStacksInput, completion: @escaping (SdkResult<ListStacksOutputResponse, ListStacksOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func listTypeRegistrations(input: ListTypeRegistrationsInput, completion: @escaping (SdkResult<ListTypeRegistrationsOutputResponse, ListTypeRegistrationsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func listTypeVersions(input: ListTypeVersionsInput, completion: @escaping (SdkResult<ListTypeVersionsOutputResponse, ListTypeVersionsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func recordHandlerProgress(input: RecordHandlerProgressInput, completion: @escaping (SdkResult<RecordHandlerProgressOutputResponse, RecordHandlerProgressOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func registerType(input: RegisterTypeInput, completion: @escaping (SdkResult<RegisterTypeOutputResponse, RegisterTypeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func setStackPolicy(input: SetStackPolicyInput, completion: @escaping (SdkResult<SetStackPolicyOutputResponse, SetStackPolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func setTypeDefaultVersion(input: SetTypeDefaultVersionInput, completion: @escaping (SdkResult<SetTypeDefaultVersionOutputResponse, SetTypeDefaultVersionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///          instance.</p>
    public func signalResource(input: SignalResourceInput, completion: @escaping (SdkResult<SignalResourceOutputResponse, SignalResourceOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func stopStackSetOperation(input: StopStackSetOperationInput, completion: @escaping (SdkResult<StopStackSetOperationOutputResponse, StopStackSetOperationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func updateStackInstances(input: UpdateStackInstancesInput, completion: @escaping (SdkResult<UpdateStackInstancesOutputResponse, UpdateStackInstancesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateStackInstancesOutputResponse>, SdkError<UpdateStackInstancesOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.operationId == nil {
                copiedInput.operationId = idempotencyTokenGenerator.generateToken()
    ...
    public func updateStackSet(input: UpdateStackSetInput, completion: @escaping (SdkResult<UpdateStackSetOutputResponse, UpdateStackSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateStackSetOutputResponse>, SdkError<UpdateStackSetOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.operationId == nil {
                copiedInput.operationId = idempotencyTokenGenerator.generateToken()
    ...
    public func updateTerminationProtection(input: UpdateTerminationProtectionInput, completion: @escaping (SdkResult<UpdateTerminationProtectionOutputResponse, UpdateTerminationProtectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func validateTemplate(input: ValidateTemplateInput, completion: @escaping (SdkResult<ValidateTemplateOutputResponse, ValidateTemplateOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
