...
public protocol CloudFormationClientProtocol {
    ...
    ///          </note>
    func cancelUpdateStack(input: CancelUpdateStackInput, completion: @escaping (SdkResult<CancelUpdateStackOutputResponse, CancelUpdateStackOutputError>) -> Void)
    ...
    func continueUpdateRollback(input: ContinueUpdateRollbackInput, completion: @escaping (SdkResult<ContinueUpdateRollbackOutputResponse, ContinueUpdateRollbackOutputError>) -> Void)
    ...
    func createChangeSet(input: CreateChangeSetInput, completion: @escaping (SdkResult<CreateChangeSetOutputResponse, CreateChangeSetOutputError>) -> Void)
    ...
    func createStackInstances(input: CreateStackInstancesInput, completion: @escaping (SdkResult<CreateStackInstancesOutputResponse, CreateStackInstancesOutputError>) -> Void)
    /// <p>Creates a stack set.</p>
    func createStackSet(input: CreateStackSetInput, completion: @escaping (SdkResult<CreateStackSetOutputResponse, CreateStackSetOutputError>) -> Void)
    ...
    func deleteChangeSet(input: DeleteChangeSetInput, completion: @escaping (SdkResult<DeleteChangeSetOutputResponse, DeleteChangeSetOutputError>) -> Void)
    ...
    func deleteStackInstances(input: DeleteStackInstancesInput, completion: @escaping (SdkResult<DeleteStackInstancesOutputResponse, DeleteStackInstancesOutputError>) -> Void)
    ...
    func deleteStackSet(input: DeleteStackSetInput, completion: @escaping (SdkResult<DeleteStackSetOutputResponse, DeleteStackSetOutputError>) -> Void)
    ...
    func deregisterType(input: DeregisterTypeInput, completion: @escaping (SdkResult<DeregisterTypeOutputResponse, DeregisterTypeOutputError>) -> Void)
    ...
    func describeStackDriftDetectionStatus(input: DescribeStackDriftDetectionStatusInput, completion: @escaping (SdkResult<DescribeStackDriftDetectionStatusOutputResponse, DescribeStackDriftDetectionStatusOutputError>) -> Void)
    ...
    ///          </note>
    func describeStackEvents(input: DescribeStackEventsInput, completion: @escaping (SdkResult<DescribeStackEventsOutputResponse, DescribeStackEventsOutputError>) -> Void)
    ...
    func describeStackInstance(input: DescribeStackInstanceInput, completion: @escaping (SdkResult<DescribeStackInstanceOutputResponse, DescribeStackInstanceOutputError>) -> Void)
    ...
    func describeStackResource(input: DescribeStackResourceInput, completion: @escaping (SdkResult<DescribeStackResourceOutputResponse, DescribeStackResourceOutputError>) -> Void)
    ...
    ///          for a given stack.</p>
    func describeStackResourceDrifts(input: DescribeStackResourceDriftsInput, completion: @escaping (SdkResult<DescribeStackResourceDriftsOutputResponse, DescribeStackResourceDriftsOutputError>) -> Void)
    ...
    ///             request.</p>
    ///          </note>
    func describeStackResources(input: DescribeStackResourcesInput, completion: @escaping (SdkResult<DescribeStackResourcesOutputResponse, DescribeStackResourcesOutputError>) -> Void)
    ...
    func describeStackSet(input: DescribeStackSetInput, completion: @escaping (SdkResult<DescribeStackSetOutputResponse, DescribeStackSetOutputError>) -> Void)
    /// <p>Returns the description of the specified stack set operation. </p>
    func describeStackSetOperation(input: DescribeStackSetOperationInput, completion: @escaping (SdkResult<DescribeStackSetOperationOutputResponse, DescribeStackSetOperationOutputError>) -> Void)
    ...
    func describeType(input: DescribeTypeInput, completion: @escaping (SdkResult<DescribeTypeOutputResponse, DescribeTypeOutputError>) -> Void)
    ...
    func describeTypeRegistration(input: DescribeTypeRegistrationInput, completion: @escaping (SdkResult<DescribeTypeRegistrationOutputResponse, DescribeTypeRegistrationOutputError>) -> Void)
    ...
    ///          itself.</p>
    func detectStackDrift(input: DetectStackDriftInput, completion: @escaping (SdkResult<DetectStackDriftOutputResponse, DetectStackDriftOutputError>) -> Void)
    ...
    func detectStackResourceDrift(input: DetectStackResourceDriftInput, completion: @escaping (SdkResult<DetectStackResourceDriftOutputResponse, DetectStackResourceDriftOutputError>) -> Void)
    ...
    ///             </code>.</p>
    func detectStackSetDrift(input: DetectStackSetDriftInput, completion: @escaping (SdkResult<DetectStackSetDriftOutputResponse, DetectStackSetDriftOutputError>) -> Void)
    ...
    ///          template.</p>
    func estimateTemplateCost(input: EstimateTemplateCostInput, completion: @escaping (SdkResult<EstimateTemplateCostOutputResponse, EstimateTemplateCostOutputError>) -> Void)
    ...
    func executeChangeSet(input: ExecuteChangeSetInput, completion: @escaping (SdkResult<ExecuteChangeSetOutputResponse, ExecuteChangeSetOutputError>) -> Void)
    /// <p>Returns the stack policy for a specified stack. If a stack doesn't have a policy, a
    ///          null value is returned.</p>
    func getStackPolicy(input: GetStackPolicyInput, completion: @escaping (SdkResult<GetStackPolicyOutputResponse, GetStackPolicyOutputError>) -> Void)
    ...
    ///          </p>
    ///          </note>
    func getTemplate(input: GetTemplateInput, completion: @escaping (SdkResult<GetTemplateOutputResponse, GetTemplateOutputError>) -> Void)
    ...
    func getTemplateSummary(input: GetTemplateSummaryInput, completion: @escaping (SdkResult<GetTemplateSummaryOutputResponse, GetTemplateSummaryOutputError>) -> Void)
    ...
    func listStackInstances(input: ListStackInstancesInput, completion: @escaping (SdkResult<ListStackInstancesOutputResponse, ListStackInstancesOutputError>) -> Void)
    ...
    func listStackResources(input: ListStackResourcesInput, completion: @escaping (SdkResult<ListStackResourcesOutputResponse, ListStackResourcesOutputError>) -> Void)
    ...
    ///          deleted).</p>
    func listStacks(input: ListStacksInput, completion: @escaping (SdkResult<ListStacksOutputResponse, ListStacksOutputError>) -> Void)
    /// <p>Returns summary information about the results of a stack set operation. </p>
    func listStackSetOperationResults(input: ListStackSetOperationResultsInput, completion: @escaping (SdkResult<ListStackSetOperationResultsOutputResponse, ListStackSetOperationResultsOutputError>) -> Void)
    /// <p>Returns summary information about operations performed on a stack set. </p>
    func listStackSetOperations(input: ListStackSetOperationsInput, completion: @escaping (SdkResult<ListStackSetOperationsOutputResponse, ListStackSetOperationsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func listStackSets(input: ListStackSetsInput, completion: @escaping (SdkResult<ListStackSetsOutputResponse, ListStackSetsOutputError>) -> Void)
    /// <p>Returns a list of registration tokens for the specified extension(s).</p>
    func listTypeRegistrations(input: ListTypeRegistrationsInput, completion: @escaping (SdkResult<ListTypeRegistrationsOutputResponse, ListTypeRegistrationsOutputError>) -> Void)
    ...
    func listTypeVersions(input: ListTypeVersionsInput, completion: @escaping (SdkResult<ListTypeVersionsOutputResponse, ListTypeVersionsOutputError>) -> Void)
    ...
    func recordHandlerProgress(input: RecordHandlerProgressInput, completion: @escaping (SdkResult<RecordHandlerProgressOutputResponse, RecordHandlerProgressOutputError>) -> Void)
    ...
    func registerType(input: RegisterTypeInput, completion: @escaping (SdkResult<RegisterTypeOutputResponse, RegisterTypeOutputError>) -> Void)
    /// <p>Sets a stack policy for a specified stack.</p>
    func setStackPolicy(input: SetStackPolicyInput, completion: @escaping (SdkResult<SetStackPolicyOutputResponse, SetStackPolicyOutputError>) -> Void)
    ...
    func setTypeDefaultVersion(input: SetTypeDefaultVersionInput, completion: @escaping (SdkResult<SetTypeDefaultVersionOutputResponse, SetTypeDefaultVersionOutputError>) -> Void)
    ...
    ///          instance.</p>
    func signalResource(input: SignalResourceInput, completion: @escaping (SdkResult<SignalResourceOutputResponse, SignalResourceOutputError>) -> Void)
    /// <p>Stops an in-progress operation on a stack set and its associated stack instances. </p>
    func stopStackSetOperation(input: StopStackSetOperationInput, completion: @escaping (SdkResult<StopStackSetOperationOutputResponse, StopStackSetOperationOutputError>) -> Void)
    ...
    func updateStackInstances(input: UpdateStackInstancesInput, completion: @escaping (SdkResult<UpdateStackInstancesOutputResponse, UpdateStackInstancesOutputError>) -> Void)
    ...
    func updateStackSet(input: UpdateStackSetInput, completion: @escaping (SdkResult<UpdateStackSetOutputResponse, UpdateStackSetOutputError>) -> Void)
    ...
    func updateTerminationProtection(input: UpdateTerminationProtectionInput, completion: @escaping (SdkResult<UpdateTerminationProtectionOutputResponse, UpdateTerminationProtectionOutputError>) -> Void)
    ...
    func validateTemplate(input: ValidateTemplateInput, completion: @escaping (SdkResult<ValidateTemplateOutputResponse, ValidateTemplateOutputError>) -> Void)
}
