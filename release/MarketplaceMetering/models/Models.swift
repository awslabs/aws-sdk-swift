...
public enum BatchMeterUsageOutputError: Swift.Error, Equatable {
...
public enum MeterUsageOutputError: Swift.Error, Equatable {
...
public enum RegisterUsageOutputError: Swift.Error, Equatable {
    case customerNotEntitledException(CustomerNotEntitledException)
    case disabledApiException(DisabledApiException)
    case internalServiceErrorException(InternalServiceErrorException)
    case invalidProductCodeException(InvalidProductCodeException)
...
public enum ResolveCustomerOutputError: Swift.Error, Equatable {
    case disabledApiException(DisabledApiException)
