...
extension MarketplaceMeteringClient: MarketplaceMeteringClientProtocol {
    ...
    public func batchMeterUsage(input: BatchMeterUsageInput, completion: @escaping (SdkResult<BatchMeterUsageOutput, BatchMeterUsageOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<BatchMeterUsageInput, BatchMeterUsageOutput, BatchMeterUsageOutputError>(id: "batchMeterUsage")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<BatchMeterUsageInput, BatchMeterUsageOutput, BatchMeterUsageOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<BatchMeterUsageInput, BatchMeterUsageOutput, BatchMeterUsageOutputError>(xAmzTarget: "AWSMPMeteringService.BatchMeterUsage"))
    ...
    ///             define).</p>
    public func meterUsage(input: MeterUsageInput, completion: @escaping (SdkResult<MeterUsageOutput, MeterUsageOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "aws-marketplace")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<MeterUsageInput, MeterUsageOutput, MeterUsageOutputError>(id: "meterUsage")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<MeterUsageInput, MeterUsageOutput, MeterUsageOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<MeterUsageInput, MeterUsageOutput, MeterUsageOutputError>(xAmzTarget: "AWSMPMeteringService.MeterUsage"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </li>
    ///          </ul>
    public func registerUsage(input: RegisterUsageInput, completion: @escaping (SdkResult<RegisterUsageOutput, RegisterUsageOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "aws-marketplace")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RegisterUsageInput, RegisterUsageOutput, RegisterUsageOutputError>(id: "registerUsage")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RegisterUsageInput, RegisterUsageOutput, RegisterUsageOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RegisterUsageInput, RegisterUsageOutput, RegisterUsageOutputError>(xAmzTarget: "AWSMPMeteringService.RegisterUsage"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func resolveCustomer(input: ResolveCustomerInput, completion: @escaping (SdkResult<ResolveCustomerOutput, ResolveCustomerOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "aws-marketplace")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ResolveCustomerInput, ResolveCustomerOutput, ResolveCustomerOutputError>(id: "resolveCustomer")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ResolveCustomerInput, ResolveCustomerOutput, ResolveCustomerOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ResolveCustomerInput, ResolveCustomerOutput, ResolveCustomerOutputError>(xAmzTarget: "AWSMPMeteringService.ResolveCustomer"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
