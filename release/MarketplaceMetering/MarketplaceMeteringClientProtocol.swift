...
public protocol MarketplaceMeteringClientProtocol {
    ...
    func batchMeterUsage(input: BatchMeterUsageInput, completion: @escaping (SdkResult<BatchMeterUsageOutputResponse, BatchMeterUsageOutputError>) -> Void)
    ...
    ///             define).</p>
    func meterUsage(input: MeterUsageInput, completion: @escaping (SdkResult<MeterUsageOutputResponse, MeterUsageOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func registerUsage(input: RegisterUsageInput, completion: @escaping (SdkResult<RegisterUsageOutputResponse, RegisterUsageOutputError>) -> Void)
    ...
    func resolveCustomer(input: ResolveCustomerInput, completion: @escaping (SdkResult<ResolveCustomerOutputResponse, ResolveCustomerOutputError>) -> Void)
}
