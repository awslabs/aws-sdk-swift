...
public protocol MarketplaceMeteringClientProtocol {
    ...
    func batchMeterUsage(input: BatchMeterUsageInput, completion: @escaping (SdkResult<BatchMeterUsageOutput, BatchMeterUsageOutputError>) -> Void)
    ...
    ///             define).</p>
    func meterUsage(input: MeterUsageInput, completion: @escaping (SdkResult<MeterUsageOutput, MeterUsageOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func registerUsage(input: RegisterUsageInput, completion: @escaping (SdkResult<RegisterUsageOutput, RegisterUsageOutputError>) -> Void)
    ...
    func resolveCustomer(input: ResolveCustomerInput, completion: @escaping (SdkResult<ResolveCustomerOutput, ResolveCustomerOutputError>) -> Void)
}
