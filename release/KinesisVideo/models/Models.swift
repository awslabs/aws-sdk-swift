...
extension AccountChannelLimitExceededException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
///             in this region.</p>
public struct AccountChannelLimitExceededException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension AccountStreamLimitExceededException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct AccountStreamLimitExceededException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension KinesisVideoClientTypes {
    ...
    public struct ChannelInfo: Swift.Equatable {
        ...
        public let channelStatus: KinesisVideoClientTypes.Status?
...
extension KinesisVideoClientTypes {
    ...
    public struct ChannelNameCondition: Swift.Equatable {
        ...
        public let comparisonOperator: KinesisVideoClientTypes.ComparisonOperator?
        /// <p>A value to compare.</p>
        public let comparisonValue: Swift.String?
...
extension DeviceStreamLimitExceededException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
/// <p>Not implemented.
///             </p>
public struct DeviceStreamLimitExceededException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension InvalidDeviceException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
/// <p>Not implemented.</p>
public struct InvalidDeviceException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension InvalidResourceFormatException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct InvalidResourceFormatException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension KinesisVideoClientTypes {
    ...
    public struct ResourceEndpointListItem: Swift.Equatable {
        ...
        ///                 <code>GetSignalingChannelEndpoint</code> API.</p>
        public let `protocol`: KinesisVideoClientTypes.ChannelProtocol?
        /// <p>The endpoint of the signaling channel returned by the
        ///                 <code>GetSignalingChannelEndpoint</code> API.</p>
        public let resourceEndpoint: Swift.String?
...
extension KinesisVideoClientTypes {
    ...
    public struct SingleMasterChannelEndpointConfiguration: Swift.Equatable {
        ...
        public let protocols: [KinesisVideoClientTypes.ChannelProtocol]?
        ...
        public let role: KinesisVideoClientTypes.ChannelRole?
...
extension KinesisVideoClientTypes {
    ...
    public struct SingleMasterConfiguration: Swift.Equatable {
        ...
        ///             discarded.</p>
        public let messageTtlSeconds: Swift.Int?
...
extension KinesisVideoClientTypes {
    ...
    public struct StreamInfo: Swift.Equatable {
        ...
        public let status: KinesisVideoClientTypes.Status?
        /// <p>The Amazon Resource Name (ARN) of the stream.</p>
        public let streamARN: Swift.String?
        /// <p>The name of the stream.</p>
        public let streamName: Swift.String?
...
extension TagsPerResourceExceededLimitException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct TagsPerResourceExceededLimitException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension VersionMismatchException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
///             API.</p>
public struct VersionMismatchException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
