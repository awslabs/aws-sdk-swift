...
public struct DeleteBucketAnalyticsConfigurationInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DeleteBucketAnalyticsConfigurationOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DeleteBucketAnalyticsConfigurationOutput>
