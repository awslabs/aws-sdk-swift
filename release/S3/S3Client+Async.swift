...
public extension S3Client {
    ...
    {
        typealias abortMultipartUploadContinuation = CheckedContinuation<AbortMultipartUploadOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: abortMultipartUploadContinuation) in
            abortMultipartUpload(input: input) { result in
                switch result {
    ...
    {
        typealias completeMultipartUploadContinuation = CheckedContinuation<CompleteMultipartUploadOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: completeMultipartUploadContinuation) in
            completeMultipartUpload(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias copyObjectContinuation = CheckedContinuation<CopyObjectOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: copyObjectContinuation) in
            copyObject(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createMultipartUploadContinuation = CheckedContinuation<CreateMultipartUploadOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createMultipartUploadContinuation) in
            createMultipartUpload(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBucketAnalyticsConfigurationContinuation = CheckedContinuation<DeleteBucketAnalyticsConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBucketAnalyticsConfigurationContinuation) in
            deleteBucketAnalyticsConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBucketCorsContinuation = CheckedContinuation<DeleteBucketCorsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBucketCorsContinuation) in
            deleteBucketCors(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBucketEncryptionContinuation = CheckedContinuation<DeleteBucketEncryptionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBucketEncryptionContinuation) in
            deleteBucketEncryption(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBucketIntelligentTieringConfigurationContinuation = CheckedContinuation<DeleteBucketIntelligentTieringConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBucketIntelligentTieringConfigurationContinuation) in
            deleteBucketIntelligentTieringConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBucketInventoryConfigurationContinuation = CheckedContinuation<DeleteBucketInventoryConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBucketInventoryConfigurationContinuation) in
            deleteBucketInventoryConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBucketLifecycleContinuation = CheckedContinuation<DeleteBucketLifecycleOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBucketLifecycleContinuation) in
            deleteBucketLifecycle(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBucketMetricsConfigurationContinuation = CheckedContinuation<DeleteBucketMetricsConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBucketMetricsConfigurationContinuation) in
            deleteBucketMetricsConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBucketOwnershipControlsContinuation = CheckedContinuation<DeleteBucketOwnershipControlsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBucketOwnershipControlsContinuation) in
            deleteBucketOwnershipControls(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBucketReplicationContinuation = CheckedContinuation<DeleteBucketReplicationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBucketReplicationContinuation) in
            deleteBucketReplication(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteBucketWebsiteContinuation = CheckedContinuation<DeleteBucketWebsiteOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBucketWebsiteContinuation) in
            deleteBucketWebsite(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteObjectTaggingContinuation = CheckedContinuation<DeleteObjectTaggingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteObjectTaggingContinuation) in
            deleteObjectTagging(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteObjectsContinuation = CheckedContinuation<DeleteObjectsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteObjectsContinuation) in
            deleteObjects(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketAccelerateConfigurationContinuation = CheckedContinuation<GetBucketAccelerateConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketAccelerateConfigurationContinuation) in
            getBucketAccelerateConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketAclContinuation = CheckedContinuation<GetBucketAclOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketAclContinuation) in
            getBucketAcl(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketAnalyticsConfigurationContinuation = CheckedContinuation<GetBucketAnalyticsConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketAnalyticsConfigurationContinuation) in
            getBucketAnalyticsConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketCorsContinuation = CheckedContinuation<GetBucketCorsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketCorsContinuation) in
            getBucketCors(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketEncryptionContinuation = CheckedContinuation<GetBucketEncryptionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketEncryptionContinuation) in
            getBucketEncryption(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketIntelligentTieringConfigurationContinuation = CheckedContinuation<GetBucketIntelligentTieringConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketIntelligentTieringConfigurationContinuation) in
            getBucketIntelligentTieringConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketInventoryConfigurationContinuation = CheckedContinuation<GetBucketInventoryConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketInventoryConfigurationContinuation) in
            getBucketInventoryConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketLocationContinuation = CheckedContinuation<GetBucketLocationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketLocationContinuation) in
            getBucketLocation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketLoggingContinuation = CheckedContinuation<GetBucketLoggingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketLoggingContinuation) in
            getBucketLogging(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketMetricsConfigurationContinuation = CheckedContinuation<GetBucketMetricsConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketMetricsConfigurationContinuation) in
            getBucketMetricsConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketNotificationConfigurationContinuation = CheckedContinuation<GetBucketNotificationConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketNotificationConfigurationContinuation) in
            getBucketNotificationConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketOwnershipControlsContinuation = CheckedContinuation<GetBucketOwnershipControlsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketOwnershipControlsContinuation) in
            getBucketOwnershipControls(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketPolicyStatusContinuation = CheckedContinuation<GetBucketPolicyStatusOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketPolicyStatusContinuation) in
            getBucketPolicyStatus(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketReplicationContinuation = CheckedContinuation<GetBucketReplicationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketReplicationContinuation) in
            getBucketReplication(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketRequestPaymentContinuation = CheckedContinuation<GetBucketRequestPaymentOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketRequestPaymentContinuation) in
            getBucketRequestPayment(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketVersioningContinuation = CheckedContinuation<GetBucketVersioningOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketVersioningContinuation) in
            getBucketVersioning(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getBucketWebsiteContinuation = CheckedContinuation<GetBucketWebsiteOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getBucketWebsiteContinuation) in
            getBucketWebsite(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getObjectAclContinuation = CheckedContinuation<GetObjectAclOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getObjectAclContinuation) in
            getObjectAcl(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getObjectLegalHoldContinuation = CheckedContinuation<GetObjectLegalHoldOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getObjectLegalHoldContinuation) in
            getObjectLegalHold(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getObjectLockConfigurationContinuation = CheckedContinuation<GetObjectLockConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getObjectLockConfigurationContinuation) in
            getObjectLockConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getObjectRetentionContinuation = CheckedContinuation<GetObjectRetentionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getObjectRetentionContinuation) in
            getObjectRetention(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getObjectTaggingContinuation = CheckedContinuation<GetObjectTaggingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getObjectTaggingContinuation) in
            getObjectTagging(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getObjectTorrentContinuation = CheckedContinuation<GetObjectTorrentOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getObjectTorrentContinuation) in
            getObjectTorrent(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias headBucketContinuation = CheckedContinuation<HeadBucketOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: headBucketContinuation) in
            headBucket(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias headObjectContinuation = CheckedContinuation<HeadObjectOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: headObjectContinuation) in
            headObject(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listBucketAnalyticsConfigurationsContinuation = CheckedContinuation<ListBucketAnalyticsConfigurationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listBucketAnalyticsConfigurationsContinuation) in
            listBucketAnalyticsConfigurations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listBucketIntelligentTieringConfigurationsContinuation = CheckedContinuation<ListBucketIntelligentTieringConfigurationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listBucketIntelligentTieringConfigurationsContinuation) in
            listBucketIntelligentTieringConfigurations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listBucketInventoryConfigurationsContinuation = CheckedContinuation<ListBucketInventoryConfigurationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listBucketInventoryConfigurationsContinuation) in
            listBucketInventoryConfigurations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listBucketMetricsConfigurationsContinuation = CheckedContinuation<ListBucketMetricsConfigurationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listBucketMetricsConfigurationsContinuation) in
            listBucketMetricsConfigurations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listBucketsContinuation = CheckedContinuation<ListBucketsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listBucketsContinuation) in
            listBuckets(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listMultipartUploadsContinuation = CheckedContinuation<ListMultipartUploadsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listMultipartUploadsContinuation) in
            listMultipartUploads(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listObjectVersionsContinuation = CheckedContinuation<ListObjectVersionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listObjectVersionsContinuation) in
            listObjectVersions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listObjectsContinuation = CheckedContinuation<ListObjectsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listObjectsContinuation) in
            listObjects(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listObjectsV2Continuation = CheckedContinuation<ListObjectsV2OutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listObjectsV2Continuation) in
            listObjectsV2(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listPartsContinuation = CheckedContinuation<ListPartsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listPartsContinuation) in
            listParts(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketAccelerateConfigurationContinuation = CheckedContinuation<PutBucketAccelerateConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketAccelerateConfigurationContinuation) in
            putBucketAccelerateConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketAclContinuation = CheckedContinuation<PutBucketAclOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketAclContinuation) in
            putBucketAcl(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketAnalyticsConfigurationContinuation = CheckedContinuation<PutBucketAnalyticsConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketAnalyticsConfigurationContinuation) in
            putBucketAnalyticsConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketCorsContinuation = CheckedContinuation<PutBucketCorsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketCorsContinuation) in
            putBucketCors(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketEncryptionContinuation = CheckedContinuation<PutBucketEncryptionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketEncryptionContinuation) in
            putBucketEncryption(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketIntelligentTieringConfigurationContinuation = CheckedContinuation<PutBucketIntelligentTieringConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketIntelligentTieringConfigurationContinuation) in
            putBucketIntelligentTieringConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketInventoryConfigurationContinuation = CheckedContinuation<PutBucketInventoryConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketInventoryConfigurationContinuation) in
            putBucketInventoryConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketLoggingContinuation = CheckedContinuation<PutBucketLoggingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketLoggingContinuation) in
            putBucketLogging(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketMetricsConfigurationContinuation = CheckedContinuation<PutBucketMetricsConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketMetricsConfigurationContinuation) in
            putBucketMetricsConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketNotificationConfigurationContinuation = CheckedContinuation<PutBucketNotificationConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketNotificationConfigurationContinuation) in
            putBucketNotificationConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketOwnershipControlsContinuation = CheckedContinuation<PutBucketOwnershipControlsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketOwnershipControlsContinuation) in
            putBucketOwnershipControls(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketReplicationContinuation = CheckedContinuation<PutBucketReplicationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketReplicationContinuation) in
            putBucketReplication(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketRequestPaymentContinuation = CheckedContinuation<PutBucketRequestPaymentOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketRequestPaymentContinuation) in
            putBucketRequestPayment(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketVersioningContinuation = CheckedContinuation<PutBucketVersioningOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketVersioningContinuation) in
            putBucketVersioning(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBucketWebsiteContinuation = CheckedContinuation<PutBucketWebsiteOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBucketWebsiteContinuation) in
            putBucketWebsite(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putObjectAclContinuation = CheckedContinuation<PutObjectAclOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putObjectAclContinuation) in
            putObjectAcl(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putObjectLegalHoldContinuation = CheckedContinuation<PutObjectLegalHoldOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putObjectLegalHoldContinuation) in
            putObjectLegalHold(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putObjectLockConfigurationContinuation = CheckedContinuation<PutObjectLockConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putObjectLockConfigurationContinuation) in
            putObjectLockConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putObjectRetentionContinuation = CheckedContinuation<PutObjectRetentionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putObjectRetentionContinuation) in
            putObjectRetention(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putObjectTaggingContinuation = CheckedContinuation<PutObjectTaggingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putObjectTaggingContinuation) in
            putObjectTagging(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias restoreObjectContinuation = CheckedContinuation<RestoreObjectOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: restoreObjectContinuation) in
            restoreObject(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias selectObjectContentContinuation = CheckedContinuation<SelectObjectContentOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: selectObjectContentContinuation) in
            selectObjectContent(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias uploadPartContinuation = CheckedContinuation<UploadPartOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: uploadPartContinuation) in
            uploadPart(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias uploadPartCopyContinuation = CheckedContinuation<UploadPartCopyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: uploadPartCopyContinuation) in
            uploadPartCopy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias writeGetObjectResponseContinuation = CheckedContinuation<WriteGetObjectResponseOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: writeGetObjectResponseContinuation) in
            writeGetObjectResponse(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
