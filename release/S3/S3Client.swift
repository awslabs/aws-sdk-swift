...
public class S3Client {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try S3ClientConfiguration(region: unwrappedRegion)
    ...
    public class S3ClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("S3Client")
...
extension S3Client: S3ClientProtocol {
    ...
    ///             </li>
    ///          </ul>
    public func getObjectTorrent(input: GetObjectTorrentInput, completion: @escaping (SdkResult<GetObjectTorrentOutputResponse, GetObjectTorrentOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
    ...
    ///             </li>
    ///          </ul>
    public func selectObjectContent(input: SelectObjectContentInput, completion: @escaping (SdkResult<SelectObjectContentOutputResponse, SelectObjectContentOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
    ...
    ///             </li>
    ///          </ul>
    public func uploadPart(input: UploadPartInput, completion: @escaping (SdkResult<UploadPartOutputResponse, UploadPartOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
    ...
    public func writeGetObjectResponse(input: WriteGetObjectResponseInput, completion: @escaping (SdkResult<WriteGetObjectResponseOutputResponse, WriteGetObjectResponseOutputError>) -> Void)
    {
