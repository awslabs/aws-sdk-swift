...
public class S3Client {
    ...
    public init(config: S3ClientConfiguration) {
    ...
    public class S3ClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        public static func `default`() throws -> S3ClientConfiguration {
            ...
            return try S3ClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
...
extension S3Client: S3ClientProtocol {
    ...
    public func abortMultipartUpload(input: AbortMultipartUploadInput, completion: @escaping (SdkResult<AbortMultipartUploadOutputResponse, AbortMultipartUploadOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AbortMultipartUploadInput, AbortMultipartUploadOutputResponse, AbortMultipartUploadOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        let sigv4Config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
    ...
    public func completeMultipartUpload(input: CompleteMultipartUploadInput, completion: @escaping (SdkResult<CompleteMultipartUploadOutputResponse, CompleteMultipartUploadOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CompleteMultipartUploadInput, CompleteMultipartUploadOutputResponse, CompleteMultipartUploadOutputError>(contentType: "application/xml"))
    ...
    ///             Objects</a>.</p>
    public func copyObject(input: CopyObjectInput, completion: @escaping (SdkResult<CopyObjectOutputResponse, CopyObjectOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CopyObjectInput, CopyObjectOutputResponse, CopyObjectOutputError>(id: "copyObject")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CopyObjectInput, CopyObjectOutputResponse, CopyObjectOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func createMultipartUpload(input: CreateMultipartUploadInput, completion: @escaping (SdkResult<CreateMultipartUploadOutputResponse, CreateMultipartUploadOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateMultipartUploadInput, CreateMultipartUploadOutputResponse, CreateMultipartUploadOutputError>(id: "createMultipartUpload")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateMultipartUploadInput, CreateMultipartUploadOutputResponse, CreateMultipartUploadOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketAnalyticsConfiguration(input: DeleteBucketAnalyticsConfigurationInput, completion: @escaping (SdkResult<DeleteBucketAnalyticsConfigurationOutputResponse, DeleteBucketAnalyticsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketAnalyticsConfigurationInput, DeleteBucketAnalyticsConfigurationOutputResponse, DeleteBucketAnalyticsConfigurationOutputError>(id: "deleteBucketAnalyticsConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketAnalyticsConfigurationInput, DeleteBucketAnalyticsConfigurationOutputResponse, DeleteBucketAnalyticsConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketCors(input: DeleteBucketCorsInput, completion: @escaping (SdkResult<DeleteBucketCorsOutputResponse, DeleteBucketCorsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketCorsInput, DeleteBucketCorsOutputResponse, DeleteBucketCorsOutputError>(id: "deleteBucketCors")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketCorsInput, DeleteBucketCorsOutputResponse, DeleteBucketCorsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketEncryption(input: DeleteBucketEncryptionInput, completion: @escaping (SdkResult<DeleteBucketEncryptionOutputResponse, DeleteBucketEncryptionOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketEncryptionInput, DeleteBucketEncryptionOutputResponse, DeleteBucketEncryptionOutputError>(id: "deleteBucketEncryption")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketEncryptionInput, DeleteBucketEncryptionOutputResponse, DeleteBucketEncryptionOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketIntelligentTieringConfiguration(input: DeleteBucketIntelligentTieringConfigurationInput, completion: @escaping (SdkResult<DeleteBucketIntelligentTieringConfigurationOutputResponse, DeleteBucketIntelligentTieringConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketIntelligentTieringConfigurationInput, DeleteBucketIntelligentTieringConfigurationOutputResponse, DeleteBucketIntelligentTieringConfigurationOutputError>(id: "deleteBucketIntelligentTieringConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketIntelligentTieringConfigurationInput, DeleteBucketIntelligentTieringConfigurationOutputResponse, DeleteBucketIntelligentTieringConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketInventoryConfiguration(input: DeleteBucketInventoryConfigurationInput, completion: @escaping (SdkResult<DeleteBucketInventoryConfigurationOutputResponse, DeleteBucketInventoryConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketInventoryConfigurationInput, DeleteBucketInventoryConfigurationOutputResponse, DeleteBucketInventoryConfigurationOutputError>(id: "deleteBucketInventoryConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketInventoryConfigurationInput, DeleteBucketInventoryConfigurationOutputResponse, DeleteBucketInventoryConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketLifecycle(input: DeleteBucketLifecycleInput, completion: @escaping (SdkResult<DeleteBucketLifecycleOutputResponse, DeleteBucketLifecycleOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketLifecycleInput, DeleteBucketLifecycleOutputResponse, DeleteBucketLifecycleOutputError>(id: "deleteBucketLifecycle")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketLifecycleInput, DeleteBucketLifecycleOutputResponse, DeleteBucketLifecycleOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketMetricsConfiguration(input: DeleteBucketMetricsConfigurationInput, completion: @escaping (SdkResult<DeleteBucketMetricsConfigurationOutputResponse, DeleteBucketMetricsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketMetricsConfigurationInput, DeleteBucketMetricsConfigurationOutputResponse, DeleteBucketMetricsConfigurationOutputError>(id: "deleteBucketMetricsConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketMetricsConfigurationInput, DeleteBucketMetricsConfigurationOutputResponse, DeleteBucketMetricsConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketOwnershipControls(input: DeleteBucketOwnershipControlsInput, completion: @escaping (SdkResult<DeleteBucketOwnershipControlsOutputResponse, DeleteBucketOwnershipControlsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketOwnershipControlsInput, DeleteBucketOwnershipControlsOutputResponse, DeleteBucketOwnershipControlsOutputError>(id: "deleteBucketOwnershipControls")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketOwnershipControlsInput, DeleteBucketOwnershipControlsOutputResponse, DeleteBucketOwnershipControlsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketReplication(input: DeleteBucketReplicationInput, completion: @escaping (SdkResult<DeleteBucketReplicationOutputResponse, DeleteBucketReplicationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketReplicationInput, DeleteBucketReplicationOutputResponse, DeleteBucketReplicationOutputError>(id: "deleteBucketReplication")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketReplicationInput, DeleteBucketReplicationOutputResponse, DeleteBucketReplicationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketWebsite(input: DeleteBucketWebsiteInput, completion: @escaping (SdkResult<DeleteBucketWebsiteOutputResponse, DeleteBucketWebsiteOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketWebsiteInput, DeleteBucketWebsiteOutputResponse, DeleteBucketWebsiteOutputError>(id: "deleteBucketWebsite")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketWebsiteInput, DeleteBucketWebsiteOutputResponse, DeleteBucketWebsiteOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    public func deleteObject(input: DeleteObjectInput, completion: @escaping (SdkResult<DeleteObjectOutputResponse, DeleteObjectOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteObjectInput, DeleteObjectOutputResponse, DeleteObjectOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteObjectTagging(input: DeleteObjectTaggingInput, completion: @escaping (SdkResult<DeleteObjectTaggingOutputResponse, DeleteObjectTaggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteObjectTaggingInput, DeleteObjectTaggingOutputResponse, DeleteObjectTaggingOutputError>(id: "deleteObjectTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteObjectTaggingInput, DeleteObjectTaggingOutputResponse, DeleteObjectTaggingOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func deleteObjects(input: DeleteObjectsInput, completion: @escaping (SdkResult<DeleteObjectsOutputResponse, DeleteObjectsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteObjectsInput, DeleteObjectsOutputResponse, DeleteObjectsOutputError>(id: "deleteObjects")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteObjectsInput, DeleteObjectsOutputResponse, DeleteObjectsOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketAccelerateConfiguration(input: GetBucketAccelerateConfigurationInput, completion: @escaping (SdkResult<GetBucketAccelerateConfigurationOutputResponse, GetBucketAccelerateConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketAccelerateConfigurationInput, GetBucketAccelerateConfigurationOutputResponse, GetBucketAccelerateConfigurationOutputError>(id: "getBucketAccelerateConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketAccelerateConfigurationInput, GetBucketAccelerateConfigurationOutputResponse, GetBucketAccelerateConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketAcl(input: GetBucketAclInput, completion: @escaping (SdkResult<GetBucketAclOutputResponse, GetBucketAclOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketAclInput, GetBucketAclOutputResponse, GetBucketAclOutputError>(id: "getBucketAcl")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketAclInput, GetBucketAclOutputResponse, GetBucketAclOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketAnalyticsConfiguration(input: GetBucketAnalyticsConfigurationInput, completion: @escaping (SdkResult<GetBucketAnalyticsConfigurationOutputResponse, GetBucketAnalyticsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketAnalyticsConfigurationInput, GetBucketAnalyticsConfigurationOutputResponse, GetBucketAnalyticsConfigurationOutputError>(id: "getBucketAnalyticsConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketAnalyticsConfigurationInput, GetBucketAnalyticsConfigurationOutputResponse, GetBucketAnalyticsConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketCors(input: GetBucketCorsInput, completion: @escaping (SdkResult<GetBucketCorsOutputResponse, GetBucketCorsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketCorsInput, GetBucketCorsOutputResponse, GetBucketCorsOutputError>(id: "getBucketCors")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketCorsInput, GetBucketCorsOutputResponse, GetBucketCorsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketEncryption(input: GetBucketEncryptionInput, completion: @escaping (SdkResult<GetBucketEncryptionOutputResponse, GetBucketEncryptionOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketEncryptionInput, GetBucketEncryptionOutputResponse, GetBucketEncryptionOutputError>(id: "getBucketEncryption")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketEncryptionInput, GetBucketEncryptionOutputResponse, GetBucketEncryptionOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketIntelligentTieringConfiguration(input: GetBucketIntelligentTieringConfigurationInput, completion: @escaping (SdkResult<GetBucketIntelligentTieringConfigurationOutputResponse, GetBucketIntelligentTieringConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketIntelligentTieringConfigurationInput, GetBucketIntelligentTieringConfigurationOutputResponse, GetBucketIntelligentTieringConfigurationOutputError>(id: "getBucketIntelligentTieringConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketIntelligentTieringConfigurationInput, GetBucketIntelligentTieringConfigurationOutputResponse, GetBucketIntelligentTieringConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketInventoryConfiguration(input: GetBucketInventoryConfigurationInput, completion: @escaping (SdkResult<GetBucketInventoryConfigurationOutputResponse, GetBucketInventoryConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketInventoryConfigurationInput, GetBucketInventoryConfigurationOutputResponse, GetBucketInventoryConfigurationOutputError>(id: "getBucketInventoryConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketInventoryConfigurationInput, GetBucketInventoryConfigurationOutputResponse, GetBucketInventoryConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketLocation(input: GetBucketLocationInput, completion: @escaping (SdkResult<GetBucketLocationOutputResponse, GetBucketLocationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketLocationInput, GetBucketLocationOutputResponse, GetBucketLocationOutputError>(id: "getBucketLocation")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketLocationInput, GetBucketLocationOutputResponse, GetBucketLocationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketLogging(input: GetBucketLoggingInput, completion: @escaping (SdkResult<GetBucketLoggingOutputResponse, GetBucketLoggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketLoggingInput, GetBucketLoggingOutputResponse, GetBucketLoggingOutputError>(id: "getBucketLogging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketLoggingInput, GetBucketLoggingOutputResponse, GetBucketLoggingOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketMetricsConfiguration(input: GetBucketMetricsConfigurationInput, completion: @escaping (SdkResult<GetBucketMetricsConfigurationOutputResponse, GetBucketMetricsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketMetricsConfigurationInput, GetBucketMetricsConfigurationOutputResponse, GetBucketMetricsConfigurationOutputError>(id: "getBucketMetricsConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketMetricsConfigurationInput, GetBucketMetricsConfigurationOutputResponse, GetBucketMetricsConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketNotificationConfiguration(input: GetBucketNotificationConfigurationInput, completion: @escaping (SdkResult<GetBucketNotificationConfigurationOutputResponse, GetBucketNotificationConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketNotificationConfigurationInput, GetBucketNotificationConfigurationOutputResponse, GetBucketNotificationConfigurationOutputError>(id: "getBucketNotificationConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketNotificationConfigurationInput, GetBucketNotificationConfigurationOutputResponse, GetBucketNotificationConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketOwnershipControls(input: GetBucketOwnershipControlsInput, completion: @escaping (SdkResult<GetBucketOwnershipControlsOutputResponse, GetBucketOwnershipControlsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketOwnershipControlsInput, GetBucketOwnershipControlsOutputResponse, GetBucketOwnershipControlsOutputError>(id: "getBucketOwnershipControls")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketOwnershipControlsInput, GetBucketOwnershipControlsOutputResponse, GetBucketOwnershipControlsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketPolicyStatus(input: GetBucketPolicyStatusInput, completion: @escaping (SdkResult<GetBucketPolicyStatusOutputResponse, GetBucketPolicyStatusOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketPolicyStatusInput, GetBucketPolicyStatusOutputResponse, GetBucketPolicyStatusOutputError>(id: "getBucketPolicyStatus")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketPolicyStatusInput, GetBucketPolicyStatusOutputResponse, GetBucketPolicyStatusOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketReplication(input: GetBucketReplicationInput, completion: @escaping (SdkResult<GetBucketReplicationOutputResponse, GetBucketReplicationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketReplicationInput, GetBucketReplicationOutputResponse, GetBucketReplicationOutputError>(id: "getBucketReplication")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketReplicationInput, GetBucketReplicationOutputResponse, GetBucketReplicationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketRequestPayment(input: GetBucketRequestPaymentInput, completion: @escaping (SdkResult<GetBucketRequestPaymentOutputResponse, GetBucketRequestPaymentOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketRequestPaymentInput, GetBucketRequestPaymentOutputResponse, GetBucketRequestPaymentOutputError>(id: "getBucketRequestPayment")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketRequestPaymentInput, GetBucketRequestPaymentOutputResponse, GetBucketRequestPaymentOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketVersioning(input: GetBucketVersioningInput, completion: @escaping (SdkResult<GetBucketVersioningOutputResponse, GetBucketVersioningOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketVersioningInput, GetBucketVersioningOutputResponse, GetBucketVersioningOutputError>(id: "getBucketVersioning")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketVersioningInput, GetBucketVersioningOutputResponse, GetBucketVersioningOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getBucketWebsite(input: GetBucketWebsiteInput, completion: @escaping (SdkResult<GetBucketWebsiteOutputResponse, GetBucketWebsiteOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketWebsiteInput, GetBucketWebsiteOutputResponse, GetBucketWebsiteOutputError>(id: "getBucketWebsite")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketWebsiteInput, GetBucketWebsiteOutputResponse, GetBucketWebsiteOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    public func getObject(input: GetObjectInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetObjectOutputResponse, GetObjectOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectInput, GetObjectOutputResponse, GetObjectOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getObjectAcl(input: GetObjectAclInput, completion: @escaping (SdkResult<GetObjectAclOutputResponse, GetObjectAclOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectAclInput, GetObjectAclOutputResponse, GetObjectAclOutputError>(id: "getObjectAcl")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectAclInput, GetObjectAclOutputResponse, GetObjectAclOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///          <p>This action is not supported by Amazon S3 on Outposts.</p>
    public func getObjectLegalHold(input: GetObjectLegalHoldInput, completion: @escaping (SdkResult<GetObjectLegalHoldOutputResponse, GetObjectLegalHoldOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectLegalHoldInput, GetObjectLegalHoldOutputResponse, GetObjectLegalHoldOutputError>(id: "getObjectLegalHold")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectLegalHoldInput, GetObjectLegalHoldOutputResponse, GetObjectLegalHoldOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             Objects</a>.</p>
    public func getObjectLockConfiguration(input: GetObjectLockConfigurationInput, completion: @escaping (SdkResult<GetObjectLockConfigurationOutputResponse, GetObjectLockConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectLockConfigurationInput, GetObjectLockConfigurationOutputResponse, GetObjectLockConfigurationOutputError>(id: "getObjectLockConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectLockConfigurationInput, GetObjectLockConfigurationOutputResponse, GetObjectLockConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///          <p>This action is not supported by Amazon S3 on Outposts.</p>
    public func getObjectRetention(input: GetObjectRetentionInput, completion: @escaping (SdkResult<GetObjectRetentionOutputResponse, GetObjectRetentionOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectRetentionInput, GetObjectRetentionOutputResponse, GetObjectRetentionOutputError>(id: "getObjectRetention")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectRetentionInput, GetObjectRetentionOutputResponse, GetObjectRetentionOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getObjectTagging(input: GetObjectTaggingInput, completion: @escaping (SdkResult<GetObjectTaggingOutputResponse, GetObjectTaggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectTaggingInput, GetObjectTaggingOutputResponse, GetObjectTaggingOutputError>(id: "getObjectTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectTaggingInput, GetObjectTaggingOutputResponse, GetObjectTaggingOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func getObjectTorrent(input: GetObjectTorrentInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetObjectTorrentOutputResponse, GetObjectTorrentOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectTorrentInput, GetObjectTorrentOutputResponse, GetObjectTorrentOutputError>(id: "getObjectTorrent")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectTorrentInput, GetObjectTorrentOutputResponse, GetObjectTorrentOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             Resources</a>.</p>
    public func headBucket(input: HeadBucketInput, completion: @escaping (SdkResult<HeadBucketOutputResponse, HeadBucketOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<HeadBucketInput, HeadBucketOutputResponse, HeadBucketOutputError>(id: "headBucket")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<HeadBucketInput, HeadBucketOutputResponse, HeadBucketOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func headObject(input: HeadObjectInput, completion: @escaping (SdkResult<HeadObjectOutputResponse, HeadObjectOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<HeadObjectInput, HeadObjectOutputResponse, HeadObjectOutputError>(id: "headObject")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<HeadObjectInput, HeadObjectOutputResponse, HeadObjectOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func listBucketAnalyticsConfigurations(input: ListBucketAnalyticsConfigurationsInput, completion: @escaping (SdkResult<ListBucketAnalyticsConfigurationsOutputResponse, ListBucketAnalyticsConfigurationsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBucketAnalyticsConfigurationsInput, ListBucketAnalyticsConfigurationsOutputResponse, ListBucketAnalyticsConfigurationsOutputError>(id: "listBucketAnalyticsConfigurations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBucketAnalyticsConfigurationsInput, ListBucketAnalyticsConfigurationsOutputResponse, ListBucketAnalyticsConfigurationsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func listBucketIntelligentTieringConfigurations(input: ListBucketIntelligentTieringConfigurationsInput, completion: @escaping (SdkResult<ListBucketIntelligentTieringConfigurationsOutputResponse, ListBucketIntelligentTieringConfigurationsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBucketIntelligentTieringConfigurationsInput, ListBucketIntelligentTieringConfigurationsOutputResponse, ListBucketIntelligentTieringConfigurationsOutputError>(id: "listBucketIntelligentTieringConfigurations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBucketIntelligentTieringConfigurationsInput, ListBucketIntelligentTieringConfigurationsOutputResponse, ListBucketIntelligentTieringConfigurationsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func listBucketInventoryConfigurations(input: ListBucketInventoryConfigurationsInput, completion: @escaping (SdkResult<ListBucketInventoryConfigurationsOutputResponse, ListBucketInventoryConfigurationsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBucketInventoryConfigurationsInput, ListBucketInventoryConfigurationsOutputResponse, ListBucketInventoryConfigurationsOutputError>(id: "listBucketInventoryConfigurations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBucketInventoryConfigurationsInput, ListBucketInventoryConfigurationsOutputResponse, ListBucketInventoryConfigurationsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func listBucketMetricsConfigurations(input: ListBucketMetricsConfigurationsInput, completion: @escaping (SdkResult<ListBucketMetricsConfigurationsOutputResponse, ListBucketMetricsConfigurationsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBucketMetricsConfigurationsInput, ListBucketMetricsConfigurationsOutputResponse, ListBucketMetricsConfigurationsOutputError>(id: "listBucketMetricsConfigurations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBucketMetricsConfigurationsInput, ListBucketMetricsConfigurationsOutputResponse, ListBucketMetricsConfigurationsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    public func listBuckets(input: ListBucketsInput, completion: @escaping (SdkResult<ListBucketsOutputResponse, ListBucketsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBucketsInput, ListBucketsOutputResponse, ListBucketsOutputError>(id: "listBuckets")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBucketsInput, ListBucketsOutputResponse, ListBucketsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    public func listMultipartUploads(input: ListMultipartUploadsInput, completion: @escaping (SdkResult<ListMultipartUploadsOutputResponse, ListMultipartUploadsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListMultipartUploadsInput, ListMultipartUploadsOutputResponse, ListMultipartUploadsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func listObjectVersions(input: ListObjectVersionsInput, completion: @escaping (SdkResult<ListObjectVersionsOutputResponse, ListObjectVersionsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListObjectVersionsInput, ListObjectVersionsOutputResponse, ListObjectVersionsOutputError>(id: "listObjectVersions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListObjectVersionsInput, ListObjectVersionsOutputResponse, ListObjectVersionsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func listObjects(input: ListObjectsInput, completion: @escaping (SdkResult<ListObjectsOutputResponse, ListObjectsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListObjectsInput, ListObjectsOutputResponse, ListObjectsOutputError>(id: "listObjects")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListObjectsInput, ListObjectsOutputResponse, ListObjectsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func listObjectsV2(input: ListObjectsV2Input, completion: @escaping (SdkResult<ListObjectsV2OutputResponse, ListObjectsV2OutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListObjectsV2Input, ListObjectsV2OutputResponse, ListObjectsV2OutputError>(id: "listObjectsV2")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListObjectsV2Input, ListObjectsV2OutputResponse, ListObjectsV2OutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    public func listParts(input: ListPartsInput, completion: @escaping (SdkResult<ListPartsOutputResponse, ListPartsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListPartsInput, ListPartsOutputResponse, ListPartsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketAccelerateConfiguration(input: PutBucketAccelerateConfigurationInput, completion: @escaping (SdkResult<PutBucketAccelerateConfigurationOutputResponse, PutBucketAccelerateConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketAccelerateConfigurationInput, PutBucketAccelerateConfigurationOutputResponse, PutBucketAccelerateConfigurationOutputError>(id: "putBucketAccelerateConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketAccelerateConfigurationInput, PutBucketAccelerateConfigurationOutputResponse, PutBucketAccelerateConfigurationOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketAcl(input: PutBucketAclInput, completion: @escaping (SdkResult<PutBucketAclOutputResponse, PutBucketAclOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketAclInput, PutBucketAclOutputResponse, PutBucketAclOutputError>(id: "putBucketAcl")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketAclInput, PutBucketAclOutputResponse, PutBucketAclOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketAnalyticsConfiguration(input: PutBucketAnalyticsConfigurationInput, completion: @escaping (SdkResult<PutBucketAnalyticsConfigurationOutputResponse, PutBucketAnalyticsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketAnalyticsConfigurationInput, PutBucketAnalyticsConfigurationOutputResponse, PutBucketAnalyticsConfigurationOutputError>(id: "putBucketAnalyticsConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketAnalyticsConfigurationInput, PutBucketAnalyticsConfigurationOutputResponse, PutBucketAnalyticsConfigurationOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketCors(input: PutBucketCorsInput, completion: @escaping (SdkResult<PutBucketCorsOutputResponse, PutBucketCorsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketCorsInput, PutBucketCorsOutputResponse, PutBucketCorsOutputError>(id: "putBucketCors")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketCorsInput, PutBucketCorsOutputResponse, PutBucketCorsOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketEncryption(input: PutBucketEncryptionInput, completion: @escaping (SdkResult<PutBucketEncryptionOutputResponse, PutBucketEncryptionOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketEncryptionInput, PutBucketEncryptionOutputResponse, PutBucketEncryptionOutputError>(id: "putBucketEncryption")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketEncryptionInput, PutBucketEncryptionOutputResponse, PutBucketEncryptionOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketIntelligentTieringConfiguration(input: PutBucketIntelligentTieringConfigurationInput, completion: @escaping (SdkResult<PutBucketIntelligentTieringConfigurationOutputResponse, PutBucketIntelligentTieringConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketIntelligentTieringConfigurationInput, PutBucketIntelligentTieringConfigurationOutputResponse, PutBucketIntelligentTieringConfigurationOutputError>(id: "putBucketIntelligentTieringConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketIntelligentTieringConfigurationInput, PutBucketIntelligentTieringConfigurationOutputResponse, PutBucketIntelligentTieringConfigurationOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketInventoryConfiguration(input: PutBucketInventoryConfigurationInput, completion: @escaping (SdkResult<PutBucketInventoryConfigurationOutputResponse, PutBucketInventoryConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketInventoryConfigurationInput, PutBucketInventoryConfigurationOutputResponse, PutBucketInventoryConfigurationOutputError>(id: "putBucketInventoryConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketInventoryConfigurationInput, PutBucketInventoryConfigurationOutputResponse, PutBucketInventoryConfigurationOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketLogging(input: PutBucketLoggingInput, completion: @escaping (SdkResult<PutBucketLoggingOutputResponse, PutBucketLoggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketLoggingInput, PutBucketLoggingOutputResponse, PutBucketLoggingOutputError>(id: "putBucketLogging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketLoggingInput, PutBucketLoggingOutputResponse, PutBucketLoggingOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketMetricsConfiguration(input: PutBucketMetricsConfigurationInput, completion: @escaping (SdkResult<PutBucketMetricsConfigurationOutputResponse, PutBucketMetricsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketMetricsConfigurationInput, PutBucketMetricsConfigurationOutputResponse, PutBucketMetricsConfigurationOutputError>(id: "putBucketMetricsConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketMetricsConfigurationInput, PutBucketMetricsConfigurationOutputResponse, PutBucketMetricsConfigurationOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketNotificationConfiguration(input: PutBucketNotificationConfigurationInput, completion: @escaping (SdkResult<PutBucketNotificationConfigurationOutputResponse, PutBucketNotificationConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketNotificationConfigurationInput, PutBucketNotificationConfigurationOutputResponse, PutBucketNotificationConfigurationOutputError>(id: "putBucketNotificationConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketNotificationConfigurationInput, PutBucketNotificationConfigurationOutputResponse, PutBucketNotificationConfigurationOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketOwnershipControls(input: PutBucketOwnershipControlsInput, completion: @escaping (SdkResult<PutBucketOwnershipControlsOutputResponse, PutBucketOwnershipControlsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketOwnershipControlsInput, PutBucketOwnershipControlsOutputResponse, PutBucketOwnershipControlsOutputError>(id: "putBucketOwnershipControls")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketOwnershipControlsInput, PutBucketOwnershipControlsOutputResponse, PutBucketOwnershipControlsOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketReplication(input: PutBucketReplicationInput, completion: @escaping (SdkResult<PutBucketReplicationOutputResponse, PutBucketReplicationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketReplicationInput, PutBucketReplicationOutputResponse, PutBucketReplicationOutputError>(id: "putBucketReplication")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketReplicationInput, PutBucketReplicationOutputResponse, PutBucketReplicationOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketRequestPayment(input: PutBucketRequestPaymentInput, completion: @escaping (SdkResult<PutBucketRequestPaymentOutputResponse, PutBucketRequestPaymentOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketRequestPaymentInput, PutBucketRequestPaymentOutputResponse, PutBucketRequestPaymentOutputError>(id: "putBucketRequestPayment")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketRequestPaymentInput, PutBucketRequestPaymentOutputResponse, PutBucketRequestPaymentOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketVersioning(input: PutBucketVersioningInput, completion: @escaping (SdkResult<PutBucketVersioningOutputResponse, PutBucketVersioningOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketVersioningInput, PutBucketVersioningOutputResponse, PutBucketVersioningOutputError>(id: "putBucketVersioning")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketVersioningInput, PutBucketVersioningOutputResponse, PutBucketVersioningOutputError>(contentType: "application/xml"))
    ...
    public func putBucketWebsite(input: PutBucketWebsiteInput, completion: @escaping (SdkResult<PutBucketWebsiteOutputResponse, PutBucketWebsiteOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketWebsiteInput, PutBucketWebsiteOutputResponse, PutBucketWebsiteOutputError>(id: "putBucketWebsite")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketWebsiteInput, PutBucketWebsiteOutputResponse, PutBucketWebsiteOutputError>(contentType: "application/xml"))
    ...
    public func putObject(input: PutObjectInput, streamSource: StreamSource, completion: @escaping (SdkResult<PutObjectOutputResponse, PutObjectOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectInput, PutObjectOutputResponse, PutObjectOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putObjectAcl(input: PutObjectAclInput, completion: @escaping (SdkResult<PutObjectAclOutputResponse, PutObjectAclOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutObjectAclInput, PutObjectAclOutputResponse, PutObjectAclOutputError>(id: "putObjectAcl")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectAclInput, PutObjectAclOutputResponse, PutObjectAclOutputError>(contentType: "application/xml"))
    ...
    ///             Objects</a>.</p>
    ///          <p>This action is not supported by Amazon S3 on Outposts.</p>
    public func putObjectLegalHold(input: PutObjectLegalHoldInput, completion: @escaping (SdkResult<PutObjectLegalHoldOutputResponse, PutObjectLegalHoldOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutObjectLegalHoldInput, PutObjectLegalHoldOutputResponse, PutObjectLegalHoldOutputError>(id: "putObjectLegalHold")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectLegalHoldInput, PutObjectLegalHoldOutputResponse, PutObjectLegalHoldOutputError>(contentType: "application/xml"))
    ...
    ///             </ul>
    ///          </note>
    public func putObjectLockConfiguration(input: PutObjectLockConfigurationInput, completion: @escaping (SdkResult<PutObjectLockConfigurationOutputResponse, PutObjectLockConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutObjectLockConfigurationInput, PutObjectLockConfigurationOutputResponse, PutObjectLockConfigurationOutputError>(id: "putObjectLockConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectLockConfigurationInput, PutObjectLockConfigurationOutputResponse, PutObjectLockConfigurationOutputError>(contentType: "application/xml"))
    ...
    ///          </p>
    ///          <p>This action is not supported by Amazon S3 on Outposts.</p>
    public func putObjectRetention(input: PutObjectRetentionInput, completion: @escaping (SdkResult<PutObjectRetentionOutputResponse, PutObjectRetentionOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutObjectRetentionInput, PutObjectRetentionOutputResponse, PutObjectRetentionOutputError>(id: "putObjectRetention")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectRetentionInput, PutObjectRetentionOutputResponse, PutObjectRetentionOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putObjectTagging(input: PutObjectTaggingInput, completion: @escaping (SdkResult<PutObjectTaggingOutputResponse, PutObjectTaggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutObjectTaggingInput, PutObjectTaggingOutputResponse, PutObjectTaggingOutputError>(id: "putObjectTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectTaggingInput, PutObjectTaggingOutputResponse, PutObjectTaggingOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func restoreObject(input: RestoreObjectInput, completion: @escaping (SdkResult<RestoreObjectOutputResponse, RestoreObjectOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RestoreObjectInput, RestoreObjectOutputResponse, RestoreObjectOutputError>(id: "restoreObject")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RestoreObjectInput, RestoreObjectOutputResponse, RestoreObjectOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func selectObjectContent(input: SelectObjectContentInput, streamSink: StreamSink, completion: @escaping (SdkResult<SelectObjectContentOutputResponse, SelectObjectContentOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SelectObjectContentInput, SelectObjectContentOutputResponse, SelectObjectContentOutputError>(id: "selectObjectContent")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SelectObjectContentInput, SelectObjectContentOutputResponse, SelectObjectContentOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func uploadPart(input: UploadPartInput, streamSource: StreamSource, completion: @escaping (SdkResult<UploadPartOutputResponse, UploadPartOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UploadPartInput, UploadPartOutputResponse, UploadPartOutputError>(id: "uploadPart")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UploadPartInput, UploadPartOutputResponse, UploadPartOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func uploadPartCopy(input: UploadPartCopyInput, completion: @escaping (SdkResult<UploadPartCopyOutputResponse, UploadPartCopyOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UploadPartCopyInput, UploadPartCopyOutputResponse, UploadPartCopyOutputError>(id: "uploadPartCopy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UploadPartCopyInput, UploadPartCopyOutputResponse, UploadPartCopyOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
    ...
    public func writeGetObjectResponse(input: WriteGetObjectResponseInput, streamSource: StreamSource, completion: @escaping (SdkResult<WriteGetObjectResponseOutputResponse, WriteGetObjectResponseOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<WriteGetObjectResponseInput, WriteGetObjectResponseOutputResponse, WriteGetObjectResponseOutputError>(id: "writeGetObjectResponse")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: WriteGetObjectResponseInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: WriteGetObjectResponseInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<WriteGetObjectResponseInput, WriteGetObjectResponseOutputResponse, WriteGetObjectResponseOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: WriteGetObjectResponseInputBodyMiddleware())
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        let sigv4Config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: true)
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
