...
extension S3Client: S3ClientProtocol {
    ...
    public func writeGetObjectResponse(input: WriteGetObjectResponseInput, streamSource: StreamSource, completion: @escaping (SdkResult<WriteGetObjectResponseOutput, WriteGetObjectResponseOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<WriteGetObjectResponseInput, WriteGetObjectResponseOutput, WriteGetObjectResponseOutputError>(id: "writeGetObjectResponse")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<WriteGetObjectResponseInput, WriteGetObjectResponseOutput, WriteGetObjectResponseOutputError>(contentType: "application/xml"))
