...
public struct AssociateBrowserSettingsInput: Swift.Equatable {
    ...
    var browserSettingsArn: Swift.String?
...
public struct AssociateNetworkSettingsInput: Swift.Equatable {
    ...
    /// This member is required.
    var networkSettingsArn: Swift.String?
    /// The ARN of the web portal.
    /// This member is required.
    var portalArn: Swift.String?
...
public struct AssociateTrustStoreInput: Swift.Equatable {
    ...
    /// This member is required.
    var trustStoreArn: Swift.String?
...
public struct AssociateUserSettingsInput: Swift.Equatable {
    ...
    /// This member is required.
    var userSettingsArn: Swift.String?
...
extension WorkSpacesWebClientTypes {
    ...
    public struct BrowserSettings: Swift.Equatable {
        ...
        var associatedPortalArns: [Swift.String]?
        /// A JSON string containing Chrome Enterprise policies that will be applied to all streaming sessions.
        var browserPolicy: Swift.String?
        /// The ARN of the browser settings.
        /// This member is required.
        var browserSettingsArn: Swift.String?
...
extension WorkSpacesWebClientTypes {
    ...
    public struct Certificate: Swift.Equatable {
        ...
        var notValidAfter: ClientRuntime.Date?
        /// The certificate is not valid before this date.
        var notValidBefore: ClientRuntime.Date?
...
public struct CreateBrowserSettingsInput: Swift.Equatable {
    ...
    var additionalEncryptionContext: [Swift.String:Swift.String]?
    /// A JSON string containing Chrome Enterprise policies that will be applied to all streaming sessions.
    /// This member is required.
    var browserPolicy: Swift.String?
    ...
    var customerManagedKey: Swift.String?
    /// The tags to add to the browser settings resource. A tag is a key-value pair.
    var tags: [WorkSpacesWebClientTypes.Tag]?
...
public struct CreateIdentityProviderInput: Swift.Equatable {
    ...
    /// * IDPSignout optional
    /// This member is required.
    var identityProviderDetails: [Swift.String:Swift.String]?
    /// The identity provider name.
    /// This member is required.
    var identityProviderName: Swift.String?
    /// The identity provider type.
    /// This member is required.
    var identityProviderType: WorkSpacesWebClientTypes.IdentityProviderType?
    /// The ARN of the web portal.
    /// This member is required.
    var portalArn: Swift.String?
...
public struct CreateIdentityProviderOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var identityProviderArn: Swift.String?
...
public struct CreatePortalOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var portalEndpoint: Swift.String?
...
public struct CreateTrustStoreInput: Swift.Equatable {
    ...
    /// This member is required.
    var certificateList: [ClientRuntime.Data]?
    /// A unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Idempotency ensures that an API request completes only once. With an idempotent request, if the original request completes successfully, subsequent retries with the same client token returns the result from the original successful request. If you do not specify a client token, one is automatically generated by the AWS SDK.
    var clientToken: Swift.String?
...
public struct CreateUserSettingsInput: Swift.Equatable {
    ...
    /// This member is required.
    var copyAllowed: WorkSpacesWebClientTypes.EnabledType?
    /// Specifies whether the user can download files from the streaming session to the local device.
    /// This member is required.
    var downloadAllowed: WorkSpacesWebClientTypes.EnabledType?
    /// Specifies whether the user can paste text from the local device to the streaming session.
    /// This member is required.
    var pasteAllowed: WorkSpacesWebClientTypes.EnabledType?
    /// Specifies whether the user can print to the local device.
    /// This member is required.
    var printAllowed: WorkSpacesWebClientTypes.EnabledType?
    /// The tags to add to the user settings resource. A tag is a key-value pair.
    var tags: [WorkSpacesWebClientTypes.Tag]?
    /// Specifies whether the user can upload files from the local device to the streaming session.
    /// This member is required.
    var uploadAllowed: WorkSpacesWebClientTypes.EnabledType?
...
public struct GetBrowserSettingsOutputResponse: Swift.Equatable {
    ...
    var browserSettings: WorkSpacesWebClientTypes.BrowserSettings?
...
public struct GetIdentityProviderOutputResponse: Swift.Equatable {
    ...
    var identityProvider: WorkSpacesWebClientTypes.IdentityProvider?
...
public struct GetNetworkSettingsOutputResponse: Swift.Equatable {
    ...
    var networkSettings: WorkSpacesWebClientTypes.NetworkSettings?
...
public struct GetPortalOutputResponse: Swift.Equatable {
    /// The web portal.
    var portal: WorkSpacesWebClientTypes.Portal?
...
public struct GetTrustStoreCertificateOutputResponse: Swift.Equatable {
    ...
    var certificate: WorkSpacesWebClientTypes.Certificate?
    /// The ARN of the trust store certificate.
    var trustStoreArn: Swift.String?
...
public struct GetTrustStoreOutputResponse: Swift.Equatable {
    /// The trust store.
    var trustStore: WorkSpacesWebClientTypes.TrustStore?
...
public struct GetUserSettingsOutputResponse: Swift.Equatable {
    /// The user settings.
    var userSettings: WorkSpacesWebClientTypes.UserSettings?
...
public struct ListBrowserSettingsOutputResponse: Swift.Equatable {
    /// The browser settings.
    var browserSettings: [WorkSpacesWebClientTypes.BrowserSettingsSummary]?
    /// The pagination token used to retrieve the next page of results for this operation.
    var nextToken: Swift.String?
...
public struct ListIdentityProvidersOutputResponse: Swift.Equatable {
    ...
    var identityProviders: [WorkSpacesWebClientTypes.IdentityProviderSummary]?
    /// The pagination token used to retrieve the next page of results for this operation.
    var nextToken: Swift.String?
...
public struct ListNetworkSettingsOutputResponse: Swift.Equatable {
    /// The network settings.
    var networkSettings: [WorkSpacesWebClientTypes.NetworkSettingsSummary]?
    /// The pagination token used to retrieve the next page of results for this operation.
    var nextToken: Swift.String?
...
public struct ListPortalsOutputResponse: Swift.Equatable {
    ...
    var portals: [WorkSpacesWebClientTypes.PortalSummary]?
...
public struct ListTrustStoreCertificatesOutputResponse: Swift.Equatable {
    ...
    var certificateList: [WorkSpacesWebClientTypes.CertificateSummary]?
    /// The pagination token used to retrieve the next page of results for this operation.>
    var nextToken: Swift.String?
    /// The ARN of the trust store.
    var trustStoreArn: Swift.String?
...
public struct ListTrustStoresOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// The trust stores.
    var trustStores: [WorkSpacesWebClientTypes.TrustStoreSummary]?
...
public struct ListUserSettingsOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// The user settings.
    var userSettings: [WorkSpacesWebClientTypes.UserSettingsSummary]?
...
extension WorkSpacesWebClientTypes {
    ...
    public struct Portal: Swift.Equatable {
        ...
        var browserType: WorkSpacesWebClientTypes.BrowserType?
        ...
        var portalStatus: WorkSpacesWebClientTypes.PortalStatus?
        /// The renderer that is used in streaming sessions.
        var rendererType: WorkSpacesWebClientTypes.RendererType?
...
public struct UpdateTrustStoreInput: Swift.Equatable {
    ...
    var certificatesToAdd: [ClientRuntime.Data]?
    /// A list of CA certificates to delete from a trust store.
    var certificatesToDelete: [Swift.String]?
    /// A unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Idempotency ensures that an API request completes only once. With an idempotent request, if the original request completes successfully, subsequent retries with the same client token return the result from the original successful request. If you do not specify a client token, one is automatically generated by the AWS SDK.
    var clientToken: Swift.String?
    /// The ARN of the trust store.
    /// This member is required.
