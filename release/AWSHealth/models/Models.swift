...
extension HealthClientTypes {
    ...
    public struct DateTimeRange: Swift.Equatable {
        ...
        var from: ClientRuntime.Date?
        /// The ending date and time of a time range.
        var to: ClientRuntime.Date?
...
public struct DescribeAffectedAccountsForOrganizationOutputResponse: Swift.Equatable {
    ...
    var affectedAccounts: [Swift.String]?
    ...
    var eventScopeCode: HealthClientTypes.EventScopeCode?
    /// If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
    var nextToken: Swift.String?
...
public struct DescribeAffectedEntitiesForOrganizationInput: Swift.Equatable {
    ...
    /// This member is required.
    var organizationEntityFilters: [HealthClientTypes.EventAccountFilter]?
...
public struct DescribeAffectedEntitiesForOrganizationOutputResponse: Swift.Equatable {
    ...
    var entities: [HealthClientTypes.AffectedEntity]?
    /// A JSON set of elements of the failed response, including the awsAccountId, errorMessage, errorName, and eventArn.
    var failedSet: [HealthClientTypes.OrganizationAffectedEntitiesErrorItem]?
    /// If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
    var nextToken: Swift.String?
...
public struct DescribeAffectedEntitiesInput: Swift.Equatable {
    ...
    /// This member is required.
    var filter: HealthClientTypes.EntityFilter?
    /// The locale (language) to return information in. English (en) is the default and the only supported value at this time.
    var locale: Swift.String?
    /// The maximum number of items to return in one batch, between 10 and 100, inclusive.
    var maxResults: Swift.Int?
...
public struct DescribeEntityAggregatesOutputResponse: Swift.Equatable {
    ...
    var entityAggregates: [HealthClientTypes.EntityAggregate]?
...
public struct DescribeEventAggregatesInput: Swift.Equatable {
    ...
    /// This member is required.
    var aggregateField: HealthClientTypes.EventAggregateField?
    /// Values to narrow the results returned.
    var filter: HealthClientTypes.EventFilter?
    /// The maximum number of items to return in one batch, between 10 and 100, inclusive.
    var maxResults: Swift.Int?
    /// If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
    var nextToken: Swift.String?
...
public struct DescribeEventAggregatesOutputResponse: Swift.Equatable {
    ...
    var eventAggregates: [HealthClientTypes.EventAggregate]?
    /// If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
    var nextToken: Swift.String?
...
public struct DescribeEventDetailsForOrganizationInput: Swift.Equatable {
    ...
    /// This member is required.
    var organizationEventDetailFilters: [HealthClientTypes.EventAccountFilter]?
...
public struct DescribeEventDetailsForOrganizationOutputResponse: Swift.Equatable {
    ...
    var failedSet: [HealthClientTypes.OrganizationEventDetailsErrorItem]?
    /// Information about the events that could be retrieved.
    var successfulSet: [HealthClientTypes.OrganizationEventDetails]?
...
public struct DescribeEventDetailsOutputResponse: Swift.Equatable {
    /// Error messages for any events that could not be retrieved.
    var failedSet: [HealthClientTypes.EventDetailsErrorItem]?
    /// Information about the events that could be retrieved.
    var successfulSet: [HealthClientTypes.EventDetails]?
...
public struct DescribeEventTypesInput: Swift.Equatable {
    /// Values to narrow the results returned.
    var filter: HealthClientTypes.EventTypeFilter?
    /// The locale (language) to return information in. English (en) is the default and the only supported value at this time.
    var locale: Swift.String?
    /// The maximum number of items to return in one batch, between 10 and 100, inclusive.
    var maxResults: Swift.Int?
...
public struct DescribeEventTypesOutputResponse: Swift.Equatable {
    ...
    var eventTypes: [HealthClientTypes.EventType]?
    /// If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
    var nextToken: Swift.String?
...
public struct DescribeEventsForOrganizationInput: Swift.Equatable {
    /// Values to narrow the results returned.
    var filter: HealthClientTypes.OrganizationEventFilter?
    /// The locale (language) to return information in. English (en) is the default and the only supported value at this time.
    var locale: Swift.String?
    /// The maximum number of items to return in one batch, between 10 and 100, inclusive.
    var maxResults: Swift.Int?
...
public struct DescribeEventsForOrganizationOutputResponse: Swift.Equatable {
    ...
    var events: [HealthClientTypes.OrganizationEvent]?
    /// If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
    var nextToken: Swift.String?
...
public struct DescribeEventsOutputResponse: Swift.Equatable {
    /// The events that match the specified filter criteria.
    var events: [HealthClientTypes.Event]?
    /// If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
    var nextToken: Swift.String?
...
public struct DescribeHealthServiceStatusForOrganizationOutputResponse: Swift.Equatable {
    ...
    var healthServiceAccessStatusForOrganization: Swift.String?
...
extension HealthClientTypes {
    ...
    public struct EntityFilter: Swift.Equatable {
        ...
        var entityArns: [Swift.String]?
        /// A list of IDs for affected entities.
        var entityValues: [Swift.String]?
        /// A list of event ARNs (unique identifiers). For example: "arn:aws:health:us-east-1::event/EC2/EC2_INSTANCE_RETIREMENT_SCHEDULED/EC2_INSTANCE_RETIREMENT_SCHEDULED_ABC123-CDE456", "arn:aws:health:us-west-1::event/EBS/AWS_EBS_LOST_VOLUME/AWS_EBS_LOST_VOLUME_CHI789_JKL101"
        /// This member is required.
        var eventArns: [Swift.String]?
        /// A list of the most recent dates and times that the entity was updated.
        var lastUpdatedTimes: [HealthClientTypes.DateTimeRange]?
        /// A list of entity status codes (IMPAIRED, UNIMPAIRED, or UNKNOWN).
        var statusCodes: [HealthClientTypes.EntityStatusCode]?
        /// A map of entity tags attached to the affected entity. Currently, the tags property isn't supported.
        var tags: [[Swift.String:Swift.String]]?
...
extension HealthClientTypes {
    ...
    public struct Event: Swift.Equatable {
        ...
        var eventTypeCategory: HealthClientTypes.EventTypeCategory?
        /// The unique identifier for the event type. The format is AWS_SERVICE_DESCRIPTION ; for example, AWS_EC2_SYSTEM_MAINTENANCE_EVENT.
        var eventTypeCode: Swift.String?
        ...
        var statusCode: HealthClientTypes.EventStatusCode?
...
extension HealthClientTypes {
    ...
    public struct EventAggregate: Swift.Equatable {
        ...
        var aggregateValue: Swift.String?
...
extension HealthClientTypes {
    ...
    public struct EventDescription: Swift.Equatable {
        ...
        var latestDescription: Swift.String?
...
extension HealthClientTypes {
    ...
    public struct EventDetails: Swift.Equatable {
        ...
        var event: HealthClientTypes.Event?
        /// The most recent description of the event.
        var eventDescription: HealthClientTypes.EventDescription?
        /// Additional metadata about the event.
        var eventMetadata: [Swift.String:Swift.String]?
...
extension HealthClientTypes {
    ...
    public struct EventFilter: Swift.Equatable {
        ...
        var endTimes: [HealthClientTypes.DateTimeRange]?
        /// A list of entity ARNs (unique identifiers).
        var entityArns: [Swift.String]?
        ...
        var eventStatusCodes: [HealthClientTypes.EventStatusCode]?
        /// A list of event type category codes. Possible values are issue, accountNotification, or scheduledChange. Currently, the investigation value isn't supported at this time.
        var eventTypeCategories: [HealthClientTypes.EventTypeCategory]?
        /// A list of unique identifiers for event types. For example, "AWS_EC2_SYSTEM_MAINTENANCE_EVENT","AWS_RDS_MAINTENANCE_SCHEDULED".
        var eventTypeCodes: [Swift.String]?
        /// A list of dates and times that the event was last updated.
        var lastUpdatedTimes: [HealthClientTypes.DateTimeRange]?
        /// A list of Amazon Web Services Regions.
        var regions: [Swift.String]?
        /// The Amazon Web Services services associated with the event. For example, EC2, RDS.
        var services: [Swift.String]?
        /// A list of dates and times that the event began.
        var startTimes: [HealthClientTypes.DateTimeRange]?
        /// A map of entity tags attached to the affected entity. Currently, the tags property isn't supported.
        var tags: [[Swift.String:Swift.String]]?
...
extension HealthClientTypes {
    ...
    public struct EventType: Swift.Equatable {
        /// A list of event type category codes. Possible values are issue, accountNotification, or scheduledChange. Currently, the investigation value isn't supported at this time.
        var category: HealthClientTypes.EventTypeCategory?
        /// The unique identifier for the event type. The format is AWS_SERVICE_DESCRIPTION ; for example, AWS_EC2_SYSTEM_MAINTENANCE_EVENT.
...
extension HealthClientTypes {
    ...
    public struct OrganizationEventFilter: Swift.Equatable {
        ...
        /// A range of dates and times that is used by the [EventFilter](https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html) and [EntityFilter](https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html) objects. If from is set and to is set: match items where the timestamp (startTime, endTime, or lastUpdatedTime) is between from and to inclusive. If from is set and to is not set: match items where the timestamp value is equal to or after from. If from is not set and to is set: match items where the timestamp value is equal to or before to.
        var endTime: HealthClientTypes.DateTimeRange?
        /// A list of entity ARNs (unique identifiers).
        var entityArns: [Swift.String]?
        /// A list of entity identifiers, such as EC2 instance IDs (i-34ab692e) or EBS volumes (vol-426ab23e).
        var entityValues: [Swift.String]?
        ...
        var eventTypeCodes: [Swift.String]?
        /// A range of dates and times that is used by the [EventFilter](https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html) and [EntityFilter](https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html) objects. If from is set and to is set: match items where the timestamp (startTime, endTime, or lastUpdatedTime) is between from and to inclusive. If from is set and to is not set: match items where the timestamp value is equal to or after from. If from is not set and to is set: match items where the timestamp value is equal to or before to.
        var lastUpdatedTime: HealthClientTypes.DateTimeRange?
        /// A list of Amazon Web Services Regions.
        var regions: [Swift.String]?
        /// The Amazon Web Services services associated with the event. For example, EC2, RDS.
        var services: [Swift.String]?
        /// A range of dates and times that is used by the [EventFilter](https://docs.aws.amazon.com/health/latest/APIReference/API_EventFilter.html) and [EntityFilter](https://docs.aws.amazon.com/health/latest/APIReference/API_EntityFilter.html) objects. If from is set and to is set: match items where the timestamp (startTime, endTime, or lastUpdatedTime) is between from and to inclusive. If from is set and to is not set: match items where the timestamp value is equal to or after from. If from is not set and to is set: match items where the timestamp value is equal to or before to.
        var startTime: HealthClientTypes.DateTimeRange?
