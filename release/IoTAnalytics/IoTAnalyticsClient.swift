...
public class IoTAnalyticsClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try IoTAnalyticsClientConfiguration(region: unwrappedRegion)
    ...
    public class IoTAnalyticsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("IoTAnalyticsClient")
