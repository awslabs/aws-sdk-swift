...
public class DataExchangeClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try DataExchangeClientConfiguration(region: unwrappedRegion)
    ...
    public class DataExchangeClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("DataExchangeClient")
...
public struct DataExchangeClientLogHandlerFactory: SDKLogHandlerFactory {
