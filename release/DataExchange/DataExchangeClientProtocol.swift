...
public protocol DataExchangeClientProtocol {
    ...
    func createRevision(input: CreateRevisionInput, completion: @escaping (SdkResult<CreateRevisionOutput, CreateRevisionOutputError>) -> Void)
    ...
    func deleteRevision(input: DeleteRevisionInput, completion: @escaping (SdkResult<DeleteRevisionOutput, DeleteRevisionOutputError>) -> Void)
    /// <p>This operation returns information about an asset.</p>
    func getAsset(input: GetAssetInput, completion: @escaping (SdkResult<GetAssetOutput, GetAssetOutputError>) -> Void)
    /// <p>This operation returns information about a data set.</p>
    func getDataSet(input: GetDataSetInput, completion: @escaping (SdkResult<GetDataSetOutput, GetDataSetOutputError>) -> Void)
    ...
    func listDataSetRevisions(input: ListDataSetRevisionsInput, completion: @escaping (SdkResult<ListDataSetRevisionsOutput, ListDataSetRevisionsOutputError>) -> Void)
    ...
    func listRevisionAssets(input: ListRevisionAssetsInput, completion: @escaping (SdkResult<ListRevisionAssetsOutput, ListRevisionAssetsOutputError>) -> Void)
    ...
    func updateAsset(input: UpdateAssetInput, completion: @escaping (SdkResult<UpdateAssetOutput, UpdateAssetOutputError>) -> Void)
    ...
    func updateRevision(input: UpdateRevisionInput, completion: @escaping (SdkResult<UpdateRevisionOutput, UpdateRevisionOutputError>) -> Void)
}
