...
extension OutpostsClientTypes {
    ...
    public struct Address: Swift.Equatable {
        ...
        var contactPhoneNumber: Swift.String?
        /// The ISO-3166 two-letter country code for the address.
        /// This member is required.
        var countryCode: Swift.String?
        /// The district or county for the address.
        var districtOrCounty: Swift.String?
        ...
        /// This member is required.
        var stateOrRegion: Swift.String?
...
extension OutpostsClientTypes {
    ...
    public struct CatalogItem: Swift.Equatable {
        ...
        var catalogItemId: Swift.String?
        /// Information about the EC2 capacity of an item.
        var eC2Capacities: [OutpostsClientTypes.EC2Capacity]?
        /// The status of a catalog item.
        var itemStatus: OutpostsClientTypes.CatalogItemStatus?
        /// Information about the power draw of an item.
        var powerKva: Swift.Float?
        /// The supported storage options for the catalog item.
        var supportedStorage: [OutpostsClientTypes.SupportedStorageEnum]?
        /// The uplink speed this catalog item requires for the connection to the Region.
        var supportedUplinkGbps: [Swift.Int]?
        /// The weight of the item in pounds.
        var weightLbs: Swift.Int?
...
public struct CreateOrderInput: Swift.Equatable {
    ...
    /// This member is required.
    var lineItems: [OutpostsClientTypes.LineItemRequest]?
    /// The ID or the Amazon Resource Name (ARN) of the Outpost.
    /// This member is required.
    var outpostIdentifier: Swift.String?
    /// The payment option for the order.
    /// This member is required.
    var paymentOption: OutpostsClientTypes.PaymentOption?
    /// The payment terms for the order.
    var paymentTerm: OutpostsClientTypes.PaymentTerm?
...
public struct CreateOrderOutputResponse: Swift.Equatable {
    ...
    var order: OutpostsClientTypes.Order?
...
public struct CreateOutpostInput: Swift.Equatable {
    ...
    var availabilityZoneId: Swift.String?
    ...
    /// This member is required.
    var siteId: Swift.String?
    /// The type of hardware for this Outpost.
    var supportedHardwareType: OutpostsClientTypes.SupportedHardwareType?
...
public struct CreateOutpostOutputResponse: Swift.Equatable {
    ...
    var outpost: OutpostsClientTypes.Outpost?
...
public struct CreateSiteInput: Swift.Equatable {
    ...
    var operatingAddress: OutpostsClientTypes.Address?
    ...
    var rackPhysicalProperties: OutpostsClientTypes.RackPhysicalProperties?
    /// The location to ship the hardware. This address might be different from the operating address.
    var shippingAddress: OutpostsClientTypes.Address?
...
public struct CreateSiteOutputResponse: Swift.Equatable {
    ...
    var site: OutpostsClientTypes.Site?
...
extension OutpostsClientTypes {
    ...
    public struct EC2Capacity: Swift.Equatable {
        ...
        var maxSize: Swift.String?
        /// The quantity of the EC2 capacity.
        var quantity: Swift.String?
...
public struct GetCatalogItemOutputResponse: Swift.Equatable {
    ...
    var catalogItem: OutpostsClientTypes.CatalogItem?
...
public struct GetOutpostInstanceTypesOutputResponse: Swift.Equatable {
    ...
    var instanceTypes: [OutpostsClientTypes.InstanceTypeItem]?
    /// The pagination token.
    var nextToken: Swift.String?
    /// The Amazon Resource Name (ARN) of the Outpost.
    var outpostArn: Swift.String?
...
public struct GetSiteAddressInput: Swift.Equatable {
    ...
    /// This member is required.
    var addressType: OutpostsClientTypes.AddressType?
    /// The ID or the Amazon Resource Name (ARN) of the site.
    /// This member is required.
    var siteId: Swift.String?
...
public struct GetSiteAddressOutputResponse: Swift.Equatable {
    ...
    var address: OutpostsClientTypes.Address?
...
extension OutpostsClientTypes {
    ...
    public struct LineItem: Swift.Equatable {
        ...
        var lineItemId: Swift.String?
        /// The quantity of the line item.
        var quantity: Swift.Int
        /// The status of the line item.
        var status: OutpostsClientTypes.LineItemStatus?
...
public struct ListCatalogItemsInput: Swift.Equatable {
    ...
    var eC2FamilyFilter: [Swift.String]?
    ...
    var itemClassFilter: [OutpostsClientTypes.CatalogItemClass]?
    /// The maximum page size.
    var maxResults: Swift.Int?
    /// The pagination token.
    var nextToken: Swift.String?
    ...
    var supportedStorageFilter: [OutpostsClientTypes.SupportedStorageEnum]?
...
public struct ListCatalogItemsOutputResponse: Swift.Equatable {
    ...
    var catalogItems: [OutpostsClientTypes.CatalogItem]?
    /// The pagination token.
    var nextToken: Swift.String?
...
public struct ListOrdersInput: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// The ID or the Amazon Resource Name (ARN) of the Outpost.
    var outpostIdentifierFilter: Swift.String?
...
public struct ListOrdersOutputResponse: Swift.Equatable {
    ...
    var orders: [OutpostsClientTypes.OrderSummary]?
...
public struct ListOutpostsInput: Swift.Equatable {
    ...
    var availabilityZoneFilter: [Swift.String]?
    ...
    var availabilityZoneIdFilter: [Swift.String]?
    ...
    var lifeCycleStatusFilter: [Swift.String]?
    /// The maximum page size.
    var maxResults: Swift.Int?
    /// The pagination token.
    var nextToken: Swift.String?
...
public struct ListOutpostsOutputResponse: Swift.Equatable {
    ...
    var outposts: [OutpostsClientTypes.Outpost]?
...
public struct ListSitesOutputResponse: Swift.Equatable {
    ...
    var sites: [OutpostsClientTypes.Site]?
...
extension OutpostsClientTypes {
    ...
    public struct Order: Swift.Equatable {
        ...
        var lineItems: [OutpostsClientTypes.LineItem]?
        /// The fulfillment date of the order.
        var orderFulfilledDate: ClientRuntime.Date?
        /// The ID of the order.
        var orderId: Swift.String?
        /// The submission date for the order.
        var orderSubmissionDate: ClientRuntime.Date?
        ...
        var status: OutpostsClientTypes.OrderStatus?
...
extension OutpostsClientTypes {
    ...
    public struct OrderSummary: Swift.Equatable {
        ...
        var lineItemCountsByStatus: [Swift.String:Swift.Int]?
        ...
        var orderSubmissionDate: ClientRuntime.Date?
        /// The type of order.
        var orderType: OutpostsClientTypes.OrderType?
        /// The ID of the Outpost.
        var outpostId: Swift.String?
        /// The status of the order.
        ///
...
extension OutpostsClientTypes {
    ...
    public struct Outpost: Swift.Equatable {
        ...
        var lifeCycleStatus: Swift.String?
        /// The name of the Outpost.
        var name: Swift.String?
        /// The Amazon Resource Name (ARN) of the Outpost.
        var outpostArn: Swift.String?
...
extension OutpostsClientTypes {
    ...
    public struct RackPhysicalProperties: Swift.Equatable {
        ...
        var fiberOpticCableType: OutpostsClientTypes.FiberOpticCableType?
        /// The maximum rack weight that this site can support. NO_LIMIT is over 2000 lbs (907 kg).
        var maximumSupportedWeightLbs: OutpostsClientTypes.MaximumSupportedWeightLbs?
        ...
        var opticalStandard: OutpostsClientTypes.OpticalStandard?
        /// The power connector for the hardware.
        var powerConnector: OutpostsClientTypes.PowerConnector?
        /// The power draw available at the hardware placement position for the rack.
        var powerDrawKva: OutpostsClientTypes.PowerDrawKva?
        /// The position of the power feed.
        var powerFeedDrop: OutpostsClientTypes.PowerFeedDrop?
        /// The power option that you can provide for hardware.
        var powerPhase: OutpostsClientTypes.PowerPhase?
        /// The number of uplinks each Outpost network device.
        var uplinkCount: OutpostsClientTypes.UplinkCount?
        /// The uplink speed the rack supports for the connection to the Region.
        var uplinkGbps: OutpostsClientTypes.UplinkGbps?
...
extension OutpostsClientTypes {
    ...
    public struct Site: Swift.Equatable {
        ...
        var operatingAddressCity: Swift.String?
        /// The ISO-3166 two-letter country code where the hardware is installed and powered on.
        var operatingAddressCountryCode: Swift.String?
        /// State or region where the hardware is installed and powered on.
        var operatingAddressStateOrRegion: Swift.String?
