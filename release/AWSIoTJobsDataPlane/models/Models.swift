...
extension DescribeJobExecutionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeJobExecutionInput(executionNumber: \(Swift.String(describing: executionNumber)), includeJobDocument: \(Swift.String(describing: includeJobDocument)), jobId: \(Swift.String(describing: jobId)), thingName: \(Swift.String(describing: thingName)))"}
}
...
public struct DescribeJobExecutionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJobExecutionInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeJobExecutionInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeJobExecutionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeJobExecutionOutputError>
}

public struct DescribeJobExecutionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJobExecutionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let thingName = input.thingName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("thingName is nil and needs a value for the path of this operation"))))
        }
        ...
        var urlPath = "/things/\(thingName.urlPercentEncoding())/jobs/\(jobId.urlPercentEncoding())"
...
struct DescribeJobExecutionOutputResponseBody: Swift.Equatable {
    public let execution: IotJobsDataPlaneClientTypes.JobExecution?
}
...
extension GetPendingJobExecutionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetPendingJobExecutionsInput(thingName: \(Swift.String(describing: thingName)))"}
}

extension GetPendingJobExecutionsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetPendingJobExecutionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPendingJobExecutionsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetPendingJobExecutionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetPendingJobExecutionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetPendingJobExecutionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetPendingJobExecutionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetPendingJobExecutionsOutputError>
}

public struct GetPendingJobExecutionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPendingJobExecutionsInputQueryItemMiddleware"
...
public struct GetPendingJobExecutionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPendingJobExecutionsInputURLHostMiddleware"
    ...
    public typealias MInput = GetPendingJobExecutionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetPendingJobExecutionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetPendingJobExecutionsOutputError>
}

public struct GetPendingJobExecutionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPendingJobExecutionsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/things/\(thingName.urlPercentEncoding())/jobs"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension GetPendingJobExecutionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetPendingJobExecutionsOutputResponse(inProgressJobs: \(Swift.String(describing: inProgressJobs)), queuedJobs: \(Swift.String(describing: queuedJobs)))"}
}
...
struct GetPendingJobExecutionsOutputResponseBody: Swift.Equatable {
    public let inProgressJobs: [IotJobsDataPlaneClientTypes.JobExecutionSummary]?
    public let queuedJobs: [IotJobsDataPlaneClientTypes.JobExecutionSummary]?
}
...
extension IotJobsDataPlaneClientTypes.JobExecution: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension IotJobsDataPlaneClientTypes.JobExecution: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobExecution(approximateSecondsBeforeTimedOut: \(Swift.String(describing: approximateSecondsBeforeTimedOut)), executionNumber: \(Swift.String(describing: executionNumber)), jobDocument: \(Swift.String(describing: jobDocument)), jobId: \(Swift.String(describing: jobId)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), queuedAt: \(Swift.String(describing: queuedAt)), startedAt: \(Swift.String(describing: startedAt)), status: \(Swift.String(describing: status)), statusDetails: \(Swift.String(describing: statusDetails)), thingName: \(Swift.String(describing: thingName)), versionNumber: \(Swift.String(describing: versionNumber)))"}
}
...
extension IotJobsDataPlaneClientTypes.JobExecutionState: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case status
        case statusDetails
        case versionNumber
...
extension IotJobsDataPlaneClientTypes.JobExecutionState: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobExecutionState(status: \(Swift.String(describing: status)), statusDetails: \(Swift.String(describing: statusDetails)), versionNumber: \(Swift.String(describing: versionNumber)))"}
}
...
extension IotJobsDataPlaneClientTypes.JobExecutionSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case executionNumber
        case jobId
        case lastUpdatedAt
...
extension IotJobsDataPlaneClientTypes.JobExecutionSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobExecutionSummary(executionNumber: \(Swift.String(describing: executionNumber)), jobId: \(Swift.String(describing: jobId)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), queuedAt: \(Swift.String(describing: queuedAt)), startedAt: \(Swift.String(describing: startedAt)), versionNumber: \(Swift.String(describing: versionNumber)))"}
}
...
public struct StartNextPendingJobExecutionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartNextPendingJobExecutionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartNextPendingJobExecutionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartNextPendingJobExecutionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartNextPendingJobExecutionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartNextPendingJobExecutionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartNextPendingJobExecutionOutputError>
}

extension StartNextPendingJobExecutionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartNextPendingJobExecutionInput(statusDetails: \(Swift.String(describing: statusDetails)), stepTimeoutInMinutes: \(Swift.String(describing: stepTimeoutInMinutes)), thingName: \(Swift.String(describing: thingName)))"}
}

extension StartNextPendingJobExecutionInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case statusDetails
...
public struct StartNextPendingJobExecutionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartNextPendingJobExecutionInputHeadersMiddleware"
...
public struct StartNextPendingJobExecutionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartNextPendingJobExecutionInputQueryItemMiddleware"
...
public struct StartNextPendingJobExecutionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartNextPendingJobExecutionInputURLHostMiddleware"
    ...
    public typealias MInput = StartNextPendingJobExecutionInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartNextPendingJobExecutionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartNextPendingJobExecutionOutputError>
}

public struct StartNextPendingJobExecutionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartNextPendingJobExecutionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/things/\(thingName.urlPercentEncoding())/jobs/$next"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct StartNextPendingJobExecutionInputBody: Swift.Equatable {
    ...
    public let stepTimeoutInMinutes: Swift.Int?
}
...
extension StartNextPendingJobExecutionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartNextPendingJobExecutionOutputResponse(execution: \(Swift.String(describing: execution)))"}
}
...
extension TerminalStateException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TerminalStateException(message: \(Swift.String(describing: message)))"}
}
...
extension ThrottlingException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ThrottlingException(message: \(Swift.String(describing: message)), payload: \(Swift.String(describing: payload)))"}
}
...
public struct UpdateJobExecutionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobExecutionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateJobExecutionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateJobExecutionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateJobExecutionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateJobExecutionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateJobExecutionOutputError>
}

extension UpdateJobExecutionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateJobExecutionInput(executionNumber: \(Swift.String(describing: executionNumber)), expectedVersion: \(Swift.String(describing: expectedVersion)), includeJobDocument: \(Swift.String(describing: includeJobDocument)), includeJobExecutionState: \(Swift.String(describing: includeJobExecutionState)), jobId: \(Swift.String(describing: jobId)), status: \(Swift.String(describing: status)), statusDetails: \(Swift.String(describing: statusDetails)), stepTimeoutInMinutes: \(Swift.String(describing: stepTimeoutInMinutes)), thingName: \(Swift.String(describing: thingName)))"}
}

extension UpdateJobExecutionInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case executionNumber
...
public struct UpdateJobExecutionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobExecutionInputHeadersMiddleware"
...
public struct UpdateJobExecutionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobExecutionInputQueryItemMiddleware"
...
public struct UpdateJobExecutionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobExecutionInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateJobExecutionInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateJobExecutionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateJobExecutionOutputError>
}

public struct UpdateJobExecutionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobExecutionInputURLPathMiddleware"
...
struct UpdateJobExecutionInputBody: Swift.Equatable {
    public let status: IotJobsDataPlaneClientTypes.JobExecutionStatus?
    public let statusDetails: [Swift.String:Swift.String]?
    public let stepTimeoutInMinutes: Swift.Int?
    public let expectedVersion: Swift.Int?
    public let includeJobExecutionState: Swift.Bool?
    public let includeJobDocument: Swift.Bool?
...
extension UpdateJobExecutionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateJobExecutionOutputResponse(executionState: \(Swift.String(describing: executionState)), jobDocument: \(Swift.String(describing: jobDocument)))"}
}
...
struct UpdateJobExecutionOutputResponseBody: Swift.Equatable {
    public let executionState: IotJobsDataPlaneClientTypes.JobExecutionState?
    public let jobDocument: Swift.String?
}
