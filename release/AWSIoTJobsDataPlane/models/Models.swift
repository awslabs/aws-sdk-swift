...
public struct DescribeJobExecutionInput: Swift.Equatable {
    ...
    var executionNumber: Swift.Int?
    /// Optional. When set to true, the response contains the job document. The default is false.
    var includeJobDocument: Swift.Bool?
    /// The unique identifier assigned to this job when it was created.
    /// This member is required.
    var jobId: Swift.String?
    /// The thing name associated with the device the job execution is running on.
    /// This member is required.
    var thingName: Swift.String?
...
public struct DescribeJobExecutionOutputResponse: Swift.Equatable {
    ...
    var execution: IotJobsDataPlaneClientTypes.JobExecution?
...
public struct GetPendingJobExecutionsOutputResponse: Swift.Equatable {
    ...
    var inProgressJobs: [IotJobsDataPlaneClientTypes.JobExecutionSummary]?
    /// A list of JobExecutionSummary objects with status QUEUED.
    var queuedJobs: [IotJobsDataPlaneClientTypes.JobExecutionSummary]?
...
extension IotJobsDataPlaneClientTypes {
    ...
    public struct JobExecution: Swift.Equatable {
        ...
        var approximateSecondsBeforeTimedOut: Swift.Int?
        /// A number that identifies a particular job execution on a particular device. It can be used later in commands that return or update job execution information.
        var executionNumber: Swift.Int?
        /// The content of the job document.
        var jobDocument: Swift.String?
        /// The unique identifier you assigned to this job when it was created.
        var jobId: Swift.String?
        /// The time, in milliseconds since the epoch, when the job execution was last updated.
        var lastUpdatedAt: Swift.Int
        /// The time, in milliseconds since the epoch, when the job execution was enqueued.
        var queuedAt: Swift.Int
        /// The time, in milliseconds since the epoch, when the job execution was started.
        var startedAt: Swift.Int?
        /// The status of the job execution. Can be one of: "QUEUED", "IN_PROGRESS", "FAILED", "SUCCESS", "CANCELED", "REJECTED", or "REMOVED".
        var status: IotJobsDataPlaneClientTypes.JobExecutionStatus?
        /// A collection of name/value pairs that describe the status of the job execution.
        var statusDetails: [Swift.String:Swift.String]?
        /// The name of the thing that is executing the job.
        var thingName: Swift.String?
...
public struct StartNextPendingJobExecutionInput: Swift.Equatable {
    ...
    var stepTimeoutInMinutes: Swift.Int?
...
public struct UpdateJobExecutionInput: Swift.Equatable {
    ...
    var expectedVersion: Swift.Int?
    /// Optional. When set to true, the response contains the job document. The default is false.
    var includeJobDocument: Swift.Bool?
    /// Optional. When included and set to true, the response contains the JobExecutionState data. The default is false.
    var includeJobExecutionState: Swift.Bool?
    /// The unique identifier assigned to this job when it was created.
    /// This member is required.
    var jobId: Swift.String?
...
public struct UpdateJobExecutionOutputResponse: Swift.Equatable {
    ...
    var executionState: IotJobsDataPlaneClientTypes.JobExecutionState?
