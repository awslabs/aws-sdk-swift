...
public class AppflowClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try AppflowClientConfiguration(region: unwrappedRegion)
    ...
    public class AppflowClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("AppflowClient")
