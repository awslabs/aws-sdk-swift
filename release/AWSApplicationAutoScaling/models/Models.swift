...
extension ApplicationAutoScalingClientTypes {
    ...
    ///          For information about the available metrics for a service, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/aws-services-cloudwatch-metrics.html">Amazon Web Services
...
public struct DeleteScalingPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteScalingPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteScalingPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteScalingPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteScalingPolicyOutputError>
}

public struct DeleteScalingPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteScalingPolicyInputURLPathMiddleware"
...
public struct DeleteScheduledActionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteScheduledActionInputURLHostMiddleware"
...
public struct DeregisterScalableTargetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeregisterScalableTargetInputURLHostMiddleware"
    ...
    public typealias MInput = DeregisterScalableTargetInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeregisterScalableTargetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeregisterScalableTargetOutputError>
}

public struct DeregisterScalableTargetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeregisterScalableTargetInputURLPathMiddleware"
...
public struct DescribeScalableTargetsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScalableTargetsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeScalableTargetsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeScalableTargetsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeScalableTargetsOutputError>
}

public struct DescribeScalableTargetsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScalableTargetsInputURLPathMiddleware"
...
public struct DescribeScalingActivitiesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScalingActivitiesInputURLHostMiddleware"
...
public struct DescribeScalingPoliciesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScalingPoliciesInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeScalingPoliciesInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeScalingPoliciesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeScalingPoliciesOutputError>
}

public struct DescribeScalingPoliciesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScalingPoliciesInputURLPathMiddleware"
...
public struct DescribeScheduledActionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScheduledActionsInputURLHostMiddleware"
...
///          call the CloudWatch <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_DescribeAlarms.html">DescribeAlarms on your behalf.
...
/// A per-account resource limit is exceeded. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-limits.html">Application Auto Scaling service quotas.
...
public struct PutScalingPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutScalingPolicyInputURLHostMiddleware"
...
public struct PutScalingPolicyInput: Swift.Equatable {
    ...
    ///         tracking scaling policies and <a href="https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-step-scaling-policies.html">Step scaling policies in the Application Auto Scaling User Guide.
...
public struct PutScheduledActionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutScheduledActionInputURLHostMiddleware"
    ...
    public typealias MInput = PutScheduledActionInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutScheduledActionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutScheduledActionOutputError>
}

public struct PutScheduledActionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutScheduledActionInputURLPathMiddleware"
...
public struct PutScheduledActionInput: Swift.Equatable {
    ...
    ///            For more information and examples, see <a href="https://docs.aws.amazon.com/autoscaling/application/userguide/examples-scheduled-actions.html">Example scheduled actions for Application Auto Scaling in the Application Auto Scaling User Guide.
    ...
    ///          as Etc/GMT+9 or Pacific/Tahiti). For more information, see <a href="https://www.joda.org/joda-time/timezones.html">https://www.joda.org/joda-time/timezones.html.
...
public struct RegisterScalableTargetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterScalableTargetInputURLHostMiddleware"
    ...
    public typealias MInput = RegisterScalableTargetInput
    public typealias MOutput = ClientRuntime.OperationOutput<RegisterScalableTargetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RegisterScalableTargetOutputError>
}

public struct RegisterScalableTargetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterScalableTargetInputURLPathMiddleware"
...
extension ApplicationAutoScalingClientTypes {
    ...
    ///             <a href="https://docs.aws.amazon.com/autoscaling/application/userguide/getting-started.html">Getting started with Application Auto Scaling in the
...
extension ApplicationAutoScalingClientTypes {
    /// Represents a step adjustment for a <a href="https://docs.aws.amazon.com/autoscaling/application/APIReference/API_StepScalingPolicyConfiguration.html">StepScalingPolicyConfiguration. Describes an adjustment based on the difference
