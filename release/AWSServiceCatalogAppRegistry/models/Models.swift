...
public struct AssociateAttributeGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateAttributeGroupInputURLHostMiddleware"
    ...
    public typealias MInput = AssociateAttributeGroupInput
    public typealias MOutput = ClientRuntime.OperationOutput<AssociateAttributeGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AssociateAttributeGroupOutputError>
}

public struct AssociateAttributeGroupInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateAttributeGroupInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let attributeGroup = input.attributeGroup else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("attributeGroup is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/applications/\(application.urlPercentEncoding())/attribute-groups/\(attributeGroup.urlPercentEncoding())"
...
public struct AssociateResourceInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateResourceInputURLHostMiddleware"
    ...
    public typealias MInput = AssociateResourceInput
    public typealias MOutput = ClientRuntime.OperationOutput<AssociateResourceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AssociateResourceOutputError>
}

public struct AssociateResourceInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateResourceInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let resourceType = input.resourceType else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("resourceType is nil and needs a value for the path of this operation"))))
        }
        ...
        var urlPath = "/applications/\(application.urlPercentEncoding())/resources/\(resourceType.rawValue.urlPercentEncoding())/\(resource.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreateAttributeGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAttributeGroupInputURLHostMiddleware"
    ...
    public typealias MInput = CreateAttributeGroupInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateAttributeGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateAttributeGroupOutputError>
}

public struct CreateAttributeGroupInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAttributeGroupInputURLPathMiddleware"
...
public struct DeleteApplicationInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/applications/\(application.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteAttributeGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAttributeGroupInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteAttributeGroupInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteAttributeGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteAttributeGroupOutputError>
}

public struct DeleteAttributeGroupInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAttributeGroupInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/attribute-groups/\(attributeGroup.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DisassociateAttributeGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateAttributeGroupInputURLHostMiddleware"
    ...
    public typealias MInput = DisassociateAttributeGroupInput
    public typealias MOutput = ClientRuntime.OperationOutput<DisassociateAttributeGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisassociateAttributeGroupOutputError>
}

public struct DisassociateAttributeGroupInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateAttributeGroupInputURLPathMiddleware"
...
public struct DisassociateResourceInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateResourceInputURLHostMiddleware"
    ...
    public typealias MInput = DisassociateResourceInput
    public typealias MOutput = ClientRuntime.OperationOutput<DisassociateResourceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisassociateResourceOutputError>
}

public struct DisassociateResourceInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateResourceInputURLPathMiddleware"
...
extension GetApplicationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetApplicationOutputResponse(arn: \(Swift.String(describing: arn)), associatedResourceCount: \(Swift.String(describing: associatedResourceCount)), creationTime: \(Swift.String(describing: creationTime)), description: \(Swift.String(describing: description)), id: \(Swift.String(describing: id)), integrations: \(Swift.String(describing: integrations)), lastUpdateTime: \(Swift.String(describing: lastUpdateTime)), name: \(Swift.String(describing: name)), tags: \(Swift.String(describing: tags)))"}
}
...
struct GetApplicationOutputResponseBody: Swift.Equatable {
    ...
    public let tags: [Swift.String:Swift.String]?
    public let integrations: ServiceCatalogAppRegistryClientTypes.Integrations?
}
...
extension GetAssociatedResourceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAssociatedResourceInput(application: \(Swift.String(describing: application)), resource: \(Swift.String(describing: resource)), resourceType: \(Swift.String(describing: resourceType)))"}
}

extension GetAssociatedResourceInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetAssociatedResourceInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAssociatedResourceInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAssociatedResourceInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAssociatedResourceOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAssociatedResourceInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAssociatedResourceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAssociatedResourceOutputError>
}

public struct GetAssociatedResourceInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAssociatedResourceInputQueryItemMiddleware"
...
public struct GetAssociatedResourceInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAssociatedResourceInputURLHostMiddleware"
    ...
    public typealias MInput = GetAssociatedResourceInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAssociatedResourceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAssociatedResourceOutputError>
}

public struct GetAssociatedResourceInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAssociatedResourceInputURLPathMiddleware"
...
extension GetAssociatedResourceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAssociatedResourceOutputResponse(resource: \(Swift.String(describing: resource)))"}
}
...
struct GetAssociatedResourceOutputResponseBody: Swift.Equatable {
    public let resource: ServiceCatalogAppRegistryClientTypes.Resource?
}
...
public struct GetAttributeGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAttributeGroupInputURLHostMiddleware"
    ...
    public typealias MInput = GetAttributeGroupInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAttributeGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAttributeGroupOutputError>
}

public struct GetAttributeGroupInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAttributeGroupInputURLPathMiddleware"
...
extension ServiceCatalogAppRegistryClientTypes.Integrations: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case resourceGroup
    }
...
extension ServiceCatalogAppRegistryClientTypes.Integrations: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Integrations(resourceGroup: \(Swift.String(describing: resourceGroup)))"}
}
...
public struct ListAssociatedAttributeGroupsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAssociatedAttributeGroupsInputURLHostMiddleware"
    ...
    public typealias MInput = ListAssociatedAttributeGroupsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListAssociatedAttributeGroupsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAssociatedAttributeGroupsOutputError>
}

public struct ListAssociatedAttributeGroupsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAssociatedAttributeGroupsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/applications/\(application.urlPercentEncoding())/attribute-groups"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListAssociatedResourcesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAssociatedResourcesInputURLHostMiddleware"
    ...
    public typealias MInput = ListAssociatedResourcesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListAssociatedResourcesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAssociatedResourcesOutputError>
}

public struct ListAssociatedResourcesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAssociatedResourcesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/applications/\(application.urlPercentEncoding())/resources"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListAttributeGroupsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAttributeGroupsInputURLHostMiddleware"
    ...
    public typealias MInput = ListAttributeGroupsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListAttributeGroupsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAttributeGroupsOutputError>
}

public struct ListAttributeGroupsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAttributeGroupsInputURLPathMiddleware"
...
extension ServiceCatalogAppRegistryClientTypes.Resource: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
...
extension ServiceCatalogAppRegistryClientTypes.Resource: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Resource(arn: \(Swift.String(describing: arn)), associationTime: \(Swift.String(describing: associationTime)), integrations: \(Swift.String(describing: integrations)), name: \(Swift.String(describing: name)))"}
}
...
extension ServiceCatalogAppRegistryClientTypes.ResourceGroup: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
        case errorMessage
        case state
...
extension ServiceCatalogAppRegistryClientTypes.ResourceGroup: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceGroup(arn: \(Swift.String(describing: arn)), errorMessage: \(Swift.String(describing: errorMessage)), state: \(Swift.String(describing: state)))"}
}
...
extension ServiceCatalogAppRegistryClientTypes.ResourceIntegrations: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case resourceGroup
    }
...
extension ServiceCatalogAppRegistryClientTypes.ResourceIntegrations: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceIntegrations(resourceGroup: \(Swift.String(describing: resourceGroup)))"}
}
...
public struct SyncResourceInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SyncResourceInputURLHostMiddleware"
    ...
    public typealias MInput = SyncResourceInput
    public typealias MOutput = ClientRuntime.OperationOutput<SyncResourceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SyncResourceOutputError>
}

public struct SyncResourceInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SyncResourceInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/sync/\(resourceType.rawValue.urlPercentEncoding())/\(resource.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdateAttributeGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateAttributeGroupInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateAttributeGroupInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateAttributeGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateAttributeGroupOutputError>
}

public struct UpdateAttributeGroupInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateAttributeGroupInputURLPathMiddleware"
