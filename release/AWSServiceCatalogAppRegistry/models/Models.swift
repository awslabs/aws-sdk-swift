...
public struct AssociateAttributeGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var attributeGroup: Swift.String?
...
public struct AssociateAttributeGroupOutputResponse: Swift.Equatable {
    ...
    var attributeGroupArn: Swift.String?
...
public struct AssociateResourceInput: Swift.Equatable {
    ...
    /// This member is required.
    var resourceType: ServiceCatalogAppRegistryClientTypes.ResourceType?
...
public struct CreateApplicationOutputResponse: Swift.Equatable {
    ...
    var application: ServiceCatalogAppRegistryClientTypes.Application?
...
public struct CreateAttributeGroupOutputResponse: Swift.Equatable {
    ...
    var attributeGroup: ServiceCatalogAppRegistryClientTypes.AttributeGroup?
...
public struct DeleteApplicationOutputResponse: Swift.Equatable {
    ...
    var application: ServiceCatalogAppRegistryClientTypes.ApplicationSummary?
...
public struct DeleteAttributeGroupOutputResponse: Swift.Equatable {
    ...
    var attributeGroup: ServiceCatalogAppRegistryClientTypes.AttributeGroupSummary?
...
public struct GetApplicationOutputResponse: Swift.Equatable {
    ...
    var associatedResourceCount: Swift.Int
    /// The ISO-8601 formatted timestamp of the moment when the application was created.
    var creationTime: ClientRuntime.Date?
    /// The description of the application.
    var description: Swift.String?
    ...
    var integrations: ServiceCatalogAppRegistryClientTypes.Integrations?
    /// The ISO-8601 formatted timestamp of the moment when the application was last updated.
    var lastUpdateTime: ClientRuntime.Date?
    /// The name of the application. The name must be unique in the region in which you are creating the application.
    var name: Swift.String?
...
public struct GetAssociatedResourceOutputResponse: Swift.Equatable {
    ...
    var resource: ServiceCatalogAppRegistryClientTypes.Resource?
...
extension ServiceCatalogAppRegistryClientTypes {
    ...
    public struct Integrations: Swift.Equatable {
        ...
        var resourceGroup: ServiceCatalogAppRegistryClientTypes.ResourceGroup?
...
public struct ListApplicationsOutputResponse: Swift.Equatable {
    ...
    var applications: [ServiceCatalogAppRegistryClientTypes.ApplicationSummary]?
    /// The token to use to get the next page of results after a previous API call.
    var nextToken: Swift.String?
...
public struct ListAssociatedAttributeGroupsOutputResponse: Swift.Equatable {
    ...
    var attributeGroups: [Swift.String]?
    /// The token to use to get the next page of results after a previous API call.
    var nextToken: Swift.String?
...
public struct ListAssociatedResourcesOutputResponse: Swift.Equatable {
    ...
    var resources: [ServiceCatalogAppRegistryClientTypes.ResourceInfo]?
...
public struct ListAttributeGroupsOutputResponse: Swift.Equatable {
    ...
    var attributeGroups: [ServiceCatalogAppRegistryClientTypes.AttributeGroupSummary]?
    /// The token to use to get the next page of results after a previous API call.
    var nextToken: Swift.String?
...
extension ServiceCatalogAppRegistryClientTypes {
    ...
    public struct Resource: Swift.Equatable {
        ...
        var integrations: ServiceCatalogAppRegistryClientTypes.ResourceIntegrations?
...
extension ServiceCatalogAppRegistryClientTypes {
    ...
    public struct ResourceGroup: Swift.Equatable {
        ...
        var state: ServiceCatalogAppRegistryClientTypes.ResourceGroupState?
...
public struct SyncResourceOutputResponse: Swift.Equatable {
    ...
    var actionTaken: ServiceCatalogAppRegistryClientTypes.SyncAction?
    /// The Amazon resource name (ARN) that specifies the application.
    var applicationArn: Swift.String?
    /// The Amazon resource name (ARN) that specifies the resource.
    var resourceArn: Swift.String?
