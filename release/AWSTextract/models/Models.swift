...
public struct AnalyzeDocumentOutputResponse: Swift.Equatable {
    ...
    var analyzeDocumentModelVersion: Swift.String?
...
public struct AnalyzeExpenseOutputResponse: Swift.Equatable {
    ...
    var expenseDocuments: [TextractClientTypes.ExpenseDocument]?
...
extension TextractClientTypes {
    ...
    public struct AnalyzeIDDetections: Swift.Equatable {
        ...
        var confidence: Swift.Float?
        /// Only returned for dates, returns the type of value detected and the date written in a more machine readable way.
        var normalizedValue: TextractClientTypes.NormalizedValue?
...
public struct AnalyzeIDInput: Swift.Equatable {
    ...
    /// This member is required.
    var documentPages: [TextractClientTypes.Document]?
...
public struct AnalyzeIDOutputResponse: Swift.Equatable {
    ...
    var analyzeIDModelVersion: Swift.String?
    /// Information about the input document.
    var documentMetadata: TextractClientTypes.DocumentMetadata?
    ...
    var identityDocuments: [TextractClientTypes.IdentityDocument]?
...
extension TextractClientTypes {
    ...
    public struct BoundingBox: Swift.Equatable {
        ...
        var `left`: Swift.Float
        /// The height of the bounding box as a ratio of the overall document page height.
        var height: Swift.Float
        /// The top coordinate of the bounding box as a ratio of overall document page height.
        var top: Swift.Float
        /// The width of the bounding box as a ratio of the overall document page width.
        var width: Swift.Float
...
public struct DetectDocumentTextOutputResponse: Swift.Equatable {
    ...
    var blocks: [TextractClientTypes.Block]?
    ///
    var detectDocumentTextModelVersion: Swift.String?
...
extension TextractClientTypes {
    ...
    public struct ExpenseDocument: Swift.Equatable {
        ...
        var expenseIndex: Swift.Int?
        /// Information detected on each table of a document, seperated into LineItems.
        var lineItemGroups: [TextractClientTypes.LineItemGroup]?
        /// Any information found outside of a table by Amazon Textract.
        var summaryFields: [TextractClientTypes.ExpenseField]?
...
extension TextractClientTypes {
    ...
    public struct ExpenseField: Swift.Equatable {
        ...
        var labelDetection: TextractClientTypes.ExpenseDetection?
        /// The page number the value was detected on.
        var pageNumber: Swift.Int?
        /// The implied label of a detected element. Present alongside LabelDetection for explicit elements.
        var type: TextractClientTypes.ExpenseType?
        /// The value of a detected element. Present in explicit and implicit elements.
        var valueDetection: TextractClientTypes.ExpenseDetection?
...
public struct GetExpenseAnalysisOutputResponse: Swift.Equatable {
    ...
    var analyzeExpenseModelVersion: Swift.String?
...
extension TextractClientTypes {
    ...
    public struct HumanLoopActivationOutput: Swift.Equatable {
        ...
        var humanLoopActivationConditionsEvaluationResults: Swift.String?
        /// Shows if and why human review was needed.
        var humanLoopActivationReasons: [Swift.String]?
...
extension TextractClientTypes {
    ...
    public struct IdentityDocument: Swift.Equatable {
        ...
        var documentIndex: Swift.Int?
        /// The structure used to record information extracted from identity documents. Contains both normalized field and value of the extracted text.
        var identityDocumentFields: [TextractClientTypes.IdentityDocumentField]?
...
extension TextractClientTypes {
    ...
    public struct IdentityDocumentField: Swift.Equatable {
        /// Used to contain the information detected by an AnalyzeID operation.
        var type: TextractClientTypes.AnalyzeIDDetections?
        /// Used to contain the information detected by an AnalyzeID operation.
        var valueDetection: TextractClientTypes.AnalyzeIDDetections?
...
extension TextractClientTypes {
    ...
    public struct LineItemFields: Swift.Equatable {
        ...
        var lineItemExpenseFields: [TextractClientTypes.ExpenseField]?
...
extension TextractClientTypes {
    ...
    public struct LineItemGroup: Swift.Equatable {
        ...
        var lineItemGroupIndex: Swift.Int?
        /// The breakdown of information on a particular line of a table.
        var lineItems: [TextractClientTypes.LineItemFields]?
...
extension TextractClientTypes {
    ...
    public struct NormalizedValue: Swift.Equatable {
        ...
        var valueType: TextractClientTypes.ValueType?
...
public struct StartDocumentAnalysisInput: Swift.Equatable {
    ...
    /// This member is required.
    var documentLocation: TextractClientTypes.DocumentLocation?
    /// A list of the types of analysis to perform. Add TABLES to the list to return information about the tables that are detected in the input document. Add FORMS to return detected form data. To perform both types of analysis, add TABLES and FORMS to FeatureTypes. All lines and words detected in the document are included in the response (including text that isn't related to the value of FeatureTypes).
    /// This member is required.
    var featureTypes: [TextractClientTypes.FeatureType]?
    /// An identifier that you specify that's included in the completion notification published to the Amazon SNS topic. For example, you can use JobTag to identify the type of document that the completion notification corresponds to (such as a tax form or a receipt).
    var jobTag: Swift.String?
    /// The KMS key used to encrypt the inference results. This can be in either Key ID or Key Alias format. When a KMS key is provided, the KMS key will be used for server-side encryption of the objects in the customer bucket. When this parameter is not enabled, the result will be encrypted server side,using SSE-S3.
    var kMSKeyId: Swift.String?
    /// The Amazon SNS topic ARN that you want Amazon Textract to publish the completion status of the operation to.
    var notificationChannel: TextractClientTypes.NotificationChannel?
    /// Sets if the output will go to a customer defined bucket. By default, Amazon Textract will save the results internally to be accessed by the GetDocumentAnalysis operation.
    var outputConfig: TextractClientTypes.OutputConfig?
