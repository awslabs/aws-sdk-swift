...
extension TextractClientTypes.AnalyzeIDDetections: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TextractClientTypes.AnalyzeIDDetections: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AnalyzeIDDetections(confidence: \(Swift.String(describing: confidence)), normalizedValue: \(Swift.String(describing: normalizedValue)), text: \(Swift.String(describing: text)))"}
}
...
public struct AnalyzeIDInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AnalyzeIDInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<AnalyzeIDInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<AnalyzeIDOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<AnalyzeIDInput>
    public typealias MOutput = ClientRuntime.OperationOutput<AnalyzeIDOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AnalyzeIDOutputError>
}

extension AnalyzeIDInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AnalyzeIDInput(documentPages: \(Swift.String(describing: documentPages)))"}
}

extension AnalyzeIDInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct AnalyzeIDInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AnalyzeIDInputHeadersMiddleware"
...
public struct AnalyzeIDInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AnalyzeIDInputQueryItemMiddleware"
...
public struct AnalyzeIDInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AnalyzeIDInputURLHostMiddleware"
    ...
    public typealias MInput = AnalyzeIDInput
    public typealias MOutput = ClientRuntime.OperationOutput<AnalyzeIDOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AnalyzeIDOutputError>
}

public struct AnalyzeIDInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AnalyzeIDInputURLPathMiddleware"
...
struct AnalyzeIDInputBody: Swift.Equatable {
    public let documentPages: [TextractClientTypes.Document]?
}
...
extension AnalyzeIDOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AnalyzeIDOutputResponse(analyzeIDModelVersion: \(Swift.String(describing: analyzeIDModelVersion)), documentMetadata: \(Swift.String(describing: documentMetadata)), identityDocuments: \(Swift.String(describing: identityDocuments)))"}
}
...
struct AnalyzeIDOutputResponseBody: Swift.Equatable {
    public let identityDocuments: [TextractClientTypes.IdentityDocument]?
    public let documentMetadata: TextractClientTypes.DocumentMetadata?
    public let analyzeIDModelVersion: Swift.String?
}
...
public struct GetExpenseAnalysisInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetExpenseAnalysisInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetExpenseAnalysisInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetExpenseAnalysisOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetExpenseAnalysisInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetExpenseAnalysisOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetExpenseAnalysisOutputError>
}

extension GetExpenseAnalysisInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetExpenseAnalysisInput(jobId: \(Swift.String(describing: jobId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension GetExpenseAnalysisInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case jobId = "JobId"
        case maxResults = "MaxResults"
        case nextToken = "NextToken"
...
public struct GetExpenseAnalysisInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetExpenseAnalysisInputHeadersMiddleware"
...
public struct GetExpenseAnalysisInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetExpenseAnalysisInputQueryItemMiddleware"
...
public struct GetExpenseAnalysisInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetExpenseAnalysisInputURLHostMiddleware"
    ...
    public typealias MInput = GetExpenseAnalysisInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetExpenseAnalysisOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetExpenseAnalysisOutputError>
}

public struct GetExpenseAnalysisInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetExpenseAnalysisInputURLPathMiddleware"
...
extension GetExpenseAnalysisOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetExpenseAnalysisOutputResponse(analyzeExpenseModelVersion: \(Swift.String(describing: analyzeExpenseModelVersion)), documentMetadata: \(Swift.String(describing: documentMetadata)), expenseDocuments: \(Swift.String(describing: expenseDocuments)), jobStatus: \(Swift.String(describing: jobStatus)), nextToken: \(Swift.String(describing: nextToken)), statusMessage: \(Swift.String(describing: statusMessage)), warnings: \(Swift.String(describing: warnings)))"}
}
...
struct GetExpenseAnalysisOutputResponseBody: Swift.Equatable {
    ...
    public let warnings: [TextractClientTypes.Warning]?
    public let statusMessage: Swift.String?
    public let analyzeExpenseModelVersion: Swift.String?
}
...
extension TextractClientTypes.IdentityDocument: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension TextractClientTypes.IdentityDocument: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IdentityDocument(documentIndex: \(Swift.String(describing: documentIndex)), identityDocumentFields: \(Swift.String(describing: identityDocumentFields)))"}
}
...
extension TextractClientTypes.IdentityDocumentField: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case type = "Type"
        case valueDetection = "ValueDetection"
    }
...
extension TextractClientTypes.IdentityDocumentField: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IdentityDocumentField(type: \(Swift.String(describing: type)), valueDetection: \(Swift.String(describing: valueDetection)))"}
}
...
extension TextractClientTypes.NormalizedValue: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case value = "Value"
...
extension TextractClientTypes.NormalizedValue: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "NormalizedValue(value: \(Swift.String(describing: value)), valueType: \(Swift.String(describing: valueType)))"}
}
...
public struct StartExpenseAnalysisInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartExpenseAnalysisInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartExpenseAnalysisInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartExpenseAnalysisOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartExpenseAnalysisInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartExpenseAnalysisOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartExpenseAnalysisOutputError>
}

extension StartExpenseAnalysisInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartExpenseAnalysisInput(clientRequestToken: \(Swift.String(describing: clientRequestToken)), documentLocation: \(Swift.String(describing: documentLocation)), jobTag: \(Swift.String(describing: jobTag)), kMSKeyId: \(Swift.String(describing: kMSKeyId)), notificationChannel: \(Swift.String(describing: notificationChannel)), outputConfig: \(Swift.String(describing: outputConfig)))"}
}

extension StartExpenseAnalysisInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientRequestToken = "ClientRequestToken"
        case documentLocation = "DocumentLocation"
        case jobTag = "JobTag"
...
public struct StartExpenseAnalysisInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartExpenseAnalysisInputHeadersMiddleware"
...
public struct StartExpenseAnalysisInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartExpenseAnalysisInputQueryItemMiddleware"
...
public struct StartExpenseAnalysisInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartExpenseAnalysisInputURLHostMiddleware"
    ...
    public typealias MInput = StartExpenseAnalysisInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartExpenseAnalysisOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartExpenseAnalysisOutputError>
}

public struct StartExpenseAnalysisInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartExpenseAnalysisInputURLPathMiddleware"
...
extension StartExpenseAnalysisOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartExpenseAnalysisOutputResponse(jobId: \(Swift.String(describing: jobId)))"}
}
