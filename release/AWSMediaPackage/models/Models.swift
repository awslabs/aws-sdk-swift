...
extension MediaPackageClientTypes {
    ...
    public struct Authorization: Swift.Equatable {
        ...
        var cdnIdentifierSecret: Swift.String?
        /// The Amazon Resource Name (ARN) for the IAM role that allows MediaPackage to communicate with AWS Secrets Manager.
        /// This member is required.
        var secretsRoleArn: Swift.String?
...
extension MediaPackageClientTypes {
    ...
    public struct Channel: Swift.Equatable {
        ...
        var egressAccessLogs: MediaPackageClientTypes.EgressAccessLogs?
        /// An HTTP Live Streaming (HLS) ingest resource configuration.
        var hlsIngest: MediaPackageClientTypes.HlsIngest?
        /// The ID of the Channel.
        var id: Swift.String?
        /// Configure ingress access logging.
        var ingressAccessLogs: MediaPackageClientTypes.IngressAccessLogs?
...
extension MediaPackageClientTypes {
    ...
    public struct CmafEncryption: Swift.Equatable {
        ...
        var constantInitializationVector: Swift.String?
        /// Time (in seconds) between each encryption key rotation.
        var keyRotationIntervalSeconds: Swift.Int?
        /// A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
        /// This member is required.
        var spekeKeyProvider: MediaPackageClientTypes.SpekeKeyProvider?
...
extension MediaPackageClientTypes {
    ...
    public struct CmafPackage: Swift.Equatable {
        /// A Common Media Application Format (CMAF) encryption configuration.
        var encryption: MediaPackageClientTypes.CmafEncryption?
        /// A list of HLS manifest configurations
        var hlsManifests: [MediaPackageClientTypes.HlsManifest]?
        /// Duration (in seconds) of each segment. Actual segments will be rounded to the nearest multiple of the source segment duration.
        var segmentDurationSeconds: Swift.Int?
        /// An optional custom string that is prepended to the name of each segment. If not specified, it defaults to the ChannelId.
        var segmentPrefix: Swift.String?
        /// A StreamSelection configuration.
        var streamSelection: MediaPackageClientTypes.StreamSelection?
...
extension MediaPackageClientTypes {
    ...
    public struct CmafPackageCreateOrUpdateParameters: Swift.Equatable {
        ...
        var encryption: MediaPackageClientTypes.CmafEncryption?
        /// A list of HLS manifest configurations
        var hlsManifests: [MediaPackageClientTypes.HlsManifestCreateOrUpdateParameters]?
        /// Duration (in seconds) of each segment. Actual segments will be rounded to the nearest multiple of the source segment duration.
        var segmentDurationSeconds: Swift.Int?
        /// An optional custom string that is prepended to the name of each segment. If not specified, it defaults to the ChannelId.
        var segmentPrefix: Swift.String?
...
public struct CreateHarvestJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var originEndpointId: Swift.String?
    /// Configuration parameters for where in an S3 bucket to place the harvested content
    /// This member is required.
    var s3Destination: MediaPackageClientTypes.S3Destination?
...
public struct CreateHarvestJobOutputResponse: Swift.Equatable {
    ...
    var status: MediaPackageClientTypes.Status?
...
public struct CreateOriginEndpointInput: Swift.Equatable {
    /// CDN Authorization credentials
    var authorization: MediaPackageClientTypes.Authorization?
    ...
    var channelId: Swift.String?
    /// A Common Media Application Format (CMAF) packaging configuration.
    var cmafPackage: MediaPackageClientTypes.CmafPackageCreateOrUpdateParameters?
    /// A Dynamic Adaptive Streaming over HTTP (DASH) packaging configuration.
    var dashPackage: MediaPackageClientTypes.DashPackage?
    /// A short text description of the OriginEndpoint.
    var description: Swift.String?
    /// An HTTP Live Streaming (HLS) packaging configuration.
    var hlsPackage: MediaPackageClientTypes.HlsPackage?
    ...
    var manifestName: Swift.String?
    /// A Microsoft Smooth Streaming (MSS) packaging configuration.
    var mssPackage: MediaPackageClientTypes.MssPackage?
    /// Control whether origination of video is allowed for this OriginEndpoint. If set to ALLOW, the OriginEndpoint may by requested, pursuant to any other form of access control. If set to DENY, the OriginEndpoint may not be requested. This can be helpful for Live to VOD harvesting, or for temporarily disabling origination
    var origination: MediaPackageClientTypes.Origination?
    /// Maximum duration (seconds) of content to retain for startover playback. If not specified, startover playback will be disabled for the OriginEndpoint.
    var startoverWindowSeconds: Swift.Int?
    /// A collection of tags associated with a resource
    var tags: [Swift.String:Swift.String]?
    /// Amount of delay (seconds) to enforce on the playback of live content. If not specified, there will be no time delay in effect for the OriginEndpoint.
    var timeDelaySeconds: Swift.Int?
    /// A list of source IP CIDR blocks that will be allowed to access the OriginEndpoint.
    var whitelist: [Swift.String]?
...
public struct CreateOriginEndpointOutputResponse: Swift.Equatable {
    ...
    var channelId: Swift.String?
    /// A Common Media Application Format (CMAF) packaging configuration.
    var cmafPackage: MediaPackageClientTypes.CmafPackage?
    /// A Dynamic Adaptive Streaming over HTTP (DASH) packaging configuration.
    var dashPackage: MediaPackageClientTypes.DashPackage?
    /// A short text description of the OriginEndpoint.
    var description: Swift.String?
...
extension MediaPackageClientTypes {
    ...
    public struct DashPackage: Swift.Equatable {
        ...
        var adTriggers: [MediaPackageClientTypes.__AdTriggersElement]?
        /// This setting allows the delivery restriction flags on SCTE-35 segmentation descriptors to determine whether a message signals an ad. Choosing "NONE" means no SCTE-35 messages become ads. Choosing "RESTRICTED" means SCTE-35 messages of the types specified in AdTriggers that contain delivery restrictions will be treated as ads. Choosing "UNRESTRICTED" means SCTE-35 messages of the types specified in AdTriggers that do not contain delivery restrictions will be treated as ads. Choosing "BOTH" means all SCTE-35 messages of the types specified in AdTriggers will be treated as ads. Note that Splice Insert messages do not have these flags and are always treated as ads if specified in AdTriggers.
        var adsOnDeliveryRestrictions: MediaPackageClientTypes.AdsOnDeliveryRestrictions?
        /// A Dynamic Adaptive Streaming over HTTP (DASH) encryption configuration.
        var encryption: MediaPackageClientTypes.DashEncryption?
        /// Determines the position of some tags in the Media Presentation Description (MPD). When set to FULL, elements like SegmentTemplate and ContentProtection are included in each Representation. When set to COMPACT, duplicate elements are combined and presented at the AdaptationSet level.
        var manifestLayout: MediaPackageClientTypes.ManifestLayout?
        /// Time window (in seconds) contained in each manifest.
        var manifestWindowSeconds: Swift.Int?
        /// Minimum duration (in seconds) that a player will buffer media before starting the presentation.
        var minBufferTimeSeconds: Swift.Int?
        /// Minimum duration (in seconds) between potential changes to the Dynamic Adaptive Streaming over HTTP (DASH) Media Presentation Description (MPD).
        var minUpdatePeriodSeconds: Swift.Int?
        /// A list of triggers that controls when the outgoing Dynamic Adaptive Streaming over HTTP (DASH) Media Presentation Description (MPD) will be partitioned into multiple periods. If empty, the content will not be partitioned into more than one period. If the list contains "ADS", new periods will be created where the Channel source contains SCTE-35 ad markers.
        var periodTriggers: [MediaPackageClientTypes.__PeriodTriggersElement]?
        /// The Dynamic Adaptive Streaming over HTTP (DASH) profile type. When set to "HBBTV_1_5", HbbTV 1.5 compliant output is enabled.
        var profile: MediaPackageClientTypes.Profile?
        /// Duration (in seconds) of each segment. Actual segments will be rounded to the nearest multiple of the source segment duration.
        var segmentDurationSeconds: Swift.Int?
        /// Determines the type of SegmentTemplate included in the Media Presentation Description (MPD). When set to NUMBER_WITH_TIMELINE, a full timeline is presented in each SegmentTemplate, with $Number$ media URLs. When set to TIME_WITH_TIMELINE, a full timeline is presented in each SegmentTemplate, with $Time$ media URLs. When set to NUMBER_WITH_DURATION, only a duration is included in each SegmentTemplate, with $Number$ media URLs.
        var segmentTemplateFormat: MediaPackageClientTypes.SegmentTemplateFormat?
        /// A StreamSelection configuration.
        var streamSelection: MediaPackageClientTypes.StreamSelection?
        /// Duration (in seconds) to delay live content before presentation.
        var suggestedPresentationDelaySeconds: Swift.Int?
        /// Determines the type of UTCTiming included in the Media Presentation Description (MPD)
        var utcTiming: MediaPackageClientTypes.UtcTiming?
        /// Specifies the value attribute of the UTCTiming field when utcTiming is set to HTTP-ISO or HTTP-HEAD
        var utcTimingUri: Swift.String?
...
extension MediaPackageClientTypes {
    ...
    public struct EncryptionContractConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var presetSpeke20Audio: MediaPackageClientTypes.PresetSpeke20Audio?
        /// A collection of video encryption presets.
        /// This member is required.
        var presetSpeke20Video: MediaPackageClientTypes.PresetSpeke20Video?
...
extension MediaPackageClientTypes {
    ...
    public struct HlsEncryption: Swift.Equatable {
        ...
        var encryptionMethod: MediaPackageClientTypes.EncryptionMethod?
        /// Interval (in seconds) between each encryption key rotation.
        var keyRotationIntervalSeconds: Swift.Int?
        /// When enabled, the EXT-X-KEY tag will be repeated in output manifests.
        var repeatExtXKey: Swift.Bool?
        /// A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
        /// This member is required.
        var spekeKeyProvider: MediaPackageClientTypes.SpekeKeyProvider?
...
extension MediaPackageClientTypes {
    ...
    public struct HlsIngest: Swift.Equatable {
        ...
        var ingestEndpoints: [MediaPackageClientTypes.IngestEndpoint]?
...
extension MediaPackageClientTypes {
    ...
    public struct HlsManifest: Swift.Equatable {
        ...
        var adMarkers: MediaPackageClientTypes.AdMarkers?
        /// The ID of the manifest. The ID must be unique within the OriginEndpoint and it cannot be changed after it is created.
        /// This member is required.
        var id: Swift.String?
        /// When enabled, an I-Frame only stream will be included in the output.
        var includeIframeOnlyStream: Swift.Bool?
        /// An optional short string appended to the end of the OriginEndpoint URL. If not specified, defaults to the manifestName for the OriginEndpoint.
        var manifestName: Swift.String?
        /// The HTTP Live Streaming (HLS) playlist type. When either "EVENT" or "VOD" is specified, a corresponding EXT-X-PLAYLIST-TYPE entry will be included in the media playlist.
        var playlistType: MediaPackageClientTypes.PlaylistType?
        /// Time window (in seconds) contained in each parent manifest.
        var playlistWindowSeconds: Swift.Int?
        /// The interval (in seconds) between each EXT-X-PROGRAM-DATE-TIME tag inserted into manifests. Additionally, when an interval is specified ID3Timed Metadata messages will be generated every 5 seconds using the ingest time of the content. If the interval is not specified, or set to 0, then no EXT-X-PROGRAM-DATE-TIME tags will be inserted into manifests and no ID3Timed Metadata messages will be generated. Note that irrespective of this parameter, if any ID3 Timed Metadata is found in HTTP Live Streaming (HLS) input, it will be passed through to HLS output.
        var programDateTimeIntervalSeconds: Swift.Int?
        /// The URL of the packaged OriginEndpoint for consumption.
        var url: Swift.String?
...
extension MediaPackageClientTypes {
    ...
    public struct HlsPackage: Swift.Equatable {
        ...
        var adsOnDeliveryRestrictions: MediaPackageClientTypes.AdsOnDeliveryRestrictions?
        /// An HTTP Live Streaming (HLS) encryption configuration.
        var encryption: MediaPackageClientTypes.HlsEncryption?
        /// When enabled, MediaPackage passes through digital video broadcasting (DVB) subtitles into the output.
        var includeDvbSubtitles: Swift.Bool?
        /// When enabled, an I-Frame only stream will be included in the output.
        var includeIframeOnlyStream: Swift.Bool?
        /// The HTTP Live Streaming (HLS) playlist type. When either "EVENT" or "VOD" is specified, a corresponding EXT-X-PLAYLIST-TYPE entry will be included in the media playlist.
        var playlistType: MediaPackageClientTypes.PlaylistType?
        ...
        var useAudioRenditionGroup: Swift.Bool?
...
public struct ListChannelsOutputResponse: Swift.Equatable {
    ...
    var channels: [MediaPackageClientTypes.Channel]?
...
public struct ListHarvestJobsInput: Swift.Equatable {
    ...
    var includeChannelId: Swift.String?
    /// When specified, the request will return only HarvestJobs in the given status.
    var includeStatus: Swift.String?
...
public struct ListHarvestJobsOutputResponse: Swift.Equatable {
    ...
    var harvestJobs: [MediaPackageClientTypes.HarvestJob]?
    /// A token that can be used to resume pagination from the end of the collection.
    var nextToken: Swift.String?
...
public struct ListOriginEndpointsOutputResponse: Swift.Equatable {
    ...
    var originEndpoints: [MediaPackageClientTypes.OriginEndpoint]?
...
extension MediaPackageClientTypes {
    ...
    public struct MssPackage: Swift.Equatable {
        /// A Microsoft Smooth Streaming (MSS) encryption configuration.
        var encryption: MediaPackageClientTypes.MssEncryption?
...
public struct RotateIngestEndpointCredentialsInput: Swift.Equatable {
    ...
    /// This member is required.
    var ingestEndpointId: Swift.String?
...
extension MediaPackageClientTypes {
    ...
    public struct SpekeKeyProvider: Swift.Equatable {
        ...
        /// Use encryptionContractConfiguration to configure one or more content encryption keys for your endpoints that use SPEKE 2.0. The encryption contract defines which content keys are used to encrypt the audio and video tracks in your stream. To configure the encryption contract, specify which audio and video encryption presets to use. Note the following considerations when using encryptionContractConfiguration: encryptionContractConfiguration can be used for DASH or CMAF endpoints that use SPEKE 2.0. SPEKE 2.0 relies on the CPIX 2.3 specification. You must disable key rotation for this endpoint by setting keyRotationIntervalSeconds to 0.
        var encryptionContractConfiguration: MediaPackageClientTypes.EncryptionContractConfiguration?
...
extension MediaPackageClientTypes {
    ...
    public struct StreamSelection: Swift.Equatable {
        ...
        var maxVideoBitsPerSecond: Swift.Int?
        /// The minimum video bitrate (bps) to include in output.
        var minVideoBitsPerSecond: Swift.Int?
        /// A directive that determines the order of streams in the output.
        var streamOrder: MediaPackageClientTypes.StreamOrder?
