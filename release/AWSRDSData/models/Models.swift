...
public struct BatchExecuteStatementInput: Swift.Equatable {
    ...
    var parameterSets: [[RdsDataClientTypes.SqlParameter]]?
...
public struct BatchExecuteStatementOutputResponse: Swift.Equatable {
    ...
    var updateResults: [RdsDataClientTypes.UpdateResult]?
...
extension RdsDataClientTypes {
    ...
    public struct ColumnMetadata: Swift.Equatable {
        ...
        var arrayBaseColumnType: Swift.Int
        /// A value that indicates whether the column increments automatically.
        var isAutoIncrement: Swift.Bool
...
public struct CommitTransactionOutputResponse: Swift.Equatable {
    ...
    var transactionStatus: Swift.String?
...
public struct ExecuteSqlInput: Swift.Equatable {
    ...
    /// This member is required.
    var dbClusterOrInstanceArn: Swift.String?
    /// The name of the database schema.
    var schema: Swift.String?
    ...
    /// This member is required.
    var sqlStatements: Swift.String?
...
public struct ExecuteSqlOutputResponse: Swift.Equatable {
    ...
    var sqlStatementResults: [RdsDataClientTypes.SqlStatementResult]?
...
public struct ExecuteStatementInput: Swift.Equatable {
    ...
    var continueAfterTimeout: Swift.Bool
    /// The name of the database.
    var database: Swift.String?
    /// A value that indicates whether to include metadata in the results.
    var includeResultMetadata: Swift.Bool
    /// The parameters for the SQL statement. Array parameters are not supported.
    var parameters: [RdsDataClientTypes.SqlParameter]?
    /// The Amazon Resource Name (ARN) of the Aurora Serverless DB cluster.
    /// This member is required.
    var resourceArn: Swift.String?
    /// Options that control how the result set is returned.
    var resultSetOptions: RdsDataClientTypes.ResultSetOptions?
...
public struct ExecuteStatementOutputResponse: Swift.Equatable {
    ...
    var columnMetadata: [RdsDataClientTypes.ColumnMetadata]?
    ...
    var generatedFields: [RdsDataClientTypes.Field]?
    /// The number of records updated by the request.
    var numberOfRecordsUpdated: Swift.Int
    /// The records returned by the SQL statement.
    var records: [[RdsDataClientTypes.Field]]?
...
extension RdsDataClientTypes {
    ...
    public struct Record: Swift.Equatable {
        ...
        var values: [RdsDataClientTypes.Value]?
...
extension RdsDataClientTypes {
    ...
    public struct ResultFrame: Swift.Equatable {
        ...
        var records: [RdsDataClientTypes.Record]?
        /// The result-set metadata in the result set.
        var resultSetMetadata: RdsDataClientTypes.ResultSetMetadata?
...
extension RdsDataClientTypes {
    ...
    public struct ResultSetOptions: Swift.Equatable {
        ...
        var decimalReturnType: RdsDataClientTypes.DecimalReturnType?
...
extension RdsDataClientTypes {
    ...
    public struct SqlParameter: Swift.Equatable {
        ...
        var typeHint: RdsDataClientTypes.TypeHint?
        /// The value of the parameter.
        var value: RdsDataClientTypes.Field?
...
extension RdsDataClientTypes {
    ...
    public struct SqlStatementResult: Swift.Equatable {
        ...
        var resultFrame: RdsDataClientTypes.ResultFrame?
...
extension RdsDataClientTypes {
    ...
    public struct StructValue: Swift.Equatable {
        ...
        var attributes: [RdsDataClientTypes.Value]?
