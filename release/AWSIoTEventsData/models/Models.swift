...
extension IotEventsDataClientTypes {
    ...
    public struct AcknowledgeAlarmActionRequest: Swift.Equatable {
        ...
        var alarmModelName: Swift.String?
...
extension IotEventsDataClientTypes {
    ...
    public struct Alarm: Swift.Equatable {
        ...
        var alarmModelVersion: Swift.String?
        /// Contains information about the current state of the alarm.
        var alarmState: IotEventsDataClientTypes.AlarmState?
...
extension IotEventsDataClientTypes {
    ...
    public struct AlarmState: Swift.Equatable {
        ...
        var customerAction: IotEventsDataClientTypes.CustomerAction?
        /// Information needed to evaluate data.
        var ruleEvaluation: IotEventsDataClientTypes.RuleEvaluation?
        ...
        var stateName: IotEventsDataClientTypes.AlarmStateName?
        /// Contains information about alarm state changes.
        var systemEvent: IotEventsDataClientTypes.SystemEvent?
...
public struct BatchAcknowledgeAlarmInput: Swift.Equatable {
    ...
    /// This member is required.
    var acknowledgeActionRequests: [IotEventsDataClientTypes.AcknowledgeAlarmActionRequest]?
...
public struct BatchAcknowledgeAlarmOutputResponse: Swift.Equatable {
    ...
    var errorEntries: [IotEventsDataClientTypes.BatchAlarmActionErrorEntry]?
...
extension IotEventsDataClientTypes {
    ...
    public struct BatchAlarmActionErrorEntry: Swift.Equatable {
        /// The error code.
        var errorCode: IotEventsDataClientTypes.ErrorCode?
...
public struct BatchDisableAlarmInput: Swift.Equatable {
    ...
    /// This member is required.
    var disableActionRequests: [IotEventsDataClientTypes.DisableAlarmActionRequest]?
...
public struct BatchEnableAlarmInput: Swift.Equatable {
    ...
    /// This member is required.
    var enableActionRequests: [IotEventsDataClientTypes.EnableAlarmActionRequest]?
...
public struct BatchPutMessageInput: Swift.Equatable {
    ...
    /// This member is required.
    var messages: [IotEventsDataClientTypes.Message]?
...
public struct BatchPutMessageOutputResponse: Swift.Equatable {
    ...
    var batchPutMessageErrorEntries: [IotEventsDataClientTypes.BatchPutMessageErrorEntry]?
...
public struct BatchResetAlarmInput: Swift.Equatable {
    ...
    /// This member is required.
    var resetActionRequests: [IotEventsDataClientTypes.ResetAlarmActionRequest]?
...
public struct BatchSnoozeAlarmInput: Swift.Equatable {
    ...
    /// This member is required.
    var snoozeActionRequests: [IotEventsDataClientTypes.SnoozeAlarmActionRequest]?
...
public struct BatchUpdateDetectorInput: Swift.Equatable {
    ...
    /// This member is required.
    var detectors: [IotEventsDataClientTypes.UpdateDetectorRequest]?
...
public struct BatchUpdateDetectorOutputResponse: Swift.Equatable {
    ...
    var batchUpdateDetectorErrorEntries: [IotEventsDataClientTypes.BatchUpdateDetectorErrorEntry]?
...
extension IotEventsDataClientTypes {
    ...
    public struct CustomerAction: Swift.Equatable {
        /// Contains the configuration information of an acknowledge action.
        var acknowledgeActionConfiguration: IotEventsDataClientTypes.AcknowledgeActionConfiguration?
        ...
        var actionName: IotEventsDataClientTypes.CustomerActionName?
        /// Contains the configuration information of a disable action.
        var disableActionConfiguration: IotEventsDataClientTypes.DisableActionConfiguration?
        /// Contains the configuration information of an enable action.
        var enableActionConfiguration: IotEventsDataClientTypes.EnableActionConfiguration?
        /// Contains the configuration information of a reset action.
        var resetActionConfiguration: IotEventsDataClientTypes.ResetActionConfiguration?
        /// Contains the configuration information of a snooze action.
        var snoozeActionConfiguration: IotEventsDataClientTypes.SnoozeActionConfiguration?
...
public struct DescribeAlarmOutputResponse: Swift.Equatable {
    /// Contains information about an alarm.
    var alarm: IotEventsDataClientTypes.Alarm?
...
public struct DescribeDetectorInput: Swift.Equatable {
    ...
    /// This member is required.
    var detectorModelName: Swift.String?
...
public struct DescribeDetectorOutputResponse: Swift.Equatable {
    ...
    var detector: IotEventsDataClientTypes.Detector?
...
extension IotEventsDataClientTypes {
    ...
    public struct Detector: Swift.Equatable {
        ...
        var detectorModelVersion: Swift.String?
        /// The value of the key (identifying the device or system) that caused the creation of this detector (instance).
        var keyValue: Swift.String?
        /// The time the detector (instance) was last updated.
        var lastUpdateTime: ClientRuntime.Date?
        /// The current state of the detector (instance).
        var state: IotEventsDataClientTypes.DetectorState?
...
extension IotEventsDataClientTypes {
    ...
    public struct DetectorState: Swift.Equatable {
        ...
        /// This member is required.
        var stateName: Swift.String?
        /// The current state of the detector's timers.
        /// This member is required.
        var timers: [IotEventsDataClientTypes.Timer]?
        /// The current values of the detector's variables.
        /// This member is required.
        var variables: [IotEventsDataClientTypes.Variable]?
...
extension IotEventsDataClientTypes {
    ...
    public struct DetectorStateDefinition: Swift.Equatable {
        ...
        /// This member is required.
        var timers: [IotEventsDataClientTypes.TimerDefinition]?
        /// The new values of the detector's variables. Any variable whose value isn't specified is cleared.
        /// This member is required.
        var variables: [IotEventsDataClientTypes.VariableDefinition]?
...
extension IotEventsDataClientTypes {
    ...
    public struct DetectorSummary: Swift.Equatable {
        ...
        var lastUpdateTime: ClientRuntime.Date?
        /// The current state of the detector (instance).
        var state: IotEventsDataClientTypes.DetectorStateSummary?
...
public struct ListAlarmsOutputResponse: Swift.Equatable {
    ...
    var alarmSummaries: [IotEventsDataClientTypes.AlarmSummary]?
...
public struct ListDetectorsOutputResponse: Swift.Equatable {
    ...
    var detectorSummaries: [IotEventsDataClientTypes.DetectorSummary]?
    /// The token that you can use to return the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
extension IotEventsDataClientTypes {
    ...
    public struct Message: Swift.Equatable {
        ...
        var timestamp: IotEventsDataClientTypes.TimestampValue?
...
extension IotEventsDataClientTypes {
    ...
    public struct RuleEvaluation: Swift.Equatable {
        ...
        var simpleRuleEvaluation: IotEventsDataClientTypes.SimpleRuleEvaluation?
...
extension IotEventsDataClientTypes {
    ...
    public struct SimpleRuleEvaluation: Swift.Equatable {
        ...
        var `operator`: IotEventsDataClientTypes.ComparisonOperator?
        /// The value of the input property, on the left side of the comparison operator.
        var inputPropertyValue: Swift.String?
        /// The threshold value, on the right side of the comparison operator.
        var thresholdValue: Swift.String?
...
extension IotEventsDataClientTypes {
    ...
    public struct StateChangeConfiguration: Swift.Equatable {
        ...
        var triggerType: IotEventsDataClientTypes.TriggerType?
...
extension IotEventsDataClientTypes {
    ...
    public struct SystemEvent: Swift.Equatable {
        ...
        var eventType: IotEventsDataClientTypes.EventType?
        /// Contains the configuration information of alarm state changes.
        var stateChangeConfiguration: IotEventsDataClientTypes.StateChangeConfiguration?
...
extension IotEventsDataClientTypes {
    ...
    public struct UpdateDetectorRequest: Swift.Equatable {
        ...
        /// The new state, variable values, and timer settings of the detector (instance).
        /// This member is required.
        var state: IotEventsDataClientTypes.DetectorStateDefinition?
