...
extension IotEventsDataClientTypes {
    ...
    public struct AcknowledgeAlarmActionRequest: Swift.Equatable {
        ...
        /// <a href="https://docs.aws.amazon.com/iotevents/latest/apireference/API_CreateAlarmModel.html#iotevents-CreateAlarmModel-request-key">key.
...
public struct BatchAcknowledgeAlarmInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchAcknowledgeAlarmInputURLHostMiddleware"
    ...
    public typealias MInput = BatchAcknowledgeAlarmInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchAcknowledgeAlarmOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchAcknowledgeAlarmOutputError>
}

public struct BatchAcknowledgeAlarmInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchAcknowledgeAlarmInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/alarms/acknowledge"
...
extension IotEventsDataClientTypes {
    ...
    ///
    ///
    ///                   <a href="https://docs.aws.amazon.com/iotevents/latest/apireference/API_iotevents-data_BatchAcknowledgeAlarm.html">BatchAcknowledgeAlarm
    ///
    ///
    ///
    ///
    ///                   <a href="https://docs.aws.amazon.com/iotevents/latest/apireference/API_iotevents-data_BatchDisableAlarm.html">BatchDisableAlarm
    ///
    ///
    ///
    ///
    ///                   <a href="https://docs.aws.amazon.com/iotevents/latest/apireference/API_iotevents-data_BatchEnableAlarm.html">BatchEnableAlarm
    ///
    ///
    ///
    ///
    ///                   <a href="https://docs.aws.amazon.com/iotevents/latest/apireference/API_iotevents-data_BatchResetAlarm.html">BatchResetAlarm
    ///
    ///
    ///
    ///
    ///                   <a href="https://docs.aws.amazon.com/iotevents/latest/apireference/API_iotevents-data_BatchSnoozeAlarm.html">BatchSnoozeAlarm
    ///
    ///
    ///
...
public struct BatchDisableAlarmInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDisableAlarmInputURLHostMiddleware"
    ...
    public typealias MInput = BatchDisableAlarmInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchDisableAlarmOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchDisableAlarmOutputError>
}

public struct BatchDisableAlarmInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDisableAlarmInputURLPathMiddleware"
...
public struct BatchEnableAlarmInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchEnableAlarmInputURLHostMiddleware"
    ...
    public typealias MInput = BatchEnableAlarmInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchEnableAlarmOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchEnableAlarmOutputError>
}

public struct BatchEnableAlarmInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchEnableAlarmInputURLPathMiddleware"
...
public struct BatchResetAlarmInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchResetAlarmInputURLHostMiddleware"
    ...
    public typealias MInput = BatchResetAlarmInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchResetAlarmOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchResetAlarmOutputError>
}

public struct BatchResetAlarmInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchResetAlarmInputURLPathMiddleware"
...
public struct BatchSnoozeAlarmInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchSnoozeAlarmInputURLHostMiddleware"
    ...
    public typealias MInput = BatchSnoozeAlarmInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchSnoozeAlarmOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchSnoozeAlarmOutputError>
}

public struct BatchSnoozeAlarmInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchSnoozeAlarmInputURLPathMiddleware"
...
public struct BatchUpdateDetectorInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpdateDetectorInputURLHostMiddleware"
    ...
    public typealias MInput = BatchUpdateDetectorInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchUpdateDetectorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchUpdateDetectorOutputError>
}

public struct BatchUpdateDetectorInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpdateDetectorInputURLPathMiddleware"
...
extension IotEventsDataClientTypes {
    ...
    public struct CustomerAction: Swift.Equatable {
        ...
        /// 		
        ///
        ///          For more information, see the <a href="https://docs.aws.amazon.com/iotevents/latest/apireference/API_iotevents-data_AlarmState.html">AlarmState API.
...
public struct DescribeAlarmInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAlarmInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeAlarmInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeAlarmOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeAlarmOutputError>
}

public struct DescribeAlarmInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAlarmInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let alarmModelName = input.alarmModelName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("alarmModelName is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/alarms/\(alarmModelName.urlPercentEncoding())/keyValues"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeDetectorInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        guard let detectorModelName = input.detectorModelName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("detectorModelName is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/detectors/\(detectorModelName.urlPercentEncoding())/keyValues"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListAlarmsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAlarmsInputURLHostMiddleware"
    ...
    public typealias MInput = ListAlarmsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListAlarmsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAlarmsOutputError>
}

public struct ListAlarmsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAlarmsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/alarms/\(alarmModelName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListDetectorsInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/detectors/\(detectorModelName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
