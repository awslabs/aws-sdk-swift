...
public protocol ProtonClientProtocol {
    ...
    func createTemplateSyncConfig(input: CreateTemplateSyncConfigInput, completion: @escaping (ClientRuntime.SdkResult<CreateTemplateSyncConfigOutputResponse, CreateTemplateSyncConfigOutputError>) -> Void)
    ...
    func deleteTemplateSyncConfig(input: DeleteTemplateSyncConfigInput, completion: @escaping (ClientRuntime.SdkResult<DeleteTemplateSyncConfigOutputResponse, DeleteTemplateSyncConfigOutputError>) -> Void)
    ...
    func getRepositorySyncStatus(input: GetRepositorySyncStatusInput, completion: @escaping (ClientRuntime.SdkResult<GetRepositorySyncStatusOutputResponse, GetRepositorySyncStatusOutputError>) -> Void)
    ...
    func getTemplateSyncConfig(input: GetTemplateSyncConfigInput, completion: @escaping (ClientRuntime.SdkResult<GetTemplateSyncConfigOutputResponse, GetTemplateSyncConfigOutputError>) -> Void)
    /// Get the status of a template sync.
    func getTemplateSyncStatus(input: GetTemplateSyncStatusInput, completion: @escaping (ClientRuntime.SdkResult<GetTemplateSyncStatusOutputResponse, GetTemplateSyncStatusOutputError>) -> Void)
    ...
    func listEnvironmentOutputs(input: ListEnvironmentOutputsInput, completion: @escaping (ClientRuntime.SdkResult<ListEnvironmentOutputsOutputResponse, ListEnvironmentOutputsOutputError>) -> Void)
    /// List the provisioned resources for your environment.
    func listEnvironmentProvisionedResources(input: ListEnvironmentProvisionedResourcesInput, completion: @escaping (ClientRuntime.SdkResult<ListEnvironmentProvisionedResourcesOutputResponse, ListEnvironmentProvisionedResourcesOutputError>) -> Void)
    ...
    func listRepositorySyncDefinitions(input: ListRepositorySyncDefinitionsInput, completion: @escaping (ClientRuntime.SdkResult<ListRepositorySyncDefinitionsOutputResponse, ListRepositorySyncDefinitionsOutputError>) -> Void)
    /// View a list service instance infrastructure as code outputs with detail data.
    func listServiceInstanceOutputs(input: ListServiceInstanceOutputsInput, completion: @escaping (ClientRuntime.SdkResult<ListServiceInstanceOutputsOutputResponse, ListServiceInstanceOutputsOutputError>) -> Void)
    /// List provisioned resources for a service instance with details.
    func listServiceInstanceProvisionedResources(input: ListServiceInstanceProvisionedResourcesInput, completion: @escaping (ClientRuntime.SdkResult<ListServiceInstanceProvisionedResourcesOutputResponse, ListServiceInstanceProvisionedResourcesOutputError>) -> Void)
    ...
    func listServicePipelineOutputs(input: ListServicePipelineOutputsInput, completion: @escaping (ClientRuntime.SdkResult<ListServicePipelineOutputsOutputResponse, ListServicePipelineOutputsOutputError>) -> Void)
    /// List provisioned resources for a service and pipeline with details.
    func listServicePipelineProvisionedResources(input: ListServicePipelineProvisionedResourcesInput, completion: @escaping (ClientRuntime.SdkResult<ListServicePipelineProvisionedResourcesOutputResponse, ListServicePipelineProvisionedResourcesOutputError>) -> Void)
    ...
    func notifyResourceDeploymentStatusChange(input: NotifyResourceDeploymentStatusChangeInput, completion: @escaping (ClientRuntime.SdkResult<NotifyResourceDeploymentStatusChangeOutputResponse, NotifyResourceDeploymentStatusChangeOutputError>) -> Void)
    ...
    func updateTemplateSyncConfig(input: UpdateTemplateSyncConfigInput, completion: @escaping (ClientRuntime.SdkResult<UpdateTemplateSyncConfigOutputResponse, UpdateTemplateSyncConfigOutputError>) -> Void)
}
