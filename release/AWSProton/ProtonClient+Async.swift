...
public extension ProtonClient {
    ...
    {
        typealias createTemplateSyncConfigContinuation = CheckedContinuation<CreateTemplateSyncConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createTemplateSyncConfigContinuation) in
            createTemplateSyncConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteTemplateSyncConfigContinuation = CheckedContinuation<DeleteTemplateSyncConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteTemplateSyncConfigContinuation) in
            deleteTemplateSyncConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getRepositorySyncStatusContinuation = CheckedContinuation<GetRepositorySyncStatusOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getRepositorySyncStatusContinuation) in
            getRepositorySyncStatus(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getTemplateSyncConfigContinuation = CheckedContinuation<GetTemplateSyncConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getTemplateSyncConfigContinuation) in
            getTemplateSyncConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getTemplateSyncStatusContinuation = CheckedContinuation<GetTemplateSyncStatusOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getTemplateSyncStatusContinuation) in
            getTemplateSyncStatus(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listEnvironmentOutputsContinuation = CheckedContinuation<ListEnvironmentOutputsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listEnvironmentOutputsContinuation) in
            listEnvironmentOutputs(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listEnvironmentProvisionedResourcesContinuation = CheckedContinuation<ListEnvironmentProvisionedResourcesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listEnvironmentProvisionedResourcesContinuation) in
            listEnvironmentProvisionedResources(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listRepositorySyncDefinitionsContinuation = CheckedContinuation<ListRepositorySyncDefinitionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listRepositorySyncDefinitionsContinuation) in
            listRepositorySyncDefinitions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listServiceInstanceOutputsContinuation = CheckedContinuation<ListServiceInstanceOutputsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listServiceInstanceOutputsContinuation) in
            listServiceInstanceOutputs(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listServiceInstanceProvisionedResourcesContinuation = CheckedContinuation<ListServiceInstanceProvisionedResourcesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listServiceInstanceProvisionedResourcesContinuation) in
            listServiceInstanceProvisionedResources(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listServicePipelineOutputsContinuation = CheckedContinuation<ListServicePipelineOutputsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listServicePipelineOutputsContinuation) in
            listServicePipelineOutputs(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listServicePipelineProvisionedResourcesContinuation = CheckedContinuation<ListServicePipelineProvisionedResourcesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listServicePipelineProvisionedResourcesContinuation) in
            listServicePipelineProvisionedResources(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias notifyResourceDeploymentStatusChangeContinuation = CheckedContinuation<NotifyResourceDeploymentStatusChangeOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: notifyResourceDeploymentStatusChangeContinuation) in
            notifyResourceDeploymentStatusChange(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateTemplateSyncConfigContinuation = CheckedContinuation<UpdateTemplateSyncConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateTemplateSyncConfigContinuation) in
            updateTemplateSyncConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
