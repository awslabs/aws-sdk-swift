...
extension ProtonClientTypes {
    /// Detailed data of an Proton component resource. For more information about components, see [Proton components](https://docs.aws.amazon.com/proton/latest/adminguide/ag-components.html) in the Proton Administrator Guide.
...
extension ProtonClientTypes {
    /// Summary data of an Proton component resource. For more information about components, see [Proton components](https://docs.aws.amazon.com/proton/latest/adminguide/ag-components.html) in the Proton Administrator Guide.
...
public struct CreateEnvironmentAccountConnectionInput: Swift.Equatable {
    ...
    /// An optional list of metadata items that you can associate with the Proton environment account connection. A tag is a key-value pair. For more information, see [Proton resources and tagging](https://docs.aws.amazon.com/proton/latest/adminguide/resources.html) in the Proton Administrator Guide.
    public var tags: [ProtonClientTypes.Tag]?
...
public struct CreateEnvironmentInput: Swift.Equatable {
    ...
    /// A YAML formatted string that provides inputs as defined in the environment template bundle schema file. For more information, see [Environments](https://docs.aws.amazon.com/proton/latest/adminguide/ag-environments.html) in the Proton Administrator Guide.
    /// This member is required.
...
public struct CreateRepositoryInput: Swift.Equatable {
    /// The Amazon Resource Name (ARN) of your Amazon Web Services CodeStar connection. For more information, see [Setting up for Proton](https://docs.aws.amazon.com/proton/latest/adminguide/setting-up-for-service.html) in the Proton Administrator Guide.
    /// This member is required.
...
public struct CreateServiceTemplateInput: Swift.Equatable {
    ...
    /// This member is required.
    public var name: Swift.String?
    /// By default, Proton provides a service pipeline for your service. When this parameter is included, it indicates that an Proton service pipeline isn't provided for your service. After it's included, it can't be changed. For more information, see [Service template bundles](https://docs.aws.amazon.com/proton/latest/adminguide/ag-template-bundles.html) in the Proton Administrator Guide.
