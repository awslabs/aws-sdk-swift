...
public struct CreateEnvironmentInput: Swift.Equatable {
    ...
    /// A link to a YAML formatted spec file that provides inputs as defined in the environment template bundle schema file. For more information, see [Environments](https://docs.aws.amazon.com/proton/latest/adminguide/ag-environments.html) in the AWS Proton Administrator Guide.
    /// This member is required.
    public var spec: Swift.String?
    /// Create tags for your environment. For more information, see AWS Proton resources and tagging in the [AWS Proton Administrator Guide](https://docs.aws.amazon.com/proton/latest/adminguide/resources.html) or [AWS Proton User Guide](https://docs.aws.amazon.com/proton/latest/userguide/resources.html).
    ...
    /// The name of the environment template. For more information, see [Environment Templates](https://docs.aws.amazon.com/proton/latest/adminguide/ag-templates.html) in the AWS Proton Administrator Guide.
    /// This member is required.
    public var templateName: Swift.String?
...
public struct CreateEnvironmentTemplateInput: Swift.Equatable {
    ...
    /// Create tags for your environment template. For more information, see AWS Proton resources and tagging in the [AWS Proton Administrator Guide](https://docs.aws.amazon.com/proton/latest/adminguide/resources.html) or [AWS Proton User Guide](https://docs.aws.amazon.com/proton/latest/userguide/resources.html).
    public var tags: [ProtonClientTypes.Tag]?
...
public struct CreateServiceInput: Swift.Equatable {
    ...
    /// This member is required.
    public var spec: Swift.String?
    /// Create tags for your service. For more information, see AWS Proton resources and tagging in the [AWS Proton Administrator Guide](https://docs.aws.amazon.com/proton/latest/adminguide/resources.html) or [AWS Proton User Guide](https://docs.aws.amazon.com/proton/latest/userguide/resources.html).
    public var tags: [ProtonClientTypes.Tag]?
...
public struct CreateServiceTemplateInput: Swift.Equatable {
    ...
    /// This member is required.
    public var name: Swift.String?
    /// AWS Proton includes a service pipeline for your service by default. When included, this parameter indicates that an AWS Proton service pipeline won't be included for your service. Once specified, this parameter can't be changed. For more information, see [Service template bundles](https://docs.aws.amazon.com/proton/latest/adminguide/ag-template-bundles.html) in the AWS Proton Administrator Guide.
    public var pipelineProvisioning: ProtonClientTypes.Provisioning?
    /// Create tags for your service template. For more information, see AWS Proton resources and tagging in the [AWS Proton Administrator Guide](https://docs.aws.amazon.com/proton/latest/adminguide/resources.html) or [AWS Proton User Guide](https://docs.aws.amazon.com/proton/latest/userguide/resources.html).
    public var tags: [ProtonClientTypes.Tag]?
