...
public struct AcceptEnvironmentAccountConnectionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var environmentAccountConnection: ProtonClientTypes.EnvironmentAccountConnection?
...
extension ProtonClientTypes {
    ...
    public struct AccountSettings: Swift.Equatable {
        ...
        var pipelineProvisioningRepository: ProtonClientTypes.RepositoryBranch?
        /// The Amazon Resource Name (ARN) of the Proton pipeline service role.
        var pipelineServiceRoleArn: Swift.String?
...
public struct CancelEnvironmentDeploymentOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var environment: ProtonClientTypes.Environment?
...
public struct CancelServiceInstanceDeploymentInput: Swift.Equatable {
    ...
    /// This member is required.
    var serviceInstanceName: Swift.String?
...
public struct CancelServiceInstanceDeploymentOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var serviceInstance: ProtonClientTypes.ServiceInstance?
...
public struct CancelServicePipelineDeploymentOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var pipeline: ProtonClientTypes.ServicePipeline?
...
public struct CreateEnvironmentAccountConnectionInput: Swift.Equatable {
    ...
    /// This member is required.
    var managementAccountId: Swift.String?
    ...
    var tags: [ProtonClientTypes.Tag]?
...
public struct CreateEnvironmentInput: Swift.Equatable {
    ...
    var environmentAccountConnectionId: Swift.String?
    ...
    var protonServiceRoleArn: Swift.String?
    ...
    var provisioningRepository: ProtonClientTypes.RepositoryBranchInput?
    ...
    /// This member is required.
    var templateMajorVersion: Swift.String?
    /// The minor version of the environment template.
    var templateMinorVersion: Swift.String?
...
public struct CreateEnvironmentTemplateInput: Swift.Equatable {
    ...
    var provisioning: ProtonClientTypes.Provisioning?
...
public struct CreateEnvironmentTemplateOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var environmentTemplate: ProtonClientTypes.EnvironmentTemplate?
...
public struct CreateEnvironmentTemplateVersionInput: Swift.Equatable {
    ...
    /// This member is required.
    var source: ProtonClientTypes.TemplateVersionSourceInput?
...
public struct CreateEnvironmentTemplateVersionOutputResponse: Swift.Equatable {
    /// The environment template detail data that's returned by Proton.
    /// This member is required.
    var environmentTemplateVersion: ProtonClientTypes.EnvironmentTemplateVersion?
...
public struct CreateRepositoryInput: Swift.Equatable {
    ...
    /// This member is required.
    var provider: ProtonClientTypes.RepositoryProvider?
...
public struct CreateRepositoryOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var repository: ProtonClientTypes.Repository?
...
public struct CreateServiceInput: Swift.Equatable {
    ...
    var repositoryConnectionArn: Swift.String?
    /// The ID of the code repository. Don't include this parameter if your service template doesn't include a service pipeline.
    var repositoryId: Swift.String?
...
public struct CreateServiceOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var service: ProtonClientTypes.Service?
...
public struct CreateServiceTemplateInput: Swift.Equatable {
    ...
    var pipelineProvisioning: ProtonClientTypes.Provisioning?
...
public struct CreateServiceTemplateOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var serviceTemplate: ProtonClientTypes.ServiceTemplate?
...
public struct CreateServiceTemplateVersionInput: Swift.Equatable {
    ...
    /// This member is required.
    var compatibleEnvironmentTemplates: [ProtonClientTypes.CompatibleEnvironmentTemplateInput]?
...
public struct CreateServiceTemplateVersionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var serviceTemplateVersion: ProtonClientTypes.ServiceTemplateVersion?
...
public struct CreateTemplateSyncConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var repositoryProvider: ProtonClientTypes.RepositoryProvider?
    ...
    /// This member is required.
    var templateType: ProtonClientTypes.TemplateType?
...
public struct CreateTemplateSyncConfigOutputResponse: Swift.Equatable {
    ...
    var templateSyncConfig: ProtonClientTypes.TemplateSyncConfig?
...
extension ProtonClientTypes {
    ...
    public struct Environment: Swift.Equatable {
        ...
        /// This member is required.
        var deploymentStatus: ProtonClientTypes.DeploymentStatus?
        ...
        var environmentAccountId: Swift.String?
        /// The time when a deployment of the environment was last attempted.
        /// This member is required.
        var lastDeploymentAttemptedAt: ClientRuntime.Date?
        /// The time when the environment was last deployed successfully.
        /// This member is required.
        var lastDeploymentSucceededAt: ClientRuntime.Date?
        /// The name of the environment.
        /// This member is required.
        var name: Swift.String?
        ...
        var provisioning: ProtonClientTypes.Provisioning?
        /// The repository that you provide with pull request provisioning. Provisioning by pull request is currently in feature preview and is only usable with Terraform based Proton Templates. To learn more about [Amazon Web Services Feature Preview terms](https://aws.amazon.com/service-terms), see section 2 on Beta and Previews.
        var provisioningRepository: ProtonClientTypes.RepositoryBranch?
...
extension ProtonClientTypes {
    ...
    public struct EnvironmentAccountConnection: Swift.Equatable {
        ...
        /// This member is required.
        var requestedAt: ClientRuntime.Date?
        /// The IAM service role that's associated with the environment account connection.
        /// This member is required.
        var roleArn: Swift.String?
        /// The status of the environment account connection.
        /// This member is required.
        var status: ProtonClientTypes.EnvironmentAccountConnectionStatus?
...
extension ProtonClientTypes {
    ...
    public struct EnvironmentTemplateVersion: Swift.Equatable {
        ...
        var recommendedMinorVersion: Swift.String?
        /// The schema of the version of an environment template.
        var schema: Swift.String?
        /// The status of the version of an environment template.
        /// This member is required.
        var status: ProtonClientTypes.TemplateVersionStatus?
...
public struct GetAccountSettingsOutputResponse: Swift.Equatable {
    ...
    var accountSettings: ProtonClientTypes.AccountSettings?
...
public struct GetRepositorySyncStatusInput: Swift.Equatable {
    ...
    /// This member is required.
    var syncType: ProtonClientTypes.SyncType?
...
public struct GetRepositorySyncStatusOutputResponse: Swift.Equatable {
    ...
    var latestSync: ProtonClientTypes.RepositorySyncAttempt?
...
public struct GetTemplateSyncStatusInput: Swift.Equatable {
    ...
    /// This member is required.
    var templateVersion: Swift.String?
...
public struct GetTemplateSyncStatusOutputResponse: Swift.Equatable {
    ...
    var desiredState: ProtonClientTypes.Revision?
    /// The details of the last successful sync that's returned by Proton.
    var latestSuccessfulSync: ProtonClientTypes.ResourceSyncAttempt?
    /// The details of the last sync that's returned by Proton.
    var latestSync: ProtonClientTypes.ResourceSyncAttempt?
...
public struct ListEnvironmentAccountConnectionsInput: Swift.Equatable {
    ...
    /// This member is required.
    var requestedBy: ProtonClientTypes.EnvironmentAccountConnectionRequesterAccountType?
    /// The status details for each listed environment account connection.
    var statuses: [ProtonClientTypes.EnvironmentAccountConnectionStatus]?
...
public struct ListEnvironmentAccountConnectionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var environmentAccountConnections: [ProtonClientTypes.EnvironmentAccountConnectionSummary]?
...
public struct ListEnvironmentOutputsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var outputs: [ProtonClientTypes.Output]?
...
public struct ListEnvironmentProvisionedResourcesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var provisionedResources: [ProtonClientTypes.ProvisionedResource]?
...
public struct ListEnvironmentTemplateVersionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var templateVersions: [ProtonClientTypes.EnvironmentTemplateVersionSummary]?
...
public struct ListEnvironmentTemplatesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var templates: [ProtonClientTypes.EnvironmentTemplateSummary]?
...
public struct ListEnvironmentsInput: Swift.Equatable {
    ...
    var environmentTemplates: [ProtonClientTypes.EnvironmentTemplateFilter]?
...
public struct ListEnvironmentsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var environments: [ProtonClientTypes.EnvironmentSummary]?
...
public struct ListRepositoriesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var repositories: [ProtonClientTypes.RepositorySummary]?
...
public struct ListRepositorySyncDefinitionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var syncDefinitions: [ProtonClientTypes.RepositorySyncDefinition]?
...
public struct ListServiceInstancesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var serviceInstances: [ProtonClientTypes.ServiceInstanceSummary]?
...
public struct ListServiceTemplateVersionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var templateVersions: [ProtonClientTypes.ServiceTemplateVersionSummary]?
...
public struct ListServiceTemplatesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var templates: [ProtonClientTypes.ServiceTemplateSummary]?
...
public struct ListServicesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var services: [ProtonClientTypes.ServiceSummary]?
...
public struct NotifyResourceDeploymentStatusChangeInput: Swift.Equatable {
    ...
    /// This member is required.
    var status: ProtonClientTypes.ResourceDeploymentStatus?
...
extension ProtonClientTypes {
    ...
    public struct ProvisionedResource: Swift.Equatable {
        ...
        var provisioningEngine: ProtonClientTypes.ProvisionedResourceEngine?
...
extension ProtonClientTypes {
    ...
    public struct RepositorySyncAttempt: Swift.Equatable {
        ...
        /// This member is required.
        var events: [ProtonClientTypes.RepositorySyncEvent]?
        /// The time when the sync attempt started.
        /// This member is required.
        var startedAt: ClientRuntime.Date?
        /// The sync attempt status.
        /// This member is required.
        var status: ProtonClientTypes.RepositorySyncStatus?
...
extension ProtonClientTypes {
    ...
    public struct RepositorySyncDefinition: Swift.Equatable {
        ...
        /// This member is required.
        var directory: Swift.String?
        /// The resource that is synced from.
        /// This member is required.
        var parent: Swift.String?
...
extension ProtonClientTypes {
    ...
    public struct ResourceSyncAttempt: Swift.Equatable {
        ...
        /// This member is required.
        var events: [ProtonClientTypes.ResourceSyncEvent]?
        /// Detail data for the initial repository commit, path and push.
        /// This member is required.
        var initialRevision: ProtonClientTypes.Revision?
        /// The time when the sync attempt started.
        /// This member is required.
        var startedAt: ClientRuntime.Date?
        /// The status of the sync attempt.
        /// This member is required.
        var status: ProtonClientTypes.ResourceSyncStatus?
        /// The resource that is synced to.
        /// This member is required.
        var target: Swift.String?
        /// Detail data for the target revision.
        /// This member is required.
        var targetRevision: ProtonClientTypes.Revision?
...
extension ProtonClientTypes {
    ...
    public struct Service: Swift.Equatable {
        ...
        /// This member is required.
        var status: ProtonClientTypes.ServiceStatus?
...
extension ProtonClientTypes {
    ...
    public struct ServiceTemplateVersion: Swift.Equatable {
        ...
        /// This member is required.
        var compatibleEnvironmentTemplates: [ProtonClientTypes.CompatibleEnvironmentTemplate]?
...
public struct UpdateAccountSettingsInput: Swift.Equatable {
    /// The repository that you provide with pull request provisioning. Provisioning by pull request is currently in feature preview and is only usable with Terraform based Proton Templates. To learn more about [Amazon Web Services Feature Preview terms](https://aws.amazon.com/service-terms), see section 2 on Beta and Previews.
    var pipelineProvisioningRepository: ProtonClientTypes.RepositoryBranchInput?
...
public struct UpdateEnvironmentInput: Swift.Equatable {
    ...
    /// This member is required.
    var deploymentType: ProtonClientTypes.DeploymentUpdateType?
