...
public class Route53DomainsClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try Route53DomainsClientConfiguration(region: unwrappedRegion)
    ...
    public class Route53DomainsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("Route53DomainsClient")
