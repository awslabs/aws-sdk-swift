...
public struct AcceptDomainTransferFromAnotherAwsAccountInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<AcceptDomainTransferFromAnotherAwsAccountOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<AcceptDomainTransferFromAnotherAwsAccountOutput>
