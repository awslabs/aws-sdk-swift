...
public struct RejectDomainTransferFromAnotherAwsAccountInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<RejectDomainTransferFromAnotherAwsAccountOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<RejectDomainTransferFromAnotherAwsAccountOutput>
