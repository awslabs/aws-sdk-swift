...
public protocol Route53DomainsClientProtocol {
    ...
    /// 		</p>
    func acceptDomainTransferFromAnotherAwsAccount(input: AcceptDomainTransferFromAnotherAwsAccountInput, completion: @escaping (SdkResult<AcceptDomainTransferFromAnotherAwsAccountOutputResponse, AcceptDomainTransferFromAnotherAwsAccountOutputError>) -> Void)
    ...
    /// 			provides additional information, for example, <code>Domain Transfer from Aws Account 111122223333 has been cancelled</code>.
    /// 		</p>
    func cancelDomainTransferToAnotherAwsAccount(input: CancelDomainTransferToAnotherAwsAccountInput, completion: @escaping (SdkResult<CancelDomainTransferToAnotherAwsAccountOutputResponse, CancelDomainTransferToAnotherAwsAccountOutputError>) -> Void)
    ...
    func checkDomainAvailability(input: CheckDomainAvailabilityInput, completion: @escaping (SdkResult<CheckDomainAvailabilityOutputResponse, CheckDomainAvailabilityOutputError>) -> Void)
    /// <p>Checks whether a domain name can be transferred to Amazon Route 53. </p>
    func checkDomainTransferability(input: CheckDomainTransferabilityInput, completion: @escaping (SdkResult<CheckDomainTransferabilityOutputResponse, CheckDomainTransferabilityOutputError>) -> Void)
    ...
    func deleteTagsForDomain(input: DeleteTagsForDomainInput, completion: @escaping (SdkResult<DeleteTagsForDomainOutputResponse, DeleteTagsForDomainOutputError>) -> Void)
    /// <p>This operation disables automatic renewal of domain registration for the specified domain.</p>
    func disableDomainAutoRenew(input: DisableDomainAutoRenewInput, completion: @escaping (SdkResult<DisableDomainAutoRenewOutputResponse, DisableDomainAutoRenewOutputError>) -> Void)
    ...
    func disableDomainTransferLock(input: DisableDomainTransferLockInput, completion: @escaping (SdkResult<DisableDomainTransferLockOutputResponse, DisableDomainTransferLockOutputError>) -> Void)
    ...
    func enableDomainAutoRenew(input: EnableDomainAutoRenewInput, completion: @escaping (SdkResult<EnableDomainAutoRenewOutputResponse, EnableDomainAutoRenewOutputError>) -> Void)
    ...
    func enableDomainTransferLock(input: EnableDomainTransferLockInput, completion: @escaping (SdkResult<EnableDomainTransferLockOutputResponse, EnableDomainTransferLockOutputError>) -> Void)
    ...
    func getContactReachabilityStatus(input: GetContactReachabilityStatusInput, completion: @escaping (SdkResult<GetContactReachabilityStatusOutputResponse, GetContactReachabilityStatusOutputError>) -> Void)
    ...
    func getDomainDetail(input: GetDomainDetailInput, completion: @escaping (SdkResult<GetDomainDetailOutputResponse, GetDomainDetailOutputError>) -> Void)
    /// <p>The GetDomainSuggestions operation returns a list of suggested domain names.</p>
    func getDomainSuggestions(input: GetDomainSuggestionsInput, completion: @escaping (SdkResult<GetDomainSuggestionsOutputResponse, GetDomainSuggestionsOutputError>) -> Void)
    /// <p>This operation returns the current status of an operation that is not completed.</p>
    func getOperationDetail(input: GetOperationDetailInput, completion: @escaping (SdkResult<GetOperationDetailOutputResponse, GetOperationDetailOutputError>) -> Void)
    ...
    /// 		       <p>All tag operations are eventually consistent; subsequent operations might not immediately represent all issued operations.</p>
    func listTagsForDomain(input: ListTagsForDomainInput, completion: @escaping (SdkResult<ListTagsForDomainOutputResponse, ListTagsForDomainOutputError>) -> Void)
    ...
    /// 			provides additional information, for example, <code>Domain Transfer from Aws Account 111122223333 has been cancelled</code>.
    /// 		</p>
    func rejectDomainTransferFromAnotherAwsAccount(input: RejectDomainTransferFromAnotherAwsAccountInput, completion: @escaping (SdkResult<RejectDomainTransferFromAnotherAwsAccountOutputResponse, RejectDomainTransferFromAnotherAwsAccountOutputError>) -> Void)
    ...
    func renewDomain(input: RenewDomainInput, completion: @escaping (SdkResult<RenewDomainOutputResponse, RenewDomainOutputError>) -> Void)
    /// <p>For operations that require confirmation that the email address for the registrant contact is valid,
    ...
    func resendContactReachabilityEmail(input: ResendContactReachabilityEmailInput, completion: @escaping (SdkResult<ResendContactReachabilityEmailOutputResponse, ResendContactReachabilityEmailOutputError>) -> Void)
    ...
    func retrieveDomainAuthCode(input: RetrieveDomainAuthCodeInput, completion: @escaping (SdkResult<RetrieveDomainAuthCodeOutputResponse, RetrieveDomainAuthCodeOutputError>) -> Void)
    ...
    func transferDomain(input: TransferDomainInput, completion: @escaping (SdkResult<TransferDomainOutputResponse, TransferDomainOutputError>) -> Void)
    ...
    /// 			provides additional information, for example, <code>Domain Transfer from Aws Account 111122223333 has been cancelled</code>.
    /// 		</p>
    func transferDomainToAnotherAwsAccount(input: TransferDomainToAnotherAwsAccountInput, completion: @escaping (SdkResult<TransferDomainToAnotherAwsAccountOutputResponse, TransferDomainToAnotherAwsAccountOutputError>) -> Void)
    ...
    func updateDomainContact(input: UpdateDomainContactInput, completion: @escaping (SdkResult<UpdateDomainContactOutputResponse, UpdateDomainContactOutputError>) -> Void)
    ...
    ///          </important>
    func updateDomainContactPrivacy(input: UpdateDomainContactPrivacyInput, completion: @escaping (SdkResult<UpdateDomainContactPrivacyOutputResponse, UpdateDomainContactPrivacyOutputError>) -> Void)
    ...
    /// 			If the request is not completed successfully, the domain registrant will be notified by email.</p>
    func updateDomainNameservers(input: UpdateDomainNameserversInput, completion: @escaping (SdkResult<UpdateDomainNameserversOutputResponse, UpdateDomainNameserversOutputError>) -> Void)
    /// <p>This operation adds or updates tags for a specified domain.</p>
    /// 		       <p>All tag operations are eventually consistent; subsequent operations might not immediately represent all issued operations.</p>
    func updateTagsForDomain(input: UpdateTagsForDomainInput, completion: @escaping (SdkResult<UpdateTagsForDomainOutputResponse, UpdateTagsForDomainOutputError>) -> Void)
    /// <p>Returns all the domain-related billing records for the current AWS account for a specified period</p>
    func viewBilling(input: ViewBillingInput, completion: @escaping (SdkResult<ViewBillingOutputResponse, ViewBillingOutputError>) -> Void)
}
