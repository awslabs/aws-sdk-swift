...
public protocol Route53DomainsClientProtocol {
    ...
    /// 		</p>
    func acceptDomainTransferFromAnotherAwsAccount(input: AcceptDomainTransferFromAnotherAwsAccountInput, completion: @escaping (SdkResult<AcceptDomainTransferFromAnotherAwsAccountOutput, AcceptDomainTransferFromAnotherAwsAccountOutputError>) -> Void)
    ...
    /// 			provides additional information, for example, <code>Domain Transfer from Aws Account 111122223333 has been cancelled</code>.
    /// 		</p>
    func cancelDomainTransferToAnotherAwsAccount(input: CancelDomainTransferToAnotherAwsAccountInput, completion: @escaping (SdkResult<CancelDomainTransferToAnotherAwsAccountOutput, CancelDomainTransferToAnotherAwsAccountOutputError>) -> Void)
    ...
    func checkDomainAvailability(input: CheckDomainAvailabilityInput, completion: @escaping (SdkResult<CheckDomainAvailabilityOutput, CheckDomainAvailabilityOutputError>) -> Void)
    /// <p>Checks whether a domain name can be transferred to Amazon Route 53. </p>
    func checkDomainTransferability(input: CheckDomainTransferabilityInput, completion: @escaping (SdkResult<CheckDomainTransferabilityOutput, CheckDomainTransferabilityOutputError>) -> Void)
    ...
    func deleteTagsForDomain(input: DeleteTagsForDomainInput, completion: @escaping (SdkResult<DeleteTagsForDomainOutput, DeleteTagsForDomainOutputError>) -> Void)
    /// <p>This operation disables automatic renewal of domain registration for the specified domain.</p>
    func disableDomainAutoRenew(input: DisableDomainAutoRenewInput, completion: @escaping (SdkResult<DisableDomainAutoRenewOutput, DisableDomainAutoRenewOutputError>) -> Void)
    ...
    func disableDomainTransferLock(input: DisableDomainTransferLockInput, completion: @escaping (SdkResult<DisableDomainTransferLockOutput, DisableDomainTransferLockOutputError>) -> Void)
    ...
    func enableDomainAutoRenew(input: EnableDomainAutoRenewInput, completion: @escaping (SdkResult<EnableDomainAutoRenewOutput, EnableDomainAutoRenewOutputError>) -> Void)
    ...
    func enableDomainTransferLock(input: EnableDomainTransferLockInput, completion: @escaping (SdkResult<EnableDomainTransferLockOutput, EnableDomainTransferLockOutputError>) -> Void)
    ...
    func getContactReachabilityStatus(input: GetContactReachabilityStatusInput, completion: @escaping (SdkResult<GetContactReachabilityStatusOutput, GetContactReachabilityStatusOutputError>) -> Void)
    ...
    func getDomainDetail(input: GetDomainDetailInput, completion: @escaping (SdkResult<GetDomainDetailOutput, GetDomainDetailOutputError>) -> Void)
    /// <p>The GetDomainSuggestions operation returns a list of suggested domain names.</p>
    func getDomainSuggestions(input: GetDomainSuggestionsInput, completion: @escaping (SdkResult<GetDomainSuggestionsOutput, GetDomainSuggestionsOutputError>) -> Void)
    /// <p>This operation returns the current status of an operation that is not completed.</p>
    func getOperationDetail(input: GetOperationDetailInput, completion: @escaping (SdkResult<GetOperationDetailOutput, GetOperationDetailOutputError>) -> Void)
    ...
    /// 		       <p>All tag operations are eventually consistent; subsequent operations might not immediately represent all issued operations.</p>
    func listTagsForDomain(input: ListTagsForDomainInput, completion: @escaping (SdkResult<ListTagsForDomainOutput, ListTagsForDomainOutputError>) -> Void)
    ...
    /// 			provides additional information, for example, <code>Domain Transfer from Aws Account 111122223333 has been cancelled</code>.
    /// 		</p>
    func rejectDomainTransferFromAnotherAwsAccount(input: RejectDomainTransferFromAnotherAwsAccountInput, completion: @escaping (SdkResult<RejectDomainTransferFromAnotherAwsAccountOutput, RejectDomainTransferFromAnotherAwsAccountOutputError>) -> Void)
    ...
    func renewDomain(input: RenewDomainInput, completion: @escaping (SdkResult<RenewDomainOutput, RenewDomainOutputError>) -> Void)
    /// <p>For operations that require confirmation that the email address for the registrant contact is valid,
    ...
    func resendContactReachabilityEmail(input: ResendContactReachabilityEmailInput, completion: @escaping (SdkResult<ResendContactReachabilityEmailOutput, ResendContactReachabilityEmailOutputError>) -> Void)
    ...
    func retrieveDomainAuthCode(input: RetrieveDomainAuthCodeInput, completion: @escaping (SdkResult<RetrieveDomainAuthCodeOutput, RetrieveDomainAuthCodeOutputError>) -> Void)
    ...
    func transferDomain(input: TransferDomainInput, completion: @escaping (SdkResult<TransferDomainOutput, TransferDomainOutputError>) -> Void)
    ...
    /// 			provides additional information, for example, <code>Domain Transfer from Aws Account 111122223333 has been cancelled</code>.
    /// 		</p>
    func transferDomainToAnotherAwsAccount(input: TransferDomainToAnotherAwsAccountInput, completion: @escaping (SdkResult<TransferDomainToAnotherAwsAccountOutput, TransferDomainToAnotherAwsAccountOutputError>) -> Void)
    ...
    func updateDomainContact(input: UpdateDomainContactInput, completion: @escaping (SdkResult<UpdateDomainContactOutput, UpdateDomainContactOutputError>) -> Void)
    ...
    ///          </important>
    func updateDomainContactPrivacy(input: UpdateDomainContactPrivacyInput, completion: @escaping (SdkResult<UpdateDomainContactPrivacyOutput, UpdateDomainContactPrivacyOutputError>) -> Void)
    ...
    /// 			If the request is not completed successfully, the domain registrant will be notified by email.</p>
    func updateDomainNameservers(input: UpdateDomainNameserversInput, completion: @escaping (SdkResult<UpdateDomainNameserversOutput, UpdateDomainNameserversOutputError>) -> Void)
    /// <p>This operation adds or updates tags for a specified domain.</p>
    /// 		       <p>All tag operations are eventually consistent; subsequent operations might not immediately represent all issued operations.</p>
    func updateTagsForDomain(input: UpdateTagsForDomainInput, completion: @escaping (SdkResult<UpdateTagsForDomainOutput, UpdateTagsForDomainOutputError>) -> Void)
    /// <p>Returns all the domain-related billing records for the current AWS account for a specified period</p>
    func viewBilling(input: ViewBillingInput, completion: @escaping (SdkResult<ViewBillingOutput, ViewBillingOutputError>) -> Void)
}
