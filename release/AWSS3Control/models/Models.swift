...
extension S3ControlClientTypes.CloudWatchMetrics: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case isEnabled = "IsEnabled"
    }
...
extension S3ControlClientTypes.CloudWatchMetrics: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CloudWatchMetrics(isEnabled: \(Swift.String(describing: isEnabled)))"}
}
...
extension S3ControlClientTypes.StorageLensDataExport: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StorageLensDataExport(cloudWatchMetrics: \(Swift.String(describing: cloudWatchMetrics)), s3BucketDestination: \(Swift.String(describing: s3BucketDestination)))"}
}
