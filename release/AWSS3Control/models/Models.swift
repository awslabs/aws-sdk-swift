...
extension S3ControlClientTypes.AccessPoint: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AccessPoint(accessPointArn: \(Swift.String(describing: accessPointArn)), alias: \(Swift.String(describing: alias)), bucket: \(Swift.String(describing: bucket)), name: \(Swift.String(describing: name)), networkOrigin: \(Swift.String(describing: networkOrigin)), vpcConfiguration: \(Swift.String(describing: vpcConfiguration)))"}
}
...
extension S3ControlClientTypes.AsyncErrorDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case code = "Code"
...
extension S3ControlClientTypes.AsyncErrorDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AsyncErrorDetails(code: \(Swift.String(describing: code)), message: \(Swift.String(describing: message)), requestId: \(Swift.String(describing: requestId)), resource: \(Swift.String(describing: resource)))"}
}
...
extension S3ControlClientTypes.AsyncOperation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.AsyncOperation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AsyncOperation(creationTime: \(Swift.String(describing: creationTime)), operation: \(Swift.String(describing: operation)), requestParameters: \(Swift.String(describing: requestParameters)), requestStatus: \(Swift.String(describing: requestStatus)), requestTokenARN: \(Swift.String(describing: requestTokenARN)), responseDetails: \(Swift.String(describing: responseDetails)))"}
}
...
extension S3ControlClientTypes.AsyncRequestParameters: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.AsyncRequestParameters: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AsyncRequestParameters(createMultiRegionAccessPointRequest: \(Swift.String(describing: createMultiRegionAccessPointRequest)), deleteMultiRegionAccessPointRequest: \(Swift.String(describing: deleteMultiRegionAccessPointRequest)), putMultiRegionAccessPointPolicyRequest: \(Swift.String(describing: putMultiRegionAccessPointPolicyRequest)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct AsyncRequestParameters: Swift.Equatable {
        ...
        /// A container of the parameters for a
        ///          <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_PutMultiRegionAccessPoint.html">PutMultiRegionAccessPoint
        ///          request.
...
extension S3ControlClientTypes.AsyncResponseDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.AsyncResponseDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AsyncResponseDetails(errorDetails: \(Swift.String(describing: errorDetails)), multiRegionAccessPointDetails: \(Swift.String(describing: multiRegionAccessPointDetails)))"}
}
...
public struct CreateAccessPointForObjectLambdaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAccessPointForObjectLambdaInputURLHostMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        copiedContext.attributes.set(key: AttributeKey<String>(name: "HostPrefix"), value: "\(input.accountId!).")
        return next.handle(context: copiedContext, input: input)
    }

    public typealias MInput = CreateAccessPointForObjectLambdaInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateAccessPointForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateAccessPointForObjectLambdaOutputError>
}

public struct CreateAccessPointForObjectLambdaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAccessPointForObjectLambdaInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/accesspointforobjectlambda/\(name.urlPercentEncoding())"
...
public struct CreateAccessPointInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/accesspoint/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension CreateAccessPointOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAccessPointOutputResponse(accessPointArn: \(Swift.String(describing: accessPointArn)), alias: \(Swift.String(describing: alias)))"}
}
...
public struct CreateBucketInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateBucketInputURLHostMiddleware"
    ...
    public typealias MInput = CreateBucketInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateBucketOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateBucketOutputError>
}

public struct CreateBucketInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateBucketInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let bucket = input.bucket else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("bucket is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/v20180820/bucket/\(bucket.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreateJobInput: Swift.Equatable {
    ...
    ///          For more information about the available actions, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/batch-ops-actions.html">Operations in the
...
public struct CreateMultiRegionAccessPointInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateMultiRegionAccessPointInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateMultiRegionAccessPointInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateMultiRegionAccessPointOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateMultiRegionAccessPointInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateMultiRegionAccessPointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateMultiRegionAccessPointOutputError>
}

extension S3ControlClientTypes.CreateMultiRegionAccessPointInput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
...
extension S3ControlClientTypes.CreateMultiRegionAccessPointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateMultiRegionAccessPointInput(name: \(Swift.String(describing: name)), publicAccessBlock: \(Swift.String(describing: publicAccessBlock)), regions: \(Swift.String(describing: regions)))"}
}

extension CreateMultiRegionAccessPointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateMultiRegionAccessPointInput(accountId: \(Swift.String(describing: accountId)), clientToken: \(Swift.String(describing: clientToken)), details: \(Swift.String(describing: details)))"}
}
...
extension CreateMultiRegionAccessPointInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateMultiRegionAccessPointInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateMultiRegionAccessPointInputHeadersMiddleware"
...
public struct CreateMultiRegionAccessPointInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateMultiRegionAccessPointInputQueryItemMiddleware"
...
public struct CreateMultiRegionAccessPointInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateMultiRegionAccessPointInputURLHostMiddleware"
    ...
    public typealias MInput = CreateMultiRegionAccessPointInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateMultiRegionAccessPointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateMultiRegionAccessPointOutputError>
}

public struct CreateMultiRegionAccessPointInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateMultiRegionAccessPointInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v20180820/async-requests/mrap/create"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension S3ControlClientTypes {
    ...
    public struct CreateMultiRegionAccessPointInput: Swift.Equatable {
        ...
        ///          when Amazon S3 considers a bucket or object public, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html#access-control-block-public-access-policy-status">The Meaning of "Public" in the Amazon S3 User Guide.
...
struct CreateMultiRegionAccessPointInputBody: Swift.Equatable {
    ...
    public let details: S3ControlClientTypes.CreateMultiRegionAccessPointInput?
}
...
extension CreateMultiRegionAccessPointOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateMultiRegionAccessPointOutputResponse(requestTokenARN: \(Swift.String(describing: requestTokenARN)))"}
}
...
public struct CreateMultiRegionAccessPointOutputResponse: Swift.Equatable {
    /// The request token associated with the request. You can use this token with <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_DescribeMultiRegionAccessPointOperation.html">DescribeMultiRegionAccessPointOperation to determine the status of
...
struct CreateMultiRegionAccessPointOutputResponseBody: Swift.Equatable {
    public let requestTokenARN: Swift.String?
}
...
public struct DeleteAccessPointForObjectLambdaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointForObjectLambdaInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteAccessPointForObjectLambdaInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteAccessPointForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteAccessPointForObjectLambdaOutputError>
}

public struct DeleteAccessPointForObjectLambdaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointForObjectLambdaInputURLPathMiddleware"
...
public struct DeleteAccessPointPolicyForObjectLambdaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointPolicyForObjectLambdaInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteAccessPointPolicyForObjectLambdaInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteAccessPointPolicyForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteAccessPointPolicyForObjectLambdaOutputError>
}

public struct DeleteAccessPointPolicyForObjectLambdaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointPolicyForObjectLambdaInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/accesspointforobjectlambda/\(name.urlPercentEncoding())/policy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteAccessPointPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteAccessPointPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteAccessPointPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteAccessPointPolicyOutputError>
}

public struct DeleteAccessPointPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointPolicyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/accesspoint/\(name.urlPercentEncoding())/policy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteBucketInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteBucketInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteBucketInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteBucketOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteBucketOutputError>
}

public struct DeleteBucketInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteBucketInputURLPathMiddleware"
...
public struct DeleteBucketLifecycleConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteBucketLifecycleConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteBucketLifecycleConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteBucketLifecycleConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteBucketLifecycleConfigurationOutputError>
}

public struct DeleteBucketLifecycleConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteBucketLifecycleConfigurationInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/bucket/\(bucket.urlPercentEncoding())/lifecycleconfiguration"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteBucketPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteBucketPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteBucketPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteBucketPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteBucketPolicyOutputError>
}

public struct DeleteBucketPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteBucketPolicyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/bucket/\(bucket.urlPercentEncoding())/policy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteBucketTaggingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteBucketTaggingInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteBucketTaggingInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteBucketTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteBucketTaggingOutputError>
}

public struct DeleteBucketTaggingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteBucketTaggingInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/bucket/\(bucket.urlPercentEncoding())/tagging"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteJobTaggingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteJobTaggingInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteJobTaggingInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteJobTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteJobTaggingOutputError>
}

public struct DeleteJobTaggingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteJobTaggingInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/jobs/\(jobId.urlPercentEncoding())/tagging"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteMultiRegionAccessPointInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteMultiRegionAccessPointInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteMultiRegionAccessPointInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteMultiRegionAccessPointOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteMultiRegionAccessPointInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteMultiRegionAccessPointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteMultiRegionAccessPointOutputError>
}

extension S3ControlClientTypes.DeleteMultiRegionAccessPointInput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
    }
...
extension S3ControlClientTypes.DeleteMultiRegionAccessPointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteMultiRegionAccessPointInput(name: \(Swift.String(describing: name)))"}
}

extension DeleteMultiRegionAccessPointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteMultiRegionAccessPointInput(accountId: \(Swift.String(describing: accountId)), clientToken: \(Swift.String(describing: clientToken)), details: \(Swift.String(describing: details)))"}
}
...
extension DeleteMultiRegionAccessPointInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientToken = "ClientToken"
        case details = "Details"
    }
...
public struct DeleteMultiRegionAccessPointInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteMultiRegionAccessPointInputHeadersMiddleware"
...
public struct DeleteMultiRegionAccessPointInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteMultiRegionAccessPointInputQueryItemMiddleware"
...
public struct DeleteMultiRegionAccessPointInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteMultiRegionAccessPointInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteMultiRegionAccessPointInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteMultiRegionAccessPointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteMultiRegionAccessPointOutputError>
}

public struct DeleteMultiRegionAccessPointInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteMultiRegionAccessPointInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v20180820/async-requests/mrap/delete"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct DeleteMultiRegionAccessPointInputBody: Swift.Equatable {
    public let clientToken: Swift.String?
    public let details: S3ControlClientTypes.DeleteMultiRegionAccessPointInput?
}
...
extension DeleteMultiRegionAccessPointOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteMultiRegionAccessPointOutputResponse(requestTokenARN: \(Swift.String(describing: requestTokenARN)))"}
}
...
public struct DeletePublicAccessBlockInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePublicAccessBlockInputURLHostMiddleware"
    ...
    public typealias MInput = DeletePublicAccessBlockInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeletePublicAccessBlockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeletePublicAccessBlockOutputError>
}

public struct DeletePublicAccessBlockInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePublicAccessBlockInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v20180820/configuration/publicAccessBlock"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteStorageLensConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStorageLensConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteStorageLensConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteStorageLensConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteStorageLensConfigurationOutputError>
}

public struct DeleteStorageLensConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStorageLensConfigurationInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/storagelens/\(configId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteStorageLensConfigurationTaggingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStorageLensConfigurationTaggingInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteStorageLensConfigurationTaggingInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteStorageLensConfigurationTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteStorageLensConfigurationTaggingOutputError>
}

public struct DeleteStorageLensConfigurationTaggingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStorageLensConfigurationTaggingInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/storagelens/\(configId.urlPercentEncoding())/tagging"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeJobInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/jobs/\(jobId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeMultiRegionAccessPointOperationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeMultiRegionAccessPointOperationInput(accountId: \(Swift.String(describing: accountId)), requestTokenARN: \(Swift.String(describing: requestTokenARN)))"}
}

extension DescribeMultiRegionAccessPointOperationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeMultiRegionAccessPointOperationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeMultiRegionAccessPointOperationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeMultiRegionAccessPointOperationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeMultiRegionAccessPointOperationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeMultiRegionAccessPointOperationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeMultiRegionAccessPointOperationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeMultiRegionAccessPointOperationOutputError>
}

public struct DescribeMultiRegionAccessPointOperationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeMultiRegionAccessPointOperationInputQueryItemMiddleware"
...
public struct DescribeMultiRegionAccessPointOperationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeMultiRegionAccessPointOperationInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeMultiRegionAccessPointOperationInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeMultiRegionAccessPointOperationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeMultiRegionAccessPointOperationOutputError>
}

public struct DescribeMultiRegionAccessPointOperationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeMultiRegionAccessPointOperationInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let requestTokenARN = input.requestTokenARN else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("requestTokenARN is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/v20180820/async-requests/mrap/\(requestTokenARN)"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeMultiRegionAccessPointOperationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeMultiRegionAccessPointOperationOutputResponse(asyncOperation: \(Swift.String(describing: asyncOperation)))"}
}
...
struct DescribeMultiRegionAccessPointOperationOutputResponseBody: Swift.Equatable {
    public let asyncOperation: S3ControlClientTypes.AsyncOperation?
}
...
extension S3ControlClientTypes.EstablishedMultiRegionAccessPointPolicy: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case policy = "Policy"
    }
...
extension S3ControlClientTypes.EstablishedMultiRegionAccessPointPolicy: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EstablishedMultiRegionAccessPointPolicy(policy: \(Swift.String(describing: policy)))"}
}
...
public struct GetAccessPointConfigurationForObjectLambdaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointConfigurationForObjectLambdaInputURLHostMiddleware"
    ...
    public typealias MInput = GetAccessPointConfigurationForObjectLambdaInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointConfigurationForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointConfigurationForObjectLambdaOutputError>
}

public struct GetAccessPointConfigurationForObjectLambdaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointConfigurationForObjectLambdaInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/accesspointforobjectlambda/\(name.urlPercentEncoding())/configuration"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetAccessPointForObjectLambdaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointForObjectLambdaInputURLHostMiddleware"
    ...
    public typealias MInput = GetAccessPointForObjectLambdaInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointForObjectLambdaOutputError>
}

public struct GetAccessPointForObjectLambdaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointForObjectLambdaInputURLPathMiddleware"
...
public struct GetAccessPointInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointInputURLHostMiddleware"
    ...
    public typealias MInput = GetAccessPointInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointOutputError>
}

public struct GetAccessPointInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointInputURLPathMiddleware"
...
extension GetAccessPointOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointOutputResponse(accessPointArn: \(Swift.String(describing: accessPointArn)), alias: \(Swift.String(describing: alias)), bucket: \(Swift.String(describing: bucket)), creationDate: \(Swift.String(describing: creationDate)), endpoints: \(Swift.String(describing: endpoints)), name: \(Swift.String(describing: name)), networkOrigin: \(Swift.String(describing: networkOrigin)), publicAccessBlockConfiguration: \(Swift.String(describing: publicAccessBlockConfiguration)), vpcConfiguration: \(Swift.String(describing: vpcConfiguration)))"}
}
...
public struct GetAccessPointPolicyForObjectLambdaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyForObjectLambdaInputURLHostMiddleware"
    ...
    public typealias MInput = GetAccessPointPolicyForObjectLambdaInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointPolicyForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointPolicyForObjectLambdaOutputError>
}

public struct GetAccessPointPolicyForObjectLambdaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyForObjectLambdaInputURLPathMiddleware"
...
public struct GetAccessPointPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = GetAccessPointPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointPolicyOutputError>
}

public struct GetAccessPointPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyInputURLPathMiddleware"
...
public struct GetAccessPointPolicyStatusForObjectLambdaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyStatusForObjectLambdaInputURLHostMiddleware"
    ...
    public typealias MInput = GetAccessPointPolicyStatusForObjectLambdaInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointPolicyStatusForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointPolicyStatusForObjectLambdaOutputError>
}

public struct GetAccessPointPolicyStatusForObjectLambdaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyStatusForObjectLambdaInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/accesspointforobjectlambda/\(name.urlPercentEncoding())/policyStatus"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetAccessPointPolicyStatusForObjectLambdaOutputResponse: Swift.Equatable {
    ...
    ///          <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html#access-control-block-public-access-policy-status">The Meaning of "Public" in the
    /// 	 Amazon S3 User Guide.
    ///
...
public struct GetAccessPointPolicyStatusInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyStatusInputURLHostMiddleware"
    ...
    public typealias MInput = GetAccessPointPolicyStatusInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointPolicyStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointPolicyStatusOutputError>
}

public struct GetAccessPointPolicyStatusInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyStatusInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/accesspoint/\(name.urlPercentEncoding())/policyStatus"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetBucketInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBucketInputURLHostMiddleware"
    ...
    public typealias MInput = GetBucketInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetBucketOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetBucketOutputError>
}

public struct GetBucketInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBucketInputURLPathMiddleware"
...
public struct GetBucketLifecycleConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBucketLifecycleConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = GetBucketLifecycleConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetBucketLifecycleConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetBucketLifecycleConfigurationOutputError>
}

public struct GetBucketLifecycleConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBucketLifecycleConfigurationInputURLPathMiddleware"
...
public struct GetBucketPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBucketPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = GetBucketPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetBucketPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetBucketPolicyOutputError>
}

public struct GetBucketPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBucketPolicyInputURLPathMiddleware"
...
public struct GetBucketTaggingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBucketTaggingInputURLHostMiddleware"
    ...
    public typealias MInput = GetBucketTaggingInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetBucketTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetBucketTaggingOutputError>
}

public struct GetBucketTaggingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBucketTaggingInputURLPathMiddleware"
...
public struct GetJobTaggingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetJobTaggingInputURLHostMiddleware"
    ...
    public typealias MInput = GetJobTaggingInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetJobTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetJobTaggingOutputError>
}

public struct GetJobTaggingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetJobTaggingInputURLPathMiddleware"
...
extension GetMultiRegionAccessPointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetMultiRegionAccessPointInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension GetMultiRegionAccessPointInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetMultiRegionAccessPointInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetMultiRegionAccessPointInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetMultiRegionAccessPointOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetMultiRegionAccessPointInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetMultiRegionAccessPointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetMultiRegionAccessPointOutputError>
}

public struct GetMultiRegionAccessPointInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointInputQueryItemMiddleware"
...
public struct GetMultiRegionAccessPointInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointInputURLHostMiddleware"
    ...
    public typealias MInput = GetMultiRegionAccessPointInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetMultiRegionAccessPointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetMultiRegionAccessPointOutputError>
}

public struct GetMultiRegionAccessPointInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/mrap/instances/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetMultiRegionAccessPointInput: Swift.Equatable {
    ...
    ///             between the name and the alias of an Multi-Region Access Point, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/CreatingMultiRegionAccessPoints.html#multi-region-access-point-naming">Managing Multi-Region Access Points in the
    ///                 Amazon S3 User Guide.
    /// This member is required.
    public var name: Swift.String?
...
extension GetMultiRegionAccessPointOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetMultiRegionAccessPointOutputResponse(accessPoint: \(Swift.String(describing: accessPoint)))"}
}
...
struct GetMultiRegionAccessPointOutputResponseBody: Swift.Equatable {
    public let accessPoint: S3ControlClientTypes.MultiRegionAccessPointReport?
}
...
extension GetMultiRegionAccessPointPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetMultiRegionAccessPointPolicyInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension GetMultiRegionAccessPointPolicyInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetMultiRegionAccessPointPolicyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointPolicyInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetMultiRegionAccessPointPolicyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetMultiRegionAccessPointPolicyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetMultiRegionAccessPointPolicyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetMultiRegionAccessPointPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetMultiRegionAccessPointPolicyOutputError>
}

public struct GetMultiRegionAccessPointPolicyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointPolicyInputQueryItemMiddleware"
...
public struct GetMultiRegionAccessPointPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = GetMultiRegionAccessPointPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetMultiRegionAccessPointPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetMultiRegionAccessPointPolicyOutputError>
}

public struct GetMultiRegionAccessPointPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointPolicyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/mrap/instances/\(name.urlPercentEncoding())/policy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetMultiRegionAccessPointPolicyInput: Swift.Equatable {
    ...
    ///                 <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/CreatingMultiRegionAccessPoints.html#multi-region-access-point-naming">Managing Multi-Region Access Points in the
    ///                 Amazon S3 User Guide.
    /// This member is required.
    public var name: Swift.String?
...
extension GetMultiRegionAccessPointPolicyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetMultiRegionAccessPointPolicyOutputResponse(policy: \(Swift.String(describing: policy)))"}
}
...
struct GetMultiRegionAccessPointPolicyOutputResponseBody: Swift.Equatable {
    public let policy: S3ControlClientTypes.MultiRegionAccessPointPolicyDocument?
}
...
extension GetMultiRegionAccessPointPolicyStatusInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetMultiRegionAccessPointPolicyStatusInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension GetMultiRegionAccessPointPolicyStatusInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetMultiRegionAccessPointPolicyStatusInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointPolicyStatusInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetMultiRegionAccessPointPolicyStatusInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetMultiRegionAccessPointPolicyStatusOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetMultiRegionAccessPointPolicyStatusInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetMultiRegionAccessPointPolicyStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetMultiRegionAccessPointPolicyStatusOutputError>
}

public struct GetMultiRegionAccessPointPolicyStatusInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointPolicyStatusInputQueryItemMiddleware"
...
public struct GetMultiRegionAccessPointPolicyStatusInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointPolicyStatusInputURLHostMiddleware"
    ...
    public typealias MInput = GetMultiRegionAccessPointPolicyStatusInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetMultiRegionAccessPointPolicyStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetMultiRegionAccessPointPolicyStatusOutputError>
}

public struct GetMultiRegionAccessPointPolicyStatusInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMultiRegionAccessPointPolicyStatusInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/mrap/instances/\(name.urlPercentEncoding())/policystatus"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension GetMultiRegionAccessPointPolicyStatusOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetMultiRegionAccessPointPolicyStatusOutputResponse(established: \(Swift.String(describing: established)))"}
}
...
struct GetMultiRegionAccessPointPolicyStatusOutputResponseBody: Swift.Equatable {
    public let established: S3ControlClientTypes.PolicyStatus?
}
...
public struct GetPublicAccessBlockInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPublicAccessBlockInputURLHostMiddleware"
    ...
    public typealias MInput = GetPublicAccessBlockInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetPublicAccessBlockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetPublicAccessBlockOutputError>
}

public struct GetPublicAccessBlockInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPublicAccessBlockInputURLPathMiddleware"
...
public struct GetStorageLensConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStorageLensConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = GetStorageLensConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetStorageLensConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetStorageLensConfigurationOutputError>
}

public struct GetStorageLensConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStorageLensConfigurationInputURLPathMiddleware"
...
public struct GetStorageLensConfigurationTaggingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStorageLensConfigurationTaggingInputURLHostMiddleware"
    ...
    public typealias MInput = GetStorageLensConfigurationTaggingInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetStorageLensConfigurationTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetStorageLensConfigurationTaggingOutputError>
}

public struct GetStorageLensConfigurationTaggingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStorageLensConfigurationTaggingInputURLPathMiddleware"
...
extension S3ControlClientTypes {
    ...
    ///          For more information about the available operations, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/batch-ops-operations.html">Operations in the
    ///             Amazon S3 User Guide.
    public struct JobOperation: Swift.Equatable {
        ...
        ///             PutObjectLegalHold API. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/batch-ops-legal-hold.html">Using
        ...
        ///             PutObjectRetention API. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/batch-ops-retention-date.html">Using
...
public struct ListAccessPointsForObjectLambdaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccessPointsForObjectLambdaInputURLHostMiddleware"
    ...
    public typealias MInput = ListAccessPointsForObjectLambdaInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListAccessPointsForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAccessPointsForObjectLambdaOutputError>
}

public struct ListAccessPointsForObjectLambdaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccessPointsForObjectLambdaInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v20180820/accesspointforobjectlambda"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListAccessPointsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccessPointsInputURLHostMiddleware"
    ...
    public typealias MInput = ListAccessPointsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListAccessPointsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAccessPointsOutputError>
}

public struct ListAccessPointsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccessPointsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v20180820/accesspoint"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListMultiRegionAccessPointsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListMultiRegionAccessPointsInput(accountId: \(Swift.String(describing: accountId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListMultiRegionAccessPointsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListMultiRegionAccessPointsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListMultiRegionAccessPointsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListMultiRegionAccessPointsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListMultiRegionAccessPointsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListMultiRegionAccessPointsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListMultiRegionAccessPointsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListMultiRegionAccessPointsOutputError>
}

public struct ListMultiRegionAccessPointsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListMultiRegionAccessPointsInputQueryItemMiddleware"
...
public struct ListMultiRegionAccessPointsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListMultiRegionAccessPointsInputURLHostMiddleware"
    ...
    public typealias MInput = ListMultiRegionAccessPointsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListMultiRegionAccessPointsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListMultiRegionAccessPointsOutputError>
}

public struct ListMultiRegionAccessPointsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListMultiRegionAccessPointsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v20180820/mrap/instances"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListMultiRegionAccessPointsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListMultiRegionAccessPointsOutputResponse(accessPoints: \(Swift.String(describing: accessPoints)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListMultiRegionAccessPointsOutputResponseBody: Swift.Equatable {
    public let accessPoints: [S3ControlClientTypes.MultiRegionAccessPointReport]?
    public let nextToken: Swift.String?
}
...
public struct ListRegionalBucketsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRegionalBucketsInputURLHostMiddleware"
    ...
    public typealias MInput = ListRegionalBucketsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListRegionalBucketsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRegionalBucketsOutputError>
}

public struct ListRegionalBucketsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRegionalBucketsInputURLPathMiddleware"
...
public struct ListStorageLensConfigurationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStorageLensConfigurationsInputURLHostMiddleware"
    ...
    public typealias MInput = ListStorageLensConfigurationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListStorageLensConfigurationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListStorageLensConfigurationsOutputError>
}

public struct ListStorageLensConfigurationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStorageLensConfigurationsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v20180820/storagelens"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension S3ControlClientTypes.MultiRegionAccessPointPolicyDocument: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case established = "Established"
...
extension S3ControlClientTypes.MultiRegionAccessPointPolicyDocument: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MultiRegionAccessPointPolicyDocument(established: \(Swift.String(describing: established)), proposed: \(Swift.String(describing: proposed)))"}
}
...
extension S3ControlClientTypes.MultiRegionAccessPointRegionalResponse: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case requestStatus = "RequestStatus"
    }
...
extension S3ControlClientTypes.MultiRegionAccessPointRegionalResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MultiRegionAccessPointRegionalResponse(name: \(Swift.String(describing: name)), requestStatus: \(Swift.String(describing: requestStatus)))"}
}
...
extension S3ControlClientTypes.MultiRegionAccessPointReport: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case alias = "Alias"
...
extension S3ControlClientTypes.MultiRegionAccessPointReport: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MultiRegionAccessPointReport(alias: \(Swift.String(describing: alias)), createdAt: \(Swift.String(describing: createdAt)), name: \(Swift.String(describing: name)), publicAccessBlock: \(Swift.String(describing: publicAccessBlock)), regions: \(Swift.String(describing: regions)), status: \(Swift.String(describing: status)))"}
}
...
extension S3ControlClientTypes.MultiRegionAccessPointsAsyncResponse: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case regions = "Regions"
    }
...
extension S3ControlClientTypes.MultiRegionAccessPointsAsyncResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MultiRegionAccessPointsAsyncResponse(regions: \(Swift.String(describing: regions)))"}
}
...
extension S3ControlClientTypes.ProposedMultiRegionAccessPointPolicy: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case policy = "Policy"
    }
...
extension S3ControlClientTypes.ProposedMultiRegionAccessPointPolicy: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ProposedMultiRegionAccessPointPolicy(policy: \(Swift.String(describing: policy)))"}
}
...
public struct PutAccessPointConfigurationForObjectLambdaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointConfigurationForObjectLambdaInputURLHostMiddleware"
    ...
    public typealias MInput = PutAccessPointConfigurationForObjectLambdaInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutAccessPointConfigurationForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutAccessPointConfigurationForObjectLambdaOutputError>
}

public struct PutAccessPointConfigurationForObjectLambdaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointConfigurationForObjectLambdaInputURLPathMiddleware"
...
public struct PutAccessPointPolicyForObjectLambdaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointPolicyForObjectLambdaInputURLHostMiddleware"
    ...
    public typealias MInput = PutAccessPointPolicyForObjectLambdaInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutAccessPointPolicyForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutAccessPointPolicyForObjectLambdaOutputError>
}

public struct PutAccessPointPolicyForObjectLambdaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointPolicyForObjectLambdaInputURLPathMiddleware"
...
public struct PutAccessPointPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = PutAccessPointPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutAccessPointPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutAccessPointPolicyOutputError>
}

public struct PutAccessPointPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointPolicyInputURLPathMiddleware"
...
public struct PutAccessPointPolicyInput: Swift.Equatable {
    ...
    /// This member is required.
    public var name: Swift.String?
    /// The policy that you want to apply to the specified access point. For more information about access point policies, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-points.html">Managing data access with Amazon S3 access points in the Amazon S3 User Guide.
    /// This member is required.
    public var policy: Swift.String?
...
public struct PutBucketLifecycleConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutBucketLifecycleConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = PutBucketLifecycleConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutBucketLifecycleConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutBucketLifecycleConfigurationOutputError>
}

public struct PutBucketLifecycleConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutBucketLifecycleConfigurationInputURLPathMiddleware"
...
public struct PutBucketPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutBucketPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = PutBucketPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutBucketPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutBucketPolicyOutputError>
}

public struct PutBucketPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutBucketPolicyInputURLPathMiddleware"
...
public struct PutBucketTaggingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutBucketTaggingInputURLHostMiddleware"
    ...
    public typealias MInput = PutBucketTaggingInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutBucketTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutBucketTaggingOutputError>
}

public struct PutBucketTaggingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutBucketTaggingInputURLPathMiddleware"
...
public struct PutJobTaggingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutJobTaggingInputURLHostMiddleware"
    ...
    public typealias MInput = PutJobTaggingInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutJobTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutJobTaggingOutputError>
}

public struct PutJobTaggingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutJobTaggingInputURLPathMiddleware"
...
public struct PutMultiRegionAccessPointPolicyInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutMultiRegionAccessPointPolicyInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutMultiRegionAccessPointPolicyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutMultiRegionAccessPointPolicyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutMultiRegionAccessPointPolicyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutMultiRegionAccessPointPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutMultiRegionAccessPointPolicyOutputError>
}

extension S3ControlClientTypes.PutMultiRegionAccessPointPolicyInput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case policy = "Policy"
    }
...
extension PutMultiRegionAccessPointPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutMultiRegionAccessPointPolicyInput(accountId: \(Swift.String(describing: accountId)), clientToken: \(Swift.String(describing: clientToken)), details: \(Swift.String(describing: details)))"}
}

extension S3ControlClientTypes.PutMultiRegionAccessPointPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutMultiRegionAccessPointPolicyInput(name: \(Swift.String(describing: name)), policy: \(Swift.String(describing: policy)))"}
}
...
extension PutMultiRegionAccessPointPolicyInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientToken = "ClientToken"
        case details = "Details"
    }
...
public struct PutMultiRegionAccessPointPolicyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutMultiRegionAccessPointPolicyInputHeadersMiddleware"
...
public struct PutMultiRegionAccessPointPolicyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutMultiRegionAccessPointPolicyInputQueryItemMiddleware"
...
public struct PutMultiRegionAccessPointPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutMultiRegionAccessPointPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = PutMultiRegionAccessPointPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutMultiRegionAccessPointPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutMultiRegionAccessPointPolicyOutputError>
}

public struct PutMultiRegionAccessPointPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutMultiRegionAccessPointPolicyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v20180820/async-requests/mrap/put-policy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct PutMultiRegionAccessPointPolicyInputBody: Swift.Equatable {
    public let clientToken: Swift.String?
    public let details: S3ControlClientTypes.PutMultiRegionAccessPointPolicyInput?
}
...
extension PutMultiRegionAccessPointPolicyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutMultiRegionAccessPointPolicyOutputResponse(requestTokenARN: \(Swift.String(describing: requestTokenARN)))"}
}
...
public struct PutPublicAccessBlockInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutPublicAccessBlockInputURLHostMiddleware"
    ...
    public typealias MInput = PutPublicAccessBlockInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutPublicAccessBlockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutPublicAccessBlockOutputError>
}

public struct PutPublicAccessBlockInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutPublicAccessBlockInputURLPathMiddleware"
...
public struct PutStorageLensConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStorageLensConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = PutStorageLensConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutStorageLensConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutStorageLensConfigurationOutputError>
}

public struct PutStorageLensConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStorageLensConfigurationInputURLPathMiddleware"
...
public struct PutStorageLensConfigurationTaggingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStorageLensConfigurationTaggingInputURLHostMiddleware"
    ...
    public typealias MInput = PutStorageLensConfigurationTaggingInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutStorageLensConfigurationTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutStorageLensConfigurationTaggingOutputError>
}

public struct PutStorageLensConfigurationTaggingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStorageLensConfigurationTaggingInputURLPathMiddleware"
...
extension S3ControlClientTypes.Region: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bucket = "Bucket"
    }
...
extension S3ControlClientTypes.Region: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Region(bucket: \(Swift.String(describing: bucket)))"}
}
...
extension S3ControlClientTypes.RegionReport: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bucket = "Bucket"
        case region = "Region"
    }
...
extension S3ControlClientTypes.RegionReport: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RegionReport(bucket: \(Swift.String(describing: bucket)), region: \(Swift.String(describing: region)))"}
}
...
extension S3ControlClientTypes {
    ...
    ///          API. For more information about the parameters for this operation, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectCOPY.html">PUT Object - Copy.
...
extension S3ControlClientTypes {
    ...
    ///          more information about the parameters for this operation, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectPOSTrestore.html#RESTObjectPOSTrestore-restore-request">RestoreObject.
...
extension S3ControlClientTypes {
    ...
    ///          For more information about the parameters for this operation, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectPUTacl.html">PUT Object acl.
...
extension S3ControlClientTypes {
    ...
    ///          For more information about the parameters for this operation, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectPUTtagging.html">PUT Object tagging.
...
public struct UpdateJobPriorityInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobPriorityInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateJobPriorityInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateJobPriorityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateJobPriorityOutputError>
}

public struct UpdateJobPriorityInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobPriorityInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/jobs/\(jobId.urlPercentEncoding())/priority"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdateJobStatusInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobStatusInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateJobStatusInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateJobStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateJobStatusOutputError>
}

public struct UpdateJobStatusInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobStatusInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v20180820/jobs/\(jobId.urlPercentEncoding())/status"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
