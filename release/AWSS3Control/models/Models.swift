...
extension S3ControlClientTypes.JobManifestGeneratorFilter: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if eligibleForReplication != false {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let eligibleForReplicationDecoded = try containerValues.decode(Swift.Bool.self, forKey: .eligibleForReplication)
        ...
        if containerValues.contains(.objectReplicationStatuses) {
            ...
            if let objectReplicationStatusesWrappedContainer = objectReplicationStatusesWrappedContainer {
                ...
                if let objectReplicationStatusesContainer = objectReplicationStatusesContainer {
                    ...
                    for stringContainer0 in objectReplicationStatusesContainer {
                        objectReplicationStatusesBuffer?.append(stringContainer0)
                    }
                }
...
extension S3ControlClientTypes.JobTimers: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if elapsedTimeInActiveSeconds != 0 {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let elapsedTimeInActiveSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .elapsedTimeInActiveSeconds)
