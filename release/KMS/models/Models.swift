...
public struct CancelKeyDeletionOutputResponse: Swift.Equatable {
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the CMK whose deletion is canceled.
    public let keyId: Swift.String?
...
///       cluster certificate of a cluster, use the <a href="https://docs.aws.amazon.com/cloudhsm/latest/APIReference/API_DescribeClusters.html">DescribeClusters operation.
...
///           them. To get information about a particular security group, use the <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeSecurityGroups.html">DescribeSecurityGroups operation.
///
///
///                The cluster must contain at least as many HSMs as the operation requires. To add HSMs,
///           use the AWS CloudHSM <a href="https://docs.aws.amazon.com/cloudhsm/latest/APIReference/API_CreateHsm.html">CreateHsm operation.
...
///       custom key store, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/create-keystore.html#before-keystore">Assemble the Prerequisites
...
///       detailed instructions, see <a href="https://docs.aws.amazon.com/cloudhsm/latest/userguide/getting-started.html">Getting Started in the AWS CloudHSM User Guide.
...
public struct CreateAliasInput: Swift.Equatable {
    ...
    ///       for <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-managed-cmk">AWS managed CMKs.
    /// This member is required.
    public let aliasName: Swift.String?
    /// Associates the alias with the specified <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk">customer managed CMK. The CMK must be
    ///       in the same AWS Region.
    ///          A valid CMK ID is required. If you supply a null or empty string value, this operation
    ///       returns an error.
    ///          For help finding the key ID and ARN, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/viewing-keys.html#find-cmk-id-arn">Finding the Key ID and
...
public struct CreateCustomKeyStoreInput: Swift.Equatable {
    ...
    ///       use the <a href="https://docs.aws.amazon.com/cloudhsm/latest/APIReference/API_DescribeClusters.html">DescribeClusters operation.
    /// This member is required.
    ...
    ///       the customerCA.crt file that you created when you <a href="https://docs.aws.amazon.com/cloudhsm/latest/userguide/initialize-cluster.html">initialized the cluster.
    /// This member is required.
...
public struct CreateGrantInput: Swift.Equatable {
    ...
    ///       384 characters.
    ///          These grant constraints allow a <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations">cryptographic operation only when the encryption context in the
    ...
    ///       For more information about encryption context, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context">Encryption Context in the
    ///
    ...
    ///          Use a grant token when your permission to call this operation comes from a new grant that has not yet achieved eventual consistency. For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token">Grant token in the
    ///     AWS Key Management Service Developer Guide.
    public let grantTokens: [Swift.String]?
    /// The identity that gets the permissions specified in the grant.
    ///          To specify the principal, use the <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Name (ARN) of an AWS
    ...
    ///         ValidationError exception. For details, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#terms-grant-operations">Grant operations in the
    ///       AWS Key Management Service Developer Guide.
    /// This member is required.
    ...
    ///         <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-iam">AWS Identity and Access Management (IAM) in the Example ARNs section of the
...
extension CreateKeyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateKeyInput(bypassPolicyLockoutSafetyCheck: \(Swift.String(describing: bypassPolicyLockoutSafetyCheck)), customKeyStoreId: \(Swift.String(describing: customKeyStoreId)), customerMasterKeySpec: \(Swift.String(describing: customerMasterKeySpec)), description: \(Swift.String(describing: description)), keyUsage: \(Swift.String(describing: keyUsage)), multiRegion: \(Swift.String(describing: multiRegion)), origin: \(Swift.String(describing: origin)), policy: \(Swift.String(describing: policy)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct CreateKeyInput: Swift.Equatable {
    ...
    ///             For more information, refer to the scenario in the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default-allow-root-enable-iam">Default Key Policy section in the
    ///                   AWS Key Management Service Developer Guide
    ///                .
    ///
    ...
    /// Creates the CMK in the specified <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store and the key material in its associated
    ...
    ///       key in its key policy or IAM policy. For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/policy-conditions.html#conditions-kms-encryption-algorithm">kms:EncryptionAlgorithm or <a href="https://docs.aws.amazon.com/kms/latest/developerguide/policy-conditions.html#conditions-kms-signing-algorithm">kms:Signing Algorithm in the AWS Key Management Service Developer
    ///         Guide.
    ///
    ///
    ...
    /// Determines the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations">cryptographic operations for which you can use the CMK. The default value is
    ...
    ///       a custom key store.
    public let multiRegion: Swift.Bool?
    ...
    ///          To create a CMK in an AWS KMS <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store and create its key material in the associated
    ...
    ///           the CMK becomes unmanageable. For more information, refer to the scenario in the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default-allow-root-enable-iam">Default Key Policy section of the
    ///                      AWS Key Management Service Developer Guide
    ///                   .
    ///
    ///
    ...
    ///           to AWS KMS. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/troubleshoot_general.html#troubleshoot_general_eventual-consistency">Changes that I make are not always immediately visible in the AWS
    ///             Identity and Access Management User Guide.
    ///
    ///
    ///          If you do not provide a key policy, AWS KMS attaches a default key policy to the CMK. For
    ///       more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default">Default Key Policy in the
    ///       AWS Key Management Service Developer Guide.
    ...
    ///
    ///          To use this parameter, you must have <a href="https://docs.aws.amazon.com/kms/latest/developerguide/kms-api-permissions-reference.html">kms:TagResource permission in an IAM policy.
    ...
    ///               see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/tagging-keys.html">Tagging Keys.
...
extension KmsClientTypes {
    ...
    public struct CustomKeyStoresListEntry: Swift.Equatable {
        ...
        ///             kmsuser crypto user in the AWS CloudHSM cluster. Before you can connect your
        ...
        ///           store to its AWS CloudHSM cluster, you must log the kmsuser CU out of the cluster.
        ...
        ///       For help resolving a connection failure, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore.html">Troubleshooting a Custom Key Store in the
        ///       AWS Key Management Service Developer Guide.
        ...
        public let customKeyStoreName: Swift.String?
        /// The trust anchor certificate of the associated AWS CloudHSM cluster. When you <a href="https://docs.aws.amazon.com/cloudhsm/latest/userguide/initialize-cluster.html#sign-csr">initialize the
...
public struct DecryptInput: Swift.Equatable {
    ...
    ///       An encryption context is valid only for <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations">cryptographic operations with a symmetric CMK. The standard asymmetric encryption algorithms that AWS KMS uses do not support an encryption context.
    ...
    ///       grant that has not yet achieved eventual consistency. Use a grant token when your permission to call this operation comes from a new grant that has not yet achieved eventual consistency. For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token">Grant token in the
    ///     AWS Key Management Service Developer Guide.
    public let grantTokens: [Swift.String]?
...
public struct DecryptOutputResponse: Swift.Equatable {
    ...
    public let encryptionAlgorithm: KmsClientTypes.EncryptionAlgorithmSpec?
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the CMK that was used to decrypt the ciphertext.
    public let keyId: Swift.String?
...
public struct DisableKeyRotationInput: Swift.Equatable {
    ...
    ///       rotation of <a href="https://docs.aws.amazon.com/kms/latest/developerguide/symmetric-asymmetric.html#asymmetric-cmks">asymmetric CMKs, CMKs
    ///       with <a href="https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys.html">imported key
    ///         material, or CMKs in a <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store.
    ///          Specify the key ID or key ARN of the CMK.
    ///          For example:
    ///
    ///
...
public struct EncryptOutputResponse: Swift.Equatable {
    ...
    public let encryptionAlgorithm: KmsClientTypes.EncryptionAlgorithmSpec?
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the CMK that was used to encrypt the plaintext.
    public let keyId: Swift.String?
...
public struct GenerateDataKeyOutputResponse: Swift.Equatable {
    ...
    public let ciphertextBlob: ClientRuntime.Data?
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the CMK that encrypted the data key.
    public let keyId: Swift.String?
...
public struct GenerateDataKeyPairOutputResponse: Swift.Equatable {
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the CMK that encrypted the private key.
    public let keyId: Swift.String?
...
public struct GenerateRandomInput: Swift.Equatable {
    ...
    ///       specified <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store. To find the ID of a custom key store, use the DescribeCustomKeyStores operation.
    public let customKeyStoreId: Swift.String?
...
public struct GetParametersForImportInput: Swift.Equatable {
    ...
    /// This member is required.
    public let keyId: Swift.String?
    /// The algorithm you will use to encrypt the key material before importing it with ImportKeyMaterial. For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys-encrypt-key-material.html">Encrypt the Key Material
...
public struct GetParametersForImportOutputResponse: Swift.Equatable {
    ...
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the CMK to use in a subsequent ImportKeyMaterial
...
public struct GetPublicKeyOutputResponse: Swift.Equatable {
    ...
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the asymmetric CMK from which the public key was downloaded.
    public let keyId: Swift.String?
    ...
    ///         SubjectPublicKeyInfo (SPKI), as defined in <a href="https://tools.ietf.org/html/rfc5280">RFC 5280. When you use the HTTP API or the AWS CLI, the value is Base64-encoded. Otherwise, it is not Base64-encoded.
    ///
    public let publicKey: ClientRuntime.Data?
...
extension KmsClientTypes {
    /// Use this structure to allow <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations">cryptographic operations in the grant only when the operation request
    ///       includes the specified <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context">encryption context.
    ///          AWS KMS applies the grant constraints only to cryptographic operations that support an
    ///       encryption context, that is, all cryptographic operations with a <a href="https://docs.aws.amazon.com/kms/latest/developerguide/symm-asymm-concepts.html#symmetric-cmks">symmetric CMK. Grant
    ...
    ///         in an IAM or key policy. For details, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/policy-conditions.html#conditions-kms-encryption-context">kms:EncryptionContext: in the
    ///                   AWS Key Management Service Developer Guide
    ///                .
    ///
    public struct GrantConstraints: Swift.Equatable {
        /// A list of key-value pairs that must match the encryption context in the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations">cryptographic operation
        ...
        ///       <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations">cryptographic operation request. The grant allows the cryptographic operation only when the encryption
...
///          When you <a href="https://docs.aws.amazon.com/cloudhsm/latest/userguide/initialize-cluster.html#sign-csr">initialize the cluster, you create the trust anchor certificate and save it in the
///         customerCA.crt file.
...
///       request.
///          For more information about how key state affects the use of a CMK, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">How Key State Affects Use of a
...
extension KmsClientTypes.KeyMetadata: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "KeyMetadata(aWSAccountId: \(Swift.String(describing: aWSAccountId)), arn: \(Swift.String(describing: arn)), cloudHsmClusterId: \(Swift.String(describing: cloudHsmClusterId)), creationDate: \(Swift.String(describing: creationDate)), customKeyStoreId: \(Swift.String(describing: customKeyStoreId)), customerMasterKeySpec: \(Swift.String(describing: customerMasterKeySpec)), deletionDate: \(Swift.String(describing: deletionDate)), description: \(Swift.String(describing: description)), enabled: \(Swift.String(describing: enabled)), encryptionAlgorithms: \(Swift.String(describing: encryptionAlgorithms)), expirationModel: \(Swift.String(describing: expirationModel)), keyId: \(Swift.String(describing: keyId)), keyManager: \(Swift.String(describing: keyManager)), keyState: \(Swift.String(describing: keyState)), keyUsage: \(Swift.String(describing: keyUsage)), multiRegion: \(Swift.String(describing: multiRegion)), multiRegionConfiguration: \(Swift.String(describing: multiRegionConfiguration)), origin: \(Swift.String(describing: origin)), pendingDeletionWindowInDays: \(Swift.String(describing: pendingDeletionWindowInDays)), signingAlgorithms: \(Swift.String(describing: signingAlgorithms)), validTo: \(Swift.String(describing: validTo)))"}
}
...
extension KmsClientTypes {
    ...
    public struct KeyMetadata: Swift.Equatable {
        ...
        /// The Amazon Resource Name (ARN) of the CMK. For examples, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kms">AWS Key Management Service
        ...
        ///       create a CMK in a <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store, AWS KMS creates the key material for the CMK in the
        ///       associated AWS CloudHSM cluster. This value is present only when the CMK is created in a custom key
        ///       store.
        public let cloudHsmClusterId: Swift.String?
        /// The date and time when the CMK was created.
        public let creationDate: ClientRuntime.Date?
        /// A unique identifier for the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store that contains the CMK. This value is present
        ...
        ///       managed. For more information about the difference, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#master_keys">Customer Master Keys in the
        ///       AWS Key Management Service Developer Guide.
        public let keyManager: KmsClientTypes.KeyManagerType?
        /// The current status of the CMK.
        ///          For more information about how key state affects the use of a CMK, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key state: Effect on your CMK
        ///       in the AWS Key Management Service Developer Guide.
        public let keyState: KmsClientTypes.KeyState?
        /// The <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations">cryptographic operations for which you can use the CMK.
        public let keyUsage: KmsClientTypes.KeyUsageType?
        ...
        ///          For more information about multi-Region keys, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-overview.html">Using multi-Region keys in the AWS Key Management Service Developer Guide.
        public let multiRegion: Swift.Bool?
        ...
        ///
        ///
        public let multiRegionConfiguration: KmsClientTypes.MultiRegionConfiguration?
        ...
        public let pendingDeletionWindowInDays: Swift.Int?
...
/// The request was rejected because a quota was exceeded. For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/limits.html">Quotas in the
///       AWS Key Management Service Developer Guide.
...
public struct ListRetirableGrantsInput: Swift.Equatable {
    ...
    ///       account.
    ///          To specify the retiring principal, use the <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Name (ARN) of an AWS
    ///       principal. Valid AWS principals include AWS accounts (root), IAM users, federated users, and
...
extension KmsClientTypes.MultiRegionConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension KmsClientTypes.MultiRegionConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MultiRegionConfiguration(multiRegionKeyType: \(Swift.String(describing: multiRegionKeyType)), primaryKey: \(Swift.String(describing: primaryKey)), replicaKeys: \(Swift.String(describing: replicaKeys)))"}
}
...
extension KmsClientTypes.MultiRegionKey: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
        case region = "Region"
    }
...
extension KmsClientTypes.MultiRegionKey: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MultiRegionKey(arn: \(Swift.String(describing: arn)), region: \(Swift.String(describing: region)))"}
}
...
public struct PutKeyPolicyInput: Swift.Equatable {
    ...
    ///             Setting this value to true increases the risk that the CMK becomes unmanageable. Do not
    ///         set this value to true indiscriminately.
    ///             For more information, refer to the scenario in the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default-allow-root-enable-iam">Default Key Policy section in the AWS Key Management Service Developer Guide.
    ///
    ...
    ///           subsequent PutKeyPolicy request on the CMK. This reduces the risk that the
    ///           CMK becomes unmanageable. For more information, refer to the scenario in the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default-allow-root-enable-iam">Default Key Policy section of the AWS Key Management Service Developer Guide.
    ///
    ///
    ///                Each statement in the key policy must contain one or more principals. The principals
    ///           in the key policy must exist and be visible to AWS KMS. When you create a new AWS principal
    ...
    ///
    ///
    ///          The key policy cannot exceed 32 kilobytes (32768 bytes). For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/resource-limits.html">Resource Quotas in the
    ///       AWS Key Management Service Developer Guide.
    /// This member is required.
    public let policy: Swift.String?
...
public struct ReEncryptOutputResponse: Swift.Equatable {
    ...
    public let destinationEncryptionAlgorithm: KmsClientTypes.EncryptionAlgorithmSpec?
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the CMK that was used to reencrypt the data.
    public let keyId: Swift.String?
...
public struct ReplicateKeyInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReplicateKeyInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ReplicateKeyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ReplicateKeyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ReplicateKeyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ReplicateKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ReplicateKeyOutputError>
}

extension ReplicateKeyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ReplicateKeyInput(bypassPolicyLockoutSafetyCheck: \(Swift.String(describing: bypassPolicyLockoutSafetyCheck)), description: \(Swift.String(describing: description)), keyId: \(Swift.String(describing: keyId)), policy: \(Swift.String(describing: policy)), replicaRegion: \(Swift.String(describing: replicaRegion)), tags: \(Swift.String(describing: tags)))"}
}

extension ReplicateKeyInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bypassPolicyLockoutSafetyCheck = "BypassPolicyLockoutSafetyCheck"
        case description = "Description"
        case keyId = "KeyId"
...
public struct ReplicateKeyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReplicateKeyInputHeadersMiddleware"
...
public struct ReplicateKeyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReplicateKeyInputQueryItemMiddleware"
...
public struct ReplicateKeyInput: Swift.Equatable {
    ...
    /// This member is required.
    public let keyId: Swift.String?
    /// The key policy to attach to the CMK. This parameter is optional. If you do not provide a key policy, AWS KMS attaches the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default">default key policy to the CMK.
    ...
    ///
    ///                If you don't set BypassPolicyLockoutSafetyCheck to true, the key policy
    ///           must give the caller kms:PutKeyPolicy permission on the replica CMK. This reduces the
    ///           risk that the CMK becomes unmanageable. For more information, refer to the scenario in the
    ///             <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default-allow-root-enable-iam">Default Key Policy section of the
    ///                      AWS Key Management Service Developer Guide
    ///                   .
    ///
    ///
    ...
    ///       list of AWS Regions in which AWS KMS is supported, see <a href="https://docs.aws.amazon.com/general/latest/gr/kms.html#kms_region">AWS KMS service endpoints in the
    ///       Amazon Web Services General Reference.
    ...
    ///       Region.
    ///          For information about AWS partitions, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs) in the
    ///         Amazon Web Services General Reference. For information about enabling and disabling Regions, see <a href="https://docs.aws.amazon.com/general/latest/gr/rande-manage.html#rande-manage-enable">Enabling a
    ///         Region and <a href="https://docs.aws.amazon.com/general/latest/gr/rande-manage.html#rande-manage-disable">Disabling a Region in the
    ///       Amazon Web Services General Reference.
    /// This member is required.
    public let replicaRegion: Swift.String?
...
extension ReplicateKeyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ReplicateKeyOutputResponse(replicaKeyMetadata: \(Swift.String(describing: replicaKeyMetadata)), replicaPolicy: \(Swift.String(describing: replicaPolicy)), replicaTags: \(Swift.String(describing: replicaTags)))"}
}
...
public struct ReplicateKeyOutputResponse: Swift.Equatable {
    /// Displays details about the new replica CMK, including its Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key
    ///       ARN) and <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">key state. It also includes the ARN and AWS Region of its primary key and other
    ///       replica keys.
    public let replicaKeyMetadata: KmsClientTypes.KeyMetadata?
    /// The key policy of the new replica key. The value is a key policy document in JSON
    ///       format.
    public let replicaPolicy: Swift.String?
    /// The tags on the new replica key. The value is a list of tag key and tag value
    ///       pairs.
    public let replicaTags: [KmsClientTypes.Tag]?
...
public struct RetireGrantInput: Swift.Equatable {
    ...
    ///         <a href="https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#grant_token">Grant token
    ///       and <a href="https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#terms-eventual-consistency">Eventual consistency in the AWS Key Management Service Developer Guide.
    public let grantToken: Swift.String?
...
extension ScheduleKeyDeletionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ScheduleKeyDeletionOutputResponse(deletionDate: \(Swift.String(describing: deletionDate)), keyId: \(Swift.String(describing: keyId)), keyState: \(Swift.String(describing: keyState)), pendingWindowInDays: \(Swift.String(describing: pendingWindowInDays)))"}
}
...
public struct ScheduleKeyDeletionOutputResponse: Swift.Equatable {
    ...
    ///       deleted.
    public let deletionDate: ClientRuntime.Date?
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the CMK whose deletion is scheduled.
    public let keyId: Swift.String?
    /// The current status of the CMK.
    ///          For more information about how key state affects the use of a CMK, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key state: Effect on your CMK
    ///       in the AWS Key Management Service Developer Guide.
...
public struct SignOutputResponse: Swift.Equatable {
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the asymmetric CMK that was used to sign the message.
    public let keyId: Swift.String?
    ...
    ///           defined by ANS X9.62–2005 and <a href="https://tools.ietf.org/html/rfc3279#section-2.2.3">RFC 3279 Section 2.2.3.
...
extension KmsClientTypes {
    ...
    ///          For information about the rules that apply to tag keys and tag values, see <a href="https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/allocation-tag-restrictions.html">User-Defined Tag Restrictions in the AWS Billing and Cost Management User
    ///         Guide.
...
public struct UpdateAliasInput: Swift.Equatable {
    ...
    /// This member is required.
    public let aliasName: Swift.String?
    /// Identifies the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk">customer managed CMK to associate with the alias. You don't have permission to
    ///       associate an alias with an <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-managed-cmk">AWS managed CMK.
...
public struct UpdateCustomKeyStoreInput: Swift.Equatable {
    ...
    ///       cluster. In addition, the replacement cluster must <a href="https://docs.aws.amazon.com/kms/latest/developerguide/create-keystore.html#before-keystore">fulfill the requirements for
...
public struct UpdatePrimaryRegionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePrimaryRegionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdatePrimaryRegionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdatePrimaryRegionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdatePrimaryRegionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdatePrimaryRegionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdatePrimaryRegionOutputError>
}

extension UpdatePrimaryRegionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdatePrimaryRegionInput(keyId: \(Swift.String(describing: keyId)), primaryRegion: \(Swift.String(describing: primaryRegion)))"}
}

extension UpdatePrimaryRegionInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case keyId = "KeyId"
...
public struct UpdatePrimaryRegionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePrimaryRegionInputHeadersMiddleware"
...
public struct UpdatePrimaryRegionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePrimaryRegionInputQueryItemMiddleware"
...
extension UpdatePrimaryRegionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdatePrimaryRegionOutputResponse()"}
}
...
struct UpdatePrimaryRegionOutputResponseBody: Swift.Equatable {
}

extension UpdatePrimaryRegionOutputResponseBody: Swift.Decodable {
...
public struct VerifyOutputResponse: Swift.Equatable {
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the asymmetric CMK that was used to verify the signature.
    public let keyId: Swift.String?
