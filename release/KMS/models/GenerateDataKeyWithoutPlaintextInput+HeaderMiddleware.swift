...
public struct GenerateDataKeyWithoutPlaintextInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GenerateDataKeyWithoutPlaintextOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GenerateDataKeyWithoutPlaintextOutput>
