...
extension CodeartifactClientTypes {
    ...
    public struct AssetSummary: Swift.Equatable {
        ...
        var hashes: [Swift.String:Swift.String]?
...
public struct AssociateExternalConnectionInput: Swift.Equatable {
    ...
    /// This member is required.
    var externalConnection: Swift.String?
...
public struct AssociateExternalConnectionOutputResponse: Swift.Equatable {
    ...
    var repository: CodeartifactClientTypes.RepositoryDescription?
...
public struct CopyPackageVersionsInput: Swift.Equatable {
    ...
    var allowOverwrite: Swift.Bool?
    /// The name of the repository into which package versions are copied.
    /// This member is required.
    var destinationRepository: Swift.String?
    ...
    /// This member is required.
    var format: CodeartifactClientTypes.PackageFormat?
    ...
    var includeFromUpstream: Swift.Bool?
    ...
    /// This member is required.
    var sourceRepository: Swift.String?
    ...
    var versionRevisions: [Swift.String:Swift.String]?
...
public struct CopyPackageVersionsOutputResponse: Swift.Equatable {
    ...
    ///
    /// * SKIPPED
    var failedVersions: [Swift.String:CodeartifactClientTypes.PackageVersionError]?
    /// A list of the package versions that were successfully copied to your repository.
    var successfulVersions: [Swift.String:CodeartifactClientTypes.SuccessfulPackageVersionInfo]?
...
public struct CreateDomainInput: Swift.Equatable {
    ...
    var tags: [CodeartifactClientTypes.Tag]?
...
public struct CreateDomainOutputResponse: Swift.Equatable {
    ...
    var domain: CodeartifactClientTypes.DomainDescription?
...
public struct CreateRepositoryInput: Swift.Equatable {
    ...
    var upstreams: [CodeartifactClientTypes.UpstreamRepository]?
...
public struct DeleteDomainPermissionsPolicyInput: Swift.Equatable {
    ...
    var policyRevision: Swift.String?
...
public struct DeleteDomainPermissionsPolicyOutputResponse: Swift.Equatable {
    ...
    var policy: CodeartifactClientTypes.ResourcePolicy?
...
public struct DeletePackageVersionsInput: Swift.Equatable {
    ...
    ///
    /// * Disposed
    var expectedStatus: CodeartifactClientTypes.PackageVersionStatus?
...
public struct DescribePackageVersionInput: Swift.Equatable {
    ...
    /// This member is required.
    var packageVersion: Swift.String?
...
public struct DescribePackageVersionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var packageVersion: CodeartifactClientTypes.PackageVersionDescription?
...
extension CodeartifactClientTypes {
    ...
    public struct DomainDescription: Swift.Equatable {
        ...
        ///
        /// * Deleted
        var status: CodeartifactClientTypes.DomainStatus?
...
public struct GetAuthorizationTokenOutputResponse: Swift.Equatable {
    ...
    var expiration: ClientRuntime.Date?
...
public struct GetPackageVersionAssetInput: Swift.Equatable {
    ...
    var packageVersionRevision: Swift.String?
...
public struct GetPackageVersionAssetOutputResponse: Swift.Equatable {
    ...
    var asset: ClientRuntime.ByteStream?
    /// The name of the asset that is downloaded.
    var assetName: Swift.String?
    /// A string that contains the package version (for example, 3.5.2).
    var packageVersion: Swift.String?
...
public struct GetPackageVersionReadmeOutputResponse: Swift.Equatable {
    ...
    var readme: Swift.String?
    /// The version of the package with the requested readme file.
    var version: Swift.String?
    /// The current revision associated with the package version.
    var versionRevision: Swift.String?
...
public struct GetRepositoryEndpointOutputResponse: Swift.Equatable {
    ...
    var repositoryEndpoint: Swift.String?
...
public struct ListDomainsOutputResponse: Swift.Equatable {
    ...
    var domains: [CodeartifactClientTypes.DomainSummary]?
    /// The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct ListPackageVersionAssetsOutputResponse: Swift.Equatable {
    ...
    var assets: [CodeartifactClientTypes.AssetSummary]?
...
public struct ListPackageVersionDependenciesOutputResponse: Swift.Equatable {
    ...
    var dependencies: [CodeartifactClientTypes.PackageDependency]?
...
public struct ListPackageVersionsInput: Swift.Equatable {
    ...
    var sortBy: CodeartifactClientTypes.PackageVersionSortType?
    ...
    ///
    /// * Disposed
    var status: CodeartifactClientTypes.PackageVersionStatus?
...
public struct ListPackageVersionsOutputResponse: Swift.Equatable {
    ...
    var defaultDisplayVersion: Swift.String?
    ...
    var versions: [CodeartifactClientTypes.PackageVersionSummary]?
...
public struct ListPackagesInput: Swift.Equatable {
    ...
    var packagePrefix: Swift.String?
...
public struct ListPackagesOutputResponse: Swift.Equatable {
    ...
    var packages: [CodeartifactClientTypes.PackageSummary]?
...
public struct ListRepositoriesInDomainInput: Swift.Equatable {
    ...
    var administratorAccount: Swift.String?
    ...
    var repositoryPrefix: Swift.String?
...
public struct ListRepositoriesInDomainOutputResponse: Swift.Equatable {
    ...
    var repositories: [CodeartifactClientTypes.RepositorySummary]?
...
extension CodeartifactClientTypes {
    ...
    public struct PackageDependency: Swift.Equatable {
        ...
        var dependencyType: Swift.String?
        /// The namespace of the package. The package component that specifies its namespace depends on its type. For example:
        ///
        /// * The namespace of a Maven package is its groupId.
        ///
        ...
        var versionRequirement: Swift.String?
...
extension CodeartifactClientTypes {
    ...
    public struct PackageVersionDescription: Swift.Equatable {
        ...
        var homePage: Swift.String?
        /// Information about licenses associated with the package version.
        var licenses: [CodeartifactClientTypes.LicenseInfo]?
        /// The namespace of the package. The package component that specifies its namespace depends on its type. For example:
        ///
        /// * The namespace of a Maven package is its groupId.
        ///
        ...
        var packageName: Swift.String?
        /// A timestamp that contains the date and time the package version was published.
        var publishedTime: ClientRuntime.Date?
        /// The revision of the package version.
        var revision: Swift.String?
        /// The repository for the source code in the package version, or the source code used to build it.
        var sourceCodeRepository: Swift.String?
...
extension CodeartifactClientTypes {
    ...
    public struct PackageVersionError: Swift.Equatable {
        ...
        ///
        /// * SKIPPED
        var errorCode: CodeartifactClientTypes.PackageVersionErrorCode?
...
public struct PutDomainPermissionsPolicyInput: Swift.Equatable {
    ...
    /// This member is required.
    var policyDocument: Swift.String?
...
extension CodeartifactClientTypes {
    ...
    public struct RepositoryDescription: Swift.Equatable {
        ...
        var externalConnections: [CodeartifactClientTypes.RepositoryExternalConnectionInfo]?
        /// The name of the repository.
        var name: Swift.String?
        /// A list of upstream repositories to associate with the repository. The order of the upstream repositories in the list determines their priority order when AWS CodeArtifact looks for a requested package version. For more information, see [Working with upstream repositories](https://docs.aws.amazon.com/codeartifact/latest/ug/repos-upstream.html).
        var upstreams: [CodeartifactClientTypes.UpstreamRepositoryInfo]?
...
extension CodeartifactClientTypes {
    ...
    public struct RepositoryExternalConnectionInfo: Swift.Equatable {
        ...
        var externalConnectionName: Swift.String?
        ...
        ///
        /// * maven: A Maven package that contains compiled code in a distributable format, such as a JAR file.
        var packageFormat: CodeartifactClientTypes.PackageFormat?
        /// The status of the external connection of a repository. There is one valid value, Available.
        var status: CodeartifactClientTypes.ExternalConnectionStatus?
...
public struct UpdatePackageVersionsStatusInput: Swift.Equatable {
    ...
    /// This member is required.
    var targetStatus: CodeartifactClientTypes.PackageVersionStatus?
