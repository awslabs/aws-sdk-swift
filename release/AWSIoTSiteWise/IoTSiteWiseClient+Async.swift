...
public extension IoTSiteWiseClient {
    ...
    {
        typealias associateTimeSeriesToAssetPropertyContinuation = CheckedContinuation<AssociateTimeSeriesToAssetPropertyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: associateTimeSeriesToAssetPropertyContinuation) in
            associateTimeSeriesToAssetProperty(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteTimeSeriesContinuation = CheckedContinuation<DeleteTimeSeriesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteTimeSeriesContinuation) in
            deleteTimeSeries(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeTimeSeriesContinuation = CheckedContinuation<DescribeTimeSeriesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeTimeSeriesContinuation) in
            describeTimeSeries(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias disassociateTimeSeriesFromAssetPropertyContinuation = CheckedContinuation<DisassociateTimeSeriesFromAssetPropertyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: disassociateTimeSeriesFromAssetPropertyContinuation) in
            disassociateTimeSeriesFromAssetProperty(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listTimeSeriesContinuation = CheckedContinuation<ListTimeSeriesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTimeSeriesContinuation) in
            listTimeSeries(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
