...
public struct SendSSHPublicKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SendSSHPublicKeyInputURLHostMiddleware"
    ...
    public typealias MInput = SendSSHPublicKeyInput
    public typealias MOutput = ClientRuntime.OperationOutput<SendSSHPublicKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SendSSHPublicKeyOutputError>
}

public struct SendSSHPublicKeyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SendSSHPublicKeyInputURLPathMiddleware"
...
public struct SendSerialConsoleSSHPublicKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SendSerialConsoleSSHPublicKeyInputURLHostMiddleware"
    ...
    public typealias MInput = SendSerialConsoleSSHPublicKeyInput
    public typealias MOutput = ClientRuntime.OperationOutput<SendSerialConsoleSSHPublicKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SendSerialConsoleSSHPublicKeyOutputError>
}

public struct SendSerialConsoleSSHPublicKeyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SendSerialConsoleSSHPublicKeyInputURLPathMiddleware"
...
public struct SendSerialConsoleSSHPublicKeyInput: Swift.Equatable {
    ...
    ///             key. For information about the supported key formats and lengths, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html#how-to-generate-your-own-key-and-import-it-to-aws">Requirements for key pairs in the Amazon EC2 User
    ///             Guide.
    /// This member is required.
    public var sSHPublicKey: Swift.String?
...
///             <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_EnableSerialConsoleAccess.html">EnableSerialConsoleAccess in the Amazon EC2 API Reference.
