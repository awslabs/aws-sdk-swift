...
public struct BatchPutMessageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchPutMessageInputURLHostMiddleware"
    ...
    public typealias MInput = BatchPutMessageInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchPutMessageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchPutMessageOutputError>
}

public struct BatchPutMessageInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchPutMessageInputURLPathMiddleware"
...
public struct CancelPipelineReprocessingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelPipelineReprocessingInputURLHostMiddleware"
    ...
    public typealias MInput = CancelPipelineReprocessingInput
    public typealias MOutput = ClientRuntime.OperationOutput<CancelPipelineReprocessingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelPipelineReprocessingOutputError>
}

public struct CancelPipelineReprocessingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelPipelineReprocessingInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let pipelineName = input.pipelineName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("pipelineName is nil and needs a value for the path of this operation"))))
        }
        guard let reprocessingId = input.reprocessingId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("reprocessingId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/pipelines/\(pipelineName.urlPercentEncoding())/reprocessing/\(reprocessingId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension IoTAnalyticsClientTypes {
    ...
    public struct ChannelStorage: Swift.Equatable {
        ...
        /// Used to store channel data in an S3 bucket managed by IoT Analytics. You can't change the choice
        ///       of S3 storage after the data store is created.
...
extension IoTAnalyticsClientTypes {
    ...
    public struct Column: Swift.Equatable {
        ...
        /// This member is required.
        public var name: Swift.String?
        /// The type of data. For more information about the supported data types, see <a href="https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-common.html">Common data types
...
public struct CreateDatasetContentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateDatasetContentInputURLHostMiddleware"
    ...
    public typealias MInput = CreateDatasetContentInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateDatasetContentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateDatasetContentOutputError>
}

public struct CreateDatasetContentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateDatasetContentInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/datasets/\(datasetName.urlPercentEncoding())/content"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreateDatasetContentInput: Swift.Equatable {
    ...
    ///       content, the dataset must use a <a href="https://docs.aws.amazon.com/iotanalytics/latest/APIReference/API_DeltaTime.html">DeltaTimer filter.
...
extension CreateDatastoreInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateDatastoreInput(datastoreName: \(Swift.String(describing: datastoreName)), datastorePartitions: \(Swift.String(describing: datastorePartitions)), datastoreStorage: \(Swift.String(describing: datastoreStorage)), fileFormatConfiguration: \(Swift.String(describing: fileFormatConfiguration)), retentionPeriod: \(Swift.String(describing: retentionPeriod)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct CreateDatastoreInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateDatastoreInputURLHostMiddleware"
    ...
    public typealias MInput = CreateDatastoreInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateDatastoreOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateDatastoreOutputError>
}

public struct CreateDatastoreInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateDatastoreInputURLPathMiddleware"
...
struct CreateDatastoreInputBody: Swift.Equatable {
    ...
    public let datastorePartitions: IoTAnalyticsClientTypes.DatastorePartitions?
}
...
extension IoTAnalyticsClientTypes.Datastore: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Datastore(arn: \(Swift.String(describing: arn)), creationTime: \(Swift.String(describing: creationTime)), datastorePartitions: \(Swift.String(describing: datastorePartitions)), fileFormatConfiguration: \(Swift.String(describing: fileFormatConfiguration)), lastMessageArrivalTime: \(Swift.String(describing: lastMessageArrivalTime)), lastUpdateTime: \(Swift.String(describing: lastUpdateTime)), name: \(Swift.String(describing: name)), retentionPeriod: \(Swift.String(describing: retentionPeriod)), status: \(Swift.String(describing: status)), storage: \(Swift.String(describing: storage)))"}
}
...
extension IoTAnalyticsClientTypes.DatastoreIotSiteWiseMultiLayerStorage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension IoTAnalyticsClientTypes.DatastoreIotSiteWiseMultiLayerStorage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatastoreIotSiteWiseMultiLayerStorage(customerManagedS3Storage: \(Swift.String(describing: customerManagedS3Storage)))"}
}
...
extension IoTAnalyticsClientTypes.DatastoreIotSiteWiseMultiLayerStorageSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case customerManagedS3Storage
    }
...
extension IoTAnalyticsClientTypes.DatastoreIotSiteWiseMultiLayerStorageSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatastoreIotSiteWiseMultiLayerStorageSummary(customerManagedS3Storage: \(Swift.String(describing: customerManagedS3Storage)))"}
}
...
extension IoTAnalyticsClientTypes.DatastorePartition: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension IoTAnalyticsClientTypes.DatastorePartition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatastorePartition(attributePartition: \(Swift.String(describing: attributePartition)), timestampPartition: \(Swift.String(describing: timestampPartition)))"}
}
...
extension IoTAnalyticsClientTypes.DatastorePartitions: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case partitions
    }
...
extension IoTAnalyticsClientTypes.DatastorePartitions: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatastorePartitions(partitions: \(Swift.String(describing: partitions)))"}
}
...
extension IoTAnalyticsClientTypes.DatastoreStorageSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatastoreStorageSummary(customerManagedS3: \(Swift.String(describing: customerManagedS3)), iotSiteWiseMultiLayerStorage: \(Swift.String(describing: iotSiteWiseMultiLayerStorage)), serviceManagedS3: \(Swift.String(describing: serviceManagedS3)))"}
}
...
extension IoTAnalyticsClientTypes.DatastoreSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatastoreSummary(creationTime: \(Swift.String(describing: creationTime)), datastoreName: \(Swift.String(describing: datastoreName)), datastorePartitions: \(Swift.String(describing: datastorePartitions)), datastoreStorage: \(Swift.String(describing: datastoreStorage)), fileFormatType: \(Swift.String(describing: fileFormatType)), lastMessageArrivalTime: \(Swift.String(describing: lastMessageArrivalTime)), lastUpdateTime: \(Swift.String(describing: lastUpdateTime)), status: \(Swift.String(describing: status)))"}
}
...
public struct DeleteChannelInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/channels/\(channelName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteDatasetContentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteDatasetContentInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteDatasetContentInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteDatasetContentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteDatasetContentOutputError>
}

public struct DeleteDatasetContentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteDatasetContentInputURLPathMiddleware"
...
public struct DeleteDatasetInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/datasets/\(datasetName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteDatastoreInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteDatastoreInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteDatastoreInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteDatastoreOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteDatastoreOutputError>
}

public struct DeleteDatastoreInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteDatastoreInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let datastoreName = input.datastoreName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("datastoreName is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/datastores/\(datastoreName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeletePipelineInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/pipelines/\(pipelineName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeDatastoreInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeDatastoreInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeDatastoreInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeDatastoreOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeDatastoreOutputError>
}

public struct DescribeDatastoreInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeDatastoreInputURLPathMiddleware"
...
public struct DescribeLoggingOptionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeLoggingOptionsInputURLHostMiddleware"
...
public struct DescribePipelineInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePipelineInputURLHostMiddleware"
    ...
    public typealias MInput = DescribePipelineInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribePipelineOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribePipelineOutputError>
}

public struct DescribePipelineInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePipelineInputURLPathMiddleware"
...
public struct GetDatasetContentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDatasetContentInputURLHostMiddleware"
    ...
    public typealias MInput = GetDatasetContentInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetDatasetContentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetDatasetContentOutputError>
}

public struct GetDatasetContentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDatasetContentInputURLPathMiddleware"
...
extension IoTAnalyticsClientTypes {
    ...
    public struct GlueConfiguration: Swift.Equatable {
        /// The name of the database in your Glue Data Catalog in which the table is located. An
...
extension IoTAnalyticsClientTypes.IotSiteWiseCustomerManagedDatastoreS3Storage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bucket
        case keyPrefix
    }
...
extension IoTAnalyticsClientTypes.IotSiteWiseCustomerManagedDatastoreS3Storage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IotSiteWiseCustomerManagedDatastoreS3Storage(bucket: \(Swift.String(describing: bucket)), keyPrefix: \(Swift.String(describing: keyPrefix)))"}
}
...
extension IoTAnalyticsClientTypes.IotSiteWiseCustomerManagedDatastoreS3StorageSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bucket
        case keyPrefix
    }
...
extension IoTAnalyticsClientTypes.IotSiteWiseCustomerManagedDatastoreS3StorageSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IotSiteWiseCustomerManagedDatastoreS3StorageSummary(bucket: \(Swift.String(describing: bucket)), keyPrefix: \(Swift.String(describing: keyPrefix)))"}
}
...
public struct ListDatasetContentsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDatasetContentsInputURLHostMiddleware"
    ...
    public typealias MInput = ListDatasetContentsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListDatasetContentsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListDatasetContentsOutputError>
}

public struct ListDatasetContentsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDatasetContentsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/datasets/\(datasetName.urlPercentEncoding())/contents"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListDatastoresInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDatastoresInputURLHostMiddleware"
    ...
    public typealias MInput = ListDatastoresInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListDatastoresOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListDatastoresOutputError>
}

public struct ListDatastoresInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDatastoresInputURLPathMiddleware"
...
extension IoTAnalyticsClientTypes.Partition: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case attributeName
    }
...
extension IoTAnalyticsClientTypes.Partition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Partition(attributeName: \(Swift.String(describing: attributeName)))"}
}
...
public struct PutLoggingOptionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutLoggingOptionsInputURLHostMiddleware"
...
public struct RunPipelineActivityInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RunPipelineActivityInputURLHostMiddleware"
    ...
    public typealias MInput = RunPipelineActivityInput
    public typealias MOutput = ClientRuntime.OperationOutput<RunPipelineActivityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RunPipelineActivityOutputError>
}

public struct RunPipelineActivityInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RunPipelineActivityInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/pipelineactivities/run"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct SampleChannelDataInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SampleChannelDataInputURLHostMiddleware"
    ...
    public typealias MInput = SampleChannelDataInput
    public typealias MOutput = ClientRuntime.OperationOutput<SampleChannelDataOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SampleChannelDataOutputError>
}

public struct SampleChannelDataInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SampleChannelDataInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/channels/\(channelName.urlPercentEncoding())/sample"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension IoTAnalyticsClientTypes {
    ...
    public struct Schedule: Swift.Equatable {
        /// The expression that defines when to trigger an update. For more information, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/events/ScheduledEvents.html">Schedule
...
public struct StartPipelineReprocessingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartPipelineReprocessingInputURLHostMiddleware"
    ...
    public typealias MInput = StartPipelineReprocessingInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartPipelineReprocessingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartPipelineReprocessingOutputError>
}

public struct StartPipelineReprocessingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartPipelineReprocessingInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/pipelines/\(pipelineName.urlPercentEncoding())/reprocessing"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension IoTAnalyticsClientTypes.TimestampPartition: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case attributeName
...
extension IoTAnalyticsClientTypes.TimestampPartition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TimestampPartition(attributeName: \(Swift.String(describing: attributeName)), timestampFormat: \(Swift.String(describing: timestampFormat)))"}
}
...
extension IoTAnalyticsClientTypes {
    ...
    public struct TimestampPartition: Swift.Equatable {
        ...
        /// This member is required.
        public var attributeName: Swift.String?
        ///  The timestamp format of a partition defined by a timestamp. The default format is seconds
...
public struct UpdateDatastoreInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateDatastoreInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateDatastoreInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateDatastoreOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateDatastoreOutputError>
}

public struct UpdateDatastoreInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateDatastoreInputURLPathMiddleware"
