...
public struct BatchPutMessageInput: Swift.Equatable {
    ...
    /// This member is required.
    var messages: [IoTAnalyticsClientTypes.Message]?
...
public struct BatchPutMessageOutputResponse: Swift.Equatable {
    ...
    var batchPutMessageErrorEntries: [IoTAnalyticsClientTypes.BatchPutMessageErrorEntry]?
...
public struct CancelPipelineReprocessingInput: Swift.Equatable {
    ...
    /// This member is required.
    var reprocessingId: Swift.String?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct Channel: Swift.Equatable {
        ...
        var lastMessageArrivalTime: ClientRuntime.Date?
        /// When the channel was last updated.
        var lastUpdateTime: ClientRuntime.Date?
        /// The name of the channel.
        var name: Swift.String?
        /// How long, in days, message data is kept for the channel.
        var retentionPeriod: IoTAnalyticsClientTypes.RetentionPeriod?
        /// The status of the channel.
        var status: IoTAnalyticsClientTypes.ChannelStatus?
        ...
        var storage: IoTAnalyticsClientTypes.ChannelStorage?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct ChannelStatistics: Swift.Equatable {
        ...
        var size: IoTAnalyticsClientTypes.EstimatedResourceSize?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct ChannelStorage: Swift.Equatable {
        ...
        var customerManagedS3: IoTAnalyticsClientTypes.CustomerManagedChannelS3Storage?
        ...
        var serviceManagedS3: IoTAnalyticsClientTypes.ServiceManagedChannelS3Storage?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct ChannelStorageSummary: Swift.Equatable {
        ...
        var customerManagedS3: IoTAnalyticsClientTypes.CustomerManagedChannelS3StorageSummary?
        /// Used to store channel data in an S3 bucket managed by IoT Analytics.
        var serviceManagedS3: IoTAnalyticsClientTypes.ServiceManagedChannelS3StorageSummary?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct ChannelSummary: Swift.Equatable {
        ...
        var channelName: Swift.String?
        /// Where channel data is stored.
        var channelStorage: IoTAnalyticsClientTypes.ChannelStorageSummary?
        /// When the channel was created.
        var creationTime: ClientRuntime.Date?
        /// The last time when a new message arrived in the channel. IoT Analytics updates this value at most once per minute for one channel. Hence, the lastMessageArrivalTime value is an approximation. This feature only applies to messages that arrived in the data store after October 23, 2020.
        var lastMessageArrivalTime: ClientRuntime.Date?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct ContainerDatasetAction: Swift.Equatable {
        ...
        /// This member is required.
        var executionRoleArn: Swift.String?
        /// The ARN of the Docker container stored in your account. The Docker container contains an application and required support libraries and is used to generate dataset contents.
        /// This member is required.
        var image: Swift.String?
        /// Configuration of the resource that executes the containerAction.
        /// This member is required.
        var resourceConfiguration: IoTAnalyticsClientTypes.ResourceConfiguration?
        ...
        var variables: [IoTAnalyticsClientTypes.Variable]?
...
public struct CreateChannelInput: Swift.Equatable {
    ...
    var channelName: Swift.String?
    /// Where channel data is stored. You can choose one of serviceManagedS3 or customerManagedS3 storage. If not specified, the default is serviceManagedS3. You can't change this storage option after the channel is created.
    var channelStorage: IoTAnalyticsClientTypes.ChannelStorage?
    ...
    var tags: [IoTAnalyticsClientTypes.Tag]?
...
public struct CreateDatasetInput: Swift.Equatable {
    ...
    /// This member is required.
    var actions: [IoTAnalyticsClientTypes.DatasetAction]?
    /// When dataset contents are created, they are delivered to destinations specified here.
    var contentDeliveryRules: [IoTAnalyticsClientTypes.DatasetContentDeliveryRule]?
    /// The name of the dataset.
    /// This member is required.
    var datasetName: Swift.String?
    ...
    var lateDataRules: [IoTAnalyticsClientTypes.LateDataRule]?
    ...
    var triggers: [IoTAnalyticsClientTypes.DatasetTrigger]?
    ...
    var versioningConfiguration: IoTAnalyticsClientTypes.VersioningConfiguration?
...
public struct CreateDatastoreInput: Swift.Equatable {
    ...
    /// This member is required.
    var datastoreName: Swift.String?
    /// Contains information about the partition dimensions in a data store.
    var datastorePartitions: IoTAnalyticsClientTypes.DatastorePartitions?
    /// Where data in a data store is stored.. You can choose serviceManagedS3 storage, customerManagedS3 storage, or iotSiteWiseMultiLayerStorage storage. The default is serviceManagedS3. You can't change the choice of Amazon S3 storage after your data store is created.
    var datastoreStorage: IoTAnalyticsClientTypes.DatastoreStorage?
    ...
    var fileFormatConfiguration: IoTAnalyticsClientTypes.FileFormatConfiguration?
...
public struct CreatePipelineInput: Swift.Equatable {
    ...
    /// This member is required.
    var pipelineActivities: [IoTAnalyticsClientTypes.PipelineActivity]?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct Dataset: Swift.Equatable {
        ...
        var status: IoTAnalyticsClientTypes.DatasetStatus?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatasetAction: Swift.Equatable {
        ...
        var containerAction: IoTAnalyticsClientTypes.ContainerDatasetAction?
        /// An SqlQueryDatasetAction object that uses an SQL query to automatically create dataset contents.
        var queryAction: IoTAnalyticsClientTypes.SqlQueryDatasetAction?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatasetActionSummary: Swift.Equatable {
        ...
        var actionType: IoTAnalyticsClientTypes.DatasetActionType?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatasetContentDeliveryDestination: Swift.Equatable {
        ...
        var iotEventsDestinationConfiguration: IoTAnalyticsClientTypes.IotEventsDestinationConfiguration?
        /// Configuration information for delivery of dataset contents to Amazon S3.
        var s3DestinationConfiguration: IoTAnalyticsClientTypes.S3DestinationConfiguration?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatasetContentDeliveryRule: Swift.Equatable {
        /// The destination to which dataset contents are delivered.
        /// This member is required.
        var destination: IoTAnalyticsClientTypes.DatasetContentDeliveryDestination?
        /// The name of the dataset content delivery rules entry.
        var entryName: Swift.String?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatasetContentStatus: Swift.Equatable {
        ...
        var state: IoTAnalyticsClientTypes.DatasetContentState?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatasetContentSummary: Swift.Equatable {
        ...
        var completionTime: ClientRuntime.Date?
        /// The actual time the creation of the dataset contents was started.
        var creationTime: ClientRuntime.Date?
        /// The time the creation of the dataset contents was scheduled to start.
        var scheduleTime: ClientRuntime.Date?
        /// The status of the dataset contents.
        var status: IoTAnalyticsClientTypes.DatasetContentStatus?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatasetSummary: Swift.Equatable {
        ...
        var actions: [IoTAnalyticsClientTypes.DatasetActionSummary]?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatasetTrigger: Swift.Equatable {
        ...
        var dataset: IoTAnalyticsClientTypes.TriggeringDataset?
        /// The Schedule when the trigger is initiated.
        var schedule: IoTAnalyticsClientTypes.Schedule?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct Datastore: Swift.Equatable {
        ...
        var status: IoTAnalyticsClientTypes.DatastoreStatus?
        /// Where data in a data store is stored.. You can choose serviceManagedS3 storage, customerManagedS3 storage, or iotSiteWiseMultiLayerStorage storage. The default is serviceManagedS3. You can't change the choice of Amazon S3 storage after your data store is created.
        var storage: IoTAnalyticsClientTypes.DatastoreStorage?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatastoreIotSiteWiseMultiLayerStorage: Swift.Equatable {
        ...
        /// This member is required.
        var customerManagedS3Storage: IoTAnalyticsClientTypes.IotSiteWiseCustomerManagedDatastoreS3Storage?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatastoreIotSiteWiseMultiLayerStorageSummary: Swift.Equatable {
        /// Used to store data used by IoT SiteWise in an Amazon S3 bucket that you manage.
        var customerManagedS3Storage: IoTAnalyticsClientTypes.IotSiteWiseCustomerManagedDatastoreS3StorageSummary?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatastorePartition: Swift.Equatable {
        ...
        var attributePartition: IoTAnalyticsClientTypes.Partition?
        /// A partition dimension defined by a timestamp attribute.
        var timestampPartition: IoTAnalyticsClientTypes.TimestampPartition?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatastorePartitions: Swift.Equatable {
        ...
        var partitions: [IoTAnalyticsClientTypes.DatastorePartition]?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatastoreStorageSummary: Swift.Equatable {
        ...
        var customerManagedS3: IoTAnalyticsClientTypes.CustomerManagedDatastoreS3StorageSummary?
        /// Used to store data used by IoT SiteWise in an Amazon S3 bucket that you manage.
        var iotSiteWiseMultiLayerStorage: IoTAnalyticsClientTypes.DatastoreIotSiteWiseMultiLayerStorageSummary?
        /// Used to store data in an Amazon S3 bucket managed by IoT Analytics.
        var serviceManagedS3: IoTAnalyticsClientTypes.ServiceManagedDatastoreS3StorageSummary?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DatastoreSummary: Swift.Equatable {
        ...
        var datastoreStorage: IoTAnalyticsClientTypes.DatastoreStorageSummary?
        /// The file format of the data in the data store.
        var fileFormatType: IoTAnalyticsClientTypes.FileFormatType?
        /// The last time when a new message arrived in the data store. IoT Analytics updates this value at most once per minute for Amazon Simple Storage Service one data store. Hence, the lastMessageArrivalTime value is an approximation. This feature only applies to messages that arrived in the data store after October 23, 2020.
        var lastMessageArrivalTime: ClientRuntime.Date?
        /// The last time the data store was updated.
        var lastUpdateTime: ClientRuntime.Date?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct DeltaTime: Swift.Equatable {
        ...
        /// This member is required.
        var offsetSeconds: Swift.Int?
        /// An expression by which the time of the message data might be determined. This can be the name of a timestamp field or a SQL expression that is used to derive the time the message data was generated.
        /// This member is required.
        var timeExpression: Swift.String?
...
public struct DescribeChannelInput: Swift.Equatable {
    ...
    var includeStatistics: Swift.Bool
...
public struct DescribeChannelOutputResponse: Swift.Equatable {
    ...
    var channel: IoTAnalyticsClientTypes.Channel?
    /// Statistics about the channel. Included if the includeStatistics parameter is set to true in the request.
    var statistics: IoTAnalyticsClientTypes.ChannelStatistics?
...
public struct DescribeDatasetOutputResponse: Swift.Equatable {
    ...
    var dataset: IoTAnalyticsClientTypes.Dataset?
...
public struct DescribeDatastoreOutputResponse: Swift.Equatable {
    ...
    var datastore: IoTAnalyticsClientTypes.Datastore?
    /// Additional statistical information about the data store. Included if the includeStatistics parameter is set to true in the request.
    var statistics: IoTAnalyticsClientTypes.DatastoreStatistics?
...
public struct DescribeLoggingOptionsOutputResponse: Swift.Equatable {
    ...
    var loggingOptions: IoTAnalyticsClientTypes.LoggingOptions?
...
public struct DescribePipelineOutputResponse: Swift.Equatable {
    ...
    var pipeline: IoTAnalyticsClientTypes.Pipeline?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct EstimatedResourceSize: Swift.Equatable {
        ...
        var estimatedOn: ClientRuntime.Date?
        /// The estimated size of the resource, in bytes.
        var estimatedSizeInBytes: Swift.Double?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct FileFormatConfiguration: Swift.Equatable {
        ...
        var jsonConfiguration: IoTAnalyticsClientTypes.JsonConfiguration?
        /// Contains the configuration information of the Parquet format.
        var parquetConfiguration: IoTAnalyticsClientTypes.ParquetConfiguration?
...
public struct GetDatasetContentOutputResponse: Swift.Equatable {
    ...
    var entries: [IoTAnalyticsClientTypes.DatasetEntry]?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct LateDataRule: Swift.Equatable {
        ...
        /// This member is required.
        var ruleConfiguration: IoTAnalyticsClientTypes.LateDataRuleConfiguration?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct LateDataRuleConfiguration: Swift.Equatable {
        /// The information needed to configure a delta time session window.
        var deltaTimeSessionWindowConfiguration: IoTAnalyticsClientTypes.DeltaTimeSessionWindowConfiguration?
...
public struct ListChannelsOutputResponse: Swift.Equatable {
    ...
    var channelSummaries: [IoTAnalyticsClientTypes.ChannelSummary]?
...
public struct ListDatasetContentsInput: Swift.Equatable {
    ...
    var scheduledBefore: ClientRuntime.Date?
    ...
    var scheduledOnOrAfter: ClientRuntime.Date?
...
public struct ListDatasetContentsOutputResponse: Swift.Equatable {
    ...
    var datasetContentSummaries: [IoTAnalyticsClientTypes.DatasetContentSummary]?
    /// The token to retrieve the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListDatasetsOutputResponse: Swift.Equatable {
    ...
    var datasetSummaries: [IoTAnalyticsClientTypes.DatasetSummary]?
    /// The token to retrieve the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListDatastoresOutputResponse: Swift.Equatable {
    ...
    var datastoreSummaries: [IoTAnalyticsClientTypes.DatastoreSummary]?
    /// The token to retrieve the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListPipelinesOutputResponse: Swift.Equatable {
    ...
    var pipelineSummaries: [IoTAnalyticsClientTypes.PipelineSummary]?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct LoggingOptions: Swift.Equatable {
        ...
        /// This member is required.
        var level: IoTAnalyticsClientTypes.LoggingLevel?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct Message: Swift.Equatable {
        ...
        /// This member is required.
        var payload: ClientRuntime.Data?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct ParquetConfiguration: Swift.Equatable {
        ...
        var schemaDefinition: IoTAnalyticsClientTypes.SchemaDefinition?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct Pipeline: Swift.Equatable {
        ...
        var activities: [IoTAnalyticsClientTypes.PipelineActivity]?
        /// The ARN of the pipeline.
        var arn: Swift.String?
        ...
        var reprocessingSummaries: [IoTAnalyticsClientTypes.ReprocessingSummary]?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct PipelineActivity: Swift.Equatable {
        ...
        var addAttributes: IoTAnalyticsClientTypes.AddAttributesActivity?
        /// Determines the source of the messages to be processed.
        var channel: IoTAnalyticsClientTypes.ChannelActivity?
        /// Specifies where to store the processed message data.
        var datastore: IoTAnalyticsClientTypes.DatastoreActivity?
        /// Adds data from the IoT device registry to your message.
        var deviceRegistryEnrich: IoTAnalyticsClientTypes.DeviceRegistryEnrichActivity?
        /// Adds information from the IoT Device Shadow service to a message.
        var deviceShadowEnrich: IoTAnalyticsClientTypes.DeviceShadowEnrichActivity?
        /// Filters a message based on its attributes.
        var filter: IoTAnalyticsClientTypes.FilterActivity?
        /// Runs a Lambda function to modify the message.
        var lambda: IoTAnalyticsClientTypes.LambdaActivity?
        /// Computes an arithmetic expression using the message's attributes and adds it to the message.
        var math: IoTAnalyticsClientTypes.MathActivity?
        /// Removes attributes from a message.
        var removeAttributes: IoTAnalyticsClientTypes.RemoveAttributesActivity?
        /// Used to create a new message using only the specified attributes from the original message.
        var selectAttributes: IoTAnalyticsClientTypes.SelectAttributesActivity?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct QueryFilter: Swift.Equatable {
        /// Used to limit data to that which has arrived since the last execution of the action.
        var deltaTime: IoTAnalyticsClientTypes.DeltaTime?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct ReprocessingSummary: Swift.Equatable {
        ...
        var status: IoTAnalyticsClientTypes.ReprocessingStatus?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct ResourceConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var computeType: IoTAnalyticsClientTypes.ComputeType?
        /// The size, in GB, of the persistent storage available to the resource instance used to execute the containerAction (min: 1, max: 50).
        /// This member is required.
        var volumeSizeInGB: Swift.Int
...
extension IoTAnalyticsClientTypes {
    ...
    public struct RetentionPeriod: Swift.Equatable {
        ...
        var numberOfDays: Swift.Int?
        /// If true, message data is kept indefinitely.
        var unlimited: Swift.Bool
...
public struct RunPipelineActivityInput: Swift.Equatable {
    ...
    /// This member is required.
    var payloads: [ClientRuntime.Data]?
    ...
    /// This member is required.
    var pipelineActivity: IoTAnalyticsClientTypes.PipelineActivity?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct S3DestinationConfiguration: Swift.Equatable {
        ...
        var bucket: Swift.String?
        /// Configuration information for coordination with Glue, a fully managed extract, transform and load (ETL) service.
        var glueConfiguration: IoTAnalyticsClientTypes.GlueConfiguration?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct SchemaDefinition: Swift.Equatable {
        ...
        var columns: [IoTAnalyticsClientTypes.Column]?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct SqlQueryDatasetAction: Swift.Equatable {
        ...
        var filters: [IoTAnalyticsClientTypes.QueryFilter]?
        /// A SQL query string.
        /// This member is required.
        var sqlQuery: Swift.String?
...
public struct StartPipelineReprocessingInput: Swift.Equatable {
    ...
    var channelMessages: IoTAnalyticsClientTypes.ChannelMessages?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct TimestampPartition: Swift.Equatable {
        ...
        var timestampFormat: Swift.String?
...
extension IoTAnalyticsClientTypes {
    ...
    public struct Variable: Swift.Equatable {
        ...
        var datasetContentVersionValue: IoTAnalyticsClientTypes.DatasetContentVersionValue?
        ...
        var name: Swift.String?
        /// The value of the variable as a structure that specifies an output file URI.
        var outputFileUriValue: IoTAnalyticsClientTypes.OutputFileUriValue?
