...
public class WAFRegionalClient {
    ...
    let config: WAFRegionalClientConfigurationProtocol
    let serviceName = "WAF Regional"
    let encoder: ClientRuntime.RequestEncoder
    let decoder: ClientRuntime.ResponseDecoder

    public init(config: WAFRegionalClientConfigurationProtocol) {
    ...
    public convenience init() async throws {
        let config = try await WAFRegionalClientConfiguration()
        self.init(config: config)
    }

    public class WAFRegionalClientConfiguration: WAFRegionalClientConfigurationProtocol {
        ...
        public convenience init(
            ...
            let runtimeConfig = try ClientRuntime.DefaultSDKRuntimeConfiguration("WAFRegionalClient")
            try self.init(
