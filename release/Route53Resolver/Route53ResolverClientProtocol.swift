...
public protocol Route53ResolverClientProtocol {
    ...
    func associateFirewallRuleGroup(input: AssociateFirewallRuleGroupInput, completion: @escaping (SdkResult<AssociateFirewallRuleGroupOutput, AssociateFirewallRuleGroupOutputError>) -> Void)
    ...
    /// 		</p>
    func associateResolverEndpointIpAddress(input: AssociateResolverEndpointIpAddressInput, completion: @escaping (SdkResult<AssociateResolverEndpointIpAddressOutput, AssociateResolverEndpointIpAddressOutputError>) -> Void)
    ...
    /// 			</p>
    func associateResolverQueryLogConfig(input: AssociateResolverQueryLogConfigInput, completion: @escaping (SdkResult<AssociateResolverQueryLogConfigOutput, AssociateResolverQueryLogConfigOutputError>) -> Void)
    ...
    func associateResolverRule(input: AssociateResolverRuleInput, completion: @escaping (SdkResult<AssociateResolverRuleOutput, AssociateResolverRuleOutputError>) -> Void)
    ...
    func createFirewallDomainList(input: CreateFirewallDomainListInput, completion: @escaping (SdkResult<CreateFirewallDomainListOutput, CreateFirewallDomainListOutputError>) -> Void)
    /// <p>Creates a single DNS Firewall rule in the specified rule group, using the specified domain list.</p>
    func createFirewallRule(input: CreateFirewallRuleInput, completion: @escaping (SdkResult<CreateFirewallRuleOutput, CreateFirewallRuleOutputError>) -> Void)
    ...
    func createFirewallRuleGroup(input: CreateFirewallRuleGroupInput, completion: @escaping (SdkResult<CreateFirewallRuleGroupOutput, CreateFirewallRuleGroupOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createResolverEndpoint(input: CreateResolverEndpointInput, completion: @escaping (SdkResult<CreateResolverEndpointOutput, CreateResolverEndpointOutputError>) -> Void)
    ...
    func createResolverQueryLogConfig(input: CreateResolverQueryLogConfigInput, completion: @escaping (SdkResult<CreateResolverQueryLogConfigOutput, CreateResolverQueryLogConfigOutputError>) -> Void)
    ...
    func createResolverRule(input: CreateResolverRuleInput, completion: @escaping (SdkResult<CreateResolverRuleOutput, CreateResolverRuleOutputError>) -> Void)
    /// <p>Deletes the specified domain list. </p>
    func deleteFirewallDomainList(input: DeleteFirewallDomainListInput, completion: @escaping (SdkResult<DeleteFirewallDomainListOutput, DeleteFirewallDomainListOutputError>) -> Void)
    /// <p>Deletes the specified firewall rule.</p>
    func deleteFirewallRule(input: DeleteFirewallRuleInput, completion: @escaping (SdkResult<DeleteFirewallRuleOutput, DeleteFirewallRuleOutputError>) -> Void)
    /// <p>Deletes the specified firewall rule group. </p>
    func deleteFirewallRuleGroup(input: DeleteFirewallRuleGroupInput, completion: @escaping (SdkResult<DeleteFirewallRuleGroupOutput, DeleteFirewallRuleGroupOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteResolverEndpoint(input: DeleteResolverEndpointInput, completion: @escaping (SdkResult<DeleteResolverEndpointOutput, DeleteResolverEndpointOutputError>) -> Void)
    ...
    func deleteResolverQueryLogConfig(input: DeleteResolverQueryLogConfigInput, completion: @escaping (SdkResult<DeleteResolverQueryLogConfigOutput, DeleteResolverQueryLogConfigOutputError>) -> Void)
    ...
    func deleteResolverRule(input: DeleteResolverRuleInput, completion: @escaping (SdkResult<DeleteResolverRuleOutput, DeleteResolverRuleOutputError>) -> Void)
    /// <p>Disassociates a <a>FirewallRuleGroup</a> from a VPC, to remove DNS filtering from the VPC. </p>
    func disassociateFirewallRuleGroup(input: DisassociateFirewallRuleGroupInput, completion: @escaping (SdkResult<DisassociateFirewallRuleGroupOutput, DisassociateFirewallRuleGroupOutputError>) -> Void)
    ...
    /// 		</p>
    func disassociateResolverEndpointIpAddress(input: DisassociateResolverEndpointIpAddressInput, completion: @escaping (SdkResult<DisassociateResolverEndpointIpAddressOutput, DisassociateResolverEndpointIpAddressOutputError>) -> Void)
    ...
    ///             </ul>
    /// 		       </note>
    func disassociateResolverQueryLogConfig(input: DisassociateResolverQueryLogConfigInput, completion: @escaping (SdkResult<DisassociateResolverQueryLogConfigOutput, DisassociateResolverQueryLogConfigOutputError>) -> Void)
    ...
    /// 		       </important>
    func disassociateResolverRule(input: DisassociateResolverRuleInput, completion: @escaping (SdkResult<DisassociateResolverRuleOutput, DisassociateResolverRuleOutputError>) -> Void)
    ...
    func getFirewallConfig(input: GetFirewallConfigInput, completion: @escaping (SdkResult<GetFirewallConfigOutput, GetFirewallConfigOutputError>) -> Void)
    /// <p>Retrieves the specified firewall domain list.</p>
    func getFirewallDomainList(input: GetFirewallDomainListInput, completion: @escaping (SdkResult<GetFirewallDomainListOutput, GetFirewallDomainListOutputError>) -> Void)
    /// <p>Retrieves the specified firewall rule group. </p>
    func getFirewallRuleGroup(input: GetFirewallRuleGroupInput, completion: @escaping (SdkResult<GetFirewallRuleGroupOutput, GetFirewallRuleGroupOutputError>) -> Void)
    ...
    func getFirewallRuleGroupAssociation(input: GetFirewallRuleGroupAssociationInput, completion: @escaping (SdkResult<GetFirewallRuleGroupAssociationOutput, GetFirewallRuleGroupAssociationOutputError>) -> Void)
    ...
    func getFirewallRuleGroupPolicy(input: GetFirewallRuleGroupPolicyInput, completion: @escaping (SdkResult<GetFirewallRuleGroupPolicyOutput, GetFirewallRuleGroupPolicyOutputError>) -> Void)
    /// <p>Gets DNSSEC validation information for a specified resource.</p>
    func getResolverDnssecConfig(input: GetResolverDnssecConfigInput, completion: @escaping (SdkResult<GetResolverDnssecConfigOutput, GetResolverDnssecConfigOutputError>) -> Void)
    ...
    func getResolverEndpoint(input: GetResolverEndpointInput, completion: @escaping (SdkResult<GetResolverEndpointOutput, GetResolverEndpointOutputError>) -> Void)
    ...
    func getResolverQueryLogConfig(input: GetResolverQueryLogConfigInput, completion: @escaping (SdkResult<GetResolverQueryLogConfigOutput, GetResolverQueryLogConfigOutputError>) -> Void)
    ...
    func getResolverQueryLogConfigAssociation(input: GetResolverQueryLogConfigAssociationInput, completion: @escaping (SdkResult<GetResolverQueryLogConfigAssociationOutput, GetResolverQueryLogConfigAssociationOutputError>) -> Void)
    ...
    func getResolverQueryLogConfigPolicy(input: GetResolverQueryLogConfigPolicyInput, completion: @escaping (SdkResult<GetResolverQueryLogConfigPolicyOutput, GetResolverQueryLogConfigPolicyOutputError>) -> Void)
    ...
    func getResolverRule(input: GetResolverRuleInput, completion: @escaping (SdkResult<GetResolverRuleOutput, GetResolverRuleOutputError>) -> Void)
    ...
    func getResolverRuleAssociation(input: GetResolverRuleAssociationInput, completion: @escaping (SdkResult<GetResolverRuleAssociationOutput, GetResolverRuleAssociationOutputError>) -> Void)
    ...
    func getResolverRulePolicy(input: GetResolverRulePolicyInput, completion: @escaping (SdkResult<GetResolverRulePolicyOutput, GetResolverRulePolicyOutputError>) -> Void)
    ...
    ///       	     </li>
    ///          </ul>
    func importFirewallDomains(input: ImportFirewallDomainsInput, completion: @escaping (SdkResult<ImportFirewallDomainsOutput, ImportFirewallDomainsOutputError>) -> Void)
    ...
    func listFirewallConfigs(input: ListFirewallConfigsInput, completion: @escaping (SdkResult<ListFirewallConfigsOutput, ListFirewallConfigsOutputError>) -> Void)
    ...
    func listFirewallDomainLists(input: ListFirewallDomainListsInput, completion: @escaping (SdkResult<ListFirewallDomainListsOutput, ListFirewallDomainListsOutputError>) -> Void)
    ...
    func listFirewallDomains(input: ListFirewallDomainsInput, completion: @escaping (SdkResult<ListFirewallDomainsOutput, ListFirewallDomainsOutputError>) -> Void)
    ...
    func listFirewallRuleGroupAssociations(input: ListFirewallRuleGroupAssociationsInput, completion: @escaping (SdkResult<ListFirewallRuleGroupAssociationsOutput, ListFirewallRuleGroupAssociationsOutputError>) -> Void)
    ...
    func listFirewallRuleGroups(input: ListFirewallRuleGroupsInput, completion: @escaping (SdkResult<ListFirewallRuleGroupsOutput, ListFirewallRuleGroupsOutputError>) -> Void)
    ...
    func listFirewallRules(input: ListFirewallRulesInput, completion: @escaping (SdkResult<ListFirewallRulesOutput, ListFirewallRulesOutputError>) -> Void)
    /// <p>Lists the configurations for DNSSEC validation that are associated with the current AWS account.</p>
    func listResolverDnssecConfigs(input: ListResolverDnssecConfigsInput, completion: @escaping (SdkResult<ListResolverDnssecConfigsOutput, ListResolverDnssecConfigsOutputError>) -> Void)
    /// <p>Gets the IP addresses for a specified Resolver endpoint.</p>
    func listResolverEndpointIpAddresses(input: ListResolverEndpointIpAddressesInput, completion: @escaping (SdkResult<ListResolverEndpointIpAddressesOutput, ListResolverEndpointIpAddressesOutputError>) -> Void)
    /// <p>Lists all the Resolver endpoints that were created using the current AWS account.</p>
    func listResolverEndpoints(input: ListResolverEndpointsInput, completion: @escaping (SdkResult<ListResolverEndpointsOutput, ListResolverEndpointsOutputError>) -> Void)
    /// <p>Lists information about associations between Amazon VPCs and query logging configurations.</p>
    func listResolverQueryLogConfigAssociations(input: ListResolverQueryLogConfigAssociationsInput, completion: @escaping (SdkResult<ListResolverQueryLogConfigAssociationsOutput, ListResolverQueryLogConfigAssociationsOutputError>) -> Void)
    ...
    func listResolverQueryLogConfigs(input: ListResolverQueryLogConfigsInput, completion: @escaping (SdkResult<ListResolverQueryLogConfigsOutput, ListResolverQueryLogConfigsOutputError>) -> Void)
    /// <p>Lists the associations that were created between Resolver rules and VPCs using the current AWS account.</p>
    func listResolverRuleAssociations(input: ListResolverRuleAssociationsInput, completion: @escaping (SdkResult<ListResolverRuleAssociationsOutput, ListResolverRuleAssociationsOutputError>) -> Void)
    /// <p>Lists the Resolver rules that were created using the current AWS account.</p>
    func listResolverRules(input: ListResolverRulesInput, completion: @escaping (SdkResult<ListResolverRulesOutput, ListResolverRulesOutputError>) -> Void)
    ...
    /// 			(AWS RAM). </p>
    func putFirewallRuleGroupPolicy(input: PutFirewallRuleGroupPolicyInput, completion: @escaping (SdkResult<PutFirewallRuleGroupPolicyOutput, PutFirewallRuleGroupPolicyOutputError>) -> Void)
    ...
    func putResolverQueryLogConfigPolicy(input: PutResolverQueryLogConfigPolicyInput, completion: @escaping (SdkResult<PutResolverQueryLogConfigPolicyOutput, PutResolverQueryLogConfigPolicyOutputError>) -> Void)
    ...
    func putResolverRulePolicy(input: PutResolverRulePolicyInput, completion: @escaping (SdkResult<PutResolverRulePolicyOutput, PutResolverRulePolicyOutputError>) -> Void)
    ...
    func updateFirewallConfig(input: UpdateFirewallConfigInput, completion: @escaping (SdkResult<UpdateFirewallConfigOutput, UpdateFirewallConfigOutputError>) -> Void)
    /// <p>Updates the firewall domain list from an array of domain specifications. </p>
    func updateFirewallDomains(input: UpdateFirewallDomainsInput, completion: @escaping (SdkResult<UpdateFirewallDomainsOutput, UpdateFirewallDomainsOutputError>) -> Void)
    /// <p>Updates the specified firewall rule. </p>
    func updateFirewallRule(input: UpdateFirewallRuleInput, completion: @escaping (SdkResult<UpdateFirewallRuleOutput, UpdateFirewallRuleOutputError>) -> Void)
    /// <p>Changes the association of a <a>FirewallRuleGroup</a> with a VPC. The association enables DNS filtering for the VPC. </p>
    func updateFirewallRuleGroupAssociation(input: UpdateFirewallRuleGroupAssociationInput, completion: @escaping (SdkResult<UpdateFirewallRuleGroupAssociationOutput, UpdateFirewallRuleGroupAssociationOutputError>) -> Void)
    ...
    func updateResolverDnssecConfig(input: UpdateResolverDnssecConfigInput, completion: @escaping (SdkResult<UpdateResolverDnssecConfigOutput, UpdateResolverDnssecConfigOutputError>) -> Void)
    /// <p>Updates the name of an inbound or an outbound Resolver endpoint.  </p>
    func updateResolverEndpoint(input: UpdateResolverEndpointInput, completion: @escaping (SdkResult<UpdateResolverEndpointOutput, UpdateResolverEndpointOutputError>) -> Void)
    ...
    func updateResolverRule(input: UpdateResolverRuleInput, completion: @escaping (SdkResult<UpdateResolverRuleOutput, UpdateResolverRuleOutputError>) -> Void)
}
