...
extension KinesisClientTypes {
    ...
    public struct ChildShard: Swift.Equatable {
        ...
        /// This member is required.
        var hashKeyRange: KinesisClientTypes.HashKeyRange?
        /// The current shard that is the parent of the existing child shard.
        /// This member is required.
        var parentShards: [Swift.String]?
...
extension KinesisClientTypes {
    ...
    public struct Consumer: Swift.Equatable {
        ...
        ///
        /// This member is required.
        var consumerCreationTimestamp: ClientRuntime.Date?
        /// The name of the consumer is something you choose when you register the consumer.
        /// This member is required.
        var consumerName: Swift.String?
        /// A consumer can't read data while in the CREATING or DELETING states.
        /// This member is required.
        var consumerStatus: KinesisClientTypes.ConsumerStatus?
...
public struct CreateStreamInput: Swift.Equatable {
    ...
    var streamModeDetails: KinesisClientTypes.StreamModeDetails?
...
public struct DecreaseStreamRetentionPeriodInput: Swift.Equatable {
    ...
    /// This member is required.
    var retentionPeriodHours: Swift.Int?
...
public struct DeleteStreamInput: Swift.Equatable {
    ...
    var enforceConsumerDeletion: Swift.Bool?
...
public struct DescribeLimitsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var onDemandStreamCount: Swift.Int?
    /// The maximum number of data streams with the on-demand capacity mode.
    /// This member is required.
    var onDemandStreamCountLimit: Swift.Int?
    /// The number of open shards.
    /// This member is required.
    var openShardCount: Swift.Int?
    /// The maximum number of shards.
    /// This member is required.
    var shardLimit: Swift.Int?
...
public struct DescribeStreamConsumerOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var consumerDescription: KinesisClientTypes.ConsumerDescription?
...
public struct DescribeStreamOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var streamDescription: KinesisClientTypes.StreamDescription?
...
public struct DescribeStreamSummaryOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var streamDescriptionSummary: KinesisClientTypes.StreamDescriptionSummary?
...
public struct DisableEnhancedMonitoringInput: Swift.Equatable {
    ...
    /// This member is required.
    var shardLevelMetrics: [KinesisClientTypes.MetricsName]?
...
public struct DisableEnhancedMonitoringOutputResponse: Swift.Equatable {
    ...
    var currentShardLevelMetrics: [KinesisClientTypes.MetricsName]?
    /// Represents the list of all the metrics that would be in the enhanced state after the operation.
    var desiredShardLevelMetrics: [KinesisClientTypes.MetricsName]?
...
public struct GetShardIteratorInput: Swift.Equatable {
    ...
    /// This member is required.
    var shardIteratorType: KinesisClientTypes.ShardIteratorType?
...
extension KinesisClientTypes {
    ...
    public struct HashKeyRange: Swift.Equatable {
        ...
        /// This member is required.
        var endingHashKey: Swift.String?
        /// The starting hash key of the hash key range.
        /// This member is required.
        var startingHashKey: Swift.String?
...
public struct ListShardsInput: Swift.Equatable {
    ...
    var shardFilter: KinesisClientTypes.ShardFilter?
    ...
    var streamCreationTimestamp: ClientRuntime.Date?
...
public struct ListShardsOutputResponse: Swift.Equatable {
    ...
    var shards: [KinesisClientTypes.Shard]?
...
public struct ListStreamConsumersOutputResponse: Swift.Equatable {
    ...
    var consumers: [KinesisClientTypes.Consumer]?
...
public struct ListStreamsInput: Swift.Equatable {
    ...
    var exclusiveStartStreamName: Swift.String?
...
public struct ListTagsForStreamOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var tags: [KinesisClientTypes.Tag]?
...
public struct MergeShardsInput: Swift.Equatable {
    ...
    /// This member is required.
    var adjacentShardToMerge: Swift.String?
    /// The shard ID of the shard to combine with the adjacent shard for the merge.
    /// This member is required.
    var shardToMerge: Swift.String?
...
public struct PutRecordOutputResponse: Swift.Equatable {
    ...
    var encryptionType: KinesisClientTypes.EncryptionType?
...
public struct PutRecordsInput: Swift.Equatable {
    ...
    /// This member is required.
    var records: [KinesisClientTypes.PutRecordsRequestEntry]?
...
public struct PutRecordsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var records: [KinesisClientTypes.PutRecordsResultEntry]?
...
extension KinesisClientTypes {
    ...
    public struct Record: Swift.Equatable {
        ...
        var approximateArrivalTimestamp: ClientRuntime.Date?
...
public struct RegisterStreamConsumerOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var consumer: KinesisClientTypes.Consumer?
...
extension KinesisClientTypes {
    ...
    public struct Shard: Swift.Equatable {
        ...
        var adjacentParentShardId: Swift.String?
        /// The range of possible hash key values for the shard, which is a set of ordered contiguous positive integers.
        /// This member is required.
        var hashKeyRange: KinesisClientTypes.HashKeyRange?
        ...
        /// The range of possible sequence numbers for the shard.
        /// This member is required.
        var sequenceNumberRange: KinesisClientTypes.SequenceNumberRange?
...
extension KinesisClientTypes {
    ...
    public struct ShardFilter: Swift.Equatable {
        ...
        /// This member is required.
        var type: KinesisClientTypes.ShardFilterType?
...
public struct SplitShardInput: Swift.Equatable {
    ...
    /// This member is required.
    var newStartingHashKey: Swift.String?
    /// The shard ID of the shard to split.
    /// This member is required.
    var shardToSplit: Swift.String?
...
extension KinesisClientTypes {
    ...
    public struct StartingPosition: Swift.Equatable {
        ...
        /// This member is required.
        var type: KinesisClientTypes.ShardIteratorType?
...
extension KinesisClientTypes {
    ...
    public struct StreamDescription: Swift.Equatable {
        ...
        /// This member is required.
        var enhancedMonitoring: [KinesisClientTypes.EnhancedMetrics]?
        /// If set to true, more shards in the stream are available to describe.
        /// This member is required.
        var hasMoreShards: Swift.Bool?
        ...
        /// This member is required.
        var streamStatus: KinesisClientTypes.StreamStatus?
...
extension KinesisClientTypes {
    ...
    public struct StreamModeDetails: Swift.Equatable {
        /// Specifies the capacity mode to which you want to set your data stream. Currently, in Kinesis Data Streams, you can choose between an on-demand capacity mode and a provisioned capacity mode for your data streams.
        /// This member is required.
        var streamMode: KinesisClientTypes.StreamMode?
...
extension KinesisClientTypes {
    ...
    public struct SubscribeToShardEvent: Swift.Equatable {
        ...
        /// This member is required.
        var continuationSequenceNumber: Swift.String?
...
public struct SubscribeToShardInput: Swift.Equatable {
    ...
    /// The starting position in the data stream from which to start streaming.
    /// This member is required.
    var startingPosition: KinesisClientTypes.StartingPosition?
...
public struct SubscribeToShardOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var eventStream: KinesisClientTypes.SubscribeToShardEventStream?
...
public struct UpdateShardCountInput: Swift.Equatable {
    ...
    /// This member is required.
    var scalingType: KinesisClientTypes.ScalingType?
    /// The name of the stream.
    /// This member is required.
    var streamName: Swift.String?
    ...
    /// This member is required.
    var targetShardCount: Swift.Int?
...
public struct UpdateShardCountOutputResponse: Swift.Equatable {
    ...
    var currentShardCount: Swift.Int?
    /// The name of the stream.
    var streamName: Swift.String?
