...
extension ApplicationDiscoveryClientTypes.CustomerAgentlessCollectorInfo: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let activeAgentlessCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .activeAgentlessCollectors)
        activeAgentlessCollectors = activeAgentlessCollectorsDecoded
        let healthyAgentlessCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .healthyAgentlessCollectors)
        healthyAgentlessCollectors = healthyAgentlessCollectorsDecoded
        let denyListedAgentlessCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .denyListedAgentlessCollectors)
        denyListedAgentlessCollectors = denyListedAgentlessCollectorsDecoded
        let shutdownAgentlessCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .shutdownAgentlessCollectors)
        shutdownAgentlessCollectors = shutdownAgentlessCollectorsDecoded
        let unhealthyAgentlessCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .unhealthyAgentlessCollectors)
        unhealthyAgentlessCollectors = unhealthyAgentlessCollectorsDecoded
        let totalAgentlessCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .totalAgentlessCollectors)
        totalAgentlessCollectors = totalAgentlessCollectorsDecoded
        let unknownAgentlessCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .unknownAgentlessCollectors)
...
extension ApplicationDiscoveryClientTypes.CustomerMeCollectorInfo: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let activeMeCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .activeMeCollectors)
        activeMeCollectors = activeMeCollectorsDecoded
        let healthyMeCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .healthyMeCollectors)
        healthyMeCollectors = healthyMeCollectorsDecoded
        let denyListedMeCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .denyListedMeCollectors)
        denyListedMeCollectors = denyListedMeCollectorsDecoded
        let shutdownMeCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .shutdownMeCollectors)
        shutdownMeCollectors = shutdownMeCollectorsDecoded
        let unhealthyMeCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .unhealthyMeCollectors)
        unhealthyMeCollectors = unhealthyMeCollectorsDecoded
        let totalMeCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .totalMeCollectors)
        totalMeCollectors = totalMeCollectorsDecoded
        let unknownMeCollectorsDecoded = try containerValues.decode(Swift.Int.self, forKey: .unknownMeCollectors)
