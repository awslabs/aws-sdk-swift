...
public struct DeleteSessionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSessionInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteSessionInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteSessionOutputError>
}

public struct DeleteSessionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSessionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/bot/\(botName.urlPercentEncoding())/alias/\(botAlias.urlPercentEncoding())/user/\(userId.urlPercentEncoding())/session"
...
public struct PostContentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostContentInputURLHostMiddleware"
    ...
    public typealias MInput = PostContentInput
    public typealias MOutput = ClientRuntime.OperationOutput<PostContentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PostContentOutputError>
}

public struct PostContentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostContentInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/bot/\(botName.urlPercentEncoding())/alias/\(botAlias.urlPercentEncoding())/user/\(userId.urlPercentEncoding())/content"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct PostTextInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostTextInputURLHostMiddleware"
    ...
    public typealias MInput = PostTextInput
    public typealias MOutput = ClientRuntime.OperationOutput<PostTextOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PostTextOutputError>
}

public struct PostTextInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostTextInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/bot/\(botName.urlPercentEncoding())/alias/\(botAlias.urlPercentEncoding())/user/\(userId.urlPercentEncoding())/text"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct PutSessionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutSessionInputURLHostMiddleware"
    ...
    public typealias MInput = PutSessionInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutSessionOutputError>
}

public struct PutSessionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutSessionInputURLPathMiddleware"
