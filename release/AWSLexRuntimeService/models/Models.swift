...
extension LexRuntimeClientTypes {
    ...
    public struct ActiveContext: Swift.Equatable {
        ...
        /// This member is required.
        var timeToLive: LexRuntimeClientTypes.ActiveContextTimeToLive?
...
extension LexRuntimeClientTypes {
    ...
    public struct DialogAction: Swift.Equatable {
        ...
        var fulfillmentState: LexRuntimeClientTypes.FulfillmentState?
        ...
        var messageFormat: LexRuntimeClientTypes.MessageFormatType?
        /// The name of the slot that should be elicited from the user.
        var slotToElicit: Swift.String?
        /// Map of the slots that have been gathered and their values.
        var slots: [Swift.String:Swift.String]?
        ...
        /// This member is required.
        var type: LexRuntimeClientTypes.DialogActionType?
...
extension LexRuntimeClientTypes {
    ...
    public struct GenericAttachment: Swift.Equatable {
        ...
        var attachmentLinkUrl: Swift.String?
        /// The list of options to show to the user.
        var buttons: [LexRuntimeClientTypes.Button]?
...
public struct GetSessionInput: Swift.Equatable {
    ...
    var checkpointLabelFilter: Swift.String?
...
public struct GetSessionOutputResponse: Swift.Equatable {
    ...
    var activeContexts: [LexRuntimeClientTypes.ActiveContext]?
    /// Describes the current state of the bot.
    var dialogAction: LexRuntimeClientTypes.DialogAction?
    ...
    var recentIntentSummaryView: [LexRuntimeClientTypes.IntentSummary]?
    /// Map of key/value pairs representing the session-specific context information. It contains application information passed between Amazon Lex and a client application.
    var sessionAttributes: [Swift.String:Swift.String]?
...
extension LexRuntimeClientTypes {
    ...
    public struct IntentSummary: Swift.Equatable {
        ...
        var checkpointLabel: Swift.String?
        ...
        var confirmationStatus: LexRuntimeClientTypes.ConfirmationStatus?
        /// The next action that the bot should take in its interaction with the user. The possible values are:
        ///
        /// * ConfirmIntent - The next action is asking the user if the intent is complete and ready to be fulfilled. This is a yes/no question such as "Place the order?"
        ///
        ...
        /// * ElicitSlot - The next action is to elicit a slot value from the user.
        /// This member is required.
        var dialogActionType: LexRuntimeClientTypes.DialogActionType?
        /// The fulfillment state of the intent. The possible values are:
        ///
        /// * Failed - The Lambda function associated with the intent failed to fulfill the intent.
        ///
...
public struct PostContentInput: Swift.Equatable {
    ...
    var activeContexts: Swift.String?
    ...
    /// This member is required.
    var inputStream: ClientRuntime.ByteStream?
    ...
    var requestAttributes: Swift.String?
    ...
    var sessionAttributes: Swift.String?
...
public struct PostContentOutputResponse: Swift.Equatable {
    ...
    var alternativeIntents: Swift.String?
    ...
    var dialogState: LexRuntimeClientTypes.DialogState?
    ...
    var encodedInputTranscript: Swift.String?
    ...
    var inputTranscript: Swift.String?
    ...
    var nluIntentConfidence: Swift.String?
    ...
    var sentimentResponse: Swift.String?
...
public struct PostTextInput: Swift.Equatable {
    ...
    var requestAttributes: [Swift.String:Swift.String]?
...
public struct PostTextOutputResponse: Swift.Equatable {
    ...
    var activeContexts: [LexRuntimeClientTypes.ActiveContext]?
    /// One to four alternative intents that may be applicable to the user's intent. Each alternative includes a score that indicates how confident Amazon Lex is that the intent matches the user's intent. The intents are sorted by the confidence score.
    var alternativeIntents: [LexRuntimeClientTypes.PredictedIntent]?
    /// The version of the bot that responded to the conversation. You can use this information to help determine if one version of a bot is performing better than another version.
    var botVersion: Swift.String?
    /// Identifies the current state of the user interaction. Amazon Lex returns one of the following values as dialogState. The client can optionally use this information to customize the user interface.
    ///
    ...
    var nluIntentConfidence: LexRuntimeClientTypes.IntentConfidence?
    /// Represents the options that the user has to respond to the current prompt. Response Card can come from the bot configuration (in the Amazon Lex console, choose the settings button next to a slot) or from a code hook (Lambda function).
    var responseCard: LexRuntimeClientTypes.ResponseCard?
    ...
    var sentimentResponse: LexRuntimeClientTypes.SentimentResponse?
...
extension LexRuntimeClientTypes {
    ...
    public struct ResponseCard: Swift.Equatable {
        ...
        var contentType: LexRuntimeClientTypes.ContentType?
        /// An array of attachment objects representing options.
        var genericAttachments: [LexRuntimeClientTypes.GenericAttachment]?
...
extension LexRuntimeClientTypes {
    ...
    public struct SentimentResponse: Swift.Equatable {
        ...
        var sentimentLabel: Swift.String?
        /// The likelihood that the sentiment was correctly inferred.
        var sentimentScore: Swift.String?
