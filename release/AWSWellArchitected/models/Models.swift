...
extension WellArchitectedClientTypes {
    ...
    public struct Answer: Swift.Equatable {
        ...
        public let choiceAnswers: [WellArchitectedClientTypes.ChoiceAnswer]?
        /// List of choices available for a question.
        public let choices: [WellArchitectedClientTypes.Choice]?
        /// The helpful resource URL for a question.
        public let helpfulResourceUrl: Swift.String?
        /// The improvement plan URL for a question.
        ///         This value is only available if the question has been answered.
        public let improvementPlanUrl: Swift.String?
        ...
        public let pillarId: Swift.String?
        /// The description of the question.
        public let questionDescription: Swift.String?
        ...
        public let risk: WellArchitectedClientTypes.Risk?
...
extension WellArchitectedClientTypes {
    ...
    public struct AnswerSummary: Swift.Equatable {
        /// A list of selected choices to a question in your workload.
        public let choiceAnswerSummaries: [WellArchitectedClientTypes.ChoiceAnswerSummary]?
        /// List of choices available for a question.
        public let choices: [WellArchitectedClientTypes.Choice]?
        /// Defines whether this question is applicable to a lens review.
        public let isApplicable: Swift.Bool
...
extension WellArchitectedClientTypes.Choice: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Choice(choiceId: \(Swift.String(describing: choiceId)), description: \(Swift.String(describing: description)), title: \(Swift.String(describing: title)))"}
}
...
extension WellArchitectedClientTypes {
    ...
    public struct Choice: Swift.Equatable {
        /// The ID of a choice.
        public let choiceId: Swift.String?
...
extension WellArchitectedClientTypes {
    ...
    public struct ChoiceAnswer: Swift.Equatable {
        ...
        public let notes: Swift.String?
        /// The reason why a choice is non-applicable to a question in your workload.
        public let reason: WellArchitectedClientTypes.ChoiceReason?
        /// The status of a choice.
        public let status: WellArchitectedClientTypes.ChoiceStatus?
...
extension GetAnswerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAnswerOutputResponse(answer: \(Swift.String(describing: answer)), lensAlias: \(Swift.String(describing: lensAlias)), milestoneNumber: \(Swift.String(describing: milestoneNumber)), workloadId: \(Swift.String(describing: workloadId)))"}
}
...
extension GetLensVersionDifferenceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetLensVersionDifferenceInput(baseLensVersion: \(Swift.String(describing: baseLensVersion)), lensAlias: \(Swift.String(describing: lensAlias)))"}
}
...
extension GetLensVersionDifferenceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetLensVersionDifferenceOutputResponse(baseLensVersion: \(Swift.String(describing: baseLensVersion)), latestLensVersion: \(Swift.String(describing: latestLensVersion)), lensAlias: \(Swift.String(describing: lensAlias)), versionDifferences: \(Swift.String(describing: versionDifferences)))"}
}
...
extension WellArchitectedClientTypes.ImprovementSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ImprovementSummary(improvementPlanUrl: \(Swift.String(describing: improvementPlanUrl)), pillarId: \(Swift.String(describing: pillarId)), questionId: \(Swift.String(describing: questionId)), questionTitle: \(Swift.String(describing: questionTitle)), risk: \(Swift.String(describing: risk)))"}
}
...
extension WellArchitectedClientTypes.LensReview: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LensReview(lensAlias: \(Swift.String(describing: lensAlias)), lensName: \(Swift.String(describing: lensName)), lensStatus: \(Swift.String(describing: lensStatus)), lensVersion: \(Swift.String(describing: lensVersion)), nextToken: \(Swift.String(describing: nextToken)), notes: \(Swift.String(describing: notes)), pillarReviewSummaries: \(Swift.String(describing: pillarReviewSummaries)), riskCounts: \(Swift.String(describing: riskCounts)), updatedAt: \(Swift.String(describing: updatedAt)))"}
}
...
extension WellArchitectedClientTypes {
    ...
    public struct LensReview: Swift.Equatable {
        ...
        public let lensName: Swift.String?
        /// The status of the lens.
        public let lensStatus: WellArchitectedClientTypes.LensStatus?
        ...
        public let pillarReviewSummaries: [WellArchitectedClientTypes.PillarReviewSummary]?
        /// A map from risk names to the count of how questions have that rating.
        public let riskCounts: [Swift.String:Swift.Int]?
...
extension WellArchitectedClientTypes.LensReviewReport: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LensReviewReport(base64String: \(Swift.String(describing: base64String)), lensAlias: \(Swift.String(describing: lensAlias)))"}
}
...
extension WellArchitectedClientTypes.LensReviewSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LensReviewSummary(lensAlias: \(Swift.String(describing: lensAlias)), lensName: \(Swift.String(describing: lensName)), lensStatus: \(Swift.String(describing: lensStatus)), lensVersion: \(Swift.String(describing: lensVersion)), riskCounts: \(Swift.String(describing: riskCounts)), updatedAt: \(Swift.String(describing: updatedAt)))"}
}
...
extension WellArchitectedClientTypes.LensSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LensSummary(description: \(Swift.String(describing: description)), lensAlias: \(Swift.String(describing: lensAlias)), lensName: \(Swift.String(describing: lensName)), lensVersion: \(Swift.String(describing: lensVersion)))"}
}
...
extension WellArchitectedClientTypes.LensUpgradeSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LensUpgradeSummary(currentLensVersion: \(Swift.String(describing: currentLensVersion)), latestLensVersion: \(Swift.String(describing: latestLensVersion)), lensAlias: \(Swift.String(describing: lensAlias)), workloadId: \(Swift.String(describing: workloadId)), workloadName: \(Swift.String(describing: workloadName)))"}
}
...
extension WellArchitectedClientTypes {
    ...
    public struct LensUpgradeSummary: Swift.Equatable {
        ...
        public let currentLensVersion: Swift.String?
        /// The latest version of the lens.
        public let latestLensVersion: Swift.String?
        /// The alias of the lens, for example, serverless.
        ///         Each lens is identified by its LensSummary$LensAlias.
...
extension ListAnswersOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAnswersOutputResponse(answerSummaries: \(Swift.String(describing: answerSummaries)), lensAlias: \(Swift.String(describing: lensAlias)), milestoneNumber: \(Swift.String(describing: milestoneNumber)), nextToken: \(Swift.String(describing: nextToken)), workloadId: \(Swift.String(describing: workloadId)))"}
}
...
extension ListLensReviewImprovementsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListLensReviewImprovementsOutputResponse(improvementSummaries: \(Swift.String(describing: improvementSummaries)), lensAlias: \(Swift.String(describing: lensAlias)), milestoneNumber: \(Swift.String(describing: milestoneNumber)), nextToken: \(Swift.String(describing: nextToken)), workloadId: \(Swift.String(describing: workloadId)))"}
}
...
extension ListLensesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListLensesInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
extension ListShareInvitationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListShareInvitationsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), workloadNamePrefix: \(Swift.String(describing: workloadNamePrefix)))"}
}
...
public struct ListWorkloadSharesInput: Swift.Equatable {
    ...
    public let nextToken: Swift.String?
    /// The AWS account ID or IAM role with which the workload is shared.
    public let sharedWithPrefix: Swift.String?
    /// The ID assigned to the workload. This ID is unique within an AWS Region.
    /// This member is required.
    public let workloadId: Swift.String?
...
extension WellArchitectedClientTypes {
    ...
    public struct Milestone: Swift.Equatable {
        ...
        public let milestoneNumber: Swift.Int
        /// The date and time recorded.
        public let recordedAt: ClientRuntime.Date?
        /// A workload return object.
        public let workload: WellArchitectedClientTypes.Workload?
...
extension WellArchitectedClientTypes {
    ...
    public struct MilestoneSummary: Swift.Equatable {
        ...
        public let workloadSummary: WellArchitectedClientTypes.WorkloadSummary?
...
extension WellArchitectedClientTypes {
    ...
    public struct NotificationSummary: Swift.Equatable {
        ...
        public let lensUpgradeSummary: WellArchitectedClientTypes.LensUpgradeSummary?
        /// The type of notification.
        public let type: WellArchitectedClientTypes.NotificationType?
...
extension WellArchitectedClientTypes.PillarDifference: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PillarDifference(differenceStatus: \(Swift.String(describing: differenceStatus)), pillarId: \(Swift.String(describing: pillarId)), questionDifferences: \(Swift.String(describing: questionDifferences)))"}
}
...
extension WellArchitectedClientTypes {
    ...
    public struct PillarDifference: Swift.Equatable {
        ...
        public let differenceStatus: WellArchitectedClientTypes.DifferenceStatus?
        /// The ID used to identify a pillar, for example, security.
        ///         A pillar is identified by its PillarReviewSummary$PillarId.
        public let pillarId: Swift.String?
        /// List of question differences.
        public let questionDifferences: [WellArchitectedClientTypes.QuestionDifference]?
...
extension WellArchitectedClientTypes {
    ...
    public struct PillarReviewSummary: Swift.Equatable {
        ...
        public let pillarName: Swift.String?
        /// A map from risk names to the count of how questions have that rating.
        public let riskCounts: [Swift.String:Swift.Int]?
...
extension WellArchitectedClientTypes.ShareInvitation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ShareInvitation(shareInvitationId: \(Swift.String(describing: shareInvitationId)), workloadId: \(Swift.String(describing: workloadId)))"}
}
...
extension WellArchitectedClientTypes {
    ...
    public struct ShareInvitation: Swift.Equatable {
        ...
        public let shareInvitationId: Swift.String?
        /// The ID assigned to the workload. This ID is unique within an AWS Region.
        public let workloadId: Swift.String?
...
extension WellArchitectedClientTypes {
    ...
    public struct ShareInvitationSummary: Swift.Equatable {
        ...
        public let shareInvitationId: Swift.String?
        /// An AWS account ID.
        public let sharedBy: Swift.String?
        /// The AWS account ID or IAM role with which the workload is shared.
        public let sharedWith: Swift.String?
        /// The ID assigned to the workload. This ID is unique within an AWS Region.
        public let workloadId: Swift.String?
...
extension UpdateAnswerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateAnswerOutputResponse(answer: \(Swift.String(describing: answer)), lensAlias: \(Swift.String(describing: lensAlias)), workloadId: \(Swift.String(describing: workloadId)))"}
}
...
extension WellArchitectedClientTypes {
    ...
    public struct VersionDifferences: Swift.Equatable {
        /// The differences between the base and latest versions of the lens.
        public let pillarDifferences: [WellArchitectedClientTypes.PillarDifference]?
...
extension WellArchitectedClientTypes {
    ...
    public struct Workload: Swift.Equatable {
        ...
        public let reviewOwner: Swift.String?
        /// The date and time recorded.
        public let reviewRestrictionDate: ClientRuntime.Date?
        /// A map from risk names to the count of how questions have that rating.
        public let riskCounts: [Swift.String:Swift.Int]?
        /// The ID assigned to the share invitation.
        public let shareInvitationId: Swift.String?
...
extension WellArchitectedClientTypes {
    ...
    public struct WorkloadShare: Swift.Equatable {
        ...
        public let sharedWith: Swift.String?
        /// The status of a workload share.
        public let status: WellArchitectedClientTypes.ShareStatus?
        /// The ID assigned to the workload. This ID is unique within an AWS Region.
        public let workloadId: Swift.String?
        /// The name of the workload.
        ///         The name must be unique within an account within a Region. Spaces and capitalization
