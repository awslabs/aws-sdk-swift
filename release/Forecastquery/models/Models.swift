...
extension ForecastqueryClientTypes.DataPoint: Swift.Codable, ClientRuntime.Reflection {
...
extension ForecastqueryClientTypes.DataPoint: Swift.CustomDebugStringConvertible {
...
extension ForecastqueryClientTypes.Forecast: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ForecastqueryClientTypes.Forecast: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Forecast(predictions: \(Swift.String(describing: predictions)))"}
}
...
extension ForecastqueryClientTypes {
    ...
    public struct Forecast: Swift.Equatable {
        ...
        ///             </li>
        ///          </ul>
        public let predictions: [Swift.String:[ForecastqueryClientTypes.DataPoint]]?
...
public struct QueryForecastInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "QueryForecastInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<QueryForecastInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<QueryForecastOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<QueryForecastInput>
    public typealias MOutput = ClientRuntime.OperationOutput<QueryForecastOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<QueryForecastOutputError>
}

extension QueryForecastInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "QueryForecastInput(endDate: \(Swift.String(describing: endDate)), filters: \(Swift.String(describing: filters)), forecastArn: \(Swift.String(describing: forecastArn)), nextToken: \(Swift.String(describing: nextToken)), startDate: \(Swift.String(describing: startDate)))"}
}

extension QueryForecastInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct QueryForecastInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "QueryForecastInputHeadersMiddleware"
...
public struct QueryForecastInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "QueryForecastInputQueryItemMiddleware"
...
extension QueryForecastOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "QueryForecastOutputResponse(forecast: \(Swift.String(describing: forecast)))"}
}
...
public struct QueryForecastOutputResponse: Swift.Equatable {
    /// <p>The forecast.</p>
    public let forecast: ForecastqueryClientTypes.Forecast?
