...
extension ForecastqueryClient: ForecastqueryClientProtocol {
    ...
    ///          </note>
    public func queryForecast(input: QueryForecastInput, completion: @escaping (SdkResult<QueryForecastOutput, QueryForecastOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<QueryForecastInput, QueryForecastOutput, QueryForecastOutputError>(id: "queryForecast")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<QueryForecastInput, QueryForecastOutput, QueryForecastOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<QueryForecastInput, QueryForecastOutput, QueryForecastOutputError>(xAmzTarget: "AmazonForecastRuntime.QueryForecast"))
