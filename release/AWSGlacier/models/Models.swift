...
extension GlacierClientTypes {
    ...
    public struct CSVInput: Swift.Equatable {
        ...
        var fieldDelimiter: Swift.String?
        /// Describes the first line of input. Valid values are None, Ignore, and Use.
        var fileHeaderInfo: GlacierClientTypes.FileHeaderInfo?
        /// A value used as an escape character where the field delimiter is part of the value.
        var quoteCharacter: Swift.String?
        /// A single character used for escaping the quotation-mark character inside an already escaped value.
        var quoteEscapeCharacter: Swift.String?
        /// A value used to separate individual records from each other.
        var recordDelimiter: Swift.String?
...
extension GlacierClientTypes {
    ...
    public struct CSVOutput: Swift.Equatable {
        ...
        var quoteFields: GlacierClientTypes.QuoteFields?
        /// A value used to separate individual records from each other.
        var recordDelimiter: Swift.String?
...
extension GlacierClientTypes {
    ...
    public struct DataRetrievalPolicy: Swift.Equatable {
        ...
        var rules: [GlacierClientTypes.DataRetrievalRule]?
...
public struct DescribeJobOutputResponse: Swift.Equatable {
    ...
    var action: GlacierClientTypes.ActionCode?
    /// The archive ID requested for a select job or archive retrieval. Otherwise, this field is null.
    var archiveId: Swift.String?
    /// The SHA256 tree hash of the entire archive for an archive retrieval. For inventory retrieval or select jobs, this field is null.
    var archiveSHA256TreeHash: Swift.String?
    /// For an archive retrieval job, this value is the size in bytes of the archive being requested for download. For an inventory retrieval or select job, this value is null.
    var archiveSizeInBytes: Swift.Int?
    /// The job status. When a job is completed, you get the job's output using Get Job Output (GET output).
    var completed: Swift.Bool
    /// The UTC time that the job request completed. While the job is in progress, the value is null.
    var completionDate: Swift.String?
    /// The UTC date when the job was created. This value is a string representation of ISO 8601 date format, for example "2012-03-20T17:03:43.221Z".
    var creationDate: Swift.String?
    /// Parameters used for range inventory retrieval.
    var inventoryRetrievalParameters: GlacierClientTypes.InventoryRetrievalJobDescription?
    /// For an inventory retrieval job, this value is the size in bytes of the inventory requested for download. For an archive retrieval or select job, this value is null.
    var inventorySizeInBytes: Swift.Int?
    /// The job description provided when initiating the job.
    var jobDescription: Swift.String?
    /// An opaque string that identifies an Amazon S3 Glacier job.
    var jobId: Swift.String?
    /// Contains the job output location.
    var jobOutputPath: Swift.String?
    /// Contains the location where the data from the select job is stored.
    var outputLocation: GlacierClientTypes.OutputLocation?
    /// The retrieved byte range for archive retrieval jobs in the form StartByteValue-EndByteValue. If no range was specified in the archive retrieval, then the whole archive is retrieved. In this case, StartByteValue equals 0 and EndByteValue equals the size of the archive minus 1. For inventory retrieval or select jobs, this field is null.
    var retrievalByteRange: Swift.String?
    ...
    ///
    /// * Select jobs
    var sHA256TreeHash: Swift.String?
    /// An Amazon SNS topic that receives notification.
    var sNSTopic: Swift.String?
    /// Contains the parameters used for a select.
    var selectParameters: GlacierClientTypes.SelectParameters?
    /// The status code can be InProgress, Succeeded, or Failed, and indicates the status of the job.
    var statusCode: GlacierClientTypes.StatusCode?
    /// A friendly message that describes the job status.
    var statusMessage: Swift.String?
    /// The tier to use for a select or an archive retrieval. Valid values are Expedited, Standard, or Bulk. Standard is the default.
    var tier: Swift.String?
    /// The Amazon Resource Name (ARN) of the vault from which an archive retrieval was requested.
    var vaultARN: Swift.String?
...
extension GlacierClientTypes {
    ...
    public struct DescribeVaultOutput: Swift.Equatable {
        ...
        var lastInventoryDate: Swift.String?
        /// The number of archives in the vault as of the last inventory date. This field will return null if an inventory has not yet run on the vault, for example if you just created the vault.
        var numberOfArchives: Swift.Int
...
extension GlacierClientTypes {
    ...
    public struct Encryption: Swift.Equatable {
        ...
        var encryptionType: GlacierClientTypes.EncryptionType?
        /// Optional. If the encryption type is aws:kms, you can use this value to specify the encryption context for the job results.
        var kMSContext: Swift.String?
...
public struct GetDataRetrievalPolicyOutputResponse: Swift.Equatable {
    ...
    var policy: GlacierClientTypes.DataRetrievalPolicy?
...
public struct GetJobOutputOutputResponse: Swift.Equatable {
    ...
    var acceptRanges: Swift.String?
    /// The description of an archive.
    var archiveDescription: Swift.String?
    /// The job data, either archive data or inventory data.
    var body: ClientRuntime.ByteStream?
...
public struct GetVaultAccessPolicyOutputResponse: Swift.Equatable {
    ...
    var policy: GlacierClientTypes.VaultAccessPolicy?
...
public struct GetVaultLockOutputResponse: Swift.Equatable {
    ...
    var expirationDate: Swift.String?
...
public struct GetVaultNotificationsOutputResponse: Swift.Equatable {
    ...
    var vaultNotificationConfig: GlacierClientTypes.VaultNotificationConfig?
...
extension GlacierClientTypes {
    ...
    public struct Grant: Swift.Equatable {
        /// The grantee.
        var grantee: GlacierClientTypes.Grantee?
        /// Specifies the permission given to the grantee.
        var permission: GlacierClientTypes.Permission?
...
extension GlacierClientTypes {
    ...
    public struct Grantee: Swift.Equatable {
        ...
        /// Type of grantee
        /// This member is required.
        var type: GlacierClientTypes.ModelType?
...
public struct InitiateJobInput: Swift.Equatable {
    ...
    var jobParameters: GlacierClientTypes.JobParameters?
    /// The name of the vault.
    /// This member is required.
    var vaultName: Swift.String?
...
public struct InitiateVaultLockInput: Swift.Equatable {
    ...
    var accountId: Swift.String?
    /// The vault lock policy as a JSON string, which uses "\" as an escape character.
    var policy: GlacierClientTypes.VaultLockPolicy?
    /// The name of the vault.
    /// This member is required.
    var vaultName: Swift.String?
...
extension GlacierClientTypes {
    ...
    public struct InputSerialization: Swift.Equatable {
        ...
        var csv: GlacierClientTypes.CSVInput?
...
extension GlacierClientTypes {
    ...
    public struct JobParameters: Swift.Equatable {
        ...
        var inventoryRetrievalParameters: GlacierClientTypes.InventoryRetrievalJobInput?
...
public struct ListJobsOutputResponse: Swift.Equatable {
    ...
    var jobList: [GlacierClientTypes.GlacierJobDescription]?
...
public struct ListMultipartUploadsOutputResponse: Swift.Equatable {
    ...
    var uploadsList: [GlacierClientTypes.UploadListElement]?
...
public struct ListPartsOutputResponse: Swift.Equatable {
    ...
    var multipartUploadId: Swift.String?
    /// The part size in bytes. This is the same value that you specified in the Initiate Multipart Upload request.
    var partSizeInBytes: Swift.Int
    /// A list of the part sizes of the multipart upload. Each object in the array contains a RangeBytes and sha256-tree-hash name/value pair.
    var parts: [GlacierClientTypes.PartListElement]?
...
public struct ListProvisionedCapacityOutputResponse: Swift.Equatable {
    ...
    var provisionedCapacityList: [GlacierClientTypes.ProvisionedCapacityDescription]?
...
public struct ListVaultsOutputResponse: Swift.Equatable {
    ...
    var marker: Swift.String?
    /// List of vaults.
    var vaultList: [GlacierClientTypes.DescribeVaultOutput]?
...
extension GlacierClientTypes {
    ...
    public struct OutputLocation: Swift.Equatable {
        ...
        var s3: GlacierClientTypes.S3Location?
...
extension GlacierClientTypes {
    ...
    public struct OutputSerialization: Swift.Equatable {
        ...
        var csv: GlacierClientTypes.CSVOutput?
...
extension GlacierClientTypes {
    ...
    public struct S3Location: Swift.Equatable {
        ...
        var accessControlList: [GlacierClientTypes.Grant]?
        /// The name of the Amazon S3 bucket where the job results are stored.
        var bucketName: Swift.String?
        /// The canned access control list (ACL) to apply to the job results.
        var cannedACL: GlacierClientTypes.CannedACL?
        /// Contains information about the encryption used to store the job results in Amazon S3.
        var encryption: GlacierClientTypes.Encryption?
        /// The storage class used to store the job results.
        var storageClass: GlacierClientTypes.StorageClass?
        /// The tag-set that is applied to the job results.
        var tagging: [Swift.String:Swift.String]?
...
extension GlacierClientTypes {
    ...
    public struct SelectParameters: Swift.Equatable {
        ...
        var expressionType: GlacierClientTypes.ExpressionType?
        /// Describes the serialization format of the object.
        var inputSerialization: GlacierClientTypes.InputSerialization?
        /// Describes how the results of the select job are serialized.
        var outputSerialization: GlacierClientTypes.OutputSerialization?
