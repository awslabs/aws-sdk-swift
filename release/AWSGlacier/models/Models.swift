...
public struct AbortMultipartUploadInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AbortMultipartUploadInputURLHostMiddleware"
    ...
    public typealias MInput = AbortMultipartUploadInput
    public typealias MOutput = ClientRuntime.OperationOutput<AbortMultipartUploadOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AbortMultipartUploadOutputError>
}

public struct AbortMultipartUploadInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AbortMultipartUploadInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let vaultName = input.vaultName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("vaultName is nil and needs a value for the path of this operation"))))
        }
        guard let uploadId = input.uploadId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("uploadId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/multipart-uploads/\(uploadId.urlPercentEncoding())"
...
///
///          For information about the underlying REST API, see <a href="https://docs.aws.amazon.com/amazonglacier/latest/dev/api-multipart-abort-upload.html">Abort Multipart
///             Upload. For conceptual information, see <a href="https://docs.aws.amazon.com/amazonglacier/latest/dev/working-with-archives.html">Working with Archives in
///             Amazon S3 Glacier.
...
public struct AbortVaultLockInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AbortVaultLockInputURLHostMiddleware"
    ...
    public typealias MInput = AbortVaultLockInput
    public typealias MOutput = ClientRuntime.OperationOutput<AbortVaultLockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AbortVaultLockOutputError>
}

public struct AbortVaultLockInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AbortVaultLockInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/lock-policy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct AddTagsToVaultInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddTagsToVaultInputURLHostMiddleware"
    ...
    public typealias MInput = AddTagsToVaultInput
    public typealias MOutput = ClientRuntime.OperationOutput<AddTagsToVaultOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AddTagsToVaultOutputError>
}

public struct AddTagsToVaultInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddTagsToVaultInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/tags"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CompleteMultipartUploadInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CompleteMultipartUploadInputURLHostMiddleware"
    ...
    public typealias MInput = CompleteMultipartUploadInput
    public typealias MOutput = ClientRuntime.OperationOutput<CompleteMultipartUploadOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CompleteMultipartUploadOutputError>
}

public struct CompleteMultipartUploadInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CompleteMultipartUploadInputURLPathMiddleware"
...
///          For information about the underlying REST API, see <a href="https://docs.aws.amazon.com/amazonglacier/latest/dev/api-archive-post.html">Upload Archive. For
...
public struct CompleteVaultLockInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CompleteVaultLockInputURLHostMiddleware"
    ...
    public typealias MInput = CompleteVaultLockInput
    public typealias MOutput = ClientRuntime.OperationOutput<CompleteVaultLockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CompleteVaultLockOutputError>
}

public struct CompleteVaultLockInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CompleteVaultLockInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let lockId = input.lockId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("lockId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/lock-policy/\(lockId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreateVaultInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateVaultInputURLHostMiddleware"
    ...
    public typealias MInput = CreateVaultInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateVaultOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateVaultOutputError>
}

public struct CreateVaultInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateVaultInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteArchiveInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let archiveId = input.archiveId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("archiveId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/archives/\(archiveId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteVaultAccessPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVaultAccessPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteVaultAccessPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteVaultAccessPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteVaultAccessPolicyOutputError>
}

public struct DeleteVaultAccessPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVaultAccessPolicyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/access-policy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteVaultInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVaultInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteVaultInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteVaultOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteVaultOutputError>
}

public struct DeleteVaultInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVaultInputURLPathMiddleware"
...
public struct DeleteVaultNotificationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVaultNotificationsInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteVaultNotificationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteVaultNotificationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteVaultNotificationsOutputError>
}

public struct DeleteVaultNotificationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVaultNotificationsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/notification-configuration"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJobInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeJobOutputError>
}

public struct DescribeJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJobInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/jobs/\(jobId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeVaultInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeVaultInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeVaultInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeVaultOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeVaultOutputError>
}

public struct DescribeVaultInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeVaultInputURLPathMiddleware"
...
public struct GetDataRetrievalPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDataRetrievalPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = GetDataRetrievalPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetDataRetrievalPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetDataRetrievalPolicyOutputError>
}

public struct GetDataRetrievalPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDataRetrievalPolicyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/policies/data-retrieval"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetJobOutputInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetJobOutputInputURLHostMiddleware"
    ...
    public typealias MInput = GetJobOutputInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetJobOutputOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetJobOutputOutputError>
}

public struct GetJobOutputInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetJobOutputInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/jobs/\(jobId.urlPercentEncoding())/output"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetJobOutputOutputResponse: Swift.Equatable {
    /// Indicates the range units accepted. For more information, see <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html">RFC2616.
    ...
    ///
    ///
    ///                You request a range of the archive to return that starts on a multiple of 1 MB
...
public struct GetVaultAccessPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetVaultAccessPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = GetVaultAccessPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetVaultAccessPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetVaultAccessPolicyOutputError>
}

public struct GetVaultAccessPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetVaultAccessPolicyInputURLPathMiddleware"
...
public struct GetVaultLockInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetVaultLockInputURLHostMiddleware"
    ...
    public typealias MInput = GetVaultLockInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetVaultLockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetVaultLockOutputError>
}

public struct GetVaultLockInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetVaultLockInputURLPathMiddleware"
...
public struct GetVaultNotificationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetVaultNotificationsInputURLHostMiddleware"
    ...
    public typealias MInput = GetVaultNotificationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetVaultNotificationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetVaultNotificationsOutputError>
}

public struct GetVaultNotificationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetVaultNotificationsInputURLPathMiddleware"
...
public struct InitiateJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InitiateJobInputURLHostMiddleware"
    ...
    public typealias MInput = InitiateJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<InitiateJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<InitiateJobOutputError>
}

public struct InitiateJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InitiateJobInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/jobs"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct InitiateMultipartUploadInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InitiateMultipartUploadInputURLHostMiddleware"
    ...
    public typealias MInput = InitiateMultipartUploadInput
    public typealias MOutput = ClientRuntime.OperationOutput<InitiateMultipartUploadOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<InitiateMultipartUploadOutputError>
}

public struct InitiateMultipartUploadInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InitiateMultipartUploadInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/multipart-uploads"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct InitiateVaultLockInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InitiateVaultLockInputURLHostMiddleware"
    ...
    public typealias MInput = InitiateVaultLockInput
    public typealias MOutput = ClientRuntime.OperationOutput<InitiateVaultLockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<InitiateVaultLockOutputError>
}

public struct InitiateVaultLockInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InitiateVaultLockInputURLPathMiddleware"
...
extension GlacierClientTypes {
    ...
    public struct InventoryRetrievalJobDescription: Swift.Equatable {
        ...
        ///             inventory retrieval results. You use the marker in a new InitiateJob request to obtain additional inventory items. If there are
        ///             no more inventory items, this value is null. For more information, see
        ///                 <a href="https://docs.aws.amazon.com/amazonglacier/latest/dev/api-initiate-job-post.html#api-initiate-job-post-vault-inventory-list-filtering"> Range Inventory Retrieval.
...
public struct ListMultipartUploadsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListMultipartUploadsInputURLHostMiddleware"
    ...
    public typealias MInput = ListMultipartUploadsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListMultipartUploadsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListMultipartUploadsOutputError>
}

public struct ListMultipartUploadsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListMultipartUploadsInputURLPathMiddleware"
...
public struct ListPartsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPartsInputURLHostMiddleware"
    ...
    public typealias MInput = ListPartsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListPartsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListPartsOutputError>
}

public struct ListPartsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPartsInputURLPathMiddleware"
...
public struct ListProvisionedCapacityInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProvisionedCapacityInputURLHostMiddleware"
    ...
    public typealias MInput = ListProvisionedCapacityInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListProvisionedCapacityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListProvisionedCapacityOutputError>
}

public struct ListProvisionedCapacityInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProvisionedCapacityInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/provisioned-capacity"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListTagsForVaultInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTagsForVaultInputURLHostMiddleware"
    ...
    public typealias MInput = ListTagsForVaultInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListTagsForVaultOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListTagsForVaultOutputError>
}

public struct ListTagsForVaultInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTagsForVaultInputURLPathMiddleware"
...
public struct ListVaultsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListVaultsInputURLHostMiddleware"
    ...
    public typealias MInput = ListVaultsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListVaultsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListVaultsOutputError>
}

public struct ListVaultsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListVaultsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct PurchaseProvisionedCapacityInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PurchaseProvisionedCapacityInputURLHostMiddleware"
    ...
    public typealias MInput = PurchaseProvisionedCapacityInput
    public typealias MOutput = ClientRuntime.OperationOutput<PurchaseProvisionedCapacityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PurchaseProvisionedCapacityOutputError>
}

public struct PurchaseProvisionedCapacityInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PurchaseProvisionedCapacityInputURLPathMiddleware"
...
public struct RemoveTagsFromVaultInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RemoveTagsFromVaultInputURLHostMiddleware"
    ...
    public typealias MInput = RemoveTagsFromVaultInput
    public typealias MOutput = ClientRuntime.OperationOutput<RemoveTagsFromVaultOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RemoveTagsFromVaultOutputError>
}

public struct RemoveTagsFromVaultInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RemoveTagsFromVaultInputURLPathMiddleware"
...
public struct SetDataRetrievalPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SetDataRetrievalPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = SetDataRetrievalPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<SetDataRetrievalPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SetDataRetrievalPolicyOutputError>
}

public struct SetDataRetrievalPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SetDataRetrievalPolicyInputURLPathMiddleware"
...
public struct SetVaultAccessPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SetVaultAccessPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = SetVaultAccessPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<SetVaultAccessPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SetVaultAccessPolicyOutputError>
}

public struct SetVaultAccessPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SetVaultAccessPolicyInputURLPathMiddleware"
...
public struct SetVaultNotificationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SetVaultNotificationsInputURLHostMiddleware"
    ...
    public typealias MInput = SetVaultNotificationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<SetVaultNotificationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SetVaultNotificationsOutputError>
}

public struct SetVaultNotificationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SetVaultNotificationsInputURLPathMiddleware"
...
public struct UploadArchiveInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UploadArchiveInputURLHostMiddleware"
    ...
    public typealias MInput = UploadArchiveInput
    public typealias MOutput = ClientRuntime.OperationOutput<UploadArchiveOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UploadArchiveOutputError>
}

public struct UploadArchiveInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UploadArchiveInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/\(accountId.urlPercentEncoding())/vaults/\(vaultName.urlPercentEncoding())/archives"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UploadMultipartPartInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UploadMultipartPartInputURLHostMiddleware"
    ...
    public typealias MInput = UploadMultipartPartInput
    public typealias MOutput = ClientRuntime.OperationOutput<UploadMultipartPartOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UploadMultipartPartOutputError>
}

public struct UploadMultipartPartInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UploadMultipartPartInputURLPathMiddleware"
