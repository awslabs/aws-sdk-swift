...
public struct AcceptQualificationRequestInput: Swift.Equatable {
    ...
    var qualificationRequestId: Swift.String?
...
public struct ApproveAssignmentInput: Swift.Equatable {
    ...
    /// This member is required.
    var assignmentId: Swift.String?
    /// A flag indicating that an assignment should be approved even if it was previously rejected. Defaults to False.
    var overrideRejection: Swift.Bool?
    /// A message for the Worker, which the Worker can see in the Status section of the web site.
    var requesterFeedback: Swift.String?
...
public struct AssociateQualificationWithWorkerInput: Swift.Equatable {
    ...
    /// This member is required.
    var qualificationTypeId: Swift.String?
    /// Specifies whether to send a notification email message to the Worker saying that the qualification was assigned to the Worker. Note: this is true by default.
    var sendNotification: Swift.Bool?
...
extension MTurkClientTypes {
    ...
    public struct BonusPayment: Swift.Equatable {
        ...
        var bonusAmount: Swift.String?
        /// The date and time of when the bonus was granted.
        var grantTime: ClientRuntime.Date?
...
public struct CreateHITInput: Swift.Equatable {
    ...
    /// This member is required.
    var assignmentDurationInSeconds: Swift.Int?
    /// The Assignment-level Review Policy applies to the assignments under the HIT. You can specify for Mechanical Turk to take various actions based on the policy.
    var assignmentReviewPolicy: MTurkClientTypes.ReviewPolicy?
    /// The number of seconds after an assignment for the HIT has been submitted, after which the assignment is considered Approved automatically unless the Requester explicitly rejects it.
    var autoApprovalDelayInSeconds: Swift.Int?
    ...
    var requesterAnnotation: Swift.String?
    /// The amount of money the Requester will pay a Worker for successfully completing the HIT.
    /// This member is required.
    var reward: Swift.String?
...
public struct CreateQualificationTypeInput: Swift.Equatable {
    ...
    var autoGranted: Swift.Bool?
    /// The Qualification value to use for automatically granted Qualifications. This parameter is used only if the AutoGranted parameter is true.
    var autoGrantedValue: Swift.Int?
    ...
    /// This member is required.
    var qualificationTypeStatus: MTurkClientTypes.QualificationTypeStatus?
    ...
    var retryDelayInSeconds: Swift.Int?
    ...
    var testDurationInSeconds: Swift.Int?
...
public struct CreateQualificationTypeOutputResponse: Swift.Equatable {
    ...
    var qualificationType: MTurkClientTypes.QualificationType?
...
public struct GetAccountBalanceOutputResponse: Swift.Equatable {
    /// A string representing a currency amount.
    var availableBalance: Swift.String?
    /// A string representing a currency amount.
    var onHoldBalance: Swift.String?
...
public struct GetAssignmentOutputResponse: Swift.Equatable {
    ...
    var assignment: MTurkClientTypes.Assignment?
...
public struct GetFileUploadURLInput: Swift.Equatable {
    ...
    /// This member is required.
    var questionIdentifier: Swift.String?
...
public struct GetFileUploadURLOutputResponse: Swift.Equatable {
    ...
    var fileUploadURL: Swift.String?
...
public struct GetQualificationScoreOutputResponse: Swift.Equatable {
    ...
    var qualification: MTurkClientTypes.Qualification?
...
extension MTurkClientTypes {
    ...
    public struct HIT: Swift.Equatable {
        ...
        var hITGroupId: Swift.String?
        /// A unique identifier for the HIT.
        var hITId: Swift.String?
        /// The ID of the HIT Layout of this HIT.
        var hITLayoutId: Swift.String?
        /// Indicates the review status of the HIT. Valid Values are NotReviewed | MarkedForReview | ReviewedAppropriate | ReviewedInappropriate.
        var hITReviewStatus: MTurkClientTypes.HITReviewStatus?
        /// The status of the HIT and its assignments. Valid Values are Assignable | Unassignable | Reviewable | Reviewing | Disposed.
        var hITStatus: MTurkClientTypes.HITStatus?
        ...
        var numberOfAssignmentsAvailable: Swift.Int?
        /// The number of assignments for this HIT that have been approved or rejected.
        var numberOfAssignmentsCompleted: Swift.Int?
        /// The number of assignments for this HIT that are being previewed or have been accepted by Workers, but have not yet been submitted, returned, or abandoned.
        var numberOfAssignmentsPending: Swift.Int?
        /// Conditions that a Worker's Qualifications must meet in order to accept the HIT. A HIT can have between zero and ten Qualification requirements. All requirements must be met in order for a Worker to accept the HIT. Additionally, other actions can be restricted using the ActionsGuarded field on each QualificationRequirement structure.
        var qualificationRequirements: [MTurkClientTypes.QualificationRequirement]?
...
public struct ListAssignmentsForHITInput: Swift.Equatable {
    ...
    var assignmentStatuses: [MTurkClientTypes.AssignmentStatus]?
    /// The ID of the HIT.
    /// This member is required.
    var hITId: Swift.String?
...
public struct ListAssignmentsForHITOutputResponse: Swift.Equatable {
    ...
    var assignments: [MTurkClientTypes.Assignment]?
    /// If the previous response was incomplete (because there is more data to retrieve), Amazon Mechanical Turk returns a pagination token in the response. You can use this pagination token to retrieve the next set of results.
    var nextToken: Swift.String?
    /// The number of assignments on the page in the filtered results list, equivalent to the number of assignments returned by this call.
    var numResults: Swift.Int?
...
public struct ListBonusPaymentsOutputResponse: Swift.Equatable {
    ...
    var bonusPayments: [MTurkClientTypes.BonusPayment]?
    /// If the previous response was incomplete (because there is more data to retrieve), Amazon Mechanical Turk returns a pagination token in the response. You can use this pagination token to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct ListQualificationRequestsOutputResponse: Swift.Equatable {
    ...
    var qualificationRequests: [MTurkClientTypes.QualificationRequest]?
...
public struct ListQualificationTypesOutputResponse: Swift.Equatable {
    ...
    var qualificationTypes: [MTurkClientTypes.QualificationType]?
...
public struct ListReviewPolicyResultsForHITInput: Swift.Equatable {
    ...
    var policyLevels: [MTurkClientTypes.ReviewPolicyLevel]?
    /// Specify if the operation should retrieve a list of the actions taken executing the Review Policies and their outcomes.
    var retrieveActions: Swift.Bool?
    /// Specify if the operation should retrieve a list of the results computed by the Review Policies.
    var retrieveResults: Swift.Bool?
...
public struct ListReviewPolicyResultsForHITOutputResponse: Swift.Equatable {
    ...
    var assignmentReviewReport: MTurkClientTypes.ReviewReport?
    /// The HITId of the HIT for which results have been returned.
    var hITId: Swift.String?
    /// The name of the HIT-level Review Policy. This contains only the PolicyName element.
    var hITReviewPolicy: MTurkClientTypes.ReviewPolicy?
    /// Contains both ReviewResult and ReviewAction elements for a particular HIT.
    var hITReviewReport: MTurkClientTypes.ReviewReport?
    /// If the previous response was incomplete (because there is more data to retrieve), Amazon Mechanical Turk returns a pagination token in the response. You can use this pagination token to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct ListReviewableHITsInput: Swift.Equatable {
    ...
    var status: MTurkClientTypes.ReviewableHITStatus?
...
public struct ListWorkerBlocksOutputResponse: Swift.Equatable {
    ...
    var workerBlocks: [MTurkClientTypes.WorkerBlock]?
...
public struct ListWorkersWithQualificationTypeInput: Swift.Equatable {
    ...
    var status: MTurkClientTypes.QualificationStatus?
...
public struct ListWorkersWithQualificationTypeOutputResponse: Swift.Equatable {
    ...
    var qualifications: [MTurkClientTypes.Qualification]?
...
extension MTurkClientTypes {
    ...
    public struct NotificationSpecification: Swift.Equatable {
        ...
        /// This member is required.
        var eventTypes: [MTurkClientTypes.EventType]?
        /// The method Amazon Mechanical Turk uses to send the notification. Valid Values: Email | SQS | SNS.
        /// This member is required.
        var transport: MTurkClientTypes.NotificationTransport?
...
extension MTurkClientTypes {
    ...
    public struct NotifyWorkersFailureStatus: Swift.Equatable {
        ...
        var notifyWorkersFailureCode: MTurkClientTypes.NotifyWorkersFailureCode?
        /// A message detailing the reason the Worker could not be notified.
        var notifyWorkersFailureMessage: Swift.String?
...
public struct NotifyWorkersOutputResponse: Swift.Equatable {
    ...
    var notifyWorkersFailureStatuses: [MTurkClientTypes.NotifyWorkersFailureStatus]?
...
extension MTurkClientTypes {
    ...
    public struct PolicyParameter: Swift.Equatable {
        ...
        var mapEntries: [MTurkClientTypes.ParameterMapEntry]?
...
extension MTurkClientTypes {
    ...
    public struct Qualification: Swift.Equatable {
        ...
        var integerValue: Swift.Int?
        /// The Locale data structure represents a geographical region or location.
        var localeValue: MTurkClientTypes.Locale?
...
extension MTurkClientTypes {
    ...
    public struct QualificationRequirement: Swift.Equatable {
        ...
        var requiredToPreview: Swift.Bool?
...
extension MTurkClientTypes {
    ...
    public struct ReviewPolicy: Swift.Equatable {
        /// Name of the parameter from the Review policy.
        var parameters: [MTurkClientTypes.PolicyParameter]?
...
extension MTurkClientTypes {
    ...
    public struct ReviewReport: Swift.Equatable {
        ...
        var reviewActions: [MTurkClientTypes.ReviewActionDetail]?
        /// A list of ReviewResults objects for each action specified in the Review Policy.
        var reviewResults: [MTurkClientTypes.ReviewResultDetail]?
...
extension MTurkClientTypes {
    ...
    public struct ReviewResultDetail: Swift.Equatable {
        ...
        var questionId: Swift.String?
        /// The HITID or AssignmentId about which this result was taken. Note that HIT-level Review Policies will often emit results about both the HIT itself and its Assignments, while Assignment-level review policies generally only emit results about the Assignment itself.
        var subjectId: Swift.String?
        /// The type of the object from the SubjectId field.
        var subjectType: Swift.String?
...
public struct SendTestEventNotificationInput: Swift.Equatable {
    ...
    /// This member is required.
    var notification: MTurkClientTypes.NotificationSpecification?
    /// The event to simulate to test the notification specification. This event is included in the test message even if the notification specification does not include the event type. The notification specification does not filter out the test event.
    /// This member is required.
    var testEventType: MTurkClientTypes.EventType?
...
public struct UpdateExpirationForHITInput: Swift.Equatable {
    ...
    /// This member is required.
    var expireAt: ClientRuntime.Date?
    /// The HIT to update.
    /// This member is required.
    var hITId: Swift.String?
