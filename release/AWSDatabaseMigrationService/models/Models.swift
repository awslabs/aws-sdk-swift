...
extension DatabaseMigrationClientTypes {
    ...
    public struct AccountQuota: Swift.Equatable {
        ...
        var accountQuotaName: Swift.String?
...
public struct AddTagsToResourceInput: Swift.Equatable {
    ...
    /// This member is required.
    var tags: [DatabaseMigrationClientTypes.Tag]?
...
public struct ApplyPendingMaintenanceActionInput: Swift.Equatable {
    ...
    /// This member is required.
    var replicationInstanceArn: Swift.String?
...
public struct ApplyPendingMaintenanceActionOutputResponse: Swift.Equatable {
    ...
    var resourcePendingMaintenanceActions: DatabaseMigrationClientTypes.ResourcePendingMaintenanceActions?
...
public struct CancelReplicationTaskAssessmentRunInput: Swift.Equatable {
    ...
    /// This member is required.
    var replicationTaskAssessmentRunArn: Swift.String?
...
public struct CancelReplicationTaskAssessmentRunOutputResponse: Swift.Equatable {
    ...
    var replicationTaskAssessmentRun: DatabaseMigrationClientTypes.ReplicationTaskAssessmentRun?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct Certificate: Swift.Equatable {
        ...
        var certificateCreationDate: ClientRuntime.Date?
        /// A customer-assigned name for the certificate. Identifiers must begin with a letter and must contain only ASCII letters, digits, and hyphens. They can't end with a hyphen or contain two consecutive hyphens.
        var certificateIdentifier: Swift.String?
        /// The owner of the certificate.
        var certificateOwner: Swift.String?
        /// The contents of a .pem file, which contains an X.509 certificate.
        var certificatePem: Swift.String?
        /// The location of an imported Oracle Wallet certificate for use with SSL. Example: filebase64("${path.root}/rds-ca-2019-root.sso")
        var certificateWallet: ClientRuntime.Data?
        /// The key length of the cryptographic algorithm being used.
        var keyLength: Swift.Int?
        /// The signing algorithm for the certificate.
        var signingAlgorithm: Swift.String?
        /// The beginning date that the certificate is valid.
        var validFromDate: ClientRuntime.Date?
        /// The final date that the certificate is valid.
        var validToDate: ClientRuntime.Date?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct Connection: Swift.Equatable {
        ...
        var endpointArn: Swift.String?
        /// The identifier of the endpoint. Identifiers must begin with a letter and must contain only ASCII letters, digits, and hyphens. They can't end with a hyphen or contain two consecutive hyphens.
        var endpointIdentifier: Swift.String?
        /// The error message when the connection last failed.
        var lastFailureMessage: Swift.String?
        /// The ARN of the replication instance.
        var replicationInstanceArn: Swift.String?
        /// The replication instance identifier. This parameter is stored as a lowercase string.
        var replicationInstanceIdentifier: Swift.String?
...
public struct CreateEndpointInput: Swift.Equatable {
    ...
    var dmsTransferSettings: DatabaseMigrationClientTypes.DmsTransferSettings?
    /// Provides information that defines a DocumentDB endpoint.
    var docDbSettings: DatabaseMigrationClientTypes.DocDbSettings?
    ...
    var dynamoDbSettings: DatabaseMigrationClientTypes.DynamoDbSettings?
    ...
    var elasticsearchSettings: DatabaseMigrationClientTypes.ElasticsearchSettings?
    /// The database endpoint identifier. Identifiers must begin with a letter and must contain only ASCII letters, digits, and hyphens. They can't end with a hyphen, or contain two consecutive hyphens.
    /// This member is required.
    var endpointIdentifier: Swift.String?
    /// The type of endpoint. Valid values are source and target.
    /// This member is required.
    var endpointType: DatabaseMigrationClientTypes.ReplicationEndpointTypeValue?
    ...
    /// This member is required.
    var engineName: Swift.String?
    /// The external table definition.
    var externalTableDefinition: Swift.String?
    ...
    var extraConnectionAttributes: Swift.String?
    /// Settings in JSON format for the source GCP MySQL endpoint.
    var gcpMySQLSettings: DatabaseMigrationClientTypes.GcpMySQLSettings?
    ...
    var iBMDb2Settings: DatabaseMigrationClientTypes.IBMDb2Settings?
    ...
    var kafkaSettings: DatabaseMigrationClientTypes.KafkaSettings?
    ...
    var kinesisSettings: DatabaseMigrationClientTypes.KinesisSettings?
    ...
    var microsoftSQLServerSettings: DatabaseMigrationClientTypes.MicrosoftSQLServerSettings?
    ...
    var mongoDbSettings: DatabaseMigrationClientTypes.MongoDbSettings?
    ...
    var mySQLSettings: DatabaseMigrationClientTypes.MySQLSettings?
    ...
    var neptuneSettings: DatabaseMigrationClientTypes.NeptuneSettings?
    ...
    var oracleSettings: DatabaseMigrationClientTypes.OracleSettings?
    ...
    var postgreSQLSettings: DatabaseMigrationClientTypes.PostgreSQLSettings?
    /// Settings in JSON format for the target Redis endpoint.
    var redisSettings: DatabaseMigrationClientTypes.RedisSettings?
    /// Provides information that defines an Amazon Redshift endpoint.
    var redshiftSettings: DatabaseMigrationClientTypes.RedshiftSettings?
    ...
    var s3Settings: DatabaseMigrationClientTypes.S3Settings?
    /// The name of the server where the endpoint database resides.
    var serverName: Swift.String?
    ...
    var serviceAccessRoleArn: Swift.String?
    /// The Secure Sockets Layer (SSL) mode to use for the SSL connection. The default is none
    var sslMode: DatabaseMigrationClientTypes.DmsSslModeValue?
    ...
    var sybaseSettings: DatabaseMigrationClientTypes.SybaseSettings?
...
public struct CreateEndpointOutputResponse: Swift.Equatable {
    ...
    var endpoint: DatabaseMigrationClientTypes.Endpoint?
...
public struct CreateEventSubscriptionOutputResponse: Swift.Equatable {
    ...
    var eventSubscription: DatabaseMigrationClientTypes.EventSubscription?
...
public struct CreateReplicationInstanceInput: Swift.Equatable {
    ...
    var dnsNameServers: Swift.String?
    ...
    /// This member is required.
    var replicationInstanceClass: Swift.String?
    ...
    var replicationSubnetGroupIdentifier: Swift.String?
    /// A friendly name for the resource identifier at the end of the EndpointArn response parameter that is returned in the created Endpoint object. The value for this parameter can have up to 31 characters. It can contain only ASCII letters, digits, and hyphen ('-'). Also, it can't end with a hyphen or contain two consecutive hyphens, and can only begin with a letter, such as Example-App-ARN1. For example, this value might result in the EndpointArn value arn:aws:dms:eu-west-1:012345678901:rep:Example-App-ARN1. If you don't specify a ResourceIdentifier value, DMS generates a default identifier value for the end of EndpointArn.
    var resourceIdentifier: Swift.String?
...
public struct CreateReplicationInstanceOutputResponse: Swift.Equatable {
    ...
    var replicationInstance: DatabaseMigrationClientTypes.ReplicationInstance?
...
public struct CreateReplicationSubnetGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var replicationSubnetGroupDescription: Swift.String?
...
public struct CreateReplicationSubnetGroupOutputResponse: Swift.Equatable {
    ...
    var replicationSubnetGroup: DatabaseMigrationClientTypes.ReplicationSubnetGroup?
...
public struct CreateReplicationTaskInput: Swift.Equatable {
    ...
    var cdcStartPosition: Swift.String?
    /// Indicates the start time for a change data capture (CDC) operation. Use either CdcStartTime or CdcStartPosition to specify when you want a CDC operation to start. Specifying both values results in an error. Timestamp Example: --cdc-start-time “2018-03-08T12:12:12”
    var cdcStartTime: ClientRuntime.Date?
    ...
    var cdcStopPosition: Swift.String?
    /// The migration type. Valid values: full-load | cdc | full-load-and-cdc
    /// This member is required.
    var migrationType: DatabaseMigrationClientTypes.MigrationTypeValue?
    ...
    /// This member is required.
    var replicationTaskIdentifier: Swift.String?
    ...
    var replicationTaskSettings: Swift.String?
    /// A friendly name for the resource identifier at the end of the EndpointArn response parameter that is returned in the created Endpoint object. The value for this parameter can have up to 31 characters. It can contain only ASCII letters, digits, and hyphen ('-'). Also, it can't end with a hyphen or contain two consecutive hyphens, and can only begin with a letter, such as Example-App-ARN1. For example, this value might result in the EndpointArn value arn:aws:dms:eu-west-1:012345678901:rep:Example-App-ARN1. If you don't specify a ResourceIdentifier value, DMS generates a default identifier value for the end of EndpointArn.
    var resourceIdentifier: Swift.String?
    /// An Amazon Resource Name (ARN) that uniquely identifies the source endpoint.
    /// This member is required.
    var sourceEndpointArn: Swift.String?
    ...
    /// This member is required.
    var tableMappings: Swift.String?
    /// One or more tags to be assigned to the replication task.
    var tags: [DatabaseMigrationClientTypes.Tag]?
    /// An Amazon Resource Name (ARN) that uniquely identifies the target endpoint.
    /// This member is required.
    var targetEndpointArn: Swift.String?
...
public struct CreateReplicationTaskOutputResponse: Swift.Equatable {
    ...
    var replicationTask: DatabaseMigrationClientTypes.ReplicationTask?
...
public struct DeleteCertificateOutputResponse: Swift.Equatable {
    ...
    var certificate: DatabaseMigrationClientTypes.Certificate?
...
public struct DeleteConnectionOutputResponse: Swift.Equatable {
    ...
    var connection: DatabaseMigrationClientTypes.Connection?
...
public struct DeleteReplicationTaskInput: Swift.Equatable {
    ...
    /// This member is required.
    var replicationTaskArn: Swift.String?
...
public struct DescribeAccountAttributesOutputResponse: Swift.Equatable {
    ...
    var accountQuotas: [DatabaseMigrationClientTypes.AccountQuota]?
    ...
    var uniqueAccountIdentifier: Swift.String?
...
public struct DescribeApplicableIndividualAssessmentsInput: Swift.Equatable {
    ...
    var sourceEngineName: Swift.String?
    /// Name of a database engine that the specified replication instance supports as a target.
    var targetEngineName: Swift.String?
...
public struct DescribeApplicableIndividualAssessmentsOutputResponse: Swift.Equatable {
    ...
    var individualAssessmentNames: [Swift.String]?
...
public struct DescribeCertificatesInput: Swift.Equatable {
    ...
    var filters: [DatabaseMigrationClientTypes.Filter]?
...
public struct DescribeCertificatesOutputResponse: Swift.Equatable {
    ...
    var certificates: [DatabaseMigrationClientTypes.Certificate]?
...
public struct DescribeConnectionsOutputResponse: Swift.Equatable {
    ...
    var connections: [DatabaseMigrationClientTypes.Connection]?
    /// An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by MaxRecords.
    var marker: Swift.String?
...
public struct DescribeEndpointSettingsOutputResponse: Swift.Equatable {
    ...
    var endpointSettings: [DatabaseMigrationClientTypes.EndpointSetting]?
    /// An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by MaxRecords.
    var marker: Swift.String?
...
public struct DescribeEndpointTypesOutputResponse: Swift.Equatable {
    ...
    var supportedEndpointTypes: [DatabaseMigrationClientTypes.SupportedEndpointType]?
...
public struct DescribeEndpointsOutputResponse: Swift.Equatable {
    ...
    var endpoints: [DatabaseMigrationClientTypes.Endpoint]?
    /// An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by MaxRecords.
    var marker: Swift.String?
...
public struct DescribeEventCategoriesOutputResponse: Swift.Equatable {
    ...
    var eventCategoryGroupList: [DatabaseMigrationClientTypes.EventCategoryGroup]?
...
public struct DescribeEventSubscriptionsOutputResponse: Swift.Equatable {
    ...
    var eventSubscriptionsList: [DatabaseMigrationClientTypes.EventSubscription]?
    /// An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by MaxRecords.
    var marker: Swift.String?
...
public struct DescribeEventsInput: Swift.Equatable {
    ...
    /// The type of DMS resource that generates events. Valid values: replication-instance | replication-task
    var sourceType: DatabaseMigrationClientTypes.SourceType?
...
public struct DescribeEventsOutputResponse: Swift.Equatable {
    ...
    var events: [DatabaseMigrationClientTypes.Event]?
    /// An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by MaxRecords.
    var marker: Swift.String?
...
public struct DescribeOrderableReplicationInstancesOutputResponse: Swift.Equatable {
    ...
    var orderableReplicationInstances: [DatabaseMigrationClientTypes.OrderableReplicationInstance]?
...
public struct DescribePendingMaintenanceActionsOutputResponse: Swift.Equatable {
    ...
    var pendingMaintenanceActions: [DatabaseMigrationClientTypes.ResourcePendingMaintenanceActions]?
...
public struct DescribeRefreshSchemasStatusOutputResponse: Swift.Equatable {
    ...
    var refreshSchemasStatus: DatabaseMigrationClientTypes.RefreshSchemasStatus?
...
public struct DescribeReplicationInstanceTaskLogsOutputResponse: Swift.Equatable {
    ...
    var replicationInstanceTaskLogs: [DatabaseMigrationClientTypes.ReplicationInstanceTaskLog]?
...
public struct DescribeReplicationInstancesOutputResponse: Swift.Equatable {
    ...
    var replicationInstances: [DatabaseMigrationClientTypes.ReplicationInstance]?
...
public struct DescribeReplicationSubnetGroupsOutputResponse: Swift.Equatable {
    ...
    var replicationSubnetGroups: [DatabaseMigrationClientTypes.ReplicationSubnetGroup]?
...
public struct DescribeReplicationTaskAssessmentResultsOutputResponse: Swift.Equatable {
    ...
    var replicationTaskAssessmentResults: [DatabaseMigrationClientTypes.ReplicationTaskAssessmentResult]?
...
public struct DescribeReplicationTaskAssessmentRunsOutputResponse: Swift.Equatable {
    ...
    var replicationTaskAssessmentRuns: [DatabaseMigrationClientTypes.ReplicationTaskAssessmentRun]?
...
public struct DescribeReplicationTaskIndividualAssessmentsOutputResponse: Swift.Equatable {
    ...
    var replicationTaskIndividualAssessments: [DatabaseMigrationClientTypes.ReplicationTaskIndividualAssessment]?
...
public struct DescribeReplicationTasksInput: Swift.Equatable {
    ...
    var withoutSettings: Swift.Bool?
...
public struct DescribeReplicationTasksOutputResponse: Swift.Equatable {
    ...
    var replicationTasks: [DatabaseMigrationClientTypes.ReplicationTask]?
...
public struct DescribeTableStatisticsOutputResponse: Swift.Equatable {
    ...
    var tableStatistics: [DatabaseMigrationClientTypes.TableStatistics]?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct DocDbSettings: Swift.Equatable {
        ...
        var nestingLevel: DatabaseMigrationClientTypes.NestingLevelValue?
        ...
        var secretsManagerAccessRoleArn: Swift.String?
        ...
        var secretsManagerSecretId: Swift.String?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ElasticsearchSettings: Swift.Equatable {
        ...
        /// This member is required.
        var endpointUri: Swift.String?
        /// The maximum number of seconds for which DMS retries failed API requests to the OpenSearch cluster.
        var errorRetryDuration: Swift.Int?
        ...
        var fullLoadErrorPercentage: Swift.Int?
        /// The Amazon Resource Name (ARN) used by the service to access the IAM role. The role must allow the iam:PassRole action.
        /// This member is required.
        var serviceAccessRoleArn: Swift.String?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct Endpoint: Swift.Equatable {
        ...
        var engineDisplayName: Swift.String?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct EndpointSetting: Swift.Equatable {
        ...
        var applicability: Swift.String?
        ...
        var enumValues: [Swift.String]?
        /// The maximum value of an endpoint setting that is of type int.
        var intValueMax: Swift.Int?
        /// The minimum value of an endpoint setting that is of type int.
        var intValueMin: Swift.Int?
        /// The name that you want to give the endpoint settings.
        var name: Swift.String?
        /// A value that marks this endpoint setting as sensitive.
        var sensitive: Swift.Bool?
        /// The type of endpoint. Valid values are source and target.
        var type: DatabaseMigrationClientTypes.EndpointSettingTypeValue?
        /// The unit of measure for this endpoint setting.
        var units: Swift.String?
...
extension DatabaseMigrationClientTypes.GcpMySQLSettings: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DatabaseMigrationClientTypes {
    ...
    public struct GcpMySQLSettings: Swift.Equatable {
        ...
        var afterConnectScript: Swift.String?
        ...
        var cleanSourceMetadataOnMismatch: Swift.Bool?
        ...
        var eventsPollInterval: Swift.Int?
        ...
        var serverTimezone: Swift.String?
        ...
        var targetDbType: DatabaseMigrationClientTypes.TargetDbType?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct IBMDb2Settings: Swift.Equatable {
        ...
        var currentLsn: Swift.String?
        /// Database name for the endpoint.
        var databaseName: Swift.String?
        /// Maximum number of bytes per read, as a NUMBER value. The default is 64 KB.
        var maxKBytesPerRead: Swift.Int?
        /// Endpoint connection password.
        var password: Swift.String?
        ...
        var setDataCaptureChanges: Swift.Bool?
        /// Endpoint connection user name.
        var username: Swift.String?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct KafkaSettings: Swift.Equatable {
        ...
        var broker: Swift.String?
        /// Shows detailed control information for table definition, column definition, and table and column changes in the Kafka message output. The default is false.
        var includeControlDetails: Swift.Bool?
        /// Include NULL and empty columns for records migrated to the endpoint. The default is false.
        var includeNullAndEmpty: Swift.Bool?
        /// Shows the partition value within the Kafka message output unless the partition type is schema-table-type. The default is false.
        var includePartitionValue: Swift.Bool?
        /// Includes any data definition language (DDL) operations that change the table in the control data, such as rename-table, drop-table, add-column, drop-column, and rename-column. The default is false.
        var includeTableAlterOperations: Swift.Bool?
        /// Provides detailed transaction information from the source database. This information includes a commit timestamp, a log position, and values for transaction_id, previous transaction_id, and transaction_record_id (the record offset within a transaction). The default is false.
        var includeTransactionDetails: Swift.Bool?
        /// The output format for the records created on the endpoint. The message format is JSON (default) or JSON_UNFORMATTED (a single line with no tab).
        var messageFormat: DatabaseMigrationClientTypes.MessageFormatValue?
        /// The maximum size in bytes for records created on the endpoint The default is 1,000,000.
        var messageMaxBytes: Swift.Int?
        ...
        var noHexPrefix: Swift.Bool?
        /// Prefixes schema and table names to partition values, when the partition type is primary-key-type. Doing this increases data distribution among Kafka partitions. For example, suppose that a SysBench schema has thousands of tables and each table has only limited range for a primary key. In this case, the same primary key is sent from thousands of tables to the same partition, which causes throttling. The default is false.
        var partitionIncludeSchemaTable: Swift.Bool?
        /// The secure password you created when you first set up your MSK cluster to validate a client identity and make an encrypted connection between server and client using SASL-SSL authentication.
        var saslPassword: Swift.String?
        /// The secure user name you created when you first set up your MSK cluster to validate a client identity and make an encrypted connection between server and client using SASL-SSL authentication.
        var saslUsername: Swift.String?
        /// Set secure connection to a Kafka target endpoint using Transport Layer Security (TLS). Options include ssl-encryption, ssl-authentication, and sasl-ssl. sasl-ssl requires SaslUsername and SaslPassword.
        var securityProtocol: DatabaseMigrationClientTypes.KafkaSecurityProtocol?
        ...
        var sslCaCertificateArn: Swift.String?
        /// The Amazon Resource Name (ARN) of the client certificate used to securely connect to a Kafka target endpoint.
        var sslClientCertificateArn: Swift.String?
        /// The Amazon Resource Name (ARN) for the client private key used to securely connect to a Kafka target endpoint.
        var sslClientKeyArn: Swift.String?
        /// The password for the client private key used to securely connect to a Kafka target endpoint.
        var sslClientKeyPassword: Swift.String?
...
public struct ListTagsForResourceOutputResponse: Swift.Equatable {
    ...
    var tagList: [DatabaseMigrationClientTypes.Tag]?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct MicrosoftSQLServerSettings: Swift.Equatable {
        ...
        var controlTablesFileGroup: Swift.String?
        /// Database name for the endpoint.
        var databaseName: Swift.String?
        /// Endpoint connection password.
        var password: Swift.String?
        ...
        var querySingleAlwaysOnNode: Swift.Bool?
        ...
        var safeguardPolicy: DatabaseMigrationClientTypes.SafeguardPolicy?
        ...
        var useBcpFullLoad: Swift.Bool?
        /// When this attribute is set to Y, DMS processes third-party transaction log backups if they are created in native format.
        var useThirdPartyBackupDevice: Swift.Bool?
        /// Endpoint connection user name.
        var username: Swift.String?
...
public struct ModifyReplicationInstanceInput: Swift.Equatable {
    ...
    var allowMajorVersionUpgrade: Swift.Bool
...
extension DatabaseMigrationClientTypes {
    ...
    public struct MongoDbSettings: Swift.Equatable {
        ...
        var authType: DatabaseMigrationClientTypes.AuthTypeValue?
        /// The database name on the MongoDB source endpoint.
        var databaseName: Swift.String?
        /// Indicates the number of documents to preview to determine the document organization. Use this setting when NestingLevel is set to "one". Must be a positive value greater than 0. Default value is 1000.
        var docsToInvestigate: Swift.String?
        /// Specifies the document ID. Use this setting when NestingLevel is set to "none". Default value is "false".
        var extractDocId: Swift.String?
        /// The KMS key identifier that is used to encrypt the content on the replication instance. If you don't specify a value for the KmsKeyId parameter, then DMS uses your default encryption key. KMS creates the default encryption key for your Amazon Web Services account. Your Amazon Web Services account has a different default encryption key for each Amazon Web Services Region.
        var kmsKeyId: Swift.String?
        /// Specifies either document or table mode. Default value is "none". Specify "none" to use document mode. Specify "one" to use table mode.
        var nestingLevel: DatabaseMigrationClientTypes.NestingLevelValue?
...
public struct MoveReplicationTaskInput: Swift.Equatable {
    ...
    /// This member is required.
    var targetReplicationInstanceArn: Swift.String?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct OracleSettings: Swift.Equatable {
        ...
        var accessAlternateDirectly: Swift.Bool?
        ...
        var addSupplementalLogging: Swift.Bool?
        ...
        var additionalArchivedLogDestId: Swift.Int?
        /// Set this attribute to true to enable replication of Oracle tables containing columns that are nested tables or defined types.
        var allowSelectNestedTables: Swift.Bool?
        /// Specifies the ID of the destination for the archived redo logs. This value should be the same as a number in the dest_id column of the v$archived_log view. If you work with an additional redo log destination, use the AdditionalArchivedLogDestId option to specify the additional destination ID. Doing this improves performance by ensuring that the correct logs are accessed from the outset.
        var archivedLogDestId: Swift.Int?
        ...
        var archivedLogsOnly: Swift.Bool?
        ...
        var charLengthSemantics: DatabaseMigrationClientTypes.CharLengthSemantics?
        /// Database name for the endpoint.
        var databaseName: Swift.String?
        /// When set to true, this attribute helps to increase the commit rate on the Oracle target database by writing directly to tables and not writing a trail to database logs.
        var directPathNoLog: Swift.Bool?
        ...
        var directPathParallelLoad: Swift.Bool?
        /// Set this attribute to enable homogenous tablespace replication and create existing tables or indexes under the same tablespace on the target.
        var enableHomogenousTablespace: Swift.Bool?
        ...
        var extraArchivedLogDestIds: [Swift.Int]?
        ...
        var failTasksOnLobTruncation: Swift.Bool?
        ...
        var secretsManagerOracleAsmAccessRoleArn: Swift.String?
        ...
        var secretsManagerOracleAsmSecretId: Swift.String?
        ...
        var securityDbEncryption: Swift.String?
        ...
        var securityDbEncryptionName: Swift.String?
        /// Fully qualified domain name of the endpoint.
        var serverName: Swift.String?
        /// Use this attribute to convert SDO_GEOMETRY to GEOJSON format. By default, DMS calls the SDO2GEOJSON custom function if present and accessible. Or you can create your own custom function that mimics the operation of SDOGEOJSON and set SpatialDataOptionToGeoJsonFunctionName to call it instead.
        var spatialDataOptionToGeoJsonFunctionName: Swift.String?
        ...
        var standbyDelayTime: Swift.Int?
        /// Set this attribute to true in order to use the Binary Reader to capture change data for an Amazon RDS for Oracle as the source. This tells the DMS instance to use any specified prefix replacement to access all online redo logs.
        var useAlternateFolderForOnline: Swift.Bool?
        ...
        var useDirectPathFullLoad: Swift.Bool?
        ...
        var useLogminerReader: Swift.Bool?
        /// Set this string attribute to the required value in order to use the Binary Reader to capture change data for an Amazon RDS for Oracle as the source. This value specifies the path prefix used to replace the default Oracle root to access the redo logs.
        var usePathPrefix: Swift.String?
        /// Endpoint connection user name.
        var username: Swift.String?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct OrderableReplicationInstance: Swift.Equatable {
        ...
        var defaultAllocatedStorage: Swift.Int
        /// The version of the replication engine.
        var engineVersion: Swift.String?
        /// The amount of storage (in gigabytes) that is allocated for the replication instance.
        var includedAllocatedStorage: Swift.Int
        /// The minimum amount of storage (in gigabytes) that can be allocated for the replication instance.
        var maxAllocatedStorage: Swift.Int
        /// The minimum amount of storage (in gigabytes) that can be allocated for the replication instance.
        var minAllocatedStorage: Swift.Int
        ...
        var releaseStatus: DatabaseMigrationClientTypes.ReleaseStatusValues?
        /// The compute and memory capacity of the replication instance as defined for the specified replication instance class. For example to specify the instance class dms.c4.large, set this parameter to "dms.c4.large". For more information on the settings and capacities for the available replication instance classes, see [ Selecting the right DMS replication instance for your migration](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_ReplicationInstance.html#CHAP_ReplicationInstance.InDepth).
        var replicationInstanceClass: Swift.String?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct PostgreSQLSettings: Swift.Equatable {
        ...
        var heartbeatEnable: Swift.Bool?
        /// Sets the WAL heartbeat frequency (in minutes).
        var heartbeatFrequency: Swift.Int?
        /// Sets the schema in which the heartbeat artifacts are created.
        var heartbeatSchema: Swift.String?
        /// Specifies the maximum size (in KB) of any .csv file used to transfer data to PostgreSQL. Example: maxFileSize=512
        var maxFileSize: Swift.Int?
        /// Endpoint connection password.
        var password: Swift.String?
        /// Specifies the plugin to use to create a replication slot.
        var pluginName: DatabaseMigrationClientTypes.PluginNameValue?
...
public struct RebootReplicationInstanceInput: Swift.Equatable {
    ...
    var forcePlannedFailover: Swift.Bool?
    /// The Amazon Resource Name (ARN) of the replication instance.
    /// This member is required.
    var replicationInstanceArn: Swift.String?
...
extension DatabaseMigrationClientTypes.RedisSettings: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DatabaseMigrationClientTypes {
    ...
    public struct RedisSettings: Swift.Equatable {
        ...
        var authPassword: Swift.String?
        /// The type of authentication to perform when connecting to a Redis target. Options include none, auth-token, and auth-role. The auth-token option requires an AuthPassword value to be provided. The auth-role option requires AuthUserName and AuthPassword values to be provided.
        var authType: DatabaseMigrationClientTypes.RedisAuthTypeValue?
        /// The user name provided with the auth-role option of the AuthType setting for a Redis target endpoint.
        var authUserName: Swift.String?
        ...
        var sslSecurityProtocol: DatabaseMigrationClientTypes.SslSecurityProtocolValue?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct RedshiftSettings: Swift.Equatable {
        ...
        var bucketFolder: Swift.String?
        /// The name of the intermediate S3 bucket used to store .csv files before uploading data to Redshift.
        var bucketName: Swift.String?
        /// If Amazon Redshift is configured to support case sensitive schema names, set CaseSensitiveNames to true. The default is false.
        var caseSensitiveNames: Swift.Bool?
        ...
        var compUpdate: Swift.Bool?
        /// A value that sets the amount of time to wait (in milliseconds) before timing out, beginning from when you initially establish a connection.
        var connectionTimeout: Swift.Int?
        ...
        var encryptionMode: DatabaseMigrationClientTypes.EncryptionModeValue?
        /// This setting is only valid for a full-load migration task. Set ExplicitIds to true to have tables with IDENTITY columns override their auto-generated values with explicit values loaded from the source data files used to populate the tables. The default is false.
        var explicitIds: Swift.Bool?
        ...
        var fileTransferUploadStreams: Swift.Int?
        ...
        var removeQuotes: Swift.Bool?
        /// A value that specifies to replaces the invalid characters specified in ReplaceInvalidChars, substituting the specified characters instead. The default is "?".
        var replaceChars: Swift.String?
        /// A list of characters that you want to replace. Use with ReplaceChars.
        var replaceInvalidChars: Swift.String?
        ...
        var serverSideEncryptionKmsKeyId: Swift.String?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct RefreshSchemasStatus: Swift.Equatable {
        ...
        var lastRefreshDate: ClientRuntime.Date?
        /// The Amazon Resource Name (ARN) of the replication instance.
        var replicationInstanceArn: Swift.String?
        /// The status of the schema.
        var status: DatabaseMigrationClientTypes.RefreshSchemasStatusTypeValue?
...
public struct ReloadTablesInput: Swift.Equatable {
    ...
    var reloadOption: DatabaseMigrationClientTypes.ReloadOptionValue?
    /// The Amazon Resource Name (ARN) of the replication task.
    /// This member is required.
    var replicationTaskArn: Swift.String?
    /// The name and schema of the table to be reloaded.
    /// This member is required.
    var tablesToReload: [DatabaseMigrationClientTypes.TableToReload]?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ReplicationInstance: Swift.Equatable {
        ...
        var freeUntil: ClientRuntime.Date?
        ...
        var pendingModifiedValues: DatabaseMigrationClientTypes.ReplicationPendingModifiedValues?
        ...
        var replicationInstancePrivateIpAddress: Swift.String?
        /// One or more private IP addresses for the replication instance.
        var replicationInstancePrivateIpAddresses: [Swift.String]?
        /// The public IP address of the replication instance.
        @available(*, deprecated)
        var replicationInstancePublicIpAddress: Swift.String?
        /// One or more public IP addresses for the replication instance.
        var replicationInstancePublicIpAddresses: [Swift.String]?
        ...
        ///
        /// * "maintenance"
        var replicationInstanceStatus: Swift.String?
        /// The subnet group for the replication instance.
        var replicationSubnetGroup: DatabaseMigrationClientTypes.ReplicationSubnetGroup?
        /// The Availability Zone of the standby replication instance in a Multi-AZ deployment.
        var secondaryAvailabilityZone: Swift.String?
        /// The VPC security group for the instance.
        var vpcSecurityGroups: [DatabaseMigrationClientTypes.VpcSecurityGroupMembership]?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ReplicationInstanceTaskLog: Swift.Equatable {
        ...
        var replicationInstanceTaskLogSize: Swift.Int
        /// The Amazon Resource Name (ARN) of the replication task.
        var replicationTaskArn: Swift.String?
        /// The name of the replication task.
        var replicationTaskName: Swift.String?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ReplicationSubnetGroup: Swift.Equatable {
        ...
        var subnets: [DatabaseMigrationClientTypes.Subnet]?
        /// The ID of the VPC.
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ReplicationTask: Swift.Equatable {
        ...
        var recoveryCheckpoint: Swift.String?
        /// The ARN of the replication instance.
        var replicationInstanceArn: Swift.String?
        /// The Amazon Resource Name (ARN) of the replication task.
        var replicationTaskArn: Swift.String?
        /// The date the replication task was created.
        var replicationTaskCreationDate: ClientRuntime.Date?
        ...
        var replicationTaskStartDate: ClientRuntime.Date?
        /// The statistics for the task, including elapsed time, tables loaded, and table errors.
        var replicationTaskStats: DatabaseMigrationClientTypes.ReplicationTaskStats?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ReplicationTaskAssessmentResult: Swift.Equatable {
        ...
        var assessmentResults: Swift.String?
        /// The file containing the results of the task assessment.
        var assessmentResultsFile: Swift.String?
        /// The status of the task assessment.
        var assessmentStatus: Swift.String?
        /// The Amazon Resource Name (ARN) of the replication task.
        var replicationTaskArn: Swift.String?
        /// The replication task identifier of the task on which the task assessment was run.
        var replicationTaskIdentifier: Swift.String?
        /// The date the task assessment was completed.
        var replicationTaskLastAssessmentDate: ClientRuntime.Date?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ReplicationTaskAssessmentRun: Swift.Equatable {
        ...
        var assessmentProgress: DatabaseMigrationClientTypes.ReplicationTaskAssessmentRunProgress?
        ...
        var replicationTaskAssessmentRunCreationDate: ClientRuntime.Date?
        /// Encryption mode used to encrypt the assessment run results.
        var resultEncryptionMode: Swift.String?
        /// ARN of the KMS encryption key used to encrypt the assessment run results.
        var resultKmsKeyArn: Swift.String?
        /// Amazon S3 bucket where DMS stores the results of this assessment run.
        var resultLocationBucket: Swift.String?
        /// Folder in an Amazon S3 bucket where DMS stores the results of this assessment run.
        var resultLocationFolder: Swift.String?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ReplicationTaskAssessmentRunProgress: Swift.Equatable {
        ...
        var individualAssessmentCompletedCount: Swift.Int
        /// The number of individual assessments that are specified to run.
        var individualAssessmentCount: Swift.Int
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ReplicationTaskIndividualAssessment: Swift.Equatable {
        ...
        var individualAssessmentName: Swift.String?
        /// ARN of the premigration assessment run that is created to run this individual assessment.
        var replicationTaskAssessmentRunArn: Swift.String?
        /// Amazon Resource Name (ARN) of this individual assessment.
        var replicationTaskIndividualAssessmentArn: Swift.String?
        /// Date when this individual assessment was started as part of running the StartReplicationTaskAssessmentRun operation.
        var replicationTaskIndividualAssessmentStartDate: ClientRuntime.Date?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ReplicationTaskStats: Swift.Equatable {
        ...
        var elapsedTimeMillis: Swift.Int
        /// The date the replication task was started either with a fresh start or a target reload.
        var freshStartDate: ClientRuntime.Date?
        /// The date the replication task full load was completed.
        var fullLoadFinishDate: ClientRuntime.Date?
        /// The percent complete for the full load migration task.
        var fullLoadProgressPercent: Swift.Int
        /// The date the replication task full load was started.
        var fullLoadStartDate: ClientRuntime.Date?
        ...
        var stopDate: ClientRuntime.Date?
        /// The number of errors that have occurred during this task.
        var tablesErrored: Swift.Int
        /// The number of tables loaded for this task.
        var tablesLoaded: Swift.Int
        /// The number of tables currently loading for this task.
        var tablesLoading: Swift.Int
        /// The number of tables queued for this task.
        var tablesQueued: Swift.Int
...
extension DatabaseMigrationClientTypes {
    ...
    public struct ResourcePendingMaintenanceActions: Swift.Equatable {
        ...
        var pendingMaintenanceActionDetails: [DatabaseMigrationClientTypes.PendingMaintenanceAction]?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct S3Settings: Swift.Equatable {
        ...
        var cannedAclForObjects: DatabaseMigrationClientTypes.CannedAclForObjectsValue?
        ...
        var cdcInsertsAndUpdates: Swift.Bool?
        ...
        var cdcMaxBatchInterval: Swift.Int?
        ...
        var cdcPath: Swift.String?
        /// An optional parameter to use GZIP to compress the target files. Set to GZIP to compress the target files. Either set this parameter to NONE (the default) or don't use it to leave the files uncompressed. This parameter applies to both .csv and .parquet file formats.
        var compressionType: DatabaseMigrationClientTypes.CompressionTypeValue?
        /// The delimiter used to separate columns in the .csv file for both source and target. The default is a comma.
        var csvDelimiter: Swift.String?
        ...
        var csvNoSupValue: Swift.String?
        ...
        var csvNullValue: Swift.String?
        /// The delimiter used to separate rows in the .csv file for both source and target. The default is a carriage return (\n).
        var csvRowDelimiter: Swift.String?
        /// The format of the data that you want to use for output. You can choose one of the following:
        ///
        /// * csv : This is a row-based file format with comma-separated values (.csv).
        ///
        /// * parquet : Apache Parquet (.parquet) is a columnar storage file format that features efficient compression and provides faster query response.
        var dataFormat: DatabaseMigrationClientTypes.DataFormatValue?
        /// The size of one data page in bytes. This parameter defaults to 1024 * 1024 bytes (1 MiB). This number is used for .parquet file format only.
        var dataPageSize: Swift.Int?
        /// Specifies a date separating delimiter to use during folder partitioning. The default value is SLASH. Use this parameter when DatePartitionedEnabled is set to true.
        var datePartitionDelimiter: DatabaseMigrationClientTypes.DatePartitionDelimiterValue?
        ...
        var datePartitionEnabled: Swift.Bool?
        /// Identifies the sequence of the date format to use during folder partitioning. The default value is YYYYMMDD. Use this parameter when DatePartitionedEnabled is set to true.
        var datePartitionSequence: DatabaseMigrationClientTypes.DatePartitionSequenceValue?
        ...
        var encodingType: DatabaseMigrationClientTypes.EncodingTypeValue?
        ...
        var ignoreHeaderRows: Swift.Int?
        ...
        var includeOpForFullLoad: Swift.Bool?
        ...
        var parquetTimestampInMillisecond: Swift.Bool?
        /// The version of the Apache Parquet format that you want to use: parquet_1_0 (the default) or parquet_2_0.
        var parquetVersion: DatabaseMigrationClientTypes.ParquetVersionValue?
        ...
        var preserveTransactions: Swift.Bool?
        ...
        var timestampColumnName: Swift.String?
        ...
        var useCsvNoSupValue: Swift.Bool?
        ...
        var useTaskStartTimeForFullLoadTimestamp: Swift.Bool?
...
public struct StartReplicationTaskInput: Swift.Equatable {
    ...
    /// This member is required.
    var startReplicationTaskType: DatabaseMigrationClientTypes.StartReplicationTaskTypeValue?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct Subnet: Swift.Equatable {
        ...
        var subnetAvailabilityZone: DatabaseMigrationClientTypes.AvailabilityZone?
...
extension DatabaseMigrationClientTypes {
    ...
    public struct SupportedEndpointType: Swift.Equatable {
        ...
        var replicationInstanceEngineMinimumVersion: Swift.String?
        /// Indicates if change data capture (CDC) is supported.
        var supportsCDC: Swift.Bool
...
extension DatabaseMigrationClientTypes {
    ...
    public struct TableStatistics: Swift.Equatable {
        ...
        var deletes: Swift.Int
        /// The number of rows that failed conditional checks during the full load operation (valid only for migrations where DynamoDB is the target).
        var fullLoadCondtnlChkFailedRows: Swift.Int
        /// The time when the full load operation completed.
        var fullLoadEndTime: ClientRuntime.Date?
        /// The number of rows that failed to load during the full load operation (valid only for migrations where DynamoDB is the target).
        var fullLoadErrorRows: Swift.Int
        /// A value that indicates if the table was reloaded (true) or loaded as part of a new full load operation (false).
        var fullLoadReloaded: Swift.Bool?
        /// The number of rows added during the full load operation.
        var fullLoadRows: Swift.Int
        /// The time when the full load operation started.
        var fullLoadStartTime: ClientRuntime.Date?
        /// The number of insert actions performed on a table.
        var inserts: Swift.Int
        /// The last time a table was updated.
        var lastUpdateTime: ClientRuntime.Date?
        /// The schema name.
        ...
        var tableState: Swift.String?
        /// The number of update actions performed on a table.
        var updates: Swift.Int
        /// The number of records that failed validation.
        var validationFailedRecords: Swift.Int
        /// The number of records that have yet to be validated.
        var validationPendingRecords: Swift.Int
        ...
        var validationState: Swift.String?
        /// Additional details about the state of validation.
        var validationStateDetails: Swift.String?
        /// The number of records that couldn't be validated.
        var validationSuspendedRecords: Swift.Int
