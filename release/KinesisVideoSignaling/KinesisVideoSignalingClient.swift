...
public class KinesisVideoSignalingClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try KinesisVideoSignalingClientConfiguration(region: unwrappedRegion)
    ...
    public class KinesisVideoSignalingClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("KinesisVideoSignalingClient")
...
public struct KinesisVideoSignalingClientLogHandlerFactory: SDKLogHandlerFactory {
