...
extension KinesisVideoSignalingClient: KinesisVideoSignalingClientProtocol {
    ...
    ///             API.</p>
    public func getIceServerConfig(input: GetIceServerConfigInput, completion: @escaping (SdkResult<GetIceServerConfigOutput, GetIceServerConfigOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<GetIceServerConfigInput, GetIceServerConfigOutput, GetIceServerConfigOutputError>(id: "getIceServerConfig")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetIceServerConfigInput, GetIceServerConfigOutput, GetIceServerConfigOutputError>(contentType: "application/json"))
    ...
    ///             expires.</p>
    public func sendAlexaOfferToMaster(input: SendAlexaOfferToMasterInput, completion: @escaping (SdkResult<SendAlexaOfferToMasterOutput, SendAlexaOfferToMasterOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "kinesisvideo")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SendAlexaOfferToMasterInput, SendAlexaOfferToMasterOutput, SendAlexaOfferToMasterOutputError>(id: "sendAlexaOfferToMaster")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SendAlexaOfferToMasterInput, SendAlexaOfferToMasterOutput, SendAlexaOfferToMasterOutputError>(contentType: "application/json"))
