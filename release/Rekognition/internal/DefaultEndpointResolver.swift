...
private let servicePartitions = [
    AWSClientRuntime.Partition(
        ...
        endpoints: [
            ...
            "rekognition-fips.ca-central-1": ServiceEndpointMetadata(
                hostName: "rekognition-fips.ca-central-1.amazonaws.com",
                credentialScope: CredentialScope(region: "ca-central-1")
            ),
            "rekognition-fips.us-east-1": ServiceEndpointMetadata(
                hostName: "rekognition-fips.us-east-1.amazonaws.com",
                credentialScope: CredentialScope(region: "us-east-1")
            ),
            "rekognition-fips.us-east-2": ServiceEndpointMetadata(
                hostName: "rekognition-fips.us-east-2.amazonaws.com",
                credentialScope: CredentialScope(region: "us-east-2")
            ),
            "rekognition-fips.us-west-1": ServiceEndpointMetadata(
                hostName: "rekognition-fips.us-west-1.amazonaws.com",
                credentialScope: CredentialScope(region: "us-west-1")
            ),
            "rekognition-fips.us-west-2": ServiceEndpointMetadata(
    ...
    AWSClientRuntime.Partition(
        ...
        endpoints: [
            "rekognition-fips.us-gov-west-1": ServiceEndpointMetadata(
