...
public protocol RekognitionClientProtocol {
    ...
    ///       action.</p>
    func compareFaces(input: CompareFacesInput, completion: @escaping (SdkResult<CompareFacesOutputResponse, CompareFacesOutputError>) -> Void)
    ...
    func createCollection(input: CreateCollectionInput, completion: @escaping (SdkResult<CreateCollectionOutputResponse, CreateCollectionOutputError>) -> Void)
    ...
    func createProjectVersion(input: CreateProjectVersionInput, completion: @escaping (SdkResult<CreateProjectVersionOutputResponse, CreateProjectVersionOutputError>) -> Void)
    ...
    func createStreamProcessor(input: CreateStreamProcessorInput, completion: @escaping (SdkResult<CreateStreamProcessorOutputResponse, CreateStreamProcessorOutputError>) -> Void)
    ...
    func deleteCollection(input: DeleteCollectionInput, completion: @escaping (SdkResult<DeleteCollectionOutputResponse, DeleteCollectionOutputError>) -> Void)
    ...
    ///       action.</p>
    func deleteFaces(input: DeleteFacesInput, completion: @escaping (SdkResult<DeleteFacesOutputResponse, DeleteFacesOutputError>) -> Void)
    ...
    func deleteProjectVersion(input: DeleteProjectVersionInput, completion: @escaping (SdkResult<DeleteProjectVersionOutputResponse, DeleteProjectVersionOutputError>) -> Void)
    ...
    func deleteStreamProcessor(input: DeleteStreamProcessorInput, completion: @escaping (SdkResult<DeleteStreamProcessorOutputResponse, DeleteStreamProcessorOutputError>) -> Void)
    ...
    func describeCollection(input: DescribeCollectionInput, completion: @escaping (SdkResult<DescribeCollectionOutputResponse, DescribeCollectionOutputError>) -> Void)
    ...
    func describeProjects(input: DescribeProjectsInput, completion: @escaping (SdkResult<DescribeProjectsOutputResponse, DescribeProjectsOutputError>) -> Void)
    ...
    ///             action.</p>
    func describeProjectVersions(input: DescribeProjectVersionsInput, completion: @escaping (SdkResult<DescribeProjectVersionsOutputResponse, DescribeProjectVersionsOutputError>) -> Void)
    ...
    func describeStreamProcessor(input: DescribeStreamProcessorInput, completion: @escaping (SdkResult<DescribeStreamProcessorOutputResponse, DescribeStreamProcessorOutputError>) -> Void)
    ...
    func detectCustomLabels(input: DetectCustomLabelsInput, completion: @escaping (SdkResult<DetectCustomLabelsOutputResponse, DetectCustomLabelsOutputError>) -> Void)
    ...
    func detectFaces(input: DetectFacesInput, completion: @escaping (SdkResult<DetectFacesOutputResponse, DetectFacesOutputError>) -> Void)
    ...
    func detectLabels(input: DetectLabelsInput, completion: @escaping (SdkResult<DetectLabelsOutputResponse, DetectLabelsOutputError>) -> Void)
    ...
    ///       CLI to call Amazon Rekognition operations, passing image bytes is not
    ///       supported. The image must be either a PNG or JPEG formatted file. </p>
    func detectModerationLabels(input: DetectModerationLabelsInput, completion: @escaping (SdkResult<DetectModerationLabelsOutputResponse, DetectModerationLabelsOutputError>) -> Void)
    ...
    func detectProtectiveEquipment(input: DetectProtectiveEquipmentInput, completion: @escaping (SdkResult<DetectProtectiveEquipmentOutputResponse, DetectProtectiveEquipmentOutputError>) -> Void)
    ...
    func detectText(input: DetectTextInput, completion: @escaping (SdkResult<DetectTextOutputResponse, DetectTextOutputError>) -> Void)
    ...
    func getCelebrityInfo(input: GetCelebrityInfoInput, completion: @escaping (SdkResult<GetCelebrityInfoOutputResponse, GetCelebrityInfoOutputError>) -> Void)
    ...
    func getCelebrityRecognition(input: GetCelebrityRecognitionInput, completion: @escaping (SdkResult<GetCelebrityRecognitionOutputResponse, GetCelebrityRecognitionOutputError>) -> Void)
    ...
    func getContentModeration(input: GetContentModerationInput, completion: @escaping (SdkResult<GetContentModerationOutputResponse, GetContentModerationOutputError>) -> Void)
    ...
    func getFaceDetection(input: GetFaceDetectionInput, completion: @escaping (SdkResult<GetFaceDetectionOutputResponse, GetFaceDetectionOutputError>) -> Void)
    ...
    ///     parameter.</p>
    func getFaceSearch(input: GetFaceSearchInput, completion: @escaping (SdkResult<GetFaceSearchOutputResponse, GetFaceSearchOutputError>) -> Void)
    ...
    func getLabelDetection(input: GetLabelDetectionInput, completion: @escaping (SdkResult<GetLabelDetectionOutputResponse, GetLabelDetectionOutputError>) -> Void)
    ...
    func getPersonTracking(input: GetPersonTrackingInput, completion: @escaping (SdkResult<GetPersonTrackingOutputResponse, GetPersonTrackingOutputError>) -> Void)
    ...
    func getSegmentDetection(input: GetSegmentDetectionInput, completion: @escaping (SdkResult<GetSegmentDetectionOutputResponse, GetSegmentDetectionOutputError>) -> Void)
    ...
    func getTextDetection(input: GetTextDetectionInput, completion: @escaping (SdkResult<GetTextDetectionOutputResponse, GetTextDetectionOutputError>) -> Void)
    ...
    ///       action.</p>
    func indexFaces(input: IndexFacesInput, completion: @escaping (SdkResult<IndexFacesOutputResponse, IndexFacesOutputError>) -> Void)
    ...
    func listCollections(input: ListCollectionsInput, completion: @escaping (SdkResult<ListCollectionsOutputResponse, ListCollectionsOutputError>) -> Void)
    ...
    func listFaces(input: ListFacesInput, completion: @escaping (SdkResult<ListFacesOutputResponse, ListFacesOutputError>) -> Void)
    /// <p>Gets a list of stream processors that you have created with <a>CreateStreamProcessor</a>. </p>
    func listStreamProcessors(input: ListStreamProcessorsInput, completion: @escaping (SdkResult<ListStreamProcessorsOutputResponse, ListStreamProcessorsOutputError>) -> Void)
    /// <p>
    ...
    func recognizeCelebrities(input: RecognizeCelebritiesInput, completion: @escaping (SdkResult<RecognizeCelebritiesOutputResponse, RecognizeCelebritiesOutputError>) -> Void)
    ...
    ///       action.</p>
    func searchFaces(input: SearchFacesInput, completion: @escaping (SdkResult<SearchFacesOutputResponse, SearchFacesOutputError>) -> Void)
    ...
    ///       action.</p>
    func searchFacesByImage(input: SearchFacesByImageInput, completion: @escaping (SdkResult<SearchFacesByImageOutputResponse, SearchFacesByImageOutputError>) -> Void)
    ...
    func startCelebrityRecognition(input: StartCelebrityRecognitionInput, completion: @escaping (SdkResult<StartCelebrityRecognitionOutputResponse, StartCelebrityRecognitionOutputError>) -> Void)
    ...
    ///
    ///          <p>For more information, see Detecting Unsafe Content in the Amazon Rekognition Developer Guide.</p>
    func startContentModeration(input: StartContentModerationInput, completion: @escaping (SdkResult<StartContentModerationOutputResponse, StartContentModerationOutputError>) -> Void)
    ...
    ///      Amazon Rekognition Developer Guide.</p>
    func startFaceDetection(input: StartFaceDetectionInput, completion: @escaping (SdkResult<StartFaceDetectionOutputResponse, StartFaceDetectionOutputError>) -> Void)
    ...
    func startFaceSearch(input: StartFaceSearchInput, completion: @escaping (SdkResult<StartFaceSearchOutputResponse, StartFaceSearchOutputError>) -> Void)
    ...
    ///        (<code>JobId</code>) from the initial call to <code>StartLabelDetection</code>.</p>
    ///         <p></p>
    func startLabelDetection(input: StartLabelDetectionInput, completion: @escaping (SdkResult<StartLabelDetectionOutputResponse, StartLabelDetectionOutputError>) -> Void)
    ...
    ///       (<code>JobId</code>) from the initial call to <code>StartPersonTracking</code>.</p>
    func startPersonTracking(input: StartPersonTrackingInput, completion: @escaping (SdkResult<StartPersonTrackingOutputResponse, StartPersonTrackingOutputError>) -> Void)
    ...
    func startProjectVersion(input: StartProjectVersionInput, completion: @escaping (SdkResult<StartProjectVersionOutputResponse, StartProjectVersionOutputError>) -> Void)
    ...
    ///
    ///          <p>For more information, see Detecting Video Segments in Stored Video in the Amazon Rekognition Developer Guide.</p>
    func startSegmentDetection(input: StartSegmentDetectionInput, completion: @escaping (SdkResult<StartSegmentDetectionOutputResponse, StartSegmentDetectionOutputError>) -> Void)
    ...
    func startStreamProcessor(input: StartStreamProcessorInput, completion: @escaping (SdkResult<StartStreamProcessorOutputResponse, StartStreamProcessorOutputError>) -> Void)
    ...
    func startTextDetection(input: StartTextDetectionInput, completion: @escaping (SdkResult<StartTextDetectionOutputResponse, StartTextDetectionOutputError>) -> Void)
    ...
    func stopProjectVersion(input: StopProjectVersionInput, completion: @escaping (SdkResult<StopProjectVersionOutputResponse, StopProjectVersionOutputError>) -> Void)
    /// <p>Stops a running stream processor that was created by <a>CreateStreamProcessor</a>.</p>
    func stopStreamProcessor(input: StopStreamProcessorInput, completion: @escaping (SdkResult<StopStreamProcessorOutputResponse, StopStreamProcessorOutputError>) -> Void)
    /// <p>
