...
public protocol RekognitionClientProtocol {
    ...
    ///       action.</p>
    func compareFaces(input: CompareFacesInput, completion: @escaping (SdkResult<CompareFacesOutput, CompareFacesOutputError>) -> Void)
    ...
    func createCollection(input: CreateCollectionInput, completion: @escaping (SdkResult<CreateCollectionOutput, CreateCollectionOutputError>) -> Void)
    ...
    func createProjectVersion(input: CreateProjectVersionInput, completion: @escaping (SdkResult<CreateProjectVersionOutput, CreateProjectVersionOutputError>) -> Void)
    ...
    func createStreamProcessor(input: CreateStreamProcessorInput, completion: @escaping (SdkResult<CreateStreamProcessorOutput, CreateStreamProcessorOutputError>) -> Void)
    ...
    func deleteCollection(input: DeleteCollectionInput, completion: @escaping (SdkResult<DeleteCollectionOutput, DeleteCollectionOutputError>) -> Void)
    ...
    ///       action.</p>
    func deleteFaces(input: DeleteFacesInput, completion: @escaping (SdkResult<DeleteFacesOutput, DeleteFacesOutputError>) -> Void)
    ...
    func deleteProjectVersion(input: DeleteProjectVersionInput, completion: @escaping (SdkResult<DeleteProjectVersionOutput, DeleteProjectVersionOutputError>) -> Void)
    ...
    func deleteStreamProcessor(input: DeleteStreamProcessorInput, completion: @escaping (SdkResult<DeleteStreamProcessorOutput, DeleteStreamProcessorOutputError>) -> Void)
    ...
    func describeCollection(input: DescribeCollectionInput, completion: @escaping (SdkResult<DescribeCollectionOutput, DescribeCollectionOutputError>) -> Void)
    ...
    func describeProjects(input: DescribeProjectsInput, completion: @escaping (SdkResult<DescribeProjectsOutput, DescribeProjectsOutputError>) -> Void)
    ...
    ///             action.</p>
    func describeProjectVersions(input: DescribeProjectVersionsInput, completion: @escaping (SdkResult<DescribeProjectVersionsOutput, DescribeProjectVersionsOutputError>) -> Void)
    ...
    func describeStreamProcessor(input: DescribeStreamProcessorInput, completion: @escaping (SdkResult<DescribeStreamProcessorOutput, DescribeStreamProcessorOutputError>) -> Void)
    ...
    func detectCustomLabels(input: DetectCustomLabelsInput, completion: @escaping (SdkResult<DetectCustomLabelsOutput, DetectCustomLabelsOutputError>) -> Void)
    ...
    func detectFaces(input: DetectFacesInput, completion: @escaping (SdkResult<DetectFacesOutput, DetectFacesOutputError>) -> Void)
    ...
    func detectLabels(input: DetectLabelsInput, completion: @escaping (SdkResult<DetectLabelsOutput, DetectLabelsOutputError>) -> Void)
    ...
    ///       CLI to call Amazon Rekognition operations, passing image bytes is not
    ///       supported. The image must be either a PNG or JPEG formatted file. </p>
    func detectModerationLabels(input: DetectModerationLabelsInput, completion: @escaping (SdkResult<DetectModerationLabelsOutput, DetectModerationLabelsOutputError>) -> Void)
    ...
    func detectProtectiveEquipment(input: DetectProtectiveEquipmentInput, completion: @escaping (SdkResult<DetectProtectiveEquipmentOutput, DetectProtectiveEquipmentOutputError>) -> Void)
    ...
    func detectText(input: DetectTextInput, completion: @escaping (SdkResult<DetectTextOutput, DetectTextOutputError>) -> Void)
    ...
    func getCelebrityInfo(input: GetCelebrityInfoInput, completion: @escaping (SdkResult<GetCelebrityInfoOutput, GetCelebrityInfoOutputError>) -> Void)
    ...
    func getCelebrityRecognition(input: GetCelebrityRecognitionInput, completion: @escaping (SdkResult<GetCelebrityRecognitionOutput, GetCelebrityRecognitionOutputError>) -> Void)
    ...
    func getContentModeration(input: GetContentModerationInput, completion: @escaping (SdkResult<GetContentModerationOutput, GetContentModerationOutputError>) -> Void)
    ...
    func getFaceDetection(input: GetFaceDetectionInput, completion: @escaping (SdkResult<GetFaceDetectionOutput, GetFaceDetectionOutputError>) -> Void)
    ...
    ///     parameter.</p>
    func getFaceSearch(input: GetFaceSearchInput, completion: @escaping (SdkResult<GetFaceSearchOutput, GetFaceSearchOutputError>) -> Void)
    ...
    func getLabelDetection(input: GetLabelDetectionInput, completion: @escaping (SdkResult<GetLabelDetectionOutput, GetLabelDetectionOutputError>) -> Void)
    ...
    func getPersonTracking(input: GetPersonTrackingInput, completion: @escaping (SdkResult<GetPersonTrackingOutput, GetPersonTrackingOutputError>) -> Void)
    ...
    func getSegmentDetection(input: GetSegmentDetectionInput, completion: @escaping (SdkResult<GetSegmentDetectionOutput, GetSegmentDetectionOutputError>) -> Void)
    ...
    func getTextDetection(input: GetTextDetectionInput, completion: @escaping (SdkResult<GetTextDetectionOutput, GetTextDetectionOutputError>) -> Void)
    ...
    ///       action.</p>
    func indexFaces(input: IndexFacesInput, completion: @escaping (SdkResult<IndexFacesOutput, IndexFacesOutputError>) -> Void)
    ...
    func listCollections(input: ListCollectionsInput, completion: @escaping (SdkResult<ListCollectionsOutput, ListCollectionsOutputError>) -> Void)
    ...
    func listFaces(input: ListFacesInput, completion: @escaping (SdkResult<ListFacesOutput, ListFacesOutputError>) -> Void)
    /// <p>Gets a list of stream processors that you have created with <a>CreateStreamProcessor</a>. </p>
    func listStreamProcessors(input: ListStreamProcessorsInput, completion: @escaping (SdkResult<ListStreamProcessorsOutput, ListStreamProcessorsOutputError>) -> Void)
    /// <p>
    ...
    func recognizeCelebrities(input: RecognizeCelebritiesInput, completion: @escaping (SdkResult<RecognizeCelebritiesOutput, RecognizeCelebritiesOutputError>) -> Void)
    ...
    ///       action.</p>
    func searchFaces(input: SearchFacesInput, completion: @escaping (SdkResult<SearchFacesOutput, SearchFacesOutputError>) -> Void)
    ...
    ///       action.</p>
    func searchFacesByImage(input: SearchFacesByImageInput, completion: @escaping (SdkResult<SearchFacesByImageOutput, SearchFacesByImageOutputError>) -> Void)
    ...
    func startCelebrityRecognition(input: StartCelebrityRecognitionInput, completion: @escaping (SdkResult<StartCelebrityRecognitionOutput, StartCelebrityRecognitionOutputError>) -> Void)
    ...
    ///
    ///          <p>For more information, see Detecting Unsafe Content in the Amazon Rekognition Developer Guide.</p>
    func startContentModeration(input: StartContentModerationInput, completion: @escaping (SdkResult<StartContentModerationOutput, StartContentModerationOutputError>) -> Void)
    ...
    ///      Amazon Rekognition Developer Guide.</p>
    func startFaceDetection(input: StartFaceDetectionInput, completion: @escaping (SdkResult<StartFaceDetectionOutput, StartFaceDetectionOutputError>) -> Void)
    ...
    func startFaceSearch(input: StartFaceSearchInput, completion: @escaping (SdkResult<StartFaceSearchOutput, StartFaceSearchOutputError>) -> Void)
    ...
    ///        (<code>JobId</code>) from the initial call to <code>StartLabelDetection</code>.</p>
    ///         <p></p>
    func startLabelDetection(input: StartLabelDetectionInput, completion: @escaping (SdkResult<StartLabelDetectionOutput, StartLabelDetectionOutputError>) -> Void)
    ...
    ///       (<code>JobId</code>) from the initial call to <code>StartPersonTracking</code>.</p>
    func startPersonTracking(input: StartPersonTrackingInput, completion: @escaping (SdkResult<StartPersonTrackingOutput, StartPersonTrackingOutputError>) -> Void)
    ...
    func startProjectVersion(input: StartProjectVersionInput, completion: @escaping (SdkResult<StartProjectVersionOutput, StartProjectVersionOutputError>) -> Void)
    ...
    ///
    ///          <p>For more information, see Detecting Video Segments in Stored Video in the Amazon Rekognition Developer Guide.</p>
    func startSegmentDetection(input: StartSegmentDetectionInput, completion: @escaping (SdkResult<StartSegmentDetectionOutput, StartSegmentDetectionOutputError>) -> Void)
    ...
    func startStreamProcessor(input: StartStreamProcessorInput, completion: @escaping (SdkResult<StartStreamProcessorOutput, StartStreamProcessorOutputError>) -> Void)
    ...
    func startTextDetection(input: StartTextDetectionInput, completion: @escaping (SdkResult<StartTextDetectionOutput, StartTextDetectionOutputError>) -> Void)
    ...
    func stopProjectVersion(input: StopProjectVersionInput, completion: @escaping (SdkResult<StopProjectVersionOutput, StopProjectVersionOutputError>) -> Void)
    /// <p>Stops a running stream processor that was created by <a>CreateStreamProcessor</a>.</p>
    func stopStreamProcessor(input: StopStreamProcessorInput, completion: @escaping (SdkResult<StopStreamProcessorOutput, StopStreamProcessorOutputError>) -> Void)
    /// <p>
