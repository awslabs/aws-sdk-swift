...
public class RekognitionClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try RekognitionClientConfiguration(region: unwrappedRegion)
    ...
    public class RekognitionClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("RekognitionClient")
...
public struct RekognitionClientLogHandlerFactory: SDKLogHandlerFactory {
...
extension RekognitionClient: RekognitionClientProtocol {
    ...
    ///       action.</p>
    public func compareFaces(input: CompareFacesInput, completion: @escaping (SdkResult<CompareFacesOutputResponse, CompareFacesOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<CompareFacesInput, CompareFacesOutputResponse, CompareFacesOutputError>(id: "compareFaces")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CompareFacesInput, CompareFacesOutputResponse, CompareFacesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CompareFacesInput, CompareFacesOutputResponse, CompareFacesOutputError>(xAmzTarget: "RekognitionService.CompareFaces"))
    ...
    public func createCollection(input: CreateCollectionInput, completion: @escaping (SdkResult<CreateCollectionOutputResponse, CreateCollectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateCollectionInput, CreateCollectionOutputResponse, CreateCollectionOutputError>(id: "createCollection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateCollectionInput, CreateCollectionOutputResponse, CreateCollectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateCollectionInput, CreateCollectionOutputResponse, CreateCollectionOutputError>(xAmzTarget: "RekognitionService.CreateCollection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createProject(input: CreateProjectInput, completion: @escaping (SdkResult<CreateProjectOutputResponse, CreateProjectOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateProjectInput, CreateProjectOutputResponse, CreateProjectOutputError>(xAmzTarget: "RekognitionService.CreateProject"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createProjectVersion(input: CreateProjectVersionInput, completion: @escaping (SdkResult<CreateProjectVersionOutputResponse, CreateProjectVersionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateProjectVersionInput, CreateProjectVersionOutputResponse, CreateProjectVersionOutputError>(id: "createProjectVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateProjectVersionInput, CreateProjectVersionOutputResponse, CreateProjectVersionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateProjectVersionInput, CreateProjectVersionOutputResponse, CreateProjectVersionOutputError>(xAmzTarget: "RekognitionService.CreateProjectVersion"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createStreamProcessor(input: CreateStreamProcessorInput, completion: @escaping (SdkResult<CreateStreamProcessorOutputResponse, CreateStreamProcessorOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateStreamProcessorInput, CreateStreamProcessorOutputResponse, CreateStreamProcessorOutputError>(id: "createStreamProcessor")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateStreamProcessorInput, CreateStreamProcessorOutputResponse, CreateStreamProcessorOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateStreamProcessorInput, CreateStreamProcessorOutputResponse, CreateStreamProcessorOutputError>(xAmzTarget: "RekognitionService.CreateStreamProcessor"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteCollection(input: DeleteCollectionInput, completion: @escaping (SdkResult<DeleteCollectionOutputResponse, DeleteCollectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteCollectionInput, DeleteCollectionOutputResponse, DeleteCollectionOutputError>(id: "deleteCollection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteCollectionInput, DeleteCollectionOutputResponse, DeleteCollectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteCollectionInput, DeleteCollectionOutputResponse, DeleteCollectionOutputError>(xAmzTarget: "RekognitionService.DeleteCollection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///       action.</p>
    public func deleteFaces(input: DeleteFacesInput, completion: @escaping (SdkResult<DeleteFacesOutputResponse, DeleteFacesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteFacesInput, DeleteFacesOutputResponse, DeleteFacesOutputError>(id: "deleteFaces")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteFacesInput, DeleteFacesOutputResponse, DeleteFacesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteFacesInput, DeleteFacesOutputResponse, DeleteFacesOutputError>(xAmzTarget: "RekognitionService.DeleteFaces"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteProject(input: DeleteProjectInput, completion: @escaping (SdkResult<DeleteProjectOutputResponse, DeleteProjectOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteProjectInput, DeleteProjectOutputResponse, DeleteProjectOutputError>(xAmzTarget: "RekognitionService.DeleteProject"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteProjectVersion(input: DeleteProjectVersionInput, completion: @escaping (SdkResult<DeleteProjectVersionOutputResponse, DeleteProjectVersionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteProjectVersionInput, DeleteProjectVersionOutputResponse, DeleteProjectVersionOutputError>(id: "deleteProjectVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteProjectVersionInput, DeleteProjectVersionOutputResponse, DeleteProjectVersionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteProjectVersionInput, DeleteProjectVersionOutputResponse, DeleteProjectVersionOutputError>(xAmzTarget: "RekognitionService.DeleteProjectVersion"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteStreamProcessor(input: DeleteStreamProcessorInput, completion: @escaping (SdkResult<DeleteStreamProcessorOutputResponse, DeleteStreamProcessorOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteStreamProcessorInput, DeleteStreamProcessorOutputResponse, DeleteStreamProcessorOutputError>(id: "deleteStreamProcessor")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteStreamProcessorInput, DeleteStreamProcessorOutputResponse, DeleteStreamProcessorOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteStreamProcessorInput, DeleteStreamProcessorOutputResponse, DeleteStreamProcessorOutputError>(xAmzTarget: "RekognitionService.DeleteStreamProcessor"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeCollection(input: DescribeCollectionInput, completion: @escaping (SdkResult<DescribeCollectionOutputResponse, DescribeCollectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCollectionInput, DescribeCollectionOutputResponse, DescribeCollectionOutputError>(id: "describeCollection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCollectionInput, DescribeCollectionOutputResponse, DescribeCollectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeCollectionInput, DescribeCollectionOutputResponse, DescribeCollectionOutputError>(xAmzTarget: "RekognitionService.DescribeCollection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             action.</p>
    public func describeProjectVersions(input: DescribeProjectVersionsInput, completion: @escaping (SdkResult<DescribeProjectVersionsOutputResponse, DescribeProjectVersionsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeProjectVersionsInput, DescribeProjectVersionsOutputResponse, DescribeProjectVersionsOutputError>(id: "describeProjectVersions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeProjectVersionsInput, DescribeProjectVersionsOutputResponse, DescribeProjectVersionsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeProjectVersionsInput, DescribeProjectVersionsOutputResponse, DescribeProjectVersionsOutputError>(xAmzTarget: "RekognitionService.DescribeProjectVersions"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeProjects(input: DescribeProjectsInput, completion: @escaping (SdkResult<DescribeProjectsOutputResponse, DescribeProjectsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeProjectsInput, DescribeProjectsOutputResponse, DescribeProjectsOutputError>(id: "describeProjects")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeProjectsInput, DescribeProjectsOutputResponse, DescribeProjectsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeProjectsInput, DescribeProjectsOutputResponse, DescribeProjectsOutputError>(xAmzTarget: "RekognitionService.DescribeProjects"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeStreamProcessor(input: DescribeStreamProcessorInput, completion: @escaping (SdkResult<DescribeStreamProcessorOutputResponse, DescribeStreamProcessorOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeStreamProcessorInput, DescribeStreamProcessorOutputResponse, DescribeStreamProcessorOutputError>(id: "describeStreamProcessor")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStreamProcessorInput, DescribeStreamProcessorOutputResponse, DescribeStreamProcessorOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeStreamProcessorInput, DescribeStreamProcessorOutputResponse, DescribeStreamProcessorOutputError>(xAmzTarget: "RekognitionService.DescribeStreamProcessor"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func detectCustomLabels(input: DetectCustomLabelsInput, completion: @escaping (SdkResult<DetectCustomLabelsOutputResponse, DetectCustomLabelsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DetectCustomLabelsInput, DetectCustomLabelsOutputResponse, DetectCustomLabelsOutputError>(id: "detectCustomLabels")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetectCustomLabelsInput, DetectCustomLabelsOutputResponse, DetectCustomLabelsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DetectCustomLabelsInput, DetectCustomLabelsOutputResponse, DetectCustomLabelsOutputError>(xAmzTarget: "RekognitionService.DetectCustomLabels"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func detectFaces(input: DetectFacesInput, completion: @escaping (SdkResult<DetectFacesOutputResponse, DetectFacesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DetectFacesInput, DetectFacesOutputResponse, DetectFacesOutputError>(id: "detectFaces")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetectFacesInput, DetectFacesOutputResponse, DetectFacesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DetectFacesInput, DetectFacesOutputResponse, DetectFacesOutputError>(xAmzTarget: "RekognitionService.DetectFaces"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func detectLabels(input: DetectLabelsInput, completion: @escaping (SdkResult<DetectLabelsOutputResponse, DetectLabelsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DetectLabelsInput, DetectLabelsOutputResponse, DetectLabelsOutputError>(id: "detectLabels")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetectLabelsInput, DetectLabelsOutputResponse, DetectLabelsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DetectLabelsInput, DetectLabelsOutputResponse, DetectLabelsOutputError>(xAmzTarget: "RekognitionService.DetectLabels"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///       CLI to call Amazon Rekognition operations, passing image bytes is not
    ///       supported. The image must be either a PNG or JPEG formatted file. </p>
    public func detectModerationLabels(input: DetectModerationLabelsInput, completion: @escaping (SdkResult<DetectModerationLabelsOutputResponse, DetectModerationLabelsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DetectModerationLabelsInput, DetectModerationLabelsOutputResponse, DetectModerationLabelsOutputError>(id: "detectModerationLabels")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetectModerationLabelsInput, DetectModerationLabelsOutputResponse, DetectModerationLabelsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DetectModerationLabelsInput, DetectModerationLabelsOutputResponse, DetectModerationLabelsOutputError>(xAmzTarget: "RekognitionService.DetectModerationLabels"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func detectProtectiveEquipment(input: DetectProtectiveEquipmentInput, completion: @escaping (SdkResult<DetectProtectiveEquipmentOutputResponse, DetectProtectiveEquipmentOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DetectProtectiveEquipmentInput, DetectProtectiveEquipmentOutputResponse, DetectProtectiveEquipmentOutputError>(id: "detectProtectiveEquipment")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetectProtectiveEquipmentInput, DetectProtectiveEquipmentOutputResponse, DetectProtectiveEquipmentOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DetectProtectiveEquipmentInput, DetectProtectiveEquipmentOutputResponse, DetectProtectiveEquipmentOutputError>(xAmzTarget: "RekognitionService.DetectProtectiveEquipment"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func detectText(input: DetectTextInput, completion: @escaping (SdkResult<DetectTextOutputResponse, DetectTextOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DetectTextInput, DetectTextOutputResponse, DetectTextOutputError>(id: "detectText")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetectTextInput, DetectTextOutputResponse, DetectTextOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DetectTextInput, DetectTextOutputResponse, DetectTextOutputError>(xAmzTarget: "RekognitionService.DetectText"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getCelebrityInfo(input: GetCelebrityInfoInput, completion: @escaping (SdkResult<GetCelebrityInfoOutputResponse, GetCelebrityInfoOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCelebrityInfoInput, GetCelebrityInfoOutputResponse, GetCelebrityInfoOutputError>(id: "getCelebrityInfo")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCelebrityInfoInput, GetCelebrityInfoOutputResponse, GetCelebrityInfoOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetCelebrityInfoInput, GetCelebrityInfoOutputResponse, GetCelebrityInfoOutputError>(xAmzTarget: "RekognitionService.GetCelebrityInfo"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getCelebrityRecognition(input: GetCelebrityRecognitionInput, completion: @escaping (SdkResult<GetCelebrityRecognitionOutputResponse, GetCelebrityRecognitionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCelebrityRecognitionInput, GetCelebrityRecognitionOutputResponse, GetCelebrityRecognitionOutputError>(id: "getCelebrityRecognition")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCelebrityRecognitionInput, GetCelebrityRecognitionOutputResponse, GetCelebrityRecognitionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetCelebrityRecognitionInput, GetCelebrityRecognitionOutputResponse, GetCelebrityRecognitionOutputError>(xAmzTarget: "RekognitionService.GetCelebrityRecognition"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getContentModeration(input: GetContentModerationInput, completion: @escaping (SdkResult<GetContentModerationOutputResponse, GetContentModerationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetContentModerationInput, GetContentModerationOutputResponse, GetContentModerationOutputError>(id: "getContentModeration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetContentModerationInput, GetContentModerationOutputResponse, GetContentModerationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetContentModerationInput, GetContentModerationOutputResponse, GetContentModerationOutputError>(xAmzTarget: "RekognitionService.GetContentModeration"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getFaceDetection(input: GetFaceDetectionInput, completion: @escaping (SdkResult<GetFaceDetectionOutputResponse, GetFaceDetectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetFaceDetectionInput, GetFaceDetectionOutputResponse, GetFaceDetectionOutputError>(id: "getFaceDetection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetFaceDetectionInput, GetFaceDetectionOutputResponse, GetFaceDetectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetFaceDetectionInput, GetFaceDetectionOutputResponse, GetFaceDetectionOutputError>(xAmzTarget: "RekognitionService.GetFaceDetection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///     parameter.</p>
    public func getFaceSearch(input: GetFaceSearchInput, completion: @escaping (SdkResult<GetFaceSearchOutputResponse, GetFaceSearchOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetFaceSearchInput, GetFaceSearchOutputResponse, GetFaceSearchOutputError>(id: "getFaceSearch")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetFaceSearchInput, GetFaceSearchOutputResponse, GetFaceSearchOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetFaceSearchInput, GetFaceSearchOutputResponse, GetFaceSearchOutputError>(xAmzTarget: "RekognitionService.GetFaceSearch"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getLabelDetection(input: GetLabelDetectionInput, completion: @escaping (SdkResult<GetLabelDetectionOutputResponse, GetLabelDetectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetLabelDetectionInput, GetLabelDetectionOutputResponse, GetLabelDetectionOutputError>(id: "getLabelDetection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetLabelDetectionInput, GetLabelDetectionOutputResponse, GetLabelDetectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetLabelDetectionInput, GetLabelDetectionOutputResponse, GetLabelDetectionOutputError>(xAmzTarget: "RekognitionService.GetLabelDetection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getPersonTracking(input: GetPersonTrackingInput, completion: @escaping (SdkResult<GetPersonTrackingOutputResponse, GetPersonTrackingOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetPersonTrackingInput, GetPersonTrackingOutputResponse, GetPersonTrackingOutputError>(id: "getPersonTracking")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetPersonTrackingInput, GetPersonTrackingOutputResponse, GetPersonTrackingOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetPersonTrackingInput, GetPersonTrackingOutputResponse, GetPersonTrackingOutputError>(xAmzTarget: "RekognitionService.GetPersonTracking"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getSegmentDetection(input: GetSegmentDetectionInput, completion: @escaping (SdkResult<GetSegmentDetectionOutputResponse, GetSegmentDetectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSegmentDetectionInput, GetSegmentDetectionOutputResponse, GetSegmentDetectionOutputError>(id: "getSegmentDetection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSegmentDetectionInput, GetSegmentDetectionOutputResponse, GetSegmentDetectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetSegmentDetectionInput, GetSegmentDetectionOutputResponse, GetSegmentDetectionOutputError>(xAmzTarget: "RekognitionService.GetSegmentDetection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getTextDetection(input: GetTextDetectionInput, completion: @escaping (SdkResult<GetTextDetectionOutputResponse, GetTextDetectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetTextDetectionInput, GetTextDetectionOutputResponse, GetTextDetectionOutputError>(id: "getTextDetection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetTextDetectionInput, GetTextDetectionOutputResponse, GetTextDetectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetTextDetectionInput, GetTextDetectionOutputResponse, GetTextDetectionOutputError>(xAmzTarget: "RekognitionService.GetTextDetection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///       action.</p>
    public func indexFaces(input: IndexFacesInput, completion: @escaping (SdkResult<IndexFacesOutputResponse, IndexFacesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<IndexFacesInput, IndexFacesOutputResponse, IndexFacesOutputError>(id: "indexFaces")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<IndexFacesInput, IndexFacesOutputResponse, IndexFacesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<IndexFacesInput, IndexFacesOutputResponse, IndexFacesOutputError>(xAmzTarget: "RekognitionService.IndexFaces"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listCollections(input: ListCollectionsInput, completion: @escaping (SdkResult<ListCollectionsOutputResponse, ListCollectionsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListCollectionsInput, ListCollectionsOutputResponse, ListCollectionsOutputError>(id: "listCollections")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListCollectionsInput, ListCollectionsOutputResponse, ListCollectionsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListCollectionsInput, ListCollectionsOutputResponse, ListCollectionsOutputError>(xAmzTarget: "RekognitionService.ListCollections"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listFaces(input: ListFacesInput, completion: @escaping (SdkResult<ListFacesOutputResponse, ListFacesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListFacesInput, ListFacesOutputResponse, ListFacesOutputError>(id: "listFaces")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListFacesInput, ListFacesOutputResponse, ListFacesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListFacesInput, ListFacesOutputResponse, ListFacesOutputError>(xAmzTarget: "RekognitionService.ListFaces"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }

    /// <p>Gets a list of stream processors that you have created with <a>CreateStreamProcessor</a>. </p>
    public func listStreamProcessors(input: ListStreamProcessorsInput, completion: @escaping (SdkResult<ListStreamProcessorsOutputResponse, ListStreamProcessorsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListStreamProcessorsInput, ListStreamProcessorsOutputResponse, ListStreamProcessorsOutputError>(id: "listStreamProcessors")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListStreamProcessorsInput, ListStreamProcessorsOutputResponse, ListStreamProcessorsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListStreamProcessorsInput, ListStreamProcessorsOutputResponse, ListStreamProcessorsOutputError>(xAmzTarget: "RekognitionService.ListStreamProcessors"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTagsForResource(input: ListTagsForResourceInput, completion: @escaping (SdkResult<ListTagsForResourceOutputResponse, ListTagsForResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTagsForResourceInput, ListTagsForResourceOutputResponse, ListTagsForResourceOutputError>(xAmzTarget: "RekognitionService.ListTagsForResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func recognizeCelebrities(input: RecognizeCelebritiesInput, completion: @escaping (SdkResult<RecognizeCelebritiesOutputResponse, RecognizeCelebritiesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RecognizeCelebritiesInput, RecognizeCelebritiesOutputResponse, RecognizeCelebritiesOutputError>(id: "recognizeCelebrities")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RecognizeCelebritiesInput, RecognizeCelebritiesOutputResponse, RecognizeCelebritiesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RecognizeCelebritiesInput, RecognizeCelebritiesOutputResponse, RecognizeCelebritiesOutputError>(xAmzTarget: "RekognitionService.RecognizeCelebrities"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///       action.</p>
    public func searchFaces(input: SearchFacesInput, completion: @escaping (SdkResult<SearchFacesOutputResponse, SearchFacesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SearchFacesInput, SearchFacesOutputResponse, SearchFacesOutputError>(id: "searchFaces")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SearchFacesInput, SearchFacesOutputResponse, SearchFacesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<SearchFacesInput, SearchFacesOutputResponse, SearchFacesOutputError>(xAmzTarget: "RekognitionService.SearchFaces"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///       action.</p>
    public func searchFacesByImage(input: SearchFacesByImageInput, completion: @escaping (SdkResult<SearchFacesByImageOutputResponse, SearchFacesByImageOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SearchFacesByImageInput, SearchFacesByImageOutputResponse, SearchFacesByImageOutputError>(id: "searchFacesByImage")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SearchFacesByImageInput, SearchFacesByImageOutputResponse, SearchFacesByImageOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<SearchFacesByImageInput, SearchFacesByImageOutputResponse, SearchFacesByImageOutputError>(xAmzTarget: "RekognitionService.SearchFacesByImage"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func startCelebrityRecognition(input: StartCelebrityRecognitionInput, completion: @escaping (SdkResult<StartCelebrityRecognitionOutputResponse, StartCelebrityRecognitionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartCelebrityRecognitionInput, StartCelebrityRecognitionOutputResponse, StartCelebrityRecognitionOutputError>(id: "startCelebrityRecognition")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartCelebrityRecognitionInput, StartCelebrityRecognitionOutputResponse, StartCelebrityRecognitionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartCelebrityRecognitionInput, StartCelebrityRecognitionOutputResponse, StartCelebrityRecognitionOutputError>(xAmzTarget: "RekognitionService.StartCelebrityRecognition"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///
    ///          <p>For more information, see Detecting Unsafe Content in the Amazon Rekognition Developer Guide.</p>
    public func startContentModeration(input: StartContentModerationInput, completion: @escaping (SdkResult<StartContentModerationOutputResponse, StartContentModerationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartContentModerationInput, StartContentModerationOutputResponse, StartContentModerationOutputError>(id: "startContentModeration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartContentModerationInput, StartContentModerationOutputResponse, StartContentModerationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartContentModerationInput, StartContentModerationOutputResponse, StartContentModerationOutputError>(xAmzTarget: "RekognitionService.StartContentModeration"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///      Amazon Rekognition Developer Guide.</p>
    public func startFaceDetection(input: StartFaceDetectionInput, completion: @escaping (SdkResult<StartFaceDetectionOutputResponse, StartFaceDetectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartFaceDetectionInput, StartFaceDetectionOutputResponse, StartFaceDetectionOutputError>(id: "startFaceDetection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartFaceDetectionInput, StartFaceDetectionOutputResponse, StartFaceDetectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartFaceDetectionInput, StartFaceDetectionOutputResponse, StartFaceDetectionOutputError>(xAmzTarget: "RekognitionService.StartFaceDetection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func startFaceSearch(input: StartFaceSearchInput, completion: @escaping (SdkResult<StartFaceSearchOutputResponse, StartFaceSearchOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartFaceSearchInput, StartFaceSearchOutputResponse, StartFaceSearchOutputError>(id: "startFaceSearch")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartFaceSearchInput, StartFaceSearchOutputResponse, StartFaceSearchOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartFaceSearchInput, StartFaceSearchOutputResponse, StartFaceSearchOutputError>(xAmzTarget: "RekognitionService.StartFaceSearch"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///        (<code>JobId</code>) from the initial call to <code>StartLabelDetection</code>.</p>
    ///         <p></p>
    public func startLabelDetection(input: StartLabelDetectionInput, completion: @escaping (SdkResult<StartLabelDetectionOutputResponse, StartLabelDetectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartLabelDetectionInput, StartLabelDetectionOutputResponse, StartLabelDetectionOutputError>(id: "startLabelDetection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartLabelDetectionInput, StartLabelDetectionOutputResponse, StartLabelDetectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartLabelDetectionInput, StartLabelDetectionOutputResponse, StartLabelDetectionOutputError>(xAmzTarget: "RekognitionService.StartLabelDetection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///       (<code>JobId</code>) from the initial call to <code>StartPersonTracking</code>.</p>
    public func startPersonTracking(input: StartPersonTrackingInput, completion: @escaping (SdkResult<StartPersonTrackingOutputResponse, StartPersonTrackingOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartPersonTrackingInput, StartPersonTrackingOutputResponse, StartPersonTrackingOutputError>(id: "startPersonTracking")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartPersonTrackingInput, StartPersonTrackingOutputResponse, StartPersonTrackingOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartPersonTrackingInput, StartPersonTrackingOutputResponse, StartPersonTrackingOutputError>(xAmzTarget: "RekognitionService.StartPersonTracking"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func startProjectVersion(input: StartProjectVersionInput, completion: @escaping (SdkResult<StartProjectVersionOutputResponse, StartProjectVersionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartProjectVersionInput, StartProjectVersionOutputResponse, StartProjectVersionOutputError>(id: "startProjectVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartProjectVersionInput, StartProjectVersionOutputResponse, StartProjectVersionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartProjectVersionInput, StartProjectVersionOutputResponse, StartProjectVersionOutputError>(xAmzTarget: "RekognitionService.StartProjectVersion"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///
    ///          <p>For more information, see Detecting Video Segments in Stored Video in the Amazon Rekognition Developer Guide.</p>
    public func startSegmentDetection(input: StartSegmentDetectionInput, completion: @escaping (SdkResult<StartSegmentDetectionOutputResponse, StartSegmentDetectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartSegmentDetectionInput, StartSegmentDetectionOutputResponse, StartSegmentDetectionOutputError>(id: "startSegmentDetection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartSegmentDetectionInput, StartSegmentDetectionOutputResponse, StartSegmentDetectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartSegmentDetectionInput, StartSegmentDetectionOutputResponse, StartSegmentDetectionOutputError>(xAmzTarget: "RekognitionService.StartSegmentDetection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func startStreamProcessor(input: StartStreamProcessorInput, completion: @escaping (SdkResult<StartStreamProcessorOutputResponse, StartStreamProcessorOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartStreamProcessorInput, StartStreamProcessorOutputResponse, StartStreamProcessorOutputError>(id: "startStreamProcessor")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartStreamProcessorInput, StartStreamProcessorOutputResponse, StartStreamProcessorOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartStreamProcessorInput, StartStreamProcessorOutputResponse, StartStreamProcessorOutputError>(xAmzTarget: "RekognitionService.StartStreamProcessor"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func startTextDetection(input: StartTextDetectionInput, completion: @escaping (SdkResult<StartTextDetectionOutputResponse, StartTextDetectionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartTextDetectionInput, StartTextDetectionOutputResponse, StartTextDetectionOutputError>(id: "startTextDetection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartTextDetectionInput, StartTextDetectionOutputResponse, StartTextDetectionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartTextDetectionInput, StartTextDetectionOutputResponse, StartTextDetectionOutputError>(xAmzTarget: "RekognitionService.StartTextDetection"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func stopProjectVersion(input: StopProjectVersionInput, completion: @escaping (SdkResult<StopProjectVersionOutputResponse, StopProjectVersionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StopProjectVersionInput, StopProjectVersionOutputResponse, StopProjectVersionOutputError>(id: "stopProjectVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StopProjectVersionInput, StopProjectVersionOutputResponse, StopProjectVersionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StopProjectVersionInput, StopProjectVersionOutputResponse, StopProjectVersionOutputError>(xAmzTarget: "RekognitionService.StopProjectVersion"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }

    /// <p>Stops a running stream processor that was created by <a>CreateStreamProcessor</a>.</p>
    public func stopStreamProcessor(input: StopStreamProcessorInput, completion: @escaping (SdkResult<StopStreamProcessorOutputResponse, StopStreamProcessorOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "rekognition")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StopStreamProcessorInput, StopStreamProcessorOutputResponse, StopStreamProcessorOutputError>(id: "stopStreamProcessor")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StopStreamProcessorInput, StopStreamProcessorOutputResponse, StopStreamProcessorOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StopStreamProcessorInput, StopStreamProcessorOutputResponse, StopStreamProcessorOutputError>(xAmzTarget: "RekognitionService.StopStreamProcessor"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func tagResource(input: TagResourceInput, completion: @escaping (SdkResult<TagResourceOutputResponse, TagResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<TagResourceInput, TagResourceOutputResponse, TagResourceOutputError>(xAmzTarget: "RekognitionService.TagResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func untagResource(input: UntagResourceInput, completion: @escaping (SdkResult<UntagResourceOutputResponse, UntagResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UntagResourceInput, UntagResourceOutputResponse, UntagResourceOutputError>(xAmzTarget: "RekognitionService.UntagResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
