...
public extension RekognitionClient {
    ...
    ///       action.</p>
    func compareFaces(input: CompareFacesInput) async throws -> CompareFacesOutputResponse
    {
        typealias compareFacesContinuation = CheckedContinuation<CompareFacesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: compareFacesContinuation) in
            compareFaces(input: input) { result in
                switch result {
    ...
    {
        typealias createCollectionContinuation = CheckedContinuation<CreateCollectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createCollectionContinuation) in
            createCollection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func createProjectVersion(input: CreateProjectVersionInput) async throws -> CreateProjectVersionOutputResponse
    {
        typealias createProjectVersionContinuation = CheckedContinuation<CreateProjectVersionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createProjectVersionContinuation) in
            createProjectVersion(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func createStreamProcessor(input: CreateStreamProcessorInput) async throws -> CreateStreamProcessorOutputResponse
    {
        typealias createStreamProcessorContinuation = CheckedContinuation<CreateStreamProcessorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createStreamProcessorContinuation) in
            createStreamProcessor(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteCollectionContinuation = CheckedContinuation<DeleteCollectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteCollectionContinuation) in
            deleteCollection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///       action.</p>
    func deleteFaces(input: DeleteFacesInput) async throws -> DeleteFacesOutputResponse
    {
        typealias deleteFacesContinuation = CheckedContinuation<DeleteFacesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteFacesContinuation) in
            deleteFaces(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func deleteProjectVersion(input: DeleteProjectVersionInput) async throws -> DeleteProjectVersionOutputResponse
    {
        typealias deleteProjectVersionContinuation = CheckedContinuation<DeleteProjectVersionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteProjectVersionContinuation) in
            deleteProjectVersion(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func deleteStreamProcessor(input: DeleteStreamProcessorInput) async throws -> DeleteStreamProcessorOutputResponse
    {
        typealias deleteStreamProcessorContinuation = CheckedContinuation<DeleteStreamProcessorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteStreamProcessorContinuation) in
            deleteStreamProcessor(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeCollection(input: DescribeCollectionInput) async throws -> DescribeCollectionOutputResponse
    {
        typealias describeCollectionContinuation = CheckedContinuation<DescribeCollectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeCollectionContinuation) in
            describeCollection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             action.</p>
    func describeProjectVersions(input: DescribeProjectVersionsInput) async throws -> DescribeProjectVersionsOutputResponse
    {
        typealias describeProjectVersionsContinuation = CheckedContinuation<DescribeProjectVersionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeProjectVersionsContinuation) in
            describeProjectVersions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeProjects(input: DescribeProjectsInput) async throws -> DescribeProjectsOutputResponse
    {
        typealias describeProjectsContinuation = CheckedContinuation<DescribeProjectsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeProjectsContinuation) in
            describeProjects(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeStreamProcessor(input: DescribeStreamProcessorInput) async throws -> DescribeStreamProcessorOutputResponse
    {
        typealias describeStreamProcessorContinuation = CheckedContinuation<DescribeStreamProcessorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeStreamProcessorContinuation) in
            describeStreamProcessor(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func detectCustomLabels(input: DetectCustomLabelsInput) async throws -> DetectCustomLabelsOutputResponse
    {
        typealias detectCustomLabelsContinuation = CheckedContinuation<DetectCustomLabelsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: detectCustomLabelsContinuation) in
            detectCustomLabels(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias detectFacesContinuation = CheckedContinuation<DetectFacesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: detectFacesContinuation) in
            detectFaces(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias detectLabelsContinuation = CheckedContinuation<DetectLabelsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: detectLabelsContinuation) in
            detectLabels(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias detectModerationLabelsContinuation = CheckedContinuation<DetectModerationLabelsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: detectModerationLabelsContinuation) in
            detectModerationLabels(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func detectProtectiveEquipment(input: DetectProtectiveEquipmentInput) async throws -> DetectProtectiveEquipmentOutputResponse
    {
        typealias detectProtectiveEquipmentContinuation = CheckedContinuation<DetectProtectiveEquipmentOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: detectProtectiveEquipmentContinuation) in
            detectProtectiveEquipment(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias detectTextContinuation = CheckedContinuation<DetectTextOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: detectTextContinuation) in
            detectText(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getCelebrityInfo(input: GetCelebrityInfoInput) async throws -> GetCelebrityInfoOutputResponse
    {
        typealias getCelebrityInfoContinuation = CheckedContinuation<GetCelebrityInfoOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getCelebrityInfoContinuation) in
            getCelebrityInfo(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getCelebrityRecognition(input: GetCelebrityRecognitionInput) async throws -> GetCelebrityRecognitionOutputResponse
    {
        typealias getCelebrityRecognitionContinuation = CheckedContinuation<GetCelebrityRecognitionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getCelebrityRecognitionContinuation) in
            getCelebrityRecognition(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getContentModeration(input: GetContentModerationInput) async throws -> GetContentModerationOutputResponse
    {
        typealias getContentModerationContinuation = CheckedContinuation<GetContentModerationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getContentModerationContinuation) in
            getContentModeration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getFaceDetection(input: GetFaceDetectionInput) async throws -> GetFaceDetectionOutputResponse
    {
        typealias getFaceDetectionContinuation = CheckedContinuation<GetFaceDetectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getFaceDetectionContinuation) in
            getFaceDetection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///     parameter.</p>
    func getFaceSearch(input: GetFaceSearchInput) async throws -> GetFaceSearchOutputResponse
    {
        typealias getFaceSearchContinuation = CheckedContinuation<GetFaceSearchOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getFaceSearchContinuation) in
            getFaceSearch(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getLabelDetection(input: GetLabelDetectionInput) async throws -> GetLabelDetectionOutputResponse
    {
        typealias getLabelDetectionContinuation = CheckedContinuation<GetLabelDetectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getLabelDetectionContinuation) in
            getLabelDetection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getPersonTracking(input: GetPersonTrackingInput) async throws -> GetPersonTrackingOutputResponse
    {
        typealias getPersonTrackingContinuation = CheckedContinuation<GetPersonTrackingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getPersonTrackingContinuation) in
            getPersonTracking(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getSegmentDetection(input: GetSegmentDetectionInput) async throws -> GetSegmentDetectionOutputResponse
    {
        typealias getSegmentDetectionContinuation = CheckedContinuation<GetSegmentDetectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getSegmentDetectionContinuation) in
            getSegmentDetection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getTextDetection(input: GetTextDetectionInput) async throws -> GetTextDetectionOutputResponse
    {
        typealias getTextDetectionContinuation = CheckedContinuation<GetTextDetectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getTextDetectionContinuation) in
            getTextDetection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///       action.</p>
    func indexFaces(input: IndexFacesInput) async throws -> IndexFacesOutputResponse
    {
        typealias indexFacesContinuation = CheckedContinuation<IndexFacesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: indexFacesContinuation) in
            indexFaces(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listCollectionsContinuation = CheckedContinuation<ListCollectionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listCollectionsContinuation) in
            listCollections(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listFaces(input: ListFacesInput) async throws -> ListFacesOutputResponse
    {
        typealias listFacesContinuation = CheckedContinuation<ListFacesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listFacesContinuation) in
            listFaces(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listStreamProcessors(input: ListStreamProcessorsInput) async throws -> ListStreamProcessorsOutputResponse
    {
        typealias listStreamProcessorsContinuation = CheckedContinuation<ListStreamProcessorsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listStreamProcessorsContinuation) in
            listStreamProcessors(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias recognizeCelebritiesContinuation = CheckedContinuation<RecognizeCelebritiesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: recognizeCelebritiesContinuation) in
            recognizeCelebrities(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///       action.</p>
    func searchFaces(input: SearchFacesInput) async throws -> SearchFacesOutputResponse
    {
        typealias searchFacesContinuation = CheckedContinuation<SearchFacesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: searchFacesContinuation) in
            searchFaces(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias searchFacesByImageContinuation = CheckedContinuation<SearchFacesByImageOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: searchFacesByImageContinuation) in
            searchFacesByImage(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func startCelebrityRecognition(input: StartCelebrityRecognitionInput) async throws -> StartCelebrityRecognitionOutputResponse
    {
        typealias startCelebrityRecognitionContinuation = CheckedContinuation<StartCelebrityRecognitionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startCelebrityRecognitionContinuation) in
            startCelebrityRecognition(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///
    ///          <p>For more information, see Detecting Unsafe Content in the Amazon Rekognition Developer Guide.</p>
    func startContentModeration(input: StartContentModerationInput) async throws -> StartContentModerationOutputResponse
    {
        typealias startContentModerationContinuation = CheckedContinuation<StartContentModerationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startContentModerationContinuation) in
            startContentModeration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///      Amazon Rekognition Developer Guide.</p>
    func startFaceDetection(input: StartFaceDetectionInput) async throws -> StartFaceDetectionOutputResponse
    {
        typealias startFaceDetectionContinuation = CheckedContinuation<StartFaceDetectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startFaceDetectionContinuation) in
            startFaceDetection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func startFaceSearch(input: StartFaceSearchInput) async throws -> StartFaceSearchOutputResponse
    {
        typealias startFaceSearchContinuation = CheckedContinuation<StartFaceSearchOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startFaceSearchContinuation) in
            startFaceSearch(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///        (<code>JobId</code>) from the initial call to <code>StartLabelDetection</code>.</p>
    ///         <p></p>
    func startLabelDetection(input: StartLabelDetectionInput) async throws -> StartLabelDetectionOutputResponse
    {
        typealias startLabelDetectionContinuation = CheckedContinuation<StartLabelDetectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startLabelDetectionContinuation) in
            startLabelDetection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///       (<code>JobId</code>) from the initial call to <code>StartPersonTracking</code>.</p>
    func startPersonTracking(input: StartPersonTrackingInput) async throws -> StartPersonTrackingOutputResponse
    {
        typealias startPersonTrackingContinuation = CheckedContinuation<StartPersonTrackingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startPersonTrackingContinuation) in
            startPersonTracking(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func startProjectVersion(input: StartProjectVersionInput) async throws -> StartProjectVersionOutputResponse
    {
        typealias startProjectVersionContinuation = CheckedContinuation<StartProjectVersionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startProjectVersionContinuation) in
            startProjectVersion(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///
    ///          <p>For more information, see Detecting Video Segments in Stored Video in the Amazon Rekognition Developer Guide.</p>
    func startSegmentDetection(input: StartSegmentDetectionInput) async throws -> StartSegmentDetectionOutputResponse
    {
        typealias startSegmentDetectionContinuation = CheckedContinuation<StartSegmentDetectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startSegmentDetectionContinuation) in
            startSegmentDetection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func startStreamProcessor(input: StartStreamProcessorInput) async throws -> StartStreamProcessorOutputResponse
    {
        typealias startStreamProcessorContinuation = CheckedContinuation<StartStreamProcessorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startStreamProcessorContinuation) in
            startStreamProcessor(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func startTextDetection(input: StartTextDetectionInput) async throws -> StartTextDetectionOutputResponse
    {
        typealias startTextDetectionContinuation = CheckedContinuation<StartTextDetectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startTextDetectionContinuation) in
            startTextDetection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func stopProjectVersion(input: StopProjectVersionInput) async throws -> StopProjectVersionOutputResponse
    {
        typealias stopProjectVersionContinuation = CheckedContinuation<StopProjectVersionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopProjectVersionContinuation) in
            stopProjectVersion(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func stopStreamProcessor(input: StopStreamProcessorInput) async throws -> StopStreamProcessorOutputResponse
    {
        typealias stopStreamProcessorContinuation = CheckedContinuation<StopStreamProcessorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopStreamProcessorContinuation) in
            stopStreamProcessor(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
