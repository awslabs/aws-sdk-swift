...
public protocol MTurkClientProtocol {
    ...
    ///         </p>
    func acceptQualificationRequest(input: AcceptQualificationRequestInput, completion: @escaping (SdkResult<AcceptQualificationRequestOutput, AcceptQualificationRequestOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func approveAssignment(input: ApproveAssignmentInput, completion: @escaping (SdkResult<ApproveAssignmentOutput, ApproveAssignmentOutputError>) -> Void)
    /// <p>
    ...
    ///             </p>
    ///         </note>
    func associateQualificationWithWorker(input: AssociateQualificationWithWorkerInput, completion: @escaping (SdkResult<AssociateQualificationWithWorkerOutput, AssociateQualificationWithWorkerOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///             </ul>
    ///         </note>
    func createAdditionalAssignmentsForHIT(input: CreateAdditionalAssignmentsForHITInput, completion: @escaping (SdkResult<CreateAdditionalAssignmentsForHITOutput, CreateAdditionalAssignmentsForHITOutputError>) -> Void)
    ...
    ///         </note>
    func createHIT(input: CreateHITInput, completion: @escaping (SdkResult<CreateHITOutput, CreateHITOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func createHITType(input: CreateHITTypeInput, completion: @escaping (SdkResult<CreateHITTypeOutput, CreateHITTypeOutputError>) -> Void)
    /// <p>
    ...
    ///             </p>
    ///         </note>
    func createHITWithHITType(input: CreateHITWithHITTypeInput, completion: @escaping (SdkResult<CreateHITWithHITTypeOutput, CreateHITWithHITTypeOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///             data structure.
    ///         </p>
    func createQualificationType(input: CreateQualificationTypeInput, completion: @escaping (SdkResult<CreateQualificationTypeOutput, CreateQualificationTypeOutputError>) -> Void)
    ...
    func createWorkerBlock(input: CreateWorkerBlockInput, completion: @escaping (SdkResult<CreateWorkerBlockOutput, CreateWorkerBlockOutputError>) -> Void)
    /// <p>
    ...
    ///             </ul>
    ///         </note>
    func deleteHIT(input: DeleteHITInput, completion: @escaping (SdkResult<DeleteHITOutput, DeleteHITOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///         </note>
    func deleteQualificationType(input: DeleteQualificationTypeInput, completion: @escaping (SdkResult<DeleteQualificationTypeOutput, DeleteQualificationTypeOutputError>) -> Void)
    ...
    func deleteWorkerBlock(input: DeleteWorkerBlockInput, completion: @escaping (SdkResult<DeleteWorkerBlockOutput, DeleteWorkerBlockOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func disassociateQualificationFromWorker(input: DisassociateQualificationFromWorkerInput, completion: @escaping (SdkResult<DisassociateQualificationFromWorkerOutput, DisassociateQualificationFromWorkerOutputError>) -> Void)
    ...
    func getAccountBalance(input: GetAccountBalanceInput, completion: @escaping (SdkResult<GetAccountBalanceOutput, GetAccountBalanceOutputError>) -> Void)
    /// <p>
    ///             The <code>GetAssignment</code> operation retrieves the details of the specified Assignment.
    ///         </p>
    func getAssignment(input: GetAssignmentInput, completion: @escaping (SdkResult<GetAssignmentOutput, GetAssignmentOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///
    ///         </p>
    func getFileUploadURL(input: GetFileUploadURLInput, completion: @escaping (SdkResult<GetFileUploadURLOutput, GetFileUploadURLOutputError>) -> Void)
    /// <p>
    ///             The <code>GetHIT</code> operation retrieves the details of the specified HIT.
    ///         </p>
    func getHIT(input: GetHITInput, completion: @escaping (SdkResult<GetHITOutput, GetHITOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    func getQualificationScore(input: GetQualificationScoreInput, completion: @escaping (SdkResult<GetQualificationScoreOutput, GetQualificationScoreOutputError>) -> Void)
    /// <p>
    ///             The <code>GetQualificationType</code>operation retrieves information about a Qualification type using its ID.
    ///         </p>
    func getQualificationType(input: GetQualificationTypeInput, completion: @escaping (SdkResult<GetQualificationTypeOutput, GetQualificationTypeOutputError>) -> Void)
    /// <p>
    ///             The
    ///             <code>ListAssignmentsForHIT</code>
    ...
    ///         </p>
    func listAssignmentsForHIT(input: ListAssignmentsForHITInput, completion: @escaping (SdkResult<ListAssignmentsForHITOutput, ListAssignmentsForHITOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///         </p>
    func listBonusPayments(input: ListBonusPaymentsInput, completion: @escaping (SdkResult<ListBonusPaymentsOutput, ListBonusPaymentsOutputError>) -> Void)
    /// <p>
    ///             The
    ///             <code>ListHITs</code>
    ...
    ///         </p>
    func listHITs(input: ListHITsInput, completion: @escaping (SdkResult<ListHITsOutput, ListHITsOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func listHITsForQualificationType(input: ListHITsForQualificationTypeInput, completion: @escaping (SdkResult<ListHITsForQualificationTypeOutput, ListHITsForQualificationTypeOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///         </p>
    func listQualificationRequests(input: ListQualificationRequestsInput, completion: @escaping (SdkResult<ListQualificationRequestsOutput, ListQualificationRequestsOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///         </p>
    func listQualificationTypes(input: ListQualificationTypesInput, completion: @escaping (SdkResult<ListQualificationTypesOutput, ListQualificationTypesOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func listReviewableHITs(input: ListReviewableHITsInput, completion: @escaping (SdkResult<ListReviewableHITsOutput, ListReviewableHITsOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func listReviewPolicyResultsForHIT(input: ListReviewPolicyResultsForHITInput, completion: @escaping (SdkResult<ListReviewPolicyResultsForHITOutput, ListReviewPolicyResultsForHITOutputError>) -> Void)
    /// <p>The <code>ListWorkersBlocks</code> operation retrieves a list of Workers who are blocked from working on your HITs.</p>
    func listWorkerBlocks(input: ListWorkerBlocksInput, completion: @escaping (SdkResult<ListWorkerBlocksOutput, ListWorkerBlocksOutputError>) -> Void)
    /// <p>
    ///             The <code>ListWorkersWithQualificationType</code> operation returns all of the Workers
    ///             that have been associated with a given Qualification type.
    ///         </p>
    func listWorkersWithQualificationType(input: ListWorkersWithQualificationTypeInput, completion: @escaping (SdkResult<ListWorkersWithQualificationTypeOutput, ListWorkersWithQualificationTypeOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///             Worker.
    ///         </p>
    func notifyWorkers(input: NotifyWorkersInput, completion: @escaping (SdkResult<NotifyWorkersOutput, NotifyWorkersOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func rejectAssignment(input: RejectAssignmentInput, completion: @escaping (SdkResult<RejectAssignmentOutput, RejectAssignmentOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    func rejectQualificationRequest(input: RejectQualificationRequestInput, completion: @escaping (SdkResult<RejectQualificationRequestOutput, RejectQualificationRequestOutputError>) -> Void)
    /// <p>
    ///             The
    ///             <code>SendBonus</code>
    ...
    ///             and the fees.
    ///         </p>
    func sendBonus(input: SendBonusInput, completion: @escaping (SdkResult<SendBonusOutput, SendBonusOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func sendTestEventNotification(input: SendTestEventNotificationInput, completion: @escaping (SdkResult<SendTestEventNotificationOutput, SendTestEventNotificationOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func updateExpirationForHIT(input: UpdateExpirationForHITInput, completion: @escaping (SdkResult<UpdateExpirationForHITOutput, UpdateExpirationForHITOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func updateHITReviewStatus(input: UpdateHITReviewStatusInput, completion: @escaping (SdkResult<UpdateHITReviewStatusOutput, UpdateHITReviewStatusOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///         </p>
    func updateHITTypeOfHIT(input: UpdateHITTypeOfHITInput, completion: @escaping (SdkResult<UpdateHITTypeOfHITOutput, UpdateHITTypeOfHITOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func updateNotificationSettings(input: UpdateNotificationSettingsInput, completion: @escaping (SdkResult<UpdateNotificationSettingsOutput, UpdateNotificationSettingsOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    func updateQualificationType(input: UpdateQualificationTypeInput, completion: @escaping (SdkResult<UpdateQualificationTypeOutput, UpdateQualificationTypeOutputError>) -> Void)
}
