...
public protocol MTurkClientProtocol {
    ...
    ///         </p>
    func acceptQualificationRequest(input: AcceptQualificationRequestInput, completion: @escaping (SdkResult<AcceptQualificationRequestOutputResponse, AcceptQualificationRequestOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func approveAssignment(input: ApproveAssignmentInput, completion: @escaping (SdkResult<ApproveAssignmentOutputResponse, ApproveAssignmentOutputError>) -> Void)
    /// <p>
    ...
    ///             </p>
    ///         </note>
    func associateQualificationWithWorker(input: AssociateQualificationWithWorkerInput, completion: @escaping (SdkResult<AssociateQualificationWithWorkerOutputResponse, AssociateQualificationWithWorkerOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///             </ul>
    ///         </note>
    func createAdditionalAssignmentsForHIT(input: CreateAdditionalAssignmentsForHITInput, completion: @escaping (SdkResult<CreateAdditionalAssignmentsForHITOutputResponse, CreateAdditionalAssignmentsForHITOutputError>) -> Void)
    ...
    ///         </note>
    func createHIT(input: CreateHITInput, completion: @escaping (SdkResult<CreateHITOutputResponse, CreateHITOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func createHITType(input: CreateHITTypeInput, completion: @escaping (SdkResult<CreateHITTypeOutputResponse, CreateHITTypeOutputError>) -> Void)
    /// <p>
    ...
    ///             </p>
    ///         </note>
    func createHITWithHITType(input: CreateHITWithHITTypeInput, completion: @escaping (SdkResult<CreateHITWithHITTypeOutputResponse, CreateHITWithHITTypeOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///             data structure.
    ///         </p>
    func createQualificationType(input: CreateQualificationTypeInput, completion: @escaping (SdkResult<CreateQualificationTypeOutputResponse, CreateQualificationTypeOutputError>) -> Void)
    ...
    func createWorkerBlock(input: CreateWorkerBlockInput, completion: @escaping (SdkResult<CreateWorkerBlockOutputResponse, CreateWorkerBlockOutputError>) -> Void)
    /// <p>
    ...
    ///             </ul>
    ///         </note>
    func deleteHIT(input: DeleteHITInput, completion: @escaping (SdkResult<DeleteHITOutputResponse, DeleteHITOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///         </note>
    func deleteQualificationType(input: DeleteQualificationTypeInput, completion: @escaping (SdkResult<DeleteQualificationTypeOutputResponse, DeleteQualificationTypeOutputError>) -> Void)
    ...
    func deleteWorkerBlock(input: DeleteWorkerBlockInput, completion: @escaping (SdkResult<DeleteWorkerBlockOutputResponse, DeleteWorkerBlockOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func disassociateQualificationFromWorker(input: DisassociateQualificationFromWorkerInput, completion: @escaping (SdkResult<DisassociateQualificationFromWorkerOutputResponse, DisassociateQualificationFromWorkerOutputError>) -> Void)
    ...
    func getAccountBalance(input: GetAccountBalanceInput, completion: @escaping (SdkResult<GetAccountBalanceOutputResponse, GetAccountBalanceOutputError>) -> Void)
    /// <p>
    ///             The <code>GetAssignment</code> operation retrieves the details of the specified Assignment.
    ///         </p>
    func getAssignment(input: GetAssignmentInput, completion: @escaping (SdkResult<GetAssignmentOutputResponse, GetAssignmentOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///
    ///         </p>
    func getFileUploadURL(input: GetFileUploadURLInput, completion: @escaping (SdkResult<GetFileUploadURLOutputResponse, GetFileUploadURLOutputError>) -> Void)
    /// <p>
    ///             The <code>GetHIT</code> operation retrieves the details of the specified HIT.
    ///         </p>
    func getHIT(input: GetHITInput, completion: @escaping (SdkResult<GetHITOutputResponse, GetHITOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    func getQualificationScore(input: GetQualificationScoreInput, completion: @escaping (SdkResult<GetQualificationScoreOutputResponse, GetQualificationScoreOutputError>) -> Void)
    /// <p>
    ///             The <code>GetQualificationType</code>operation retrieves information about a Qualification type using its ID.
    ///         </p>
    func getQualificationType(input: GetQualificationTypeInput, completion: @escaping (SdkResult<GetQualificationTypeOutputResponse, GetQualificationTypeOutputError>) -> Void)
    /// <p>
    ///             The
    ///             <code>ListAssignmentsForHIT</code>
    ...
    ///         </p>
    func listAssignmentsForHIT(input: ListAssignmentsForHITInput, completion: @escaping (SdkResult<ListAssignmentsForHITOutputResponse, ListAssignmentsForHITOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///         </p>
    func listBonusPayments(input: ListBonusPaymentsInput, completion: @escaping (SdkResult<ListBonusPaymentsOutputResponse, ListBonusPaymentsOutputError>) -> Void)
    /// <p>
    ///             The
    ///             <code>ListHITs</code>
    ...
    ///         </p>
    func listHITs(input: ListHITsInput, completion: @escaping (SdkResult<ListHITsOutputResponse, ListHITsOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func listHITsForQualificationType(input: ListHITsForQualificationTypeInput, completion: @escaping (SdkResult<ListHITsForQualificationTypeOutputResponse, ListHITsForQualificationTypeOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///         </p>
    func listQualificationRequests(input: ListQualificationRequestsInput, completion: @escaping (SdkResult<ListQualificationRequestsOutputResponse, ListQualificationRequestsOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///         </p>
    func listQualificationTypes(input: ListQualificationTypesInput, completion: @escaping (SdkResult<ListQualificationTypesOutputResponse, ListQualificationTypesOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func listReviewableHITs(input: ListReviewableHITsInput, completion: @escaping (SdkResult<ListReviewableHITsOutputResponse, ListReviewableHITsOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func listReviewPolicyResultsForHIT(input: ListReviewPolicyResultsForHITInput, completion: @escaping (SdkResult<ListReviewPolicyResultsForHITOutputResponse, ListReviewPolicyResultsForHITOutputError>) -> Void)
    /// <p>The <code>ListWorkersBlocks</code> operation retrieves a list of Workers who are blocked from working on your HITs.</p>
    func listWorkerBlocks(input: ListWorkerBlocksInput, completion: @escaping (SdkResult<ListWorkerBlocksOutputResponse, ListWorkerBlocksOutputError>) -> Void)
    /// <p>
    ///             The <code>ListWorkersWithQualificationType</code> operation returns all of the Workers
    ///             that have been associated with a given Qualification type.
    ///         </p>
    func listWorkersWithQualificationType(input: ListWorkersWithQualificationTypeInput, completion: @escaping (SdkResult<ListWorkersWithQualificationTypeOutputResponse, ListWorkersWithQualificationTypeOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///             Worker.
    ///         </p>
    func notifyWorkers(input: NotifyWorkersInput, completion: @escaping (SdkResult<NotifyWorkersOutputResponse, NotifyWorkersOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func rejectAssignment(input: RejectAssignmentInput, completion: @escaping (SdkResult<RejectAssignmentOutputResponse, RejectAssignmentOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    func rejectQualificationRequest(input: RejectQualificationRequestInput, completion: @escaping (SdkResult<RejectQualificationRequestOutputResponse, RejectQualificationRequestOutputError>) -> Void)
    /// <p>
    ///             The
    ///             <code>SendBonus</code>
    ...
    ///             and the fees.
    ///         </p>
    func sendBonus(input: SendBonusInput, completion: @escaping (SdkResult<SendBonusOutputResponse, SendBonusOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func sendTestEventNotification(input: SendTestEventNotificationInput, completion: @escaping (SdkResult<SendTestEventNotificationOutputResponse, SendTestEventNotificationOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func updateExpirationForHIT(input: UpdateExpirationForHITInput, completion: @escaping (SdkResult<UpdateExpirationForHITOutputResponse, UpdateExpirationForHITOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func updateHITReviewStatus(input: UpdateHITReviewStatusInput, completion: @escaping (SdkResult<UpdateHITReviewStatusOutputResponse, UpdateHITReviewStatusOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    ///         </p>
    func updateHITTypeOfHIT(input: UpdateHITTypeOfHITInput, completion: @escaping (SdkResult<UpdateHITTypeOfHITOutputResponse, UpdateHITTypeOfHITOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func updateNotificationSettings(input: UpdateNotificationSettingsInput, completion: @escaping (SdkResult<UpdateNotificationSettingsOutputResponse, UpdateNotificationSettingsOutputError>) -> Void)
    /// <p>
    ///             The
    ...
    func updateQualificationType(input: UpdateQualificationTypeInput, completion: @escaping (SdkResult<UpdateQualificationTypeOutputResponse, UpdateQualificationTypeOutputError>) -> Void)
}
