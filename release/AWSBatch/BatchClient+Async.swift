...
public extension BatchClient {
    ...
    {
        typealias createSchedulingPolicyContinuation = CheckedContinuation<CreateSchedulingPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createSchedulingPolicyContinuation) in
            createSchedulingPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteSchedulingPolicyContinuation = CheckedContinuation<DeleteSchedulingPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteSchedulingPolicyContinuation) in
            deleteSchedulingPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeSchedulingPoliciesContinuation = CheckedContinuation<DescribeSchedulingPoliciesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeSchedulingPoliciesContinuation) in
            describeSchedulingPolicies(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listSchedulingPoliciesContinuation = CheckedContinuation<ListSchedulingPoliciesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listSchedulingPoliciesContinuation) in
            listSchedulingPolicies(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateSchedulingPolicyContinuation = CheckedContinuation<UpdateSchedulingPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateSchedulingPolicyContinuation) in
            updateSchedulingPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
