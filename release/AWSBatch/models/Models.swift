...
struct CreateComputeEnvironmentInputBody: Swift.Equatable {
    ...
    public let unmanagedvCpus: Swift.Int
...
extension CreateJobQueueInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateJobQueueInput(computeEnvironmentOrder: \(Swift.String(describing: computeEnvironmentOrder)), jobQueueName: \(Swift.String(describing: jobQueueName)), priority: \(Swift.String(describing: priority)), schedulingPolicyArn: \(Swift.String(describing: schedulingPolicyArn)), state: \(Swift.String(describing: state)), tags: \(Swift.String(describing: tags)))"}
}
...
struct CreateJobQueueInputBody: Swift.Equatable {
    ...
    public let schedulingPolicyArn: Swift.String?
...
public struct CreateSchedulingPolicyInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSchedulingPolicyInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateSchedulingPolicyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateSchedulingPolicyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateSchedulingPolicyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateSchedulingPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateSchedulingPolicyOutputError>
}

extension CreateSchedulingPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateSchedulingPolicyInput(fairsharePolicy: \(Swift.String(describing: fairsharePolicy)), name: \(Swift.String(describing: name)), tags: \(Swift.String(describing: tags)))"}
}

extension CreateSchedulingPolicyInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateSchedulingPolicyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSchedulingPolicyInputHeadersMiddleware"
...
public struct CreateSchedulingPolicyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSchedulingPolicyInputQueryItemMiddleware"
...
public struct CreateSchedulingPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSchedulingPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = CreateSchedulingPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateSchedulingPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateSchedulingPolicyOutputError>
}

public struct CreateSchedulingPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSchedulingPolicyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/createschedulingpolicy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct CreateSchedulingPolicyInputBody: Swift.Equatable {
    ...
    public let fairsharePolicy: BatchClientTypes.FairsharePolicy?
    public let tags: [Swift.String:Swift.String]?
}
...
extension CreateSchedulingPolicyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateSchedulingPolicyOutputResponse(arn: \(Swift.String(describing: arn)), name: \(Swift.String(describing: name)))"}
}
...
public struct DeleteSchedulingPolicyInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSchedulingPolicyInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteSchedulingPolicyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteSchedulingPolicyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteSchedulingPolicyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteSchedulingPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteSchedulingPolicyOutputError>
}

extension DeleteSchedulingPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteSchedulingPolicyInput(arn: \(Swift.String(describing: arn)))"}
}

extension DeleteSchedulingPolicyInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
    }
...
public struct DeleteSchedulingPolicyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSchedulingPolicyInputHeadersMiddleware"
...
public struct DeleteSchedulingPolicyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSchedulingPolicyInputQueryItemMiddleware"
...
public struct DeleteSchedulingPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSchedulingPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteSchedulingPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteSchedulingPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteSchedulingPolicyOutputError>
}

public struct DeleteSchedulingPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSchedulingPolicyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/deleteschedulingpolicy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DeleteSchedulingPolicyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteSchedulingPolicyOutputResponse()"}
}
...
struct DeleteSchedulingPolicyOutputResponseBody: Swift.Equatable {
}

extension DeleteSchedulingPolicyOutputResponseBody: Swift.Decodable {
...
public struct DescribeSchedulingPoliciesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSchedulingPoliciesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeSchedulingPoliciesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeSchedulingPoliciesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeSchedulingPoliciesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeSchedulingPoliciesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeSchedulingPoliciesOutputError>
}

extension DescribeSchedulingPoliciesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeSchedulingPoliciesInput(arns: \(Swift.String(describing: arns)))"}
}

extension DescribeSchedulingPoliciesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arns
    }
...
public struct DescribeSchedulingPoliciesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSchedulingPoliciesInputHeadersMiddleware"
...
public struct DescribeSchedulingPoliciesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSchedulingPoliciesInputQueryItemMiddleware"
...
public struct DescribeSchedulingPoliciesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSchedulingPoliciesInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeSchedulingPoliciesInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeSchedulingPoliciesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeSchedulingPoliciesOutputError>
}

public struct DescribeSchedulingPoliciesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSchedulingPoliciesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/describeschedulingpolicies"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeSchedulingPoliciesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeSchedulingPoliciesOutputResponse(schedulingPolicies: \(Swift.String(describing: schedulingPolicies)))"}
}
...
struct DescribeSchedulingPoliciesOutputResponseBody: Swift.Equatable {
    public let schedulingPolicies: [BatchClientTypes.SchedulingPolicyDetail]?
}
...
extension BatchClientTypes.FairsharePolicy: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension BatchClientTypes.FairsharePolicy: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "FairsharePolicy(computeReservation: \(Swift.String(describing: computeReservation)), shareDecaySeconds: \(Swift.String(describing: shareDecaySeconds)), shareDistribution: \(Swift.String(describing: shareDistribution)))"}
}
...
extension BatchClientTypes.JobDefinition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobDefinition(containerProperties: \(Swift.String(describing: containerProperties)), jobDefinitionArn: \(Swift.String(describing: jobDefinitionArn)), jobDefinitionName: \(Swift.String(describing: jobDefinitionName)), nodeProperties: \(Swift.String(describing: nodeProperties)), parameters: \(Swift.String(describing: parameters)), platformCapabilities: \(Swift.String(describing: platformCapabilities)), propagateTags: \(Swift.String(describing: propagateTags)), retryStrategy: \(Swift.String(describing: retryStrategy)), revision: \(Swift.String(describing: revision)), schedulingPriority: \(Swift.String(describing: schedulingPriority)), status: \(Swift.String(describing: status)), tags: \(Swift.String(describing: tags)), timeout: \(Swift.String(describing: timeout)), type: \(Swift.String(describing: type)))"}
}
...
extension BatchClientTypes.JobQueueDetail: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobQueueDetail(computeEnvironmentOrder: \(Swift.String(describing: computeEnvironmentOrder)), jobQueueArn: \(Swift.String(describing: jobQueueArn)), jobQueueName: \(Swift.String(describing: jobQueueName)), priority: \(Swift.String(describing: priority)), schedulingPolicyArn: \(Swift.String(describing: schedulingPolicyArn)), state: \(Swift.String(describing: state)), status: \(Swift.String(describing: status)), statusReason: \(Swift.String(describing: statusReason)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct ListSchedulingPoliciesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSchedulingPoliciesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListSchedulingPoliciesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListSchedulingPoliciesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListSchedulingPoliciesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListSchedulingPoliciesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListSchedulingPoliciesOutputError>
}

extension ListSchedulingPoliciesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListSchedulingPoliciesInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListSchedulingPoliciesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case maxResults
        case nextToken
    }
...
public struct ListSchedulingPoliciesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSchedulingPoliciesInputHeadersMiddleware"
...
public struct ListSchedulingPoliciesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSchedulingPoliciesInputQueryItemMiddleware"
...
public struct ListSchedulingPoliciesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSchedulingPoliciesInputURLHostMiddleware"
    ...
    public typealias MInput = ListSchedulingPoliciesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListSchedulingPoliciesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListSchedulingPoliciesOutputError>
}

public struct ListSchedulingPoliciesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSchedulingPoliciesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/listschedulingpolicies"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListSchedulingPoliciesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListSchedulingPoliciesOutputResponse(nextToken: \(Swift.String(describing: nextToken)), schedulingPolicies: \(Swift.String(describing: schedulingPolicies)))"}
}
...
struct ListSchedulingPoliciesOutputResponseBody: Swift.Equatable {
    public let schedulingPolicies: [BatchClientTypes.SchedulingPolicyListingDetail]?
    public let nextToken: Swift.String?
}
...
extension RegisterJobDefinitionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RegisterJobDefinitionInput(containerProperties: \(Swift.String(describing: containerProperties)), jobDefinitionName: \(Swift.String(describing: jobDefinitionName)), nodeProperties: \(Swift.String(describing: nodeProperties)), parameters: \(Swift.String(describing: parameters)), platformCapabilities: \(Swift.String(describing: platformCapabilities)), propagateTags: \(Swift.String(describing: propagateTags)), retryStrategy: \(Swift.String(describing: retryStrategy)), schedulingPriority: \(Swift.String(describing: schedulingPriority)), tags: \(Swift.String(describing: tags)), timeout: \(Swift.String(describing: timeout)), type: \(Swift.String(describing: type)))"}
}
...
struct RegisterJobDefinitionInputBody: Swift.Equatable {
    ...
    public let schedulingPriority: Swift.Int
...
extension BatchClientTypes.SchedulingPolicyDetail: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
        case fairsharePolicy
        case name
...
extension BatchClientTypes.SchedulingPolicyDetail: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SchedulingPolicyDetail(arn: \(Swift.String(describing: arn)), fairsharePolicy: \(Swift.String(describing: fairsharePolicy)), name: \(Swift.String(describing: name)), tags: \(Swift.String(describing: tags)))"}
}
...
extension BatchClientTypes.SchedulingPolicyListingDetail: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
    }
...
extension BatchClientTypes.SchedulingPolicyListingDetail: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SchedulingPolicyListingDetail(arn: \(Swift.String(describing: arn)))"}
}
...
extension BatchClientTypes.ShareAttributes: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case shareIdentifier
        case weightFactor
    }
...
extension BatchClientTypes.ShareAttributes: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ShareAttributes(shareIdentifier: \(Swift.String(describing: shareIdentifier)), weightFactor: \(Swift.String(describing: weightFactor)))"}
}
...
extension SubmitJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SubmitJobInput(arrayProperties: \(Swift.String(describing: arrayProperties)), containerOverrides: \(Swift.String(describing: containerOverrides)), dependsOn: \(Swift.String(describing: dependsOn)), jobDefinition: \(Swift.String(describing: jobDefinition)), jobName: \(Swift.String(describing: jobName)), jobQueue: \(Swift.String(describing: jobQueue)), nodeOverrides: \(Swift.String(describing: nodeOverrides)), parameters: \(Swift.String(describing: parameters)), propagateTags: \(Swift.String(describing: propagateTags)), retryStrategy: \(Swift.String(describing: retryStrategy)), schedulingPriorityOverride: \(Swift.String(describing: schedulingPriorityOverride)), shareIdentifier: \(Swift.String(describing: shareIdentifier)), tags: \(Swift.String(describing: tags)), timeout: \(Swift.String(describing: timeout)))"}
}
...
struct SubmitJobInputBody: Swift.Equatable {
    ...
    public let jobQueue: Swift.String?
    public let shareIdentifier: Swift.String?
    public let schedulingPriorityOverride: Swift.Int
...
extension UpdateComputeEnvironmentInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateComputeEnvironmentInput(computeEnvironment: \(Swift.String(describing: computeEnvironment)), computeResources: \(Swift.String(describing: computeResources)), serviceRole: \(Swift.String(describing: serviceRole)), state: \(Swift.String(describing: state)), unmanagedvCpus: \(Swift.String(describing: unmanagedvCpus)))"}
}
...
extension UpdateJobQueueInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateJobQueueInput(computeEnvironmentOrder: \(Swift.String(describing: computeEnvironmentOrder)), jobQueue: \(Swift.String(describing: jobQueue)), priority: \(Swift.String(describing: priority)), schedulingPolicyArn: \(Swift.String(describing: schedulingPolicyArn)), state: \(Swift.String(describing: state)))"}
}
...
public struct UpdateSchedulingPolicyInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSchedulingPolicyInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateSchedulingPolicyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateSchedulingPolicyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateSchedulingPolicyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateSchedulingPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateSchedulingPolicyOutputError>
}

extension UpdateSchedulingPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateSchedulingPolicyInput(arn: \(Swift.String(describing: arn)), fairsharePolicy: \(Swift.String(describing: fairsharePolicy)))"}
}

extension UpdateSchedulingPolicyInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
        case fairsharePolicy
    }
...
public struct UpdateSchedulingPolicyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSchedulingPolicyInputHeadersMiddleware"
...
public struct UpdateSchedulingPolicyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSchedulingPolicyInputQueryItemMiddleware"
...
public struct UpdateSchedulingPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSchedulingPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateSchedulingPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateSchedulingPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateSchedulingPolicyOutputError>
}

public struct UpdateSchedulingPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSchedulingPolicyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/updateschedulingpolicy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension UpdateSchedulingPolicyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateSchedulingPolicyOutputResponse()"}
}
...
struct UpdateSchedulingPolicyOutputResponseBody: Swift.Equatable {
}

extension UpdateSchedulingPolicyOutputResponseBody: Swift.Decodable {
