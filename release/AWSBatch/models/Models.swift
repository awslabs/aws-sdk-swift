...
extension BatchClientTypes {
    ...
    public struct AttemptContainerDetail: Swift.Equatable {
        ...
        /// The Amazon Resource Name (ARN) of the Amazon ECS task that's associated with the job attempt. Each container attempt receives a task
...
extension BatchClientTypes {
    ...
    public struct ComputeEnvironmentDetail: Swift.Equatable {
        ...
        /// The compute resources defined for the compute environment. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute Environments in the
        ///    Batch User Guide.
        ...
        ///    operations on your behalf. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/service_IAM_role.html">Batch service IAM role in the
        ///    Batch User Guide.
        ...
        ///     <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute Environments in the
        ///     Batch User Guide.
...
extension BatchClientTypes {
    /// An object representing an Batch compute resource. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute Environments in the
    ///    Batch User Guide.
    public struct ComputeResource: Swift.Equatable {
        ...
        ///    type can be allocated. This might be because of availability of the instance type in the Region or <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-resource-limits.html">Amazon EC2 service limits. For more
        ///    information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/allocation-strategies.html">Allocation Strategies
        ...
        ///        <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-resource-limits.html">Amazon EC2 service limits
        ...
        ///    information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/launch-templates.html">Launch Template Support in
        ...
        ///    Availability Zone with high network flow potential. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html">Placement Groups in the Amazon EC2 User Guide for
        ///     Linux Instances.
        ///
        ///             This parameter isn't applicable to jobs that are running on Fargate resources, and shouldn't be
        ///     specified.
        ...
        ///     Instances. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/troubleshooting.html#spot-instance-no-tag">Spot Instances not tagged on creation in the
        ///      Batch User Guide.
        ///
        ...
        ///    compute resources can contain up to 16 subnets. For more information, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html">VPCs and Subnets in the Amazon VPC User
        ///     Guide.
        /// This member is required.
        ...
        ///     FARGATE_SPOT. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute Environments in the
        ///    Batch User Guide.
        ///           If you choose SPOT, you must also specify an Amazon EC2 Spot Fleet role with the
        ///     spotIamFleetRole parameter. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/spot_fleet_IAM_role.html">Amazon EC2 Spot Fleet role in the
        ///     Batch User Guide.
        /// This member is required.
...
extension BatchClientTypes {
    ...
    public struct ComputeResourceUpdate: Swift.Equatable {
        ...
        ///    can't be specified for EC2 compute resources. For more information, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html">VPCs and Subnets in the Amazon VPC User
        ///     Guide.
        public var subnets: [Swift.String]?
...
extension BatchClientTypes {
    ...
    public struct ContainerDetail: Swift.Equatable {
        ...
        /// The Amazon Resource Name (ARN) of the execution role that Batch can assume. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/execution-IAM-role.html">Batch execution IAM role in the
        ///     Batch User Guide.
        ...
        ///          This parameter maps to LogConfig in the <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the
        ///    <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --log-driver option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ...
        ///    For more information on the options for different supported log drivers, see <a href="https://docs.docker.com/engine/admin/logging/overview/">Configure logging drivers in the Docker
        ///    documentation.
        ///
        ...
        ///     instance can use these log configuration options. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-config.html">Amazon ECS Container Agent Configuration in the
        ...
        ///    maps to ReadonlyRootfs in the <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and
        ///    the --read-only option to <a href="https://docs.docker.com/engine/reference/commandline/run/">
        ///                docker run
        ///             .
        ...
        /// The secrets to pass to the container. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/specifying-sensitive-data.html">Specifying sensitive data in the
        ///     Batch User Guide.
        ...
        ///    <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --ulimit option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ///
        ///             This parameter isn't applicable to jobs that are running on Fargate resources.
        ///
        public var ulimits: [BatchClientTypes.Ulimit]?
        /// The user name to use inside the container. This parameter maps to User in the
        ///    <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --user option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ...
        ///    the <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --cpu-shares option to
        ///     <a href="https://docs.docker.com/engine/reference/run/">docker run. Each vCPU is equivalent to 1,024 CPU shares. You must
...
extension BatchClientTypes {
    ...
    public struct ContainerOverrides: Swift.Equatable {
        ...
        ///     value set to the new value.
        ///          This parameter maps to CpuShares in the <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the
        ///    <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --cpu-shares option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
...
extension BatchClientTypes {
    ...
    public struct ContainerProperties: Swift.Equatable {
        ...
        ///    <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the COMMAND parameter to <a href="https://docs.docker.com/engine/reference/run/">docker run. For more information, see <a href="https://docs.docker.com/engine/reference/builder/#cmd">https://docs.docker.com/engine/reference/builder/#cmd.
        public var command: [Swift.String]?
        /// The environment variables to pass to a container. This parameter maps to Env in the
        ///    <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --env option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ///
        ...
        ///    provide an execution role. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/execution-IAM-role.html">Batch execution IAM role in the
        ///     Batch User Guide.
        public var executionRoleArn: Swift.String?
        /// The platform configuration for jobs that are running on Fargate resources. Jobs that are running on EC2
        ///    resources must not specify this parameter.
        ...
        ///  periods, forward slashes, and number signs are allowed. This parameter maps to Image in the <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of
        ///    the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the IMAGE parameter of <a href="https://docs.docker.com/engine/reference/run/">docker
        ///    run.
        ///
        ...
        ///     <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-iam-roles.html">IAM Roles for Tasks
        ///    in the Amazon Elastic Container Service Developer Guide.
        public var jobRoleArn: Swift.String?
        /// Linux-specific modifications that are applied to the container, such as details for device mappings.
        public var linuxParameters: BatchClientTypes.LinuxParameters?
        ...
        ///          This parameter maps to Memory in the <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the
        ///    <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --memory option to <a href="https://docs.docker.com/engine/reference/run/">docker
        ///    run.
        ...
        ///    <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --volume option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        public var mountPoints: [BatchClientTypes.MountPoint]?
        /// The network configuration for jobs that are running on Fargate resources. Jobs that are running on EC2
        ///    resources must not specify this parameter.
        public var networkConfiguration: BatchClientTypes.NetworkConfiguration?
        ...
        ///    <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --privileged option to
        ///     <a href="https://docs.docker.com/engine/reference/run/">docker run. The default value is false.
        ///
        ///             This parameter isn't applicable to jobs that are running on Fargate resources and shouldn't be provided, or
        ///     specified as false.
        ///
        ...
        ///     MEMORY, and VCPU.
        public var resourceRequirements: [BatchClientTypes.ResourceRequirement]?
        /// The secrets for the container. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/specifying-sensitive-data.html">Specifying sensitive data in the
        ///     Batch User Guide.
        public var secrets: [BatchClientTypes.Secret]?
        ...
        ///     CpuShares in the <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the
        ///     --cpu-shares option to <a href="https://docs.docker.com/engine/reference/run/">docker run. The number of vCPUs must
...
public struct CreateComputeEnvironmentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateComputeEnvironmentInputURLHostMiddleware"
    ...
    public typealias MInput = CreateComputeEnvironmentInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateComputeEnvironmentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateComputeEnvironmentOutputError>
}

public struct CreateComputeEnvironmentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateComputeEnvironmentInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/createcomputeenvironment"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreateComputeEnvironmentInput: Swift.Equatable {
    ...
    ///    compute environments. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html">Compute Environments in the Batch User Guide.
    public var computeResources: BatchClientTypes.ComputeResource?
    ...
    ///    of /foo/ then you would specify /foo/bar as the role name. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html#identifiers-friendly-names">Friendly names
    ...
    ///    consists of a key and an optional value. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html">Tagging Amazon Web Services Resources in Amazon Web Services General
    ///    Reference.
    ///          These tags can be updated or removed using the <a href="https://docs.aws.amazon.com/batch/latest/APIReference/API_TagResource.html">TagResource and <a href="https://docs.aws.amazon.com/batch/latest/APIReference/API_UntagResource.html">UntagResource API operations. These tags don't
...
public struct CreateJobQueueInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateJobQueueInputURLHostMiddleware"
    ...
    public typealias MInput = CreateJobQueueInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateJobQueueOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateJobQueueOutputError>
}

public struct CreateJobQueueInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateJobQueueInputURLPathMiddleware"
...
public struct CreateJobQueueInput: Swift.Equatable {
    ...
    ///    of a key and an optional value. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/using-tags.html">Tagging your Batch resources in Batch User Guide.
    public var tags: [Swift.String:Swift.String]?
...
public struct DeleteComputeEnvironmentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteComputeEnvironmentInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteComputeEnvironmentInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteComputeEnvironmentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteComputeEnvironmentOutputError>
}

public struct DeleteComputeEnvironmentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteComputeEnvironmentInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/deletecomputeenvironment"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteJobQueueInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteJobQueueInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteJobQueueInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteJobQueueOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteJobQueueOutputError>
}

public struct DeleteJobQueueInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteJobQueueInputURLPathMiddleware"
...
public struct DeregisterJobDefinitionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeregisterJobDefinitionInputURLHostMiddleware"
    ...
    public typealias MInput = DeregisterJobDefinitionInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeregisterJobDefinitionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeregisterJobDefinitionOutputError>
}

public struct DeregisterJobDefinitionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeregisterJobDefinitionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/deregisterjobdefinition"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeComputeEnvironmentsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeComputeEnvironmentsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeComputeEnvironmentsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeComputeEnvironmentsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeComputeEnvironmentsOutputError>
}

public struct DescribeComputeEnvironmentsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeComputeEnvironmentsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/describecomputeenvironments"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeJobDefinitionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJobDefinitionsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeJobDefinitionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeJobDefinitionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeJobDefinitionsOutputError>
}

public struct DescribeJobDefinitionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJobDefinitionsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/describejobdefinitions"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeJobQueuesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJobQueuesInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeJobQueuesInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeJobQueuesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeJobQueuesOutputError>
}

public struct DescribeJobQueuesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJobQueuesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/describejobqueues"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension BatchClientTypes {
    ...
    public struct EFSAuthorizationConfig: Swift.Equatable {
        ...
        ///     EFSVolumeConfiguration. For more information, see <a href="https://docs.aws.amazon.com/efs/latest/ug/efs-access-points.html">Working with Amazon EFS Access Points in the
        ...
        ///    parameter is omitted, the default value of DISABLED is used. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/efs-volumes.html#efs-volume-accesspoints">Using Amazon EFS Access Points in
...
extension BatchClientTypes {
    /// This is used when you're using an Amazon Elastic File System file system for job storage. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/efs-volumes.html">Amazon EFS Volumes in the
    ///     Batch User Guide.
    public struct EFSVolumeConfiguration: Swift.Equatable {
        ...
        ///    value of DISABLED is used. For more information, see <a href="https://docs.aws.amazon.com/efs/latest/ug/encryption-in-transit.html">Encrypting data in transit in the
        ///     Amazon Elastic File System User Guide.
        ...
        ///    between 0 and 65,535. For more information, see <a href="https://docs.aws.amazon.com/efs/latest/ug/efs-mount-helper.html">EFS Mount Helper in the Amazon Elastic File System User Guide.
...
extension BatchClientTypes {
    ...
    ///     Ec2Configuration isn't specified, the default is currently ECS_AL1 (<a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html#alami">Amazon Linux) for
    ...
    public struct Ec2Configuration: Swift.Equatable {
        ...
        ///    isn't specified, then a recent <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html">Amazon ECS-optimized AMI (ECS_AL1) is
        ///    used. Starting on March 31, 2021, this default will be changing to ECS_AL2 (<a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html#al2ami">Amazon Linux 2).
        ///
        ///             ECS_AL2
        ///
        ///
...
extension BatchClientTypes {
    ...
    public struct FargatePlatformConfiguration: Swift.Equatable {
        ...
        ///    that are running on Fargate resources. If one isn't specified, the LATEST platform version is used by
        ///    default. This uses a recent, approved version of the Fargate platform for compute resources. For more
        ///    information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html">Fargate platform versions in the Amazon Elastic Container Service Developer Guide.
...
extension BatchClientTypes {
    ...
    public struct JobDefinition: Swift.Equatable {
        ...
        ///    parameter defaults from the job definition. For more information about specifying parameters, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/job_definition_parameters.html">Job Definition Parameters in the
        ///     Batch User Guide.
        ...
        ///    supported. For more information about multi-node parallel jobs, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/multi-node-job-def.html">Creating a multi-node parallel job definition in the
        ///     Batch User Guide.
        /// This member is required.
...
extension BatchClientTypes {
    ...
    public struct JobDetail: Swift.Equatable {
        ...
        ///
        ///             If your jobs don't progress to STARTING, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/troubleshooting.html#job_stuck_in_runnable">Jobs Stuck in RUNNABLE Status in the
...
extension BatchClientTypes {
    ...
    public struct JobQueueDetail: Swift.Equatable {
        ...
        public var statusReason: Swift.String?
        /// The tags applied to the job queue. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/using-tags.html">Tagging your Batch resources in
        ///    Batch User Guide.
        public var tags: [Swift.String:Swift.String]?
...
extension BatchClientTypes.KeyValuesPair: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name
        case values
    }
...
extension BatchClientTypes.KeyValuesPair: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "KeyValuesPair(name: \(Swift.String(describing: name)), values: \(Swift.String(describing: values)))"}
}
...
extension BatchClientTypes {
    ...
    public struct LinuxParameters: Swift.Equatable {
        ...
        ///    <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --device option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ///
        ///             This parameter isn't applicable to jobs that are running on Fargate resources and shouldn't be
        ///     provided.
        ///
        ...
        ///    parameter maps to the --init option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ...
        ///     --memory-swap option to <a href="https://docs.docker.com/engine/reference/run/">docker run where the value is the
        ///    sum of the container memory plus the maxSwap value. For more information, see <a href="https://docs.docker.com/config/containers/resource_constraints/#--memory-swap-details">
        ...
        ///     --shm-size option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ///
        ///             This parameter isn't applicable to jobs that are running on Fargate resources and shouldn't be
        ///     provided.
        ///
        ...
        ///     --memory-swappiness option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ...
        ///       feature. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-store-swap-volumes.html">Instance Store Swap Volumes in the
        ///        Amazon EC2 User Guide for Linux Instances or <a href="http://aws.amazon.com/premiumsupport/knowledge-center/ec2-memory-swap-file/">How do I allocate memory to work as swap space in an
        ...
        ///      container will have a default swappiness value of 60, and the total swap usage will be limited to two
        ...
        ///     --tmpfs option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ///
        ///             This parameter isn't applicable to jobs that are running on Fargate resources and shouldn't be
        ///     provided.
        ///
...
extension ListJobsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListJobsInput(arrayJobId: \(Swift.String(describing: arrayJobId)), filters: \(Swift.String(describing: filters)), jobQueue: \(Swift.String(describing: jobQueue)), jobStatus: \(Swift.String(describing: jobStatus)), maxResults: \(Swift.String(describing: maxResults)), multiNodeJobId: \(Swift.String(describing: multiNodeJobId)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListJobsInputBody: Swift.Equatable {
    ...
    public let maxResults: Swift.Int
    public let nextToken: Swift.String?
    public let filters: [BatchClientTypes.KeyValuesPair]?
}
...
extension BatchClientTypes {
    ...
    public struct LogConfiguration: Swift.Equatable {
        ...
        ///             awslogs
        ///
        ///                Specifies the Amazon CloudWatch Logs logging driver. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/using_awslogs.html">Using the awslogs Log Driver in the
        ///        Batch User Guide and <a href="https://docs.docker.com/config/containers/logging/awslogs/">Amazon CloudWatch Logs logging driver in the Docker documentation.
        ///
        ///             fluentd
        ///
        ///                Specifies the Fluentd logging driver. For more information, including usage and options, see <a href="https://docs.docker.com/config/containers/logging/fluentd/">Fluentd logging driver in the Docker
        ///       documentation.
        ///
        ///             gelf
        ///
        ...
        ///             journald
        ///
        ///                Specifies the journald logging driver. For more information, including usage and options, see <a href="https://docs.docker.com/config/containers/logging/journald/">Journald logging driver in the Docker
        ///       documentation.
        ///
        ///             json-file
        ///
        ///                Specifies the JSON file logging driver. For more information, including usage and options, see <a href="https://docs.docker.com/config/containers/logging/json-file/">JSON File logging driver in the Docker
        ///       documentation.
        ///
        ///             splunk
        ///
        ///                Specifies the Splunk logging driver. For more information, including usage and options, see <a href="https://docs.docker.com/config/containers/logging/splunk/">Splunk logging driver in the Docker
        ///       documentation.
        ///
        ///             syslog
        ///
        ///                Specifies the syslog logging driver. For more information, including usage and options, see <a href="https://docs.docker.com/config/containers/logging/syslog/">Syslog logging driver in the Docker
        ///       documentation.
        ///
        ///
        ///
        ...
        /// The secrets to pass to the log configuration. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/specifying-sensitive-data.html">Specifying Sensitive Data in the
        ///     Batch User Guide.
...
extension BatchClientTypes {
    ...
    ///     Volumes in the <a href="https://docs.docker.com/engine/reference/api/docker_remote_api_v1.19/#create-a-container">Create a
...
extension BatchClientTypes {
    ...
    public struct NetworkConfiguration: Swift.Equatable {
        ...
        ///    requires a NAT gateway be attached to route requests to the internet. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-networking.html">Amazon ECS task networking. The
...
public struct RegisterJobDefinitionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterJobDefinitionInputURLHostMiddleware"
    ...
    public typealias MInput = RegisterJobDefinitionInput
    public typealias MOutput = ClientRuntime.OperationOutput<RegisterJobDefinitionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RegisterJobDefinitionOutputError>
}

public struct RegisterJobDefinitionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterJobDefinitionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/registerjobdefinition"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct RegisterJobDefinitionInput: Swift.Equatable {
    ...
    ///    job, it becomes a multi-node parallel job. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/multi-node-parallel-jobs.html">Multi-node Parallel Jobs in the
    ...
    ///    consists of a key and an optional value. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/using-tags.html">Tagging Amazon Web Services Resources in Batch User Guide.
    public var tags: [Swift.String:Swift.String]?
    ...
    ///    overrides the timeout configuration defined here. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/job_timeouts.html">Job Timeouts in the Batch User Guide.
    public var timeout: BatchClientTypes.JobTimeout?
    /// The type of job definition. For more information about multi-node parallel jobs, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/multi-node-job-def.html">Creating a multi-node parallel job definition in the
    ///     Batch User Guide.
    ///
...
extension BatchClientTypes {
    ...
    public struct ResourceRequirement: Swift.Equatable {
        ...
        ///       This parameter maps to Memory in the <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the
        ///       <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --memory option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ...
        ///        Memory in the <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the
        ///        --memory option to <a href="https://docs.docker.com/engine/reference/run/">docker run.
        ///
        ...
        ///       <a href="https://docs.docker.com/engine/api/v1.23/#create-a-container">Create a container section of the <a href="https://docs.docker.com/engine/api/v1.23/">Docker Remote API and the --cpu-shares option to
        ///        <a href="https://docs.docker.com/engine/reference/run/">docker run. Each vCPU is equivalent to 1,024 CPU shares. For EC2
...
extension BatchClientTypes {
    /// The retry strategy associated with a job. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/job_retries.html">Automated job retries in the Batch User Guide.
...
public struct SubmitJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SubmitJobInputURLHostMiddleware"
    ...
    public typealias MInput = SubmitJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<SubmitJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SubmitJobOutputError>
}

public struct SubmitJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SubmitJobInputURLPathMiddleware"
...
public struct SubmitJobInput: Swift.Equatable {
    ...
    ///    10,000. If you specify array properties for a job, it becomes an array job. For more information, see <a href="https://docs.aws.amazon.com/batch/latest/userguide/array_jobs.html">Array Jobs in the
    ///    Batch User Guide.
    ...
    ///    of a key and an optional value. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html">Tagging Amazon Web Services Resources in Amazon Web Services General
    ///    Reference.
    public var tags: [Swift.String:Swift.String]?
...
public struct TagResourceInput: Swift.Equatable {
    ...
    ///    a key and an optional value. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html">Tagging Amazon Web Services Resources in Amazon Web Services General
    ///    Reference.
    /// This member is required.
    public var tags: [Swift.String:Swift.String]?
...
public struct TerminateJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateJobInputURLHostMiddleware"
    ...
    public typealias MInput = TerminateJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<TerminateJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<TerminateJobOutputError>
}

public struct TerminateJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateJobInputURLPathMiddleware"
...
public struct UpdateComputeEnvironmentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateComputeEnvironmentInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateComputeEnvironmentInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateComputeEnvironmentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateComputeEnvironmentOutputError>
}

public struct UpdateComputeEnvironmentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateComputeEnvironmentInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/updatecomputeenvironment"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdateJobQueueInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobQueueInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateJobQueueInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateJobQueueOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateJobQueueOutputError>
}

public struct UpdateJobQueueInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobQueueInputURLPathMiddleware"
