...
public protocol ForecastClientProtocol {
    ...
    ///         status.</p>
    ///          </note>
    func createForecast(input: CreateForecastInput, completion: @escaping (SdkResult<CreateForecastOutputResponse, CreateForecastOutputError>) -> Void)
    ...
    ///          </note>
    func createForecastExportJob(input: CreateForecastExportJobInput, completion: @escaping (SdkResult<CreateForecastExportJobOutputResponse, CreateForecastExportJobOutputError>) -> Void)
    ...
    ///          </note>
    func createPredictor(input: CreatePredictorInput, completion: @escaping (SdkResult<CreatePredictorOutputResponse, CreatePredictorOutputError>) -> Void)
    ...
    ///         </note>
    func createPredictorBacktestExportJob(input: CreatePredictorBacktestExportJobInput, completion: @escaping (SdkResult<CreatePredictorBacktestExportJobOutputResponse, CreatePredictorBacktestExportJobOutputError>) -> Void)
    ...
    func deleteDatasetImportJob(input: DeleteDatasetImportJobInput, completion: @escaping (SdkResult<DeleteDatasetImportJobOutputResponse, DeleteDatasetImportJobOutputError>) -> Void)
    ...
    func deleteForecast(input: DeleteForecastInput, completion: @escaping (SdkResult<DeleteForecastOutputResponse, DeleteForecastOutputError>) -> Void)
    ...
    func deleteForecastExportJob(input: DeleteForecastExportJobInput, completion: @escaping (SdkResult<DeleteForecastExportJobOutputResponse, DeleteForecastExportJobOutputError>) -> Void)
    ...
    func deletePredictor(input: DeletePredictorInput, completion: @escaping (SdkResult<DeletePredictorOutputResponse, DeletePredictorOutputError>) -> Void)
    /// <p>Deletes a predictor backtest export job.</p>
    func deletePredictorBacktestExportJob(input: DeletePredictorBacktestExportJobInput, completion: @escaping (SdkResult<DeletePredictorBacktestExportJobOutputResponse, DeletePredictorBacktestExportJobOutputError>) -> Void)
    ...
    ///         </note>
    func deleteResourceTree(input: DeleteResourceTreeInput, completion: @escaping (SdkResult<DeleteResourceTreeOutputResponse, DeleteResourceTreeOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeForecast(input: DescribeForecastInput, completion: @escaping (SdkResult<DescribeForecastOutputResponse, DescribeForecastOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeForecastExportJob(input: DescribeForecastExportJobInput, completion: @escaping (SdkResult<DescribeForecastExportJobOutputResponse, DescribeForecastExportJobOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describePredictor(input: DescribePredictorInput, completion: @escaping (SdkResult<DescribePredictorOutputResponse, DescribePredictorOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describePredictorBacktestExportJob(input: DescribePredictorBacktestExportJobInput, completion: @escaping (SdkResult<DescribePredictorBacktestExportJobOutputResponse, DescribePredictorBacktestExportJobOutputError>) -> Void)
    ...
    ///         To get the status, use the <a>DescribePredictor</a> operation.</p>
    ///          </note>
    func getAccuracyMetrics(input: GetAccuracyMetricsInput, completion: @escaping (SdkResult<GetAccuracyMetricsOutputResponse, GetAccuracyMetricsOutputError>) -> Void)
    ...
    func listForecastExportJobs(input: ListForecastExportJobsInput, completion: @escaping (SdkResult<ListForecastExportJobsOutputResponse, ListForecastExportJobsOutputError>) -> Void)
    ...
    func listForecasts(input: ListForecastsInput, completion: @escaping (SdkResult<ListForecastsOutputResponse, ListForecastsOutputError>) -> Void)
    ...
    func listPredictorBacktestExportJobs(input: ListPredictorBacktestExportJobsInput, completion: @escaping (SdkResult<ListPredictorBacktestExportJobsOutputResponse, ListPredictorBacktestExportJobsOutputError>) -> Void)
    ...
    func listPredictors(input: ListPredictorsInput, completion: @escaping (SdkResult<ListPredictorsOutputResponse, ListPredictorsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func stopResource(input: StopResourceInput, completion: @escaping (SdkResult<StopResourceOutputResponse, StopResourceOutputError>) -> Void)
    ...
    ///          </note>
    func updateDatasetGroup(input: UpdateDatasetGroupInput, completion: @escaping (SdkResult<UpdateDatasetGroupOutputResponse, UpdateDatasetGroupOutputError>) -> Void)
}
