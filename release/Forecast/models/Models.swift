...
extension ForecastClientTypes {
    ...
    public struct ContinuousParameterRange: Swift.Equatable {
        ...
        public let scalingType: ForecastClientTypes.ScalingType?
...
extension CreatePredictorInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreatePredictorInput(algorithmArn: \(Swift.String(describing: algorithmArn)), autoMLOverrideStrategy: \(Swift.String(describing: autoMLOverrideStrategy)), encryptionConfig: \(Swift.String(describing: encryptionConfig)), evaluationParameters: \(Swift.String(describing: evaluationParameters)), featurizationConfig: \(Swift.String(describing: featurizationConfig)), forecastHorizon: \(Swift.String(describing: forecastHorizon)), forecastTypes: \(Swift.String(describing: forecastTypes)), hPOConfig: \(Swift.String(describing: hPOConfig)), inputDataConfig: \(Swift.String(describing: inputDataConfig)), performAutoML: \(Swift.String(describing: performAutoML)), performHPO: \(Swift.String(describing: performHPO)), predictorName: \(Swift.String(describing: predictorName)), tags: \(Swift.String(describing: tags)), trainingParameters: \(Swift.String(describing: trainingParameters)))"}
}
...
extension ForecastClientTypes {
    ...
    public struct DataDestination: Swift.Equatable {
        ...
        ///       bucket.
        /// This member is required.
        public let s3Config: ForecastClientTypes.S3Config?
...
extension DescribePredictorOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribePredictorOutputResponse(algorithmArn: \(Swift.String(describing: algorithmArn)), autoMLAlgorithmArns: \(Swift.String(describing: autoMLAlgorithmArns)), autoMLOverrideStrategy: \(Swift.String(describing: autoMLOverrideStrategy)), creationTime: \(Swift.String(describing: creationTime)), datasetImportJobArns: \(Swift.String(describing: datasetImportJobArns)), encryptionConfig: \(Swift.String(describing: encryptionConfig)), estimatedTimeRemainingInMinutes: \(Swift.String(describing: estimatedTimeRemainingInMinutes)), evaluationParameters: \(Swift.String(describing: evaluationParameters)), featurizationConfig: \(Swift.String(describing: featurizationConfig)), forecastHorizon: \(Swift.String(describing: forecastHorizon)), forecastTypes: \(Swift.String(describing: forecastTypes)), hPOConfig: \(Swift.String(describing: hPOConfig)), inputDataConfig: \(Swift.String(describing: inputDataConfig)), lastModificationTime: \(Swift.String(describing: lastModificationTime)), message: \(Swift.String(describing: message)), performAutoML: \(Swift.String(describing: performAutoML)), performHPO: \(Swift.String(describing: performHPO)), predictorArn: \(Swift.String(describing: predictorArn)), predictorExecutionDetails: \(Swift.String(describing: predictorExecutionDetails)), predictorName: \(Swift.String(describing: predictorName)), status: \(Swift.String(describing: status)), trainingParameters: \(Swift.String(describing: trainingParameters)))"}
}
...
extension ForecastClientTypes.ErrorMetric: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ErrorMetric(forecastType: \(Swift.String(describing: forecastType)), rMSE: \(Swift.String(describing: rMSE)), wAPE: \(Swift.String(describing: wAPE)))"}
}
...
extension ForecastClientTypes {
    ...
    public struct ErrorMetric: Swift.Equatable {
        ...
        ///
        public let forecastType: Swift.String?
        ///
        ///       The root-mean-square error (RMSE).
        ///
        public let rMSE: Swift.Double?
        ///
        ///       The weighted absolute percentage error (WAPE).
        ///
        public let wAPE: Swift.Double?
...
extension ForecastClientTypes {
    ...
    public struct EvaluationResult: Swift.Equatable {
        ...
        public let testWindows: [ForecastClientTypes.WindowSummary]?
...
extension ForecastClientTypes {
    ...
    public struct Featurization: Swift.Equatable {
        ...
        public let featurizationPipeline: [ForecastClientTypes.FeaturizationMethod]?
...
extension ForecastClientTypes {
    ...
    public struct FeaturizationConfig: Swift.Equatable {
        ...
        public let featurizations: [ForecastClientTypes.Featurization]?
...
extension ForecastClientTypes {
    ...
    public struct FeaturizationMethod: Swift.Equatable {
        ...
        /// This member is required.
        public let featurizationMethodName: ForecastClientTypes.FeaturizationMethodName?
        ...
        ///         "backfill_value":"2".
        public let featurizationMethodParameters: [Swift.String:Swift.String]?
...
extension ForecastClientTypes {
    ...
    public struct Filter: Swift.Equatable {
        ...
        /// This member is required.
        public let condition: ForecastClientTypes.FilterConditionString?
...
extension GetAccuracyMetricsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccuracyMetricsOutputResponse(autoMLOverrideStrategy: \(Swift.String(describing: autoMLOverrideStrategy)), predictorEvaluationResults: \(Swift.String(describing: predictorEvaluationResults)))"}
}
...
extension ForecastClientTypes {
    ...
    public struct HyperParameterTuningJobConfig: Swift.Equatable {
        ...
        public let parameterRanges: ForecastClientTypes.ParameterRanges?
...
extension ForecastClientTypes {
    ...
    public struct InputDataConfig: Swift.Equatable {
        ...
        ///       calendar.
        public let supplementaryFeatures: [ForecastClientTypes.SupplementaryFeature]?
...
extension ForecastClientTypes.Metrics: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Metrics(errorMetrics: \(Swift.String(describing: errorMetrics)), rMSE: \(Swift.String(describing: rMSE)), weightedQuantileLosses: \(Swift.String(describing: weightedQuantileLosses)))"}
}
...
extension ForecastClientTypes {
    ...
    public struct Metrics: Swift.Equatable {
        ...
        ///
        public let errorMetrics: [ForecastClientTypes.ErrorMetric]?
        /// The root-mean-square error (RMSE).
        ...
        public let weightedQuantileLosses: [ForecastClientTypes.WeightedQuantileLoss]?
...
extension ForecastClientTypes {
    ...
    public struct ParameterRanges: Swift.Equatable {
        ...
        public let categoricalParameterRanges: [ForecastClientTypes.CategoricalParameterRange]?
        /// Specifies the tunable range for each continuous hyperparameter.
        public let continuousParameterRanges: [ForecastClientTypes.ContinuousParameterRange]?
        /// Specifies the tunable range for each integer hyperparameter.
        public let integerParameterRanges: [ForecastClientTypes.IntegerParameterRange]?
...
extension ForecastClientTypes {
    ...
    public struct PredictorExecution: Swift.Equatable {
        ...
        ///       object determines the number of windows in the array.
        public let testWindows: [ForecastClientTypes.TestWindowSummary]?
...
extension ForecastClientTypes {
    ...
    public struct PredictorExecutionDetails: Swift.Equatable {
        ...
        ///       array.
        public let predictorExecutions: [ForecastClientTypes.PredictorExecution]?
...
extension ForecastClientTypes {
    ...
    public struct Schema: Swift.Equatable {
        ...
        public let attributes: [ForecastClientTypes.SchemaAttribute]?
...
extension ForecastClientTypes {
    ...
    public struct SchemaAttribute: Swift.Equatable {
        ...
        public let attributeType: ForecastClientTypes.AttributeType?
...
extension ForecastClientTypes {
    ...
    public struct Statistics: Swift.Equatable {
        ...
        ///       CountDistinctLong.
        public let countDistinct: Swift.Int?
        ...
        public let countNullLong: Swift.Int?
...
extension ForecastClientTypes {
    ...
    public struct TestWindowSummary: Swift.Equatable {
        ...
        public let testWindowEnd: ClientRuntime.Date?
        /// The time at which the test began.
        public let testWindowStart: ClientRuntime.Date?
...
extension ForecastClientTypes {
    ...
    public struct WeightedQuantileLoss: Swift.Equatable {
        ...
        public let lossValue: Swift.Double?
        ...
        public let quantile: Swift.Double?
...
extension ForecastClientTypes {
    ...
    public struct WindowSummary: Swift.Equatable {
        ...
        ///
        ///
        public let evaluationType: ForecastClientTypes.EvaluationType?
        /// The number of data points within the window.
        public let itemCount: Swift.Int?
        /// Provides metrics used to evaluate the performance of a predictor.
        public let metrics: ForecastClientTypes.Metrics?
