...
public struct GetMediaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMediaInputURLHostMiddleware"
    ...
    public typealias MInput = GetMediaInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetMediaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetMediaOutputError>
}

public struct GetMediaInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMediaInputURLPathMiddleware"
...
///       such an exception, the user must call GetDataEndpoint with
