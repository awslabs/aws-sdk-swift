...
extension KinesisVideoMediaClient: KinesisVideoMediaClientProtocol {
    ...
    public func getMedia(input: GetMediaInput, completion: @escaping (ClientRuntime.SdkResult<GetMediaOutputResponse, GetMediaOutputError>) -> Void)
    {
        ...
        operation.initializeStep.intercept(position: .after, middleware: ClientRuntime.URLHostMiddleware<GetMediaInput, GetMediaOutputResponse, GetMediaOutputError>())
        ...
        operation.serializeStep.intercept(position: .after, middleware: ClientRuntime.SerializableBodyMiddleware<GetMediaInput, GetMediaOutputResponse, GetMediaOutputError>())
