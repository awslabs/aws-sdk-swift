...
public extension KinesisVideoMediaClient {
    ...
    {
        typealias getMediaContinuation = CheckedContinuation<GetMediaOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getMediaContinuation) in
            getMedia(input: input) { result in
                switch result {
