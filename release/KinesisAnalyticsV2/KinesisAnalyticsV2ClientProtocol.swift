...
public protocol KinesisAnalyticsV2ClientProtocol {
    ...
    func addApplicationCloudWatchLoggingOption(input: AddApplicationCloudWatchLoggingOptionInput, completion: @escaping (SdkResult<AddApplicationCloudWatchLoggingOptionOutput, AddApplicationCloudWatchLoggingOptionOutputError>) -> Void)
    /// <p>
    ...
    ///     </p>
    func addApplicationInput(input: AddApplicationInputInput, completion: @escaping (SdkResult<AddApplicationInputOutput, AddApplicationInputOutputError>) -> Void)
    ...
    func addApplicationInputProcessingConfiguration(input: AddApplicationInputProcessingConfigurationInput, completion: @escaping (SdkResult<AddApplicationInputProcessingConfigurationOutput, AddApplicationInputProcessingConfigurationOutputError>) -> Void)
    ...
    ///       version.</p>
    func addApplicationOutput(input: AddApplicationOutputInput, completion: @escaping (SdkResult<AddApplicationOutputOutput, AddApplicationOutputOutputError>) -> Void)
    ...
    func addApplicationReferenceDataSource(input: AddApplicationReferenceDataSourceInput, completion: @escaping (SdkResult<AddApplicationReferenceDataSourceOutput, AddApplicationReferenceDataSourceOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func addApplicationVpcConfiguration(input: AddApplicationVpcConfigurationInput, completion: @escaping (SdkResult<AddApplicationVpcConfigurationOutput, AddApplicationVpcConfigurationOutputError>) -> Void)
    ...
    ///          </note>
    func createApplicationPresignedUrl(input: CreateApplicationPresignedUrlInput, completion: @escaping (SdkResult<CreateApplicationPresignedUrlOutput, CreateApplicationPresignedUrlOutputError>) -> Void)
    /// <p>Creates a snapshot of the application's state data.</p>
    func createApplicationSnapshot(input: CreateApplicationSnapshotInput, completion: @escaping (SdkResult<CreateApplicationSnapshotOutput, CreateApplicationSnapshotOutputError>) -> Void)
    ...
    func deleteApplicationCloudWatchLoggingOption(input: DeleteApplicationCloudWatchLoggingOptionInput, completion: @escaping (SdkResult<DeleteApplicationCloudWatchLoggingOptionOutput, DeleteApplicationCloudWatchLoggingOptionOutputError>) -> Void)
    /// <p>Deletes an <a>InputProcessingConfiguration</a> from an input.</p>
    func deleteApplicationInputProcessingConfiguration(input: DeleteApplicationInputProcessingConfigurationInput, completion: @escaping (SdkResult<DeleteApplicationInputProcessingConfigurationOutput, DeleteApplicationInputProcessingConfigurationOutputError>) -> Void)
    ...
    func deleteApplicationOutput(input: DeleteApplicationOutputInput, completion: @escaping (SdkResult<DeleteApplicationOutputOutput, DeleteApplicationOutputOutputError>) -> Void)
    ...
    func deleteApplicationReferenceDataSource(input: DeleteApplicationReferenceDataSourceInput, completion: @escaping (SdkResult<DeleteApplicationReferenceDataSourceOutput, DeleteApplicationReferenceDataSourceOutputError>) -> Void)
    /// <p>Deletes a snapshot of application state.</p>
    func deleteApplicationSnapshot(input: DeleteApplicationSnapshotInput, completion: @escaping (SdkResult<DeleteApplicationSnapshotOutput, DeleteApplicationSnapshotOutputError>) -> Void)
    /// <p>Removes a VPC configuration from a Kinesis Data Analytics application.</p>
    func deleteApplicationVpcConfiguration(input: DeleteApplicationVpcConfigurationInput, completion: @escaping (SdkResult<DeleteApplicationVpcConfigurationOutput, DeleteApplicationVpcConfigurationOutputError>) -> Void)
    ...
    func describeApplicationSnapshot(input: DescribeApplicationSnapshotInput, completion: @escaping (SdkResult<DescribeApplicationSnapshotOutput, DescribeApplicationSnapshotOutputError>) -> Void)
    ...
    ///          </note>
    func describeApplicationVersion(input: DescribeApplicationVersionInput, completion: @escaping (SdkResult<DescribeApplicationVersionOutput, DescribeApplicationVersionOutputError>) -> Void)
    ...
    func discoverInputSchema(input: DiscoverInputSchemaInput, completion: @escaping (SdkResult<DiscoverInputSchemaOutput, DiscoverInputSchemaOutputError>) -> Void)
    ...
    func listApplicationSnapshots(input: ListApplicationSnapshotsInput, completion: @escaping (SdkResult<ListApplicationSnapshotsOutput, ListApplicationSnapshotsOutputError>) -> Void)
    ...
    ///             <p>This operation is supported only for Amazon Kinesis Data Analytics for Apache Flink.</p>
    ///          </note>
    func listApplicationVersions(input: ListApplicationVersionsInput, completion: @escaping (SdkResult<ListApplicationVersionsOutput, ListApplicationVersionsOutputError>) -> Void)
    ...
    func rollbackApplication(input: RollbackApplicationInput, completion: @escaping (SdkResult<RollbackApplicationOutput, RollbackApplicationOutputError>) -> Void)
    ...
    func startApplication(input: StartApplicationInput, completion: @escaping (SdkResult<StartApplicationOutput, StartApplicationOutputError>) -> Void)
    ...
    ///           to <code>true</code>.</p>
    func stopApplication(input: StopApplicationInput, completion: @escaping (SdkResult<StopApplicationOutput, StopApplicationOutputError>) -> Void)
    ...
    ///             <p>This operation is supported only for Amazon Kinesis Data Analytics for Apache Flink.</p>
    ///          </note>
    func updateApplicationMaintenanceConfiguration(input: UpdateApplicationMaintenanceConfigurationInput, completion: @escaping (SdkResult<UpdateApplicationMaintenanceConfigurationOutput, UpdateApplicationMaintenanceConfigurationOutputError>) -> Void)
}
