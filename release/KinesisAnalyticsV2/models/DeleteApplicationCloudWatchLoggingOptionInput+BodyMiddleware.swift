...
public struct DeleteApplicationCloudWatchLoggingOptionInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DeleteApplicationCloudWatchLoggingOptionOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DeleteApplicationCloudWatchLoggingOptionOutput>
