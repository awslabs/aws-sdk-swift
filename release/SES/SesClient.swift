...
public class SesClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try SesClientConfiguration(region: unwrappedRegion)
    ...
    public class SesClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("SesClient")
...
public struct SesClientLogHandlerFactory: SDKLogHandlerFactory {
