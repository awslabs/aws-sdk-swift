...
public protocol SesClientProtocol {
    ...
    func cloneReceiptRuleSet(input: CloneReceiptRuleSetInput, completion: @escaping (SdkResult<CloneReceiptRuleSetOutput, CloneReceiptRuleSetOutputError>) -> Void)
    ...
    func createConfigurationSetTrackingOptions(input: CreateConfigurationSetTrackingOptionsInput, completion: @escaping (SdkResult<CreateConfigurationSetTrackingOptionsOutput, CreateConfigurationSetTrackingOptionsOutputError>) -> Void)
    /// <p>Creates a new custom verification email template.</p>
    ///         <p>For more information about custom verification email templates, see <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/custom-verification-emails.html">Using Custom Verification Email Templates</a> in the <i>Amazon SES Developer
    ///                 Guide</i>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func createCustomVerificationEmailTemplate(input: CreateCustomVerificationEmailTemplateInput, completion: @escaping (SdkResult<CreateCustomVerificationEmailTemplateOutput, CreateCustomVerificationEmailTemplateOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func createReceiptFilter(input: CreateReceiptFilterInput, completion: @escaping (SdkResult<CreateReceiptFilterOutput, CreateReceiptFilterOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func createReceiptRule(input: CreateReceiptRuleInput, completion: @escaping (SdkResult<CreateReceiptRuleOutput, CreateReceiptRuleOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func createReceiptRuleSet(input: CreateReceiptRuleSetInput, completion: @escaping (SdkResult<CreateReceiptRuleSetOutput, CreateReceiptRuleSetOutputError>) -> Void)
    ...
    ///         </note>
    func deleteConfigurationSetTrackingOptions(input: DeleteConfigurationSetTrackingOptionsInput, completion: @escaping (SdkResult<DeleteConfigurationSetTrackingOptionsOutput, DeleteConfigurationSetTrackingOptionsOutputError>) -> Void)
    /// <p>Deletes an existing custom verification email template. </p>
    ///         <p>For more information about custom verification email templates, see <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/custom-verification-emails.html">Using Custom Verification Email Templates</a> in the <i>Amazon SES Developer
    ///                 Guide</i>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteCustomVerificationEmailTemplate(input: DeleteCustomVerificationEmailTemplateInput, completion: @escaping (SdkResult<DeleteCustomVerificationEmailTemplateOutput, DeleteCustomVerificationEmailTemplateOutputError>) -> Void)
    /// <p>Deletes the specified identity (an email address or a domain) from the list of
    ///             verified identities.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteIdentity(input: DeleteIdentityInput, completion: @escaping (SdkResult<DeleteIdentityOutput, DeleteIdentityOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteIdentityPolicy(input: DeleteIdentityPolicyInput, completion: @escaping (SdkResult<DeleteIdentityPolicyOutput, DeleteIdentityPolicyOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteReceiptFilter(input: DeleteReceiptFilterInput, completion: @escaping (SdkResult<DeleteReceiptFilterOutput, DeleteReceiptFilterOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteReceiptRule(input: DeleteReceiptRuleInput, completion: @escaping (SdkResult<DeleteReceiptRuleOutput, DeleteReceiptRuleOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteReceiptRuleSet(input: DeleteReceiptRuleSetInput, completion: @escaping (SdkResult<DeleteReceiptRuleSetOutput, DeleteReceiptRuleSetOutputError>) -> Void)
    ...
    ///             and domains.</p>
    func deleteVerifiedEmailAddress(input: DeleteVerifiedEmailAddressInput, completion: @escaping (SdkResult<DeleteVerifiedEmailAddressOutput, DeleteVerifiedEmailAddressOutputError>) -> Void)
    /// <p>Returns the metadata and receipt rules for the receipt rule set that is currently
    ///             active.</p>
    ///         <p>For information about setting up receipt rule sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-receipt-rule-set.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func describeActiveReceiptRuleSet(input: DescribeActiveReceiptRuleSetInput, completion: @escaping (SdkResult<DescribeActiveReceiptRuleSetOutput, DescribeActiveReceiptRuleSetOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func describeConfigurationSet(input: DescribeConfigurationSetInput, completion: @escaping (SdkResult<DescribeConfigurationSetOutput, DescribeConfigurationSetOutputError>) -> Void)
    /// <p>Returns the details of the specified receipt rule.</p>
    ///         <p>For information about setting up receipt rules, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-receipt-rules.html">Amazon SES Developer
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func describeReceiptRule(input: DescribeReceiptRuleInput, completion: @escaping (SdkResult<DescribeReceiptRuleOutput, DescribeReceiptRuleOutputError>) -> Void)
    /// <p>Returns the details of the specified receipt rule set.</p>
    ///         <p>For information about managing receipt rule sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rule-sets.html">Amazon SES Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func describeReceiptRuleSet(input: DescribeReceiptRuleSetInput, completion: @escaping (SdkResult<DescribeReceiptRuleSetOutput, DescribeReceiptRuleSetOutputError>) -> Void)
    /// <p>Returns the email sending status of the Amazon SES account for the current region.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func getAccountSendingEnabled(input: GetAccountSendingEnabledInput, completion: @escaping (SdkResult<GetAccountSendingEnabledOutput, GetAccountSendingEnabledOutputError>) -> Void)
    /// <p>Returns the custom email verification template for the template name you
    ///             specify.</p>
    ///         <p>For more information about custom verification email templates, see <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/custom-verification-emails.html">Using Custom Verification Email Templates</a> in the <i>Amazon SES Developer
    ///                 Guide</i>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func getCustomVerificationEmailTemplate(input: GetCustomVerificationEmailTemplateInput, completion: @escaping (SdkResult<GetCustomVerificationEmailTemplateOutput, GetCustomVerificationEmailTemplateOutputError>) -> Void)
    ...
    func getIdentityDkimAttributes(input: GetIdentityDkimAttributesInput, completion: @escaping (SdkResult<GetIdentityDkimAttributesOutput, GetIdentityDkimAttributesOutputError>) -> Void)
    ...
    func getIdentityMailFromDomainAttributes(input: GetIdentityMailFromDomainAttributesInput, completion: @escaping (SdkResult<GetIdentityMailFromDomainAttributesOutput, GetIdentityMailFromDomainAttributesOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    func getIdentityNotificationAttributes(input: GetIdentityNotificationAttributesInput, completion: @escaping (SdkResult<GetIdentityNotificationAttributesOutput, GetIdentityNotificationAttributesOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func getIdentityPolicies(input: GetIdentityPoliciesInput, completion: @escaping (SdkResult<GetIdentityPoliciesOutput, GetIdentityPoliciesOutputError>) -> Void)
    ...
    ///             attributes for up to 100 identities at a time.</p>
    func getIdentityVerificationAttributes(input: GetIdentityVerificationAttributesInput, completion: @escaping (SdkResult<GetIdentityVerificationAttributesOutput, GetIdentityVerificationAttributesOutputError>) -> Void)
    /// <p>Provides the sending limits for the Amazon SES account. </p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func getSendQuota(input: GetSendQuotaInput, completion: @escaping (SdkResult<GetSendQuotaOutput, GetSendQuotaOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func getSendStatistics(input: GetSendStatisticsInput, completion: @escaping (SdkResult<GetSendStatisticsOutput, GetSendStatisticsOutputError>) -> Void)
    ...
    ///                 Guide</i>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func listCustomVerificationEmailTemplates(input: ListCustomVerificationEmailTemplatesInput, completion: @escaping (SdkResult<ListCustomVerificationEmailTemplatesOutput, ListCustomVerificationEmailTemplatesOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func listIdentityPolicies(input: ListIdentityPoliciesInput, completion: @escaping (SdkResult<ListIdentityPoliciesOutput, ListIdentityPoliciesOutputError>) -> Void)
    /// <p>Lists the IP address filters associated with your AWS account in the current AWS
    ///             Region.</p>
    ///         <p>For information about managing IP address filters, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-ip-filters.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func listReceiptFilters(input: ListReceiptFiltersInput, completion: @escaping (SdkResult<ListReceiptFiltersOutput, ListReceiptFiltersOutputError>) -> Void)
    ...
    ///         <p>For information about managing receipt rule sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rule-sets.html">Amazon SES Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func listReceiptRuleSets(input: ListReceiptRuleSetsInput, completion: @escaping (SdkResult<ListReceiptRuleSetsOutput, ListReceiptRuleSetsOutputError>) -> Void)
    ...
    func listVerifiedEmailAddresses(input: ListVerifiedEmailAddressesInput, completion: @escaping (SdkResult<ListVerifiedEmailAddressesOutput, ListVerifiedEmailAddressesOutputError>) -> Void)
    /// <p>Adds or updates the delivery options for a configuration set.</p>
    func putConfigurationSetDeliveryOptions(input: PutConfigurationSetDeliveryOptionsInput, completion: @escaping (SdkResult<PutConfigurationSetDeliveryOptionsOutput, PutConfigurationSetDeliveryOptionsOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func putIdentityPolicy(input: PutIdentityPolicyInput, completion: @escaping (SdkResult<PutIdentityPolicyOutput, PutIdentityPolicyOutputError>) -> Void)
    ...
    ///         <p>For information about managing receipt rule sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rule-sets.html">Amazon SES Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func reorderReceiptRuleSet(input: ReorderReceiptRuleSetInput, completion: @escaping (SdkResult<ReorderReceiptRuleSetOutput, ReorderReceiptRuleSetOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func sendBounce(input: SendBounceInput, completion: @escaping (SdkResult<SendBounceOutput, SendBounceOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func sendBulkTemplatedEmail(input: SendBulkTemplatedEmailInput, completion: @escaping (SdkResult<SendBulkTemplatedEmailOutput, SendBulkTemplatedEmailOutputError>) -> Void)
    ...
    ///                 Guide</i>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func sendCustomVerificationEmail(input: SendCustomVerificationEmailInput, completion: @escaping (SdkResult<SendCustomVerificationEmailOutput, SendCustomVerificationEmailOutputError>) -> Void)
    ...
    ///             </p>
    ///         </important>
    func sendEmail(input: SendEmailInput, completion: @escaping (SdkResult<SendEmailOutput, SendEmailOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func sendRawEmail(input: SendRawEmailInput, completion: @escaping (SdkResult<SendRawEmailOutput, SendRawEmailOutputError>) -> Void)
    ...
    ///                     Developer Guide</i>.</p>
    ///         </important>
    func sendTemplatedEmail(input: SendTemplatedEmailInput, completion: @escaping (SdkResult<SendTemplatedEmailOutput, SendTemplatedEmailOutputError>) -> Void)
    ...
    ///         <p>For information about managing receipt rule sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rule-sets.html">Amazon SES Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func setActiveReceiptRuleSet(input: SetActiveReceiptRuleSetInput, completion: @escaping (SdkResult<SetActiveReceiptRuleSetOutput, SetActiveReceiptRuleSetOutputError>) -> Void)
    ...
    func setIdentityDkimEnabled(input: SetIdentityDkimEnabledInput, completion: @escaping (SdkResult<SetIdentityDkimEnabledOutput, SetIdentityDkimEnabledOutputError>) -> Void)
    ...
    ///         <p>For more information about using notifications with Amazon SES, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/notifications.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    func setIdentityFeedbackForwardingEnabled(input: SetIdentityFeedbackForwardingEnabledInput, completion: @escaping (SdkResult<SetIdentityFeedbackForwardingEnabledOutput, SetIdentityFeedbackForwardingEnabledOutputError>) -> Void)
    ...
    ///         <p>For more information about using notifications with Amazon SES, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/notifications.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    func setIdentityHeadersInNotificationsEnabled(input: SetIdentityHeadersInNotificationsEnabledInput, completion: @escaping (SdkResult<SetIdentityHeadersInNotificationsEnabledOutput, SetIdentityHeadersInNotificationsEnabledOutputError>) -> Void)
    ...
    ///         </important>
    ///         <p>You can execute this operation no more than once per second.</p>
    func setIdentityMailFromDomain(input: SetIdentityMailFromDomainInput, completion: @escaping (SdkResult<SetIdentityMailFromDomainOutput, SetIdentityMailFromDomainOutputError>) -> Void)
    ...
    ///             Guide</a>.</p>
    func setIdentityNotificationTopic(input: SetIdentityNotificationTopicInput, completion: @escaping (SdkResult<SetIdentityNotificationTopicOutput, SetIdentityNotificationTopicOutputError>) -> Void)
    /// <p>Sets the position of the specified receipt rule in the receipt rule set.</p>
    ///         <p>For information about managing receipt rules, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rules.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func setReceiptRulePosition(input: SetReceiptRulePositionInput, completion: @escaping (SdkResult<SetReceiptRulePositionOutput, SetReceiptRulePositionOutputError>) -> Void)
    /// <p>Creates a preview of the MIME content of an email when provided with a template and a
    ///             set of replacement data.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func testRenderTemplate(input: TestRenderTemplateInput, completion: @escaping (SdkResult<TestRenderTemplateOutput, TestRenderTemplateOutputError>) -> Void)
    ...
    ///             thresholds.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func updateAccountSendingEnabled(input: UpdateAccountSendingEnabledInput, completion: @escaping (SdkResult<UpdateAccountSendingEnabledOutput, UpdateAccountSendingEnabledOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func updateConfigurationSetReputationMetricsEnabled(input: UpdateConfigurationSetReputationMetricsEnabledInput, completion: @escaping (SdkResult<UpdateConfigurationSetReputationMetricsEnabledOutput, UpdateConfigurationSetReputationMetricsEnabledOutputError>) -> Void)
    ...
    ///             thresholds.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func updateConfigurationSetSendingEnabled(input: UpdateConfigurationSetSendingEnabledInput, completion: @escaping (SdkResult<UpdateConfigurationSetSendingEnabledOutput, UpdateConfigurationSetSendingEnabledOutputError>) -> Void)
    /// <p>Modifies an association between a configuration set and a custom domain for open and
    ///             click event tracking. </p>
    ///         <p>By default, images and links used for tracking open and click events are hosted on
    ///             domains operated by Amazon SES. You can configure a subdomain of your own to handle these
    ///             events. For information about using custom domains, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/configure-custom-open-click-domains.html">Amazon SES Developer Guide</a>.</p>
    func updateConfigurationSetTrackingOptions(input: UpdateConfigurationSetTrackingOptionsInput, completion: @escaping (SdkResult<UpdateConfigurationSetTrackingOptionsOutput, UpdateConfigurationSetTrackingOptionsOutputError>) -> Void)
    /// <p>Updates an existing custom verification email template.</p>
    ///         <p>For more information about custom verification email templates, see <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/custom-verification-emails.html">Using Custom Verification Email Templates</a> in the <i>Amazon SES Developer
    ///                 Guide</i>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func updateCustomVerificationEmailTemplate(input: UpdateCustomVerificationEmailTemplateInput, completion: @escaping (SdkResult<UpdateCustomVerificationEmailTemplateOutput, UpdateCustomVerificationEmailTemplateOutputError>) -> Void)
    /// <p>Updates a receipt rule.</p>
    ///         <p>For information about managing receipt rules, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rules.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func updateReceiptRule(input: UpdateReceiptRuleInput, completion: @escaping (SdkResult<UpdateReceiptRuleOutput, UpdateReceiptRuleOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func verifyDomainDkim(input: VerifyDomainDkimInput, completion: @escaping (SdkResult<VerifyDomainDkimOutput, VerifyDomainDkimOutputError>) -> Void)
    ...
    ///          </p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func verifyDomainIdentity(input: VerifyDomainIdentityInput, completion: @escaping (SdkResult<VerifyDomainIdentityOutput, VerifyDomainIdentityOutputError>) -> Void)
    /// <p>Deprecated. Use the <code>VerifyEmailIdentity</code> operation to verify a new email
    ///             address.</p>
    func verifyEmailAddress(input: VerifyEmailAddressInput, completion: @escaping (SdkResult<VerifyEmailAddressOutput, VerifyEmailAddressOutputError>) -> Void)
    /// <p>Adds an email address to the list of identities for your Amazon SES account in the current
    ///             AWS region and attempts to verify it. As a result of executing this operation, a
    ///             verification email is sent to the specified address.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func verifyEmailIdentity(input: VerifyEmailIdentityInput, completion: @escaping (SdkResult<VerifyEmailIdentityOutput, VerifyEmailIdentityOutputError>) -> Void)
}
