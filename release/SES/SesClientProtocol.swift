...
public protocol SesClientProtocol {
    ...
    func cloneReceiptRuleSet(input: CloneReceiptRuleSetInput, completion: @escaping (SdkResult<CloneReceiptRuleSetOutputResponse, CloneReceiptRuleSetOutputError>) -> Void)
    ...
    func createConfigurationSetTrackingOptions(input: CreateConfigurationSetTrackingOptionsInput, completion: @escaping (SdkResult<CreateConfigurationSetTrackingOptionsOutputResponse, CreateConfigurationSetTrackingOptionsOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func createReceiptFilter(input: CreateReceiptFilterInput, completion: @escaping (SdkResult<CreateReceiptFilterOutputResponse, CreateReceiptFilterOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func createReceiptRule(input: CreateReceiptRuleInput, completion: @escaping (SdkResult<CreateReceiptRuleOutputResponse, CreateReceiptRuleOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func createReceiptRuleSet(input: CreateReceiptRuleSetInput, completion: @escaping (SdkResult<CreateReceiptRuleSetOutputResponse, CreateReceiptRuleSetOutputError>) -> Void)
    ...
    ///         </note>
    func deleteConfigurationSetTrackingOptions(input: DeleteConfigurationSetTrackingOptionsInput, completion: @escaping (SdkResult<DeleteConfigurationSetTrackingOptionsOutputResponse, DeleteConfigurationSetTrackingOptionsOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteIdentity(input: DeleteIdentityInput, completion: @escaping (SdkResult<DeleteIdentityOutputResponse, DeleteIdentityOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteIdentityPolicy(input: DeleteIdentityPolicyInput, completion: @escaping (SdkResult<DeleteIdentityPolicyOutputResponse, DeleteIdentityPolicyOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteReceiptFilter(input: DeleteReceiptFilterInput, completion: @escaping (SdkResult<DeleteReceiptFilterOutputResponse, DeleteReceiptFilterOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteReceiptRule(input: DeleteReceiptRuleInput, completion: @escaping (SdkResult<DeleteReceiptRuleOutputResponse, DeleteReceiptRuleOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func deleteReceiptRuleSet(input: DeleteReceiptRuleSetInput, completion: @escaping (SdkResult<DeleteReceiptRuleSetOutputResponse, DeleteReceiptRuleSetOutputError>) -> Void)
    ...
    ///             and domains.</p>
    func deleteVerifiedEmailAddress(input: DeleteVerifiedEmailAddressInput, completion: @escaping (SdkResult<DeleteVerifiedEmailAddressOutputResponse, DeleteVerifiedEmailAddressOutputError>) -> Void)
    /// <p>Returns the metadata and receipt rules for the receipt rule set that is currently
    ///             active.</p>
    ///         <p>For information about setting up receipt rule sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-receipt-rule-set.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func describeActiveReceiptRuleSet(input: DescribeActiveReceiptRuleSetInput, completion: @escaping (SdkResult<DescribeActiveReceiptRuleSetOutputResponse, DescribeActiveReceiptRuleSetOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func describeConfigurationSet(input: DescribeConfigurationSetInput, completion: @escaping (SdkResult<DescribeConfigurationSetOutputResponse, DescribeConfigurationSetOutputError>) -> Void)
    /// <p>Returns the details of the specified receipt rule.</p>
    ///         <p>For information about setting up receipt rules, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-receipt-rules.html">Amazon SES Developer
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func describeReceiptRule(input: DescribeReceiptRuleInput, completion: @escaping (SdkResult<DescribeReceiptRuleOutputResponse, DescribeReceiptRuleOutputError>) -> Void)
    /// <p>Returns the details of the specified receipt rule set.</p>
    ///         <p>For information about managing receipt rule sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rule-sets.html">Amazon SES Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func describeReceiptRuleSet(input: DescribeReceiptRuleSetInput, completion: @escaping (SdkResult<DescribeReceiptRuleSetOutputResponse, DescribeReceiptRuleSetOutputError>) -> Void)
    /// <p>Returns the email sending status of the Amazon SES account for the current region.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func getAccountSendingEnabled(input: GetAccountSendingEnabledInput, completion: @escaping (SdkResult<GetAccountSendingEnabledOutputResponse, GetAccountSendingEnabledOutputError>) -> Void)
    ...
    func getIdentityDkimAttributes(input: GetIdentityDkimAttributesInput, completion: @escaping (SdkResult<GetIdentityDkimAttributesOutputResponse, GetIdentityDkimAttributesOutputError>) -> Void)
    ...
    func getIdentityMailFromDomainAttributes(input: GetIdentityMailFromDomainAttributesInput, completion: @escaping (SdkResult<GetIdentityMailFromDomainAttributesOutputResponse, GetIdentityMailFromDomainAttributesOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    func getIdentityNotificationAttributes(input: GetIdentityNotificationAttributesInput, completion: @escaping (SdkResult<GetIdentityNotificationAttributesOutputResponse, GetIdentityNotificationAttributesOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func getIdentityPolicies(input: GetIdentityPoliciesInput, completion: @escaping (SdkResult<GetIdentityPoliciesOutputResponse, GetIdentityPoliciesOutputError>) -> Void)
    ...
    ///             attributes for up to 100 identities at a time.</p>
    func getIdentityVerificationAttributes(input: GetIdentityVerificationAttributesInput, completion: @escaping (SdkResult<GetIdentityVerificationAttributesOutputResponse, GetIdentityVerificationAttributesOutputError>) -> Void)
    /// <p>Provides the sending limits for the Amazon SES account. </p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func getSendQuota(input: GetSendQuotaInput, completion: @escaping (SdkResult<GetSendQuotaOutputResponse, GetSendQuotaOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func getSendStatistics(input: GetSendStatisticsInput, completion: @escaping (SdkResult<GetSendStatisticsOutputResponse, GetSendStatisticsOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func listIdentityPolicies(input: ListIdentityPoliciesInput, completion: @escaping (SdkResult<ListIdentityPoliciesOutputResponse, ListIdentityPoliciesOutputError>) -> Void)
    /// <p>Lists the IP address filters associated with your AWS account in the current AWS
    ///             Region.</p>
    ///         <p>For information about managing IP address filters, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-ip-filters.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func listReceiptFilters(input: ListReceiptFiltersInput, completion: @escaping (SdkResult<ListReceiptFiltersOutputResponse, ListReceiptFiltersOutputError>) -> Void)
    ...
    ///         <p>For information about managing receipt rule sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rule-sets.html">Amazon SES Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func listReceiptRuleSets(input: ListReceiptRuleSetsInput, completion: @escaping (SdkResult<ListReceiptRuleSetsOutputResponse, ListReceiptRuleSetsOutputError>) -> Void)
    ...
    func listVerifiedEmailAddresses(input: ListVerifiedEmailAddressesInput, completion: @escaping (SdkResult<ListVerifiedEmailAddressesOutputResponse, ListVerifiedEmailAddressesOutputError>) -> Void)
    ...
    ///                 Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func putIdentityPolicy(input: PutIdentityPolicyInput, completion: @escaping (SdkResult<PutIdentityPolicyOutputResponse, PutIdentityPolicyOutputError>) -> Void)
    ...
    ///         <p>For information about managing receipt rule sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rule-sets.html">Amazon SES Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func reorderReceiptRuleSet(input: ReorderReceiptRuleSetInput, completion: @escaping (SdkResult<ReorderReceiptRuleSetOutputResponse, ReorderReceiptRuleSetOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func sendBounce(input: SendBounceInput, completion: @escaping (SdkResult<SendBounceOutputResponse, SendBounceOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func sendBulkTemplatedEmail(input: SendBulkTemplatedEmailInput, completion: @escaping (SdkResult<SendBulkTemplatedEmailOutputResponse, SendBulkTemplatedEmailOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func sendRawEmail(input: SendRawEmailInput, completion: @escaping (SdkResult<SendRawEmailOutputResponse, SendRawEmailOutputError>) -> Void)
    ...
    ///                     Developer Guide</i>.</p>
    ///         </important>
    func sendTemplatedEmail(input: SendTemplatedEmailInput, completion: @escaping (SdkResult<SendTemplatedEmailOutputResponse, SendTemplatedEmailOutputError>) -> Void)
    ...
    ///         <p>For information about managing receipt rule sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rule-sets.html">Amazon SES Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func setActiveReceiptRuleSet(input: SetActiveReceiptRuleSetInput, completion: @escaping (SdkResult<SetActiveReceiptRuleSetOutputResponse, SetActiveReceiptRuleSetOutputError>) -> Void)
    ...
    func setIdentityDkimEnabled(input: SetIdentityDkimEnabledInput, completion: @escaping (SdkResult<SetIdentityDkimEnabledOutputResponse, SetIdentityDkimEnabledOutputError>) -> Void)
    ...
    ///         <p>For more information about using notifications with Amazon SES, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/notifications.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    func setIdentityFeedbackForwardingEnabled(input: SetIdentityFeedbackForwardingEnabledInput, completion: @escaping (SdkResult<SetIdentityFeedbackForwardingEnabledOutputResponse, SetIdentityFeedbackForwardingEnabledOutputError>) -> Void)
    ...
    ///         <p>For more information about using notifications with Amazon SES, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/notifications.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    func setIdentityHeadersInNotificationsEnabled(input: SetIdentityHeadersInNotificationsEnabledInput, completion: @escaping (SdkResult<SetIdentityHeadersInNotificationsEnabledOutputResponse, SetIdentityHeadersInNotificationsEnabledOutputError>) -> Void)
    ...
    ///         </important>
    ///         <p>You can execute this operation no more than once per second.</p>
    func setIdentityMailFromDomain(input: SetIdentityMailFromDomainInput, completion: @escaping (SdkResult<SetIdentityMailFromDomainOutputResponse, SetIdentityMailFromDomainOutputError>) -> Void)
    ...
    ///             Guide</a>.</p>
    func setIdentityNotificationTopic(input: SetIdentityNotificationTopicInput, completion: @escaping (SdkResult<SetIdentityNotificationTopicOutputResponse, SetIdentityNotificationTopicOutputError>) -> Void)
    /// <p>Sets the position of the specified receipt rule in the receipt rule set.</p>
    ///         <p>For information about managing receipt rules, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rules.html">Amazon SES
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func setReceiptRulePosition(input: SetReceiptRulePositionInput, completion: @escaping (SdkResult<SetReceiptRulePositionOutputResponse, SetReceiptRulePositionOutputError>) -> Void)
    /// <p>Creates a preview of the MIME content of an email when provided with a template and a
    ///             set of replacement data.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func testRenderTemplate(input: TestRenderTemplateInput, completion: @escaping (SdkResult<TestRenderTemplateOutputResponse, TestRenderTemplateOutputError>) -> Void)
    ...
    ///             thresholds.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func updateAccountSendingEnabled(input: UpdateAccountSendingEnabledInput, completion: @escaping (SdkResult<UpdateAccountSendingEnabledOutputResponse, UpdateAccountSendingEnabledOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func updateConfigurationSetReputationMetricsEnabled(input: UpdateConfigurationSetReputationMetricsEnabledInput, completion: @escaping (SdkResult<UpdateConfigurationSetReputationMetricsEnabledOutputResponse, UpdateConfigurationSetReputationMetricsEnabledOutputError>) -> Void)
    ...
    ///             thresholds.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func updateConfigurationSetSendingEnabled(input: UpdateConfigurationSetSendingEnabledInput, completion: @escaping (SdkResult<UpdateConfigurationSetSendingEnabledOutputResponse, UpdateConfigurationSetSendingEnabledOutputError>) -> Void)
    /// <p>Modifies an association between a configuration set and a custom domain for open and
    ///             click event tracking. </p>
    ///         <p>By default, images and links used for tracking open and click events are hosted on
    ///             domains operated by Amazon SES. You can configure a subdomain of your own to handle these
    ///             events. For information about using custom domains, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/configure-custom-open-click-domains.html">Amazon SES Developer Guide</a>.</p>
    func updateConfigurationSetTrackingOptions(input: UpdateConfigurationSetTrackingOptionsInput, completion: @escaping (SdkResult<UpdateConfigurationSetTrackingOptionsOutputResponse, UpdateConfigurationSetTrackingOptionsOutputError>) -> Void)
    ...
    ///                 Developer Guide</a>.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func updateReceiptRule(input: UpdateReceiptRuleInput, completion: @escaping (SdkResult<UpdateReceiptRuleOutputResponse, UpdateReceiptRuleOutputError>) -> Void)
    ...
    ///         <p>You can execute this operation no more than once per second.</p>
    func verifyDomainDkim(input: VerifyDomainDkimInput, completion: @escaping (SdkResult<VerifyDomainDkimOutputResponse, VerifyDomainDkimOutputError>) -> Void)
    ...
    ///          </p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func verifyDomainIdentity(input: VerifyDomainIdentityInput, completion: @escaping (SdkResult<VerifyDomainIdentityOutputResponse, VerifyDomainIdentityOutputError>) -> Void)
    /// <p>Deprecated. Use the <code>VerifyEmailIdentity</code> operation to verify a new email
    ///             address.</p>
    func verifyEmailAddress(input: VerifyEmailAddressInput, completion: @escaping (SdkResult<VerifyEmailAddressOutputResponse, VerifyEmailAddressOutputError>) -> Void)
    /// <p>Adds an email address to the list of identities for your Amazon SES account in the current
    ///             AWS region and attempts to verify it. As a result of executing this operation, a
    ///             verification email is sent to the specified address.</p>
    ///         <p>You can execute this operation no more than once per second.</p>
    func verifyEmailIdentity(input: VerifyEmailIdentityInput, completion: @escaping (SdkResult<VerifyEmailIdentityOutputResponse, VerifyEmailIdentityOutputError>) -> Void)
}
