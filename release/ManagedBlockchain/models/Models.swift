...
extension ManagedBlockchainClientTypes {
    ...
    public struct ApprovalThresholdPolicy: Swift.Equatable {
        ...
        public let proposalDurationInHours: Swift.Int?
        ...
        public let thresholdComparator: ManagedBlockchainClientTypes.ThresholdComparator?
        ...
        public let thresholdPercentage: Swift.Int?
...
extension IllegalActionException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
/// <p></p>
public struct IllegalActionException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct Invitation: Swift.Equatable {
        ...
        public let networkSummary: ManagedBlockchainClientTypes.NetworkSummary?
        ...
        ///             </li>
        ///          </ul>
        public let status: ManagedBlockchainClientTypes.InvitationStatus?
...
public struct ListMembersInput: Swift.Equatable {
    ...
    public let status: ManagedBlockchainClientTypes.MemberStatus?
...
public struct ListNetworksInput: Swift.Equatable {
    ...
    ///          <p>Applies only to Hyperledger Fabric.</p>
    public let status: ManagedBlockchainClientTypes.NetworkStatus?
...
public struct ListNodesInput: Swift.Equatable {
    ...
    public let status: ManagedBlockchainClientTypes.NodeStatus?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct LogConfigurations: Swift.Equatable {
        ...
        public let cloudwatch: ManagedBlockchainClientTypes.LogConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct Member: Swift.Equatable {
        ...
        public let frameworkAttributes: ManagedBlockchainClientTypes.MemberFrameworkAttributes?
        /// <p>The unique identifier of the member.</p>
...
extension ManagedBlockchainClientTypes.MemberConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MemberConfiguration(description: \(Swift.String(describing: description)), frameworkConfiguration: \(Swift.String(describing: frameworkConfiguration)), logPublishingConfiguration: \(Swift.String(describing: logPublishingConfiguration)), name: \(Swift.String(describing: name)), tags: \(Swift.String(describing: tags)))"}
}
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberConfiguration: Swift.Equatable {
        ...
        public let frameworkConfiguration: ManagedBlockchainClientTypes.MemberFrameworkConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberFabricAttributes: Swift.Equatable {
        ...
        public let adminUsername: Swift.String?
        /// <p>The endpoint used to access the member's certificate authority.</p>
        public let caEndpoint: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberFabricConfiguration: Swift.Equatable {
        ...
        public let adminPassword: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberFabricLogPublishingConfiguration: Swift.Equatable {
        ...
        public let caLogs: ManagedBlockchainClientTypes.LogConfigurations?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberFrameworkAttributes: Swift.Equatable {
        ...
        public let fabric: ManagedBlockchainClientTypes.MemberFabricAttributes?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberFrameworkConfiguration: Swift.Equatable {
        ...
        public let fabric: ManagedBlockchainClientTypes.MemberFabricConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct MemberLogPublishingConfiguration: Swift.Equatable {
        /// <p>Configuration properties for logging events associated with a member of a Managed Blockchain network using the Hyperledger Fabric framework.</p>
        public let fabric: ManagedBlockchainClientTypes.MemberFabricLogPublishingConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct Network: Swift.Equatable {
        ...
        public let frameworkAttributes: ManagedBlockchainClientTypes.NetworkFrameworkAttributes?
        /// <p>The version of the blockchain framework that the network uses.</p>
        public let frameworkVersion: Swift.String?
        ...
        public let vpcEndpointServiceName: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NetworkFabricAttributes: Swift.Equatable {
        ...
        public let edition: ManagedBlockchainClientTypes.Edition?
        /// <p>The endpoint of the ordering service for the network.</p>
        public let orderingServiceEndpoint: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NetworkFrameworkAttributes: Swift.Equatable {
        ...
        public let ethereum: ManagedBlockchainClientTypes.NetworkEthereumAttributes?
        /// <p>Attributes of Hyperledger Fabric for a Managed Blockchain network that uses Hyperledger Fabric.</p>
        public let fabric: ManagedBlockchainClientTypes.NetworkFabricAttributes?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NetworkFrameworkConfiguration: Swift.Equatable {
        ...
        ///       </p>
        public let fabric: ManagedBlockchainClientTypes.NetworkFabricConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct Node: Swift.Equatable {
        ...
        public let frameworkAttributes: ManagedBlockchainClientTypes.NodeFrameworkAttributes?
        /// <p>The unique identifier of the node.</p>
        public let id: Swift.String?
        ...
        ///          <p>Applies only to Hyperledger Fabric.</p>
        public let stateDB: ManagedBlockchainClientTypes.StateDBType?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NodeEthereumAttributes: Swift.Equatable {
        ...
        public let httpEndpoint: Swift.String?
        ...
        public let webSocketEndpoint: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NodeFabricLogPublishingConfiguration: Swift.Equatable {
        ...
        public let chaincodeLogs: ManagedBlockchainClientTypes.LogConfigurations?
        ...
        public let peerLogs: ManagedBlockchainClientTypes.LogConfigurations?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NodeFrameworkAttributes: Swift.Equatable {
        ...
        public let ethereum: ManagedBlockchainClientTypes.NodeEthereumAttributes?
        /// <p>Attributes of Hyperledger Fabric for a peer node on a Managed Blockchain network that uses Hyperledger Fabric.</p>
        public let fabric: ManagedBlockchainClientTypes.NodeFabricAttributes?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct NodeLogPublishingConfiguration: Swift.Equatable {
        ...
        public let fabric: ManagedBlockchainClientTypes.NodeFabricLogPublishingConfiguration?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct Proposal: Swift.Equatable {
        ...
        ///       </p>
        public let noVoteCount: Swift.Int?
        /// <p>
        ...
        ///       </p>
        public let outstandingVoteCount: Swift.Int?
        /// <p>The unique identifier of the proposal.</p>
        public let proposalId: Swift.String?
        /// <p>The unique identifier of the member that created the proposal.</p>
        public let proposedByMemberId: Swift.String?
        /// <p>The name of the member that created the proposal.</p>
        public let proposedByMemberName: Swift.String?
        ...
        ///             </li>
        ///          </ul>
        public let status: ManagedBlockchainClientTypes.ProposalStatus?
        ...
        ///       </p>
        public let yesVoteCount: Swift.Int?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct ProposalActions: Swift.Equatable {
        ...
        ///       </p>
        public let invitations: [ManagedBlockchainClientTypes.InviteAction]?
        /// <p>
        ...
        ///       </p>
        public let removals: [ManagedBlockchainClientTypes.RemoveAction]?
...
extension ResourceNotReadyException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct ResourceNotReadyException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension ManagedBlockchainClientTypes {
    ...
    public struct VoteSummary: Swift.Equatable {
        ...
        ///       </p>
        public let memberName: Swift.String?
        /// <p>
...
extension ManagedBlockchainClientTypes {
    ...
    public struct VotingPolicy: Swift.Equatable {
        ...
        public let approvalThresholdPolicy: ManagedBlockchainClientTypes.ApprovalThresholdPolicy?
