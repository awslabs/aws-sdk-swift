...
public protocol ManagedBlockchainClientProtocol {
    ...
    ///          <p>Applies only to Hyperledger Fabric.</p>
    func createNetwork(input: CreateNetworkInput, completion: @escaping (SdkResult<CreateNetworkOutputResponse, CreateNetworkOutputError>) -> Void)
    /// <p>Creates a node on the specified blockchain network.</p>
    ///          <p>Applies to Hyperledger Fabric and Ethereum.</p>
    func createNode(input: CreateNodeInput, completion: @escaping (SdkResult<CreateNodeOutputResponse, CreateNodeOutputError>) -> Void)
    ...
    ///          <p>Applies only to Hyperledger Fabric.</p>
    func createProposal(input: CreateProposalInput, completion: @escaping (SdkResult<CreateProposalOutputResponse, CreateProposalOutputError>) -> Void)
    ...
    ///          <p>Applies to Hyperledger Fabric and Ethereum.</p>
    func deleteNode(input: DeleteNodeInput, completion: @escaping (SdkResult<DeleteNodeOutputResponse, DeleteNodeOutputError>) -> Void)
    ...
    ///          <p>Applies to Hyperledger Fabric and Ethereum.</p>
    func getNetwork(input: GetNetworkInput, completion: @escaping (SdkResult<GetNetworkOutputResponse, GetNetworkOutputError>) -> Void)
    /// <p>Returns detailed information about a node.</p>
    ///          <p>Applies to Hyperledger Fabric and Ethereum.</p>
    func getNode(input: GetNodeInput, completion: @escaping (SdkResult<GetNodeOutputResponse, GetNodeOutputError>) -> Void)
    /// <p>Returns detailed information about a proposal.</p>
    ///          <p>Applies only to Hyperledger Fabric.</p>
    func getProposal(input: GetProposalInput, completion: @escaping (SdkResult<GetProposalOutputResponse, GetProposalOutputError>) -> Void)
    ...
    ///          <p>Applies to Hyperledger Fabric and Ethereum.</p>
    func listNetworks(input: ListNetworksInput, completion: @escaping (SdkResult<ListNetworksOutputResponse, ListNetworksOutputError>) -> Void)
    ...
    ///          <p>Applies only to Hyperledger Fabric.</p>
    func listProposals(input: ListProposalsInput, completion: @escaping (SdkResult<ListProposalsOutputResponse, ListProposalsOutputError>) -> Void)
    ...
    ///          <p>Applies only to Hyperledger Fabric.</p>
    func listProposalVotes(input: ListProposalVotesInput, completion: @escaping (SdkResult<ListProposalVotesOutputResponse, ListProposalVotesOutputError>) -> Void)
    ...
    ///          <p>Applies only to Hyperledger Fabric.</p>
    func updateMember(input: UpdateMemberInput, completion: @escaping (SdkResult<UpdateMemberOutputResponse, UpdateMemberOutputError>) -> Void)
    /// <p>Updates a node configuration with new parameters.</p>
    ///          <p>Applies only to Hyperledger Fabric.</p>
    func updateNode(input: UpdateNodeInput, completion: @escaping (SdkResult<UpdateNodeOutputResponse, UpdateNodeOutputError>) -> Void)
    ...
    ///          <p>Applies only to Hyperledger Fabric.</p>
    func voteOnProposal(input: VoteOnProposalInput, completion: @escaping (SdkResult<VoteOnProposalOutputResponse, VoteOnProposalOutputError>) -> Void)
}
