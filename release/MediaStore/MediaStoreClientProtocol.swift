...
public protocol MediaStoreClientProtocol {
    ...
    func createContainer(input: CreateContainerInput, completion: @escaping (SdkResult<CreateContainerOutput, CreateContainerOutputError>) -> Void)
    ...
    func deleteContainer(input: DeleteContainerInput, completion: @escaping (SdkResult<DeleteContainerOutput, DeleteContainerOutputError>) -> Void)
    /// <p>Deletes the access policy that is associated with the specified container.</p>
    func deleteContainerPolicy(input: DeleteContainerPolicyInput, completion: @escaping (SdkResult<DeleteContainerPolicyOutput, DeleteContainerPolicyOutputError>) -> Void)
    ...
    func deleteCorsPolicy(input: DeleteCorsPolicyInput, completion: @escaping (SdkResult<DeleteCorsPolicyOutput, DeleteCorsPolicyOutputError>) -> Void)
    ...
    func deleteMetricPolicy(input: DeleteMetricPolicyInput, completion: @escaping (SdkResult<DeleteMetricPolicyOutput, DeleteMetricPolicyOutputError>) -> Void)
    ...
    func describeContainer(input: DescribeContainerInput, completion: @escaping (SdkResult<DescribeContainerOutput, DescribeContainerOutputError>) -> Void)
    ...
    ///             Guide</a>.</p>
    func getContainerPolicy(input: GetContainerPolicyInput, completion: @escaping (SdkResult<GetContainerPolicyOutput, GetContainerPolicyOutputError>) -> Void)
    ...
    func getCorsPolicy(input: GetCorsPolicyInput, completion: @escaping (SdkResult<GetCorsPolicyOutput, GetCorsPolicyOutputError>) -> Void)
    ...
    func getMetricPolicy(input: GetMetricPolicyInput, completion: @escaping (SdkResult<GetMetricPolicyOutput, GetMetricPolicyOutputError>) -> Void)
    ...
    ///          container. </p>
    func listContainers(input: ListContainersInput, completion: @escaping (SdkResult<ListContainersOutput, ListContainersOutputError>) -> Void)
    ...
    ///          policy. </p>
    func putContainerPolicy(input: PutContainerPolicyInput, completion: @escaping (SdkResult<PutContainerPolicyOutput, PutContainerPolicyOutputError>) -> Void)
    ...
    func putCorsPolicy(input: PutCorsPolicyInput, completion: @escaping (SdkResult<PutCorsPolicyOutput, PutCorsPolicyOutputError>) -> Void)
    ...
    func putMetricPolicy(input: PutMetricPolicyInput, completion: @escaping (SdkResult<PutMetricPolicyOutput, PutMetricPolicyOutputError>) -> Void)
    ...
    func startAccessLogging(input: StartAccessLoggingInput, completion: @escaping (SdkResult<StartAccessLoggingOutput, StartAccessLoggingOutputError>) -> Void)
    ...
    func stopAccessLogging(input: StopAccessLoggingInput, completion: @escaping (SdkResult<StopAccessLoggingOutput, StopAccessLoggingOutputError>) -> Void)
