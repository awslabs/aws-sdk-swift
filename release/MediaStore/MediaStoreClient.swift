...
public class MediaStoreClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try MediaStoreClientConfiguration(region: unwrappedRegion)
    ...
    public class MediaStoreClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("MediaStoreClient")
