...
extension CreateEnvironmentInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateEnvironmentInput(description: \(Swift.String(describing: description)), federationMode: \(Swift.String(describing: federationMode)), federationParameters: \(Swift.String(describing: federationParameters)), kmsKeyId: \(Swift.String(describing: kmsKeyId)), name: \(Swift.String(describing: name)), tags: \(Swift.String(describing: tags)))"}
}
...
extension FinspaceClientTypes {
    ...
    public struct Environment: Swift.Equatable {
        ...
        ///          environment.</p>
        public let dedicatedServiceAccountId: Swift.String?
        ...
        public let sageMakerStudioDomainUrl: Swift.String?
        /// <p>The current status of creation of the FinSpace environment.</p>
        public let status: FinspaceClientTypes.EnvironmentStatus?
...
extension FinspaceClientTypes {
    ...
    public struct FederationParameters: Swift.Equatable {
        ...
        ///        (IdP).</p>
        public let applicationCallBackURL: Swift.String?
        ...
        public let samlMetadataURL: Swift.String?
