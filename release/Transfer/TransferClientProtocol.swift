...
public protocol TransferClientProtocol {
    ...
    ///       ability.</p>
    func createAccess(input: CreateAccessInput, completion: @escaping (SdkResult<CreateAccessOutput, CreateAccessOutputError>) -> Void)
    ...
    func createServer(input: CreateServerInput, completion: @escaping (SdkResult<CreateServerOutput, CreateServerOutputError>) -> Void)
    ...
    func deleteAccess(input: DeleteAccessInput, completion: @escaping (SdkResult<DeleteAccessOutput, DeleteAccessOutputError>) -> Void)
    /// <p>Deletes the file transfer protocol-enabled server that you specify.</p>
    ///
    ///          <p>No response returns from this operation.</p>
    func deleteServer(input: DeleteServerInput, completion: @escaping (SdkResult<DeleteServerOutput, DeleteServerOutputError>) -> Void)
    ...
    func describeAccess(input: DescribeAccessInput, completion: @escaping (SdkResult<DescribeAccessOutput, DescribeAccessOutputError>) -> Void)
    ...
    ///         policies</a>.</p>
    func describeSecurityPolicy(input: DescribeSecurityPolicyInput, completion: @escaping (SdkResult<DescribeSecurityPolicyOutput, DescribeSecurityPolicyOutputError>) -> Void)
    ...
    func describeServer(input: DescribeServerInput, completion: @escaping (SdkResult<DescribeServerOutput, DescribeServerOutputError>) -> Void)
    ...
    func importSshPublicKey(input: ImportSshPublicKeyInput, completion: @escaping (SdkResult<ImportSshPublicKeyOutput, ImportSshPublicKeyOutputError>) -> Void)
    /// <p>Lists the details for all the accesses you have on your server.</p>
    func listAccesses(input: ListAccessesInput, completion: @escaping (SdkResult<ListAccessesOutput, ListAccessesOutputError>) -> Void)
    /// <p>Lists the security policies that are attached to your file transfer protocol-enabled
    ///       servers.</p>
    func listSecurityPolicies(input: ListSecurityPoliciesInput, completion: @escaping (SdkResult<ListSecurityPoliciesOutput, ListSecurityPoliciesOutputError>) -> Void)
    /// <p>Lists the file transfer protocol-enabled servers that are associated with your AWS
    ///       account.</p>
    func listServers(input: ListServersInput, completion: @escaping (SdkResult<ListServersOutput, ListServersOutputError>) -> Void)
    ...
    func startServer(input: StartServerInput, completion: @escaping (SdkResult<StartServerOutput, StartServerOutputError>) -> Void)
    ...
    ///
    ///          <p>No response is returned from this call.</p>
    func stopServer(input: StopServerInput, completion: @escaping (SdkResult<StopServerOutput, StopServerOutputError>) -> Void)
    ...
    ///       the service.</p>
    func testIdentityProvider(input: TestIdentityProviderInput, completion: @escaping (SdkResult<TestIdentityProviderOutput, TestIdentityProviderOutputError>) -> Void)
    ...
    ///       <code>ExternalID</code> parameters.</p>
    func updateAccess(input: UpdateAccessInput, completion: @escaping (SdkResult<UpdateAccessOutput, UpdateAccessOutputError>) -> Void)
    ...
    ///       updated.</p>
    func updateServer(input: UpdateServerInput, completion: @escaping (SdkResult<UpdateServerOutput, UpdateServerOutputError>) -> Void)
