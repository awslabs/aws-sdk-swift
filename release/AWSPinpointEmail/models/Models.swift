...
extension PinpointEmailClientTypes {
    ...
    public struct Body: Swift.Equatable {
        ...
        var html: PinpointEmailClientTypes.Content?
        /// An object that represents the version of the message that is displayed in email clients that don't support HTML, or clients where the recipient has disabled HTML rendering.
        var text: PinpointEmailClientTypes.Content?
...
extension PinpointEmailClientTypes {
    ...
    public struct CloudWatchDestination: Swift.Equatable {
        ...
        var dimensionConfigurations: [PinpointEmailClientTypes.CloudWatchDimensionConfiguration]?
...
extension PinpointEmailClientTypes {
    ...
    public struct CloudWatchDimensionConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var dimensionValueSource: PinpointEmailClientTypes.DimensionValueSource?
...
public struct CreateConfigurationSetEventDestinationInput: Swift.Equatable {
    ...
    /// This member is required.
    var eventDestination: PinpointEmailClientTypes.EventDestinationDefinition?
...
public struct CreateConfigurationSetInput: Swift.Equatable {
    ...
    var deliveryOptions: PinpointEmailClientTypes.DeliveryOptions?
    /// An object that defines whether or not Amazon Pinpoint collects reputation metrics for the emails that you send that use the configuration set.
    var reputationOptions: PinpointEmailClientTypes.ReputationOptions?
    /// An object that defines whether or not Amazon Pinpoint can send email that you send using the configuration set.
    var sendingOptions: PinpointEmailClientTypes.SendingOptions?
    /// An array of objects that define the tags (keys and values) that you want to associate with the configuration set.
    var tags: [PinpointEmailClientTypes.Tag]?
    /// An object that defines the open and click tracking options for emails that you send using the configuration set.
    var trackingOptions: PinpointEmailClientTypes.TrackingOptions?
...
public struct CreateDeliverabilityTestReportInput: Swift.Equatable {
    ...
    /// This member is required.
    var content: PinpointEmailClientTypes.EmailContent?
...
public struct CreateDeliverabilityTestReportOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var deliverabilityTestStatus: PinpointEmailClientTypes.DeliverabilityTestStatus?
...
public struct CreateEmailIdentityOutputResponse: Swift.Equatable {
    ...
    var dkimAttributes: PinpointEmailClientTypes.DkimAttributes?
    /// The email identity type.
    var identityType: PinpointEmailClientTypes.IdentityType?
...
extension PinpointEmailClientTypes {
    ...
    public struct DailyVolume: Swift.Equatable {
        ...
        var domainIspPlacements: [PinpointEmailClientTypes.DomainIspPlacement]?
        /// The date that the DailyVolume metrics apply to, in Unix time.
        var startDate: ClientRuntime.Date?
        /// An object that contains inbox placement metrics for a specific day in the analysis period.
        var volumeStatistics: PinpointEmailClientTypes.VolumeStatistics?
...
extension PinpointEmailClientTypes {
    ...
    public struct DedicatedIp: Swift.Equatable {
        ...
        /// This member is required.
        var warmupStatus: PinpointEmailClientTypes.WarmupStatus?
...
extension PinpointEmailClientTypes {
    ...
    public struct DeliveryOptions: Swift.Equatable {
        ...
        var tlsPolicy: PinpointEmailClientTypes.TlsPolicy?
...
extension PinpointEmailClientTypes {
    ...
    public struct DkimAttributes: Swift.Equatable {
        ...
        var status: PinpointEmailClientTypes.DkimStatus?
...
extension PinpointEmailClientTypes {
    ...
    public struct DomainDeliverabilityTrackingOption: Swift.Equatable {
        ...
        var inboxPlacementTrackingOption: PinpointEmailClientTypes.InboxPlacementTrackingOption?
...
extension PinpointEmailClientTypes {
    ...
    public struct EmailContent: Swift.Equatable {
        ...
        var raw: PinpointEmailClientTypes.RawMessage?
        /// The simple email message. The message consists of a subject and a message body.
        var simple: PinpointEmailClientTypes.Message?
        /// The template to use for the email message.
        var template: PinpointEmailClientTypes.Template?
...
extension PinpointEmailClientTypes {
    ...
    public struct EventDestination: Swift.Equatable {
        /// An object that defines an Amazon CloudWatch destination for email events. You can use Amazon CloudWatch to monitor and gain insights on your email sending metrics.
        var cloudWatchDestination: PinpointEmailClientTypes.CloudWatchDestination?
        ...
        var kinesisFirehoseDestination: PinpointEmailClientTypes.KinesisFirehoseDestination?
        /// The types of events that Amazon Pinpoint sends to the specified event destinations.
        /// This member is required.
        var matchingEventTypes: [PinpointEmailClientTypes.EventType]?
        /// A name that identifies the event destination.
        /// This member is required.
        var name: Swift.String?
        /// An object that defines a Amazon Pinpoint destination for email events. You can use Amazon Pinpoint events to create attributes in Amazon Pinpoint projects. You can use these attributes to create segments for your campaigns.
        var pinpointDestination: PinpointEmailClientTypes.PinpointDestination?
        /// An object that defines an Amazon SNS destination for email events. You can use Amazon SNS to send notification when certain email events occur.
        var snsDestination: PinpointEmailClientTypes.SnsDestination?
...
public struct GetAccountOutputResponse: Swift.Equatable {
    ...
    var sendQuota: PinpointEmailClientTypes.SendQuota?
...
public struct GetBlacklistReportsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var blacklistReport: [Swift.String:[PinpointEmailClientTypes.BlacklistEntry]]?
...
public struct GetConfigurationSetEventDestinationsOutputResponse: Swift.Equatable {
    ...
    var eventDestinations: [PinpointEmailClientTypes.EventDestination]?
...
public struct GetDedicatedIpOutputResponse: Swift.Equatable {
    ...
    var dedicatedIp: PinpointEmailClientTypes.DedicatedIp?
...
public struct GetDedicatedIpsOutputResponse: Swift.Equatable {
    ...
    var dedicatedIps: [PinpointEmailClientTypes.DedicatedIp]?
...
public struct GetDeliverabilityDashboardOptionsOutputResponse: Swift.Equatable {
    /// The current status of your Deliverability dashboard subscription. If this value is PENDING_EXPIRATION, your subscription is scheduled to expire at the end of the current calendar month.
    var accountStatus: PinpointEmailClientTypes.DeliverabilityDashboardAccountStatus?
    /// An array of objects, one for each verified domain that you use to send email and currently has an active Deliverability dashboard subscription that isn’t scheduled to expire at the end of the current calendar month.
    var activeSubscribedDomains: [PinpointEmailClientTypes.DomainDeliverabilityTrackingOption]?
    ...
    var pendingExpirationSubscribedDomains: [PinpointEmailClientTypes.DomainDeliverabilityTrackingOption]?
...
public struct GetDeliverabilityTestReportOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var deliverabilityTestReport: PinpointEmailClientTypes.DeliverabilityTestReport?
    /// An object that describes how the test email was handled by several email providers, including Gmail, Hotmail, Yahoo, AOL, and others.
    /// This member is required.
    var ispPlacements: [PinpointEmailClientTypes.IspPlacement]?
    /// An object that contains the message that you sent when you performed this predictive inbox placement test.
    var message: Swift.String?
    /// An object that specifies how many test messages that were sent during the predictive inbox placement test were delivered to recipients' inboxes, how many were sent to recipients' spam folders, and how many weren't delivered.
    /// This member is required.
    var overallPlacement: PinpointEmailClientTypes.PlacementStatistics?
...
public struct GetDomainDeliverabilityCampaignOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var domainDeliverabilityCampaign: PinpointEmailClientTypes.DomainDeliverabilityCampaign?
...
public struct GetDomainStatisticsReportOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var dailyVolumes: [PinpointEmailClientTypes.DailyVolume]?
    /// An object that contains deliverability metrics for the domain that you specified. The data in this object is a summary of all of the data that was collected from the StartDate to the EndDate.
    /// This member is required.
    var overallVolume: PinpointEmailClientTypes.OverallVolume?
...
public struct GetEmailIdentityOutputResponse: Swift.Equatable {
    ...
    var mailFromAttributes: PinpointEmailClientTypes.MailFromAttributes?
...
extension PinpointEmailClientTypes {
    ...
    public struct IspPlacement: Swift.Equatable {
        ...
        var placementStatistics: PinpointEmailClientTypes.PlacementStatistics?
...
public struct ListDeliverabilityTestReportsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var deliverabilityTestReports: [PinpointEmailClientTypes.DeliverabilityTestReport]?
...
public struct ListDomainDeliverabilityCampaignsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var domainDeliverabilityCampaigns: [PinpointEmailClientTypes.DomainDeliverabilityCampaign]?
...
public struct ListEmailIdentitiesOutputResponse: Swift.Equatable {
    ...
    var emailIdentities: [PinpointEmailClientTypes.IdentityInfo]?
...
extension PinpointEmailClientTypes {
    ...
    public struct MailFromAttributes: Swift.Equatable {
        ...
        /// This member is required.
        var behaviorOnMxFailure: PinpointEmailClientTypes.BehaviorOnMxFailure?
        ...
        /// This member is required.
        var mailFromDomainStatus: PinpointEmailClientTypes.MailFromDomainStatus?
...
extension PinpointEmailClientTypes {
    ...
    public struct Message: Swift.Equatable {
        ...
        /// This member is required.
        var body: PinpointEmailClientTypes.Body?
        ...
        /// This member is required.
        var subject: PinpointEmailClientTypes.Content?
...
public struct PutDeliverabilityDashboardOptionInput: Swift.Equatable {
    ...
    var subscribedDomains: [PinpointEmailClientTypes.DomainDeliverabilityTrackingOption]?
...
public struct SendEmailInput: Swift.Equatable {
    ...
    /// This member is required.
    var destination: PinpointEmailClientTypes.Destination?
    /// A list of tags, in the form of name/value pairs, to apply to an email that you send using the SendEmail operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.
    var emailTags: [PinpointEmailClientTypes.MessageTag]?
