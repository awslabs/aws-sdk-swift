...
public enum CancelQuantumTaskOutputError: Swift.Error, Equatable {
...
public enum CreateQuantumTaskOutputError: Swift.Error, Equatable {
    case accessDeniedException(AccessDeniedException)
...
public enum GetDeviceOutputError: Swift.Error, Equatable {
    case accessDeniedException(AccessDeniedException)
    case deviceOfflineException(DeviceOfflineException)
...
public enum GetQuantumTaskOutputError: Swift.Error, Equatable {
    case accessDeniedException(AccessDeniedException)
    case internalServiceException(InternalServiceException)
    case resourceNotFoundException(ResourceNotFoundException)
    case throttlingException(ThrottlingException)
...
public enum SearchDevicesOutputError: Swift.Error, Equatable {
    case accessDeniedException(AccessDeniedException)
    case internalServiceException(InternalServiceException)
    case throttlingException(ThrottlingException)
    case validationException(ValidationException)
...
public enum SearchQuantumTasksOutputError: Swift.Error, Equatable {
    case accessDeniedException(AccessDeniedException)
    case internalServiceException(InternalServiceException)
    case throttlingException(ThrottlingException)
    case validationException(ValidationException)
