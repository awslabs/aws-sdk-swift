...
extension BraketClient: BraketClientProtocol {
    ...
    public func cancelQuantumTask(input: CancelQuantumTaskInput, completion: @escaping (SdkResult<CancelQuantumTaskOutput, CancelQuantumTaskOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<CancelQuantumTaskInput, CancelQuantumTaskOutput, CancelQuantumTaskOutputError>(id: "cancelQuantumTask")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CancelQuantumTaskOutput>, SdkError<CancelQuantumTaskOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CancelQuantumTaskInput, CancelQuantumTaskOutput, CancelQuantumTaskOutputError>(contentType: "application/json"))
    ...
    public func createQuantumTask(input: CreateQuantumTaskInput, completion: @escaping (SdkResult<CreateQuantumTaskOutput, CreateQuantumTaskOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "braket")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateQuantumTaskInput, CreateQuantumTaskOutput, CreateQuantumTaskOutputError>(id: "createQuantumTask")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateQuantumTaskOutput>, SdkError<CreateQuantumTaskOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateQuantumTaskInput, CreateQuantumTaskOutput, CreateQuantumTaskOutputError>(contentType: "application/json"))
    ...
    public func getDevice(input: GetDeviceInput, completion: @escaping (SdkResult<GetDeviceOutput, GetDeviceOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetDeviceInput, GetDeviceOutput, GetDeviceOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getQuantumTask(input: GetQuantumTaskInput, completion: @escaping (SdkResult<GetQuantumTaskOutput, GetQuantumTaskOutputError>) -> Void)
    {
        guard let quantumTaskArn = input.quantumTaskArn else {
            completion(.failure(.client(ClientError.serializationFailed("uri component quantumTaskArn unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "braket")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetQuantumTaskInput, GetQuantumTaskOutput, GetQuantumTaskOutputError>(id: "getQuantumTask")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetQuantumTaskInput, GetQuantumTaskOutput, GetQuantumTaskOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func searchDevices(input: SearchDevicesInput, completion: @escaping (SdkResult<SearchDevicesOutput, SearchDevicesOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SearchDevicesInput, SearchDevicesOutput, SearchDevicesOutputError>(contentType: "application/json"))
    ...
    public func searchQuantumTasks(input: SearchQuantumTasksInput, completion: @escaping (SdkResult<SearchQuantumTasksOutput, SearchQuantumTasksOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "braket")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SearchQuantumTasksInput, SearchQuantumTasksOutput, SearchQuantumTasksOutputError>(id: "searchQuantumTasks")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SearchQuantumTasksInput, SearchQuantumTasksOutput, SearchQuantumTasksOutputError>(contentType: "application/json"))
