...
public struct BatchDeleteBuildsOutputResponse: Swift.Equatable {
    ...
    var buildsDeleted: [Swift.String]?
    /// Information about any builds that could not be successfully deleted.
    var buildsNotDeleted: [CodeBuildClientTypes.BuildNotDeleted]?
...
public struct BatchGetBuildBatchesOutputResponse: Swift.Equatable {
    ...
    var buildBatches: [CodeBuildClientTypes.BuildBatch]?
    /// An array that contains the identifiers of any batch builds that are not found.
    var buildBatchesNotFound: [Swift.String]?
...
public struct BatchGetBuildsOutputResponse: Swift.Equatable {
    ...
    var builds: [CodeBuildClientTypes.Build]?
    /// The IDs of builds for which information could not be found.
    var buildsNotFound: [Swift.String]?
...
public struct BatchGetProjectsOutputResponse: Swift.Equatable {
    ...
    var projects: [CodeBuildClientTypes.Project]?
    /// The names of build projects for which information could not be found.
    var projectsNotFound: [Swift.String]?
...
public struct BatchGetReportGroupsInput: Swift.Equatable {
    ...
    /// This member is required.
    var reportGroupArns: [Swift.String]?
...
public struct BatchGetReportGroupsOutputResponse: Swift.Equatable {
    ...
    var reportGroups: [CodeBuildClientTypes.ReportGroup]?
    /// An array of ARNs passed to BatchGetReportGroups that are not associated with a ReportGroup.
    var reportGroupsNotFound: [Swift.String]?
...
public struct BatchGetReportsOutputResponse: Swift.Equatable {
    ...
    var reports: [CodeBuildClientTypes.Report]?
    /// An array of ARNs passed to BatchGetReportGroups that are not associated with a Report.
    var reportsNotFound: [Swift.String]?
...
extension CodeBuildClientTypes {
    ...
    public struct BatchRestrictions: Swift.Equatable {
        ...
        var computeTypesAllowed: [Swift.String]?
        /// Specifies the maximum number of builds allowed.
        var maximumBuildsAllowed: Swift.Int?
...
extension CodeBuildClientTypes {
    ...
    public struct Build: Swift.Equatable {
        ...
        var artifacts: CodeBuildClientTypes.BuildArtifacts?
        /// The ARN of the batch build that this build is a member of, if applicable.
        var buildBatchArn: Swift.String?
        /// Whether the build is complete. True if complete; otherwise, false.
        var buildComplete: Swift.Bool
        /// The number of the build. For each project, the buildNumber of its first build is 1. The buildNumber of each subsequent build is incremented by 1. If a build is deleted, the buildNumber of other builds does not change.
        var buildNumber: Swift.Int?
        ...
        var buildStatus: CodeBuildClientTypes.StatusType?
        /// Information about the cache for the build.
        var cache: CodeBuildClientTypes.ProjectCache?
        /// The current build phase.
        var currentPhase: Swift.String?
        /// Contains information about the debug session for this build.
        var debugSession: CodeBuildClientTypes.DebugSession?
        ...
        var encryptionKey: Swift.String?
        /// When the build process ended, expressed in Unix time format.
        var endTime: ClientRuntime.Date?
        /// Information about the build environment for this build.
        var environment: CodeBuildClientTypes.ProjectEnvironment?
        ...
        var exportedEnvironmentVariables: [CodeBuildClientTypes.ExportedEnvironmentVariable]?
        /// An array of ProjectFileSystemLocation objects for a CodeBuild build project. A ProjectFileSystemLocation object specifies the identifier, location, mountOptions, mountPoint, and type of a file system created using Amazon Elastic File System.
        var fileSystemLocations: [CodeBuildClientTypes.ProjectFileSystemLocation]?
        ...
        var initiator: Swift.String?
        /// Information about the build's logs in CloudWatch Logs.
        var logs: CodeBuildClientTypes.LogsLocation?
        /// Describes a network interface.
        var networkInterface: CodeBuildClientTypes.NetworkInterface?
        /// Information about all previous build phases that are complete and information about any current build phase that is not yet complete.
        var phases: [CodeBuildClientTypes.BuildPhase]?
        /// The name of the CodeBuild project.
        var projectName: Swift.String?
        /// The number of minutes a build is allowed to be queued before it times out.
        var queuedTimeoutInMinutes: Swift.Int?
        ...
        var resolvedSourceVersion: Swift.String?
        /// An array of ProjectArtifacts objects.
        var secondaryArtifacts: [CodeBuildClientTypes.BuildArtifacts]?
        ...
        var secondarySourceVersions: [CodeBuildClientTypes.ProjectSourceVersion]?
        /// An array of ProjectSource objects.
        var secondarySources: [CodeBuildClientTypes.ProjectSource]?
        /// The name of a service role used for this build.
        var serviceRole: Swift.String?
        /// Information about the source code to be built.
        var source: CodeBuildClientTypes.ProjectSource?
        ...
        var sourceVersion: Swift.String?
        ...
        var timeoutInMinutes: Swift.Int?
        /// If your CodeBuild project accesses resources in an Amazon VPC, you provide this parameter that identifies the VPC ID and the list of security group IDs and subnet IDs. The security groups and subnets must belong to the same VPC. You must provide at least one security group and one subnet ID.
        var vpcConfig: CodeBuildClientTypes.VpcConfig?
...
extension CodeBuildClientTypes {
    ...
    public struct BuildArtifacts: Swift.Equatable {
        ...
        var artifactIdentifier: Swift.String?
        /// Specifies the bucket owner's access for objects that another account uploads to their Amazon S3 bucket. By default, only the account that uploads the objects to the bucket has access to these objects. This property allows you to give the bucket owner access to these objects. To use this property, your CodeBuild service role must have the s3:PutBucketAcl permission. This permission allows CodeBuild to modify the access control list for the bucket. This property can be one of the following values: NONE The bucket owner does not have access to the objects. This is the default. READ_ONLY The bucket owner has read-only access to the objects. The uploading account retains ownership of the objects. FULL The bucket owner has full access to the objects. Object ownership is determined by the following criteria:
        ///
        /// * If the bucket is configured with the Bucket owner preferred setting, the bucket owner owns the objects. The uploading account will have object access as specified by the bucket's policy.
        ///
        ...
        ///
        /// For more information about Amazon S3 object ownership, see [Controlling ownership of uploaded objects using S3 Object Ownership](https://docs.aws.amazon.com/AmazonS3/latest/userguide/about-object-ownership.html) in the Amazon Simple Storage Service User Guide.
        var bucketOwnerAccess: CodeBuildClientTypes.BucketOwnerAccess?
        /// Information that tells you if encryption for build artifacts is disabled.
        var encryptionDisabled: Swift.Bool?
        ...
        var md5sum: Swift.String?
        /// If this flag is set, a name specified in the buildspec file overrides the artifact name. The name specified in a buildspec file is calculated at build time and uses the Shell Command Language. For example, you can append a date and time to your artifact name so that it is always unique.
        var overrideArtifactName: Swift.Bool?
...
extension CodeBuildClientTypes {
    ...
    public struct BuildBatch: Swift.Equatable {
        ...
        var buildBatchConfig: CodeBuildClientTypes.ProjectBuildBatchConfig?
        ...
        var buildBatchNumber: Swift.Int?
        /// The status of the batch build.
        var buildBatchStatus: CodeBuildClientTypes.StatusType?
        /// An array of BuildGroup objects that define the build groups for the batch build.
        var buildGroups: [CodeBuildClientTypes.BuildGroup]?
        /// Specifies the maximum amount of time, in minutes, that the build in a batch must be completed in.
        var buildTimeoutInMinutes: Swift.Int?
        /// Information about the cache for the build project.
        var cache: CodeBuildClientTypes.ProjectCache?
        /// Indicates if the batch build is complete.
        var complete: Swift.Bool
        ...
        var debugSessionEnabled: Swift.Bool?
        ...
        var logConfig: CodeBuildClientTypes.LogsConfig?
        /// An array of BuildBatchPhase objects the specify the phases of the batch build.
        var phases: [CodeBuildClientTypes.BuildBatchPhase]?
...
extension CodeBuildClientTypes {
    ...
    public struct BuildBatchFilter: Swift.Equatable {
        ...
        var status: CodeBuildClientTypes.StatusType?
...
extension CodeBuildClientTypes {
    ...
    public struct BuildBatchPhase: Swift.Equatable {
        ...
        var contexts: [CodeBuildClientTypes.PhaseContext]?
        /// How long, in seconds, between the starting and ending times of the batch build's phase.
        var durationInSeconds: Swift.Int?
        ...
        var phaseStatus: CodeBuildClientTypes.StatusType?
        ...
        var phaseType: CodeBuildClientTypes.BuildBatchPhaseType?
...
extension CodeBuildClientTypes {
    ...
    public struct BuildGroup: Swift.Equatable {
        ...
        var currentBuildSummary: CodeBuildClientTypes.BuildSummary?
        /// An array of strings that contain the identifiers of the build groups that this build group depends on.
        var dependsOn: [Swift.String]?
        /// Contains the identifier of the build group.
        var identifier: Swift.String?
        /// Specifies if failures in this build group can be ignored.
        var ignoreFailure: Swift.Bool
        /// An array of BuildSummary objects that contain summaries of previous build groups.
        var priorBuildSummaryList: [CodeBuildClientTypes.BuildSummary]?
...
extension CodeBuildClientTypes {
    ...
    public struct BuildPhase: Swift.Equatable {
        ...
        var phaseType: CodeBuildClientTypes.BuildPhaseType?
...
extension CodeBuildClientTypes {
    ...
    public struct BuildSummary: Swift.Equatable {
        ...
        var primaryArtifact: CodeBuildClientTypes.ResolvedArtifact?
        /// When the build was started, expressed in Unix time format.
        var requestedOn: ClientRuntime.Date?
        /// An array of ResolvedArtifact objects that represents the secondary build artifacts for the build group.
        var secondaryArtifacts: [CodeBuildClientTypes.ResolvedArtifact]?
...
extension CodeBuildClientTypes {
    ...
    public struct CloudWatchLogsConfig: Swift.Equatable {
        ...
        /// This member is required.
        var status: CodeBuildClientTypes.LogsConfigStatusType?
...
extension CodeBuildClientTypes {
    ...
    public struct CodeCoverage: Swift.Equatable {
        ...
        var branchCoveragePercentage: Swift.Double?
        /// The number of conditional branches that are covered by your tests.
        var branchesCovered: Swift.Int?
        /// The number of conditional branches that are not covered by your tests.
        var branchesMissed: Swift.Int?
        /// The date and time that the tests were run.
        var expired: ClientRuntime.Date?
        /// The path of the test report file.
        var filePath: Swift.String?
        /// The identifier of the code coverage report.
        var id: Swift.String?
        /// The percentage of lines that are covered by your tests.
        var lineCoveragePercentage: Swift.Double?
        /// The number of lines that are covered by your tests.
        var linesCovered: Swift.Int?
        /// The number of lines that are not covered by your tests.
        var linesMissed: Swift.Int?
        /// The ARN of the report.
        var reportARN: Swift.String?
...
public struct CreateProjectInput: Swift.Equatable {
    ...
    /// This member is required.
    var artifacts: CodeBuildClientTypes.ProjectArtifacts?
    /// Set this to true to generate a publicly accessible URL for your project's build badge.
    var badgeEnabled: Swift.Bool?
    ...
    var concurrentBuildLimit: Swift.Int?
    ...
    var logsConfig: CodeBuildClientTypes.LogsConfig?
    ...
    var queuedTimeoutInMinutes: Swift.Int?
    /// An array of ProjectArtifacts objects.
    var secondaryArtifacts: [CodeBuildClientTypes.ProjectArtifacts]?
    ...
    var tags: [CodeBuildClientTypes.Tag]?
...
public struct CreateProjectOutputResponse: Swift.Equatable {
    ...
    var project: CodeBuildClientTypes.Project?
...
public struct CreateReportGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var exportConfig: CodeBuildClientTypes.ReportExportConfig?
    ...
    /// This member is required.
    var type: CodeBuildClientTypes.ReportType?
...
public struct CreateReportGroupOutputResponse: Swift.Equatable {
    ...
    var reportGroup: CodeBuildClientTypes.ReportGroup?
...
public struct CreateWebhookInput: Swift.Equatable {
    ...
    var branchFilter: Swift.String?
    /// Specifies the type of build this webhook will trigger.
    var buildType: CodeBuildClientTypes.WebhookBuildType?
    /// An array of arrays of WebhookFilter objects used to determine which webhooks are triggered. At least one WebhookFilter in the array must specify EVENT as its type. For a build to be triggered, at least one filter group in the filterGroups array must pass. For a filter group to pass, each of its filters must pass.
    var filterGroups: [[CodeBuildClientTypes.WebhookFilter]]?
    /// The name of the CodeBuild project.
    /// This member is required.
    var projectName: Swift.String?
...
public struct CreateWebhookOutputResponse: Swift.Equatable {
    ...
    var webhook: CodeBuildClientTypes.Webhook?
...
extension CodeBuildClientTypes {
    ...
    public struct DebugSession: Swift.Equatable {
        ...
        var sessionEnabled: Swift.Bool?
        /// Contains the identifier of the Session Manager session used for the build. To work with the paused build, you open this session to examine, control, and resume the build.
        var sessionTarget: Swift.String?
...
public struct DescribeCodeCoveragesInput: Swift.Equatable {
    ...
    var maxLineCoveragePercentage: Swift.Double?
    /// The maximum number of results to return.
    var maxResults: Swift.Int?
    /// The minimum line coverage percentage to report.
    var minLineCoveragePercentage: Swift.Double?
    ...
    var sortBy: CodeBuildClientTypes.ReportCodeCoverageSortByType?
    /// Specifies if the results are sorted in ascending or descending order.
    var sortOrder: CodeBuildClientTypes.SortOrderType?
...
public struct DescribeCodeCoveragesOutputResponse: Swift.Equatable {
    ...
    var codeCoverages: [CodeBuildClientTypes.CodeCoverage]?
...
public struct DescribeTestCasesInput: Swift.Equatable {
    ...
    var filter: CodeBuildClientTypes.TestCaseFilter?
...
public struct DescribeTestCasesOutputResponse: Swift.Equatable {
    ...
    var testCases: [CodeBuildClientTypes.TestCase]?
...
extension CodeBuildClientTypes {
    ...
    public struct EnvironmentLanguage: Swift.Equatable {
        ...
        var images: [CodeBuildClientTypes.EnvironmentImage]?
        /// The programming language for the Docker images.
        var language: CodeBuildClientTypes.LanguageType?
...
extension CodeBuildClientTypes {
    ...
    public struct EnvironmentPlatform: Swift.Equatable {
        ...
        var languages: [CodeBuildClientTypes.EnvironmentLanguage]?
        /// The platform's name.
        var platform: CodeBuildClientTypes.PlatformType?
...
extension CodeBuildClientTypes {
    ...
    public struct EnvironmentVariable: Swift.Equatable {
        ...
        var type: CodeBuildClientTypes.EnvironmentVariableType?
...
public struct GetReportGroupTrendInput: Swift.Equatable {
    ...
    var numOfReports: Swift.Int?
    /// The ARN of the report group that contains the reports to analyze.
    /// This member is required.
    var reportGroupArn: Swift.String?
    ...
    /// This member is required.
    var trendField: CodeBuildClientTypes.ReportGroupTrendFieldType?
...
public struct GetReportGroupTrendOutputResponse: Swift.Equatable {
    ...
    var rawData: [CodeBuildClientTypes.ReportWithRawData]?
    /// Contains the accumulated trend data.
    var stats: CodeBuildClientTypes.ReportGroupTrendStats?
...
extension CodeBuildClientTypes {
    ...
    public struct GitSubmodulesConfig: Swift.Equatable {
        ...
        /// This member is required.
        var fetchSubmodules: Swift.Bool?
...
public struct ImportSourceCredentialsInput: Swift.Equatable {
    ...
    /// This member is required.
    var authType: CodeBuildClientTypes.AuthType?
    /// The source provider used for this project.
    /// This member is required.
    var serverType: CodeBuildClientTypes.ServerType?
    /// Set to false to prevent overwriting the repository source credentials. Set to true to overwrite the repository source credentials. The default value is true.
    var shouldOverwrite: Swift.Bool?
...
public struct ListBuildBatchesForProjectInput: Swift.Equatable {
    ...
    var filter: CodeBuildClientTypes.BuildBatchFilter?
    /// The maximum number of results to return.
    var maxResults: Swift.Int?
...
public struct ListCuratedEnvironmentImagesOutputResponse: Swift.Equatable {
    ...
    var platforms: [CodeBuildClientTypes.EnvironmentPlatform]?
...
public struct ListProjectsInput: Swift.Equatable {
    ...
    var sortBy: CodeBuildClientTypes.ProjectSortByType?
...
public struct ListReportGroupsInput: Swift.Equatable {
    ...
    var sortBy: CodeBuildClientTypes.ReportGroupSortByType?
...
public struct ListReportsForReportGroupInput: Swift.Equatable {
    ...
    var filter: CodeBuildClientTypes.ReportFilter?
...
public struct ListSharedProjectsInput: Swift.Equatable {
    ...
    var sortBy: CodeBuildClientTypes.SharedResourceSortByType?
...
public struct ListSourceCredentialsOutputResponse: Swift.Equatable {
    ...
    var sourceCredentialsInfos: [CodeBuildClientTypes.SourceCredentialsInfo]?
...
extension CodeBuildClientTypes {
    ...
    public struct LogsConfig: Swift.Equatable {
        ...
        var cloudWatchLogs: CodeBuildClientTypes.CloudWatchLogsConfig?
        /// Information about logs built to an S3 bucket for a build project. S3 logs are not enabled by default.
        var s3Logs: CodeBuildClientTypes.S3LogsConfig?
...
extension CodeBuildClientTypes {
    ...
    public struct LogsLocation: Swift.Equatable {
        ...
        var cloudWatchLogsArn: Swift.String?
        /// The URL to an individual build log in CloudWatch Logs.
        var deepLink: Swift.String?
        /// The name of the CloudWatch Logs group for the build logs.
        var groupName: Swift.String?
        /// The URL to a build log in an S3 bucket.
        var s3DeepLink: Swift.String?
...
extension CodeBuildClientTypes {
    ...
    public struct NetworkInterface: Swift.Equatable {
        ...
        var networkInterfaceId: Swift.String?
        /// The ID of the subnet.
        var subnetId: Swift.String?
...
extension CodeBuildClientTypes {
    ...
    public struct Project: Swift.Equatable {
        ...
        var badge: CodeBuildClientTypes.ProjectBadge?
        /// A [ProjectBuildBatchConfig] object that defines the batch build options for the project.
        var buildBatchConfig: CodeBuildClientTypes.ProjectBuildBatchConfig?
        /// Information about the cache for the build project.
        var cache: CodeBuildClientTypes.ProjectCache?
        ...
        var created: ClientRuntime.Date?
        /// A description that makes the build project easy to identify.
        var description: Swift.String?
        ...
        var projectVisibility: CodeBuildClientTypes.ProjectVisibilityType?
        /// Contains the project identifier used with the public build APIs.
        var publicProjectAlias: Swift.String?
        /// The number of minutes a build is allowed to be queued before it times out.
        var queuedTimeoutInMinutes: Swift.Int?
        /// The ARN of the IAM role that enables CodeBuild to access the CloudWatch Logs and Amazon S3 artifacts for the project's builds.
        var resourceAccessRole: Swift.String?
        /// An array of ProjectArtifacts objects.
        var secondaryArtifacts: [CodeBuildClientTypes.ProjectArtifacts]?
...
extension CodeBuildClientTypes {
    ...
    public struct ProjectArtifacts: Swift.Equatable {
        ...
        var namespaceType: CodeBuildClientTypes.ArtifactNamespace?
        /// If this flag is set, a name specified in the buildspec file overrides the artifact name. The name specified in a buildspec file is calculated at build time and uses the Shell Command Language. For example, you can append a date and time to your artifact name so that it is always unique.
        var overrideArtifactName: Swift.Bool?
        ...
        var packaging: CodeBuildClientTypes.ArtifactPackaging?
        ...
        /// This member is required.
        var type: CodeBuildClientTypes.ArtifactsType?
...
extension CodeBuildClientTypes {
    ...
    public struct ProjectBadge: Swift.Equatable {
        ...
        var badgeRequestUrl: Swift.String?
...
extension CodeBuildClientTypes {
    ...
    public struct ProjectBuildBatchConfig: Swift.Equatable {
        ...
        var batchReportMode: CodeBuildClientTypes.BatchReportModeType?
        /// Specifies if the build artifacts for the batch build should be combined into a single artifact location.
        var combineArtifacts: Swift.Bool?
        /// A BatchRestrictions object that specifies the restrictions for the batch build.
        var restrictions: CodeBuildClientTypes.BatchRestrictions?
        /// Specifies the service role ARN for the batch build project.
        var serviceRole: Swift.String?
        /// Specifies the maximum amount of time, in minutes, that the batch build must be completed in.
        var timeoutInMins: Swift.Int?
...
extension CodeBuildClientTypes {
    ...
    public struct ProjectCache: Swift.Equatable {
        ...
        var modes: [CodeBuildClientTypes.CacheMode]?
        ...
        /// This member is required.
        var type: CodeBuildClientTypes.CacheType?
...
extension CodeBuildClientTypes {
    ...
    public struct ProjectEnvironment: Swift.Equatable {
        ...
        /// This member is required.
        var computeType: CodeBuildClientTypes.ComputeType?
        /// A set of environment variables to make available to builds for this build project.
        var environmentVariables: [CodeBuildClientTypes.EnvironmentVariable]?
        ...
        var imagePullCredentialsType: CodeBuildClientTypes.ImagePullCredentialsType?
        ...
        var privilegedMode: Swift.Bool?
        /// The credentials for access to a private registry.
        var registryCredential: CodeBuildClientTypes.RegistryCredential?
        ...
        /// For more information, see [Build environment compute types](https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-compute-types.html) in the CodeBuild user guide.
        /// This member is required.
        var type: CodeBuildClientTypes.EnvironmentType?
...
extension CodeBuildClientTypes {
    ...
    public struct ProjectFileSystemLocation: Swift.Equatable {
        ...
        var mountOptions: Swift.String?
        /// The location in the container where you mount the file system.
        var mountPoint: Swift.String?
        /// The type of the file system. The one supported type is EFS.
        var type: CodeBuildClientTypes.FileSystemType?
...
extension CodeBuildClientTypes {
    ...
    public struct ProjectSource: Swift.Equatable {
        ...
        var auth: CodeBuildClientTypes.SourceAuth?
        /// Contains information that defines how the build project reports the build status to the source provider. This option is only used when the source provider is GITHUB, GITHUB_ENTERPRISE, or BITBUCKET.
        var buildStatusConfig: CodeBuildClientTypes.BuildStatusConfig?
        ...
        var buildspec: Swift.String?
        /// Information about the Git clone depth for the build project.
        var gitCloneDepth: Swift.Int?
        /// Information about the Git submodules configuration for the build project.
        var gitSubmodulesConfig: CodeBuildClientTypes.GitSubmodulesConfig?
        /// Enable this flag to ignore SSL warnings while connecting to the project source code.
        var insecureSsl: Swift.Bool?
        ...
        var reportBuildStatus: Swift.Bool?
        ...
        /// This member is required.
        var type: CodeBuildClientTypes.SourceType?
...
extension CodeBuildClientTypes {
    ...
    public struct RegistryCredential: Swift.Equatable {
        ...
        /// This member is required.
        var credential: Swift.String?
        /// The service that created the credentials to access a private Docker registry. The valid value, SECRETS_MANAGER, is for Secrets Manager.
        /// This member is required.
        var credentialProvider: CodeBuildClientTypes.CredentialProviderType?
...
extension CodeBuildClientTypes {
    ...
    public struct Report: Swift.Equatable {
        ...
        var codeCoverageSummary: CodeBuildClientTypes.CodeCoverageReportSummary?
        /// The date and time this report run occurred.
        var created: ClientRuntime.Date?
        /// The ARN of the build run that generated this report.
        var executionId: Swift.String?
        ...
        var status: CodeBuildClientTypes.ReportStatusType?
        /// A TestReportSummary object that contains information about this test report.
        var testSummary: CodeBuildClientTypes.TestReportSummary?
        /// A boolean that specifies if this report run is truncated. The list of test cases is truncated after the maximum number of test cases is reached.
        var truncated: Swift.Bool?
...
extension CodeBuildClientTypes {
    ...
    public struct ReportExportConfig: Swift.Equatable {
        ...
        var exportConfigType: CodeBuildClientTypes.ReportExportConfigType?
        /// A S3ReportExportConfig object that contains information about the S3 bucket where the run of a report is exported.
        var s3Destination: CodeBuildClientTypes.S3ReportExportConfig?
...
extension CodeBuildClientTypes {
    ...
    public struct ReportGroup: Swift.Equatable {
        ...
        var status: CodeBuildClientTypes.ReportGroupStatusType?
        /// A list of tag key and value pairs associated with this report group. These tags are available for use by Amazon Web Services services that support CodeBuild report group tags.
        var tags: [CodeBuildClientTypes.Tag]?
...
extension CodeBuildClientTypes {
    ...
    public struct ReportGroupTrendStats: Swift.Equatable {
        ...
        var average: Swift.String?
        /// Contains the maximum value analyzed.
        var max: Swift.String?
        /// Contains the minimum value analyzed.
        var min: Swift.String?
...
public struct RetryBuildBatchInput: Swift.Equatable {
    ...
    var idempotencyToken: Swift.String?
    /// Specifies the type of retry to perform.
    var retryType: CodeBuildClientTypes.RetryBuildBatchType?
...
public struct RetryBuildBatchOutputResponse: Swift.Equatable {
    /// Contains information about a batch build.
    var buildBatch: CodeBuildClientTypes.BuildBatch?
...
public struct RetryBuildOutputResponse: Swift.Equatable {
    /// Information about a build.
    var build: CodeBuildClientTypes.Build?
...
extension CodeBuildClientTypes {
    ...
    public struct S3ReportExportConfig: Swift.Equatable {
        ...
        var packaging: CodeBuildClientTypes.ReportPackagingType?
...
extension CodeBuildClientTypes {
    ...
    public struct SourceAuth: Swift.Equatable {
        ...
        /// This member is required.
        var type: CodeBuildClientTypes.SourceAuthType?
...
public struct StartBuildBatchInput: Swift.Equatable {
    ...
    var artifactsOverride: CodeBuildClientTypes.ProjectArtifacts?
    /// A BuildBatchConfigOverride object that contains batch build configuration overrides.
    var buildBatchConfigOverride: CodeBuildClientTypes.ProjectBuildBatchConfig?
    /// Overrides the build timeout specified in the batch build project.
    var buildTimeoutInMinutesOverride: Swift.Int?
    ...
    var buildspecOverride: Swift.String?
    /// A ProjectCache object that specifies cache overrides.
    var cacheOverride: CodeBuildClientTypes.ProjectCache?
    /// The name of a certificate for this batch build that overrides the one specified in the batch build project.
    var certificateOverride: Swift.String?
    /// The name of a compute type for this batch build that overrides the one specified in the batch build project.
    var computeTypeOverride: CodeBuildClientTypes.ComputeType?
    /// Specifies if session debugging is enabled for this batch build. For more information, see [Viewing a running build in Session Manager](https://docs.aws.amazon.com/codebuild/latest/userguide/session-manager.html). Batch session debugging is not supported for matrix batch builds.
    var debugSessionEnabled: Swift.Bool?
    ...
    var encryptionKeyOverride: Swift.String?
    /// A container type for this batch build that overrides the one specified in the batch build project.
    var environmentTypeOverride: CodeBuildClientTypes.EnvironmentType?
    ...
    var environmentVariablesOverride: [CodeBuildClientTypes.EnvironmentVariable]?
    /// The user-defined depth of history, with a minimum value of 0, that overrides, for this batch build only, any previous depth of history defined in the batch build project.
    var gitCloneDepthOverride: Swift.Int?
    /// A GitSubmodulesConfig object that overrides the Git submodules configuration for this batch build.
    var gitSubmodulesConfigOverride: CodeBuildClientTypes.GitSubmodulesConfig?
    ...
    var imageOverride: Swift.String?
    ...
    var imagePullCredentialsTypeOverride: CodeBuildClientTypes.ImagePullCredentialsType?
    /// Enable this flag to override the insecure SSL setting that is specified in the batch build project. The insecure SSL setting determines whether to ignore SSL warnings while connecting to the project source code. This override applies only if the build's source is GitHub Enterprise.
    var insecureSslOverride: Swift.Bool?
    /// A LogsConfig object that override the log settings defined in the batch build project.
    var logsConfigOverride: CodeBuildClientTypes.LogsConfig?
    /// Enable this flag to override privileged mode in the batch build project.
    var privilegedModeOverride: Swift.Bool?
    /// The name of the project.
    /// This member is required.
    var projectName: Swift.String?
    /// The number of minutes a batch build is allowed to be queued before it times out.
    var queuedTimeoutInMinutesOverride: Swift.Int?
    /// A RegistryCredential object that overrides credentials for access to a private registry.
    var registryCredentialOverride: CodeBuildClientTypes.RegistryCredential?
    ...
    var sourceAuthOverride: CodeBuildClientTypes.SourceAuth?
    /// A location that overrides, for this batch build, the source location defined in the batch build project.
    var sourceLocationOverride: Swift.String?
    /// The source input type that overrides the source input defined in the batch build project.
    var sourceTypeOverride: CodeBuildClientTypes.SourceType?
...
public struct StartBuildInput: Swift.Equatable {
    ...
    var artifactsOverride: CodeBuildClientTypes.ProjectArtifacts?
    /// Contains information that defines how the build project reports the build status to the source provider. This option is only used when the source provider is GITHUB, GITHUB_ENTERPRISE, or BITBUCKET.
    var buildStatusConfigOverride: CodeBuildClientTypes.BuildStatusConfig?
    /// A buildspec file declaration that overrides, for this build only, the latest one already defined in the build project. If this value is set, it can be either an inline buildspec definition, the path to an alternate buildspec file relative to the value of the built-in CODEBUILD_SRC_DIR environment variable, or the path to an S3 bucket. The bucket must be in the same Amazon Web Services Region as the build project. Specify the buildspec file using its ARN (for example, arn:aws:s3:::my-codebuild-sample2/buildspec.yml). If this value is not provided or is set to an empty string, the source code must contain a buildspec file in its root directory. For more information, see [Buildspec File Name and Storage Location](https://docs.aws.amazon.com/codebuild/latest/userguide/build-spec-ref.html#build-spec-ref-name-storage).
    var buildspecOverride: Swift.String?
    ...
    var reportBuildStatusOverride: Swift.Bool?
    /// An array of ProjectArtifacts objects.
    var secondaryArtifactsOverride: [CodeBuildClientTypes.ProjectArtifacts]?
    /// An array of ProjectSource objects.
    var secondarySourcesOverride: [CodeBuildClientTypes.ProjectSource]?
    ...
    var timeoutInMinutesOverride: Swift.Int?
...
extension CodeBuildClientTypes {
    ...
    public struct TestCase: Swift.Equatable {
        ...
        var durationInNanoSeconds: Swift.Int?
        ...
        var testRawDataPath: Swift.String?
...
extension CodeBuildClientTypes {
    ...
    public struct TestReportSummary: Swift.Equatable {
        ...
        /// This member is required.
        var statusCounts: [Swift.String:Swift.Int]?
...
extension CodeBuildClientTypes {
    ...
    public struct WebhookFilter: Swift.Equatable {
        ...
        var excludeMatchedPattern: Swift.Bool?
        ...
        /// This member is required.
        var type: CodeBuildClientTypes.WebhookFilterType?
