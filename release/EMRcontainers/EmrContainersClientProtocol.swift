...
public protocol EmrContainersClientProtocol {
    ...
    func cancelJobRun(input: CancelJobRunInput, completion: @escaping (SdkResult<CancelJobRunOutputResponse, CancelJobRunOutputError>) -> Void)
    ...
    func createManagedEndpoint(input: CreateManagedEndpointInput, completion: @escaping (SdkResult<CreateManagedEndpointOutputResponse, CreateManagedEndpointOutputError>) -> Void)
    ...
    func createVirtualCluster(input: CreateVirtualClusterInput, completion: @escaping (SdkResult<CreateVirtualClusterOutputResponse, CreateVirtualClusterOutputError>) -> Void)
    ...
    func deleteManagedEndpoint(input: DeleteManagedEndpointInput, completion: @escaping (SdkResult<DeleteManagedEndpointOutputResponse, DeleteManagedEndpointOutputError>) -> Void)
    /// <p>Deletes a virtual cluster. Virtual cluster is a managed entity on Amazon EMR on EKS. You can create, describe, list and delete virtual clusters. They do not consume any additional resource in your system. A single virtual cluster maps to a single Kubernetes namespace. Given this relationship, you can model virtual clusters the same way you model Kubernetes namespaces to meet your requirements.</p>
    func deleteVirtualCluster(input: DeleteVirtualClusterInput, completion: @escaping (SdkResult<DeleteVirtualClusterOutputResponse, DeleteVirtualClusterOutputError>) -> Void)
    ...
    func describeManagedEndpoint(input: DescribeManagedEndpointInput, completion: @escaping (SdkResult<DescribeManagedEndpointOutputResponse, DescribeManagedEndpointOutputError>) -> Void)
    /// <p>Displays detailed information about a specified virtual cluster. Virtual cluster is a managed entity on Amazon EMR on EKS. You can create, describe, list and delete virtual clusters. They do not consume any additional resource in your system. A single virtual cluster maps to a single Kubernetes namespace. Given this relationship, you can model virtual clusters the same way you model Kubernetes namespaces to meet your requirements.</p>
    func describeVirtualCluster(input: DescribeVirtualClusterInput, completion: @escaping (SdkResult<DescribeVirtualClusterOutputResponse, DescribeVirtualClusterOutputError>) -> Void)
    ...
    func listManagedEndpoints(input: ListManagedEndpointsInput, completion: @escaping (SdkResult<ListManagedEndpointsOutputResponse, ListManagedEndpointsOutputError>) -> Void)
    ...
    func listVirtualClusters(input: ListVirtualClustersInput, completion: @escaping (SdkResult<ListVirtualClustersOutputResponse, ListVirtualClustersOutputError>) -> Void)
