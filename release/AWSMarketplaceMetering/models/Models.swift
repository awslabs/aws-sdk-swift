...
public struct BatchMeterUsageInput: Swift.Equatable {
    ...
    var productCode: Swift.String?
    /// The set of UsageRecords to submit. BatchMeterUsage accepts up to 25 UsageRecords at a time.
    /// This member is required.
    var usageRecords: [MarketplaceMeteringClientTypes.UsageRecord]?
...
public struct BatchMeterUsageOutputResponse: Swift.Equatable {
    ...
    var results: [MarketplaceMeteringClientTypes.UsageRecordResult]?
    /// Contains all UsageRecords that were not processed by BatchMeterUsage. This is a list of UsageRecords. You can retry the failed request by making another BatchMeterUsage call with this list as input in the BatchMeterUsageRequest.
    var unprocessedRecords: [MarketplaceMeteringClientTypes.UsageRecord]?
...
public struct MeterUsageInput: Swift.Equatable {
    ...
    var usageAllocations: [MarketplaceMeteringClientTypes.UsageAllocation]?
    /// It will be one of the fcp dimension name provided during the publishing of the product.
    /// This member is required.
    var usageDimension: Swift.String?
    /// Consumption value for the hour. Defaults to 0 if not specified.
    var usageQuantity: Swift.Int?
...
public struct MeterUsageOutputResponse: Swift.Equatable {
    /// Metering record id.
    var meteringRecordId: Swift.String?
...
public struct RegisterUsageInput: Swift.Equatable {
    ...
    /// This member is required.
    var publicKeyVersion: Swift.Int?
...
public struct RegisterUsageOutputResponse: Swift.Equatable {
    ...
    var publicKeyRotationTimestamp: ClientRuntime.Date?
    /// JWT Token
...
public struct ResolveCustomerInput: Swift.Equatable {
    ...
    /// This member is required.
    var registrationToken: Swift.String?
...
public struct ResolveCustomerOutputResponse: Swift.Equatable {
    ...
    var customerIdentifier: Swift.String?
...
extension MarketplaceMeteringClientTypes {
    ...
    public struct UsageAllocation: Swift.Equatable {
        ...
        /// This member is required.
        var allocatedUsageQuantity: Swift.Int?
        /// The set of tags that define the bucket of usage. For the bucket of items with no tags, this parameter can be left out.
        var tags: [MarketplaceMeteringClientTypes.Tag]?
...
extension MarketplaceMeteringClientTypes {
    ...
    public struct UsageRecord: Swift.Equatable {
        ...
        /// This member is required.
        var dimension: Swift.String?
        /// The quantity of usage consumed by the customer for the given dimension and time. Defaults to 0 if not specified.
        var quantity: Swift.Int?
        /// Timestamp, in UTC, for which the usage is being reported. Your application can meter usage for up to one hour in the past. Make sure the timestamp value is not before the start of the software usage.
        /// This member is required.
        var timestamp: ClientRuntime.Date?
...
extension MarketplaceMeteringClientTypes {
    ...
    public struct UsageRecordResult: Swift.Equatable {
        ...
        var status: MarketplaceMeteringClientTypes.UsageRecordResultStatus?
        /// The UsageRecord that was part of the BatchMeterUsage request.
        var usageRecord: MarketplaceMeteringClientTypes.UsageRecord?
