...
public struct BatchMeterUsageInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchMeterUsageInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<BatchMeterUsageInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<BatchMeterUsageOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<BatchMeterUsageInput>
    public typealias MOutput = ClientRuntime.OperationOutput<BatchMeterUsageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchMeterUsageOutputError>
}

extension BatchMeterUsageInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchMeterUsageInput(productCode: \(Swift.String(describing: productCode)), usageRecords: \(Swift.String(describing: usageRecords)))"}
}

extension BatchMeterUsageInput: Swift.Encodable, ClientRuntime.Reflection {
...
public struct BatchMeterUsageInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchMeterUsageInputHeadersMiddleware"
...
public struct BatchMeterUsageInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchMeterUsageInputQueryItemMiddleware"
...
public struct BatchMeterUsageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchMeterUsageInputURLHostMiddleware"
    ...
    public typealias MInput = BatchMeterUsageInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchMeterUsageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchMeterUsageOutputError>
}

public struct BatchMeterUsageInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchMeterUsageInputURLPathMiddleware"
...
struct BatchMeterUsageInputBody: Swift.Equatable {
    public let usageRecords: [MarketplaceMeteringClientTypes.UsageRecord]?
...
extension BatchMeterUsageOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchMeterUsageOutputResponse(results: \(Swift.String(describing: results)), unprocessedRecords: \(Swift.String(describing: unprocessedRecords)))"}
}
...
struct BatchMeterUsageOutputResponseBody: Swift.Equatable {
    public let results: [MarketplaceMeteringClientTypes.UsageRecordResult]?
    public let unprocessedRecords: [MarketplaceMeteringClientTypes.UsageRecord]?
}
...
extension CustomerNotEntitledException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CustomerNotEntitledException(message: \(Swift.String(describing: message)))"}
}
...
extension DisabledApiException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DisabledApiException(message: \(Swift.String(describing: message)))"}
}
...
extension InvalidCustomerIdentifierException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidCustomerIdentifierException(message: \(Swift.String(describing: message)))"}
}
...
extension InvalidEndpointRegionException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidEndpointRegionException(message: \(Swift.String(describing: message)))"}
}
...
extension InvalidProductCodeException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidProductCodeException(message: \(Swift.String(describing: message)))"}
}
...
extension InvalidPublicKeyVersionException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidPublicKeyVersionException(message: \(Swift.String(describing: message)))"}
}
...
extension InvalidRegionException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidRegionException(message: \(Swift.String(describing: message)))"}
}
...
extension InvalidUsageAllocationsException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidUsageAllocationsException(message: \(Swift.String(describing: message)))"}
}
...
extension InvalidUsageDimensionException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidUsageDimensionException(message: \(Swift.String(describing: message)))"}
}
...
public struct MeterUsageInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MeterUsageInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<MeterUsageInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<MeterUsageOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<MeterUsageInput>
    public typealias MOutput = ClientRuntime.OperationOutput<MeterUsageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<MeterUsageOutputError>
}

extension MeterUsageInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MeterUsageInput(dryRun: \(Swift.String(describing: dryRun)), productCode: \(Swift.String(describing: productCode)), timestamp: \(Swift.String(describing: timestamp)), usageAllocations: \(Swift.String(describing: usageAllocations)), usageDimension: \(Swift.String(describing: usageDimension)), usageQuantity: \(Swift.String(describing: usageQuantity)))"}
}

extension MeterUsageInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case dryRun = "DryRun"
        case productCode = "ProductCode"
...
public struct MeterUsageInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MeterUsageInputHeadersMiddleware"
...
public struct MeterUsageInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MeterUsageInputQueryItemMiddleware"
...
public struct MeterUsageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MeterUsageInputURLHostMiddleware"
    ...
    public typealias MInput = MeterUsageInput
    public typealias MOutput = ClientRuntime.OperationOutput<MeterUsageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<MeterUsageOutputError>
}

public struct MeterUsageInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MeterUsageInputURLPathMiddleware"
...
struct MeterUsageInputBody: Swift.Equatable {
    ...
    public let usageDimension: Swift.String?
    public let usageQuantity: Swift.Int?
    public let dryRun: Swift.Bool?
    public let usageAllocations: [MarketplaceMeteringClientTypes.UsageAllocation]?
}
...
extension MeterUsageOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MeterUsageOutputResponse(meteringRecordId: \(Swift.String(describing: meteringRecordId)))"}
}
...
struct MeterUsageOutputResponseBody: Swift.Equatable {
    public let meteringRecordId: Swift.String?
}
...
extension PlatformNotSupportedException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PlatformNotSupportedException(message: \(Swift.String(describing: message)))"}
}
...
public struct RegisterUsageInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterUsageInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<RegisterUsageInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<RegisterUsageOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<RegisterUsageInput>
    public typealias MOutput = ClientRuntime.OperationOutput<RegisterUsageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RegisterUsageOutputError>
}

extension RegisterUsageInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RegisterUsageInput(nonce: \(Swift.String(describing: nonce)), productCode: \(Swift.String(describing: productCode)), publicKeyVersion: \(Swift.String(describing: publicKeyVersion)))"}
}

extension RegisterUsageInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case nonce = "Nonce"
        case productCode = "ProductCode"
...
public struct RegisterUsageInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterUsageInputHeadersMiddleware"
...
public struct RegisterUsageInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterUsageInputQueryItemMiddleware"
...
public struct RegisterUsageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterUsageInputURLHostMiddleware"
    ...
    public typealias MInput = RegisterUsageInput
    public typealias MOutput = ClientRuntime.OperationOutput<RegisterUsageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RegisterUsageOutputError>
}

public struct RegisterUsageInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterUsageInputURLPathMiddleware"
...
struct RegisterUsageInputBody: Swift.Equatable {
    public let productCode: Swift.String?
    public let publicKeyVersion: Swift.Int?
...
extension RegisterUsageOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RegisterUsageOutputResponse(publicKeyRotationTimestamp: \(Swift.String(describing: publicKeyRotationTimestamp)), signature: \(Swift.String(describing: signature)))"}
}
...
struct RegisterUsageOutputResponseBody: Swift.Equatable {
    public let publicKeyRotationTimestamp: ClientRuntime.Date?
...
public struct ResolveCustomerInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ResolveCustomerInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ResolveCustomerInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ResolveCustomerOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ResolveCustomerInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ResolveCustomerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ResolveCustomerOutputError>
}

extension ResolveCustomerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResolveCustomerInput(registrationToken: \(Swift.String(describing: registrationToken)))"}
}

extension ResolveCustomerInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ResolveCustomerInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ResolveCustomerInputHeadersMiddleware"
...
public struct ResolveCustomerInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ResolveCustomerInputQueryItemMiddleware"
...
public struct ResolveCustomerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ResolveCustomerInputURLHostMiddleware"
    ...
    public typealias MInput = ResolveCustomerInput
    public typealias MOutput = ClientRuntime.OperationOutput<ResolveCustomerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ResolveCustomerOutputError>
}

public struct ResolveCustomerInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ResolveCustomerInputURLPathMiddleware"
...
extension ResolveCustomerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResolveCustomerOutputResponse(customerIdentifier: \(Swift.String(describing: customerIdentifier)), productCode: \(Swift.String(describing: productCode)))"}
}
...
extension MarketplaceMeteringClientTypes.Tag: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
...
extension MarketplaceMeteringClientTypes.Tag: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension TimestampOutOfBoundsException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TimestampOutOfBoundsException(message: \(Swift.String(describing: message)))"}
}
...
extension MarketplaceMeteringClientTypes.UsageAllocation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MarketplaceMeteringClientTypes.UsageAllocation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UsageAllocation(allocatedUsageQuantity: \(Swift.String(describing: allocatedUsageQuantity)), tags: \(Swift.String(describing: tags)))"}
}
...
extension MarketplaceMeteringClientTypes.UsageRecord: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case customerIdentifier = "CustomerIdentifier"
...
extension MarketplaceMeteringClientTypes.UsageRecord: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UsageRecord(customerIdentifier: \(Swift.String(describing: customerIdentifier)), dimension: \(Swift.String(describing: dimension)), quantity: \(Swift.String(describing: quantity)), timestamp: \(Swift.String(describing: timestamp)), usageAllocations: \(Swift.String(describing: usageAllocations)))"}
}
...
extension MarketplaceMeteringClientTypes.UsageRecordResult: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case meteringRecordId = "MeteringRecordId"
        case status = "Status"
...
extension MarketplaceMeteringClientTypes.UsageRecordResult: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UsageRecordResult(meteringRecordId: \(Swift.String(describing: meteringRecordId)), status: \(Swift.String(describing: status)), usageRecord: \(Swift.String(describing: usageRecord)))"}
}
