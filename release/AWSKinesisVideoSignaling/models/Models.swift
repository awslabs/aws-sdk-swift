...
public struct GetIceServerConfigInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetIceServerConfigInputURLHostMiddleware"
    ...
    public typealias MInput = GetIceServerConfigInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetIceServerConfigOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetIceServerConfigOutputError>
}

public struct GetIceServerConfigInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetIceServerConfigInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/get-ice-server-config"
...
public struct SendAlexaOfferToMasterInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SendAlexaOfferToMasterInputURLHostMiddleware"
    ...
    public typealias MInput = SendAlexaOfferToMasterInput
    public typealias MOutput = ClientRuntime.OperationOutput<SendAlexaOfferToMasterOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SendAlexaOfferToMasterOutputError>
}

public struct SendAlexaOfferToMasterInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SendAlexaOfferToMasterInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/send-alexa-offer-to-master"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
