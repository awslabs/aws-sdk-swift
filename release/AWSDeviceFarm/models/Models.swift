...
extension DeviceFarmClientTypes {
    ...
    public struct AccountSettings: Swift.Equatable {
        ...
        var awsAccountNumber: Swift.String?
        /// The default number of minutes (at the account level) a test run executes before it times out. The default value is 150 minutes.
        var defaultJobTimeoutMinutes: Swift.Int?
        /// The maximum number of minutes a test run executes before it times out.
        var maxJobTimeoutMinutes: Swift.Int?
        /// The maximum number of device slots that the AWS account can purchase. Each maximum is expressed as an offering-id:number pair, where the offering-id represents one of the IDs returned by the ListOfferings command.
        var maxSlots: [Swift.String:Swift.Int]?
        ...
        var skipAppResign: Swift.Bool?
        /// Information about an AWS account's usage of free trial device minutes.
        var trialMinutes: DeviceFarmClientTypes.TrialMinutes?
        /// Returns the unmetered devices you have purchased or want to purchase.
        var unmeteredDevices: [Swift.String:Swift.Int]?
        /// Returns the unmetered remote access devices you have purchased or want to purchase.
        var unmeteredRemoteAccessDevices: [Swift.String:Swift.Int]?
...
extension DeviceFarmClientTypes {
    ...
    public struct Artifact: Swift.Equatable {
        ...
        ///
        /// * TESTSPEC_OUTPUT
        var type: DeviceFarmClientTypes.ArtifactType?
...
extension DeviceFarmClientTypes {
    ...
    public struct CPU: Swift.Equatable {
        ...
        var clock: Swift.Double?
        /// The CPU's frequency.
        var frequency: Swift.String?
...
public struct CreateDevicePoolInput: Swift.Equatable {
    ...
    /// This member is required.
    var rules: [DeviceFarmClientTypes.Rule]?
...
public struct CreateDevicePoolOutputResponse: Swift.Equatable {
    ...
    var devicePool: DeviceFarmClientTypes.DevicePool?
...
public struct CreateInstanceProfileInput: Swift.Equatable {
    ...
    var excludeAppPackagesFromCleanup: [Swift.String]?
    /// The name of your instance profile.
    /// This member is required.
    var name: Swift.String?
    /// When set to true, Device Farm removes app packages after a test run. The default value is false for private devices.
    var packageCleanup: Swift.Bool?
    /// When set to true, Device Farm reboots the instance after a test run. The default value is true.
    var rebootAfterUse: Swift.Bool?
...
public struct CreateInstanceProfileOutputResponse: Swift.Equatable {
    ...
    var instanceProfile: DeviceFarmClientTypes.InstanceProfile?
...
public struct CreateNetworkProfileInput: Swift.Equatable {
    ...
    var downlinkBandwidthBits: Swift.Int?
    /// Delay time for all packets to destination in milliseconds as an integer from 0 to 2000.
    var downlinkDelayMs: Swift.Int?
    /// Time variation in the delay of received packets in milliseconds as an integer from 0 to 2000.
    var downlinkJitterMs: Swift.Int?
    /// Proportion of received packets that fail to arrive from 0 to 100 percent.
    var downlinkLossPercent: Swift.Int
    ...
    var type: DeviceFarmClientTypes.NetworkProfileType?
    /// The data throughput rate in bits per second, as an integer from 0 to 104857600.
    var uplinkBandwidthBits: Swift.Int?
    /// Delay time for all packets to destination in milliseconds as an integer from 0 to 2000.
    var uplinkDelayMs: Swift.Int?
    /// Time variation in the delay of received packets in milliseconds as an integer from 0 to 2000.
    var uplinkJitterMs: Swift.Int?
    /// Proportion of transmitted packets that fail to arrive from 0 to 100 percent.
    var uplinkLossPercent: Swift.Int
...
public struct CreateNetworkProfileOutputResponse: Swift.Equatable {
    ...
    var networkProfile: DeviceFarmClientTypes.NetworkProfile?
...
public struct CreateProjectOutputResponse: Swift.Equatable {
    ...
    var project: DeviceFarmClientTypes.Project?
...
extension DeviceFarmClientTypes {
    ...
    public struct CreateRemoteAccessSessionConfiguration: Swift.Equatable {
        ...
        var billingMethod: DeviceFarmClientTypes.BillingMethod?
        /// An array of ARNs included in the VPC endpoint configuration.
        var vpceConfigurationArns: [Swift.String]?
...
public struct CreateRemoteAccessSessionInput: Swift.Equatable {
    ...
    var configuration: DeviceFarmClientTypes.CreateRemoteAccessSessionConfiguration?
    ...
    var interactionMode: DeviceFarmClientTypes.InteractionMode?
    ...
    var remoteDebugEnabled: Swift.Bool?
    /// The Amazon Resource Name (ARN) for the app to be recorded in the remote access session.
    var remoteRecordAppArn: Swift.String?
    /// Set to true to enable remote recording for the remote access session.
    var remoteRecordEnabled: Swift.Bool?
...
public struct CreateRemoteAccessSessionOutputResponse: Swift.Equatable {
    ...
    var remoteAccessSession: DeviceFarmClientTypes.RemoteAccessSession?
...
public struct CreateTestGridProjectInput: Swift.Equatable {
    ...
    var vpcConfig: DeviceFarmClientTypes.TestGridVpcConfig?
...
public struct CreateTestGridProjectOutputResponse: Swift.Equatable {
    ...
    var testGridProject: DeviceFarmClientTypes.TestGridProject?
...
public struct CreateTestGridUrlInput: Swift.Equatable {
    ...
    /// This member is required.
    var expiresInSeconds: Swift.Int?
...
public struct CreateUploadInput: Swift.Equatable {
    ...
    /// This member is required.
    var type: DeviceFarmClientTypes.UploadType?
...
public struct CreateUploadOutputResponse: Swift.Equatable {
    ...
    var upload: DeviceFarmClientTypes.Upload?
...
public struct CreateVPCEConfigurationInput: Swift.Equatable {
    ...
    /// This member is required.
    var serviceDnsName: Swift.String?
    /// An optional description that provides details about your VPC endpoint configuration.
    var vpceConfigurationDescription: Swift.String?
    /// The friendly name you give to your VPC endpoint configuration, to manage your configurations more easily.
    /// This member is required.
    var vpceConfigurationName: Swift.String?
    /// The name of the VPC endpoint service running in your AWS account that you want Device Farm to test.
    /// This member is required.
    var vpceServiceName: Swift.String?
...
public struct CreateVPCEConfigurationOutputResponse: Swift.Equatable {
    ...
    var vpceConfiguration: DeviceFarmClientTypes.VPCEConfiguration?
...
extension DeviceFarmClientTypes {
    ...
    public struct CustomerArtifactPaths: Swift.Equatable {
        ...
        var androidPaths: [Swift.String]?
        /// Comma-separated list of paths in the test execution environment where the artifacts generated by the customer's tests are pulled from.
        var deviceHostPaths: [Swift.String]?
        /// Comma-separated list of paths on the iOS device where the artifacts generated by the customer's tests are pulled from.
        var iosPaths: [Swift.String]?
...
extension DeviceFarmClientTypes {
    ...
    public struct Device: Swift.Equatable {
        ...
        var availability: DeviceFarmClientTypes.DeviceAvailability?
        /// The device's carrier.
        var carrier: Swift.String?
        /// Information about the device's CPU.
        var cpu: DeviceFarmClientTypes.CPU?
        /// The name of the fleet to which this device belongs.
        var fleetName: Swift.String?
        /// The type of fleet to which this device belongs. Possible values are PRIVATE and PUBLIC.
        var fleetType: Swift.String?
        /// The device's form factor. Allowed values include:
        ///
        /// * PHONE
        ///
        /// * TABLET
        var formFactor: DeviceFarmClientTypes.DeviceFormFactor?
        /// The device's heap size, expressed in bytes.
        var heapSize: Swift.Int?
        /// The device's image name.
        var image: Swift.String?
        /// The instances that belong to this device.
        var instances: [DeviceFarmClientTypes.DeviceInstance]?
        ...
        ///
        /// * IOS
        var platform: DeviceFarmClientTypes.DevicePlatform?
        /// The device's radio.
        var radio: Swift.String?
        /// Specifies whether remote access has been enabled for the specified device.
        var remoteAccessEnabled: Swift.Bool?
        ...
        var resolution: DeviceFarmClientTypes.Resolution?
...
extension DeviceFarmClientTypes {
    ...
    public struct DeviceFilter: Swift.Equatable {
        ...
        /// This member is required.
        var `operator`: DeviceFarmClientTypes.RuleOperator?
        ...
        /// This member is required.
        var attribute: DeviceFarmClientTypes.DeviceFilterAttribute?
...
extension DeviceFarmClientTypes {
    ...
    public struct DeviceInstance: Swift.Equatable {
        ...
        var status: DeviceFarmClientTypes.InstanceStatus?
        /// Unique device identifier for the device instance.
        var udid: Swift.String?
...
extension DeviceFarmClientTypes {
    ...
    public struct DeviceMinutes: Swift.Equatable {
        ...
        var metered: Swift.Double?
        /// When specified, represents the total minutes used by the resource to run tests.
        var total: Swift.Double?
        /// When specified, represents only the sum of unmetered minutes used by the resource to run tests.
        var unmetered: Swift.Double?
...
extension DeviceFarmClientTypes {
    ...
    public struct DevicePool: Swift.Equatable {
        ...
        var type: DeviceFarmClientTypes.DevicePoolType?
...
extension DeviceFarmClientTypes {
    ...
    public struct DevicePoolCompatibilityResult: Swift.Equatable {
        ...
        var compatible: Swift.Bool?
        /// The device (phone or tablet) to return information about.
        var device: DeviceFarmClientTypes.Device?
        /// Information about the compatibility.
        var incompatibilityMessages: [DeviceFarmClientTypes.IncompatibilityMessage]?
...
extension DeviceFarmClientTypes {
    ...
    public struct DeviceSelectionConfiguration: Swift.Equatable {
        ...
        /// * The FLEET_TYPE attribute can be set to PUBLIC or PRIVATE.
        /// This member is required.
        var filters: [DeviceFarmClientTypes.DeviceFilter]?
...
extension DeviceFarmClientTypes {
    ...
    public struct DeviceSelectionResult: Swift.Equatable {
        ...
        var matchedDevicesCount: Swift.Int?
...
extension DeviceFarmClientTypes {
    ...
    public struct ExecutionConfiguration: Swift.Equatable {
        ...
        var accountsCleanup: Swift.Bool?
        /// True if app package cleanup is enabled at the beginning of the test. Otherwise, false.
        var appPackagesCleanup: Swift.Bool?
        /// The number of minutes a test run executes before it times out.
        var jobTimeoutMinutes: Swift.Int?
        /// When set to true, for private devices, Device Farm does not sign your app again. For public devices, Device Farm always signs your apps again. For more information about how Device Farm re-signs your apps, see [Do you modify my app?](https://aws.amazon.com/device-farm/faq/) in the AWS Device Farm FAQs.
        var skipAppResign: Swift.Bool?
        /// Set to true to enable video capture. Otherwise, set to false. The default is true.
        var videoCapture: Swift.Bool?
...
public struct GetAccountSettingsOutputResponse: Swift.Equatable {
    ...
    var accountSettings: DeviceFarmClientTypes.AccountSettings?
...
public struct GetDeviceInstanceOutputResponse: Swift.Equatable {
    ...
    var deviceInstance: DeviceFarmClientTypes.DeviceInstance?
...
public struct GetDevicePoolCompatibilityInput: Swift.Equatable {
    ...
    var configuration: DeviceFarmClientTypes.ScheduleRunConfiguration?
    /// The device pool's ARN.
    /// This member is required.
    var devicePoolArn: Swift.String?
    /// Information about the uploaded test to be run against the device pool.
    var test: DeviceFarmClientTypes.ScheduleRunTest?
    ...
    ///
    /// * XCTEST_UI.
    var testType: DeviceFarmClientTypes.TestType?
...
public struct GetDevicePoolCompatibilityOutputResponse: Swift.Equatable {
    ...
    var compatibleDevices: [DeviceFarmClientTypes.DevicePoolCompatibilityResult]?
    /// Information about incompatible devices.
    var incompatibleDevices: [DeviceFarmClientTypes.DevicePoolCompatibilityResult]?
...
public struct GetJobOutputResponse: Swift.Equatable {
    ...
    var job: DeviceFarmClientTypes.Job?
...
public struct GetOfferingStatusOutputResponse: Swift.Equatable {
    ...
    var current: [Swift.String:DeviceFarmClientTypes.OfferingStatus]?
    /// When specified, gets the offering status for the next period.
    var nextPeriod: [Swift.String:DeviceFarmClientTypes.OfferingStatus]?
    /// An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.
    var nextToken: Swift.String?
...
public struct GetRunOutputResponse: Swift.Equatable {
    ...
    var run: DeviceFarmClientTypes.Run?
...
public struct GetSuiteOutputResponse: Swift.Equatable {
    ...
    var suite: DeviceFarmClientTypes.Suite?
...
public struct GetTestGridSessionOutputResponse: Swift.Equatable {
    ...
    var testGridSession: DeviceFarmClientTypes.TestGridSession?
...
public struct GetTestOutputResponse: Swift.Equatable {
    ...
    var test: DeviceFarmClientTypes.Test?
...
extension DeviceFarmClientTypes {
    ...
    public struct IncompatibilityMessage: Swift.Equatable {
        ...
        ///
        /// * APPIUM_VERSION
        var type: DeviceFarmClientTypes.DeviceAttribute?
...
public struct InstallToRemoteAccessSessionInput: Swift.Equatable {
    ...
    /// This member is required.
    var remoteAccessSessionArn: Swift.String?
...
public struct InstallToRemoteAccessSessionOutputResponse: Swift.Equatable {
    ...
    var appUpload: DeviceFarmClientTypes.Upload?
...
extension DeviceFarmClientTypes {
    ...
    public struct Job: Swift.Equatable {
        ...
        var counters: DeviceFarmClientTypes.Counters?
        /// When the job was created.
        var created: ClientRuntime.Date?
        /// The device (phone or tablet).
        var device: DeviceFarmClientTypes.Device?
        /// Represents the total (metered or unmetered) minutes used by the job.
        var deviceMinutes: DeviceFarmClientTypes.DeviceMinutes?
        ...
        ///
        /// * STOPPED
        var result: DeviceFarmClientTypes.ExecutionResult?
        /// The job's start time.
        var started: ClientRuntime.Date?
        ...
        ///
        /// * STOPPING
        var status: DeviceFarmClientTypes.ExecutionStatus?
        /// The job's stop time.
        var stopped: ClientRuntime.Date?
        ...
        ///
        /// * XCTEST_UI
        var type: DeviceFarmClientTypes.TestType?
        /// This value is set to true if video capture is enabled. Otherwise, it is set to false.
        var videoCapture: Swift.Bool?
        /// The endpoint for streaming device video.
        var videoEndpoint: Swift.String?
...
public struct ListArtifactsInput: Swift.Equatable {
    ...
    /// * SCREENSHOT
    /// This member is required.
    var type: DeviceFarmClientTypes.ArtifactCategory?
...
public struct ListArtifactsOutputResponse: Swift.Equatable {
    ...
    var artifacts: [DeviceFarmClientTypes.Artifact]?
...
public struct ListDeviceInstancesOutputResponse: Swift.Equatable {
    ...
    var deviceInstances: [DeviceFarmClientTypes.DeviceInstance]?
...
public struct ListDevicePoolsOutputResponse: Swift.Equatable {
    ...
    var devicePools: [DeviceFarmClientTypes.DevicePool]?
    /// If the number of items that are returned is significantly large, this is an identifier that is also returned. It can be used in a subsequent call to this operation to return the next set of items in the list.
    var nextToken: Swift.String?
...
public struct ListDevicesOutputResponse: Swift.Equatable {
    ...
    var devices: [DeviceFarmClientTypes.Device]?
    /// If the number of items that are returned is significantly large, this is an identifier that is also returned. It can be used in a subsequent call to this operation to return the next set of items in the list.
    var nextToken: Swift.String?
...
public struct ListInstanceProfilesOutputResponse: Swift.Equatable {
    ...
    var instanceProfiles: [DeviceFarmClientTypes.InstanceProfile]?
    /// An identifier that can be used in the next call to this operation to return the next set of items in the list.
    var nextToken: Swift.String?
...
public struct ListJobsOutputResponse: Swift.Equatable {
    ...
    var jobs: [DeviceFarmClientTypes.Job]?
    /// If the number of items that are returned is significantly large, this is an identifier that is also returned. It can be used in a subsequent call to this operation to return the next set of items in the list.
    var nextToken: Swift.String?
...
public struct ListNetworkProfilesOutputResponse: Swift.Equatable {
    ...
    var networkProfiles: [DeviceFarmClientTypes.NetworkProfile]?
    /// An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.
    var nextToken: Swift.String?
...
public struct ListOfferingPromotionsOutputResponse: Swift.Equatable {
    ...
    var offeringPromotions: [DeviceFarmClientTypes.OfferingPromotion]?
...
public struct ListOfferingTransactionsOutputResponse: Swift.Equatable {
    ...
    var offeringTransactions: [DeviceFarmClientTypes.OfferingTransaction]?
...
public struct ListOfferingsOutputResponse: Swift.Equatable {
    ...
    var offerings: [DeviceFarmClientTypes.Offering]?
...
public struct ListProjectsOutputResponse: Swift.Equatable {
    ...
    var projects: [DeviceFarmClientTypes.Project]?
...
public struct ListRemoteAccessSessionsOutputResponse: Swift.Equatable {
    ...
    var remoteAccessSessions: [DeviceFarmClientTypes.RemoteAccessSession]?
...
public struct ListRunsOutputResponse: Swift.Equatable {
    ...
    var runs: [DeviceFarmClientTypes.Run]?
...
public struct ListSamplesOutputResponse: Swift.Equatable {
    ...
    var samples: [DeviceFarmClientTypes.Sample]?
...
public struct ListSuitesOutputResponse: Swift.Equatable {
    ...
    var suites: [DeviceFarmClientTypes.Suite]?
...
public struct ListTagsForResourceOutputResponse: Swift.Equatable {
    ...
    var tags: [DeviceFarmClientTypes.Tag]?
...
public struct ListTestGridProjectsOutputResponse: Swift.Equatable {
    ...
    var testGridProjects: [DeviceFarmClientTypes.TestGridProject]?
...
public struct ListTestGridSessionActionsOutputResponse: Swift.Equatable {
    ...
    var actions: [DeviceFarmClientTypes.TestGridSessionAction]?
    /// Pagination token.
    var nextToken: Swift.String?
...
public struct ListTestGridSessionArtifactsInput: Swift.Equatable {
    ...
    var type: DeviceFarmClientTypes.TestGridSessionArtifactCategory?
...
public struct ListTestGridSessionArtifactsOutputResponse: Swift.Equatable {
    ...
    var artifacts: [DeviceFarmClientTypes.TestGridSessionArtifact]?
    /// Pagination token.
    var nextToken: Swift.String?
...
public struct ListTestGridSessionsInput: Swift.Equatable {
    ...
    var endTimeAfter: ClientRuntime.Date?
    /// Return only sessions that ended before this time.
    var endTimeBefore: ClientRuntime.Date?
    ...
    var status: DeviceFarmClientTypes.TestGridSessionStatus?
...
public struct ListTestGridSessionsOutputResponse: Swift.Equatable {
    ...
    var testGridSessions: [DeviceFarmClientTypes.TestGridSession]?
...
public struct ListTestsOutputResponse: Swift.Equatable {
    ...
    var tests: [DeviceFarmClientTypes.Test]?
...
public struct ListUniqueProblemsOutputResponse: Swift.Equatable {
    ...
    ///
    /// * STOPPED
    var uniqueProblems: [Swift.String:[DeviceFarmClientTypes.UniqueProblem]]?
...
public struct ListUploadsOutputResponse: Swift.Equatable {
    ...
    var uploads: [DeviceFarmClientTypes.Upload]?
...
public struct ListVPCEConfigurationsOutputResponse: Swift.Equatable {
    ...
    var vpceConfigurations: [DeviceFarmClientTypes.VPCEConfiguration]?
...
extension DeviceFarmClientTypes {
    ...
    public struct MonetaryAmount: Swift.Equatable {
        ...
        var amount: Swift.Double?
        /// The currency code of a monetary amount. For example, USD means U.S. dollars.
        var currencyCode: DeviceFarmClientTypes.CurrencyCode?
...
extension DeviceFarmClientTypes {
    ...
    public struct Offering: Swift.Equatable {
        ...
        var recurringCharges: [DeviceFarmClientTypes.RecurringCharge]?
        /// The type of offering (for example, RECURRING) for a device.
        var type: DeviceFarmClientTypes.OfferingType?
...
extension DeviceFarmClientTypes {
    ...
    public struct OfferingStatus: Swift.Equatable {
        ...
        var effectiveOn: ClientRuntime.Date?
        /// Represents the metadata of an offering status.
        var offering: DeviceFarmClientTypes.Offering?
        /// The number of available devices in the offering.
        var quantity: Swift.Int?
        /// The type specified for the offering status.
        var type: DeviceFarmClientTypes.OfferingTransactionType?
...
extension DeviceFarmClientTypes {
    ...
    public struct OfferingTransaction: Swift.Equatable {
        ...
        var cost: DeviceFarmClientTypes.MonetaryAmount?
        /// The date on which an offering transaction was created.
        var createdOn: ClientRuntime.Date?
        /// The ID that corresponds to a device offering promotion.
        var offeringPromotionId: Swift.String?
        /// The status of an offering transaction.
        var offeringStatus: DeviceFarmClientTypes.OfferingStatus?
        /// The transaction ID of the offering transaction.
        var transactionId: Swift.String?
...
extension DeviceFarmClientTypes {
    ...
    public struct Problem: Swift.Equatable {
        ...
        var job: DeviceFarmClientTypes.ProblemDetail?
        ...
        var run: DeviceFarmClientTypes.ProblemDetail?
        /// Information about the associated suite.
        var suite: DeviceFarmClientTypes.ProblemDetail?
        /// Information about the associated test.
        var test: DeviceFarmClientTypes.ProblemDetail?
...
public struct PurchaseOfferingOutputResponse: Swift.Equatable {
    ...
    var offeringTransaction: DeviceFarmClientTypes.OfferingTransaction?
...
extension DeviceFarmClientTypes {
    ...
    public struct RecurringCharge: Swift.Equatable {
        ...
        var frequency: DeviceFarmClientTypes.RecurringChargeFrequency?
...
extension DeviceFarmClientTypes {
    ...
    public struct Rule: Swift.Equatable {
        ...
        var attribute: DeviceFarmClientTypes.DeviceAttribute?
        /// The rule's value.
...
extension DeviceFarmClientTypes {
    ...
    public struct Run: Swift.Equatable {
        ...
        var completedJobs: Swift.Int?
        /// The run's result counters.
        var counters: DeviceFarmClientTypes.Counters?
        /// When the run was created.
        var created: ClientRuntime.Date?
        /// Output CustomerArtifactPaths object for the test run.
        var customerArtifactPaths: DeviceFarmClientTypes.CustomerArtifactPaths?
        /// Represents the total (metered or unmetered) minutes used by the test run.
        var deviceMinutes: DeviceFarmClientTypes.DeviceMinutes?
        /// The ARN of the device pool for the run.
        var devicePoolArn: Swift.String?
        /// The results of a device filter used to select the devices for a test run.
        var deviceSelectionResult: DeviceFarmClientTypes.DeviceSelectionResult?
        ...
        var location: DeviceFarmClientTypes.Location?
        ...
        var parsingResultUrl: Swift.String?
        ...
        var radios: DeviceFarmClientTypes.Radios?
        ...
        var resultCode: DeviceFarmClientTypes.ExecutionResultCode?
        ...
        var testSpecArn: Swift.String?
        /// The total number of jobs for the run.
        var totalJobs: Swift.Int?
...
extension DeviceFarmClientTypes {
    ...
    public struct Sample: Swift.Equatable {
        ...
        var type: DeviceFarmClientTypes.SampleType?
...
extension DeviceFarmClientTypes {
    ...
    public struct ScheduleRunConfiguration: Swift.Equatable {
        ...
        var auxiliaryApps: [Swift.String]?
        ...
        var extraDataPackageArn: Swift.String?
        /// Information about the locale that is used for the run.
        var locale: Swift.String?
        /// Information about the location that is used for the run.
        var location: DeviceFarmClientTypes.Location?
...
public struct ScheduleRunInput: Swift.Equatable {
    ...
    var deviceSelectionConfiguration: DeviceFarmClientTypes.DeviceSelectionConfiguration?
    /// Specifies configuration information about a test run, such as the execution timeout (in minutes).
    var executionConfiguration: DeviceFarmClientTypes.ExecutionConfiguration?
...
extension DeviceFarmClientTypes {
    ...
    public struct ScheduleRunTest: Swift.Equatable {
        ...
        var testPackageArn: Swift.String?
...
extension DeviceFarmClientTypes {
    ...
    public struct TestGridSession: Swift.Equatable {
        ...
        var billingMinutes: Swift.Double?
        /// The time that the session was started.
        var created: ClientRuntime.Date?
        /// The time the session ended.
        var ended: ClientRuntime.Date?
        /// A JSON object of options and parameters passed to the Selenium WebDriver.
        var seleniumProperties: Swift.String?
...
extension DeviceFarmClientTypes {
    ...
    public struct TestGridSessionAction: Swift.Equatable {
        ...
        var requestMethod: Swift.String?
...
extension DeviceFarmClientTypes {
    ...
    public struct TestGridSessionArtifact: Swift.Equatable {
        ...
        var type: DeviceFarmClientTypes.TestGridSessionArtifactType?
...
extension DeviceFarmClientTypes {
    ...
    public struct UniqueProblem: Swift.Equatable {
        ...
        var problems: [DeviceFarmClientTypes.Problem]?
...
public struct UpdateDevicePoolInput: Swift.Equatable {
    ...
    var clearMaxDevices: Swift.Bool?
...
extension DeviceFarmClientTypes {
    ...
    public struct Upload: Swift.Equatable {
        ...
        var category: DeviceFarmClientTypes.UploadCategory?
        /// The upload's content type (for example, application/octet-stream).
        var contentType: Swift.String?
        ...
        ///
        /// * SUCCEEDED
        var status: DeviceFarmClientTypes.UploadStatus?
