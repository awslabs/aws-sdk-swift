...
public protocol EfsClientProtocol {
    ...
    func createFileSystem(input: CreateFileSystemInput, completion: @escaping (SdkResult<CreateFileSystemOutput, CreateFileSystemOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createMountTarget(input: CreateMountTargetInput, completion: @escaping (SdkResult<CreateMountTargetOutput, CreateMountTargetOutputError>) -> Void)
    /// <note>
    ...
    func deleteFileSystem(input: DeleteFileSystemInput, completion: @escaping (SdkResult<DeleteFileSystemOutput, DeleteFileSystemOutputError>) -> Void)
    ...
    func deleteFileSystemPolicy(input: DeleteFileSystemPolicyInput, completion: @escaping (SdkResult<DeleteFileSystemPolicyOutput, DeleteFileSystemPolicyOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteMountTarget(input: DeleteMountTargetInput, completion: @escaping (SdkResult<DeleteMountTargetOutput, DeleteMountTargetOutputError>) -> Void)
    /// <note>
    ...
    func describeAccessPoints(input: DescribeAccessPointsInput, completion: @escaping (SdkResult<DescribeAccessPointsOutput, DescribeAccessPointsOutputError>) -> Void)
    func describeAccountPreferences(input: DescribeAccountPreferencesInput, completion: @escaping (SdkResult<DescribeAccountPreferencesOutput, DescribeAccountPreferencesOutputError>) -> Void)
    /// <p>Returns the backup policy for the specified EFS file system.</p>
    func describeBackupPolicy(input: DescribeBackupPolicyInput, completion: @escaping (SdkResult<DescribeBackupPolicyOutput, DescribeBackupPolicyOutputError>) -> Void)
    ...
    func describeFileSystemPolicy(input: DescribeFileSystemPolicyInput, completion: @escaping (SdkResult<DescribeFileSystemPolicyOutput, DescribeFileSystemPolicyOutputError>) -> Void)
    ...
    func describeFileSystems(input: DescribeFileSystemsInput, completion: @escaping (SdkResult<DescribeFileSystemsOutput, DescribeFileSystemsOutputError>) -> Void)
    ...
    func describeLifecycleConfiguration(input: DescribeLifecycleConfigurationInput, completion: @escaping (SdkResult<DescribeLifecycleConfigurationOutput, DescribeLifecycleConfigurationOutputError>) -> Void)
    ...
    func describeMountTargets(input: DescribeMountTargetsInput, completion: @escaping (SdkResult<DescribeMountTargetsOutput, DescribeMountTargetsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeMountTargetSecurityGroups(input: DescribeMountTargetSecurityGroupsInput, completion: @escaping (SdkResult<DescribeMountTargetSecurityGroupsOutput, DescribeMountTargetSecurityGroupsOutputError>) -> Void)
    /// <note>
    ...
    ///             </li>
    ///          </ul>
    func modifyMountTargetSecurityGroups(input: ModifyMountTargetSecurityGroupsInput, completion: @escaping (SdkResult<ModifyMountTargetSecurityGroupsOutput, ModifyMountTargetSecurityGroupsOutputError>) -> Void)
    func putAccountPreferences(input: PutAccountPreferencesInput, completion: @escaping (SdkResult<PutAccountPreferencesOutput, PutAccountPreferencesOutputError>) -> Void)
    /// <p>Updates the file system's backup policy. Use this action to start or stop automatic backups of the file system. </p>
    func putBackupPolicy(input: PutBackupPolicyInput, completion: @escaping (SdkResult<PutBackupPolicyOutput, PutBackupPolicyOutputError>) -> Void)
    ...
    func putFileSystemPolicy(input: PutFileSystemPolicyInput, completion: @escaping (SdkResult<PutFileSystemPolicyOutput, PutFileSystemPolicyOutputError>) -> Void)
    ...
    ///       file system. </p>
    func putLifecycleConfiguration(input: PutLifecycleConfigurationInput, completion: @escaping (SdkResult<PutLifecycleConfigurationOutput, PutLifecycleConfigurationOutputError>) -> Void)
    ...
    ///       system.</p>
    func updateFileSystem(input: UpdateFileSystemInput, completion: @escaping (SdkResult<UpdateFileSystemOutput, UpdateFileSystemOutputError>) -> Void)
}
