...
public protocol EfsClientProtocol {
    ...
    func createFileSystem(input: CreateFileSystemInput, completion: @escaping (SdkResult<CreateFileSystemOutputResponse, CreateFileSystemOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createMountTarget(input: CreateMountTargetInput, completion: @escaping (SdkResult<CreateMountTargetOutputResponse, CreateMountTargetOutputError>) -> Void)
    /// <note>
    ...
    func deleteFileSystem(input: DeleteFileSystemInput, completion: @escaping (SdkResult<DeleteFileSystemOutputResponse, DeleteFileSystemOutputError>) -> Void)
    ...
    func deleteFileSystemPolicy(input: DeleteFileSystemPolicyInput, completion: @escaping (SdkResult<DeleteFileSystemPolicyOutputResponse, DeleteFileSystemPolicyOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteMountTarget(input: DeleteMountTargetInput, completion: @escaping (SdkResult<DeleteMountTargetOutputResponse, DeleteMountTargetOutputError>) -> Void)
    /// <note>
    ...
    func describeAccessPoints(input: DescribeAccessPointsInput, completion: @escaping (SdkResult<DescribeAccessPointsOutputResponse, DescribeAccessPointsOutputError>) -> Void)
    func describeAccountPreferences(input: DescribeAccountPreferencesInput, completion: @escaping (SdkResult<DescribeAccountPreferencesOutputResponse, DescribeAccountPreferencesOutputError>) -> Void)
    /// <p>Returns the backup policy for the specified EFS file system.</p>
    func describeBackupPolicy(input: DescribeBackupPolicyInput, completion: @escaping (SdkResult<DescribeBackupPolicyOutputResponse, DescribeBackupPolicyOutputError>) -> Void)
    ...
    func describeFileSystemPolicy(input: DescribeFileSystemPolicyInput, completion: @escaping (SdkResult<DescribeFileSystemPolicyOutputResponse, DescribeFileSystemPolicyOutputError>) -> Void)
    ...
    func describeFileSystems(input: DescribeFileSystemsInput, completion: @escaping (SdkResult<DescribeFileSystemsOutputResponse, DescribeFileSystemsOutputError>) -> Void)
    ...
    func describeLifecycleConfiguration(input: DescribeLifecycleConfigurationInput, completion: @escaping (SdkResult<DescribeLifecycleConfigurationOutputResponse, DescribeLifecycleConfigurationOutputError>) -> Void)
    ...
    func describeMountTargets(input: DescribeMountTargetsInput, completion: @escaping (SdkResult<DescribeMountTargetsOutputResponse, DescribeMountTargetsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeMountTargetSecurityGroups(input: DescribeMountTargetSecurityGroupsInput, completion: @escaping (SdkResult<DescribeMountTargetSecurityGroupsOutputResponse, DescribeMountTargetSecurityGroupsOutputError>) -> Void)
    /// <note>
    ...
    ///             </li>
    ///          </ul>
    func modifyMountTargetSecurityGroups(input: ModifyMountTargetSecurityGroupsInput, completion: @escaping (SdkResult<ModifyMountTargetSecurityGroupsOutputResponse, ModifyMountTargetSecurityGroupsOutputError>) -> Void)
    func putAccountPreferences(input: PutAccountPreferencesInput, completion: @escaping (SdkResult<PutAccountPreferencesOutputResponse, PutAccountPreferencesOutputError>) -> Void)
    /// <p>Updates the file system's backup policy. Use this action to start or stop automatic backups of the file system. </p>
    func putBackupPolicy(input: PutBackupPolicyInput, completion: @escaping (SdkResult<PutBackupPolicyOutputResponse, PutBackupPolicyOutputError>) -> Void)
    ...
    func putFileSystemPolicy(input: PutFileSystemPolicyInput, completion: @escaping (SdkResult<PutFileSystemPolicyOutputResponse, PutFileSystemPolicyOutputError>) -> Void)
    ...
    ///       file system. </p>
    func putLifecycleConfiguration(input: PutLifecycleConfigurationInput, completion: @escaping (SdkResult<PutLifecycleConfigurationOutputResponse, PutLifecycleConfigurationOutputError>) -> Void)
    ...
    ///       system.</p>
    func updateFileSystem(input: UpdateFileSystemInput, completion: @escaping (SdkResult<UpdateFileSystemOutputResponse, UpdateFileSystemOutputError>) -> Void)
}
