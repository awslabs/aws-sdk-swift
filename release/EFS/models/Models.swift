...
public enum CreateMountTargetOutputError: Swift.Error, Equatable {
...
public enum DeleteFileSystemPolicyOutputError: Swift.Error, Equatable {
    case fileSystemNotFound(FileSystemNotFound)
    case incorrectFileSystemLifeCycleState(IncorrectFileSystemLifeCycleState)
    case internalServerError(InternalServerError)
    case unknown(UnknownAWSHttpServiceError)
...
public enum DeleteMountTargetOutputError: Swift.Error, Equatable {
    case badRequest(BadRequest)
...
public enum DescribeAccessPointsOutputError: Swift.Error, Equatable {
    case accessPointNotFound(AccessPointNotFound)
    case badRequest(BadRequest)
    case fileSystemNotFound(FileSystemNotFound)
    case internalServerError(InternalServerError)
...
public enum DescribeAccountPreferencesOutputError: Swift.Error, Equatable {
    case internalServerError(InternalServerError)
    case unknown(UnknownAWSHttpServiceError)
}
...
public enum DescribeBackupPolicyOutputError: Swift.Error, Equatable {
    case badRequest(BadRequest)
    case fileSystemNotFound(FileSystemNotFound)
    case internalServerError(InternalServerError)
...
public enum DescribeFileSystemPolicyOutputError: Swift.Error, Equatable {
    case fileSystemNotFound(FileSystemNotFound)
    case internalServerError(InternalServerError)
    case policyNotFound(PolicyNotFound)
    case unknown(UnknownAWSHttpServiceError)
...
public enum DescribeLifecycleConfigurationOutputError: Swift.Error, Equatable {
    case badRequest(BadRequest)
    case fileSystemNotFound(FileSystemNotFound)
    case internalServerError(InternalServerError)
    case unknown(UnknownAWSHttpServiceError)
...
public enum DescribeMountTargetSecurityGroupsOutputError: Swift.Error, Equatable {
    case badRequest(BadRequest)
...
public enum DescribeMountTargetsOutputError: Swift.Error, Equatable {
    case accessPointNotFound(AccessPointNotFound)
    case badRequest(BadRequest)
    case fileSystemNotFound(FileSystemNotFound)
    case internalServerError(InternalServerError)
...
public enum ModifyMountTargetSecurityGroupsOutputError: Swift.Error, Equatable {
    case badRequest(BadRequest)
    case incorrectMountTargetState(IncorrectMountTargetState)
    case internalServerError(InternalServerError)
    case mountTargetNotFound(MountTargetNotFound)
...
public enum PutAccountPreferencesOutputError: Swift.Error, Equatable {
    case internalServerError(InternalServerError)
    case unknown(UnknownAWSHttpServiceError)
}
...
public enum PutBackupPolicyOutputError: Swift.Error, Equatable {
    case badRequest(BadRequest)
    case fileSystemNotFound(FileSystemNotFound)
    case incorrectFileSystemLifeCycleState(IncorrectFileSystemLifeCycleState)
    case internalServerError(InternalServerError)
...
public enum PutFileSystemPolicyOutputError: Swift.Error, Equatable {
    case fileSystemNotFound(FileSystemNotFound)
    case incorrectFileSystemLifeCycleState(IncorrectFileSystemLifeCycleState)
    case internalServerError(InternalServerError)
...
public enum PutLifecycleConfigurationOutputError: Swift.Error, Equatable {
    case badRequest(BadRequest)
    case fileSystemNotFound(FileSystemNotFound)
    case incorrectFileSystemLifeCycleState(IncorrectFileSystemLifeCycleState)
    case internalServerError(InternalServerError)
