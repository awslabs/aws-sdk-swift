...
public class EfsClient {
    ...
    public class EfsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("EfsClient")
...
public struct EfsClientLogHandlerFactory: SDKLogHandlerFactory {
