...
public class EfsClient {
    ...
    public convenience init(region: Swift.String? = nil) throws {
        ...
        let config = try EfsClientConfiguration(region: unwrappedRegion)
...
extension EfsClient: EfsClientProtocol {
    ...
    public func createAccessPoint(input: CreateAccessPointInput, completion: @escaping (ClientRuntime.SdkResult<CreateAccessPointOutputResponse, CreateAccessPointOutputError>) -> Void)
    {
        ...
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<CreateAccessPointOutputResponse>, ClientRuntime.SdkError<CreateAccessPointOutputError>> in
