...
public class NeptuneClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try NeptuneClientConfiguration(region: unwrappedRegion)
    ...
    public class NeptuneClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("NeptuneClient")
...
public struct NeptuneClientLogHandlerFactory: SDKLogHandlerFactory {
