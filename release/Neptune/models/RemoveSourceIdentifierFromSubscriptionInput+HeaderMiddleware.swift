...
public struct RemoveSourceIdentifierFromSubscriptionInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<RemoveSourceIdentifierFromSubscriptionOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<RemoveSourceIdentifierFromSubscriptionOutput>
