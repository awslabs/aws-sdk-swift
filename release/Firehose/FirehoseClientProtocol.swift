...
public protocol FirehoseClientProtocol {
    ...
    func createDeliveryStream(input: CreateDeliveryStreamInput, completion: @escaping (SdkResult<CreateDeliveryStreamOutputResponse, CreateDeliveryStreamOutputError>) -> Void)
    ...
    func deleteDeliveryStream(input: DeleteDeliveryStreamInput, completion: @escaping (SdkResult<DeleteDeliveryStreamOutputResponse, DeleteDeliveryStreamOutputError>) -> Void)
    ...
    func describeDeliveryStream(input: DescribeDeliveryStreamInput, completion: @escaping (SdkResult<DescribeDeliveryStreamOutputResponse, DescribeDeliveryStreamOutputError>) -> Void)
    ...
    func listDeliveryStreams(input: ListDeliveryStreamsInput, completion: @escaping (SdkResult<ListDeliveryStreamsOutputResponse, ListDeliveryStreamsOutputError>) -> Void)
    ...
    func listTagsForDeliveryStream(input: ListTagsForDeliveryStreamInput, completion: @escaping (SdkResult<ListTagsForDeliveryStreamOutputResponse, ListTagsForDeliveryStreamOutputError>) -> Void)
    ...
    ///             Instead, concatenate the raw data, then perform base64 encoding.</p>
    ///          </important>
    func putRecordBatch(input: PutRecordBatchInput, completion: @escaping (SdkResult<PutRecordBatchOutputResponse, PutRecordBatchOutputError>) -> Void)
    ...
    ///          24-hour period.</p>
    func startDeliveryStreamEncryption(input: StartDeliveryStreamEncryptionInput, completion: @escaping (SdkResult<StartDeliveryStreamEncryptionOutputResponse, StartDeliveryStreamEncryptionOutputError>) -> Void)
    ...
    ///             <code>StopDeliveryStreamEncryption</code> 12 times for the same delivery stream in a
    ///          24-hour period.</p>
    func stopDeliveryStreamEncryption(input: StopDeliveryStreamEncryptionInput, completion: @escaping (SdkResult<StopDeliveryStreamEncryptionOutputResponse, StopDeliveryStreamEncryptionOutputError>) -> Void)
    ...
    func tagDeliveryStream(input: TagDeliveryStreamInput, completion: @escaping (SdkResult<TagDeliveryStreamOutputResponse, TagDeliveryStreamOutputError>) -> Void)
    ...
    ///          <p>This operation has a limit of five transactions per second per account. </p>
    func untagDeliveryStream(input: UntagDeliveryStreamInput, completion: @escaping (SdkResult<UntagDeliveryStreamOutputResponse, UntagDeliveryStreamOutputError>) -> Void)
