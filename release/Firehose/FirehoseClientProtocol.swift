...
public protocol FirehoseClientProtocol {
    ...
    func createDeliveryStream(input: CreateDeliveryStreamInput, completion: @escaping (SdkResult<CreateDeliveryStreamOutput, CreateDeliveryStreamOutputError>) -> Void)
    ...
    func deleteDeliveryStream(input: DeleteDeliveryStreamInput, completion: @escaping (SdkResult<DeleteDeliveryStreamOutput, DeleteDeliveryStreamOutputError>) -> Void)
    ...
    func describeDeliveryStream(input: DescribeDeliveryStreamInput, completion: @escaping (SdkResult<DescribeDeliveryStreamOutput, DescribeDeliveryStreamOutputError>) -> Void)
    ...
    func listDeliveryStreams(input: ListDeliveryStreamsInput, completion: @escaping (SdkResult<ListDeliveryStreamsOutput, ListDeliveryStreamsOutputError>) -> Void)
    ...
    func listTagsForDeliveryStream(input: ListTagsForDeliveryStreamInput, completion: @escaping (SdkResult<ListTagsForDeliveryStreamOutput, ListTagsForDeliveryStreamOutputError>) -> Void)
    ...
    ///             Instead, concatenate the raw data, then perform base64 encoding.</p>
    ///          </important>
    func putRecordBatch(input: PutRecordBatchInput, completion: @escaping (SdkResult<PutRecordBatchOutput, PutRecordBatchOutputError>) -> Void)
    ...
    ///          24-hour period.</p>
    func startDeliveryStreamEncryption(input: StartDeliveryStreamEncryptionInput, completion: @escaping (SdkResult<StartDeliveryStreamEncryptionOutput, StartDeliveryStreamEncryptionOutputError>) -> Void)
    ...
    ///             <code>StopDeliveryStreamEncryption</code> 12 times for the same delivery stream in a
    ///          24-hour period.</p>
    func stopDeliveryStreamEncryption(input: StopDeliveryStreamEncryptionInput, completion: @escaping (SdkResult<StopDeliveryStreamEncryptionOutput, StopDeliveryStreamEncryptionOutputError>) -> Void)
    ...
    func tagDeliveryStream(input: TagDeliveryStreamInput, completion: @escaping (SdkResult<TagDeliveryStreamOutput, TagDeliveryStreamOutputError>) -> Void)
    ...
    ///          <p>This operation has a limit of five transactions per second per account. </p>
    func untagDeliveryStream(input: UntagDeliveryStreamInput, completion: @escaping (SdkResult<UntagDeliveryStreamOutput, UntagDeliveryStreamOutputError>) -> Void)
