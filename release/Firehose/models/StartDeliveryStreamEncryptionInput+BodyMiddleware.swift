...
public struct StartDeliveryStreamEncryptionInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<StartDeliveryStreamEncryptionOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<StartDeliveryStreamEncryptionOutput>
