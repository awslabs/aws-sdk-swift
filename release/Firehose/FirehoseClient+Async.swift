...
public extension FirehoseClient {
    ...
    {
        typealias createDeliveryStreamContinuation = CheckedContinuation<CreateDeliveryStreamOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createDeliveryStreamContinuation) in
            createDeliveryStream(input: input) { result in
                switch result {
    ...
    {
        typealias deleteDeliveryStreamContinuation = CheckedContinuation<DeleteDeliveryStreamOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteDeliveryStreamContinuation) in
            deleteDeliveryStream(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeDeliveryStreamContinuation = CheckedContinuation<DescribeDeliveryStreamOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeDeliveryStreamContinuation) in
            describeDeliveryStream(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listDeliveryStreamsContinuation = CheckedContinuation<ListDeliveryStreamsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listDeliveryStreamsContinuation) in
            listDeliveryStreams(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listTagsForDeliveryStreamContinuation = CheckedContinuation<ListTagsForDeliveryStreamOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTagsForDeliveryStreamContinuation) in
            listTagsForDeliveryStream(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putRecordBatchContinuation = CheckedContinuation<PutRecordBatchOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putRecordBatchContinuation) in
            putRecordBatch(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias startDeliveryStreamEncryptionContinuation = CheckedContinuation<StartDeliveryStreamEncryptionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startDeliveryStreamEncryptionContinuation) in
            startDeliveryStreamEncryption(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias stopDeliveryStreamEncryptionContinuation = CheckedContinuation<StopDeliveryStreamEncryptionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopDeliveryStreamEncryptionContinuation) in
            stopDeliveryStreamEncryption(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias tagDeliveryStreamContinuation = CheckedContinuation<TagDeliveryStreamOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: tagDeliveryStreamContinuation) in
            tagDeliveryStream(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias untagDeliveryStreamContinuation = CheckedContinuation<UntagDeliveryStreamOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: untagDeliveryStreamContinuation) in
            untagDeliveryStream(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
