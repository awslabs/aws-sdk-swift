...
public class FirehoseClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try FirehoseClientConfiguration(region: unwrappedRegion)
    ...
    public class FirehoseClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("FirehoseClient")
...
public struct FirehoseClientLogHandlerFactory: SDKLogHandlerFactory {
