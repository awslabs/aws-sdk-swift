...
extension LexRuntimeV2ClientTypes {
    ...
    public struct ActiveContext: Swift.Equatable {
        ...
        /// This member is required.
        var contextAttributes: [Swift.String:Swift.String]?
        ...
        /// This member is required.
        var timeToLive: LexRuntimeV2ClientTypes.ActiveContextTimeToLive?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct AudioInputEvent: Swift.Equatable {
        ...
        var audioChunk: ClientRuntime.Data?
        /// A timestamp set by the client of the date and time that the event was sent to Amazon Lex V2.
        var clientTimestampMillis: Swift.Int
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct ConfigurationEvent: Swift.Equatable {
        ...
        var disablePlayback: Swift.Bool
        /// A unique identifier that your application assigns to the event. You can use this to identify events in logs.
        var eventId: Swift.String?
        ...
        /// This member is required.
        var responseContentType: Swift.String?
        /// The state of the user's session with Amazon Lex V2.
        var sessionState: LexRuntimeV2ClientTypes.SessionState?
        /// A list of messages to send to the user.
        var welcomeMessages: [LexRuntimeV2ClientTypes.Message]?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct DTMFInputEvent: Swift.Equatable {
        ...
        /// This member is required.
        var inputCharacter: Swift.String?
...
public struct DeleteSessionInput: Swift.Equatable {
    ...
    /// This member is required.
    var botAliasId: Swift.String?
    /// The identifier of the bot that contains the session data.
    /// This member is required.
    var botId: Swift.String?
    /// The locale where the session is in use.
    /// This member is required.
    var localeId: Swift.String?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct DialogAction: Swift.Equatable {
        ...
        var slotElicitationStyle: LexRuntimeV2ClientTypes.StyleType?
        ...
        /// This member is required.
        var type: LexRuntimeV2ClientTypes.DialogActionType?
...
public struct GetSessionOutputResponse: Swift.Equatable {
    ...
    var interpretations: [LexRuntimeV2ClientTypes.Interpretation]?
    ...
    var messages: [LexRuntimeV2ClientTypes.Message]?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct ImageResponseCard: Swift.Equatable {
        ...
        var buttons: [LexRuntimeV2ClientTypes.Button]?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct Intent: Swift.Equatable {
        ...
        var confirmationState: LexRuntimeV2ClientTypes.ConfirmationState?
        /// The name of the intent.
        /// This member is required.
        var name: Swift.String?
        /// A map of all of the slots for the intent. The name of the slot maps to the value of the slot. If a slot has not been filled, the value is null.
        var slots: [Swift.String:LexRuntimeV2ClientTypes.Slot]?
        /// Contains fulfillment information for the intent.
        var state: LexRuntimeV2ClientTypes.IntentState?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct IntentResultEvent: Swift.Equatable {
        ...
        var inputMode: LexRuntimeV2ClientTypes.InputMode?
        /// A list of intents that Amazon Lex V2 determined might satisfy the user's utterance. Each interpretation includes the intent, a score that indicates how confident Amazon Lex V2 is that the interpretation is the correct one, and an optional sentiment response that indicates the sentiment expressed in the utterance.
        var interpretations: [LexRuntimeV2ClientTypes.Interpretation]?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct Interpretation: Swift.Equatable {
        ...
        var intent: LexRuntimeV2ClientTypes.Intent?
        ...
        var nluConfidence: LexRuntimeV2ClientTypes.ConfidenceScore?
        ...
        var sentimentResponse: LexRuntimeV2ClientTypes.SentimentResponse?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct Message: Swift.Equatable {
        ...
        /// This member is required.
        var contentType: LexRuntimeV2ClientTypes.MessageContentType?
        /// A card that is shown to the user by a messaging platform. You define the contents of the card, the card is displayed by the platform. When you use a response card, the response from the user is constrained to the text associated with a button on the card.
        var imageResponseCard: LexRuntimeV2ClientTypes.ImageResponseCard?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct PlaybackInterruptionEvent: Swift.Equatable {
        ...
        var causedByEventId: Swift.String?
        /// A unique identifier of the event sent by Amazon Lex V2. The identifier is in the form RESPONSE-N, where N is a number starting with one and incremented for each event sent by Amazon Lex V2 in the current session.
        var eventId: Swift.String?
        /// Indicates the type of user input that Amazon Lex V2 detected.
        var eventReason: LexRuntimeV2ClientTypes.PlaybackInterruptionReason?
...
public struct RecognizeUtteranceInput: Swift.Equatable {
    ...
    /// * text/plain; charset=utf-8
    /// This member is required.
    var requestContentType: Swift.String?
    /// The message that Amazon Lex V2 returns in the response can be either text or speech based on the responseContentType value.
    ///
    /// * If the value is text/plain;charset=utf-8, Amazon Lex V2 returns text in the response.
    ///
...
public struct RecognizeUtteranceOutputResponse: Swift.Equatable {
    ...
    var interpretations: Swift.String?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct SentimentResponse: Swift.Equatable {
        ...
        var sentiment: LexRuntimeV2ClientTypes.SentimentType?
        /// The individual sentiment responses for the utterance.
        var sentimentScore: LexRuntimeV2ClientTypes.SentimentScore?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct SentimentScore: Swift.Equatable {
        ...
        var mixed: Swift.Double
        /// The level of confidence that Amazon Comprehend has in the accuracy of its detection of the NEGATIVE sentiment.
        var negative: Swift.Double
        /// The level of confidence that Amazon Comprehend has in the accuracy of its detection of the NEUTRAL sentiment.
        var neutral: Swift.Double
        /// The level of confidence that Amazon Comprehend has in the accuracy of its detection of the POSITIVE sentiment.
        var positive: Swift.Double
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct SessionState: Swift.Equatable {
        ...
        var activeContexts: [LexRuntimeV2ClientTypes.ActiveContext]?
        /// The next step that Amazon Lex V2 should take in the conversation with a user.
        var dialogAction: LexRuntimeV2ClientTypes.DialogAction?
        /// The active intent that Amazon Lex V2 is processing.
        var intent: LexRuntimeV2ClientTypes.Intent?
        ///
        var originatingRequestId: Swift.String?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct Slot: Swift.Equatable {
        ...
        var shape: LexRuntimeV2ClientTypes.Shape?
        ...
        var values: [LexRuntimeV2ClientTypes.Slot]?
...
public struct StartConversationInput: Swift.Equatable {
    ...
    var conversationMode: LexRuntimeV2ClientTypes.ConversationMode?
    /// The locale where the session is in use.
    /// This member is required.
    var localeId: Swift.String?
    /// Represents the stream of events to Amazon Lex V2 from your application. The events are encoded as HTTP/2 data frames.
    /// This member is required.
    var requestEventStream: LexRuntimeV2ClientTypes.StartConversationRequestEventStream?
    /// The identifier of the user session that is having the conversation.
    /// This member is required.
    var sessionId: Swift.String?
...
public struct StartConversationOutputResponse: Swift.Equatable {
    ...
    var responseEventStream: LexRuntimeV2ClientTypes.StartConversationResponseEventStream?
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct Value: Swift.Equatable {
        ...
        /// This member is required.
        var interpretedValue: Swift.String?
        /// The text of the utterance from the user that was entered for the slot.
        var originalValue: Swift.String?
        /// A list of additional values that have been recognized for the slot.
        var resolvedValues: [Swift.String]?
