...
public struct DeleteSessionInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let botAliasId = input.botAliasId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("botAliasId is nil and needs a value for the path of this operation"))))
        }
        guard let localeId = input.localeId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("localeId is nil and needs a value for the path of this operation"))))
        }
        ...
        var urlPath = "/bots/\(botId.urlPercentEncoding())/botAliases/\(botAliasId.urlPercentEncoding())/botLocales/\(localeId.urlPercentEncoding())/sessions/\(sessionId.urlPercentEncoding())"
...
extension LexRuntimeV2ClientTypes.DialogAction: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DialogAction(slotElicitationStyle: \(Swift.String(describing: slotElicitationStyle)), slotToElicit: \(Swift.String(describing: slotToElicit)), type: \(Swift.String(describing: type)))"}
}
...
public struct RecognizeTextInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RecognizeTextInputURLHostMiddleware"
    ...
    public typealias MInput = RecognizeTextInput
    public typealias MOutput = ClientRuntime.OperationOutput<RecognizeTextOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RecognizeTextOutputError>
}

public struct RecognizeTextInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RecognizeTextInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/bots/\(botId.urlPercentEncoding())/botAliases/\(botAliasId.urlPercentEncoding())/botLocales/\(localeId.urlPercentEncoding())/sessions/\(sessionId.urlPercentEncoding())/text"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct RecognizeUtteranceInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RecognizeUtteranceInputURLHostMiddleware"
    ...
    public typealias MInput = RecognizeUtteranceInput
    public typealias MOutput = ClientRuntime.OperationOutput<RecognizeUtteranceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RecognizeUtteranceOutputError>
}

public struct RecognizeUtteranceInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RecognizeUtteranceInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/bots/\(botId.urlPercentEncoding())/botAliases/\(botAliasId.urlPercentEncoding())/botLocales/\(localeId.urlPercentEncoding())/sessions/\(sessionId.urlPercentEncoding())/utterance"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct StartConversationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartConversationInputURLHostMiddleware"
    ...
    public typealias MInput = StartConversationInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartConversationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartConversationOutputError>
}

public struct StartConversationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartConversationInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/bots/\(botId.urlPercentEncoding())/botAliases/\(botAliasId.urlPercentEncoding())/botLocales/\(localeId.urlPercentEncoding())/sessions/\(sessionId.urlPercentEncoding())/conversation"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
