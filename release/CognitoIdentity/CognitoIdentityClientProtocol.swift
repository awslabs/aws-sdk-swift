...
public protocol CognitoIdentityClientProtocol {
    ...
    func getPrincipalTagAttributeMap(input: GetPrincipalTagAttributeMapInput, completion: @escaping (SdkResult<GetPrincipalTagAttributeMapOutput, GetPrincipalTagAttributeMapOutputError>) -> Void)
    ...
    func setPrincipalTagAttributeMap(input: SetPrincipalTagAttributeMapInput, completion: @escaping (SdkResult<SetPrincipalTagAttributeMapOutput, SetPrincipalTagAttributeMapOutputError>) -> Void)
