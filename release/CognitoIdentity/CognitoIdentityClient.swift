...
public class CognitoIdentityClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try CognitoIdentityClientConfiguration(region: unwrappedRegion)
    ...
    public class CognitoIdentityClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("CognitoIdentityClient")
