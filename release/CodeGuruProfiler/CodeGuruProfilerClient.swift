...
public class CodeGuruProfilerClient {
    ...
    public class CodeGuruProfilerClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("CodeGuruProfilerClient")
