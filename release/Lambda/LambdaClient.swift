...
public class LambdaClient {
    ...
    public init(config: LambdaClientConfiguration) {
    ...
    public class LambdaClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "LambdaClient")
        }
        ...
        public static func `default`() throws -> LambdaClientConfiguration {
            ...
            return try LambdaClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
