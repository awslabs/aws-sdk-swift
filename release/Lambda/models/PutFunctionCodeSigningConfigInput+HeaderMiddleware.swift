...
public struct PutFunctionCodeSigningConfigInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<PutFunctionCodeSigningConfigOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<PutFunctionCodeSigningConfigOutput>
