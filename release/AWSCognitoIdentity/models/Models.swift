...
extension CognitoIdentityClientTypes {
    ...
    public struct CognitoIdentityProvider: Swift.Equatable {
        ...
        var serverSideTokenCheck: Swift.Bool
...
public struct CreateIdentityPoolInput: Swift.Equatable {
    ...
    var allowClassicFlow: Swift.Bool?
    /// TRUE if the identity pool supports unauthenticated logins.
    /// This member is required.
    var allowUnauthenticatedIdentities: Swift.Bool
    /// An array of Amazon Cognito user pools and their client IDs.
    var cognitoIdentityProviders: [CognitoIdentityClientTypes.CognitoIdentityProvider]?
    ...
    var developerProviderName: Swift.String?
    /// A string that you provide.
    /// This member is required.
    var identityPoolName: Swift.String?
    /// Tags to assign to the identity pool. A tag is a label that you can apply to identity pools to categorize and manage them in different ways, such as by purpose, owner, environment, or other criteria.
    var identityPoolTags: [Swift.String:Swift.String]?
    /// The Amazon Resource Names (ARN) of the OpenID Connect providers.
    var openIdConnectProviderARNs: [Swift.String]?
    /// An array of Amazon Resource Names (ARNs) of the SAML provider for your identity pool.
    var samlProviderARNs: [Swift.String]?
    /// Optional key:value pairs mapping provider names to provider app IDs.
    var supportedLoginProviders: [Swift.String:Swift.String]?
...
public struct DeleteIdentitiesInput: Swift.Equatable {
    ...
    /// This member is required.
    var identityIdsToDelete: [Swift.String]?
...
public struct DeleteIdentitiesOutputResponse: Swift.Equatable {
    ...
    var unprocessedIdentityIds: [CognitoIdentityClientTypes.UnprocessedIdentityId]?
...
public struct GetCredentialsForIdentityInput: Swift.Equatable {
    ...
    var customRoleArn: Swift.String?
    /// A unique identifier in the format REGION:GUID.
    /// This member is required.
    var identityId: Swift.String?
    ...
    var logins: [Swift.String:Swift.String]?
...
public struct GetIdentityPoolRolesOutputResponse: Swift.Equatable {
    ...
    var roleMappings: [Swift.String:CognitoIdentityClientTypes.RoleMapping]?
    /// The map of roles associated with this pool. Currently only authenticated and unauthenticated roles are supported.
    var roles: [Swift.String:Swift.String]?
...
public struct GetOpenIdTokenForDeveloperIdentityInput: Swift.Equatable {
    ...
    var principalTags: [Swift.String:Swift.String]?
...
public struct GetPrincipalTagAttributeMapInput: Swift.Equatable {
    ...
    /// This member is required.
    var identityProviderName: Swift.String?
...
public struct ListIdentitiesOutputResponse: Swift.Equatable {
    ...
    var identities: [CognitoIdentityClientTypes.IdentityDescription]?
    /// An identity pool ID in the format REGION:GUID.
    var identityPoolId: Swift.String?
    /// A pagination token.
    var nextToken: Swift.String?
...
public struct ListIdentityPoolsOutputResponse: Swift.Equatable {
    ...
    var identityPools: [CognitoIdentityClientTypes.IdentityPoolShortDescription]?
    /// A pagination token.
    var nextToken: Swift.String?
...
public struct LookupDeveloperIdentityInput: Swift.Equatable {
    ...
    var developerUserIdentifier: Swift.String?
    /// A unique identifier in the format REGION:GUID.
    var identityId: Swift.String?
    /// An identity pool ID in the format REGION:GUID.
    /// This member is required.
...
public struct LookupDeveloperIdentityOutputResponse: Swift.Equatable {
    ...
    var developerUserIdentifierList: [Swift.String]?
    /// A unique identifier in the format REGION:GUID.
    var identityId: Swift.String?
    /// A pagination token. The first call you make will have NextToken set to null. After that the service will return NextToken values as needed. For example, let's say you make a request with MaxResults set to 10, and there are 20 matches in the database. The service will return a pagination token as a part of the response. This token can be used to call the API again and get results starting from the 11th match.
    var nextToken: Swift.String?
...
extension CognitoIdentityClientTypes {
    ...
    public struct MappingRule: Swift.Equatable {
        ...
        /// This member is required.
        var claim: Swift.String?
        /// The match condition that specifies how closely the claim value in the IdP token must match Value.
        /// This member is required.
        var matchType: CognitoIdentityClientTypes.MappingRuleMatchType?
        /// The role ARN.
        /// This member is required.
...
public struct MergeDeveloperIdentitiesInput: Swift.Equatable {
    ...
    /// This member is required.
    var destinationUserIdentifier: Swift.String?
    ...
    /// This member is required.
    var sourceUserIdentifier: Swift.String?
...
extension CognitoIdentityClientTypes {
    ...
    public struct RoleMapping: Swift.Equatable {
        ...
        var ambiguousRoleResolution: CognitoIdentityClientTypes.AmbiguousRoleResolutionType?
        /// The rules to be used for mapping users to roles. If you specify Rules as the role mapping type, RulesConfiguration is required.
        var rulesConfiguration: CognitoIdentityClientTypes.RulesConfigurationType?
        /// The role mapping type. Token will use cognito:roles and cognito:preferred_role claims from the Cognito identity provider token to map groups to roles. Rules will attempt to match claims from the token to map to a role.
        /// This member is required.
        var type: CognitoIdentityClientTypes.RoleMappingType?
...
extension CognitoIdentityClientTypes {
    ...
    public struct RulesConfigurationType: Swift.Equatable {
        ...
        /// This member is required.
        var rules: [CognitoIdentityClientTypes.MappingRule]?
...
public struct UnlinkIdentityInput: Swift.Equatable {
    ...
    /// This member is required.
    var loginsToRemove: [Swift.String]?
...
extension CognitoIdentityClientTypes {
    ...
    public struct UnprocessedIdentityId: Swift.Equatable {
        ...
        var errorCode: CognitoIdentityClientTypes.ErrorCode?
        /// A unique identifier in the format REGION:GUID.
        var identityId: Swift.String?
