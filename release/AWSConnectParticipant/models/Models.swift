...
extension CreateParticipantConnectionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateParticipantConnectionInput(connectParticipant: \(Swift.String(describing: connectParticipant)), participantToken: \(Swift.String(describing: participantToken)), type: \(Swift.String(describing: type)))"}
}
...
struct CreateParticipantConnectionInputBody: Swift.Equatable {
    ...
    public let connectParticipant: Swift.Bool?
}
