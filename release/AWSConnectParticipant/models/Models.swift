...
extension ConnectParticipantClientTypes {
    ...
    public struct AttachmentItem: Swift.Equatable {
        ...
        var attachmentName: Swift.String?
        ...
        var status: ConnectParticipantClientTypes.ArtifactStatus?
...
public struct CompleteAttachmentUploadInput: Swift.Equatable {
    ...
    /// This member is required.
    var attachmentIds: [Swift.String]?
    /// A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.
    /// This member is required.
    var clientToken: Swift.String?
    /// The authentication token associated with the participant's connection.
    /// This member is required.
    var connectionToken: Swift.String?
...
public struct CreateParticipantConnectionInput: Swift.Equatable {
    ...
    var connectParticipant: Swift.Bool?
    ...
    /// This member is required.
    var participantToken: Swift.String?
    /// Type of connection information required.
    /// This member is required.
    var type: [ConnectParticipantClientTypes.ConnectionType]?
...
public struct CreateParticipantConnectionOutputResponse: Swift.Equatable {
    ...
    var connectionCredentials: ConnectParticipantClientTypes.ConnectionCredentials?
    /// Creates the participant's websocket connection.
    var websocket: ConnectParticipantClientTypes.Websocket?
...
public struct GetTranscriptInput: Swift.Equatable {
    ...
    var scanDirection: ConnectParticipantClientTypes.ScanDirection?
    /// The sort order for the records. Default: DESCENDING.
    var sortOrder: ConnectParticipantClientTypes.SortKey?
    /// A filtering option for where to start.
    var startPosition: ConnectParticipantClientTypes.StartPosition?
...
public struct GetTranscriptOutputResponse: Swift.Equatable {
    ...
    var initialContactId: Swift.String?
    /// The pagination token. Use the value returned previously in the next subsequent request to retrieve the next set of results.
    var nextToken: Swift.String?
    /// The list of messages in the session.
    var transcript: [ConnectParticipantClientTypes.Item]?
...
extension ConnectParticipantClientTypes {
    ...
    public struct Item: Swift.Equatable {
        ...
        var absoluteTime: Swift.String?
        /// Provides information about the attachments.
        var attachments: [ConnectParticipantClientTypes.AttachmentItem]?
        ...
        var participantRole: ConnectParticipantClientTypes.ParticipantRole?
        /// Type of the item: message or event.
        var type: ConnectParticipantClientTypes.ChatItemType?
...
public struct StartAttachmentUploadInput: Swift.Equatable {
    ...
    /// This member is required.
    var attachmentSizeInBytes: Swift.Int
...
public struct StartAttachmentUploadOutputResponse: Swift.Equatable {
    ...
    var uploadMetadata: ConnectParticipantClientTypes.UploadMetadata?
...
extension ConnectParticipantClientTypes {
    ...
    public struct Websocket: Swift.Equatable {
        ...
        var connectionExpiry: Swift.String?
