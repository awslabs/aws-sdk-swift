...
public extension DataPipelineClient {
    ...
    {
        typealias activatePipelineContinuation = CheckedContinuation<ActivatePipelineOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: activatePipelineContinuation) in
            activatePipeline(input: input) { result in
                switch result {
    ...
    {
        typealias deactivatePipelineContinuation = CheckedContinuation<DeactivatePipelineOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deactivatePipelineContinuation) in
            deactivatePipeline(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeObjectsContinuation = CheckedContinuation<DescribeObjectsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeObjectsContinuation) in
            describeObjects(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describePipelinesContinuation = CheckedContinuation<DescribePipelinesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describePipelinesContinuation) in
            describePipelines(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias evaluateExpressionContinuation = CheckedContinuation<EvaluateExpressionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: evaluateExpressionContinuation) in
            evaluateExpression(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getPipelineDefinitionContinuation = CheckedContinuation<GetPipelineDefinitionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getPipelineDefinitionContinuation) in
            getPipelineDefinition(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias pollForTaskContinuation = CheckedContinuation<PollForTaskOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: pollForTaskContinuation) in
            pollForTask(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putPipelineDefinitionContinuation = CheckedContinuation<PutPipelineDefinitionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putPipelineDefinitionContinuation) in
            putPipelineDefinition(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias queryObjectsContinuation = CheckedContinuation<QueryObjectsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: queryObjectsContinuation) in
            queryObjects(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias reportTaskProgressContinuation = CheckedContinuation<ReportTaskProgressOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: reportTaskProgressContinuation) in
            reportTaskProgress(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias reportTaskRunnerHeartbeatContinuation = CheckedContinuation<ReportTaskRunnerHeartbeatOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: reportTaskRunnerHeartbeatContinuation) in
            reportTaskRunnerHeartbeat(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias setStatusContinuation = CheckedContinuation<SetStatusOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: setStatusContinuation) in
            setStatus(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias setTaskStatusContinuation = CheckedContinuation<SetTaskStatusOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: setTaskStatusContinuation) in
            setTaskStatus(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias validatePipelineDefinitionContinuation = CheckedContinuation<ValidatePipelineDefinitionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: validatePipelineDefinitionContinuation) in
            validatePipelineDefinition(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
