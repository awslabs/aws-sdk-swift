...
public enum ActivatePipelineOutputError: Swift.Error, Equatable {
...
public enum DeactivatePipelineOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
...
public enum DescribeObjectsOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
...
public enum DescribePipelinesOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
...
public enum EvaluateExpressionOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
...
public enum GetPipelineDefinitionOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
...
public enum PollForTaskOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case taskNotFoundException(TaskNotFoundException)
    case unknown(UnknownAWSHttpServiceError)
...
public enum PutPipelineDefinitionOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
...
public enum QueryObjectsOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
...
public enum ReportTaskProgressOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
...
public enum ReportTaskRunnerHeartbeatOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case unknown(UnknownAWSHttpServiceError)
}
...
public enum SetStatusOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
...
public enum SetTaskStatusOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
...
public enum ValidatePipelineDefinitionOutputError: Swift.Error, Equatable {
    case internalServiceError(InternalServiceError)
    case invalidRequestException(InvalidRequestException)
    case pipelineDeletedException(PipelineDeletedException)
    case pipelineNotFoundException(PipelineNotFoundException)
