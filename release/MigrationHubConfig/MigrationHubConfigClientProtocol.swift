...
public protocol MigrationHubConfigClientProtocol {
    ...
    func createHomeRegionControl(input: CreateHomeRegionControlInput, completion: @escaping (SdkResult<CreateHomeRegionControlOutput, CreateHomeRegionControlOutputError>) -> Void)
    /// <p>This API permits filtering on the <code>ControlId</code> and <code>HomeRegion</code>
    ///       fields.</p>
    func describeHomeRegionControls(input: DescribeHomeRegionControlsInput, completion: @escaping (SdkResult<DescribeHomeRegionControlsOutput, DescribeHomeRegionControlsOutputError>) -> Void)
    ...
    func getHomeRegion(input: GetHomeRegionInput, completion: @escaping (SdkResult<GetHomeRegionOutput, GetHomeRegionOutputError>) -> Void)
}
