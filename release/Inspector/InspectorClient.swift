...
public class InspectorClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try InspectorClientConfiguration(region: unwrappedRegion)
    ...
    public class InspectorClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("InspectorClient")
