...
extension InspectorClientTypes {
    ...
    public struct AgentFilter: Swift.Equatable {
        ...
        public let agentHealthCodes: [InspectorClientTypes.AgentHealthCode]?
        /// <p>The current health state of the agent. Values can be set to <b>HEALTHY</b> or <b>UNHEALTHY</b>.</p>
        public let agentHealths: [InspectorClientTypes.AgentHealth]?
...
extension InspectorClientTypes {
    ...
    public struct AgentPreview: Swift.Equatable {
        ...
        public let agentHealth: InspectorClientTypes.AgentHealth?
        ...
        public let autoScalingGroup: Swift.String?
        ...
        ///          installed.</p>
        public let ipv4Address: Swift.String?
...
extension AgentsAlreadyRunningAssessmentException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct AgentsAlreadyRunningAssessmentException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension InspectorClientTypes {
    ...
    public struct AssessmentRun: Swift.Equatable {
        ...
        public let dataCollected: Swift.Bool?
        ...
        public let findingCounts: [Swift.String:Swift.Int]?
        ...
        public let notifications: [InspectorClientTypes.AssessmentRunNotification]?
        ...
        public let state: InspectorClientTypes.AssessmentRunState?
        /// <p>The last time when the assessment run's state changed.</p>
        public let stateChangedAt: ClientRuntime.Date?
        /// <p>A list of the assessment run state changes.</p>
        public let stateChanges: [InspectorClientTypes.AssessmentRunStateChange]?
...
extension InspectorClientTypes {
    ...
    public struct AssessmentRunAgent: Swift.Equatable {
        ...
        public let agentHealthCode: InspectorClientTypes.AgentHealthCode?
        /// <p>The description for the agent health code.</p>
        public let agentHealthDetails: Swift.String?
...
extension InspectorClientTypes {
    ...
    public struct AssessmentRunFilter: Swift.Equatable {
        ...
        public let completionTimeRange: InspectorClientTypes.TimestampRange?
        /// <p>For a record to match a filter, the value that is specified for this data type
        ///          property must inclusively match any value between the specified minimum and maximum values
        ///          of the <b>durationInSeconds</b> property of the <a>AssessmentRun</a> data type.</p>
        public let durationRange: InspectorClientTypes.DurationRange?
        ...
        ///          data type.</p>
        public let namePattern: Swift.String?
        /// <p>For a record to match a filter, the value that is specified for this data type
        ...
        public let startTimeRange: InspectorClientTypes.TimestampRange?
        /// <p>For a record to match a filter, the value that is specified for this data type
        ///          property must match the <b>stateChangedAt</b> property of the
        ///             <a>AssessmentRun</a> data type.</p>
        public let stateChangeTimeRange: InspectorClientTypes.TimestampRange?
        ...
        ///          type.</p>
        public let states: [InspectorClientTypes.AssessmentRunState]?
...
extension AssessmentRunInProgressException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
///          progress.</p>
public struct AssessmentRunInProgressException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension InspectorClientTypes {
    ...
    public struct AssessmentRunNotification: Swift.Equatable {
        ...
        public let snsPublishStatusCode: InspectorClientTypes.AssessmentRunNotificationSnsStatusCode?
...
extension InspectorClientTypes {
    ...
    public struct AssessmentTargetFilter: Swift.Equatable {
        ...
        public let assessmentTargetNamePattern: Swift.String?
...
extension InspectorClientTypes {
    ...
    public struct AssessmentTemplate: Swift.Equatable {
        ...
        public let assessmentRunCount: Swift.Int?
        ...
        public let lastAssessmentRunArn: Swift.String?
...
extension InspectorClientTypes {
    ...
    public struct AssetAttributes: Swift.Equatable {
        ...
        public let networkInterfaces: [InspectorClientTypes.NetworkInterface]?
...
extension InspectorClientTypes {
    ...
    public struct EventSubscription: Swift.Equatable {
        ...
        public let subscribedAt: ClientRuntime.Date?
...
extension InspectorClientTypes {
    ...
    public struct Exclusion: Swift.Equatable {
        ...
        public let scopes: [InspectorClientTypes.Scope]?
...
extension InspectorClientTypes {
    ...
    public struct FailedItemDetails: Swift.Equatable {
        ...
        public let failureCode: InspectorClientTypes.FailedItemErrorCode?
...
extension InspectorClientTypes {
    ...
    public struct Finding: Swift.Equatable {
        ...
        public let arn: Swift.String?
        /// <p>A collection of attributes of the host from which the finding is generated.</p>
        public let assetAttributes: InspectorClientTypes.AssetAttributes?
        /// <p>The type of the host from which the finding is generated.</p>
        public let assetType: InspectorClientTypes.AssetType?
        ...
        /// <p>This data element is currently not used.</p>
        public let indicatorOfCompromise: Swift.Bool?
        /// <p>The numeric value of the finding severity.</p>
        public let numericSeverity: Swift.Double
        ...
        public let serviceAttributes: InspectorClientTypes.InspectorServiceAttributes?
        /// <p>The finding severity. Values can be set to High, Medium, Low, and
        ///          Informational.</p>
        public let severity: InspectorClientTypes.Severity?
        ...
        public let userAttributes: [InspectorClientTypes.Attribute]?
...
extension InspectorClientTypes {
    ...
    public struct FindingFilter: Swift.Equatable {
        ...
        ///          type.</p>
        public let autoScalingGroups: [Swift.String]?
        /// <p>The time range during which the finding is generated.</p>
        public let creationTimeRange: InspectorClientTypes.TimestampRange?
        /// <p>For a record to match a filter, one of the values that is specified for this data
        ...
        public let severities: [InspectorClientTypes.Severity]?
        /// <p>For a record to match a filter, the value that is specified for this data type
...
extension InspectorClientTypes {
    ...
    public struct InspectorServiceAttributes: Swift.Equatable {
        ...
        public let rulesPackageArn: Swift.String?
        /// <p>The schema version of this data type.</p>
        public let schemaVersion: Swift.Int
...
extension InvalidCrossAccountRoleException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct InvalidCrossAccountRoleException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension InspectorClientTypes {
    ...
    public struct NetworkInterface: Swift.Equatable {
        ...
        public let privateIpAddresses: [InspectorClientTypes.PrivateIp]?
        ...
        public let securityGroups: [InspectorClientTypes.SecurityGroup]?
...
extension NoSuchEntityException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct NoSuchEntityException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension PreviewGenerationInProgressException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
///          exclusions preview.</p>
public struct PreviewGenerationInProgressException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension InspectorClientTypes {
    ...
    public struct ResourceGroup: Swift.Equatable {
        ...
        public let tags: [InspectorClientTypes.ResourceGroupTag]?
...
extension InspectorClientTypes {
    ...
    public struct Scope: Swift.Equatable {
        ...
        public let key: InspectorClientTypes.ScopeType?
...
extension ServiceTemporarilyUnavailableException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct ServiceTemporarilyUnavailableException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension InspectorClientTypes {
    ...
    public struct Subscription: Swift.Equatable {
        ...
        public let eventSubscriptions: [InspectorClientTypes.EventSubscription]?
...
extension InspectorClientTypes {
    ...
    public struct TimestampRange: Swift.Equatable {
        ...
        public let beginDate: ClientRuntime.Date?
...
extension UnsupportedFeatureException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
///          available.</p>
public struct UnsupportedFeatureException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
