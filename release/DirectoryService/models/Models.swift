...
extension DirectoryClientTypes {
    ...
    public struct ClientAuthenticationSettingInfo: Swift.Equatable {
        ...
        public let status: DirectoryClientTypes.ClientAuthenticationStatus?
...
public struct CreateDirectoryInput: Swift.Equatable {
    ...
    ///
    ///
    ///          For additional information about how Active Directory passwords are enforced, see <a href="https://docs.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/password-must-meet-complexity-requirements">Password must meet complexity requirements on the Microsoft website.
    /// This member is required.
    public let password: Swift.String?
...
public struct DescribeClientAuthenticationSettingsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeClientAuthenticationSettingsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeClientAuthenticationSettingsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeClientAuthenticationSettingsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeClientAuthenticationSettingsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeClientAuthenticationSettingsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeClientAuthenticationSettingsOutputError>
}
...
public struct DescribeClientAuthenticationSettingsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeClientAuthenticationSettingsInputHeadersMiddleware"
...
public struct DescribeClientAuthenticationSettingsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeClientAuthenticationSettingsInputQueryItemMiddleware"
