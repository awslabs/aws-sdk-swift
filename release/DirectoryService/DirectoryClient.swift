...
public class DirectoryClient {
    ...
    let config: DirectoryClientConfiguration
    let serviceName = "Directory"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: DirectoryClientConfiguration) {
    ...
    public class DirectoryClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "DirectoryClient")
        }
        ...
        public static func `default`() throws -> DirectoryClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try DirectoryClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}

public struct DirectoryClientLogHandlerFactory: SDKLogHandlerFactory {
