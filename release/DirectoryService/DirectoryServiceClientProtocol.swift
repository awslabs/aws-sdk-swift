...
public protocol DirectoryServiceClientProtocol {
    ...
    func acceptSharedDirectory(input: AcceptSharedDirectoryInput, completion: @escaping (SdkResult<AcceptSharedDirectoryOutput, AcceptSharedDirectoryOutputError>) -> Void)
    ...
    func addIpRoutes(input: AddIpRoutesInput, completion: @escaping (SdkResult<AddIpRoutesOutput, AddIpRoutesOutputError>) -> Void)
    /// <p>Adds two domain controllers in the specified Region for the specified directory.</p>
    func addRegion(input: AddRegionInput, completion: @escaping (SdkResult<AddRegionOutput, AddRegionOutputError>) -> Void)
    ...
    func cancelSchemaExtension(input: CancelSchemaExtensionInput, completion: @escaping (SdkResult<CancelSchemaExtensionOutput, CancelSchemaExtensionOutputError>) -> Void)
    ...
    ///       Reference</a>.</p>
    func connectDirectory(input: ConnectDirectoryInput, completion: @escaping (SdkResult<ConnectDirectoryOutput, ConnectDirectoryOutputError>) -> Void)
    ...
    func createComputer(input: CreateComputerInput, completion: @escaping (SdkResult<CreateComputerOutput, CreateComputerOutputError>) -> Void)
    ...
    func createConditionalForwarder(input: CreateConditionalForwarderInput, completion: @escaping (SdkResult<CreateConditionalForwarderOutput, CreateConditionalForwarderOutputError>) -> Void)
    ...
    func createLogSubscription(input: CreateLogSubscriptionInput, completion: @escaping (SdkResult<CreateLogSubscriptionOutput, CreateLogSubscriptionOutputError>) -> Void)
    ...
    func createMicrosoftAD(input: CreateMicrosoftADInput, completion: @escaping (SdkResult<CreateMicrosoftADOutput, CreateMicrosoftADOutputError>) -> Void)
    ...
    func createTrust(input: CreateTrustInput, completion: @escaping (SdkResult<CreateTrustOutput, CreateTrustOutputError>) -> Void)
    /// <p>Deletes a conditional forwarder that has been set up for your AWS directory.</p>
    func deleteConditionalForwarder(input: DeleteConditionalForwarderInput, completion: @escaping (SdkResult<DeleteConditionalForwarderOutput, DeleteConditionalForwarderOutputError>) -> Void)
    ...
    func deleteLogSubscription(input: DeleteLogSubscriptionInput, completion: @escaping (SdkResult<DeleteLogSubscriptionOutput, DeleteLogSubscriptionOutputError>) -> Void)
    ...
    func deleteTrust(input: DeleteTrustInput, completion: @escaping (SdkResult<DeleteTrustOutput, DeleteTrustOutputError>) -> Void)
    /// <p>Deletes from the system the certificate that was registered for secure LDAP or client certificate authentication.</p>
    func deregisterCertificate(input: DeregisterCertificateInput, completion: @escaping (SdkResult<DeregisterCertificateOutput, DeregisterCertificateOutputError>) -> Void)
    /// <p>Removes the specified directory as a publisher to the specified SNS topic.</p>
    func deregisterEventTopic(input: DeregisterEventTopicInput, completion: @escaping (SdkResult<DeregisterEventTopicOutput, DeregisterEventTopicOutputError>) -> Void)
    ...
    func describeConditionalForwarders(input: DescribeConditionalForwardersInput, completion: @escaping (SdkResult<DescribeConditionalForwardersOutput, DescribeConditionalForwardersOutputError>) -> Void)
    ...
    ///       parameter.</p>
    func describeDirectories(input: DescribeDirectoriesInput, completion: @escaping (SdkResult<DescribeDirectoriesOutput, DescribeDirectoriesOutputError>) -> Void)
    /// <p>Provides information about any domain controllers in your directory.</p>
    func describeDomainControllers(input: DescribeDomainControllersInput, completion: @escaping (SdkResult<DescribeDomainControllersOutput, DescribeDomainControllersOutputError>) -> Void)
    ...
    func describeEventTopics(input: DescribeEventTopicsInput, completion: @escaping (SdkResult<DescribeEventTopicsOutput, DescribeEventTopicsOutputError>) -> Void)
    /// <p>Describes the status of LDAP security for the specified directory.</p>
    func describeLDAPSSettings(input: DescribeLDAPSSettingsInput, completion: @escaping (SdkResult<DescribeLDAPSSettingsOutput, DescribeLDAPSSettingsOutputError>) -> Void)
    ...
    func describeSharedDirectories(input: DescribeSharedDirectoriesInput, completion: @escaping (SdkResult<DescribeSharedDirectoriesOutput, DescribeSharedDirectoriesOutputError>) -> Void)
    ...
    func describeTrusts(input: DescribeTrustsInput, completion: @escaping (SdkResult<DescribeTrustsOutput, DescribeTrustsOutputError>) -> Void)
    /// <p>Disables alternative client authentication methods for the specified directory. </p>
    func disableClientAuthentication(input: DisableClientAuthenticationInput, completion: @escaping (SdkResult<DisableClientAuthenticationOutput, DisableClientAuthenticationOutputError>) -> Void)
    /// <p>Deactivates LDAP secure calls for the specified directory.</p>
    func disableLDAPS(input: DisableLDAPSInput, completion: @escaping (SdkResult<DisableLDAPSOutput, DisableLDAPSOutputError>) -> Void)
    ...
    func disableRadius(input: DisableRadiusInput, completion: @escaping (SdkResult<DisableRadiusOutput, DisableRadiusOutputError>) -> Void)
    /// <p>Disables single-sign on for a directory.</p>
    func disableSso(input: DisableSsoInput, completion: @escaping (SdkResult<DisableSsoOutput, DisableSsoOutputError>) -> Void)
    /// <p>Enables alternative client authentication methods for the specified directory.</p>
    func enableClientAuthentication(input: EnableClientAuthenticationInput, completion: @escaping (SdkResult<EnableClientAuthenticationOutput, EnableClientAuthenticationOutputError>) -> Void)
    /// <p>Activates the switch for the specific directory to always use LDAP secure calls.</p>
    func enableLDAPS(input: EnableLDAPSInput, completion: @escaping (SdkResult<EnableLDAPSOutput, EnableLDAPSOutputError>) -> Void)
    ...
    func enableRadius(input: EnableRadiusInput, completion: @escaping (SdkResult<EnableRadiusOutput, EnableRadiusOutputError>) -> Void)
    ...
    func enableSso(input: EnableSsoInput, completion: @escaping (SdkResult<EnableSsoOutput, EnableSsoOutputError>) -> Void)
    /// <p>Obtains directory limit information for the current Region.</p>
    func getDirectoryLimits(input: GetDirectoryLimitsInput, completion: @escaping (SdkResult<GetDirectoryLimitsOutput, GetDirectoryLimitsOutputError>) -> Void)
    /// <p>Obtains the manual snapshot limits for a directory.</p>
    func getSnapshotLimits(input: GetSnapshotLimitsInput, completion: @escaping (SdkResult<GetSnapshotLimitsOutput, GetSnapshotLimitsOutputError>) -> Void)
    ...
    func listIpRoutes(input: ListIpRoutesInput, completion: @escaping (SdkResult<ListIpRoutesOutput, ListIpRoutesOutputError>) -> Void)
    /// <p>Lists the active log subscriptions for the AWS account.</p>
    func listLogSubscriptions(input: ListLogSubscriptionsInput, completion: @escaping (SdkResult<ListLogSubscriptionsOutput, ListLogSubscriptionsOutputError>) -> Void)
    /// <p>Lists all schema extensions applied to a Microsoft AD Directory.</p>
    func listSchemaExtensions(input: ListSchemaExtensionsInput, completion: @escaping (SdkResult<ListSchemaExtensionsOutput, ListSchemaExtensionsOutputError>) -> Void)
    ...
    func registerCertificate(input: RegisterCertificateInput, completion: @escaping (SdkResult<RegisterCertificateOutput, RegisterCertificateOutputError>) -> Void)
    ...
    func registerEventTopic(input: RegisterEventTopicInput, completion: @escaping (SdkResult<RegisterEventTopicOutput, RegisterEventTopicOutputError>) -> Void)
    /// <p>Rejects a directory sharing request that was sent from the directory owner account.</p>
    func rejectSharedDirectory(input: RejectSharedDirectoryInput, completion: @escaping (SdkResult<RejectSharedDirectoryOutput, RejectSharedDirectoryOutputError>) -> Void)
    /// <p>Removes IP address blocks from a directory.</p>
    func removeIpRoutes(input: RemoveIpRoutesInput, completion: @escaping (SdkResult<RemoveIpRoutesOutput, RemoveIpRoutesOutputError>) -> Void)
    ...
    func removeRegion(input: RemoveRegionInput, completion: @escaping (SdkResult<RemoveRegionOutput, RemoveRegionOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func resetUserPassword(input: ResetUserPasswordInput, completion: @escaping (SdkResult<ResetUserPasswordOutput, ResetUserPasswordOutputError>) -> Void)
    ...
    func restoreFromSnapshot(input: RestoreFromSnapshotInput, completion: @escaping (SdkResult<RestoreFromSnapshotOutput, RestoreFromSnapshotOutputError>) -> Void)
    ...
    func shareDirectory(input: ShareDirectoryInput, completion: @escaping (SdkResult<ShareDirectoryOutput, ShareDirectoryOutputError>) -> Void)
    /// <p>Applies a schema extension to a Microsoft AD directory.</p>
    func startSchemaExtension(input: StartSchemaExtensionInput, completion: @escaping (SdkResult<StartSchemaExtensionOutput, StartSchemaExtensionOutputError>) -> Void)
    /// <p>Stops the directory sharing between the directory owner and consumer accounts. </p>
    func unshareDirectory(input: UnshareDirectoryInput, completion: @escaping (SdkResult<UnshareDirectoryOutput, UnshareDirectoryOutputError>) -> Void)
    /// <p>Updates a conditional forwarder that has been set up for your AWS directory.</p>
    func updateConditionalForwarder(input: UpdateConditionalForwarderInput, completion: @escaping (SdkResult<UpdateConditionalForwarderOutput, UpdateConditionalForwarderOutputError>) -> Void)
    ...
    func updateNumberOfDomainControllers(input: UpdateNumberOfDomainControllersInput, completion: @escaping (SdkResult<UpdateNumberOfDomainControllersOutput, UpdateNumberOfDomainControllersOutputError>) -> Void)
    ...
    func updateRadius(input: UpdateRadiusInput, completion: @escaping (SdkResult<UpdateRadiusOutput, UpdateRadiusOutputError>) -> Void)
    ...
    func updateTrust(input: UpdateTrustInput, completion: @escaping (SdkResult<UpdateTrustOutput, UpdateTrustOutputError>) -> Void)
    ...
    func verifyTrust(input: VerifyTrustInput, completion: @escaping (SdkResult<VerifyTrustOutput, VerifyTrustOutputError>) -> Void)
}
