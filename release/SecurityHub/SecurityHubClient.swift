...
public class SecurityHubClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try SecurityHubClientConfiguration(region: unwrappedRegion)
    ...
    public class SecurityHubClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("SecurityHubClient")
...
public struct SecurityHubClientLogHandlerFactory: SDKLogHandlerFactory {
