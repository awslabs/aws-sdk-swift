...
public struct CreateLicenseManagerReportGeneratorInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<CreateLicenseManagerReportGeneratorOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<CreateLicenseManagerReportGeneratorOutput>
