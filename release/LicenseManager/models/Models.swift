...
public struct GetServiceSettingsOutputResponse: Swift.Equatable {
    ...
    /// Amazon Resource Name (ARN) of the AWS resource share. The License Manager management account
...
extension LicenseManagerClientTypes {
    ...
    public struct ProductInformation: Swift.Equatable {
        ...
        ///
        ///
        ///                   AccountId - The 12-digit ID of an AWS account you wish to exclude from automated discovery.
...
extension LicenseManagerClientTypes {
    ...
    public struct ReceivedMetadata: Swift.Equatable {
        ...
        public let receivedStatusReason: Swift.String?
