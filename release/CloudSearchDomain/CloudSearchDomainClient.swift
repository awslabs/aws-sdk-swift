...
extension CloudSearchDomainClient: CloudSearchDomainClientProtocol {
    ...
    public func search(input: SearchInput, completion: @escaping (SdkResult<SearchOutput, SearchOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SearchInput, SearchOutput, SearchOutputError>(contentType: "application/json"))
    ...
    public func suggest(input: SuggestInput, completion: @escaping (SdkResult<SuggestOutput, SuggestOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cloudsearch")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SuggestInput, SuggestOutput, SuggestOutputError>(id: "suggest")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SuggestInput, SuggestOutput, SuggestOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func uploadDocuments(input: UploadDocumentsInput, streamSource: StreamSource, completion: @escaping (SdkResult<UploadDocumentsOutput, UploadDocumentsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cloudsearch")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UploadDocumentsInput, UploadDocumentsOutput, UploadDocumentsOutputError>(id: "uploadDocuments")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UploadDocumentsInput, UploadDocumentsOutput, UploadDocumentsOutputError>(contentType: "application/json"))
