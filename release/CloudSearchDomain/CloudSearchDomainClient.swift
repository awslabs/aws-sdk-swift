...
extension CloudSearchDomainClient: CloudSearchDomainClientProtocol {
    ...
    public func uploadDocuments(input: UploadDocumentsInput, streamSource: StreamSource, completion: @escaping (SdkResult<UploadDocumentsOutputResponse, UploadDocumentsOutputError>) -> Void)
    {
