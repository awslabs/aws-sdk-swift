...
extension CloudSearchDomainClientTypes.Bucket: Swift.Codable, ClientRuntime.Reflection {
...
extension CloudSearchDomainClientTypes.Bucket: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Bucket(count: \(Swift.String(describing: count)), value: \(Swift.String(describing: value)))"}
}
...
extension CloudSearchDomainClientTypes.BucketInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case buckets
    }
...
extension CloudSearchDomainClientTypes.BucketInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BucketInfo(buckets: \(Swift.String(describing: buckets)))"}
}
...
extension CloudSearchDomainClientTypes {
    ...
    public struct BucketInfo: Swift.Equatable {
        ...
        public let buckets: [CloudSearchDomainClientTypes.Bucket]?
...
extension DocumentServiceException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DocumentServiceException(message: \(Swift.String(describing: message)), status: \(Swift.String(describing: status)))"}
}

extension DocumentServiceException: AWSClientRuntime.AWSHttpServiceError {
...
public struct DocumentServiceException: ClientRuntime.ServiceError, Swift.Equatable {
...
extension CloudSearchDomainClientTypes.DocumentServiceWarning: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case message
    }
...
extension CloudSearchDomainClientTypes.DocumentServiceWarning: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DocumentServiceWarning(message: \(Swift.String(describing: message)))"}
}
...
extension CloudSearchDomainClientTypes.FieldStats: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case count
        case max
        case mean
...
extension CloudSearchDomainClientTypes.FieldStats: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "FieldStats(count: \(Swift.String(describing: count)), max: \(Swift.String(describing: max)), mean: \(Swift.String(describing: mean)), min: \(Swift.String(describing: min)), missing: \(Swift.String(describing: missing)), stddev: \(Swift.String(describing: stddev)), sum: \(Swift.String(describing: sum)), sumOfSquares: \(Swift.String(describing: sumOfSquares)))"}
}
...
extension CloudSearchDomainClientTypes.Hit: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case exprs
        case fields
        case highlights
...
extension CloudSearchDomainClientTypes.Hit: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Hit(exprs: \(Swift.String(describing: exprs)), fields: \(Swift.String(describing: fields)), highlights: \(Swift.String(describing: highlights)), id: \(Swift.String(describing: id)))"}
}
...
extension CloudSearchDomainClientTypes {
    ...
    public struct Hit: Swift.Equatable {
        ...
        public let exprs: [Swift.String:Swift.String]?
        ...
        public let highlights: [Swift.String:Swift.String]?
...
extension CloudSearchDomainClientTypes.Hits: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cursor
        case found
        case hit
...
extension CloudSearchDomainClientTypes.Hits: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Hits(cursor: \(Swift.String(describing: cursor)), found: \(Swift.String(describing: found)), hit: \(Swift.String(describing: hit)), start: \(Swift.String(describing: start)))"}
}
...
extension CloudSearchDomainClientTypes {
    ...
    public struct Hits: Swift.Equatable {
        ...
        public let found: Swift.Int
        /// <p>A document that matches the search request.</p>
        public let hit: [CloudSearchDomainClientTypes.Hit]?
...
extension SearchException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SearchException(message: \(Swift.String(describing: message)))"}
}

extension SearchException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct SearchException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension SearchInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SearchInput(cursor: \(Swift.String(describing: cursor)), expr: \(Swift.String(describing: expr)), facet: \(Swift.String(describing: facet)), filterQuery: \(Swift.String(describing: filterQuery)), highlight: \(Swift.String(describing: highlight)), partial: \(Swift.String(describing: partial)), query: \(Swift.String(describing: query)), queryOptions: \(Swift.String(describing: queryOptions)), queryParser: \(Swift.String(describing: queryParser)), return: \(Swift.String(describing: `return`)), size: \(Swift.String(describing: size)), sort: \(Swift.String(describing: sort)), start: \(Swift.String(describing: start)), stats: \(Swift.String(describing: stats)))"}
}

extension SearchInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct SearchInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<SearchInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<SearchOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<SearchInput>
    public typealias MOutput = ClientRuntime.OperationOutput<SearchOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SearchOutputError>
}

public struct SearchInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchInputQueryItemMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        input.builder.withQueryItem(ClientRuntime.URLQueryItem(name: "format", value: "sdk"))
        input.builder.withQueryItem(ClientRuntime.URLQueryItem(name: "pretty", value: "true"))
        ...
        if input.operationInput.start != 0 {
            let startQueryItem = ClientRuntime.URLQueryItem(name: "start".urlPercentEncoding(), value: Swift.String(input.operationInput.start).urlPercentEncoding())
        ...
        if input.operationInput.size != 0 {
            let sizeQueryItem = ClientRuntime.URLQueryItem(name: "size".urlPercentEncoding(), value: Swift.String(input.operationInput.size).urlPercentEncoding())
        ...
        if input.operationInput.partial != false {
            let partialQueryItem = ClientRuntime.URLQueryItem(name: "partial".urlPercentEncoding(), value: Swift.String(input.operationInput.partial).urlPercentEncoding())
...
public struct SearchInput: Swift.Equatable {
    ...
    public let `return`: Swift.String?
    ...
    ///          </li>
    ///       </ul>
    public let queryOptions: Swift.String?
    /// <p>Specifies which
    ...
    ///
    ///       </ul>
    public let queryParser: CloudSearchDomainClientTypes.QueryParser?
...
extension SearchOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SearchOutputResponse(facets: \(Swift.String(describing: facets)), hits: \(Swift.String(describing: hits)), stats: \(Swift.String(describing: stats)), status: \(Swift.String(describing: status)))"}
}
...
public struct SearchOutputResponse: Swift.Equatable {
    ...
    public let facets: [Swift.String:CloudSearchDomainClientTypes.BucketInfo]?
    /// <p>The documents that match the search criteria.</p>
    public let hits: CloudSearchDomainClientTypes.Hits?
    /// <p>The requested field statistics information.</p>
    public let stats: [Swift.String:CloudSearchDomainClientTypes.FieldStats]?
    /// <p>The status information returned for the search request.</p>
    public let status: CloudSearchDomainClientTypes.SearchStatus?
...
extension CloudSearchDomainClientTypes.SearchStatus: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case rid
        case timems
    }
...
extension CloudSearchDomainClientTypes.SearchStatus: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SearchStatus(rid: \(Swift.String(describing: rid)), timems: \(Swift.String(describing: timems)))"}
}
...
extension SuggestInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SuggestInput(query: \(Swift.String(describing: query)), size: \(Swift.String(describing: size)), suggester: \(Swift.String(describing: suggester)))"}
}

extension SuggestInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct SuggestInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SuggestInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<SuggestInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<SuggestOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<SuggestInput>
    public typealias MOutput = ClientRuntime.OperationOutput<SuggestOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SuggestOutputError>
}

public struct SuggestInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SuggestInputQueryItemMiddleware"
...
public struct SuggestInput: Swift.Equatable {
    ...
    public let suggester: Swift.String?
...
extension CloudSearchDomainClientTypes.SuggestModel: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case found
        case query
        case suggestions
...
extension CloudSearchDomainClientTypes.SuggestModel: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SuggestModel(found: \(Swift.String(describing: found)), query: \(Swift.String(describing: query)), suggestions: \(Swift.String(describing: suggestions)))"}
}
...
extension CloudSearchDomainClientTypes {
    ...
    public struct SuggestModel: Swift.Equatable {
        ...
        public let suggestions: [CloudSearchDomainClientTypes.SuggestionMatch]?
...
extension SuggestOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SuggestOutputResponse(status: \(Swift.String(describing: status)), suggest: \(Swift.String(describing: suggest)))"}
}
...
public struct SuggestOutputResponse: Swift.Equatable {
    ...
    public let status: CloudSearchDomainClientTypes.SuggestStatus?
    /// <p>Container for the matching search suggestion information.</p>
    public let suggest: CloudSearchDomainClientTypes.SuggestModel?
...
extension CloudSearchDomainClientTypes.SuggestStatus: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case rid
        case timems
    }
...
extension CloudSearchDomainClientTypes.SuggestStatus: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SuggestStatus(rid: \(Swift.String(describing: rid)), timems: \(Swift.String(describing: timems)))"}
}
...
extension CloudSearchDomainClientTypes.SuggestionMatch: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case id
        case score
        case suggestion
...
extension CloudSearchDomainClientTypes.SuggestionMatch: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SuggestionMatch(id: \(Swift.String(describing: id)), score: \(Swift.String(describing: score)), suggestion: \(Swift.String(describing: suggestion)))"}
}
...
public struct UploadDocumentsInputBodyMiddleware: ClientRuntime.Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UploadDocumentsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UploadDocumentsOutputError>
}

extension UploadDocumentsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UploadDocumentsInput(contentType: \(Swift.String(describing: contentType)), documents: \(Swift.String(describing: documents)))"}
}

extension UploadDocumentsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case documents
    }
...
public struct UploadDocumentsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UploadDocumentsInputHeadersMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        if let contentType = input.operationInput.contentType {
            input.builder.withHeader(name: "Content-Type", value: Swift.String(contentType.rawValue))
        }
        return next.handle(context: context, input: input)
    }
...
public struct UploadDocumentsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UploadDocumentsInputQueryItemMiddleware"
...
public struct UploadDocumentsInput: Swift.Equatable {
    ...
    ///       </ul>
    public let contentType: CloudSearchDomainClientTypes.ContentType?
    /// <p>A batch of documents formatted in JSON or HTML.</p>
    public let documents: ClientRuntime.ByteStream?
...
extension UploadDocumentsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UploadDocumentsOutputResponse(adds: \(Swift.String(describing: adds)), deletes: \(Swift.String(describing: deletes)), status: \(Swift.String(describing: status)), warnings: \(Swift.String(describing: warnings)))"}
}
...
public struct UploadDocumentsOutputResponse: Swift.Equatable {
    ...
    public let warnings: [CloudSearchDomainClientTypes.DocumentServiceWarning]?
