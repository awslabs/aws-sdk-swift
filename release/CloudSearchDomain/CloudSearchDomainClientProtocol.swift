...
public protocol CloudSearchDomainClientProtocol {
    ...
    func search(input: SearchInput, completion: @escaping (SdkResult<SearchOutputResponse, SearchOutputError>) -> Void)
    ...
    func suggest(input: SuggestInput, completion: @escaping (SdkResult<SuggestOutputResponse, SuggestOutputError>) -> Void)
    ...
    func uploadDocuments(input: UploadDocumentsInput, streamSource: StreamSource, completion: @escaping (SdkResult<UploadDocumentsOutputResponse, UploadDocumentsOutputError>) -> Void)
}
