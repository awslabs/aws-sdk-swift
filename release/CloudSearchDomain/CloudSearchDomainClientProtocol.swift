...
public protocol CloudSearchDomainClientProtocol {
    ...
    func search(input: SearchInput, completion: @escaping (SdkResult<SearchOutput, SearchOutputError>) -> Void)
    ...
    func suggest(input: SuggestInput, completion: @escaping (SdkResult<SuggestOutput, SuggestOutputError>) -> Void)
    ...
    func uploadDocuments(input: UploadDocumentsInput, streamSource: StreamSource, completion: @escaping (SdkResult<UploadDocumentsOutput, UploadDocumentsOutputError>) -> Void)
}
