...
public struct DescribeVoicesInput: Swift.Equatable {
    ...
    ///         no.
    public let includeAdditionalLanguageCodes: Swift.Bool
...
extension PollyClientTypes {
    ...
    public struct LexiconAttributes: Swift.Equatable {
        ...
        ///         x-sampa.
        public let alphabet: Swift.String?
        ...
        public let lexemesCount: Swift.Int
        /// Amazon Resource Name (ARN) of the lexicon.
        public let lexiconArn: Swift.String?
...
extension PollyClientTypes {
    ...
    public struct LexiconDescription: Swift.Equatable {
        ...
        public let attributes: PollyClientTypes.LexiconAttributes?
        /// Name of the lexicon.
        public let name: Swift.String?
...
public struct ListSpeechSynthesisTasksInput: Swift.Equatable {
    ...
    public let status: PollyClientTypes.TaskStatus?
...
public struct StartSpeechSynthesisTaskInput: Swift.Equatable {
    ...
    ///       returned by the <a href="https://docs.aws.amazon.com/polly/latest/dg/API_DescribeVoices.html">DescribeVoices operation for the LanguageCode parameter. For example,
...
extension PollyClientTypes {
    ...
    public struct SynthesisTask: Swift.Equatable {
        ...
        public let requestCharacters: Swift.Int
        /// The audio frequency specified in Hz.
        ///          The valid values for mp3 and ogg_vorbis are "8000", "16000", "22050", and "24000". The
        ///       default value for standard voices is "22050". The default value for neural voices is
        ///       "24000".
        ...
        public let taskStatus: PollyClientTypes.TaskStatus?
        /// Reason for the current status of a specific speech synthesis task, including errors if the
        ///       task has failed.
        public let taskStatusReason: Swift.String?
        /// Specifies whether the input text is plain text or SSML. The default value is plain text.
        ///
        public let textType: PollyClientTypes.TextType?
        /// Voice ID to use for the synthesis.
...
public struct SynthesizeSpeechInput: Swift.Equatable {
    ...
    ///       both standard and NTTS formats, see <a href="https://docs.aws.amazon.com/polly/latest/dg/voicelist.html">Available Voices.
    ///
    ///             NTTS-only voices
    ///
    ...
    /// List of one or more pronunciation lexicon names you want the service to apply during
    ///       synthesis. Lexicons are applied only if the language of the lexicon is the same as the
    ///       language of the voice. For information about storing lexicons, see <a href="https://docs.aws.amazon.com/polly/latest/dg/API_PutLexicon.html">PutLexicon.
    public let lexiconNames: [Swift.String]?
    ...
    ///       text. For more information, see <a href="https://docs.aws.amazon.com/polly/latest/dg/ssml.html">Using SSML.
    public let textType: PollyClientTypes.TextType?
    ///  Voice ID to use for the synthesis. You can get a list of available voice IDs by
    ///       calling the <a href="https://docs.aws.amazon.com/polly/latest/dg/API_DescribeVoices.html">DescribeVoices operation.
    /// This member is required.
    public let voiceId: PollyClientTypes.VoiceId?
...
extension PollyClientTypes {
    ...
    public struct Voice: Swift.Equatable {
        ...
        public let additionalLanguageCodes: [PollyClientTypes.LanguageCode]?
        /// Gender of the voice.
        public let gender: PollyClientTypes.Gender?
        /// Amazon Polly assigned voice ID. This is the ID that you specify when calling the
        ///         SynthesizeSpeech operation.
        public let id: PollyClientTypes.VoiceId?
        ...
        ///       by a given voice.
        public let supportedEngines: [PollyClientTypes.Engine]?
