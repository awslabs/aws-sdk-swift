...
public struct DescribeVoicesInput: Swift.Equatable {
    ...
    var includeAdditionalLanguageCodes: Swift.Bool
...
public struct DescribeVoicesOutputResponse: Swift.Equatable {
    ...
    var voices: [PollyClientTypes.Voice]?
...
public struct GetLexiconOutputResponse: Swift.Equatable {
    ...
    var lexicon: PollyClientTypes.Lexicon?
    /// Metadata of the lexicon, including phonetic alphabetic used, language code, lexicon ARN, number of lexemes defined in the lexicon, and size of lexicon in bytes.
    var lexiconAttributes: PollyClientTypes.LexiconAttributes?
...
public struct GetSpeechSynthesisTaskOutputResponse: Swift.Equatable {
    ...
    var synthesisTask: PollyClientTypes.SynthesisTask?
...
extension PollyClientTypes {
    ...
    public struct LexiconDescription: Swift.Equatable {
        ...
        var attributes: PollyClientTypes.LexiconAttributes?
        /// Name of the lexicon.
        var name: Swift.String?
...
public struct ListLexiconsOutputResponse: Swift.Equatable {
    ...
    var lexicons: [PollyClientTypes.LexiconDescription]?
...
public struct ListSpeechSynthesisTasksInput: Swift.Equatable {
    ...
    var status: PollyClientTypes.TaskStatus?
...
public struct ListSpeechSynthesisTasksOutputResponse: Swift.Equatable {
    ...
    var synthesisTasks: [PollyClientTypes.SynthesisTask]?
...
public struct StartSpeechSynthesisTaskInput: Swift.Equatable {
    ...
    var lexiconNames: [Swift.String]?
    /// The format in which the returned output will be encoded. For audio stream, this will be mp3, ogg_vorbis, or pcm. For speech marks, this will be json.
    /// This member is required.
    var outputFormat: PollyClientTypes.OutputFormat?
    /// Amazon S3 bucket name to which the output file will be saved.
    /// This member is required.
    var outputS3BucketName: Swift.String?
    /// The Amazon S3 key prefix for the output speech file.
    var outputS3KeyPrefix: Swift.String?
...
extension PollyClientTypes {
    ...
    public struct SynthesisTask: Swift.Equatable {
        ...
        var requestCharacters: Swift.Int
        /// The audio frequency specified in Hz. The valid values for mp3 and ogg_vorbis are "8000", "16000", "22050", and "24000". The default value for standard voices is "22050". The default value for neural voices is "24000". Valid values for pcm are "8000" and "16000" The default value is "16000".
        var sampleRate: Swift.String?
        /// ARN for the SNS topic optionally used for providing status notification for a speech synthesis task.
        var snsTopicArn: Swift.String?
        ...
        var taskStatus: PollyClientTypes.TaskStatus?
        /// Reason for the current status of a specific speech synthesis task, including errors if the task has failed.
        var taskStatusReason: Swift.String?
        /// Specifies whether the input text is plain text or SSML. The default value is plain text.
        var textType: PollyClientTypes.TextType?
        /// Voice ID to use for the synthesis.
        var voiceId: PollyClientTypes.VoiceId?
...
public struct SynthesizeSpeechOutputResponse: Swift.Equatable {
    ...
    var audioStream: ClientRuntime.ByteStream?
...
extension PollyClientTypes {
    ...
    public struct Voice: Swift.Equatable {
        ...
        var additionalLanguageCodes: [PollyClientTypes.LanguageCode]?
        /// Gender of the voice.
        var gender: PollyClientTypes.Gender?
        /// Amazon Polly assigned voice ID. This is the ID that you specify when calling the SynthesizeSpeech operation.
        var id: PollyClientTypes.VoiceId?
        /// Language code of the voice.
        var languageCode: PollyClientTypes.LanguageCode?
        /// Human readable name of the language in English.
        var languageName: Swift.String?
        /// Name of the voice (for example, Salli, Kendra, etc.). This provides a human readable voice name that you might display in your application.
        var name: Swift.String?
        /// Specifies which engines (standard or neural) that are supported by a given voice.
        var supportedEngines: [PollyClientTypes.Engine]?
