...
public struct SearchInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchInputURLHostMiddleware"
    ...
    public typealias MInput = SearchInput
    public typealias MOutput = ClientRuntime.OperationOutput<SearchOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SearchOutputError>
}

public struct SearchInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchInputURLPathMiddleware"
...
public struct SearchInput: Swift.Equatable {
    ...
    ///       For more
    ///          information, see <a href="http://docs.aws.amazon.com/cloudsearch/latest/developerguide/paginating-results.html">Paginating Results in the Amazon CloudSearch Developer Guide.
    public var cursor: Swift.String?
    ...
    ///
    ///       For information about the variables, operators, and functions you can use in expressions, see <a href="http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-expressions.html#writing-expressions">Writing Expressions
    ...
    ///                   Searching for a Range of Values in the Amazon CloudSearch Developer Guide. Buckets are returned in the order they
    ...
    ///
    ///       For more
    ///          information, see <a href="http://docs.aws.amazon.com/cloudsearch/latest/developerguide/faceting.html">Getting and Using Facet Information
    ///          in the Amazon CloudSearch Developer Guide.
    ...
    ///       For more information about using filters, see <a href="http://docs.aws.amazon.com/cloudsearch/latest/developerguide/filtering-results.html">Filtering Matching Documents
    ///          in the Amazon CloudSearch Developer Guide.
    ...
    ///             For more information about specifying search criteria, see <a href="http://docs.aws.amazon.com/cloudsearch/latest/developerguide/searching.html">Searching Your Data in the Amazon CloudSearch Developer Guide.
    ...
    ///                (This is the default, unless you configure the default operator with the queryOptions parameter.)
    ///                You can use the - (NOT), |
    ...
    ///                more information, see <a href="http://docs.aws.amazon.com/cloudsearch/latest/developerguide/searching-text.html">Searching for Text in the Amazon CloudSearch Developer Guide.
    ///
    ///
    ...
    ///                For more information, see <a href="http://docs.aws.amazon.com/cloudsearch/latest/developerguide/searching-compound-queries.html">Constructing Compound Queries in the Amazon CloudSearch Developer Guide.
    ///
    ///
    ///             lucene: search using the Apache Lucene query parser syntax.
    ///                For more information, see <a href="http://lucene.apache.org/core/4_6_0/queryparser/org/apache/lucene/queryparser/classic/package-summary.html#package_description">Apache Lucene Query Parser Syntax.
    ///
    ///
    ///             dismax: search using the simplified subset of the Apache Lucene query parser syntax
    ///                defined by the DisMax query parser.
    ///                For more information, see <a href="http://wiki.apache.org/solr/DisMaxQParserPlugin#Query_Syntax">DisMax Query Parser Syntax.
    ///
    ///
    ///
    ...
    ///       For more information, see <a href="http://docs.aws.amazon.com/cloudsearch/latest/developerguide/sorting-results.html">Sorting Results in the Amazon CloudSearch Developer Guide.
    ...
    ///       For more information, see <a href="http://docs.aws.amazon.com/cloudsearch/latest/developerguide/paginating-results.html">Paginating Results in the Amazon CloudSearch Developer Guide.
    public var start: Swift.Int
...
public struct SuggestInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SuggestInputURLHostMiddleware"
    ...
    public typealias MInput = SuggestInput
    public typealias MOutput = ClientRuntime.OperationOutput<SuggestOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SuggestOutputError>
}

public struct SuggestInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SuggestInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2013-01-01/suggest"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UploadDocumentsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UploadDocumentsInputURLHostMiddleware"
    ...
    public typealias MInput = UploadDocumentsInput
    public typealias MOutput = ClientRuntime.OperationOutput<UploadDocumentsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UploadDocumentsOutputError>
}

public struct UploadDocumentsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UploadDocumentsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2013-01-01/documents/batch"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
