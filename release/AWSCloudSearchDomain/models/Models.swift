...
extension CloudSearchDomainClientTypes {
    ...
    public struct BucketInfo: Swift.Equatable {
        ...
        var buckets: [CloudSearchDomainClientTypes.Bucket]?
...
extension CloudSearchDomainClientTypes {
    ...
    public struct Hit: Swift.Equatable {
        ...
        var exprs: [Swift.String:Swift.String]?
        /// The fields returned from a document that matches the search request.
        var fields: [Swift.String:[Swift.String]]?
        /// The highlights returned from a document that matches the search request.
        var highlights: [Swift.String:Swift.String]?
...
extension CloudSearchDomainClientTypes {
    ...
    public struct Hits: Swift.Equatable {
        ...
        var cursor: Swift.String?
        /// The total number of documents that match the search request.
        var found: Swift.Int
        /// A document that matches the search request.
        var hit: [CloudSearchDomainClientTypes.Hit]?
...
public struct SearchInput: Swift.Equatable {
    ...
    var queryParser: CloudSearchDomainClientTypes.QueryParser?
...
public struct SearchOutputResponse: Swift.Equatable {
    ...
    var facets: [Swift.String:CloudSearchDomainClientTypes.BucketInfo]?
    /// The documents that match the search criteria.
    var hits: CloudSearchDomainClientTypes.Hits?
    /// The requested field statistics information.
    var stats: [Swift.String:CloudSearchDomainClientTypes.FieldStats]?
    /// The status information returned for the search request.
    var status: CloudSearchDomainClientTypes.SearchStatus?
...
extension CloudSearchDomainClientTypes {
    ...
    public struct SearchStatus: Swift.Equatable {
        ...
        var rid: Swift.String?
        /// How long it took to process the request, in milliseconds.
        var timems: Swift.Int
...
extension CloudSearchDomainClientTypes {
    ...
    public struct SuggestModel: Swift.Equatable {
        ...
        var suggestions: [CloudSearchDomainClientTypes.SuggestionMatch]?
...
public struct SuggestOutputResponse: Swift.Equatable {
    ...
    var status: CloudSearchDomainClientTypes.SuggestStatus?
    /// Container for the matching search suggestion information.
    var suggest: CloudSearchDomainClientTypes.SuggestModel?
...
public struct UploadDocumentsInput: Swift.Equatable {
    ...
    /// * application/xml
    /// This member is required.
    var contentType: CloudSearchDomainClientTypes.ContentType?
    /// A batch of documents formatted in JSON or HTML.
    /// This member is required.
    var documents: ClientRuntime.ByteStream?
...
public struct UploadDocumentsOutputResponse: Swift.Equatable {
    ...
    var warnings: [CloudSearchDomainClientTypes.DocumentServiceWarning]?
