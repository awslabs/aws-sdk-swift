...
extension CloudWatchEventsClientTypes {
    ...
    public struct ApiDestination: Swift.Equatable {
        ...
        var apiDestinationArn: Swift.String?
        /// The state of the API destination.
        var apiDestinationState: CloudWatchEventsClientTypes.ApiDestinationState?
        /// The ARN of the connection specified for the API destination.
        var connectionArn: Swift.String?
        /// A time stamp for the time that the API destination was created.
        var creationTime: ClientRuntime.Date?
        /// The method to use to connect to the HTTP endpoint.
        var httpMethod: CloudWatchEventsClientTypes.ApiDestinationHttpMethod?
        /// The URL to the endpoint for the API destination.
        var invocationEndpoint: Swift.String?
        /// The maximum number of invocations per second to send to the HTTP endpoint.
        var invocationRateLimitPerSecond: Swift.Int?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct Archive: Swift.Equatable {
        ...
        var archiveName: Swift.String?
        /// The time stamp for the time that the archive was created.
        var creationTime: ClientRuntime.Date?
        /// The number of events in the archive.
        var eventCount: Swift.Int
        /// The ARN of the event bus associated with the archive. Only events from this event bus are sent to the archive.
        var eventSourceArn: Swift.String?
        /// The number of days to retain events in the archive before they are deleted.
        var retentionDays: Swift.Int?
        /// The size of the archive, in bytes.
        var sizeBytes: Swift.Int
        /// The current state of the archive.
        var state: CloudWatchEventsClientTypes.ArchiveState?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct AwsVpcConfiguration: Swift.Equatable {
        ...
        var assignPublicIp: CloudWatchEventsClientTypes.AssignPublicIp?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct BatchParameters: Swift.Equatable {
        /// The array properties for the submitted job, such as the size of the array. The array size can be between 2 and 10,000. If you specify array properties for a job, it becomes an array job. This parameter is used only if the target is an Batch job.
        var arrayProperties: CloudWatchEventsClientTypes.BatchArrayProperties?
        /// The ARN or name of the job definition to use if the event target is an Batch job. This job definition must already exist.
        /// This member is required.
        var jobDefinition: Swift.String?
        ...
        var retryStrategy: CloudWatchEventsClientTypes.BatchRetryStrategy?
...
public struct CancelReplayOutputResponse: Swift.Equatable {
    ...
    var replayArn: Swift.String?
    /// The current state of the replay.
    var state: CloudWatchEventsClientTypes.ReplayState?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct CapacityProviderStrategyItem: Swift.Equatable {
        ...
        /// This member is required.
        var capacityProvider: Swift.String?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct Connection: Swift.Equatable {
        ...
        var authorizationType: CloudWatchEventsClientTypes.ConnectionAuthorizationType?
        /// The ARN of the connection.
        var connectionArn: Swift.String?
        /// The state of the connection.
        var connectionState: CloudWatchEventsClientTypes.ConnectionState?
        /// A time stamp for the time that the connection was created.
        var creationTime: ClientRuntime.Date?
        /// A time stamp for the time that the connection was last authorized.
        var lastAuthorizedTime: ClientRuntime.Date?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct ConnectionAuthResponseParameters: Swift.Equatable {
        ...
        var apiKeyAuthParameters: CloudWatchEventsClientTypes.ConnectionApiKeyAuthResponseParameters?
        /// The authorization parameters for Basic authorization.
        var basicAuthParameters: CloudWatchEventsClientTypes.ConnectionBasicAuthResponseParameters?
        /// Additional parameters for the connection that are passed through with every invocation to the HTTP endpoint.
        var invocationHttpParameters: CloudWatchEventsClientTypes.ConnectionHttpParameters?
        /// The OAuth parameters to use for authorization.
        var oAuthParameters: CloudWatchEventsClientTypes.ConnectionOAuthResponseParameters?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct ConnectionHttpParameters: Swift.Equatable {
        ...
        var bodyParameters: [CloudWatchEventsClientTypes.ConnectionBodyParameter]?
        /// Contains additional header parameters for the connection.
        var headerParameters: [CloudWatchEventsClientTypes.ConnectionHeaderParameter]?
        /// Contains additional query string parameters for the connection.
        var queryStringParameters: [CloudWatchEventsClientTypes.ConnectionQueryStringParameter]?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct ConnectionOAuthResponseParameters: Swift.Equatable {
        ...
        var authorizationEndpoint: Swift.String?
        ...
        var clientParameters: CloudWatchEventsClientTypes.ConnectionOAuthClientResponseParameters?
        /// The method used to connect to the HTTP endpoint.
        var httpMethod: CloudWatchEventsClientTypes.ConnectionOAuthHttpMethod?
        /// The additional HTTP parameters used for the OAuth authorization request.
        var oAuthHttpParameters: CloudWatchEventsClientTypes.ConnectionHttpParameters?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct CreateConnectionAuthRequestParameters: Swift.Equatable {
        ...
        var apiKeyAuthParameters: CloudWatchEventsClientTypes.CreateConnectionApiKeyAuthRequestParameters?
        ...
        var basicAuthParameters: CloudWatchEventsClientTypes.CreateConnectionBasicAuthRequestParameters?
        ...
        var oAuthParameters: CloudWatchEventsClientTypes.CreateConnectionOAuthRequestParameters?
...
public struct CreateConnectionInput: Swift.Equatable {
    ...
    /// This member is required.
    var authParameters: CloudWatchEventsClientTypes.CreateConnectionAuthRequestParameters?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct CreateConnectionOAuthRequestParameters: Swift.Equatable {
        ...
        /// This member is required.
        var clientParameters: CloudWatchEventsClientTypes.CreateConnectionOAuthClientRequestParameters?
...
public struct CreateEventBusInput: Swift.Equatable {
    ...
    var eventSourceName: Swift.String?
    ...
    var tags: [CloudWatchEventsClientTypes.Tag]?
...
public struct DescribeConnectionOutputResponse: Swift.Equatable {
    ...
    var authParameters: CloudWatchEventsClientTypes.ConnectionAuthResponseParameters?
...
public struct DescribeEventSourceOutputResponse: Swift.Equatable {
    ...
    var expirationTime: ClientRuntime.Date?
    /// The name of the partner event source.
    var name: Swift.String?
    /// The state of the event source. If it is ACTIVE, you have already created a matching event bus for this event source, and that event bus is active. If it is PENDING, either you haven't yet created a matching event bus, or that event bus is deactivated. If it is DELETED, you have created a matching event bus, but the event source has since been deleted.
    var state: CloudWatchEventsClientTypes.EventSourceState?
...
public struct DescribeReplayOutputResponse: Swift.Equatable {
    ...
    var destination: CloudWatchEventsClientTypes.ReplayDestination?
    /// The time stamp for the last event that was replayed from the archive.
    var eventEndTime: ClientRuntime.Date?
    /// The time that the event was last replayed.
    var eventLastReplayedTime: ClientRuntime.Date?
    /// The ARN of the archive events were replayed from.
    var eventSourceArn: Swift.String?
    /// The time stamp of the first event that was last replayed from the archive.
    var eventStartTime: ClientRuntime.Date?
    /// The ARN of the replay.
    var replayArn: Swift.String?
    /// A time stamp for the time that the replay stopped.
    var replayEndTime: ClientRuntime.Date?
    /// The name of the replay.
    var replayName: Swift.String?
    /// A time stamp for the time that the replay started.
    var replayStartTime: ClientRuntime.Date?
    /// The current state of the replay.
    var state: CloudWatchEventsClientTypes.ReplayState?
    /// The reason that the replay is in the current state.
    var stateReason: Swift.String?
...
public struct DescribeRuleOutputResponse: Swift.Equatable {
    ...
    var state: CloudWatchEventsClientTypes.RuleState?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct EcsParameters: Swift.Equatable {
        ...
        var capacityProviderStrategy: [CloudWatchEventsClientTypes.CapacityProviderStrategyItem]?
        ...
        var enableECSManagedTags: Swift.Bool
        /// Whether or not to enable the execute command functionality for the containers in this task. If true, this enables execute command functionality on all containers in the task.
        var enableExecuteCommand: Swift.Bool
        ...
        var launchType: CloudWatchEventsClientTypes.LaunchType?
        ...
        var networkConfiguration: CloudWatchEventsClientTypes.NetworkConfiguration?
        /// An array of placement constraint objects to use for the task. You can specify up to 10 constraints per task (including constraints in the task definition and those specified at runtime).
        var placementConstraints: [CloudWatchEventsClientTypes.PlacementConstraint]?
        /// The placement strategy objects to use for the task. You can specify a maximum of five strategy rules per task.
        var placementStrategy: [CloudWatchEventsClientTypes.PlacementStrategy]?
        ...
        var propagateTags: CloudWatchEventsClientTypes.PropagateTags?
        ...
        var taskCount: Swift.Int?
        /// The ARN of the task definition to use if the event target is an Amazon ECS task.
        /// This member is required.
        var taskDefinitionArn: Swift.String?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct HttpParameters: Swift.Equatable {
        ...
        var headerParameters: [Swift.String:Swift.String]?
        /// The path parameter values to be used to populate API Gateway REST API or EventBridge ApiDestination path wildcards ("*").
        var pathParameterValues: [Swift.String]?
        /// The query string keys/values that need to be sent as part of request invoking the API Gateway REST API or EventBridge ApiDestination.
        var queryStringParameters: [Swift.String:Swift.String]?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct InputTransformer: Swift.Equatable {
        ...
        var inputPathsMap: [Swift.String:Swift.String]?
        ...
        ///     }
        /// This member is required.
        var inputTemplate: Swift.String?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct KinesisParameters: Swift.Equatable {
        ...
        /// This member is required.
        var partitionKeyPath: Swift.String?
...
public struct ListApiDestinationsOutputResponse: Swift.Equatable {
    ...
    var apiDestinations: [CloudWatchEventsClientTypes.ApiDestination]?
...
public struct ListArchivesOutputResponse: Swift.Equatable {
    ...
    var archives: [CloudWatchEventsClientTypes.Archive]?
    /// The token returned by a previous call to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct ListConnectionsOutputResponse: Swift.Equatable {
    ...
    var connections: [CloudWatchEventsClientTypes.Connection]?
    /// A token you can use in a subsequent request to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct ListEventBusesOutputResponse: Swift.Equatable {
    ...
    var eventBuses: [CloudWatchEventsClientTypes.EventBus]?
...
public struct ListEventSourcesOutputResponse: Swift.Equatable {
    ...
    var eventSources: [CloudWatchEventsClientTypes.EventSource]?
    /// A token you can use in a subsequent operation to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct ListPartnerEventSourceAccountsOutputResponse: Swift.Equatable {
    ...
    var partnerEventSourceAccounts: [CloudWatchEventsClientTypes.PartnerEventSourceAccount]?
...
public struct ListPartnerEventSourcesOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// The list of partner event sources returned by the operation.
    var partnerEventSources: [CloudWatchEventsClientTypes.PartnerEventSource]?
...
public struct ListReplaysOutputResponse: Swift.Equatable {
    ...
    var replays: [CloudWatchEventsClientTypes.Replay]?
...
public struct ListRulesOutputResponse: Swift.Equatable {
    ...
    var rules: [CloudWatchEventsClientTypes.Rule]?
...
public struct ListTargetsByRuleOutputResponse: Swift.Equatable {
    ...
    var targets: [CloudWatchEventsClientTypes.Target]?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct NetworkConfiguration: Swift.Equatable {
        ...
        var awsvpcConfiguration: CloudWatchEventsClientTypes.AwsVpcConfiguration?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct PlacementConstraint: Swift.Equatable {
        ...
        var type: CloudWatchEventsClientTypes.PlacementConstraintType?
...
public struct PutEventsInput: Swift.Equatable {
    ...
    /// This member is required.
    var entries: [CloudWatchEventsClientTypes.PutEventsRequestEntry]?
...
public struct PutEventsOutputResponse: Swift.Equatable {
    ...
    var entries: [CloudWatchEventsClientTypes.PutEventsResultEntry]?
    /// The number of failed entries.
    var failedEntryCount: Swift.Int
...
public struct PutPartnerEventsInput: Swift.Equatable {
    ...
    /// This member is required.
    var entries: [CloudWatchEventsClientTypes.PutPartnerEventsRequestEntry]?
...
public struct PutPartnerEventsOutputResponse: Swift.Equatable {
    ...
    var entries: [CloudWatchEventsClientTypes.PutPartnerEventsResultEntry]?
...
public struct PutPermissionInput: Swift.Equatable {
    ...
    var condition: CloudWatchEventsClientTypes.Condition?
...
public struct PutTargetsOutputResponse: Swift.Equatable {
    ...
    var failedEntries: [CloudWatchEventsClientTypes.PutTargetsResultEntry]?
    /// The number of failed entries.
    var failedEntryCount: Swift.Int
...
extension CloudWatchEventsClientTypes {
    ...
    public struct RedshiftDataParameters: Swift.Equatable {
        ...
        var secretManagerArn: Swift.String?
...
public struct RemovePermissionInput: Swift.Equatable {
    ...
    var removeAllPermissions: Swift.Bool
...
public struct RemoveTargetsOutputResponse: Swift.Equatable {
    /// The failed target entries.
    var failedEntries: [CloudWatchEventsClientTypes.RemoveTargetsResultEntry]?
    /// The number of failed entries.
    var failedEntryCount: Swift.Int
...
extension CloudWatchEventsClientTypes {
    ...
    public struct RunCommandParameters: Swift.Equatable {
        ...
        /// This member is required.
        var runCommandTargets: [CloudWatchEventsClientTypes.RunCommandTarget]?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct SageMakerPipelineParameters: Swift.Equatable {
        ...
        var pipelineParameterList: [CloudWatchEventsClientTypes.SageMakerPipelineParameter]?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct Target: Swift.Equatable {
        ...
        var batchParameters: CloudWatchEventsClientTypes.BatchParameters?
        /// The DeadLetterConfig that defines the target queue to send dead-letter queue events to.
        var deadLetterConfig: CloudWatchEventsClientTypes.DeadLetterConfig?
        ...
        var ecsParameters: CloudWatchEventsClientTypes.EcsParameters?
        /// Contains the HTTP parameters to use when the target is a API Gateway REST endpoint or EventBridge ApiDestination. If you specify an API Gateway REST API or EventBridge ApiDestination as a target, you can use this parameter to specify headers, path parameters, and query string keys/values as part of your target invoking request. If you're using ApiDestinations, the corresponding Connection can also have these values configured. In case of any conflicting keys, values from the Connection take precedence.
        var httpParameters: CloudWatchEventsClientTypes.HttpParameters?
        ...
        var inputPath: Swift.String?
        /// Settings to enable you to provide custom input to a target based on certain event data. You can extract one or more key-value pairs from the event and then use that data to send customized input to the target.
        var inputTransformer: CloudWatchEventsClientTypes.InputTransformer?
        /// The custom parameter you can use to control the shard assignment, when the target is a Kinesis data stream. If you do not include this parameter, the default is to use the eventId as the partition key.
        var kinesisParameters: CloudWatchEventsClientTypes.KinesisParameters?
        ...
        var redshiftDataParameters: CloudWatchEventsClientTypes.RedshiftDataParameters?
        /// The RetryPolicy object that contains the retry policy configuration to use for the dead-letter queue.
        var retryPolicy: CloudWatchEventsClientTypes.RetryPolicy?
        /// The Amazon Resource Name (ARN) of the IAM role to be used for this target when the rule is triggered. If one rule triggers multiple targets, you can use a different IAM role for each target.
        var roleArn: Swift.String?
        /// Parameters used when you are using the rule to invoke Amazon EC2 Run Command.
        var runCommandParameters: CloudWatchEventsClientTypes.RunCommandParameters?
        ...
        var sageMakerPipelineParameters: CloudWatchEventsClientTypes.SageMakerPipelineParameters?
        /// Contains the message group ID to use when the target is a FIFO queue. If you specify an SQS FIFO queue as a target, the queue must have content-based deduplication enabled.
        var sqsParameters: CloudWatchEventsClientTypes.SqsParameters?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct UpdateConnectionAuthRequestParameters: Swift.Equatable {
        ...
        var apiKeyAuthParameters: CloudWatchEventsClientTypes.UpdateConnectionApiKeyAuthRequestParameters?
        /// A UpdateConnectionBasicAuthRequestParameters object that contains the authorization parameters for Basic authorization.
        var basicAuthParameters: CloudWatchEventsClientTypes.UpdateConnectionBasicAuthRequestParameters?
        ...
        var oAuthParameters: CloudWatchEventsClientTypes.UpdateConnectionOAuthRequestParameters?
...
public struct UpdateConnectionInput: Swift.Equatable {
    ...
    var authParameters: CloudWatchEventsClientTypes.UpdateConnectionAuthRequestParameters?
    /// The type of authorization to use for the connection.
    var authorizationType: CloudWatchEventsClientTypes.ConnectionAuthorizationType?
...
extension CloudWatchEventsClientTypes {
    ...
    public struct UpdateConnectionOAuthRequestParameters: Swift.Equatable {
        ...
        var clientParameters: CloudWatchEventsClientTypes.UpdateConnectionOAuthClientRequestParameters?
        /// The method used to connect to the HTTP endpoint.
        var httpMethod: CloudWatchEventsClientTypes.ConnectionOAuthHttpMethod?
        /// The additional HTTP parameters used for the OAuth authorization request.
        var oAuthHttpParameters: CloudWatchEventsClientTypes.ConnectionHttpParameters?
