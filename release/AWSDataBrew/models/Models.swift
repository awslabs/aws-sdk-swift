...
public struct DescribeScheduleOutputResponse: Swift.Equatable {
    ...
    ///             more information, see <a href="https://docs.aws.amazon.com/databrew/latest/dg/jobs.cron.html">Cron expressions in the
...
extension DataBrewClientTypes.ProfileConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ProfileConfiguration(columnStatisticsConfigurations: \(Swift.String(describing: columnStatisticsConfigurations)), datasetStatisticsConfiguration: \(Swift.String(describing: datasetStatisticsConfiguration)), profileColumns: \(Swift.String(describing: profileColumns)))"}
}
