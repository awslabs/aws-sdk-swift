...
extension DataBrewClientTypes.AllowedStatistics: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DataBrewClientTypes.AllowedStatistics: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AllowedStatistics(statistics: \(Swift.String(describing: statistics)))"}
}
...
public struct BatchDeleteRecipeVersionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDeleteRecipeVersionInputURLHostMiddleware"
    ...
    public typealias MInput = BatchDeleteRecipeVersionInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchDeleteRecipeVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchDeleteRecipeVersionOutputError>
}

public struct BatchDeleteRecipeVersionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDeleteRecipeVersionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/recipes/\(name.urlPercentEncoding())/batchDeleteRecipeVersion"
...
extension DataBrewClientTypes.ColumnSelector: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case regex = "Regex"
    }
...
extension DataBrewClientTypes.ColumnSelector: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ColumnSelector(name: \(Swift.String(describing: name)), regex: \(Swift.String(describing: regex)))"}
}
...
extension DataBrewClientTypes.ColumnStatisticsConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DataBrewClientTypes.ColumnStatisticsConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ColumnStatisticsConfiguration(selectors: \(Swift.String(describing: selectors)), statistics: \(Swift.String(describing: statistics)))"}
}
...
extension CreateProfileJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateProfileJobInput(configuration: \(Swift.String(describing: configuration)), datasetName: \(Swift.String(describing: datasetName)), encryptionKeyArn: \(Swift.String(describing: encryptionKeyArn)), encryptionMode: \(Swift.String(describing: encryptionMode)), jobSample: \(Swift.String(describing: jobSample)), logSubscription: \(Swift.String(describing: logSubscription)), maxCapacity: \(Swift.String(describing: maxCapacity)), maxRetries: \(Swift.String(describing: maxRetries)), name: \(Swift.String(describing: name)), outputLocation: \(Swift.String(describing: outputLocation)), roleArn: \(Swift.String(describing: roleArn)), tags: \(Swift.String(describing: tags)), timeout: \(Swift.String(describing: timeout)), validationConfigurations: \(Swift.String(describing: validationConfigurations)))"}
}
...
public struct CreateProfileJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateProfileJobInputURLHostMiddleware"
    ...
    public typealias MInput = CreateProfileJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateProfileJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateProfileJobOutputError>
}

public struct CreateProfileJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateProfileJobInputURLPathMiddleware"
...
struct CreateProfileJobInputBody: Swift.Equatable {
    ...
    public let configuration: DataBrewClientTypes.ProfileConfiguration?
    public let validationConfigurations: [DataBrewClientTypes.ValidationConfiguration]?
...
public struct CreateRecipeInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRecipeInputURLHostMiddleware"
    ...
    public typealias MInput = CreateRecipeInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateRecipeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateRecipeOutputError>
}

public struct CreateRecipeInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRecipeInputURLPathMiddleware"
...
public struct CreateRecipeJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRecipeJobInputURLHostMiddleware"
    ...
    public typealias MInput = CreateRecipeJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateRecipeJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateRecipeJobOutputError>
}

public struct CreateRecipeJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRecipeJobInputURLPathMiddleware"
...
struct CreateRecipeJobInputBody: Swift.Equatable {
    ...
    public let dataCatalogOutputs: [DataBrewClientTypes.DataCatalogOutput]?
    public let databaseOutputs: [DataBrewClientTypes.DatabaseOutput]?
...
public struct CreateRulesetInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRulesetInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateRulesetInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateRulesetOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateRulesetInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateRulesetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateRulesetOutputError>
}

extension CreateRulesetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateRulesetInput(description: \(Swift.String(describing: description)), name: \(Swift.String(describing: name)), rules: \(Swift.String(describing: rules)), tags: \(Swift.String(describing: tags)), targetArn: \(Swift.String(describing: targetArn)))"}
}

extension CreateRulesetInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case description = "Description"
        case name = "Name"
        case rules = "Rules"
...
public struct CreateRulesetInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRulesetInputHeadersMiddleware"
...
public struct CreateRulesetInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRulesetInputQueryItemMiddleware"
...
public struct CreateRulesetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRulesetInputURLHostMiddleware"
    ...
    public typealias MInput = CreateRulesetInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateRulesetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateRulesetOutputError>
}

public struct CreateRulesetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRulesetInputURLPathMiddleware"
...
struct CreateRulesetInputBody: Swift.Equatable {
    ...
    public let rules: [DataBrewClientTypes.Rule]?
    public let tags: [Swift.String:Swift.String]?
}
...
extension CreateRulesetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateRulesetOutputResponse(name: \(Swift.String(describing: name)))"}
}
...
public struct CreateScheduleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateScheduleInputURLHostMiddleware"
    ...
    public typealias MInput = CreateScheduleInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateScheduleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateScheduleOutputError>
}

public struct CreateScheduleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateScheduleInputURLPathMiddleware"
...
extension DataBrewClientTypes.DataCatalogOutput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case catalogId = "CatalogId"
        case databaseName = "DatabaseName"
...
extension DataBrewClientTypes.DataCatalogOutput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DataCatalogOutput(catalogId: \(Swift.String(describing: catalogId)), databaseName: \(Swift.String(describing: databaseName)), databaseOptions: \(Swift.String(describing: databaseOptions)), overwrite: \(Swift.String(describing: overwrite)), s3Options: \(Swift.String(describing: s3Options)), tableName: \(Swift.String(describing: tableName)))"}
}
...
extension DataBrewClientTypes.DatabaseInputDefinition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatabaseInputDefinition(databaseTableName: \(Swift.String(describing: databaseTableName)), glueConnectionName: \(Swift.String(describing: glueConnectionName)), queryString: \(Swift.String(describing: queryString)), tempDirectory: \(Swift.String(describing: tempDirectory)))"}
}
...
extension DataBrewClientTypes.DatabaseOutput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case databaseOptions = "DatabaseOptions"
...
extension DataBrewClientTypes.DatabaseOutput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatabaseOutput(databaseOptions: \(Swift.String(describing: databaseOptions)), databaseOutputMode: \(Swift.String(describing: databaseOutputMode)), glueConnectionName: \(Swift.String(describing: glueConnectionName)))"}
}
...
extension DataBrewClientTypes.DatabaseTableOutputOptions: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case tableName = "TableName"
        case tempDirectory = "TempDirectory"
    }
...
extension DataBrewClientTypes.DatabaseTableOutputOptions: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatabaseTableOutputOptions(tableName: \(Swift.String(describing: tableName)), tempDirectory: \(Swift.String(describing: tempDirectory)))"}
}
...
public struct DeleteDatasetInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/datasets/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteJobInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/jobs/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteProjectInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/projects/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteRecipeVersionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecipeVersionInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteRecipeVersionInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteRecipeVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteRecipeVersionOutputError>
}

public struct DeleteRecipeVersionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecipeVersionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let recipeVersion = input.recipeVersion else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("recipeVersion is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/recipes/\(name.urlPercentEncoding())/recipeVersion/\(recipeVersion.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DeleteRulesetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteRulesetInput(name: \(Swift.String(describing: name)))"}
}

extension DeleteRulesetInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteRulesetInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRulesetInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteRulesetInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteRulesetOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteRulesetInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteRulesetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteRulesetOutputError>
}

public struct DeleteRulesetInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRulesetInputQueryItemMiddleware"
...
public struct DeleteRulesetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRulesetInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteRulesetInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteRulesetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteRulesetOutputError>
}

public struct DeleteRulesetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRulesetInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/rulesets/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DeleteRulesetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteRulesetOutputResponse(name: \(Swift.String(describing: name)))"}
}
...
public struct DeleteScheduleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteScheduleInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteScheduleInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteScheduleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteScheduleOutputError>
}

public struct DeleteScheduleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteScheduleInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/schedules/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeJobOutputResponse(createDate: \(Swift.String(describing: createDate)), createdBy: \(Swift.String(describing: createdBy)), dataCatalogOutputs: \(Swift.String(describing: dataCatalogOutputs)), databaseOutputs: \(Swift.String(describing: databaseOutputs)), datasetName: \(Swift.String(describing: datasetName)), encryptionKeyArn: \(Swift.String(describing: encryptionKeyArn)), encryptionMode: \(Swift.String(describing: encryptionMode)), jobSample: \(Swift.String(describing: jobSample)), lastModifiedBy: \(Swift.String(describing: lastModifiedBy)), lastModifiedDate: \(Swift.String(describing: lastModifiedDate)), logSubscription: \(Swift.String(describing: logSubscription)), maxCapacity: \(Swift.String(describing: maxCapacity)), maxRetries: \(Swift.String(describing: maxRetries)), name: \(Swift.String(describing: name)), outputs: \(Swift.String(describing: outputs)), profileConfiguration: \(Swift.String(describing: profileConfiguration)), projectName: \(Swift.String(describing: projectName)), recipeReference: \(Swift.String(describing: recipeReference)), resourceArn: \(Swift.String(describing: resourceArn)), roleArn: \(Swift.String(describing: roleArn)), tags: \(Swift.String(describing: tags)), timeout: \(Swift.String(describing: timeout)), type: \(Swift.String(describing: type)), validationConfigurations: \(Swift.String(describing: validationConfigurations)))"}
}
...
struct DescribeJobOutputResponseBody: Swift.Equatable {
    ...
    public let databaseOutputs: [DataBrewClientTypes.DatabaseOutput]?
    public let projectName: Swift.String?
    public let profileConfiguration: DataBrewClientTypes.ProfileConfiguration?
    public let validationConfigurations: [DataBrewClientTypes.ValidationConfiguration]?
    public let recipeReference: DataBrewClientTypes.RecipeReference?
    public let resourceArn: Swift.String?
    public let roleArn: Swift.String?
...
public struct DescribeJobRunInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJobRunInputURLHostMiddleware"
...
public struct DescribeJobRunInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let runId = input.runId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("runId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/jobs/\(name.urlPercentEncoding())/jobRun/\(runId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeJobRunOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeJobRunOutputResponse(attempt: \(Swift.String(describing: attempt)), completedOn: \(Swift.String(describing: completedOn)), dataCatalogOutputs: \(Swift.String(describing: dataCatalogOutputs)), databaseOutputs: \(Swift.String(describing: databaseOutputs)), datasetName: \(Swift.String(describing: datasetName)), errorMessage: \(Swift.String(describing: errorMessage)), executionTime: \(Swift.String(describing: executionTime)), jobName: \(Swift.String(describing: jobName)), jobSample: \(Swift.String(describing: jobSample)), logGroupName: \(Swift.String(describing: logGroupName)), logSubscription: \(Swift.String(describing: logSubscription)), outputs: \(Swift.String(describing: outputs)), profileConfiguration: \(Swift.String(describing: profileConfiguration)), recipeReference: \(Swift.String(describing: recipeReference)), runId: \(Swift.String(describing: runId)), startedBy: \(Swift.String(describing: startedBy)), startedOn: \(Swift.String(describing: startedOn)), state: \(Swift.String(describing: state)), validationConfigurations: \(Swift.String(describing: validationConfigurations)))"}
}
...
public struct DescribeRecipeInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRecipeInputURLHostMiddleware"
...
public struct DescribeRecipeInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/recipes/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeRulesetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeRulesetInput(name: \(Swift.String(describing: name)))"}
}

extension DescribeRulesetInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeRulesetInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRulesetInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeRulesetInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeRulesetOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeRulesetInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeRulesetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeRulesetOutputError>
}

public struct DescribeRulesetInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRulesetInputQueryItemMiddleware"
...
public struct DescribeRulesetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRulesetInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeRulesetInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeRulesetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeRulesetOutputError>
}

public struct DescribeRulesetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRulesetInputURLPathMiddleware"
...
extension DescribeRulesetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeRulesetOutputResponse(createDate: \(Swift.String(describing: createDate)), createdBy: \(Swift.String(describing: createdBy)), description: \(Swift.String(describing: description)), lastModifiedBy: \(Swift.String(describing: lastModifiedBy)), lastModifiedDate: \(Swift.String(describing: lastModifiedDate)), name: \(Swift.String(describing: name)), resourceArn: \(Swift.String(describing: resourceArn)), rules: \(Swift.String(describing: rules)), tags: \(Swift.String(describing: tags)), targetArn: \(Swift.String(describing: targetArn)))"}
}
...
public struct DescribeScheduleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScheduleInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeScheduleInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeScheduleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeScheduleOutputError>
}

public struct DescribeScheduleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeScheduleInputURLPathMiddleware"
...
extension DataBrewClientTypes.EntityDetectorConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DataBrewClientTypes.EntityDetectorConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EntityDetectorConfiguration(allowedStatistics: \(Swift.String(describing: allowedStatistics)), entityTypes: \(Swift.String(describing: entityTypes)))"}
}
...
extension DataBrewClientTypes.Input: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Input(dataCatalogInputDefinition: \(Swift.String(describing: dataCatalogInputDefinition)), databaseInputDefinition: \(Swift.String(describing: databaseInputDefinition)), metadata: \(Swift.String(describing: metadata)), s3InputDefinition: \(Swift.String(describing: s3InputDefinition)))"}
}
...
extension DataBrewClientTypes.JobRun: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobRun(attempt: \(Swift.String(describing: attempt)), completedOn: \(Swift.String(describing: completedOn)), dataCatalogOutputs: \(Swift.String(describing: dataCatalogOutputs)), databaseOutputs: \(Swift.String(describing: databaseOutputs)), datasetName: \(Swift.String(describing: datasetName)), errorMessage: \(Swift.String(describing: errorMessage)), executionTime: \(Swift.String(describing: executionTime)), jobName: \(Swift.String(describing: jobName)), jobSample: \(Swift.String(describing: jobSample)), logGroupName: \(Swift.String(describing: logGroupName)), logSubscription: \(Swift.String(describing: logSubscription)), outputs: \(Swift.String(describing: outputs)), recipeReference: \(Swift.String(describing: recipeReference)), runId: \(Swift.String(describing: runId)), startedBy: \(Swift.String(describing: startedBy)), startedOn: \(Swift.String(describing: startedOn)), state: \(Swift.String(describing: state)), validationConfigurations: \(Swift.String(describing: validationConfigurations)))"}
}
...
public struct ListJobRunsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJobRunsInputURLHostMiddleware"
...
public struct ListJobRunsInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/jobs/\(name.urlPercentEncoding())/jobRuns"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListRecipeVersionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecipeVersionsInputURLHostMiddleware"
    ...
    public typealias MInput = ListRecipeVersionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListRecipeVersionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRecipeVersionsOutputError>
}

public struct ListRecipeVersionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecipeVersionsInputURLPathMiddleware"
...
public struct ListRecipesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecipesInputURLHostMiddleware"
...
extension ListRulesetsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListRulesetsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), targetArn: \(Swift.String(describing: targetArn)))"}
}

extension ListRulesetsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListRulesetsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRulesetsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListRulesetsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListRulesetsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListRulesetsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListRulesetsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRulesetsOutputError>
}

public struct ListRulesetsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRulesetsInputQueryItemMiddleware"
...
public struct ListRulesetsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRulesetsInputURLHostMiddleware"
    ...
    public typealias MInput = ListRulesetsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListRulesetsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRulesetsOutputError>
}

public struct ListRulesetsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRulesetsInputURLPathMiddleware"
...
extension ListRulesetsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListRulesetsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), rulesets: \(Swift.String(describing: rulesets)))"}
}
...
struct ListRulesetsOutputResponseBody: Swift.Equatable {
    public let rulesets: [DataBrewClientTypes.RulesetItem]?
    public let nextToken: Swift.String?
}
...
public struct ListSchedulesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSchedulesInputURLHostMiddleware"
    ...
    public typealias MInput = ListSchedulesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListSchedulesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListSchedulesOutputError>
}

public struct ListSchedulesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSchedulesInputURLPathMiddleware"
...
extension DataBrewClientTypes.Metadata: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DataBrewClientTypes.Metadata: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Metadata(sourceArn: \(Swift.String(describing: sourceArn)))"}
}
...
extension DataBrewClientTypes.ProfileConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DataBrewClientTypes.ProfileConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ProfileConfiguration(columnStatisticsConfigurations: \(Swift.String(describing: columnStatisticsConfigurations)), datasetStatisticsConfiguration: \(Swift.String(describing: datasetStatisticsConfiguration)), entityDetectorConfiguration: \(Swift.String(describing: entityDetectorConfiguration)), profileColumns: \(Swift.String(describing: profileColumns)))"}
}
...
public struct PublishRecipeInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PublishRecipeInputURLHostMiddleware"
    ...
    public typealias MInput = PublishRecipeInput
    public typealias MOutput = ClientRuntime.OperationOutput<PublishRecipeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PublishRecipeOutputError>
}

public struct PublishRecipeInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PublishRecipeInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/recipes/\(name.urlPercentEncoding())/publishRecipe"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DataBrewClientTypes.Rule: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DataBrewClientTypes.Rule: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Rule(checkExpression: \(Swift.String(describing: checkExpression)), columnSelectors: \(Swift.String(describing: columnSelectors)), disabled: \(Swift.String(describing: disabled)), name: \(Swift.String(describing: name)), substitutionMap: \(Swift.String(describing: substitutionMap)), threshold: \(Swift.String(describing: threshold)))"}
}
...
extension DataBrewClientTypes.RulesetItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountId = "AccountId"
        case createDate = "CreateDate"
        case createdBy = "CreatedBy"
...
extension DataBrewClientTypes.RulesetItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RulesetItem(accountId: \(Swift.String(describing: accountId)), createDate: \(Swift.String(describing: createDate)), createdBy: \(Swift.String(describing: createdBy)), description: \(Swift.String(describing: description)), lastModifiedBy: \(Swift.String(describing: lastModifiedBy)), lastModifiedDate: \(Swift.String(describing: lastModifiedDate)), name: \(Swift.String(describing: name)), resourceArn: \(Swift.String(describing: resourceArn)), ruleCount: \(Swift.String(describing: ruleCount)), tags: \(Swift.String(describing: tags)), targetArn: \(Swift.String(describing: targetArn)))"}
}
...
extension DataBrewClientTypes.S3TableOutputOptions: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case location = "Location"
    }
...
extension DataBrewClientTypes.S3TableOutputOptions: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3TableOutputOptions(location: \(Swift.String(describing: location)))"}
}
...
public struct SendProjectSessionActionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SendProjectSessionActionInputURLHostMiddleware"
    ...
    public typealias MInput = SendProjectSessionActionInput
    public typealias MOutput = ClientRuntime.OperationOutput<SendProjectSessionActionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SendProjectSessionActionOutputError>
}

public struct SendProjectSessionActionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SendProjectSessionActionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/projects/\(name.urlPercentEncoding())/sendProjectSessionAction"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct StartJobRunInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartJobRunInputURLHostMiddleware"
...
public struct StartJobRunInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/jobs/\(name.urlPercentEncoding())/startJobRun"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct StartProjectSessionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartProjectSessionInputURLHostMiddleware"
    ...
    public typealias MInput = StartProjectSessionInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartProjectSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartProjectSessionOutputError>
}

public struct StartProjectSessionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartProjectSessionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/projects/\(name.urlPercentEncoding())/startProjectSession"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DataBrewClientTypes.StatisticOverride: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case parameters = "Parameters"
...
extension DataBrewClientTypes.StatisticOverride: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StatisticOverride(parameters: \(Swift.String(describing: parameters)), statistic: \(Swift.String(describing: statistic)))"}
}
...
extension DataBrewClientTypes.StatisticsConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DataBrewClientTypes.StatisticsConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StatisticsConfiguration(includedStatistics: \(Swift.String(describing: includedStatistics)), overrides: \(Swift.String(describing: overrides)))"}
}
...
public struct StopJobRunInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopJobRunInputURLHostMiddleware"
    ...
    public typealias MInput = StopJobRunInput
    public typealias MOutput = ClientRuntime.OperationOutput<StopJobRunOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopJobRunOutputError>
}

public struct StopJobRunInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopJobRunInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/jobs/\(name.urlPercentEncoding())/jobRun/\(runId.urlPercentEncoding())/stopJobRun"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DataBrewClientTypes.Threshold: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case type = "Type"
        case unit = "Unit"
        case value = "Value"
...
extension DataBrewClientTypes.Threshold: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Threshold(type: \(Swift.String(describing: type)), unit: \(Swift.String(describing: unit)), value: \(Swift.String(describing: value)))"}
}
...
extension UpdateProfileJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateProfileJobInput(configuration: \(Swift.String(describing: configuration)), encryptionKeyArn: \(Swift.String(describing: encryptionKeyArn)), encryptionMode: \(Swift.String(describing: encryptionMode)), jobSample: \(Swift.String(describing: jobSample)), logSubscription: \(Swift.String(describing: logSubscription)), maxCapacity: \(Swift.String(describing: maxCapacity)), maxRetries: \(Swift.String(describing: maxRetries)), name: \(Swift.String(describing: name)), outputLocation: \(Swift.String(describing: outputLocation)), roleArn: \(Swift.String(describing: roleArn)), timeout: \(Swift.String(describing: timeout)), validationConfigurations: \(Swift.String(describing: validationConfigurations)))"}
}
...
public struct UpdateProfileJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateProfileJobInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateProfileJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateProfileJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateProfileJobOutputError>
}

public struct UpdateProfileJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateProfileJobInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/profileJobs/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdateRecipeInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRecipeInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateRecipeInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRecipeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRecipeOutputError>
}

public struct UpdateRecipeInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRecipeInputURLPathMiddleware"
...
public struct UpdateRecipeJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRecipeJobInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateRecipeJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRecipeJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRecipeJobOutputError>
}

public struct UpdateRecipeJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRecipeJobInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/recipeJobs/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdateRulesetInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRulesetInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateRulesetInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateRulesetOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateRulesetInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRulesetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRulesetOutputError>
}

extension UpdateRulesetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRulesetInput(description: \(Swift.String(describing: description)), name: \(Swift.String(describing: name)), rules: \(Swift.String(describing: rules)))"}
}

extension UpdateRulesetInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case description = "Description"
        case rules = "Rules"
    }
...
public struct UpdateRulesetInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRulesetInputHeadersMiddleware"
...
public struct UpdateRulesetInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRulesetInputQueryItemMiddleware"
...
public struct UpdateRulesetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRulesetInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateRulesetInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRulesetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRulesetOutputError>
}

public struct UpdateRulesetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRulesetInputURLPathMiddleware"
...
extension UpdateRulesetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRulesetOutputResponse(name: \(Swift.String(describing: name)))"}
}
...
public struct UpdateScheduleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateScheduleInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateScheduleInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateScheduleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateScheduleOutputError>
}

public struct UpdateScheduleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateScheduleInputURLPathMiddleware"
...
extension DataBrewClientTypes.ValidationConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DataBrewClientTypes.ValidationConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ValidationConfiguration(rulesetArn: \(Swift.String(describing: rulesetArn)), validationMode: \(Swift.String(describing: validationMode)))"}
}
...
extension DataBrewClientTypes.ViewFrame: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ViewFrame(analytics: \(Swift.String(describing: analytics)), columnRange: \(Swift.String(describing: columnRange)), hiddenColumns: \(Swift.String(describing: hiddenColumns)), rowRange: \(Swift.String(describing: rowRange)), startColumnIndex: \(Swift.String(describing: startColumnIndex)), startRowIndex: \(Swift.String(describing: startRowIndex)))"}
}
