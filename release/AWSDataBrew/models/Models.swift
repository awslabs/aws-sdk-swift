...
public struct BatchDeleteRecipeVersionInput: Swift.Equatable {
    ...
    /// This member is required.
    var recipeVersions: [Swift.String]?
...
public struct BatchDeleteRecipeVersionOutputResponse: Swift.Equatable {
    ...
    var errors: [DataBrewClientTypes.RecipeVersionErrorDetail]?
...
extension DataBrewClientTypes {
    ...
    public struct ColumnStatisticsConfiguration: Swift.Equatable {
        ...
        var selectors: [DataBrewClientTypes.ColumnSelector]?
        /// Configuration for evaluations. Statistics can be used to select evaluations and override parameters of evaluations.
        /// This member is required.
        var statistics: DataBrewClientTypes.StatisticsConfiguration?
...
public struct CreateDatasetInput: Swift.Equatable {
    ...
    var format: DataBrewClientTypes.InputFormat?
    /// Represents a set of options that define the structure of either comma-separated value (CSV), Excel, or JSON input.
    var formatOptions: DataBrewClientTypes.FormatOptions?
    /// Represents information on how DataBrew can find data, in either the Glue Data Catalog or Amazon S3.
    /// This member is required.
    var input: DataBrewClientTypes.Input?
    /// The name of the dataset to be created. Valid characters are alphanumeric (A-Z, a-z, 0-9), hyphen (-), period (.), and space.
    /// This member is required.
    var name: Swift.String?
    /// A set of options that defines how DataBrew interprets an Amazon S3 path of the dataset.
    var pathOptions: DataBrewClientTypes.PathOptions?
...
public struct CreateProfileJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var outputLocation: DataBrewClientTypes.S3Location?
    ...
    var validationConfigurations: [DataBrewClientTypes.ValidationConfiguration]?
...
public struct CreateProjectInput: Swift.Equatable {
    ...
    /// This member is required.
    var recipeName: Swift.String?
    /// The Amazon Resource Name (ARN) of the Identity and Access Management (IAM) role to be assumed for this request.
    /// This member is required.
    var roleArn: Swift.String?
    /// Represents the sample size and sampling type for DataBrew to use for interactive data analysis.
    var sample: DataBrewClientTypes.Sample?
...
public struct CreateRecipeInput: Swift.Equatable {
    ...
    /// This member is required.
    var steps: [DataBrewClientTypes.RecipeStep]?
...
public struct CreateRecipeJobInput: Swift.Equatable {
    ...
    var dataCatalogOutputs: [DataBrewClientTypes.DataCatalogOutput]?
    /// Represents a list of JDBC database output objects which defines the output destination for a DataBrew recipe job to write to.
    var databaseOutputs: [DataBrewClientTypes.DatabaseOutput]?
    ...
    var outputs: [DataBrewClientTypes.Output]?
    /// Either the name of an existing project, or a combination of a recipe and a dataset to associate with the recipe.
    var projectName: Swift.String?
    /// Represents the name and version of a DataBrew recipe.
    var recipeReference: DataBrewClientTypes.RecipeReference?
    /// The Amazon Resource Name (ARN) of the Identity and Access Management (IAM) role to be assumed when DataBrew runs the job.
    /// This member is required.
    var roleArn: Swift.String?
    /// Metadata tags to apply to this job.
...
public struct CreateRulesetInput: Swift.Equatable {
    ...
    /// This member is required.
    var rules: [DataBrewClientTypes.Rule]?
...
public struct CreateScheduleInput: Swift.Equatable {
    ...
    /// This member is required.
    var cronExpression: Swift.String?
    /// The name or names of one or more jobs to be run.
    var jobNames: [Swift.String]?
...
extension DataBrewClientTypes {
    ...
    public struct DataCatalogInputDefinition: Swift.Equatable {
        ...
        var tempDirectory: DataBrewClientTypes.S3Location?
...
extension DataBrewClientTypes {
    ...
    public struct DataCatalogOutput: Swift.Equatable {
        ...
        var databaseOptions: DataBrewClientTypes.DatabaseTableOutputOptions?
        /// A value that, if true, means that any data in the location specified for output is overwritten with new output. Not supported with DatabaseOptions.
        var overwrite: Swift.Bool
        /// Represents options that specify how and where DataBrew writes the Amazon S3 output generated by recipe jobs.
        var s3Options: DataBrewClientTypes.S3TableOutputOptions?
...
extension DataBrewClientTypes {
    ...
    public struct DatabaseInputDefinition: Swift.Equatable {
        ...
        var databaseTableName: Swift.String?
        /// The Glue Connection that stores the connection information for the target database.
        /// This member is required.
        var glueConnectionName: Swift.String?
...
extension DataBrewClientTypes {
    ...
    public struct DatabaseOutput: Swift.Equatable {
        ...
        var databaseOutputMode: DataBrewClientTypes.DatabaseOutputMode?
        /// The Glue connection that stores the connection information for the target database.
        /// This member is required.
        var glueConnectionName: Swift.String?
...
extension DataBrewClientTypes {
    ...
    public struct Dataset: Swift.Equatable {
        ...
        var createDate: ClientRuntime.Date?
        ...
        var source: DataBrewClientTypes.Source?
...
extension DataBrewClientTypes {
    ...
    public struct DatasetParameter: Swift.Equatable {
        ...
        var createColumn: Swift.Bool
        /// Additional parameter options such as a format and a timezone. Required for datetime parameters.
        var datetimeOptions: DataBrewClientTypes.DatetimeOptions?
        /// The optional filter expression structure to apply additional matching criteria to the parameter.
        var filter: DataBrewClientTypes.FilterExpression?
        /// The name of the parameter that is used in the dataset's Amazon S3 path.
        /// This member is required.
        var name: Swift.String?
        /// The type of the dataset parameter, can be one of a 'String', 'Number' or 'Datetime'.
        /// This member is required.
        var type: DataBrewClientTypes.ParameterType?
...
extension DataBrewClientTypes {
    ...
    public struct DatetimeOptions: Swift.Equatable {
        ...
        var localeCode: Swift.String?
        /// Optional value for a timezone offset of the datetime parameter value in the Amazon S3 path. Shouldn't be used if Format for this parameter includes timezone fields. If no offset specified, UTC is assumed.
        var timezoneOffset: Swift.String?
...
public struct DeleteRecipeVersionInput: Swift.Equatable {
    ...
    /// This member is required.
    var recipeVersion: Swift.String?
...
public struct DescribeJobOutputResponse: Swift.Equatable {
    ...
    var outputs: [DataBrewClientTypes.Output]?
    /// Configuration for profile jobs. Used to select columns, do evaluations, and override default parameters of evaluations. When configuration is null, the profile job will run with default settings.
    var profileConfiguration: DataBrewClientTypes.ProfileConfiguration?
    ...
    var type: DataBrewClientTypes.JobType?
    /// List of validation configurations that are applied to the profile job.
    var validationConfigurations: [DataBrewClientTypes.ValidationConfiguration]?
...
public struct DescribeJobRunOutputResponse: Swift.Equatable {
    ...
    var attempt: Swift.Int
    /// The date and time when the job completed processing.
    var completedOn: ClientRuntime.Date?
    /// One or more artifacts that represent the Glue Data Catalog output from running the job.
    var dataCatalogOutputs: [DataBrewClientTypes.DataCatalogOutput]?
    /// Represents a list of JDBC database output objects which defines the output destination for a DataBrew recipe job to write into.
    var databaseOutputs: [DataBrewClientTypes.DatabaseOutput]?
    ...
    var startedOn: ClientRuntime.Date?
    /// The current state of the job run entity itself.
    var state: DataBrewClientTypes.JobRunState?
    /// List of validation configurations that are applied to the profile job.
    var validationConfigurations: [DataBrewClientTypes.ValidationConfiguration]?
...
public struct DescribeProjectOutputResponse: Swift.Equatable {
    ...
    var openDate: ClientRuntime.Date?
    /// The identifier (user name) of the user that opened the project for use.
    var openedBy: Swift.String?
    ...
    var sessionStatus: DataBrewClientTypes.SessionStatus?
...
public struct DescribeRecipeOutputResponse: Swift.Equatable {
    ...
    var publishedBy: Swift.String?
    /// The date and time when the recipe was last published.
    var publishedDate: ClientRuntime.Date?
...
extension DataBrewClientTypes {
    ...
    public struct EntityDetectorConfiguration: Swift.Equatable {
        /// Configuration of statistics that are allowed to be run on columns that contain detected entities. When undefined, no statistics will be computed on columns that contain detected entities.
        var allowedStatistics: [DataBrewClientTypes.AllowedStatistics]?
...
extension DataBrewClientTypes {
    ...
    public struct ExcelOptions: Swift.Equatable {
        ...
        var sheetIndexes: [Swift.Int]?
        /// One or more named sheets in the Excel file that will be included in the dataset.
        var sheetNames: [Swift.String]?
...
extension DataBrewClientTypes {
    ...
    public struct FilesLimit: Swift.Equatable {
        ...
        var order: DataBrewClientTypes.Order?
        /// A criteria to use for Amazon S3 files sorting before their selection. By default uses LAST_MODIFIED_DATE as a sorting criteria. Currently it's the only allowed value.
        var orderedBy: DataBrewClientTypes.OrderedBy?
...
extension DataBrewClientTypes {
    ...
    public struct FilterExpression: Swift.Equatable {
        ...
        /// This member is required.
        var valuesMap: [Swift.String:Swift.String]?
...
extension DataBrewClientTypes {
    ...
    public struct FormatOptions: Swift.Equatable {
        ...
        var csv: DataBrewClientTypes.CsvOptions?
        /// Options that define how Excel input is to be interpreted by DataBrew.
        var excel: DataBrewClientTypes.ExcelOptions?
        /// Options that define how JSON input is to be interpreted by DataBrew.
        var json: DataBrewClientTypes.JsonOptions?
...
extension DataBrewClientTypes {
    ...
    public struct Input: Swift.Equatable {
        ...
        var dataCatalogInputDefinition: DataBrewClientTypes.DataCatalogInputDefinition?
        /// Connection information for dataset input files stored in a database.
        var databaseInputDefinition: DataBrewClientTypes.DatabaseInputDefinition?
        /// Contains additional resource information needed for specific datasets.
        var metadata: DataBrewClientTypes.Metadata?
        /// The Amazon S3 location where the data is stored.
        var s3InputDefinition: DataBrewClientTypes.S3Location?
...
extension DataBrewClientTypes {
    ...
    public struct JobSample: Swift.Equatable {
        ...
        var mode: DataBrewClientTypes.SampleMode?
...
public struct ListDatasetsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var datasets: [DataBrewClientTypes.Dataset]?
...
public struct ListJobRunsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var jobRuns: [DataBrewClientTypes.JobRun]?
    /// A token that you can use in a subsequent call to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct ListJobsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var jobs: [DataBrewClientTypes.Job]?
    /// A token that you can use in a subsequent call to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct ListProjectsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var projects: [DataBrewClientTypes.Project]?
...
public struct ListRecipeVersionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var recipes: [DataBrewClientTypes.Recipe]?
...
public struct ListRulesetsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var rulesets: [DataBrewClientTypes.RulesetItem]?
...
public struct ListSchedulesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var schedules: [DataBrewClientTypes.Schedule]?
...
extension DataBrewClientTypes {
    ...
    public struct Output: Swift.Equatable {
        ...
        var compressionFormat: DataBrewClientTypes.CompressionFormat?
        /// The data format of the output of the job.
        var format: DataBrewClientTypes.OutputFormat?
        /// Represents options that define how DataBrew formats job output files.
        var formatOptions: DataBrewClientTypes.OutputFormatOptions?
        /// The location in Amazon S3 where the job writes its output.
        /// This member is required.
        var location: DataBrewClientTypes.S3Location?
...
extension DataBrewClientTypes {
    ...
    public struct OutputFormatOptions: Swift.Equatable {
        ...
        var csv: DataBrewClientTypes.CsvOutputOptions?
...
extension DataBrewClientTypes {
    ...
    public struct PathOptions: Swift.Equatable {
        ...
        var filesLimit: DataBrewClientTypes.FilesLimit?
        /// If provided, this structure defines a date range for matching Amazon S3 objects based on their LastModifiedDate attribute in Amazon S3.
        var lastModifiedDateCondition: DataBrewClientTypes.FilterExpression?
        /// A structure that maps names of parameters used in the Amazon S3 path of a dataset to their definitions.
        var parameters: [Swift.String:DataBrewClientTypes.DatasetParameter]?
...
extension DataBrewClientTypes {
    ...
    public struct ProfileConfiguration: Swift.Equatable {
        ...
        var columnStatisticsConfigurations: [DataBrewClientTypes.ColumnStatisticsConfiguration]?
        /// Configuration for inter-column evaluations. Configuration can be used to select evaluations and override parameters of evaluations. When configuration is undefined, the profile job will run all supported inter-column evaluations.
        var datasetStatisticsConfiguration: DataBrewClientTypes.StatisticsConfiguration?
        /// Configuration of entity detection for a profile job. When undefined, entity detection is disabled.
        var entityDetectorConfiguration: DataBrewClientTypes.EntityDetectorConfiguration?
        /// List of column selectors. ProfileColumns can be used to select columns from the dataset. When ProfileColumns is undefined, the profile job will profile all supported columns.
        var profileColumns: [DataBrewClientTypes.ColumnSelector]?
...
extension DataBrewClientTypes {
    ...
    public struct RecipeStep: Swift.Equatable {
        ...
        /// This member is required.
        var action: DataBrewClientTypes.RecipeAction?
        ...
        var conditionExpressions: [DataBrewClientTypes.ConditionExpression]?
...
extension DataBrewClientTypes {
    ...
    public struct Rule: Swift.Equatable {
        ...
        /// This member is required.
        var checkExpression: Swift.String?
        /// List of column selectors. Selectors can be used to select columns using a name or regular expression from the dataset. Rule will be applied to selected columns.
        var columnSelectors: [DataBrewClientTypes.ColumnSelector]?
        ...
        var substitutionMap: [Swift.String:Swift.String]?
        /// The threshold used with a non-aggregate check expression. Non-aggregate check expressions will be applied to each row in a specific column, and the threshold will be used to determine whether the validation succeeds.
        var threshold: DataBrewClientTypes.Threshold?
...
extension DataBrewClientTypes {
    ...
    public struct Sample: Swift.Equatable {
        ...
        /// This member is required.
        var type: DataBrewClientTypes.SampleType?
...
public struct SendProjectSessionActionInput: Swift.Equatable {
    ...
    var clientSessionId: Swift.String?
    /// The name of the project to apply the action to.
    /// This member is required.
    var name: Swift.String?
    /// If true, the result of the recipe step will be returned, but not applied.
    var preview: Swift.Bool
    /// Represents a single step from a DataBrew recipe to be performed.
    var recipeStep: DataBrewClientTypes.RecipeStep?
    /// The index from which to preview a step. This index is used to preview the result of steps that have already been applied, so that the resulting view frame is from earlier in the view frame stack.
    var stepIndex: Swift.Int?
    /// Represents the data being transformed during an action.
    var viewFrame: DataBrewClientTypes.ViewFrame?
...
extension DataBrewClientTypes {
    ...
    public struct StatisticsConfiguration: Swift.Equatable {
        ...
        var includedStatistics: [Swift.String]?
        /// List of overrides for evaluations.
        var overrides: [DataBrewClientTypes.StatisticOverride]?
...
extension DataBrewClientTypes {
    ...
    public struct Threshold: Swift.Equatable {
        ...
        var type: DataBrewClientTypes.ThresholdType?
        /// Unit of threshold value. Can be either a COUNT or PERCENTAGE of the full sample size used for validation.
        var unit: DataBrewClientTypes.ThresholdUnit?
...
extension DataBrewClientTypes {
    ...
    public struct ValidationConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var rulesetArn: Swift.String?
        /// Mode of data quality validation. Default mode is “CHECK_ALL” which verifies all rules defined in the selected ruleset.
        var validationMode: DataBrewClientTypes.ValidationMode?
...
extension DataBrewClientTypes {
    ...
    public struct ViewFrame: Swift.Equatable {
        ...
        var analytics: DataBrewClientTypes.AnalyticsMode?
        /// The number of columns to include in the view frame, beginning with the StartColumnIndex value and ignoring any columns in the HiddenColumns list.
        var columnRange: Swift.Int?
        /// A list of columns to hide in the view frame.
        var hiddenColumns: [Swift.String]?
        /// The number of rows to include in the view frame, beginning with the StartRowIndex value.
        var rowRange: Swift.Int?
        /// The starting index for the range of columns to return in the view frame.
        /// This member is required.
        var startColumnIndex: Swift.Int?
        /// The starting index for the range of rows to return in the view frame.
        var startRowIndex: Swift.Int?
