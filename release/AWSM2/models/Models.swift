...
extension M2ClientTypes.AlternateKey: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let allowDuplicatesDecoded = try containerValues.decode(Swift.Bool.self, forKey: .allowDuplicates)
...
extension GetDataSetDetailsOutputResponseBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        dataSetOrg = dataSetOrgDecoded
        let recordLengthDecoded = try containerValues.decode(Swift.Int.self, forKey: .recordLength)
        recordLength = recordLengthDecoded
        let locationDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .location)
        location = locationDecoded
        let blocksizeDecoded = try containerValues.decode(Swift.Int.self, forKey: .blocksize)
...
extension M2ClientTypes.RecordLength: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let minDecoded = try containerValues.decode(Swift.Int.self, forKey: .min)
        min = minDecoded
...
extension StopApplicationInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let forceStopDecoded = try containerValues.decode(Swift.Bool.self, forKey: .forceStop)
...
extension UpdateEnvironmentInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let preferredMaintenanceWindowDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .preferredMaintenanceWindow)
        preferredMaintenanceWindow = preferredMaintenanceWindowDecoded
        let applyDuringMaintenanceWindowDecoded = try containerValues.decode(Swift.Bool.self, forKey: .applyDuringMaintenanceWindow)
...
extension M2ClientTypes.VsamDetailAttributes: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let compressedDecoded = try containerValues.decode(Swift.Bool.self, forKey: .compressed)
        compressed = compressedDecoded
        let cacheAtStartupDecoded = try containerValues.decode(Swift.Bool.self, forKey: .cacheAtStartup)
