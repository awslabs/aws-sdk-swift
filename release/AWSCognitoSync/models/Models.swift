...
extension CognitoSyncClientTypes {
    ...
    public struct CognitoStreams: Swift.Equatable {
        ...
        var streamingStatus: CognitoSyncClientTypes.StreamingStatus?
...
public struct DeleteDatasetOutputResponse: Swift.Equatable {
    /// A collection of data for an identity pool. An identity pool can have multiple datasets. A dataset is per identity and can be general or associated with a particular entity in an application (like a saved game). Datasets are automatically created if they don't exist. Data is synced by dataset, and a dataset can hold up to 1MB of key-value pairs.
    var dataset: CognitoSyncClientTypes.Dataset?
...
public struct DescribeIdentityPoolUsageOutputResponse: Swift.Equatable {
    ...
    var identityPoolUsage: CognitoSyncClientTypes.IdentityPoolUsage?
...
public struct DescribeIdentityUsageOutputResponse: Swift.Equatable {
    ...
    var identityUsage: CognitoSyncClientTypes.IdentityUsage?
...
public struct GetBulkPublishDetailsOutputResponse: Swift.Equatable {
    ...
    var bulkPublishCompleteTime: ClientRuntime.Date?
    /// The date/time at which the last bulk publish was initiated.
    var bulkPublishStartTime: ClientRuntime.Date?
    ...
    var bulkPublishStatus: CognitoSyncClientTypes.BulkPublishStatus?
    /// If BulkPublishStatus is FAILED this field will contain the error message that caused the bulk publish to fail.
    var failureMessage: Swift.String?
    /// A name-spaced GUID (for example, us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito. GUID generation is unique within a region.
    var identityPoolId: Swift.String?
...
public struct GetCognitoEventsOutputResponse: Swift.Equatable {
    ...
    var events: [Swift.String:Swift.String]?
...
public struct GetIdentityPoolConfigurationOutputResponse: Swift.Equatable {
    ...
    var cognitoStreams: CognitoSyncClientTypes.CognitoStreams?
    /// A name-spaced GUID (for example, us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito.
    var identityPoolId: Swift.String?
    /// Options to apply to this identity pool for push synchronization.
    var pushSync: CognitoSyncClientTypes.PushSync?
...
extension CognitoSyncClientTypes {
    ...
    public struct IdentityPoolUsage: Swift.Equatable {
        ...
        var syncSessionsCount: Swift.Int?
...
public struct ListDatasetsOutputResponse: Swift.Equatable {
    ...
    var count: Swift.Int
    /// A set of datasets.
    var datasets: [CognitoSyncClientTypes.Dataset]?
    /// A pagination token for obtaining the next page of results.
    var nextToken: Swift.String?
...
public struct ListIdentityPoolUsageOutputResponse: Swift.Equatable {
    ...
    var identityPoolUsages: [CognitoSyncClientTypes.IdentityPoolUsage]?
    /// The maximum number of results to be returned.
    var maxResults: Swift.Int
    /// A pagination token for obtaining the next page of results.
    var nextToken: Swift.String?
...
public struct ListRecordsInput: Swift.Equatable {
    ...
    var lastSyncCount: Swift.Int?
    /// The maximum number of results to be returned.
    var maxResults: Swift.Int
    /// A pagination token for obtaining the next page of results.
    var nextToken: Swift.String?
    /// A token containing a session ID, identity ID, and expiration.
    var syncSessionToken: Swift.String?
...
public struct ListRecordsOutputResponse: Swift.Equatable {
    ...
    var datasetDeletedAfterRequestedSyncCount: Swift.Bool
    /// Indicates whether the dataset exists.
    var datasetExists: Swift.Bool
    /// Server sync count for this dataset.
    var datasetSyncCount: Swift.Int?
    /// The user/device that made the last change to this record.
    var lastModifiedBy: Swift.String?
    /// Names of merged datasets.
    var mergedDatasetNames: [Swift.String]?
    /// A pagination token for obtaining the next page of results.
    var nextToken: Swift.String?
    /// A list of all records.
    var records: [CognitoSyncClientTypes.Record]?
    /// A token containing a session ID, identity ID, and expiration.
    var syncSessionToken: Swift.String?
...
extension CognitoSyncClientTypes {
    ...
    public struct PushSync: Swift.Equatable {
        ...
        var applicationArns: [Swift.String]?
...
extension CognitoSyncClientTypes {
    ...
    public struct Record: Swift.Equatable {
        ...
        var deviceLastModifiedDate: ClientRuntime.Date?
...
extension CognitoSyncClientTypes {
    ...
    public struct RecordPatch: Swift.Equatable {
        ...
        /// This member is required.
        var op: CognitoSyncClientTypes.Operation?
...
public struct RegisterDeviceInput: Swift.Equatable {
    ...
    /// This member is required.
    var platform: CognitoSyncClientTypes.Platform?
    /// The push token.
    /// This member is required.
...
public struct UpdateRecordsInput: Swift.Equatable {
    ...
    var recordPatches: [CognitoSyncClientTypes.RecordPatch]?
