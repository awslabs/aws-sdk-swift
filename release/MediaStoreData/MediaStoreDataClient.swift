...
extension MediaStoreDataClient: MediaStoreDataClientProtocol {
    ...
    public func getObject(input: GetObjectInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetObjectOutputResponse, GetObjectOutputError>) -> Void)
    {
        guard let path = input.path else {
            completion(.failure(.client(ClientError.serializationFailed("uri component path unexpectedly nil"))))
            return
    ...
    public func putObject(input: PutObjectInput, streamSource: StreamSource, completion: @escaping (SdkResult<PutObjectOutputResponse, PutObjectOutputError>) -> Void)
    {
        guard let path = input.path else {
            completion(.failure(.client(ClientError.serializationFailed("uri component path unexpectedly nil"))))
            return
