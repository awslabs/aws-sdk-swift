...
extension DeleteObjectInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteObjectInput(path: \(Swift.String(describing: path)))"}
}
...
extension DescribeObjectInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeObjectInput(path: \(Swift.String(describing: path)))"}
}

extension DescribeObjectInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeObjectInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeObjectInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeObjectInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeObjectOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeObjectInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeObjectOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeObjectOutputError>
}

public struct DescribeObjectInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeObjectInputQueryItemMiddleware"
...
extension DescribeObjectOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeObjectOutputResponse(cacheControl: \(Swift.String(describing: cacheControl)), contentLength: \(Swift.String(describing: contentLength)), contentType: \(Swift.String(describing: contentType)), eTag: \(Swift.String(describing: eTag)), lastModified: \(Swift.String(describing: lastModified)))"}
}
...
public struct DescribeObjectOutputResponse: Swift.Equatable {
    ...
    ///          object's cache behavior. Headers can be passed in as specified in the HTTP at <a href="https://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9">https://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.
...
struct DescribeObjectOutputResponseBody: Swift.Equatable {
}

extension DescribeObjectOutputResponseBody: Swift.Decodable {
...
extension GetObjectInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetObjectInput(path: \(Swift.String(describing: path)), range: \(Swift.String(describing: range)))"}
}
...
public struct GetObjectInput: Swift.Equatable {
    ...
    ///          For more information about folders and how they exist in a container, see the <a href="http://docs.aws.amazon.com/mediastore/latest/ug/">AWS Elemental MediaStore User
    ///             Guide.
    ...
    ///           Range header, see <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.35">http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.35. AWS Elemental MediaStore ignores this header for partially uploaded objects that have streaming upload availability.
...
extension GetObjectOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetObjectOutputResponse(body: \(Swift.String(describing: body)), cacheControl: \(Swift.String(describing: cacheControl)), contentLength: \(Swift.String(describing: contentLength)), contentRange: \(Swift.String(describing: contentRange)), contentType: \(Swift.String(describing: contentType)), eTag: \(Swift.String(describing: eTag)), lastModified: \(Swift.String(describing: lastModified)), statusCode: \(Swift.String(describing: statusCode)))"}
}
...
public struct GetObjectOutputResponse: Swift.Equatable {
    ...
    /// An optional CacheControl header that allows the caller to control the
    ///          object's cache behavior. Headers can be passed in as specified in the HTTP spec at <a href="https://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9">https://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9.
    ///          Headers with a custom user-defined value are also accepted.
    public let cacheControl: Swift.String?
    /// The length of the object in bytes.
    public let contentLength: Swift.Int?
...
extension MediaStoreDataClientTypes.Item: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaStoreDataClientTypes.Item: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Item(contentLength: \(Swift.String(describing: contentLength)), contentType: \(Swift.String(describing: contentType)), eTag: \(Swift.String(describing: eTag)), lastModified: \(Swift.String(describing: lastModified)), name: \(Swift.String(describing: name)), type: \(Swift.String(describing: type)))"}
}
...
extension MediaStoreDataClientTypes {
    ...
    public struct Item: Swift.Equatable {
        ...
        public let type: MediaStoreDataClientTypes.ItemType?
...
extension ListItemsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListItemsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), path: \(Swift.String(describing: path)))"}
}

extension ListItemsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListItemsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListItemsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListItemsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListItemsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListItemsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListItemsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListItemsOutputError>
}

public struct ListItemsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListItemsInputQueryItemMiddleware"
...
extension ListItemsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListItemsOutputResponse(items: \(Swift.String(describing: items)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct ListItemsOutputResponse: Swift.Equatable {
    ...
    public let items: [MediaStoreDataClientTypes.Item]?
...
extension PutObjectInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutObjectInput(body: \(Swift.String(describing: body)), cacheControl: \(Swift.String(describing: cacheControl)), contentType: \(Swift.String(describing: contentType)), path: \(Swift.String(describing: path)), storageClass: \(Swift.String(describing: storageClass)), uploadAvailability: \(Swift.String(describing: uploadAvailability)))"}
}
...
public struct PutObjectInputHeadersMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        if let uploadAvailability = input.operationInput.uploadAvailability {
            input.builder.withHeader(name: "x-amz-upload-availability", value: Swift.String(uploadAvailability.rawValue))
        }
        return next.handle(context: context, input: input)
    }
...
public struct PutObjectInput: Swift.Equatable {
    ...
    public let storageClass: MediaStoreDataClientTypes.StorageClass?
    /// Indicates the availability of an object while it is still uploading. If the value is set to streaming, the object is available for
    ///             downloading after some initial buffering but before the object is uploaded completely. If the value is set to standard, the object is
    ///             available for downloading only when it is uploaded completely. The default value for this header is standard.
    ///         To use this header, you must also set the HTTP Transfer-Encoding header to chunked.
    public let uploadAvailability: MediaStoreDataClientTypes.UploadAvailability?
...
extension PutObjectOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutObjectOutputResponse(contentSHA256: \(Swift.String(describing: contentSHA256)), eTag: \(Swift.String(describing: eTag)), storageClass: \(Swift.String(describing: storageClass)))"}
}
...
public struct PutObjectOutputResponse: Swift.Equatable {
    ...
    public let contentSHA256: Swift.String?
...
extension RequestedRangeNotSatisfiableException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RequestedRangeNotSatisfiableException(message: \(Swift.String(describing: message)))"}
}
