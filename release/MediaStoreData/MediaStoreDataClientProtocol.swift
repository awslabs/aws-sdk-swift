...
public protocol MediaStoreDataClientProtocol {
    ...
    func describeObject(input: DescribeObjectInput, completion: @escaping (SdkResult<DescribeObjectOutput, DescribeObjectOutputError>) -> Void)
    ...
    ///          folder.</p>
    func listItems(input: ListItemsInput, completion: @escaping (SdkResult<ListItemsOutput, ListItemsOutputError>) -> Void)
