...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct Component: Swift.Equatable {
        ...
        /// This member is required.
        var bindingProperties: [Swift.String:AmplifyUiBuilderClientTypes.ComponentBindingPropertiesValue]?
        /// A list of the component's ComponentChild instances.
        var children: [AmplifyUiBuilderClientTypes.ComponentChild]?
        /// The data binding configuration for the component's properties. Use this for a collection component.
        var collectionProperties: [Swift.String:AmplifyUiBuilderClientTypes.ComponentDataConfiguration]?
        /// The type of the component. This can be an Amplify custom UI component or another custom component.
        /// This member is required.
        var componentType: Swift.String?
        ...
        /// This member is required.
        var overrides: [Swift.String:[Swift.String:Swift.String]]?
        /// Describes the component's properties.
        /// This member is required.
        var properties: [Swift.String:AmplifyUiBuilderClientTypes.ComponentProperty]?
        ...
        /// This member is required.
        var variants: [AmplifyUiBuilderClientTypes.ComponentVariant]?
...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct ComponentBindingPropertiesValue: Swift.Equatable {
        ...
        var bindingProperties: AmplifyUiBuilderClientTypes.ComponentBindingPropertiesValueProperties?
...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct ComponentBindingPropertiesValueProperties: Swift.Equatable {
        ...
        var predicates: [AmplifyUiBuilderClientTypes.Predicate]?
        /// An authenticated user attribute.
        var userAttribute: Swift.String?
...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct ComponentConditionProperty: Swift.Equatable {
        ...
        var `else`: Box<AmplifyUiBuilderClientTypes.ComponentProperty>?
        /// The operator to use to perform the evaluation, such as eq to represent equals.
        var `operator`: Swift.String?
        /// The name of a field. Specify this when the property is a data model.
        var field: Swift.String?
        /// The value of the property to evaluate.
        var operand: Swift.String?
        /// The name of the conditional property.
        var property: Swift.String?
        /// The value to assign to the property if the condition is met.
        var then: Box<AmplifyUiBuilderClientTypes.ComponentProperty>?
...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct ComponentDataConfiguration: Swift.Equatable {
        ...
        var predicate: AmplifyUiBuilderClientTypes.Predicate?
        /// Describes how to sort the component's properties.
        var sort: [AmplifyUiBuilderClientTypes.SortProperty]?
...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct ComponentProperty: Swift.Equatable {
        ...
        var bindingProperties: AmplifyUiBuilderClientTypes.ComponentPropertyBindingProperties?
        /// The information to bind the component property to form data.
        var bindings: [Swift.String:AmplifyUiBuilderClientTypes.FormBindingElement]?
        /// The information to bind the component property to data at runtime. Use this for collection components.
        var collectionBindingProperties: AmplifyUiBuilderClientTypes.ComponentPropertyBindingProperties?
        /// A list of component properties to concatenate to create the value to assign to this component property.
        var concat: [AmplifyUiBuilderClientTypes.ComponentProperty]?
        /// The conditional expression to use to assign a value to the component property..
        var condition: AmplifyUiBuilderClientTypes.ComponentConditionProperty?
        ...
        var importedValue: Swift.String?
...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct ComponentVariant: Swift.Equatable {
        ...
        var variantValues: [Swift.String:Swift.String]?
...
public struct CreateComponentInput: Swift.Equatable {
    ...
    /// This member is required.
    var componentToCreate: AmplifyUiBuilderClientTypes.CreateComponentData?
    /// The name of the backend environment that is a part of the Amplify app.
    /// This member is required.
    var environmentName: Swift.String?
...
public struct CreateComponentOutputResponse: Swift.Equatable {
    ...
    var entity: AmplifyUiBuilderClientTypes.Component?
...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct CreateThemeData: Swift.Equatable {
        ...
        var overrides: [AmplifyUiBuilderClientTypes.ThemeValues]?
        /// One or more key-value pairs to use when tagging the theme data.
        var tags: [Swift.String:Swift.String]?
        /// A list of key-value pairs that deﬁnes the properties of the theme.
        /// This member is required.
        var values: [AmplifyUiBuilderClientTypes.ThemeValues]?
...
public struct CreateThemeInput: Swift.Equatable {
    ...
    /// This member is required.
    var themeToCreate: AmplifyUiBuilderClientTypes.CreateThemeData?
...
public struct CreateThemeOutputResponse: Swift.Equatable {
    ...
    var entity: AmplifyUiBuilderClientTypes.Theme?
...
public struct ExchangeCodeForTokenInput: Swift.Equatable {
    ...
    /// This member is required.
    var provider: AmplifyUiBuilderClientTypes.TokenProviders?
    /// Describes the configuration of the request.
    /// This member is required.
    var request: AmplifyUiBuilderClientTypes.ExchangeCodeForTokenRequestBody?
...
public struct ExportComponentsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entities: [AmplifyUiBuilderClientTypes.Component]?
...
public struct ExportThemesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entities: [AmplifyUiBuilderClientTypes.Theme]?
...
public struct GetComponentOutputResponse: Swift.Equatable {
    ...
    var component: AmplifyUiBuilderClientTypes.Component?
...
public struct GetThemeOutputResponse: Swift.Equatable {
    ...
    var theme: AmplifyUiBuilderClientTypes.Theme?
...
public struct ListComponentsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entities: [AmplifyUiBuilderClientTypes.ComponentSummary]?
...
public struct ListThemesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entities: [AmplifyUiBuilderClientTypes.ThemeSummary]?
...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct Predicate: Swift.Equatable {
        ...
        var and: [AmplifyUiBuilderClientTypes.Predicate]?
        /// The field to query.
        var field: Swift.String?
        /// The value to use when performing the evaluation.
        var operand: Swift.String?
        /// A list of predicates to combine logically.
        var or: [AmplifyUiBuilderClientTypes.Predicate]?
...
public struct RefreshTokenInput: Swift.Equatable {
    ...
    /// This member is required.
    var refreshTokenBody: AmplifyUiBuilderClientTypes.RefreshTokenRequestBody?
...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct SortProperty: Swift.Equatable {
        ...
        /// This member is required.
        var direction: AmplifyUiBuilderClientTypes.SortDirection?
...
extension AmplifyUiBuilderClientTypes {
    ...
    public struct ThemeValue: Swift.Equatable {
        ...
        var children: [AmplifyUiBuilderClientTypes.ThemeValues]?
...
public struct UpdateComponentInput: Swift.Equatable {
    ...
    /// This member is required.
    var updatedComponent: AmplifyUiBuilderClientTypes.UpdateComponentData?
...
public struct UpdateThemeInput: Swift.Equatable {
    ...
    /// This member is required.
    var updatedTheme: AmplifyUiBuilderClientTypes.UpdateThemeData?
