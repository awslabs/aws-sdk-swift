...
public struct CreateLedgerInput: Swift.Equatable {
    ...
    /// This member is required.
    var permissionsMode: QldbClientTypes.PermissionsMode?
...
public struct CreateLedgerOutputResponse: Swift.Equatable {
    ...
    var creationDateTime: ClientRuntime.Date?
    /// The flag that prevents a ledger from being deleted by any user. If not provided on ledger creation, this feature is enabled (true) by default. If deletion protection is enabled, you must first disable it before you can delete the ledger. You can disable it by calling the UpdateLedger operation to set the flag to false.
    var deletionProtection: Swift.Bool?
    ...
    var state: QldbClientTypes.LedgerState?
...
public struct DescribeJournalKinesisStreamOutputResponse: Swift.Equatable {
    ...
    var stream: QldbClientTypes.JournalKinesisStreamDescription?
...
public struct DescribeJournalS3ExportOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var exportDescription: QldbClientTypes.JournalS3ExportDescription?
...
public struct DescribeLedgerOutputResponse: Swift.Equatable {
    ...
    var encryptionDescription: QldbClientTypes.LedgerEncryptionDescription?
    /// The name of the ledger.
    var name: Swift.String?
...
public struct ExportJournalToS3Input: Swift.Equatable {
    ...
    /// This member is required.
    var exclusiveEndTime: ClientRuntime.Date?
    ...
    /// This member is required.
    var inclusiveStartTime: ClientRuntime.Date?
    /// The name of the ledger.
    /// This member is required.
    var name: Swift.String?
    ...
    /// This member is required.
    var s3ExportConfiguration: QldbClientTypes.S3ExportConfiguration?
...
public struct GetBlockInput: Swift.Equatable {
    ...
    /// This member is required.
    var blockAddress: QldbClientTypes.ValueHolder?
    ...
    var digestTipAddress: QldbClientTypes.ValueHolder?
    /// The name of the ledger.
    /// This member is required.
    var name: Swift.String?
...
public struct GetBlockOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var block: QldbClientTypes.ValueHolder?
    ...
    var proof: QldbClientTypes.ValueHolder?
...
public struct GetRevisionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var revision: QldbClientTypes.ValueHolder?
...
extension QldbClientTypes {
    ...
    public struct JournalKinesisStreamDescription: Swift.Equatable {
        ...
        var errorCause: QldbClientTypes.ErrorCause?
        ...
        /// This member is required.
        var kinesisConfiguration: QldbClientTypes.KinesisConfiguration?
        /// The name of the ledger.
        /// This member is required.
        var ledgerName: Swift.String?
        ...
        /// This member is required.
        var status: QldbClientTypes.StreamStatus?
...
extension QldbClientTypes {
    ...
    public struct JournalS3ExportDescription: Swift.Equatable {
        ...
        /// This member is required.
        var exportCreationTime: ClientRuntime.Date?
        ...
        /// This member is required.
        var status: QldbClientTypes.ExportStatus?
...
extension QldbClientTypes {
    ...
    public struct KinesisConfiguration: Swift.Equatable {
        ...
        var aggregationEnabled: Swift.Bool?
...
extension QldbClientTypes {
    ...
    public struct LedgerEncryptionDescription: Swift.Equatable {
        ...
        /// This member is required.
        var encryptionStatus: QldbClientTypes.EncryptionStatus?
        ...
        var inaccessibleKmsKeyDateTime: ClientRuntime.Date?
...
public struct ListJournalKinesisStreamsForLedgerOutputResponse: Swift.Equatable {
    ...
    var streams: [QldbClientTypes.JournalKinesisStreamDescription]?
...
public struct ListJournalS3ExportsForLedgerOutputResponse: Swift.Equatable {
    ...
    var journalS3Exports: [QldbClientTypes.JournalS3ExportDescription]?
...
public struct ListLedgersOutputResponse: Swift.Equatable {
    ...
    var ledgers: [QldbClientTypes.LedgerSummary]?
...
extension QldbClientTypes {
    ...
    public struct S3EncryptionConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var objectEncryptionType: QldbClientTypes.S3ObjectEncryptionType?
...
extension QldbClientTypes {
    ...
    public struct S3ExportConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var encryptionConfiguration: QldbClientTypes.S3EncryptionConfiguration?
