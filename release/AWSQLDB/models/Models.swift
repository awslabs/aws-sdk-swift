...
extension CancelJournalKinesisStreamInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CancelJournalKinesisStreamInput(ledgerName: \(Swift.String(describing: ledgerName)), streamId: \(Swift.String(describing: streamId)))"}
}

extension CancelJournalKinesisStreamInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct CancelJournalKinesisStreamInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelJournalKinesisStreamInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CancelJournalKinesisStreamInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CancelJournalKinesisStreamOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CancelJournalKinesisStreamInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CancelJournalKinesisStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelJournalKinesisStreamOutputError>
}

public struct CancelJournalKinesisStreamInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelJournalKinesisStreamInputQueryItemMiddleware"
...
public struct CancelJournalKinesisStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelJournalKinesisStreamInputURLHostMiddleware"
    ...
    public typealias MInput = CancelJournalKinesisStreamInput
    public typealias MOutput = ClientRuntime.OperationOutput<CancelJournalKinesisStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelJournalKinesisStreamOutputError>
}

public struct CancelJournalKinesisStreamInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelJournalKinesisStreamInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let ledgerName = input.ledgerName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("ledgerName is nil and needs a value for the path of this operation"))))
        }
        ...
        var urlPath = "/ledgers/\(ledgerName.urlPercentEncoding())/journal-kinesis-streams/\(streamId.urlPercentEncoding())"
...
extension CancelJournalKinesisStreamOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CancelJournalKinesisStreamOutputResponse(streamId: \(Swift.String(describing: streamId)))"}
}
...
public struct CreateLedgerInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateLedgerInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateLedgerInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateLedgerOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateLedgerInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateLedgerOutputError>
}

extension CreateLedgerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateLedgerInput(deletionProtection: \(Swift.String(describing: deletionProtection)), kmsKey: \(Swift.String(describing: kmsKey)), name: \(Swift.String(describing: name)), permissionsMode: \(Swift.String(describing: permissionsMode)), tags: \(Swift.String(describing: tags)))"}
}

extension CreateLedgerInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateLedgerInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateLedgerInputHeadersMiddleware"
...
public struct CreateLedgerInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateLedgerInputQueryItemMiddleware"
...
public struct CreateLedgerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateLedgerInputURLHostMiddleware"
    ...
    public typealias MInput = CreateLedgerInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateLedgerOutputError>
}

public struct CreateLedgerInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateLedgerInputURLPathMiddleware"
...
struct CreateLedgerInputBody: Swift.Equatable {
    ...
    public let permissionsMode: QldbClientTypes.PermissionsMode?
...
extension CreateLedgerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateLedgerOutputResponse(arn: \(Swift.String(describing: arn)), creationDateTime: \(Swift.String(describing: creationDateTime)), deletionProtection: \(Swift.String(describing: deletionProtection)), kmsKeyArn: \(Swift.String(describing: kmsKeyArn)), name: \(Swift.String(describing: name)), permissionsMode: \(Swift.String(describing: permissionsMode)), state: \(Swift.String(describing: state)))"}
}
...
struct CreateLedgerOutputResponseBody: Swift.Equatable {
    ...
    public let state: QldbClientTypes.LedgerState?
...
extension DeleteLedgerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteLedgerInput(name: \(Swift.String(describing: name)))"}
}

extension DeleteLedgerInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteLedgerInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteLedgerInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteLedgerInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteLedgerOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteLedgerInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteLedgerOutputError>
}

public struct DeleteLedgerInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteLedgerInputQueryItemMiddleware"
...
public struct DeleteLedgerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteLedgerInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteLedgerInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteLedgerOutputError>
}

public struct DeleteLedgerInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteLedgerInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/ledgers/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DeleteLedgerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteLedgerOutputResponseBody: Swift.Equatable {
}

extension DeleteLedgerOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension DescribeJournalKinesisStreamInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeJournalKinesisStreamInput(ledgerName: \(Swift.String(describing: ledgerName)), streamId: \(Swift.String(describing: streamId)))"}
}

extension DescribeJournalKinesisStreamInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeJournalKinesisStreamInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJournalKinesisStreamInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeJournalKinesisStreamInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeJournalKinesisStreamOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeJournalKinesisStreamInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeJournalKinesisStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeJournalKinesisStreamOutputError>
}

public struct DescribeJournalKinesisStreamInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJournalKinesisStreamInputQueryItemMiddleware"
...
public struct DescribeJournalKinesisStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJournalKinesisStreamInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeJournalKinesisStreamInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeJournalKinesisStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeJournalKinesisStreamOutputError>
}

public struct DescribeJournalKinesisStreamInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJournalKinesisStreamInputURLPathMiddleware"
...
extension DescribeJournalKinesisStreamOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeJournalKinesisStreamOutputResponse(stream: \(Swift.String(describing: stream)))"}
}
...
struct DescribeJournalKinesisStreamOutputResponseBody: Swift.Equatable {
    public let stream: QldbClientTypes.JournalKinesisStreamDescription?
}
...
extension DescribeJournalS3ExportInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeJournalS3ExportInput(exportId: \(Swift.String(describing: exportId)), name: \(Swift.String(describing: name)))"}
}

extension DescribeJournalS3ExportInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeJournalS3ExportInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJournalS3ExportInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeJournalS3ExportInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeJournalS3ExportOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeJournalS3ExportInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeJournalS3ExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeJournalS3ExportOutputError>
}

public struct DescribeJournalS3ExportInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJournalS3ExportInputQueryItemMiddleware"
...
public struct DescribeJournalS3ExportInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJournalS3ExportInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeJournalS3ExportInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeJournalS3ExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeJournalS3ExportOutputError>
}

public struct DescribeJournalS3ExportInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeJournalS3ExportInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let exportId = input.exportId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("exportId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/ledgers/\(name.urlPercentEncoding())/journal-s3-exports/\(exportId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeJournalS3ExportOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeJournalS3ExportOutputResponse(exportDescription: \(Swift.String(describing: exportDescription)))"}
}
...
struct DescribeJournalS3ExportOutputResponseBody: Swift.Equatable {
    public let exportDescription: QldbClientTypes.JournalS3ExportDescription?
}
...
extension DescribeLedgerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeLedgerInput(name: \(Swift.String(describing: name)))"}
}

extension DescribeLedgerInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeLedgerInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeLedgerInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeLedgerInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeLedgerOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeLedgerInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeLedgerOutputError>
}

public struct DescribeLedgerInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeLedgerInputQueryItemMiddleware"
...
public struct DescribeLedgerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeLedgerInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeLedgerInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeLedgerOutputError>
}

public struct DescribeLedgerInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeLedgerInputURLPathMiddleware"
...
extension DescribeLedgerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeLedgerOutputResponse(arn: \(Swift.String(describing: arn)), creationDateTime: \(Swift.String(describing: creationDateTime)), deletionProtection: \(Swift.String(describing: deletionProtection)), encryptionDescription: \(Swift.String(describing: encryptionDescription)), name: \(Swift.String(describing: name)), permissionsMode: \(Swift.String(describing: permissionsMode)), state: \(Swift.String(describing: state)))"}
}
...
struct DescribeLedgerOutputResponseBody: Swift.Equatable {
    ...
    public let permissionsMode: QldbClientTypes.PermissionsMode?
    public let deletionProtection: Swift.Bool?
    public let encryptionDescription: QldbClientTypes.LedgerEncryptionDescription?
}
...
public struct ExportJournalToS3InputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportJournalToS3InputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ExportJournalToS3Input>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ExportJournalToS3OutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ExportJournalToS3Input>
    public typealias MOutput = ClientRuntime.OperationOutput<ExportJournalToS3OutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExportJournalToS3OutputError>
}

extension ExportJournalToS3Input: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExportJournalToS3Input(exclusiveEndTime: \(Swift.String(describing: exclusiveEndTime)), inclusiveStartTime: \(Swift.String(describing: inclusiveStartTime)), name: \(Swift.String(describing: name)), roleArn: \(Swift.String(describing: roleArn)), s3ExportConfiguration: \(Swift.String(describing: s3ExportConfiguration)))"}
}

extension ExportJournalToS3Input: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ExportJournalToS3InputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportJournalToS3InputHeadersMiddleware"
...
public struct ExportJournalToS3InputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportJournalToS3InputQueryItemMiddleware"
...
public struct ExportJournalToS3InputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportJournalToS3InputURLHostMiddleware"
    ...
    public typealias MInput = ExportJournalToS3Input
    public typealias MOutput = ClientRuntime.OperationOutput<ExportJournalToS3OutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExportJournalToS3OutputError>
}

public struct ExportJournalToS3InputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportJournalToS3InputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/ledgers/\(name.urlPercentEncoding())/journal-s3-exports"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct ExportJournalToS3InputBody: Swift.Equatable {
    public let inclusiveStartTime: ClientRuntime.Date?
    public let exclusiveEndTime: ClientRuntime.Date?
    public let s3ExportConfiguration: QldbClientTypes.S3ExportConfiguration?
...
extension ExportJournalToS3OutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExportJournalToS3OutputResponse(exportId: \(Swift.String(describing: exportId)))"}
}
...
public struct GetBlockInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBlockInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetBlockInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetBlockOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetBlockInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetBlockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetBlockOutputError>
}

extension GetBlockInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetBlockInput(blockAddress: \(Swift.String(describing: blockAddress)), digestTipAddress: \(Swift.String(describing: digestTipAddress)), name: \(Swift.String(describing: name)))"}
}

extension GetBlockInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct GetBlockInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBlockInputHeadersMiddleware"
...
public struct GetBlockInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBlockInputQueryItemMiddleware"
...
public struct GetBlockInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBlockInputURLHostMiddleware"
    ...
    public typealias MInput = GetBlockInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetBlockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetBlockOutputError>
}

public struct GetBlockInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBlockInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/ledgers/\(name.urlPercentEncoding())/block"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct GetBlockInputBody: Swift.Equatable {
    public let blockAddress: QldbClientTypes.ValueHolder?
    public let digestTipAddress: QldbClientTypes.ValueHolder?
}
...
extension GetBlockOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetBlockOutputResponse(block: \(Swift.String(describing: block)), proof: \(Swift.String(describing: proof)))"}
}
...
struct GetBlockOutputResponseBody: Swift.Equatable {
    public let block: QldbClientTypes.ValueHolder?
    public let proof: QldbClientTypes.ValueHolder?
}
...
extension GetDigestInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetDigestInput(name: \(Swift.String(describing: name)))"}
}

extension GetDigestInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetDigestInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDigestInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetDigestInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetDigestOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetDigestInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetDigestOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetDigestOutputError>
}

public struct GetDigestInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDigestInputQueryItemMiddleware"
...
public struct GetDigestInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDigestInputURLHostMiddleware"
    ...
    public typealias MInput = GetDigestInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetDigestOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetDigestOutputError>
}

public struct GetDigestInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDigestInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/ledgers/\(name.urlPercentEncoding())/digest"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension GetDigestOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetDigestOutputResponse(digest: \(Swift.String(describing: digest)), digestTipAddress: \(Swift.String(describing: digestTipAddress)))"}
}
...
struct GetDigestOutputResponseBody: Swift.Equatable {
    public let digest: ClientRuntime.Data?
    public let digestTipAddress: QldbClientTypes.ValueHolder?
}
...
public struct GetRevisionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRevisionInputBodyMiddleware"
...
extension GetRevisionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRevisionInput(blockAddress: \(Swift.String(describing: blockAddress)), digestTipAddress: \(Swift.String(describing: digestTipAddress)), documentId: \(Swift.String(describing: documentId)), name: \(Swift.String(describing: name)))"}
}
...
public struct GetRevisionInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/ledgers/\(name.urlPercentEncoding())/revision"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension GetRevisionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRevisionOutputResponse(proof: \(Swift.String(describing: proof)), revision: \(Swift.String(describing: revision)))"}
}
...
struct GetRevisionOutputResponseBody: Swift.Equatable {
    public let proof: QldbClientTypes.ValueHolder?
    public let revision: QldbClientTypes.ValueHolder?
}
...
extension QldbClientTypes.JournalKinesisStreamDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
...
extension QldbClientTypes.JournalKinesisStreamDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JournalKinesisStreamDescription(arn: \(Swift.String(describing: arn)), creationTime: \(Swift.String(describing: creationTime)), errorCause: \(Swift.String(describing: errorCause)), exclusiveEndTime: \(Swift.String(describing: exclusiveEndTime)), inclusiveStartTime: \(Swift.String(describing: inclusiveStartTime)), kinesisConfiguration: \(Swift.String(describing: kinesisConfiguration)), ledgerName: \(Swift.String(describing: ledgerName)), roleArn: \(Swift.String(describing: roleArn)), status: \(Swift.String(describing: status)), streamId: \(Swift.String(describing: streamId)), streamName: \(Swift.String(describing: streamName)))"}
}
...
extension QldbClientTypes.JournalS3ExportDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case exclusiveEndTime = "ExclusiveEndTime"
...
extension QldbClientTypes.JournalS3ExportDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JournalS3ExportDescription(exclusiveEndTime: \(Swift.String(describing: exclusiveEndTime)), exportCreationTime: \(Swift.String(describing: exportCreationTime)), exportId: \(Swift.String(describing: exportId)), inclusiveStartTime: \(Swift.String(describing: inclusiveStartTime)), ledgerName: \(Swift.String(describing: ledgerName)), roleArn: \(Swift.String(describing: roleArn)), s3ExportConfiguration: \(Swift.String(describing: s3ExportConfiguration)), status: \(Swift.String(describing: status)))"}
}
...
extension QldbClientTypes.KinesisConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension QldbClientTypes.KinesisConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "KinesisConfiguration(aggregationEnabled: \(Swift.String(describing: aggregationEnabled)), streamArn: \(Swift.String(describing: streamArn)))"}
}
...
extension QldbClientTypes.LedgerEncryptionDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension QldbClientTypes.LedgerEncryptionDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LedgerEncryptionDescription(encryptionStatus: \(Swift.String(describing: encryptionStatus)), inaccessibleKmsKeyDateTime: \(Swift.String(describing: inaccessibleKmsKeyDateTime)), kmsKeyArn: \(Swift.String(describing: kmsKeyArn)))"}
}
...
extension QldbClientTypes.LedgerSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case creationDateTime = "CreationDateTime"
        case name = "Name"
        case state = "State"
...
extension QldbClientTypes.LedgerSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LedgerSummary(creationDateTime: \(Swift.String(describing: creationDateTime)), name: \(Swift.String(describing: name)), state: \(Swift.String(describing: state)))"}
}
...
extension LimitExceededException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LimitExceededException(message: \(Swift.String(describing: message)), resourceType: \(Swift.String(describing: resourceType)))"}
}
...
extension ListJournalKinesisStreamsForLedgerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListJournalKinesisStreamsForLedgerInput(ledgerName: \(Swift.String(describing: ledgerName)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListJournalKinesisStreamsForLedgerInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListJournalKinesisStreamsForLedgerInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalKinesisStreamsForLedgerInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListJournalKinesisStreamsForLedgerInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListJournalKinesisStreamsForLedgerOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListJournalKinesisStreamsForLedgerInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListJournalKinesisStreamsForLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListJournalKinesisStreamsForLedgerOutputError>
}

public struct ListJournalKinesisStreamsForLedgerInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalKinesisStreamsForLedgerInputQueryItemMiddleware"
...
public struct ListJournalKinesisStreamsForLedgerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalKinesisStreamsForLedgerInputURLHostMiddleware"
    ...
    public typealias MInput = ListJournalKinesisStreamsForLedgerInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListJournalKinesisStreamsForLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListJournalKinesisStreamsForLedgerOutputError>
}

public struct ListJournalKinesisStreamsForLedgerInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalKinesisStreamsForLedgerInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/ledgers/\(ledgerName.urlPercentEncoding())/journal-kinesis-streams"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListJournalKinesisStreamsForLedgerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListJournalKinesisStreamsForLedgerOutputResponse(nextToken: \(Swift.String(describing: nextToken)), streams: \(Swift.String(describing: streams)))"}
}
...
struct ListJournalKinesisStreamsForLedgerOutputResponseBody: Swift.Equatable {
    public let streams: [QldbClientTypes.JournalKinesisStreamDescription]?
...
extension ListJournalS3ExportsForLedgerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListJournalS3ExportsForLedgerInput(maxResults: \(Swift.String(describing: maxResults)), name: \(Swift.String(describing: name)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListJournalS3ExportsForLedgerInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListJournalS3ExportsForLedgerInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalS3ExportsForLedgerInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListJournalS3ExportsForLedgerInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListJournalS3ExportsForLedgerOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListJournalS3ExportsForLedgerInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListJournalS3ExportsForLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListJournalS3ExportsForLedgerOutputError>
}

public struct ListJournalS3ExportsForLedgerInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalS3ExportsForLedgerInputQueryItemMiddleware"
...
public struct ListJournalS3ExportsForLedgerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalS3ExportsForLedgerInputURLHostMiddleware"
    ...
    public typealias MInput = ListJournalS3ExportsForLedgerInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListJournalS3ExportsForLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListJournalS3ExportsForLedgerOutputError>
}

public struct ListJournalS3ExportsForLedgerInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalS3ExportsForLedgerInputURLPathMiddleware"
...
extension ListJournalS3ExportsForLedgerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListJournalS3ExportsForLedgerOutputResponse(journalS3Exports: \(Swift.String(describing: journalS3Exports)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListJournalS3ExportsForLedgerOutputResponseBody: Swift.Equatable {
    public let journalS3Exports: [QldbClientTypes.JournalS3ExportDescription]?
    public let nextToken: Swift.String?
}
...
extension ListJournalS3ExportsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListJournalS3ExportsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListJournalS3ExportsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListJournalS3ExportsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalS3ExportsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListJournalS3ExportsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListJournalS3ExportsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListJournalS3ExportsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListJournalS3ExportsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListJournalS3ExportsOutputError>
}

public struct ListJournalS3ExportsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalS3ExportsInputQueryItemMiddleware"
...
public struct ListJournalS3ExportsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalS3ExportsInputURLHostMiddleware"
    ...
    public typealias MInput = ListJournalS3ExportsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListJournalS3ExportsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListJournalS3ExportsOutputError>
}

public struct ListJournalS3ExportsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListJournalS3ExportsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/journal-s3-exports"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListJournalS3ExportsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListJournalS3ExportsOutputResponse(journalS3Exports: \(Swift.String(describing: journalS3Exports)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
extension ListLedgersInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListLedgersInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListLedgersInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListLedgersInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListLedgersInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListLedgersInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListLedgersOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListLedgersInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListLedgersOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListLedgersOutputError>
}

public struct ListLedgersInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListLedgersInputQueryItemMiddleware"
...
public struct ListLedgersInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListLedgersInputURLHostMiddleware"
    ...
    public typealias MInput = ListLedgersInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListLedgersOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListLedgersOutputError>
}

public struct ListLedgersInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListLedgersInputURLPathMiddleware"
...
extension ListLedgersOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListLedgersOutputResponse(ledgers: \(Swift.String(describing: ledgers)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListLedgersOutputResponseBody: Swift.Equatable {
    public let ledgers: [QldbClientTypes.LedgerSummary]?
    public let nextToken: Swift.String?
}
...
extension ResourceAlreadyExistsException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceAlreadyExistsException(message: \(Swift.String(describing: message)), resourceName: \(Swift.String(describing: resourceName)), resourceType: \(Swift.String(describing: resourceType)))"}
}
...
extension ResourceInUseException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceInUseException(message: \(Swift.String(describing: message)), resourceName: \(Swift.String(describing: resourceName)), resourceType: \(Swift.String(describing: resourceType)))"}
}
...
extension ResourceNotFoundException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceNotFoundException(message: \(Swift.String(describing: message)), resourceName: \(Swift.String(describing: resourceName)), resourceType: \(Swift.String(describing: resourceType)))"}
}
...
extension ResourcePreconditionNotMetException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourcePreconditionNotMetException(message: \(Swift.String(describing: message)), resourceName: \(Swift.String(describing: resourceName)), resourceType: \(Swift.String(describing: resourceType)))"}
}
...
extension QldbClientTypes.S3EncryptionConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case kmsKeyArn = "KmsKeyArn"
...
extension QldbClientTypes.S3EncryptionConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3EncryptionConfiguration(kmsKeyArn: \(Swift.String(describing: kmsKeyArn)), objectEncryptionType: \(Swift.String(describing: objectEncryptionType)))"}
}
...
extension QldbClientTypes.S3ExportConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bucket = "Bucket"
...
extension QldbClientTypes.S3ExportConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3ExportConfiguration(bucket: \(Swift.String(describing: bucket)), encryptionConfiguration: \(Swift.String(describing: encryptionConfiguration)), prefix: \(Swift.String(describing: `prefix`)))"}
}
...
public struct StreamJournalToKinesisInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StreamJournalToKinesisInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StreamJournalToKinesisInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StreamJournalToKinesisOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StreamJournalToKinesisInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StreamJournalToKinesisOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StreamJournalToKinesisOutputError>
}

extension StreamJournalToKinesisInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamJournalToKinesisInput(exclusiveEndTime: \(Swift.String(describing: exclusiveEndTime)), inclusiveStartTime: \(Swift.String(describing: inclusiveStartTime)), kinesisConfiguration: \(Swift.String(describing: kinesisConfiguration)), ledgerName: \(Swift.String(describing: ledgerName)), roleArn: \(Swift.String(describing: roleArn)), streamName: \(Swift.String(describing: streamName)), tags: \(Swift.String(describing: tags)))"}
}

extension StreamJournalToKinesisInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case exclusiveEndTime = "ExclusiveEndTime"
        case inclusiveStartTime = "InclusiveStartTime"
        case kinesisConfiguration = "KinesisConfiguration"
...
public struct StreamJournalToKinesisInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StreamJournalToKinesisInputHeadersMiddleware"
...
public struct StreamJournalToKinesisInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StreamJournalToKinesisInputQueryItemMiddleware"
...
public struct StreamJournalToKinesisInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StreamJournalToKinesisInputURLHostMiddleware"
    ...
    public typealias MInput = StreamJournalToKinesisInput
    public typealias MOutput = ClientRuntime.OperationOutput<StreamJournalToKinesisOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StreamJournalToKinesisOutputError>
}

public struct StreamJournalToKinesisInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StreamJournalToKinesisInputURLPathMiddleware"
...
struct StreamJournalToKinesisInputBody: Swift.Equatable {
    ...
    public let inclusiveStartTime: ClientRuntime.Date?
    public let exclusiveEndTime: ClientRuntime.Date?
    public let kinesisConfiguration: QldbClientTypes.KinesisConfiguration?
...
extension StreamJournalToKinesisOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamJournalToKinesisOutputResponse(streamId: \(Swift.String(describing: streamId)))"}
}
...
public struct UpdateLedgerInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLedgerInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateLedgerInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateLedgerOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateLedgerInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateLedgerOutputError>
}

extension UpdateLedgerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateLedgerInput(deletionProtection: \(Swift.String(describing: deletionProtection)), kmsKey: \(Swift.String(describing: kmsKey)), name: \(Swift.String(describing: name)))"}
}

extension UpdateLedgerInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case deletionProtection = "DeletionProtection"
        case kmsKey = "KmsKey"
    }
...
public struct UpdateLedgerInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLedgerInputHeadersMiddleware"
...
public struct UpdateLedgerInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLedgerInputQueryItemMiddleware"
...
public struct UpdateLedgerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLedgerInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateLedgerInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateLedgerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateLedgerOutputError>
}

public struct UpdateLedgerInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLedgerInputURLPathMiddleware"
...
extension UpdateLedgerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateLedgerOutputResponse(arn: \(Swift.String(describing: arn)), creationDateTime: \(Swift.String(describing: creationDateTime)), deletionProtection: \(Swift.String(describing: deletionProtection)), encryptionDescription: \(Swift.String(describing: encryptionDescription)), name: \(Swift.String(describing: name)), state: \(Swift.String(describing: state)))"}
}
...
public struct UpdateLedgerPermissionsModeInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLedgerPermissionsModeInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateLedgerPermissionsModeInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateLedgerPermissionsModeOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateLedgerPermissionsModeInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateLedgerPermissionsModeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateLedgerPermissionsModeOutputError>
}

extension UpdateLedgerPermissionsModeInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateLedgerPermissionsModeInput(name: \(Swift.String(describing: name)), permissionsMode: \(Swift.String(describing: permissionsMode)))"}
}

extension UpdateLedgerPermissionsModeInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case permissionsMode = "PermissionsMode"
    }
...
public struct UpdateLedgerPermissionsModeInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLedgerPermissionsModeInputHeadersMiddleware"
...
public struct UpdateLedgerPermissionsModeInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLedgerPermissionsModeInputQueryItemMiddleware"
...
public struct UpdateLedgerPermissionsModeInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLedgerPermissionsModeInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateLedgerPermissionsModeInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateLedgerPermissionsModeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateLedgerPermissionsModeOutputError>
}

public struct UpdateLedgerPermissionsModeInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLedgerPermissionsModeInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/ledgers/\(name.urlPercentEncoding())/permissions-mode"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension UpdateLedgerPermissionsModeOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateLedgerPermissionsModeOutputResponse(arn: \(Swift.String(describing: arn)), name: \(Swift.String(describing: name)), permissionsMode: \(Swift.String(describing: permissionsMode)))"}
}
...
extension QldbClientTypes.ValueHolder: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
