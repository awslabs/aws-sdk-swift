...
extension MarketplaceCommerceAnalyticsClient: MarketplaceCommerceAnalyticsClientProtocol {
    ...
    public func generateDataSet(input: GenerateDataSetInput, completion: @escaping (SdkResult<GenerateDataSetOutput, GenerateDataSetOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<GenerateDataSetInput, GenerateDataSetOutput, GenerateDataSetOutputError>(id: "generateDataSet")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GenerateDataSetInput, GenerateDataSetOutput, GenerateDataSetOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GenerateDataSetInput, GenerateDataSetOutput, GenerateDataSetOutputError>(xAmzTarget: "MarketplaceCommerceAnalytics20150701.GenerateDataSet"))
    ...
    ///         Requires a Role with an attached permissions policy providing Allow permissions for the following actions:
    ///         s3:PutObject, s3:GetBucketLocation, sns:GetTopicAttributes, sns:Publish, iam:GetRolePolicy.
    public func startSupportDataExport(input: StartSupportDataExportInput, completion: @escaping (SdkResult<StartSupportDataExportOutput, StartSupportDataExportOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "marketplacecommerceanalytics")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartSupportDataExportInput, StartSupportDataExportOutput, StartSupportDataExportOutputError>(id: "startSupportDataExport")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartSupportDataExportInput, StartSupportDataExportOutput, StartSupportDataExportOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartSupportDataExportInput, StartSupportDataExportOutput, StartSupportDataExportOutputError>(xAmzTarget: "MarketplaceCommerceAnalytics20150701.StartSupportDataExport"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
