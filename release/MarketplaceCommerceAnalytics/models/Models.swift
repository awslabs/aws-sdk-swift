...
public struct GenerateDataSetInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataSetInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GenerateDataSetInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GenerateDataSetOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GenerateDataSetInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GenerateDataSetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GenerateDataSetOutputError>
}

extension GenerateDataSetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GenerateDataSetInput(customerDefinedValues: \(Swift.String(describing: customerDefinedValues)), dataSetPublicationDate: \(Swift.String(describing: dataSetPublicationDate)), dataSetType: \(Swift.String(describing: dataSetType)), destinationS3BucketName: \(Swift.String(describing: destinationS3BucketName)), destinationS3Prefix: \(Swift.String(describing: destinationS3Prefix)), roleNameArn: \(Swift.String(describing: roleNameArn)), snsTopicArn: \(Swift.String(describing: snsTopicArn)))"}
}

extension GenerateDataSetInput: Swift.Encodable, ClientRuntime.Reflection {
...
public struct GenerateDataSetInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataSetInputHeadersMiddleware"
...
public struct GenerateDataSetInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataSetInputQueryItemMiddleware"
...
public struct GenerateDataSetInput: Swift.Equatable {
    ...
    public let customerDefinedValues: [Swift.String:Swift.String]?
    ...
    public let dataSetPublicationDate: ClientRuntime.Date?
    ...
    ///             </ul>
    ///         </p>
    public let dataSetType: MarketplaceCommerceAnalyticsClientTypes.DataSetType?
    /// The name (friendly name, not ARN) of the destination S3 bucket.
    public let destinationS3BucketName: Swift.String?
...
extension GenerateDataSetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GenerateDataSetOutputResponse(dataSetRequestId: \(Swift.String(describing: dataSetRequestId)))"}
}
...
public struct GenerateDataSetOutputResponse: Swift.Equatable {
    ...
    public let dataSetRequestId: Swift.String?
...
extension MarketplaceCommerceAnalyticsException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MarketplaceCommerceAnalyticsException(message: \(Swift.String(describing: message)))"}
}

extension MarketplaceCommerceAnalyticsException: AWSClientRuntime.AWSHttpServiceError {
...
public struct MarketplaceCommerceAnalyticsException: ClientRuntime.ServiceError, Swift.Equatable {
...
public struct StartSupportDataExportInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartSupportDataExportInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartSupportDataExportInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartSupportDataExportOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartSupportDataExportInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartSupportDataExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartSupportDataExportOutputError>
}

extension StartSupportDataExportInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartSupportDataExportInput(customerDefinedValues: \(Swift.String(describing: customerDefinedValues)), dataSetType: \(Swift.String(describing: dataSetType)), destinationS3BucketName: \(Swift.String(describing: destinationS3BucketName)), destinationS3Prefix: \(Swift.String(describing: destinationS3Prefix)), fromDate: \(Swift.String(describing: fromDate)), roleNameArn: \(Swift.String(describing: roleNameArn)), snsTopicArn: \(Swift.String(describing: snsTopicArn)))"}
}

extension StartSupportDataExportInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case customerDefinedValues
        case dataSetType
        case destinationS3BucketName
...
public struct StartSupportDataExportInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartSupportDataExportInputHeadersMiddleware"
...
public struct StartSupportDataExportInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartSupportDataExportInputQueryItemMiddleware"
...
public struct StartSupportDataExportInput: Swift.Equatable {
    ...
    ///             </ul>
    ///         </p>
    public let dataSetType: MarketplaceCommerceAnalyticsClientTypes.SupportDataSetType?
    /// The name (friendly name, not ARN) of the destination S3 bucket.
    public let destinationS3BucketName: Swift.String?
    /// (Optional) The desired S3 prefix for the published data set, similar to a directory path in standard file systems.
    ///         For example, if given the bucket name "mybucket" and the prefix "myprefix/mydatasets", the output file
    ...
    public let fromDate: ClientRuntime.Date?
    /// The Amazon Resource Name (ARN) of the Role with an attached permissions policy to interact with the provided
    ///         AWS services.
    public let roleNameArn: Swift.String?
    /// Amazon Resource Name (ARN) for the SNS Topic that will be notified when the data set has been published or if an
...
extension StartSupportDataExportOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartSupportDataExportOutputResponse(dataSetRequestId: \(Swift.String(describing: dataSetRequestId)))"}
}
