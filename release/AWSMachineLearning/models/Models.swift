...
public struct AddTagsInput: Swift.Equatable {
    ...
    /// This member is required.
    var resourceType: MachineLearningClientTypes.TaggableResourceType?
    /// The key-value pairs to use to create tags. If you specify a key without specifying a value, Amazon ML creates a tag with the specified key and a value of null.
    /// This member is required.
    var tags: [MachineLearningClientTypes.Tag]?
...
extension MachineLearningClientTypes {
    ...
    public struct BatchPrediction: Swift.Equatable {
        ...
        var status: MachineLearningClientTypes.EntityStatus?
        /// Long integer type that is a 64-bit signed number.
        var totalRecordCount: Swift.Int?
...
public struct CreateBatchPredictionInput: Swift.Equatable {
    ...
    var batchPredictionName: Swift.String?
...
public struct CreateDataSourceFromRDSInput: Swift.Equatable {
    ...
    var computeStatistics: Swift.Bool
    /// A user-supplied ID that uniquely identifies the DataSource. Typically, an Amazon Resource Number (ARN) becomes the ID for a DataSource.
    /// This member is required.
    var dataSourceId: Swift.String?
    /// A user-supplied name or description of the DataSource.
    var dataSourceName: Swift.String?
    ...
    /// This member is required.
    var rDSData: MachineLearningClientTypes.RDSDataSpec?
...
public struct CreateDataSourceFromRedshiftInput: Swift.Equatable {
    ...
    /// * DataRearrangement - A JSON string that represents the splitting and rearrangement requirements for the DataSource. Sample -  "{\"splitting\":{\"percentBegin\":10,\"percentEnd\":60}}"
    /// This member is required.
    var dataSpec: MachineLearningClientTypes.RedshiftDataSpec?
...
public struct CreateDataSourceFromS3Input: Swift.Equatable {
    ...
    /// * DataRearrangement - A JSON string that represents the splitting and rearrangement requirements for the Datasource. Sample -  "{\"splitting\":{\"percentBegin\":10,\"percentEnd\":60}}"
    /// This member is required.
    var dataSpec: MachineLearningClientTypes.S3DataSpec?
...
public struct CreateEvaluationInput: Swift.Equatable {
    ...
    /// This member is required.
    var evaluationDataSourceId: Swift.String?
    /// A user-supplied ID that uniquely identifies the Evaluation.
    /// This member is required.
    var evaluationId: Swift.String?
    /// A user-supplied name or description of the Evaluation.
    var evaluationName: Swift.String?
...
public struct CreateMLModelInput: Swift.Equatable {
    ...
    /// This member is required.
    var mLModelType: MachineLearningClientTypes.MLModelType?
    ...
    var recipe: Swift.String?
    /// The Amazon Simple Storage Service (Amazon S3) location and file name that contains the MLModel recipe. You must specify either the recipe or its URI. If you don't specify a recipe or its URI, Amazon ML creates a default.
    var recipeUri: Swift.String?
    /// The DataSource that points to the training data.
    /// This member is required.
    var trainingDataSourceId: Swift.String?
...
public struct CreateRealtimeEndpointOutputResponse: Swift.Equatable {
    ...
    var realtimeEndpointInfo: MachineLearningClientTypes.RealtimeEndpointInfo?
...
extension MachineLearningClientTypes {
    ...
    public struct DataSource: Swift.Equatable {
        ...
        var dataLocationS3: Swift.String?
        /// A JSON string that represents the splitting and rearrangement requirement used when this DataSource was created.
        var dataRearrangement: Swift.String?
        /// The total number of observations contained in the data files that the DataSource references.
        var dataSizeInBytes: Swift.Int?
        ...
        var numberOfFiles: Swift.Int?
        /// The datasource details that are specific to Amazon RDS.
        var rDSMetadata: MachineLearningClientTypes.RDSMetadata?
        /// Describes the DataSource details specific to Amazon Redshift.
        var redshiftMetadata: MachineLearningClientTypes.RedshiftMetadata?
...
public struct DescribeBatchPredictionsInput: Swift.Equatable {
    ...
    var filterVariable: MachineLearningClientTypes.BatchPredictionFilterVariable?
    ...
    var sortOrder: MachineLearningClientTypes.SortOrder?
...
public struct DescribeBatchPredictionsOutputResponse: Swift.Equatable {
    ...
    var results: [MachineLearningClientTypes.BatchPrediction]?
...
public struct DescribeDataSourcesInput: Swift.Equatable {
    ...
    ///
    /// * IAMUser - Sets the search criteria to the user account that invoked the DataSource creation.
    var filterVariable: MachineLearningClientTypes.DataSourceFilterVariable?
...
public struct DescribeDataSourcesOutputResponse: Swift.Equatable {
    ...
    var results: [MachineLearningClientTypes.DataSource]?
...
public struct DescribeEvaluationsInput: Swift.Equatable {
    ...
    var filterVariable: MachineLearningClientTypes.EvaluationFilterVariable?
...
public struct DescribeEvaluationsOutputResponse: Swift.Equatable {
    ...
    var results: [MachineLearningClientTypes.Evaluation]?
...
public struct DescribeMLModelsInput: Swift.Equatable {
    ...
    var filterVariable: MachineLearningClientTypes.MLModelFilterVariable?
...
public struct DescribeMLModelsOutputResponse: Swift.Equatable {
    ...
    var results: [MachineLearningClientTypes.MLModel]?
...
extension MachineLearningClientTypes {
    ...
    public struct Evaluation: Swift.Equatable {
        ...
        var performanceMetrics: MachineLearningClientTypes.PerformanceMetrics?
        /// A timestamp represented in epoch time.
        var startedAt: ClientRuntime.Date?
...
public struct GetDataSourceOutputResponse: Swift.Equatable {
    ...
    var dataSourceSchema: Swift.String?
...
public struct GetMLModelOutputResponse: Swift.Equatable {
    ...
    var endpointInfo: MachineLearningClientTypes.RealtimeEndpointInfo?
    ...
    var scoreThreshold: Swift.Float?
    /// The time of the most recent edit to the ScoreThreshold. The time is expressed in epoch time.
    var scoreThresholdLastUpdatedAt: ClientRuntime.Date?
    /// Long integer type that is a 64-bit signed number.
    ...
    ///
    /// * sgd.l2RegularizationAmount - The coefficient regularization L2 norm. It controls overfitting the data by penalizing large coefficients. This tends to drive coefficients to small, nonzero values. If you use this parameter, start by specifying a small value, such as 1.0E-08. The value is a double that ranges from 0 to MAX_DOUBLE. The default is to not use L2 normalization. This parameter can't be used when L1 is specified. Use this parameter sparingly.
    var trainingParameters: [Swift.String:Swift.String]?
...
extension MachineLearningClientTypes {
    ...
    public struct MLModel: Swift.Equatable {
        ...
        var algorithm: MachineLearningClientTypes.Algorithm?
        /// Long integer type that is a 64-bit signed number.
        var computeTime: Swift.Int?
        /// The time that the MLModel was created. The time is expressed in epoch time.
        var createdAt: ClientRuntime.Date?
...
extension MachineLearningClientTypes {
    ...
    public struct PerformanceMetrics: Swift.Equatable {
        var properties: [Swift.String:Swift.String]?
...
public struct PredictInput: Swift.Equatable {
    ...
    var mLModelId: Swift.String?
    /// This member is required.
    var predictEndpoint: Swift.String?
    /// A map of variable name-value pairs that represent an observation.
    /// This member is required.
    var record: [Swift.String:Swift.String]?
...
public struct PredictOutputResponse: Swift.Equatable {
    ...
    var prediction: MachineLearningClientTypes.Prediction?
...
extension MachineLearningClientTypes {
    ...
    public struct Prediction: Swift.Equatable {
        ...
        var details: [Swift.String:Swift.String]?
        /// The prediction label for either a BINARY or MULTICLASSMLModel.
        var predictedLabel: Swift.String?
        /// Provides the raw classification score corresponding to each label.
        var predictedScores: [Swift.String:Swift.Float]?
        /// The prediction value for REGRESSIONMLModel.
        var predictedValue: Swift.Float?
...
extension MachineLearningClientTypes {
    ...
    public struct RDSDataSpec: Swift.Equatable {
        ...
        var dataSchema: Swift.String?
        /// The Amazon S3 location of the DataSchema.
        var dataSchemaUri: Swift.String?
        /// The AWS Identity and Access Management (IAM) credentials that are used connect to the Amazon RDS database.
        /// This member is required.
        var databaseCredentials: MachineLearningClientTypes.RDSDatabaseCredentials?
        /// Describes the DatabaseName and InstanceIdentifier of an Amazon RDS database.
        /// This member is required.
        var databaseInformation: MachineLearningClientTypes.RDSDatabase?
...
extension MachineLearningClientTypes {
    ...
    public struct RDSDatabase: Swift.Equatable {
        ...
        /// This member is required.
        var instanceIdentifier: Swift.String?
...
extension MachineLearningClientTypes {
    ...
    public struct RDSMetadata: Swift.Equatable {
        ...
        var dataPipelineId: Swift.String?
        /// The database details required to connect to an Amazon RDS.
        var database: MachineLearningClientTypes.RDSDatabase?
        /// The username to be used by Amazon ML to connect to database on an Amazon RDS instance. The username should have sufficient permissions to execute an RDSSelectSqlQuery query.
        var databaseUserName: Swift.String?
...
extension MachineLearningClientTypes {
    ...
    public struct RealtimeEndpointInfo: Swift.Equatable {
        ...
        var endpointStatus: MachineLearningClientTypes.RealtimeEndpointStatus?
        ...
        var endpointUrl: Swift.String?
        /// The maximum processing rate for the real-time endpoint for MLModel, measured in incoming requests per second.
        var peakRequestsPerSecond: Swift.Int
...
extension MachineLearningClientTypes {
    ...
    public struct RedshiftDataSpec: Swift.Equatable {
        ...
        /// This member is required.
        var databaseCredentials: MachineLearningClientTypes.RedshiftDatabaseCredentials?
        /// Describes the DatabaseName and ClusterIdentifier for an Amazon Redshift DataSource.
        /// This member is required.
        var databaseInformation: MachineLearningClientTypes.RedshiftDatabase?
...
extension MachineLearningClientTypes {
    ...
    public struct RedshiftDatabase: Swift.Equatable {
        ...
        /// This member is required.
        var clusterIdentifier: Swift.String?
...
extension MachineLearningClientTypes {
    ...
    public struct RedshiftMetadata: Swift.Equatable {
        ...
        var databaseUserName: Swift.String?
        /// Describes the database details required to connect to an Amazon Redshift database.
        var redshiftDatabase: MachineLearningClientTypes.RedshiftDatabase?
...
extension MachineLearningClientTypes {
    ...
    public struct S3DataSpec: Swift.Equatable {
        ...
        var dataSchemaLocationS3: Swift.String?
