...
extension WorkMailClientTypes {
    ...
    public struct AccessControlRule: Swift.Equatable {
        ...
        var actions: [Swift.String]?
        /// The date that the rule was created.
        var dateCreated: ClientRuntime.Date?
        /// The date that the rule was modified.
        var dateModified: ClientRuntime.Date?
        /// The rule description.
        var description: Swift.String?
        /// The rule effect.
        var effect: WorkMailClientTypes.AccessControlRuleEffect?
        /// IPv4 CIDR ranges to include in the rule.
        var ipRanges: [Swift.String]?
        /// The rule name.
        var name: Swift.String?
        /// Access protocol actions to exclude from the rule. Valid values include ActiveSync, AutoDiscover, EWS, IMAP, SMTP, WindowsOutlook, and WebMail.
        var notActions: [Swift.String]?
        /// IPv4 CIDR ranges to exclude from the rule.
        var notIpRanges: [Swift.String]?
        /// User IDs to exclude from the rule.
        var notUserIds: [Swift.String]?
...
public struct AssociateDelegateToResourceInput: Swift.Equatable {
    ...
    var entityId: Swift.String?
    /// The organization under which the resource exists.
    /// This member is required.
    var organizationId: Swift.String?
...
extension WorkMailClientTypes {
    ...
    public struct BookingOptions: Swift.Equatable {
        ...
        var autoAcceptRequests: Swift.Bool
        /// The resource's ability to automatically decline any conflicting requests.
        var autoDeclineConflictingRequests: Swift.Bool
        /// The resource's ability to automatically decline any recurring requests.
        var autoDeclineRecurringRequests: Swift.Bool
...
public struct CreateMobileDeviceAccessRuleInput: Swift.Equatable {
    ...
    var deviceModels: [Swift.String]?
    /// Device operating systems that the rule will match.
    var deviceOperatingSystems: [Swift.String]?
    /// Device types that the rule will match.
    var deviceTypes: [Swift.String]?
    /// Device user agents that the rule will match.
    var deviceUserAgents: [Swift.String]?
    /// The effect of the rule when it matches. Allowed values are ALLOW or DENY.
    /// This member is required.
    var effect: WorkMailClientTypes.MobileDeviceAccessRuleEffect?
    /// The rule name.
    /// This member is required.
    var name: Swift.String?
    /// Device models that the rule will not match. All other device models will match.
    var notDeviceModels: [Swift.String]?
    /// Device operating systems that the rule will not match. All other device operating systems will match.
    var notDeviceOperatingSystems: [Swift.String]?
    /// Device types that the rule will not match. All other device types will match.
    var notDeviceTypes: [Swift.String]?
    /// Device user agents that the rule will not match. All other device user agents will match.
    var notDeviceUserAgents: [Swift.String]?
...
public struct CreateMobileDeviceAccessRuleOutputResponse: Swift.Equatable {
    ...
    var mobileDeviceAccessRuleId: Swift.String?
...
public struct CreateOrganizationInput: Swift.Equatable {
    ...
    var domains: [WorkMailClientTypes.Domain]?
...
public struct CreateResourceInput: Swift.Equatable {
    ...
    /// This member is required.
    var type: WorkMailClientTypes.ResourceType?
...
extension WorkMailClientTypes {
    ...
    public struct Delegate: Swift.Equatable {
        ...
        /// This member is required.
        var type: WorkMailClientTypes.MemberType?
...
public struct DeleteOrganizationInput: Swift.Equatable {
    ...
    /// This member is required.
    var deleteDirectory: Swift.Bool
    /// The organization ID.
    /// This member is required.
    var organizationId: Swift.String?
...
public struct DescribeGroupOutputResponse: Swift.Equatable {
    ...
    var disabledDate: ClientRuntime.Date?
    /// The email of the described group.
    var email: Swift.String?
    /// The date and time when a user was registered to WorkMail, in UNIX epoch time format.
    var enabledDate: ClientRuntime.Date?
    ...
    var state: WorkMailClientTypes.EntityState?
...
public struct DescribeMailboxExportJobOutputResponse: Swift.Equatable {
    ...
    var errorInfo: Swift.String?
    /// The estimated progress of the mailbox export job, in percentage points.
    var estimatedProgress: Swift.Int
    ...
    var s3Path: Swift.String?
    /// The S3 bucket prefix.
    var s3Prefix: Swift.String?
    /// The mailbox export job start timestamp.
    var startTime: ClientRuntime.Date?
    /// The state of the mailbox export job.
    var state: WorkMailClientTypes.MailboxExportJobState?
...
public struct DescribeOrganizationOutputResponse: Swift.Equatable {
    ...
    var completedDate: ClientRuntime.Date?
    /// The default mail domain associated with the organization.
    var defaultMailDomain: Swift.String?
    /// The identifier for the directory associated with an Amazon WorkMail organization.
    var directoryId: Swift.String?
    /// The type of directory associated with the WorkMail organization.
    var directoryType: Swift.String?
...
public struct DescribeResourceOutputResponse: Swift.Equatable {
    ...
    var bookingOptions: WorkMailClientTypes.BookingOptions?
...
public struct DescribeUserOutputResponse: Swift.Equatable {
    ...
    var userRole: WorkMailClientTypes.UserRole?
...
extension WorkMailClientTypes {
    ...
    public struct FolderConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var action: WorkMailClientTypes.RetentionAction?
        /// The folder name.
        /// This member is required.
        var name: WorkMailClientTypes.FolderName?
...
public struct GetDefaultRetentionPolicyOutputResponse: Swift.Equatable {
    ...
    var folderConfigurations: [WorkMailClientTypes.FolderConfiguration]?
    /// The retention policy ID.
    var id: Swift.String?
...
public struct GetMailDomainOutputResponse: Swift.Equatable {
    ...
    var dkimVerificationStatus: WorkMailClientTypes.DnsRecordVerificationStatus?
    /// Specifies whether the domain is the default domain for your organization.
    var isDefault: Swift.Bool
    /// Specifies whether the domain is a test domain provided by WorkMail, or a custom domain.
    var isTestDomain: Swift.Bool
    /// Indicates the status of the domain ownership verification.
    var ownershipVerificationStatus: WorkMailClientTypes.DnsRecordVerificationStatus?
    ...
    var records: [WorkMailClientTypes.DnsRecord]?
...
public struct GetMailboxDetailsOutputResponse: Swift.Equatable {
    ...
    var mailboxQuota: Swift.Int?
    /// The current mailbox size, in MB, for the specified user.
    var mailboxSize: Swift.Double
...
public struct GetMobileDeviceAccessEffectInput: Swift.Equatable {
    ...
    var deviceModel: Swift.String?
    /// Device operating system the simulated user will report.
    var deviceOperatingSystem: Swift.String?
    /// Device type the simulated user will report.
    var deviceType: Swift.String?
    /// Device user agent the simulated user will report.
    var deviceUserAgent: Swift.String?
...
public struct GetMobileDeviceAccessEffectOutputResponse: Swift.Equatable {
    ...
    var matchedRules: [WorkMailClientTypes.MobileDeviceAccessMatchedRule]?
...
public struct ListAccessControlRulesOutputResponse: Swift.Equatable {
    ...
    var rules: [WorkMailClientTypes.AccessControlRule]?
...
public struct ListGroupMembersOutputResponse: Swift.Equatable {
    ...
    var members: [WorkMailClientTypes.Member]?
    /// The token to use to retrieve the next page of results. The first call does not contain any tokens.
    var nextToken: Swift.String?
...
public struct ListGroupsOutputResponse: Swift.Equatable {
    ...
    var groups: [WorkMailClientTypes.Group]?
    /// The token to use to retrieve the next page of results. The value is "null" when there are no more results to return.
    var nextToken: Swift.String?
...
public struct ListMailDomainsOutputResponse: Swift.Equatable {
    ...
    var mailDomains: [WorkMailClientTypes.MailDomainSummary]?
...
public struct ListMailboxExportJobsOutputResponse: Swift.Equatable {
    ...
    var jobs: [WorkMailClientTypes.MailboxExportJob]?
    /// The token to use to retrieve the next page of results.
    var nextToken: Swift.String?
...
public struct ListMailboxPermissionsOutputResponse: Swift.Equatable {
    ...
    var permissions: [WorkMailClientTypes.Permission]?
...
public struct ListMobileDeviceAccessOverridesOutputResponse: Swift.Equatable {
    ...
    var overrides: [WorkMailClientTypes.MobileDeviceAccessOverride]?
...
public struct ListMobileDeviceAccessRulesOutputResponse: Swift.Equatable {
    ...
    var rules: [WorkMailClientTypes.MobileDeviceAccessRule]?
...
public struct ListOrganizationsOutputResponse: Swift.Equatable {
    ...
    var organizationSummaries: [WorkMailClientTypes.OrganizationSummary]?
...
public struct ListResourceDelegatesOutputResponse: Swift.Equatable {
    ...
    var delegates: [WorkMailClientTypes.Delegate]?
...
public struct ListResourcesOutputResponse: Swift.Equatable {
    ...
    var resources: [WorkMailClientTypes.Resource]?
...
public struct ListTagsForResourceOutputResponse: Swift.Equatable {
    ...
    var tags: [WorkMailClientTypes.Tag]?
...
public struct ListUsersOutputResponse: Swift.Equatable {
    ...
    var users: [WorkMailClientTypes.User]?
...
extension WorkMailClientTypes {
    ...
    public struct Permission: Swift.Equatable {
        ...
        /// This member is required.
        var granteeType: WorkMailClientTypes.MemberType?
        /// The permissions granted to the grantee. SEND_AS allows the grantee to send email as the owner of the mailbox (the grantee is not mentioned on these emails). SEND_ON_BEHALF allows the grantee to send email on behalf of the owner of the mailbox (the grantee is not mentioned as the physical sender of these emails). FULL_ACCESS allows the grantee full access to the mailbox, irrespective of other folder-level permissions set on the mailbox.
        /// This member is required.
        var permissionValues: [WorkMailClientTypes.PermissionType]?
