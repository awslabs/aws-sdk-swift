...
public extension WorkMailClient {
    ...
    {
        typealias deregisterMailDomainContinuation = CheckedContinuation<DeregisterMailDomainOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deregisterMailDomainContinuation) in
            deregisterMailDomain(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeInboundDmarcSettingsContinuation = CheckedContinuation<DescribeInboundDmarcSettingsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeInboundDmarcSettingsContinuation) in
            describeInboundDmarcSettings(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getMailDomainContinuation = CheckedContinuation<GetMailDomainOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getMailDomainContinuation) in
            getMailDomain(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listMailDomainsContinuation = CheckedContinuation<ListMailDomainsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listMailDomainsContinuation) in
            listMailDomains(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putInboundDmarcSettingsContinuation = CheckedContinuation<PutInboundDmarcSettingsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putInboundDmarcSettingsContinuation) in
            putInboundDmarcSettings(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias registerMailDomainContinuation = CheckedContinuation<RegisterMailDomainOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: registerMailDomainContinuation) in
            registerMailDomain(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateDefaultMailDomainContinuation = CheckedContinuation<UpdateDefaultMailDomainOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateDefaultMailDomainContinuation) in
            updateDefaultMailDomain(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
