...
public class CloudWatchEventsClient {
    ...
    let config: CloudWatchEventsClientConfiguration
    let serviceName = "CloudWatch Events"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: CloudWatchEventsClientConfiguration) {
    ...
    public class CloudWatchEventsClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "CloudWatchEventsClient")
        }
        ...
        public static func `default`() throws -> CloudWatchEventsClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try CloudWatchEventsClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
