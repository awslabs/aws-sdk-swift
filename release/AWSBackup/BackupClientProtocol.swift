...
public protocol BackupClientProtocol {
    ...
    func deleteBackupVaultLockConfiguration(input: DeleteBackupVaultLockConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<DeleteBackupVaultLockConfigurationOutputResponse, DeleteBackupVaultLockConfigurationOutputError>) -> Void)
    ...
    func putBackupVaultLockConfiguration(input: PutBackupVaultLockConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<PutBackupVaultLockConfigurationOutputResponse, PutBackupVaultLockConfigurationOutputError>) -> Void)
