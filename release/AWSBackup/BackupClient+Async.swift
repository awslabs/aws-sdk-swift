...
public extension BackupClient {
    ...
    {
        typealias deleteBackupVaultLockConfigurationContinuation = CheckedContinuation<DeleteBackupVaultLockConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBackupVaultLockConfigurationContinuation) in
            deleteBackupVaultLockConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putBackupVaultLockConfigurationContinuation = CheckedContinuation<PutBackupVaultLockConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBackupVaultLockConfigurationContinuation) in
            putBackupVaultLockConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
