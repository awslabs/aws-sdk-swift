...
extension BackupClientTypes {
    ...
    public struct AdvancedBackupSetting: Swift.Equatable {
        ...
        var backupOptions: [Swift.String:Swift.String]?
...
extension BackupClientTypes {
    ...
    public struct BackupJob: Swift.Equatable {
        ...
        var expectedCompletionDate: ClientRuntime.Date?
        ...
        var percentDone: Swift.String?
        /// An ARN that uniquely identifies a recovery point; for example, arn:aws:backup:us-east-1:123456789012:recovery-point:1EB3B5E7-9EB0-435A-A80B-108B488B0D45.
        var recoveryPointArn: Swift.String?
        ...
        var startBy: ClientRuntime.Date?
        /// The current state of a resource recovery point.
        var state: BackupClientTypes.BackupJobState?
...
extension BackupClientTypes {
    ...
    public struct BackupPlan: Swift.Equatable {
        ...
        var advancedBackupSettings: [BackupClientTypes.AdvancedBackupSetting]?
        /// The display name of a backup plan. Must contain 1 to 50 alphanumeric or '-_.' characters.
        /// This member is required.
        var backupPlanName: Swift.String?
        /// An array of BackupRule objects, each of which specifies a scheduled task that is used to back up a selection of resources.
        /// This member is required.
        var rules: [BackupClientTypes.BackupRule]?
...
extension BackupClientTypes {
    ...
    public struct BackupPlanInput: Swift.Equatable {
        ...
        /// An array of BackupRule objects, each of which specifies a scheduled task that is used to back up a selection of resources.
        /// This member is required.
        var rules: [BackupClientTypes.BackupRuleInput]?
...
extension BackupClientTypes {
    ...
    public struct BackupPlanTemplatesListMember: Swift.Equatable {
        ...
        var backupPlanTemplateId: Swift.String?
        /// The optional display name of a backup plan template.
        var backupPlanTemplateName: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct BackupPlansListMember: Swift.Equatable {
        ...
        var backupPlanArn: Swift.String?
        /// Uniquely identifies a backup plan.
        var backupPlanId: Swift.String?
        ...
        var lastExecutionDate: ClientRuntime.Date?
...
extension BackupClientTypes {
    ...
    public struct BackupRule: Swift.Equatable {
        ...
        var completionWindowMinutes: Swift.Int?
        /// An array of CopyAction objects, which contains the details of the copy operation.
        var copyActions: [BackupClientTypes.CopyAction]?
        /// Specifies whether Backup creates continuous backups. True causes Backup to create continuous backups capable of point-in-time restore (PITR). False (or not specified) causes Backup to create snapshot backups.
        var enableContinuousBackup: Swift.Bool?
        ...
        var lifecycle: BackupClientTypes.Lifecycle?
        /// An array of key-value pair strings that are assigned to resources that are associated with this rule when restored from backup.
        var recoveryPointTags: [Swift.String:Swift.String]?
        ...
        var startWindowMinutes: Swift.Int?
        /// The name of a logical container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the Amazon Web Services Region where they are created. They consist of lowercase letters, numbers, and hyphens.
        /// This member is required.
        var targetBackupVaultName: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct BackupSelection: Swift.Equatable {
        ...
        var conditions: BackupClientTypes.Conditions?
        ...
        var listOfTags: [BackupClientTypes.Condition]?
        ...
        /// This member is required.
        var selectionName: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct BackupVaultListMember: Swift.Equatable {
        ...
        var lockDate: ClientRuntime.Date?
        ...
        var maxRetentionDays: Swift.Int?
        ...
        var minRetentionDays: Swift.Int?
        /// The number of recovery points that are stored in a backup vault.
        var numberOfRecoveryPoints: Swift.Int
...
extension BackupClientTypes {
    ...
    public struct CalculatedLifecycle: Swift.Equatable {
        ...
        var deleteAt: ClientRuntime.Date?
        /// A timestamp that specifies when to transition a recovery point to cold storage.
        var moveToColdStorageAt: ClientRuntime.Date?
...
extension BackupClientTypes {
    ...
    public struct Condition: Swift.Equatable {
        ...
        /// This member is required.
        var conditionType: BackupClientTypes.ConditionType?
        /// The value in a key-value pair. For example, in the tag Department: Accounting, Accounting is the value.
        /// This member is required.
        var conditionValue: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct Conditions: Swift.Equatable {
        ...
        var stringEquals: [BackupClientTypes.ConditionParameter]?
        /// Filters the values of your tagged resources for matching tag values with the use of a wildcard character (*) anywhere in the string. For example, "prod*" or "*rod*" matches the tag value "production".
        var stringLike: [BackupClientTypes.ConditionParameter]?
        /// Filters the values of your tagged resources for only those resources that you tagged that do not have the same value. Also called "negated matching."
        var stringNotEquals: [BackupClientTypes.ConditionParameter]?
        /// Filters the values of your tagged resources for non-matching tag values with the use of a wildcard character (*) anywhere in the string.
        var stringNotLike: [BackupClientTypes.ConditionParameter]?
...
extension BackupClientTypes {
    ...
    public struct ControlScope: Swift.Equatable {
        ...
        var complianceResourceIds: [Swift.String]?
        /// Describes whether the control scope includes one or more types of resources, such as EFS or RDS.
        var complianceResourceTypes: [Swift.String]?
...
extension BackupClientTypes {
    ...
    public struct CopyAction: Swift.Equatable {
        ...
        /// This member is required.
        var destinationBackupVaultArn: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct CopyJob: Swift.Equatable {
        ...
        var destinationRecoveryPointArn: Swift.String?
        ...
        var sourceBackupVaultArn: Swift.String?
        /// An ARN that uniquely identifies a source recovery point; for example, arn:aws:backup:us-east-1:123456789012:recovery-point:1EB3B5E7-9EB0-435A-A80B-108B488B0D45.
        var sourceRecoveryPointArn: Swift.String?
        /// The current state of a copy job.
        var state: BackupClientTypes.CopyJobState?
...
public struct CreateBackupPlanInput: Swift.Equatable {
    ...
    /// This member is required.
    var backupPlan: BackupClientTypes.BackupPlanInput?
    /// To help organize your resources, you can assign your own metadata to the resources that you create. Each tag is a key-value pair. The specified tags are assigned to all backups created with this plan.
    var backupPlanTags: [Swift.String:Swift.String]?
...
public struct CreateBackupSelectionInput: Swift.Equatable {
    ...
    /// This member is required.
    var backupSelection: BackupClientTypes.BackupSelection?
    /// A unique string that identifies the request and allows failed requests to be retried without the risk of running the operation twice. This parameter is optional. If used, this parameter must contain 1 to 50 alphanumeric or '-_.' characters.
    var creatorRequestId: Swift.String?
...
public struct CreateBackupVaultInput: Swift.Equatable {
    ...
    var backupVaultTags: [Swift.String:Swift.String]?
    /// A unique string that identifies the request and allows failed requests to be retried without the risk of running the operation twice. This parameter is optional. If used, this parameter must contain 1 to 50 alphanumeric or '-_.' characters.
    var creatorRequestId: Swift.String?
    /// The server-side encryption key that is used to protect your backups; for example, arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab.
    var encryptionKeyArn: Swift.String?
...
public struct CreateFrameworkInput: Swift.Equatable {
    ...
    /// This member is required.
    var frameworkControls: [BackupClientTypes.FrameworkControl]?
    ...
    var frameworkTags: [Swift.String:Swift.String]?
...
public struct CreateReportPlanInput: Swift.Equatable {
    ...
    /// This member is required.
    var reportDeliveryChannel: BackupClientTypes.ReportDeliveryChannel?
    /// An optional description of the report plan with a maximum of 1,024 characters.
    var reportPlanDescription: Swift.String?
    /// The unique name of the report plan. The name must be between 1 and 256 characters, starting with a letter, and consisting of letters (a-z, A-Z), numbers (0-9), and underscores (_).
    /// This member is required.
    var reportPlanName: Swift.String?
    /// Metadata that you can assign to help organize the report plans that you create. Each tag is a key-value pair.
    var reportPlanTags: [Swift.String:Swift.String]?
    ...
    /// This member is required.
    var reportSetting: BackupClientTypes.ReportSetting?
...
public struct CreateReportPlanOutputResponse: Swift.Equatable {
    ...
    /// An Amazon Resource Name (ARN) that uniquely identifies a resource. The format of the ARN depends on the resource type.
    var reportPlanArn: Swift.String?
...
public struct DescribeCopyJobOutputResponse: Swift.Equatable {
    /// Contains detailed information about a copy job.
    var copyJob: BackupClientTypes.CopyJob?
...
public struct DescribeFrameworkOutputResponse: Swift.Equatable {
    ...
    var frameworkStatus: Swift.String?
...
public struct DescribeGlobalSettingsOutputResponse: Swift.Equatable {
    ...
    var globalSettings: [Swift.String:Swift.String]?
...
public struct DescribeProtectedResourceOutputResponse: Swift.Equatable {
    ...
    var lastBackupTime: ClientRuntime.Date?
    /// An ARN that uniquely identifies a resource. The format of the ARN depends on the resource type.
    var resourceArn: Swift.String?
...
public struct DescribeRecoveryPointOutputResponse: Swift.Equatable {
    ...
    var calculatedLifecycle: BackupClientTypes.CalculatedLifecycle?
    ...
    var isEncrypted: Swift.Bool
    /// The date and time that a recovery point was last restored, in Unix format and Coordinated Universal Time (UTC). The value of LastRestoreTime is accurate to milliseconds. For example, the value 1516925490.087 represents Friday, January 26, 2018 12:11:30.087 AM.
    var lastRestoreTime: ClientRuntime.Date?
    ...
    var status: BackupClientTypes.RecoveryPointStatus?
    /// A status message explaining the reason for the recovery point deletion failure.
    var statusMessage: Swift.String?
    /// Specifies the storage class of the recovery point. Valid values are WARM or COLD.
    var storageClass: BackupClientTypes.StorageClass?
...
public struct DescribeRegionSettingsOutputResponse: Swift.Equatable {
    ...
    var resourceTypeManagementPreference: [Swift.String:Swift.Bool]?
    /// Returns a list of all services along with the opt-in preferences in the Region.
    var resourceTypeOptInPreference: [Swift.String:Swift.Bool]?
...
public struct DescribeReportJobOutputResponse: Swift.Equatable {
    ...
    var reportJob: BackupClientTypes.ReportJob?
...
public struct DescribeReportPlanOutputResponse: Swift.Equatable {
    ...
    var reportPlan: BackupClientTypes.ReportPlan?
...
public struct DescribeRestoreJobOutputResponse: Swift.Equatable {
    ...
    var createdResourceArn: Swift.String?
    /// The date and time that a restore job is created, in Unix format and Coordinated Universal Time (UTC). The value of CreationDate is accurate to milliseconds. For example, the value 1516925490.087 represents Friday, January 26, 2018 12:11:30.087 AM.
    var creationDate: ClientRuntime.Date?
    /// The amount of time in minutes that a job restoring a recovery point is expected to take.
    var expectedCompletionTimeMinutes: Swift.Int?
    /// Specifies the IAM role ARN used to create the target recovery point; for example, arn:aws:iam::123456789012:role/S3Access.
    var iamRoleArn: Swift.String?
    /// Contains an estimated percentage that is complete of a job at the time the job status was queried.
    var percentDone: Swift.String?
    ...
    var status: BackupClientTypes.RestoreJobStatus?
...
public struct ExportBackupPlanTemplateOutputResponse: Swift.Equatable {
    ...
    var backupPlanTemplateJson: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct Framework: Swift.Equatable {
        ...
        var numberOfControls: Swift.Int
...
extension BackupClientTypes {
    ...
    public struct FrameworkControl: Swift.Equatable {
        ...
        var controlInputParameters: [BackupClientTypes.ControlInputParameter]?
        ...
        var controlScope: BackupClientTypes.ControlScope?
...
public struct GetBackupPlanFromJSONOutputResponse: Swift.Equatable {
    /// Specifies the body of a backup plan. Includes a BackupPlanName and one or more sets of Rules.
    var backupPlan: BackupClientTypes.BackupPlan?
...
public struct GetBackupPlanFromTemplateOutputResponse: Swift.Equatable {
    ...
    var backupPlanDocument: BackupClientTypes.BackupPlan?
...
public struct GetBackupVaultNotificationsOutputResponse: Swift.Equatable {
    ...
    var backupVaultEvents: [BackupClientTypes.BackupVaultEvent]?
    /// The name of a logical container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the Region where they are created. They consist of lowercase letters, numbers, and hyphens.
    var backupVaultName: Swift.String?
...
public struct GetRecoveryPointRestoreMetadataOutputResponse: Swift.Equatable {
    ...
    var restoreMetadata: [Swift.String:Swift.String]?
...
extension BackupClientTypes {
    ...
    public struct Lifecycle: Swift.Equatable {
        ...
        var deleteAfterDays: Swift.Int?
        /// Specifies the number of days after creation that a recovery point is moved to cold storage.
        var moveToColdStorageAfterDays: Swift.Int?
...
public struct ListBackupJobsInput: Swift.Equatable {
    ...
    var byBackupVaultName: Swift.String?
    /// Returns only backup jobs that were created after the specified date.
    var byCreatedAfter: ClientRuntime.Date?
    /// Returns only backup jobs that were created before the specified date.
    var byCreatedBefore: ClientRuntime.Date?
    /// Returns only backup jobs that match the specified resource Amazon Resource Name (ARN).
    var byResourceArn: Swift.String?
    ...
    ///
    /// * Storage Gateway for Storage Gateway
    var byResourceType: Swift.String?
    /// Returns only backup jobs that are in the specified state.
    var byState: BackupClientTypes.BackupJobState?
...
public struct ListBackupJobsOutputResponse: Swift.Equatable {
    ...
    var backupJobs: [BackupClientTypes.BackupJob]?
    /// The next item following a partial list of returned items. For example, if a request is made to return maxResults number of items, NextToken allows you to return more items in your list starting at the location pointed to by the next token.
    var nextToken: Swift.String?
...
public struct ListBackupPlanTemplatesOutputResponse: Swift.Equatable {
    ...
    var backupPlanTemplatesList: [BackupClientTypes.BackupPlanTemplatesListMember]?
    /// The next item following a partial list of returned items. For example, if a request is made to return maxResults number of items, NextToken allows you to return more items in your list starting at the location pointed to by the next token.
    var nextToken: Swift.String?
...
public struct ListBackupPlanVersionsOutputResponse: Swift.Equatable {
    ...
    var backupPlanVersionsList: [BackupClientTypes.BackupPlansListMember]?
    /// The next item following a partial list of returned items. For example, if a request is made to return maxResults number of items, NextToken allows you to return more items in your list starting at the location pointed to by the next token.
    var nextToken: Swift.String?
...
public struct ListBackupPlansOutputResponse: Swift.Equatable {
    ...
    var backupPlansList: [BackupClientTypes.BackupPlansListMember]?
    /// The next item following a partial list of returned items. For example, if a request is made to return maxResults number of items, NextToken allows you to return more items in your list starting at the location pointed to by the next token.
    var nextToken: Swift.String?
...
public struct ListBackupSelectionsOutputResponse: Swift.Equatable {
    ...
    var backupSelectionsList: [BackupClientTypes.BackupSelectionsListMember]?
    /// The next item following a partial list of returned items. For example, if a request is made to return maxResults number of items, NextToken allows you to return more items in your list starting at the location pointed to by the next token.
    var nextToken: Swift.String?
...
public struct ListBackupVaultsOutputResponse: Swift.Equatable {
    ...
    var backupVaultList: [BackupClientTypes.BackupVaultListMember]?
    /// The next item following a partial list of returned items. For example, if a request is made to return maxResults number of items, NextToken allows you to return more items in your list starting at the location pointed to by the next token.
    var nextToken: Swift.String?
...
public struct ListCopyJobsInput: Swift.Equatable {
    ...
    var byDestinationVaultArn: Swift.String?
    ...
    var byState: BackupClientTypes.CopyJobState?
    /// The maximum number of items to be returned.
    var maxResults: Swift.Int?
    /// The next item following a partial list of returned items. For example, if a request is made to return maxResults number of items, NextToken allows you to return more items in your list starting at the location pointed to by the next token.
    var nextToken: Swift.String?
...
public struct ListCopyJobsOutputResponse: Swift.Equatable {
    ...
    var copyJobs: [BackupClientTypes.CopyJob]?
    /// The next item following a partial list of returned items. For example, if a request is made to return maxResults number of items, NextToken allows you to return more items in your list starting at the location pointed to by the next token.
    var nextToken: Swift.String?
...
public struct ListFrameworksOutputResponse: Swift.Equatable {
    ...
    var frameworks: [BackupClientTypes.Framework]?
    /// An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.
    var nextToken: Swift.String?
...
public struct ListProtectedResourcesOutputResponse: Swift.Equatable {
    ...
    var results: [BackupClientTypes.ProtectedResource]?
...
public struct ListRecoveryPointsByBackupVaultInput: Swift.Equatable {
    ...
    var byBackupPlanId: Swift.String?
...
public struct ListRecoveryPointsByBackupVaultOutputResponse: Swift.Equatable {
    ...
    var recoveryPoints: [BackupClientTypes.RecoveryPointByBackupVault]?
...
public struct ListRecoveryPointsByResourceOutputResponse: Swift.Equatable {
    ...
    var recoveryPoints: [BackupClientTypes.RecoveryPointByResource]?
...
public struct ListReportJobsOutputResponse: Swift.Equatable {
    ...
    var reportJobs: [BackupClientTypes.ReportJob]?
...
public struct ListReportPlansOutputResponse: Swift.Equatable {
    ...
    var reportPlans: [BackupClientTypes.ReportPlan]?
...
public struct ListRestoreJobsInput: Swift.Equatable {
    ...
    var byStatus: BackupClientTypes.RestoreJobStatus?
    /// The maximum number of items to be returned.
    var maxResults: Swift.Int?
    /// The next item following a partial list of returned items. For example, if a request is made to return maxResults number of items, NextToken allows you to return more items in your list starting at the location pointed to by the next token.
    var nextToken: Swift.String?
...
public struct ListRestoreJobsOutputResponse: Swift.Equatable {
    ...
    var restoreJobs: [BackupClientTypes.RestoreJobsListMember]?
...
public struct PutBackupVaultLockConfigurationInput: Swift.Equatable {
    ...
    var changeableForDays: Swift.Int?
...
extension BackupClientTypes {
    ...
    public struct RecoveryPointCreator: Swift.Equatable {
        ...
        var backupPlanVersion: Swift.String?
        /// Uniquely identifies a rule used to schedule the backup of a selection of resources.
        var backupRuleId: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct ReportJob: Swift.Equatable {
        ...
        var reportDestination: BackupClientTypes.ReportDestination?
        ...
        var reportTemplate: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct ReportPlan: Swift.Equatable {
        ...
        var lastAttemptedExecutionTime: ClientRuntime.Date?
        ...
        var lastSuccessfulExecutionTime: ClientRuntime.Date?
...
extension BackupClientTypes {
    ...
    public struct ReportSetting: Swift.Equatable {
        ...
        var frameworkArns: [Swift.String]?
        /// The number of frameworks a report covers.
        var numberOfFrameworks: Swift.Int
        /// Identifies the report template for the report. Reports are built using a report template. The report templates are: RESOURCE_COMPLIANCE_REPORT | CONTROL_COMPLIANCE_REPORT | BACKUP_JOB_REPORT | COPY_JOB_REPORT | RESTORE_JOB_REPORT
        /// This member is required.
        var reportTemplate: Swift.String?
...
public struct StartBackupJobInput: Swift.Equatable {
    ...
    var completeWindowMinutes: Swift.Int?
    /// Specifies the IAM role ARN used to create the target recovery point; for example, arn:aws:iam::123456789012:role/S3Access.
    /// This member is required.
    var iamRoleArn: Swift.String?
...
public struct StartCopyJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var sourceBackupVaultName: Swift.String?
