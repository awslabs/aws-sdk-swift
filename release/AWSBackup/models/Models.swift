...
extension BackupClientTypes {
    ...
    public struct BackupJob: Swift.Equatable {
        ...
        /// The type of Amazon Web Services resource to be backed up; for example, an Amazon Elastic Block Store (Amazon EBS) volume or an Amazon Relational Database Service (Amazon RDS) database. For Windows Volume Shadow Copy Service (VSS) backups, the only
...
extension BackupClientTypes {
    ...
    public struct BackupRule: Swift.Equatable {
        ...
        /// Specifies whether Backup creates continuous backups. True causes Backup to create continuous backups capable of point-in-time restore (PITR). False
        ...
        ///          more information about cron expressions, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/events/ScheduledEvents.html">Schedule Expressions for Rules in the Amazon CloudWatch Events User
...
extension BackupClientTypes {
    ...
    public struct CopyJob: Swift.Equatable {
        ...
        public var iamRoleArn: Swift.String?
        /// The Amazon Web Services resource to be copied; for example, an Amazon Elastic Block Store
...
extension CreateReportPlanOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateReportPlanOutputResponse(reportPlanArn: \(Swift.String(describing: reportPlanArn)), reportPlanName: \(Swift.String(describing: reportPlanName)))"}
}
...
public struct DescribeRecoveryPointOutputResponse: Swift.Equatable {
    ...
    ///          resource type.
    public var resourceArn: Swift.String?
    /// The type of Amazon Web Services resource to save as a recovery point; for example, an
    ...
    ///          see <a href="https://docs.aws.amazon.com/aws-backup/latest/devguide/API_UpdateBackupPlan.html">UpdateBackupPlan. You can also increase your backup plan window using the
...
extension BackupClientTypes.ReportSetting: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ReportSetting(reportTemplate: \(Swift.String(describing: reportTemplate)))"}
}
