...
public protocol LookoutEquipmentClientProtocol {
    ...
    func createInferenceScheduler(input: CreateInferenceSchedulerInput, completion: @escaping (SdkResult<CreateInferenceSchedulerOutput, CreateInferenceSchedulerOutputError>) -> Void)
    ...
    ///          are not affected. </p>
    func deleteInferenceScheduler(input: DeleteInferenceSchedulerInput, completion: @escaping (SdkResult<DeleteInferenceSchedulerOutput, DeleteInferenceSchedulerOutputError>) -> Void)
    ...
    func describeDataIngestionJob(input: DescribeDataIngestionJobInput, completion: @escaping (SdkResult<DescribeDataIngestionJobOutput, DescribeDataIngestionJobOutputError>) -> Void)
    ...
    func describeInferenceScheduler(input: DescribeInferenceSchedulerInput, completion: @escaping (SdkResult<DescribeInferenceSchedulerOutput, DescribeInferenceSchedulerOutputError>) -> Void)
    ...
    func listDataIngestionJobs(input: ListDataIngestionJobsInput, completion: @escaping (SdkResult<ListDataIngestionJobsOutput, ListDataIngestionJobsOutputError>) -> Void)
    ...
    ///          scheduler. </p>
    func listInferenceExecutions(input: ListInferenceExecutionsInput, completion: @escaping (SdkResult<ListInferenceExecutionsOutput, ListInferenceExecutionsOutputError>) -> Void)
    /// <p>Retrieves a list of all inference schedulers currently available for your account.
    ///       </p>
    func listInferenceSchedulers(input: ListInferenceSchedulersInput, completion: @escaping (SdkResult<ListInferenceSchedulersOutput, ListInferenceSchedulersOutputError>) -> Void)
    ...
    func startDataIngestionJob(input: StartDataIngestionJobInput, completion: @escaping (SdkResult<StartDataIngestionJobOutput, StartDataIngestionJobOutputError>) -> Void)
    /// <p>Starts an inference scheduler. </p>
    func startInferenceScheduler(input: StartInferenceSchedulerInput, completion: @escaping (SdkResult<StartInferenceSchedulerOutput, StartInferenceSchedulerOutputError>) -> Void)
    /// <p>Stops an inference scheduler. </p>
    func stopInferenceScheduler(input: StopInferenceSchedulerInput, completion: @escaping (SdkResult<StopInferenceSchedulerOutput, StopInferenceSchedulerOutputError>) -> Void)
    ...
    func updateInferenceScheduler(input: UpdateInferenceSchedulerInput, completion: @escaping (SdkResult<UpdateInferenceSchedulerOutput, UpdateInferenceSchedulerOutputError>) -> Void)
}
