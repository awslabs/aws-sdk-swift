...
public struct AdminUpdateAuthEventFeedbackInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<AdminUpdateAuthEventFeedbackOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<AdminUpdateAuthEventFeedbackOutput>
