...
public protocol CognitoIdentityProviderClientProtocol {
    ...
    func addCustomAttributes(input: AddCustomAttributesInput, completion: @escaping (SdkResult<AddCustomAttributesOutput, AddCustomAttributesOutputError>) -> Void)
    /// <p>Adds the specified user to the specified group.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminAddUserToGroup(input: AdminAddUserToGroupInput, completion: @escaping (SdkResult<AdminAddUserToGroupOutput, AdminAddUserToGroupOutputError>) -> Void)
    /// <p>Confirms user registration as an admin without using a confirmation code. Works on any
    ///             user.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminConfirmSignUp(input: AdminConfirmSignUpInput, completion: @escaping (SdkResult<AdminConfirmSignUpOutput, AdminConfirmSignUpOutputError>) -> Void)
    ...
    func adminCreateUser(input: AdminCreateUserInput, completion: @escaping (SdkResult<AdminCreateUserOutput, AdminCreateUserOutputError>) -> Void)
    /// <p>Deletes a user as an administrator. Works on any user.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminDeleteUser(input: AdminDeleteUserInput, completion: @escaping (SdkResult<AdminDeleteUserOutput, AdminDeleteUserOutputError>) -> Void)
    /// <p>Deletes the user attributes in a user pool as an administrator. Works on any
    ///             user.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminDeleteUserAttributes(input: AdminDeleteUserAttributesInput, completion: @escaping (SdkResult<AdminDeleteUserAttributesOutput, AdminDeleteUserAttributesOutputError>) -> Void)
    ...
    ///             assertion.</p>
    func adminDisableProviderForUser(input: AdminDisableProviderForUserInput, completion: @escaping (SdkResult<AdminDisableProviderForUserOutput, AdminDisableProviderForUserOutputError>) -> Void)
    /// <p>Disables the specified user.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminDisableUser(input: AdminDisableUserInput, completion: @escaping (SdkResult<AdminDisableUserOutput, AdminDisableUserOutputError>) -> Void)
    /// <p>Enables the specified user as an administrator. Works on any user.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminEnableUser(input: AdminEnableUserInput, completion: @escaping (SdkResult<AdminEnableUserOutput, AdminEnableUserOutputError>) -> Void)
    /// <p>Forgets the device, as an administrator.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminForgetDevice(input: AdminForgetDeviceInput, completion: @escaping (SdkResult<AdminForgetDeviceOutput, AdminForgetDeviceOutputError>) -> Void)
    /// <p>Gets the device, as an administrator.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminGetDevice(input: AdminGetDeviceInput, completion: @escaping (SdkResult<AdminGetDeviceOutput, AdminGetDeviceOutputError>) -> Void)
    /// <p>Gets the specified user by user name in a user pool as an administrator. Works on any
    ///             user.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminGetUser(input: AdminGetUserInput, completion: @escaping (SdkResult<AdminGetUserOutput, AdminGetUserOutputError>) -> Void)
    /// <p>Initiates the authentication flow, as an administrator.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminInitiateAuth(input: AdminInitiateAuthInput, completion: @escaping (SdkResult<AdminInitiateAuthOutput, AdminInitiateAuthOutputError>) -> Void)
    ...
    ///         <p>This action is enabled only for admin access and requires developer
    ///             credentials.</p>
    func adminLinkProviderForUser(input: AdminLinkProviderForUserInput, completion: @escaping (SdkResult<AdminLinkProviderForUserOutput, AdminLinkProviderForUserOutputError>) -> Void)
    /// <p>Lists devices, as an administrator.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminListDevices(input: AdminListDevicesInput, completion: @escaping (SdkResult<AdminListDevicesOutput, AdminListDevicesOutputError>) -> Void)
    /// <p>Lists the groups that the user belongs to.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminListGroupsForUser(input: AdminListGroupsForUserInput, completion: @escaping (SdkResult<AdminListGroupsForUserOutput, AdminListGroupsForUserOutputError>) -> Void)
    /// <p>Lists a history of user activity and any risks detected as part of Amazon Cognito
    ///             advanced security.</p>
    func adminListUserAuthEvents(input: AdminListUserAuthEventsInput, completion: @escaping (SdkResult<AdminListUserAuthEventsOutput, AdminListUserAuthEventsOutputError>) -> Void)
    /// <p>Removes the specified user from the specified group.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminRemoveUserFromGroup(input: AdminRemoveUserFromGroupInput, completion: @escaping (SdkResult<AdminRemoveUserFromGroupOutput, AdminRemoveUserFromGroupOutputError>) -> Void)
    ...
    ///         <p>Calling this action requires developer credentials.</p>
    func adminResetUserPassword(input: AdminResetUserPasswordInput, completion: @escaping (SdkResult<AdminResetUserPasswordOutput, AdminResetUserPasswordOutputError>) -> Void)
    /// <p>Responds to an authentication challenge, as an administrator.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminRespondToAuthChallenge(input: AdminRespondToAuthChallengeInput, completion: @escaping (SdkResult<AdminRespondToAuthChallengeOutput, AdminRespondToAuthChallengeOutputError>) -> Void)
    ...
    func adminSetUserMFAPreference(input: AdminSetUserMFAPreferenceInput, completion: @escaping (SdkResult<AdminSetUserMFAPreferenceOutput, AdminSetUserMFAPreferenceOutputError>) -> Void)
    ...
    func adminSetUserPassword(input: AdminSetUserPasswordInput, completion: @escaping (SdkResult<AdminSetUserPasswordOutput, AdminSetUserPasswordOutputError>) -> Void)
    /// <p>
    ...
    func adminSetUserSettings(input: AdminSetUserSettingsInput, completion: @escaping (SdkResult<AdminSetUserSettingsOutput, AdminSetUserSettingsOutputError>) -> Void)
    ...
    func adminUpdateAuthEventFeedback(input: AdminUpdateAuthEventFeedbackInput, completion: @escaping (SdkResult<AdminUpdateAuthEventFeedbackOutput, AdminUpdateAuthEventFeedbackOutputError>) -> Void)
    /// <p>Updates the device status as an administrator.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminUpdateDeviceStatus(input: AdminUpdateDeviceStatusInput, completion: @escaping (SdkResult<AdminUpdateDeviceStatusOutput, AdminUpdateDeviceStatusOutputError>) -> Void)
    ...
    ///             email as verified.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    func adminUpdateUserAttributes(input: AdminUpdateUserAttributesInput, completion: @escaping (SdkResult<AdminUpdateUserAttributesOutput, AdminUpdateUserAttributesOutputError>) -> Void)
    ...
    ///         <p>Calling this action requires developer credentials.</p>
    func adminUserGlobalSignOut(input: AdminUserGlobalSignOutInput, completion: @escaping (SdkResult<AdminUserGlobalSignOutOutput, AdminUserGlobalSignOutOutputError>) -> Void)
    ...
    func associateSoftwareToken(input: AssociateSoftwareTokenInput, completion: @escaping (SdkResult<AssociateSoftwareTokenOutput, AssociateSoftwareTokenOutputError>) -> Void)
    ...
    ///             tracking.</p>
    func confirmDevice(input: ConfirmDeviceInput, completion: @escaping (SdkResult<ConfirmDeviceOutput, ConfirmDeviceOutputError>) -> Void)
    /// <p>Allows a user to enter a confirmation code to reset a forgotten password.</p>
    func confirmForgotPassword(input: ConfirmForgotPasswordInput, completion: @escaping (SdkResult<ConfirmForgotPasswordOutput, ConfirmForgotPasswordOutputError>) -> Void)
    /// <p>Confirms registration of a user and handles the existing alias from a previous
    ///             user.</p>
    func confirmSignUp(input: ConfirmSignUpInput, completion: @escaping (SdkResult<ConfirmSignUpOutput, ConfirmSignUpOutputError>) -> Void)
    ...
    func createIdentityProvider(input: CreateIdentityProviderInput, completion: @escaping (SdkResult<CreateIdentityProviderOutput, CreateIdentityProviderOutputError>) -> Void)
    /// <p>Creates a new OAuth2.0 resource server and defines custom scopes in it.</p>
    func createResourceServer(input: CreateResourceServerInput, completion: @escaping (SdkResult<CreateResourceServerOutput, CreateResourceServerOutputError>) -> Void)
    /// <p>Creates the user import job.</p>
    func createUserImportJob(input: CreateUserImportJobInput, completion: @escaping (SdkResult<CreateUserImportJobOutput, CreateUserImportJobOutputError>) -> Void)
    /// <p>Creates a new Amazon Cognito user pool and sets the password policy for the
    ///             pool.</p>
    func createUserPool(input: CreateUserPoolInput, completion: @escaping (SdkResult<CreateUserPoolOutput, CreateUserPoolOutputError>) -> Void)
    /// <p>Creates the user pool client.</p>
    func createUserPoolClient(input: CreateUserPoolClientInput, completion: @escaping (SdkResult<CreateUserPoolClientOutput, CreateUserPoolClientOutputError>) -> Void)
    /// <p>Creates a new domain for a user pool.</p>
    func createUserPoolDomain(input: CreateUserPoolDomainInput, completion: @escaping (SdkResult<CreateUserPoolDomainOutput, CreateUserPoolDomainOutputError>) -> Void)
    /// <p>Deletes a group.</p>
    ///         <p>Calling this action requires developer credentials.</p>
    ...
    func deleteIdentityProvider(input: DeleteIdentityProviderInput, completion: @escaping (SdkResult<DeleteIdentityProviderOutput, DeleteIdentityProviderOutputError>) -> Void)
    /// <p>Deletes a resource server.</p>
    func deleteResourceServer(input: DeleteResourceServerInput, completion: @escaping (SdkResult<DeleteResourceServerOutput, DeleteResourceServerOutputError>) -> Void)
    ...
    func deleteUserAttributes(input: DeleteUserAttributesInput, completion: @escaping (SdkResult<DeleteUserAttributesOutput, DeleteUserAttributesOutputError>) -> Void)
    /// <p>Deletes the specified Amazon Cognito user pool.</p>
    func deleteUserPool(input: DeleteUserPoolInput, completion: @escaping (SdkResult<DeleteUserPoolOutput, DeleteUserPoolOutputError>) -> Void)
    /// <p>Allows the developer to delete the user pool client.</p>
    func deleteUserPoolClient(input: DeleteUserPoolClientInput, completion: @escaping (SdkResult<DeleteUserPoolClientOutput, DeleteUserPoolClientOutputError>) -> Void)
    /// <p>Deletes a domain for a user pool.</p>
    func deleteUserPoolDomain(input: DeleteUserPoolDomainInput, completion: @escaping (SdkResult<DeleteUserPoolDomainOutput, DeleteUserPoolDomainOutputError>) -> Void)
    /// <p>Gets information about a specific identity provider.</p>
    func describeIdentityProvider(input: DescribeIdentityProviderInput, completion: @escaping (SdkResult<DescribeIdentityProviderOutput, DescribeIdentityProviderOutputError>) -> Void)
    /// <p>Describes a resource server.</p>
    func describeResourceServer(input: DescribeResourceServerInput, completion: @escaping (SdkResult<DescribeResourceServerOutput, DescribeResourceServerOutputError>) -> Void)
    /// <p>Describes the risk configuration.</p>
    func describeRiskConfiguration(input: DescribeRiskConfigurationInput, completion: @escaping (SdkResult<DescribeRiskConfigurationOutput, DescribeRiskConfigurationOutputError>) -> Void)
    /// <p>Describes the user import job.</p>
    func describeUserImportJob(input: DescribeUserImportJobInput, completion: @escaping (SdkResult<DescribeUserImportJobOutput, DescribeUserImportJobOutputError>) -> Void)
    /// <p>Returns the configuration information and metadata of the specified user pool.</p>
    func describeUserPool(input: DescribeUserPoolInput, completion: @escaping (SdkResult<DescribeUserPoolOutput, DescribeUserPoolOutputError>) -> Void)
    /// <p>Client method for returning the configuration information and metadata of the
    ///             specified user pool app client.</p>
    func describeUserPoolClient(input: DescribeUserPoolClientInput, completion: @escaping (SdkResult<DescribeUserPoolClientOutput, DescribeUserPoolClientOutputError>) -> Void)
    /// <p>Gets information about a domain.</p>
    func describeUserPoolDomain(input: DescribeUserPoolDomainInput, completion: @escaping (SdkResult<DescribeUserPoolDomainOutput, DescribeUserPoolDomainOutputError>) -> Void)
    /// <p>Forgets the specified device.</p>
    func forgetDevice(input: ForgetDeviceInput, completion: @escaping (SdkResult<ForgetDeviceOutput, ForgetDeviceOutputError>) -> Void)
    ...
    func forgotPassword(input: ForgotPasswordInput, completion: @escaping (SdkResult<ForgotPasswordOutput, ForgotPasswordOutputError>) -> Void)
    /// <p>Gets the header information for the .csv file to be used as input for the user import
    ///             job.</p>
    func getCSVHeader(input: GetCSVHeaderInput, completion: @escaping (SdkResult<GetCSVHeaderOutput, GetCSVHeaderOutputError>) -> Void)
    /// <p>Gets the device.</p>
    ...
    func getIdentityProviderByIdentifier(input: GetIdentityProviderByIdentifierInput, completion: @escaping (SdkResult<GetIdentityProviderByIdentifierOutput, GetIdentityProviderByIdentifierOutputError>) -> Void)
    /// <p>This method takes a user pool ID, and returns the signing certificate.</p>
    func getSigningCertificate(input: GetSigningCertificateInput, completion: @escaping (SdkResult<GetSigningCertificateOutput, GetSigningCertificateOutputError>) -> Void)
    ...
    func getUICustomization(input: GetUICustomizationInput, completion: @escaping (SdkResult<GetUICustomizationOutput, GetUICustomizationOutputError>) -> Void)
    ...
    func getUserAttributeVerificationCode(input: GetUserAttributeVerificationCodeInput, completion: @escaping (SdkResult<GetUserAttributeVerificationCodeOutput, GetUserAttributeVerificationCodeOutputError>) -> Void)
    /// <p>Gets the user pool multi-factor authentication (MFA) configuration.</p>
    func getUserPoolMfaConfig(input: GetUserPoolMfaConfigInput, completion: @escaping (SdkResult<GetUserPoolMfaConfigOutput, GetUserPoolMfaConfigOutputError>) -> Void)
    ...
    func globalSignOut(input: GlobalSignOutInput, completion: @escaping (SdkResult<GlobalSignOutOutput, GlobalSignOutOutputError>) -> Void)
    /// <p>Initiates the authentication flow.</p>
    func initiateAuth(input: InitiateAuthInput, completion: @escaping (SdkResult<InitiateAuthOutput, InitiateAuthOutputError>) -> Void)
    ...
    func listIdentityProviders(input: ListIdentityProvidersInput, completion: @escaping (SdkResult<ListIdentityProvidersOutput, ListIdentityProvidersOutputError>) -> Void)
    /// <p>Lists the resource servers for a user pool.</p>
    func listResourceServers(input: ListResourceServersInput, completion: @escaping (SdkResult<ListResourceServersOutput, ListResourceServersOutputError>) -> Void)
    ...
    func listUserImportJobs(input: ListUserImportJobsInput, completion: @escaping (SdkResult<ListUserImportJobsOutput, ListUserImportJobsOutputError>) -> Void)
    /// <p>Lists the clients that have been created for the specified user pool.</p>
    func listUserPoolClients(input: ListUserPoolClientsInput, completion: @escaping (SdkResult<ListUserPoolClientsOutput, ListUserPoolClientsOutputError>) -> Void)
    /// <p>Lists the user pools associated with an AWS account.</p>
    func listUserPools(input: ListUserPoolsInput, completion: @escaping (SdkResult<ListUserPoolsOutput, ListUserPoolsOutputError>) -> Void)
    ...
    ///         <p>Calling this action requires developer credentials.</p>
    func listUsersInGroup(input: ListUsersInGroupInput, completion: @escaping (SdkResult<ListUsersInGroupOutput, ListUsersInGroupOutputError>) -> Void)
    /// <p>Resends the confirmation (for confirmation of registration) to a specific user in the
    ///             user pool.</p>
    func resendConfirmationCode(input: ResendConfirmationCodeInput, completion: @escaping (SdkResult<ResendConfirmationCodeOutput, ResendConfirmationCodeOutputError>) -> Void)
    /// <p>Responds to the authentication challenge.</p>
    func respondToAuthChallenge(input: RespondToAuthChallengeInput, completion: @escaping (SdkResult<RespondToAuthChallengeOutput, RespondToAuthChallengeOutputError>) -> Void)
    ...
    func setRiskConfiguration(input: SetRiskConfigurationInput, completion: @escaping (SdkResult<SetRiskConfigurationOutput, SetRiskConfigurationOutputError>) -> Void)
    ...
    ///                 error.</p>
    ///         </note>
    func setUICustomization(input: SetUICustomizationInput, completion: @escaping (SdkResult<SetUICustomizationOutput, SetUICustomizationOutputError>) -> Void)
    ...
    func setUserMFAPreference(input: SetUserMFAPreferenceInput, completion: @escaping (SdkResult<SetUserMFAPreferenceOutput, SetUserMFAPreferenceOutputError>) -> Void)
    /// <p>Set the user pool multi-factor authentication (MFA) configuration.</p>
    func setUserPoolMfaConfig(input: SetUserPoolMfaConfigInput, completion: @escaping (SdkResult<SetUserPoolMfaConfigOutput, SetUserPoolMfaConfigOutputError>) -> Void)
    /// <p>
    ///             <i>This action is no longer supported.</i> You can use it to configure
    ///             only SMS MFA. You can't use it to configure TOTP software token MFA. To configure either
    ...
    func setUserSettings(input: SetUserSettingsInput, completion: @escaping (SdkResult<SetUserSettingsOutput, SetUserSettingsOutputError>) -> Void)
    /// <p>Registers the user in the specified user pool and creates a user name, password, and
    ///             user attributes.</p>
    func signUp(input: SignUpInput, completion: @escaping (SdkResult<SignUpOutput, SignUpOutputError>) -> Void)
    /// <p>Starts the user import.</p>
    func startUserImportJob(input: StartUserImportJobInput, completion: @escaping (SdkResult<StartUserImportJobOutput, StartUserImportJobOutputError>) -> Void)
    /// <p>Stops the user import job.</p>
    func stopUserImportJob(input: StopUserImportJobInput, completion: @escaping (SdkResult<StopUserImportJobOutput, StopUserImportJobOutputError>) -> Void)
    ...
    func updateAuthEventFeedback(input: UpdateAuthEventFeedbackInput, completion: @escaping (SdkResult<UpdateAuthEventFeedbackOutput, UpdateAuthEventFeedbackOutputError>) -> Void)
    /// <p>Updates the device status.</p>
    func updateDeviceStatus(input: UpdateDeviceStatusInput, completion: @escaping (SdkResult<UpdateDeviceStatusOutput, UpdateDeviceStatusOutputError>) -> Void)
    ...
    func updateIdentityProvider(input: UpdateIdentityProviderInput, completion: @escaping (SdkResult<UpdateIdentityProviderOutput, UpdateIdentityProviderOutputError>) -> Void)
    /// <p>Updates the name and scopes of resource server. All other fields are read-only.</p>
    ///         <important>
    ///             <p>If you don't provide a value for an attribute, it will be set to the default
    ///                 value.</p>
    ///         </important>
    func updateResourceServer(input: UpdateResourceServerInput, completion: @escaping (SdkResult<UpdateResourceServerOutput, UpdateResourceServerOutputError>) -> Void)
    /// <p>Allows a user to update a specific attribute (one at a time).</p>
    func updateUserAttributes(input: UpdateUserAttributesInput, completion: @escaping (SdkResult<UpdateUserAttributesOutput, UpdateUserAttributesOutputError>) -> Void)
    ...
    ///                 value.</p>
    ///         </important>
    func updateUserPool(input: UpdateUserPoolInput, completion: @escaping (SdkResult<UpdateUserPoolOutput, UpdateUserPoolOutputError>) -> Void)
    ...
    ///                 value.</p>
    ///         </important>
    func updateUserPoolClient(input: UpdateUserPoolClientInput, completion: @escaping (SdkResult<UpdateUserPoolClientOutput, UpdateUserPoolClientOutputError>) -> Void)
    ...
    func updateUserPoolDomain(input: UpdateUserPoolDomainInput, completion: @escaping (SdkResult<UpdateUserPoolDomainOutput, UpdateUserPoolDomainOutputError>) -> Void)
    ...
    func verifySoftwareToken(input: VerifySoftwareTokenInput, completion: @escaping (SdkResult<VerifySoftwareTokenOutput, VerifySoftwareTokenOutputError>) -> Void)
    /// <p>Verifies the specified user attributes in the user pool.</p>
    func verifyUserAttribute(input: VerifyUserAttributeInput, completion: @escaping (SdkResult<VerifyUserAttributeOutput, VerifyUserAttributeOutputError>) -> Void)
}
