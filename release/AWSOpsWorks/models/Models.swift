...
extension OpsWorksClientTypes {
    ...
    public struct AgentVersion: Swift.Equatable {
        ...
        var configurationManager: OpsWorksClientTypes.StackConfigurationManager?
        /// The agent version.
...
extension OpsWorksClientTypes {
    ...
    public struct App: Swift.Equatable {
        ...
        var environment: [OpsWorksClientTypes.EnvironmentVariable]?
        /// The app name.
        var name: Swift.String?
        /// The app's short name.
        var shortname: Swift.String?
        /// An SslConfiguration object with the SSL configuration.
        var sslConfiguration: OpsWorksClientTypes.SslConfiguration?
        /// The app stack ID.
        var stackId: Swift.String?
        /// The app type.
        var type: OpsWorksClientTypes.AppType?
...
public struct AttachElasticLoadBalancerInput: Swift.Equatable {
    ...
    /// This member is required.
    var elasticLoadBalancerName: Swift.String?
    /// The ID of the layer to which the Elastic Load Balancing instance is to be attached.
    /// This member is required.
    var layerId: Swift.String?
...
extension OpsWorksClientTypes {
    ...
    public struct AutoScalingThresholds: Swift.Equatable {
        ...
        var loadThreshold: Swift.Double?
        /// The memory utilization threshold, as a percent of the available memory. A value of -1 disables the threshold.
        var memoryThreshold: Swift.Double?
        /// The amount of time, in minutes, that the load must exceed a threshold before more instances are added or removed.
        var thresholdsWaitTime: Swift.Int?
...
extension OpsWorksClientTypes {
    ...
    public struct BlockDeviceMapping: Swift.Equatable {
        ...
        var ebs: OpsWorksClientTypes.EbsBlockDevice?
        /// Suppresses the specified device included in the AMI's block device mapping.
        var noDevice: Swift.String?
...
extension OpsWorksClientTypes {
    ...
    public struct ChefConfiguration: Swift.Equatable {
        ...
        var berkshelfVersion: Swift.String?
        /// Whether to enable Berkshelf.
        var manageBerkshelf: Swift.Bool?
...
public struct CloneStackInput: Swift.Equatable {
    ...
    var chefConfiguration: OpsWorksClientTypes.ChefConfiguration?
    /// A list of source stack app IDs to be included in the cloned stack.
    var cloneAppIds: [Swift.String]?
    /// Whether to clone the source stack's permissions.
    var clonePermissions: Swift.Bool?
    ...
    var customCookbooksSource: OpsWorksClientTypes.Source?
    ...
    var defaultAvailabilityZone: Swift.String?
    ...
    var defaultInstanceProfileArn: Swift.String?
    ...
    var defaultRootDeviceType: OpsWorksClientTypes.RootDeviceType?
    ...
    var hostnameTheme: Swift.String?
    ...
    /// This member is required.
    var serviceRoleArn: Swift.String?
    /// The source stack ID.
    /// This member is required.
    var sourceStackId: Swift.String?
    /// Whether to use custom cookbooks.
    var useCustomCookbooks: Swift.Bool?
    ...
    var useOpsworksSecurityGroups: Swift.Bool?
...
extension OpsWorksClientTypes {
    ...
    public struct CloudWatchLogsConfiguration: Swift.Equatable {
        ...
        var logStreams: [OpsWorksClientTypes.CloudWatchLogsLogStream]?
...
extension OpsWorksClientTypes {
    ...
    public struct CloudWatchLogsLogStream: Swift.Equatable {
        ...
        var datetimeFormat: Swift.String?
        /// Specifies the encoding of the log file so that the file can be read correctly. The default is utf_8. Encodings supported by Python codecs.decode() can be used here.
        var encoding: OpsWorksClientTypes.CloudWatchLogsEncoding?
        ...
        var fileFingerprintLines: Swift.String?
        /// Specifies where to start to read data (start_of_file or end_of_file). The default is start_of_file. This setting is only used if there is no state persisted for that log stream.
        var initialPosition: OpsWorksClientTypes.CloudWatchLogsInitialPosition?
        /// Specifies the destination log group. A log group is created automatically if it doesn't already exist. Log group names can be between 1 and 512 characters long. Allowed characters include a-z, A-Z, 0-9, '_' (underscore), '-' (hyphen), '/' (forward slash), and '.' (period).
        var logGroupName: Swift.String?
        /// Specifies the pattern for identifying the start of a log message.
        var multiLineStartPattern: Swift.String?
        /// Specifies the time zone of log event time stamps.
        var timeZone: OpsWorksClientTypes.CloudWatchLogsTimeZone?
...
extension OpsWorksClientTypes {
    ...
    public struct Command: Swift.Equatable {
        ...
        var acknowledgedAt: Swift.String?
        /// The command ID.
        var commandId: Swift.String?
        /// Date when the command completed.
        var completedAt: Swift.String?
        /// Date and time when the command was run.
        var createdAt: Swift.String?
        /// The command deployment ID.
        var deploymentId: Swift.String?
        /// The command exit code.
        var exitCode: Swift.Int?
        /// The ID of the instance where the command was executed.
        var instanceId: Swift.String?
        /// The URL of the command log.
        var logUrl: Swift.String?
        /// The command status:
        ///
        /// * failed
        ///
...
public struct CreateDeploymentInput: Swift.Equatable {
    ...
    /// This member is required.
    var command: OpsWorksClientTypes.DeploymentCommand?
...
public struct CreateInstanceInput: Swift.Equatable {
    ...
    var architecture: OpsWorksClientTypes.Architecture?
    /// For load-based or time-based instances, the type. Windows stacks can use only time-based instances.
    var autoScalingType: OpsWorksClientTypes.AutoScalingType?
    ...
    var blockDeviceMappings: [OpsWorksClientTypes.BlockDeviceMapping]?
    ...
    var installUpdatesOnBoot: Swift.Bool?
    ...
    var rootDeviceType: OpsWorksClientTypes.RootDeviceType?
    /// The instance's Amazon EC2 key-pair name.
    var sshKeyName: Swift.String?
    /// The stack ID.
    /// This member is required.
    var stackId: Swift.String?
    ...
    var tenancy: Swift.String?
    /// The instance's virtualization type, paravirtual or hvm.
    var virtualizationType: Swift.String?
...
public struct CreateLayerInput: Swift.Equatable {
    ...
    var autoAssignElasticIps: Swift.Bool?
    ...
    var autoAssignPublicIps: Swift.Bool?
    /// Specifies CloudWatch Logs configuration options for the layer. For more information, see [CloudWatchLogsLogStream].
    var cloudWatchLogsConfiguration: OpsWorksClientTypes.CloudWatchLogsConfiguration?
    ...
    var customInstanceProfileArn: Swift.String?
    ...
    var customRecipes: OpsWorksClientTypes.Recipes?
    /// An array containing the layer custom security group IDs.
    var customSecurityGroupIds: [Swift.String]?
    /// Whether to disable auto healing for the layer.
    var enableAutoHealing: Swift.Bool?
    ...
    var lifecycleEventConfiguration: OpsWorksClientTypes.LifecycleEventConfiguration?
    /// The layer name, which is used by the console.
    /// This member is required.
    var name: Swift.String?
    /// An array of Package objects that describes the layer packages.
    var packages: [Swift.String]?
    ...
    /// This member is required.
    var type: OpsWorksClientTypes.LayerType?
    /// Whether to use Amazon EBS-optimized instances.
    var useEbsOptimizedInstances: Swift.Bool?
    /// A VolumeConfigurations object that describes the layer's Amazon EBS volumes.
    var volumeConfigurations: [OpsWorksClientTypes.VolumeConfiguration]?
...
public struct DeleteInstanceInput: Swift.Equatable {
    ...
    var deleteElasticIp: Swift.Bool?
    /// Whether to delete the instance's Amazon EBS volumes.
    var deleteVolumes: Swift.Bool?
    /// The instance ID.
    /// This member is required.
    var instanceId: Swift.String?
...
extension OpsWorksClientTypes {
    ...
    public struct DeploymentCommand: Swift.Equatable {
        ...
        var args: [Swift.String:[Swift.String]]?
        ...
        /// This member is required.
        var name: OpsWorksClientTypes.DeploymentCommandName?
...
public struct DeregisterEcsClusterInput: Swift.Equatable {
    ...
    /// This member is required.
    var ecsClusterArn: Swift.String?
...
public struct DeregisterRdsDbInstanceInput: Swift.Equatable {
    ...
    /// This member is required.
    var rdsDbInstanceArn: Swift.String?
...
public struct DescribeAgentVersionsOutputResponse: Swift.Equatable {
    ...
    var agentVersions: [OpsWorksClientTypes.AgentVersion]?
...
public struct DescribeAppsOutputResponse: Swift.Equatable {
    ...
    var apps: [OpsWorksClientTypes.App]?
...
public struct DescribeCommandsOutputResponse: Swift.Equatable {
    ...
    var commands: [OpsWorksClientTypes.Command]?
...
public struct DescribeDeploymentsInput: Swift.Equatable {
    ...
    var deploymentIds: [Swift.String]?
...
public struct DescribeDeploymentsOutputResponse: Swift.Equatable {
    ...
    var deployments: [OpsWorksClientTypes.Deployment]?
...
public struct DescribeEcsClustersInput: Swift.Equatable {
    ...
    var ecsClusterArns: [Swift.String]?
...
public struct DescribeEcsClustersOutputResponse: Swift.Equatable {
    ...
    var ecsClusters: [OpsWorksClientTypes.EcsCluster]?
...
public struct DescribeElasticIpsOutputResponse: Swift.Equatable {
    ...
    var elasticIps: [OpsWorksClientTypes.ElasticIp]?
...
public struct DescribeElasticLoadBalancersOutputResponse: Swift.Equatable {
    ...
    var elasticLoadBalancers: [OpsWorksClientTypes.ElasticLoadBalancer]?
...
public struct DescribeInstancesOutputResponse: Swift.Equatable {
    ...
    var instances: [OpsWorksClientTypes.Instance]?
...
public struct DescribeLayersOutputResponse: Swift.Equatable {
    ...
    var layers: [OpsWorksClientTypes.Layer]?
...
public struct DescribeLoadBasedAutoScalingOutputResponse: Swift.Equatable {
    ...
    var loadBasedAutoScalingConfigurations: [OpsWorksClientTypes.LoadBasedAutoScalingConfiguration]?
...
public struct DescribeMyUserProfileOutputResponse: Swift.Equatable {
    ...
    var userProfile: OpsWorksClientTypes.SelfUserProfile?
...
public struct DescribeOperatingSystemsOutputResponse: Swift.Equatable {
    ...
    var operatingSystems: [OpsWorksClientTypes.OperatingSystem]?
...
public struct DescribePermissionsOutputResponse: Swift.Equatable {
    ...
    var permissions: [OpsWorksClientTypes.Permission]?
...
public struct DescribeRaidArraysOutputResponse: Swift.Equatable {
    ...
    var raidArrays: [OpsWorksClientTypes.RaidArray]?
...
public struct DescribeRdsDbInstancesInput: Swift.Equatable {
    ...
    var rdsDbInstanceArns: [Swift.String]?
...
public struct DescribeRdsDbInstancesOutputResponse: Swift.Equatable {
    ...
    var rdsDbInstances: [OpsWorksClientTypes.RdsDbInstance]?
...
public struct DescribeServiceErrorsInput: Swift.Equatable {
    ...
    var serviceErrorIds: [Swift.String]?
...
public struct DescribeServiceErrorsOutputResponse: Swift.Equatable {
    ...
    var serviceErrors: [OpsWorksClientTypes.ServiceError]?
...
public struct DescribeStackProvisioningParametersOutputResponse: Swift.Equatable {
    ...
    var agentInstallerUrl: Swift.String?
...
public struct DescribeStackSummaryOutputResponse: Swift.Equatable {
    ...
    var stackSummary: OpsWorksClientTypes.StackSummary?
...
public struct DescribeStacksOutputResponse: Swift.Equatable {
    ...
    var stacks: [OpsWorksClientTypes.Stack]?
...
public struct DescribeTimeBasedAutoScalingOutputResponse: Swift.Equatable {
    ...
    var timeBasedAutoScalingConfigurations: [OpsWorksClientTypes.TimeBasedAutoScalingConfiguration]?
...
public struct DescribeUserProfilesOutputResponse: Swift.Equatable {
    ...
    var userProfiles: [OpsWorksClientTypes.UserProfile]?
...
public struct DescribeVolumesInput: Swift.Equatable {
    ...
    var raidArrayId: Swift.String?
    /// A stack ID. The action describes the stack's registered Amazon EBS volumes.
    var stackId: Swift.String?
    /// Am array of volume IDs. If you use this parameter, DescribeVolumes returns descriptions of the specified volumes. Otherwise, it returns a description of every volume.
    var volumeIds: [Swift.String]?
...
public struct DescribeVolumesOutputResponse: Swift.Equatable {
    ...
    var volumes: [OpsWorksClientTypes.Volume]?
...
extension OpsWorksClientTypes {
    ...
    public struct EbsBlockDevice: Swift.Equatable {
        ...
        var volumeType: OpsWorksClientTypes.VolumeType?
...
extension OpsWorksClientTypes {
    ...
    public struct EcsCluster: Swift.Equatable {
        ...
        var ecsClusterArn: Swift.String?
        /// The cluster name.
        var ecsClusterName: Swift.String?
        /// The time and date that the cluster was registered with the stack.
        var registeredAt: Swift.String?
        /// The stack ID.
        var stackId: Swift.String?
...
extension OpsWorksClientTypes {
    ...
    public struct ElasticLoadBalancer: Swift.Equatable {
        ...
        var ec2InstanceIds: [Swift.String]?
        /// The Elastic Load Balancing instance's name.
        var elasticLoadBalancerName: Swift.String?
...
public struct GrantAccessInput: Swift.Equatable {
    ...
    var validForInMinutes: Swift.Int?
...
public struct GrantAccessOutputResponse: Swift.Equatable {
    ...
    var temporaryCredential: OpsWorksClientTypes.TemporaryCredential?
...
extension OpsWorksClientTypes {
    ...
    public struct Instance: Swift.Equatable {
        ...
        var ecsContainerInstanceArn: Swift.String?
        ...
        var infrastructureClass: Swift.String?
        ...
        var instanceProfileArn: Swift.String?
        /// The instance type, such as t2.micro.
        var instanceType: Swift.String?
        /// The ID of the last service error. For more information, call [DescribeServiceErrors].
        var lastServiceErrorId: Swift.String?
        ...
        var privateDns: Swift.String?
        /// The instance's private IP address.
        var privateIp: Swift.String?
        /// The instance public DNS name.
        var publicDns: Swift.String?
        /// The instance public IP address.
        var publicIp: Swift.String?
        /// For registered instances, who performed the registration.
        var registeredBy: Swift.String?
        /// The instance's reported AWS OpsWorks Stacks agent version.
        var reportedAgentVersion: Swift.String?
        /// For registered instances, the reported operating system.
        var reportedOs: OpsWorksClientTypes.ReportedOs?
        ...
        var rootDeviceVolumeId: Swift.String?
        /// An array containing the instance security group IDs.
        var securityGroupIds: [Swift.String]?
        /// The SSH key's Deep Security Agent (DSA) fingerprint.
        var sshHostDsaKeyFingerprint: Swift.String?
        /// The SSH key's RSA fingerprint.
        var sshHostRsaKeyFingerprint: Swift.String?
        /// The instance's Amazon EC2 key-pair name.
        var sshKeyName: Swift.String?
        /// The stack ID.
        var stackId: Swift.String?
        ...
        var tenancy: Swift.String?
        /// The instance's virtualization type: paravirtual or hvm.
        var virtualizationType: OpsWorksClientTypes.VirtualizationType?
...
extension OpsWorksClientTypes {
    ...
    public struct InstancesCount: Swift.Equatable {
        ...
        var assigning: Swift.Int?
        /// The number of instances with booting status.
        var booting: Swift.Int?
        /// The number of instances with connection_lost status.
        var connectionLost: Swift.Int?
        /// The number of instances in the Deregistering state.
        var deregistering: Swift.Int?
        /// The number of instances with online status.
        var online: Swift.Int?
        /// The number of instances with pending status.
        var pending: Swift.Int?
        /// The number of instances with rebooting status.
        var rebooting: Swift.Int?
        /// The number of instances in the Registered state.
        var registered: Swift.Int?
        /// The number of instances in the Registering state.
        var registering: Swift.Int?
        /// The number of instances with requested status.
        var requested: Swift.Int?
        /// The number of instances with running_setup status.
        var runningSetup: Swift.Int?
        /// The number of instances with setup_failed status.
        var setupFailed: Swift.Int?
        /// The number of instances with shutting_down status.
        var shuttingDown: Swift.Int?
        /// The number of instances with start_failed status.
        var startFailed: Swift.Int?
        /// The number of instances with stop_failed status.
        var stopFailed: Swift.Int?
        /// The number of instances with stopped status.
        var stopped: Swift.Int?
        /// The number of instances with stopping status.
        var stopping: Swift.Int?
        /// The number of instances with terminated status.
        var terminated: Swift.Int?
        /// The number of instances with terminating status.
        var terminating: Swift.Int?
        /// The number of instances in the Unassigning state.
        var unassigning: Swift.Int?
...
extension OpsWorksClientTypes {
    ...
    public struct Layer: Swift.Equatable {
        ...
        var defaultRecipes: OpsWorksClientTypes.Recipes?
        /// An array containing the layer's security group names.
        var defaultSecurityGroupNames: [Swift.String]?
...
extension OpsWorksClientTypes {
    ...
    public struct LifecycleEventConfiguration: Swift.Equatable {
        ...
        var shutdown: OpsWorksClientTypes.ShutdownEventConfiguration?
...
extension OpsWorksClientTypes {
    ...
    public struct LoadBasedAutoScalingConfiguration: Swift.Equatable {
        ...
        var downScaling: OpsWorksClientTypes.AutoScalingThresholds?
        /// Whether load-based auto scaling is enabled for the layer.
        var enable: Swift.Bool?
        /// The layer ID.
        var layerId: Swift.String?
        /// An AutoScalingThresholds object that describes the upscaling configuration, which defines how and when AWS OpsWorks Stacks increases the number of instances.
        var upScaling: OpsWorksClientTypes.AutoScalingThresholds?
...
extension OpsWorksClientTypes {
    ...
    public struct OperatingSystem: Swift.Equatable {
        ...
        var configurationManagers: [OpsWorksClientTypes.OperatingSystemConfigurationManager]?
        /// The ID of a supported operating system, such as Amazon Linux 2018.03.
        var id: Swift.String?
        /// The name of the operating system, such as Amazon Linux 2018.03.
        var name: Swift.String?
        /// A short name for the operating system manufacturer.
        var reportedName: Swift.String?
        /// The version of the operating system, including the release and edition, if applicable.
        var reportedVersion: Swift.String?
        /// Indicates that an operating system is not supported for new instances.
        var supported: Swift.Bool?
...
extension OpsWorksClientTypes {
    ...
    public struct Permission: Swift.Equatable {
        ...
        var allowSsh: Swift.Bool?
        /// Whether the user can use sudo.
        var allowSudo: Swift.Bool?
...
extension OpsWorksClientTypes {
    ...
    public struct Recipes: Swift.Equatable {
        ...
        var configure: [Swift.String]?
        /// An array of custom recipe names to be run following a deploy event.
        var deploy: [Swift.String]?
        /// An array of custom recipe names to be run following a setup event.
        var setup: [Swift.String]?
        /// An array of custom recipe names to be run following a shutdown event.
        var shutdown: [Swift.String]?
        /// An array of custom recipe names to be run following a undeploy event.
        var undeploy: [Swift.String]?
...
public struct RegisterInstanceInput: Swift.Equatable {
    ...
    var instanceIdentity: OpsWorksClientTypes.InstanceIdentity?
    /// The instance's private IP address.
    var privateIp: Swift.String?
    /// The instance's public IP address.
    var publicIp: Swift.String?
    /// The instances public RSA key. This key is used to encrypt communication between the instance and the service.
    var rsaPublicKey: Swift.String?
    /// The instances public RSA key fingerprint.
    var rsaPublicKeyFingerprint: Swift.String?
...
extension OpsWorksClientTypes {
    ...
    public struct ServiceError: Swift.Equatable {
        ...
        /// The error ID.
        var serviceErrorId: Swift.String?
        /// The stack ID.
        var stackId: Swift.String?
        /// The error type.
        var type: Swift.String?
...
public struct SetTimeBasedAutoScalingInput: Swift.Equatable {
    ...
    var autoScalingSchedule: OpsWorksClientTypes.WeeklyAutoScalingSchedule?
    /// The instance ID.
    /// This member is required.
    var instanceId: Swift.String?
...
extension OpsWorksClientTypes {
    ...
    public struct ShutdownEventConfiguration: Swift.Equatable {
        ...
        var delayUntilElbConnectionsDrained: Swift.Bool?
        /// The time, in seconds, that AWS OpsWorks Stacks will wait after triggering a Shutdown event before shutting down an instance.
        var executionTimeout: Swift.Int?
...
extension OpsWorksClientTypes {
    ...
    public struct Source: Swift.Equatable {
        ...
        var sshKey: Swift.String?
        /// The repository type.
        var type: OpsWorksClientTypes.SourceType?
...
extension OpsWorksClientTypes {
    ...
    public struct StackSummary: Swift.Equatable {
        /// The number of apps.
        var appsCount: Swift.Int?
        /// The stack's ARN.
        var arn: Swift.String?
        /// An InstancesCount object with the number of instances in each status.
        var instancesCount: OpsWorksClientTypes.InstancesCount?
        /// The number of layers.
        var layersCount: Swift.Int?
        /// The stack name.
        var name: Swift.String?
        /// The stack ID.
        var stackId: Swift.String?
...
extension OpsWorksClientTypes {
    ...
    public struct WeeklyAutoScalingSchedule: Swift.Equatable {
        ...
        var friday: [Swift.String:Swift.String]?
        /// The schedule for Monday.
        var monday: [Swift.String:Swift.String]?
        /// The schedule for Saturday.
        var saturday: [Swift.String:Swift.String]?
        /// The schedule for Sunday.
        var sunday: [Swift.String:Swift.String]?
        /// The schedule for Thursday.
        var thursday: [Swift.String:Swift.String]?
        /// The schedule for Tuesday.
        var tuesday: [Swift.String:Swift.String]?
        /// The schedule for Wednesday.
        var wednesday: [Swift.String:Swift.String]?
