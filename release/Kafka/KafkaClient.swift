...
public class KafkaClient {
    ...
    public class KafkaClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("KafkaClient")
...
public struct KafkaClientLogHandlerFactory: SDKLogHandlerFactory {
