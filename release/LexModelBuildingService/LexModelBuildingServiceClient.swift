...
extension LexModelBuildingServiceClient: LexModelBuildingServiceClientProtocol {
    ...
    public func createIntentVersion(input: CreateIntentVersionInput, completion: @escaping (SdkResult<CreateIntentVersionOutput, CreateIntentVersionOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateIntentVersionInput, CreateIntentVersionOutput, CreateIntentVersionOutputError>(id: "createIntentVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateIntentVersionInput, CreateIntentVersionOutput, CreateIntentVersionOutputError>(contentType: "application/json"))
    ...
    public func createSlotTypeVersion(input: CreateSlotTypeVersionInput, completion: @escaping (SdkResult<CreateSlotTypeVersionOutput, CreateSlotTypeVersionOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateSlotTypeVersionInput, CreateSlotTypeVersionOutput, CreateSlotTypeVersionOutputError>(id: "createSlotTypeVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateSlotTypeVersionInput, CreateSlotTypeVersionOutput, CreateSlotTypeVersionOutputError>(contentType: "application/json"))
    ...
    public func deleteBotChannelAssociation(input: DeleteBotChannelAssociationInput, completion: @escaping (SdkResult<DeleteBotChannelAssociationOutput, DeleteBotChannelAssociationOutputError>) -> Void)
    {
        guard let botName = input.botName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBotChannelAssociationInput, DeleteBotChannelAssociationOutput, DeleteBotChannelAssociationOutputError>(id: "deleteBotChannelAssociation")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBotChannelAssociationInput, DeleteBotChannelAssociationOutput, DeleteBotChannelAssociationOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func deleteIntentVersion(input: DeleteIntentVersionInput, completion: @escaping (SdkResult<DeleteIntentVersionOutput, DeleteIntentVersionOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteIntentVersionInput, DeleteIntentVersionOutput, DeleteIntentVersionOutputError>(id: "deleteIntentVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteIntentVersionInput, DeleteIntentVersionOutput, DeleteIntentVersionOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func deleteSlotTypeVersion(input: DeleteSlotTypeVersionInput, completion: @escaping (SdkResult<DeleteSlotTypeVersionOutput, DeleteSlotTypeVersionOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteSlotTypeVersionInput, DeleteSlotTypeVersionOutput, DeleteSlotTypeVersionOutputError>(id: "deleteSlotTypeVersion")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteSlotTypeVersionInput, DeleteSlotTypeVersionOutput, DeleteSlotTypeVersionOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func deleteUtterances(input: DeleteUtterancesInput, completion: @escaping (SdkResult<DeleteUtterancesOutput, DeleteUtterancesOutputError>) -> Void)
    {
        guard let botName = input.botName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteUtterancesInput, DeleteUtterancesOutput, DeleteUtterancesOutputError>(id: "deleteUtterances")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteUtterancesInput, DeleteUtterancesOutput, DeleteUtterancesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getBotAlias(input: GetBotAliasInput, completion: @escaping (SdkResult<GetBotAliasOutput, GetBotAliasOutputError>) -> Void)
    {
        guard let botName = input.botName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBotAliasInput, GetBotAliasOutput, GetBotAliasOutputError>(id: "getBotAlias")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBotAliasInput, GetBotAliasOutput, GetBotAliasOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getBotAliases(input: GetBotAliasesInput, completion: @escaping (SdkResult<GetBotAliasesOutput, GetBotAliasesOutputError>) -> Void)
    {
        guard let botName = input.botName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBotAliasesInput, GetBotAliasesOutput, GetBotAliasesOutputError>(id: "getBotAliases")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBotAliasesInput, GetBotAliasesOutput, GetBotAliasesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getBotChannelAssociation(input: GetBotChannelAssociationInput, completion: @escaping (SdkResult<GetBotChannelAssociationOutput, GetBotChannelAssociationOutputError>) -> Void)
    {
        guard let botName = input.botName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBotChannelAssociationInput, GetBotChannelAssociationOutput, GetBotChannelAssociationOutputError>(id: "getBotChannelAssociation")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBotChannelAssociationInput, GetBotChannelAssociationOutput, GetBotChannelAssociationOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       action.</p>
    public func getBotChannelAssociations(input: GetBotChannelAssociationsInput, completion: @escaping (SdkResult<GetBotChannelAssociationsOutput, GetBotChannelAssociationsOutputError>) -> Void)
    {
        guard let botName = input.botName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBotChannelAssociationsInput, GetBotChannelAssociationsOutput, GetBotChannelAssociationsOutputError>(id: "getBotChannelAssociations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBotChannelAssociationsInput, GetBotChannelAssociationsOutput, GetBotChannelAssociationsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getBotVersions(input: GetBotVersionsInput, completion: @escaping (SdkResult<GetBotVersionsOutput, GetBotVersionsOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBotVersionsInput, GetBotVersionsOutput, GetBotVersionsOutputError>(id: "getBotVersions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBotVersionsInput, GetBotVersionsOutput, GetBotVersionsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       action.</p>
    public func getBots(input: GetBotsInput, completion: @escaping (SdkResult<GetBotsOutput, GetBotsOutputError>) -> Void)
    {
        let urlPath = "/bots"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBotsInput, GetBotsOutput, GetBotsOutputError>(id: "getBots")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBotsInput, GetBotsOutput, GetBotsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getBuiltinIntent(input: GetBuiltinIntentInput, completion: @escaping (SdkResult<GetBuiltinIntentOutput, GetBuiltinIntentOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBuiltinIntentInput, GetBuiltinIntentOutput, GetBuiltinIntentOutputError>(id: "getBuiltinIntent")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBuiltinIntentInput, GetBuiltinIntentOutput, GetBuiltinIntentOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getBuiltinIntents(input: GetBuiltinIntentsInput, completion: @escaping (SdkResult<GetBuiltinIntentsOutput, GetBuiltinIntentsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBuiltinIntentsInput, GetBuiltinIntentsOutput, GetBuiltinIntentsOutputError>(id: "getBuiltinIntents")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBuiltinIntentsInput, GetBuiltinIntentsOutput, GetBuiltinIntentsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getBuiltinSlotTypes(input: GetBuiltinSlotTypesInput, completion: @escaping (SdkResult<GetBuiltinSlotTypesOutput, GetBuiltinSlotTypesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBuiltinSlotTypesInput, GetBuiltinSlotTypesOutput, GetBuiltinSlotTypesOutputError>(id: "getBuiltinSlotTypes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBuiltinSlotTypesInput, GetBuiltinSlotTypesOutput, GetBuiltinSlotTypesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///     </p>
    public func getExport(input: GetExportInput, completion: @escaping (SdkResult<GetExportOutput, GetExportOutputError>) -> Void)
    {
        let urlPath = "/exports"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetExportInput, GetExportOutput, GetExportOutputError>(id: "getExport")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetExportInput, GetExportOutput, GetExportOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getImport(input: GetImportInput, completion: @escaping (SdkResult<GetImportOutput, GetImportOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetImportInput, GetImportOutput, GetImportOutputError>(id: "getImport")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetImportInput, GetImportOutput, GetImportOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getIntent(input: GetIntentInput, completion: @escaping (SdkResult<GetIntentOutput, GetIntentOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetIntentInput, GetIntentOutput, GetIntentOutputError>(id: "getIntent")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetIntentInput, GetIntentOutput, GetIntentOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getIntentVersions(input: GetIntentVersionsInput, completion: @escaping (SdkResult<GetIntentVersionsOutput, GetIntentVersionsOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetIntentVersionsInput, GetIntentVersionsOutput, GetIntentVersionsOutputError>(id: "getIntentVersions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetIntentVersionsInput, GetIntentVersionsOutput, GetIntentVersionsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getIntents(input: GetIntentsInput, completion: @escaping (SdkResult<GetIntentsOutput, GetIntentsOutputError>) -> Void)
    {
        let urlPath = "/intents"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetIntentsInput, GetIntentsOutput, GetIntentsOutputError>(id: "getIntents")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetIntentsInput, GetIntentsOutput, GetIntentsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getSlotType(input: GetSlotTypeInput, completion: @escaping (SdkResult<GetSlotTypeOutput, GetSlotTypeOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSlotTypeInput, GetSlotTypeOutput, GetSlotTypeOutputError>(id: "getSlotType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSlotTypeInput, GetSlotTypeOutput, GetSlotTypeOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getSlotTypeVersions(input: GetSlotTypeVersionsInput, completion: @escaping (SdkResult<GetSlotTypeVersionsOutput, GetSlotTypeVersionsOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSlotTypeVersionsInput, GetSlotTypeVersionsOutput, GetSlotTypeVersionsOutputError>(id: "getSlotTypeVersions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSlotTypeVersionsInput, GetSlotTypeVersionsOutput, GetSlotTypeVersionsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getSlotTypes(input: GetSlotTypesInput, completion: @escaping (SdkResult<GetSlotTypesOutput, GetSlotTypesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSlotTypesInput, GetSlotTypesOutput, GetSlotTypesOutputError>(id: "getSlotTypes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSlotTypesInput, GetSlotTypesOutput, GetSlotTypesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getUtterancesView(input: GetUtterancesViewInput, completion: @escaping (SdkResult<GetUtterancesViewOutput, GetUtterancesViewOutputError>) -> Void)
    {
        guard let botName = input.botName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetUtterancesViewInput, GetUtterancesViewOutput, GetUtterancesViewOutputError>(id: "getUtterancesView")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetUtterancesViewInput, GetUtterancesViewOutput, GetUtterancesViewOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func putBot(input: PutBotInput, completion: @escaping (SdkResult<PutBotOutput, PutBotOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBotInput, PutBotOutput, PutBotOutputError>(id: "putBot")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBotInput, PutBotOutput, PutBotOutputError>(contentType: "application/json"))
    ...
    public func putBotAlias(input: PutBotAliasInput, completion: @escaping (SdkResult<PutBotAliasOutput, PutBotAliasOutputError>) -> Void)
    {
        guard let botName = input.botName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBotAliasInput, PutBotAliasOutput, PutBotAliasOutputError>(id: "putBotAlias")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBotAliasInput, PutBotAliasOutput, PutBotAliasOutputError>(contentType: "application/json"))
    ...
    public func putIntent(input: PutIntentInput, completion: @escaping (SdkResult<PutIntentOutput, PutIntentOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutIntentInput, PutIntentOutput, PutIntentOutputError>(id: "putIntent")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutIntentInput, PutIntentOutput, PutIntentOutputError>(contentType: "application/json"))
    ...
    public func putSlotType(input: PutSlotTypeInput, completion: @escaping (SdkResult<PutSlotTypeOutput, PutSlotTypeOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutSlotTypeInput, PutSlotTypeOutput, PutSlotTypeOutputError>(id: "putSlotType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutSlotTypeInput, PutSlotTypeOutput, PutSlotTypeOutputError>(contentType: "application/json"))
