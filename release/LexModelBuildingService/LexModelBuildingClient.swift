...
extension LexModelBuildingClient: LexModelBuildingClientProtocol {
    ...
    public func getMigration(input: GetMigrationInput, completion: @escaping (ClientRuntime.SdkResult<GetMigrationOutputResponse, GetMigrationOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetMigrationInput, GetMigrationOutputResponse, GetMigrationOutputError>(id: "getMigration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetMigrationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetMigrationInputQueryItemMiddleware())
    ...
    public func getMigrations(input: GetMigrationsInput, completion: @escaping (ClientRuntime.SdkResult<GetMigrationsOutputResponse, GetMigrationsOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetMigrationsInput, GetMigrationsOutputResponse, GetMigrationsOutputError>(id: "getMigrations")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetMigrationsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetMigrationsInputQueryItemMiddleware())
