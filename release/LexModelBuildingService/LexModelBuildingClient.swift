...
public class LexModelBuildingClient {
    ...
    public class LexModelBuildingClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("LexModelBuildingClient")
