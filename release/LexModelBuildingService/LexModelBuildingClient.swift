...
public class LexModelBuildingClient {
    ...
    let config: LexModelBuildingClientConfiguration
    let serviceName = "Lex Model Building"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: LexModelBuildingClientConfiguration) {
    ...
    public class LexModelBuildingClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "LexModelBuildingClient")
        }
        ...
        public static func `default`() throws -> LexModelBuildingClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try LexModelBuildingClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}

public struct LexModelBuildingClientLogHandlerFactory: SDKLogHandlerFactory {
