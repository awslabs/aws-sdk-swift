...
public protocol LexModelBuildingServiceClientProtocol {
    ...
    func createBotVersion(input: CreateBotVersionInput, completion: @escaping (SdkResult<CreateBotVersionOutput, CreateBotVersionOutputError>) -> Void)
    ...
    func createIntentVersion(input: CreateIntentVersionInput, completion: @escaping (SdkResult<CreateIntentVersionOutput, CreateIntentVersionOutputError>) -> Void)
    ...
    func createSlotTypeVersion(input: CreateSlotTypeVersionInput, completion: @escaping (SdkResult<CreateSlotTypeVersionOutput, CreateSlotTypeVersionOutputError>) -> Void)
    ...
    func deleteBot(input: DeleteBotInput, completion: @escaping (SdkResult<DeleteBotOutput, DeleteBotOutputError>) -> Void)
    ...
    func deleteBotAlias(input: DeleteBotAliasInput, completion: @escaping (SdkResult<DeleteBotAliasOutput, DeleteBotAliasOutputError>) -> Void)
    /// <p>Deletes the association between an Amazon Lex bot and a messaging
    ///       platform.</p>
    ///          <p>This operation requires permission for the
    ///         <code>lex:DeleteBotChannelAssociation</code> action.</p>
    func deleteBotChannelAssociation(input: DeleteBotChannelAssociationInput, completion: @escaping (SdkResult<DeleteBotChannelAssociationOutput, DeleteBotChannelAssociationOutputError>) -> Void)
    ...
    func deleteBotVersion(input: DeleteBotVersionInput, completion: @escaping (SdkResult<DeleteBotVersionOutput, DeleteBotVersionOutputError>) -> Void)
    ...
    func deleteIntent(input: DeleteIntentInput, completion: @escaping (SdkResult<DeleteIntentOutput, DeleteIntentOutputError>) -> Void)
    ...
    func deleteIntentVersion(input: DeleteIntentVersionInput, completion: @escaping (SdkResult<DeleteIntentVersionOutput, DeleteIntentVersionOutputError>) -> Void)
    ...
    func deleteSlotType(input: DeleteSlotTypeInput, completion: @escaping (SdkResult<DeleteSlotTypeOutput, DeleteSlotTypeOutputError>) -> Void)
    ...
    func deleteSlotTypeVersion(input: DeleteSlotTypeVersionInput, completion: @escaping (SdkResult<DeleteSlotTypeVersionOutput, DeleteSlotTypeVersionOutputError>) -> Void)
    ...
    func deleteUtterances(input: DeleteUtterancesInput, completion: @escaping (SdkResult<DeleteUtterancesOutput, DeleteUtterancesOutputError>) -> Void)
    ...
    func getBot(input: GetBotInput, completion: @escaping (SdkResult<GetBotOutput, GetBotOutputError>) -> Void)
    ...
    func getBotAlias(input: GetBotAliasInput, completion: @escaping (SdkResult<GetBotAliasOutput, GetBotAliasOutputError>) -> Void)
    /// <p>Returns a list of aliases for a specified Amazon Lex bot.</p>
    ///          <p>This operation requires permissions for the
    ///         <code>lex:GetBotAliases</code> action.</p>
    func getBotAliases(input: GetBotAliasesInput, completion: @escaping (SdkResult<GetBotAliasesOutput, GetBotAliasesOutputError>) -> Void)
    ...
    func getBotChannelAssociation(input: GetBotChannelAssociationInput, completion: @escaping (SdkResult<GetBotChannelAssociationOutput, GetBotChannelAssociationOutputError>) -> Void)
    ...
    ///       action.</p>
    func getBotChannelAssociations(input: GetBotChannelAssociationsInput, completion: @escaping (SdkResult<GetBotChannelAssociationsOutput, GetBotChannelAssociationsOutputError>) -> Void)
    ...
    ///       action.</p>
    func getBots(input: GetBotsInput, completion: @escaping (SdkResult<GetBotsOutput, GetBotsOutputError>) -> Void)
    ...
    func getBotVersions(input: GetBotVersionsInput, completion: @escaping (SdkResult<GetBotVersionsOutput, GetBotVersionsOutputError>) -> Void)
    /// <p>Returns information about a built-in intent.</p>
    ///          <p>This operation requires permission for the
    ///         <code>lex:GetBuiltinIntent</code> action.</p>
    func getBuiltinIntent(input: GetBuiltinIntentInput, completion: @escaping (SdkResult<GetBuiltinIntentOutput, GetBuiltinIntentOutputError>) -> Void)
    /// <p>Gets a list of built-in intents that meet the specified
    ///       criteria.</p>
    ///          <p>This operation requires permission for the
    ///         <code>lex:GetBuiltinIntents</code> action.</p>
    func getBuiltinIntents(input: GetBuiltinIntentsInput, completion: @escaping (SdkResult<GetBuiltinIntentsOutput, GetBuiltinIntentsOutputError>) -> Void)
    ...
    func getBuiltinSlotTypes(input: GetBuiltinSlotTypesInput, completion: @escaping (SdkResult<GetBuiltinSlotTypesOutput, GetBuiltinSlotTypesOutputError>) -> Void)
    /// <p>Exports the contents of a Amazon Lex resource in a specified format.
    ///     </p>
    func getExport(input: GetExportInput, completion: @escaping (SdkResult<GetExportOutput, GetExportOutputError>) -> Void)
    /// <p>Gets information about an import job started with the
    ///         <code>StartImport</code> operation.</p>
    func getImport(input: GetImportInput, completion: @escaping (SdkResult<GetImportOutput, GetImportOutputError>) -> Void)
    ...
    func getIntent(input: GetIntentInput, completion: @escaping (SdkResult<GetIntentOutput, GetIntentOutputError>) -> Void)
    ...
    func getIntents(input: GetIntentsInput, completion: @escaping (SdkResult<GetIntentsOutput, GetIntentsOutputError>) -> Void)
    ...
    func getIntentVersions(input: GetIntentVersionsInput, completion: @escaping (SdkResult<GetIntentVersionsOutput, GetIntentVersionsOutputError>) -> Void)
    ...
    func getSlotType(input: GetSlotTypeInput, completion: @escaping (SdkResult<GetSlotTypeOutput, GetSlotTypeOutputError>) -> Void)
    ...
    func getSlotTypes(input: GetSlotTypesInput, completion: @escaping (SdkResult<GetSlotTypesOutput, GetSlotTypesOutputError>) -> Void)
    ...
    func getSlotTypeVersions(input: GetSlotTypeVersionsInput, completion: @escaping (SdkResult<GetSlotTypeVersionsOutput, GetSlotTypeVersionsOutputError>) -> Void)
    ...
    func getUtterancesView(input: GetUtterancesViewInput, completion: @escaping (SdkResult<GetUtterancesViewOutput, GetUtterancesViewOutputError>) -> Void)
    ...
    func putBot(input: PutBotInput, completion: @escaping (SdkResult<PutBotOutput, PutBotOutputError>) -> Void)
    ...
    func putBotAlias(input: PutBotAliasInput, completion: @escaping (SdkResult<PutBotAliasOutput, PutBotAliasOutputError>) -> Void)
    ...
    func putIntent(input: PutIntentInput, completion: @escaping (SdkResult<PutIntentOutput, PutIntentOutputError>) -> Void)
    ...
    func putSlotType(input: PutSlotTypeInput, completion: @escaping (SdkResult<PutSlotTypeOutput, PutSlotTypeOutputError>) -> Void)
    /// <p>Starts a job to import a resource to Amazon Lex.</p>
    func startImport(input: StartImportInput, completion: @escaping (SdkResult<StartImportOutput, StartImportOutputError>) -> Void)
