...
public struct GetMigrationsInput: Swift.Equatable {
    ...
    public let migrationStatusEquals: LexModelBuildingClientTypes.MigrationStatus?
    ...
    ///       started.
    public let sortByAttribute: LexModelBuildingClientTypes.MigrationSortAttribute?
    /// The order so sort the list.
    public let sortByOrder: LexModelBuildingClientTypes.SortOrder?
    /// Filters the list to contain only bots whose name contains the
    ///       specified string. The string is matched anywhere in bot name.
    public let v1BotNameContains: Swift.String?
...
extension LexModelBuildingClientTypes {
    ...
    public struct MigrationAlert: Swift.Equatable {
        ...
        ///
        ///
        public let type: LexModelBuildingClientTypes.MigrationAlertType?
