...
extension AcmPcaClientTypes {
    ...
    public struct ASN1Subject: Swift.Equatable {
        ...
        public let distinguishedNameQualifier: Swift.String?
        ...
        public let generationQualifier: Swift.String?
        /// <p>First name.</p>
        ...
        public let initials: Swift.String?
...
extension AcmPcaClientTypes {
    ...
    public struct AccessDescription: Swift.Equatable {
        ...
        public let accessLocation: AcmPcaClientTypes.GeneralName?
        /// <p>The type and format of <code>AccessDescription</code> information.</p>
        public let accessMethod: AcmPcaClientTypes.AccessMethod?
...
extension AcmPcaClientTypes {
    ...
    public struct AccessMethod: Swift.Equatable {
        ...
        public let accessMethodType: AcmPcaClientTypes.AccessMethodType?
        ...
        /// 				(OID)</a>.</p>
        public let customObjectIdentifier: Swift.String?
...
extension AcmPcaClientTypes {
    ...
    public struct ApiPassthrough: Swift.Equatable {
        ...
        public let extensions: AcmPcaClientTypes.Extensions?
        /// <p>Contains information about the certificate subject. The <code>Subject</code> field in
        /// 			the certificate identifies the entity that owns or controls the public key in the
        /// 			certificate. The entity can be a user, computer, device, or service. The <code>Subject
        /// 			</code>must contain an X.500 distinguished name (DN). A DN is a sequence of relative
        /// 			distinguished names (RDNs). The RDNs are separated by commas in the certificate.</p>
        public let subject: AcmPcaClientTypes.ASN1Subject?
...
extension AcmPcaClientTypes {
    ...
    public struct CertificateAuthority: Swift.Equatable {
        ...
        public let failureReason: AcmPcaClientTypes.FailureReason?
        ...
        public let lastStateChangeAt: ClientRuntime.Date?
        ...
        public let restorableUntil: ClientRuntime.Date?
        ...
        public let type: AcmPcaClientTypes.CertificateAuthorityType?
...
extension AcmPcaClientTypes {
    ...
    public struct CertificateAuthorityConfiguration: Swift.Equatable {
        ...
        /// 			request (CSR).</p>
        public let csrExtensions: AcmPcaClientTypes.CsrExtensions?
        ...
        public let keyAlgorithm: AcmPcaClientTypes.KeyAlgorithm?
...
extension CertificateMismatchException: AWSClientRuntime.AWSHttpServiceError {
...
public struct CertificateMismatchException: ClientRuntime.ServiceError, Swift.Equatable {
...
extension AcmPcaClientTypes {
    ...
    public struct CrlConfiguration: Swift.Equatable {
        ...
        /// 			public.</p>
        public let customCname: Swift.String?
        ...
        /// 				bucket</a>.</p>
        public let s3ObjectAcl: AcmPcaClientTypes.S3ObjectAcl?
...
extension AcmPcaClientTypes {
    ...
    public struct CsrExtensions: Swift.Equatable {
        ...
        /// 			certificate.</p>
        public let keyUsage: AcmPcaClientTypes.KeyUsage?
        ...
        public let subjectInformationAccess: [AcmPcaClientTypes.AccessDescription]?
...
extension AcmPcaClientTypes {
    ...
    public struct EdiPartyName: Swift.Equatable {
        ...
        public let nameAssigner: Swift.String?
        /// <p>Specifies the party name.</p>
        public let partyName: Swift.String?
...
extension AcmPcaClientTypes {
    ...
    public struct ExtendedKeyUsage: Swift.Equatable {
        ...
        /// 			(OID).</p>
        public let extendedKeyUsageObjectIdentifier: Swift.String?
        ...
        public let extendedKeyUsageType: AcmPcaClientTypes.ExtendedKeyUsageType?
...
extension AcmPcaClientTypes {
    ...
    public struct Extensions: Swift.Equatable {
        ...
        /// 			certificate.</p>
        public let certificatePolicies: [AcmPcaClientTypes.PolicyInformation]?
        /// <p>Specifies additional purposes for which the certified public key may be used other
        /// 			than basic purposes indicated in the <code>KeyUsage</code> extension.</p>
        public let extendedKeyUsage: [AcmPcaClientTypes.ExtendedKeyUsage]?
        ...
        public let subjectAlternativeNames: [AcmPcaClientTypes.GeneralName]?
...
extension AcmPcaClientTypes {
    ...
    public struct GeneralName: Swift.Equatable {
        ...
        /// 			</code>must contain an X.500 distinguished name (DN). A DN is a sequence of relative
        /// 			distinguished names (RDNs). The RDNs are separated by commas in the certificate.</p>
        public let directoryName: AcmPcaClientTypes.ASN1Subject?
        ...
        public let ediPartyName: AcmPcaClientTypes.EdiPartyName?
...
extension LockoutPreventedException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct LockoutPreventedException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension MalformedCSRException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct MalformedCSRException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension MalformedCertificateException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct MalformedCertificateException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension PermissionAlreadyExistsException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct PermissionAlreadyExistsException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension AcmPcaClientTypes {
    ...
    public struct PolicyInformation: Swift.Equatable {
        ...
        /// 				(OID)</a>.</p>
        public let certPolicyId: Swift.String?
        ...
        public let policyQualifiers: [AcmPcaClientTypes.PolicyQualifierInfo]?
...
extension AcmPcaClientTypes {
    ...
    public struct PolicyQualifierInfo: Swift.Equatable {
        ...
        public let policyQualifierId: AcmPcaClientTypes.PolicyQualifierId?
        /// <p>Defines the qualifier type. ACM Private CA supports the use of a URI for a CPS qualifier in
        /// 			this field.</p>
        public let qualifier: AcmPcaClientTypes.Qualifier?
...
extension AcmPcaClientTypes {
    ...
    public struct Qualifier: Swift.Equatable {
        ...
        /// 			CA.</p>
        public let cpsUri: Swift.String?
...
extension RequestAlreadyProcessedException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct RequestAlreadyProcessedException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension AcmPcaClientTypes.RevocationConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RevocationConfiguration(crlConfiguration: \(Swift.String(describing: crlConfiguration)))"}
}
...
extension AcmPcaClientTypes {
    ...
    public struct RevocationConfiguration: Swift.Equatable {
        ...
        /// 			private CA.</p>
        public let crlConfiguration: AcmPcaClientTypes.CrlConfiguration?
...
extension AcmPcaClientTypes {
    ...
    public struct Validity: Swift.Equatable {
        ...
        public let type: AcmPcaClientTypes.ValidityPeriodType?
