...
extension AcmPcaClient: AcmPcaClientProtocol {
    ...
    ///                 </note>
    public func createCertificateAuthority(input: CreateCertificateAuthorityInput, completion: @escaping (SdkResult<CreateCertificateAuthorityOutput, CreateCertificateAuthorityOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<CreateCertificateAuthorityInput, CreateCertificateAuthorityOutput, CreateCertificateAuthorityOutputError>(id: "createCertificateAuthority")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateCertificateAuthorityInput, CreateCertificateAuthorityOutput, CreateCertificateAuthorityOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateCertificateAuthorityInput, CreateCertificateAuthorityOutput, CreateCertificateAuthorityOutputError>(xAmzTarget: "ACMPrivateCA.CreateCertificateAuthority"))
    ...
    /// 				Reports</a>.</p>
    public func createCertificateAuthorityAuditReport(input: CreateCertificateAuthorityAuditReportInput, completion: @escaping (SdkResult<CreateCertificateAuthorityAuditReportOutput, CreateCertificateAuthorityAuditReportOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateCertificateAuthorityAuditReportInput, CreateCertificateAuthorityAuditReportOutput, CreateCertificateAuthorityAuditReportOutputError>(id: "createCertificateAuthorityAuditReport")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateCertificateAuthorityAuditReportInput, CreateCertificateAuthorityAuditReportOutput, CreateCertificateAuthorityAuditReportOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateCertificateAuthorityAuditReportInput, CreateCertificateAuthorityAuditReportOutput, CreateCertificateAuthorityAuditReportOutputError>(xAmzTarget: "ACMPrivateCA.CreateCertificateAuthorityAuditReport"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 		          </li>
    ///          </ul>
    public func createPermission(input: CreatePermissionInput, completion: @escaping (SdkResult<CreatePermissionOutput, CreatePermissionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreatePermissionInput, CreatePermissionOutput, CreatePermissionOutputError>(id: "createPermission")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreatePermissionInput, CreatePermissionOutput, CreatePermissionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreatePermissionInput, CreatePermissionOutput, CreatePermissionOutputError>(xAmzTarget: "ACMPrivateCA.CreatePermission"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteCertificateAuthority(input: DeleteCertificateAuthorityInput, completion: @escaping (SdkResult<DeleteCertificateAuthorityOutput, DeleteCertificateAuthorityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteCertificateAuthorityInput, DeleteCertificateAuthorityOutput, DeleteCertificateAuthorityOutputError>(id: "deleteCertificateAuthority")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteCertificateAuthorityInput, DeleteCertificateAuthorityOutput, DeleteCertificateAuthorityOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteCertificateAuthorityInput, DeleteCertificateAuthorityOutput, DeleteCertificateAuthorityOutputError>(xAmzTarget: "ACMPrivateCA.DeleteCertificateAuthority"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 		          </li>
    ///          </ul>
    public func deletePermission(input: DeletePermissionInput, completion: @escaping (SdkResult<DeletePermissionOutput, DeletePermissionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeletePermissionInput, DeletePermissionOutput, DeletePermissionOutputError>(id: "deletePermission")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeletePermissionInput, DeletePermissionOutput, DeletePermissionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeletePermissionInput, DeletePermissionOutput, DeletePermissionOutputError>(xAmzTarget: "ACMPrivateCA.DeletePermission"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deletePolicy(input: DeletePolicyInput, completion: @escaping (SdkResult<DeletePolicyOutput, DeletePolicyOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeletePolicyInput, DeletePolicyOutput, DeletePolicyOutputError>(xAmzTarget: "ACMPrivateCA.DeletePolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 			         </li>
    ///          </ul>
    public func describeCertificateAuthority(input: DescribeCertificateAuthorityInput, completion: @escaping (SdkResult<DescribeCertificateAuthorityOutput, DescribeCertificateAuthorityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCertificateAuthorityInput, DescribeCertificateAuthorityOutput, DescribeCertificateAuthorityOutputError>(id: "describeCertificateAuthority")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCertificateAuthorityInput, DescribeCertificateAuthorityOutput, DescribeCertificateAuthorityOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeCertificateAuthorityInput, DescribeCertificateAuthorityOutput, DescribeCertificateAuthorityOutputError>(xAmzTarget: "ACMPrivateCA.DescribeCertificateAuthority"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeCertificateAuthorityAuditReport(input: DescribeCertificateAuthorityAuditReportInput, completion: @escaping (SdkResult<DescribeCertificateAuthorityAuditReportOutput, DescribeCertificateAuthorityAuditReportOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCertificateAuthorityAuditReportInput, DescribeCertificateAuthorityAuditReportOutput, DescribeCertificateAuthorityAuditReportOutputError>(id: "describeCertificateAuthorityAuditReport")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCertificateAuthorityAuditReportInput, DescribeCertificateAuthorityAuditReportOutput, DescribeCertificateAuthorityAuditReportOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeCertificateAuthorityAuditReportInput, DescribeCertificateAuthorityAuditReportOutput, DescribeCertificateAuthorityAuditReportOutputError>(xAmzTarget: "ACMPrivateCA.DescribeCertificateAuthorityAuditReport"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getCertificate(input: GetCertificateInput, completion: @escaping (SdkResult<GetCertificateOutput, GetCertificateOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetCertificateInput, GetCertificateOutput, GetCertificateOutputError>(xAmzTarget: "ACMPrivateCA.GetCertificate"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getCertificateAuthorityCertificate(input: GetCertificateAuthorityCertificateInput, completion: @escaping (SdkResult<GetCertificateAuthorityCertificateOutput, GetCertificateAuthorityCertificateOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCertificateAuthorityCertificateInput, GetCertificateAuthorityCertificateOutput, GetCertificateAuthorityCertificateOutputError>(id: "getCertificateAuthorityCertificate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCertificateAuthorityCertificateInput, GetCertificateAuthorityCertificateOutput, GetCertificateAuthorityCertificateOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetCertificateAuthorityCertificateInput, GetCertificateAuthorityCertificateOutput, GetCertificateAuthorityCertificateOutputError>(xAmzTarget: "ACMPrivateCA.GetCertificateAuthorityCertificate"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getCertificateAuthorityCsr(input: GetCertificateAuthorityCsrInput, completion: @escaping (SdkResult<GetCertificateAuthorityCsrOutput, GetCertificateAuthorityCsrOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCertificateAuthorityCsrInput, GetCertificateAuthorityCsrOutput, GetCertificateAuthorityCsrOutputError>(id: "getCertificateAuthorityCsr")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCertificateAuthorityCsrInput, GetCertificateAuthorityCsrOutput, GetCertificateAuthorityCsrOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetCertificateAuthorityCsrInput, GetCertificateAuthorityCsrOutput, GetCertificateAuthorityCsrOutputError>(xAmzTarget: "ACMPrivateCA.GetCertificateAuthorityCsr"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getPolicy(input: GetPolicyInput, completion: @escaping (SdkResult<GetPolicyOutput, GetPolicyOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetPolicyInput, GetPolicyOutput, GetPolicyOutputError>(xAmzTarget: "ACMPrivateCA.GetPolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 			         </li>
    ///          </ul>
    public func importCertificateAuthorityCertificate(input: ImportCertificateAuthorityCertificateInput, completion: @escaping (SdkResult<ImportCertificateAuthorityCertificateOutput, ImportCertificateAuthorityCertificateOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ImportCertificateAuthorityCertificateInput, ImportCertificateAuthorityCertificateOutput, ImportCertificateAuthorityCertificateOutputError>(id: "importCertificateAuthorityCertificate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ImportCertificateAuthorityCertificateInput, ImportCertificateAuthorityCertificateOutput, ImportCertificateAuthorityCertificateOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ImportCertificateAuthorityCertificateInput, ImportCertificateAuthorityCertificateOutput, ImportCertificateAuthorityCertificateOutputError>(xAmzTarget: "ACMPrivateCA.ImportCertificateAuthorityCertificate"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 		       </note>
    public func issueCertificate(input: IssueCertificateInput, completion: @escaping (SdkResult<IssueCertificateOutput, IssueCertificateOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<IssueCertificateInput, IssueCertificateOutput, IssueCertificateOutputError>(id: "issueCertificate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<IssueCertificateInput, IssueCertificateOutput, IssueCertificateOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<IssueCertificateInput, IssueCertificateOutput, IssueCertificateOutputError>(xAmzTarget: "ACMPrivateCA.IssueCertificate"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listCertificateAuthorities(input: ListCertificateAuthoritiesInput, completion: @escaping (SdkResult<ListCertificateAuthoritiesOutput, ListCertificateAuthoritiesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListCertificateAuthoritiesInput, ListCertificateAuthoritiesOutput, ListCertificateAuthoritiesOutputError>(id: "listCertificateAuthorities")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListCertificateAuthoritiesInput, ListCertificateAuthoritiesOutput, ListCertificateAuthoritiesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListCertificateAuthoritiesInput, ListCertificateAuthoritiesOutput, ListCertificateAuthoritiesOutputError>(xAmzTarget: "ACMPrivateCA.ListCertificateAuthorities"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listPermissions(input: ListPermissionsInput, completion: @escaping (SdkResult<ListPermissionsOutput, ListPermissionsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListPermissionsInput, ListPermissionsOutput, ListPermissionsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListPermissionsInput, ListPermissionsOutput, ListPermissionsOutputError>(xAmzTarget: "ACMPrivateCA.ListPermissions"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTags(input: ListTagsInput, completion: @escaping (SdkResult<ListTagsOutput, ListTagsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTagsInput, ListTagsOutput, ListTagsOutputError>(xAmzTarget: "ACMPrivateCA.ListTags"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func putPolicy(input: PutPolicyInput, completion: @escaping (SdkResult<PutPolicyOutput, PutPolicyOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<PutPolicyInput, PutPolicyOutput, PutPolicyOutputError>(xAmzTarget: "ACMPrivateCA.PutPolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func restoreCertificateAuthority(input: RestoreCertificateAuthorityInput, completion: @escaping (SdkResult<RestoreCertificateAuthorityOutput, RestoreCertificateAuthorityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RestoreCertificateAuthorityInput, RestoreCertificateAuthorityOutput, RestoreCertificateAuthorityOutputError>(id: "restoreCertificateAuthority")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RestoreCertificateAuthorityInput, RestoreCertificateAuthorityOutput, RestoreCertificateAuthorityOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RestoreCertificateAuthorityInput, RestoreCertificateAuthorityOutput, RestoreCertificateAuthorityOutputError>(xAmzTarget: "ACMPrivateCA.RestoreCertificateAuthority"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 		       </note>
    public func revokeCertificate(input: RevokeCertificateInput, completion: @escaping (SdkResult<RevokeCertificateOutput, RevokeCertificateOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RevokeCertificateInput, RevokeCertificateOutput, RevokeCertificateOutputError>(id: "revokeCertificate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RevokeCertificateInput, RevokeCertificateOutput, RevokeCertificateOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RevokeCertificateInput, RevokeCertificateOutput, RevokeCertificateOutputError>(xAmzTarget: "ACMPrivateCA.RevokeCertificate"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func tagCertificateAuthority(input: TagCertificateAuthorityInput, completion: @escaping (SdkResult<TagCertificateAuthorityOutput, TagCertificateAuthorityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<TagCertificateAuthorityInput, TagCertificateAuthorityOutput, TagCertificateAuthorityOutputError>(id: "tagCertificateAuthority")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<TagCertificateAuthorityInput, TagCertificateAuthorityOutput, TagCertificateAuthorityOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<TagCertificateAuthorityInput, TagCertificateAuthorityOutput, TagCertificateAuthorityOutputError>(xAmzTarget: "ACMPrivateCA.TagCertificateAuthority"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 			associated with your CA. </p>
    public func untagCertificateAuthority(input: UntagCertificateAuthorityInput, completion: @escaping (SdkResult<UntagCertificateAuthorityOutput, UntagCertificateAuthorityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UntagCertificateAuthorityInput, UntagCertificateAuthorityOutput, UntagCertificateAuthorityOutputError>(id: "untagCertificateAuthority")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UntagCertificateAuthorityInput, UntagCertificateAuthorityOutput, UntagCertificateAuthorityOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UntagCertificateAuthorityInput, UntagCertificateAuthorityOutput, UntagCertificateAuthorityOutputError>(xAmzTarget: "ACMPrivateCA.UntagCertificateAuthority"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///                         Access to ACM Private CA</a>.</p>
    ///                 </note>
    public func updateCertificateAuthority(input: UpdateCertificateAuthorityInput, completion: @escaping (SdkResult<UpdateCertificateAuthorityOutput, UpdateCertificateAuthorityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "acm-pca")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateCertificateAuthorityInput, UpdateCertificateAuthorityOutput, UpdateCertificateAuthorityOutputError>(id: "updateCertificateAuthority")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateCertificateAuthorityInput, UpdateCertificateAuthorityOutput, UpdateCertificateAuthorityOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateCertificateAuthorityInput, UpdateCertificateAuthorityOutput, UpdateCertificateAuthorityOutputError>(xAmzTarget: "ACMPrivateCA.UpdateCertificateAuthority"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
