...
public class AcmPcaClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try AcmPcaClientConfiguration(region: unwrappedRegion)
    ...
    public class AcmPcaClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("AcmPcaClient")
...
public struct AcmPcaClientLogHandlerFactory: SDKLogHandlerFactory {
