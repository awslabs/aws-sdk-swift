...
public extension AcmPcaClient {
    ...
    {
        typealias createCertificateAuthorityContinuation = CheckedContinuation<CreateCertificateAuthorityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createCertificateAuthorityContinuation) in
            createCertificateAuthority(input: input) { result in
                switch result {
    ...
    {
        typealias createCertificateAuthorityAuditReportContinuation = CheckedContinuation<CreateCertificateAuthorityAuditReportOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createCertificateAuthorityAuditReportContinuation) in
            createCertificateAuthorityAuditReport(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createPermissionContinuation = CheckedContinuation<CreatePermissionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createPermissionContinuation) in
            createPermission(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteCertificateAuthorityContinuation = CheckedContinuation<DeleteCertificateAuthorityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteCertificateAuthorityContinuation) in
            deleteCertificateAuthority(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deletePermissionContinuation = CheckedContinuation<DeletePermissionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deletePermissionContinuation) in
            deletePermission(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeCertificateAuthorityContinuation = CheckedContinuation<DescribeCertificateAuthorityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeCertificateAuthorityContinuation) in
            describeCertificateAuthority(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeCertificateAuthorityAuditReportContinuation = CheckedContinuation<DescribeCertificateAuthorityAuditReportOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeCertificateAuthorityAuditReportContinuation) in
            describeCertificateAuthorityAuditReport(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getCertificateAuthorityCertificateContinuation = CheckedContinuation<GetCertificateAuthorityCertificateOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getCertificateAuthorityCertificateContinuation) in
            getCertificateAuthorityCertificate(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getCertificateAuthorityCsrContinuation = CheckedContinuation<GetCertificateAuthorityCsrOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getCertificateAuthorityCsrContinuation) in
            getCertificateAuthorityCsr(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias importCertificateAuthorityCertificateContinuation = CheckedContinuation<ImportCertificateAuthorityCertificateOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: importCertificateAuthorityCertificateContinuation) in
            importCertificateAuthorityCertificate(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias issueCertificateContinuation = CheckedContinuation<IssueCertificateOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: issueCertificateContinuation) in
            issueCertificate(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listCertificateAuthoritiesContinuation = CheckedContinuation<ListCertificateAuthoritiesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listCertificateAuthoritiesContinuation) in
            listCertificateAuthorities(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias restoreCertificateAuthorityContinuation = CheckedContinuation<RestoreCertificateAuthorityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: restoreCertificateAuthorityContinuation) in
            restoreCertificateAuthority(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias revokeCertificateContinuation = CheckedContinuation<RevokeCertificateOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: revokeCertificateContinuation) in
            revokeCertificate(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias tagCertificateAuthorityContinuation = CheckedContinuation<TagCertificateAuthorityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: tagCertificateAuthorityContinuation) in
            tagCertificateAuthority(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias untagCertificateAuthorityContinuation = CheckedContinuation<UntagCertificateAuthorityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: untagCertificateAuthorityContinuation) in
            untagCertificateAuthority(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateCertificateAuthorityContinuation = CheckedContinuation<UpdateCertificateAuthorityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateCertificateAuthorityContinuation) in
            updateCertificateAuthority(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
