...
extension ResourceGroupsTaggingApiClientTypes {
    ...
    public struct ComplianceDetails: Swift.Equatable {
        ...
        public let complianceStatus: Swift.Bool?
        ...
        public let keysWithNoncompliantValues: [Swift.String]?
        /// <p>These tag keys on the resource are noncompliant with the effective tag policy.</p>
        public let noncompliantKeys: [Swift.String]?
...
extension ConstraintViolationException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
///             </li>
///          </ul>
public struct ConstraintViolationException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension ResourceGroupsTaggingApiClientTypes {
    ...
    public struct FailureInfo: Swift.Equatable {
        ...
        ///             to tag.</p>
        public let errorCode: ResourceGroupsTaggingApiClientTypes.ErrorCode?
...
extension PaginationTokenExpiredException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct PaginationTokenExpiredException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension ResourceGroupsTaggingApiClientTypes {
    ...
    public struct ResourceTagMapping: Swift.Equatable {
        /// <p>Information that shows whether a resource is compliant with the effective tag policy,
        ///             including details on any noncompliant tag keys.</p>
        public let complianceDetails: ResourceGroupsTaggingApiClientTypes.ComplianceDetails?
        /// <p>The ARN of the resource.</p>
        public let resourceARN: Swift.String?
        /// <p>The tags that have been applied to one or more AWS resources.</p>
        public let tags: [ResourceGroupsTaggingApiClientTypes.Tag]?
...
extension ResourceGroupsTaggingApiClientTypes {
    ...
    public struct Summary: Swift.Equatable {
        ...
        public let nonCompliantResources: Swift.Int
        ...
        public let targetIdType: ResourceGroupsTaggingApiClientTypes.TargetIdType?
