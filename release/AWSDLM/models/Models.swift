...
extension DlmClientTypes {
    ...
    public struct Action: Swift.Equatable {
        ...
        var crossRegionCopy: [DlmClientTypes.CrossRegionCopyAction]?
...
public struct CreateLifecyclePolicyInput: Swift.Equatable {
    ...
    /// This member is required.
    var policyDetails: DlmClientTypes.PolicyDetails?
    /// The desired activation state of the lifecycle policy after creation.
    /// This member is required.
    var state: DlmClientTypes.SettablePolicyStateValues?
...
extension DlmClientTypes {
    ...
    public struct CreateRule: Swift.Equatable {
        ...
        /// The interval unit.
        var intervalUnit: DlmClientTypes.IntervalUnitValues?
        ...
        var location: DlmClientTypes.LocationValues?
...
extension DlmClientTypes {
    ...
    public struct CrossRegionCopyAction: Swift.Equatable {
        ...
        /// This member is required.
        var encryptionConfiguration: DlmClientTypes.EncryptionConfiguration?
        /// Specifies the retention rule for cross-Region snapshot copies.
        var retainRule: DlmClientTypes.CrossRegionCopyRetainRule?
        /// The target Region.
        /// This member is required.
...
extension DlmClientTypes {
    ...
    public struct CrossRegionCopyDeprecateRule: Swift.Equatable {
        ...
        var intervalUnit: DlmClientTypes.RetentionIntervalUnitValues?
...
extension DlmClientTypes {
    ...
    public struct CrossRegionCopyRule: Swift.Equatable {
        ...
        var deprecateRule: DlmClientTypes.CrossRegionCopyDeprecateRule?
...
extension DlmClientTypes {
    ...
    public struct EventParameters: Swift.Equatable {
        ...
        /// This member is required.
        var descriptionRegex: Swift.String?
        /// The type of event. Currently, only snapshot sharing events are supported.
        /// This member is required.
        var eventType: DlmClientTypes.EventTypeValues?
        ...
        /// This member is required.
        var snapshotOwner: [Swift.String]?
...
extension DlmClientTypes {
    ...
    public struct EventSource: Swift.Equatable {
        ...
        var parameters: DlmClientTypes.EventParameters?
        /// The source of the event. Currently only managed CloudWatch Events rules are supported.
        /// This member is required.
        var type: DlmClientTypes.EventSourceValues?
...
public struct GetLifecyclePoliciesInput: Swift.Equatable {
    ...
    var policyIds: [Swift.String]?
    /// The resource type.
    var resourceTypes: [DlmClientTypes.ResourceTypeValues]?
    /// The activation state.
    var state: DlmClientTypes.GettablePolicyStateValues?
...
public struct GetLifecyclePoliciesOutputResponse: Swift.Equatable {
    ...
    var policies: [DlmClientTypes.LifecyclePolicySummary]?
...
public struct GetLifecyclePolicyOutputResponse: Swift.Equatable {
    ...
    var policy: DlmClientTypes.LifecyclePolicy?
...
extension DlmClientTypes {
    ...
    public struct LifecyclePolicySummary: Swift.Equatable {
        ...
        var policyType: DlmClientTypes.PolicyTypeValues?
        /// The activation state of the lifecycle policy.
        var state: DlmClientTypes.GettablePolicyStateValues?
        /// The tags.
        var tags: [Swift.String:Swift.String]?
...
extension DlmClientTypes {
    ...
    public struct PolicyDetails: Swift.Equatable {
        ...
        var actions: [DlmClientTypes.Action]?
        ...
        var eventSource: DlmClientTypes.EventSource?
        ...
        var parameters: DlmClientTypes.Parameters?
        ...
        var resourceLocations: [DlmClientTypes.ResourceLocationValues]?
        ...
        var schedules: [DlmClientTypes.Schedule]?
        ...
        var targetTags: [DlmClientTypes.Tag]?
...
extension DlmClientTypes {
    ...
    public struct Schedule: Swift.Equatable {
        ...
        var copyTags: Swift.Bool
        /// The creation rule.
        var createRule: DlmClientTypes.CreateRule?
        ...
        var crossRegionCopyRules: [DlmClientTypes.CrossRegionCopyRule]?
        /// The AMI deprecation rule for the schedule.
        var deprecateRule: DlmClientTypes.DeprecateRule?
        /// The rule for enabling fast snapshot restore.
        var fastRestoreRule: DlmClientTypes.FastRestoreRule?
        /// The name of the schedule.
        var name: Swift.String?
        /// The retention rule.
        var retainRule: DlmClientTypes.RetainRule?
        /// The rule for sharing snapshots with other Amazon Web Services accounts.
        var shareRules: [DlmClientTypes.ShareRule]?
        ...
        var tagsToAdd: [DlmClientTypes.Tag]?
        /// A collection of key/value pairs with values determined dynamically when the policy is executed. Keys may be any valid Amazon EC2 tag key. Values must be in one of the two following formats: $(instance-id) or $(timestamp). Variable tags are only valid for EBS Snapshot Management – Instance policies.
        var variableTags: [DlmClientTypes.Tag]?
...
extension DlmClientTypes {
    ...
    public struct ShareRule: Swift.Equatable {
        ...
        /// This member is required.
        var targetAccounts: [Swift.String]?
        /// The period after which snapshots that are shared with other Amazon Web Services accounts are automatically unshared.
        var unshareInterval: Swift.Int
        /// The unit of time for the automatic unsharing interval.
        var unshareIntervalUnit: DlmClientTypes.RetentionIntervalUnitValues?
