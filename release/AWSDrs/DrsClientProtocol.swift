...
public protocol DrsClientProtocol {
    ...
    func deleteRecoveryInstance(input: DeleteRecoveryInstanceInput, completion: @escaping (ClientRuntime.SdkResult<DeleteRecoveryInstanceOutputResponse, DeleteRecoveryInstanceOutputError>) -> Void)
    ...
    func describeRecoveryInstances(input: DescribeRecoveryInstancesInput, completion: @escaping (ClientRuntime.SdkResult<DescribeRecoveryInstancesOutputResponse, DescribeRecoveryInstancesOutputError>) -> Void)
    /// Lists all Recovery Snapshots for a single Source Server.
    func describeRecoverySnapshots(input: DescribeRecoverySnapshotsInput, completion: @escaping (ClientRuntime.SdkResult<DescribeRecoverySnapshotsOutputResponse, DescribeRecoverySnapshotsOutputError>) -> Void)
    ...
    func disconnectRecoveryInstance(input: DisconnectRecoveryInstanceInput, completion: @escaping (ClientRuntime.SdkResult<DisconnectRecoveryInstanceOutputResponse, DisconnectRecoveryInstanceOutputError>) -> Void)
    /// Disconnects a specific Source Server from Elastic Disaster Recovery. Data replication is stopped immediately. All AWS resources created by Elastic Disaster Recovery for enabling the replication of the Source Server will be terminated / deleted within 90 minutes. You cannot disconnect a Source Server if it has a Recovery Instance. If the agent on the Source Server has not been prevented from communicating with the Elastic Disaster Recovery service, then it will receive a command to uninstall itself (within approximately 10 minutes). The following properties of the SourceServer will be changed immediately: dataReplicationInfo.dataReplicationState will be set to DISCONNECTED; The totalStorageBytes property for each of dataReplicationInfo.replicatedDisks will be set to zero; dataReplicationInfo.lagDuration and dataReplicationInfo.lagDuration will be nullified.
    func disconnectSourceServer(input: DisconnectSourceServerInput, completion: @escaping (ClientRuntime.SdkResult<DisconnectSourceServerOutputResponse, DisconnectSourceServerOutputError>) -> Void)
    /// Lists all Failback ReplicationConfigurations, filtered by Recovery Instance ID.
    func getFailbackReplicationConfiguration(input: GetFailbackReplicationConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<GetFailbackReplicationConfigurationOutputResponse, GetFailbackReplicationConfigurationOutputError>) -> Void)
    ...
    func startFailbackLaunch(input: StartFailbackLaunchInput, completion: @escaping (ClientRuntime.SdkResult<StartFailbackLaunchOutputResponse, StartFailbackLaunchOutputError>) -> Void)
    /// Launches Recovery Instances for the specified Source Servers. For each Source Server you may choose a point in time snapshot to launch from, or use an on demand snapshot.
    func startRecovery(input: StartRecoveryInput, completion: @escaping (ClientRuntime.SdkResult<StartRecoveryOutputResponse, StartRecoveryOutputError>) -> Void)
    /// Stops the failback process for a specified Recovery Instance. This changes the Failback State of the Recovery Instance back to FAILBACK_NOT_STARTED.
    func stopFailback(input: StopFailbackInput, completion: @escaping (ClientRuntime.SdkResult<StopFailbackOutputResponse, StopFailbackOutputError>) -> Void)
    /// Adds or overwrites only the specified tags for the specified Elastic Disaster Recovery resource or resources. When you specify an existing tag key, the value is overwritten with the new value. Each resource can have a maximum of 50 tags. Each tag consists of a key and optional value.
    func tagResource(input: TagResourceInput, completion: @escaping (ClientRuntime.SdkResult<TagResourceOutputResponse, TagResourceOutputError>) -> Void)
    /// Initiates a Job for terminating the EC2 resources associated with the specified Recovery Instances, and then will delete the Recovery Instances from the Elastic Disaster Recovery service.
    func terminateRecoveryInstances(input: TerminateRecoveryInstancesInput, completion: @escaping (ClientRuntime.SdkResult<TerminateRecoveryInstancesOutputResponse, TerminateRecoveryInstancesOutputError>) -> Void)
    /// Deletes the specified set of tags from the specified set of Elastic Disaster Recovery resources.
    func untagResource(input: UntagResourceInput, completion: @escaping (ClientRuntime.SdkResult<UntagResourceOutputResponse, UntagResourceOutputError>) -> Void)
    /// Allows you to update the failback replication configuration of a Recovery Instance by ID.
    func updateFailbackReplicationConfiguration(input: UpdateFailbackReplicationConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<UpdateFailbackReplicationConfigurationOutputResponse, UpdateFailbackReplicationConfigurationOutputError>) -> Void)
