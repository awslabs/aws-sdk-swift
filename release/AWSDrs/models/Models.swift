...
public struct CreateReplicationConfigurationTemplateInput: Swift.Equatable {
    ...
    var associateDefaultSecurityGroup: Swift.Bool?
    /// Configure bandwidth throttling for the outbound data transfer rate of the Source Server in Mbps.
    /// This member is required.
    var bandwidthThrottling: Swift.Int
    /// Whether to create a Public IP for the Recovery Instance by default.
    /// This member is required.
    var createPublicIP: Swift.Bool?
    /// The data plane routing mechanism that will be used for replication.
    /// This member is required.
    var dataPlaneRouting: DrsClientTypes.ReplicationConfigurationDataPlaneRouting?
    /// The Staging Disk EBS volume type to be used during replication.
    /// This member is required.
    var defaultLargeStagingDiskType: DrsClientTypes.ReplicationConfigurationDefaultLargeStagingDiskType?
    /// The type of EBS encryption to be used during replication.
    /// This member is required.
    var ebsEncryption: DrsClientTypes.ReplicationConfigurationEbsEncryption?
    /// The ARN of the EBS encryption key to be used during replication.
    var ebsEncryptionKeyArn: Swift.String?
    /// The Point in time (PIT) policy to manage snapshots taken during replication.
    /// This member is required.
    var pitPolicy: [DrsClientTypes.PITPolicyRule]?
    /// The instance type to be used for the replication server.
    /// This member is required.
    var replicationServerInstanceType: Swift.String?
    /// The security group IDs that will be used by the replication server.
    /// This member is required.
    var replicationServersSecurityGroupsIDs: [Swift.String]?
    /// The subnet to be used by the replication staging area.
    /// This member is required.
    var stagingAreaSubnetId: Swift.String?
    /// A set of tags to be associated with all resources created in the replication staging area: EC2 replication server, EBS volumes, EBS snapshots, etc.
    /// This member is required.
    var stagingAreaTags: [Swift.String:Swift.String]?
    /// A set of tags to be associated with the Replication Configuration Template resource.
    var tags: [Swift.String:Swift.String]?
    /// Whether to use a dedicated Replication Server in the replication staging area.
    /// This member is required.
    var useDedicatedReplicationServer: Swift.Bool?
...
public struct CreateReplicationConfigurationTemplateOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var replicationConfigurationTemplateID: Swift.String?
    /// The instance type to be used for the replication server.
    var replicationServerInstanceType: Swift.String?
    /// The security group IDs that will be used by the replication server.
    var replicationServersSecurityGroupsIDs: [Swift.String]?
...
extension DrsClientTypes {
    ...
    public struct DataReplicationError: Swift.Equatable {
        /// Error in data replication.
        var error: DrsClientTypes.DataReplicationErrorString?
        /// Error in data replication.
        var rawError: Swift.String?
...
extension DrsClientTypes {
    ...
    public struct DataReplicationInfo: Swift.Equatable {
        /// Error in data replication.
        var dataReplicationError: DrsClientTypes.DataReplicationError?
        /// Information about whether the data replication has been initiated.
        var dataReplicationInitiation: DrsClientTypes.DataReplicationInitiation?
        /// The state of the data replication.
        var dataReplicationState: DrsClientTypes.DataReplicationState?
        /// An estimate of when the data replication will be completed.
        var etaDateTime: Swift.String?
        /// Data replication lag duration.
        var lagDuration: Swift.String?
        /// The disks that should be replicated.
        var replicatedDisks: [DrsClientTypes.DataReplicationInfoReplicatedDisk]?
...
extension DrsClientTypes {
    ...
    public struct DataReplicationInfoReplicatedDisk: Swift.Equatable {
        ...
        var backloggedStorageBytes: Swift.Int
        /// The name of the device.
        var deviceName: Swift.String?
        /// The amount of data replicated so far in bytes.
        var replicatedStorageBytes: Swift.Int
        /// The amount of data to be rescanned in bytes.
        var rescannedStorageBytes: Swift.Int
        /// The total amount of data to be replicated in bytes.
        var totalStorageBytes: Swift.Int
...
extension DrsClientTypes {
    ...
    public struct DataReplicationInitiation: Swift.Equatable {
        ...
        var nextAttemptDateTime: Swift.String?
        /// The date and time of the current attempt to initiate data replication.
        var startDateTime: Swift.String?
        /// The steps of the current attempt to initiate data replication.
        var steps: [DrsClientTypes.DataReplicationInitiationStep]?
...
extension DrsClientTypes {
    ...
    public struct DataReplicationInitiationStep: Swift.Equatable {
        ...
        var name: DrsClientTypes.DataReplicationInitiationStepName?
        /// The status of the step.
        var status: DrsClientTypes.DataReplicationInitiationStepStatus?
...
public struct DeleteRecoveryInstanceInput: Swift.Equatable {
    ...
    /// This member is required.
    var recoveryInstanceID: Swift.String?
...
public struct DeleteSourceServerInput: Swift.Equatable {
    ...
    /// This member is required.
    var sourceServerID: Swift.String?
...
public struct DescribeJobLogItemsOutputResponse: Swift.Equatable {
    ...
    var items: [DrsClientTypes.JobLog]?
    /// The token of the next Job log items to retrieve.
    var nextToken: Swift.String?
...
public struct DescribeJobsInput: Swift.Equatable {
    ...
    /// This member is required.
    var filters: DrsClientTypes.DescribeJobsRequestFilters?
...
extension DrsClientTypes {
    ...
    public struct DescribeJobsRequestFilters: Swift.Equatable {
        ...
        var fromDate: Swift.String?
        /// An array of Job IDs that should be returned. An empty array means all jobs.
        var jobIDs: [Swift.String]?
        /// The end date in a date range query.
        var toDate: Swift.String?
...
public struct DescribeRecoveryInstancesInput: Swift.Equatable {
    ...
    /// This member is required.
    var filters: DrsClientTypes.DescribeRecoveryInstancesRequestFilters?
...
public struct DescribeRecoveryInstancesOutputResponse: Swift.Equatable {
    ...
    var items: [DrsClientTypes.RecoveryInstance]?
    /// The token of the next Recovery Instance to retrieve.
    var nextToken: Swift.String?
...
public struct DescribeRecoverySnapshotsInput: Swift.Equatable {
    ...
    var filters: DrsClientTypes.DescribeRecoverySnapshotsRequestFilters?
    /// Maximum number of Recovery Snapshots to retrieve.
    var maxResults: Swift.Int
    /// The token of the next Recovery Snapshot to retrieve.
    var nextToken: Swift.String?
    /// The sorted ordering by which to return Recovery Snapshots.
    var order: DrsClientTypes.RecoverySnapshotsOrder?
...
public struct DescribeRecoverySnapshotsOutputResponse: Swift.Equatable {
    ...
    var items: [DrsClientTypes.RecoverySnapshot]?
    /// The token of the next Recovery Snapshot to retrieve.
    var nextToken: Swift.String?
...
extension DrsClientTypes {
    ...
    public struct DescribeRecoverySnapshotsRequestFilters: Swift.Equatable {
        /// The start date in a date range query.
        var fromDateTime: Swift.String?
        /// The end date in a date range query.
        var toDateTime: Swift.String?
...
public struct DescribeReplicationConfigurationTemplatesInput: Swift.Equatable {
    ...
    /// This member is required.
    var replicationConfigurationTemplateIDs: [Swift.String]?
...
public struct DescribeReplicationConfigurationTemplatesOutputResponse: Swift.Equatable {
    ...
    var items: [DrsClientTypes.ReplicationConfigurationTemplate]?
    /// The token of the next Replication Configuration Template to retrieve.
    var nextToken: Swift.String?
...
public struct DescribeSourceServersInput: Swift.Equatable {
    ...
    /// This member is required.
    var filters: DrsClientTypes.DescribeSourceServersRequestFilters?
...
public struct DescribeSourceServersOutputResponse: Swift.Equatable {
    ...
    var items: [DrsClientTypes.SourceServer]?
    /// The token of the next Source Server to retrieve.
    var nextToken: Swift.String?
...
public struct DisconnectSourceServerOutputResponse: Swift.Equatable {
    ...
    var dataReplicationInfo: DrsClientTypes.DataReplicationInfo?
    /// The status of the last recovery launch of this Source Server.
    var lastLaunchResult: DrsClientTypes.LastLaunchResult?
    /// The lifecycle information of this Source Server.
    var lifeCycle: DrsClientTypes.LifeCycle?
    /// The ID of the Recovery Instance associated with this Source Server.
    var recoveryInstanceId: Swift.String?
    /// The source properties of the Source Server.
    var sourceProperties: DrsClientTypes.SourceProperties?
...
public struct GetLaunchConfigurationOutputResponse: Swift.Equatable {
    ...
    var copyPrivateIp: Swift.Bool?
    /// Whether we want to copy the tags of the Source Server to the EC2 machine of the Recovery Instance.
    var copyTags: Swift.Bool?
    /// The EC2 launch template ID of this launch configuration.
    var ec2LaunchTemplateID: Swift.String?
    /// The state of the Recovery Instance in EC2 after the recovery operation.
    var launchDisposition: DrsClientTypes.LaunchDisposition?
    /// The licensing configuration to be used for this launch configuration.
    var licensing: DrsClientTypes.Licensing?
    /// The name of the launch configuration.
    var name: Swift.String?
    /// The ID of the Source Server for this launch configuration.
    var sourceServerID: Swift.String?
    /// Whether Elastic Disaster Recovery should try to automatically choose the instance type that best matches the OS, CPU, and RAM of your Source Server.
    var targetInstanceTypeRightSizingMethod: DrsClientTypes.TargetInstanceTypeRightSizingMethod?
...
public struct GetReplicationConfigurationOutputResponse: Swift.Equatable {
    ...
    var replicatedDisks: [DrsClientTypes.ReplicationConfigurationReplicatedDisk]?
    /// The instance type to be used for the replication server.
    var replicationServerInstanceType: Swift.String?
    /// The security group IDs that will be used by the replication server.
    var replicationServersSecurityGroupsIDs: [Swift.String]?
...
extension DrsClientTypes {
    ...
    public struct IdentificationHints: Swift.Equatable {
        ...
        var awsInstanceID: Swift.String?
        /// Fully Qualified Domain Name identification hint.
        var fqdn: Swift.String?
        /// Hostname identification hint.
        var hostname: Swift.String?
        /// vCenter VM path identification hint.
        var vmWareUuid: Swift.String?
...
extension DrsClientTypes {
    ...
    public struct Job: Swift.Equatable {
        ...
        var creationDateTime: Swift.String?
        /// The date and time of when the Job ended.
        var endDateTime: Swift.String?
        /// A string representing who initiated the Job.
        var initiatedBy: DrsClientTypes.InitiatedBy?
        /// The ID of the Job.
        /// This member is required.
        var jobID: Swift.String?
        /// A list of servers that the Job is acting upon.
        var participatingServers: [DrsClientTypes.ParticipatingServer]?
        /// The status of the Job.
        var status: DrsClientTypes.JobStatus?
        /// A list of tags associated with the Job.
        var tags: [Swift.String:Swift.String]?
        /// The type of the Job.
        var type: DrsClientTypes.JobType?
...
extension DrsClientTypes {
    ...
    public struct JobLog: Swift.Equatable {
        ...
        var event: DrsClientTypes.JobLogEvent?
        /// Metadata associated with a Job log.
        var eventData: DrsClientTypes.JobLogEventData?
        /// The date and time the log was taken.
        var logDateTime: Swift.String?
...
extension DrsClientTypes {
    ...
    public struct JobLogEventData: Swift.Equatable {
        ...
        var conversionServerID: Swift.String?
        /// A string representing a job error.
        var rawError: Swift.String?
        /// The ID of a Source Server.
        var sourceServerID: Swift.String?
        /// The ID of a Recovery Instance.
        var targetInstanceID: Swift.String?
...
extension DrsClientTypes {
    ...
    public struct LifeCycle: Swift.Equatable {
        ...
        var addedToServiceDateTime: Swift.String?
        /// The amount of time that the Source Server has been replicating for.
        var elapsedReplicationDuration: Swift.String?
        /// The date and time of the first byte that was replicated from the Source Server.
        var firstByteDateTime: Swift.String?
        /// An object containing information regarding the last launch of the Source Server.
        var lastLaunch: DrsClientTypes.LifeCycleLastLaunch?
        /// The date and time this Source Server was last seen by the service.
        var lastSeenByServiceDateTime: Swift.String?
...
extension DrsClientTypes {
    ...
    public struct LifeCycleLastLaunch: Swift.Equatable {
        ...
        var initiated: DrsClientTypes.LifeCycleLastLaunchInitiated?
...
extension DrsClientTypes {
    ...
    public struct LifeCycleLastLaunchInitiated: Swift.Equatable {
        ...
        var apiCallDateTime: Swift.String?
        /// The ID of the Job that was used to last launch the Source Server.
        var jobID: Swift.String?
        /// The Job type that was used to last launch the Source Server.
        var type: DrsClientTypes.LastLaunchType?
...
extension DrsClientTypes {
    ...
    public struct NetworkInterface: Swift.Equatable {
        ...
        var ips: [Swift.String]?
        /// Whether this is the primary network interface.
        var isPrimary: Swift.Bool?
        /// The MAC address of the network interface.
        var macAddress: Swift.String?
...
extension DrsClientTypes {
    ...
    public struct PITPolicyRule: Swift.Equatable {
        ...
        /// This member is required.
        var retentionDuration: Swift.Int
        /// The ID of the rule.
        var ruleID: Swift.Int
        /// The units used to measure the interval and retentionDuration.
        /// This member is required.
        var units: DrsClientTypes.PITPolicyRuleUnits?
...
extension DrsClientTypes {
    ...
    public struct ParticipatingServer: Swift.Equatable {
        ...
        var launchStatus: DrsClientTypes.LaunchStatus?
...
extension DrsClientTypes {
    ...
    public struct RecoveryInstance: Swift.Equatable {
        ...
        var dataReplicationInfo: DrsClientTypes.RecoveryInstanceDataReplicationInfo?
        /// The EC2 instance ID of the Recovery Instance.
        var ec2InstanceID: Swift.String?
        /// The state of the EC2 instance for this Recovery Instance.
        var ec2InstanceState: DrsClientTypes.EC2InstanceState?
        /// An object representing failback related information of the Recovery Instance.
        var failback: DrsClientTypes.RecoveryInstanceFailback?
        /// Whether this Recovery Instance was created for a drill or for an actual Recovery event.
        var isDrill: Swift.Bool?
        /// The ID of the Job that created the Recovery Instance.
        var jobID: Swift.String?
        /// The date and time of the Point in Time (PIT) snapshot that this Recovery Instance was launched from.
        var pointInTimeSnapshotDateTime: Swift.String?
        /// The ID of the Recovery Instance.
        var recoveryInstanceID: Swift.String?
        /// Properties of the Recovery Instance machine.
        var recoveryInstanceProperties: DrsClientTypes.RecoveryInstanceProperties?
...
extension DrsClientTypes {
    ...
    public struct RecoveryInstanceDataReplicationError: Swift.Equatable {
        /// Error in data replication.
        var error: DrsClientTypes.FailbackReplicationError?
        /// Error in data replication.
        var rawError: Swift.String?
...
extension DrsClientTypes {
    ...
    public struct RecoveryInstanceDataReplicationInfo: Swift.Equatable {
        /// Information about Data Replication
        var dataReplicationError: DrsClientTypes.RecoveryInstanceDataReplicationError?
        /// Information about whether the data replication has been initiated.
        var dataReplicationInitiation: DrsClientTypes.RecoveryInstanceDataReplicationInitiation?
        /// The state of the data replication.
        var dataReplicationState: DrsClientTypes.RecoveryInstanceDataReplicationState?
        /// An estimate of when the data replication will be completed.
        var etaDateTime: Swift.String?
        /// Data replication lag duration.
        var lagDuration: Swift.String?
        /// The disks that should be replicated.
        var replicatedDisks: [DrsClientTypes.RecoveryInstanceDataReplicationInfoReplicatedDisk]?
...
extension DrsClientTypes {
    ...
    public struct RecoveryInstanceDataReplicationInitiation: Swift.Equatable {
        ...
        var startDateTime: Swift.String?
        /// The steps of the current attempt to initiate data replication.
        var steps: [DrsClientTypes.RecoveryInstanceDataReplicationInitiationStep]?
...
extension DrsClientTypes {
    ...
    public struct RecoveryInstanceDataReplicationInitiationStep: Swift.Equatable {
        /// The name of the step.
        var name: DrsClientTypes.RecoveryInstanceDataReplicationInitiationStepName?
        /// The status of the step.
        var status: DrsClientTypes.RecoveryInstanceDataReplicationInitiationStepStatus?
...
extension DrsClientTypes {
    ...
    public struct RecoveryInstanceDisk: Swift.Equatable {
        ...
        var internalDeviceName: Swift.String?
...
extension DrsClientTypes {
    ...
    public struct RecoveryInstanceFailback: Swift.Equatable {
        ...
        var agentLastSeenByServiceDateTime: Swift.String?
        /// The amount of time that the Recovery Instance has been replicating for.
        var elapsedReplicationDuration: Swift.String?
        /// The ID of the failback client that this Recovery Instance is associated with.
        var failbackClientID: Swift.String?
        /// The date and time that the failback client was last seen by the service.
        var failbackClientLastSeenByServiceDateTime: Swift.String?
        /// The date and time that the failback initiation started.
        var failbackInitiationTime: Swift.String?
        /// The Job ID of the last failback log for this Recovery Instance.
        var failbackJobID: Swift.String?
        /// Whether we are failing back to the original Source Server for this Recovery Instance.
        var failbackToOriginalServer: Swift.Bool?
        /// The date and time of the first byte that was replicated from the Recovery Instance.
        var firstByteDateTime: Swift.String?
        /// The state of the failback process that this Recovery Instance is in.
        var state: DrsClientTypes.FailbackState?
...
extension DrsClientTypes {
    ...
    public struct RecoveryInstanceProperties: Swift.Equatable {
        /// An array of CPUs.
        var cpus: [DrsClientTypes.CPU]?
        /// An array of disks.
        var disks: [DrsClientTypes.RecoveryInstanceDisk]?
        /// Hints used to uniquely identify a machine.
        var identificationHints: DrsClientTypes.IdentificationHints?
        /// The date and time the Recovery Instance properties were last updated on.
        var lastUpdatedDateTime: Swift.String?
        /// An array of network interfaces.
        var networkInterfaces: [DrsClientTypes.NetworkInterface]?
        /// Operating system.
        var os: DrsClientTypes.OS?
        /// The amount of RAM in bytes.
        var ramBytes: Swift.Int
...
extension DrsClientTypes {
    ...
    public struct RecoverySnapshot: Swift.Equatable {
        ...
        var ebsSnapshots: [Swift.String]?
        /// The timestamp of when we expect the snapshot to be taken.
        /// This member is required.
        var expectedTimestamp: Swift.String?
...
extension DrsClientTypes {
    ...
    public struct ReplicationConfigurationReplicatedDisk: Swift.Equatable {
        ...
        var isBootDisk: Swift.Bool?
        /// The Staging Disk EBS volume type to be used during replication.
        var stagingDiskType: DrsClientTypes.ReplicationConfigurationReplicatedDiskStagingDiskType?
...
extension DrsClientTypes {
    ...
    public struct SourceProperties: Swift.Equatable {
        ...
        var recommendedInstanceType: Swift.String?
...
public struct StartRecoveryInput: Swift.Equatable {
    ...
    /// This member is required.
    var sourceServers: [DrsClientTypes.StartRecoveryRequestSourceServer]?
...
extension DrsClientTypes {
    ...
    public struct StartRecoveryRequestSourceServer: Swift.Equatable {
        ...
        var recoverySnapshotID: Swift.String?
