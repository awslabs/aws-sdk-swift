...
public extension PinpointClient {
    ...
    {
        typealias createInAppTemplateContinuation = CheckedContinuation<CreateInAppTemplateOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createInAppTemplateContinuation) in
            createInAppTemplate(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteInAppTemplateContinuation = CheckedContinuation<DeleteInAppTemplateOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteInAppTemplateContinuation) in
            deleteInAppTemplate(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getInAppMessagesContinuation = CheckedContinuation<GetInAppMessagesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getInAppMessagesContinuation) in
            getInAppMessages(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getInAppTemplateContinuation = CheckedContinuation<GetInAppTemplateOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getInAppTemplateContinuation) in
            getInAppTemplate(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias sendOTPMessageContinuation = CheckedContinuation<SendOTPMessageOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: sendOTPMessageContinuation) in
            sendOTPMessage(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateInAppTemplateContinuation = CheckedContinuation<UpdateInAppTemplateOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateInAppTemplateContinuation) in
            updateInAppTemplate(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias verifyOTPMessageContinuation = CheckedContinuation<VerifyOTPMessageOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: verifyOTPMessageContinuation) in
            verifyOTPMessage(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
