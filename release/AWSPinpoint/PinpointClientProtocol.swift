...
public protocol PinpointClientProtocol {
    ...
    /// Send an OTP message
    func sendOTPMessage(input: SendOTPMessageInput, completion: @escaping (ClientRuntime.SdkResult<SendOTPMessageOutputResponse, SendOTPMessageOutputError>) -> Void)
    ...
    /// Verify an OTP
    func verifyOTPMessage(input: VerifyOTPMessageInput, completion: @escaping (ClientRuntime.SdkResult<VerifyOTPMessageOutputResponse, VerifyOTPMessageOutputError>) -> Void)
}
