...
extension SignerClient: SignerClientProtocol {
    ...
    public func addProfilePermission(input: AddProfilePermissionInput, completion: @escaping (SdkResult<AddProfilePermissionOutput, AddProfilePermissionOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<AddProfilePermissionInput, AddProfilePermissionOutput, AddProfilePermissionOutputError>(id: "addProfilePermission")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AddProfilePermissionInput, AddProfilePermissionOutput, AddProfilePermissionOutputError>(contentType: "application/json"))
    ...
    /// 			cancelation.</p>
    public func cancelSigningProfile(input: CancelSigningProfileInput, completion: @escaping (SdkResult<CancelSigningProfileOutput, CancelSigningProfileOutputError>) -> Void)
    {
        guard let profileName = input.profileName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component profileName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CancelSigningProfileInput, CancelSigningProfileOutput, CancelSigningProfileOutputError>(id: "cancelSigningProfile")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CancelSigningProfileInput, CancelSigningProfileOutput, CancelSigningProfileOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    /// 			operation. </p>
    public func describeSigningJob(input: DescribeSigningJobInput, completion: @escaping (SdkResult<DescribeSigningJobOutput, DescribeSigningJobOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeSigningJobInput, DescribeSigningJobOutput, DescribeSigningJobOutputError>(id: "describeSigningJob")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeSigningJobInput, DescribeSigningJobOutput, DescribeSigningJobOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getSigningPlatform(input: GetSigningPlatformInput, completion: @escaping (SdkResult<GetSigningPlatformOutput, GetSigningPlatformOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSigningPlatformInput, GetSigningPlatformOutput, GetSigningPlatformOutputError>(id: "getSigningPlatform")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSigningPlatformInput, GetSigningPlatformOutput, GetSigningPlatformOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getSigningProfile(input: GetSigningProfileInput, completion: @escaping (SdkResult<GetSigningProfileOutput, GetSigningProfileOutputError>) -> Void)
    {
        guard let profileName = input.profileName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component profileName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSigningProfileInput, GetSigningProfileOutput, GetSigningProfileOutputError>(id: "getSigningProfile")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSigningProfileInput, GetSigningProfileOutput, GetSigningProfileOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listProfilePermissions(input: ListProfilePermissionsInput, completion: @escaping (SdkResult<ListProfilePermissionsOutput, ListProfilePermissionsOutputError>) -> Void)
    {
        guard let profileName = input.profileName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component profileName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListProfilePermissionsInput, ListProfilePermissionsOutput, ListProfilePermissionsOutputError>(id: "listProfilePermissions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListProfilePermissionsInput, ListProfilePermissionsOutput, ListProfilePermissionsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listSigningJobs(input: ListSigningJobsInput, completion: @escaping (SdkResult<ListSigningJobsOutput, ListSigningJobsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListSigningJobsInput, ListSigningJobsOutput, ListSigningJobsOutputError>(id: "listSigningJobs")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListSigningJobsInput, ListSigningJobsOutput, ListSigningJobsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    /// 			returned.</p>
    public func listSigningPlatforms(input: ListSigningPlatformsInput, completion: @escaping (SdkResult<ListSigningPlatformsOutput, ListSigningPlatformsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListSigningPlatformsInput, ListSigningPlatformsOutput, ListSigningPlatformsOutputError>(id: "listSigningPlatforms")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListSigningPlatformsInput, ListSigningPlatformsOutput, ListSigningPlatformsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listSigningProfiles(input: ListSigningProfilesInput, completion: @escaping (SdkResult<ListSigningProfilesOutput, ListSigningProfilesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListSigningProfilesInput, ListSigningProfilesOutput, ListSigningProfilesOutputError>(id: "listSigningProfiles")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListSigningProfilesInput, ListSigningProfilesOutput, ListSigningProfilesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          </p>
    public func putSigningProfile(input: PutSigningProfileInput, completion: @escaping (SdkResult<PutSigningProfileOutput, PutSigningProfileOutputError>) -> Void)
    {
        guard let profileName = input.profileName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component profileName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutSigningProfileInput, PutSigningProfileOutput, PutSigningProfileOutputError>(id: "putSigningProfile")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutSigningProfileInput, PutSigningProfileOutput, PutSigningProfileOutputError>(contentType: "application/json"))
    ...
    public func removeProfilePermission(input: RemoveProfilePermissionInput, completion: @escaping (SdkResult<RemoveProfilePermissionOutput, RemoveProfilePermissionOutputError>) -> Void)
    {
        guard let profileName = input.profileName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component profileName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RemoveProfilePermissionInput, RemoveProfilePermissionOutput, RemoveProfilePermissionOutputError>(id: "removeProfilePermission")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RemoveProfilePermissionInput, RemoveProfilePermissionOutput, RemoveProfilePermissionOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    /// 			longer valid.</p>
    public func revokeSignature(input: RevokeSignatureInput, completion: @escaping (SdkResult<RevokeSignatureOutput, RevokeSignatureOutputError>) -> Void)
    {
        guard let jobId = input.jobId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component jobId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RevokeSignatureInput, RevokeSignatureOutput, RevokeSignatureOutputError>(id: "revokeSignature")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RevokeSignatureInput, RevokeSignatureOutput, RevokeSignatureOutputError>(contentType: "application/json"))
    ...
    /// 			valid.</p>
    public func revokeSigningProfile(input: RevokeSigningProfileInput, completion: @escaping (SdkResult<RevokeSigningProfileOutput, RevokeSigningProfileOutputError>) -> Void)
    {
        guard let profileName = input.profileName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component profileName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RevokeSigningProfileInput, RevokeSigningProfileOutput, RevokeSigningProfileOutputError>(id: "revokeSigningProfile")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RevokeSigningProfileInput, RevokeSigningProfileOutput, RevokeSigningProfileOutputError>(contentType: "application/json"))
    ...
    ///          </p>
    public func startSigningJob(input: StartSigningJobInput, completion: @escaping (SdkResult<StartSigningJobOutput, StartSigningJobOutputError>) -> Void)
    {
        let urlPath = "/signing-jobs"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "signer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartSigningJobInput, StartSigningJobOutput, StartSigningJobOutputError>(id: "startSigningJob")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<StartSigningJobOutput>, SdkError<StartSigningJobOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartSigningJobInput, StartSigningJobOutput, StartSigningJobOutputError>(contentType: "application/json"))
