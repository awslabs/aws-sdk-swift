...
public struct AddApplicationVpcConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddApplicationVpcConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = AddApplicationVpcConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<AddApplicationVpcConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AddApplicationVpcConfigurationOutputError>
}

public struct AddApplicationVpcConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddApplicationVpcConfigurationInputURLPathMiddleware"
...
public struct CreateApplicationPresignedUrlInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateApplicationPresignedUrlInputURLHostMiddleware"
    ...
    public typealias MInput = CreateApplicationPresignedUrlInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateApplicationPresignedUrlOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateApplicationPresignedUrlOutputError>
}

public struct CreateApplicationPresignedUrlInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateApplicationPresignedUrlInputURLPathMiddleware"
...
public struct CreateApplicationSnapshotInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateApplicationSnapshotInputURLHostMiddleware"
    ...
    public typealias MInput = CreateApplicationSnapshotInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateApplicationSnapshotOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateApplicationSnapshotOutputError>
}

public struct CreateApplicationSnapshotInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateApplicationSnapshotInputURLPathMiddleware"
...
public struct DeleteApplicationSnapshotInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationSnapshotInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteApplicationSnapshotInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteApplicationSnapshotOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteApplicationSnapshotOutputError>
}

public struct DeleteApplicationSnapshotInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationSnapshotInputURLPathMiddleware"
...
public struct DeleteApplicationVpcConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationVpcConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteApplicationVpcConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteApplicationVpcConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteApplicationVpcConfigurationOutputError>
}

public struct DeleteApplicationVpcConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationVpcConfigurationInputURLPathMiddleware"
...
public struct DescribeApplicationSnapshotInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationSnapshotInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeApplicationSnapshotInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeApplicationSnapshotOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeApplicationSnapshotOutputError>
}

public struct DescribeApplicationSnapshotInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationSnapshotInputURLPathMiddleware"
...
public struct DescribeApplicationVersionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationVersionInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeApplicationVersionInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeApplicationVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeApplicationVersionOutputError>
}

public struct DescribeApplicationVersionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationVersionInputURLPathMiddleware"
...
extension KinesisAnalyticsV2ClientTypes {
    ...
    public struct InputLambdaProcessor: Swift.Equatable {
        /// The ARN of the AWS Lambda function that operates on records in the stream. To specify an earlier version of the Lambda function than the latest, include the Lambda function version in the Lambda function ARN. For more information about Lambda ARNs, see [Example ARNs: AWS Lambda](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-lambda)
        /// This member is required.
        public var resourceARN: Swift.String?
...
extension KinesisAnalyticsV2ClientTypes {
    ...
    public struct InputLambdaProcessorDescription: Swift.Equatable {
        /// The ARN of the AWS Lambda function that is used to preprocess the records in the stream. To specify an earlier version of the Lambda function than the latest, include the Lambda function version in the Lambda function ARN. For more information about Lambda ARNs, see [Example ARNs: AWS Lambda](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-lambda)
        /// This member is required.
        public var resourceARN: Swift.String?
...
extension KinesisAnalyticsV2ClientTypes {
    /// For a SQL-based Kinesis Data Analytics application, describes a processor that is used to preprocess the records in the stream before being processed by your application code. Currently, the only input processor available is [AWS Lambda](https://docs.aws.amazon.com/lambda/).
...
extension KinesisAnalyticsV2ClientTypes {
    /// For a SQL-based Kinesis Data Analytics application, provides the configuration information about an input processor. Currently, the only input processor available is [AWS Lambda](https://docs.aws.amazon.com/lambda/).
...
public struct ListApplicationSnapshotsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListApplicationSnapshotsInputURLHostMiddleware"
    ...
    public typealias MInput = ListApplicationSnapshotsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListApplicationSnapshotsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListApplicationSnapshotsOutputError>
}

public struct ListApplicationSnapshotsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListApplicationSnapshotsInputURLPathMiddleware"
...
public struct ListApplicationVersionsInput: Swift.Equatable {
    ...
    public var limit: Swift.Int?
    /// If a previous invocation of this operation returned a pagination token, pass it into this value to retrieve the next set of results. For more information about pagination, see [Using the AWS Command Line Interface's Pagination Options](https://docs.aws.amazon.com/cli/latest/userguide/pagination.html).
    public var nextToken: Swift.String?
...
public struct ListApplicationsInput: Swift.Equatable {
    ...
    public var limit: Swift.Int?
    /// If a previous command returned a pagination token, pass it into this value to retrieve the next set of results. For more information about pagination, see [Using the AWS Command Line Interface's Pagination Options](https://docs.aws.amazon.com/cli/latest/userguide/pagination.html).
    public var nextToken: Swift.String?
...
public struct RollbackApplicationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RollbackApplicationInputURLHostMiddleware"
    ...
    public typealias MInput = RollbackApplicationInput
    public typealias MOutput = ClientRuntime.OperationOutput<RollbackApplicationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RollbackApplicationOutputError>
}

public struct RollbackApplicationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RollbackApplicationInputURLPathMiddleware"
...
public struct UpdateApplicationMaintenanceConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationMaintenanceConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateApplicationMaintenanceConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateApplicationMaintenanceConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateApplicationMaintenanceConfigurationOutputError>
}

public struct UpdateApplicationMaintenanceConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationMaintenanceConfigurationInputURLPathMiddleware"
