...
public struct DescribeTableReplicaAutoScalingInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DescribeTableReplicaAutoScalingOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DescribeTableReplicaAutoScalingOutput>
