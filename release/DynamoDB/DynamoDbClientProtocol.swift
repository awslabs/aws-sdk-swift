...
public protocol DynamoDbClientProtocol {
    ...
    ///                 Guide</i>.</p>
    func batchGetItem(input: BatchGetItemInput, completion: @escaping (SdkResult<BatchGetItemOutput, BatchGetItemOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func batchWriteItem(input: BatchWriteItemInput, completion: @escaping (SdkResult<BatchWriteItemOutput, BatchWriteItemOutputError>) -> Void)
    ...
    ///               </li>
    ///          </ul>
    func createBackup(input: CreateBackupInput, completion: @escaping (SdkResult<CreateBackupOutput, CreateBackupOutputError>) -> Void)
    ...
    ///     </p>
    ///          </important>
    func createGlobalTable(input: CreateGlobalTableInput, completion: @escaping (SdkResult<CreateGlobalTableOutput, CreateGlobalTableOutputError>) -> Void)
    ...
    func deleteItem(input: DeleteItemInput, completion: @escaping (SdkResult<DeleteItemOutput, DeleteItemOutputError>) -> Void)
    ...
    func describeBackup(input: DescribeBackupInput, completion: @escaping (SdkResult<DescribeBackupOutput, DescribeBackupOutputError>) -> Void)
    ...
    func describeContinuousBackups(input: DescribeContinuousBackupsInput, completion: @escaping (SdkResult<DescribeContinuousBackupsOutput, DescribeContinuousBackupsOutputError>) -> Void)
    /// <p>Returns information about contributor insights, for a given table or global secondary index.</p>
    func describeContributorInsights(input: DescribeContributorInsightsInput, completion: @escaping (SdkResult<DescribeContributorInsightsOutput, DescribeContributorInsightsOutputError>) -> Void)
    ...
    ///          </note>
    func describeGlobalTable(input: DescribeGlobalTableInput, completion: @escaping (SdkResult<DescribeGlobalTableOutput, DescribeGlobalTableOutputError>) -> Void)
    /// <p>Describes Region-specific settings for a global table.</p>
    ///           <note>
    ///             <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29</a> of global tables.</p>
    ///          </note>
    func describeGlobalTableSettings(input: DescribeGlobalTableSettingsInput, completion: @escaping (SdkResult<DescribeGlobalTableSettingsOutput, DescribeGlobalTableSettingsOutputError>) -> Void)
    /// <p>Returns information about the status of Kinesis streaming.</p>
    func describeKinesisStreamingDestination(input: DescribeKinesisStreamingDestinationInput, completion: @escaping (SdkResult<DescribeKinesisStreamingDestinationOutput, DescribeKinesisStreamingDestinationOutputError>) -> Void)
    ...
    ///          </note>
    func describeTableReplicaAutoScaling(input: DescribeTableReplicaAutoScalingInput, completion: @escaping (SdkResult<DescribeTableReplicaAutoScalingOutput, DescribeTableReplicaAutoScalingOutputError>) -> Void)
    /// <p>Gives a description of the Time to Live (TTL) status on the specified table. </p>
    func describeTimeToLive(input: DescribeTimeToLiveInput, completion: @escaping (SdkResult<DescribeTimeToLiveOutput, DescribeTimeToLiveOutputError>) -> Void)
    ...
    func disableKinesisStreamingDestination(input: DisableKinesisStreamingDestinationInput, completion: @escaping (SdkResult<DisableKinesisStreamingDestinationOutput, DisableKinesisStreamingDestinationOutputError>) -> Void)
    ...
    ///             ACTIVE.</p>
    func enableKinesisStreamingDestination(input: EnableKinesisStreamingDestinationInput, completion: @escaping (SdkResult<EnableKinesisStreamingDestinationOutput, EnableKinesisStreamingDestinationOutputError>) -> Void)
    /// <p>
    ...
    /// </p>
    func executeTransaction(input: ExecuteTransactionInput, completion: @escaping (SdkResult<ExecuteTransactionOutput, ExecuteTransactionOutputError>) -> Void)
    /// <p>Exports table data to an S3 bucket. The table must have point in time recovery
    ///             enabled, and you can export data from any time within the point in time recovery
    ///             window.</p>
    func exportTableToPointInTime(input: ExportTableToPointInTimeInput, completion: @escaping (SdkResult<ExportTableToPointInTimeOutput, ExportTableToPointInTimeOutputError>) -> Void)
    ...
    func getItem(input: GetItemInput, completion: @escaping (SdkResult<GetItemOutput, GetItemOutputError>) -> Void)
    ...
    func listBackups(input: ListBackupsInput, completion: @escaping (SdkResult<ListBackupsOutput, ListBackupsOutputError>) -> Void)
    /// <p>Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.</p>
    func listContributorInsights(input: ListContributorInsightsInput, completion: @escaping (SdkResult<ListContributorInsightsOutput, ListContributorInsightsOutputError>) -> Void)
    ...
    ///             <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29</a> of global tables.</p>
    ///          </note>
    func listGlobalTables(input: ListGlobalTablesInput, completion: @escaping (SdkResult<ListGlobalTablesOutput, ListGlobalTablesOutputError>) -> Void)
    ...
    func listTagsOfResource(input: ListTagsOfResourceInput, completion: @escaping (SdkResult<ListTagsOfResourceOutput, ListTagsOfResourceOutputError>) -> Void)
    ...
    func putItem(input: PutItemInput, completion: @escaping (SdkResult<PutItemOutput, PutItemOutputError>) -> Void)
    ...
    ///              </li>
    ///          </ul>
    func restoreTableFromBackup(input: RestoreTableFromBackupInput, completion: @escaping (SdkResult<RestoreTableFromBackupOutput, RestoreTableFromBackupOutputError>) -> Void)
    ...
    ///              </li>
    ///          </ul>
    func restoreTableToPointInTime(input: RestoreTableToPointInTimeInput, completion: @escaping (SdkResult<RestoreTableToPointInTimeOutput, RestoreTableToPointInTimeOutputError>) -> Void)
    ...
    func scan(input: ScanInput, completion: @escaping (SdkResult<ScanOutput, ScanOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func transactGetItems(input: TransactGetItemsInput, completion: @escaping (SdkResult<TransactGetItemsOutput, TransactGetItemsOutputError>) -> Void)
    /// <p>
    ...
    ///             </li>
    ///          </ul>
    func transactWriteItems(input: TransactWriteItemsInput, completion: @escaping (SdkResult<TransactWriteItemsOutput, TransactWriteItemsOutputError>) -> Void)
    ...
    func updateContinuousBackups(input: UpdateContinuousBackupsInput, completion: @escaping (SdkResult<UpdateContinuousBackupsOutput, UpdateContinuousBackupsOutputError>) -> Void)
    /// <p>Updates the status for contributor insights for a specific table or index.</p>
    func updateContributorInsights(input: UpdateContributorInsightsInput, completion: @escaping (SdkResult<UpdateContributorInsightsOutput, UpdateContributorInsightsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func updateGlobalTable(input: UpdateGlobalTableInput, completion: @escaping (SdkResult<UpdateGlobalTableOutput, UpdateGlobalTableOutputError>) -> Void)
    /// <p>Updates settings for a global table.</p>
    func updateGlobalTableSettings(input: UpdateGlobalTableSettingsInput, completion: @escaping (SdkResult<UpdateGlobalTableSettingsOutput, UpdateGlobalTableSettingsOutputError>) -> Void)
    ...
    ///       operation using the <code>ReturnValues</code> parameter.</p>
    func updateItem(input: UpdateItemInput, completion: @escaping (SdkResult<UpdateItemOutput, UpdateItemOutputError>) -> Void)
    ...
    ///             <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version 2019.11.21</a> of global tables.</p>
    ///          </note>
    func updateTableReplicaAutoScaling(input: UpdateTableReplicaAutoScalingInput, completion: @escaping (SdkResult<UpdateTableReplicaAutoScalingOutput, UpdateTableReplicaAutoScalingOutputError>) -> Void)
    ...
    func updateTimeToLive(input: UpdateTimeToLiveInput, completion: @escaping (SdkResult<UpdateTimeToLiveOutput, UpdateTimeToLiveOutputError>) -> Void)
}
