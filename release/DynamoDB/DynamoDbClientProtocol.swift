...
public protocol DynamoDbClientProtocol {
    ...
    ///                 Guide</i>.</p>
    func batchGetItem(input: BatchGetItemInput, completion: @escaping (SdkResult<BatchGetItemOutputResponse, BatchGetItemOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func batchWriteItem(input: BatchWriteItemInput, completion: @escaping (SdkResult<BatchWriteItemOutputResponse, BatchWriteItemOutputError>) -> Void)
    ...
    ///               </li>
    ///          </ul>
    func createBackup(input: CreateBackupInput, completion: @escaping (SdkResult<CreateBackupOutputResponse, CreateBackupOutputError>) -> Void)
    ...
    ///     </p>
    ///          </important>
    func createGlobalTable(input: CreateGlobalTableInput, completion: @escaping (SdkResult<CreateGlobalTableOutputResponse, CreateGlobalTableOutputError>) -> Void)
    ...
    func deleteItem(input: DeleteItemInput, completion: @escaping (SdkResult<DeleteItemOutputResponse, DeleteItemOutputError>) -> Void)
    ...
    func describeBackup(input: DescribeBackupInput, completion: @escaping (SdkResult<DescribeBackupOutputResponse, DescribeBackupOutputError>) -> Void)
    ...
    func describeContinuousBackups(input: DescribeContinuousBackupsInput, completion: @escaping (SdkResult<DescribeContinuousBackupsOutputResponse, DescribeContinuousBackupsOutputError>) -> Void)
    /// <p>Returns information about contributor insights, for a given table or global secondary index.</p>
    func describeContributorInsights(input: DescribeContributorInsightsInput, completion: @escaping (SdkResult<DescribeContributorInsightsOutputResponse, DescribeContributorInsightsOutputError>) -> Void)
    ...
    ///          </note>
    func describeGlobalTable(input: DescribeGlobalTableInput, completion: @escaping (SdkResult<DescribeGlobalTableOutputResponse, DescribeGlobalTableOutputError>) -> Void)
    /// <p>Describes Region-specific settings for a global table.</p>
    ///           <note>
    ///             <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29</a> of global tables.</p>
    ///          </note>
    func describeGlobalTableSettings(input: DescribeGlobalTableSettingsInput, completion: @escaping (SdkResult<DescribeGlobalTableSettingsOutputResponse, DescribeGlobalTableSettingsOutputError>) -> Void)
    /// <p>Returns information about the status of Kinesis streaming.</p>
    func describeKinesisStreamingDestination(input: DescribeKinesisStreamingDestinationInput, completion: @escaping (SdkResult<DescribeKinesisStreamingDestinationOutputResponse, DescribeKinesisStreamingDestinationOutputError>) -> Void)
    ...
    ///          </note>
    func describeTableReplicaAutoScaling(input: DescribeTableReplicaAutoScalingInput, completion: @escaping (SdkResult<DescribeTableReplicaAutoScalingOutputResponse, DescribeTableReplicaAutoScalingOutputError>) -> Void)
    /// <p>Gives a description of the Time to Live (TTL) status on the specified table. </p>
    func describeTimeToLive(input: DescribeTimeToLiveInput, completion: @escaping (SdkResult<DescribeTimeToLiveOutputResponse, DescribeTimeToLiveOutputError>) -> Void)
    ...
    func disableKinesisStreamingDestination(input: DisableKinesisStreamingDestinationInput, completion: @escaping (SdkResult<DisableKinesisStreamingDestinationOutputResponse, DisableKinesisStreamingDestinationOutputError>) -> Void)
    ...
    ///             ACTIVE.</p>
    func enableKinesisStreamingDestination(input: EnableKinesisStreamingDestinationInput, completion: @escaping (SdkResult<EnableKinesisStreamingDestinationOutputResponse, EnableKinesisStreamingDestinationOutputError>) -> Void)
    /// <p>
    ...
    /// </p>
    func executeTransaction(input: ExecuteTransactionInput, completion: @escaping (SdkResult<ExecuteTransactionOutputResponse, ExecuteTransactionOutputError>) -> Void)
    /// <p>Exports table data to an S3 bucket. The table must have point in time recovery
    ///             enabled, and you can export data from any time within the point in time recovery
    ///             window.</p>
    func exportTableToPointInTime(input: ExportTableToPointInTimeInput, completion: @escaping (SdkResult<ExportTableToPointInTimeOutputResponse, ExportTableToPointInTimeOutputError>) -> Void)
    ...
    func getItem(input: GetItemInput, completion: @escaping (SdkResult<GetItemOutputResponse, GetItemOutputError>) -> Void)
    ...
    func listBackups(input: ListBackupsInput, completion: @escaping (SdkResult<ListBackupsOutputResponse, ListBackupsOutputError>) -> Void)
    /// <p>Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.</p>
    func listContributorInsights(input: ListContributorInsightsInput, completion: @escaping (SdkResult<ListContributorInsightsOutputResponse, ListContributorInsightsOutputError>) -> Void)
    ...
    ///             <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29</a> of global tables.</p>
    ///          </note>
    func listGlobalTables(input: ListGlobalTablesInput, completion: @escaping (SdkResult<ListGlobalTablesOutputResponse, ListGlobalTablesOutputError>) -> Void)
    ...
    func listTagsOfResource(input: ListTagsOfResourceInput, completion: @escaping (SdkResult<ListTagsOfResourceOutputResponse, ListTagsOfResourceOutputError>) -> Void)
    ...
    func putItem(input: PutItemInput, completion: @escaping (SdkResult<PutItemOutputResponse, PutItemOutputError>) -> Void)
    ...
    ///              </li>
    ///          </ul>
    func restoreTableFromBackup(input: RestoreTableFromBackupInput, completion: @escaping (SdkResult<RestoreTableFromBackupOutputResponse, RestoreTableFromBackupOutputError>) -> Void)
    ...
    ///              </li>
    ///          </ul>
    func restoreTableToPointInTime(input: RestoreTableToPointInTimeInput, completion: @escaping (SdkResult<RestoreTableToPointInTimeOutputResponse, RestoreTableToPointInTimeOutputError>) -> Void)
    ...
    func scan(input: ScanInput, completion: @escaping (SdkResult<ScanOutputResponse, ScanOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func transactGetItems(input: TransactGetItemsInput, completion: @escaping (SdkResult<TransactGetItemsOutputResponse, TransactGetItemsOutputError>) -> Void)
    /// <p>
    ...
    ///             </li>
    ///          </ul>
    func transactWriteItems(input: TransactWriteItemsInput, completion: @escaping (SdkResult<TransactWriteItemsOutputResponse, TransactWriteItemsOutputError>) -> Void)
    ...
    func updateContinuousBackups(input: UpdateContinuousBackupsInput, completion: @escaping (SdkResult<UpdateContinuousBackupsOutputResponse, UpdateContinuousBackupsOutputError>) -> Void)
    /// <p>Updates the status for contributor insights for a specific table or index.</p>
    func updateContributorInsights(input: UpdateContributorInsightsInput, completion: @escaping (SdkResult<UpdateContributorInsightsOutputResponse, UpdateContributorInsightsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func updateGlobalTable(input: UpdateGlobalTableInput, completion: @escaping (SdkResult<UpdateGlobalTableOutputResponse, UpdateGlobalTableOutputError>) -> Void)
    /// <p>Updates settings for a global table.</p>
    func updateGlobalTableSettings(input: UpdateGlobalTableSettingsInput, completion: @escaping (SdkResult<UpdateGlobalTableSettingsOutputResponse, UpdateGlobalTableSettingsOutputError>) -> Void)
    ...
    ///       operation using the <code>ReturnValues</code> parameter.</p>
    func updateItem(input: UpdateItemInput, completion: @escaping (SdkResult<UpdateItemOutputResponse, UpdateItemOutputError>) -> Void)
    ...
    ///             <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version 2019.11.21</a> of global tables.</p>
    ///          </note>
    func updateTableReplicaAutoScaling(input: UpdateTableReplicaAutoScalingInput, completion: @escaping (SdkResult<UpdateTableReplicaAutoScalingOutputResponse, UpdateTableReplicaAutoScalingOutputError>) -> Void)
    ...
    func updateTimeToLive(input: UpdateTimeToLiveInput, completion: @escaping (SdkResult<UpdateTimeToLiveOutputResponse, UpdateTimeToLiveOutputError>) -> Void)
}
