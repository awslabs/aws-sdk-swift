...
extension DynamoDbClient: DynamoDbClientProtocol {
    ...
    public func executeTransaction(input: ExecuteTransactionInput, completion: @escaping (ClientRuntime.SdkResult<ExecuteTransactionOutputResponse, ExecuteTransactionOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<ExecuteTransactionOutputResponse>, ClientRuntime.SdkError<ExecuteTransactionOutputError>> in
    ...
    public func exportTableToPointInTime(input: ExportTableToPointInTimeInput, completion: @escaping (ClientRuntime.SdkResult<ExportTableToPointInTimeOutputResponse, ExportTableToPointInTimeOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<ExportTableToPointInTimeOutputResponse>, ClientRuntime.SdkError<ExportTableToPointInTimeOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
    ...
    public func transactWriteItems(input: TransactWriteItemsInput, completion: @escaping (ClientRuntime.SdkResult<TransactWriteItemsOutputResponse, TransactWriteItemsOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<TransactWriteItemsOutputResponse>, ClientRuntime.SdkError<TransactWriteItemsOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
