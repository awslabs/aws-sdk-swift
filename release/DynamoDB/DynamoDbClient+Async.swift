...
public extension DynamoDbClient {
    /// <p>
    ...
    ///                 Guide</i>.</p>
    func batchGetItem(input: BatchGetItemInput) async throws -> BatchGetItemOutputResponse
    {
        typealias batchGetItemContinuation = CheckedContinuation<BatchGetItemOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: batchGetItemContinuation) in
            batchGetItem(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </li>
    ///          </ul>
    func batchWriteItem(input: BatchWriteItemInput) async throws -> BatchWriteItemOutputResponse
    {
        typealias batchWriteItemContinuation = CheckedContinuation<BatchWriteItemOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: batchWriteItemContinuation) in
            batchWriteItem(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///     </p>
    ///          </important>
    func createGlobalTable(input: CreateGlobalTableInput) async throws -> CreateGlobalTableOutputResponse
    {
        typealias createGlobalTableContinuation = CheckedContinuation<CreateGlobalTableOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createGlobalTableContinuation) in
            createGlobalTable(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func deleteItem(input: DeleteItemInput) async throws -> DeleteItemOutputResponse
    {
        typealias deleteItemContinuation = CheckedContinuation<DeleteItemOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteItemContinuation) in
            deleteItem(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeBackup(input: DescribeBackupInput) async throws -> DescribeBackupOutputResponse
    {
        typealias describeBackupContinuation = CheckedContinuation<DescribeBackupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeBackupContinuation) in
            describeBackup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeContinuousBackupsContinuation = CheckedContinuation<DescribeContinuousBackupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeContinuousBackupsContinuation) in
            describeContinuousBackups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeContributorInsightsContinuation = CheckedContinuation<DescribeContributorInsightsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeContributorInsightsContinuation) in
            describeContributorInsights(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///          </note>
    func describeGlobalTable(input: DescribeGlobalTableInput) async throws -> DescribeGlobalTableOutputResponse
    {
        typealias describeGlobalTableContinuation = CheckedContinuation<DescribeGlobalTableOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeGlobalTableContinuation) in
            describeGlobalTable(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29</a> of global tables.</p>
    ///          </note>
    func describeGlobalTableSettings(input: DescribeGlobalTableSettingsInput) async throws -> DescribeGlobalTableSettingsOutputResponse
    {
        typealias describeGlobalTableSettingsContinuation = CheckedContinuation<DescribeGlobalTableSettingsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeGlobalTableSettingsContinuation) in
            describeGlobalTableSettings(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeKinesisStreamingDestination(input: DescribeKinesisStreamingDestinationInput) async throws -> DescribeKinesisStreamingDestinationOutputResponse
    {
        typealias describeKinesisStreamingDestinationContinuation = CheckedContinuation<DescribeKinesisStreamingDestinationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeKinesisStreamingDestinationContinuation) in
            describeKinesisStreamingDestination(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///          </note>
    func describeTableReplicaAutoScaling(input: DescribeTableReplicaAutoScalingInput) async throws -> DescribeTableReplicaAutoScalingOutputResponse
    {
        typealias describeTableReplicaAutoScalingContinuation = CheckedContinuation<DescribeTableReplicaAutoScalingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeTableReplicaAutoScalingContinuation) in
            describeTableReplicaAutoScaling(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeTimeToLive(input: DescribeTimeToLiveInput) async throws -> DescribeTimeToLiveOutputResponse
    {
        typealias describeTimeToLiveContinuation = CheckedContinuation<DescribeTimeToLiveOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeTimeToLiveContinuation) in
            describeTimeToLive(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func disableKinesisStreamingDestination(input: DisableKinesisStreamingDestinationInput) async throws -> DisableKinesisStreamingDestinationOutputResponse
    {
        typealias disableKinesisStreamingDestinationContinuation = CheckedContinuation<DisableKinesisStreamingDestinationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: disableKinesisStreamingDestinationContinuation) in
            disableKinesisStreamingDestination(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             ACTIVE.</p>
    func enableKinesisStreamingDestination(input: EnableKinesisStreamingDestinationInput) async throws -> EnableKinesisStreamingDestinationOutputResponse
    {
        typealias enableKinesisStreamingDestinationContinuation = CheckedContinuation<EnableKinesisStreamingDestinationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: enableKinesisStreamingDestinationContinuation) in
            enableKinesisStreamingDestination(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// </p>
    func executeTransaction(input: ExecuteTransactionInput) async throws -> ExecuteTransactionOutputResponse
    {
        typealias executeTransactionContinuation = CheckedContinuation<ExecuteTransactionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: executeTransactionContinuation) in
            executeTransaction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             window.</p>
    func exportTableToPointInTime(input: ExportTableToPointInTimeInput) async throws -> ExportTableToPointInTimeOutputResponse
    {
        typealias exportTableToPointInTimeContinuation = CheckedContinuation<ExportTableToPointInTimeOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: exportTableToPointInTimeContinuation) in
            exportTableToPointInTime(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getItem(input: GetItemInput) async throws -> GetItemOutputResponse
    {
        typealias getItemContinuation = CheckedContinuation<GetItemOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getItemContinuation) in
            getItem(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listBackups(input: ListBackupsInput) async throws -> ListBackupsOutputResponse
    {
        typealias listBackupsContinuation = CheckedContinuation<ListBackupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listBackupsContinuation) in
            listBackups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listContributorInsights(input: ListContributorInsightsInput) async throws -> ListContributorInsightsOutputResponse
    {
        typealias listContributorInsightsContinuation = CheckedContinuation<ListContributorInsightsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listContributorInsightsContinuation) in
            listContributorInsights(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29</a> of global tables.</p>
    ///          </note>
    func listGlobalTables(input: ListGlobalTablesInput) async throws -> ListGlobalTablesOutputResponse
    {
        typealias listGlobalTablesContinuation = CheckedContinuation<ListGlobalTablesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listGlobalTablesContinuation) in
            listGlobalTables(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listTagsOfResource(input: ListTagsOfResourceInput) async throws -> ListTagsOfResourceOutputResponse
    {
        typealias listTagsOfResourceContinuation = CheckedContinuation<ListTagsOfResourceOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTagsOfResourceContinuation) in
            listTagsOfResource(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func putItem(input: PutItemInput) async throws -> PutItemOutputResponse
    {
        typealias putItemContinuation = CheckedContinuation<PutItemOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putItemContinuation) in
            putItem(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///              </li>
    ///          </ul>
    func restoreTableFromBackup(input: RestoreTableFromBackupInput) async throws -> RestoreTableFromBackupOutputResponse
    {
        typealias restoreTableFromBackupContinuation = CheckedContinuation<RestoreTableFromBackupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: restoreTableFromBackupContinuation) in
            restoreTableFromBackup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///              </li>
    ///          </ul>
    func restoreTableToPointInTime(input: RestoreTableToPointInTimeInput) async throws -> RestoreTableToPointInTimeOutputResponse
    {
        typealias restoreTableToPointInTimeContinuation = CheckedContinuation<RestoreTableToPointInTimeOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: restoreTableToPointInTimeContinuation) in
            restoreTableToPointInTime(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func scan(input: ScanInput) async throws -> ScanOutputResponse
    {
        typealias scanContinuation = CheckedContinuation<ScanOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: scanContinuation) in
            scan(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </li>
    ///          </ul>
    func transactGetItems(input: TransactGetItemsInput) async throws -> TransactGetItemsOutputResponse
    {
        typealias transactGetItemsContinuation = CheckedContinuation<TransactGetItemsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: transactGetItemsContinuation) in
            transactGetItems(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </li>
    ///          </ul>
    func transactWriteItems(input: TransactWriteItemsInput) async throws -> TransactWriteItemsOutputResponse
    {
        typealias transactWriteItemsContinuation = CheckedContinuation<TransactWriteItemsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: transactWriteItemsContinuation) in
            transactWriteItems(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func updateContinuousBackups(input: UpdateContinuousBackupsInput) async throws -> UpdateContinuousBackupsOutputResponse
    {
        typealias updateContinuousBackupsContinuation = CheckedContinuation<UpdateContinuousBackupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateContinuousBackupsContinuation) in
            updateContinuousBackups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func updateContributorInsights(input: UpdateContributorInsightsInput) async throws -> UpdateContributorInsightsOutputResponse
    {
        typealias updateContributorInsightsContinuation = CheckedContinuation<UpdateContributorInsightsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateContributorInsightsContinuation) in
            updateContributorInsights(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </li>
    ///          </ul>
    func updateGlobalTable(input: UpdateGlobalTableInput) async throws -> UpdateGlobalTableOutputResponse
    {
        typealias updateGlobalTableContinuation = CheckedContinuation<UpdateGlobalTableOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateGlobalTableContinuation) in
            updateGlobalTable(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func updateGlobalTableSettings(input: UpdateGlobalTableSettingsInput) async throws -> UpdateGlobalTableSettingsOutputResponse
    {
        typealias updateGlobalTableSettingsContinuation = CheckedContinuation<UpdateGlobalTableSettingsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateGlobalTableSettingsContinuation) in
            updateGlobalTableSettings(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///       operation using the <code>ReturnValues</code> parameter.</p>
    func updateItem(input: UpdateItemInput) async throws -> UpdateItemOutputResponse
    {
        typealias updateItemContinuation = CheckedContinuation<UpdateItemOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateItemContinuation) in
            updateItem(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version 2019.11.21</a> of global tables.</p>
    ///          </note>
    func updateTableReplicaAutoScaling(input: UpdateTableReplicaAutoScalingInput) async throws -> UpdateTableReplicaAutoScalingOutputResponse
    {
        typealias updateTableReplicaAutoScalingContinuation = CheckedContinuation<UpdateTableReplicaAutoScalingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateTableReplicaAutoScalingContinuation) in
            updateTableReplicaAutoScaling(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func updateTimeToLive(input: UpdateTimeToLiveInput) async throws -> UpdateTimeToLiveOutputResponse
    {
        typealias updateTimeToLiveContinuation = CheckedContinuation<UpdateTimeToLiveOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateTimeToLiveContinuation) in
            updateTimeToLive(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
