...
public extension AppSyncClient {
    ...
    {
        typealias associateApiContinuation = CheckedContinuation<AssociateApiOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: associateApiContinuation) in
            associateApi(input: input) { result in
                switch result {
    ...
    {
        typealias disassociateApiContinuation = CheckedContinuation<DisassociateApiOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: disassociateApiContinuation) in
            disassociateApi(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getApiAssociationContinuation = CheckedContinuation<GetApiAssociationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getApiAssociationContinuation) in
            getApiAssociation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
