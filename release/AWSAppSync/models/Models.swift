...
extension AppSyncClientTypes {
    ...
    public struct AdditionalAuthenticationProvider: Swift.Equatable {
        ...
        var authenticationType: AppSyncClientTypes.AuthenticationType?
        /// Configuration for Lambda function authorization.
        var lambdaAuthorizerConfig: AppSyncClientTypes.LambdaAuthorizerConfig?
        /// The OIDC configuration.
        var openIDConnectConfig: AppSyncClientTypes.OpenIDConnectConfig?
        /// The Amazon Cognito user pool configuration.
        var userPoolConfig: AppSyncClientTypes.CognitoUserPoolConfig?
...
extension AppSyncClientTypes {
    ...
    public struct ApiAssociation: Swift.Equatable {
        ...
        var associationStatus: AppSyncClientTypes.AssociationStatus?
        /// Details about the last deployment status.
        var deploymentDetail: Swift.String?
        /// The domain name.
...
extension AppSyncClientTypes {
    ...
    public struct ApiCache: Swift.Equatable {
        ...
        var apiCachingBehavior: AppSyncClientTypes.ApiCachingBehavior?
        ...
        var status: AppSyncClientTypes.ApiCacheStatus?
        ...
        var type: AppSyncClientTypes.ApiCacheType?
...
public struct AssociateApiOutputResponse: Swift.Equatable {
    ...
    var apiAssociation: AppSyncClientTypes.ApiAssociation?
...
extension AppSyncClientTypes {
    ...
    public struct AuthorizationConfig: Swift.Equatable {
        ...
        /// This member is required.
        var authorizationType: AppSyncClientTypes.AuthorizationType?
        /// The Identity and Access Management (IAM) settings.
        var awsIamConfig: AppSyncClientTypes.AwsIamConfig?
...
extension AppSyncClientTypes {
    ...
    public struct AwsIamConfig: Swift.Equatable {
        ...
        var signingRegion: Swift.String?
        /// The signing service name for IAM authorization.
        var signingServiceName: Swift.String?
...
extension AppSyncClientTypes {
    ...
    public struct CognitoUserPoolConfig: Swift.Equatable {
        ...
        var appIdClientRegex: Swift.String?
...
public struct CreateApiCacheOutputResponse: Swift.Equatable {
    /// The ApiCache object.
    var apiCache: AppSyncClientTypes.ApiCache?
...
public struct CreateApiKeyOutputResponse: Swift.Equatable {
    /// The API key.
    var apiKey: AppSyncClientTypes.ApiKey?
...
public struct CreateDataSourceInput: Swift.Equatable {
    ...
    var dynamodbConfig: AppSyncClientTypes.DynamodbDataSourceConfig?
    ...
    var elasticsearchConfig: AppSyncClientTypes.ElasticsearchDataSourceConfig?
    /// HTTP endpoint settings.
    var httpConfig: AppSyncClientTypes.HttpDataSourceConfig?
    /// Lambda settings.
    var lambdaConfig: AppSyncClientTypes.LambdaDataSourceConfig?
    /// A user-supplied name for the DataSource.
    /// This member is required.
    var name: Swift.String?
    /// Amazon OpenSearch Service settings.
    var openSearchServiceConfig: AppSyncClientTypes.OpenSearchServiceDataSourceConfig?
    /// Relational database settings.
    var relationalDatabaseConfig: AppSyncClientTypes.RelationalDatabaseDataSourceConfig?
    /// The Identity and Access Management (IAM) service role Amazon Resource Name (ARN) for the data source. The system assumes this role when accessing the data source.
    var serviceRoleArn: Swift.String?
    /// The type of the DataSource.
    /// This member is required.
    var type: AppSyncClientTypes.DataSourceType?
...
public struct CreateDataSourceOutputResponse: Swift.Equatable {
    ...
    var dataSource: AppSyncClientTypes.DataSource?
...
public struct CreateDomainNameOutputResponse: Swift.Equatable {
    ...
    var domainNameConfig: AppSyncClientTypes.DomainNameConfig?
...
public struct CreateFunctionInput: Swift.Equatable {
    ...
    var requestMappingTemplate: Swift.String?
    /// The Function response mapping template.
    var responseMappingTemplate: Swift.String?
    /// Describes a Sync configuration for a resolver. Specifies which Conflict Detection strategy and Resolution strategy to use when the resolver is invoked.
    var syncConfig: AppSyncClientTypes.SyncConfig?
...
public struct CreateFunctionOutputResponse: Swift.Equatable {
    /// The Function object.
    var functionConfiguration: AppSyncClientTypes.FunctionConfiguration?
...
public struct CreateGraphqlApiInput: Swift.Equatable {
    ...
    var additionalAuthenticationProviders: [AppSyncClientTypes.AdditionalAuthenticationProvider]?
    /// The authentication type: API key, Identity and Access Management (IAM), OpenID Connect (OIDC), Amazon Cognito user pools, or Lambda.
    /// This member is required.
    var authenticationType: AppSyncClientTypes.AuthenticationType?
    /// Configuration for Lambda function authorization.
    ...
    var logConfig: AppSyncClientTypes.LogConfig?
    ...
    /// The Amazon Cognito user pool configuration.
    var userPoolConfig: AppSyncClientTypes.UserPoolConfig?
    /// A flag indicating whether to use X-Ray tracing for the GraphqlApi.
    var xrayEnabled: Swift.Bool
...
public struct CreateGraphqlApiOutputResponse: Swift.Equatable {
    /// The GraphqlApi.
    var graphqlApi: AppSyncClientTypes.GraphqlApi?
...
public struct CreateResolverInput: Swift.Equatable {
    ...
    var cachingConfig: AppSyncClientTypes.CachingConfig?
    ...
    var kind: AppSyncClientTypes.ResolverKind?
    /// The PipelineConfig.
    var pipelineConfig: AppSyncClientTypes.PipelineConfig?
...
public struct CreateResolverOutputResponse: Swift.Equatable {
    /// The Resolver object.
    var resolver: AppSyncClientTypes.Resolver?
...
public struct CreateTypeInput: Swift.Equatable {
    ...
    /// This member is required.
    var format: AppSyncClientTypes.TypeDefinitionFormat?
...
public struct CreateTypeOutputResponse: Swift.Equatable {
    /// The Type object.
    var type: AppSyncClientTypes.ModelType?
...
extension AppSyncClientTypes {
    ...
    public struct DataSource: Swift.Equatable {
        ...
        var dataSourceArn: Swift.String?
...
extension AppSyncClientTypes {
    ...
    public struct DeltaSyncConfig: Swift.Equatable {
        ...
        var baseTableTTL: Swift.Int
        /// The Delta Sync table name.
        var deltaSyncTableName: Swift.String?
        /// The number of minutes that a Delta Sync log entry is stored in the Delta Sync table.
        var deltaSyncTableTTL: Swift.Int
...
extension AppSyncClientTypes {
    ...
    public struct DomainNameConfig: Swift.Equatable {
        ...
        var appsyncDomainName: Swift.String?
        /// The Amazon Resource Name (ARN) of the certificate. This can be an Certificate Manager (ACM) certificate or an Identity and Access Management (IAM) server certificate.
        var certificateArn: Swift.String?
...
extension AppSyncClientTypes {
    ...
    public struct DynamodbDataSourceConfig: Swift.Equatable {
        ...
        var deltaSyncConfig: AppSyncClientTypes.DeltaSyncConfig?
        /// The table name.
        /// This member is required.
        var tableName: Swift.String?
        /// Set to TRUE to use Amazon Cognito credentials with this data source.
        var useCallerCredentials: Swift.Bool
        /// Set to TRUE to use Conflict Detection and Resolution with this data source.
        var versioned: Swift.Bool
...
public struct GetIntrospectionSchemaInput: Swift.Equatable {
    ...
    /// This member is required.
    var format: AppSyncClientTypes.OutputType?
    /// A flag that specifies whether the schema introspection should contain directives.
    var includeDirectives: Swift.Bool?
...
public struct GetSchemaCreationStatusOutputResponse: Swift.Equatable {
    ...
    var status: AppSyncClientTypes.SchemaStatus?
...
extension AppSyncClientTypes {
    ...
    public struct HttpDataSourceConfig: Swift.Equatable {
        /// The authorization configuration in case the HTTP endpoint requires authorization.
        var authorizationConfig: AppSyncClientTypes.AuthorizationConfig?
...
extension AppSyncClientTypes {
    ...
    public struct LambdaConflictHandlerConfig: Swift.Equatable {
        ...
        var lambdaConflictHandlerArn: Swift.String?
...
public struct ListApiKeysOutputResponse: Swift.Equatable {
    /// The ApiKey objects.
    var apiKeys: [AppSyncClientTypes.ApiKey]?
...
public struct ListDataSourcesOutputResponse: Swift.Equatable {
    ...
    var dataSources: [AppSyncClientTypes.DataSource]?
    /// An identifier to pass in the next request to this operation to return the next set of items in the list.
    var nextToken: Swift.String?
...
public struct ListDomainNamesOutputResponse: Swift.Equatable {
    ...
    var domainNameConfigs: [AppSyncClientTypes.DomainNameConfig]?
    /// The API token.
    var nextToken: Swift.String?
...
public struct ListFunctionsOutputResponse: Swift.Equatable {
    ...
    var functions: [AppSyncClientTypes.FunctionConfiguration]?
    /// An identifier that was returned from the previous call to this operation, which you can use to return the next set of items in the list.
    var nextToken: Swift.String?
...
public struct ListGraphqlApisOutputResponse: Swift.Equatable {
    ...
    var graphqlApis: [AppSyncClientTypes.GraphqlApi]?
    /// An identifier to pass in the next request to this operation to return the next set of items in the list.
    var nextToken: Swift.String?
...
public struct ListResolversByFunctionOutputResponse: Swift.Equatable {
    ...
    var resolvers: [AppSyncClientTypes.Resolver]?
...
public struct ListTypesOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// The Type objects.
    var types: [AppSyncClientTypes.ModelType]?
...
extension AppSyncClientTypes {
    ...
    public struct LogConfig: Swift.Equatable {
        ...
        /// This member is required.
        var cloudWatchLogsRoleArn: Swift.String?
        /// Set to TRUE to exclude sections that contain information such as headers, context, and evaluated mapping templates, regardless of logging level.
        var excludeVerboseContent: Swift.Bool
        ...
        /// This member is required.
        var fieldLogLevel: AppSyncClientTypes.FieldLogLevel?
...
extension AppSyncClientTypes {
    ...
    public struct RdsHttpEndpointConfig: Swift.Equatable {
        ...
        var awsSecretStoreArn: Swift.String?
...
extension AppSyncClientTypes {
    ...
    public struct RelationalDatabaseDataSourceConfig: Swift.Equatable {
        ...
        var rdsHttpEndpointConfig: AppSyncClientTypes.RdsHttpEndpointConfig?
        ...
        var relationalDatabaseSourceType: AppSyncClientTypes.RelationalDatabaseSourceType?
...
public struct StartSchemaCreationInput: Swift.Equatable {
    ...
    /// This member is required.
    var definition: ClientRuntime.Data?
...
extension AppSyncClientTypes {
    ...
    public struct SyncConfig: Swift.Equatable {
        ...
        var conflictDetection: AppSyncClientTypes.ConflictDetectionType?
        ...
        var conflictHandler: AppSyncClientTypes.ConflictHandlerType?
        /// The LambdaConflictHandlerConfig when configuring LAMBDA as the Conflict Handler.
        var lambdaConflictHandlerConfig: AppSyncClientTypes.LambdaConflictHandlerConfig?
...
extension AppSyncClientTypes {
    ...
    public struct UserPoolConfig: Swift.Equatable {
        ...
        /// This member is required.
        var defaultAction: AppSyncClientTypes.DefaultAction?
        /// The user pool ID.
        /// This member is required.
        var userPoolId: Swift.String?
