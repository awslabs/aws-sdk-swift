...
public protocol AppSyncClientProtocol {
    ...
    func associateApi(input: AssociateApiInput, completion: @escaping (ClientRuntime.SdkResult<AssociateApiOutputResponse, AssociateApiOutputError>) -> Void)
    ...
    func disassociateApi(input: DisassociateApiInput, completion: @escaping (ClientRuntime.SdkResult<DisassociateApiOutputResponse, DisassociateApiOutputError>) -> Void)
    ...
    func getApiAssociation(input: GetApiAssociationInput, completion: @escaping (ClientRuntime.SdkResult<GetApiAssociationOutputResponse, GetApiAssociationOutputError>) -> Void)
