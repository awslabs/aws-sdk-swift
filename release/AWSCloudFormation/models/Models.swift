...
extension CloudFormationClientTypes {
    ...
    public struct AccountGateResult: Swift.Equatable {
        ...
        var status: CloudFormationClientTypes.AccountGateStatus?
...
extension ActivateTypeInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct ActivateTypeInput: Swift.Equatable {
    ...
    var loggingConfig: CloudFormationClientTypes.LoggingConfig?
    ...
    var typeNameAlias: Swift.String?
    /// Manually updates a previously-activated type to a new major or minor version, if available. You can also use this parameter to update the value of AutoUpdate.
    ///
    /// * MAJOR: CloudFormation updates the extension to the newest major version, if one is available.
    ///
    /// * MINOR: CloudFormation updates the extension to the newest minor version, if one is available.
    var versionBump: CloudFormationClientTypes.VersionBump?
...
extension CloudFormationClientTypes {
    ...
    public struct AutoDeployment: Swift.Equatable {
        ...
        var retainStacksOnAccountRemoval: Swift.Bool?
...
extension CloudFormationClientTypes.BatchDescribeTypeConfigurationsError: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CloudFormationClientTypes {
    ...
    public struct BatchDescribeTypeConfigurationsError: Swift.Equatable {
        ...
        var typeConfigurationIdentifier: CloudFormationClientTypes.TypeConfigurationIdentifier?
...
extension BatchDescribeTypeConfigurationsInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct BatchDescribeTypeConfigurationsInput: Swift.Equatable {
    ...
    var typeConfigurationIdentifiers: [CloudFormationClientTypes.TypeConfigurationIdentifier]?
...
public struct BatchDescribeTypeConfigurationsOutputResponse: Swift.Equatable {
    ...
    var errors: [CloudFormationClientTypes.BatchDescribeTypeConfigurationsError]?
    /// A list of any of the specified extension configurations from the CloudFormation registry.
    var typeConfigurations: [CloudFormationClientTypes.TypeConfigurationDetails]?
    /// A list of any of the specified extension configurations that CloudFormation could not process for any reason.
    var unprocessedTypeConfigurations: [CloudFormationClientTypes.TypeConfigurationIdentifier]?
...
extension CloudFormationClientTypes {
    ...
    public struct Change: Swift.Equatable {
        ...
        var resourceChange: CloudFormationClientTypes.ResourceChange?
        /// The type of entity that CloudFormation changes. Currently, the only entity type is Resource.
        var type: CloudFormationClientTypes.ChangeType?
...
extension CloudFormationClientTypes {
    ...
    public struct ChangeSetSummary: Swift.Equatable {
        ...
        var changeSetName: Swift.String?
        /// The start time when the change set was created, in UTC.
        var creationTime: ClientRuntime.Date?
        /// Descriptive information about the change set.
        var description: Swift.String?
        /// If the change set execution status is AVAILABLE, you can execute the change set. If you can’t execute the change set, the status indicates why. For example, a change set might be in an UNAVAILABLE state because CloudFormation is still creating it or in an OBSOLETE state because the stack was already updated.
        var executionStatus: CloudFormationClientTypes.ExecutionStatus?
        /// Specifies the current setting of IncludeNestedStacks for the change set.
        var includeNestedStacks: Swift.Bool?
        /// The parent change set ID.
        var parentChangeSetId: Swift.String?
        /// The root change set ID.
        var rootChangeSetId: Swift.String?
        /// The ID of the stack with which the change set is associated.
        var stackId: Swift.String?
        /// The name of the stack with which the change set is associated.
        var stackName: Swift.String?
        /// The state of the change set, such as CREATE_IN_PROGRESS, CREATE_COMPLETE, or FAILED.
        var status: CloudFormationClientTypes.ChangeSetStatus?
...
public struct ContinueUpdateRollbackInput: Swift.Equatable {
    ...
    var resourcesToSkip: [Swift.String]?
...
public struct CreateChangeSetInput: Swift.Equatable {
    ...
    var capabilities: [CloudFormationClientTypes.Capability]?
    ...
    var changeSetType: CloudFormationClientTypes.ChangeSetType?
    ...
    var parameters: [CloudFormationClientTypes.Parameter]?
    ...
    var resourceTypes: [Swift.String]?
    /// The resources to import into your stack.
    var resourcesToImport: [CloudFormationClientTypes.ResourceToImport]?
    ...
    var rollbackConfiguration: CloudFormationClientTypes.RollbackConfiguration?
    ...
    var tags: [CloudFormationClientTypes.Tag]?
    ...
    var templateURL: Swift.String?
    /// Whether to reuse the template that is associated with the stack to create the change set.
    var usePreviousTemplate: Swift.Bool?
...
public struct CreateStackInput: Swift.Equatable {
    ...
    var disableRollback: Swift.Bool?
    ...
    var enableTerminationProtection: Swift.Bool?
    ...
    var onFailure: CloudFormationClientTypes.OnFailure?
    ...
    var stackPolicyBody: Swift.String?
    /// Location of a file containing the stack policy. The URL must point to a policy (maximum size: 16 KB) located in an S3 bucket in the same Region as the stack. You can specify either the StackPolicyBody or the StackPolicyURL parameter, but not both.
    var stackPolicyURL: Swift.String?
...
public struct CreateStackInstancesInput: Swift.Equatable {
    ...
    var callAs: CloudFormationClientTypes.CallAs?
    ...
    var deploymentTargets: CloudFormationClientTypes.DeploymentTargets?
    ...
    var operationPreferences: CloudFormationClientTypes.StackSetOperationPreferences?
    ...
    var parameterOverrides: [CloudFormationClientTypes.Parameter]?
    ...
    /// This member is required.
    var regions: [Swift.String]?
    /// The name or unique ID of the stack set that you want to create stack instances from.
    /// This member is required.
    var stackSetName: Swift.String?
...
public struct CreateStackSetInput: Swift.Equatable {
    ...
    var administrationRoleARN: Swift.String?
    ...
    var autoDeployment: CloudFormationClientTypes.AutoDeployment?
    /// [Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account. By default, SELF is specified. Use SELF for stack sets with self-managed permissions.
    ///
    ...
    var executionRoleName: Swift.String?
    /// Describes whether StackSets performs non-conflicting operations concurrently and queues conflicting operations.
    var managedExecution: CloudFormationClientTypes.ManagedExecution?
    ...
    var permissionModel: CloudFormationClientTypes.PermissionModels?
...
extension DeactivateTypeInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let arn = arn {
...
public struct DeleteStackInput: Swift.Equatable {
    ...
    var retainResources: [Swift.String]?
...
extension CloudFormationClientTypes {
    ...
    public struct DeploymentTargets: Swift.Equatable {
        ...
        var accountsUrl: Swift.String?
        /// The organization root ID or organizational unit (OU) IDs to which StackSets deploys.
        var organizationalUnitIds: [Swift.String]?
...
public struct DeregisterTypeInput: Swift.Equatable {
    ...
    var type: CloudFormationClientTypes.RegistryType?
...
public struct DescribeAccountLimitsOutputResponse: Swift.Equatable {
    ...
    var accountLimits: [CloudFormationClientTypes.AccountLimit]?
...
public struct DescribeChangeSetOutputResponse: Swift.Equatable {
    ...
    var changes: [CloudFormationClientTypes.Change]?
    /// The start time when the change set was created, in UTC.
    var creationTime: ClientRuntime.Date?
...
extension DescribePublisherInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let publisherId = publisherId {
            try container.encode(publisherId, forKey: ClientRuntime.Key("PublisherId"))
...
public struct DescribePublisherOutputResponse: Swift.Equatable {
    ...
    var identityProvider: CloudFormationClientTypes.IdentityProvider?
    /// The ID of the extension publisher.
    var publisherId: Swift.String?
    /// The URL to the publisher's profile with the identity provider.
    var publisherProfile: Swift.String?
    /// Whether the publisher is verified. Currently, all registered publishers are verified.
    var publisherStatus: CloudFormationClientTypes.PublisherStatus?
...
public struct DescribeStackDriftDetectionStatusInput: Swift.Equatable {
    ...
    /// This member is required.
    var stackDriftDetectionId: Swift.String?
...
public struct DescribeStackDriftDetectionStatusOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var detectionStatus: CloudFormationClientTypes.StackDriftDetectionStatus?
    /// The reason the stack drift detection operation has its current status.
    var detectionStatusReason: Swift.String?
    ...
    var driftedStackResourceCount: Swift.Int?
    ...
    var stackDriftStatus: CloudFormationClientTypes.StackDriftStatus?
    /// The ID of the stack.
    /// This member is required.
    var stackId: Swift.String?
...
public struct DescribeStackEventsOutputResponse: Swift.Equatable {
    ...
    var stackEvents: [CloudFormationClientTypes.StackEvent]?
...
public struct DescribeStackInstanceInput: Swift.Equatable {
    ...
    /// This member is required.
    var stackInstanceAccount: Swift.String?
    /// The name of a Region that's associated with this stack instance.
    /// This member is required.
    var stackInstanceRegion: Swift.String?
...
public struct DescribeStackInstanceOutputResponse: Swift.Equatable {
    ...
    var stackInstance: CloudFormationClientTypes.StackInstance?
...
public struct DescribeStackResourceDriftsInput: Swift.Equatable {
    ...
    var stackResourceDriftStatusFilters: [CloudFormationClientTypes.StackResourceDriftStatus]?
...
public struct DescribeStackResourceDriftsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var stackResourceDrifts: [CloudFormationClientTypes.StackResourceDrift]?
...
public struct DescribeStackResourceOutputResponse: Swift.Equatable {
    ...
    var stackResourceDetail: CloudFormationClientTypes.StackResourceDetail?
...
public struct DescribeStackResourcesOutputResponse: Swift.Equatable {
    ...
    var stackResources: [CloudFormationClientTypes.StackResource]?
...
public struct DescribeStackSetOperationOutputResponse: Swift.Equatable {
    ...
    var stackSetOperation: CloudFormationClientTypes.StackSetOperation?
...
public struct DescribeStackSetOutputResponse: Swift.Equatable {
    ...
    var stackSet: CloudFormationClientTypes.StackSet?
...
public struct DescribeStacksOutputResponse: Swift.Equatable {
    ...
    var stacks: [CloudFormationClientTypes.Stack]?
...
public struct DescribeTypeInput: Swift.Equatable {
    ...
    var publicVersionNumber: Swift.String?
...
public struct DescribeTypeOutputResponse: Swift.Equatable {
    ...
    var configurationSchema: Swift.String?
    ...
    var defaultVersionId: Swift.String?
    ...
    var deprecatedStatus: CloudFormationClientTypes.DeprecatedStatus?
    /// The description of the extension.
    var description: Swift.String?
    /// The URL of a page providing detailed documentation for this extension.
    var documentationUrl: Swift.String?
    ...
    var isDefaultVersion: Swift.Bool?
    ...
    var latestPublicVersion: Swift.String?
    ...
    var originalTypeArn: Swift.String?
    ...
    var originalTypeName: Swift.String?
    ...
    ///
    /// * delete
    var provisioningType: CloudFormationClientTypes.ProvisioningType?
    ...
    var requiredActivatedTypes: [CloudFormationClientTypes.RequiredActivatedType]?
    ...
    var sourceUrl: Swift.String?
    /// When the specified private extension version was registered or activated in your account.
    var timeCreated: ClientRuntime.Date?
    ...
    var typeTestsStatus: CloudFormationClientTypes.TypeTestsStatus?
    ...
    var typeTestsStatusDescription: Swift.String?
    ...
    var visibility: CloudFormationClientTypes.Visibility?
...
public struct DescribeTypeRegistrationOutputResponse: Swift.Equatable {
    ...
    var progressStatus: CloudFormationClientTypes.RegistrationStatus?
    ...
    var typeVersionArn: Swift.String?
...
public struct DetectStackDriftInput: Swift.Equatable {
    ...
    var logicalResourceIds: [Swift.String]?
...
public struct DetectStackResourceDriftOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var stackResourceDrift: CloudFormationClientTypes.StackResourceDrift?
...
extension CloudFormationClientTypes {
    ...
    public struct Export: Swift.Equatable {
        ...
        var exportingStackId: Swift.String?
...
public struct GetTemplateInput: Swift.Equatable {
    ...
    var templateStage: CloudFormationClientTypes.TemplateStage?
...
public struct GetTemplateOutputResponse: Swift.Equatable {
    ...
    var stagesAvailable: [CloudFormationClientTypes.TemplateStage]?
...
public struct GetTemplateSummaryOutputResponse: Swift.Equatable {
    ...
    var capabilitiesReason: Swift.String?
    /// A list of the transforms that are declared in the template.
    var declaredTransforms: [Swift.String]?
    /// The value that is defined in the Description property of the template.
    var description: Swift.String?
    /// The value that is defined for the Metadata property of the template.
    var metadata: Swift.String?
    /// A list of parameter declarations that describe various properties for each parameter.
    var parameters: [CloudFormationClientTypes.ParameterDeclaration]?
    /// A list of resource identifier summaries that describe the target resources of an import operation and the properties you can provide during the import to identify the target resources. For example, BucketName is a possible identifier property for an AWS::S3::Bucket resource.
    var resourceIdentifierSummaries: [CloudFormationClientTypes.ResourceIdentifierSummary]?
...
extension ImportStacksToStackSetInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let callAs = callAs {
            try container.encode(callAs, forKey: ClientRuntime.Key("CallAs"))
...
public struct ListChangeSetsOutputResponse: Swift.Equatable {
    ...
    var summaries: [CloudFormationClientTypes.ChangeSetSummary]?
...
public struct ListExportsOutputResponse: Swift.Equatable {
    ...
    var exports: [CloudFormationClientTypes.Export]?
...
public struct ListStackInstancesInput: Swift.Equatable {
    ...
    var filters: [CloudFormationClientTypes.StackInstanceFilter]?
    /// The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a NextToken value that you can assign to the NextToken request parameter to get the next set of results.
    var maxResults: Swift.Int?
...
public struct ListStackInstancesOutputResponse: Swift.Equatable {
    ...
    var summaries: [CloudFormationClientTypes.StackInstanceSummary]?
...
public struct ListStackResourcesOutputResponse: Swift.Equatable {
    ...
    var stackResourceSummaries: [CloudFormationClientTypes.StackResourceSummary]?
...
public struct ListStackSetOperationResultsOutputResponse: Swift.Equatable {
    ...
    var summaries: [CloudFormationClientTypes.StackSetOperationResultSummary]?
...
public struct ListStackSetOperationsOutputResponse: Swift.Equatable {
    ...
    var summaries: [CloudFormationClientTypes.StackSetOperationSummary]?
...
public struct ListStackSetsInput: Swift.Equatable {
    ...
    var status: CloudFormationClientTypes.StackSetStatus?
...
public struct ListStackSetsOutputResponse: Swift.Equatable {
    ...
    var summaries: [CloudFormationClientTypes.StackSetSummary]?
...
public struct ListStacksInput: Swift.Equatable {
    ...
    var stackStatusFilter: [CloudFormationClientTypes.StackStatus]?
...
public struct ListStacksOutputResponse: Swift.Equatable {
    ...
    var stackSummaries: [CloudFormationClientTypes.StackSummary]?
...
public struct ListTypeRegistrationsInput: Swift.Equatable {
    ...
    var registrationStatusFilter: CloudFormationClientTypes.RegistrationStatus?
    /// The kind of extension. Conditional: You must specify either TypeName and Type, or Arn.
    var type: CloudFormationClientTypes.RegistryType?
    /// The Amazon Resource Name (ARN) of the extension. Conditional: You must specify either TypeName and Type, or Arn.
    var typeArn: Swift.String?
...
public struct ListTypeRegistrationsOutputResponse: Swift.Equatable {
    ...
    var registrationTokenList: [Swift.String]?
...
public struct ListTypeVersionsOutputResponse: Swift.Equatable {
    ...
    var typeVersionSummaries: [CloudFormationClientTypes.TypeVersionSummary]?
...
public struct ListTypesInput: Swift.Equatable {
    ...
    var filters: CloudFormationClientTypes.TypeFilters?
    /// The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a NextToken value that you can assign to the NextToken request parameter to get the next set of results.
    var maxResults: Swift.Int?
    /// If the previous paginated request didn't return all of the remaining results, the response object's NextToken parameter value is set to a token. To retrieve the next set of results, call this action again and assign that token to the request object's NextToken parameter. If there are no remaining results, the previous response object's NextToken parameter is set to null.
    var nextToken: Swift.String?
...
public struct ListTypesOutputResponse: Swift.Equatable {
    ...
    var typeSummaries: [CloudFormationClientTypes.TypeSummary]?
...
extension CloudFormationClientTypes.ManagedExecution: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case active = "Active"
    }
...
extension CloudFormationClientTypes {
    ...
    public struct ModuleInfo: Swift.Equatable {
        ...
        var logicalIdHierarchy: Swift.String?
        ...
        var typeHierarchy: Swift.String?
...
extension CloudFormationClientTypes {
    ...
    public struct Parameter: Swift.Equatable {
        ...
        var resolvedValue: Swift.String?
...
extension CloudFormationClientTypes {
    ...
    public struct ParameterDeclaration: Swift.Equatable {
        ...
        var parameterConstraints: CloudFormationClientTypes.ParameterConstraints?
...
extension CloudFormationClientTypes {
    ...
    public struct PropertyDifference: Swift.Equatable {
        ...
        /// This member is required.
        var differenceType: CloudFormationClientTypes.DifferenceType?
        /// The expected property value of the resource property, as defined in the stack template and any values specified as template parameters.
        /// This member is required.
        var expectedValue: Swift.String?
        /// The fully-qualified path to the resource property.
        /// This member is required.
        var propertyPath: Swift.String?
...
extension PublishTypeInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let arn = arn {
            try container.encode(arn, forKey: ClientRuntime.Key("Arn"))
...
public struct RecordHandlerProgressInput: Swift.Equatable {
    ...
    /// This member is required.
    var bearerToken: Swift.String?
    /// Reserved for use by the [CloudFormation CLI](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html).
    var clientRequestToken: Swift.String?
    /// Reserved for use by the [CloudFormation CLI](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html).
    var currentOperationStatus: CloudFormationClientTypes.OperationStatus?
    /// Reserved for use by the [CloudFormation CLI](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html).
    var errorCode: CloudFormationClientTypes.HandlerErrorCode?
    /// Reserved for use by the [CloudFormation CLI](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html).
    /// This member is required.
    var operationStatus: CloudFormationClientTypes.OperationStatus?
    /// Reserved for use by the [CloudFormation CLI](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html).
    var resourceModel: Swift.String?
    /// Reserved for use by the [CloudFormation CLI](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html).
...
extension RegisterPublisherInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct RegisterPublisherInput: Swift.Equatable {
    ...
    var acceptTermsAndConditions: Swift.Bool?
...
public struct RegisterTypeInput: Swift.Equatable {
    ...
    /// This member is required.
    var schemaHandlerPackage: Swift.String?
    /// The kind of extension.
    var type: CloudFormationClientTypes.RegistryType?
...
extension CloudFormationClientTypes.RequiredActivatedType: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case originalTypeName = "OriginalTypeName"
        case publisherId = "PublisherId"
...
extension CloudFormationClientTypes {
    ...
    public struct RequiredActivatedType: Swift.Equatable {
        ...
        var supportedMajorVersions: [Swift.Int]?
...
extension CloudFormationClientTypes {
    ...
    public struct ResourceChange: Swift.Equatable {
        ...
        var action: CloudFormationClientTypes.ChangeAction?
        ...
        var details: [CloudFormationClientTypes.ResourceChangeDetail]?
        /// The resource's logical ID, which is defined in the stack's template.
        var logicalResourceId: Swift.String?
        /// Contains information about the module from which the resource was created, if the resource was created from a module included in the stack template.
        var moduleInfo: CloudFormationClientTypes.ModuleInfo?
        ...
        var replacement: CloudFormationClientTypes.Replacement?
        /// The type of CloudFormation resource, such as AWS::S3::Bucket.
        var resourceType: Swift.String?
        /// For the Modify action, indicates which resource attribute is triggering this update, such as a change in the resource attribute's Metadata, Properties, or Tags.
        var scope: [CloudFormationClientTypes.ResourceAttribute]?
...
extension CloudFormationClientTypes {
    ...
    public struct ResourceChangeDetail: Swift.Equatable {
        ...
        var changeSource: CloudFormationClientTypes.ChangeSource?
        ...
        var evaluation: CloudFormationClientTypes.EvaluationType?
        ...
        var target: CloudFormationClientTypes.ResourceTargetDefinition?
...
extension CloudFormationClientTypes {
    ...
    public struct ResourceIdentifierSummary: Swift.Equatable {
        ...
        var resourceIdentifiers: [Swift.String]?
...
extension CloudFormationClientTypes {
    ...
    public struct ResourceTargetDefinition: Swift.Equatable {
        ...
        var attribute: CloudFormationClientTypes.ResourceAttribute?
        ...
        var requiresRecreation: CloudFormationClientTypes.RequiresRecreation?
...
extension CloudFormationClientTypes {
    ...
    public struct ResourceToImport: Swift.Equatable {
        ...
        /// This member is required.
        var resourceIdentifier: [Swift.String:Swift.String]?
...
extension CloudFormationClientTypes {
    ...
    public struct RollbackConfiguration: Swift.Equatable {
        ...
        var monitoringTimeInMinutes: Swift.Int?
        ...
        var rollbackTriggers: [CloudFormationClientTypes.RollbackTrigger]?
...
extension RollbackStackInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let clientRequestToken = clientRequestToken {
            try container.encode(clientRequestToken, forKey: ClientRuntime.Key("ClientRequestToken"))
...
extension SetTypeConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct SetTypeConfigurationInput: Swift.Equatable {
    ...
    var configurationAlias: Swift.String?
...
public struct SignalResourceInput: Swift.Equatable {
    ...
    /// This member is required.
    var status: CloudFormationClientTypes.ResourceSignalStatus?
...
extension CloudFormationClientTypes {
    ...
    public struct Stack: Swift.Equatable {
        ...
        var deletionTime: ClientRuntime.Date?
        ...
        var driftInformation: CloudFormationClientTypes.StackDriftInformation?
        ...
        var outputs: [CloudFormationClientTypes.Output]?
        ...
        /// This member is required.
        var stackStatus: CloudFormationClientTypes.StackStatus?
        /// Success/failure message associated with the stack status.
        var stackStatusReason: Swift.String?
...
extension CloudFormationClientTypes {
    ...
    public struct StackDriftInformation: Swift.Equatable {
        ...
        var lastCheckTimestamp: ClientRuntime.Date?
...
extension CloudFormationClientTypes {
    ...
    public struct StackEvent: Swift.Equatable {
        ...
        var resourceProperties: Swift.String?
        /// Current status of the resource.
        var resourceStatus: CloudFormationClientTypes.ResourceStatus?
        /// Success/failure message associated with the resource.
        var resourceStatusReason: Swift.String?
...
extension CloudFormationClientTypes {
    ...
    public struct StackInstance: Swift.Equatable {
        ...
        ///
        /// * UNKNOWN: This value is reserved for future use.
        var driftStatus: CloudFormationClientTypes.StackDriftStatus?
        ...
        var lastDriftCheckTimestamp: ClientRuntime.Date?
        ...
        var organizationalUnitId: Swift.String?
        ...
        var stackInstanceStatus: CloudFormationClientTypes.StackInstanceComprehensiveStatus?
        ...
        var status: CloudFormationClientTypes.StackInstanceStatus?
...
extension CloudFormationClientTypes {
    ...
    public struct StackInstanceComprehensiveStatus: Swift.Equatable {
        ...
        var detailedStatus: CloudFormationClientTypes.StackInstanceDetailedStatus?
...
extension CloudFormationClientTypes {
    ...
    public struct StackInstanceFilter: Swift.Equatable {
        ...
        var name: CloudFormationClientTypes.StackInstanceFilterName?
...
extension CloudFormationClientTypes {
    ...
    public struct StackResource: Swift.Equatable {
        ...
        var driftInformation: CloudFormationClientTypes.StackResourceDriftInformation?
        /// The logical name of the resource specified in the template.
        /// This member is required.
        var logicalResourceId: Swift.String?
        /// Contains information about the module from which the resource was created, if the resource was created from a module included in the stack template.
...
extension CloudFormationClientTypes {
    ...
    public struct StackResourceDrift: Swift.Equatable {
        ...
        var actualProperties: Swift.String?
        ...
        var expectedProperties: Swift.String?
        /// The logical name of the resource specified in the template.
        /// This member is required.
        var logicalResourceId: Swift.String?
        /// Contains information about the module from which the resource was created, if the resource was created from a module included in the stack template.
        ...
        var physicalResourceIdContext: [CloudFormationClientTypes.PhysicalResourceIdContextKeyValuePair]?
        /// A collection of the resource properties whose actual values differ from their expected values. These will be present only for resources whose StackResourceDriftStatus is MODIFIED.
        var propertyDifferences: [CloudFormationClientTypes.PropertyDifference]?
        ...
        /// * NOT_CHECKED: CloudFormation does not currently return this value.
        /// This member is required.
        var stackResourceDriftStatus: CloudFormationClientTypes.StackResourceDriftStatus?
...
extension CloudFormationClientTypes {
    ...
    public struct StackResourceSummary: Swift.Equatable {
        /// Information about whether the resource's actual configuration differs, or has drifted, from its expected configuration, as defined in the stack template and any values specified as template parameters. For more information, see [Detecting Unregulated Configuration Changes to Stacks and Resources](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-stack-drift.html).
        var driftInformation: CloudFormationClientTypes.StackResourceDriftInformationSummary?
        /// Time the status was updated.
        /// This member is required.
        var lastUpdatedTimestamp: ClientRuntime.Date?
        /// The logical name of the resource specified in the template.
...
extension CloudFormationClientTypes {
    ...
    public struct StackSet: Swift.Equatable {
        ...
        var stackSetDriftDetectionDetails: CloudFormationClientTypes.StackSetDriftDetectionDetails?
...
extension CloudFormationClientTypes {
    ...
    public struct StackSetDriftDetectionDetails: Swift.Equatable {
        ...
        var driftDetectionStatus: CloudFormationClientTypes.StackSetDriftDetectionStatus?
        ...
        var driftStatus: CloudFormationClientTypes.StackSetDriftStatus?
        ...
        var driftedStackInstancesCount: Swift.Int
        /// The number of stack instances for which the drift detection operation failed.
        var failedStackInstancesCount: Swift.Int
        /// The number of stack instances that are currently being checked for drift.
        var inProgressStackInstancesCount: Swift.Int
        /// The number of stack instances which match the expected template and parameter configuration of the stack set.
        var inSyncStackInstancesCount: Swift.Int
        ...
        var totalStackInstancesCount: Swift.Int
...
extension CloudFormationClientTypes {
    ...
    public struct StackSetOperation: Swift.Equatable {
        ...
        var action: CloudFormationClientTypes.StackSetOperationAction?
        ...
        var endTimestamp: ClientRuntime.Date?
        /// The name of the IAM execution role used to create or update the stack set. Use customized execution roles to control which stack resources users and groups can include in their stack sets.
        var executionRoleName: Swift.String?
        ...
        var status: CloudFormationClientTypes.StackSetOperationStatus?
...
extension CloudFormationClientTypes {
    ...
    public struct StackSetOperationPreferences: Swift.Equatable {
        ...
        var failureToleranceCount: Swift.Int?
        ...
        var failureTolerancePercentage: Swift.Int?
        ...
        var maxConcurrentCount: Swift.Int?
        ...
        var maxConcurrentPercentage: Swift.Int?
        /// The concurrency type of deploying StackSets operations in Regions, could be in parallel or one Region at a time.
        var regionConcurrencyType: CloudFormationClientTypes.RegionConcurrencyType?
        /// The order of the Regions in where you want to perform the stack operation.
        var regionOrder: [Swift.String]?
...
extension CloudFormationClientTypes {
    ...
    public struct StackSetOperationResultSummary: Swift.Equatable {
        ...
        var accountGateResult: CloudFormationClientTypes.AccountGateResult?
        /// [Service-managed permissions] The organization root ID or organizational unit (OU) IDs that you specified for [DeploymentTargets](https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_DeploymentTargets.html).
        var organizationalUnitId: Swift.String?
        ...
        ///
        /// * SUCCEEDED: The operation in the specified account and Region completed successfully.
        var status: CloudFormationClientTypes.StackSetOperationResultStatus?
...
extension CloudFormationClientTypes {
    ...
    public struct StackSummary: Swift.Equatable {
        ...
        var driftInformation: CloudFormationClientTypes.StackDriftInformationSummary?
        /// The time the stack was last updated. This field will only be returned if the stack has been updated at least once.
        var lastUpdatedTime: ClientRuntime.Date?
        /// For nested stacks--stacks created as resources for another stack--the stack ID of the direct parent of this stack. For the first level of nested stacks, the root stack is also the parent stack. For more information, see [Working with Nested Stacks](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-nested-stacks.html) in the CloudFormation User Guide.
        var parentId: Swift.String?
        ...
        var templateDescription: Swift.String?
...
extension TestTypeInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let arn = arn {
            try container.encode(arn, forKey: ClientRuntime.Key("Arn"))
...
public struct TestTypeInput: Swift.Equatable {
    ...
    var logDeliveryBucket: Swift.String?
...
extension CloudFormationClientTypes.TypeConfigurationDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case alias = "Alias"
        case arn = "Arn"
...
extension CloudFormationClientTypes {
    ...
    public struct TypeConfigurationDetails: Swift.Equatable {
        ...
        var isDefaultConfiguration: Swift.Bool?
...
extension CloudFormationClientTypes.TypeConfigurationIdentifier: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case type = "Type"
        case typeArn = "TypeArn"
...
extension CloudFormationClientTypes.TypeFilters: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CloudFormationClientTypes {
    ...
    public struct TypeFilters: Swift.Equatable {
        ...
        var category: CloudFormationClientTypes.Category?
        ...
        var typeNamePrefix: Swift.String?
...
extension CloudFormationClientTypes {
    ...
    public struct TypeSummary: Swift.Equatable {
        ...
        var publisherIdentity: CloudFormationClientTypes.IdentityProvider?
        ...
        var publisherName: Swift.String?
        /// The kind of extension.
        var type: CloudFormationClientTypes.RegistryType?
        /// The Amazon Resource Name (ARN) of the extension.
        var typeArn: Swift.String?
...
public struct UpdateStackInput: Swift.Equatable {
    ...
    var stackPolicyDuringUpdateBody: Swift.String?
    /// Location of a file containing the temporary overriding stack policy. The URL must point to a policy (max size: 16KB) located in an S3 bucket in the same Region as the stack. You can specify either the StackPolicyDuringUpdateBody or the StackPolicyDuringUpdateURL parameter, but not both. If you want to update protected resources, specify a temporary overriding stack policy during this update. If you do not specify a stack policy, the current policy that is associated with the stack will be used.
    var stackPolicyDuringUpdateURL: Swift.String?
...
public struct ValidateTemplateOutputResponse: Swift.Equatable {
    ...
    var parameters: [CloudFormationClientTypes.TemplateParameter]?
