...
public protocol SyntheticsClientProtocol {
    ...
    ///             Considerations for Synthetics Canaries</a>.</p>
    func createCanary(input: CreateCanaryInput, completion: @escaping (SdkResult<CreateCanaryOutput, CreateCanaryOutputError>) -> Void)
    ...
    func deleteCanary(input: DeleteCanaryInput, completion: @escaping (SdkResult<DeleteCanaryOutput, DeleteCanaryOutputError>) -> Void)
    ...
    func describeCanaries(input: DescribeCanariesInput, completion: @escaping (SdkResult<DescribeCanariesOutput, DescribeCanariesOutputError>) -> Void)
    /// <p>Use this operation to see information from the most recent run of each canary that you have created.</p>
    func describeCanariesLastRun(input: DescribeCanariesLastRunInput, completion: @escaping (SdkResult<DescribeCanariesLastRunOutput, DescribeCanariesLastRunOutputError>) -> Void)
    ...
    func describeRuntimeVersions(input: DescribeRuntimeVersionsInput, completion: @escaping (SdkResult<DescribeRuntimeVersionsOutput, DescribeRuntimeVersionsOutputError>) -> Void)
    ...
    func getCanary(input: GetCanaryInput, completion: @escaping (SdkResult<GetCanaryOutput, GetCanaryOutputError>) -> Void)
    /// <p>Retrieves a list of runs for a specified canary.</p>
    func getCanaryRuns(input: GetCanaryRunsInput, completion: @escaping (SdkResult<GetCanaryRunsOutput, GetCanaryRunsOutputError>) -> Void)
    ...
    func startCanary(input: StartCanaryInput, completion: @escaping (SdkResult<StartCanaryOutput, StartCanaryOutputError>) -> Void)
    ...
    func stopCanary(input: StopCanaryInput, completion: @escaping (SdkResult<StopCanaryOutput, StopCanaryOutputError>) -> Void)
    ...
    func updateCanary(input: UpdateCanaryInput, completion: @escaping (SdkResult<UpdateCanaryOutput, UpdateCanaryOutputError>) -> Void)
}
