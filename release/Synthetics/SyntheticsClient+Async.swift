...
public extension SyntheticsClient {
    ...
    {
        typealias createCanaryContinuation = CheckedContinuation<CreateCanaryOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createCanaryContinuation) in
            createCanary(input: input) { result in
                switch result {
    ...
    {
        typealias deleteCanaryContinuation = CheckedContinuation<DeleteCanaryOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteCanaryContinuation) in
            deleteCanary(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeCanariesContinuation = CheckedContinuation<DescribeCanariesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeCanariesContinuation) in
            describeCanaries(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeCanariesLastRunContinuation = CheckedContinuation<DescribeCanariesLastRunOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeCanariesLastRunContinuation) in
            describeCanariesLastRun(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeRuntimeVersionsContinuation = CheckedContinuation<DescribeRuntimeVersionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeRuntimeVersionsContinuation) in
            describeRuntimeVersions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getCanaryContinuation = CheckedContinuation<GetCanaryOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getCanaryContinuation) in
            getCanary(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getCanaryRunsContinuation = CheckedContinuation<GetCanaryRunsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getCanaryRunsContinuation) in
            getCanaryRuns(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias startCanaryContinuation = CheckedContinuation<StartCanaryOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startCanaryContinuation) in
            startCanary(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias stopCanaryContinuation = CheckedContinuation<StopCanaryOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopCanaryContinuation) in
            stopCanary(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateCanaryContinuation = CheckedContinuation<UpdateCanaryOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateCanaryContinuation) in
            updateCanary(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
