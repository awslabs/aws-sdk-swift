...
extension SyntheticsClient: SyntheticsClientProtocol {
    ...
    public func createCanary(input: CreateCanaryInput, completion: @escaping (SdkResult<CreateCanaryOutput, CreateCanaryOutputError>) -> Void)
    {
        let urlPath = "/canary"
        ...
        var operation = OperationStack<CreateCanaryInput, CreateCanaryOutput, CreateCanaryOutputError>(id: "createCanary")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateCanaryInput, CreateCanaryOutput, CreateCanaryOutputError>(contentType: "application/json"))
    ...
    public func deleteCanary(input: DeleteCanaryInput, completion: @escaping (SdkResult<DeleteCanaryOutput, DeleteCanaryOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "synthetics")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteCanaryInput, DeleteCanaryOutput, DeleteCanaryOutputError>(id: "deleteCanary")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteCanaryInput, DeleteCanaryOutput, DeleteCanaryOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeCanaries(input: DescribeCanariesInput, completion: @escaping (SdkResult<DescribeCanariesOutput, DescribeCanariesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "synthetics")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCanariesInput, DescribeCanariesOutput, DescribeCanariesOutputError>(id: "describeCanaries")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCanariesInput, DescribeCanariesOutput, DescribeCanariesOutputError>(contentType: "application/json"))
    ...
    public func describeCanariesLastRun(input: DescribeCanariesLastRunInput, completion: @escaping (SdkResult<DescribeCanariesLastRunOutput, DescribeCanariesLastRunOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "synthetics")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCanariesLastRunInput, DescribeCanariesLastRunOutput, DescribeCanariesLastRunOutputError>(id: "describeCanariesLastRun")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCanariesLastRunInput, DescribeCanariesLastRunOutput, DescribeCanariesLastRunOutputError>(contentType: "application/json"))
    ...
    public func describeRuntimeVersions(input: DescribeRuntimeVersionsInput, completion: @escaping (SdkResult<DescribeRuntimeVersionsOutput, DescribeRuntimeVersionsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "synthetics")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeRuntimeVersionsInput, DescribeRuntimeVersionsOutput, DescribeRuntimeVersionsOutputError>(id: "describeRuntimeVersions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeRuntimeVersionsInput, DescribeRuntimeVersionsOutput, DescribeRuntimeVersionsOutputError>(contentType: "application/json"))
    ...
    public func getCanary(input: GetCanaryInput, completion: @escaping (SdkResult<GetCanaryOutput, GetCanaryOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "synthetics")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCanaryInput, GetCanaryOutput, GetCanaryOutputError>(id: "getCanary")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCanaryInput, GetCanaryOutput, GetCanaryOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getCanaryRuns(input: GetCanaryRunsInput, completion: @escaping (SdkResult<GetCanaryRunsOutput, GetCanaryRunsOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "synthetics")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCanaryRunsInput, GetCanaryRunsOutput, GetCanaryRunsOutputError>(id: "getCanaryRuns")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCanaryRunsInput, GetCanaryRunsOutput, GetCanaryRunsOutputError>(contentType: "application/json"))
    ...
    public func startCanary(input: StartCanaryInput, completion: @escaping (SdkResult<StartCanaryOutput, StartCanaryOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "synthetics")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartCanaryInput, StartCanaryOutput, StartCanaryOutputError>(id: "startCanary")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartCanaryInput, StartCanaryOutput, StartCanaryOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func stopCanary(input: StopCanaryInput, completion: @escaping (SdkResult<StopCanaryOutput, StopCanaryOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "synthetics")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StopCanaryInput, StopCanaryOutput, StopCanaryOutputError>(id: "stopCanary")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StopCanaryInput, StopCanaryOutput, StopCanaryOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func updateCanary(input: UpdateCanaryInput, completion: @escaping (SdkResult<UpdateCanaryOutput, UpdateCanaryOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "synthetics")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateCanaryInput, UpdateCanaryOutput, UpdateCanaryOutputError>(id: "updateCanary")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateCanaryInput, UpdateCanaryOutput, UpdateCanaryOutputError>(contentType: "application/json"))
