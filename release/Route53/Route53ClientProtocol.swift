...
public protocol Route53ClientProtocol {
    ...
    func activateKeySigningKey(input: ActivateKeySigningKeyInput, completion: @escaping (SdkResult<ActivateKeySigningKeyOutput, ActivateKeySigningKeyOutputError>) -> Void)
    ...
    ///          </note>
    func associateVPCWithHostedZone(input: AssociateVPCWithHostedZoneInput, completion: @escaping (SdkResult<AssociateVPCWithHostedZoneOutput, AssociateVPCWithHostedZoneOutputError>) -> Void)
    ...
    func changeResourceRecordSets(input: ChangeResourceRecordSetsInput, completion: @escaping (SdkResult<ChangeResourceRecordSetsOutput, ChangeResourceRecordSetsOutputError>) -> Void)
    ...
    func changeTagsForResource(input: ChangeTagsForResourceInput, completion: @escaping (SdkResult<ChangeTagsForResourceOutput, ChangeTagsForResourceOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func createHealthCheck(input: CreateHealthCheckInput, completion: @escaping (SdkResult<CreateHealthCheckOutput, CreateHealthCheckOutputError>) -> Void)
    ...
    func createHostedZone(input: CreateHostedZoneInput, completion: @escaping (SdkResult<CreateHostedZoneOutput, CreateHostedZoneOutputError>) -> Void)
    /// <p>Creates a new key-signing key (KSK) associated with a hosted zone. You can only have two KSKs per hosted zone.</p>
    func createKeySigningKey(input: CreateKeySigningKeyInput, completion: @escaping (SdkResult<CreateKeySigningKeyOutput, CreateKeySigningKeyOutputError>) -> Void)
    ...
    /// 				        </dd>
    ///          </dl>
    func createQueryLoggingConfig(input: CreateQueryLoggingConfigInput, completion: @escaping (SdkResult<CreateQueryLoggingConfigOutput, CreateQueryLoggingConfigOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createReusableDelegationSet(input: CreateReusableDelegationSetInput, completion: @escaping (SdkResult<CreateReusableDelegationSetOutput, CreateReusableDelegationSetOutputError>) -> Void)
    ...
    func createTrafficPolicy(input: CreateTrafficPolicyInput, completion: @escaping (SdkResult<CreateTrafficPolicyOutput, CreateTrafficPolicyOutputError>) -> Void)
    ...
    func createTrafficPolicyInstance(input: CreateTrafficPolicyInstanceInput, completion: @escaping (SdkResult<CreateTrafficPolicyInstanceOutput, CreateTrafficPolicyInstanceOutputError>) -> Void)
    ...
    /// 			traffic policy.</p>
    func createTrafficPolicyVersion(input: CreateTrafficPolicyVersionInput, completion: @escaping (SdkResult<CreateTrafficPolicyVersionOutput, CreateTrafficPolicyVersionOutputError>) -> Void)
    ...
    ///          </note>
    func createVPCAssociationAuthorization(input: CreateVPCAssociationAuthorizationInput, completion: @escaping (SdkResult<CreateVPCAssociationAuthorizationOutput, CreateVPCAssociationAuthorizationOutputError>) -> Void)
    ...
    func deactivateKeySigningKey(input: DeactivateKeySigningKeyInput, completion: @escaping (SdkResult<DeactivateKeySigningKeyOutput, DeactivateKeySigningKeyOutputError>) -> Void)
    ...
    /// 			from Route 53. </p>
    func deleteHealthCheck(input: DeleteHealthCheckInput, completion: @escaping (SdkResult<DeleteHealthCheckOutput, DeleteHealthCheckOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteHostedZone(input: DeleteHostedZoneInput, completion: @escaping (SdkResult<DeleteHostedZoneOutput, DeleteHostedZoneOutputError>) -> Void)
    ...
    func deleteKeySigningKey(input: DeleteKeySigningKeyInput, completion: @escaping (SdkResult<DeleteKeySigningKeyOutput, DeleteKeySigningKeyOutputError>) -> Void)
    ...
    func deleteQueryLoggingConfig(input: DeleteQueryLoggingConfigInput, completion: @escaping (SdkResult<DeleteQueryLoggingConfigOutput, DeleteQueryLoggingConfigOutputError>) -> Void)
    ...
    func deleteReusableDelegationSet(input: DeleteReusableDelegationSetInput, completion: @escaping (SdkResult<DeleteReusableDelegationSetOutput, DeleteReusableDelegationSetOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteTrafficPolicy(input: DeleteTrafficPolicyInput, completion: @escaping (SdkResult<DeleteTrafficPolicyOutput, DeleteTrafficPolicyOutputError>) -> Void)
    ...
    /// 		       </note>
    func deleteTrafficPolicyInstance(input: DeleteTrafficPolicyInstanceInput, completion: @escaping (SdkResult<DeleteTrafficPolicyInstanceOutput, DeleteTrafficPolicyInstanceOutputError>) -> Void)
    ...
    /// 		       </important>
    func deleteVPCAssociationAuthorization(input: DeleteVPCAssociationAuthorizationInput, completion: @escaping (SdkResult<DeleteVPCAssociationAuthorizationOutput, DeleteVPCAssociationAuthorizationOutputError>) -> Void)
    ...
    func disableHostedZoneDNSSEC(input: DisableHostedZoneDNSSECInput, completion: @escaping (SdkResult<DisableHostedZoneDNSSECOutput, DisableHostedZoneDNSSECOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func disassociateVPCFromHostedZone(input: DisassociateVPCFromHostedZoneInput, completion: @escaping (SdkResult<DisassociateVPCFromHostedZoneOutput, DisassociateVPCFromHostedZoneOutputError>) -> Void)
    /// <p>Enables DNSSEC signing in a specific hosted zone.</p>
    func enableHostedZoneDNSSEC(input: EnableHostedZoneDNSSECInput, completion: @escaping (SdkResult<EnableHostedZoneDNSSECOutput, EnableHostedZoneDNSSECOutputError>) -> Void)
    ...
    /// 		       </note>
    func getAccountLimit(input: GetAccountLimitInput, completion: @escaping (SdkResult<GetAccountLimitOutput, GetAccountLimitOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func getChange(input: GetChangeInput, completion: @escaping (SdkResult<GetChangeOutput, GetChangeOutputError>) -> Void)
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>.</p>
    /// 		       </important>
    func getCheckerIpRanges(input: GetCheckerIpRangesInput, completion: @escaping (SdkResult<GetCheckerIpRangesOutput, GetCheckerIpRangesOutputError>) -> Void)
    /// <p>Returns information about DNSSEC for a specific hosted zone, including the key-signing keys (KSKs) in the hosted zone.</p>
    func getDNSSEC(input: GetDNSSECInput, completion: @escaping (SdkResult<GetDNSSECOutput, GetDNSSECOutputError>) -> Void)
    ...
    ///             </code>
    ///          </p>
    func getGeoLocation(input: GetGeoLocationInput, completion: @escaping (SdkResult<GetGeoLocationOutput, GetGeoLocationOutputError>) -> Void)
    /// <p>Gets information about a specified health check.</p>
    func getHealthCheck(input: GetHealthCheckInput, completion: @escaping (SdkResult<GetHealthCheckOutput, GetHealthCheckOutputError>) -> Void)
    /// <p>Retrieves the number of health checks that are associated with the current AWS account.</p>
    func getHealthCheckCount(input: GetHealthCheckCountInput, completion: @escaping (SdkResult<GetHealthCheckCountOutput, GetHealthCheckCountOutputError>) -> Void)
    /// <p>Gets the reason that a specified health check failed most recently.</p>
    func getHealthCheckLastFailureReason(input: GetHealthCheckLastFailureReasonInput, completion: @escaping (SdkResult<GetHealthCheckLastFailureReasonOutput, GetHealthCheckLastFailureReasonOutputError>) -> Void)
    /// <p>Gets status of a specified health check. </p>
    func getHealthCheckStatus(input: GetHealthCheckStatusInput, completion: @escaping (SdkResult<GetHealthCheckStatusOutput, GetHealthCheckStatusOutputError>) -> Void)
    /// <p>Gets information about a specified hosted zone including the four name servers assigned to the hosted zone.</p>
    func getHostedZone(input: GetHostedZoneInput, completion: @escaping (SdkResult<GetHostedZoneOutput, GetHostedZoneOutputError>) -> Void)
    /// <p>Retrieves the number of hosted zones that are associated with the current AWS account.</p>
    func getHostedZoneCount(input: GetHostedZoneCountInput, completion: @escaping (SdkResult<GetHostedZoneCountOutput, GetHostedZoneCountOutputError>) -> Void)
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>. To request a higher limit,
    /// 			<a href="https://console.aws.amazon.com/support/home#/case/create?issueType=service-limit-increase&limitType=service-code-route53">open a case</a>.</p>
    func getHostedZoneLimit(input: GetHostedZoneLimitInput, completion: @escaping (SdkResult<GetHostedZoneLimitOutput, GetHostedZoneLimitOutputError>) -> Void)
    ...
    func getQueryLoggingConfig(input: GetQueryLoggingConfigInput, completion: @escaping (SdkResult<GetQueryLoggingConfigOutput, GetQueryLoggingConfigOutputError>) -> Void)
    ...
    func getReusableDelegationSet(input: GetReusableDelegationSetInput, completion: @escaping (SdkResult<GetReusableDelegationSetOutput, GetReusableDelegationSetOutputError>) -> Void)
    /// <p>Gets the maximum number of hosted zones that you can associate with the specified reusable delegation set.</p>
    /// 		       <p>For the default limit, see <a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DNSLimitations.html">Limits</a>
    /// 			in the <i>Amazon Route 53 Developer Guide</i>. To request a higher limit,
    /// 			<a href="https://console.aws.amazon.com/support/home#/case/create?issueType=service-limit-increase&limitType=service-code-route53">open a case</a>.</p>
    func getReusableDelegationSetLimit(input: GetReusableDelegationSetLimitInput, completion: @escaping (SdkResult<GetReusableDelegationSetLimitOutput, GetReusableDelegationSetLimitOutputError>) -> Void)
    ...
    /// 		</p>
    func getTrafficPolicy(input: GetTrafficPolicyInput, completion: @escaping (SdkResult<GetTrafficPolicyOutput, GetTrafficPolicyOutputError>) -> Void)
    ...
    /// 			         <p>In the Route 53 console, traffic policy instances are known as policy records.</p>
    /// 		       </note>
    func getTrafficPolicyInstance(input: GetTrafficPolicyInstanceInput, completion: @escaping (SdkResult<GetTrafficPolicyInstanceOutput, GetTrafficPolicyInstanceOutputError>) -> Void)
    /// <p>Gets the number of traffic policy instances that are associated with the current AWS account.</p>
    func getTrafficPolicyInstanceCount(input: GetTrafficPolicyInstanceCountInput, completion: @escaping (SdkResult<GetTrafficPolicyInstanceCountOutput, GetTrafficPolicyInstanceCountOutputError>) -> Void)
    ...
    func listGeoLocations(input: ListGeoLocationsInput, completion: @escaping (SdkResult<ListGeoLocationsOutput, ListGeoLocationsOutputError>) -> Void)
    /// <p>Retrieve a list of the health checks that are associated with the current AWS account. </p>
    func listHealthChecks(input: ListHealthChecksInput, completion: @escaping (SdkResult<ListHealthChecksOutput, ListHealthChecksOutputError>) -> Void)
    ...
    func listHostedZones(input: ListHostedZonesInput, completion: @escaping (SdkResult<ListHostedZonesOutput, ListHostedZonesOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func listHostedZonesByName(input: ListHostedZonesByNameInput, completion: @escaping (SdkResult<ListHostedZonesByNameOutput, ListHostedZonesByNameOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func listHostedZonesByVPC(input: ListHostedZonesByVPCInput, completion: @escaping (SdkResult<ListHostedZonesByVPCOutput, ListHostedZonesByVPCOutputError>) -> Void)
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>.</p>
    func listQueryLoggingConfigs(input: ListQueryLoggingConfigsInput, completion: @escaping (SdkResult<ListQueryLoggingConfigsOutput, ListQueryLoggingConfigsOutputError>) -> Void)
    ...
    func listResourceRecordSets(input: ListResourceRecordSetsInput, completion: @escaping (SdkResult<ListResourceRecordSetsOutput, ListResourceRecordSetsOutputError>) -> Void)
    /// <p>Retrieves a list of the reusable delegation sets that are associated with the current AWS account.</p>
    func listReusableDelegationSets(input: ListReusableDelegationSetsInput, completion: @escaping (SdkResult<ListReusableDelegationSetsOutput, ListReusableDelegationSetsOutputError>) -> Void)
    ...
    /// 			<a href="https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html">Using Cost Allocation Tags</a>
    /// 			in the <i>AWS Billing and Cost Management User Guide</i>.</p>
    func listTagsForResources(input: ListTagsForResourcesInput, completion: @escaping (SdkResult<ListTagsForResourcesOutput, ListTagsForResourcesOutputError>) -> Void)
    ...
    ///
    /// 		</p>
    func listTrafficPolicies(input: ListTrafficPoliciesInput, completion: @escaping (SdkResult<ListTrafficPoliciesOutput, ListTrafficPoliciesOutputError>) -> Void)
    ...
    /// 			<code>MaxItems</code> parameter to list them in groups of up to 100.</p>
    func listTrafficPolicyInstances(input: ListTrafficPolicyInstancesInput, completion: @escaping (SdkResult<ListTrafficPolicyInstancesOutput, ListTrafficPolicyInstancesOutputError>) -> Void)
    ...
    /// 		       <p>Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policy instances, you can use the
    /// 			<code>MaxItems</code> parameter to list them in groups of up to 100.</p>
    func listTrafficPolicyInstancesByHostedZone(input: ListTrafficPolicyInstancesByHostedZoneInput, completion: @escaping (SdkResult<ListTrafficPolicyInstancesByHostedZoneOutput, ListTrafficPolicyInstancesByHostedZoneOutputError>) -> Void)
    ...
    /// 		       <p>Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policy instances, you can use the
    /// 			<code>MaxItems</code> parameter to list them in groups of up to 100.</p>
    func listTrafficPolicyInstancesByPolicy(input: ListTrafficPolicyInstancesByPolicyInput, completion: @escaping (SdkResult<ListTrafficPolicyInstancesByPolicyOutput, ListTrafficPolicyInstancesByPolicyOutputError>) -> Void)
    ...
    func listTrafficPolicyVersions(input: ListTrafficPolicyVersionsInput, completion: @escaping (SdkResult<ListTrafficPolicyVersionsOutput, ListTrafficPolicyVersionsOutputError>) -> Void)
    ...
    func listVPCAssociationAuthorizations(input: ListVPCAssociationAuthorizationsInput, completion: @escaping (SdkResult<ListVPCAssociationAuthorizationsOutput, ListVPCAssociationAuthorizationsOutputError>) -> Void)
    ...
    func testDNSAnswer(input: TestDNSAnswerInput, completion: @escaping (SdkResult<TestDNSAnswerOutput, TestDNSAnswerOutputError>) -> Void)
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>.</p>
    func updateHealthCheck(input: UpdateHealthCheckInput, completion: @escaping (SdkResult<UpdateHealthCheckOutput, UpdateHealthCheckOutputError>) -> Void)
    /// <p>Updates the comment for a specified hosted zone.</p>
    func updateHostedZoneComment(input: UpdateHostedZoneCommentInput, completion: @escaping (SdkResult<UpdateHostedZoneCommentOutput, UpdateHostedZoneCommentOutputError>) -> Void)
    /// <p>Updates the comment for a specified traffic policy version.</p>
    func updateTrafficPolicyComment(input: UpdateTrafficPolicyCommentInput, completion: @escaping (SdkResult<UpdateTrafficPolicyCommentOutput, UpdateTrafficPolicyCommentOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ol>
    func updateTrafficPolicyInstance(input: UpdateTrafficPolicyInstanceInput, completion: @escaping (SdkResult<UpdateTrafficPolicyInstanceOutput, UpdateTrafficPolicyInstanceOutputError>) -> Void)
}
