...
public protocol Route53ClientProtocol {
    ...
    func activateKeySigningKey(input: ActivateKeySigningKeyInput, completion: @escaping (SdkResult<ActivateKeySigningKeyOutputResponse, ActivateKeySigningKeyOutputError>) -> Void)
    ...
    ///          </note>
    func associateVPCWithHostedZone(input: AssociateVPCWithHostedZoneInput, completion: @escaping (SdkResult<AssociateVPCWithHostedZoneOutputResponse, AssociateVPCWithHostedZoneOutputError>) -> Void)
    ...
    func changeResourceRecordSets(input: ChangeResourceRecordSetsInput, completion: @escaping (SdkResult<ChangeResourceRecordSetsOutputResponse, ChangeResourceRecordSetsOutputError>) -> Void)
    ...
    func changeTagsForResource(input: ChangeTagsForResourceInput, completion: @escaping (SdkResult<ChangeTagsForResourceOutputResponse, ChangeTagsForResourceOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func createHealthCheck(input: CreateHealthCheckInput, completion: @escaping (SdkResult<CreateHealthCheckOutputResponse, CreateHealthCheckOutputError>) -> Void)
    ...
    func createHostedZone(input: CreateHostedZoneInput, completion: @escaping (SdkResult<CreateHostedZoneOutputResponse, CreateHostedZoneOutputError>) -> Void)
    /// <p>Creates a new key-signing key (KSK) associated with a hosted zone. You can only have two KSKs per hosted zone.</p>
    func createKeySigningKey(input: CreateKeySigningKeyInput, completion: @escaping (SdkResult<CreateKeySigningKeyOutputResponse, CreateKeySigningKeyOutputError>) -> Void)
    ...
    /// 				        </dd>
    ///          </dl>
    func createQueryLoggingConfig(input: CreateQueryLoggingConfigInput, completion: @escaping (SdkResult<CreateQueryLoggingConfigOutputResponse, CreateQueryLoggingConfigOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createReusableDelegationSet(input: CreateReusableDelegationSetInput, completion: @escaping (SdkResult<CreateReusableDelegationSetOutputResponse, CreateReusableDelegationSetOutputError>) -> Void)
    ...
    func createTrafficPolicy(input: CreateTrafficPolicyInput, completion: @escaping (SdkResult<CreateTrafficPolicyOutputResponse, CreateTrafficPolicyOutputError>) -> Void)
    ...
    func createTrafficPolicyInstance(input: CreateTrafficPolicyInstanceInput, completion: @escaping (SdkResult<CreateTrafficPolicyInstanceOutputResponse, CreateTrafficPolicyInstanceOutputError>) -> Void)
    ...
    /// 			traffic policy.</p>
    func createTrafficPolicyVersion(input: CreateTrafficPolicyVersionInput, completion: @escaping (SdkResult<CreateTrafficPolicyVersionOutputResponse, CreateTrafficPolicyVersionOutputError>) -> Void)
    ...
    ///          </note>
    func createVPCAssociationAuthorization(input: CreateVPCAssociationAuthorizationInput, completion: @escaping (SdkResult<CreateVPCAssociationAuthorizationOutputResponse, CreateVPCAssociationAuthorizationOutputError>) -> Void)
    ...
    func deactivateKeySigningKey(input: DeactivateKeySigningKeyInput, completion: @escaping (SdkResult<DeactivateKeySigningKeyOutputResponse, DeactivateKeySigningKeyOutputError>) -> Void)
    ...
    /// 			from Route 53. </p>
    func deleteHealthCheck(input: DeleteHealthCheckInput, completion: @escaping (SdkResult<DeleteHealthCheckOutputResponse, DeleteHealthCheckOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteHostedZone(input: DeleteHostedZoneInput, completion: @escaping (SdkResult<DeleteHostedZoneOutputResponse, DeleteHostedZoneOutputError>) -> Void)
    ...
    func deleteKeySigningKey(input: DeleteKeySigningKeyInput, completion: @escaping (SdkResult<DeleteKeySigningKeyOutputResponse, DeleteKeySigningKeyOutputError>) -> Void)
    ...
    func deleteQueryLoggingConfig(input: DeleteQueryLoggingConfigInput, completion: @escaping (SdkResult<DeleteQueryLoggingConfigOutputResponse, DeleteQueryLoggingConfigOutputError>) -> Void)
    ...
    func deleteReusableDelegationSet(input: DeleteReusableDelegationSetInput, completion: @escaping (SdkResult<DeleteReusableDelegationSetOutputResponse, DeleteReusableDelegationSetOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteTrafficPolicy(input: DeleteTrafficPolicyInput, completion: @escaping (SdkResult<DeleteTrafficPolicyOutputResponse, DeleteTrafficPolicyOutputError>) -> Void)
    ...
    /// 		       </note>
    func deleteTrafficPolicyInstance(input: DeleteTrafficPolicyInstanceInput, completion: @escaping (SdkResult<DeleteTrafficPolicyInstanceOutputResponse, DeleteTrafficPolicyInstanceOutputError>) -> Void)
    ...
    /// 		       </important>
    func deleteVPCAssociationAuthorization(input: DeleteVPCAssociationAuthorizationInput, completion: @escaping (SdkResult<DeleteVPCAssociationAuthorizationOutputResponse, DeleteVPCAssociationAuthorizationOutputError>) -> Void)
    ...
    func disableHostedZoneDNSSEC(input: DisableHostedZoneDNSSECInput, completion: @escaping (SdkResult<DisableHostedZoneDNSSECOutputResponse, DisableHostedZoneDNSSECOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func disassociateVPCFromHostedZone(input: DisassociateVPCFromHostedZoneInput, completion: @escaping (SdkResult<DisassociateVPCFromHostedZoneOutputResponse, DisassociateVPCFromHostedZoneOutputError>) -> Void)
    /// <p>Enables DNSSEC signing in a specific hosted zone.</p>
    func enableHostedZoneDNSSEC(input: EnableHostedZoneDNSSECInput, completion: @escaping (SdkResult<EnableHostedZoneDNSSECOutputResponse, EnableHostedZoneDNSSECOutputError>) -> Void)
    ...
    /// 		       </note>
    func getAccountLimit(input: GetAccountLimitInput, completion: @escaping (SdkResult<GetAccountLimitOutputResponse, GetAccountLimitOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func getChange(input: GetChangeInput, completion: @escaping (SdkResult<GetChangeOutputResponse, GetChangeOutputError>) -> Void)
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>.</p>
    /// 		       </important>
    func getCheckerIpRanges(input: GetCheckerIpRangesInput, completion: @escaping (SdkResult<GetCheckerIpRangesOutputResponse, GetCheckerIpRangesOutputError>) -> Void)
    /// <p>Returns information about DNSSEC for a specific hosted zone, including the key-signing keys (KSKs) in the hosted zone.</p>
    func getDNSSEC(input: GetDNSSECInput, completion: @escaping (SdkResult<GetDNSSECOutputResponse, GetDNSSECOutputError>) -> Void)
    ...
    ///             </code>
    ///          </p>
    func getGeoLocation(input: GetGeoLocationInput, completion: @escaping (SdkResult<GetGeoLocationOutputResponse, GetGeoLocationOutputError>) -> Void)
    /// <p>Gets information about a specified health check.</p>
    func getHealthCheck(input: GetHealthCheckInput, completion: @escaping (SdkResult<GetHealthCheckOutputResponse, GetHealthCheckOutputError>) -> Void)
    /// <p>Retrieves the number of health checks that are associated with the current AWS account.</p>
    func getHealthCheckCount(input: GetHealthCheckCountInput, completion: @escaping (SdkResult<GetHealthCheckCountOutputResponse, GetHealthCheckCountOutputError>) -> Void)
    /// <p>Gets the reason that a specified health check failed most recently.</p>
    func getHealthCheckLastFailureReason(input: GetHealthCheckLastFailureReasonInput, completion: @escaping (SdkResult<GetHealthCheckLastFailureReasonOutputResponse, GetHealthCheckLastFailureReasonOutputError>) -> Void)
    /// <p>Gets status of a specified health check. </p>
    func getHealthCheckStatus(input: GetHealthCheckStatusInput, completion: @escaping (SdkResult<GetHealthCheckStatusOutputResponse, GetHealthCheckStatusOutputError>) -> Void)
    /// <p>Gets information about a specified hosted zone including the four name servers assigned to the hosted zone.</p>
    func getHostedZone(input: GetHostedZoneInput, completion: @escaping (SdkResult<GetHostedZoneOutputResponse, GetHostedZoneOutputError>) -> Void)
    /// <p>Retrieves the number of hosted zones that are associated with the current AWS account.</p>
    func getHostedZoneCount(input: GetHostedZoneCountInput, completion: @escaping (SdkResult<GetHostedZoneCountOutputResponse, GetHostedZoneCountOutputError>) -> Void)
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>. To request a higher limit,
    /// 			<a href="https://console.aws.amazon.com/support/home#/case/create?issueType=service-limit-increase&limitType=service-code-route53">open a case</a>.</p>
    func getHostedZoneLimit(input: GetHostedZoneLimitInput, completion: @escaping (SdkResult<GetHostedZoneLimitOutputResponse, GetHostedZoneLimitOutputError>) -> Void)
    ...
    func getQueryLoggingConfig(input: GetQueryLoggingConfigInput, completion: @escaping (SdkResult<GetQueryLoggingConfigOutputResponse, GetQueryLoggingConfigOutputError>) -> Void)
    ...
    func getReusableDelegationSet(input: GetReusableDelegationSetInput, completion: @escaping (SdkResult<GetReusableDelegationSetOutputResponse, GetReusableDelegationSetOutputError>) -> Void)
    /// <p>Gets the maximum number of hosted zones that you can associate with the specified reusable delegation set.</p>
    /// 		       <p>For the default limit, see <a href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DNSLimitations.html">Limits</a>
    /// 			in the <i>Amazon Route 53 Developer Guide</i>. To request a higher limit,
    /// 			<a href="https://console.aws.amazon.com/support/home#/case/create?issueType=service-limit-increase&limitType=service-code-route53">open a case</a>.</p>
    func getReusableDelegationSetLimit(input: GetReusableDelegationSetLimitInput, completion: @escaping (SdkResult<GetReusableDelegationSetLimitOutputResponse, GetReusableDelegationSetLimitOutputError>) -> Void)
    ...
    /// 		</p>
    func getTrafficPolicy(input: GetTrafficPolicyInput, completion: @escaping (SdkResult<GetTrafficPolicyOutputResponse, GetTrafficPolicyOutputError>) -> Void)
    ...
    /// 			         <p>In the Route 53 console, traffic policy instances are known as policy records.</p>
    /// 		       </note>
    func getTrafficPolicyInstance(input: GetTrafficPolicyInstanceInput, completion: @escaping (SdkResult<GetTrafficPolicyInstanceOutputResponse, GetTrafficPolicyInstanceOutputError>) -> Void)
    /// <p>Gets the number of traffic policy instances that are associated with the current AWS account.</p>
    func getTrafficPolicyInstanceCount(input: GetTrafficPolicyInstanceCountInput, completion: @escaping (SdkResult<GetTrafficPolicyInstanceCountOutputResponse, GetTrafficPolicyInstanceCountOutputError>) -> Void)
    ...
    func listGeoLocations(input: ListGeoLocationsInput, completion: @escaping (SdkResult<ListGeoLocationsOutputResponse, ListGeoLocationsOutputError>) -> Void)
    /// <p>Retrieve a list of the health checks that are associated with the current AWS account. </p>
    func listHealthChecks(input: ListHealthChecksInput, completion: @escaping (SdkResult<ListHealthChecksOutputResponse, ListHealthChecksOutputError>) -> Void)
    ...
    func listHostedZones(input: ListHostedZonesInput, completion: @escaping (SdkResult<ListHostedZonesOutputResponse, ListHostedZonesOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func listHostedZonesByName(input: ListHostedZonesByNameInput, completion: @escaping (SdkResult<ListHostedZonesByNameOutputResponse, ListHostedZonesByNameOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func listHostedZonesByVPC(input: ListHostedZonesByVPCInput, completion: @escaping (SdkResult<ListHostedZonesByVPCOutputResponse, ListHostedZonesByVPCOutputError>) -> Void)
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>.</p>
    func listQueryLoggingConfigs(input: ListQueryLoggingConfigsInput, completion: @escaping (SdkResult<ListQueryLoggingConfigsOutputResponse, ListQueryLoggingConfigsOutputError>) -> Void)
    ...
    func listResourceRecordSets(input: ListResourceRecordSetsInput, completion: @escaping (SdkResult<ListResourceRecordSetsOutputResponse, ListResourceRecordSetsOutputError>) -> Void)
    /// <p>Retrieves a list of the reusable delegation sets that are associated with the current AWS account.</p>
    func listReusableDelegationSets(input: ListReusableDelegationSetsInput, completion: @escaping (SdkResult<ListReusableDelegationSetsOutputResponse, ListReusableDelegationSetsOutputError>) -> Void)
    ...
    /// 			<a href="https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html">Using Cost Allocation Tags</a>
    /// 			in the <i>AWS Billing and Cost Management User Guide</i>.</p>
    func listTagsForResources(input: ListTagsForResourcesInput, completion: @escaping (SdkResult<ListTagsForResourcesOutputResponse, ListTagsForResourcesOutputError>) -> Void)
    ...
    ///
    /// 		</p>
    func listTrafficPolicies(input: ListTrafficPoliciesInput, completion: @escaping (SdkResult<ListTrafficPoliciesOutputResponse, ListTrafficPoliciesOutputError>) -> Void)
    ...
    /// 			<code>MaxItems</code> parameter to list them in groups of up to 100.</p>
    func listTrafficPolicyInstances(input: ListTrafficPolicyInstancesInput, completion: @escaping (SdkResult<ListTrafficPolicyInstancesOutputResponse, ListTrafficPolicyInstancesOutputError>) -> Void)
    ...
    /// 		       <p>Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policy instances, you can use the
    /// 			<code>MaxItems</code> parameter to list them in groups of up to 100.</p>
    func listTrafficPolicyInstancesByHostedZone(input: ListTrafficPolicyInstancesByHostedZoneInput, completion: @escaping (SdkResult<ListTrafficPolicyInstancesByHostedZoneOutputResponse, ListTrafficPolicyInstancesByHostedZoneOutputError>) -> Void)
    ...
    /// 		       <p>Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policy instances, you can use the
    /// 			<code>MaxItems</code> parameter to list them in groups of up to 100.</p>
    func listTrafficPolicyInstancesByPolicy(input: ListTrafficPolicyInstancesByPolicyInput, completion: @escaping (SdkResult<ListTrafficPolicyInstancesByPolicyOutputResponse, ListTrafficPolicyInstancesByPolicyOutputError>) -> Void)
    ...
    func listTrafficPolicyVersions(input: ListTrafficPolicyVersionsInput, completion: @escaping (SdkResult<ListTrafficPolicyVersionsOutputResponse, ListTrafficPolicyVersionsOutputError>) -> Void)
    ...
    func listVPCAssociationAuthorizations(input: ListVPCAssociationAuthorizationsInput, completion: @escaping (SdkResult<ListVPCAssociationAuthorizationsOutputResponse, ListVPCAssociationAuthorizationsOutputError>) -> Void)
    ...
    func testDNSAnswer(input: TestDNSAnswerInput, completion: @escaping (SdkResult<TestDNSAnswerOutputResponse, TestDNSAnswerOutputError>) -> Void)
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>.</p>
    func updateHealthCheck(input: UpdateHealthCheckInput, completion: @escaping (SdkResult<UpdateHealthCheckOutputResponse, UpdateHealthCheckOutputError>) -> Void)
    /// <p>Updates the comment for a specified hosted zone.</p>
    func updateHostedZoneComment(input: UpdateHostedZoneCommentInput, completion: @escaping (SdkResult<UpdateHostedZoneCommentOutputResponse, UpdateHostedZoneCommentOutputError>) -> Void)
    /// <p>Updates the comment for a specified traffic policy version.</p>
    func updateTrafficPolicyComment(input: UpdateTrafficPolicyCommentInput, completion: @escaping (SdkResult<UpdateTrafficPolicyCommentOutputResponse, UpdateTrafficPolicyCommentOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ol>
    func updateTrafficPolicyInstance(input: UpdateTrafficPolicyInstanceInput, completion: @escaping (SdkResult<UpdateTrafficPolicyInstanceOutputResponse, UpdateTrafficPolicyInstanceOutputError>) -> Void)
}
