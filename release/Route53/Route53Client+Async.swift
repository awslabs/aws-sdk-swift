...
public extension Route53Client {
    ...
    func activateKeySigningKey(input: ActivateKeySigningKeyInput) async throws -> ActivateKeySigningKeyOutputResponse
    {
        typealias activateKeySigningKeyContinuation = CheckedContinuation<ActivateKeySigningKeyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: activateKeySigningKeyContinuation) in
            activateKeySigningKey(input: input) { result in
                switch result {
    ...
    ///          </note>
    func associateVPCWithHostedZone(input: AssociateVPCWithHostedZoneInput) async throws -> AssociateVPCWithHostedZoneOutputResponse
    {
        typealias associateVPCWithHostedZoneContinuation = CheckedContinuation<AssociateVPCWithHostedZoneOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: associateVPCWithHostedZoneContinuation) in
            associateVPCWithHostedZone(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func changeResourceRecordSets(input: ChangeResourceRecordSetsInput) async throws -> ChangeResourceRecordSetsOutputResponse
    {
        typealias changeResourceRecordSetsContinuation = CheckedContinuation<ChangeResourceRecordSetsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: changeResourceRecordSetsContinuation) in
            changeResourceRecordSets(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func changeTagsForResource(input: ChangeTagsForResourceInput) async throws -> ChangeTagsForResourceOutputResponse
    {
        typealias changeTagsForResourceContinuation = CheckedContinuation<ChangeTagsForResourceOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: changeTagsForResourceContinuation) in
            changeTagsForResource(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			         </li>
    ///          </ul>
    func createHealthCheck(input: CreateHealthCheckInput) async throws -> CreateHealthCheckOutputResponse
    {
        typealias createHealthCheckContinuation = CheckedContinuation<CreateHealthCheckOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createHealthCheckContinuation) in
            createHealthCheck(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func createHostedZone(input: CreateHostedZoneInput) async throws -> CreateHostedZoneOutputResponse
    {
        typealias createHostedZoneContinuation = CheckedContinuation<CreateHostedZoneOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createHostedZoneContinuation) in
            createHostedZone(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func createKeySigningKey(input: CreateKeySigningKeyInput) async throws -> CreateKeySigningKeyOutputResponse
    {
        typealias createKeySigningKeyContinuation = CheckedContinuation<CreateKeySigningKeyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createKeySigningKeyContinuation) in
            createKeySigningKey(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 				        </dd>
    ///          </dl>
    func createQueryLoggingConfig(input: CreateQueryLoggingConfigInput) async throws -> CreateQueryLoggingConfigOutputResponse
    {
        typealias createQueryLoggingConfigContinuation = CheckedContinuation<CreateQueryLoggingConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createQueryLoggingConfigContinuation) in
            createQueryLoggingConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </li>
    ///          </ul>
    func createReusableDelegationSet(input: CreateReusableDelegationSetInput) async throws -> CreateReusableDelegationSetOutputResponse
    {
        typealias createReusableDelegationSetContinuation = CheckedContinuation<CreateReusableDelegationSetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createReusableDelegationSetContinuation) in
            createReusableDelegationSet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func createTrafficPolicy(input: CreateTrafficPolicyInput) async throws -> CreateTrafficPolicyOutputResponse
    {
        typealias createTrafficPolicyContinuation = CheckedContinuation<CreateTrafficPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createTrafficPolicyContinuation) in
            createTrafficPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func createTrafficPolicyInstance(input: CreateTrafficPolicyInstanceInput) async throws -> CreateTrafficPolicyInstanceOutputResponse
    {
        typealias createTrafficPolicyInstanceContinuation = CheckedContinuation<CreateTrafficPolicyInstanceOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createTrafficPolicyInstanceContinuation) in
            createTrafficPolicyInstance(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			traffic policy.</p>
    func createTrafficPolicyVersion(input: CreateTrafficPolicyVersionInput) async throws -> CreateTrafficPolicyVersionOutputResponse
    {
        typealias createTrafficPolicyVersionContinuation = CheckedContinuation<CreateTrafficPolicyVersionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createTrafficPolicyVersionContinuation) in
            createTrafficPolicyVersion(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///          </note>
    func createVPCAssociationAuthorization(input: CreateVPCAssociationAuthorizationInput) async throws -> CreateVPCAssociationAuthorizationOutputResponse
    {
        typealias createVPCAssociationAuthorizationContinuation = CheckedContinuation<CreateVPCAssociationAuthorizationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createVPCAssociationAuthorizationContinuation) in
            createVPCAssociationAuthorization(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func deactivateKeySigningKey(input: DeactivateKeySigningKeyInput) async throws -> DeactivateKeySigningKeyOutputResponse
    {
        typealias deactivateKeySigningKeyContinuation = CheckedContinuation<DeactivateKeySigningKeyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deactivateKeySigningKeyContinuation) in
            deactivateKeySigningKey(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			from Route 53. </p>
    func deleteHealthCheck(input: DeleteHealthCheckInput) async throws -> DeleteHealthCheckOutputResponse
    {
        typealias deleteHealthCheckContinuation = CheckedContinuation<DeleteHealthCheckOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteHealthCheckContinuation) in
            deleteHealthCheck(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </li>
    ///          </ul>
    func deleteHostedZone(input: DeleteHostedZoneInput) async throws -> DeleteHostedZoneOutputResponse
    {
        typealias deleteHostedZoneContinuation = CheckedContinuation<DeleteHostedZoneOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteHostedZoneContinuation) in
            deleteHostedZone(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func deleteKeySigningKey(input: DeleteKeySigningKeyInput) async throws -> DeleteKeySigningKeyOutputResponse
    {
        typealias deleteKeySigningKeyContinuation = CheckedContinuation<DeleteKeySigningKeyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteKeySigningKeyContinuation) in
            deleteKeySigningKey(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func deleteQueryLoggingConfig(input: DeleteQueryLoggingConfigInput) async throws -> DeleteQueryLoggingConfigOutputResponse
    {
        typealias deleteQueryLoggingConfigContinuation = CheckedContinuation<DeleteQueryLoggingConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteQueryLoggingConfigContinuation) in
            deleteQueryLoggingConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func deleteReusableDelegationSet(input: DeleteReusableDelegationSetInput) async throws -> DeleteReusableDelegationSetOutputResponse
    {
        typealias deleteReusableDelegationSetContinuation = CheckedContinuation<DeleteReusableDelegationSetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteReusableDelegationSetContinuation) in
            deleteReusableDelegationSet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </li>
    ///          </ul>
    func deleteTrafficPolicy(input: DeleteTrafficPolicyInput) async throws -> DeleteTrafficPolicyOutputResponse
    {
        typealias deleteTrafficPolicyContinuation = CheckedContinuation<DeleteTrafficPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteTrafficPolicyContinuation) in
            deleteTrafficPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 		       </note>
    func deleteTrafficPolicyInstance(input: DeleteTrafficPolicyInstanceInput) async throws -> DeleteTrafficPolicyInstanceOutputResponse
    {
        typealias deleteTrafficPolicyInstanceContinuation = CheckedContinuation<DeleteTrafficPolicyInstanceOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteTrafficPolicyInstanceContinuation) in
            deleteTrafficPolicyInstance(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 		       </important>
    func deleteVPCAssociationAuthorization(input: DeleteVPCAssociationAuthorizationInput) async throws -> DeleteVPCAssociationAuthorizationOutputResponse
    {
        typealias deleteVPCAssociationAuthorizationContinuation = CheckedContinuation<DeleteVPCAssociationAuthorizationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteVPCAssociationAuthorizationContinuation) in
            deleteVPCAssociationAuthorization(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func disableHostedZoneDNSSEC(input: DisableHostedZoneDNSSECInput) async throws -> DisableHostedZoneDNSSECOutputResponse
    {
        typealias disableHostedZoneDNSSECContinuation = CheckedContinuation<DisableHostedZoneDNSSECOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: disableHostedZoneDNSSECContinuation) in
            disableHostedZoneDNSSEC(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			         </li>
    ///          </ul>
    func disassociateVPCFromHostedZone(input: DisassociateVPCFromHostedZoneInput) async throws -> DisassociateVPCFromHostedZoneOutputResponse
    {
        typealias disassociateVPCFromHostedZoneContinuation = CheckedContinuation<DisassociateVPCFromHostedZoneOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: disassociateVPCFromHostedZoneContinuation) in
            disassociateVPCFromHostedZone(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func enableHostedZoneDNSSEC(input: EnableHostedZoneDNSSECInput) async throws -> EnableHostedZoneDNSSECOutputResponse
    {
        typealias enableHostedZoneDNSSECContinuation = CheckedContinuation<EnableHostedZoneDNSSECOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: enableHostedZoneDNSSECContinuation) in
            enableHostedZoneDNSSEC(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 		       </note>
    func getAccountLimit(input: GetAccountLimitInput) async throws -> GetAccountLimitOutputResponse
    {
        typealias getAccountLimitContinuation = CheckedContinuation<GetAccountLimitOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getAccountLimitContinuation) in
            getAccountLimit(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			         </li>
    ///          </ul>
    func getChange(input: GetChangeInput) async throws -> GetChangeOutputResponse
    {
        typealias getChangeContinuation = CheckedContinuation<GetChangeOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getChangeContinuation) in
            getChange(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>.</p>
    /// 		       </important>
    func getCheckerIpRanges(input: GetCheckerIpRangesInput) async throws -> GetCheckerIpRangesOutputResponse
    {
        typealias getCheckerIpRangesContinuation = CheckedContinuation<GetCheckerIpRangesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getCheckerIpRangesContinuation) in
            getCheckerIpRanges(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getDNSSEC(input: GetDNSSECInput) async throws -> GetDNSSECOutputResponse
    {
        typealias getDNSSECContinuation = CheckedContinuation<GetDNSSECOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getDNSSECContinuation) in
            getDNSSEC(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </code>
    ///          </p>
    func getGeoLocation(input: GetGeoLocationInput) async throws -> GetGeoLocationOutputResponse
    {
        typealias getGeoLocationContinuation = CheckedContinuation<GetGeoLocationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getGeoLocationContinuation) in
            getGeoLocation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getHealthCheck(input: GetHealthCheckInput) async throws -> GetHealthCheckOutputResponse
    {
        typealias getHealthCheckContinuation = CheckedContinuation<GetHealthCheckOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getHealthCheckContinuation) in
            getHealthCheck(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getHealthCheckCount(input: GetHealthCheckCountInput) async throws -> GetHealthCheckCountOutputResponse
    {
        typealias getHealthCheckCountContinuation = CheckedContinuation<GetHealthCheckCountOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getHealthCheckCountContinuation) in
            getHealthCheckCount(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getHealthCheckLastFailureReason(input: GetHealthCheckLastFailureReasonInput) async throws -> GetHealthCheckLastFailureReasonOutputResponse
    {
        typealias getHealthCheckLastFailureReasonContinuation = CheckedContinuation<GetHealthCheckLastFailureReasonOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getHealthCheckLastFailureReasonContinuation) in
            getHealthCheckLastFailureReason(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getHealthCheckStatus(input: GetHealthCheckStatusInput) async throws -> GetHealthCheckStatusOutputResponse
    {
        typealias getHealthCheckStatusContinuation = CheckedContinuation<GetHealthCheckStatusOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getHealthCheckStatusContinuation) in
            getHealthCheckStatus(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getHostedZone(input: GetHostedZoneInput) async throws -> GetHostedZoneOutputResponse
    {
        typealias getHostedZoneContinuation = CheckedContinuation<GetHostedZoneOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getHostedZoneContinuation) in
            getHostedZone(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getHostedZoneCount(input: GetHostedZoneCountInput) async throws -> GetHostedZoneCountOutputResponse
    {
        typealias getHostedZoneCountContinuation = CheckedContinuation<GetHostedZoneCountOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getHostedZoneCountContinuation) in
            getHostedZoneCount(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>. To request a higher limit,
    /// 			<a href="https://console.aws.amazon.com/support/home#/case/create?issueType=service-limit-increase&limitType=service-code-route53">open a case</a>.</p>
    func getHostedZoneLimit(input: GetHostedZoneLimitInput) async throws -> GetHostedZoneLimitOutputResponse
    {
        typealias getHostedZoneLimitContinuation = CheckedContinuation<GetHostedZoneLimitOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getHostedZoneLimitContinuation) in
            getHostedZoneLimit(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getQueryLoggingConfig(input: GetQueryLoggingConfigInput) async throws -> GetQueryLoggingConfigOutputResponse
    {
        typealias getQueryLoggingConfigContinuation = CheckedContinuation<GetQueryLoggingConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getQueryLoggingConfigContinuation) in
            getQueryLoggingConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getReusableDelegationSet(input: GetReusableDelegationSetInput) async throws -> GetReusableDelegationSetOutputResponse
    {
        typealias getReusableDelegationSetContinuation = CheckedContinuation<GetReusableDelegationSetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getReusableDelegationSetContinuation) in
            getReusableDelegationSet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>. To request a higher limit,
    /// 			<a href="https://console.aws.amazon.com/support/home#/case/create?issueType=service-limit-increase&limitType=service-code-route53">open a case</a>.</p>
    func getReusableDelegationSetLimit(input: GetReusableDelegationSetLimitInput) async throws -> GetReusableDelegationSetLimitOutputResponse
    {
        typealias getReusableDelegationSetLimitContinuation = CheckedContinuation<GetReusableDelegationSetLimitOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getReusableDelegationSetLimitContinuation) in
            getReusableDelegationSetLimit(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 		</p>
    func getTrafficPolicy(input: GetTrafficPolicyInput) async throws -> GetTrafficPolicyOutputResponse
    {
        typealias getTrafficPolicyContinuation = CheckedContinuation<GetTrafficPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getTrafficPolicyContinuation) in
            getTrafficPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			         <p>In the Route 53 console, traffic policy instances are known as policy records.</p>
    /// 		       </note>
    func getTrafficPolicyInstance(input: GetTrafficPolicyInstanceInput) async throws -> GetTrafficPolicyInstanceOutputResponse
    {
        typealias getTrafficPolicyInstanceContinuation = CheckedContinuation<GetTrafficPolicyInstanceOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getTrafficPolicyInstanceContinuation) in
            getTrafficPolicyInstance(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getTrafficPolicyInstanceCount(input: GetTrafficPolicyInstanceCountInput) async throws -> GetTrafficPolicyInstanceCountOutputResponse
    {
        typealias getTrafficPolicyInstanceCountContinuation = CheckedContinuation<GetTrafficPolicyInstanceCountOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getTrafficPolicyInstanceCountContinuation) in
            getTrafficPolicyInstanceCount(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listGeoLocations(input: ListGeoLocationsInput) async throws -> ListGeoLocationsOutputResponse
    {
        typealias listGeoLocationsContinuation = CheckedContinuation<ListGeoLocationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listGeoLocationsContinuation) in
            listGeoLocations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listHealthChecks(input: ListHealthChecksInput) async throws -> ListHealthChecksOutputResponse
    {
        typealias listHealthChecksContinuation = CheckedContinuation<ListHealthChecksOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listHealthChecksContinuation) in
            listHealthChecks(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listHostedZones(input: ListHostedZonesInput) async throws -> ListHostedZonesOutputResponse
    {
        typealias listHostedZonesContinuation = CheckedContinuation<ListHostedZonesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listHostedZonesContinuation) in
            listHostedZones(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			         </li>
    ///          </ul>
    func listHostedZonesByName(input: ListHostedZonesByNameInput) async throws -> ListHostedZonesByNameOutputResponse
    {
        typealias listHostedZonesByNameContinuation = CheckedContinuation<ListHostedZonesByNameOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listHostedZonesByNameContinuation) in
            listHostedZonesByName(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			         </li>
    ///          </ul>
    func listHostedZonesByVPC(input: ListHostedZonesByVPCInput) async throws -> ListHostedZonesByVPCOutputResponse
    {
        typealias listHostedZonesByVPCContinuation = CheckedContinuation<ListHostedZonesByVPCOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listHostedZonesByVPCContinuation) in
            listHostedZonesByVPC(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>.</p>
    func listQueryLoggingConfigs(input: ListQueryLoggingConfigsInput) async throws -> ListQueryLoggingConfigsOutputResponse
    {
        typealias listQueryLoggingConfigsContinuation = CheckedContinuation<ListQueryLoggingConfigsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listQueryLoggingConfigsContinuation) in
            listQueryLoggingConfigs(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listResourceRecordSets(input: ListResourceRecordSetsInput) async throws -> ListResourceRecordSetsOutputResponse
    {
        typealias listResourceRecordSetsContinuation = CheckedContinuation<ListResourceRecordSetsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listResourceRecordSetsContinuation) in
            listResourceRecordSets(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listReusableDelegationSets(input: ListReusableDelegationSetsInput) async throws -> ListReusableDelegationSetsOutputResponse
    {
        typealias listReusableDelegationSetsContinuation = CheckedContinuation<ListReusableDelegationSetsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listReusableDelegationSetsContinuation) in
            listReusableDelegationSets(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///
    /// 		</p>
    func listTrafficPolicies(input: ListTrafficPoliciesInput) async throws -> ListTrafficPoliciesOutputResponse
    {
        typealias listTrafficPoliciesContinuation = CheckedContinuation<ListTrafficPoliciesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTrafficPoliciesContinuation) in
            listTrafficPolicies(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			<code>MaxItems</code> parameter to list them in groups of up to 100.</p>
    func listTrafficPolicyInstances(input: ListTrafficPolicyInstancesInput) async throws -> ListTrafficPolicyInstancesOutputResponse
    {
        typealias listTrafficPolicyInstancesContinuation = CheckedContinuation<ListTrafficPolicyInstancesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTrafficPolicyInstancesContinuation) in
            listTrafficPolicyInstances(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 		       <p>Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policy instances, you can use the
    /// 			<code>MaxItems</code> parameter to list them in groups of up to 100.</p>
    func listTrafficPolicyInstancesByHostedZone(input: ListTrafficPolicyInstancesByHostedZoneInput) async throws -> ListTrafficPolicyInstancesByHostedZoneOutputResponse
    {
        typealias listTrafficPolicyInstancesByHostedZoneContinuation = CheckedContinuation<ListTrafficPolicyInstancesByHostedZoneOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTrafficPolicyInstancesByHostedZoneContinuation) in
            listTrafficPolicyInstancesByHostedZone(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 		       <p>Route 53 returns a maximum of 100 items in each response. If you have a lot of traffic policy instances, you can use the
    /// 			<code>MaxItems</code> parameter to list them in groups of up to 100.</p>
    func listTrafficPolicyInstancesByPolicy(input: ListTrafficPolicyInstancesByPolicyInput) async throws -> ListTrafficPolicyInstancesByPolicyOutputResponse
    {
        typealias listTrafficPolicyInstancesByPolicyContinuation = CheckedContinuation<ListTrafficPolicyInstancesByPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTrafficPolicyInstancesByPolicyContinuation) in
            listTrafficPolicyInstancesByPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listTrafficPolicyVersions(input: ListTrafficPolicyVersionsInput) async throws -> ListTrafficPolicyVersionsOutputResponse
    {
        typealias listTrafficPolicyVersionsContinuation = CheckedContinuation<ListTrafficPolicyVersionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTrafficPolicyVersionsContinuation) in
            listTrafficPolicyVersions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listVPCAssociationAuthorizations(input: ListVPCAssociationAuthorizationsInput) async throws -> ListVPCAssociationAuthorizationsOutputResponse
    {
        typealias listVPCAssociationAuthorizationsContinuation = CheckedContinuation<ListVPCAssociationAuthorizationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listVPCAssociationAuthorizationsContinuation) in
            listVPCAssociationAuthorizations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias testDNSAnswerContinuation = CheckedContinuation<TestDNSAnswerOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: testDNSAnswerContinuation) in
            testDNSAnswer(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			in the <i>Amazon Route 53 Developer Guide</i>.</p>
    func updateHealthCheck(input: UpdateHealthCheckInput) async throws -> UpdateHealthCheckOutputResponse
    {
        typealias updateHealthCheckContinuation = CheckedContinuation<UpdateHealthCheckOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateHealthCheckContinuation) in
            updateHealthCheck(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func updateHostedZoneComment(input: UpdateHostedZoneCommentInput) async throws -> UpdateHostedZoneCommentOutputResponse
    {
        typealias updateHostedZoneCommentContinuation = CheckedContinuation<UpdateHostedZoneCommentOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateHostedZoneCommentContinuation) in
            updateHostedZoneComment(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func updateTrafficPolicyComment(input: UpdateTrafficPolicyCommentInput) async throws -> UpdateTrafficPolicyCommentOutputResponse
    {
        typealias updateTrafficPolicyCommentContinuation = CheckedContinuation<UpdateTrafficPolicyCommentOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateTrafficPolicyCommentContinuation) in
            updateTrafficPolicyComment(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			         </li>
    ///          </ol>
    func updateTrafficPolicyInstance(input: UpdateTrafficPolicyInstanceInput) async throws -> UpdateTrafficPolicyInstanceOutputResponse
    {
        typealias updateTrafficPolicyInstanceContinuation = CheckedContinuation<UpdateTrafficPolicyInstanceOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateTrafficPolicyInstanceContinuation) in
            updateTrafficPolicyInstance(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
