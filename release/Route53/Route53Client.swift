...
public class Route53Client {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try Route53ClientConfiguration(region: unwrappedRegion)
    ...
    public class Route53ClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("Route53Client")
...
public struct Route53ClientLogHandlerFactory: SDKLogHandlerFactory {
