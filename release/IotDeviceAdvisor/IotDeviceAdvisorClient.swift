...
extension IotDeviceAdvisorClient: IotDeviceAdvisorClientProtocol {
    ...
    public func createSuiteDefinition(input: CreateSuiteDefinitionInput, completion: @escaping (SdkResult<CreateSuiteDefinitionOutput, CreateSuiteDefinitionOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<CreateSuiteDefinitionInput, CreateSuiteDefinitionOutput, CreateSuiteDefinitionOutputError>(id: "createSuiteDefinition")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateSuiteDefinitionInput, CreateSuiteDefinitionOutput, CreateSuiteDefinitionOutputError>(contentType: "application/json"))
    ...
    public func deleteSuiteDefinition(input: DeleteSuiteDefinitionInput, completion: @escaping (SdkResult<DeleteSuiteDefinitionOutput, DeleteSuiteDefinitionOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotdeviceadvisor")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteSuiteDefinitionInput, DeleteSuiteDefinitionOutput, DeleteSuiteDefinitionOutputError>(id: "deleteSuiteDefinition")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteSuiteDefinitionInput, DeleteSuiteDefinitionOutput, DeleteSuiteDefinitionOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getSuiteDefinition(input: GetSuiteDefinitionInput, completion: @escaping (SdkResult<GetSuiteDefinitionOutput, GetSuiteDefinitionOutputError>) -> Void)
    {
        guard let suiteDefinitionId = input.suiteDefinitionId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component suiteDefinitionId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotdeviceadvisor")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSuiteDefinitionInput, GetSuiteDefinitionOutput, GetSuiteDefinitionOutputError>(id: "getSuiteDefinition")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSuiteDefinitionInput, GetSuiteDefinitionOutput, GetSuiteDefinitionOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getSuiteRun(input: GetSuiteRunInput, completion: @escaping (SdkResult<GetSuiteRunOutput, GetSuiteRunOutputError>) -> Void)
    {
        guard let suiteDefinitionId = input.suiteDefinitionId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component suiteDefinitionId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotdeviceadvisor")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSuiteRunInput, GetSuiteRunOutput, GetSuiteRunOutputError>(id: "getSuiteRun")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSuiteRunInput, GetSuiteRunOutput, GetSuiteRunOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getSuiteRunReport(input: GetSuiteRunReportInput, completion: @escaping (SdkResult<GetSuiteRunReportOutput, GetSuiteRunReportOutputError>) -> Void)
    {
        guard let suiteDefinitionId = input.suiteDefinitionId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component suiteDefinitionId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotdeviceadvisor")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSuiteRunReportInput, GetSuiteRunReportOutput, GetSuiteRunReportOutputError>(id: "getSuiteRunReport")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSuiteRunReportInput, GetSuiteRunReportOutput, GetSuiteRunReportOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listSuiteDefinitions(input: ListSuiteDefinitionsInput, completion: @escaping (SdkResult<ListSuiteDefinitionsOutput, ListSuiteDefinitionsOutputError>) -> Void)
    {
        let urlPath = "/suiteDefinitions"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "iotdeviceadvisor")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListSuiteDefinitionsInput, ListSuiteDefinitionsOutput, ListSuiteDefinitionsOutputError>(id: "listSuiteDefinitions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListSuiteDefinitionsInput, ListSuiteDefinitionsOutput, ListSuiteDefinitionsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listSuiteRuns(input: ListSuiteRunsInput, completion: @escaping (SdkResult<ListSuiteRunsOutput, ListSuiteRunsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotdeviceadvisor")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListSuiteRunsInput, ListSuiteRunsOutput, ListSuiteRunsOutputError>(id: "listSuiteRuns")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListSuiteRunsInput, ListSuiteRunsOutput, ListSuiteRunsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func startSuiteRun(input: StartSuiteRunInput, completion: @escaping (SdkResult<StartSuiteRunOutput, StartSuiteRunOutputError>) -> Void)
    {
        guard let suiteDefinitionId = input.suiteDefinitionId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component suiteDefinitionId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotdeviceadvisor")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartSuiteRunInput, StartSuiteRunOutput, StartSuiteRunOutputError>(id: "startSuiteRun")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartSuiteRunInput, StartSuiteRunOutput, StartSuiteRunOutputError>(contentType: "application/json"))
    ...
    public func stopSuiteRun(input: StopSuiteRunInput, completion: @escaping (SdkResult<StopSuiteRunOutput, StopSuiteRunOutputError>) -> Void)
    {
        guard let suiteDefinitionId = input.suiteDefinitionId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component suiteDefinitionId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotdeviceadvisor")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StopSuiteRunInput, StopSuiteRunOutput, StopSuiteRunOutputError>(id: "stopSuiteRun")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StopSuiteRunInput, StopSuiteRunOutput, StopSuiteRunOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func updateSuiteDefinition(input: UpdateSuiteDefinitionInput, completion: @escaping (SdkResult<UpdateSuiteDefinitionOutput, UpdateSuiteDefinitionOutputError>) -> Void)
    {
        guard let suiteDefinitionId = input.suiteDefinitionId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component suiteDefinitionId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotdeviceadvisor")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateSuiteDefinitionInput, UpdateSuiteDefinitionOutput, UpdateSuiteDefinitionOutputError>(id: "updateSuiteDefinition")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateSuiteDefinitionInput, UpdateSuiteDefinitionOutput, UpdateSuiteDefinitionOutputError>(contentType: "application/json"))
