...
public struct AddTagsToResourceInput: Swift.Equatable {
    ...
    /// One or more tags.
    /// This member is required.
    var tagList: [CloudHsmClientTypes.Tag]?
...
public struct CreateHsmInput: Swift.Equatable {
    ...
    /// This member is required.
    var subscriptionType: CloudHsmClientTypes.SubscriptionType?
    /// The IP address for the syslog monitoring server. The AWS CloudHSM service only supports one syslog monitoring server.
    var syslogIp: Swift.String?
...
public struct DescribeHapgOutputResponse: Swift.Equatable {
    ...
    var hapgSerial: Swift.String?
    ///
    var hsmsLastActionFailed: [Swift.String]?
    ///
    var hsmsPendingDeletion: [Swift.String]?
    ///
    var hsmsPendingRegistration: [Swift.String]?
    /// The label for the high-availability partition group.
    var label: Swift.String?
    /// The date and time the high-availability partition group was last modified.
    var lastModifiedTimestamp: Swift.String?
    /// The list of partition serial numbers that belong to the high-availability partition group.
    var partitionSerialList: [Swift.String]?
    /// The state of the high-availability partition group.
    var state: CloudHsmClientTypes.CloudHsmObjectState?
...
public struct DescribeHsmInput: Swift.Equatable {
    ...
    var hsmSerialNumber: Swift.String?
...
public struct DescribeHsmOutputResponse: Swift.Equatable {
    ...
    var partitions: [Swift.String]?
    /// The serial number of the HSM.
    var serialNumber: Swift.String?
    /// The date and time that the server certificate was last updated.
    var serverCertLastUpdated: Swift.String?
    /// The URI of the certificate server.
    var serverCertUri: Swift.String?
    /// The HSM software version.
    var softwareVersion: Swift.String?
    /// The date and time that the SSH key was last updated.
    var sshKeyLastUpdated: Swift.String?
    /// The public SSH key.
    var sshPublicKey: Swift.String?
    /// The status of the HSM.
    var status: CloudHsmClientTypes.HsmStatus?
    /// Contains additional information about the status of the HSM.
    var statusDetails: Swift.String?
    /// The identifier of the subnet that the HSM is in.
    var subnetId: Swift.String?
    /// The subscription end date.
    var subscriptionEndDate: Swift.String?
    /// The subscription start date.
    var subscriptionStartDate: Swift.String?
    /// Specifies the type of subscription for the HSM.
    ///
    /// * PRODUCTION - The HSM is being used in a production environment.
    ///
...
public struct DescribeLunaClientInput: Swift.Equatable {
    ...
    var certificateFingerprint: Swift.String?
    /// The ARN of the client.
    var clientArn: Swift.String?
...
public struct GetConfigInput: Swift.Equatable {
    ...
    /// The client version.
    /// This member is required.
    var clientVersion: CloudHsmClientTypes.ClientVersion?
    /// A list of ARNs that identify the high-availability partition groups that are associated with the client.
    /// This member is required.
    var hapgList: [Swift.String]?
...
public struct GetConfigOutputResponse: Swift.Equatable {
    ...
    var configCred: Swift.String?
    /// The chrystoki.conf configuration file.
    var configFile: Swift.String?
    /// The type of credentials.
    var configType: Swift.String?
