...
public struct BatchEvaluateFeatureOutputResponse: Swift.Equatable {
    ...
    var results: [EvidentlyClientTypes.EvaluationResult]?
...
public struct CreateExperimentInput: Swift.Equatable {
    ...
    /// This member is required.
    var metricGoals: [EvidentlyClientTypes.MetricGoalConfig]?
    ...
    var onlineAbConfig: EvidentlyClientTypes.OnlineAbConfig?
    /// The name or ARN of the project that you want to create the new experiment in.
    /// This member is required.
    var project: Swift.String?
    /// When Evidently assigns a particular user session to an experiment, it must use a randomization ID to determine which variation the user session is served. This randomization ID is a combination of the entity ID and randomizationSalt. If you omit randomizationSalt, Evidently uses the experiment name as the randomizationSalt.
    var randomizationSalt: Swift.String?
    ...
    /// This member is required.
    var treatments: [EvidentlyClientTypes.TreatmentConfig]?
...
public struct CreateExperimentOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var experiment: EvidentlyClientTypes.Experiment?
...
public struct CreateFeatureInput: Swift.Equatable {
    ...
    var defaultVariation: Swift.String?
    /// An optional description of the feature.
    var description: Swift.String?
    /// Specify users that should always be served a specific variation of a feature. Each user is specified by a key-value pair . For each key, specify a user by entering their user ID, account ID, or some other identifier. For the value, specify the name of the variation that they are to be served.
    var entityOverrides: [Swift.String:Swift.String]?
    /// Specify ALL_RULES to activate the traffic allocation specified by any ongoing launches or experiments. Specify DEFAULT_VARIATION to serve the default variation to all users instead.
    var evaluationStrategy: EvidentlyClientTypes.FeatureEvaluationStrategy?
    ...
    /// This member is required.
    var variations: [EvidentlyClientTypes.VariationConfig]?
...
public struct CreateFeatureOutputResponse: Swift.Equatable {
    ...
    var feature: EvidentlyClientTypes.Feature?
...
public struct CreateLaunchInput: Swift.Equatable {
    ...
    /// This member is required.
    var groups: [EvidentlyClientTypes.LaunchGroupConfig]?
    /// An array of structures that define the metrics that will be used to monitor the launch performance.
    var metricMonitors: [EvidentlyClientTypes.MetricMonitorConfig]?
    ...
    var scheduledSplitsConfig: EvidentlyClientTypes.ScheduledSplitsLaunchConfig?
...
public struct CreateLaunchOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var launch: EvidentlyClientTypes.Launch?
...
public struct CreateProjectInput: Swift.Equatable {
    ...
    var dataDelivery: EvidentlyClientTypes.ProjectDataDeliveryConfig?
...
public struct CreateProjectOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var project: EvidentlyClientTypes.Project?
...
public struct EvaluateFeatureInput: Swift.Equatable {
    ...
    var evaluationContext: Swift.String?
...
public struct EvaluateFeatureOutputResponse: Swift.Equatable {
    ...
    var value: EvidentlyClientTypes.VariableValue?
    /// The name of the variation that was served to the user session.
    var variation: Swift.String?
...
extension EvidentlyClientTypes {
    ...
    public struct Event: Swift.Equatable {
        ...
        /// This member is required.
        var type: EvidentlyClientTypes.EventType?
...
extension EvidentlyClientTypes {
    ...
    public struct Experiment: Swift.Equatable {
        ...
        var execution: EvidentlyClientTypes.ExperimentExecution?
        /// The date and time that the experiment was most recently updated.
        /// This member is required.
        var lastUpdatedTime: ClientRuntime.Date?
        /// An array of structures that defines the metrics used for the experiment, and whether a higher or lower value for each metric is the goal.
        var metricGoals: [EvidentlyClientTypes.MetricGoal]?
        /// The name of the experiment.
        /// This member is required.
        var name: Swift.String?
        /// A structure that contains the configuration of which variation to use as the "control" version. The "control" version is used for comparison with other variations. This structure also specifies how much experiment traffic is allocated to each variation.
        var onlineAbDefinition: EvidentlyClientTypes.OnlineAbDefinition?
        ...
        var schedule: EvidentlyClientTypes.ExperimentSchedule?
        /// The current state of the experiment.
        /// This member is required.
        var status: EvidentlyClientTypes.ExperimentStatus?
        ...
        var tags: [Swift.String:Swift.String]?
        /// An array of structures that describe the configuration of each feature variation used in the experiment.
        var treatments: [EvidentlyClientTypes.Treatment]?
        /// The type of this experiment. Currently, this value must be aws.experiment.onlineab.
        /// This member is required.
        var type: EvidentlyClientTypes.ExperimentType?
...
extension EvidentlyClientTypes {
    ...
    public struct ExperimentExecution: Swift.Equatable {
        ...
        var endedTime: ClientRuntime.Date?
        /// The date and time that the experiment started.
        var startedTime: ClientRuntime.Date?
...
extension EvidentlyClientTypes {
    ...
    public struct ExperimentReport: Swift.Equatable {
        ...
        var reportName: EvidentlyClientTypes.ExperimentReportName?
        /// The name of the variation that this report pertains to.
        var treatmentName: Swift.String?
...
extension EvidentlyClientTypes {
    ...
    public struct ExperimentResultsData: Swift.Equatable {
        ...
        var resultStat: EvidentlyClientTypes.ExperimentResultResponseType?
...
extension EvidentlyClientTypes {
    ...
    public struct ExperimentSchedule: Swift.Equatable {
        ...
        var analysisCompleteTime: ClientRuntime.Date?
...
extension EvidentlyClientTypes {
    ...
    public struct Feature: Swift.Equatable {
        ...
        var evaluationRules: [EvidentlyClientTypes.EvaluationRule]?
        ...
        /// This member is required.
        var status: EvidentlyClientTypes.FeatureStatus?
        ...
        /// This member is required.
        var valueType: EvidentlyClientTypes.VariationValueType?
        /// An array of structures that contain the configuration of the feature's different variations.
        /// This member is required.
        var variations: [EvidentlyClientTypes.Variation]?
...
public struct GetExperimentResultsInput: Swift.Equatable {
    ...
    var baseStat: EvidentlyClientTypes.ExperimentBaseStat?
    ...
    var reportNames: [EvidentlyClientTypes.ExperimentReportName]?
    ...
    var resultStats: [EvidentlyClientTypes.ExperimentResultRequestType]?
    /// The date and time that the experiment started.
    var startTime: ClientRuntime.Date?
    /// The names of the experiment treatments that you want to see the results for.
    /// This member is required.
    var treatmentNames: [Swift.String]?
...
public struct GetExperimentResultsOutputResponse: Swift.Equatable {
    ...
    var reports: [EvidentlyClientTypes.ExperimentReport]?
    /// An array of structures that include experiment results including metric names and values.
    var resultsData: [EvidentlyClientTypes.ExperimentResultsData]?
...
extension EvidentlyClientTypes {
    ...
    public struct Launch: Swift.Equatable {
        ...
        var execution: EvidentlyClientTypes.LaunchExecution?
        /// An array of structures that define the feature variations that are being used in the launch.
        var groups: [EvidentlyClientTypes.LaunchGroup]?
        /// The date and time that the launch was most recently updated.
        /// This member is required.
        var lastUpdatedTime: ClientRuntime.Date?
        /// An array of structures that define the metrics that are being used to monitor the launch performance.
        var metricMonitors: [EvidentlyClientTypes.MetricMonitor]?
        ...
        var randomizationSalt: Swift.String?
        /// An array of structures that define the traffic allocation percentages among the feature variations during each step of the launch.
        var scheduledSplitsDefinition: EvidentlyClientTypes.ScheduledSplitsLaunchDefinition?
        /// The current state of the launch.
        /// This member is required.
        var status: EvidentlyClientTypes.LaunchStatus?
        ...
        /// The type of launch.
        /// This member is required.
        var type: EvidentlyClientTypes.LaunchType?
...
extension EvidentlyClientTypes {
    ...
    public struct LaunchGroup: Swift.Equatable {
        ...
        /// This member is required.
        var featureVariations: [Swift.String:Swift.String]?
...
public struct ListExperimentsOutputResponse: Swift.Equatable {
    ...
    var experiments: [EvidentlyClientTypes.Experiment]?
...
public struct ListFeaturesOutputResponse: Swift.Equatable {
    ...
    var features: [EvidentlyClientTypes.FeatureSummary]?
...
public struct ListLaunchesOutputResponse: Swift.Equatable {
    ...
    var launches: [EvidentlyClientTypes.Launch]?
...
public struct ListProjectsOutputResponse: Swift.Equatable {
    ...
    var projects: [EvidentlyClientTypes.ProjectSummary]?
...
extension EvidentlyClientTypes {
    ...
    public struct MetricGoal: Swift.Equatable {
        ...
        var desiredChange: EvidentlyClientTypes.ChangeDirectionEnum?
        /// A structure that contains details about the metric.
        /// This member is required.
        var metricDefinition: EvidentlyClientTypes.MetricDefinition?
...
extension EvidentlyClientTypes {
    ...
    public struct MetricGoalConfig: Swift.Equatable {
        ...
        /// A structure that contains details about the metric.
        /// This member is required.
        var metricDefinition: EvidentlyClientTypes.MetricDefinitionConfig?
...
extension EvidentlyClientTypes {
    ...
    public struct OnlineAbConfig: Swift.Equatable {
        ...
        var controlTreatmentName: Swift.String?
        ...
        var treatmentWeights: [Swift.String:Swift.Int]?
...
extension EvidentlyClientTypes {
    ...
    public struct Project: Swift.Equatable {
        ...
        var activeExperimentCount: Swift.Int?
        /// The number of ongoing launches currently in the project.
        var activeLaunchCount: Swift.Int?
        ...
        var dataDelivery: EvidentlyClientTypes.ProjectDataDelivery?
        /// The user-entered description of the project.
        var description: Swift.String?
        /// The number of experiments currently in the project. This includes all experiments that have been created and not deleted, whether they are ongoing or not.
        var experimentCount: Swift.Int?
        /// The number of features currently in the project.
        var featureCount: Swift.Int?
        /// The date and time that the project was most recently updated.
        /// This member is required.
        var lastUpdatedTime: ClientRuntime.Date?
        /// The number of launches currently in the project. This includes all launches that have been created and not deleted, whether they are ongoing or not.
        var launchCount: Swift.Int?
        /// The name of the project.
        /// This member is required.
        var name: Swift.String?
        /// The current state of the project.
        /// This member is required.
        var status: EvidentlyClientTypes.ProjectStatus?
...
extension EvidentlyClientTypes {
    ...
    public struct ProjectDataDelivery: Swift.Equatable {
        ...
        var cloudWatchLogs: EvidentlyClientTypes.CloudWatchLogsDestination?
        /// If the project stores evaluation events in an Amazon S3 bucket, this structure stores the bucket name and bucket prefix.
        var s3Destination: EvidentlyClientTypes.S3Destination?
...
extension EvidentlyClientTypes {
    ...
    public struct ProjectDataDeliveryConfig: Swift.Equatable {
        /// If the project stores evaluation events in CloudWatch Logs, this structure stores the log group name.
        var cloudWatchLogs: EvidentlyClientTypes.CloudWatchLogsDestinationConfig?
        /// If the project stores evaluation events in an Amazon S3 bucket, this structure stores the bucket name and bucket prefix.
        var s3Destination: EvidentlyClientTypes.S3DestinationConfig?
...
public struct PutProjectEventsInput: Swift.Equatable {
    ...
    /// This member is required.
    var events: [EvidentlyClientTypes.Event]?
...
public struct PutProjectEventsOutputResponse: Swift.Equatable {
    ...
    var eventResults: [EvidentlyClientTypes.PutProjectEventsResultEntry]?
    /// The number of events in the operation that could not be used by Evidently.
    var failedEventCount: Swift.Int?
...
extension EvidentlyClientTypes {
    ...
    public struct ScheduledSplit: Swift.Equatable {
        ...
        var groupWeights: [Swift.String:Swift.Int]?
...
extension EvidentlyClientTypes {
    ...
    public struct ScheduledSplitsLaunchConfig: Swift.Equatable {
        ...
        /// This member is required.
        var steps: [EvidentlyClientTypes.ScheduledSplitConfig]?
...
extension EvidentlyClientTypes {
    ...
    public struct ScheduledSplitsLaunchDefinition: Swift.Equatable {
        /// An array of structures that define the traffic allocation percentages among the feature variations during each step of the launch. This also defines the start time of each step.
        var steps: [EvidentlyClientTypes.ScheduledSplit]?
...
public struct StopExperimentInput: Swift.Equatable {
    ...
    var desiredState: EvidentlyClientTypes.ExperimentStopDesiredState?
...
public struct StopLaunchInput: Swift.Equatable {
    ...
    var desiredState: EvidentlyClientTypes.LaunchStopDesiredState?
...
public struct UpdateFeatureInput: Swift.Equatable {
    ...
    var addOrUpdateVariations: [EvidentlyClientTypes.VariationConfig]?
    ...
    var removeVariations: [Swift.String]?
