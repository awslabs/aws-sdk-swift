...
public struct AcceptPageInput: Swift.Equatable {
    ...
    var acceptCodeValidation: SsmContactsClientTypes.AcceptCodeValidation?
    /// The type indicates if the page was DELIVERED or READ.
    /// This member is required.
    var acceptType: SsmContactsClientTypes.AcceptType?
    /// The ARN of the contact channel.
    var contactChannelId: Swift.String?
    /// Information provided by the user when the user acknowledges the page.
    var note: Swift.String?
...
public struct ActivateContactChannelInput: Swift.Equatable {
    ...
    /// This member is required.
    var activationCode: Swift.String?
...
extension SsmContactsClientTypes {
    ...
    public struct ChannelTargetInfo: Swift.Equatable {
        ...
        var retryIntervalInMinutes: Swift.Int?
...
extension SsmContactsClientTypes {
    ...
    public struct Contact: Swift.Equatable {
        ...
        /// This member is required.
        var type: SsmContactsClientTypes.ContactType?
...
extension SsmContactsClientTypes {
    ...
    public struct ContactChannel: Swift.Equatable {
        ...
        /// This member is required.
        var activationStatus: SsmContactsClientTypes.ActivationStatus?
        /// The ARN of the contact that contains the contact channel.
        /// This member is required.
        var contactArn: Swift.String?
        /// The Amazon Resource Name (ARN) of the contact channel.
        /// This member is required.
        var contactChannelArn: Swift.String?
        /// The details that Incident Manager uses when trying to engage the contact channel.
        /// This member is required.
        var deliveryAddress: SsmContactsClientTypes.ContactChannelAddress?
        ...
        ///
        /// * EMAIL
        var type: SsmContactsClientTypes.ChannelType?
...
extension SsmContactsClientTypes {
    ...
    public struct ContactChannelAddress: Swift.Equatable {
        ...
        var simpleAddress: Swift.String?
...
extension SsmContactsClientTypes {
    ...
    public struct ContactTargetInfo: Swift.Equatable {
        ...
        var contactId: Swift.String?
        /// A Boolean value determining if the contact's acknowledgement stops the progress of stages in the plan.
        /// This member is required.
        var isEssential: Swift.Bool?
...
public struct CreateContactChannelInput: Swift.Equatable {
    ...
    var deferActivation: Swift.Bool?
...
public struct CreateContactInput: Swift.Equatable {
    ...
    /// This member is required.
    var plan: SsmContactsClientTypes.Plan?
    /// Adds a tag to the target. You can only tag resources created in the first Region of your replication set.
    var tags: [SsmContactsClientTypes.Tag]?
...
public struct DescribeEngagementOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var engagementArn: Swift.String?
    /// The ARN of the incident in which the engagement occurred.
    var incidentId: Swift.String?
    /// The insecure content of the message that was sent to the contact. Use this field for engagements to SMS.
    var publicContent: Swift.String?
    /// The insecure subject of the message that was sent to the contact. Use this field for engagements to SMS.
    var publicSubject: Swift.String?
    /// The user that started the engagement.
    /// This member is required.
    var sender: Swift.String?
    /// The time that the engagement started.
    var startTime: ClientRuntime.Date?
    /// The time that the engagement ended.
    var stopTime: ClientRuntime.Date?
...
public struct DescribePageOutputResponse: Swift.Equatable {
    ...
    var deliveryTime: ClientRuntime.Date?
    ...
    /// The Amazon Resource Name (ARN) of the engagement to a contact channel.
    /// This member is required.
    var pageArn: Swift.String?
    /// The insecure content of the message that was sent to the contact. Use this field for engagements to SMS.
    var publicContent: Swift.String?
    /// The insecure subject of the message that was sent to the contact. Use this field for engagements to SMS.
    var publicSubject: Swift.String?
    /// The time that the contact channel acknowledged the engagement.
    var readTime: ClientRuntime.Date?
    /// The user that started the engagement.
    /// This member is required.
    var sender: Swift.String?
    /// The time the engagement was sent to the contact channel.
    var sentTime: ClientRuntime.Date?
    /// The secure subject of the message that was sent to the contact. Use this field for engagements to VOICE and EMAIL.
    /// This member is required.
    var subject: Swift.String?
...
public struct ListContactChannelsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var contactChannels: [SsmContactsClientTypes.ContactChannel]?
    /// The pagination token to continue to the next page of results.
    var nextToken: Swift.String?
...
public struct ListContactsOutputResponse: Swift.Equatable {
    ...
    var contacts: [SsmContactsClientTypes.Contact]?
    /// The pagination token to continue to the next page of results.
    var nextToken: Swift.String?
...
public struct ListEngagementsInput: Swift.Equatable {
    ...
    var timeRangeValue: SsmContactsClientTypes.TimeRange?
...
public struct ListEngagementsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var engagements: [SsmContactsClientTypes.Engagement]?
    /// The pagination token to continue to the next page of results.
    var nextToken: Swift.String?
...
public struct ListPageReceiptsOutputResponse: Swift.Equatable {
    ...
    var receipts: [SsmContactsClientTypes.Receipt]?
...
public struct ListPagesByContactOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var pages: [SsmContactsClientTypes.Page]?
...
extension SsmContactsClientTypes {
    ...
    public struct Plan: Swift.Equatable {
        ...
        /// This member is required.
        var stages: [SsmContactsClientTypes.Stage]?
...
extension SsmContactsClientTypes {
    ...
    public struct Receipt: Swift.Equatable {
        ...
        var receiptInfo: Swift.String?
        /// The time receipt was SENT, DELIVERED, or READ.
        /// This member is required.
        var receiptTime: ClientRuntime.Date?
        /// The type follows the engagement cycle, SENT, DELIVERED, and READ.
        /// This member is required.
        var receiptType: SsmContactsClientTypes.ReceiptType?
...
extension SsmContactsClientTypes {
    ...
    public struct Stage: Swift.Equatable {
        ...
        /// This member is required.
        var targets: [SsmContactsClientTypes.Target]?
...
extension SsmContactsClientTypes {
    ...
    public struct Target: Swift.Equatable {
        ...
        var channelTargetInfo: SsmContactsClientTypes.ChannelTargetInfo?
        /// Information about the contact that Incident Manager is engaging.
        var contactTargetInfo: SsmContactsClientTypes.ContactTargetInfo?
