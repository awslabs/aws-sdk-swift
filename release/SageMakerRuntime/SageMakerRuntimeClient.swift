...
extension SageMakerRuntimeClient: SageMakerRuntimeClientProtocol {
    ...
    ///         </note>
    public func invokeEndpoint(input: InvokeEndpointInput, completion: @escaping (SdkResult<InvokeEndpointOutput, InvokeEndpointOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<InvokeEndpointInput, InvokeEndpointOutput, InvokeEndpointOutputError>(id: "invokeEndpoint")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<InvokeEndpointInput, InvokeEndpointOutput, InvokeEndpointOutputError>(contentType: "application/json"))
