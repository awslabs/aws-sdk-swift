...
extension BraketClientTypes {
    ...
    public struct AlgorithmSpecification: Swift.Equatable {
        ...
        var containerImage: BraketClientTypes.ContainerImage?
        /// Configures the paths to the Python scripts used for entry and training.
        var scriptModeConfig: BraketClientTypes.ScriptModeConfig?
...
public struct CancelJobOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var cancellationStatus: BraketClientTypes.CancellationStatus?
...
public struct CancelQuantumTaskInput: Swift.Equatable {
    ...
    /// This member is required.
    var quantumTaskArn: Swift.String?
...
public struct CreateJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var algorithmSpecification: BraketClientTypes.AlgorithmSpecification?
    /// Information about the output locations for job checkpoint data.
    var checkpointConfig: BraketClientTypes.JobCheckpointConfig?
    /// A unique token that guarantees that the call to this API is idempotent.
    /// This member is required.
    var clientToken: Swift.String?
    /// The quantum processing unit (QPU) or simulator used to create an Amazon Braket job.
    /// This member is required.
    var deviceConfig: BraketClientTypes.DeviceConfig?
    /// Algorithm-specific parameters used by an Amazon Braket job that influence the quality of the training job. The values are set with a string of JSON key:value pairs, where the key is the name of the hyperparameter and the value is the value of th hyperparameter.
    var hyperParameters: [Swift.String:Swift.String]?
    /// A list of parameters that specify the name and type of input data and where it is located.
    var inputDataConfig: [BraketClientTypes.InputFileConfig]?
    /// Configuration of the resource instances to use while running the hybrid job on Amazon Braket.
    /// This member is required.
    var instanceConfig: BraketClientTypes.InstanceConfig?
    /// The name of the Amazon Braket job.
    /// This member is required.
    var jobName: Swift.String?
    /// The path to the S3 location where you want to store job artifacts and the encryption key used to store them.
    /// This member is required.
    var outputDataConfig: BraketClientTypes.JobOutputDataConfig?
    /// The Amazon Resource Name (ARN) of an IAM role that Amazon Braket can assume to perform tasks on behalf of a user. It can access user resources, run an Amazon Braket job container on behalf of user, and output resources to the users' s3 buckets.
    /// This member is required.
    var roleArn: Swift.String?
    /// The user-defined criteria that specifies when a job stops running.
    var stoppingCondition: BraketClientTypes.JobStoppingCondition?
...
public struct CreateQuantumTaskInput: Swift.Equatable {
    ...
    var deviceParameters: Swift.String?
    /// The token for an Amazon Braket job that associates it with the quantum task.
    var jobToken: Swift.String?
    /// The S3 bucket to store task result files in.
    /// This member is required.
    var outputS3Bucket: Swift.String?
...
extension BraketClientTypes {
    ...
    public struct DataSource: Swift.Equatable {
        ...
        /// This member is required.
        var s3DataSource: BraketClientTypes.S3DataSource?
...
extension BraketClientTypes {
    ...
    public struct DeviceSummary: Swift.Equatable {
        ...
        /// This member is required.
        var deviceStatus: BraketClientTypes.DeviceStatus?
        /// The type of the device.
        /// This member is required.
        var deviceType: BraketClientTypes.DeviceType?
...
public struct GetDeviceOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var deviceCapabilities: Swift.String?
    /// The name of the device.
    /// This member is required.
    var deviceName: Swift.String?
    /// The status of the device.
...
public struct GetJobOutputResponse: Swift.Equatable {
    ...
    var billableDuration: Swift.Int?
    /// Information about the output locations for job checkpoint data.
    var checkpointConfig: BraketClientTypes.JobCheckpointConfig?
    ...
    var endedAt: ClientRuntime.Date?
    /// Details about the type and time events occurred related to the Amazon Braket job.
    var events: [BraketClientTypes.JobEventDetails]?
    ...
    /// This member is required.
    var status: BraketClientTypes.JobPrimaryStatus?
...
public struct GetQuantumTaskOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var outputS3Directory: Swift.String?
    /// The ARN of the task.
    /// This member is required.
    var quantumTaskArn: Swift.String?
    ...
    /// This member is required.
    var status: BraketClientTypes.QuantumTaskStatus?
...
extension BraketClientTypes {
    ...
    public struct InputFileConfig: Swift.Equatable {
        ...
        /// This member is required.
        var dataSource: BraketClientTypes.DataSource?
...
extension BraketClientTypes {
    ...
    public struct InstanceConfig: Swift.Equatable {
        ...
        /// This member is required.
        var instanceType: BraketClientTypes.InstanceType?
...
extension BraketClientTypes {
    ...
    public struct JobEventDetails: Swift.Equatable {
        ...
        var eventType: BraketClientTypes.JobEventType?
        /// A message describing the event that occurred related to the Amazon Braket job.
        var message: Swift.String?
        /// TThe type of event that occurred related to the Amazon Braket job.
        var timeOfEvent: ClientRuntime.Date?
...
extension BraketClientTypes {
    ...
    public struct JobStoppingCondition: Swift.Equatable {
        ...
        var maxRuntimeInSeconds: Swift.Int?
...
extension BraketClientTypes {
    ...
    public struct ScriptModeConfig: Swift.Equatable {
        ...
        var compressionType: BraketClientTypes.CompressionType?
...
public struct SearchDevicesInput: Swift.Equatable {
    ...
    /// This member is required.
    var filters: [BraketClientTypes.SearchDevicesFilter]?
...
public struct SearchDevicesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var devices: [BraketClientTypes.DeviceSummary]?
...
extension BraketClientTypes {
    ...
    public struct SearchJobsFilter: Swift.Equatable {
        ...
        /// This member is required.
        var `operator`: BraketClientTypes.SearchJobsFilterOperator?
...
public struct SearchJobsInput: Swift.Equatable {
    ...
    /// This member is required.
    var filters: [BraketClientTypes.SearchJobsFilter]?
    /// The maximum number of results to return in the response.
    var maxResults: Swift.Int?
...
public struct SearchJobsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var jobs: [BraketClientTypes.JobSummary]?
    /// A token used for pagination of results, or null if there are no additional results. Use the token value in a subsequent request to continue results where the previous request ended.
    var nextToken: Swift.String?
...
extension BraketClientTypes {
    ...
    public struct SearchQuantumTasksFilter: Swift.Equatable {
        ...
        /// This member is required.
        var `operator`: BraketClientTypes.SearchQuantumTasksFilterOperator?
...
public struct SearchQuantumTasksInput: Swift.Equatable {
    ...
    /// This member is required.
    var filters: [BraketClientTypes.SearchQuantumTasksFilter]?
...
public struct SearchQuantumTasksOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var quantumTasks: [BraketClientTypes.QuantumTaskSummary]?
