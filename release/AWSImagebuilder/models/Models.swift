...
extension ImagebuilderClientTypes.LaunchPermissionConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LaunchPermissionConfiguration(organizationArns: \(Swift.String(describing: organizationArns)), organizationalUnitArns: \(Swift.String(describing: organizationalUnitArns)), userGroups: \(Swift.String(describing: userGroups)), userIds: \(Swift.String(describing: userIds)))"}
}
