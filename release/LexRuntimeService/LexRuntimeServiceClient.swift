...
extension LexRuntimeServiceClient: LexRuntimeServiceClientProtocol {
    ...
    public func postContent(input: PostContentInput, streamSource: StreamSource, completion: @escaping (SdkResult<PostContentOutput, PostContentOutputError>) -> Void)
    {
        guard let botName = input.botName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PostContentInput, PostContentOutput, PostContentOutputError>(id: "postContent")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PostContentInput, PostContentOutput, PostContentOutputError>(contentType: "application/json"))
    ...
    ///         <code>sessionAttributes</code>. For more information, see <a href="https://docs.aws.amazon.com/lex/latest/dg/context-mgmt.html">Managing
    ///         Conversation Context</a>. </p>
    public func postText(input: PostTextInput, completion: @escaping (SdkResult<PostTextOutput, PostTextOutputError>) -> Void)
    {
        guard let botName = input.botName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "lex")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PostTextInput, PostTextOutput, PostTextOutputError>(id: "postText")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PostTextInput, PostTextOutput, PostTextOutputError>(contentType: "application/json"))
