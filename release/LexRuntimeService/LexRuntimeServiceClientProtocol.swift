...
///       API, . </p>
public protocol LexRuntimeServiceClientProtocol {
    /// <p>Removes session information for a specified bot, alias, and user ID.
    ///     </p>
    func deleteSession(input: DeleteSessionInput, completion: @escaping (SdkResult<DeleteSessionOutput, DeleteSessionOutputError>) -> Void)
    /// <p>Returns session information for a specified bot, alias, and user
    ///       ID.</p>
    func getSession(input: GetSessionInput, completion: @escaping (SdkResult<GetSessionOutput, GetSessionOutputError>) -> Void)
    ...
    func postContent(input: PostContentInput, streamSource: StreamSource, completion: @escaping (SdkResult<PostContentOutput, PostContentOutputError>) -> Void)
    ...
    ///         <code>sessionAttributes</code>. For more information, see <a href="https://docs.aws.amazon.com/lex/latest/dg/context-mgmt.html">Managing
    ///         Conversation Context</a>. </p>
    func postText(input: PostTextInput, completion: @escaping (SdkResult<PostTextOutput, PostTextOutputError>) -> Void)
    ...
    ///         Sessions</a>.</p>
    func putSession(input: PutSessionInput, streamSink: StreamSink, completion: @escaping (SdkResult<PutSessionOutput, PutSessionOutputError>) -> Void)
}
