...
extension LexRuntimeClientTypes.ActiveContext: Swift.Codable, ClientRuntime.Reflection {
...
extension LexRuntimeClientTypes.ActiveContext: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ActiveContext(name: \(Swift.String(describing: name)), parameters: \(Swift.String(describing: parameters)), timeToLive: \(Swift.String(describing: timeToLive)))"}
}
...
extension LexRuntimeClientTypes {
    ...
    public struct ActiveContext: Swift.Equatable {
        ...
        ///       active.
        /// This member is required.
        public let timeToLive: LexRuntimeClientTypes.ActiveContextTimeToLive?
...
extension LexRuntimeClientTypes.ActiveContextTimeToLive: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension LexRuntimeClientTypes.ActiveContextTimeToLive: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension LexRuntimeClientTypes.Button: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case text
        case value
    }
...
extension LexRuntimeClientTypes.Button: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension DeleteSessionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteSessionInput(botAlias: \(Swift.String(describing: botAlias)), botName: \(Swift.String(describing: botName)), userId: \(Swift.String(describing: userId)))"}
}
...
extension DeleteSessionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteSessionOutputResponse(botAlias: \(Swift.String(describing: botAlias)), botName: \(Swift.String(describing: botName)), sessionId: \(Swift.String(describing: sessionId)), userId: \(Swift.String(describing: userId)))"}
}
...
extension LexRuntimeClientTypes.DialogAction: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension LexRuntimeClientTypes.DialogAction: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DialogAction(fulfillmentState: \(Swift.String(describing: fulfillmentState)), intentName: \(Swift.String(describing: intentName)), message: \(Swift.String(describing: message)), messageFormat: \(Swift.String(describing: messageFormat)), slotToElicit: \(Swift.String(describing: slotToElicit)), slots: \(Swift.String(describing: slots)), type: \(Swift.String(describing: type)))"}
}
...
extension LexRuntimeClientTypes {
    ...
    public struct DialogAction: Swift.Equatable {
        ...
        ///
        ///
        public let fulfillmentState: LexRuntimeClientTypes.FulfillmentState?
        ...
        ///             <a href="https://docs.aws.amazon.com/lex/latest/dg/howitworks-manage-prompts.html">Message Groups.
        ///
        ///
        public let messageFormat: LexRuntimeClientTypes.MessageFormatType?
        /// The name of the slot that should be elicited from the user.
        public let slotToElicit: Swift.String?
        /// Map of the slots that have been gathered and their values.
        public let slots: [Swift.String:Swift.String]?
        ...
        ///
        /// This member is required.
        public let type: LexRuntimeClientTypes.DialogActionType?
...
extension LexRuntimeClientTypes.GenericAttachment: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension LexRuntimeClientTypes.GenericAttachment: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GenericAttachment(attachmentLinkUrl: \(Swift.String(describing: attachmentLinkUrl)), buttons: \(Swift.String(describing: buttons)), imageUrl: \(Swift.String(describing: imageUrl)), subTitle: \(Swift.String(describing: subTitle)), title: \(Swift.String(describing: title)))"}
}
...
extension LexRuntimeClientTypes {
    ...
    public struct GenericAttachment: Swift.Equatable {
        ...
        public let attachmentLinkUrl: Swift.String?
        /// The list of options to show to the user.
        public let buttons: [LexRuntimeClientTypes.Button]?
...
extension GetSessionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetSessionInput(botAlias: \(Swift.String(describing: botAlias)), botName: \(Swift.String(describing: botName)), checkpointLabelFilter: \(Swift.String(describing: checkpointLabelFilter)), userId: \(Swift.String(describing: userId)))"}
}
...
public struct GetSessionInput: Swift.Equatable {
    ...
    ///       returned.
    public let checkpointLabelFilter: Swift.String?
...
extension GetSessionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetSessionOutputResponse(activeContexts: \(Swift.String(describing: activeContexts)), dialogAction: \(Swift.String(describing: dialogAction)), recentIntentSummaryView: \(Swift.String(describing: recentIntentSummaryView)), sessionAttributes: \(Swift.String(describing: sessionAttributes)), sessionId: \(Swift.String(describing: sessionId)))"}
}
...
public struct GetSessionOutputResponse: Swift.Equatable {
    ...
    public let activeContexts: [LexRuntimeClientTypes.ActiveContext]?
    /// Describes the current state of the bot.
    public let dialogAction: LexRuntimeClientTypes.DialogAction?
    ...
    ///       label.
    public let recentIntentSummaryView: [LexRuntimeClientTypes.IntentSummary]?
...
extension LexRuntimeClientTypes.IntentConfidence: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case score
    }
...
extension LexRuntimeClientTypes.IntentConfidence: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IntentConfidence(score: \(Swift.String(describing: score)))"}
}
...
extension LexRuntimeClientTypes.IntentSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension LexRuntimeClientTypes.IntentSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IntentSummary(checkpointLabel: \(Swift.String(describing: checkpointLabel)), confirmationStatus: \(Swift.String(describing: confirmationStatus)), dialogActionType: \(Swift.String(describing: dialogActionType)), fulfillmentState: \(Swift.String(describing: fulfillmentState)), intentName: \(Swift.String(describing: intentName)), slotToElicit: \(Swift.String(describing: slotToElicit)), slots: \(Swift.String(describing: slots)))"}
}
...
extension LexRuntimeClientTypes {
    ...
    public struct IntentSummary: Swift.Equatable {
        ...
        public let checkpointLabel: Swift.String?
        ...
        ///
        ///
        public let confirmationStatus: LexRuntimeClientTypes.ConfirmationStatus?
        /// The next action that the bot should take in its interaction with the
        ///       user. The possible values are:
        ///
        ///
        ...
        ///
        /// This member is required.
        public let dialogActionType: LexRuntimeClientTypes.DialogActionType?
        /// The fulfillment state of the intent. The possible values are:
        ///
        ///
        ///
...
extension LoopDetectedException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LoopDetectedException(message: \(Swift.String(describing: message)))"}
}
...
extension NotAcceptableException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "NotAcceptableException(message: \(Swift.String(describing: message)))"}
}
...
public struct PostContentInputBodyMiddleware: ClientRuntime.Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PostContentOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PostContentOutputError>
}

extension PostContentInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PostContentInput(accept: \(Swift.String(describing: accept)), activeContexts: \(Swift.String(describing: activeContexts)), botAlias: \(Swift.String(describing: botAlias)), botName: \(Swift.String(describing: botName)), contentType: \(Swift.String(describing: contentType)), inputStream: \(Swift.String(describing: inputStream)), requestAttributes: \(Swift.String(describing: requestAttributes)), sessionAttributes: \(Swift.String(describing: sessionAttributes)), userId: \(Swift.String(describing: userId)))"}
}

extension PostContentInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case inputStream
    }
...
public struct PostContentInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostContentInputHeadersMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        if let activeContexts = input.operationInput.activeContexts {
            do {
                ...
                input.builder.withHeader(name: "x-amz-lex-active-contexts", value: Swift.String(base64EncodedValue))
            } catch let err {
        ...
        if let requestAttributes = input.operationInput.requestAttributes {
            do {
                ...
                input.builder.withHeader(name: "x-amz-lex-request-attributes", value: Swift.String(base64EncodedValue))
            } catch let err {
                return .failure(.client(ClientRuntime.ClientError.serializationFailed(err.localizedDescription)))
            }
        }
        if let sessionAttributes = input.operationInput.sessionAttributes {
            do {
                ...
                input.builder.withHeader(name: "x-amz-lex-session-attributes", value: Swift.String(base64EncodedValue))
            } catch let err {
                return .failure(.client(ClientRuntime.ClientError.serializationFailed(err.localizedDescription)))
            }
        }
...
public struct PostContentInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostContentInputQueryItemMiddleware"
...
public struct PostContentInput: Swift.Equatable {
    ...
    public let activeContexts: Swift.String?
    ...
    ///         x-amz-lex:.
    ///          For more information, see <a href="https://docs.aws.amazon.com/lex/latest/dg/context-mgmt.html#context-mgmt-request-attribs">Setting Request Attributes.
    ...
    ///       headers is limited to 12 KB.
    ///          For more information, see <a href="https://docs.aws.amazon.com/lex/latest/dg/context-mgmt.html#context-mgmt-session-attribs">Setting Session Attributes.
    public let sessionAttributes: Swift.String?
    /// The ID of the client application user. Amazon Lex uses this to identify a
...
extension PostContentOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PostContentOutputResponse(activeContexts: \(Swift.String(describing: activeContexts)), alternativeIntents: \(Swift.String(describing: alternativeIntents)), audioStream: \(Swift.String(describing: audioStream)), botVersion: \(Swift.String(describing: botVersion)), contentType: \(Swift.String(describing: contentType)), dialogState: \(Swift.String(describing: dialogState)), encodedInputTranscript: \(Swift.String(describing: encodedInputTranscript)), encodedMessage: \(Swift.String(describing: encodedMessage)), inputTranscript: \(Swift.String(describing: inputTranscript)), intentName: \(Swift.String(describing: intentName)), message: \(Swift.String(describing: message)), messageFormat: \(Swift.String(describing: messageFormat)), nluIntentConfidence: \(Swift.String(describing: nluIntentConfidence)), sentimentResponse: \(Swift.String(describing: sentimentResponse)), sessionAttributes: \(Swift.String(describing: sessionAttributes)), sessionId: \(Swift.String(describing: sessionId)), slotToElicit: \(Swift.String(describing: slotToElicit)), slots: \(Swift.String(describing: slots)))"}
}
...
public struct PostContentOutputResponse: Swift.Equatable {
    ...
    public let alternativeIntents: Swift.String?
    ...
    ///
    ///
    public let dialogState: LexRuntimeClientTypes.DialogState?
    ...
    public let encodedInputTranscript: Swift.String?
    ...
    public let nluIntentConfidence: Swift.String?
    ...
    public let sentimentResponse: Swift.String?
    ///  Map of key/value pairs representing the session-specific context
    ///       information.
    public let sessionAttributes: Swift.String?
    /// The unique identifier for the session.
...
public struct PostTextInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostTextInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PostTextInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PostTextOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PostTextInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PostTextOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PostTextOutputError>
}

extension PostTextInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PostTextInput(activeContexts: \(Swift.String(describing: activeContexts)), botAlias: \(Swift.String(describing: botAlias)), botName: \(Swift.String(describing: botName)), inputText: \(Swift.String(describing: inputText)), requestAttributes: \(Swift.String(describing: requestAttributes)), sessionAttributes: \(Swift.String(describing: sessionAttributes)), userId: \(Swift.String(describing: userId)))"}
}

extension PostTextInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case activeContexts
        case inputText
...
public struct PostTextInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostTextInputHeadersMiddleware"
...
public struct PostTextInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostTextInputQueryItemMiddleware"
...
extension PostTextOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PostTextOutputResponse(activeContexts: \(Swift.String(describing: activeContexts)), alternativeIntents: \(Swift.String(describing: alternativeIntents)), botVersion: \(Swift.String(describing: botVersion)), dialogState: \(Swift.String(describing: dialogState)), intentName: \(Swift.String(describing: intentName)), message: \(Swift.String(describing: message)), messageFormat: \(Swift.String(describing: messageFormat)), nluIntentConfidence: \(Swift.String(describing: nluIntentConfidence)), responseCard: \(Swift.String(describing: responseCard)), sentimentResponse: \(Swift.String(describing: sentimentResponse)), sessionAttributes: \(Swift.String(describing: sessionAttributes)), sessionId: \(Swift.String(describing: sessionId)), slotToElicit: \(Swift.String(describing: slotToElicit)), slots: \(Swift.String(describing: slots)))"}
}
...
public struct PostTextOutputResponse: Swift.Equatable {
    ...
    ///       is that the intent matches the user's intent. The intents are sorted by
    ///       the confidence score.
    public let alternativeIntents: [LexRuntimeClientTypes.PredictedIntent]?
    /// The version of the bot that responded to the conversation. You can use
    ///       this information to help determine if one version of a bot is performing
    ///       better than another version.
    public let botVersion: Swift.String?
    ...
    /// Provides a score that indicates how confident Amazon Lex is that the
    ///       returned intent is the one that matches the user's intent. The score is
    ///       between 0.0 and 1.0. For more information, see <a href="https://docs.aws.amazon.com/lex/latest/dg/confidence-scores.html">Confidence Scores.
    ///          The score is a relative score, not an absolute score. The score may
    ///       change based on improvements to Amazon Lex.
    public let nluIntentConfidence: LexRuntimeClientTypes.IntentConfidence?
    ...
    public let responseCard: LexRuntimeClientTypes.ResponseCard?
    /// The sentiment expressed in and utterance.
    ///          When the bot is configured to send utterances to Amazon Comprehend for
    ///       sentiment analysis, this field contains the result of the analysis.
    public let sentimentResponse: LexRuntimeClientTypes.SentimentResponse?
...
extension LexRuntimeClientTypes.PredictedIntent: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case intentName
        case nluIntentConfidence
        case slots
...
extension LexRuntimeClientTypes.PredictedIntent: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PredictedIntent(intentName: \(Swift.String(describing: intentName)), nluIntentConfidence: \(Swift.String(describing: nluIntentConfidence)), slots: \(Swift.String(describing: slots)))"}
}
...
extension PutSessionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutSessionInput(accept: \(Swift.String(describing: accept)), activeContexts: \(Swift.String(describing: activeContexts)), botAlias: \(Swift.String(describing: botAlias)), botName: \(Swift.String(describing: botName)), dialogAction: \(Swift.String(describing: dialogAction)), recentIntentSummaryView: \(Swift.String(describing: recentIntentSummaryView)), sessionAttributes: \(Swift.String(describing: sessionAttributes)), userId: \(Swift.String(describing: userId)))"}
}
...
extension PutSessionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutSessionOutputResponse(activeContexts: \(Swift.String(describing: activeContexts)), audioStream: \(Swift.String(describing: audioStream)), contentType: \(Swift.String(describing: contentType)), dialogState: \(Swift.String(describing: dialogState)), encodedMessage: \(Swift.String(describing: encodedMessage)), intentName: \(Swift.String(describing: intentName)), message: \(Swift.String(describing: message)), messageFormat: \(Swift.String(describing: messageFormat)), sessionAttributes: \(Swift.String(describing: sessionAttributes)), sessionId: \(Swift.String(describing: sessionId)), slotToElicit: \(Swift.String(describing: slotToElicit)), slots: \(Swift.String(describing: slots)))"}
}
...
extension RequestTimeoutException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RequestTimeoutException(message: \(Swift.String(describing: message)))"}
}
...
extension LexRuntimeClientTypes.ResponseCard: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case contentType
...
extension LexRuntimeClientTypes.ResponseCard: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResponseCard(contentType: \(Swift.String(describing: contentType)), genericAttachments: \(Swift.String(describing: genericAttachments)), version: \(Swift.String(describing: version)))"}
}
...
extension LexRuntimeClientTypes {
    ...
    public struct ResponseCard: Swift.Equatable {
        ...
        public let contentType: LexRuntimeClientTypes.ContentType?
        /// An array of attachment objects representing options.
        public let genericAttachments: [LexRuntimeClientTypes.GenericAttachment]?
...
extension LexRuntimeClientTypes.SentimentResponse: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case sentimentLabel
        case sentimentScore
    }
...
extension LexRuntimeClientTypes.SentimentResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SentimentResponse(sentimentLabel: \(Swift.String(describing: sentimentLabel)), sentimentScore: \(Swift.String(describing: sentimentScore)))"}
}
...
extension LexRuntimeClientTypes {
    ...
    public struct SentimentResponse: Swift.Equatable {
        ...
        ///       confidence in.
        public let sentimentLabel: Swift.String?
        /// The likelihood that the sentiment was correctly inferred.
        public let sentimentScore: Swift.String?
...
extension UnsupportedMediaTypeException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UnsupportedMediaTypeException(message: \(Swift.String(describing: message)))"}
}
