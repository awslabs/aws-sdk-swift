...
public protocol LexRuntimeClientProtocol {
    ...
    func postContent(input: PostContentInput, completion: @escaping (SdkResult<PostContentOutputResponse, PostContentOutputError>) -> Void)
    ...
    ///         <code>sessionAttributes</code>. For more information, see <a href="https://docs.aws.amazon.com/lex/latest/dg/context-mgmt.html">Managing
    ///         Conversation Context</a>. </p>
    func postText(input: PostTextInput, completion: @escaping (SdkResult<PostTextOutputResponse, PostTextOutputError>) -> Void)
