...
extension StorageGatewayClient: StorageGatewayClientProtocol {
    ...
    ///          </note>
    public func activateGateway(input: ActivateGatewayInput, completion: @escaping (SdkResult<ActivateGatewayOutput, ActivateGatewayOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<ActivateGatewayInput, ActivateGatewayOutput, ActivateGatewayOutputError>(id: "activateGateway")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ActivateGatewayInput, ActivateGatewayOutput, ActivateGatewayOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ActivateGatewayInput, ActivateGatewayOutput, ActivateGatewayOutputError>(xAmzTarget: "StorageGateway_20130630.ActivateGateway"))
    ...
    public func addCache(input: AddCacheInput, completion: @escaping (SdkResult<AddCacheOutput, AddCacheOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AddCacheInput, AddCacheOutput, AddCacheOutputError>(id: "addCache")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AddCacheInput, AddCacheOutput, AddCacheOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AddCacheInput, AddCacheOutput, AddCacheOutputError>(xAmzTarget: "StorageGateway_20130630.AddCache"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func addTagsToResource(input: AddTagsToResourceInput, completion: @escaping (SdkResult<AddTagsToResourceOutput, AddTagsToResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AddTagsToResourceInput, AddTagsToResourceOutput, AddTagsToResourceOutputError>(xAmzTarget: "StorageGateway_20130630.AddTagsToResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          buffer.</p>
    public func addUploadBuffer(input: AddUploadBufferInput, completion: @escaping (SdkResult<AddUploadBufferOutput, AddUploadBufferOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AddUploadBufferInput, AddUploadBufferOutput, AddUploadBufferOutputError>(id: "addUploadBuffer")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AddUploadBufferInput, AddUploadBufferOutput, AddUploadBufferOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AddUploadBufferInput, AddUploadBufferOutput, AddUploadBufferOutputError>(xAmzTarget: "StorageGateway_20130630.AddUploadBuffer"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          storage.</p>
    public func addWorkingStorage(input: AddWorkingStorageInput, completion: @escaping (SdkResult<AddWorkingStorageOutput, AddWorkingStorageOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AddWorkingStorageInput, AddWorkingStorageOutput, AddWorkingStorageOutputError>(id: "addWorkingStorage")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AddWorkingStorageInput, AddWorkingStorageOutput, AddWorkingStorageOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AddWorkingStorageInput, AddWorkingStorageOutput, AddWorkingStorageOutputError>(xAmzTarget: "StorageGateway_20130630.AddWorkingStorage"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </p>
    public func assignTapePool(input: AssignTapePoolInput, completion: @escaping (SdkResult<AssignTapePoolOutput, AssignTapePoolOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AssignTapePoolInput, AssignTapePoolOutput, AssignTapePoolOutputError>(id: "assignTapePool")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssignTapePoolInput, AssignTapePoolOutput, AssignTapePoolOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AssignTapePoolInput, AssignTapePoolOutput, AssignTapePoolOutputError>(xAmzTarget: "StorageGateway_20130630.AssignTapePool"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          gateway type.</p>
    public func associateFileSystem(input: AssociateFileSystemInput, completion: @escaping (SdkResult<AssociateFileSystemOutput, AssociateFileSystemOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AssociateFileSystemInput, AssociateFileSystemOutput, AssociateFileSystemOutputError>(id: "associateFileSystem")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssociateFileSystemInput, AssociateFileSystemOutput, AssociateFileSystemOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AssociateFileSystemInput, AssociateFileSystemOutput, AssociateFileSystemOutputError>(xAmzTarget: "StorageGateway_20130630.AssociateFileSystem"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func attachVolume(input: AttachVolumeInput, completion: @escaping (SdkResult<AttachVolumeOutput, AttachVolumeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AttachVolumeInput, AttachVolumeOutput, AttachVolumeOutputError>(id: "attachVolume")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AttachVolumeInput, AttachVolumeOutput, AttachVolumeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AttachVolumeInput, AttachVolumeOutput, AttachVolumeOutputError>(xAmzTarget: "StorageGateway_20130630.AttachVolume"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func cancelArchival(input: CancelArchivalInput, completion: @escaping (SdkResult<CancelArchivalOutput, CancelArchivalOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CancelArchivalInput, CancelArchivalOutput, CancelArchivalOutputError>(id: "cancelArchival")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CancelArchivalInput, CancelArchivalOutput, CancelArchivalOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CancelArchivalInput, CancelArchivalOutput, CancelArchivalOutputError>(xAmzTarget: "StorageGateway_20130630.CancelArchival"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func cancelRetrieval(input: CancelRetrievalInput, completion: @escaping (SdkResult<CancelRetrievalOutput, CancelRetrievalOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CancelRetrievalInput, CancelRetrievalOutput, CancelRetrievalOutputError>(id: "cancelRetrieval")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CancelRetrievalInput, CancelRetrievalOutput, CancelRetrievalOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CancelRetrievalInput, CancelRetrievalOutput, CancelRetrievalOutputError>(xAmzTarget: "StorageGateway_20130630.CancelRetrieval"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createCachediSCSIVolume(input: CreateCachediSCSIVolumeInput, completion: @escaping (SdkResult<CreateCachediSCSIVolumeOutput, CreateCachediSCSIVolumeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateCachediSCSIVolumeInput, CreateCachediSCSIVolumeOutput, CreateCachediSCSIVolumeOutputError>(id: "createCachediSCSIVolume")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateCachediSCSIVolumeInput, CreateCachediSCSIVolumeOutput, CreateCachediSCSIVolumeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateCachediSCSIVolumeInput, CreateCachediSCSIVolumeOutput, CreateCachediSCSIVolumeOutputError>(xAmzTarget: "StorageGateway_20130630.CreateCachediSCSIVolume"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </important>
    public func createNFSFileShare(input: CreateNFSFileShareInput, completion: @escaping (SdkResult<CreateNFSFileShareOutput, CreateNFSFileShareOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateNFSFileShareInput, CreateNFSFileShareOutput, CreateNFSFileShareOutputError>(id: "createNFSFileShare")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateNFSFileShareInput, CreateNFSFileShareOutput, CreateNFSFileShareOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateNFSFileShareInput, CreateNFSFileShareOutput, CreateNFSFileShareOutputError>(xAmzTarget: "StorageGateway_20130630.CreateNFSFileShare"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             share.</p>
    ///          </important>
    public func createSMBFileShare(input: CreateSMBFileShareInput, completion: @escaping (SdkResult<CreateSMBFileShareOutput, CreateSMBFileShareOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateSMBFileShareInput, CreateSMBFileShareOutput, CreateSMBFileShareOutputError>(id: "createSMBFileShare")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateSMBFileShareInput, CreateSMBFileShareOutput, CreateSMBFileShareOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateSMBFileShareInput, CreateSMBFileShareOutput, CreateSMBFileShareOutputError>(xAmzTarget: "StorageGateway_20130630.CreateSMBFileShare"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createSnapshot(input: CreateSnapshotInput, completion: @escaping (SdkResult<CreateSnapshotOutput, CreateSnapshotOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateSnapshotInput, CreateSnapshotOutput, CreateSnapshotOutputError>(xAmzTarget: "StorageGateway_20130630.CreateSnapshot"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///                Reference</i>.</p>
    ///          </note>
    public func createSnapshotFromVolumeRecoveryPoint(input: CreateSnapshotFromVolumeRecoveryPointInput, completion: @escaping (SdkResult<CreateSnapshotFromVolumeRecoveryPointOutput, CreateSnapshotFromVolumeRecoveryPointOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateSnapshotFromVolumeRecoveryPointInput, CreateSnapshotFromVolumeRecoveryPointOutput, CreateSnapshotFromVolumeRecoveryPointOutputError>(id: "createSnapshotFromVolumeRecoveryPoint")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateSnapshotFromVolumeRecoveryPointInput, CreateSnapshotFromVolumeRecoveryPointOutput, CreateSnapshotFromVolumeRecoveryPointOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateSnapshotFromVolumeRecoveryPointInput, CreateSnapshotFromVolumeRecoveryPointOutput, CreateSnapshotFromVolumeRecoveryPointOutputError>(xAmzTarget: "StorageGateway_20130630.CreateSnapshotFromVolumeRecoveryPoint"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createStorediSCSIVolume(input: CreateStorediSCSIVolumeInput, completion: @escaping (SdkResult<CreateStorediSCSIVolumeOutput, CreateStorediSCSIVolumeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateStorediSCSIVolumeInput, CreateStorediSCSIVolumeOutput, CreateStorediSCSIVolumeOutputError>(id: "createStorediSCSIVolume")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateStorediSCSIVolumeInput, CreateStorediSCSIVolumeOutput, CreateStorediSCSIVolumeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateStorediSCSIVolumeInput, CreateStorediSCSIVolumeOutput, CreateStorediSCSIVolumeOutputError>(xAmzTarget: "StorageGateway_20130630.CreateStorediSCSIVolume"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createTapePool(input: CreateTapePoolInput, completion: @escaping (SdkResult<CreateTapePoolOutput, CreateTapePoolOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateTapePoolInput, CreateTapePoolOutput, CreateTapePoolOutputError>(id: "createTapePool")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateTapePoolInput, CreateTapePoolOutput, CreateTapePoolOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateTapePoolInput, CreateTapePoolOutput, CreateTapePoolOutputError>(xAmzTarget: "StorageGateway_20130630.CreateTapePool"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             Use the <a>AddCache</a> operation to add cache storage to a gateway.</p>
    ///          </note>
    public func createTapeWithBarcode(input: CreateTapeWithBarcodeInput, completion: @escaping (SdkResult<CreateTapeWithBarcodeOutput, CreateTapeWithBarcodeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateTapeWithBarcodeInput, CreateTapeWithBarcodeOutput, CreateTapeWithBarcodeOutputError>(id: "createTapeWithBarcode")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateTapeWithBarcodeInput, CreateTapeWithBarcodeOutput, CreateTapeWithBarcodeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateTapeWithBarcodeInput, CreateTapeWithBarcodeOutput, CreateTapeWithBarcodeOutputError>(xAmzTarget: "StorageGateway_20130630.CreateTapeWithBarcode"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             Use the <a>AddCache</a> operation to add cache storage to a gateway.</p>
    ///          </note>
    public func createTapes(input: CreateTapesInput, completion: @escaping (SdkResult<CreateTapesOutput, CreateTapesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateTapesInput, CreateTapesOutput, CreateTapesOutputError>(id: "createTapes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateTapesInput, CreateTapesOutput, CreateTapesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateTapesInput, CreateTapesOutput, CreateTapesOutputError>(xAmzTarget: "StorageGateway_20130630.CreateTapes"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteAutomaticTapeCreationPolicy(input: DeleteAutomaticTapeCreationPolicyInput, completion: @escaping (SdkResult<DeleteAutomaticTapeCreationPolicyOutput, DeleteAutomaticTapeCreationPolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteAutomaticTapeCreationPolicyInput, DeleteAutomaticTapeCreationPolicyOutput, DeleteAutomaticTapeCreationPolicyOutputError>(id: "deleteAutomaticTapeCreationPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteAutomaticTapeCreationPolicyInput, DeleteAutomaticTapeCreationPolicyOutput, DeleteAutomaticTapeCreationPolicyOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteAutomaticTapeCreationPolicyInput, DeleteAutomaticTapeCreationPolicyOutput, DeleteAutomaticTapeCreationPolicyOutputError>(xAmzTarget: "StorageGateway_20130630.DeleteAutomaticTapeCreationPolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteBandwidthRateLimit(input: DeleteBandwidthRateLimitInput, completion: @escaping (SdkResult<DeleteBandwidthRateLimitOutput, DeleteBandwidthRateLimitOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBandwidthRateLimitInput, DeleteBandwidthRateLimitOutput, DeleteBandwidthRateLimitOutputError>(id: "deleteBandwidthRateLimit")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBandwidthRateLimitInput, DeleteBandwidthRateLimitOutput, DeleteBandwidthRateLimitOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteBandwidthRateLimitInput, DeleteBandwidthRateLimitOutput, DeleteBandwidthRateLimitOutputError>(xAmzTarget: "StorageGateway_20130630.DeleteBandwidthRateLimit"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          types.</p>
    public func deleteChapCredentials(input: DeleteChapCredentialsInput, completion: @escaping (SdkResult<DeleteChapCredentialsOutput, DeleteChapCredentialsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteChapCredentialsInput, DeleteChapCredentialsOutput, DeleteChapCredentialsOutputError>(id: "deleteChapCredentials")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteChapCredentialsInput, DeleteChapCredentialsOutput, DeleteChapCredentialsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteChapCredentialsInput, DeleteChapCredentialsOutput, DeleteChapCredentialsOutputError>(xAmzTarget: "StorageGateway_20130630.DeleteChapCredentials"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          gateways.</p>
    public func deleteFileShare(input: DeleteFileShareInput, completion: @escaping (SdkResult<DeleteFileShareOutput, DeleteFileShareOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteFileShareInput, DeleteFileShareOutput, DeleteFileShareOutputError>(id: "deleteFileShare")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteFileShareInput, DeleteFileShareOutput, DeleteFileShareOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteFileShareInput, DeleteFileShareOutput, DeleteFileShareOutputError>(xAmzTarget: "StorageGateway_20130630.DeleteFileShare"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteGateway(input: DeleteGatewayInput, completion: @escaping (SdkResult<DeleteGatewayOutput, DeleteGatewayOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteGatewayInput, DeleteGatewayOutput, DeleteGatewayOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteGatewayInput, DeleteGatewayOutput, DeleteGatewayOutputError>(xAmzTarget: "StorageGateway_20130630.DeleteGateway"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteSnapshotSchedule(input: DeleteSnapshotScheduleInput, completion: @escaping (SdkResult<DeleteSnapshotScheduleOutput, DeleteSnapshotScheduleOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteSnapshotScheduleInput, DeleteSnapshotScheduleOutput, DeleteSnapshotScheduleOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteSnapshotScheduleInput, DeleteSnapshotScheduleOutput, DeleteSnapshotScheduleOutputError>(xAmzTarget: "StorageGateway_20130630.DeleteSnapshotSchedule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          type.</p>
    public func deleteTape(input: DeleteTapeInput, completion: @escaping (SdkResult<DeleteTapeOutput, DeleteTapeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteTapeInput, DeleteTapeOutput, DeleteTapeOutputError>(id: "deleteTape")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteTapeInput, DeleteTapeOutput, DeleteTapeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteTapeInput, DeleteTapeOutput, DeleteTapeOutputError>(xAmzTarget: "StorageGateway_20130630.DeleteTape"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteTapeArchive(input: DeleteTapeArchiveInput, completion: @escaping (SdkResult<DeleteTapeArchiveOutput, DeleteTapeArchiveOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteTapeArchiveInput, DeleteTapeArchiveOutput, DeleteTapeArchiveOutputError>(id: "deleteTapeArchive")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteTapeArchiveInput, DeleteTapeArchiveOutput, DeleteTapeArchiveOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteTapeArchiveInput, DeleteTapeArchiveOutput, DeleteTapeArchiveOutputError>(xAmzTarget: "StorageGateway_20130630.DeleteTapeArchive"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          tape pool.</p>
    public func deleteTapePool(input: DeleteTapePoolInput, completion: @escaping (SdkResult<DeleteTapePoolOutput, DeleteTapePoolOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteTapePoolInput, DeleteTapePoolOutput, DeleteTapePoolOutputError>(id: "deleteTapePool")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteTapePoolInput, DeleteTapePoolOutput, DeleteTapePoolOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteTapePoolInput, DeleteTapePoolOutput, DeleteTapePoolOutputError>(xAmzTarget: "StorageGateway_20130630.DeleteTapePool"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteVolume(input: DeleteVolumeInput, completion: @escaping (SdkResult<DeleteVolumeOutput, DeleteVolumeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteVolumeInput, DeleteVolumeOutput, DeleteVolumeOutputError>(id: "deleteVolume")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteVolumeInput, DeleteVolumeOutput, DeleteVolumeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteVolumeInput, DeleteVolumeOutput, DeleteVolumeOutputError>(xAmzTarget: "StorageGateway_20130630.DeleteVolume"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeAvailabilityMonitorTest(input: DescribeAvailabilityMonitorTestInput, completion: @escaping (SdkResult<DescribeAvailabilityMonitorTestOutput, DescribeAvailabilityMonitorTestOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAvailabilityMonitorTestInput, DescribeAvailabilityMonitorTestOutput, DescribeAvailabilityMonitorTestOutputError>(id: "describeAvailabilityMonitorTest")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAvailabilityMonitorTestInput, DescribeAvailabilityMonitorTestOutput, DescribeAvailabilityMonitorTestOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeAvailabilityMonitorTestInput, DescribeAvailabilityMonitorTestOutput, DescribeAvailabilityMonitorTestOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeAvailabilityMonitorTest"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeBandwidthRateLimit(input: DescribeBandwidthRateLimitInput, completion: @escaping (SdkResult<DescribeBandwidthRateLimitOutput, DescribeBandwidthRateLimitOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeBandwidthRateLimitInput, DescribeBandwidthRateLimitOutput, DescribeBandwidthRateLimitOutputError>(id: "describeBandwidthRateLimit")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeBandwidthRateLimitInput, DescribeBandwidthRateLimitOutput, DescribeBandwidthRateLimitOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeBandwidthRateLimitInput, DescribeBandwidthRateLimitOutput, DescribeBandwidthRateLimitOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeBandwidthRateLimit"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          of the gateway in your request.</p>
    public func describeBandwidthRateLimitSchedule(input: DescribeBandwidthRateLimitScheduleInput, completion: @escaping (SdkResult<DescribeBandwidthRateLimitScheduleOutput, DescribeBandwidthRateLimitScheduleOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeBandwidthRateLimitScheduleInput, DescribeBandwidthRateLimitScheduleOutput, DescribeBandwidthRateLimitScheduleOutputError>(id: "describeBandwidthRateLimitSchedule")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeBandwidthRateLimitScheduleInput, DescribeBandwidthRateLimitScheduleOutput, DescribeBandwidthRateLimitScheduleOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeBandwidthRateLimitScheduleInput, DescribeBandwidthRateLimitScheduleOutput, DescribeBandwidthRateLimitScheduleOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeBandwidthRateLimitSchedule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeCache(input: DescribeCacheInput, completion: @escaping (SdkResult<DescribeCacheOutput, DescribeCacheOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCacheInput, DescribeCacheOutput, DescribeCacheOutputError>(id: "describeCache")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCacheInput, DescribeCacheOutput, DescribeCacheOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeCacheInput, DescribeCacheOutput, DescribeCacheOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeCache"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          (ARN).</p>
    public func describeCachediSCSIVolumes(input: DescribeCachediSCSIVolumesInput, completion: @escaping (SdkResult<DescribeCachediSCSIVolumesOutput, DescribeCachediSCSIVolumesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCachediSCSIVolumesInput, DescribeCachediSCSIVolumesOutput, DescribeCachediSCSIVolumesOutputError>(id: "describeCachediSCSIVolumes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCachediSCSIVolumesInput, DescribeCachediSCSIVolumesOutput, DescribeCachediSCSIVolumesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeCachediSCSIVolumesInput, DescribeCachediSCSIVolumesOutput, DescribeCachediSCSIVolumesOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeCachediSCSIVolumes"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeChapCredentials(input: DescribeChapCredentialsInput, completion: @escaping (SdkResult<DescribeChapCredentialsOutput, DescribeChapCredentialsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeChapCredentialsInput, DescribeChapCredentialsOutput, DescribeChapCredentialsOutputError>(id: "describeChapCredentials")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeChapCredentialsInput, DescribeChapCredentialsOutput, DescribeChapCredentialsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeChapCredentialsInput, DescribeChapCredentialsOutput, DescribeChapCredentialsOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeChapCredentials"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeFileSystemAssociations(input: DescribeFileSystemAssociationsInput, completion: @escaping (SdkResult<DescribeFileSystemAssociationsOutput, DescribeFileSystemAssociationsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeFileSystemAssociationsInput, DescribeFileSystemAssociationsOutput, DescribeFileSystemAssociationsOutputError>(id: "describeFileSystemAssociations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeFileSystemAssociationsInput, DescribeFileSystemAssociationsOutput, DescribeFileSystemAssociationsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeFileSystemAssociationsInput, DescribeFileSystemAssociationsOutput, DescribeFileSystemAssociationsOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeFileSystemAssociations"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeGatewayInformation(input: DescribeGatewayInformationInput, completion: @escaping (SdkResult<DescribeGatewayInformationOutput, DescribeGatewayInformationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeGatewayInformationInput, DescribeGatewayInformationOutput, DescribeGatewayInformationOutputError>(id: "describeGatewayInformation")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeGatewayInformationInput, DescribeGatewayInformationOutput, DescribeGatewayInformationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeGatewayInformationInput, DescribeGatewayInformationOutput, DescribeGatewayInformationOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeGatewayInformation"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeMaintenanceStartTime(input: DescribeMaintenanceStartTimeInput, completion: @escaping (SdkResult<DescribeMaintenanceStartTimeOutput, DescribeMaintenanceStartTimeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeMaintenanceStartTimeInput, DescribeMaintenanceStartTimeOutput, DescribeMaintenanceStartTimeOutputError>(id: "describeMaintenanceStartTime")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeMaintenanceStartTimeInput, DescribeMaintenanceStartTimeOutput, DescribeMaintenanceStartTimeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeMaintenanceStartTimeInput, DescribeMaintenanceStartTimeOutput, DescribeMaintenanceStartTimeOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeMaintenanceStartTime"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeNFSFileShares(input: DescribeNFSFileSharesInput, completion: @escaping (SdkResult<DescribeNFSFileSharesOutput, DescribeNFSFileSharesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeNFSFileSharesInput, DescribeNFSFileSharesOutput, DescribeNFSFileSharesOutputError>(id: "describeNFSFileShares")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeNFSFileSharesInput, DescribeNFSFileSharesOutput, DescribeNFSFileSharesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeNFSFileSharesInput, DescribeNFSFileSharesOutput, DescribeNFSFileSharesOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeNFSFileShares"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          gateway. This operation is only supported for file gateways.</p>
    public func describeSMBFileShares(input: DescribeSMBFileSharesInput, completion: @escaping (SdkResult<DescribeSMBFileSharesOutput, DescribeSMBFileSharesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeSMBFileSharesInput, DescribeSMBFileSharesOutput, DescribeSMBFileSharesOutputError>(id: "describeSMBFileShares")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeSMBFileSharesInput, DescribeSMBFileSharesOutput, DescribeSMBFileSharesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeSMBFileSharesInput, DescribeSMBFileSharesOutput, DescribeSMBFileSharesOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeSMBFileShares"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          gateway. This operation is only supported for file gateways.</p>
    public func describeSMBSettings(input: DescribeSMBSettingsInput, completion: @escaping (SdkResult<DescribeSMBSettingsOutput, DescribeSMBSettingsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeSMBSettingsInput, DescribeSMBSettingsOutput, DescribeSMBSettingsOutputError>(id: "describeSMBSettings")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeSMBSettingsInput, DescribeSMBSettingsOutput, DescribeSMBSettingsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeSMBSettingsInput, DescribeSMBSettingsOutput, DescribeSMBSettingsOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeSMBSettings"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          types.</p>
    public func describeSnapshotSchedule(input: DescribeSnapshotScheduleInput, completion: @escaping (SdkResult<DescribeSnapshotScheduleOutput, DescribeSnapshotScheduleOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeSnapshotScheduleInput, DescribeSnapshotScheduleOutput, DescribeSnapshotScheduleOutputError>(id: "describeSnapshotSchedule")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeSnapshotScheduleInput, DescribeSnapshotScheduleOutput, DescribeSnapshotScheduleOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeSnapshotScheduleInput, DescribeSnapshotScheduleOutput, DescribeSnapshotScheduleOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeSnapshotSchedule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeStorediSCSIVolumes(input: DescribeStorediSCSIVolumesInput, completion: @escaping (SdkResult<DescribeStorediSCSIVolumesOutput, DescribeStorediSCSIVolumesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeStorediSCSIVolumesInput, DescribeStorediSCSIVolumesOutput, DescribeStorediSCSIVolumesOutputError>(id: "describeStorediSCSIVolumes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStorediSCSIVolumesInput, DescribeStorediSCSIVolumesOutput, DescribeStorediSCSIVolumesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeStorediSCSIVolumesInput, DescribeStorediSCSIVolumesOutput, DescribeStorediSCSIVolumesOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeStorediSCSIVolumes"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeTapeArchives(input: DescribeTapeArchivesInput, completion: @escaping (SdkResult<DescribeTapeArchivesOutput, DescribeTapeArchivesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTapeArchivesInput, DescribeTapeArchivesOutput, DescribeTapeArchivesOutputError>(id: "describeTapeArchives")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTapeArchivesInput, DescribeTapeArchivesOutput, DescribeTapeArchivesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeTapeArchivesInput, DescribeTapeArchivesOutput, DescribeTapeArchivesOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeTapeArchives"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          gateway type.</p>
    public func describeTapeRecoveryPoints(input: DescribeTapeRecoveryPointsInput, completion: @escaping (SdkResult<DescribeTapeRecoveryPointsOutput, DescribeTapeRecoveryPointsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTapeRecoveryPointsInput, DescribeTapeRecoveryPointsOutput, DescribeTapeRecoveryPointsOutputError>(id: "describeTapeRecoveryPoints")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTapeRecoveryPointsInput, DescribeTapeRecoveryPointsOutput, DescribeTapeRecoveryPointsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeTapeRecoveryPointsInput, DescribeTapeRecoveryPointsOutput, DescribeTapeRecoveryPointsOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeTapeRecoveryPoints"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          type.</p>
    public func describeTapes(input: DescribeTapesInput, completion: @escaping (SdkResult<DescribeTapesOutput, DescribeTapesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTapesInput, DescribeTapesOutput, DescribeTapesOutputError>(id: "describeTapes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTapesInput, DescribeTapesOutput, DescribeTapesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeTapesInput, DescribeTapesOutput, DescribeTapesOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeTapes"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeUploadBuffer(input: DescribeUploadBufferInput, completion: @escaping (SdkResult<DescribeUploadBufferOutput, DescribeUploadBufferOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeUploadBufferInput, DescribeUploadBufferOutput, DescribeUploadBufferOutputError>(id: "describeUploadBuffer")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeUploadBufferInput, DescribeUploadBufferOutput, DescribeUploadBufferOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeUploadBufferInput, DescribeUploadBufferOutput, DescribeUploadBufferOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeUploadBuffer"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeVTLDevices(input: DescribeVTLDevicesInput, completion: @escaping (SdkResult<DescribeVTLDevicesOutput, DescribeVTLDevicesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeVTLDevicesInput, DescribeVTLDevicesOutput, DescribeVTLDevicesOutputError>(id: "describeVTLDevices")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeVTLDevicesInput, DescribeVTLDevicesOutput, DescribeVTLDevicesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeVTLDevicesInput, DescribeVTLDevicesOutput, DescribeVTLDevicesOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeVTLDevices"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeWorkingStorage(input: DescribeWorkingStorageInput, completion: @escaping (SdkResult<DescribeWorkingStorageOutput, DescribeWorkingStorageOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeWorkingStorageInput, DescribeWorkingStorageOutput, DescribeWorkingStorageOutputError>(id: "describeWorkingStorage")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeWorkingStorageInput, DescribeWorkingStorageOutput, DescribeWorkingStorageOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeWorkingStorageInput, DescribeWorkingStorageOutput, DescribeWorkingStorageOutputError>(xAmzTarget: "StorageGateway_20130630.DescribeWorkingStorage"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func detachVolume(input: DetachVolumeInput, completion: @escaping (SdkResult<DetachVolumeOutput, DetachVolumeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DetachVolumeInput, DetachVolumeOutput, DetachVolumeOutputError>(id: "detachVolume")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetachVolumeInput, DetachVolumeOutput, DetachVolumeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DetachVolumeInput, DetachVolumeOutput, DetachVolumeOutputError>(xAmzTarget: "StorageGateway_20130630.DetachVolume"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </important>
    public func disableGateway(input: DisableGatewayInput, completion: @escaping (SdkResult<DisableGatewayOutput, DisableGatewayOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DisableGatewayInput, DisableGatewayOutput, DisableGatewayOutputError>(id: "disableGateway")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DisableGatewayInput, DisableGatewayOutput, DisableGatewayOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DisableGatewayInput, DisableGatewayOutput, DisableGatewayOutputError>(xAmzTarget: "StorageGateway_20130630.DisableGateway"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func disassociateFileSystem(input: DisassociateFileSystemInput, completion: @escaping (SdkResult<DisassociateFileSystemOutput, DisassociateFileSystemOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DisassociateFileSystemInput, DisassociateFileSystemOutput, DisassociateFileSystemOutputError>(id: "disassociateFileSystem")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DisassociateFileSystemInput, DisassociateFileSystemOutput, DisassociateFileSystemOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DisassociateFileSystemInput, DisassociateFileSystemOutput, DisassociateFileSystemOutputError>(xAmzTarget: "StorageGateway_20130630.DisassociateFileSystem"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func joinDomain(input: JoinDomainInput, completion: @escaping (SdkResult<JoinDomainOutput, JoinDomainOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<JoinDomainInput, JoinDomainOutput, JoinDomainOutputError>(id: "joinDomain")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<JoinDomainInput, JoinDomainOutput, JoinDomainOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<JoinDomainInput, JoinDomainOutput, JoinDomainOutputError>(xAmzTarget: "StorageGateway_20130630.JoinDomain"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listAutomaticTapeCreationPolicies(input: ListAutomaticTapeCreationPoliciesInput, completion: @escaping (SdkResult<ListAutomaticTapeCreationPoliciesOutput, ListAutomaticTapeCreationPoliciesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAutomaticTapeCreationPoliciesInput, ListAutomaticTapeCreationPoliciesOutput, ListAutomaticTapeCreationPoliciesOutputError>(id: "listAutomaticTapeCreationPolicies")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAutomaticTapeCreationPoliciesInput, ListAutomaticTapeCreationPoliciesOutput, ListAutomaticTapeCreationPoliciesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListAutomaticTapeCreationPoliciesInput, ListAutomaticTapeCreationPoliciesOutput, ListAutomaticTapeCreationPoliciesOutputError>(xAmzTarget: "StorageGateway_20130630.ListAutomaticTapeCreationPolicies"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          gateways.</p>
    public func listFileShares(input: ListFileSharesInput, completion: @escaping (SdkResult<ListFileSharesOutput, ListFileSharesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListFileSharesInput, ListFileSharesOutput, ListFileSharesOutputError>(id: "listFileShares")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListFileSharesInput, ListFileSharesOutput, ListFileSharesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListFileSharesInput, ListFileSharesOutput, ListFileSharesOutputError>(xAmzTarget: "StorageGateway_20130630.ListFileShares"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          gateways.</p>
    public func listFileSystemAssociations(input: ListFileSystemAssociationsInput, completion: @escaping (SdkResult<ListFileSystemAssociationsOutput, ListFileSystemAssociationsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListFileSystemAssociationsInput, ListFileSystemAssociationsOutput, ListFileSystemAssociationsOutputError>(id: "listFileSystemAssociations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListFileSystemAssociationsInput, ListFileSystemAssociationsOutput, ListFileSystemAssociationsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListFileSystemAssociationsInput, ListFileSystemAssociationsOutput, ListFileSystemAssociationsOutputError>(xAmzTarget: "StorageGateway_20130630.ListFileSystemAssociations"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listGateways(input: ListGatewaysInput, completion: @escaping (SdkResult<ListGatewaysOutput, ListGatewaysOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListGatewaysInput, ListGatewaysOutput, ListGatewaysOutputError>(xAmzTarget: "StorageGateway_20130630.ListGateways"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          corrupted).</p>
    public func listLocalDisks(input: ListLocalDisksInput, completion: @escaping (SdkResult<ListLocalDisksOutput, ListLocalDisksOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListLocalDisksInput, ListLocalDisksOutput, ListLocalDisksOutputError>(id: "listLocalDisks")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListLocalDisksInput, ListLocalDisksOutput, ListLocalDisksOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListLocalDisksInput, ListLocalDisksOutput, ListLocalDisksOutputError>(xAmzTarget: "StorageGateway_20130630.ListLocalDisks"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTagsForResource(input: ListTagsForResourceInput, completion: @escaping (SdkResult<ListTagsForResourceOutput, ListTagsForResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput, ListTagsForResourceOutputError>(xAmzTarget: "StorageGateway_20130630.ListTagsForResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTapePools(input: ListTapePoolsInput, completion: @escaping (SdkResult<ListTapePoolsOutput, ListTapePoolsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListTapePoolsInput, ListTapePoolsOutput, ListTapePoolsOutputError>(id: "listTapePools")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListTapePoolsInput, ListTapePoolsOutput, ListTapePoolsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTapePoolsInput, ListTapePoolsOutput, ListTapePoolsOutputError>(xAmzTarget: "StorageGateway_20130630.ListTapePools"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTapes(input: ListTapesInput, completion: @escaping (SdkResult<ListTapesOutput, ListTapesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListTapesInput, ListTapesOutput, ListTapesOutputError>(id: "listTapes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListTapesInput, ListTapesOutput, ListTapesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTapesInput, ListTapesOutput, ListTapesOutputError>(xAmzTarget: "StorageGateway_20130630.ListTapes"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listVolumeInitiators(input: ListVolumeInitiatorsInput, completion: @escaping (SdkResult<ListVolumeInitiatorsOutput, ListVolumeInitiatorsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListVolumeInitiatorsInput, ListVolumeInitiatorsOutput, ListVolumeInitiatorsOutputError>(id: "listVolumeInitiators")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListVolumeInitiatorsInput, ListVolumeInitiatorsOutput, ListVolumeInitiatorsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListVolumeInitiatorsInput, ListVolumeInitiatorsOutput, ListVolumeInitiatorsOutputError>(xAmzTarget: "StorageGateway_20130630.ListVolumeInitiators"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listVolumeRecoveryPoints(input: ListVolumeRecoveryPointsInput, completion: @escaping (SdkResult<ListVolumeRecoveryPointsOutput, ListVolumeRecoveryPointsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListVolumeRecoveryPointsInput, ListVolumeRecoveryPointsOutput, ListVolumeRecoveryPointsOutputError>(id: "listVolumeRecoveryPoints")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListVolumeRecoveryPointsInput, ListVolumeRecoveryPointsOutput, ListVolumeRecoveryPointsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListVolumeRecoveryPointsInput, ListVolumeRecoveryPointsOutput, ListVolumeRecoveryPointsOutputError>(xAmzTarget: "StorageGateway_20130630.ListVolumeRecoveryPoints"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listVolumes(input: ListVolumesInput, completion: @escaping (SdkResult<ListVolumesOutput, ListVolumesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListVolumesInput, ListVolumesOutput, ListVolumesOutputError>(id: "listVolumes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListVolumesInput, ListVolumesOutput, ListVolumesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListVolumesInput, ListVolumesOutput, ListVolumesOutputError>(xAmzTarget: "StorageGateway_20130630.ListVolumes"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             Guide</i>.</p>
    public func notifyWhenUploaded(input: NotifyWhenUploadedInput, completion: @escaping (SdkResult<NotifyWhenUploadedOutput, NotifyWhenUploadedOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<NotifyWhenUploadedInput, NotifyWhenUploadedOutput, NotifyWhenUploadedOutputError>(id: "notifyWhenUploaded")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<NotifyWhenUploadedInput, NotifyWhenUploadedOutput, NotifyWhenUploadedOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<NotifyWhenUploadedInput, NotifyWhenUploadedOutput, NotifyWhenUploadedOutputError>(xAmzTarget: "StorageGateway_20130630.NotifyWhenUploaded"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             User Guide</i>.</p>
    public func refreshCache(input: RefreshCacheInput, completion: @escaping (SdkResult<RefreshCacheOutput, RefreshCacheOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RefreshCacheInput, RefreshCacheOutput, RefreshCacheOutputError>(id: "refreshCache")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RefreshCacheInput, RefreshCacheOutput, RefreshCacheOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RefreshCacheInput, RefreshCacheOutput, RefreshCacheOutputError>(xAmzTarget: "StorageGateway_20130630.RefreshCache"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func removeTagsFromResource(input: RemoveTagsFromResourceInput, completion: @escaping (SdkResult<RemoveTagsFromResourceOutput, RemoveTagsFromResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RemoveTagsFromResourceInput, RemoveTagsFromResourceOutput, RemoveTagsFromResourceOutputError>(xAmzTarget: "StorageGateway_20130630.RemoveTagsFromResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </important>
    public func resetCache(input: ResetCacheInput, completion: @escaping (SdkResult<ResetCacheOutput, ResetCacheOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ResetCacheInput, ResetCacheOutput, ResetCacheOutputError>(id: "resetCache")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ResetCacheInput, ResetCacheOutput, ResetCacheOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ResetCacheInput, ResetCacheOutput, ResetCacheOutputError>(xAmzTarget: "StorageGateway_20130630.ResetCache"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func retrieveTapeArchive(input: RetrieveTapeArchiveInput, completion: @escaping (SdkResult<RetrieveTapeArchiveOutput, RetrieveTapeArchiveOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RetrieveTapeArchiveInput, RetrieveTapeArchiveOutput, RetrieveTapeArchiveOutputError>(id: "retrieveTapeArchive")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RetrieveTapeArchiveInput, RetrieveTapeArchiveOutput, RetrieveTapeArchiveOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RetrieveTapeArchiveInput, RetrieveTapeArchiveOutput, RetrieveTapeArchiveOutputError>(xAmzTarget: "StorageGateway_20130630.RetrieveTapeArchive"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </note>
    public func retrieveTapeRecoveryPoint(input: RetrieveTapeRecoveryPointInput, completion: @escaping (SdkResult<RetrieveTapeRecoveryPointOutput, RetrieveTapeRecoveryPointOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RetrieveTapeRecoveryPointInput, RetrieveTapeRecoveryPointOutput, RetrieveTapeRecoveryPointOutputError>(id: "retrieveTapeRecoveryPoint")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RetrieveTapeRecoveryPointInput, RetrieveTapeRecoveryPointOutput, RetrieveTapeRecoveryPointOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RetrieveTapeRecoveryPointInput, RetrieveTapeRecoveryPointOutput, RetrieveTapeRecoveryPointOutputError>(xAmzTarget: "StorageGateway_20130630.RetrieveTapeRecoveryPoint"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          password.</p>
    public func setLocalConsolePassword(input: SetLocalConsolePasswordInput, completion: @escaping (SdkResult<SetLocalConsolePasswordOutput, SetLocalConsolePasswordOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SetLocalConsolePasswordInput, SetLocalConsolePasswordOutput, SetLocalConsolePasswordOutputError>(id: "setLocalConsolePassword")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SetLocalConsolePasswordInput, SetLocalConsolePasswordOutput, SetLocalConsolePasswordOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<SetLocalConsolePasswordInput, SetLocalConsolePasswordOutput, SetLocalConsolePasswordOutputError>(xAmzTarget: "StorageGateway_20130630.SetLocalConsolePassword"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func setSMBGuestPassword(input: SetSMBGuestPasswordInput, completion: @escaping (SdkResult<SetSMBGuestPasswordOutput, SetSMBGuestPasswordOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SetSMBGuestPasswordInput, SetSMBGuestPasswordOutput, SetSMBGuestPasswordOutputError>(id: "setSMBGuestPassword")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SetSMBGuestPasswordInput, SetSMBGuestPasswordOutput, SetSMBGuestPasswordOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<SetSMBGuestPasswordInput, SetSMBGuestPasswordOutput, SetSMBGuestPasswordOutputError>(xAmzTarget: "StorageGateway_20130630.SetSMBGuestPassword"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          gateway.</p>
    public func shutdownGateway(input: ShutdownGatewayInput, completion: @escaping (SdkResult<ShutdownGatewayOutput, ShutdownGatewayOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ShutdownGatewayInput, ShutdownGatewayOutput, ShutdownGatewayOutputError>(id: "shutdownGateway")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ShutdownGatewayInput, ShutdownGatewayOutput, ShutdownGatewayOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ShutdownGatewayInput, ShutdownGatewayOutput, ShutdownGatewayOutputError>(xAmzTarget: "StorageGateway_20130630.ShutdownGateway"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </note>
    public func startAvailabilityMonitorTest(input: StartAvailabilityMonitorTestInput, completion: @escaping (SdkResult<StartAvailabilityMonitorTestOutput, StartAvailabilityMonitorTestOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartAvailabilityMonitorTestInput, StartAvailabilityMonitorTestOutput, StartAvailabilityMonitorTestOutputError>(id: "startAvailabilityMonitorTest")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartAvailabilityMonitorTestInput, StartAvailabilityMonitorTestOutput, StartAvailabilityMonitorTestOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartAvailabilityMonitorTestInput, StartAvailabilityMonitorTestOutput, StartAvailabilityMonitorTestOutputError>(xAmzTarget: "StorageGateway_20130630.StartAvailabilityMonitorTest"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          your request.</p>
    public func startGateway(input: StartGatewayInput, completion: @escaping (SdkResult<StartGatewayOutput, StartGatewayOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartGatewayInput, StartGatewayOutput, StartGatewayOutputError>(id: "startGateway")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartGatewayInput, StartGatewayOutput, StartGatewayOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartGatewayInput, StartGatewayOutput, StartGatewayOutputError>(xAmzTarget: "StorageGateway_20130630.StartGateway"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </note>
    public func updateAutomaticTapeCreationPolicy(input: UpdateAutomaticTapeCreationPolicyInput, completion: @escaping (SdkResult<UpdateAutomaticTapeCreationPolicyOutput, UpdateAutomaticTapeCreationPolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateAutomaticTapeCreationPolicyInput, UpdateAutomaticTapeCreationPolicyOutput, UpdateAutomaticTapeCreationPolicyOutputError>(id: "updateAutomaticTapeCreationPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateAutomaticTapeCreationPolicyInput, UpdateAutomaticTapeCreationPolicyOutput, UpdateAutomaticTapeCreationPolicyOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateAutomaticTapeCreationPolicyInput, UpdateAutomaticTapeCreationPolicyOutput, UpdateAutomaticTapeCreationPolicyOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateAutomaticTapeCreationPolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          your request.</p>
    public func updateBandwidthRateLimit(input: UpdateBandwidthRateLimitInput, completion: @escaping (SdkResult<UpdateBandwidthRateLimitOutput, UpdateBandwidthRateLimitOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateBandwidthRateLimitInput, UpdateBandwidthRateLimitOutput, UpdateBandwidthRateLimitOutputError>(id: "updateBandwidthRateLimit")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateBandwidthRateLimitInput, UpdateBandwidthRateLimitOutput, UpdateBandwidthRateLimitOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateBandwidthRateLimitInput, UpdateBandwidthRateLimitOutput, UpdateBandwidthRateLimitOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateBandwidthRateLimit"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///       </p>
    public func updateBandwidthRateLimitSchedule(input: UpdateBandwidthRateLimitScheduleInput, completion: @escaping (SdkResult<UpdateBandwidthRateLimitScheduleOutput, UpdateBandwidthRateLimitScheduleOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateBandwidthRateLimitScheduleInput, UpdateBandwidthRateLimitScheduleOutput, UpdateBandwidthRateLimitScheduleOutputError>(id: "updateBandwidthRateLimitSchedule")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateBandwidthRateLimitScheduleInput, UpdateBandwidthRateLimitScheduleOutput, UpdateBandwidthRateLimitScheduleOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateBandwidthRateLimitScheduleInput, UpdateBandwidthRateLimitScheduleOutput, UpdateBandwidthRateLimitScheduleOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateBandwidthRateLimitSchedule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </important>
    public func updateChapCredentials(input: UpdateChapCredentialsInput, completion: @escaping (SdkResult<UpdateChapCredentialsOutput, UpdateChapCredentialsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateChapCredentialsInput, UpdateChapCredentialsOutput, UpdateChapCredentialsOutputError>(id: "updateChapCredentials")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateChapCredentialsInput, UpdateChapCredentialsOutput, UpdateChapCredentialsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateChapCredentialsInput, UpdateChapCredentialsOutput, UpdateChapCredentialsOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateChapCredentials"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          file gateway type.</p>
    public func updateFileSystemAssociation(input: UpdateFileSystemAssociationInput, completion: @escaping (SdkResult<UpdateFileSystemAssociationOutput, UpdateFileSystemAssociationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateFileSystemAssociationInput, UpdateFileSystemAssociationOutput, UpdateFileSystemAssociationOutputError>(id: "updateFileSystemAssociation")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateFileSystemAssociationInput, UpdateFileSystemAssociationOutput, UpdateFileSystemAssociationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateFileSystemAssociationInput, UpdateFileSystemAssociationOutput, UpdateFileSystemAssociationOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateFileSystemAssociation"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </note>
    public func updateGatewayInformation(input: UpdateGatewayInformationInput, completion: @escaping (SdkResult<UpdateGatewayInformationOutput, UpdateGatewayInformationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateGatewayInformationInput, UpdateGatewayInformationOutput, UpdateGatewayInformationOutputError>(id: "updateGatewayInformation")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateGatewayInformationInput, UpdateGatewayInformationOutput, UpdateGatewayInformationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateGatewayInformationInput, UpdateGatewayInformationOutput, UpdateGatewayInformationOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateGatewayInformation"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </important>
    public func updateGatewaySoftwareNow(input: UpdateGatewaySoftwareNowInput, completion: @escaping (SdkResult<UpdateGatewaySoftwareNowOutput, UpdateGatewaySoftwareNowOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateGatewaySoftwareNowInput, UpdateGatewaySoftwareNowOutput, UpdateGatewaySoftwareNowOutputError>(id: "updateGatewaySoftwareNow")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateGatewaySoftwareNowInput, UpdateGatewaySoftwareNowOutput, UpdateGatewaySoftwareNowOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateGatewaySoftwareNowInput, UpdateGatewaySoftwareNowOutput, UpdateGatewaySoftwareNowOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateGatewaySoftwareNow"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateMaintenanceStartTime(input: UpdateMaintenanceStartTimeInput, completion: @escaping (SdkResult<UpdateMaintenanceStartTimeOutput, UpdateMaintenanceStartTimeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateMaintenanceStartTimeInput, UpdateMaintenanceStartTimeOutput, UpdateMaintenanceStartTimeOutputError>(id: "updateMaintenanceStartTime")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateMaintenanceStartTimeInput, UpdateMaintenanceStartTimeOutput, UpdateMaintenanceStartTimeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateMaintenanceStartTimeInput, UpdateMaintenanceStartTimeOutput, UpdateMaintenanceStartTimeOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateMaintenanceStartTime"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </li>
    ///          </ul>
    public func updateNFSFileShare(input: UpdateNFSFileShareInput, completion: @escaping (SdkResult<UpdateNFSFileShareOutput, UpdateNFSFileShareOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateNFSFileShareInput, UpdateNFSFileShareOutput, UpdateNFSFileShareOutputError>(id: "updateNFSFileShare")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateNFSFileShareInput, UpdateNFSFileShareOutput, UpdateNFSFileShareOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateNFSFileShareInput, UpdateNFSFileShareOutput, UpdateNFSFileShareOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateNFSFileShare"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             share.</p>
    ///          </important>
    public func updateSMBFileShare(input: UpdateSMBFileShareInput, completion: @escaping (SdkResult<UpdateSMBFileShareOutput, UpdateSMBFileShareOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateSMBFileShareInput, UpdateSMBFileShareOutput, UpdateSMBFileShareOutputError>(id: "updateSMBFileShare")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateSMBFileShareInput, UpdateSMBFileShareOutput, UpdateSMBFileShareOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateSMBFileShareInput, UpdateSMBFileShareOutput, UpdateSMBFileShareOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateSMBFileShare"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          list.</p>
    public func updateSMBFileShareVisibility(input: UpdateSMBFileShareVisibilityInput, completion: @escaping (SdkResult<UpdateSMBFileShareVisibilityOutput, UpdateSMBFileShareVisibilityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateSMBFileShareVisibilityInput, UpdateSMBFileShareVisibilityOutput, UpdateSMBFileShareVisibilityOutputError>(id: "updateSMBFileShareVisibility")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateSMBFileShareVisibilityInput, UpdateSMBFileShareVisibilityOutput, UpdateSMBFileShareVisibilityOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateSMBFileShareVisibilityInput, UpdateSMBFileShareVisibilityOutput, UpdateSMBFileShareVisibilityOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateSMBFileShareVisibility"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </note>
    public func updateSMBSecurityStrategy(input: UpdateSMBSecurityStrategyInput, completion: @escaping (SdkResult<UpdateSMBSecurityStrategyOutput, UpdateSMBSecurityStrategyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateSMBSecurityStrategyInput, UpdateSMBSecurityStrategyOutput, UpdateSMBSecurityStrategyOutputError>(id: "updateSMBSecurityStrategy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateSMBSecurityStrategyInput, UpdateSMBSecurityStrategyOutput, UpdateSMBSecurityStrategyOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateSMBSecurityStrategyInput, UpdateSMBSecurityStrategyOutput, UpdateSMBSecurityStrategyOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateSMBSecurityStrategy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateSnapshotSchedule(input: UpdateSnapshotScheduleInput, completion: @escaping (SdkResult<UpdateSnapshotScheduleOutput, UpdateSnapshotScheduleOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateSnapshotScheduleInput, UpdateSnapshotScheduleOutput, UpdateSnapshotScheduleOutputError>(id: "updateSnapshotSchedule")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateSnapshotScheduleInput, UpdateSnapshotScheduleOutput, UpdateSnapshotScheduleOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateSnapshotScheduleInput, UpdateSnapshotScheduleOutput, UpdateSnapshotScheduleOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateSnapshotSchedule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          only supported in the tape gateway type.</p>
    public func updateVTLDeviceType(input: UpdateVTLDeviceTypeInput, completion: @escaping (SdkResult<UpdateVTLDeviceTypeOutput, UpdateVTLDeviceTypeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "storagegateway")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateVTLDeviceTypeInput, UpdateVTLDeviceTypeOutput, UpdateVTLDeviceTypeOutputError>(id: "updateVTLDeviceType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateVTLDeviceTypeInput, UpdateVTLDeviceTypeOutput, UpdateVTLDeviceTypeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateVTLDeviceTypeInput, UpdateVTLDeviceTypeOutput, UpdateVTLDeviceTypeOutputError>(xAmzTarget: "StorageGateway_20130630.UpdateVTLDeviceType"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
