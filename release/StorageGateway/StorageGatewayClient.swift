...
public class StorageGatewayClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try StorageGatewayClientConfiguration(region: unwrappedRegion)
    ...
    public class StorageGatewayClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("StorageGatewayClient")
