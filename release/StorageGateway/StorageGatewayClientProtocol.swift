...
public protocol StorageGatewayClientProtocol {
    ...
    ///          </note>
    func activateGateway(input: ActivateGatewayInput, completion: @escaping (SdkResult<ActivateGatewayOutput, ActivateGatewayOutputError>) -> Void)
    ...
    func addCache(input: AddCacheInput, completion: @escaping (SdkResult<AddCacheOutput, AddCacheOutputError>) -> Void)
    ...
    ///          buffer.</p>
    func addUploadBuffer(input: AddUploadBufferInput, completion: @escaping (SdkResult<AddUploadBufferOutput, AddUploadBufferOutputError>) -> Void)
    ...
    ///          storage.</p>
    func addWorkingStorage(input: AddWorkingStorageInput, completion: @escaping (SdkResult<AddWorkingStorageOutput, AddWorkingStorageOutputError>) -> Void)
    ...
    ///          </p>
    func assignTapePool(input: AssignTapePoolInput, completion: @escaping (SdkResult<AssignTapePoolOutput, AssignTapePoolOutputError>) -> Void)
    ...
    ///          gateway type.</p>
    func associateFileSystem(input: AssociateFileSystemInput, completion: @escaping (SdkResult<AssociateFileSystemOutput, AssociateFileSystemOutputError>) -> Void)
    ...
    func attachVolume(input: AttachVolumeInput, completion: @escaping (SdkResult<AttachVolumeOutput, AttachVolumeOutputError>) -> Void)
    ...
    func cancelArchival(input: CancelArchivalInput, completion: @escaping (SdkResult<CancelArchivalOutput, CancelArchivalOutputError>) -> Void)
    ...
    func cancelRetrieval(input: CancelRetrievalInput, completion: @escaping (SdkResult<CancelRetrievalOutput, CancelRetrievalOutputError>) -> Void)
    ...
    func createCachediSCSIVolume(input: CreateCachediSCSIVolumeInput, completion: @escaping (SdkResult<CreateCachediSCSIVolumeOutput, CreateCachediSCSIVolumeOutputError>) -> Void)
    ...
    ///          </important>
    func createNFSFileShare(input: CreateNFSFileShareInput, completion: @escaping (SdkResult<CreateNFSFileShareOutput, CreateNFSFileShareOutputError>) -> Void)
    ...
    ///             share.</p>
    ///          </important>
    func createSMBFileShare(input: CreateSMBFileShareInput, completion: @escaping (SdkResult<CreateSMBFileShareOutput, CreateSMBFileShareOutputError>) -> Void)
    ...
    ///                Reference</i>.</p>
    ///          </note>
    func createSnapshotFromVolumeRecoveryPoint(input: CreateSnapshotFromVolumeRecoveryPointInput, completion: @escaping (SdkResult<CreateSnapshotFromVolumeRecoveryPointOutput, CreateSnapshotFromVolumeRecoveryPointOutputError>) -> Void)
    ...
    func createStorediSCSIVolume(input: CreateStorediSCSIVolumeInput, completion: @escaping (SdkResult<CreateStorediSCSIVolumeOutput, CreateStorediSCSIVolumeOutputError>) -> Void)
    ...
    func createTapePool(input: CreateTapePoolInput, completion: @escaping (SdkResult<CreateTapePoolOutput, CreateTapePoolOutputError>) -> Void)
    ...
    ///             Use the <a>AddCache</a> operation to add cache storage to a gateway.</p>
    ///          </note>
    func createTapes(input: CreateTapesInput, completion: @escaping (SdkResult<CreateTapesOutput, CreateTapesOutputError>) -> Void)
    ...
    ///             Use the <a>AddCache</a> operation to add cache storage to a gateway.</p>
    ///          </note>
    func createTapeWithBarcode(input: CreateTapeWithBarcodeInput, completion: @escaping (SdkResult<CreateTapeWithBarcodeOutput, CreateTapeWithBarcodeOutputError>) -> Void)
    ...
    func deleteAutomaticTapeCreationPolicy(input: DeleteAutomaticTapeCreationPolicyInput, completion: @escaping (SdkResult<DeleteAutomaticTapeCreationPolicyOutput, DeleteAutomaticTapeCreationPolicyOutputError>) -> Void)
    ...
    func deleteBandwidthRateLimit(input: DeleteBandwidthRateLimitInput, completion: @escaping (SdkResult<DeleteBandwidthRateLimitOutput, DeleteBandwidthRateLimitOutputError>) -> Void)
    /// <p>Deletes Challenge-Handshake Authentication Protocol (CHAP) credentials for a specified
    ///          iSCSI target and initiator pair. This operation is supported in volume and tape gateway
    ///          types.</p>
    func deleteChapCredentials(input: DeleteChapCredentialsInput, completion: @escaping (SdkResult<DeleteChapCredentialsOutput, DeleteChapCredentialsOutputError>) -> Void)
    /// <p>Deletes a file share from a file gateway. This operation is only supported for file
    ///          gateways.</p>
    func deleteFileShare(input: DeleteFileShareInput, completion: @escaping (SdkResult<DeleteFileShareOutput, DeleteFileShareOutputError>) -> Void)
    ...
    ///             page</a>.</p>
    ///          </important>
    func deleteGateway(input: DeleteGatewayInput, completion: @escaping (SdkResult<DeleteGatewayOutput, DeleteGatewayOutputError>) -> Void)
    ...
    ///          type.</p>
    func deleteTape(input: DeleteTapeInput, completion: @escaping (SdkResult<DeleteTapeOutput, DeleteTapeOutputError>) -> Void)
    ...
    func deleteTapeArchive(input: DeleteTapeArchiveInput, completion: @escaping (SdkResult<DeleteTapeArchiveOutput, DeleteTapeArchiveOutputError>) -> Void)
    ...
    ///          tape pool.</p>
    func deleteTapePool(input: DeleteTapePoolInput, completion: @escaping (SdkResult<DeleteTapePoolOutput, DeleteTapePoolOutputError>) -> Void)
    ...
    func deleteVolume(input: DeleteVolumeInput, completion: @escaping (SdkResult<DeleteVolumeOutput, DeleteVolumeOutputError>) -> Void)
    ...
    func describeAvailabilityMonitorTest(input: DescribeAvailabilityMonitorTestInput, completion: @escaping (SdkResult<DescribeAvailabilityMonitorTestOutput, DescribeAvailabilityMonitorTestOutputError>) -> Void)
    ...
    func describeBandwidthRateLimit(input: DescribeBandwidthRateLimitInput, completion: @escaping (SdkResult<DescribeBandwidthRateLimitOutput, DescribeBandwidthRateLimitOutputError>) -> Void)
    /// <p>
    ...
    ///          of the gateway in your request.</p>
    func describeBandwidthRateLimitSchedule(input: DescribeBandwidthRateLimitScheduleInput, completion: @escaping (SdkResult<DescribeBandwidthRateLimitScheduleOutput, DescribeBandwidthRateLimitScheduleOutputError>) -> Void)
    ...
    func describeCache(input: DescribeCacheInput, completion: @escaping (SdkResult<DescribeCacheOutput, DescribeCacheOutputError>) -> Void)
    ...
    ///          (ARN).</p>
    func describeCachediSCSIVolumes(input: DescribeCachediSCSIVolumesInput, completion: @escaping (SdkResult<DescribeCachediSCSIVolumesOutput, DescribeCachediSCSIVolumesOutputError>) -> Void)
    ...
    func describeChapCredentials(input: DescribeChapCredentialsInput, completion: @escaping (SdkResult<DescribeChapCredentialsOutput, DescribeChapCredentialsOutputError>) -> Void)
    /// <p>Gets the file system association information. This operation is only supported for
    ///          Amazon FSx file gateways.</p>
    func describeFileSystemAssociations(input: DescribeFileSystemAssociationsInput, completion: @escaping (SdkResult<DescribeFileSystemAssociationsOutput, DescribeFileSystemAssociationsOutputError>) -> Void)
    ...
    func describeGatewayInformation(input: DescribeGatewayInformationInput, completion: @escaping (SdkResult<DescribeGatewayInformationOutput, DescribeGatewayInformationOutputError>) -> Void)
    ...
    func describeMaintenanceStartTime(input: DescribeMaintenanceStartTimeInput, completion: @escaping (SdkResult<DescribeMaintenanceStartTimeOutput, DescribeMaintenanceStartTimeOutputError>) -> Void)
    ...
    func describeNFSFileShares(input: DescribeNFSFileSharesInput, completion: @escaping (SdkResult<DescribeNFSFileSharesOutput, DescribeNFSFileSharesOutputError>) -> Void)
    /// <p>Gets a description for one or more Server Message Block (SMB) file shares from a file
    ///          gateway. This operation is only supported for file gateways.</p>
    func describeSMBFileShares(input: DescribeSMBFileSharesInput, completion: @escaping (SdkResult<DescribeSMBFileSharesOutput, DescribeSMBFileSharesOutputError>) -> Void)
    /// <p>Gets a description of a Server Message Block (SMB) file share settings from a file
    ///          gateway. This operation is only supported for file gateways.</p>
    func describeSMBSettings(input: DescribeSMBSettingsInput, completion: @escaping (SdkResult<DescribeSMBSettingsOutput, DescribeSMBSettingsOutputError>) -> Void)
    ...
    ///          types.</p>
    func describeSnapshotSchedule(input: DescribeSnapshotScheduleInput, completion: @escaping (SdkResult<DescribeSnapshotScheduleOutput, DescribeSnapshotScheduleOutputError>) -> Void)
    ...
    func describeStorediSCSIVolumes(input: DescribeStorediSCSIVolumesInput, completion: @escaping (SdkResult<DescribeStorediSCSIVolumesOutput, DescribeStorediSCSIVolumesOutputError>) -> Void)
    ...
    func describeTapeArchives(input: DescribeTapeArchivesInput, completion: @escaping (SdkResult<DescribeTapeArchivesOutput, DescribeTapeArchivesOutputError>) -> Void)
    ...
    ///          gateway type.</p>
    func describeTapeRecoveryPoints(input: DescribeTapeRecoveryPointsInput, completion: @escaping (SdkResult<DescribeTapeRecoveryPointsOutput, DescribeTapeRecoveryPointsOutputError>) -> Void)
    ...
    ///          type.</p>
    func describeTapes(input: DescribeTapesInput, completion: @escaping (SdkResult<DescribeTapesOutput, DescribeTapesOutputError>) -> Void)
    ...
    func describeUploadBuffer(input: DescribeUploadBufferInput, completion: @escaping (SdkResult<DescribeUploadBufferOutput, DescribeUploadBufferOutputError>) -> Void)
    ...
    func describeVTLDevices(input: DescribeVTLDevicesInput, completion: @escaping (SdkResult<DescribeVTLDevicesOutput, DescribeVTLDevicesOutputError>) -> Void)
    ...
    func describeWorkingStorage(input: DescribeWorkingStorageInput, completion: @escaping (SdkResult<DescribeWorkingStorageOutput, DescribeWorkingStorageOutputError>) -> Void)
    ...
    func detachVolume(input: DetachVolumeInput, completion: @escaping (SdkResult<DetachVolumeOutput, DetachVolumeOutputError>) -> Void)
    ...
    ///          </important>
    func disableGateway(input: DisableGatewayInput, completion: @escaping (SdkResult<DisableGatewayOutput, DisableGatewayOutputError>) -> Void)
    ...
    func disassociateFileSystem(input: DisassociateFileSystemInput, completion: @escaping (SdkResult<DisassociateFileSystemOutput, DisassociateFileSystemOutputError>) -> Void)
    ...
    func joinDomain(input: JoinDomainInput, completion: @escaping (SdkResult<JoinDomainOutput, JoinDomainOutputError>) -> Void)
    ...
    func listAutomaticTapeCreationPolicies(input: ListAutomaticTapeCreationPoliciesInput, completion: @escaping (SdkResult<ListAutomaticTapeCreationPoliciesOutput, ListAutomaticTapeCreationPoliciesOutputError>) -> Void)
    ...
    ///          gateways.</p>
    func listFileShares(input: ListFileSharesInput, completion: @escaping (SdkResult<ListFileSharesOutput, ListFileSharesOutputError>) -> Void)
    ...
    ///          gateways.</p>
    func listFileSystemAssociations(input: ListFileSystemAssociationsInput, completion: @escaping (SdkResult<ListFileSystemAssociationsOutput, ListFileSystemAssociationsOutputError>) -> Void)
    ...
    ///          corrupted).</p>
    func listLocalDisks(input: ListLocalDisksInput, completion: @escaping (SdkResult<ListLocalDisksOutput, ListLocalDisksOutputError>) -> Void)
    ...
    func listTapePools(input: ListTapePoolsInput, completion: @escaping (SdkResult<ListTapePoolsOutput, ListTapePoolsOutputError>) -> Void)
    ...
    func listTapes(input: ListTapesInput, completion: @escaping (SdkResult<ListTapesOutput, ListTapesOutputError>) -> Void)
    ...
    func listVolumeInitiators(input: ListVolumeInitiatorsInput, completion: @escaping (SdkResult<ListVolumeInitiatorsOutput, ListVolumeInitiatorsOutputError>) -> Void)
    ...
    func listVolumeRecoveryPoints(input: ListVolumeRecoveryPointsInput, completion: @escaping (SdkResult<ListVolumeRecoveryPointsOutput, ListVolumeRecoveryPointsOutputError>) -> Void)
    ...
    func listVolumes(input: ListVolumesInput, completion: @escaping (SdkResult<ListVolumesOutput, ListVolumesOutputError>) -> Void)
    ...
    ///             Guide</i>.</p>
    func notifyWhenUploaded(input: NotifyWhenUploadedInput, completion: @escaping (SdkResult<NotifyWhenUploadedOutput, NotifyWhenUploadedOutputError>) -> Void)
    ...
    ///             User Guide</i>.</p>
    func refreshCache(input: RefreshCacheInput, completion: @escaping (SdkResult<RefreshCacheOutput, RefreshCacheOutputError>) -> Void)
    ...
    ///          </important>
    func resetCache(input: ResetCacheInput, completion: @escaping (SdkResult<ResetCacheOutput, ResetCacheOutputError>) -> Void)
    ...
    func retrieveTapeArchive(input: RetrieveTapeArchiveInput, completion: @escaping (SdkResult<RetrieveTapeArchiveOutput, RetrieveTapeArchiveOutputError>) -> Void)
    ...
    ///          </note>
    func retrieveTapeRecoveryPoint(input: RetrieveTapeRecoveryPointInput, completion: @escaping (SdkResult<RetrieveTapeRecoveryPointOutput, RetrieveTapeRecoveryPointOutputError>) -> Void)
    ...
    ///          password.</p>
    func setLocalConsolePassword(input: SetLocalConsolePasswordInput, completion: @escaping (SdkResult<SetLocalConsolePasswordOutput, SetLocalConsolePasswordOutputError>) -> Void)
    ...
    func setSMBGuestPassword(input: SetSMBGuestPasswordInput, completion: @escaping (SdkResult<SetSMBGuestPasswordOutput, SetSMBGuestPasswordOutputError>) -> Void)
    ...
    ///          gateway.</p>
    func shutdownGateway(input: ShutdownGatewayInput, completion: @escaping (SdkResult<ShutdownGatewayOutput, ShutdownGatewayOutputError>) -> Void)
    ...
    ///          </note>
    func startAvailabilityMonitorTest(input: StartAvailabilityMonitorTestInput, completion: @escaping (SdkResult<StartAvailabilityMonitorTestOutput, StartAvailabilityMonitorTestOutputError>) -> Void)
    ...
    ///          your request.</p>
    func startGateway(input: StartGatewayInput, completion: @escaping (SdkResult<StartGatewayOutput, StartGatewayOutputError>) -> Void)
    ...
    ///          </note>
    func updateAutomaticTapeCreationPolicy(input: UpdateAutomaticTapeCreationPolicyInput, completion: @escaping (SdkResult<UpdateAutomaticTapeCreationPolicyOutput, UpdateAutomaticTapeCreationPolicyOutputError>) -> Void)
    ...
    ///          your request.</p>
    func updateBandwidthRateLimit(input: UpdateBandwidthRateLimitInput, completion: @escaping (SdkResult<UpdateBandwidthRateLimitOutput, UpdateBandwidthRateLimitOutputError>) -> Void)
    /// <p>
    ...
    ///       </p>
    func updateBandwidthRateLimitSchedule(input: UpdateBandwidthRateLimitScheduleInput, completion: @escaping (SdkResult<UpdateBandwidthRateLimitScheduleOutput, UpdateBandwidthRateLimitScheduleOutputError>) -> Void)
    ...
    ///          </important>
    func updateChapCredentials(input: UpdateChapCredentialsInput, completion: @escaping (SdkResult<UpdateChapCredentialsOutput, UpdateChapCredentialsOutputError>) -> Void)
    /// <p>Updates a file system association. This operation is only supported in the Amazon FSx
    ///          file gateway type.</p>
    func updateFileSystemAssociation(input: UpdateFileSystemAssociationInput, completion: @escaping (SdkResult<UpdateFileSystemAssociationOutput, UpdateFileSystemAssociationOutputError>) -> Void)
    ...
    ///          </note>
    func updateGatewayInformation(input: UpdateGatewayInformationInput, completion: @escaping (SdkResult<UpdateGatewayInformationOutput, UpdateGatewayInformationOutputError>) -> Void)
    ...
    ///          </important>
    func updateGatewaySoftwareNow(input: UpdateGatewaySoftwareNowInput, completion: @escaping (SdkResult<UpdateGatewaySoftwareNowOutput, UpdateGatewaySoftwareNowOutputError>) -> Void)
    ...
    func updateMaintenanceStartTime(input: UpdateMaintenanceStartTimeInput, completion: @escaping (SdkResult<UpdateMaintenanceStartTimeOutput, UpdateMaintenanceStartTimeOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func updateNFSFileShare(input: UpdateNFSFileShareInput, completion: @escaping (SdkResult<UpdateNFSFileShareOutput, UpdateNFSFileShareOutputError>) -> Void)
    ...
    ///             share.</p>
    ///          </important>
    func updateSMBFileShare(input: UpdateSMBFileShareInput, completion: @escaping (SdkResult<UpdateSMBFileShareOutput, UpdateSMBFileShareOutputError>) -> Void)
    /// <p>Controls whether the shares on a gateway are visible in a net view or browse
    ///          list.</p>
    func updateSMBFileShareVisibility(input: UpdateSMBFileShareVisibilityInput, completion: @escaping (SdkResult<UpdateSMBFileShareVisibilityOutput, UpdateSMBFileShareVisibilityOutputError>) -> Void)
    ...
    ///          </note>
    func updateSMBSecurityStrategy(input: UpdateSMBSecurityStrategyInput, completion: @escaping (SdkResult<UpdateSMBSecurityStrategyOutput, UpdateSMBSecurityStrategyOutputError>) -> Void)
    ...
    func updateSnapshotSchedule(input: UpdateSnapshotScheduleInput, completion: @escaping (SdkResult<UpdateSnapshotScheduleOutput, UpdateSnapshotScheduleOutputError>) -> Void)
    ...
    ///          only supported in the tape gateway type.</p>
    func updateVTLDeviceType(input: UpdateVTLDeviceTypeInput, completion: @escaping (SdkResult<UpdateVTLDeviceTypeOutput, UpdateVTLDeviceTypeOutputError>) -> Void)
}
