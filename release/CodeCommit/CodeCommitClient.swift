...
public class CodeCommitClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try CodeCommitClientConfiguration(region: unwrappedRegion)
    ...
    public class CodeCommitClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("CodeCommitClient")
...
public struct CodeCommitClientLogHandlerFactory: SDKLogHandlerFactory {
