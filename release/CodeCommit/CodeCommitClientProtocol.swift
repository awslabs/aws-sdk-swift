...
public protocol CodeCommitClientProtocol {
    ...
    ///             that repository.</p>
    func associateApprovalRuleTemplateWithRepository(input: AssociateApprovalRuleTemplateWithRepositoryInput, completion: @escaping (SdkResult<AssociateApprovalRuleTemplateWithRepositoryOutput, AssociateApprovalRuleTemplateWithRepositoryOutputError>) -> Void)
    /// <p>Creates an association between an approval rule template and one or more specified repositories. </p>
    func batchAssociateApprovalRuleTemplateWithRepositories(input: BatchAssociateApprovalRuleTemplateWithRepositoriesInput, completion: @escaping (SdkResult<BatchAssociateApprovalRuleTemplateWithRepositoriesOutput, BatchAssociateApprovalRuleTemplateWithRepositoriesOutputError>) -> Void)
    ...
    func batchDescribeMergeConflicts(input: BatchDescribeMergeConflictsInput, completion: @escaping (SdkResult<BatchDescribeMergeConflictsOutput, BatchDescribeMergeConflictsOutputError>) -> Void)
    /// <p>Removes the association between an approval rule template and one or more specified repositories. </p>
    func batchDisassociateApprovalRuleTemplateFromRepositories(input: BatchDisassociateApprovalRuleTemplateFromRepositoriesInput, completion: @escaping (SdkResult<BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput, BatchDisassociateApprovalRuleTemplateFromRepositoriesOutputError>) -> Void)
    /// <p>Returns information about the contents of one or more commits in a repository.</p>
    func batchGetCommits(input: BatchGetCommitsInput, completion: @escaping (SdkResult<BatchGetCommitsOutput, BatchGetCommitsOutputError>) -> Void)
    ...
    ///          </note>
    func batchGetRepositories(input: BatchGetRepositoriesInput, completion: @escaping (SdkResult<BatchGetRepositoriesOutput, BatchGetRepositoriesOutputError>) -> Void)
    ...
    func createApprovalRuleTemplate(input: CreateApprovalRuleTemplateInput, completion: @escaping (SdkResult<CreateApprovalRuleTemplateOutput, CreateApprovalRuleTemplateOutputError>) -> Void)
    ...
    func createCommit(input: CreateCommitInput, completion: @escaping (SdkResult<CreateCommitOutput, CreateCommitOutputError>) -> Void)
    /// <p>Creates a pull request in the specified repository.</p>
    func createPullRequest(input: CreatePullRequestInput, completion: @escaping (SdkResult<CreatePullRequestOutput, CreatePullRequestOutputError>) -> Void)
    /// <p>Creates an approval rule for a pull request.</p>
    func createPullRequestApprovalRule(input: CreatePullRequestApprovalRuleInput, completion: @escaping (SdkResult<CreatePullRequestApprovalRuleOutput, CreatePullRequestApprovalRuleOutputError>) -> Void)
    ...
    ///          </note>
    func createUnreferencedMergeCommit(input: CreateUnreferencedMergeCommitInput, completion: @escaping (SdkResult<CreateUnreferencedMergeCommitOutput, CreateUnreferencedMergeCommitOutputError>) -> Void)
    ...
    func deleteApprovalRuleTemplate(input: DeleteApprovalRuleTemplateInput, completion: @escaping (SdkResult<DeleteApprovalRuleTemplateOutput, DeleteApprovalRuleTemplateOutputError>) -> Void)
    ...
    func deleteCommentContent(input: DeleteCommentContentInput, completion: @escaping (SdkResult<DeleteCommentContentOutput, DeleteCommentContentOutputError>) -> Void)
    ...
    func deleteFile(input: DeleteFileInput, completion: @escaping (SdkResult<DeleteFileOutput, DeleteFileOutputError>) -> Void)
    ...
    func deletePullRequestApprovalRule(input: DeletePullRequestApprovalRuleInput, completion: @escaping (SdkResult<DeletePullRequestApprovalRuleOutput, DeletePullRequestApprovalRuleOutputError>) -> Void)
    ...
    func describeMergeConflicts(input: DescribeMergeConflictsInput, completion: @escaping (SdkResult<DescribeMergeConflictsOutput, DescribeMergeConflictsOutputError>) -> Void)
    /// <p>Returns information about one or more pull request events.</p>
    func describePullRequestEvents(input: DescribePullRequestEventsInput, completion: @escaping (SdkResult<DescribePullRequestEventsOutput, DescribePullRequestEventsOutputError>) -> Void)
    ...
    func disassociateApprovalRuleTemplateFromRepository(input: DisassociateApprovalRuleTemplateFromRepositoryInput, completion: @escaping (SdkResult<DisassociateApprovalRuleTemplateFromRepositoryOutput, DisassociateApprovalRuleTemplateFromRepositoryOutputError>) -> Void)
    /// <p>Evaluates whether a pull request has met all the conditions specified in its associated approval rules.</p>
    func evaluatePullRequestApprovalRules(input: EvaluatePullRequestApprovalRulesInput, completion: @escaping (SdkResult<EvaluatePullRequestApprovalRulesOutput, EvaluatePullRequestApprovalRulesOutputError>) -> Void)
    /// <p>Returns information about a specified approval rule template.</p>
    func getApprovalRuleTemplate(input: GetApprovalRuleTemplateInput, completion: @escaping (SdkResult<GetApprovalRuleTemplateOutput, GetApprovalRuleTemplateOutputError>) -> Void)
    /// <p>Returns the base-64 encoded content of an individual blob in a repository.</p>
    func getBlob(input: GetBlobInput, completion: @escaping (SdkResult<GetBlobOutput, GetBlobOutputError>) -> Void)
    ...
    ///          </note>
    func getComment(input: GetCommentInput, completion: @escaping (SdkResult<GetCommentOutput, GetCommentOutputError>) -> Void)
    ...
    func getCommentReactions(input: GetCommentReactionsInput, completion: @escaping (SdkResult<GetCommentReactionsOutput, GetCommentReactionsOutputError>) -> Void)
    /// <p>Returns information about comments made on the comparison between two commits.</p>
    ///         <note>
    ///             <p>Reaction counts might include numbers from user identities who were deleted after the reaction was made. For a count of
    ///             reactions from active identities, use GetCommentReactions.</p>
    ///          </note>
    func getCommentsForComparedCommit(input: GetCommentsForComparedCommitInput, completion: @escaping (SdkResult<GetCommentsForComparedCommitOutput, GetCommentsForComparedCommitOutputError>) -> Void)
    /// <p>Returns comments made on a pull request.</p>
    ///         <note>
    ///             <p>Reaction counts might include numbers from user identities who were deleted after the reaction was made. For a count of
    ///             reactions from active identities, use GetCommentReactions.</p>
    ///          </note>
    func getCommentsForPullRequest(input: GetCommentsForPullRequestInput, completion: @escaping (SdkResult<GetCommentsForPullRequestOutput, GetCommentsForPullRequestOutputError>) -> Void)
    /// <p>Returns information about a commit, including commit message and committer information.</p>
    func getCommit(input: GetCommitInput, completion: @escaping (SdkResult<GetCommitOutput, GetCommitOutputError>) -> Void)
    ...
    func getDifferences(input: GetDifferencesInput, completion: @escaping (SdkResult<GetDifferencesOutput, GetDifferencesOutputError>) -> Void)
    /// <p>Returns the base-64 encoded contents of a specified file and its metadata.</p>
    func getFile(input: GetFileInput, completion: @escaping (SdkResult<GetFileOutput, GetFileOutputError>) -> Void)
    ...
    func getMergeCommit(input: GetMergeCommitInput, completion: @escaping (SdkResult<GetMergeCommitOutput, GetMergeCommitOutputError>) -> Void)
    /// <p>Returns information about merge conflicts between the before and after commit IDs for a pull request in a repository.</p>
    func getMergeConflicts(input: GetMergeConflictsInput, completion: @escaping (SdkResult<GetMergeConflictsOutput, GetMergeConflictsOutputError>) -> Void)
    ...
    func getMergeOptions(input: GetMergeOptionsInput, completion: @escaping (SdkResult<GetMergeOptionsOutput, GetMergeOptionsOutputError>) -> Void)
    /// <p>Gets information about a pull request in a specified repository.</p>
    func getPullRequest(input: GetPullRequestInput, completion: @escaping (SdkResult<GetPullRequestOutput, GetPullRequestOutputError>) -> Void)
    ...
    func getPullRequestApprovalStates(input: GetPullRequestApprovalStatesInput, completion: @escaping (SdkResult<GetPullRequestApprovalStatesOutput, GetPullRequestApprovalStatesOutputError>) -> Void)
    /// <p>Returns information about whether approval rules have been set aside (overridden) for a
    ///             pull request, and if so, the Amazon Resource Name (ARN) of the user or identity that overrode the rules and their requirements for the pull request.</p>
    func getPullRequestOverrideState(input: GetPullRequestOverrideStateInput, completion: @escaping (SdkResult<GetPullRequestOverrideStateOutput, GetPullRequestOverrideStateOutputError>) -> Void)
    ...
    ///                 the repository description on a webpage.</p>
    ///          </note>
    func getRepository(input: GetRepositoryInput, completion: @escaping (SdkResult<GetRepositoryOutput, GetRepositoryOutputError>) -> Void)
    /// <p>Gets information about triggers configured for a repository.</p>
    func getRepositoryTriggers(input: GetRepositoryTriggersInput, completion: @escaping (SdkResult<GetRepositoryTriggersOutput, GetRepositoryTriggersOutputError>) -> Void)
    ...
    func listApprovalRuleTemplates(input: ListApprovalRuleTemplatesInput, completion: @escaping (SdkResult<ListApprovalRuleTemplatesOutput, ListApprovalRuleTemplatesOutputError>) -> Void)
    /// <p>Lists all approval rule templates that are associated with a specified repository.</p>
    func listAssociatedApprovalRuleTemplatesForRepository(input: ListAssociatedApprovalRuleTemplatesForRepositoryInput, completion: @escaping (SdkResult<ListAssociatedApprovalRuleTemplatesForRepositoryOutput, ListAssociatedApprovalRuleTemplatesForRepositoryOutputError>) -> Void)
    ...
    func listPullRequests(input: ListPullRequestsInput, completion: @escaping (SdkResult<ListPullRequestsOutput, ListPullRequestsOutputError>) -> Void)
    ...
    func listRepositoriesForApprovalRuleTemplate(input: ListRepositoriesForApprovalRuleTemplateInput, completion: @escaping (SdkResult<ListRepositoriesForApprovalRuleTemplateOutput, ListRepositoriesForApprovalRuleTemplateOutputError>) -> Void)
    ...
    func mergeBranchesByFastForward(input: MergeBranchesByFastForwardInput, completion: @escaping (SdkResult<MergeBranchesByFastForwardOutput, MergeBranchesByFastForwardOutputError>) -> Void)
    /// <p>Merges two branches using the squash merge strategy.</p>
    func mergeBranchesBySquash(input: MergeBranchesBySquashInput, completion: @escaping (SdkResult<MergeBranchesBySquashOutput, MergeBranchesBySquashOutputError>) -> Void)
    /// <p>Merges two specified branches using the three-way merge strategy.</p>
    func mergeBranchesByThreeWay(input: MergeBranchesByThreeWayInput, completion: @escaping (SdkResult<MergeBranchesByThreeWayOutput, MergeBranchesByThreeWayOutputError>) -> Void)
    ...
    func mergePullRequestByFastForward(input: MergePullRequestByFastForwardInput, completion: @escaping (SdkResult<MergePullRequestByFastForwardOutput, MergePullRequestByFastForwardOutputError>) -> Void)
    /// <p>Attempts to merge the source commit of a pull request into the specified destination
    ...
    func mergePullRequestBySquash(input: MergePullRequestBySquashInput, completion: @escaping (SdkResult<MergePullRequestBySquashOutput, MergePullRequestBySquashOutputError>) -> Void)
    /// <p>Attempts to merge the source commit of a pull request into the specified destination
    ...
    func mergePullRequestByThreeWay(input: MergePullRequestByThreeWayInput, completion: @escaping (SdkResult<MergePullRequestByThreeWayOutput, MergePullRequestByThreeWayOutputError>) -> Void)
    /// <p>Sets aside (overrides) all approval rule requirements for a specified pull request.</p>
    func overridePullRequestApprovalRules(input: OverridePullRequestApprovalRulesInput, completion: @escaping (SdkResult<OverridePullRequestApprovalRulesOutput, OverridePullRequestApprovalRulesOutputError>) -> Void)
    /// <p>Posts a comment on the comparison between two commits.</p>
    func postCommentForComparedCommit(input: PostCommentForComparedCommitInput, completion: @escaping (SdkResult<PostCommentForComparedCommitOutput, PostCommentForComparedCommitOutputError>) -> Void)
    /// <p>Posts a comment on a pull request.</p>
    func postCommentForPullRequest(input: PostCommentForPullRequestInput, completion: @escaping (SdkResult<PostCommentForPullRequestOutput, PostCommentForPullRequestOutputError>) -> Void)
    /// <p>Posts a comment in reply to an existing comment on a comparison between commits or a pull request.</p>
    func postCommentReply(input: PostCommentReplyInput, completion: @escaping (SdkResult<PostCommentReplyOutput, PostCommentReplyOutputError>) -> Void)
    ...
    func putCommentReaction(input: PutCommentReactionInput, completion: @escaping (SdkResult<PutCommentReactionOutput, PutCommentReactionOutputError>) -> Void)
    ...
    func putFile(input: PutFileInput, completion: @escaping (SdkResult<PutFileOutput, PutFileOutputError>) -> Void)
    /// <p>Replaces all triggers for a repository. Used to create or delete triggers.</p>
    func putRepositoryTriggers(input: PutRepositoryTriggersInput, completion: @escaping (SdkResult<PutRepositoryTriggersOutput, PutRepositoryTriggersOutputError>) -> Void)
    ...
    func testRepositoryTriggers(input: TestRepositoryTriggersInput, completion: @escaping (SdkResult<TestRepositoryTriggersOutput, TestRepositoryTriggersOutputError>) -> Void)
    ...
    ///             defined.</p>
    func updateApprovalRuleTemplateContent(input: UpdateApprovalRuleTemplateContentInput, completion: @escaping (SdkResult<UpdateApprovalRuleTemplateContentOutput, UpdateApprovalRuleTemplateContentOutputError>) -> Void)
    /// <p>Updates the description for a specified approval rule template.</p>
    func updateApprovalRuleTemplateDescription(input: UpdateApprovalRuleTemplateDescriptionInput, completion: @escaping (SdkResult<UpdateApprovalRuleTemplateDescriptionOutput, UpdateApprovalRuleTemplateDescriptionOutputError>) -> Void)
    /// <p>Updates the name of a specified approval rule template.</p>
    func updateApprovalRuleTemplateName(input: UpdateApprovalRuleTemplateNameInput, completion: @escaping (SdkResult<UpdateApprovalRuleTemplateNameOutput, UpdateApprovalRuleTemplateNameOutputError>) -> Void)
    /// <p>Replaces the contents of a comment.</p>
    func updateComment(input: UpdateCommentInput, completion: @escaping (SdkResult<UpdateCommentOutput, UpdateCommentOutputError>) -> Void)
    ...
    ///          </note>
    func updateDefaultBranch(input: UpdateDefaultBranchInput, completion: @escaping (SdkResult<UpdateDefaultBranchOutput, UpdateDefaultBranchOutputError>) -> Void)
    ...
    func updatePullRequestApprovalRuleContent(input: UpdatePullRequestApprovalRuleContentInput, completion: @escaping (SdkResult<UpdatePullRequestApprovalRuleContentOutput, UpdatePullRequestApprovalRuleContentOutputError>) -> Void)
    ...
    func updatePullRequestApprovalState(input: UpdatePullRequestApprovalStateInput, completion: @escaping (SdkResult<UpdatePullRequestApprovalStateOutput, UpdatePullRequestApprovalStateOutputError>) -> Void)
    /// <p>Replaces the contents of the description of a pull request.</p>
    func updatePullRequestDescription(input: UpdatePullRequestDescriptionInput, completion: @escaping (SdkResult<UpdatePullRequestDescriptionOutput, UpdatePullRequestDescriptionOutputError>) -> Void)
    /// <p>Updates the status of a pull request. </p>
    func updatePullRequestStatus(input: UpdatePullRequestStatusInput, completion: @escaping (SdkResult<UpdatePullRequestStatusOutput, UpdatePullRequestStatusOutputError>) -> Void)
    /// <p>Replaces the title of a pull request.</p>
    func updatePullRequestTitle(input: UpdatePullRequestTitleInput, completion: @escaping (SdkResult<UpdatePullRequestTitleOutput, UpdatePullRequestTitleOutputError>) -> Void)
    ...
    ///                 the repository description on a webpage.</p>
    ///          </note>
    func updateRepositoryDescription(input: UpdateRepositoryDescriptionInput, completion: @escaping (SdkResult<UpdateRepositoryDescriptionOutput, UpdateRepositoryDescriptionOutputError>) -> Void)
    ...
    ///             User Guide.</p>
    func updateRepositoryName(input: UpdateRepositoryNameInput, completion: @escaping (SdkResult<UpdateRepositoryNameOutput, UpdateRepositoryNameOutputError>) -> Void)
}
