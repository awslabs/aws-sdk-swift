...
struct ListAssociatedApprovalRuleTemplatesForRepositoryOutputBody: Equatable {
    public let approvalRuleTemplateNames: [String]?
    public let nextToken: String?
}

extension ListAssociatedApprovalRuleTemplatesForRepositoryOutputBody: Decodable {
