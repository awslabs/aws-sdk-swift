...
extension IotJobsDataPlaneClient: IotJobsDataPlaneClientProtocol {
    ...
    public func describeJobExecution(input: DescribeJobExecutionInput, completion: @escaping (SdkResult<DescribeJobExecutionOutput, DescribeJobExecutionOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<DescribeJobExecutionInput, DescribeJobExecutionOutput, DescribeJobExecutionOutputError>(id: "describeJobExecution")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeJobExecutionInput, DescribeJobExecutionOutput, DescribeJobExecutionOutputError>(contentType: "application/json"))
    ...
    public func getPendingJobExecutions(input: GetPendingJobExecutionsInput, completion: @escaping (SdkResult<GetPendingJobExecutionsOutput, GetPendingJobExecutionsOutputError>) -> Void)
    {
        guard let thingName = input.thingName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component thingName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iot-jobs-data")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetPendingJobExecutionsInput, GetPendingJobExecutionsOutput, GetPendingJobExecutionsOutputError>(id: "getPendingJobExecutions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetPendingJobExecutionsInput, GetPendingJobExecutionsOutput, GetPendingJobExecutionsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func startNextPendingJobExecution(input: StartNextPendingJobExecutionInput, completion: @escaping (SdkResult<StartNextPendingJobExecutionOutput, StartNextPendingJobExecutionOutputError>) -> Void)
    {
        guard let thingName = input.thingName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component thingName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iot-jobs-data")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartNextPendingJobExecutionInput, StartNextPendingJobExecutionOutput, StartNextPendingJobExecutionOutputError>(id: "startNextPendingJobExecution")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartNextPendingJobExecutionInput, StartNextPendingJobExecutionOutput, StartNextPendingJobExecutionOutputError>(contentType: "application/json"))
    ...
    public func updateJobExecution(input: UpdateJobExecutionInput, completion: @escaping (SdkResult<UpdateJobExecutionOutput, UpdateJobExecutionOutputError>) -> Void)
    {
        guard let thingName = input.thingName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component thingName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iot-jobs-data")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateJobExecutionInput, UpdateJobExecutionOutput, UpdateJobExecutionOutputError>(id: "updateJobExecution")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateJobExecutionInput, UpdateJobExecutionOutput, UpdateJobExecutionOutputError>(contentType: "application/json"))
