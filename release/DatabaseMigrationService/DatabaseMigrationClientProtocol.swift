...
public protocol DatabaseMigrationClientProtocol {
    ...
    ///          running.</p>
    func cancelReplicationTaskAssessmentRun(input: CancelReplicationTaskAssessmentRunInput, completion: @escaping (SdkResult<CancelReplicationTaskAssessmentRunOutputResponse, CancelReplicationTaskAssessmentRunOutputError>) -> Void)
    ...
    func createReplicationInstance(input: CreateReplicationInstanceInput, completion: @escaping (SdkResult<CreateReplicationInstanceOutputResponse, CreateReplicationInstanceOutputError>) -> Void)
    /// <p>Creates a replication subnet group given a list of the subnet IDs in a VPC.</p>
    func createReplicationSubnetGroup(input: CreateReplicationSubnetGroupInput, completion: @escaping (SdkResult<CreateReplicationSubnetGroupOutputResponse, CreateReplicationSubnetGroupOutputError>) -> Void)
    /// <p>Creates a replication task using the specified parameters.</p>
    func createReplicationTask(input: CreateReplicationTaskInput, completion: @escaping (SdkResult<CreateReplicationTaskOutputResponse, CreateReplicationTaskOutputError>) -> Void)
    ...
    ///          </note>
    ///          <p></p>
    func deleteReplicationInstance(input: DeleteReplicationInstanceInput, completion: @escaping (SdkResult<DeleteReplicationInstanceOutputResponse, DeleteReplicationInstanceOutputError>) -> Void)
    /// <p>Deletes a subnet group.</p>
    func deleteReplicationSubnetGroup(input: DeleteReplicationSubnetGroupInput, completion: @escaping (SdkResult<DeleteReplicationSubnetGroupOutputResponse, DeleteReplicationSubnetGroupOutputError>) -> Void)
    /// <p>Deletes the specified replication task.</p>
    func deleteReplicationTask(input: DeleteReplicationTaskInput, completion: @escaping (SdkResult<DeleteReplicationTaskOutputResponse, DeleteReplicationTaskOutputError>) -> Void)
    ...
    func deleteReplicationTaskAssessmentRun(input: DeleteReplicationTaskAssessmentRunInput, completion: @escaping (SdkResult<DeleteReplicationTaskAssessmentRunOutputResponse, DeleteReplicationTaskAssessmentRunOutputError>) -> Void)
    ...
    func describeApplicableIndividualAssessments(input: DescribeApplicableIndividualAssessmentsInput, completion: @escaping (SdkResult<DescribeApplicableIndividualAssessmentsOutputResponse, DescribeApplicableIndividualAssessmentsOutputError>) -> Void)
    ...
    func describeConnections(input: DescribeConnectionsInput, completion: @escaping (SdkResult<DescribeConnectionsOutputResponse, DescribeConnectionsOutputError>) -> Void)
    ...
    func describeEndpointSettings(input: DescribeEndpointSettingsInput, completion: @escaping (SdkResult<DescribeEndpointSettingsOutputResponse, DescribeEndpointSettingsOutputError>) -> Void)
    /// <p>Returns information about the type of endpoints available.</p>
    func describeEndpointTypes(input: DescribeEndpointTypesInput, completion: @escaping (SdkResult<DescribeEndpointTypesOutputResponse, DescribeEndpointTypesOutputError>) -> Void)
    ...
    ///          specified region.</p>
    func describeOrderableReplicationInstances(input: DescribeOrderableReplicationInstancesInput, completion: @escaping (SdkResult<DescribeOrderableReplicationInstancesOutputResponse, DescribeOrderableReplicationInstancesOutputError>) -> Void)
    ...
    func describeRefreshSchemasStatus(input: DescribeRefreshSchemasStatusInput, completion: @escaping (SdkResult<DescribeRefreshSchemasStatusOutputResponse, DescribeRefreshSchemasStatusOutputError>) -> Void)
    /// <p>Returns information about replication instances for your account in the current
    ///          region.</p>
    func describeReplicationInstances(input: DescribeReplicationInstancesInput, completion: @escaping (SdkResult<DescribeReplicationInstancesOutputResponse, DescribeReplicationInstancesOutputError>) -> Void)
    /// <p>Returns information about the task logs for the specified task.</p>
    func describeReplicationInstanceTaskLogs(input: DescribeReplicationInstanceTaskLogsInput, completion: @escaping (SdkResult<DescribeReplicationInstanceTaskLogsOutputResponse, DescribeReplicationInstanceTaskLogsOutputError>) -> Void)
    /// <p>Returns information about the replication subnet groups.</p>
    func describeReplicationSubnetGroups(input: DescribeReplicationSubnetGroupsInput, completion: @escaping (SdkResult<DescribeReplicationSubnetGroupsOutputResponse, DescribeReplicationSubnetGroupsOutputError>) -> Void)
    /// <p>Returns the task assessment results from Amazon S3. This action always returns the
    ///          latest results.</p>
    func describeReplicationTaskAssessmentResults(input: DescribeReplicationTaskAssessmentResultsInput, completion: @escaping (SdkResult<DescribeReplicationTaskAssessmentResultsOutputResponse, DescribeReplicationTaskAssessmentResultsOutputError>) -> Void)
    ...
    ///             operation. </p>
    ///          </note>
    func describeReplicationTaskAssessmentRuns(input: DescribeReplicationTaskAssessmentRunsInput, completion: @escaping (SdkResult<DescribeReplicationTaskAssessmentRunsOutputResponse, DescribeReplicationTaskAssessmentRunsOutputError>) -> Void)
    ...
    func describeReplicationTaskIndividualAssessments(input: DescribeReplicationTaskIndividualAssessmentsInput, completion: @escaping (SdkResult<DescribeReplicationTaskIndividualAssessmentsOutputResponse, DescribeReplicationTaskIndividualAssessmentsOutputError>) -> Void)
    /// <p>Returns information about replication tasks for your account in the current
    ///          region.</p>
    func describeReplicationTasks(input: DescribeReplicationTasksInput, completion: @escaping (SdkResult<DescribeReplicationTasksOutputResponse, DescribeReplicationTasksOutputError>) -> Void)
    /// <p>Returns information about the schema for the specified endpoint.</p>
    ///
    ///          <p></p>
    func describeSchemas(input: DescribeSchemasInput, completion: @escaping (SdkResult<DescribeSchemasOutputResponse, DescribeSchemasOutputError>) -> Void)
    ...
    func describeTableStatistics(input: DescribeTableStatisticsInput, completion: @escaping (SdkResult<DescribeTableStatisticsOutputResponse, DescribeTableStatisticsOutputError>) -> Void)
    ...
    func modifyEndpoint(input: ModifyEndpointInput, completion: @escaping (SdkResult<ModifyEndpointOutputResponse, ModifyEndpointOutputError>) -> Void)
    ...
    ///
    ///          <p></p>
    func modifyReplicationInstance(input: ModifyReplicationInstanceInput, completion: @escaping (SdkResult<ModifyReplicationInstanceOutputResponse, ModifyReplicationInstanceOutputError>) -> Void)
    /// <p>Modifies the settings for the specified replication subnet group.</p>
    func modifyReplicationSubnetGroup(input: ModifyReplicationSubnetGroupInput, completion: @escaping (SdkResult<ModifyReplicationSubnetGroupOutputResponse, ModifyReplicationSubnetGroupOutputError>) -> Void)
    ...
    func modifyReplicationTask(input: ModifyReplicationTaskInput, completion: @escaping (SdkResult<ModifyReplicationTaskOutputResponse, ModifyReplicationTaskOutputError>) -> Void)
    ...
    ///          instance.</p>
    func moveReplicationTask(input: MoveReplicationTaskInput, completion: @escaping (SdkResult<MoveReplicationTaskOutputResponse, MoveReplicationTaskOutputError>) -> Void)
    ...
    func rebootReplicationInstance(input: RebootReplicationInstanceInput, completion: @escaping (SdkResult<RebootReplicationInstanceOutputResponse, RebootReplicationInstanceOutputError>) -> Void)
    ...
    func refreshSchemas(input: RefreshSchemasInput, completion: @escaping (SdkResult<RefreshSchemasOutputResponse, RefreshSchemasOutputError>) -> Void)
    /// <p>Reloads the target database table with the source data. </p>
    func reloadTables(input: ReloadTablesInput, completion: @escaping (SdkResult<ReloadTablesOutputResponse, ReloadTablesOutputError>) -> Void)
    ...
    ///          </p>
    func startReplicationTask(input: StartReplicationTaskInput, completion: @escaping (SdkResult<StartReplicationTaskOutputResponse, StartReplicationTaskOutputError>) -> Void)
    /// <p> Starts the replication task assessment for unsupported data types in the source
    ///          database. </p>
    func startReplicationTaskAssessment(input: StartReplicationTaskAssessmentInput, completion: @escaping (SdkResult<StartReplicationTaskAssessmentOutputResponse, StartReplicationTaskAssessmentOutputError>) -> Void)
    ...
    func startReplicationTaskAssessmentRun(input: StartReplicationTaskAssessmentRunInput, completion: @escaping (SdkResult<StartReplicationTaskAssessmentRunOutputResponse, StartReplicationTaskAssessmentRunOutputError>) -> Void)
    /// <p>Stops the replication task.</p>
    func stopReplicationTask(input: StopReplicationTaskInput, completion: @escaping (SdkResult<StopReplicationTaskOutputResponse, StopReplicationTaskOutputError>) -> Void)
    /// <p>Tests the connection between the replication instance and the endpoint.</p>
    func testConnection(input: TestConnectionInput, completion: @escaping (SdkResult<TestConnectionOutputResponse, TestConnectionOutputError>) -> Void)
}
