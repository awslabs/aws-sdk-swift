...
///          </p>
public protocol DatabaseMigrationServiceClientProtocol {
    ...
    ///          running.</p>
    func cancelReplicationTaskAssessmentRun(input: CancelReplicationTaskAssessmentRunInput, completion: @escaping (SdkResult<CancelReplicationTaskAssessmentRunOutput, CancelReplicationTaskAssessmentRunOutputError>) -> Void)
    ...
    func createReplicationInstance(input: CreateReplicationInstanceInput, completion: @escaping (SdkResult<CreateReplicationInstanceOutput, CreateReplicationInstanceOutputError>) -> Void)
    /// <p>Creates a replication subnet group given a list of the subnet IDs in a VPC.</p>
    func createReplicationSubnetGroup(input: CreateReplicationSubnetGroupInput, completion: @escaping (SdkResult<CreateReplicationSubnetGroupOutput, CreateReplicationSubnetGroupOutputError>) -> Void)
    /// <p>Creates a replication task using the specified parameters.</p>
    func createReplicationTask(input: CreateReplicationTaskInput, completion: @escaping (SdkResult<CreateReplicationTaskOutput, CreateReplicationTaskOutputError>) -> Void)
    /// <p>Deletes the specified certificate. </p>
    func deleteCertificate(input: DeleteCertificateInput, completion: @escaping (SdkResult<DeleteCertificateOutput, DeleteCertificateOutputError>) -> Void)
    ...
    ///          </note>
    ///          <p></p>
    func deleteReplicationInstance(input: DeleteReplicationInstanceInput, completion: @escaping (SdkResult<DeleteReplicationInstanceOutput, DeleteReplicationInstanceOutputError>) -> Void)
    /// <p>Deletes a subnet group.</p>
    func deleteReplicationSubnetGroup(input: DeleteReplicationSubnetGroupInput, completion: @escaping (SdkResult<DeleteReplicationSubnetGroupOutput, DeleteReplicationSubnetGroupOutputError>) -> Void)
    /// <p>Deletes the specified replication task.</p>
    func deleteReplicationTask(input: DeleteReplicationTaskInput, completion: @escaping (SdkResult<DeleteReplicationTaskOutput, DeleteReplicationTaskOutputError>) -> Void)
    ...
    func deleteReplicationTaskAssessmentRun(input: DeleteReplicationTaskAssessmentRunInput, completion: @escaping (SdkResult<DeleteReplicationTaskAssessmentRunOutput, DeleteReplicationTaskAssessmentRunOutputError>) -> Void)
    ...
    func describeApplicableIndividualAssessments(input: DescribeApplicableIndividualAssessmentsInput, completion: @escaping (SdkResult<DescribeApplicableIndividualAssessmentsOutput, DescribeApplicableIndividualAssessmentsOutputError>) -> Void)
    ...
    func describeConnections(input: DescribeConnectionsInput, completion: @escaping (SdkResult<DescribeConnectionsOutput, DescribeConnectionsOutputError>) -> Void)
    ...
    func describeEndpointSettings(input: DescribeEndpointSettingsInput, completion: @escaping (SdkResult<DescribeEndpointSettingsOutput, DescribeEndpointSettingsOutputError>) -> Void)
    /// <p>Returns information about the type of endpoints available.</p>
    func describeEndpointTypes(input: DescribeEndpointTypesInput, completion: @escaping (SdkResult<DescribeEndpointTypesOutput, DescribeEndpointTypesOutputError>) -> Void)
    ...
    ///          specified region.</p>
    func describeOrderableReplicationInstances(input: DescribeOrderableReplicationInstancesInput, completion: @escaping (SdkResult<DescribeOrderableReplicationInstancesOutput, DescribeOrderableReplicationInstancesOutputError>) -> Void)
    ...
    func describeRefreshSchemasStatus(input: DescribeRefreshSchemasStatusInput, completion: @escaping (SdkResult<DescribeRefreshSchemasStatusOutput, DescribeRefreshSchemasStatusOutputError>) -> Void)
    /// <p>Returns information about replication instances for your account in the current
    ///          region.</p>
    func describeReplicationInstances(input: DescribeReplicationInstancesInput, completion: @escaping (SdkResult<DescribeReplicationInstancesOutput, DescribeReplicationInstancesOutputError>) -> Void)
    /// <p>Returns information about the task logs for the specified task.</p>
    func describeReplicationInstanceTaskLogs(input: DescribeReplicationInstanceTaskLogsInput, completion: @escaping (SdkResult<DescribeReplicationInstanceTaskLogsOutput, DescribeReplicationInstanceTaskLogsOutputError>) -> Void)
    /// <p>Returns information about the replication subnet groups.</p>
    func describeReplicationSubnetGroups(input: DescribeReplicationSubnetGroupsInput, completion: @escaping (SdkResult<DescribeReplicationSubnetGroupsOutput, DescribeReplicationSubnetGroupsOutputError>) -> Void)
    /// <p>Returns the task assessment results from Amazon S3. This action always returns the
    ///          latest results.</p>
    func describeReplicationTaskAssessmentResults(input: DescribeReplicationTaskAssessmentResultsInput, completion: @escaping (SdkResult<DescribeReplicationTaskAssessmentResultsOutput, DescribeReplicationTaskAssessmentResultsOutputError>) -> Void)
    ...
    ///             operation. </p>
    ///          </note>
    func describeReplicationTaskAssessmentRuns(input: DescribeReplicationTaskAssessmentRunsInput, completion: @escaping (SdkResult<DescribeReplicationTaskAssessmentRunsOutput, DescribeReplicationTaskAssessmentRunsOutputError>) -> Void)
    ...
    func describeReplicationTaskIndividualAssessments(input: DescribeReplicationTaskIndividualAssessmentsInput, completion: @escaping (SdkResult<DescribeReplicationTaskIndividualAssessmentsOutput, DescribeReplicationTaskIndividualAssessmentsOutputError>) -> Void)
    /// <p>Returns information about replication tasks for your account in the current
    ///          region.</p>
    func describeReplicationTasks(input: DescribeReplicationTasksInput, completion: @escaping (SdkResult<DescribeReplicationTasksOutput, DescribeReplicationTasksOutputError>) -> Void)
    /// <p>Returns information about the schema for the specified endpoint.</p>
    ///
    ///          <p></p>
    func describeSchemas(input: DescribeSchemasInput, completion: @escaping (SdkResult<DescribeSchemasOutput, DescribeSchemasOutputError>) -> Void)
    ...
    func describeTableStatistics(input: DescribeTableStatisticsInput, completion: @escaping (SdkResult<DescribeTableStatisticsOutput, DescribeTableStatisticsOutputError>) -> Void)
    /// <p>Uploads the specified certificate.</p>
    func importCertificate(input: ImportCertificateInput, completion: @escaping (SdkResult<ImportCertificateOutput, ImportCertificateOutputError>) -> Void)
    ...
    func modifyEndpoint(input: ModifyEndpointInput, completion: @escaping (SdkResult<ModifyEndpointOutput, ModifyEndpointOutputError>) -> Void)
    ...
    ///
    ///          <p></p>
    func modifyReplicationInstance(input: ModifyReplicationInstanceInput, completion: @escaping (SdkResult<ModifyReplicationInstanceOutput, ModifyReplicationInstanceOutputError>) -> Void)
    /// <p>Modifies the settings for the specified replication subnet group.</p>
    func modifyReplicationSubnetGroup(input: ModifyReplicationSubnetGroupInput, completion: @escaping (SdkResult<ModifyReplicationSubnetGroupOutput, ModifyReplicationSubnetGroupOutputError>) -> Void)
    ...
    func modifyReplicationTask(input: ModifyReplicationTaskInput, completion: @escaping (SdkResult<ModifyReplicationTaskOutput, ModifyReplicationTaskOutputError>) -> Void)
    ...
    ///          instance.</p>
    func moveReplicationTask(input: MoveReplicationTaskInput, completion: @escaping (SdkResult<MoveReplicationTaskOutput, MoveReplicationTaskOutputError>) -> Void)
    ...
    func rebootReplicationInstance(input: RebootReplicationInstanceInput, completion: @escaping (SdkResult<RebootReplicationInstanceOutput, RebootReplicationInstanceOutputError>) -> Void)
    ...
    func refreshSchemas(input: RefreshSchemasInput, completion: @escaping (SdkResult<RefreshSchemasOutput, RefreshSchemasOutputError>) -> Void)
    /// <p>Reloads the target database table with the source data. </p>
    func reloadTables(input: ReloadTablesInput, completion: @escaping (SdkResult<ReloadTablesOutput, ReloadTablesOutputError>) -> Void)
    ...
    ///          </p>
    func startReplicationTask(input: StartReplicationTaskInput, completion: @escaping (SdkResult<StartReplicationTaskOutput, StartReplicationTaskOutputError>) -> Void)
    /// <p> Starts the replication task assessment for unsupported data types in the source
    ///          database. </p>
    func startReplicationTaskAssessment(input: StartReplicationTaskAssessmentInput, completion: @escaping (SdkResult<StartReplicationTaskAssessmentOutput, StartReplicationTaskAssessmentOutputError>) -> Void)
    ...
    func startReplicationTaskAssessmentRun(input: StartReplicationTaskAssessmentRunInput, completion: @escaping (SdkResult<StartReplicationTaskAssessmentRunOutput, StartReplicationTaskAssessmentRunOutputError>) -> Void)
    /// <p>Stops the replication task.</p>
    func stopReplicationTask(input: StopReplicationTaskInput, completion: @escaping (SdkResult<StopReplicationTaskOutput, StopReplicationTaskOutputError>) -> Void)
    /// <p>Tests the connection between the replication instance and the endpoint.</p>
    func testConnection(input: TestConnectionInput, completion: @escaping (SdkResult<TestConnectionOutput, TestConnectionOutputError>) -> Void)
}
