...
public struct ApplyPendingMaintenanceActionInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<ApplyPendingMaintenanceActionOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<ApplyPendingMaintenanceActionOutput>
