...
public class DatabaseMigrationClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try DatabaseMigrationClientConfiguration(region: unwrappedRegion)
    ...
    public class DatabaseMigrationClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("DatabaseMigrationClient")
