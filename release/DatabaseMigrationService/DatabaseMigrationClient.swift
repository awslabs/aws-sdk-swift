...
public class DatabaseMigrationClient {
    ...
    let config: DatabaseMigrationClientConfiguration
    let serviceName = "Database Migration"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: DatabaseMigrationClientConfiguration) {
    ...
    public class DatabaseMigrationClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "DatabaseMigrationClient")
        }
        ...
        public static func `default`() throws -> DatabaseMigrationClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try DatabaseMigrationClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}

public struct DatabaseMigrationClientLogHandlerFactory: SDKLogHandlerFactory {
