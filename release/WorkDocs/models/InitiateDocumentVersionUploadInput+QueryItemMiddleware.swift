...
public struct InitiateDocumentVersionUploadInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<InitiateDocumentVersionUploadOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<InitiateDocumentVersionUploadOutput>
