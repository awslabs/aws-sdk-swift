...
public class WorkDocsClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try WorkDocsClientConfiguration(region: unwrappedRegion)
    ...
    public class WorkDocsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("WorkDocsClient")
