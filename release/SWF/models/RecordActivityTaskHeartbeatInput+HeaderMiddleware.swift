...
public struct RecordActivityTaskHeartbeatInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<RecordActivityTaskHeartbeatOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<RecordActivityTaskHeartbeatOutput>
