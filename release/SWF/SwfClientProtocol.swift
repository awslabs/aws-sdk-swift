...
public protocol SwfClientProtocol {
    ...
    func countClosedWorkflowExecutions(input: CountClosedWorkflowExecutionsInput, completion: @escaping (SdkResult<CountClosedWorkflowExecutionsOutputResponse, CountClosedWorkflowExecutionsOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func countOpenWorkflowExecutions(input: CountOpenWorkflowExecutionsInput, completion: @escaping (SdkResult<CountOpenWorkflowExecutionsOutputResponse, CountOpenWorkflowExecutionsOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func countPendingActivityTasks(input: CountPendingActivityTasksInput, completion: @escaping (SdkResult<CountPendingActivityTasksOutputResponse, CountPendingActivityTasksOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func countPendingDecisionTasks(input: CountPendingDecisionTasksInput, completion: @escaping (SdkResult<CountPendingDecisionTasksOutputResponse, CountPendingDecisionTasksOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func deprecateActivityType(input: DeprecateActivityTypeInput, completion: @escaping (SdkResult<DeprecateActivityTypeOutputResponse, DeprecateActivityTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func deprecateDomain(input: DeprecateDomainInput, completion: @escaping (SdkResult<DeprecateDomainOutputResponse, DeprecateDomainOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func deprecateWorkflowType(input: DeprecateWorkflowTypeInput, completion: @escaping (SdkResult<DeprecateWorkflowTypeOutputResponse, DeprecateWorkflowTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func describeActivityType(input: DescribeActivityTypeInput, completion: @escaping (SdkResult<DescribeActivityTypeOutputResponse, DescribeActivityTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func describeWorkflowExecution(input: DescribeWorkflowExecutionInput, completion: @escaping (SdkResult<DescribeWorkflowExecutionOutputResponse, DescribeWorkflowExecutionOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func describeWorkflowType(input: DescribeWorkflowTypeInput, completion: @escaping (SdkResult<DescribeWorkflowTypeOutputResponse, DescribeWorkflowTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func getWorkflowExecutionHistory(input: GetWorkflowExecutionHistoryInput, completion: @escaping (SdkResult<GetWorkflowExecutionHistoryOutputResponse, GetWorkflowExecutionHistoryOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func listActivityTypes(input: ListActivityTypesInput, completion: @escaping (SdkResult<ListActivityTypesOutputResponse, ListActivityTypesOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func listClosedWorkflowExecutions(input: ListClosedWorkflowExecutionsInput, completion: @escaping (SdkResult<ListClosedWorkflowExecutionsOutputResponse, ListClosedWorkflowExecutionsOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func listOpenWorkflowExecutions(input: ListOpenWorkflowExecutionsInput, completion: @escaping (SdkResult<ListOpenWorkflowExecutionsOutputResponse, ListOpenWorkflowExecutionsOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func listWorkflowTypes(input: ListWorkflowTypesInput, completion: @escaping (SdkResult<ListWorkflowTypesOutputResponse, ListWorkflowTypesOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func pollForActivityTask(input: PollForActivityTaskInput, completion: @escaping (SdkResult<PollForActivityTaskOutputResponse, PollForActivityTaskOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func pollForDecisionTask(input: PollForDecisionTaskInput, completion: @escaping (SdkResult<PollForDecisionTaskOutputResponse, PollForDecisionTaskOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func recordActivityTaskHeartbeat(input: RecordActivityTaskHeartbeatInput, completion: @escaping (SdkResult<RecordActivityTaskHeartbeatOutputResponse, RecordActivityTaskHeartbeatOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func registerActivityType(input: RegisterActivityTypeInput, completion: @escaping (SdkResult<RegisterActivityTypeOutputResponse, RegisterActivityTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func registerDomain(input: RegisterDomainInput, completion: @escaping (SdkResult<RegisterDomainOutputResponse, RegisterDomainOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func registerWorkflowType(input: RegisterWorkflowTypeInput, completion: @escaping (SdkResult<RegisterWorkflowTypeOutputResponse, RegisterWorkflowTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func requestCancelWorkflowExecution(input: RequestCancelWorkflowExecutionInput, completion: @escaping (SdkResult<RequestCancelWorkflowExecutionOutputResponse, RequestCancelWorkflowExecutionOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func respondActivityTaskCanceled(input: RespondActivityTaskCanceledInput, completion: @escaping (SdkResult<RespondActivityTaskCanceledOutputResponse, RespondActivityTaskCanceledOutputError>) -> Void)
    /// <p>Used by workers to tell the service that the <a>ActivityTask</a> identified
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func respondActivityTaskCompleted(input: RespondActivityTaskCompletedInput, completion: @escaping (SdkResult<RespondActivityTaskCompletedOutputResponse, RespondActivityTaskCompletedOutputError>) -> Void)
    /// <p>Used by workers to tell the service that the <a>ActivityTask</a> identified
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func respondActivityTaskFailed(input: RespondActivityTaskFailedInput, completion: @escaping (SdkResult<RespondActivityTaskFailedOutputResponse, RespondActivityTaskFailedOutputError>) -> Void)
    ...
    func respondDecisionTaskCompleted(input: RespondDecisionTaskCompletedInput, completion: @escaping (SdkResult<RespondDecisionTaskCompletedOutputResponse, RespondDecisionTaskCompletedOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func signalWorkflowExecution(input: SignalWorkflowExecutionInput, completion: @escaping (SdkResult<SignalWorkflowExecutionOutputResponse, SignalWorkflowExecutionOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func startWorkflowExecution(input: StartWorkflowExecutionInput, completion: @escaping (SdkResult<StartWorkflowExecutionOutputResponse, StartWorkflowExecutionOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func terminateWorkflowExecution(input: TerminateWorkflowExecutionInput, completion: @escaping (SdkResult<TerminateWorkflowExecutionOutputResponse, TerminateWorkflowExecutionOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func undeprecateActivityType(input: UndeprecateActivityTypeInput, completion: @escaping (SdkResult<UndeprecateActivityTypeOutputResponse, UndeprecateActivityTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func undeprecateDomain(input: UndeprecateDomainInput, completion: @escaping (SdkResult<UndeprecateDomainOutputResponse, UndeprecateDomainOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func undeprecateWorkflowType(input: UndeprecateWorkflowTypeInput, completion: @escaping (SdkResult<UndeprecateWorkflowTypeOutputResponse, UndeprecateWorkflowTypeOutputError>) -> Void)
