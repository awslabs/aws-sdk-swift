...
public protocol SwfClientProtocol {
    ...
    func countClosedWorkflowExecutions(input: CountClosedWorkflowExecutionsInput, completion: @escaping (SdkResult<CountClosedWorkflowExecutionsOutput, CountClosedWorkflowExecutionsOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func countOpenWorkflowExecutions(input: CountOpenWorkflowExecutionsInput, completion: @escaping (SdkResult<CountOpenWorkflowExecutionsOutput, CountOpenWorkflowExecutionsOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func countPendingActivityTasks(input: CountPendingActivityTasksInput, completion: @escaping (SdkResult<CountPendingActivityTasksOutput, CountPendingActivityTasksOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func countPendingDecisionTasks(input: CountPendingDecisionTasksInput, completion: @escaping (SdkResult<CountPendingDecisionTasksOutput, CountPendingDecisionTasksOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func deprecateActivityType(input: DeprecateActivityTypeInput, completion: @escaping (SdkResult<DeprecateActivityTypeOutput, DeprecateActivityTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func deprecateDomain(input: DeprecateDomainInput, completion: @escaping (SdkResult<DeprecateDomainOutput, DeprecateDomainOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func deprecateWorkflowType(input: DeprecateWorkflowTypeInput, completion: @escaping (SdkResult<DeprecateWorkflowTypeOutput, DeprecateWorkflowTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func describeActivityType(input: DescribeActivityTypeInput, completion: @escaping (SdkResult<DescribeActivityTypeOutput, DescribeActivityTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func describeWorkflowExecution(input: DescribeWorkflowExecutionInput, completion: @escaping (SdkResult<DescribeWorkflowExecutionOutput, DescribeWorkflowExecutionOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func describeWorkflowType(input: DescribeWorkflowTypeInput, completion: @escaping (SdkResult<DescribeWorkflowTypeOutput, DescribeWorkflowTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func getWorkflowExecutionHistory(input: GetWorkflowExecutionHistoryInput, completion: @escaping (SdkResult<GetWorkflowExecutionHistoryOutput, GetWorkflowExecutionHistoryOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func listActivityTypes(input: ListActivityTypesInput, completion: @escaping (SdkResult<ListActivityTypesOutput, ListActivityTypesOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func listClosedWorkflowExecutions(input: ListClosedWorkflowExecutionsInput, completion: @escaping (SdkResult<ListClosedWorkflowExecutionsOutput, ListClosedWorkflowExecutionsOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func listOpenWorkflowExecutions(input: ListOpenWorkflowExecutionsInput, completion: @escaping (SdkResult<ListOpenWorkflowExecutionsOutput, ListOpenWorkflowExecutionsOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func listWorkflowTypes(input: ListWorkflowTypesInput, completion: @escaping (SdkResult<ListWorkflowTypesOutput, ListWorkflowTypesOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func pollForActivityTask(input: PollForActivityTaskInput, completion: @escaping (SdkResult<PollForActivityTaskOutput, PollForActivityTaskOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func pollForDecisionTask(input: PollForDecisionTaskInput, completion: @escaping (SdkResult<PollForDecisionTaskOutput, PollForDecisionTaskOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func recordActivityTaskHeartbeat(input: RecordActivityTaskHeartbeatInput, completion: @escaping (SdkResult<RecordActivityTaskHeartbeatOutput, RecordActivityTaskHeartbeatOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func registerActivityType(input: RegisterActivityTypeInput, completion: @escaping (SdkResult<RegisterActivityTypeOutput, RegisterActivityTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func registerDomain(input: RegisterDomainInput, completion: @escaping (SdkResult<RegisterDomainOutput, RegisterDomainOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func registerWorkflowType(input: RegisterWorkflowTypeInput, completion: @escaping (SdkResult<RegisterWorkflowTypeOutput, RegisterWorkflowTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func requestCancelWorkflowExecution(input: RequestCancelWorkflowExecutionInput, completion: @escaping (SdkResult<RequestCancelWorkflowExecutionOutput, RequestCancelWorkflowExecutionOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func respondActivityTaskCanceled(input: RespondActivityTaskCanceledInput, completion: @escaping (SdkResult<RespondActivityTaskCanceledOutput, RespondActivityTaskCanceledOutputError>) -> Void)
    /// <p>Used by workers to tell the service that the <a>ActivityTask</a> identified
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func respondActivityTaskCompleted(input: RespondActivityTaskCompletedInput, completion: @escaping (SdkResult<RespondActivityTaskCompletedOutput, RespondActivityTaskCompletedOutputError>) -> Void)
    /// <p>Used by workers to tell the service that the <a>ActivityTask</a> identified
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func respondActivityTaskFailed(input: RespondActivityTaskFailedInput, completion: @escaping (SdkResult<RespondActivityTaskFailedOutput, RespondActivityTaskFailedOutputError>) -> Void)
    ...
    func respondDecisionTaskCompleted(input: RespondDecisionTaskCompletedInput, completion: @escaping (SdkResult<RespondDecisionTaskCompletedOutput, RespondDecisionTaskCompletedOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func signalWorkflowExecution(input: SignalWorkflowExecutionInput, completion: @escaping (SdkResult<SignalWorkflowExecutionOutput, SignalWorkflowExecutionOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func startWorkflowExecution(input: StartWorkflowExecutionInput, completion: @escaping (SdkResult<StartWorkflowExecutionOutput, StartWorkflowExecutionOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func terminateWorkflowExecution(input: TerminateWorkflowExecutionInput, completion: @escaping (SdkResult<TerminateWorkflowExecutionOutput, TerminateWorkflowExecutionOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func undeprecateActivityType(input: UndeprecateActivityTypeInput, completion: @escaping (SdkResult<UndeprecateActivityTypeOutput, UndeprecateActivityTypeOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func undeprecateDomain(input: UndeprecateDomainInput, completion: @escaping (SdkResult<UndeprecateDomainOutput, UndeprecateDomainOutputError>) -> Void)
    ...
    ///       For details and example IAM policies, see <a href="https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html">Using IAM to Manage Access to Amazon SWF
    ///         Workflows</a> in the <i>Amazon SWF Developer Guide</i>.</p>
    func undeprecateWorkflowType(input: UndeprecateWorkflowTypeInput, completion: @escaping (SdkResult<UndeprecateWorkflowTypeOutput, UndeprecateWorkflowTypeOutputError>) -> Void)
