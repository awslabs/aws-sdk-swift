...
public struct PutBlockPublicAccessConfigurationInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<PutBlockPublicAccessConfigurationOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<PutBlockPublicAccessConfigurationOutput>
