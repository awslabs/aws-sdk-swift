...
public protocol EmrClientProtocol {
    ...
    ///          </note>
    func addInstanceFleet(input: AddInstanceFleetInput, completion: @escaping (SdkResult<AddInstanceFleetOutput, AddInstanceFleetOutputError>) -> Void)
    /// <p>Adds one or more instance groups to a running cluster.</p>
    func addInstanceGroups(input: AddInstanceGroupsInput, completion: @escaping (SdkResult<AddInstanceGroupsOutput, AddInstanceGroupsOutputError>) -> Void)
    ...
    func addJobFlowSteps(input: AddJobFlowStepsInput, completion: @escaping (SdkResult<AddJobFlowStepsOutput, AddJobFlowStepsOutputError>) -> Void)
    ...
    func cancelSteps(input: CancelStepsInput, completion: @escaping (SdkResult<CancelStepsOutput, CancelStepsOutputError>) -> Void)
    ...
    func createStudioSessionMapping(input: CreateStudioSessionMappingInput, completion: @escaping (SdkResult<CreateStudioSessionMappingOutput, CreateStudioSessionMappingOutputError>) -> Void)
    ...
    func deleteStudioSessionMapping(input: DeleteStudioSessionMappingInput, completion: @escaping (SdkResult<DeleteStudioSessionMappingOutput, DeleteStudioSessionMappingOutputError>) -> Void)
    ...
    func describeJobFlows(input: DescribeJobFlowsInput, completion: @escaping (SdkResult<DescribeJobFlowsOutput, DescribeJobFlowsOutputError>) -> Void)
    /// <p>Provides details of a notebook execution.</p>
    func describeNotebookExecution(input: DescribeNotebookExecutionInput, completion: @escaping (SdkResult<DescribeNotebookExecutionOutput, DescribeNotebookExecutionOutputError>) -> Void)
    /// <p>Provides the details of a security configuration by returning the configuration
    ///          JSON.</p>
    func describeSecurityConfiguration(input: DescribeSecurityConfigurationInput, completion: @escaping (SdkResult<DescribeSecurityConfigurationOutput, DescribeSecurityConfigurationOutputError>) -> Void)
    /// <p>Provides more detail about the cluster step.</p>
    func describeStep(input: DescribeStepInput, completion: @escaping (SdkResult<DescribeStepOutput, DescribeStepOutputError>) -> Void)
    /// <p>Returns details for the specified Amazon EMR Studio including ID, Name, VPC, Studio
    ///          access URL, and so on.</p>
    func describeStudio(input: DescribeStudioInput, completion: @escaping (SdkResult<DescribeStudioOutput, DescribeStudioOutputError>) -> Void)
    ...
    ///             Guide</i>.</p>
    func getBlockPublicAccessConfiguration(input: GetBlockPublicAccessConfigurationInput, completion: @escaping (SdkResult<GetBlockPublicAccessConfigurationOutput, GetBlockPublicAccessConfigurationOutputError>) -> Void)
    /// <p>Fetches the attached managed scaling policy for an Amazon EMR cluster. </p>
    func getManagedScalingPolicy(input: GetManagedScalingPolicyInput, completion: @escaping (SdkResult<GetManagedScalingPolicyOutput, GetManagedScalingPolicyOutputError>) -> Void)
    /// <p>Fetches mapping details for the specified Amazon EMR Studio and identity (user or
    ///          group).</p>
    func getStudioSessionMapping(input: GetStudioSessionMappingInput, completion: @escaping (SdkResult<GetStudioSessionMappingOutput, GetStudioSessionMappingOutputError>) -> Void)
    /// <p>Provides information about the bootstrap actions associated with a cluster.</p>
    func listBootstrapActions(input: ListBootstrapActionsInput, completion: @escaping (SdkResult<ListBootstrapActionsOutput, ListBootstrapActionsOutputError>) -> Void)
    ...
    ///          </note>
    func listInstanceFleets(input: ListInstanceFleetsInput, completion: @escaping (SdkResult<ListInstanceFleetsOutput, ListInstanceFleetsOutputError>) -> Void)
    /// <p>Provides all available details about the instance groups in a cluster.</p>
    func listInstanceGroups(input: ListInstanceGroupsInput, completion: @escaping (SdkResult<ListInstanceGroupsOutput, ListInstanceGroupsOutputError>) -> Void)
    ...
    func listNotebookExecutions(input: ListNotebookExecutionsInput, completion: @escaping (SdkResult<ListNotebookExecutionsOutput, ListNotebookExecutionsOutputError>) -> Void)
    ...
    func listSecurityConfigurations(input: ListSecurityConfigurationsInput, completion: @escaping (SdkResult<ListSecurityConfigurationsOutput, ListSecurityConfigurationsOutputError>) -> Void)
    ...
    func listSteps(input: ListStepsInput, completion: @escaping (SdkResult<ListStepsOutput, ListStepsOutputError>) -> Void)
    ...
    func listStudioSessionMappings(input: ListStudioSessionMappingsInput, completion: @escaping (SdkResult<ListStudioSessionMappingsOutput, ListStudioSessionMappingsOutputError>) -> Void)
    ...
    ///             later, excluding 5.0.x versions.</p>
    ///          </note>
    func modifyInstanceFleet(input: ModifyInstanceFleetInput, completion: @escaping (SdkResult<ModifyInstanceFleetOutput, ModifyInstanceFleetOutputError>) -> Void)
    ...
    func modifyInstanceGroups(input: ModifyInstanceGroupsInput, completion: @escaping (SdkResult<ModifyInstanceGroupsOutput, ModifyInstanceGroupsOutputError>) -> Void)
    ...
    ///          CloudWatch metric.</p>
    func putAutoScalingPolicy(input: PutAutoScalingPolicyInput, completion: @escaping (SdkResult<PutAutoScalingPolicyOutput, PutAutoScalingPolicyOutputError>) -> Void)
    ...
    ///             Public Access for Amazon EMR</a> in the <i>Amazon EMR Management
    ///             Guide</i>.</p>
    func putBlockPublicAccessConfiguration(input: PutBlockPublicAccessConfigurationInput, completion: @escaping (SdkResult<PutBlockPublicAccessConfigurationOutput, PutBlockPublicAccessConfigurationOutputError>) -> Void)
    ...
    func putManagedScalingPolicy(input: PutManagedScalingPolicyInput, completion: @escaping (SdkResult<PutManagedScalingPolicyOutput, PutManagedScalingPolicyOutputError>) -> Void)
    /// <p>Removes an automatic scaling policy from a specified instance group within an EMR
    ///          cluster.</p>
    func removeAutoScalingPolicy(input: RemoveAutoScalingPolicyInput, completion: @escaping (SdkResult<RemoveAutoScalingPolicyOutput, RemoveAutoScalingPolicyOutputError>) -> Void)
    /// <p> Removes a managed scaling policy from a specified EMR cluster. </p>
    func removeManagedScalingPolicy(input: RemoveManagedScalingPolicyInput, completion: @escaping (SdkResult<RemoveManagedScalingPolicyOutput, RemoveManagedScalingPolicyOutputError>) -> Void)
    ...
    ///          </note>
    func runJobFlow(input: RunJobFlowInput, completion: @escaping (SdkResult<RunJobFlowOutput, RunJobFlowOutputError>) -> Void)
    ...
    func setTerminationProtection(input: SetTerminationProtectionInput, completion: @escaping (SdkResult<SetTerminationProtectionOutput, SetTerminationProtectionOutputError>) -> Void)
    ...
    func setVisibleToAllUsers(input: SetVisibleToAllUsersInput, completion: @escaping (SdkResult<SetVisibleToAllUsersOutput, SetVisibleToAllUsersOutputError>) -> Void)
    /// <p>Starts a notebook execution.</p>
    func startNotebookExecution(input: StartNotebookExecutionInput, completion: @escaping (SdkResult<StartNotebookExecutionOutput, StartNotebookExecutionOutputError>) -> Void)
    /// <p>Stops a notebook execution.</p>
    func stopNotebookExecution(input: StopNotebookExecutionInput, completion: @escaping (SdkResult<StopNotebookExecutionOutput, StopNotebookExecutionOutputError>) -> Void)
    ...
    func terminateJobFlows(input: TerminateJobFlowsInput, completion: @escaping (SdkResult<TerminateJobFlowsOutput, TerminateJobFlowsOutputError>) -> Void)
    ...
    ///          Studio.</p>
    func updateStudioSessionMapping(input: UpdateStudioSessionMappingInput, completion: @escaping (SdkResult<UpdateStudioSessionMappingOutput, UpdateStudioSessionMappingOutputError>) -> Void)
}
