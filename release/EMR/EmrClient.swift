...
public class EmrClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try EmrClientConfiguration(region: unwrappedRegion)
    ...
    public class EmrClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("EmrClient")
...
public struct EmrClientLogHandlerFactory: SDKLogHandlerFactory {
