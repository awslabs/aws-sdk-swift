...
extension Route53DomainsClientTypes {
    ...
    public struct BillingRecord: Swift.Equatable {
        ...
        var billDate: ClientRuntime.Date?
        ...
        var invoiceId: Swift.String?
        /// The operation that you were charged for.
        var operation: Route53DomainsClientTypes.OperationType?
        /// The price that you were charged for the operation, in US dollars. Example value: 12.0
        var price: Swift.Double
...
public struct CheckDomainAvailabilityOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var availability: Route53DomainsClientTypes.DomainAvailability?
...
public struct CheckDomainTransferabilityOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var transferability: Route53DomainsClientTypes.DomainTransferability?
...
extension Route53DomainsClientTypes {
    ...
    public struct ContactDetail: Swift.Equatable {
        ...
        var addressLine1: Swift.String?
        /// Second line of contact's address, if any.
        var addressLine2: Swift.String?
        ...
        var contactType: Route53DomainsClientTypes.ContactType?
        /// Code for the country of the contact's address.
        var countryCode: Route53DomainsClientTypes.CountryCode?
        /// Email address of the contact.
        var email: Swift.String?
        /// A list of name-value pairs for parameters required by certain top-level domains.
        var extraParams: [Route53DomainsClientTypes.ExtraParam]?
...
extension Route53DomainsClientTypes {
    ...
    public struct DomainPrice: Swift.Equatable {
        ...
        var changeOwnershipPrice: Route53DomainsClientTypes.PriceWithCurrency?
        /// The name of the TLD for which the prices apply.
        var name: Swift.String?
        /// The price for domain registration with Route 53.
        var registrationPrice: Route53DomainsClientTypes.PriceWithCurrency?
        /// The price for renewing domain registration with Route 53.
        var renewalPrice: Route53DomainsClientTypes.PriceWithCurrency?
        /// The price for restoring the domain with Route 53.
        var restorationPrice: Route53DomainsClientTypes.PriceWithCurrency?
        /// The price for transferring the domain registration to Route 53.
        var transferPrice: Route53DomainsClientTypes.PriceWithCurrency?
...
extension Route53DomainsClientTypes {
    ...
    public struct DomainSummary: Swift.Equatable {
        ...
        var autoRenew: Swift.Bool?
        /// The name of the domain that the summary information applies to.
        /// This member is required.
        var domainName: Swift.String?
        /// Expiration date of the domain in Unix time format and Coordinated Universal Time (UTC).
        var expiry: ClientRuntime.Date?
        /// Indicates whether a domain is locked from unauthorized transfer to another party.
        var transferLock: Swift.Bool?
...
extension Route53DomainsClientTypes {
    ...
    public struct DomainTransferability: Swift.Equatable {
        ...
        var transferable: Route53DomainsClientTypes.Transferable?
...
extension Route53DomainsClientTypes {
    ...
    public struct ExtraParam: Swift.Equatable {
        ...
        /// This member is required.
        var name: Route53DomainsClientTypes.ExtraParamName?
...
extension Route53DomainsClientTypes {
    ...
    public struct FilterCondition: Swift.Equatable {
        ...
        /// This member is required.
        var `operator`: Route53DomainsClientTypes.Operator?
        /// Name of the field which should be used for filtering the list of domains.
        /// This member is required.
        var name: Route53DomainsClientTypes.ListDomainsAttributeName?
...
public struct GetContactReachabilityStatusOutputResponse: Swift.Equatable {
    ...
    var status: Route53DomainsClientTypes.ReachabilityStatus?
...
public struct GetDomainDetailOutputResponse: Swift.Equatable {
    ...
    var abuseContactEmail: Swift.String?
    /// Phone number for reporting abuse.
    var abuseContactPhone: Swift.String?
    /// Provides details about the domain administrative contact.
    /// This member is required.
    var adminContact: Route53DomainsClientTypes.ContactDetail?
    /// Specifies whether contact information is concealed from WHOIS queries. If the value is true, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If the value is false, WHOIS queries return the information that you entered for the admin contact.
    var adminPrivacy: Swift.Bool?
    /// Specifies whether the domain registration is set to renew automatically.
    var autoRenew: Swift.Bool?
    /// The date when the domain was created as found in the response to a WHOIS query. The date and time is in Unix time format and Coordinated Universal time (UTC).
    var creationDate: ClientRuntime.Date?
    /// Deprecated.
    var dnsSec: Swift.String?
    /// The name of a domain.
    /// This member is required.
    var domainName: Swift.String?
    /// The date when the registration for the domain is set to expire. The date and time is in Unix time format and Coordinated Universal time (UTC).
    var expirationDate: ClientRuntime.Date?
    /// The name of the domain.
    /// This member is required.
    var nameservers: [Route53DomainsClientTypes.Nameserver]?
    /// Provides details about the domain registrant.
    /// This member is required.
    var registrantContact: Route53DomainsClientTypes.ContactDetail?
    /// Specifies whether contact information is concealed from WHOIS queries. If the value is true, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If the value is false, WHOIS queries return the information that you entered for the registrant contact (domain owner).
    var registrantPrivacy: Swift.Bool?
    ...
    var registrarName: Swift.String?
    /// Web address of the registrar.
    var registrarUrl: Swift.String?
    /// Reserved for future use.
    var registryDomainId: Swift.String?
    /// Reseller of the domain. Domains registered or transferred using Route 53 domains will have "Amazon" as the reseller.
    var reseller: Swift.String?
    ...
    var statusList: [Swift.String]?
    /// Provides details about the domain technical contact.
    /// This member is required.
    var techContact: Route53DomainsClientTypes.ContactDetail?
    /// Specifies whether contact information is concealed from WHOIS queries. If the value is true, WHOIS ("who is") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If the value is false, WHOIS queries return the information that you entered for the technical contact.
    var techPrivacy: Swift.Bool?
    /// The last updated date of the domain as found in the response to a WHOIS query. The date and time is in Unix time format and Coordinated Universal time (UTC).
    var updatedDate: ClientRuntime.Date?
    /// The fully qualified name of the WHOIS server that can answer the WHOIS query for the domain.
    var whoIsServer: Swift.String?
...
public struct GetDomainSuggestionsOutputResponse: Swift.Equatable {
    ...
    var suggestionsList: [Route53DomainsClientTypes.DomainSuggestion]?
...
public struct GetOperationDetailOutputResponse: Swift.Equatable {
    ...
    var status: Route53DomainsClientTypes.OperationStatus?
    /// The date when the request was submitted.
    var submittedDate: ClientRuntime.Date?
    /// The type of operation that was requested.
    var type: Route53DomainsClientTypes.OperationType?
...
public struct ListDomainsInput: Swift.Equatable {
    ...
    var filterConditions: [Route53DomainsClientTypes.FilterCondition]?
    ...
    var sortCondition: Route53DomainsClientTypes.SortCondition?
...
public struct ListDomainsOutputResponse: Swift.Equatable {
    /// A list of domains.
    /// This member is required.
    var domains: [Route53DomainsClientTypes.DomainSummary]?
    /// If there are more domains than you specified for MaxItems in the request, submit another request and include the value of NextPageMarker in the value of Marker.
    var nextPageMarker: Swift.String?
...
public struct ListOperationsInput: Swift.Equatable {
    ...
    var submittedSince: ClientRuntime.Date?
...
public struct ListOperationsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var operations: [Route53DomainsClientTypes.OperationSummary]?
...
public struct ListPricesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var prices: [Route53DomainsClientTypes.DomainPrice]?
...
public struct ListTagsForDomainOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var tagList: [Route53DomainsClientTypes.Tag]?
...
public struct RegisterDomainInput: Swift.Equatable {
    ...
    var privacyProtectAdminContact: Swift.Bool?
    ...
    var privacyProtectRegistrantContact: Swift.Bool?
    ...
    var privacyProtectTechContact: Swift.Bool?
    /// Provides detailed contact information. For information about the values that you specify for each element, see [ContactDetail](https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_ContactDetail.html).
    /// This member is required.
    var registrantContact: Route53DomainsClientTypes.ContactDetail?
    /// Provides detailed contact information. For information about the values that you specify for each element, see [ContactDetail](https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_ContactDetail.html).
...
public struct RenewDomainInput: Swift.Equatable {
    ...
    /// This member is required.
    var currentExpiryYear: Swift.Int
...
public struct ResendContactReachabilityEmailOutputResponse: Swift.Equatable {
    ...
    var isAlreadyVerified: Swift.Bool?
...
extension Route53DomainsClientTypes {
    ...
    public struct SortCondition: Swift.Equatable {
        ...
        /// This member is required.
        var sortOrder: Route53DomainsClientTypes.SortOrder?
...
public struct UpdateTagsForDomainInput: Swift.Equatable {
    ...
    var tagsToUpdate: [Route53DomainsClientTypes.Tag]?
...
public struct ViewBillingOutputResponse: Swift.Equatable {
    ...
    var billingRecords: [Route53DomainsClientTypes.BillingRecord]?
