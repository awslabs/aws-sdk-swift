...
extension CodestarNotificationsClient: CodestarNotificationsClientProtocol {
    ...
    public func createNotificationRule(input: CreateNotificationRuleInput, completion: @escaping (ClientRuntime.SdkResult<CreateNotificationRuleOutputResponse, CreateNotificationRuleOutputError>) -> Void)
    {
        ...
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<CreateNotificationRuleOutputResponse>, ClientRuntime.SdkError<CreateNotificationRuleOutputError>> in
