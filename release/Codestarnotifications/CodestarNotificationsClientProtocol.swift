...
public protocol CodestarNotificationsClientProtocol {
    ...
    ///             them.</p>
    func createNotificationRule(input: CreateNotificationRuleInput, completion: @escaping (SdkResult<CreateNotificationRuleOutput, CreateNotificationRuleOutputError>) -> Void)
    /// <p>Deletes a notification rule for a resource.</p>
    func deleteNotificationRule(input: DeleteNotificationRuleInput, completion: @escaping (SdkResult<DeleteNotificationRuleOutput, DeleteNotificationRuleOutputError>) -> Void)
    /// <p>Deletes a specified target for notifications.</p>
    func deleteTarget(input: DeleteTargetInput, completion: @escaping (SdkResult<DeleteTargetOutput, DeleteTargetOutputError>) -> Void)
    /// <p>Returns information about a specified notification rule.</p>
    func describeNotificationRule(input: DescribeNotificationRuleInput, completion: @escaping (SdkResult<DescribeNotificationRuleOutput, DescribeNotificationRuleOutputError>) -> Void)
    /// <p>Returns information about the event types available for configuring notifications.</p>
    func listEventTypes(input: ListEventTypesInput, completion: @escaping (SdkResult<ListEventTypesOutput, ListEventTypesOutputError>) -> Void)
    /// <p>Returns a list of the notification rules for an AWS account.</p>
    func listNotificationRules(input: ListNotificationRulesInput, completion: @escaping (SdkResult<ListNotificationRulesOutput, ListNotificationRulesOutputError>) -> Void)
    ...
    func listTargets(input: ListTargetsInput, completion: @escaping (SdkResult<ListTargetsOutput, ListTargetsOutputError>) -> Void)
    ...
    ///          </note>
    func updateNotificationRule(input: UpdateNotificationRuleInput, completion: @escaping (SdkResult<UpdateNotificationRuleOutput, UpdateNotificationRuleOutputError>) -> Void)
}
