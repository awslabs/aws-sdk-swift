...
public class BatchClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try BatchClientConfiguration(region: unwrappedRegion)
    ...
    public class BatchClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("BatchClient")
