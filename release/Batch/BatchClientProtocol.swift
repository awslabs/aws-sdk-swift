...
public protocol BatchClientProtocol {
    ...
    ///             </ol>
    ///          </note>
    func createComputeEnvironment(input: CreateComputeEnvironmentInput, completion: @escaping (SdkResult<CreateComputeEnvironmentOutputResponse, CreateComputeEnvironmentOutputError>) -> Void)
    ...
    ///    environment.</p>
    func createJobQueue(input: CreateJobQueueInput, completion: @escaping (SdkResult<CreateJobQueueOutputResponse, CreateJobQueueOutputError>) -> Void)
    ...
    func deleteComputeEnvironment(input: DeleteComputeEnvironmentInput, completion: @escaping (SdkResult<DeleteComputeEnvironmentOutputResponse, DeleteComputeEnvironmentOutputError>) -> Void)
    ...
    func deleteJobQueue(input: DeleteJobQueueInput, completion: @escaping (SdkResult<DeleteJobQueueOutputResponse, DeleteJobQueueOutputError>) -> Void)
    /// <p>Deregisters an AWS Batch job definition. Job definitions are permanently deleted after 180 days.</p>
    func deregisterJobDefinition(input: DeregisterJobDefinitionInput, completion: @escaping (SdkResult<DeregisterJobDefinitionOutputResponse, DeregisterJobDefinitionOutputError>) -> Void)
    ...
    ///    into.</p>
    func describeComputeEnvironments(input: DescribeComputeEnvironmentsInput, completion: @escaping (SdkResult<DescribeComputeEnvironmentsOutputResponse, DescribeComputeEnvironmentsOutputError>) -> Void)
    ...
    func describeJobDefinitions(input: DescribeJobDefinitionsInput, completion: @escaping (SdkResult<DescribeJobDefinitionsOutputResponse, DescribeJobDefinitionsOutputError>) -> Void)
    /// <p>Describes one or more of your job queues.</p>
    func describeJobQueues(input: DescribeJobQueuesInput, completion: @escaping (SdkResult<DescribeJobQueuesOutputResponse, DescribeJobQueuesOutputError>) -> Void)
    ...
    func registerJobDefinition(input: RegisterJobDefinitionInput, completion: @escaping (SdkResult<RegisterJobDefinitionOutputResponse, RegisterJobDefinitionOutputError>) -> Void)
    ...
    ///          </important>
    func submitJob(input: SubmitJobInput, completion: @escaping (SdkResult<SubmitJobOutputResponse, SubmitJobOutputError>) -> Void)
    ...
    func terminateJob(input: TerminateJobInput, completion: @escaping (SdkResult<TerminateJobOutputResponse, TerminateJobOutputError>) -> Void)
    ...
    func updateComputeEnvironment(input: UpdateComputeEnvironmentInput, completion: @escaping (SdkResult<UpdateComputeEnvironmentOutputResponse, UpdateComputeEnvironmentOutputError>) -> Void)
    /// <p>Updates a job queue.</p>
    func updateJobQueue(input: UpdateJobQueueInput, completion: @escaping (SdkResult<UpdateJobQueueOutputResponse, UpdateJobQueueOutputError>) -> Void)
}
