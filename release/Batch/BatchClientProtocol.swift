...
public protocol BatchClientProtocol {
    ...
    ///             </ol>
    ///          </note>
    func createComputeEnvironment(input: CreateComputeEnvironmentInput, completion: @escaping (SdkResult<CreateComputeEnvironmentOutput, CreateComputeEnvironmentOutputError>) -> Void)
    ...
    ///    environment.</p>
    func createJobQueue(input: CreateJobQueueInput, completion: @escaping (SdkResult<CreateJobQueueOutput, CreateJobQueueOutputError>) -> Void)
    ...
    func deleteComputeEnvironment(input: DeleteComputeEnvironmentInput, completion: @escaping (SdkResult<DeleteComputeEnvironmentOutput, DeleteComputeEnvironmentOutputError>) -> Void)
    ...
    func deleteJobQueue(input: DeleteJobQueueInput, completion: @escaping (SdkResult<DeleteJobQueueOutput, DeleteJobQueueOutputError>) -> Void)
    /// <p>Deregisters an AWS Batch job definition. Job definitions are permanently deleted after 180 days.</p>
    func deregisterJobDefinition(input: DeregisterJobDefinitionInput, completion: @escaping (SdkResult<DeregisterJobDefinitionOutput, DeregisterJobDefinitionOutputError>) -> Void)
    ...
    ///    into.</p>
    func describeComputeEnvironments(input: DescribeComputeEnvironmentsInput, completion: @escaping (SdkResult<DescribeComputeEnvironmentsOutput, DescribeComputeEnvironmentsOutputError>) -> Void)
    ...
    func describeJobDefinitions(input: DescribeJobDefinitionsInput, completion: @escaping (SdkResult<DescribeJobDefinitionsOutput, DescribeJobDefinitionsOutputError>) -> Void)
    /// <p>Describes one or more of your job queues.</p>
    func describeJobQueues(input: DescribeJobQueuesInput, completion: @escaping (SdkResult<DescribeJobQueuesOutput, DescribeJobQueuesOutputError>) -> Void)
    ...
    func registerJobDefinition(input: RegisterJobDefinitionInput, completion: @escaping (SdkResult<RegisterJobDefinitionOutput, RegisterJobDefinitionOutputError>) -> Void)
    ...
    ///          </important>
    func submitJob(input: SubmitJobInput, completion: @escaping (SdkResult<SubmitJobOutput, SubmitJobOutputError>) -> Void)
    ...
    func terminateJob(input: TerminateJobInput, completion: @escaping (SdkResult<TerminateJobOutput, TerminateJobOutputError>) -> Void)
    ...
    func updateComputeEnvironment(input: UpdateComputeEnvironmentInput, completion: @escaping (SdkResult<UpdateComputeEnvironmentOutput, UpdateComputeEnvironmentOutputError>) -> Void)
    /// <p>Updates a job queue.</p>
    func updateJobQueue(input: UpdateJobQueueInput, completion: @escaping (SdkResult<UpdateJobQueueOutput, UpdateJobQueueOutputError>) -> Void)
}
