...
public protocol CodeartifactClientProtocol {
    ...
    ///     </p>
    func getPackageVersionAsset(input: GetPackageVersionAssetInput, completion: @escaping (SdkResult<GetPackageVersionAssetOutputResponse, GetPackageVersionAssetOutputError>) -> Void)
    /// <p>
