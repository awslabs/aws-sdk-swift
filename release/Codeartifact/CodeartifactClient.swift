...
public class CodeartifactClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try CodeartifactClientConfiguration(region: unwrappedRegion)
    ...
    public class CodeartifactClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("CodeartifactClient")
