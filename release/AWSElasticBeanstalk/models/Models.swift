...
public struct AbortEnvironmentUpdateInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AbortEnvironmentUpdateInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<AbortEnvironmentUpdateInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<AbortEnvironmentUpdateOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<AbortEnvironmentUpdateInput>
    public typealias MOutput = ClientRuntime.OperationOutput<AbortEnvironmentUpdateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AbortEnvironmentUpdateOutputError>
}

extension AbortEnvironmentUpdateInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AbortEnvironmentUpdateInput(environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)))"}
}

extension AbortEnvironmentUpdateInput: Swift.Encodable, ClientRuntime.Reflection {
...
public struct AbortEnvironmentUpdateInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AbortEnvironmentUpdateInputHeadersMiddleware"
...
public struct AbortEnvironmentUpdateInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AbortEnvironmentUpdateInputQueryItemMiddleware"
...
public struct AbortEnvironmentUpdateInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AbortEnvironmentUpdateInputURLHostMiddleware"
    ...
    public typealias MInput = AbortEnvironmentUpdateInput
    public typealias MOutput = ClientRuntime.OperationOutput<AbortEnvironmentUpdateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AbortEnvironmentUpdateOutputError>
}

public struct AbortEnvironmentUpdateInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AbortEnvironmentUpdateInputURLPathMiddleware"
...
extension AbortEnvironmentUpdateOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct AbortEnvironmentUpdateOutputResponseBody: Swift.Equatable {
}

extension AbortEnvironmentUpdateOutputResponseBody: Swift.Decodable {
...
extension ElasticBeanstalkClientTypes.ApplicationDescription: Swift.Codable, ClientRuntime.Reflection {
...
extension ElasticBeanstalkClientTypes.ApplicationDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ApplicationDescription(applicationArn: \(Swift.String(describing: applicationArn)), applicationName: \(Swift.String(describing: applicationName)), configurationTemplates: \(Swift.String(describing: configurationTemplates)), dateCreated: \(Swift.String(describing: dateCreated)), dateUpdated: \(Swift.String(describing: dateUpdated)), description: \(Swift.String(describing: description)), resourceLifecycleConfig: \(Swift.String(describing: resourceLifecycleConfig)), versions: \(Swift.String(describing: versions)))"}
}
...
extension ElasticBeanstalkClientTypes.ApplicationMetrics: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.ApplicationMetrics: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ApplicationMetrics(duration: \(Swift.String(describing: duration)), latency: \(Swift.String(describing: latency)), requestCount: \(Swift.String(describing: requestCount)), statusCodes: \(Swift.String(describing: statusCodes)))"}
}
...
extension ElasticBeanstalkClientTypes.ApplicationResourceLifecycleConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.ApplicationResourceLifecycleConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ApplicationResourceLifecycleConfig(serviceRole: \(Swift.String(describing: serviceRole)), versionLifecycleConfig: \(Swift.String(describing: versionLifecycleConfig)))"}
}
...
extension ElasticBeanstalkClientTypes.ApplicationVersionDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case applicationName = "ApplicationName"
...
extension ElasticBeanstalkClientTypes.ApplicationVersionDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ApplicationVersionDescription(applicationName: \(Swift.String(describing: applicationName)), applicationVersionArn: \(Swift.String(describing: applicationVersionArn)), buildArn: \(Swift.String(describing: buildArn)), dateCreated: \(Swift.String(describing: dateCreated)), dateUpdated: \(Swift.String(describing: dateUpdated)), description: \(Swift.String(describing: description)), sourceBuildInformation: \(Swift.String(describing: sourceBuildInformation)), sourceBundle: \(Swift.String(describing: sourceBundle)), status: \(Swift.String(describing: status)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
extension ElasticBeanstalkClientTypes.ApplicationVersionLifecycleConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.ApplicationVersionLifecycleConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ApplicationVersionLifecycleConfig(maxAgeRule: \(Swift.String(describing: maxAgeRule)), maxCountRule: \(Swift.String(describing: maxCountRule)))"}
}
...
public struct ApplyEnvironmentManagedActionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ApplyEnvironmentManagedActionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ApplyEnvironmentManagedActionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ApplyEnvironmentManagedActionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ApplyEnvironmentManagedActionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ApplyEnvironmentManagedActionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ApplyEnvironmentManagedActionOutputError>
}

extension ApplyEnvironmentManagedActionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ApplyEnvironmentManagedActionInput(actionId: \(Swift.String(describing: actionId)), environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)))"}
}

extension ApplyEnvironmentManagedActionInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct ApplyEnvironmentManagedActionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ApplyEnvironmentManagedActionInputHeadersMiddleware"
...
public struct ApplyEnvironmentManagedActionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ApplyEnvironmentManagedActionInputQueryItemMiddleware"
...
public struct ApplyEnvironmentManagedActionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ApplyEnvironmentManagedActionInputURLHostMiddleware"
    ...
    public typealias MInput = ApplyEnvironmentManagedActionInput
    public typealias MOutput = ClientRuntime.OperationOutput<ApplyEnvironmentManagedActionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ApplyEnvironmentManagedActionOutputError>
}

public struct ApplyEnvironmentManagedActionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ApplyEnvironmentManagedActionInputURLPathMiddleware"
...
extension ApplyEnvironmentManagedActionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ApplyEnvironmentManagedActionOutputResponse(actionDescription: \(Swift.String(describing: actionDescription)), actionId: \(Swift.String(describing: actionId)), actionType: \(Swift.String(describing: actionType)), status: \(Swift.String(describing: status)))"}
}
...
struct ApplyEnvironmentManagedActionOutputResponseBody: Swift.Equatable {
    ...
    public let actionDescription: Swift.String?
    public let actionType: ElasticBeanstalkClientTypes.ActionType?
...
public struct AssociateEnvironmentOperationsRoleInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateEnvironmentOperationsRoleInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<AssociateEnvironmentOperationsRoleInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<AssociateEnvironmentOperationsRoleOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<AssociateEnvironmentOperationsRoleInput>
    public typealias MOutput = ClientRuntime.OperationOutput<AssociateEnvironmentOperationsRoleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AssociateEnvironmentOperationsRoleOutputError>
}

extension AssociateEnvironmentOperationsRoleInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssociateEnvironmentOperationsRoleInput(environmentName: \(Swift.String(describing: environmentName)), operationsRole: \(Swift.String(describing: operationsRole)))"}
}

extension AssociateEnvironmentOperationsRoleInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentName = environmentName {
            try container.encode(environmentName, forKey: ClientRuntime.Key("EnvironmentName"))
...
public struct AssociateEnvironmentOperationsRoleInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateEnvironmentOperationsRoleInputHeadersMiddleware"
...
public struct AssociateEnvironmentOperationsRoleInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateEnvironmentOperationsRoleInputQueryItemMiddleware"
...
public struct AssociateEnvironmentOperationsRoleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateEnvironmentOperationsRoleInputURLHostMiddleware"
    ...
    public typealias MInput = AssociateEnvironmentOperationsRoleInput
    public typealias MOutput = ClientRuntime.OperationOutput<AssociateEnvironmentOperationsRoleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AssociateEnvironmentOperationsRoleOutputError>
}

public struct AssociateEnvironmentOperationsRoleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateEnvironmentOperationsRoleInputURLPathMiddleware"
...
extension AssociateEnvironmentOperationsRoleOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct AssociateEnvironmentOperationsRoleOutputResponseBody: Swift.Equatable {
}

extension AssociateEnvironmentOperationsRoleOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension ElasticBeanstalkClientTypes.AutoScalingGroup: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
    }
...
extension ElasticBeanstalkClientTypes.AutoScalingGroup: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension ElasticBeanstalkClientTypes.BuildConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.BuildConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BuildConfiguration(artifactName: \(Swift.String(describing: artifactName)), codeBuildServiceRole: \(Swift.String(describing: codeBuildServiceRole)), computeType: \(Swift.String(describing: computeType)), image: \(Swift.String(describing: image)), timeoutInMinutes: \(Swift.String(describing: timeoutInMinutes)))"}
}
...
extension ElasticBeanstalkClientTypes.Builder: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case aRN = "ARN"
    }
...
extension ElasticBeanstalkClientTypes.Builder: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Builder(aRN: \(Swift.String(describing: aRN)))"}
}
...
extension ElasticBeanstalkClientTypes.CPUUtilization: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case iOWait = "IOWait"
        case iRQ = "IRQ"
        case idle = "Idle"
...
extension ElasticBeanstalkClientTypes.CPUUtilization: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CPUUtilization(iOWait: \(Swift.String(describing: iOWait)), iRQ: \(Swift.String(describing: iRQ)), idle: \(Swift.String(describing: idle)), nice: \(Swift.String(describing: nice)), privileged: \(Swift.String(describing: privileged)), softIRQ: \(Swift.String(describing: softIRQ)), system: \(Swift.String(describing: system)), user: \(Swift.String(describing: user)))"}
}
...
public struct CheckDNSAvailabilityInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CheckDNSAvailabilityInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CheckDNSAvailabilityInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CheckDNSAvailabilityOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CheckDNSAvailabilityInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CheckDNSAvailabilityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CheckDNSAvailabilityOutputError>
}

extension CheckDNSAvailabilityInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CheckDNSAvailabilityInput(cNAMEPrefix: \(Swift.String(describing: cNAMEPrefix)))"}
}

extension CheckDNSAvailabilityInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct CheckDNSAvailabilityInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CheckDNSAvailabilityInputHeadersMiddleware"
...
public struct CheckDNSAvailabilityInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CheckDNSAvailabilityInputQueryItemMiddleware"
...
public struct CheckDNSAvailabilityInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CheckDNSAvailabilityInputURLHostMiddleware"
    ...
    public typealias MInput = CheckDNSAvailabilityInput
    public typealias MOutput = ClientRuntime.OperationOutput<CheckDNSAvailabilityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CheckDNSAvailabilityOutputError>
}

public struct CheckDNSAvailabilityInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CheckDNSAvailabilityInputURLPathMiddleware"
...
extension CheckDNSAvailabilityOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CheckDNSAvailabilityOutputResponse(available: \(Swift.String(describing: available)), fullyQualifiedCNAME: \(Swift.String(describing: fullyQualifiedCNAME)))"}
}
...
struct CheckDNSAvailabilityOutputResponseBody: Swift.Equatable {
    ...
    public let fullyQualifiedCNAME: Swift.String?
}
...
extension CodeBuildNotInServiceRegionException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CodeBuildNotInServiceRegionException(message: \(Swift.String(describing: message)))"}
}
...
public struct ComposeEnvironmentsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ComposeEnvironmentsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ComposeEnvironmentsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ComposeEnvironmentsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ComposeEnvironmentsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ComposeEnvironmentsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ComposeEnvironmentsOutputError>
}

extension ComposeEnvironmentsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ComposeEnvironmentsInput(applicationName: \(Swift.String(describing: applicationName)), groupName: \(Swift.String(describing: groupName)), versionLabels: \(Swift.String(describing: versionLabels)))"}
}

extension ComposeEnvironmentsInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct ComposeEnvironmentsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ComposeEnvironmentsInputHeadersMiddleware"
...
public struct ComposeEnvironmentsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ComposeEnvironmentsInputQueryItemMiddleware"
...
public struct ComposeEnvironmentsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ComposeEnvironmentsInputURLHostMiddleware"
    ...
    public typealias MInput = ComposeEnvironmentsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ComposeEnvironmentsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ComposeEnvironmentsOutputError>
}

public struct ComposeEnvironmentsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ComposeEnvironmentsInputURLPathMiddleware"
...
extension ComposeEnvironmentsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ComposeEnvironmentsOutputResponse(environments: \(Swift.String(describing: environments)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ComposeEnvironmentsOutputResponseBody: Swift.Equatable {
    public let environments: [ElasticBeanstalkClientTypes.EnvironmentDescription]?
...
extension ElasticBeanstalkClientTypes.ConfigurationOptionDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.ConfigurationOptionDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConfigurationOptionDescription(changeSeverity: \(Swift.String(describing: changeSeverity)), defaultValue: \(Swift.String(describing: defaultValue)), maxLength: \(Swift.String(describing: maxLength)), maxValue: \(Swift.String(describing: maxValue)), minValue: \(Swift.String(describing: minValue)), name: \(Swift.String(describing: name)), namespace: \(Swift.String(describing: namespace)), regex: \(Swift.String(describing: regex)), userDefined: \(Swift.String(describing: userDefined)), valueOptions: \(Swift.String(describing: valueOptions)), valueType: \(Swift.String(describing: valueType)))"}
}
...
extension ElasticBeanstalkClientTypes.ConfigurationOptionSetting: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case namespace = "Namespace"
...
extension ElasticBeanstalkClientTypes.ConfigurationOptionSetting: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConfigurationOptionSetting(namespace: \(Swift.String(describing: namespace)), optionName: \(Swift.String(describing: optionName)), resourceName: \(Swift.String(describing: resourceName)), value: \(Swift.String(describing: value)))"}
}

extension ElasticBeanstalkClientTypes {
    /// A specification identifying an individual configuration option along with its current
    ///       value. For a list of possible namespaces and option values, see <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/command-options.html">Option Values in the
...
extension ElasticBeanstalkClientTypes.ConfigurationSettingsDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case applicationName = "ApplicationName"
        case dateCreated = "DateCreated"
        case dateUpdated = "DateUpdated"
...
extension ElasticBeanstalkClientTypes.ConfigurationSettingsDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConfigurationSettingsDescription(applicationName: \(Swift.String(describing: applicationName)), dateCreated: \(Swift.String(describing: dateCreated)), dateUpdated: \(Swift.String(describing: dateUpdated)), deploymentStatus: \(Swift.String(describing: deploymentStatus)), description: \(Swift.String(describing: description)), environmentName: \(Swift.String(describing: environmentName)), optionSettings: \(Swift.String(describing: optionSettings)), platformArn: \(Swift.String(describing: platformArn)), solutionStackName: \(Swift.String(describing: solutionStackName)), templateName: \(Swift.String(describing: templateName)))"}
}
...
extension CreateApplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateApplicationInput(applicationName: \(Swift.String(describing: applicationName)), description: \(Swift.String(describing: description)), resourceLifecycleConfig: \(Swift.String(describing: resourceLifecycleConfig)), tags: \(Swift.String(describing: tags)))"}
}
...
struct CreateApplicationOutputResponseBody: Swift.Equatable {
    public let application: ElasticBeanstalkClientTypes.ApplicationDescription?
}
...
extension CreateApplicationVersionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateApplicationVersionInput(applicationName: \(Swift.String(describing: applicationName)), autoCreateApplication: \(Swift.String(describing: autoCreateApplication)), buildConfiguration: \(Swift.String(describing: buildConfiguration)), description: \(Swift.String(describing: description)), process: \(Swift.String(describing: process)), sourceBuildInformation: \(Swift.String(describing: sourceBuildInformation)), sourceBundle: \(Swift.String(describing: sourceBundle)), tags: \(Swift.String(describing: tags)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
extension CreateApplicationVersionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateApplicationVersionOutputResponse(applicationVersion: \(Swift.String(describing: applicationVersion)))"}
}
...
struct CreateApplicationVersionOutputResponseBody: Swift.Equatable {
    public let applicationVersion: ElasticBeanstalkClientTypes.ApplicationVersionDescription?
}
...
public struct CreateConfigurationTemplateInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConfigurationTemplateInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateConfigurationTemplateInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateConfigurationTemplateOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateConfigurationTemplateInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateConfigurationTemplateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateConfigurationTemplateOutputError>
}

extension CreateConfigurationTemplateInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateConfigurationTemplateInput(applicationName: \(Swift.String(describing: applicationName)), description: \(Swift.String(describing: description)), environmentId: \(Swift.String(describing: environmentId)), optionSettings: \(Swift.String(describing: optionSettings)), platformArn: \(Swift.String(describing: platformArn)), solutionStackName: \(Swift.String(describing: solutionStackName)), sourceConfiguration: \(Swift.String(describing: sourceConfiguration)), tags: \(Swift.String(describing: tags)), templateName: \(Swift.String(describing: templateName)))"}
}

extension CreateConfigurationTemplateInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct CreateConfigurationTemplateInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConfigurationTemplateInputHeadersMiddleware"
...
public struct CreateConfigurationTemplateInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConfigurationTemplateInputQueryItemMiddleware"
...
public struct CreateConfigurationTemplateInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConfigurationTemplateInputURLHostMiddleware"
    ...
    public typealias MInput = CreateConfigurationTemplateInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateConfigurationTemplateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateConfigurationTemplateOutputError>
}

public struct CreateConfigurationTemplateInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConfigurationTemplateInputURLPathMiddleware"
...
public struct CreateConfigurationTemplateInput: Swift.Equatable {
    ...
    ///       template. For a complete list of Elastic Beanstalk configuration options, see <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/command-options.html">Option Values in the
    ///         AWS Elastic Beanstalk Developer Guide.
    public var optionSettings: [ElasticBeanstalkClientTypes.ConfigurationOptionSetting]?
    /// The Amazon Resource Name (ARN) of the custom platform. For more information, see <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/custom-platforms.html"> Custom
    ...
    ///       values. For more information, see <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/concepts.platforms.html">Supported Platforms in the
    ///         AWS Elastic Beanstalk Developer Guide.
...
extension CreateConfigurationTemplateOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateConfigurationTemplateOutputResponse(applicationName: \(Swift.String(describing: applicationName)), dateCreated: \(Swift.String(describing: dateCreated)), dateUpdated: \(Swift.String(describing: dateUpdated)), deploymentStatus: \(Swift.String(describing: deploymentStatus)), description: \(Swift.String(describing: description)), environmentName: \(Swift.String(describing: environmentName)), optionSettings: \(Swift.String(describing: optionSettings)), platformArn: \(Swift.String(describing: platformArn)), solutionStackName: \(Swift.String(describing: solutionStackName)), templateName: \(Swift.String(describing: templateName)))"}
}
...
struct CreateConfigurationTemplateOutputResponseBody: Swift.Equatable {
    ...
    public let deploymentStatus: ElasticBeanstalkClientTypes.ConfigurationDeploymentStatus?
    public let dateCreated: ClientRuntime.Date?
    public let dateUpdated: ClientRuntime.Date?
    public let optionSettings: [ElasticBeanstalkClientTypes.ConfigurationOptionSetting]?
}
...
extension CreateEnvironmentInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateEnvironmentInput(applicationName: \(Swift.String(describing: applicationName)), cNAMEPrefix: \(Swift.String(describing: cNAMEPrefix)), description: \(Swift.String(describing: description)), environmentName: \(Swift.String(describing: environmentName)), groupName: \(Swift.String(describing: groupName)), operationsRole: \(Swift.String(describing: operationsRole)), optionSettings: \(Swift.String(describing: optionSettings)), optionsToRemove: \(Swift.String(describing: optionsToRemove)), platformArn: \(Swift.String(describing: platformArn)), solutionStackName: \(Swift.String(describing: solutionStackName)), tags: \(Swift.String(describing: tags)), templateName: \(Swift.String(describing: templateName)), tier: \(Swift.String(describing: tier)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
public struct CreateEnvironmentInput: Swift.Equatable {
    ...
    ///       more information, see <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/iam-operationsrole.html">Operations roles in the
    ///         AWS Elastic Beanstalk Developer Guide.
    public var operationsRole: Swift.String?
    ...
    ///       more information, see <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/custom-platforms.html">Custom Platforms in the
    ///         AWS Elastic Beanstalk Developer Guide.
    ///
    ///
    ...
    ///       specified solution stack. For a list of current solution stacks, see <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/platforms/platforms-supported.html">Elastic Beanstalk Supported Platforms in the AWS Elastic Beanstalk
    ///         Platforms guide.
    ///
...
extension CreateEnvironmentOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateEnvironmentOutputResponse(abortableOperationInProgress: \(Swift.String(describing: abortableOperationInProgress)), applicationName: \(Swift.String(describing: applicationName)), cNAME: \(Swift.String(describing: cNAME)), dateCreated: \(Swift.String(describing: dateCreated)), dateUpdated: \(Swift.String(describing: dateUpdated)), description: \(Swift.String(describing: description)), endpointURL: \(Swift.String(describing: endpointURL)), environmentArn: \(Swift.String(describing: environmentArn)), environmentId: \(Swift.String(describing: environmentId)), environmentLinks: \(Swift.String(describing: environmentLinks)), environmentName: \(Swift.String(describing: environmentName)), health: \(Swift.String(describing: health)), healthStatus: \(Swift.String(describing: healthStatus)), operationsRole: \(Swift.String(describing: operationsRole)), platformArn: \(Swift.String(describing: platformArn)), resources: \(Swift.String(describing: resources)), solutionStackName: \(Swift.String(describing: solutionStackName)), status: \(Swift.String(describing: status)), templateName: \(Swift.String(describing: templateName)), tier: \(Swift.String(describing: tier)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
public struct CreateEnvironmentOutputResponse: Swift.Equatable {
    ...
    ///       see <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/iam-operationsrole.html">Operations roles in the AWS Elastic Beanstalk Developer Guide.
    public var operationsRole: Swift.String?
    /// The ARN of the platform version.
    public var platformArn: Swift.String?
...
struct CreateEnvironmentOutputResponseBody: Swift.Equatable {
    ...
    public let dateCreated: ClientRuntime.Date?
    public let dateUpdated: ClientRuntime.Date?
    public let status: ElasticBeanstalkClientTypes.EnvironmentStatus?
    public let abortableOperationInProgress: Swift.Bool?
    public let health: ElasticBeanstalkClientTypes.EnvironmentHealth?
    public let healthStatus: ElasticBeanstalkClientTypes.EnvironmentHealthStatus?
    public let resources: ElasticBeanstalkClientTypes.EnvironmentResourcesDescription?
    public let tier: ElasticBeanstalkClientTypes.EnvironmentTier?
    public let environmentLinks: [ElasticBeanstalkClientTypes.EnvironmentLink]?
    public let environmentArn: Swift.String?
    public let operationsRole: Swift.String?
}
...
public struct CreatePlatformVersionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePlatformVersionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreatePlatformVersionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreatePlatformVersionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreatePlatformVersionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreatePlatformVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreatePlatformVersionOutputError>
}

extension CreatePlatformVersionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreatePlatformVersionInput(environmentName: \(Swift.String(describing: environmentName)), optionSettings: \(Swift.String(describing: optionSettings)), platformDefinitionBundle: \(Swift.String(describing: platformDefinitionBundle)), platformName: \(Swift.String(describing: platformName)), platformVersion: \(Swift.String(describing: platformVersion)), tags: \(Swift.String(describing: tags)))"}
}

extension CreatePlatformVersionInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentName = environmentName {
            try container.encode(environmentName, forKey: ClientRuntime.Key("EnvironmentName"))
...
public struct CreatePlatformVersionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePlatformVersionInputHeadersMiddleware"
...
public struct CreatePlatformVersionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePlatformVersionInputQueryItemMiddleware"
...
public struct CreatePlatformVersionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePlatformVersionInputURLHostMiddleware"
    ...
    public typealias MInput = CreatePlatformVersionInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreatePlatformVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreatePlatformVersionOutputError>
}

public struct CreatePlatformVersionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePlatformVersionInputURLPathMiddleware"
...
extension CreatePlatformVersionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreatePlatformVersionOutputResponse(builder: \(Swift.String(describing: builder)), platformSummary: \(Swift.String(describing: platformSummary)))"}
}
...
struct CreatePlatformVersionOutputResponseBody: Swift.Equatable {
    public let platformSummary: ElasticBeanstalkClientTypes.PlatformSummary?
    public let builder: ElasticBeanstalkClientTypes.Builder?
}
...
public struct CreateStorageLocationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStorageLocationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateStorageLocationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateStorageLocationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateStorageLocationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateStorageLocationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateStorageLocationOutputError>
}

extension CreateStorageLocationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateStorageLocationInput()"}
}

extension CreateStorageLocationInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct CreateStorageLocationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStorageLocationInputHeadersMiddleware"
...
public struct CreateStorageLocationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStorageLocationInputQueryItemMiddleware"
...
public struct CreateStorageLocationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStorageLocationInputURLHostMiddleware"
    ...
    public typealias MInput = CreateStorageLocationInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateStorageLocationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateStorageLocationOutputError>
}

public struct CreateStorageLocationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStorageLocationInputURLPathMiddleware"
...
extension CreateStorageLocationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateStorageLocationOutputResponse(s3Bucket: \(Swift.String(describing: s3Bucket)))"}
}
...
extension ElasticBeanstalkClientTypes.CustomAmi: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.CustomAmi: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CustomAmi(imageId: \(Swift.String(describing: imageId)), virtualizationType: \(Swift.String(describing: virtualizationType)))"}
}
...
extension DeleteApplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteApplicationInput(applicationName: \(Swift.String(describing: applicationName)), terminateEnvByForce: \(Swift.String(describing: terminateEnvByForce)))"}
}
...
public struct DeleteApplicationVersionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationVersionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteApplicationVersionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteApplicationVersionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteApplicationVersionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteApplicationVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteApplicationVersionOutputError>
}

extension DeleteApplicationVersionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteApplicationVersionInput(applicationName: \(Swift.String(describing: applicationName)), deleteSourceBundle: \(Swift.String(describing: deleteSourceBundle)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}

extension DeleteApplicationVersionInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct DeleteApplicationVersionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationVersionInputHeadersMiddleware"
...
public struct DeleteApplicationVersionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationVersionInputQueryItemMiddleware"
...
public struct DeleteApplicationVersionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationVersionInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteApplicationVersionInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteApplicationVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteApplicationVersionOutputError>
}

public struct DeleteApplicationVersionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationVersionInputURLPathMiddleware"
...
extension DeleteApplicationVersionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteApplicationVersionOutputResponseBody: Swift.Equatable {
}

extension DeleteApplicationVersionOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct DeleteConfigurationTemplateInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConfigurationTemplateInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteConfigurationTemplateInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteConfigurationTemplateOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteConfigurationTemplateInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteConfigurationTemplateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteConfigurationTemplateOutputError>
}

extension DeleteConfigurationTemplateInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteConfigurationTemplateInput(applicationName: \(Swift.String(describing: applicationName)), templateName: \(Swift.String(describing: templateName)))"}
}

extension DeleteConfigurationTemplateInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct DeleteConfigurationTemplateInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConfigurationTemplateInputHeadersMiddleware"
...
public struct DeleteConfigurationTemplateInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConfigurationTemplateInputQueryItemMiddleware"
...
public struct DeleteConfigurationTemplateInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConfigurationTemplateInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteConfigurationTemplateInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteConfigurationTemplateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteConfigurationTemplateOutputError>
}

public struct DeleteConfigurationTemplateInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConfigurationTemplateInputURLPathMiddleware"
...
extension DeleteConfigurationTemplateOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteConfigurationTemplateOutputResponseBody: Swift.Equatable {
}

extension DeleteConfigurationTemplateOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct DeleteEnvironmentConfigurationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteEnvironmentConfigurationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteEnvironmentConfigurationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteEnvironmentConfigurationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteEnvironmentConfigurationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteEnvironmentConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteEnvironmentConfigurationOutputError>
}

extension DeleteEnvironmentConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteEnvironmentConfigurationInput(applicationName: \(Swift.String(describing: applicationName)), environmentName: \(Swift.String(describing: environmentName)))"}
}

extension DeleteEnvironmentConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct DeleteEnvironmentConfigurationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteEnvironmentConfigurationInputHeadersMiddleware"
...
public struct DeleteEnvironmentConfigurationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteEnvironmentConfigurationInputQueryItemMiddleware"
...
public struct DeleteEnvironmentConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteEnvironmentConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteEnvironmentConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteEnvironmentConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteEnvironmentConfigurationOutputError>
}

public struct DeleteEnvironmentConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteEnvironmentConfigurationInputURLPathMiddleware"
...
extension DeleteEnvironmentConfigurationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteEnvironmentConfigurationOutputResponseBody: Swift.Equatable {
}

extension DeleteEnvironmentConfigurationOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct DeletePlatformVersionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePlatformVersionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeletePlatformVersionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeletePlatformVersionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeletePlatformVersionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeletePlatformVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeletePlatformVersionOutputError>
}

extension DeletePlatformVersionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeletePlatformVersionInput(platformArn: \(Swift.String(describing: platformArn)))"}
}

extension DeletePlatformVersionInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let platformArn = platformArn {
            try container.encode(platformArn, forKey: ClientRuntime.Key("PlatformArn"))
...
public struct DeletePlatformVersionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePlatformVersionInputHeadersMiddleware"
...
public struct DeletePlatformVersionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePlatformVersionInputQueryItemMiddleware"
...
public struct DeletePlatformVersionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePlatformVersionInputURLHostMiddleware"
    ...
    public typealias MInput = DeletePlatformVersionInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeletePlatformVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeletePlatformVersionOutputError>
}

public struct DeletePlatformVersionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePlatformVersionInputURLPathMiddleware"
...
extension DeletePlatformVersionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeletePlatformVersionOutputResponse(platformSummary: \(Swift.String(describing: platformSummary)))"}
}
...
extension ElasticBeanstalkClientTypes.Deployment: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.Deployment: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Deployment(deploymentId: \(Swift.String(describing: deploymentId)), deploymentTime: \(Swift.String(describing: deploymentTime)), status: \(Swift.String(describing: status)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
public struct DescribeAccountAttributesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAccountAttributesInputURLHostMiddleware"
...
extension DescribeAccountAttributesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAccountAttributesOutputResponse(resourceQuotas: \(Swift.String(describing: resourceQuotas)))"}
}
...
struct DescribeAccountAttributesOutputResponseBody: Swift.Equatable {
    public let resourceQuotas: ElasticBeanstalkClientTypes.ResourceQuotas?
}
...
public struct DescribeApplicationVersionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationVersionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeApplicationVersionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeApplicationVersionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeApplicationVersionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeApplicationVersionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeApplicationVersionsOutputError>
}

extension DescribeApplicationVersionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeApplicationVersionsInput(applicationName: \(Swift.String(describing: applicationName)), maxRecords: \(Swift.String(describing: maxRecords)), nextToken: \(Swift.String(describing: nextToken)), versionLabels: \(Swift.String(describing: versionLabels)))"}
}

extension DescribeApplicationVersionsInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct DescribeApplicationVersionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationVersionsInputHeadersMiddleware"
...
public struct DescribeApplicationVersionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationVersionsInputQueryItemMiddleware"
...
public struct DescribeApplicationVersionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationVersionsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeApplicationVersionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeApplicationVersionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeApplicationVersionsOutputError>
}

public struct DescribeApplicationVersionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationVersionsInputURLPathMiddleware"
...
extension DescribeApplicationVersionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeApplicationVersionsOutputResponse(applicationVersions: \(Swift.String(describing: applicationVersions)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct DescribeApplicationVersionsOutputResponseBody: Swift.Equatable {
    public let applicationVersions: [ElasticBeanstalkClientTypes.ApplicationVersionDescription]?
    public let nextToken: Swift.String?
}
...
public struct DescribeApplicationsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeApplicationsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeApplicationsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeApplicationsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeApplicationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeApplicationsOutputError>
}

extension DescribeApplicationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeApplicationsInput(applicationNames: \(Swift.String(describing: applicationNames)))"}
}
...
public struct DescribeApplicationsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationsInputHeadersMiddleware"
...
public struct DescribeApplicationsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationsInputQueryItemMiddleware"
...
public struct DescribeApplicationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeApplicationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeApplicationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeApplicationsOutputError>
}

public struct DescribeApplicationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeApplicationsInputURLPathMiddleware"
...
extension DescribeApplicationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeApplicationsOutputResponse(applications: \(Swift.String(describing: applications)))"}
}
...
struct DescribeApplicationsOutputResponseBody: Swift.Equatable {
    public let applications: [ElasticBeanstalkClientTypes.ApplicationDescription]?
}
...
public struct DescribeConfigurationOptionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationOptionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeConfigurationOptionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeConfigurationOptionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeConfigurationOptionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeConfigurationOptionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeConfigurationOptionsOutputError>
}

extension DescribeConfigurationOptionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeConfigurationOptionsInput(applicationName: \(Swift.String(describing: applicationName)), environmentName: \(Swift.String(describing: environmentName)), options: \(Swift.String(describing: options)), platformArn: \(Swift.String(describing: platformArn)), solutionStackName: \(Swift.String(describing: solutionStackName)), templateName: \(Swift.String(describing: templateName)))"}
}

extension DescribeConfigurationOptionsInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct DescribeConfigurationOptionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationOptionsInputHeadersMiddleware"
...
public struct DescribeConfigurationOptionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationOptionsInputQueryItemMiddleware"
...
public struct DescribeConfigurationOptionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationOptionsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeConfigurationOptionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeConfigurationOptionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeConfigurationOptionsOutputError>
}

public struct DescribeConfigurationOptionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationOptionsInputURLPathMiddleware"
...
extension DescribeConfigurationOptionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeConfigurationOptionsOutputResponse(options: \(Swift.String(describing: options)), platformArn: \(Swift.String(describing: platformArn)), solutionStackName: \(Swift.String(describing: solutionStackName)))"}
}
...
struct DescribeConfigurationOptionsOutputResponseBody: Swift.Equatable {
    public let solutionStackName: Swift.String?
    public let platformArn: Swift.String?
    public let options: [ElasticBeanstalkClientTypes.ConfigurationOptionDescription]?
}
...
public struct DescribeConfigurationSettingsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationSettingsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeConfigurationSettingsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeConfigurationSettingsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeConfigurationSettingsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeConfigurationSettingsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeConfigurationSettingsOutputError>
}

extension DescribeConfigurationSettingsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeConfigurationSettingsInput(applicationName: \(Swift.String(describing: applicationName)), environmentName: \(Swift.String(describing: environmentName)), templateName: \(Swift.String(describing: templateName)))"}
}

extension DescribeConfigurationSettingsInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct DescribeConfigurationSettingsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationSettingsInputHeadersMiddleware"
...
public struct DescribeConfigurationSettingsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationSettingsInputQueryItemMiddleware"
...
public struct DescribeConfigurationSettingsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationSettingsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeConfigurationSettingsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeConfigurationSettingsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeConfigurationSettingsOutputError>
}

public struct DescribeConfigurationSettingsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationSettingsInputURLPathMiddleware"
...
extension DescribeConfigurationSettingsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeConfigurationSettingsOutputResponse(configurationSettings: \(Swift.String(describing: configurationSettings)))"}
}
...
struct DescribeConfigurationSettingsOutputResponseBody: Swift.Equatable {
    public let configurationSettings: [ElasticBeanstalkClientTypes.ConfigurationSettingsDescription]?
}
...
public struct DescribeEnvironmentHealthInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentHealthInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEnvironmentHealthInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEnvironmentHealthOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEnvironmentHealthInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEnvironmentHealthOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEnvironmentHealthOutputError>
}

extension DescribeEnvironmentHealthInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEnvironmentHealthInput(attributeNames: \(Swift.String(describing: attributeNames)), environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)))"}
}

extension DescribeEnvironmentHealthInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct DescribeEnvironmentHealthInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentHealthInputHeadersMiddleware"
...
public struct DescribeEnvironmentHealthInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentHealthInputQueryItemMiddleware"
...
public struct DescribeEnvironmentHealthInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentHealthInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeEnvironmentHealthInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEnvironmentHealthOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEnvironmentHealthOutputError>
}

public struct DescribeEnvironmentHealthInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentHealthInputURLPathMiddleware"
...
extension DescribeEnvironmentHealthOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEnvironmentHealthOutputResponse(applicationMetrics: \(Swift.String(describing: applicationMetrics)), causes: \(Swift.String(describing: causes)), color: \(Swift.String(describing: color)), environmentName: \(Swift.String(describing: environmentName)), healthStatus: \(Swift.String(describing: healthStatus)), instancesHealth: \(Swift.String(describing: instancesHealth)), refreshedAt: \(Swift.String(describing: refreshedAt)), status: \(Swift.String(describing: status)))"}
}
...
public struct DescribeEnvironmentHealthOutputResponse: Swift.Equatable {
    ...
    /// The <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/health-enhanced-status.html">health color of the
    ///       environment.
    public var color: Swift.String?
    /// The environment's name.
    public var environmentName: Swift.String?
    /// The <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/health-enhanced-status.html">health status of the
...
struct DescribeEnvironmentHealthOutputResponseBody: Swift.Equatable {
    public let environmentName: Swift.String?
    public let healthStatus: Swift.String?
    public let status: ElasticBeanstalkClientTypes.EnvironmentHealth?
    public let color: Swift.String?
    public let causes: [Swift.String]?
    public let applicationMetrics: ElasticBeanstalkClientTypes.ApplicationMetrics?
    public let instancesHealth: ElasticBeanstalkClientTypes.InstanceHealthSummary?
    public let refreshedAt: ClientRuntime.Date?
}
...
public struct DescribeEnvironmentManagedActionHistoryInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentManagedActionHistoryInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEnvironmentManagedActionHistoryInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEnvironmentManagedActionHistoryOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEnvironmentManagedActionHistoryInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEnvironmentManagedActionHistoryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEnvironmentManagedActionHistoryOutputError>
}

extension DescribeEnvironmentManagedActionHistoryInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEnvironmentManagedActionHistoryInput(environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)), maxItems: \(Swift.String(describing: maxItems)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeEnvironmentManagedActionHistoryInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentId = environmentId {
            try container.encode(environmentId, forKey: ClientRuntime.Key("EnvironmentId"))
...
public struct DescribeEnvironmentManagedActionHistoryInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentManagedActionHistoryInputHeadersMiddleware"
...
public struct DescribeEnvironmentManagedActionHistoryInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentManagedActionHistoryInputQueryItemMiddleware"
...
public struct DescribeEnvironmentManagedActionHistoryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentManagedActionHistoryInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeEnvironmentManagedActionHistoryInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEnvironmentManagedActionHistoryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEnvironmentManagedActionHistoryOutputError>
}

public struct DescribeEnvironmentManagedActionHistoryInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentManagedActionHistoryInputURLPathMiddleware"
...
extension DescribeEnvironmentManagedActionHistoryOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEnvironmentManagedActionHistoryOutputResponse(managedActionHistoryItems: \(Swift.String(describing: managedActionHistoryItems)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct DescribeEnvironmentManagedActionHistoryOutputResponseBody: Swift.Equatable {
    public let managedActionHistoryItems: [ElasticBeanstalkClientTypes.ManagedActionHistoryItem]?
    public let nextToken: Swift.String?
}
...
public struct DescribeEnvironmentManagedActionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentManagedActionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEnvironmentManagedActionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEnvironmentManagedActionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEnvironmentManagedActionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEnvironmentManagedActionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEnvironmentManagedActionsOutputError>
}

extension DescribeEnvironmentManagedActionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEnvironmentManagedActionsInput(environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)), status: \(Swift.String(describing: status)))"}
}

extension DescribeEnvironmentManagedActionsInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentId = environmentId {
            try container.encode(environmentId, forKey: ClientRuntime.Key("EnvironmentId"))
...
public struct DescribeEnvironmentManagedActionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentManagedActionsInputHeadersMiddleware"
...
public struct DescribeEnvironmentManagedActionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentManagedActionsInputQueryItemMiddleware"
...
public struct DescribeEnvironmentManagedActionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentManagedActionsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeEnvironmentManagedActionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEnvironmentManagedActionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEnvironmentManagedActionsOutputError>
}

public struct DescribeEnvironmentManagedActionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentManagedActionsInputURLPathMiddleware"
...
extension DescribeEnvironmentManagedActionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEnvironmentManagedActionsOutputResponse(managedActions: \(Swift.String(describing: managedActions)))"}
}
...
struct DescribeEnvironmentManagedActionsOutputResponseBody: Swift.Equatable {
    public let managedActions: [ElasticBeanstalkClientTypes.ManagedAction]?
}
...
public struct DescribeEnvironmentResourcesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentResourcesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEnvironmentResourcesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEnvironmentResourcesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEnvironmentResourcesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEnvironmentResourcesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEnvironmentResourcesOutputError>
}

extension DescribeEnvironmentResourcesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEnvironmentResourcesInput(environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)))"}
}

extension DescribeEnvironmentResourcesInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentId = environmentId {
            try container.encode(environmentId, forKey: ClientRuntime.Key("EnvironmentId"))
...
public struct DescribeEnvironmentResourcesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentResourcesInputHeadersMiddleware"
...
public struct DescribeEnvironmentResourcesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentResourcesInputQueryItemMiddleware"
...
public struct DescribeEnvironmentResourcesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentResourcesInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeEnvironmentResourcesInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEnvironmentResourcesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEnvironmentResourcesOutputError>
}

public struct DescribeEnvironmentResourcesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentResourcesInputURLPathMiddleware"
...
extension DescribeEnvironmentResourcesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEnvironmentResourcesOutputResponse(environmentResources: \(Swift.String(describing: environmentResources)))"}
}
...
struct DescribeEnvironmentResourcesOutputResponseBody: Swift.Equatable {
    public let environmentResources: ElasticBeanstalkClientTypes.EnvironmentResourceDescription?
}
...
extension DescribeEnvironmentsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEnvironmentsInput(applicationName: \(Swift.String(describing: applicationName)), environmentIds: \(Swift.String(describing: environmentIds)), environmentNames: \(Swift.String(describing: environmentNames)), includeDeleted: \(Swift.String(describing: includeDeleted)), includedDeletedBackTo: \(Swift.String(describing: includedDeletedBackTo)), maxRecords: \(Swift.String(describing: maxRecords)), nextToken: \(Swift.String(describing: nextToken)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
public struct DescribeEnvironmentsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeEnvironmentsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEnvironmentsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEnvironmentsOutputError>
}

public struct DescribeEnvironmentsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEnvironmentsInputURLPathMiddleware"
...
extension DescribeEnvironmentsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEnvironmentsOutputResponse(environments: \(Swift.String(describing: environments)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
extension DescribeEventsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEventsInput(applicationName: \(Swift.String(describing: applicationName)), endTime: \(Swift.String(describing: endTime)), environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)), maxRecords: \(Swift.String(describing: maxRecords)), nextToken: \(Swift.String(describing: nextToken)), platformArn: \(Swift.String(describing: platformArn)), requestId: \(Swift.String(describing: requestId)), severity: \(Swift.String(describing: severity)), startTime: \(Swift.String(describing: startTime)), templateName: \(Swift.String(describing: templateName)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
struct DescribeEventsOutputResponseBody: Swift.Equatable {
    public let events: [ElasticBeanstalkClientTypes.EventDescription]?
    public let nextToken: Swift.String?
}
...
public struct DescribeInstancesHealthInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeInstancesHealthInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeInstancesHealthInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeInstancesHealthOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeInstancesHealthInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeInstancesHealthOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeInstancesHealthOutputError>
}

extension DescribeInstancesHealthInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeInstancesHealthInput(attributeNames: \(Swift.String(describing: attributeNames)), environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeInstancesHealthInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let attributeNames = attributeNames {
            var attributeNamesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AttributeNames"))
...
public struct DescribeInstancesHealthInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeInstancesHealthInputHeadersMiddleware"
...
public struct DescribeInstancesHealthInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeInstancesHealthInputQueryItemMiddleware"
...
public struct DescribeInstancesHealthInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeInstancesHealthInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeInstancesHealthInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeInstancesHealthOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeInstancesHealthOutputError>
}

public struct DescribeInstancesHealthInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeInstancesHealthInputURLPathMiddleware"
...
extension DescribeInstancesHealthOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeInstancesHealthOutputResponse(instanceHealthList: \(Swift.String(describing: instanceHealthList)), nextToken: \(Swift.String(describing: nextToken)), refreshedAt: \(Swift.String(describing: refreshedAt)))"}
}
...
struct DescribeInstancesHealthOutputResponseBody: Swift.Equatable {
    public let instanceHealthList: [ElasticBeanstalkClientTypes.SingleInstanceHealth]?
    public let refreshedAt: ClientRuntime.Date?
    public let nextToken: Swift.String?
}
...
public struct DescribePlatformVersionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePlatformVersionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribePlatformVersionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribePlatformVersionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribePlatformVersionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribePlatformVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribePlatformVersionOutputError>
}

extension DescribePlatformVersionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribePlatformVersionInput(platformArn: \(Swift.String(describing: platformArn)))"}
}

extension DescribePlatformVersionInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let platformArn = platformArn {
            try container.encode(platformArn, forKey: ClientRuntime.Key("PlatformArn"))
...
public struct DescribePlatformVersionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePlatformVersionInputHeadersMiddleware"
...
public struct DescribePlatformVersionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePlatformVersionInputQueryItemMiddleware"
...
public struct DescribePlatformVersionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePlatformVersionInputURLHostMiddleware"
    ...
    public typealias MInput = DescribePlatformVersionInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribePlatformVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribePlatformVersionOutputError>
}

public struct DescribePlatformVersionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePlatformVersionInputURLPathMiddleware"
...
extension DescribePlatformVersionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribePlatformVersionOutputResponse(platformDescription: \(Swift.String(describing: platformDescription)))"}
}
...
struct DescribePlatformVersionOutputResponseBody: Swift.Equatable {
    public let platformDescription: ElasticBeanstalkClientTypes.PlatformDescription?
}
...
public struct DisassociateEnvironmentOperationsRoleInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateEnvironmentOperationsRoleInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DisassociateEnvironmentOperationsRoleInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DisassociateEnvironmentOperationsRoleOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DisassociateEnvironmentOperationsRoleInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DisassociateEnvironmentOperationsRoleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisassociateEnvironmentOperationsRoleOutputError>
}

extension DisassociateEnvironmentOperationsRoleInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DisassociateEnvironmentOperationsRoleInput(environmentName: \(Swift.String(describing: environmentName)))"}
}

extension DisassociateEnvironmentOperationsRoleInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentName = environmentName {
            try container.encode(environmentName, forKey: ClientRuntime.Key("EnvironmentName"))
...
public struct DisassociateEnvironmentOperationsRoleInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateEnvironmentOperationsRoleInputHeadersMiddleware"
...
public struct DisassociateEnvironmentOperationsRoleInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateEnvironmentOperationsRoleInputQueryItemMiddleware"
...
public struct DisassociateEnvironmentOperationsRoleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateEnvironmentOperationsRoleInputURLHostMiddleware"
    ...
    public typealias MInput = DisassociateEnvironmentOperationsRoleInput
    public typealias MOutput = ClientRuntime.OperationOutput<DisassociateEnvironmentOperationsRoleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisassociateEnvironmentOperationsRoleOutputError>
}

public struct DisassociateEnvironmentOperationsRoleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateEnvironmentOperationsRoleInputURLPathMiddleware"
...
extension DisassociateEnvironmentOperationsRoleOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DisassociateEnvironmentOperationsRoleOutputResponseBody: Swift.Equatable {
}

extension DisassociateEnvironmentOperationsRoleOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension ElasticBeanstalkServiceException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ElasticBeanstalkServiceException(message: \(Swift.String(describing: message)))"}
}
...
extension ElasticBeanstalkClientTypes.EnvironmentDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case abortableOperationInProgress = "AbortableOperationInProgress"
        case applicationName = "ApplicationName"
        case cNAME = "CNAME"
...
extension ElasticBeanstalkClientTypes.EnvironmentDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EnvironmentDescription(abortableOperationInProgress: \(Swift.String(describing: abortableOperationInProgress)), applicationName: \(Swift.String(describing: applicationName)), cNAME: \(Swift.String(describing: cNAME)), dateCreated: \(Swift.String(describing: dateCreated)), dateUpdated: \(Swift.String(describing: dateUpdated)), description: \(Swift.String(describing: description)), endpointURL: \(Swift.String(describing: endpointURL)), environmentArn: \(Swift.String(describing: environmentArn)), environmentId: \(Swift.String(describing: environmentId)), environmentLinks: \(Swift.String(describing: environmentLinks)), environmentName: \(Swift.String(describing: environmentName)), health: \(Swift.String(describing: health)), healthStatus: \(Swift.String(describing: healthStatus)), operationsRole: \(Swift.String(describing: operationsRole)), platformArn: \(Swift.String(describing: platformArn)), resources: \(Swift.String(describing: resources)), solutionStackName: \(Swift.String(describing: solutionStackName)), status: \(Swift.String(describing: status)), templateName: \(Swift.String(describing: templateName)), tier: \(Swift.String(describing: tier)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
extension ElasticBeanstalkClientTypes.EnvironmentInfoDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.EnvironmentInfoDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EnvironmentInfoDescription(ec2InstanceId: \(Swift.String(describing: ec2InstanceId)), infoType: \(Swift.String(describing: infoType)), message: \(Swift.String(describing: message)), sampleTimestamp: \(Swift.String(describing: sampleTimestamp)))"}
}
...
extension ElasticBeanstalkClientTypes.EnvironmentLink: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case environmentName = "EnvironmentName"
...
extension ElasticBeanstalkClientTypes.EnvironmentLink: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EnvironmentLink(environmentName: \(Swift.String(describing: environmentName)), linkName: \(Swift.String(describing: linkName)))"}
}
...
extension ElasticBeanstalkClientTypes.EnvironmentResourceDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.EnvironmentResourceDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EnvironmentResourceDescription(autoScalingGroups: \(Swift.String(describing: autoScalingGroups)), environmentName: \(Swift.String(describing: environmentName)), instances: \(Swift.String(describing: instances)), launchConfigurations: \(Swift.String(describing: launchConfigurations)), launchTemplates: \(Swift.String(describing: launchTemplates)), loadBalancers: \(Swift.String(describing: loadBalancers)), queues: \(Swift.String(describing: queues)), triggers: \(Swift.String(describing: triggers)))"}
}
...
extension ElasticBeanstalkClientTypes.EnvironmentResourcesDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.EnvironmentResourcesDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EnvironmentResourcesDescription(loadBalancer: \(Swift.String(describing: loadBalancer)))"}
}
...
extension ElasticBeanstalkClientTypes.EnvironmentTier: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case type = "Type"
...
extension ElasticBeanstalkClientTypes.EnvironmentTier: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EnvironmentTier(name: \(Swift.String(describing: name)), type: \(Swift.String(describing: type)), version: \(Swift.String(describing: version)))"}
}
...
extension ElasticBeanstalkClientTypes.EventDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case applicationName = "ApplicationName"
        case environmentName = "EnvironmentName"
...
extension ElasticBeanstalkClientTypes.EventDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EventDescription(applicationName: \(Swift.String(describing: applicationName)), environmentName: \(Swift.String(describing: environmentName)), eventDate: \(Swift.String(describing: eventDate)), message: \(Swift.String(describing: message)), platformArn: \(Swift.String(describing: platformArn)), requestId: \(Swift.String(describing: requestId)), severity: \(Swift.String(describing: severity)), templateName: \(Swift.String(describing: templateName)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
extension ElasticBeanstalkClientTypes.Instance: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case id = "Id"
    }
...
extension ElasticBeanstalkClientTypes.Instance: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Instance(id: \(Swift.String(describing: id)))"}
}
...
extension ElasticBeanstalkClientTypes.InstanceHealthSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.InstanceHealthSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InstanceHealthSummary(degraded: \(Swift.String(describing: degraded)), info: \(Swift.String(describing: info)), noData: \(Swift.String(describing: noData)), ok: \(Swift.String(describing: ok)), pending: \(Swift.String(describing: pending)), severe: \(Swift.String(describing: severe)), unknown: \(Swift.String(describing: unknown)), warning: \(Swift.String(describing: warning)))"}
}

extension ElasticBeanstalkClientTypes {
    /// Represents summary information about the health of an instance. For more information,
    ///       see <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/health-enhanced-status.html">Health Colors and Statuses.
...
extension InsufficientPrivilegesException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InsufficientPrivilegesException(message: \(Swift.String(describing: message)))"}
}
...
extension ElasticBeanstalkClientTypes.Latency: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case p10 = "P10"
        case p50 = "P50"
        case p75 = "P75"
...
extension ElasticBeanstalkClientTypes.Latency: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Latency(p10: \(Swift.String(describing: p10)), p50: \(Swift.String(describing: p50)), p75: \(Swift.String(describing: p75)), p85: \(Swift.String(describing: p85)), p90: \(Swift.String(describing: p90)), p95: \(Swift.String(describing: p95)), p99: \(Swift.String(describing: p99)), p999: \(Swift.String(describing: p999)))"}
}
...
extension ElasticBeanstalkClientTypes.LaunchConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
    }
...
extension ElasticBeanstalkClientTypes.LaunchConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LaunchConfiguration(name: \(Swift.String(describing: name)))"}
}
...
extension ElasticBeanstalkClientTypes.LaunchTemplate: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case id = "Id"
    }
...
extension ElasticBeanstalkClientTypes.LaunchTemplate: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LaunchTemplate(id: \(Swift.String(describing: id)))"}
}
...
public struct ListAvailableSolutionStacksInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableSolutionStacksInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListAvailableSolutionStacksInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListAvailableSolutionStacksOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListAvailableSolutionStacksInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListAvailableSolutionStacksOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAvailableSolutionStacksOutputError>
}

extension ListAvailableSolutionStacksInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAvailableSolutionStacksInput()"}
}

extension ListAvailableSolutionStacksInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct ListAvailableSolutionStacksInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableSolutionStacksInputHeadersMiddleware"
...
public struct ListAvailableSolutionStacksInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableSolutionStacksInputQueryItemMiddleware"
...
public struct ListAvailableSolutionStacksInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableSolutionStacksInputURLHostMiddleware"
    ...
    public typealias MInput = ListAvailableSolutionStacksInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListAvailableSolutionStacksOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAvailableSolutionStacksOutputError>
}

public struct ListAvailableSolutionStacksInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableSolutionStacksInputURLPathMiddleware"
...
extension ListAvailableSolutionStacksOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAvailableSolutionStacksOutputResponse(solutionStackDetails: \(Swift.String(describing: solutionStackDetails)), solutionStacks: \(Swift.String(describing: solutionStacks)))"}
}
...
struct ListAvailableSolutionStacksOutputResponseBody: Swift.Equatable {
    public let solutionStacks: [Swift.String]?
    public let solutionStackDetails: [ElasticBeanstalkClientTypes.SolutionStackDescription]?
}
...
public struct ListPlatformBranchesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlatformBranchesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListPlatformBranchesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListPlatformBranchesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListPlatformBranchesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListPlatformBranchesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListPlatformBranchesOutputError>
}

extension ListPlatformBranchesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPlatformBranchesInput(filters: \(Swift.String(describing: filters)), maxRecords: \(Swift.String(describing: maxRecords)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListPlatformBranchesInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct ListPlatformBranchesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlatformBranchesInputHeadersMiddleware"
...
public struct ListPlatformBranchesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlatformBranchesInputQueryItemMiddleware"
...
public struct ListPlatformBranchesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlatformBranchesInputURLHostMiddleware"
    ...
    public typealias MInput = ListPlatformBranchesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListPlatformBranchesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListPlatformBranchesOutputError>
}

public struct ListPlatformBranchesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlatformBranchesInputURLPathMiddleware"
...
extension ListPlatformBranchesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPlatformBranchesOutputResponse(nextToken: \(Swift.String(describing: nextToken)), platformBranchSummaryList: \(Swift.String(describing: platformBranchSummaryList)))"}
}
...
struct ListPlatformBranchesOutputResponseBody: Swift.Equatable {
    public let platformBranchSummaryList: [ElasticBeanstalkClientTypes.PlatformBranchSummary]?
    public let nextToken: Swift.String?
}
...
public struct ListPlatformVersionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlatformVersionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListPlatformVersionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListPlatformVersionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListPlatformVersionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListPlatformVersionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListPlatformVersionsOutputError>
}

extension ListPlatformVersionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPlatformVersionsInput(filters: \(Swift.String(describing: filters)), maxRecords: \(Swift.String(describing: maxRecords)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListPlatformVersionsInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let filters = filters {
            var filtersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Filters"))
...
public struct ListPlatformVersionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlatformVersionsInputHeadersMiddleware"
...
public struct ListPlatformVersionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlatformVersionsInputQueryItemMiddleware"
...
public struct ListPlatformVersionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlatformVersionsInputURLHostMiddleware"
    ...
    public typealias MInput = ListPlatformVersionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListPlatformVersionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListPlatformVersionsOutputError>
}

public struct ListPlatformVersionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPlatformVersionsInputURLPathMiddleware"
...
extension ListPlatformVersionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPlatformVersionsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), platformSummaryList: \(Swift.String(describing: platformSummaryList)))"}
}
...
struct ListPlatformVersionsOutputResponseBody: Swift.Equatable {
    public let platformSummaryList: [ElasticBeanstalkClientTypes.PlatformSummary]?
    public let nextToken: Swift.String?
}
...
extension ListTagsForResourceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListTagsForResourceOutputResponse(resourceArn: \(Swift.String(describing: resourceArn)), resourceTags: \(Swift.String(describing: resourceTags)))"}
}
...
struct ListTagsForResourceOutputResponseBody: Swift.Equatable {
    ...
    public let resourceTags: [ElasticBeanstalkClientTypes.Tag]?
}
...
extension ElasticBeanstalkClientTypes.Listener: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case port = "Port"
...
extension ElasticBeanstalkClientTypes.Listener: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Listener(port: \(Swift.String(describing: port)), protocol: \(Swift.String(describing: `protocol`)))"}
}
...
extension ElasticBeanstalkClientTypes.LoadBalancer: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
    }
...
extension ElasticBeanstalkClientTypes.LoadBalancer: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LoadBalancer(name: \(Swift.String(describing: name)))"}
}
...
extension ElasticBeanstalkClientTypes.LoadBalancerDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case domain = "Domain"
...
extension ElasticBeanstalkClientTypes.LoadBalancerDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LoadBalancerDescription(domain: \(Swift.String(describing: domain)), listeners: \(Swift.String(describing: listeners)), loadBalancerName: \(Swift.String(describing: loadBalancerName)))"}
}
...
extension ElasticBeanstalkClientTypes.ManagedAction: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case actionDescription = "ActionDescription"
        case actionId = "ActionId"
        case actionType = "ActionType"
...
extension ElasticBeanstalkClientTypes.ManagedAction: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ManagedAction(actionDescription: \(Swift.String(describing: actionDescription)), actionId: \(Swift.String(describing: actionId)), actionType: \(Swift.String(describing: actionType)), status: \(Swift.String(describing: status)), windowStartTime: \(Swift.String(describing: windowStartTime)))"}
}
...
extension ElasticBeanstalkClientTypes.ManagedActionHistoryItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case actionDescription = "ActionDescription"
        case actionId = "ActionId"
        case actionType = "ActionType"
...
extension ElasticBeanstalkClientTypes.ManagedActionHistoryItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ManagedActionHistoryItem(actionDescription: \(Swift.String(describing: actionDescription)), actionId: \(Swift.String(describing: actionId)), actionType: \(Swift.String(describing: actionType)), executedTime: \(Swift.String(describing: executedTime)), failureDescription: \(Swift.String(describing: failureDescription)), failureType: \(Swift.String(describing: failureType)), finishedTime: \(Swift.String(describing: finishedTime)), status: \(Swift.String(describing: status)))"}
}
...
extension ManagedActionInvalidStateException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ManagedActionInvalidStateException(message: \(Swift.String(describing: message)))"}
}
...
extension ElasticBeanstalkClientTypes.MaxAgeRule: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.MaxAgeRule: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MaxAgeRule(deleteSourceFromS3: \(Swift.String(describing: deleteSourceFromS3)), enabled: \(Swift.String(describing: enabled)), maxAgeInDays: \(Swift.String(describing: maxAgeInDays)))"}
}
...
extension ElasticBeanstalkClientTypes.MaxCountRule: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case deleteSourceFromS3 = "DeleteSourceFromS3"
        case enabled = "Enabled"
...
extension ElasticBeanstalkClientTypes.MaxCountRule: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MaxCountRule(deleteSourceFromS3: \(Swift.String(describing: deleteSourceFromS3)), enabled: \(Swift.String(describing: enabled)), maxCount: \(Swift.String(describing: maxCount)))"}
}
...
extension ElasticBeanstalkClientTypes.OptionRestrictionRegex: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case label = "Label"
...
extension ElasticBeanstalkClientTypes.OptionRestrictionRegex: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "OptionRestrictionRegex(label: \(Swift.String(describing: label)), pattern: \(Swift.String(describing: pattern)))"}
}
...
extension ElasticBeanstalkClientTypes.OptionSpecification: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case namespace = "Namespace"
        case optionName = "OptionName"
        case resourceName = "ResourceName"
...
extension ElasticBeanstalkClientTypes.OptionSpecification: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "OptionSpecification(namespace: \(Swift.String(describing: namespace)), optionName: \(Swift.String(describing: optionName)), resourceName: \(Swift.String(describing: resourceName)))"}
}
...
extension ElasticBeanstalkClientTypes.PlatformBranchSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.PlatformBranchSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PlatformBranchSummary(branchName: \(Swift.String(describing: branchName)), branchOrder: \(Swift.String(describing: branchOrder)), lifecycleState: \(Swift.String(describing: lifecycleState)), platformName: \(Swift.String(describing: platformName)), supportedTierList: \(Swift.String(describing: supportedTierList)))"}
}
...
extension ElasticBeanstalkClientTypes.PlatformDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.PlatformDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PlatformDescription(customAmiList: \(Swift.String(describing: customAmiList)), dateCreated: \(Swift.String(describing: dateCreated)), dateUpdated: \(Swift.String(describing: dateUpdated)), description: \(Swift.String(describing: description)), frameworks: \(Swift.String(describing: frameworks)), maintainer: \(Swift.String(describing: maintainer)), operatingSystemName: \(Swift.String(describing: operatingSystemName)), operatingSystemVersion: \(Swift.String(describing: operatingSystemVersion)), platformArn: \(Swift.String(describing: platformArn)), platformBranchLifecycleState: \(Swift.String(describing: platformBranchLifecycleState)), platformBranchName: \(Swift.String(describing: platformBranchName)), platformCategory: \(Swift.String(describing: platformCategory)), platformLifecycleState: \(Swift.String(describing: platformLifecycleState)), platformName: \(Swift.String(describing: platformName)), platformOwner: \(Swift.String(describing: platformOwner)), platformStatus: \(Swift.String(describing: platformStatus)), platformVersion: \(Swift.String(describing: platformVersion)), programmingLanguages: \(Swift.String(describing: programmingLanguages)), solutionStackName: \(Swift.String(describing: solutionStackName)), supportedAddonList: \(Swift.String(describing: supportedAddonList)), supportedTierList: \(Swift.String(describing: supportedTierList)))"}
}
...
extension ElasticBeanstalkClientTypes.PlatformFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.PlatformFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PlatformFilter(operator: \(Swift.String(describing: `operator`)), type: \(Swift.String(describing: type)), values: \(Swift.String(describing: values)))"}
}
...
extension ElasticBeanstalkClientTypes.PlatformFramework: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case version = "Version"
    }
...
extension ElasticBeanstalkClientTypes.PlatformFramework: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PlatformFramework(name: \(Swift.String(describing: name)), version: \(Swift.String(describing: version)))"}
}
...
extension ElasticBeanstalkClientTypes.PlatformProgrammingLanguage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case version = "Version"
    }
...
extension ElasticBeanstalkClientTypes.PlatformProgrammingLanguage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PlatformProgrammingLanguage(name: \(Swift.String(describing: name)), version: \(Swift.String(describing: version)))"}
}
...
extension ElasticBeanstalkClientTypes.PlatformSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case operatingSystemName = "OperatingSystemName"
        case operatingSystemVersion = "OperatingSystemVersion"
        case platformArn = "PlatformArn"
...
extension ElasticBeanstalkClientTypes.PlatformSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PlatformSummary(operatingSystemName: \(Swift.String(describing: operatingSystemName)), operatingSystemVersion: \(Swift.String(describing: operatingSystemVersion)), platformArn: \(Swift.String(describing: platformArn)), platformBranchLifecycleState: \(Swift.String(describing: platformBranchLifecycleState)), platformBranchName: \(Swift.String(describing: platformBranchName)), platformCategory: \(Swift.String(describing: platformCategory)), platformLifecycleState: \(Swift.String(describing: platformLifecycleState)), platformOwner: \(Swift.String(describing: platformOwner)), platformStatus: \(Swift.String(describing: platformStatus)), platformVersion: \(Swift.String(describing: platformVersion)), supportedAddonList: \(Swift.String(describing: supportedAddonList)), supportedTierList: \(Swift.String(describing: supportedTierList)))"}
}
...
extension PlatformVersionStillReferencedException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PlatformVersionStillReferencedException(message: \(Swift.String(describing: message)))"}
}
...
extension ElasticBeanstalkClientTypes.Queue: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case uRL = "URL"
    }
...
extension ElasticBeanstalkClientTypes.Queue: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Queue(name: \(Swift.String(describing: name)), uRL: \(Swift.String(describing: uRL)))"}
}
...
public struct RebuildEnvironmentInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebuildEnvironmentInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<RebuildEnvironmentInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<RebuildEnvironmentOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<RebuildEnvironmentInput>
    public typealias MOutput = ClientRuntime.OperationOutput<RebuildEnvironmentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RebuildEnvironmentOutputError>
}

extension RebuildEnvironmentInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RebuildEnvironmentInput(environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)))"}
}

extension RebuildEnvironmentInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentId = environmentId {
            try container.encode(environmentId, forKey: ClientRuntime.Key("EnvironmentId"))
...
public struct RebuildEnvironmentInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebuildEnvironmentInputHeadersMiddleware"
...
public struct RebuildEnvironmentInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebuildEnvironmentInputQueryItemMiddleware"
...
public struct RebuildEnvironmentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebuildEnvironmentInputURLHostMiddleware"
    ...
    public typealias MInput = RebuildEnvironmentInput
    public typealias MOutput = ClientRuntime.OperationOutput<RebuildEnvironmentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RebuildEnvironmentOutputError>
}

public struct RebuildEnvironmentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebuildEnvironmentInputURLPathMiddleware"
...
extension RebuildEnvironmentOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct RebuildEnvironmentOutputResponseBody: Swift.Equatable {
}

extension RebuildEnvironmentOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct RequestEnvironmentInfoInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RequestEnvironmentInfoInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<RequestEnvironmentInfoInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<RequestEnvironmentInfoOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<RequestEnvironmentInfoInput>
    public typealias MOutput = ClientRuntime.OperationOutput<RequestEnvironmentInfoOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RequestEnvironmentInfoOutputError>
}

extension RequestEnvironmentInfoInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RequestEnvironmentInfoInput(environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)), infoType: \(Swift.String(describing: infoType)))"}
}

extension RequestEnvironmentInfoInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentId = environmentId {
            try container.encode(environmentId, forKey: ClientRuntime.Key("EnvironmentId"))
...
public struct RequestEnvironmentInfoInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RequestEnvironmentInfoInputHeadersMiddleware"
...
public struct RequestEnvironmentInfoInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RequestEnvironmentInfoInputQueryItemMiddleware"
...
public struct RequestEnvironmentInfoInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RequestEnvironmentInfoInputURLHostMiddleware"
    ...
    public typealias MInput = RequestEnvironmentInfoInput
    public typealias MOutput = ClientRuntime.OperationOutput<RequestEnvironmentInfoOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RequestEnvironmentInfoOutputError>
}

public struct RequestEnvironmentInfoInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RequestEnvironmentInfoInputURLPathMiddleware"
...
extension RequestEnvironmentInfoOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct RequestEnvironmentInfoOutputResponseBody: Swift.Equatable {
}

extension RequestEnvironmentInfoOutputResponseBody: Swift.Decodable {
...
extension ElasticBeanstalkClientTypes.ResourceQuota: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.ResourceQuota: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceQuota(maximum: \(Swift.String(describing: maximum)))"}
}
...
extension ElasticBeanstalkClientTypes {
    ...
    public struct ResourceQuota: Swift.Equatable {
        /// The maximum number of instances of this Elastic Beanstalk resource type that an AWS account can
        ///       use.
...
extension ElasticBeanstalkClientTypes.ResourceQuotas: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.ResourceQuotas: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceQuotas(applicationQuota: \(Swift.String(describing: applicationQuota)), applicationVersionQuota: \(Swift.String(describing: applicationVersionQuota)), configurationTemplateQuota: \(Swift.String(describing: configurationTemplateQuota)), customPlatformQuota: \(Swift.String(describing: customPlatformQuota)), environmentQuota: \(Swift.String(describing: environmentQuota)))"}
}
...
public struct RestartAppServerInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RestartAppServerInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<RestartAppServerInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<RestartAppServerOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<RestartAppServerInput>
    public typealias MOutput = ClientRuntime.OperationOutput<RestartAppServerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RestartAppServerOutputError>
}

extension RestartAppServerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RestartAppServerInput(environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)))"}
}

extension RestartAppServerInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentId = environmentId {
            try container.encode(environmentId, forKey: ClientRuntime.Key("EnvironmentId"))
...
public struct RestartAppServerInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RestartAppServerInputHeadersMiddleware"
...
public struct RestartAppServerInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RestartAppServerInputQueryItemMiddleware"
...
public struct RestartAppServerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RestartAppServerInputURLHostMiddleware"
    ...
    public typealias MInput = RestartAppServerInput
    public typealias MOutput = ClientRuntime.OperationOutput<RestartAppServerOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RestartAppServerOutputError>
}

public struct RestartAppServerInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RestartAppServerInputURLPathMiddleware"
...
extension RestartAppServerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct RestartAppServerOutputResponseBody: Swift.Equatable {
}

extension RestartAppServerOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct RetrieveEnvironmentInfoInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RetrieveEnvironmentInfoInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<RetrieveEnvironmentInfoInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<RetrieveEnvironmentInfoOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<RetrieveEnvironmentInfoInput>
    public typealias MOutput = ClientRuntime.OperationOutput<RetrieveEnvironmentInfoOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RetrieveEnvironmentInfoOutputError>
}

extension RetrieveEnvironmentInfoInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RetrieveEnvironmentInfoInput(environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)), infoType: \(Swift.String(describing: infoType)))"}
}

extension RetrieveEnvironmentInfoInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentId = environmentId {
            try container.encode(environmentId, forKey: ClientRuntime.Key("EnvironmentId"))
...
public struct RetrieveEnvironmentInfoInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RetrieveEnvironmentInfoInputHeadersMiddleware"
...
public struct RetrieveEnvironmentInfoInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RetrieveEnvironmentInfoInputQueryItemMiddleware"
...
public struct RetrieveEnvironmentInfoInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RetrieveEnvironmentInfoInputURLHostMiddleware"
    ...
    public typealias MInput = RetrieveEnvironmentInfoInput
    public typealias MOutput = ClientRuntime.OperationOutput<RetrieveEnvironmentInfoOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RetrieveEnvironmentInfoOutputError>
}

public struct RetrieveEnvironmentInfoInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RetrieveEnvironmentInfoInputURLPathMiddleware"
...
extension RetrieveEnvironmentInfoOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RetrieveEnvironmentInfoOutputResponse(environmentInfo: \(Swift.String(describing: environmentInfo)))"}
}
...
struct RetrieveEnvironmentInfoOutputResponseBody: Swift.Equatable {
    public let environmentInfo: [ElasticBeanstalkClientTypes.EnvironmentInfoDescription]?
}
...
extension ElasticBeanstalkClientTypes.S3Location: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case s3Bucket = "S3Bucket"
        case s3Key = "S3Key"
    }
...
extension ElasticBeanstalkClientTypes.S3Location: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3LocationNotInServiceRegionException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3LocationNotInServiceRegionException(message: \(Swift.String(describing: message)))"}
}
...
extension S3SubscriptionRequiredException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3SubscriptionRequiredException(message: \(Swift.String(describing: message)))"}
}
...
extension ElasticBeanstalkClientTypes.SearchFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.SearchFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SearchFilter(attribute: \(Swift.String(describing: attribute)), operator: \(Swift.String(describing: `operator`)), values: \(Swift.String(describing: values)))"}
}
...
extension ElasticBeanstalkClientTypes.SingleInstanceHealth: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case applicationMetrics = "ApplicationMetrics"
...
extension ElasticBeanstalkClientTypes.SingleInstanceHealth: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SingleInstanceHealth(applicationMetrics: \(Swift.String(describing: applicationMetrics)), availabilityZone: \(Swift.String(describing: availabilityZone)), causes: \(Swift.String(describing: causes)), color: \(Swift.String(describing: color)), deployment: \(Swift.String(describing: deployment)), healthStatus: \(Swift.String(describing: healthStatus)), instanceId: \(Swift.String(describing: instanceId)), instanceType: \(Swift.String(describing: instanceType)), launchedAt: \(Swift.String(describing: launchedAt)), system: \(Swift.String(describing: system)))"}
}
...
extension ElasticBeanstalkClientTypes {
    ...
    public struct SingleInstanceHealth: Swift.Equatable {
        ...
        /// Returns the health status of the specified instance. For more information, see <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/health-enhanced-status.html">Health
        ///         Colors and Statuses.
        public var healthStatus: Swift.String?
        /// The ID of the Amazon EC2 instance.
...
extension ElasticBeanstalkClientTypes.SolutionStackDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.SolutionStackDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SolutionStackDescription(permittedFileTypes: \(Swift.String(describing: permittedFileTypes)), solutionStackName: \(Swift.String(describing: solutionStackName)))"}
}
...
extension ElasticBeanstalkClientTypes.SourceBuildInformation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.SourceBuildInformation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SourceBuildInformation(sourceLocation: \(Swift.String(describing: sourceLocation)), sourceRepository: \(Swift.String(describing: sourceRepository)), sourceType: \(Swift.String(describing: sourceType)))"}
}
...
extension SourceBundleDeletionException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SourceBundleDeletionException(message: \(Swift.String(describing: message)))"}
}
...
extension ElasticBeanstalkClientTypes.SourceConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case applicationName = "ApplicationName"
        case templateName = "TemplateName"
    }
...
extension ElasticBeanstalkClientTypes.SourceConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SourceConfiguration(applicationName: \(Swift.String(describing: applicationName)), templateName: \(Swift.String(describing: templateName)))"}
}
...
extension ElasticBeanstalkClientTypes.StatusCodes: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.StatusCodes: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StatusCodes(status2xx: \(Swift.String(describing: status2xx)), status3xx: \(Swift.String(describing: status3xx)), status4xx: \(Swift.String(describing: status4xx)), status5xx: \(Swift.String(describing: status5xx)))"}
}
...
public struct SwapEnvironmentCNAMEsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SwapEnvironmentCNAMEsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<SwapEnvironmentCNAMEsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<SwapEnvironmentCNAMEsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<SwapEnvironmentCNAMEsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<SwapEnvironmentCNAMEsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SwapEnvironmentCNAMEsOutputError>
}

extension SwapEnvironmentCNAMEsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SwapEnvironmentCNAMEsInput(destinationEnvironmentId: \(Swift.String(describing: destinationEnvironmentId)), destinationEnvironmentName: \(Swift.String(describing: destinationEnvironmentName)), sourceEnvironmentId: \(Swift.String(describing: sourceEnvironmentId)), sourceEnvironmentName: \(Swift.String(describing: sourceEnvironmentName)))"}
}

extension SwapEnvironmentCNAMEsInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
...
public struct SwapEnvironmentCNAMEsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SwapEnvironmentCNAMEsInputHeadersMiddleware"
...
public struct SwapEnvironmentCNAMEsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SwapEnvironmentCNAMEsInputQueryItemMiddleware"
...
public struct SwapEnvironmentCNAMEsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SwapEnvironmentCNAMEsInputURLHostMiddleware"
    ...
    public typealias MInput = SwapEnvironmentCNAMEsInput
    public typealias MOutput = ClientRuntime.OperationOutput<SwapEnvironmentCNAMEsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SwapEnvironmentCNAMEsOutputError>
}

public struct SwapEnvironmentCNAMEsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SwapEnvironmentCNAMEsInputURLPathMiddleware"
...
extension SwapEnvironmentCNAMEsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct SwapEnvironmentCNAMEsOutputResponseBody: Swift.Equatable {
}

extension SwapEnvironmentCNAMEsOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension ElasticBeanstalkClientTypes.SystemStatus: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticBeanstalkClientTypes.SystemStatus: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SystemStatus(cPUUtilization: \(Swift.String(describing: cPUUtilization)), loadAverage: \(Swift.String(describing: loadAverage)))"}
}
...
extension ElasticBeanstalkClientTypes {
    ...
    public struct SystemStatus: Swift.Equatable {
        ...
        ///         <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/health-enhanced-metrics.html#health-enhanced-metrics-os">Operating System Metrics.
...
extension ElasticBeanstalkClientTypes.Tag: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
...
extension ElasticBeanstalkClientTypes.Tag: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
public struct TerminateEnvironmentInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateEnvironmentInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<TerminateEnvironmentInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<TerminateEnvironmentOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<TerminateEnvironmentInput>
    public typealias MOutput = ClientRuntime.OperationOutput<TerminateEnvironmentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<TerminateEnvironmentOutputError>
}

extension TerminateEnvironmentInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TerminateEnvironmentInput(environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)), forceTerminate: \(Swift.String(describing: forceTerminate)), terminateResources: \(Swift.String(describing: terminateResources)))"}
}

extension TerminateEnvironmentInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let environmentId = environmentId {
            try container.encode(environmentId, forKey: ClientRuntime.Key("EnvironmentId"))
...
public struct TerminateEnvironmentInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateEnvironmentInputHeadersMiddleware"
...
public struct TerminateEnvironmentInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateEnvironmentInputQueryItemMiddleware"
...
public struct TerminateEnvironmentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateEnvironmentInputURLHostMiddleware"
    ...
    public typealias MInput = TerminateEnvironmentInput
    public typealias MOutput = ClientRuntime.OperationOutput<TerminateEnvironmentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<TerminateEnvironmentOutputError>
}

public struct TerminateEnvironmentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateEnvironmentInputURLPathMiddleware"
...
extension TerminateEnvironmentOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TerminateEnvironmentOutputResponse(abortableOperationInProgress: \(Swift.String(describing: abortableOperationInProgress)), applicationName: \(Swift.String(describing: applicationName)), cNAME: \(Swift.String(describing: cNAME)), dateCreated: \(Swift.String(describing: dateCreated)), dateUpdated: \(Swift.String(describing: dateUpdated)), description: \(Swift.String(describing: description)), endpointURL: \(Swift.String(describing: endpointURL)), environmentArn: \(Swift.String(describing: environmentArn)), environmentId: \(Swift.String(describing: environmentId)), environmentLinks: \(Swift.String(describing: environmentLinks)), environmentName: \(Swift.String(describing: environmentName)), health: \(Swift.String(describing: health)), healthStatus: \(Swift.String(describing: healthStatus)), operationsRole: \(Swift.String(describing: operationsRole)), platformArn: \(Swift.String(describing: platformArn)), resources: \(Swift.String(describing: resources)), solutionStackName: \(Swift.String(describing: solutionStackName)), status: \(Swift.String(describing: status)), templateName: \(Swift.String(describing: templateName)), tier: \(Swift.String(describing: tier)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
extension TooManyApplicationVersionsException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TooManyApplicationVersionsException(message: \(Swift.String(describing: message)))"}
}
...
extension TooManyApplicationsException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TooManyApplicationsException(message: \(Swift.String(describing: message)))"}
}
...
extension TooManyBucketsException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TooManyBucketsException(message: \(Swift.String(describing: message)))"}
}
...
extension TooManyConfigurationTemplatesException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TooManyConfigurationTemplatesException(message: \(Swift.String(describing: message)))"}
}
...
extension TooManyEnvironmentsException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TooManyEnvironmentsException(message: \(Swift.String(describing: message)))"}
}
...
extension TooManyPlatformsException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TooManyPlatformsException(message: \(Swift.String(describing: message)))"}
}
...
extension ElasticBeanstalkClientTypes.Trigger: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
    }
...
extension ElasticBeanstalkClientTypes.Trigger: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Trigger(name: \(Swift.String(describing: name)))"}
}
...
extension UpdateApplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateApplicationInput(applicationName: \(Swift.String(describing: applicationName)), description: \(Swift.String(describing: description)))"}
}
...
public struct UpdateApplicationResourceLifecycleInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationResourceLifecycleInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateApplicationResourceLifecycleInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateApplicationResourceLifecycleOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateApplicationResourceLifecycleInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateApplicationResourceLifecycleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateApplicationResourceLifecycleOutputError>
}

extension UpdateApplicationResourceLifecycleInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateApplicationResourceLifecycleInput(applicationName: \(Swift.String(describing: applicationName)), resourceLifecycleConfig: \(Swift.String(describing: resourceLifecycleConfig)))"}
}

extension UpdateApplicationResourceLifecycleInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct UpdateApplicationResourceLifecycleInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationResourceLifecycleInputHeadersMiddleware"
...
public struct UpdateApplicationResourceLifecycleInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationResourceLifecycleInputQueryItemMiddleware"
...
public struct UpdateApplicationResourceLifecycleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationResourceLifecycleInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateApplicationResourceLifecycleInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateApplicationResourceLifecycleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateApplicationResourceLifecycleOutputError>
}

public struct UpdateApplicationResourceLifecycleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationResourceLifecycleInputURLPathMiddleware"
...
extension UpdateApplicationResourceLifecycleOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateApplicationResourceLifecycleOutputResponse(applicationName: \(Swift.String(describing: applicationName)), resourceLifecycleConfig: \(Swift.String(describing: resourceLifecycleConfig)))"}
}
...
struct UpdateApplicationResourceLifecycleOutputResponseBody: Swift.Equatable {
    public let applicationName: Swift.String?
    public let resourceLifecycleConfig: ElasticBeanstalkClientTypes.ApplicationResourceLifecycleConfig?
}
...
public struct UpdateApplicationVersionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationVersionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateApplicationVersionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateApplicationVersionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateApplicationVersionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateApplicationVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateApplicationVersionOutputError>
}

extension UpdateApplicationVersionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateApplicationVersionInput(applicationName: \(Swift.String(describing: applicationName)), description: \(Swift.String(describing: description)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}

extension UpdateApplicationVersionInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct UpdateApplicationVersionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationVersionInputHeadersMiddleware"
...
public struct UpdateApplicationVersionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationVersionInputQueryItemMiddleware"
...
public struct UpdateApplicationVersionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationVersionInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateApplicationVersionInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateApplicationVersionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateApplicationVersionOutputError>
}

public struct UpdateApplicationVersionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateApplicationVersionInputURLPathMiddleware"
...
extension UpdateApplicationVersionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateApplicationVersionOutputResponse(applicationVersion: \(Swift.String(describing: applicationVersion)))"}
}
...
public struct UpdateConfigurationTemplateInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateConfigurationTemplateInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateConfigurationTemplateInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateConfigurationTemplateOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateConfigurationTemplateInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateConfigurationTemplateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateConfigurationTemplateOutputError>
}

extension UpdateConfigurationTemplateInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateConfigurationTemplateInput(applicationName: \(Swift.String(describing: applicationName)), description: \(Swift.String(describing: description)), optionSettings: \(Swift.String(describing: optionSettings)), optionsToRemove: \(Swift.String(describing: optionsToRemove)), templateName: \(Swift.String(describing: templateName)))"}
}

extension UpdateConfigurationTemplateInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct UpdateConfigurationTemplateInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateConfigurationTemplateInputHeadersMiddleware"
...
public struct UpdateConfigurationTemplateInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateConfigurationTemplateInputQueryItemMiddleware"
...
public struct UpdateConfigurationTemplateInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateConfigurationTemplateInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateConfigurationTemplateInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateConfigurationTemplateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateConfigurationTemplateOutputError>
}

public struct UpdateConfigurationTemplateInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateConfigurationTemplateInputURLPathMiddleware"
...
extension UpdateConfigurationTemplateOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateConfigurationTemplateOutputResponse(applicationName: \(Swift.String(describing: applicationName)), dateCreated: \(Swift.String(describing: dateCreated)), dateUpdated: \(Swift.String(describing: dateUpdated)), deploymentStatus: \(Swift.String(describing: deploymentStatus)), description: \(Swift.String(describing: description)), environmentName: \(Swift.String(describing: environmentName)), optionSettings: \(Swift.String(describing: optionSettings)), platformArn: \(Swift.String(describing: platformArn)), solutionStackName: \(Swift.String(describing: solutionStackName)), templateName: \(Swift.String(describing: templateName)))"}
}
...
extension UpdateEnvironmentInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateEnvironmentInput(applicationName: \(Swift.String(describing: applicationName)), description: \(Swift.String(describing: description)), environmentId: \(Swift.String(describing: environmentId)), environmentName: \(Swift.String(describing: environmentName)), groupName: \(Swift.String(describing: groupName)), optionSettings: \(Swift.String(describing: optionSettings)), optionsToRemove: \(Swift.String(describing: optionsToRemove)), platformArn: \(Swift.String(describing: platformArn)), solutionStackName: \(Swift.String(describing: solutionStackName)), templateName: \(Swift.String(describing: templateName)), tier: \(Swift.String(describing: tier)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
extension UpdateEnvironmentOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateEnvironmentOutputResponse(abortableOperationInProgress: \(Swift.String(describing: abortableOperationInProgress)), applicationName: \(Swift.String(describing: applicationName)), cNAME: \(Swift.String(describing: cNAME)), dateCreated: \(Swift.String(describing: dateCreated)), dateUpdated: \(Swift.String(describing: dateUpdated)), description: \(Swift.String(describing: description)), endpointURL: \(Swift.String(describing: endpointURL)), environmentArn: \(Swift.String(describing: environmentArn)), environmentId: \(Swift.String(describing: environmentId)), environmentLinks: \(Swift.String(describing: environmentLinks)), environmentName: \(Swift.String(describing: environmentName)), health: \(Swift.String(describing: health)), healthStatus: \(Swift.String(describing: healthStatus)), operationsRole: \(Swift.String(describing: operationsRole)), platformArn: \(Swift.String(describing: platformArn)), resources: \(Swift.String(describing: resources)), solutionStackName: \(Swift.String(describing: solutionStackName)), status: \(Swift.String(describing: status)), templateName: \(Swift.String(describing: templateName)), tier: \(Swift.String(describing: tier)), versionLabel: \(Swift.String(describing: versionLabel)))"}
}
...
public struct UpdateTagsForResourceInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateTagsForResourceInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateTagsForResourceInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateTagsForResourceOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateTagsForResourceInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateTagsForResourceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateTagsForResourceOutputError>
}

extension UpdateTagsForResourceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateTagsForResourceInput(resourceArn: \(Swift.String(describing: resourceArn)), tagsToAdd: \(Swift.String(describing: tagsToAdd)), tagsToRemove: \(Swift.String(describing: tagsToRemove)))"}
}

extension UpdateTagsForResourceInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let resourceArn = resourceArn {
            try container.encode(resourceArn, forKey: ClientRuntime.Key("ResourceArn"))
...
public struct UpdateTagsForResourceInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateTagsForResourceInputHeadersMiddleware"
...
public struct UpdateTagsForResourceInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateTagsForResourceInputQueryItemMiddleware"
...
public struct UpdateTagsForResourceInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateTagsForResourceInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateTagsForResourceInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateTagsForResourceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateTagsForResourceOutputError>
}

public struct UpdateTagsForResourceInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateTagsForResourceInputURLPathMiddleware"
...
extension UpdateTagsForResourceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct UpdateTagsForResourceOutputResponseBody: Swift.Equatable {
}

extension UpdateTagsForResourceOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct ValidateConfigurationSettingsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ValidateConfigurationSettingsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ValidateConfigurationSettingsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ValidateConfigurationSettingsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ValidateConfigurationSettingsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ValidateConfigurationSettingsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ValidateConfigurationSettingsOutputError>
}

extension ValidateConfigurationSettingsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ValidateConfigurationSettingsInput(applicationName: \(Swift.String(describing: applicationName)), environmentName: \(Swift.String(describing: environmentName)), optionSettings: \(Swift.String(describing: optionSettings)), templateName: \(Swift.String(describing: templateName)))"}
}

extension ValidateConfigurationSettingsInput: Swift.Encodable, ClientRuntime.Reflection {
    public func encode(to encoder: Swift.Encoder) throws {
        var container = encoder.container(keyedBy: ClientRuntime.Key.self)
        if let applicationName = applicationName {
            try container.encode(applicationName, forKey: ClientRuntime.Key("ApplicationName"))
...
public struct ValidateConfigurationSettingsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ValidateConfigurationSettingsInputHeadersMiddleware"
...
public struct ValidateConfigurationSettingsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ValidateConfigurationSettingsInputQueryItemMiddleware"
...
public struct ValidateConfigurationSettingsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ValidateConfigurationSettingsInputURLHostMiddleware"
    ...
    public typealias MInput = ValidateConfigurationSettingsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ValidateConfigurationSettingsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ValidateConfigurationSettingsOutputError>
}

public struct ValidateConfigurationSettingsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ValidateConfigurationSettingsInputURLPathMiddleware"
...
extension ValidateConfigurationSettingsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ValidateConfigurationSettingsOutputResponse(messages: \(Swift.String(describing: messages)))"}
}
...
struct ValidateConfigurationSettingsOutputResponseBody: Swift.Equatable {
    public let messages: [ElasticBeanstalkClientTypes.ValidationMessage]?
}
...
extension ElasticBeanstalkClientTypes.ValidationMessage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case message = "Message"
        case namespace = "Namespace"
        case optionName = "OptionName"
...
extension ElasticBeanstalkClientTypes.ValidationMessage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ValidationMessage(message: \(Swift.String(describing: message)), namespace: \(Swift.String(describing: namespace)), optionName: \(Swift.String(describing: optionName)), severity: \(Swift.String(describing: severity)))"}
}
