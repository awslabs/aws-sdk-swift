...
public protocol CloudHsmV2ClientProtocol {
    ...
    func copyBackupToRegion(input: CopyBackupToRegionInput, completion: @escaping (SdkResult<CopyBackupToRegionOutputResponse, CopyBackupToRegionOutputError>) -> Void)
    ...
    ///       cluster.</p>
    func createHsm(input: CreateHsmInput, completion: @escaping (SdkResult<CreateHsmOutputResponse, CreateHsmOutputError>) -> Void)
    ...
    ///                 <a>RestoreBackup</a>.</p>
    func deleteBackup(input: DeleteBackupInput, completion: @escaping (SdkResult<DeleteBackupOutputResponse, DeleteBackupOutputError>) -> Void)
    ...
    func deleteHsm(input: DeleteHsmInput, completion: @escaping (SdkResult<DeleteHsmOutputResponse, DeleteHsmOutputError>) -> Void)
    ...
    func describeBackups(input: DescribeBackupsInput, completion: @escaping (SdkResult<DescribeBackupsOutputResponse, DescribeBackupsOutputError>) -> Void)
    ...
    func initializeCluster(input: InitializeClusterInput, completion: @escaping (SdkResult<InitializeClusterOutputResponse, InitializeClusterOutputError>) -> Void)
    ...
    func modifyBackupAttributes(input: ModifyBackupAttributesInput, completion: @escaping (SdkResult<ModifyBackupAttributesOutputResponse, ModifyBackupAttributesOutputError>) -> Void)
    ...
    ///                 <a>DeleteBackup</a>.</p>
    func restoreBackup(input: RestoreBackupInput, completion: @escaping (SdkResult<RestoreBackupOutputResponse, RestoreBackupOutputError>) -> Void)
