...
extension GuardDutyClientTypes.DataSourceFreeTrial: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let freeTrialDaysRemainingDecoded = try containerValues.decode(Swift.Int.self, forKey: .freeTrialDaysRemaining)
...
extension GuardDutyClientTypes.KubernetesWorkloadDetails: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let hostNetworkDecoded = try containerValues.decode(Swift.Bool.self, forKey: .hostNetwork)
...
extension GuardDutyClientTypes.RemoteAccountDetails: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let accountIdDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .accountId)
        accountId = accountIdDecoded
        let affiliatedDecoded = try containerValues.decode(Swift.Bool.self, forKey: .affiliated)
