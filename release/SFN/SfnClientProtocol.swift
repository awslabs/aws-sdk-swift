...
public protocol SfnClientProtocol {
    ...
    ///          </note>
    func createActivity(input: CreateActivityInput, completion: @escaping (SdkResult<CreateActivityOutputResponse, CreateActivityOutputError>) -> Void)
    ...
    ///          </note>
    func createStateMachine(input: CreateStateMachineInput, completion: @escaping (SdkResult<CreateStateMachineOutputResponse, CreateStateMachineOutputError>) -> Void)
    /// <p>Deletes an activity.</p>
    func deleteActivity(input: DeleteActivityInput, completion: @escaping (SdkResult<DeleteActivityOutputResponse, DeleteActivityOutputError>) -> Void)
    ...
    ///         API is called.</p>
    ///          </note>
    func deleteStateMachine(input: DeleteStateMachineInput, completion: @escaping (SdkResult<DeleteStateMachineOutputResponse, DeleteStateMachineOutputError>) -> Void)
    /// <p>Describes an activity.</p>
    ///          <note>
    ///             <p>This operation is eventually consistent. The results are best effort and may not reflect very recent updates and changes.</p>
    ///          </note>
    func describeActivity(input: DescribeActivityInput, completion: @escaping (SdkResult<DescribeActivityOutputResponse, DescribeActivityOutputError>) -> Void)
    /// <p>Describes an execution.</p>
    ///          <note>
    ///             <p>This operation is eventually consistent. The results are best effort and may not reflect very recent updates and changes.</p>
    ///          </note>
    ///          <p>This API action is not supported by <code>EXPRESS</code> state machines.</p>
    func describeExecution(input: DescribeExecutionInput, completion: @escaping (SdkResult<DescribeExecutionOutputResponse, DescribeExecutionOutputError>) -> Void)
    /// <p>Describes a state machine.</p>
    ///          <note>
    ///             <p>This operation is eventually consistent. The results are best effort and may not reflect very recent updates and changes.</p>
    ///          </note>
    func describeStateMachine(input: DescribeStateMachineInput, completion: @escaping (SdkResult<DescribeStateMachineOutputResponse, DescribeStateMachineOutputError>) -> Void)
    /// <p>Describes the state machine associated with a specific execution.</p>
    ///          <note>
    ///             <p>This operation is eventually consistent. The results are best effort and may not reflect very recent updates and changes.</p>
    ///          </note>
    ///          <p>This API action is not supported by <code>EXPRESS</code> state machines.</p>
    func describeStateMachineForExecution(input: DescribeStateMachineForExecutionInput, completion: @escaping (SdkResult<DescribeStateMachineForExecutionOutputResponse, DescribeStateMachineForExecutionOutputError>) -> Void)
    ...
    ///          </important>
    func getActivityTask(input: GetActivityTaskInput, completion: @escaping (SdkResult<GetActivityTaskOutputResponse, GetActivityTaskOutputError>) -> Void)
    ...
    ///          <p>This API action is not supported by <code>EXPRESS</code> state machines.</p>
    func getExecutionHistory(input: GetExecutionHistoryInput, completion: @escaping (SdkResult<GetExecutionHistoryOutputResponse, GetExecutionHistoryOutputError>) -> Void)
    ...
    ///             <p>This operation is eventually consistent. The results are best effort and may not reflect very recent updates and changes.</p>
    ///          </note>
    func listActivities(input: ListActivitiesInput, completion: @escaping (SdkResult<ListActivitiesOutputResponse, ListActivitiesOutputError>) -> Void)
    ...
    ///          </note>
    ///          <p>This API action is not supported by <code>EXPRESS</code> state machines.</p>
    func listExecutions(input: ListExecutionsInput, completion: @escaping (SdkResult<ListExecutionsOutputResponse, ListExecutionsOutputError>) -> Void)
    ...
    ///             <p>This operation is eventually consistent. The results are best effort and may not reflect very recent updates and changes.</p>
    ///          </note>
    func listStateMachines(input: ListStateMachinesInput, completion: @escaping (SdkResult<ListStateMachinesOutputResponse, ListStateMachinesOutputError>) -> Void)
    ...
    func sendTaskFailure(input: SendTaskFailureInput, completion: @escaping (SdkResult<SendTaskFailureOutputResponse, SendTaskFailureOutputError>) -> Void)
    /// <p>Used by activity workers and task states using the <a href="https://docs.aws.amazon.com/step-functions/latest/dg/connect-to-resource.html#connect-wait-token">callback</a>
    ...
    ///         for heartbeats.</p>
    ///          </note>
    func sendTaskHeartbeat(input: SendTaskHeartbeatInput, completion: @escaping (SdkResult<SendTaskHeartbeatOutputResponse, SendTaskHeartbeatOutputError>) -> Void)
    /// <p>Used by activity workers and task states using the <a href="https://docs.aws.amazon.com/step-functions/latest/dg/connect-to-resource.html#connect-wait-token">callback</a>
    ///       pattern to report that the task identified by the <code>taskToken</code> completed
    ///       successfully.</p>
    func sendTaskSuccess(input: SendTaskSuccessInput, completion: @escaping (SdkResult<SendTaskSuccessOutputResponse, SendTaskSuccessOutputError>) -> Void)
    ...
    ///         days. </p>
    ///          </note>
    func startExecution(input: StartExecutionInput, completion: @escaping (SdkResult<StartExecutionOutputResponse, StartExecutionOutputError>) -> Void)
    /// <p>Starts a Synchronous Express state machine execution.</p>
    func startSyncExecution(input: StartSyncExecutionInput, completion: @escaping (SdkResult<StartSyncExecutionOutputResponse, StartSyncExecutionOutputError>) -> Void)
    /// <p>Stops an execution.</p>
    ///          <p>This API action is not supported by <code>EXPRESS</code> state machines.</p>
    func stopExecution(input: StopExecutionInput, completion: @escaping (SdkResult<StopExecutionOutputResponse, StopExecutionOutputError>) -> Void)
    ...
    ///          </note>
    func updateStateMachine(input: UpdateStateMachineInput, completion: @escaping (SdkResult<UpdateStateMachineOutputResponse, UpdateStateMachineOutputError>) -> Void)
}
