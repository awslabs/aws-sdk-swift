...
public class MarketplaceCatalogClient {
    ...
    let config: MarketplaceCatalogClientConfiguration
    let serviceName = "Marketplace Catalog"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: MarketplaceCatalogClientConfiguration) {
    ...
    public class MarketplaceCatalogClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        public static func `default`() throws -> MarketplaceCatalogClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try MarketplaceCatalogClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
...
extension MarketplaceCatalogClient: MarketplaceCatalogClientProtocol {
    ...
    ///             calls.</p>
    public func cancelChangeSet(input: CancelChangeSetInput, completion: @escaping (SdkResult<CancelChangeSetOutput, CancelChangeSetOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<CancelChangeSetInput, CancelChangeSetOutput, CancelChangeSetOutputError>(id: "cancelChangeSet")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CancelChangeSetInput, CancelChangeSetOutput, CancelChangeSetOutputError>(contentType: "application/json"))
    ...
    public func describeChangeSet(input: DescribeChangeSetInput, completion: @escaping (SdkResult<DescribeChangeSetOutput, DescribeChangeSetOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "aws-marketplace")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeChangeSetInput, DescribeChangeSetOutput, DescribeChangeSetOutputError>(id: "describeChangeSet")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeChangeSetInput, DescribeChangeSetOutput, DescribeChangeSetOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeEntity(input: DescribeEntityInput, completion: @escaping (SdkResult<DescribeEntityOutput, DescribeEntityOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "aws-marketplace")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeEntityInput, DescribeEntityOutput, DescribeEntityOutputError>(id: "describeEntity")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeEntityInput, DescribeEntityOutput, DescribeEntityOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             calls.</p>
    public func listChangeSets(input: ListChangeSetsInput, completion: @escaping (SdkResult<ListChangeSetsOutput, ListChangeSetsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "aws-marketplace")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListChangeSetsInput, ListChangeSetsOutput, ListChangeSetsOutputError>(id: "listChangeSets")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListChangeSetsInput, ListChangeSetsOutput, ListChangeSetsOutputError>(contentType: "application/json"))
    ...
    public func listEntities(input: ListEntitiesInput, completion: @escaping (SdkResult<ListEntitiesOutput, ListEntitiesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "aws-marketplace")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListEntitiesInput, ListEntitiesOutput, ListEntitiesOutputError>(id: "listEntities")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListEntitiesInput, ListEntitiesOutput, ListEntitiesOutputError>(contentType: "application/json"))
    ...
    public func startChangeSet(input: StartChangeSetInput, completion: @escaping (SdkResult<StartChangeSetOutput, StartChangeSetOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "aws-marketplace")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartChangeSetInput, StartChangeSetOutput, StartChangeSetOutputError>(id: "startChangeSet")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartChangeSetInput, StartChangeSetOutput, StartChangeSetOutputError>(contentType: "application/json"))
