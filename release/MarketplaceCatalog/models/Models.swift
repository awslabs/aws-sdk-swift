...
extension CancelChangeSetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CancelChangeSetInput(catalog: \(Swift.String(describing: catalog)), changeSetId: \(Swift.String(describing: changeSetId)))"}
}

extension CancelChangeSetInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct CancelChangeSetInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelChangeSetInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CancelChangeSetInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CancelChangeSetOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CancelChangeSetInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CancelChangeSetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelChangeSetOutputError>
}

public struct CancelChangeSetInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelChangeSetInputQueryItemMiddleware"
...
extension CancelChangeSetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CancelChangeSetOutputResponse(changeSetArn: \(Swift.String(describing: changeSetArn)), changeSetId: \(Swift.String(describing: changeSetId)))"}
}
...
extension MarketplaceCatalogClientTypes.Change: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MarketplaceCatalogClientTypes.Change: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Change(changeName: \(Swift.String(describing: changeName)), changeType: \(Swift.String(describing: changeType)), details: \(Swift.String(describing: details)), entity: \(Swift.String(describing: entity)))"}
}
...
extension MarketplaceCatalogClientTypes {
    ...
    public struct Change: Swift.Equatable {
        ...
        public let changeName: Swift.String?
        ...
        ///             scope.</p>
        public let changeType: Swift.String?
        ...
        public let entity: MarketplaceCatalogClientTypes.Entity?
...
extension MarketplaceCatalogClientTypes.ChangeSetSummaryListItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case changeSetArn = "ChangeSetArn"
        case changeSetId = "ChangeSetId"
...
extension MarketplaceCatalogClientTypes.ChangeSetSummaryListItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ChangeSetSummaryListItem(changeSetArn: \(Swift.String(describing: changeSetArn)), changeSetId: \(Swift.String(describing: changeSetId)), changeSetName: \(Swift.String(describing: changeSetName)), endTime: \(Swift.String(describing: endTime)), entityIdList: \(Swift.String(describing: entityIdList)), failureCode: \(Swift.String(describing: failureCode)), startTime: \(Swift.String(describing: startTime)), status: \(Swift.String(describing: status)))"}
}
...
extension MarketplaceCatalogClientTypes {
    ...
    public struct ChangeSetSummaryListItem: Swift.Equatable {
        ...
        public let entityIdList: [Swift.String]?
        ...
        public let failureCode: MarketplaceCatalogClientTypes.FailureCode?
        /// <p>The time, in ISO 8601 format (2018-02-27T13:45:22Z), when the change set was
        ///             started.</p>
        public let startTime: Swift.String?
        /// <p>The current status of the change set.</p>
        public let status: MarketplaceCatalogClientTypes.ChangeStatus?
...
extension MarketplaceCatalogClientTypes.ChangeSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case changeName = "ChangeName"
        case changeType = "ChangeType"
        case details = "Details"
...
extension MarketplaceCatalogClientTypes.ChangeSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ChangeSummary(changeName: \(Swift.String(describing: changeName)), changeType: \(Swift.String(describing: changeType)), details: \(Swift.String(describing: details)), entity: \(Swift.String(describing: entity)), errorDetailList: \(Swift.String(describing: errorDetailList)))"}
}
...
extension MarketplaceCatalogClientTypes {
    ...
    public struct ChangeSummary: Swift.Equatable {
        ...
        public let errorDetailList: [MarketplaceCatalogClientTypes.ErrorDetail]?
...
extension DescribeChangeSetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeChangeSetInput(catalog: \(Swift.String(describing: catalog)), changeSetId: \(Swift.String(describing: changeSetId)))"}
}
...
extension DescribeChangeSetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeChangeSetOutputResponse(changeSet: \(Swift.String(describing: changeSet)), changeSetArn: \(Swift.String(describing: changeSetArn)), changeSetId: \(Swift.String(describing: changeSetId)), changeSetName: \(Swift.String(describing: changeSetName)), endTime: \(Swift.String(describing: endTime)), failureCode: \(Swift.String(describing: failureCode)), failureDescription: \(Swift.String(describing: failureDescription)), startTime: \(Swift.String(describing: startTime)), status: \(Swift.String(describing: status)))"}
}
...
public struct DescribeChangeSetOutputResponse: Swift.Equatable {
    ...
    public let changeSet: [MarketplaceCatalogClientTypes.ChangeSummary]?
    /// <p>The ARN associated with the unique identifier for the change set referenced in this
    ///             request.</p>
    public let changeSetArn: Swift.String?
...
extension DescribeEntityInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEntityInput(catalog: \(Swift.String(describing: catalog)), entityId: \(Swift.String(describing: entityId)))"}
}

extension DescribeEntityInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeEntityInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEntityInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeEntityInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeEntityOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeEntityInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeEntityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeEntityOutputError>
}

public struct DescribeEntityInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEntityInputQueryItemMiddleware"
...
extension DescribeEntityOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeEntityOutputResponse(details: \(Swift.String(describing: details)), entityArn: \(Swift.String(describing: entityArn)), entityIdentifier: \(Swift.String(describing: entityIdentifier)), entityType: \(Swift.String(describing: entityType)), lastModifiedDate: \(Swift.String(describing: lastModifiedDate)))"}
}
...
public struct DescribeEntityOutputResponse: Swift.Equatable {
    ...
    public let lastModifiedDate: Swift.String?
...
extension MarketplaceCatalogClientTypes.Entity: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MarketplaceCatalogClientTypes.Entity: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Entity(identifier: \(Swift.String(describing: identifier)), type: \(Swift.String(describing: type)))"}
}
...
extension MarketplaceCatalogClientTypes.EntitySummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case entityArn = "EntityArn"
...
extension MarketplaceCatalogClientTypes.EntitySummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EntitySummary(entityArn: \(Swift.String(describing: entityArn)), entityId: \(Swift.String(describing: entityId)), entityType: \(Swift.String(describing: entityType)), lastModifiedDate: \(Swift.String(describing: lastModifiedDate)), name: \(Swift.String(describing: name)), visibility: \(Swift.String(describing: visibility)))"}
}
...
extension MarketplaceCatalogClientTypes.ErrorDetail: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MarketplaceCatalogClientTypes.ErrorDetail: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension MarketplaceCatalogClientTypes.Filter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
...
extension MarketplaceCatalogClientTypes.Filter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Filter(name: \(Swift.String(describing: name)), valueList: \(Swift.String(describing: valueList)))"}
}
...
extension MarketplaceCatalogClientTypes {
    ...
    public struct Filter: Swift.Equatable {
        ...
        ///             </li>
        ///          </ul>
        public let valueList: [Swift.String]?
...
extension ListChangeSetsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListChangeSetsInput(catalog: \(Swift.String(describing: catalog)), filterList: \(Swift.String(describing: filterList)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), sort: \(Swift.String(describing: sort)))"}
}
...
public struct ListChangeSetsInput: Swift.Equatable {
    ...
    public let filterList: [MarketplaceCatalogClientTypes.Filter]?
    ...
    public let sort: MarketplaceCatalogClientTypes.Sort?
...
extension ListChangeSetsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListChangeSetsOutputResponse(changeSetSummaryList: \(Swift.String(describing: changeSetSummaryList)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct ListChangeSetsOutputResponse: Swift.Equatable {
    ...
    public let changeSetSummaryList: [MarketplaceCatalogClientTypes.ChangeSetSummaryListItem]?
...
extension ListEntitiesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListEntitiesInput(catalog: \(Swift.String(describing: catalog)), entityType: \(Swift.String(describing: entityType)), filterList: \(Swift.String(describing: filterList)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), sort: \(Swift.String(describing: sort)))"}
}
...
extension ListEntitiesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListEntitiesOutputResponse(entitySummaryList: \(Swift.String(describing: entitySummaryList)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct ListEntitiesOutputResponse: Swift.Equatable {
    ...
    public let entitySummaryList: [MarketplaceCatalogClientTypes.EntitySummary]?
...
extension ResourceNotSupportedException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceNotSupportedException(message: \(Swift.String(describing: message)))"}
}

extension ResourceNotSupportedException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct ResourceNotSupportedException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension MarketplaceCatalogClientTypes.Sort: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case sortBy = "SortBy"
...
extension MarketplaceCatalogClientTypes.Sort: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Sort(sortBy: \(Swift.String(describing: sortBy)), sortOrder: \(Swift.String(describing: sortOrder)))"}
}
...
extension MarketplaceCatalogClientTypes {
    ...
    public struct Sort: Swift.Equatable {
        ...
        public let sortOrder: MarketplaceCatalogClientTypes.SortOrder?
...
public struct StartChangeSetInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartChangeSetInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartChangeSetInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartChangeSetOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartChangeSetInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartChangeSetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartChangeSetOutputError>
}

extension StartChangeSetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartChangeSetInput(catalog: \(Swift.String(describing: catalog)), changeSet: \(Swift.String(describing: changeSet)), changeSetName: \(Swift.String(describing: changeSetName)), clientRequestToken: \(Swift.String(describing: clientRequestToken)))"}
}

extension StartChangeSetInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case catalog = "Catalog"
        case changeSet = "ChangeSet"
        case changeSetName = "ChangeSetName"
...
public struct StartChangeSetInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartChangeSetInputHeadersMiddleware"
...
public struct StartChangeSetInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartChangeSetInputQueryItemMiddleware"
...
public struct StartChangeSetInput: Swift.Equatable {
    ...
    public let changeSet: [MarketplaceCatalogClientTypes.Change]?
...
extension StartChangeSetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartChangeSetOutputResponse(changeSetArn: \(Swift.String(describing: changeSetArn)), changeSetId: \(Swift.String(describing: changeSetId)))"}
}
