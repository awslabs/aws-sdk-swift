...
public protocol MarketplaceCatalogClientProtocol {
    ...
    ///             calls.</p>
    func cancelChangeSet(input: CancelChangeSetInput, completion: @escaping (SdkResult<CancelChangeSetOutput, CancelChangeSetOutputError>) -> Void)
    ...
    func describeEntity(input: DescribeEntityInput, completion: @escaping (SdkResult<DescribeEntityOutput, DescribeEntityOutputError>) -> Void)
    ...
    func listEntities(input: ListEntitiesInput, completion: @escaping (SdkResult<ListEntitiesOutput, ListEntitiesOutputError>) -> Void)
    ...
    func startChangeSet(input: StartChangeSetInput, completion: @escaping (SdkResult<StartChangeSetOutput, StartChangeSetOutputError>) -> Void)
}
