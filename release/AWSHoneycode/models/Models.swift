...
extension AutomationExecutionException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AutomationExecutionException(message: \(Swift.String(describing: message)))"}
}
...
extension AutomationExecutionTimeoutException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AutomationExecutionTimeoutException(message: \(Swift.String(describing: message)))"}
}
...
public struct BatchCreateTableRowsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchCreateTableRowsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<BatchCreateTableRowsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<BatchCreateTableRowsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<BatchCreateTableRowsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<BatchCreateTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchCreateTableRowsOutputError>
}

extension BatchCreateTableRowsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchCreateTableRowsInput(clientRequestToken: \(Swift.String(describing: clientRequestToken)), rowsToCreate: \(Swift.String(describing: rowsToCreate)), tableId: \(Swift.String(describing: tableId)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension BatchCreateTableRowsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct BatchCreateTableRowsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchCreateTableRowsInputHeadersMiddleware"
...
public struct BatchCreateTableRowsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchCreateTableRowsInputQueryItemMiddleware"
...
public struct BatchCreateTableRowsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchCreateTableRowsInputURLHostMiddleware"
    ...
    public typealias MInput = BatchCreateTableRowsInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchCreateTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchCreateTableRowsOutputError>
}

public struct BatchCreateTableRowsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchCreateTableRowsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let workbookId = input.workbookId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("workbookId is nil and needs a value for the path of this operation"))))
        }
        guard let tableId = input.tableId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("tableId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/tables/\(tableId.urlPercentEncoding())/rows/batchcreate"
...
struct BatchCreateTableRowsInputBody: Swift.Equatable {
    public let rowsToCreate: [HoneycodeClientTypes.CreateRowData]?
...
extension BatchCreateTableRowsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchCreateTableRowsOutputResponse(createdRows: \(Swift.String(describing: createdRows)), failedBatchItems: \(Swift.String(describing: failedBatchItems)), workbookCursor: \(Swift.String(describing: workbookCursor)))"}
}
...
struct BatchCreateTableRowsOutputResponseBody: Swift.Equatable {
    public let workbookCursor: Swift.Int
    public let createdRows: [Swift.String:Swift.String]?
    public let failedBatchItems: [HoneycodeClientTypes.FailedBatchItem]?
}
...
public struct BatchDeleteTableRowsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDeleteTableRowsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<BatchDeleteTableRowsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<BatchDeleteTableRowsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<BatchDeleteTableRowsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<BatchDeleteTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchDeleteTableRowsOutputError>
}

extension BatchDeleteTableRowsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchDeleteTableRowsInput(clientRequestToken: \(Swift.String(describing: clientRequestToken)), rowIds: \(Swift.String(describing: rowIds)), tableId: \(Swift.String(describing: tableId)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension BatchDeleteTableRowsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientRequestToken
        case rowIds
    }
...
public struct BatchDeleteTableRowsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDeleteTableRowsInputHeadersMiddleware"
...
public struct BatchDeleteTableRowsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDeleteTableRowsInputQueryItemMiddleware"
...
public struct BatchDeleteTableRowsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDeleteTableRowsInputURLHostMiddleware"
    ...
    public typealias MInput = BatchDeleteTableRowsInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchDeleteTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchDeleteTableRowsOutputError>
}

public struct BatchDeleteTableRowsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDeleteTableRowsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/tables/\(tableId.urlPercentEncoding())/rows/batchdelete"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct BatchDeleteTableRowsInputBody: Swift.Equatable {
    public let rowIds: [Swift.String]?
    public let clientRequestToken: Swift.String?
}
...
extension BatchDeleteTableRowsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchDeleteTableRowsOutputResponse(failedBatchItems: \(Swift.String(describing: failedBatchItems)), workbookCursor: \(Swift.String(describing: workbookCursor)))"}
}
...
public struct BatchUpdateTableRowsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpdateTableRowsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<BatchUpdateTableRowsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<BatchUpdateTableRowsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<BatchUpdateTableRowsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<BatchUpdateTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchUpdateTableRowsOutputError>
}

extension BatchUpdateTableRowsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchUpdateTableRowsInput(clientRequestToken: \(Swift.String(describing: clientRequestToken)), rowsToUpdate: \(Swift.String(describing: rowsToUpdate)), tableId: \(Swift.String(describing: tableId)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension BatchUpdateTableRowsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientRequestToken
        case rowsToUpdate
    }
...
public struct BatchUpdateTableRowsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpdateTableRowsInputHeadersMiddleware"
...
public struct BatchUpdateTableRowsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpdateTableRowsInputQueryItemMiddleware"
...
public struct BatchUpdateTableRowsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpdateTableRowsInputURLHostMiddleware"
    ...
    public typealias MInput = BatchUpdateTableRowsInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchUpdateTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchUpdateTableRowsOutputError>
}

public struct BatchUpdateTableRowsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpdateTableRowsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/tables/\(tableId.urlPercentEncoding())/rows/batchupdate"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct BatchUpdateTableRowsInputBody: Swift.Equatable {
    public let rowsToUpdate: [HoneycodeClientTypes.UpdateRowData]?
    public let clientRequestToken: Swift.String?
}
...
extension BatchUpdateTableRowsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchUpdateTableRowsOutputResponse(failedBatchItems: \(Swift.String(describing: failedBatchItems)), workbookCursor: \(Swift.String(describing: workbookCursor)))"}
}
...
public struct BatchUpsertTableRowsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpsertTableRowsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<BatchUpsertTableRowsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<BatchUpsertTableRowsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<BatchUpsertTableRowsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<BatchUpsertTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchUpsertTableRowsOutputError>
}

extension BatchUpsertTableRowsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchUpsertTableRowsInput(clientRequestToken: \(Swift.String(describing: clientRequestToken)), rowsToUpsert: \(Swift.String(describing: rowsToUpsert)), tableId: \(Swift.String(describing: tableId)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension BatchUpsertTableRowsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientRequestToken
        case rowsToUpsert
    }
...
public struct BatchUpsertTableRowsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpsertTableRowsInputHeadersMiddleware"
...
public struct BatchUpsertTableRowsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpsertTableRowsInputQueryItemMiddleware"
...
public struct BatchUpsertTableRowsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpsertTableRowsInputURLHostMiddleware"
    ...
    public typealias MInput = BatchUpsertTableRowsInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchUpsertTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchUpsertTableRowsOutputError>
}

public struct BatchUpsertTableRowsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchUpsertTableRowsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/tables/\(tableId.urlPercentEncoding())/rows/batchupsert"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct BatchUpsertTableRowsInputBody: Swift.Equatable {
    public let rowsToUpsert: [HoneycodeClientTypes.UpsertRowData]?
    public let clientRequestToken: Swift.String?
}
...
extension BatchUpsertTableRowsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchUpsertTableRowsOutputResponse(failedBatchItems: \(Swift.String(describing: failedBatchItems)), rows: \(Swift.String(describing: rows)), workbookCursor: \(Swift.String(describing: workbookCursor)))"}
}
...
struct BatchUpsertTableRowsOutputResponseBody: Swift.Equatable {
    public let rows: [Swift.String:HoneycodeClientTypes.UpsertRowsResult]?
    public let workbookCursor: Swift.Int
    public let failedBatchItems: [HoneycodeClientTypes.FailedBatchItem]?
}
...
extension HoneycodeClientTypes.Cell: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case format
        case formattedValue
        case formula
...
extension HoneycodeClientTypes.CellInput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case fact
    }
...
extension HoneycodeClientTypes.CellInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CellInput(fact: \(Swift.String(describing: fact)))"}
}
...
extension HoneycodeClientTypes.ColumnMetadata: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case format
        case name
    }
...
extension HoneycodeClientTypes.ColumnMetadata: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ColumnMetadata(format: \(Swift.String(describing: format)), name: \(Swift.String(describing: name)))"}
}
...
extension HoneycodeClientTypes.CreateRowData: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case batchItemId
        case cellsToCreate
    }
...
extension HoneycodeClientTypes.CreateRowData: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateRowData(batchItemId: \(Swift.String(describing: batchItemId)), cellsToCreate: \(Swift.String(describing: cellsToCreate)))"}
}
...
extension HoneycodeClientTypes.DataItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case formattedValue
        case overrideFormat
        case rawValue
...
extension HoneycodeClientTypes.DelimitedTextImportOptions: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension HoneycodeClientTypes.DelimitedTextImportOptions: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DelimitedTextImportOptions(dataCharacterEncoding: \(Swift.String(describing: dataCharacterEncoding)), delimiter: \(Swift.String(describing: delimiter)), hasHeaderRow: \(Swift.String(describing: hasHeaderRow)), ignoreEmptyRows: \(Swift.String(describing: ignoreEmptyRows)))"}
}
...
extension DescribeTableDataImportJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeTableDataImportJobInput(jobId: \(Swift.String(describing: jobId)), tableId: \(Swift.String(describing: tableId)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension DescribeTableDataImportJobInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeTableDataImportJobInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeTableDataImportJobInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeTableDataImportJobInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeTableDataImportJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeTableDataImportJobInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeTableDataImportJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeTableDataImportJobOutputError>
}

public struct DescribeTableDataImportJobInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeTableDataImportJobInputQueryItemMiddleware"
...
public struct DescribeTableDataImportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeTableDataImportJobInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeTableDataImportJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeTableDataImportJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeTableDataImportJobOutputError>
}

public struct DescribeTableDataImportJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeTableDataImportJobInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/tables/\(tableId.urlPercentEncoding())/import/\(jobId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeTableDataImportJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeTableDataImportJobOutputResponse(jobMetadata: \(Swift.String(describing: jobMetadata)), jobStatus: \(Swift.String(describing: jobStatus)), message: \(Swift.String(describing: message)))"}
}
...
struct DescribeTableDataImportJobOutputResponseBody: Swift.Equatable {
    public let jobStatus: HoneycodeClientTypes.TableDataImportJobStatus?
    public let message: Swift.String?
    public let jobMetadata: HoneycodeClientTypes.TableDataImportJobMetadata?
}
...
extension HoneycodeClientTypes.DestinationOptions: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case columnMap
    }
...
extension HoneycodeClientTypes.DestinationOptions: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DestinationOptions(columnMap: \(Swift.String(describing: columnMap)))"}
}
...
extension HoneycodeClientTypes.FailedBatchItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case errorMessage
        case id
    }
...
extension HoneycodeClientTypes.FailedBatchItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "FailedBatchItem(errorMessage: \(Swift.String(describing: errorMessage)), id: \(Swift.String(describing: id)))"}
}
...
extension HoneycodeClientTypes.Filter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case contextRowId
        case formula
    }
...
extension HoneycodeClientTypes.Filter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Filter(contextRowId: \(Swift.String(describing: contextRowId)), formula: \(Swift.String(describing: formula)))"}
}
...
public struct GetScreenDataInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetScreenDataInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetScreenDataInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetScreenDataOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetScreenDataInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetScreenDataOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetScreenDataOutputError>
}

extension GetScreenDataInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetScreenDataInput(appId: \(Swift.String(describing: appId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), screenId: \(Swift.String(describing: screenId)), variables: \(Swift.String(describing: variables)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension GetScreenDataInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case appId
        case maxResults
        case nextToken
...
public struct GetScreenDataInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetScreenDataInputHeadersMiddleware"
...
public struct GetScreenDataInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetScreenDataInputQueryItemMiddleware"
...
public struct GetScreenDataInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetScreenDataInputURLHostMiddleware"
    ...
    public typealias MInput = GetScreenDataInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetScreenDataOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetScreenDataOutputError>
}

public struct GetScreenDataInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetScreenDataInputURLPathMiddleware"
...
struct GetScreenDataInputBody: Swift.Equatable {
    public let workbookId: Swift.String?
    public let appId: Swift.String?
    public let screenId: Swift.String?
    public let variables: [Swift.String:HoneycodeClientTypes.VariableValue]?
...
extension GetScreenDataOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetScreenDataOutputResponse(nextToken: \(Swift.String(describing: nextToken)), results: \(Swift.String(describing: results)), workbookCursor: \(Swift.String(describing: workbookCursor)))"}
}
...
struct GetScreenDataOutputResponseBody: Swift.Equatable {
    public let results: [Swift.String:HoneycodeClientTypes.ResultSet]?
    public let workbookCursor: Swift.Int
    public let nextToken: Swift.String?
}
...
extension HoneycodeClientTypes.ImportDataSource: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension HoneycodeClientTypes.ImportDataSource: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ImportDataSource(dataSourceConfig: \(Swift.String(describing: dataSourceConfig)))"}
}
...
extension HoneycodeClientTypes.ImportDataSourceConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case dataSourceUrl
    }
...
extension HoneycodeClientTypes.ImportDataSourceConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ImportDataSourceConfig(dataSourceUrl: \(Swift.String(describing: dataSourceUrl)))"}
}
...
extension HoneycodeClientTypes.ImportJobSubmitter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case email
        case userArn
    }
...
extension HoneycodeClientTypes.ImportJobSubmitter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ImportJobSubmitter(email: \(Swift.String(describing: email)), userArn: \(Swift.String(describing: userArn)))"}
}
...
extension HoneycodeClientTypes.ImportOptions: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension HoneycodeClientTypes.ImportOptions: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ImportOptions(delimitedTextOptions: \(Swift.String(describing: delimitedTextOptions)), destinationOptions: \(Swift.String(describing: destinationOptions)))"}
}
...
public struct InvokeScreenAutomationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeScreenAutomationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<InvokeScreenAutomationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<InvokeScreenAutomationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<InvokeScreenAutomationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<InvokeScreenAutomationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<InvokeScreenAutomationOutputError>
}

extension InvokeScreenAutomationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvokeScreenAutomationInput(appId: \(Swift.String(describing: appId)), clientRequestToken: \(Swift.String(describing: clientRequestToken)), rowId: \(Swift.String(describing: rowId)), screenAutomationId: \(Swift.String(describing: screenAutomationId)), screenId: \(Swift.String(describing: screenId)), variables: \(Swift.String(describing: variables)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension InvokeScreenAutomationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientRequestToken
        case rowId
        case variables
...
public struct InvokeScreenAutomationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeScreenAutomationInputHeadersMiddleware"
...
public struct InvokeScreenAutomationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeScreenAutomationInputQueryItemMiddleware"
...
public struct InvokeScreenAutomationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeScreenAutomationInputURLHostMiddleware"
    ...
    public typealias MInput = InvokeScreenAutomationInput
    public typealias MOutput = ClientRuntime.OperationOutput<InvokeScreenAutomationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<InvokeScreenAutomationOutputError>
}

public struct InvokeScreenAutomationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "InvokeScreenAutomationInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let screenId = input.screenId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("screenId is nil and needs a value for the path of this operation"))))
        }
        guard let screenAutomationId = input.screenAutomationId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("screenAutomationId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/apps/\(appId.urlPercentEncoding())/screens/\(screenId.urlPercentEncoding())/automations/\(screenAutomationId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension InvokeScreenAutomationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvokeScreenAutomationOutputResponse(workbookCursor: \(Swift.String(describing: workbookCursor)))"}
}
...
extension ListTableColumnsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListTableColumnsInput(nextToken: \(Swift.String(describing: nextToken)), tableId: \(Swift.String(describing: tableId)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension ListTableColumnsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListTableColumnsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTableColumnsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListTableColumnsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListTableColumnsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListTableColumnsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListTableColumnsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListTableColumnsOutputError>
}

public struct ListTableColumnsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTableColumnsInputQueryItemMiddleware"
...
public struct ListTableColumnsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTableColumnsInputURLHostMiddleware"
    ...
    public typealias MInput = ListTableColumnsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListTableColumnsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListTableColumnsOutputError>
}

public struct ListTableColumnsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTableColumnsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/tables/\(tableId.urlPercentEncoding())/columns"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListTableColumnsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListTableColumnsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), tableColumns: \(Swift.String(describing: tableColumns)), workbookCursor: \(Swift.String(describing: workbookCursor)))"}
}
...
struct ListTableColumnsOutputResponseBody: Swift.Equatable {
    public let tableColumns: [HoneycodeClientTypes.TableColumn]?
    public let nextToken: Swift.String?
    public let workbookCursor: Swift.Int
}
...
public struct ListTableRowsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTableRowsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListTableRowsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListTableRowsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListTableRowsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListTableRowsOutputError>
}

extension ListTableRowsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListTableRowsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), rowIds: \(Swift.String(describing: rowIds)), tableId: \(Swift.String(describing: tableId)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension ListTableRowsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case maxResults
        case nextToken
        case rowIds
...
public struct ListTableRowsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTableRowsInputHeadersMiddleware"
...
public struct ListTableRowsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTableRowsInputQueryItemMiddleware"
...
public struct ListTableRowsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTableRowsInputURLHostMiddleware"
    ...
    public typealias MInput = ListTableRowsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListTableRowsOutputError>
}

public struct ListTableRowsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTableRowsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/tables/\(tableId.urlPercentEncoding())/rows/list"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListTableRowsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListTableRowsOutputResponse(columnIds: \(Swift.String(describing: columnIds)), nextToken: \(Swift.String(describing: nextToken)), rowIdsNotFound: \(Swift.String(describing: rowIdsNotFound)), rows: \(Swift.String(describing: rows)), workbookCursor: \(Swift.String(describing: workbookCursor)))"}
}
...
struct ListTableRowsOutputResponseBody: Swift.Equatable {
    public let columnIds: [Swift.String]?
    public let rows: [HoneycodeClientTypes.TableRow]?
    public let rowIdsNotFound: [Swift.String]?
    public let nextToken: Swift.String?
    public let workbookCursor: Swift.Int
}
...
extension ListTablesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListTablesInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), workbookId: \(Swift.String(describing: workbookId)))"}
}
...
public struct ListTablesInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/tables"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListTablesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListTablesOutputResponse(nextToken: \(Swift.String(describing: nextToken)), tables: \(Swift.String(describing: tables)), workbookCursor: \(Swift.String(describing: workbookCursor)))"}
}
...
struct ListTablesOutputResponseBody: Swift.Equatable {
    public let tables: [HoneycodeClientTypes.Table]?
    public let nextToken: Swift.String?
    public let workbookCursor: Swift.Int
}
...
public struct QueryTableRowsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "QueryTableRowsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<QueryTableRowsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<QueryTableRowsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<QueryTableRowsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<QueryTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<QueryTableRowsOutputError>
}

extension QueryTableRowsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "QueryTableRowsInput(filterFormula: \(Swift.String(describing: filterFormula)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), tableId: \(Swift.String(describing: tableId)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension QueryTableRowsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filterFormula
        case maxResults
        case nextToken
...
public struct QueryTableRowsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "QueryTableRowsInputHeadersMiddleware"
...
public struct QueryTableRowsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "QueryTableRowsInputQueryItemMiddleware"
...
public struct QueryTableRowsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "QueryTableRowsInputURLHostMiddleware"
    ...
    public typealias MInput = QueryTableRowsInput
    public typealias MOutput = ClientRuntime.OperationOutput<QueryTableRowsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<QueryTableRowsOutputError>
}

public struct QueryTableRowsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "QueryTableRowsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/tables/\(tableId.urlPercentEncoding())/rows/query"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct QueryTableRowsInputBody: Swift.Equatable {
    public let filterFormula: HoneycodeClientTypes.Filter?
    public let maxResults: Swift.Int?
    public let nextToken: Swift.String?
}
...
extension QueryTableRowsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "QueryTableRowsOutputResponse(columnIds: \(Swift.String(describing: columnIds)), nextToken: \(Swift.String(describing: nextToken)), rows: \(Swift.String(describing: rows)), workbookCursor: \(Swift.String(describing: workbookCursor)))"}
}
...
extension HoneycodeClientTypes.ResultRow: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case dataItems
        case rowId
    }
...
extension HoneycodeClientTypes.ResultRow: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResultRow(dataItems: \(Swift.String(describing: dataItems)), rowId: \(Swift.String(describing: rowId)))"}
}
...
extension HoneycodeClientTypes.ResultSet: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case headers
        case rows
    }
...
extension HoneycodeClientTypes.ResultSet: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResultSet(headers: \(Swift.String(describing: headers)), rows: \(Swift.String(describing: rows)))"}
}
...
extension HoneycodeClientTypes.SourceDataColumnProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case columnIndex
    }
...
extension HoneycodeClientTypes.SourceDataColumnProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SourceDataColumnProperties(columnIndex: \(Swift.String(describing: columnIndex)))"}
}
...
public struct StartTableDataImportJobInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartTableDataImportJobInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartTableDataImportJobInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartTableDataImportJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartTableDataImportJobInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartTableDataImportJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartTableDataImportJobOutputError>
}

extension StartTableDataImportJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartTableDataImportJobInput(clientRequestToken: \(Swift.String(describing: clientRequestToken)), dataFormat: \(Swift.String(describing: dataFormat)), dataSource: \(Swift.String(describing: dataSource)), destinationTableId: \(Swift.String(describing: destinationTableId)), importOptions: \(Swift.String(describing: importOptions)), workbookId: \(Swift.String(describing: workbookId)))"}
}

extension StartTableDataImportJobInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientRequestToken
        case dataFormat
        case dataSource
...
public struct StartTableDataImportJobInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartTableDataImportJobInputHeadersMiddleware"
...
public struct StartTableDataImportJobInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartTableDataImportJobInputQueryItemMiddleware"
...
public struct StartTableDataImportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartTableDataImportJobInputURLHostMiddleware"
    ...
    public typealias MInput = StartTableDataImportJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartTableDataImportJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartTableDataImportJobOutputError>
}

public struct StartTableDataImportJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartTableDataImportJobInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let destinationTableId = input.destinationTableId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("destinationTableId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/workbooks/\(workbookId.urlPercentEncoding())/tables/\(destinationTableId.urlPercentEncoding())/import"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct StartTableDataImportJobInputBody: Swift.Equatable {
    public let dataSource: HoneycodeClientTypes.ImportDataSource?
    public let dataFormat: HoneycodeClientTypes.ImportSourceDataFormat?
    public let importOptions: HoneycodeClientTypes.ImportOptions?
    public let clientRequestToken: Swift.String?
}
...
extension StartTableDataImportJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartTableDataImportJobOutputResponse(jobId: \(Swift.String(describing: jobId)), jobStatus: \(Swift.String(describing: jobStatus)))"}
}
...
extension HoneycodeClientTypes.Table: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case tableId
        case tableName
    }
...
extension HoneycodeClientTypes.Table: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Table(tableId: \(Swift.String(describing: tableId)), tableName: \(Swift.String(describing: tableName)))"}
}
...
extension HoneycodeClientTypes.TableColumn: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case format
        case tableColumnId
...
extension HoneycodeClientTypes.TableColumn: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TableColumn(format: \(Swift.String(describing: format)), tableColumnId: \(Swift.String(describing: tableColumnId)), tableColumnName: \(Swift.String(describing: tableColumnName)))"}
}
...
extension HoneycodeClientTypes.TableDataImportJobMetadata: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case dataSource
        case importOptions
        case submitTime
...
extension HoneycodeClientTypes.TableDataImportJobMetadata: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TableDataImportJobMetadata(dataSource: \(Swift.String(describing: dataSource)), importOptions: \(Swift.String(describing: importOptions)), submitTime: \(Swift.String(describing: submitTime)), submitter: \(Swift.String(describing: submitter)))"}
}
...
extension HoneycodeClientTypes.TableRow: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cells
        case rowId
    }
...
extension HoneycodeClientTypes.TableRow: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TableRow(cells: \(Swift.String(describing: cells)), rowId: \(Swift.String(describing: rowId)))"}
}
...
extension HoneycodeClientTypes.UpdateRowData: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cellsToUpdate
        case rowId
    }
...
extension HoneycodeClientTypes.UpdateRowData: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRowData(cellsToUpdate: \(Swift.String(describing: cellsToUpdate)), rowId: \(Swift.String(describing: rowId)))"}
}
...
extension HoneycodeClientTypes.UpsertRowData: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case batchItemId
        case cellsToUpdate
        case filter
...
extension HoneycodeClientTypes.UpsertRowData: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpsertRowData(batchItemId: \(Swift.String(describing: batchItemId)), cellsToUpdate: \(Swift.String(describing: cellsToUpdate)), filter: \(Swift.String(describing: filter)))"}
}
...
extension HoneycodeClientTypes.UpsertRowsResult: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case rowIds
        case upsertAction
    }
...
extension HoneycodeClientTypes.UpsertRowsResult: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpsertRowsResult(rowIds: \(Swift.String(describing: rowIds)), upsertAction: \(Swift.String(describing: upsertAction)))"}
}
...
extension HoneycodeClientTypes.VariableValue: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case rawValue
    }
