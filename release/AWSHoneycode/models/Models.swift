...
public struct BatchCreateTableRowsInput: Swift.Equatable {
    ...
    var rowsToCreate: [HoneycodeClientTypes.CreateRowData]?
...
public struct BatchCreateTableRowsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var createdRows: [Swift.String:Swift.String]?
    ...
    var failedBatchItems: [HoneycodeClientTypes.FailedBatchItem]?
    /// The updated workbook cursor after adding the new rows at the end of the table.
    /// This member is required.
    var workbookCursor: Swift.Int
...
public struct BatchUpdateTableRowsInput: Swift.Equatable {
    ...
    /// This member is required.
    var rowsToUpdate: [HoneycodeClientTypes.UpdateRowData]?
...
public struct BatchUpsertTableRowsInput: Swift.Equatable {
    ...
    /// This member is required.
    var rowsToUpsert: [HoneycodeClientTypes.UpsertRowData]?
...
public struct BatchUpsertTableRowsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var rows: [Swift.String:HoneycodeClientTypes.UpsertRowsResult]?
...
extension HoneycodeClientTypes {
    ...
    public struct Cell: Swift.Equatable {
        ...
        var format: HoneycodeClientTypes.Format?
...
extension HoneycodeClientTypes {
    ...
    public struct CreateRowData: Swift.Equatable {
        ...
        /// This member is required.
        var cellsToCreate: [Swift.String:HoneycodeClientTypes.CellInput]?
...
extension HoneycodeClientTypes {
    ...
    public struct DataItem: Swift.Equatable {
        ...
        var overrideFormat: HoneycodeClientTypes.Format?
...
extension HoneycodeClientTypes {
    ...
    public struct DelimitedTextImportOptions: Swift.Equatable {
        ...
        var dataCharacterEncoding: HoneycodeClientTypes.ImportDataCharacterEncoding?
        /// The delimiter to use for separating columns in a single row of the input.
        /// This member is required.
        var delimiter: Swift.String?
        /// Indicates whether the input file has a header row at the top containing the column names.
        var hasHeaderRow: Swift.Bool
        /// A parameter to indicate whether empty rows should be ignored or be included in the import.
        var ignoreEmptyRows: Swift.Bool
...
public struct DescribeTableDataImportJobOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var jobMetadata: HoneycodeClientTypes.TableDataImportJobMetadata?
    /// The current status of the import job.
    /// This member is required.
    var jobStatus: HoneycodeClientTypes.TableDataImportJobStatus?
...
extension HoneycodeClientTypes {
    ...
    public struct DestinationOptions: Swift.Equatable {
        ...
        var columnMap: [Swift.String:HoneycodeClientTypes.SourceDataColumnProperties]?
...
public struct GetScreenDataInput: Swift.Equatable {
    ...
    /// This member is required.
    var screenId: Swift.String?
    /// Variables are optional and are needed only if the screen requires them to render correctly. Variables are specified as a map where the key is the name of the variable as defined on the screen. The value is an object which currently has only one property, rawValue, which holds the value of the variable to be passed to the screen.
    var variables: [Swift.String:HoneycodeClientTypes.VariableValue]?
...
public struct GetScreenDataOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var results: [Swift.String:HoneycodeClientTypes.ResultSet]?
...
extension HoneycodeClientTypes {
    ...
    public struct ImportDataSource: Swift.Equatable {
        ...
        /// This member is required.
        var dataSourceConfig: HoneycodeClientTypes.ImportDataSourceConfig?
...
extension HoneycodeClientTypes {
    ...
    public struct ImportDataSourceConfig: Swift.Equatable {
        ...
        var dataSourceUrl: Swift.String?
...
extension HoneycodeClientTypes {
    ...
    public struct ImportOptions: Swift.Equatable {
        ...
        var delimitedTextOptions: HoneycodeClientTypes.DelimitedTextImportOptions?
        /// Options relating to the destination of the import request.
        var destinationOptions: HoneycodeClientTypes.DestinationOptions?
...
public struct InvokeScreenAutomationInput: Swift.Equatable {
    ...
    var rowId: Swift.String?
    /// The ID of the automation action to be performed.
    /// This member is required.
    var screenAutomationId: Swift.String?
...
public struct ListTableColumnsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var tableColumns: [HoneycodeClientTypes.TableColumn]?
...
public struct ListTablesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var tables: [HoneycodeClientTypes.Table]?
    /// Indicates the cursor of the workbook at which the data returned by this request is read. Workbook cursor keeps increasing with every update and the increments are not sequential.
    var workbookCursor: Swift.Int
...
public struct QueryTableRowsInput: Swift.Equatable {
    /// An object that represents a filter formula along with the id of the context row under which the filter function needs to evaluate.
    /// This member is required.
    var filterFormula: HoneycodeClientTypes.Filter?
    /// The maximum number of rows to return in each page of the results.
    var maxResults: Swift.Int?
    /// This parameter is optional. If a nextToken is not specified, the API returns the first page of data. Pagination tokens expire after 1 hour. If you use a token that was returned more than an hour back, the API will throw ValidationException.
    var nextToken: Swift.String?
...
extension HoneycodeClientTypes {
    ...
    public struct ResultRow: Swift.Equatable {
        ...
        /// This member is required.
        var dataItems: [HoneycodeClientTypes.DataItem]?
...
extension HoneycodeClientTypes {
    ...
    public struct ResultSet: Swift.Equatable {
        ...
        /// This member is required.
        var headers: [HoneycodeClientTypes.ColumnMetadata]?
        ...
        /// This member is required.
        var rows: [HoneycodeClientTypes.ResultRow]?
...
public struct StartTableDataImportJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var dataFormat: HoneycodeClientTypes.ImportSourceDataFormat?
    ...
    /// This member is required.
    var dataSource: HoneycodeClientTypes.ImportDataSource?
    ...
    /// This member is required.
    var destinationTableId: Swift.String?
    /// The options for customizing this import request.
    /// This member is required.
    var importOptions: HoneycodeClientTypes.ImportOptions?
...
extension HoneycodeClientTypes {
    ...
    public struct TableColumn: Swift.Equatable {
        ...
        var tableColumnId: Swift.String?
        /// The name of the column in the table.
        var tableColumnName: Swift.String?
...
extension HoneycodeClientTypes {
    ...
    public struct TableDataImportJobMetadata: Swift.Equatable {
        ...
        /// This member is required.
        var submitter: HoneycodeClientTypes.ImportJobSubmitter?
...
extension HoneycodeClientTypes {
    ...
    public struct TableRow: Swift.Equatable {
        ...
        /// This member is required.
        var cells: [HoneycodeClientTypes.Cell]?
...
extension HoneycodeClientTypes {
    ...
    public struct UpdateRowData: Swift.Equatable {
        ...
        /// This member is required.
        var cellsToUpdate: [Swift.String:HoneycodeClientTypes.CellInput]?
...
extension HoneycodeClientTypes {
    ...
    public struct UpsertRowData: Swift.Equatable {
        ...
        /// This member is required.
        var filter: HoneycodeClientTypes.Filter?
...
extension HoneycodeClientTypes {
    ...
    public struct UpsertRowsResult: Swift.Equatable {
        ...
        /// This member is required.
        var upsertAction: HoneycodeClientTypes.UpsertAction?
