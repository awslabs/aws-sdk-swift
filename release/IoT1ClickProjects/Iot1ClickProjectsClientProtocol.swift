...
public protocol Iot1ClickProjectsClientProtocol {
    ...
    func associateDeviceWithPlacement(input: AssociateDeviceWithPlacementInput, completion: @escaping (SdkResult<AssociateDeviceWithPlacementOutputResponse, AssociateDeviceWithPlacementOutputError>) -> Void)
    /// <p>Creates an empty placement.</p>
    func createPlacement(input: CreatePlacementInput, completion: @escaping (SdkResult<CreatePlacementOutputResponse, CreatePlacementOutputError>) -> Void)
    ...
    ///          </note>
    func deletePlacement(input: DeletePlacementInput, completion: @escaping (SdkResult<DeletePlacementOutputResponse, DeletePlacementOutputError>) -> Void)
    ...
    func describePlacement(input: DescribePlacementInput, completion: @escaping (SdkResult<DescribePlacementOutputResponse, DescribePlacementOutputError>) -> Void)
    ...
    func disassociateDeviceFromPlacement(input: DisassociateDeviceFromPlacementInput, completion: @escaping (SdkResult<DisassociateDeviceFromPlacementOutputResponse, DisassociateDeviceFromPlacementOutputError>) -> Void)
    /// <p>Returns an object enumerating the devices in a placement.</p>
    func getDevicesInPlacement(input: GetDevicesInPlacementInput, completion: @escaping (SdkResult<GetDevicesInPlacementOutputResponse, GetDevicesInPlacementOutputError>) -> Void)
    /// <p>Lists the placement(s) of a project.</p>
    func listPlacements(input: ListPlacementsInput, completion: @escaping (SdkResult<ListPlacementsOutputResponse, ListPlacementsOutputError>) -> Void)
    ...
    ///       (i.e., "").</p>
    func updatePlacement(input: UpdatePlacementInput, completion: @escaping (SdkResult<UpdatePlacementOutputResponse, UpdatePlacementOutputError>) -> Void)
