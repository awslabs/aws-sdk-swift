...
extension BudgetsClientTypes {
    ...
    public struct Action: Swift.Equatable {
        ...
        /// This member is required.
        var actionThreshold: BudgetsClientTypes.ActionThreshold?
        /// The type of action. This defines the type of tasks that can be carried out by this action. This field also determines the format for definition.
        /// This member is required.
        var actionType: BudgetsClientTypes.ActionType?
        /// This specifies if the action needs manual or automatic approval.
        /// This member is required.
        var approvalModel: BudgetsClientTypes.ApprovalModel?
        /// A string that represents the budget name. The ":" and "\" characters aren't allowed.
        /// This member is required.
        var budgetName: Swift.String?
        /// Where you specify all of the type-specific parameters.
        /// This member is required.
        var definition: BudgetsClientTypes.Definition?
        /// The role passed for action execution and reversion. Roles and actions must be in the same account.
        /// This member is required.
        var executionRoleArn: Swift.String?
        /// The type of a notification. It must be ACTUAL or FORECASTED.
        /// This member is required.
        var notificationType: BudgetsClientTypes.NotificationType?
        /// The status of action.
        /// This member is required.
        var status: BudgetsClientTypes.ActionStatus?
        /// A list of subscribers.
        /// This member is required.
        var subscribers: [BudgetsClientTypes.Subscriber]?
...
extension BudgetsClientTypes {
    ...
    public struct ActionHistory: Swift.Equatable {
        ...
        /// This member is required.
        var actionHistoryDetails: BudgetsClientTypes.ActionHistoryDetails?
        /// This distinguishes between whether the events are triggered by the user or generated by the system.
        /// This member is required.
        var eventType: BudgetsClientTypes.EventType?
...
extension BudgetsClientTypes {
    ...
    public struct ActionHistoryDetails: Swift.Equatable {
        ...
        /// This member is required.
        var action: BudgetsClientTypes.Action?
        /// A generic string.
        /// This member is required.
...
extension BudgetsClientTypes {
    ...
    public struct ActionThreshold: Swift.Equatable {
        ...
        /// This member is required.
        var actionThresholdType: BudgetsClientTypes.ThresholdType?
        /// The threshold of a notification.
        /// This member is required.
        var actionThresholdValue: Swift.Double
...
extension BudgetsClientTypes {
    ...
    public struct Budget: Swift.Equatable {
        ...
        var budgetLimit: BudgetsClientTypes.Spend?
        ...
        /// This member is required.
        var budgetType: BudgetsClientTypes.BudgetType?
        /// The actual and forecasted cost or usage that the budget tracks.
        var calculatedSpend: BudgetsClientTypes.CalculatedSpend?
        ...
        var costFilters: [Swift.String:[Swift.String]]?
        ...
        var costTypes: BudgetsClientTypes.CostTypes?
        ...
        var plannedBudgetLimits: [Swift.String:BudgetsClientTypes.Spend]?
        ...
        var timePeriod: BudgetsClientTypes.TimePeriod?
        /// The length of time until a budget resets the actual and forecasted spend.
        /// This member is required.
        var timeUnit: BudgetsClientTypes.TimeUnit?
...
extension BudgetsClientTypes {
    ...
    public struct BudgetPerformanceHistory: Swift.Equatable {
        ...
        var budgetedAndActualAmountsList: [BudgetsClientTypes.BudgetedAndActualAmounts]?
...
extension BudgetsClientTypes {
    ...
    public struct BudgetedAndActualAmounts: Swift.Equatable {
        ...
        var actualAmount: BudgetsClientTypes.Spend?
        /// The amount of cost or usage that you created the budget for.
        var budgetedAmount: BudgetsClientTypes.Spend?
...
public struct CreateBudgetInput: Swift.Equatable {
    ...
    /// This member is required.
    var budget: BudgetsClientTypes.Budget?
    /// A notification that you want to associate with a budget. A budget can have up to five notifications, and each notification can have one SNS subscriber and up to 10 email subscribers. If you include notifications and subscribers in your CreateBudget call, AWS creates the notifications and subscribers for you.
    var notificationsWithSubscribers: [BudgetsClientTypes.NotificationWithSubscribers]?
...
public struct CreateNotificationInput: Swift.Equatable {
    ...
    /// This member is required.
    var notification: BudgetsClientTypes.Notification?
...
public struct CreateSubscriberInput: Swift.Equatable {
    ...
    /// This member is required.
    var subscriber: BudgetsClientTypes.Subscriber?
...
extension BudgetsClientTypes {
    ...
    public struct Definition: Swift.Equatable {
        ...
        var iamActionDefinition: BudgetsClientTypes.IamActionDefinition?
        /// The service control policies (SCPs) action definition details.
        var scpActionDefinition: BudgetsClientTypes.ScpActionDefinition?
        /// The AWS Systems Manager (SSM) action definition details.
        var ssmActionDefinition: BudgetsClientTypes.SsmActionDefinition?
...
public struct DescribeBudgetActionHistoriesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var actionHistories: [BudgetsClientTypes.ActionHistory]?
    /// A generic string.
    var nextToken: Swift.String?
...
public struct DescribeBudgetActionsForAccountOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var actions: [BudgetsClientTypes.Action]?
    /// A generic string.
    var nextToken: Swift.String?
...
public struct DescribeBudgetPerformanceHistoryOutputResponse: Swift.Equatable {
    ...
    var budgetPerformanceHistory: BudgetsClientTypes.BudgetPerformanceHistory?
    /// A generic string.
    var nextToken: Swift.String?
...
public struct DescribeBudgetsOutputResponse: Swift.Equatable {
    /// A list of budgets.
    var budgets: [BudgetsClientTypes.Budget]?
...
public struct DescribeNotificationsForBudgetOutputResponse: Swift.Equatable {
    ...
    var notifications: [BudgetsClientTypes.Notification]?
...
public struct ExecuteBudgetActionInput: Swift.Equatable {
    ...
    /// This member is required.
    var executionType: BudgetsClientTypes.ExecutionType?
...
extension BudgetsClientTypes {
    ...
    public struct IamActionDefinition: Swift.Equatable {
        ...
        var roles: [Swift.String]?
        /// A list of users to be attached. There must be at least one user.
        var users: [Swift.String]?
...
extension BudgetsClientTypes {
    ...
    public struct Notification: Swift.Equatable {
        ...
        /// This member is required.
        var comparisonOperator: BudgetsClientTypes.ComparisonOperator?
        ...
        var notificationState: BudgetsClientTypes.NotificationState?
        ...
        var thresholdType: BudgetsClientTypes.ThresholdType?
...
extension BudgetsClientTypes {
    ...
    public struct SsmActionDefinition: Swift.Equatable {
        /// The action subType.
        /// This member is required.
        var actionSubType: BudgetsClientTypes.ActionSubType?
...
extension BudgetsClientTypes {
    ...
    public struct Subscriber: Swift.Equatable {
        ...
        /// This member is required.
        var subscriptionType: BudgetsClientTypes.SubscriptionType?
...
public struct UpdateBudgetActionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var newAction: BudgetsClientTypes.Action?
    /// The previous action resource information.
    /// This member is required.
    var oldAction: BudgetsClientTypes.Action?
...
public struct UpdateBudgetInput: Swift.Equatable {
    ...
    /// This member is required.
    var newBudget: BudgetsClientTypes.Budget?
...
public struct UpdateNotificationInput: Swift.Equatable {
    ...
    /// This member is required.
    var newNotification: BudgetsClientTypes.Notification?
    /// The previous notification that is associated with a budget.
    /// This member is required.
    var oldNotification: BudgetsClientTypes.Notification?
...
public struct UpdateSubscriberInput: Swift.Equatable {
    ...
    /// This member is required.
    var newSubscriber: BudgetsClientTypes.Subscriber?
    /// The notification whose subscriber you want to update.
    /// This member is required.
    var notification: BudgetsClientTypes.Notification?
    /// The previous subscriber that is associated with a budget notification.
    /// This member is required.
    var oldSubscriber: BudgetsClientTypes.Subscriber?
