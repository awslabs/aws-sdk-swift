...
extension ElasticInferenceClient: ElasticInferenceClientProtocol {
    ...
    ///         </p>
    public func describeAcceleratorOfferings(input: DescribeAcceleratorOfferingsInput, completion: @escaping (SdkResult<DescribeAcceleratorOfferingsOutput, DescribeAcceleratorOfferingsOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<DescribeAcceleratorOfferingsInput, DescribeAcceleratorOfferingsOutput, DescribeAcceleratorOfferingsOutputError>(id: "describeAcceleratorOfferings")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAcceleratorOfferingsInput, DescribeAcceleratorOfferingsOutput, DescribeAcceleratorOfferingsOutputError>(contentType: "application/json"))
    ...
    ///         </p>
    public func describeAcceleratorTypes(input: DescribeAcceleratorTypesInput, completion: @escaping (SdkResult<DescribeAcceleratorTypesOutput, DescribeAcceleratorTypesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "elastic-inference")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAcceleratorTypesInput, DescribeAcceleratorTypesOutput, DescribeAcceleratorTypesOutputError>(id: "describeAcceleratorTypes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAcceleratorTypesInput, DescribeAcceleratorTypesOutput, DescribeAcceleratorTypesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///         </p>
    public func describeAccelerators(input: DescribeAcceleratorsInput, completion: @escaping (SdkResult<DescribeAcceleratorsOutput, DescribeAcceleratorsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "elastic-inference")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAcceleratorsInput, DescribeAcceleratorsOutput, DescribeAcceleratorsOutputError>(id: "describeAccelerators")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAcceleratorsInput, DescribeAcceleratorsOutput, DescribeAcceleratorsOutputError>(contentType: "application/json"))
