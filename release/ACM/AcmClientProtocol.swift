...
public protocol AcmClientProtocol {
    ...
    func addTagsToCertificate(input: AddTagsToCertificateInput, completion: @escaping (SdkResult<AddTagsToCertificateOutput, AddTagsToCertificateOutputError>) -> Void)
    ...
    func describeCertificate(input: DescribeCertificateInput, completion: @escaping (SdkResult<DescribeCertificateOutput, DescribeCertificateOutputError>) -> Void)
    ...
    func exportCertificate(input: ExportCertificateInput, completion: @escaping (SdkResult<ExportCertificateOutput, ExportCertificateOutputError>) -> Void)
    /// <p>Returns the account
    ///       configuration options associated with an AWS account.</p>
    func getAccountConfiguration(input: GetAccountConfigurationInput, completion: @escaping (SdkResult<GetAccountConfigurationOutput, GetAccountConfigurationOutputError>) -> Void)
    ...
    func getCertificate(input: GetCertificateInput, completion: @escaping (SdkResult<GetCertificateOutput, GetCertificateOutputError>) -> Void)
    ...
    func listCertificates(input: ListCertificatesInput, completion: @escaping (SdkResult<ListCertificatesOutput, ListCertificatesOutputError>) -> Void)
    ...
    func listTagsForCertificate(input: ListTagsForCertificateInput, completion: @escaping (SdkResult<ListTagsForCertificateOutput, ListTagsForCertificateOutputError>) -> Void)
    /// <p>Adds or modifies
    ...
    ///       expiration.</p>
    func putAccountConfiguration(input: PutAccountConfigurationInput, completion: @escaping (SdkResult<PutAccountConfigurationOutput, PutAccountConfigurationOutputError>) -> Void)
    ...
    func removeTagsFromCertificate(input: RemoveTagsFromCertificateInput, completion: @escaping (SdkResult<RemoveTagsFromCertificateOutput, RemoveTagsFromCertificateOutputError>) -> Void)
    ...
    func renewCertificate(input: RenewCertificateInput, completion: @escaping (SdkResult<RenewCertificateOutput, RenewCertificateOutputError>) -> Void)
    ...
    func requestCertificate(input: RequestCertificateInput, completion: @escaping (SdkResult<RequestCertificateOutput, RequestCertificateOutputError>) -> Void)
    ...
    func resendValidationEmail(input: ResendValidationEmailInput, completion: @escaping (SdkResult<ResendValidationEmailOutput, ResendValidationEmailOutputError>) -> Void)
    ...
    func updateCertificateOptions(input: UpdateCertificateOptionsInput, completion: @escaping (SdkResult<UpdateCertificateOptionsOutput, UpdateCertificateOptionsOutputError>) -> Void)
}
