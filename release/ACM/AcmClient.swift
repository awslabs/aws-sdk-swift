...
public class AcmClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try AcmClientConfiguration(region: unwrappedRegion)
    ...
    public class AcmClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("AcmClient")
