...
public extension EmrClient {
    ...
    {
        typealias getAutoTerminationPolicyContinuation = CheckedContinuation<GetAutoTerminationPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getAutoTerminationPolicyContinuation) in
            getAutoTerminationPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putAutoTerminationPolicyContinuation = CheckedContinuation<PutAutoTerminationPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putAutoTerminationPolicyContinuation) in
            putAutoTerminationPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias removeAutoTerminationPolicyContinuation = CheckedContinuation<RemoveAutoTerminationPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: removeAutoTerminationPolicyContinuation) in
            removeAutoTerminationPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
