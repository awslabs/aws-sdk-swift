...
public struct AddNotificationChannelsInput: Swift.Equatable {
    ...
    var channels: Swift.Set<CodeGuruProfilerClientTypes.Channel>?
    /// The name of the profiling group that we are setting up notifications for.
    /// This member is required.
    var profilingGroupName: Swift.String?
...
public struct AddNotificationChannelsOutputResponse: Swift.Equatable {
    ...
    var notificationConfiguration: CodeGuruProfilerClientTypes.NotificationConfiguration?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct AgentConfiguration: Swift.Equatable {
        ...
        var agentParameters: [Swift.String:Swift.String]?
        ...
        /// This member is required.
        var periodInSeconds: Swift.Int?
        /// A Boolean that specifies whether the profiling agent collects profiling data or not. Set to true to enable profiling.
        /// This member is required.
        var shouldProfile: Swift.Bool?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct AgentOrchestrationConfig: Swift.Equatable {
        /// A Boolean that specifies whether the profiling agent collects profiling data or not. Set to true to enable profiling.
        /// This member is required.
        var profilingEnabled: Swift.Bool?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct AggregatedProfileTime: Swift.Equatable {
        ...
        ///
        /// * PT5M — 5 minutes
        var period: CodeGuruProfilerClientTypes.AggregationPeriod?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct Anomaly: Swift.Equatable {
        ...
        /// This member is required.
        var instances: [CodeGuruProfilerClientTypes.AnomalyInstance]?
        /// Details about the metric that the analysis used when it detected the anomaly. The metric includes the name of the frame that was analyzed with the type and thread states used to derive the metric value for that frame.
        /// This member is required.
        var metric: CodeGuruProfilerClientTypes.Metric?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct AnomalyInstance: Swift.Equatable {
        ...
        var userFeedback: CodeGuruProfilerClientTypes.UserFeedback?
...
public struct BatchGetFrameMetricDataInput: Swift.Equatable {
    ...
    var frameMetrics: [CodeGuruProfilerClientTypes.FrameMetric]?
    ...
    ///
    /// * PT5M — 5 minutes
    var targetResolution: CodeGuruProfilerClientTypes.AggregationPeriod?
...
public struct BatchGetFrameMetricDataOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var endTimes: [CodeGuruProfilerClientTypes.TimestampStructure]?
    /// Details of the metrics to request a time series of values. The metric includes the name of the frame, the aggregation type to calculate the metric value for the frame, and the thread states to use to get the count for the metric value of the frame.
    /// This member is required.
    var frameMetricData: [CodeGuruProfilerClientTypes.FrameMetricDatum]?
    ...
    /// * PT5M — 5 minutes
    /// This member is required.
    var resolution: CodeGuruProfilerClientTypes.AggregationPeriod?
    /// The start time of the time period for the returned time series values. This is specified using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC.
    /// This member is required.
    var startTime: ClientRuntime.Date?
    /// List of instances which remained unprocessed. This will create a missing time step in the list of end times.
    /// This member is required.
    var unprocessedEndTimes: [Swift.String:[CodeGuruProfilerClientTypes.TimestampStructure]]?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct Channel: Swift.Equatable, Swift.Hashable {
        ...
        /// This member is required.
        var eventPublishers: Swift.Set<CodeGuruProfilerClientTypes.EventPublisher>?
...
public struct ConfigureAgentInput: Swift.Equatable {
    ...
    var fleetInstanceId: Swift.String?
...
public struct ConfigureAgentOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var configuration: CodeGuruProfilerClientTypes.AgentConfiguration?
...
public struct CreateProfilingGroupInput: Swift.Equatable {
    ...
    var agentOrchestrationConfig: CodeGuruProfilerClientTypes.AgentOrchestrationConfig?
    ...
    var computePlatform: CodeGuruProfilerClientTypes.ComputePlatform?
...
public struct CreateProfilingGroupOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var profilingGroup: CodeGuruProfilerClientTypes.ProfilingGroupDescription?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct FindingsReportSummary: Swift.Equatable {
        ...
        var id: Swift.String?
        /// The end time of the period during which the metric is flagged as anomalous. This is specified using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC.
        var profileEndTime: ClientRuntime.Date?
        /// The start time of the profile the analysis data is about. This is specified using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC.
        var profileStartTime: ClientRuntime.Date?
        /// The name of the profiling group that is associated with the analysis data.
        var profilingGroupName: Swift.String?
        /// The total number of different recommendations that were found by the analysis.
        var totalNumberOfFindings: Swift.Int?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct FrameMetric: Swift.Equatable {
        ...
        /// This member is required.
        var frameName: Swift.String?
        /// List of application runtime thread states used to get the counts for a frame a derive a metric value.
        /// This member is required.
        var threadStates: [Swift.String]?
        ...
        /// This member is required.
        var type: CodeGuruProfilerClientTypes.MetricType?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct FrameMetricDatum: Swift.Equatable {
        /// The frame name, metric type, and thread states. These are used to derive the value of the metric for the frame.
        /// This member is required.
        var frameMetric: CodeGuruProfilerClientTypes.FrameMetric?
...
public struct GetFindingsReportAccountSummaryInput: Swift.Equatable {
    ...
    var dailyReportsOnly: Swift.Bool?
...
public struct GetFindingsReportAccountSummaryOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var reportSummaries: [CodeGuruProfilerClientTypes.FindingsReportSummary]?
...
public struct GetProfileOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var profile: ClientRuntime.Data?
...
public struct GetRecommendationsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var anomalies: [CodeGuruProfilerClientTypes.Anomaly]?
    ...
    /// This member is required.
    var recommendations: [CodeGuruProfilerClientTypes.Recommendation]?
...
public struct ListFindingsReportsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var findingsReportSummaries: [CodeGuruProfilerClientTypes.FindingsReportSummary]?
...
public struct ListProfileTimesInput: Swift.Equatable {
    ...
    var orderBy: CodeGuruProfilerClientTypes.OrderBy?
...
public struct ListProfileTimesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var profileTimes: [CodeGuruProfilerClientTypes.ProfileTime]?
...
public struct ListProfilingGroupsInput: Swift.Equatable {
    ...
    var includeDescription: Swift.Bool?
...
public struct ListProfilingGroupsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var profilingGroupNames: [Swift.String]?
    ...
    var profilingGroups: [CodeGuruProfilerClientTypes.ProfilingGroupDescription]?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct Match: Swift.Equatable {
        ...
        var frameAddress: Swift.String?
        /// The target frame that triggered a match.
        var targetFramesIndex: Swift.Int?
        /// The value in the profile data that exceeded the recommendation threshold.
        var thresholdBreachValue: Swift.Double?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct Pattern: Swift.Equatable {
        ...
        var countersToAggregate: [Swift.String]?
        ...
        var resolutionSteps: Swift.String?
        /// A list of frame names that were searched during the analysis that generated a recommendation.
        var targetFrames: [[Swift.String]]?
        /// The percentage of time an application spends in one method that triggers a recommendation. The percentage of time is the same as the percentage of the total gathered sample counts during analysis.
        var thresholdPercent: Swift.Double
...
public struct PostAgentProfileInput: Swift.Equatable {
    ...
    /// This member is required.
    var agentProfile: ClientRuntime.Data?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct ProfilingGroupDescription: Swift.Equatable {
        ...
        var profilingStatus: CodeGuruProfilerClientTypes.ProfilingStatus?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct ProfilingStatus: Swift.Equatable {
        ...
        var latestAgentOrchestratedAt: ClientRuntime.Date?
        /// The date and time when the most recent profile was received. Specify using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC.
        var latestAgentProfileReportedAt: ClientRuntime.Date?
        ...
        var latestAggregatedProfile: CodeGuruProfilerClientTypes.AggregatedProfileTime?
...
public struct PutPermissionInput: Swift.Equatable {
    ...
    /// This member is required.
    var actionGroup: CodeGuruProfilerClientTypes.ActionGroup?
...
extension CodeGuruProfilerClientTypes {
    ...
    public struct Recommendation: Swift.Equatable {
        ...
        /// This member is required.
        var allMatchesCount: Swift.Int?
        /// How much of the total sample count is potentially affected.
        /// This member is required.
        var allMatchesSum: Swift.Double?
        /// End time of the profile that was used by this analysis. This is specified using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC.
        /// This member is required.
        var endTime: ClientRuntime.Date?
        /// The pattern that analysis recognized in the profile to make this recommendation.
        /// This member is required.
        var pattern: CodeGuruProfilerClientTypes.Pattern?
        /// The start time of the profile that was used by this analysis. This is specified using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC.
        /// This member is required.
        var startTime: ClientRuntime.Date?
        /// List of the matches with most impact.
        /// This member is required.
        var topMatches: [CodeGuruProfilerClientTypes.Match]?
...
public struct SubmitFeedbackInput: Swift.Equatable {
    ...
    /// This member is required.
    var anomalyInstanceId: Swift.String?
    ...
    /// This member is required.
    var type: CodeGuruProfilerClientTypes.FeedbackType?
