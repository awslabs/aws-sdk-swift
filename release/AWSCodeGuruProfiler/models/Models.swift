...
public struct AddNotificationChannelsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddNotificationChannelsInputURLHostMiddleware"
    ...
    public typealias MInput = AddNotificationChannelsInput
    public typealias MOutput = ClientRuntime.OperationOutput<AddNotificationChannelsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AddNotificationChannelsOutputError>
}

public struct AddNotificationChannelsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddNotificationChannelsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let profilingGroupName = input.profilingGroupName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("profilingGroupName is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/profilingGroups/\(profilingGroupName.urlPercentEncoding())/notificationConfiguration"
...
public struct BatchGetFrameMetricDataInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchGetFrameMetricDataInputURLHostMiddleware"
    ...
    public typealias MInput = BatchGetFrameMetricDataInput
    public typealias MOutput = ClientRuntime.OperationOutput<BatchGetFrameMetricDataOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchGetFrameMetricDataOutputError>
}

public struct BatchGetFrameMetricDataInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchGetFrameMetricDataInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/profilingGroups/\(profilingGroupName.urlPercentEncoding())/frames/-/metrics"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ConfigureAgentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ConfigureAgentInputURLHostMiddleware"
    ...
    public typealias MInput = ConfigureAgentInput
    public typealias MOutput = ClientRuntime.OperationOutput<ConfigureAgentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ConfigureAgentOutputError>
}

public struct ConfigureAgentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ConfigureAgentInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/profilingGroups/\(profilingGroupName.urlPercentEncoding())/configureAgent"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreateProfilingGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateProfilingGroupInputURLHostMiddleware"
    ...
    public typealias MInput = CreateProfilingGroupInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateProfilingGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateProfilingGroupOutputError>
}

public struct CreateProfilingGroupInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateProfilingGroupInputURLPathMiddleware"
...
public struct DeleteProfilingGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfilingGroupInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteProfilingGroupInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteProfilingGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteProfilingGroupOutputError>
}

public struct DeleteProfilingGroupInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfilingGroupInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/profilingGroups/\(profilingGroupName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeProfilingGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeProfilingGroupInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeProfilingGroupInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeProfilingGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeProfilingGroupOutputError>
}

public struct DescribeProfilingGroupInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeProfilingGroupInputURLPathMiddleware"
...
public struct GetFindingsReportAccountSummaryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetFindingsReportAccountSummaryInputURLHostMiddleware"
    ...
    public typealias MInput = GetFindingsReportAccountSummaryInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetFindingsReportAccountSummaryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetFindingsReportAccountSummaryOutputError>
}

public struct GetFindingsReportAccountSummaryInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetFindingsReportAccountSummaryInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/internal/findingsReports"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetNotificationConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetNotificationConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = GetNotificationConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetNotificationConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetNotificationConfigurationOutputError>
}

public struct GetNotificationConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetNotificationConfigurationInputURLPathMiddleware"
...
public struct GetPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/profilingGroups/\(profilingGroupName.urlPercentEncoding())/policy"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetProfileInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetProfileInputURLHostMiddleware"
    ...
    public typealias MInput = GetProfileInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetProfileOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetProfileOutputError>
}

public struct GetProfileInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetProfileInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/profilingGroups/\(profilingGroupName.urlPercentEncoding())/profile"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetRecommendationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRecommendationsInputURLHostMiddleware"
...
public struct GetRecommendationsInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/internal/profilingGroups/\(profilingGroupName.urlPercentEncoding())/recommendations"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListFindingsReportsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListFindingsReportsInputURLHostMiddleware"
    ...
    public typealias MInput = ListFindingsReportsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListFindingsReportsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListFindingsReportsOutputError>
}

public struct ListFindingsReportsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListFindingsReportsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/internal/profilingGroups/\(profilingGroupName.urlPercentEncoding())/findingsReports"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListFindingsReportsOutputResponse: Swift.Equatable {
    ...
    ///          When the results of a ListFindingsReports request exceed maxResults, this
    ///          value can be used to retrieve the next page of results. This value is null when there are no more
    ///          results to return.
    public var nextToken: Swift.String?
...
public struct ListProfileTimesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileTimesInputURLHostMiddleware"
    ...
    public typealias MInput = ListProfileTimesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListProfileTimesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListProfileTimesOutputError>
}

public struct ListProfileTimesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileTimesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/profilingGroups/\(profilingGroupName.urlPercentEncoding())/profileTimes"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListProfilingGroupsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfilingGroupsInputURLHostMiddleware"
    ...
    public typealias MInput = ListProfilingGroupsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListProfilingGroupsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListProfilingGroupsOutputError>
}

public struct ListProfilingGroupsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfilingGroupsInputURLPathMiddleware"
...
public struct ListProfilingGroupsOutputResponse: Swift.Equatable {
    ...
    ///          When the results of a ListProfilingGroups request exceed maxResults, this
    ///          value can be used to retrieve the next page of results. This value is null when there are no more
    ///          results to return.
    public var nextToken: Swift.String?
    ///
    ...
    ///                ProfilingGroupDescription
    ///
    ///          objects is returned only if includeDescription is true, otherwise a list of profiling group names is returned.
    ///
...
extension CodeGuruProfilerClientTypes {
    /// The configuration for notifications stored for each profiling group. This includes up to
    ...
    public struct NotificationConfiguration: Swift.Equatable {
        /// List of up to two channels to be used for sending notifications for events detected from
...
public struct PostAgentProfileInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostAgentProfileInputURLHostMiddleware"
    ...
    public typealias MInput = PostAgentProfileInput
    public typealias MOutput = ClientRuntime.OperationOutput<PostAgentProfileOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PostAgentProfileOutputError>
}

public struct PostAgentProfileInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostAgentProfileInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/profilingGroups/\(profilingGroupName.urlPercentEncoding())/agentProfile"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct PutPermissionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutPermissionInputURLHostMiddleware"
    ...
    public typealias MInput = PutPermissionInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutPermissionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutPermissionOutputError>
}

public struct PutPermissionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutPermissionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let actionGroup = input.actionGroup else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("actionGroup is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/profilingGroups/\(profilingGroupName.urlPercentEncoding())/policy/\(actionGroup.rawValue.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct RemoveNotificationChannelInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RemoveNotificationChannelInputURLHostMiddleware"
...
public struct RemoveNotificationChannelInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let channelId = input.channelId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("channelId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/profilingGroups/\(profilingGroupName.urlPercentEncoding())/notificationConfiguration/\(channelId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct RemovePermissionInput: Swift.Equatable {
    ...
    ///             a profiling group's resource-based policy. One action group is supported, agentPermissions, which
...
///         remove some of the relevant resources, or use <a href="https://docs.aws.amazon.com/servicequotas/latest/userguide/intro.html">Service Quotas to request a
...
public struct SubmitFeedbackInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SubmitFeedbackInputURLHostMiddleware"
    ...
    public typealias MInput = SubmitFeedbackInput
    public typealias MOutput = ClientRuntime.OperationOutput<SubmitFeedbackOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SubmitFeedbackOutputError>
}

public struct SubmitFeedbackInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SubmitFeedbackInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let anomalyInstanceId = input.anomalyInstanceId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("anomalyInstanceId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/internal/profilingGroups/\(profilingGroupName.urlPercentEncoding())/anomalies/\(anomalyInstanceId.urlPercentEncoding())/feedback"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdateProfilingGroupInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateProfilingGroupInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateProfilingGroupInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateProfilingGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateProfilingGroupOutputError>
}

public struct UpdateProfilingGroupInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateProfilingGroupInputURLPathMiddleware"
...
extension CodeGuruProfilerClientTypes {
    ...
    ///             Feedback is be used for improvements in generating recommendations for the application.
