...
public struct CreateTokenInput: Swift.Equatable {
    ...
    /// This member is required.
    var deviceCode: Swift.String?
    /// Supports grant types for authorization code, refresh token, and device code request.
    /// This member is required.
    var grantType: Swift.String?
...
public struct RegisterClientOutputResponse: Swift.Equatable {
    ...
    var clientIdIssuedAt: Swift.Int
    /// A secret string generated for the client. The client will use this string to get authenticated by the service in subsequent calls.
    var clientSecret: Swift.String?
    /// Indicates the time at which the clientId and clientSecret will become invalid.
    var clientSecretExpiresAt: Swift.Int
...
public struct StartDeviceAuthorizationOutputResponse: Swift.Equatable {
    ...
    var userCode: Swift.String?
    /// The URI of the verification page that takes the userCode to authorize the device.
    var verificationUri: Swift.String?
    /// An alternate URL that the client can use to automatically launch a browser. This process skips the manual step in which the user visits the verification page and enters their code.
    var verificationUriComplete: Swift.String?
