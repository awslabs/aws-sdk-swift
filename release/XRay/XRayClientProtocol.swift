...
public protocol XRayClientProtocol {
    ...
    ///       list of trace IDs.</p>
    func batchGetTraces(input: BatchGetTracesInput, completion: @escaping (SdkResult<BatchGetTracesOutputResponse, BatchGetTracesOutputError>) -> Void)
    ...
    func createSamplingRule(input: CreateSamplingRuleInput, completion: @escaping (SdkResult<CreateSamplingRuleOutputResponse, CreateSamplingRuleOutputError>) -> Void)
    ...
    func deleteSamplingRule(input: DeleteSamplingRuleInput, completion: @escaping (SdkResult<DeleteSamplingRuleOutputResponse, DeleteSamplingRuleOutputError>) -> Void)
    /// <p>Retrieves the current encryption configuration for X-Ray data.</p>
    func getEncryptionConfig(input: GetEncryptionConfigInput, completion: @escaping (SdkResult<GetEncryptionConfigOutputResponse, GetEncryptionConfigOutputError>) -> Void)
    ...
    func getGroups(input: GetGroupsInput, completion: @escaping (SdkResult<GetGroupsOutputResponse, GetGroupsOutputError>) -> Void)
    ...
    func getInsight(input: GetInsightInput, completion: @escaping (SdkResult<GetInsightOutputResponse, GetInsightOutputError>) -> Void)
    ...
    ///          console.</p>
    func getInsightEvents(input: GetInsightEventsInput, completion: @escaping (SdkResult<GetInsightEventsOutputResponse, GetInsightEventsOutputError>) -> Void)
    ...
    func getInsightImpactGraph(input: GetInsightImpactGraphInput, completion: @escaping (SdkResult<GetInsightImpactGraphOutputResponse, GetInsightImpactGraphOutputError>) -> Void)
    /// <p>Retrieves the summaries of all insights in the specified group matching the provided filter values.</p>
    func getInsightSummaries(input: GetInsightSummariesInput, completion: @escaping (SdkResult<GetInsightSummariesOutputResponse, GetInsightSummariesOutputError>) -> Void)
    /// <p>Retrieves all sampling rules.</p>
    func getSamplingRules(input: GetSamplingRulesInput, completion: @escaping (SdkResult<GetSamplingRulesOutputResponse, GetSamplingRulesOutputError>) -> Void)
    /// <p>Retrieves information about recent sampling results for all sampling rules.</p>
    func getSamplingStatisticSummaries(input: GetSamplingStatisticSummariesInput, completion: @escaping (SdkResult<GetSamplingStatisticSummariesOutputResponse, GetSamplingStatisticSummariesOutputError>) -> Void)
    /// <p>Requests a sampling quota for rules that the service is using to sample requests.
    ///       </p>
    func getSamplingTargets(input: GetSamplingTargetsInput, completion: @escaping (SdkResult<GetSamplingTargetsOutputResponse, GetSamplingTargetsOutputError>) -> Void)
    ...
    ///       databases.</p>
    func getServiceGraph(input: GetServiceGraphInput, completion: @escaping (SdkResult<GetServiceGraphOutputResponse, GetServiceGraphOutputError>) -> Void)
    /// <p>Get an aggregation of service statistics defined by a specific time
    ///             range.</p>
    func getTimeSeriesServiceStatistics(input: GetTimeSeriesServiceStatisticsInput, completion: @escaping (SdkResult<GetTimeSeriesServiceStatisticsOutputResponse, GetTimeSeriesServiceStatisticsOutputError>) -> Void)
    /// <p>Retrieves a service graph for one or more specific trace IDs.</p>
    func getTraceGraph(input: GetTraceGraphInput, completion: @escaping (SdkResult<GetTraceGraphOutputResponse, GetTraceGraphOutputError>) -> Void)
    ...
    func getTraceSummaries(input: GetTraceSummariesInput, completion: @escaping (SdkResult<GetTraceSummariesOutputResponse, GetTraceSummariesOutputError>) -> Void)
    ...
    func putEncryptionConfig(input: PutEncryptionConfigInput, completion: @escaping (SdkResult<PutEncryptionConfigOutputResponse, PutEncryptionConfigOutputError>) -> Void)
    /// <p>Used by the AWS X-Ray daemon to upload telemetry.</p>
    func putTelemetryRecords(input: PutTelemetryRecordsInput, completion: @escaping (SdkResult<PutTelemetryRecordsOutputResponse, PutTelemetryRecordsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func putTraceSegments(input: PutTraceSegmentsInput, completion: @escaping (SdkResult<PutTraceSegmentsOutputResponse, PutTraceSegmentsOutputError>) -> Void)
    ...
    func updateSamplingRule(input: UpdateSamplingRuleInput, completion: @escaping (SdkResult<UpdateSamplingRuleOutputResponse, UpdateSamplingRuleOutputError>) -> Void)
}
