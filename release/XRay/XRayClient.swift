...
public class XRayClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try XRayClientConfiguration(region: unwrappedRegion)
    ...
    public class XRayClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("XRayClient")
