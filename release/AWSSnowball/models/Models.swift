...
extension SnowballClientTypes {
    ...
    public struct Address: Swift.Equatable {
        ...
        /// This field is no longer used and the value is ignored.
        var prefectureOrDistrict: Swift.String?
        /// The state or province in an address that a Snow device is to be delivered to.
        var stateOrProvince: Swift.String?
        /// The first line in a street address that a Snow device is to be delivered to.
        var street1: Swift.String?
        /// The second line in a street address that a Snow device is to be delivered to.
        var street2: Swift.String?
        /// The third line in a street address that a Snow device is to be delivered to.
        var street3: Swift.String?
...
extension SnowballClientTypes {
    ...
    public struct ClusterListEntry: Swift.Equatable {
        ...
        var clusterState: SnowballClientTypes.ClusterState?
...
extension SnowballClientTypes {
    ...
    public struct ClusterMetadata: Swift.Equatable {
        ...
        var forwardingAddressId: Swift.String?
        /// The type of job for this cluster. Currently, the only job type supported for clusters is LOCAL_USE.
        var jobType: SnowballClientTypes.JobType?
        ...
        var notification: SnowballClientTypes.Notification?
        /// Represents metadata and configuration settings for services on an Amazon Web Services Snow Family device.
        var onDeviceServiceConfiguration: SnowballClientTypes.OnDeviceServiceConfiguration?
        /// The arrays of [JobResource] objects that can include updated [S3Resource] objects or [LambdaResource] objects.
        var resources: SnowballClientTypes.JobResource?
        ...
        var shippingOption: SnowballClientTypes.ShippingOption?
        ...
        var snowballType: SnowballClientTypes.SnowballType?
        /// The tax documents required in your Amazon Web Services Region.
        var taxDocuments: SnowballClientTypes.TaxDocuments?
...
public struct CreateAddressInput: Swift.Equatable {
    ...
    /// This member is required.
    var address: SnowballClientTypes.Address?
...
public struct CreateClusterInput: Swift.Equatable {
    ...
    var remoteManagement: SnowballClientTypes.RemoteManagement?
...
public struct CreateJobInput: Swift.Equatable {
    ...
    var deviceConfiguration: SnowballClientTypes.DeviceConfiguration?
    ...
    var longTermPricingId: Swift.String?
    ...
    var snowballCapacityPreference: SnowballClientTypes.SnowballCapacity?
...
public struct CreateLongTermPricingInput: Swift.Equatable {
    ...
    var isLongTermPricingAutoRenew: Swift.Bool?
    /// The type of long-term pricing option you want for the device, either 1-year or 3-year long-term pricing.
    /// This member is required.
    var longTermPricingType: SnowballClientTypes.LongTermPricingType?
...
public struct CreateReturnShippingLabelOutputResponse: Swift.Equatable {
    ...
    var status: SnowballClientTypes.ShippingLabelStatus?
...
extension SnowballClientTypes {
    ...
    public struct DataTransfer: Swift.Equatable {
        ...
        var objectsTransferred: Swift.Int
...
public struct DescribeAddressesOutputResponse: Swift.Equatable {
    ...
    var addresses: [SnowballClientTypes.Address]?
...
public struct DescribeClusterOutputResponse: Swift.Equatable {
    ...
    var clusterMetadata: SnowballClientTypes.ClusterMetadata?
...
public struct DescribeJobOutputResponse: Swift.Equatable {
    ...
    var jobMetadata: SnowballClientTypes.JobMetadata?
    /// Information about a specific job part (in the case of an export job), including shipping information, job status, and other important metadata.
    var subJobMetadata: [SnowballClientTypes.JobMetadata]?
...
public struct DescribeReturnShippingLabelOutputResponse: Swift.Equatable {
    ...
    var returnShippingLabelURI: Swift.String?
    /// The status information of the task on a Snow device that is being returned to Amazon Web Services.
    var status: SnowballClientTypes.ShippingLabelStatus?
...
extension SnowballClientTypes {
    ...
    public struct DeviceConfiguration: Swift.Equatable {
        ...
        var snowconeDeviceConfiguration: SnowballClientTypes.SnowconeDeviceConfiguration?
...
extension SnowballClientTypes {
    ...
    public struct Ec2AmiResource: Swift.Equatable {
        ...
        var snowballAmiId: Swift.String?
...
extension SnowballClientTypes {
    ...
    public struct EventTriggerDefinition: Swift.Equatable {
        ...
        var eventResourceARN: Swift.String?
...
public struct GetSnowballUsageOutputResponse: Swift.Equatable {
    ...
    var snowballLimit: Swift.Int?
    /// The number of Snow devices that this account is currently using.
    var snowballsInUse: Swift.Int?
...
extension SnowballClientTypes {
    ...
    public struct JobListEntry: Swift.Equatable {
        ...
        var isMaster: Swift.Bool
        /// The automatically generated ID for a job, for example JID123e4567-e89b-12d3-a456-426655440000.
        var jobId: Swift.String?
        /// The current state of this job.
        var jobState: SnowballClientTypes.JobState?
        /// The type of job.
        var jobType: SnowballClientTypes.JobType?
...
extension SnowballClientTypes {
    ...
    public struct JobLogs: Swift.Equatable {
        ...
        var jobCompletionReportURI: Swift.String?
        /// A link to an Amazon S3 presigned URL where the job failure log is located.
        var jobFailureLogURI: Swift.String?
        /// A link to an Amazon S3 presigned URL where the job success log is located.
        var jobSuccessLogURI: Swift.String?
...
extension SnowballClientTypes {
    ...
    public struct JobMetadata: Swift.Equatable {
        ...
        var dataTransferProgress: SnowballClientTypes.DataTransfer?
        ...
        var jobLogInfo: SnowballClientTypes.JobLogs?
        ...
        var shippingDetails: SnowballClientTypes.ShippingDetails?
...
extension SnowballClientTypes {
    ...
    public struct JobResource: Swift.Equatable {
        ...
        var ec2AmiResources: [SnowballClientTypes.Ec2AmiResource]?
        /// The Python-language Lambda functions for this job.
        var lambdaResources: [SnowballClientTypes.LambdaResource]?
        /// An array of S3Resource objects.
        var s3Resources: [SnowballClientTypes.S3Resource]?
...
extension SnowballClientTypes {
    ...
    public struct KeyRange: Swift.Equatable {
        ...
        var beginMarker: Swift.String?
        /// The key that ends an optional key range for an export job. Ranges are inclusive and UTF-8 binary sorted.
        var endMarker: Swift.String?
...
extension SnowballClientTypes {
    ...
    public struct LambdaResource: Swift.Equatable {
        ...
        var eventTriggers: [SnowballClientTypes.EventTriggerDefinition]?
...
public struct ListClusterJobsOutputResponse: Swift.Equatable {
    ...
    var jobListEntries: [SnowballClientTypes.JobListEntry]?
...
public struct ListClustersOutputResponse: Swift.Equatable {
    ...
    var clusterListEntries: [SnowballClientTypes.ClusterListEntry]?
...
public struct ListCompatibleImagesOutputResponse: Swift.Equatable {
    ...
    var compatibleImages: [SnowballClientTypes.CompatibleImage]?
...
public struct ListLongTermPricingOutputResponse: Swift.Equatable {
    ...
    var longTermPricingEntries: [SnowballClientTypes.LongTermPricingListEntry]?
...
extension SnowballClientTypes {
    ...
    public struct LongTermPricingListEntry: Swift.Equatable {
        ...
        var currentActiveJob: Swift.String?
        ...
        var longTermPricingEndDate: ClientRuntime.Date?
        /// The ID of the long-term pricing type for the device.
        var longTermPricingId: Swift.String?
        /// The start date of the long-term pricing contract.
        var longTermPricingStartDate: ClientRuntime.Date?
        /// The status of the long-term pricing type.
        var longTermPricingStatus: Swift.String?
        /// The type of long-term pricing that was selected for the device.
        var longTermPricingType: SnowballClientTypes.LongTermPricingType?
        /// A new device that replaces a device that is ordered with long-term pricing.
        var replacementJob: Swift.String?
...
extension SnowballClientTypes {
    ...
    public struct NFSOnDeviceServiceConfiguration: Swift.Equatable {
        ...
        var storageLimit: Swift.Int
        /// The scale unit of the NFS storage on the device. Valid values: TB.
        var storageUnit: SnowballClientTypes.StorageUnit?
...
extension SnowballClientTypes {
    ...
    public struct Notification: Swift.Equatable {
        ...
        var jobStatesToNotify: [SnowballClientTypes.JobState]?
        /// Any change in job state will trigger a notification for this job.
        var notifyAll: Swift.Bool
...
extension SnowballClientTypes {
    ...
    public struct OnDeviceServiceConfiguration: Swift.Equatable {
        ...
        var nFSOnDeviceService: SnowballClientTypes.NFSOnDeviceServiceConfiguration?
        /// Represents the Storage Gateway service Tape Gateway type on a Snow Family device.
        var tGWOnDeviceService: SnowballClientTypes.TGWOnDeviceServiceConfiguration?
...
extension SnowballClientTypes {
    ...
    public struct S3Resource: Swift.Equatable {
        ...
        var keyRange: SnowballClientTypes.KeyRange?
        ...
        var targetOnDeviceServices: [SnowballClientTypes.TargetOnDeviceService]?
...
extension SnowballClientTypes {
    ...
    public struct Shipment: Swift.Equatable {
        ...
        var trackingNumber: Swift.String?
...
extension SnowballClientTypes {
    ...
    public struct ShippingDetails: Swift.Equatable {
        ...
        var inboundShipment: SnowballClientTypes.Shipment?
        ...
        var outboundShipment: SnowballClientTypes.Shipment?
...
extension SnowballClientTypes {
    ...
    public struct SnowconeDeviceConfiguration: Swift.Equatable {
        ...
        var wirelessConnection: SnowballClientTypes.WirelessConnection?
...
extension SnowballClientTypes {
    ...
    public struct TargetOnDeviceService: Swift.Equatable {
        ...
        var serviceName: SnowballClientTypes.DeviceServiceName?
        /// Specifies whether the data is being imported or exported. You can import or export the data, or use it locally on the device.
        var transferOption: SnowballClientTypes.TransferOption?
...
extension SnowballClientTypes {
    ...
    public struct TaxDocuments: Swift.Equatable {
        /// The tax documents required in Amazon Web Services Region in India.
        var iND: SnowballClientTypes.INDTaxDocuments?
...
public struct UpdateJobShipmentStateInput: Swift.Equatable {
    ...
    /// This member is required.
    var shipmentState: SnowballClientTypes.ShipmentState?
