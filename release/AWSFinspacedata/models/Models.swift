...
extension FinspaceDataClientTypes.ChangesetSummary: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let activeFromTimestampDecoded = try containerValues.decode(Swift.Int.self, forKey: .activeFromTimestamp)
...
extension GetUserOutputResponseBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let createTimeDecoded = try containerValues.decode(Swift.Int.self, forKey: .createTime)
        createTime = createTimeDecoded
        let lastEnabledTimeDecoded = try containerValues.decode(Swift.Int.self, forKey: .lastEnabledTime)
        lastEnabledTime = lastEnabledTimeDecoded
        let lastDisabledTimeDecoded = try containerValues.decode(Swift.Int.self, forKey: .lastDisabledTime)
        lastDisabledTime = lastDisabledTimeDecoded
        let lastModifiedTimeDecoded = try containerValues.decode(Swift.Int.self, forKey: .lastModifiedTime)
        lastModifiedTime = lastModifiedTimeDecoded
        let lastLoginTimeDecoded = try containerValues.decode(Swift.Int.self, forKey: .lastLoginTime)
