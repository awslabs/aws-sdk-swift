...
extension FinspaceDataClientTypes {
    ...
    public struct ChangesetErrorInfo: Swift.Equatable {
        ...
        var errorCategory: FinspaceDataClientTypes.ErrorCategory?
...
extension FinspaceDataClientTypes {
    ...
    public struct ChangesetSummary: Swift.Equatable {
        ...
        var activeUntilTimestamp: Swift.Int
        ...
        var changeType: FinspaceDataClientTypes.ChangeType?
        /// The ARN identifier of the Changeset.
        var changesetArn: Swift.String?
        /// The unique identifier for a Changeset.
        var changesetId: Swift.String?
        /// The timestamp at which the Changeset was created in FinSpace. The value is determined as Epoch time in milliseconds. For example, the value for Monday, November 1, 2021 12:00:00 PM UTC is specified as 1635768000000.
        var createTime: Swift.Int
        /// The unique identifier for the FinSpace Dataset in which the Changeset is created.
        var datasetId: Swift.String?
        /// The structure with error messages.
        var errorInfo: FinspaceDataClientTypes.ChangesetErrorInfo?
        /// Options that define the structure of the source file(s).
        var formatParams: [Swift.String:Swift.String]?
        /// Options that define the location of the data being ingested.
        var sourceParams: [Swift.String:Swift.String]?
        ...
        var status: FinspaceDataClientTypes.IngestionStatus?
        /// The unique identifier of the updated Changeset.
        var updatedByChangesetId: Swift.String?
        /// The unique identifier of the Changeset that is updated.
        var updatesChangesetId: Swift.String?
...
extension FinspaceDataClientTypes {
    ...
    public struct ColumnDefinition: Swift.Equatable {
        ...
        var columnDescription: Swift.String?
        /// Name for a column.
        ...
        var dataType: FinspaceDataClientTypes.ColumnDataType?
...
public struct CreateDataViewInput: Swift.Equatable {
    ...
    var asOfTimestamp: Swift.Int
    /// Flag to indicate Dataview should be updated automatically.
    var autoUpdate: Swift.Bool
    /// A token used to ensure idempotency.
    var clientToken: Swift.String?
    ...
    /// This member is required.
    var destinationTypeParams: FinspaceDataClientTypes.DataViewDestinationTypeParams?
    /// Ordered set of column names used to partition data.
    var partitionColumns: [Swift.String]?
    /// Columns to be used for sorting the data.
    var sortColumns: [Swift.String]?
...
public struct CreateDatasetInput: Swift.Equatable {
    ...
    /// This member is required.
    var datasetDescription: Swift.String?
    /// Display title for a FinSpace Dataset.
    /// This member is required.
    var datasetTitle: Swift.String?
    ...
    /// This member is required.
    var kind: FinspaceDataClientTypes.DatasetKind?
    /// Contact information for a Dataset owner.
    var ownerInfo: FinspaceDataClientTypes.DatasetOwnerInfo?
    /// Permission group parameters for Dataset permissions.
    /// This member is required.
    var permissionGroupParams: FinspaceDataClientTypes.PermissionGroupParams?
    /// Definition for a schema on a tabular Dataset.
    var schemaDefinition: FinspaceDataClientTypes.SchemaUnion?
...
extension FinspaceDataClientTypes {
    ...
    public struct DataViewDestinationTypeParams: Swift.Equatable {
        ...
        /// This member is required.
        var destinationType: Swift.String?
...
extension FinspaceDataClientTypes {
    ...
    public struct DataViewSummary: Swift.Equatable {
        ...
        var dataViewArn: Swift.String?
        /// The unique identifier for the Dataview.
        var dataViewId: Swift.String?
        /// Th unique identifier for the Dataview Dataset.
        var datasetId: Swift.String?
        /// Information about the Dataview destination.
        var destinationTypeProperties: FinspaceDataClientTypes.DataViewDestinationTypeParams?
        /// The structure with error messages.
        var errorInfo: FinspaceDataClientTypes.DataViewErrorInfo?
        /// The last time that a Dataview was modified. The value is determined as Epoch time in milliseconds. For example, the value for Monday, November 1, 2021 12:00:00 PM UTC is specified as 1635768000000.
        var lastModifiedTime: Swift.Int
        /// Ordered set of column names used to partition data.
        var partitionColumns: [Swift.String]?
        /// Columns to be used for sorting the data.
        var sortColumns: [Swift.String]?
        ...
        var status: FinspaceDataClientTypes.DataViewStatus?
...
public struct GetDatasetOutputResponse: Swift.Equatable {
    ...
    var status: FinspaceDataClientTypes.DatasetStatus?
...
public struct GetProgrammaticAccessCredentialsInput: Swift.Equatable {
    ...
    var durationInMinutes: Swift.Int
...
public struct GetProgrammaticAccessCredentialsOutputResponse: Swift.Equatable {
    ...
    var credentials: FinspaceDataClientTypes.Credentials?
...
public struct GetWorkingLocationInput: Swift.Equatable {
    ...
    var locationType: FinspaceDataClientTypes.LocationType?
...
public struct ListChangesetsOutputResponse: Swift.Equatable {
    ...
    var changesets: [FinspaceDataClientTypes.ChangesetSummary]?
    /// A token indicating where a results page should begin.
    var nextToken: Swift.String?
...
public struct ListDataViewsOutputResponse: Swift.Equatable {
    /// A list of Dataviews.
    var dataViews: [FinspaceDataClientTypes.DataViewSummary]?
    /// A token indicating where a results page should begin.
    var nextToken: Swift.String?
...
public struct ListDatasetsOutputResponse: Swift.Equatable {
    /// List of Datasets.
    var datasets: [FinspaceDataClientTypes.Dataset]?
    /// A token indicating where a results page should begin.
    var nextToken: Swift.String?
...
extension FinspaceDataClientTypes {
    ...
    public struct PermissionGroupParams: Swift.Equatable {
        ...
        var datasetPermissions: [FinspaceDataClientTypes.ResourcePermission]?
        /// The unique identifier of the PermissionGroup.
        var permissionGroupId: Swift.String?
...
extension FinspaceDataClientTypes {
    ...
    public struct SchemaDefinition: Swift.Equatable {
        ...
        var columns: [FinspaceDataClientTypes.ColumnDefinition]?
        /// List of column names used for primary key.
        var primaryKeyColumns: [Swift.String]?
...
extension FinspaceDataClientTypes {
    ...
    public struct SchemaUnion: Swift.Equatable {
        ...
        var tabularSchemaConfig: FinspaceDataClientTypes.SchemaDefinition?
