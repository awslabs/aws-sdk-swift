...
extension FisClientTypes {
    ...
    public struct Action: Swift.Equatable {
        ...
        var parameters: [Swift.String:FisClientTypes.ActionParameter]?
        /// The tags for the action.
        var tags: [Swift.String:Swift.String]?
        /// The supported targets for the action.
        var targets: [Swift.String:FisClientTypes.ActionTarget]?
...
extension FisClientTypes {
    ...
    public struct CreateExperimentTemplateActionInput: Swift.Equatable {
        ...
        var startAfter: [Swift.String]?
        /// The targets for the action.
        var targets: [Swift.String:Swift.String]?
...
public struct CreateExperimentTemplateInput: Swift.Equatable {
    ...
    /// This member is required.
    var actions: [Swift.String:FisClientTypes.CreateExperimentTemplateActionInput]?
    ...
    /// The stop conditions.
    /// This member is required.
    var stopConditions: [FisClientTypes.CreateExperimentTemplateStopConditionInput]?
    /// The tags to apply to the experiment template.
    var tags: [Swift.String:Swift.String]?
    /// The targets for the experiment.
    var targets: [Swift.String:FisClientTypes.CreateExperimentTemplateTargetInput]?
...
public struct CreateExperimentTemplateOutputResponse: Swift.Equatable {
    ...
    var experimentTemplate: FisClientTypes.ExperimentTemplate?
...
extension FisClientTypes {
    ...
    public struct CreateExperimentTemplateTargetInput: Swift.Equatable {
        ...
        var filters: [FisClientTypes.ExperimentTemplateTargetInputFilter]?
        /// The Amazon Resource Names (ARNs) of the resources.
        var resourceArns: [Swift.String]?
        /// The tags for the target resources.
        var resourceTags: [Swift.String:Swift.String]?
        ...
        /// This member is required.
        var selectionMode: Swift.String?
...
extension FisClientTypes {
    ...
    public struct Experiment: Swift.Equatable {
        /// The actions for the experiment.
        var actions: [Swift.String:FisClientTypes.ExperimentAction]?
        /// The time the experiment was created.
        var creationTime: ClientRuntime.Date?
        /// The time that the experiment ended.
        var endTime: ClientRuntime.Date?
        /// The ID of the experiment template.
        var experimentTemplateId: Swift.String?
        ...
        var state: FisClientTypes.ExperimentState?
        /// The stop conditions for the experiment.
        var stopConditions: [FisClientTypes.ExperimentStopCondition]?
        /// The tags for the experiment.
        var tags: [Swift.String:Swift.String]?
        /// The targets for the experiment.
        var targets: [Swift.String:FisClientTypes.ExperimentTarget]?
...
extension FisClientTypes {
    ...
    public struct ExperimentAction: Swift.Equatable {
        ...
        var state: FisClientTypes.ExperimentActionState?
        /// The targets for the action.
        var targets: [Swift.String:Swift.String]?
...
extension FisClientTypes {
    ...
    public struct ExperimentActionState: Swift.Equatable {
        ...
        /// The state of the action.
        var status: FisClientTypes.ExperimentActionStatus?
...
extension FisClientTypes {
    ...
    public struct ExperimentState: Swift.Equatable {
        ...
        var reason: Swift.String?
        /// The state of the experiment.
        var status: FisClientTypes.ExperimentStatus?
...
extension FisClientTypes {
    ...
    public struct ExperimentTarget: Swift.Equatable {
        /// The filters to apply to identify target resources using specific attributes.
        var filters: [FisClientTypes.ExperimentTargetFilter]?
        /// The Amazon Resource Names (ARNs) of the resources.
        var resourceArns: [Swift.String]?
        /// The tags for the target resources.
        var resourceTags: [Swift.String:Swift.String]?
...
extension FisClientTypes {
    ...
    public struct ExperimentTemplate: Swift.Equatable {
        /// The actions for the experiment.
        var actions: [Swift.String:FisClientTypes.ExperimentTemplateAction]?
        ...
        var roleArn: Swift.String?
        /// The stop conditions for the experiment.
        var stopConditions: [FisClientTypes.ExperimentTemplateStopCondition]?
        /// The tags for the experiment template.
        var tags: [Swift.String:Swift.String]?
        /// The targets for the experiment.
        var targets: [Swift.String:FisClientTypes.ExperimentTemplateTarget]?
...
extension FisClientTypes {
    ...
    public struct ExperimentTemplateTarget: Swift.Equatable {
        /// The filters to apply to identify target resources using specific attributes.
        var filters: [FisClientTypes.ExperimentTemplateTargetFilter]?
...
public struct GetActionOutputResponse: Swift.Equatable {
    ...
    var action: FisClientTypes.Action?
...
public struct GetExperimentOutputResponse: Swift.Equatable {
    ...
    var experiment: FisClientTypes.Experiment?
...
public struct ListActionsOutputResponse: Swift.Equatable {
    /// The actions.
    var actions: [FisClientTypes.ActionSummary]?
...
public struct ListExperimentTemplatesOutputResponse: Swift.Equatable {
    ...
    var experimentTemplates: [FisClientTypes.ExperimentTemplateSummary]?
    /// The token to use to retrieve the next page of results. This value is null when there are no more results to return.
    var nextToken: Swift.String?
...
public struct ListExperimentsOutputResponse: Swift.Equatable {
    /// The experiments.
    var experiments: [FisClientTypes.ExperimentSummary]?
    /// The token to use to retrieve the next page of results. This value is null when there are no more results to return.
    var nextToken: Swift.String?
...
public struct UpdateExperimentTemplateInput: Swift.Equatable {
    /// The actions for the experiment.
    var actions: [Swift.String:FisClientTypes.UpdateExperimentTemplateActionInputItem]?
    ...
    var roleArn: Swift.String?
    /// The stop conditions for the experiment.
    var stopConditions: [FisClientTypes.UpdateExperimentTemplateStopConditionInput]?
    /// The targets for the experiment.
    var targets: [Swift.String:FisClientTypes.UpdateExperimentTemplateTargetInput]?
