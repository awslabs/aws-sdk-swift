...
public struct CreateReplicationSetInput: Swift.Equatable {
    ...
    /// This member is required.
    var regions: [Swift.String:SsmIncidentsClientTypes.RegionMapInputValue]?
...
public struct CreateResponsePlanInput: Swift.Equatable {
    ...
    var actions: [SsmIncidentsClientTypes.Action]?
    /// The Chatbot chat channel used for collaboration during an incident.
    var chatChannel: SsmIncidentsClientTypes.ChatChannel?
    /// A token ensuring that the operation is called only once with the specified details.
    var clientToken: Swift.String?
    /// The long format of the response plan name. This field can contain spaces.
    var displayName: Swift.String?
    /// The contacts and escalation plans that the response plan engages during an incident.
    var engagements: Swift.Set<Swift.String>?
    /// Details used to create an incident when using this response plan.
    /// This member is required.
    var incidentTemplate: SsmIncidentsClientTypes.IncidentTemplate?
...
public struct CreateTimelineEventInput: Swift.Equatable {
    ...
    /// This member is required.
    var incidentRecordArn: Swift.String?
...
extension SsmIncidentsClientTypes {
    ...
    public struct EventSummary: Swift.Equatable {
        ...
        /// This member is required.
        var eventUpdatedTime: ClientRuntime.Date?
...
extension SsmIncidentsClientTypes {
    ...
    public struct Filter: Swift.Equatable {
        ...
        /// This member is required.
        var condition: SsmIncidentsClientTypes.Condition?
...
public struct GetIncidentRecordOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var incidentRecord: SsmIncidentsClientTypes.IncidentRecord?
...
public struct GetReplicationSetOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var replicationSet: SsmIncidentsClientTypes.ReplicationSet?
...
public struct GetResourcePoliciesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var resourcePolicies: [SsmIncidentsClientTypes.ResourcePolicy]?
...
public struct GetTimelineEventOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var event: SsmIncidentsClientTypes.TimelineEvent?
...
extension SsmIncidentsClientTypes {
    ...
    public struct IncidentRecord: Swift.Equatable {
        ...
        var automationExecutions: Swift.Set<SsmIncidentsClientTypes.AutomationExecution>?
        ...
        /// This member is required.
        var dedupeString: Swift.String?
        /// The impact of the incident on customers and applications.
        /// This member is required.
        var impact: Swift.Int?
        /// Details about the action that started the incident.
        /// This member is required.
        var incidentRecordSource: SsmIncidentsClientTypes.IncidentRecordSource?
        ...
        var notificationTargets: Swift.Set<SsmIncidentsClientTypes.NotificationTargetItem>?
        /// The time at which the incident was resolved. This appears as a timeline event.
        var resolvedTime: ClientRuntime.Date?
        /// The current status of the incident.
        /// This member is required.
        var status: SsmIncidentsClientTypes.IncidentRecordStatus?
...
extension SsmIncidentsClientTypes {
    ...
    public struct ItemIdentifier: Swift.Equatable {
        ...
        /// * OTHER
        /// This member is required.
        var type: SsmIncidentsClientTypes.ItemType?
        /// Details about the related item.
        /// This member is required.
        var value: SsmIncidentsClientTypes.ItemValue?
...
public struct ListIncidentRecordsInput: Swift.Equatable {
    ...
    var filters: [SsmIncidentsClientTypes.Filter]?
...
public struct ListIncidentRecordsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var incidentRecordSummaries: [SsmIncidentsClientTypes.IncidentRecordSummary]?
    /// The pagination token to continue to the next page of results.
    var nextToken: Swift.String?
...
public struct ListRelatedItemsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var relatedItems: [SsmIncidentsClientTypes.RelatedItem]?
...
public struct ListReplicationSetsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var replicationSetArns: [Swift.String]?
...
public struct ListResponsePlansOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var responsePlanSummaries: [SsmIncidentsClientTypes.ResponsePlanSummary]?
...
public struct ListTimelineEventsInput: Swift.Equatable {
    ...
    var sortBy: SsmIncidentsClientTypes.TimelineEventSort?
    /// Sorts the order of timeline events by the value specified in the sortBy field.
    var sortOrder: SsmIncidentsClientTypes.SortOrder?
...
public struct ListTimelineEventsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var eventSummaries: [SsmIncidentsClientTypes.EventSummary]?
    /// The pagination token to continue to the next page of results.
    var nextToken: Swift.String?
...
extension SsmIncidentsClientTypes {
    ...
    public struct RegionInfo: Swift.Equatable {
        ...
        /// This member is required.
        var status: SsmIncidentsClientTypes.RegionStatus?
        ...
        /// This member is required.
        var statusUpdateDateTime: ClientRuntime.Date?
...
extension SsmIncidentsClientTypes {
    ...
    public struct RelatedItem: Swift.Equatable {
        /// Details about the related item.
        /// This member is required.
        var identifier: SsmIncidentsClientTypes.ItemIdentifier?
...
extension SsmIncidentsClientTypes {
    ...
    public struct ReplicationSet: Swift.Equatable {
        ...
        /// This member is required.
        var deletionProtected: Swift.Bool?
...
extension SsmIncidentsClientTypes {
    ...
    public struct ResourcePolicy: Swift.Equatable {
        ...
        /// This member is required.
        var ramResourceShareRegion: Swift.String?
...
extension SsmIncidentsClientTypes {
    ...
    public struct SsmAutomation: Swift.Equatable {
        ...
        /// This member is required.
        var documentName: Swift.String?
        /// The automation document's version to use when running.
        var documentVersion: Swift.String?
        ...
        var targetAccount: SsmIncidentsClientTypes.SsmTargetAccount?
...
public struct StartIncidentInput: Swift.Equatable {
    ...
    /// This member is required.
    var responsePlanArn: Swift.String?
    /// Provide a title for the incident. Providing a title overwrites the title provided by the response plan.
    var title: Swift.String?
    /// Details of what created the incident record in Incident Manager.
    var triggerDetails: SsmIncidentsClientTypes.TriggerDetails?
...
public struct UpdateRelatedItemsInput: Swift.Equatable {
    ...
    /// This member is required.
    var relatedItemsUpdate: SsmIncidentsClientTypes.RelatedItemsUpdate?
...
public struct UpdateReplicationSetInput: Swift.Equatable {
    ...
    /// This member is required.
    var actions: [SsmIncidentsClientTypes.UpdateReplicationSetAction]?
    /// The Amazon Resource Name (ARN) of the replication set you're updating.
    /// This member is required.
    var arn: Swift.String?
    /// A token ensuring that the operation is called only once with the specified details.
...
public struct UpdateResponsePlanInput: Swift.Equatable {
    ...
    var engagements: Swift.Set<Swift.String>?
    /// The string Incident Manager uses to prevent duplicate incidents from being created by the same incident in the same account.
    var incidentTemplateDedupeString: Swift.String?
    /// Defines the impact to the customers. Providing an impact overwrites the impact provided by a response plan. Possible impacts:
    ///
    /// * 5 - Severe impact
    ///
    ...
    ///
    /// * 1 - No impact
    var incidentTemplateImpact: Swift.Int?
    /// The Amazon SNS targets that are notified when updates are made to an incident.
    var incidentTemplateNotificationTargets: Swift.Set<SsmIncidentsClientTypes.NotificationTargetItem>?
    /// A brief summary of the incident. This typically contains what has happened, what's currently happening, and next steps.
    var incidentTemplateSummary: Swift.String?
    /// The short format name of the incident. The title can't contain spaces.
    var incidentTemplateTitle: Swift.String?
