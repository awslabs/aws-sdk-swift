...
extension SesV2ClientTypes.DkimAttributes: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DkimAttributes(currentSigningKeyLength: \(Swift.String(describing: currentSigningKeyLength)), lastKeyGenerationTimestamp: \(Swift.String(describing: lastKeyGenerationTimestamp)), nextSigningKeyLength: \(Swift.String(describing: nextSigningKeyLength)), signingAttributesOrigin: \(Swift.String(describing: signingAttributesOrigin)), signingEnabled: \(Swift.String(describing: signingEnabled)), status: \(Swift.String(describing: status)), tokens: \(Swift.String(describing: tokens)))"}
}
...
extension SesV2ClientTypes.DkimSigningAttributes: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DkimSigningAttributes(domainSigningPrivateKey: \(Swift.String(describing: domainSigningPrivateKey)), domainSigningSelector: \(Swift.String(describing: domainSigningSelector)), nextSigningKeyLength: \(Swift.String(describing: nextSigningKeyLength)))"}
}
