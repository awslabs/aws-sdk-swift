...
extension SesV2ClientTypes {
    ...
    public struct AccountDetails: Swift.Equatable {
        ...
        var additionalContactEmailAddresses: [Swift.String]?
        /// The language you would prefer for the case. The contact language can be one of ENGLISH or JAPANESE.
        var contactLanguage: SesV2ClientTypes.ContactLanguage?
        ...
        var mailType: SesV2ClientTypes.MailType?
        /// Information about the review of the latest details you submitted.
        var reviewDetails: SesV2ClientTypes.ReviewDetails?
        /// A description of the types of email that you plan to send.
        var useCaseDescription: Swift.String?
        /// The URL of your website. This information helps us better understand the type of content that you plan to send.
        var websiteURL: Swift.String?
...
extension SesV2ClientTypes {
    ...
    public struct BlacklistEntry: Swift.Equatable {
        ...
        var listingTime: ClientRuntime.Date?
        /// The name of the blacklist that the IP address appears on.
        var rblName: Swift.String?
...
extension SesV2ClientTypes {
    ...
    public struct Body: Swift.Equatable {
        ...
        var html: SesV2ClientTypes.Content?
        /// An object that represents the version of the message that is displayed in email clients that don't support HTML, or clients where the recipient has disabled HTML rendering.
        var text: SesV2ClientTypes.Content?
...
extension SesV2ClientTypes {
    ...
    public struct BulkEmailContent: Swift.Equatable {
        ...
        var template: SesV2ClientTypes.Template?
...
extension SesV2ClientTypes {
    public struct BulkEmailEntry: Swift.Equatable {
        ...
        var destination: SesV2ClientTypes.Destination?
        /// The ReplacementEmailContent associated with a BulkEmailEntry.
        var replacementEmailContent: SesV2ClientTypes.ReplacementEmailContent?
        ...
        var replacementTags: [SesV2ClientTypes.MessageTag]?
...
extension SesV2ClientTypes {
    ...
    public struct BulkEmailEntryResult: Swift.Equatable {
        ...
        var status: SesV2ClientTypes.BulkEmailStatus?
...
extension SesV2ClientTypes {
    ...
    public struct CloudWatchDestination: Swift.Equatable {
        ...
        /// This member is required.
        var dimensionConfigurations: [SesV2ClientTypes.CloudWatchDimensionConfiguration]?
...
extension SesV2ClientTypes {
    ...
    public struct CloudWatchDimensionConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var dimensionValueSource: SesV2ClientTypes.DimensionValueSource?
...
extension SesV2ClientTypes {
    ...
    public struct Contact: Swift.Equatable {
        ...
        var topicDefaultPreferences: [SesV2ClientTypes.TopicPreference]?
        /// The contact's preference for being opted-in to or opted-out of a topic.
        var topicPreferences: [SesV2ClientTypes.TopicPreference]?
        /// A boolean value status noting if the contact is unsubscribed from all contact list topics.
        var unsubscribeAll: Swift.Bool
...
extension SesV2ClientTypes {
    ...
    public struct ContactList: Swift.Equatable {
        ...
        var contactListName: Swift.String?
...
extension SesV2ClientTypes {
    ...
    public struct ContactListDestination: Swift.Equatable {
        ...
        /// This member is required.
        var contactListImportAction: SesV2ClientTypes.ContactListImportAction?
        /// The name of the contact list.
        /// This member is required.
        var contactListName: Swift.String?
...
public struct CreateConfigurationSetEventDestinationInput: Swift.Equatable {
    ...
    /// This member is required.
    var eventDestination: SesV2ClientTypes.EventDestinationDefinition?
...
public struct CreateConfigurationSetInput: Swift.Equatable {
    ...
    var deliveryOptions: SesV2ClientTypes.DeliveryOptions?
    /// An object that defines whether or not Amazon SES collects reputation metrics for the emails that you send that use the configuration set.
    var reputationOptions: SesV2ClientTypes.ReputationOptions?
    /// An object that defines whether or not Amazon SES can send email that you send using the configuration set.
    var sendingOptions: SesV2ClientTypes.SendingOptions?
    /// An object that contains information about the suppression list preferences for your account.
    var suppressionOptions: SesV2ClientTypes.SuppressionOptions?
    /// An array of objects that define the tags (keys and values) to associate with the configuration set.
    var tags: [SesV2ClientTypes.Tag]?
    /// An object that defines the open and click tracking options for emails that you send using the configuration set.
    var trackingOptions: SesV2ClientTypes.TrackingOptions?
...
public struct CreateContactInput: Swift.Equatable {
    ...
    var attributesData: Swift.String?
...
public struct CreateContactListInput: Swift.Equatable {
    ...
    var topics: [SesV2ClientTypes.Topic]?
...
public struct CreateDeliverabilityTestReportInput: Swift.Equatable {
    ...
    /// This member is required.
    var content: SesV2ClientTypes.EmailContent?
...
public struct CreateDeliverabilityTestReportOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var deliverabilityTestStatus: SesV2ClientTypes.DeliverabilityTestStatus?
    /// A unique string that identifies the predictive inbox placement test.
    /// This member is required.
    var reportId: Swift.String?
...
public struct CreateEmailIdentityInput: Swift.Equatable {
    ...
    var dkimSigningAttributes: SesV2ClientTypes.DkimSigningAttributes?
    /// The email address or domain to verify.
    /// This member is required.
    var emailIdentity: Swift.String?
...
public struct CreateEmailIdentityOutputResponse: Swift.Equatable {
    ...
    var dkimAttributes: SesV2ClientTypes.DkimAttributes?
    /// The email identity type. Note: the MANAGED_DOMAIN identity type is not supported.
    var identityType: SesV2ClientTypes.IdentityType?
    ...
    var verifiedForSendingStatus: Swift.Bool
...
public struct CreateEmailTemplateInput: Swift.Equatable {
    ...
    /// This member is required.
    var templateContent: SesV2ClientTypes.EmailTemplateContent?
...
public struct CreateImportJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var importDataSource: SesV2ClientTypes.ImportDataSource?
    /// The destination for the import job.
    /// This member is required.
    var importDestination: SesV2ClientTypes.ImportDestination?
...
extension SesV2ClientTypes {
    ...
    public struct DailyVolume: Swift.Equatable {
        ...
        var domainIspPlacements: [SesV2ClientTypes.DomainIspPlacement]?
        /// The date that the DailyVolume metrics apply to, in Unix time.
        var startDate: ClientRuntime.Date?
        /// An object that contains inbox placement metrics for a specific day in the analysis period.
        var volumeStatistics: SesV2ClientTypes.VolumeStatistics?
...
extension SesV2ClientTypes {
    ...
    public struct DedicatedIp: Swift.Equatable {
        ...
        /// This member is required.
        var warmupPercentage: Swift.Int?
        ...
        /// This member is required.
        var warmupStatus: SesV2ClientTypes.WarmupStatus?
...
extension SesV2ClientTypes {
    ...
    public struct DeliveryOptions: Swift.Equatable {
        ...
        var sendingPoolName: Swift.String?
        /// Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is Require, messages are only delivered if a TLS connection can be established. If the value is Optional, messages can be delivered in plain text if a TLS connection can't be established.
        var tlsPolicy: SesV2ClientTypes.TlsPolicy?
...
extension SesV2ClientTypes {
    ...
    public struct DkimAttributes: Swift.Equatable {
        ...
        var currentSigningKeyLength: SesV2ClientTypes.DkimSigningKeyLength?
        /// [Easy DKIM] The last time a key pair was generated for this identity.
        var lastKeyGenerationTimestamp: ClientRuntime.Date?
        /// [Easy DKIM] The key length of the future DKIM key pair to be generated. This can be changed at most once per day.
        var nextSigningKeyLength: SesV2ClientTypes.DkimSigningKeyLength?
        ...
        var signingAttributesOrigin: SesV2ClientTypes.DkimSigningAttributesOrigin?
        ...
        var status: SesV2ClientTypes.DkimStatus?
...
extension SesV2ClientTypes {
    ...
    public struct DkimSigningAttributes: Swift.Equatable {
        ...
        var domainSigningPrivateKey: Swift.String?
        /// [Bring Your Own DKIM] A string that's used to identify a public key in the DNS configuration for a domain.
        var domainSigningSelector: Swift.String?
        /// [Easy DKIM] The key length of the future DKIM key pair to be generated. This can be changed at most once per day.
        var nextSigningKeyLength: SesV2ClientTypes.DkimSigningKeyLength?
...
extension SesV2ClientTypes {
    ...
    public struct DomainDeliverabilityCampaign: Swift.Equatable {
        ...
        var campaignId: Swift.String?
        /// The percentage of email messages that were deleted by recipients, without being opened first. Due to technical limitations, this value only includes recipients who opened the message by using an email client that supports images.
        var deleteRate: Swift.Double?
        /// The major email providers who handled the email message.
        var esps: [Swift.String]?
        /// The first time, in Unix time format, when the email message was delivered to any recipient's inbox. This value can help you determine how long it took for a campaign to deliver an email message.
        var firstSeenDateTime: ClientRuntime.Date?
        /// The verified email address that the email message was sent from.
        var fromAddress: Swift.String?
        /// The URL of an image that contains a snapshot of the email message that was sent.
        var imageUrl: Swift.String?
        /// The number of email messages that were delivered to recipients’ inboxes.
        var inboxCount: Swift.Int?
        /// The last time, in Unix time format, when the email message was delivered to any recipient's inbox. This value can help you determine how long it took for a campaign to deliver an email message.
        var lastSeenDateTime: ClientRuntime.Date?
        /// The projected number of recipients that the email message was sent to.
        var projectedVolume: Swift.Int?
        /// The percentage of email messages that were opened and then deleted by recipients. Due to technical limitations, this value only includes recipients who opened the message by using an email client that supports images.
        var readDeleteRate: Swift.Double?
        /// The percentage of email messages that were opened by recipients. Due to technical limitations, this value only includes recipients who opened the message by using an email client that supports images.
        var readRate: Swift.Double?
        /// The IP addresses that were used to send the email message.
        var sendingIps: [Swift.String]?
        /// The number of email messages that were delivered to recipients' spam or junk mail folders.
        var spamCount: Swift.Int?
...
extension SesV2ClientTypes {
    ...
    public struct DomainDeliverabilityTrackingOption: Swift.Equatable {
        ...
        var inboxPlacementTrackingOption: SesV2ClientTypes.InboxPlacementTrackingOption?
        /// The date, in Unix time format, when you enabled the Deliverability dashboard for the domain.
        var subscriptionStartDate: ClientRuntime.Date?
...
extension SesV2ClientTypes {
    ...
    public struct DomainIspPlacement: Swift.Equatable {
        ...
        var inboxPercentage: Swift.Double?
        /// The total number of messages that were sent from the selected domain to the specified email provider that arrived in recipients' inboxes.
        var inboxRawCount: Swift.Int?
        /// The name of the email provider that the inbox placement data applies to.
        var ispName: Swift.String?
        /// The percentage of messages that were sent from the selected domain to the specified email provider that arrived in recipients' spam or junk mail folders.
        var spamPercentage: Swift.Double?
        /// The total number of messages that were sent from the selected domain to the specified email provider that arrived in recipients' spam or junk mail folders.
        var spamRawCount: Swift.Int?
...
extension SesV2ClientTypes {
    ...
    public struct EmailContent: Swift.Equatable {
        ...
        var raw: SesV2ClientTypes.RawMessage?
        /// The simple email message. The message consists of a subject and a message body.
        var simple: SesV2ClientTypes.Message?
...
extension SesV2ClientTypes {
    ...
    public struct EventDestination: Swift.Equatable {
        /// An object that defines an Amazon CloudWatch destination for email events. You can use Amazon CloudWatch to monitor and gain insights on your email sending metrics.
        var cloudWatchDestination: SesV2ClientTypes.CloudWatchDestination?
        ...
        var kinesisFirehoseDestination: SesV2ClientTypes.KinesisFirehoseDestination?
        /// The types of events that Amazon SES sends to the specified event destinations.
        /// This member is required.
        var matchingEventTypes: [SesV2ClientTypes.EventType]?
        ...
        var pinpointDestination: SesV2ClientTypes.PinpointDestination?
        /// An object that defines an Amazon SNS destination for email events. You can use Amazon SNS to send notification when certain email events occur.
        var snsDestination: SesV2ClientTypes.SnsDestination?
...
extension SesV2ClientTypes {
    ...
    public struct FailureInfo: Swift.Equatable {
        ...
        var failedRecordsS3Url: Swift.String?
...
public struct GetAccountOutputResponse: Swift.Equatable {
    ...
    var dedicatedIpAutoWarmupEnabled: Swift.Bool
    /// An object that defines your account details.
    var details: SesV2ClientTypes.AccountDetails?
    ...
    var enforcementStatus: Swift.String?
    ...
    var productionAccessEnabled: Swift.Bool
    /// An object that contains information about the per-day and per-second sending limits for your Amazon SES account in the current Amazon Web Services Region.
    var sendQuota: SesV2ClientTypes.SendQuota?
    ...
    var suppressionAttributes: SesV2ClientTypes.SuppressionAttributes?
...
public struct GetBlacklistReportsInput: Swift.Equatable {
    ...
    /// This member is required.
    var blacklistItemNames: [Swift.String]?
...
public struct GetBlacklistReportsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var blacklistReport: [Swift.String:[SesV2ClientTypes.BlacklistEntry]]?
...
public struct GetConfigurationSetEventDestinationsOutputResponse: Swift.Equatable {
    ...
    var eventDestinations: [SesV2ClientTypes.EventDestination]?
...
public struct GetDedicatedIpOutputResponse: Swift.Equatable {
    ...
    var dedicatedIp: SesV2ClientTypes.DedicatedIp?
...
public struct GetDedicatedIpsOutputResponse: Swift.Equatable {
    ...
    var dedicatedIps: [SesV2ClientTypes.DedicatedIp]?
...
public struct GetDeliverabilityDashboardOptionsOutputResponse: Swift.Equatable {
    /// The current status of your Deliverability dashboard subscription. If this value is PENDING_EXPIRATION, your subscription is scheduled to expire at the end of the current calendar month.
    var accountStatus: SesV2ClientTypes.DeliverabilityDashboardAccountStatus?
    /// An array of objects, one for each verified domain that you use to send email and currently has an active Deliverability dashboard subscription that isn’t scheduled to expire at the end of the current calendar month.
    var activeSubscribedDomains: [SesV2ClientTypes.DomainDeliverabilityTrackingOption]?
    /// Specifies whether the Deliverability dashboard is enabled. If this value is true, the dashboard is enabled.
    /// This member is required.
    var dashboardEnabled: Swift.Bool
    /// An array of objects, one for each verified domain that you use to send email and currently has an active Deliverability dashboard subscription that's scheduled to expire at the end of the current calendar month.
    var pendingExpirationSubscribedDomains: [SesV2ClientTypes.DomainDeliverabilityTrackingOption]?
    /// The date, in Unix time format, when your current subscription to the Deliverability dashboard is scheduled to expire, if your subscription is scheduled to expire at the end of the current calendar month. This value is null if you have an active subscription that isn’t due to expire at the end of the month.
    var subscriptionExpiryDate: ClientRuntime.Date?
...
public struct GetDeliverabilityTestReportOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var deliverabilityTestReport: SesV2ClientTypes.DeliverabilityTestReport?
    /// An object that describes how the test email was handled by several email providers, including Gmail, Hotmail, Yahoo, AOL, and others.
    /// This member is required.
    var ispPlacements: [SesV2ClientTypes.IspPlacement]?
    /// An object that contains the message that you sent when you performed this predictive inbox placement test.
    var message: Swift.String?
    /// An object that specifies how many test messages that were sent during the predictive inbox placement test were delivered to recipients' inboxes, how many were sent to recipients' spam folders, and how many weren't delivered.
    /// This member is required.
    var overallPlacement: SesV2ClientTypes.PlacementStatistics?
...
public struct GetDomainDeliverabilityCampaignOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var domainDeliverabilityCampaign: SesV2ClientTypes.DomainDeliverabilityCampaign?
...
public struct GetDomainStatisticsReportOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var dailyVolumes: [SesV2ClientTypes.DailyVolume]?
    /// An object that contains deliverability metrics for the domain that you specified. The data in this object is a summary of all of the data that was collected from the StartDate to the EndDate.
    /// This member is required.
    var overallVolume: SesV2ClientTypes.OverallVolume?
...
public struct GetEmailIdentityOutputResponse: Swift.Equatable {
    ...
    var feedbackForwardingStatus: Swift.Bool
    /// The email identity type. Note: the MANAGED_DOMAIN identity type is not supported.
    var identityType: SesV2ClientTypes.IdentityType?
    /// An object that contains information about the Mail-From attributes for the email identity.
    var mailFromAttributes: SesV2ClientTypes.MailFromAttributes?
...
public struct GetImportJobOutputResponse: Swift.Equatable {
    ...
    var completedTimestamp: ClientRuntime.Date?
    /// The time stamp of when the import job was created.
    var createdTimestamp: ClientRuntime.Date?
    /// The number of records that failed processing because of invalid input or other reasons.
    var failedRecordsCount: Swift.Int?
    /// The failure details about an import job.
    var failureInfo: SesV2ClientTypes.FailureInfo?
    ...
    var jobStatus: SesV2ClientTypes.JobStatus?
...
public struct GetSuppressedDestinationOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var suppressedDestination: SesV2ClientTypes.SuppressedDestination?
...
extension SesV2ClientTypes {
    ...
    public struct ImportDataSource: Swift.Equatable {
        /// The data format of the import job's data source.
        /// This member is required.
        var dataFormat: SesV2ClientTypes.DataFormat?
        /// An Amazon S3 URL in the format s3:///.
        /// This member is required.
        var s3Url: Swift.String?
...
extension SesV2ClientTypes {
    ...
    public struct ImportDestination: Swift.Equatable {
        ...
        var contactListDestination: SesV2ClientTypes.ContactListDestination?
        /// An object that contains the action of the import job towards suppression list.
        var suppressionListDestination: SesV2ClientTypes.SuppressionListDestination?
...
extension SesV2ClientTypes {
    ...
    public struct InboxPlacementTrackingOption: Swift.Equatable {
        ...
        var global: Swift.Bool
        /// An array of strings, one for each major email provider that the inbox placement data applies to.
        var trackedIsps: [Swift.String]?
...
extension SesV2ClientTypes {
    ...
    public struct IspPlacement: Swift.Equatable {
        ...
        var placementStatistics: SesV2ClientTypes.PlacementStatistics?
...
public struct ListContactListsOutputResponse: Swift.Equatable {
    ...
    var contactLists: [SesV2ClientTypes.ContactList]?
...
extension SesV2ClientTypes {
    ...
    public struct ListContactsFilter: Swift.Equatable {
        ...
        var filteredStatus: SesV2ClientTypes.SubscriptionStatus?
        /// Used for filtering by a specific topic preference.
        var topicFilter: SesV2ClientTypes.TopicFilter?
...
public struct ListContactsInput: Swift.Equatable {
    ...
    var contactListName: Swift.String?
    /// A filter that can be applied to a list of contacts.
    var filter: SesV2ClientTypes.ListContactsFilter?
...
public struct ListContactsOutputResponse: Swift.Equatable {
    ...
    var contacts: [SesV2ClientTypes.Contact]?
...
public struct ListCustomVerificationEmailTemplatesOutputResponse: Swift.Equatable {
    ...
    var customVerificationEmailTemplates: [SesV2ClientTypes.CustomVerificationEmailTemplateMetadata]?
...
public struct ListDedicatedIpPoolsOutputResponse: Swift.Equatable {
    ...
    var dedicatedIpPools: [Swift.String]?
...
public struct ListDeliverabilityTestReportsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var deliverabilityTestReports: [SesV2ClientTypes.DeliverabilityTestReport]?
...
public struct ListDomainDeliverabilityCampaignsInput: Swift.Equatable {
    ...
    /// This member is required.
    var subscribedDomain: Swift.String?
...
public struct ListDomainDeliverabilityCampaignsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var domainDeliverabilityCampaigns: [SesV2ClientTypes.DomainDeliverabilityCampaign]?
...
public struct ListEmailIdentitiesOutputResponse: Swift.Equatable {
    ...
    var emailIdentities: [SesV2ClientTypes.IdentityInfo]?
...
public struct ListEmailTemplatesOutputResponse: Swift.Equatable {
    ...
    var templatesMetadata: [SesV2ClientTypes.EmailTemplateMetadata]?
...
public struct ListImportJobsInput: Swift.Equatable {
    /// The destination of the import job, which can be used to list import jobs that have a certain ImportDestinationType.
    var importDestinationType: SesV2ClientTypes.ImportDestinationType?
...
public struct ListImportJobsOutputResponse: Swift.Equatable {
    ...
    var importJobs: [SesV2ClientTypes.ImportJobSummary]?
    /// A string token indicating that there might be additional import jobs available to be listed. Copy this token to a subsequent call to ListImportJobs with the same parameters to retrieve the next page of import jobs.
    var nextToken: Swift.String?
...
public struct ListSuppressedDestinationsInput: Swift.Equatable {
    ...
    var reasons: [SesV2ClientTypes.SuppressionListReason]?
...
public struct ListSuppressedDestinationsOutputResponse: Swift.Equatable {
    ...
    var suppressedDestinationSummaries: [SesV2ClientTypes.SuppressedDestinationSummary]?
...
extension SesV2ClientTypes {
    ...
    public struct MailFromAttributes: Swift.Equatable {
        /// The action to take if the required MX record can't be found when you send an email. When you set this value to UseDefaultValue, the mail is sent using amazonses.com as the MAIL FROM domain. When you set this value to RejectMessage, the Amazon SES API v2 returns a MailFromDomainNotVerified error, and doesn't attempt to deliver the email. These behaviors are taken when the custom MAIL FROM domain configuration is in the Pending, Failed, and TemporaryFailure states.
        /// This member is required.
        var behaviorOnMxFailure: SesV2ClientTypes.BehaviorOnMxFailure?
        ...
        /// This member is required.
        var mailFromDomainStatus: SesV2ClientTypes.MailFromDomainStatus?
...
extension SesV2ClientTypes {
    ...
    public struct Message: Swift.Equatable {
        ...
        /// This member is required.
        var body: SesV2ClientTypes.Body?
        ...
        /// This member is required.
        var subject: SesV2ClientTypes.Content?
...
extension SesV2ClientTypes {
    ...
    public struct OverallVolume: Swift.Equatable {
        ...
        var readRatePercent: Swift.Double?
...
extension SesV2ClientTypes {
    ...
    public struct PlacementStatistics: Swift.Equatable {
        ...
        var dkimPercentage: Swift.Double?
        /// The percentage of emails that arrived in recipients' inboxes during the predictive inbox placement test.
        var inboxPercentage: Swift.Double?
        /// The percentage of emails that didn't arrive in recipients' inboxes at all during the predictive inbox placement test.
        var missingPercentage: Swift.Double?
        /// The percentage of emails that arrived in recipients' spam or junk mail folders during the predictive inbox placement test.
        var spamPercentage: Swift.Double?
        /// The percentage of emails that were authenticated by using Sender Policy Framework (SPF) during the predictive inbox placement test.
        var spfPercentage: Swift.Double?
...
public struct PutAccountDedicatedIpWarmupAttributesInput: Swift.Equatable {
    ...
    var autoWarmupEnabled: Swift.Bool
...
public struct PutAccountSuppressionAttributesInput: Swift.Equatable {
    ...
    var suppressedReasons: [SesV2ClientTypes.SuppressionListReason]?
...
public struct PutDedicatedIpInPoolInput: Swift.Equatable {
    ...
    /// This member is required.
    var destinationPoolName: Swift.String?
...
public struct PutDeliverabilityDashboardOptionInput: Swift.Equatable {
    ...
    var subscribedDomains: [SesV2ClientTypes.DomainDeliverabilityTrackingOption]?
...
public struct PutEmailIdentityDkimSigningAttributesInput: Swift.Equatable {
    ...
    var signingAttributes: SesV2ClientTypes.DkimSigningAttributes?
...
public struct PutEmailIdentityDkimSigningAttributesOutputResponse: Swift.Equatable {
    ...
    ///
    /// * NOT_STARTED – The DKIM verification process hasn't been initiated for the domain.
    var dkimStatus: SesV2ClientTypes.DkimStatus?
...
public struct PutEmailIdentityFeedbackAttributesInput: Swift.Equatable {
    ...
    var emailForwardingEnabled: Swift.Bool
    /// The email identity.
    /// This member is required.
    var emailIdentity: Swift.String?
...
public struct PutSuppressedDestinationInput: Swift.Equatable {
    ...
    /// This member is required.
    var reason: SesV2ClientTypes.SuppressionListReason?
...
extension SesV2ClientTypes {
    ...
    public struct ReplacementEmailContent: Swift.Equatable {
        ...
        var replacementTemplate: SesV2ClientTypes.ReplacementTemplate?
...
extension SesV2ClientTypes {
    ...
    public struct ReviewDetails: Swift.Equatable {
        ...
        var status: SesV2ClientTypes.ReviewStatus?
...
public struct SendBulkEmailInput: Swift.Equatable {
    ...
    /// This member is required.
    var bulkEmailEntries: [SesV2ClientTypes.BulkEmailEntry]?
    /// The name of the configuration set to use when sending the email.
    var configurationSetName: Swift.String?
    /// An object that contains the body of the message. You can specify a template message.
    /// This member is required.
    var defaultContent: SesV2ClientTypes.BulkEmailContent?
    /// A list of tags, in the form of name/value pairs, to apply to an email that you send using the SendEmail operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.
    var defaultEmailTags: [SesV2ClientTypes.MessageTag]?
    /// The address that you want bounce and complaint notifications to be sent to.
    var feedbackForwardingEmailAddress: Swift.String?
    ...
    var feedbackForwardingEmailAddressIdentityArn: Swift.String?
    ...
    var fromEmailAddressIdentityArn: Swift.String?
...
public struct SendBulkEmailOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var bulkEmailEntryResults: [SesV2ClientTypes.BulkEmailEntryResult]?
...
public struct SendEmailInput: Swift.Equatable {
    ...
    var destination: SesV2ClientTypes.Destination?
    /// A list of tags, in the form of name/value pairs, to apply to an email that you send using the SendEmail operation. Tags correspond to characteristics of the email that you define, so that you can publish email sending events.
    var emailTags: [SesV2ClientTypes.MessageTag]?
    /// The address that you want bounce and complaint notifications to be sent to.
    var feedbackForwardingEmailAddress: Swift.String?
    /// This parameter is used only for sending authorization. It is the ARN of the identity that is associated with the sending authorization policy that permits you to use the email address specified in the FeedbackForwardingEmailAddress parameter. For example, if the owner of example.com (which has ARN arn:aws:ses:us-east-1:123456789012:identity/example.com) attaches a policy to it that authorizes you to use feedback@example.com, then you would specify the FeedbackForwardingEmailAddressIdentityArn to be arn:aws:ses:us-east-1:123456789012:identity/example.com, and the FeedbackForwardingEmailAddress to be feedback@example.com. For more information about sending authorization, see the [Amazon SES Developer Guide](https://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization.html).
    var feedbackForwardingEmailAddressIdentityArn: Swift.String?
    ...
    var fromEmailAddressIdentityArn: Swift.String?
    /// An object used to specify a list or topic to which an email belongs, which will be used when a contact chooses to unsubscribe.
    var listManagementOptions: SesV2ClientTypes.ListManagementOptions?
    /// The "Reply-to" email addresses for the message. When the recipient replies to the message, each Reply-to address receives the reply.
    var replyToAddresses: [Swift.String]?
...
extension SesV2ClientTypes {
    ...
    public struct SuppressedDestination: Swift.Equatable {
        ...
        var attributes: SesV2ClientTypes.SuppressedDestinationAttributes?
...
extension SesV2ClientTypes {
    ...
    public struct SuppressionListDestination: Swift.Equatable {
        ...
        /// This member is required.
        var suppressionListImportAction: SesV2ClientTypes.SuppressionListImportAction?
...
extension SesV2ClientTypes {
    ...
    public struct Topic: Swift.Equatable {
        ...
        /// This member is required.
        var defaultSubscriptionStatus: SesV2ClientTypes.SubscriptionStatus?
...
extension SesV2ClientTypes {
    ...
    public struct TopicFilter: Swift.Equatable {
        ...
        var useDefaultIfPreferenceUnavailable: Swift.Bool
...
extension SesV2ClientTypes {
    ...
    public struct TopicPreference: Swift.Equatable {
        ...
        /// This member is required.
        var subscriptionStatus: SesV2ClientTypes.SubscriptionStatus?
        /// The name of the topic.
        /// This member is required.
        var topicName: Swift.String?
...
extension SesV2ClientTypes {
    ...
    public struct VolumeStatistics: Swift.Equatable {
        ...
        var projectedInbox: Swift.Int?
        /// An estimate of the percentage of emails sent from the current domain that will arrive in recipients' spam or junk mail folders.
        var projectedSpam: Swift.Int?
