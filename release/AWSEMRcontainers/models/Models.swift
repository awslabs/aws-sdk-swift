...
public struct CancelJobRunInput: Swift.Equatable {
    ...
    /// This member is required.
    var virtualClusterId: Swift.String?
...
extension EmrContainersClientTypes {
    ...
    public struct Configuration: Swift.Equatable {
        ...
        /// This member is required.
        var classification: Swift.String?
        /// A list of additional configurations to apply within a configuration object.
        var configurations: [EmrContainersClientTypes.Configuration]?
...
extension EmrContainersClientTypes {
    ...
    public struct ConfigurationOverrides: Swift.Equatable {
        ...
        var applicationConfiguration: [EmrContainersClientTypes.Configuration]?
        /// The configurations for monitoring.
        var monitoringConfiguration: EmrContainersClientTypes.MonitoringConfiguration?
...
extension EmrContainersClientTypes {
    ...
    public struct ContainerProvider: Swift.Equatable {
        ...
        var info: EmrContainersClientTypes.ContainerInfo?
        /// The type of the container provider. EKS is the only supported type as of now.
        /// This member is required.
        var type: EmrContainersClientTypes.ContainerProviderType?
...
public struct CreateManagedEndpointInput: Swift.Equatable {
    ...
    var configurationOverrides: EmrContainersClientTypes.ConfigurationOverrides?
...
public struct CreateVirtualClusterInput: Swift.Equatable {
    ...
    /// This member is required.
    var containerProvider: EmrContainersClientTypes.ContainerProvider?
...
public struct DescribeJobRunOutputResponse: Swift.Equatable {
    ...
    var jobRun: EmrContainersClientTypes.JobRun?
...
public struct DescribeManagedEndpointOutputResponse: Swift.Equatable {
    ...
    var endpoint: EmrContainersClientTypes.Endpoint?
...
public struct DescribeVirtualClusterOutputResponse: Swift.Equatable {
    ...
    var virtualCluster: EmrContainersClientTypes.VirtualCluster?
...
extension EmrContainersClientTypes {
    ...
    public struct Endpoint: Swift.Equatable {
        ...
        var certificateAuthority: EmrContainersClientTypes.Certificate?
        ...
        var failureReason: EmrContainersClientTypes.FailureReason?
        ...
        var state: EmrContainersClientTypes.EndpointState?
        /// Additional details of the endpoint state.
        var stateDetails: Swift.String?
...
extension EmrContainersClientTypes {
    ...
    public struct JobDriver: Swift.Equatable {
        ...
        var sparkSubmitJobDriver: EmrContainersClientTypes.SparkSubmitJobDriver?
...
extension EmrContainersClientTypes {
    ...
    public struct JobRun: Swift.Equatable {
        ...
        var jobDriver: EmrContainersClientTypes.JobDriver?
        /// The name of the job run.
        var name: Swift.String?
        /// The release version of Amazon EMR.
        var releaseLabel: Swift.String?
        /// The state of the job run.
        var state: EmrContainersClientTypes.JobRunState?
...
public struct ListJobRunsInput: Swift.Equatable {
    ...
    var states: [EmrContainersClientTypes.JobRunState]?
...
public struct ListJobRunsOutputResponse: Swift.Equatable {
    ...
    var jobRuns: [EmrContainersClientTypes.JobRun]?
...
public struct ListManagedEndpointsInput: Swift.Equatable {
    ...
    var states: [EmrContainersClientTypes.EndpointState]?
...
public struct ListManagedEndpointsOutputResponse: Swift.Equatable {
    ...
    var endpoints: [EmrContainersClientTypes.Endpoint]?
...
public struct ListVirtualClustersInput: Swift.Equatable {
    ...
    var containerProviderId: Swift.String?
    /// The container provider type of the virtual cluster. EKS is the only supported type as of now.
    var containerProviderType: EmrContainersClientTypes.ContainerProviderType?
    ...
    var states: [EmrContainersClientTypes.VirtualClusterState]?
...
public struct ListVirtualClustersOutputResponse: Swift.Equatable {
    ...
    var virtualClusters: [EmrContainersClientTypes.VirtualCluster]?
...
extension EmrContainersClientTypes {
    ...
    public struct MonitoringConfiguration: Swift.Equatable {
        ...
        var cloudWatchMonitoringConfiguration: EmrContainersClientTypes.CloudWatchMonitoringConfiguration?
        /// Monitoring configurations for the persistent application UI.
        var persistentAppUI: EmrContainersClientTypes.PersistentAppUI?
        /// Amazon S3 configuration for monitoring log publishing.
        var s3MonitoringConfiguration: EmrContainersClientTypes.S3MonitoringConfiguration?
...
extension EmrContainersClientTypes {
    ...
    public struct SparkSubmitJobDriver: Swift.Equatable {
        ...
        var entryPointArguments: [Swift.String]?
        /// The Spark submit parameters that are used for job runs.
        var sparkSubmitParameters: Swift.String?
...
extension EmrContainersClientTypes {
    ...
    public struct VirtualCluster: Swift.Equatable {
        ...
        var state: EmrContainersClientTypes.VirtualClusterState?
