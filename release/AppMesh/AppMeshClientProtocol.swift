...
public protocol AppMeshClientProtocol {
    ...
    func createGatewayRoute(input: CreateGatewayRouteInput, completion: @escaping (SdkResult<CreateGatewayRouteOutput, CreateGatewayRouteOutputError>) -> Void)
    ...
    func createMesh(input: CreateMeshInput, completion: @escaping (SdkResult<CreateMeshOutput, CreateMeshOutputError>) -> Void)
    ...
    func createVirtualGateway(input: CreateVirtualGatewayInput, completion: @escaping (SdkResult<CreateVirtualGatewayOutput, CreateVirtualGatewayOutputError>) -> Void)
    ...
    func createVirtualNode(input: CreateVirtualNodeInput, completion: @escaping (SdkResult<CreateVirtualNodeOutput, CreateVirtualNodeOutputError>) -> Void)
    ...
    func createVirtualRouter(input: CreateVirtualRouterInput, completion: @escaping (SdkResult<CreateVirtualRouterOutput, CreateVirtualRouterOutputError>) -> Void)
    ...
    func createVirtualService(input: CreateVirtualServiceInput, completion: @escaping (SdkResult<CreateVirtualServiceOutput, CreateVirtualServiceOutputError>) -> Void)
    /// <p>Deletes an existing gateway route.</p>
    func deleteGatewayRoute(input: DeleteGatewayRouteInput, completion: @escaping (SdkResult<DeleteGatewayRouteOutput, DeleteGatewayRouteOutputError>) -> Void)
    /// <p>Deletes an existing service mesh.</p>
    ///          <p>You must delete all resources (virtual services, routes, virtual routers, and virtual
    ///          nodes) in the service mesh before you can delete the mesh itself.</p>
    func deleteMesh(input: DeleteMeshInput, completion: @escaping (SdkResult<DeleteMeshOutput, DeleteMeshOutputError>) -> Void)
    ...
    func deleteVirtualGateway(input: DeleteVirtualGatewayInput, completion: @escaping (SdkResult<DeleteVirtualGatewayOutput, DeleteVirtualGatewayOutputError>) -> Void)
    /// <p>Deletes an existing virtual node.</p>
    ///          <p>You must delete any virtual services that list a virtual node as a service provider
    ///          before you can delete the virtual node itself.</p>
    func deleteVirtualNode(input: DeleteVirtualNodeInput, completion: @escaping (SdkResult<DeleteVirtualNodeOutput, DeleteVirtualNodeOutputError>) -> Void)
    /// <p>Deletes an existing virtual router.</p>
    ///          <p>You must delete any routes associated with the virtual router before you can delete the
    ///          router itself.</p>
    func deleteVirtualRouter(input: DeleteVirtualRouterInput, completion: @escaping (SdkResult<DeleteVirtualRouterOutput, DeleteVirtualRouterOutputError>) -> Void)
    /// <p>Deletes an existing virtual service.</p>
    func deleteVirtualService(input: DeleteVirtualServiceInput, completion: @escaping (SdkResult<DeleteVirtualServiceOutput, DeleteVirtualServiceOutputError>) -> Void)
    /// <p>Describes an existing gateway route.</p>
    func describeGatewayRoute(input: DescribeGatewayRouteInput, completion: @escaping (SdkResult<DescribeGatewayRouteOutput, DescribeGatewayRouteOutputError>) -> Void)
    /// <p>Describes an existing service mesh.</p>
    func describeMesh(input: DescribeMeshInput, completion: @escaping (SdkResult<DescribeMeshOutput, DescribeMeshOutputError>) -> Void)
    /// <p>Describes an existing route.</p>
    func describeRoute(input: DescribeRouteInput, completion: @escaping (SdkResult<DescribeRouteOutput, DescribeRouteOutputError>) -> Void)
    /// <p>Describes an existing virtual gateway.</p>
    func describeVirtualGateway(input: DescribeVirtualGatewayInput, completion: @escaping (SdkResult<DescribeVirtualGatewayOutput, DescribeVirtualGatewayOutputError>) -> Void)
    /// <p>Describes an existing virtual node.</p>
    func describeVirtualNode(input: DescribeVirtualNodeInput, completion: @escaping (SdkResult<DescribeVirtualNodeOutput, DescribeVirtualNodeOutputError>) -> Void)
    /// <p>Describes an existing virtual router.</p>
    func describeVirtualRouter(input: DescribeVirtualRouterInput, completion: @escaping (SdkResult<DescribeVirtualRouterOutput, DescribeVirtualRouterOutputError>) -> Void)
    /// <p>Describes an existing virtual service.</p>
    func describeVirtualService(input: DescribeVirtualServiceInput, completion: @escaping (SdkResult<DescribeVirtualServiceOutput, DescribeVirtualServiceOutputError>) -> Void)
    /// <p>Returns a list of existing gateway routes that are associated to a virtual
    ///          gateway.</p>
    func listGatewayRoutes(input: ListGatewayRoutesInput, completion: @escaping (SdkResult<ListGatewayRoutesOutput, ListGatewayRoutesOutputError>) -> Void)
    /// <p>Returns a list of existing service meshes.</p>
    func listMeshes(input: ListMeshesInput, completion: @escaping (SdkResult<ListMeshesOutput, ListMeshesOutputError>) -> Void)
    /// <p>Returns a list of existing routes in a service mesh.</p>
    func listRoutes(input: ListRoutesInput, completion: @escaping (SdkResult<ListRoutesOutput, ListRoutesOutputError>) -> Void)
    ...
    func listVirtualGateways(input: ListVirtualGatewaysInput, completion: @escaping (SdkResult<ListVirtualGatewaysOutput, ListVirtualGatewaysOutputError>) -> Void)
    /// <p>Returns a list of existing virtual nodes.</p>
    func listVirtualNodes(input: ListVirtualNodesInput, completion: @escaping (SdkResult<ListVirtualNodesOutput, ListVirtualNodesOutputError>) -> Void)
    /// <p>Returns a list of existing virtual routers in a service mesh.</p>
    func listVirtualRouters(input: ListVirtualRoutersInput, completion: @escaping (SdkResult<ListVirtualRoutersOutput, ListVirtualRoutersOutputError>) -> Void)
    /// <p>Returns a list of existing virtual services in a service mesh.</p>
    func listVirtualServices(input: ListVirtualServicesInput, completion: @escaping (SdkResult<ListVirtualServicesOutput, ListVirtualServicesOutputError>) -> Void)
    ...
    ///          service mesh.</p>
    func updateGatewayRoute(input: UpdateGatewayRouteInput, completion: @escaping (SdkResult<UpdateGatewayRouteOutput, UpdateGatewayRouteOutputError>) -> Void)
    /// <p>Updates an existing service mesh.</p>
    func updateMesh(input: UpdateMeshInput, completion: @escaping (SdkResult<UpdateMeshOutput, UpdateMeshOutputError>) -> Void)
    ...
    func updateVirtualGateway(input: UpdateVirtualGatewayInput, completion: @escaping (SdkResult<UpdateVirtualGatewayOutput, UpdateVirtualGatewayOutputError>) -> Void)
    /// <p>Updates an existing virtual node in a specified service mesh.</p>
    func updateVirtualNode(input: UpdateVirtualNodeInput, completion: @escaping (SdkResult<UpdateVirtualNodeOutput, UpdateVirtualNodeOutputError>) -> Void)
    /// <p>Updates an existing virtual router in a specified service mesh.</p>
    func updateVirtualRouter(input: UpdateVirtualRouterInput, completion: @escaping (SdkResult<UpdateVirtualRouterOutput, UpdateVirtualRouterOutputError>) -> Void)
    /// <p>Updates an existing virtual service in a specified service mesh.</p>
    func updateVirtualService(input: UpdateVirtualServiceInput, completion: @escaping (SdkResult<UpdateVirtualServiceOutput, UpdateVirtualServiceOutputError>) -> Void)
}
