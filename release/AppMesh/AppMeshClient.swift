...
public class AppMeshClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try AppMeshClientConfiguration(region: unwrappedRegion)
    ...
    public class AppMeshClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("AppMeshClient")
...
public struct AppMeshClientLogHandlerFactory: SDKLogHandlerFactory {
