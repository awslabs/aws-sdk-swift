...
extension DataExchangeClientTypes {
    ...
    public struct Action: Swift.Equatable {
        ...
        var exportRevisionToS3: DataExchangeClientTypes.AutoExportRevisionToS3RequestDetails?
...
extension DataExchangeClientTypes {
    ...
    public struct ApiGatewayApiAsset: Swift.Equatable {
        ...
        var apiDescription: Swift.String?
        ...
        var apiSpecificationDownloadUrl: Swift.String?
        /// The date and time that the upload URL expires, in ISO 8601 format.
        var apiSpecificationDownloadUrlExpiresAt: ClientRuntime.Date?
        /// The protocol type of the API asset.
        var protocolType: DataExchangeClientTypes.ProtocolType?
...
extension DataExchangeClientTypes {
    ...
    public struct AssetDetails: Swift.Equatable {
        ...
        var apiGatewayApiAsset: DataExchangeClientTypes.ApiGatewayApiAsset?
        /// The Amazon Redshift datashare that is the asset.
        var redshiftDataShareAsset: DataExchangeClientTypes.RedshiftDataShareAsset?
        /// The S3 object that is the asset.
        var s3SnapshotAsset: DataExchangeClientTypes.S3SnapshotAsset?
...
extension DataExchangeClientTypes {
    ...
    public struct AssetEntry: Swift.Equatable {
        ...
        /// Information about the asset.
        /// This member is required.
        var assetDetails: DataExchangeClientTypes.AssetDetails?
        /// The type of asset that is added to a data set.
        /// This member is required.
        var assetType: DataExchangeClientTypes.AssetType?
...
extension DataExchangeClientTypes {
    ...
    public struct AutoExportRevisionToS3RequestDetails: Swift.Equatable {
        ...
        var encryption: DataExchangeClientTypes.ExportServerSideEncryption?
        /// A revision destination is the Amazon S3 bucket folder destination to where the export will be sent.
        /// This member is required.
        var revisionDestination: DataExchangeClientTypes.AutoExportRevisionDestinationEntry?
...
public struct CreateDataSetOutputResponse: Swift.Equatable {
    ...
    var origin: DataExchangeClientTypes.Origin?
    /// If the origin of this data set is ENTITLED, includes the details for the product on AWS Marketplace.
    var originDetails: DataExchangeClientTypes.OriginDetails?
...
public struct CreateEventActionInput: Swift.Equatable {
    /// What occurs after a certain event.
    /// This member is required.
    var action: DataExchangeClientTypes.Action?
    /// What occurs to start an action.
    /// This member is required.
    var event: DataExchangeClientTypes.Event?
...
public struct CreateJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var details: DataExchangeClientTypes.RequestDetails?
    /// The type of job to be created.
    /// This member is required.
    var type: DataExchangeClientTypes.ModelType?
...
public struct CreateJobOutputResponse: Swift.Equatable {
    ...
    var details: DataExchangeClientTypes.ResponseDetails?
    /// The errors associated with jobs.
    var errors: [DataExchangeClientTypes.JobError]?
    /// The unique identifier for the job.
    var id: Swift.String?
    /// The state of the job.
    var state: DataExchangeClientTypes.State?
    /// The job type.
    var type: DataExchangeClientTypes.ModelType?
...
public struct DeleteEventActionInput: Swift.Equatable {
    /// The unique identifier for the event action.
    /// This member is required.
    var eventActionId: Swift.String?
...
extension DataExchangeClientTypes {
    ...
    public struct Details: Swift.Equatable {
        /// Information about the job error.
        var importAssetFromSignedUrlJobErrorDetails: DataExchangeClientTypes.ImportAssetFromSignedUrlJobErrorDetails?
        /// Information about the job error.
        var importAssetsFromS3JobErrorDetails: [DataExchangeClientTypes.AssetSourceEntry]?
...
extension DataExchangeClientTypes {
    ...
    public struct Event: Swift.Equatable {
        ...
        var revisionPublished: DataExchangeClientTypes.RevisionPublished?
...
extension DataExchangeClientTypes {
    ...
    public struct ExportAssetToSignedUrlResponseDetails: Swift.Equatable {
        ...
        var signedUrl: Swift.String?
        /// The date and time that the signed URL expires, in ISO 8601 format.
        var signedUrlExpiresAt: ClientRuntime.Date?
...
extension DataExchangeClientTypes {
    ...
    public struct ExportAssetsToS3RequestDetails: Swift.Equatable {
        /// The destination for the asset.
        /// This member is required.
        var assetDestinations: [DataExchangeClientTypes.AssetDestinationEntry]?
        /// The unique identifier for the data set associated with this export job.
        /// This member is required.
        var dataSetId: Swift.String?
...
extension DataExchangeClientTypes {
    ...
    public struct ExportRevisionsToS3RequestDetails: Swift.Equatable {
        ...
        /// This member is required.
        var revisionDestinations: [DataExchangeClientTypes.RevisionDestinationEntry]?
...
extension DataExchangeClientTypes {
    ...
    public struct ExportRevisionsToS3ResponseDetails: Swift.Equatable {
        ...
        var eventActionArn: Swift.String?
...
extension DataExchangeClientTypes {
    ...
    public struct ExportServerSideEncryption: Swift.Equatable {
        ...
        /// This member is required.
        var type: DataExchangeClientTypes.ServerSideEncryptionTypes?
...
extension DataExchangeClientTypes {
    ...
    public struct ImportAssetFromApiGatewayApiRequestDetails: Swift.Equatable {
        ...
        /// This member is required.
        var apiSpecificationMd5Hash: Swift.String?
        /// The data set ID.
        /// This member is required.
        var dataSetId: Swift.String?
        /// The protocol type.
...
extension DataExchangeClientTypes {
    ...
    public struct ImportAssetFromApiGatewayApiResponseDetails: Swift.Equatable {
        ...
        /// This member is required.
        var apiSpecificationUploadUrl: Swift.String?
        /// The date and time that the upload URL expires, in ISO 8601 format.
        /// This member is required.
        var apiSpecificationUploadUrlExpiresAt: ClientRuntime.Date?
        /// The data set ID.
        /// This member is required.
        var dataSetId: Swift.String?
        /// The protocol type.
...
extension DataExchangeClientTypes {
    ...
    public struct ImportAssetsFromRedshiftDataSharesRequestDetails: Swift.Equatable {
        ...
        /// This member is required.
        var assetSources: [DataExchangeClientTypes.RedshiftDataShareAssetSourceEntry]?
        /// The unique identifier for the data set associated with this import job.
        /// This member is required.
        var dataSetId: Swift.String?
...
extension DataExchangeClientTypes {
    ...
    public struct ImportAssetsFromS3RequestDetails: Swift.Equatable {
        ...
        /// This member is required.
        var assetSources: [DataExchangeClientTypes.AssetSourceEntry]?
        /// The unique identifier for the data set associated with this import job.
        /// This member is required.
        var dataSetId: Swift.String?
        /// The unique identifier for the revision associated with this import request.
...
extension DataExchangeClientTypes {
    ...
    public struct JobError: Swift.Equatable {
        ...
        /// This member is required.
        var code: DataExchangeClientTypes.Code?
        /// The details about the job error.
        var details: DataExchangeClientTypes.Details?
        /// The name of the limit that was reached.
        var limitName: DataExchangeClientTypes.JobErrorLimitName?
        /// The value of the exceeded limit.
        var limitValue: Swift.Double?
        ...
        var resourceType: DataExchangeClientTypes.JobErrorResourceTypes?
...
public struct ListDataSetRevisionsOutputResponse: Swift.Equatable {
    ...
    var revisions: [DataExchangeClientTypes.RevisionEntry]?
...
public struct ListDataSetsOutputResponse: Swift.Equatable {
    ...
    var dataSets: [DataExchangeClientTypes.DataSetEntry]?
    /// The token value retrieved from a previous call to access the next page of results.
    var nextToken: Swift.String?
...
public struct ListEventActionsInput: Swift.Equatable {
    ...
    var eventSourceId: Swift.String?
    /// The maximum number of results returned by a single call.
    var maxResults: Swift.Int?
    /// The token value retrieved from a previous call to access the next page of results.
    var nextToken: Swift.String?
...
public struct ListEventActionsOutputResponse: Swift.Equatable {
    ...
    var eventActions: [DataExchangeClientTypes.EventActionEntry]?
    /// The token value retrieved from a previous call to access the next page of results.
    var nextToken: Swift.String?
...
public struct ListJobsOutputResponse: Swift.Equatable {
    ...
    var jobs: [DataExchangeClientTypes.JobEntry]?
    /// The token value retrieved from a previous call to access the next page of results.
    var nextToken: Swift.String?
...
public struct ListRevisionAssetsOutputResponse: Swift.Equatable {
    /// The asset objects listed by the request.
    var assets: [DataExchangeClientTypes.AssetEntry]?
    /// The token value retrieved from a previous call to access the next page of results.
    var nextToken: Swift.String?
...
extension DataExchangeClientTypes {
    ...
    public struct RequestDetails: Swift.Equatable {
        ...
        var exportAssetToSignedUrl: DataExchangeClientTypes.ExportAssetToSignedUrlRequestDetails?
        /// Details about the export to Amazon S3 request.
        var exportAssetsToS3: DataExchangeClientTypes.ExportAssetsToS3RequestDetails?
        /// Details about the export to Amazon S3 request.
        var exportRevisionsToS3: DataExchangeClientTypes.ExportRevisionsToS3RequestDetails?
        /// Information about the import asset from API Gateway API request.
        var importAssetFromApiGatewayApi: DataExchangeClientTypes.ImportAssetFromApiGatewayApiRequestDetails?
        /// Details about the import from signed URL request.
        var importAssetFromSignedUrl: DataExchangeClientTypes.ImportAssetFromSignedUrlRequestDetails?
        /// Details from an import from Amazon Redshift datashare request.
        var importAssetsFromRedshiftDataShares: DataExchangeClientTypes.ImportAssetsFromRedshiftDataSharesRequestDetails?
        /// Details about the import from Amazon S3 request.
        var importAssetsFromS3: DataExchangeClientTypes.ImportAssetsFromS3RequestDetails?
...
extension DataExchangeClientTypes {
    ...
    public struct ResponseDetails: Swift.Equatable {
        ...
        var exportAssetToSignedUrl: DataExchangeClientTypes.ExportAssetToSignedUrlResponseDetails?
        /// Details for the export to Amazon S3 response.
        var exportAssetsToS3: DataExchangeClientTypes.ExportAssetsToS3ResponseDetails?
        /// Details for the export revisions to Amazon S3 response.
        var exportRevisionsToS3: DataExchangeClientTypes.ExportRevisionsToS3ResponseDetails?
        /// The response details.
        var importAssetFromApiGatewayApi: DataExchangeClientTypes.ImportAssetFromApiGatewayApiResponseDetails?
        /// Details for the import from signed URL response.
        var importAssetFromSignedUrl: DataExchangeClientTypes.ImportAssetFromSignedUrlResponseDetails?
        /// Details from an import from Amazon Redshift datashare response.
        var importAssetsFromRedshiftDataShares: DataExchangeClientTypes.ImportAssetsFromRedshiftDataSharesResponseDetails?
        /// Details for the import from Amazon S3 response.
        var importAssetsFromS3: DataExchangeClientTypes.ImportAssetsFromS3ResponseDetails?
...
public struct SendApiAssetInput: Swift.Equatable {
    ...
    var requestHeaders: [Swift.String:Swift.String]?
...
public struct SendApiAssetOutputResponse: Swift.Equatable {
    ...
    var responseHeaders: [Swift.String:Swift.String]?
