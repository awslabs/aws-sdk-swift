...
public extension DataExchangeClient {
    ...
    {
        typealias createEventActionContinuation = CheckedContinuation<CreateEventActionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createEventActionContinuation) in
            createEventAction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteEventActionContinuation = CheckedContinuation<DeleteEventActionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteEventActionContinuation) in
            deleteEventAction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getEventActionContinuation = CheckedContinuation<GetEventActionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getEventActionContinuation) in
            getEventAction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listEventActionsContinuation = CheckedContinuation<ListEventActionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listEventActionsContinuation) in
            listEventActions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias sendApiAssetContinuation = CheckedContinuation<SendApiAssetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: sendApiAssetContinuation) in
            sendApiAsset(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateEventActionContinuation = CheckedContinuation<UpdateEventActionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateEventActionContinuation) in
            updateEventAction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
