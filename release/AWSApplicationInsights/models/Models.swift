...
extension ApplicationInsightsClientTypes {
    ...
    public struct ApplicationComponent: Swift.Equatable {
        ...
        var componentRemarks: Swift.String?
        /// Workloads detected in the application component.
        var detectedWorkload: [Swift.String:[Swift.String:Swift.String]]?
        /// Indicates whether the application component is monitored.
        var monitor: Swift.Bool?
        /// The operating system of the component.
        var osType: ApplicationInsightsClientTypes.OsType?
        /// The resource type. Supported resource types include EC2 instances, Auto Scaling group, Classic ELB, Application ELB, and SQS Queue.
        var resourceType: Swift.String?
        /// The stack tier of the application component.
        var tier: ApplicationInsightsClientTypes.Tier?
...
extension ApplicationInsightsClientTypes {
    ...
    public struct ApplicationInfo: Swift.Equatable {
        var autoConfigEnabled: Swift.Bool?
        /// Indicates whether Application Insights can listen to CloudWatch events for the application resources, such as instance terminated, failed deployment, and others.
        var cWEMonitorEnabled: Swift.Bool?
        var discoveryType: ApplicationInsightsClientTypes.DiscoveryType?
        /// The lifecycle of the application.
        var lifeCycle: Swift.String?
        /// Indicates whether Application Insights will create opsItems for any problem detected by Application Insights for an application.
        var opsCenterEnabled: Swift.Bool?
        /// The SNS topic provided to Application Insights that is associated to the created opsItems to receive SNS notifications for opsItem updates.
        var opsItemSNSTopicArn: Swift.String?
        /// The issues on the user side that block Application Insights from successfully monitoring an application. Example remarks include:
        ///
        /// * “Configuring application, detected 1 Errors, 3 Warnings”
        ///
        /// * “Configuring application, detected 1 Unconfigured Components”
        var remarks: Swift.String?
...
extension ApplicationInsightsClientTypes {
    ...
    public struct ConfigurationEvent: Swift.Equatable {
        ...
        var eventDetail: Swift.String?
        /// The name of the resource Application Insights attempted to configure.
        var eventResourceName: Swift.String?
        /// The resource type that Application Insights attempted to configure, for example, CLOUDWATCH_ALARM.
        var eventResourceType: ApplicationInsightsClientTypes.ConfigurationEventResourceType?
        /// The status of the configuration update event. Possible values include INFO, WARN, and ERROR.
        var eventStatus: ApplicationInsightsClientTypes.ConfigurationEventStatus?
        /// The timestamp of the event.
        var eventTime: ClientRuntime.Date?
        /// The resource monitored by Application Insights.
        var monitoredResourceARN: Swift.String?
...
public struct CreateApplicationInput: Swift.Equatable {
    ...
    var tags: [ApplicationInsightsClientTypes.Tag]?
...
public struct CreateApplicationOutputResponse: Swift.Equatable {
    ...
    var applicationInfo: ApplicationInsightsClientTypes.ApplicationInfo?
...
public struct CreateLogPatternInput: Swift.Equatable {
    ...
    /// This member is required.
    var patternName: Swift.String?
    /// The name of the log pattern set.
    /// This member is required.
    var patternSetName: Swift.String?
...
public struct CreateLogPatternOutputResponse: Swift.Equatable {
    ...
    var logPattern: ApplicationInsightsClientTypes.LogPattern?
    /// The name of the resource group.
    var resourceGroupName: Swift.String?
...
public struct DescribeComponentConfigurationOutputResponse: Swift.Equatable {
    ...
    var componentConfiguration: Swift.String?
    /// Indicates whether the application component is monitored.
    var monitor: Swift.Bool?
...
public struct DescribeComponentOutputResponse: Swift.Equatable {
    /// Describes a standalone resource or similarly grouped resources that the application is made up of.
    var applicationComponent: ApplicationInsightsClientTypes.ApplicationComponent?
    /// The list of resource ARNs that belong to the component.
    var resourceList: [Swift.String]?
...
public struct DescribeObservationInput: Swift.Equatable {
    ...
    /// This member is required.
    var observationId: Swift.String?
...
public struct DescribeObservationOutputResponse: Swift.Equatable {
    ...
    var observation: ApplicationInsightsClientTypes.Observation?
...
public struct DescribeProblemObservationsOutputResponse: Swift.Equatable {
    ...
    var relatedObservations: ApplicationInsightsClientTypes.RelatedObservations?
...
public struct DescribeProblemOutputResponse: Swift.Equatable {
    ...
    var problem: ApplicationInsightsClientTypes.Problem?
...
public struct ListApplicationsOutputResponse: Swift.Equatable {
    ...
    var applicationInfoList: [ApplicationInsightsClientTypes.ApplicationInfo]?
...
public struct ListComponentsOutputResponse: Swift.Equatable {
    ...
    var applicationComponentList: [ApplicationInsightsClientTypes.ApplicationComponent]?
    /// The token to request the next page of results.
    var nextToken: Swift.String?
...
public struct ListConfigurationHistoryOutputResponse: Swift.Equatable {
    ...
    var eventList: [ApplicationInsightsClientTypes.ConfigurationEvent]?
...
public struct ListLogPatternSetsOutputResponse: Swift.Equatable {
    ...
    var logPatternSets: [Swift.String]?
    /// The token used to retrieve the next page of results. This value is null when there are no more results to return.
    var nextToken: Swift.String?
    /// The name of the resource group.
    var resourceGroupName: Swift.String?
...
public struct ListLogPatternsOutputResponse: Swift.Equatable {
    ...
    var logPatterns: [ApplicationInsightsClientTypes.LogPattern]?
    /// The token used to retrieve the next page of results. This value is null when there are no more results to return.
    var nextToken: Swift.String?
    /// The name of the resource group.
    var resourceGroupName: Swift.String?
...
public struct ListProblemsOutputResponse: Swift.Equatable {
    ...
    var problemList: [ApplicationInsightsClientTypes.Problem]?
    var resourceGroupName: Swift.String?
...
extension ApplicationInsightsClientTypes {
    ...
    public struct Observation: Swift.Equatable {
        ...
        var cloudWatchEventDetailType: Swift.String?
        /// The ID of the CloudWatch Event-based observation related to the detected problem.
        var cloudWatchEventId: Swift.String?
        /// The source of the CloudWatch Event.
        var cloudWatchEventSource: ApplicationInsightsClientTypes.CloudWatchEventSource?
        /// The CodeDeploy application to which the deployment belongs.
        var codeDeployApplication: Swift.String?
        /// The deployment group to which the CodeDeploy deployment belongs.
        var codeDeployDeploymentGroup: Swift.String?
        /// The deployment ID of the CodeDeploy-based observation related to the detected problem.
        var codeDeployDeploymentId: Swift.String?
        /// The instance group to which the CodeDeploy instance belongs.
        var codeDeployInstanceGroupId: Swift.String?
        /// The status of the CodeDeploy deployment, for example SUCCESS or  FAILURE.
        var codeDeployState: Swift.String?
        /// The cause of an EBS CloudWatch event.
        var ebsCause: Swift.String?
        /// The type of EBS CloudWatch event, such as createVolume, deleteVolume or attachVolume.
        var ebsEvent: Swift.String?
        /// The request ID of an EBS CloudWatch event.
        var ebsRequestId: Swift.String?
        /// The result of an EBS CloudWatch event, such as failed or succeeded.
        var ebsResult: Swift.String?
        /// The state of the instance, such as STOPPING or TERMINATING.
        var ec2State: Swift.String?
        /// The time when the observation ended, in epoch seconds.
        var endTime: ClientRuntime.Date?
        /// The Amazon Resource Name (ARN) of the AWS Health Event-based observation.
        var healthEventArn: Swift.String?
        /// The description of the AWS Health event provided by the service, such as Amazon EC2.
        var healthEventDescription: Swift.String?
        /// The category of the AWS Health event, such as issue.
        var healthEventTypeCategory: Swift.String?
        /// The type of the AWS Health event, for example, AWS_EC2_POWER_CONNECTIVITY_ISSUE.
        var healthEventTypeCode: Swift.String?
        /// The service to which the AWS Health Event belongs, such as EC2.
        var healthService: Swift.String?
        /// The ID of the observation type.
        var id: Swift.String?
        /// The timestamp in the CloudWatch Logs that specifies when the matched line occurred.
        var lineTime: ClientRuntime.Date?
        /// The log filter of the observation.
        var logFilter: ApplicationInsightsClientTypes.LogFilter?
        /// The log group name.
        var logGroup: Swift.String?
        /// The log text of the observation.
        var logText: Swift.String?
        /// The name of the observation metric.
        var metricName: Swift.String?
        /// The namespace of the observation metric.
        var metricNamespace: Swift.String?
        /// The category of an RDS event.
        var rdsEventCategories: Swift.String?
        /// The message of an RDS event.
        var rdsEventMessage: Swift.String?
        /// The name of the S3 CloudWatch Event-based observation.
        var s3EventName: Swift.String?
        ...
        var statesArn: Swift.String?
        /// The Amazon Resource Name (ARN) of the step function execution-based observation.
        var statesExecutionArn: Swift.String?
        /// The input to the step function-based observation.
        var statesInput: Swift.String?
        /// The status of the step function-related observation.
        var statesStatus: Swift.String?
        /// The unit of the source observation metric.
        var unit: Swift.String?
        /// The value of the source observation metric.
        var value: Swift.Double?
        /// The X-Ray request error percentage for this node.
        var xRayErrorPercent: Swift.Int?
        /// The X-Ray request fault percentage for this node.
        var xRayFaultPercent: Swift.Int?
        /// The name of the X-Ray node.
        var xRayNodeName: Swift.String?
        /// The type of the X-Ray node.
        var xRayNodeType: Swift.String?
        /// The X-Ray node request average latency for this node.
        var xRayRequestAverageLatency: Swift.Int?
        /// The X-Ray request count for this node.
        var xRayRequestCount: Swift.Int?
        /// The X-Ray request throttle percentage for this node.
        var xRayThrottlePercent: Swift.Int?
...
extension ApplicationInsightsClientTypes {
    ...
    public struct Problem: Swift.Equatable {
        ...
        var affectedResource: Swift.String?
        /// The time when the problem ended, in epoch seconds.
        var endTime: ClientRuntime.Date?
        /// Feedback provided by the user about the problem.
        var feedback: [Swift.String:ApplicationInsightsClientTypes.FeedbackValue]?
        /// The ID of the problem.
        var id: Swift.String?
        /// A detailed analysis of the problem using machine learning.
        var insights: Swift.String?
        var lastRecurrenceTime: ClientRuntime.Date?
        var recurringCount: Swift.Int?
        /// The name of the resource group affected by the problem.
        var resourceGroupName: Swift.String?
        /// A measure of the level of impact of the problem.
        var severityLevel: ApplicationInsightsClientTypes.SeverityLevel?
        /// The time when the problem started, in epoch seconds.
        var startTime: ClientRuntime.Date?
        /// The status of the problem.
        var status: ApplicationInsightsClientTypes.Status?
...
extension ApplicationInsightsClientTypes {
    ...
    public struct RelatedObservations: Swift.Equatable {
        ...
        var observationList: [ApplicationInsightsClientTypes.Observation]?
...
public struct UpdateComponentInput: Swift.Equatable {
    ...
    var newComponentName: Swift.String?
    /// The name of the resource group.
    /// This member is required.
    var resourceGroupName: Swift.String?
    /// The list of resource ARNs that belong to the component.
