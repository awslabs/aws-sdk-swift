...
public class ApiGatewayClient {
    ...
    let config: ApiGatewayClientConfiguration
    let serviceName = "API Gateway"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: ApiGatewayClientConfiguration) {
    ...
    public class ApiGatewayClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "ApiGatewayClient")
        }
        ...
        public static func `default`() throws -> ApiGatewayClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try ApiGatewayClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
