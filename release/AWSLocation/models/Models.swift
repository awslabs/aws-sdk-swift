...
public struct AssociateTrackerConsumerInput: Swift.Equatable {
    ...
    /// This member is required.
    var consumerArn: Swift.String?
    /// The name of the tracker resource to be associated with a geofence collection.
    /// This member is required.
    var trackerName: Swift.String?
...
extension LocationClientTypes {
    ...
    public struct BatchDeleteDevicePositionHistoryError: Swift.Equatable {
        ...
        /// This member is required.
        var error: LocationClientTypes.BatchItemError?
...
public struct BatchDeleteDevicePositionHistoryOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var errors: [LocationClientTypes.BatchDeleteDevicePositionHistoryError]?
...
public struct BatchDeleteGeofenceInput: Swift.Equatable {
    ...
    /// This member is required.
    var collectionName: Swift.String?
    /// The batch of geofences to be deleted.
    /// This member is required.
    var geofenceIds: [Swift.String]?
...
public struct BatchDeleteGeofenceOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var errors: [LocationClientTypes.BatchDeleteGeofenceError]?
...
extension LocationClientTypes {
    ...
    public struct BatchEvaluateGeofencesError: Swift.Equatable {
        ...
        /// This member is required.
        var sampleTime: ClientRuntime.Date?
...
public struct BatchEvaluateGeofencesInput: Swift.Equatable {
    ...
    /// This member is required.
    var devicePositionUpdates: [LocationClientTypes.DevicePositionUpdate]?
...
public struct BatchEvaluateGeofencesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var errors: [LocationClientTypes.BatchEvaluateGeofencesError]?
...
public struct BatchGetDevicePositionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var devicePositions: [LocationClientTypes.DevicePosition]?
    /// Contains error details for each device that failed to send its position to the tracker resource.
    /// This member is required.
    var errors: [LocationClientTypes.BatchGetDevicePositionError]?
...
extension LocationClientTypes {
    ...
    public struct BatchItemError: Swift.Equatable {
        ...
        var code: LocationClientTypes.BatchItemErrorCode?
...
public struct BatchPutGeofenceInput: Swift.Equatable {
    ...
    /// This member is required.
    var entries: [LocationClientTypes.BatchPutGeofenceRequestEntry]?
...
public struct BatchPutGeofenceOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var errors: [LocationClientTypes.BatchPutGeofenceError]?
    /// Contains each geofence that was successfully stored in a geofence collection.
    /// This member is required.
    var successes: [LocationClientTypes.BatchPutGeofenceSuccess]?
...
extension LocationClientTypes {
    ...
    public struct BatchPutGeofenceRequestEntry: Swift.Equatable {
        ...
        /// This member is required.
        var geometry: LocationClientTypes.GeofenceGeometry?
...
public struct BatchUpdateDevicePositionInput: Swift.Equatable {
    ...
    /// This member is required.
    var updates: [LocationClientTypes.DevicePositionUpdate]?
...
public struct BatchUpdateDevicePositionOutputResponse: Swift.Equatable {
    /// Contains error details for each device that failed to update its position.
    /// This member is required.
    var errors: [LocationClientTypes.BatchUpdateDevicePositionError]?
...
public struct CalculateRouteInput: Swift.Equatable {
    ...
    /// This member is required.
    var calculatorName: Swift.String?
    ...
    var carModeOptions: LocationClientTypes.CalculateRouteCarModeOptions?
    ...
    /// This member is required.
    var departurePosition: [Swift.Double]?
    ...
    var departureTime: ClientRuntime.Date?
    ...
    /// This member is required.
    var destinationPosition: [Swift.Double]?
    /// Set the unit system to specify the distance. Default Value: Kilometers
    var distanceUnit: LocationClientTypes.DistanceUnit?
    ...
    var includeLegGeometry: Swift.Bool?
    ...
    ///
    /// Default Value: Car
    var travelMode: LocationClientTypes.TravelMode?
    ...
    var truckModeOptions: LocationClientTypes.CalculateRouteTruckModeOptions?
    ...
    var waypointPositions: [[Swift.Double]]?
...
extension LocationClientTypes {
    ...
    public struct CalculateRouteSummary: Swift.Equatable {
        ...
        /// This member is required.
        var durationSeconds: Swift.Double?
...
extension LocationClientTypes {
    ...
    public struct CalculateRouteTruckModeOptions: Swift.Equatable {
        ...
        var dimensions: LocationClientTypes.TruckDimensions?
        /// Specifies the truck's weight specifications including total weight and unit of measurement. Used to avoid roads that can't support the truck's weight.
        var weight: LocationClientTypes.TruckWeight?
...
public struct CreateGeofenceCollectionInput: Swift.Equatable {
    ...
    /// This member is required.
    var pricingPlan: LocationClientTypes.PricingPlan?
    ...
    var pricingPlanDataSource: Swift.String?
...
public struct CreateGeofenceCollectionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var collectionArn: Swift.String?
...
public struct CreateMapInput: Swift.Equatable {
    ...
    /// This member is required.
    var configuration: LocationClientTypes.MapConfiguration?
...
public struct CreatePlaceIndexInput: Swift.Equatable {
    ...
    var dataSourceConfiguration: LocationClientTypes.DataSourceConfiguration?
...
public struct CreateRouteCalculatorOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var calculatorArn: Swift.String?
...
public struct CreateTrackerInput: Swift.Equatable {
    ...
    var positionFiltering: LocationClientTypes.PositionFiltering?
...
extension LocationClientTypes {
    ...
    public struct DataSourceConfiguration: Swift.Equatable {
        ...
        var intendedUse: LocationClientTypes.IntendedUse?
...
extension LocationClientTypes {
    ...
    public struct DevicePosition: Swift.Equatable {
        ...
        var accuracy: LocationClientTypes.PositionalAccuracy?
        ...
        var positionProperties: [Swift.String:Swift.String]?
        ...
        /// This member is required.
        var receivedTime: ClientRuntime.Date?
...
public struct GetDevicePositionHistoryInput: Swift.Equatable {
    ...
    var endTimeExclusive: ClientRuntime.Date?
    ...
    var startTimeInclusive: ClientRuntime.Date?
...
public struct GetMapGlyphsInput: Swift.Equatable {
    ...
    /// This member is required.
    var fontStack: Swift.String?
    /// A Unicode range of characters to download glyphs for. Each response will contain 256 characters. For example, 0–255 includes all characters from range U+0000 to 00FF. Must be aligned to multiples of 256.
    /// This member is required.
    var fontUnicodeRange: Swift.String?
...
extension LocationClientTypes {
    ...
    public struct Leg: Swift.Equatable {
        ...
        /// This member is required.
        var endPosition: [Swift.Double]?
        /// Contains the calculated route's path as a linestring geometry.
        var geometry: LocationClientTypes.LegGeometry?
        ...
        /// This member is required.
        var startPosition: [Swift.Double]?
        /// Contains a list of steps, which represent subsections of a leg. Each step provides instructions for how to move to the next step in the leg such as the step's start position, end position, travel distance, travel duration, and geometry offset.
        /// This member is required.
        var steps: [LocationClientTypes.Step]?
...
public struct ListDevicePositionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entries: [LocationClientTypes.ListDevicePositionsResponseEntry]?
    /// A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results.
    var nextToken: Swift.String?
...
public struct ListGeofenceCollectionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entries: [LocationClientTypes.ListGeofenceCollectionsResponseEntry]?
    /// A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results.
    var nextToken: Swift.String?
...
public struct ListGeofencesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entries: [LocationClientTypes.ListGeofenceResponseEntry]?
    /// A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results.
    var nextToken: Swift.String?
...
public struct ListMapsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entries: [LocationClientTypes.ListMapsResponseEntry]?
    /// A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results.
    var nextToken: Swift.String?
...
public struct ListPlaceIndexesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entries: [LocationClientTypes.ListPlaceIndexesResponseEntry]?
...
public struct ListRouteCalculatorsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entries: [LocationClientTypes.ListRouteCalculatorsResponseEntry]?
...
public struct ListTrackersOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var entries: [LocationClientTypes.ListTrackersResponseEntry]?
    /// A pagination token indicating there are additional pages available. You can use the token in a following request to fetch the next set of results.
    var nextToken: Swift.String?
...
extension LocationClientTypes {
    ...
    public struct Place: Swift.Equatable {
        ...
        /// This member is required.
        var geometry: LocationClientTypes.PlaceGeometry?
        ...
        var timeZone: LocationClientTypes.TimeZone?
...
extension LocationClientTypes {
    ...
    public struct SearchForPositionResult: Swift.Equatable {
        ...
        /// This member is required.
        var place: LocationClientTypes.Place?
...
public struct SearchPlaceIndexForPositionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var results: [LocationClientTypes.SearchForPositionResult]?
    ...
    /// This member is required.
    var summary: LocationClientTypes.SearchPlaceIndexForPositionSummary?
...
public struct SearchPlaceIndexForSuggestionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var results: [LocationClientTypes.SearchForSuggestionsResult]?
    ...
    /// This member is required.
    var summary: LocationClientTypes.SearchPlaceIndexForSuggestionsSummary?
...
public struct SearchPlaceIndexForTextOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var results: [LocationClientTypes.SearchForTextResult]?
    ...
    /// This member is required.
    var summary: LocationClientTypes.SearchPlaceIndexForTextSummary?
...
extension LocationClientTypes {
    ...
    public struct TruckDimensions: Swift.Equatable {
        ...
        ///
        /// * For example, 4.5.
        var height: Swift.Double?
        /// The length of the truck.
        ///
        /// * For example, 15.5.
        var length: Swift.Double?
        /// Specifies the unit of measurement for the truck dimensions. Default Value: Meters
        var unit: LocationClientTypes.DimensionUnit?
        /// The width of the truck.
        ///
        /// * For example, 4.5.
        var width: Swift.Double?
...
extension LocationClientTypes {
    ...
    public struct TruckWeight: Swift.Equatable {
        ...
        var unit: LocationClientTypes.VehicleWeightUnit?
