...
public struct CalculateRouteInput: Swift.Equatable {
    ...
    ///
    ///
    /// If you specify a departure that's not located on a road, Amazon Location [moves the position to the nearest road](https://docs.aws.amazon.com/location/latest/developerguide/calculate-route.html#snap-to-nearby-road). Valid Values: [-180 to 180,-90 to 90]
    /// This member is required.
    public var departurePosition: [Swift.Double]?
    /// Specifies the desired time of departure. Uses the given time to calculate a route. Otherwise, the best time of day to travel with the best traffic conditions is used to calculate the route. Setting a departure time in the past returns a 400 ValidationException error.
    ///
...
public struct CreateMapInput: Swift.Equatable {
    ...
    /// Specifies the pricing plan for your map resource. For additional details and restrictions on each pricing plan option, see the [Amazon Location Service pricing page](https://aws.amazon.com/location/pricing/).
    /// This member is required.
    public var pricingPlan: LocationClientTypes.PricingPlan?
...
public struct CreatePlaceIndexInput: Swift.Equatable {
    /// Specifies the data provider of geospatial data. This field is case-sensitive. Enter the valid values as shown. For example, entering HERE returns an error. Valid values include:
    ///
    ...
    /// Specifies the pricing plan for your place index resource. For additional details and restrictions on each pricing plan option, see the [Amazon Location Service pricing page](https://aws.amazon.com/location/pricing/).
    /// This member is required.
    public var pricingPlan: LocationClientTypes.PricingPlan?
    /// Applies one or more tags to the place index resource. A tag is a key-value pair helps manage, identify, search, and filter your resources by labelling them. Format: "key" : "value" Restrictions:
    ///
    /// * Maximum 50 tags per resource
    ///
    /// * Each resource tag must be unique with a maximum of one value.
...
public struct CreateTrackerInput: Swift.Equatable {
    ...
    /// A key identifier for an [AWS KMS customer managed key](https://docs.aws.amazon.com/kms/latest/developerguide/create-keys.html). Enter a key ID, key ARN, alias name, or alias ARN.
    public var kmsKeyId: Swift.String?
    /// Specifies the pricing plan for the tracker resource. For additional details and restrictions on each pricing plan option, see the [Amazon Location Service pricing page](https://aws.amazon.com/location/pricing/).
    /// This member is required.
    public var pricingPlan: LocationClientTypes.PricingPlan?
...
public struct DescribeMapOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    public var mapName: Swift.String?
    /// The pricing plan selected for the specified map resource. For additional details and restrictions on each pricing plan option, see the [Amazon Location Service pricing page](https://aws.amazon.com/location/pricing/).
    /// This member is required.
    public var pricingPlan: LocationClientTypes.PricingPlan?
...
public struct DescribePlaceIndexOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    public var indexName: Swift.String?
    /// The pricing plan selected for the specified place index resource. For additional details and restrictions on each pricing plan option, see the [Amazon Location Service pricing page](https://aws.amazon.com/location/pricing/).
    /// This member is required.
    public var pricingPlan: LocationClientTypes.PricingPlan?
...
public struct DescribeTrackerOutputResponse: Swift.Equatable {
    ...
    /// A key identifier for an [AWS KMS customer managed key](https://docs.aws.amazon.com/kms/latest/developerguide/create-keys.html) assigned to the Amazon Location resource.
    public var kmsKeyId: Swift.String?
    /// The pricing plan selected for the specified tracker resource. For additional details and restrictions on each pricing plan option, see the [Amazon Location Service pricing page](https://aws.amazon.com/location/pricing/).
    /// This member is required.
    public var pricingPlan: LocationClientTypes.PricingPlan?
...
public struct GetMapGlyphsInput: Swift.Equatable {
    /// A comma-separated list of fonts to load glyphs from in order of preference. For example, Noto Sans Regular, Arial Unicode. Valid fonts for [Esri](https://docs.aws.amazon.com/location/latest/developerguide/esri.html) styles:
    ///
...
extension LocationClientTypes {
    ...
    public struct ListMapsResponseEntry: Swift.Equatable {
        ...
        /// This member is required.
        public var mapName: Swift.String?
        /// The pricing plan for the specified map resource. For additional details and restrictions on each pricing plan option, see the [Amazon Location Service pricing page](https://aws.amazon.com/location/pricing/).
        /// This member is required.
        public var pricingPlan: LocationClientTypes.PricingPlan?
...
extension LocationClientTypes {
    ...
    public struct ListPlaceIndexesResponseEntry: Swift.Equatable {
        ...
        /// This member is required.
        public var indexName: Swift.String?
        /// The pricing plan for the specified place index resource. For additional details and restrictions on each pricing plan option, see the [Amazon Location Service pricing page](https://aws.amazon.com/location/pricing/).
        /// This member is required.
        public var pricingPlan: LocationClientTypes.PricingPlan?
        /// The timestamp for when the place index resource was last updated in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format: YYYY-MM-DDThh:mm:ss.sssZ.
        /// This member is required.
...
extension LocationClientTypes {
    ...
    public struct ListTrackersResponseEntry: Swift.Equatable {
        ...
        /// This member is required.
        public var description: Swift.String?
        /// The pricing plan for the specified tracker resource. For additional details and restrictions on each pricing plan option, see the [Amazon Location Service pricing page](https://aws.amazon.com/location/pricing/).
        /// This member is required.
        public var pricingPlan: LocationClientTypes.PricingPlan?
        /// The specified data provider for the tracker resource.
        public var pricingPlanDataSource: Swift.String?
...
extension LocationClientTypes {
    ...
    public struct MapConfiguration: Swift.Equatable {
        /// Specifies the map style selected from an available data provider. For additional information on each map style and to preview each map style, see [Esri map styles] and [HERE map styles]. Valid [Esri](https://docs.aws.amazon.com/location/latest/developerguide/esri.html) styles:
        ///
        ...
        ///
        ///
        /// Valid [HERE Technologies](https://docs.aws.amazon.com/location/latest/developerguide/HERE.html) styles:
        ///
...
public struct SearchPlaceIndexForTextInput: Swift.Equatable {
    ...
    /// Filters the results by returning only Places within the provided bounding box. An optional parameter. The first 2 bbox parameters describe the lower southwest corner:
    ///
    /// * The first bbox position is the X coordinate or longitude of the lower southwest corner.
    ///
    /// * The second bbox position is the Y coordinate or latitude of the lower southwest corner.
