...
public struct ListPoliciesGrantingServiceAccessInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<ListPoliciesGrantingServiceAccessOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<ListPoliciesGrantingServiceAccessOutput>
