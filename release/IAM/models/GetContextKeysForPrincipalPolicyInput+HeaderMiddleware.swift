...
public struct GetContextKeysForPrincipalPolicyInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetContextKeysForPrincipalPolicyOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetContextKeysForPrincipalPolicyOutput>
