...
extension CognitoSyncClient: CognitoSyncClientProtocol {
    ...
    public func bulkPublish(input: BulkPublishInput, completion: @escaping (SdkResult<BulkPublishOutput, BulkPublishOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<BulkPublishInput, BulkPublishOutput, BulkPublishOutputError>(id: "bulkPublish")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<BulkPublishInput, BulkPublishOutput, BulkPublishOutputError>(contentType: "application/json"))
    ...
    ///          </example>
    ///       </examples>
    public func describeIdentityPoolUsage(input: DescribeIdentityPoolUsageInput, completion: @escaping (SdkResult<DescribeIdentityPoolUsageOutput, DescribeIdentityPoolUsageOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeIdentityPoolUsageInput, DescribeIdentityPoolUsageOutput, DescribeIdentityPoolUsageOutputError>(id: "describeIdentityPoolUsage")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeIdentityPoolUsageInput, DescribeIdentityPoolUsageOutput, DescribeIdentityPoolUsageOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          </example>
    ///       </examples>
    public func describeIdentityUsage(input: DescribeIdentityUsageInput, completion: @escaping (SdkResult<DescribeIdentityUsageOutput, DescribeIdentityUsageOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeIdentityUsageInput, DescribeIdentityUsageOutput, DescribeIdentityUsageOutputError>(id: "describeIdentityUsage")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeIdentityUsageInput, DescribeIdentityUsageOutput, DescribeIdentityUsageOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getBulkPublishDetails(input: GetBulkPublishDetailsInput, completion: @escaping (SdkResult<GetBulkPublishDetailsOutput, GetBulkPublishDetailsOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBulkPublishDetailsInput, GetBulkPublishDetailsOutput, GetBulkPublishDetailsOutputError>(id: "getBulkPublishDetails")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBulkPublishDetailsInput, GetBulkPublishDetailsOutput, GetBulkPublishDetailsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getCognitoEvents(input: GetCognitoEventsInput, completion: @escaping (SdkResult<GetCognitoEventsOutput, GetCognitoEventsOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCognitoEventsInput, GetCognitoEventsOutput, GetCognitoEventsOutputError>(id: "getCognitoEvents")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCognitoEventsInput, GetCognitoEventsOutput, GetCognitoEventsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          </example>
    ///       </examples>
    public func getIdentityPoolConfiguration(input: GetIdentityPoolConfigurationInput, completion: @escaping (SdkResult<GetIdentityPoolConfigurationOutput, GetIdentityPoolConfigurationOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetIdentityPoolConfigurationInput, GetIdentityPoolConfigurationOutput, GetIdentityPoolConfigurationOutputError>(id: "getIdentityPoolConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetIdentityPoolConfigurationInput, GetIdentityPoolConfigurationOutput, GetIdentityPoolConfigurationOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          </example>
    ///       </examples>
    public func listIdentityPoolUsage(input: ListIdentityPoolUsageInput, completion: @escaping (SdkResult<ListIdentityPoolUsageOutput, ListIdentityPoolUsageOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListIdentityPoolUsageInput, ListIdentityPoolUsageOutput, ListIdentityPoolUsageOutputError>(id: "listIdentityPoolUsage")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListIdentityPoolUsageInput, ListIdentityPoolUsageOutput, ListIdentityPoolUsageOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          </example>
    ///       </examples>
    public func listRecords(input: ListRecordsInput, completion: @escaping (SdkResult<ListRecordsOutput, ListRecordsOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListRecordsInput, ListRecordsOutput, ListRecordsOutputError>(id: "listRecords")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListRecordsInput, ListRecordsOutput, ListRecordsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          </example>
    ///       </examples>
    public func registerDevice(input: RegisterDeviceInput, completion: @escaping (SdkResult<RegisterDeviceOutput, RegisterDeviceOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RegisterDeviceInput, RegisterDeviceOutput, RegisterDeviceOutputError>(id: "registerDevice")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RegisterDeviceInput, RegisterDeviceOutput, RegisterDeviceOutputError>(contentType: "application/json"))
    ...
    public func setCognitoEvents(input: SetCognitoEventsInput, completion: @escaping (SdkResult<SetCognitoEventsOutput, SetCognitoEventsOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SetCognitoEventsInput, SetCognitoEventsOutput, SetCognitoEventsOutputError>(id: "setCognitoEvents")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SetCognitoEventsInput, SetCognitoEventsOutput, SetCognitoEventsOutputError>(contentType: "application/json"))
    ...
    ///          </example>
    ///       </examples>
    public func setIdentityPoolConfiguration(input: SetIdentityPoolConfigurationInput, completion: @escaping (SdkResult<SetIdentityPoolConfigurationOutput, SetIdentityPoolConfigurationOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SetIdentityPoolConfigurationInput, SetIdentityPoolConfigurationOutput, SetIdentityPoolConfigurationOutputError>(id: "setIdentityPoolConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SetIdentityPoolConfigurationInput, SetIdentityPoolConfigurationOutput, SetIdentityPoolConfigurationOutputError>(contentType: "application/json"))
    ...
    ///          </example>
    ///       </examples>
    public func subscribeToDataset(input: SubscribeToDatasetInput, completion: @escaping (SdkResult<SubscribeToDatasetOutput, SubscribeToDatasetOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SubscribeToDatasetInput, SubscribeToDatasetOutput, SubscribeToDatasetOutputError>(id: "subscribeToDataset")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SubscribeToDatasetInput, SubscribeToDatasetOutput, SubscribeToDatasetOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          </example>
    ///       </examples>
    public func unsubscribeFromDataset(input: UnsubscribeFromDatasetInput, completion: @escaping (SdkResult<UnsubscribeFromDatasetOutput, UnsubscribeFromDatasetOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UnsubscribeFromDatasetInput, UnsubscribeFromDatasetOutput, UnsubscribeFromDatasetOutputError>(id: "unsubscribeFromDataset")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UnsubscribeFromDatasetInput, UnsubscribeFromDatasetOutput, UnsubscribeFromDatasetOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       <p>This API can be called with temporary user credentials provided by Cognito Identity or with developer credentials.</p>
    public func updateRecords(input: UpdateRecordsInput, completion: @escaping (SdkResult<UpdateRecordsOutput, UpdateRecordsOutputError>) -> Void)
    {
        guard let identityPoolId = input.identityPoolId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component identityPoolId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "cognito-sync")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateRecordsInput, UpdateRecordsOutput, UpdateRecordsOutputError>(id: "updateRecords")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateRecordsInput, UpdateRecordsOutput, UpdateRecordsOutputError>(contentType: "application/json"))
