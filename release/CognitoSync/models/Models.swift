...
extension AlreadyStreamedException: AWSClientRuntime.AWSHttpServiceError {
...
public struct AlreadyStreamedException: ClientRuntime.ServiceError, Swift.Equatable {
...
extension CognitoSyncClientTypes {
    ...
    public struct CognitoStreams: Swift.Equatable {
        ...
        public let streamingStatus: CognitoSyncClientTypes.StreamingStatus?
...
extension CognitoSyncClientTypes {
    ...
    public struct Dataset: Swift.Equatable {
        ...
        ///       dataset.
        public let dataStorage: Swift.Int?
        ...
        public let numRecords: Swift.Int?
...
extension DuplicateRequestException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct DuplicateRequestException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension CognitoSyncClientTypes {
    ...
    public struct IdentityPoolUsage: Swift.Equatable {
        ...
        ///       identity pool.
        public let syncSessionsCount: Swift.Int?
...
extension CognitoSyncClientTypes {
    ...
    public struct IdentityUsage: Swift.Equatable {
        ...
        ///       identity.
        public let datasetCount: Swift.Int
        /// A name-spaced GUID (for example,
        ///       us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito. GUID generation is
        ///       unique within a region.
        public let identityId: Swift.String?
...
extension InvalidLambdaFunctionOutputException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct InvalidLambdaFunctionOutputException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension LambdaThrottledException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct LambdaThrottledException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
public struct ListRecordsInput: Swift.Equatable {
    ...
    ///       record.
    public let lastSyncCount: Swift.Int?
    /// The maximum number of results to be
    ///       returned.
    public let maxResults: Swift.Int
    /// A pagination token for obtaining the next
...
extension CognitoSyncClientTypes {
    ...
    public struct PushSync: Swift.Equatable {
        ...
        public let applicationArns: [Swift.String]?
...
extension CognitoSyncClientTypes {
    ...
    public struct Record: Swift.Equatable {
        ...
        ///       device.
        public let deviceLastModifiedDate: ClientRuntime.Date?
        ...
        public let syncCount: Swift.Int?
...
extension CognitoSyncClientTypes {
    ...
    public struct RecordPatch: Swift.Equatable {
        ...
        public let op: CognitoSyncClientTypes.Operation?
...
public struct UpdateRecordsInput: Swift.Equatable {
    ...
    public let clientContext: Swift.String?
    /// A string of up to 128 characters.
    ///       Allowed characters are a-z, A-Z, 0-9, '_' (underscore), '-' (dash), and '.'
    ///       (dot).
    public let datasetName: Swift.String?
