...
extension MarketplaceEntitlementClientTypes.Entitlement: Swift.Codable, ClientRuntime.Reflection {
...
extension MarketplaceEntitlementClientTypes.Entitlement: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Entitlement(customerIdentifier: \(Swift.String(describing: customerIdentifier)), dimension: \(Swift.String(describing: dimension)), expirationDate: \(Swift.String(describing: expirationDate)), productCode: \(Swift.String(describing: productCode)), value: \(Swift.String(describing: value)))"}
}
...
extension MarketplaceEntitlementClientTypes.EntitlementValue: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct GetEntitlementsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEntitlementsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetEntitlementsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetEntitlementsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetEntitlementsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetEntitlementsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetEntitlementsOutputError>
}

extension GetEntitlementsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetEntitlementsInput(filter: \(Swift.String(describing: filter)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), productCode: \(Swift.String(describing: productCode)))"}
}

extension GetEntitlementsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filter = "Filter"
...
public struct GetEntitlementsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEntitlementsInputHeadersMiddleware"
...
public struct GetEntitlementsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEntitlementsInputQueryItemMiddleware"
...
public struct GetEntitlementsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEntitlementsInputURLHostMiddleware"
    ...
    public typealias MInput = GetEntitlementsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetEntitlementsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetEntitlementsOutputError>
}

public struct GetEntitlementsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEntitlementsInputURLPathMiddleware"
...
extension GetEntitlementsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetEntitlementsOutputResponse(entitlements: \(Swift.String(describing: entitlements)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct GetEntitlementsOutputResponseBody: Swift.Equatable {
    public let entitlements: [MarketplaceEntitlementClientTypes.Entitlement]?
    public let nextToken: Swift.String?
}
