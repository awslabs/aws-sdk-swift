...
public class ComprehendMedicalClient {
    ...
    public class ComprehendMedicalClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("ComprehendMedicalClient")
