...
public protocol ComprehendMedicalClientProtocol {
    ...
    func describeEntitiesDetectionV2Job(input: DescribeEntitiesDetectionV2JobInput, completion: @escaping (SdkResult<DescribeEntitiesDetectionV2JobOutput, DescribeEntitiesDetectionV2JobOutputError>) -> Void)
    /// <p>Gets the properties associated with an InferICD10CM job. Use this operation to get the
    ///       status of an inference job.</p>
    func describeICD10CMInferenceJob(input: DescribeICD10CMInferenceJobInput, completion: @escaping (SdkResult<DescribeICD10CMInferenceJobOutput, DescribeICD10CMInferenceJobOutputError>) -> Void)
    ...
    func describePHIDetectionJob(input: DescribePHIDetectionJobInput, completion: @escaping (SdkResult<DescribePHIDetectionJobOutput, DescribePHIDetectionJobOutputError>) -> Void)
    /// <p>Gets the properties associated with an InferRxNorm job. Use this operation to get the
    ///       status of an inference job.</p>
    func describeRxNormInferenceJob(input: DescribeRxNormInferenceJobInput, completion: @escaping (SdkResult<DescribeRxNormInferenceJobOutput, DescribeRxNormInferenceJobOutputError>) -> Void)
    ...
    func detectEntitiesV2(input: DetectEntitiesV2Input, completion: @escaping (SdkResult<DetectEntitiesV2Output, DetectEntitiesV2OutputError>) -> Void)
    ...
    func detectPHI(input: DetectPHIInput, completion: @escaping (SdkResult<DetectPHIOutput, DetectPHIOutputError>) -> Void)
    ...
    func inferICD10CM(input: InferICD10CMInput, completion: @escaping (SdkResult<InferICD10CMOutput, InferICD10CMOutputError>) -> Void)
    ...
    func inferRxNorm(input: InferRxNormInput, completion: @escaping (SdkResult<InferRxNormOutput, InferRxNormOutputError>) -> Void)
    /// <p>Gets a list of medical entity detection jobs that you have submitted.</p>
    func listEntitiesDetectionV2Jobs(input: ListEntitiesDetectionV2JobsInput, completion: @escaping (SdkResult<ListEntitiesDetectionV2JobsOutput, ListEntitiesDetectionV2JobsOutputError>) -> Void)
    /// <p>Gets a list of InferICD10CM jobs that you have submitted.</p>
    func listICD10CMInferenceJobs(input: ListICD10CMInferenceJobsInput, completion: @escaping (SdkResult<ListICD10CMInferenceJobsOutput, ListICD10CMInferenceJobsOutputError>) -> Void)
    /// <p>Gets a list of protected health information (PHI) detection jobs that you have
    ///       submitted.</p>
    func listPHIDetectionJobs(input: ListPHIDetectionJobsInput, completion: @escaping (SdkResult<ListPHIDetectionJobsOutput, ListPHIDetectionJobsOutputError>) -> Void)
    /// <p>Gets a list of InferRxNorm jobs that you have submitted.</p>
    func listRxNormInferenceJobs(input: ListRxNormInferenceJobsInput, completion: @escaping (SdkResult<ListRxNormInferenceJobsOutput, ListRxNormInferenceJobsOutputError>) -> Void)
    ...
    func startEntitiesDetectionV2Job(input: StartEntitiesDetectionV2JobInput, completion: @escaping (SdkResult<StartEntitiesDetectionV2JobOutput, StartEntitiesDetectionV2JobOutputError>) -> Void)
    ...
    ///       job.</p>
    func startICD10CMInferenceJob(input: StartICD10CMInferenceJobInput, completion: @escaping (SdkResult<StartICD10CMInferenceJobOutput, StartICD10CMInferenceJobOutputError>) -> Void)
    ...
    func startPHIDetectionJob(input: StartPHIDetectionJobInput, completion: @escaping (SdkResult<StartPHIDetectionJobOutput, StartPHIDetectionJobOutputError>) -> Void)
    ...
    ///       job.</p>
    func startRxNormInferenceJob(input: StartRxNormInferenceJobInput, completion: @escaping (SdkResult<StartRxNormInferenceJobOutput, StartRxNormInferenceJobOutputError>) -> Void)
    /// <p>Stops a medical entities detection job in progress.</p>
    func stopEntitiesDetectionV2Job(input: StopEntitiesDetectionV2JobInput, completion: @escaping (SdkResult<StopEntitiesDetectionV2JobOutput, StopEntitiesDetectionV2JobOutputError>) -> Void)
    /// <p>Stops an InferICD10CM inference job in progress.</p>
    func stopICD10CMInferenceJob(input: StopICD10CMInferenceJobInput, completion: @escaping (SdkResult<StopICD10CMInferenceJobOutput, StopICD10CMInferenceJobOutputError>) -> Void)
    /// <p>Stops a protected health information (PHI) detection job in progress.</p>
    func stopPHIDetectionJob(input: StopPHIDetectionJobInput, completion: @escaping (SdkResult<StopPHIDetectionJobOutput, StopPHIDetectionJobOutputError>) -> Void)
    /// <p>Stops an InferRxNorm inference job in progress.</p>
    func stopRxNormInferenceJob(input: StopRxNormInferenceJobInput, completion: @escaping (SdkResult<StopRxNormInferenceJobOutput, StopRxNormInferenceJobOutputError>) -> Void)
}
