...
public class LexRuntimeV2Client {
    ...
    public class LexRuntimeV2ClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "LexRuntimeV2Client")
        }
...
public struct LexRuntimeV2ClientLogHandlerFactory: SDKLogHandlerFactory {
...
extension LexRuntimeV2Client: LexRuntimeV2ClientProtocol {
    ...
    ///          the bot.</p>
    public func recognizeUtterance(input: RecognizeUtteranceInput, completion: @escaping (SdkResult<RecognizeUtteranceOutputResponse, RecognizeUtteranceOutputError>) -> Void)
    {
        guard let botId = input.botId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botId unexpectedly nil"))))
            return
    ...
    ///       </p>
    ///          <p></p>
    public func startConversation(input: StartConversationInput, completion: @escaping (SdkResult<StartConversationOutputResponse, StartConversationOutputError>) -> Void)
    {
        guard let botId = input.botId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component botId unexpectedly nil"))))
            return
