...
public protocol LexRuntimeV2ClientProtocol {
    ...
    func recognizeText(input: RecognizeTextInput, completion: @escaping (SdkResult<RecognizeTextOutput, RecognizeTextOutputError>) -> Void)
    ...
    ///          the bot.</p>
    func recognizeUtterance(input: RecognizeUtteranceInput, streamSource: StreamSource, completion: @escaping (SdkResult<RecognizeUtteranceOutput, RecognizeUtteranceOutputError>) -> Void)
    ...
    ///       </p>
    ///          <p></p>
    func startConversation(input: StartConversationInput, streamSource: StreamSource, completion: @escaping (SdkResult<StartConversationOutput, StartConversationOutputError>) -> Void)
}
