...
extension LexRuntimeV2ClientTypes.Slot: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Slot(shape: \(Swift.String(describing: shape)), value: \(Swift.String(describing: value)), values: \(Swift.String(describing: values)))"}
}
...
extension LexRuntimeV2ClientTypes {
    ...
    public struct Slot: Swift.Equatable {
        ...
        public let shape: LexRuntimeV2ClientTypes.Shape?
        ...
        public let values: [LexRuntimeV2ClientTypes.Slot]?
