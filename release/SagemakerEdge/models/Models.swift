...
extension SagemakerEdgeClientTypes {
    ...
    public struct Model: Swift.Equatable {
        ...
        public let latestInference: ClientRuntime.Date?
        /// <p>The timestamp of the last data sample taken.</p>
        public let latestSampleTime: ClientRuntime.Date?
        /// <p>Information required for model metrics.</p>
        public let modelMetrics: [SagemakerEdgeClientTypes.EdgeMetric]?
