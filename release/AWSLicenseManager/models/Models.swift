...
public struct CheckoutBorrowLicenseInput: Swift.Equatable {
    ...
    ///          For more information, see <a href="https://tools.ietf.org/html/rfc7518#section-3.5">RFC 7518 Digital Signature with RSASSA-PSS.
    /// This member is required.
...
public struct CreateLicenseConversionTaskForResourceInput: Swift.Equatable {
    /// Information that identifies the license type you are converting to. For the structure of the destination license, see <a href="https://docs.aws.amazon.com/license-manager/latest/userguide/conversion-procedures.html#conversion-cli">Convert a license type using the AWS CLI in the License Manager User Guide.
    /// This member is required.
    ...
    ///          For the structure of the source license, see <a href="https://docs.aws.amazon.com/license-manager/latest/userguide/conversion-procedures.html#conversion-cli">Convert a license type using the AWS CLI in the License Manager User Guide.
    /// This member is required.
...
extension LicenseManagerClientTypes {
    ...
    public struct ProductInformation: Swift.Equatable {
        ...
        ///
        ///
        ///                   AccountId - The 12-digit ID of an Amazon Web Services account you wish to exclude from automated discovery.
