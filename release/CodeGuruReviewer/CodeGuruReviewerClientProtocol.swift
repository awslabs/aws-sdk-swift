...
public protocol CodeGuruReviewerClientProtocol {
    ...
    ///             </p>
    ///          </note>
    func associateRepository(input: AssociateRepositoryInput, completion: @escaping (SdkResult<AssociateRepositoryOutput, AssociateRepositoryOutputError>) -> Void)
    /// <p>
    ...
    ///       </p>
    func createCodeReview(input: CreateCodeReviewInput, completion: @escaping (SdkResult<CreateCodeReviewOutput, CreateCodeReviewOutputError>) -> Void)
    /// <p> Returns the metadata associated with the code review along with its status.</p>
    func describeCodeReview(input: DescribeCodeReviewInput, completion: @escaping (SdkResult<DescribeCodeReviewOutput, DescribeCodeReviewOutputError>) -> Void)
    /// <p>
    ///          Describes the customer feedback for a CodeGuru Reviewer recommendation.
    ///       </p>
    func describeRecommendationFeedback(input: DescribeRecommendationFeedbackInput, completion: @escaping (SdkResult<DescribeRecommendationFeedbackOutput, DescribeRecommendationFeedbackOutputError>) -> Void)
    /// <p>
    ...
    ///       </p>
    func describeRepositoryAssociation(input: DescribeRepositoryAssociationInput, completion: @escaping (SdkResult<DescribeRepositoryAssociationOutput, DescribeRepositoryAssociationOutputError>) -> Void)
    /// <p>Removes the association between Amazon CodeGuru Reviewer and a repository.</p>
    func disassociateRepository(input: DisassociateRepositoryInput, completion: @escaping (SdkResult<DisassociateRepositoryOutput, DisassociateRepositoryOutputError>) -> Void)
    /// <p>
    ///          Lists all the code reviews that the customer has created in the past 90 days.
    ///       </p>
    func listCodeReviews(input: ListCodeReviewsInput, completion: @escaping (SdkResult<ListCodeReviewsOutput, ListCodeReviewsOutputError>) -> Void)
    /// <p>
    ///          Returns a list of
    ...
    ///       </p>
    func listRecommendationFeedback(input: ListRecommendationFeedbackInput, completion: @escaping (SdkResult<ListRecommendationFeedbackOutput, ListRecommendationFeedbackOutputError>) -> Void)
    /// <p>
    ///          Returns the list of all recommendations for a completed code review.
    ///       </p>
    func listRecommendations(input: ListRecommendationsInput, completion: @escaping (SdkResult<ListRecommendationsOutput, ListRecommendationsOutputError>) -> Void)
    /// <p>
    ...
    ///             </a>.
    ///       </p>
    func listRepositoryAssociations(input: ListRepositoryAssociationsInput, completion: @escaping (SdkResult<ListRepositoryAssociationsOutput, ListRepositoryAssociationsOutputError>) -> Void)
    ...
    ///       </p>
    func putRecommendationFeedback(input: PutRecommendationFeedbackInput, completion: @escaping (SdkResult<PutRecommendationFeedbackOutput, PutRecommendationFeedbackOutputError>) -> Void)
