...
public class CodeGuruReviewerClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try CodeGuruReviewerClientConfiguration(region: unwrappedRegion)
    ...
    public class CodeGuruReviewerClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("CodeGuruReviewerClient")
...
public struct CodeGuruReviewerClientLogHandlerFactory: SDKLogHandlerFactory {
