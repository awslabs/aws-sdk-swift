...
extension CodeGuruReviewerClient: CodeGuruReviewerClientProtocol {
    ...
    ///             </p>
    ///          </note>
    public func associateRepository(input: AssociateRepositoryInput, completion: @escaping (SdkResult<AssociateRepositoryOutput, AssociateRepositoryOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<AssociateRepositoryInput, AssociateRepositoryOutput, AssociateRepositoryOutputError>(id: "associateRepository")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<AssociateRepositoryOutput>, SdkError<AssociateRepositoryOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssociateRepositoryInput, AssociateRepositoryOutput, AssociateRepositoryOutputError>(contentType: "application/json"))
    ...
    ///       </p>
    public func createCodeReview(input: CreateCodeReviewInput, completion: @escaping (SdkResult<CreateCodeReviewOutput, CreateCodeReviewOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "codeguru-reviewer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateCodeReviewInput, CreateCodeReviewOutput, CreateCodeReviewOutputError>(id: "createCodeReview")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateCodeReviewOutput>, SdkError<CreateCodeReviewOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateCodeReviewInput, CreateCodeReviewOutput, CreateCodeReviewOutputError>(contentType: "application/json"))
    ...
    public func describeCodeReview(input: DescribeCodeReviewInput, completion: @escaping (SdkResult<DescribeCodeReviewOutput, DescribeCodeReviewOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "codeguru-reviewer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCodeReviewInput, DescribeCodeReviewOutput, DescribeCodeReviewOutputError>(id: "describeCodeReview")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCodeReviewInput, DescribeCodeReviewOutput, DescribeCodeReviewOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       </p>
    public func describeRecommendationFeedback(input: DescribeRecommendationFeedbackInput, completion: @escaping (SdkResult<DescribeRecommendationFeedbackOutput, DescribeRecommendationFeedbackOutputError>) -> Void)
    {
        guard let codeReviewArn = input.codeReviewArn else {
            completion(.failure(.client(ClientError.serializationFailed("uri component codeReviewArn unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "codeguru-reviewer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeRecommendationFeedbackInput, DescribeRecommendationFeedbackOutput, DescribeRecommendationFeedbackOutputError>(id: "describeRecommendationFeedback")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeRecommendationFeedbackInput, DescribeRecommendationFeedbackOutput, DescribeRecommendationFeedbackOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       </p>
    public func describeRepositoryAssociation(input: DescribeRepositoryAssociationInput, completion: @escaping (SdkResult<DescribeRepositoryAssociationOutput, DescribeRepositoryAssociationOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "codeguru-reviewer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeRepositoryAssociationInput, DescribeRepositoryAssociationOutput, DescribeRepositoryAssociationOutputError>(id: "describeRepositoryAssociation")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeRepositoryAssociationInput, DescribeRepositoryAssociationOutput, DescribeRepositoryAssociationOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func disassociateRepository(input: DisassociateRepositoryInput, completion: @escaping (SdkResult<DisassociateRepositoryOutput, DisassociateRepositoryOutputError>) -> Void)
    {
        guard let associationArn = input.associationArn else {
            completion(.failure(.client(ClientError.serializationFailed("uri component associationArn unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "codeguru-reviewer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DisassociateRepositoryInput, DisassociateRepositoryOutput, DisassociateRepositoryOutputError>(id: "disassociateRepository")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DisassociateRepositoryInput, DisassociateRepositoryOutput, DisassociateRepositoryOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       </p>
    public func listCodeReviews(input: ListCodeReviewsInput, completion: @escaping (SdkResult<ListCodeReviewsOutput, ListCodeReviewsOutputError>) -> Void)
    {
        let urlPath = "/codereviews"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "codeguru-reviewer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListCodeReviewsInput, ListCodeReviewsOutput, ListCodeReviewsOutputError>(id: "listCodeReviews")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListCodeReviewsInput, ListCodeReviewsOutput, ListCodeReviewsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       </p>
    public func listRecommendationFeedback(input: ListRecommendationFeedbackInput, completion: @escaping (SdkResult<ListRecommendationFeedbackOutput, ListRecommendationFeedbackOutputError>) -> Void)
    {
        guard let codeReviewArn = input.codeReviewArn else {
            completion(.failure(.client(ClientError.serializationFailed("uri component codeReviewArn unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "codeguru-reviewer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListRecommendationFeedbackInput, ListRecommendationFeedbackOutput, ListRecommendationFeedbackOutputError>(id: "listRecommendationFeedback")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListRecommendationFeedbackInput, ListRecommendationFeedbackOutput, ListRecommendationFeedbackOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </a>.
    ///       </p>
    public func listRepositoryAssociations(input: ListRepositoryAssociationsInput, completion: @escaping (SdkResult<ListRepositoryAssociationsOutput, ListRepositoryAssociationsOutputError>) -> Void)
    {
        let urlPath = "/associations"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "codeguru-reviewer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListRepositoryAssociationsInput, ListRepositoryAssociationsOutput, ListRepositoryAssociationsOutputError>(id: "listRepositoryAssociations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListRepositoryAssociationsInput, ListRepositoryAssociationsOutput, ListRepositoryAssociationsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       </p>
    public func putRecommendationFeedback(input: PutRecommendationFeedbackInput, completion: @escaping (SdkResult<PutRecommendationFeedbackOutput, PutRecommendationFeedbackOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "codeguru-reviewer")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutRecommendationFeedbackInput, PutRecommendationFeedbackOutput, PutRecommendationFeedbackOutputError>(id: "putRecommendationFeedback")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutRecommendationFeedbackInput, PutRecommendationFeedbackOutput, PutRecommendationFeedbackOutputError>(contentType: "application/json"))
