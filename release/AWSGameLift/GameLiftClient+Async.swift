...
public extension GameLiftClient {
    ...
    ///
    func acceptMatch(input: AcceptMatchInput) async throws -> AcceptMatchOutputResponse
    {
        typealias acceptMatchContinuation = CheckedContinuation<AcceptMatchOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: acceptMatchContinuation) in
            acceptMatch(input: input) { result in
                switch result {
    ...
    ///
    func claimGameServer(input: ClaimGameServerInput) async throws -> ClaimGameServerOutputResponse
    {
        typealias claimGameServerContinuation = CheckedContinuation<ClaimGameServerOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: claimGameServerContinuation) in
            claimGameServer(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func createBuild(input: CreateBuildInput) async throws -> CreateBuildOutputResponse
    {
        typealias createBuildContinuation = CheckedContinuation<CreateBuildOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createBuildContinuation) in
            createBuild(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func createFleetLocations(input: CreateFleetLocationsInput) async throws -> CreateFleetLocationsOutputResponse
    {
        typealias createFleetLocationsContinuation = CheckedContinuation<CreateFleetLocationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createFleetLocationsContinuation) in
            createFleetLocations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func createGameServerGroup(input: CreateGameServerGroupInput) async throws -> CreateGameServerGroupOutputResponse
    {
        typealias createGameServerGroupContinuation = CheckedContinuation<CreateGameServerGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createGameServerGroupContinuation) in
            createGameServerGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func createGameSession(input: CreateGameSessionInput) async throws -> CreateGameSessionOutputResponse
    {
        typealias createGameSessionContinuation = CheckedContinuation<CreateGameSessionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createGameSessionContinuation) in
            createGameSession(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func createGameSessionQueue(input: CreateGameSessionQueueInput) async throws -> CreateGameSessionQueueOutputResponse
    {
        typealias createGameSessionQueueContinuation = CheckedContinuation<CreateGameSessionQueueOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createGameSessionQueueContinuation) in
            createGameSessionQueue(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func createMatchmakingConfiguration(input: CreateMatchmakingConfigurationInput) async throws -> CreateMatchmakingConfigurationOutputResponse
    {
        typealias createMatchmakingConfigurationContinuation = CheckedContinuation<CreateMatchmakingConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createMatchmakingConfigurationContinuation) in
            createMatchmakingConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func createMatchmakingRuleSet(input: CreateMatchmakingRuleSetInput) async throws -> CreateMatchmakingRuleSetOutputResponse
    {
        typealias createMatchmakingRuleSetContinuation = CheckedContinuation<CreateMatchmakingRuleSetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createMatchmakingRuleSetContinuation) in
            createMatchmakingRuleSet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func createPlayerSession(input: CreatePlayerSessionInput) async throws -> CreatePlayerSessionOutputResponse
    {
        typealias createPlayerSessionContinuation = CheckedContinuation<CreatePlayerSessionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createPlayerSessionContinuation) in
            createPlayerSession(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func createPlayerSessions(input: CreatePlayerSessionsInput) async throws -> CreatePlayerSessionsOutputResponse
    {
        typealias createPlayerSessionsContinuation = CheckedContinuation<CreatePlayerSessionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createPlayerSessionsContinuation) in
            createPlayerSessions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func createVpcPeeringAuthorization(input: CreateVpcPeeringAuthorizationInput) async throws -> CreateVpcPeeringAuthorizationOutputResponse
    {
        typealias createVpcPeeringAuthorizationContinuation = CheckedContinuation<CreateVpcPeeringAuthorizationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createVpcPeeringAuthorizationContinuation) in
            createVpcPeeringAuthorization(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func deleteBuild(input: DeleteBuildInput) async throws -> DeleteBuildOutputResponse
    {
        typealias deleteBuildContinuation = CheckedContinuation<DeleteBuildOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteBuildContinuation) in
            deleteBuild(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func deleteFleetLocations(input: DeleteFleetLocationsInput) async throws -> DeleteFleetLocationsOutputResponse
    {
        typealias deleteFleetLocationsContinuation = CheckedContinuation<DeleteFleetLocationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteFleetLocationsContinuation) in
            deleteFleetLocations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func deleteGameServerGroup(input: DeleteGameServerGroupInput) async throws -> DeleteGameServerGroupOutputResponse
    {
        typealias deleteGameServerGroupContinuation = CheckedContinuation<DeleteGameServerGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteGameServerGroupContinuation) in
            deleteGameServerGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func deleteGameSessionQueue(input: DeleteGameSessionQueueInput) async throws -> DeleteGameSessionQueueOutputResponse
    {
        typealias deleteGameSessionQueueContinuation = CheckedContinuation<DeleteGameSessionQueueOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteGameSessionQueueContinuation) in
            deleteGameSessionQueue(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func deleteMatchmakingConfiguration(input: DeleteMatchmakingConfigurationInput) async throws -> DeleteMatchmakingConfigurationOutputResponse
    {
        typealias deleteMatchmakingConfigurationContinuation = CheckedContinuation<DeleteMatchmakingConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteMatchmakingConfigurationContinuation) in
            deleteMatchmakingConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func deleteMatchmakingRuleSet(input: DeleteMatchmakingRuleSetInput) async throws -> DeleteMatchmakingRuleSetOutputResponse
    {
        typealias deleteMatchmakingRuleSetContinuation = CheckedContinuation<DeleteMatchmakingRuleSetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteMatchmakingRuleSetContinuation) in
            deleteMatchmakingRuleSet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func deleteScript(input: DeleteScriptInput) async throws -> DeleteScriptOutputResponse
    {
        typealias deleteScriptContinuation = CheckedContinuation<DeleteScriptOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteScriptContinuation) in
            deleteScript(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func deleteVpcPeeringAuthorization(input: DeleteVpcPeeringAuthorizationInput) async throws -> DeleteVpcPeeringAuthorizationOutputResponse
    {
        typealias deleteVpcPeeringAuthorizationContinuation = CheckedContinuation<DeleteVpcPeeringAuthorizationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteVpcPeeringAuthorizationContinuation) in
            deleteVpcPeeringAuthorization(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func deregisterGameServer(input: DeregisterGameServerInput) async throws -> DeregisterGameServerOutputResponse
    {
        typealias deregisterGameServerContinuation = CheckedContinuation<DeregisterGameServerOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deregisterGameServerContinuation) in
            deregisterGameServer(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeAlias(input: DescribeAliasInput) async throws -> DescribeAliasOutputResponse
    {
        typealias describeAliasContinuation = CheckedContinuation<DescribeAliasOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAliasContinuation) in
            describeAlias(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeBuild(input: DescribeBuildInput) async throws -> DescribeBuildOutputResponse
    {
        typealias describeBuildContinuation = CheckedContinuation<DescribeBuildOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeBuildContinuation) in
            describeBuild(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeEC2InstanceLimits(input: DescribeEC2InstanceLimitsInput) async throws -> DescribeEC2InstanceLimitsOutputResponse
    {
        typealias describeEC2InstanceLimitsContinuation = CheckedContinuation<DescribeEC2InstanceLimitsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeEC2InstanceLimitsContinuation) in
            describeEC2InstanceLimits(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeFleetAttributes(input: DescribeFleetAttributesInput) async throws -> DescribeFleetAttributesOutputResponse
    {
        typealias describeFleetAttributesContinuation = CheckedContinuation<DescribeFleetAttributesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFleetAttributesContinuation) in
            describeFleetAttributes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeFleetCapacity(input: DescribeFleetCapacityInput) async throws -> DescribeFleetCapacityOutputResponse
    {
        typealias describeFleetCapacityContinuation = CheckedContinuation<DescribeFleetCapacityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFleetCapacityContinuation) in
            describeFleetCapacity(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeFleetEvents(input: DescribeFleetEventsInput) async throws -> DescribeFleetEventsOutputResponse
    {
        typealias describeFleetEventsContinuation = CheckedContinuation<DescribeFleetEventsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFleetEventsContinuation) in
            describeFleetEvents(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeFleetLocationAttributes(input: DescribeFleetLocationAttributesInput) async throws -> DescribeFleetLocationAttributesOutputResponse
    {
        typealias describeFleetLocationAttributesContinuation = CheckedContinuation<DescribeFleetLocationAttributesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFleetLocationAttributesContinuation) in
            describeFleetLocationAttributes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeFleetLocationCapacity(input: DescribeFleetLocationCapacityInput) async throws -> DescribeFleetLocationCapacityOutputResponse
    {
        typealias describeFleetLocationCapacityContinuation = CheckedContinuation<DescribeFleetLocationCapacityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFleetLocationCapacityContinuation) in
            describeFleetLocationCapacity(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeFleetLocationUtilization(input: DescribeFleetLocationUtilizationInput) async throws -> DescribeFleetLocationUtilizationOutputResponse
    {
        typealias describeFleetLocationUtilizationContinuation = CheckedContinuation<DescribeFleetLocationUtilizationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFleetLocationUtilizationContinuation) in
            describeFleetLocationUtilization(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeFleetPortSettings(input: DescribeFleetPortSettingsInput) async throws -> DescribeFleetPortSettingsOutputResponse
    {
        typealias describeFleetPortSettingsContinuation = CheckedContinuation<DescribeFleetPortSettingsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFleetPortSettingsContinuation) in
            describeFleetPortSettings(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeFleetUtilization(input: DescribeFleetUtilizationInput) async throws -> DescribeFleetUtilizationOutputResponse
    {
        typealias describeFleetUtilizationContinuation = CheckedContinuation<DescribeFleetUtilizationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFleetUtilizationContinuation) in
            describeFleetUtilization(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func describeGameServer(input: DescribeGameServerInput) async throws -> DescribeGameServerOutputResponse
    {
        typealias describeGameServerContinuation = CheckedContinuation<DescribeGameServerOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeGameServerContinuation) in
            describeGameServer(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func describeGameServerGroup(input: DescribeGameServerGroupInput) async throws -> DescribeGameServerGroupOutputResponse
    {
        typealias describeGameServerGroupContinuation = CheckedContinuation<DescribeGameServerGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeGameServerGroupContinuation) in
            describeGameServerGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func describeGameServerInstances(input: DescribeGameServerInstancesInput) async throws -> DescribeGameServerInstancesOutputResponse
    {
        typealias describeGameServerInstancesContinuation = CheckedContinuation<DescribeGameServerInstancesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeGameServerInstancesContinuation) in
            describeGameServerInstances(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeGameSessionDetails(input: DescribeGameSessionDetailsInput) async throws -> DescribeGameSessionDetailsOutputResponse
    {
        typealias describeGameSessionDetailsContinuation = CheckedContinuation<DescribeGameSessionDetailsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeGameSessionDetailsContinuation) in
            describeGameSessionDetails(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeGameSessionPlacement(input: DescribeGameSessionPlacementInput) async throws -> DescribeGameSessionPlacementOutputResponse
    {
        typealias describeGameSessionPlacementContinuation = CheckedContinuation<DescribeGameSessionPlacementOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeGameSessionPlacementContinuation) in
            describeGameSessionPlacement(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeGameSessionQueues(input: DescribeGameSessionQueuesInput) async throws -> DescribeGameSessionQueuesOutputResponse
    {
        typealias describeGameSessionQueuesContinuation = CheckedContinuation<DescribeGameSessionQueuesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeGameSessionQueuesContinuation) in
            describeGameSessionQueues(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeGameSessions(input: DescribeGameSessionsInput) async throws -> DescribeGameSessionsOutputResponse
    {
        typealias describeGameSessionsContinuation = CheckedContinuation<DescribeGameSessionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeGameSessionsContinuation) in
            describeGameSessions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeMatchmaking(input: DescribeMatchmakingInput) async throws -> DescribeMatchmakingOutputResponse
    {
        typealias describeMatchmakingContinuation = CheckedContinuation<DescribeMatchmakingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeMatchmakingContinuation) in
            describeMatchmaking(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeMatchmakingConfigurations(input: DescribeMatchmakingConfigurationsInput) async throws -> DescribeMatchmakingConfigurationsOutputResponse
    {
        typealias describeMatchmakingConfigurationsContinuation = CheckedContinuation<DescribeMatchmakingConfigurationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeMatchmakingConfigurationsContinuation) in
            describeMatchmakingConfigurations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeMatchmakingRuleSets(input: DescribeMatchmakingRuleSetsInput) async throws -> DescribeMatchmakingRuleSetsOutputResponse
    {
        typealias describeMatchmakingRuleSetsContinuation = CheckedContinuation<DescribeMatchmakingRuleSetsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeMatchmakingRuleSetsContinuation) in
            describeMatchmakingRuleSets(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describePlayerSessions(input: DescribePlayerSessionsInput) async throws -> DescribePlayerSessionsOutputResponse
    {
        typealias describePlayerSessionsContinuation = CheckedContinuation<DescribePlayerSessionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describePlayerSessionsContinuation) in
            describePlayerSessions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeRuntimeConfiguration(input: DescribeRuntimeConfigurationInput) async throws -> DescribeRuntimeConfigurationOutputResponse
    {
        typealias describeRuntimeConfigurationContinuation = CheckedContinuation<DescribeRuntimeConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeRuntimeConfigurationContinuation) in
            describeRuntimeConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeScript(input: DescribeScriptInput) async throws -> DescribeScriptOutputResponse
    {
        typealias describeScriptContinuation = CheckedContinuation<DescribeScriptOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeScriptContinuation) in
            describeScript(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func describeVpcPeeringAuthorizations(input: DescribeVpcPeeringAuthorizationsInput) async throws -> DescribeVpcPeeringAuthorizationsOutputResponse
    {
        typealias describeVpcPeeringAuthorizationsContinuation = CheckedContinuation<DescribeVpcPeeringAuthorizationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeVpcPeeringAuthorizationsContinuation) in
            describeVpcPeeringAuthorizations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func getGameSessionLogUrl(input: GetGameSessionLogUrlInput) async throws -> GetGameSessionLogUrlOutputResponse
    {
        typealias getGameSessionLogUrlContinuation = CheckedContinuation<GetGameSessionLogUrlOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getGameSessionLogUrlContinuation) in
            getGameSessionLogUrl(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func getInstanceAccess(input: GetInstanceAccessInput) async throws -> GetInstanceAccessOutputResponse
    {
        typealias getInstanceAccessContinuation = CheckedContinuation<GetInstanceAccessOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getInstanceAccessContinuation) in
            getInstanceAccess(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func listGameServerGroups(input: ListGameServerGroupsInput) async throws -> ListGameServerGroupsOutputResponse
    {
        typealias listGameServerGroupsContinuation = CheckedContinuation<ListGameServerGroupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listGameServerGroupsContinuation) in
            listGameServerGroups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func listGameServers(input: ListGameServersInput) async throws -> ListGameServersOutputResponse
    {
        typealias listGameServersContinuation = CheckedContinuation<ListGameServersOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listGameServersContinuation) in
            listGameServers(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func listScripts(input: ListScriptsInput) async throws -> ListScriptsOutputResponse
    {
        typealias listScriptsContinuation = CheckedContinuation<ListScriptsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listScriptsContinuation) in
            listScripts(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func registerGameServer(input: RegisterGameServerInput) async throws -> RegisterGameServerOutputResponse
    {
        typealias registerGameServerContinuation = CheckedContinuation<RegisterGameServerOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: registerGameServerContinuation) in
            registerGameServer(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func requestUploadCredentials(input: RequestUploadCredentialsInput) async throws -> RequestUploadCredentialsOutputResponse
    {
        typealias requestUploadCredentialsContinuation = CheckedContinuation<RequestUploadCredentialsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: requestUploadCredentialsContinuation) in
            requestUploadCredentials(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func resolveAlias(input: ResolveAliasInput) async throws -> ResolveAliasOutputResponse
    {
        typealias resolveAliasContinuation = CheckedContinuation<ResolveAliasOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: resolveAliasContinuation) in
            resolveAlias(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func resumeGameServerGroup(input: ResumeGameServerGroupInput) async throws -> ResumeGameServerGroupOutputResponse
    {
        typealias resumeGameServerGroupContinuation = CheckedContinuation<ResumeGameServerGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: resumeGameServerGroupContinuation) in
            resumeGameServerGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func searchGameSessions(input: SearchGameSessionsInput) async throws -> SearchGameSessionsOutputResponse
    {
        typealias searchGameSessionsContinuation = CheckedContinuation<SearchGameSessionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: searchGameSessionsContinuation) in
            searchGameSessions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func startFleetActions(input: StartFleetActionsInput) async throws -> StartFleetActionsOutputResponse
    {
        typealias startFleetActionsContinuation = CheckedContinuation<StartFleetActionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startFleetActionsContinuation) in
            startFleetActions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func startGameSessionPlacement(input: StartGameSessionPlacementInput) async throws -> StartGameSessionPlacementOutputResponse
    {
        typealias startGameSessionPlacementContinuation = CheckedContinuation<StartGameSessionPlacementOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startGameSessionPlacementContinuation) in
            startGameSessionPlacement(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func startMatchBackfill(input: StartMatchBackfillInput) async throws -> StartMatchBackfillOutputResponse
    {
        typealias startMatchBackfillContinuation = CheckedContinuation<StartMatchBackfillOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startMatchBackfillContinuation) in
            startMatchBackfill(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func startMatchmaking(input: StartMatchmakingInput) async throws -> StartMatchmakingOutputResponse
    {
        typealias startMatchmakingContinuation = CheckedContinuation<StartMatchmakingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startMatchmakingContinuation) in
            startMatchmaking(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func stopFleetActions(input: StopFleetActionsInput) async throws -> StopFleetActionsOutputResponse
    {
        typealias stopFleetActionsContinuation = CheckedContinuation<StopFleetActionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopFleetActionsContinuation) in
            stopFleetActions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func stopGameSessionPlacement(input: StopGameSessionPlacementInput) async throws -> StopGameSessionPlacementOutputResponse
    {
        typealias stopGameSessionPlacementContinuation = CheckedContinuation<StopGameSessionPlacementOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopGameSessionPlacementContinuation) in
            stopGameSessionPlacement(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func stopMatchmaking(input: StopMatchmakingInput) async throws -> StopMatchmakingOutputResponse
    {
        typealias stopMatchmakingContinuation = CheckedContinuation<StopMatchmakingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopMatchmakingContinuation) in
            stopMatchmaking(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func suspendGameServerGroup(input: SuspendGameServerGroupInput) async throws -> SuspendGameServerGroupOutputResponse
    {
        typealias suspendGameServerGroupContinuation = CheckedContinuation<SuspendGameServerGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: suspendGameServerGroupContinuation) in
            suspendGameServerGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func updateBuild(input: UpdateBuildInput) async throws -> UpdateBuildOutputResponse
    {
        typealias updateBuildContinuation = CheckedContinuation<UpdateBuildOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateBuildContinuation) in
            updateBuild(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func updateFleetAttributes(input: UpdateFleetAttributesInput) async throws -> UpdateFleetAttributesOutputResponse
    {
        typealias updateFleetAttributesContinuation = CheckedContinuation<UpdateFleetAttributesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateFleetAttributesContinuation) in
            updateFleetAttributes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func updateFleetCapacity(input: UpdateFleetCapacityInput) async throws -> UpdateFleetCapacityOutputResponse
    {
        typealias updateFleetCapacityContinuation = CheckedContinuation<UpdateFleetCapacityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateFleetCapacityContinuation) in
            updateFleetCapacity(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func updateFleetPortSettings(input: UpdateFleetPortSettingsInput) async throws -> UpdateFleetPortSettingsOutputResponse
    {
        typealias updateFleetPortSettingsContinuation = CheckedContinuation<UpdateFleetPortSettingsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateFleetPortSettingsContinuation) in
            updateFleetPortSettings(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func updateGameServer(input: UpdateGameServerInput) async throws -> UpdateGameServerOutputResponse
    {
        typealias updateGameServerContinuation = CheckedContinuation<UpdateGameServerOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateGameServerContinuation) in
            updateGameServer(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/reference-awssdk-fleetiq.html">All APIs by task
    ///
    func updateGameServerGroup(input: UpdateGameServerGroupInput) async throws -> UpdateGameServerGroupOutputResponse
    {
        typealias updateGameServerGroupContinuation = CheckedContinuation<UpdateGameServerGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateGameServerGroupContinuation) in
            updateGameServerGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func updateGameSession(input: UpdateGameSessionInput) async throws -> UpdateGameSessionOutputResponse
    {
        typealias updateGameSessionContinuation = CheckedContinuation<UpdateGameSessionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateGameSessionContinuation) in
            updateGameSession(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func updateGameSessionQueue(input: UpdateGameSessionQueueInput) async throws -> UpdateGameSessionQueueOutputResponse
    {
        typealias updateGameSessionQueueContinuation = CheckedContinuation<UpdateGameSessionQueueOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateGameSessionQueueContinuation) in
            updateGameSessionQueue(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func updateMatchmakingConfiguration(input: UpdateMatchmakingConfigurationInput) async throws -> UpdateMatchmakingConfigurationOutputResponse
    {
        typealias updateMatchmakingConfigurationContinuation = CheckedContinuation<UpdateMatchmakingConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateMatchmakingConfigurationContinuation) in
            updateMatchmakingConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func updateRuntimeConfiguration(input: UpdateRuntimeConfigurationInput) async throws -> UpdateRuntimeConfigurationOutputResponse
    {
        typealias updateRuntimeConfigurationContinuation = CheckedContinuation<UpdateRuntimeConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateRuntimeConfigurationContinuation) in
            updateRuntimeConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func updateScript(input: UpdateScriptInput) async throws -> UpdateScriptOutputResponse
    {
        typealias updateScriptContinuation = CheckedContinuation<UpdateScriptOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateScriptContinuation) in
            updateScript(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets">All APIs by task
    ///
    func validateMatchmakingRuleSet(input: ValidateMatchmakingRuleSetInput) async throws -> ValidateMatchmakingRuleSetOutputResponse
    {
        typealias validateMatchmakingRuleSetContinuation = CheckedContinuation<ValidateMatchmakingRuleSetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: validateMatchmakingRuleSetContinuation) in
            validateMatchmakingRuleSet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
