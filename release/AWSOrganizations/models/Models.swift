...
public struct AcceptHandshakeOutputResponse: Swift.Equatable {
    ...
    var handshake: OrganizationsClientTypes.Handshake?
...
extension OrganizationsClientTypes {
    ...
    public struct Account: Swift.Equatable {
        ...
        var joinedMethod: OrganizationsClientTypes.AccountJoinedMethod?
        /// The date the account became a part of the organization.
        var joinedTimestamp: ClientRuntime.Date?
        ...
        var status: OrganizationsClientTypes.AccountStatus?
...
extension OrganizationsClientTypes {
    ...
    public struct Child: Swift.Equatable {
        ...
        var type: OrganizationsClientTypes.ChildType?
...
public struct CreateAccountInput: Swift.Equatable {
    ...
    var iamUserAccessToBilling: OrganizationsClientTypes.IAMUserAccessToBilling?
    ...
    var tags: [OrganizationsClientTypes.Tag]?
...
public struct CreateAccountOutputResponse: Swift.Equatable {
    ...
    var createAccountStatus: OrganizationsClientTypes.CreateAccountStatus?
...
extension OrganizationsClientTypes {
    ...
    public struct CreateAccountStatus: Swift.Equatable {
        ...
        var requestedTimestamp: ClientRuntime.Date?
        /// The status of the asynchronous request to create an AWS account.
        var state: OrganizationsClientTypes.CreateAccountState?
...
public struct CreateOrganizationInput: Swift.Equatable {
    ...
    var featureSet: OrganizationsClientTypes.OrganizationFeatureSet?
...
public struct CreateOrganizationOutputResponse: Swift.Equatable {
    ...
    var organization: OrganizationsClientTypes.Organization?
...
public struct CreateOrganizationalUnitOutputResponse: Swift.Equatable {
    ...
    var organizationalUnit: OrganizationsClientTypes.OrganizationalUnit?
...
public struct CreatePolicyInput: Swift.Equatable {
    ...
    /// This member is required.
    var type: OrganizationsClientTypes.PolicyType?
...
public struct CreatePolicyOutputResponse: Swift.Equatable {
    ...
    var policy: OrganizationsClientTypes.Policy?
...
extension OrganizationsClientTypes {
    ...
    public struct DelegatedAdministrator: Swift.Equatable {
        ...
        var delegationEnabledDate: ClientRuntime.Date?
...
public struct DescribeAccountOutputResponse: Swift.Equatable {
    ...
    var account: OrganizationsClientTypes.Account?
...
public struct DescribeCreateAccountStatusInput: Swift.Equatable {
    ...
    /// This member is required.
    var createAccountRequestId: Swift.String?
...
public struct DescribeEffectivePolicyInput: Swift.Equatable {
    ...
    /// * [TAG_POLICY](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_tag-policies.html)
    /// This member is required.
    var policyType: OrganizationsClientTypes.EffectivePolicyType?
...
public struct DescribeEffectivePolicyOutputResponse: Swift.Equatable {
    ...
    var effectivePolicy: OrganizationsClientTypes.EffectivePolicy?
...
public struct DisablePolicyTypeInput: Swift.Equatable {
    ...
    /// * [TAG_POLICY](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_tag-policies.html)
    /// This member is required.
    var policyType: OrganizationsClientTypes.PolicyType?
...
public struct DisablePolicyTypeOutputResponse: Swift.Equatable {
    ...
    var root: OrganizationsClientTypes.Root?
...
extension OrganizationsClientTypes {
    ...
    public struct EffectivePolicy: Swift.Equatable {
        ...
        var policyContent: Swift.String?
        /// The policy type.
        var policyType: OrganizationsClientTypes.EffectivePolicyType?
...
extension OrganizationsClientTypes {
    ...
    public struct EnabledServicePrincipal: Swift.Equatable {
        ...
        var dateEnabled: ClientRuntime.Date?
...
extension OrganizationsClientTypes {
    ...
    public struct Handshake: Swift.Equatable {
        ...
        var action: OrganizationsClientTypes.ActionType?
        ...
        var expirationTimestamp: ClientRuntime.Date?
        ...
        var parties: [OrganizationsClientTypes.HandshakeParty]?
        /// The date and time that the handshake request was made.
        var requestedTimestamp: ClientRuntime.Date?
        /// Additional information that is needed to process the handshake.
        var resources: [OrganizationsClientTypes.HandshakeResource]?
        ...
        var state: OrganizationsClientTypes.HandshakeState?
...
extension OrganizationsClientTypes {
    ...
    public struct HandshakeFilter: Swift.Equatable {
        ...
        var actionType: OrganizationsClientTypes.ActionType?
        ...
        var parentHandshakeId: Swift.String?
...
extension OrganizationsClientTypes {
    ...
    public struct HandshakeParty: Swift.Equatable {
        ...
        /// The type of party.
        /// This member is required.
        var type: OrganizationsClientTypes.HandshakePartyType?
...
extension OrganizationsClientTypes {
    ...
    public struct HandshakeResource: Swift.Equatable {
        ...
        var type: OrganizationsClientTypes.HandshakeResourceType?
...
public struct InviteAccountToOrganizationInput: Swift.Equatable {
    ...
    /// This member is required.
    var target: OrganizationsClientTypes.HandshakeParty?
...
public struct ListAWSServiceAccessForOrganizationOutputResponse: Swift.Equatable {
    ...
    var enabledServicePrincipals: [OrganizationsClientTypes.EnabledServicePrincipal]?
...
public struct ListAccountsForParentOutputResponse: Swift.Equatable {
    ...
    var accounts: [OrganizationsClientTypes.Account]?
    /// If present, indicates that more output is available than is included in the current response. Use this value in the NextToken request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the NextToken response element comes back as null.
    var nextToken: Swift.String?
...
public struct ListChildrenInput: Swift.Equatable {
    ...
    /// This member is required.
    var childType: OrganizationsClientTypes.ChildType?
    /// The total number of results that you want included on each page of the response. If you do not include this parameter, it defaults to a value that is specific to the operation. If additional items exist beyond the maximum you specify, the NextToken response element is present and has a value (is not null). Include that value as the NextToken request parameter in the next call to the operation to get the next part of the results. Note that Organizations might return fewer results than the maximum even when there are more results available. You should check NextToken after every operation to ensure that you receive all of the results.
    var maxResults: Swift.Int?
    /// The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
    var nextToken: Swift.String?
...
public struct ListChildrenOutputResponse: Swift.Equatable {
    ...
    var children: [OrganizationsClientTypes.Child]?
    /// If present, indicates that more output is available than is included in the current response. Use this value in the NextToken request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the NextToken response element comes back as null.
    var nextToken: Swift.String?
...
public struct ListCreateAccountStatusInput: Swift.Equatable {
    ...
    var states: [OrganizationsClientTypes.CreateAccountState]?
...
public struct ListCreateAccountStatusOutputResponse: Swift.Equatable {
    ...
    var createAccountStatuses: [OrganizationsClientTypes.CreateAccountStatus]?
    /// If present, indicates that more output is available than is included in the current response. Use this value in the NextToken request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the NextToken response element comes back as null.
    var nextToken: Swift.String?
...
public struct ListDelegatedAdministratorsOutputResponse: Swift.Equatable {
    ...
    var delegatedAdministrators: [OrganizationsClientTypes.DelegatedAdministrator]?
    /// If present, indicates that more output is available than is included in the current response. Use this value in the NextToken request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the NextToken response element comes back as null.
    var nextToken: Swift.String?
...
public struct ListDelegatedServicesForAccountOutputResponse: Swift.Equatable {
    ...
    var delegatedServices: [OrganizationsClientTypes.DelegatedService]?
    /// If present, indicates that more output is available than is included in the current response. Use this value in the NextToken request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the NextToken response element comes back as null.
    var nextToken: Swift.String?
...
public struct ListHandshakesForAccountInput: Swift.Equatable {
    ...
    var filter: OrganizationsClientTypes.HandshakeFilter?
    /// The total number of results that you want included on each page of the response. If you do not include this parameter, it defaults to a value that is specific to the operation. If additional items exist beyond the maximum you specify, the NextToken response element is present and has a value (is not null). Include that value as the NextToken request parameter in the next call to the operation to get the next part of the results. Note that Organizations might return fewer results than the maximum even when there are more results available. You should check NextToken after every operation to ensure that you receive all of the results.
    var maxResults: Swift.Int?
    /// The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
    var nextToken: Swift.String?
...
public struct ListHandshakesForAccountOutputResponse: Swift.Equatable {
    ...
    var handshakes: [OrganizationsClientTypes.Handshake]?
    /// If present, indicates that more output is available than is included in the current response. Use this value in the NextToken request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the NextToken response element comes back as null.
    var nextToken: Swift.String?
...
public struct ListOrganizationalUnitsForParentOutputResponse: Swift.Equatable {
    ...
    var organizationalUnits: [OrganizationsClientTypes.OrganizationalUnit]?
...
public struct ListParentsOutputResponse: Swift.Equatable {
    ...
    var parents: [OrganizationsClientTypes.Parent]?
...
public struct ListPoliciesForTargetInput: Swift.Equatable {
    ...
    /// * [TAG_POLICY](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_tag-policies.html)
    /// This member is required.
    var filter: OrganizationsClientTypes.PolicyType?
    /// The total number of results that you want included on each page of the response. If you do not include this parameter, it defaults to a value that is specific to the operation. If additional items exist beyond the maximum you specify, the NextToken response element is present and has a value (is not null). Include that value as the NextToken request parameter in the next call to the operation to get the next part of the results. Note that Organizations might return fewer results than the maximum even when there are more results available. You should check NextToken after every operation to ensure that you receive all of the results.
    var maxResults: Swift.Int?
    /// The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
    var nextToken: Swift.String?
...
public struct ListPoliciesForTargetOutputResponse: Swift.Equatable {
    ...
    var policies: [OrganizationsClientTypes.PolicySummary]?
...
public struct ListRootsOutputResponse: Swift.Equatable {
    ...
    var roots: [OrganizationsClientTypes.Root]?
...
public struct ListTargetsForPolicyOutputResponse: Swift.Equatable {
    ...
    var targets: [OrganizationsClientTypes.PolicyTargetSummary]?
...
public struct MoveAccountInput: Swift.Equatable {
    ...
    /// * Organizational unit (OU) - A string that begins with "ou-" followed by from 4 to 32 lowercase letters or digits (the ID of the root that the OU is in). This string is followed by a second "-" dash and from 8 to 32 additional lowercase letters or digits.
    /// This member is required.
    var destinationParentId: Swift.String?
    ...
    /// * Organizational unit (OU) - A string that begins with "ou-" followed by from 4 to 32 lowercase letters or digits (the ID of the root that the OU is in). This string is followed by a second "-" dash and from 8 to 32 additional lowercase letters or digits.
    /// This member is required.
    var sourceParentId: Swift.String?
...
extension OrganizationsClientTypes {
    ...
    public struct Organization: Swift.Equatable {
        ...
        var availablePolicyTypes: [OrganizationsClientTypes.PolicyTypeSummary]?
        ...
        var masterAccountArn: Swift.String?
        /// The email address that is associated with the AWS account that is designated as the management account for the organization.
        var masterAccountEmail: Swift.String?
...
extension OrganizationsClientTypes {
    ...
    public struct Parent: Swift.Equatable {
        ...
        var type: OrganizationsClientTypes.ParentType?
...
extension OrganizationsClientTypes {
    ...
    public struct Policy: Swift.Equatable {
        ...
        var policySummary: OrganizationsClientTypes.PolicySummary?
...
extension OrganizationsClientTypes {
    ...
    public struct PolicyTargetSummary: Swift.Equatable {
        ...
        var type: OrganizationsClientTypes.TargetType?
...
extension OrganizationsClientTypes {
    ...
    public struct PolicyTypeSummary: Swift.Equatable {
        ...
        var status: OrganizationsClientTypes.PolicyTypeStatus?
...
extension OrganizationsClientTypes {
    ...
    public struct Root: Swift.Equatable {
        ...
        var policyTypes: [OrganizationsClientTypes.PolicyTypeSummary]?
