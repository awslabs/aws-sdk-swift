...
public protocol IotEventsDataClientProtocol {
    ...
    func batchAcknowledgeAlarm(input: BatchAcknowledgeAlarmInput, completion: @escaping (SdkResult<BatchAcknowledgeAlarmOutput, BatchAcknowledgeAlarmOutputError>) -> Void)
    /// <p>Disables one or more alarms. The alarms change to the <code>DISABLED</code> state after
    ///       you disable them.</p>
    func batchDisableAlarm(input: BatchDisableAlarmInput, completion: @escaping (SdkResult<BatchDisableAlarmOutput, BatchDisableAlarmOutputError>) -> Void)
    /// <p>Enables one or more alarms. The alarms change to the <code>NORMAL</code> state after you
    ///       enable them.</p>
    func batchEnableAlarm(input: BatchEnableAlarmInput, completion: @escaping (SdkResult<BatchEnableAlarmOutput, BatchEnableAlarmOutputError>) -> Void)
    ...
    ///       reset them.</p>
    func batchResetAlarm(input: BatchResetAlarmInput, completion: @escaping (SdkResult<BatchResetAlarmOutput, BatchResetAlarmOutputError>) -> Void)
    ...
    func batchSnoozeAlarm(input: BatchSnoozeAlarmInput, completion: @escaping (SdkResult<BatchSnoozeAlarmOutput, BatchSnoozeAlarmOutputError>) -> Void)
    /// <p>Updates the state, variable values, and timer settings of one or more detectors
    ///       (instances) of a specified detector model.</p>
    func batchUpdateDetector(input: BatchUpdateDetectorInput, completion: @escaping (SdkResult<BatchUpdateDetectorOutput, BatchUpdateDetectorOutputError>) -> Void)
    /// <p>Retrieves information about an alarm.</p>
    func describeAlarm(input: DescribeAlarmInput, completion: @escaping (SdkResult<DescribeAlarmOutput, DescribeAlarmOutputError>) -> Void)
    /// <p>Returns information about the specified detector (instance).</p>
    func describeDetector(input: DescribeDetectorInput, completion: @escaping (SdkResult<DescribeDetectorOutput, DescribeDetectorOutputError>) -> Void)
    /// <p>Lists one or more alarms. The operation returns only the metadata associated with each
    ///       alarm.</p>
    func listAlarms(input: ListAlarmsInput, completion: @escaping (SdkResult<ListAlarmsOutput, ListAlarmsOutputError>) -> Void)
    /// <p>Lists detectors (the instances of a detector model).</p>
    func listDetectors(input: ListDetectorsInput, completion: @escaping (SdkResult<ListDetectorsOutput, ListDetectorsOutputError>) -> Void)
}
