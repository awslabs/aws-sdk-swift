...
extension ConnectCasesClientTypes.CaseFilter: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        switch self {
            ...
            case let .not(not):
                try container.encode(not.value, forKey: .not)
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let notDecoded = try values.decodeIfPresent(Box<ConnectCasesClientTypes.CaseFilter>.self, forKey: .not)
...
extension ConnectCasesClientTypes.ContactContent: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let connectedToSystemTime = self.connectedToSystemTime {
            try encodeContainer.encode(connectedToSystemTime.timeIntervalSince1970, forKey: .connectedToSystemTime)
        }
        if let contactArn = self.contactArn {
            try encodeContainer.encode(contactArn, forKey: .contactArn)
        }
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let connectedToSystemTimeDecoded = try containerValues.decodeIfPresent(ClientRuntime.Date.self, forKey: .connectedToSystemTime)
