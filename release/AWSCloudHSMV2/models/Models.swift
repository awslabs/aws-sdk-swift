...
extension CloudHsmV2ClientTypes {
    ...
    public struct Backup: Swift.Equatable {
        ...
        var backupState: CloudHsmV2ClientTypes.BackupState?
        /// The identifier (ID) of the cluster that was backed up.
        var clusterId: Swift.String?
        /// The date and time when the backup was copied from a source backup.
        var copyTimestamp: ClientRuntime.Date?
        /// The date and time when the backup was created.
        var createTimestamp: ClientRuntime.Date?
        /// The date and time when the backup will be permanently deleted.
        var deleteTimestamp: ClientRuntime.Date?
        /// Specifies whether the service should exempt a backup from the retention policy for the cluster. True exempts a backup from the retention policy. False means the service applies the backup retention policy defined at the cluster.
        var neverExpires: Swift.Bool?
        /// The identifier (ID) of the source backup from which the new backup was copied.
        var sourceBackup: Swift.String?
        /// The identifier (ID) of the cluster containing the source backup from which the new backup was copied.
        var sourceCluster: Swift.String?
        /// The AWS Region that contains the source backup from which the new backup was copied.
        var sourceRegion: Swift.String?
        /// The list of tags for the backup.
        var tagList: [CloudHsmV2ClientTypes.Tag]?
...
extension CloudHsmV2ClientTypes {
    ...
    public struct BackupRetentionPolicy: Swift.Equatable {
        ...
        var type: CloudHsmV2ClientTypes.BackupRetentionType?
...
extension CloudHsmV2ClientTypes {
    ...
    public struct Certificates: Swift.Equatable {
        ...
        var awsHardwareCertificate: Swift.String?
        /// The cluster certificate issued (signed) by the issuing certificate authority (CA) of the cluster's owner.
        var clusterCertificate: Swift.String?
        /// The cluster's certificate signing request (CSR). The CSR exists only when the cluster's state is UNINITIALIZED.
        var clusterCsr: Swift.String?
        /// The HSM certificate issued (signed) by the HSM hardware.
        var hsmCertificate: Swift.String?
        /// The HSM hardware certificate issued (signed) by the hardware manufacturer.
        var manufacturerHardwareCertificate: Swift.String?
...
extension CloudHsmV2ClientTypes {
    ...
    public struct Cluster: Swift.Equatable {
        ...
        var backupPolicy: CloudHsmV2ClientTypes.BackupPolicy?
        /// A policy that defines how the service retains backups.
        var backupRetentionPolicy: CloudHsmV2ClientTypes.BackupRetentionPolicy?
        /// Contains one or more certificates or a certificate signing request (CSR).
        var certificates: CloudHsmV2ClientTypes.Certificates?
        /// The cluster's identifier (ID).
        var clusterId: Swift.String?
        /// The date and time when the cluster was created.
        var createTimestamp: ClientRuntime.Date?
        /// The type of HSM that the cluster contains.
        var hsmType: Swift.String?
        /// Contains information about the HSMs in the cluster.
        var hsms: [CloudHsmV2ClientTypes.Hsm]?
        /// The default password for the cluster's Pre-Crypto Officer (PRECO) user.
        var preCoPassword: Swift.String?
        /// The identifier (ID) of the cluster's security group.
        var securityGroup: Swift.String?
        /// The identifier (ID) of the backup used to create the cluster. This value exists only when the cluster was created from a backup.
        var sourceBackupId: Swift.String?
        /// The cluster's state.
        var state: CloudHsmV2ClientTypes.ClusterState?
        /// A description of the cluster's state.
        var stateMessage: Swift.String?
        /// A map from availability zone to the cluster’s subnet in that availability zone.
        var subnetMapping: [Swift.String:Swift.String]?
...
public struct CopyBackupToRegionOutputResponse: Swift.Equatable {
    ...
    var destinationBackup: CloudHsmV2ClientTypes.DestinationBackup?
...
public struct CreateClusterOutputResponse: Swift.Equatable {
    ...
    var cluster: CloudHsmV2ClientTypes.Cluster?
...
public struct CreateHsmOutputResponse: Swift.Equatable {
    ...
    var hsm: CloudHsmV2ClientTypes.Hsm?
...
public struct DeleteBackupOutputResponse: Swift.Equatable {
    ...
    var backup: CloudHsmV2ClientTypes.Backup?
...
public struct DeleteHsmInput: Swift.Equatable {
    ...
    var eniIp: Swift.String?
    /// The identifier (ID) of the HSM that you are deleting.
    var hsmId: Swift.String?
...
public struct DescribeBackupsOutputResponse: Swift.Equatable {
    /// A list of backups.
    var backups: [CloudHsmV2ClientTypes.Backup]?
...
public struct DescribeClustersOutputResponse: Swift.Equatable {
    /// A list of clusters.
    var clusters: [CloudHsmV2ClientTypes.Cluster]?
...
extension CloudHsmV2ClientTypes {
    ...
    public struct Hsm: Swift.Equatable {
        ...
        var hsmId: Swift.String?
        /// The HSM's state.
        var state: CloudHsmV2ClientTypes.HsmState?
