...
extension CreateCloudFormationTemplateOutput: HttpResponseBinding {
    public init (httpResponse: HttpResponse, decoder: ResponseDecoder? = nil) throws {
        if case .data(let data) = httpResponse.body,
            let unwrappedData = data,
            let responseDecoder = decoder {
            let output: CreateCloudFormationTemplateOutputBody = try responseDecoder.decode(responseBody: unwrappedData)
