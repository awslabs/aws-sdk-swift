...
extension GreengrassV2Client: GreengrassV2ClientProtocol {
    ...
    public func batchAssociateClientDeviceWithCoreDevice(input: BatchAssociateClientDeviceWithCoreDeviceInput, completion: @escaping (ClientRuntime.SdkResult<BatchAssociateClientDeviceWithCoreDeviceOutputResponse, BatchAssociateClientDeviceWithCoreDeviceOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<BatchAssociateClientDeviceWithCoreDeviceInput, BatchAssociateClientDeviceWithCoreDeviceOutputResponse, BatchAssociateClientDeviceWithCoreDeviceOutputError>(id: "batchAssociateClientDeviceWithCoreDevice")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: BatchAssociateClientDeviceWithCoreDeviceInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: BatchAssociateClientDeviceWithCoreDeviceInputQueryItemMiddleware())
        ...
        operation.serializeStep.intercept(position: .before, middleware: BatchAssociateClientDeviceWithCoreDeviceInputBodyMiddleware())
    ...
    public func batchDisassociateClientDeviceFromCoreDevice(input: BatchDisassociateClientDeviceFromCoreDeviceInput, completion: @escaping (ClientRuntime.SdkResult<BatchDisassociateClientDeviceFromCoreDeviceOutputResponse, BatchDisassociateClientDeviceFromCoreDeviceOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "greengrass")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<BatchDisassociateClientDeviceFromCoreDeviceInput, BatchDisassociateClientDeviceFromCoreDeviceOutputResponse, BatchDisassociateClientDeviceFromCoreDeviceOutputError>(id: "batchDisassociateClientDeviceFromCoreDevice")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: BatchDisassociateClientDeviceFromCoreDeviceInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: BatchDisassociateClientDeviceFromCoreDeviceInputQueryItemMiddleware())
        ...
        operation.serializeStep.intercept(position: .before, middleware: BatchDisassociateClientDeviceFromCoreDeviceInputBodyMiddleware())
        operation.deserializeStep.intercept(position: .before, middleware: ClientRuntime.LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: AWSClientRuntime.RetryerMiddleware(retryer: config.retryer))
        let sigv4Config = AWSClientRuntime.SigV4Config(unsignedBody: false)
    ...
    public func createComponentVersion(input: CreateComponentVersionInput, completion: @escaping (ClientRuntime.SdkResult<CreateComponentVersionOutputResponse, CreateComponentVersionOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<CreateComponentVersionOutputResponse>, ClientRuntime.SdkError<CreateComponentVersionOutputError>> in
    ...
    public func createDeployment(input: CreateDeploymentInput, completion: @escaping (ClientRuntime.SdkResult<CreateDeploymentOutputResponse, CreateDeploymentOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<CreateDeploymentOutputResponse>, ClientRuntime.SdkError<CreateDeploymentOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
    ...
    public func listClientDevicesAssociatedWithCoreDevice(input: ListClientDevicesAssociatedWithCoreDeviceInput, completion: @escaping (ClientRuntime.SdkResult<ListClientDevicesAssociatedWithCoreDeviceOutputResponse, ListClientDevicesAssociatedWithCoreDeviceOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "greengrass")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListClientDevicesAssociatedWithCoreDeviceInput, ListClientDevicesAssociatedWithCoreDeviceOutputResponse, ListClientDevicesAssociatedWithCoreDeviceOutputError>(id: "listClientDevicesAssociatedWithCoreDevice")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListClientDevicesAssociatedWithCoreDeviceInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListClientDevicesAssociatedWithCoreDeviceInputQueryItemMiddleware())
