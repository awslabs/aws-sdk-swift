...
public class GreengrassV2Client {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try GreengrassV2ClientConfiguration(region: unwrappedRegion)
    ...
    public class GreengrassV2ClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("GreengrassV2Client")
...
public struct GreengrassV2ClientLogHandlerFactory: SDKLogHandlerFactory {
