...
public protocol GreengrassV2ClientProtocol {
    ...
    func cancelDeployment(input: CancelDeploymentInput, completion: @escaping (SdkResult<CancelDeploymentOutput, CancelDeploymentOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createComponentVersion(input: CreateComponentVersionInput, completion: @escaping (SdkResult<CreateComponentVersionOutput, CreateComponentVersionOutputError>) -> Void)
    ...
    func deleteCoreDevice(input: DeleteCoreDeviceInput, completion: @escaping (SdkResult<DeleteCoreDeviceOutput, DeleteCoreDeviceOutputError>) -> Void)
    ...
    func getComponentVersionArtifact(input: GetComponentVersionArtifactInput, completion: @escaping (SdkResult<GetComponentVersionArtifactOutput, GetComponentVersionArtifactOutputError>) -> Void)
    /// <p>Retrieves metadata for a AWS IoT Greengrass core device.</p>
    func getCoreDevice(input: GetCoreDeviceInput, completion: @escaping (SdkResult<GetCoreDeviceOutput, GetCoreDeviceOutputError>) -> Void)
    ...
    func listComponentVersions(input: ListComponentVersionsInput, completion: @escaping (SdkResult<ListComponentVersionsOutput, ListComponentVersionsOutputError>) -> Void)
    /// <p>Retrieves a paginated list of AWS IoT Greengrass core devices.</p>
    func listCoreDevices(input: ListCoreDevicesInput, completion: @escaping (SdkResult<ListCoreDevicesOutput, ListCoreDevicesOutputError>) -> Void)
    ...
    ///       devices.</p>
    func listEffectiveDeployments(input: ListEffectiveDeploymentsInput, completion: @escaping (SdkResult<ListEffectiveDeploymentsOutput, ListEffectiveDeploymentsOutputError>) -> Void)
    /// <p>Retrieves a paginated list of the components that a AWS IoT Greengrass core device runs.</p>
    func listInstalledComponents(input: ListInstalledComponentsInput, completion: @escaping (SdkResult<ListInstalledComponentsOutput, ListInstalledComponentsOutputError>) -> Void)
    ...
    ///          </important>
    func resolveComponentCandidates(input: ResolveComponentCandidatesInput, completion: @escaping (SdkResult<ResolveComponentCandidatesOutput, ResolveComponentCandidatesOutputError>) -> Void)
