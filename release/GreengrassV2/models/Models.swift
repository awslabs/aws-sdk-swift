...
extension GreengrassV2ClientTypes {
    ...
    public struct CloudComponentStatus: Swift.Equatable {
        ...
        public let componentState: GreengrassV2ClientTypes.CloudComponentState?
...
extension GreengrassV2ClientTypes {
    ...
    public struct Component: Swift.Equatable {
        ...
        public let latestVersion: GreengrassV2ClientTypes.ComponentLatestVersion?
...
extension GreengrassV2ClientTypes {
    ...
    public struct ComponentCandidate: Swift.Equatable {
        ...
        public let versionRequirements: [Swift.String:Swift.String]?
...
extension GreengrassV2ClientTypes {
    ...
    public struct ComponentDependencyRequirement: Swift.Equatable {
        ...
        ///          </p>
        public let dependencyType: GreengrassV2ClientTypes.ComponentDependencyType?
...
extension GreengrassV2ClientTypes {
    ...
    public struct ComponentDeploymentSpecification: Swift.Equatable {
        ...
        ///         configurations</a> in the <i>AWS IoT Greengrass V2 Developer Guide</i>.</p>
        public let configurationUpdate: GreengrassV2ClientTypes.ComponentConfigurationUpdate?
        ...
        ///         Guide</i>.</p>
        public let runWith: GreengrassV2ClientTypes.ComponentRunWith?
...
extension GreengrassV2ClientTypes.ComponentRunWith: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ComponentRunWith(posixUser: \(Swift.String(describing: posixUser)))"}
}
...
extension GreengrassV2ClientTypes {
    ...
    public struct ComponentRunWith: Swift.Equatable {
        ...
        public let posixUser: Swift.String?
...
extension CreateComponentVersionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateComponentVersionInput(inlineRecipe: \(Swift.String(describing: inlineRecipe)), lambdaFunction: \(Swift.String(describing: lambdaFunction)), tags: \(Swift.String(describing: tags)))"}
}
...
extension CreateDeploymentInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateDeploymentInput(components: \(Swift.String(describing: components)), deploymentName: \(Swift.String(describing: deploymentName)), deploymentPolicies: \(Swift.String(describing: deploymentPolicies)), iotJobConfiguration: \(Swift.String(describing: iotJobConfiguration)), tags: \(Swift.String(describing: tags)), targetArn: \(Swift.String(describing: targetArn)))"}
}
...
extension GreengrassV2ClientTypes {
    ...
    public struct DeploymentComponentUpdatePolicy: Swift.Equatable {
        ...
        ///          </p>
        public let action: GreengrassV2ClientTypes.DeploymentComponentUpdatePolicyAction?
...
extension GreengrassV2ClientTypes {
    ...
    public struct DeploymentIoTJobConfiguration: Swift.Equatable {
        ...
        ///       rollout.</p>
        public let abortConfig: GreengrassV2ClientTypes.IoTJobAbortConfig?
        ...
        public let jobExecutionsRolloutConfig: GreengrassV2ClientTypes.IoTJobExecutionsRolloutConfig?
        ...
        public let timeoutConfig: GreengrassV2ClientTypes.IoTJobTimeoutConfig?
...
extension GreengrassV2ClientTypes {
    ...
    public struct DeploymentPolicies: Swift.Equatable {
        ...
        public let componentUpdatePolicy: GreengrassV2ClientTypes.DeploymentComponentUpdatePolicy?
        ...
        public let configurationValidationPolicy: GreengrassV2ClientTypes.DeploymentConfigurationValidationPolicy?
        ...
        ///          </p>
        public let failureHandlingPolicy: GreengrassV2ClientTypes.DeploymentFailureHandlingPolicy?
...
extension GreengrassV2ClientTypes {
    ...
    public struct EffectiveDeployment: Swift.Equatable {
        ...
        public let coreDeviceExecutionStatus: GreengrassV2ClientTypes.EffectiveDeploymentExecutionStatus?
        /// <p>The time at which the deployment was created, expressed in ISO 8601 format.</p>
        public let creationTimestamp: ClientRuntime.Date?
        /// <p>The ID of the deployment.</p>
        public let deploymentId: Swift.String?
...
public struct GetComponentVersionArtifactInput: Swift.Equatable {
    ...
    public let artifactName: Swift.String?
...
extension GreengrassV2ClientTypes {
    ...
    public struct InstalledComponent: Swift.Equatable {
        ...
        public let lifecycleState: GreengrassV2ClientTypes.InstalledComponentLifecycleState?
        /// <p>The details about the lifecycle state of the component.</p>
        public let lifecycleStateDetails: Swift.String?
...
extension GreengrassV2ClientTypes {
    ...
    public struct IoTJobAbortConfig: Swift.Equatable {
        ...
        public let criteriaList: [GreengrassV2ClientTypes.IoTJobAbortCriteria]?
...
extension GreengrassV2ClientTypes {
    ...
    public struct IoTJobAbortCriteria: Swift.Equatable {
        ...
        public let action: GreengrassV2ClientTypes.IoTJobAbortAction?
        /// <p>The type of job deployment failure that can cancel a job.</p>
        public let failureType: GreengrassV2ClientTypes.IoTJobExecutionFailureType?
...
extension GreengrassV2ClientTypes {
    ...
    public struct IoTJobExecutionsRolloutConfig: Swift.Equatable {
        ...
        public let exponentialRate: GreengrassV2ClientTypes.IoTJobExponentialRolloutRate?
...
extension GreengrassV2ClientTypes {
    ...
    public struct IoTJobExponentialRolloutRate: Swift.Equatable {
        ...
        public let rateIncreaseCriteria: GreengrassV2ClientTypes.IoTJobRateIncreaseCriteria?
...
extension GreengrassV2ClientTypes {
    ...
    public struct LambdaDeviceMount: Swift.Equatable {
        ...
        ///          <p>Default: <code>false</code>
        ///          </p>
        public let addGroupOwner: Swift.Bool
        ...
        ///          </p>
        public let permission: GreengrassV2ClientTypes.LambdaFilesystemPermission?
...
extension GreengrassV2ClientTypes {
    ...
    public struct LambdaEventSource: Swift.Equatable {
        ...
        ///             </li>
        ///          </ul>
        public let type: GreengrassV2ClientTypes.LambdaEventSourceType?
...
extension GreengrassV2ClientTypes {
    ...
    public struct LambdaExecutionParameters: Swift.Equatable {
        ...
        public let eventSources: [GreengrassV2ClientTypes.LambdaEventSource]?
        ...
        ///          </p>
        public let inputPayloadEncodingType: GreengrassV2ClientTypes.LambdaInputPayloadEncodingType?
        /// <p>The parameters for the Linux process that contains the Lambda function.</p>
        public let linuxProcessParams: GreengrassV2ClientTypes.LambdaLinuxProcessParams?
        ...
        public let maxQueueSize: Swift.Int
        ...
        public let statusTimeoutInSeconds: Swift.Int
...
extension GreengrassV2ClientTypes {
    ...
    public struct LambdaFunctionRecipeSource: Swift.Equatable {
        ...
        public let componentDependencies: [Swift.String:GreengrassV2ClientTypes.ComponentDependencyRequirement]?
        /// <p>The system and runtime parameters for the Lambda function as it runs on the AWS IoT Greengrass core
        ///       device.</p>
        public let componentLambdaParameters: GreengrassV2ClientTypes.LambdaExecutionParameters?
        /// <p>The name of the component.</p>
        ///          <p>Defaults to the name of the Lambda function.</p>
        public let componentName: Swift.String?
        /// <p>The platforms that the component version supports.</p>
        public let componentPlatforms: [GreengrassV2ClientTypes.ComponentPlatform]?
        /// <p>The version of the component.</p>
...
extension GreengrassV2ClientTypes {
    ...
    public struct LambdaLinuxProcessParams: Swift.Equatable {
        ...
        public let containerParams: GreengrassV2ClientTypes.LambdaContainerParams?
        ...
        ///          </p>
        public let isolationMode: GreengrassV2ClientTypes.LambdaIsolationMode?
...
public struct ListComponentsInput: Swift.Equatable {
    ...
    ///          </p>
    public let scope: GreengrassV2ClientTypes.ComponentVisibilityScope?
...
public struct ListDeploymentsInput: Swift.Equatable {
    ...
    ///          </p>
    public let historyFilter: GreengrassV2ClientTypes.DeploymentHistoryFilter?
    /// <p>The maximum number of results to be returned per paginated request.</p>
    public let maxResults: Swift.Int
    /// <p>The token to be used for the next set of paginated results.</p>
    public let nextToken: Swift.String?
