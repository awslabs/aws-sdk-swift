...
extension AcmClientTypes {
    ...
    public struct CertificateDetail: Swift.Equatable {
        ...
        var certificateAuthorityArn: Swift.String?
        ...
        var domainValidationOptions: [AcmClientTypes.DomainValidation]?
        /// Contains a list of Extended Key Usage X.509 v3 extension objects. Each object specifies a purpose for which the certificate public key can be used and consists of a name and an object identifier (OID).
        var extendedKeyUsages: [AcmClientTypes.ExtendedKeyUsage]?
        ...
        var failureReason: AcmClientTypes.FailureReason?
        /// The date and time at which the certificate was imported. This value exists only when the certificate type is IMPORTED.
        var importedAt: ClientRuntime.Date?
        ...
        var inUseBy: [Swift.String]?
        /// The time at which the certificate was issued. This value exists only when the certificate type is AMAZON_ISSUED.
        var issuedAt: ClientRuntime.Date?
        /// The name of the certificate authority that issued and signed the certificate.
        var issuer: Swift.String?
        /// The algorithm that was used to generate the public-private key pair.
        var keyAlgorithm: AcmClientTypes.KeyAlgorithm?
        /// A list of Key Usage X.509 v3 extension objects. Each object is a string value that identifies the purpose of the public key contained in the certificate. Possible extension values include DIGITAL_SIGNATURE, KEY_ENCHIPHERMENT, NON_REPUDIATION, and more.
        var keyUsages: [AcmClientTypes.KeyUsage]?
        ...
        var options: AcmClientTypes.CertificateOptions?
        /// Specifies whether the certificate is eligible for renewal. At this time, only exported private certificates can be renewed with the [RenewCertificate] command.
        var renewalEligibility: AcmClientTypes.RenewalEligibility?
        ...
        var renewalSummary: AcmClientTypes.RenewalSummary?
        /// The reason the certificate was revoked. This value exists only when the certificate status is REVOKED.
        var revocationReason: AcmClientTypes.RevocationReason?
        /// The time at which the certificate was revoked. This value exists only when the certificate status is REVOKED.
        var revokedAt: ClientRuntime.Date?
        /// The serial number of the certificate.
        var serial: Swift.String?
        /// The algorithm that was used to sign the certificate.
        var signatureAlgorithm: Swift.String?
        /// The status of the certificate.
        var status: AcmClientTypes.CertificateStatus?
        /// The name of the entity that is associated with the public key contained in the certificate.
        var subject: Swift.String?
        /// One or more domain names (subject alternative names) included in the certificate. This list contains the domain names that are bound to the public key that is contained in the certificate. The subject alternative names include the canonical domain name (CN) of the certificate and additional domain names that can be used to connect to the website.
        var subjectAlternativeNames: [Swift.String]?
        ...
        var type: AcmClientTypes.CertificateType?
...
extension AcmClientTypes {
    ...
    public struct CertificateOptions: Swift.Equatable {
        ...
        var certificateTransparencyLoggingPreference: AcmClientTypes.CertificateTransparencyLoggingPreference?
...
public struct DescribeCertificateOutputResponse: Swift.Equatable {
    ...
    var certificate: AcmClientTypes.CertificateDetail?
...
extension AcmClientTypes {
    ...
    public struct DomainValidation: Swift.Equatable {
        ...
        var resourceRecord: AcmClientTypes.ResourceRecord?
        /// The domain name that ACM used to send domain validation emails.
        var validationDomain: Swift.String?
        /// A list of email addresses that ACM used to send domain validation emails.
        var validationEmails: [Swift.String]?
        /// Specifies the domain validation method.
        var validationMethod: AcmClientTypes.ValidationMethod?
        ...
        ///
        /// * FAILED
        var validationStatus: AcmClientTypes.DomainStatus?
...
extension AcmClientTypes {
    ...
    public struct ExpiryEventsConfiguration: Swift.Equatable {
        ...
        var daysBeforeExpiry: Swift.Int?
...
public struct ExportCertificateInput: Swift.Equatable {
    ...
    /// This member is required.
    var passphrase: ClientRuntime.Data?
...
public struct ExportCertificateOutputResponse: Swift.Equatable {
    ...
    var certificateChain: Swift.String?
...
extension AcmClientTypes {
    ...
    public struct ExtendedKeyUsage: Swift.Equatable {
        ...
        var name: AcmClientTypes.ExtendedKeyUsageName?
...
extension AcmClientTypes {
    ...
    public struct Filters: Swift.Equatable {
        ...
        var extendedKeyUsage: [AcmClientTypes.ExtendedKeyUsageName]?
        ...
        var keyTypes: [AcmClientTypes.KeyAlgorithm]?
        /// Specify one or more [KeyUsage] extension values.
        var keyUsage: [AcmClientTypes.KeyUsageName]?
...
public struct GetAccountConfigurationOutputResponse: Swift.Equatable {
    ...
    var expiryEvents: AcmClientTypes.ExpiryEventsConfiguration?
...
public struct ImportCertificateInput: Swift.Equatable {
    ...
    /// This member is required.
    var certificate: ClientRuntime.Data?
    ...
    var certificateChain: ClientRuntime.Data?
    /// The private key that matches the public key in the certificate.
    /// This member is required.
    var privateKey: ClientRuntime.Data?
...
extension AcmClientTypes {
    ...
    public struct KeyUsage: Swift.Equatable {
        ...
        var name: AcmClientTypes.KeyUsageName?
...
public struct ListCertificatesInput: Swift.Equatable {
    ...
    var certificateStatuses: [AcmClientTypes.CertificateStatus]?
    /// Filter the certificate list. For more information, see the [Filters] structure.
    var includes: AcmClientTypes.Filters?
...
public struct ListCertificatesOutputResponse: Swift.Equatable {
    ...
    var certificateSummaryList: [AcmClientTypes.CertificateSummary]?
...
extension AcmClientTypes {
    ...
    public struct RenewalSummary: Swift.Equatable {
        ...
        /// This member is required.
        var renewalStatus: AcmClientTypes.RenewalStatus?
        /// The reason that a renewal request was unsuccessful.
        var renewalStatusReason: AcmClientTypes.FailureReason?
...
public struct RequestCertificateInput: Swift.Equatable {
    ...
    var domainValidationOptions: [AcmClientTypes.DomainValidationOption]?
...
extension AcmClientTypes {
    ...
    public struct ResourceRecord: Swift.Equatable {
        ...
        /// This member is required.
        var type: AcmClientTypes.RecordType?
