...
public struct GetEvidenceByEvidenceFolderInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetEvidenceByEvidenceFolderOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetEvidenceByEvidenceFolderOutput>
