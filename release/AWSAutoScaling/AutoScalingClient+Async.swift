...
public extension AutoScalingClient {
    ...
    {
        typealias attachInstancesContinuation = CheckedContinuation<AttachInstancesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: attachInstancesContinuation) in
            attachInstances(input: input) { result in
                switch result {
    ...
    {
        typealias attachLoadBalancerTargetGroupsContinuation = CheckedContinuation<AttachLoadBalancerTargetGroupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: attachLoadBalancerTargetGroupsContinuation) in
            attachLoadBalancerTargetGroups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias attachLoadBalancersContinuation = CheckedContinuation<AttachLoadBalancersOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: attachLoadBalancersContinuation) in
            attachLoadBalancers(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias batchDeleteScheduledActionContinuation = CheckedContinuation<BatchDeleteScheduledActionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: batchDeleteScheduledActionContinuation) in
            batchDeleteScheduledAction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias batchPutScheduledUpdateGroupActionContinuation = CheckedContinuation<BatchPutScheduledUpdateGroupActionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: batchPutScheduledUpdateGroupActionContinuation) in
            batchPutScheduledUpdateGroupAction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias cancelInstanceRefreshContinuation = CheckedContinuation<CancelInstanceRefreshOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: cancelInstanceRefreshContinuation) in
            cancelInstanceRefresh(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias completeLifecycleActionContinuation = CheckedContinuation<CompleteLifecycleActionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: completeLifecycleActionContinuation) in
            completeLifecycleAction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createAutoScalingGroupContinuation = CheckedContinuation<CreateAutoScalingGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createAutoScalingGroupContinuation) in
            createAutoScalingGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createLaunchConfigurationContinuation = CheckedContinuation<CreateLaunchConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createLaunchConfigurationContinuation) in
            createLaunchConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createOrUpdateTagsContinuation = CheckedContinuation<CreateOrUpdateTagsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createOrUpdateTagsContinuation) in
            createOrUpdateTags(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteAutoScalingGroupContinuation = CheckedContinuation<DeleteAutoScalingGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteAutoScalingGroupContinuation) in
            deleteAutoScalingGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteLaunchConfigurationContinuation = CheckedContinuation<DeleteLaunchConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteLaunchConfigurationContinuation) in
            deleteLaunchConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteLifecycleHookContinuation = CheckedContinuation<DeleteLifecycleHookOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteLifecycleHookContinuation) in
            deleteLifecycleHook(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteNotificationConfigurationContinuation = CheckedContinuation<DeleteNotificationConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteNotificationConfigurationContinuation) in
            deleteNotificationConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteWarmPoolContinuation = CheckedContinuation<DeleteWarmPoolOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteWarmPoolContinuation) in
            deleteWarmPool(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeAdjustmentTypesContinuation = CheckedContinuation<DescribeAdjustmentTypesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAdjustmentTypesContinuation) in
            describeAdjustmentTypes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeAutoScalingGroupsContinuation = CheckedContinuation<DescribeAutoScalingGroupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAutoScalingGroupsContinuation) in
            describeAutoScalingGroups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeAutoScalingInstancesContinuation = CheckedContinuation<DescribeAutoScalingInstancesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAutoScalingInstancesContinuation) in
            describeAutoScalingInstances(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeAutoScalingNotificationTypesContinuation = CheckedContinuation<DescribeAutoScalingNotificationTypesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAutoScalingNotificationTypesContinuation) in
            describeAutoScalingNotificationTypes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeInstanceRefreshesContinuation = CheckedContinuation<DescribeInstanceRefreshesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeInstanceRefreshesContinuation) in
            describeInstanceRefreshes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeLaunchConfigurationsContinuation = CheckedContinuation<DescribeLaunchConfigurationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeLaunchConfigurationsContinuation) in
            describeLaunchConfigurations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeLifecycleHookTypesContinuation = CheckedContinuation<DescribeLifecycleHookTypesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeLifecycleHookTypesContinuation) in
            describeLifecycleHookTypes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeLifecycleHooksContinuation = CheckedContinuation<DescribeLifecycleHooksOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeLifecycleHooksContinuation) in
            describeLifecycleHooks(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeLoadBalancerTargetGroupsContinuation = CheckedContinuation<DescribeLoadBalancerTargetGroupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeLoadBalancerTargetGroupsContinuation) in
            describeLoadBalancerTargetGroups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeMetricCollectionTypesContinuation = CheckedContinuation<DescribeMetricCollectionTypesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeMetricCollectionTypesContinuation) in
            describeMetricCollectionTypes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeNotificationConfigurationsContinuation = CheckedContinuation<DescribeNotificationConfigurationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeNotificationConfigurationsContinuation) in
            describeNotificationConfigurations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describePoliciesContinuation = CheckedContinuation<DescribePoliciesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describePoliciesContinuation) in
            describePolicies(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeScalingProcessTypesContinuation = CheckedContinuation<DescribeScalingProcessTypesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeScalingProcessTypesContinuation) in
            describeScalingProcessTypes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeTerminationPolicyTypesContinuation = CheckedContinuation<DescribeTerminationPolicyTypesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeTerminationPolicyTypesContinuation) in
            describeTerminationPolicyTypes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeWarmPoolContinuation = CheckedContinuation<DescribeWarmPoolOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeWarmPoolContinuation) in
            describeWarmPool(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias detachInstancesContinuation = CheckedContinuation<DetachInstancesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: detachInstancesContinuation) in
            detachInstances(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias detachLoadBalancerTargetGroupsContinuation = CheckedContinuation<DetachLoadBalancerTargetGroupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: detachLoadBalancerTargetGroupsContinuation) in
            detachLoadBalancerTargetGroups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias detachLoadBalancersContinuation = CheckedContinuation<DetachLoadBalancersOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: detachLoadBalancersContinuation) in
            detachLoadBalancers(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias disableMetricsCollectionContinuation = CheckedContinuation<DisableMetricsCollectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: disableMetricsCollectionContinuation) in
            disableMetricsCollection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias enableMetricsCollectionContinuation = CheckedContinuation<EnableMetricsCollectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: enableMetricsCollectionContinuation) in
            enableMetricsCollection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias enterStandbyContinuation = CheckedContinuation<EnterStandbyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: enterStandbyContinuation) in
            enterStandby(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias executePolicyContinuation = CheckedContinuation<ExecutePolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: executePolicyContinuation) in
            executePolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias exitStandbyContinuation = CheckedContinuation<ExitStandbyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: exitStandbyContinuation) in
            exitStandby(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getPredictiveScalingForecastContinuation = CheckedContinuation<GetPredictiveScalingForecastOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getPredictiveScalingForecastContinuation) in
            getPredictiveScalingForecast(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putLifecycleHookContinuation = CheckedContinuation<PutLifecycleHookOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putLifecycleHookContinuation) in
            putLifecycleHook(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putNotificationConfigurationContinuation = CheckedContinuation<PutNotificationConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putNotificationConfigurationContinuation) in
            putNotificationConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putScheduledUpdateGroupActionContinuation = CheckedContinuation<PutScheduledUpdateGroupActionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putScheduledUpdateGroupActionContinuation) in
            putScheduledUpdateGroupAction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putWarmPoolContinuation = CheckedContinuation<PutWarmPoolOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putWarmPoolContinuation) in
            putWarmPool(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias recordLifecycleActionHeartbeatContinuation = CheckedContinuation<RecordLifecycleActionHeartbeatOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: recordLifecycleActionHeartbeatContinuation) in
            recordLifecycleActionHeartbeat(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias resumeProcessesContinuation = CheckedContinuation<ResumeProcessesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: resumeProcessesContinuation) in
            resumeProcesses(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias setDesiredCapacityContinuation = CheckedContinuation<SetDesiredCapacityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: setDesiredCapacityContinuation) in
            setDesiredCapacity(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias setInstanceHealthContinuation = CheckedContinuation<SetInstanceHealthOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: setInstanceHealthContinuation) in
            setInstanceHealth(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias setInstanceProtectionContinuation = CheckedContinuation<SetInstanceProtectionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: setInstanceProtectionContinuation) in
            setInstanceProtection(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias startInstanceRefreshContinuation = CheckedContinuation<StartInstanceRefreshOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startInstanceRefreshContinuation) in
            startInstanceRefresh(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias suspendProcessesContinuation = CheckedContinuation<SuspendProcessesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: suspendProcessesContinuation) in
            suspendProcesses(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias terminateInstanceInAutoScalingGroupContinuation = CheckedContinuation<TerminateInstanceInAutoScalingGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: terminateInstanceInAutoScalingGroupContinuation) in
            terminateInstanceInAutoScalingGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateAutoScalingGroupContinuation = CheckedContinuation<UpdateAutoScalingGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateAutoScalingGroupContinuation) in
            updateAutoScalingGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
