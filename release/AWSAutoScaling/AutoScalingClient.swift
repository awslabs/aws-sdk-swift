...
public class AutoScalingClient {
    ...
    let config: AutoScalingClientConfigurationProtocol
    let serviceName = "Auto Scaling"
    let encoder: ClientRuntime.RequestEncoder
    let decoder: ClientRuntime.ResponseDecoder

    public init(config: AutoScalingClientConfigurationProtocol) {
    ...
    public class AutoScalingClientConfiguration: AutoScalingClientConfigurationProtocol {
        ...
        public convenience init(
            ...
            let runtimeConfig = try ClientRuntime.DefaultSDKRuntimeConfiguration("AutoScalingClient")
            try self.init(
