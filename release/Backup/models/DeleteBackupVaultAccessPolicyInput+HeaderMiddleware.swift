...
public struct DeleteBackupVaultAccessPolicyInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DeleteBackupVaultAccessPolicyOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DeleteBackupVaultAccessPolicyOutput>
