...
extension BackupClientTypes {
    ...
    public struct AdvancedBackupSetting: Swift.Equatable {
        ...
        ///          exception.
        ///          For more information about Windows VSS backups, see <a href="https://docs.aws.amazon.com/aws-backup/latest/devguide/windows-backups.html">Creating a VSS-Enabled Windows
        ///             Backup.
...
extension BackupClientTypes {
    ...
    public struct BackupPlanInput: Swift.Equatable {
        ...
        ///          that is used to back up a selection of resources.
        /// This member is required.
        public let rules: [BackupClientTypes.BackupRuleInput]?
...
extension BackupClientTypes {
    ...
    public struct BackupPlanTemplatesListMember: Swift.Equatable {
        ...
        public let backupPlanTemplateId: Swift.String?
        /// The optional display name of a backup plan template.
        public let backupPlanTemplateName: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct BackupRule: Swift.Equatable {
        ...
        public let completionWindowMinutes: Swift.Int?
        /// An array of CopyAction objects, which contains the details of the copy
        ///          operation.
        public let copyActions: [BackupClientTypes.CopyAction]?
        ...
        public let enableContinuousBackup: Swift.Bool?
        ...
        ///          information about cron expressions, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/events/ScheduledEvents.html">Schedule Expressions for Rules in the Amazon CloudWatch Events User
        ...
        ///          are created. They consist of lowercase letters, numbers, and hyphens.
        /// This member is required.
        public let targetBackupVaultName: Swift.String?
...
extension BackupClientTypes.BackupSelection: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BackupSelection(iamRoleArn: \(Swift.String(describing: iamRoleArn)), listOfTags: \(Swift.String(describing: listOfTags)), resources: \(Swift.String(describing: resources)), selectionName: \(Swift.String(describing: selectionName)))"}
}
...
extension BackupClientTypes {
    ...
    public struct BackupSelection: Swift.Equatable {
        ...
        public let listOfTags: [BackupClientTypes.Condition]?
        ...
        /// This member is required.
        public let selectionName: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct CalculatedLifecycle: Swift.Equatable {
        ...
        public let deleteAt: ClientRuntime.Date?
        /// A timestamp that specifies when to transition a recovery point to cold storage.
        public let moveToColdStorageAt: ClientRuntime.Date?
...
extension BackupClientTypes {
    ...
    public struct CopyJob: Swift.Equatable {
        ...
        ///             arn:aws:backup:us-east-1:123456789012:recovery-point:1EB3B5E7-9EB0-435A-A80B-108B488B0D45.
        public let destinationRecoveryPointArn: Swift.String?
        ...
        ///             arn:aws:backup:us-east-1:123456789012:recovery-point:1EB3B5E7-9EB0-435A-A80B-108B488B0D45.
        public let sourceRecoveryPointArn: Swift.String?
        /// The current state of a copy job.
        public let state: BackupClientTypes.CopyJobState?
...
public struct DescribeBackupJobOutputResponse: Swift.Equatable {
    ...
    ///             BackupType is empty, then the backup type that was is a regular
    ///          backup.
    public let backupType: Swift.String?
    /// An Amazon Resource Name (ARN) that uniquely identifies a backup vault; for example,
    ///             arn:aws:backup:us-east-1:123456789012:vault:aBackupVault.
...
public struct DescribeGlobalSettingsOutputResponse: Swift.Equatable {
    ...
    ///          format and Coordinated Universal Time (UTC). The value of LastUpdateTime is
    ///          accurate to milliseconds. For example, the value 1516925490.087 represents Friday, January
    ///          26, 2018 12:11:30.087 AM.
...
extension DescribeRegionSettingsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeRegionSettingsOutputResponse(resourceTypeOptInPreference: \(Swift.String(describing: resourceTypeOptInPreference)))"}
}
...
extension BackupClientTypes {
    ...
    public struct Lifecycle: Swift.Equatable {
        ...
        public let deleteAfterDays: Swift.Int?
        /// Specifies the number of days after creation that a recovery point is moved to cold
        ///          storage.
        public let moveToColdStorageAfterDays: Swift.Int?
...
public struct ListBackupJobsInput: Swift.Equatable {
    ...
    public let byAccountId: Swift.String?
    ...
    ///          hyphens.
    public let byBackupVaultName: Swift.String?
    /// Returns only backup jobs that were created after the specified date.
    public let byCreatedAfter: ClientRuntime.Date?
    /// Returns only backup jobs that were created before the specified date.
    public let byCreatedBefore: ClientRuntime.Date?
    /// Returns only backup jobs that match the specified resource Amazon Resource Name
    ///          (ARN).
    public let byResourceArn: Swift.String?
    ...
    ///
    ///
    public let byResourceType: Swift.String?
    /// Returns only backup jobs that are in the specified state.
    public let byState: BackupClientTypes.BackupJobState?
...
public struct ListCopyJobsInput: Swift.Equatable {
    ...
    ///
    public let byDestinationVaultArn: Swift.String?
    ...
    public let byState: BackupClientTypes.CopyJobState?
    /// The maximum number of items to be returned.
    public let maxResults: Swift.Int?
    /// The next item following a partial list of returned items. For example, if a request is
...
public struct ListRecoveryPointsByBackupVaultInput: Swift.Equatable {
    ...
    public let byBackupPlanId: Swift.String?
...
public struct ListRestoreJobsInput: Swift.Equatable {
    ...
    public let byStatus: BackupClientTypes.RestoreJobStatus?
    /// The maximum number of items to be returned.
    public let maxResults: Swift.Int?
    /// The next item following a partial list of returned items. For example, if a request is
    ///          made to return maxResults number of items, NextToken allows you
...
extension BackupClientTypes {
    ...
    public struct RecoveryPointByResource: Swift.Equatable {
        /// The size, in bytes, of a backup.
        public let backupSizeBytes: Swift.Int?
        /// The name of a logical container where backups are stored. Backup vaults are identified
        ///          by names that are unique to the account used to create them and the AWS Region where they
        ///          are created. They consist of lowercase letters, numbers, and hyphens.
        public let backupVaultName: Swift.String?
...
extension BackupClientTypes {
    ...
    public struct RecoveryPointCreator: Swift.Equatable {
        ...
        public let backupPlanVersion: Swift.String?
        /// Uniquely identifies a rule used to schedule the backup of a selection of
        ///          resources.
        public let backupRuleId: Swift.String?
...
extension UpdateRegionSettingsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRegionSettingsInput(resourceTypeOptInPreference: \(Swift.String(describing: resourceTypeOptInPreference)))"}
}
