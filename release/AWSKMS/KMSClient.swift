...
extension KMSClient: KMSClientProtocol {
    ...
    public func generateMac(input: GenerateMacInput) async throws -> GenerateMacOutputResponse
    {
        ...
        operation.serializeStep.intercept(position: .after, middleware: ClientRuntime.SerializableBodyMiddleware<GenerateMacInput, GenerateMacOutputResponse>())
    ...
    public func verifyMac(input: VerifyMacInput) async throws -> VerifyMacOutputResponse
    {
        ...
        operation.serializeStep.intercept(position: .after, middleware: ClientRuntime.SerializableBodyMiddleware<VerifyMacInput, VerifyMacOutputResponse>())
