...
public struct ConnectCustomKeyStoreInput: Swift.Equatable {
    ...
    /// This member is required.
    var customKeyStoreId: Swift.String?
...
public struct CreateCustomKeyStoreInput: Swift.Equatable {
    ...
    /// This member is required.
    var keyStorePassword: Swift.String?
    ...
    /// This member is required.
    var trustAnchorCertificate: Swift.String?
...
public struct CreateGrantInput: Swift.Equatable {
    ...
    /// This member is required.
    var operations: [KmsClientTypes.GrantOperation]?
...
public struct CreateGrantOutputResponse: Swift.Equatable {
    ...
    var grantId: Swift.String?
    /// The grant token. Use a grant token when your permission to call this operation comes from a new grant that has not yet achieved eventual consistency. For more information, see [Grant token](https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#grant_token) and [Using a grant token](https://docs.aws.amazon.com/kms/latest/developerguide/grant-manage.html#using-grant-token) in the Key Management Service Developer Guide.
    var grantToken: Swift.String?
...
public struct CreateKeyInput: Swift.Equatable {
    ...
    var customerMasterKeySpec: KmsClientTypes.CustomerMasterKeySpec?
    ...
    var keySpec: KmsClientTypes.KeySpec?
    ...
    var keyUsage: KmsClientTypes.KeyUsageType?
    ...
    var origin: KmsClientTypes.OriginType?
...
public struct CreateKeyOutputResponse: Swift.Equatable {
    ...
    var keyMetadata: KmsClientTypes.KeyMetadata?
...
extension KmsClientTypes {
    ...
    public struct CustomKeyStoresListEntry: Swift.Equatable {
        ...
        var connectionErrorCode: KmsClientTypes.ConnectionErrorCodeType?
        ...
        var connectionState: KmsClientTypes.ConnectionStateType?
...
public struct DecryptInput: Swift.Equatable {
    ...
    /// This member is required.
    var ciphertextBlob: ClientRuntime.Data?
    ...
    var encryptionAlgorithm: KmsClientTypes.EncryptionAlgorithmSpec?
    ...
    var encryptionContext: [Swift.String:Swift.String]?
    /// A list of grant tokens. Use a grant token when your permission to call this operation comes from a new grant that has not yet achieved eventual consistency. For more information, see [Grant token](https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#grant_token) and [Using a grant token](https://docs.aws.amazon.com/kms/latest/developerguide/grant-manage.html#using-grant-token) in the Key Management Service Developer Guide.
    var grantTokens: [Swift.String]?
...
public struct DecryptOutputResponse: Swift.Equatable {
    ...
    var plaintext: ClientRuntime.Data?
...
public struct DescribeCustomKeyStoresOutputResponse: Swift.Equatable {
    ...
    var customKeyStores: [KmsClientTypes.CustomKeyStoresListEntry]?
...
public struct GenerateDataKeyInput: Swift.Equatable {
    ...
    var keySpec: KmsClientTypes.DataKeySpec?
...
public struct GenerateDataKeyPairInput: Swift.Equatable {
    ...
    /// This member is required.
    var keyPairSpec: KmsClientTypes.DataKeyPairSpec?
...
public struct GenerateDataKeyPairOutputResponse: Swift.Equatable {
    ...
    var privateKeyCiphertextBlob: ClientRuntime.Data?
    ...
    var privateKeyPlaintext: ClientRuntime.Data?
    /// The public key (in plaintext).
    var publicKey: ClientRuntime.Data?
...
public struct GetKeyRotationStatusOutputResponse: Swift.Equatable {
    ...
    var keyRotationEnabled: Swift.Bool
...
public struct GetParametersForImportInput: Swift.Equatable {
    ...
    /// This member is required.
    var wrappingAlgorithm: KmsClientTypes.AlgorithmSpec?
    /// The type of wrapping key (public key) to return in the response. Only 2048-bit RSA public keys are supported.
    /// This member is required.
    var wrappingKeySpec: KmsClientTypes.WrappingKeySpec?
...
public struct GetParametersForImportOutputResponse: Swift.Equatable {
    ...
    var importToken: ClientRuntime.Data?
    ...
    var parametersValidTo: ClientRuntime.Date?
...
public struct GetPublicKeyOutputResponse: Swift.Equatable {
    ...
    var encryptionAlgorithms: [KmsClientTypes.EncryptionAlgorithmSpec]?
    ...
    var signingAlgorithms: [KmsClientTypes.SigningAlgorithmSpec]?
...
public struct ImportKeyMaterialInput: Swift.Equatable {
    ...
    /// This member is required.
    var encryptedKeyMaterial: ClientRuntime.Data?
    /// Specifies whether the key material expires. The default is KEY_MATERIAL_EXPIRES, in which case you must include the ValidTo parameter. When this parameter is set to KEY_MATERIAL_DOES_NOT_EXPIRE, you must omit the ValidTo parameter.
    var expirationModel: KmsClientTypes.ExpirationModelType?
    ...
    var validTo: ClientRuntime.Date?
...
extension KmsClientTypes {
    ...
    public struct KeyMetadata: Swift.Equatable {
        ...
        var deletionDate: ClientRuntime.Date?
        ...
        var keyManager: KmsClientTypes.KeyManagerType?
        ...
        var keyState: KmsClientTypes.KeyState?
        ...
        var multiRegionConfiguration: KmsClientTypes.MultiRegionConfiguration?
        ...
        var pendingDeletionWindowInDays: Swift.Int?
...
public struct ListAliasesOutputResponse: Swift.Equatable {
    /// A list of aliases.
    var aliases: [KmsClientTypes.AliasListEntry]?
    /// When Truncated is true, this element is present and contains the value to use for the Marker parameter in a subsequent request.
    var nextMarker: Swift.String?
    /// A flag that indicates whether there are more items in the list. When this value is true, the list in this response is truncated. To get more items, pass the value of the NextMarker element in thisresponse to the Marker parameter in a subsequent request.
    var truncated: Swift.Bool
...
public struct ListGrantsOutputResponse: Swift.Equatable {
    /// A list of grants.
    var grants: [KmsClientTypes.GrantListEntry]?
    /// When Truncated is true, this element is present and contains the value to use for the Marker parameter in a subsequent request.
    var nextMarker: Swift.String?
    /// A flag that indicates whether there are more items in the list. When this value is true, the list in this response is truncated. To get more items, pass the value of the NextMarker element in thisresponse to the Marker parameter in a subsequent request.
    var truncated: Swift.Bool
...
public struct ListKeysOutputResponse: Swift.Equatable {
    /// A list of KMS keys.
    var keys: [KmsClientTypes.KeyListEntry]?
    /// When Truncated is true, this element is present and contains the value to use for the Marker parameter in a subsequent request.
    var nextMarker: Swift.String?
    /// A flag that indicates whether there are more items in the list. When this value is true, the list in this response is truncated. To get more items, pass the value of the NextMarker element in thisresponse to the Marker parameter in a subsequent request.
    var truncated: Swift.Bool
...
extension KmsClientTypes {
    ...
    public struct MultiRegionConfiguration: Swift.Equatable {
        ...
        var multiRegionKeyType: KmsClientTypes.MultiRegionKeyType?
        /// Displays the key ARN and Region of the primary key. This field includes the current KMS key if it is the primary key.
        var primaryKey: KmsClientTypes.MultiRegionKey?
        /// displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.
        var replicaKeys: [KmsClientTypes.MultiRegionKey]?
...
public struct ReEncryptInput: Swift.Equatable {
    ...
    var destinationEncryptionAlgorithm: KmsClientTypes.EncryptionAlgorithmSpec?
    ...
    var destinationEncryptionContext: [Swift.String:Swift.String]?
    ...
    /// To get the key ID and key ARN for a KMS key, use [ListKeys] or [DescribeKey]. To get the alias name and alias ARN, use [ListAliases].
    /// This member is required.
    var destinationKeyId: Swift.String?
    /// A list of grant tokens. Use a grant token when your permission to call this operation comes from a new grant that has not yet achieved eventual consistency. For more information, see [Grant token](https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#grant_token) and [Using a grant token](https://docs.aws.amazon.com/kms/latest/developerguide/grant-manage.html#using-grant-token) in the Key Management Service Developer Guide.
    var grantTokens: [Swift.String]?
    ...
    var sourceEncryptionAlgorithm: KmsClientTypes.EncryptionAlgorithmSpec?
    /// Specifies the encryption context to use to decrypt the ciphertext. Enter the same encryption context that was used to encrypt the ciphertext. An encryption context is a collection of non-secret key-value pairs that represents additional authenticated data. When you use an encryption context to encrypt data, you must specify the same (an exact case-sensitive match) encryption context to decrypt the data. An encryption context is optional when encrypting with a symmetric KMS key, but it is highly recommended. For more information, see [Encryption Context](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context) in the Key Management Service Developer Guide.
    var sourceEncryptionContext: [Swift.String:Swift.String]?
...
public struct ReplicateKeyInput: Swift.Equatable {
    ...
    /// This member is required.
    var replicaRegion: Swift.String?
...
public struct ReplicateKeyOutputResponse: Swift.Equatable {
    ...
    var replicaKeyMetadata: KmsClientTypes.KeyMetadata?
    /// The key policy of the new replica key. The value is a key policy document in JSON format.
    var replicaPolicy: Swift.String?
    /// The tags on the new replica key. The value is a list of tag key and tag value pairs.
    var replicaTags: [KmsClientTypes.Tag]?
...
public struct ScheduleKeyDeletionInput: Swift.Equatable {
    ...
    var pendingWindowInDays: Swift.Int?
...
public struct SignInput: Swift.Equatable {
    ...
    /// This member is required.
    var message: ClientRuntime.Data?
    ...
    var messageType: KmsClientTypes.MessageType?
    ...
    /// This member is required.
    var signingAlgorithm: KmsClientTypes.SigningAlgorithmSpec?
...
public struct SignOutputResponse: Swift.Equatable {
    ...
    var signature: ClientRuntime.Data?
...
public struct UpdateCustomKeyStoreInput: Swift.Equatable {
    ...
    var newCustomKeyStoreName: Swift.String?
