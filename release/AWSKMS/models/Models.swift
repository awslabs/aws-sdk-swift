...
public struct CancelKeyDeletionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelKeyDeletionInputURLHostMiddleware"
    ...
    public typealias MInput = CancelKeyDeletionInput
    public typealias MOutput = ClientRuntime.OperationOutput<CancelKeyDeletionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelKeyDeletionOutputError>
}

public struct CancelKeyDeletionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelKeyDeletionInputURLPathMiddleware"
...
public struct CancelKeyDeletionOutputResponse: Swift.Equatable {
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the KMS key whose deletion is canceled.
    public var keyId: Swift.String?
...
///           use the CloudHSM <a href="https://docs.aws.amazon.com/cloudhsm/latest/APIReference/API_CreateHsm.html">CreateHsm operation.
...
///       detailed instructions, see <a href="https://docs.aws.amazon.com/cloudhsm/latest/userguide/getting-started.html">Getting Started in the CloudHSM User Guide.
...
public struct ConnectCustomKeyStoreInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ConnectCustomKeyStoreInputURLHostMiddleware"
    ...
    public typealias MInput = ConnectCustomKeyStoreInput
    public typealias MOutput = ClientRuntime.OperationOutput<ConnectCustomKeyStoreOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ConnectCustomKeyStoreOutputError>
}

public struct ConnectCustomKeyStoreInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ConnectCustomKeyStoreInputURLPathMiddleware"
...
public struct CreateAliasInput: Swift.Equatable {
    ...
    ///       for <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-managed-cmk">Amazon Web Services managed keys.
    /// This member is required.
    public var aliasName: Swift.String?
    /// Associates the alias with the specified <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk">customer managed key. The KMS key must be
...
public struct CreateCustomKeyStoreInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateCustomKeyStoreInputURLHostMiddleware"
    ...
    public typealias MInput = CreateCustomKeyStoreInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateCustomKeyStoreOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateCustomKeyStoreOutputError>
}

public struct CreateCustomKeyStoreInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateCustomKeyStoreInputURLPathMiddleware"
...
public struct CreateGrantInput: Swift.Equatable {
    ...
    ///          Use a grant token when your permission to call this operation comes from a new grant that has not yet achieved eventual consistency. For more information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#grant_token">Grant token and <a href="https://docs.aws.amazon.com/kms/latest/developerguide/grant-manage.html#using-grant-token">Using a grant token in the
    ///     Key Management Service Developer Guide.
    public var grantTokens: [Swift.String]?
    /// The identity that gets the permissions specified in the grant.
    ///          To specify the principal, use the <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Name (ARN) of an Amazon Web Services principal. Valid Amazon Web Services principals include Amazon Web Services accounts (root), IAM users, IAM roles, federated
    ...
    ///       retire the grant.
    ///          To specify the principal, use the <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Name (ARN) of an Amazon Web Services principal. Valid Amazon Web Services principals include Amazon Web Services accounts (root), IAM users, federated users, and
    ///       assumed role users. For examples of the ARN syntax to use for specifying a principal, see
    ///       <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-iam">Amazon Web Services Identity and Access Management (IAM) in the Example ARNs section of the
    ...
    ///       <a href="https://docs.aws.amazon.com/kms/latest/developerguide/grant-manage.html#grant-delete">Retiring and revoking grants in the Key Management Service Developer Guide.
...
extension CreateKeyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateKeyInput(bypassPolicyLockoutSafetyCheck: \(Swift.String(describing: bypassPolicyLockoutSafetyCheck)), customKeyStoreId: \(Swift.String(describing: customKeyStoreId)), customerMasterKeySpec: \(Swift.String(describing: customerMasterKeySpec)), description: \(Swift.String(describing: description)), keySpec: \(Swift.String(describing: keySpec)), keyUsage: \(Swift.String(describing: keyUsage)), multiRegion: \(Swift.String(describing: multiRegion)), origin: \(Swift.String(describing: origin)), policy: \(Swift.String(describing: policy)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct CreateKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateKeyInputURLHostMiddleware"
    ...
    public typealias MInput = CreateKeyInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateKeyOutputError>
}

public struct CreateKeyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateKeyInputURLPathMiddleware"
...
public struct CreateKeyInput: Swift.Equatable {
    ...
    /// Creates the KMS key in the specified <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store and the key material in its associated
    ...
    ///         asymmetric, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/find-symm-asymm.html">Identifying Symmetric and Asymmetric KMS keys in the Key Management Service Developer
    ///             Guide.
    ///
    ...
    /// Determines the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations">cryptographic operations for which you can use the KMS key. The default value is
    ...
    ///          To create a KMS key in an KMS <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store and create its key material in the associated
    ...
    ///           the KMS key becomes unmanageable. For more information, refer to the scenario in the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default-allow-root-enable-iam">Default Key Policy section of the
    ///                      Key Management Service Developer Guide
    ///                   .
    ///
    ///
    ...
    ///           to KMS. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/troubleshoot_general.html#troubleshoot_general_eventual-consistency">Changes that I make are not always immediately visible in the Amazon Web Services Identity and Access Management User Guide.
    ///
    ///
...
struct CreateKeyInputBody: Swift.Equatable {
    ...
    public let keySpec: KmsClientTypes.KeySpec?
...
extension KmsClientTypes {
    ...
    public struct CustomKeyStoresListEntry: Swift.Equatable {
        ...
        public var customKeyStoreName: Swift.String?
        /// The trust anchor certificate of the associated CloudHSM cluster. When you <a href="https://docs.aws.amazon.com/cloudhsm/latest/userguide/initialize-cluster.html#sign-csr">initialize the
...
public struct DecryptInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DecryptInputURLHostMiddleware"
    ...
    public typealias MInput = DecryptInput
    public typealias MOutput = ClientRuntime.OperationOutput<DecryptOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DecryptOutputError>
}

public struct DecryptInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DecryptInputURLPathMiddleware"
...
public struct DecryptInput: Swift.Equatable {
    ...
    ///       An encryption context is valid only for <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations">cryptographic operations with a symmetric KMS key. The standard asymmetric encryption algorithms that KMS uses do not support an encryption context.
...
public struct DecryptOutputResponse: Swift.Equatable {
    ...
    public var encryptionAlgorithm: KmsClientTypes.EncryptionAlgorithmSpec?
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the KMS key that was used to decrypt the ciphertext.
    public var keyId: Swift.String?
...
public struct DeleteCustomKeyStoreInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteCustomKeyStoreInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteCustomKeyStoreInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteCustomKeyStoreOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteCustomKeyStoreOutputError>
}

public struct DeleteCustomKeyStoreInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteCustomKeyStoreInputURLPathMiddleware"
...
public struct DeleteImportedKeyMaterialInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteImportedKeyMaterialInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteImportedKeyMaterialInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteImportedKeyMaterialOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteImportedKeyMaterialOutputError>
}

public struct DeleteImportedKeyMaterialInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteImportedKeyMaterialInputURLPathMiddleware"
...
public struct DescribeCustomKeyStoresInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeCustomKeyStoresInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeCustomKeyStoresInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeCustomKeyStoresOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeCustomKeyStoresOutputError>
}

public struct DescribeCustomKeyStoresInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeCustomKeyStoresInputURLPathMiddleware"
...
public struct DescribeKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeKeyInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeKeyInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeKeyOutputError>
}

public struct DescribeKeyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeKeyInputURLPathMiddleware"
...
public struct DescribeKeyInput: Swift.Equatable {
    ...
    ///       alias with an <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html##aws-managed-cmk">Amazon Web Services managed key and returns its KeyId and Arn in the
    ///       response.
    ///          To specify a KMS key, use its key ID, key ARN, alias name, or alias ARN. When using an alias name, prefix it with "alias/". To specify a KMS key in a different Amazon Web Services account, you must use the key ARN or alias ARN.
    ///          For example:
    ///
...
public struct DisableKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisableKeyInputURLHostMiddleware"
    ...
    public typealias MInput = DisableKeyInput
    public typealias MOutput = ClientRuntime.OperationOutput<DisableKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisableKeyOutputError>
}

public struct DisableKeyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisableKeyInputURLPathMiddleware"
...
public struct DisableKeyRotationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisableKeyRotationInputURLHostMiddleware"
    ...
    public typealias MInput = DisableKeyRotationInput
    public typealias MOutput = ClientRuntime.OperationOutput<DisableKeyRotationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisableKeyRotationOutputError>
}

public struct DisableKeyRotationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisableKeyRotationInputURLPathMiddleware"
...
public struct DisableKeyRotationInput: Swift.Equatable {
    ...
    ///       rotation of <a href="https://docs.aws.amazon.com/kms/latest/developerguide/symmetric-asymmetric.html#asymmetric-cmks">asymmetric KMS keys, KMS keys
    ///       with <a href="https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys.html">imported key
    ///         material, or KMS keys in a <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store.
    ///          Specify the key ID or key ARN of the KMS key.
    ///          For example:
    ///
    ///
...
public struct DisconnectCustomKeyStoreInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisconnectCustomKeyStoreInputURLHostMiddleware"
    ...
    public typealias MInput = DisconnectCustomKeyStoreInput
    public typealias MOutput = ClientRuntime.OperationOutput<DisconnectCustomKeyStoreOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisconnectCustomKeyStoreOutputError>
}

public struct DisconnectCustomKeyStoreInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisconnectCustomKeyStoreInputURLPathMiddleware"
...
public struct EnableKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "EnableKeyInputURLHostMiddleware"
    ...
    public typealias MInput = EnableKeyInput
    public typealias MOutput = ClientRuntime.OperationOutput<EnableKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<EnableKeyOutputError>
}

public struct EnableKeyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "EnableKeyInputURLPathMiddleware"
...
public struct EnableKeyRotationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "EnableKeyRotationInputURLHostMiddleware"
    ...
    public typealias MInput = EnableKeyRotationInput
    public typealias MOutput = ClientRuntime.OperationOutput<EnableKeyRotationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<EnableKeyRotationOutputError>
}

public struct EnableKeyRotationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "EnableKeyRotationInputURLPathMiddleware"
...
public struct EncryptInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "EncryptInputURLHostMiddleware"
    ...
    public typealias MInput = EncryptInput
    public typealias MOutput = ClientRuntime.OperationOutput<EncryptOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<EncryptOutputError>
}

public struct EncryptInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "EncryptInputURLPathMiddleware"
...
public struct EncryptOutputResponse: Swift.Equatable {
    ...
    public var encryptionAlgorithm: KmsClientTypes.EncryptionAlgorithmSpec?
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the KMS key that was used to encrypt the plaintext.
    public var keyId: Swift.String?
...
public struct GenerateDataKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataKeyInputURLHostMiddleware"
    ...
    public typealias MInput = GenerateDataKeyInput
    public typealias MOutput = ClientRuntime.OperationOutput<GenerateDataKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GenerateDataKeyOutputError>
}

public struct GenerateDataKeyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataKeyInputURLPathMiddleware"
...
public struct GenerateDataKeyOutputResponse: Swift.Equatable {
    ...
    public var ciphertextBlob: ClientRuntime.Data?
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the KMS key that encrypted the data key.
    public var keyId: Swift.String?
...
public struct GenerateDataKeyPairInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataKeyPairInputURLHostMiddleware"
    ...
    public typealias MInput = GenerateDataKeyPairInput
    public typealias MOutput = ClientRuntime.OperationOutput<GenerateDataKeyPairOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GenerateDataKeyPairOutputError>
}

public struct GenerateDataKeyPairInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataKeyPairInputURLPathMiddleware"
...
public struct GenerateDataKeyPairOutputResponse: Swift.Equatable {
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the KMS key that encrypted the private key.
    public var keyId: Swift.String?
...
public struct GenerateDataKeyPairWithoutPlaintextInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataKeyPairWithoutPlaintextInputURLHostMiddleware"
    ...
    public typealias MInput = GenerateDataKeyPairWithoutPlaintextInput
    public typealias MOutput = ClientRuntime.OperationOutput<GenerateDataKeyPairWithoutPlaintextOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GenerateDataKeyPairWithoutPlaintextOutputError>
}

public struct GenerateDataKeyPairWithoutPlaintextInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataKeyPairWithoutPlaintextInputURLPathMiddleware"
...
public struct GenerateDataKeyWithoutPlaintextInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataKeyWithoutPlaintextInputURLHostMiddleware"
    ...
    public typealias MInput = GenerateDataKeyWithoutPlaintextInput
    public typealias MOutput = ClientRuntime.OperationOutput<GenerateDataKeyWithoutPlaintextOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GenerateDataKeyWithoutPlaintextOutputError>
}

public struct GenerateDataKeyWithoutPlaintextInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateDataKeyWithoutPlaintextInputURLPathMiddleware"
...
public struct GenerateRandomInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateRandomInputURLHostMiddleware"
    ...
    public typealias MInput = GenerateRandomInput
    public typealias MOutput = ClientRuntime.OperationOutput<GenerateRandomOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GenerateRandomOutputError>
}

public struct GenerateRandomInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GenerateRandomInputURLPathMiddleware"
...
public struct GetKeyPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetKeyPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = GetKeyPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetKeyPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetKeyPolicyOutputError>
}

public struct GetKeyPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetKeyPolicyInputURLPathMiddleware"
...
public struct GetKeyRotationStatusInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetKeyRotationStatusInputURLHostMiddleware"
    ...
    public typealias MInput = GetKeyRotationStatusInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetKeyRotationStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetKeyRotationStatusOutputError>
}

public struct GetKeyRotationStatusInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetKeyRotationStatusInputURLPathMiddleware"
...
public struct GetParametersForImportInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetParametersForImportInputURLHostMiddleware"
    ...
    public typealias MInput = GetParametersForImportInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetParametersForImportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetParametersForImportOutputError>
}

public struct GetParametersForImportInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetParametersForImportInputURLPathMiddleware"
...
public struct GetParametersForImportOutputResponse: Swift.Equatable {
    ...
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the KMS key to use in a subsequent ImportKeyMaterial
...
extension GetPublicKeyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetPublicKeyOutputResponse(customerMasterKeySpec: \(Swift.String(describing: customerMasterKeySpec)), encryptionAlgorithms: \(Swift.String(describing: encryptionAlgorithms)), keyId: \(Swift.String(describing: keyId)), keySpec: \(Swift.String(describing: keySpec)), keyUsage: \(Swift.String(describing: keyUsage)), publicKey: \(Swift.String(describing: publicKey)), signingAlgorithms: \(Swift.String(describing: signingAlgorithms)))"}
}
...
public struct GetPublicKeyOutputResponse: Swift.Equatable {
    ...
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the asymmetric KMS key from which the public key was downloaded.
    public var keyId: Swift.String?
    ...
    ///         SubjectPublicKeyInfo (SPKI), as defined in <a href="https://tools.ietf.org/html/rfc5280">RFC 5280. When you use the HTTP API or the Amazon Web Services CLI, the value is Base64-encoded. Otherwise, it is not Base64-encoded.
    ///
    public var publicKey: ClientRuntime.Data?
...
extension KmsClientTypes {
    ...
    ///       encryption context, that is, all cryptographic operations with a <a href="https://docs.aws.amazon.com/kms/latest/developerguide/symm-asymm-concepts.html#symmetric-cmks">symmetric KMS key. Grant
...
public struct ImportKeyMaterialInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ImportKeyMaterialInputURLHostMiddleware"
    ...
    public typealias MInput = ImportKeyMaterialInput
    public typealias MOutput = ClientRuntime.OperationOutput<ImportKeyMaterialOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ImportKeyMaterialOutputError>
}

public struct ImportKeyMaterialInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ImportKeyMaterialInputURLPathMiddleware"
...
extension KmsClientTypes.KeyMetadata: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "KeyMetadata(aWSAccountId: \(Swift.String(describing: aWSAccountId)), arn: \(Swift.String(describing: arn)), cloudHsmClusterId: \(Swift.String(describing: cloudHsmClusterId)), creationDate: \(Swift.String(describing: creationDate)), customKeyStoreId: \(Swift.String(describing: customKeyStoreId)), customerMasterKeySpec: \(Swift.String(describing: customerMasterKeySpec)), deletionDate: \(Swift.String(describing: deletionDate)), description: \(Swift.String(describing: description)), enabled: \(Swift.String(describing: enabled)), encryptionAlgorithms: \(Swift.String(describing: encryptionAlgorithms)), expirationModel: \(Swift.String(describing: expirationModel)), keyId: \(Swift.String(describing: keyId)), keyManager: \(Swift.String(describing: keyManager)), keySpec: \(Swift.String(describing: keySpec)), keyState: \(Swift.String(describing: keyState)), keyUsage: \(Swift.String(describing: keyUsage)), multiRegion: \(Swift.String(describing: multiRegion)), multiRegionConfiguration: \(Swift.String(describing: multiRegionConfiguration)), origin: \(Swift.String(describing: origin)), pendingDeletionWindowInDays: \(Swift.String(describing: pendingDeletionWindowInDays)), signingAlgorithms: \(Swift.String(describing: signingAlgorithms)), validTo: \(Swift.String(describing: validTo)))"}
}
...
extension KmsClientTypes {
    ...
    public struct KeyMetadata: Swift.Equatable {
        ...
        /// The Amazon Resource Name (ARN) of the KMS key. For examples, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kms">Key Management Service
        ...
        ///       create a KMS key in a <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store, KMS creates the key material for the KMS key in the
        ///       associated CloudHSM cluster. This value is present only when the KMS key is created in a custom key
        ///       store.
        public var cloudHsmClusterId: Swift.String?
        /// The date and time when the KMS key was created.
        public var creationDate: ClientRuntime.Date?
        /// A unique identifier for the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html">custom key store that contains the KMS key. This value is present
        ...
        /// This member is required.
        public var keyId: Swift.String?
        /// The manager of the KMS key. KMS keys in your Amazon Web Services account are either customer managed or Amazon Web Services managed. For more information about the difference, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#kms_keys">KMS keys in the
        ///       Key Management Service Developer Guide.
        public var keyManager: KmsClientTypes.KeyManagerType?
        /// Describes the type of key material in the KMS key.
        public var keySpec: KmsClientTypes.KeySpec?
        /// The current status of the KMS key.
        ///          For more information about how key state affects the use of a KMS key, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key state: Effect on your KMS key
        ///       in the Key Management Service Developer Guide.
        public var keyState: KmsClientTypes.KeyState?
        /// The <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations">cryptographic operations for which you can use the KMS key.
        public var keyUsage: KmsClientTypes.KeyUsageType?
        ...
        ///          For more information about multi-Region keys, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-overview.html">Using multi-Region keys in the Key Management Service Developer Guide.
        public var multiRegion: Swift.Bool?
...
public struct ListGrantsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListGrantsInputURLHostMiddleware"
    ...
    public typealias MInput = ListGrantsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListGrantsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListGrantsOutputError>
}

public struct ListGrantsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListGrantsInputURLPathMiddleware"
...
public struct ListKeyPoliciesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListKeyPoliciesInputURLHostMiddleware"
    ...
    public typealias MInput = ListKeyPoliciesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListKeyPoliciesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListKeyPoliciesOutputError>
}

public struct ListKeyPoliciesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListKeyPoliciesInputURLPathMiddleware"
...
public struct ListKeysInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListKeysInputURLHostMiddleware"
    ...
    public typealias MInput = ListKeysInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListKeysOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListKeysOutputError>
}

public struct ListKeysInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListKeysInputURLPathMiddleware"
...
public struct ListResourceTagsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListResourceTagsInputURLHostMiddleware"
    ...
    public typealias MInput = ListResourceTagsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListResourceTagsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListResourceTagsOutputError>
}

public struct ListResourceTagsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListResourceTagsInputURLPathMiddleware"
...
public struct ListRetirableGrantsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRetirableGrantsInputURLHostMiddleware"
    ...
    public typealias MInput = ListRetirableGrantsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListRetirableGrantsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRetirableGrantsOutputError>
}

public struct ListRetirableGrantsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRetirableGrantsInputURLPathMiddleware"
...
public struct ListRetirableGrantsInput: Swift.Equatable {
    ...
    ///          To specify the retiring principal, use the <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Name (ARN) of an Amazon Web Services principal. Valid Amazon Web Services principals include Amazon Web Services accounts (root), IAM users, federated users, and
    ///       assumed role users. For examples of the ARN syntax for specifying a principal, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-iam">Amazon Web Services Identity and Access Management (IAM) in the Example ARNs section of the
    ///       Amazon Web Services General Reference.
    /// This member is required.
    public var retiringPrincipal: Swift.String?
...
public struct PutKeyPolicyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutKeyPolicyInputURLHostMiddleware"
    ...
    public typealias MInput = PutKeyPolicyInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutKeyPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutKeyPolicyOutputError>
}

public struct PutKeyPolicyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutKeyPolicyInputURLPathMiddleware"
...
public struct PutKeyPolicyInput: Swift.Equatable {
    ...
    ///             Setting this value to true increases the risk that the KMS key becomes unmanageable. Do not
    ///         set this value to true indiscriminately.
    ///             For more information, refer to the scenario in the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default-allow-root-enable-iam">Default Key Policy section in the Key Management Service Developer Guide.
    ///
    ...
    ///           subsequent PutKeyPolicy request on the KMS key. This reduces the risk that the KMS key becomes unmanageable. For more information, refer to the scenario in the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default-allow-root-enable-iam">Default Key Policy section of the Key Management Service Developer Guide.
    ///
    ///
    ///                Each statement in the key policy must contain one or more principals. The principals
    ///           in the key policy must exist and be visible to KMS. When you create a new Amazon Web Services principal
...
public struct ReEncryptInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReEncryptInputURLHostMiddleware"
    ...
    public typealias MInput = ReEncryptInput
    public typealias MOutput = ClientRuntime.OperationOutput<ReEncryptOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ReEncryptOutputError>
}

public struct ReEncryptInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReEncryptInputURLPathMiddleware"
...
public struct ReEncryptOutputResponse: Swift.Equatable {
    ...
    public var destinationEncryptionAlgorithm: KmsClientTypes.EncryptionAlgorithmSpec?
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the KMS key that was used to reencrypt the data.
    public var keyId: Swift.String?
...
public struct ReplicateKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReplicateKeyInputURLHostMiddleware"
    ...
    public typealias MInput = ReplicateKeyInput
    public typealias MOutput = ClientRuntime.OperationOutput<ReplicateKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ReplicateKeyOutputError>
}

public struct ReplicateKeyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ReplicateKeyInputURLPathMiddleware"
...
public struct ReplicateKeyInput: Swift.Equatable {
    ...
    /// This member is required.
    public var keyId: Swift.String?
    /// The key policy to attach to the KMS key. This parameter is optional. If you do not provide a key policy, KMS attaches the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default">default key policy to the KMS key.
    ...
    ///           (for example, an IAM user or role), you might need to enforce a delay before including the
    ///           new principal in a key policy because the new principal might not be immediately visible
    ///           to KMS. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/troubleshoot_general.html#troubleshoot_general_eventual-consistency">Changes that I make are not always immediately visible in the
    ///                      Identity and Access Management User Guide
    ///                   .
    ///
    ///
    ...
    ///       list of Amazon Web Services Regions in which KMS is supported, see <a href="https://docs.aws.amazon.com/general/latest/gr/kms.html#kms_region">KMS service endpoints in the
    ///       Amazon Web Services General Reference.
    ...
    ///       Region.
    ///          For information about Amazon Web Services partitions, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs) in the
...
public struct ReplicateKeyOutputResponse: Swift.Equatable {
    /// Displays details about the new replica key, including its Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key
    ///       ARN) and <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">key state. It also includes the ARN and Amazon Web Services Region of its primary key and other
    ///       replica keys.
...
public struct RetireGrantInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RetireGrantInputURLHostMiddleware"
    ...
    public typealias MInput = RetireGrantInput
    public typealias MOutput = ClientRuntime.OperationOutput<RetireGrantOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RetireGrantOutputError>
}

public struct RetireGrantInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RetireGrantInputURLPathMiddleware"
...
public struct RetireGrantInput: Swift.Equatable {
    ...
    ///       and <a href="https://docs.aws.amazon.com/kms/latest/developerguide/grants.html#terms-eventual-consistency">Eventual consistency in the Key Management Service Developer Guide.
    public var grantToken: Swift.String?
...
public struct RevokeGrantInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RevokeGrantInputURLHostMiddleware"
    ...
    public typealias MInput = RevokeGrantInput
    public typealias MOutput = ClientRuntime.OperationOutput<RevokeGrantOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RevokeGrantOutputError>
}

public struct RevokeGrantInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RevokeGrantInputURLPathMiddleware"
...
public struct ScheduleKeyDeletionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ScheduleKeyDeletionInputURLHostMiddleware"
    ...
    public typealias MInput = ScheduleKeyDeletionInput
    public typealias MOutput = ClientRuntime.OperationOutput<ScheduleKeyDeletionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ScheduleKeyDeletionOutputError>
}

public struct ScheduleKeyDeletionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ScheduleKeyDeletionInputURLPathMiddleware"
...
public struct ScheduleKeyDeletionOutputResponse: Swift.Equatable {
    ...
    ///       deleted.
    public var deletionDate: ClientRuntime.Date?
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the KMS key whose deletion is scheduled.
    public var keyId: Swift.String?
    /// The current status of the KMS key.
    ///          For more information about how key state affects the use of a KMS key, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key state: Effect on your KMS key
    ///       in the Key Management Service Developer Guide.
...
public struct SignInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SignInputURLHostMiddleware"
    ...
    public typealias MInput = SignInput
    public typealias MOutput = ClientRuntime.OperationOutput<SignOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SignOutputError>
}

public struct SignInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SignInputURLPathMiddleware"
...
public struct SignOutputResponse: Swift.Equatable {
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the asymmetric KMS key that was used to sign the message.
    public var keyId: Swift.String?
...
extension KmsClientTypes {
    ...
    ///          For information about the rules that apply to tag keys and tag values, see <a href="https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/allocation-tag-restrictions.html">User-Defined Tag Restrictions in the Amazon Web Services Billing and Cost Management User
    ///         Guide.
...
public struct UpdateAliasInput: Swift.Equatable {
    ...
    /// This member is required.
    public var aliasName: Swift.String?
    /// Identifies the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk">customer managed key to associate with the alias. You don't have permission
    ///       to associate an alias with an <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-managed-cmk">Amazon Web Services managed key.
...
public struct UpdateCustomKeyStoreInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateCustomKeyStoreInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateCustomKeyStoreInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateCustomKeyStoreOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateCustomKeyStoreOutputError>
}

public struct UpdateCustomKeyStoreInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateCustomKeyStoreInputURLPathMiddleware"
...
public struct UpdateKeyDescriptionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateKeyDescriptionInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateKeyDescriptionInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateKeyDescriptionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateKeyDescriptionOutputError>
}

public struct UpdateKeyDescriptionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateKeyDescriptionInputURLPathMiddleware"
...
public struct UpdatePrimaryRegionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePrimaryRegionInputURLHostMiddleware"
    ...
    public typealias MInput = UpdatePrimaryRegionInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdatePrimaryRegionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdatePrimaryRegionOutputError>
}

public struct UpdatePrimaryRegionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePrimaryRegionInputURLPathMiddleware"
...
public struct VerifyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "VerifyInputURLHostMiddleware"
    ...
    public typealias MInput = VerifyInput
    public typealias MOutput = ClientRuntime.OperationOutput<VerifyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<VerifyOutputError>
}

public struct VerifyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "VerifyInputURLPathMiddleware"
...
public struct VerifyOutputResponse: Swift.Equatable {
    /// The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN) of the asymmetric KMS key that was used to verify the signature.
    public var keyId: Swift.String?
