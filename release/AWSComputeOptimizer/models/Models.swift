...
extension ComputeOptimizerClientTypes.AccountEnrollmentStatus: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountId
...
extension ComputeOptimizerClientTypes.AccountEnrollmentStatus: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AccountEnrollmentStatus(accountId: \(Swift.String(describing: accountId)), lastUpdatedTimestamp: \(Swift.String(describing: lastUpdatedTimestamp)), status: \(Swift.String(describing: status)), statusReason: \(Swift.String(describing: statusReason)))"}
}
...
extension ComputeOptimizerClientTypes.AutoScalingGroupRecommendationOption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AutoScalingGroupRecommendationOption(configuration: \(Swift.String(describing: configuration)), performanceRisk: \(Swift.String(describing: performanceRisk)), projectedUtilizationMetrics: \(Swift.String(describing: projectedUtilizationMetrics)), rank: \(Swift.String(describing: rank)), savingsOpportunity: \(Swift.String(describing: savingsOpportunity)))"}
}
...
extension ComputeOptimizerClientTypes.CurrentPerformanceRiskRatings: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case high
        case low
        case medium
...
extension ComputeOptimizerClientTypes.CurrentPerformanceRiskRatings: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CurrentPerformanceRiskRatings(high: \(Swift.String(describing: high)), low: \(Swift.String(describing: low)), medium: \(Swift.String(describing: medium)), veryLow: \(Swift.String(describing: veryLow)))"}
}
...
public struct DeleteRecommendationPreferencesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecommendationPreferencesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteRecommendationPreferencesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteRecommendationPreferencesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteRecommendationPreferencesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteRecommendationPreferencesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteRecommendationPreferencesOutputError>
}

extension DeleteRecommendationPreferencesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteRecommendationPreferencesInput(recommendationPreferenceNames: \(Swift.String(describing: recommendationPreferenceNames)), resourceType: \(Swift.String(describing: resourceType)), scope: \(Swift.String(describing: scope)))"}
}

extension DeleteRecommendationPreferencesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DeleteRecommendationPreferencesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecommendationPreferencesInputHeadersMiddleware"
...
public struct DeleteRecommendationPreferencesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecommendationPreferencesInputQueryItemMiddleware"
...
public struct DeleteRecommendationPreferencesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecommendationPreferencesInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteRecommendationPreferencesInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteRecommendationPreferencesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteRecommendationPreferencesOutputError>
}

public struct DeleteRecommendationPreferencesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecommendationPreferencesInputURLPathMiddleware"
...
struct DeleteRecommendationPreferencesInputBody: Swift.Equatable {
    ...
    public let scope: ComputeOptimizerClientTypes.Scope?
    public let recommendationPreferenceNames: [ComputeOptimizerClientTypes.RecommendationPreferenceName]?
}
...
extension DeleteRecommendationPreferencesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteRecommendationPreferencesOutputResponse()"}
}
...
struct DeleteRecommendationPreferencesOutputResponseBody: Swift.Equatable {
}

extension DeleteRecommendationPreferencesOutputResponseBody: Swift.Decodable {
...
public struct DescribeRecommendationExportJobsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRecommendationExportJobsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeRecommendationExportJobsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeRecommendationExportJobsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeRecommendationExportJobsOutputError>
}

public struct DescribeRecommendationExportJobsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRecommendationExportJobsInputURLPathMiddleware"
...
extension ComputeOptimizerClientTypes.EffectiveRecommendationPreferences: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ComputeOptimizerClientTypes.EffectiveRecommendationPreferences: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EffectiveRecommendationPreferences(cpuVendorArchitectures: \(Swift.String(describing: cpuVendorArchitectures)), enhancedInfrastructureMetrics: \(Swift.String(describing: enhancedInfrastructureMetrics)))"}
}
...
extension ComputeOptimizerClientTypes.EnrollmentFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name
        case values
    }
...
extension ComputeOptimizerClientTypes.EnrollmentFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EnrollmentFilter(name: \(Swift.String(describing: name)), values: \(Swift.String(describing: values)))"}
}
...
extension ComputeOptimizerClientTypes.EstimatedMonthlySavings: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case currency
        case value
    }
...
extension ComputeOptimizerClientTypes.EstimatedMonthlySavings: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EstimatedMonthlySavings(currency: \(Swift.String(describing: currency)), value: \(Swift.String(describing: value)))"}
}
...
public struct ExportAutoScalingGroupRecommendationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportAutoScalingGroupRecommendationsInputURLHostMiddleware"
    ...
    public typealias MInput = ExportAutoScalingGroupRecommendationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ExportAutoScalingGroupRecommendationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExportAutoScalingGroupRecommendationsOutputError>
}

public struct ExportAutoScalingGroupRecommendationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportAutoScalingGroupRecommendationsInputURLPathMiddleware"
...
struct ExportAutoScalingGroupRecommendationsInputBody: Swift.Equatable {
    ...
    public let recommendationPreferences: ComputeOptimizerClientTypes.RecommendationPreferences?
}
...
public struct ExportEBSVolumeRecommendationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportEBSVolumeRecommendationsInputURLHostMiddleware"
    ...
    public typealias MInput = ExportEBSVolumeRecommendationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ExportEBSVolumeRecommendationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExportEBSVolumeRecommendationsOutputError>
}

public struct ExportEBSVolumeRecommendationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportEBSVolumeRecommendationsInputURLPathMiddleware"
...
public struct ExportEC2InstanceRecommendationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportEC2InstanceRecommendationsInputURLHostMiddleware"
    ...
    public typealias MInput = ExportEC2InstanceRecommendationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ExportEC2InstanceRecommendationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExportEC2InstanceRecommendationsOutputError>
}

public struct ExportEC2InstanceRecommendationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportEC2InstanceRecommendationsInputURLPathMiddleware"
...
public struct ExportLambdaFunctionRecommendationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportLambdaFunctionRecommendationsInputURLHostMiddleware"
    ...
    public typealias MInput = ExportLambdaFunctionRecommendationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ExportLambdaFunctionRecommendationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExportLambdaFunctionRecommendationsOutputError>
}

public struct ExportLambdaFunctionRecommendationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportLambdaFunctionRecommendationsInputURLPathMiddleware"
...
extension GetAutoScalingGroupRecommendationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAutoScalingGroupRecommendationsInput(accountIds: \(Swift.String(describing: accountIds)), autoScalingGroupArns: \(Swift.String(describing: autoScalingGroupArns)), filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), recommendationPreferences: \(Swift.String(describing: recommendationPreferences)))"}
}
...
public struct GetAutoScalingGroupRecommendationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAutoScalingGroupRecommendationsInputURLHostMiddleware"
    ...
    public typealias MInput = GetAutoScalingGroupRecommendationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAutoScalingGroupRecommendationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAutoScalingGroupRecommendationsOutputError>
}

public struct GetAutoScalingGroupRecommendationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAutoScalingGroupRecommendationsInputURLPathMiddleware"
...
public struct GetEBSVolumeRecommendationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEBSVolumeRecommendationsInputURLHostMiddleware"
    ...
    public typealias MInput = GetEBSVolumeRecommendationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetEBSVolumeRecommendationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetEBSVolumeRecommendationsOutputError>
}

public struct GetEBSVolumeRecommendationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEBSVolumeRecommendationsInputURLPathMiddleware"
...
extension GetEC2InstanceRecommendationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetEC2InstanceRecommendationsInput(accountIds: \(Swift.String(describing: accountIds)), filters: \(Swift.String(describing: filters)), instanceArns: \(Swift.String(describing: instanceArns)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), recommendationPreferences: \(Swift.String(describing: recommendationPreferences)))"}
}
...
public struct GetEC2InstanceRecommendationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEC2InstanceRecommendationsInputURLHostMiddleware"
    ...
    public typealias MInput = GetEC2InstanceRecommendationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetEC2InstanceRecommendationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetEC2InstanceRecommendationsOutputError>
}

public struct GetEC2InstanceRecommendationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEC2InstanceRecommendationsInputURLPathMiddleware"
...
extension GetEC2RecommendationProjectedMetricsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetEC2RecommendationProjectedMetricsInput(endTime: \(Swift.String(describing: endTime)), instanceArn: \(Swift.String(describing: instanceArn)), period: \(Swift.String(describing: period)), recommendationPreferences: \(Swift.String(describing: recommendationPreferences)), startTime: \(Swift.String(describing: startTime)), stat: \(Swift.String(describing: stat)))"}
}
...
public struct GetEC2RecommendationProjectedMetricsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEC2RecommendationProjectedMetricsInputURLHostMiddleware"
    ...
    public typealias MInput = GetEC2RecommendationProjectedMetricsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetEC2RecommendationProjectedMetricsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetEC2RecommendationProjectedMetricsOutputError>
}

public struct GetEC2RecommendationProjectedMetricsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEC2RecommendationProjectedMetricsInputURLPathMiddleware"
...
public struct GetEffectiveRecommendationPreferencesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEffectiveRecommendationPreferencesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetEffectiveRecommendationPreferencesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetEffectiveRecommendationPreferencesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetEffectiveRecommendationPreferencesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetEffectiveRecommendationPreferencesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetEffectiveRecommendationPreferencesOutputError>
}

extension GetEffectiveRecommendationPreferencesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetEffectiveRecommendationPreferencesInput(resourceArn: \(Swift.String(describing: resourceArn)))"}
}

extension GetEffectiveRecommendationPreferencesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case resourceArn
    }
...
public struct GetEffectiveRecommendationPreferencesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEffectiveRecommendationPreferencesInputHeadersMiddleware"
...
public struct GetEffectiveRecommendationPreferencesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEffectiveRecommendationPreferencesInputQueryItemMiddleware"
...
public struct GetEffectiveRecommendationPreferencesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEffectiveRecommendationPreferencesInputURLHostMiddleware"
    ...
    public typealias MInput = GetEffectiveRecommendationPreferencesInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetEffectiveRecommendationPreferencesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetEffectiveRecommendationPreferencesOutputError>
}

public struct GetEffectiveRecommendationPreferencesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEffectiveRecommendationPreferencesInputURLPathMiddleware"
...
extension GetEffectiveRecommendationPreferencesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetEffectiveRecommendationPreferencesOutputResponse(enhancedInfrastructureMetrics: \(Swift.String(describing: enhancedInfrastructureMetrics)))"}
}
...
struct GetEffectiveRecommendationPreferencesOutputResponseBody: Swift.Equatable {
    public let enhancedInfrastructureMetrics: ComputeOptimizerClientTypes.EnhancedInfrastructureMetrics?
}
...
public struct GetEnrollmentStatusInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEnrollmentStatusInputURLHostMiddleware"
    ...
    public typealias MInput = GetEnrollmentStatusInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetEnrollmentStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetEnrollmentStatusOutputError>
}

public struct GetEnrollmentStatusInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEnrollmentStatusInputURLPathMiddleware"
...
extension GetEnrollmentStatusOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetEnrollmentStatusOutputResponse(lastUpdatedTimestamp: \(Swift.String(describing: lastUpdatedTimestamp)), memberAccountsEnrolled: \(Swift.String(describing: memberAccountsEnrolled)), numberOfMemberAccountsOptedIn: \(Swift.String(describing: numberOfMemberAccountsOptedIn)), status: \(Swift.String(describing: status)), statusReason: \(Swift.String(describing: statusReason)))"}
}
...
struct GetEnrollmentStatusOutputResponseBody: Swift.Equatable {
    ...
    public let numberOfMemberAccountsOptedIn: Swift.Int?
}
...
public struct GetEnrollmentStatusesForOrganizationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEnrollmentStatusesForOrganizationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetEnrollmentStatusesForOrganizationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetEnrollmentStatusesForOrganizationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetEnrollmentStatusesForOrganizationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetEnrollmentStatusesForOrganizationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetEnrollmentStatusesForOrganizationOutputError>
}

extension GetEnrollmentStatusesForOrganizationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetEnrollmentStatusesForOrganizationInput(filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension GetEnrollmentStatusesForOrganizationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filters
        case maxResults
        case nextToken
...
public struct GetEnrollmentStatusesForOrganizationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEnrollmentStatusesForOrganizationInputHeadersMiddleware"
...
public struct GetEnrollmentStatusesForOrganizationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEnrollmentStatusesForOrganizationInputQueryItemMiddleware"
...
public struct GetEnrollmentStatusesForOrganizationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEnrollmentStatusesForOrganizationInputURLHostMiddleware"
    ...
    public typealias MInput = GetEnrollmentStatusesForOrganizationInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetEnrollmentStatusesForOrganizationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetEnrollmentStatusesForOrganizationOutputError>
}

public struct GetEnrollmentStatusesForOrganizationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEnrollmentStatusesForOrganizationInputURLPathMiddleware"
...
struct GetEnrollmentStatusesForOrganizationInputBody: Swift.Equatable {
    public let filters: [ComputeOptimizerClientTypes.EnrollmentFilter]?
    public let nextToken: Swift.String?
    public let maxResults: Swift.Int?
}
...
extension GetEnrollmentStatusesForOrganizationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetEnrollmentStatusesForOrganizationOutputResponse(accountEnrollmentStatuses: \(Swift.String(describing: accountEnrollmentStatuses)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct GetEnrollmentStatusesForOrganizationOutputResponseBody: Swift.Equatable {
    public let accountEnrollmentStatuses: [ComputeOptimizerClientTypes.AccountEnrollmentStatus]?
    public let nextToken: Swift.String?
}
...
public struct GetLambdaFunctionRecommendationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetLambdaFunctionRecommendationsInputURLHostMiddleware"
    ...
    public typealias MInput = GetLambdaFunctionRecommendationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetLambdaFunctionRecommendationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetLambdaFunctionRecommendationsOutputError>
}

public struct GetLambdaFunctionRecommendationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetLambdaFunctionRecommendationsInputURLPathMiddleware"
...
public struct GetRecommendationPreferencesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRecommendationPreferencesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetRecommendationPreferencesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetRecommendationPreferencesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetRecommendationPreferencesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetRecommendationPreferencesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRecommendationPreferencesOutputError>
}

extension GetRecommendationPreferencesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRecommendationPreferencesInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), resourceType: \(Swift.String(describing: resourceType)), scope: \(Swift.String(describing: scope)))"}
}

extension GetRecommendationPreferencesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case maxResults
        case nextToken
        case resourceType
...
public struct GetRecommendationPreferencesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRecommendationPreferencesInputHeadersMiddleware"
...
public struct GetRecommendationPreferencesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRecommendationPreferencesInputQueryItemMiddleware"
...
public struct GetRecommendationPreferencesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRecommendationPreferencesInputURLHostMiddleware"
    ...
    public typealias MInput = GetRecommendationPreferencesInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetRecommendationPreferencesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRecommendationPreferencesOutputError>
}

public struct GetRecommendationPreferencesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRecommendationPreferencesInputURLPathMiddleware"
...
extension GetRecommendationPreferencesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRecommendationPreferencesOutputResponse(nextToken: \(Swift.String(describing: nextToken)), recommendationPreferencesDetails: \(Swift.String(describing: recommendationPreferencesDetails)))"}
}
...
struct GetRecommendationPreferencesOutputResponseBody: Swift.Equatable {
    public let nextToken: Swift.String?
    public let recommendationPreferencesDetails: [ComputeOptimizerClientTypes.RecommendationPreferencesDetail]?
}
...
public struct GetRecommendationSummariesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRecommendationSummariesInputURLHostMiddleware"
    ...
    public typealias MInput = GetRecommendationSummariesInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetRecommendationSummariesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRecommendationSummariesOutputError>
}

public struct GetRecommendationSummariesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRecommendationSummariesInputURLPathMiddleware"
...
extension ComputeOptimizerClientTypes.InstanceRecommendationOption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InstanceRecommendationOption(instanceType: \(Swift.String(describing: instanceType)), performanceRisk: \(Swift.String(describing: performanceRisk)), platformDifferences: \(Swift.String(describing: platformDifferences)), projectedUtilizationMetrics: \(Swift.String(describing: projectedUtilizationMetrics)), rank: \(Swift.String(describing: rank)), savingsOpportunity: \(Swift.String(describing: savingsOpportunity)))"}
}
...
extension ComputeOptimizerClientTypes.LambdaFunctionMemoryRecommendationOption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LambdaFunctionMemoryRecommendationOption(memorySize: \(Swift.String(describing: memorySize)), projectedUtilizationMetrics: \(Swift.String(describing: projectedUtilizationMetrics)), rank: \(Swift.String(describing: rank)), savingsOpportunity: \(Swift.String(describing: savingsOpportunity)))"}
}
...
public struct PutRecommendationPreferencesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRecommendationPreferencesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutRecommendationPreferencesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutRecommendationPreferencesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutRecommendationPreferencesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutRecommendationPreferencesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutRecommendationPreferencesOutputError>
}

extension PutRecommendationPreferencesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutRecommendationPreferencesInput(enhancedInfrastructureMetrics: \(Swift.String(describing: enhancedInfrastructureMetrics)), resourceType: \(Swift.String(describing: resourceType)), scope: \(Swift.String(describing: scope)))"}
}

extension PutRecommendationPreferencesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case enhancedInfrastructureMetrics
        case resourceType
        case scope
...
public struct PutRecommendationPreferencesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRecommendationPreferencesInputHeadersMiddleware"
...
public struct PutRecommendationPreferencesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRecommendationPreferencesInputQueryItemMiddleware"
...
public struct PutRecommendationPreferencesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRecommendationPreferencesInputURLHostMiddleware"
    ...
    public typealias MInput = PutRecommendationPreferencesInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutRecommendationPreferencesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutRecommendationPreferencesOutputError>
}

public struct PutRecommendationPreferencesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRecommendationPreferencesInputURLPathMiddleware"
...
extension PutRecommendationPreferencesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutRecommendationPreferencesOutputResponse()"}
}
...
struct PutRecommendationPreferencesOutputResponseBody: Swift.Equatable {
}

extension PutRecommendationPreferencesOutputResponseBody: Swift.Decodable {
...
extension ComputeOptimizerClientTypes.RecommendationPreferences: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cpuVendorArchitectures
    }
...
extension ComputeOptimizerClientTypes.RecommendationPreferences: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RecommendationPreferences(cpuVendorArchitectures: \(Swift.String(describing: cpuVendorArchitectures)))"}
}
...
extension ComputeOptimizerClientTypes.RecommendationPreferencesDetail: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case enhancedInfrastructureMetrics
        case resourceType
        case scope
...
extension ComputeOptimizerClientTypes.RecommendationPreferencesDetail: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RecommendationPreferencesDetail(enhancedInfrastructureMetrics: \(Swift.String(describing: enhancedInfrastructureMetrics)), resourceType: \(Swift.String(describing: resourceType)), scope: \(Swift.String(describing: scope)))"}
}
...
extension ComputeOptimizerClientTypes.RecommendationSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RecommendationSummary(accountId: \(Swift.String(describing: accountId)), currentPerformanceRiskRatings: \(Swift.String(describing: currentPerformanceRiskRatings)), recommendationResourceType: \(Swift.String(describing: recommendationResourceType)), savingsOpportunity: \(Swift.String(describing: savingsOpportunity)), summaries: \(Swift.String(describing: summaries)))"}
}
...
extension ComputeOptimizerClientTypes.SavingsOpportunity: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ComputeOptimizerClientTypes.SavingsOpportunity: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SavingsOpportunity(estimatedMonthlySavings: \(Swift.String(describing: estimatedMonthlySavings)), savingsOpportunityPercentage: \(Swift.String(describing: savingsOpportunityPercentage)))"}
}
...
extension ComputeOptimizerClientTypes.Scope: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name
        case value
    }
...
extension ComputeOptimizerClientTypes.Scope: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Scope(name: \(Swift.String(describing: name)), value: \(Swift.String(describing: value)))"}
}
...
public struct UpdateEnrollmentStatusInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateEnrollmentStatusInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateEnrollmentStatusInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateEnrollmentStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateEnrollmentStatusOutputError>
}

public struct UpdateEnrollmentStatusInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateEnrollmentStatusInputURLPathMiddleware"
...
extension ComputeOptimizerClientTypes.VolumeRecommendationOption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "VolumeRecommendationOption(configuration: \(Swift.String(describing: configuration)), performanceRisk: \(Swift.String(describing: performanceRisk)), rank: \(Swift.String(describing: rank)), savingsOpportunity: \(Swift.String(describing: savingsOpportunity)))"}
}
