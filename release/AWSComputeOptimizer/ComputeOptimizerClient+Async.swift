...
public extension ComputeOptimizerClient {
    ...
    {
        typealias deleteRecommendationPreferencesContinuation = CheckedContinuation<DeleteRecommendationPreferencesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteRecommendationPreferencesContinuation) in
            deleteRecommendationPreferences(input: input) { result in
                switch result {
    ...
    {
        typealias getEffectiveRecommendationPreferencesContinuation = CheckedContinuation<GetEffectiveRecommendationPreferencesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getEffectiveRecommendationPreferencesContinuation) in
            getEffectiveRecommendationPreferences(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getRecommendationPreferencesContinuation = CheckedContinuation<GetRecommendationPreferencesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getRecommendationPreferencesContinuation) in
            getRecommendationPreferences(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putRecommendationPreferencesContinuation = CheckedContinuation<PutRecommendationPreferencesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putRecommendationPreferencesContinuation) in
            putRecommendationPreferences(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
