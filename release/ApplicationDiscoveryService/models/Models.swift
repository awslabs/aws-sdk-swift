...
extension ApplicationDiscoveryClientTypes {
    ...
    ///       for export using the <a href="http://docs.aws.amazon.com/application-discovery/latest/APIReference/API_StartExportTask.html">StartExportTask action.
    public struct ExportFilter: Swift.Equatable {
        ...
        ///       found using the <a href="http://docs.aws.amazon.com/application-discovery/latest/APIReference/API_DescribeExportTasks.html">DescribeAgents action. Typically an ADS agentId is in the form
        ///         o-0123456789abcdef0.
        /// This member is required.
