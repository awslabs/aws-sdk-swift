...
extension ApplicationDiscoveryClientTypes.AgentConfigurationStatus: Swift.Codable, ClientRuntime.Reflection {
...
extension ApplicationDiscoveryClientTypes.AgentConfigurationStatus: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AgentConfigurationStatus(agentId: \(Swift.String(describing: agentId)), description: \(Swift.String(describing: description)), operationSucceeded: \(Swift.String(describing: operationSucceeded)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct AgentConfigurationStatus: Swift.Equatable {
        ...
        ///     </p>
        public let operationSucceeded: Swift.Bool
...
extension ApplicationDiscoveryClientTypes.AgentInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case agentId
...
extension ApplicationDiscoveryClientTypes.AgentInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AgentInfo(agentId: \(Swift.String(describing: agentId)), agentNetworkInfoList: \(Swift.String(describing: agentNetworkInfoList)), agentType: \(Swift.String(describing: agentType)), collectionStatus: \(Swift.String(describing: collectionStatus)), connectorId: \(Swift.String(describing: connectorId)), health: \(Swift.String(describing: health)), hostName: \(Swift.String(describing: hostName)), lastHealthPingTime: \(Swift.String(describing: lastHealthPingTime)), registeredTime: \(Swift.String(describing: registeredTime)), version: \(Swift.String(describing: version)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct AgentInfo: Swift.Equatable {
        ...
        public let agentNetworkInfoList: [ApplicationDiscoveryClientTypes.AgentNetworkInfo]?
        /// <p>Type of agent.</p>
        public let agentType: Swift.String?
        /// <p>Status of the collection process for an agent or connector.</p>
        public let collectionStatus: Swift.String?
        /// <p>The ID of the connector.</p>
        public let connectorId: Swift.String?
        /// <p>The health of the agent or connector.</p>
        public let health: ApplicationDiscoveryClientTypes.AgentStatus?
        ...
        public let lastHealthPingTime: Swift.String?
        /// <p>Agent's first registration timestamp in UTC.</p>
        public let registeredTime: Swift.String?
...
extension ApplicationDiscoveryClientTypes.AgentNetworkInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case ipAddress
        case macAddress
    }
...
extension ApplicationDiscoveryClientTypes.AgentNetworkInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AgentNetworkInfo(ipAddress: \(Swift.String(describing: ipAddress)), macAddress: \(Swift.String(describing: macAddress)))"}
}
...
public struct AssociateConfigurationItemsToApplicationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateConfigurationItemsToApplicationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<AssociateConfigurationItemsToApplicationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<AssociateConfigurationItemsToApplicationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<AssociateConfigurationItemsToApplicationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<AssociateConfigurationItemsToApplicationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AssociateConfigurationItemsToApplicationOutputError>
}

extension AssociateConfigurationItemsToApplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssociateConfigurationItemsToApplicationInput(applicationConfigurationId: \(Swift.String(describing: applicationConfigurationId)), configurationIds: \(Swift.String(describing: configurationIds)))"}
}

extension AssociateConfigurationItemsToApplicationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct AssociateConfigurationItemsToApplicationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateConfigurationItemsToApplicationInputHeadersMiddleware"
...
public struct AssociateConfigurationItemsToApplicationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateConfigurationItemsToApplicationInputQueryItemMiddleware"
...
public struct AssociateConfigurationItemsToApplicationInput: Swift.Equatable {
    ...
    public let applicationConfigurationId: Swift.String?
    /// <p>The ID of each configuration item to be associated with an application.</p>
    public let configurationIds: [Swift.String]?
...
extension AssociateConfigurationItemsToApplicationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct AssociateConfigurationItemsToApplicationOutputResponseBody: Swift.Equatable {
}

extension AssociateConfigurationItemsToApplicationOutputResponseBody: Swift.Decodable {
...
extension ApplicationDiscoveryClientTypes.BatchDeleteImportDataError: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case errorCode
...
extension ApplicationDiscoveryClientTypes.BatchDeleteImportDataError: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchDeleteImportDataError(errorCode: \(Swift.String(describing: errorCode)), errorDescription: \(Swift.String(describing: errorDescription)), importTaskId: \(Swift.String(describing: importTaskId)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct BatchDeleteImportDataError: Swift.Equatable {
        ...
        public let errorCode: ApplicationDiscoveryClientTypes.BatchDeleteImportDataErrorCode?
        ...
        public let importTaskId: Swift.String?
...
public struct BatchDeleteImportDataInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDeleteImportDataInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<BatchDeleteImportDataInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<BatchDeleteImportDataOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<BatchDeleteImportDataInput>
    public typealias MOutput = ClientRuntime.OperationOutput<BatchDeleteImportDataOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<BatchDeleteImportDataOutputError>
}

extension BatchDeleteImportDataInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchDeleteImportDataInput(importTaskIds: \(Swift.String(describing: importTaskIds)))"}
}

extension BatchDeleteImportDataInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case importTaskIds
    }
...
public struct BatchDeleteImportDataInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDeleteImportDataInputHeadersMiddleware"
...
public struct BatchDeleteImportDataInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "BatchDeleteImportDataInputQueryItemMiddleware"
...
public struct BatchDeleteImportDataInput: Swift.Equatable {
    ...
    public let importTaskIds: [Swift.String]?
...
extension BatchDeleteImportDataOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchDeleteImportDataOutputResponse(errors: \(Swift.String(describing: errors)))"}
}
...
public struct BatchDeleteImportDataOutputResponse: Swift.Equatable {
    /// <p>Error messages returned for each import task that you deleted as a response for this
    ///       command.</p>
    public let errors: [ApplicationDiscoveryClientTypes.BatchDeleteImportDataError]?
...
extension ApplicationDiscoveryClientTypes.ConfigurationTag: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApplicationDiscoveryClientTypes.ConfigurationTag: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConfigurationTag(configurationId: \(Swift.String(describing: configurationId)), configurationType: \(Swift.String(describing: configurationType)), key: \(Swift.String(describing: key)), timeOfCreation: \(Swift.String(describing: timeOfCreation)), value: \(Swift.String(describing: value)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct ConfigurationTag: Swift.Equatable {
        ...
        public let configurationType: ApplicationDiscoveryClientTypes.ConfigurationItemType?
        ...
        ///       (UTC).</p>
        public let timeOfCreation: ClientRuntime.Date?
...
extension ConflictErrorException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConflictErrorException(message: \(Swift.String(describing: message)))"}
}

extension ConflictErrorException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
/// <p></p>
public struct ConflictErrorException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension ApplicationDiscoveryClientTypes.ContinuousExportDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case dataSource
        case exportId
        case s3Bucket
...
extension ApplicationDiscoveryClientTypes.ContinuousExportDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ContinuousExportDescription(dataSource: \(Swift.String(describing: dataSource)), exportId: \(Swift.String(describing: exportId)), s3Bucket: \(Swift.String(describing: s3Bucket)), schemaStorageConfig: \(Swift.String(describing: schemaStorageConfig)), startTime: \(Swift.String(describing: startTime)), status: \(Swift.String(describing: status)), statusDetail: \(Swift.String(describing: statusDetail)), stopTime: \(Swift.String(describing: stopTime)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct ContinuousExportDescription: Swift.Equatable {
        ...
        ///       AGENT).</p>
        public let dataSource: ApplicationDiscoveryClientTypes.DataSource?
        /// <p>The unique ID assigned to this export.</p>
        public let exportId: Swift.String?
        ...
        ///             </li>
        ///          </ul>
        public let schemaStorageConfig: [Swift.String:Swift.String]?
        ...
        ///             </li>
        ///          </ul>
        public let status: ApplicationDiscoveryClientTypes.ContinuousExportStatus?
...
extension CreateApplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateApplicationInput(description: \(Swift.String(describing: description)), name: \(Swift.String(describing: name)))"}
}
...
extension CreateApplicationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateApplicationOutputResponse(configurationId: \(Swift.String(describing: configurationId)))"}
}
...
extension CreateTagsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateTagsInput(configurationIds: \(Swift.String(describing: configurationIds)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct CreateTagsInput: Swift.Equatable {
    ...
    ///          </p>
    public let tags: [ApplicationDiscoveryClientTypes.Tag]?
...
extension ApplicationDiscoveryClientTypes.CustomerAgentInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case activeAgents
...
extension ApplicationDiscoveryClientTypes.CustomerAgentInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CustomerAgentInfo(activeAgents: \(Swift.String(describing: activeAgents)), blackListedAgents: \(Swift.String(describing: blackListedAgents)), healthyAgents: \(Swift.String(describing: healthyAgents)), shutdownAgents: \(Swift.String(describing: shutdownAgents)), totalAgents: \(Swift.String(describing: totalAgents)), unhealthyAgents: \(Swift.String(describing: unhealthyAgents)), unknownAgents: \(Swift.String(describing: unknownAgents)))"}
}
...
extension ApplicationDiscoveryClientTypes.CustomerConnectorInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApplicationDiscoveryClientTypes.CustomerConnectorInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CustomerConnectorInfo(activeConnectors: \(Swift.String(describing: activeConnectors)), blackListedConnectors: \(Swift.String(describing: blackListedConnectors)), healthyConnectors: \(Swift.String(describing: healthyConnectors)), shutdownConnectors: \(Swift.String(describing: shutdownConnectors)), totalConnectors: \(Swift.String(describing: totalConnectors)), unhealthyConnectors: \(Swift.String(describing: unhealthyConnectors)), unknownConnectors: \(Swift.String(describing: unknownConnectors)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct CustomerConnectorInfo: Swift.Equatable {
        ...
        public let activeConnectors: Swift.Int
        /// <p>Number of blacklisted discovery connectors.</p>
        public let blackListedConnectors: Swift.Int
        /// <p>Number of healthy discovery connectors.</p>
        public let healthyConnectors: Swift.Int
        /// <p>Number of discovery connectors with status SHUTDOWN,</p>
        public let shutdownConnectors: Swift.Int
        /// <p>Total number of discovery connectors.</p>
        public let totalConnectors: Swift.Int
        /// <p>Number of unhealthy discovery connectors.</p>
        public let unhealthyConnectors: Swift.Int
        /// <p>Number of unknown discovery connectors.</p>
        public let unknownConnectors: Swift.Int
...
public struct DeleteApplicationsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteApplicationsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteApplicationsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteApplicationsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteApplicationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteApplicationsOutputError>
}

extension DeleteApplicationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteApplicationsInput(configurationIds: \(Swift.String(describing: configurationIds)))"}
}

extension DeleteApplicationsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case configurationIds
    }
...
public struct DeleteApplicationsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationsInputHeadersMiddleware"
...
public struct DeleteApplicationsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteApplicationsInputQueryItemMiddleware"
...
extension DeleteApplicationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteApplicationsOutputResponseBody: Swift.Equatable {
}

extension DeleteApplicationsOutputResponseBody: Swift.Decodable {
...
extension DeleteTagsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteTagsInput(configurationIds: \(Swift.String(describing: configurationIds)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct DescribeAgentsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAgentsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeAgentsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeAgentsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeAgentsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeAgentsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeAgentsOutputError>
}

extension DescribeAgentsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAgentsInput(agentIds: \(Swift.String(describing: agentIds)), filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeAgentsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case agentIds
        case filters
        case maxResults
...
public struct DescribeAgentsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAgentsInputHeadersMiddleware"
...
public struct DescribeAgentsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAgentsInputQueryItemMiddleware"
...
public struct DescribeAgentsInput: Swift.Equatable {
    ...
    ///       account.</p>
    public let agentIds: [Swift.String]?
    ...
    ///          </p>
    public let filters: [ApplicationDiscoveryClientTypes.Filter]?
...
extension DescribeAgentsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAgentsOutputResponse(agentsInfo: \(Swift.String(describing: agentsInfo)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeAgentsOutputResponse: Swift.Equatable {
    ...
    public let agentsInfo: [ApplicationDiscoveryClientTypes.AgentInfo]?
...
public struct DescribeConfigurationsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeConfigurationsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeConfigurationsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeConfigurationsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeConfigurationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeConfigurationsOutputError>
}

extension DescribeConfigurationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeConfigurationsInput(configurationIds: \(Swift.String(describing: configurationIds)))"}
}

extension DescribeConfigurationsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case configurationIds
    }
...
public struct DescribeConfigurationsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationsInputHeadersMiddleware"
...
public struct DescribeConfigurationsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConfigurationsInputQueryItemMiddleware"
...
extension DescribeConfigurationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeConfigurationsOutputResponse(configurations: \(Swift.String(describing: configurations)))"}
}
...
public struct DescribeConfigurationsOutputResponse: Swift.Equatable {
    ...
    public let configurations: [[Swift.String:Swift.String]]?
...
public struct DescribeContinuousExportsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeContinuousExportsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeContinuousExportsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeContinuousExportsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeContinuousExportsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeContinuousExportsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeContinuousExportsOutputError>
}

extension DescribeContinuousExportsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeContinuousExportsInput(exportIds: \(Swift.String(describing: exportIds)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeContinuousExportsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case exportIds
        case maxResults
        case nextToken
...
public struct DescribeContinuousExportsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeContinuousExportsInputHeadersMiddleware"
...
public struct DescribeContinuousExportsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeContinuousExportsInputQueryItemMiddleware"
...
public struct DescribeContinuousExportsInput: Swift.Equatable {
    ...
    public let exportIds: [Swift.String]?
...
extension DescribeContinuousExportsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeContinuousExportsOutputResponse(descriptions: \(Swift.String(describing: descriptions)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeContinuousExportsOutputResponse: Swift.Equatable {
    /// <p>A list of continuous export descriptions.</p>
    public let descriptions: [ApplicationDiscoveryClientTypes.ContinuousExportDescription]?
    /// <p>The token from the previous call to <code>DescribeExportTasks</code>.</p>
    public let nextToken: Swift.String?
...
public struct DescribeExportConfigurationsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExportConfigurationsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeExportConfigurationsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeExportConfigurationsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeExportConfigurationsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeExportConfigurationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeExportConfigurationsOutputError>
}

extension DescribeExportConfigurationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeExportConfigurationsInput(exportIds: \(Swift.String(describing: exportIds)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeExportConfigurationsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case exportIds
        case maxResults
        case nextToken
...
public struct DescribeExportConfigurationsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExportConfigurationsInputHeadersMiddleware"
...
public struct DescribeExportConfigurationsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeExportConfigurationsInputQueryItemMiddleware"
...
extension DescribeExportConfigurationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeExportConfigurationsOutputResponse(exportsInfo: \(Swift.String(describing: exportsInfo)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeExportConfigurationsOutputResponse: Swift.Equatable {
    /// <p></p>
    public let exportsInfo: [ApplicationDiscoveryClientTypes.ExportInfo]?
    /// <p>The token from the previous call to describe-export-tasks.</p>
    public let nextToken: Swift.String?
...
extension DescribeExportTasksInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeExportTasksInput(exportIds: \(Swift.String(describing: exportIds)), filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeExportTasksInput: Swift.Equatable {
    ...
    ///             </li>
    ///          </ul>
    public let filters: [ApplicationDiscoveryClientTypes.ExportFilter]?
...
extension DescribeExportTasksOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeExportTasksOutputResponse(exportsInfo: \(Swift.String(describing: exportsInfo)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeImportTasksInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeImportTasksInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeImportTasksInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeImportTasksOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeImportTasksInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeImportTasksOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeImportTasksOutputError>
}

extension DescribeImportTasksInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeImportTasksInput(filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeImportTasksInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filters
        case maxResults
        case nextToken
...
public struct DescribeImportTasksInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeImportTasksInputHeadersMiddleware"
...
public struct DescribeImportTasksInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeImportTasksInputQueryItemMiddleware"
...
public struct DescribeImportTasksInput: Swift.Equatable {
    ...
    public let filters: [ApplicationDiscoveryClientTypes.ImportTaskFilter]?
...
extension DescribeImportTasksOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeImportTasksOutputResponse(nextToken: \(Swift.String(describing: nextToken)), tasks: \(Swift.String(describing: tasks)))"}
}
...
public struct DescribeImportTasksOutputResponse: Swift.Equatable {
    ...
    public let tasks: [ApplicationDiscoveryClientTypes.ImportTask]?
...
extension DescribeTagsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeTagsInput(filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeTagsInput: Swift.Equatable {
    ...
    public let filters: [ApplicationDiscoveryClientTypes.TagFilter]?
...
public struct DescribeTagsOutputResponse: Swift.Equatable {
    ...
    public let tags: [ApplicationDiscoveryClientTypes.ConfigurationTag]?
...
public struct DisassociateConfigurationItemsFromApplicationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateConfigurationItemsFromApplicationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DisassociateConfigurationItemsFromApplicationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DisassociateConfigurationItemsFromApplicationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DisassociateConfigurationItemsFromApplicationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DisassociateConfigurationItemsFromApplicationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisassociateConfigurationItemsFromApplicationOutputError>
}

extension DisassociateConfigurationItemsFromApplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DisassociateConfigurationItemsFromApplicationInput(applicationConfigurationId: \(Swift.String(describing: applicationConfigurationId)), configurationIds: \(Swift.String(describing: configurationIds)))"}
}

extension DisassociateConfigurationItemsFromApplicationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case applicationConfigurationId
        case configurationIds
    }
...
public struct DisassociateConfigurationItemsFromApplicationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateConfigurationItemsFromApplicationInputHeadersMiddleware"
...
public struct DisassociateConfigurationItemsFromApplicationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateConfigurationItemsFromApplicationInputQueryItemMiddleware"
...
extension DisassociateConfigurationItemsFromApplicationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DisassociateConfigurationItemsFromApplicationOutputResponseBody: Swift.Equatable {
}

extension DisassociateConfigurationItemsFromApplicationOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension ExportConfigurationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExportConfigurationsInput()"}
}

extension ExportConfigurationsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ExportConfigurationsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportConfigurationsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ExportConfigurationsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ExportConfigurationsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ExportConfigurationsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ExportConfigurationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExportConfigurationsOutputError>
}

public struct ExportConfigurationsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportConfigurationsInputQueryItemMiddleware"
...
extension ExportConfigurationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExportConfigurationsOutputResponse(exportId: \(Swift.String(describing: exportId)))"}
}
...
extension ApplicationDiscoveryClientTypes.ExportFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case condition
        case name
        case values
...
extension ApplicationDiscoveryClientTypes.ExportFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExportFilter(condition: \(Swift.String(describing: condition)), name: \(Swift.String(describing: name)), values: \(Swift.String(describing: values)))"}
}
...
extension ApplicationDiscoveryClientTypes.ExportInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApplicationDiscoveryClientTypes.ExportInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExportInfo(configurationsDownloadUrl: \(Swift.String(describing: configurationsDownloadUrl)), exportId: \(Swift.String(describing: exportId)), exportRequestTime: \(Swift.String(describing: exportRequestTime)), exportStatus: \(Swift.String(describing: exportStatus)), isTruncated: \(Swift.String(describing: isTruncated)), requestedEndTime: \(Swift.String(describing: requestedEndTime)), requestedStartTime: \(Swift.String(describing: requestedStartTime)), statusMessage: \(Swift.String(describing: statusMessage)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct ExportInfo: Swift.Equatable {
        ...
        public let configurationsDownloadUrl: Swift.String?
        /// <p>A unique identifier used to query an export.</p>
        public let exportId: Swift.String?
        /// <p>The time that the data export was initiated.</p>
        public let exportRequestTime: ClientRuntime.Date?
        /// <p>The status of the data export job.</p>
        public let exportStatus: ApplicationDiscoveryClientTypes.ExportStatus?
        ...
        public let requestedEndTime: ClientRuntime.Date?
        ...
        ///         <code>ExportInfo</code>.</p>
        public let requestedStartTime: ClientRuntime.Date?
...
extension ApplicationDiscoveryClientTypes.Filter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case condition
        case name
        case values
...
extension ApplicationDiscoveryClientTypes.Filter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Filter(condition: \(Swift.String(describing: condition)), name: \(Swift.String(describing: name)), values: \(Swift.String(describing: values)))"}
}
...
extension GetDiscoverySummaryInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetDiscoverySummaryInput()"}
}

extension GetDiscoverySummaryInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetDiscoverySummaryInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDiscoverySummaryInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetDiscoverySummaryInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetDiscoverySummaryOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetDiscoverySummaryInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetDiscoverySummaryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetDiscoverySummaryOutputError>
}

public struct GetDiscoverySummaryInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDiscoverySummaryInputQueryItemMiddleware"
...
extension GetDiscoverySummaryOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetDiscoverySummaryOutputResponse(agentSummary: \(Swift.String(describing: agentSummary)), applications: \(Swift.String(describing: applications)), connectorSummary: \(Swift.String(describing: connectorSummary)), servers: \(Swift.String(describing: servers)), serversMappedToApplications: \(Swift.String(describing: serversMappedToApplications)), serversMappedtoTags: \(Swift.String(describing: serversMappedtoTags)))"}
}
...
public struct GetDiscoverySummaryOutputResponse: Swift.Equatable {
    ...
    public let agentSummary: ApplicationDiscoveryClientTypes.CustomerAgentInfo?
    /// <p>The number of applications discovered.</p>
    public let applications: Swift.Int
    /// <p>Details about discovered connectors, including connector status and health.</p>
    public let connectorSummary: ApplicationDiscoveryClientTypes.CustomerConnectorInfo?
    /// <p>The number of servers discovered.</p>
    public let servers: Swift.Int
    /// <p>The number of servers mapped to applications.</p>
    public let serversMappedToApplications: Swift.Int
    /// <p>The number of servers mapped to tags.</p>
    public let serversMappedtoTags: Swift.Int
...
extension HomeRegionNotSetException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct HomeRegionNotSetException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension ApplicationDiscoveryClientTypes.ImportTask: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApplicationDiscoveryClientTypes.ImportTask: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ImportTask(applicationImportFailure: \(Swift.String(describing: applicationImportFailure)), applicationImportSuccess: \(Swift.String(describing: applicationImportSuccess)), clientRequestToken: \(Swift.String(describing: clientRequestToken)), errorsAndFailedEntriesZip: \(Swift.String(describing: errorsAndFailedEntriesZip)), importCompletionTime: \(Swift.String(describing: importCompletionTime)), importDeletedTime: \(Swift.String(describing: importDeletedTime)), importRequestTime: \(Swift.String(describing: importRequestTime)), importTaskId: \(Swift.String(describing: importTaskId)), importUrl: \(Swift.String(describing: importUrl)), name: \(Swift.String(describing: name)), serverImportFailure: \(Swift.String(describing: serverImportFailure)), serverImportSuccess: \(Swift.String(describing: serverImportSuccess)), status: \(Swift.String(describing: status)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct ImportTask: Swift.Equatable {
        ...
        ///       imported.</p>
        public let applicationImportFailure: Swift.Int
        /// <p>The total number of application records in the import file that were successfully
        ///       imported.</p>
        public let applicationImportSuccess: Swift.Int
        ...
        public let importUrl: Swift.String?
        ...
        public let serverImportFailure: Swift.Int
        /// <p>The total number of server records in the import file that were successfully
        ///       imported.</p>
        public let serverImportSuccess: Swift.Int
        ...
        ///       console.</p>
        public let status: ApplicationDiscoveryClientTypes.ImportStatus?
...
extension ApplicationDiscoveryClientTypes.ImportTaskFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name
        case values
    }
...
extension ApplicationDiscoveryClientTypes.ImportTaskFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ImportTaskFilter(name: \(Swift.String(describing: name)), values: \(Swift.String(describing: values)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct ImportTaskFilter: Swift.Equatable {
        ...
        public let name: ApplicationDiscoveryClientTypes.ImportTaskFilterName?
...
public struct ListConfigurationsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListConfigurationsInputBodyMiddleware"
...
extension ListConfigurationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListConfigurationsInput(configurationType: \(Swift.String(describing: configurationType)), filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), orderBy: \(Swift.String(describing: orderBy)))"}
}
...
public struct ListConfigurationsInput: Swift.Equatable {
    ...
    ///         Service User Guide</i>.</p>
    public let orderBy: [ApplicationDiscoveryClientTypes.OrderByElement]?
...
public struct ListServerNeighborsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListServerNeighborsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListServerNeighborsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListServerNeighborsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListServerNeighborsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListServerNeighborsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListServerNeighborsOutputError>
}

extension ListServerNeighborsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListServerNeighborsInput(configurationId: \(Swift.String(describing: configurationId)), maxResults: \(Swift.String(describing: maxResults)), neighborConfigurationIds: \(Swift.String(describing: neighborConfigurationIds)), nextToken: \(Swift.String(describing: nextToken)), portInformationNeeded: \(Swift.String(describing: portInformationNeeded)))"}
}

extension ListServerNeighborsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case configurationId
        case maxResults
...
public struct ListServerNeighborsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListServerNeighborsInputHeadersMiddleware"
...
public struct ListServerNeighborsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListServerNeighborsInputQueryItemMiddleware"
...
public struct ListServerNeighborsInput: Swift.Equatable {
    ...
    public let neighborConfigurationIds: [Swift.String]?
    /// <p>Token to retrieve the next set of results. For example, if you previously specified 100
    ...
    ///       response.</p>
    public let portInformationNeeded: Swift.Bool
...
extension ListServerNeighborsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListServerNeighborsOutputResponse(knownDependencyCount: \(Swift.String(describing: knownDependencyCount)), neighbors: \(Swift.String(describing: neighbors)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct ListServerNeighborsOutputResponse: Swift.Equatable {
    ...
    public let knownDependencyCount: Swift.Int
    /// <p>List of distinct servers that are one hop away from the given server.</p>
    public let neighbors: [ApplicationDiscoveryClientTypes.NeighborConnectionDetail]?
    /// <p>Token to retrieve the next set of results. For example, if you specified 100 IDs for
...
extension ApplicationDiscoveryClientTypes.NeighborConnectionDetail: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApplicationDiscoveryClientTypes.NeighborConnectionDetail: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "NeighborConnectionDetail(connectionsCount: \(Swift.String(describing: connectionsCount)), destinationPort: \(Swift.String(describing: destinationPort)), destinationServerId: \(Swift.String(describing: destinationServerId)), sourceServerId: \(Swift.String(describing: sourceServerId)), transportProtocol: \(Swift.String(describing: transportProtocol)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct NeighborConnectionDetail: Swift.Equatable {
        ...
        public let connectionsCount: Swift.Int
        ...
        public let destinationServerId: Swift.String?
        ...
        public let transportProtocol: Swift.String?
...
extension ApplicationDiscoveryClientTypes.OrderByElement: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case fieldName
        case sortOrder
    }
...
extension ApplicationDiscoveryClientTypes.OrderByElement: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "OrderByElement(fieldName: \(Swift.String(describing: fieldName)), sortOrder: \(Swift.String(describing: sortOrder)))"}
}
...
extension ApplicationDiscoveryClientTypes {
    ...
    public struct OrderByElement: Swift.Equatable {
        ...
        public let sortOrder: ApplicationDiscoveryClientTypes.OrderString?
...
extension ServerInternalErrorException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ServerInternalErrorException(message: \(Swift.String(describing: message)))"}
}

extension ServerInternalErrorException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct ServerInternalErrorException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension StartContinuousExportInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartContinuousExportInput()"}
}

extension StartContinuousExportInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct StartContinuousExportInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartContinuousExportInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartContinuousExportInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartContinuousExportOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartContinuousExportInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartContinuousExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartContinuousExportOutputError>
}

public struct StartContinuousExportInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartContinuousExportInputQueryItemMiddleware"
...
extension StartContinuousExportOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartContinuousExportOutputResponse(dataSource: \(Swift.String(describing: dataSource)), exportId: \(Swift.String(describing: exportId)), s3Bucket: \(Swift.String(describing: s3Bucket)), schemaStorageConfig: \(Swift.String(describing: schemaStorageConfig)), startTime: \(Swift.String(describing: startTime)))"}
}
...
public struct StartDataCollectionByAgentIdsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartDataCollectionByAgentIdsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartDataCollectionByAgentIdsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartDataCollectionByAgentIdsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartDataCollectionByAgentIdsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartDataCollectionByAgentIdsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartDataCollectionByAgentIdsOutputError>
}

extension StartDataCollectionByAgentIdsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartDataCollectionByAgentIdsInput(agentIds: \(Swift.String(describing: agentIds)))"}
}

extension StartDataCollectionByAgentIdsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case agentIds
    }
...
public struct StartDataCollectionByAgentIdsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartDataCollectionByAgentIdsInputHeadersMiddleware"
...
public struct StartDataCollectionByAgentIdsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartDataCollectionByAgentIdsInputQueryItemMiddleware"
...
extension StartDataCollectionByAgentIdsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartDataCollectionByAgentIdsOutputResponse(agentsConfigurationStatus: \(Swift.String(describing: agentsConfigurationStatus)))"}
}
...
public struct StartDataCollectionByAgentIdsOutputResponse: Swift.Equatable {
    ...
    public let agentsConfigurationStatus: [ApplicationDiscoveryClientTypes.AgentConfigurationStatus]?
...
extension StartExportTaskInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartExportTaskInput(endTime: \(Swift.String(describing: endTime)), exportDataFormat: \(Swift.String(describing: exportDataFormat)), filters: \(Swift.String(describing: filters)), startTime: \(Swift.String(describing: startTime)))"}
}
...
public struct StartExportTaskInput: Swift.Equatable {
    ...
    ///          </p>
    public let exportDataFormat: [ApplicationDiscoveryClientTypes.ExportDataFormat]?
...
extension StartExportTaskOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartExportTaskOutputResponse(exportId: \(Swift.String(describing: exportId)))"}
}
...
public struct StartImportTaskInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartImportTaskInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartImportTaskInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartImportTaskOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartImportTaskInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartImportTaskOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartImportTaskOutputError>
}

extension StartImportTaskInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartImportTaskInput(clientRequestToken: \(Swift.String(describing: clientRequestToken)), importUrl: \(Swift.String(describing: importUrl)), name: \(Swift.String(describing: name)))"}
}

extension StartImportTaskInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientRequestToken
        case importUrl
        case name
...
public struct StartImportTaskInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartImportTaskInputHeadersMiddleware"
...
public struct StartImportTaskInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartImportTaskInputQueryItemMiddleware"
...
extension StartImportTaskOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartImportTaskOutputResponse(task: \(Swift.String(describing: task)))"}
}
...
public struct StartImportTaskOutputResponse: Swift.Equatable {
    ...
    public let task: ApplicationDiscoveryClientTypes.ImportTask?
...
public struct StopContinuousExportInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopContinuousExportInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StopContinuousExportInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StopContinuousExportOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StopContinuousExportInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StopContinuousExportOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopContinuousExportOutputError>
}

extension StopContinuousExportInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopContinuousExportInput(exportId: \(Swift.String(describing: exportId)))"}
}

extension StopContinuousExportInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case exportId
    }
...
public struct StopContinuousExportInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopContinuousExportInputHeadersMiddleware"
...
public struct StopContinuousExportInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopContinuousExportInputQueryItemMiddleware"
...
extension StopContinuousExportOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopContinuousExportOutputResponse(startTime: \(Swift.String(describing: startTime)), stopTime: \(Swift.String(describing: stopTime)))"}
}
...
public struct StopDataCollectionByAgentIdsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopDataCollectionByAgentIdsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StopDataCollectionByAgentIdsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StopDataCollectionByAgentIdsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StopDataCollectionByAgentIdsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StopDataCollectionByAgentIdsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopDataCollectionByAgentIdsOutputError>
}

extension StopDataCollectionByAgentIdsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopDataCollectionByAgentIdsInput(agentIds: \(Swift.String(describing: agentIds)))"}
}

extension StopDataCollectionByAgentIdsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case agentIds
    }
...
public struct StopDataCollectionByAgentIdsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopDataCollectionByAgentIdsInputHeadersMiddleware"
...
public struct StopDataCollectionByAgentIdsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopDataCollectionByAgentIdsInputQueryItemMiddleware"
...
extension StopDataCollectionByAgentIdsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopDataCollectionByAgentIdsOutputResponse(agentsConfigurationStatus: \(Swift.String(describing: agentsConfigurationStatus)))"}
}
...
extension ApplicationDiscoveryClientTypes.Tag: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key
        case value
    }
...
extension ApplicationDiscoveryClientTypes.Tag: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension ApplicationDiscoveryClientTypes.TagFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name
        case values
    }
...
extension ApplicationDiscoveryClientTypes.TagFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TagFilter(name: \(Swift.String(describing: name)), values: \(Swift.String(describing: values)))"}
}
...
extension UpdateApplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateApplicationInput(configurationId: \(Swift.String(describing: configurationId)), description: \(Swift.String(describing: description)), name: \(Swift.String(describing: name)))"}
}
