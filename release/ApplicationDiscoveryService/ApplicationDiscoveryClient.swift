...
public class ApplicationDiscoveryClient {
    ...
    let config: ApplicationDiscoveryClientConfiguration
    let serviceName = "Application Discovery"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: ApplicationDiscoveryClientConfiguration) {
    ...
    public class ApplicationDiscoveryClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "ApplicationDiscoveryClient")
        }
        ...
        public static func `default`() throws -> ApplicationDiscoveryClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try ApplicationDiscoveryClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}

public struct ApplicationDiscoveryClientLogHandlerFactory: SDKLogHandlerFactory {
