...
public class ElasticBeanstalkClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try ElasticBeanstalkClientConfiguration(region: unwrappedRegion)
    ...
    public class ElasticBeanstalkClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("ElasticBeanstalkClient")
