...
public protocol GlobalAcceleratorClientProtocol {
    ...
    func addCustomRoutingEndpoints(input: AddCustomRoutingEndpointsInput, completion: @escaping (SdkResult<AddCustomRoutingEndpointsOutput, AddCustomRoutingEndpointsOutputError>) -> Void)
    ...
    func allowCustomRoutingTraffic(input: AllowCustomRoutingTrafficInput, completion: @escaping (SdkResult<AllowCustomRoutingTrafficOutput, AllowCustomRoutingTrafficOutputError>) -> Void)
    ...
    /// 				US West (Oregon) Region to create or update accelerators.</p>
    /// 		       </important>
    func createAccelerator(input: CreateAcceleratorInput, completion: @escaping (SdkResult<CreateAcceleratorOutput, CreateAcceleratorOutputError>) -> Void)
    ...
    /// 			US West (Oregon) Region to create or update accelerators.</p>
    /// 	        </important>
    func createCustomRoutingAccelerator(input: CreateCustomRoutingAcceleratorInput, completion: @escaping (SdkResult<CreateCustomRoutingAcceleratorOutput, CreateCustomRoutingAcceleratorOutputError>) -> Void)
    ...
    /// 		Region. </p>
    func createCustomRoutingEndpointGroup(input: CreateCustomRoutingEndpointGroupInput, completion: @escaping (SdkResult<CreateCustomRoutingEndpointGroupOutput, CreateCustomRoutingEndpointGroupOutputError>) -> Void)
    ...
    func createCustomRoutingListener(input: CreateCustomRoutingListenerInput, completion: @escaping (SdkResult<CreateCustomRoutingListenerOutput, CreateCustomRoutingListenerOutputError>) -> Void)
    ...
    func createEndpointGroup(input: CreateEndpointGroupInput, completion: @escaping (SdkResult<CreateEndpointGroupOutput, CreateEndpointGroupOutputError>) -> Void)
    ...
    func createListener(input: CreateListenerInput, completion: @escaping (SdkResult<CreateListenerOutput, CreateListenerOutputError>) -> Void)
    ...
    ///          </important>
    func deleteAccelerator(input: DeleteAcceleratorInput, completion: @escaping (SdkResult<DeleteAcceleratorOutput, DeleteAcceleratorOutputError>) -> Void)
    ...
    /// 			the <i>AWS Global Accelerator Developer Guide</i>.</p>
    ///          </important>
    func deleteCustomRoutingAccelerator(input: DeleteCustomRoutingAcceleratorInput, completion: @escaping (SdkResult<DeleteCustomRoutingAcceleratorOutput, DeleteCustomRoutingAcceleratorOutputError>) -> Void)
    /// <p>Delete an endpoint group from a listener for a custom routing accelerator.</p>
    func deleteCustomRoutingEndpointGroup(input: DeleteCustomRoutingEndpointGroupInput, completion: @escaping (SdkResult<DeleteCustomRoutingEndpointGroupOutput, DeleteCustomRoutingEndpointGroupOutputError>) -> Void)
    /// <p>Delete a listener for a custom routing accelerator.</p>
    func deleteCustomRoutingListener(input: DeleteCustomRoutingListenerInput, completion: @escaping (SdkResult<DeleteCustomRoutingListenerOutput, DeleteCustomRoutingListenerOutputError>) -> Void)
    /// <p>Delete an endpoint group from a listener.</p>
    func deleteEndpointGroup(input: DeleteEndpointGroupInput, completion: @escaping (SdkResult<DeleteEndpointGroupOutput, DeleteEndpointGroupOutputError>) -> Void)
    /// <p>Delete a listener from an accelerator.</p>
    func deleteListener(input: DeleteListenerInput, completion: @escaping (SdkResult<DeleteListenerOutput, DeleteListenerOutputError>) -> Void)
    ...
    /// 		       <p>After you make changes, you can verify that the updates are complete by checking the status of your
    /// 			accelerator: the status changes from IN_PROGRESS to DEPLOYED.</p>
    func denyCustomRoutingTraffic(input: DenyCustomRoutingTrafficInput, completion: @escaping (SdkResult<DenyCustomRoutingTrafficOutput, DenyCustomRoutingTrafficOutputError>) -> Void)
    ...
    func describeAccelerator(input: DescribeAcceleratorInput, completion: @escaping (SdkResult<DescribeAcceleratorOutput, DescribeAcceleratorOutputError>) -> Void)
    /// <p>Describe the attributes of an accelerator.
    /// 		</p>
    func describeAcceleratorAttributes(input: DescribeAcceleratorAttributesInput, completion: @escaping (SdkResult<DescribeAcceleratorAttributesOutput, DescribeAcceleratorAttributesOutputError>) -> Void)
    /// <p>Describe a custom routing accelerator. </p>
    func describeCustomRoutingAccelerator(input: DescribeCustomRoutingAcceleratorInput, completion: @escaping (SdkResult<DescribeCustomRoutingAcceleratorOutput, DescribeCustomRoutingAcceleratorOutputError>) -> Void)
    /// <p>Describe the attributes of a custom routing accelerator. </p>
    func describeCustomRoutingAcceleratorAttributes(input: DescribeCustomRoutingAcceleratorAttributesInput, completion: @escaping (SdkResult<DescribeCustomRoutingAcceleratorAttributesOutput, DescribeCustomRoutingAcceleratorAttributesOutputError>) -> Void)
    /// <p>Describe an endpoint group for a custom routing accelerator. </p>
    func describeCustomRoutingEndpointGroup(input: DescribeCustomRoutingEndpointGroupInput, completion: @escaping (SdkResult<DescribeCustomRoutingEndpointGroupOutput, DescribeCustomRoutingEndpointGroupOutputError>) -> Void)
    /// <p>The description of a listener for a custom routing accelerator.</p>
    func describeCustomRoutingListener(input: DescribeCustomRoutingListenerInput, completion: @escaping (SdkResult<DescribeCustomRoutingListenerOutput, DescribeCustomRoutingListenerOutputError>) -> Void)
    /// <p>Describe an endpoint group. </p>
    func describeEndpointGroup(input: DescribeEndpointGroupInput, completion: @escaping (SdkResult<DescribeEndpointGroupOutput, DescribeEndpointGroupOutputError>) -> Void)
    /// <p>Describe a listener. </p>
    func describeListener(input: DescribeListenerInput, completion: @escaping (SdkResult<DescribeListenerOutput, DescribeListenerOutputError>) -> Void)
    /// <p>List the accelerators for an AWS account. </p>
    func listAccelerators(input: ListAcceleratorsInput, completion: @escaping (SdkResult<ListAcceleratorsOutput, ListAcceleratorsOutputError>) -> Void)
    ...
    func listByoipCidrs(input: ListByoipCidrsInput, completion: @escaping (SdkResult<ListByoipCidrsOutput, ListByoipCidrsOutputError>) -> Void)
    /// <p>List the custom routing accelerators for an AWS account. </p>
    func listCustomRoutingAccelerators(input: ListCustomRoutingAcceleratorsInput, completion: @escaping (SdkResult<ListCustomRoutingAcceleratorsOutput, ListCustomRoutingAcceleratorsOutputError>) -> Void)
    /// <p>List the endpoint groups that are associated with a listener for a custom routing accelerator. </p>
    func listCustomRoutingEndpointGroups(input: ListCustomRoutingEndpointGroupsInput, completion: @escaping (SdkResult<ListCustomRoutingEndpointGroupsOutput, ListCustomRoutingEndpointGroupsOutputError>) -> Void)
    /// <p>List the listeners for a custom routing accelerator. </p>
    func listCustomRoutingListeners(input: ListCustomRoutingListenersInput, completion: @escaping (SdkResult<ListCustomRoutingListenersOutput, ListCustomRoutingListenersOutputError>) -> Void)
    ...
    func listCustomRoutingPortMappings(input: ListCustomRoutingPortMappingsInput, completion: @escaping (SdkResult<ListCustomRoutingPortMappingsOutput, ListCustomRoutingPortMappingsOutputError>) -> Void)
    ...
    func listCustomRoutingPortMappingsByDestination(input: ListCustomRoutingPortMappingsByDestinationInput, completion: @escaping (SdkResult<ListCustomRoutingPortMappingsByDestinationOutput, ListCustomRoutingPortMappingsByDestinationOutputError>) -> Void)
    /// <p>List the endpoint groups that are associated with a listener. </p>
    func listEndpointGroups(input: ListEndpointGroupsInput, completion: @escaping (SdkResult<ListEndpointGroupsOutput, ListEndpointGroupsOutputError>) -> Void)
    /// <p>List the listeners for an accelerator. </p>
    func listListeners(input: ListListenersInput, completion: @escaping (SdkResult<ListListenersOutput, ListListenersOutputError>) -> Void)
    ...
    func removeCustomRoutingEndpoints(input: RemoveCustomRoutingEndpointsInput, completion: @escaping (SdkResult<RemoveCustomRoutingEndpointsOutput, RemoveCustomRoutingEndpointsOutputError>) -> Void)
    ...
    /// 				US West (Oregon) Region to create or update accelerators.</p>
    /// 		       </important>
    func updateAccelerator(input: UpdateAcceleratorInput, completion: @escaping (SdkResult<UpdateAcceleratorOutput, UpdateAcceleratorOutputError>) -> Void)
    /// <p>Update the attributes for an accelerator. </p>
    func updateAcceleratorAttributes(input: UpdateAcceleratorAttributesInput, completion: @escaping (SdkResult<UpdateAcceleratorAttributesOutput, UpdateAcceleratorAttributesOutputError>) -> Void)
    /// <p>Update a custom routing accelerator. </p>
    func updateCustomRoutingAccelerator(input: UpdateCustomRoutingAcceleratorInput, completion: @escaping (SdkResult<UpdateCustomRoutingAcceleratorOutput, UpdateCustomRoutingAcceleratorOutputError>) -> Void)
    /// <p>Update the attributes for a custom routing accelerator. </p>
    func updateCustomRoutingAcceleratorAttributes(input: UpdateCustomRoutingAcceleratorAttributesInput, completion: @escaping (SdkResult<UpdateCustomRoutingAcceleratorAttributesOutput, UpdateCustomRoutingAcceleratorAttributesOutputError>) -> Void)
    /// <p>Update a listener for a custom routing accelerator. </p>
    func updateCustomRoutingListener(input: UpdateCustomRoutingListenerInput, completion: @escaping (SdkResult<UpdateCustomRoutingListenerOutput, UpdateCustomRoutingListenerOutputError>) -> Void)
    /// <p>Update an endpoint group. A resource must be valid and active when you add it as an endpoint.</p>
    func updateEndpointGroup(input: UpdateEndpointGroupInput, completion: @escaping (SdkResult<UpdateEndpointGroupOutput, UpdateEndpointGroupOutputError>) -> Void)
    /// <p>Update a listener. </p>
    func updateListener(input: UpdateListenerInput, completion: @escaping (SdkResult<UpdateListenerOutput, UpdateListenerOutputError>) -> Void)
