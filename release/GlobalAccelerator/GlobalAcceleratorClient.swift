...
public class GlobalAcceleratorClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try GlobalAcceleratorClientConfiguration(region: unwrappedRegion)
    ...
    public class GlobalAcceleratorClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("GlobalAcceleratorClient")
