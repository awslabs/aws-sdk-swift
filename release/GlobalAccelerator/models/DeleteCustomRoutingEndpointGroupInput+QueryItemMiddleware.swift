...
public struct DeleteCustomRoutingEndpointGroupInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DeleteCustomRoutingEndpointGroupOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DeleteCustomRoutingEndpointGroupOutput>
