...
public struct ListCustomRoutingAcceleratorsInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<ListCustomRoutingAcceleratorsOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<ListCustomRoutingAcceleratorsOutput>
