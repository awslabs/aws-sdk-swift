...
public protocol MwaaClientProtocol {
    ...
    func createCliToken(input: CreateCliTokenInput, completion: @escaping (SdkResult<CreateCliTokenOutputResponse, CreateCliTokenOutputError>) -> Void)
    ...
    func createWebLoginToken(input: CreateWebLoginTokenInput, completion: @escaping (SdkResult<CreateWebLoginTokenOutputResponse, CreateWebLoginTokenOutputError>) -> Void)
    ...
    func publishMetrics(input: PublishMetricsInput, completion: @escaping (SdkResult<PublishMetricsOutputResponse, PublishMetricsOutputError>) -> Void)
