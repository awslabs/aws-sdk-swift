...
extension MwaaClient: MwaaClientProtocol {
    ...
    public func createCliToken(input: CreateCliTokenInput, completion: @escaping (SdkResult<CreateCliTokenOutput, CreateCliTokenOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<CreateCliTokenInput, CreateCliTokenOutput, CreateCliTokenOutputError>(id: "createCliToken")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateCliTokenInput, CreateCliTokenOutput, CreateCliTokenOutputError>(contentType: "application/json"))
    ...
    public func createWebLoginToken(input: CreateWebLoginTokenInput, completion: @escaping (SdkResult<CreateWebLoginTokenOutput, CreateWebLoginTokenOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "airflow")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateWebLoginTokenInput, CreateWebLoginTokenOutput, CreateWebLoginTokenOutputError>(id: "createWebLoginToken")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateWebLoginTokenInput, CreateWebLoginTokenOutput, CreateWebLoginTokenOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func publishMetrics(input: PublishMetricsInput, completion: @escaping (SdkResult<PublishMetricsOutput, PublishMetricsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "airflow")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PublishMetricsInput, PublishMetricsOutput, PublishMetricsOutputError>(id: "publishMetrics")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PublishMetricsInput, PublishMetricsOutput, PublishMetricsOutputError>(contentType: "application/json"))
