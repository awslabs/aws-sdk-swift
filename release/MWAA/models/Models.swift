...
extension CreateCliTokenInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateCliTokenInput(name: \(Swift.String(describing: name)))"}
}

extension CreateCliTokenInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct CreateCliTokenInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateCliTokenInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateCliTokenInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateCliTokenOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateCliTokenInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateCliTokenOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateCliTokenOutputError>
}

public struct CreateCliTokenInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateCliTokenInputQueryItemMiddleware"
...
public struct CreateEnvironmentInput: Swift.Equatable {
    ...
    public let airflowConfigurationOptions: [Swift.String:Swift.String]?
    ...
    public let airflowVersion: Swift.String?
    ...
    public let dagS3Path: Swift.String?
    ...
    public let environmentClass: Swift.String?
    ...
    public let loggingConfiguration: MwaaClientTypes.LoggingConfigurationInput?
    ...
    public let maxWorkers: Swift.Int?
    ...
    public let minWorkers: Swift.Int?
    ...
    public let networkConfiguration: MwaaClientTypes.NetworkConfiguration?
    ...
    public let pluginsS3ObjectVersion: Swift.String?
    ...
    public let pluginsS3Path: Swift.String?
    ...
    public let requirementsS3ObjectVersion: Swift.String?
    ...
    public let requirementsS3Path: Swift.String?
    /// <p>The number of Apache Airflow schedulers to run in your environment.</p>
    public let schedulers: Swift.Int?
    ...
    public let sourceBucketArn: Swift.String?
    ...
    public let webserverAccessMode: MwaaClientTypes.WebserverAccessMode?
    ...
    ///             </li>
    ///          </ul>
    public let weeklyMaintenanceWindowStart: Swift.String?
...
extension CreateEnvironmentOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateEnvironmentOutputResponse(arn: \(Swift.String(describing: arn)))"}
}
...
extension CreateWebLoginTokenInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateWebLoginTokenInput(name: \(Swift.String(describing: name)))"}
}

extension CreateWebLoginTokenInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct CreateWebLoginTokenInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateWebLoginTokenInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateWebLoginTokenInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateWebLoginTokenOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateWebLoginTokenInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateWebLoginTokenOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateWebLoginTokenOutputError>
}

public struct CreateWebLoginTokenInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateWebLoginTokenInputQueryItemMiddleware"
...
public struct CreateWebLoginTokenOutputResponse: Swift.Equatable {
    ...
    public let webToken: Swift.String?
...
extension MwaaClientTypes.Dimension: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case value = "Value"
    }
...
extension MwaaClientTypes.Dimension: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension MwaaClientTypes.Environment: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case airflowConfigurationOptions = "AirflowConfigurationOptions"
        case airflowVersion = "AirflowVersion"
        case arn = "Arn"
...
extension MwaaClientTypes.Environment: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Environment(airflowConfigurationOptions: \(Swift.String(describing: airflowConfigurationOptions)), airflowVersion: \(Swift.String(describing: airflowVersion)), arn: \(Swift.String(describing: arn)), createdAt: \(Swift.String(describing: createdAt)), dagS3Path: \(Swift.String(describing: dagS3Path)), environmentClass: \(Swift.String(describing: environmentClass)), executionRoleArn: \(Swift.String(describing: executionRoleArn)), kmsKey: \(Swift.String(describing: kmsKey)), lastUpdate: \(Swift.String(describing: lastUpdate)), loggingConfiguration: \(Swift.String(describing: loggingConfiguration)), maxWorkers: \(Swift.String(describing: maxWorkers)), minWorkers: \(Swift.String(describing: minWorkers)), name: \(Swift.String(describing: name)), networkConfiguration: \(Swift.String(describing: networkConfiguration)), pluginsS3ObjectVersion: \(Swift.String(describing: pluginsS3ObjectVersion)), pluginsS3Path: \(Swift.String(describing: pluginsS3Path)), requirementsS3ObjectVersion: \(Swift.String(describing: requirementsS3ObjectVersion)), requirementsS3Path: \(Swift.String(describing: requirementsS3Path)), schedulers: \(Swift.String(describing: schedulers)), serviceRoleArn: \(Swift.String(describing: serviceRoleArn)), sourceBucketArn: \(Swift.String(describing: sourceBucketArn)), status: \(Swift.String(describing: status)), tags: \(Swift.String(describing: tags)), webserverAccessMode: \(Swift.String(describing: webserverAccessMode)), webserverUrl: \(Swift.String(describing: webserverUrl)), weeklyMaintenanceWindowStart: \(Swift.String(describing: weeklyMaintenanceWindowStart)))"}
}
...
extension MwaaClientTypes {
    ...
    public struct Environment: Swift.Equatable {
        ...
        public let lastUpdate: MwaaClientTypes.LastUpdate?
        ...
        public let loggingConfiguration: MwaaClientTypes.LoggingConfiguration?
        ...
        public let status: MwaaClientTypes.EnvironmentStatus?
        ...
        public let webserverUrl: Swift.String?
...
public struct GetEnvironmentOutputResponse: Swift.Equatable {
    ...
    public let environment: MwaaClientTypes.Environment?
...
extension MwaaClientTypes.LastUpdate: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case createdAt = "CreatedAt"
        case error = "Error"
        case status = "Status"
...
extension MwaaClientTypes.LastUpdate: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LastUpdate(createdAt: \(Swift.String(describing: createdAt)), error: \(Swift.String(describing: error)), status: \(Swift.String(describing: status)))"}
}
...
public struct ListEnvironmentsOutputResponse: Swift.Equatable {
    ...
    public let environments: [Swift.String]?
    /// <p>Retrieves the next page of the results.</p>
    public let nextToken: Swift.String?
...
extension MwaaClientTypes.LoggingConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MwaaClientTypes.LoggingConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LoggingConfiguration(dagProcessingLogs: \(Swift.String(describing: dagProcessingLogs)), schedulerLogs: \(Swift.String(describing: schedulerLogs)), taskLogs: \(Swift.String(describing: taskLogs)), webserverLogs: \(Swift.String(describing: webserverLogs)), workerLogs: \(Swift.String(describing: workerLogs)))"}
}
...
extension MwaaClientTypes {
    ...
    public struct LoggingConfiguration: Swift.Equatable {
        ...
        public let dagProcessingLogs: MwaaClientTypes.ModuleLoggingConfiguration?
        /// <p>Defines the type of logs to send for the Apache Airflow log type (e.g. <code>DagProcessingLogs</code>). Valid values: <code>CloudWatchLogGroupArn</code>, <code>Enabled</code>, <code>LogLevel</code>.</p>
        public let schedulerLogs: MwaaClientTypes.ModuleLoggingConfiguration?
        /// <p>Defines the type of logs to send for the Apache Airflow log type (e.g. <code>DagProcessingLogs</code>). Valid values: <code>CloudWatchLogGroupArn</code>, <code>Enabled</code>, <code>LogLevel</code>.</p>
        public let taskLogs: MwaaClientTypes.ModuleLoggingConfiguration?
        /// <p>Defines the type of logs to send for the Apache Airflow log type (e.g. <code>DagProcessingLogs</code>). Valid values: <code>CloudWatchLogGroupArn</code>, <code>Enabled</code>, <code>LogLevel</code>.</p>
        public let webserverLogs: MwaaClientTypes.ModuleLoggingConfiguration?
        /// <p>Defines the type of logs to send for the Apache Airflow log type (e.g. <code>DagProcessingLogs</code>). Valid values: <code>CloudWatchLogGroupArn</code>, <code>Enabled</code>, <code>LogLevel</code>.</p>
        public let workerLogs: MwaaClientTypes.ModuleLoggingConfiguration?
...
extension MwaaClientTypes.LoggingConfigurationInput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case dagProcessingLogs = "DagProcessingLogs"
        case schedulerLogs = "SchedulerLogs"
        case taskLogs = "TaskLogs"
...
extension MwaaClientTypes.LoggingConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LoggingConfigurationInput(dagProcessingLogs: \(Swift.String(describing: dagProcessingLogs)), schedulerLogs: \(Swift.String(describing: schedulerLogs)), taskLogs: \(Swift.String(describing: taskLogs)), webserverLogs: \(Swift.String(describing: webserverLogs)), workerLogs: \(Swift.String(describing: workerLogs)))"}
}
...
extension MwaaClientTypes {
    ...
    public struct LoggingConfigurationInput: Swift.Equatable {
        /// <p>Defines the type of logs to send for the Apache Airflow log type (e.g. <code>DagProcessingLogs</code>). Valid values: <code>CloudWatchLogGroupArn</code>, <code>Enabled</code>, <code>LogLevel</code>.</p>
        public let dagProcessingLogs: MwaaClientTypes.ModuleLoggingConfigurationInput?
        /// <p>Defines the type of logs to send for the Apache Airflow log type (e.g. <code>DagProcessingLogs</code>). Valid values: <code>CloudWatchLogGroupArn</code>, <code>Enabled</code>, <code>LogLevel</code>.</p>
        public let schedulerLogs: MwaaClientTypes.ModuleLoggingConfigurationInput?
        /// <p>Defines the type of logs to send for the Apache Airflow log type (e.g. <code>DagProcessingLogs</code>). Valid values: <code>CloudWatchLogGroupArn</code>, <code>Enabled</code>, <code>LogLevel</code>.</p>
        public let taskLogs: MwaaClientTypes.ModuleLoggingConfigurationInput?
        /// <p>Defines the type of logs to send for the Apache Airflow log type (e.g. <code>DagProcessingLogs</code>). Valid values: <code>CloudWatchLogGroupArn</code>, <code>Enabled</code>, <code>LogLevel</code>.</p>
        public let webserverLogs: MwaaClientTypes.ModuleLoggingConfigurationInput?
        /// <p>Defines the type of logs to send for the Apache Airflow log type (e.g. <code>DagProcessingLogs</code>). Valid values: <code>CloudWatchLogGroupArn</code>, <code>Enabled</code>, <code>LogLevel</code>.</p>
        public let workerLogs: MwaaClientTypes.ModuleLoggingConfigurationInput?
...
extension MwaaClientTypes.MetricDatum: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MwaaClientTypes.MetricDatum: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MetricDatum(dimensions: \(Swift.String(describing: dimensions)), metricName: \(Swift.String(describing: metricName)), statisticValues: \(Swift.String(describing: statisticValues)), timestamp: \(Swift.String(describing: timestamp)), unit: \(Swift.String(describing: unit)), value: \(Swift.String(describing: value)))"}
}
...
extension MwaaClientTypes {
    ...
    public struct MetricDatum: Swift.Equatable {
        /// <p>Internal only API.</p>
        public let dimensions: [MwaaClientTypes.Dimension]?
        /// <p>Internal only API.</p>
        public let metricName: Swift.String?
        /// <p>Internal only API.</p>
        public let statisticValues: MwaaClientTypes.StatisticSet?
        /// <p>Internal only API.</p>
        public let timestamp: ClientRuntime.Date?
        /// Unit
        public let unit: MwaaClientTypes.Unit?
        /// <p>Internal only API.</p>
...
extension MwaaClientTypes.ModuleLoggingConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MwaaClientTypes.ModuleLoggingConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModuleLoggingConfiguration(cloudWatchLogGroupArn: \(Swift.String(describing: cloudWatchLogGroupArn)), enabled: \(Swift.String(describing: enabled)), logLevel: \(Swift.String(describing: logLevel)))"}
}
...
extension MwaaClientTypes {
    ...
    public struct ModuleLoggingConfiguration: Swift.Equatable {
        ...
        public let logLevel: MwaaClientTypes.LoggingLevel?
...
extension MwaaClientTypes.ModuleLoggingConfigurationInput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case enabled = "Enabled"
        case logLevel = "LogLevel"
    }
...
extension MwaaClientTypes.ModuleLoggingConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModuleLoggingConfigurationInput(enabled: \(Swift.String(describing: enabled)), logLevel: \(Swift.String(describing: logLevel)))"}
}
...
extension MwaaClientTypes.NetworkConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MwaaClientTypes.NetworkConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "NetworkConfiguration(securityGroupIds: \(Swift.String(describing: securityGroupIds)), subnetIds: \(Swift.String(describing: subnetIds)))"}
}
...
public struct PublishMetricsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PublishMetricsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PublishMetricsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PublishMetricsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PublishMetricsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PublishMetricsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PublishMetricsOutputError>
}

extension PublishMetricsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PublishMetricsInput(environmentName: \(Swift.String(describing: environmentName)), metricData: \(Swift.String(describing: metricData)))"}
}

extension PublishMetricsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct PublishMetricsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PublishMetricsInputHeadersMiddleware"
...
public struct PublishMetricsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PublishMetricsInputQueryItemMiddleware"
...
public struct PublishMetricsInput: Swift.Equatable {
    ...
    public let metricData: [MwaaClientTypes.MetricDatum]?
...
extension PublishMetricsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct PublishMetricsOutputResponseBody: Swift.Equatable {
}

extension PublishMetricsOutputResponseBody: Swift.Decodable {
...
extension MwaaClientTypes.StatisticSet: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MwaaClientTypes.StatisticSet: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension MwaaClientTypes {
    ...
    public struct StatisticSet: Swift.Equatable {
        ...
        /// <p>Internal only API.</p>
        public let sampleCount: Swift.Int?
        /// <p>Internal only API.</p>
...
public struct UpdateEnvironmentInput: Swift.Equatable {
    ...
    public let name: Swift.String?
    /// <p>The VPC networking components used to secure and enable network traffic between the AWS resources for your environment. To learn more, see <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/networking-about.html">About networking on Amazon MWAA</a>.</p>
    public let networkConfiguration: MwaaClientTypes.UpdateNetworkConfigurationInput?
    /// <p>The version of the plugins.zip file on your Amazon S3 bucket. A version must be specified each time a plugins.zip file is updated. To learn more, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/versioning-workflows.html">How S3 Versioning works</a>.</p>
    public let pluginsS3ObjectVersion: Swift.String?
    /// <p>The relative path to the <code>plugins.zip</code> file on your Amazon S3 bucket. For example, <code>plugins.zip</code>. If specified, then the plugins.zip version is required. To learn more, see <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import-plugins.html">Installing custom plugins</a>.</p>
    public let pluginsS3Path: Swift.String?
...
extension UpdateEnvironmentOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateEnvironmentOutputResponse(arn: \(Swift.String(describing: arn)))"}
}
...
extension MwaaClientTypes.UpdateError: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MwaaClientTypes.UpdateError: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateError(errorCode: \(Swift.String(describing: errorCode)), errorMessage: \(Swift.String(describing: errorMessage)))"}
}
...
extension MwaaClientTypes.UpdateNetworkConfigurationInput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case securityGroupIds = "SecurityGroupIds"
    }
...
extension MwaaClientTypes.UpdateNetworkConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateNetworkConfigurationInput(securityGroupIds: \(Swift.String(describing: securityGroupIds)))"}
}
