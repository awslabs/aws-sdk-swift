...
public extension KafkaClient {
    ...
    {
        typealias createClusterV2Continuation = CheckedContinuation<CreateClusterV2OutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createClusterV2Continuation) in
            createClusterV2(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeClusterV2Continuation = CheckedContinuation<DescribeClusterV2OutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeClusterV2Continuation) in
            describeClusterV2(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listClustersV2Continuation = CheckedContinuation<ListClustersV2OutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listClustersV2Continuation) in
            listClustersV2(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateConnectivityContinuation = CheckedContinuation<UpdateConnectivityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateConnectivityContinuation) in
            updateConnectivity(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
