...
public struct BatchAssociateScramSecretInput: Swift.Equatable {
    ...
    var clusterArn: Swift.String?
    /// List of AWS Secrets Manager secret ARNs.
    /// This member is required.
    var secretArnList: [Swift.String]?
...
public struct BatchAssociateScramSecretOutputResponse: Swift.Equatable {
    ...
    var unprocessedScramSecrets: [KafkaClientTypes.UnprocessedScramSecret]?
...
extension KafkaClientTypes {
    ...
    public struct BrokerEBSVolumeInfo: Swift.Equatable {
        ...
        /// This member is required.
        var kafkaBrokerNodeId: Swift.String?
        /// Size of the EBS volume to update.
        /// This member is required.
        var volumeSizeGB: Swift.Int?
...
extension KafkaClientTypes {
    public struct BrokerLogs: Swift.Equatable {
        var cloudWatchLogs: KafkaClientTypes.CloudWatchLogs?
        var firehose: KafkaClientTypes.Firehose?
        var s3: KafkaClientTypes.S3?
...
extension KafkaClientTypes {
    ...
    public struct BrokerNodeGroupInfo: Swift.Equatable {
        /// The distribution of broker nodes across Availability Zones. This is an optional parameter. If you don't specify it, Amazon MSK gives it the value DEFAULT. You can also explicitly set this parameter to the value DEFAULT. No other values are currently allowed. Amazon MSK distributes the broker nodes evenly across the Availability Zones that correspond to the subnets you provide when you create the cluster.
        var brokerAZDistribution: KafkaClientTypes.BrokerAZDistribution?
        /// The list of subnets to connect to in the client virtual private cloud (VPC). AWS creates elastic network interfaces inside these subnets. Client applications use elastic network interfaces to produce and consume data. Client subnets can't be in Availability Zone us-east-1e.
        /// This member is required.
        var clientSubnets: [Swift.String]?
        /// Information about the broker access configuration.
        var connectivityInfo: KafkaClientTypes.ConnectivityInfo?
        ...
        var storageInfo: KafkaClientTypes.StorageInfo?
...
extension KafkaClientTypes {
    ...
    public struct BrokerNodeInfo: Swift.Equatable {
        ...
        var attachedENIId: Swift.String?
        /// The ID of the broker.
        var brokerId: Swift.Double?
        /// The client subnet to which this broker node belongs.
        var clientSubnet: Swift.String?
        /// The virtual private cloud (VPC) of the client.
        var clientVpcIpAddress: Swift.String?
        /// Information about the version of software currently deployed on the Apache Kafka brokers in the cluster.
        var currentBrokerSoftwareInfo: KafkaClientTypes.BrokerSoftwareInfo?
        /// Endpoints for accessing the broker.
        var endpoints: [Swift.String]?
...
extension KafkaClientTypes {
    ...
    public struct BrokerSoftwareInfo: Swift.Equatable {
        ...
        var configurationArn: Swift.String?
        /// The revision of the configuration to use. This field isn't visible in this preview release.
        var configurationRevision: Swift.Int?
        /// The version of Apache Kafka.
        var kafkaVersion: Swift.String?
...
extension KafkaClientTypes {
    ...
    public struct ClientAuthentication: Swift.Equatable {
        ...
        var sasl: KafkaClientTypes.Sasl?
        /// Details for ClientAuthentication using TLS.
        var tls: KafkaClientTypes.Tls?
        /// Contains information about unauthenticated traffic to the cluster.
        var unauthenticated: KafkaClientTypes.Unauthenticated?
...
extension KafkaClientTypes {
    ...
    public struct Cluster: Swift.Equatable {
        ...
        var activeOperationArn: Swift.String?
        /// The Amazon Resource Name (ARN) that uniquely identifies the cluster.
        var clusterArn: Swift.String?
        /// The name of the cluster.
        var clusterName: Swift.String?
        /// Cluster Type.
        var clusterType: KafkaClientTypes.ClusterType?
        /// The time when the cluster was created.
        var creationTime: ClientRuntime.Date?
        /// The current version of the MSK cluster.
        var currentVersion: Swift.String?
        /// Information about the provisioned cluster.
        var provisioned: KafkaClientTypes.Provisioned?
        /// Information about the serverless cluster.
        var serverless: KafkaClientTypes.Serverless?
        /// The state of the cluster. The possible states are ACTIVE, CREATING, DELETING, FAILED, HEALING, MAINTENANCE, REBOOTING_BROKER, and UPDATING.
        var state: KafkaClientTypes.ClusterState?
        /// State Info for the Amazon MSK cluster.
        var stateInfo: KafkaClientTypes.StateInfo?
...
extension KafkaClientTypes {
    ...
    public struct ClusterInfo: Swift.Equatable {
        ...
        var brokerNodeGroupInfo: KafkaClientTypes.BrokerNodeGroupInfo?
        /// Includes all client authentication information.
        var clientAuthentication: KafkaClientTypes.ClientAuthentication?
        /// The Amazon Resource Name (ARN) that uniquely identifies the cluster.
        var clusterArn: Swift.String?
        /// The name of the cluster.
        var clusterName: Swift.String?
        ...
        var encryptionInfo: KafkaClientTypes.EncryptionInfo?
        /// Specifies which metrics are gathered for the MSK cluster. This property has the following possible values: DEFAULT, PER_BROKER, PER_TOPIC_PER_BROKER, and PER_TOPIC_PER_PARTITION. For a list of the metrics associated with each of these levels of monitoring, see [Monitoring](https://docs.aws.amazon.com/msk/latest/developerguide/monitoring.html).
        var enhancedMonitoring: KafkaClientTypes.EnhancedMonitoring?
        var loggingInfo: KafkaClientTypes.LoggingInfo?
        /// The number of broker nodes in the cluster.
        var numberOfBrokerNodes: Swift.Int?
        /// Settings for open monitoring using Prometheus.
        var openMonitoring: KafkaClientTypes.OpenMonitoring?
        /// The state of the cluster. The possible states are ACTIVE, CREATING, DELETING, FAILED, HEALING, MAINTENANCE, REBOOTING_BROKER, and UPDATING.
        var state: KafkaClientTypes.ClusterState?
        var stateInfo: KafkaClientTypes.StateInfo?
        /// Tags attached to the cluster.
        ...
        var zookeeperConnectString: Swift.String?
        /// The connection string to use to connect to zookeeper cluster on Tls port.
        var zookeeperConnectStringTls: Swift.String?
...
extension KafkaClientTypes {
    ...
    public struct ClusterOperationInfo: Swift.Equatable {
        ...
        var clientRequestId: Swift.String?
        /// ARN of the cluster.
        var clusterArn: Swift.String?
        ...
        var errorInfo: KafkaClientTypes.ErrorInfo?
        /// ARN of the cluster operation.
        var operationArn: Swift.String?
        /// State of the cluster operation.
        var operationState: Swift.String?
        /// Steps completed during the operation.
        var operationSteps: [KafkaClientTypes.ClusterOperationStep]?
        /// Type of the cluster operation.
        var operationType: Swift.String?
        /// Information about cluster attributes before a cluster is updated.
        var sourceClusterInfo: KafkaClientTypes.MutableClusterInfo?
        /// Information about cluster attributes after a cluster is updated.
        var targetClusterInfo: KafkaClientTypes.MutableClusterInfo?
...
extension KafkaClientTypes {
    ...
    public struct ClusterOperationStep: Swift.Equatable {
        ...
        var stepInfo: KafkaClientTypes.ClusterOperationStepInfo?
        /// The name of the step.
        var stepName: Swift.String?
...
extension KafkaClientTypes {
    ...
    public struct CompatibleKafkaVersion: Swift.Equatable {
        ...
        var targetVersions: [Swift.String]?
...
extension KafkaClientTypes {
    ...
    public struct Configuration: Swift.Equatable {
        ...
        /// This member is required.
        var kafkaVersions: [Swift.String]?
        /// Latest revision of the configuration.
        /// This member is required.
        var latestRevision: KafkaClientTypes.ConfigurationRevision?
        /// The name of the configuration.
        /// This member is required.
        var name: Swift.String?
        /// The state of the configuration. The possible states are ACTIVE, DELETING, and DELETE_FAILED.
        /// This member is required.
        var state: KafkaClientTypes.ConfigurationState?
...
extension KafkaClientTypes {
    ...
    public struct ConnectivityInfo: Swift.Equatable {
        ...
        var publicAccess: KafkaClientTypes.PublicAccess?
...
public struct CreateClusterInput: Swift.Equatable {
    ...
    var configurationInfo: KafkaClientTypes.ConfigurationInfo?
    /// Includes all encryption-related information.
    var encryptionInfo: KafkaClientTypes.EncryptionInfo?
    ...
    var openMonitoring: KafkaClientTypes.OpenMonitoringInfo?
...
public struct CreateClusterV2Input: Swift.Equatable {
    ...
    var clusterName: Swift.String?
    /// Information about the provisioned cluster.
    var provisioned: KafkaClientTypes.ProvisionedRequest?
    /// Information about the serverless cluster.
    var serverless: KafkaClientTypes.ServerlessRequest?
...
public struct CreateConfigurationInput: Swift.Equatable {
    ...
    /// This member is required.
    var serverProperties: ClientRuntime.Data?
...
public struct DescribeClusterOperationInput: Swift.Equatable {
    ...
    /// This member is required.
    var clusterOperationArn: Swift.String?
...
public struct DescribeClusterOperationOutputResponse: Swift.Equatable {
    ...
    var clusterOperationInfo: KafkaClientTypes.ClusterOperationInfo?
...
public struct DescribeClusterOutputResponse: Swift.Equatable {
    ...
    var clusterInfo: KafkaClientTypes.ClusterInfo?
...
public struct DescribeClusterV2OutputResponse: Swift.Equatable {
    /// The cluster information.
    var clusterInfo: KafkaClientTypes.Cluster?
...
extension KafkaClientTypes {
    ...
    public struct EncryptionAtRest: Swift.Equatable {
        ...
        /// This member is required.
        var dataVolumeKMSKeyId: Swift.String?
...
extension KafkaClientTypes {
    ...
    public struct EncryptionInTransit: Swift.Equatable {
        ...
        var clientBroker: KafkaClientTypes.ClientBroker?
...
extension KafkaClientTypes {
    ...
    public struct EncryptionInfo: Swift.Equatable {
        /// The data-volume encryption details.
        var encryptionAtRest: KafkaClientTypes.EncryptionAtRest?
        /// The details for encryption in transit.
        var encryptionInTransit: KafkaClientTypes.EncryptionInTransit?
...
public struct GetBootstrapBrokersOutputResponse: Swift.Equatable {
    ...
    var bootstrapBrokerString: Swift.String?
    /// A string that contains one or more DNS names (or IP addresses) and SASL IAM port pairs.
    var bootstrapBrokerStringPublicSaslIam: Swift.String?
    /// A string containing one or more DNS names (or IP) and Sasl Scram port pairs.
    var bootstrapBrokerStringPublicSaslScram: Swift.String?
    /// A string containing one or more DNS names (or IP) and TLS port pairs.
    var bootstrapBrokerStringPublicTls: Swift.String?
    /// A string that contains one or more DNS names (or IP addresses) and SASL IAM port pairs.
    var bootstrapBrokerStringSaslIam: Swift.String?
    /// A string containing one or more DNS names (or IP) and Sasl Scram port pairs.
    var bootstrapBrokerStringSaslScram: Swift.String?
    /// A string containing one or more DNS names (or IP) and TLS port pairs.
    var bootstrapBrokerStringTls: Swift.String?
...
public struct GetCompatibleKafkaVersionsOutputResponse: Swift.Equatable {
    ...
    var compatibleKafkaVersions: [KafkaClientTypes.CompatibleKafkaVersion]?
...
extension KafkaClientTypes {
    ...
    public struct JmxExporter: Swift.Equatable {
        /// Indicates whether you want to turn on or turn off the JMX Exporter.
        /// This member is required.
        var enabledInBroker: Swift.Bool?
...
extension KafkaClientTypes {
    public struct KafkaVersion: Swift.Equatable {
        var status: KafkaClientTypes.KafkaVersionStatus?
...
public struct ListClusterOperationsOutputResponse: Swift.Equatable {
    ...
    var clusterOperationInfoList: [KafkaClientTypes.ClusterOperationInfo]?
...
public struct ListClustersInput: Swift.Equatable {
    ...
    var clusterNameFilter: Swift.String?
    /// The maximum number of results to return in the response. If there are more results, the response includes a NextToken parameter.
    var maxResults: Swift.Int?
    /// The paginated results marker. When the result of the operation is truncated, the call returns NextToken in the response. To get the next batch, provide this token in your next request.
    var nextToken: Swift.String?
...
public struct ListClustersOutputResponse: Swift.Equatable {
    ...
    var clusterInfoList: [KafkaClientTypes.ClusterInfo]?
...
public struct ListClustersV2Input: Swift.Equatable {
    ...
    var clusterTypeFilter: Swift.String?
    /// The maximum number of results to return in the response. If there are more results, the response includes a NextToken parameter.
    var maxResults: Swift.Int?
    /// The paginated results marker. When the result of the operation is truncated, the call returns NextToken in the response. To get the next batch, provide this token in your next request.
    var nextToken: Swift.String?
...
public struct ListClustersV2OutputResponse: Swift.Equatable {
    /// Information on each of the MSK clusters in the response.
    var clusterInfoList: [KafkaClientTypes.Cluster]?
    /// The paginated results marker. When the result of a ListClusters operation is truncated, the call returns NextToken in the response. To get another batch of clusters, provide this token in your next request.
    var nextToken: Swift.String?
...
public struct ListConfigurationRevisionsOutputResponse: Swift.Equatable {
    ...
    var revisions: [KafkaClientTypes.ConfigurationRevision]?
...
public struct ListConfigurationsOutputResponse: Swift.Equatable {
    ...
    var configurations: [KafkaClientTypes.Configuration]?
...
public struct ListKafkaVersionsOutputResponse: Swift.Equatable {
    var kafkaVersions: [KafkaClientTypes.KafkaVersion]?
    var nextToken: Swift.String?
...
public struct ListNodesOutputResponse: Swift.Equatable {
    ...
    var nodeInfoList: [KafkaClientTypes.NodeInfo]?
...
extension KafkaClientTypes {
    public struct LoggingInfo: Swift.Equatable {
        /// This member is required.
        var brokerLogs: KafkaClientTypes.BrokerLogs?
...
extension KafkaClientTypes {
    ...
    public struct MutableClusterInfo: Swift.Equatable {
        ...
        var brokerEBSVolumeInfo: [KafkaClientTypes.BrokerEBSVolumeInfo]?
        /// Includes all client authentication information.
        var clientAuthentication: KafkaClientTypes.ClientAuthentication?
...
extension KafkaClientTypes {
    ...
    public struct NodeInfo: Swift.Equatable {
        /// The start time.
        var addedToClusterTime: Swift.String?
        /// The broker node info.
        var brokerNodeInfo: KafkaClientTypes.BrokerNodeInfo?
        /// The instance type.
        var instanceType: Swift.String?
        /// The Amazon Resource Name (ARN) of the node.
        var nodeARN: Swift.String?
        /// The node type.
        var nodeType: KafkaClientTypes.NodeType?
        /// The ZookeeperNodeInfo.
        var zookeeperNodeInfo: KafkaClientTypes.ZookeeperNodeInfo?
...
extension KafkaClientTypes {
    ...
    public struct OpenMonitoring: Swift.Equatable {
        /// Prometheus settings.
        /// This member is required.
        var prometheus: KafkaClientTypes.Prometheus?
...
extension KafkaClientTypes {
    ...
    public struct OpenMonitoringInfo: Swift.Equatable {
        /// Prometheus settings.
        /// This member is required.
        var prometheus: KafkaClientTypes.PrometheusInfo?
...
extension KafkaClientTypes {
    ...
    public struct Prometheus: Swift.Equatable {
        /// Indicates whether you want to turn on or turn off the JMX Exporter.
        var jmxExporter: KafkaClientTypes.JmxExporter?
        /// Indicates whether you want to turn on or turn off the Node Exporter.
        var nodeExporter: KafkaClientTypes.NodeExporter?
...
extension KafkaClientTypes {
    ...
    public struct PrometheusInfo: Swift.Equatable {
        /// Indicates whether you want to turn on or turn off the JMX Exporter.
        var jmxExporter: KafkaClientTypes.JmxExporterInfo?
        /// Indicates whether you want to turn on or turn off the Node Exporter.
        var nodeExporter: KafkaClientTypes.NodeExporterInfo?
...
extension KafkaClientTypes {
    ...
    public struct Sasl: Swift.Equatable {
        /// Indicates whether IAM access control is enabled.
        var iam: KafkaClientTypes.Iam?
        /// Details for SASL/SCRAM client authentication.
        var scram: KafkaClientTypes.Scram?
...
extension KafkaClientTypes {
    ...
    public struct Serverless: Swift.Equatable {
        /// Includes all client authentication information.
        var clientAuthentication: KafkaClientTypes.ServerlessClientAuthentication?
        /// The configuration of the Amazon VPCs for the cluster.
        /// This member is required.
        var vpcConfigs: [KafkaClientTypes.VpcConfig]?
...
extension KafkaClientTypes {
    ...
    public struct ServerlessClientAuthentication: Swift.Equatable {
        /// Details for ClientAuthentication using SASL.
        var sasl: KafkaClientTypes.ServerlessSasl?
...
extension KafkaClientTypes {
    ...
    public struct StorageInfo: Swift.Equatable {
        ...
        var ebsStorageInfo: KafkaClientTypes.EBSStorageInfo?
...
extension KafkaClientTypes {
    ...
    public struct Tls: Swift.Equatable {
        ...
        var certificateAuthorityArnList: [Swift.String]?
...
public struct UpdateBrokerCountInput: Swift.Equatable {
    ...
    /// This member is required.
    var targetNumberOfBrokerNodes: Swift.Int?
...
public struct UpdateBrokerStorageInput: Swift.Equatable {
    ...
    /// This member is required.
    var targetBrokerEBSVolumeInfo: [KafkaClientTypes.BrokerEBSVolumeInfo]?
...
public struct UpdateBrokerTypeInput: Swift.Equatable {
    ...
    /// This member is required.
    var targetInstanceType: Swift.String?
...
public struct UpdateClusterKafkaVersionInput: Swift.Equatable {
    ...
    /// This member is required.
    var targetKafkaVersion: Swift.String?
...
extension KafkaClientTypes {
    ...
    public struct ZookeeperNodeInfo: Swift.Equatable {
        ...
        var zookeeperId: Swift.Double?
        /// The version of Zookeeper.
        var zookeeperVersion: Swift.String?
