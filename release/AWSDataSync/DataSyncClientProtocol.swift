...
public protocol DataSyncClientProtocol {
    ...
    func createLocationHdfs(input: CreateLocationHdfsInput, completion: @escaping (ClientRuntime.SdkResult<CreateLocationHdfsOutputResponse, CreateLocationHdfsOutputError>) -> Void)
    ...
    func describeLocationHdfs(input: DescribeLocationHdfsInput, completion: @escaping (ClientRuntime.SdkResult<DescribeLocationHdfsOutputResponse, DescribeLocationHdfsOutputError>) -> Void)
    ...
    func updateLocationHdfs(input: UpdateLocationHdfsInput, completion: @escaping (ClientRuntime.SdkResult<UpdateLocationHdfsOutputResponse, UpdateLocationHdfsOutputError>) -> Void)
