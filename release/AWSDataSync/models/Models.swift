...
extension DataSyncClientTypes {
    ...
    public struct AgentListEntry: Swift.Equatable {
        ...
        var agentArn: Swift.String?
        /// The name of the agent.
        var name: Swift.String?
        /// The status of the agent.
        var status: DataSyncClientTypes.AgentStatus?
...
public struct CancelTaskExecutionInput: Swift.Equatable {
    ...
    var taskExecutionArn: Swift.String?
...
public struct CreateAgentInput: Swift.Equatable {
    ...
    var securityGroupArns: [Swift.String]?
    ...
    var tags: [DataSyncClientTypes.TagListEntry]?
...
public struct CreateLocationEfsInput: Swift.Equatable {
    ...
    /// This member is required.
    var ec2Config: DataSyncClientTypes.Ec2Config?
    /// The Amazon Resource Name (ARN) for the Amazon EFS file system.
    /// This member is required.
    var efsFilesystemArn: Swift.String?
...
public struct CreateLocationFsxWindowsInput: Swift.Equatable {
    ...
    /// This member is required.
    var fsxFilesystemArn: Swift.String?
...
public struct CreateLocationHdfsInput: Swift.Equatable {
    ...
    /// This member is required.
    var agentArns: [Swift.String]?
    /// The type of authentication used to determine the identity of the user.
    /// This member is required.
    var authenticationType: DataSyncClientTypes.HdfsAuthenticationType?
    ...
    var kerberosKeytab: ClientRuntime.Data?
    ...
    var kerberosKrb5Conf: ClientRuntime.Data?
    ...
    var kerberosPrincipal: Swift.String?
    /// The URI of the HDFS cluster's Key Management Server (KMS).
    var kmsKeyProviderUri: Swift.String?
    /// The NameNode that manages the HDFS namespace. The NameNode performs operations such as opening, closing, and renaming files and directories. The NameNode contains the information to map blocks of data to the DataNodes. You can use only one NameNode.
    /// This member is required.
    var nameNodes: [DataSyncClientTypes.HdfsNameNode]?
    /// The Quality of Protection (QOP) configuration specifies the Remote Procedure Call (RPC) and data transfer protection settings configured on the Hadoop Distributed File System (HDFS) cluster. If QopConfiguration isn't specified, RpcProtection and DataTransferProtection default to PRIVACY. If you set RpcProtection or DataTransferProtection, the other parameter assumes the same value.
    var qopConfiguration: DataSyncClientTypes.QopConfiguration?
    /// The number of DataNodes to replicate the data to when writing to the HDFS cluster. By default, data is replicated to three DataNodes.
    var replicationFactor: Swift.Int?
...
public struct CreateLocationNfsInput: Swift.Equatable {
    ...
    var mountOptions: DataSyncClientTypes.NfsMountOptions?
    ...
    /// This member is required.
    var onPremConfig: DataSyncClientTypes.OnPremConfig?
    ...
    /// This member is required.
    var serverHostname: Swift.String?
...
public struct CreateLocationObjectStorageInput: Swift.Equatable {
    ...
    var serverPort: Swift.Int?
    /// The protocol that the object storage server uses to communicate. Valid values are HTTP or HTTPS.
    var serverProtocol: DataSyncClientTypes.ObjectStorageServerProtocol?
...
public struct CreateLocationS3Input: Swift.Equatable {
    ...
    /// This member is required.
    var s3Config: DataSyncClientTypes.S3Config?
    ...
    var s3StorageClass: DataSyncClientTypes.S3StorageClass?
...
public struct CreateLocationSmbInput: Swift.Equatable {
    ...
    var mountOptions: DataSyncClientTypes.SmbMountOptions?
...
public struct CreateTaskInput: Swift.Equatable {
    ...
    /// This member is required.
    var destinationLocationArn: Swift.String?
    /// A list of filter rules that determines which files to exclude from a task. The list should contain a single filter string that consists of the patterns to exclude. The patterns are delimited by "|" (that is, a pipe), for example, "/folder1|/folder2".
    var excludes: [DataSyncClientTypes.FilterRule]?
    ...
    var includes: [DataSyncClientTypes.FilterRule]?
    ...
    var options: DataSyncClientTypes.Options?
    ...
    var schedule: DataSyncClientTypes.TaskSchedule?
    /// The Amazon Resource Name (ARN) of the source location for the task.
    /// This member is required.
    var sourceLocationArn: Swift.String?
...
public struct DescribeAgentOutputResponse: Swift.Equatable {
    ...
    var endpointType: DataSyncClientTypes.EndpointType?
    /// The time that the agent last connected to DataSync.
    var lastConnectionTime: ClientRuntime.Date?
    /// The name of the agent.
    var name: Swift.String?
    /// The subnet and the security group that DataSync used to access a VPC endpoint.
    var privateLinkConfig: DataSyncClientTypes.PrivateLinkConfig?
...
public struct DescribeTaskExecutionOutputResponse: Swift.Equatable {
    ...
    var filesTransferred: Swift.Int
    ...
    var result: DataSyncClientTypes.TaskExecutionResultDetail?
    ...
    var status: DataSyncClientTypes.TaskExecutionStatus?
...
public struct DescribeTaskOutputResponse: Swift.Equatable {
    ...
    var currentTaskExecutionArn: Swift.String?
    ...
    var destinationNetworkInterfaceArns: [Swift.String]?
    /// Errors that DataSync encountered during execution of the task. You can use this error code to help troubleshoot issues.
    var errorCode: Swift.String?
    /// Detailed description of an error that was encountered during the task execution. You can use this information to help troubleshoot issues.
    var errorDetail: Swift.String?
    /// A list of filter rules that determines which files to exclude from a task. The list should contain a single filter string that consists of the patterns to exclude. The patterns are delimited by "|" (that is, a pipe), for example, "/folder1|/folder2".
    var excludes: [DataSyncClientTypes.FilterRule]?
    /// A list of filter rules that determines which files to include when running a task. The pattern contains a single filter string that consists of the patterns to include. The patterns are delimited by "|" (that is, a pipe), for example, "/folder1|/folder2".
    var includes: [DataSyncClientTypes.FilterRule]?
    ...
    var sourceNetworkInterfaceArns: [Swift.String]?
    ...
    var status: DataSyncClientTypes.TaskStatus?
...
extension DataSyncClientTypes {
    ...
    public struct FilterRule: Swift.Equatable {
        ...
        var filterType: DataSyncClientTypes.FilterType?
...
public struct ListAgentsOutputResponse: Swift.Equatable {
    ...
    var agents: [DataSyncClientTypes.AgentListEntry]?
...
public struct ListLocationsInput: Swift.Equatable {
    ...
    var filters: [DataSyncClientTypes.LocationFilter]?
...
public struct ListLocationsOutputResponse: Swift.Equatable {
    ...
    var locations: [DataSyncClientTypes.LocationListEntry]?
...
public struct ListTaskExecutionsOutputResponse: Swift.Equatable {
    ...
    var taskExecutions: [DataSyncClientTypes.TaskExecutionListEntry]?
...
public struct ListTasksInput: Swift.Equatable {
    ...
    var filters: [DataSyncClientTypes.TaskFilter]?
...
public struct ListTasksOutputResponse: Swift.Equatable {
    ...
    var tasks: [DataSyncClientTypes.TaskListEntry]?
...
extension DataSyncClientTypes {
    ...
    public struct LocationFilter: Swift.Equatable {
        ...
        /// This member is required.
        var `operator`: DataSyncClientTypes.Operator?
        /// The name of the filter being used. Each API call supports a list of filters that are available for it (for example, LocationType for ListLocations).
        /// This member is required.
        var name: DataSyncClientTypes.LocationFilterName?
...
extension DataSyncClientTypes {
    ...
    public struct NfsMountOptions: Swift.Equatable {
        ...
        var version: DataSyncClientTypes.NfsVersion?
...
extension DataSyncClientTypes {
    ...
    public struct Options: Swift.Equatable {
        ...
        var atime: DataSyncClientTypes.Atime?
        ...
        var gid: DataSyncClientTypes.Gid?
        ...
        var logLevel: DataSyncClientTypes.LogLevel?
        ...
        var mtime: DataSyncClientTypes.Mtime?
        ...
        var overwriteMode: DataSyncClientTypes.OverwriteMode?
        ...
        var posixPermissions: DataSyncClientTypes.PosixPermissions?
        ...
        var preserveDeletedFiles: DataSyncClientTypes.PreserveDeletedFiles?
        ...
        var preserveDevices: DataSyncClientTypes.PreserveDevices?
        ...
        var securityDescriptorCopyFlags: DataSyncClientTypes.SmbSecurityDescriptorCopyFlags?
        ...
        var taskQueueing: DataSyncClientTypes.TaskQueueing?
        ...
        var transferMode: DataSyncClientTypes.TransferMode?
        ...
        var uid: DataSyncClientTypes.Uid?
        ...
        var verifyMode: DataSyncClientTypes.VerifyMode?
...
extension DataSyncClientTypes {
    ...
    public struct PrivateLinkConfig: Swift.Equatable {
        ...
        var privateLinkEndpoint: Swift.String?
...
extension DataSyncClientTypes {
    ...
    public struct QopConfiguration: Swift.Equatable {
        ...
        var dataTransferProtection: DataSyncClientTypes.HdfsDataTransferProtection?
        /// The RPC protection setting configured on the HDFS cluster. This setting corresponds to your hadoop.rpc.protection setting in your core-site.xml file on your Hadoop cluster.
        var rpcProtection: DataSyncClientTypes.HdfsRpcProtection?
...
extension DataSyncClientTypes {
    ...
    public struct S3Config: Swift.Equatable {
        ...
        /// This member is required.
        var bucketAccessRoleArn: Swift.String?
...
extension DataSyncClientTypes {
    ...
    public struct SmbMountOptions: Swift.Equatable {
        ...
        var version: DataSyncClientTypes.SmbVersion?
...
public struct StartTaskExecutionInput: Swift.Equatable {
    ...
    var includes: [DataSyncClientTypes.FilterRule]?
    /// Represents the options that are available to control the behavior of a [StartTaskExecution](https://docs.aws.amazon.com/datasync/latest/userguide/API_StartTaskExecution.html) operation. Behavior includes preserving metadata such as user ID (UID), group ID (GID), and file permissions, and also overwriting files in the destination, data integrity verification, and so on. A task has a set of default options associated with it. If you don't specify an option in [StartTaskExecution](https://docs.aws.amazon.com/datasync/latest/userguide/API_StartTaskExecution.html), the default value is used. You can override the defaults options on each task execution by specifying an overriding Options value to [StartTaskExecution](https://docs.aws.amazon.com/datasync/latest/userguide/API_StartTaskExecution.html).
    var overrideOptions: DataSyncClientTypes.Options?
...
extension DataSyncClientTypes {
    ...
    public struct TaskExecutionResultDetail: Swift.Equatable {
        ...
        var prepareDuration: Swift.Int?
        /// The status of the PREPARING phase.
        var prepareStatus: DataSyncClientTypes.PhaseStatus?
        /// The total time in milliseconds that DataSync took to transfer the file from the source to the destination location.
        var totalDuration: Swift.Int?
        /// The total time in milliseconds that DataSync spent in the TRANSFERRING phase.
        var transferDuration: Swift.Int?
        /// The status of the TRANSFERRING phase.
        var transferStatus: DataSyncClientTypes.PhaseStatus?
        /// The total time in milliseconds that DataSync spent in the VERIFYING phase.
        var verifyDuration: Swift.Int?
        /// The status of the VERIFYING phase.
        var verifyStatus: DataSyncClientTypes.PhaseStatus?
...
extension DataSyncClientTypes {
    ...
    public struct TaskFilter: Swift.Equatable {
        ...
        /// This member is required.
        var name: DataSyncClientTypes.TaskFilterName?
