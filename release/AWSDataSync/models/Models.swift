...
public struct CreateLocationNfsInput: Swift.Equatable {
    ...
    ///       an NFS server.
    ///          If you are copying data to or from your AWS Snowcone device, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/create-nfs-location.html#nfs-on-snowcone">NFS Server on AWS Snowcone for more information.
    /// This member is required.
...
public struct CreateLocationS3Input: Swift.Equatable {
    ...
    ///       agent on an AWS Outpost, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/deploy-agents.html#outposts-agent">Deploy your DataSync agent on AWS Outposts.
    public let agentArns: [Swift.String]?
...
public struct DescribeLocationS3OutputResponse: Swift.Equatable {
    ...
    ///       AWS Outpost, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/deploy-agents.html#outposts-agent">Deploy your DataSync agent on AWS Outposts.
    public let agentArns: [Swift.String]?
...
extension DataSyncClientTypes {
    ...
    public struct Options: Swift.Equatable {
        ...
        ///       information, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/create-s3-location.html#using-storage-classes">Considerations when working with Amazon S3 storage classes in DataSync  in the AWS DataSync User
        ///         Guide.
        ///          Default value: PRESERVE.
