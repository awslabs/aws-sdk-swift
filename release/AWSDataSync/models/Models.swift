...
extension DataSyncClientTypes {
    ...
    ///       array that contains a list of agents when the <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_ListAgents.html">ListAgents
    ///       operation is
    ///       called.
...
public struct CreateAgentInput: Swift.Equatable {
    ...
    /// The ARNs of the security groups used to protect your data transfer task subnets. See <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_Ec2Config.html#DataSync-Type-Ec2Config-SecurityGroupArns">SecurityGroupArns.
    ...
    ///       endpoint, see <a href="https://docs.aws.amazon.com/vpc/latest/userguide/endpoint-service.html#create-endpoint-service">Creating a VPC Endpoint Service Configuration in the Amazon VPC User Guide.
...
public struct CreateLocationFsxWindowsInput: Swift.Equatable {
    ...
    /// The password of the user who has the permissions to access files and folders in the FSx
    ...
    ///       folders, and metadata, see <a href="create-fsx-location.html#FSxWuser">user.
    /// This member is required.
...
public struct CreateLocationNfsInput: Swift.Equatable {
    ...
    ///       an NFS server.
    ///          If you are copying data to or from your Snowcone device, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/create-nfs-location.html#nfs-on-snowcone">NFS Server on Snowcone for more information.
    /// This member is required.
...
public struct CreateLocationS3Input: Swift.Equatable {
    ...
    ///       agent on an Amazon Web Services Outpost, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/deploy-agents.html#outposts-agent">Deploy your DataSync agent on Outposts.
    public var agentArns: [Swift.String]?
    ...
    ///
    ///          For more information about S3 storage classes, see <a href="http://aws.amazon.com/s3/storage-classes/">Amazon S3 Storage Classes. Some storage classes have behaviors that
    ///       can affect your S3 storage cost. For detailed information, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/create-s3-location.html#using-storage-classes">Considerations when working with S3 storage classes in DataSync.
...
public struct CreateLocationSmbInput: Swift.Equatable {
    ...
    ///
    ///          For information about choosing a user name that ensures sufficient permissions to files,
    ///       folders, and metadata, see <a href="create-smb-location.html#SMBuser">user.
    /// This member is required.
    public var user: Swift.String?
...
public struct CreateTaskInput: Swift.Equatable {
    ...
    ///       the <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_StartTaskExecution.html">StartTaskExecution operation.
    ...
    ///       location. The schedule should be specified in UTC time. For more information, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/task-scheduling.html">Scheduling your task.
...
public struct DescribeLocationS3OutputResponse: Swift.Equatable {
    ...
    ///       Amazon Web Services Outpost, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/deploy-agents.html#outposts-agent">Deploy your DataSync agent on Outposts.
    public var agentArns: [Swift.String]?
    ...
    ///       used as a task destination. For more information about S3 storage classes, see <a href="http://aws.amazon.com/s3/storage-classes/">Amazon S3 Storage Classes. Some storage
...
public struct DescribeTaskExecutionOutputResponse: Swift.Equatable {
    ...
    ///       <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_StartTaskExecution.html">StartTaskExecution
    ...
    ///       in <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_StartTaskExecution.html">StartTaskExecution,
    ...
    ///       to <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_StartTaskExecution.html">StartTaskExecution.
    public var options: DataSyncClientTypes.Options?
...
public struct DescribeTaskOutputResponse: Swift.Equatable {
    ...
    ///       integrity verification, and so on.
    ///          For each individual task execution, you can override these options by specifying the
    ///       overriding OverrideOptions value to <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_StartTaskExecution.html">StartTaskExecution operation.
    public var options: DataSyncClientTypes.Options?
...
extension DataSyncClientTypes {
    ...
    public struct LocationFilter: Swift.Equatable {
        ...
        ///       <a href="https://docs.aws.amazon.com/datasync/latest/userguide/query-resources.html">API filters for ListTasks and ListLocations.
        /// This member is required.
...
extension DataSyncClientTypes {
    ...
    ///       <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_ListLocations.html">ListLocations
    ///       operation is called.
    public struct LocationListEntry: Swift.Equatable {
        ...
        ///       contains a list of locations when the <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_ListLocations.html">ListLocations operation is
        ///       called.
...
extension DataSyncClientTypes {
    ...
    public struct NfsMountOptions: Swift.Equatable {
        ...
        ///
        ///
        ///                      <a href="https://tools.ietf.org/html/rfc1813">NFSv3
        ...
        ///
        ///
        ///                      <a href="https://tools.ietf.org/html/rfc3530">NFSv4.0
        ...
        ///
        ///
        ///                      <a href="https://tools.ietf.org/html/rfc5661">NFSv4.1
...
extension DataSyncClientTypes {
    ...
    public struct Options: Swift.Equatable {
        ...
        ///       see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/special-files.html#metadata-copied">Metadata Copied by DataSync.
        ...
        ///       for DataSync, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_CreateTask.html#DataSync-CreateTask-request-CloudWatchLogGroupArn">CloudWatchLogGroupArn. If set to OFF, no logs are published.
        ...
        ///       <a href="https://docs.aws.amazon.com/datasync/latest/userguide/create-s3-location.html#using-storage-classes">Considerations when working with Amazon S3 storage classes in DataSync
        ///       in the DataSync
        ///         User Guide.
        ...
        ///         <a href="https://docs.aws.amazon.com/datasync/latest/userguide/special-files.html#metadata-copied">Metadata Copied by DataSync.
        ///          Default value: PRESERVE.
        ...
        ///       information, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/create-s3-location.html#using-storage-classes">Considerations when working with Amazon S3 storage classes in DataSync  in the DataSync User
        ///         Guide.
        ///          Default value: PRESERVE.
        ...
        ///       <a href="https://docs.aws.amazon.com/datasync/latest/userguide/special-files.html">How DataSync Handles Metadata and Special Files.
        ///
        ...
        ///       sufficient permissions to files, folders, and metadata, see <a href="create-smb-location.html#SMBuser">user.
        ///
        ///
        ...
        ///       <a href="https://docs.aws.amazon.com/datasync/latest/userguide/run-task.html#queue-task-execution">Queueing task executions.
        ...
        ///       EFS, and S3 locations. To learn more about what metadata is copied by DataSync, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/special-files.html#metadata-copied">Metadata Copied by DataSync.
        ///          Default value: INT_VALUE. This preserves the integer value of the ID.
        ...
        ///       <a href="https://docs.aws.amazon.com/datasync/latest/userguide/create-task.html">Configure task settings.
        ///
...
extension DataSyncClientTypes {
    ...
    public struct PrivateLinkConfig: Swift.Equatable {
        ...
        ///         <a href="https://docs.aws.amazon.com/vpc/latest/userguide/endpoint-service.html">PrivateLink. An agent that is configured with this endpoint will not be accessible
...
extension DataSyncClientTypes {
    ...
    public struct S3Config: Swift.Equatable {
        ...
        ///       <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_CreateLocationS3.html">CreateLocationS3
        ///       operation.
        /// This member is required.
...
extension DataSyncClientTypes {
    ...
    ///       <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_ListTagsForResource.html">ListTagsForResource
    ///       operation is called.
...
extension DataSyncClientTypes {
    ...
    ///       <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_ListTaskExecutions.html">ListTaskExecutions
    ///       operation is called.
...
extension DataSyncClientTypes {
    ...
    ///       array that contains a list of tasks when the <a href="https://docs.aws.amazon.com/datasync/latest/userguide/API_ListTasks.html">ListTasks operation is called.
...
extension DataSyncClientTypes {
    ...
    ///       information, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/events/ScheduledEvents.html">Schedule Expressions for Rules.
    public struct TaskSchedule: Swift.Equatable {
        /// A cron expression that specifies when DataSync initiates a scheduled transfer from a
...
public struct UpdateTaskInput: Swift.Equatable {
    ...
    ///       specify is UTC time. For more information, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/task-scheduling.html">Scheduling your task.
    public var schedule: DataSyncClientTypes.TaskSchedule?
