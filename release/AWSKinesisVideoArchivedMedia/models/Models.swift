...
/// Kinesis Video Streams has throttled the request because you have exceeded a limit. Try making the call later. For information about limits, see <a href="http://docs.aws.amazon.com/kinesisvideostreams/latest/dg/limits.html">Kinesis Video Streams Limits.
...
public struct GetClipInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetClipInputURLHostMiddleware"
    ...
    public typealias MInput = GetClipInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetClipOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetClipOutputError>
}

public struct GetClipInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetClipInputURLPathMiddleware"
...
public struct GetDASHStreamingSessionURLInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDASHStreamingSessionURLInputURLHostMiddleware"
    ...
    public typealias MInput = GetDASHStreamingSessionURLInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetDASHStreamingSessionURLOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetDASHStreamingSessionURLOutputError>
}

public struct GetDASHStreamingSessionURLInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDASHStreamingSessionURLInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/getDASHStreamingSessionURL"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetHLSStreamingSessionURLInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetHLSStreamingSessionURLInputURLHostMiddleware"
    ...
    public typealias MInput = GetHLSStreamingSessionURLInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetHLSStreamingSessionURLOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetHLSStreamingSessionURLOutputError>
}

public struct GetHLSStreamingSessionURLInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetHLSStreamingSessionURLInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/getHLSStreamingSessionURL"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetMediaForFragmentListInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMediaForFragmentListInputURLHostMiddleware"
    ...
    public typealias MInput = GetMediaForFragmentListInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetMediaForFragmentListOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetMediaForFragmentListOutputError>
}

public struct GetMediaForFragmentListInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMediaForFragmentListInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/getMediaForFragmentList"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetMediaForFragmentListOutputResponse: Swift.Equatable {
    ...
    ///             specified stream. For information about the chunks, see <a href="http://docs.aws.amazon.com/kinesisvideostreams/latest/dg/API_dataplane_PutMedia.html">PutMedia. The chunks that Kinesis Video Streams returns in the
...
public struct ListFragmentsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListFragmentsInputURLHostMiddleware"
    ...
    public typealias MInput = ListFragmentsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListFragmentsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListFragmentsOutputError>
}

public struct ListFragmentsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListFragmentsInputURLPathMiddleware"
...
public struct ListFragmentsInput: Swift.Equatable {
    ...
    ///             more than the value specified in max-results, then a ListFragmentsOutput$NextToken is provided in the output that you can use
