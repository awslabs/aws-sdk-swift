...
public protocol KinesisVideoArchivedMediaClientProtocol {
    ...
    func getImages(input: GetImagesInput) async throws -> GetImagesOutputResponse
...
public protocol KinesisVideoArchivedMediaClientConfigurationProtocol : AWSClientRuntime.AWSClientConfiguration {
