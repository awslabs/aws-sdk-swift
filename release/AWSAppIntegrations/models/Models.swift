...
public struct CreateDataIntegrationInput: Swift.Equatable {
    ...
    var scheduleConfig: AppIntegrationsClientTypes.ScheduleConfiguration?
    /// The URI of the data source.
    var sourceURI: Swift.String?
    /// One or more tags.
...
public struct CreateDataIntegrationOutputResponse: Swift.Equatable {
    ...
    var name: Swift.String?
    /// The name of the data and how often it should be pulled from the source.
    var scheduleConfiguration: AppIntegrationsClientTypes.ScheduleConfiguration?
    /// The URI of the data source.
    var sourceURI: Swift.String?
    /// One or more tags.
    var tags: [Swift.String:Swift.String]?
...
public struct CreateEventIntegrationInput: Swift.Equatable {
    ...
    /// The EventBridge bus.
    /// This member is required.
    var eventBridgeBus: Swift.String?
    /// The event filter.
    /// This member is required.
    var eventFilter: AppIntegrationsClientTypes.EventFilter?
...
public struct CreateEventIntegrationOutputResponse: Swift.Equatable {
    ...
    var eventIntegrationArn: Swift.String?
...
extension AppIntegrationsClientTypes {
    ...
    public struct DataIntegrationAssociationSummary: Swift.Equatable {
        ...
        var dataIntegrationArn: Swift.String?
        /// The Amazon Resource Name (ARN) of the DataIntegration association.
        var dataIntegrationAssociationArn: Swift.String?
...
public struct DeleteDataIntegrationInput: Swift.Equatable {
    ...
    /// This member is required.
    var dataIntegrationIdentifier: Swift.String?
...
extension AppIntegrationsClientTypes {
    ...
    public struct EventIntegrationAssociation: Swift.Equatable {
        ...
        var clientAssociationMetadata: [Swift.String:Swift.String]?
        /// The identifier for the client that is associated with the event integration.
        var clientId: Swift.String?
        /// The name of the EventBridge rule.
        var eventBridgeRuleName: Swift.String?
        /// The Amazon Resource Name (ARN) for the event integration association.
        var eventIntegrationAssociationArn: Swift.String?
        /// The identifier for the event integration association.
        var eventIntegrationAssociationId: Swift.String?
        /// The name of the event integration.
        var eventIntegrationName: Swift.String?
...
public struct ListDataIntegrationAssociationsOutputResponse: Swift.Equatable {
    ...
    var dataIntegrationAssociations: [AppIntegrationsClientTypes.DataIntegrationAssociationSummary]?
...
public struct ListDataIntegrationsOutputResponse: Swift.Equatable {
    ...
    var dataIntegrations: [AppIntegrationsClientTypes.DataIntegrationSummary]?
    /// If there are additional results, this is the token for the next set of results.
    var nextToken: Swift.String?
...
public struct ListEventIntegrationAssociationsOutputResponse: Swift.Equatable {
    ...
    var eventIntegrationAssociations: [AppIntegrationsClientTypes.EventIntegrationAssociation]?
    /// If there are additional results, this is the token for the next set of results.
    var nextToken: Swift.String?
...
public struct ListEventIntegrationsOutputResponse: Swift.Equatable {
    ...
    var eventIntegrations: [AppIntegrationsClientTypes.EventIntegration]?
    /// If there are additional results, this is the token for the next set of results.
    var nextToken: Swift.String?
...
extension AppIntegrationsClientTypes {
    ...
    public struct ScheduleConfiguration: Swift.Equatable {
        ...
        var firstExecutionFrom: Swift.String?
