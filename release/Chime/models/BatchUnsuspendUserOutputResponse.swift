...
public struct BatchUnsuspendUserOutputResponse: Equatable {
...
extension BatchUnsuspendUserOutputResponse: CustomDebugStringConvertible {
    public var debugDescription: String {
        "BatchUnsuspendUserOutputResponse(userErrors: \(String(describing: userErrors)))"}
}
