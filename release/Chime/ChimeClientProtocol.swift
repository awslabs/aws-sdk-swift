...
public protocol ChimeClientProtocol {
    ...
    func associatePhoneNumbersWithVoiceConnector(input: AssociatePhoneNumbersWithVoiceConnectorInput, completion: @escaping (SdkResult<AssociatePhoneNumbersWithVoiceConnectorOutput, AssociatePhoneNumbersWithVoiceConnectorOutputError>) -> Void)
    /// <p>Associates phone numbers with the specified Amazon Chime Voice Connector group.</p>
    func associatePhoneNumbersWithVoiceConnectorGroup(input: AssociatePhoneNumbersWithVoiceConnectorGroupInput, completion: @escaping (SdkResult<AssociatePhoneNumbersWithVoiceConnectorGroupOutput, AssociatePhoneNumbersWithVoiceConnectorGroupOutputError>) -> Void)
    /// <p>Associates a phone number with the specified Amazon Chime user.</p>
    func associatePhoneNumberWithUser(input: AssociatePhoneNumberWithUserInput, completion: @escaping (SdkResult<AssociatePhoneNumberWithUserOutput, AssociatePhoneNumberWithUserOutputError>) -> Void)
    /// <p>Associates the specified sign-in delegate groups with the specified Amazon Chime account.</p>
    func associateSigninDelegateGroupsWithAccount(input: AssociateSigninDelegateGroupsWithAccountInput, completion: @escaping (SdkResult<AssociateSigninDelegateGroupsWithAccountOutput, AssociateSigninDelegateGroupsWithAccountOutputError>) -> Void)
    /// <p>
    ...
    /// </p>
    func batchCreateAttendee(input: BatchCreateAttendeeInput, completion: @escaping (SdkResult<BatchCreateAttendeeOutput, BatchCreateAttendeeOutputError>) -> Void)
    /// <p>Adds a specified number of users to a channel. </p>
    func batchCreateChannelMembership(input: BatchCreateChannelMembershipInput, completion: @escaping (SdkResult<BatchCreateChannelMembershipOutput, BatchCreateChannelMembershipOutputError>) -> Void)
    ...
    func batchCreateRoomMembership(input: BatchCreateRoomMembershipInput, completion: @escaping (SdkResult<BatchCreateRoomMembershipOutput, BatchCreateRoomMembershipOutputError>) -> Void)
    /// <p>
    ...
    /// </p>
    func batchDeletePhoneNumber(input: BatchDeletePhoneNumberInput, completion: @escaping (SdkResult<BatchDeletePhoneNumberOutput, BatchDeletePhoneNumberOutputError>) -> Void)
    ...
    /// action.
    /// </p>
    func batchSuspendUser(input: BatchSuspendUserInput, completion: @escaping (SdkResult<BatchSuspendUserOutput, BatchSuspendUserOutputError>) -> Void)
    ...
    /// </p>
    func batchUnsuspendUser(input: BatchUnsuspendUserInput, completion: @escaping (SdkResult<BatchUnsuspendUserOutput, BatchUnsuspendUserOutputError>) -> Void)
    ...
    func batchUpdatePhoneNumber(input: BatchUpdatePhoneNumberInput, completion: @escaping (SdkResult<BatchUpdatePhoneNumberOutput, BatchUpdatePhoneNumberOutputError>) -> Void)
    /// <p>
    ...
    /// </p>
    func batchUpdateUser(input: BatchUpdateUserInput, completion: @escaping (SdkResult<BatchUpdateUserOutput, BatchUpdateUserOutputError>) -> Void)
    ...
    func createAppInstance(input: CreateAppInstanceInput, completion: @escaping (SdkResult<CreateAppInstanceOutput, CreateAppInstanceOutputError>) -> Void)
    ...
    func createAppInstanceAdmin(input: CreateAppInstanceAdminInput, completion: @escaping (SdkResult<CreateAppInstanceAdminOutput, CreateAppInstanceAdminOutputError>) -> Void)
    ...
    func createAppInstanceUser(input: CreateAppInstanceUserInput, completion: @escaping (SdkResult<CreateAppInstanceUserOutput, CreateAppInstanceUserOutputError>) -> Void)
    /// <p>
    ...
    /// <i>Amazon Chime Developer Guide</i>.
    /// </p>
    func createAttendee(input: CreateAttendeeInput, completion: @escaping (SdkResult<CreateAttendeeOutput, CreateAttendeeOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func createChannelBan(input: CreateChannelBanInput, completion: @escaping (SdkResult<CreateChannelBanOutput, CreateChannelBanOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func createChannelMembership(input: CreateChannelMembershipInput, completion: @escaping (SdkResult<CreateChannelMembershipOutput, CreateChannelMembershipOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func createChannelModerator(input: CreateChannelModeratorInput, completion: @escaping (SdkResult<CreateChannelModeratorOutput, CreateChannelModeratorOutputError>) -> Void)
    /// <p>
    ...
    /// .
    /// </p>
    func createMeeting(input: CreateMeetingInput, completion: @escaping (SdkResult<CreateMeetingOutput, CreateMeetingOutputError>) -> Void)
    ...
    func createMeetingDialOut(input: CreateMeetingDialOutInput, completion: @escaping (SdkResult<CreateMeetingDialOutOutput, CreateMeetingDialOutOutputError>) -> Void)
    /// <p>
    ...
    /// .
    /// </p>
    func createMeetingWithAttendees(input: CreateMeetingWithAttendeesInput, completion: @escaping (SdkResult<CreateMeetingWithAttendeesOutput, CreateMeetingWithAttendeesOutputError>) -> Void)
    ...
    ///             US,
    ///             you must use the Amazon Chime SIP Media Application Dial-In product type.</p>
    func createPhoneNumberOrder(input: CreatePhoneNumberOrderInput, completion: @escaping (SdkResult<CreatePhoneNumberOrderOutput, CreatePhoneNumberOrderOutputError>) -> Void)
    /// <p>Creates a proxy session on the specified Amazon Chime Voice Connector for the specified participant phone numbers.</p>
    func createProxySession(input: CreateProxySessionInput, completion: @escaping (SdkResult<CreateProxySessionOutput, CreateProxySessionOutputError>) -> Void)
    ...
    func createRoomMembership(input: CreateRoomMembershipInput, completion: @escaping (SdkResult<CreateRoomMembershipOutput, CreateRoomMembershipOutputError>) -> Void)
    /// <p>Creates a SIP media application.</p>
    func createSipMediaApplication(input: CreateSipMediaApplicationInput, completion: @escaping (SdkResult<CreateSipMediaApplicationOutput, CreateSipMediaApplicationOutputError>) -> Void)
    ...
    func createSipMediaApplicationCall(input: CreateSipMediaApplicationCallInput, completion: @escaping (SdkResult<CreateSipMediaApplicationCallOutput, CreateSipMediaApplicationCallOutputError>) -> Void)
    /// <p>Creates a SIP rule which can be used to run a SIP media application as a target for a specific trigger type.</p>
    func createSipRule(input: CreateSipRuleInput, completion: @escaping (SdkResult<CreateSipRuleOutput, CreateSipRuleOutputError>) -> Void)
    ...
    /// </p>
    func createVoiceConnector(input: CreateVoiceConnectorInput, completion: @escaping (SdkResult<CreateVoiceConnectorOutput, CreateVoiceConnectorOutputError>) -> Void)
    ...
    func createVoiceConnectorGroup(input: CreateVoiceConnectorGroupInput, completion: @escaping (SdkResult<CreateVoiceConnectorGroupOutput, CreateVoiceConnectorGroupOutputError>) -> Void)
    ...
    func deleteAccount(input: DeleteAccountInput, completion: @escaping (SdkResult<DeleteAccountOutput, DeleteAccountOutputError>) -> Void)
    /// <p>Deletes an <code>AppInstance</code> and all associated data asynchronously.</p>
    func deleteAppInstance(input: DeleteAppInstanceInput, completion: @escaping (SdkResult<DeleteAppInstanceOutput, DeleteAppInstanceOutputError>) -> Void)
    /// <p>Demotes an <code>AppInstanceAdmin</code> to an <code>AppInstanceUser</code>. This action does not delete the user.</p>
    func deleteAppInstanceAdmin(input: DeleteAppInstanceAdminInput, completion: @escaping (SdkResult<DeleteAppInstanceAdminOutput, DeleteAppInstanceAdminOutputError>) -> Void)
    /// <p>Deletes the streaming configurations of an <code>AppInstance</code>.</p>
    func deleteAppInstanceStreamingConfigurations(input: DeleteAppInstanceStreamingConfigurationsInput, completion: @escaping (SdkResult<DeleteAppInstanceStreamingConfigurationsOutput, DeleteAppInstanceStreamingConfigurationsOutputError>) -> Void)
    /// <p>Deletes an <code>AppInstanceUser</code>.</p>
    func deleteAppInstanceUser(input: DeleteAppInstanceUserInput, completion: @escaping (SdkResult<DeleteAppInstanceUserOutput, DeleteAppInstanceUserOutputError>) -> Void)
    ...
    func deleteAttendee(input: DeleteAttendeeInput, completion: @escaping (SdkResult<DeleteAttendeeOutput, DeleteAttendeeOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func deleteChannelBan(input: DeleteChannelBanInput, completion: @escaping (SdkResult<DeleteChannelBanOutput, DeleteChannelBanOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func deleteChannelMembership(input: DeleteChannelMembershipInput, completion: @escaping (SdkResult<DeleteChannelMembershipOutput, DeleteChannelMembershipOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func deleteChannelMessage(input: DeleteChannelMessageInput, completion: @escaping (SdkResult<DeleteChannelMessageOutput, DeleteChannelMessageOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func deleteChannelModerator(input: DeleteChannelModeratorInput, completion: @escaping (SdkResult<DeleteChannelModeratorOutput, DeleteChannelModeratorOutputError>) -> Void)
    /// <p>Deletes the events configuration that allows a bot to receive outgoing events.</p>
    func deleteEventsConfiguration(input: DeleteEventsConfigurationInput, completion: @escaping (SdkResult<DeleteEventsConfigurationOutput, DeleteEventsConfigurationOutputError>) -> Void)
    ...
    func deleteMeeting(input: DeleteMeetingInput, completion: @escaping (SdkResult<DeleteMeetingOutput, DeleteMeetingOutputError>) -> Void)
    ...
    func deletePhoneNumber(input: DeletePhoneNumberInput, completion: @escaping (SdkResult<DeletePhoneNumberOutput, DeletePhoneNumberOutputError>) -> Void)
    /// <p>Deletes the specified proxy session from the specified Amazon Chime Voice Connector.</p>
    func deleteProxySession(input: DeleteProxySessionInput, completion: @escaping (SdkResult<DeleteProxySessionOutput, DeleteProxySessionOutputError>) -> Void)
    ...
    func deleteRoomMembership(input: DeleteRoomMembershipInput, completion: @escaping (SdkResult<DeleteRoomMembershipOutput, DeleteRoomMembershipOutputError>) -> Void)
    /// <p>Deletes a SIP media application.</p>
    func deleteSipMediaApplication(input: DeleteSipMediaApplicationInput, completion: @escaping (SdkResult<DeleteSipMediaApplicationOutput, DeleteSipMediaApplicationOutputError>) -> Void)
    /// <p>Deletes a SIP rule. You must disable a SIP rule before you can delete it.</p>
    func deleteSipRule(input: DeleteSipRuleInput, completion: @escaping (SdkResult<DeleteSipRuleOutput, DeleteSipRuleOutputError>) -> Void)
    ...
    ///             deleted.</p>
    func deleteVoiceConnector(input: DeleteVoiceConnectorInput, completion: @escaping (SdkResult<DeleteVoiceConnectorOutput, DeleteVoiceConnectorOutputError>) -> Void)
    /// <p>Deletes the emergency calling configuration details from the specified Amazon Chime Voice Connector.</p>
    func deleteVoiceConnectorEmergencyCallingConfiguration(input: DeleteVoiceConnectorEmergencyCallingConfigurationInput, completion: @escaping (SdkResult<DeleteVoiceConnectorEmergencyCallingConfigurationOutput, DeleteVoiceConnectorEmergencyCallingConfigurationOutputError>) -> Void)
    ...
    func deleteVoiceConnectorGroup(input: DeleteVoiceConnectorGroupInput, completion: @escaping (SdkResult<DeleteVoiceConnectorGroupOutput, DeleteVoiceConnectorGroupOutputError>) -> Void)
    ...
    ///          </note>
    func deleteVoiceConnectorOrigination(input: DeleteVoiceConnectorOriginationInput, completion: @escaping (SdkResult<DeleteVoiceConnectorOriginationOutput, DeleteVoiceConnectorOriginationOutputError>) -> Void)
    /// <p>Deletes the proxy configuration from the specified Amazon Chime Voice Connector.</p>
    func deleteVoiceConnectorProxy(input: DeleteVoiceConnectorProxyInput, completion: @escaping (SdkResult<DeleteVoiceConnectorProxyOutput, DeleteVoiceConnectorProxyOutputError>) -> Void)
    /// <p>Deletes the streaming configuration for the specified Amazon Chime Voice Connector.</p>
    func deleteVoiceConnectorStreamingConfiguration(input: DeleteVoiceConnectorStreamingConfigurationInput, completion: @escaping (SdkResult<DeleteVoiceConnectorStreamingConfigurationOutput, DeleteVoiceConnectorStreamingConfigurationOutputError>) -> Void)
    ...
    ///          </note>
    func deleteVoiceConnectorTermination(input: DeleteVoiceConnectorTerminationInput, completion: @escaping (SdkResult<DeleteVoiceConnectorTerminationOutput, DeleteVoiceConnectorTerminationOutputError>) -> Void)
    /// <p>Deletes the specified SIP credentials used by your equipment to authenticate during call termination.</p>
    func deleteVoiceConnectorTerminationCredentials(input: DeleteVoiceConnectorTerminationCredentialsInput, completion: @escaping (SdkResult<DeleteVoiceConnectorTerminationCredentialsOutput, DeleteVoiceConnectorTerminationCredentialsOutputError>) -> Void)
    /// <p>Returns the full details of an <code>AppInstance</code>.</p>
    func describeAppInstance(input: DescribeAppInstanceInput, completion: @escaping (SdkResult<DescribeAppInstanceOutput, DescribeAppInstanceOutputError>) -> Void)
    /// <p>Returns the full details of an <code>AppInstanceAdmin</code>.</p>
    func describeAppInstanceAdmin(input: DescribeAppInstanceAdminInput, completion: @escaping (SdkResult<DescribeAppInstanceAdminOutput, DescribeAppInstanceAdminOutputError>) -> Void)
    /// <p>
    /// Returns the full details of an
    /// <code>AppInstanceUser</code>
    /// .
    /// </p>
    func describeAppInstanceUser(input: DescribeAppInstanceUserInput, completion: @escaping (SdkResult<DescribeAppInstanceUserOutput, DescribeAppInstanceUserOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func describeChannelBan(input: DescribeChannelBanInput, completion: @escaping (SdkResult<DescribeChannelBanOutput, DescribeChannelBanOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func describeChannelMembership(input: DescribeChannelMembershipInput, completion: @escaping (SdkResult<DescribeChannelMembershipOutput, DescribeChannelMembershipOutputError>) -> Void)
    /// <p>
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func describeChannelMembershipForAppInstanceUser(input: DescribeChannelMembershipForAppInstanceUserInput, completion: @escaping (SdkResult<DescribeChannelMembershipForAppInstanceUserOutput, DescribeChannelMembershipForAppInstanceUserOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func describeChannelModeratedByAppInstanceUser(input: DescribeChannelModeratedByAppInstanceUserInput, completion: @escaping (SdkResult<DescribeChannelModeratedByAppInstanceUserOutput, DescribeChannelModeratedByAppInstanceUserOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func describeChannelModerator(input: DescribeChannelModeratorInput, completion: @escaping (SdkResult<DescribeChannelModeratorOutput, DescribeChannelModeratorOutputError>) -> Void)
    /// <p>Disassociates the primary provisioned phone number from the specified Amazon Chime
    ///             user.</p>
    func disassociatePhoneNumberFromUser(input: DisassociatePhoneNumberFromUserInput, completion: @escaping (SdkResult<DisassociatePhoneNumberFromUserOutput, DisassociatePhoneNumberFromUserOutputError>) -> Void)
    /// <p>Disassociates the specified phone numbers from the specified Amazon Chime Voice Connector.</p>
    func disassociatePhoneNumbersFromVoiceConnector(input: DisassociatePhoneNumbersFromVoiceConnectorInput, completion: @escaping (SdkResult<DisassociatePhoneNumbersFromVoiceConnectorOutput, DisassociatePhoneNumbersFromVoiceConnectorOutputError>) -> Void)
    /// <p>Disassociates the specified phone numbers from the specified Amazon Chime Voice Connector group.</p>
    func disassociatePhoneNumbersFromVoiceConnectorGroup(input: DisassociatePhoneNumbersFromVoiceConnectorGroupInput, completion: @escaping (SdkResult<DisassociatePhoneNumbersFromVoiceConnectorGroupOutput, DisassociatePhoneNumbersFromVoiceConnectorGroupOutputError>) -> Void)
    /// <p>Disassociates the specified sign-in delegate groups from the specified Amazon Chime account.</p>
    func disassociateSigninDelegateGroupsFromAccount(input: DisassociateSigninDelegateGroupsFromAccountInput, completion: @escaping (SdkResult<DisassociateSigninDelegateGroupsFromAccountOutput, DisassociateSigninDelegateGroupsFromAccountOutputError>) -> Void)
    ...
    func getAppInstanceRetentionSettings(input: GetAppInstanceRetentionSettingsInput, completion: @escaping (SdkResult<GetAppInstanceRetentionSettingsOutput, GetAppInstanceRetentionSettingsOutputError>) -> Void)
    /// <p>Gets the streaming settings for an <code>AppInstance</code>.</p>
    func getAppInstanceStreamingConfigurations(input: GetAppInstanceStreamingConfigurationsInput, completion: @escaping (SdkResult<GetAppInstanceStreamingConfigurationsOutput, GetAppInstanceStreamingConfigurationsOutputError>) -> Void)
    /// <p>
    ...
    /// .
    /// </p>
    func getAttendee(input: GetAttendeeInput, completion: @escaping (SdkResult<GetAttendeeOutput, GetAttendeeOutputError>) -> Void)
    ...
    ///          </note>
    func getChannelMessage(input: GetChannelMessageInput, completion: @escaping (SdkResult<GetChannelMessageOutput, GetChannelMessageOutputError>) -> Void)
    ...
    func getEventsConfiguration(input: GetEventsConfigurationInput, completion: @escaping (SdkResult<GetEventsConfigurationOutput, GetEventsConfigurationOutputError>) -> Void)
    ...
    func getGlobalSettings(input: GetGlobalSettingsInput, completion: @escaping (SdkResult<GetGlobalSettingsOutput, GetGlobalSettingsOutputError>) -> Void)
    /// <p>
    ...
    /// .
    /// </p>
    func getMeeting(input: GetMeetingInput, completion: @escaping (SdkResult<GetMeetingOutput, GetMeetingOutputError>) -> Void)
    /// <p>The details of the endpoint for the messaging session.</p>
    func getMessagingSessionEndpoint(input: GetMessagingSessionEndpointInput, completion: @escaping (SdkResult<GetMessagingSessionEndpointOutput, GetMessagingSessionEndpointOutputError>) -> Void)
    /// <p>Retrieves details for the specified phone number ID, such as associations, capabilities, and product type.</p>
    func getPhoneNumber(input: GetPhoneNumberInput, completion: @escaping (SdkResult<GetPhoneNumberOutput, GetPhoneNumberOutputError>) -> Void)
    ...
    func getPhoneNumberOrder(input: GetPhoneNumberOrderInput, completion: @escaping (SdkResult<GetPhoneNumberOrderOutput, GetPhoneNumberOrderOutputError>) -> Void)
    /// <p>Retrieves the phone number settings for the administrator's AWS account, such as the default outbound calling name.</p>
    func getPhoneNumberSettings(input: GetPhoneNumberSettingsInput, completion: @escaping (SdkResult<GetPhoneNumberSettingsOutput, GetPhoneNumberSettingsOutputError>) -> Void)
    /// <p>Gets the specified proxy session details for the specified Amazon Chime Voice Connector.</p>
    func getProxySession(input: GetProxySessionInput, completion: @escaping (SdkResult<GetProxySessionOutput, GetProxySessionOutputError>) -> Void)
    /// <p>
    ...
    /// .
    /// </p>
    func getRetentionSettings(input: GetRetentionSettingsInput, completion: @escaping (SdkResult<GetRetentionSettingsOutput, GetRetentionSettingsOutputError>) -> Void)
    ...
    func getSipMediaApplication(input: GetSipMediaApplicationInput, completion: @escaping (SdkResult<GetSipMediaApplicationOutput, GetSipMediaApplicationOutputError>) -> Void)
    /// <p>Returns the logging configuration for the specified SIP media application.</p>
    func getSipMediaApplicationLoggingConfiguration(input: GetSipMediaApplicationLoggingConfigurationInput, completion: @escaping (SdkResult<GetSipMediaApplicationLoggingConfigurationOutput, GetSipMediaApplicationLoggingConfigurationOutputError>) -> Void)
    /// <p>Retrieves the details of a SIP rule, such as the rule ID, name, triggers, and target endpoints.</p>
    func getSipRule(input: GetSipRuleInput, completion: @escaping (SdkResult<GetSipRuleOutput, GetSipRuleOutputError>) -> Void)
    ...
    func getUserSettings(input: GetUserSettingsInput, completion: @escaping (SdkResult<GetUserSettingsOutput, GetUserSettingsOutputError>) -> Void)
    ...
    func getVoiceConnector(input: GetVoiceConnectorInput, completion: @escaping (SdkResult<GetVoiceConnectorOutput, GetVoiceConnectorOutputError>) -> Void)
    /// <p>Gets the emergency calling configuration details for the specified Amazon Chime Voice Connector.</p>
    func getVoiceConnectorEmergencyCallingConfiguration(input: GetVoiceConnectorEmergencyCallingConfigurationInput, completion: @escaping (SdkResult<GetVoiceConnectorEmergencyCallingConfigurationOutput, GetVoiceConnectorEmergencyCallingConfigurationOutputError>) -> Void)
    /// <p>
    /// Retrieves details for the specified Amazon Chime Voice Connector group, such as timestamps,name, and associated
    /// <code>VoiceConnectorItems</code>
    /// .
    /// </p>
    func getVoiceConnectorGroup(input: GetVoiceConnectorGroupInput, completion: @escaping (SdkResult<GetVoiceConnectorGroupOutput, GetVoiceConnectorGroupOutputError>) -> Void)
    ...
    func getVoiceConnectorLoggingConfiguration(input: GetVoiceConnectorLoggingConfigurationInput, completion: @escaping (SdkResult<GetVoiceConnectorLoggingConfigurationOutput, GetVoiceConnectorLoggingConfigurationOutputError>) -> Void)
    /// <p>Retrieves origination setting details for the specified Amazon Chime Voice Connector.</p>
    func getVoiceConnectorOrigination(input: GetVoiceConnectorOriginationInput, completion: @escaping (SdkResult<GetVoiceConnectorOriginationOutput, GetVoiceConnectorOriginationOutputError>) -> Void)
    /// <p>Gets the proxy configuration details for the specified Amazon Chime Voice Connector.</p>
    func getVoiceConnectorProxy(input: GetVoiceConnectorProxyInput, completion: @escaping (SdkResult<GetVoiceConnectorProxyOutput, GetVoiceConnectorProxyOutputError>) -> Void)
    ...
    func getVoiceConnectorStreamingConfiguration(input: GetVoiceConnectorStreamingConfigurationInput, completion: @escaping (SdkResult<GetVoiceConnectorStreamingConfigurationOutput, GetVoiceConnectorStreamingConfigurationOutputError>) -> Void)
    /// <p>Retrieves termination setting details for the specified Amazon Chime Voice Connector.</p>
    func getVoiceConnectorTermination(input: GetVoiceConnectorTerminationInput, completion: @escaping (SdkResult<GetVoiceConnectorTerminationOutput, GetVoiceConnectorTerminationOutputError>) -> Void)
    ...
    func getVoiceConnectorTerminationHealth(input: GetVoiceConnectorTerminationHealthInput, completion: @escaping (SdkResult<GetVoiceConnectorTerminationHealthOutput, GetVoiceConnectorTerminationHealthOutputError>) -> Void)
    ...
    func inviteUsers(input: InviteUsersInput, completion: @escaping (SdkResult<InviteUsersOutput, InviteUsersOutputError>) -> Void)
    ...
    func listAppInstanceAdmins(input: ListAppInstanceAdminsInput, completion: @escaping (SdkResult<ListAppInstanceAdminsOutput, ListAppInstanceAdminsOutputError>) -> Void)
    /// <p>Lists all Amazon Chime <code>AppInstance</code>s created under a single AWS account.</p>
    func listAppInstances(input: ListAppInstancesInput, completion: @escaping (SdkResult<ListAppInstancesOutput, ListAppInstancesOutputError>) -> Void)
    /// <p>
    /// List all
    /// <code>AppInstanceUsers</code>
    /// created under a single <code>AppInstance</code>.
    /// </p>
    func listAppInstanceUsers(input: ListAppInstanceUsersInput, completion: @escaping (SdkResult<ListAppInstanceUsersOutput, ListAppInstanceUsersOutputError>) -> Void)
    /// <p>
    ...
    /// .
    /// </p>
    func listAttendees(input: ListAttendeesInput, completion: @escaping (SdkResult<ListAttendeesOutput, ListAttendeesOutputError>) -> Void)
    /// <p>Lists the tags applied to an Amazon Chime SDK attendee resource.</p>
    func listAttendeeTags(input: ListAttendeeTagsInput, completion: @escaping (SdkResult<ListAttendeeTagsOutput, ListAttendeeTagsOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func listChannelBans(input: ListChannelBansInput, completion: @escaping (SdkResult<ListChannelBansOutput, ListChannelBansOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func listChannelMemberships(input: ListChannelMembershipsInput, completion: @escaping (SdkResult<ListChannelMembershipsOutput, ListChannelMembershipsOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func listChannelMembershipsForAppInstanceUser(input: ListChannelMembershipsForAppInstanceUserInput, completion: @escaping (SdkResult<ListChannelMembershipsForAppInstanceUserOutput, ListChannelMembershipsForAppInstanceUserOutputError>) -> Void)
    ...
    ///         value in the header.</p>
    ///          </note>
    func listChannelMessages(input: ListChannelMessagesInput, completion: @escaping (SdkResult<ListChannelMessagesOutput, ListChannelMessagesOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func listChannelModerators(input: ListChannelModeratorsInput, completion: @escaping (SdkResult<ListChannelModeratorsOutput, ListChannelModeratorsOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func listChannelsModeratedByAppInstanceUser(input: ListChannelsModeratedByAppInstanceUserInput, completion: @escaping (SdkResult<ListChannelsModeratedByAppInstanceUserOutput, ListChannelsModeratedByAppInstanceUserOutputError>) -> Void)
    /// <p>
    ...
    /// .
    /// </p>
    func listMeetings(input: ListMeetingsInput, completion: @escaping (SdkResult<ListMeetingsOutput, ListMeetingsOutputError>) -> Void)
    /// <p>Lists the tags applied to an Amazon Chime SDK meeting resource.</p>
    func listMeetingTags(input: ListMeetingTagsInput, completion: @escaping (SdkResult<ListMeetingTagsOutput, ListMeetingTagsOutputError>) -> Void)
    /// <p>Lists the phone number orders for the administrator's Amazon Chime account.</p>
    func listPhoneNumberOrders(input: ListPhoneNumberOrdersInput, completion: @escaping (SdkResult<ListPhoneNumberOrdersOutput, ListPhoneNumberOrdersOutputError>) -> Void)
    ...
    func listProxySessions(input: ListProxySessionsInput, completion: @escaping (SdkResult<ListProxySessionsOutput, ListProxySessionsOutputError>) -> Void)
    ...
    func listRoomMemberships(input: ListRoomMembershipsInput, completion: @escaping (SdkResult<ListRoomMembershipsOutput, ListRoomMembershipsOutputError>) -> Void)
    ...
    func listRooms(input: ListRoomsInput, completion: @escaping (SdkResult<ListRoomsOutput, ListRoomsOutputError>) -> Void)
    /// <p>Lists the SIP media applications under the administrator's AWS account.</p>
    func listSipMediaApplications(input: ListSipMediaApplicationsInput, completion: @escaping (SdkResult<ListSipMediaApplicationsOutput, ListSipMediaApplicationsOutputError>) -> Void)
    /// <p>Lists the SIP rules under the administrator's AWS account.</p>
    func listSipRules(input: ListSipRulesInput, completion: @escaping (SdkResult<ListSipRulesOutput, ListSipRulesOutputError>) -> Void)
    /// <p>Lists supported phone number countries.</p>
    func listSupportedPhoneNumberCountries(input: ListSupportedPhoneNumberCountriesInput, completion: @escaping (SdkResult<ListSupportedPhoneNumberCountriesOutput, ListSupportedPhoneNumberCountriesOutputError>) -> Void)
    /// <p>Lists the tags applied to an Amazon Chime SDK meeting resource.</p>
    ...
    func listVoiceConnectorGroups(input: ListVoiceConnectorGroupsInput, completion: @escaping (SdkResult<ListVoiceConnectorGroupsOutput, ListVoiceConnectorGroupsOutputError>) -> Void)
    /// <p>Lists the Amazon Chime Voice Connectors for the administrator's AWS account.</p>
    func listVoiceConnectors(input: ListVoiceConnectorsInput, completion: @escaping (SdkResult<ListVoiceConnectorsOutput, ListVoiceConnectorsOutputError>) -> Void)
    /// <p>Lists the SIP credentials for the specified Amazon Chime Voice Connector.</p>
    func listVoiceConnectorTerminationCredentials(input: ListVoiceConnectorTerminationCredentialsInput, completion: @escaping (SdkResult<ListVoiceConnectorTerminationCredentialsOutput, ListVoiceConnectorTerminationCredentialsOutputError>) -> Void)
    /// <p>Logs out the specified user from all of the devices they are currently logged into.</p>
    func logoutUser(input: LogoutUserInput, completion: @escaping (SdkResult<LogoutUserOutput, LogoutUserOutputError>) -> Void)
    /// <p>Sets the amount of time in days that a given <code>AppInstance</code> retains data.</p>
    func putAppInstanceRetentionSettings(input: PutAppInstanceRetentionSettingsInput, completion: @escaping (SdkResult<PutAppInstanceRetentionSettingsOutput, PutAppInstanceRetentionSettingsOutputError>) -> Void)
    /// <p>The data streaming configurations of an <code>AppInstance</code>.</p>
    func putAppInstanceStreamingConfigurations(input: PutAppInstanceStreamingConfigurationsInput, completion: @escaping (SdkResult<PutAppInstanceStreamingConfigurationsOutput, PutAppInstanceStreamingConfigurationsOutputError>) -> Void)
    ...
    ///             see <a>Bot</a>.</p>
    func putEventsConfiguration(input: PutEventsConfigurationInput, completion: @escaping (SdkResult<PutEventsConfigurationOutput, PutEventsConfigurationOutputError>) -> Void)
    /// <p>
    ...
    /// .
    /// </p>
    func putRetentionSettings(input: PutRetentionSettingsInput, completion: @escaping (SdkResult<PutRetentionSettingsOutput, PutRetentionSettingsOutputError>) -> Void)
    /// <p>Updates the logging configuration for the specified SIP media application.</p>
    func putSipMediaApplicationLoggingConfiguration(input: PutSipMediaApplicationLoggingConfigurationInput, completion: @escaping (SdkResult<PutSipMediaApplicationLoggingConfigurationOutput, PutSipMediaApplicationLoggingConfigurationOutputError>) -> Void)
    ...
    func putVoiceConnectorEmergencyCallingConfiguration(input: PutVoiceConnectorEmergencyCallingConfigurationInput, completion: @escaping (SdkResult<PutVoiceConnectorEmergencyCallingConfigurationOutput, PutVoiceConnectorEmergencyCallingConfigurationOutputError>) -> Void)
    ...
    func putVoiceConnectorLoggingConfiguration(input: PutVoiceConnectorLoggingConfigurationInput, completion: @escaping (SdkResult<PutVoiceConnectorLoggingConfigurationOutput, PutVoiceConnectorLoggingConfigurationOutputError>) -> Void)
    ...
    ///          </note>
    func putVoiceConnectorOrigination(input: PutVoiceConnectorOriginationInput, completion: @escaping (SdkResult<PutVoiceConnectorOriginationOutput, PutVoiceConnectorOriginationOutputError>) -> Void)
    /// <p>Puts the specified proxy configuration to the specified Amazon Chime Voice Connector.</p>
    func putVoiceConnectorProxy(input: PutVoiceConnectorProxyInput, completion: @escaping (SdkResult<PutVoiceConnectorProxyOutput, PutVoiceConnectorProxyOutputError>) -> Void)
    ...
    func putVoiceConnectorStreamingConfiguration(input: PutVoiceConnectorStreamingConfigurationInput, completion: @escaping (SdkResult<PutVoiceConnectorStreamingConfigurationOutput, PutVoiceConnectorStreamingConfigurationOutputError>) -> Void)
    ...
    ///          </note>
    func putVoiceConnectorTermination(input: PutVoiceConnectorTerminationInput, completion: @escaping (SdkResult<PutVoiceConnectorTerminationOutput, PutVoiceConnectorTerminationOutputError>) -> Void)
    /// <p>Adds termination SIP credentials for the specified Amazon Chime Voice Connector.</p>
    func putVoiceConnectorTerminationCredentials(input: PutVoiceConnectorTerminationCredentialsInput, completion: @escaping (SdkResult<PutVoiceConnectorTerminationCredentialsOutput, PutVoiceConnectorTerminationCredentialsOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func redactChannelMessage(input: RedactChannelMessageInput, completion: @escaping (SdkResult<RedactChannelMessageOutput, RedactChannelMessageOutputError>) -> Void)
    /// <p>Redacts the specified message from the specified Amazon Chime conversation.</p>
    func redactConversationMessage(input: RedactConversationMessageInput, completion: @escaping (SdkResult<RedactConversationMessageOutput, RedactConversationMessageOutputError>) -> Void)
    /// <p>Redacts the specified message from the specified Amazon Chime channel.</p>
    func redactRoomMessage(input: RedactRoomMessageInput, completion: @escaping (SdkResult<RedactRoomMessageOutput, RedactRoomMessageOutputError>) -> Void)
    /// <p>Regenerates the security token for a bot.</p>
    func regenerateSecurityToken(input: RegenerateSecurityTokenInput, completion: @escaping (SdkResult<RegenerateSecurityTokenOutput, RegenerateSecurityTokenOutputError>) -> Void)
    ...
    func resetPersonalPIN(input: ResetPersonalPINInput, completion: @escaping (SdkResult<ResetPersonalPINOutput, ResetPersonalPINOutputError>) -> Void)
    /// <p>Moves a phone number from the <b>Deletion queue</b> back into the
    ///             phone number <b>Inventory</b>.</p>
    func restorePhoneNumber(input: RestorePhoneNumberInput, completion: @escaping (SdkResult<RestorePhoneNumberOutput, RestorePhoneNumberOutputError>) -> Void)
    ...
    func searchAvailablePhoneNumbers(input: SearchAvailablePhoneNumbersInput, completion: @escaping (SdkResult<SearchAvailablePhoneNumbersOutput, SearchAvailablePhoneNumbersOutputError>) -> Void)
    ...
    ///          </note>
    func sendChannelMessage(input: SendChannelMessageInput, completion: @escaping (SdkResult<SendChannelMessageOutput, SendChannelMessageOutputError>) -> Void)
    /// <p>Applies the specified tags to the specified Amazon Chime SDK attendee.</p>
    func tagAttendee(input: TagAttendeeInput, completion: @escaping (SdkResult<TagAttendeeOutput, TagAttendeeOutputError>) -> Void)
    /// <p>Applies the specified tags to the specified Amazon Chime SDK meeting.</p>
    func tagMeeting(input: TagMeetingInput, completion: @escaping (SdkResult<TagMeetingOutput, TagMeetingOutputError>) -> Void)
    ...
    func untagAttendee(input: UntagAttendeeInput, completion: @escaping (SdkResult<UntagAttendeeOutput, UntagAttendeeOutputError>) -> Void)
    /// <p>Untags the specified tags from the specified Amazon Chime SDK meeting.</p>
    func untagMeeting(input: UntagMeetingInput, completion: @escaping (SdkResult<UntagMeetingOutput, UntagMeetingOutputError>) -> Void)
    ...
    func updateAccount(input: UpdateAccountInput, completion: @escaping (SdkResult<UpdateAccountOutput, UpdateAccountOutputError>) -> Void)
    ...
    func updateAppInstance(input: UpdateAppInstanceInput, completion: @escaping (SdkResult<UpdateAppInstanceOutput, UpdateAppInstanceOutputError>) -> Void)
    /// <p>Updates the details of an <code>AppInstanceUser</code>. You can update names and metadata.</p>
    func updateAppInstanceUser(input: UpdateAppInstanceUserInput, completion: @escaping (SdkResult<UpdateAppInstanceUserOutput, UpdateAppInstanceUserOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func updateChannelMessage(input: UpdateChannelMessageInput, completion: @escaping (SdkResult<UpdateChannelMessageOutput, UpdateChannelMessageOutputError>) -> Void)
    ...
    ///         the API call as the value in the header.</p>
    ///          </note>
    func updateChannelReadMarker(input: UpdateChannelReadMarkerInput, completion: @escaping (SdkResult<UpdateChannelReadMarkerOutput, UpdateChannelReadMarkerOutputError>) -> Void)
    ...
    ///          <p>Updates to outbound calling names can take 72 hours to complete. Pending updates to outbound calling names must be complete before you
    ///          can request another update.</p>
    func updatePhoneNumber(input: UpdatePhoneNumberInput, completion: @escaping (SdkResult<UpdatePhoneNumberOutput, UpdatePhoneNumberOutputError>) -> Void)
    ...
    func updatePhoneNumberSettings(input: UpdatePhoneNumberSettingsInput, completion: @escaping (SdkResult<UpdatePhoneNumberSettingsOutput, UpdatePhoneNumberSettingsOutputError>) -> Void)
    /// <p>Updates the specified proxy session details, such as voice or SMS capabilities.</p>
    func updateProxySession(input: UpdateProxySessionInput, completion: @escaping (SdkResult<UpdateProxySessionOutput, UpdateProxySessionOutputError>) -> Void)
    ...
    ///             user IDs.</p>
    func updateRoomMembership(input: UpdateRoomMembershipInput, completion: @escaping (SdkResult<UpdateRoomMembershipOutput, UpdateRoomMembershipOutputError>) -> Void)
    /// <p>Updates the details of the specified SIP media application.</p>
    func updateSipMediaApplication(input: UpdateSipMediaApplicationInput, completion: @escaping (SdkResult<UpdateSipMediaApplicationOutput, UpdateSipMediaApplicationOutputError>) -> Void)
    /// <p>Updates the details of the specified SIP rule.</p>
    func updateSipRule(input: UpdateSipRuleInput, completion: @escaping (SdkResult<UpdateSipRuleOutput, UpdateSipRuleOutputError>) -> Void)
    /// <p>
    ...
    func updateUserSettings(input: UpdateUserSettingsInput, completion: @escaping (SdkResult<UpdateUserSettingsOutput, UpdateUserSettingsOutputError>) -> Void)
    /// <p>Updates details for the specified Amazon Chime Voice Connector.</p>
    func updateVoiceConnector(input: UpdateVoiceConnectorInput, completion: @escaping (SdkResult<UpdateVoiceConnectorOutput, UpdateVoiceConnectorOutputError>) -> Void)
    ...
    func updateVoiceConnectorGroup(input: UpdateVoiceConnectorGroupInput, completion: @escaping (SdkResult<UpdateVoiceConnectorGroupOutput, UpdateVoiceConnectorGroupOutputError>) -> Void)
}
