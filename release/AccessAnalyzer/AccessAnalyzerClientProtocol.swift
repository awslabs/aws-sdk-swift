...
public protocol AccessAnalyzerClientProtocol {
    ...
    ///          criteria.</p>
    func applyArchiveRule(input: ApplyArchiveRuleInput, completion: @escaping (SdkResult<ApplyArchiveRuleOutput, ApplyArchiveRuleOutputError>) -> Void)
    /// <p>Cancels the requested policy generation.</p>
    func cancelPolicyGeneration(input: CancelPolicyGenerationInput, completion: @escaping (SdkResult<CancelPolicyGenerationOutput, CancelPolicyGenerationOutputError>) -> Void)
    ...
    func createAccessPreview(input: CreateAccessPreviewInput, completion: @escaping (SdkResult<CreateAccessPreviewOutput, CreateAccessPreviewOutputError>) -> Void)
    /// <p>Creates an analyzer for your account.</p>
    func createAnalyzer(input: CreateAnalyzerInput, completion: @escaping (SdkResult<CreateAnalyzerOutput, CreateAnalyzerOutputError>) -> Void)
    ...
    ///          Guide</b>.</p>
    func createArchiveRule(input: CreateArchiveRuleInput, completion: @escaping (SdkResult<CreateArchiveRuleOutput, CreateArchiveRuleOutputError>) -> Void)
    ...
    func deleteAnalyzer(input: DeleteAnalyzerInput, completion: @escaping (SdkResult<DeleteAnalyzerOutput, DeleteAnalyzerOutputError>) -> Void)
    /// <p>Deletes the specified archive rule.</p>
    func deleteArchiveRule(input: DeleteArchiveRuleInput, completion: @escaping (SdkResult<DeleteArchiveRuleOutput, DeleteArchiveRuleOutputError>) -> Void)
    /// <p>Retrieves information about an access preview for the specified analyzer.</p>
    func getAccessPreview(input: GetAccessPreviewInput, completion: @escaping (SdkResult<GetAccessPreviewOutput, GetAccessPreviewOutputError>) -> Void)
    /// <p>Retrieves information about a resource that was analyzed.</p>
    func getAnalyzedResource(input: GetAnalyzedResourceInput, completion: @escaping (SdkResult<GetAnalyzedResourceOutput, GetAnalyzedResourceOutputError>) -> Void)
    /// <p>Retrieves information about the specified analyzer.</p>
    func getAnalyzer(input: GetAnalyzerInput, completion: @escaping (SdkResult<GetAnalyzerOutput, GetAnalyzerOutputError>) -> Void)
    /// <p>Retrieves information about an archive rule.</p>
    ///          <p>To learn about filter keys that you can use to create an archive rule, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-reference-filter-keys.html">Access Analyzer filter keys</a> in the <b>IAM User
    ///          Guide</b>.</p>
    func getArchiveRule(input: GetArchiveRuleInput, completion: @escaping (SdkResult<GetArchiveRuleOutput, GetArchiveRuleOutputError>) -> Void)
    /// <p>Retrieves information about the specified finding.</p>
    func getFinding(input: GetFindingInput, completion: @escaping (SdkResult<GetFindingOutput, GetFindingOutputError>) -> Void)
    /// <p>Retrieves the policy that was generated using <code>StartPolicyGeneration</code>.
    ///       </p>
    func getGeneratedPolicy(input: GetGeneratedPolicyInput, completion: @escaping (SdkResult<GetGeneratedPolicyOutput, GetGeneratedPolicyOutputError>) -> Void)
    /// <p>Retrieves a list of access preview findings generated by the specified access
    ///          preview.</p>
    func listAccessPreviewFindings(input: ListAccessPreviewFindingsInput, completion: @escaping (SdkResult<ListAccessPreviewFindingsOutput, ListAccessPreviewFindingsOutputError>) -> Void)
    /// <p>Retrieves a list of access previews for the specified analyzer.</p>
    func listAccessPreviews(input: ListAccessPreviewsInput, completion: @escaping (SdkResult<ListAccessPreviewsOutput, ListAccessPreviewsOutputError>) -> Void)
    /// <p>Retrieves a list of resources of the specified type that have been analyzed by the
    ///          specified analyzer..</p>
    func listAnalyzedResources(input: ListAnalyzedResourcesInput, completion: @escaping (SdkResult<ListAnalyzedResourcesOutput, ListAnalyzedResourcesOutputError>) -> Void)
    /// <p>Retrieves a list of analyzers.</p>
    func listAnalyzers(input: ListAnalyzersInput, completion: @escaping (SdkResult<ListAnalyzersOutput, ListAnalyzersOutputError>) -> Void)
    /// <p>Retrieves a list of archive rules created for the specified analyzer.</p>
    func listArchiveRules(input: ListArchiveRulesInput, completion: @escaping (SdkResult<ListArchiveRulesOutput, ListArchiveRulesOutputError>) -> Void)
    ...
    func listPolicyGenerations(input: ListPolicyGenerationsInput, completion: @escaping (SdkResult<ListPolicyGenerationsOutput, ListPolicyGenerationsOutputError>) -> Void)
    ...
    func startPolicyGeneration(input: StartPolicyGenerationInput, completion: @escaping (SdkResult<StartPolicyGenerationOutput, StartPolicyGenerationOutputError>) -> Void)
    /// <p>Immediately starts a scan of the policies applied to the specified resource.</p>
    func startResourceScan(input: StartResourceScanInput, completion: @escaping (SdkResult<StartResourceScanOutput, StartResourceScanOutputError>) -> Void)
    ...
    func updateArchiveRule(input: UpdateArchiveRuleInput, completion: @escaping (SdkResult<UpdateArchiveRuleOutput, UpdateArchiveRuleOutputError>) -> Void)
    ...
    func validatePolicy(input: ValidatePolicyInput, completion: @escaping (SdkResult<ValidatePolicyOutput, ValidatePolicyOutputError>) -> Void)
}
