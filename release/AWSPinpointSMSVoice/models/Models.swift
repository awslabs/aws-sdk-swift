...
public struct CreateConfigurationSetEventDestinationInput: Swift.Equatable {
    ...
    var eventDestination: PinpointSmsVoiceClientTypes.EventDestinationDefinition?
...
extension PinpointSmsVoiceClientTypes {
    ...
    public struct EventDestination: Swift.Equatable {
        /// An object that contains information about an event destination that sends data to Amazon CloudWatch Logs.
        var cloudWatchLogsDestination: PinpointSmsVoiceClientTypes.CloudWatchLogsDestination?
        /// Indicates whether or not the event destination is enabled. If the event destination is enabled, then Amazon Pinpoint sends response data to the specified event destination.
        var enabled: Swift.Bool?
        /// An object that contains information about an event destination that sends data to Amazon Kinesis Data Firehose.
        var kinesisFirehoseDestination: PinpointSmsVoiceClientTypes.KinesisFirehoseDestination?
        /// An array of EventDestination objects. Each EventDestination object includes ARNs and other information that define an event destination.
        var matchingEventTypes: [PinpointSmsVoiceClientTypes.EventType]?
        /// A name that identifies the event destination configuration.
        var name: Swift.String?
        /// An object that contains information about an event destination that sends data to Amazon SNS.
        var snsDestination: PinpointSmsVoiceClientTypes.SnsDestination?
...
public struct GetConfigurationSetEventDestinationsOutputResponse: Swift.Equatable {
    /// An array of EventDestination objects. Each EventDestination object includes ARNs and other information that define an event destination.
    var eventDestinations: [PinpointSmsVoiceClientTypes.EventDestination]?
...
public struct ListConfigurationSetsOutputResponse: Swift.Equatable {
    ...
    var configurationSets: [Swift.String]?
...
public struct SendVoiceMessageInput: Swift.Equatable {
    ...
    var callerId: Swift.String?
    /// The name of the configuration set that you want to use to send the message.
    var configurationSetName: Swift.String?
    /// An object that contains a voice message and information about the recipient that you want to send it to.
    var content: PinpointSmsVoiceClientTypes.VoiceMessageContent?
    /// The phone number that you want to send the voice message to.
    var destinationPhoneNumber: Swift.String?
    /// The phone number that Amazon Pinpoint should use to send the voice message. This isn't necessarily the phone number that appears on recipients' devices when they receive the message, because you can specify a CallerId parameter in the request.
    var originationPhoneNumber: Swift.String?
...
extension PinpointSmsVoiceClientTypes {
    ...
    public struct VoiceMessageContent: Swift.Equatable {
        /// An object that defines a message that contains text formatted using Amazon Pinpoint Voice Instructions markup.
        var callInstructionsMessage: PinpointSmsVoiceClientTypes.CallInstructionsMessageType?
        /// An object that defines a message that contains unformatted text.
        var plainTextMessage: PinpointSmsVoiceClientTypes.PlainTextMessageType?
        /// An object that defines a message that contains SSML-formatted text.
        var sSMLMessage: PinpointSmsVoiceClientTypes.SSMLMessageType?
