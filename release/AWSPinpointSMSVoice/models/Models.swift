...
public struct CreateConfigurationSetEventDestinationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConfigurationSetEventDestinationInputURLHostMiddleware"
    ...
    public typealias MInput = CreateConfigurationSetEventDestinationInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateConfigurationSetEventDestinationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateConfigurationSetEventDestinationOutputError>
}

public struct CreateConfigurationSetEventDestinationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConfigurationSetEventDestinationInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let configurationSetName = input.configurationSetName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("configurationSetName is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/v1/sms-voice/configuration-sets/\(configurationSetName.urlPercentEncoding())/event-destinations"
...
public struct CreateConfigurationSetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConfigurationSetInputURLHostMiddleware"
    ...
    public typealias MInput = CreateConfigurationSetInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateConfigurationSetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateConfigurationSetOutputError>
}

public struct CreateConfigurationSetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConfigurationSetInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/sms-voice/configuration-sets"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteConfigurationSetEventDestinationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConfigurationSetEventDestinationInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteConfigurationSetEventDestinationInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteConfigurationSetEventDestinationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteConfigurationSetEventDestinationOutputError>
}

public struct DeleteConfigurationSetEventDestinationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConfigurationSetEventDestinationInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let eventDestinationName = input.eventDestinationName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("eventDestinationName is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/v1/sms-voice/configuration-sets/\(configurationSetName.urlPercentEncoding())/event-destinations/\(eventDestinationName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteConfigurationSetInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConfigurationSetInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteConfigurationSetInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteConfigurationSetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteConfigurationSetOutputError>
}

public struct DeleteConfigurationSetInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConfigurationSetInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/v1/sms-voice/configuration-sets/\(configurationSetName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetConfigurationSetEventDestinationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetConfigurationSetEventDestinationsInputURLHostMiddleware"
    ...
    public typealias MInput = GetConfigurationSetEventDestinationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetConfigurationSetEventDestinationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetConfigurationSetEventDestinationsOutputError>
}

public struct GetConfigurationSetEventDestinationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetConfigurationSetEventDestinationsInputURLPathMiddleware"
...
public struct ListConfigurationSetsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListConfigurationSetsInputURLHostMiddleware"
    ...
    public typealias MInput = ListConfigurationSetsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListConfigurationSetsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListConfigurationSetsOutputError>
}

public struct ListConfigurationSetsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListConfigurationSetsInputURLPathMiddleware"
...
public struct SendVoiceMessageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SendVoiceMessageInputURLHostMiddleware"
    ...
    public typealias MInput = SendVoiceMessageInput
    public typealias MOutput = ClientRuntime.OperationOutput<SendVoiceMessageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SendVoiceMessageOutputError>
}

public struct SendVoiceMessageInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SendVoiceMessageInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/v1/sms-voice/voice/message"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdateConfigurationSetEventDestinationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateConfigurationSetEventDestinationInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateConfigurationSetEventDestinationInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateConfigurationSetEventDestinationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateConfigurationSetEventDestinationOutputError>
}

public struct UpdateConfigurationSetEventDestinationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateConfigurationSetEventDestinationInputURLPathMiddleware"
