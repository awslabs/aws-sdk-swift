...
public protocol SsmIncidentsClientProtocol {
    ...
    ///             provided KMS key. </p>
    func createReplicationSet(input: CreateReplicationSetInput, completion: @escaping (SdkResult<CreateReplicationSetOutputResponse, CreateReplicationSetOutputError>) -> Void)
    ...
    func createResponsePlan(input: CreateResponsePlanInput, completion: @escaping (SdkResult<CreateResponsePlanOutputResponse, CreateResponsePlanOutputError>) -> Void)
    ...
    func createTimelineEvent(input: CreateTimelineEventInput, completion: @escaping (SdkResult<CreateTimelineEventOutputResponse, CreateTimelineEventOutputError>) -> Void)
    /// <p>Delete an incident record from Incident Manager. </p>
    func deleteIncidentRecord(input: DeleteIncidentRecordInput, completion: @escaping (SdkResult<DeleteIncidentRecordOutputResponse, DeleteIncidentRecordOutputError>) -> Void)
    /// <p>Deletes all Regions in your replication set. Deleting the replication set deletes all
    ///             Incident Manager data.</p>
    func deleteReplicationSet(input: DeleteReplicationSetInput, completion: @escaping (SdkResult<DeleteReplicationSetOutputResponse, DeleteReplicationSetOutputError>) -> Void)
    ...
    ///             plan.</p>
    func deleteResponsePlan(input: DeleteResponsePlanInput, completion: @escaping (SdkResult<DeleteResponsePlanOutputResponse, DeleteResponsePlanOutputError>) -> Void)
    /// <p>Deletes a timeline event from an incident.</p>
    func deleteTimelineEvent(input: DeleteTimelineEventInput, completion: @escaping (SdkResult<DeleteTimelineEventOutputResponse, DeleteTimelineEventOutputError>) -> Void)
    /// <p>Returns the details of the specified incident record.</p>
    func getIncidentRecord(input: GetIncidentRecordInput, completion: @escaping (SdkResult<GetIncidentRecordOutputResponse, GetIncidentRecordOutputError>) -> Void)
    /// <p>Retrieve your Incident Manager replication set.</p>
    func getReplicationSet(input: GetReplicationSetInput, completion: @escaping (SdkResult<GetReplicationSetOutputResponse, GetReplicationSetOutputError>) -> Void)
    ...
    func getResponsePlan(input: GetResponsePlanInput, completion: @escaping (SdkResult<GetResponsePlanOutputResponse, GetResponsePlanOutputError>) -> Void)
    /// <p>Retrieves a timeline event based on its ID and incident record.</p>
    func getTimelineEvent(input: GetTimelineEventInput, completion: @escaping (SdkResult<GetTimelineEventOutputResponse, GetTimelineEventOutputError>) -> Void)
    ...
    func listIncidentRecords(input: ListIncidentRecordsInput, completion: @escaping (SdkResult<ListIncidentRecordsOutputResponse, ListIncidentRecordsOutputError>) -> Void)
    /// <p>List all related items for an incident record.</p>
    func listRelatedItems(input: ListRelatedItemsInput, completion: @escaping (SdkResult<ListRelatedItemsOutputResponse, ListRelatedItemsOutputError>) -> Void)
    /// <p>Lists details about the replication set configured in your account. </p>
    func listReplicationSets(input: ListReplicationSetsInput, completion: @escaping (SdkResult<ListReplicationSetsOutputResponse, ListReplicationSetsOutputError>) -> Void)
    /// <p>Lists all response plans in your account.</p>
    func listResponsePlans(input: ListResponsePlansInput, completion: @escaping (SdkResult<ListResponsePlansOutputResponse, ListResponsePlansOutputError>) -> Void)
    ...
    func listTimelineEvents(input: ListTimelineEventsInput, completion: @escaping (SdkResult<ListTimelineEventsOutputResponse, ListTimelineEventsOutputError>) -> Void)
    ...
    func startIncident(input: StartIncidentInput, completion: @escaping (SdkResult<StartIncidentOutputResponse, StartIncidentOutputError>) -> Void)
    ...
    ///             replication set.</p>
    func updateDeletionProtection(input: UpdateDeletionProtectionInput, completion: @escaping (SdkResult<UpdateDeletionProtectionOutputResponse, UpdateDeletionProtectionOutputError>) -> Void)
    ...
    func updateIncidentRecord(input: UpdateIncidentRecordInput, completion: @escaping (SdkResult<UpdateIncidentRecordOutputResponse, UpdateIncidentRecordOutputError>) -> Void)
    /// <p>Add or remove related items from the related items tab of an incident record.</p>
    func updateRelatedItems(input: UpdateRelatedItemsInput, completion: @escaping (SdkResult<UpdateRelatedItemsOutputResponse, UpdateRelatedItemsOutputError>) -> Void)
    /// <p>Add or delete Regions from your replication set.</p>
    func updateReplicationSet(input: UpdateReplicationSetInput, completion: @escaping (SdkResult<UpdateReplicationSetOutputResponse, UpdateReplicationSetOutputError>) -> Void)
    /// <p>Updates the specified response plan.</p>
    func updateResponsePlan(input: UpdateResponsePlanInput, completion: @escaping (SdkResult<UpdateResponsePlanOutputResponse, UpdateResponsePlanOutputError>) -> Void)
    /// <p>Updates a timeline event. You can update events of type <code>Custom
    ///             Event</code>.</p>
    func updateTimelineEvent(input: UpdateTimelineEventInput, completion: @escaping (SdkResult<UpdateTimelineEventOutputResponse, UpdateTimelineEventOutputError>) -> Void)
}
