...
extension AddFlowOutputs420Exception: AWSClientRuntime.AWSHttpServiceError {
...
public struct AddFlowOutputs420Exception: ClientRuntime.ServiceError, Swift.Equatable {
...
extension MediaConnectClientTypes.AddMediaStreamRequest: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let clockRateDecoded = try containerValues.decode(Swift.Int.self, forKey: .clockRate)
        clockRate = clockRateDecoded
        let descriptionDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .description)
        description = descriptionDecoded
        let mediaStreamIdDecoded = try containerValues.decode(Swift.Int.self, forKey: .mediaStreamId)
...
extension MediaConnectClientTypes {
    ...
    public struct AddMediaStreamRequest: Swift.Equatable {
        ...
        public init (
            ...
            clockRate: Swift.Int = 0,
            description: Swift.String? = nil,
            mediaStreamId: Swift.Int = 0,
...
extension MediaConnectClientTypes.AddOutputRequest: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let maxLatencyDecoded = try containerValues.decode(Swift.Int.self, forKey: .maxLatency)
        ...
        let minLatencyDecoded = try containerValues.decode(Swift.Int.self, forKey: .minLatency)
        ...
        let smoothingLatencyDecoded = try containerValues.decode(Swift.Int.self, forKey: .smoothingLatency)
...
extension CreateFlow420Exception: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
/// Exception raised by AWS Elemental MediaConnect. See the error message and documentation for the operation for more information on the cause of this exception.
public struct CreateFlow420Exception: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension MediaConnectClientTypes.EncodingParameters: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let compressionFactorDecoded = try containerValues.decode(Swift.Double.self, forKey: .compressionFactor)
...
extension MediaConnectClientTypes {
    ...
    public struct EncodingParameters: Swift.Equatable {
        ...
        public init (
            compressionFactor: Swift.Double = 0.0,
...
extension MediaConnectClientTypes.Entitlement: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let dataTransferSubscriberFeePercentDecoded = try containerValues.decode(Swift.Int.self, forKey: .dataTransferSubscriberFeePercent)
...
extension MediaConnectClientTypes {
    ...
    public struct Entitlement: Swift.Equatable {
        ...
        public init (
            dataTransferSubscriberFeePercent: Swift.Int = 0,
            description: Swift.String? = nil,
            encryption: MediaConnectClientTypes.Encryption? = nil,
...
extension MediaConnectClientTypes.FailoverConfig: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let recoveryWindowDecoded = try containerValues.decode(Swift.Int.self, forKey: .recoveryWindow)
...
extension MediaConnectClientTypes.FailoverConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "FailoverConfig(recoveryWindow: \(Swift.String(describing: recoveryWindow)), state: \(Swift.String(describing: state)))"}
}
...
extension GrantFlowEntitlements420Exception: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
/// Exception raised by AWS Elemental MediaConnect. See the error message and documentation for the operation for more information on the cause of this exception.
public struct GrantFlowEntitlements420Exception: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension MediaConnectClientTypes.InputConfiguration: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let inputPortDecoded = try containerValues.decode(Swift.Int.self, forKey: .inputPort)
...
extension MediaConnectClientTypes.MediaStream: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let descriptionDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .description)
        description = descriptionDecoded
        let fmtDecoded = try containerValues.decode(Swift.Int.self, forKey: .fmt)
        fmt = fmtDecoded
        let mediaStreamIdDecoded = try containerValues.decode(Swift.Int.self, forKey: .mediaStreamId)
        mediaStreamId = mediaStreamIdDecoded
        let mediaStreamNameDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .mediaStreamName)
...
extension MediaConnectClientTypes.ResourceSpecification: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let reservedBitrateDecoded = try containerValues.decode(Swift.Int.self, forKey: .reservedBitrate)
...
extension MediaConnectClientTypes.SetSourceRequest: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let entitlementArnDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .entitlementArn)
        entitlementArn = entitlementArnDecoded
        let ingestPortDecoded = try containerValues.decode(Swift.Int.self, forKey: .ingestPort)
        ingestPort = ingestPortDecoded
        let maxBitrateDecoded = try containerValues.decode(Swift.Int.self, forKey: .maxBitrate)
        maxBitrate = maxBitrateDecoded
        let maxLatencyDecoded = try containerValues.decode(Swift.Int.self, forKey: .maxLatency)
        maxLatency = maxLatencyDecoded
        let maxSyncBufferDecoded = try containerValues.decode(Swift.Int.self, forKey: .maxSyncBuffer)
...
extension MediaConnectClientTypes {
    ...
    public struct SetSourceRequest: Swift.Equatable {
        ...
        public init (
            ...
            description: Swift.String? = nil,
            entitlementArn: Swift.String? = nil,
            ingestPort: Swift.Int = 0,
            maxBitrate: Swift.Int = 0,
            maxLatency: Swift.Int = 0,
            maxSyncBuffer: Swift.Int = 0,
...
extension MediaConnectClientTypes.UpdateFailoverConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateFailoverConfig(recoveryWindow: \(Swift.String(describing: recoveryWindow)), state: \(Swift.String(describing: state)))"}
}
