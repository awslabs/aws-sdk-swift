...
public class MediaConnectClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try MediaConnectClientConfiguration(region: unwrappedRegion)
    ...
    public class MediaConnectClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("MediaConnectClient")
