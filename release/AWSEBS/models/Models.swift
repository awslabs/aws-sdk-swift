...
extension EbsClientTypes {
    ...
    public struct Block: Swift.Equatable {
        /// The block index.
        var blockIndex: Swift.Int?
        /// The block token for the block index.
        var blockToken: Swift.String?
...
extension EbsClientTypes {
    ...
    public struct ChangedBlock: Swift.Equatable {
        ...
        var firstBlockToken: Swift.String?
        /// The block token for the block index of the SecondSnapshotId specified in the ListChangedBlocks operation.
        var secondBlockToken: Swift.String?
...
public struct CompleteSnapshotInput: Swift.Equatable {
    ...
    /// This member is required.
    var changedBlocksCount: Swift.Int?
    ...
    var checksumAggregationMethod: EbsClientTypes.ChecksumAggregationMethod?
    /// The algorithm used to generate the checksum. Currently, the only supported algorithm is SHA256.
    var checksumAlgorithm: EbsClientTypes.ChecksumAlgorithm?
...
public struct CompleteSnapshotOutputResponse: Swift.Equatable {
    ...
    var status: EbsClientTypes.Status?
...
public struct GetSnapshotBlockOutputResponse: Swift.Equatable {
    ...
    var blockData: ClientRuntime.ByteStream?
    /// The checksum generated for the block, which is Base64 encoded.
    var checksum: Swift.String?
    /// The algorithm used to generate the checksum for the block, such as SHA256.
    var checksumAlgorithm: EbsClientTypes.ChecksumAlgorithm?
    /// The size of the data in the block.
    var dataLength: Swift.Int?
...
public struct ListChangedBlocksInput: Swift.Equatable {
    ...
    var firstSnapshotId: Swift.String?
    ...
    /// This member is required.
    var secondSnapshotId: Swift.String?
    ...
    var startingBlockIndex: Swift.Int?
...
public struct ListChangedBlocksOutputResponse: Swift.Equatable {
    ...
    var changedBlocks: [EbsClientTypes.ChangedBlock]?
    /// The time when the BlockToken expires.
    var expiryTime: ClientRuntime.Date?
...
public struct ListSnapshotBlocksOutputResponse: Swift.Equatable {
    ...
    var blocks: [EbsClientTypes.Block]?
    /// The time when the BlockToken expires.
    var expiryTime: ClientRuntime.Date?
    /// The token to use to retrieve the next page of results. This value is null when there are no more results to return.
    var nextToken: Swift.String?
...
public struct StartSnapshotInput: Swift.Equatable {
    ...
    var parentSnapshotId: Swift.String?
    /// The tags to apply to the snapshot.
    var tags: [EbsClientTypes.Tag]?
