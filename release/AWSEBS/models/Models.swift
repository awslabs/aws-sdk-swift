...
public struct CompleteSnapshotInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CompleteSnapshotInputURLHostMiddleware"
    ...
    public typealias MInput = CompleteSnapshotInput
    public typealias MOutput = ClientRuntime.OperationOutput<CompleteSnapshotOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CompleteSnapshotOutputError>
}

public struct CompleteSnapshotInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CompleteSnapshotInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let snapshotId = input.snapshotId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("snapshotId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/snapshots/completion/\(snapshotId.urlPercentEncoding())"
...
///                 <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-accessing-snapshot.html#ebsapi-performance">Optimizing performance of the EBS direct APIs in the Amazon Elastic Compute Cloud
///                 User Guide.
...
public struct GetSnapshotBlockInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetSnapshotBlockInputURLHostMiddleware"
    ...
    public typealias MInput = GetSnapshotBlockInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetSnapshotBlockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetSnapshotBlockOutputError>
}

public struct GetSnapshotBlockInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetSnapshotBlockInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let blockIndex = input.blockIndex else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("blockIndex is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/snapshots/\(snapshotId.urlPercentEncoding())/blocks/\(blockIndex)"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListChangedBlocksInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListChangedBlocksInputURLHostMiddleware"
    ...
    public typealias MInput = ListChangedBlocksInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListChangedBlocksOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListChangedBlocksOutputError>
}

public struct ListChangedBlocksInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListChangedBlocksInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let secondSnapshotId = input.secondSnapshotId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("secondSnapshotId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/snapshots/\(secondSnapshotId.urlPercentEncoding())/changedblocks"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListSnapshotBlocksInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSnapshotBlocksInputURLHostMiddleware"
    ...
    public typealias MInput = ListSnapshotBlocksInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListSnapshotBlocksOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListSnapshotBlocksOutputError>
}

public struct ListSnapshotBlocksInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSnapshotBlocksInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/snapshots/\(snapshotId.urlPercentEncoding())/blocks"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct PutSnapshotBlockInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutSnapshotBlockInputURLHostMiddleware"
    ...
    public typealias MInput = PutSnapshotBlockInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutSnapshotBlockOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutSnapshotBlockOutputError>
}

public struct PutSnapshotBlockInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutSnapshotBlockInputURLPathMiddleware"
...
public struct StartSnapshotInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartSnapshotInputURLHostMiddleware"
    ...
    public typealias MInput = StartSnapshotInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartSnapshotOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartSnapshotOutputError>
}

public struct StartSnapshotInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartSnapshotInputURLPathMiddleware"
...
public struct StartSnapshotInput: Swift.Equatable {
    ...
    ///             snapshot using <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CopySnapshot.html">CopySnapshot.
