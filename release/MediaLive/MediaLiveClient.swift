...
public class MediaLiveClient {
    ...
    public class MediaLiveClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("MediaLiveClient")
...
public struct MediaLiveClientLogHandlerFactory: SDKLogHandlerFactory {
...
extension MediaLiveClient: MediaLiveClientProtocol {
    ...
    public func describeInputDeviceThumbnail(input: DescribeInputDeviceThumbnailInput, completion: @escaping (SdkResult<DescribeInputDeviceThumbnailOutputResponse, DescribeInputDeviceThumbnailOutputError>) -> Void)
    {
        guard let inputDeviceId = input.inputDeviceId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component inputDeviceId unexpectedly nil"))))
            return
