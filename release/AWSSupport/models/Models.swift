...
public struct AddAttachmentsToSetInput: Swift.Equatable {
    ...
    var attachmentSetId: Swift.String?
    ...
    var attachments: [SupportClientTypes.Attachment]?
...
public struct AddCommunicationToCaseInput: Swift.Equatable {
    ...
    var ccEmailAddresses: [Swift.String]?
    /// The body of an email communication to add to the support case.
    /// This member is required.
    var communicationBody: Swift.String?
...
extension SupportClientTypes {
    ...
    public struct CaseDetails: Swift.Equatable {
        ...
        var recentCommunications: SupportClientTypes.RecentCaseCommunications?
...
extension SupportClientTypes {
    ...
    public struct Communication: Swift.Equatable {
        ...
        var attachmentSet: [SupportClientTypes.AttachmentDetails]?
...
public struct DescribeAttachmentOutputResponse: Swift.Equatable {
    ...
    var attachment: SupportClientTypes.Attachment?
...
public struct DescribeCasesInput: Swift.Equatable {
    ...
    var afterTime: Swift.String?
    /// The end date for a filtered date search on support case communications. Case communications are available for 12 months after creation.
    var beforeTime: Swift.String?
    /// A list of ID numbers of the support cases you want returned. The maximum number of cases is 100.
    var caseIdList: [Swift.String]?
    ...
    var includeCommunications: Swift.Bool?
    /// Specifies whether to include resolved support cases in the DescribeCases response. By default, resolved cases aren't included.
    var includeResolvedCases: Swift.Bool
    /// The ISO 639-1 code for the language in which Amazon Web Services provides support. Amazon Web Services Support currently supports English ("en") and Japanese ("ja"). Language parameters must be passed explicitly for operations that take them.
    var language: Swift.String?
...
public struct DescribeCasesOutputResponse: Swift.Equatable {
    ...
    var cases: [SupportClientTypes.CaseDetails]?
    /// A resumption point for pagination.
    var nextToken: Swift.String?
...
public struct DescribeCommunicationsOutputResponse: Swift.Equatable {
    ...
    var communications: [SupportClientTypes.Communication]?
    /// A resumption point for pagination.
    var nextToken: Swift.String?
...
public struct DescribeServicesInput: Swift.Equatable {
    ...
    var serviceCodeList: [Swift.String]?
...
public struct DescribeServicesOutputResponse: Swift.Equatable {
    ...
    var services: [SupportClientTypes.Service]?
...
public struct DescribeSeverityLevelsOutputResponse: Swift.Equatable {
    ...
    var severityLevels: [SupportClientTypes.SeverityLevel]?
...
public struct DescribeTrustedAdvisorCheckRefreshStatusesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var statuses: [SupportClientTypes.TrustedAdvisorCheckRefreshStatus]?
...
public struct DescribeTrustedAdvisorCheckResultOutputResponse: Swift.Equatable {
    ...
    var result: SupportClientTypes.TrustedAdvisorCheckResult?
...
public struct DescribeTrustedAdvisorCheckSummariesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var summaries: [SupportClientTypes.TrustedAdvisorCheckSummary]?
...
public struct DescribeTrustedAdvisorChecksOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var checks: [SupportClientTypes.TrustedAdvisorCheckDescription]?
...
public struct RefreshTrustedAdvisorCheckOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var status: SupportClientTypes.TrustedAdvisorCheckRefreshStatus?
...
public struct ResolveCaseOutputResponse: Swift.Equatable {
    ...
    var finalCaseStatus: Swift.String?
    /// The status of the case when the [ResolveCase] request was sent.
    var initialCaseStatus: Swift.String?
...
extension SupportClientTypes {
    ...
    public struct Service: Swift.Equatable {
        ...
        var categories: [SupportClientTypes.Category]?
...
extension SupportClientTypes {
    ...
    public struct TrustedAdvisorCategorySpecificSummary: Swift.Equatable {
        ...
        var costOptimizing: SupportClientTypes.TrustedAdvisorCostOptimizingSummary?
...
extension SupportClientTypes {
    ...
    public struct TrustedAdvisorCheckRefreshStatus: Swift.Equatable {
        ...
        /// This member is required.
        var millisUntilNextRefreshable: Swift.Int
...
extension SupportClientTypes {
    ...
    public struct TrustedAdvisorCheckResult: Swift.Equatable {
        ...
        /// This member is required.
        var categorySpecificSummary: SupportClientTypes.TrustedAdvisorCategorySpecificSummary?
        /// The unique identifier for the Trusted Advisor check.
        /// This member is required.
        var checkId: Swift.String?
        /// The details about each resource listed in the check result.
        /// This member is required.
        var flaggedResources: [SupportClientTypes.TrustedAdvisorResourceDetail]?
        ...
        /// This member is required.
        var resourcesSummary: SupportClientTypes.TrustedAdvisorResourcesSummary?
...
extension SupportClientTypes {
    ...
    public struct TrustedAdvisorCheckSummary: Swift.Equatable {
        ...
        var hasFlaggedResources: Swift.Bool
        /// Details about Amazon Web Services resources that were analyzed in a call to Trusted Advisor [DescribeTrustedAdvisorCheckSummaries].
        /// This member is required.
        var resourcesSummary: SupportClientTypes.TrustedAdvisorResourcesSummary?
        /// The alert status of the check: "ok" (green), "warning" (yellow), "error" (red), or "not_available".
...
extension SupportClientTypes {
    ...
    public struct TrustedAdvisorCostOptimizingSummary: Swift.Equatable {
        ...
        /// This member is required.
        var estimatedMonthlySavings: Swift.Double
        /// The estimated percentage of savings that might be realized if the recommended operations are taken.
        /// This member is required.
        var estimatedPercentMonthlySavings: Swift.Double
...
extension SupportClientTypes {
    ...
    public struct TrustedAdvisorResourcesSummary: Swift.Equatable {
        ...
        /// This member is required.
        var resourcesSuppressed: Swift.Int
