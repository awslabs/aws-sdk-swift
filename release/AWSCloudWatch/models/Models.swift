...
extension CloudWatchClientTypes {
    ...
    public struct AlarmHistoryItem: Swift.Equatable {
        ...
        var alarmType: CloudWatchClientTypes.AlarmType?
        /// Data about the alarm, in JSON format.
        var historyData: Swift.String?
        /// The type of alarm history item.
        var historyItemType: CloudWatchClientTypes.HistoryItemType?
        /// A summary of the alarm history, in text format.
        var historySummary: Swift.String?
        /// The time stamp for the alarm history item.
        var timestamp: ClientRuntime.Date?
...
extension CloudWatchClientTypes {
    ...
    public struct AnomalyDetector: Swift.Equatable {
        ...
        var configuration: CloudWatchClientTypes.AnomalyDetectorConfiguration?
        /// The metric dimensions associated with the anomaly detection model.
        @available(*, deprecated, message: "Use SingleMetricAnomalyDetector.Dimensions property.")
        var dimensions: [CloudWatchClientTypes.Dimension]?
        /// The CloudWatch metric math expression for this anomaly detector.
        var metricMathAnomalyDetector: CloudWatchClientTypes.MetricMathAnomalyDetector?
        ...
        var singleMetricAnomalyDetector: CloudWatchClientTypes.SingleMetricAnomalyDetector?
        ...
        var stateValue: CloudWatchClientTypes.AnomalyDetectorStateValue?
...
extension CloudWatchClientTypes {
    ...
    public struct AnomalyDetectorConfiguration: Swift.Equatable {
        ...
        var excludedTimeRanges: [CloudWatchClientTypes.Range]?
        ...
        var metricTimezone: Swift.String?
...
extension CloudWatchClientTypes {
    ...
    public struct CompositeAlarm: Swift.Equatable {
        ...
        var alarmActions: [Swift.String]?
        /// The Amazon Resource Name (ARN) of the alarm.
        var alarmArn: Swift.String?
        /// The time stamp of the last update to the alarm configuration.
        var alarmConfigurationUpdatedTimestamp: ClientRuntime.Date?
        /// The description of the alarm.
        var alarmDescription: Swift.String?
        /// The name of the alarm.
        var alarmName: Swift.String?
        /// The rule that this alarm uses to evaluate its alarm state.
        var alarmRule: Swift.String?
        /// The actions to execute when this alarm transitions to the INSUFFICIENT_DATA state from any other state. Each action is specified as an Amazon Resource Name (ARN).
        var insufficientDataActions: [Swift.String]?
        /// The actions to execute when this alarm transitions to the OK state from any other state. Each action is specified as an Amazon Resource Name (ARN).
        var oKActions: [Swift.String]?
        /// An explanation for the alarm state, in text format.
        var stateReason: Swift.String?
        /// An explanation for the alarm state, in JSON format.
        var stateReasonData: Swift.String?
        /// The time stamp of the last update to the alarm state.
        var stateUpdatedTimestamp: ClientRuntime.Date?
        /// The state value for the alarm.
        var stateValue: CloudWatchClientTypes.StateValue?
...
extension CloudWatchClientTypes {
    ...
    public struct DashboardEntry: Swift.Equatable {
        ...
        var dashboardArn: Swift.String?
        /// The name of the dashboard.
        var dashboardName: Swift.String?
...
extension CloudWatchClientTypes {
    ...
    public struct Datapoint: Swift.Equatable {
        ...
        var average: Swift.Double?
        /// The percentile statistic for the data point.
        var extendedStatistics: [Swift.String:Swift.Double]?
        /// The maximum metric value for the data point.
        var maximum: Swift.Double?
        /// The minimum metric value for the data point.
        var minimum: Swift.Double?
        /// The number of metric values that contributed to the aggregate value of this data point.
        var sampleCount: Swift.Double?
        /// The sum of the metric values for the data point.
        var sum: Swift.Double?
        /// The time stamp used for the data point.
        var timestamp: ClientRuntime.Date?
        /// The standard unit for the data point.
        var unit: CloudWatchClientTypes.StandardUnit?
...
public struct DeleteDashboardsInput: Swift.Equatable {
    ...
    /// This member is required.
    var dashboardNames: [Swift.String]?
...
public struct DeleteInsightRulesOutputResponse: Swift.Equatable {
    ...
    var failures: [CloudWatchClientTypes.PartialFailure]?
...
public struct DescribeAlarmHistoryInput: Swift.Equatable {
    ...
    var alarmTypes: [CloudWatchClientTypes.AlarmType]?
    /// The ending date to retrieve alarm history.
    var endDate: ClientRuntime.Date?
    ...
    var scanBy: CloudWatchClientTypes.ScanBy?
    /// The starting date to retrieve alarm history.
    var startDate: ClientRuntime.Date?
...
public struct DescribeAlarmHistoryOutputResponse: Swift.Equatable {
    ...
    var alarmHistoryItems: [CloudWatchClientTypes.AlarmHistoryItem]?
...
public struct DescribeAlarmsForMetricInput: Swift.Equatable {
    ...
    var extendedStatistic: Swift.String?
    ...
    var statistic: CloudWatchClientTypes.Statistic?
...
public struct DescribeAlarmsForMetricOutputResponse: Swift.Equatable {
    ...
    var metricAlarms: [CloudWatchClientTypes.MetricAlarm]?
...
public struct DescribeAlarmsInput: Swift.Equatable {
    ...
    var alarmNamePrefix: Swift.String?
    ...
    var childrenOfAlarmName: Swift.String?
    ...
    var parentsOfAlarmName: Swift.String?
...
public struct DescribeAlarmsOutputResponse: Swift.Equatable {
    ...
    var compositeAlarms: [CloudWatchClientTypes.CompositeAlarm]?
...
public struct DescribeAnomalyDetectorsInput: Swift.Equatable {
    ...
    var anomalyDetectorTypes: [CloudWatchClientTypes.AnomalyDetectorType]?
...
public struct DescribeAnomalyDetectorsOutputResponse: Swift.Equatable {
    ...
    var anomalyDetectors: [CloudWatchClientTypes.AnomalyDetector]?
...
public struct DescribeInsightRulesOutputResponse: Swift.Equatable {
    ...
    var insightRules: [CloudWatchClientTypes.InsightRule]?
...
public struct GetDashboardOutputResponse: Swift.Equatable {
    ...
    var dashboardBody: Swift.String?
    /// The name of the dashboard.
    var dashboardName: Swift.String?
...
public struct GetInsightRuleReportInput: Swift.Equatable {
    ...
    var maxContributorCount: Swift.Int?
    ...
    var orderBy: Swift.String?
    /// The period, in seconds, to use for the statistics in the InsightRuleMetricDatapoint results.
    /// This member is required.
    var period: Swift.Int?
    /// The name of the rule that you want to see data from.
    /// This member is required.
    var ruleName: Swift.String?
...
public struct GetInsightRuleReportOutputResponse: Swift.Equatable {
    ...
    var aggregateValue: Swift.Double?
    /// Specifies whether this rule aggregates contributor data by COUNT or SUM.
    var aggregationStatistic: Swift.String?
    /// An approximate count of the unique contributors found by this rule in this time period.
    var approximateUniqueCount: Swift.Int?
    /// An array of the unique contributors found by this rule in this time period. If the rule contains multiple keys, each combination of values for the keys counts as a unique contributor.
    var contributors: [CloudWatchClientTypes.InsightRuleContributor]?
    /// An array of the strings used as the keys for this rule. The keys are the dimensions used to classify contributors. If the rule contains more than one key, then each unique combination of values for the keys is counted as a unique contributor.
    var keyLabels: [Swift.String]?
    /// A time series of metric data points that matches the time period in the rule request.
    var metricDatapoints: [CloudWatchClientTypes.InsightRuleMetricDatapoint]?
...
public struct GetMetricDataInput: Swift.Equatable {
    ...
    var labelOptions: CloudWatchClientTypes.LabelOptions?
    /// The maximum number of data points the request should return before paginating. If you omit this, the default of 100,800 is used.
    var maxDatapoints: Swift.Int?
    ...
    /// This member is required.
    var metricDataQueries: [CloudWatchClientTypes.MetricDataQuery]?
...
public struct GetMetricDataOutputResponse: Swift.Equatable {
    ...
    var messages: [CloudWatchClientTypes.MessageData]?
    /// The metrics that are returned, including the metric name, namespace, and dimensions.
    var metricDataResults: [CloudWatchClientTypes.MetricDataResult]?
...
public struct GetMetricStatisticsInput: Swift.Equatable {
    ...
    var extendedStatistics: [Swift.String]?
    ...
    var statistics: [CloudWatchClientTypes.Statistic]?
...
public struct GetMetricStatisticsOutputResponse: Swift.Equatable {
    ...
    var datapoints: [CloudWatchClientTypes.Datapoint]?
...
public struct GetMetricStreamOutputResponse: Swift.Equatable {
    ...
    var excludeFilters: [CloudWatchClientTypes.MetricStreamFilter]?
    /// The ARN of the Amazon Kinesis Firehose delivery stream that is used by this metric stream.
    var firehoseArn: Swift.String?
    /// If this array of metric namespaces is present, then these namespaces are the only metric namespaces that are streamed by this metric stream.
    var includeFilters: [CloudWatchClientTypes.MetricStreamFilter]?
    /// The date of the most recent update to the metric stream's configuration.
    var lastUpdateDate: ClientRuntime.Date?
    /// The name of the metric stream.
    var name: Swift.String?
    ///
    var outputFormat: CloudWatchClientTypes.MetricStreamOutputFormat?
...
public struct GetMetricWidgetImageOutputResponse: Swift.Equatable {
    ...
    var metricWidgetImage: ClientRuntime.Data?
...
extension CloudWatchClientTypes {
    ...
    public struct InsightRuleContributor: Swift.Equatable {
        ...
        /// This member is required.
        var approximateAggregateValue: Swift.Double?
        /// An array of the data points where this contributor is present. Only the data points when this contributor appeared are included in the array.
        /// This member is required.
        var datapoints: [CloudWatchClientTypes.InsightRuleContributorDatapoint]?
        /// One of the log entry field keywords that is used to define contributors for this rule.
        /// This member is required.
        var keys: [Swift.String]?
...
extension CloudWatchClientTypes {
    ...
    public struct InsightRuleContributorDatapoint: Swift.Equatable {
        ...
        /// This member is required.
        var approximateValue: Swift.Double?
...
extension CloudWatchClientTypes {
    ...
    public struct InsightRuleMetricDatapoint: Swift.Equatable {
        ...
        var maxContributorValue: Swift.Double?
        ...
        var uniqueContributors: Swift.Double?
...
public struct ListDashboardsInput: Swift.Equatable {
    ...
    var dashboardNamePrefix: Swift.String?
    /// The token returned by a previous call to indicate that there is more data available.
    var nextToken: Swift.String?
...
public struct ListDashboardsOutputResponse: Swift.Equatable {
    ...
    var dashboardEntries: [CloudWatchClientTypes.DashboardEntry]?
    /// The token that marks the start of the next batch of returned results.
    var nextToken: Swift.String?
...
public struct ListMetricStreamsOutputResponse: Swift.Equatable {
    ...
    var entries: [CloudWatchClientTypes.MetricStreamEntry]?
...
public struct ListMetricsInput: Swift.Equatable {
    ...
    var dimensions: [CloudWatchClientTypes.DimensionFilter]?
    ...
    var recentlyActive: CloudWatchClientTypes.RecentlyActive?
...
public struct ListMetricsOutputResponse: Swift.Equatable {
    ...
    var metrics: [CloudWatchClientTypes.Metric]?
    /// The token that marks the start of the next batch of returned results.
    var nextToken: Swift.String?
...
public struct ListTagsForResourceOutputResponse: Swift.Equatable {
    ...
    var tags: [CloudWatchClientTypes.Tag]?
...
extension CloudWatchClientTypes {
    ...
    public struct MetricAlarm: Swift.Equatable {
        ...
        var comparisonOperator: CloudWatchClientTypes.ComparisonOperator?
        /// The number of data points that must be breaching to trigger the alarm.
        var datapointsToAlarm: Swift.Int?
        /// The dimensions for the metric associated with the alarm.
        var dimensions: [CloudWatchClientTypes.Dimension]?
        /// Used only for alarms based on percentiles. If ignore, the alarm state does not change during periods with too few data points to be statistically significant. If evaluate or this parameter is not used, the alarm is always evaluated and possibly changes state no matter how many data points are available.
        var evaluateLowSampleCountPercentile: Swift.String?
        ...
        var metrics: [CloudWatchClientTypes.MetricDataQuery]?
        ...
        var thresholdMetricId: Swift.String?
        /// Sets how this alarm is to handle missing data points. If this parameter is omitted, the default behavior of missing is used.
        var treatMissingData: Swift.String?
...
extension CloudWatchClientTypes {
    ...
    public struct MetricDataQuery: Swift.Equatable {
        ...
        var metricStat: CloudWatchClientTypes.MetricStat?
...
extension CloudWatchClientTypes {
    ...
    public struct MetricDataResult: Swift.Equatable {
        ...
        var statusCode: CloudWatchClientTypes.StatusCode?
...
extension CloudWatchClientTypes {
    ...
    public struct MetricDatum: Swift.Equatable {
        ...
        var statisticValues: CloudWatchClientTypes.StatisticSet?
        ...
        var storageResolution: Swift.Int?
...
extension CloudWatchClientTypes {
    ...
    public struct MetricStat: Swift.Equatable {
        ...
        /// This member is required.
        var metric: CloudWatchClientTypes.Metric?
        /// The granularity, in seconds, of the returned data points. For metrics with regular resolution, a period can be as short as one minute (60 seconds) and must be a multiple of 60. For high-resolution metrics that are collected at intervals of less than one minute, the period can be 1, 5, 10, 30, 60, or any multiple of 60. High-resolution metrics are those metrics stored by a PutMetricData call that includes a StorageResolution of 1 second. If the StartTime parameter specifies a time stamp that is greater than 3 hours ago, you must specify the period as follows or no data points in that time range is returned:
        ///
        /// * Start time between 3 hours and 15 days ago - Use a multiple of 60 seconds (1 minute).
        ///
...
extension CloudWatchClientTypes {
    ...
    public struct PartialFailure: Swift.Equatable {
        /// The type of error.
        var exceptionType: Swift.String?
        /// The code of the error.
        var failureCode: Swift.String?
        /// A description of the error.
        var failureDescription: Swift.String?
        /// The specified rule that could not be deleted.
        var failureResource: Swift.String?
...
public struct PutDashboardOutputResponse: Swift.Equatable {
    ...
    var dashboardValidationMessages: [CloudWatchClientTypes.DashboardValidationMessage]?
...
public struct PutInsightRuleInput: Swift.Equatable {
    ...
    /// This member is required.
    var ruleDefinition: Swift.String?
    /// A unique name for the rule.
    /// This member is required.
    var ruleName: Swift.String?
    /// The state of the rule. Valid values are ENABLED and DISABLED.
    var ruleState: Swift.String?
...
public struct PutMetricDataInput: Swift.Equatable {
    ...
    /// This member is required.
    var metricData: [CloudWatchClientTypes.MetricDatum]?
