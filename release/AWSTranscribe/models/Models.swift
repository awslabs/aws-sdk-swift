...
extension TranscribeClientTypes {
    ...
    public struct CallAnalyticsJob: Swift.Equatable {
        ...
        var callAnalyticsJobName: Swift.String?
        /// The status of the analytics job.
        var callAnalyticsJobStatus: TranscribeClientTypes.CallAnalyticsJobStatus?
        ...
        var channelDefinitions: [TranscribeClientTypes.ChannelDefinition]?
        ...
        var identifiedLanguageScore: Swift.Float?
        ...
        var languageCode: TranscribeClientTypes.LanguageCode?
        /// Describes the input media file in a transcription request.
        var media: TranscribeClientTypes.Media?
        ...
        var mediaFormat: TranscribeClientTypes.MediaFormat?
        /// The sample rate, in Hertz, of the audio.
        var mediaSampleRateHertz: Swift.Int?
        /// Provides information about the settings used to run a transcription job.
        var settings: TranscribeClientTypes.CallAnalyticsJobSettings?
        /// A timestamp that shows when the analytics job started processing.
        var startTime: ClientRuntime.Date?
        /// Identifies the location of a transcription.
        var transcript: TranscribeClientTypes.Transcript?
...
extension TranscribeClientTypes {
    ...
    public struct CallAnalyticsJobSettings: Swift.Equatable {
        ...
        var contentRedaction: TranscribeClientTypes.ContentRedaction?
        ...
        var languageIdSettings: [Swift.String:TranscribeClientTypes.LanguageIdSettings]?
        ...
        var languageOptions: [TranscribeClientTypes.LanguageCode]?
        ...
        var vocabularyFilterMethod: TranscribeClientTypes.VocabularyFilterMethod?
...
extension TranscribeClientTypes {
    ...
    public struct CategoryProperties: Swift.Equatable {
        ...
        var rules: [TranscribeClientTypes.Rule]?
...
extension TranscribeClientTypes {
    ...
    public struct ContentRedaction: Swift.Equatable {
        ...
        var redactionOutput: TranscribeClientTypes.RedactionOutput?
        /// Request parameter that defines the entities to be redacted. The only accepted value is PII.
        /// This member is required.
        var redactionType: TranscribeClientTypes.RedactionType?
...
public struct CreateCallAnalyticsCategoryOutputResponse: Swift.Equatable {
    ...
    var categoryProperties: TranscribeClientTypes.CategoryProperties?
...
public struct CreateLanguageModelInput: Swift.Equatable {
    ...
    /// This member is required.
    var baseModelName: TranscribeClientTypes.BaseModelName?
    ...
    /// This member is required.
    var inputDataConfig: TranscribeClientTypes.InputDataConfig?
    /// The language of the input text you're using to train your custom language model.
    /// This member is required.
    var languageCode: TranscribeClientTypes.CLMLanguageCode?
    ...
    var tags: [TranscribeClientTypes.Tag]?
...
public struct CreateLanguageModelOutputResponse: Swift.Equatable {
    ...
    var modelStatus: TranscribeClientTypes.ModelStatus?
...
public struct CreateMedicalVocabularyInput: Swift.Equatable {
    ...
    /// This member is required.
    var vocabularyFileUri: Swift.String?
...
public struct CreateMedicalVocabularyOutputResponse: Swift.Equatable {
    ...
    var vocabularyState: TranscribeClientTypes.VocabularyState?
...
public struct CreateVocabularyFilterInput: Swift.Equatable {
    ...
    var vocabularyFilterFileUri: Swift.String?
...
public struct DeleteMedicalTranscriptionJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var medicalTranscriptionJobName: Swift.String?
...
public struct DeleteTranscriptionJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var transcriptionJobName: Swift.String?
...
public struct DescribeLanguageModelOutputResponse: Swift.Equatable {
    ...
    var languageModel: TranscribeClientTypes.LanguageModel?
...
public struct GetCallAnalyticsJobOutputResponse: Swift.Equatable {
    ...
    var callAnalyticsJob: TranscribeClientTypes.CallAnalyticsJob?
...
public struct GetMedicalTranscriptionJobOutputResponse: Swift.Equatable {
    ...
    var medicalTranscriptionJob: TranscribeClientTypes.MedicalTranscriptionJob?
...
public struct GetTranscriptionJobOutputResponse: Swift.Equatable {
    ...
    var transcriptionJob: TranscribeClientTypes.TranscriptionJob?
...
extension TranscribeClientTypes {
    ...
    public struct InputDataConfig: Swift.Equatable {
        ...
        var tuningDataS3Uri: Swift.String?
...
extension TranscribeClientTypes {
    ...
    public struct InterruptionFilter: Swift.Equatable {
        ...
        var absoluteTimeRange: TranscribeClientTypes.AbsoluteTimeRange?
        /// Set to TRUE to look for a time period where there was no interruption.
        var negate: Swift.Bool?
        ...
        var relativeTimeRange: TranscribeClientTypes.RelativeTimeRange?
...
extension TranscribeClientTypes {
    ...
    public struct JobExecutionSettings: Swift.Equatable {
        ...
        var allowDeferredExecution: Swift.Bool?
...
extension TranscribeClientTypes {
    ...
    public struct LanguageModel: Swift.Equatable {
        ...
        var upgradeAvailability: Swift.Bool?
...
public struct ListCallAnalyticsCategoriesOutputResponse: Swift.Equatable {
    ...
    var categories: [TranscribeClientTypes.CategoryProperties]?
...
public struct ListCallAnalyticsJobsInput: Swift.Equatable {
    ...
    var jobNameContains: Swift.String?
    ...
    var status: TranscribeClientTypes.CallAnalyticsJobStatus?
...
public struct ListCallAnalyticsJobsOutputResponse: Swift.Equatable {
    ...
    var callAnalyticsJobSummaries: [TranscribeClientTypes.CallAnalyticsJobSummary]?
...
public struct ListLanguageModelsInput: Swift.Equatable {
    ...
    var statusEquals: TranscribeClientTypes.ModelStatus?
...
public struct ListLanguageModelsOutputResponse: Swift.Equatable {
    ...
    var models: [TranscribeClientTypes.LanguageModel]?
...
public struct ListMedicalTranscriptionJobsInput: Swift.Equatable {
    ...
    var status: TranscribeClientTypes.TranscriptionJobStatus?
...
public struct ListMedicalTranscriptionJobsOutputResponse: Swift.Equatable {
    /// A list of objects containing summary information for a transcription job.
    var medicalTranscriptionJobSummaries: [TranscribeClientTypes.MedicalTranscriptionJobSummary]?
...
public struct ListMedicalVocabulariesInput: Swift.Equatable {
    ...
    var stateEquals: TranscribeClientTypes.VocabularyState?
...
public struct ListMedicalVocabulariesOutputResponse: Swift.Equatable {
    ...
    var status: TranscribeClientTypes.VocabularyState?
    /// A list of objects that describe the vocabularies that match your search criteria.
    var vocabularies: [TranscribeClientTypes.VocabularyInfo]?
...
public struct ListTranscriptionJobsOutputResponse: Swift.Equatable {
    ...
    var status: TranscribeClientTypes.TranscriptionJobStatus?
    /// A list of objects containing summary information for a transcription job.
    var transcriptionJobSummaries: [TranscribeClientTypes.TranscriptionJobSummary]?
...
public struct ListVocabularyFiltersOutputResponse: Swift.Equatable {
    ...
    var vocabularyFilters: [TranscribeClientTypes.VocabularyFilterInfo]?
...
extension TranscribeClientTypes {
    ...
    public struct MedicalTranscript: Swift.Equatable {
        ...
        var transcriptFileUri: Swift.String?
...
extension TranscribeClientTypes {
    ...
    public struct MedicalTranscriptionJob: Swift.Equatable {
        ...
        var contentIdentificationType: TranscribeClientTypes.MedicalContentIdentificationType?
        ...
        var settings: TranscribeClientTypes.MedicalTranscriptionSetting?
        ...
        var specialty: TranscribeClientTypes.Specialty?
        /// A timestamp that shows when the job started processing.
        var startTime: ClientRuntime.Date?
        /// A key:value pair assigned to a given medical transcription job.
        var tags: [TranscribeClientTypes.Tag]?
        /// An object that contains the MedicalTranscript. The MedicalTranscript contains the TranscriptFileUri.
        var transcript: TranscribeClientTypes.MedicalTranscript?
        /// The completion status of a medical transcription job.
        var transcriptionJobStatus: TranscribeClientTypes.TranscriptionJobStatus?
        ...
        var type: TranscribeClientTypes.ModelType?
...
extension TranscribeClientTypes {
    ...
    public struct MedicalTranscriptionJobSummary: Swift.Equatable {
        ...
        var outputLocationType: TranscribeClientTypes.OutputLocationType?
...
extension TranscribeClientTypes {
    ...
    public struct MedicalTranscriptionSetting: Swift.Equatable {
        ...
        var channelIdentification: Swift.Bool?
        ...
        var maxAlternatives: Swift.Int?
        /// The maximum number of speakers to identify in the input audio. If there are more speakers in the audio than this number, multiple speakers are identified as a single speaker. If you specify the MaxSpeakerLabels field, you must set the ShowSpeakerLabels field to true.
        var maxSpeakerLabels: Swift.Int?
        ...
        var showAlternatives: Swift.Bool?
        ...
        var showSpeakerLabels: Swift.Bool?
...
extension TranscribeClientTypes {
    ...
    public struct SentimentFilter: Swift.Equatable {
        ...
        /// This member is required.
        var sentiments: [TranscribeClientTypes.SentimentValue]?
...
public struct StartCallAnalyticsJobInput: Swift.Equatable {
    ...
    var outputEncryptionKMSKeyId: Swift.String?
...
public struct StartMedicalTranscriptionJobInput: Swift.Equatable {
    ...
    var kMSEncryptionContext: [Swift.String:Swift.String]?
    ...
    /// This member is required.
    var outputBucketName: Swift.String?
...
public struct StartTranscriptionJobInput: Swift.Equatable {
    ...
    var identifyLanguage: Swift.Bool?
    /// Provides information about how a transcription job is executed. Use this field to indicate that the job can be queued for deferred execution if the concurrency limit is reached and there are no slots available to immediately run the job.
    var jobExecutionSettings: TranscribeClientTypes.JobExecutionSettings?
    /// A map of plain text, non-secret key:value pairs, known as encryption context pairs, that provide an added layer of security for your data.
    var kMSEncryptionContext: [Swift.String:Swift.String]?
    ...
    var modelSettings: TranscribeClientTypes.ModelSettings?
    ...
    var settings: TranscribeClientTypes.Settings?
    /// Add subtitles to your batch transcription job.
    var subtitles: TranscribeClientTypes.Subtitles?
...
extension TranscribeClientTypes {
    ...
    public struct Subtitles: Swift.Equatable {
        ...
        var formats: [TranscribeClientTypes.SubtitleFormat]?
...
extension TranscribeClientTypes {
    ...
    public struct SubtitlesOutput: Swift.Equatable {
        ...
        var subtitleFileUris: [Swift.String]?
...
extension TranscribeClientTypes {
    ...
    public struct Transcript: Swift.Equatable {
        ...
        var redactedTranscriptFileUri: Swift.String?
...
extension TranscribeClientTypes {
    ...
    public struct TranscriptFilter: Swift.Equatable {
        ...
        /// This member is required.
        var transcriptFilterType: TranscribeClientTypes.TranscriptFilterType?
...
extension TranscribeClientTypes {
    ...
    public struct TranscriptionJob: Swift.Equatable {
        ...
        var startTime: ClientRuntime.Date?
        /// Generate subtitles for your batch transcription job.
        var subtitles: TranscribeClientTypes.SubtitlesOutput?
