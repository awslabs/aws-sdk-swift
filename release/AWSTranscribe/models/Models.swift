...
extension TranscribeClientTypes {
    ...
    public struct CallAnalyticsJob: Swift.Equatable {
        ...
        ///                 MediaFormat field of the request isn't valid. See the description of the MediaFormat
        ///                 field for a list of valid values.
        ///
        ///
        ///
        ///                   The media format provided does not match the detected media format: The media
        ///                 format of the audio file doesn't match the format specified in the MediaFormat field in the request.
        ...
        ///
        ///
        ///                   The sample rate provided does not match the detected sample rate: The sample rate
        ///                 in the audio file doesn't match the sample rate specified in the MediaSampleRateHertz field in the
        ///                 request. Check the sample rate of your media file and make sure that the two values match.
        ///
        ///
        ///
        ///                   Invalid file size: file size too large: The size of your audio file is larger than what Amazon Transcribe Medical
        ...
        ///             possible language codes for the language spoken in your audio. Refer to <a href="https://docs.aws.amazon.com/transcribe/latest/dg/how-it-works.html">Supported languages and language-specific features for
...
public struct CreateMedicalVocabularyInput: Swift.Equatable {
    ...
    ///
    ///         For more information about Amazon S3 object names, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#object-keys">Object Keys in the Amazon S3
    ///                 Developer Guide.
    ///         For more information about custom vocabularies, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/how-it-works.html#how-vocabulary-med">Medical Custom Vocabularies.
    /// This member is required.
...
public struct CreateVocabularyFilterInput: Swift.Equatable {
    ...
    ///             the character set defined for custom vocabularies. For a list of character sets, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/how-vocabulary.html#charsets">Character Sets for Custom Vocabularies.
    ...
    ///             vocabularies. For a list of character sets, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/how-vocabulary.html#charsets">Character Sets for Custom Vocabularies.
...
public struct CreateVocabularyInput: Swift.Equatable {
    ...
    ///
    ///
    ///         For more information about S3 object names, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#object-keys">Object Keys in the
    ///             Amazon S3 Developer Guide.
    ///         For more information about custom vocabularies, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/how-vocabulary">Custom vocabularies.
    public var vocabularyFileUri: Swift.String?
...
extension TranscribeClientTypes {
    ...
    public struct Media: Swift.Equatable {
        ...
        ///
        ///
        ///         For more information about S3 object names, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#object-keys">Object Keys in the Amazon S3
        ///                 Developer Guide.
...
extension TranscribeClientTypes {
    ...
    public struct MedicalTranscriptionJob: Swift.Equatable {
        ...
        ///                     of the audio file doesn't match the format specified in the MediaFormat field in the request.
        ///                     Check the media format of your media file and make sure the two values match.
        ///
        ///
        ///
        ...
        ///                     audio file doesn't match the sample rate specified in the MediaSampleRateHertz field in the request.
        ///                     Check the sample rate of your media file and make sure that the two values match.
        ///
        ///
        ///
        ///                   Invalid file size: file size too large- The size of your audio file is larger than what Amazon Transcribe Medical can
        ///                     process. For more information, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/limits-guidelines.html#limits">Guidelines and Quotas in the Amazon Transcribe Medical
        ///                             Guide
        ///
        ///
        ///
        ...
        ///                     than Amazon Transcribe Medical is configured to process. To request additional channels, see <a href="https://docs.aws.amazon.com/general/latest/gr/transcribe-medical.html">Amazon Transcribe Medical Endpoints and Quotas in the Amazon
        ...
        /// The medical specialty of any clinicians providing a dictation or having a conversation. Refer to <a href="https://docs.aws.amazon.com/transcribe/latest/dg/transcribe-medical-conversation.html">Transcribing a medical conversationfor a
...
extension TranscribeClientTypes {
    ...
    public struct MedicalTranscriptionJobSummary: Swift.Equatable {
        ...
        /// The medical specialty of the transcription job. Refer to <a href="https://docs.aws.amazon.com/transcribe/latest/dg/transcribe-medical-conversation.html">Transcribing a medical conversationfor a
        ///             list of supported specialties.
        public var specialty: TranscribeClientTypes.Specialty?
        /// A timestamp that shows when the job began processing.
        public var startTime: ClientRuntime.Date?
...
extension StartTranscriptionJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartTranscriptionJobInput(contentRedaction: \(Swift.String(describing: contentRedaction)), identifyLanguage: \(Swift.String(describing: identifyLanguage)), jobExecutionSettings: \(Swift.String(describing: jobExecutionSettings)), kMSEncryptionContext: \(Swift.String(describing: kMSEncryptionContext)), languageCode: \(Swift.String(describing: languageCode)), languageOptions: \(Swift.String(describing: languageOptions)), media: \(Swift.String(describing: media)), mediaFormat: \(Swift.String(describing: mediaFormat)), mediaSampleRateHertz: \(Swift.String(describing: mediaSampleRateHertz)), modelSettings: \(Swift.String(describing: modelSettings)), outputBucketName: \(Swift.String(describing: outputBucketName)), outputEncryptionKMSKeyId: \(Swift.String(describing: outputEncryptionKMSKeyId)), outputKey: \(Swift.String(describing: outputKey)), settings: \(Swift.String(describing: settings)), subtitles: \(Swift.String(describing: subtitles)), tags: \(Swift.String(describing: tags)), transcriptionJobName: \(Swift.String(describing: transcriptionJobName)))"}
}
...
extension TranscribeClientTypes.TranscriptionJob: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TranscriptionJob(completionTime: \(Swift.String(describing: completionTime)), contentRedaction: \(Swift.String(describing: contentRedaction)), creationTime: \(Swift.String(describing: creationTime)), failureReason: \(Swift.String(describing: failureReason)), identifiedLanguageScore: \(Swift.String(describing: identifiedLanguageScore)), identifyLanguage: \(Swift.String(describing: identifyLanguage)), jobExecutionSettings: \(Swift.String(describing: jobExecutionSettings)), languageCode: \(Swift.String(describing: languageCode)), languageOptions: \(Swift.String(describing: languageOptions)), media: \(Swift.String(describing: media)), mediaFormat: \(Swift.String(describing: mediaFormat)), mediaSampleRateHertz: \(Swift.String(describing: mediaSampleRateHertz)), modelSettings: \(Swift.String(describing: modelSettings)), settings: \(Swift.String(describing: settings)), startTime: \(Swift.String(describing: startTime)), subtitles: \(Swift.String(describing: subtitles)), tags: \(Swift.String(describing: tags)), transcript: \(Swift.String(describing: transcript)), transcriptionJobName: \(Swift.String(describing: transcriptionJobName)), transcriptionJobStatus: \(Swift.String(describing: transcriptionJobStatus)))"}
}
...
extension TranscribeClientTypes {
    ...
    public struct TranscriptionJob: Swift.Equatable {
        ...
        ///                     field of the request isn't valid. See the description of the MediaFormat field for a list of valid
        ///                     values.
        ///
        ///
        ///
        ///                   The media format provided does not match the detected media format - The media format
        ///                     of the audio file doesn't match the format specified in the MediaFormat field in the request. Check
        ...
        ///
        ///
        ///                   Invalid file size: file size too large - The size of your audio file is larger than Amazon Transcribe can process.
        ///                     For more information, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/limits-guidelines.html#limits">Limits in the Amazon Transcribe Developer Guide.
        ///
        ///
        ///
        ///                   Invalid number of channels: number of channels too large - Your audio contains more
        ///                     channels than Amazon Transcribe is configured to process. To request additional channels, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html#limits-amazon-transcribe">Amazon Transcribe Limits in
...
public struct UpdateMedicalVocabularyInput: Swift.Equatable {
    ...
    ///         For more information about Amazon S3 object names, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#object-keys">Object Keys in the Amazon S3
    ///                 Developer Guide.
    ///         For more information about custom vocabularies in Amazon Transcribe Medical, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/how-it-works.html#how-vocabulary">Medical Custom Vocabularies.
    public var vocabularyFileUri: Swift.String?
...
public struct UpdateVocabularyInput: Swift.Equatable {
    ...
    ///         For more information about S3 object names, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#object-keys">Object Keys in the Amazon S3
    ///                 Developer Guide.
    ///         For more information about custom vocabularies, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/how-it-works.html#how-vocabulary">Custom Vocabularies.
    public var vocabularyFileUri: Swift.String?
    /// The name of the vocabulary to update. The name is case sensitive. If you try to update a vocabulary with the
