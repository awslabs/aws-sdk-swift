...
public struct CreateSavingsPlanInput: Swift.Equatable {
    ...
    var commitment: Swift.String?
    /// The time at which to purchase the Savings Plan, in UTC format (YYYY-MM-DDTHH:MM:SSZ).
    var purchaseTime: ClientRuntime.Date?
    /// The ID of the offering.
    /// This member is required.
    var savingsPlanOfferingId: Swift.String?
    /// One or more tags.
    ...
    var upfrontPaymentAmount: Swift.String?
...
public struct CreateSavingsPlanOutputResponse: Swift.Equatable {
    ...
    var savingsPlanId: Swift.String?
...
public struct DescribeSavingsPlanRatesInput: Swift.Equatable {
    /// The filters.
    var filters: [SavingsplansClientTypes.SavingsPlanRateFilter]?
...
public struct DescribeSavingsPlanRatesOutputResponse: Swift.Equatable {
    ...
    var searchResults: [SavingsplansClientTypes.SavingsPlanRate]?
...
public struct DescribeSavingsPlansInput: Swift.Equatable {
    /// The filters.
    var filters: [SavingsplansClientTypes.SavingsPlanFilter]?
    /// The maximum number of results to return with a single call. To retrieve additional results, make another call with the returned token value.
    var maxResults: Swift.Int?
    /// The token for the next page of results.
    var nextToken: Swift.String?
    /// The Amazon Resource Names (ARN) of the Savings Plans.
    var savingsPlanArns: [Swift.String]?
    /// The IDs of the Savings Plans.
    var savingsPlanIds: [Swift.String]?
    /// The states.
    var states: [SavingsplansClientTypes.SavingsPlanState]?
...
public struct DescribeSavingsPlansOfferingRatesInput: Swift.Equatable {
    /// The filters.
    var filters: [SavingsplansClientTypes.SavingsPlanOfferingRateFilterElement]?
    /// The maximum number of results to return with a single call. To retrieve additional results, make another call with the returned token value.
    var maxResults: Swift.Int
    /// The token for the next page of results.
    var nextToken: Swift.String?
    /// The specific AWS operation for the line item in the billing report.
    var operations: [Swift.String]?
    /// The AWS products.
    var products: [SavingsplansClientTypes.SavingsPlanProductType]?
    /// The IDs of the offerings.
    var savingsPlanOfferingIds: [Swift.String]?
    /// The payment options.
    var savingsPlanPaymentOptions: [SavingsplansClientTypes.SavingsPlanPaymentOption]?
    /// The plan types.
    var savingsPlanTypes: [SavingsplansClientTypes.SavingsPlanType]?
    /// The services.
    var serviceCodes: [SavingsplansClientTypes.SavingsPlanRateServiceCode]?
    /// The usage details of the line item in the billing report.
    var usageTypes: [Swift.String]?
...
public struct DescribeSavingsPlansOfferingRatesOutputResponse: Swift.Equatable {
    ...
    var searchResults: [SavingsplansClientTypes.SavingsPlanOfferingRate]?
...
public struct DescribeSavingsPlansOfferingsInput: Swift.Equatable {
    /// The currencies.
    var currencies: [SavingsplansClientTypes.CurrencyCode]?
    /// The descriptions.
    var descriptions: [Swift.String]?
    /// The durations, in seconds.
    var durations: [Swift.Int]?
    /// The filters.
    var filters: [SavingsplansClientTypes.SavingsPlanOfferingFilterElement]?
    /// The maximum number of results to return with a single call. To retrieve additional results, make another call with the returned token value.
    var maxResults: Swift.Int
    /// The token for the next page of results.
    var nextToken: Swift.String?
    /// The IDs of the offerings.
    var offeringIds: [Swift.String]?
    /// The specific AWS operation for the line item in the billing report.
    var operations: [Swift.String]?
    /// The payment options.
    var paymentOptions: [SavingsplansClientTypes.SavingsPlanPaymentOption]?
    /// The plan type.
    var planTypes: [SavingsplansClientTypes.SavingsPlanType]?
    /// The product type.
    var productType: SavingsplansClientTypes.SavingsPlanProductType?
    /// The services.
    var serviceCodes: [Swift.String]?
    /// The usage details of the line item in the billing report.
    var usageTypes: [Swift.String]?
...
public struct DescribeSavingsPlansOfferingsOutputResponse: Swift.Equatable {
    ...
    var searchResults: [SavingsplansClientTypes.SavingsPlanOffering]?
...
public struct DescribeSavingsPlansOutputResponse: Swift.Equatable {
    ...
    var savingsPlans: [SavingsplansClientTypes.SavingsPlan]?
...
extension SavingsplansClientTypes {
    ...
    public struct ParentSavingsPlanOffering: Swift.Equatable {
        /// The currency.
        var currency: SavingsplansClientTypes.CurrencyCode?
        /// The duration, in seconds.
        var durationSeconds: Swift.Int
        /// The ID of the offering.
        var offeringId: Swift.String?
        /// The payment option.
        var paymentOption: SavingsplansClientTypes.SavingsPlanPaymentOption?
        /// The description.
        var planDescription: Swift.String?
        /// The plan type.
        var planType: SavingsplansClientTypes.SavingsPlanType?
...
extension SavingsplansClientTypes {
    ...
    public struct SavingsPlan: Swift.Equatable {
        ...
        var ec2InstanceFamily: Swift.String?
        /// The end time.
        ...
        var paymentOption: SavingsplansClientTypes.SavingsPlanPaymentOption?
        /// The product types.
        var productTypes: [SavingsplansClientTypes.SavingsPlanProductType]?
        /// The recurring payment amount.
        var recurringPaymentAmount: Swift.String?
        /// The AWS Region.
        var region: Swift.String?
        /// The Amazon Resource Name (ARN) of the Savings Plan.
        var savingsPlanArn: Swift.String?
        /// The ID of the Savings Plan.
        var savingsPlanId: Swift.String?
        /// The plan type.
        var savingsPlanType: SavingsplansClientTypes.SavingsPlanType?
        /// The start time.
        var start: Swift.String?
        /// The state.
        var state: SavingsplansClientTypes.SavingsPlanState?
        /// One or more tags.
        var tags: [Swift.String:Swift.String]?
        /// The duration of the term, in seconds.
        var termDurationInSeconds: Swift.Int
...
extension SavingsplansClientTypes {
    ...
    public struct SavingsPlanFilter: Swift.Equatable {
        /// The filter name.
        var name: SavingsplansClientTypes.SavingsPlansFilterName?
        /// The filter value.
...
extension SavingsplansClientTypes {
    ...
    public struct SavingsPlanOffering: Swift.Equatable {
        ...
        var productTypes: [SavingsplansClientTypes.SavingsPlanProductType]?
        /// The properties.
        var properties: [SavingsplansClientTypes.SavingsPlanOfferingProperty]?
        /// The service.
        var serviceCode: Swift.String?
        /// The usage details of the line item in the billing report.
        var usageType: Swift.String?
...
extension SavingsplansClientTypes {
    ...
    public struct SavingsPlanOfferingFilterElement: Swift.Equatable {
        /// The filter name.
        var name: SavingsplansClientTypes.SavingsPlanOfferingFilterAttribute?
        /// The filter values.
        var values: [Swift.String]?
...
extension SavingsplansClientTypes {
    ...
    public struct SavingsPlanOfferingProperty: Swift.Equatable {
        /// The property name.
        var name: SavingsplansClientTypes.SavingsPlanOfferingPropertyKey?
        /// The property value.
...
extension SavingsplansClientTypes {
    ...
    public struct SavingsPlanOfferingRate: Swift.Equatable {
        ...
        var productType: SavingsplansClientTypes.SavingsPlanProductType?
        /// The properties.
        var properties: [SavingsplansClientTypes.SavingsPlanOfferingRateProperty]?
        /// The Savings Plan rate.
        var rate: Swift.String?
        /// The Savings Plan offering.
        var savingsPlanOffering: SavingsplansClientTypes.ParentSavingsPlanOffering?
        /// The service.
        var serviceCode: SavingsplansClientTypes.SavingsPlanRateServiceCode?
        /// The unit.
        var unit: SavingsplansClientTypes.SavingsPlanRateUnit?
        /// The usage details of the line item in the billing report.
        var usageType: Swift.String?
...
extension SavingsplansClientTypes {
    ...
    public struct SavingsPlanOfferingRateFilterElement: Swift.Equatable {
        /// The filter name.
        var name: SavingsplansClientTypes.SavingsPlanRateFilterAttribute?
        /// The filter values.
        var values: [Swift.String]?
...
extension SavingsplansClientTypes {
    ...
    public struct SavingsPlanRate: Swift.Equatable {
        ...
        var productType: SavingsplansClientTypes.SavingsPlanProductType?
        /// The properties.
        var properties: [SavingsplansClientTypes.SavingsPlanRateProperty]?
        /// The rate.
        var rate: Swift.String?
        /// The service.
        var serviceCode: SavingsplansClientTypes.SavingsPlanRateServiceCode?
...
extension SavingsplansClientTypes {
    ...
    public struct SavingsPlanRateFilter: Swift.Equatable {
        /// The filter name.
        var name: SavingsplansClientTypes.SavingsPlanRateFilterName?
        /// The filter values.
        var values: [Swift.String]?
...
extension SavingsplansClientTypes {
    ...
    public struct SavingsPlanRateProperty: Swift.Equatable {
        /// The property name.
        var name: SavingsplansClientTypes.SavingsPlanRatePropertyKey?
        /// The property value.
        var value: Swift.String?
