...
extension FSxClientTypes {
    ...
    public struct ActiveDirectoryBackupAttributes: Swift.Equatable {
        ...
        var activeDirectoryId: Swift.String?
...
extension FSxClientTypes {
    ...
    public struct AdministrativeAction: Swift.Equatable {
        ...
        var administrativeActionType: FSxClientTypes.AdministrativeActionType?
        /// Provides information about a failed administrative action.
        var failureDetails: FSxClientTypes.AdministrativeActionFailureDetails?
        ...
        var requestTime: ClientRuntime.Date?
        ...
        var status: FSxClientTypes.Status?
        ...
        var targetFileSystemValues: FSxClientTypes.FileSystem?
        /// A snapshot of an Amazon FSx for OpenZFS volume.
        var targetSnapshotValues: FSxClientTypes.Snapshot?
        /// Describes an Amazon FSx for NetApp ONTAP or Amazon FSx for OpenZFS volume.
        var targetVolumeValues: FSxClientTypes.Volume?
...
extension FSxClientTypes {
    ...
    public struct Alias: Swift.Equatable {
        ...
        var lifecycle: FSxClientTypes.AliasLifecycle?
...
public struct AssociateFileSystemAliasesOutputResponse: Swift.Equatable {
    ...
    var aliases: [FSxClientTypes.Alias]?
...
extension FSxClientTypes {
    ...
    public struct AutoExportPolicy: Swift.Equatable {
        ...
        var events: [FSxClientTypes.EventType]?
...
extension FSxClientTypes {
    ...
    public struct Backup: Swift.Equatable {
        ...
        var directoryInformation: FSxClientTypes.ActiveDirectoryBackupAttributes?
        /// Details explaining any failures that occurred when creating a backup.
        var failureDetails: FSxClientTypes.BackupFailureDetails?
        /// The metadata of the file system associated with the backup. This metadata is persisted even if the file system is deleted.
        /// This member is required.
        var fileSystem: FSxClientTypes.FileSystem?
        ...
        /// This member is required.
        var lifecycle: FSxClientTypes.BackupLifecycle?
        ...
        var resourceType: FSxClientTypes.ResourceType?
        /// The ID of the source backup. Specifies the backup that you are copying.
        var sourceBackupId: Swift.String?
        /// The source Region of the backup. Specifies the Region from where this backup is copied.
        var sourceBackupRegion: Swift.String?
        /// The tags associated with a particular file system.
        var tags: [FSxClientTypes.Tag]?
        /// The type of the file-system backup.
        /// This member is required.
        var type: FSxClientTypes.BackupType?
        /// Describes an Amazon FSx for NetApp ONTAP or Amazon FSx for OpenZFS volume.
        var volume: FSxClientTypes.Volume?
...
public struct CancelDataRepositoryTaskOutputResponse: Swift.Equatable {
    ...
    var lifecycle: FSxClientTypes.DataRepositoryTaskLifecycle?
...
extension FSxClientTypes {
    ...
    public struct CompletionReport: Swift.Equatable {
        ...
        var format: FSxClientTypes.ReportFormat?
        ...
        var scope: FSxClientTypes.ReportScope?
...
public struct CopyBackupOutputResponse: Swift.Equatable {
    /// A backup of an Amazon FSx for Windows File Server, Amazon FSx for Lustre file system, Amazon FSx for NetApp ONTAP volume, or Amazon FSx for OpenZFS file system.
    var backup: FSxClientTypes.Backup?
...
public struct CreateDataRepositoryAssociationInput: Swift.Equatable {
    ...
    var batchImportMetaDataOnCreate: Swift.Bool?
    /// (Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.
    var clientRequestToken: Swift.String?
    /// The path to the Amazon S3 data repository that will be linked to the file system. The path can be an S3 bucket or prefix in the format s3://myBucket/myPrefix/. This path specifies where in the S3 data repository files will be imported from or exported to.
    /// This member is required.
    var dataRepositoryPath: Swift.String?
...
public struct CreateDataRepositoryAssociationOutputResponse: Swift.Equatable {
    ...
    var association: FSxClientTypes.DataRepositoryAssociation?
...
public struct CreateDataRepositoryTaskInput: Swift.Equatable {
    ...
    /// This member is required.
    var report: FSxClientTypes.CompletionReport?
    /// A list of Tag values, with a maximum of 50 elements.
    var tags: [FSxClientTypes.Tag]?
    /// Specifies the type of data repository task to create.
    /// This member is required.
    var type: FSxClientTypes.DataRepositoryTaskType?
...
public struct CreateDataRepositoryTaskOutputResponse: Swift.Equatable {
    ...
    var dataRepositoryTask: FSxClientTypes.DataRepositoryTask?
...
public struct CreateFileSystemFromBackupInput: Swift.Equatable {
    ...
    var fileSystemTypeVersion: Swift.String?
    /// The ID of the Key Management Service (KMS) key used to encrypt the file system's data for Amazon FSx for Windows File Server file systems, Amazon FSx for NetApp ONTAP file systems, and Amazon FSx for Lustre PERSISTENT_1 and PERSISTENT_2 file systems at rest. If this ID isn't specified, the key managed by Amazon FSx is used. The Amazon FSx for Lustre SCRATCH_1 and SCRATCH_2 file systems are always encrypted at rest using Amazon FSx-managed keys. For more information, see [Encrypt](https://docs.aws.amazon.com/kms/latest/APIReference/API_Encrypt.html) in the Key Management Service API Reference.
    var kmsKeyId: Swift.String?
    ...
    ///
    /// * ImportPath
    var lustreConfiguration: FSxClientTypes.CreateFileSystemLustreConfiguration?
    /// The OpenZFS configuration for the file system that's being created.
    var openZFSConfiguration: FSxClientTypes.CreateFileSystemOpenZFSConfiguration?
    ...
    var storageType: FSxClientTypes.StorageType?
    ...
    var windowsConfiguration: FSxClientTypes.CreateFileSystemWindowsConfiguration?
...
public struct CreateFileSystemInput: Swift.Equatable {
    ...
    /// This member is required.
    var fileSystemType: FSxClientTypes.FileSystemType?
    ...
    var ontapConfiguration: FSxClientTypes.CreateFileSystemOntapConfiguration?
    /// The OpenZFS configuration for the file system that's being created.
    var openZFSConfiguration: FSxClientTypes.CreateFileSystemOpenZFSConfiguration?
...
extension FSxClientTypes {
    ...
    public struct CreateFileSystemLustreConfiguration: Swift.Equatable {
        ...
        var autoImportPolicy: FSxClientTypes.AutoImportPolicyType?
        /// The number of days to retain automatic backups. Setting this property to 0 disables automatic backups. You can retain automatic backups for a maximum of 90 days. The default is 0.
        var automaticBackupRetentionDays: Swift.Int?
        ...
        var copyTagsToBackups: Swift.Bool?
        /// A recurring daily time, in the format HH:MM. HH is the zero-padded hour of the day (0-23), and MM is the zero-padded minute of the hour. For example, 05:00 specifies 5 AM daily.
        var dailyAutomaticBackupStartTime: Swift.String?
        ...
        var dataCompressionType: FSxClientTypes.DataCompressionType?
        ...
        var deploymentType: FSxClientTypes.LustreDeploymentType?
        /// The type of drive cache used by PERSISTENT_1 file systems that are provisioned with HDD storage devices. This parameter is required when storage type is HDD. Set this property to READ to improve the performance for frequently accessed files by caching up to 20% of the total storage capacity of the file system. This parameter is required when StorageType is set to HDD.
        var driveCacheType: FSxClientTypes.DriveCacheType?
        ...
        var logConfiguration: FSxClientTypes.LustreLogCreateConfiguration?
        ...
        var perUnitStorageThroughput: Swift.Int?
        /// (Optional) The preferred start time to perform weekly maintenance, formatted d:HH:MM in the UTC time zone, where d is the weekday number, from 1 through 7, beginning with Monday and ending with Sunday.
        var weeklyMaintenanceStartTime: Swift.String?
...
extension FSxClientTypes {
    ...
    public struct CreateFileSystemOntapConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var deploymentType: FSxClientTypes.OntapDeploymentType?
        /// The SSD IOPS configuration for the FSx for ONTAP file system.
        var diskIopsConfiguration: FSxClientTypes.DiskIopsConfiguration?
        /// Specifies the IP address range in which the endpoints to access your file system will be created. By default, Amazon FSx selects an unused IP address range for you from the 198.19.* range.
        var endpointIpAddressRange: Swift.String?
        /// The ONTAP administrative password for the fsxadmin user with which you administer your file system using the NetApp ONTAP CLI and REST API.
        var fsxAdminPassword: Swift.String?
        /// Required when DeploymentType is set to MULTI_AZ_1. This specifies the subnet in which you want the preferred file server to be located.
        var preferredSubnetId: Swift.String?
...
extension FSxClientTypes {
    ...
    public struct CreateFileSystemOpenZFSConfiguration: Swift.Equatable {
        ...
        var copyTagsToVolumes: Swift.Bool?
        /// A recurring daily time, in the format HH:MM. HH is the zero-padded hour of the day (0-23), and MM is the zero-padded minute of the hour. For example, 05:00 specifies 5 AM daily.
        var dailyAutomaticBackupStartTime: Swift.String?
        ...
        /// This member is required.
        var deploymentType: FSxClientTypes.OpenZFSDeploymentType?
        /// The SSD IOPS (input/output operations per second) configuration for an Amazon FSx for NetApp ONTAP or Amazon FSx for OpenZFS file system. The default is 3 IOPS per GB of storage capacity, but you can provision additional IOPS per GB of storage. The configuration consists of the total number of provisioned SSD IOPS and how the amount was provisioned (by the customer or by the system).
        var diskIopsConfiguration: FSxClientTypes.DiskIopsConfiguration?
        /// The configuration Amazon FSx uses when creating the root value of the Amazon FSx for OpenZFS file system. All volumes are children of the root volume.
        var rootVolumeConfiguration: FSxClientTypes.OpenZFSCreateRootVolumeConfiguration?
...
extension FSxClientTypes {
    ...
    public struct CreateFileSystemWindowsConfiguration: Swift.Equatable {
        ...
        var auditLogConfiguration: FSxClientTypes.WindowsAuditLogCreateConfiguration?
        ...
        var deploymentType: FSxClientTypes.WindowsDeploymentType?
        ...
        var selfManagedActiveDirectoryConfiguration: FSxClientTypes.SelfManagedActiveDirectoryConfiguration?
...
extension FSxClientTypes {
    ...
    public struct CreateOntapVolumeConfiguration: Swift.Equatable {
        ...
        var securityStyle: FSxClientTypes.SecurityStyle?
        /// Specifies the size of the volume, in megabytes (MB), that you are creating.
        /// This member is required.
        var sizeInMegabytes: Swift.Int?
        /// Set to true to enable deduplication, compression, and compaction storage efficiency features on the volume.
        /// This member is required.
        var storageEfficiencyEnabled: Swift.Bool?
        /// Specifies the ONTAP SVM in which to create the volume.
        /// This member is required.
        var storageVirtualMachineId: Swift.String?
        /// Describes the data tiering policy for an ONTAP volume. When enabled, Amazon FSx for ONTAP's intelligent tiering automatically transitions a volume's data between the file system's primary storage and capacity pool storage based on your access patterns.
        var tieringPolicy: FSxClientTypes.TieringPolicy?
...
extension FSxClientTypes {
    ...
    public struct CreateOpenZFSOriginSnapshotConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var copyStrategy: FSxClientTypes.OpenZFSCopyStrategy?
        /// The Amazon Resource Name (ARN) for a given resource. ARNs uniquely identify Amazon Web Services resources. We require an ARN when you need to specify a resource unambiguously across all of Amazon Web Services. For more information, see [Amazon Resource Names (ARNs)](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) in the Amazon Web Services General Reference.
        /// This member is required.
        var snapshotARN: Swift.String?
...
extension FSxClientTypes {
    ...
    public struct CreateOpenZFSVolumeConfiguration: Swift.Equatable {
        /// A Boolean value indicating whether tags for the volume should be copied to snapshots. This value defaults to false. If it's set to true, all tags for the volume are copied to snapshots where the user doesn't specify tags. If this value is true, and you specify one or more tags, only the specified tags are copied to snapshots. If you specify one or more tags when creating the snapshot, no tags are copied from the volume, regardless of this value.
        var copyTagsToSnapshots: Swift.Bool?
        ...
        var dataCompressionType: FSxClientTypes.OpenZFSDataCompressionType?
        /// The configuration object for mounting a Network File System (NFS) file system.
        var nfsExports: [FSxClientTypes.OpenZFSNfsExport]?
        /// The configuration object that specifies the snapshot to use as the origin of the data for the volume.
        var originSnapshot: FSxClientTypes.CreateOpenZFSOriginSnapshotConfiguration?
        /// The ID of the volume to use as the parent volume.
        /// This member is required.
        var parentVolumeId: Swift.String?
        ...
        var storageCapacityQuotaGiB: Swift.Int?
        /// The amount of storage in gibibytes (GiB) to reserve from the parent volume. You can't reserve more storage than the parent volume has reserved.
        var storageCapacityReservationGiB: Swift.Int?
        /// An object specifying how much storage users or groups can use on the volume.
        var userAndGroupQuotas: [FSxClientTypes.OpenZFSUserOrGroupQuota]?
...
public struct CreateSnapshotOutputResponse: Swift.Equatable {
    ...
    var snapshot: FSxClientTypes.Snapshot?
...
public struct CreateStorageVirtualMachineInput: Swift.Equatable {
    ...
    var activeDirectoryConfiguration: FSxClientTypes.CreateSvmActiveDirectoryConfiguration?
    /// (Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.
    var clientRequestToken: Swift.String?
    /// The globally unique ID of the file system, assigned by Amazon FSx.
    /// This member is required.
    ...
    ///
    /// * MIXED if the file system is managed by both UNIX and Windows administrators and users consist of both NFS and SMB clients.
    var rootVolumeSecurityStyle: FSxClientTypes.StorageVirtualMachineRootVolumeSecurityStyle?
    ...
    var svmAdminPassword: Swift.String?
    /// A list of Tag values, with a maximum of 50 elements.
    var tags: [FSxClientTypes.Tag]?
...
public struct CreateStorageVirtualMachineOutputResponse: Swift.Equatable {
    ...
    var storageVirtualMachine: FSxClientTypes.StorageVirtualMachine?
...
public struct CreateVolumeFromBackupInput: Swift.Equatable {
    ...
    var name: Swift.String?
    /// Specifies the configuration of the ONTAP volume that you are creating.
    var ontapConfiguration: FSxClientTypes.CreateOntapVolumeConfiguration?
    /// A list of Tag values, with a maximum of 50 elements.
    var tags: [FSxClientTypes.Tag]?
...
public struct CreateVolumeInput: Swift.Equatable {
    ...
    var openZFSConfiguration: FSxClientTypes.CreateOpenZFSVolumeConfiguration?
    /// A list of Tag values, with a maximum of 50 elements.
    var tags: [FSxClientTypes.Tag]?
    /// Specifies the type of volume to create; ONTAP and OPENZFS are the only valid volume types.
    /// This member is required.
    var volumeType: FSxClientTypes.VolumeType?
...
extension FSxClientTypes {
    ...
    public struct DataRepositoryAssociation: Swift.Equatable {
        ...
        var failureDetails: FSxClientTypes.DataRepositoryFailureDetails?
        /// The globally unique ID of the file system, assigned by Amazon FSx.
        var fileSystemId: Swift.String?
        /// A path on the file system that points to a high-level directory (such as /ns1/) or subdirectory (such as /ns1/subdir/) that will be mapped 1-1 with DataRepositoryPath. The leading forward slash in the name is required. Two data repository associations cannot have overlapping file system paths. For example, if a data repository is associated with file system path /ns1/, then you cannot link another data repository with file system path /ns1/ns2. This path specifies where in your file system files will be exported from or imported to. This file system directory can be linked to only one Amazon S3 bucket, and no other S3 bucket can be linked to the directory.
        var fileSystemPath: Swift.String?
        ...
        var lifecycle: FSxClientTypes.DataRepositoryLifecycle?
        /// The Amazon Resource Name (ARN) for a given resource. ARNs uniquely identify Amazon Web Services resources. We require an ARN when you need to specify a resource unambiguously across all of Amazon Web Services. For more information, see [Amazon Resource Names (ARNs)](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) in the Amazon Web Services General Reference.
        var resourceARN: Swift.String?
        /// The configuration for an Amazon S3 data repository linked to an Amazon FSx Lustre file system with a data repository association. The configuration defines which file events (new, changed, or deleted files or directories) are automatically imported from the linked data repository to the file system or automatically exported from the file system to the data repository.
        var s3: FSxClientTypes.S3DataRepositoryConfiguration?
...
extension FSxClientTypes {
    ...
    public struct DataRepositoryTask: Swift.Equatable {
        ...
        var failureDetails: FSxClientTypes.DataRepositoryTaskFailureDetails?
        /// The globally unique ID of the file system, assigned by Amazon FSx.
        /// This member is required.
        var fileSystemId: Swift.String?
        /// The lifecycle status of the data repository task, as follows:
        ...
        var status: FSxClientTypes.DataRepositoryTaskStatus?
        /// A list of Tag values, with a maximum of 50 elements.
        var tags: [FSxClientTypes.Tag]?
...
extension FSxClientTypes {
    ...
    public struct DataRepositoryTaskFilter: Swift.Equatable {
        ...
        var name: FSxClientTypes.DataRepositoryTaskFilterName?
...
public struct DeleteDataRepositoryAssociationInput: Swift.Equatable {
    ...
    /// This member is required.
    var deleteDataInFileSystem: Swift.Bool?
...
public struct DeleteFileSystemInput: Swift.Equatable {
    ...
    var lustreConfiguration: FSxClientTypes.DeleteFileSystemLustreConfiguration?
    /// The configuration object for the OpenZFS file system used in the DeleteFileSystem operation.
    var openZFSConfiguration: FSxClientTypes.DeleteFileSystemOpenZFSConfiguration?
    /// The configuration object for the Microsoft Windows file system used in the DeleteFileSystem operation.
    var windowsConfiguration: FSxClientTypes.DeleteFileSystemWindowsConfiguration?
...
extension FSxClientTypes {
    ...
    public struct DeleteFileSystemLustreConfiguration: Swift.Equatable {
        ...
        var finalBackupTags: [FSxClientTypes.Tag]?
        ...
        var skipFinalBackup: Swift.Bool?
...
extension FSxClientTypes {
    ...
    public struct DeleteFileSystemLustreResponse: Swift.Equatable {
        ...
        var finalBackupId: Swift.String?
...
public struct DeleteFileSystemOutputResponse: Swift.Equatable {
    ...
    var lifecycle: FSxClientTypes.FileSystemLifecycle?
    /// The response object for the Amazon FSx for Lustre file system being deleted in the DeleteFileSystem operation.
    var lustreResponse: FSxClientTypes.DeleteFileSystemLustreResponse?
    /// The response object for the OpenZFS file system that's being deleted in the DeleteFileSystem operation.
    var openZFSResponse: FSxClientTypes.DeleteFileSystemOpenZFSResponse?
    /// The response object for the Microsoft Windows file system used in the DeleteFileSystem operation.
    var windowsResponse: FSxClientTypes.DeleteFileSystemWindowsResponse?
...
public struct DeleteSnapshotOutputResponse: Swift.Equatable {
    ...
    var lifecycle: FSxClientTypes.SnapshotLifecycle?
...
public struct DeleteStorageVirtualMachineOutputResponse: Swift.Equatable {
    ...
    var lifecycle: FSxClientTypes.StorageVirtualMachineLifecycle?
...
public struct DeleteVolumeInput: Swift.Equatable {
    ...
    var ontapConfiguration: FSxClientTypes.DeleteVolumeOntapConfiguration?
    /// For Amazon FSx for OpenZFS volumes, specify whether to delete all child volumes and snapshots.
    var openZFSConfiguration: FSxClientTypes.DeleteVolumeOpenZFSConfiguration?
...
extension FSxClientTypes {
    ...
    public struct DeleteVolumeOpenZFSConfiguration: Swift.Equatable {
        ...
        var options: [FSxClientTypes.DeleteOpenZFSVolumeOption]?
...
public struct DeleteVolumeOutputResponse: Swift.Equatable {
    ...
    var lifecycle: FSxClientTypes.VolumeLifecycle?
    /// Returned after a DeleteVolume request, showing the status of the delete request.
    var ontapResponse: FSxClientTypes.DeleteVolumeOntapResponse?
...
public struct DescribeBackupsOutputResponse: Swift.Equatable {
    /// An array of backups.
    var backups: [FSxClientTypes.Backup]?
...
public struct DescribeDataRepositoryAssociationsInput: Swift.Equatable {
    ...
    var associationIds: [Swift.String]?
...
public struct DescribeDataRepositoryAssociationsOutputResponse: Swift.Equatable {
    ...
    var associations: [FSxClientTypes.DataRepositoryAssociation]?
    /// (Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous NextToken value left off.
    var nextToken: Swift.String?
...
public struct DescribeDataRepositoryTasksInput: Swift.Equatable {
    ...
    var filters: [FSxClientTypes.DataRepositoryTaskFilter]?
    /// The maximum number of resources to return in the response. This value must be an integer greater than zero.
    var maxResults: Swift.Int?
    /// (Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous NextToken value left off.
    var nextToken: Swift.String?
    /// (Optional) IDs of the tasks whose descriptions you want to retrieve (String).
    var taskIds: [Swift.String]?
...
public struct DescribeDataRepositoryTasksOutputResponse: Swift.Equatable {
    ...
    var dataRepositoryTasks: [FSxClientTypes.DataRepositoryTask]?
    /// (Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous NextToken value left off.
    var nextToken: Swift.String?
...
public struct DescribeFileSystemsInput: Swift.Equatable {
    ...
    var fileSystemIds: [Swift.String]?
...
public struct DescribeFileSystemsOutputResponse: Swift.Equatable {
    ...
    var fileSystems: [FSxClientTypes.FileSystem]?
...
public struct DescribeSnapshotsInput: Swift.Equatable {
    ...
    var filters: [FSxClientTypes.SnapshotFilter]?
    /// The maximum number of resources to return in the response. This value must be an integer greater than zero.
    var maxResults: Swift.Int?
    /// (Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous NextToken value left off.
    var nextToken: Swift.String?
...
public struct DescribeSnapshotsOutputResponse: Swift.Equatable {
    ...
    var snapshots: [FSxClientTypes.Snapshot]?
...
public struct DescribeStorageVirtualMachinesInput: Swift.Equatable {
    ...
    var filters: [FSxClientTypes.StorageVirtualMachineFilter]?
    /// The maximum number of resources to return in the response. This value must be an integer greater than zero.
    var maxResults: Swift.Int?
    /// (Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous NextToken value left off.
    var nextToken: Swift.String?
    /// Enter the ID of one or more SVMs that you want to view.
    var storageVirtualMachineIds: [Swift.String]?
...
public struct DescribeStorageVirtualMachinesOutputResponse: Swift.Equatable {
    ...
    var storageVirtualMachines: [FSxClientTypes.StorageVirtualMachine]?
...
public struct DescribeVolumesInput: Swift.Equatable {
    ...
    var filters: [FSxClientTypes.VolumeFilter]?
    /// The maximum number of resources to return in the response. This value must be an integer greater than zero.
    var maxResults: Swift.Int?
    /// (Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous NextToken value left off.
    var nextToken: Swift.String?
...
public struct DescribeVolumesOutputResponse: Swift.Equatable {
    ...
    var volumes: [FSxClientTypes.Volume]?
...
extension FSxClientTypes {
    ...
    public struct DiskIopsConfiguration: Swift.Equatable {
        ...
        var mode: FSxClientTypes.DiskIopsConfigurationMode?
...
extension FSxClientTypes {
    ...
    public struct FileSystem: Swift.Equatable {
        ...
        var administrativeActions: [FSxClientTypes.AdministrativeAction]?
        ...
        var failureDetails: FSxClientTypes.FileSystemFailureDetails?
        ...
        var lustreConfiguration: FSxClientTypes.LustreFileSystemConfiguration?
        ...
        var networkInterfaceIds: [Swift.String]?
        /// The configuration for this FSx for ONTAP file system.
        var ontapConfiguration: FSxClientTypes.OntapFileSystemConfiguration?
        /// The configuration for this Amazon FSx for OpenZFS file system.
        var openZFSConfiguration: FSxClientTypes.OpenZFSFileSystemConfiguration?
        ...
        var windowsConfiguration: FSxClientTypes.WindowsFileSystemConfiguration?
...
extension FSxClientTypes {
    ...
    public struct FileSystemEndpoints: Swift.Equatable {
        ...
        var intercluster: FSxClientTypes.FileSystemEndpoint?
        /// An endpoint for managing your file system using the NetApp ONTAP CLI and NetApp ONTAP API.
        var management: FSxClientTypes.FileSystemEndpoint?
...
extension FSxClientTypes {
    ...
    public struct Filter: Swift.Equatable {
        ...
        var name: FSxClientTypes.FilterName?
...
extension FSxClientTypes {
    ...
    public struct LustreFileSystemConfiguration: Swift.Equatable {
        ...
        var dataCompressionType: FSxClientTypes.DataCompressionType?
        /// The data repository configuration object for Lustre file systems returned in the response of the CreateFileSystem operation. This data type is not supported for file systems with the Persistent_2 deployment type. Instead, use .
        var dataRepositoryConfiguration: FSxClientTypes.DataRepositoryConfiguration?
        ...
        var logConfiguration: FSxClientTypes.LustreLogConfiguration?
...
extension FSxClientTypes {
    ...
    public struct LustreLogConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var level: FSxClientTypes.LustreAccessAuditLogLevel?
...
extension FSxClientTypes {
    ...
    public struct OntapFileSystemConfiguration: Swift.Equatable {
        ...
        var endpoints: FSxClientTypes.FileSystemEndpoints?
...
extension FSxClientTypes {
    ...
    public struct OntapVolumeConfiguration: Swift.Equatable {
        ...
        var flexCacheEndpointType: FSxClientTypes.FlexCacheEndpointType?
        ...
        var ontapVolumeType: FSxClientTypes.OntapVolumeType?
        ...
        var storageVirtualMachineRoot: Swift.Bool?
...
extension FSxClientTypes {
    ...
    public struct OpenZFSNfsExport: Swift.Equatable {
        ...
        /// This member is required.
        var clientConfigurations: [FSxClientTypes.OpenZFSClientConfiguration]?
...
extension FSxClientTypes {
    ...
    public struct OpenZFSUserOrGroupQuota: Swift.Equatable {
        ...
        /// This member is required.
        var type: FSxClientTypes.OpenZFSQuotaType?
...
extension FSxClientTypes {
    ...
    public struct OpenZFSVolumeConfiguration: Swift.Equatable {
        ...
        var nfsExports: [FSxClientTypes.OpenZFSNfsExport]?
        /// The configuration object that specifies the snapshot to use as the origin of the data for the volume.
        var originSnapshot: FSxClientTypes.OpenZFSOriginSnapshotConfiguration?
...
public struct RestoreVolumeFromSnapshotInput: Swift.Equatable {
    ...
    var options: [FSxClientTypes.RestoreOpenZFSVolumeOption]?
...
extension FSxClientTypes {
    ...
    public struct S3DataRepositoryConfiguration: Swift.Equatable {
        ...
        var autoExportPolicy: FSxClientTypes.AutoExportPolicy?
        /// Specifies the type of updated objects (new, changed, deleted) that will be automatically imported from the linked S3 bucket to your file system.
        var autoImportPolicy: FSxClientTypes.AutoImportPolicy?
...
extension FSxClientTypes {
    ...
    public struct SelfManagedActiveDirectoryAttributes: Swift.Equatable {
        ...
        var dnsIps: [Swift.String]?
        /// The fully qualified domain name of the self-managed AD directory.
        var domainName: Swift.String?
        /// The name of the domain group whose members have administrative privileges for the FSx file system.
        var fileSystemAdministratorsGroup: Swift.String?
...
extension FSxClientTypes {
    ...
    public struct SnapshotFilter: Swift.Equatable {
        ...
        var name: FSxClientTypes.SnapshotFilterName?
...
extension FSxClientTypes {
    ...
    public struct StorageVirtualMachine: Swift.Equatable {
        ...
        var activeDirectoryConfiguration: FSxClientTypes.SvmActiveDirectoryConfiguration?
        /// The time that the resource was created, in seconds (since 1970-01-01T00:00:00Z), also known as Unix time.
        var creationTime: ClientRuntime.Date?
        ...
        var endpoints: FSxClientTypes.SvmEndpoints?
        /// The globally unique ID of the file system, assigned by Amazon FSx.
        var fileSystemId: Swift.String?
        ...
        var lifecycleTransitionReason: FSxClientTypes.LifecycleTransitionReason?
        ...
        var subtype: FSxClientTypes.StorageVirtualMachineSubtype?
        /// A list of Tag values, with a maximum of 50 elements.
        var tags: [FSxClientTypes.Tag]?
...
extension FSxClientTypes {
    ...
    public struct StorageVirtualMachineFilter: Swift.Equatable {
        /// The name for this filter.
        var name: FSxClientTypes.StorageVirtualMachineFilterName?
        /// The values of the filter. These are all the values for any of the applied filters.
        var values: [Swift.String]?
...
extension FSxClientTypes {
    ...
    public struct SvmActiveDirectoryConfiguration: Swift.Equatable {
        ...
        var netBiosName: Swift.String?
        /// The configuration of the self-managed Microsoft Active Directory (AD) directory to which the Windows File Server or ONTAP storage virtual machine (SVM) instance is joined.
        var selfManagedActiveDirectoryConfiguration: FSxClientTypes.SelfManagedActiveDirectoryAttributes?
...
extension FSxClientTypes {
    ...
    public struct SvmEndpoints: Swift.Equatable {
        ...
        var iscsi: FSxClientTypes.SvmEndpoint?
        /// An endpoint for managing SVMs using the NetApp ONTAP CLI, NetApp ONTAP API, or NetApp CloudManager.
        var management: FSxClientTypes.SvmEndpoint?
        /// An endpoint for connecting using the Network File System (NFS) protocol.
        var nfs: FSxClientTypes.SvmEndpoint?
        /// An endpoint for connecting using the Server Message Block (SMB) protocol.
        var smb: FSxClientTypes.SvmEndpoint?
...
extension FSxClientTypes {
    ...
    public struct TieringPolicy: Swift.Equatable {
        ...
        var name: FSxClientTypes.TieringPolicyName?
...
public struct UpdateFileSystemInput: Swift.Equatable {
    ...
    var lustreConfiguration: FSxClientTypes.UpdateFileSystemLustreConfiguration?
    /// The configuration updates for an Amazon FSx for NetApp ONTAP file system.
    var ontapConfiguration: FSxClientTypes.UpdateFileSystemOntapConfiguration?
    /// The configuration updates for an Amazon FSx for OpenZFS file system.
    var openZFSConfiguration: FSxClientTypes.UpdateFileSystemOpenZFSConfiguration?
    ...
    var windowsConfiguration: FSxClientTypes.UpdateFileSystemWindowsConfiguration?
...
extension FSxClientTypes {
    ...
    public struct UpdateFileSystemWindowsConfiguration: Swift.Equatable {
        ...
        var selfManagedActiveDirectoryConfiguration: FSxClientTypes.SelfManagedActiveDirectoryConfigurationUpdates?
...
public struct UpdateStorageVirtualMachineInput: Swift.Equatable {
    ...
    var activeDirectoryConfiguration: FSxClientTypes.UpdateSvmActiveDirectoryConfiguration?
    /// (Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.
    var clientRequestToken: Swift.String?
...
public struct UpdateVolumeInput: Swift.Equatable {
    ...
    var ontapConfiguration: FSxClientTypes.UpdateOntapVolumeConfiguration?
    /// The configuration of the OpenZFS volume that you are updating.
    var openZFSConfiguration: FSxClientTypes.UpdateOpenZFSVolumeConfiguration?
...
extension FSxClientTypes {
    ...
    public struct Volume: Swift.Equatable {
        ...
        var name: Swift.String?
        /// The configuration of an Amazon FSx for NetApp ONTAP volume.
        var ontapConfiguration: FSxClientTypes.OntapVolumeConfiguration?
        /// The configuration of an Amazon FSx for OpenZFS volume.
        var openZFSConfiguration: FSxClientTypes.OpenZFSVolumeConfiguration?
        /// The Amazon Resource Name (ARN) for a given resource. ARNs uniquely identify Amazon Web Services resources. We require an ARN when you need to specify a resource unambiguously across all of Amazon Web Services. For more information, see [Amazon Resource Names (ARNs)](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) in the Amazon Web Services General Reference.
        var resourceARN: Swift.String?
        /// A list of Tag values, with a maximum of 50 elements.
        var tags: [FSxClientTypes.Tag]?
...
extension FSxClientTypes {
    ...
    public struct VolumeFilter: Swift.Equatable {
        /// The name for this filter.
        var name: FSxClientTypes.VolumeFilterName?
        /// The values of the filter. These are all the values for any of the applied filters.
        var values: [Swift.String]?
...
extension FSxClientTypes {
    ...
    public struct WindowsAuditLogConfiguration: Swift.Equatable {
        ...
        var auditLogDestination: Swift.String?
        ...
        /// This member is required.
        var fileAccessAuditLogLevel: FSxClientTypes.WindowsAccessAuditLogLevel?
        ...
        /// This member is required.
        var fileShareAccessAuditLogLevel: FSxClientTypes.WindowsAccessAuditLogLevel?
...
extension FSxClientTypes {
    ...
    public struct WindowsFileSystemConfiguration: Swift.Equatable {
        ...
        var aliases: [FSxClientTypes.Alias]?
        /// The configuration that Amazon FSx for Windows File Server uses to audit and log user accesses of files, folders, and file shares on the Amazon FSx for Windows File Server file system.
        var auditLogConfiguration: FSxClientTypes.WindowsAuditLogConfiguration?
        ...
        var maintenanceOperationsInProgress: [FSxClientTypes.FileSystemMaintenanceOperation]?
        ...
        var preferredFileServerIp: Swift.String?
        ...
        var remoteAdministrationEndpoint: Swift.String?
        /// The configuration of the self-managed Microsoft Active Directory (AD) directory to which the Windows File Server or ONTAP storage virtual machine (SVM) instance is joined.
        var selfManagedActiveDirectoryConfiguration: FSxClientTypes.SelfManagedActiveDirectoryAttributes?
