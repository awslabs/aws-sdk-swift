...
public struct CreateFileSystemFromBackupInput: Swift.Equatable {
    ...
    ///
    ///
    /// Default value is SSD. HDD and SSD storage types have different minimum storage capacity requirements. A restored file system's storage capacity is tied to the file system that was backed up. You can create a file system that uses HDD storage from a backup of a file system that used SSD storage only if the original SSD file system had a storage capacity of at least 2000 GiB.
...
public struct CreateFileSystemInput: Swift.Equatable {
    ...
    public var securityGroupIds: [Swift.String]?
    /// Sets the storage capacity of the file system that you're creating. For Lustre file systems:
    ///
