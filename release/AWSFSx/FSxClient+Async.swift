...
public extension FSxClient {
    ...
    {
        typealias createDataRepositoryAssociationContinuation = CheckedContinuation<CreateDataRepositoryAssociationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createDataRepositoryAssociationContinuation) in
            createDataRepositoryAssociation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createStorageVirtualMachineContinuation = CheckedContinuation<CreateStorageVirtualMachineOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createStorageVirtualMachineContinuation) in
            createStorageVirtualMachine(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createVolumeFromBackupContinuation = CheckedContinuation<CreateVolumeFromBackupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createVolumeFromBackupContinuation) in
            createVolumeFromBackup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteDataRepositoryAssociationContinuation = CheckedContinuation<DeleteDataRepositoryAssociationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteDataRepositoryAssociationContinuation) in
            deleteDataRepositoryAssociation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteStorageVirtualMachineContinuation = CheckedContinuation<DeleteStorageVirtualMachineOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteStorageVirtualMachineContinuation) in
            deleteStorageVirtualMachine(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeDataRepositoryAssociationsContinuation = CheckedContinuation<DescribeDataRepositoryAssociationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeDataRepositoryAssociationsContinuation) in
            describeDataRepositoryAssociations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeStorageVirtualMachinesContinuation = CheckedContinuation<DescribeStorageVirtualMachinesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeStorageVirtualMachinesContinuation) in
            describeStorageVirtualMachines(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias releaseFileSystemNfsV3LocksContinuation = CheckedContinuation<ReleaseFileSystemNfsV3LocksOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: releaseFileSystemNfsV3LocksContinuation) in
            releaseFileSystemNfsV3Locks(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias restoreVolumeFromSnapshotContinuation = CheckedContinuation<RestoreVolumeFromSnapshotOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: restoreVolumeFromSnapshotContinuation) in
            restoreVolumeFromSnapshot(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateDataRepositoryAssociationContinuation = CheckedContinuation<UpdateDataRepositoryAssociationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateDataRepositoryAssociationContinuation) in
            updateDataRepositoryAssociation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateSnapshotContinuation = CheckedContinuation<UpdateSnapshotOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateSnapshotContinuation) in
            updateSnapshot(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateStorageVirtualMachineContinuation = CheckedContinuation<UpdateStorageVirtualMachineOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateStorageVirtualMachineContinuation) in
            updateStorageVirtualMachine(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
