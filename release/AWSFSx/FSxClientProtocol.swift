...
public protocol FSxClientProtocol {
    ...
    func createFileCache(input: CreateFileCacheInput) async throws -> CreateFileCacheOutputResponse
    ...
    func deleteFileCache(input: DeleteFileCacheInput) async throws -> DeleteFileCacheOutputResponse
    ...
    func describeFileCaches(input: DescribeFileCachesInput) async throws -> DescribeFileCachesOutputResponse
    ...
    func updateFileCache(input: UpdateFileCacheInput) async throws -> UpdateFileCacheOutputResponse
...
public protocol FSxClientConfigurationProtocol : AWSClientRuntime.AWSClientConfiguration {
