...
public protocol FSxClientProtocol {
    ...
    func createDataRepositoryAssociation(input: CreateDataRepositoryAssociationInput, completion: @escaping (ClientRuntime.SdkResult<CreateDataRepositoryAssociationOutputResponse, CreateDataRepositoryAssociationOutputError>) -> Void)
    ...
    func deleteDataRepositoryAssociation(input: DeleteDataRepositoryAssociationInput, completion: @escaping (ClientRuntime.SdkResult<DeleteDataRepositoryAssociationOutputResponse, DeleteDataRepositoryAssociationOutputError>) -> Void)
    ...
    func describeDataRepositoryAssociations(input: DescribeDataRepositoryAssociationsInput, completion: @escaping (ClientRuntime.SdkResult<DescribeDataRepositoryAssociationsOutputResponse, DescribeDataRepositoryAssociationsOutputError>) -> Void)
    ...
    func releaseFileSystemNfsV3Locks(input: ReleaseFileSystemNfsV3LocksInput, completion: @escaping (ClientRuntime.SdkResult<ReleaseFileSystemNfsV3LocksOutputResponse, ReleaseFileSystemNfsV3LocksOutputError>) -> Void)
    /// Returns an Amazon FSx for OpenZFS volume to the state saved by the specified snapshot.
    func restoreVolumeFromSnapshot(input: RestoreVolumeFromSnapshotInput, completion: @escaping (ClientRuntime.SdkResult<RestoreVolumeFromSnapshotOutputResponse, RestoreVolumeFromSnapshotOutputError>) -> Void)
    ...
    func updateDataRepositoryAssociation(input: UpdateDataRepositoryAssociationInput, completion: @escaping (ClientRuntime.SdkResult<UpdateDataRepositoryAssociationOutputResponse, UpdateDataRepositoryAssociationOutputError>) -> Void)
    ...
    func updateSnapshot(input: UpdateSnapshotInput, completion: @escaping (ClientRuntime.SdkResult<UpdateSnapshotOutputResponse, UpdateSnapshotOutputError>) -> Void)
