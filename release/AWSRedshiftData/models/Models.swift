...
public struct BatchExecuteStatementInput: Swift.Equatable {
    ...
    /// This member is required.
    var database: Swift.String?
    /// The database user name. This parameter is required when connecting to a cluster and authenticating using temporary credentials.
    var dbUser: Swift.String?
    /// The name or ARN of the secret that enables access to the database. This parameter is required when authenticating using Secrets Manager.
    var secretArn: Swift.String?
    /// One or more SQL statements to run.
    /// This member is required.
    var sqls: [Swift.String]?
    /// The name of the SQL statements. You can name the SQL statements when you create them to identify the query.
    var statementName: Swift.String?
    /// A value that indicates whether to send an event to the Amazon EventBridge event bus after the SQL statements run.
    var withEvent: Swift.Bool?
...
extension RedshiftDataClientTypes {
    ...
    public struct ColumnMetadata: Swift.Equatable {
        ...
        var columnDefault: Swift.String?
        /// A value that indicates whether the column is case-sensitive.
        var isCaseSensitive: Swift.Bool
        /// A value that indicates whether the column contains currency values.
        var isCurrency: Swift.Bool
        /// A value that indicates whether an integer column is signed.
        var isSigned: Swift.Bool
        ...
        var nullable: Swift.Int
        /// The precision value of a decimal number column.
        var precision: Swift.Int
...
public struct DescribeStatementOutputResponse: Swift.Equatable {
    ...
    var hasResultSet: Swift.Bool?
    /// The identifier of the SQL statement described. This value is a universally unique identifier (UUID) generated by Amazon Redshift Data API.
    /// This member is required.
    var id: Swift.String?
    /// The parameters for the SQL statement.
    var queryParameters: [RedshiftDataClientTypes.SqlParameter]?
    /// The SQL statement text.
    var queryString: Swift.String?
    /// The process identifier from Amazon Redshift.
    var redshiftPid: Swift.Int
    ...
    var redshiftQueryId: Swift.Int
    /// Either the number of rows returned from the SQL statement or the number of rows affected. If result size is greater than zero, the result rows can be the number of rows affected by SQL statements such as INSERT, UPDATE, DELETE, COPY, and others. A -1 indicates the value is null.
    var resultRows: Swift.Int
    /// The size in bytes of the returned results. A -1 indicates the value is null.
    var resultSize: Swift.Int
    ...
    var status: RedshiftDataClientTypes.StatusString?
    /// The SQL statements from a multiple statement run.
    var subStatements: [RedshiftDataClientTypes.SubStatementData]?
...
public struct DescribeTableInput: Swift.Equatable {
    ...
    var connectedDatabase: Swift.String?
...
public struct DescribeTableOutputResponse: Swift.Equatable {
    ...
    var columnList: [RedshiftDataClientTypes.ColumnMetadata]?
    /// A value that indicates the starting point for the next set of response records in a subsequent request. If a value is returned in a response, you can retrieve the next set of records by providing this returned NextToken value in the next NextToken parameter and retrying the command. If the NextToken field is empty, all response records have been retrieved for the request.
    var nextToken: Swift.String?
    /// The table name.
    var tableName: Swift.String?
...
public struct ExecuteStatementInput: Swift.Equatable {
    ...
    var dbUser: Swift.String?
    /// The parameters for the SQL statement.
    var parameters: [RedshiftDataClientTypes.SqlParameter]?
    /// The name or ARN of the secret that enables access to the database. This parameter is required when authenticating using Secrets Manager.
    var secretArn: Swift.String?
...
public struct GetStatementResultOutputResponse: Swift.Equatable {
    /// The properties (metadata) of a column.
    var columnMetadata: [RedshiftDataClientTypes.ColumnMetadata]?
    /// A value that indicates the starting point for the next set of response records in a subsequent request. If a value is returned in a response, you can retrieve the next set of records by providing this returned NextToken value in the next NextToken parameter and retrying the command. If the NextToken field is empty, all response records have been retrieved for the request.
    var nextToken: Swift.String?
    /// The results of the SQL statement.
    /// This member is required.
    var records: [[RedshiftDataClientTypes.Field]]?
...
public struct ListSchemasInput: Swift.Equatable {
    ...
    var schemaPattern: Swift.String?
    /// The name or ARN of the secret that enables access to the database. This parameter is required when authenticating using Secrets Manager.
    var secretArn: Swift.String?
...
public struct ListStatementsOutputResponse: Swift.Equatable {
    ...
    /// The SQL statements.
    /// This member is required.
    var statements: [RedshiftDataClientTypes.StatementData]?
...
public struct ListTablesOutputResponse: Swift.Equatable {
    ...
    var tables: [RedshiftDataClientTypes.TableMember]?
...
extension RedshiftDataClientTypes {
    ...
    public struct StatementData: Swift.Equatable {
        ...
        var isBatchStatement: Swift.Bool?
        /// The parameters used in a SQL statement.
        var queryParameters: [RedshiftDataClientTypes.SqlParameter]?
        /// The SQL statement.
        var queryString: Swift.String?
        /// One or more SQL statements. Each query string in the array corresponds to one of the queries in a batch query request.
        var queryStrings: [Swift.String]?
        /// The name or Amazon Resource Name (ARN) of the secret that enables access to the database.
        var secretArn: Swift.String?
...
extension RedshiftDataClientTypes {
    ...
    public struct SubStatementData: Swift.Equatable {
        ...
        var resultSize: Swift.Int
        /// The status of the SQL statement. An example is the that the SQL statement finished.
        var status: RedshiftDataClientTypes.StatementStatusString?
        /// The date and time (UTC) that the statement metadata was last updated.
        var updatedAt: ClientRuntime.Date?
