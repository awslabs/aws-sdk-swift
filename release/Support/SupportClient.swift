...
public class SupportClient {
    ...
    let config: SupportClientConfiguration
    let serviceName = "Support"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: SupportClientConfiguration) {
    ...
    public class SupportClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        public static func `default`() throws -> SupportClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try SupportClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
...
extension SupportClient: SupportClientProtocol {
    ...
    ///             </ul>
    ///         </note>
    public func addAttachmentsToSet(input: AddAttachmentsToSetInput, completion: @escaping (SdkResult<AddAttachmentsToSetOutput, AddAttachmentsToSetOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<AddAttachmentsToSetInput, AddAttachmentsToSetOutput, AddAttachmentsToSetOutputError>(id: "addAttachmentsToSet")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AddAttachmentsToSetInput, AddAttachmentsToSetOutput, AddAttachmentsToSetOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AddAttachmentsToSetInput, AddAttachmentsToSetOutput, AddAttachmentsToSetOutputError>(xAmzTarget: "AWSSupport_20130415.AddAttachmentsToSet"))
    ...
    ///             </ul>
    ///         </note>
    public func addCommunicationToCase(input: AddCommunicationToCaseInput, completion: @escaping (SdkResult<AddCommunicationToCaseOutput, AddCommunicationToCaseOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AddCommunicationToCaseInput, AddCommunicationToCaseOutput, AddCommunicationToCaseOutputError>(id: "addCommunicationToCase")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AddCommunicationToCaseInput, AddCommunicationToCaseOutput, AddCommunicationToCaseOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AddCommunicationToCaseInput, AddCommunicationToCaseOutput, AddCommunicationToCaseOutputError>(xAmzTarget: "AWSSupport_20130415.AddCommunicationToCase"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func createCase(input: CreateCaseInput, completion: @escaping (SdkResult<CreateCaseOutput, CreateCaseOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateCaseInput, CreateCaseOutput, CreateCaseOutputError>(id: "createCase")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateCaseInput, CreateCaseOutput, CreateCaseOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateCaseInput, CreateCaseOutput, CreateCaseOutputError>(xAmzTarget: "AWSSupport_20130415.CreateCase"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func describeAttachment(input: DescribeAttachmentInput, completion: @escaping (SdkResult<DescribeAttachmentOutput, DescribeAttachmentOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAttachmentInput, DescribeAttachmentOutput, DescribeAttachmentOutputError>(id: "describeAttachment")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAttachmentInput, DescribeAttachmentOutput, DescribeAttachmentOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeAttachmentInput, DescribeAttachmentOutput, DescribeAttachmentOutputError>(xAmzTarget: "AWSSupport_20130415.DescribeAttachment"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func describeCases(input: DescribeCasesInput, completion: @escaping (SdkResult<DescribeCasesOutput, DescribeCasesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCasesInput, DescribeCasesOutput, DescribeCasesOutputError>(id: "describeCases")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCasesInput, DescribeCasesOutput, DescribeCasesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeCasesInput, DescribeCasesOutput, DescribeCasesOutputError>(xAmzTarget: "AWSSupport_20130415.DescribeCases"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func describeCommunications(input: DescribeCommunicationsInput, completion: @escaping (SdkResult<DescribeCommunicationsOutput, DescribeCommunicationsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCommunicationsInput, DescribeCommunicationsOutput, DescribeCommunicationsOutputError>(id: "describeCommunications")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCommunicationsInput, DescribeCommunicationsOutput, DescribeCommunicationsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeCommunicationsInput, DescribeCommunicationsOutput, DescribeCommunicationsOutputError>(xAmzTarget: "AWSSupport_20130415.DescribeCommunications"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeServices(input: DescribeServicesInput, completion: @escaping (SdkResult<DescribeServicesOutput, DescribeServicesOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeServicesInput, DescribeServicesOutput, DescribeServicesOutputError>(xAmzTarget: "AWSSupport_20130415.DescribeServices"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func describeSeverityLevels(input: DescribeSeverityLevelsInput, completion: @escaping (SdkResult<DescribeSeverityLevelsOutput, DescribeSeverityLevelsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeSeverityLevelsInput, DescribeSeverityLevelsOutput, DescribeSeverityLevelsOutputError>(id: "describeSeverityLevels")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeSeverityLevelsInput, DescribeSeverityLevelsOutput, DescribeSeverityLevelsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeSeverityLevelsInput, DescribeSeverityLevelsOutput, DescribeSeverityLevelsOutputError>(xAmzTarget: "AWSSupport_20130415.DescribeSeverityLevels"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func describeTrustedAdvisorCheckRefreshStatuses(input: DescribeTrustedAdvisorCheckRefreshStatusesInput, completion: @escaping (SdkResult<DescribeTrustedAdvisorCheckRefreshStatusesOutput, DescribeTrustedAdvisorCheckRefreshStatusesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTrustedAdvisorCheckRefreshStatusesInput, DescribeTrustedAdvisorCheckRefreshStatusesOutput, DescribeTrustedAdvisorCheckRefreshStatusesOutputError>(id: "describeTrustedAdvisorCheckRefreshStatuses")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTrustedAdvisorCheckRefreshStatusesInput, DescribeTrustedAdvisorCheckRefreshStatusesOutput, DescribeTrustedAdvisorCheckRefreshStatusesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeTrustedAdvisorCheckRefreshStatusesInput, DescribeTrustedAdvisorCheckRefreshStatusesOutput, DescribeTrustedAdvisorCheckRefreshStatusesOutputError>(xAmzTarget: "AWSSupport_20130415.DescribeTrustedAdvisorCheckRefreshStatuses"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func describeTrustedAdvisorCheckResult(input: DescribeTrustedAdvisorCheckResultInput, completion: @escaping (SdkResult<DescribeTrustedAdvisorCheckResultOutput, DescribeTrustedAdvisorCheckResultOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTrustedAdvisorCheckResultInput, DescribeTrustedAdvisorCheckResultOutput, DescribeTrustedAdvisorCheckResultOutputError>(id: "describeTrustedAdvisorCheckResult")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTrustedAdvisorCheckResultInput, DescribeTrustedAdvisorCheckResultOutput, DescribeTrustedAdvisorCheckResultOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeTrustedAdvisorCheckResultInput, DescribeTrustedAdvisorCheckResultOutput, DescribeTrustedAdvisorCheckResultOutputError>(xAmzTarget: "AWSSupport_20130415.DescribeTrustedAdvisorCheckResult"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func describeTrustedAdvisorCheckSummaries(input: DescribeTrustedAdvisorCheckSummariesInput, completion: @escaping (SdkResult<DescribeTrustedAdvisorCheckSummariesOutput, DescribeTrustedAdvisorCheckSummariesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTrustedAdvisorCheckSummariesInput, DescribeTrustedAdvisorCheckSummariesOutput, DescribeTrustedAdvisorCheckSummariesOutputError>(id: "describeTrustedAdvisorCheckSummaries")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTrustedAdvisorCheckSummariesInput, DescribeTrustedAdvisorCheckSummariesOutput, DescribeTrustedAdvisorCheckSummariesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeTrustedAdvisorCheckSummariesInput, DescribeTrustedAdvisorCheckSummariesOutput, DescribeTrustedAdvisorCheckSummariesOutputError>(xAmzTarget: "AWSSupport_20130415.DescribeTrustedAdvisorCheckSummaries"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func describeTrustedAdvisorChecks(input: DescribeTrustedAdvisorChecksInput, completion: @escaping (SdkResult<DescribeTrustedAdvisorChecksOutput, DescribeTrustedAdvisorChecksOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTrustedAdvisorChecksInput, DescribeTrustedAdvisorChecksOutput, DescribeTrustedAdvisorChecksOutputError>(id: "describeTrustedAdvisorChecks")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTrustedAdvisorChecksInput, DescribeTrustedAdvisorChecksOutput, DescribeTrustedAdvisorChecksOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeTrustedAdvisorChecksInput, DescribeTrustedAdvisorChecksOutput, DescribeTrustedAdvisorChecksOutputError>(xAmzTarget: "AWSSupport_20130415.DescribeTrustedAdvisorChecks"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func refreshTrustedAdvisorCheck(input: RefreshTrustedAdvisorCheckInput, completion: @escaping (SdkResult<RefreshTrustedAdvisorCheckOutput, RefreshTrustedAdvisorCheckOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RefreshTrustedAdvisorCheckInput, RefreshTrustedAdvisorCheckOutput, RefreshTrustedAdvisorCheckOutputError>(id: "refreshTrustedAdvisorCheck")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RefreshTrustedAdvisorCheckInput, RefreshTrustedAdvisorCheckOutput, RefreshTrustedAdvisorCheckOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RefreshTrustedAdvisorCheckInput, RefreshTrustedAdvisorCheckOutput, RefreshTrustedAdvisorCheckOutputError>(xAmzTarget: "AWSSupport_20130415.RefreshTrustedAdvisorCheck"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </note>
    public func resolveCase(input: ResolveCaseInput, completion: @escaping (SdkResult<ResolveCaseOutput, ResolveCaseOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "support")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ResolveCaseInput, ResolveCaseOutput, ResolveCaseOutputError>(id: "resolveCase")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ResolveCaseInput, ResolveCaseOutput, ResolveCaseOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ResolveCaseInput, ResolveCaseOutput, ResolveCaseOutputError>(xAmzTarget: "AWSSupport_20130415.ResolveCase"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
