...
extension AccountChannelLimitExceededException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AccountChannelLimitExceededException(message: \(Swift.String(describing: message)))"}
}
...
extension AccountStreamLimitExceededException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AccountStreamLimitExceededException(message: \(Swift.String(describing: message)))"}
}
...
extension KinesisVideoClientTypes.ChannelInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension KinesisVideoClientTypes.ChannelInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ChannelInfo(channelARN: \(Swift.String(describing: channelARN)), channelName: \(Swift.String(describing: channelName)), channelStatus: \(Swift.String(describing: channelStatus)), channelType: \(Swift.String(describing: channelType)), creationTime: \(Swift.String(describing: creationTime)), singleMasterConfiguration: \(Swift.String(describing: singleMasterConfiguration)), version: \(Swift.String(describing: version)))"}
}
...
extension KinesisVideoClientTypes.ChannelNameCondition: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension KinesisVideoClientTypes.ChannelNameCondition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ChannelNameCondition(comparisonOperator: \(Swift.String(describing: comparisonOperator)), comparisonValue: \(Swift.String(describing: comparisonValue)))"}
}
...
public struct CreateSignalingChannelInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSignalingChannelInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateSignalingChannelInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateSignalingChannelOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateSignalingChannelInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateSignalingChannelOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateSignalingChannelOutputError>
}

extension CreateSignalingChannelInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateSignalingChannelInput(channelName: \(Swift.String(describing: channelName)), channelType: \(Swift.String(describing: channelType)), singleMasterConfiguration: \(Swift.String(describing: singleMasterConfiguration)), tags: \(Swift.String(describing: tags)))"}
}

extension CreateSignalingChannelInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case channelName = "ChannelName"
        case channelType = "ChannelType"
        case singleMasterConfiguration = "SingleMasterConfiguration"
...
public struct CreateSignalingChannelInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSignalingChannelInputHeadersMiddleware"
...
public struct CreateSignalingChannelInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSignalingChannelInputQueryItemMiddleware"
...
public struct CreateSignalingChannelInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSignalingChannelInputURLHostMiddleware"
    ...
    public typealias MInput = CreateSignalingChannelInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateSignalingChannelOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateSignalingChannelOutputError>
}

public struct CreateSignalingChannelInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSignalingChannelInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/createSignalingChannel"
...
struct CreateSignalingChannelInputBody: Swift.Equatable {
    ...
    public let channelType: KinesisVideoClientTypes.ChannelType?
    public let singleMasterConfiguration: KinesisVideoClientTypes.SingleMasterConfiguration?
    public let tags: [KinesisVideoClientTypes.Tag]?
}
...
extension CreateSignalingChannelOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateSignalingChannelOutputResponse(channelARN: \(Swift.String(describing: channelARN)))"}
}
...
extension CreateStreamInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateStreamInput(dataRetentionInHours: \(Swift.String(describing: dataRetentionInHours)), deviceName: \(Swift.String(describing: deviceName)), kmsKeyId: \(Swift.String(describing: kmsKeyId)), mediaType: \(Swift.String(describing: mediaType)), streamName: \(Swift.String(describing: streamName)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct CreateStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStreamInputURLHostMiddleware"
    ...
    public typealias MInput = CreateStreamInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateStreamOutputError>
}

public struct CreateStreamInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStreamInputURLPathMiddleware"
...
public struct CreateStreamInput: Swift.Equatable {
    ...
    ///          For more information, see <a href="https://docs.aws.amazon.com/kms/latest/APIReference/API_DescribeKey.html#API_DescribeKey_RequestParameters">DescribeKey.
    ...
    ///                 Types. If you choose to specify the MediaType, see <a href="https://tools.ietf.org/html/rfc6838#section-4.2">Naming Requirements
    ///             for guidelines.
    ///
...
struct CreateStreamInputBody: Swift.Equatable {
    ...
    public let dataRetentionInHours: Swift.Int?
...
extension CreateStreamOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateStreamOutputResponse(streamARN: \(Swift.String(describing: streamARN)))"}
}
...
public struct DeleteSignalingChannelInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSignalingChannelInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteSignalingChannelInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteSignalingChannelOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteSignalingChannelInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteSignalingChannelOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteSignalingChannelOutputError>
}

extension DeleteSignalingChannelInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteSignalingChannelInput(channelARN: \(Swift.String(describing: channelARN)), currentVersion: \(Swift.String(describing: currentVersion)))"}
}

extension DeleteSignalingChannelInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case channelARN = "ChannelARN"
...
public struct DeleteSignalingChannelInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSignalingChannelInputHeadersMiddleware"
...
public struct DeleteSignalingChannelInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSignalingChannelInputQueryItemMiddleware"
...
public struct DeleteSignalingChannelInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSignalingChannelInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteSignalingChannelInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteSignalingChannelOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteSignalingChannelOutputError>
}

public struct DeleteSignalingChannelInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSignalingChannelInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/deleteSignalingChannel"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DeleteSignalingChannelOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteSignalingChannelOutputResponseBody: Swift.Equatable {
}

extension DeleteSignalingChannelOutputResponseBody: Swift.Decodable {
...
extension DeleteStreamInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteStreamInput(currentVersion: \(Swift.String(describing: currentVersion)), streamARN: \(Swift.String(describing: streamARN)))"}
}
...
public struct DeleteStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStreamInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteStreamInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteStreamOutputError>
}

public struct DeleteStreamInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStreamInputURLPathMiddleware"
...
public struct DescribeSignalingChannelInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSignalingChannelInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeSignalingChannelInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeSignalingChannelOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeSignalingChannelInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeSignalingChannelOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeSignalingChannelOutputError>
}

extension DescribeSignalingChannelInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeSignalingChannelInput(channelARN: \(Swift.String(describing: channelARN)), channelName: \(Swift.String(describing: channelName)))"}
}

extension DescribeSignalingChannelInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case channelARN = "ChannelARN"
        case channelName = "ChannelName"
    }
...
public struct DescribeSignalingChannelInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSignalingChannelInputHeadersMiddleware"
...
public struct DescribeSignalingChannelInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSignalingChannelInputQueryItemMiddleware"
...
public struct DescribeSignalingChannelInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSignalingChannelInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeSignalingChannelInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeSignalingChannelOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeSignalingChannelOutputError>
}

public struct DescribeSignalingChannelInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSignalingChannelInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/describeSignalingChannel"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeSignalingChannelOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeSignalingChannelOutputResponse(channelInfo: \(Swift.String(describing: channelInfo)))"}
}
...
struct DescribeSignalingChannelOutputResponseBody: Swift.Equatable {
    public let channelInfo: KinesisVideoClientTypes.ChannelInfo?
}
...
extension DescribeStreamInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeStreamInput(streamARN: \(Swift.String(describing: streamARN)), streamName: \(Swift.String(describing: streamName)))"}
}
...
struct DescribeStreamOutputResponseBody: Swift.Equatable {
    public let streamInfo: KinesisVideoClientTypes.StreamInfo?
}
...
extension DeviceStreamLimitExceededException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeviceStreamLimitExceededException(message: \(Swift.String(describing: message)))"}
}
...
public struct GetDataEndpointInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDataEndpointInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetDataEndpointInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetDataEndpointOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetDataEndpointInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetDataEndpointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetDataEndpointOutputError>
}

extension GetDataEndpointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetDataEndpointInput(aPIName: \(Swift.String(describing: aPIName)), streamARN: \(Swift.String(describing: streamARN)), streamName: \(Swift.String(describing: streamName)))"}
}

extension GetDataEndpointInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct GetDataEndpointInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDataEndpointInputHeadersMiddleware"
...
public struct GetDataEndpointInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDataEndpointInputQueryItemMiddleware"
...
public struct GetDataEndpointInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDataEndpointInputURLHostMiddleware"
    ...
    public typealias MInput = GetDataEndpointInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetDataEndpointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetDataEndpointOutputError>
}

public struct GetDataEndpointInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDataEndpointInputURLPathMiddleware"
...
struct GetDataEndpointInputBody: Swift.Equatable {
    public let streamName: Swift.String?
    public let streamARN: Swift.String?
    public let aPIName: KinesisVideoClientTypes.APIName?
}
...
extension GetDataEndpointOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetDataEndpointOutputResponse(dataEndpoint: \(Swift.String(describing: dataEndpoint)))"}
}
...
struct GetDataEndpointOutputResponseBody: Swift.Equatable {
    public let dataEndpoint: Swift.String?
}
...
public struct GetSignalingChannelEndpointInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetSignalingChannelEndpointInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetSignalingChannelEndpointInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetSignalingChannelEndpointOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetSignalingChannelEndpointInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetSignalingChannelEndpointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetSignalingChannelEndpointOutputError>
}

extension GetSignalingChannelEndpointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetSignalingChannelEndpointInput(channelARN: \(Swift.String(describing: channelARN)), singleMasterChannelEndpointConfiguration: \(Swift.String(describing: singleMasterChannelEndpointConfiguration)))"}
}

extension GetSignalingChannelEndpointInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case channelARN = "ChannelARN"
...
public struct GetSignalingChannelEndpointInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetSignalingChannelEndpointInputHeadersMiddleware"
...
public struct GetSignalingChannelEndpointInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetSignalingChannelEndpointInputQueryItemMiddleware"
...
public struct GetSignalingChannelEndpointInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetSignalingChannelEndpointInputURLHostMiddleware"
    ...
    public typealias MInput = GetSignalingChannelEndpointInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetSignalingChannelEndpointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetSignalingChannelEndpointOutputError>
}

public struct GetSignalingChannelEndpointInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetSignalingChannelEndpointInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/getSignalingChannelEndpoint"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct GetSignalingChannelEndpointInputBody: Swift.Equatable {
    public let channelARN: Swift.String?
    public let singleMasterChannelEndpointConfiguration: KinesisVideoClientTypes.SingleMasterChannelEndpointConfiguration?
}
...
extension GetSignalingChannelEndpointOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetSignalingChannelEndpointOutputResponse(resourceEndpointList: \(Swift.String(describing: resourceEndpointList)))"}
}
...
struct GetSignalingChannelEndpointOutputResponseBody: Swift.Equatable {
    public let resourceEndpointList: [KinesisVideoClientTypes.ResourceEndpointListItem]?
}
...
extension InvalidDeviceException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidDeviceException(message: \(Swift.String(describing: message)))"}
}
...
extension InvalidResourceFormatException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidResourceFormatException(message: \(Swift.String(describing: message)))"}
}
...
public struct ListSignalingChannelsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSignalingChannelsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListSignalingChannelsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListSignalingChannelsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListSignalingChannelsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListSignalingChannelsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListSignalingChannelsOutputError>
}

extension ListSignalingChannelsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListSignalingChannelsInput(channelNameCondition: \(Swift.String(describing: channelNameCondition)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListSignalingChannelsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ListSignalingChannelsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSignalingChannelsInputHeadersMiddleware"
...
public struct ListSignalingChannelsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSignalingChannelsInputQueryItemMiddleware"
...
public struct ListSignalingChannelsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSignalingChannelsInputURLHostMiddleware"
    ...
    public typealias MInput = ListSignalingChannelsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListSignalingChannelsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListSignalingChannelsOutputError>
}

public struct ListSignalingChannelsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSignalingChannelsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/listSignalingChannels"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct ListSignalingChannelsInputBody: Swift.Equatable {
    ...
    public let channelNameCondition: KinesisVideoClientTypes.ChannelNameCondition?
}
...
extension ListSignalingChannelsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListSignalingChannelsOutputResponse(channelInfoList: \(Swift.String(describing: channelInfoList)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListSignalingChannelsOutputResponseBody: Swift.Equatable {
    public let channelInfoList: [KinesisVideoClientTypes.ChannelInfo]?
    public let nextToken: Swift.String?
}
...
extension ListStreamsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListStreamsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), streamNameCondition: \(Swift.String(describing: streamNameCondition)))"}
}
...
struct ListStreamsInputBody: Swift.Equatable {
    public let maxResults: Swift.Int?
    public let nextToken: Swift.String?
    public let streamNameCondition: KinesisVideoClientTypes.StreamNameCondition?
}
...
extension ListStreamsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListStreamsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), streamInfoList: \(Swift.String(describing: streamInfoList)))"}
}
...
struct ListStreamsOutputResponseBody: Swift.Equatable {
    public let streamInfoList: [KinesisVideoClientTypes.StreamInfo]?
    public let nextToken: Swift.String?
}
...
extension ListTagsForStreamInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListTagsForStreamInput(nextToken: \(Swift.String(describing: nextToken)), streamARN: \(Swift.String(describing: streamARN)), streamName: \(Swift.String(describing: streamName)))"}
}
...
public struct ListTagsForStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTagsForStreamInputURLHostMiddleware"
    ...
    public typealias MInput = ListTagsForStreamInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListTagsForStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListTagsForStreamOutputError>
}

public struct ListTagsForStreamInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListTagsForStreamInputURLPathMiddleware"
...
extension ListTagsForStreamOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListTagsForStreamOutputResponse(nextToken: \(Swift.String(describing: nextToken)), tags: \(Swift.String(describing: tags)))"}
}
...
extension KinesisVideoClientTypes.ResourceEndpointListItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension KinesisVideoClientTypes.ResourceEndpointListItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceEndpointListItem(protocol: \(Swift.String(describing: `protocol`)), resourceEndpoint: \(Swift.String(describing: resourceEndpoint)))"}
}
...
extension KinesisVideoClientTypes.SingleMasterChannelEndpointConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension KinesisVideoClientTypes.SingleMasterChannelEndpointConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SingleMasterChannelEndpointConfiguration(protocols: \(Swift.String(describing: protocols)), role: \(Swift.String(describing: role)))"}
}
...
extension KinesisVideoClientTypes.SingleMasterConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension KinesisVideoClientTypes.SingleMasterConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SingleMasterConfiguration(messageTtlSeconds: \(Swift.String(describing: messageTtlSeconds)))"}
}
...
extension KinesisVideoClientTypes.StreamInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case creationTime = "CreationTime"
        case dataRetentionInHours = "DataRetentionInHours"
        case deviceName = "DeviceName"
...
extension KinesisVideoClientTypes.StreamInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamInfo(creationTime: \(Swift.String(describing: creationTime)), dataRetentionInHours: \(Swift.String(describing: dataRetentionInHours)), deviceName: \(Swift.String(describing: deviceName)), kmsKeyId: \(Swift.String(describing: kmsKeyId)), mediaType: \(Swift.String(describing: mediaType)), status: \(Swift.String(describing: status)), streamARN: \(Swift.String(describing: streamARN)), streamName: \(Swift.String(describing: streamName)), version: \(Swift.String(describing: version)))"}
}
...
extension KinesisVideoClientTypes.StreamNameCondition: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case comparisonOperator = "ComparisonOperator"
        case comparisonValue = "ComparisonValue"
    }
...
extension KinesisVideoClientTypes.StreamNameCondition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamNameCondition(comparisonOperator: \(Swift.String(describing: comparisonOperator)), comparisonValue: \(Swift.String(describing: comparisonValue)))"}
}
...
extension KinesisVideoClientTypes.Tag: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
...
extension KinesisVideoClientTypes.Tag: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
public struct TagStreamInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TagStreamInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<TagStreamInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<TagStreamOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<TagStreamInput>
    public typealias MOutput = ClientRuntime.OperationOutput<TagStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<TagStreamOutputError>
}

extension TagStreamInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TagStreamInput(streamARN: \(Swift.String(describing: streamARN)), streamName: \(Swift.String(describing: streamName)), tags: \(Swift.String(describing: tags)))"}
}

extension TagStreamInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case streamARN = "StreamARN"
        case streamName = "StreamName"
        case tags = "Tags"
...
public struct TagStreamInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TagStreamInputHeadersMiddleware"
...
public struct TagStreamInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TagStreamInputQueryItemMiddleware"
...
public struct TagStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TagStreamInputURLHostMiddleware"
    ...
    public typealias MInput = TagStreamInput
    public typealias MOutput = ClientRuntime.OperationOutput<TagStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<TagStreamOutputError>
}

public struct TagStreamInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TagStreamInputURLPathMiddleware"
...
extension TagStreamOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct TagStreamOutputResponseBody: Swift.Equatable {
}

extension TagStreamOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension TagsPerResourceExceededLimitException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TagsPerResourceExceededLimitException(message: \(Swift.String(describing: message)))"}
}
...
public struct UntagStreamInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UntagStreamInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UntagStreamInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UntagStreamOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UntagStreamInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UntagStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UntagStreamOutputError>
}

extension UntagStreamInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UntagStreamInput(streamARN: \(Swift.String(describing: streamARN)), streamName: \(Swift.String(describing: streamName)), tagKeyList: \(Swift.String(describing: tagKeyList)))"}
}

extension UntagStreamInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case streamARN = "StreamARN"
        case streamName = "StreamName"
        case tagKeyList = "TagKeyList"
...
public struct UntagStreamInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UntagStreamInputHeadersMiddleware"
...
public struct UntagStreamInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UntagStreamInputQueryItemMiddleware"
...
public struct UntagStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UntagStreamInputURLHostMiddleware"
    ...
    public typealias MInput = UntagStreamInput
    public typealias MOutput = ClientRuntime.OperationOutput<UntagStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UntagStreamOutputError>
}

public struct UntagStreamInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UntagStreamInputURLPathMiddleware"
...
extension UntagStreamOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct UntagStreamOutputResponseBody: Swift.Equatable {
}

extension UntagStreamOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct UpdateDataRetentionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateDataRetentionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateDataRetentionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateDataRetentionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateDataRetentionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateDataRetentionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateDataRetentionOutputError>
}

extension UpdateDataRetentionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateDataRetentionInput(currentVersion: \(Swift.String(describing: currentVersion)), dataRetentionChangeInHours: \(Swift.String(describing: dataRetentionChangeInHours)), operation: \(Swift.String(describing: operation)), streamARN: \(Swift.String(describing: streamARN)), streamName: \(Swift.String(describing: streamName)))"}
}

extension UpdateDataRetentionInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case currentVersion = "CurrentVersion"
...
public struct UpdateDataRetentionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateDataRetentionInputHeadersMiddleware"
...
public struct UpdateDataRetentionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateDataRetentionInputQueryItemMiddleware"
...
public struct UpdateDataRetentionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateDataRetentionInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateDataRetentionInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateDataRetentionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateDataRetentionOutputError>
}

public struct UpdateDataRetentionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateDataRetentionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/updateDataRetention"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct UpdateDataRetentionInputBody: Swift.Equatable {
    ...
    public let streamARN: Swift.String?
    public let currentVersion: Swift.String?
    public let operation: KinesisVideoClientTypes.UpdateDataRetentionOperation?
    public let dataRetentionChangeInHours: Swift.Int?
}
...
extension UpdateDataRetentionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct UpdateDataRetentionOutputResponseBody: Swift.Equatable {
}

extension UpdateDataRetentionOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct UpdateSignalingChannelInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSignalingChannelInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateSignalingChannelInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateSignalingChannelOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateSignalingChannelInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateSignalingChannelOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateSignalingChannelOutputError>
}

extension UpdateSignalingChannelInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateSignalingChannelInput(channelARN: \(Swift.String(describing: channelARN)), currentVersion: \(Swift.String(describing: currentVersion)), singleMasterConfiguration: \(Swift.String(describing: singleMasterConfiguration)))"}
}

extension UpdateSignalingChannelInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case channelARN = "ChannelARN"
        case currentVersion = "CurrentVersion"
        case singleMasterConfiguration = "SingleMasterConfiguration"
...
public struct UpdateSignalingChannelInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSignalingChannelInputHeadersMiddleware"
...
public struct UpdateSignalingChannelInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSignalingChannelInputQueryItemMiddleware"
...
public struct UpdateSignalingChannelInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSignalingChannelInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateSignalingChannelInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateSignalingChannelOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateSignalingChannelOutputError>
}

public struct UpdateSignalingChannelInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSignalingChannelInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/updateSignalingChannel"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension UpdateSignalingChannelOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct UpdateSignalingChannelOutputResponseBody: Swift.Equatable {
}

extension UpdateSignalingChannelOutputResponseBody: Swift.Decodable {
...
extension UpdateStreamInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateStreamInput(currentVersion: \(Swift.String(describing: currentVersion)), deviceName: \(Swift.String(describing: deviceName)), mediaType: \(Swift.String(describing: mediaType)), streamARN: \(Swift.String(describing: streamARN)), streamName: \(Swift.String(describing: streamName)))"}
}
...
public struct UpdateStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateStreamInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateStreamInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateStreamOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateStreamOutputError>
}

public struct UpdateStreamInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateStreamInputURLPathMiddleware"
...
public struct UpdateStreamInput: Swift.Equatable {
    ...
    ///                 Types. If you choose to specify the MediaType, see <a href="https://tools.ietf.org/html/rfc6838#section-4.2">Naming
    ///             Requirements.
...
extension VersionMismatchException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "VersionMismatchException(message: \(Swift.String(describing: message)))"}
}
...
///             version, use the <a href="https://docs.aws.amazon.com/kinesisvideostreams/latest/dg/API_DescribeStream.html">DescribeStream
///             API.
