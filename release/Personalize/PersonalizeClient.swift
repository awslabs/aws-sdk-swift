...
public class PersonalizeClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try PersonalizeClientConfiguration(region: unwrappedRegion)
    ...
    public class PersonalizeClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("PersonalizeClient")
...
public struct PersonalizeClientLogHandlerFactory: SDKLogHandlerFactory {
