...
extension EksClientTypes {
    ...
    public struct Addon: Swift.Equatable {
        ...
        public let addonArn: Swift.String?
        ...
        public let health: EksClientTypes.AddonHealth?
        ...
        public let status: EksClientTypes.AddonStatus?
...
extension EksClientTypes {
    ...
    public struct AddonHealth: Swift.Equatable {
        ...
        public let issues: [EksClientTypes.AddonIssue]?
...
extension EksClientTypes {
    ...
    public struct AddonInfo: Swift.Equatable {
        ...
        public let addonVersions: [EksClientTypes.AddonVersionInfo]?
...
extension EksClientTypes {
    ...
    public struct AddonIssue: Swift.Equatable {
        ...
        public let code: EksClientTypes.AddonIssueCode?
...
extension EksClientTypes {
    ...
    public struct AddonVersionInfo: Swift.Equatable {
        ...
        public let compatibilities: [EksClientTypes.Compatibility]?
...
extension EksClientTypes {
    ...
    public struct Cluster: Swift.Equatable {
        ...
        public let certificateAuthority: EksClientTypes.Certificate?
        /// <p>Unique, case-sensitive identifier that you provide to ensure the idempotency of the
        ///             request.</p>
        public let clientRequestToken: Swift.String?
        ...
        public let identity: EksClientTypes.Identity?
        /// <p>The Kubernetes network configuration for the cluster.</p>
        public let kubernetesNetworkConfig: EksClientTypes.KubernetesNetworkConfigResponse?
        ...
        public let resourcesVpcConfig: EksClientTypes.VpcConfigResponse?
        ...
        public let status: EksClientTypes.ClusterStatus?
...
extension EksClientTypes {
    ...
    public struct Compatibility: Swift.Equatable {
        ...
        public let platformVersions: [Swift.String]?
...
extension DeleteAddonInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteAddonInput(addonName: \(Swift.String(describing: addonName)), clusterName: \(Swift.String(describing: clusterName)))"}
}
...
public struct DescribeAddonVersionsInput: Swift.Equatable {
    ...
    public let kubernetesVersion: Swift.String?
...
public struct DescribeUpdateInput: Swift.Equatable {
    ...
    public let updateId: Swift.String?
...
extension EksClientTypes {
    ...
    public struct EncryptionConfig: Swift.Equatable {
        ...
        public let provider: EksClientTypes.Provider?
...
extension EksClientTypes {
    ...
    public struct ErrorDetail: Swift.Equatable {
        ...
        ///             </li>
        ///          </ul>
        public let errorCode: EksClientTypes.ErrorCode?
...
extension EksClientTypes {
    ...
    public struct FargateProfile: Swift.Equatable {
        ...
        public let fargateProfileArn: Swift.String?
        /// <p>The name of the Fargate profile.</p>
        public let fargateProfileName: Swift.String?
        /// <p>The Amazon Resource Name (ARN) of the pod execution role to use for pods that match the selectors in
        ...
        public let status: EksClientTypes.FargateProfileStatus?
...
extension EksClientTypes {
    ...
    public struct Identity: Swift.Equatable {
        ...
        public let oidc: EksClientTypes.OIDC?
...
extension EksClientTypes {
    ...
    public struct IdentityProviderConfigResponse: Swift.Equatable {
        /// <p>An object that represents an OpenID Connect (OIDC) identity provider
        ///             configuration.</p>
        public let oidc: EksClientTypes.OidcIdentityProviderConfig?
...
extension EksClientTypes {
    ...
    public struct Issue: Swift.Equatable {
        ...
        ///             </li>
        ///          </ul>
        public let code: EksClientTypes.NodegroupIssueCode?
...
extension EksClientTypes {
    ...
    public struct KubernetesNetworkConfigRequest: Swift.Equatable {
        ...
        ///         </important>
        public let serviceIpv4Cidr: Swift.String?
...
extension EksClientTypes {
    ...
    public struct LogSetup: Swift.Equatable {
        ...
        public let types: [EksClientTypes.LogType]?
...
extension EksClientTypes {
    ...
    public struct Logging: Swift.Equatable {
        ...
        public let clusterLogging: [EksClientTypes.LogSetup]?
...
extension EksClientTypes {
    ...
    public struct Nodegroup: Swift.Equatable {
        ...
        public let health: EksClientTypes.NodegroupHealth?
        ...
        public let nodegroupArn: Swift.String?
        ...
        public let resources: EksClientTypes.NodegroupResources?
        ...
        public let status: EksClientTypes.NodegroupStatus?
...
extension EksClientTypes {
    ...
    public struct NodegroupHealth: Swift.Equatable {
        ...
        public let issues: [EksClientTypes.Issue]?
...
extension EksClientTypes {
    ...
    public struct NodegroupScalingConfig: Swift.Equatable {
        ...
        public let desiredSize: Swift.Int?
...
extension EksClientTypes {
    ...
    public struct OidcIdentityProviderConfig: Swift.Equatable {
        ...
        public let groupsClaim: Swift.String?
        ...
        ///          </p>
        public let groupsPrefix: Swift.String?
        /// <p>The ARN of the configuration.</p>
        public let identityProviderConfigArn: Swift.String?
        /// <p>The name of the configuration.</p>
        public let identityProviderConfigName: Swift.String?
        ...
        public let requiredClaims: [Swift.String:Swift.String]?
        /// <p>The status of the OIDC identity provider.</p>
        public let status: EksClientTypes.ConfigStatus?
        ...
        public let usernameClaim: Swift.String?
        ...
        ///          </p>
        public let usernamePrefix: Swift.String?
...
extension EksClientTypes {
    ...
    public struct RemoteAccessConfig: Swift.Equatable {
        ...
        public let ec2SshKey: Swift.String?
        ...
        public let sourceSecurityGroups: [Swift.String]?
...
extension EksClientTypes {
    ...
    public struct Taint: Swift.Equatable {
        ...
        public let effect: EksClientTypes.TaintEffect?
...
extension UnsupportedAvailabilityZoneException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct UnsupportedAvailabilityZoneException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension EksClientTypes {
    ...
    public struct Update: Swift.Equatable {
        ...
        public let errors: [EksClientTypes.ErrorDetail]?
        /// <p>A UUID that is used to track the update.</p>
        public let id: Swift.String?
        /// <p>A key-value map that contains the parameters associated with the update.</p>
        public let params: [EksClientTypes.UpdateParam]?
        /// <p>The current status of the update.</p>
        public let status: EksClientTypes.UpdateStatus?
        /// <p>The type of the update.</p>
        public let type: EksClientTypes.UpdateType?
...
extension EksClientTypes {
    ...
    public struct UpdateLabelsPayload: Swift.Equatable {
        ...
        public let addOrUpdateLabels: [Swift.String:Swift.String]?
        /// <p>Kubernetes labels to be removed.</p>
        public let removeLabels: [Swift.String]?
...
extension UpdateNodegroupConfigInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateNodegroupConfigInput(clientRequestToken: \(Swift.String(describing: clientRequestToken)), clusterName: \(Swift.String(describing: clusterName)), labels: \(Swift.String(describing: labels)), nodegroupName: \(Swift.String(describing: nodegroupName)), scalingConfig: \(Swift.String(describing: scalingConfig)), taints: \(Swift.String(describing: taints)))"}
}
...
extension EksClientTypes {
    ...
    public struct UpdateParam: Swift.Equatable {
        ...
        public let type: EksClientTypes.UpdateParamType?
...
extension EksClientTypes {
    ...
    public struct UpdateTaintsPayload: Swift.Equatable {
        ...
        public let addOrUpdateTaints: [EksClientTypes.Taint]?
        /// <p>Kubernetes taints to be removed.</p>
        public let removeTaints: [EksClientTypes.Taint]?
...
extension EksClientTypes {
    ...
    public struct VpcConfigRequest: Swift.Equatable {
        ...
        ///                <i>Amazon EKS User Guide</i>
        ///             </i>.</p>
        public let endpointPrivateAccess: Swift.Bool?
        ...
        ///                <i>Amazon EKS User Guide</i>
        ///             </i>.</p>
        public let endpointPublicAccess: Swift.Bool?
        ...
        ///                <i>Amazon EKS User Guide</i>
        ///             </i>.</p>
        public let publicAccessCidrs: [Swift.String]?
...
extension EksClientTypes {
    ...
    public struct VpcConfigResponse: Swift.Equatable {
        ...
        public let clusterSecurityGroupId: Swift.String?
