...
public class EksClient {
    ...
    public class EksClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("EksClient")
...
public struct EksClientLogHandlerFactory: SDKLogHandlerFactory {
