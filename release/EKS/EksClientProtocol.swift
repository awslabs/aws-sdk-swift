...
public protocol EksClientProtocol {
    ...
    func associateEncryptionConfig(input: AssociateEncryptionConfigInput, completion: @escaping (SdkResult<AssociateEncryptionConfigOutputResponse, AssociateEncryptionConfigOutputError>) -> Void)
    ...
    func associateIdentityProviderConfig(input: AssociateIdentityProviderConfigInput, completion: @escaping (SdkResult<AssociateIdentityProviderConfigOutputResponse, AssociateIdentityProviderConfigOutputError>) -> Void)
    ...
    func createAddon(input: CreateAddonInput, completion: @escaping (SdkResult<CreateAddonOutputResponse, CreateAddonOutputError>) -> Void)
    ...
    func createFargateProfile(input: CreateFargateProfileInput, completion: @escaping (SdkResult<CreateFargateProfileOutputResponse, CreateFargateProfileOutputError>) -> Void)
    ...
    func createNodegroup(input: CreateNodegroupInput, completion: @escaping (SdkResult<CreateNodegroupOutputResponse, CreateNodegroupOutputError>) -> Void)
    ...
    func deleteAddon(input: DeleteAddonInput, completion: @escaping (SdkResult<DeleteAddonOutputResponse, DeleteAddonOutputError>) -> Void)
    ...
    func deleteFargateProfile(input: DeleteFargateProfileInput, completion: @escaping (SdkResult<DeleteFargateProfileOutputResponse, DeleteFargateProfileOutputError>) -> Void)
    /// <p>Deletes an Amazon EKS node group for a cluster.</p>
    func deleteNodegroup(input: DeleteNodegroupInput, completion: @escaping (SdkResult<DeleteNodegroupOutputResponse, DeleteNodegroupOutputError>) -> Void)
    /// <p>Describes an Amazon EKS add-on.</p>
    func describeAddon(input: DescribeAddonInput, completion: @escaping (SdkResult<DescribeAddonOutputResponse, DescribeAddonOutputError>) -> Void)
    /// <p>Describes the Kubernetes versions that the add-on can be used with.</p>
    func describeAddonVersions(input: DescribeAddonVersionsInput, completion: @escaping (SdkResult<DescribeAddonVersionsOutputResponse, DescribeAddonVersionsOutputError>) -> Void)
    ...
    func describeFargateProfile(input: DescribeFargateProfileInput, completion: @escaping (SdkResult<DescribeFargateProfileOutputResponse, DescribeFargateProfileOutputError>) -> Void)
    /// <p>Returns descriptive information about an identity provider configuration.</p>
    func describeIdentityProviderConfig(input: DescribeIdentityProviderConfigInput, completion: @escaping (SdkResult<DescribeIdentityProviderConfigOutputResponse, DescribeIdentityProviderConfigOutputError>) -> Void)
    /// <p>Returns descriptive information about an Amazon EKS node group.</p>
    func describeNodegroup(input: DescribeNodegroupInput, completion: @escaping (SdkResult<DescribeNodegroupOutputResponse, DescribeNodegroupOutputError>) -> Void)
    ...
    ///             for the failure.</p>
    func describeUpdate(input: DescribeUpdateInput, completion: @escaping (SdkResult<DescribeUpdateOutputResponse, DescribeUpdateOutputError>) -> Void)
    ...
    ///             users.</p>
    func disassociateIdentityProviderConfig(input: DisassociateIdentityProviderConfigInput, completion: @escaping (SdkResult<DisassociateIdentityProviderConfigOutputResponse, DisassociateIdentityProviderConfigOutputError>) -> Void)
    /// <p>Lists the available add-ons.</p>
    func listAddons(input: ListAddonsInput, completion: @escaping (SdkResult<ListAddonsOutputResponse, ListAddonsOutputError>) -> Void)
    ...
    func listFargateProfiles(input: ListFargateProfilesInput, completion: @escaping (SdkResult<ListFargateProfilesOutputResponse, ListFargateProfilesOutputError>) -> Void)
    /// <p>A list of identity provider configurations.</p>
    func listIdentityProviderConfigs(input: ListIdentityProviderConfigsInput, completion: @escaping (SdkResult<ListIdentityProviderConfigsOutputResponse, ListIdentityProviderConfigsOutputError>) -> Void)
    ...
    func listNodegroups(input: ListNodegroupsInput, completion: @escaping (SdkResult<ListNodegroupsOutputResponse, ListNodegroupsOutputError>) -> Void)
    ...
    ///             account, in the specified Region.</p>
    func listUpdates(input: ListUpdatesInput, completion: @escaping (SdkResult<ListUpdatesOutputResponse, ListUpdatesOutputError>) -> Void)
    ...
    func updateAddon(input: UpdateAddonInput, completion: @escaping (SdkResult<UpdateAddonOutputResponse, UpdateAddonOutputError>) -> Void)
    ...
    func updateClusterConfig(input: UpdateClusterConfigInput, completion: @escaping (SdkResult<UpdateClusterConfigOutputResponse, UpdateClusterConfigOutputError>) -> Void)
    ...
    func updateClusterVersion(input: UpdateClusterVersionInput, completion: @escaping (SdkResult<UpdateClusterVersionOutputResponse, UpdateClusterVersionOutputError>) -> Void)
    ...
    func updateNodegroupConfig(input: UpdateNodegroupConfigInput, completion: @escaping (SdkResult<UpdateNodegroupConfigOutputResponse, UpdateNodegroupConfigOutputError>) -> Void)
    ...
    func updateNodegroupVersion(input: UpdateNodegroupVersionInput, completion: @escaping (SdkResult<UpdateNodegroupVersionOutputResponse, UpdateNodegroupVersionOutputError>) -> Void)
}
