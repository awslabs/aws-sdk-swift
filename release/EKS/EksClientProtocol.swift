...
public protocol EksClientProtocol {
    ...
    func associateEncryptionConfig(input: AssociateEncryptionConfigInput, completion: @escaping (SdkResult<AssociateEncryptionConfigOutput, AssociateEncryptionConfigOutputError>) -> Void)
    ...
    func associateIdentityProviderConfig(input: AssociateIdentityProviderConfigInput, completion: @escaping (SdkResult<AssociateIdentityProviderConfigOutput, AssociateIdentityProviderConfigOutputError>) -> Void)
    ...
    func createAddon(input: CreateAddonInput, completion: @escaping (SdkResult<CreateAddonOutput, CreateAddonOutputError>) -> Void)
    ...
    func createFargateProfile(input: CreateFargateProfileInput, completion: @escaping (SdkResult<CreateFargateProfileOutput, CreateFargateProfileOutputError>) -> Void)
    ...
    func createNodegroup(input: CreateNodegroupInput, completion: @escaping (SdkResult<CreateNodegroupOutput, CreateNodegroupOutputError>) -> Void)
    ...
    func deleteAddon(input: DeleteAddonInput, completion: @escaping (SdkResult<DeleteAddonOutput, DeleteAddonOutputError>) -> Void)
    ...
    func deleteFargateProfile(input: DeleteFargateProfileInput, completion: @escaping (SdkResult<DeleteFargateProfileOutput, DeleteFargateProfileOutputError>) -> Void)
    /// <p>Deletes an Amazon EKS node group for a cluster.</p>
    func deleteNodegroup(input: DeleteNodegroupInput, completion: @escaping (SdkResult<DeleteNodegroupOutput, DeleteNodegroupOutputError>) -> Void)
    /// <p>Describes an Amazon EKS add-on.</p>
    func describeAddon(input: DescribeAddonInput, completion: @escaping (SdkResult<DescribeAddonOutput, DescribeAddonOutputError>) -> Void)
    /// <p>Describes the Kubernetes versions that the add-on can be used with.</p>
    func describeAddonVersions(input: DescribeAddonVersionsInput, completion: @escaping (SdkResult<DescribeAddonVersionsOutput, DescribeAddonVersionsOutputError>) -> Void)
    ...
    func describeFargateProfile(input: DescribeFargateProfileInput, completion: @escaping (SdkResult<DescribeFargateProfileOutput, DescribeFargateProfileOutputError>) -> Void)
    /// <p>Returns descriptive information about an identity provider configuration.</p>
    func describeIdentityProviderConfig(input: DescribeIdentityProviderConfigInput, completion: @escaping (SdkResult<DescribeIdentityProviderConfigOutput, DescribeIdentityProviderConfigOutputError>) -> Void)
    /// <p>Returns descriptive information about an Amazon EKS node group.</p>
    func describeNodegroup(input: DescribeNodegroupInput, completion: @escaping (SdkResult<DescribeNodegroupOutput, DescribeNodegroupOutputError>) -> Void)
    ...
    ///             for the failure.</p>
    func describeUpdate(input: DescribeUpdateInput, completion: @escaping (SdkResult<DescribeUpdateOutput, DescribeUpdateOutputError>) -> Void)
    ...
    ///             users.</p>
    func disassociateIdentityProviderConfig(input: DisassociateIdentityProviderConfigInput, completion: @escaping (SdkResult<DisassociateIdentityProviderConfigOutput, DisassociateIdentityProviderConfigOutputError>) -> Void)
    /// <p>Lists the available add-ons.</p>
    func listAddons(input: ListAddonsInput, completion: @escaping (SdkResult<ListAddonsOutput, ListAddonsOutputError>) -> Void)
    ...
    func listFargateProfiles(input: ListFargateProfilesInput, completion: @escaping (SdkResult<ListFargateProfilesOutput, ListFargateProfilesOutputError>) -> Void)
    /// <p>A list of identity provider configurations.</p>
    func listIdentityProviderConfigs(input: ListIdentityProviderConfigsInput, completion: @escaping (SdkResult<ListIdentityProviderConfigsOutput, ListIdentityProviderConfigsOutputError>) -> Void)
    ...
    func listNodegroups(input: ListNodegroupsInput, completion: @escaping (SdkResult<ListNodegroupsOutput, ListNodegroupsOutputError>) -> Void)
    ...
    ///             account, in the specified Region.</p>
    func listUpdates(input: ListUpdatesInput, completion: @escaping (SdkResult<ListUpdatesOutput, ListUpdatesOutputError>) -> Void)
    ...
    func updateAddon(input: UpdateAddonInput, completion: @escaping (SdkResult<UpdateAddonOutput, UpdateAddonOutputError>) -> Void)
    ...
    func updateClusterConfig(input: UpdateClusterConfigInput, completion: @escaping (SdkResult<UpdateClusterConfigOutput, UpdateClusterConfigOutputError>) -> Void)
    ...
    func updateClusterVersion(input: UpdateClusterVersionInput, completion: @escaping (SdkResult<UpdateClusterVersionOutput, UpdateClusterVersionOutputError>) -> Void)
    ...
    func updateNodegroupConfig(input: UpdateNodegroupConfigInput, completion: @escaping (SdkResult<UpdateNodegroupConfigOutput, UpdateNodegroupConfigOutputError>) -> Void)
    ...
    func updateNodegroupVersion(input: UpdateNodegroupVersionInput, completion: @escaping (SdkResult<UpdateNodegroupVersionOutput, UpdateNodegroupVersionOutputError>) -> Void)
}
