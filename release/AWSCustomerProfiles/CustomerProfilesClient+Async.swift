...
public extension CustomerProfilesClient {
    ...
    {
        typealias getAutoMergingPreviewContinuation = CheckedContinuation<GetAutoMergingPreviewOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getAutoMergingPreviewContinuation) in
            getAutoMergingPreview(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getIdentityResolutionJobContinuation = CheckedContinuation<GetIdentityResolutionJobOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getIdentityResolutionJobContinuation) in
            getIdentityResolutionJob(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listIdentityResolutionJobsContinuation = CheckedContinuation<ListIdentityResolutionJobsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listIdentityResolutionJobsContinuation) in
            listIdentityResolutionJobs(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
