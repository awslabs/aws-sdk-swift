...
public struct AddProfileKeyInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddProfileKeyInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<AddProfileKeyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<AddProfileKeyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<AddProfileKeyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<AddProfileKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AddProfileKeyOutputError>
}

extension AddProfileKeyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AddProfileKeyInput(domainName: \(Swift.String(describing: domainName)), keyName: \(Swift.String(describing: keyName)), profileId: \(Swift.String(describing: profileId)), values: \(Swift.String(describing: values)))"}
}

extension AddProfileKeyInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct AddProfileKeyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddProfileKeyInputHeadersMiddleware"
...
public struct AddProfileKeyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddProfileKeyInputQueryItemMiddleware"
...
public struct AddProfileKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddProfileKeyInputURLHostMiddleware"
    ...
    public typealias MInput = AddProfileKeyInput
    public typealias MOutput = ClientRuntime.OperationOutput<AddProfileKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AddProfileKeyOutputError>
}

public struct AddProfileKeyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddProfileKeyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/profiles/keys"
...
extension AddProfileKeyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AddProfileKeyOutputResponse(keyName: \(Swift.String(describing: keyName)), values: \(Swift.String(describing: values)))"}
}
...
extension CustomerProfilesClientTypes.Address: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.Address: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Address(address1: \(Swift.String(describing: address1)), address2: \(Swift.String(describing: address2)), address3: \(Swift.String(describing: address3)), address4: \(Swift.String(describing: address4)), city: \(Swift.String(describing: city)), country: \(Swift.String(describing: country)), county: \(Swift.String(describing: county)), postalCode: \(Swift.String(describing: postalCode)), province: \(Swift.String(describing: province)), state: \(Swift.String(describing: state)))"}
}
...
extension CustomerProfilesClientTypes.AutoMerging: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.AutoMerging: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AutoMerging(conflictResolution: \(Swift.String(describing: conflictResolution)), consolidation: \(Swift.String(describing: consolidation)), enabled: \(Swift.String(describing: enabled)))"}
}
...
extension CustomerProfilesClientTypes.ConflictResolution: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.ConflictResolution: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConflictResolution(conflictResolvingModel: \(Swift.String(describing: conflictResolvingModel)), sourceName: \(Swift.String(describing: sourceName)))"}
}
...
extension CustomerProfilesClientTypes.ConnectorOperator: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.ConnectorOperator: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConnectorOperator(marketo: \(Swift.String(describing: marketo)), s3: \(Swift.String(describing: s3)), salesforce: \(Swift.String(describing: salesforce)), serviceNow: \(Swift.String(describing: serviceNow)), zendesk: \(Swift.String(describing: zendesk)))"}
}
...
extension CustomerProfilesClientTypes.Consolidation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.Consolidation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Consolidation(matchingAttributesList: \(Swift.String(describing: matchingAttributesList)))"}
}
...
extension CreateDomainInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateDomainInput(deadLetterQueueUrl: \(Swift.String(describing: deadLetterQueueUrl)), defaultEncryptionKey: \(Swift.String(describing: defaultEncryptionKey)), defaultExpirationDays: \(Swift.String(describing: defaultExpirationDays)), domainName: \(Swift.String(describing: domainName)), matching: \(Swift.String(describing: matching)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct CreateDomainInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct CreateDomainInputBody: Swift.Equatable {
    public let defaultExpirationDays: Swift.Int?
    public let defaultEncryptionKey: Swift.String?
    public let deadLetterQueueUrl: Swift.String?
    public let matching: CustomerProfilesClientTypes.MatchingRequest?
...
extension CreateDomainOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateDomainOutputResponse(createdAt: \(Swift.String(describing: createdAt)), deadLetterQueueUrl: \(Swift.String(describing: deadLetterQueueUrl)), defaultEncryptionKey: \(Swift.String(describing: defaultEncryptionKey)), defaultExpirationDays: \(Swift.String(describing: defaultExpirationDays)), domainName: \(Swift.String(describing: domainName)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), matching: \(Swift.String(describing: matching)), tags: \(Swift.String(describing: tags)))"}
}
...
struct CreateDomainOutputResponseBody: Swift.Equatable {
    ...
    public let defaultEncryptionKey: Swift.String?
    public let deadLetterQueueUrl: Swift.String?
    public let matching: CustomerProfilesClientTypes.MatchingResponse?
...
public struct CreateProfileInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateProfileInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateProfileInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateProfileOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateProfileInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateProfileOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateProfileOutputError>
}

extension CreateProfileInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateProfileInput(accountNumber: \(Swift.String(describing: accountNumber)), additionalInformation: \(Swift.String(describing: additionalInformation)), address: \(Swift.String(describing: address)), attributes: \(Swift.String(describing: attributes)), billingAddress: \(Swift.String(describing: billingAddress)), birthDate: \(Swift.String(describing: birthDate)), businessEmailAddress: \(Swift.String(describing: businessEmailAddress)), businessName: \(Swift.String(describing: businessName)), businessPhoneNumber: \(Swift.String(describing: businessPhoneNumber)), domainName: \(Swift.String(describing: domainName)), emailAddress: \(Swift.String(describing: emailAddress)), firstName: \(Swift.String(describing: firstName)), gender: \(Swift.String(describing: gender)), homePhoneNumber: \(Swift.String(describing: homePhoneNumber)), lastName: \(Swift.String(describing: lastName)), mailingAddress: \(Swift.String(describing: mailingAddress)), middleName: \(Swift.String(describing: middleName)), mobilePhoneNumber: \(Swift.String(describing: mobilePhoneNumber)), partyType: \(Swift.String(describing: partyType)), personalEmailAddress: \(Swift.String(describing: personalEmailAddress)), phoneNumber: \(Swift.String(describing: phoneNumber)), shippingAddress: \(Swift.String(describing: shippingAddress)))"}
}

extension CreateProfileInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateProfileInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateProfileInputHeadersMiddleware"
...
public struct CreateProfileInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateProfileInputQueryItemMiddleware"
...
public struct CreateProfileInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateProfileInputURLHostMiddleware"
    ...
    public typealias MInput = CreateProfileInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateProfileOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateProfileOutputError>
}

public struct CreateProfileInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateProfileInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/profiles"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct CreateProfileInputBody: Swift.Equatable {
    ...
    public let additionalInformation: Swift.String?
    public let partyType: CustomerProfilesClientTypes.PartyType?
    public let businessName: Swift.String?
    public let firstName: Swift.String?
    public let middleName: Swift.String?
    public let lastName: Swift.String?
    public let birthDate: Swift.String?
    public let gender: CustomerProfilesClientTypes.Gender?
    public let phoneNumber: Swift.String?
    public let mobilePhoneNumber: Swift.String?
    public let homePhoneNumber: Swift.String?
    public let businessPhoneNumber: Swift.String?
    public let emailAddress: Swift.String?
    public let personalEmailAddress: Swift.String?
    public let businessEmailAddress: Swift.String?
    public let address: CustomerProfilesClientTypes.Address?
    public let shippingAddress: CustomerProfilesClientTypes.Address?
    public let mailingAddress: CustomerProfilesClientTypes.Address?
    public let billingAddress: CustomerProfilesClientTypes.Address?
...
extension CreateProfileOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateProfileOutputResponse(profileId: \(Swift.String(describing: profileId)))"}
}
...
extension DeleteDomainOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteDomainOutputResponse(message: \(Swift.String(describing: message)))"}
}
...
public struct DeleteIntegrationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteIntegrationInputBodyMiddleware"
...
extension DeleteIntegrationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteIntegrationInput(domainName: \(Swift.String(describing: domainName)), uri: \(Swift.String(describing: uri)))"}
}

extension DeleteIntegrationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case uri = "Uri"
    }
...
public struct DeleteIntegrationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteIntegrationInputHeadersMiddleware"
...
public struct DeleteIntegrationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteIntegrationInputURLHostMiddleware"
...
public struct DeleteIntegrationInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/integrations/delete"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DeleteIntegrationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteIntegrationOutputResponse(message: \(Swift.String(describing: message)))"}
}
...
public struct DeleteProfileInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteProfileInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteProfileOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteProfileInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteProfileOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteProfileOutputError>
}

extension DeleteProfileInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteProfileInput(domainName: \(Swift.String(describing: domainName)), profileId: \(Swift.String(describing: profileId)))"}
}

extension DeleteProfileInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case profileId = "ProfileId"
    }
...
public struct DeleteProfileInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileInputHeadersMiddleware"
...
public struct DeleteProfileInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileInputQueryItemMiddleware"
...
public struct DeleteProfileInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteProfileInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteProfileOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteProfileOutputError>
}

public struct DeleteProfileInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/profiles/delete"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteProfileKeyInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileKeyInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteProfileKeyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteProfileKeyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteProfileKeyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteProfileKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteProfileKeyOutputError>
}

extension DeleteProfileKeyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteProfileKeyInput(domainName: \(Swift.String(describing: domainName)), keyName: \(Swift.String(describing: keyName)), profileId: \(Swift.String(describing: profileId)), values: \(Swift.String(describing: values)))"}
}

extension DeleteProfileKeyInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case keyName = "KeyName"
        case profileId = "ProfileId"
        case values = "Values"
...
public struct DeleteProfileKeyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileKeyInputHeadersMiddleware"
...
public struct DeleteProfileKeyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileKeyInputQueryItemMiddleware"
...
public struct DeleteProfileKeyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileKeyInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteProfileKeyInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteProfileKeyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteProfileKeyOutputError>
}

public struct DeleteProfileKeyInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileKeyInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/profiles/keys/delete"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DeleteProfileKeyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteProfileKeyOutputResponse(message: \(Swift.String(describing: message)))"}
}
...
public struct DeleteProfileObjectInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileObjectInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteProfileObjectInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteProfileObjectOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteProfileObjectInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteProfileObjectOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteProfileObjectOutputError>
}

extension DeleteProfileObjectInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteProfileObjectInput(domainName: \(Swift.String(describing: domainName)), objectTypeName: \(Swift.String(describing: objectTypeName)), profileId: \(Swift.String(describing: profileId)), profileObjectUniqueKey: \(Swift.String(describing: profileObjectUniqueKey)))"}
}

extension DeleteProfileObjectInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DeleteProfileObjectInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileObjectInputHeadersMiddleware"
...
public struct DeleteProfileObjectInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileObjectInputQueryItemMiddleware"
...
public struct DeleteProfileObjectInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileObjectInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteProfileObjectInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteProfileObjectOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteProfileObjectOutputError>
}

public struct DeleteProfileObjectInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileObjectInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/profiles/objects/delete"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct DeleteProfileObjectInputBody: Swift.Equatable {
    public let profileId: Swift.String?
    public let profileObjectUniqueKey: Swift.String?
...
extension DeleteProfileObjectOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteProfileObjectOutputResponse(message: \(Swift.String(describing: message)))"}
}
...
extension DeleteProfileObjectTypeInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteProfileObjectTypeInput(domainName: \(Swift.String(describing: domainName)), objectTypeName: \(Swift.String(describing: objectTypeName)))"}
}

extension DeleteProfileObjectTypeInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteProfileObjectTypeInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileObjectTypeInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteProfileObjectTypeInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteProfileObjectTypeOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteProfileObjectTypeInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteProfileObjectTypeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteProfileObjectTypeOutputError>
}

public struct DeleteProfileObjectTypeInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileObjectTypeInputQueryItemMiddleware"
...
public struct DeleteProfileObjectTypeInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileObjectTypeInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteProfileObjectTypeInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteProfileObjectTypeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteProfileObjectTypeOutputError>
}

public struct DeleteProfileObjectTypeInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteProfileObjectTypeInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let objectTypeName = input.objectTypeName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("objectTypeName is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/object-types/\(objectTypeName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DeleteProfileObjectTypeOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteProfileObjectTypeOutputResponse(message: \(Swift.String(describing: message)))"}
}
...
extension DeleteProfileOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteProfileOutputResponse(message: \(Swift.String(describing: message)))"}
}
...
extension CustomerProfilesClientTypes.DomainStats: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.DomainStats: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DomainStats(meteringProfileCount: \(Swift.String(describing: meteringProfileCount)), objectCount: \(Swift.String(describing: objectCount)), profileCount: \(Swift.String(describing: profileCount)), totalSize: \(Swift.String(describing: totalSize)))"}
}
...
extension CustomerProfilesClientTypes.ExportingConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.ExportingConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExportingConfig(s3Exporting: \(Swift.String(describing: s3Exporting)))"}
}
...
extension CustomerProfilesClientTypes.ExportingLocation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case s3Exporting = "S3Exporting"
    }
...
extension CustomerProfilesClientTypes.ExportingLocation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ExportingLocation(s3Exporting: \(Swift.String(describing: s3Exporting)))"}
}
...
extension CustomerProfilesClientTypes.FieldSourceProfileIds: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountNumber = "AccountNumber"
        case additionalInformation = "AdditionalInformation"
        case address = "Address"
...
extension CustomerProfilesClientTypes.FieldSourceProfileIds: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "FieldSourceProfileIds(accountNumber: \(Swift.String(describing: accountNumber)), additionalInformation: \(Swift.String(describing: additionalInformation)), address: \(Swift.String(describing: address)), attributes: \(Swift.String(describing: attributes)), billingAddress: \(Swift.String(describing: billingAddress)), birthDate: \(Swift.String(describing: birthDate)), businessEmailAddress: \(Swift.String(describing: businessEmailAddress)), businessName: \(Swift.String(describing: businessName)), businessPhoneNumber: \(Swift.String(describing: businessPhoneNumber)), emailAddress: \(Swift.String(describing: emailAddress)), firstName: \(Swift.String(describing: firstName)), gender: \(Swift.String(describing: gender)), homePhoneNumber: \(Swift.String(describing: homePhoneNumber)), lastName: \(Swift.String(describing: lastName)), mailingAddress: \(Swift.String(describing: mailingAddress)), middleName: \(Swift.String(describing: middleName)), mobilePhoneNumber: \(Swift.String(describing: mobilePhoneNumber)), partyType: \(Swift.String(describing: partyType)), personalEmailAddress: \(Swift.String(describing: personalEmailAddress)), phoneNumber: \(Swift.String(describing: phoneNumber)), shippingAddress: \(Swift.String(describing: shippingAddress)))"}
}
...
extension CustomerProfilesClientTypes.FlowDefinition: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.FlowDefinition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "FlowDefinition(description: \(Swift.String(describing: description)), flowName: \(Swift.String(describing: flowName)), kmsArn: \(Swift.String(describing: kmsArn)), sourceFlowConfig: \(Swift.String(describing: sourceFlowConfig)), tasks: \(Swift.String(describing: tasks)), triggerConfig: \(Swift.String(describing: triggerConfig)))"}
}
...
public struct GetAutoMergingPreviewInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAutoMergingPreviewInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAutoMergingPreviewInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAutoMergingPreviewOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAutoMergingPreviewInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAutoMergingPreviewOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAutoMergingPreviewOutputError>
}

extension GetAutoMergingPreviewInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAutoMergingPreviewInput(conflictResolution: \(Swift.String(describing: conflictResolution)), consolidation: \(Swift.String(describing: consolidation)), domainName: \(Swift.String(describing: domainName)))"}
}

extension GetAutoMergingPreviewInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case conflictResolution = "ConflictResolution"
        case consolidation = "Consolidation"
    }
...
public struct GetAutoMergingPreviewInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAutoMergingPreviewInputHeadersMiddleware"
...
public struct GetAutoMergingPreviewInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAutoMergingPreviewInputQueryItemMiddleware"
...
public struct GetAutoMergingPreviewInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAutoMergingPreviewInputURLHostMiddleware"
    ...
    public typealias MInput = GetAutoMergingPreviewInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAutoMergingPreviewOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAutoMergingPreviewOutputError>
}

public struct GetAutoMergingPreviewInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAutoMergingPreviewInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/identity-resolution-jobs/auto-merging-preview"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct GetAutoMergingPreviewInputBody: Swift.Equatable {
    public let consolidation: CustomerProfilesClientTypes.Consolidation?
    public let conflictResolution: CustomerProfilesClientTypes.ConflictResolution?
}
...
extension GetAutoMergingPreviewOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAutoMergingPreviewOutputResponse(domainName: \(Swift.String(describing: domainName)), numberOfMatchesInSample: \(Swift.String(describing: numberOfMatchesInSample)), numberOfProfilesInSample: \(Swift.String(describing: numberOfProfilesInSample)), numberOfProfilesWillBeMerged: \(Swift.String(describing: numberOfProfilesWillBeMerged)))"}
}
...
struct GetAutoMergingPreviewOutputResponseBody: Swift.Equatable {
    public let domainName: Swift.String?
    public let numberOfMatchesInSample: Swift.Int
    public let numberOfProfilesInSample: Swift.Int
    public let numberOfProfilesWillBeMerged: Swift.Int
}
...
public struct GetDomainInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDomainInputURLHostMiddleware"
    ...
    public typealias MInput = GetDomainInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetDomainOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetDomainOutputError>
}

public struct GetDomainInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetDomainInputURLPathMiddleware"
...
extension GetDomainOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetDomainOutputResponse(createdAt: \(Swift.String(describing: createdAt)), deadLetterQueueUrl: \(Swift.String(describing: deadLetterQueueUrl)), defaultEncryptionKey: \(Swift.String(describing: defaultEncryptionKey)), defaultExpirationDays: \(Swift.String(describing: defaultExpirationDays)), domainName: \(Swift.String(describing: domainName)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), matching: \(Swift.String(describing: matching)), stats: \(Swift.String(describing: stats)), tags: \(Swift.String(describing: tags)))"}
}
...
struct GetDomainOutputResponseBody: Swift.Equatable {
    ...
    public let defaultEncryptionKey: Swift.String?
    public let deadLetterQueueUrl: Swift.String?
    public let stats: CustomerProfilesClientTypes.DomainStats?
    public let matching: CustomerProfilesClientTypes.MatchingResponse?
    public let createdAt: ClientRuntime.Date?
    public let lastUpdatedAt: ClientRuntime.Date?
    public let tags: [Swift.String:Swift.String]?
...
extension GetIdentityResolutionJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetIdentityResolutionJobInput(domainName: \(Swift.String(describing: domainName)), jobId: \(Swift.String(describing: jobId)))"}
}

extension GetIdentityResolutionJobInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetIdentityResolutionJobInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetIdentityResolutionJobInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetIdentityResolutionJobInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetIdentityResolutionJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetIdentityResolutionJobInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetIdentityResolutionJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetIdentityResolutionJobOutputError>
}

public struct GetIdentityResolutionJobInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetIdentityResolutionJobInputQueryItemMiddleware"
...
public struct GetIdentityResolutionJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetIdentityResolutionJobInputURLHostMiddleware"
    ...
    public typealias MInput = GetIdentityResolutionJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetIdentityResolutionJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetIdentityResolutionJobOutputError>
}

public struct GetIdentityResolutionJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetIdentityResolutionJobInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/identity-resolution-jobs/\(jobId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension GetIdentityResolutionJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetIdentityResolutionJobOutputResponse(autoMerging: \(Swift.String(describing: autoMerging)), domainName: \(Swift.String(describing: domainName)), exportingLocation: \(Swift.String(describing: exportingLocation)), jobEndTime: \(Swift.String(describing: jobEndTime)), jobExpirationTime: \(Swift.String(describing: jobExpirationTime)), jobId: \(Swift.String(describing: jobId)), jobStartTime: \(Swift.String(describing: jobStartTime)), jobStats: \(Swift.String(describing: jobStats)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), message: \(Swift.String(describing: message)), status: \(Swift.String(describing: status)))"}
}
...
struct GetIdentityResolutionJobOutputResponseBody: Swift.Equatable {
    ...
    public let status: CustomerProfilesClientTypes.IdentityResolutionJobStatus?
    public let message: Swift.String?
    public let jobStartTime: ClientRuntime.Date?
    public let jobEndTime: ClientRuntime.Date?
    public let lastUpdatedAt: ClientRuntime.Date?
    public let jobExpirationTime: ClientRuntime.Date?
    public let autoMerging: CustomerProfilesClientTypes.AutoMerging?
    public let exportingLocation: CustomerProfilesClientTypes.ExportingLocation?
    public let jobStats: CustomerProfilesClientTypes.JobStats?
}
...
public struct GetIntegrationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetIntegrationInputBodyMiddleware"
...
extension GetIntegrationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetIntegrationInput(domainName: \(Swift.String(describing: domainName)), uri: \(Swift.String(describing: uri)))"}
}

extension GetIntegrationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case uri = "Uri"
    }
...
public struct GetIntegrationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetIntegrationInputQueryItemMiddleware"
...
public struct GetIntegrationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetIntegrationInputURLHostMiddleware"
...
public struct GetIntegrationInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/integrations"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension GetIntegrationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetIntegrationOutputResponse(createdAt: \(Swift.String(describing: createdAt)), domainName: \(Swift.String(describing: domainName)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), objectTypeName: \(Swift.String(describing: objectTypeName)), tags: \(Swift.String(describing: tags)), uri: \(Swift.String(describing: uri)))"}
}
...
extension GetMatchesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetMatchesInput(domainName: \(Swift.String(describing: domainName)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension GetMatchesInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetMatchesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMatchesInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetMatchesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetMatchesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetMatchesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetMatchesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetMatchesOutputError>
}

public struct GetMatchesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMatchesInputQueryItemMiddleware"
...
public struct GetMatchesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMatchesInputURLHostMiddleware"
    ...
    public typealias MInput = GetMatchesInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetMatchesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetMatchesOutputError>
}

public struct GetMatchesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetMatchesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/matches"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension GetMatchesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetMatchesOutputResponse(matchGenerationDate: \(Swift.String(describing: matchGenerationDate)), matches: \(Swift.String(describing: matches)), nextToken: \(Swift.String(describing: nextToken)), potentialMatches: \(Swift.String(describing: potentialMatches)))"}
}
...
struct GetMatchesOutputResponseBody: Swift.Equatable {
    ...
    public let matchGenerationDate: ClientRuntime.Date?
    public let potentialMatches: Swift.Int?
    public let matches: [CustomerProfilesClientTypes.MatchItem]?
}
...
extension GetProfileObjectTypeInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetProfileObjectTypeInput(domainName: \(Swift.String(describing: domainName)), objectTypeName: \(Swift.String(describing: objectTypeName)))"}
}

extension GetProfileObjectTypeInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetProfileObjectTypeInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetProfileObjectTypeInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetProfileObjectTypeInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetProfileObjectTypeOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetProfileObjectTypeInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetProfileObjectTypeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetProfileObjectTypeOutputError>
}

public struct GetProfileObjectTypeInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetProfileObjectTypeInputQueryItemMiddleware"
...
public struct GetProfileObjectTypeInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetProfileObjectTypeInputURLHostMiddleware"
    ...
    public typealias MInput = GetProfileObjectTypeInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetProfileObjectTypeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetProfileObjectTypeOutputError>
}

public struct GetProfileObjectTypeInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetProfileObjectTypeInputURLPathMiddleware"
...
extension GetProfileObjectTypeOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetProfileObjectTypeOutputResponse(allowProfileCreation: \(Swift.String(describing: allowProfileCreation)), createdAt: \(Swift.String(describing: createdAt)), description: \(Swift.String(describing: description)), encryptionKey: \(Swift.String(describing: encryptionKey)), expirationDays: \(Swift.String(describing: expirationDays)), fields: \(Swift.String(describing: fields)), keys: \(Swift.String(describing: keys)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), objectTypeName: \(Swift.String(describing: objectTypeName)), sourceLastUpdatedTimestampFormat: \(Swift.String(describing: sourceLastUpdatedTimestampFormat)), tags: \(Swift.String(describing: tags)), templateId: \(Swift.String(describing: templateId)))"}
}
...
struct GetProfileObjectTypeOutputResponseBody: Swift.Equatable {
    ...
    public let allowProfileCreation: Swift.Bool
    public let sourceLastUpdatedTimestampFormat: Swift.String?
    public let fields: [Swift.String:CustomerProfilesClientTypes.ObjectTypeField]?
    public let keys: [Swift.String:[CustomerProfilesClientTypes.ObjectTypeKey]]?
    public let createdAt: ClientRuntime.Date?
    public let lastUpdatedAt: ClientRuntime.Date?
    public let tags: [Swift.String:Swift.String]?
}
...
extension GetProfileObjectTypeTemplateInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetProfileObjectTypeTemplateInput(templateId: \(Swift.String(describing: templateId)))"}
}

extension GetProfileObjectTypeTemplateInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetProfileObjectTypeTemplateInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetProfileObjectTypeTemplateInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetProfileObjectTypeTemplateInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetProfileObjectTypeTemplateOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetProfileObjectTypeTemplateInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetProfileObjectTypeTemplateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetProfileObjectTypeTemplateOutputError>
}

public struct GetProfileObjectTypeTemplateInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetProfileObjectTypeTemplateInputQueryItemMiddleware"
...
public struct GetProfileObjectTypeTemplateInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetProfileObjectTypeTemplateInputURLHostMiddleware"
    ...
    public typealias MInput = GetProfileObjectTypeTemplateInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetProfileObjectTypeTemplateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetProfileObjectTypeTemplateOutputError>
}

public struct GetProfileObjectTypeTemplateInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetProfileObjectTypeTemplateInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/templates/\(templateId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension GetProfileObjectTypeTemplateOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetProfileObjectTypeTemplateOutputResponse(allowProfileCreation: \(Swift.String(describing: allowProfileCreation)), fields: \(Swift.String(describing: fields)), keys: \(Swift.String(describing: keys)), sourceLastUpdatedTimestampFormat: \(Swift.String(describing: sourceLastUpdatedTimestampFormat)), sourceName: \(Swift.String(describing: sourceName)), sourceObject: \(Swift.String(describing: sourceObject)), templateId: \(Swift.String(describing: templateId)))"}
}
...
struct GetProfileObjectTypeTemplateOutputResponseBody: Swift.Equatable {
    ...
    public let sourceObject: Swift.String?
    public let allowProfileCreation: Swift.Bool
    public let sourceLastUpdatedTimestampFormat: Swift.String?
    public let fields: [Swift.String:CustomerProfilesClientTypes.ObjectTypeField]?
    public let keys: [Swift.String:[CustomerProfilesClientTypes.ObjectTypeKey]]?
...
extension CustomerProfilesClientTypes.IdentityResolutionJob: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case domainName = "DomainName"
        case exportingLocation = "ExportingLocation"
        case jobEndTime = "JobEndTime"
...
extension CustomerProfilesClientTypes.IdentityResolutionJob: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IdentityResolutionJob(domainName: \(Swift.String(describing: domainName)), exportingLocation: \(Swift.String(describing: exportingLocation)), jobEndTime: \(Swift.String(describing: jobEndTime)), jobId: \(Swift.String(describing: jobId)), jobStartTime: \(Swift.String(describing: jobStartTime)), jobStats: \(Swift.String(describing: jobStats)), message: \(Swift.String(describing: message)), status: \(Swift.String(describing: status)))"}
}
...
extension CustomerProfilesClientTypes.IncrementalPullConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.IncrementalPullConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension CustomerProfilesClientTypes.JobSchedule: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.JobSchedule: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobSchedule(dayOfTheWeek: \(Swift.String(describing: dayOfTheWeek)), time: \(Swift.String(describing: time)))"}
}
...
extension CustomerProfilesClientTypes.JobStats: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.JobStats: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobStats(numberOfMatchesFound: \(Swift.String(describing: numberOfMatchesFound)), numberOfMergesDone: \(Swift.String(describing: numberOfMergesDone)), numberOfProfilesReviewed: \(Swift.String(describing: numberOfProfilesReviewed)))"}
}
...
public struct ListAccountIntegrationsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccountIntegrationsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListAccountIntegrationsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListAccountIntegrationsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListAccountIntegrationsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListAccountIntegrationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAccountIntegrationsOutputError>
}

extension ListAccountIntegrationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAccountIntegrationsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), uri: \(Swift.String(describing: uri)))"}
}

extension ListAccountIntegrationsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case uri = "Uri"
    }
...
public struct ListAccountIntegrationsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccountIntegrationsInputHeadersMiddleware"
...
public struct ListAccountIntegrationsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccountIntegrationsInputQueryItemMiddleware"
...
public struct ListAccountIntegrationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccountIntegrationsInputURLHostMiddleware"
    ...
    public typealias MInput = ListAccountIntegrationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListAccountIntegrationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAccountIntegrationsOutputError>
}

public struct ListAccountIntegrationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccountIntegrationsInputURLPathMiddleware"
...
extension ListAccountIntegrationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAccountIntegrationsOutputResponse(items: \(Swift.String(describing: items)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListAccountIntegrationsOutputResponseBody: Swift.Equatable {
    public let items: [CustomerProfilesClientTypes.ListIntegrationItem]?
    public let nextToken: Swift.String?
}
...
extension CustomerProfilesClientTypes.ListDomainItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case createdAt = "CreatedAt"
        case domainName = "DomainName"
        case lastUpdatedAt = "LastUpdatedAt"
...
extension CustomerProfilesClientTypes.ListDomainItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListDomainItem(createdAt: \(Swift.String(describing: createdAt)), domainName: \(Swift.String(describing: domainName)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), tags: \(Swift.String(describing: tags)))"}
}
...
extension ListDomainsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListDomainsOutputResponse(items: \(Swift.String(describing: items)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListDomainsOutputResponseBody: Swift.Equatable {
    public let items: [CustomerProfilesClientTypes.ListDomainItem]?
    public let nextToken: Swift.String?
}
...
extension ListIdentityResolutionJobsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListIdentityResolutionJobsInput(domainName: \(Swift.String(describing: domainName)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListIdentityResolutionJobsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListIdentityResolutionJobsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListIdentityResolutionJobsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListIdentityResolutionJobsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListIdentityResolutionJobsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListIdentityResolutionJobsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListIdentityResolutionJobsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListIdentityResolutionJobsOutputError>
}

public struct ListIdentityResolutionJobsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListIdentityResolutionJobsInputQueryItemMiddleware"
...
public struct ListIdentityResolutionJobsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListIdentityResolutionJobsInputURLHostMiddleware"
    ...
    public typealias MInput = ListIdentityResolutionJobsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListIdentityResolutionJobsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListIdentityResolutionJobsOutputError>
}

public struct ListIdentityResolutionJobsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListIdentityResolutionJobsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/identity-resolution-jobs"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListIdentityResolutionJobsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListIdentityResolutionJobsOutputResponse(identityResolutionJobsList: \(Swift.String(describing: identityResolutionJobsList)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListIdentityResolutionJobsOutputResponseBody: Swift.Equatable {
    public let identityResolutionJobsList: [CustomerProfilesClientTypes.IdentityResolutionJob]?
    public let nextToken: Swift.String?
}
...
extension CustomerProfilesClientTypes.ListIntegrationItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case createdAt = "CreatedAt"
        case domainName = "DomainName"
        case lastUpdatedAt = "LastUpdatedAt"
...
extension CustomerProfilesClientTypes.ListIntegrationItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListIntegrationItem(createdAt: \(Swift.String(describing: createdAt)), domainName: \(Swift.String(describing: domainName)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), objectTypeName: \(Swift.String(describing: objectTypeName)), tags: \(Swift.String(describing: tags)), uri: \(Swift.String(describing: uri)))"}
}
...
extension ListIntegrationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListIntegrationsInput(domainName: \(Swift.String(describing: domainName)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListIntegrationsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListIntegrationsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListIntegrationsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListIntegrationsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListIntegrationsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListIntegrationsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListIntegrationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListIntegrationsOutputError>
}

public struct ListIntegrationsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListIntegrationsInputQueryItemMiddleware"
...
public struct ListIntegrationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListIntegrationsInputURLHostMiddleware"
    ...
    public typealias MInput = ListIntegrationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListIntegrationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListIntegrationsOutputError>
}

public struct ListIntegrationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListIntegrationsInputURLPathMiddleware"
...
extension ListIntegrationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListIntegrationsOutputResponse(items: \(Swift.String(describing: items)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
extension CustomerProfilesClientTypes.ListProfileObjectTypeItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case createdAt = "CreatedAt"
        case description = "Description"
        case lastUpdatedAt = "LastUpdatedAt"
...
extension CustomerProfilesClientTypes.ListProfileObjectTypeItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListProfileObjectTypeItem(createdAt: \(Swift.String(describing: createdAt)), description: \(Swift.String(describing: description)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), objectTypeName: \(Swift.String(describing: objectTypeName)), tags: \(Swift.String(describing: tags)))"}
}
...
extension CustomerProfilesClientTypes.ListProfileObjectTypeTemplateItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case sourceName = "SourceName"
        case sourceObject = "SourceObject"
        case templateId = "TemplateId"
...
extension CustomerProfilesClientTypes.ListProfileObjectTypeTemplateItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListProfileObjectTypeTemplateItem(sourceName: \(Swift.String(describing: sourceName)), sourceObject: \(Swift.String(describing: sourceObject)), templateId: \(Swift.String(describing: templateId)))"}
}
...
extension ListProfileObjectTypeTemplatesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListProfileObjectTypeTemplatesInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListProfileObjectTypeTemplatesInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListProfileObjectTypeTemplatesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectTypeTemplatesInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListProfileObjectTypeTemplatesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListProfileObjectTypeTemplatesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListProfileObjectTypeTemplatesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListProfileObjectTypeTemplatesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListProfileObjectTypeTemplatesOutputError>
}

public struct ListProfileObjectTypeTemplatesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectTypeTemplatesInputQueryItemMiddleware"
...
public struct ListProfileObjectTypeTemplatesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectTypeTemplatesInputURLHostMiddleware"
    ...
    public typealias MInput = ListProfileObjectTypeTemplatesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListProfileObjectTypeTemplatesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListProfileObjectTypeTemplatesOutputError>
}

public struct ListProfileObjectTypeTemplatesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectTypeTemplatesInputURLPathMiddleware"
...
extension ListProfileObjectTypeTemplatesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListProfileObjectTypeTemplatesOutputResponse(items: \(Swift.String(describing: items)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListProfileObjectTypeTemplatesOutputResponseBody: Swift.Equatable {
    public let items: [CustomerProfilesClientTypes.ListProfileObjectTypeTemplateItem]?
    public let nextToken: Swift.String?
}
...
extension ListProfileObjectTypesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListProfileObjectTypesInput(domainName: \(Swift.String(describing: domainName)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListProfileObjectTypesInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListProfileObjectTypesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectTypesInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListProfileObjectTypesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListProfileObjectTypesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListProfileObjectTypesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListProfileObjectTypesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListProfileObjectTypesOutputError>
}

public struct ListProfileObjectTypesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectTypesInputQueryItemMiddleware"
...
public struct ListProfileObjectTypesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectTypesInputURLHostMiddleware"
    ...
    public typealias MInput = ListProfileObjectTypesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListProfileObjectTypesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListProfileObjectTypesOutputError>
}

public struct ListProfileObjectTypesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectTypesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/object-types"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListProfileObjectTypesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListProfileObjectTypesOutputResponse(items: \(Swift.String(describing: items)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListProfileObjectTypesOutputResponseBody: Swift.Equatable {
    public let items: [CustomerProfilesClientTypes.ListProfileObjectTypeItem]?
    public let nextToken: Swift.String?
}
...
public struct ListProfileObjectsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListProfileObjectsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListProfileObjectsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListProfileObjectsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListProfileObjectsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListProfileObjectsOutputError>
}

extension ListProfileObjectsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListProfileObjectsInput(domainName: \(Swift.String(describing: domainName)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), objectFilter: \(Swift.String(describing: objectFilter)), objectTypeName: \(Swift.String(describing: objectTypeName)), profileId: \(Swift.String(describing: profileId)))"}
}

extension ListProfileObjectsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ListProfileObjectsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectsInputHeadersMiddleware"
...
public struct ListProfileObjectsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectsInputQueryItemMiddleware"
...
public struct ListProfileObjectsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectsInputURLHostMiddleware"
    ...
    public typealias MInput = ListProfileObjectsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListProfileObjectsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListProfileObjectsOutputError>
}

public struct ListProfileObjectsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListProfileObjectsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/profiles/objects"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct ListProfileObjectsInputBody: Swift.Equatable {
    public let objectTypeName: Swift.String?
    public let profileId: Swift.String?
    public let objectFilter: CustomerProfilesClientTypes.ObjectFilter?
}
...
extension CustomerProfilesClientTypes.ListProfileObjectsItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case object = "Object"
        case objectTypeName = "ObjectTypeName"
        case profileObjectUniqueKey = "ProfileObjectUniqueKey"
...
extension CustomerProfilesClientTypes.ListProfileObjectsItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListProfileObjectsItem(object: \(Swift.String(describing: object)), objectTypeName: \(Swift.String(describing: objectTypeName)), profileObjectUniqueKey: \(Swift.String(describing: profileObjectUniqueKey)))"}
}
...
extension ListProfileObjectsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListProfileObjectsOutputResponse(items: \(Swift.String(describing: items)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListProfileObjectsOutputResponseBody: Swift.Equatable {
    public let items: [CustomerProfilesClientTypes.ListProfileObjectsItem]?
    public let nextToken: Swift.String?
}
...
extension CustomerProfilesClientTypes.MarketoSourceProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case object = "Object"
    }
...
extension CustomerProfilesClientTypes.MarketoSourceProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension CustomerProfilesClientTypes.MatchItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.MatchItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MatchItem(confidenceScore: \(Swift.String(describing: confidenceScore)), matchId: \(Swift.String(describing: matchId)), profileIds: \(Swift.String(describing: profileIds)))"}
}
...
extension CustomerProfilesClientTypes.MatchingRequest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case autoMerging = "AutoMerging"
        case enabled = "Enabled"
...
extension CustomerProfilesClientTypes.MatchingRequest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MatchingRequest(autoMerging: \(Swift.String(describing: autoMerging)), enabled: \(Swift.String(describing: enabled)), exportingConfig: \(Swift.String(describing: exportingConfig)), jobSchedule: \(Swift.String(describing: jobSchedule)))"}
}
...
extension CustomerProfilesClientTypes.MatchingResponse: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case autoMerging = "AutoMerging"
        case enabled = "Enabled"
        case exportingConfig = "ExportingConfig"
...
extension CustomerProfilesClientTypes.MatchingResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MatchingResponse(autoMerging: \(Swift.String(describing: autoMerging)), enabled: \(Swift.String(describing: enabled)), exportingConfig: \(Swift.String(describing: exportingConfig)), jobSchedule: \(Swift.String(describing: jobSchedule)))"}
}
...
public struct MergeProfilesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MergeProfilesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<MergeProfilesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<MergeProfilesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<MergeProfilesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<MergeProfilesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<MergeProfilesOutputError>
}

extension MergeProfilesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MergeProfilesInput(domainName: \(Swift.String(describing: domainName)), fieldSourceProfileIds: \(Swift.String(describing: fieldSourceProfileIds)), mainProfileId: \(Swift.String(describing: mainProfileId)), profileIdsToBeMerged: \(Swift.String(describing: profileIdsToBeMerged)))"}
}

extension MergeProfilesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct MergeProfilesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MergeProfilesInputHeadersMiddleware"
...
public struct MergeProfilesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MergeProfilesInputQueryItemMiddleware"
...
public struct MergeProfilesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MergeProfilesInputURLHostMiddleware"
    ...
    public typealias MInput = MergeProfilesInput
    public typealias MOutput = ClientRuntime.OperationOutput<MergeProfilesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<MergeProfilesOutputError>
}

public struct MergeProfilesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MergeProfilesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/profiles/objects/merge"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct MergeProfilesInputBody: Swift.Equatable {
    public let mainProfileId: Swift.String?
    public let profileIdsToBeMerged: [Swift.String]?
    public let fieldSourceProfileIds: CustomerProfilesClientTypes.FieldSourceProfileIds?
}
...
extension MergeProfilesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MergeProfilesOutputResponse(message: \(Swift.String(describing: message)))"}
}
...
extension CustomerProfilesClientTypes.ObjectFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case keyName = "KeyName"
        case values = "Values"
    }
...
extension CustomerProfilesClientTypes.ObjectFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ObjectFilter(keyName: \(Swift.String(describing: keyName)), values: \(Swift.String(describing: values)))"}
}
...
extension CustomerProfilesClientTypes.ObjectTypeField: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.ObjectTypeField: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ObjectTypeField(contentType: \(Swift.String(describing: contentType)), source: \(Swift.String(describing: source)), target: \(Swift.String(describing: target)))"}
}
...
extension CustomerProfilesClientTypes.ObjectTypeKey: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.ObjectTypeKey: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ObjectTypeKey(fieldNames: \(Swift.String(describing: fieldNames)), standardIdentifiers: \(Swift.String(describing: standardIdentifiers)))"}
}
...
extension CustomerProfilesClientTypes.Profile: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountNumber = "AccountNumber"
        case additionalInformation = "AdditionalInformation"
        case address = "Address"
...
extension CustomerProfilesClientTypes.Profile: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Profile(accountNumber: \(Swift.String(describing: accountNumber)), additionalInformation: \(Swift.String(describing: additionalInformation)), address: \(Swift.String(describing: address)), attributes: \(Swift.String(describing: attributes)), billingAddress: \(Swift.String(describing: billingAddress)), birthDate: \(Swift.String(describing: birthDate)), businessEmailAddress: \(Swift.String(describing: businessEmailAddress)), businessName: \(Swift.String(describing: businessName)), businessPhoneNumber: \(Swift.String(describing: businessPhoneNumber)), emailAddress: \(Swift.String(describing: emailAddress)), firstName: \(Swift.String(describing: firstName)), gender: \(Swift.String(describing: gender)), homePhoneNumber: \(Swift.String(describing: homePhoneNumber)), lastName: \(Swift.String(describing: lastName)), mailingAddress: \(Swift.String(describing: mailingAddress)), middleName: \(Swift.String(describing: middleName)), mobilePhoneNumber: \(Swift.String(describing: mobilePhoneNumber)), partyType: \(Swift.String(describing: partyType)), personalEmailAddress: \(Swift.String(describing: personalEmailAddress)), phoneNumber: \(Swift.String(describing: phoneNumber)), profileId: \(Swift.String(describing: profileId)), shippingAddress: \(Swift.String(describing: shippingAddress)))"}
}
...
public struct PutIntegrationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutIntegrationInputBodyMiddleware"
...
extension PutIntegrationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutIntegrationInput(domainName: \(Swift.String(describing: domainName)), flowDefinition: \(Swift.String(describing: flowDefinition)), objectTypeName: \(Swift.String(describing: objectTypeName)), tags: \(Swift.String(describing: tags)), uri: \(Swift.String(describing: uri)))"}
}

extension PutIntegrationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct PutIntegrationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutIntegrationInputQueryItemMiddleware"
...
public struct PutIntegrationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutIntegrationInputURLHostMiddleware"
...
struct PutIntegrationInputBody: Swift.Equatable {
    ...
    public let objectTypeName: Swift.String?
    public let tags: [Swift.String:Swift.String]?
    public let flowDefinition: CustomerProfilesClientTypes.FlowDefinition?
}
...
extension PutIntegrationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutIntegrationOutputResponse(createdAt: \(Swift.String(describing: createdAt)), domainName: \(Swift.String(describing: domainName)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), objectTypeName: \(Swift.String(describing: objectTypeName)), tags: \(Swift.String(describing: tags)), uri: \(Swift.String(describing: uri)))"}
}
...
public struct PutProfileObjectInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutProfileObjectInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutProfileObjectInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutProfileObjectOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutProfileObjectInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutProfileObjectOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutProfileObjectOutputError>
}

extension PutProfileObjectInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutProfileObjectInput(domainName: \(Swift.String(describing: domainName)), object: \(Swift.String(describing: object)), objectTypeName: \(Swift.String(describing: objectTypeName)))"}
}

extension PutProfileObjectInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case object = "Object"
        case objectTypeName = "ObjectTypeName"
    }
...
public struct PutProfileObjectInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutProfileObjectInputHeadersMiddleware"
...
public struct PutProfileObjectInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutProfileObjectInputQueryItemMiddleware"
...
public struct PutProfileObjectInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutProfileObjectInputURLHostMiddleware"
    ...
    public typealias MInput = PutProfileObjectInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutProfileObjectOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutProfileObjectOutputError>
}

public struct PutProfileObjectInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutProfileObjectInputURLPathMiddleware"
...
extension PutProfileObjectOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutProfileObjectOutputResponse(profileObjectUniqueKey: \(Swift.String(describing: profileObjectUniqueKey)))"}
}
...
public struct PutProfileObjectTypeInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutProfileObjectTypeInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutProfileObjectTypeInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutProfileObjectTypeOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutProfileObjectTypeInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutProfileObjectTypeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutProfileObjectTypeOutputError>
}

extension PutProfileObjectTypeInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutProfileObjectTypeInput(allowProfileCreation: \(Swift.String(describing: allowProfileCreation)), description: \(Swift.String(describing: description)), domainName: \(Swift.String(describing: domainName)), encryptionKey: \(Swift.String(describing: encryptionKey)), expirationDays: \(Swift.String(describing: expirationDays)), fields: \(Swift.String(describing: fields)), keys: \(Swift.String(describing: keys)), objectTypeName: \(Swift.String(describing: objectTypeName)), sourceLastUpdatedTimestampFormat: \(Swift.String(describing: sourceLastUpdatedTimestampFormat)), tags: \(Swift.String(describing: tags)), templateId: \(Swift.String(describing: templateId)))"}
}

extension PutProfileObjectTypeInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case allowProfileCreation = "AllowProfileCreation"
        case description = "Description"
        case encryptionKey = "EncryptionKey"
...
public struct PutProfileObjectTypeInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutProfileObjectTypeInputHeadersMiddleware"
...
public struct PutProfileObjectTypeInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutProfileObjectTypeInputQueryItemMiddleware"
...
public struct PutProfileObjectTypeInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutProfileObjectTypeInputURLHostMiddleware"
    ...
    public typealias MInput = PutProfileObjectTypeInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutProfileObjectTypeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutProfileObjectTypeOutputError>
}

public struct PutProfileObjectTypeInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutProfileObjectTypeInputURLPathMiddleware"
...
extension CustomerProfilesClientTypes.S3ExportingConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.S3ExportingConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3ExportingConfig(s3BucketName: \(Swift.String(describing: s3BucketName)), s3KeyName: \(Swift.String(describing: s3KeyName)))"}
}
...
extension CustomerProfilesClientTypes.S3ExportingLocation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case s3BucketName = "S3BucketName"
        case s3KeyName = "S3KeyName"
    }
...
extension CustomerProfilesClientTypes.S3ExportingLocation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3ExportingLocation(s3BucketName: \(Swift.String(describing: s3BucketName)), s3KeyName: \(Swift.String(describing: s3KeyName)))"}
}
...
extension CustomerProfilesClientTypes.S3SourceProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.S3SourceProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension CustomerProfilesClientTypes.SalesforceSourceProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.SalesforceSourceProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension CustomerProfilesClientTypes.ScheduledTriggerProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.ScheduledTriggerProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
public struct SearchProfilesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchProfilesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<SearchProfilesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<SearchProfilesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<SearchProfilesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<SearchProfilesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SearchProfilesOutputError>
}

extension SearchProfilesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SearchProfilesInput(domainName: \(Swift.String(describing: domainName)), keyName: \(Swift.String(describing: keyName)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), values: \(Swift.String(describing: values)))"}
}

extension SearchProfilesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case keyName = "KeyName"
        case values = "Values"
    }
...
public struct SearchProfilesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchProfilesInputHeadersMiddleware"
...
public struct SearchProfilesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchProfilesInputQueryItemMiddleware"
...
public struct SearchProfilesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchProfilesInputURLHostMiddleware"
    ...
    public typealias MInput = SearchProfilesInput
    public typealias MOutput = ClientRuntime.OperationOutput<SearchProfilesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SearchProfilesOutputError>
}

public struct SearchProfilesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchProfilesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/domains/\(domainName.urlPercentEncoding())/profiles/search"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension SearchProfilesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SearchProfilesOutputResponse(items: \(Swift.String(describing: items)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct SearchProfilesOutputResponseBody: Swift.Equatable {
    public let items: [CustomerProfilesClientTypes.Profile]?
    public let nextToken: Swift.String?
}
...
extension CustomerProfilesClientTypes.ServiceNowSourceProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case object = "Object"
    }
...
extension CustomerProfilesClientTypes.ServiceNowSourceProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension CustomerProfilesClientTypes.SourceConnectorProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case marketo = "Marketo"
        case s3 = "S3"
        case salesforce = "Salesforce"
...
extension CustomerProfilesClientTypes.SourceConnectorProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SourceConnectorProperties(marketo: \(Swift.String(describing: marketo)), s3: \(Swift.String(describing: s3)), salesforce: \(Swift.String(describing: salesforce)), serviceNow: \(Swift.String(describing: serviceNow)), zendesk: \(Swift.String(describing: zendesk)))"}
}
...
extension CustomerProfilesClientTypes.SourceFlowConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.SourceFlowConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension CustomerProfilesClientTypes.Task: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.Task: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension CustomerProfilesClientTypes.TriggerConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.TriggerConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension CustomerProfilesClientTypes.TriggerProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CustomerProfilesClientTypes.TriggerProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension CustomerProfilesClientTypes.UpdateAddress: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case address1 = "Address1"
        case address2 = "Address2"
        case address3 = "Address3"
...
extension CustomerProfilesClientTypes.UpdateAddress: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateAddress(address1: \(Swift.String(describing: address1)), address2: \(Swift.String(describing: address2)), address3: \(Swift.String(describing: address3)), address4: \(Swift.String(describing: address4)), city: \(Swift.String(describing: city)), country: \(Swift.String(describing: country)), county: \(Swift.String(describing: county)), postalCode: \(Swift.String(describing: postalCode)), province: \(Swift.String(describing: province)), state: \(Swift.String(describing: state)))"}
}
...
extension UpdateDomainInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateDomainInput(deadLetterQueueUrl: \(Swift.String(describing: deadLetterQueueUrl)), defaultEncryptionKey: \(Swift.String(describing: defaultEncryptionKey)), defaultExpirationDays: \(Swift.String(describing: defaultExpirationDays)), domainName: \(Swift.String(describing: domainName)), matching: \(Swift.String(describing: matching)), tags: \(Swift.String(describing: tags)))"}
}
...
extension UpdateDomainOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateDomainOutputResponse(createdAt: \(Swift.String(describing: createdAt)), deadLetterQueueUrl: \(Swift.String(describing: deadLetterQueueUrl)), defaultEncryptionKey: \(Swift.String(describing: defaultEncryptionKey)), defaultExpirationDays: \(Swift.String(describing: defaultExpirationDays)), domainName: \(Swift.String(describing: domainName)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), matching: \(Swift.String(describing: matching)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct UpdateProfileInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateProfileInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateProfileInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateProfileOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateProfileInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateProfileOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateProfileOutputError>
}

extension UpdateProfileInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateProfileInput(accountNumber: \(Swift.String(describing: accountNumber)), additionalInformation: \(Swift.String(describing: additionalInformation)), address: \(Swift.String(describing: address)), attributes: \(Swift.String(describing: attributes)), billingAddress: \(Swift.String(describing: billingAddress)), birthDate: \(Swift.String(describing: birthDate)), businessEmailAddress: \(Swift.String(describing: businessEmailAddress)), businessName: \(Swift.String(describing: businessName)), businessPhoneNumber: \(Swift.String(describing: businessPhoneNumber)), domainName: \(Swift.String(describing: domainName)), emailAddress: \(Swift.String(describing: emailAddress)), firstName: \(Swift.String(describing: firstName)), gender: \(Swift.String(describing: gender)), homePhoneNumber: \(Swift.String(describing: homePhoneNumber)), lastName: \(Swift.String(describing: lastName)), mailingAddress: \(Swift.String(describing: mailingAddress)), middleName: \(Swift.String(describing: middleName)), mobilePhoneNumber: \(Swift.String(describing: mobilePhoneNumber)), partyType: \(Swift.String(describing: partyType)), personalEmailAddress: \(Swift.String(describing: personalEmailAddress)), phoneNumber: \(Swift.String(describing: phoneNumber)), profileId: \(Swift.String(describing: profileId)), shippingAddress: \(Swift.String(describing: shippingAddress)))"}
}

extension UpdateProfileInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountNumber = "AccountNumber"
        case additionalInformation = "AdditionalInformation"
        case address = "Address"
...
public struct UpdateProfileInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateProfileInputHeadersMiddleware"
...
public struct UpdateProfileInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateProfileInputQueryItemMiddleware"
...
public struct UpdateProfileInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateProfileInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateProfileInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateProfileOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateProfileOutputError>
}

public struct UpdateProfileInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateProfileInputURLPathMiddleware"
...
struct UpdateProfileInputBody: Swift.Equatable {
    ...
    public let personalEmailAddress: Swift.String?
    public let businessEmailAddress: Swift.String?
    public let address: CustomerProfilesClientTypes.UpdateAddress?
    public let shippingAddress: CustomerProfilesClientTypes.UpdateAddress?
    public let mailingAddress: CustomerProfilesClientTypes.UpdateAddress?
    public let billingAddress: CustomerProfilesClientTypes.UpdateAddress?
    public let attributes: [Swift.String:Swift.String]?
}
...
extension UpdateProfileOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateProfileOutputResponse(profileId: \(Swift.String(describing: profileId)))"}
}
...
extension CustomerProfilesClientTypes.ZendeskSourceProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case object = "Object"
    }
...
extension CustomerProfilesClientTypes.ZendeskSourceProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
