...
public protocol CustomerProfilesClientProtocol {
    ...
    func getAutoMergingPreview(input: GetAutoMergingPreviewInput, completion: @escaping (ClientRuntime.SdkResult<GetAutoMergingPreviewOutputResponse, GetAutoMergingPreviewOutputError>) -> Void)
    ...
    func getIdentityResolutionJob(input: GetIdentityResolutionJobInput, completion: @escaping (ClientRuntime.SdkResult<GetIdentityResolutionJobOutputResponse, GetIdentityResolutionJobOutputError>) -> Void)
    ...
    func listIdentityResolutionJobs(input: ListIdentityResolutionJobsInput, completion: @escaping (ClientRuntime.SdkResult<ListIdentityResolutionJobsOutputResponse, ListIdentityResolutionJobsOutputError>) -> Void)
