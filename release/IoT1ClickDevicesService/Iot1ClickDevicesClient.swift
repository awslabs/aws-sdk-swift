...
public class Iot1ClickDevicesClient {
    ...
    let config: Iot1ClickDevicesClientConfiguration
    let serviceName = "IoT 1Click Devices"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: Iot1ClickDevicesClientConfiguration) {
    ...
    public class Iot1ClickDevicesClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "Iot1ClickDevicesClient")
        }
        ...
        public static func `default`() throws -> Iot1ClickDevicesClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try Iot1ClickDevicesClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}

public struct Iot1ClickDevicesClientLogHandlerFactory: SDKLogHandlerFactory {
