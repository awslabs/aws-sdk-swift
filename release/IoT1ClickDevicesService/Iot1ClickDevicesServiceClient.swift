...
extension Iot1ClickDevicesServiceClient: Iot1ClickDevicesServiceClientProtocol {
    ...
    public func claimDevicesByClaimCode(input: ClaimDevicesByClaimCodeInput, completion: @escaping (SdkResult<ClaimDevicesByClaimCodeOutput, ClaimDevicesByClaimCodeOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<ClaimDevicesByClaimCodeInput, ClaimDevicesByClaimCodeOutput, ClaimDevicesByClaimCodeOutputError>(id: "claimDevicesByClaimCode")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ClaimDevicesByClaimCodeInput, ClaimDevicesByClaimCodeOutput, ClaimDevicesByClaimCodeOutputError>(contentType: "application/json"))
    ...
    ///  </note>
    public func finalizeDeviceClaim(input: FinalizeDeviceClaimInput, completion: @escaping (SdkResult<FinalizeDeviceClaimOutput, FinalizeDeviceClaimOutputError>) -> Void)
    {
        guard let deviceId = input.deviceId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component deviceId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iot1click")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<FinalizeDeviceClaimInput, FinalizeDeviceClaimOutput, FinalizeDeviceClaimOutputError>(id: "finalizeDeviceClaim")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<FinalizeDeviceClaimInput, FinalizeDeviceClaimOutput, FinalizeDeviceClaimOutputError>(contentType: "application/json"))
    ...
    public func getDeviceMethods(input: GetDeviceMethodsInput, completion: @escaping (SdkResult<GetDeviceMethodsOutput, GetDeviceMethodsOutputError>) -> Void)
    {
        guard let deviceId = input.deviceId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component deviceId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iot1click")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetDeviceMethodsInput, GetDeviceMethodsOutput, GetDeviceMethodsOutputError>(id: "getDeviceMethods")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetDeviceMethodsInput, GetDeviceMethodsOutput, GetDeviceMethodsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///  be published by simply clicking the device.</p>
    ///  </note>
    public func initiateDeviceClaim(input: InitiateDeviceClaimInput, completion: @escaping (SdkResult<InitiateDeviceClaimOutput, InitiateDeviceClaimOutputError>) -> Void)
    {
        guard let deviceId = input.deviceId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component deviceId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iot1click")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<InitiateDeviceClaimInput, InitiateDeviceClaimOutput, InitiateDeviceClaimOutputError>(id: "initiateDeviceClaim")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<InitiateDeviceClaimInput, InitiateDeviceClaimOutput, InitiateDeviceClaimOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func invokeDeviceMethod(input: InvokeDeviceMethodInput, completion: @escaping (SdkResult<InvokeDeviceMethodOutput, InvokeDeviceMethodOutputError>) -> Void)
    {
        guard let deviceId = input.deviceId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component deviceId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iot1click")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<InvokeDeviceMethodInput, InvokeDeviceMethodOutput, InvokeDeviceMethodOutputError>(id: "invokeDeviceMethod")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<InvokeDeviceMethodInput, InvokeDeviceMethodOutput, InvokeDeviceMethodOutputError>(contentType: "application/json"))
    ...
    public func listDeviceEvents(input: ListDeviceEventsInput, completion: @escaping (SdkResult<ListDeviceEventsOutput, ListDeviceEventsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListDeviceEventsInput, ListDeviceEventsOutput, ListDeviceEventsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func unclaimDevice(input: UnclaimDeviceInput, completion: @escaping (SdkResult<UnclaimDeviceOutput, UnclaimDeviceOutputError>) -> Void)
    {
        guard let deviceId = input.deviceId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component deviceId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iot1click")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UnclaimDeviceInput, UnclaimDeviceOutput, UnclaimDeviceOutputError>(id: "unclaimDevice")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UnclaimDeviceInput, UnclaimDeviceOutput, UnclaimDeviceOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func updateDeviceState(input: UpdateDeviceStateInput, completion: @escaping (SdkResult<UpdateDeviceStateOutput, UpdateDeviceStateOutputError>) -> Void)
    {
        guard let deviceId = input.deviceId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component deviceId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iot1click")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateDeviceStateInput, UpdateDeviceStateOutput, UpdateDeviceStateOutputError>(id: "updateDeviceState")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateDeviceStateInput, UpdateDeviceStateOutput, UpdateDeviceStateOutputError>(contentType: "application/json"))
