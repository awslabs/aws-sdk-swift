...
public struct CreateEnvironmentInput: Swift.Equatable {
    ...
    var federationMode: FinspaceClientTypes.FederationMode?
    ...
    var superuserParameters: FinspaceClientTypes.SuperuserParameters?
...
public struct CreateEnvironmentOutputResponse: Swift.Equatable {
    ...
    var environmentUrl: Swift.String?
...
extension FinspaceClientTypes {
    ...
    public struct Environment: Swift.Equatable {
        ...
        var dedicatedServiceAccountId: Swift.String?
        ...
        var sageMakerStudioDomainUrl: Swift.String?
        /// The current status of creation of the FinSpace environment.
        var status: FinspaceClientTypes.EnvironmentStatus?
...
extension FinspaceClientTypes {
    ...
    public struct FederationParameters: Swift.Equatable {
        ...
        var applicationCallBackURL: Swift.String?
        /// SAML attribute name and value. The name must always be Email and the value should be set to the attribute definition in which user email is set. For example, name would be Email and value http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress. Please check your SAML 2.0 compliant identity provider (IdP) documentation for details.
        var attributeMap: [Swift.String:Swift.String]?
        /// Name of the identity provider (IdP).
        var federationProviderName: Swift.String?
        /// The Uniform Resource Name (URN). Also referred as Service Provider URN or Audience URI or Service Provider Entity ID.
        var federationURN: Swift.String?
        /// SAML 2.0 Metadata document from identity provider (IdP).
        var samlMetadataDocument: Swift.String?
        /// Provide the metadata URL from your SAML 2.0 compliant identity provider (IdP).
        var samlMetadataURL: Swift.String?
...
public struct GetEnvironmentOutputResponse: Swift.Equatable {
    /// The name of the FinSpace environment.
    var environment: FinspaceClientTypes.Environment?
...
public struct ListEnvironmentsOutputResponse: Swift.Equatable {
    ...
    var environments: [FinspaceClientTypes.Environment]?
