...
public protocol LexModelsV2ClientProtocol {
    ...
    func buildBotLocale(input: BuildBotLocaleInput, completion: @escaping (SdkResult<BuildBotLocaleOutput, BuildBotLocaleOutputError>) -> Void)
    /// <p>Creates an Amazon Lex conversational bot. </p>
    func createBot(input: CreateBotInput, completion: @escaping (SdkResult<CreateBotOutput, CreateBotOutputError>) -> Void)
    ...
    func createBotAlias(input: CreateBotAliasInput, completion: @escaping (SdkResult<CreateBotAliasOutput, CreateBotAliasOutputError>) -> Void)
    ...
    func createBotLocale(input: CreateBotLocaleInput, completion: @escaping (SdkResult<CreateBotLocaleOutput, CreateBotLocaleOutputError>) -> Void)
    ...
    ///             exporting bots </a>
    ///          </p>
    func createExport(input: CreateExportInput, completion: @escaping (SdkResult<CreateExportOutput, CreateExportOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createIntent(input: CreateIntentInput, completion: @escaping (SdkResult<CreateIntentOutput, CreateIntentOutputError>) -> Void)
    /// <p>Creates a new resource policy with the specified policy
    ///          statements.</p>
    func createResourcePolicy(input: CreateResourcePolicyInput, completion: @escaping (SdkResult<CreateResourcePolicyOutput, CreateResourcePolicyOutputError>) -> Void)
    ...
    ///          access.</p>
    func createResourcePolicyStatement(input: CreateResourcePolicyStatementInput, completion: @escaping (SdkResult<CreateResourcePolicyStatementOutput, CreateResourcePolicyStatementOutputError>) -> Void)
    ...
    ///          user. </p>
    func createSlot(input: CreateSlotInput, completion: @escaping (SdkResult<CreateSlotOutput, CreateSlotOutputError>) -> Void)
    ...
    ///          assume. </p>
    func createSlotType(input: CreateSlotTypeInput, completion: @escaping (SdkResult<CreateSlotTypeOutput, CreateSlotTypeOutputError>) -> Void)
    /// <p>Gets a pre-signed S3 write URL that you use to upload the zip
    ///          archive when importing a bot or a bot locale. </p>
    func createUploadUrl(input: CreateUploadUrlInput, completion: @escaping (SdkResult<CreateUploadUrlOutput, CreateUploadUrlOutputError>) -> Void)
    ...
    func deleteBotLocale(input: DeleteBotLocaleInput, completion: @escaping (SdkResult<DeleteBotLocaleOutput, DeleteBotLocaleOutputError>) -> Void)
    ...
    ///          bucket.</p>
    func deleteExport(input: DeleteExportInput, completion: @escaping (SdkResult<DeleteExportOutput, DeleteExportOutputError>) -> Void)
    /// <p>Removes a previous import and the associated file stored in an S3
    ///          bucket.</p>
    func deleteImport(input: DeleteImportInput, completion: @escaping (SdkResult<DeleteImportOutput, DeleteImportOutputError>) -> Void)
    ...
    ///          exception.</p>
    func deleteResourcePolicyStatement(input: DeleteResourcePolicyStatementInput, completion: @escaping (SdkResult<DeleteResourcePolicyStatementOutput, DeleteResourcePolicyStatementOutputError>) -> Void)
    /// <p>Deletes the specified slot from an intent.</p>
    func deleteSlot(input: DeleteSlotInput, completion: @escaping (SdkResult<DeleteSlotOutput, DeleteSlotOutputError>) -> Void)
    ...
    func describeBot(input: DescribeBotInput, completion: @escaping (SdkResult<DescribeBotOutput, DescribeBotOutputError>) -> Void)
    /// <p>Get information about a specific bot alias.</p>
    func describeBotAlias(input: DescribeBotAliasInput, completion: @escaping (SdkResult<DescribeBotAliasOutput, DescribeBotAliasOutputError>) -> Void)
    /// <p>Describes the settings that a bot has for a specific locale. </p>
    func describeBotLocale(input: DescribeBotLocaleInput, completion: @escaping (SdkResult<DescribeBotLocaleOutput, DescribeBotLocaleOutputError>) -> Void)
    /// <p>Provides metadata about a version of a bot.</p>
    func describeBotVersion(input: DescribeBotVersionInput, completion: @escaping (SdkResult<DescribeBotVersionOutput, DescribeBotVersionOutputError>) -> Void)
    /// <p>Gets information about a specific export.</p>
    func describeExport(input: DescribeExportInput, completion: @escaping (SdkResult<DescribeExportOutput, DescribeExportOutputError>) -> Void)
    /// <p>Gets information about a specific import.</p>
    func describeImport(input: DescribeImportInput, completion: @escaping (SdkResult<DescribeImportOutput, DescribeImportOutputError>) -> Void)
    /// <p>Returns metadata about an intent.</p>
    func describeIntent(input: DescribeIntentInput, completion: @escaping (SdkResult<DescribeIntentOutput, DescribeIntentOutputError>) -> Void)
    /// <p>Gets the resource policy and policy revision for a bot or bot
    ///          alias.</p>
    func describeResourcePolicy(input: DescribeResourcePolicyInput, completion: @escaping (SdkResult<DescribeResourcePolicyOutput, DescribeResourcePolicyOutputError>) -> Void)
    /// <p>Gets metadata information about a slot.</p>
    func describeSlot(input: DescribeSlotInput, completion: @escaping (SdkResult<DescribeSlotOutput, DescribeSlotOutputError>) -> Void)
    /// <p>Gets metadata information about a slot type.</p>
    func describeSlotType(input: DescribeSlotTypeInput, completion: @escaping (SdkResult<DescribeSlotTypeOutput, DescribeSlotTypeOutputError>) -> Void)
    /// <p>Gets a list of aliases for the specified bot.</p>
    func listBotAliases(input: ListBotAliasesInput, completion: @escaping (SdkResult<ListBotAliasesOutput, ListBotAliasesOutputError>) -> Void)
    /// <p>Gets a list of locales for the specified bot.</p>
    func listBotLocales(input: ListBotLocalesInput, completion: @escaping (SdkResult<ListBotLocalesOutput, ListBotLocalesOutputError>) -> Void)
    /// <p>Gets a list of available bots.</p>
    func listBots(input: ListBotsInput, completion: @escaping (SdkResult<ListBotsOutput, ListBotsOutputError>) -> Void)
    ...
    func listBotVersions(input: ListBotVersionsInput, completion: @escaping (SdkResult<ListBotVersionsOutput, ListBotVersionsOutputError>) -> Void)
    ...
    func listBuiltInIntents(input: ListBuiltInIntentsInput, completion: @escaping (SdkResult<ListBuiltInIntentsOutput, ListBuiltInIntentsOutputError>) -> Void)
    /// <p>Gets a list of built-in slot types that meet the specified
    ///          criteria.</p>
    func listBuiltInSlotTypes(input: ListBuiltInSlotTypesInput, completion: @escaping (SdkResult<ListBuiltInSlotTypesOutput, ListBuiltInSlotTypesOutputError>) -> Void)
    ...
    func listIntents(input: ListIntentsInput, completion: @escaping (SdkResult<ListIntentsOutput, ListIntentsOutputError>) -> Void)
    /// <p>Gets a list of slots that match the specified criteria.</p>
    func listSlots(input: ListSlotsInput, completion: @escaping (SdkResult<ListSlotsOutput, ListSlotsOutputError>) -> Void)
    /// <p>Gets a list of slot types that match the specified criteria.</p>
    func listSlotTypes(input: ListSlotTypesInput, completion: @escaping (SdkResult<ListSlotTypesOutput, ListSlotTypesOutputError>) -> Void)
    ...
    func updateBot(input: UpdateBotInput, completion: @escaping (SdkResult<UpdateBotOutput, UpdateBotOutputError>) -> Void)
    /// <p>Updates the configuration of an existing bot alias.</p>
    func updateBotAlias(input: UpdateBotAliasInput, completion: @escaping (SdkResult<UpdateBotAliasOutput, UpdateBotAliasOutputError>) -> Void)
    /// <p>Updates the settings that a bot has for a specific locale.</p>
    func updateBotLocale(input: UpdateBotLocaleInput, completion: @escaping (SdkResult<UpdateBotLocaleOutput, UpdateBotLocaleOutputError>) -> Void)
    /// <p>Updates the password used to encrypt an export zip archive.</p>
    func updateExport(input: UpdateExportInput, completion: @escaping (SdkResult<UpdateExportOutput, UpdateExportOutputError>) -> Void)
    /// <p>Updates the settings for an intent.</p>
    func updateIntent(input: UpdateIntentInput, completion: @escaping (SdkResult<UpdateIntentOutput, UpdateIntentOutputError>) -> Void)
    ...
    ///          exception.</p>
    func updateResourcePolicy(input: UpdateResourcePolicyInput, completion: @escaping (SdkResult<UpdateResourcePolicyOutput, UpdateResourcePolicyOutputError>) -> Void)
    /// <p>Updates the settings for a slot.</p>
    func updateSlot(input: UpdateSlotInput, completion: @escaping (SdkResult<UpdateSlotOutput, UpdateSlotOutputError>) -> Void)
    /// <p>Updates the configuration of an existing slot type.</p>
    func updateSlotType(input: UpdateSlotTypeInput, completion: @escaping (SdkResult<UpdateSlotTypeOutput, UpdateSlotTypeOutputError>) -> Void)
}
