...
public class LexModelsV2Client {
    ...
    public convenience init(region: Swift.String? = nil) throws {
        ...
        let config = try LexModelsV2ClientConfiguration(region: unwrappedRegion)
...
extension LexModelsV2Client: LexModelsV2ClientProtocol {
    ...
    public func buildBotLocale(input: BuildBotLocaleInput, completion: @escaping (ClientRuntime.SdkResult<BuildBotLocaleOutputResponse, BuildBotLocaleOutputError>) -> Void)
    {
        ...
        guard let botVersion = input.botVersion else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component botVersion unexpectedly nil"))))
            return
        }
    ...
    public func createSlot(input: CreateSlotInput, completion: @escaping (ClientRuntime.SdkResult<CreateSlotOutputResponse, CreateSlotOutputError>) -> Void)
    {
        ...
        guard let intentId = input.intentId else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component intentId unexpectedly nil"))))
            return
        }
    ...
    public func deleteSlot(input: DeleteSlotInput, completion: @escaping (ClientRuntime.SdkResult<DeleteSlotOutputResponse, DeleteSlotOutputError>) -> Void)
    {
        ...
        guard let slotId = input.slotId else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component slotId unexpectedly nil"))))
            return
        }
    ...
    public func deleteSlotType(input: DeleteSlotTypeInput, completion: @escaping (ClientRuntime.SdkResult<DeleteSlotTypeOutputResponse, DeleteSlotTypeOutputError>) -> Void)
    {
        ...
        guard let slotTypeId = input.slotTypeId else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component slotTypeId unexpectedly nil"))))
            return
        }
