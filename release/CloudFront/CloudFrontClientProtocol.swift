...
public protocol CloudFrontClientProtocol {
    ...
    func createCachePolicy(input: CreateCachePolicyInput, completion: @escaping (SdkResult<CreateCachePolicyOutputResponse, CreateCachePolicyOutputError>) -> Void)
    ...
    /// 				<i>Amazon CloudFront Developer Guide</i>.</p>
    func createCloudFrontOriginAccessIdentity(input: CreateCloudFrontOriginAccessIdentityInput, completion: @escaping (SdkResult<CreateCloudFrontOriginAccessIdentityOutputResponse, CreateCloudFrontOriginAccessIdentityOutputError>) -> Void)
    ...
    func createDistributionWithTags(input: CreateDistributionWithTagsInput, completion: @escaping (SdkResult<CreateDistributionWithTagsOutputResponse, CreateDistributionWithTagsOutputError>) -> Void)
    /// <p>Create a new field-level encryption configuration.</p>
    func createFieldLevelEncryptionConfig(input: CreateFieldLevelEncryptionConfigInput, completion: @escaping (SdkResult<CreateFieldLevelEncryptionConfigOutputResponse, CreateFieldLevelEncryptionConfigOutputError>) -> Void)
    /// <p>Create a field-level encryption profile.</p>
    func createFieldLevelEncryptionProfile(input: CreateFieldLevelEncryptionProfileInput, completion: @escaping (SdkResult<CreateFieldLevelEncryptionProfileOutputResponse, CreateFieldLevelEncryptionProfileOutputError>) -> Void)
    ...
    func createInvalidation(input: CreateInvalidationInput, completion: @escaping (SdkResult<CreateInvalidationOutputResponse, CreateInvalidationOutputError>) -> Void)
    ...
    func createKeyGroup(input: CreateKeyGroupInput, completion: @escaping (SdkResult<CreateKeyGroupOutputResponse, CreateKeyGroupOutputError>) -> Void)
    ...
    /// 			<i>Amazon CloudFront Developer Guide</i>.</p>
    func createMonitoringSubscription(input: CreateMonitoringSubscriptionInput, completion: @escaping (SdkResult<CreateMonitoringSubscriptionOutputResponse, CreateMonitoringSubscriptionOutputError>) -> Void)
    ...
    /// 			<i>Amazon CloudFront Developer Guide</i>.</p>
    func createOriginRequestPolicy(input: CreateOriginRequestPolicyInput, completion: @escaping (SdkResult<CreateOriginRequestPolicyOutputResponse, CreateOriginRequestPolicyOutputError>) -> Void)
    /// <p>Uploads a public key to CloudFront that you can use with <a href="https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html">signed URLs and signed cookies</a>, or with <a href="https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/field-level-encryption.html">field-level encryption</a>.</p>
    func createPublicKey(input: CreatePublicKeyInput, completion: @escaping (SdkResult<CreatePublicKeyOutputResponse, CreatePublicKeyOutputError>) -> Void)
    ...
    func createRealtimeLogConfig(input: CreateRealtimeLogConfigInput, completion: @escaping (SdkResult<CreateRealtimeLogConfigOutputResponse, CreateRealtimeLogConfigOutputError>) -> Void)
    ...
    func createStreamingDistribution(input: CreateStreamingDistributionInput, completion: @escaping (SdkResult<CreateStreamingDistributionOutputResponse, CreateStreamingDistributionOutputError>) -> Void)
    /// <p>This API is deprecated.
    ///             Amazon CloudFront is deprecating real-time messaging protocol (RTMP) distributions on December 31, 2020.
    ///             For more information, <a href="http://forums.aws.amazon.com/ann.jspa?annID=7356">read the announcement</a> on the Amazon CloudFront discussion forum.</p>
    func createStreamingDistributionWithTags(input: CreateStreamingDistributionWithTagsInput, completion: @escaping (SdkResult<CreateStreamingDistributionWithTagsOutputResponse, CreateStreamingDistributionWithTagsOutputError>) -> Void)
    ...
    func deleteCachePolicy(input: DeleteCachePolicyInput, completion: @escaping (SdkResult<DeleteCachePolicyOutputResponse, DeleteCachePolicyOutputError>) -> Void)
    /// <p>Delete an origin access identity. </p>
    func deleteCloudFrontOriginAccessIdentity(input: DeleteCloudFrontOriginAccessIdentityInput, completion: @escaping (SdkResult<DeleteCloudFrontOriginAccessIdentityOutputResponse, DeleteCloudFrontOriginAccessIdentityOutputError>) -> Void)
    ...
    func deleteFieldLevelEncryptionConfig(input: DeleteFieldLevelEncryptionConfigInput, completion: @escaping (SdkResult<DeleteFieldLevelEncryptionConfigOutputResponse, DeleteFieldLevelEncryptionConfigOutputError>) -> Void)
    /// <p>Remove a field-level encryption profile.</p>
    func deleteFieldLevelEncryptionProfile(input: DeleteFieldLevelEncryptionProfileInput, completion: @escaping (SdkResult<DeleteFieldLevelEncryptionProfileOutputResponse, DeleteFieldLevelEncryptionProfileOutputError>) -> Void)
    ...
    func deleteKeyGroup(input: DeleteKeyGroupInput, completion: @escaping (SdkResult<DeleteKeyGroupOutputResponse, DeleteKeyGroupOutputError>) -> Void)
    /// <p>Disables additional CloudWatch metrics for the specified CloudFront distribution.</p>
    func deleteMonitoringSubscription(input: DeleteMonitoringSubscriptionInput, completion: @escaping (SdkResult<DeleteMonitoringSubscriptionOutputResponse, DeleteMonitoringSubscriptionOutputError>) -> Void)
    ...
    func deleteOriginRequestPolicy(input: DeleteOriginRequestPolicyInput, completion: @escaping (SdkResult<DeleteOriginRequestPolicyOutputResponse, DeleteOriginRequestPolicyOutputError>) -> Void)
    /// <p>Remove a public key you previously added to CloudFront.</p>
    func deletePublicKey(input: DeletePublicKeyInput, completion: @escaping (SdkResult<DeletePublicKeyOutputResponse, DeletePublicKeyOutputError>) -> Void)
    ...
    func deleteRealtimeLogConfig(input: DeleteRealtimeLogConfigInput, completion: @escaping (SdkResult<DeleteRealtimeLogConfigOutputResponse, DeleteRealtimeLogConfigOutputError>) -> Void)
    ...
    /// 				<i>Amazon CloudFront Developer Guide</i>.</p>
    func deleteStreamingDistribution(input: DeleteStreamingDistributionInput, completion: @escaping (SdkResult<DeleteStreamingDistributionOutputResponse, DeleteStreamingDistributionOutputError>) -> Void)
    ...
    func describeFunction(input: DescribeFunctionInput, completion: @escaping (SdkResult<DescribeFunctionOutputResponse, DescribeFunctionOutputError>) -> Void)
    ...
    func getCachePolicy(input: GetCachePolicyInput, completion: @escaping (SdkResult<GetCachePolicyOutputResponse, GetCachePolicyOutputError>) -> Void)
    ...
    /// 			<code>ListCachePolicies</code>.</p>
    func getCachePolicyConfig(input: GetCachePolicyConfigInput, completion: @escaping (SdkResult<GetCachePolicyConfigOutputResponse, GetCachePolicyConfigOutputError>) -> Void)
    /// <p>Get the information about an origin access identity. </p>
    func getCloudFrontOriginAccessIdentity(input: GetCloudFrontOriginAccessIdentityInput, completion: @escaping (SdkResult<GetCloudFrontOriginAccessIdentityOutputResponse, GetCloudFrontOriginAccessIdentityOutputError>) -> Void)
    /// <p>Get the configuration information about an origin access identity. </p>
    func getCloudFrontOriginAccessIdentityConfig(input: GetCloudFrontOriginAccessIdentityConfigInput, completion: @escaping (SdkResult<GetCloudFrontOriginAccessIdentityConfigOutputResponse, GetCloudFrontOriginAccessIdentityConfigOutputError>) -> Void)
    /// <p>Get the information about a distribution.</p>
    func getDistribution(input: GetDistributionInput, completion: @escaping (SdkResult<GetDistributionOutputResponse, GetDistributionOutputError>) -> Void)
    /// <p>Get the configuration information about a distribution. </p>
    func getDistributionConfig(input: GetDistributionConfigInput, completion: @escaping (SdkResult<GetDistributionConfigOutputResponse, GetDistributionConfigOutputError>) -> Void)
    /// <p>Get the field-level encryption configuration information.</p>
    func getFieldLevelEncryption(input: GetFieldLevelEncryptionInput, completion: @escaping (SdkResult<GetFieldLevelEncryptionOutputResponse, GetFieldLevelEncryptionOutputError>) -> Void)
    /// <p>Get the field-level encryption configuration information.</p>
    func getFieldLevelEncryptionConfig(input: GetFieldLevelEncryptionConfigInput, completion: @escaping (SdkResult<GetFieldLevelEncryptionConfigOutputResponse, GetFieldLevelEncryptionConfigOutputError>) -> Void)
    /// <p>Get the field-level encryption profile information.</p>
    func getFieldLevelEncryptionProfile(input: GetFieldLevelEncryptionProfileInput, completion: @escaping (SdkResult<GetFieldLevelEncryptionProfileOutputResponse, GetFieldLevelEncryptionProfileOutputError>) -> Void)
    /// <p>Get the field-level encryption profile configuration information.</p>
    func getFieldLevelEncryptionProfileConfig(input: GetFieldLevelEncryptionProfileConfigInput, completion: @escaping (SdkResult<GetFieldLevelEncryptionProfileConfigOutputResponse, GetFieldLevelEncryptionProfileConfigOutputError>) -> Void)
    ...
    func getInvalidation(input: GetInvalidationInput, completion: @escaping (SdkResult<GetInvalidationOutputResponse, GetInvalidationOutputError>) -> Void)
    ...
    func getKeyGroup(input: GetKeyGroupInput, completion: @escaping (SdkResult<GetKeyGroupOutputResponse, GetKeyGroupOutputError>) -> Void)
    ...
    /// 			<code>ListKeyGroups</code>.</p>
    func getKeyGroupConfig(input: GetKeyGroupConfigInput, completion: @escaping (SdkResult<GetKeyGroupConfigOutputResponse, GetKeyGroupConfigOutputError>) -> Void)
    /// <p>Gets information about whether additional CloudWatch metrics are enabled for the specified
    /// 			CloudFront distribution.</p>
    func getMonitoringSubscription(input: GetMonitoringSubscriptionInput, completion: @escaping (SdkResult<GetMonitoringSubscriptionOutputResponse, GetMonitoringSubscriptionOutputError>) -> Void)
    ...
    func getOriginRequestPolicy(input: GetOriginRequestPolicyInput, completion: @escaping (SdkResult<GetOriginRequestPolicyOutputResponse, GetOriginRequestPolicyOutputError>) -> Void)
    ...
    func getOriginRequestPolicyConfig(input: GetOriginRequestPolicyConfigInput, completion: @escaping (SdkResult<GetOriginRequestPolicyConfigOutputResponse, GetOriginRequestPolicyConfigOutputError>) -> Void)
    /// <p>Gets a public key.</p>
    func getPublicKey(input: GetPublicKeyInput, completion: @escaping (SdkResult<GetPublicKeyOutputResponse, GetPublicKeyOutputError>) -> Void)
    /// <p>Gets a public key configuration.</p>
    func getPublicKeyConfig(input: GetPublicKeyConfigInput, completion: @escaping (SdkResult<GetPublicKeyConfigOutputResponse, GetPublicKeyConfigOutputError>) -> Void)
    ...
    func getRealtimeLogConfig(input: GetRealtimeLogConfigInput, completion: @escaping (SdkResult<GetRealtimeLogConfigOutputResponse, GetRealtimeLogConfigOutputError>) -> Void)
    /// <p>Gets information about a specified RTMP distribution, including the distribution configuration.</p>
    func getStreamingDistribution(input: GetStreamingDistributionInput, completion: @escaping (SdkResult<GetStreamingDistributionOutputResponse, GetStreamingDistributionOutputError>) -> Void)
    /// <p>Get the configuration information about a streaming distribution. </p>
    func getStreamingDistributionConfig(input: GetStreamingDistributionConfigInput, completion: @escaping (SdkResult<GetStreamingDistributionConfigOutputResponse, GetStreamingDistributionConfigOutputError>) -> Void)
    ...
    func listCachePolicies(input: ListCachePoliciesInput, completion: @escaping (SdkResult<ListCachePoliciesOutputResponse, ListCachePoliciesOutputError>) -> Void)
    /// <p>Lists origin access identities.</p>
    func listCloudFrontOriginAccessIdentities(input: ListCloudFrontOriginAccessIdentitiesInput, completion: @escaping (SdkResult<ListCloudFrontOriginAccessIdentitiesOutputResponse, ListCloudFrontOriginAccessIdentitiesOutputError>) -> Void)
    /// <p>List CloudFront distributions.</p>
    func listDistributions(input: ListDistributionsInput, completion: @escaping (SdkResult<ListDistributionsOutputResponse, ListDistributionsOutputError>) -> Void)
    ...
    /// 			subsequent request that specifies the <code>NextMarker</code> value from the current
    /// 			response as the <code>Marker</code> value in the subsequent request.</p>
    func listDistributionsByCachePolicyId(input: ListDistributionsByCachePolicyIdInput, completion: @escaping (SdkResult<ListDistributionsByCachePolicyIdOutputResponse, ListDistributionsByCachePolicyIdOutputError>) -> Void)
    ...
    /// 			subsequent request that specifies the <code>NextMarker</code> value from the current
    /// 			response as the <code>Marker</code> value in the subsequent request.</p>
    func listDistributionsByKeyGroup(input: ListDistributionsByKeyGroupInput, completion: @escaping (SdkResult<ListDistributionsByKeyGroupOutputResponse, ListDistributionsByKeyGroupOutputError>) -> Void)
    /// <p>Gets a list of distribution IDs for distributions that have a cache behavior that’s
    ...
    /// 			subsequent request that specifies the <code>NextMarker</code> value from the current
    /// 			response as the <code>Marker</code> value in the subsequent request.</p>
    func listDistributionsByOriginRequestPolicyId(input: ListDistributionsByOriginRequestPolicyIdInput, completion: @escaping (SdkResult<ListDistributionsByOriginRequestPolicyIdOutputResponse, ListDistributionsByOriginRequestPolicyIdOutputError>) -> Void)
    ...
    /// 			subsequent request that specifies the <code>NextMarker</code> value from the current
    /// 			response as the <code>Marker</code> value in the subsequent request. </p>
    func listDistributionsByRealtimeLogConfig(input: ListDistributionsByRealtimeLogConfigInput, completion: @escaping (SdkResult<ListDistributionsByRealtimeLogConfigOutputResponse, ListDistributionsByRealtimeLogConfigOutputError>) -> Void)
    /// <p>List the distributions that are associated with a specified AWS WAF web ACL. </p>
    func listDistributionsByWebACLId(input: ListDistributionsByWebACLIdInput, completion: @escaping (SdkResult<ListDistributionsByWebACLIdOutputResponse, ListDistributionsByWebACLIdOutputError>) -> Void)
    /// <p>List all field-level encryption configurations that have been created in CloudFront for this account.</p>
    func listFieldLevelEncryptionConfigs(input: ListFieldLevelEncryptionConfigsInput, completion: @escaping (SdkResult<ListFieldLevelEncryptionConfigsOutputResponse, ListFieldLevelEncryptionConfigsOutputError>) -> Void)
    /// <p>Request a list of field-level encryption profiles that have been created in CloudFront for this account.</p>
    func listFieldLevelEncryptionProfiles(input: ListFieldLevelEncryptionProfilesInput, completion: @escaping (SdkResult<ListFieldLevelEncryptionProfilesOutputResponse, ListFieldLevelEncryptionProfilesOutputError>) -> Void)
    ...
    func listInvalidations(input: ListInvalidationsInput, completion: @escaping (SdkResult<ListInvalidationsOutputResponse, ListInvalidationsOutputError>) -> Void)
    ...
    /// 			subsequent request that specifies the <code>NextMarker</code> value from the current
    /// 			response as the <code>Marker</code> value in the subsequent request.</p>
    func listKeyGroups(input: ListKeyGroupsInput, completion: @escaping (SdkResult<ListKeyGroupsOutputResponse, ListKeyGroupsOutputError>) -> Void)
    ...
    /// 			subsequent request that specifies the <code>NextMarker</code> value from the current
    /// 			response as the <code>Marker</code> value in the subsequent request.</p>
    func listOriginRequestPolicies(input: ListOriginRequestPoliciesInput, completion: @escaping (SdkResult<ListOriginRequestPoliciesOutputResponse, ListOriginRequestPoliciesOutputError>) -> Void)
    /// <p>List all public keys that have been added to CloudFront for this account.</p>
    func listPublicKeys(input: ListPublicKeysInput, completion: @escaping (SdkResult<ListPublicKeysOutputResponse, ListPublicKeysOutputError>) -> Void)
    ...
    /// 			subsequent request that specifies the <code>NextMarker</code> value from the current
    /// 			response as the <code>Marker</code> value in the subsequent request. </p>
    func listRealtimeLogConfigs(input: ListRealtimeLogConfigsInput, completion: @escaping (SdkResult<ListRealtimeLogConfigsOutputResponse, ListRealtimeLogConfigsOutputError>) -> Void)
    /// <p>List streaming distributions. </p>
    func listStreamingDistributions(input: ListStreamingDistributionsInput, completion: @escaping (SdkResult<ListStreamingDistributionsOutputResponse, ListStreamingDistributionsOutputError>) -> Void)
    ...
    func publishFunction(input: PublishFunctionInput, completion: @escaping (SdkResult<PublishFunctionOutputResponse, PublishFunctionOutputError>) -> Void)
    ...
    func testFunction(input: TestFunctionInput, completion: @escaping (SdkResult<TestFunctionOutputResponse, TestFunctionOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ol>
    func updateCachePolicy(input: UpdateCachePolicyInput, completion: @escaping (SdkResult<UpdateCachePolicyOutputResponse, UpdateCachePolicyOutputError>) -> Void)
    /// <p>Update an origin access identity. </p>
    func updateCloudFrontOriginAccessIdentity(input: UpdateCloudFrontOriginAccessIdentityInput, completion: @escaping (SdkResult<UpdateCloudFrontOriginAccessIdentityOutputResponse, UpdateCloudFrontOriginAccessIdentityOutputError>) -> Void)
    ...
    func updateFieldLevelEncryptionConfig(input: UpdateFieldLevelEncryptionConfigInput, completion: @escaping (SdkResult<UpdateFieldLevelEncryptionConfigOutputResponse, UpdateFieldLevelEncryptionConfigOutputError>) -> Void)
    /// <p>Update a field-level encryption profile. </p>
    func updateFieldLevelEncryptionProfile(input: UpdateFieldLevelEncryptionProfileInput, completion: @escaping (SdkResult<UpdateFieldLevelEncryptionProfileOutputResponse, UpdateFieldLevelEncryptionProfileOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ol>
    func updateKeyGroup(input: UpdateKeyGroupInput, completion: @escaping (SdkResult<UpdateKeyGroupOutputResponse, UpdateKeyGroupOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ol>
    func updateOriginRequestPolicy(input: UpdateOriginRequestPolicyInput, completion: @escaping (SdkResult<UpdateOriginRequestPolicyOutputResponse, UpdateOriginRequestPolicyOutputError>) -> Void)
    /// <p>Update public key information. Note that the only value you can change is the comment.</p>
    func updatePublicKey(input: UpdatePublicKeyInput, completion: @escaping (SdkResult<UpdatePublicKeyOutputResponse, UpdatePublicKeyOutputError>) -> Void)
    ...
    /// 			<code>ARN</code>.</p>
    func updateRealtimeLogConfig(input: UpdateRealtimeLogConfigInput, completion: @escaping (SdkResult<UpdateRealtimeLogConfigOutputResponse, UpdateRealtimeLogConfigOutputError>) -> Void)
    /// <p>Update a streaming distribution. </p>
    func updateStreamingDistribution(input: UpdateStreamingDistributionInput, completion: @escaping (SdkResult<UpdateStreamingDistributionOutputResponse, UpdateStreamingDistributionOutputError>) -> Void)
}
