...
extension CloudFrontClient: CloudFrontClientProtocol {
    ...
    public func associateAlias(input: AssociateAliasInput, completion: @escaping (ClientRuntime.SdkResult<AssociateAliasOutputResponse, AssociateAliasOutputError>) -> Void)
    {
        guard let targetDistributionId = input.targetDistributionId else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component targetDistributionId unexpectedly nil"))))
            return
        }
        let urlPath = "/2020-05-31/distribution/\(targetDistributionId)/associate-alias"
        ...
        var operation = OperationStack<AssociateAliasInput, AssociateAliasOutputResponse, AssociateAliasOutputError>(id: "associateAlias")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: AssociateAliasInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: AssociateAliasInputQueryItemMiddleware())
    ...
    {
        let urlPath = "/2020-05-31/conflicting-alias"
        let context = ClientRuntime.HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .withDecoder(value: decoder)
                      .withMethod(value: .get)
                      ...
                      .withSigningName(value: "cloudfront")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListConflictingAliasesInput, ListConflictingAliasesOutputResponse, ListConflictingAliasesOutputError>(id: "listConflictingAliases")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListConflictingAliasesInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListConflictingAliasesInputQueryItemMiddleware())
