...
extension MediaPackageClientTypes {
    ...
    public struct Authorization: Swift.Equatable {
        ...
        public let cdnIdentifierSecret: Swift.String?
        /// The Amazon Resource Name (ARN) for the IAM role that allows MediaPackage to communicate with AWS Secrets Manager.
        public let secretsRoleArn: Swift.String?
...
extension MediaPackageClientTypes.CmafEncryption: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let keyRotationIntervalSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .keyRotationIntervalSeconds)
...
extension MediaPackageClientTypes {
    ...
    public struct CmafEncryption: Swift.Equatable {
        ...
        public let keyRotationIntervalSeconds: Swift.Int
        /// A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
        public let spekeKeyProvider: MediaPackageClientTypes.SpekeKeyProvider?

        public init (
            constantInitializationVector: Swift.String? = nil,
            keyRotationIntervalSeconds: Swift.Int = 0,
...
extension MediaPackageClientTypes.CmafPackage: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let segmentDurationSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .segmentDurationSeconds)
...
extension MediaPackageClientTypes {
    ...
    public struct CmafPackage: Swift.Equatable {
        /// A Common Media Application Format (CMAF) encryption configuration.
        public let encryption: MediaPackageClientTypes.CmafEncryption?
        /// A list of HLS manifest configurations
        public let hlsManifests: [MediaPackageClientTypes.HlsManifest]?
        /// Duration (in seconds) of each segment. Actual segments will be
        /// rounded to the nearest multiple of the source segment duration.
        public let segmentDurationSeconds: Swift.Int
        /// An optional custom string that is prepended to the name of each segment. If not specified, it defaults to the ChannelId.
        public let segmentPrefix: Swift.String?
        /// A StreamSelection configuration.
        public let streamSelection: MediaPackageClientTypes.StreamSelection?

        public init (
            encryption: MediaPackageClientTypes.CmafEncryption? = nil,
            hlsManifests: [MediaPackageClientTypes.HlsManifest]? = nil,
            segmentDurationSeconds: Swift.Int = 0,
...
extension MediaPackageClientTypes {
    ...
    public struct CmafPackageCreateOrUpdateParameters: Swift.Equatable {
        ...
        public let encryption: MediaPackageClientTypes.CmafEncryption?
        /// A list of HLS manifest configurations
        public let hlsManifests: [MediaPackageClientTypes.HlsManifestCreateOrUpdateParameters]?
        /// Duration (in seconds) of each segment. Actual segments will be
        /// rounded to the nearest multiple of the source segment duration.
        public let segmentDurationSeconds: Swift.Int
        /// An optional custom string that is prepended to the name of each segment. If not specified, it defaults to the ChannelId.
...
public struct CreateOriginEndpointInput: Swift.Equatable {
    ...
    public init (
        ...
        startoverWindowSeconds: Swift.Int = 0,
        tags: [Swift.String:Swift.String]? = nil,
        timeDelaySeconds: Swift.Int = 0,
...
extension CreateOriginEndpointInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let startoverWindowSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .startoverWindowSeconds)
        ...
        tags = tagsDecoded0
        let timeDelaySecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .timeDelaySeconds)
...
extension MediaPackageClientTypes {
    ...
    public struct DashPackage: Swift.Equatable {
        ...
        /// message types.
        public let adTriggers: [MediaPackageClientTypes.__AdTriggersElement]?
        /// This setting allows the delivery restriction flags on SCTE-35 segmentation descriptors to
        /// determine whether a message signals an ad.  Choosing "NONE" means no SCTE-35 messages become
        /// ads.  Choosing "RESTRICTED" means SCTE-35 messages of the types specified in AdTriggers that
        /// contain delivery restrictions will be treated as ads.  Choosing "UNRESTRICTED" means SCTE-35
        ...
        /// AdTriggers will be treated as ads.  Note that Splice Insert messages do not have these flags
        /// and are always treated as ads if specified in AdTriggers.
        public let adsOnDeliveryRestrictions: MediaPackageClientTypes.AdsOnDeliveryRestrictions?
        /// A Dynamic Adaptive Streaming over HTTP (DASH) encryption configuration.
        public let encryption: MediaPackageClientTypes.DashEncryption?
        /// Determines the position of some tags in the Media Presentation Description (MPD).  When set to FULL, elements like SegmentTemplate and ContentProtection are included in each Representation.  When set to COMPACT, duplicate elements are combined and presented at the AdaptationSet level.
        public let manifestLayout: MediaPackageClientTypes.ManifestLayout?
        ...
        public let periodTriggers: [MediaPackageClientTypes.__PeriodTriggersElement]?
        /// The Dynamic Adaptive Streaming over HTTP (DASH) profile type.  When set to "HBBTV_1_5", HbbTV 1.5 compliant output is enabled.
        public let profile: MediaPackageClientTypes.Profile?
        /// Duration (in seconds) of each segment. Actual segments will be
        /// rounded to the nearest multiple of the source segment duration.
        public let segmentDurationSeconds: Swift.Int
        /// Determines the type of SegmentTemplate included in the Media Presentation Description (MPD).  When set to NUMBER_WITH_TIMELINE, a full timeline is presented in each SegmentTemplate, with $Number$ media URLs.  When set to TIME_WITH_TIMELINE, a full timeline is presented in each SegmentTemplate, with $Time$ media URLs. When set to NUMBER_WITH_DURATION, only a duration is included in each SegmentTemplate, with $Number$ media URLs.
        public let segmentTemplateFormat: MediaPackageClientTypes.SegmentTemplateFormat?
        /// A StreamSelection configuration.
        public let streamSelection: MediaPackageClientTypes.StreamSelection?
        /// Duration (in seconds) to delay live content before presentation.
        public let suggestedPresentationDelaySeconds: Swift.Int
        /// Determines the type of UTCTiming included in the Media Presentation Description (MPD)
        public let utcTiming: MediaPackageClientTypes.UtcTiming?
        /// Specifies the value attribute of the UTCTiming field when utcTiming is set to HTTP-ISO or HTTP-HEAD
        public let utcTimingUri: Swift.String?
...
extension MediaPackageClientTypes {
    ...
    public struct EncryptionContractConfiguration: Swift.Equatable {
        ...
        public let presetSpeke20Audio: MediaPackageClientTypes.PresetSpeke20Audio?
        /// A collection of video encryption presets.
        public let presetSpeke20Video: MediaPackageClientTypes.PresetSpeke20Video?
...
extension MediaPackageClientTypes.HlsEncryption: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let keyRotationIntervalSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .keyRotationIntervalSeconds)
        keyRotationIntervalSeconds = keyRotationIntervalSecondsDecoded
        let repeatExtXKeyDecoded = try containerValues.decode(Swift.Bool.self, forKey: .repeatExtXKey)
...
extension MediaPackageClientTypes {
    ...
    public struct HlsEncryption: Swift.Equatable {
        ...
        public let encryptionMethod: MediaPackageClientTypes.EncryptionMethod?
        /// Interval (in seconds) between each encryption key rotation.
        public let keyRotationIntervalSeconds: Swift.Int
        /// When enabled, the EXT-X-KEY tag will be repeated in output manifests.
        public let repeatExtXKey: Swift.Bool
        /// A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
        public let spekeKeyProvider: MediaPackageClientTypes.SpekeKeyProvider?
        ...
        public init (
            ...
            keyRotationIntervalSeconds: Swift.Int = 0,
            repeatExtXKey: Swift.Bool = false,
            spekeKeyProvider: MediaPackageClientTypes.SpekeKeyProvider? = nil
        )
        {
            self.constantInitializationVector = constantInitializationVector
...
extension MediaPackageClientTypes {
    ...
    public struct HlsIngest: Swift.Equatable {
        ...
        public let ingestEndpoints: [MediaPackageClientTypes.IngestEndpoint]?
...
extension MediaPackageClientTypes.HlsManifest: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let idDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .id)
        id = idDecoded
        let includeIframeOnlyStreamDecoded = try containerValues.decode(Swift.Bool.self, forKey: .includeIframeOnlyStream)
        ...
        let playlistWindowSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .playlistWindowSeconds)
        playlistWindowSeconds = playlistWindowSecondsDecoded
        let programDateTimeIntervalSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .programDateTimeIntervalSeconds)
...
extension MediaPackageClientTypes {
    ...
    public struct HlsManifest: Swift.Equatable {
        ...
        public let adMarkers: MediaPackageClientTypes.AdMarkers?
        /// The ID of the manifest. The ID must be unique within the OriginEndpoint and it cannot be changed after it is created.
        public let id: Swift.String?
        /// When enabled, an I-Frame only stream will be included in the output.
        public let includeIframeOnlyStream: Swift.Bool
        /// An optional short string appended to the end of the OriginEndpoint URL. If not specified, defaults to the manifestName for the OriginEndpoint.
        public let manifestName: Swift.String?
        /// The HTTP Live Streaming (HLS) playlist type.
        /// When either "EVENT" or "VOD" is specified, a corresponding EXT-X-PLAYLIST-TYPE
        /// entry will be included in the media playlist.
        public let playlistType: MediaPackageClientTypes.PlaylistType?
        /// Time window (in seconds) contained in each parent manifest.
        public let playlistWindowSeconds: Swift.Int
        ...
        public let programDateTimeIntervalSeconds: Swift.Int
        /// The URL of the packaged OriginEndpoint for consumption.
        public let url: Swift.String?
        ...
        public init (
            ...
            id: Swift.String? = nil,
            includeIframeOnlyStream: Swift.Bool = false,
            manifestName: Swift.String? = nil,
            playlistType: MediaPackageClientTypes.PlaylistType? = nil,
            playlistWindowSeconds: Swift.Int = 0,
            programDateTimeIntervalSeconds: Swift.Int = 0,
            url: Swift.String? = nil
        )
        {
...
extension MediaPackageClientTypes.HlsPackage: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let streamSelectionDecoded = try containerValues.decodeIfPresent(MediaPackageClientTypes.StreamSelection.self, forKey: .streamSelection)
        streamSelection = streamSelectionDecoded
        let useAudioRenditionGroupDecoded = try containerValues.decode(Swift.Bool.self, forKey: .useAudioRenditionGroup)
...
extension MediaPackageClientTypes {
    ...
    public struct HlsPackage: Swift.Equatable {
        ...
        public let adsOnDeliveryRestrictions: MediaPackageClientTypes.AdsOnDeliveryRestrictions?
        /// An HTTP Live Streaming (HLS) encryption configuration.
        public let encryption: MediaPackageClientTypes.HlsEncryption?
        /// When enabled, an I-Frame only stream will be included in the output.
        public let includeIframeOnlyStream: Swift.Bool
        /// The HTTP Live Streaming (HLS) playlist type.
        /// When either "EVENT" or "VOD" is specified, a corresponding EXT-X-PLAYLIST-TYPE
        ...
        public let useAudioRenditionGroup: Swift.Bool
        ...
        public init (
            ...
            segmentDurationSeconds: Swift.Int = 0,
            streamSelection: MediaPackageClientTypes.StreamSelection? = nil,
            useAudioRenditionGroup: Swift.Bool = false
        )
        {
            self.adMarkers = adMarkers
            self.adTriggers = adTriggers
...
public struct ListHarvestJobsInput: Swift.Equatable {
    ...
    public let includeChannelId: Swift.String?
    /// When specified, the request will return only HarvestJobs in the given status.
    public let includeStatus: Swift.String?
...
extension MediaPackageClientTypes {
    ...
    public struct MssPackage: Swift.Equatable {
        /// A Microsoft Smooth Streaming (MSS) encryption configuration.
        public let encryption: MediaPackageClientTypes.MssEncryption?
...
public struct RotateIngestEndpointCredentialsInput: Swift.Equatable {
    ...
    public let ingestEndpointId: Swift.String?
...
extension MediaPackageClientTypes {
    ...
    public struct S3Destination: Swift.Equatable {
        ...
        public let manifestKey: Swift.String?
...
extension MediaPackageClientTypes {
    ...
    public struct SpekeKeyProvider: Swift.Equatable {
        ...
        /// encryptionContractConfiguration can be used for DASH endpoints that use SPEKE 2.0. SPEKE 2.0 relies on the CPIX 2.3 specification.
        /// You must disable key rotation for this endpoint by setting keyRotationIntervalSeconds to 0.
        public let encryptionContractConfiguration: MediaPackageClientTypes.EncryptionContractConfiguration?
        ...
        public let systemIds: [Swift.String]?
...
extension MediaPackageClientTypes.StreamSelection: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let maxVideoBitsPerSecondDecoded = try containerValues.decode(Swift.Int.self, forKey: .maxVideoBitsPerSecond)
        maxVideoBitsPerSecond = maxVideoBitsPerSecondDecoded
        let minVideoBitsPerSecondDecoded = try containerValues.decode(Swift.Int.self, forKey: .minVideoBitsPerSecond)
...
extension MediaPackageClientTypes {
    ...
    public struct StreamSelection: Swift.Equatable {
        ...
        public let maxVideoBitsPerSecond: Swift.Int
        /// The minimum video bitrate (bps) to include in output.
        public let minVideoBitsPerSecond: Swift.Int
        /// A directive that determines the order of streams in the output.
        public let streamOrder: MediaPackageClientTypes.StreamOrder?

        public init (
            maxVideoBitsPerSecond: Swift.Int = 0,
            minVideoBitsPerSecond: Swift.Int = 0,
...
extension UnprocessableEntityException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct UnprocessableEntityException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
