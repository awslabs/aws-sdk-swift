...
extension CloudSearchClientTypes {
    ...
    public struct AccessPoliciesStatus: Swift.Equatable {
        ...
        /// This member is required.
        var status: CloudSearchClientTypes.OptionStatus?
...
extension CloudSearchClientTypes {
    ...
    public struct AnalysisOptions: Swift.Equatable {
        ...
        var algorithmicStemming: CloudSearchClientTypes.AlgorithmicStemming?
        /// A JSON array that contains a collection of terms, tokens, readings and part of speech for Japanese Tokenizaiton. The Japanese tokenization dictionary enables you to override the default tokenization for selected terms. This is only valid for Japanese language fields.
        var japaneseTokenizationDictionary: Swift.String?
        /// A JSON object that contains a collection of string:value pairs that each map a term to its stem. For example, {"term1": "stem1", "term2": "stem2", "term3": "stem3"}. The stemming dictionary is applied in addition to any algorithmic stemming. This enables you to override the results of the algorithmic stemming to correct specific cases of overstemming or understemming. The maximum size of a stemming dictionary is 500 KB.
        var stemmingDictionary: Swift.String?
        /// A JSON array of terms to ignore during indexing and searching. For example, ["a", "an", "the", "of"]. The stopwords dictionary must explicitly list each word you want to ignore. Wildcards and regular expressions are not supported.
        var stopwords: Swift.String?
...
extension CloudSearchClientTypes {
    ...
    public struct AnalysisScheme: Swift.Equatable {
        /// Synonyms, stopwords, and stemming options for an analysis scheme. Includes tokenization dictionary for Japanese.
        var analysisOptions: CloudSearchClientTypes.AnalysisOptions?
        /// An [IETF RFC 4646](http://tools.ietf.org/html/rfc4646) language code or mul for multiple languages.
        /// This member is required.
        var analysisSchemeLanguage: CloudSearchClientTypes.AnalysisSchemeLanguage?
        /// Names must begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore).
        /// This member is required.
        var analysisSchemeName: Swift.String?
...
extension CloudSearchClientTypes {
    ...
    public struct AnalysisSchemeStatus: Swift.Equatable {
        /// Configuration information for an analysis scheme. Each analysis scheme has a unique name and specifies the language of the text to be processed. The following options can be configured for an analysis scheme: Synonyms, Stopwords, StemmingDictionary, JapaneseTokenizationDictionary and AlgorithmicStemming.
        /// This member is required.
        var options: CloudSearchClientTypes.AnalysisScheme?
        /// The status of domain configuration option.
        /// This member is required.
        var status: CloudSearchClientTypes.OptionStatus?
...
public struct CreateDomainOutputResponse: Swift.Equatable {
    ...
    var domainStatus: CloudSearchClientTypes.DomainStatus?
...
extension CloudSearchClientTypes {
    ...
    public struct DateArrayOptions: Swift.Equatable {
        ...
        var facetEnabled: Swift.Bool?
        /// Whether the contents of the field can be returned in the search results.
        var returnEnabled: Swift.Bool?
        /// Whether the contents of the field are searchable.
        var searchEnabled: Swift.Bool?
...
public struct DefineAnalysisSchemeInput: Swift.Equatable {
    /// Configuration information for an analysis scheme. Each analysis scheme has a unique name and specifies the language of the text to be processed. The following options can be configured for an analysis scheme: Synonyms, Stopwords, StemmingDictionary, JapaneseTokenizationDictionary and AlgorithmicStemming.
    /// This member is required.
    var analysisScheme: CloudSearchClientTypes.AnalysisScheme?
    /// A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).
    /// This member is required.
    var domainName: Swift.String?
...
public struct DefineAnalysisSchemeOutputResponse: Swift.Equatable {
    /// The status and configuration of an AnalysisScheme.
    /// This member is required.
    var analysisScheme: CloudSearchClientTypes.AnalysisSchemeStatus?
...
public struct DefineExpressionInput: Swift.Equatable {
    ...
    /// This member is required.
    var expression: CloudSearchClientTypes.Expression?
...
public struct DefineExpressionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var expression: CloudSearchClientTypes.ExpressionStatus?
...
public struct DefineIndexFieldInput: Swift.Equatable {
    ...
    /// This member is required.
    var indexField: CloudSearchClientTypes.IndexField?
...
public struct DefineIndexFieldOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var indexField: CloudSearchClientTypes.IndexFieldStatus?
...
public struct DefineSuggesterInput: Swift.Equatable {
    ...
    /// This member is required.
    var suggester: CloudSearchClientTypes.Suggester?
...
public struct DefineSuggesterOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var suggester: CloudSearchClientTypes.SuggesterStatus?
...
public struct DeleteExpressionInput: Swift.Equatable {
    ...
    /// This member is required.
    var expressionName: Swift.String?
...
public struct DeleteSuggesterInput: Swift.Equatable {
    ...
    /// This member is required.
    var suggesterName: Swift.String?
...
public struct DescribeAnalysisSchemesInput: Swift.Equatable {
    ...
    var analysisSchemeNames: [Swift.String]?
    /// Whether to display the deployed configuration (true) or include any pending changes (false). Defaults to false.
    var deployed: Swift.Bool?
...
public struct DescribeAnalysisSchemesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var analysisSchemes: [CloudSearchClientTypes.AnalysisSchemeStatus]?
...
public struct DescribeAvailabilityOptionsOutputResponse: Swift.Equatable {
    ...
    var availabilityOptions: CloudSearchClientTypes.AvailabilityOptionsStatus?
...
public struct DescribeDomainEndpointOptionsOutputResponse: Swift.Equatable {
    ...
    var domainEndpointOptions: CloudSearchClientTypes.DomainEndpointOptionsStatus?
...
public struct DescribeDomainsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var domainStatusList: [CloudSearchClientTypes.DomainStatus]?
...
public struct DescribeExpressionsInput: Swift.Equatable {
    ...
    var expressionNames: [Swift.String]?
...
public struct DescribeExpressionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var expressions: [CloudSearchClientTypes.ExpressionStatus]?
...
public struct DescribeIndexFieldsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var indexFields: [CloudSearchClientTypes.IndexFieldStatus]?
...
public struct DescribeScalingParametersOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var scalingParameters: CloudSearchClientTypes.ScalingParametersStatus?
...
public struct DescribeServiceAccessPoliciesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var accessPolicies: CloudSearchClientTypes.AccessPoliciesStatus?
...
public struct DescribeSuggestersInput: Swift.Equatable {
    ...
    var suggesterNames: [Swift.String]?
...
public struct DescribeSuggestersOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var suggesters: [CloudSearchClientTypes.SuggesterStatus]?
...
extension CloudSearchClientTypes {
    ...
    public struct DomainEndpointOptions: Swift.Equatable {
        ...
        var tLSSecurityPolicy: CloudSearchClientTypes.TLSSecurityPolicy?
...
extension CloudSearchClientTypes {
    ...
    public struct DomainEndpointOptionsStatus: Swift.Equatable {
        ...
        /// This member is required.
        var options: CloudSearchClientTypes.DomainEndpointOptions?
...
extension CloudSearchClientTypes {
    ...
    public struct DomainStatus: Swift.Equatable {
        ...
        var docService: CloudSearchClientTypes.ServiceEndpoint?
        ...
        /// This member is required.
        var domainName: Swift.String?
        var limits: CloudSearchClientTypes.Limits?
        /// True if processing is being done to activate the current domain configuration.
        var processing: Swift.Bool?
        /// True if [IndexDocuments] needs to be called to activate the current domain configuration.
        /// This member is required.
        var requiresIndexDocuments: Swift.Bool?
        /// The number of search instances that are available to process search requests.
        var searchInstanceCount: Swift.Int
        /// The instance type that is being used to process search requests.
        var searchInstanceType: Swift.String?
        /// The number of partitions across which the search index is spread.
        var searchPartitionCount: Swift.Int
        /// The service endpoint for requesting search results from a search domain.
        var searchService: CloudSearchClientTypes.ServiceEndpoint?
...
extension CloudSearchClientTypes {
    ...
    public struct Expression: Swift.Equatable {
        ...
        /// This member is required.
        var expressionValue: Swift.String?
...
extension CloudSearchClientTypes {
    ...
    public struct ExpressionStatus: Swift.Equatable {
        ...
        /// This member is required.
        var options: CloudSearchClientTypes.Expression?
        /// The status of domain configuration option.
        /// This member is required.
        var status: CloudSearchClientTypes.OptionStatus?
...
extension CloudSearchClientTypes {
    ...
    public struct IndexField: Swift.Equatable {
        /// Options for a field that contains an array of dates. Present if IndexFieldType specifies the field is of type date-array. All options are enabled by default.
        var dateArrayOptions: CloudSearchClientTypes.DateArrayOptions?
        /// Options for a date field. Dates and times are specified in UTC (Coordinated Universal Time) according to IETF RFC3339: yyyy-mm-ddT00:00:00Z. Present if IndexFieldType specifies the field is of type date. All options are enabled by default.
        var dateOptions: CloudSearchClientTypes.DateOptions?
        /// Options for a field that contains an array of double-precision 64-bit floating point values. Present if IndexFieldType specifies the field is of type double-array. All options are enabled by default.
        var doubleArrayOptions: CloudSearchClientTypes.DoubleArrayOptions?
        /// Options for a double-precision 64-bit floating point field. Present if IndexFieldType specifies the field is of type double. All options are enabled by default.
        var doubleOptions: CloudSearchClientTypes.DoubleOptions?
        /// A string that represents the name of an index field. CloudSearch supports regular index fields as well as dynamic fields. A dynamic field's name defines a pattern that begins or ends with a wildcard. Any document fields that don't map to a regular index field but do match a dynamic field's pattern are configured with the dynamic field's indexing options. Regular field names begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore). Dynamic field names must begin or end with a wildcard (*). The wildcard can also be the only character in a dynamic field name. Multiple wildcards, and wildcards embedded within a string are not supported. The name score is reserved and cannot be used as a field name. To reference a document's ID, you can use the name _id.
        /// This member is required.
        var indexFieldName: Swift.String?
        ...
        /// This member is required.
        var indexFieldType: CloudSearchClientTypes.IndexFieldType?
        /// Options for a field that contains an array of 64-bit signed integers. Present if IndexFieldType specifies the field is of type int-array. All options are enabled by default.
        var intArrayOptions: CloudSearchClientTypes.IntArrayOptions?
        /// Options for a 64-bit signed integer field. Present if IndexFieldType specifies the field is of type int. All options are enabled by default.
        var intOptions: CloudSearchClientTypes.IntOptions?
        /// Options for a latlon field. A latlon field contains a location stored as a latitude and longitude value pair. Present if IndexFieldType specifies the field is of type latlon. All options are enabled by default.
        var latLonOptions: CloudSearchClientTypes.LatLonOptions?
        /// Options for a field that contains an array of literal strings. Present if IndexFieldType specifies the field is of type literal-array. All options are enabled by default.
        var literalArrayOptions: CloudSearchClientTypes.LiteralArrayOptions?
        /// Options for literal field. Present if IndexFieldType specifies the field is of type literal. All options are enabled by default.
        var literalOptions: CloudSearchClientTypes.LiteralOptions?
        /// Options for a field that contains an array of text strings. Present if IndexFieldType specifies the field is of type text-array. A text-array field is always searchable. All options are enabled by default.
        var textArrayOptions: CloudSearchClientTypes.TextArrayOptions?
        /// Options for text field. Present if IndexFieldType specifies the field is of type text. A text field is always searchable. All options are enabled by default.
        var textOptions: CloudSearchClientTypes.TextOptions?
...
extension CloudSearchClientTypes {
    ...
    public struct IndexFieldStatus: Swift.Equatable {
        /// Configuration information for a field in the index, including its name, type, and options. The supported options depend on the [IndexFieldType].
        /// This member is required.
        var options: CloudSearchClientTypes.IndexField?
        /// The status of domain configuration option.
        /// This member is required.
        var status: CloudSearchClientTypes.OptionStatus?
...
extension CloudSearchClientTypes {
    public struct Limits: Swift.Equatable {
        /// This member is required.
        var maximumPartitionCount: Swift.Int
        /// This member is required.
        var maximumReplicationCount: Swift.Int
...
public struct ListDomainNamesOutputResponse: Swift.Equatable {
    ...
    var domainNames: [Swift.String:Swift.String]?
...
extension CloudSearchClientTypes {
    ...
    public struct OptionStatus: Swift.Equatable {
        ...
        /// * FailedToValidate: the option value is not compatible with the domain's data and cannot be used to index the data. You must either modify the option value or update or remove the incompatible documents.
        /// This member is required.
        var state: CloudSearchClientTypes.OptionState?
...
extension CloudSearchClientTypes {
    ...
    public struct ScalingParameters: Swift.Equatable {
        ...
        var desiredInstanceType: CloudSearchClientTypes.PartitionInstanceType?
        /// The number of partitions you want to preconfigure for your domain. Only valid when you select m2.2xlarge as the desired instance type.
        var desiredPartitionCount: Swift.Int
        /// The number of replicas you want to preconfigure for each index partition.
        var desiredReplicationCount: Swift.Int
...
extension CloudSearchClientTypes {
    ...
    public struct ScalingParametersStatus: Swift.Equatable {
        /// The desired instance type and desired number of replicas of each index partition.
        /// This member is required.
        var options: CloudSearchClientTypes.ScalingParameters?
        /// The status of domain configuration option.
        /// This member is required.
        var status: CloudSearchClientTypes.OptionStatus?
...
extension CloudSearchClientTypes {
    ...
    public struct Suggester: Swift.Equatable {
        /// Options for a search suggester.
        /// This member is required.
        var documentSuggesterOptions: CloudSearchClientTypes.DocumentSuggesterOptions?
        /// Names must begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore).
        /// This member is required.
        var suggesterName: Swift.String?
...
extension CloudSearchClientTypes {
    ...
    public struct SuggesterStatus: Swift.Equatable {
        /// Configuration information for a search suggester. Each suggester has a unique name and specifies the text field you want to use for suggestions. The following options can be configured for a suggester: FuzzyMatching, SortExpression.
        /// This member is required.
        var options: CloudSearchClientTypes.Suggester?
        /// The status of domain configuration option.
        /// This member is required.
        var status: CloudSearchClientTypes.OptionStatus?
...
extension CloudSearchClientTypes {
    ...
    public struct TextArrayOptions: Swift.Equatable {
        ...
        var analysisScheme: Swift.String?
        /// A value to use for the field if the field isn't specified for a document.
        var defaultValue: Swift.String?
        /// Whether highlights can be returned for the field.
        var highlightEnabled: Swift.Bool?
        /// Whether the contents of the field can be returned in the search results.
        var returnEnabled: Swift.Bool?
        /// A list of source fields to map to the field.
        var sourceFields: Swift.String?
...
public struct UpdateDomainEndpointOptionsInput: Swift.Equatable {
    ...
    /// This member is required.
    var domainEndpointOptions: CloudSearchClientTypes.DomainEndpointOptions?
    /// A string that represents the name of a domain.
    /// This member is required.
    var domainName: Swift.String?
...
public struct UpdateScalingParametersInput: Swift.Equatable {
    ...
    /// The desired instance type and desired number of replicas of each index partition.
    /// This member is required.
    var scalingParameters: CloudSearchClientTypes.ScalingParameters?
