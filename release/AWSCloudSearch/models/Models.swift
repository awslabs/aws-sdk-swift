...
extension CloudSearchClientTypes {
    ...
    public struct AccessPoliciesStatus: Swift.Equatable {
        /// Access rules for a domain's document or search service endpoints. For more information, see <a href="http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-access.html" target="_blank">Configuring Access for a Search Domain in the Amazon CloudSearch Developer Guide. The maximum size of a policy document is 100 KB.
...
///       report an issue from the <a href="http://status.aws.amazon.com/" target="_blank">Service Health Dashboard.
