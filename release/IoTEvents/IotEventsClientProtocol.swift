...
public protocol IotEventsClientProtocol {
    ...
    func createAlarmModel(input: CreateAlarmModelInput, completion: @escaping (SdkResult<CreateAlarmModelOutputResponse, CreateAlarmModelOutputError>) -> Void)
    /// <p>Creates a detector model.</p>
    func createDetectorModel(input: CreateDetectorModelInput, completion: @escaping (SdkResult<CreateDetectorModelOutputResponse, CreateDetectorModelOutputError>) -> Void)
    ...
    func deleteAlarmModel(input: DeleteAlarmModelInput, completion: @escaping (SdkResult<DeleteAlarmModelOutputResponse, DeleteAlarmModelOutputError>) -> Void)
    /// <p>Deletes a detector model. Any active instances of the detector model are also
    ///       deleted.</p>
    func deleteDetectorModel(input: DeleteDetectorModelInput, completion: @escaping (SdkResult<DeleteDetectorModelOutputResponse, DeleteDetectorModelOutputError>) -> Void)
    ...
    func describeAlarmModel(input: DescribeAlarmModelInput, completion: @escaping (SdkResult<DescribeAlarmModelOutputResponse, DescribeAlarmModelOutputError>) -> Void)
    ...
    func describeDetectorModel(input: DescribeDetectorModelInput, completion: @escaping (SdkResult<DescribeDetectorModelOutputResponse, DescribeDetectorModelOutputError>) -> Void)
    ...
    ///          </note>
    func describeDetectorModelAnalysis(input: DescribeDetectorModelAnalysisInput, completion: @escaping (SdkResult<DescribeDetectorModelAnalysisOutputResponse, DescribeDetectorModelAnalysisOutputError>) -> Void)
    ...
    ///             <p>After AWS IoT Events starts analyzing your detector model, you have up to 24 hours to retrieve the analysis results.</p>
    ///          </note>
    func getDetectorModelAnalysisResults(input: GetDetectorModelAnalysisResultsInput, completion: @escaping (SdkResult<GetDetectorModelAnalysisResultsOutputResponse, GetDetectorModelAnalysisResultsOutputError>) -> Void)
    /// <p>Lists the alarm models that you created. The operation returns only the metadata
    ///       associated with each alarm model.</p>
    func listAlarmModels(input: ListAlarmModelsInput, completion: @escaping (SdkResult<ListAlarmModelsOutputResponse, ListAlarmModelsOutputError>) -> Void)
    ...
    func listAlarmModelVersions(input: ListAlarmModelVersionsInput, completion: @escaping (SdkResult<ListAlarmModelVersionsOutputResponse, ListAlarmModelVersionsOutputError>) -> Void)
    /// <p>Lists the detector models you have created. Only the metadata associated with each
    ///       detector model is returned.</p>
    func listDetectorModels(input: ListDetectorModelsInput, completion: @escaping (SdkResult<ListDetectorModelsOutputResponse, ListDetectorModelsOutputError>) -> Void)
    /// <p>Lists all the versions of a detector model. Only the metadata associated with each
    ///       detector model version is returned.</p>
    func listDetectorModelVersions(input: ListDetectorModelVersionsInput, completion: @escaping (SdkResult<ListDetectorModelVersionsOutputResponse, ListDetectorModelVersionsOutputError>) -> Void)
    /// <p>
    ///       Lists one or more input routings.
    ///     </p>
    func listInputRoutings(input: ListInputRoutingsInput, completion: @escaping (SdkResult<ListInputRoutingsOutputResponse, ListInputRoutingsOutputError>) -> Void)
    ...
    func startDetectorModelAnalysis(input: StartDetectorModelAnalysisInput, completion: @escaping (SdkResult<StartDetectorModelAnalysisOutputResponse, StartDetectorModelAnalysisOutputError>) -> Void)
    ...
    func updateAlarmModel(input: UpdateAlarmModelInput, completion: @escaping (SdkResult<UpdateAlarmModelOutputResponse, UpdateAlarmModelOutputError>) -> Void)
    ...
    func updateDetectorModel(input: UpdateDetectorModelInput, completion: @escaping (SdkResult<UpdateDetectorModelOutputResponse, UpdateDetectorModelOutputError>) -> Void)
