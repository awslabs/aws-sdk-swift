...
public class IotEventsClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try IotEventsClientConfiguration(region: unwrappedRegion)
    ...
    public class IotEventsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("IotEventsClient")
...
public struct IotEventsClientLogHandlerFactory: SDKLogHandlerFactory {
