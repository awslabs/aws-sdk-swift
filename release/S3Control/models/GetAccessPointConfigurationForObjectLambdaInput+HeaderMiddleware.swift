...
public struct GetAccessPointConfigurationForObjectLambdaInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetAccessPointConfigurationForObjectLambdaOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetAccessPointConfigurationForObjectLambdaOutput>
