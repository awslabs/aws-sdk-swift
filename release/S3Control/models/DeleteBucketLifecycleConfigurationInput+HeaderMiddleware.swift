...
public struct DeleteBucketLifecycleConfigurationInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DeleteBucketLifecycleConfigurationOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DeleteBucketLifecycleConfigurationOutput>
