...
extension S3ControlClientTypes.AbortIncompleteMultipartUpload: Swift.Codable, ClientRuntime.Reflection {
...
extension S3ControlClientTypes.AbortIncompleteMultipartUpload: Swift.CustomDebugStringConvertible {
...
extension S3ControlClientTypes.AccessPoint: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.AccessPoint: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AccessPoint(accessPointArn: \(Swift.String(describing: accessPointArn)), bucket: \(Swift.String(describing: bucket)), name: \(Swift.String(describing: name)), networkOrigin: \(Swift.String(describing: networkOrigin)), vpcConfiguration: \(Swift.String(describing: vpcConfiguration)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct AccessPoint: Swift.Equatable {
        ...
        ///          policies.</p>
        public let networkOrigin: S3ControlClientTypes.NetworkOrigin?
        ...
        ///          </note>
        public let vpcConfiguration: S3ControlClientTypes.VpcConfiguration?
...
extension S3ControlClientTypes.AccountLevel: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.AccountLevel: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AccountLevel(activityMetrics: \(Swift.String(describing: activityMetrics)), bucketLevel: \(Swift.String(describing: bucketLevel)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct AccountLevel: Swift.Equatable {
        ...
        public let activityMetrics: S3ControlClientTypes.ActivityMetrics?
        /// <p>A container for the S3 Storage Lens bucket-level configuration.</p>
        public let bucketLevel: S3ControlClientTypes.BucketLevel?
...
extension S3ControlClientTypes.ActivityMetrics: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.ActivityMetrics: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ActivityMetrics(isEnabled: \(Swift.String(describing: isEnabled)))"}
}
...
extension S3ControlClientTypes.AwsLambdaTransformation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.AwsLambdaTransformation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AwsLambdaTransformation(functionArn: \(Swift.String(describing: functionArn)), functionPayload: \(Swift.String(describing: functionPayload)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct AwsLambdaTransformation: Swift.Equatable {
        ...
        public let functionPayload: Swift.String?
...
extension S3ControlClientTypes.BucketLevel: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case activityMetrics = "ActivityMetrics"
...
extension S3ControlClientTypes.BucketLevel: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BucketLevel(activityMetrics: \(Swift.String(describing: activityMetrics)), prefixLevel: \(Swift.String(describing: prefixLevel)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct BucketLevel: Swift.Equatable {
        ...
        public let prefixLevel: S3ControlClientTypes.PrefixLevel?
...
public struct CreateAccessPointForObjectLambdaInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAccessPointForObjectLambdaInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateAccessPointForObjectLambdaInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateAccessPointForObjectLambdaOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateAccessPointForObjectLambdaInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateAccessPointForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateAccessPointForObjectLambdaOutputError>
}

extension CreateAccessPointForObjectLambdaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAccessPointForObjectLambdaInput(accountId: \(Swift.String(describing: accountId)), configuration: \(Swift.String(describing: configuration)), name: \(Swift.String(describing: name)))"}
}
...
extension CreateAccessPointForObjectLambdaInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateAccessPointForObjectLambdaInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAccessPointForObjectLambdaInputHeadersMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        if let accountId = input.operationInput.accountId {
            input.builder.withHeader(name: "x-amz-account-id", value: Swift.String(accountId))
        }
        return next.handle(context: context, input: input)
    }
...
public struct CreateAccessPointForObjectLambdaInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAccessPointForObjectLambdaInputQueryItemMiddleware"
...
public struct CreateAccessPointForObjectLambdaInput: Swift.Equatable {
    ...
    public let configuration: S3ControlClientTypes.ObjectLambdaConfiguration?
...
extension CreateAccessPointForObjectLambdaOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAccessPointForObjectLambdaOutputResponse(objectLambdaAccessPointArn: \(Swift.String(describing: objectLambdaAccessPointArn)))"}
}
...
public struct CreateAccessPointForObjectLambdaOutputResponse: Swift.Equatable {
    ...
    public let objectLambdaAccessPointArn: Swift.String?
...
extension CreateAccessPointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAccessPointInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)), name: \(Swift.String(describing: name)), publicAccessBlockConfiguration: \(Swift.String(describing: publicAccessBlockConfiguration)), vpcConfiguration: \(Swift.String(describing: vpcConfiguration)))"}
}
...
public struct CreateAccessPointInput: Swift.Equatable {
    ...
    ///       </p>
    public let publicAccessBlockConfiguration: S3ControlClientTypes.PublicAccessBlockConfiguration?
...
extension CreateAccessPointOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAccessPointOutputResponse(accessPointArn: \(Swift.String(describing: accessPointArn)))"}
}
...
extension S3ControlClientTypes.CreateBucketConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.CreateBucketConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3ControlClientTypes {
    ...
    public struct CreateBucketConfiguration: Swift.Equatable {
        ...
        ///             <p>This is not supported by Amazon S3 on Outposts buckets.</p>
        ///          </note>
        public let locationConstraint: S3ControlClientTypes.BucketLocationConstraint?
...
public struct CreateBucketInputHeadersMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        if let outpostId = input.operationInput.outpostId {
            input.builder.withHeader(name: "x-amz-outpost-id", value: Swift.String(outpostId))
        }
        return next.handle(context: context, input: input)
    }
...
public struct CreateBucketInput: Swift.Equatable {
    ...
    ///             <p>This is not supported by Amazon S3 on Outposts buckets.</p>
    ///          </note>
    public let aCL: S3ControlClientTypes.BucketCannedACL?
    ...
    ///             <p>This is not supported by Amazon S3 on Outposts buckets.</p>
    ///          </note>
    public let createBucketConfiguration: S3ControlClientTypes.CreateBucketConfiguration?
...
extension CreateBucketOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateBucketOutputResponse(bucketArn: \(Swift.String(describing: bucketArn)), location: \(Swift.String(describing: location)))"}
}
...
extension CreateJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateJobInput(accountId: \(Swift.String(describing: accountId)), clientRequestToken: \(Swift.String(describing: clientRequestToken)), confirmationRequired: \(Swift.String(describing: confirmationRequired)), description: \(Swift.String(describing: description)), manifest: \(Swift.String(describing: manifest)), operation: \(Swift.String(describing: operation)), priority: \(Swift.String(describing: priority)), report: \(Swift.String(describing: report)), roleArn: \(Swift.String(describing: roleArn)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct CreateJobInput: Swift.Equatable {
    ...
    public let manifest: S3ControlClientTypes.JobManifest?
    ...
    public let operation: S3ControlClientTypes.JobOperation?
    ...
    public let report: S3ControlClientTypes.JobReport?
    ...
    public let tags: [S3ControlClientTypes.S3Tag]?
...
extension DeleteAccessPointForObjectLambdaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteAccessPointForObjectLambdaInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension DeleteAccessPointForObjectLambdaInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteAccessPointForObjectLambdaInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointForObjectLambdaInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteAccessPointForObjectLambdaInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteAccessPointForObjectLambdaOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteAccessPointForObjectLambdaInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteAccessPointForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteAccessPointForObjectLambdaOutputError>
}

public struct DeleteAccessPointForObjectLambdaInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointForObjectLambdaInputQueryItemMiddleware"
...
extension DeleteAccessPointForObjectLambdaOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteAccessPointForObjectLambdaOutputResponseBody: Swift.Equatable {
}

extension DeleteAccessPointForObjectLambdaOutputResponseBody: Swift.Decodable {
...
extension DeleteAccessPointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteAccessPointInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}
...
extension DeleteAccessPointPolicyForObjectLambdaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteAccessPointPolicyForObjectLambdaInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension DeleteAccessPointPolicyForObjectLambdaInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteAccessPointPolicyForObjectLambdaInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointPolicyForObjectLambdaInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteAccessPointPolicyForObjectLambdaInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteAccessPointPolicyForObjectLambdaOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteAccessPointPolicyForObjectLambdaInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteAccessPointPolicyForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteAccessPointPolicyForObjectLambdaOutputError>
}

public struct DeleteAccessPointPolicyForObjectLambdaInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointPolicyForObjectLambdaInputQueryItemMiddleware"
...
extension DeleteAccessPointPolicyForObjectLambdaOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteAccessPointPolicyForObjectLambdaOutputResponseBody: Swift.Equatable {
}

extension DeleteAccessPointPolicyForObjectLambdaOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension DeleteAccessPointPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteAccessPointPolicyInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension DeleteAccessPointPolicyInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteAccessPointPolicyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointPolicyInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteAccessPointPolicyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteAccessPointPolicyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteAccessPointPolicyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteAccessPointPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteAccessPointPolicyOutputError>
}

public struct DeleteAccessPointPolicyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAccessPointPolicyInputQueryItemMiddleware"
...
extension DeleteAccessPointPolicyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteAccessPointPolicyOutputResponseBody: Swift.Equatable {
}

extension DeleteAccessPointPolicyOutputResponseBody: Swift.Decodable {
...
extension DeleteBucketInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteBucketInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)))"}
}
...
extension DeleteBucketLifecycleConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteBucketLifecycleConfigurationInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)))"}
}

extension DeleteBucketLifecycleConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteBucketLifecycleConfigurationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteBucketLifecycleConfigurationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteBucketLifecycleConfigurationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteBucketLifecycleConfigurationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteBucketLifecycleConfigurationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteBucketLifecycleConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteBucketLifecycleConfigurationOutputError>
}

public struct DeleteBucketLifecycleConfigurationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteBucketLifecycleConfigurationInputQueryItemMiddleware"
...
extension DeleteBucketLifecycleConfigurationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteBucketLifecycleConfigurationOutputResponseBody: Swift.Equatable {
}

extension DeleteBucketLifecycleConfigurationOutputResponseBody: Swift.Decodable {
...
extension DeleteBucketPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteBucketPolicyInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)))"}
}
...
extension DeleteBucketTaggingInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteBucketTaggingInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)))"}
}
...
extension DeleteJobTaggingInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteJobTaggingInput(accountId: \(Swift.String(describing: accountId)), jobId: \(Swift.String(describing: jobId)))"}
}

extension DeleteJobTaggingInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteJobTaggingInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteJobTaggingInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteJobTaggingInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteJobTaggingOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteJobTaggingInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteJobTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteJobTaggingOutputError>
}

public struct DeleteJobTaggingInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteJobTaggingInputQueryItemMiddleware"
...
extension DeleteJobTaggingOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteJobTaggingOutputResponseBody: Swift.Equatable {
}

extension DeleteJobTaggingOutputResponseBody: Swift.Decodable {
...
extension DeletePublicAccessBlockInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeletePublicAccessBlockInput(accountId: \(Swift.String(describing: accountId)))"}
}
...
extension DeleteStorageLensConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteStorageLensConfigurationInput(accountId: \(Swift.String(describing: accountId)), configId: \(Swift.String(describing: configId)))"}
}

extension DeleteStorageLensConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteStorageLensConfigurationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStorageLensConfigurationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteStorageLensConfigurationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteStorageLensConfigurationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteStorageLensConfigurationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteStorageLensConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteStorageLensConfigurationOutputError>
}

public struct DeleteStorageLensConfigurationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStorageLensConfigurationInputQueryItemMiddleware"
...
extension DeleteStorageLensConfigurationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteStorageLensConfigurationOutputResponseBody: Swift.Equatable {
}

extension DeleteStorageLensConfigurationOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension DeleteStorageLensConfigurationTaggingInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteStorageLensConfigurationTaggingInput(accountId: \(Swift.String(describing: accountId)), configId: \(Swift.String(describing: configId)))"}
}

extension DeleteStorageLensConfigurationTaggingInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteStorageLensConfigurationTaggingInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStorageLensConfigurationTaggingInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteStorageLensConfigurationTaggingInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteStorageLensConfigurationTaggingOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteStorageLensConfigurationTaggingInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteStorageLensConfigurationTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteStorageLensConfigurationTaggingOutputError>
}

public struct DeleteStorageLensConfigurationTaggingInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStorageLensConfigurationTaggingInputQueryItemMiddleware"
...
extension DeleteStorageLensConfigurationTaggingOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteStorageLensConfigurationTaggingOutputResponseBody: Swift.Equatable {
}

extension DeleteStorageLensConfigurationTaggingOutputResponseBody: Swift.Decodable {
...
extension DescribeJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeJobInput(accountId: \(Swift.String(describing: accountId)), jobId: \(Swift.String(describing: jobId)))"}
}
...
extension DescribeJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeJobOutputResponse(job: \(Swift.String(describing: job)))"}
}
...
public struct DescribeJobOutputResponse: Swift.Equatable {
    ...
    public let job: S3ControlClientTypes.JobDescriptor?
...
extension S3ControlClientTypes.Exclude: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.Exclude: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Exclude(buckets: \(Swift.String(describing: buckets)), regions: \(Swift.String(describing: regions)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct Exclude: Swift.Equatable {
        ...
        public let buckets: [Swift.String]?
...
extension GetAccessPointConfigurationForObjectLambdaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointConfigurationForObjectLambdaInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension GetAccessPointConfigurationForObjectLambdaInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetAccessPointConfigurationForObjectLambdaInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointConfigurationForObjectLambdaInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAccessPointConfigurationForObjectLambdaInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAccessPointConfigurationForObjectLambdaOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAccessPointConfigurationForObjectLambdaInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointConfigurationForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointConfigurationForObjectLambdaOutputError>
}

public struct GetAccessPointConfigurationForObjectLambdaInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointConfigurationForObjectLambdaInputQueryItemMiddleware"
...
extension GetAccessPointConfigurationForObjectLambdaOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointConfigurationForObjectLambdaOutputResponse(configuration: \(Swift.String(describing: configuration)))"}
}
...
extension GetAccessPointForObjectLambdaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointForObjectLambdaInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension GetAccessPointForObjectLambdaInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetAccessPointForObjectLambdaInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointForObjectLambdaInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAccessPointForObjectLambdaInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAccessPointForObjectLambdaOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAccessPointForObjectLambdaInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointForObjectLambdaOutputError>
}

public struct GetAccessPointForObjectLambdaInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointForObjectLambdaInputQueryItemMiddleware"
...
extension GetAccessPointForObjectLambdaOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointForObjectLambdaOutputResponse(creationDate: \(Swift.String(describing: creationDate)), name: \(Swift.String(describing: name)), publicAccessBlockConfiguration: \(Swift.String(describing: publicAccessBlockConfiguration)))"}
}
...
extension GetAccessPointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension GetAccessPointInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetAccessPointInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAccessPointInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAccessPointOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAccessPointInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointOutputError>
}

public struct GetAccessPointInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointInputQueryItemMiddleware"
...
extension GetAccessPointOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointOutputResponse(bucket: \(Swift.String(describing: bucket)), creationDate: \(Swift.String(describing: creationDate)), name: \(Swift.String(describing: name)), networkOrigin: \(Swift.String(describing: networkOrigin)), publicAccessBlockConfiguration: \(Swift.String(describing: publicAccessBlockConfiguration)), vpcConfiguration: \(Swift.String(describing: vpcConfiguration)))"}
}
...
extension GetAccessPointPolicyForObjectLambdaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointPolicyForObjectLambdaInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension GetAccessPointPolicyForObjectLambdaInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetAccessPointPolicyForObjectLambdaInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyForObjectLambdaInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAccessPointPolicyForObjectLambdaInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAccessPointPolicyForObjectLambdaOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAccessPointPolicyForObjectLambdaInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointPolicyForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointPolicyForObjectLambdaOutputError>
}

public struct GetAccessPointPolicyForObjectLambdaInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyForObjectLambdaInputQueryItemMiddleware"
...
extension GetAccessPointPolicyForObjectLambdaOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointPolicyForObjectLambdaOutputResponse(policy: \(Swift.String(describing: policy)))"}
}
...
extension GetAccessPointPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointPolicyInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension GetAccessPointPolicyInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetAccessPointPolicyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAccessPointPolicyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAccessPointPolicyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAccessPointPolicyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointPolicyOutputError>
}

public struct GetAccessPointPolicyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyInputQueryItemMiddleware"
...
extension GetAccessPointPolicyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointPolicyOutputResponse(policy: \(Swift.String(describing: policy)))"}
}
...
extension GetAccessPointPolicyStatusForObjectLambdaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointPolicyStatusForObjectLambdaInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension GetAccessPointPolicyStatusForObjectLambdaInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetAccessPointPolicyStatusForObjectLambdaInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyStatusForObjectLambdaInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAccessPointPolicyStatusForObjectLambdaInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAccessPointPolicyStatusForObjectLambdaOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAccessPointPolicyStatusForObjectLambdaInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointPolicyStatusForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointPolicyStatusForObjectLambdaOutputError>
}

public struct GetAccessPointPolicyStatusForObjectLambdaInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyStatusForObjectLambdaInputQueryItemMiddleware"
...
extension GetAccessPointPolicyStatusForObjectLambdaOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointPolicyStatusForObjectLambdaOutputResponse(policyStatus: \(Swift.String(describing: policyStatus)))"}
}
...
public struct GetAccessPointPolicyStatusForObjectLambdaOutputResponse: Swift.Equatable {
    ...
    ///       </p>
    public let policyStatus: S3ControlClientTypes.PolicyStatus?
...
extension GetAccessPointPolicyStatusInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointPolicyStatusInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)))"}
}

extension GetAccessPointPolicyStatusInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetAccessPointPolicyStatusInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyStatusInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAccessPointPolicyStatusInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAccessPointPolicyStatusOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAccessPointPolicyStatusInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAccessPointPolicyStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAccessPointPolicyStatusOutputError>
}

public struct GetAccessPointPolicyStatusInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAccessPointPolicyStatusInputQueryItemMiddleware"
...
extension GetAccessPointPolicyStatusOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAccessPointPolicyStatusOutputResponse(policyStatus: \(Swift.String(describing: policyStatus)))"}
}
...
extension GetBucketInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetBucketInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)))"}
}

extension GetBucketInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetBucketInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBucketInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetBucketInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetBucketOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetBucketInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetBucketOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetBucketOutputError>
}

public struct GetBucketInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetBucketInputQueryItemMiddleware"
...
extension GetBucketLifecycleConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetBucketLifecycleConfigurationInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)))"}
}
...
public struct GetBucketLifecycleConfigurationOutputResponse: Swift.Equatable {
    ...
    public let rules: [S3ControlClientTypes.LifecycleRule]?
...
extension GetBucketOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetBucketOutputResponse(bucket: \(Swift.String(describing: bucket)), creationDate: \(Swift.String(describing: creationDate)), publicAccessBlockEnabled: \(Swift.String(describing: publicAccessBlockEnabled)))"}
}
...
public struct GetBucketOutputResponse: Swift.Equatable {
    ...
    public let creationDate: ClientRuntime.Date?
    /// <p></p>
    public let publicAccessBlockEnabled: Swift.Bool
...
extension GetBucketPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetBucketPolicyInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)))"}
}
...
extension GetBucketTaggingInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetBucketTaggingInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)))"}
}
...
public struct GetBucketTaggingOutputResponse: Swift.Equatable {
    ...
    public let tagSet: [S3ControlClientTypes.S3Tag]?
...
extension GetJobTaggingInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetJobTaggingInput(accountId: \(Swift.String(describing: accountId)), jobId: \(Swift.String(describing: jobId)))"}
}

extension GetJobTaggingInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetJobTaggingInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetJobTaggingInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetJobTaggingInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetJobTaggingOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetJobTaggingInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetJobTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetJobTaggingOutputError>
}

public struct GetJobTaggingInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetJobTaggingInputQueryItemMiddleware"
...
extension GetJobTaggingOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetJobTaggingOutputResponse(tags: \(Swift.String(describing: tags)))"}
}
...
extension GetPublicAccessBlockInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetPublicAccessBlockInput(accountId: \(Swift.String(describing: accountId)))"}
}
...
extension GetStorageLensConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetStorageLensConfigurationInput(accountId: \(Swift.String(describing: accountId)), configId: \(Swift.String(describing: configId)))"}
}

extension GetStorageLensConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetStorageLensConfigurationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStorageLensConfigurationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetStorageLensConfigurationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetStorageLensConfigurationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetStorageLensConfigurationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetStorageLensConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetStorageLensConfigurationOutputError>
}

public struct GetStorageLensConfigurationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStorageLensConfigurationInputQueryItemMiddleware"
...
extension GetStorageLensConfigurationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetStorageLensConfigurationOutputResponse(storageLensConfiguration: \(Swift.String(describing: storageLensConfiguration)))"}
}
...
public struct GetStorageLensConfigurationOutputResponse: Swift.Equatable {
    ...
    public let storageLensConfiguration: S3ControlClientTypes.StorageLensConfiguration?
...
extension GetStorageLensConfigurationTaggingInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetStorageLensConfigurationTaggingInput(accountId: \(Swift.String(describing: accountId)), configId: \(Swift.String(describing: configId)))"}
}

extension GetStorageLensConfigurationTaggingInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetStorageLensConfigurationTaggingInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStorageLensConfigurationTaggingInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetStorageLensConfigurationTaggingInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetStorageLensConfigurationTaggingOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetStorageLensConfigurationTaggingInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetStorageLensConfigurationTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetStorageLensConfigurationTaggingOutputError>
}

public struct GetStorageLensConfigurationTaggingInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStorageLensConfigurationTaggingInputQueryItemMiddleware"
...
extension GetStorageLensConfigurationTaggingOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetStorageLensConfigurationTaggingOutputResponse(tags: \(Swift.String(describing: tags)))"}
}
...
public struct GetStorageLensConfigurationTaggingOutputResponse: Swift.Equatable {
    ...
    public let tags: [S3ControlClientTypes.StorageLensTag]?
...
extension IdempotencyException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
/// <p></p>
public struct IdempotencyException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension S3ControlClientTypes.Include: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case buckets = "Buckets"
        case regions = "Regions"
    }
...
extension S3ControlClientTypes.Include: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Include(buckets: \(Swift.String(describing: buckets)), regions: \(Swift.String(describing: regions)))"}
}
...
extension S3ControlClientTypes.JobDescriptor: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case confirmationRequired = "ConfirmationRequired"
...
extension S3ControlClientTypes.JobDescriptor: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobDescriptor(confirmationRequired: \(Swift.String(describing: confirmationRequired)), creationTime: \(Swift.String(describing: creationTime)), description: \(Swift.String(describing: description)), failureReasons: \(Swift.String(describing: failureReasons)), jobArn: \(Swift.String(describing: jobArn)), jobId: \(Swift.String(describing: jobId)), manifest: \(Swift.String(describing: manifest)), operation: \(Swift.String(describing: operation)), priority: \(Swift.String(describing: priority)), progressSummary: \(Swift.String(describing: progressSummary)), report: \(Swift.String(describing: report)), roleArn: \(Swift.String(describing: roleArn)), status: \(Swift.String(describing: status)), statusUpdateReason: \(Swift.String(describing: statusUpdateReason)), suspendedCause: \(Swift.String(describing: suspendedCause)), suspendedDate: \(Swift.String(describing: suspendedDate)), terminationDate: \(Swift.String(describing: terminationDate)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct JobDescriptor: Swift.Equatable {
        ...
        public let failureReasons: [S3ControlClientTypes.JobFailure]?
        ...
        public let progressSummary: S3ControlClientTypes.JobProgressSummary?
        ...
        public let status: S3ControlClientTypes.JobStatus?
        /// <p>The reason for updating the job.</p>
        public let statusUpdateReason: Swift.String?
        ...
        public let suspendedCause: Swift.String?
        /// <p>The timestamp when this job was suspended, if it has been suspended.</p>
        public let suspendedDate: ClientRuntime.Date?
        ...
        public let terminationDate: ClientRuntime.Date?
...
extension S3ControlClientTypes.JobFailure: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.JobFailure: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobFailure(failureCode: \(Swift.String(describing: failureCode)), failureReason: \(Swift.String(describing: failureReason)))"}
}
...
extension S3ControlClientTypes.JobListDescriptor: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case creationTime = "CreationTime"
        case description = "Description"
        case jobId = "JobId"
...
extension S3ControlClientTypes.JobListDescriptor: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobListDescriptor(creationTime: \(Swift.String(describing: creationTime)), description: \(Swift.String(describing: description)), jobId: \(Swift.String(describing: jobId)), operation: \(Swift.String(describing: operation)), priority: \(Swift.String(describing: priority)), progressSummary: \(Swift.String(describing: progressSummary)), status: \(Swift.String(describing: status)), terminationDate: \(Swift.String(describing: terminationDate)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct JobListDescriptor: Swift.Equatable {
        ...
        public let operation: S3ControlClientTypes.OperationName?
...
extension S3ControlClientTypes.JobManifest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.JobManifest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobManifest(location: \(Swift.String(describing: location)), spec: \(Swift.String(describing: spec)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct JobManifest: Swift.Equatable {
        ...
        public let location: S3ControlClientTypes.JobManifestLocation?
        ...
        public let spec: S3ControlClientTypes.JobManifestSpec?
...
extension S3ControlClientTypes.JobManifestLocation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case eTag = "ETag"
...
extension S3ControlClientTypes.JobManifestLocation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobManifestLocation(eTag: \(Swift.String(describing: eTag)), objectArn: \(Swift.String(describing: objectArn)), objectVersionId: \(Swift.String(describing: objectVersionId)))"}
}
...
extension S3ControlClientTypes.JobManifestSpec: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case fields = "Fields"
        case format = "Format"
    }
...
extension S3ControlClientTypes.JobManifestSpec: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobManifestSpec(fields: \(Swift.String(describing: fields)), format: \(Swift.String(describing: format)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct JobManifestSpec: Swift.Equatable {
        ...
        public let fields: [S3ControlClientTypes.JobManifestFieldName]?
        /// <p>Indicates which of the available formats the specified manifest uses.</p>
        public let format: S3ControlClientTypes.JobManifestFormat?
...
extension S3ControlClientTypes.JobOperation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.JobOperation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobOperation(lambdaInvoke: \(Swift.String(describing: lambdaInvoke)), s3DeleteObjectTagging: \(Swift.String(describing: s3DeleteObjectTagging)), s3InitiateRestoreObject: \(Swift.String(describing: s3InitiateRestoreObject)), s3PutObjectAcl: \(Swift.String(describing: s3PutObjectAcl)), s3PutObjectCopy: \(Swift.String(describing: s3PutObjectCopy)), s3PutObjectLegalHold: \(Swift.String(describing: s3PutObjectLegalHold)), s3PutObjectRetention: \(Swift.String(describing: s3PutObjectRetention)), s3PutObjectTagging: \(Swift.String(describing: s3PutObjectTagging)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct JobOperation: Swift.Equatable {
        ...
        ///             <i>Amazon S3 User Guide</i>.</p>
        public let s3PutObjectLegalHold: S3ControlClientTypes.S3SetObjectLegalHoldOperation?
        ...
        ///             <i>Amazon S3 User Guide</i>.</p>
        public let s3PutObjectRetention: S3ControlClientTypes.S3SetObjectRetentionOperation?
        /// <p>Directs the specified job to run a PUT Object tagging call on every object in the manifest.</p>
        public let s3PutObjectTagging: S3ControlClientTypes.S3SetObjectTaggingOperation?
...
extension S3ControlClientTypes.JobProgressSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.JobProgressSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobProgressSummary(numberOfTasksFailed: \(Swift.String(describing: numberOfTasksFailed)), numberOfTasksSucceeded: \(Swift.String(describing: numberOfTasksSucceeded)), totalNumberOfTasks: \(Swift.String(describing: totalNumberOfTasks)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct JobProgressSummary: Swift.Equatable {
        /// <p></p>
        public let numberOfTasksFailed: Swift.Int
        /// <p></p>
        public let numberOfTasksSucceeded: Swift.Int
        /// <p></p>
        public let totalNumberOfTasks: Swift.Int
...
extension S3ControlClientTypes.JobReport: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bucket = "Bucket"
...
extension S3ControlClientTypes.JobReport: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobReport(bucket: \(Swift.String(describing: bucket)), enabled: \(Swift.String(describing: enabled)), format: \(Swift.String(describing: format)), prefix: \(Swift.String(describing: prefix)), reportScope: \(Swift.String(describing: reportScope)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct JobReport: Swift.Equatable {
        ...
        public let format: S3ControlClientTypes.JobReportFormat?
        ...
        public let reportScope: S3ControlClientTypes.JobReportScope?
...
extension JobStatusException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "JobStatusException(message: \(Swift.String(describing: message)))"}
}

extension JobStatusException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
/// <p></p>
public struct JobStatusException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension S3ControlClientTypes.LambdaInvokeOperation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case functionArn = "FunctionArn"
    }
...
extension S3ControlClientTypes.LambdaInvokeOperation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LambdaInvokeOperation(functionArn: \(Swift.String(describing: functionArn)))"}
}
...
extension S3ControlClientTypes.LifecycleConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case rules = "Rules"
    }
...
extension S3ControlClientTypes.LifecycleConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LifecycleConfiguration(rules: \(Swift.String(describing: rules)))"}
}
...
extension S3ControlClientTypes.LifecycleExpiration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case date = "Date"
        case days = "Days"
...
extension S3ControlClientTypes.LifecycleExpiration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3ControlClientTypes.LifecycleRule: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes {
    ...
    public struct LifecycleRule: Swift.Equatable {
        ...
        ///             <i>Amazon S3 User Guide</i>.</p>
        public let abortIncompleteMultipartUpload: S3ControlClientTypes.AbortIncompleteMultipartUpload?
        ...
        public let expiration: S3ControlClientTypes.LifecycleExpiration?
        /// <p>The container for the filter of lifecycle rule.</p>
        public let filter: S3ControlClientTypes.LifecycleRuleFilter?
        ...
        ///             <p>This is not supported by Amazon S3 on Outposts buckets.</p>
        ///          </note>
        public let noncurrentVersionExpiration: S3ControlClientTypes.NoncurrentVersionExpiration?
        ...
        ///             <p>This is not supported by Amazon S3 on Outposts buckets.</p>
        ///          </note>
        public let noncurrentVersionTransitions: [S3ControlClientTypes.NoncurrentVersionTransition]?
        /// <p>If 'Enabled', the rule is currently being applied. If 'Disabled', the rule is not currently being applied.</p>
        public let status: S3ControlClientTypes.ExpirationStatus?
        /// <p>Specifies when an Amazon S3 object transitions to a specified storage class.</p>
        ///          <note>
        ///             <p>This is not supported by Amazon S3 on Outposts buckets.</p>
        ///          </note>
        public let transitions: [S3ControlClientTypes.Transition]?
...
extension S3ControlClientTypes.LifecycleRuleAndOperator: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case prefix = "Prefix"
        case tags = "Tags"
    }
...
extension S3ControlClientTypes.LifecycleRuleAndOperator: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3ControlClientTypes.LifecycleRuleFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case and = "And"
        case prefix = "Prefix"
        case tag = "Tag"
...
extension S3ControlClientTypes.LifecycleRuleFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LifecycleRuleFilter(and: \(Swift.String(describing: and)), prefix: \(Swift.String(describing: prefix)), tag: \(Swift.String(describing: tag)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct LifecycleRuleFilter: Swift.Equatable {
        ...
        public let and: S3ControlClientTypes.LifecycleRuleAndOperator?
        /// <p>Prefix identifying one or more objects to which the rule applies.</p>
        ///          <important>
        ///             <p>Replacement must be made for object keys containing special characters (such as carriage returns) when using
        ///          XML requests. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-keys.html#object-key-xml-related-constraints">
        ...
        public let prefix: Swift.String?
        /// <p></p>
        public let tag: S3ControlClientTypes.S3Tag?
...
extension ListAccessPointsForObjectLambdaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAccessPointsForObjectLambdaInput(accountId: \(Swift.String(describing: accountId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListAccessPointsForObjectLambdaInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListAccessPointsForObjectLambdaInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccessPointsForObjectLambdaInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListAccessPointsForObjectLambdaInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListAccessPointsForObjectLambdaOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListAccessPointsForObjectLambdaInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListAccessPointsForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAccessPointsForObjectLambdaOutputError>
}

public struct ListAccessPointsForObjectLambdaInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccessPointsForObjectLambdaInputQueryItemMiddleware"
...
extension ListAccessPointsForObjectLambdaOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAccessPointsForObjectLambdaOutputResponse(nextToken: \(Swift.String(describing: nextToken)), objectLambdaAccessPointList: \(Swift.String(describing: objectLambdaAccessPointList)))"}
}
...
public struct ListAccessPointsForObjectLambdaOutputResponse: Swift.Equatable {
    ...
    public let objectLambdaAccessPointList: [S3ControlClientTypes.ObjectLambdaAccessPoint]?
...
extension ListAccessPointsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAccessPointsInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListAccessPointsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListAccessPointsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccessPointsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListAccessPointsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListAccessPointsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListAccessPointsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListAccessPointsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAccessPointsOutputError>
}

public struct ListAccessPointsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccessPointsInputQueryItemMiddleware"
...
extension ListAccessPointsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAccessPointsOutputResponse(accessPointList: \(Swift.String(describing: accessPointList)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct ListAccessPointsOutputResponse: Swift.Equatable {
    ...
    public let accessPointList: [S3ControlClientTypes.AccessPoint]?
...
extension ListJobsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListJobsInput(accountId: \(Swift.String(describing: accountId)), jobStatuses: \(Swift.String(describing: jobStatuses)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct ListJobsInput: Swift.Equatable {
    ...
    public let jobStatuses: [S3ControlClientTypes.JobStatus]?
...
public struct ListJobsOutputResponse: Swift.Equatable {
    ...
    public let jobs: [S3ControlClientTypes.JobListDescriptor]?
...
extension ListRegionalBucketsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListRegionalBucketsInput(accountId: \(Swift.String(describing: accountId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), outpostId: \(Swift.String(describing: outpostId)))"}
}

extension ListRegionalBucketsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListRegionalBucketsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRegionalBucketsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListRegionalBucketsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListRegionalBucketsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListRegionalBucketsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListRegionalBucketsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRegionalBucketsOutputError>
}

public struct ListRegionalBucketsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRegionalBucketsInputQueryItemMiddleware"
...
extension ListRegionalBucketsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListRegionalBucketsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), regionalBucketList: \(Swift.String(describing: regionalBucketList)))"}
}
...
public struct ListRegionalBucketsOutputResponse: Swift.Equatable {
    ...
    public let nextToken: Swift.String?
    /// <p></p>
    public let regionalBucketList: [S3ControlClientTypes.RegionalBucket]?
...
extension S3ControlClientTypes.ListStorageLensConfigurationEntry: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.ListStorageLensConfigurationEntry: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListStorageLensConfigurationEntry(homeRegion: \(Swift.String(describing: homeRegion)), id: \(Swift.String(describing: id)), isEnabled: \(Swift.String(describing: isEnabled)), storageLensArn: \(Swift.String(describing: storageLensArn)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct ListStorageLensConfigurationEntry: Swift.Equatable {
        ...
        public let storageLensArn: Swift.String?
...
extension ListStorageLensConfigurationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListStorageLensConfigurationsInput(accountId: \(Swift.String(describing: accountId)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListStorageLensConfigurationsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListStorageLensConfigurationsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStorageLensConfigurationsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListStorageLensConfigurationsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListStorageLensConfigurationsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListStorageLensConfigurationsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListStorageLensConfigurationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListStorageLensConfigurationsOutputError>
}

public struct ListStorageLensConfigurationsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStorageLensConfigurationsInputQueryItemMiddleware"
...
extension ListStorageLensConfigurationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListStorageLensConfigurationsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), storageLensConfigurationList: \(Swift.String(describing: storageLensConfigurationList)))"}
}
...
public struct ListStorageLensConfigurationsOutputResponse: Swift.Equatable {
    ...
    public let storageLensConfigurationList: [S3ControlClientTypes.ListStorageLensConfigurationEntry]?
...
extension NoSuchPublicAccessBlockConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "NoSuchPublicAccessBlockConfiguration(message: \(Swift.String(describing: message)))"}
}

extension NoSuchPublicAccessBlockConfiguration: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct NoSuchPublicAccessBlockConfiguration: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension S3ControlClientTypes.NoncurrentVersionExpiration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.NoncurrentVersionExpiration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3ControlClientTypes.NoncurrentVersionTransition: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case noncurrentDays = "NoncurrentDays"
...
extension S3ControlClientTypes.NoncurrentVersionTransition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3ControlClientTypes {
    ...
    public struct NoncurrentVersionTransition: Swift.Equatable {
        ...
        public let storageClass: S3ControlClientTypes.TransitionStorageClass?
...
extension S3ControlClientTypes.ObjectLambdaAccessPoint: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case objectLambdaAccessPointArn = "ObjectLambdaAccessPointArn"
    }
...
extension S3ControlClientTypes.ObjectLambdaAccessPoint: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ObjectLambdaAccessPoint(name: \(Swift.String(describing: name)), objectLambdaAccessPointArn: \(Swift.String(describing: objectLambdaAccessPointArn)))"}
}
...
extension S3ControlClientTypes.ObjectLambdaConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.ObjectLambdaConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ObjectLambdaConfiguration(allowedFeatures: \(Swift.String(describing: allowedFeatures)), cloudWatchMetricsEnabled: \(Swift.String(describing: cloudWatchMetricsEnabled)), supportingAccessPoint: \(Swift.String(describing: supportingAccessPoint)), transformationConfigurations: \(Swift.String(describing: transformationConfigurations)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct ObjectLambdaConfiguration: Swift.Equatable {
        ...
        public let allowedFeatures: [S3ControlClientTypes.ObjectLambdaAllowedFeature]?
        ...
        public let supportingAccessPoint: Swift.String?
        /// <p>A container for transformation configurations for an Object Lambda Access Point.</p>
        public let transformationConfigurations: [S3ControlClientTypes.ObjectLambdaTransformationConfiguration]?
...
extension S3ControlClientTypes.ObjectLambdaContentTransformation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let awslambdaDecoded = try containerValues.decodeIfPresent(S3ControlClientTypes.AwsLambdaTransformation.self, forKey: .awslambda)
...
extension S3ControlClientTypes.ObjectLambdaTransformationConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.ObjectLambdaTransformationConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ObjectLambdaTransformationConfiguration(actions: \(Swift.String(describing: actions)), contentTransformation: \(Swift.String(describing: contentTransformation)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct ObjectLambdaTransformationConfiguration: Swift.Equatable {
        ...
        public let actions: [S3ControlClientTypes.ObjectLambdaTransformationConfigurationAction]?
        /// <p>A container for the content transformation of an Object Lambda Access Point configuration.</p>
        public let contentTransformation: S3ControlClientTypes.ObjectLambdaContentTransformation?
...
extension S3ControlClientTypes.PolicyStatus: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.PolicyStatus: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3ControlClientTypes.PrefixLevel: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.PrefixLevel: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PrefixLevel(storageMetrics: \(Swift.String(describing: storageMetrics)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct PrefixLevel: Swift.Equatable {
        ...
        public let storageMetrics: S3ControlClientTypes.PrefixLevelStorageMetrics?
...
extension S3ControlClientTypes.PrefixLevelStorageMetrics: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case isEnabled = "IsEnabled"
...
extension S3ControlClientTypes.PrefixLevelStorageMetrics: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PrefixLevelStorageMetrics(isEnabled: \(Swift.String(describing: isEnabled)), selectionCriteria: \(Swift.String(describing: selectionCriteria)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct PrefixLevelStorageMetrics: Swift.Equatable {
        ...
        public let isEnabled: Swift.Bool
        /// <p></p>
        public let selectionCriteria: S3ControlClientTypes.SelectionCriteria?
...
extension S3ControlClientTypes.PublicAccessBlockConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.PublicAccessBlockConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
public struct PutAccessPointConfigurationForObjectLambdaInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointConfigurationForObjectLambdaInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutAccessPointConfigurationForObjectLambdaInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutAccessPointConfigurationForObjectLambdaOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutAccessPointConfigurationForObjectLambdaInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutAccessPointConfigurationForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutAccessPointConfigurationForObjectLambdaOutputError>
}

extension PutAccessPointConfigurationForObjectLambdaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutAccessPointConfigurationForObjectLambdaInput(accountId: \(Swift.String(describing: accountId)), configuration: \(Swift.String(describing: configuration)), name: \(Swift.String(describing: name)))"}
}
...
extension PutAccessPointConfigurationForObjectLambdaInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case configuration = "Configuration"
    }
...
public struct PutAccessPointConfigurationForObjectLambdaInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointConfigurationForObjectLambdaInputHeadersMiddleware"
...
public struct PutAccessPointConfigurationForObjectLambdaInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointConfigurationForObjectLambdaInputQueryItemMiddleware"
...
extension PutAccessPointConfigurationForObjectLambdaOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct PutAccessPointConfigurationForObjectLambdaOutputResponseBody: Swift.Equatable {
}

extension PutAccessPointConfigurationForObjectLambdaOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct PutAccessPointPolicyForObjectLambdaInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointPolicyForObjectLambdaInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutAccessPointPolicyForObjectLambdaInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutAccessPointPolicyForObjectLambdaOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutAccessPointPolicyForObjectLambdaInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutAccessPointPolicyForObjectLambdaOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutAccessPointPolicyForObjectLambdaOutputError>
}

extension PutAccessPointPolicyForObjectLambdaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutAccessPointPolicyForObjectLambdaInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)), policy: \(Swift.String(describing: policy)))"}
}
...
extension PutAccessPointPolicyForObjectLambdaInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case policy = "Policy"
    }
...
public struct PutAccessPointPolicyForObjectLambdaInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointPolicyForObjectLambdaInputHeadersMiddleware"
...
public struct PutAccessPointPolicyForObjectLambdaInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointPolicyForObjectLambdaInputQueryItemMiddleware"
...
extension PutAccessPointPolicyForObjectLambdaOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct PutAccessPointPolicyForObjectLambdaOutputResponseBody: Swift.Equatable {
}

extension PutAccessPointPolicyForObjectLambdaOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct PutAccessPointPolicyInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointPolicyInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutAccessPointPolicyInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutAccessPointPolicyOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutAccessPointPolicyInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutAccessPointPolicyOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutAccessPointPolicyOutputError>
}

extension PutAccessPointPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutAccessPointPolicyInput(accountId: \(Swift.String(describing: accountId)), name: \(Swift.String(describing: name)), policy: \(Swift.String(describing: policy)))"}
}
...
extension PutAccessPointPolicyInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case policy = "Policy"
    }
...
public struct PutAccessPointPolicyInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointPolicyInputHeadersMiddleware"
...
public struct PutAccessPointPolicyInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutAccessPointPolicyInputQueryItemMiddleware"
...
extension PutAccessPointPolicyOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct PutAccessPointPolicyOutputResponseBody: Swift.Equatable {
}

extension PutAccessPointPolicyOutputResponseBody: Swift.Decodable {
...
extension PutBucketLifecycleConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutBucketLifecycleConfigurationInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)), lifecycleConfiguration: \(Swift.String(describing: lifecycleConfiguration)))"}
}
...
public struct PutBucketLifecycleConfigurationInput: Swift.Equatable {
    ...
    public let lifecycleConfiguration: S3ControlClientTypes.LifecycleConfiguration?
...
extension PutBucketPolicyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutBucketPolicyInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)), confirmRemoveSelfBucketAccess: \(Swift.String(describing: confirmRemoveSelfBucketAccess)), policy: \(Swift.String(describing: policy)))"}
}
...
extension PutBucketTaggingInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutBucketTaggingInput(accountId: \(Swift.String(describing: accountId)), bucket: \(Swift.String(describing: bucket)), tagging: \(Swift.String(describing: tagging)))"}
}
...
public struct PutBucketTaggingInput: Swift.Equatable {
    ...
    public let bucket: Swift.String?
    /// <p></p>
    public let tagging: S3ControlClientTypes.Tagging?
...
public struct PutJobTaggingInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutJobTaggingInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutJobTaggingInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutJobTaggingOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutJobTaggingInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutJobTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutJobTaggingOutputError>
}

extension PutJobTaggingInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutJobTaggingInput(accountId: \(Swift.String(describing: accountId)), jobId: \(Swift.String(describing: jobId)), tags: \(Swift.String(describing: tags)))"}
}
...
extension PutJobTaggingInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case tags = "Tags"
    }
...
public struct PutJobTaggingInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutJobTaggingInputHeadersMiddleware"
...
public struct PutJobTaggingInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutJobTaggingInputQueryItemMiddleware"
...
extension PutJobTaggingOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct PutJobTaggingOutputResponseBody: Swift.Equatable {
}

extension PutJobTaggingOutputResponseBody: Swift.Decodable {
...
extension PutPublicAccessBlockInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutPublicAccessBlockInput(accountId: \(Swift.String(describing: accountId)), publicAccessBlockConfiguration: \(Swift.String(describing: publicAccessBlockConfiguration)))"}
}
...
public struct PutStorageLensConfigurationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStorageLensConfigurationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutStorageLensConfigurationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutStorageLensConfigurationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutStorageLensConfigurationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutStorageLensConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutStorageLensConfigurationOutputError>
}

extension PutStorageLensConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutStorageLensConfigurationInput(accountId: \(Swift.String(describing: accountId)), configId: \(Swift.String(describing: configId)), storageLensConfiguration: \(Swift.String(describing: storageLensConfiguration)), tags: \(Swift.String(describing: tags)))"}
}
...
extension PutStorageLensConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case storageLensConfiguration = "StorageLensConfiguration"
        case tags = "Tags"
    }
...
public struct PutStorageLensConfigurationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStorageLensConfigurationInputHeadersMiddleware"
...
public struct PutStorageLensConfigurationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStorageLensConfigurationInputQueryItemMiddleware"
...
extension PutStorageLensConfigurationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct PutStorageLensConfigurationOutputResponseBody: Swift.Equatable {
}

extension PutStorageLensConfigurationOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct PutStorageLensConfigurationTaggingInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStorageLensConfigurationTaggingInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutStorageLensConfigurationTaggingInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutStorageLensConfigurationTaggingOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutStorageLensConfigurationTaggingInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutStorageLensConfigurationTaggingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutStorageLensConfigurationTaggingOutputError>
}

extension PutStorageLensConfigurationTaggingInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutStorageLensConfigurationTaggingInput(accountId: \(Swift.String(describing: accountId)), configId: \(Swift.String(describing: configId)), tags: \(Swift.String(describing: tags)))"}
}
...
extension PutStorageLensConfigurationTaggingInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case tags = "Tags"
    }
...
public struct PutStorageLensConfigurationTaggingInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStorageLensConfigurationTaggingInputHeadersMiddleware"
...
public struct PutStorageLensConfigurationTaggingInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStorageLensConfigurationTaggingInputQueryItemMiddleware"
...
extension PutStorageLensConfigurationTaggingOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct PutStorageLensConfigurationTaggingOutputResponseBody: Swift.Equatable {
}

extension PutStorageLensConfigurationTaggingOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension S3ControlClientTypes.RegionalBucket: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bucket = "Bucket"
        case bucketArn = "BucketArn"
        case creationDate = "CreationDate"
...
extension S3ControlClientTypes.RegionalBucket: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RegionalBucket(bucket: \(Swift.String(describing: bucket)), bucketArn: \(Swift.String(describing: bucketArn)), creationDate: \(Swift.String(describing: creationDate)), outpostId: \(Swift.String(describing: outpostId)), publicAccessBlockEnabled: \(Swift.String(describing: publicAccessBlockEnabled)))"}
}
...
extension S3ControlClientTypes.S3AccessControlList: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case grants = "Grants"
        case owner = "Owner"
    }
...
extension S3ControlClientTypes.S3AccessControlList: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3AccessControlList(grants: \(Swift.String(describing: grants)), owner: \(Swift.String(describing: owner)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3AccessControlList: Swift.Equatable {
        /// <p></p>
        public let grants: [S3ControlClientTypes.S3Grant]?
        /// <p></p>
        public let owner: S3ControlClientTypes.S3ObjectOwner?
...
extension S3ControlClientTypes.S3AccessControlPolicy: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.S3AccessControlPolicy: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3AccessControlPolicy(accessControlList: \(Swift.String(describing: accessControlList)), cannedAccessControlList: \(Swift.String(describing: cannedAccessControlList)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3AccessControlPolicy: Swift.Equatable {
        /// <p></p>
        public let accessControlList: S3ControlClientTypes.S3AccessControlList?
        /// <p></p>
        public let cannedAccessControlList: S3ControlClientTypes.S3CannedAccessControlList?
...
extension S3ControlClientTypes.S3BucketDestination: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.S3BucketDestination: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3BucketDestination(accountId: \(Swift.String(describing: accountId)), arn: \(Swift.String(describing: arn)), encryption: \(Swift.String(describing: encryption)), format: \(Swift.String(describing: format)), outputSchemaVersion: \(Swift.String(describing: outputSchemaVersion)), prefix: \(Swift.String(describing: prefix)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3BucketDestination: Swift.Equatable {
        ...
        public let encryption: S3ControlClientTypes.StorageLensDataExportEncryption?
        /// <p></p>
        public let format: S3ControlClientTypes.Format?
        /// <p>The schema version of the export file.</p>
        public let outputSchemaVersion: S3ControlClientTypes.OutputSchemaVersion?
...
extension S3ControlClientTypes.S3CopyObjectOperation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.S3CopyObjectOperation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3CopyObjectOperation(accessControlGrants: \(Swift.String(describing: accessControlGrants)), bucketKeyEnabled: \(Swift.String(describing: bucketKeyEnabled)), cannedAccessControlList: \(Swift.String(describing: cannedAccessControlList)), metadataDirective: \(Swift.String(describing: metadataDirective)), modifiedSinceConstraint: \(Swift.String(describing: modifiedSinceConstraint)), newObjectMetadata: \(Swift.String(describing: newObjectMetadata)), newObjectTagging: \(Swift.String(describing: newObjectTagging)), objectLockLegalHoldStatus: \(Swift.String(describing: objectLockLegalHoldStatus)), objectLockMode: \(Swift.String(describing: objectLockMode)), objectLockRetainUntilDate: \(Swift.String(describing: objectLockRetainUntilDate)), redirectLocation: \(Swift.String(describing: redirectLocation)), requesterPays: \(Swift.String(describing: requesterPays)), sSEAwsKmsKeyId: \(Swift.String(describing: sSEAwsKmsKeyId)), storageClass: \(Swift.String(describing: storageClass)), targetKeyPrefix: \(Swift.String(describing: targetKeyPrefix)), targetResource: \(Swift.String(describing: targetResource)), unModifiedSinceConstraint: \(Swift.String(describing: unModifiedSinceConstraint)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3CopyObjectOperation: Swift.Equatable {
        /// <p></p>
        public let accessControlGrants: [S3ControlClientTypes.S3Grant]?
        ...
        public let cannedAccessControlList: S3ControlClientTypes.S3CannedAccessControlList?
        /// <p></p>
        public let metadataDirective: S3ControlClientTypes.S3MetadataDirective?
        /// <p></p>
        public let modifiedSinceConstraint: ClientRuntime.Date?
        /// <p></p>
        public let newObjectMetadata: S3ControlClientTypes.S3ObjectMetadata?
        /// <p></p>
        public let newObjectTagging: [S3ControlClientTypes.S3Tag]?
        /// <p>The legal hold status to be applied to all objects in the Batch Operations job.</p>
        public let objectLockLegalHoldStatus: S3ControlClientTypes.S3ObjectLockLegalHoldStatus?
        /// <p>The retention mode to be applied to all objects in the Batch Operations job.</p>
        public let objectLockMode: S3ControlClientTypes.S3ObjectLockMode?
        ...
        public let redirectLocation: Swift.String?
        /// <p></p>
        public let requesterPays: Swift.Bool
        /// <p></p>
        public let sSEAwsKmsKeyId: Swift.String?
        /// <p></p>
        public let storageClass: S3ControlClientTypes.S3StorageClass?
        ...
        public let targetKeyPrefix: Swift.String?
        ...
        public let targetResource: Swift.String?
        /// <p></p>
        public let unModifiedSinceConstraint: ClientRuntime.Date?
...
extension S3ControlClientTypes.S3DeleteObjectTaggingOperation: Swift.Codable, ClientRuntime.Reflection {
...
extension S3ControlClientTypes.S3DeleteObjectTaggingOperation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3ControlClientTypes.S3Grant: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.S3Grant: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3Grant(grantee: \(Swift.String(describing: grantee)), permission: \(Swift.String(describing: permission)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3Grant: Swift.Equatable {
        /// <p></p>
        public let grantee: S3ControlClientTypes.S3Grantee?
        /// <p></p>
        public let permission: S3ControlClientTypes.S3Permission?
...
extension S3ControlClientTypes.S3Grantee: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.S3Grantee: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3Grantee(displayName: \(Swift.String(describing: displayName)), identifier: \(Swift.String(describing: identifier)), typeIdentifier: \(Swift.String(describing: typeIdentifier)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3Grantee: Swift.Equatable {
        ...
        /// <p></p>
        public let typeIdentifier: S3ControlClientTypes.S3GranteeTypeIdentifier?
...
extension S3ControlClientTypes.S3InitiateRestoreObjectOperation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.S3InitiateRestoreObjectOperation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3InitiateRestoreObjectOperation(expirationInDays: \(Swift.String(describing: expirationInDays)), glacierJobTier: \(Swift.String(describing: glacierJobTier)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3InitiateRestoreObjectOperation: Swift.Equatable {
        ...
        public let glacierJobTier: S3ControlClientTypes.S3GlacierJobTier?
...
extension S3ControlClientTypes.S3ObjectLockLegalHold: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case status = "Status"
    }
...
extension S3ControlClientTypes.S3ObjectLockLegalHold: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3ObjectLockLegalHold(status: \(Swift.String(describing: status)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3ObjectLockLegalHold: Swift.Equatable {
        ...
        public let status: S3ControlClientTypes.S3ObjectLockLegalHoldStatus?
...
extension S3ControlClientTypes.S3ObjectMetadata: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.S3ObjectMetadata: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3ObjectMetadata(cacheControl: \(Swift.String(describing: cacheControl)), contentDisposition: \(Swift.String(describing: contentDisposition)), contentEncoding: \(Swift.String(describing: contentEncoding)), contentLanguage: \(Swift.String(describing: contentLanguage)), contentLength: \(Swift.String(describing: contentLength)), contentMD5: \(Swift.String(describing: contentMD5)), contentType: \(Swift.String(describing: contentType)), httpExpiresDate: \(Swift.String(describing: httpExpiresDate)), requesterCharged: \(Swift.String(describing: requesterCharged)), sSEAlgorithm: \(Swift.String(describing: sSEAlgorithm)), userMetadata: \(Swift.String(describing: userMetadata)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3ObjectMetadata: Swift.Equatable {
        ...
        /// <p></p>
        public let httpExpiresDate: ClientRuntime.Date?
        /// <p></p>
        public let requesterCharged: Swift.Bool
        /// <p></p>
        public let sSEAlgorithm: S3ControlClientTypes.S3SSEAlgorithm?
        /// <p></p>
...
extension S3ControlClientTypes.S3ObjectOwner: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case displayName = "DisplayName"
        case iD = "ID"
    }
...
extension S3ControlClientTypes.S3ObjectOwner: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3ObjectOwner(displayName: \(Swift.String(describing: displayName)), iD: \(Swift.String(describing: iD)))"}
}
...
extension S3ControlClientTypes.S3Retention: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case mode = "Mode"
...
extension S3ControlClientTypes.S3Retention: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3Retention(mode: \(Swift.String(describing: mode)), retainUntilDate: \(Swift.String(describing: retainUntilDate)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3Retention: Swift.Equatable {
        ...
        public let mode: S3ControlClientTypes.S3ObjectLockRetentionMode?
...
extension S3ControlClientTypes.S3SetObjectAclOperation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.S3SetObjectAclOperation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3SetObjectAclOperation(accessControlPolicy: \(Swift.String(describing: accessControlPolicy)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3SetObjectAclOperation: Swift.Equatable {
        /// <p></p>
        public let accessControlPolicy: S3ControlClientTypes.S3AccessControlPolicy?
...
extension S3ControlClientTypes.S3SetObjectLegalHoldOperation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.S3SetObjectLegalHoldOperation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3SetObjectLegalHoldOperation(legalHold: \(Swift.String(describing: legalHold)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3SetObjectLegalHoldOperation: Swift.Equatable {
        ...
        public let legalHold: S3ControlClientTypes.S3ObjectLockLegalHold?
...
extension S3ControlClientTypes.S3SetObjectRetentionOperation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.S3SetObjectRetentionOperation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3SetObjectRetentionOperation(bypassGovernanceRetention: \(Swift.String(describing: bypassGovernanceRetention)), retention: \(Swift.String(describing: retention)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct S3SetObjectRetentionOperation: Swift.Equatable {
        ...
        ///             with S3 Batch Operations</a> in the <i>Amazon S3 User Guide</i>.</p>
        public let retention: S3ControlClientTypes.S3Retention?
...
extension S3ControlClientTypes.S3SetObjectTaggingOperation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case tagSet = "TagSet"
    }
...
extension S3ControlClientTypes.S3SetObjectTaggingOperation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3SetObjectTaggingOperation(tagSet: \(Swift.String(describing: tagSet)))"}
}
...
extension S3ControlClientTypes.S3Tag: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
...
extension S3ControlClientTypes.S3Tag: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3ControlClientTypes.SSEKMS: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case keyId = "KeyId"
    }
...
extension S3ControlClientTypes.SSEKMS: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3ControlClientTypes.SSES3: Swift.Codable, ClientRuntime.Reflection {
...
extension S3ControlClientTypes.SSES3: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SSES3()"}
}
...
extension S3ControlClientTypes.SelectionCriteria: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.SelectionCriteria: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SelectionCriteria(delimiter: \(Swift.String(describing: delimiter)), maxDepth: \(Swift.String(describing: maxDepth)), minStorageBytesPercentage: \(Swift.String(describing: minStorageBytesPercentage)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct SelectionCriteria: Swift.Equatable {
        ...
        ///          </note>
        public let minStorageBytesPercentage: Swift.Double
...
extension S3ControlClientTypes.StorageLensAwsOrg: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
    }
...
extension S3ControlClientTypes.StorageLensAwsOrg: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StorageLensAwsOrg(arn: \(Swift.String(describing: arn)))"}
}
...
extension S3ControlClientTypes.StorageLensConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.StorageLensConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StorageLensConfiguration(accountLevel: \(Swift.String(describing: accountLevel)), awsOrg: \(Swift.String(describing: awsOrg)), dataExport: \(Swift.String(describing: dataExport)), exclude: \(Swift.String(describing: exclude)), id: \(Swift.String(describing: id)), include: \(Swift.String(describing: include)), isEnabled: \(Swift.String(describing: isEnabled)), storageLensArn: \(Swift.String(describing: storageLensArn)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct StorageLensConfiguration: Swift.Equatable {
        ...
        public let exclude: S3ControlClientTypes.Exclude?
        ...
        public let include: S3ControlClientTypes.Include?
...
extension S3ControlClientTypes.StorageLensDataExport: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension S3ControlClientTypes.StorageLensDataExport: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StorageLensDataExport(s3BucketDestination: \(Swift.String(describing: s3BucketDestination)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct StorageLensDataExport: Swift.Equatable {
        ...
        ///          </note>
        public let s3BucketDestination: S3ControlClientTypes.S3BucketDestination?
...
extension S3ControlClientTypes.StorageLensDataExportEncryption: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case sSEKMS = "SSE-KMS"
        case sSES3 = "SSE-S3"
    }
...
extension S3ControlClientTypes.StorageLensDataExportEncryption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StorageLensDataExportEncryption(sSEKMS: \(Swift.String(describing: sSEKMS)), sSES3: \(Swift.String(describing: sSES3)))"}
}
...
extension S3ControlClientTypes {
    ...
    public struct StorageLensDataExportEncryption: Swift.Equatable {
        /// <p></p>
        public let sSEKMS: S3ControlClientTypes.SSEKMS?
        /// <p></p>
        public let sSES3: S3ControlClientTypes.SSES3?
...
extension S3ControlClientTypes.StorageLensTag: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
...
extension S3ControlClientTypes.StorageLensTag: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StorageLensTag(key: \(Swift.String(describing: key)), value: \(Swift.String(describing: value)))"}
}
...
extension S3ControlClientTypes.Tagging: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case tagSet = "TagSet"
    }
...
extension S3ControlClientTypes.Tagging: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension S3ControlClientTypes.Transition: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case date = "Date"
        case days = "Days"
        case storageClass = "StorageClass"
...
extension S3ControlClientTypes.Transition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension UpdateJobPriorityInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateJobPriorityInput(accountId: \(Swift.String(describing: accountId)), jobId: \(Swift.String(describing: jobId)), priority: \(Swift.String(describing: priority)))"}
}

extension UpdateJobPriorityInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct UpdateJobPriorityInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobPriorityInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateJobPriorityInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateJobPriorityOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateJobPriorityInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateJobPriorityOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateJobPriorityOutputError>
}

public struct UpdateJobPriorityInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobPriorityInputQueryItemMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        let priorityQueryItem = ClientRuntime.URLQueryItem(name: "priority".urlPercentEncoding(), value: Swift.String(input.operationInput.priority).urlPercentEncoding())
...
extension UpdateJobPriorityOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateJobPriorityOutputResponse(jobId: \(Swift.String(describing: jobId)), priority: \(Swift.String(describing: priority)))"}
}
...
extension UpdateJobStatusInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateJobStatusInput(accountId: \(Swift.String(describing: accountId)), jobId: \(Swift.String(describing: jobId)), requestedJobStatus: \(Swift.String(describing: requestedJobStatus)), statusUpdateReason: \(Swift.String(describing: statusUpdateReason)))"}
}

extension UpdateJobStatusInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct UpdateJobStatusInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobStatusInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateJobStatusInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateJobStatusOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateJobStatusInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateJobStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateJobStatusOutputError>
}

public struct UpdateJobStatusInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateJobStatusInputQueryItemMiddleware"
...
public struct UpdateJobStatusInput: Swift.Equatable {
    ...
    public let requestedJobStatus: S3ControlClientTypes.RequestedJobStatus?
...
extension UpdateJobStatusOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateJobStatusOutputResponse(jobId: \(Swift.String(describing: jobId)), status: \(Swift.String(describing: status)), statusUpdateReason: \(Swift.String(describing: statusUpdateReason)))"}
}
...
extension S3ControlClientTypes.VpcConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case vpcId = "VpcId"
    }
...
extension S3ControlClientTypes.VpcConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
