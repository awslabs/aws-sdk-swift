...
public struct GetStorageLensConfigurationTaggingInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetStorageLensConfigurationTaggingOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetStorageLensConfigurationTaggingOutput>
