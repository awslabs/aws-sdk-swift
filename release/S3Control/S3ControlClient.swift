...
public class S3ControlClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try S3ControlClientConfiguration(region: unwrappedRegion)
    ...
    public class S3ControlClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("S3ControlClient")
