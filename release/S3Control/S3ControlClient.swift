...
extension S3ControlClient: S3ControlClientProtocol {
    ...
    public func createAccessPoint(input: CreateAccessPointInput, completion: @escaping (SdkResult<CreateAccessPointOutput, CreateAccessPointOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateAccessPointInput, CreateAccessPointOutput, CreateAccessPointOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func createAccessPointForObjectLambda(input: CreateAccessPointForObjectLambdaInput, completion: @escaping (SdkResult<CreateAccessPointForObjectLambdaOutput, CreateAccessPointForObjectLambdaOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateAccessPointForObjectLambdaInput, CreateAccessPointForObjectLambdaOutput, CreateAccessPointForObjectLambdaOutputError>(id: "createAccessPointForObjectLambda")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateAccessPointForObjectLambdaInput, CreateAccessPointForObjectLambdaOutput, CreateAccessPointForObjectLambdaOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func createBucket(input: CreateBucketInput, completion: @escaping (SdkResult<CreateBucketOutput, CreateBucketOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateBucketInput, CreateBucketOutput, CreateBucketOutputError>(id: "createBucket")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateBucketInput, CreateBucketOutput, CreateBucketOutputError>(contentType: "application/xml"))
    ...
    public func createJob(input: CreateJobInput, completion: @escaping (SdkResult<CreateJobOutput, CreateJobOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateJobOutput>, SdkError<CreateJobOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateJobInput, CreateJobOutput, CreateJobOutputError>(contentType: "application/xml"))
    ...
    public func deleteAccessPoint(input: DeleteAccessPointInput, completion: @escaping (SdkResult<DeleteAccessPointOutput, DeleteAccessPointOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteAccessPointInput, DeleteAccessPointOutput, DeleteAccessPointOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func deleteAccessPointForObjectLambda(input: DeleteAccessPointForObjectLambdaInput, completion: @escaping (SdkResult<DeleteAccessPointForObjectLambdaOutput, DeleteAccessPointForObjectLambdaOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteAccessPointForObjectLambdaInput, DeleteAccessPointForObjectLambdaOutput, DeleteAccessPointForObjectLambdaOutputError>(id: "deleteAccessPointForObjectLambda")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteAccessPointForObjectLambdaInput, DeleteAccessPointForObjectLambdaOutput, DeleteAccessPointForObjectLambdaOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func deleteAccessPointPolicy(input: DeleteAccessPointPolicyInput, completion: @escaping (SdkResult<DeleteAccessPointPolicyOutput, DeleteAccessPointPolicyOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteAccessPointPolicyInput, DeleteAccessPointPolicyOutput, DeleteAccessPointPolicyOutputError>(id: "deleteAccessPointPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteAccessPointPolicyInput, DeleteAccessPointPolicyOutput, DeleteAccessPointPolicyOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func deleteAccessPointPolicyForObjectLambda(input: DeleteAccessPointPolicyForObjectLambdaInput, completion: @escaping (SdkResult<DeleteAccessPointPolicyForObjectLambdaOutput, DeleteAccessPointPolicyForObjectLambdaOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteAccessPointPolicyForObjectLambdaInput, DeleteAccessPointPolicyForObjectLambdaOutput, DeleteAccessPointPolicyForObjectLambdaOutputError>(id: "deleteAccessPointPolicyForObjectLambda")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteAccessPointPolicyForObjectLambdaInput, DeleteAccessPointPolicyForObjectLambdaOutput, DeleteAccessPointPolicyForObjectLambdaOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucket(input: DeleteBucketInput, completion: @escaping (SdkResult<DeleteBucketOutput, DeleteBucketOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketInput, DeleteBucketOutput, DeleteBucketOutputError>(id: "deleteBucket")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketInput, DeleteBucketOutput, DeleteBucketOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketLifecycleConfiguration(input: DeleteBucketLifecycleConfigurationInput, completion: @escaping (SdkResult<DeleteBucketLifecycleConfigurationOutput, DeleteBucketLifecycleConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketLifecycleConfigurationInput, DeleteBucketLifecycleConfigurationOutput, DeleteBucketLifecycleConfigurationOutputError>(id: "deleteBucketLifecycleConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketLifecycleConfigurationInput, DeleteBucketLifecycleConfigurationOutput, DeleteBucketLifecycleConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketPolicy(input: DeleteBucketPolicyInput, completion: @escaping (SdkResult<DeleteBucketPolicyOutput, DeleteBucketPolicyOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketPolicyInput, DeleteBucketPolicyOutput, DeleteBucketPolicyOutputError>(id: "deleteBucketPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketPolicyInput, DeleteBucketPolicyOutput, DeleteBucketPolicyOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func deleteBucketTagging(input: DeleteBucketTaggingInput, completion: @escaping (SdkResult<DeleteBucketTaggingOutput, DeleteBucketTaggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketTaggingInput, DeleteBucketTaggingOutput, DeleteBucketTaggingOutputError>(id: "deleteBucketTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketTaggingInput, DeleteBucketTaggingOutput, DeleteBucketTaggingOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func deleteJobTagging(input: DeleteJobTaggingInput, completion: @escaping (SdkResult<DeleteJobTaggingOutput, DeleteJobTaggingOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteJobTaggingInput, DeleteJobTaggingOutput, DeleteJobTaggingOutputError>(id: "deleteJobTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteJobTaggingInput, DeleteJobTaggingOutput, DeleteJobTaggingOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func deletePublicAccessBlock(input: DeletePublicAccessBlockInput, completion: @escaping (SdkResult<DeletePublicAccessBlockOutput, DeletePublicAccessBlockOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeletePublicAccessBlockInput, DeletePublicAccessBlockOutput, DeletePublicAccessBlockOutputError>(id: "deletePublicAccessBlock")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeletePublicAccessBlockInput, DeletePublicAccessBlockOutput, DeletePublicAccessBlockOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          <i>Amazon S3 User Guide</i>.</p>
    ///          </note>
    public func deleteStorageLensConfiguration(input: DeleteStorageLensConfigurationInput, completion: @escaping (SdkResult<DeleteStorageLensConfigurationOutput, DeleteStorageLensConfigurationOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteStorageLensConfigurationInput, DeleteStorageLensConfigurationOutput, DeleteStorageLensConfigurationOutputError>(id: "deleteStorageLensConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteStorageLensConfigurationInput, DeleteStorageLensConfigurationOutput, DeleteStorageLensConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          <i>Amazon S3 User Guide</i>.</p>
    ///          </note>
    public func deleteStorageLensConfigurationTagging(input: DeleteStorageLensConfigurationTaggingInput, completion: @escaping (SdkResult<DeleteStorageLensConfigurationTaggingOutput, DeleteStorageLensConfigurationTaggingOutputError>) -> Void)
    {
        guard let configId = input.configId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component configId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteStorageLensConfigurationTaggingInput, DeleteStorageLensConfigurationTaggingOutput, DeleteStorageLensConfigurationTaggingOutputError>(id: "deleteStorageLensConfigurationTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteStorageLensConfigurationTaggingInput, DeleteStorageLensConfigurationTaggingOutput, DeleteStorageLensConfigurationTaggingOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeJob(input: DescribeJobInput, completion: @escaping (SdkResult<DescribeJobOutput, DescribeJobOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeJobInput, DescribeJobOutput, DescribeJobOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getAccessPoint(input: GetAccessPointInput, completion: @escaping (SdkResult<GetAccessPointOutput, GetAccessPointOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAccessPointInput, GetAccessPointOutput, GetAccessPointOutputError>(id: "getAccessPoint")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAccessPointInput, GetAccessPointOutput, GetAccessPointOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getAccessPointConfigurationForObjectLambda(input: GetAccessPointConfigurationForObjectLambdaInput, completion: @escaping (SdkResult<GetAccessPointConfigurationForObjectLambdaOutput, GetAccessPointConfigurationForObjectLambdaOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAccessPointConfigurationForObjectLambdaInput, GetAccessPointConfigurationForObjectLambdaOutput, GetAccessPointConfigurationForObjectLambdaOutputError>(id: "getAccessPointConfigurationForObjectLambda")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAccessPointConfigurationForObjectLambdaInput, GetAccessPointConfigurationForObjectLambdaOutput, GetAccessPointConfigurationForObjectLambdaOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getAccessPointForObjectLambda(input: GetAccessPointForObjectLambdaInput, completion: @escaping (SdkResult<GetAccessPointForObjectLambdaOutput, GetAccessPointForObjectLambdaOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAccessPointForObjectLambdaInput, GetAccessPointForObjectLambdaOutput, GetAccessPointForObjectLambdaOutputError>(id: "getAccessPointForObjectLambda")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAccessPointForObjectLambdaInput, GetAccessPointForObjectLambdaOutput, GetAccessPointForObjectLambdaOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getAccessPointPolicy(input: GetAccessPointPolicyInput, completion: @escaping (SdkResult<GetAccessPointPolicyOutput, GetAccessPointPolicyOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAccessPointPolicyInput, GetAccessPointPolicyOutput, GetAccessPointPolicyOutputError>(id: "getAccessPointPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAccessPointPolicyInput, GetAccessPointPolicyOutput, GetAccessPointPolicyOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getAccessPointPolicyForObjectLambda(input: GetAccessPointPolicyForObjectLambdaInput, completion: @escaping (SdkResult<GetAccessPointPolicyForObjectLambdaOutput, GetAccessPointPolicyForObjectLambdaOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAccessPointPolicyForObjectLambdaInput, GetAccessPointPolicyForObjectLambdaOutput, GetAccessPointPolicyForObjectLambdaOutputError>(id: "getAccessPointPolicyForObjectLambda")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAccessPointPolicyForObjectLambdaInput, GetAccessPointPolicyForObjectLambdaOutput, GetAccessPointPolicyForObjectLambdaOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getAccessPointPolicyStatus(input: GetAccessPointPolicyStatusInput, completion: @escaping (SdkResult<GetAccessPointPolicyStatusOutput, GetAccessPointPolicyStatusOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAccessPointPolicyStatusInput, GetAccessPointPolicyStatusOutput, GetAccessPointPolicyStatusOutputError>(id: "getAccessPointPolicyStatus")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAccessPointPolicyStatusInput, GetAccessPointPolicyStatusOutput, GetAccessPointPolicyStatusOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getAccessPointPolicyStatusForObjectLambda(input: GetAccessPointPolicyStatusForObjectLambdaInput, completion: @escaping (SdkResult<GetAccessPointPolicyStatusForObjectLambdaOutput, GetAccessPointPolicyStatusForObjectLambdaOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAccessPointPolicyStatusForObjectLambdaInput, GetAccessPointPolicyStatusForObjectLambdaOutput, GetAccessPointPolicyStatusForObjectLambdaOutputError>(id: "getAccessPointPolicyStatusForObjectLambda")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAccessPointPolicyStatusForObjectLambdaInput, GetAccessPointPolicyStatusForObjectLambdaOutput, GetAccessPointPolicyStatusForObjectLambdaOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getBucket(input: GetBucketInput, completion: @escaping (SdkResult<GetBucketOutput, GetBucketOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketInput, GetBucketOutput, GetBucketOutputError>(id: "getBucket")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketInput, GetBucketOutput, GetBucketOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getBucketLifecycleConfiguration(input: GetBucketLifecycleConfigurationInput, completion: @escaping (SdkResult<GetBucketLifecycleConfigurationOutput, GetBucketLifecycleConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketLifecycleConfigurationInput, GetBucketLifecycleConfigurationOutput, GetBucketLifecycleConfigurationOutputError>(id: "getBucketLifecycleConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketLifecycleConfigurationInput, GetBucketLifecycleConfigurationOutput, GetBucketLifecycleConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getBucketPolicy(input: GetBucketPolicyInput, completion: @escaping (SdkResult<GetBucketPolicyOutput, GetBucketPolicyOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketPolicyInput, GetBucketPolicyOutput, GetBucketPolicyOutputError>(id: "getBucketPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketPolicyInput, GetBucketPolicyOutput, GetBucketPolicyOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getBucketTagging(input: GetBucketTaggingInput, completion: @escaping (SdkResult<GetBucketTaggingOutput, GetBucketTaggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketTaggingInput, GetBucketTaggingOutput, GetBucketTaggingOutputError>(id: "getBucketTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketTaggingInput, GetBucketTaggingOutput, GetBucketTaggingOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getJobTagging(input: GetJobTaggingInput, completion: @escaping (SdkResult<GetJobTaggingOutput, GetJobTaggingOutputError>) -> Void)
    {
        guard let jobId = input.jobId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component jobId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetJobTaggingInput, GetJobTaggingOutput, GetJobTaggingOutputError>(id: "getJobTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetJobTaggingInput, GetJobTaggingOutput, GetJobTaggingOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getPublicAccessBlock(input: GetPublicAccessBlockInput, completion: @escaping (SdkResult<GetPublicAccessBlockOutput, GetPublicAccessBlockOutputError>) -> Void)
    {
        let urlPath = "/v20180820/configuration/publicAccessBlock"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetPublicAccessBlockInput, GetPublicAccessBlockOutput, GetPublicAccessBlockOutputError>(id: "getPublicAccessBlock")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetPublicAccessBlockInput, GetPublicAccessBlockOutput, GetPublicAccessBlockOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          <i>Amazon S3 User Guide</i>.</p>
    ///          </note>
    public func getStorageLensConfiguration(input: GetStorageLensConfigurationInput, completion: @escaping (SdkResult<GetStorageLensConfigurationOutput, GetStorageLensConfigurationOutputError>) -> Void)
    {
        guard let configId = input.configId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component configId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetStorageLensConfigurationInput, GetStorageLensConfigurationOutput, GetStorageLensConfigurationOutputError>(id: "getStorageLensConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetStorageLensConfigurationInput, GetStorageLensConfigurationOutput, GetStorageLensConfigurationOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          <i>Amazon S3 User Guide</i>.</p>
    ///          </note>
    public func getStorageLensConfigurationTagging(input: GetStorageLensConfigurationTaggingInput, completion: @escaping (SdkResult<GetStorageLensConfigurationTaggingOutput, GetStorageLensConfigurationTaggingOutputError>) -> Void)
    {
        guard let configId = input.configId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component configId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetStorageLensConfigurationTaggingInput, GetStorageLensConfigurationTaggingOutput, GetStorageLensConfigurationTaggingOutputError>(id: "getStorageLensConfigurationTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetStorageLensConfigurationTaggingInput, GetStorageLensConfigurationTaggingOutput, GetStorageLensConfigurationTaggingOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func listAccessPoints(input: ListAccessPointsInput, completion: @escaping (SdkResult<ListAccessPointsOutput, ListAccessPointsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAccessPointsInput, ListAccessPointsOutput, ListAccessPointsOutputError>(id: "listAccessPoints")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAccessPointsInput, ListAccessPointsOutput, ListAccessPointsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func listAccessPointsForObjectLambda(input: ListAccessPointsForObjectLambdaInput, completion: @escaping (SdkResult<ListAccessPointsForObjectLambdaOutput, ListAccessPointsForObjectLambdaOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAccessPointsForObjectLambdaInput, ListAccessPointsForObjectLambdaOutput, ListAccessPointsForObjectLambdaOutputError>(id: "listAccessPointsForObjectLambda")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAccessPointsForObjectLambdaInput, ListAccessPointsForObjectLambdaOutput, ListAccessPointsForObjectLambdaOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listJobs(input: ListJobsInput, completion: @escaping (SdkResult<ListJobsOutput, ListJobsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListJobsInput, ListJobsOutput, ListJobsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listRegionalBuckets(input: ListRegionalBucketsInput, completion: @escaping (SdkResult<ListRegionalBucketsOutput, ListRegionalBucketsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListRegionalBucketsInput, ListRegionalBucketsOutput, ListRegionalBucketsOutputError>(id: "listRegionalBuckets")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListRegionalBucketsInput, ListRegionalBucketsOutput, ListRegionalBucketsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          <i>Amazon S3 User Guide</i>.</p>
    ///          </note>
    public func listStorageLensConfigurations(input: ListStorageLensConfigurationsInput, completion: @escaping (SdkResult<ListStorageLensConfigurationsOutput, ListStorageLensConfigurationsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListStorageLensConfigurationsInput, ListStorageLensConfigurationsOutput, ListStorageLensConfigurationsOutputError>(id: "listStorageLensConfigurations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListStorageLensConfigurationsInput, ListStorageLensConfigurationsOutput, ListStorageLensConfigurationsOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func putAccessPointConfigurationForObjectLambda(input: PutAccessPointConfigurationForObjectLambdaInput, completion: @escaping (SdkResult<PutAccessPointConfigurationForObjectLambdaOutput, PutAccessPointConfigurationForObjectLambdaOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutAccessPointConfigurationForObjectLambdaInput, PutAccessPointConfigurationForObjectLambdaOutput, PutAccessPointConfigurationForObjectLambdaOutputError>(id: "putAccessPointConfigurationForObjectLambda")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutAccessPointConfigurationForObjectLambdaInput, PutAccessPointConfigurationForObjectLambdaOutput, PutAccessPointConfigurationForObjectLambdaOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putAccessPointPolicy(input: PutAccessPointPolicyInput, completion: @escaping (SdkResult<PutAccessPointPolicyOutput, PutAccessPointPolicyOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutAccessPointPolicyInput, PutAccessPointPolicyOutput, PutAccessPointPolicyOutputError>(id: "putAccessPointPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutAccessPointPolicyInput, PutAccessPointPolicyOutput, PutAccessPointPolicyOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putAccessPointPolicyForObjectLambda(input: PutAccessPointPolicyForObjectLambdaInput, completion: @escaping (SdkResult<PutAccessPointPolicyForObjectLambdaOutput, PutAccessPointPolicyForObjectLambdaOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutAccessPointPolicyForObjectLambdaInput, PutAccessPointPolicyForObjectLambdaOutput, PutAccessPointPolicyForObjectLambdaOutputError>(id: "putAccessPointPolicyForObjectLambda")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutAccessPointPolicyForObjectLambdaInput, PutAccessPointPolicyForObjectLambdaOutput, PutAccessPointPolicyForObjectLambdaOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketLifecycleConfiguration(input: PutBucketLifecycleConfigurationInput, completion: @escaping (SdkResult<PutBucketLifecycleConfigurationOutput, PutBucketLifecycleConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketLifecycleConfigurationInput, PutBucketLifecycleConfigurationOutput, PutBucketLifecycleConfigurationOutputError>(id: "putBucketLifecycleConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketLifecycleConfigurationInput, PutBucketLifecycleConfigurationOutput, PutBucketLifecycleConfigurationOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketPolicy(input: PutBucketPolicyInput, completion: @escaping (SdkResult<PutBucketPolicyOutput, PutBucketPolicyOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketPolicyInput, PutBucketPolicyOutput, PutBucketPolicyOutputError>(id: "putBucketPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketPolicyInput, PutBucketPolicyOutput, PutBucketPolicyOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putBucketTagging(input: PutBucketTaggingInput, completion: @escaping (SdkResult<PutBucketTaggingOutput, PutBucketTaggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketTaggingInput, PutBucketTaggingOutput, PutBucketTaggingOutputError>(id: "putBucketTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketTaggingInput, PutBucketTaggingOutput, PutBucketTaggingOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putJobTagging(input: PutJobTaggingInput, completion: @escaping (SdkResult<PutJobTaggingOutput, PutJobTaggingOutputError>) -> Void)
    {
        guard let jobId = input.jobId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component jobId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutJobTaggingInput, PutJobTaggingOutput, PutJobTaggingOutputError>(id: "putJobTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutJobTaggingInput, PutJobTaggingOutput, PutJobTaggingOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func putPublicAccessBlock(input: PutPublicAccessBlockInput, completion: @escaping (SdkResult<PutPublicAccessBlockOutput, PutPublicAccessBlockOutputError>) -> Void)
    {
        let urlPath = "/v20180820/configuration/publicAccessBlock"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutPublicAccessBlockInput, PutPublicAccessBlockOutput, PutPublicAccessBlockOutputError>(id: "putPublicAccessBlock")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutPublicAccessBlockInput, PutPublicAccessBlockOutput, PutPublicAccessBlockOutputError>(contentType: "application/xml"))
    ...
    ///          <i>Amazon S3 User Guide</i>.</p>
    ///          </note>
    public func putStorageLensConfiguration(input: PutStorageLensConfigurationInput, completion: @escaping (SdkResult<PutStorageLensConfigurationOutput, PutStorageLensConfigurationOutputError>) -> Void)
    {
        guard let configId = input.configId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component configId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutStorageLensConfigurationInput, PutStorageLensConfigurationOutput, PutStorageLensConfigurationOutputError>(id: "putStorageLensConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutStorageLensConfigurationInput, PutStorageLensConfigurationOutput, PutStorageLensConfigurationOutputError>(contentType: "application/xml"))
    ...
    ///          <i>Amazon S3 User Guide</i>.</p>
    ///          </note>
    public func putStorageLensConfigurationTagging(input: PutStorageLensConfigurationTaggingInput, completion: @escaping (SdkResult<PutStorageLensConfigurationTaggingOutput, PutStorageLensConfigurationTaggingOutputError>) -> Void)
    {
        guard let configId = input.configId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component configId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutStorageLensConfigurationTaggingInput, PutStorageLensConfigurationTaggingOutput, PutStorageLensConfigurationTaggingOutputError>(id: "putStorageLensConfigurationTagging")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutStorageLensConfigurationTaggingInput, PutStorageLensConfigurationTaggingOutput, PutStorageLensConfigurationTaggingOutputError>(contentType: "application/xml"))
    ...
    ///             </li>
    ///          </ul>
    public func updateJobPriority(input: UpdateJobPriorityInput, completion: @escaping (SdkResult<UpdateJobPriorityOutput, UpdateJobPriorityOutputError>) -> Void)
    {
        guard let jobId = input.jobId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component jobId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateJobPriorityInput, UpdateJobPriorityOutput, UpdateJobPriorityOutputError>(id: "updateJobPriority")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateJobPriorityInput, UpdateJobPriorityOutput, UpdateJobPriorityOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func updateJobStatus(input: UpdateJobStatusInput, completion: @escaping (SdkResult<UpdateJobStatusOutput, UpdateJobStatusOutputError>) -> Void)
    {
        guard let jobId = input.jobId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component jobId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateJobStatusInput, UpdateJobStatusOutput, UpdateJobStatusOutputError>(id: "updateJobStatus")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateJobStatusInput, UpdateJobStatusOutput, UpdateJobStatusOutputError>(contentType: "application/xml"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
