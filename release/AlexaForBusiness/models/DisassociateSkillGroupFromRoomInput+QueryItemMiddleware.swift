...
public struct DisassociateSkillGroupFromRoomInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DisassociateSkillGroupFromRoomOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DisassociateSkillGroupFromRoomOutput>
