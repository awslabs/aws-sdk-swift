...
extension FirehoseClientTypes.AmazonopensearchserviceBufferingHints: Swift.Codable, ClientRuntime.Reflection {
...
extension FirehoseClientTypes.AmazonopensearchserviceDestinationConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension FirehoseClientTypes {
    public struct AmazonopensearchserviceDestinationConfiguration: Swift.Equatable {
        var bufferingHints: FirehoseClientTypes.AmazonopensearchserviceBufferingHints?
        /// Describes the Amazon CloudWatch logging options for your delivery stream.
        var cloudWatchLoggingOptions: FirehoseClientTypes.CloudWatchLoggingOptions?
        var clusterEndpoint: Swift.String?
        var domainARN: Swift.String?
        /// This member is required.
        var indexName: Swift.String?
        var indexRotationPeriod: FirehoseClientTypes.AmazonopensearchserviceIndexRotationPeriod?
        /// Describes a data processing configuration.
        var processingConfiguration: FirehoseClientTypes.ProcessingConfiguration?
        var retryOptions: FirehoseClientTypes.AmazonopensearchserviceRetryOptions?
        /// This member is required.
        var roleARN: Swift.String?
        var s3BackupMode: FirehoseClientTypes.AmazonopensearchserviceS3BackupMode?
        /// Describes the configuration of a destination in Amazon S3.
        /// This member is required.
        var s3Configuration: FirehoseClientTypes.S3DestinationConfiguration?
        var typeName: Swift.String?
        /// The details of the VPC of the Amazon ES destination.
        var vpcConfiguration: FirehoseClientTypes.VpcConfiguration?
...
extension FirehoseClientTypes.AmazonopensearchserviceDestinationDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bufferingHints = "BufferingHints"
        case cloudWatchLoggingOptions = "CloudWatchLoggingOptions"
        case clusterEndpoint = "ClusterEndpoint"
...
extension FirehoseClientTypes {
    public struct AmazonopensearchserviceDestinationDescription: Swift.Equatable {
        ...
        var s3DestinationDescription: FirehoseClientTypes.S3DestinationDescription?
        var typeName: Swift.String?
        /// The details of the VPC of the Amazon ES destination.
        var vpcConfigurationDescription: FirehoseClientTypes.VpcConfigurationDescription?
...
extension FirehoseClientTypes.AmazonopensearchserviceDestinationUpdate: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bufferingHints = "BufferingHints"
        case cloudWatchLoggingOptions = "CloudWatchLoggingOptions"
        case clusterEndpoint = "ClusterEndpoint"
...
extension FirehoseClientTypes {
    public struct AmazonopensearchserviceDestinationUpdate: Swift.Equatable {
        ...
        var s3Update: FirehoseClientTypes.S3DestinationUpdate?
        var typeName: Swift.String?
...
extension FirehoseClientTypes.AmazonopensearchserviceRetryOptions: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension FirehoseClientTypes {
    ...
    public struct CloudWatchLoggingOptions: Swift.Equatable {
        ...
        var logStreamName: Swift.String?
...
extension FirehoseClientTypes {
    ...
    public struct CopyCommand: Swift.Equatable {
        ...
        var copyOptions: Swift.String?
        /// A comma-separated list of column names.
        var dataTableColumns: Swift.String?
        /// The name of the target table. The table must already exist in the database.
        /// This member is required.
        var dataTableName: Swift.String?
...
public struct CreateDeliveryStreamInput: Swift.Equatable {
    var amazonopensearchserviceDestinationConfiguration: FirehoseClientTypes.AmazonopensearchserviceDestinationConfiguration?
    /// Used to specify the type and Amazon Resource Name (ARN) of the KMS key needed for Server-Side Encryption (SSE).
    var deliveryStreamEncryptionConfigurationInput: FirehoseClientTypes.DeliveryStreamEncryptionConfigurationInput?
    /// The name of the delivery stream. This name must be unique per AWS account in the same AWS Region. If the delivery streams are in different accounts or different Regions, you can have multiple delivery streams with the same name.
    /// This member is required.
    var deliveryStreamName: Swift.String?
    /// The delivery stream type. This parameter can be one of the following values:
    ///
    /// * DirectPut: Provider applications access the delivery stream directly.
    ///
    /// * KinesisStreamAsSource: The delivery stream uses a Kinesis data stream as a source.
    var deliveryStreamType: FirehoseClientTypes.DeliveryStreamType?
    /// The destination in Amazon ES. You can specify only one destination.
    var elasticsearchDestinationConfiguration: FirehoseClientTypes.ElasticsearchDestinationConfiguration?
    /// The destination in Amazon S3. You can specify only one destination.
    var extendedS3DestinationConfiguration: FirehoseClientTypes.ExtendedS3DestinationConfiguration?
    /// Enables configuring Kinesis Firehose to deliver data to any HTTP endpoint destination. You can specify only one destination.
    var httpEndpointDestinationConfiguration: FirehoseClientTypes.HttpEndpointDestinationConfiguration?
    /// When a Kinesis data stream is used as the source for the delivery stream, a [KinesisStreamSourceConfiguration] containing the Kinesis data stream Amazon Resource Name (ARN) and the role ARN for the source stream.
    var kinesisStreamSourceConfiguration: FirehoseClientTypes.KinesisStreamSourceConfiguration?
    /// The destination in Amazon Redshift. You can specify only one destination.
    var redshiftDestinationConfiguration: FirehoseClientTypes.RedshiftDestinationConfiguration?
    /// [Deprecated] The destination in Amazon S3. You can specify only one destination.
    @available(*, deprecated)
    var s3DestinationConfiguration: FirehoseClientTypes.S3DestinationConfiguration?
    /// The destination in Splunk. You can specify only one destination.
    var splunkDestinationConfiguration: FirehoseClientTypes.SplunkDestinationConfiguration?
    ...
    var tags: [FirehoseClientTypes.Tag]?
...
public struct CreateDeliveryStreamOutputResponse: Swift.Equatable {
    ...
    var deliveryStreamARN: Swift.String?
...
extension FirehoseClientTypes {
    ...
    public struct DataFormatConversionConfiguration: Swift.Equatable {
        ...
        var inputFormatConfiguration: FirehoseClientTypes.InputFormatConfiguration?
        ...
        var outputFormatConfiguration: FirehoseClientTypes.OutputFormatConfiguration?
        /// Specifies the AWS Glue Data Catalog table that contains the column information. This parameter is required if Enabled is set to true.
        var schemaConfiguration: FirehoseClientTypes.SchemaConfiguration?
...
public struct DeleteDeliveryStreamInput: Swift.Equatable {
    ...
    var allowForceDelete: Swift.Bool?
...
extension FirehoseClientTypes {
    ...
    public struct DeliveryStreamDescription: Swift.Equatable {
        ...
        var deliveryStreamEncryptionConfiguration: FirehoseClientTypes.DeliveryStreamEncryptionConfiguration?
        /// The name of the delivery stream.
        /// This member is required.
        var deliveryStreamName: Swift.String?
        ...
        /// This member is required.
        var deliveryStreamStatus: FirehoseClientTypes.DeliveryStreamStatus?
        ...
        /// The destinations.
        /// This member is required.
        var destinations: [FirehoseClientTypes.DestinationDescription]?
        /// Provides details in case one of the following operations fails due to an error related to KMS: [CreateDeliveryStream], [DeleteDeliveryStream], [StartDeliveryStreamEncryption], [StopDeliveryStreamEncryption].
        var failureDescription: FirehoseClientTypes.FailureDescription?
        /// Indicates whether there are more destinations available to list.
        /// This member is required.
        var hasMoreDestinations: Swift.Bool?
        /// The date and time that the delivery stream was last updated.
        var lastUpdateTimestamp: ClientRuntime.Date?
        /// If the DeliveryStreamType parameter is KinesisStreamAsSource, a [SourceDescription] object describing the source Kinesis data stream.
        var source: FirehoseClientTypes.SourceDescription?
...
extension FirehoseClientTypes {
    ...
    public struct DeliveryStreamEncryptionConfiguration: Swift.Equatable {
        ...
        var keyType: FirehoseClientTypes.KeyType?
        ...
        var status: FirehoseClientTypes.DeliveryStreamEncryptionStatus?
...
public struct DescribeDeliveryStreamInput: Swift.Equatable {
    ...
    var exclusiveStartDestinationId: Swift.String?
...
public struct DescribeDeliveryStreamOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var deliveryStreamDescription: FirehoseClientTypes.DeliveryStreamDescription?
...
extension FirehoseClientTypes {
    ...
    public struct Deserializer: Swift.Equatable {
        ...
        var hiveJsonSerDe: FirehoseClientTypes.HiveJsonSerDe?
        /// The OpenX SerDe. Used by Kinesis Data Firehose for deserializing data, which means converting it from the JSON format in preparation for serializing it to the Parquet or ORC format. This is one of two deserializers you can choose, depending on which one offers the functionality you need. The other option is the native Hive / HCatalog JsonSerDe.
        var openXJsonSerDe: FirehoseClientTypes.OpenXJsonSerDe?
...
extension FirehoseClientTypes {
    ...
    public struct DestinationDescription: Swift.Equatable {
        var amazonopensearchserviceDestinationDescription: FirehoseClientTypes.AmazonopensearchserviceDestinationDescription?
        /// The ID of the destination.
        /// This member is required.
        var destinationId: Swift.String?
        /// The destination in Amazon ES.
        var elasticsearchDestinationDescription: FirehoseClientTypes.ElasticsearchDestinationDescription?
        /// The destination in Amazon S3.
        var extendedS3DestinationDescription: FirehoseClientTypes.ExtendedS3DestinationDescription?
        /// Describes the specified HTTP endpoint destination.
        var httpEndpointDestinationDescription: FirehoseClientTypes.HttpEndpointDestinationDescription?
        /// The destination in Amazon Redshift.
        var redshiftDestinationDescription: FirehoseClientTypes.RedshiftDestinationDescription?
        /// [Deprecated] The destination in Amazon S3.
        var s3DestinationDescription: FirehoseClientTypes.S3DestinationDescription?
        /// The destination in Splunk.
        var splunkDestinationDescription: FirehoseClientTypes.SplunkDestinationDescription?
...
extension FirehoseClientTypes.DynamicPartitioningConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case enabled = "Enabled"
        case retryOptions = "RetryOptions"
    }
...
extension FirehoseClientTypes {
    ...
    public struct DynamicPartitioningConfiguration: Swift.Equatable {
        ...
        var retryOptions: FirehoseClientTypes.RetryOptions?
...
extension FirehoseClientTypes {
    ...
    public struct ElasticsearchDestinationConfiguration: Swift.Equatable {
        ...
        var bufferingHints: FirehoseClientTypes.ElasticsearchBufferingHints?
        ...
        var indexRotationPeriod: FirehoseClientTypes.ElasticsearchIndexRotationPeriod?
        /// The data processing configuration.
        var processingConfiguration: FirehoseClientTypes.ProcessingConfiguration?
        /// The retry behavior in case Kinesis Data Firehose is unable to deliver documents to Amazon ES. The default value is 300 (5 minutes).
        var retryOptions: FirehoseClientTypes.ElasticsearchRetryOptions?
        ...
        var s3BackupMode: FirehoseClientTypes.ElasticsearchS3BackupMode?
...
extension FirehoseClientTypes {
    ...
    public struct EncryptionConfiguration: Swift.Equatable {
        /// The encryption key.
        var kMSEncryptionConfig: FirehoseClientTypes.KMSEncryptionConfig?
        /// Specifically override existing encryption information to ensure that no encryption is used.
        var noEncryptionConfig: FirehoseClientTypes.NoEncryptionConfig?
...
extension FirehoseClientTypes {
    ...
    public struct ExtendedS3DestinationConfiguration: Swift.Equatable {
        ...
        var bufferingHints: FirehoseClientTypes.BufferingHints?
        /// The Amazon CloudWatch logging options for your delivery stream.
        var cloudWatchLoggingOptions: FirehoseClientTypes.CloudWatchLoggingOptions?
        /// The compression format. If no value is specified, the default is UNCOMPRESSED.
        var compressionFormat: FirehoseClientTypes.CompressionFormat?
        /// The serializer, deserializer, and schema for converting data from the JSON format to the Parquet or ORC format before writing it to Amazon S3.
        var dataFormatConversionConfiguration: FirehoseClientTypes.DataFormatConversionConfiguration?
        /// The configuration of the dynamic partitioning mechanism that creates smaller data sets from the streaming data by partitioning it based on partition keys. Currently, dynamic partitioning is only supported for Amazon S3 destinations. For more information, see [https://docs.aws.amazon.com/firehose/latest/dev/dynamic-partitioning.html](https://docs.aws.amazon.com/firehose/latest/dev/dynamic-partitioning.html)
        var dynamicPartitioningConfiguration: FirehoseClientTypes.DynamicPartitioningConfiguration?
        /// The encryption configuration. If no value is specified, the default is no encryption.
        var encryptionConfiguration: FirehoseClientTypes.EncryptionConfiguration?
        /// A prefix that Kinesis Data Firehose evaluates and adds to failed records before writing them to S3. This prefix appears immediately following the bucket name. For information about how to specify this prefix, see [Custom Prefixes for Amazon S3 Objects](https://docs.aws.amazon.com/firehose/latest/dev/s3-prefixes.html).
        var errorOutputPrefix: Swift.String?
        /// The data processing configuration.
        var processingConfiguration: FirehoseClientTypes.ProcessingConfiguration?
        /// The Amazon Resource Name (ARN) of the AWS credentials. For more information, see [Amazon Resource Names (ARNs) and AWS Service Namespaces](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html).
        /// This member is required.
        ...
        var s3BackupConfiguration: FirehoseClientTypes.S3DestinationConfiguration?
        /// The Amazon S3 backup mode. After you create a delivery stream, you can update it to enable Amazon S3 backup if it is disabled. If backup is enabled, you can't update the delivery stream to disable it.
        var s3BackupMode: FirehoseClientTypes.S3BackupMode?
...
extension FirehoseClientTypes {
    ...
    public struct ExtendedS3DestinationDescription: Swift.Equatable {
        ...
        var roleARN: Swift.String?
        /// The configuration for backup in Amazon S3.
        var s3BackupDescription: FirehoseClientTypes.S3DestinationDescription?
        /// The Amazon S3 backup mode.
        var s3BackupMode: FirehoseClientTypes.S3BackupMode?
...
extension FirehoseClientTypes {
    ...
    public struct ExtendedS3DestinationUpdate: Swift.Equatable {
        ...
        var s3BackupUpdate: FirehoseClientTypes.S3DestinationUpdate?
...
extension FirehoseClientTypes {
    ...
    public struct FailureDescription: Swift.Equatable {
        ...
        /// This member is required.
        var type: FirehoseClientTypes.DeliveryStreamFailureType?
...
extension FirehoseClientTypes {
    ...
    public struct HiveJsonSerDe: Swift.Equatable {
        ...
        var timestampFormats: [Swift.String]?
...
extension FirehoseClientTypes {
    ...
    public struct HttpEndpointDestinationConfiguration: Swift.Equatable {
        ...
        var bufferingHints: FirehoseClientTypes.HttpEndpointBufferingHints?
        /// Describes the Amazon CloudWatch logging options for your delivery stream.
        var cloudWatchLoggingOptions: FirehoseClientTypes.CloudWatchLoggingOptions?
        /// The configuration of the HTTP endpoint selected as the destination.
        /// This member is required.
        var endpointConfiguration: FirehoseClientTypes.HttpEndpointConfiguration?
        /// Describes a data processing configuration.
        var processingConfiguration: FirehoseClientTypes.ProcessingConfiguration?
        /// The configuration of the requeste sent to the HTTP endpoint specified as the destination.
        var requestConfiguration: FirehoseClientTypes.HttpEndpointRequestConfiguration?
        /// Describes the retry behavior in case Kinesis Data Firehose is unable to deliver data to the specified HTTP endpoint destination, or if it doesn't receive a valid acknowledgment of receipt from the specified HTTP endpoint destination.
        var retryOptions: FirehoseClientTypes.HttpEndpointRetryOptions?
        /// Kinesis Data Firehose uses this IAM role for all the permissions that the delivery stream needs.
        var roleARN: Swift.String?
        /// Describes the S3 bucket backup options for the data that Kinesis Data Firehose delivers to the HTTP endpoint destination. You can back up all documents (AllData) or only the documents that Kinesis Data Firehose could not deliver to the specified HTTP endpoint destination (FailedDataOnly).
        var s3BackupMode: FirehoseClientTypes.HttpEndpointS3BackupMode?
        /// Describes the configuration of a destination in Amazon S3.
        /// This member is required.
        var s3Configuration: FirehoseClientTypes.S3DestinationConfiguration?
...
extension FirehoseClientTypes {
    ...
    public struct HttpEndpointDestinationDescription: Swift.Equatable {
        ...
        var endpointConfiguration: FirehoseClientTypes.HttpEndpointDescription?
        /// Describes a data processing configuration.
        var processingConfiguration: FirehoseClientTypes.ProcessingConfiguration?
...
extension FirehoseClientTypes {
    ...
    public struct HttpEndpointRequestConfiguration: Swift.Equatable {
        ...
        var commonAttributes: [FirehoseClientTypes.HttpEndpointCommonAttribute]?
        ...
        var contentEncoding: FirehoseClientTypes.ContentEncoding?
...
extension FirehoseClientTypes {
    ...
    public struct InputFormatConfiguration: Swift.Equatable {
        ...
        var deserializer: FirehoseClientTypes.Deserializer?
...
extension FirehoseClientTypes {
    ...
    public struct KinesisStreamSourceConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var kinesisStreamARN: Swift.String?
...
extension FirehoseClientTypes {
    ...
    public struct KinesisStreamSourceDescription: Swift.Equatable {
        ...
        var deliveryStartTimestamp: ClientRuntime.Date?
...
public struct ListDeliveryStreamsInput: Swift.Equatable {
    ...
    var exclusiveStartDeliveryStreamName: Swift.String?
...
public struct ListDeliveryStreamsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var deliveryStreamNames: [Swift.String]?
    /// Indicates whether there are more delivery streams available to list.
    /// This member is required.
    var hasMoreDeliveryStreams: Swift.Bool?
...
public struct ListTagsForDeliveryStreamInput: Swift.Equatable {
    ...
    var exclusiveStartTagKey: Swift.String?
...
extension FirehoseClientTypes {
    ...
    public struct OrcSerDe: Swift.Equatable {
        ...
        var blockSizeBytes: Swift.Int?
        /// The column names for which you want Kinesis Data Firehose to create bloom filters. The default is null.
        var bloomFilterColumns: [Swift.String]?
        /// The Bloom filter false positive probability (FPP). The lower the FPP, the bigger the Bloom filter. The default value is 0.05, the minimum is 0, and the maximum is 1.
        var bloomFilterFalsePositiveProbability: Swift.Double?
        /// The compression code to use over data blocks. The default is SNAPPY.
        var compression: FirehoseClientTypes.OrcCompression?
        /// Represents the fraction of the total number of non-null rows. To turn off dictionary encoding, set this fraction to a number that is less than the number of distinct keys in a dictionary. To always use dictionary encoding, set this threshold to 1.
        var dictionaryKeyThreshold: Swift.Double?
        /// Set this to true to indicate that you want stripes to be padded to the HDFS block boundaries. This is useful if you intend to copy the data from Amazon S3 to HDFS before querying. The default is false.
        var enablePadding: Swift.Bool?
        /// The version of the file to write. The possible values are V0_11 and V0_12. The default is V0_12.
        var formatVersion: FirehoseClientTypes.OrcFormatVersion?
        ...
        var paddingTolerance: Swift.Double?
        /// The number of rows between index entries. The default is 10,000 and the minimum is 1,000.
        var rowIndexStride: Swift.Int?
        /// The number of bytes in each stripe. The default is 64 MiB and the minimum is 8 MiB.
        var stripeSizeBytes: Swift.Int?
...
extension FirehoseClientTypes {
    ...
    public struct OutputFormatConfiguration: Swift.Equatable {
        ...
        var serializer: FirehoseClientTypes.Serializer?
...
extension FirehoseClientTypes {
    ...
    public struct ParquetSerDe: Swift.Equatable {
        ...
        var compression: FirehoseClientTypes.ParquetCompression?
        /// Indicates whether to enable dictionary compression.
        var enableDictionaryCompression: Swift.Bool?
        /// The maximum amount of padding to apply. This is useful if you intend to copy the data from Amazon S3 to HDFS before querying. The default is 0.
        var maxPaddingBytes: Swift.Int?
        /// The Parquet page size. Column chunks are divided into pages. A page is conceptually an indivisible unit (in terms of compression and encoding). The minimum value is 64 KiB and the default is 1 MiB.
        var pageSizeBytes: Swift.Int?
        /// Indicates the version of row format to output. The possible values are V1 and V2. The default is V1.
        var writerVersion: FirehoseClientTypes.ParquetWriterVersion?
...
extension FirehoseClientTypes {
    ...
    public struct ProcessingConfiguration: Swift.Equatable {
        ...
        var enabled: Swift.Bool?
        /// The data processors.
        var processors: [FirehoseClientTypes.Processor]?
...
extension FirehoseClientTypes {
    ...
    public struct Processor: Swift.Equatable {
        ...
        var parameters: [FirehoseClientTypes.ProcessorParameter]?
        /// The type of processor.
        /// This member is required.
        var type: FirehoseClientTypes.ProcessorType?
...
extension FirehoseClientTypes {
    ...
    public struct ProcessorParameter: Swift.Equatable {
        ...
        /// This member is required.
        var parameterName: FirehoseClientTypes.ProcessorParameterName?
        /// The parameter value.
        /// This member is required.
...
public struct PutRecordBatchInput: Swift.Equatable {
    ...
    /// One or more records.
    /// This member is required.
    var records: [FirehoseClientTypes.Record]?
...
public struct PutRecordBatchOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var failedPutCount: Swift.Int?
    /// The results array. For each record, the index of the response element is the same as the index used in the request array.
    /// This member is required.
    var requestResponses: [FirehoseClientTypes.PutRecordBatchResponseEntry]?
...
public struct PutRecordInput: Swift.Equatable {
    ...
    /// The record.
    /// This member is required.
    var record: FirehoseClientTypes.Record?
...
extension FirehoseClientTypes {
    ...
    public struct RedshiftDestinationConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var clusterJDBCURL: Swift.String?
        /// The COPY command.
        /// This member is required.
        var copyCommand: FirehoseClientTypes.CopyCommand?
        /// The user password.
        /// This member is required.
        ...
        var retryOptions: FirehoseClientTypes.RedshiftRetryOptions?
        /// The Amazon Resource Name (ARN) of the AWS credentials. For more information, see [Amazon Resource Names (ARNs) and AWS Service Namespaces](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html).
        /// This member is required.
        var roleARN: Swift.String?
        /// The configuration for backup in Amazon S3.
        var s3BackupConfiguration: FirehoseClientTypes.S3DestinationConfiguration?
        /// The Amazon S3 backup mode. After you create a delivery stream, you can update it to enable Amazon S3 backup if it is disabled. If backup is enabled, you can't update the delivery stream to disable it.
        var s3BackupMode: FirehoseClientTypes.RedshiftS3BackupMode?
...
extension FirehoseClientTypes.RetryOptions: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case durationInSeconds = "DurationInSeconds"
    }
...
extension FirehoseClientTypes {
    ...
    public struct Serializer: Swift.Equatable {
        /// A serializer to use for converting data to the ORC format before storing it in Amazon S3. For more information, see [Apache ORC](https://orc.apache.org/docs/).
        var orcSerDe: FirehoseClientTypes.OrcSerDe?
        /// A serializer to use for converting data to the Parquet format before storing it in Amazon S3. For more information, see [Apache Parquet](https://parquet.apache.org/documentation/latest/).
        var parquetSerDe: FirehoseClientTypes.ParquetSerDe?
...
extension FirehoseClientTypes {
    ...
    public struct SourceDescription: Swift.Equatable {
        ...
        var kinesisStreamSourceDescription: FirehoseClientTypes.KinesisStreamSourceDescription?
...
extension FirehoseClientTypes {
    ...
    public struct SplunkDestinationConfiguration: Swift.Equatable {
        ...
        var hECAcknowledgmentTimeoutInSeconds: Swift.Int?
        /// The HTTP Event Collector (HEC) endpoint to which Kinesis Data Firehose sends your data.
        /// This member is required.
        var hECEndpoint: Swift.String?
        /// This type can be either "Raw" or "Event."
        /// This member is required.
        var hECEndpointType: FirehoseClientTypes.HECEndpointType?
        /// This is a GUID that you obtain from your Splunk cluster when you create a new HEC endpoint.
        /// This member is required.
        var hECToken: Swift.String?
        /// The data processing configuration.
        var processingConfiguration: FirehoseClientTypes.ProcessingConfiguration?
        /// The retry behavior in case Kinesis Data Firehose is unable to deliver data to Splunk, or if it doesn't receive an acknowledgment of receipt from Splunk.
        var retryOptions: FirehoseClientTypes.SplunkRetryOptions?
        ...
        var s3BackupMode: FirehoseClientTypes.SplunkS3BackupMode?
        /// The configuration for the backup Amazon S3 location.
        /// This member is required.
        var s3Configuration: FirehoseClientTypes.S3DestinationConfiguration?
...
public struct UpdateDestinationInput: Swift.Equatable {
    var amazonopensearchserviceDestinationUpdate: FirehoseClientTypes.AmazonopensearchserviceDestinationUpdate?
    /// Obtain this value from the VersionId result of [DeliveryStreamDescription]. This value is required, and helps the service perform conditional operations. For example, if there is an interleaving update and this value is null, then the update destination fails. After the update is successful, the VersionId value is updated. The service then performs a merge of the old configuration with the new configuration.
    /// This member is required.
    var currentDeliveryStreamVersionId: Swift.String?
    /// The name of the delivery stream.
    /// This member is required.
    var deliveryStreamName: Swift.String?
    /// The ID of the destination.
    ...
    var destinationId: Swift.String?
    /// Describes an update for a destination in Amazon ES.
    var elasticsearchDestinationUpdate: FirehoseClientTypes.ElasticsearchDestinationUpdate?
    /// Describes an update for a destination in Amazon S3.
    var extendedS3DestinationUpdate: FirehoseClientTypes.ExtendedS3DestinationUpdate?
    /// Describes an update to the specified HTTP endpoint destination.
    var httpEndpointDestinationUpdate: FirehoseClientTypes.HttpEndpointDestinationUpdate?
    /// Describes an update for a destination in Amazon Redshift.
    var redshiftDestinationUpdate: FirehoseClientTypes.RedshiftDestinationUpdate?
    /// [Deprecated] Describes an update for a destination in Amazon S3.
    @available(*, deprecated)
    var s3DestinationUpdate: FirehoseClientTypes.S3DestinationUpdate?
    /// Describes an update for a destination in Splunk.
    var splunkDestinationUpdate: FirehoseClientTypes.SplunkDestinationUpdate?
