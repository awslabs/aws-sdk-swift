...
extension GroundStationClientTypes {
    ...
    public struct AntennaDownlinkConfig: Swift.Equatable {
        ...
        var spectrumConfig: GroundStationClientTypes.SpectrumConfig?
...
extension GroundStationClientTypes {
    ...
    public struct AntennaDownlinkDemodDecodeConfig: Swift.Equatable {
        ...
        /// This member is required.
        var decodeConfig: GroundStationClientTypes.DecodeConfig?
        /// Information about the demodulation Config.
        /// This member is required.
        var demodulationConfig: GroundStationClientTypes.DemodulationConfig?
...
extension GroundStationClientTypes {
    ...
    public struct AntennaUplinkConfig: Swift.Equatable {
        ...
        /// This member is required.
        var spectrumConfig: GroundStationClientTypes.UplinkSpectrumConfig?
        /// EIRP of the target.
        /// This member is required.
        var targetEirp: GroundStationClientTypes.Eirp?
        /// Whether or not uplink transmit is disabled.
        var transmitDisabled: Swift.Bool?
...
extension GroundStationClientTypes {
    ...
    public struct ConfigListItem: Swift.Equatable {
        /// ARN of a Config.
        var configArn: Swift.String?
        /// UUID of a Config.
        var configId: Swift.String?
        /// Type of a Config.
        var configType: GroundStationClientTypes.ConfigCapabilityType?
        /// Name of a Config.
...
extension GroundStationClientTypes {
    ...
    public struct ContactData: Swift.Equatable {
        ...
        var contactId: Swift.String?
        /// Status of a contact.
        var contactStatus: GroundStationClientTypes.ContactStatus?
        /// End time of a contact.
        var endTime: ClientRuntime.Date?
        /// Error message of a contact.
        var errorMessage: Swift.String?
        /// Name of a ground station.
        var groundStation: Swift.String?
        /// Maximum elevation angle of a contact.
        var maximumElevation: GroundStationClientTypes.Elevation?
        /// ARN of a mission profile.
        var missionProfileArn: Swift.String?
        /// Amount of time after a contact ends that you’d like to receive a CloudWatch event indicating the pass has finished.
        var postPassEndTime: ClientRuntime.Date?
        /// Amount of time prior to contact start you’d like to receive a CloudWatch event indicating an upcoming pass.
        var prePassStartTime: ClientRuntime.Date?
        /// Region of a contact.
        var region: Swift.String?
        /// ARN of a satellite.
        var satelliteArn: Swift.String?
...
public struct CreateConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var configData: GroundStationClientTypes.ConfigTypeData?
    /// Name of a Config.
    /// This member is required.
    var name: Swift.String?
...
public struct CreateDataflowEndpointGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var endpointDetails: [GroundStationClientTypes.EndpointDetails]?
...
public struct CreateDataflowEndpointGroupOutputResponse: Swift.Equatable {
    ...
    var dataflowEndpointGroupId: Swift.String?
...
public struct CreateMissionProfileInput: Swift.Equatable {
    /// Amount of time after a contact ends that you’d like to receive a CloudWatch event indicating the pass has finished.
    var contactPostPassDurationSeconds: Swift.Int?
    /// Amount of time prior to contact start you’d like to receive a CloudWatch event indicating an upcoming pass.
    var contactPrePassDurationSeconds: Swift.Int?
    /// A list of lists of ARNs. Each list of ARNs is an edge, with a from Config and a to Config.
    /// This member is required.
    var dataflowEdges: [[Swift.String]]?
    /// Smallest amount of time in seconds that you’d like to see for an available contact. AWS Ground Station will not present you with contacts shorter than this duration.
    /// This member is required.
    var minimumViableContactDurationSeconds: Swift.Int?
    ...
    /// This member is required.
    var trackingConfigArn: Swift.String?
...
public struct CreateMissionProfileOutputResponse: Swift.Equatable {
    ...
    var missionProfileId: Swift.String?
...
extension GroundStationClientTypes {
    ...
    public struct DataflowDetail: Swift.Equatable {
        ...
        var destination: GroundStationClientTypes.Destination?
        /// Error message for a dataflow.
        var errorMessage: Swift.String?
        /// Dataflow details for the source side.
        var source: GroundStationClientTypes.Source?
...
extension GroundStationClientTypes {
    ...
    public struct DataflowEndpoint: Swift.Equatable {
        ...
        var address: GroundStationClientTypes.SocketAddress?
        /// Maximum transmission unit (MTU) size in bytes of a dataflow endpoint.
        var mtu: Swift.Int?
        /// Name of a dataflow endpoint.
        var name: Swift.String?
        /// Status of a dataflow endpoint.
        var status: GroundStationClientTypes.EndpointStatus?
...
extension GroundStationClientTypes {
    ...
    public struct DataflowEndpointConfig: Swift.Equatable {
        /// Name of a dataflow endpoint.
        /// This member is required.
        var dataflowEndpointName: Swift.String?
        /// Region of a dataflow endpoint.
        var dataflowEndpointRegion: Swift.String?
...
extension GroundStationClientTypes {
    ...
    public struct DataflowEndpointListItem: Swift.Equatable {
        ...
        var dataflowEndpointGroupArn: Swift.String?
        /// UUID of a dataflow endpoint group.
        var dataflowEndpointGroupId: Swift.String?
...
extension GroundStationClientTypes {
    ...
    public struct DecodeConfig: Swift.Equatable {
        ...
        /// This member is required.
        var unvalidatedJSON: Swift.String?
...
public struct DescribeContactOutputResponse: Swift.Equatable {
    ...
    var dataflowList: [GroundStationClientTypes.DataflowDetail]?
    /// End time of a contact.
    var endTime: ClientRuntime.Date?
...
extension GroundStationClientTypes {
    ...
    public struct Destination: Swift.Equatable {
        ...
        var configDetails: GroundStationClientTypes.ConfigDetails?
        /// UUID of a Config.
        var configId: Swift.String?
        /// Type of a Config.
        var configType: GroundStationClientTypes.ConfigCapabilityType?
        /// Region of a dataflow destination.
        var dataflowDestinationRegion: Swift.String?
...
extension GroundStationClientTypes {
    ...
    public struct Eirp: Swift.Equatable {
        /// Units of an EIRP.
        /// This member is required.
        var units: GroundStationClientTypes.EirpUnits?
...
extension GroundStationClientTypes {
    ...
    public struct Elevation: Swift.Equatable {
        ...
        /// This member is required.
        var unit: GroundStationClientTypes.AngleUnits?
...
extension GroundStationClientTypes {
    ...
    public struct EndpointDetails: Swift.Equatable {
        /// A dataflow endpoint.
        var endpoint: GroundStationClientTypes.DataflowEndpoint?
        /// Endpoint security details.
        var securityDetails: GroundStationClientTypes.SecurityDetails?
...
extension GroundStationClientTypes {
    ...
    public struct Frequency: Swift.Equatable {
        /// Frequency units.
        /// This member is required.
        var units: GroundStationClientTypes.FrequencyUnits?
...
extension GroundStationClientTypes {
    ...
    public struct FrequencyBandwidth: Swift.Equatable {
        ...
        /// This member is required.
        var units: GroundStationClientTypes.BandwidthUnits?
...
public struct GetDataflowEndpointGroupOutputResponse: Swift.Equatable {
    ...
    var endpointsDetails: [GroundStationClientTypes.EndpointDetails]?
...
public struct GetMinuteUsageOutputResponse: Swift.Equatable {
    ...
    var estimatedMinutesRemaining: Swift.Int?
    /// Returns whether or not an account has signed up for the reserved minutes pricing plan, specific to the month being requested.
    var isReservedMinutesCustomer: Swift.Bool?
    /// Total number of reserved minutes allocated, specific to the month being requested.
    var totalReservedMinuteAllocation: Swift.Int?
    /// Total scheduled minutes for an account, specific to the month being requested.
    var totalScheduledMinutes: Swift.Int?
    /// Upcoming minutes scheduled for an account, specific to the month being requested.
    var upcomingMinutesScheduled: Swift.Int?
...
public struct GetSatelliteOutputResponse: Swift.Equatable {
    ...
    var groundStations: [Swift.String]?
    /// NORAD satellite ID number.
    var noradSatelliteID: Swift.Int
    /// ARN of a satellite.
    var satelliteArn: Swift.String?
    /// UUID of a satellite.
    var satelliteId: Swift.String?
...
extension GroundStationClientTypes {
    ...
    public struct GroundStationData: Swift.Equatable {
        ...
        var groundStationId: Swift.String?
        /// Name of a ground station.
        var groundStationName: Swift.String?
...
public struct ListConfigsOutputResponse: Swift.Equatable {
    ...
    var configList: [GroundStationClientTypes.ConfigListItem]?
...
public struct ListContactsInput: Swift.Equatable {
    ...
    /// This member is required.
    var statusList: [GroundStationClientTypes.ContactStatus]?
...
public struct ListContactsOutputResponse: Swift.Equatable {
    /// List of contacts.
    var contactList: [GroundStationClientTypes.ContactData]?
...
public struct ListDataflowEndpointGroupsOutputResponse: Swift.Equatable {
    ...
    var dataflowEndpointGroupList: [GroundStationClientTypes.DataflowEndpointListItem]?
...
public struct ListGroundStationsOutputResponse: Swift.Equatable {
    ...
    var groundStationList: [GroundStationClientTypes.GroundStationData]?
    /// Next token that can be supplied in the next call to get the next page of ground stations.
    var nextToken: Swift.String?
...
public struct ListMissionProfilesOutputResponse: Swift.Equatable {
    ...
    var missionProfileList: [GroundStationClientTypes.MissionProfileListItem]?
...
public struct ListSatellitesOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// List of satellites.
    var satellites: [GroundStationClientTypes.SatelliteListItem]?
...
extension GroundStationClientTypes {
    ...
    public struct Source: Swift.Equatable {
        ...
        var dataflowSourceRegion: Swift.String?
...
extension GroundStationClientTypes {
    ...
    public struct SpectrumConfig: Swift.Equatable {
        ...
        /// * For AntennaUplinkConfig, valid values are between 10 kHz to 54 MHz.
        /// This member is required.
        var bandwidth: GroundStationClientTypes.FrequencyBandwidth?
        /// Center frequency of a spectral Config. Valid values are between 2200 to 2300 MHz and 7750 to 8400 MHz for downlink and 2025 to 2120 MHz for uplink.
        /// This member is required.
        var centerFrequency: GroundStationClientTypes.Frequency?
        /// Polarization of a spectral Config. Capturing both "RIGHT_HAND" and "LEFT_HAND" polarization requires two separate configs.
        var polarization: GroundStationClientTypes.Polarization?
...
extension GroundStationClientTypes {
    ...
    public struct TrackingConfig: Swift.Equatable {
        ...
        /// This member is required.
        var autotrack: GroundStationClientTypes.Criticality?
...
extension GroundStationClientTypes {
    ...
    public struct UplinkEchoConfig: Swift.Equatable {
        ...
        /// This member is required.
        var antennaUplinkConfigArn: Swift.String?
