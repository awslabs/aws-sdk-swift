...
extension PersonalizeEventsClientTypes.Event: Swift.Codable, ClientRuntime.Reflection {
...
extension PersonalizeEventsClientTypes.Event: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Event(eventId: \(Swift.String(describing: eventId)), eventType: \(Swift.String(describing: eventType)), eventValue: \(Swift.String(describing: eventValue)), impression: \(Swift.String(describing: impression)), itemId: \(Swift.String(describing: itemId)), properties: \(Swift.String(describing: properties)), recommendationId: \(Swift.String(describing: recommendationId)), sentAt: \(Swift.String(describing: sentAt)))"}
}
...
extension PersonalizeEventsClientTypes.Item: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case itemId
        case properties
    }
...
extension PersonalizeEventsClientTypes.Item: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Item(itemId: \(Swift.String(describing: itemId)), properties: \(Swift.String(describing: properties)))"}
}
...
extension PutEventsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutEventsInput(eventList: \(Swift.String(describing: eventList)), sessionId: \(Swift.String(describing: sessionId)), trackingId: \(Swift.String(describing: trackingId)), userId: \(Swift.String(describing: userId)))"}
}
...
public struct PutEventsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutEventsInputURLHostMiddleware"
    ...
    public typealias MInput = PutEventsInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutEventsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutEventsOutputError>
}

public struct PutEventsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutEventsInputURLPathMiddleware"
...
public struct PutEventsInput: Swift.Equatable {
    ...
    ///       <a href="https://docs.aws.amazon.com/personalize/latest/dg/API_CreateEventTracker.html">CreateEventTracker API.
    /// This member is required.
...
struct PutEventsInputBody: Swift.Equatable {
    ...
    public let eventList: [PersonalizeEventsClientTypes.Event]?
}
...
public struct PutItemsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutItemsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutItemsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutItemsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutItemsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutItemsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutItemsOutputError>
}

extension PutItemsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutItemsInput(datasetArn: \(Swift.String(describing: datasetArn)), items: \(Swift.String(describing: items)))"}
}

extension PutItemsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case datasetArn
        case items
    }
...
public struct PutItemsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutItemsInputHeadersMiddleware"
...
public struct PutItemsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutItemsInputQueryItemMiddleware"
...
public struct PutItemsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutItemsInputURLHostMiddleware"
    ...
    public typealias MInput = PutItemsInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutItemsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutItemsOutputError>
}

public struct PutItemsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutItemsInputURLPathMiddleware"
...
struct PutItemsInputBody: Swift.Equatable {
    ...
    public let items: [PersonalizeEventsClientTypes.Item]?
}
...
extension PutItemsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct PutItemsOutputResponseBody: Swift.Equatable {
}

extension PutItemsOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct PutUsersInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutUsersInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutUsersInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutUsersOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutUsersInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutUsersOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutUsersOutputError>
}

extension PutUsersInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutUsersInput(datasetArn: \(Swift.String(describing: datasetArn)), users: \(Swift.String(describing: users)))"}
}

extension PutUsersInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case datasetArn
        case users
    }
...
public struct PutUsersInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutUsersInputHeadersMiddleware"
...
public struct PutUsersInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutUsersInputQueryItemMiddleware"
...
public struct PutUsersInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutUsersInputURLHostMiddleware"
    ...
    public typealias MInput = PutUsersInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutUsersOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutUsersOutputError>
}

public struct PutUsersInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutUsersInputURLPathMiddleware"
...
struct PutUsersInputBody: Swift.Equatable {
    public let datasetArn: Swift.String?
    public let users: [PersonalizeEventsClientTypes.User]?
}
...
extension PutUsersOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct PutUsersOutputResponseBody: Swift.Equatable {
}

extension PutUsersOutputResponseBody: Swift.Decodable {
...
extension PersonalizeEventsClientTypes.User: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case properties
        case userId
    }
...
extension PersonalizeEventsClientTypes.User: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "User(properties: \(Swift.String(describing: properties)), userId: \(Swift.String(describing: userId)))"}
}
