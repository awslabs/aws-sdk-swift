...
public struct GetPersonalizedRankingInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPersonalizedRankingInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetPersonalizedRankingInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetPersonalizedRankingOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetPersonalizedRankingInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetPersonalizedRankingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetPersonalizedRankingOutputError>
}

extension GetPersonalizedRankingInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetPersonalizedRankingInput(campaignArn: \(Swift.String(describing: campaignArn)), context: \(Swift.String(describing: context)), filterArn: \(Swift.String(describing: filterArn)), filterValues: \(Swift.String(describing: filterValues)), inputList: \(Swift.String(describing: inputList)), userId: \(Swift.String(describing: userId)))"}
}

extension GetPersonalizedRankingInput: Swift.Encodable, ClientRuntime.Reflection {
...
public struct GetPersonalizedRankingInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPersonalizedRankingInputHeadersMiddleware"
...
public struct GetPersonalizedRankingInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPersonalizedRankingInputQueryItemMiddleware"
...
public struct GetPersonalizedRankingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPersonalizedRankingInputURLHostMiddleware"
    ...
    public typealias MInput = GetPersonalizedRankingInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetPersonalizedRankingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetPersonalizedRankingOutputError>
}

public struct GetPersonalizedRankingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPersonalizedRankingInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/personalize-ranking"
...
public struct GetPersonalizedRankingInput: Swift.Equatable {
    ...
    ///       <a href="https://docs.aws.amazon.com/personalize/latest/dg/filter.html">Filtering Recommendations.
...
extension GetPersonalizedRankingOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetPersonalizedRankingOutputResponse(personalizedRanking: \(Swift.String(describing: personalizedRanking)), recommendationId: \(Swift.String(describing: recommendationId)))"}
}
...
struct GetPersonalizedRankingOutputResponseBody: Swift.Equatable {
    public let personalizedRanking: [PersonalizeRuntimeClientTypes.PredictedItem]?
...
public struct GetRecommendationsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRecommendationsInputBodyMiddleware"
...
extension GetRecommendationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRecommendationsInput(campaignArn: \(Swift.String(describing: campaignArn)), context: \(Swift.String(describing: context)), filterArn: \(Swift.String(describing: filterArn)), filterValues: \(Swift.String(describing: filterValues)), itemId: \(Swift.String(describing: itemId)), numResults: \(Swift.String(describing: numResults)), userId: \(Swift.String(describing: userId)))"}
}
...
extension GetRecommendationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRecommendationsOutputResponse(itemList: \(Swift.String(describing: itemList)), recommendationId: \(Swift.String(describing: recommendationId)))"}
}
...
struct GetRecommendationsOutputResponseBody: Swift.Equatable {
    public let itemList: [PersonalizeRuntimeClientTypes.PredictedItem]?
    public let recommendationId: Swift.String?
}
...
extension PersonalizeRuntimeClientTypes.PredictedItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case itemId
        case score
    }
...
extension PersonalizeRuntimeClientTypes.PredictedItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PredictedItem(itemId: \(Swift.String(describing: itemId)), score: \(Swift.String(describing: score)))"}
}
