...
public struct DescribeJournalKinesisStreamInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DescribeJournalKinesisStreamOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DescribeJournalKinesisStreamOutput>
