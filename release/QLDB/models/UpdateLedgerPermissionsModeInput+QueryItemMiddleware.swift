...
public struct UpdateLedgerPermissionsModeInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<UpdateLedgerPermissionsModeOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<UpdateLedgerPermissionsModeOutput>
