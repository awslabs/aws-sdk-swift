...
extension CreateLedgerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateLedgerInput(deletionProtection: \(Swift.String(describing: deletionProtection)), name: \(Swift.String(describing: name)), permissionsMode: \(Swift.String(describing: permissionsMode)), tags: \(Swift.String(describing: tags)))"}
}
...
extension QldbClientTypes {
    ...
    public struct JournalKinesisStreamDescription: Swift.Equatable {
        ...
        public let errorCause: QldbClientTypes.ErrorCause?
        ...
        public let status: QldbClientTypes.StreamStatus?
...
extension QldbClientTypes {
    ...
    public struct JournalS3ExportDescription: Swift.Equatable {
        ...
        public let exportCreationTime: ClientRuntime.Date?
        ...
        public let status: QldbClientTypes.ExportStatus?
...
extension QldbClientTypes {
    ...
    public struct KinesisConfiguration: Swift.Equatable {
        ...
        ///          Guide</i>.</p>
        public let aggregationEnabled: Swift.Bool?
...
extension ResourcePreconditionNotMetException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct ResourcePreconditionNotMetException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension QldbClientTypes {
    ...
    public struct S3EncryptionConfiguration: Swift.Equatable {
        ...
        ///          Guide</i>.</p>
        public let objectEncryptionType: QldbClientTypes.S3ObjectEncryptionType?
...
extension QldbClientTypes {
    ...
    public struct S3ExportConfiguration: Swift.Equatable {
        ...
        ///          bucket.</p>
        public let encryptionConfiguration: QldbClientTypes.S3EncryptionConfiguration?
...
extension UpdateLedgerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateLedgerInput(deletionProtection: \(Swift.String(describing: deletionProtection)), name: \(Swift.String(describing: name)))"}
}
...
extension UpdateLedgerOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateLedgerOutputResponse(arn: \(Swift.String(describing: arn)), creationDateTime: \(Swift.String(describing: creationDateTime)), deletionProtection: \(Swift.String(describing: deletionProtection)), name: \(Swift.String(describing: name)), state: \(Swift.String(describing: state)))"}
}
