...
extension QldbClient: QldbClientProtocol {
    ...
    ///          expires.</p>
    public func cancelJournalKinesisStream(input: CancelJournalKinesisStreamInput, completion: @escaping (SdkResult<CancelJournalKinesisStreamOutput, CancelJournalKinesisStreamOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<CancelJournalKinesisStreamInput, CancelJournalKinesisStreamOutput, CancelJournalKinesisStreamOutputError>(id: "cancelJournalKinesisStream")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CancelJournalKinesisStreamInput, CancelJournalKinesisStreamOutput, CancelJournalKinesisStreamOutputError>(contentType: "application/json"))
    ...
    public func createLedger(input: CreateLedgerInput, completion: @escaping (SdkResult<CreateLedgerOutput, CreateLedgerOutputError>) -> Void)
    {
        let urlPath = "/ledgers"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateLedgerInput, CreateLedgerOutput, CreateLedgerOutputError>(id: "createLedger")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateLedgerInput, CreateLedgerOutput, CreateLedgerOutputError>(contentType: "application/json"))
    ...
    public func deleteLedger(input: DeleteLedgerInput, completion: @escaping (SdkResult<DeleteLedgerOutput, DeleteLedgerOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteLedgerInput, DeleteLedgerOutput, DeleteLedgerOutputError>(id: "deleteLedger")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteLedgerInput, DeleteLedgerOutput, DeleteLedgerOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             Guide</i>.</p>
    public func describeJournalKinesisStream(input: DescribeJournalKinesisStreamInput, completion: @escaping (SdkResult<DescribeJournalKinesisStreamOutput, DescribeJournalKinesisStreamOutputError>) -> Void)
    {
        guard let ledgerName = input.ledgerName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component ledgerName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeJournalKinesisStreamInput, DescribeJournalKinesisStreamOutput, DescribeJournalKinesisStreamOutputError>(id: "describeJournalKinesisStream")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeJournalKinesisStreamInput, DescribeJournalKinesisStreamOutput, DescribeJournalKinesisStreamOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             <code>ResourceNotFoundException</code>.</p>
    public func describeJournalS3Export(input: DescribeJournalS3ExportInput, completion: @escaping (SdkResult<DescribeJournalS3ExportOutput, DescribeJournalS3ExportOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeJournalS3ExportInput, DescribeJournalS3ExportOutput, DescribeJournalS3ExportOutputError>(id: "describeJournalS3Export")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeJournalS3ExportInput, DescribeJournalS3ExportOutput, DescribeJournalS3ExportOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeLedger(input: DescribeLedgerInput, completion: @escaping (SdkResult<DescribeLedgerOutput, DescribeLedgerOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeLedgerInput, DescribeLedgerOutput, DescribeLedgerOutputError>(id: "describeLedger")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeLedgerInput, DescribeLedgerOutput, DescribeLedgerOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func exportJournalToS3(input: ExportJournalToS3Input, completion: @escaping (SdkResult<ExportJournalToS3Output, ExportJournalToS3OutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ExportJournalToS3Input, ExportJournalToS3Output, ExportJournalToS3OutputError>(id: "exportJournalToS3")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ExportJournalToS3Input, ExportJournalToS3Output, ExportJournalToS3OutputError>(contentType: "application/json"))
    ...
    public func getBlock(input: GetBlockInput, completion: @escaping (SdkResult<GetBlockOutput, GetBlockOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBlockInput, GetBlockOutput, GetBlockOutputError>(id: "getBlock")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBlockInput, GetBlockOutput, GetBlockOutputError>(contentType: "application/json"))
    ...
    public func getDigest(input: GetDigestInput, completion: @escaping (SdkResult<GetDigestOutput, GetDigestOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetDigestInput, GetDigestOutput, GetDigestOutputError>(id: "getDigest")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetDigestInput, GetDigestOutput, GetDigestOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          multiple times.</p>
    public func listJournalKinesisStreamsForLedger(input: ListJournalKinesisStreamsForLedgerInput, completion: @escaping (SdkResult<ListJournalKinesisStreamsForLedgerOutput, ListJournalKinesisStreamsForLedgerOutputError>) -> Void)
    {
        guard let ledgerName = input.ledgerName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component ledgerName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListJournalKinesisStreamsForLedgerInput, ListJournalKinesisStreamsForLedgerOutput, ListJournalKinesisStreamsForLedgerOutputError>(id: "listJournalKinesisStreamsForLedger")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListJournalKinesisStreamsForLedgerInput, ListJournalKinesisStreamsForLedgerOutput, ListJournalKinesisStreamsForLedgerOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          <p>This action does not return any expired export jobs. For more information, see <a href="https://docs.aws.amazon.com/qldb/latest/developerguide/export-journal.request.html#export-journal.request.expiration">Export job expiration</a> in the <i>Amazon QLDB Developer
    ///          Guide</i>.</p>
    public func listJournalS3Exports(input: ListJournalS3ExportsInput, completion: @escaping (SdkResult<ListJournalS3ExportsOutput, ListJournalS3ExportsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListJournalS3ExportsInput, ListJournalS3ExportsOutput, ListJournalS3ExportsOutputError>(id: "listJournalS3Exports")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListJournalS3ExportsInput, ListJournalS3ExportsOutput, ListJournalS3ExportsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          <p>This action does not return any expired export jobs. For more information, see <a href="https://docs.aws.amazon.com/qldb/latest/developerguide/export-journal.request.html#export-journal.request.expiration">Export job expiration</a> in the <i>Amazon QLDB Developer
    ///          Guide</i>.</p>
    public func listJournalS3ExportsForLedger(input: ListJournalS3ExportsForLedgerInput, completion: @escaping (SdkResult<ListJournalS3ExportsForLedgerOutput, ListJournalS3ExportsForLedgerOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListJournalS3ExportsForLedgerInput, ListJournalS3ExportsForLedgerOutput, ListJournalS3ExportsForLedgerOutputError>(id: "listJournalS3ExportsForLedger")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListJournalS3ExportsForLedgerInput, ListJournalS3ExportsForLedgerOutput, ListJournalS3ExportsForLedgerOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listLedgers(input: ListLedgersInput, completion: @escaping (SdkResult<ListLedgersOutput, ListLedgersOutputError>) -> Void)
    {
        let urlPath = "/ledgers"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListLedgersInput, ListLedgersOutput, ListLedgersOutputError>(id: "listLedgers")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListLedgersInput, ListLedgersOutput, ListLedgersOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func streamJournalToKinesis(input: StreamJournalToKinesisInput, completion: @escaping (SdkResult<StreamJournalToKinesisOutput, StreamJournalToKinesisOutputError>) -> Void)
    {
        guard let ledgerName = input.ledgerName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component ledgerName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StreamJournalToKinesisInput, StreamJournalToKinesisOutput, StreamJournalToKinesisOutputError>(id: "streamJournalToKinesis")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StreamJournalToKinesisInput, StreamJournalToKinesisOutput, StreamJournalToKinesisOutputError>(contentType: "application/json"))
    ...
    public func updateLedger(input: UpdateLedgerInput, completion: @escaping (SdkResult<UpdateLedgerOutput, UpdateLedgerOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateLedgerInput, UpdateLedgerOutput, UpdateLedgerOutputError>(id: "updateLedger")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateLedgerInput, UpdateLedgerOutput, UpdateLedgerOutputError>(contentType: "application/json"))
    ...
    ///                Developer Guide</i>.</p>
    ///          </important>
    public func updateLedgerPermissionsMode(input: UpdateLedgerPermissionsModeInput, completion: @escaping (SdkResult<UpdateLedgerPermissionsModeOutput, UpdateLedgerPermissionsModeOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "qldb")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateLedgerPermissionsModeInput, UpdateLedgerPermissionsModeOutput, UpdateLedgerPermissionsModeOutputError>(id: "updateLedgerPermissionsMode")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateLedgerPermissionsModeInput, UpdateLedgerPermissionsModeOutput, UpdateLedgerPermissionsModeOutputError>(contentType: "application/json"))
