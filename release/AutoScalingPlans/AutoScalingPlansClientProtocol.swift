...
public protocol AutoScalingPlansClientProtocol {
    ...
    func createScalingPlan(input: CreateScalingPlanInput, completion: @escaping (SdkResult<CreateScalingPlanOutput, CreateScalingPlanOutputError>) -> Void)
    ...
    func deleteScalingPlan(input: DeleteScalingPlanInput, completion: @escaping (SdkResult<DeleteScalingPlanOutput, DeleteScalingPlanOutputError>) -> Void)
    /// <p>Describes the scalable resources in the specified scaling plan.</p>
    func describeScalingPlanResources(input: DescribeScalingPlanResourcesInput, completion: @escaping (SdkResult<DescribeScalingPlanResourcesOutput, DescribeScalingPlanResourcesOutputError>) -> Void)
    /// <p>Describes one or more of your scaling plans.</p>
    func describeScalingPlans(input: DescribeScalingPlansInput, completion: @escaping (SdkResult<DescribeScalingPlansOutput, DescribeScalingPlansOutputError>) -> Void)
    ...
    func getScalingPlanResourceForecastData(input: GetScalingPlanResourceForecastDataInput, completion: @escaping (SdkResult<GetScalingPlanResourceForecastDataOutput, GetScalingPlanResourceForecastDataOutputError>) -> Void)
    ...
    ///          deleted.</p>
    func updateScalingPlan(input: UpdateScalingPlanInput, completion: @escaping (SdkResult<UpdateScalingPlanOutput, UpdateScalingPlanOutputError>) -> Void)
}
