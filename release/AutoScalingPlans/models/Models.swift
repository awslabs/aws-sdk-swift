...
public enum CreateScalingPlanOutputError: Swift.Error, Equatable {
...
public enum DeleteScalingPlanOutputError: Swift.Error, Equatable {
    case concurrentUpdateException(ConcurrentUpdateException)
    case internalServiceException(InternalServiceException)
...
public enum DescribeScalingPlanResourcesOutputError: Swift.Error, Equatable {
    case concurrentUpdateException(ConcurrentUpdateException)
    case internalServiceException(InternalServiceException)
...
public enum DescribeScalingPlansOutputError: Swift.Error, Equatable {
    case concurrentUpdateException(ConcurrentUpdateException)
    case internalServiceException(InternalServiceException)
    case invalidNextTokenException(InvalidNextTokenException)
    case validationException(ValidationException)
...
public enum GetScalingPlanResourceForecastDataOutputError: Swift.Error, Equatable {
    case internalServiceException(InternalServiceException)
    case validationException(ValidationException)
    case unknown(UnknownAWSHttpServiceError)
}
...
public enum UpdateScalingPlanOutputError: Swift.Error, Equatable {
    case concurrentUpdateException(ConcurrentUpdateException)
    case internalServiceException(InternalServiceException)
    case objectNotFoundException(ObjectNotFoundException)
    case validationException(ValidationException)
