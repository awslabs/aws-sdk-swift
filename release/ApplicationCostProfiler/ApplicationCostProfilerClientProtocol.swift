...
public protocol ApplicationCostProfilerClientProtocol {
    ...
    ///       generated.</p>
    func deleteReportDefinition(input: DeleteReportDefinitionInput, completion: @escaping (SdkResult<DeleteReportDefinitionOutput, DeleteReportDefinitionOutputError>) -> Void)
    /// <p>Retrieves the definition of a report already configured in AWS Application Cost Profiler.</p>
    func getReportDefinition(input: GetReportDefinitionInput, completion: @escaping (SdkResult<GetReportDefinitionOutput, GetReportDefinitionOutputError>) -> Void)
    ...
    ///       asynchronously.</p>
    func importApplicationUsage(input: ImportApplicationUsageInput, completion: @escaping (SdkResult<ImportApplicationUsageOutput, ImportApplicationUsageOutputError>) -> Void)
    ...
    func listReportDefinitions(input: ListReportDefinitionsInput, completion: @escaping (SdkResult<ListReportDefinitionsOutput, ListReportDefinitionsOutputError>) -> Void)
    /// <p>Creates the report definition for a report in Application Cost Profiler.</p>
    func putReportDefinition(input: PutReportDefinitionInput, completion: @escaping (SdkResult<PutReportDefinitionOutput, PutReportDefinitionOutputError>) -> Void)
    /// <p>Updates existing report in AWS Application Cost Profiler.</p>
    func updateReportDefinition(input: UpdateReportDefinitionInput, completion: @escaping (SdkResult<UpdateReportDefinitionOutput, UpdateReportDefinitionOutputError>) -> Void)
}
