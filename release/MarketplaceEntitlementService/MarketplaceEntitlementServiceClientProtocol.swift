...
///             </li>
///          </ul>
public protocol MarketplaceEntitlementServiceClientProtocol {
    ...
    func getEntitlements(input: GetEntitlementsInput, completion: @escaping (SdkResult<GetEntitlementsOutput, GetEntitlementsOutputError>) -> Void)
}
