...
extension Wafv2ClientTypes {
    ...
    public struct CustomResponse: Swift.Equatable {
        ...
        ///          For a list of status codes that you can use in your custom reqponses, see <a href="https://docs.aws.amazon.com/waf/latest/developerguide/customizing-the-response-status-codes.html">Supported status codes for custom response in the
        ///          <a href="https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html">WAF Developer Guide.
        /// This member is required.
...
extension DescribeManagedRuleGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeManagedRuleGroupInput(name: \(Swift.String(describing: name)), scope: \(Swift.String(describing: scope)), vendorName: \(Swift.String(describing: vendorName)), versionName: \(Swift.String(describing: versionName)))"}
}
...
extension DescribeManagedRuleGroupOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeManagedRuleGroupOutputResponse(availableLabels: \(Swift.String(describing: availableLabels)), capacity: \(Swift.String(describing: capacity)), consumedLabels: \(Swift.String(describing: consumedLabels)), labelNamespace: \(Swift.String(describing: labelNamespace)), rules: \(Swift.String(describing: rules)), snsTopicArn: \(Swift.String(describing: snsTopicArn)), versionName: \(Swift.String(describing: versionName)))"}
}
...
public struct DescribeManagedRuleGroupOutputResponse: Swift.Equatable {
    ...
    ///          For more information, see the <a href="https://docs.aws.amazon.com/sns/latest/dg/welcome.html">Amazon Simple Notification Service Developer Guide.
...
public struct GetManagedRuleSetInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetManagedRuleSetInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetManagedRuleSetInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetManagedRuleSetOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetManagedRuleSetInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetManagedRuleSetOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetManagedRuleSetOutputError>
}

extension GetManagedRuleSetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetManagedRuleSetInput(id: \(Swift.String(describing: id)), name: \(Swift.String(describing: name)), scope: \(Swift.String(describing: scope)))"}
}

extension GetManagedRuleSetInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case id = "Id"
        case name = "Name"
        case scope = "Scope"
...
public struct GetManagedRuleSetInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetManagedRuleSetInputHeadersMiddleware"
...
public struct GetManagedRuleSetInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetManagedRuleSetInputQueryItemMiddleware"
...
extension GetManagedRuleSetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetManagedRuleSetOutputResponse(lockToken: \(Swift.String(describing: lockToken)), managedRuleSet: \(Swift.String(describing: managedRuleSet)))"}
}
...
public struct GetManagedRuleSetOutputResponse: Swift.Equatable {
    ...
    public let managedRuleSet: Wafv2ClientTypes.ManagedRuleSet?
...
extension GetRuleGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRuleGroupInput(aRN: \(Swift.String(describing: aRN)), id: \(Swift.String(describing: id)), name: \(Swift.String(describing: name)), scope: \(Swift.String(describing: scope)))"}
}
...
public struct ListAvailableManagedRuleGroupVersionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableManagedRuleGroupVersionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListAvailableManagedRuleGroupVersionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListAvailableManagedRuleGroupVersionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListAvailableManagedRuleGroupVersionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListAvailableManagedRuleGroupVersionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAvailableManagedRuleGroupVersionsOutputError>
}

extension ListAvailableManagedRuleGroupVersionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAvailableManagedRuleGroupVersionsInput(limit: \(Swift.String(describing: limit)), name: \(Swift.String(describing: name)), nextMarker: \(Swift.String(describing: nextMarker)), scope: \(Swift.String(describing: scope)), vendorName: \(Swift.String(describing: vendorName)))"}
}

extension ListAvailableManagedRuleGroupVersionsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case limit = "Limit"
        case name = "Name"
...
public struct ListAvailableManagedRuleGroupVersionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableManagedRuleGroupVersionsInputHeadersMiddleware"
...
public struct ListAvailableManagedRuleGroupVersionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableManagedRuleGroupVersionsInputQueryItemMiddleware"
...
extension ListAvailableManagedRuleGroupVersionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAvailableManagedRuleGroupVersionsOutputResponse(nextMarker: \(Swift.String(describing: nextMarker)), versions: \(Swift.String(describing: versions)))"}
}
...
public struct ListAvailableManagedRuleGroupVersionsOutputResponse: Swift.Equatable {
    ...
    public let versions: [Wafv2ClientTypes.ManagedRuleGroupVersion]?
...
public struct ListManagedRuleSetsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListManagedRuleSetsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListManagedRuleSetsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListManagedRuleSetsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListManagedRuleSetsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListManagedRuleSetsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListManagedRuleSetsOutputError>
}

extension ListManagedRuleSetsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListManagedRuleSetsInput(limit: \(Swift.String(describing: limit)), nextMarker: \(Swift.String(describing: nextMarker)), scope: \(Swift.String(describing: scope)))"}
}

extension ListManagedRuleSetsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case limit = "Limit"
        case nextMarker = "NextMarker"
        case scope = "Scope"
...
public struct ListManagedRuleSetsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListManagedRuleSetsInputHeadersMiddleware"
...
public struct ListManagedRuleSetsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListManagedRuleSetsInputQueryItemMiddleware"
...
extension ListManagedRuleSetsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListManagedRuleSetsOutputResponse(managedRuleSets: \(Swift.String(describing: managedRuleSets)), nextMarker: \(Swift.String(describing: nextMarker)))"}
}
...
public struct ListManagedRuleSetsOutputResponse: Swift.Equatable {
    ...
    public let managedRuleSets: [Wafv2ClientTypes.ManagedRuleSetSummary]?
    /// When you request a list of objects with a Limit setting, if the number of objects that are still available
    ///          for retrieval exceeds the limit, WAF returns a NextMarker
    ///          value in the response. To retrieve the next batch of objects, provide the marker from the prior call in your next request.
    public let nextMarker: Swift.String?
...
extension Wafv2ClientTypes.ManagedRuleGroupStatement: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ManagedRuleGroupStatement(excludedRules: \(Swift.String(describing: excludedRules)), name: \(Swift.String(describing: name)), scopeDownStatement: \(Swift.String(describing: scopeDownStatement)), vendorName: \(Swift.String(describing: vendorName)), version: \(Swift.String(describing: version)))"}
}
...
extension Wafv2ClientTypes.ManagedRuleGroupVersion: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension Wafv2ClientTypes.ManagedRuleGroupVersion: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ManagedRuleGroupVersion(lastUpdateTimestamp: \(Swift.String(describing: lastUpdateTimestamp)), name: \(Swift.String(describing: name)))"}
}
...
extension Wafv2ClientTypes.ManagedRuleSet: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case aRN = "ARN"
        case description = "Description"
        case id = "Id"
...
extension Wafv2ClientTypes.ManagedRuleSet: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ManagedRuleSet(aRN: \(Swift.String(describing: aRN)), description: \(Swift.String(describing: description)), id: \(Swift.String(describing: id)), labelNamespace: \(Swift.String(describing: labelNamespace)), name: \(Swift.String(describing: name)), publishedVersions: \(Swift.String(describing: publishedVersions)), recommendedVersion: \(Swift.String(describing: recommendedVersion)))"}
}
...
extension Wafv2ClientTypes {
    ...
    public struct ManagedRuleSet: Swift.Equatable {
        ...
        public let publishedVersions: [Swift.String:Wafv2ClientTypes.ManagedRuleSetVersion]?
        /// The version that you would like your customers to use.
        public let recommendedVersion: Swift.String?
...
extension Wafv2ClientTypes.ManagedRuleSetSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case aRN = "ARN"
        case description = "Description"
        case id = "Id"
...
extension Wafv2ClientTypes.ManagedRuleSetSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ManagedRuleSetSummary(aRN: \(Swift.String(describing: aRN)), description: \(Swift.String(describing: description)), id: \(Swift.String(describing: id)), labelNamespace: \(Swift.String(describing: labelNamespace)), lockToken: \(Swift.String(describing: lockToken)), name: \(Swift.String(describing: name)))"}
}
...
extension Wafv2ClientTypes.ManagedRuleSetVersion: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension Wafv2ClientTypes.ManagedRuleSetVersion: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ManagedRuleSetVersion(associatedRuleGroupArn: \(Swift.String(describing: associatedRuleGroupArn)), capacity: \(Swift.String(describing: capacity)), expiryTimestamp: \(Swift.String(describing: expiryTimestamp)), forecastedLifetime: \(Swift.String(describing: forecastedLifetime)), lastUpdateTimestamp: \(Swift.String(describing: lastUpdateTimestamp)), publishTimestamp: \(Swift.String(describing: publishTimestamp)))"}
}
...
extension Wafv2ClientTypes {
    ...
    public struct ManagedRuleSetVersion: Swift.Equatable {
        ...
        public let associatedRuleGroupArn: Swift.String?
        /// The web ACL capacity units (WCUs) required for this rule group.
        ///           WAF uses WCUs to calculate and control the operating
        ///          resources that are used to run your rules, rule groups, and web ACLs. WAF
        ///          calculates capacity differently for each rule type, to reflect the relative cost of each rule.
        ...
        public let expiryTimestamp: ClientRuntime.Date?
        /// The amount of time you expect this version of your managed rule group to last, in days.
        ///
        public let forecastedLifetime: Swift.Int?
        /// The last time that you updated this version.
        ///          Times are in Coordinated Universal Time (UTC) format. UTC format includes the special designator, Z. For example, "2016-09-27T14:50Z".
        public let lastUpdateTimestamp: ClientRuntime.Date?
        /// The time that you first published this version.
        ///          Times are in Coordinated Universal Time (UTC) format. UTC format includes the special designator, Z. For example, "2016-09-27T14:50Z".
        public let publishTimestamp: ClientRuntime.Date?
...
public struct PutManagedRuleSetVersionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutManagedRuleSetVersionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutManagedRuleSetVersionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutManagedRuleSetVersionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutManagedRuleSetVersionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutManagedRuleSetVersionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutManagedRuleSetVersionsOutputError>
}

extension PutManagedRuleSetVersionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutManagedRuleSetVersionsInput(id: \(Swift.String(describing: id)), lockToken: \(Swift.String(describing: lockToken)), name: \(Swift.String(describing: name)), recommendedVersion: \(Swift.String(describing: recommendedVersion)), scope: \(Swift.String(describing: scope)), versionsToPublish: \(Swift.String(describing: versionsToPublish)))"}
}

extension PutManagedRuleSetVersionsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case id = "Id"
        case lockToken = "LockToken"
        case name = "Name"
...
public struct PutManagedRuleSetVersionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutManagedRuleSetVersionsInputHeadersMiddleware"
...
public struct PutManagedRuleSetVersionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutManagedRuleSetVersionsInputQueryItemMiddleware"
...
public struct PutManagedRuleSetVersionsInput: Swift.Equatable {
    ...
    ///
    public let versionsToPublish: [Swift.String:Wafv2ClientTypes.VersionToPublish]?
...
extension PutManagedRuleSetVersionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutManagedRuleSetVersionsOutputResponse(nextLockToken: \(Swift.String(describing: nextLockToken)))"}
}
...
extension Wafv2ClientTypes {
    ...
    public struct SampledHTTPRequest: Swift.Equatable {
        ...
        ///          format for this name is <vendor name>#<managed rule group name>#<rule
        ///             name>. For your own rule groups, the format for this name is <rule
        ///             group name>#<rule name>. If the rule is not in a rule group, this field
        ///          is absent.
...
public struct UpdateManagedRuleSetVersionExpiryDateInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateManagedRuleSetVersionExpiryDateInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateManagedRuleSetVersionExpiryDateInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateManagedRuleSetVersionExpiryDateOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateManagedRuleSetVersionExpiryDateInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateManagedRuleSetVersionExpiryDateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateManagedRuleSetVersionExpiryDateOutputError>
}

extension UpdateManagedRuleSetVersionExpiryDateInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateManagedRuleSetVersionExpiryDateInput(expiryTimestamp: \(Swift.String(describing: expiryTimestamp)), id: \(Swift.String(describing: id)), lockToken: \(Swift.String(describing: lockToken)), name: \(Swift.String(describing: name)), scope: \(Swift.String(describing: scope)), versionToExpire: \(Swift.String(describing: versionToExpire)))"}
}

extension UpdateManagedRuleSetVersionExpiryDateInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case expiryTimestamp = "ExpiryTimestamp"
        case id = "Id"
        case lockToken = "LockToken"
...
public struct UpdateManagedRuleSetVersionExpiryDateInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateManagedRuleSetVersionExpiryDateInputHeadersMiddleware"
...
public struct UpdateManagedRuleSetVersionExpiryDateInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateManagedRuleSetVersionExpiryDateInputQueryItemMiddleware"
...
public struct UpdateManagedRuleSetVersionExpiryDateInput: Swift.Equatable {
    ...
    ///          rule group.
    /// This member is required.
    public let versionToExpire: Swift.String?
...
extension UpdateManagedRuleSetVersionExpiryDateOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateManagedRuleSetVersionExpiryDateOutputResponse(expiringVersion: \(Swift.String(describing: expiringVersion)), expiryTimestamp: \(Swift.String(describing: expiryTimestamp)), nextLockToken: \(Swift.String(describing: nextLockToken)))"}
}
...
public struct UpdateManagedRuleSetVersionExpiryDateOutputResponse: Swift.Equatable {
    ...
    public let expiringVersion: Swift.String?
...
extension Wafv2ClientTypes.VersionToPublish: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case associatedRuleGroupArn = "AssociatedRuleGroupArn"
        case forecastedLifetime = "ForecastedLifetime"
    }
...
extension Wafv2ClientTypes.VersionToPublish: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "VersionToPublish(associatedRuleGroupArn: \(Swift.String(describing: associatedRuleGroupArn)), forecastedLifetime: \(Swift.String(describing: forecastedLifetime)))"}
}
...
extension WAFExpiredManagedRuleGroupVersionException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WAFExpiredManagedRuleGroupVersionException(message: \(Swift.String(describing: message)))"}
}
...
///          account. For more information, see <a href="https://docs.aws.amazon.com/waf/latest/developerguide/limits.html">WAF quotas in the
///             WAF Developer Guide.
