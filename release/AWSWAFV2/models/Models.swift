...
public struct CreateIPSetInput: Swift.Equatable {
    /// Contains an array of strings that specifies zero or more IP addresses or blocks of IP addresses in Classless Inter-Domain Routing (CIDR) notation. WAF supports all IPv4 and IPv6 CIDR ranges except for /0. Example address strings:
    ///
...
extension Wafv2ClientTypes.ManagedRuleGroupSummary: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let nameDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .name)
        name = nameDecoded
        let versioningSupportedDecoded = try containerValues.decode(Swift.Bool.self, forKey: .versioningSupported)
