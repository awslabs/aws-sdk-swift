...
extension NetworkFirewallClientTypes {
    ...
    public struct Attachment: Swift.Equatable {
        ...
        /// The current status of the firewall endpoint in the subnet. This value reflects both the
        ///          instantiation of the endpoint in the VPC subnet and the sync states that are reported in
        ///          the Config settings. When this value is READY, the endpoint is
...
public struct CreateFirewallPolicyInput: Swift.Equatable {
    ...
    ///          dry run set to FALSE, but doesn't make additions or changes to your resources. This option allows you to make sure that you have
...
extension NetworkFirewallClientTypes {
    ...
    ///          dimension value.
    ///          For more information about CloudWatch custom metric dimensions, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/publishingMetrics.html#usingDimensions">Publishing Custom Metrics in the <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html">Amazon CloudWatch User
    ///             Guide.
...
extension NetworkFirewallClientTypes {
    ...
    ///          describe. You can use the information provided in the metadata to retrieve and manage a
    ///          firewall policy. You can retrieve all objects for a firewall policy by calling DescribeFirewallPolicy.
...
extension NetworkFirewallClientTypes {
    ...
    public struct FirewallStatus: Swift.Equatable {
        ...
        ///          in the Config settings for all of the Availability Zones where you have
        ...
        ///          Availability Zones where you've configured it. This setting is READY only when
...
/// AWS doesn't currently have enough available capacity to fulfill your request. Try your
///          request later.
...
public struct ListFirewallPoliciesOutputResponse: Swift.Equatable {
    /// The metadata for the firewall policies. Depending on your setting for max results and
    ///          the number of firewall policies that you have, this might not be the full list.
...
public struct ListFirewallsInput: Swift.Equatable {
    ...
    ///          value in the response. To retrieve the next batch of objects, use the token returned from the prior request in your next request.
    public var nextToken: Swift.String?
    /// The unique identifiers of the VPCs that you want Network Firewall to retrieve the firewalls
...
extension NetworkFirewallClientTypes {
    ...
    ///           rules in the endpoint, so it can properly filter network traffic. This is part of a SyncState for a firewall.
...
public struct PutResourcePolicyInput: Swift.Equatable {
    /// The AWS Identity and Access Management policy statement that lists the accounts that you want to share your rule group or firewall policy with
...
extension NetworkFirewallClientTypes {
    ...
    public struct RulesSource: Swift.Equatable {
        ...
        ///                                         <a href="https://suricata.readthedocs.io/en/suricata-5.0.0/rules/intro.html#">Rules Format.
...
extension NetworkFirewallClientTypes {
    ...
    ///          By default, Network Firewall domain list inspection only includes traffic coming from the VPC where you deploy the firewall. To inspect traffic from IP addresses outside of the deployment VPC, you set the HOME_NET rule variable to include the CIDR range of the deployment VPC plus the other CIDR ranges. For more information, see RuleVariables in this guide and <a href="https://docs.aws.amazon.com/network-firewall/latest/developerguide/stateful-rule-groups-domain-names.html">Stateful domain list rule groups in AWS Network Firewall in the Network Firewall Developer Guide.
...
extension NetworkFirewallClientTypes.StatefulRuleGroupReference: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StatefulRuleGroupReference(priority: \(Swift.String(describing: priority)), resourceArn: \(Swift.String(describing: resourceArn)))"}
}
...
extension NetworkFirewallClientTypes {
    ...
    public struct StatelessRulesAndCustomActions: Swift.Equatable {
        ...
        ///          name each custom action that you define, and then you can use it by name in your StatelessRule
        ///             RuleDefinition
...
extension NetworkFirewallClientTypes {
    ...
    public struct SyncState: Swift.Equatable {
        ...
        ///          endpoint in the subnet so that it's ready to take traffic. This is part of the FirewallStatus.
        public var attachment: NetworkFirewallClientTypes.Attachment?
        /// The configuration status of the firewall endpoint in a single VPC subnet. Network Firewall
        ///          provides each endpoint with the rules that are configured in the firewall policy. Each time
        ///          you add a subnet or modify the associated firewall policy, Network Firewall synchronizes the
        ///          rules in the endpoint, so it can properly filter network traffic. This is part of the FirewallStatus.
