...
extension NetworkFirewallClientTypes {
    ...
    public struct ActionDefinition: Swift.Equatable {
        ...
        var publishMetricAction: NetworkFirewallClientTypes.PublishMetricAction?
...
extension NetworkFirewallClientTypes {
    ...
    public struct Address: Swift.Equatable {
        ...
        var addressDefinition: Swift.String?
...
public struct AssociateFirewallPolicyInput: Swift.Equatable {
    ...
    var firewallName: Swift.String?
    /// The Amazon Resource Name (ARN) of the firewall policy.
    /// This member is required.
    var firewallPolicyArn: Swift.String?
...
public struct AssociateSubnetsInput: Swift.Equatable {
    ...
    /// This member is required.
    var subnetMappings: [NetworkFirewallClientTypes.SubnetMapping]?
    /// An optional token that you can use for optimistic locking. Network Firewall returns a token to your requests that access the firewall. The token marks the state of the firewall resource at the time of the request. To make an unconditional change to the firewall, omit the token in your update request. Without the token, Network Firewall performs your updates regardless of whether the firewall has changed since you last retrieved it. To make a conditional change to the firewall, provide the token in your update request. Network Firewall uses the token to ensure that the firewall hasn't changed since you last retrieved it. If it has changed, the operation fails with an InvalidTokenException. If this happens, retrieve the firewall again to get a current copy of it with a new token. Reapply your changes as needed, then try the operation again using the new token.
    var updateToken: Swift.String?
...
extension NetworkFirewallClientTypes {
    ...
    public struct Attachment: Swift.Equatable {
        ...
        var status: NetworkFirewallClientTypes.AttachmentStatus?
...
public struct CreateFirewallInput: Swift.Equatable {
    ...
    var deleteProtection: Swift.Bool
    ...
    var firewallPolicyChangeProtection: Swift.Bool
    /// A setting indicating whether the firewall is protected against changes to the subnet associations. Use this setting to protect against accidentally modifying the subnet associations for a firewall that is in use. When you create a firewall, the operation initializes this setting to TRUE.
    var subnetChangeProtection: Swift.Bool
    /// The public subnets to use for your Network Firewall firewalls. Each subnet must belong to a different Availability Zone in the VPC. Network Firewall creates a firewall endpoint in each subnet.
    /// This member is required.
    var subnetMappings: [NetworkFirewallClientTypes.SubnetMapping]?
    /// The key:value pairs to associate with the resource.
    var tags: [NetworkFirewallClientTypes.Tag]?
...
public struct CreateFirewallOutputResponse: Swift.Equatable {
    ...
    var firewall: NetworkFirewallClientTypes.Firewall?
    /// Detailed information about the current status of a [Firewall]. You can retrieve this for a firewall by calling [DescribeFirewall] and providing the firewall name and ARN.
    var firewallStatus: NetworkFirewallClientTypes.FirewallStatus?
...
public struct CreateFirewallPolicyInput: Swift.Equatable {
    ...
    /// This member is required.
    var firewallPolicy: NetworkFirewallClientTypes.FirewallPolicy?
    /// The descriptive name of the firewall policy. You can't change the name of a firewall policy after you create it.
    /// This member is required.
    var firewallPolicyName: Swift.String?
    /// The key:value pairs to associate with the resource.
    var tags: [NetworkFirewallClientTypes.Tag]?
...
public struct CreateFirewallPolicyOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var firewallPolicyResponse: NetworkFirewallClientTypes.FirewallPolicyResponse?
...
public struct CreateRuleGroupInput: Swift.Equatable {
    ...
    var ruleGroup: NetworkFirewallClientTypes.RuleGroup?
    ...
    /// This member is required.
    var type: NetworkFirewallClientTypes.RuleGroupType?
...
public struct CreateRuleGroupOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var ruleGroupResponse: NetworkFirewallClientTypes.RuleGroupResponse?
...
extension NetworkFirewallClientTypes {
    ...
    public struct CustomAction: Swift.Equatable {
        ...
        /// This member is required.
        var actionDefinition: NetworkFirewallClientTypes.ActionDefinition?
...
public struct DescribeLoggingConfigurationOutputResponse: Swift.Equatable {
    ...
    var loggingConfiguration: NetworkFirewallClientTypes.LoggingConfiguration?
...
public struct DescribeRuleGroupMetadataOutputResponse: Swift.Equatable {
    ...
    var statefulRuleOptions: NetworkFirewallClientTypes.StatefulRuleOptions?
    /// Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules. This setting is required for requests that do not include the RuleGroupARN.
    var type: NetworkFirewallClientTypes.RuleGroupType?
...
extension NetworkFirewallClientTypes {
    ...
    public struct FirewallPolicy: Swift.Equatable {
        ...
        var statefulDefaultActions: [Swift.String]?
        /// Additional options governing how Network Firewall handles stateful rules. The stateful rule groups that you use in your policy must have stateful rule options settings that are compatible with these settings.
        var statefulEngineOptions: NetworkFirewallClientTypes.StatefulEngineOptions?
        /// References to the stateful rule groups that are used in the policy. These define the inspection criteria in stateful rules.
        var statefulRuleGroupReferences: [NetworkFirewallClientTypes.StatefulRuleGroupReference]?
        /// The custom action definitions that are available for use in the firewall policy's StatelessDefaultActions setting. You name each custom action that you define, and then you can use it by name in your default actions specifications.
        var statelessCustomActions: [NetworkFirewallClientTypes.CustomAction]?
        ...
        var statelessRuleGroupReferences: [NetworkFirewallClientTypes.StatelessRuleGroupReference]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct FirewallPolicyResponse: Swift.Equatable {
        ...
        var consumedStatefulRuleCapacity: Swift.Int?
        /// The number of capacity units currently consumed by the policy's stateless rules.
        var consumedStatelessRuleCapacity: Swift.Int?
        /// A description of the firewall policy.
        var description: Swift.String?
        ...
        /// This member is required.
        var firewallPolicyId: Swift.String?
        /// The descriptive name of the firewall policy. You can't change the name of a firewall policy after you create it.
        /// This member is required.
        var firewallPolicyName: Swift.String?
        /// The current status of the firewall policy. You can retrieve this for a firewall policy by calling [DescribeFirewallPolicy] and providing the firewall policy's name or ARN.
        var firewallPolicyStatus: NetworkFirewallClientTypes.ResourceStatus?
        /// The number of firewalls that are associated with this firewall policy.
        var numberOfAssociations: Swift.Int?
        /// The key:value pairs to associate with the resource.
        var tags: [NetworkFirewallClientTypes.Tag]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct FirewallStatus: Swift.Equatable {
        ...
        /// This member is required.
        var configurationSyncStateSummary: NetworkFirewallClientTypes.ConfigurationSyncState?
        ...
        /// This member is required.
        var status: NetworkFirewallClientTypes.FirewallStatusValue?
        ...
        var syncStates: [Swift.String:NetworkFirewallClientTypes.SyncState]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct Header: Swift.Equatable {
        ...
        /// This member is required.
        var `protocol`: NetworkFirewallClientTypes.StatefulRuleProtocol?
        ...
        /// This member is required.
        var destinationPort: Swift.String?
        /// The direction of traffic flow to inspect. If set to ANY, the inspection matches bidirectional traffic, both from the source to the destination and from the destination to the source. If set to FORWARD, the inspection only matches traffic going from the source to the destination.
        /// This member is required.
        var direction: NetworkFirewallClientTypes.StatefulRuleDirection?
...
public struct ListFirewallPoliciesOutputResponse: Swift.Equatable {
    ...
    var firewallPolicies: [NetworkFirewallClientTypes.FirewallPolicyMetadata]?
    /// When you request a list of objects with a MaxResults setting, if the number of objects that are still available for retrieval exceeds the maximum you requested, Network Firewall returns a NextToken value in the response. To retrieve the next batch of objects, use the token returned from the prior request in your next request.
    var nextToken: Swift.String?
...
public struct ListFirewallsOutputResponse: Swift.Equatable {
    ...
    var firewalls: [NetworkFirewallClientTypes.FirewallMetadata]?
    /// When you request a list of objects with a MaxResults setting, if the number of objects that are still available for retrieval exceeds the maximum you requested, Network Firewall returns a NextToken value in the response. To retrieve the next batch of objects, use the token returned from the prior request in your next request.
    var nextToken: Swift.String?
...
public struct ListRuleGroupsInput: Swift.Equatable {
    ...
    var scope: NetworkFirewallClientTypes.ResourceManagedStatus?
...
public struct ListRuleGroupsOutputResponse: Swift.Equatable {
    ...
    var ruleGroups: [NetworkFirewallClientTypes.RuleGroupMetadata]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct LogDestinationConfig: Swift.Equatable {
        ...
        /// This member is required.
        var logDestination: [Swift.String:Swift.String]?
        ...
        /// This member is required.
        var logDestinationType: NetworkFirewallClientTypes.LogDestinationType?
        ...
        /// This member is required.
        var logType: NetworkFirewallClientTypes.LogType?
...
extension NetworkFirewallClientTypes {
    ...
    public struct LoggingConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var logDestinationConfigs: [NetworkFirewallClientTypes.LogDestinationConfig]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct MatchAttributes: Swift.Equatable {
        ...
        var destinationPorts: [NetworkFirewallClientTypes.PortRange]?
        /// The destination IP addresses and address ranges to inspect for, in CIDR notation. If not specified, this matches with any destination address.
        var destinations: [NetworkFirewallClientTypes.Address]?
        /// The protocols to inspect for, specified using each protocol's assigned internet protocol number (IANA). If not specified, this matches with any protocol.
        var protocols: [Swift.Int]?
        ...
        var sourcePorts: [NetworkFirewallClientTypes.PortRange]?
        /// The source IP addresses and address ranges to inspect for, in CIDR notation. If not specified, this matches with any source address.
        var sources: [NetworkFirewallClientTypes.Address]?
        /// The TCP flags and masks to inspect for. If not specified, this matches with any settings. This setting is only used for protocol 6 (TCP).
        var tCPFlags: [NetworkFirewallClientTypes.TCPFlagField]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct PerObjectStatus: Swift.Equatable {
        ...
        var syncStatus: NetworkFirewallClientTypes.PerObjectSyncStatus?
...
extension NetworkFirewallClientTypes {
    ...
    public struct PublishMetricAction: Swift.Equatable {
        ///
        /// This member is required.
        var dimensions: [NetworkFirewallClientTypes.Dimension]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct RuleDefinition: Swift.Equatable {
        ...
        /// Criteria for Network Firewall to use to inspect an individual packet in stateless rule inspection. Each match attributes set can include one or more items such as IP address, CIDR range, port number, protocol, and TCP flags.
        /// This member is required.
        var matchAttributes: NetworkFirewallClientTypes.MatchAttributes?
...
extension NetworkFirewallClientTypes {
    ...
    public struct RuleGroup: Swift.Equatable {
        ...
        var ruleVariables: NetworkFirewallClientTypes.RuleVariables?
        /// The stateful rules or stateless rules for the rule group.
        /// This member is required.
        var rulesSource: NetworkFirewallClientTypes.RulesSource?
...
extension NetworkFirewallClientTypes {
    ...
    public struct RuleGroupResponse: Swift.Equatable {
        ...
        var consumedCapacity: Swift.Int?
        /// A description of the rule group.
        var description: Swift.String?
        ...
        var ruleGroupStatus: NetworkFirewallClientTypes.ResourceStatus?
        /// The key:value pairs to associate with the resource.
        var tags: [NetworkFirewallClientTypes.Tag]?
        /// Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules.
        var type: NetworkFirewallClientTypes.RuleGroupType?
...
extension NetworkFirewallClientTypes {
    ...
    public struct RuleVariables: Swift.Equatable {
        ...
        var iPSets: [Swift.String:NetworkFirewallClientTypes.IPSet]?
        /// A list of port ranges.
        var portSets: [Swift.String:NetworkFirewallClientTypes.PortSet]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct RulesSource: Swift.Equatable {
        ...
        var rulesSourceList: NetworkFirewallClientTypes.RulesSourceList?
        ...
        var statefulRules: [NetworkFirewallClientTypes.StatefulRule]?
        /// Stateless inspection criteria to be used in a stateless rule group.
        var statelessRulesAndCustomActions: NetworkFirewallClientTypes.StatelessRulesAndCustomActions?
...
extension NetworkFirewallClientTypes {
    ...
    public struct RulesSourceList: Swift.Equatable {
        ...
        /// This member is required.
        var generatedRulesType: NetworkFirewallClientTypes.GeneratedRulesType?
        /// The protocols you want to inspect. Specify TLS_SNI for HTTPS. Specify HTTP_HOST for HTTP. You can specify either or both.
        /// This member is required.
        var targetTypes: [NetworkFirewallClientTypes.TargetType]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct StatefulEngineOptions: Swift.Equatable {
        ...
        var ruleOrder: NetworkFirewallClientTypes.RuleOrder?
...
extension NetworkFirewallClientTypes {
    ...
    public struct StatefulRule: Swift.Equatable {
        ...
        /// This member is required.
        var action: NetworkFirewallClientTypes.StatefulAction?
        /// The stateful inspection criteria for this rule, used to inspect traffic flows.
        /// This member is required.
        var header: NetworkFirewallClientTypes.Header?
        /// Additional options for the rule. These are the Suricata RuleOptions settings.
        /// This member is required.
        var ruleOptions: [NetworkFirewallClientTypes.RuleOption]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct StatefulRuleGroupOverride: Swift.Equatable {
        ...
        var action: NetworkFirewallClientTypes.OverrideAction?
...
extension NetworkFirewallClientTypes {
    ...
    public struct StatefulRuleGroupReference: Swift.Equatable {
        ...
        var `override`: NetworkFirewallClientTypes.StatefulRuleGroupOverride?
...
extension NetworkFirewallClientTypes {
    ...
    public struct StatelessRule: Swift.Equatable {
        ...
        /// This member is required.
        var ruleDefinition: NetworkFirewallClientTypes.RuleDefinition?
...
extension NetworkFirewallClientTypes {
    ...
    public struct StatelessRulesAndCustomActions: Swift.Equatable {
        ...
        var customActions: [NetworkFirewallClientTypes.CustomAction]?
        /// Defines the set of stateless rules for use in a stateless rule group.
        /// This member is required.
        var statelessRules: [NetworkFirewallClientTypes.StatelessRule]?
...
extension NetworkFirewallClientTypes {
    ...
    public struct TCPFlagField: Swift.Equatable {
        ...
        /// This member is required.
        var flags: [NetworkFirewallClientTypes.TCPFlag]?
        /// The set of flags to consider in the inspection. To inspect all flags in the valid values list, leave this with no setting.
        var masks: [NetworkFirewallClientTypes.TCPFlag]?
