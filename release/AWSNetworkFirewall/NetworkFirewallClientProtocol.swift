...
public protocol NetworkFirewallClientProtocol {
    ...
    func describeRuleGroupMetadata(input: DescribeRuleGroupMetadataInput, completion: @escaping (ClientRuntime.SdkResult<DescribeRuleGroupMetadataOutputResponse, DescribeRuleGroupMetadataOutputError>) -> Void)
