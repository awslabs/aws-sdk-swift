...
public struct BatchDeleteWorldsOutputResponse: Swift.Equatable {
    ...
    var unprocessedWorlds: [Swift.String]?
...
public struct BatchDescribeSimulationJobOutputResponse: Swift.Equatable {
    ...
    var jobs: [RoboMakerClientTypes.SimulationJob]?
    /// A list of unprocessed simulation job Amazon Resource Names (ARNs).
    var unprocessedJobs: [Swift.String]?
...
extension RoboMakerClientTypes {
    ...
    public struct Compute: Swift.Equatable {
        ...
        var computeType: RoboMakerClientTypes.ComputeType?
        /// Compute GPU unit limit for the simulation job. It is the same as the number of GPUs allocated to the SimulationJob.
        var gpuUnitLimit: Swift.Int?
        /// The simulation unit limit. Your simulation is allocated CPU and memory proportional to the supplied simulation unit limit. A simulation unit is 1 vcpu and 2GB of memory. You are only billed for the SU utilization you consume up to the maximum value provided. The default is 15.
        var simulationUnitLimit: Swift.Int?
...
public struct CreateDeploymentJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var deploymentApplicationConfigs: [RoboMakerClientTypes.DeploymentApplicationConfig]?
    /// The requested deployment configuration.
    var deploymentConfig: RoboMakerClientTypes.DeploymentConfig?
    /// The Amazon Resource Name (ARN) of the fleet to deploy.
    /// This member is required.
    var fleet: Swift.String?
...
public struct CreateDeploymentJobOutputResponse: Swift.Equatable {
    ...
    var failureCode: RoboMakerClientTypes.DeploymentJobErrorCode?
    /// The failure reason of the deployment job if it failed.
    var failureReason: Swift.String?
    /// The target fleet for the deployment job.
    var fleet: Swift.String?
    /// The status of the deployment job.
    var status: RoboMakerClientTypes.DeploymentStatus?
...
public struct CreateRobotApplicationInput: Swift.Equatable {
    ...
    var environment: RoboMakerClientTypes.Environment?
    /// The name of the robot application.
    /// This member is required.
    var name: Swift.String?
    /// The robot software suite (ROS distribuition) used by the robot application.
    /// This member is required.
    var robotSoftwareSuite: RoboMakerClientTypes.RobotSoftwareSuite?
    /// The sources of the robot application.
    var sources: [RoboMakerClientTypes.SourceConfig]?
...
public struct CreateRobotApplicationOutputResponse: Swift.Equatable {
    ...
    var robotSoftwareSuite: RoboMakerClientTypes.RobotSoftwareSuite?
    /// The sources of the robot application.
    var sources: [RoboMakerClientTypes.Source]?
...
public struct CreateRobotInput: Swift.Equatable {
    ...
    /// This member is required.
    var architecture: RoboMakerClientTypes.Architecture?
...
public struct CreateSimulationApplicationInput: Swift.Equatable {
    ...
    var renderingEngine: RoboMakerClientTypes.RenderingEngine?
    /// The robot software suite (ROS distribution) used by the simulation application.
    /// This member is required.
    var robotSoftwareSuite: RoboMakerClientTypes.RobotSoftwareSuite?
    /// The simulation software suite used by the simulation application.
    /// This member is required.
    var simulationSoftwareSuite: RoboMakerClientTypes.SimulationSoftwareSuite?
...
public struct CreateSimulationJobInput: Swift.Equatable {
    ...
    var clientRequestToken: Swift.String?
    /// Compute information for the simulation job.
    var compute: RoboMakerClientTypes.Compute?
    ...
    var dataSources: [RoboMakerClientTypes.DataSourceConfig]?
    ...
    var failureBehavior: RoboMakerClientTypes.FailureBehavior?
    /// The IAM role name that allows the simulation instance to call the AWS APIs that are specified in its associated policies on your behalf. This is how credentials are passed in to your simulation job.
    /// This member is required.
    var iamRole: Swift.String?
    /// The logging configuration.
    var loggingConfig: RoboMakerClientTypes.LoggingConfig?
    /// The maximum simulation job duration in seconds (up to 14 days or 1,209,600 seconds. When maxJobDurationInSeconds is reached, the simulation job will status will transition to Completed.
    /// This member is required.
    var maxJobDurationInSeconds: Swift.Int
    /// Location for output files generated by the simulation job.
    var outputLocation: RoboMakerClientTypes.OutputLocation?
    /// The robot application to use in the simulation job.
    var robotApplications: [RoboMakerClientTypes.RobotApplicationConfig]?
    /// The simulation application to use in the simulation job.
    var simulationApplications: [RoboMakerClientTypes.SimulationApplicationConfig]?
    /// A map that contains tag keys and tag values that are attached to the simulation job.
    var tags: [Swift.String:Swift.String]?
    /// If your simulation job accesses resources in a VPC, you provide this parameter identifying the list of security group IDs and subnet IDs. These must belong to the same VPC. You must provide at least one security group and one subnet ID.
    var vpcConfig: RoboMakerClientTypes.VPCConfig?
...
public struct CreateSimulationJobOutputResponse: Swift.Equatable {
    ...
    var clientRequestToken: Swift.String?
    /// Compute information for the simulation job.
    var compute: RoboMakerClientTypes.ComputeResponse?
    /// The data sources for the simulation job.
    var dataSources: [RoboMakerClientTypes.DataSource]?
    ...
    var failureCode: RoboMakerClientTypes.SimulationJobErrorCode?
    /// The IAM role that allows the simulation job to call the AWS APIs that are specified in its associated policies on your behalf.
    var iamRole: Swift.String?
    /// The time, in milliseconds since the epoch, when the simulation job was last started.
    var lastStartedAt: ClientRuntime.Date?
    ...
    var simulationTimeMillis: Swift.Int
    /// The status of the simulation job.
    var status: RoboMakerClientTypes.SimulationJobStatus?
    /// The list of all tags added to the simulation job.
    var tags: [Swift.String:Swift.String]?
    /// Information about the vpc configuration.
    var vpcConfig: RoboMakerClientTypes.VPCConfigResponse?
...
public struct CreateWorldExportJobOutputResponse: Swift.Equatable {
    ...
    var failureCode: RoboMakerClientTypes.WorldExportJobErrorCode?
    /// The IAM role that the world export process uses to access the Amazon S3 bucket and put the export.
    var iamRole: Swift.String?
    /// The output location.
    var outputLocation: RoboMakerClientTypes.OutputLocation?
    ...
    var status: RoboMakerClientTypes.WorldExportJobStatus?
    /// A map that contains tag keys and tag values that are attached to the world export job.
    var tags: [Swift.String:Swift.String]?
...
public struct CreateWorldGenerationJobInput: Swift.Equatable {
    ...
    /// This member is required.
    var worldCount: RoboMakerClientTypes.WorldCount?
    /// A map that contains tag keys and tag values that are attached to the generated worlds.
    var worldTags: [Swift.String:Swift.String]?
...
public struct CreateWorldGenerationJobOutputResponse: Swift.Equatable {
    ...
    var failureCode: RoboMakerClientTypes.WorldGenerationJobErrorCode?
    ...
    var status: RoboMakerClientTypes.WorldGenerationJobStatus?
    /// A map that contains tag keys and tag values that are attached to the world generator job.
    var tags: [Swift.String:Swift.String]?
...
public struct CreateWorldTemplateInput: Swift.Equatable {
    ...
    var templateBody: Swift.String?
    /// The location of the world template.
    var templateLocation: RoboMakerClientTypes.TemplateLocation?
...
extension RoboMakerClientTypes {
    ...
    public struct DataSource: Swift.Equatable {
        ...
        var s3Keys: [RoboMakerClientTypes.S3KeyOutput]?
        ...
        var type: RoboMakerClientTypes.DataSourceType?
...
public struct DeleteRobotApplicationInput: Swift.Equatable {
    ...
    var applicationVersion: Swift.String?
...
extension RoboMakerClientTypes {
    ...
    public struct DeploymentApplicationConfig: Swift.Equatable {
        ...
        /// This member is required.
        var launchConfig: RoboMakerClientTypes.DeploymentLaunchConfig?
...
extension RoboMakerClientTypes {
    ...
    public struct DeploymentConfig: Swift.Equatable {
        ...
        var concurrentDeploymentPercentage: Swift.Int?
        /// The download condition file.
        var downloadConditionFile: RoboMakerClientTypes.S3Object?
        /// The percentage of deployments that need to fail before stopping deployment.
        var failureThresholdPercentage: Swift.Int?
        /// The amount of time, in seconds, to wait for deployment to a single robot to complete. Choose a time between 1 minute and 7 days. The default is 5 hours.
        var robotDeploymentTimeoutInSeconds: Swift.Int?
...
extension RoboMakerClientTypes {
    ...
    public struct DeploymentLaunchConfig: Swift.Equatable {
        ...
        var environmentVariables: [Swift.String:Swift.String]?
        /// The launch file name.
        /// This member is required.
        var launchFile: Swift.String?
        /// The package name.
        /// This member is required.
        var packageName: Swift.String?
        /// The deployment post-launch file. This file will be executed after the launch file.
        var postLaunchFile: Swift.String?
        /// The deployment pre-launch file. This file will be executed prior to the launch file.
        var preLaunchFile: Swift.String?
...
public struct DescribeDeploymentJobOutputResponse: Swift.Equatable {
    ...
    var robotDeploymentSummary: [RoboMakerClientTypes.RobotDeployment]?
    /// The status of the deployment job.
    var status: RoboMakerClientTypes.DeploymentStatus?
...
public struct DescribeFleetOutputResponse: Swift.Equatable {
    ...
    var lastDeploymentJob: Swift.String?
    /// The status of the last deployment.
    var lastDeploymentStatus: RoboMakerClientTypes.DeploymentStatus?
    /// The time of the last deployment.
    var lastDeploymentTime: ClientRuntime.Date?
    /// The name of the fleet.
    var name: Swift.String?
    /// A list of robots.
    var robots: [RoboMakerClientTypes.Robot]?
...
public struct DescribeRobotOutputResponse: Swift.Equatable {
    ...
    var status: RoboMakerClientTypes.RobotStatus?
...
public struct DescribeSimulationJobBatchOutputResponse: Swift.Equatable {
    ...
    var arn: Swift.String?
    /// The batch policy.
    var batchPolicy: RoboMakerClientTypes.BatchPolicy?
    /// Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.
    var clientRequestToken: Swift.String?
    /// The time, in milliseconds since the epoch, when the simulation job batch was created.
    var createdAt: ClientRuntime.Date?
    /// A list of created simulation job summaries.
    var createdRequests: [RoboMakerClientTypes.SimulationJobSummary]?
    ...
    var failedRequests: [RoboMakerClientTypes.FailedCreateSimulationJobRequest]?
    /// The failure code of the simulation job batch.
    var failureCode: RoboMakerClientTypes.SimulationJobBatchErrorCode?
    /// The reason the simulation job batch failed.
    var failureReason: Swift.String?
    /// The time, in milliseconds since the epoch, when the simulation job batch was last updated.
    var lastUpdatedAt: ClientRuntime.Date?
    /// A list of pending simulation job requests. These requests have not yet been created into simulation jobs.
    var pendingRequests: [RoboMakerClientTypes.SimulationJobRequest]?
    ...
    var status: RoboMakerClientTypes.SimulationJobBatchStatus?
...
public struct DescribeSimulationJobOutputResponse: Swift.Equatable {
    ...
    var networkInterface: RoboMakerClientTypes.NetworkInterface?
    /// Location for output files generated by the simulation job.
    var outputLocation: RoboMakerClientTypes.OutputLocation?
...
public struct DescribeWorldGenerationJobOutputResponse: Swift.Equatable {
    ...
    var finishedWorldsSummary: RoboMakerClientTypes.FinishedWorldsSummary?
...
public struct DescribeWorldOutputResponse: Swift.Equatable {
    ...
    var generationJob: Swift.String?
    /// A map that contains tag keys and tag values that are attached to the world.
    var tags: [Swift.String:Swift.String]?
    /// The world template.
    var template: Swift.String?
    /// Returns the JSON formatted string that describes the contents of your world.
    var worldDescriptionBody: Swift.String?
...
extension RoboMakerClientTypes {
    ...
    public struct FailedCreateSimulationJobRequest: Swift.Equatable {
        ...
        var failedAt: ClientRuntime.Date?
        /// The failure code.
        var failureCode: RoboMakerClientTypes.SimulationJobErrorCode?
        /// The failure reason of the simulation job request.
        var failureReason: Swift.String?
        /// The simulation job request.
        var request: RoboMakerClientTypes.SimulationJobRequest?
...
extension RoboMakerClientTypes {
    ...
    public struct FailureSummary: Swift.Equatable {
        ...
        var failures: [RoboMakerClientTypes.WorldFailure]?
        /// The total number of failures.
        var totalFailureCount: Swift.Int
...
extension RoboMakerClientTypes {
    ...
    public struct FinishedWorldsSummary: Swift.Equatable {
        /// Information about worlds that failed.
        var failureSummary: RoboMakerClientTypes.FailureSummary?
        /// The total number of finished worlds.
        var finishedCount: Swift.Int
        /// A list of worlds that succeeded.
        var succeededWorlds: [Swift.String]?
...
extension RoboMakerClientTypes {
    ...
    public struct LaunchConfig: Swift.Equatable {
        ...
        var portForwardingConfig: RoboMakerClientTypes.PortForwardingConfig?
...
public struct ListDeploymentJobsInput: Swift.Equatable {
    ...
    var filters: [RoboMakerClientTypes.Filter]?
...
public struct ListDeploymentJobsOutputResponse: Swift.Equatable {
    ...
    var deploymentJobs: [RoboMakerClientTypes.DeploymentJob]?
    /// If the previous paginated request did not return all of the remaining results, the response object's nextToken parameter value is set to a token. To retrieve the next set of results, call ListDeploymentJobs again and assign that token to the request object's nextToken parameter. If there are no remaining results, the previous response object's NextToken parameter is set to null.
    var nextToken: Swift.String?
...
public struct ListFleetsOutputResponse: Swift.Equatable {
    ...
    var fleetDetails: [RoboMakerClientTypes.Fleet]?
    /// If the previous paginated request did not return all of the remaining results, the response object's nextToken parameter value is set to a token. To retrieve the next set of results, call ListFleets again and assign that token to the request object's nextToken parameter. If there are no remaining results, the previous response object's NextToken parameter is set to null.
    var nextToken: Swift.String?
...
public struct ListRobotApplicationsInput: Swift.Equatable {
    ...
    var versionQualifier: Swift.String?
...
public struct ListRobotApplicationsOutputResponse: Swift.Equatable {
    ...
    var robotApplicationSummaries: [RoboMakerClientTypes.RobotApplicationSummary]?
...
public struct ListSimulationApplicationsOutputResponse: Swift.Equatable {
    ...
    var simulationApplicationSummaries: [RoboMakerClientTypes.SimulationApplicationSummary]?
...
public struct ListSimulationJobBatchesOutputResponse: Swift.Equatable {
    ...
    var simulationJobBatchSummaries: [RoboMakerClientTypes.SimulationJobBatchSummary]?
...
public struct ListSimulationJobsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var simulationJobSummaries: [RoboMakerClientTypes.SimulationJobSummary]?
...
public struct ListWorldExportJobsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var worldExportJobSummaries: [RoboMakerClientTypes.WorldExportJobSummary]?
...
public struct ListWorldGenerationJobsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var worldGenerationJobSummaries: [RoboMakerClientTypes.WorldGenerationJobSummary]?
...
public struct ListWorldTemplatesOutputResponse: Swift.Equatable {
    ...
    var templateSummaries: [RoboMakerClientTypes.TemplateSummary]?
...
public struct ListWorldsOutputResponse: Swift.Equatable {
    ...
    var worldSummaries: [RoboMakerClientTypes.WorldSummary]?
...
extension RoboMakerClientTypes {
    ...
    public struct LoggingConfig: Swift.Equatable {
        ...
        /// This member is required.
        var recordAllRosTopics: Swift.Bool?
...
extension RoboMakerClientTypes {
    ...
    public struct NetworkInterface: Swift.Equatable {
        ...
        var publicIpAddress: Swift.String?
...
extension RoboMakerClientTypes {
    ...
    public struct PortForwardingConfig: Swift.Equatable {
        ...
        var portMappings: [RoboMakerClientTypes.PortMapping]?
...
extension RoboMakerClientTypes {
    ...
    public struct PortMapping: Swift.Equatable {
        ...
        /// This member is required.
        var applicationPort: Swift.Int
        /// A Boolean indicating whether to enable this port mapping on public IP.
        var enableOnPublicIp: Swift.Bool
        /// The port number on the simulation job instance to use as a remote connection point.
        /// This member is required.
        var jobPort: Swift.Int
...
extension RoboMakerClientTypes {
    ...
    public struct ProgressDetail: Swift.Equatable {
        ...
        var currentProgress: RoboMakerClientTypes.RobotDeploymentStep?
        /// Estimated amount of time in seconds remaining in the step. This currently only applies to the Downloading/Extracting step of the deployment. It is empty for other steps.
        var estimatedTimeRemainingSeconds: Swift.Int?
        /// Precentage of the step that is done. This currently only applies to the Downloading/Extracting step of the deployment. It is empty for other steps.
        var percentDone: Swift.Float?
        /// The Amazon Resource Name (ARN) of the deployment job.
        var targetResource: Swift.String?
...
extension RoboMakerClientTypes {
    ...
    public struct RenderingEngine: Swift.Equatable {
        ...
        var name: RoboMakerClientTypes.RenderingEngineType?
...
extension RoboMakerClientTypes {
    ...
    public struct RobotApplicationConfig: Swift.Equatable {
        ...
        /// This member is required.
        var launchConfig: RoboMakerClientTypes.LaunchConfig?
        /// Information about tools configured for the robot application.
        var tools: [RoboMakerClientTypes.Tool]?
        /// The upload configurations for the robot application.
        var uploadConfigurations: [RoboMakerClientTypes.UploadConfiguration]?
        /// A Boolean indicating whether to use default robot application tools. The default tools are rviz, rqt, terminal and rosbag record. The default is False.
        var useDefaultTools: Swift.Bool?
        ...
        var useDefaultUploadConfigurations: Swift.Bool?
...
extension RoboMakerClientTypes {
    ...
    public struct RobotDeployment: Swift.Equatable {
        ...
        var deploymentFinishTime: ClientRuntime.Date?
        /// The time, in milliseconds since the epoch, when the deployment was started.
        var deploymentStartTime: ClientRuntime.Date?
        /// The robot deployment failure code.
        var failureCode: RoboMakerClientTypes.DeploymentJobErrorCode?
        /// A short description of the reason why the robot deployment failed.
        var failureReason: Swift.String?
        /// Information about how the deployment is progressing.
        var progressDetail: RoboMakerClientTypes.ProgressDetail?
...
extension RoboMakerClientTypes {
    ...
    public struct RobotSoftwareSuite: Swift.Equatable {
        ...
        var name: RoboMakerClientTypes.RobotSoftwareSuiteType?
        /// The version of the robot software suite (ROS distribution).
        var version: RoboMakerClientTypes.RobotSoftwareSuiteVersionType?
...
extension RoboMakerClientTypes {
    ...
    public struct SimulationApplicationConfig: Swift.Equatable {
        ...
        var worldConfigs: [RoboMakerClientTypes.WorldConfig]?
...
extension RoboMakerClientTypes {
    ...
    public struct SimulationJobBatchSummary: Swift.Equatable {
        ...
        var createdRequestCount: Swift.Int
        /// The number of failed simulation job requests.
        var failedRequestCount: Swift.Int
        /// The time, in milliseconds since the epoch, when the simulation job batch was last updated.
        var lastUpdatedAt: ClientRuntime.Date?
        /// The number of pending simulation job requests.
        var pendingRequestCount: Swift.Int
...
extension RoboMakerClientTypes {
    ...
    public struct SimulationJobRequest: Swift.Equatable {
        ...
        var useDefaultApplications: Swift.Bool?
...
extension RoboMakerClientTypes {
    ...
    public struct SimulationJobSummary: Swift.Equatable {
        ...
        var dataSourceNames: [Swift.String]?
        /// The time, in milliseconds since the epoch, when the simulation job was last updated.
        var lastUpdatedAt: ClientRuntime.Date?
        /// The name of the simulation job.
        var name: Swift.String?
        /// A list of simulation job robot application names.
        var robotApplicationNames: [Swift.String]?
        /// A list of simulation job simulation application names.
        var simulationApplicationNames: [Swift.String]?
        /// The status of the simulation job.
        var status: RoboMakerClientTypes.SimulationJobStatus?
...
extension RoboMakerClientTypes {
    ...
    public struct SimulationSoftwareSuite: Swift.Equatable {
        ...
        var name: RoboMakerClientTypes.SimulationSoftwareSuiteType?
...
public struct StartSimulationJobBatchInput: Swift.Equatable {
    ...
    /// This member is required.
    var createSimulationJobRequests: [RoboMakerClientTypes.SimulationJobRequest]?
...
extension RoboMakerClientTypes {
    ...
    public struct UploadConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var uploadBehavior: RoboMakerClientTypes.UploadBehavior?
...
extension RoboMakerClientTypes {
    ...
    public struct WorldCount: Swift.Equatable {
        ...
        var floorplanCount: Swift.Int?
        /// The number of unique interiors per floorplan.
        var interiorCountPerFloorplan: Swift.Int?
...
extension RoboMakerClientTypes {
    ...
    public struct WorldGenerationJobSummary: Swift.Equatable {
        ...
        var failedWorldCount: Swift.Int
        /// The status of the world generator job: Pending The world generator job request is pending. Running The world generator job is running. Completed The world generator job completed. Failed The world generator job failed. See failureCode for more information. PartialFailed Some worlds did not generate. Canceled The world generator job was cancelled. Canceling The world generator job is being cancelled.
        var status: RoboMakerClientTypes.WorldGenerationJobStatus?
        /// The number of worlds that were generated.
        var succeededWorldCount: Swift.Int
        /// The Amazon Resource Name (arn) of the world template.
        var template: Swift.String?
        /// Information about the world count.
        var worldCount: RoboMakerClientTypes.WorldCount?
