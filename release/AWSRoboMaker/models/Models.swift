...
extension RoboMakerClientTypes.Compute: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Compute(computeType: \(Swift.String(describing: computeType)), gpuUnitLimit: \(Swift.String(describing: gpuUnitLimit)), simulationUnitLimit: \(Swift.String(describing: simulationUnitLimit)))"}
}
...
extension RoboMakerClientTypes.ComputeResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ComputeResponse(computeType: \(Swift.String(describing: computeType)), gpuUnitLimit: \(Swift.String(describing: gpuUnitLimit)), simulationUnitLimit: \(Swift.String(describing: simulationUnitLimit)))"}
}
...
extension RoboMakerClientTypes.DataSource: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DataSource(destination: \(Swift.String(describing: destination)), name: \(Swift.String(describing: name)), s3Bucket: \(Swift.String(describing: s3Bucket)), s3Keys: \(Swift.String(describing: s3Keys)), type: \(Swift.String(describing: type)))"}
}
...
extension RoboMakerClientTypes.DataSourceConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DataSourceConfig(destination: \(Swift.String(describing: destination)), name: \(Swift.String(describing: name)), s3Bucket: \(Swift.String(describing: s3Bucket)), s3Keys: \(Swift.String(describing: s3Keys)), type: \(Swift.String(describing: type)))"}
}
...
extension RoboMakerClientTypes.LaunchConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LaunchConfig(command: \(Swift.String(describing: command)), environmentVariables: \(Swift.String(describing: environmentVariables)), launchFile: \(Swift.String(describing: launchFile)), packageName: \(Swift.String(describing: packageName)), portForwardingConfig: \(Swift.String(describing: portForwardingConfig)), streamUI: \(Swift.String(describing: streamUI)))"}
}
...
extension RoboMakerClientTypes.SimulationJobSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SimulationJobSummary(arn: \(Swift.String(describing: arn)), computeType: \(Swift.String(describing: computeType)), dataSourceNames: \(Swift.String(describing: dataSourceNames)), lastUpdatedAt: \(Swift.String(describing: lastUpdatedAt)), name: \(Swift.String(describing: name)), robotApplicationNames: \(Swift.String(describing: robotApplicationNames)), simulationApplicationNames: \(Swift.String(describing: simulationApplicationNames)), status: \(Swift.String(describing: status)))"}
}
