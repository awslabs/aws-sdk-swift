...
public struct DeleteReportDefinitionOutputResponse: Swift.Equatable {
    ...
    var responseMessage: Swift.String?
...
public struct DescribeReportDefinitionsOutputResponse: Swift.Equatable {
    ...
    var reportDefinitions: [CostAndUsageReportClientTypes.ReportDefinition]?
...
public struct ModifyReportDefinitionInput: Swift.Equatable {
    ...
    var reportDefinition: CostAndUsageReportClientTypes.ReportDefinition?
...
extension CostAndUsageReportClientTypes {
    ...
    public struct ReportDefinition: Swift.Equatable {
        ...
        var additionalArtifacts: [CostAndUsageReportClientTypes.AdditionalArtifact]?
        /// A list of strings that indicate additional content that Amazon Web Services includes in the report, such as individual resource IDs.
        /// This member is required.
        var additionalSchemaElements: [CostAndUsageReportClientTypes.SchemaElement]?
        /// The Amazon resource name of the billing view. You can get this value by using the billing view service public APIs.
        var billingViewArn: Swift.String?
        /// The compression format that AWS uses for the report.
        /// This member is required.
        var compression: CostAndUsageReportClientTypes.CompressionFormat?
        /// The format that AWS saves the report in.
        /// This member is required.
        var format: CostAndUsageReportClientTypes.ReportFormat?
        /// Whether you want Amazon Web Services to update your reports after they have been finalized if Amazon Web Services detects charges related to previous months. These charges can include refunds, credits, or support fees.
        var refreshClosedReports: Swift.Bool?
        /// The name of the report that you want to create. The name must be unique, is case sensitive, and can't include spaces.
        /// This member is required.
        var reportName: Swift.String?
        /// Whether you want Amazon Web Services to overwrite the previous version of each report or to deliver the report in addition to the previous versions.
        var reportVersioning: CostAndUsageReportClientTypes.ReportVersioning?
        ...
        /// The region of the S3 bucket that AWS delivers the report into.
        /// This member is required.
        var s3Region: CostAndUsageReportClientTypes.AWSRegion?
        /// The length of time covered by the report.
        /// This member is required.
        var timeUnit: CostAndUsageReportClientTypes.TimeUnit?
