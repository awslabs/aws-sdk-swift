...
public protocol DlmClientProtocol {
    ...
    func createLifecyclePolicy(input: CreateLifecyclePolicyInput, completion: @escaping (SdkResult<CreateLifecyclePolicyOutputResponse, CreateLifecyclePolicyOutputError>) -> Void)
    ...
    func getLifecyclePolicies(input: GetLifecyclePoliciesInput, completion: @escaping (SdkResult<GetLifecyclePoliciesOutputResponse, GetLifecyclePoliciesOutputError>) -> Void)
    ...
    func updateLifecyclePolicy(input: UpdateLifecyclePolicyInput, completion: @escaping (SdkResult<UpdateLifecyclePolicyOutputResponse, UpdateLifecyclePolicyOutputError>) -> Void)
}
