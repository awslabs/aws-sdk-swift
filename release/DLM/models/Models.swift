...
extension DlmClientTypes {
    ...
    public struct Action: Swift.Equatable {
        ...
        public let crossRegionCopy: [DlmClientTypes.CrossRegionCopyAction]?
...
extension DlmClientTypes {
    ...
    public struct CreateRule: Swift.Equatable {
        ...
        public let intervalUnit: DlmClientTypes.IntervalUnitValues?
        ...
        public let location: DlmClientTypes.LocationValues?
...
extension DlmClientTypes {
    ...
    public struct CrossRegionCopyAction: Swift.Equatable {
        ...
        public let encryptionConfiguration: DlmClientTypes.EncryptionConfiguration?
        /// <p>Specifies the retention rule for cross-Region snapshot copies.</p>
        public let retainRule: DlmClientTypes.CrossRegionCopyRetainRule?
...
extension DlmClientTypes {
    ...
    public struct CrossRegionCopyRetainRule: Swift.Equatable {
        ...
        public let intervalUnit: DlmClientTypes.RetentionIntervalUnitValues?
...
extension DlmClientTypes.CrossRegionCopyRule: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CrossRegionCopyRule(cmkArn: \(Swift.String(describing: cmkArn)), copyTags: \(Swift.String(describing: copyTags)), encrypted: \(Swift.String(describing: encrypted)), retainRule: \(Swift.String(describing: retainRule)), target: \(Swift.String(describing: target)), targetRegion: \(Swift.String(describing: targetRegion)))"}
}
...
extension DlmClientTypes {
    ...
    public struct CrossRegionCopyRule: Swift.Equatable {
        ...
        /// 			used.</p>
        public let cmkArn: Swift.String?
        ...
        /// 			specify a target Region and a target Outpost in the same rule.</p>
        public let targetRegion: Swift.String?
...
extension DlmClientTypes {
    ...
    public struct EventParameters: Swift.Equatable {
        ...
        public let descriptionRegex: Swift.String?
        /// <p>The type of event. Currently, only snapshot sharing events are supported.</p>
        public let eventType: DlmClientTypes.EventTypeValues?
        ...
        public let snapshotOwner: [Swift.String]?
...
extension DlmClientTypes {
    ...
    public struct EventSource: Swift.Equatable {
        ...
        public let parameters: DlmClientTypes.EventParameters?
        /// <p>The source of the event. Currently only managed AWS CloudWatch Events rules are supported.</p>
        public let type: DlmClientTypes.EventSourceValues?
...
public struct GetLifecyclePoliciesInput: Swift.Equatable {
    ...
    public let policyIds: [Swift.String]?
    /// <p>The resource type.</p>
    public let resourceTypes: [DlmClientTypes.ResourceTypeValues]?
    /// <p>The activation state.</p>
    public let state: DlmClientTypes.GettablePolicyStateValues?
    ...
    public let tagsToAdd: [Swift.String]?
    /// <p>The target tag for a policy.</p>
    /// 		       <p>Tags are strings in the format <code>key=value</code>.</p>
    public let targetTags: [Swift.String]?
...
extension DlmClientTypes {
    ...
    public struct LifecyclePolicySummary: Swift.Equatable {
        ...
        public let policyType: DlmClientTypes.PolicyTypeValues?
        /// <p>The activation state of the lifecycle policy.</p>
        public let state: DlmClientTypes.GettablePolicyStateValues?
        /// <p>The tags.</p>
        public let tags: [Swift.String:Swift.String]?
...
extension DlmClientTypes {
    ...
    public struct Parameters: Swift.Equatable {
        ...
        public let excludeBootVolume: Swift.Bool?
        ...
        public let noReboot: Swift.Bool?
...
extension DlmClientTypes {
    ...
    public struct PolicyDetails: Swift.Equatable {
        ...
        public let actions: [DlmClientTypes.Action]?
        /// <p>The event that triggers the event-based policy. </p>
        /// 		       <p>This parameter is required for event-based policies only. If you are creating a snapshot or AMI policy, omit this parameter.</p>
        public let eventSource: DlmClientTypes.EventSource?
        ...
        public let parameters: DlmClientTypes.Parameters?
        ...
        public let resourceLocations: [DlmClientTypes.ResourceLocationValues]?
        ...
        /// 		       <p>This parameter is required for snapshot and AMI policies only. If you are creating an event-based policy, omit this parameter.</p>
        public let schedules: [DlmClientTypes.Schedule]?
        /// <p>The single tag that identifies targeted resources for this policy.</p>
        /// 		       <p>This parameter is required for snapshot and AMI policies only. If you are creating an event-based policy, omit this parameter.</p>
        public let targetTags: [DlmClientTypes.Tag]?
...
extension DlmClientTypes {
    ...
    public struct Schedule: Swift.Equatable {
        ...
        public let createRule: DlmClientTypes.CreateRule?
        ...
        public let crossRegionCopyRules: [DlmClientTypes.CrossRegionCopyRule]?
        /// <p>The rule for enabling fast snapshot restore.</p>
        public let fastRestoreRule: DlmClientTypes.FastRestoreRule?
        /// <p>The name of the schedule.</p>
        public let name: Swift.String?
        /// <p>The retention rule.</p>
        public let retainRule: DlmClientTypes.RetainRule?
        /// <p>The rule for sharing snapshots with other AWS accounts.</p>
        public let shareRules: [DlmClientTypes.ShareRule]?
        /// <p>The tags to apply to policy-created resources. These user-defined tags are in addition
        /// 			to the AWS-added lifecycle tags.</p>
        public let tagsToAdd: [DlmClientTypes.Tag]?
        ...
        public let variableTags: [DlmClientTypes.Tag]?
