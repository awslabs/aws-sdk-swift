...
public struct GetRoleCredentialsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRoleCredentialsInputURLHostMiddleware"
    ...
    public typealias MInput = GetRoleCredentialsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetRoleCredentialsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRoleCredentialsOutputError>
}

public struct GetRoleCredentialsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRoleCredentialsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/federation/credentials"
...
public struct GetRoleCredentialsInput: Swift.Equatable {
    ...
    ///         <a href="https://docs.aws.amazon.com/singlesignon/latest/OIDCAPIReference/API_CreateToken.html">CreateToken in the AWS SSO OIDC API Reference Guide.
...
public struct ListAccountRolesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccountRolesInputURLHostMiddleware"
    ...
    public typealias MInput = ListAccountRolesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListAccountRolesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAccountRolesOutputError>
}

public struct ListAccountRolesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAccountRolesInputURLPathMiddleware"
...
public struct ListAccountsInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/assignment/accounts"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct LogoutInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "LogoutInputURLHostMiddleware"
    ...
    public typealias MInput = LogoutInput
    public typealias MOutput = ClientRuntime.OperationOutput<LogoutOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<LogoutOutputError>
}

public struct LogoutInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "LogoutInputURLPathMiddleware"
...
extension SsoClientTypes {
    ...
    public struct RoleCredentials: Swift.Equatable {
        ...
        ///         <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_use-resources.html">Using Temporary Security Credentials to Request Access to AWS Resources in the
        ///         AWS IAM User Guide.
        public var accessKeyId: Swift.String?
        /// The date on which temporary security credentials expire.
        public var expiration: Swift.Int
        /// The key that is used to sign the request. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_use-resources.html">Using Temporary Security Credentials to Request Access to AWS Resources in the
        ///         AWS IAM User Guide.
        public var secretAccessKey: Swift.String?
        /// The token used for temporary credentials. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_use-resources.html">Using Temporary Security Credentials to Request Access to AWS Resources in the
        ///         AWS IAM User Guide.
