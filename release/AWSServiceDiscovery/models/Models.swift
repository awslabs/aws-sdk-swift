...
public struct CreateHttpNamespaceInput: Swift.Equatable {
    ...
    var tags: [ServiceDiscoveryClientTypes.Tag]?
...
public struct CreatePrivateDnsNamespaceInput: Swift.Equatable {
    ...
    var properties: ServiceDiscoveryClientTypes.PrivateDnsNamespaceProperties?
    /// The tags to add to the namespace. Each tag consists of a key and an optional value that you define. Tags keys can be up to 128 characters in length, and tag values can be up to 256 characters in length.
    var tags: [ServiceDiscoveryClientTypes.Tag]?
...
public struct CreatePublicDnsNamespaceInput: Swift.Equatable {
    ...
    var properties: ServiceDiscoveryClientTypes.PublicDnsNamespaceProperties?
    /// The tags to add to the namespace. Each tag consists of a key and an optional value that you define. Tags keys can be up to 128 characters in length, and tag values can be up to 256 characters in length.
    var tags: [ServiceDiscoveryClientTypes.Tag]?
...
public struct CreateServiceInput: Swift.Equatable {
    ...
    var dnsConfig: ServiceDiscoveryClientTypes.DnsConfig?
    ...
    var healthCheckConfig: ServiceDiscoveryClientTypes.HealthCheckConfig?
    ...
    var healthCheckCustomConfig: ServiceDiscoveryClientTypes.HealthCheckCustomConfig?
    ...
    var type: ServiceDiscoveryClientTypes.ServiceTypeOption?
...
public struct CreateServiceOutputResponse: Swift.Equatable {
    ...
    var service: ServiceDiscoveryClientTypes.Service?
...
public struct DiscoverInstancesInput: Swift.Equatable {
    ...
    var healthStatus: ServiceDiscoveryClientTypes.HealthStatusFilter?
    ...
    var optionalParameters: [Swift.String:Swift.String]?
    ...
    var queryParameters: [Swift.String:Swift.String]?
...
public struct DiscoverInstancesOutputResponse: Swift.Equatable {
    ...
    var instances: [ServiceDiscoveryClientTypes.HttpInstanceSummary]?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct DnsConfig: Swift.Equatable {
        ...
        /// This member is required.
        var dnsRecords: [ServiceDiscoveryClientTypes.DnsRecord]?
        ...
        var routingPolicy: ServiceDiscoveryClientTypes.RoutingPolicy?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct DnsProperties: Swift.Equatable {
        ...
        var sOA: ServiceDiscoveryClientTypes.SOA?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct DnsRecord: Swift.Equatable {
        ...
        /// This member is required.
        var type: ServiceDiscoveryClientTypes.RecordType?
...
public struct GetInstanceOutputResponse: Swift.Equatable {
    ...
    var instance: ServiceDiscoveryClientTypes.Instance?
...
public struct GetInstancesHealthStatusOutputResponse: Swift.Equatable {
    ...
    var status: [Swift.String:ServiceDiscoveryClientTypes.HealthStatus]?
...
public struct GetNamespaceOutputResponse: Swift.Equatable {
    ...
    var namespace: ServiceDiscoveryClientTypes.Namespace?
...
public struct GetOperationOutputResponse: Swift.Equatable {
    ...
    var operation: ServiceDiscoveryClientTypes.Operation?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct HealthCheckConfig: Swift.Equatable {
        ...
        /// This member is required.
        var type: ServiceDiscoveryClientTypes.HealthCheckType?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct HttpInstanceSummary: Swift.Equatable {
        ...
        var healthStatus: ServiceDiscoveryClientTypes.HealthStatus?
...
public struct ListInstancesOutputResponse: Swift.Equatable {
    ...
    var instances: [ServiceDiscoveryClientTypes.InstanceSummary]?
...
public struct ListNamespacesInput: Swift.Equatable {
    ...
    var filters: [ServiceDiscoveryClientTypes.NamespaceFilter]?
...
public struct ListNamespacesOutputResponse: Swift.Equatable {
    ...
    var namespaces: [ServiceDiscoveryClientTypes.NamespaceSummary]?
...
public struct ListOperationsInput: Swift.Equatable {
    ...
    var filters: [ServiceDiscoveryClientTypes.OperationFilter]?
...
public struct ListOperationsOutputResponse: Swift.Equatable {
    ...
    var operations: [ServiceDiscoveryClientTypes.OperationSummary]?
...
public struct ListServicesInput: Swift.Equatable {
    ...
    var filters: [ServiceDiscoveryClientTypes.ServiceFilter]?
...
public struct ListServicesOutputResponse: Swift.Equatable {
    ...
    var services: [ServiceDiscoveryClientTypes.ServiceSummary]?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct Namespace: Swift.Equatable {
        ...
        var properties: ServiceDiscoveryClientTypes.NamespaceProperties?
        /// The number of services that are associated with the namespace.
        var serviceCount: Swift.Int?
        ...
        var type: ServiceDiscoveryClientTypes.NamespaceType?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct NamespaceFilter: Swift.Equatable {
        ...
        var condition: ServiceDiscoveryClientTypes.FilterCondition?
        /// Specify TYPE.
        /// This member is required.
        var name: ServiceDiscoveryClientTypes.NamespaceFilterName?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct NamespaceProperties: Swift.Equatable {
        /// A complex type that contains the ID for the Route 53 hosted zone that Cloud Map creates when you create a namespace.
        var dnsProperties: ServiceDiscoveryClientTypes.DnsProperties?
        /// A complex type that contains the name of an HTTP namespace.
        var httpProperties: ServiceDiscoveryClientTypes.HttpProperties?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct Operation: Swift.Equatable {
        ...
        var status: ServiceDiscoveryClientTypes.OperationStatus?
        ...
        var type: ServiceDiscoveryClientTypes.OperationType?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct OperationFilter: Swift.Equatable {
        ...
        /// This member is required.
        var name: ServiceDiscoveryClientTypes.OperationFilterName?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct PrivateDnsNamespaceChange: Swift.Equatable {
        ...
        var properties: ServiceDiscoveryClientTypes.PrivateDnsNamespacePropertiesChange?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct PrivateDnsNamespaceProperties: Swift.Equatable {
        /// DNS properties for the private DNS namespace.
        /// This member is required.
        var dnsProperties: ServiceDiscoveryClientTypes.PrivateDnsPropertiesMutable?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct PrivateDnsNamespacePropertiesChange: Swift.Equatable {
        ...
        /// This member is required.
        var dnsProperties: ServiceDiscoveryClientTypes.PrivateDnsPropertiesMutableChange?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct PrivateDnsPropertiesMutableChange: Swift.Equatable {
        ...
        /// This member is required.
        var sOA: ServiceDiscoveryClientTypes.SOAChange?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct PublicDnsNamespaceChange: Swift.Equatable {
        ...
        var properties: ServiceDiscoveryClientTypes.PublicDnsNamespacePropertiesChange?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct PublicDnsNamespaceProperties: Swift.Equatable {
        /// DNS properties for the public DNS namespace.
        /// This member is required.
        var dnsProperties: ServiceDiscoveryClientTypes.PublicDnsPropertiesMutable?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct PublicDnsNamespacePropertiesChange: Swift.Equatable {
        ...
        /// This member is required.
        var dnsProperties: ServiceDiscoveryClientTypes.PublicDnsPropertiesMutableChange?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct Service: Swift.Equatable {
        ...
        var type: ServiceDiscoveryClientTypes.ServiceType?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct ServiceChange: Swift.Equatable {
        ...
        var dnsConfig: ServiceDiscoveryClientTypes.DnsConfigChange?
...
extension ServiceDiscoveryClientTypes {
    ...
    public struct ServiceFilter: Swift.Equatable {
        ...
        /// This member is required.
        var name: ServiceDiscoveryClientTypes.ServiceFilterName?
...
public struct UpdateHttpNamespaceInput: Swift.Equatable {
    ...
    /// This member is required.
    var namespace: ServiceDiscoveryClientTypes.HttpNamespaceChange?
    ...
    var updaterRequestId: Swift.String?
...
public struct UpdateInstanceCustomHealthStatusInput: Swift.Equatable {
    ...
    /// This member is required.
    var status: ServiceDiscoveryClientTypes.CustomHealthStatus?
...
public struct UpdatePrivateDnsNamespaceInput: Swift.Equatable {
    ...
    /// Updated properties for the private DNS namespace.
    /// This member is required.
    var namespace: ServiceDiscoveryClientTypes.PrivateDnsNamespaceChange?
...
public struct UpdatePublicDnsNamespaceInput: Swift.Equatable {
    ...
    /// Updated properties for the public DNS namespace.
    /// This member is required.
    var namespace: ServiceDiscoveryClientTypes.PublicDnsNamespaceChange?
...
public struct UpdateServiceInput: Swift.Equatable {
    ...
    /// This member is required.
    var service: ServiceDiscoveryClientTypes.ServiceChange?
