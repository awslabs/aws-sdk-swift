...
extension GreengrassV2ClientTypes {
    ...
    public struct AssociatedClientDevice: Swift.Equatable {
        ...
        var associationTimestamp: ClientRuntime.Date?
...
public struct BatchAssociateClientDeviceWithCoreDeviceInput: Swift.Equatable {
    ...
    var entries: [GreengrassV2ClientTypes.AssociateClientDeviceWithCoreDeviceEntry]?
...
public struct BatchAssociateClientDeviceWithCoreDeviceOutputResponse: Swift.Equatable {
    ...
    var errorEntries: [GreengrassV2ClientTypes.AssociateClientDeviceWithCoreDeviceErrorEntry]?
...
public struct BatchDisassociateClientDeviceFromCoreDeviceInput: Swift.Equatable {
    ...
    var entries: [GreengrassV2ClientTypes.DisassociateClientDeviceFromCoreDeviceEntry]?
...
public struct BatchDisassociateClientDeviceFromCoreDeviceOutputResponse: Swift.Equatable {
    ...
    var errorEntries: [GreengrassV2ClientTypes.DisassociateClientDeviceFromCoreDeviceErrorEntry]?
...
extension GreengrassV2ClientTypes {
    ...
    public struct CloudComponentStatus: Swift.Equatable {
        ...
        var componentState: GreengrassV2ClientTypes.CloudComponentState?
        ...
        var errors: [Swift.String:Swift.String]?
...
extension GreengrassV2ClientTypes {
    ...
    public struct Component: Swift.Equatable {
        ...
        var latestVersion: GreengrassV2ClientTypes.ComponentLatestVersion?
...
extension GreengrassV2ClientTypes {
    ...
    public struct ComponentCandidate: Swift.Equatable {
        ...
        var versionRequirements: [Swift.String:Swift.String]?
...
extension GreengrassV2ClientTypes {
    ...
    public struct ComponentDependencyRequirement: Swift.Equatable {
        ...
        ///
        /// Default: HARD
        var dependencyType: GreengrassV2ClientTypes.ComponentDependencyType?
...
extension GreengrassV2ClientTypes {
    ...
    public struct ComponentDeploymentSpecification: Swift.Equatable {
        ...
        var configurationUpdate: GreengrassV2ClientTypes.ComponentConfigurationUpdate?
        ...
        var runWith: GreengrassV2ClientTypes.ComponentRunWith?
...
extension GreengrassV2ClientTypes {
    ...
    public struct ComponentLatestVersion: Swift.Equatable {
        ...
        var platforms: [GreengrassV2ClientTypes.ComponentPlatform]?
        /// The publisher of the component version.
        var publisher: Swift.String?
...
extension GreengrassV2ClientTypes {
    ...
    public struct ComponentRunWith: Swift.Equatable {
        ...
        var systemResourceLimits: GreengrassV2ClientTypes.SystemResourceLimits?
...
extension GreengrassV2ClientTypes {
    ...
    public struct CoreDevice: Swift.Equatable {
        ...
        var lastStatusUpdateTimestamp: ClientRuntime.Date?
        /// The status of the core device. Core devices can have the following statuses:
        ///
        /// * HEALTHY – The IoT Greengrass Core software and all components run on the core device without issue.
        ///
        /// * UNHEALTHY – The IoT Greengrass Core software or a component is in a failed state on the core device.
        var status: GreengrassV2ClientTypes.CoreDeviceStatus?
...
public struct CreateComponentVersionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var status: GreengrassV2ClientTypes.CloudComponentStatus?
...
public struct CreateDeploymentInput: Swift.Equatable {
    ...
    var components: [Swift.String:GreengrassV2ClientTypes.ComponentDeploymentSpecification]?
    /// The name of the deployment.
    var deploymentName: Swift.String?
    /// The deployment policies for the deployment. These policies define how the deployment updates components and handles failure.
    var deploymentPolicies: GreengrassV2ClientTypes.DeploymentPolicies?
    /// The job configuration for the deployment configuration. The job configuration specifies the rollout, timeout, and stop configurations for the deployment configuration.
    var iotJobConfiguration: GreengrassV2ClientTypes.DeploymentIoTJobConfiguration?
    /// A list of key-value pairs that contain metadata for the resource. For more information, see [Tag your resources](https://docs.aws.amazon.com/greengrass/v2/developerguide/tag-resources.html) in the IoT Greengrass V2 Developer Guide.
    var tags: [Swift.String:Swift.String]?
...
extension GreengrassV2ClientTypes {
    ...
    public struct Deployment: Swift.Equatable {
        ...
        var deploymentStatus: GreengrassV2ClientTypes.DeploymentStatus?
        /// Whether or not the deployment is the latest revision for its target.
        var isLatestForTarget: Swift.Bool
...
extension GreengrassV2ClientTypes {
    ...
    public struct DeploymentComponentUpdatePolicy: Swift.Equatable {
        ...
        var action: GreengrassV2ClientTypes.DeploymentComponentUpdatePolicyAction?
...
extension GreengrassV2ClientTypes {
    ...
    public struct DeploymentIoTJobConfiguration: Swift.Equatable {
        ...
        var abortConfig: GreengrassV2ClientTypes.IoTJobAbortConfig?
        /// The rollout configuration for the job. This configuration defines the rate at which the job rolls out to the fleet of target devices.
        var jobExecutionsRolloutConfig: GreengrassV2ClientTypes.IoTJobExecutionsRolloutConfig?
        /// The timeout configuration for the job. This configuration defines the amount of time each device has to complete the job.
        var timeoutConfig: GreengrassV2ClientTypes.IoTJobTimeoutConfig?
...
extension GreengrassV2ClientTypes {
    ...
    public struct DeploymentPolicies: Swift.Equatable {
        ...
        var componentUpdatePolicy: GreengrassV2ClientTypes.DeploymentComponentUpdatePolicy?
        /// The configuration validation policy for the configuration deployment. This policy defines how long each component has to validate its configure updates.
        var configurationValidationPolicy: GreengrassV2ClientTypes.DeploymentConfigurationValidationPolicy?
        ...
        var failureHandlingPolicy: GreengrassV2ClientTypes.DeploymentFailureHandlingPolicy?
...
extension GreengrassV2ClientTypes {
    ...
    public struct EffectiveDeployment: Swift.Equatable {
        ...
        /// This member is required.
        var coreDeviceExecutionStatus: GreengrassV2ClientTypes.EffectiveDeploymentExecutionStatus?
        /// The time at which the deployment was created, expressed in ISO 8601 format.
        /// This member is required.
        var creationTimestamp: ClientRuntime.Date?
        /// The ID of the deployment.
...
public struct GetComponentInput: Swift.Equatable {
    ...
    var recipeOutputFormat: GreengrassV2ClientTypes.RecipeOutputFormat?
...
extension GreengrassV2ClientTypes {
    ...
    public struct InstalledComponent: Swift.Equatable {
        ...
        var isRoot: Swift.Bool
        /// The lifecycle state of the component.
        var lifecycleState: GreengrassV2ClientTypes.InstalledComponentLifecycleState?
        /// The details about the lifecycle state of the component.
        var lifecycleStateDetails: Swift.String?
...
extension GreengrassV2ClientTypes {
    ...
    public struct IoTJobAbortConfig: Swift.Equatable {
        ...
        /// This member is required.
        var criteriaList: [GreengrassV2ClientTypes.IoTJobAbortCriteria]?
...
extension GreengrassV2ClientTypes {
    ...
    public struct IoTJobAbortCriteria: Swift.Equatable {
        ...
        /// This member is required.
        var action: GreengrassV2ClientTypes.IoTJobAbortAction?
        /// The type of job deployment failure that can cancel a job.
        /// This member is required.
        var failureType: GreengrassV2ClientTypes.IoTJobExecutionFailureType?
        /// The minimum number of things that receive the configuration before the job can cancel.
        /// This member is required.
        var minNumberOfExecutedThings: Swift.Int
        ...
        /// This member is required.
        var thresholdPercentage: Swift.Double
...
extension GreengrassV2ClientTypes {
    ...
    public struct IoTJobExecutionsRolloutConfig: Swift.Equatable {
        ...
        var exponentialRate: GreengrassV2ClientTypes.IoTJobExponentialRolloutRate?
        /// The maximum number of devices that receive a pending job notification, per minute.
        var maximumPerMinute: Swift.Int
...
extension GreengrassV2ClientTypes {
    ...
    public struct IoTJobExponentialRolloutRate: Swift.Equatable {
        ...
        /// This member is required.
        var baseRatePerMinute: Swift.Int
        ...
        /// This member is required.
        var incrementFactor: Swift.Double
        /// The criteria to increase the rollout rate for the job.
        /// This member is required.
        var rateIncreaseCriteria: GreengrassV2ClientTypes.IoTJobRateIncreaseCriteria?
...
extension GreengrassV2ClientTypes {
    ...
    public struct IoTJobRateIncreaseCriteria: Swift.Equatable {
        ...
        var numberOfNotifiedThings: Swift.Int
        /// The number of devices to successfully run the configuration job before the rollout rate increases.
        var numberOfSucceededThings: Swift.Int
...
extension GreengrassV2ClientTypes {
    ...
    public struct IoTJobTimeoutConfig: Swift.Equatable {
        ...
        var inProgressTimeoutInMinutes: Swift.Int
...
extension GreengrassV2ClientTypes {
    ...
    public struct LambdaEventSource: Swift.Equatable {
        ...
        /// This member is required.
        var type: GreengrassV2ClientTypes.LambdaEventSourceType?
...
extension GreengrassV2ClientTypes {
    ...
    public struct LambdaExecutionParameters: Swift.Equatable {
        ...
        var eventSources: [GreengrassV2ClientTypes.LambdaEventSource]?
        /// The list of arguments to pass to the Lambda function when it runs.
        var execArgs: [Swift.String]?
        /// The encoding type that the Lambda function supports. Default: json
        var inputPayloadEncodingType: GreengrassV2ClientTypes.LambdaInputPayloadEncodingType?
        /// The parameters for the Linux process that contains the Lambda function.
        var linuxProcessParams: GreengrassV2ClientTypes.LambdaLinuxProcessParams?
        ...
        var maxIdleTimeInSeconds: Swift.Int
        /// The maximum number of instances that a non-pinned Lambda function can run at the same time.
        var maxInstancesCount: Swift.Int
        ...
        var statusTimeoutInSeconds: Swift.Int
...
extension GreengrassV2ClientTypes {
    ...
    public struct LambdaFunctionRecipeSource: Swift.Equatable {
        ...
        var componentDependencies: [Swift.String:GreengrassV2ClientTypes.ComponentDependencyRequirement]?
        /// The system and runtime parameters for the Lambda function as it runs on the Greengrass core device.
        var componentLambdaParameters: GreengrassV2ClientTypes.LambdaExecutionParameters?
        /// The name of the component. Defaults to the name of the Lambda function.
        var componentName: Swift.String?
        /// The platforms that the component version supports.
        var componentPlatforms: [GreengrassV2ClientTypes.ComponentPlatform]?
...
extension GreengrassV2ClientTypes {
    ...
    public struct LambdaLinuxProcessParams: Swift.Equatable {
        ...
        var containerParams: GreengrassV2ClientTypes.LambdaContainerParams?
        ...
        var isolationMode: GreengrassV2ClientTypes.LambdaIsolationMode?
...
public struct ListClientDevicesAssociatedWithCoreDeviceOutputResponse: Swift.Equatable {
    ...
    var associatedClientDevices: [GreengrassV2ClientTypes.AssociatedClientDevice]?
...
public struct ListComponentVersionsOutputResponse: Swift.Equatable {
    ...
    var componentVersions: [GreengrassV2ClientTypes.ComponentVersionListItem]?
    /// The token for the next set of results, or null if there are no additional results.
    var nextToken: Swift.String?
...
public struct ListComponentsInput: Swift.Equatable {
    ...
    var scope: GreengrassV2ClientTypes.ComponentVisibilityScope?
...
public struct ListComponentsOutputResponse: Swift.Equatable {
    ...
    var components: [GreengrassV2ClientTypes.Component]?
    /// The token for the next set of results, or null if there are no additional results.
    var nextToken: Swift.String?
...
public struct ListCoreDevicesInput: Swift.Equatable {
    ...
    var thingGroupArn: Swift.String?
...
public struct ListCoreDevicesOutputResponse: Swift.Equatable {
    ...
    var coreDevices: [GreengrassV2ClientTypes.CoreDevice]?
    /// The token for the next set of results, or null if there are no additional results.
    var nextToken: Swift.String?
...
public struct ListDeploymentsInput: Swift.Equatable {
    ...
    ///
    /// Default: LATEST_ONLY
    var historyFilter: GreengrassV2ClientTypes.DeploymentHistoryFilter?
    /// The maximum number of results to be returned per paginated request.
    var maxResults: Swift.Int
    /// The token to be used for the next set of paginated results.
    var nextToken: Swift.String?
...
public struct ListDeploymentsOutputResponse: Swift.Equatable {
    ...
    var deployments: [GreengrassV2ClientTypes.Deployment]?
    /// The token for the next set of results, or null if there are no additional results.
    var nextToken: Swift.String?
...
public struct ListEffectiveDeploymentsOutputResponse: Swift.Equatable {
    ...
    var effectiveDeployments: [GreengrassV2ClientTypes.EffectiveDeployment]?
    /// The token for the next set of results, or null if there are no additional results.
    var nextToken: Swift.String?
...
public struct ListInstalledComponentsOutputResponse: Swift.Equatable {
    ...
    var installedComponents: [GreengrassV2ClientTypes.InstalledComponent]?
    /// The token for the next set of results, or null if there are no additional results.
    var nextToken: Swift.String?
...
public struct ResolveComponentCandidatesInput: Swift.Equatable {
    ...
    /// This member is required.
    var componentCandidates: [GreengrassV2ClientTypes.ComponentCandidate]?
    /// The platform to use to resolve compatible components.
    /// This member is required.
    var platform: GreengrassV2ClientTypes.ComponentPlatform?
...
public struct ResolveComponentCandidatesOutputResponse: Swift.Equatable {
    ...
    var resolvedComponentVersions: [GreengrassV2ClientTypes.ResolvedComponentVersion]?
