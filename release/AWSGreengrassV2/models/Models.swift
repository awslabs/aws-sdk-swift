...
extension GreengrassV2ClientTypes.InstalledComponent: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let lastReportedTimestamp = self.lastReportedTimestamp {
            try encodeContainer.encode(lastReportedTimestamp.timeIntervalSince1970, forKey: .lastReportedTimestamp)
        }
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let lastReportedTimestampDecoded = try containerValues.decodeIfPresent(ClientRuntime.Date.self, forKey: .lastReportedTimestamp)
