...
public struct CreateDatabaseInput: Swift.Equatable {
    ...
    var tags: [TimestreamWriteClientTypes.Tag]?
...
public struct CreateDatabaseOutputResponse: Swift.Equatable {
    ...
    var database: TimestreamWriteClientTypes.Database?
...
public struct CreateTableInput: Swift.Equatable {
    ...
    var magneticStoreWriteProperties: TimestreamWriteClientTypes.MagneticStoreWriteProperties?
    /// The duration for which your time series data must be stored in the memory store and the magnetic store.
    var retentionProperties: TimestreamWriteClientTypes.RetentionProperties?
...
public struct CreateTableOutputResponse: Swift.Equatable {
    ...
    var table: TimestreamWriteClientTypes.Table?
...
public struct DescribeEndpointsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var endpoints: [TimestreamWriteClientTypes.Endpoint]?
...
extension TimestreamWriteClientTypes {
    ...
    public struct Dimension: Swift.Equatable {
        ...
        var dimensionValueType: TimestreamWriteClientTypes.DimensionValueType?
...
extension TimestreamWriteClientTypes {
    ...
    public struct Endpoint: Swift.Equatable {
        ...
        /// This member is required.
        var cachePeriodInMinutes: Swift.Int
...
public struct ListDatabasesOutputResponse: Swift.Equatable {
    ...
    var databases: [TimestreamWriteClientTypes.Database]?
...
public struct ListTablesOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// A list of tables.
    var tables: [TimestreamWriteClientTypes.Table]?
...
extension TimestreamWriteClientTypes {
    ...
    public struct MagneticStoreRejectedDataLocation: Swift.Equatable {
        ...
        var s3Configuration: TimestreamWriteClientTypes.S3Configuration?
...
extension TimestreamWriteClientTypes {
    ...
    public struct MagneticStoreWriteProperties: Swift.Equatable {
        ...
        /// This member is required.
        var enableMagneticStoreWrites: Swift.Bool?
        /// The location to write error reports for records rejected asynchronously during magnetic store writes.
        var magneticStoreRejectedDataLocation: TimestreamWriteClientTypes.MagneticStoreRejectedDataLocation?
...
extension TimestreamWriteClientTypes {
    ...
    public struct MeasureValue: Swift.Equatable {
        ...
        /// This member is required.
        var type: TimestreamWriteClientTypes.MeasureValueType?
...
extension TimestreamWriteClientTypes {
    ...
    public struct Record: Swift.Equatable {
        ...
        var dimensions: [TimestreamWriteClientTypes.Dimension]?
        /// Measure represents the data attribute of the time series. For example, the CPU utilization of an EC2 instance or the RPM of a wind turbine are measures.
        var measureName: Swift.String?
        /// Contains the measure value for the time series data point.
        var measureValue: Swift.String?
        /// Contains the data type of the measure value for the time series data point. Default type is DOUBLE.
        var measureValueType: TimestreamWriteClientTypes.MeasureValueType?
        ...
        var measureValues: [TimestreamWriteClientTypes.MeasureValue]?
        /// Contains the time at which the measure value for the data point was collected. The time value plus the unit provides the time elapsed since the epoch. For example, if the time value is 12345 and the unit is ms, then 12345 ms have elapsed since the epoch.
        var time: Swift.String?
        /// The granularity of the timestamp unit. It indicates if the time value is in seconds, milliseconds, nanoseconds or other supported values. Default is MILLISECONDS.
        var timeUnit: TimestreamWriteClientTypes.TimeUnit?
...
extension TimestreamWriteClientTypes {
    ...
    public struct RecordsIngested: Swift.Equatable {
        ...
        var magneticStore: Swift.Int
        /// Count of records ingested into the memory store.
        var memoryStore: Swift.Int
...
extension TimestreamWriteClientTypes {
    ...
    public struct RetentionProperties: Swift.Equatable {
        ...
        /// This member is required.
        var magneticStoreRetentionPeriodInDays: Swift.Int
        /// The duration for which data must be stored in the memory store.
        /// This member is required.
        var memoryStoreRetentionPeriodInHours: Swift.Int
...
extension TimestreamWriteClientTypes {
    ...
    public struct S3Configuration: Swift.Equatable {
        ...
        var encryptionOption: TimestreamWriteClientTypes.S3EncryptionOption?
...
extension TimestreamWriteClientTypes {
    ...
    public struct Table: Swift.Equatable {
        ...
        var tableStatus: TimestreamWriteClientTypes.TableStatus?
...
public struct WriteRecordsOutputResponse: Swift.Equatable {
    /// Information on the records ingested by this request.
    var recordsIngested: TimestreamWriteClientTypes.RecordsIngested?
