...
public extension SageMakerClient {
    ...
    {
        typealias batchDescribeModelPackageContinuation = CheckedContinuation<BatchDescribeModelPackageOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: batchDescribeModelPackageContinuation) in
            batchDescribeModelPackage(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createInferenceRecommendationsJobContinuation = CheckedContinuation<CreateInferenceRecommendationsJobOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createInferenceRecommendationsJobContinuation) in
            createInferenceRecommendationsJob(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeInferenceRecommendationsJobContinuation = CheckedContinuation<DescribeInferenceRecommendationsJobOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeInferenceRecommendationsJobContinuation) in
            describeInferenceRecommendationsJob(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeLineageGroupContinuation = CheckedContinuation<DescribeLineageGroupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeLineageGroupContinuation) in
            describeLineageGroup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getLineageGroupPolicyContinuation = CheckedContinuation<GetLineageGroupPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getLineageGroupPolicyContinuation) in
            getLineageGroupPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listInferenceRecommendationsJobsContinuation = CheckedContinuation<ListInferenceRecommendationsJobsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listInferenceRecommendationsJobsContinuation) in
            listInferenceRecommendationsJobs(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listLineageGroupsContinuation = CheckedContinuation<ListLineageGroupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listLineageGroupsContinuation) in
            listLineageGroups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listModelMetadataContinuation = CheckedContinuation<ListModelMetadataOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listModelMetadataContinuation) in
            listModelMetadata(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias queryLineageContinuation = CheckedContinuation<QueryLineageOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: queryLineageContinuation) in
            queryLineage(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias stopInferenceRecommendationsJobContinuation = CheckedContinuation<StopInferenceRecommendationsJobOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopInferenceRecommendationsJobContinuation) in
            stopInferenceRecommendationsJob(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
