...
public protocol SageMakerClientProtocol {
    ...
    func batchDescribeModelPackage(input: BatchDescribeModelPackageInput, completion: @escaping (ClientRuntime.SdkResult<BatchDescribeModelPackageOutputResponse, BatchDescribeModelPackageOutputError>) -> Void)
    ...
    func createInferenceRecommendationsJob(input: CreateInferenceRecommendationsJobInput, completion: @escaping (ClientRuntime.SdkResult<CreateInferenceRecommendationsJobOutputResponse, CreateInferenceRecommendationsJobOutputError>) -> Void)
    ...
    func describeInferenceRecommendationsJob(input: DescribeInferenceRecommendationsJobInput, completion: @escaping (ClientRuntime.SdkResult<DescribeInferenceRecommendationsJobOutputResponse, DescribeInferenceRecommendationsJobOutputError>) -> Void)
    ...
    func describeLineageGroup(input: DescribeLineageGroupInput, completion: @escaping (ClientRuntime.SdkResult<DescribeLineageGroupOutputResponse, DescribeLineageGroupOutputError>) -> Void)
    ...
    func getLineageGroupPolicy(input: GetLineageGroupPolicyInput, completion: @escaping (ClientRuntime.SdkResult<GetLineageGroupPolicyOutputResponse, GetLineageGroupPolicyOutputError>) -> Void)
    ...
    func listInferenceRecommendationsJobs(input: ListInferenceRecommendationsJobsInput, completion: @escaping (ClientRuntime.SdkResult<ListInferenceRecommendationsJobsOutputResponse, ListInferenceRecommendationsJobsOutputError>) -> Void)
    ...
    func listLineageGroups(input: ListLineageGroupsInput, completion: @escaping (ClientRuntime.SdkResult<ListLineageGroupsOutputResponse, ListLineageGroupsOutputError>) -> Void)
    ...
    func listModelMetadata(input: ListModelMetadataInput, completion: @escaping (ClientRuntime.SdkResult<ListModelMetadataOutputResponse, ListModelMetadataOutputError>) -> Void)
    ...
    func queryLineage(input: QueryLineageInput, completion: @escaping (ClientRuntime.SdkResult<QueryLineageOutputResponse, QueryLineageOutputError>) -> Void)
    /// Register devices.
    ...
    func stopInferenceRecommendationsJob(input: StopInferenceRecommendationsJobInput, completion: @escaping (ClientRuntime.SdkResult<StopInferenceRecommendationsJobOutputResponse, StopInferenceRecommendationsJobOutputError>) -> Void)
