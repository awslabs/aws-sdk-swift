...
extension RdsDataClient: RdsDataClientProtocol {
    ...
    public func batchExecuteStatement(input: BatchExecuteStatementInput, completion: @escaping (SdkResult<BatchExecuteStatementOutput, BatchExecuteStatementOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<BatchExecuteStatementInput, BatchExecuteStatementOutput, BatchExecuteStatementOutputError>(contentType: "application/json"))
    ...
    ///         </important>
    public func beginTransaction(input: BeginTransactionInput, completion: @escaping (SdkResult<BeginTransactionOutput, BeginTransactionOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "rds-data")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<BeginTransactionInput, BeginTransactionOutput, BeginTransactionOutputError>(id: "beginTransaction")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<BeginTransactionInput, BeginTransactionOutput, BeginTransactionOutputError>(contentType: "application/json"))
    ...
    public func commitTransaction(input: CommitTransactionInput, completion: @escaping (SdkResult<CommitTransactionOutput, CommitTransactionOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "rds-data")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CommitTransactionInput, CommitTransactionOutput, CommitTransactionOutputError>(id: "commitTransaction")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CommitTransactionInput, CommitTransactionOutput, CommitTransactionOutputError>(contentType: "application/json"))
    ...
    public func executeSql(input: ExecuteSqlInput, completion: @escaping (SdkResult<ExecuteSqlOutput, ExecuteSqlOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "rds-data")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ExecuteSqlInput, ExecuteSqlOutput, ExecuteSqlOutputError>(id: "executeSql")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ExecuteSqlInput, ExecuteSqlOutput, ExecuteSqlOutputError>(contentType: "application/json"))
    ...
    public func executeStatement(input: ExecuteStatementInput, completion: @escaping (SdkResult<ExecuteStatementOutput, ExecuteStatementOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ExecuteStatementInput, ExecuteStatementOutput, ExecuteStatementOutputError>(contentType: "application/json"))
    ...
    public func rollbackTransaction(input: RollbackTransactionInput, completion: @escaping (SdkResult<RollbackTransactionOutput, RollbackTransactionOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "rds-data")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RollbackTransactionInput, RollbackTransactionOutput, RollbackTransactionOutputError>(id: "rollbackTransaction")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RollbackTransactionInput, RollbackTransactionOutput, RollbackTransactionOutputError>(contentType: "application/json"))
