...
public protocol RdsDataClientProtocol {
    ...
    ///         </important>
    func batchExecuteStatement(input: BatchExecuteStatementInput, completion: @escaping (SdkResult<BatchExecuteStatementOutput, BatchExecuteStatementOutputError>) -> Void)
    ...
    ///         </important>
    func beginTransaction(input: BeginTransactionInput, completion: @escaping (SdkResult<BeginTransactionOutput, BeginTransactionOutputError>) -> Void)
    /// <p>Ends a SQL transaction started with the <code>BeginTransaction</code> operation and
    ///             commits the changes.</p>
    func commitTransaction(input: CommitTransactionInput, completion: @escaping (SdkResult<CommitTransactionOutput, CommitTransactionOutputError>) -> Void)
    ...
    func executeSql(input: ExecuteSqlInput, completion: @escaping (SdkResult<ExecuteSqlOutput, ExecuteSqlOutputError>) -> Void)
    ...
    func rollbackTransaction(input: RollbackTransactionInput, completion: @escaping (SdkResult<RollbackTransactionOutput, RollbackTransactionOutputError>) -> Void)
}
