...
public protocol CostExplorerClientProtocol {
    ...
    ///       specification. </p>
    func createAnomalyMonitor(input: CreateAnomalyMonitorInput, completion: @escaping (SdkResult<CreateAnomalyMonitorOutput, CreateAnomalyMonitorOutputError>) -> Void)
    ...
    func createAnomalySubscription(input: CreateAnomalySubscriptionInput, completion: @escaping (SdkResult<CreateAnomalySubscriptionOutput, CreateAnomalySubscriptionOutputError>) -> Void)
    /// <p>Creates a new Cost Category with the requested name and rules.</p>
    func createCostCategoryDefinition(input: CreateCostCategoryDefinitionInput, completion: @escaping (SdkResult<CreateCostCategoryDefinitionOutput, CreateCostCategoryDefinitionOutputError>) -> Void)
    /// <p>Deletes a cost anomaly monitor. </p>
    func deleteAnomalyMonitor(input: DeleteAnomalyMonitorInput, completion: @escaping (SdkResult<DeleteAnomalyMonitorOutput, DeleteAnomalyMonitorOutputError>) -> Void)
    /// <p>Deletes a cost anomaly subscription. </p>
    func deleteAnomalySubscription(input: DeleteAnomalySubscriptionInput, completion: @escaping (SdkResult<DeleteAnomalySubscriptionOutput, DeleteAnomalySubscriptionOutputError>) -> Void)
    /// <p>Deletes a Cost Category. Expenses from this month going forward will no longer be categorized with this Cost Category.</p>
    func deleteCostCategoryDefinition(input: DeleteCostCategoryDefinitionInput, completion: @escaping (SdkResult<DeleteCostCategoryDefinitionOutput, DeleteCostCategoryDefinitionOutputError>) -> Void)
    ...
    func describeCostCategoryDefinition(input: DescribeCostCategoryDefinitionInput, completion: @escaping (SdkResult<DescribeCostCategoryDefinitionOutput, DescribeCostCategoryDefinitionOutputError>) -> Void)
    ...
    func getAnomalies(input: GetAnomaliesInput, completion: @escaping (SdkResult<GetAnomaliesOutput, GetAnomaliesOutputError>) -> Void)
    ...
    func getAnomalyMonitors(input: GetAnomalyMonitorsInput, completion: @escaping (SdkResult<GetAnomalyMonitorsOutput, GetAnomalyMonitorsOutputError>) -> Void)
    /// <p>Retrieves the cost anomaly subscription objects for your account. You can filter using a
    ///       list of cost anomaly monitor Amazon Resource Names (ARNs). </p>
    func getAnomalySubscriptions(input: GetAnomalySubscriptionsInput, completion: @escaping (SdkResult<GetAnomalySubscriptionsOutput, GetAnomalySubscriptionsOutputError>) -> Void)
    ...
    func getCostAndUsage(input: GetCostAndUsageInput, completion: @escaping (SdkResult<GetCostAndUsageOutput, GetCostAndUsageOutputError>) -> Void)
    ...
    ///          </note>
    func getCostAndUsageWithResources(input: GetCostAndUsageWithResourcesInput, completion: @escaping (SdkResult<GetCostAndUsageWithResourcesOutput, GetCostAndUsageWithResourcesOutputError>) -> Void)
    ...
    ///          </note>
    func getCostCategories(input: GetCostCategoriesInput, completion: @escaping (SdkResult<GetCostCategoriesOutput, GetCostCategoriesOutputError>) -> Void)
    ...
    func getCostForecast(input: GetCostForecastInput, completion: @escaping (SdkResult<GetCostForecastOutput, GetCostForecastOutputError>) -> Void)
    ...
    func getDimensionValues(input: GetDimensionValuesInput, completion: @escaping (SdkResult<GetDimensionValuesOutput, GetDimensionValuesOutputError>) -> Void)
    ...
    func getReservationCoverage(input: GetReservationCoverageInput, completion: @escaping (SdkResult<GetReservationCoverageOutput, GetReservationCoverageOutputError>) -> Void)
    ...
    func getReservationPurchaseRecommendation(input: GetReservationPurchaseRecommendationInput, completion: @escaping (SdkResult<GetReservationPurchaseRecommendationOutput, GetReservationPurchaseRecommendationOutputError>) -> Void)
    ...
    func getReservationUtilization(input: GetReservationUtilizationInput, completion: @escaping (SdkResult<GetReservationUtilizationOutput, GetReservationUtilizationOutputError>) -> Void)
    ...
    ///       Guide</i>.</p>
    func getRightsizingRecommendation(input: GetRightsizingRecommendationInput, completion: @escaping (SdkResult<GetRightsizingRecommendationOutput, GetRightsizingRecommendationOutputError>) -> Void)
    ...
    ///          </ul>
    /// 	        <p>To determine valid values for a dimension, use the <code>GetDimensionValues</code> operation.</p>
    func getSavingsPlansCoverage(input: GetSavingsPlansCoverageInput, completion: @escaping (SdkResult<GetSavingsPlansCoverageOutput, GetSavingsPlansCoverageOutputError>) -> Void)
    /// <p>Retrieves your request parameters, Savings Plan Recommendations Summary and Details. </p>
    func getSavingsPlansPurchaseRecommendation(input: GetSavingsPlansPurchaseRecommendationInput, completion: @escaping (SdkResult<GetSavingsPlansPurchaseRecommendationOutput, GetSavingsPlansPurchaseRecommendationOutputError>) -> Void)
    ...
    ///          </note>
    func getSavingsPlansUtilization(input: GetSavingsPlansUtilizationInput, completion: @escaping (SdkResult<GetSavingsPlansUtilizationOutput, GetSavingsPlansUtilizationOutputError>) -> Void)
    ...
    ///          </note>
    func getSavingsPlansUtilizationDetails(input: GetSavingsPlansUtilizationDetailsInput, completion: @escaping (SdkResult<GetSavingsPlansUtilizationDetailsOutput, GetSavingsPlansUtilizationDetailsOutputError>) -> Void)
    ...
    func getUsageForecast(input: GetUsageForecastInput, completion: @escaping (SdkResult<GetUsageForecastOutput, GetUsageForecastOutputError>) -> Void)
    ...
    func listCostCategoryDefinitions(input: ListCostCategoryDefinitionsInput, completion: @escaping (SdkResult<ListCostCategoryDefinitionsOutput, ListCostCategoryDefinitionsOutputError>) -> Void)
    /// <p>Modifies the feedback property of a given cost anomaly. </p>
    func provideAnomalyFeedback(input: ProvideAnomalyFeedbackInput, completion: @escaping (SdkResult<ProvideAnomalyFeedbackOutput, ProvideAnomalyFeedbackOutputError>) -> Void)
    ...
    func updateAnomalyMonitor(input: UpdateAnomalyMonitorInput, completion: @escaping (SdkResult<UpdateAnomalyMonitorOutput, UpdateAnomalyMonitorOutputError>) -> Void)
    /// <p> Updates an existing cost anomaly monitor subscription. </p>
    func updateAnomalySubscription(input: UpdateAnomalySubscriptionInput, completion: @escaping (SdkResult<UpdateAnomalySubscriptionOutput, UpdateAnomalySubscriptionOutputError>) -> Void)
    ...
    func updateCostCategoryDefinition(input: UpdateCostCategoryDefinitionInput, completion: @escaping (SdkResult<UpdateCostCategoryDefinitionOutput, UpdateCostCategoryDefinitionOutputError>) -> Void)
}
