...
public extension Route53ResolverClient {
    ...
    {
        typealias getResolverConfigContinuation = CheckedContinuation<GetResolverConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getResolverConfigContinuation) in
            getResolverConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listResolverConfigsContinuation = CheckedContinuation<ListResolverConfigsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listResolverConfigsContinuation) in
            listResolverConfigs(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateResolverConfigContinuation = CheckedContinuation<UpdateResolverConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateResolverConfigContinuation) in
            updateResolverConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
