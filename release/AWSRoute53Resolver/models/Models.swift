...
public struct AssociateFirewallRuleGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var firewallRuleGroupId: Swift.String?
    ...
    var mutationProtection: Route53ResolverClientTypes.MutationProtectionStatus?
    ...
    var tags: [Route53ResolverClientTypes.Tag]?
...
public struct AssociateFirewallRuleGroupOutputResponse: Swift.Equatable {
    ...
    var firewallRuleGroupAssociation: Route53ResolverClientTypes.FirewallRuleGroupAssociation?
...
public struct AssociateResolverEndpointIpAddressInput: Swift.Equatable {
    ...
    /// This member is required.
    var ipAddress: Route53ResolverClientTypes.IpAddressUpdate?
    /// The ID of the Resolver endpoint that you want to associate IP addresses with.
    /// This member is required.
    var resolverEndpointId: Swift.String?
...
public struct AssociateResolverEndpointIpAddressOutputResponse: Swift.Equatable {
    ...
    var resolverEndpoint: Route53ResolverClientTypes.ResolverEndpoint?
...
public struct AssociateResolverQueryLogConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var resolverQueryLogConfigId: Swift.String?
...
public struct AssociateResolverQueryLogConfigOutputResponse: Swift.Equatable {
    ...
    var resolverQueryLogConfigAssociation: Route53ResolverClientTypes.ResolverQueryLogConfigAssociation?
...
public struct AssociateResolverRuleInput: Swift.Equatable {
    ...
    /// This member is required.
    var resolverRuleId: Swift.String?
...
public struct AssociateResolverRuleOutputResponse: Swift.Equatable {
    ...
    var resolverRuleAssociation: Route53ResolverClientTypes.ResolverRuleAssociation?
...
public struct CreateFirewallDomainListOutputResponse: Swift.Equatable {
    ...
    var firewallDomainList: Route53ResolverClientTypes.FirewallDomainList?
...
public struct CreateFirewallRuleGroupOutputResponse: Swift.Equatable {
    ...
    var firewallRuleGroup: Route53ResolverClientTypes.FirewallRuleGroup?
...
public struct CreateFirewallRuleInput: Swift.Equatable {
    ...
    /// This member is required.
    var action: Route53ResolverClientTypes.Action?
    ...
    var blockOverrideDnsType: Route53ResolverClientTypes.BlockOverrideDnsType?
    ...
    var blockOverrideDomain: Swift.String?
    ...
    var blockOverrideTtl: Swift.Int?
    ...
    var blockResponse: Route53ResolverClientTypes.BlockResponse?
    /// A unique string that identifies the request and that allows you to retry failed requests without the risk of running the operation twice. CreatorRequestId can be any unique string, for example, a date/time stamp.
    /// This member is required.
    var creatorRequestId: Swift.String?
    /// The ID of the domain list that you want to use in the rule.
    /// This member is required.
    var firewallDomainListId: Swift.String?
...
public struct CreateFirewallRuleOutputResponse: Swift.Equatable {
    ...
    var firewallRule: Route53ResolverClientTypes.FirewallRule?
...
public struct CreateResolverEndpointInput: Swift.Equatable {
    ...
    /// This member is required.
    var direction: Route53ResolverClientTypes.ResolverEndpointDirection?
    /// The subnets and IP addresses in your VPC that DNS queries originate from (for outbound endpoints) or that you forward DNS queries to (for inbound endpoints). The subnet ID uniquely identifies a VPC.
    /// This member is required.
    var ipAddresses: [Route53ResolverClientTypes.IpAddressRequest]?
...
public struct CreateResolverQueryLogConfigOutputResponse: Swift.Equatable {
    ...
    var resolverQueryLogConfig: Route53ResolverClientTypes.ResolverQueryLogConfig?
...
public struct CreateResolverRuleInput: Swift.Equatable {
    ...
    /// This member is required.
    var ruleType: Route53ResolverClientTypes.RuleTypeOption?
    /// A list of the tag keys and values that you want to associate with the endpoint.
    var tags: [Route53ResolverClientTypes.Tag]?
    ...
    var targetIps: [Route53ResolverClientTypes.TargetAddress]?
...
public struct CreateResolverRuleOutputResponse: Swift.Equatable {
    ...
    var resolverRule: Route53ResolverClientTypes.ResolverRule?
...
public struct DisassociateFirewallRuleGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var firewallRuleGroupAssociationId: Swift.String?
...
extension Route53ResolverClientTypes {
    ...
    public struct FirewallConfig: Swift.Equatable {
        ...
        var firewallFailOpen: Route53ResolverClientTypes.FirewallFailOpenStatus?
...
extension Route53ResolverClientTypes {
    ...
    public struct FirewallDomainList: Swift.Equatable {
        ...
        var domainCount: Swift.Int?
        /// The ID of the domain list.
        var id: Swift.String?
        /// The owner of the list, used only for lists that are not managed by you. For example, the managed domain list AWSManagedDomainsMalwareDomainList has the managed owner name Route 53 Resolver DNS Firewall.
        var managedOwnerName: Swift.String?
        /// The date and time that the domain list was last modified, in Unix time format and Coordinated Universal Time (UTC).
        var modificationTime: Swift.String?
        /// The name of the domain list.
        var name: Swift.String?
        /// The status of the domain list.
        var status: Route53ResolverClientTypes.FirewallDomainListStatus?
...
extension Route53ResolverClientTypes {
    ...
    public struct FirewallRuleGroup: Swift.Equatable {
        ...
        var shareStatus: Route53ResolverClientTypes.ShareStatus?
        /// The status of the domain list.
        var status: Route53ResolverClientTypes.FirewallRuleGroupStatus?
...
extension Route53ResolverClientTypes {
    ...
    public struct FirewallRuleGroupAssociation: Swift.Equatable {
        ...
        var status: Route53ResolverClientTypes.FirewallRuleGroupAssociationStatus?
...
public struct GetFirewallConfigOutputResponse: Swift.Equatable {
    ...
    var firewallConfig: Route53ResolverClientTypes.FirewallConfig?
...
public struct GetFirewallRuleGroupPolicyOutputResponse: Swift.Equatable {
    ...
    var firewallRuleGroupPolicy: Swift.String?
...
public struct GetResolverConfigOutputResponse: Swift.Equatable {
    ...
    var resolverConfig: Route53ResolverClientTypes.ResolverConfig?
...
public struct GetResolverDnssecConfigOutputResponse: Swift.Equatable {
    ...
    var resolverDNSSECConfig: Route53ResolverClientTypes.ResolverDnssecConfig?
...
public struct GetResolverQueryLogConfigAssociationInput: Swift.Equatable {
    ...
    /// This member is required.
    var resolverQueryLogConfigAssociationId: Swift.String?
...
public struct GetResolverQueryLogConfigPolicyOutputResponse: Swift.Equatable {
    ...
    var resolverQueryLogConfigPolicy: Swift.String?
...
public struct GetResolverRuleAssociationInput: Swift.Equatable {
    ...
    /// This member is required.
    var resolverRuleAssociationId: Swift.String?
...
public struct GetResolverRulePolicyOutputResponse: Swift.Equatable {
    ...
    var resolverRulePolicy: Swift.String?
...
public struct ImportFirewallDomainsInput: Swift.Equatable {
    ...
    /// This member is required.
    var domainFileUrl: Swift.String?
    ...
    /// This member is required.
    var operation: Route53ResolverClientTypes.FirewallDomainImportOperation?
...
extension Route53ResolverClientTypes {
    ...
    public struct IpAddressResponse: Swift.Equatable {
        ...
        var ipId: Swift.String?
        /// The date and time that the IP address was last modified, in Unix time format and Coordinated Universal Time (UTC).
        var modificationTime: Swift.String?
        /// A status code that gives the current status of the request.
        var status: Route53ResolverClientTypes.IpAddressStatus?
...
public struct ListFirewallConfigsOutputResponse: Swift.Equatable {
    ...
    var firewallConfigs: [Route53ResolverClientTypes.FirewallConfig]?
...
public struct ListFirewallDomainListsOutputResponse: Swift.Equatable {
    ...
    var firewallDomainLists: [Route53ResolverClientTypes.FirewallDomainListMetadata]?
    /// If objects are still available for retrieval, Resolver returns this token in the response. To retrieve the next batch of objects, provide this token in your next request.
    var nextToken: Swift.String?
...
public struct ListFirewallRuleGroupAssociationsOutputResponse: Swift.Equatable {
    ...
    var firewallRuleGroupAssociations: [Route53ResolverClientTypes.FirewallRuleGroupAssociation]?
    /// If objects are still available for retrieval, Resolver returns this token in the response. To retrieve the next batch of objects, provide this token in your next request.
    var nextToken: Swift.String?
...
public struct ListFirewallRuleGroupsOutputResponse: Swift.Equatable {
    ...
    var firewallRuleGroups: [Route53ResolverClientTypes.FirewallRuleGroupMetadata]?
    /// If objects are still available for retrieval, Resolver returns this token in the response. To retrieve the next batch of objects, provide this token in your next request.
    var nextToken: Swift.String?
...
public struct ListFirewallRulesOutputResponse: Swift.Equatable {
    ...
    var firewallRules: [Route53ResolverClientTypes.FirewallRule]?
    /// If objects are still available for retrieval, Resolver returns this token in the response. To retrieve the next batch of objects, provide this token in your next request.
    var nextToken: Swift.String?
...
public struct ListResolverConfigsOutputResponse: Swift.Equatable {
    ...
    var resolverConfigs: [Route53ResolverClientTypes.ResolverConfig]?
...
public struct ListResolverDnssecConfigsInput: Swift.Equatable {
    ...
    var filters: [Route53ResolverClientTypes.Filter]?
...
public struct ListResolverDnssecConfigsOutputResponse: Swift.Equatable {
    ...
    var resolverDnssecConfigs: [Route53ResolverClientTypes.ResolverDnssecConfig]?
...
public struct ListResolverEndpointIpAddressesOutputResponse: Swift.Equatable {
    ...
    var ipAddresses: [Route53ResolverClientTypes.IpAddressResponse]?
...
public struct ListResolverEndpointsOutputResponse: Swift.Equatable {
    ...
    var resolverEndpoints: [Route53ResolverClientTypes.ResolverEndpoint]?
...
public struct ListResolverQueryLogConfigAssociationsInput: Swift.Equatable {
    ...
    var sortOrder: Route53ResolverClientTypes.SortOrder?
...
public struct ListResolverQueryLogConfigAssociationsOutputResponse: Swift.Equatable {
    ...
    var resolverQueryLogConfigAssociations: [Route53ResolverClientTypes.ResolverQueryLogConfigAssociation]?
    ...
    var totalFilteredCount: Swift.Int
...
public struct ListResolverQueryLogConfigsOutputResponse: Swift.Equatable {
    ...
    var resolverQueryLogConfigs: [Route53ResolverClientTypes.ResolverQueryLogConfig]?
...
public struct ListResolverRuleAssociationsOutputResponse: Swift.Equatable {
    ...
    var resolverRuleAssociations: [Route53ResolverClientTypes.ResolverRuleAssociation]?
...
public struct ListResolverRulesOutputResponse: Swift.Equatable {
    ...
    var resolverRules: [Route53ResolverClientTypes.ResolverRule]?
...
extension Route53ResolverClientTypes {
    ...
    public struct ResolverConfig: Swift.Equatable {
        ...
        var autodefinedReverse: Route53ResolverClientTypes.ResolverAutodefinedReverseStatus?
...
extension Route53ResolverClientTypes {
    ...
    public struct ResolverDnssecConfig: Swift.Equatable {
        ...
        var validationStatus: Route53ResolverClientTypes.ResolverDNSSECValidationStatus?
...
extension Route53ResolverClientTypes {
    ...
    public struct ResolverEndpoint: Swift.Equatable {
        ...
        var hostVPCId: Swift.String?
        /// The ID of the Resolver endpoint.
        var id: Swift.String?
        /// The number of IP addresses that the Resolver endpoint can use for DNS queries.
        var ipAddressCount: Swift.Int?
        ...
        var status: Route53ResolverClientTypes.ResolverEndpointStatus?
...
extension Route53ResolverClientTypes {
    ...
    public struct ResolverQueryLogConfig: Swift.Equatable {
        ...
        ///
        /// * Permissions don't allow sending logs to the destination.
        var status: Route53ResolverClientTypes.ResolverQueryLogConfigStatus?
...
extension Route53ResolverClientTypes {
    ...
    public struct ResolverQueryLogConfigAssociation: Swift.Equatable {
        ...
        var error: Route53ResolverClientTypes.ResolverQueryLogConfigAssociationError?
        ...
        var status: Route53ResolverClientTypes.ResolverQueryLogConfigAssociationStatus?
...
extension Route53ResolverClientTypes {
    ...
    public struct ResolverRule: Swift.Equatable {
        ...
        var status: Route53ResolverClientTypes.ResolverRuleStatus?
...
extension Route53ResolverClientTypes {
    ...
    public struct ResolverRuleAssociation: Swift.Equatable {
        ...
        var status: Route53ResolverClientTypes.ResolverRuleAssociationStatus?
...
public struct UpdateFirewallDomainsInput: Swift.Equatable {
    ...
    /// This member is required.
    var operation: Route53ResolverClientTypes.FirewallDomainUpdateOperation?
...
public struct UpdateResolverConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var autodefinedReverseFlag: Route53ResolverClientTypes.AutodefinedReverseFlag?
...
public struct UpdateResolverDnssecConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var validation: Route53ResolverClientTypes.Validation?
...
public struct UpdateResolverRuleInput: Swift.Equatable {
    ...
    /// This member is required.
    var config: Route53ResolverClientTypes.ResolverRuleConfig?
