...
public protocol Route53ResolverClientProtocol {
    ...
    func getResolverConfig(input: GetResolverConfigInput, completion: @escaping (ClientRuntime.SdkResult<GetResolverConfigOutputResponse, GetResolverConfigOutputError>) -> Void)
    ...
    func listResolverConfigs(input: ListResolverConfigsInput, completion: @escaping (ClientRuntime.SdkResult<ListResolverConfigsOutputResponse, ListResolverConfigsOutputError>) -> Void)
    ...
    func updateResolverConfig(input: UpdateResolverConfigInput, completion: @escaping (ClientRuntime.SdkResult<UpdateResolverConfigOutputResponse, UpdateResolverConfigOutputError>) -> Void)
