...
public protocol ElasticLoadBalancingClientProtocol {
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func applySecurityGroupsToLoadBalancer(input: ApplySecurityGroupsToLoadBalancerInput, completion: @escaping (SdkResult<ApplySecurityGroupsToLoadBalancerOutput, ApplySecurityGroupsToLoadBalancerOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func attachLoadBalancerToSubnets(input: AttachLoadBalancerToSubnetsInput, completion: @escaping (SdkResult<AttachLoadBalancerToSubnetsOutput, AttachLoadBalancerToSubnetsOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func configureHealthCheck(input: ConfigureHealthCheckInput, completion: @escaping (SdkResult<ConfigureHealthCheckOutput, ConfigureHealthCheckOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func createAppCookieStickinessPolicy(input: CreateAppCookieStickinessPolicyInput, completion: @escaping (SdkResult<CreateAppCookieStickinessPolicyOutput, CreateAppCookieStickinessPolicyOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func createLBCookieStickinessPolicy(input: CreateLBCookieStickinessPolicyInput, completion: @escaping (SdkResult<CreateLBCookieStickinessPolicyOutput, CreateLBCookieStickinessPolicyOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func createLoadBalancer(input: CreateLoadBalancerInput, completion: @escaping (SdkResult<CreateLoadBalancerOutput, CreateLoadBalancerOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func createLoadBalancerListeners(input: CreateLoadBalancerListenersInput, completion: @escaping (SdkResult<CreateLoadBalancerListenersOutput, CreateLoadBalancerListenersOutputError>) -> Void)
    ...
    func createLoadBalancerPolicy(input: CreateLoadBalancerPolicyInput, completion: @escaping (SdkResult<CreateLoadBalancerPolicyOutput, CreateLoadBalancerPolicyOutputError>) -> Void)
    ...
    func deleteLoadBalancer(input: DeleteLoadBalancerInput, completion: @escaping (SdkResult<DeleteLoadBalancerOutput, DeleteLoadBalancerOutputError>) -> Void)
    /// <p>Deletes the specified listeners from the specified load balancer.</p>
    func deleteLoadBalancerListeners(input: DeleteLoadBalancerListenersInput, completion: @escaping (SdkResult<DeleteLoadBalancerListenersOutput, DeleteLoadBalancerListenersOutputError>) -> Void)
    /// <p>Deletes the specified policy from the specified load balancer. This policy must not be enabled for any listeners.</p>
    func deleteLoadBalancerPolicy(input: DeleteLoadBalancerPolicyInput, completion: @escaping (SdkResult<DeleteLoadBalancerPolicyOutput, DeleteLoadBalancerPolicyOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func deregisterInstancesFromLoadBalancer(input: DeregisterInstancesFromLoadBalancerInput, completion: @escaping (SdkResult<DeregisterInstancesFromLoadBalancerOutput, DeregisterInstancesFromLoadBalancerOutputError>) -> Void)
    ...
    func describeInstanceHealth(input: DescribeInstanceHealthInput, completion: @escaping (SdkResult<DescribeInstanceHealthOutput, DescribeInstanceHealthOutputError>) -> Void)
    /// <p>Describes the attributes for the specified load balancer.</p>
    func describeLoadBalancerAttributes(input: DescribeLoadBalancerAttributesInput, completion: @escaping (SdkResult<DescribeLoadBalancerAttributesOutput, DescribeLoadBalancerAttributesOutputError>) -> Void)
    ...
    func describeLoadBalancerPolicies(input: DescribeLoadBalancerPoliciesInput, completion: @escaping (SdkResult<DescribeLoadBalancerPoliciesOutput, DescribeLoadBalancerPoliciesOutputError>) -> Void)
    ...
    func describeLoadBalancerPolicyTypes(input: DescribeLoadBalancerPolicyTypesInput, completion: @escaping (SdkResult<DescribeLoadBalancerPolicyTypesOutput, DescribeLoadBalancerPolicyTypesOutputError>) -> Void)
    ...
    func detachLoadBalancerFromSubnets(input: DetachLoadBalancerFromSubnetsInput, completion: @escaping (SdkResult<DetachLoadBalancerFromSubnetsOutput, DetachLoadBalancerFromSubnetsOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func disableAvailabilityZonesForLoadBalancer(input: DisableAvailabilityZonesForLoadBalancerInput, completion: @escaping (SdkResult<DisableAvailabilityZonesForLoadBalancerOutput, DisableAvailabilityZonesForLoadBalancerOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func enableAvailabilityZonesForLoadBalancer(input: EnableAvailabilityZonesForLoadBalancerInput, completion: @escaping (SdkResult<EnableAvailabilityZonesForLoadBalancerOutput, EnableAvailabilityZonesForLoadBalancerOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func modifyLoadBalancerAttributes(input: ModifyLoadBalancerAttributesInput, completion: @escaping (SdkResult<ModifyLoadBalancerAttributesOutput, ModifyLoadBalancerAttributesOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-deregister-register-instances.html">Register or De-Register EC2 Instances</a>
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func registerInstancesWithLoadBalancer(input: RegisterInstancesWithLoadBalancerInput, completion: @escaping (SdkResult<RegisterInstancesWithLoadBalancerOutput, RegisterInstancesWithLoadBalancerOutputError>) -> Void)
    ...
    ///                 in the <i>Classic Load Balancers Guide</i>.</p>
    func setLoadBalancerListenerSSLCertificate(input: SetLoadBalancerListenerSSLCertificateInput, completion: @escaping (SdkResult<SetLoadBalancerListenerSSLCertificateOutput, SetLoadBalancerListenerSSLCertificateOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func setLoadBalancerPoliciesForBackendServer(input: SetLoadBalancerPoliciesForBackendServerInput, completion: @escaping (SdkResult<SetLoadBalancerPoliciesForBackendServerOutput, SetLoadBalancerPoliciesForBackendServerOutputError>) -> Void)
    ...
    ///             in the <i>Classic Load Balancers Guide</i>.</p>
    func setLoadBalancerPoliciesOfListener(input: SetLoadBalancerPoliciesOfListenerInput, completion: @escaping (SdkResult<SetLoadBalancerPoliciesOfListenerOutput, SetLoadBalancerPoliciesOfListenerOutputError>) -> Void)
}
