...
public struct CreateAppCookieStickinessPolicyInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<CreateAppCookieStickinessPolicyOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<CreateAppCookieStickinessPolicyOutput>
