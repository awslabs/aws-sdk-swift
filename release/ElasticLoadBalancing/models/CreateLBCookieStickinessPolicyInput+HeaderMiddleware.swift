...
public struct CreateLBCookieStickinessPolicyInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<CreateLBCookieStickinessPolicyOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<CreateLBCookieStickinessPolicyOutput>
