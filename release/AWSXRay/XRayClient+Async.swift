...
public extension XRayClient {
    ...
    {
        typealias batchGetTracesContinuation = CheckedContinuation<BatchGetTracesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: batchGetTracesContinuation) in
            batchGetTraces(input: input) { result in
                switch result {
    ...
    {
        typealias createSamplingRuleContinuation = CheckedContinuation<CreateSamplingRuleOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createSamplingRuleContinuation) in
            createSamplingRule(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteSamplingRuleContinuation = CheckedContinuation<DeleteSamplingRuleOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteSamplingRuleContinuation) in
            deleteSamplingRule(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getEncryptionConfigContinuation = CheckedContinuation<GetEncryptionConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getEncryptionConfigContinuation) in
            getEncryptionConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getGroupsContinuation = CheckedContinuation<GetGroupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getGroupsContinuation) in
            getGroups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getInsightContinuation = CheckedContinuation<GetInsightOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getInsightContinuation) in
            getInsight(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getInsightEventsContinuation = CheckedContinuation<GetInsightEventsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getInsightEventsContinuation) in
            getInsightEvents(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getInsightImpactGraphContinuation = CheckedContinuation<GetInsightImpactGraphOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getInsightImpactGraphContinuation) in
            getInsightImpactGraph(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getInsightSummariesContinuation = CheckedContinuation<GetInsightSummariesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getInsightSummariesContinuation) in
            getInsightSummaries(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getSamplingRulesContinuation = CheckedContinuation<GetSamplingRulesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getSamplingRulesContinuation) in
            getSamplingRules(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getSamplingStatisticSummariesContinuation = CheckedContinuation<GetSamplingStatisticSummariesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getSamplingStatisticSummariesContinuation) in
            getSamplingStatisticSummaries(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getSamplingTargetsContinuation = CheckedContinuation<GetSamplingTargetsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getSamplingTargetsContinuation) in
            getSamplingTargets(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getServiceGraphContinuation = CheckedContinuation<GetServiceGraphOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getServiceGraphContinuation) in
            getServiceGraph(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getTimeSeriesServiceStatisticsContinuation = CheckedContinuation<GetTimeSeriesServiceStatisticsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getTimeSeriesServiceStatisticsContinuation) in
            getTimeSeriesServiceStatistics(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getTraceGraphContinuation = CheckedContinuation<GetTraceGraphOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getTraceGraphContinuation) in
            getTraceGraph(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getTraceSummariesContinuation = CheckedContinuation<GetTraceSummariesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getTraceSummariesContinuation) in
            getTraceSummaries(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putEncryptionConfigContinuation = CheckedContinuation<PutEncryptionConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putEncryptionConfigContinuation) in
            putEncryptionConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putTelemetryRecordsContinuation = CheckedContinuation<PutTelemetryRecordsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putTelemetryRecordsContinuation) in
            putTelemetryRecords(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putTraceSegmentsContinuation = CheckedContinuation<PutTraceSegmentsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putTraceSegmentsContinuation) in
            putTraceSegments(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateSamplingRuleContinuation = CheckedContinuation<UpdateSamplingRuleOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateSamplingRuleContinuation) in
            updateSamplingRule(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
