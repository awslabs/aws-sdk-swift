...
public class LookoutMetricsClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try LookoutMetricsClientConfiguration(region: unwrappedRegion)
    ...
    public class LookoutMetricsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("LookoutMetricsClient")
