...
extension DirectoryClientTypes.ClientAuthenticationSettingInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ClientAuthenticationSettingInfo(lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), status: \(Swift.String(describing: status)), type: \(Swift.String(describing: type)))"}
}
...
extension DescribeClientAuthenticationSettingsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeClientAuthenticationSettingsInput(directoryId: \(Swift.String(describing: directoryId)), limit: \(Swift.String(describing: limit)), nextToken: \(Swift.String(describing: nextToken)), type: \(Swift.String(describing: type)))"}
}
...
extension DescribeClientAuthenticationSettingsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeClientAuthenticationSettingsOutputResponse(clientAuthenticationSettingsInfo: \(Swift.String(describing: clientAuthenticationSettingsInfo)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct DescribeClientAuthenticationSettingsOutputResponseBody: Swift.Equatable {
    public let clientAuthenticationSettingsInfo: [DirectoryClientTypes.ClientAuthenticationSettingInfo]?
    public let nextToken: Swift.String?
}
