...
extension FmsClientTypes {
    ...
    public struct EC2AssociateRouteTableAction: Swift.Equatable {
        ...
        public let gatewayId: FmsClientTypes.ActionTarget?
        /// The ID of the EC2 route table that is associated with the remediation action.
        /// This member is required.
        public let routeTableId: FmsClientTypes.ActionTarget?
        /// The ID of the subnet for the EC2 route table that is associated with the remediation action.
        public let subnetId: FmsClientTypes.ActionTarget?
...
extension FmsClientTypes {
    ...
    public struct EC2CopyRouteTableAction: Swift.Equatable {
        ...
        /// This member is required.
        public let vpcId: FmsClientTypes.ActionTarget?
...
extension FmsClientTypes {
    ...
    public struct EC2CreateRouteAction: Swift.Equatable {
        ...
        public let destinationCidrBlock: Swift.String?
        /// Information about the IPv6 CIDR block destination.
        public let destinationIpv6CidrBlock: Swift.String?
        /// Information about the ID of a prefix list used for the destination match.
        public let destinationPrefixListId: Swift.String?
        ...
        public let vpcEndpointId: FmsClientTypes.ActionTarget?
...
extension FmsClientTypes {
    ...
    public struct EC2ReplaceRouteTableAssociationAction: Swift.Equatable {
        ...
        /// This member is required.
        public let associationId: FmsClientTypes.ActionTarget?
...
extension FmsClientTypes {
    ...
    public struct ExpectedRoute: Swift.Equatable {
        ...
        public let allowedTargets: [Swift.String]?
        /// Information about the contributing subnets.
        public let contributingSubnets: [Swift.String]?
        /// Information about the IPv4 CIDR block.
        public let ipV4Cidr: Swift.String?
        /// Information about the IPv6 CIDR block.
        public let ipV6Cidr: Swift.String?
        /// Information about the ID of the prefix list for the route.
        public let prefixListId: Swift.String?
        /// Information about the route table ID.
        public let routeTableId: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallBlackHoleRouteDetectedViolation: Swift.Equatable {
        ...
        public let violatingRoutes: [FmsClientTypes.Route]?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallInternetTrafficNotInspectedViolation: Swift.Equatable {
        ...
        public let actualFirewallSubnetRoutes: [FmsClientTypes.Route]?
        /// The actual internet gateway routes.
        public let actualInternetGatewayRoutes: [FmsClientTypes.Route]?
        /// Information about the subnet route table for the current firewall.
        public let currentFirewallSubnetRouteTable: Swift.String?
        /// The current route table for the internet gateway.
        public let currentInternetGatewayRouteTable: Swift.String?
        /// The expected endpoint for the current firewall.
        public let expectedFirewallEndpoint: Swift.String?
        /// The firewall subnet routes that are expected.
        public let expectedFirewallSubnetRoutes: [FmsClientTypes.ExpectedRoute]?
        /// The internet gateway routes that are expected.
        public let expectedInternetGatewayRoutes: [FmsClientTypes.ExpectedRoute]?
        /// The firewall subnet ID.
        public let firewallSubnetId: Swift.String?
        /// The internet gateway ID.
        public let internetGatewayId: Swift.String?
        /// Information about whether the route table is used in another Availability Zone.
        public let isRouteTableUsedInDifferentAZ: Swift.Bool
        /// Information about the route table ID.
        public let routeTableId: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallInvalidRouteConfigurationViolation: Swift.Equatable {
        ...
        public let actualFirewallEndpoint: Swift.String?
        /// The actual subnet ID for the firewall.
        public let actualFirewallSubnetId: Swift.String?
        /// The actual firewall subnet routes that are expected.
        public let actualFirewallSubnetRoutes: [FmsClientTypes.Route]?
        /// The actual internet gateway routes.
        public let actualInternetGatewayRoutes: [FmsClientTypes.Route]?
        /// The subnets that are affected.
        public let affectedSubnets: [Swift.String]?
        ...
        public let expectedFirewallSubnetId: Swift.String?
        /// The firewall subnet routes that are expected.
        public let expectedFirewallSubnetRoutes: [FmsClientTypes.ExpectedRoute]?
        ...
        public let violatingRoute: FmsClientTypes.Route?
        /// Information about the VPC ID.
        public let vpcId: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallMissingExpectedRoutesViolation: Swift.Equatable {
        /// The expected routes.
        public let expectedRoutes: [FmsClientTypes.ExpectedRoute]?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallUnexpectedFirewallRoutesViolation: Swift.Equatable {
        ...
        public let firewallEndpoint: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct PossibleRemediationAction: Swift.Equatable {
        ...
        /// This member is required.
        public let orderedRemediationActions: [FmsClientTypes.RemediationActionWithOrder]?
...
extension FmsClientTypes {
    ...
    public struct PossibleRemediationActions: Swift.Equatable {
        ...
        public let actions: [FmsClientTypes.PossibleRemediationAction]?
...
extension FmsClientTypes {
    ...
    public struct RemediationAction: Swift.Equatable {
        ...
        public let eC2AssociateRouteTableAction: FmsClientTypes.EC2AssociateRouteTableAction?
        /// Information about the CopyRouteTable action in the Amazon EC2 API.
        public let eC2CopyRouteTableAction: FmsClientTypes.EC2CopyRouteTableAction?
        /// Information about the CreateRoute action in the Amazon EC2 API.
        public let eC2CreateRouteAction: FmsClientTypes.EC2CreateRouteAction?
        /// Information about the CreateRouteTable action in the Amazon EC2 API.
        public let eC2CreateRouteTableAction: FmsClientTypes.EC2CreateRouteTableAction?
        /// Information about the DeleteRoute action in the Amazon EC2 API.
        public let eC2DeleteRouteAction: FmsClientTypes.EC2DeleteRouteAction?
        /// Information about the ReplaceRoute action in the Amazon EC2 API.
        public let eC2ReplaceRouteAction: FmsClientTypes.EC2ReplaceRouteAction?
        /// Information about the ReplaceRouteTableAssociation action in the Amazon EC2 API.
        public let eC2ReplaceRouteTableAssociationAction: FmsClientTypes.EC2ReplaceRouteTableAssociationAction?
...
extension FmsClientTypes {
    ...
    public struct RemediationActionWithOrder: Swift.Equatable {
        ...
        public let remediationAction: FmsClientTypes.RemediationAction?
...
extension FmsClientTypes {
    ...
    public struct ResourceViolation: Swift.Equatable {
        ...
        /// Violation detail for an internet gateway route with an inactive state in the customer subnet route table or Network Firewall subnet route table.
        public let networkFirewallBlackHoleRouteDetectedViolation: FmsClientTypes.NetworkFirewallBlackHoleRouteDetectedViolation?
        /// Violation detail for the subnet for which internet traffic hasn't been inspected.
        public let networkFirewallInternetTrafficNotInspectedViolation: FmsClientTypes.NetworkFirewallInternetTrafficNotInspectedViolation?
        /// The route configuration is invalid.
        public let networkFirewallInvalidRouteConfigurationViolation: FmsClientTypes.NetworkFirewallInvalidRouteConfigurationViolation?
        ...
        public let networkFirewallMissingExpectedRoutesViolation: FmsClientTypes.NetworkFirewallMissingExpectedRoutesViolation?
        ...
        public let networkFirewallUnexpectedFirewallRoutesViolation: FmsClientTypes.NetworkFirewallUnexpectedFirewallRoutesViolation?
        /// There's an unexpected gateway route.
        public let networkFirewallUnexpectedGatewayRoutesViolation: FmsClientTypes.NetworkFirewallUnexpectedGatewayRoutesViolation?
        /// A list of possible remediation action lists. Each individual possible remediation action is a list of individual remediation actions.
        public let possibleRemediationActions: FmsClientTypes.PossibleRemediationActions?
...
extension FmsClientTypes {
    ...
    public struct Route: Swift.Equatable {
        ...
        public let destinationType: FmsClientTypes.DestinationType?
        /// The route's target.
        public let target: Swift.String?
        /// The type of target for the route.
        public let targetType: FmsClientTypes.TargetType?
