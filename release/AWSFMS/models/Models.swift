...
extension FmsClientTypes {
    ...
    public struct AppsListData: Swift.Equatable {
        ...
        /// This member is required.
        var appsList: [FmsClientTypes.App]?
        /// The time that the Firewall Manager applications list was created.
        var createTime: ClientRuntime.Date?
        /// The time that the Firewall Manager applications list was last updated.
        var lastUpdateTime: ClientRuntime.Date?
        /// The ID of the Firewall Manager applications list.
        var listId: Swift.String?
        /// The name of the Firewall Manager applications list.
        /// This member is required.
        var listName: Swift.String?
        /// A unique identifier for each update to the list. When you update the list, the update token must match the token of the current version of the application list. You can retrieve the update token by getting the list.
        var listUpdateToken: Swift.String?
        /// A map of previous version numbers to their corresponding App object arrays.
        var previousAppsList: [Swift.String:[FmsClientTypes.App]]?
...
extension FmsClientTypes {
    ...
    public struct AwsEc2InstanceViolation: Swift.Equatable {
        ...
        var awsEc2NetworkInterfaceViolations: [FmsClientTypes.AwsEc2NetworkInterfaceViolation]?
        /// The resource ID of the EC2 instance.
        var violationTarget: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct AwsEc2NetworkInterfaceViolation: Swift.Equatable {
        ...
        var violatingSecurityGroups: [Swift.String]?
...
extension FmsClientTypes {
    ...
    public struct AwsVPCSecurityGroupViolation: Swift.Equatable {
        ...
        var partialMatches: [FmsClientTypes.PartialMatch]?
        /// Remediation options for the rule specified in the ViolationTarget.
        var possibleSecurityGroupRemediationActions: [FmsClientTypes.SecurityGroupRemediationAction]?
        /// The security group rule that is being evaluated.
        var violationTarget: Swift.String?
        /// A description of the security group that violates the policy.
        var violationTargetDescription: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct ComplianceViolator: Swift.Equatable {
        ...
        var violationReason: FmsClientTypes.ViolationReason?
...
public struct DeletePolicyInput: Swift.Equatable {
    ...
    var deleteAllPolicyResources: Swift.Bool
    /// The ID of the policy that you want to delete. You can retrieve this ID from PutPolicy and ListPolicies.
    /// This member is required.
    var policyId: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct DnsRuleGroupLimitExceededViolation: Swift.Equatable {
        ...
        var numberOfRuleGroupsAlreadyAssociated: Swift.Int
        /// Information about the VPC ID.
        var violationTarget: Swift.String?
        /// A description of the violation that specifies the rule group and VPC.
        var violationTargetDescription: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct DnsRuleGroupPriorityConflictViolation: Swift.Equatable {
        ...
        var conflictingPolicyId: Swift.String?
        /// The priority setting of the two conflicting rule groups.
        var conflictingPriority: Swift.Int
        /// The priorities of rule groups that are already associated with the VPC. To retry your operation, choose priority settings that aren't in this list for the rule groups in your new DNS Firewall policy.
        var unavailablePriorities: [Swift.Int]?
        /// Information about the VPC ID.
        var violationTarget: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct EC2AssociateRouteTableAction: Swift.Equatable {
        ...
        var gatewayId: FmsClientTypes.ActionTarget?
        /// The ID of the EC2 route table that is associated with the remediation action.
        /// This member is required.
        var routeTableId: FmsClientTypes.ActionTarget?
        /// The ID of the subnet for the EC2 route table that is associated with the remediation action.
        var subnetId: FmsClientTypes.ActionTarget?
...
extension FmsClientTypes {
    ...
    public struct EC2CopyRouteTableAction: Swift.Equatable {
        ...
        /// This member is required.
        var vpcId: FmsClientTypes.ActionTarget?
...
extension FmsClientTypes {
    ...
    public struct EC2CreateRouteAction: Swift.Equatable {
        ...
        var destinationCidrBlock: Swift.String?
        /// Information about the IPv6 CIDR block destination.
        var destinationIpv6CidrBlock: Swift.String?
        /// Information about the ID of a prefix list used for the destination match.
        var destinationPrefixListId: Swift.String?
        ...
        var vpcEndpointId: FmsClientTypes.ActionTarget?
...
extension FmsClientTypes {
    ...
    public struct EC2ReplaceRouteTableAssociationAction: Swift.Equatable {
        ...
        /// This member is required.
        var associationId: FmsClientTypes.ActionTarget?
...
extension FmsClientTypes {
    ...
    public struct EvaluationResult: Swift.Equatable {
        ...
        var complianceStatus: FmsClientTypes.PolicyComplianceStatusType?
        /// Indicates that over 100 resources are noncompliant with the Firewall Manager policy.
        var evaluationLimitExceeded: Swift.Bool
...
extension FmsClientTypes {
    ...
    public struct ExpectedRoute: Swift.Equatable {
        ...
        var allowedTargets: [Swift.String]?
        /// Information about the contributing subnets.
        var contributingSubnets: [Swift.String]?
        /// Information about the IPv4 CIDR block.
        var ipV4Cidr: Swift.String?
        /// Information about the IPv6 CIDR block.
        var ipV6Cidr: Swift.String?
        /// Information about the ID of the prefix list for the route.
        var prefixListId: Swift.String?
        /// Information about the route table ID.
        var routeTableId: Swift.String?
...
public struct GetAdminAccountOutputResponse: Swift.Equatable {
    ...
    var roleStatus: FmsClientTypes.AccountRoleStatus?
...
public struct GetAppsListOutputResponse: Swift.Equatable {
    ...
    var appsList: FmsClientTypes.AppsListData?
    /// The Amazon Resource Name (ARN) of the applications list.
    var appsListArn: Swift.String?
...
public struct GetComplianceDetailInput: Swift.Equatable {
    ...
    /// This member is required.
    var memberAccount: Swift.String?
...
public struct GetComplianceDetailOutputResponse: Swift.Equatable {
    ...
    var policyComplianceDetail: FmsClientTypes.PolicyComplianceDetail?
...
public struct GetPolicyOutputResponse: Swift.Equatable {
    ...
    var policy: FmsClientTypes.Policy?
...
public struct GetProtectionStatusInput: Swift.Equatable {
    ...
    var memberAccountId: Swift.String?
...
public struct GetProtectionStatusOutputResponse: Swift.Equatable {
    ...
    var serviceType: FmsClientTypes.SecurityServiceType?
...
public struct GetProtocolsListOutputResponse: Swift.Equatable {
    ...
    var protocolsList: FmsClientTypes.ProtocolsListData?
    /// The Amazon Resource Name (ARN) of the specified protocols list.
    var protocolsListArn: Swift.String?
...
public struct GetViolationDetailsOutputResponse: Swift.Equatable {
    ...
    var violationDetail: FmsClientTypes.ViolationDetail?
...
public struct ListAppsListsOutputResponse: Swift.Equatable {
    ...
    var appsLists: [FmsClientTypes.AppsListDataSummary]?
...
public struct ListComplianceStatusOutputResponse: Swift.Equatable {
    ...
    var policyComplianceStatusList: [FmsClientTypes.PolicyComplianceStatus]?
...
public struct ListMemberAccountsOutputResponse: Swift.Equatable {
    ...
    var memberAccounts: [Swift.String]?
...
public struct ListPoliciesOutputResponse: Swift.Equatable {
    ...
    var policyList: [FmsClientTypes.PolicySummary]?
...
public struct ListProtocolsListsOutputResponse: Swift.Equatable {
    ...
    var protocolsLists: [FmsClientTypes.ProtocolsListDataSummary]?
...
public struct ListTagsForResourceOutputResponse: Swift.Equatable {
    ...
    var tagList: [FmsClientTypes.Tag]?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallBlackHoleRouteDetectedViolation: Swift.Equatable {
        ...
        var violatingRoutes: [FmsClientTypes.Route]?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallInternetTrafficNotInspectedViolation: Swift.Equatable {
        ...
        var actualFirewallSubnetRoutes: [FmsClientTypes.Route]?
        /// The actual internet gateway routes.
        var actualInternetGatewayRoutes: [FmsClientTypes.Route]?
        /// Information about the subnet route table for the current firewall.
        var currentFirewallSubnetRouteTable: Swift.String?
        /// The current route table for the internet gateway.
        var currentInternetGatewayRouteTable: Swift.String?
        /// The expected endpoint for the current firewall.
        var expectedFirewallEndpoint: Swift.String?
        /// The firewall subnet routes that are expected.
        var expectedFirewallSubnetRoutes: [FmsClientTypes.ExpectedRoute]?
        /// The internet gateway routes that are expected.
        var expectedInternetGatewayRoutes: [FmsClientTypes.ExpectedRoute]?
        /// The firewall subnet ID.
        var firewallSubnetId: Swift.String?
        /// The internet gateway ID.
        var internetGatewayId: Swift.String?
        /// Information about whether the route table is used in another Availability Zone.
        var isRouteTableUsedInDifferentAZ: Swift.Bool
        /// Information about the route table ID.
        var routeTableId: Swift.String?
        /// The subnet Availability Zone.
        var subnetAvailabilityZone: Swift.String?
        /// The subnet ID.
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallInvalidRouteConfigurationViolation: Swift.Equatable {
        ...
        var actualFirewallEndpoint: Swift.String?
        /// The actual subnet ID for the firewall.
        var actualFirewallSubnetId: Swift.String?
        /// The actual firewall subnet routes that are expected.
        var actualFirewallSubnetRoutes: [FmsClientTypes.Route]?
        /// The actual internet gateway routes.
        var actualInternetGatewayRoutes: [FmsClientTypes.Route]?
        /// The subnets that are affected.
        var affectedSubnets: [Swift.String]?
        ...
        var expectedFirewallSubnetId: Swift.String?
        /// The firewall subnet routes that are expected.
        var expectedFirewallSubnetRoutes: [FmsClientTypes.ExpectedRoute]?
        ...
        var violatingRoute: FmsClientTypes.Route?
        /// Information about the VPC ID.
        var vpcId: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallMissingExpectedRTViolation: Swift.Equatable {
        ...
        var currentRouteTable: Swift.String?
        /// The resource ID of the route table that should be associated with the subnet.
        var expectedRouteTable: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallMissingExpectedRoutesViolation: Swift.Equatable {
        /// The expected routes.
        var expectedRoutes: [FmsClientTypes.ExpectedRoute]?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallMissingFirewallViolation: Swift.Equatable {
        ...
        var targetViolationReason: Swift.String?
        /// The resource ID of the VPC associated with a violating subnet.
        var vPC: Swift.String?
        /// The ID of the Network Firewall or VPC resource that's in violation.
        var violationTarget: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallPolicyDescription: Swift.Equatable {
        ...
        var statefulRuleGroups: [FmsClientTypes.StatefulRuleGroup]?
        /// Names of custom actions that are available for use in the stateless default actions settings.
        var statelessCustomActions: [Swift.String]?
        /// The actions to take on packets that don't match any of the stateless rule groups.
        var statelessDefaultActions: [Swift.String]?
        /// The actions to take on packet fragments that don't match any of the stateless rule groups.
        var statelessFragmentDefaultActions: [Swift.String]?
        /// The stateless rule groups that are used in the Network Firewall firewall policy.
        var statelessRuleGroups: [FmsClientTypes.StatelessRuleGroup]?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallPolicyModifiedViolation: Swift.Equatable {
        ...
        var currentPolicyDescription: FmsClientTypes.NetworkFirewallPolicyDescription?
        /// The policy that should be in use in the individual account in order to be compliant.
        var expectedPolicyDescription: FmsClientTypes.NetworkFirewallPolicyDescription?
        /// The ID of the Network Firewall or VPC resource that's in violation.
        var violationTarget: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct NetworkFirewallUnexpectedFirewallRoutesViolation: Swift.Equatable {
        ...
        var firewallEndpoint: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct PartialMatch: Swift.Equatable {
        ...
        var reference: Swift.String?
        /// The violation reason.
        var targetViolationReasons: [Swift.String]?
...
extension FmsClientTypes {
    ...
    public struct Policy: Swift.Equatable {
        ...
        var deleteUnusedFMManagedResources: Swift.Bool
        ...
        var excludeMap: [Swift.String:[Swift.String]]?
        /// If set to True, resources with the tags that are specified in the ResourceTag array are not in scope of the policy. If set to False, and the ResourceTag array is not null, only resources with the specified tags are in scope of the policy.
        /// This member is required.
        var excludeResourceTags: Swift.Bool
        ...
        ///
        /// * Specify accounts and OUs together in a single map, separated with a comma. For example, the following is a valid map: {“ACCOUNT” : [“accountID1”, “accountID2”], “ORG_UNIT” : [“ouid111”, “ouid112”]}.
        var includeMap: [Swift.String:[Swift.String]]?
        ...
        var policyUpdateToken: Swift.String?
        /// Indicates if the policy should be automatically applied to new resources.
        /// This member is required.
        var remediationEnabled: Swift.Bool
        /// An array of ResourceTag objects.
        var resourceTags: [FmsClientTypes.ResourceTag]?
        ...
        var resourceTypeList: [Swift.String]?
        /// Details about the security service that is being used to protect the resources.
        /// This member is required.
        var securityServicePolicyData: FmsClientTypes.SecurityServicePolicyData?
...
extension FmsClientTypes {
    ...
    public struct PolicyComplianceDetail: Swift.Equatable {
        ...
        var expiredAt: ClientRuntime.Date?
        /// Details about problems with dependent services, such as WAF or Config, and the error message received that indicates the problem with the service.
        var issueInfoMap: [Swift.String:Swift.String]?
        /// The Amazon Web Services account ID.
        var memberAccount: Swift.String?
        /// The ID of the Firewall Manager policy.
        var policyId: Swift.String?
        /// The Amazon Web Services account that created the Firewall Manager policy.
        var policyOwner: Swift.String?
        /// An array of resources that aren't protected by the WAF or Shield Advanced policy or that aren't in compliance with the security group policy.
        var violators: [FmsClientTypes.ComplianceViolator]?
...
extension FmsClientTypes {
    ...
    public struct PolicyComplianceStatus: Swift.Equatable {
        ...
        var evaluationResults: [FmsClientTypes.EvaluationResult]?
        /// Details about problems with dependent services, such as WAF or Config, and the error message received that indicates the problem with the service.
        var issueInfoMap: [Swift.String:Swift.String]?
...
extension FmsClientTypes {
    ...
    public struct PolicySummary: Swift.Equatable {
        ...
        var securityServiceType: FmsClientTypes.SecurityServiceType?
...
extension FmsClientTypes {
    ...
    public struct PossibleRemediationAction: Swift.Equatable {
        ...
        var isDefaultAction: Swift.Bool
        /// The ordered list of remediation actions.
        /// This member is required.
        var orderedRemediationActions: [FmsClientTypes.RemediationActionWithOrder]?
...
extension FmsClientTypes {
    ...
    public struct PossibleRemediationActions: Swift.Equatable {
        ...
        var actions: [FmsClientTypes.PossibleRemediationAction]?
...
extension FmsClientTypes {
    ...
    public struct ProtocolsListData: Swift.Equatable {
        ...
        var previousProtocolsList: [Swift.String:[Swift.String]]?
        /// An array of protocols in the Firewall Manager protocols list.
        /// This member is required.
        var protocolsList: [Swift.String]?
...
extension FmsClientTypes {
    ...
    public struct RemediationAction: Swift.Equatable {
        ...
        var eC2AssociateRouteTableAction: FmsClientTypes.EC2AssociateRouteTableAction?
        /// Information about the CopyRouteTable action in the Amazon EC2 API.
        var eC2CopyRouteTableAction: FmsClientTypes.EC2CopyRouteTableAction?
        /// Information about the CreateRoute action in the Amazon EC2 API.
        var eC2CreateRouteAction: FmsClientTypes.EC2CreateRouteAction?
        /// Information about the CreateRouteTable action in the Amazon EC2 API.
        var eC2CreateRouteTableAction: FmsClientTypes.EC2CreateRouteTableAction?
        /// Information about the DeleteRoute action in the Amazon EC2 API.
        var eC2DeleteRouteAction: FmsClientTypes.EC2DeleteRouteAction?
        /// Information about the ReplaceRoute action in the Amazon EC2 API.
        var eC2ReplaceRouteAction: FmsClientTypes.EC2ReplaceRouteAction?
        /// Information about the ReplaceRouteTableAssociation action in the Amazon EC2 API.
        var eC2ReplaceRouteTableAssociationAction: FmsClientTypes.EC2ReplaceRouteTableAssociationAction?
...
extension FmsClientTypes {
    ...
    public struct RemediationActionWithOrder: Swift.Equatable {
        ...
        var remediationAction: FmsClientTypes.RemediationAction?
...
extension FmsClientTypes {
    ...
    public struct ResourceViolation: Swift.Equatable {
        ...
        var awsEc2InstanceViolation: FmsClientTypes.AwsEc2InstanceViolation?
        /// Violation detail for a network interface.
        var awsEc2NetworkInterfaceViolation: FmsClientTypes.AwsEc2NetworkInterfaceViolation?
        /// Violation detail for security groups.
        var awsVPCSecurityGroupViolation: FmsClientTypes.AwsVPCSecurityGroupViolation?
        /// Violation detail for a DNS Firewall policy that indicates that a rule group that Firewall Manager tried to associate with a VPC is already associated with the VPC and can't be associated again.
        var dnsDuplicateRuleGroupViolation: FmsClientTypes.DnsDuplicateRuleGroupViolation?
        /// Violation detail for a DNS Firewall policy that indicates that the VPC reached the limit for associated DNS Firewall rule groups. Firewall Manager tried to associate another rule group with the VPC and failed.
        var dnsRuleGroupLimitExceededViolation: FmsClientTypes.DnsRuleGroupLimitExceededViolation?
        /// Violation detail for a DNS Firewall policy that indicates that a rule group that Firewall Manager tried to associate with a VPC has the same priority as a rule group that's already associated.
        var dnsRuleGroupPriorityConflictViolation: FmsClientTypes.DnsRuleGroupPriorityConflictViolation?
        /// Violation detail for an internet gateway route with an inactive state in the customer subnet route table or Network Firewall subnet route table.
        var networkFirewallBlackHoleRouteDetectedViolation: FmsClientTypes.NetworkFirewallBlackHoleRouteDetectedViolation?
        /// Violation detail for the subnet for which internet traffic hasn't been inspected.
        var networkFirewallInternetTrafficNotInspectedViolation: FmsClientTypes.NetworkFirewallInternetTrafficNotInspectedViolation?
        /// The route configuration is invalid.
        var networkFirewallInvalidRouteConfigurationViolation: FmsClientTypes.NetworkFirewallInvalidRouteConfigurationViolation?
        /// Violation detail for an Network Firewall policy that indicates that a subnet is not associated with the expected Firewall Manager managed route table.
        var networkFirewallMissingExpectedRTViolation: FmsClientTypes.NetworkFirewallMissingExpectedRTViolation?
        /// Expected routes are missing from Network Firewall.
        var networkFirewallMissingExpectedRoutesViolation: FmsClientTypes.NetworkFirewallMissingExpectedRoutesViolation?
        /// Violation detail for an Network Firewall policy that indicates that a subnet has no Firewall Manager managed firewall in its VPC.
        var networkFirewallMissingFirewallViolation: FmsClientTypes.NetworkFirewallMissingFirewallViolation?
        /// Violation detail for an Network Firewall policy that indicates that an Availability Zone is missing the expected Firewall Manager managed subnet.
        var networkFirewallMissingSubnetViolation: FmsClientTypes.NetworkFirewallMissingSubnetViolation?
        /// Violation detail for an Network Firewall policy that indicates that a firewall policy in an individual account has been modified in a way that makes it noncompliant. For example, the individual account owner might have deleted a rule group, changed the priority of a stateless rule group, or changed a policy default action.
        var networkFirewallPolicyModifiedViolation: FmsClientTypes.NetworkFirewallPolicyModifiedViolation?
        /// There's an unexpected firewall route.
        var networkFirewallUnexpectedFirewallRoutesViolation: FmsClientTypes.NetworkFirewallUnexpectedFirewallRoutesViolation?
        /// There's an unexpected gateway route.
        var networkFirewallUnexpectedGatewayRoutesViolation: FmsClientTypes.NetworkFirewallUnexpectedGatewayRoutesViolation?
        /// A list of possible remediation action lists. Each individual possible remediation action is a list of individual remediation actions.
        var possibleRemediationActions: FmsClientTypes.PossibleRemediationActions?
...
extension FmsClientTypes {
    ...
    public struct Route: Swift.Equatable {
        ...
        var destinationType: FmsClientTypes.DestinationType?
        /// The route's target.
        var target: Swift.String?
        /// The type of target for the route.
        var targetType: FmsClientTypes.TargetType?
...
extension FmsClientTypes {
    ...
    public struct SecurityGroupRemediationAction: Swift.Equatable {
        ...
        var remediationActionType: FmsClientTypes.RemediationActionType?
        /// The final state of the rule specified in the ViolationTarget after it is remediated.
        var remediationResult: FmsClientTypes.SecurityGroupRuleDescription?
...
extension FmsClientTypes {
    ...
    public struct SecurityGroupRuleDescription: Swift.Equatable {
        ...
        var iPV4Range: Swift.String?
        /// The IPv6 ranges for the security group rule.
        var iPV6Range: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct SecurityServicePolicyData: Swift.Equatable {
        ...
        var managedServiceData: Swift.String?
        ...
        /// This member is required.
        var type: FmsClientTypes.SecurityServiceType?
...
extension FmsClientTypes {
    ...
    public struct StatefulRuleGroup: Swift.Equatable {
        ...
        var ruleGroupName: Swift.String?
...
extension FmsClientTypes {
    ...
    public struct ViolationDetail: Swift.Equatable {
        ...
        var resourceDescription: Swift.String?
        /// The resource ID that the violation details were requested for.
        /// This member is required.
        var resourceId: Swift.String?
        /// The ResourceTag objects associated with the resource.
        var resourceTags: [FmsClientTypes.Tag]?
        /// The resource type that the violation details were requested for.
        /// This member is required.
        var resourceType: Swift.String?
        /// List of violations for the requested resource.
        /// This member is required.
        var resourceViolations: [FmsClientTypes.ResourceViolation]?
