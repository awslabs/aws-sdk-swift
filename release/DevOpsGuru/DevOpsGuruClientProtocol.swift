...
public protocol DevOpsGuruClientProtocol {
    ...
    func addNotificationChannel(input: AddNotificationChannelInput, completion: @escaping (SdkResult<AddNotificationChannelOutputResponse, AddNotificationChannelOutputError>) -> Void)
    /// <p>
    ...
    ///    	</p>
    func describeAccountHealth(input: DescribeAccountHealthInput, completion: @escaping (SdkResult<DescribeAccountHealthOutputResponse, DescribeAccountHealthOutputError>) -> Void)
    /// <p>
    ...
    ///    	</p>
    func describeAccountOverview(input: DescribeAccountOverviewInput, completion: @escaping (SdkResult<DescribeAccountOverviewOutputResponse, DescribeAccountOverviewOutputError>) -> Void)
    /// <p>
    ///    		Returns details about an anomaly that you specify using its ID.
    ///    	</p>
    func describeAnomaly(input: DescribeAnomalyInput, completion: @escaping (SdkResult<DescribeAnomalyOutputResponse, DescribeAnomalyOutputError>) -> Void)
    /// <p>
    /// 			Returns the most recent feedback submitted in the current AWS account and Region.
    /// 		</p>
    func describeFeedback(input: DescribeFeedbackInput, completion: @escaping (SdkResult<DescribeFeedbackOutputResponse, DescribeFeedbackOutputError>) -> Void)
    /// <p>
    ///    		Returns details about an insight that you specify using its ID.
    ///    	</p>
    func describeInsight(input: DescribeInsightInput, completion: @escaping (SdkResult<DescribeInsightOutputResponse, DescribeInsightOutputError>) -> Void)
    /// <p>
    ...
    ///    	</p>
    func describeResourceCollectionHealth(input: DescribeResourceCollectionHealthInput, completion: @escaping (SdkResult<DescribeResourceCollectionHealthOutputResponse, DescribeResourceCollectionHealthOutputError>) -> Void)
    /// <p>
    /// 			Returns the integration status of services that are integrated with DevOps Guru.
    /// 			The one service that can be integrated with DevOps Guru
    ///       	is AWS Systems Manager, which can be used to create an OpsItem for each generated insight.
    /// 		</p>
    func describeServiceIntegration(input: DescribeServiceIntegrationInput, completion: @escaping (SdkResult<DescribeServiceIntegrationOutputResponse, DescribeServiceIntegrationOutputError>) -> Void)
    ...
    func getCostEstimation(input: GetCostEstimationInput, completion: @escaping (SdkResult<GetCostEstimationOutputResponse, GetCostEstimationOutputError>) -> Void)
    /// <p>
    ...
    ///       	only the AWS resources that are defined in the stacks. You can specify up to 500 AWS CloudFormation stacks.
    ///    	</p>
    func getResourceCollection(input: GetResourceCollectionInput, completion: @escaping (SdkResult<GetResourceCollectionOutputResponse, GetResourceCollectionOutputError>) -> Void)
    /// <p>
    ///    		Returns a list of the anomalies that belong to an insight that you specify using its ID.
    ///    	</p>
    func listAnomaliesForInsight(input: ListAnomaliesForInsightInput, completion: @escaping (SdkResult<ListAnomaliesForInsightOutputResponse, ListAnomaliesForInsightOutputError>) -> Void)
    /// <p>
    ///    		Returns a list of the events emitted by the resources that are evaluated by DevOps Guru. You can use filters to specify which events are returned.
    ///    	</p>
    func listEvents(input: ListEventsInput, completion: @escaping (SdkResult<ListEventsOutputResponse, ListEventsOutputError>) -> Void)
    /// <p>
    ...
    ///    	</p>
    func listInsights(input: ListInsightsInput, completion: @escaping (SdkResult<ListInsightsOutputResponse, ListInsightsOutputError>) -> Void)
    /// <p>
    ...
    ///    	</p>
    func listNotificationChannels(input: ListNotificationChannelsInput, completion: @escaping (SdkResult<ListNotificationChannelsOutputResponse, ListNotificationChannelsOutputError>) -> Void)
    /// <p>
    ...
    ///    	</p>
    func searchInsights(input: SearchInsightsInput, completion: @escaping (SdkResult<SearchInsightsOutputResponse, SearchInsightsOutputError>) -> Void)
    /// <p>Starts the creation of an estimate of the monthly cost to analyze your AWS resources.</p>
    func startCostEstimation(input: StartCostEstimationInput, completion: @escaping (SdkResult<StartCostEstimationOutputResponse, StartCostEstimationOutputError>) -> Void)
    ...
    func updateResourceCollection(input: UpdateResourceCollectionInput, completion: @escaping (SdkResult<UpdateResourceCollectionOutputResponse, UpdateResourceCollectionOutputError>) -> Void)
    /// <p>
    ...
    /// 		</p>
    func updateServiceIntegration(input: UpdateServiceIntegrationInput, completion: @escaping (SdkResult<UpdateServiceIntegrationOutputResponse, UpdateServiceIntegrationOutputError>) -> Void)
}
