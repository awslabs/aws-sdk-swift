...
extension DevOpsGuruClient: DevOpsGuruClientProtocol {
    ...
    public func addNotificationChannel(input: AddNotificationChannelInput, completion: @escaping (SdkResult<AddNotificationChannelOutput, AddNotificationChannelOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<AddNotificationChannelInput, AddNotificationChannelOutput, AddNotificationChannelOutputError>(id: "addNotificationChannel")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AddNotificationChannelInput, AddNotificationChannelOutput, AddNotificationChannelOutputError>(contentType: "application/json"))
    ...
    ///    	</p>
    public func describeAccountHealth(input: DescribeAccountHealthInput, completion: @escaping (SdkResult<DescribeAccountHealthOutput, DescribeAccountHealthOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAccountHealthInput, DescribeAccountHealthOutput, DescribeAccountHealthOutputError>(id: "describeAccountHealth")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAccountHealthInput, DescribeAccountHealthOutput, DescribeAccountHealthOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///    	</p>
    public func describeAccountOverview(input: DescribeAccountOverviewInput, completion: @escaping (SdkResult<DescribeAccountOverviewOutput, DescribeAccountOverviewOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAccountOverviewInput, DescribeAccountOverviewOutput, DescribeAccountOverviewOutputError>(id: "describeAccountOverview")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAccountOverviewInput, DescribeAccountOverviewOutput, DescribeAccountOverviewOutputError>(contentType: "application/json"))
    ...
    ///    	</p>
    public func describeAnomaly(input: DescribeAnomalyInput, completion: @escaping (SdkResult<DescribeAnomalyOutput, DescribeAnomalyOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAnomalyInput, DescribeAnomalyOutput, DescribeAnomalyOutputError>(id: "describeAnomaly")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAnomalyInput, DescribeAnomalyOutput, DescribeAnomalyOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    /// 		</p>
    public func describeFeedback(input: DescribeFeedbackInput, completion: @escaping (SdkResult<DescribeFeedbackOutput, DescribeFeedbackOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeFeedbackInput, DescribeFeedbackOutput, DescribeFeedbackOutputError>(id: "describeFeedback")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeFeedbackInput, DescribeFeedbackOutput, DescribeFeedbackOutputError>(contentType: "application/json"))
    ...
    ///    	</p>
    public func describeInsight(input: DescribeInsightInput, completion: @escaping (SdkResult<DescribeInsightOutput, DescribeInsightOutputError>) -> Void)
    {
        guard let id = input.id else {
            completion(.failure(.client(ClientError.serializationFailed("uri component id unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeInsightInput, DescribeInsightOutput, DescribeInsightOutputError>(id: "describeInsight")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeInsightInput, DescribeInsightOutput, DescribeInsightOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///    	</p>
    public func describeResourceCollectionHealth(input: DescribeResourceCollectionHealthInput, completion: @escaping (SdkResult<DescribeResourceCollectionHealthOutput, DescribeResourceCollectionHealthOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeResourceCollectionHealthInput, DescribeResourceCollectionHealthOutput, DescribeResourceCollectionHealthOutputError>(id: "describeResourceCollectionHealth")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeResourceCollectionHealthInput, DescribeResourceCollectionHealthOutput, DescribeResourceCollectionHealthOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    /// 		</p>
    public func describeServiceIntegration(input: DescribeServiceIntegrationInput, completion: @escaping (SdkResult<DescribeServiceIntegrationOutput, DescribeServiceIntegrationOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeServiceIntegrationInput, DescribeServiceIntegrationOutput, DescribeServiceIntegrationOutputError>(id: "describeServiceIntegration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeServiceIntegrationInput, DescribeServiceIntegrationOutput, DescribeServiceIntegrationOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getCostEstimation(input: GetCostEstimationInput, completion: @escaping (SdkResult<GetCostEstimationOutput, GetCostEstimationOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCostEstimationInput, GetCostEstimationOutput, GetCostEstimationOutputError>(id: "getCostEstimation")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCostEstimationInput, GetCostEstimationOutput, GetCostEstimationOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       	only the AWS resources that are defined in the stacks. You can specify up to 500 AWS CloudFormation stacks.
    ///    	</p>
    public func getResourceCollection(input: GetResourceCollectionInput, completion: @escaping (SdkResult<GetResourceCollectionOutput, GetResourceCollectionOutputError>) -> Void)
    {
        guard let resourceCollectionType = input.resourceCollectionType else {
            completion(.failure(.client(ClientError.serializationFailed("uri component resourceCollectionType unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetResourceCollectionInput, GetResourceCollectionOutput, GetResourceCollectionOutputError>(id: "getResourceCollection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetResourceCollectionInput, GetResourceCollectionOutput, GetResourceCollectionOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///    	</p>
    public func listAnomaliesForInsight(input: ListAnomaliesForInsightInput, completion: @escaping (SdkResult<ListAnomaliesForInsightOutput, ListAnomaliesForInsightOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAnomaliesForInsightInput, ListAnomaliesForInsightOutput, ListAnomaliesForInsightOutputError>(id: "listAnomaliesForInsight")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAnomaliesForInsightInput, ListAnomaliesForInsightOutput, ListAnomaliesForInsightOutputError>(contentType: "application/json"))
    ...
    ///    	</p>
    public func listEvents(input: ListEventsInput, completion: @escaping (SdkResult<ListEventsOutput, ListEventsOutputError>) -> Void)
    {
        let urlPath = "/events"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListEventsInput, ListEventsOutput, ListEventsOutputError>(id: "listEvents")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListEventsInput, ListEventsOutput, ListEventsOutputError>(contentType: "application/json"))
    ...
    ///    	</p>
    public func listInsights(input: ListInsightsInput, completion: @escaping (SdkResult<ListInsightsOutput, ListInsightsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListInsightsInput, ListInsightsOutput, ListInsightsOutputError>(id: "listInsights")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListInsightsInput, ListInsightsOutput, ListInsightsOutputError>(contentType: "application/json"))
    ...
    ///    	</p>
    public func listNotificationChannels(input: ListNotificationChannelsInput, completion: @escaping (SdkResult<ListNotificationChannelsOutput, ListNotificationChannelsOutputError>) -> Void)
    {
        let urlPath = "/channels"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListNotificationChannelsInput, ListNotificationChannelsOutput, ListNotificationChannelsOutputError>(id: "listNotificationChannels")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListNotificationChannelsInput, ListNotificationChannelsOutput, ListNotificationChannelsOutputError>(contentType: "application/json"))
    ...
    ///    	</p>
    public func listRecommendations(input: ListRecommendationsInput, completion: @escaping (SdkResult<ListRecommendationsOutput, ListRecommendationsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListRecommendationsInput, ListRecommendationsOutput, ListRecommendationsOutputError>(id: "listRecommendations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListRecommendationsInput, ListRecommendationsOutput, ListRecommendationsOutputError>(contentType: "application/json"))
    ...
    ///    	</p>
    public func removeNotificationChannel(input: RemoveNotificationChannelInput, completion: @escaping (SdkResult<RemoveNotificationChannelOutput, RemoveNotificationChannelOutputError>) -> Void)
    {
        guard let id = input.id else {
            completion(.failure(.client(ClientError.serializationFailed("uri component id unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RemoveNotificationChannelInput, RemoveNotificationChannelOutput, RemoveNotificationChannelOutputError>(id: "removeNotificationChannel")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RemoveNotificationChannelInput, RemoveNotificationChannelOutput, RemoveNotificationChannelOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///    	</p>
    public func searchInsights(input: SearchInsightsInput, completion: @escaping (SdkResult<SearchInsightsOutput, SearchInsightsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SearchInsightsInput, SearchInsightsOutput, SearchInsightsOutputError>(id: "searchInsights")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SearchInsightsInput, SearchInsightsOutput, SearchInsightsOutputError>(contentType: "application/json"))
    ...
    public func startCostEstimation(input: StartCostEstimationInput, completion: @escaping (SdkResult<StartCostEstimationOutput, StartCostEstimationOutputError>) -> Void)
    {
        let urlPath = "/cost-estimation"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartCostEstimationInput, StartCostEstimationOutput, StartCostEstimationOutputError>(id: "startCostEstimation")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<StartCostEstimationOutput>, SdkError<StartCostEstimationOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartCostEstimationInput, StartCostEstimationOutput, StartCostEstimationOutputError>(contentType: "application/json"))
    ...
    public func updateResourceCollection(input: UpdateResourceCollectionInput, completion: @escaping (SdkResult<UpdateResourceCollectionOutput, UpdateResourceCollectionOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateResourceCollectionInput, UpdateResourceCollectionOutput, UpdateResourceCollectionOutputError>(id: "updateResourceCollection")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateResourceCollectionInput, UpdateResourceCollectionOutput, UpdateResourceCollectionOutputError>(contentType: "application/json"))
    ...
    /// 		</p>
    public func updateServiceIntegration(input: UpdateServiceIntegrationInput, completion: @escaping (SdkResult<UpdateServiceIntegrationOutput, UpdateServiceIntegrationOutputError>) -> Void)
    {
        let urlPath = "/service-integrations"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "devops-guru")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateServiceIntegrationInput, UpdateServiceIntegrationOutput, UpdateServiceIntegrationOutputError>(id: "updateServiceIntegration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateServiceIntegrationInput, UpdateServiceIntegrationOutput, UpdateServiceIntegrationOutputError>(contentType: "application/json"))
