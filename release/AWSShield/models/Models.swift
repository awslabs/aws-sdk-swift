...
extension ShieldClientTypes {
    ...
    public struct ApplicationLayerAutomaticResponseConfiguration: Swift.Equatable {
        ...
        var action: ShieldClientTypes.ResponseAction?
        /// Indicates whether automatic application layer DDoS mitigation is enabled for the protection.
        /// This member is required.
        var status: ShieldClientTypes.ApplicationLayerAutomaticResponseStatus?
...
public struct AssociateHealthCheckInput: Swift.Equatable {
    ...
    /// This member is required.
    var healthCheckArn: Swift.String?
    /// The unique identifier (ID) for the [Protection] object to add the health check association to.
    /// This member is required.
    var protectionId: Swift.String?
...
public struct AssociateProactiveEngagementDetailsInput: Swift.Equatable {
    ...
    /// This member is required.
    var emergencyContactList: [ShieldClientTypes.EmergencyContact]?
...
extension ShieldClientTypes {
    ...
    public struct AttackDetail: Swift.Equatable {
        ...
        var attackCounters: [ShieldClientTypes.SummarizedCounter]?
        /// The unique identifier (ID) of the attack.
        var attackId: Swift.String?
        ...
        var attackProperties: [ShieldClientTypes.AttackProperty]?
        /// The time the attack ended, in Unix time in seconds.
        var endTime: ClientRuntime.Date?
        /// List of mitigation actions taken for the attack.
        var mitigations: [ShieldClientTypes.Mitigation]?
        /// The ARN (Amazon Resource Name) of the resource that was attacked.
        var resourceArn: Swift.String?
        /// The time the attack started, in Unix time in seconds.
        var startTime: ClientRuntime.Date?
        /// If applicable, additional detail about the resource being attacked, for example, IP address or URL.
        var subResources: [ShieldClientTypes.SubResourceSummary]?
...
extension ShieldClientTypes {
    ...
    public struct AttackProperty: Swift.Equatable {
        ...
        var attackLayer: ShieldClientTypes.AttackLayer?
        ...
        var attackPropertyIdentifier: ShieldClientTypes.AttackPropertyIdentifier?
        ...
        var topContributors: [ShieldClientTypes.Contributor]?
        /// The total contributions made to this Shield event by all contributors.
        var total: Swift.Int
        /// The unit used for the ContributorValue property.
        var unit: ShieldClientTypes.Unit?
...
extension ShieldClientTypes {
    ...
    public struct AttackStatisticsDataItem: Swift.Equatable {
        ...
        /// This member is required.
        var attackCount: Swift.Int
        /// Information about the volume of attacks during the time period. If the accompanying AttackCount is zero, this setting might be empty.
        var attackVolume: ShieldClientTypes.AttackVolume?
...
extension ShieldClientTypes {
    ...
    public struct AttackSummary: Swift.Equatable {
        ...
        var attackVectors: [ShieldClientTypes.AttackVectorDescription]?
...
extension ShieldClientTypes {
    ...
    public struct AttackVolume: Swift.Equatable {
        ...
        var bitsPerSecond: ShieldClientTypes.AttackVolumeStatistics?
        /// A statistics object that uses packets per second as the unit. This is included for network level attacks.
        var packetsPerSecond: ShieldClientTypes.AttackVolumeStatistics?
        /// A statistics object that uses requests per second as the unit. This is included for application level attacks, and is only available for accounts that are subscribed to Shield Advanced.
        var requestsPerSecond: ShieldClientTypes.AttackVolumeStatistics?
...
public struct CreateProtectionGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var aggregation: ShieldClientTypes.ProtectionGroupAggregation?
    /// The Amazon Resource Names (ARNs) of the resources to include in the protection group. You must set this when you set Pattern to ARBITRARY and you must not set it for any other Pattern setting.
    var members: [Swift.String]?
    /// The criteria to use to choose the protected resources for inclusion in the group. You can include all resources that have protections, provide a list of resource Amazon Resource Names (ARNs), or include all resources of a specified resource type.
    /// This member is required.
    var pattern: ShieldClientTypes.ProtectionGroupPattern?
    /// The name of the protection group. You use this to identify the protection group in lists and to manage the protection group, for example to update, delete, or describe it.
    /// This member is required.
    var protectionGroupId: Swift.String?
    /// The resource type to include in the protection group. All protected resources of this type are included in the protection group. Newly protected resources of this type are automatically added to the group. You must set this when you set Pattern to BY_RESOURCE_TYPE and you must not set it for any other Pattern setting.
    var resourceType: ShieldClientTypes.ProtectedResourceType?
    /// One or more tag key-value pairs for the protection group.
    var tags: [ShieldClientTypes.Tag]?
...
public struct DescribeAttackOutputResponse: Swift.Equatable {
    ...
    var attack: ShieldClientTypes.AttackDetail?
...
public struct DescribeAttackStatisticsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var dataItems: [ShieldClientTypes.AttackStatisticsDataItem]?
    /// The time range.
    /// This member is required.
    var timeRange: ShieldClientTypes.TimeRange?
...
public struct DescribeDRTAccessOutputResponse: Swift.Equatable {
    ...
    var logBucketList: [Swift.String]?
...
public struct DescribeProtectionGroupOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var protectionGroup: ShieldClientTypes.ProtectionGroup?
...
public struct DescribeProtectionOutputResponse: Swift.Equatable {
    ...
    var protection: ShieldClientTypes.Protection?
...
public struct DescribeSubscriptionOutputResponse: Swift.Equatable {
    ...
    var subscription: ShieldClientTypes.Subscription?
...
public struct GetSubscriptionStateOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var subscriptionState: ShieldClientTypes.SubscriptionState?
...
public struct ListAttacksInput: Swift.Equatable {
    ...
    var endTime: ShieldClientTypes.TimeRange?
    ...
    var startTime: ShieldClientTypes.TimeRange?
...
public struct ListAttacksOutputResponse: Swift.Equatable {
    ...
    var attackSummaries: [ShieldClientTypes.AttackSummary]?
...
public struct ListProtectionGroupsOutputResponse: Swift.Equatable {
    ...
    ///
    /// This member is required.
    var protectionGroups: [ShieldClientTypes.ProtectionGroup]?
...
public struct ListProtectionsOutputResponse: Swift.Equatable {
    ...
    var protections: [ShieldClientTypes.Protection]?
...
extension ShieldClientTypes {
    ...
    public struct Mitigation: Swift.Equatable {
        ...
        var mitigationName: Swift.String?
...
extension ShieldClientTypes {
    ...
    public struct Protection: Swift.Equatable {
        ...
        var applicationLayerAutomaticResponseConfiguration: ShieldClientTypes.ApplicationLayerAutomaticResponseConfiguration?
        /// The unique identifier (ID) for the Route 53 health check that's associated with the protection.
        var healthCheckIds: [Swift.String]?
        /// The unique identifier (ID) of the protection.
        var id: Swift.String?
        /// The name of the protection. For example, My CloudFront distributions.
        var name: Swift.String?
        /// The ARN (Amazon Resource Name) of the protection.
        var protectionArn: Swift.String?
...
extension ShieldClientTypes {
    ...
    public struct ProtectionGroup: Swift.Equatable {
        ...
        var protectionGroupArn: Swift.String?
        /// The name of the protection group. You use this to identify the protection group in lists and to manage the protection group, for example to update, delete, or describe it.
        /// This member is required.
        var protectionGroupId: Swift.String?
...
extension ShieldClientTypes {
    ...
    public struct ProtectionGroupLimits: Swift.Equatable {
        ...
        /// This member is required.
        var maxProtectionGroups: Swift.Int
        /// Limits settings by pattern type in the protection groups for your subscription.
        /// This member is required.
        var patternTypeLimits: ShieldClientTypes.ProtectionGroupPatternTypeLimits?
...
extension ShieldClientTypes {
    ...
    public struct ProtectionGroupPatternTypeLimits: Swift.Equatable {
        /// Limits settings on protection groups with arbitrary pattern type.
        /// This member is required.
        var arbitraryPatternLimits: ShieldClientTypes.ProtectionGroupArbitraryPatternLimits?
...
extension ShieldClientTypes {
    ...
    public struct ProtectionLimits: Swift.Equatable {
        ...
        /// This member is required.
        var protectedResourceTypeLimits: [ShieldClientTypes.Limit]?
...
extension ShieldClientTypes {
    ...
    public struct ResponseAction: Swift.Equatable {
        ...
        var block: ShieldClientTypes.BlockAction?
        ...
        var count: ShieldClientTypes.CountAction?
...
extension ShieldClientTypes {
    ...
    public struct SubResourceSummary: Swift.Equatable {
        ...
        var attackVectors: [ShieldClientTypes.SummarizedAttackVector]?
        /// The counters that describe the details of the attack.
        var counters: [ShieldClientTypes.SummarizedCounter]?
        /// The unique identifier (ID) of the SubResource.
        var id: Swift.String?
        /// The SubResource type.
        var type: ShieldClientTypes.SubResourceType?
...
extension ShieldClientTypes {
    ...
    public struct Subscription: Swift.Equatable {
        ...
        var autoRenew: ShieldClientTypes.AutoRenew?
        /// The date and time your subscription will end.
        var endTime: ClientRuntime.Date?
        /// Specifies how many protections of a given type you can create.
        var limits: [ShieldClientTypes.Limit]?
        ...
        var proactiveEngagementStatus: ShieldClientTypes.ProactiveEngagementStatus?
        ...
        /// This member is required.
        var subscriptionLimits: ShieldClientTypes.SubscriptionLimits?
        /// The length, in seconds, of the Shield Advanced subscription for the account.
        var timeCommitmentInSeconds: Swift.Int
...
extension ShieldClientTypes {
    ...
    public struct SubscriptionLimits: Swift.Equatable {
        /// Limits settings on protection groups for your subscription.
        /// This member is required.
        var protectionGroupLimits: ShieldClientTypes.ProtectionGroupLimits?
        /// Limits settings on protections for your subscription.
        /// This member is required.
        var protectionLimits: ShieldClientTypes.ProtectionLimits?
...
extension ShieldClientTypes {
    ...
    public struct SummarizedAttackVector: Swift.Equatable {
        ...
        var vectorCounters: [ShieldClientTypes.SummarizedCounter]?
...
extension ShieldClientTypes {
    ...
    public struct TimeRange: Swift.Equatable {
        ...
        var fromInclusive: ClientRuntime.Date?
        /// The end time, in Unix time in seconds.
        var toExclusive: ClientRuntime.Date?
