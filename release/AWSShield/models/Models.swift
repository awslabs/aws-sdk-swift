...
extension ShieldClientTypes {
    ...
    public struct TimeRange: Swift.Equatable {
        /// The start time, in Unix time in seconds. For more information see [timestamp](http://docs.aws.amazon.com/cli/latest/userguide/cli-using-param.html#parameter-types).
        public var fromInclusive: ClientRuntime.Date?
        /// The end time, in Unix time in seconds. For more information see [timestamp](http://docs.aws.amazon.com/cli/latest/userguide/cli-using-param.html#parameter-types).
