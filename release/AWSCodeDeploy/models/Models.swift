...
public struct AddTagsToOnPremisesInstancesInput: Swift.Equatable {
    ...
    var instanceNames: [Swift.String]?
    ...
    /// This member is required.
    var tags: [CodeDeployClientTypes.Tag]?
...
extension CodeDeployClientTypes {
    ...
    public struct AlarmConfiguration: Swift.Equatable {
        ...
        var alarms: [CodeDeployClientTypes.Alarm]?
        ...
        var ignorePollAlarmFailure: Swift.Bool
...
extension CodeDeployClientTypes {
    ...
    public struct ApplicationInfo: Swift.Equatable {
        ...
        var computePlatform: CodeDeployClientTypes.ComputePlatform?
        /// The time at which the application was created.
        var createTime: ClientRuntime.Date?
        /// The name for a connection to a GitHub account.
        var gitHubAccountName: Swift.String?
        /// True if the user has authenticated with GitHub for the specified application. Otherwise, false.
        var linkedToGitHub: Swift.Bool
...
extension CodeDeployClientTypes {
    ...
    public struct AutoRollbackConfiguration: Swift.Equatable {
        ...
        var events: [CodeDeployClientTypes.AutoRollbackEvent]?
...
public struct BatchGetApplicationRevisionsInput: Swift.Equatable {
    ...
    /// This member is required.
    var revisions: [CodeDeployClientTypes.RevisionLocation]?
...
public struct BatchGetApplicationRevisionsOutputResponse: Swift.Equatable {
    ...
    var revisions: [CodeDeployClientTypes.RevisionInfo]?
...
public struct BatchGetApplicationsOutputResponse: Swift.Equatable {
    ...
    var applicationsInfo: [CodeDeployClientTypes.ApplicationInfo]?
...
public struct BatchGetDeploymentGroupsInput: Swift.Equatable {
    ...
    /// This member is required.
    var deploymentGroupNames: [Swift.String]?
...
public struct BatchGetDeploymentGroupsOutputResponse: Swift.Equatable {
    ...
    var deploymentGroupsInfo: [CodeDeployClientTypes.DeploymentGroupInfo]?
    /// Information about errors that might have occurred during the API call.
    var errorMessage: Swift.String?
...
public struct BatchGetDeploymentInstancesOutputResponse: Swift.Equatable {
    ...
    var instancesSummary: [CodeDeployClientTypes.InstanceSummary]?
...
public struct BatchGetDeploymentTargetsOutputResponse: Swift.Equatable {
    ...
    var deploymentTargets: [CodeDeployClientTypes.DeploymentTarget]?
...
public struct BatchGetDeploymentsOutputResponse: Swift.Equatable {
    ...
    var deploymentsInfo: [CodeDeployClientTypes.DeploymentInfo]?
...
public struct BatchGetOnPremisesInstancesOutputResponse: Swift.Equatable {
    ...
    var instanceInfos: [CodeDeployClientTypes.InstanceInfo]?
...
extension CodeDeployClientTypes {
    ...
    public struct BlueGreenDeploymentConfiguration: Swift.Equatable {
        ...
        var deploymentReadyOption: CodeDeployClientTypes.DeploymentReadyOption?
        /// Information about how instances are provisioned for a replacement environment in a blue/green deployment.
        var greenFleetProvisioningOption: CodeDeployClientTypes.GreenFleetProvisioningOption?
        /// Information about whether to terminate instances in the original fleet during a blue/green deployment.
        var terminateBlueInstancesOnDeploymentSuccess: CodeDeployClientTypes.BlueInstanceTerminationOption?
...
extension CodeDeployClientTypes {
    ...
    public struct BlueInstanceTerminationOption: Swift.Equatable {
        ...
        var action: CodeDeployClientTypes.InstanceAction?
        ...
        var terminationWaitTimeInMinutes: Swift.Int
...
extension CodeDeployClientTypes {
    ...
    public struct CloudFormationTarget: Swift.Equatable {
        ...
        var lifecycleEvents: [CodeDeployClientTypes.LifecycleEvent]?
        /// The resource type for the AWS CloudFormation blue/green deployment.
        var resourceType: Swift.String?
        /// The status of an AWS CloudFormation blue/green deployment's target application.
        var status: CodeDeployClientTypes.TargetStatus?
        ...
        var targetVersionWeight: Swift.Double
...
public struct ContinueDeploymentInput: Swift.Equatable {
    ...
    var deploymentWaitType: CodeDeployClientTypes.DeploymentWaitType?
...
public struct CreateDeploymentConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var deploymentConfigName: Swift.String?
    ...
    var minimumHealthyHosts: CodeDeployClientTypes.MinimumHealthyHosts?
    /// The configuration that specifies how the deployment traffic is routed.
    var trafficRoutingConfig: CodeDeployClientTypes.TrafficRoutingConfig?
...
public struct CreateDeploymentConfigOutputResponse: Swift.Equatable {
    ...
    var deploymentConfigId: Swift.String?
...
public struct CreateDeploymentGroupInput: Swift.Equatable {
    ...
    var alarmConfiguration: CodeDeployClientTypes.AlarmConfiguration?
    /// The name of an AWS CodeDeploy application associated with the IAM user or AWS account.
    /// This member is required.
    var applicationName: Swift.String?
    /// Configuration information for an automatic rollback that is added when a deployment group is created.
    var autoRollbackConfiguration: CodeDeployClientTypes.AutoRollbackConfiguration?
    /// A list of associated Amazon EC2 Auto Scaling groups.
    var autoScalingGroups: [Swift.String]?
    /// Information about blue/green deployment options for a deployment group.
    var blueGreenDeploymentConfiguration: CodeDeployClientTypes.BlueGreenDeploymentConfiguration?
    ...
    /// This member is required.
    var deploymentGroupName: Swift.String?
    /// Information about the type of deployment, in-place or blue/green, that you want to run and whether to route deployment traffic behind a load balancer.
    var deploymentStyle: CodeDeployClientTypes.DeploymentStyle?
    ...
    var ec2TagFilters: [CodeDeployClientTypes.EC2TagFilter]?
    ...
    var ec2TagSet: CodeDeployClientTypes.EC2TagSet?
    ...
    var ecsServices: [CodeDeployClientTypes.ECSService]?
    /// Information about the load balancer used in a deployment.
    var loadBalancerInfo: CodeDeployClientTypes.LoadBalancerInfo?
    /// The on-premises instance tags on which to filter. The deployment group includes on-premises instances with any of the specified tags. Cannot be used in the same call as OnPremisesTagSet.
    var onPremisesInstanceTagFilters: [CodeDeployClientTypes.TagFilter]?
    /// Information about groups of tags applied to on-premises instances. The deployment group includes only on-premises instances identified by all of the tag groups. Cannot be used in the same call as onPremisesInstanceTagFilters.
    var onPremisesTagSet: CodeDeployClientTypes.OnPremisesTagSet?
    ...
    var outdatedInstancesStrategy: CodeDeployClientTypes.OutdatedInstancesStrategy?
    ...
    var triggerConfigurations: [CodeDeployClientTypes.TriggerConfig]?
...
public struct CreateDeploymentGroupOutputResponse: Swift.Equatable {
    ...
    var deploymentGroupId: Swift.String?
...
public struct CreateDeploymentInput: Swift.Equatable {
    ...
    var fileExistsBehavior: CodeDeployClientTypes.FileExistsBehavior?
    ...
    var ignoreApplicationStopFailures: Swift.Bool
    /// The type and location of the revision to deploy.
    var revision: CodeDeployClientTypes.RevisionLocation?
    /// Information about the instances that belong to the replacement environment in a blue/green deployment.
    var targetInstances: CodeDeployClientTypes.TargetInstances?
    /// Indicates whether to deploy to all instances or only to instances that are not running the latest application revision.
    var updateOutdatedInstancesOnly: Swift.Bool
...
public struct DeleteDeploymentGroupOutputResponse: Swift.Equatable {
    ...
    var hooksNotCleanedUp: [CodeDeployClientTypes.AutoScalingGroup]?
...
extension CodeDeployClientTypes {
    ...
    public struct DeploymentGroupInfo: Swift.Equatable {
        ...
        var autoScalingGroups: [CodeDeployClientTypes.AutoScalingGroup]?
        /// Information about blue/green deployment options for a deployment group.
        var blueGreenDeploymentConfiguration: CodeDeployClientTypes.BlueGreenDeploymentConfiguration?
        /// The destination platform type for the deployment (Lambda, Server, or ECS).
        var computePlatform: CodeDeployClientTypes.ComputePlatform?
        ...
        var lastAttemptedDeployment: CodeDeployClientTypes.LastDeploymentInfo?
        /// Information about the most recent successful deployment to the deployment group.
        var lastSuccessfulDeployment: CodeDeployClientTypes.LastDeploymentInfo?
        ...
        var targetRevision: CodeDeployClientTypes.RevisionLocation?
...
extension CodeDeployClientTypes {
    ...
    public struct DeploymentInfo: Swift.Equatable {
        ...
        var additionalDeploymentStatusInfo: Swift.String?
        /// The application name.
        var applicationName: Swift.String?
        ...
        var creator: CodeDeployClientTypes.DeploymentCreator?
        /// The deployment configuration name.
        var deploymentConfigName: Swift.String?
        /// The deployment group name.
        var deploymentGroupName: Swift.String?
        ...
        var deploymentOverview: CodeDeployClientTypes.DeploymentOverview?
        /// Messages that contain information about the status of a deployment.
        var deploymentStatusMessages: [Swift.String]?
        /// Information about the type of deployment, either in-place or blue/green, you want to run and whether to route deployment traffic behind a load balancer.
        var deploymentStyle: CodeDeployClientTypes.DeploymentStyle?
        /// A comment about the deployment.
        var description: Swift.String?
        /// Information about any error associated with this deployment.
        var errorInformation: CodeDeployClientTypes.ErrorInformation?
        ...
        var instanceTerminationWaitTimeStarted: Swift.Bool
        /// Information about the load balancer used in the deployment.
        var loadBalancerInfo: CodeDeployClientTypes.LoadBalancerInfo?
        /// Information about the application revision that was deployed to the deployment group before the most recent successful deployment.
        var previousRevision: CodeDeployClientTypes.RevisionLocation?
        /// Information about deployments related to the specified deployment.
        var relatedDeployments: CodeDeployClientTypes.RelatedDeployments?
        /// Information about the location of stored application artifacts and the service from which to retrieve them.
        var revision: CodeDeployClientTypes.RevisionLocation?
        /// Information about a deployment rollback.
        var rollbackInfo: CodeDeployClientTypes.RollbackInfo?
        ...
        var status: CodeDeployClientTypes.DeploymentStatus?
        /// Information about the instances that belong to the replacement environment in a blue/green deployment.
        var targetInstances: CodeDeployClientTypes.TargetInstances?
...
extension CodeDeployClientTypes {
    ...
    public struct DeploymentReadyOption: Swift.Equatable {
        ...
        var actionOnTimeout: CodeDeployClientTypes.DeploymentReadyAction?
        /// The number of minutes to wait before the status of a blue/green deployment is changed to Stopped if rerouting is not started manually. Applies only to the STOP_DEPLOYMENT option for actionOnTimeout.
        var waitTimeInMinutes: Swift.Int
...
extension CodeDeployClientTypes {
    ...
    public struct DeploymentStyle: Swift.Equatable {
        ...
        var deploymentOption: CodeDeployClientTypes.DeploymentOption?
        /// Indicates whether to run an in-place deployment or a blue/green deployment.
        var deploymentType: CodeDeployClientTypes.DeploymentType?
...
extension CodeDeployClientTypes {
    ...
    public struct DeploymentTarget: Swift.Equatable {
        /// Information about the target to be updated by an AWS CloudFormation blue/green deployment. This target type is used for all deployments initiated by a CloudFormation stack update.
        var cloudFormationTarget: CodeDeployClientTypes.CloudFormationTarget?
        /// The deployment type that is specific to the deployment's compute platform or deployments initiated by a CloudFormation stack update.
        var deploymentTargetType: CodeDeployClientTypes.DeploymentTargetType?
        /// Information about the target for a deployment that uses the Amazon ECS compute platform.
        var ecsTarget: CodeDeployClientTypes.ECSTarget?
        /// Information about the target for a deployment that uses the EC2/On-premises compute platform.
        var instanceTarget: CodeDeployClientTypes.InstanceTarget?
        /// Information about the target for a deployment that uses the AWS Lambda compute platform.
        var lambdaTarget: CodeDeployClientTypes.LambdaTarget?
...
extension CodeDeployClientTypes {
    ...
    public struct EC2TagFilter: Swift.Equatable {
        ...
        var type: CodeDeployClientTypes.EC2TagFilterType?
...
extension CodeDeployClientTypes {
    ...
    public struct EC2TagSet: Swift.Equatable {
        ...
        var ec2TagSetList: [[CodeDeployClientTypes.EC2TagFilter]]?
...
extension CodeDeployClientTypes {
    ...
    public struct ECSTarget: Swift.Equatable {
        ...
        var taskSetsInfo: [CodeDeployClientTypes.ECSTaskSet]?
...
extension CodeDeployClientTypes {
    ...
    public struct ECSTaskSet: Swift.Equatable {
        ...
        var desiredCount: Swift.Int
        /// A unique ID of an ECSTaskSet.
        var identifer: Swift.String?
        /// The number of tasks in the task set that are in the PENDING status during an Amazon ECS deployment. A task in the PENDING state is preparing to enter the RUNNING state. A task set enters the PENDING status when it launches for the first time, or when it is restarted after being in the STOPPED state.
        var pendingCount: Swift.Int
        /// The number of tasks in the task set that are in the RUNNING status during an Amazon ECS deployment. A task in the RUNNING state is running and ready for use.
        var runningCount: Swift.Int
        ...
        var targetGroup: CodeDeployClientTypes.TargetGroupInfo?
        /// A label that identifies whether the ECS task set is an original target (BLUE) or a replacement target (GREEN).
        var taskSetLabel: CodeDeployClientTypes.TargetLabel?
        /// The percentage of traffic served by this task set.
        var trafficWeight: Swift.Double
...
extension CodeDeployClientTypes {
    ...
    public struct ErrorInformation: Swift.Equatable {
        ...
        var code: CodeDeployClientTypes.ErrorCode?
...
extension CodeDeployClientTypes {
    ...
    public struct GenericRevisionInfo: Swift.Equatable {
        ...
        var deploymentGroups: [Swift.String]?
        /// A comment about the revision.
        var description: Swift.String?
        /// When the revision was first used by AWS CodeDeploy.
        var firstUsedTime: ClientRuntime.Date?
        /// When the revision was last used by AWS CodeDeploy.
        var lastUsedTime: ClientRuntime.Date?
        /// When the revision was registered with AWS CodeDeploy.
        var registerTime: ClientRuntime.Date?
...
public struct GetApplicationOutputResponse: Swift.Equatable {
    ...
    var application: CodeDeployClientTypes.ApplicationInfo?
...
public struct GetApplicationRevisionOutputResponse: Swift.Equatable {
    ...
    var revisionInfo: CodeDeployClientTypes.GenericRevisionInfo?
...
public struct GetDeploymentConfigOutputResponse: Swift.Equatable {
    ...
    var deploymentConfigInfo: CodeDeployClientTypes.DeploymentConfigInfo?
...
public struct GetDeploymentGroupOutputResponse: Swift.Equatable {
    ...
    var deploymentGroupInfo: CodeDeployClientTypes.DeploymentGroupInfo?
...
public struct GetDeploymentInstanceOutputResponse: Swift.Equatable {
    ...
    var instanceSummary: CodeDeployClientTypes.InstanceSummary?
...
public struct GetDeploymentOutputResponse: Swift.Equatable {
    ...
    var deploymentInfo: CodeDeployClientTypes.DeploymentInfo?
...
public struct GetDeploymentTargetOutputResponse: Swift.Equatable {
    ...
    var deploymentTarget: CodeDeployClientTypes.DeploymentTarget?
...
public struct GetOnPremisesInstanceOutputResponse: Swift.Equatable {
    ...
    var instanceInfo: CodeDeployClientTypes.InstanceInfo?
...
extension CodeDeployClientTypes {
    ...
    public struct GreenFleetProvisioningOption: Swift.Equatable {
        ...
        var action: CodeDeployClientTypes.GreenFleetProvisioningAction?
...
extension CodeDeployClientTypes {
    ...
    public struct InstanceInfo: Swift.Equatable {
        ...
        var deregisterTime: ClientRuntime.Date?
        /// The ARN of the IAM session associated with the on-premises instance.
        var iamSessionArn: Swift.String?
...
extension CodeDeployClientTypes {
    ...
    public struct InstanceSummary: Swift.Equatable {
        ...
        var instanceType: CodeDeployClientTypes.InstanceType?
        ...
        @available(*, deprecated, message: "InstanceStatus is deprecated, use TargetStatus instead.")
        var status: CodeDeployClientTypes.InstanceStatus?
...
extension CodeDeployClientTypes {
    ...
    public struct InstanceTarget: Swift.Equatable {
        ...
        var instanceLabel: CodeDeployClientTypes.TargetLabel?
...
extension CodeDeployClientTypes {
    ...
    public struct LambdaFunctionInfo: Swift.Equatable {
        ...
        var functionAlias: Swift.String?
...
extension CodeDeployClientTypes {
    ...
    public struct LambdaTarget: Swift.Equatable {
        ...
        var lambdaFunctionInfo: CodeDeployClientTypes.LambdaFunctionInfo?
...
extension CodeDeployClientTypes {
    ...
    public struct LifecycleEvent: Swift.Equatable {
        ...
        var diagnostics: CodeDeployClientTypes.Diagnostics?
        /// A timestamp that indicates when the deployment lifecycle event ended.
        var endTime: ClientRuntime.Date?
        /// The deployment lifecycle event name, such as ApplicationStop, BeforeInstall, AfterInstall, ApplicationStart, or ValidateService.
        var lifecycleEventName: Swift.String?
        ...
        var status: CodeDeployClientTypes.LifecycleEventStatus?
...
public struct ListApplicationRevisionsInput: Swift.Equatable {
    ...
    var deployed: CodeDeployClientTypes.ListStateFilterAction?
    ...
    var sortBy: CodeDeployClientTypes.ApplicationRevisionSortBy?
    ...
    var sortOrder: CodeDeployClientTypes.SortOrder?
...
public struct ListDeploymentConfigsOutputResponse: Swift.Equatable {
    ...
    var deploymentConfigsList: [Swift.String]?
...
public struct ListDeploymentInstancesInput: Swift.Equatable {
    ...
    var instanceStatusFilter: [CodeDeployClientTypes.InstanceStatus]?
    /// The set of instances in a blue/green deployment, either those in the original environment ("BLUE") or those in the replacement environment ("GREEN"), for which you want to view instance information.
    var instanceTypeFilter: [CodeDeployClientTypes.InstanceType]?
...
public struct ListDeploymentInstancesOutputResponse: Swift.Equatable {
    ...
    var instancesList: [Swift.String]?
...
public struct ListDeploymentTargetsInput: Swift.Equatable {
    ...
    var targetFilters: [Swift.String:[Swift.String]]?
...
public struct ListDeploymentsInput: Swift.Equatable {
    ...
    var createTimeRange: CodeDeployClientTypes.TimeRange?
    ...
    var includeOnlyStatuses: [CodeDeployClientTypes.DeploymentStatus]?
...
public struct ListGitHubAccountTokenNamesOutputResponse: Swift.Equatable {
    ...
    var tokenNameList: [Swift.String]?
...
public struct ListOnPremisesInstancesInput: Swift.Equatable {
    ...
    var registrationStatus: CodeDeployClientTypes.RegistrationStatus?
    /// The on-premises instance tags that are used to restrict the on-premises instance names returned.
    var tagFilters: [CodeDeployClientTypes.TagFilter]?
...
extension CodeDeployClientTypes {
    ...
    public struct LoadBalancerInfo: Swift.Equatable {
        ...
        var elbInfoList: [CodeDeployClientTypes.ELBInfo]?
        ...
        var targetGroupInfoList: [CodeDeployClientTypes.TargetGroupInfo]?
        /// The target group pair information. This is an array of TargeGroupPairInfo objects with a maximum size of one.
        var targetGroupPairInfoList: [CodeDeployClientTypes.TargetGroupPairInfo]?
...
extension CodeDeployClientTypes {
    ...
    public struct MinimumHealthyHosts: Swift.Equatable {
        ...
        var type: CodeDeployClientTypes.MinimumHealthyHostsType?
...
extension CodeDeployClientTypes {
    ...
    public struct OnPremisesTagSet: Swift.Equatable {
        ...
        var onPremisesTagSetList: [[CodeDeployClientTypes.TagFilter]]?
...
public struct PutLifecycleEventHookExecutionStatusInput: Swift.Equatable {
    ...
    var lifecycleEventHookExecutionId: Swift.String?
...
extension CodeDeployClientTypes {
    ...
    public struct RelatedDeployments: Swift.Equatable {
        ...
        var autoUpdateOutdatedInstancesDeploymentIds: [Swift.String]?
        /// The deployment ID of the root deployment that triggered this deployment.
        var autoUpdateOutdatedInstancesRootDeploymentId: Swift.String?
...
extension CodeDeployClientTypes {
    ...
    public struct RevisionInfo: Swift.Equatable {
        ...
        var genericRevisionInfo: CodeDeployClientTypes.GenericRevisionInfo?
        /// Information about the location and type of an application revision.
        var revisionLocation: CodeDeployClientTypes.RevisionLocation?
...
extension CodeDeployClientTypes {
    ...
    public struct RevisionLocation: Swift.Equatable {
        ...
        var appSpecContent: CodeDeployClientTypes.AppSpecContent?
        /// Information about the location of application artifacts stored in GitHub.
        var gitHubLocation: CodeDeployClientTypes.GitHubLocation?
        ...
        var revisionType: CodeDeployClientTypes.RevisionLocationType?
        /// Information about the location of a revision stored in Amazon S3.
        var s3Location: CodeDeployClientTypes.S3Location?
        /// Information about the location of an AWS Lambda deployment revision stored as a RawString.
        @available(*, deprecated, message: "RawString and String revision type are deprecated, use AppSpecContent type instead.")
        var string: CodeDeployClientTypes.RawString?
...
extension CodeDeployClientTypes {
    ...
    public struct RollbackInfo: Swift.Equatable {
        ...
        var rollbackDeploymentId: Swift.String?
        /// Information that describes the status of a deployment rollback (for example, whether the deployment can't be rolled back, is in progress, failed, or succeeded).
        var rollbackMessage: Swift.String?
        /// The deployment ID of the deployment that was underway and triggered a rollback deployment because it failed or was stopped.
        var rollbackTriggeringDeploymentId: Swift.String?
...
extension CodeDeployClientTypes {
    ...
    public struct S3Location: Swift.Equatable {
        ...
        var bundleType: CodeDeployClientTypes.BundleType?
...
public struct StopDeploymentInput: Swift.Equatable {
    ...
    var autoRollbackEnabled: Swift.Bool?
    /// The unique ID of a deployment.
    /// This member is required.
    var deploymentId: Swift.String?
...
public struct StopDeploymentOutputResponse: Swift.Equatable {
    ...
    var status: CodeDeployClientTypes.StopStatus?
...
extension CodeDeployClientTypes {
    ...
    public struct TagFilter: Swift.Equatable {
        ...
        ///
        /// * KEY_AND_VALUE: Key and value.
        var type: CodeDeployClientTypes.TagFilterType?
...
extension CodeDeployClientTypes {
    ...
    public struct TargetGroupPairInfo: Swift.Equatable {
        ...
        var prodTrafficRoute: CodeDeployClientTypes.TrafficRoute?
        /// One pair of target groups. One is associated with the original task set. The second is associated with the task set that serves traffic after the deployment is complete.
        var targetGroups: [CodeDeployClientTypes.TargetGroupInfo]?
        /// An optional path used by a load balancer to route test traffic after an Amazon ECS deployment. Validation can occur while test traffic is served during a deployment.
        var testTrafficRoute: CodeDeployClientTypes.TrafficRoute?
...
extension CodeDeployClientTypes {
    ...
    public struct TargetInstances: Swift.Equatable {
        ...
        var tagFilters: [CodeDeployClientTypes.EC2TagFilter]?
...
extension CodeDeployClientTypes {
    ...
    public struct TimeBasedCanary: Swift.Equatable {
        ...
        var canaryInterval: Swift.Int
        /// The percentage of traffic to shift in the first increment of a TimeBasedCanary deployment.
        var canaryPercentage: Swift.Int
...
extension CodeDeployClientTypes {
    ...
    public struct TimeBasedLinear: Swift.Equatable {
        ...
        var linearInterval: Swift.Int
        /// The percentage of traffic that is shifted at the start of each increment of a TimeBasedLinear deployment.
        var linearPercentage: Swift.Int
...
extension CodeDeployClientTypes {
    ...
    public struct TrafficRoutingConfig: Swift.Equatable {
        /// A configuration that shifts traffic from one version of a Lambda function or ECS task set to another in two increments. The original and target Lambda function versions or ECS task sets are specified in the deployment's AppSpec file.
        var timeBasedCanary: CodeDeployClientTypes.TimeBasedCanary?
        /// A configuration that shifts traffic from one version of a Lambda function or ECS task set to another in equal increments, with an equal number of minutes between each increment. The original and target Lambda function versions or ECS task sets are specified in the deployment's AppSpec file.
        var timeBasedLinear: CodeDeployClientTypes.TimeBasedLinear?
        /// The type of traffic shifting (TimeBasedCanary or TimeBasedLinear) used by a deployment configuration.
        var type: CodeDeployClientTypes.TrafficRoutingType?
...
extension CodeDeployClientTypes {
    ...
    public struct TriggerConfig: Swift.Equatable {
        ...
        var triggerEvents: [CodeDeployClientTypes.TriggerEventType]?
        /// The name of the notification trigger.
        var triggerName: Swift.String?
        /// The Amazon Resource Name (ARN) of the Amazon Simple Notification Service topic through which notifications about deployment or instance events are sent.
        var triggerTargetArn: Swift.String?
...
public struct UpdateApplicationInput: Swift.Equatable {
    ...
    var newApplicationName: Swift.String?
...
public struct UpdateDeploymentGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var currentDeploymentGroupName: Swift.String?
    ...
    var newDeploymentGroupName: Swift.String?
