...
public class LookoutVisionClient {
    ...
    public class LookoutVisionClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("LookoutVisionClient")
...
public struct LookoutVisionClientLogHandlerFactory: SDKLogHandlerFactory {
...
extension LookoutVisionClient: LookoutVisionClientProtocol {
    ...
    public func detectAnomalies(input: DetectAnomaliesInput, completion: @escaping (SdkResult<DetectAnomaliesOutputResponse, DetectAnomaliesOutputError>) -> Void)
    {
        guard let projectName = input.projectName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component projectName unexpectedly nil"))))
            return
