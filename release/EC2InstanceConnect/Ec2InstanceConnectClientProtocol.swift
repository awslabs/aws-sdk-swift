...
public protocol Ec2InstanceConnectClientProtocol {
    ...
    func sendSerialConsoleSSHPublicKey(input: SendSerialConsoleSSHPublicKeyInput, completion: @escaping (SdkResult<SendSerialConsoleSSHPublicKeyOutputResponse, SendSerialConsoleSSHPublicKeyOutputError>) -> Void)
    ...
    ///                 User Guide</i>.</p>
    func sendSSHPublicKey(input: SendSSHPublicKeyInput, completion: @escaping (SdkResult<SendSSHPublicKeyOutputResponse, SendSSHPublicKeyOutputError>) -> Void)
}
