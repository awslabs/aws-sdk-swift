...
public protocol Ec2InstanceConnectClientProtocol {
    ...
    func sendSerialConsoleSSHPublicKey(input: SendSerialConsoleSSHPublicKeyInput, completion: @escaping (SdkResult<SendSerialConsoleSSHPublicKeyOutput, SendSerialConsoleSSHPublicKeyOutputError>) -> Void)
    ...
    ///                 User Guide</i>.</p>
    func sendSSHPublicKey(input: SendSSHPublicKeyInput, completion: @escaping (SdkResult<SendSSHPublicKeyOutput, SendSSHPublicKeyOutputError>) -> Void)
}
