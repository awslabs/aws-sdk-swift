...
public struct SendSerialConsoleSSHPublicKeyInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<SendSerialConsoleSSHPublicKeyOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<SendSerialConsoleSSHPublicKeyOutput>
