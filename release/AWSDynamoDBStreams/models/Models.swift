...
public struct DescribeStreamInput: Swift.Equatable {
    ...
    var exclusiveStartShardId: Swift.String?
    /// The maximum number of shard objects to return. The upper limit is 100.
    var limit: Swift.Int?
    /// The Amazon Resource Name (ARN) for the stream.
    /// This member is required.
    var streamArn: Swift.String?
...
public struct DescribeStreamOutputResponse: Swift.Equatable {
    ...
    var streamDescription: DynamoDbStreamsClientTypes.StreamDescription?
...
public struct GetRecordsInput: Swift.Equatable {
    ...
    /// This member is required.
    var shardIterator: Swift.String?
...
public struct GetRecordsOutputResponse: Swift.Equatable {
    ...
    var nextShardIterator: Swift.String?
    /// The stream records from the shard, which were retrieved using the shard iterator.
    var records: [DynamoDbStreamsClientTypes.Record]?
...
public struct GetShardIteratorInput: Swift.Equatable {
    ...
    var sequenceNumber: Swift.String?
    /// The identifier of the shard. The iterator will be returned for this shard ID.
    /// This member is required.
    var shardId: Swift.String?
    ...
    /// This member is required.
    var shardIteratorType: DynamoDbStreamsClientTypes.ShardIteratorType?
    /// The Amazon Resource Name (ARN) for the stream.
    /// This member is required.
    var streamArn: Swift.String?
...
extension DynamoDbStreamsClientTypes {
    ...
    public struct KeySchemaElement: Swift.Equatable {
        ...
        /// This member is required.
        var keyType: DynamoDbStreamsClientTypes.KeyType?
...
public struct ListStreamsInput: Swift.Equatable {
    ...
    var exclusiveStartStreamArn: Swift.String?
...
public struct ListStreamsOutputResponse: Swift.Equatable {
    ...
    var lastEvaluatedStreamArn: Swift.String?
    /// A list of stream descriptors associated with the current account and endpoint.
    var streams: [DynamoDbStreamsClientTypes.Stream]?
...
extension DynamoDbStreamsClientTypes {
    ...
    public struct Record: Swift.Equatable {
        ...
        var awsRegion: Swift.String?
        /// The main body of the stream record, containing all of the DynamoDB-specific fields.
        var dynamodb: DynamoDbStreamsClientTypes.StreamRecord?
        /// A globally unique identifier for the event that was recorded in this stream record.
        var eventID: Swift.String?
        ...
        var eventName: DynamoDbStreamsClientTypes.OperationType?
        /// The AWS service from which the stream record originated. For DynamoDB Streams, this is aws:dynamodb.
        var eventSource: Swift.String?
...
extension DynamoDbStreamsClientTypes {
    ...
    public struct SequenceNumberRange: Swift.Equatable {
        ...
        var endingSequenceNumber: Swift.String?
        /// The first sequence number for the stream records contained within a shard. String contains numeric characters only.
        var startingSequenceNumber: Swift.String?
...
extension DynamoDbStreamsClientTypes {
    ...
    public struct Shard: Swift.Equatable {
        ...
        var parentShardId: Swift.String?
        /// The range of possible sequence numbers for the shard.
        var sequenceNumberRange: DynamoDbStreamsClientTypes.SequenceNumberRange?
...
extension DynamoDbStreamsClientTypes {
    ...
    public struct StreamDescription: Swift.Equatable {
        ...
        var creationRequestDateTime: ClientRuntime.Date?
        /// The key attribute(s) of the stream's DynamoDB table.
        var keySchema: [DynamoDbStreamsClientTypes.KeySchemaElement]?
        ...
        var lastEvaluatedShardId: Swift.String?
        /// The shards that comprise the stream.
        var shards: [DynamoDbStreamsClientTypes.Shard]?
        /// The Amazon Resource Name (ARN) for the stream.
        var streamArn: Swift.String?
        /// A timestamp, in ISO 8601 format, for this stream. Note that LatestStreamLabel is not a unique identifier for the stream, because it is possible that a stream from another table might have the same timestamp. However, the combination of the following three elements is guaranteed to be unique:
        ///
        ...
        var streamStatus: DynamoDbStreamsClientTypes.StreamStatus?
        ...
        var streamViewType: DynamoDbStreamsClientTypes.StreamViewType?
        /// The DynamoDB table with which the stream is associated.
        var tableName: Swift.String?
...
extension DynamoDbStreamsClientTypes {
    ...
    public struct StreamRecord: Swift.Equatable {
        ...
        var approximateCreationDateTime: ClientRuntime.Date?
        /// The primary key attribute(s) for the DynamoDB item that was modified.
        var keys: [Swift.String:DynamoDbStreamsClientTypes.AttributeValue]?
        /// The item in the DynamoDB table as it appeared after it was modified.
        var newImage: [Swift.String:DynamoDbStreamsClientTypes.AttributeValue]?
        /// The item in the DynamoDB table as it appeared before it was modified.
        var oldImage: [Swift.String:DynamoDbStreamsClientTypes.AttributeValue]?
        /// The sequence number of the stream record.
        var sequenceNumber: Swift.String?
        /// The size of the stream record, in bytes.
        var sizeBytes: Swift.Int?
