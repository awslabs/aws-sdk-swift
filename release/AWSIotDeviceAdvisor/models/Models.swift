...
public struct CreateSuiteDefinitionInput: Swift.Equatable {
    ...
    var suiteDefinitionConfiguration: IotDeviceAdvisorClientTypes.SuiteDefinitionConfiguration?
...
public struct CreateSuiteDefinitionOutputResponse: Swift.Equatable {
    ...
    var suiteDefinitionArn: Swift.String?
    /// Creates a Device Advisor test suite with suite UUID.
    var suiteDefinitionId: Swift.String?
    /// Creates a Device Advisor test suite with suite definition name.
    var suiteDefinitionName: Swift.String?
...
public struct GetSuiteDefinitionInput: Swift.Equatable {
    ...
    var suiteDefinitionVersion: Swift.String?
...
public struct GetSuiteDefinitionOutputResponse: Swift.Equatable {
    ...
    var lastModifiedAt: ClientRuntime.Date?
...
public struct GetSuiteRunOutputResponse: Swift.Equatable {
    ...
    var errorReason: Swift.String?
    /// Date (in Unix epoch time) when the test suite run started.
    var startTime: ClientRuntime.Date?
    /// Status for the test suite run.
    var status: IotDeviceAdvisorClientTypes.SuiteRunStatus?
    /// Suite definition ID for the test suite run.
    var suiteDefinitionId: Swift.String?
    /// Suite definition version for the test suite run.
    var suiteDefinitionVersion: Swift.String?
    /// The ARN of the suite run.
    var suiteRunArn: Swift.String?
    /// Suite run configuration for the test suite run.
    var suiteRunConfiguration: IotDeviceAdvisorClientTypes.SuiteRunConfiguration?
    /// Suite run ID for the test suite run.
    var suiteRunId: Swift.String?
    /// The tags attached to the suite run.
    var tags: [Swift.String:Swift.String]?
    /// Test results for the test suite run.
    var testResult: IotDeviceAdvisorClientTypes.TestResult?
...
public struct GetSuiteRunReportOutputResponse: Swift.Equatable {
    ...
    var qualificationReportDownloadUrl: Swift.String?
...
extension IotDeviceAdvisorClientTypes {
    ...
    public struct GroupResult: Swift.Equatable {
        ...
        var tests: [IotDeviceAdvisorClientTypes.TestCaseRun]?
...
public struct ListSuiteDefinitionsOutputResponse: Swift.Equatable {
    ...
    var suiteDefinitionInformationList: [IotDeviceAdvisorClientTypes.SuiteDefinitionInformation]?
...
public struct ListSuiteRunsOutputResponse: Swift.Equatable {
    ...
    var suiteRunsList: [IotDeviceAdvisorClientTypes.SuiteRunInformation]?
...
extension IotDeviceAdvisorClientTypes {
    ...
    public struct SuiteDefinitionConfiguration: Swift.Equatable {
        ...
        var devicePermissionRoleArn: Swift.String?
        /// Gets the devices configured.
        var devices: [IotDeviceAdvisorClientTypes.DeviceUnderTest]?
        /// Gets the tests intended for qualification in a suite.
        var intendedForQualification: Swift.Bool
        /// Gets test suite root group.
        var rootGroup: Swift.String?
...
extension IotDeviceAdvisorClientTypes {
    ...
    public struct SuiteDefinitionInformation: Swift.Equatable {
        ...
        var defaultDevices: [IotDeviceAdvisorClientTypes.DeviceUnderTest]?
...
extension IotDeviceAdvisorClientTypes {
    ...
    public struct SuiteRunConfiguration: Swift.Equatable {
        ...
        var parallelRun: Swift.Bool
        /// Gets the primary device for suite run.
        var primaryDevice: IotDeviceAdvisorClientTypes.DeviceUnderTest?
        /// Gets test case list.
        var selectedTestList: [Swift.String]?
...
extension IotDeviceAdvisorClientTypes {
    ...
    public struct SuiteRunInformation: Swift.Equatable {
        ...
        var endAt: ClientRuntime.Date?
        /// Number of test cases that failed in the suite run.
        var failed: Swift.Int
        /// Number of test cases that passed in the suite run.
        var passed: Swift.Int
...
extension IotDeviceAdvisorClientTypes {
    ...
    public struct TestCaseRun: Swift.Equatable {
        ...
        var status: IotDeviceAdvisorClientTypes.Status?
        /// Provides the test case run definition ID.
        var testCaseDefinitionId: Swift.String?
        /// Provides the test case run definition name.
        var testCaseDefinitionName: Swift.String?
        /// Provides the test case run ID.
        var testCaseRunId: Swift.String?
...
extension IotDeviceAdvisorClientTypes {
    ...
    public struct TestResult: Swift.Equatable {
        ...
        var groups: [IotDeviceAdvisorClientTypes.GroupResult]?
