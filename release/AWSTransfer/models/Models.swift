...
extension TransferClientTypes.IdentityProviderDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IdentityProviderDetails(directoryId: \(Swift.String(describing: directoryId)), function: \(Swift.String(describing: function)), invocationRole: \(Swift.String(describing: invocationRole)), url: \(Swift.String(describing: url)))"}
}
