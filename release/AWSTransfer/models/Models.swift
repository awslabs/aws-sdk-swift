...
extension TransferClientTypes {
    ...
    public struct CopyStepDetails: Swift.Equatable {
        ...
        var destinationFileLocation: TransferClientTypes.InputFileLocation?
        /// The name of the step, used as an identifier.
        var name: Swift.String?
        /// A flag that indicates whether or not to overwrite an existing file of the same name. The default is FALSE.
        var overwriteExisting: TransferClientTypes.OverwriteExisting?
...
public struct CreateAccessInput: Swift.Equatable {
    ...
    var homeDirectory: Swift.String?
    ...
    var homeDirectoryMappings: [TransferClientTypes.HomeDirectoryMapEntry]?
    /// The type of landing directory (folder) you want your users' home directory to be when they log into the server. If you set it to PATH, the user will see the absolute Amazon S3 bucket or EFS paths as is in their file transfer protocol clients. If you set it LOGICAL, you need to provide mappings in the HomeDirectoryMappings for how you want to make Amazon S3 or EFS paths visible to your users.
    var homeDirectoryType: TransferClientTypes.HomeDirectoryType?
    ...
    var posixProfile: TransferClientTypes.PosixProfile?
...
public struct CreateServerInput: Swift.Equatable {
    ...
    var domain: TransferClientTypes.Domain?
    /// The virtual private cloud (VPC) endpoint settings that are configured for your server. When you host your endpoint within your VPC, you can make it accessible only to resources within your VPC, or you can attach Elastic IP addresses and make it accessible to clients over the internet. Your VPC's default security groups are automatically assigned to your endpoint.
    var endpointDetails: TransferClientTypes.EndpointDetails?
    ...
    var endpointType: TransferClientTypes.EndpointType?
    ...
    var hostKey: Swift.String?
    /// Required when IdentityProviderType is set to AWS_DIRECTORY_SERVICE or API_GATEWAY. Accepts an array containing all of the information required to use a directory in AWS_DIRECTORY_SERVICE or invoke a customer-supplied authentication API, including the API Gateway URL. Not required when IdentityProviderType is set to SERVICE_MANAGED.
    var identityProviderDetails: TransferClientTypes.IdentityProviderDetails?
    ...
    var identityProviderType: TransferClientTypes.IdentityProviderType?
    ...
    var protocols: [TransferClientTypes.ModelProtocol]?
    /// Specifies the name of the security policy that is attached to the server.
    var securityPolicyName: Swift.String?
    /// Key-value pairs that can be used to group and search for servers.
    var tags: [TransferClientTypes.Tag]?
    /// Specifies the workflow ID for the workflow to assign and the execution role used for executing the workflow.
    var workflowDetails: TransferClientTypes.WorkflowDetails?
...
public struct CreateUserInput: Swift.Equatable {
    ...
    var sshPublicKeyBody: Swift.String?
...
public struct CreateWorkflowInput: Swift.Equatable {
    ...
    var onExceptionSteps: [TransferClientTypes.WorkflowStep]?
    ...
    /// This member is required.
    var steps: [TransferClientTypes.WorkflowStep]?
...
public struct DeleteSshPublicKeyInput: Swift.Equatable {
    ...
    /// This member is required.
    var sshPublicKeyId: Swift.String?
...
public struct DescribeAccessOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var access: TransferClientTypes.DescribedAccess?
    /// A system-assigned unique identifier for a server that has this access assigned.
    /// This member is required.
    var serverId: Swift.String?
...
public struct DescribeExecutionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var execution: TransferClientTypes.DescribedExecution?
    /// A unique identifier for the workflow.
    /// This member is required.
    var workflowId: Swift.String?
...
public struct DescribeSecurityPolicyOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var securityPolicy: TransferClientTypes.DescribedSecurityPolicy?
...
public struct DescribeServerOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var server: TransferClientTypes.DescribedServer?
...
public struct DescribeUserOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var user: TransferClientTypes.DescribedUser?
...
public struct DescribeWorkflowOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var workflow: TransferClientTypes.DescribedWorkflow?
...
extension TransferClientTypes {
    ...
    public struct DescribedExecution: Swift.Equatable {
        ...
        var executionRole: Swift.String?
        /// A structure that describes the Amazon S3 or EFS file location. This is the file location when the execution begins: if the file is being copied, this is the initial (as opposed to destination) file location.
        var initialFileLocation: TransferClientTypes.FileLocation?
        /// The IAM logging role associated with the execution.
        var loggingConfiguration: TransferClientTypes.LoggingConfiguration?
        /// The full POSIX identity, including user ID (Uid), group ID (Gid), and any secondary groups IDs (SecondaryGids), that controls your users' access to your Amazon EFS file systems. The POSIX permissions that are set on files and directories in your file system determine the level of access your users get when transferring files into and out of your Amazon EFS file systems.
        var posixProfile: TransferClientTypes.PosixProfile?
        ...
        var results: TransferClientTypes.ExecutionResults?
        /// A container object for the session details associated with a workflow.
        var serviceMetadata: TransferClientTypes.ServiceMetadata?
        /// The status is one of the execution. Can be in progress, completed, exception encountered, or handling the exception.
        var status: TransferClientTypes.ExecutionStatus?
...
extension TransferClientTypes {
    ...
    public struct DescribedSecurityPolicy: Swift.Equatable {
        ...
        var sshCiphers: [Swift.String]?
        /// Specifies the enabled SSH key exchange (KEX) encryption algorithms in the security policy that is attached to the server.
        var sshKexs: [Swift.String]?
        /// Specifies the enabled SSH message authentication code (MAC) encryption algorithms in the security policy that is attached to the server.
        var sshMacs: [Swift.String]?
        /// Specifies the enabled Transport Layer Security (TLS) cipher encryption algorithms in the security policy that is attached to the server.
        var tlsCiphers: [Swift.String]?
...
extension TransferClientTypes {
    ...
    public struct DescribedServer: Swift.Equatable {
        ...
        var hostKeyFingerprint: Swift.String?
        ...
        var protocolDetails: TransferClientTypes.ProtocolDetails?
        /// Specifies the file transfer protocol or protocols over which your file transfer protocol client can connect to your server's endpoint. The available protocols are:
        ///
        /// * SFTP (Secure Shell (SSH) File Transfer Protocol): File transfer over SSH
        ///
        ...
        var state: TransferClientTypes.State?
        /// Specifies the key-value pairs that you can use to search for and group servers that were assigned to the server that was described.
        var tags: [TransferClientTypes.Tag]?
        /// Specifies the number of users that are assigned to a server you specified with the ServerId.
        var userCount: Swift.Int?
        /// Specifies the workflow ID for the workflow to assign and the execution role used for executing the workflow.
        var workflowDetails: TransferClientTypes.WorkflowDetails?
...
extension TransferClientTypes {
    ...
    public struct DescribedUser: Swift.Equatable {
        ...
        var sshPublicKeys: [TransferClientTypes.SshPublicKey]?
...
extension TransferClientTypes {
    ...
    public struct EndpointDetails: Swift.Equatable {
        ...
        var addressAllocationIds: [Swift.String]?
        ...
        var vpcEndpointId: Swift.String?
...
extension TransferClientTypes {
    ...
    public struct ExecutionError: Swift.Equatable {
        ...
        /// This member is required.
        var type: TransferClientTypes.ExecutionErrorType?
...
extension TransferClientTypes {
    ...
    public struct ExecutionResults: Swift.Equatable {
        /// Specifies the steps (actions) to take if errors are encountered during execution of the workflow.
        var onExceptionSteps: [TransferClientTypes.ExecutionStepResult]?
        /// Specifies the details for the steps that are in the specified workflow.
        var steps: [TransferClientTypes.ExecutionStepResult]?
...
extension TransferClientTypes {
    ...
    public struct ExecutionStepResult: Swift.Equatable {
        ...
        var error: TransferClientTypes.ExecutionError?
        /// The values for the key/value pair applied as a tag to the file. Only applicable if the step type is TAG.
        var outputs: Swift.String?
        ...
        ///
        /// * Tag: add a tag to the file
        var stepType: TransferClientTypes.WorkflowStepType?
...
extension TransferClientTypes {
    ...
    public struct FileLocation: Swift.Equatable {
        ...
        var efsFileLocation: TransferClientTypes.EfsFileLocation?
        /// Specifies the S3 details for the file being used, such as bucket, Etag, and so forth.
        var s3FileLocation: TransferClientTypes.S3FileLocation?
...
extension TransferClientTypes {
    ...
    public struct IdentityProviderDetails: Swift.Equatable {
        ...
        var directoryId: Swift.String?
        /// The ARN for a lambda function to use for the Identity provider.
        var function: Swift.String?
        /// Provides the type of InvocationRole used to authenticate the user account.
        var invocationRole: Swift.String?
...
extension TransferClientTypes {
    ...
    public struct InputFileLocation: Swift.Equatable {
        ...
        var s3FileLocation: TransferClientTypes.S3InputFileLocation?
...
public struct ListAccessesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var accesses: [TransferClientTypes.ListedAccess]?
    /// When you can get additional results from the ListAccesses call, a NextToken parameter is returned in the output. You can then pass in a subsequent command to the NextToken parameter to continue listing additional accesses.
    var nextToken: Swift.String?
    /// A system-assigned unique identifier for a server that has users assigned to it.
    /// This member is required.
...
public struct ListExecutionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var executions: [TransferClientTypes.ListedExecution]?
...
public struct ListSecurityPoliciesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var securityPolicyNames: [Swift.String]?
...
public struct ListServersOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var servers: [TransferClientTypes.ListedServer]?
...
public struct ListUsersOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var users: [TransferClientTypes.ListedUser]?
...
public struct ListWorkflowsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var workflows: [TransferClientTypes.ListedWorkflow]?
...
extension TransferClientTypes {
    ...
    public struct ListedUser: Swift.Equatable {
        ...
        var sshPublicKeyCount: Swift.Int?
...
public struct SendWorkflowStepStateInput: Swift.Equatable {
    ...
    /// This member is required.
    var status: TransferClientTypes.CustomStepStatus?
...
extension TransferClientTypes {
    ...
    public struct ServiceMetadata: Swift.Equatable {
        ...
        /// This member is required.
        var userDetails: TransferClientTypes.UserDetails?
...
extension TransferClientTypes {
    ...
    public struct SshPublicKey: Swift.Equatable {
        ...
        /// This member is required.
        var dateImported: ClientRuntime.Date?
...
extension TransferClientTypes {
    ...
    public struct TagStepDetails: Swift.Equatable {
        ...
        var tags: [TransferClientTypes.S3Tag]?
...
public struct TestIdentityProviderInput: Swift.Equatable {
    ...
    var serverProtocol: TransferClientTypes.ModelProtocol?
...
extension TransferClientTypes {
    ...
    public struct WorkflowDetails: Swift.Equatable {
        ...
        /// This member is required.
        var onUpload: [TransferClientTypes.WorkflowDetail]?
...
extension TransferClientTypes {
    ...
    public struct WorkflowStep: Swift.Equatable {
        ...
        ///
        /// * Tag: add a tag to the file
        var type: TransferClientTypes.WorkflowStepType?
