...
public struct CreateUserInput: Swift.Equatable {
    ...
    ///
    ///
    ///             For an example of a scope-down policy, see <a href="https://docs.aws.amazon.com/transfer/latest/userguide/scope-down-policy.html">Example scope-down
    ///         policy.
    ///
    ///
    ///
...
extension TransferClientTypes {
    ...
    public struct ProtocolDetails: Swift.Equatable {
        ...
        public let passiveIp: Swift.String?
...
extension UpdateServerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateServerInput(certificate: \(Swift.String(describing: certificate)), endpointDetails: \(Swift.String(describing: endpointDetails)), endpointType: \(Swift.String(describing: endpointType)), hostKey: \(Swift.String(describing: hostKey)), identityProviderDetails: \(Swift.String(describing: identityProviderDetails)), loggingRole: \(Swift.String(describing: loggingRole)), protocolDetails: \(Swift.String(describing: protocolDetails)), protocols: \(Swift.String(describing: protocols)), securityPolicyName: \(Swift.String(describing: securityPolicyName)), serverId: \(Swift.String(describing: serverId)))"}
}
...
public struct UpdateUserInput: Swift.Equatable {
    ...
    ///
    ///
    ///             For an example of a scope-down policy, see <a href="https://docs.aws.amazon.com/transfer/latest/userguide/users.html#users-policies-scope-down">Creating a scope-down
    ///           policy.
    ///
    ///
    ///
