...
public class WorkMailClient {
    ...
    public class WorkMailClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("WorkMailClient")
...
public struct WorkMailClientLogHandlerFactory: SDKLogHandlerFactory {
