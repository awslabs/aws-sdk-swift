...
public protocol WorkMailClientProtocol {
    ...
    func associateDelegateToResource(input: AssociateDelegateToResourceInput, completion: @escaping (SdkResult<AssociateDelegateToResourceOutput, AssociateDelegateToResourceOutputError>) -> Void)
    /// <p>Adds a member (user or group) to the group's set.</p>
    func associateMemberToGroup(input: AssociateMemberToGroupInput, completion: @escaping (SdkResult<AssociateMemberToGroupOutput, AssociateMemberToGroupOutputError>) -> Void)
    /// <p>Cancels a mailbox export job.</p>
    ///          <note>
    ///             <p>If the mailbox export job is near completion, it might not be possible to cancel
    ///             it.</p>
    ///          </note>
    func cancelMailboxExportJob(input: CancelMailboxExportJobInput, completion: @escaping (SdkResult<CancelMailboxExportJobOutput, CancelMailboxExportJobOutputError>) -> Void)
    ...
    func createMobileDeviceAccessRule(input: CreateMobileDeviceAccessRuleInput, completion: @escaping (SdkResult<CreateMobileDeviceAccessRuleOutput, CreateMobileDeviceAccessRuleOutputError>) -> Void)
    ...
    func createResource(input: CreateResourceInput, completion: @escaping (SdkResult<CreateResourceOutput, CreateResourceOutputError>) -> Void)
    ...
    func deleteAccessControlRule(input: DeleteAccessControlRuleInput, completion: @escaping (SdkResult<DeleteAccessControlRuleOutput, DeleteAccessControlRuleOutputError>) -> Void)
    ...
    func deleteMailboxPermissions(input: DeleteMailboxPermissionsInput, completion: @escaping (SdkResult<DeleteMailboxPermissionsOutput, DeleteMailboxPermissionsOutputError>) -> Void)
    /// <p>Deletes a mobile device access rule for the specified Amazon WorkMail organization.</p>
    func deleteMobileDeviceAccessRule(input: DeleteMobileDeviceAccessRuleInput, completion: @escaping (SdkResult<DeleteMobileDeviceAccessRuleOutput, DeleteMobileDeviceAccessRuleOutputError>) -> Void)
    ...
    func deleteResource(input: DeleteResourceInput, completion: @escaping (SdkResult<DeleteResourceOutput, DeleteResourceOutputError>) -> Void)
    ...
    ///             <i>Disable</i>.</p>
    func deregisterFromWorkMail(input: DeregisterFromWorkMailInput, completion: @escaping (SdkResult<DeregisterFromWorkMailOutput, DeregisterFromWorkMailOutputError>) -> Void)
    ...
    func describeMailboxExportJob(input: DescribeMailboxExportJobInput, completion: @escaping (SdkResult<DescribeMailboxExportJobOutput, DescribeMailboxExportJobOutputError>) -> Void)
    ...
    func disassociateDelegateFromResource(input: DisassociateDelegateFromResourceInput, completion: @escaping (SdkResult<DisassociateDelegateFromResourceOutput, DisassociateDelegateFromResourceOutputError>) -> Void)
    /// <p>Removes a member from a group.</p>
    func disassociateMemberFromGroup(input: DisassociateMemberFromGroupInput, completion: @escaping (SdkResult<DisassociateMemberFromGroupOutput, DisassociateMemberFromGroupOutputError>) -> Void)
    ...
    func getAccessControlEffect(input: GetAccessControlEffectInput, completion: @escaping (SdkResult<GetAccessControlEffectOutput, GetAccessControlEffectOutputError>) -> Void)
    /// <p>Gets the default retention policy details for the specified organization.</p>
    func getDefaultRetentionPolicy(input: GetDefaultRetentionPolicyInput, completion: @escaping (SdkResult<GetDefaultRetentionPolicyOutput, GetDefaultRetentionPolicyOutputError>) -> Void)
    /// <p>Requests a user's mailbox details for a specified organization and user.</p>
    func getMailboxDetails(input: GetMailboxDetailsInput, completion: @escaping (SdkResult<GetMailboxDetailsOutput, GetMailboxDetailsOutputError>) -> Void)
    ...
    func getMobileDeviceAccessEffect(input: GetMobileDeviceAccessEffectInput, completion: @escaping (SdkResult<GetMobileDeviceAccessEffectOutput, GetMobileDeviceAccessEffectOutputError>) -> Void)
    /// <p>Lists the access control rules for the specified organization.</p>
    func listAccessControlRules(input: ListAccessControlRulesInput, completion: @escaping (SdkResult<ListAccessControlRulesOutput, ListAccessControlRulesOutputError>) -> Void)
    ...
    ///          group.</p>
    func listGroupMembers(input: ListGroupMembersInput, completion: @escaping (SdkResult<ListGroupMembersOutput, ListGroupMembersOutputError>) -> Void)
    ...
    ///          seven days.</p>
    func listMailboxExportJobs(input: ListMailboxExportJobsInput, completion: @escaping (SdkResult<ListMailboxExportJobsOutput, ListMailboxExportJobsOutputError>) -> Void)
    /// <p>Lists the mailbox permissions associated with a user, group, or resource
    ///          mailbox.</p>
    func listMailboxPermissions(input: ListMailboxPermissionsInput, completion: @escaping (SdkResult<ListMailboxPermissionsOutput, ListMailboxPermissionsOutputError>) -> Void)
    /// <p>Lists the mobile device access rules for the specified Amazon WorkMail organization.</p>
    func listMobileDeviceAccessRules(input: ListMobileDeviceAccessRulesInput, completion: @escaping (SdkResult<ListMobileDeviceAccessRulesOutput, ListMobileDeviceAccessRulesOutputError>) -> Void)
    /// <p>Returns summaries of the customer's organizations.</p>
    func listOrganizations(input: ListOrganizationsInput, completion: @escaping (SdkResult<ListOrganizationsOutput, ListOrganizationsOutputError>) -> Void)
    ...
    func listResourceDelegates(input: ListResourceDelegatesInput, completion: @escaping (SdkResult<ListResourceDelegatesOutput, ListResourceDelegatesOutputError>) -> Void)
    ...
    ///          the older rule.</p>
    func putAccessControlRule(input: PutAccessControlRuleInput, completion: @escaping (SdkResult<PutAccessControlRuleOutput, PutAccessControlRuleOutputError>) -> Void)
    /// <p>Sets permissions for a user, group, or resource. This replaces any pre-existing
    ///          permissions.</p>
    func putMailboxPermissions(input: PutMailboxPermissionsInput, completion: @escaping (SdkResult<PutMailboxPermissionsOutput, PutMailboxPermissionsOutputError>) -> Void)
    ...
    func registerToWorkMail(input: RegisterToWorkMailInput, completion: @escaping (SdkResult<RegisterToWorkMailOutput, RegisterToWorkMailOutputError>) -> Void)
    /// <p>Allows the administrator to reset the password for a user.</p>
    func resetPassword(input: ResetPasswordInput, completion: @escaping (SdkResult<ResetPasswordOutput, ResetPasswordOutputError>) -> Void)
    ...
    func startMailboxExportJob(input: StartMailboxExportJobInput, completion: @escaping (SdkResult<StartMailboxExportJobOutput, StartMailboxExportJobOutputError>) -> Void)
    ...
    ///          user.</p>
    func updateMailboxQuota(input: UpdateMailboxQuotaInput, completion: @escaping (SdkResult<UpdateMailboxQuotaOutput, UpdateMailboxQuotaOutputError>) -> Void)
    /// <p>Updates a mobile device access rule for the specified Amazon WorkMail organization.</p>
    func updateMobileDeviceAccessRule(input: UpdateMobileDeviceAccessRuleInput, completion: @escaping (SdkResult<UpdateMobileDeviceAccessRuleOutput, UpdateMobileDeviceAccessRuleOutputError>) -> Void)
    ...
    func updatePrimaryEmailAddress(input: UpdatePrimaryEmailAddressInput, completion: @escaping (SdkResult<UpdatePrimaryEmailAddressOutput, UpdatePrimaryEmailAddressOutputError>) -> Void)
