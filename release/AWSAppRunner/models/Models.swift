...
public struct AssociateCustomDomainInput: Swift.Equatable {
    ...
    var enableWWWSubdomain: Swift.Bool?
    /// The Amazon Resource Name (ARN) of the App Runner service that you want to associate a custom domain name with.
    /// This member is required.
    var serviceArn: Swift.String?
...
public struct AssociateCustomDomainOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var customDomain: AppRunnerClientTypes.CustomDomain?
    /// The App Runner subdomain of the App Runner service. The custom domain name is mapped to this target name.
    /// This member is required.
    var dNSTarget: Swift.String?
...
extension AppRunnerClientTypes {
    ...
    public struct AuthenticationConfiguration: Swift.Equatable {
        ...
        var accessRoleArn: Swift.String?
...
extension AppRunnerClientTypes {
    ...
    public struct AutoScalingConfiguration: Swift.Equatable {
        ...
        var autoScalingConfigurationArn: Swift.String?
        /// The customer-provided auto scaling configuration name. It can be used in multiple revisions of a configuration.
        var autoScalingConfigurationName: Swift.String?
        /// The revision of this auto scaling configuration. It's unique among all the active configurations ("Status": "ACTIVE") that share the same AutoScalingConfigurationName.
        var autoScalingConfigurationRevision: Swift.Int
        /// The time when the auto scaling configuration was created. It's in Unix time stamp format.
        var createdAt: ClientRuntime.Date?
        /// The time when the auto scaling configuration was deleted. It's in Unix time stamp format.
        var deletedAt: ClientRuntime.Date?
        ...
        var status: AppRunnerClientTypes.AutoScalingConfigurationStatus?
...
extension AppRunnerClientTypes {
    ...
    public struct CertificateValidationRecord: Swift.Equatable {
        ...
        var status: AppRunnerClientTypes.CertificateValidationRecordStatus?
...
extension AppRunnerClientTypes {
    ...
    public struct CodeConfiguration: Swift.Equatable {
        ...
        var codeConfigurationValues: AppRunnerClientTypes.CodeConfigurationValues?
        ...
        /// This member is required.
        var configurationSource: AppRunnerClientTypes.ConfigurationSource?
...
extension AppRunnerClientTypes {
    ...
    public struct CodeConfigurationValues: Swift.Equatable {
        ...
        var runtimeEnvironmentVariables: [Swift.String:Swift.String]?
        /// The command App Runner runs to start your application.
        var startCommand: Swift.String?
...
extension AppRunnerClientTypes {
    ...
    public struct CodeRepository: Swift.Equatable {
        ...
        var codeConfiguration: AppRunnerClientTypes.CodeConfiguration?
        /// The location of the repository that contains the source code.
        /// This member is required.
        var repositoryUrl: Swift.String?
        /// The version that should be used within the source code repository.
        /// This member is required.
        var sourceCodeVersion: AppRunnerClientTypes.SourceCodeVersion?
...
extension AppRunnerClientTypes {
    ...
    public struct Connection: Swift.Equatable {
        ...
        var providerType: AppRunnerClientTypes.ProviderType?
        ...
        var status: AppRunnerClientTypes.ConnectionStatus?
...
public struct CreateAutoScalingConfigurationInput: Swift.Equatable {
    ...
    var tags: [AppRunnerClientTypes.Tag]?
...
public struct CreateAutoScalingConfigurationOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var autoScalingConfiguration: AppRunnerClientTypes.AutoScalingConfiguration?
...
public struct CreateConnectionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var connection: AppRunnerClientTypes.Connection?
...
public struct CreateServiceInput: Swift.Equatable {
    ...
    var encryptionConfiguration: AppRunnerClientTypes.EncryptionConfiguration?
    /// The settings for the health check that App Runner performs to monitor the health of your service.
    var healthCheckConfiguration: AppRunnerClientTypes.HealthCheckConfiguration?
    /// The runtime configuration of instances (scaling units) of the App Runner service.
    var instanceConfiguration: AppRunnerClientTypes.InstanceConfiguration?
    ...
    /// This member is required.
    var sourceConfiguration: AppRunnerClientTypes.SourceConfiguration?
...
public struct CreateServiceOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var service: AppRunnerClientTypes.Service?
...
extension AppRunnerClientTypes {
    ...
    public struct CustomDomain: Swift.Equatable {
        ...
        var certificateValidationRecords: [AppRunnerClientTypes.CertificateValidationRecord]?
        ...
        /// This member is required.
        var status: AppRunnerClientTypes.CustomDomainAssociationStatus?
...
public struct DescribeCustomDomainsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var customDomains: [AppRunnerClientTypes.CustomDomain]?
...
extension AppRunnerClientTypes {
    ...
    public struct HealthCheckConfiguration: Swift.Equatable {
        ...
        var unhealthyThreshold: Swift.Int?
...
extension AppRunnerClientTypes {
    ...
    public struct ImageRepository: Swift.Equatable {
        ...
        var imageConfiguration: AppRunnerClientTypes.ImageConfiguration?
        ...
        /// This member is required.
        var imageIdentifier: Swift.String?
        /// The type of the image repository. This reflects the repository provider and whether the repository is private or public.
        /// This member is required.
        var imageRepositoryType: AppRunnerClientTypes.ImageRepositoryType?
...
public struct ListAutoScalingConfigurationsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var autoScalingConfigurationSummaryList: [AppRunnerClientTypes.AutoScalingConfigurationSummary]?
    /// The token that you can pass in a subsequent request to get the next result page. It's returned in a paginated request.
    var nextToken: Swift.String?
...
public struct ListConnectionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var connectionSummaryList: [AppRunnerClientTypes.ConnectionSummary]?
...
public struct ListOperationsOutputResponse: Swift.Equatable {
    ...
    var operationSummaryList: [AppRunnerClientTypes.OperationSummary]?
...
public struct ListServicesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var serviceSummaryList: [AppRunnerClientTypes.ServiceSummary]?
...
extension AppRunnerClientTypes {
    ...
    public struct OperationSummary: Swift.Equatable {
        ...
        var status: AppRunnerClientTypes.OperationStatus?
        /// The Amazon Resource Name (ARN) of the resource that the operation acted on (for example, an App Runner service).
        var targetArn: Swift.String?
        /// The type of operation. It indicates a specific action that occured.
        var type: AppRunnerClientTypes.OperationType?
...
extension AppRunnerClientTypes {
    ...
    public struct Service: Swift.Equatable {
        ...
        /// This member is required.
        var autoScalingConfigurationSummary: AppRunnerClientTypes.AutoScalingConfigurationSummary?
        ...
        /// This member is required.
        var serviceId: Swift.String?
        /// The customer-provided service name.
        /// This member is required.
        var serviceName: Swift.String?
        /// A subdomain URL that App Runner generated for this service. You can use this URL to access your service web application.
        /// This member is required.
        var serviceUrl: Swift.String?
        ...
        /// This member is required.
        var status: AppRunnerClientTypes.ServiceStatus?
...
extension AppRunnerClientTypes {
    ...
    public struct SourceCodeVersion: Swift.Equatable {
        ...
        /// This member is required.
        var type: AppRunnerClientTypes.SourceCodeVersionType?
...
extension AppRunnerClientTypes {
    ...
    public struct SourceConfiguration: Swift.Equatable {
        ...
        var authenticationConfiguration: AppRunnerClientTypes.AuthenticationConfiguration?
