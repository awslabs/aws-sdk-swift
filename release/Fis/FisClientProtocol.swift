...
public protocol FisClientProtocol {
    ...
    func createExperimentTemplate(input: CreateExperimentTemplateInput, completion: @escaping (SdkResult<CreateExperimentTemplateOutput, CreateExperimentTemplateOutputError>) -> Void)
    /// <p>Deletes the specified experiment template.</p>
    func deleteExperimentTemplate(input: DeleteExperimentTemplateInput, completion: @escaping (SdkResult<DeleteExperimentTemplateOutput, DeleteExperimentTemplateOutputError>) -> Void)
    /// <p>Gets information about the specified AWS FIS action.</p>
    func getAction(input: GetActionInput, completion: @escaping (SdkResult<GetActionOutput, GetActionOutputError>) -> Void)
    /// <p>Gets information about the specified experiment.</p>
    func getExperiment(input: GetExperimentInput, completion: @escaping (SdkResult<GetExperimentOutput, GetExperimentOutputError>) -> Void)
    /// <p>Gets information about the specified experiment template.</p>
    func getExperimentTemplate(input: GetExperimentTemplateInput, completion: @escaping (SdkResult<GetExperimentTemplateOutput, GetExperimentTemplateOutputError>) -> Void)
    /// <p>Lists the available AWS FIS actions.</p>
    func listActions(input: ListActionsInput, completion: @escaping (SdkResult<ListActionsOutput, ListActionsOutputError>) -> Void)
    /// <p>Lists your experiments.</p>
    func listExperiments(input: ListExperimentsInput, completion: @escaping (SdkResult<ListExperimentsOutput, ListExperimentsOutputError>) -> Void)
    /// <p>Lists your experiment templates.</p>
    func listExperimentTemplates(input: ListExperimentTemplatesInput, completion: @escaping (SdkResult<ListExperimentTemplatesOutput, ListExperimentTemplatesOutputError>) -> Void)
    ...
    func startExperiment(input: StartExperimentInput, completion: @escaping (SdkResult<StartExperimentOutput, StartExperimentOutputError>) -> Void)
    /// <p>Stops the specified experiment.</p>
    func stopExperiment(input: StopExperimentInput, completion: @escaping (SdkResult<StopExperimentOutput, StopExperimentOutputError>) -> Void)
    ...
    func updateExperimentTemplate(input: UpdateExperimentTemplateInput, completion: @escaping (SdkResult<UpdateExperimentTemplateOutput, UpdateExperimentTemplateOutputError>) -> Void)
}
