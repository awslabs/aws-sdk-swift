...
public struct ChangeServerLifeCycleStateInput: Swift.Equatable {
    ...
    var lifeCycle: MgnClientTypes.ChangeServerLifeCycleStateSourceServerLifecycle?
...
public struct ChangeServerLifeCycleStateOutputResponse: Swift.Equatable {
    ...
    var dataReplicationInfo: MgnClientTypes.DataReplicationInfo?
    /// Source server archived status.
    var isArchived: Swift.Bool?
    /// Source server launched instance.
    var launchedInstance: MgnClientTypes.LaunchedInstance?
    /// Source server lifecycle state.
    var lifeCycle: MgnClientTypes.LifeCycle?
    /// Source server replication type.
    var replicationType: MgnClientTypes.ReplicationType?
    /// Source server properties.
    var sourceProperties: MgnClientTypes.SourceProperties?
    /// Source server ID.
    var sourceServerID: Swift.String?
    /// Source server Tags.
    var tags: [Swift.String:Swift.String]?
    /// Source server vCenter client id.
    var vcenterClientID: Swift.String?
...
extension MgnClientTypes {
    ...
    public struct ChangeServerLifeCycleStateSourceServerLifecycle: Swift.Equatable {
        /// The request to change the source server migration lifecycle state.
        /// This member is required.
        var state: MgnClientTypes.ChangeServerLifeCycleStateSourceServerLifecycleState?
...
public struct CreateReplicationConfigurationTemplateInput: Swift.Equatable {
    ...
    /// This member is required.
    var dataPlaneRouting: MgnClientTypes.ReplicationConfigurationDataPlaneRouting?
    /// Request to configure the Staging Disk EBS volume type to "gp2" during Replication Settings template creation.
    /// This member is required.
    var defaultLargeStagingDiskType: MgnClientTypes.ReplicationConfigurationDefaultLargeStagingDiskType?
    /// Request to configure EBS enryption during Replication Settings template creation.
    /// This member is required.
    var ebsEncryption: MgnClientTypes.ReplicationConfigurationEbsEncryption?
...
extension MgnClientTypes {
    ...
    public struct DataReplicationError: Swift.Equatable {
        /// Error in data replication.
        var error: MgnClientTypes.DataReplicationErrorString?
        /// Error in data replication.
...
extension MgnClientTypes {
    ...
    public struct DataReplicationInfo: Swift.Equatable {
        ...
        var dataReplicationError: MgnClientTypes.DataReplicationError?
        /// Request to query whether data replication has been initiated.
        var dataReplicationInitiation: MgnClientTypes.DataReplicationInitiation?
        /// Request to query the data replication state.
        var dataReplicationState: MgnClientTypes.DataReplicationState?
        ...
        var lastSnapshotDateTime: Swift.String?
        /// Request to query disks replicated.
        var replicatedDisks: [MgnClientTypes.DataReplicationInfoReplicatedDisk]?
...
extension MgnClientTypes {
    ...
    public struct DataReplicationInitiation: Swift.Equatable {
        ...
        var steps: [MgnClientTypes.DataReplicationInitiationStep]?
...
extension MgnClientTypes {
    ...
    public struct DataReplicationInitiationStep: Swift.Equatable {
        ...
        var name: MgnClientTypes.DataReplicationInitiationStepName?
        /// Request to query data initiation status.
        var status: MgnClientTypes.DataReplicationInitiationStepStatus?
...
public struct DescribeJobLogItemsOutputResponse: Swift.Equatable {
    ...
    var items: [MgnClientTypes.JobLog]?
...
public struct DescribeJobsInput: Swift.Equatable {
    ...
    /// This member is required.
    var filters: MgnClientTypes.DescribeJobsRequestFilters?
...
public struct DescribeReplicationConfigurationTemplatesOutputResponse: Swift.Equatable {
    ...
    var items: [MgnClientTypes.ReplicationConfigurationTemplate]?
    /// Request to describe Replication Configuration template by next token.
    var nextToken: Swift.String?
...
public struct DescribeSourceServersInput: Swift.Equatable {
    ...
    /// This member is required.
    var filters: MgnClientTypes.DescribeSourceServersRequestFilters?
...
public struct DescribeSourceServersOutputResponse: Swift.Equatable {
    ...
    var items: [MgnClientTypes.SourceServer]?
...
extension MgnClientTypes {
    ...
    public struct DescribeSourceServersRequestFilters: Swift.Equatable {
        ...
        var lifeCycleStates: [MgnClientTypes.LifeCycleState]?
        /// Request to filter Source Servers list by replication type.
        var replicationTypes: [MgnClientTypes.ReplicationType]?
...
public struct DescribeVcenterClientsOutputResponse: Swift.Equatable {
    ...
    var items: [MgnClientTypes.VcenterClient]?
...
public struct GetLaunchConfigurationOutputResponse: Swift.Equatable {
    ...
    var launchDisposition: MgnClientTypes.LaunchDisposition?
    /// Configure launch configuration OS licensing.
    var licensing: MgnClientTypes.Licensing?
    ...
    var targetInstanceTypeRightSizingMethod: MgnClientTypes.TargetInstanceTypeRightSizingMethod?
...
public struct GetReplicationConfigurationOutputResponse: Swift.Equatable {
    ...
    var replicatedDisks: [MgnClientTypes.ReplicationConfigurationReplicatedDisk]?
...
extension MgnClientTypes {
    ...
    public struct Job: Swift.Equatable {
        ...
        var initiatedBy: MgnClientTypes.InitiatedBy?
        /// Job ID.
        /// This member is required.
        var jobID: Swift.String?
        /// Servers participating in a specific Job.
        var participatingServers: [MgnClientTypes.ParticipatingServer]?
        /// Job status.
        var status: MgnClientTypes.JobStatus?
        /// Tags associated with spcific Job.
        var tags: [Swift.String:Swift.String]?
        /// Job type.
        var type: MgnClientTypes.JobType?
...
extension MgnClientTypes {
    ...
    public struct JobLog: Swift.Equatable {
        /// Job log event.
        var event: MgnClientTypes.JobLogEvent?
        /// Job event data
        var eventData: MgnClientTypes.JobLogEventData?
...
extension MgnClientTypes {
    ...
    public struct LaunchedInstance: Swift.Equatable {
        ...
        var firstBoot: MgnClientTypes.FirstBoot?
...
extension MgnClientTypes {
    ...
    public struct LifeCycle: Swift.Equatable {
        ...
        var lastCutover: MgnClientTypes.LifeCycleLastCutover?
        /// Lifecycle last seen date and time.
        var lastSeenByServiceDateTime: Swift.String?
        /// Lifecycle last Test.
        var lastTest: MgnClientTypes.LifeCycleLastTest?
        /// Lifecycle state.
        var state: MgnClientTypes.LifeCycleState?
...
extension MgnClientTypes {
    ...
    public struct LifeCycleLastCutover: Swift.Equatable {
        ...
        var finalized: MgnClientTypes.LifeCycleLastCutoverFinalized?
        /// Lifecycle last Cutover initiated.
        var initiated: MgnClientTypes.LifeCycleLastCutoverInitiated?
        /// Lifecycle last Cutover reverted.
        var reverted: MgnClientTypes.LifeCycleLastCutoverReverted?
...
extension MgnClientTypes {
    ...
    public struct LifeCycleLastTest: Swift.Equatable {
        ...
        var finalized: MgnClientTypes.LifeCycleLastTestFinalized?
        /// Lifecycle last Test initiated.
        var initiated: MgnClientTypes.LifeCycleLastTestInitiated?
        /// Lifecycle last Test reverted.
        var reverted: MgnClientTypes.LifeCycleLastTestReverted?
...
extension MgnClientTypes {
    ...
    public struct ParticipatingServer: Swift.Equatable {
        ...
        var launchStatus: MgnClientTypes.LaunchStatus?
...
extension MgnClientTypes {
    ...
    public struct ReplicationConfigurationReplicatedDisk: Swift.Equatable {
        ...
        var stagingDiskType: MgnClientTypes.ReplicationConfigurationReplicatedDiskStagingDiskType?
...
extension MgnClientTypes {
    ...
    public struct SourceProperties: Swift.Equatable {
        /// Source Server CPUs.
        var cpus: [MgnClientTypes.CPU]?
        /// Source Server disks.
        var disks: [MgnClientTypes.Disk]?
        /// Source server identification hints.
        var identificationHints: MgnClientTypes.IdentificationHints?
        /// Source server last update date and time.
        var lastUpdatedDateTime: Swift.String?
        /// Source server network interfaces.
        var networkInterfaces: [MgnClientTypes.NetworkInterface]?
        /// Source server OS.
        var os: MgnClientTypes.OS?
...
extension MgnClientTypes {
    ...
    public struct VcenterClient: Swift.Equatable {
        ...
        var datacenterName: Swift.String?
        /// Hostname of vCenter client .
        var hostname: Swift.String?
        /// Last seen time of vCenter client.
        var lastSeenDatetime: Swift.String?
        /// Tags for Source Server of vCenter client.
        var sourceServerTags: [Swift.String:Swift.String]?
        /// Tags for vCenter client.
        var tags: [Swift.String:Swift.String]?
        /// ID of vCenter client.
        var vcenterClientID: Swift.String?
        /// Vcenter UUID of vCenter client.
        var vcenterUUID: Swift.String?
