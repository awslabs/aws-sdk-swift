...
public struct ChangeServerLifeCycleStateInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ChangeServerLifeCycleStateInputURLHostMiddleware"
    ...
    public typealias MInput = ChangeServerLifeCycleStateInput
    public typealias MOutput = ClientRuntime.OperationOutput<ChangeServerLifeCycleStateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ChangeServerLifeCycleStateOutputError>
}

public struct ChangeServerLifeCycleStateInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ChangeServerLifeCycleStateInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/ChangeServerLifeCycleState"
...
extension ChangeServerLifeCycleStateOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ChangeServerLifeCycleStateOutputResponse(arn: \(Swift.String(describing: arn)), dataReplicationInfo: \(Swift.String(describing: dataReplicationInfo)), isArchived: \(Swift.String(describing: isArchived)), launchedInstance: \(Swift.String(describing: launchedInstance)), lifeCycle: \(Swift.String(describing: lifeCycle)), replicationType: \(Swift.String(describing: replicationType)), sourceProperties: \(Swift.String(describing: sourceProperties)), sourceServerID: \(Swift.String(describing: sourceServerID)), tags: \(Swift.String(describing: tags)), vcenterClientID: \(Swift.String(describing: vcenterClientID)))"}
}
...
struct ChangeServerLifeCycleStateOutputResponseBody: Swift.Equatable {
    ...
    public let replicationType: MgnClientTypes.ReplicationType?
    public let vcenterClientID: Swift.String?
}
...
public struct DeleteVcenterClientInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVcenterClientInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteVcenterClientInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteVcenterClientOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteVcenterClientInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteVcenterClientOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteVcenterClientOutputError>
}

extension DeleteVcenterClientInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteVcenterClientInput(vcenterClientID: \(Swift.String(describing: vcenterClientID)))"}
}

extension DeleteVcenterClientInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case vcenterClientID
    }
...
public struct DeleteVcenterClientInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVcenterClientInputHeadersMiddleware"
...
public struct DeleteVcenterClientInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVcenterClientInputQueryItemMiddleware"
...
public struct DeleteVcenterClientInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVcenterClientInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteVcenterClientInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteVcenterClientOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteVcenterClientOutputError>
}

public struct DeleteVcenterClientInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteVcenterClientInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/DeleteVcenterClient"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DeleteVcenterClientOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteVcenterClientOutputResponse()"}
}
...
struct DeleteVcenterClientOutputResponseBody: Swift.Equatable {
}

extension DeleteVcenterClientOutputResponseBody: Swift.Decodable {
...
extension MgnClientTypes.DescribeSourceServersRequestFilters: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeSourceServersRequestFilters(isArchived: \(Swift.String(describing: isArchived)), lifeCycleStates: \(Swift.String(describing: lifeCycleStates)), replicationTypes: \(Swift.String(describing: replicationTypes)), sourceServerIDs: \(Swift.String(describing: sourceServerIDs)))"}
}
...
extension DescribeVcenterClientsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeVcenterClientsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeVcenterClientsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeVcenterClientsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeVcenterClientsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeVcenterClientsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeVcenterClientsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeVcenterClientsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeVcenterClientsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeVcenterClientsOutputError>
}

public struct DescribeVcenterClientsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeVcenterClientsInputQueryItemMiddleware"
...
public struct DescribeVcenterClientsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeVcenterClientsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeVcenterClientsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeVcenterClientsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeVcenterClientsOutputError>
}

public struct DescribeVcenterClientsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeVcenterClientsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/DescribeVcenterClients"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeVcenterClientsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeVcenterClientsOutputResponse(items: \(Swift.String(describing: items)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct DescribeVcenterClientsOutputResponseBody: Swift.Equatable {
    public let items: [MgnClientTypes.VcenterClient]?
    public let nextToken: Swift.String?
}
...
public struct DisconnectFromServiceInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisconnectFromServiceInputURLHostMiddleware"
    ...
    public typealias MInput = DisconnectFromServiceInput
    public typealias MOutput = ClientRuntime.OperationOutput<DisconnectFromServiceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisconnectFromServiceOutputError>
}

public struct DisconnectFromServiceInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisconnectFromServiceInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/DisconnectFromService"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct FinalizeCutoverInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "FinalizeCutoverInputURLHostMiddleware"
    ...
    public typealias MInput = FinalizeCutoverInput
    public typealias MOutput = ClientRuntime.OperationOutput<FinalizeCutoverOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<FinalizeCutoverOutputError>
}

public struct FinalizeCutoverInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "FinalizeCutoverInputURLPathMiddleware"
...
extension MgnClientTypes.IdentificationHints: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IdentificationHints(awsInstanceID: \(Swift.String(describing: awsInstanceID)), fqdn: \(Swift.String(describing: fqdn)), hostname: \(Swift.String(describing: hostname)), vmPath: \(Swift.String(describing: vmPath)), vmWareUuid: \(Swift.String(describing: vmWareUuid)))"}
}
...
public struct MarkAsArchivedInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MarkAsArchivedInputURLHostMiddleware"
    ...
    public typealias MInput = MarkAsArchivedInput
    public typealias MOutput = ClientRuntime.OperationOutput<MarkAsArchivedOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<MarkAsArchivedOutputError>
}

public struct MarkAsArchivedInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MarkAsArchivedInputURLPathMiddleware"
...
public struct StartCutoverInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartCutoverInputURLHostMiddleware"
    ...
    public typealias MInput = StartCutoverInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartCutoverOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartCutoverOutputError>
}

public struct StartCutoverInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartCutoverInputURLPathMiddleware"
...
public struct StartReplicationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartReplicationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartReplicationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartReplicationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartReplicationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartReplicationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartReplicationOutputError>
}

extension StartReplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartReplicationInput(sourceServerID: \(Swift.String(describing: sourceServerID)))"}
}

extension StartReplicationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case sourceServerID
    }
...
public struct StartReplicationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartReplicationInputHeadersMiddleware"
...
public struct StartReplicationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartReplicationInputQueryItemMiddleware"
...
public struct StartReplicationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartReplicationInputURLHostMiddleware"
    ...
    public typealias MInput = StartReplicationInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartReplicationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartReplicationOutputError>
}

public struct StartReplicationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartReplicationInputURLPathMiddleware"
...
public struct StartTestInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartTestInputURLHostMiddleware"
    ...
    public typealias MInput = StartTestInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartTestOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartTestOutputError>
}

public struct StartTestInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartTestInputURLPathMiddleware"
...
public struct TerminateTargetInstancesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateTargetInstancesInputURLHostMiddleware"
    ...
    public typealias MInput = TerminateTargetInstancesInput
    public typealias MOutput = ClientRuntime.OperationOutput<TerminateTargetInstancesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<TerminateTargetInstancesOutputError>
}

public struct TerminateTargetInstancesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateTargetInstancesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/TerminateTargetInstances"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdateSourceServerReplicationTypeInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSourceServerReplicationTypeInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateSourceServerReplicationTypeInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateSourceServerReplicationTypeOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateSourceServerReplicationTypeInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateSourceServerReplicationTypeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateSourceServerReplicationTypeOutputError>
}

extension UpdateSourceServerReplicationTypeInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateSourceServerReplicationTypeInput(replicationType: \(Swift.String(describing: replicationType)), sourceServerID: \(Swift.String(describing: sourceServerID)))"}
}

extension UpdateSourceServerReplicationTypeInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case replicationType
        case sourceServerID
    }
...
public struct UpdateSourceServerReplicationTypeInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSourceServerReplicationTypeInputHeadersMiddleware"
...
public struct UpdateSourceServerReplicationTypeInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSourceServerReplicationTypeInputQueryItemMiddleware"
...
public struct UpdateSourceServerReplicationTypeInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSourceServerReplicationTypeInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateSourceServerReplicationTypeInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateSourceServerReplicationTypeOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateSourceServerReplicationTypeOutputError>
}

public struct UpdateSourceServerReplicationTypeInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateSourceServerReplicationTypeInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/UpdateSourceServerReplicationType"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension MgnClientTypes.VcenterClient: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn
        case datacenterName
        case hostname
...
extension MgnClientTypes.VcenterClient: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "VcenterClient(arn: \(Swift.String(describing: arn)), datacenterName: \(Swift.String(describing: datacenterName)), hostname: \(Swift.String(describing: hostname)), lastSeenDatetime: \(Swift.String(describing: lastSeenDatetime)), sourceServerTags: \(Swift.String(describing: sourceServerTags)), tags: \(Swift.String(describing: tags)), vcenterClientID: \(Swift.String(describing: vcenterClientID)), vcenterUUID: \(Swift.String(describing: vcenterUUID)))"}
}
