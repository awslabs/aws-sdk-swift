...
public protocol MgnClientProtocol {
    ...
    func deleteVcenterClient(input: DeleteVcenterClientInput, completion: @escaping (ClientRuntime.SdkResult<DeleteVcenterClientOutputResponse, DeleteVcenterClientOutputError>) -> Void)
    ...
    func describeVcenterClients(input: DescribeVcenterClientsInput, completion: @escaping (ClientRuntime.SdkResult<DescribeVcenterClientsOutputResponse, DescribeVcenterClientsOutputError>) -> Void)
    ...
    func startReplication(input: StartReplicationInput, completion: @escaping (ClientRuntime.SdkResult<StartReplicationOutputResponse, StartReplicationOutputError>) -> Void)
    ...
    func updateSourceServerReplicationType(input: UpdateSourceServerReplicationTypeInput, completion: @escaping (ClientRuntime.SdkResult<UpdateSourceServerReplicationTypeOutputResponse, UpdateSourceServerReplicationTypeOutputError>) -> Void)
}
