...
public struct AssociateLicenseInput: Swift.Equatable {
    ...
    /// This member is required.
    var licenseType: GrafanaClientTypes.LicenseType?
...
public struct AssociateLicenseOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var workspace: GrafanaClientTypes.WorkspaceDescription?
...
extension GrafanaClientTypes {
    ...
    public struct AuthenticationDescription: Swift.Equatable {
        ...
        var awsSso: GrafanaClientTypes.AwsSsoAuthentication?
        ...
        /// This member is required.
        var providers: [GrafanaClientTypes.AuthenticationProviderTypes]?
        /// A structure containing information about how this workspace works with SAML, including what attributes within the assertion are to be mapped to user information in the workspace.
        var saml: GrafanaClientTypes.SamlAuthentication?
...
extension GrafanaClientTypes {
    ...
    public struct AuthenticationSummary: Swift.Equatable {
        ...
        var samlConfigurationStatus: GrafanaClientTypes.SamlConfigurationStatus?
...
public struct CreateWorkspaceInput: Swift.Equatable {
    ...
    /// This member is required.
    var accountAccessType: GrafanaClientTypes.AccountAccessType?
    ...
    /// This member is required.
    var authenticationProviders: [GrafanaClientTypes.AuthenticationProviderTypes]?
    /// A unique, case-sensitive, user-provided identifier to ensure the idempotency of the request.
    var clientToken: Swift.String?
    /// The name of an IAM role that already exists to use with Organizations to access Amazon Web Services data sources and notification channels in other accounts in an organization.
    var organizationRoleName: Swift.String?
    ...
    /// This member is required.
    var permissionType: GrafanaClientTypes.PermissionType?
    ...
    var workspaceDataSources: [GrafanaClientTypes.DataSourceType]?
    /// A description for the workspace. This is used only to help you identify this workspace.
    var workspaceDescription: Swift.String?
    /// The name for the workspace. It does not have to be unique.
    var workspaceName: Swift.String?
    /// Specify the Amazon Web Services notification channels that you plan to use in this workspace. Specifying these data sources here enables Amazon Managed Grafana to create IAM roles and permissions that allow Amazon Managed Grafana to use these channels.
    var workspaceNotificationDestinations: [GrafanaClientTypes.NotificationDestinationType]?
    /// Specifies the organizational units that this workspace is allowed to use data sources from, if this workspace is in an account that is part of an organization.
    var workspaceOrganizationalUnits: [Swift.String]?
    ...
    var workspaceRoleArn: Swift.String?
...
public struct DescribeWorkspaceAuthenticationOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var authentication: GrafanaClientTypes.AuthenticationDescription?
...
public struct ListPermissionsInput: Swift.Equatable {
    ...
    var userType: GrafanaClientTypes.UserType?
...
public struct ListPermissionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var permissions: [GrafanaClientTypes.PermissionEntry]?
...
public struct ListWorkspacesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var workspaces: [GrafanaClientTypes.WorkspaceSummary]?
...
extension GrafanaClientTypes {
    ...
    public struct PermissionEntry: Swift.Equatable {
        ...
        /// This member is required.
        var role: GrafanaClientTypes.Role?
        /// A structure with the ID of the user or group with this role.
        /// This member is required.
        var user: GrafanaClientTypes.User?
...
extension GrafanaClientTypes {
    ...
    public struct RoleValues: Swift.Equatable {
        ...
        var admin: [Swift.String]?
        /// A list of groups from the SAML assertion attribute to grant the Grafana Editor role to.
        var editor: [Swift.String]?
...
extension GrafanaClientTypes {
    ...
    public struct SamlAuthentication: Swift.Equatable {
        ...
        var configuration: GrafanaClientTypes.SamlConfiguration?
        /// Specifies whether the workspace's SAML configuration is complete.
        /// This member is required.
        var status: GrafanaClientTypes.SamlConfigurationStatus?
...
extension GrafanaClientTypes {
    ...
    public struct SamlConfiguration: Swift.Equatable {
        ...
        var allowedOrganizations: [Swift.String]?
        /// A structure that defines which attributes in the SAML assertion are to be used to define information about the users authenticated by that IdP to use the workspace.
        var assertionAttributes: GrafanaClientTypes.AssertionAttributes?
        /// A structure containing the identity provider (IdP) metadata used to integrate the identity provider with this workspace.
        /// This member is required.
        var idpMetadata: GrafanaClientTypes.IdpMetadata?
        /// How long a sign-on session by a SAML user is valid, before the user has to sign on again.
        var loginValidityDuration: Swift.Int
        /// A structure containing arrays that map group names in the SAML assertion to the Grafana Admin and Editor roles in the workspace.
        var roleValues: GrafanaClientTypes.RoleValues?
...
extension GrafanaClientTypes {
    ...
    public struct UpdateError: Swift.Equatable {
        ...
        /// This member is required.
        var causedBy: GrafanaClientTypes.UpdateInstruction?
        /// The error code.
        /// This member is required.
        var code: Swift.Int?
...
extension GrafanaClientTypes {
    ...
    public struct UpdateInstruction: Swift.Equatable {
        ...
        /// This member is required.
        var action: GrafanaClientTypes.UpdateAction?
        /// The role to add or revoke for the user or the group specified in users.
        /// This member is required.
        var role: GrafanaClientTypes.Role?
        /// A structure that specifies the user or group to add or revoke the role for.
        /// This member is required.
        var users: [GrafanaClientTypes.User]?
...
public struct UpdatePermissionsInput: Swift.Equatable {
    ...
    /// This member is required.
    var updateInstructionBatch: [GrafanaClientTypes.UpdateInstruction]?
...
public struct UpdatePermissionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var errors: [GrafanaClientTypes.UpdateError]?
...
public struct UpdateWorkspaceAuthenticationInput: Swift.Equatable {
    ...
    var samlConfiguration: GrafanaClientTypes.SamlConfiguration?
...
extension GrafanaClientTypes {
    ...
    public struct User: Swift.Equatable {
        ...
        /// This member is required.
        var type: GrafanaClientTypes.UserType?
...
extension GrafanaClientTypes {
    ...
    public struct WorkspaceDescription: Swift.Equatable {
        ...
        /// This member is required.
        var authentication: GrafanaClientTypes.AuthenticationSummary?
        /// The date that the workspace was created.
        /// This member is required.
        var created: ClientRuntime.Date?
        /// Specifies the Amazon Web Services data sources that have been configured to have IAM roles and permissions created to allow Amazon Managed Grafana to read data from these sources.
        /// This member is required.
        var dataSources: [GrafanaClientTypes.DataSourceType]?
        ...
        var freeTrialConsumed: Swift.Bool?
        /// If this workspace is currently in the free trial period for Grafana Enterprise, this value specifies when that free trial ends.
        var freeTrialExpiration: ClientRuntime.Date?
        /// The version of Grafana supported in this workspace.
        /// This member is required.
        var grafanaVersion: Swift.String?
        ...
        var licenseExpiration: ClientRuntime.Date?
        /// Specifies whether this workspace has a full Grafana Enterprise license or a free trial license.
        var licenseType: GrafanaClientTypes.LicenseType?
        /// The most recent date that the workspace was modified.
        /// This member is required.
        var modified: ClientRuntime.Date?
        /// The name of the workspace.
        var name: Swift.String?
        /// The Amazon Web Services notification channels that Amazon Managed Grafana can automatically create IAM roles and permissions for, to allow Amazon Managed Grafana to use these channels.
        var notificationDestinations: [GrafanaClientTypes.NotificationDestinationType]?
        /// The name of the IAM role that is used to access resources through Organizations.
        var organizationRoleName: Swift.String?
        /// Specifies the organizational units that this workspace is allowed to use data sources from, if this workspace is in an account that is part of an organization.
        var organizationalUnits: [Swift.String]?
        ...
        /// This member is required.
        var status: GrafanaClientTypes.WorkspaceStatus?
