...
extension GrafanaClientTypes.AssertionAttributes: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case email
        case groups
        case login
...
extension GrafanaClientTypes.AssertionAttributes: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssertionAttributes(email: \(Swift.String(describing: email)), groups: \(Swift.String(describing: groups)), login: \(Swift.String(describing: login)), name: \(Swift.String(describing: name)), org: \(Swift.String(describing: org)), role: \(Swift.String(describing: role)))"}
}
...
extension AssociateLicenseInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssociateLicenseInput(licenseType: \(Swift.String(describing: licenseType)), workspaceId: \(Swift.String(describing: workspaceId)))"}
}

extension AssociateLicenseInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct AssociateLicenseInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateLicenseInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<AssociateLicenseInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<AssociateLicenseOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<AssociateLicenseInput>
    public typealias MOutput = ClientRuntime.OperationOutput<AssociateLicenseOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AssociateLicenseOutputError>
}

public struct AssociateLicenseInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateLicenseInputQueryItemMiddleware"
...
public struct AssociateLicenseInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateLicenseInputURLHostMiddleware"
    ...
    public typealias MInput = AssociateLicenseInput
    public typealias MOutput = ClientRuntime.OperationOutput<AssociateLicenseOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AssociateLicenseOutputError>
}

public struct AssociateLicenseInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateLicenseInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        guard let licenseType = input.licenseType else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("licenseType is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/workspaces/\(workspaceId.urlPercentEncoding())/licenses/\(licenseType.rawValue.urlPercentEncoding())"
...
extension AssociateLicenseOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssociateLicenseOutputResponse(workspace: \(Swift.String(describing: workspace)))"}
}
...
struct AssociateLicenseOutputResponseBody: Swift.Equatable {
    public let workspace: GrafanaClientTypes.WorkspaceDescription?
}
...
extension GrafanaClientTypes.AuthenticationDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case awsSso
        case providers
        case saml
...
extension GrafanaClientTypes.AuthenticationDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AuthenticationDescription(awsSso: \(Swift.String(describing: awsSso)), providers: \(Swift.String(describing: providers)), saml: \(Swift.String(describing: saml)))"}
}
...
extension GrafanaClientTypes.AuthenticationSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case providers
...
extension GrafanaClientTypes.AuthenticationSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AuthenticationSummary(providers: \(Swift.String(describing: providers)), samlConfigurationStatus: \(Swift.String(describing: samlConfigurationStatus)))"}
}
...
extension GrafanaClientTypes.AwsSsoAuthentication: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case ssoClientId
    }
...
extension GrafanaClientTypes.AwsSsoAuthentication: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AwsSsoAuthentication(ssoClientId: \(Swift.String(describing: ssoClientId)))"}
}
...
extension CreateWorkspaceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateWorkspaceInput(accountAccessType: \(Swift.String(describing: accountAccessType)), authenticationProviders: \(Swift.String(describing: authenticationProviders)), clientToken: \(Swift.String(describing: clientToken)), organizationRoleName: \(Swift.String(describing: organizationRoleName)), permissionType: \(Swift.String(describing: permissionType)), stackSetName: \(Swift.String(describing: stackSetName)), workspaceDataSources: \(Swift.String(describing: workspaceDataSources)), workspaceDescription: \(Swift.String(describing: workspaceDescription)), workspaceName: \(Swift.String(describing: workspaceName)), workspaceNotificationDestinations: \(Swift.String(describing: workspaceNotificationDestinations)), workspaceOrganizationalUnits: \(Swift.String(describing: workspaceOrganizationalUnits)), workspaceRoleArn: \(Swift.String(describing: workspaceRoleArn)))"}
}
...
struct CreateWorkspaceInputBody: Swift.Equatable {
    public let accountAccessType: GrafanaClientTypes.AccountAccessType?
    public let clientToken: Swift.String?
    public let organizationRoleName: Swift.String?
    public let permissionType: GrafanaClientTypes.PermissionType?
    public let stackSetName: Swift.String?
    public let workspaceDataSources: [GrafanaClientTypes.DataSourceType]?
    public let workspaceDescription: Swift.String?
    public let workspaceName: Swift.String?
    public let workspaceNotificationDestinations: [GrafanaClientTypes.NotificationDestinationType]?
    public let workspaceOrganizationalUnits: [Swift.String]?
    public let workspaceRoleArn: Swift.String?
    public let authenticationProviders: [GrafanaClientTypes.AuthenticationProviderTypes]?
}
...
extension CreateWorkspaceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateWorkspaceOutputResponse(workspace: \(Swift.String(describing: workspace)))"}
}
...
extension DeleteWorkspaceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteWorkspaceOutputResponse(workspace: \(Swift.String(describing: workspace)))"}
}
...
extension DescribeWorkspaceAuthenticationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceAuthenticationInput(workspaceId: \(Swift.String(describing: workspaceId)))"}
}

extension DescribeWorkspaceAuthenticationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribeWorkspaceAuthenticationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceAuthenticationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeWorkspaceAuthenticationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeWorkspaceAuthenticationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeWorkspaceAuthenticationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeWorkspaceAuthenticationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeWorkspaceAuthenticationOutputError>
}

public struct DescribeWorkspaceAuthenticationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceAuthenticationInputQueryItemMiddleware"
...
public struct DescribeWorkspaceAuthenticationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceAuthenticationInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeWorkspaceAuthenticationInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeWorkspaceAuthenticationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeWorkspaceAuthenticationOutputError>
}

public struct DescribeWorkspaceAuthenticationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceAuthenticationInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/workspaces/\(workspaceId.urlPercentEncoding())/authentication"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeWorkspaceAuthenticationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceAuthenticationOutputResponse(authentication: \(Swift.String(describing: authentication)))"}
}
...
struct DescribeWorkspaceAuthenticationOutputResponseBody: Swift.Equatable {
    public let authentication: GrafanaClientTypes.AuthenticationDescription?
}
...
extension DisassociateLicenseInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DisassociateLicenseInput(licenseType: \(Swift.String(describing: licenseType)), workspaceId: \(Swift.String(describing: workspaceId)))"}
}

extension DisassociateLicenseInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DisassociateLicenseInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateLicenseInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DisassociateLicenseInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DisassociateLicenseOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DisassociateLicenseInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DisassociateLicenseOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisassociateLicenseOutputError>
}

public struct DisassociateLicenseInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateLicenseInputQueryItemMiddleware"
...
public struct DisassociateLicenseInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateLicenseInputURLHostMiddleware"
    ...
    public typealias MInput = DisassociateLicenseInput
    public typealias MOutput = ClientRuntime.OperationOutput<DisassociateLicenseOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisassociateLicenseOutputError>
}

public struct DisassociateLicenseInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateLicenseInputURLPathMiddleware"
...
extension DisassociateLicenseOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DisassociateLicenseOutputResponse(workspace: \(Swift.String(describing: workspace)))"}
}
...
extension GrafanaClientTypes.IdpMetadata: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case sdkUnknown
        case url
        case xml
...
extension ListPermissionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPermissionsInput(groupId: \(Swift.String(describing: groupId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), userId: \(Swift.String(describing: userId)), userType: \(Swift.String(describing: userType)), workspaceId: \(Swift.String(describing: workspaceId)))"}
}
...
public struct ListPermissionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        if let groupId = input.operationInput.groupId {
            ...
            input.builder.withQueryItem(groupIdQueryItem)
        }
...
public struct ListPermissionsInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/workspaces/\(workspaceId.urlPercentEncoding())/permissions"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct ListPermissionsOutputResponseBody: Swift.Equatable {
    ...
    public let permissions: [GrafanaClientTypes.PermissionEntry]?
}
...
struct ListWorkspacesOutputResponseBody: Swift.Equatable {
    public let workspaces: [GrafanaClientTypes.WorkspaceSummary]?
    public let nextToken: Swift.String?
}
...
extension GrafanaClientTypes.PermissionEntry: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case role
        case user
    }
...
extension GrafanaClientTypes.PermissionEntry: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PermissionEntry(role: \(Swift.String(describing: role)), user: \(Swift.String(describing: user)))"}
}
...
extension GrafanaClientTypes.RoleValues: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case admin
        case editor
    }
...
extension GrafanaClientTypes.RoleValues: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RoleValues(admin: \(Swift.String(describing: admin)), editor: \(Swift.String(describing: editor)))"}
}
...
extension GrafanaClientTypes.SamlAuthentication: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case configuration
        case status
    }
...
extension GrafanaClientTypes.SamlAuthentication: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SamlAuthentication(configuration: \(Swift.String(describing: configuration)), status: \(Swift.String(describing: status)))"}
}
...
extension GrafanaClientTypes.SamlConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension GrafanaClientTypes.SamlConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SamlConfiguration(allowedOrganizations: \(Swift.String(describing: allowedOrganizations)), assertionAttributes: \(Swift.String(describing: assertionAttributes)), idpMetadata: \(Swift.String(describing: idpMetadata)), loginValidityDuration: \(Swift.String(describing: loginValidityDuration)), roleValues: \(Swift.String(describing: roleValues)))"}
}
...
extension GrafanaClientTypes.UpdateError: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case causedBy
        case code
        case message
...
extension GrafanaClientTypes.UpdateError: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateError(causedBy: \(Swift.String(describing: causedBy)), code: \(Swift.String(describing: code)), message: \(Swift.String(describing: message)))"}
}
...
extension GrafanaClientTypes.UpdateInstruction: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case action
        case role
        case users
...
extension GrafanaClientTypes.UpdateInstruction: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateInstruction(action: \(Swift.String(describing: action)), role: \(Swift.String(describing: role)), users: \(Swift.String(describing: users)))"}
}
...
public struct UpdatePermissionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePermissionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdatePermissionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdatePermissionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdatePermissionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdatePermissionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdatePermissionsOutputError>
}

extension UpdatePermissionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdatePermissionsInput(updateInstructionBatch: \(Swift.String(describing: updateInstructionBatch)), workspaceId: \(Swift.String(describing: workspaceId)))"}
}

extension UpdatePermissionsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct UpdatePermissionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePermissionsInputHeadersMiddleware"
...
public struct UpdatePermissionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePermissionsInputQueryItemMiddleware"
...
public struct UpdatePermissionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePermissionsInputURLHostMiddleware"
    ...
    public typealias MInput = UpdatePermissionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdatePermissionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdatePermissionsOutputError>
}

public struct UpdatePermissionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePermissionsInputURLPathMiddleware"
...
struct UpdatePermissionsInputBody: Swift.Equatable {
    public let updateInstructionBatch: [GrafanaClientTypes.UpdateInstruction]?
}
...
extension UpdatePermissionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdatePermissionsOutputResponse(errors: \(Swift.String(describing: errors)))"}
}
...
struct UpdatePermissionsOutputResponseBody: Swift.Equatable {
    public let errors: [GrafanaClientTypes.UpdateError]?
}
...
public struct UpdateWorkspaceAuthenticationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceAuthenticationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateWorkspaceAuthenticationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateWorkspaceAuthenticationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateWorkspaceAuthenticationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateWorkspaceAuthenticationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateWorkspaceAuthenticationOutputError>
}

extension UpdateWorkspaceAuthenticationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateWorkspaceAuthenticationInput(authenticationProviders: \(Swift.String(describing: authenticationProviders)), samlConfiguration: \(Swift.String(describing: samlConfiguration)), workspaceId: \(Swift.String(describing: workspaceId)))"}
}

extension UpdateWorkspaceAuthenticationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case authenticationProviders
...
public struct UpdateWorkspaceAuthenticationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceAuthenticationInputHeadersMiddleware"
...
public struct UpdateWorkspaceAuthenticationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceAuthenticationInputQueryItemMiddleware"
...
public struct UpdateWorkspaceAuthenticationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceAuthenticationInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateWorkspaceAuthenticationInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateWorkspaceAuthenticationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateWorkspaceAuthenticationOutputError>
}

public struct UpdateWorkspaceAuthenticationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceAuthenticationInputURLPathMiddleware"
...
struct UpdateWorkspaceAuthenticationInputBody: Swift.Equatable {
    public let authenticationProviders: [GrafanaClientTypes.AuthenticationProviderTypes]?
    public let samlConfiguration: GrafanaClientTypes.SamlConfiguration?
}
...
extension UpdateWorkspaceAuthenticationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateWorkspaceAuthenticationOutputResponse(authentication: \(Swift.String(describing: authentication)))"}
}
...
extension UpdateWorkspaceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateWorkspaceInput(accountAccessType: \(Swift.String(describing: accountAccessType)), organizationRoleName: \(Swift.String(describing: organizationRoleName)), permissionType: \(Swift.String(describing: permissionType)), stackSetName: \(Swift.String(describing: stackSetName)), workspaceDataSources: \(Swift.String(describing: workspaceDataSources)), workspaceDescription: \(Swift.String(describing: workspaceDescription)), workspaceId: \(Swift.String(describing: workspaceId)), workspaceName: \(Swift.String(describing: workspaceName)), workspaceNotificationDestinations: \(Swift.String(describing: workspaceNotificationDestinations)), workspaceOrganizationalUnits: \(Swift.String(describing: workspaceOrganizationalUnits)), workspaceRoleArn: \(Swift.String(describing: workspaceRoleArn)))"}
}
...
extension UpdateWorkspaceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateWorkspaceOutputResponse(workspace: \(Swift.String(describing: workspace)))"}
}
...
extension GrafanaClientTypes.User: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case id
        case type
    }
...
extension GrafanaClientTypes.User: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "User(id: \(Swift.String(describing: id)), type: \(Swift.String(describing: type)))"}
}
...
struct ValidationExceptionBody: Swift.Equatable {
    public let message: Swift.String?
    public let reason: GrafanaClientTypes.ValidationExceptionReason?
    public let fieldList: [GrafanaClientTypes.ValidationExceptionField]?
}
...
extension GrafanaClientTypes.ValidationExceptionField: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case message
        case name
    }
...
extension GrafanaClientTypes.ValidationExceptionField: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension GrafanaClientTypes.WorkspaceDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountAccessType
        case authentication
        case created
...
extension GrafanaClientTypes.WorkspaceDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspaceDescription(accountAccessType: \(Swift.String(describing: accountAccessType)), authentication: \(Swift.String(describing: authentication)), created: \(Swift.String(describing: created)), dataSources: \(Swift.String(describing: dataSources)), description: \(Swift.String(describing: description)), endpoint: \(Swift.String(describing: endpoint)), freeTrialConsumed: \(Swift.String(describing: freeTrialConsumed)), freeTrialExpiration: \(Swift.String(describing: freeTrialExpiration)), grafanaVersion: \(Swift.String(describing: grafanaVersion)), id: \(Swift.String(describing: id)), licenseExpiration: \(Swift.String(describing: licenseExpiration)), licenseType: \(Swift.String(describing: licenseType)), modified: \(Swift.String(describing: modified)), name: \(Swift.String(describing: name)), notificationDestinations: \(Swift.String(describing: notificationDestinations)), organizationRoleName: \(Swift.String(describing: organizationRoleName)), organizationalUnits: \(Swift.String(describing: organizationalUnits)), permissionType: \(Swift.String(describing: permissionType)), stackSetName: \(Swift.String(describing: stackSetName)), status: \(Swift.String(describing: status)), workspaceRoleArn: \(Swift.String(describing: workspaceRoleArn)))"}
}
...
extension GrafanaClientTypes.WorkspaceSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case authentication
        case created
        case description
...
extension GrafanaClientTypes.WorkspaceSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspaceSummary(authentication: \(Swift.String(describing: authentication)), created: \(Swift.String(describing: created)), description: \(Swift.String(describing: description)), endpoint: \(Swift.String(describing: endpoint)), grafanaVersion: \(Swift.String(describing: grafanaVersion)), id: \(Swift.String(describing: id)), modified: \(Swift.String(describing: modified)), name: \(Swift.String(describing: name)), notificationDestinations: \(Swift.String(describing: notificationDestinations)), status: \(Swift.String(describing: status)))"}
}
