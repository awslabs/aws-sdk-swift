...
public protocol SnsClientProtocol {
    ...
    func checkIfPhoneNumberIsOptedOut(input: CheckIfPhoneNumberIsOptedOutInput, completion: @escaping (SdkResult<CheckIfPhoneNumberIsOptedOutOutput, CheckIfPhoneNumberIsOptedOutOutputError>) -> Void)
    ...
    ///             set to "true".</p>
    func confirmSubscription(input: ConfirmSubscriptionInput, completion: @escaping (SdkResult<ConfirmSubscriptionOutput, ConfirmSubscriptionOutputError>) -> Void)
    ...
    func createPlatformApplication(input: CreatePlatformApplicationInput, completion: @escaping (SdkResult<CreatePlatformApplicationOutput, CreatePlatformApplicationOutputError>) -> Void)
    ...
    ///                 for Baidu</a>. </p>
    func createPlatformEndpoint(input: CreatePlatformEndpointInput, completion: @escaping (SdkResult<CreatePlatformEndpointOutput, CreatePlatformEndpointOutputError>) -> Void)
    ...
    func createSMSSandboxPhoneNumber(input: CreateSMSSandboxPhoneNumberInput, completion: @escaping (SdkResult<CreateSMSSandboxPhoneNumberOutput, CreateSMSSandboxPhoneNumberOutputError>) -> Void)
    ...
    func createTopic(input: CreateTopicInput, completion: @escaping (SdkResult<CreateTopicOutput, CreateTopicOutputError>) -> Void)
    ...
    func deletePlatformApplication(input: DeletePlatformApplicationInput, completion: @escaping (SdkResult<DeletePlatformApplicationOutput, DeletePlatformApplicationOutputError>) -> Void)
    ...
    ///                 see <a href="https://docs.aws.amazon.com/sns/latest/dg/sns-sms-sandbox.html">SMS sandbox</a> in
    ///                 the <i>Amazon SNS Developer Guide</i>.</p>
    func deleteSMSSandboxPhoneNumber(input: DeleteSMSSandboxPhoneNumberInput, completion: @escaping (SdkResult<DeleteSMSSandboxPhoneNumberOutput, DeleteSMSSandboxPhoneNumberOutputError>) -> Void)
    ...
    ///             error.</p>
    func deleteTopic(input: DeleteTopicInput, completion: @escaping (SdkResult<DeleteTopicOutput, DeleteTopicOutputError>) -> Void)
    ...
    func getEndpointAttributes(input: GetEndpointAttributesInput, completion: @escaping (SdkResult<GetEndpointAttributesOutput, GetEndpointAttributesOutputError>) -> Void)
    /// <p>Retrieves the attributes of the platform application object for the supported push
    ///             notification services, such as APNS and GCM (Firebase Cloud Messaging). For more
    ///             information, see <a href="https://docs.aws.amazon.com/sns/latest/dg/SNSMobilePush.html">Using Amazon SNS Mobile Push Notifications</a>. </p>
    func getPlatformApplicationAttributes(input: GetPlatformApplicationAttributesInput, completion: @escaping (SdkResult<GetPlatformApplicationAttributesOutput, GetPlatformApplicationAttributesOutputError>) -> Void)
    ...
    func getSMSAttributes(input: GetSMSAttributesInput, completion: @escaping (SdkResult<GetSMSAttributesOutput, GetSMSAttributesOutputError>) -> Void)
    ...
    ///                 see <a href="https://docs.aws.amazon.com/sns/latest/dg/sns-sms-sandbox.html">SMS sandbox</a> in
    ///                 the <i>Amazon SNS Developer Guide</i>.</p>
    func getSMSSandboxAccountStatus(input: GetSMSSandboxAccountStatusInput, completion: @escaping (SdkResult<GetSMSSandboxAccountStatusOutput, GetSMSSandboxAccountStatusOutputError>) -> Void)
    /// <p>Returns all of the properties of a subscription.</p>
    func getSubscriptionAttributes(input: GetSubscriptionAttributesInput, completion: @escaping (SdkResult<GetSubscriptionAttributesOutput, GetSubscriptionAttributesOutputError>) -> Void)
    ...
    func getTopicAttributes(input: GetTopicAttributesInput, completion: @escaping (SdkResult<GetTopicAttributesOutput, GetTopicAttributesOutputError>) -> Void)
    ...
    func listEndpointsByPlatformApplication(input: ListEndpointsByPlatformApplicationInput, completion: @escaping (SdkResult<ListEndpointsByPlatformApplicationOutput, ListEndpointsByPlatformApplicationOutputError>) -> Void)
    ...
    ///             Guide</i>.</p>
    func listOriginationNumbers(input: ListOriginationNumbersInput, completion: @escaping (SdkResult<ListOriginationNumbersOutput, ListOriginationNumbersOutputError>) -> Void)
    ...
    func listPhoneNumbersOptedOut(input: ListPhoneNumbersOptedOutInput, completion: @escaping (SdkResult<ListPhoneNumbersOptedOutOutput, ListPhoneNumbersOptedOutOutputError>) -> Void)
    ...
    func listPlatformApplications(input: ListPlatformApplicationsInput, completion: @escaping (SdkResult<ListPlatformApplicationsOutput, ListPlatformApplicationsOutputError>) -> Void)
    ...
    ///                 see <a href="https://docs.aws.amazon.com/sns/latest/dg/sns-sms-sandbox.html">SMS sandbox</a> in
    ///                 the <i>Amazon SNS Developer Guide</i>.</p>
    func listSMSSandboxPhoneNumbers(input: ListSMSSandboxPhoneNumbersInput, completion: @escaping (SdkResult<ListSMSSandboxPhoneNumbersOutput, ListSMSSandboxPhoneNumbersOutputError>) -> Void)
    ...
    ///         <p>This action is throttled at 30 transactions per second (TPS).</p>
    func listSubscriptions(input: ListSubscriptionsInput, completion: @escaping (SdkResult<ListSubscriptionsOutput, ListSubscriptionsOutputError>) -> Void)
    ...
    ///         <p>This action is throttled at 30 transactions per second (TPS).</p>
    func listSubscriptionsByTopic(input: ListSubscriptionsByTopicInput, completion: @escaping (SdkResult<ListSubscriptionsByTopicOutput, ListSubscriptionsByTopicOutputError>) -> Void)
    ...
    ///             further results.</p>
    ///         <p>This action is throttled at 30 transactions per second (TPS).</p>
    func listTopics(input: ListTopicsInput, completion: @escaping (SdkResult<ListTopicsOutput, ListTopicsOutputError>) -> Void)
    ...
    func optInPhoneNumber(input: OptInPhoneNumberInput, completion: @escaping (SdkResult<OptInPhoneNumberOutput, OptInPhoneNumberOutputError>) -> Void)
    ...
    ///             notification services, such as GCM (Firebase Cloud Messaging) and APNS. For more
    ///             information, see <a href="https://docs.aws.amazon.com/sns/latest/dg/SNSMobilePush.html">Using Amazon SNS Mobile Push Notifications</a>. </p>
    func setEndpointAttributes(input: SetEndpointAttributesInput, completion: @escaping (SdkResult<SetEndpointAttributesOutput, SetEndpointAttributesOutputError>) -> Void)
    ...
    func setPlatformApplicationAttributes(input: SetPlatformApplicationAttributesInput, completion: @escaping (SdkResult<SetPlatformApplicationAttributesOutput, SetPlatformApplicationAttributesOutputError>) -> Void)
    ...
    ///         </note>
    func setSMSAttributes(input: SetSMSAttributesInput, completion: @escaping (SdkResult<SetSMSAttributesOutput, SetSMSAttributesOutputError>) -> Void)
    /// <p>Allows a subscription owner to set an attribute of the subscription to a new
    ///             value.</p>
    func setSubscriptionAttributes(input: SetSubscriptionAttributesInput, completion: @escaping (SdkResult<SetSubscriptionAttributesOutput, SetSubscriptionAttributesOutputError>) -> Void)
    /// <p>Allows a topic owner to set an attribute of the topic to a new value.</p>
    func setTopicAttributes(input: SetTopicAttributesInput, completion: @escaping (SdkResult<SetTopicAttributesOutput, SetTopicAttributesOutputError>) -> Void)
    ...
    func subscribe(input: SubscribeInput, completion: @escaping (SdkResult<SubscribeOutput, SubscribeOutputError>) -> Void)
    ...
    ///         <p>This action is throttled at 100 transactions per second (TPS).</p>
    func unsubscribe(input: UnsubscribeInput, completion: @escaping (SdkResult<UnsubscribeOutput, UnsubscribeOutputError>) -> Void)
    ...
    ///                 see <a href="https://docs.aws.amazon.com/sns/latest/dg/sns-sms-sandbox.html">SMS sandbox</a> in
    ///                 the <i>Amazon SNS Developer Guide</i>.</p>
    func verifySMSSandboxPhoneNumber(input: VerifySMSSandboxPhoneNumberInput, completion: @escaping (SdkResult<VerifySMSSandboxPhoneNumberOutput, VerifySMSSandboxPhoneNumberOutputError>) -> Void)
}
