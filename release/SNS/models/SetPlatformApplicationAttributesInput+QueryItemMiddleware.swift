...
public struct SetPlatformApplicationAttributesInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<SetPlatformApplicationAttributesOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<SetPlatformApplicationAttributesOutput>
