...
public class PollyClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try PollyClientConfiguration(region: unwrappedRegion)
    ...
    public class PollyClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("PollyClient")
