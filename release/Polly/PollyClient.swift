...
extension PollyClient: PollyClientProtocol {
    ...
    ///         Lexicons</a>.</p>
    public func deleteLexicon(input: DeleteLexiconInput, completion: @escaping (SdkResult<DeleteLexiconOutput, DeleteLexiconOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<DeleteLexiconInput, DeleteLexiconOutput, DeleteLexiconOutputError>(id: "deleteLexicon")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteLexiconInput, DeleteLexiconOutput, DeleteLexiconOutputError>(contentType: "application/json"))
    ...
    ///       action.</p>
    public func describeVoices(input: DescribeVoicesInput, completion: @escaping (SdkResult<DescribeVoicesOutput, DescribeVoicesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "polly")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeVoicesInput, DescribeVoicesOutput, DescribeVoicesOutputError>(id: "describeVoices")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeVoicesInput, DescribeVoicesOutput, DescribeVoicesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///         Lexicons</a>.</p>
    public func getLexicon(input: GetLexiconInput, completion: @escaping (SdkResult<GetLexiconOutput, GetLexiconOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "polly")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetLexiconInput, GetLexiconOutput, GetLexiconOutputError>(id: "getLexicon")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetLexiconInput, GetLexiconOutput, GetLexiconOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getSpeechSynthesisTask(input: GetSpeechSynthesisTaskInput, completion: @escaping (SdkResult<GetSpeechSynthesisTaskOutput, GetSpeechSynthesisTaskOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "polly")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSpeechSynthesisTaskInput, GetSpeechSynthesisTaskOutput, GetSpeechSynthesisTaskOutputError>(id: "getSpeechSynthesisTask")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSpeechSynthesisTaskInput, GetSpeechSynthesisTaskOutput, GetSpeechSynthesisTaskOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///         Lexicons</a>.</p>
    public func listLexicons(input: ListLexiconsInput, completion: @escaping (SdkResult<ListLexiconsOutput, ListLexiconsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "polly")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListLexiconsInput, ListLexiconsOutput, ListLexiconsOutputError>(id: "listLexicons")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListLexiconsInput, ListLexiconsOutput, ListLexiconsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listSpeechSynthesisTasks(input: ListSpeechSynthesisTasksInput, completion: @escaping (SdkResult<ListSpeechSynthesisTasksOutput, ListSpeechSynthesisTasksOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "polly")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListSpeechSynthesisTasksInput, ListSpeechSynthesisTasksOutput, ListSpeechSynthesisTasksOutputError>(id: "listSpeechSynthesisTasks")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListSpeechSynthesisTasksInput, ListSpeechSynthesisTasksOutput, ListSpeechSynthesisTasksOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/polly/latest/dg/managing-lexicons.html">Managing
    ///         Lexicons</a>.</p>
    public func putLexicon(input: PutLexiconInput, completion: @escaping (SdkResult<PutLexiconOutput, PutLexiconOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "polly")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutLexiconInput, PutLexiconOutput, PutLexiconOutputError>(id: "putLexicon")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutLexiconInput, PutLexiconOutput, PutLexiconOutputError>(contentType: "application/json"))
    ...
    public func startSpeechSynthesisTask(input: StartSpeechSynthesisTaskInput, completion: @escaping (SdkResult<StartSpeechSynthesisTaskOutput, StartSpeechSynthesisTaskOutputError>) -> Void)
    {
        let urlPath = "/v1/synthesisTasks"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "polly")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartSpeechSynthesisTaskInput, StartSpeechSynthesisTaskOutput, StartSpeechSynthesisTaskOutputError>(id: "startSpeechSynthesisTask")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartSpeechSynthesisTaskInput, StartSpeechSynthesisTaskOutput, StartSpeechSynthesisTaskOutputError>(contentType: "application/json"))
    ...
    ///         Works</a>.</p>
    public func synthesizeSpeech(input: SynthesizeSpeechInput, streamSink: StreamSink, completion: @escaping (SdkResult<SynthesizeSpeechOutput, SynthesizeSpeechOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "polly")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SynthesizeSpeechInput, SynthesizeSpeechOutput, SynthesizeSpeechOutputError>(id: "synthesizeSpeech")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SynthesizeSpeechInput, SynthesizeSpeechOutput, SynthesizeSpeechOutputError>(contentType: "application/json"))
