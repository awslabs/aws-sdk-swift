...
public protocol PollyClientProtocol {
    ...
    ///         Lexicons</a>.</p>
    func deleteLexicon(input: DeleteLexiconInput, completion: @escaping (SdkResult<DeleteLexiconOutput, DeleteLexiconOutputError>) -> Void)
    ...
    ///       action.</p>
    func describeVoices(input: DescribeVoicesInput, completion: @escaping (SdkResult<DescribeVoicesOutput, DescribeVoicesOutputError>) -> Void)
    ...
    ///         Lexicons</a>.</p>
    func getLexicon(input: GetLexiconInput, completion: @escaping (SdkResult<GetLexiconOutput, GetLexiconOutputError>) -> Void)
    ...
    func getSpeechSynthesisTask(input: GetSpeechSynthesisTaskInput, completion: @escaping (SdkResult<GetSpeechSynthesisTaskOutput, GetSpeechSynthesisTaskOutputError>) -> Void)
    ...
    ///         Lexicons</a>.</p>
    func listLexicons(input: ListLexiconsInput, completion: @escaping (SdkResult<ListLexiconsOutput, ListLexiconsOutputError>) -> Void)
    ...
    func listSpeechSynthesisTasks(input: ListSpeechSynthesisTasksInput, completion: @escaping (SdkResult<ListSpeechSynthesisTasksOutput, ListSpeechSynthesisTasksOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/polly/latest/dg/managing-lexicons.html">Managing
    ///         Lexicons</a>.</p>
    func putLexicon(input: PutLexiconInput, completion: @escaping (SdkResult<PutLexiconOutput, PutLexiconOutputError>) -> Void)
    ...
    func startSpeechSynthesisTask(input: StartSpeechSynthesisTaskInput, completion: @escaping (SdkResult<StartSpeechSynthesisTaskOutput, StartSpeechSynthesisTaskOutputError>) -> Void)
    ...
    ///         Works</a>.</p>
    func synthesizeSpeech(input: SynthesizeSpeechInput, streamSink: StreamSink, completion: @escaping (SdkResult<SynthesizeSpeechOutput, SynthesizeSpeechOutputError>) -> Void)
}
