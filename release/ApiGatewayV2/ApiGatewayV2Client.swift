...
public class ApiGatewayV2Client {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try ApiGatewayV2ClientConfiguration(region: unwrappedRegion)
    ...
    public class ApiGatewayV2ClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("ApiGatewayV2Client")
