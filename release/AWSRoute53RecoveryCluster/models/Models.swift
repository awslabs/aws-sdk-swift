...
extension EndpointTemporarilyUnavailableException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EndpointTemporarilyUnavailableException(message: \(Swift.String(describing: message)))"}
}
...
public struct GetRoutingControlStateInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRoutingControlStateInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetRoutingControlStateInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetRoutingControlStateOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetRoutingControlStateInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetRoutingControlStateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRoutingControlStateOutputError>
}

extension GetRoutingControlStateInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRoutingControlStateInput(routingControlArn: \(Swift.String(describing: routingControlArn)))"}
}

extension GetRoutingControlStateInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct GetRoutingControlStateInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRoutingControlStateInputHeadersMiddleware"
...
public struct GetRoutingControlStateInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRoutingControlStateInputQueryItemMiddleware"
...
public struct GetRoutingControlStateInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRoutingControlStateInputURLHostMiddleware"
    ...
    public typealias MInput = GetRoutingControlStateInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetRoutingControlStateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRoutingControlStateOutputError>
}

public struct GetRoutingControlStateInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRoutingControlStateInputURLPathMiddleware"
...
extension GetRoutingControlStateOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetRoutingControlStateOutputResponse(routingControlArn: \(Swift.String(describing: routingControlArn)), routingControlState: \(Swift.String(describing: routingControlState)))"}
}
...
struct GetRoutingControlStateOutputResponseBody: Swift.Equatable {
    public let routingControlArn: Swift.String?
    public let routingControlState: Route53RecoveryClusterClientTypes.RoutingControlState?
}
...
extension Route53RecoveryClusterClientTypes.UpdateRoutingControlStateEntry: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case routingControlArn = "RoutingControlArn"
        case routingControlState = "RoutingControlState"
    }
...
extension Route53RecoveryClusterClientTypes.UpdateRoutingControlStateEntry: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRoutingControlStateEntry(routingControlArn: \(Swift.String(describing: routingControlArn)), routingControlState: \(Swift.String(describing: routingControlState)))"}
}
...
public struct UpdateRoutingControlStateInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRoutingControlStateInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateRoutingControlStateInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateRoutingControlStateOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateRoutingControlStateInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRoutingControlStateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRoutingControlStateOutputError>
}

extension UpdateRoutingControlStateInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRoutingControlStateInput(routingControlArn: \(Swift.String(describing: routingControlArn)), routingControlState: \(Swift.String(describing: routingControlState)))"}
}

extension UpdateRoutingControlStateInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case routingControlArn = "RoutingControlArn"
        case routingControlState = "RoutingControlState"
    }
...
public struct UpdateRoutingControlStateInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRoutingControlStateInputHeadersMiddleware"
...
public struct UpdateRoutingControlStateInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRoutingControlStateInputQueryItemMiddleware"
...
public struct UpdateRoutingControlStateInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRoutingControlStateInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateRoutingControlStateInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRoutingControlStateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRoutingControlStateOutputError>
}

public struct UpdateRoutingControlStateInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRoutingControlStateInputURLPathMiddleware"
...
extension UpdateRoutingControlStateOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRoutingControlStateOutputResponse()"}
}
...
struct UpdateRoutingControlStateOutputResponseBody: Swift.Equatable {
}

extension UpdateRoutingControlStateOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct UpdateRoutingControlStatesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRoutingControlStatesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateRoutingControlStatesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateRoutingControlStatesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateRoutingControlStatesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRoutingControlStatesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRoutingControlStatesOutputError>
}

extension UpdateRoutingControlStatesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRoutingControlStatesInput(updateRoutingControlStateEntries: \(Swift.String(describing: updateRoutingControlStateEntries)))"}
}

extension UpdateRoutingControlStatesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct UpdateRoutingControlStatesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRoutingControlStatesInputHeadersMiddleware"
...
public struct UpdateRoutingControlStatesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRoutingControlStatesInputQueryItemMiddleware"
...
public struct UpdateRoutingControlStatesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRoutingControlStatesInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateRoutingControlStatesInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRoutingControlStatesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRoutingControlStatesOutputError>
}

public struct UpdateRoutingControlStatesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRoutingControlStatesInputURLPathMiddleware"
...
struct UpdateRoutingControlStatesInputBody: Swift.Equatable {
    public let updateRoutingControlStateEntries: [Route53RecoveryClusterClientTypes.UpdateRoutingControlStateEntry]?
}
...
extension UpdateRoutingControlStatesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRoutingControlStatesOutputResponse()"}
}
...
struct UpdateRoutingControlStatesOutputResponseBody: Swift.Equatable {
}

extension UpdateRoutingControlStatesOutputResponseBody: Swift.Decodable {
...
struct ValidationExceptionBody: Swift.Equatable {
    public let message: Swift.String?
    public let reason: Route53RecoveryClusterClientTypes.ValidationExceptionReason?
    public let fields: [Route53RecoveryClusterClientTypes.ValidationExceptionField]?
}
...
extension Route53RecoveryClusterClientTypes.ValidationExceptionField: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case message
        case name
    }
...
extension Route53RecoveryClusterClientTypes.ValidationExceptionField: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
