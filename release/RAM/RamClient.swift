...
public class RamClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try RamClientConfiguration(region: unwrappedRegion)
    ...
    public class RamClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("RamClient")
