...
public protocol SageMakerFeatureStoreRuntimeClientProtocol {
    ...
    func deleteRecord(input: DeleteRecordInput, completion: @escaping (SdkResult<DeleteRecordOutput, DeleteRecordOutputError>) -> Void)
    ...
    func getRecord(input: GetRecordInput, completion: @escaping (SdkResult<GetRecordOutput, GetRecordOutputError>) -> Void)
