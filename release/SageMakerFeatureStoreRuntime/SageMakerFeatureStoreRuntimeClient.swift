...
extension SageMakerFeatureStoreRuntimeClient: SageMakerFeatureStoreRuntimeClientProtocol {
    ...
    public func deleteRecord(input: DeleteRecordInput, completion: @escaping (SdkResult<DeleteRecordOutput, DeleteRecordOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<DeleteRecordInput, DeleteRecordOutput, DeleteRecordOutputError>(id: "deleteRecord")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteRecordInput, DeleteRecordOutput, DeleteRecordOutputError>(contentType: "application/json"))
    ...
    public func getRecord(input: GetRecordInput, completion: @escaping (SdkResult<GetRecordOutput, GetRecordOutputError>) -> Void)
    {
        guard let featureGroupName = input.featureGroupName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component featureGroupName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "sagemaker")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetRecordInput, GetRecordOutput, GetRecordOutputError>(id: "getRecord")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetRecordInput, GetRecordOutput, GetRecordOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func putRecord(input: PutRecordInput, completion: @escaping (SdkResult<PutRecordOutput, PutRecordOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutRecordInput, PutRecordOutput, PutRecordOutputError>(contentType: "application/json"))
