...
public extension EcsClient {
    ...
    {
        typealias createCapacityProviderContinuation = CheckedContinuation<CreateCapacityProviderOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createCapacityProviderContinuation) in
            createCapacityProvider(input: input) { result in
                switch result {
    ...
    {
        typealias createTaskSetContinuation = CheckedContinuation<CreateTaskSetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createTaskSetContinuation) in
            createTaskSet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteAccountSettingContinuation = CheckedContinuation<DeleteAccountSettingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteAccountSettingContinuation) in
            deleteAccountSetting(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteAttributesContinuation = CheckedContinuation<DeleteAttributesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteAttributesContinuation) in
            deleteAttributes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteCapacityProviderContinuation = CheckedContinuation<DeleteCapacityProviderOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteCapacityProviderContinuation) in
            deleteCapacityProvider(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteTaskSetContinuation = CheckedContinuation<DeleteTaskSetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteTaskSetContinuation) in
            deleteTaskSet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deregisterContainerInstanceContinuation = CheckedContinuation<DeregisterContainerInstanceOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deregisterContainerInstanceContinuation) in
            deregisterContainerInstance(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deregisterTaskDefinitionContinuation = CheckedContinuation<DeregisterTaskDefinitionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deregisterTaskDefinitionContinuation) in
            deregisterTaskDefinition(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeCapacityProvidersContinuation = CheckedContinuation<DescribeCapacityProvidersOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeCapacityProvidersContinuation) in
            describeCapacityProviders(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeContainerInstancesContinuation = CheckedContinuation<DescribeContainerInstancesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeContainerInstancesContinuation) in
            describeContainerInstances(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeTaskDefinitionContinuation = CheckedContinuation<DescribeTaskDefinitionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeTaskDefinitionContinuation) in
            describeTaskDefinition(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeTaskSetsContinuation = CheckedContinuation<DescribeTaskSetsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeTaskSetsContinuation) in
            describeTaskSets(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeTasksContinuation = CheckedContinuation<DescribeTasksOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeTasksContinuation) in
            describeTasks(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias discoverPollEndpointContinuation = CheckedContinuation<DiscoverPollEndpointOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: discoverPollEndpointContinuation) in
            discoverPollEndpoint(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias executeCommandContinuation = CheckedContinuation<ExecuteCommandOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: executeCommandContinuation) in
            executeCommand(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listAccountSettingsContinuation = CheckedContinuation<ListAccountSettingsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listAccountSettingsContinuation) in
            listAccountSettings(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listAttributesContinuation = CheckedContinuation<ListAttributesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listAttributesContinuation) in
            listAttributes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listContainerInstancesContinuation = CheckedContinuation<ListContainerInstancesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listContainerInstancesContinuation) in
            listContainerInstances(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listTaskDefinitionFamiliesContinuation = CheckedContinuation<ListTaskDefinitionFamiliesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTaskDefinitionFamiliesContinuation) in
            listTaskDefinitionFamilies(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listTaskDefinitionsContinuation = CheckedContinuation<ListTaskDefinitionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listTaskDefinitionsContinuation) in
            listTaskDefinitions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putAccountSettingContinuation = CheckedContinuation<PutAccountSettingOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putAccountSettingContinuation) in
            putAccountSetting(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putAccountSettingDefaultContinuation = CheckedContinuation<PutAccountSettingDefaultOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putAccountSettingDefaultContinuation) in
            putAccountSettingDefault(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putAttributesContinuation = CheckedContinuation<PutAttributesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putAttributesContinuation) in
            putAttributes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias putClusterCapacityProvidersContinuation = CheckedContinuation<PutClusterCapacityProvidersOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putClusterCapacityProvidersContinuation) in
            putClusterCapacityProviders(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias registerContainerInstanceContinuation = CheckedContinuation<RegisterContainerInstanceOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: registerContainerInstanceContinuation) in
            registerContainerInstance(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias registerTaskDefinitionContinuation = CheckedContinuation<RegisterTaskDefinitionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: registerTaskDefinitionContinuation) in
            registerTaskDefinition(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias runTaskContinuation = CheckedContinuation<RunTaskOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: runTaskContinuation) in
            runTask(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias startTaskContinuation = CheckedContinuation<StartTaskOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startTaskContinuation) in
            startTask(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias stopTaskContinuation = CheckedContinuation<StopTaskOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopTaskContinuation) in
            stopTask(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias submitAttachmentStateChangesContinuation = CheckedContinuation<SubmitAttachmentStateChangesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: submitAttachmentStateChangesContinuation) in
            submitAttachmentStateChanges(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias submitContainerStateChangeContinuation = CheckedContinuation<SubmitContainerStateChangeOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: submitContainerStateChangeContinuation) in
            submitContainerStateChange(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias submitTaskStateChangeContinuation = CheckedContinuation<SubmitTaskStateChangeOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: submitTaskStateChangeContinuation) in
            submitTaskStateChange(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateCapacityProviderContinuation = CheckedContinuation<UpdateCapacityProviderOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateCapacityProviderContinuation) in
            updateCapacityProvider(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateClusterSettingsContinuation = CheckedContinuation<UpdateClusterSettingsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateClusterSettingsContinuation) in
            updateClusterSettings(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateContainerAgentContinuation = CheckedContinuation<UpdateContainerAgentOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateContainerAgentContinuation) in
            updateContainerAgent(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateContainerInstancesStateContinuation = CheckedContinuation<UpdateContainerInstancesStateOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateContainerInstancesStateContinuation) in
            updateContainerInstancesState(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateServicePrimaryTaskSetContinuation = CheckedContinuation<UpdateServicePrimaryTaskSetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateServicePrimaryTaskSetContinuation) in
            updateServicePrimaryTaskSet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateTaskSetContinuation = CheckedContinuation<UpdateTaskSetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateTaskSetContinuation) in
            updateTaskSet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
