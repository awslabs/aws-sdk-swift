...
public class EcsClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try EcsClientConfiguration(region: unwrappedRegion)
    ...
    public class EcsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("EcsClient")
...
public struct EcsClientLogHandlerFactory: SDKLogHandlerFactory {
...
extension EcsClient: EcsClientProtocol {
    ...
    /// 			AWS Fargate.</p>
    public func createCapacityProvider(input: CreateCapacityProviderInput, completion: @escaping (SdkResult<CreateCapacityProviderOutputResponse, CreateCapacityProviderOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<CreateCapacityProviderInput, CreateCapacityProviderOutputResponse, CreateCapacityProviderOutputError>(id: "createCapacityProvider")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateCapacityProviderInput, CreateCapacityProviderOutputResponse, CreateCapacityProviderOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateCapacityProviderInput, CreateCapacityProviderOutputResponse, CreateCapacityProviderOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.CreateCapacityProvider"))
    ...
    public func createCluster(input: CreateClusterInput, completion: @escaping (SdkResult<CreateClusterOutputResponse, CreateClusterOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateClusterInput, CreateClusterOutputResponse, CreateClusterOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.CreateCluster"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createService(input: CreateServiceInput, completion: @escaping (SdkResult<CreateServiceOutputResponse, CreateServiceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateServiceInput, CreateServiceOutputResponse, CreateServiceOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.CreateService"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createTaskSet(input: CreateTaskSetInput, completion: @escaping (SdkResult<CreateTaskSetOutputResponse, CreateTaskSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateTaskSetInput, CreateTaskSetOutputResponse, CreateTaskSetOutputError>(id: "createTaskSet")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateTaskSetInput, CreateTaskSetOutputResponse, CreateTaskSetOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateTaskSetInput, CreateTaskSetOutputResponse, CreateTaskSetOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.CreateTaskSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 			an account.</p>
    public func deleteAccountSetting(input: DeleteAccountSettingInput, completion: @escaping (SdkResult<DeleteAccountSettingOutputResponse, DeleteAccountSettingOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteAccountSettingInput, DeleteAccountSettingOutputResponse, DeleteAccountSettingOutputError>(id: "deleteAccountSetting")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteAccountSettingInput, DeleteAccountSettingOutputResponse, DeleteAccountSettingOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteAccountSettingInput, DeleteAccountSettingOutputResponse, DeleteAccountSettingOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DeleteAccountSetting"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }

    /// <p>Deletes one or more custom attributes from an Amazon ECS resource.</p>
    public func deleteAttributes(input: DeleteAttributesInput, completion: @escaping (SdkResult<DeleteAttributesOutputResponse, DeleteAttributesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteAttributesInput, DeleteAttributesOutputResponse, DeleteAttributesOutputError>(id: "deleteAttributes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteAttributesInput, DeleteAttributesOutputResponse, DeleteAttributesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteAttributesInput, DeleteAttributesOutputResponse, DeleteAttributesOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DeleteAttributes"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteCapacityProvider(input: DeleteCapacityProviderInput, completion: @escaping (SdkResult<DeleteCapacityProviderOutputResponse, DeleteCapacityProviderOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteCapacityProviderInput, DeleteCapacityProviderOutputResponse, DeleteCapacityProviderOutputError>(id: "deleteCapacityProvider")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteCapacityProviderInput, DeleteCapacityProviderOutputResponse, DeleteCapacityProviderOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteCapacityProviderInput, DeleteCapacityProviderOutputResponse, DeleteCapacityProviderOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DeleteCapacityProvider"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteCluster(input: DeleteClusterInput, completion: @escaping (SdkResult<DeleteClusterOutputResponse, DeleteClusterOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteClusterInput, DeleteClusterOutputResponse, DeleteClusterOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DeleteCluster"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteService(input: DeleteServiceInput, completion: @escaping (SdkResult<DeleteServiceOutputResponse, DeleteServiceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteServiceInput, DeleteServiceOutputResponse, DeleteServiceOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DeleteService"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteTaskSet(input: DeleteTaskSetInput, completion: @escaping (SdkResult<DeleteTaskSetOutputResponse, DeleteTaskSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteTaskSetInput, DeleteTaskSetOutputResponse, DeleteTaskSetOutputError>(id: "deleteTaskSet")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteTaskSetInput, DeleteTaskSetOutputResponse, DeleteTaskSetOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteTaskSetInput, DeleteTaskSetOutputResponse, DeleteTaskSetOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DeleteTaskSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 		       </note>
    public func deregisterContainerInstance(input: DeregisterContainerInstanceInput, completion: @escaping (SdkResult<DeregisterContainerInstanceOutputResponse, DeregisterContainerInstanceOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeregisterContainerInstanceInput, DeregisterContainerInstanceOutputResponse, DeregisterContainerInstanceOutputError>(id: "deregisterContainerInstance")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeregisterContainerInstanceInput, DeregisterContainerInstanceOutputResponse, DeregisterContainerInstanceOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeregisterContainerInstanceInput, DeregisterContainerInstanceOutputResponse, DeregisterContainerInstanceOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DeregisterContainerInstance"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 		       </note>
    public func deregisterTaskDefinition(input: DeregisterTaskDefinitionInput, completion: @escaping (SdkResult<DeregisterTaskDefinitionOutputResponse, DeregisterTaskDefinitionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeregisterTaskDefinitionInput, DeregisterTaskDefinitionOutputResponse, DeregisterTaskDefinitionOutputError>(id: "deregisterTaskDefinition")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeregisterTaskDefinitionInput, DeregisterTaskDefinitionOutputResponse, DeregisterTaskDefinitionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeregisterTaskDefinitionInput, DeregisterTaskDefinitionOutputResponse, DeregisterTaskDefinitionOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DeregisterTaskDefinition"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }

    /// <p>Describes one or more of your capacity providers.</p>
    public func describeCapacityProviders(input: DescribeCapacityProvidersInput, completion: @escaping (SdkResult<DescribeCapacityProvidersOutputResponse, DescribeCapacityProvidersOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCapacityProvidersInput, DescribeCapacityProvidersOutputResponse, DescribeCapacityProvidersOutputError>(id: "describeCapacityProviders")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCapacityProvidersInput, DescribeCapacityProvidersOutputResponse, DescribeCapacityProvidersOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeCapacityProvidersInput, DescribeCapacityProvidersOutputResponse, DescribeCapacityProvidersOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DescribeCapacityProviders"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeClusters(input: DescribeClustersInput, completion: @escaping (SdkResult<DescribeClustersOutputResponse, DescribeClustersOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeClustersInput, DescribeClustersOutputResponse, DescribeClustersOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DescribeClusters"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeContainerInstances(input: DescribeContainerInstancesInput, completion: @escaping (SdkResult<DescribeContainerInstancesOutputResponse, DescribeContainerInstancesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeContainerInstancesInput, DescribeContainerInstancesOutputResponse, DescribeContainerInstancesOutputError>(id: "describeContainerInstances")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeContainerInstancesInput, DescribeContainerInstancesOutputResponse, DescribeContainerInstancesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeContainerInstancesInput, DescribeContainerInstancesOutputResponse, DescribeContainerInstancesOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DescribeContainerInstances"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeServices(input: DescribeServicesInput, completion: @escaping (SdkResult<DescribeServicesOutputResponse, DescribeServicesOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeServicesInput, DescribeServicesOutputResponse, DescribeServicesOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DescribeServices"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 		       </note>
    public func describeTaskDefinition(input: DescribeTaskDefinitionInput, completion: @escaping (SdkResult<DescribeTaskDefinitionOutputResponse, DescribeTaskDefinitionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTaskDefinitionInput, DescribeTaskDefinitionOutputResponse, DescribeTaskDefinitionOutputError>(id: "describeTaskDefinition")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTaskDefinitionInput, DescribeTaskDefinitionOutputResponse, DescribeTaskDefinitionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeTaskDefinitionInput, DescribeTaskDefinitionOutputResponse, DescribeTaskDefinitionOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DescribeTaskDefinition"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 				Types</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    public func describeTaskSets(input: DescribeTaskSetsInput, completion: @escaping (SdkResult<DescribeTaskSetsOutputResponse, DescribeTaskSetsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTaskSetsInput, DescribeTaskSetsOutputResponse, DescribeTaskSetsOutputError>(id: "describeTaskSets")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTaskSetsInput, DescribeTaskSetsOutputResponse, DescribeTaskSetsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeTaskSetsInput, DescribeTaskSetsOutputResponse, DescribeTaskSetsOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DescribeTaskSets"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }

    /// <p>Describes a specified task or tasks.</p>
    public func describeTasks(input: DescribeTasksInput, completion: @escaping (SdkResult<DescribeTasksOutputResponse, DescribeTasksOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeTasksInput, DescribeTasksOutputResponse, DescribeTasksOutputError>(id: "describeTasks")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeTasksInput, DescribeTasksOutputResponse, DescribeTasksOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeTasksInput, DescribeTasksOutputResponse, DescribeTasksOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DescribeTasks"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func discoverPollEndpoint(input: DiscoverPollEndpointInput, completion: @escaping (SdkResult<DiscoverPollEndpointOutputResponse, DiscoverPollEndpointOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DiscoverPollEndpointInput, DiscoverPollEndpointOutputResponse, DiscoverPollEndpointOutputError>(id: "discoverPollEndpoint")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DiscoverPollEndpointInput, DiscoverPollEndpointOutputResponse, DiscoverPollEndpointOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DiscoverPollEndpointInput, DiscoverPollEndpointOutputResponse, DiscoverPollEndpointOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.DiscoverPollEndpoint"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }

    /// <p>Runs a command remotely on a container within a task.</p>
    public func executeCommand(input: ExecuteCommandInput, completion: @escaping (SdkResult<ExecuteCommandOutputResponse, ExecuteCommandOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ExecuteCommandInput, ExecuteCommandOutputResponse, ExecuteCommandOutputError>(id: "executeCommand")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ExecuteCommandInput, ExecuteCommandOutputResponse, ExecuteCommandOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ExecuteCommandInput, ExecuteCommandOutputResponse, ExecuteCommandOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.ExecuteCommand"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }

    /// <p>Lists the account settings for a specified principal.</p>
    public func listAccountSettings(input: ListAccountSettingsInput, completion: @escaping (SdkResult<ListAccountSettingsOutputResponse, ListAccountSettingsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAccountSettingsInput, ListAccountSettingsOutputResponse, ListAccountSettingsOutputError>(id: "listAccountSettings")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAccountSettingsInput, ListAccountSettingsOutputResponse, ListAccountSettingsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListAccountSettingsInput, ListAccountSettingsOutputResponse, ListAccountSettingsOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.ListAccountSettings"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listAttributes(input: ListAttributesInput, completion: @escaping (SdkResult<ListAttributesOutputResponse, ListAttributesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAttributesInput, ListAttributesOutputResponse, ListAttributesOutputError>(id: "listAttributes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAttributesInput, ListAttributesOutputResponse, ListAttributesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListAttributesInput, ListAttributesOutputResponse, ListAttributesOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.ListAttributes"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listClusters(input: ListClustersInput, completion: @escaping (SdkResult<ListClustersOutputResponse, ListClustersOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListClustersInput, ListClustersOutputResponse, ListClustersOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.ListClusters"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 				<i>Amazon Elastic Container Service Developer Guide</i>.</p>
    public func listContainerInstances(input: ListContainerInstancesInput, completion: @escaping (SdkResult<ListContainerInstancesOutputResponse, ListContainerInstancesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListContainerInstancesInput, ListContainerInstancesOutputResponse, ListContainerInstancesOutputError>(id: "listContainerInstances")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListContainerInstancesInput, ListContainerInstancesOutputResponse, ListContainerInstancesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListContainerInstancesInput, ListContainerInstancesOutputResponse, ListContainerInstancesOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.ListContainerInstances"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listServices(input: ListServicesInput, completion: @escaping (SdkResult<ListServicesOutputResponse, ListServicesOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListServicesInput, ListServicesOutputResponse, ListServicesOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.ListServices"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTagsForResource(input: ListTagsForResourceInput, completion: @escaping (SdkResult<ListTagsForResourceOutputResponse, ListTagsForResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTagsForResourceInput, ListTagsForResourceOutputResponse, ListTagsForResourceOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.ListTagsForResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTaskDefinitionFamilies(input: ListTaskDefinitionFamiliesInput, completion: @escaping (SdkResult<ListTaskDefinitionFamiliesOutputResponse, ListTaskDefinitionFamiliesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListTaskDefinitionFamiliesInput, ListTaskDefinitionFamiliesOutputResponse, ListTaskDefinitionFamiliesOutputError>(id: "listTaskDefinitionFamilies")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListTaskDefinitionFamiliesInput, ListTaskDefinitionFamiliesOutputResponse, ListTaskDefinitionFamiliesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTaskDefinitionFamiliesInput, ListTaskDefinitionFamiliesOutputResponse, ListTaskDefinitionFamiliesOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.ListTaskDefinitionFamilies"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTaskDefinitions(input: ListTaskDefinitionsInput, completion: @escaping (SdkResult<ListTaskDefinitionsOutputResponse, ListTaskDefinitionsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListTaskDefinitionsInput, ListTaskDefinitionsOutputResponse, ListTaskDefinitionsOutputError>(id: "listTaskDefinitions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListTaskDefinitionsInput, ListTaskDefinitionsOutputResponse, ListTaskDefinitionsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTaskDefinitionsInput, ListTaskDefinitionsOutputResponse, ListTaskDefinitionsOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.ListTaskDefinitions"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTasks(input: ListTasksInput, completion: @escaping (SdkResult<ListTasksOutputResponse, ListTasksOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTasksInput, ListTasksOutputResponse, ListTasksOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.ListTasks"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func putAccountSetting(input: PutAccountSettingInput, completion: @escaping (SdkResult<PutAccountSettingOutputResponse, PutAccountSettingOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutAccountSettingInput, PutAccountSettingOutputResponse, PutAccountSettingOutputError>(id: "putAccountSetting")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutAccountSettingInput, PutAccountSettingOutputResponse, PutAccountSettingOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<PutAccountSettingInput, PutAccountSettingOutputResponse, PutAccountSettingOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.PutAccountSetting"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 			basis.</p>
    public func putAccountSettingDefault(input: PutAccountSettingDefaultInput, completion: @escaping (SdkResult<PutAccountSettingDefaultOutputResponse, PutAccountSettingDefaultOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutAccountSettingDefaultInput, PutAccountSettingDefaultOutputResponse, PutAccountSettingDefaultOutputError>(id: "putAccountSettingDefault")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutAccountSettingDefaultInput, PutAccountSettingDefaultOutputResponse, PutAccountSettingDefaultOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<PutAccountSettingDefaultInput, PutAccountSettingDefaultOutputResponse, PutAccountSettingDefaultOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.PutAccountSettingDefault"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 			<i>Amazon Elastic Container Service Developer Guide</i>.</p>
    public func putAttributes(input: PutAttributesInput, completion: @escaping (SdkResult<PutAttributesOutputResponse, PutAttributesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutAttributesInput, PutAttributesOutputResponse, PutAttributesOutputError>(id: "putAttributes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutAttributesInput, PutAttributesOutputResponse, PutAttributesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<PutAttributesInput, PutAttributesOutputResponse, PutAttributesOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.PutAttributes"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 			strategy.</p>
    public func putClusterCapacityProviders(input: PutClusterCapacityProvidersInput, completion: @escaping (SdkResult<PutClusterCapacityProvidersOutputResponse, PutClusterCapacityProvidersOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutClusterCapacityProvidersInput, PutClusterCapacityProvidersOutputResponse, PutClusterCapacityProvidersOutputError>(id: "putClusterCapacityProviders")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutClusterCapacityProvidersInput, PutClusterCapacityProvidersOutputResponse, PutClusterCapacityProvidersOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<PutClusterCapacityProvidersInput, PutClusterCapacityProvidersOutputResponse, PutClusterCapacityProvidersOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.PutClusterCapacityProviders"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 			on.</p>
    public func registerContainerInstance(input: RegisterContainerInstanceInput, completion: @escaping (SdkResult<RegisterContainerInstanceOutputResponse, RegisterContainerInstanceOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RegisterContainerInstanceInput, RegisterContainerInstanceOutputResponse, RegisterContainerInstanceOutputError>(id: "registerContainerInstance")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RegisterContainerInstanceInput, RegisterContainerInstanceOutputResponse, RegisterContainerInstanceOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RegisterContainerInstanceInput, RegisterContainerInstanceOutputResponse, RegisterContainerInstanceOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.RegisterContainerInstance"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func registerTaskDefinition(input: RegisterTaskDefinitionInput, completion: @escaping (SdkResult<RegisterTaskDefinitionOutputResponse, RegisterTaskDefinitionOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RegisterTaskDefinitionInput, RegisterTaskDefinitionOutputResponse, RegisterTaskDefinitionOutputError>(id: "registerTaskDefinition")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RegisterTaskDefinitionInput, RegisterTaskDefinitionOutputResponse, RegisterTaskDefinitionOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RegisterTaskDefinitionInput, RegisterTaskDefinitionOutputResponse, RegisterTaskDefinitionOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.RegisterTaskDefinition"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 			         </li>
    ///          </ul>
    public func runTask(input: RunTaskInput, completion: @escaping (SdkResult<RunTaskOutputResponse, RunTaskOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RunTaskInput, RunTaskOutputResponse, RunTaskOutputError>(id: "runTask")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RunTaskInput, RunTaskOutputResponse, RunTaskOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RunTaskInput, RunTaskOutputResponse, RunTaskOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.RunTask"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 				<i>Amazon Elastic Container Service Developer Guide</i>.</p>
    public func startTask(input: StartTaskInput, completion: @escaping (SdkResult<StartTaskOutputResponse, StartTaskOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartTaskInput, StartTaskOutputResponse, StartTaskOutputError>(id: "startTask")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartTaskInput, StartTaskOutputResponse, StartTaskOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StartTaskInput, StartTaskOutputResponse, StartTaskOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.StartTask"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 					<i>Amazon Elastic Container Service Developer Guide</i>.</p>
    /// 		       </note>
    public func stopTask(input: StopTaskInput, completion: @escaping (SdkResult<StopTaskOutputResponse, StopTaskOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StopTaskInput, StopTaskOutputResponse, StopTaskOutputError>(id: "stopTask")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StopTaskInput, StopTaskOutputResponse, StopTaskOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StopTaskInput, StopTaskOutputResponse, StopTaskOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.StopTask"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func submitAttachmentStateChanges(input: SubmitAttachmentStateChangesInput, completion: @escaping (SdkResult<SubmitAttachmentStateChangesOutputResponse, SubmitAttachmentStateChangesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SubmitAttachmentStateChangesInput, SubmitAttachmentStateChangesOutputResponse, SubmitAttachmentStateChangesOutputError>(id: "submitAttachmentStateChanges")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SubmitAttachmentStateChangesInput, SubmitAttachmentStateChangesOutputResponse, SubmitAttachmentStateChangesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<SubmitAttachmentStateChangesInput, SubmitAttachmentStateChangesOutputResponse, SubmitAttachmentStateChangesOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.SubmitAttachmentStateChanges"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func submitContainerStateChange(input: SubmitContainerStateChangeInput, completion: @escaping (SdkResult<SubmitContainerStateChangeOutputResponse, SubmitContainerStateChangeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SubmitContainerStateChangeInput, SubmitContainerStateChangeOutputResponse, SubmitContainerStateChangeOutputError>(id: "submitContainerStateChange")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SubmitContainerStateChangeInput, SubmitContainerStateChangeOutputResponse, SubmitContainerStateChangeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<SubmitContainerStateChangeInput, SubmitContainerStateChangeOutputResponse, SubmitContainerStateChangeOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.SubmitContainerStateChange"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func submitTaskStateChange(input: SubmitTaskStateChangeInput, completion: @escaping (SdkResult<SubmitTaskStateChangeOutputResponse, SubmitTaskStateChangeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SubmitTaskStateChangeInput, SubmitTaskStateChangeOutputResponse, SubmitTaskStateChangeOutputError>(id: "submitTaskStateChange")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SubmitTaskStateChangeInput, SubmitTaskStateChangeOutputResponse, SubmitTaskStateChangeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<SubmitTaskStateChangeInput, SubmitTaskStateChangeOutputResponse, SubmitTaskStateChangeOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.SubmitTaskStateChange"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func tagResource(input: TagResourceInput, completion: @escaping (SdkResult<TagResourceOutputResponse, TagResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<TagResourceInput, TagResourceOutputResponse, TagResourceOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.TagResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func untagResource(input: UntagResourceInput, completion: @escaping (SdkResult<UntagResourceOutputResponse, UntagResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UntagResourceInput, UntagResourceOutputResponse, UntagResourceOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.UntagResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }

    /// <p>Modifies the parameters for a capacity provider.</p>
    public func updateCapacityProvider(input: UpdateCapacityProviderInput, completion: @escaping (SdkResult<UpdateCapacityProviderOutputResponse, UpdateCapacityProviderOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateCapacityProviderInput, UpdateCapacityProviderOutputResponse, UpdateCapacityProviderOutputError>(id: "updateCapacityProvider")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateCapacityProviderInput, UpdateCapacityProviderOutputResponse, UpdateCapacityProviderOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateCapacityProviderInput, UpdateCapacityProviderOutputResponse, UpdateCapacityProviderOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.UpdateCapacityProvider"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateCluster(input: UpdateClusterInput, completion: @escaping (SdkResult<UpdateClusterOutputResponse, UpdateClusterOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateClusterInput, UpdateClusterOutputResponse, UpdateClusterOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.UpdateCluster"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }

    /// <p>Modifies the settings to use for a cluster.</p>
    public func updateClusterSettings(input: UpdateClusterSettingsInput, completion: @escaping (SdkResult<UpdateClusterSettingsOutputResponse, UpdateClusterSettingsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateClusterSettingsInput, UpdateClusterSettingsOutputResponse, UpdateClusterSettingsOutputError>(id: "updateClusterSettings")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateClusterSettingsInput, UpdateClusterSettingsOutputResponse, UpdateClusterSettingsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateClusterSettingsInput, UpdateClusterSettingsOutputResponse, UpdateClusterSettingsOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.UpdateClusterSettings"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 				<i>Amazon Elastic Container Service Developer Guide</i>.</p>
    public func updateContainerAgent(input: UpdateContainerAgentInput, completion: @escaping (SdkResult<UpdateContainerAgentOutputResponse, UpdateContainerAgentOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateContainerAgentInput, UpdateContainerAgentOutputResponse, UpdateContainerAgentOutputError>(id: "updateContainerAgent")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateContainerAgentInput, UpdateContainerAgentOutputResponse, UpdateContainerAgentOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateContainerAgentInput, UpdateContainerAgentOutputResponse, UpdateContainerAgentOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.UpdateContainerAgent"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateContainerInstancesState(input: UpdateContainerInstancesStateInput, completion: @escaping (SdkResult<UpdateContainerInstancesStateOutputResponse, UpdateContainerInstancesStateOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateContainerInstancesStateInput, UpdateContainerInstancesStateOutputResponse, UpdateContainerInstancesStateOutputError>(id: "updateContainerInstancesState")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateContainerInstancesStateInput, UpdateContainerInstancesStateOutputResponse, UpdateContainerInstancesStateOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateContainerInstancesStateInput, UpdateContainerInstancesStateOutputResponse, UpdateContainerInstancesStateOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.UpdateContainerInstancesState"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateService(input: UpdateServiceInput, completion: @escaping (SdkResult<UpdateServiceOutputResponse, UpdateServiceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateServiceInput, UpdateServiceOutputResponse, UpdateServiceOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.UpdateService"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 				Types</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    public func updateServicePrimaryTaskSet(input: UpdateServicePrimaryTaskSetInput, completion: @escaping (SdkResult<UpdateServicePrimaryTaskSetOutputResponse, UpdateServicePrimaryTaskSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateServicePrimaryTaskSetInput, UpdateServicePrimaryTaskSetOutputResponse, UpdateServicePrimaryTaskSetOutputError>(id: "updateServicePrimaryTaskSet")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateServicePrimaryTaskSetInput, UpdateServicePrimaryTaskSetOutputResponse, UpdateServicePrimaryTaskSetOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateServicePrimaryTaskSetInput, UpdateServicePrimaryTaskSetOutputResponse, UpdateServicePrimaryTaskSetOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.UpdateServicePrimaryTaskSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    /// 				Types</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    public func updateTaskSet(input: UpdateTaskSetInput, completion: @escaping (SdkResult<UpdateTaskSetOutputResponse, UpdateTaskSetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "ecs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateTaskSetInput, UpdateTaskSetOutputResponse, UpdateTaskSetOutputError>(id: "updateTaskSet")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateTaskSetInput, UpdateTaskSetOutputResponse, UpdateTaskSetOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateTaskSetInput, UpdateTaskSetOutputResponse, UpdateTaskSetOutputError>(xAmzTarget: "AmazonEC2ContainerServiceV20141113.UpdateTaskSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
