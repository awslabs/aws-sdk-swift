...
public protocol LexModelsV2ClientProtocol {
    ...
    func describeBotRecommendation(input: DescribeBotRecommendationInput, completion: @escaping (ClientRuntime.SdkResult<DescribeBotRecommendationOutputResponse, DescribeBotRecommendationOutputError>) -> Void)
    ...
    func listBotRecommendations(input: ListBotRecommendationsInput, completion: @escaping (ClientRuntime.SdkResult<ListBotRecommendationsOutputResponse, ListBotRecommendationsOutputError>) -> Void)
    ...
    func listRecommendedIntents(input: ListRecommendedIntentsInput, completion: @escaping (ClientRuntime.SdkResult<ListRecommendedIntentsOutputResponse, ListRecommendedIntentsOutputError>) -> Void)
    ...
    func searchAssociatedTranscripts(input: SearchAssociatedTranscriptsInput, completion: @escaping (ClientRuntime.SdkResult<SearchAssociatedTranscriptsOutputResponse, SearchAssociatedTranscriptsOutputError>) -> Void)
    /// Use this to provide your transcript data, and to start the bot recommendation process.
    func startBotRecommendation(input: StartBotRecommendationInput, completion: @escaping (ClientRuntime.SdkResult<StartBotRecommendationOutputResponse, StartBotRecommendationOutputError>) -> Void)
    ...
    func updateBotRecommendation(input: UpdateBotRecommendationInput, completion: @escaping (ClientRuntime.SdkResult<UpdateBotRecommendationOutputResponse, UpdateBotRecommendationOutputError>) -> Void)
