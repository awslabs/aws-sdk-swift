...
public extension LexModelsV2Client {
    ...
    {
        typealias describeBotRecommendationContinuation = CheckedContinuation<DescribeBotRecommendationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeBotRecommendationContinuation) in
            describeBotRecommendation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listAggregatedUtterancesContinuation = CheckedContinuation<ListAggregatedUtterancesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listAggregatedUtterancesContinuation) in
            listAggregatedUtterances(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listBotRecommendationsContinuation = CheckedContinuation<ListBotRecommendationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listBotRecommendationsContinuation) in
            listBotRecommendations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listRecommendedIntentsContinuation = CheckedContinuation<ListRecommendedIntentsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listRecommendedIntentsContinuation) in
            listRecommendedIntents(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias searchAssociatedTranscriptsContinuation = CheckedContinuation<SearchAssociatedTranscriptsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: searchAssociatedTranscriptsContinuation) in
            searchAssociatedTranscripts(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias startBotRecommendationContinuation = CheckedContinuation<StartBotRecommendationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startBotRecommendationContinuation) in
            startBotRecommendation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateBotRecommendationContinuation = CheckedContinuation<UpdateBotRecommendationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateBotRecommendationContinuation) in
            updateBotRecommendation(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
