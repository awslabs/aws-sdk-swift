...
public class FmsClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try FmsClientConfiguration(region: unwrappedRegion)
    ...
    public class FmsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("FmsClient")
...
public struct FmsClientLogHandlerFactory: SDKLogHandlerFactory {
