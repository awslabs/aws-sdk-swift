...
public protocol FmsClientProtocol {
    ...
    func associateAdminAccount(input: AssociateAdminAccountInput, completion: @escaping (SdkResult<AssociateAdminAccountOutput, AssociateAdminAccountOutputError>) -> Void)
    /// <p>Permanently deletes an AWS Firewall Manager applications list.</p>
    func deleteAppsList(input: DeleteAppsListInput, completion: @escaping (SdkResult<DeleteAppsListOutput, DeleteAppsListOutputError>) -> Void)
    ...
    func deleteNotificationChannel(input: DeleteNotificationChannelInput, completion: @escaping (SdkResult<DeleteNotificationChannelOutput, DeleteNotificationChannelOutputError>) -> Void)
    ...
    func deleteProtocolsList(input: DeleteProtocolsListInput, completion: @escaping (SdkResult<DeleteProtocolsListOutput, DeleteProtocolsListOutputError>) -> Void)
    ...
    func disassociateAdminAccount(input: DisassociateAdminAccountInput, completion: @escaping (SdkResult<DisassociateAdminAccountOutput, DisassociateAdminAccountOutputError>) -> Void)
    ...
    func getAdminAccount(input: GetAdminAccountInput, completion: @escaping (SdkResult<GetAdminAccountOutput, GetAdminAccountOutputError>) -> Void)
    /// <p>Returns information about the specified AWS Firewall Manager applications list.</p>
    func getAppsList(input: GetAppsListInput, completion: @escaping (SdkResult<GetAppsListOutput, GetAppsListOutputError>) -> Void)
    ...
    func getComplianceDetail(input: GetComplianceDetailInput, completion: @escaping (SdkResult<GetComplianceDetailOutput, GetComplianceDetailOutputError>) -> Void)
    /// <p>Information
    ///       about the Amazon Simple Notification Service (SNS) topic that is used to
    ///       record AWS Firewall Manager SNS logs.</p>
    func getNotificationChannel(input: GetNotificationChannelInput, completion: @escaping (SdkResult<GetNotificationChannelOutput, GetNotificationChannelOutputError>) -> Void)
    ...
    func getProtectionStatus(input: GetProtectionStatusInput, completion: @escaping (SdkResult<GetProtectionStatusOutput, GetProtectionStatusOutputError>) -> Void)
    /// <p>Returns information about the specified AWS Firewall Manager protocols list.</p>
    func getProtocolsList(input: GetProtocolsListInput, completion: @escaping (SdkResult<GetProtocolsListOutput, GetProtocolsListOutputError>) -> Void)
    /// <p>Retrieves violations for a resource based on the specified AWS Firewall Manager policy and AWS account.</p>
    func getViolationDetails(input: GetViolationDetailsInput, completion: @escaping (SdkResult<GetViolationDetailsOutput, GetViolationDetailsOutputError>) -> Void)
    /// <p>Returns an array of <code>AppsListDataSummary</code> objects.</p>
    func listAppsLists(input: ListAppsListsInput, completion: @escaping (SdkResult<ListAppsListsOutput, ListAppsListsOutputError>) -> Void)
    ...
    func listComplianceStatus(input: ListComplianceStatusInput, completion: @escaping (SdkResult<ListComplianceStatusOutput, ListComplianceStatusOutputError>) -> Void)
    ...
    func listProtocolsLists(input: ListProtocolsListsInput, completion: @escaping (SdkResult<ListProtocolsListsOutput, ListProtocolsListsOutputError>) -> Void)
    ...
    func putAppsList(input: PutAppsListInput, completion: @escaping (SdkResult<PutAppsListOutput, PutAppsListOutputError>) -> Void)
    ...
    func putNotificationChannel(input: PutNotificationChannelInput, completion: @escaping (SdkResult<PutNotificationChannelOutput, PutNotificationChannelOutputError>) -> Void)
    ...
    func putProtocolsList(input: PutProtocolsListInput, completion: @escaping (SdkResult<PutProtocolsListOutput, PutProtocolsListOutputError>) -> Void)
