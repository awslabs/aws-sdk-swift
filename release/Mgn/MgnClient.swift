...
public class MgnClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try MgnClientConfiguration(region: unwrappedRegion)
    ...
    public class MgnClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("MgnClient")
...
public struct MgnClientLogHandlerFactory: SDKLogHandlerFactory {
