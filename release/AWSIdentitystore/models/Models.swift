...
extension DescribeUserOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeUserOutputResponse(userId: \(Swift.String(describing: userId)), userName: \"CONTENT_REDACTED\")"}
}
...
extension IdentitystoreClientTypes.User: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "User(userId: \(Swift.String(describing: userId)), userName: \"CONTENT_REDACTED\")"}
}
