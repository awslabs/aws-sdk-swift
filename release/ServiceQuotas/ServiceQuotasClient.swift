...
public class ServiceQuotasClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try ServiceQuotasClientConfiguration(region: unwrappedRegion)
    ...
    public class ServiceQuotasClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("ServiceQuotasClient")
