...
extension Iot1ClickProjectsClient: Iot1ClickProjectsClientProtocol {
    ...
    public func associateDeviceWithPlacement(input: AssociateDeviceWithPlacementInput, completion: @escaping (ClientRuntime.SdkResult<AssociateDeviceWithPlacementOutputResponse, AssociateDeviceWithPlacementOutputError>) -> Void)
    {
        ...
        guard let placementName = input.placementName else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component placementName unexpectedly nil"))))
            return
        }
        guard let deviceTemplateName = input.deviceTemplateName else {
            completion(.failure(.client(ClientRuntime.ClientError.serializationFailed("uri component deviceTemplateName unexpectedly nil"))))
            return
        }
