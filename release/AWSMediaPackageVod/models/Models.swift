...
extension MediaPackageVodClientTypes {
    ...
    public struct CmafEncryption: Swift.Equatable {
        ...
        /// This member is required.
        var spekeKeyProvider: MediaPackageVodClientTypes.SpekeKeyProvider?
...
extension MediaPackageVodClientTypes {
    ...
    public struct CmafPackage: Swift.Equatable {
        /// A CMAF encryption configuration.
        var encryption: MediaPackageVodClientTypes.CmafEncryption?
        /// A list of HLS manifest configurations.
        /// This member is required.
        var hlsManifests: [MediaPackageVodClientTypes.HlsManifest]?
        /// When includeEncoderConfigurationInSegments is set to true, MediaPackage places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and Video Parameter Set (VPS) metadata in every video segment instead of in the init fragment. This lets you use different SPS/PPS/VPS settings for your assets during content playback.
        var includeEncoderConfigurationInSegments: Swift.Bool?
...
public struct ConfigureLogsInput: Swift.Equatable {
    ...
    var egressAccessLogs: MediaPackageVodClientTypes.EgressAccessLogs?
...
public struct ConfigureLogsOutputResponse: Swift.Equatable {
    ...
    var arn: Swift.String?
    /// CDN Authorization credentials
    var authorization: MediaPackageVodClientTypes.Authorization?
...
public struct CreateAssetOutputResponse: Swift.Equatable {
    ...
    var egressEndpoints: [MediaPackageVodClientTypes.EgressEndpoint]?
    /// The unique identifier for the Asset.
    var id: Swift.String?
    /// The ID of the PackagingGroup for the Asset.
    var packagingGroupId: Swift.String?
...
public struct CreatePackagingConfigurationInput: Swift.Equatable {
    /// A CMAF packaging configuration.
    var cmafPackage: MediaPackageVodClientTypes.CmafPackage?
    /// A Dynamic Adaptive Streaming over HTTP (DASH) packaging configuration.
    var dashPackage: MediaPackageVodClientTypes.DashPackage?
    /// An HTTP Live Streaming (HLS) packaging configuration.
    var hlsPackage: MediaPackageVodClientTypes.HlsPackage?
    /// The ID of the PackagingConfiguration.
    /// This member is required.
    var id: Swift.String?
    /// A Microsoft Smooth Streaming (MSS) PackagingConfiguration.
    var mssPackage: MediaPackageVodClientTypes.MssPackage?
...
extension MediaPackageVodClientTypes {
    ...
    public struct DashManifest: Swift.Equatable {
        ...
        var manifestLayout: MediaPackageVodClientTypes.ManifestLayout?
        /// An optional string to include in the name of the manifest.
        var manifestName: Swift.String?
        /// Minimum duration (in seconds) that a player will buffer media before starting the presentation.
        var minBufferTimeSeconds: Swift.Int?
        /// The Dynamic Adaptive Streaming over HTTP (DASH) profile type. When set to "HBBTV_1_5", HbbTV 1.5 compliant output is enabled.
        var profile: MediaPackageVodClientTypes.Profile?
        /// A StreamSelection configuration.
        var streamSelection: MediaPackageVodClientTypes.StreamSelection?
...
extension MediaPackageVodClientTypes {
    ...
    public struct DashPackage: Swift.Equatable {
        ...
        /// This member is required.
        var dashManifests: [MediaPackageVodClientTypes.DashManifest]?
        /// A Dynamic Adaptive Streaming over HTTP (DASH) encryption configuration.
        var encryption: MediaPackageVodClientTypes.DashEncryption?
        /// When includeEncoderConfigurationInSegments is set to true, MediaPackage places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and Video Parameter Set (VPS) metadata in every video segment instead of in the init fragment. This lets you use different SPS/PPS/VPS settings for your assets during content playback.
        var includeEncoderConfigurationInSegments: Swift.Bool?
        /// A list of triggers that controls when the outgoing Dynamic Adaptive Streaming over HTTP (DASH) Media Presentation Description (MPD) will be partitioned into multiple periods. If empty, the content will not be partitioned into more than one period. If the list contains "ADS", new periods will be created where the Asset contains SCTE-35 ad markers.
        var periodTriggers: [MediaPackageVodClientTypes.__PeriodTriggersElement]?
        /// Duration (in seconds) of each segment. Actual segments will be rounded to the nearest multiple of the source segment duration.
        var segmentDurationSeconds: Swift.Int?
        /// Determines the type of SegmentTemplate included in the Media Presentation Description (MPD). When set to NUMBER_WITH_TIMELINE, a full timeline is presented in each SegmentTemplate, with $Number$ media URLs. When set to TIME_WITH_TIMELINE, a full timeline is presented in each SegmentTemplate, with $Time$ media URLs. When set to NUMBER_WITH_DURATION, only a duration is included in each SegmentTemplate, with $Number$ media URLs.
        var segmentTemplateFormat: MediaPackageVodClientTypes.SegmentTemplateFormat?
...
extension MediaPackageVodClientTypes {
    ...
    public struct EgressEndpoint: Swift.Equatable {
        ...
        var packagingConfigurationId: Swift.String?
...
extension MediaPackageVodClientTypes {
    ...
    public struct HlsEncryption: Swift.Equatable {
        ...
        var encryptionMethod: MediaPackageVodClientTypes.EncryptionMethod?
        /// A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
        /// This member is required.
        var spekeKeyProvider: MediaPackageVodClientTypes.SpekeKeyProvider?
...
extension MediaPackageVodClientTypes {
    ...
    public struct HlsManifest: Swift.Equatable {
        ...
        var adMarkers: MediaPackageVodClientTypes.AdMarkers?
...
extension MediaPackageVodClientTypes {
    ...
    public struct HlsPackage: Swift.Equatable {
        /// An HTTP Live Streaming (HLS) encryption configuration.
        var encryption: MediaPackageVodClientTypes.HlsEncryption?
        /// A list of HLS manifest configurations.
        /// This member is required.
        var hlsManifests: [MediaPackageVodClientTypes.HlsManifest]?
...
public struct ListAssetsOutputResponse: Swift.Equatable {
    ...
    var assets: [MediaPackageVodClientTypes.AssetShallow]?
...
public struct ListPackagingConfigurationsOutputResponse: Swift.Equatable {
    ...
    var packagingConfigurations: [MediaPackageVodClientTypes.PackagingConfiguration]?
...
public struct ListPackagingGroupsOutputResponse: Swift.Equatable {
    ...
    var packagingGroups: [MediaPackageVodClientTypes.PackagingGroup]?
...
extension MediaPackageVodClientTypes {
    ...
    public struct MssPackage: Swift.Equatable {
        /// A Microsoft Smooth Streaming (MSS) encryption configuration.
        var encryption: MediaPackageVodClientTypes.MssEncryption?
        /// A list of MSS manifest configurations.
        /// This member is required.
        var mssManifests: [MediaPackageVodClientTypes.MssManifest]?
...
extension MediaPackageVodClientTypes {
    ...
    public struct StreamSelection: Swift.Equatable {
        ...
        var streamOrder: MediaPackageVodClientTypes.StreamOrder?
