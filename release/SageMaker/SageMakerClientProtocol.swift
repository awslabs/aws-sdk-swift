...
public protocol SageMakerClientProtocol {
    ...
    func addAssociation(input: AddAssociationInput, completion: @escaping (SdkResult<AddAssociationOutputResponse, AddAssociationOutputError>) -> Void)
    ...
    func associateTrialComponent(input: AssociateTrialComponentInput, completion: @escaping (SdkResult<AssociateTrialComponentOutputResponse, AssociateTrialComponentOutputError>) -> Void)
    ...
    ///          </note>
    func createAction(input: CreateActionInput, completion: @escaping (SdkResult<CreateActionOutputResponse, CreateActionOutputError>) -> Void)
    /// <p>Create a machine learning algorithm that you can use in Amazon SageMaker and list in the AWS
    ///             Marketplace.</p>
    func createAlgorithm(input: CreateAlgorithmInput, completion: @escaping (SdkResult<CreateAlgorithmOutputResponse, CreateAlgorithmOutputError>) -> Void)
    ...
    func createAppImageConfig(input: CreateAppImageConfigInput, completion: @escaping (SdkResult<CreateAppImageConfigOutputResponse, CreateAppImageConfigOutputError>) -> Void)
    ...
    ///           environments results in an error.</p>
    ///          </note>
    func createArtifact(input: CreateArtifactInput, completion: @escaping (SdkResult<CreateArtifactOutputResponse, CreateArtifactOutputError>) -> Void)
    ...
    func createAutoMLJob(input: CreateAutoMLJobInput, completion: @escaping (SdkResult<CreateAutoMLJobOutputResponse, CreateAutoMLJobOutputError>) -> Void)
    ...
    func createCodeRepository(input: CreateCodeRepositoryInput, completion: @escaping (SdkResult<CreateCodeRepositoryOutputResponse, CreateCodeRepositoryOutputError>) -> Void)
    ...
    func createCompilationJob(input: CreateCompilationJobInput, completion: @escaping (SdkResult<CreateCompilationJobOutputResponse, CreateCompilationJobOutputError>) -> Void)
    ...
    ///           environments results in an error.</p>
    ///          </note>
    func createContext(input: CreateContextInput, completion: @escaping (SdkResult<CreateContextOutputResponse, CreateContextOutputError>) -> Void)
    ...
    func createDataQualityJobDefinition(input: CreateDataQualityJobDefinitionInput, completion: @escaping (SdkResult<CreateDataQualityJobDefinitionOutputResponse, CreateDataQualityJobDefinitionOutputError>) -> Void)
    /// <p>Creates a device fleet.</p>
    func createDeviceFleet(input: CreateDeviceFleetInput, completion: @escaping (SdkResult<CreateDeviceFleetOutputResponse, CreateDeviceFleetOutputError>) -> Void)
    ...
    func createEdgePackagingJob(input: CreateEdgePackagingJobInput, completion: @escaping (SdkResult<CreateEdgePackagingJobOutputResponse, CreateEdgePackagingJobOutputError>) -> Void)
    ...
    ///                 these possible issues. We also recommend that customers call <a>DescribeEndpointConfig</a> before calling <a>CreateEndpoint</a> to minimize the potential impact of a DynamoDB eventually consistent read.</p>
    ///         </note>
    func createEndpointConfig(input: CreateEndpointConfigInput, completion: @escaping (SdkResult<CreateEndpointConfigOutputResponse, CreateEndpointConfigOutputError>) -> Void)
    ...
    func createExperiment(input: CreateExperimentInput, completion: @escaping (SdkResult<CreateExperimentOutputResponse, CreateExperimentOutputError>) -> Void)
    ...
    ///          </important>
    func createFeatureGroup(input: CreateFeatureGroupInput, completion: @escaping (SdkResult<CreateFeatureGroupOutputResponse, CreateFeatureGroupOutputError>) -> Void)
    /// <p>Creates a flow definition.</p>
    func createFlowDefinition(input: CreateFlowDefinitionInput, completion: @escaping (SdkResult<CreateFlowDefinitionOutputResponse, CreateFlowDefinitionOutputError>) -> Void)
    ...
    func createHumanTaskUi(input: CreateHumanTaskUiInput, completion: @escaping (SdkResult<CreateHumanTaskUiOutputResponse, CreateHumanTaskUiOutputError>) -> Void)
    ...
    func createHyperParameterTuningJob(input: CreateHyperParameterTuningJobInput, completion: @escaping (SdkResult<CreateHyperParameterTuningJobOutputResponse, CreateHyperParameterTuningJobOutputError>) -> Void)
    ...
    func createImageVersion(input: CreateImageVersionInput, completion: @escaping (SdkResult<CreateImageVersionOutputResponse, CreateImageVersionOutputError>) -> Void)
    ...
    ///                 Job</a>.</p>
    func createLabelingJob(input: CreateLabelingJobInput, completion: @escaping (SdkResult<CreateLabelingJobOutputResponse, CreateLabelingJobOutputError>) -> Void)
    ...
    func createModelBiasJobDefinition(input: CreateModelBiasJobDefinitionInput, completion: @escaping (SdkResult<CreateModelBiasJobDefinitionOutputResponse, CreateModelBiasJobDefinitionOutputError>) -> Void)
    /// <p>Creates the definition for a model explainability job.</p>
    func createModelExplainabilityJobDefinition(input: CreateModelExplainabilityJobDefinitionInput, completion: @escaping (SdkResult<CreateModelExplainabilityJobDefinitionOutputResponse, CreateModelExplainabilityJobDefinitionOutputError>) -> Void)
    ...
    ///             </ul>
    ///         </note>
    func createModelPackage(input: CreateModelPackageInput, completion: @escaping (SdkResult<CreateModelPackageOutputResponse, CreateModelPackageOutputError>) -> Void)
    /// <p>Creates a model group. A model group contains a group of model versions.</p>
    func createModelPackageGroup(input: CreateModelPackageGroupInput, completion: @escaping (SdkResult<CreateModelPackageGroupOutputResponse, CreateModelPackageGroupOutputError>) -> Void)
    /// <p>Creates a definition for a job that monitors model quality and drift. For information
    ///          about model monitor, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/model-monitor.html">Amazon SageMaker Model Monitor</a>.</p>
    func createModelQualityJobDefinition(input: CreateModelQualityJobDefinitionInput, completion: @escaping (SdkResult<CreateModelQualityJobDefinitionOutputResponse, CreateModelQualityJobDefinitionOutputError>) -> Void)
    ...
    func createMonitoringSchedule(input: CreateMonitoringScheduleInput, completion: @escaping (SdkResult<CreateMonitoringScheduleOutputResponse, CreateMonitoringScheduleOutputError>) -> Void)
    ...
    func createNotebookInstance(input: CreateNotebookInstanceInput, completion: @escaping (SdkResult<CreateNotebookInstanceOutputResponse, CreateNotebookInstanceOutputError>) -> Void)
    ...
    func createNotebookInstanceLifecycleConfig(input: CreateNotebookInstanceLifecycleConfigInput, completion: @escaping (SdkResult<CreateNotebookInstanceLifecycleConfigOutputResponse, CreateNotebookInstanceLifecycleConfigOutputError>) -> Void)
    ...
    ///          </note>
    func createPresignedDomainUrl(input: CreatePresignedDomainUrlInput, completion: @escaping (SdkResult<CreatePresignedDomainUrlOutputResponse, CreatePresignedDomainUrlOutputError>) -> Void)
    ...
    ///         </note>
    func createPresignedNotebookInstanceUrl(input: CreatePresignedNotebookInstanceUrlInput, completion: @escaping (SdkResult<CreatePresignedNotebookInstanceUrlOutputResponse, CreatePresignedNotebookInstanceUrlOutputError>) -> Void)
    /// <p>Creates a processing job.</p>
    func createProcessingJob(input: CreateProcessingJobInput, completion: @escaping (SdkResult<CreateProcessingJobOutputResponse, CreateProcessingJobOutputError>) -> Void)
    ...
    func createTrainingJob(input: CreateTrainingJobInput, completion: @escaping (SdkResult<CreateTrainingJobOutputResponse, CreateTrainingJobOutputError>) -> Void)
    ...
    ///                 Transform</a>.</p>
    func createTransformJob(input: CreateTransformJobInput, completion: @escaping (SdkResult<CreateTransformJobOutputResponse, CreateTransformJobOutputError>) -> Void)
    ...
    func createTrial(input: CreateTrialInput, completion: @escaping (SdkResult<CreateTrialOutputResponse, CreateTrialOutputError>) -> Void)
    ...
    ///         environments results in an error.</p>
    ///          </note>
    func createTrialComponent(input: CreateTrialComponentInput, completion: @escaping (SdkResult<CreateTrialComponentOutputResponse, CreateTrialComponentOutputError>) -> Void)
    ...
    func createWorkforce(input: CreateWorkforceInput, completion: @escaping (SdkResult<CreateWorkforceOutputResponse, CreateWorkforceOutputError>) -> Void)
    ...
    func createWorkteam(input: CreateWorkteamInput, completion: @escaping (SdkResult<CreateWorkteamOutputResponse, CreateWorkteamOutputError>) -> Void)
    /// <p>Deletes an action.</p>
    func deleteAction(input: DeleteActionInput, completion: @escaping (SdkResult<DeleteActionOutputResponse, DeleteActionOutputError>) -> Void)
    /// <p>Removes the specified algorithm from your account.</p>
    func deleteAlgorithm(input: DeleteAlgorithmInput, completion: @escaping (SdkResult<DeleteAlgorithmOutputResponse, DeleteAlgorithmOutputError>) -> Void)
    ...
    func deleteAppImageConfig(input: DeleteAppImageConfigInput, completion: @escaping (SdkResult<DeleteAppImageConfigOutputResponse, DeleteAppImageConfigOutputError>) -> Void)
    /// <p>Deletes an artifact. Either <code>ArtifactArn</code> or <code>Source</code> must be
    ///         specified.</p>
    func deleteArtifact(input: DeleteArtifactInput, completion: @escaping (SdkResult<DeleteArtifactOutputResponse, DeleteArtifactOutputError>) -> Void)
    ...
    func deleteCodeRepository(input: DeleteCodeRepositoryInput, completion: @escaping (SdkResult<DeleteCodeRepositoryOutputResponse, DeleteCodeRepositoryOutputError>) -> Void)
    /// <p>Deletes an context.</p>
    func deleteContext(input: DeleteContextInput, completion: @escaping (SdkResult<DeleteContextOutputResponse, DeleteContextOutputError>) -> Void)
    /// <p>Deletes a data quality monitoring job definition.</p>
    func deleteDataQualityJobDefinition(input: DeleteDataQualityJobDefinitionInput, completion: @escaping (SdkResult<DeleteDataQualityJobDefinitionOutputResponse, DeleteDataQualityJobDefinitionOutputError>) -> Void)
    /// <p>Deletes a fleet.</p>
    func deleteDeviceFleet(input: DeleteDeviceFleetInput, completion: @escaping (SdkResult<DeleteDeviceFleetOutputResponse, DeleteDeviceFleetOutputError>) -> Void)
    ...
    ///             incurring charges.</p>
    func deleteEndpointConfig(input: DeleteEndpointConfigInput, completion: @escaping (SdkResult<DeleteEndpointConfigOutputResponse, DeleteEndpointConfigOutputError>) -> Void)
    ...
    ///       the experiment.</p>
    func deleteExperiment(input: DeleteExperimentInput, completion: @escaping (SdkResult<DeleteExperimentOutputResponse, DeleteExperimentOutputError>) -> Void)
    ...
    ///          not deleted. </p>
    func deleteFeatureGroup(input: DeleteFeatureGroupInput, completion: @escaping (SdkResult<DeleteFeatureGroupOutputResponse, DeleteFeatureGroupOutputError>) -> Void)
    /// <p>Deletes the specified flow definition.</p>
    func deleteFlowDefinition(input: DeleteFlowDefinitionInput, completion: @escaping (SdkResult<DeleteFlowDefinitionOutputResponse, DeleteFlowDefinitionOutputError>) -> Void)
    ...
    func deleteHumanTaskUi(input: DeleteHumanTaskUiInput, completion: @escaping (SdkResult<DeleteHumanTaskUiOutputResponse, DeleteHumanTaskUiOutputError>) -> Void)
    ...
    ///         deleted.</p>
    func deleteImageVersion(input: DeleteImageVersionInput, completion: @escaping (SdkResult<DeleteImageVersionOutputResponse, DeleteImageVersionOutputError>) -> Void)
    ...
    func deleteModelBiasJobDefinition(input: DeleteModelBiasJobDefinitionInput, completion: @escaping (SdkResult<DeleteModelBiasJobDefinitionOutputResponse, DeleteModelBiasJobDefinitionOutputError>) -> Void)
    /// <p>Deletes an Amazon SageMaker model explainability job definition.</p>
    func deleteModelExplainabilityJobDefinition(input: DeleteModelExplainabilityJobDefinitionInput, completion: @escaping (SdkResult<DeleteModelExplainabilityJobDefinitionOutputResponse, DeleteModelExplainabilityJobDefinitionOutputError>) -> Void)
    ...
    func deleteModelPackage(input: DeleteModelPackageInput, completion: @escaping (SdkResult<DeleteModelPackageOutputResponse, DeleteModelPackageOutputError>) -> Void)
    /// <p>Deletes the specified model group.</p>
    func deleteModelPackageGroup(input: DeleteModelPackageGroupInput, completion: @escaping (SdkResult<DeleteModelPackageGroupOutputResponse, DeleteModelPackageGroupOutputError>) -> Void)
    /// <p>Deletes a model group resource policy.</p>
    func deleteModelPackageGroupPolicy(input: DeleteModelPackageGroupPolicyInput, completion: @escaping (SdkResult<DeleteModelPackageGroupPolicyOutputResponse, DeleteModelPackageGroupPolicyOutputError>) -> Void)
    /// <p>Deletes the secified model quality monitoring job definition.</p>
    func deleteModelQualityJobDefinition(input: DeleteModelQualityJobDefinitionInput, completion: @escaping (SdkResult<DeleteModelQualityJobDefinitionOutputResponse, DeleteModelQualityJobDefinitionOutputError>) -> Void)
    ...
    func deleteMonitoringSchedule(input: DeleteMonitoringScheduleInput, completion: @escaping (SdkResult<DeleteMonitoringScheduleOutputResponse, DeleteMonitoringScheduleOutputError>) -> Void)
    ...
    ///         </important>
    func deleteNotebookInstance(input: DeleteNotebookInstanceInput, completion: @escaping (SdkResult<DeleteNotebookInstanceOutputResponse, DeleteNotebookInstanceOutputError>) -> Void)
    /// <p>Deletes a notebook instance lifecycle configuration.</p>
    func deleteNotebookInstanceLifecycleConfig(input: DeleteNotebookInstanceLifecycleConfigInput, completion: @escaping (SdkResult<DeleteNotebookInstanceLifecycleConfigOutputResponse, DeleteNotebookInstanceLifecycleConfigOutputError>) -> Void)
    ...
    ///       components.</p>
    func deleteTrial(input: DeleteTrialInput, completion: @escaping (SdkResult<DeleteTrialOutputResponse, DeleteTrialOutputError>) -> Void)
    ...
    func deleteTrialComponent(input: DeleteTrialComponentInput, completion: @escaping (SdkResult<DeleteTrialComponentOutputResponse, DeleteTrialComponentOutputError>) -> Void)
    ...
    ///         </important>
    func deleteWorkforce(input: DeleteWorkforceInput, completion: @escaping (SdkResult<DeleteWorkforceOutputResponse, DeleteWorkforceOutputError>) -> Void)
    /// <p>Deletes an existing work team. This operation can't be undone.</p>
    func deleteWorkteam(input: DeleteWorkteamInput, completion: @escaping (SdkResult<DeleteWorkteamOutputResponse, DeleteWorkteamOutputError>) -> Void)
    /// <p>Deregisters the specified devices. After you deregister a device, you will need to re-register the devices.</p>
    func deregisterDevices(input: DeregisterDevicesInput, completion: @escaping (SdkResult<DeregisterDevicesOutputResponse, DeregisterDevicesOutputError>) -> Void)
    /// <p>Describes an action.</p>
    func describeAction(input: DescribeActionInput, completion: @escaping (SdkResult<DescribeActionOutputResponse, DescribeActionOutputError>) -> Void)
    ...
    func describeApp(input: DescribeAppInput, completion: @escaping (SdkResult<DescribeAppOutputResponse, DescribeAppOutputError>) -> Void)
    /// <p>Describes an AppImageConfig.</p>
    func describeAppImageConfig(input: DescribeAppImageConfigInput, completion: @escaping (SdkResult<DescribeAppImageConfigOutputResponse, DescribeAppImageConfigOutputError>) -> Void)
    /// <p>Describes an artifact.</p>
    func describeArtifact(input: DescribeArtifactInput, completion: @escaping (SdkResult<DescribeArtifactOutputResponse, DescribeArtifactOutputError>) -> Void)
    /// <p>Returns information about an Amazon SageMaker AutoML job.</p>
    func describeAutoMLJob(input: DescribeAutoMLJobInput, completion: @escaping (SdkResult<DescribeAutoMLJobOutputResponse, DescribeAutoMLJobOutputError>) -> Void)
    /// <p>Gets details about the specified Git repository.</p>
    func describeCodeRepository(input: DescribeCodeRepositoryInput, completion: @escaping (SdkResult<DescribeCodeRepositoryOutputResponse, DescribeCodeRepositoryOutputError>) -> Void)
    ...
    func describeCompilationJob(input: DescribeCompilationJobInput, completion: @escaping (SdkResult<DescribeCompilationJobOutputResponse, DescribeCompilationJobOutputError>) -> Void)
    /// <p>Describes a context.</p>
    func describeContext(input: DescribeContextInput, completion: @escaping (SdkResult<DescribeContextOutputResponse, DescribeContextOutputError>) -> Void)
    /// <p>Gets the details of a data quality monitoring job definition.</p>
    func describeDataQualityJobDefinition(input: DescribeDataQualityJobDefinitionInput, completion: @escaping (SdkResult<DescribeDataQualityJobDefinitionOutputResponse, DescribeDataQualityJobDefinitionOutputError>) -> Void)
    ...
    func describeDeviceFleet(input: DescribeDeviceFleetInput, completion: @escaping (SdkResult<DescribeDeviceFleetOutputResponse, DescribeDeviceFleetOutputError>) -> Void)
    ...
    func describeEdgePackagingJob(input: DescribeEdgePackagingJobInput, completion: @escaping (SdkResult<DescribeEdgePackagingJobOutputResponse, DescribeEdgePackagingJobOutputError>) -> Void)
    ...
    func describeEndpointConfig(input: DescribeEndpointConfigInput, completion: @escaping (SdkResult<DescribeEndpointConfigOutputResponse, DescribeEndpointConfigOutputError>) -> Void)
    /// <p>Provides a list of an experiment's properties.</p>
    func describeExperiment(input: DescribeExperimentInput, completion: @escaping (SdkResult<DescribeExperimentOutputResponse, DescribeExperimentOutputError>) -> Void)
    ...
    func describeFeatureGroup(input: DescribeFeatureGroupInput, completion: @escaping (SdkResult<DescribeFeatureGroupOutputResponse, DescribeFeatureGroupOutputError>) -> Void)
    /// <p>Returns information about the specified flow definition.</p>
    func describeFlowDefinition(input: DescribeFlowDefinitionInput, completion: @escaping (SdkResult<DescribeFlowDefinitionOutputResponse, DescribeFlowDefinitionOutputError>) -> Void)
    /// <p>Returns information about the requested human task user interface (worker task template).</p>
    func describeHumanTaskUi(input: DescribeHumanTaskUiInput, completion: @escaping (SdkResult<DescribeHumanTaskUiOutputResponse, DescribeHumanTaskUiOutputError>) -> Void)
    /// <p>Gets
    ///             a description of a hyperparameter tuning job.</p>
    func describeHyperParameterTuningJob(input: DescribeHyperParameterTuningJobInput, completion: @escaping (SdkResult<DescribeHyperParameterTuningJobOutputResponse, DescribeHyperParameterTuningJobOutputError>) -> Void)
    /// <p>Describes a SageMaker image.</p>
    func describeImage(input: DescribeImageInput, completion: @escaping (SdkResult<DescribeImageOutputResponse, DescribeImageOutputError>) -> Void)
    /// <p>Describes a version of a SageMaker image.</p>
    func describeImageVersion(input: DescribeImageVersionInput, completion: @escaping (SdkResult<DescribeImageVersionOutputResponse, DescribeImageVersionOutputError>) -> Void)
    /// <p>Gets information about a labeling job.</p>
    func describeLabelingJob(input: DescribeLabelingJobInput, completion: @escaping (SdkResult<DescribeLabelingJobOutputResponse, DescribeLabelingJobOutputError>) -> Void)
    ...
    func describeModelBiasJobDefinition(input: DescribeModelBiasJobDefinitionInput, completion: @escaping (SdkResult<DescribeModelBiasJobDefinitionOutputResponse, DescribeModelBiasJobDefinitionOutputError>) -> Void)
    /// <p>Returns a description of a model explainability job definition.</p>
    func describeModelExplainabilityJobDefinition(input: DescribeModelExplainabilityJobDefinitionInput, completion: @escaping (SdkResult<DescribeModelExplainabilityJobDefinitionOutputResponse, DescribeModelExplainabilityJobDefinitionOutputError>) -> Void)
    ...
    ///             Marketplace.</p>
    func describeModelPackage(input: DescribeModelPackageInput, completion: @escaping (SdkResult<DescribeModelPackageOutputResponse, DescribeModelPackageOutputError>) -> Void)
    /// <p>Gets a description for the specified model group.</p>
    func describeModelPackageGroup(input: DescribeModelPackageGroupInput, completion: @escaping (SdkResult<DescribeModelPackageGroupOutputResponse, DescribeModelPackageGroupOutputError>) -> Void)
    /// <p>Returns a description of a model quality job definition.</p>
    func describeModelQualityJobDefinition(input: DescribeModelQualityJobDefinitionInput, completion: @escaping (SdkResult<DescribeModelQualityJobDefinitionOutputResponse, DescribeModelQualityJobDefinitionOutputError>) -> Void)
    /// <p>Describes the schedule for a monitoring job.</p>
    func describeMonitoringSchedule(input: DescribeMonitoringScheduleInput, completion: @escaping (SdkResult<DescribeMonitoringScheduleOutputResponse, DescribeMonitoringScheduleOutputError>) -> Void)
    /// <p>Returns information about a notebook instance.</p>
    func describeNotebookInstance(input: DescribeNotebookInstanceInput, completion: @escaping (SdkResult<DescribeNotebookInstanceOutputResponse, DescribeNotebookInstanceOutputError>) -> Void)
    /// <p>Returns a description of a notebook instance lifecycle configuration.</p>
    ///         <p>For information about notebook instance lifestyle configurations, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/notebook-lifecycle-config.html">Step
    ///                 2.1: (Optional) Customize a Notebook Instance</a>.</p>
    func describeNotebookInstanceLifecycleConfig(input: DescribeNotebookInstanceLifecycleConfigInput, completion: @escaping (SdkResult<DescribeNotebookInstanceLifecycleConfigOutputResponse, DescribeNotebookInstanceLifecycleConfigOutputError>) -> Void)
    ...
    func describePipelineDefinitionForExecution(input: DescribePipelineDefinitionForExecutionInput, completion: @escaping (SdkResult<DescribePipelineDefinitionForExecutionOutputResponse, DescribePipelineDefinitionForExecutionOutputError>) -> Void)
    /// <p>Describes the details of a pipeline execution.</p>
    func describePipelineExecution(input: DescribePipelineExecutionInput, completion: @escaping (SdkResult<DescribePipelineExecutionOutputResponse, DescribePipelineExecutionOutputError>) -> Void)
    /// <p>Returns a description of a processing job.</p>
    func describeProcessingJob(input: DescribeProcessingJobInput, completion: @escaping (SdkResult<DescribeProcessingJobOutputResponse, DescribeProcessingJobOutputError>) -> Void)
    ...
    func describeSubscribedWorkteam(input: DescribeSubscribedWorkteamInput, completion: @escaping (SdkResult<DescribeSubscribedWorkteamOutputResponse, DescribeSubscribedWorkteamOutputError>) -> Void)
    ...
    func describeTrainingJob(input: DescribeTrainingJobInput, completion: @escaping (SdkResult<DescribeTrainingJobOutputResponse, DescribeTrainingJobOutputError>) -> Void)
    /// <p>Returns information about a transform job.</p>
    func describeTransformJob(input: DescribeTransformJobInput, completion: @escaping (SdkResult<DescribeTransformJobOutputResponse, DescribeTransformJobOutputError>) -> Void)
    /// <p>Provides a list of a trial's properties.</p>
    func describeTrial(input: DescribeTrialInput, completion: @escaping (SdkResult<DescribeTrialOutputResponse, DescribeTrialOutputError>) -> Void)
    /// <p>Provides a list of a trials component's properties.</p>
    func describeTrialComponent(input: DescribeTrialComponentInput, completion: @escaping (SdkResult<DescribeTrialComponentOutputResponse, DescribeTrialComponentOutputError>) -> Void)
    ...
    ///         </important>
    func describeWorkforce(input: DescribeWorkforceInput, completion: @escaping (SdkResult<DescribeWorkforceOutputResponse, DescribeWorkforceOutputError>) -> Void)
    ...
    ///             Resource Name (ARN).</p>
    func describeWorkteam(input: DescribeWorkteamInput, completion: @escaping (SdkResult<DescribeWorkteamOutputResponse, DescribeWorkteamOutputError>) -> Void)
    /// <p>Disables using Service Catalog in SageMaker. Service Catalog is used to create
    ///             SageMaker projects.</p>
    func disableSagemakerServicecatalogPortfolio(input: DisableSagemakerServicecatalogPortfolioInput, completion: @escaping (SdkResult<DisableSagemakerServicecatalogPortfolioOutputResponse, DisableSagemakerServicecatalogPortfolioOutputError>) -> Void)
    ...
    func disassociateTrialComponent(input: DisassociateTrialComponentInput, completion: @escaping (SdkResult<DisassociateTrialComponentOutputResponse, DisassociateTrialComponentOutputError>) -> Void)
    /// <p>Enables using Service Catalog in SageMaker. Service Catalog is used to create
    ///             SageMaker projects.</p>
    func enableSagemakerServicecatalogPortfolio(input: EnableSagemakerServicecatalogPortfolioInput, completion: @escaping (SdkResult<EnableSagemakerServicecatalogPortfolioOutputResponse, EnableSagemakerServicecatalogPortfolioOutputError>) -> Void)
    /// <p>Describes a fleet.</p>
    func getDeviceFleetReport(input: GetDeviceFleetReportInput, completion: @escaping (SdkResult<GetDeviceFleetReportOutputResponse, GetDeviceFleetReportOutputError>) -> Void)
    ...
    func getModelPackageGroupPolicy(input: GetModelPackageGroupPolicyInput, completion: @escaping (SdkResult<GetModelPackageGroupPolicyOutputResponse, GetModelPackageGroupPolicyOutputError>) -> Void)
    /// <p>Gets the status of Service Catalog in SageMaker. Service Catalog is used to create
    ///             SageMaker projects.</p>
    func getSagemakerServicecatalogPortfolioStatus(input: GetSagemakerServicecatalogPortfolioStatusInput, completion: @escaping (SdkResult<GetSagemakerServicecatalogPortfolioStatusOutputResponse, GetSagemakerServicecatalogPortfolioStatusOutputError>) -> Void)
    ...
    ///       <code>Metrics</code>.</p>
    func getSearchSuggestions(input: GetSearchSuggestionsInput, completion: @escaping (SdkResult<GetSearchSuggestionsOutputResponse, GetSearchSuggestionsOutputError>) -> Void)
    ...
    func listAlgorithms(input: ListAlgorithmsInput, completion: @escaping (SdkResult<ListAlgorithmsOutputResponse, ListAlgorithmsOutputError>) -> Void)
    ...
    func listAppImageConfigs(input: ListAppImageConfigsInput, completion: @escaping (SdkResult<ListAppImageConfigsOutputResponse, ListAppImageConfigsOutputError>) -> Void)
    /// <p>Lists apps.</p>
    ...
    func listAutoMLJobs(input: ListAutoMLJobsInput, completion: @escaping (SdkResult<ListAutoMLJobsOutputResponse, ListAutoMLJobsOutputError>) -> Void)
    /// <p>List the candidates created for the job.</p>
    func listCandidatesForAutoMLJob(input: ListCandidatesForAutoMLJobInput, completion: @escaping (SdkResult<ListCandidatesForAutoMLJobOutputResponse, ListCandidatesForAutoMLJobOutputError>) -> Void)
    /// <p>Gets a list of the Git repositories in your account.</p>
    func listCodeRepositories(input: ListCodeRepositoriesInput, completion: @escaping (SdkResult<ListCodeRepositoriesOutputResponse, ListCodeRepositoriesOutputError>) -> Void)
    ...
    func listCompilationJobs(input: ListCompilationJobsInput, completion: @escaping (SdkResult<ListCompilationJobsOutputResponse, ListCompilationJobsOutputError>) -> Void)
    /// <p>Lists the contexts in your account and their properties.</p>
    func listContexts(input: ListContextsInput, completion: @escaping (SdkResult<ListContextsOutputResponse, ListContextsOutputError>) -> Void)
    /// <p>Lists the data quality job definitions in your account.</p>
    func listDataQualityJobDefinitions(input: ListDataQualityJobDefinitionsInput, completion: @escaping (SdkResult<ListDataQualityJobDefinitionsOutputResponse, ListDataQualityJobDefinitionsOutputError>) -> Void)
    /// <p>Returns a list of devices in the fleet.</p>
    func listDeviceFleets(input: ListDeviceFleetsInput, completion: @escaping (SdkResult<ListDeviceFleetsOutputResponse, ListDeviceFleetsOutputError>) -> Void)
    ...
    func listEdgePackagingJobs(input: ListEdgePackagingJobsInput, completion: @escaping (SdkResult<ListEdgePackagingJobsOutputResponse, ListEdgePackagingJobsOutputError>) -> Void)
    /// <p>Lists endpoint configurations.</p>
    func listEndpointConfigs(input: ListEndpointConfigsInput, completion: @escaping (SdkResult<ListEndpointConfigsOutputResponse, ListEndpointConfigsOutputError>) -> Void)
    /// <p>Lists endpoints.</p>
    ...
    func listFeatureGroups(input: ListFeatureGroupsInput, completion: @escaping (SdkResult<ListFeatureGroupsOutputResponse, ListFeatureGroupsOutputError>) -> Void)
    /// <p>Returns information about the flow definitions in your account.</p>
    func listFlowDefinitions(input: ListFlowDefinitionsInput, completion: @escaping (SdkResult<ListFlowDefinitionsOutputResponse, ListFlowDefinitionsOutputError>) -> Void)
    /// <p>Returns information about the human task user interfaces in your account.</p>
    func listHumanTaskUis(input: ListHumanTaskUisInput, completion: @escaping (SdkResult<ListHumanTaskUisOutputResponse, ListHumanTaskUisOutputError>) -> Void)
    ...
    func listHyperParameterTuningJobs(input: ListHyperParameterTuningJobsInput, completion: @escaping (SdkResult<ListHyperParameterTuningJobsOutputResponse, ListHyperParameterTuningJobsOutputError>) -> Void)
    ...
    func listImageVersions(input: ListImageVersionsInput, completion: @escaping (SdkResult<ListImageVersionsOutputResponse, ListImageVersionsOutputError>) -> Void)
    /// <p>Gets a list of labeling jobs.</p>
    func listLabelingJobs(input: ListLabelingJobsInput, completion: @escaping (SdkResult<ListLabelingJobsOutputResponse, ListLabelingJobsOutputError>) -> Void)
    /// <p>Gets a list of labeling jobs assigned to a specified work team.</p>
    func listLabelingJobsForWorkteam(input: ListLabelingJobsForWorkteamInput, completion: @escaping (SdkResult<ListLabelingJobsForWorkteamOutputResponse, ListLabelingJobsForWorkteamOutputError>) -> Void)
    /// <p>Lists model bias jobs definitions that satisfy various filters.</p>
    func listModelBiasJobDefinitions(input: ListModelBiasJobDefinitionsInput, completion: @escaping (SdkResult<ListModelBiasJobDefinitionsOutputResponse, ListModelBiasJobDefinitionsOutputError>) -> Void)
    /// <p>Lists model explainability job definitions that satisfy various filters.</p>
    func listModelExplainabilityJobDefinitions(input: ListModelExplainabilityJobDefinitionsInput, completion: @escaping (SdkResult<ListModelExplainabilityJobDefinitionsOutputResponse, ListModelExplainabilityJobDefinitionsOutputError>) -> Void)
    /// <p>Gets a list of the model groups in your AWS account.</p>
    func listModelPackageGroups(input: ListModelPackageGroupsInput, completion: @escaping (SdkResult<ListModelPackageGroupsOutputResponse, ListModelPackageGroupsOutputError>) -> Void)
    /// <p>Lists the model packages that have been created.</p>
    func listModelPackages(input: ListModelPackagesInput, completion: @escaping (SdkResult<ListModelPackagesOutputResponse, ListModelPackagesOutputError>) -> Void)
    /// <p>Gets a list of model quality monitoring job definitions in your account.</p>
    func listModelQualityJobDefinitions(input: ListModelQualityJobDefinitionsInput, completion: @escaping (SdkResult<ListModelQualityJobDefinitionsOutputResponse, ListModelQualityJobDefinitionsOutputError>) -> Void)
    ...
    func listMonitoringExecutions(input: ListMonitoringExecutionsInput, completion: @escaping (SdkResult<ListMonitoringExecutionsOutputResponse, ListMonitoringExecutionsOutputError>) -> Void)
    /// <p>Returns list of all monitoring schedules.</p>
    func listMonitoringSchedules(input: ListMonitoringSchedulesInput, completion: @escaping (SdkResult<ListMonitoringSchedulesOutputResponse, ListMonitoringSchedulesOutputError>) -> Void)
    /// <p>Lists notebook instance lifestyle configurations created with the <a>CreateNotebookInstanceLifecycleConfig</a> API.</p>
    func listNotebookInstanceLifecycleConfigs(input: ListNotebookInstanceLifecycleConfigsInput, completion: @escaping (SdkResult<ListNotebookInstanceLifecycleConfigsOutputResponse, ListNotebookInstanceLifecycleConfigsOutputError>) -> Void)
    /// <p>Returns a list of the Amazon SageMaker notebook instances in the requester's account in an AWS
    ///             Region. </p>
    func listNotebookInstances(input: ListNotebookInstancesInput, completion: @escaping (SdkResult<ListNotebookInstancesOutputResponse, ListNotebookInstancesOutputError>) -> Void)
    ...
    func listPipelineExecutionSteps(input: ListPipelineExecutionStepsInput, completion: @escaping (SdkResult<ListPipelineExecutionStepsOutputResponse, ListPipelineExecutionStepsOutputError>) -> Void)
    /// <p>Gets a list of parameters for a pipeline execution.</p>
    func listPipelineParametersForExecution(input: ListPipelineParametersForExecutionInput, completion: @escaping (SdkResult<ListPipelineParametersForExecutionOutputResponse, ListPipelineParametersForExecutionOutputError>) -> Void)
    ...
    func listProcessingJobs(input: ListProcessingJobsInput, completion: @escaping (SdkResult<ListProcessingJobsOutputResponse, ListProcessingJobsOutputError>) -> Void)
    ...
    func listSubscribedWorkteams(input: ListSubscribedWorkteamsInput, completion: @escaping (SdkResult<ListSubscribedWorkteamsOutputResponse, ListSubscribedWorkteamsOutputError>) -> Void)
    ...
    ///             </p>
    ///         </note>
    func listTrainingJobs(input: ListTrainingJobsInput, completion: @escaping (SdkResult<ListTrainingJobsOutputResponse, ListTrainingJobsOutputError>) -> Void)
    ...
    func listTrainingJobsForHyperParameterTuningJob(input: ListTrainingJobsForHyperParameterTuningJobInput, completion: @escaping (SdkResult<ListTrainingJobsForHyperParameterTuningJobOutputResponse, ListTrainingJobsForHyperParameterTuningJobOutputError>) -> Void)
    /// <p>Lists transform jobs.</p>
    func listTransformJobs(input: ListTransformJobsInput, completion: @escaping (SdkResult<ListTransformJobsOutputResponse, ListTransformJobsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func listTrialComponents(input: ListTrialComponentsInput, completion: @escaping (SdkResult<ListTrialComponentsOutputResponse, ListTrialComponentsOutputError>) -> Void)
    ...
    ///       creation time.</p>
    func listTrials(input: ListTrialsInput, completion: @escaping (SdkResult<ListTrialsOutputResponse, ListTrialsOutputError>) -> Void)
    ...
    func listWorkforces(input: ListWorkforcesInput, completion: @escaping (SdkResult<ListWorkforcesOutputResponse, ListWorkforcesOutputError>) -> Void)
    ...
    ///             parameter.</p>
    func listWorkteams(input: ListWorkteamsInput, completion: @escaping (SdkResult<ListWorkteamsOutputResponse, ListWorkteamsOutputError>) -> Void)
    ...
    func putModelPackageGroupPolicy(input: PutModelPackageGroupPolicyInput, completion: @escaping (SdkResult<PutModelPackageGroupPolicyOutputResponse, PutModelPackageGroupPolicyOutputError>) -> Void)
    /// <p>Register devices.</p>
    func registerDevices(input: RegisterDevicesInput, completion: @escaping (SdkResult<RegisterDevicesOutputResponse, RegisterDevicesOutputError>) -> Void)
    /// <p>Renders the UI template so that you can preview the worker's experience. </p>
    func renderUiTemplate(input: RenderUiTemplateInput, completion: @escaping (SdkResult<RenderUiTemplateOutputResponse, RenderUiTemplateOutputError>) -> Void)
    ...
    ///          </note>
    func startMonitoringSchedule(input: StartMonitoringScheduleInput, completion: @escaping (SdkResult<StartMonitoringScheduleOutputResponse, StartMonitoringScheduleOutputError>) -> Void)
    ...
    func startNotebookInstance(input: StartNotebookInstanceInput, completion: @escaping (SdkResult<StartNotebookInstanceOutputResponse, StartNotebookInstanceOutputError>) -> Void)
    ...
    func stopAutoMLJob(input: StopAutoMLJobInput, completion: @escaping (SdkResult<StopAutoMLJobOutputResponse, StopAutoMLJobOutputError>) -> Void)
    ...
    ///         </p>
    func stopCompilationJob(input: StopCompilationJobInput, completion: @escaping (SdkResult<StopCompilationJobOutputResponse, StopCompilationJobOutputError>) -> Void)
    /// <p>Request to stop an edge packaging job.</p>
    func stopEdgePackagingJob(input: StopEdgePackagingJobInput, completion: @escaping (SdkResult<StopEdgePackagingJobOutputResponse, StopEdgePackagingJobOutputError>) -> Void)
    ...
    func stopHyperParameterTuningJob(input: StopHyperParameterTuningJobInput, completion: @escaping (SdkResult<StopHyperParameterTuningJobOutputResponse, StopHyperParameterTuningJobOutputError>) -> Void)
    ...
    func stopLabelingJob(input: StopLabelingJobInput, completion: @escaping (SdkResult<StopLabelingJobOutputResponse, StopLabelingJobOutputError>) -> Void)
    /// <p>Stops a previously started monitoring schedule.</p>
    func stopMonitoringSchedule(input: StopMonitoringScheduleInput, completion: @escaping (SdkResult<StopMonitoringScheduleOutputResponse, StopMonitoringScheduleOutputError>) -> Void)
    ...
    ///         </p>
    func stopNotebookInstance(input: StopNotebookInstanceInput, completion: @escaping (SdkResult<StopNotebookInstanceOutputResponse, StopNotebookInstanceOutputError>) -> Void)
    ...
    func stopProcessingJob(input: StopProcessingJobInput, completion: @escaping (SdkResult<StopProcessingJobOutputResponse, StopProcessingJobOutputError>) -> Void)
    ...
    ///                 <code>Stopped</code>.</p>
    func stopTrainingJob(input: StopTrainingJobInput, completion: @escaping (SdkResult<StopTrainingJobOutputResponse, StopTrainingJobOutputError>) -> Void)
    ...
    func stopTransformJob(input: StopTransformJobInput, completion: @escaping (SdkResult<StopTransformJobOutputResponse, StopTransformJobOutputError>) -> Void)
    /// <p>Updates an action.</p>
    func updateAction(input: UpdateActionInput, completion: @escaping (SdkResult<UpdateActionOutputResponse, UpdateActionOutputError>) -> Void)
    /// <p>Updates the properties of an AppImageConfig.</p>
    func updateAppImageConfig(input: UpdateAppImageConfigInput, completion: @escaping (SdkResult<UpdateAppImageConfigOutputResponse, UpdateAppImageConfigOutputError>) -> Void)
    /// <p>Updates an artifact.</p>
    func updateArtifact(input: UpdateArtifactInput, completion: @escaping (SdkResult<UpdateArtifactOutputResponse, UpdateArtifactOutputError>) -> Void)
    /// <p>Updates the specified Git repository with the specified values.</p>
    func updateCodeRepository(input: UpdateCodeRepositoryInput, completion: @escaping (SdkResult<UpdateCodeRepositoryOutputResponse, UpdateCodeRepositoryOutputError>) -> Void)
    /// <p>Updates a context.</p>
    func updateContext(input: UpdateContextInput, completion: @escaping (SdkResult<UpdateContextOutputResponse, UpdateContextOutputError>) -> Void)
    /// <p>Updates a fleet of devices.</p>
    func updateDeviceFleet(input: UpdateDeviceFleetInput, completion: @escaping (SdkResult<UpdateDeviceFleetOutputResponse, UpdateDeviceFleetOutputError>) -> Void)
    /// <p>Updates one or more devices in a fleet.</p>
    func updateDevices(input: UpdateDevicesInput, completion: @escaping (SdkResult<UpdateDevicesOutputResponse, UpdateDevicesOutputError>) -> Void)
    ...
    func updateEndpointWeightsAndCapacities(input: UpdateEndpointWeightsAndCapacitiesInput, completion: @escaping (SdkResult<UpdateEndpointWeightsAndCapacitiesOutputResponse, UpdateEndpointWeightsAndCapacitiesOutputError>) -> Void)
    /// <p>Adds, updates, or removes the description of an experiment. Updates the display name of an
    ///       experiment.</p>
    func updateExperiment(input: UpdateExperimentInput, completion: @escaping (SdkResult<UpdateExperimentOutputResponse, UpdateExperimentOutputError>) -> Void)
    /// <p>Updates the properties of a SageMaker image. To change the image's tags, use the
    ///         <a>AddTags</a> and <a>DeleteTags</a> APIs.</p>
    func updateImage(input: UpdateImageInput, completion: @escaping (SdkResult<UpdateImageOutputResponse, UpdateImageOutputError>) -> Void)
    /// <p>Updates a versioned model.</p>
    func updateModelPackage(input: UpdateModelPackageInput, completion: @escaping (SdkResult<UpdateModelPackageOutputResponse, UpdateModelPackageOutputError>) -> Void)
    /// <p>Updates a previously created schedule.</p>
    func updateMonitoringSchedule(input: UpdateMonitoringScheduleInput, completion: @escaping (SdkResult<UpdateMonitoringScheduleOutputResponse, UpdateMonitoringScheduleOutputError>) -> Void)
    ...
    func updateNotebookInstance(input: UpdateNotebookInstanceInput, completion: @escaping (SdkResult<UpdateNotebookInstanceOutputResponse, UpdateNotebookInstanceOutputError>) -> Void)
    /// <p>Updates a notebook instance lifecycle configuration created with the <a>CreateNotebookInstanceLifecycleConfig</a> API.</p>
    func updateNotebookInstanceLifecycleConfig(input: UpdateNotebookInstanceLifecycleConfigInput, completion: @escaping (SdkResult<UpdateNotebookInstanceLifecycleConfigOutputResponse, UpdateNotebookInstanceLifecycleConfigOutputError>) -> Void)
    ...
    func updatePipelineExecution(input: UpdatePipelineExecutionInput, completion: @escaping (SdkResult<UpdatePipelineExecutionOutputResponse, UpdatePipelineExecutionOutputError>) -> Void)
    /// <p>Update a model training job to request a new Debugger profiling configuration.</p>
    func updateTrainingJob(input: UpdateTrainingJobInput, completion: @escaping (SdkResult<UpdateTrainingJobOutputResponse, UpdateTrainingJobOutputError>) -> Void)
    /// <p>Updates the display name of a trial.</p>
    func updateTrial(input: UpdateTrialInput, completion: @escaping (SdkResult<UpdateTrialOutputResponse, UpdateTrialOutputError>) -> Void)
    /// <p>Updates one or more properties of a trial component.</p>
    func updateTrialComponent(input: UpdateTrialComponentInput, completion: @escaping (SdkResult<UpdateTrialComponentOutputResponse, UpdateTrialComponentOutputError>) -> Void)
    ...
    ///         </important>
    func updateWorkforce(input: UpdateWorkforceInput, completion: @escaping (SdkResult<UpdateWorkforceOutputResponse, UpdateWorkforceOutputError>) -> Void)
    /// <p>Updates an existing work team with new member definitions or description.</p>
    func updateWorkteam(input: UpdateWorkteamInput, completion: @escaping (SdkResult<UpdateWorkteamOutputResponse, UpdateWorkteamOutputError>) -> Void)
}
