...
public protocol SageMakerClientProtocol {
    ...
    func addAssociation(input: AddAssociationInput, completion: @escaping (SdkResult<AddAssociationOutput, AddAssociationOutputError>) -> Void)
    ...
    func associateTrialComponent(input: AssociateTrialComponentInput, completion: @escaping (SdkResult<AssociateTrialComponentOutput, AssociateTrialComponentOutputError>) -> Void)
    ...
    ///          </note>
    func createAction(input: CreateActionInput, completion: @escaping (SdkResult<CreateActionOutput, CreateActionOutputError>) -> Void)
    /// <p>Create a machine learning algorithm that you can use in Amazon SageMaker and list in the AWS
    ///             Marketplace.</p>
    func createAlgorithm(input: CreateAlgorithmInput, completion: @escaping (SdkResult<CreateAlgorithmOutput, CreateAlgorithmOutputError>) -> Void)
    ...
    func createAppImageConfig(input: CreateAppImageConfigInput, completion: @escaping (SdkResult<CreateAppImageConfigOutput, CreateAppImageConfigOutputError>) -> Void)
    ...
    ///           environments results in an error.</p>
    ///          </note>
    func createArtifact(input: CreateArtifactInput, completion: @escaping (SdkResult<CreateArtifactOutput, CreateArtifactOutputError>) -> Void)
    ...
    func createAutoMLJob(input: CreateAutoMLJobInput, completion: @escaping (SdkResult<CreateAutoMLJobOutput, CreateAutoMLJobOutputError>) -> Void)
    ...
    func createCodeRepository(input: CreateCodeRepositoryInput, completion: @escaping (SdkResult<CreateCodeRepositoryOutput, CreateCodeRepositoryOutputError>) -> Void)
    ...
    func createCompilationJob(input: CreateCompilationJobInput, completion: @escaping (SdkResult<CreateCompilationJobOutput, CreateCompilationJobOutputError>) -> Void)
    ...
    ///           environments results in an error.</p>
    ///          </note>
    func createContext(input: CreateContextInput, completion: @escaping (SdkResult<CreateContextOutput, CreateContextOutputError>) -> Void)
    ...
    func createDataQualityJobDefinition(input: CreateDataQualityJobDefinitionInput, completion: @escaping (SdkResult<CreateDataQualityJobDefinitionOutput, CreateDataQualityJobDefinitionOutputError>) -> Void)
    /// <p>Creates a device fleet.</p>
    func createDeviceFleet(input: CreateDeviceFleetInput, completion: @escaping (SdkResult<CreateDeviceFleetOutput, CreateDeviceFleetOutputError>) -> Void)
    ...
    func createEdgePackagingJob(input: CreateEdgePackagingJobInput, completion: @escaping (SdkResult<CreateEdgePackagingJobOutput, CreateEdgePackagingJobOutputError>) -> Void)
    ...
    ///                 these possible issues. We also recommend that customers call <a>DescribeEndpointConfig</a> before calling <a>CreateEndpoint</a> to minimize the potential impact of a DynamoDB eventually consistent read.</p>
    ///         </note>
    func createEndpointConfig(input: CreateEndpointConfigInput, completion: @escaping (SdkResult<CreateEndpointConfigOutput, CreateEndpointConfigOutputError>) -> Void)
    ...
    func createExperiment(input: CreateExperimentInput, completion: @escaping (SdkResult<CreateExperimentOutput, CreateExperimentOutputError>) -> Void)
    ...
    ///          </important>
    func createFeatureGroup(input: CreateFeatureGroupInput, completion: @escaping (SdkResult<CreateFeatureGroupOutput, CreateFeatureGroupOutputError>) -> Void)
    /// <p>Creates a flow definition.</p>
    func createFlowDefinition(input: CreateFlowDefinitionInput, completion: @escaping (SdkResult<CreateFlowDefinitionOutput, CreateFlowDefinitionOutputError>) -> Void)
    ...
    func createHumanTaskUi(input: CreateHumanTaskUiInput, completion: @escaping (SdkResult<CreateHumanTaskUiOutput, CreateHumanTaskUiOutputError>) -> Void)
    ...
    func createHyperParameterTuningJob(input: CreateHyperParameterTuningJobInput, completion: @escaping (SdkResult<CreateHyperParameterTuningJobOutput, CreateHyperParameterTuningJobOutputError>) -> Void)
    ...
    func createImageVersion(input: CreateImageVersionInput, completion: @escaping (SdkResult<CreateImageVersionOutput, CreateImageVersionOutputError>) -> Void)
    ...
    ///                 Job</a>.</p>
    func createLabelingJob(input: CreateLabelingJobInput, completion: @escaping (SdkResult<CreateLabelingJobOutput, CreateLabelingJobOutputError>) -> Void)
    ...
    func createModelBiasJobDefinition(input: CreateModelBiasJobDefinitionInput, completion: @escaping (SdkResult<CreateModelBiasJobDefinitionOutput, CreateModelBiasJobDefinitionOutputError>) -> Void)
    /// <p>Creates the definition for a model explainability job.</p>
    func createModelExplainabilityJobDefinition(input: CreateModelExplainabilityJobDefinitionInput, completion: @escaping (SdkResult<CreateModelExplainabilityJobDefinitionOutput, CreateModelExplainabilityJobDefinitionOutputError>) -> Void)
    ...
    ///             </ul>
    ///         </note>
    func createModelPackage(input: CreateModelPackageInput, completion: @escaping (SdkResult<CreateModelPackageOutput, CreateModelPackageOutputError>) -> Void)
    /// <p>Creates a model group. A model group contains a group of model versions.</p>
    func createModelPackageGroup(input: CreateModelPackageGroupInput, completion: @escaping (SdkResult<CreateModelPackageGroupOutput, CreateModelPackageGroupOutputError>) -> Void)
    /// <p>Creates a definition for a job that monitors model quality and drift. For information
    ///          about model monitor, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/model-monitor.html">Amazon SageMaker Model Monitor</a>.</p>
    func createModelQualityJobDefinition(input: CreateModelQualityJobDefinitionInput, completion: @escaping (SdkResult<CreateModelQualityJobDefinitionOutput, CreateModelQualityJobDefinitionOutputError>) -> Void)
    ...
    func createMonitoringSchedule(input: CreateMonitoringScheduleInput, completion: @escaping (SdkResult<CreateMonitoringScheduleOutput, CreateMonitoringScheduleOutputError>) -> Void)
    ...
    func createNotebookInstance(input: CreateNotebookInstanceInput, completion: @escaping (SdkResult<CreateNotebookInstanceOutput, CreateNotebookInstanceOutputError>) -> Void)
    ...
    func createNotebookInstanceLifecycleConfig(input: CreateNotebookInstanceLifecycleConfigInput, completion: @escaping (SdkResult<CreateNotebookInstanceLifecycleConfigOutput, CreateNotebookInstanceLifecycleConfigOutputError>) -> Void)
    ...
    ///          </note>
    func createPresignedDomainUrl(input: CreatePresignedDomainUrlInput, completion: @escaping (SdkResult<CreatePresignedDomainUrlOutput, CreatePresignedDomainUrlOutputError>) -> Void)
    ...
    ///         </note>
    func createPresignedNotebookInstanceUrl(input: CreatePresignedNotebookInstanceUrlInput, completion: @escaping (SdkResult<CreatePresignedNotebookInstanceUrlOutput, CreatePresignedNotebookInstanceUrlOutputError>) -> Void)
    /// <p>Creates a processing job.</p>
    func createProcessingJob(input: CreateProcessingJobInput, completion: @escaping (SdkResult<CreateProcessingJobOutput, CreateProcessingJobOutputError>) -> Void)
    ...
    func createTrainingJob(input: CreateTrainingJobInput, completion: @escaping (SdkResult<CreateTrainingJobOutput, CreateTrainingJobOutputError>) -> Void)
    ...
    ///                 Transform</a>.</p>
    func createTransformJob(input: CreateTransformJobInput, completion: @escaping (SdkResult<CreateTransformJobOutput, CreateTransformJobOutputError>) -> Void)
    ...
    func createTrial(input: CreateTrialInput, completion: @escaping (SdkResult<CreateTrialOutput, CreateTrialOutputError>) -> Void)
    ...
    ///         environments results in an error.</p>
    ///          </note>
    func createTrialComponent(input: CreateTrialComponentInput, completion: @escaping (SdkResult<CreateTrialComponentOutput, CreateTrialComponentOutputError>) -> Void)
    ...
    func createWorkforce(input: CreateWorkforceInput, completion: @escaping (SdkResult<CreateWorkforceOutput, CreateWorkforceOutputError>) -> Void)
    ...
    func createWorkteam(input: CreateWorkteamInput, completion: @escaping (SdkResult<CreateWorkteamOutput, CreateWorkteamOutputError>) -> Void)
    /// <p>Deletes an action.</p>
    func deleteAction(input: DeleteActionInput, completion: @escaping (SdkResult<DeleteActionOutput, DeleteActionOutputError>) -> Void)
    /// <p>Removes the specified algorithm from your account.</p>
    func deleteAlgorithm(input: DeleteAlgorithmInput, completion: @escaping (SdkResult<DeleteAlgorithmOutput, DeleteAlgorithmOutputError>) -> Void)
    ...
    func deleteAppImageConfig(input: DeleteAppImageConfigInput, completion: @escaping (SdkResult<DeleteAppImageConfigOutput, DeleteAppImageConfigOutputError>) -> Void)
    /// <p>Deletes an artifact. Either <code>ArtifactArn</code> or <code>Source</code> must be
    ///         specified.</p>
    func deleteArtifact(input: DeleteArtifactInput, completion: @escaping (SdkResult<DeleteArtifactOutput, DeleteArtifactOutputError>) -> Void)
    /// <p>Deletes an association.</p>
    func deleteAssociation(input: DeleteAssociationInput, completion: @escaping (SdkResult<DeleteAssociationOutput, DeleteAssociationOutputError>) -> Void)
    /// <p>Deletes the specified Git repository from your account.</p>
    func deleteCodeRepository(input: DeleteCodeRepositoryInput, completion: @escaping (SdkResult<DeleteCodeRepositoryOutput, DeleteCodeRepositoryOutputError>) -> Void)
    /// <p>Deletes an context.</p>
    func deleteContext(input: DeleteContextInput, completion: @escaping (SdkResult<DeleteContextOutput, DeleteContextOutputError>) -> Void)
    /// <p>Deletes a data quality monitoring job definition.</p>
    func deleteDataQualityJobDefinition(input: DeleteDataQualityJobDefinitionInput, completion: @escaping (SdkResult<DeleteDataQualityJobDefinitionOutput, DeleteDataQualityJobDefinitionOutputError>) -> Void)
    /// <p>Deletes a fleet.</p>
    func deleteDeviceFleet(input: DeleteDeviceFleetInput, completion: @escaping (SdkResult<DeleteDeviceFleetOutput, DeleteDeviceFleetOutputError>) -> Void)
    ...
    ///             incurring charges.</p>
    func deleteEndpointConfig(input: DeleteEndpointConfigInput, completion: @escaping (SdkResult<DeleteEndpointConfigOutput, DeleteEndpointConfigOutputError>) -> Void)
    ...
    ///       the experiment.</p>
    func deleteExperiment(input: DeleteExperimentInput, completion: @escaping (SdkResult<DeleteExperimentOutput, DeleteExperimentOutputError>) -> Void)
    ...
    ///          not deleted. </p>
    func deleteFeatureGroup(input: DeleteFeatureGroupInput, completion: @escaping (SdkResult<DeleteFeatureGroupOutput, DeleteFeatureGroupOutputError>) -> Void)
    /// <p>Deletes the specified flow definition.</p>
    func deleteFlowDefinition(input: DeleteFlowDefinitionInput, completion: @escaping (SdkResult<DeleteFlowDefinitionOutput, DeleteFlowDefinitionOutputError>) -> Void)
    ...
    func deleteHumanTaskUi(input: DeleteHumanTaskUiInput, completion: @escaping (SdkResult<DeleteHumanTaskUiOutput, DeleteHumanTaskUiOutputError>) -> Void)
    ...
    ///         deleted.</p>
    func deleteImageVersion(input: DeleteImageVersionInput, completion: @escaping (SdkResult<DeleteImageVersionOutput, DeleteImageVersionOutputError>) -> Void)
    ...
    func deleteModelBiasJobDefinition(input: DeleteModelBiasJobDefinitionInput, completion: @escaping (SdkResult<DeleteModelBiasJobDefinitionOutput, DeleteModelBiasJobDefinitionOutputError>) -> Void)
    /// <p>Deletes an Amazon SageMaker model explainability job definition.</p>
    func deleteModelExplainabilityJobDefinition(input: DeleteModelExplainabilityJobDefinitionInput, completion: @escaping (SdkResult<DeleteModelExplainabilityJobDefinitionOutput, DeleteModelExplainabilityJobDefinitionOutputError>) -> Void)
    ...
    func deleteModelPackage(input: DeleteModelPackageInput, completion: @escaping (SdkResult<DeleteModelPackageOutput, DeleteModelPackageOutputError>) -> Void)
    /// <p>Deletes the specified model group.</p>
    func deleteModelPackageGroup(input: DeleteModelPackageGroupInput, completion: @escaping (SdkResult<DeleteModelPackageGroupOutput, DeleteModelPackageGroupOutputError>) -> Void)
    /// <p>Deletes a model group resource policy.</p>
    func deleteModelPackageGroupPolicy(input: DeleteModelPackageGroupPolicyInput, completion: @escaping (SdkResult<DeleteModelPackageGroupPolicyOutput, DeleteModelPackageGroupPolicyOutputError>) -> Void)
    /// <p>Deletes the secified model quality monitoring job definition.</p>
    func deleteModelQualityJobDefinition(input: DeleteModelQualityJobDefinitionInput, completion: @escaping (SdkResult<DeleteModelQualityJobDefinitionOutput, DeleteModelQualityJobDefinitionOutputError>) -> Void)
    ...
    func deleteMonitoringSchedule(input: DeleteMonitoringScheduleInput, completion: @escaping (SdkResult<DeleteMonitoringScheduleOutput, DeleteMonitoringScheduleOutputError>) -> Void)
    ...
    ///         </important>
    func deleteNotebookInstance(input: DeleteNotebookInstanceInput, completion: @escaping (SdkResult<DeleteNotebookInstanceOutput, DeleteNotebookInstanceOutputError>) -> Void)
    /// <p>Deletes a notebook instance lifecycle configuration.</p>
    func deleteNotebookInstanceLifecycleConfig(input: DeleteNotebookInstanceLifecycleConfigInput, completion: @escaping (SdkResult<DeleteNotebookInstanceLifecycleConfigOutput, DeleteNotebookInstanceLifecycleConfigOutputError>) -> Void)
    ...
    ///       components.</p>
    func deleteTrial(input: DeleteTrialInput, completion: @escaping (SdkResult<DeleteTrialOutput, DeleteTrialOutputError>) -> Void)
    ...
    func deleteTrialComponent(input: DeleteTrialComponentInput, completion: @escaping (SdkResult<DeleteTrialComponentOutput, DeleteTrialComponentOutputError>) -> Void)
    ...
    ///         </important>
    func deleteWorkforce(input: DeleteWorkforceInput, completion: @escaping (SdkResult<DeleteWorkforceOutput, DeleteWorkforceOutputError>) -> Void)
    /// <p>Deletes an existing work team. This operation can't be undone.</p>
    func deleteWorkteam(input: DeleteWorkteamInput, completion: @escaping (SdkResult<DeleteWorkteamOutput, DeleteWorkteamOutputError>) -> Void)
    /// <p>Deregisters the specified devices. After you deregister a device, you will need to re-register the devices.</p>
    func deregisterDevices(input: DeregisterDevicesInput, completion: @escaping (SdkResult<DeregisterDevicesOutput, DeregisterDevicesOutputError>) -> Void)
    /// <p>Describes an action.</p>
    func describeAction(input: DescribeActionInput, completion: @escaping (SdkResult<DescribeActionOutput, DescribeActionOutputError>) -> Void)
    ...
    func describeApp(input: DescribeAppInput, completion: @escaping (SdkResult<DescribeAppOutput, DescribeAppOutputError>) -> Void)
    /// <p>Describes an AppImageConfig.</p>
    func describeAppImageConfig(input: DescribeAppImageConfigInput, completion: @escaping (SdkResult<DescribeAppImageConfigOutput, DescribeAppImageConfigOutputError>) -> Void)
    /// <p>Describes an artifact.</p>
    func describeArtifact(input: DescribeArtifactInput, completion: @escaping (SdkResult<DescribeArtifactOutput, DescribeArtifactOutputError>) -> Void)
    /// <p>Returns information about an Amazon SageMaker AutoML job.</p>
    func describeAutoMLJob(input: DescribeAutoMLJobInput, completion: @escaping (SdkResult<DescribeAutoMLJobOutput, DescribeAutoMLJobOutputError>) -> Void)
    /// <p>Gets details about the specified Git repository.</p>
    func describeCodeRepository(input: DescribeCodeRepositoryInput, completion: @escaping (SdkResult<DescribeCodeRepositoryOutput, DescribeCodeRepositoryOutputError>) -> Void)
    ...
    func describeCompilationJob(input: DescribeCompilationJobInput, completion: @escaping (SdkResult<DescribeCompilationJobOutput, DescribeCompilationJobOutputError>) -> Void)
    /// <p>Describes a context.</p>
    func describeContext(input: DescribeContextInput, completion: @escaping (SdkResult<DescribeContextOutput, DescribeContextOutputError>) -> Void)
    /// <p>Gets the details of a data quality monitoring job definition.</p>
    func describeDataQualityJobDefinition(input: DescribeDataQualityJobDefinitionInput, completion: @escaping (SdkResult<DescribeDataQualityJobDefinitionOutput, DescribeDataQualityJobDefinitionOutputError>) -> Void)
    ...
    func describeDeviceFleet(input: DescribeDeviceFleetInput, completion: @escaping (SdkResult<DescribeDeviceFleetOutput, DescribeDeviceFleetOutputError>) -> Void)
    ...
    func describeEdgePackagingJob(input: DescribeEdgePackagingJobInput, completion: @escaping (SdkResult<DescribeEdgePackagingJobOutput, DescribeEdgePackagingJobOutputError>) -> Void)
    ...
    func describeEndpointConfig(input: DescribeEndpointConfigInput, completion: @escaping (SdkResult<DescribeEndpointConfigOutput, DescribeEndpointConfigOutputError>) -> Void)
    /// <p>Provides a list of an experiment's properties.</p>
    func describeExperiment(input: DescribeExperimentInput, completion: @escaping (SdkResult<DescribeExperimentOutput, DescribeExperimentOutputError>) -> Void)
    ...
    func describeFeatureGroup(input: DescribeFeatureGroupInput, completion: @escaping (SdkResult<DescribeFeatureGroupOutput, DescribeFeatureGroupOutputError>) -> Void)
    /// <p>Returns information about the specified flow definition.</p>
    func describeFlowDefinition(input: DescribeFlowDefinitionInput, completion: @escaping (SdkResult<DescribeFlowDefinitionOutput, DescribeFlowDefinitionOutputError>) -> Void)
    /// <p>Returns information about the requested human task user interface (worker task template).</p>
    func describeHumanTaskUi(input: DescribeHumanTaskUiInput, completion: @escaping (SdkResult<DescribeHumanTaskUiOutput, DescribeHumanTaskUiOutputError>) -> Void)
    /// <p>Gets
    ///             a description of a hyperparameter tuning job.</p>
    func describeHyperParameterTuningJob(input: DescribeHyperParameterTuningJobInput, completion: @escaping (SdkResult<DescribeHyperParameterTuningJobOutput, DescribeHyperParameterTuningJobOutputError>) -> Void)
    /// <p>Describes a SageMaker image.</p>
    func describeImage(input: DescribeImageInput, completion: @escaping (SdkResult<DescribeImageOutput, DescribeImageOutputError>) -> Void)
    /// <p>Describes a version of a SageMaker image.</p>
    func describeImageVersion(input: DescribeImageVersionInput, completion: @escaping (SdkResult<DescribeImageVersionOutput, DescribeImageVersionOutputError>) -> Void)
    /// <p>Gets information about a labeling job.</p>
    func describeLabelingJob(input: DescribeLabelingJobInput, completion: @escaping (SdkResult<DescribeLabelingJobOutput, DescribeLabelingJobOutputError>) -> Void)
    ...
    func describeModelBiasJobDefinition(input: DescribeModelBiasJobDefinitionInput, completion: @escaping (SdkResult<DescribeModelBiasJobDefinitionOutput, DescribeModelBiasJobDefinitionOutputError>) -> Void)
    /// <p>Returns a description of a model explainability job definition.</p>
    func describeModelExplainabilityJobDefinition(input: DescribeModelExplainabilityJobDefinitionInput, completion: @escaping (SdkResult<DescribeModelExplainabilityJobDefinitionOutput, DescribeModelExplainabilityJobDefinitionOutputError>) -> Void)
    ...
    ///             Marketplace.</p>
    func describeModelPackage(input: DescribeModelPackageInput, completion: @escaping (SdkResult<DescribeModelPackageOutput, DescribeModelPackageOutputError>) -> Void)
    /// <p>Gets a description for the specified model group.</p>
    func describeModelPackageGroup(input: DescribeModelPackageGroupInput, completion: @escaping (SdkResult<DescribeModelPackageGroupOutput, DescribeModelPackageGroupOutputError>) -> Void)
    /// <p>Returns a description of a model quality job definition.</p>
    func describeModelQualityJobDefinition(input: DescribeModelQualityJobDefinitionInput, completion: @escaping (SdkResult<DescribeModelQualityJobDefinitionOutput, DescribeModelQualityJobDefinitionOutputError>) -> Void)
    /// <p>Describes the schedule for a monitoring job.</p>
    func describeMonitoringSchedule(input: DescribeMonitoringScheduleInput, completion: @escaping (SdkResult<DescribeMonitoringScheduleOutput, DescribeMonitoringScheduleOutputError>) -> Void)
    /// <p>Returns information about a notebook instance.</p>
    func describeNotebookInstance(input: DescribeNotebookInstanceInput, completion: @escaping (SdkResult<DescribeNotebookInstanceOutput, DescribeNotebookInstanceOutputError>) -> Void)
    /// <p>Returns a description of a notebook instance lifecycle configuration.</p>
    ///         <p>For information about notebook instance lifestyle configurations, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/notebook-lifecycle-config.html">Step
    ///                 2.1: (Optional) Customize a Notebook Instance</a>.</p>
    func describeNotebookInstanceLifecycleConfig(input: DescribeNotebookInstanceLifecycleConfigInput, completion: @escaping (SdkResult<DescribeNotebookInstanceLifecycleConfigOutput, DescribeNotebookInstanceLifecycleConfigOutputError>) -> Void)
    ...
    func describePipelineDefinitionForExecution(input: DescribePipelineDefinitionForExecutionInput, completion: @escaping (SdkResult<DescribePipelineDefinitionForExecutionOutput, DescribePipelineDefinitionForExecutionOutputError>) -> Void)
    /// <p>Describes the details of a pipeline execution.</p>
    func describePipelineExecution(input: DescribePipelineExecutionInput, completion: @escaping (SdkResult<DescribePipelineExecutionOutput, DescribePipelineExecutionOutputError>) -> Void)
    /// <p>Returns a description of a processing job.</p>
    func describeProcessingJob(input: DescribeProcessingJobInput, completion: @escaping (SdkResult<DescribeProcessingJobOutput, DescribeProcessingJobOutputError>) -> Void)
    ...
    func describeSubscribedWorkteam(input: DescribeSubscribedWorkteamInput, completion: @escaping (SdkResult<DescribeSubscribedWorkteamOutput, DescribeSubscribedWorkteamOutputError>) -> Void)
    ...
    func describeTrainingJob(input: DescribeTrainingJobInput, completion: @escaping (SdkResult<DescribeTrainingJobOutput, DescribeTrainingJobOutputError>) -> Void)
    /// <p>Returns information about a transform job.</p>
    func describeTransformJob(input: DescribeTransformJobInput, completion: @escaping (SdkResult<DescribeTransformJobOutput, DescribeTransformJobOutputError>) -> Void)
    /// <p>Provides a list of a trial's properties.</p>
    func describeTrial(input: DescribeTrialInput, completion: @escaping (SdkResult<DescribeTrialOutput, DescribeTrialOutputError>) -> Void)
    /// <p>Provides a list of a trials component's properties.</p>
    func describeTrialComponent(input: DescribeTrialComponentInput, completion: @escaping (SdkResult<DescribeTrialComponentOutput, DescribeTrialComponentOutputError>) -> Void)
    ...
    ///         </important>
    func describeWorkforce(input: DescribeWorkforceInput, completion: @escaping (SdkResult<DescribeWorkforceOutput, DescribeWorkforceOutputError>) -> Void)
    ...
    ///             Resource Name (ARN).</p>
    func describeWorkteam(input: DescribeWorkteamInput, completion: @escaping (SdkResult<DescribeWorkteamOutput, DescribeWorkteamOutputError>) -> Void)
    /// <p>Disables using Service Catalog in SageMaker. Service Catalog is used to create
    ///             SageMaker projects.</p>
    func disableSagemakerServicecatalogPortfolio(input: DisableSagemakerServicecatalogPortfolioInput, completion: @escaping (SdkResult<DisableSagemakerServicecatalogPortfolioOutput, DisableSagemakerServicecatalogPortfolioOutputError>) -> Void)
    ...
    func disassociateTrialComponent(input: DisassociateTrialComponentInput, completion: @escaping (SdkResult<DisassociateTrialComponentOutput, DisassociateTrialComponentOutputError>) -> Void)
    /// <p>Enables using Service Catalog in SageMaker. Service Catalog is used to create
    ///             SageMaker projects.</p>
    func enableSagemakerServicecatalogPortfolio(input: EnableSagemakerServicecatalogPortfolioInput, completion: @escaping (SdkResult<EnableSagemakerServicecatalogPortfolioOutput, EnableSagemakerServicecatalogPortfolioOutputError>) -> Void)
    /// <p>Describes a fleet.</p>
    func getDeviceFleetReport(input: GetDeviceFleetReportInput, completion: @escaping (SdkResult<GetDeviceFleetReportOutput, GetDeviceFleetReportOutputError>) -> Void)
    ...
    func getModelPackageGroupPolicy(input: GetModelPackageGroupPolicyInput, completion: @escaping (SdkResult<GetModelPackageGroupPolicyOutput, GetModelPackageGroupPolicyOutputError>) -> Void)
    /// <p>Gets the status of Service Catalog in SageMaker. Service Catalog is used to create
    ///             SageMaker projects.</p>
    func getSagemakerServicecatalogPortfolioStatus(input: GetSagemakerServicecatalogPortfolioStatusInput, completion: @escaping (SdkResult<GetSagemakerServicecatalogPortfolioStatusOutput, GetSagemakerServicecatalogPortfolioStatusOutputError>) -> Void)
    ...
    ///       <code>Metrics</code>.</p>
    func getSearchSuggestions(input: GetSearchSuggestionsInput, completion: @escaping (SdkResult<GetSearchSuggestionsOutput, GetSearchSuggestionsOutputError>) -> Void)
    ...
    func listAlgorithms(input: ListAlgorithmsInput, completion: @escaping (SdkResult<ListAlgorithmsOutput, ListAlgorithmsOutputError>) -> Void)
    ...
    func listAppImageConfigs(input: ListAppImageConfigsInput, completion: @escaping (SdkResult<ListAppImageConfigsOutput, ListAppImageConfigsOutputError>) -> Void)
    /// <p>Lists apps.</p>
    ...
    func listAssociations(input: ListAssociationsInput, completion: @escaping (SdkResult<ListAssociationsOutput, ListAssociationsOutputError>) -> Void)
    /// <p>Request a list of jobs.</p>
    func listAutoMLJobs(input: ListAutoMLJobsInput, completion: @escaping (SdkResult<ListAutoMLJobsOutput, ListAutoMLJobsOutputError>) -> Void)
    /// <p>List the candidates created for the job.</p>
    func listCandidatesForAutoMLJob(input: ListCandidatesForAutoMLJobInput, completion: @escaping (SdkResult<ListCandidatesForAutoMLJobOutput, ListCandidatesForAutoMLJobOutputError>) -> Void)
    /// <p>Gets a list of the Git repositories in your account.</p>
    func listCodeRepositories(input: ListCodeRepositoriesInput, completion: @escaping (SdkResult<ListCodeRepositoriesOutput, ListCodeRepositoriesOutputError>) -> Void)
    ...
    func listCompilationJobs(input: ListCompilationJobsInput, completion: @escaping (SdkResult<ListCompilationJobsOutput, ListCompilationJobsOutputError>) -> Void)
    /// <p>Lists the contexts in your account and their properties.</p>
    func listContexts(input: ListContextsInput, completion: @escaping (SdkResult<ListContextsOutput, ListContextsOutputError>) -> Void)
    /// <p>Lists the data quality job definitions in your account.</p>
    func listDataQualityJobDefinitions(input: ListDataQualityJobDefinitionsInput, completion: @escaping (SdkResult<ListDataQualityJobDefinitionsOutput, ListDataQualityJobDefinitionsOutputError>) -> Void)
    /// <p>Returns a list of devices in the fleet.</p>
    func listDeviceFleets(input: ListDeviceFleetsInput, completion: @escaping (SdkResult<ListDeviceFleetsOutput, ListDeviceFleetsOutputError>) -> Void)
    ...
    func listEdgePackagingJobs(input: ListEdgePackagingJobsInput, completion: @escaping (SdkResult<ListEdgePackagingJobsOutput, ListEdgePackagingJobsOutputError>) -> Void)
    /// <p>Lists endpoint configurations.</p>
    func listEndpointConfigs(input: ListEndpointConfigsInput, completion: @escaping (SdkResult<ListEndpointConfigsOutput, ListEndpointConfigsOutputError>) -> Void)
    /// <p>Lists endpoints.</p>
    ...
    func listFeatureGroups(input: ListFeatureGroupsInput, completion: @escaping (SdkResult<ListFeatureGroupsOutput, ListFeatureGroupsOutputError>) -> Void)
    /// <p>Returns information about the flow definitions in your account.</p>
    func listFlowDefinitions(input: ListFlowDefinitionsInput, completion: @escaping (SdkResult<ListFlowDefinitionsOutput, ListFlowDefinitionsOutputError>) -> Void)
    /// <p>Returns information about the human task user interfaces in your account.</p>
    func listHumanTaskUis(input: ListHumanTaskUisInput, completion: @escaping (SdkResult<ListHumanTaskUisOutput, ListHumanTaskUisOutputError>) -> Void)
    ...
    func listHyperParameterTuningJobs(input: ListHyperParameterTuningJobsInput, completion: @escaping (SdkResult<ListHyperParameterTuningJobsOutput, ListHyperParameterTuningJobsOutputError>) -> Void)
    ...
    func listImageVersions(input: ListImageVersionsInput, completion: @escaping (SdkResult<ListImageVersionsOutput, ListImageVersionsOutputError>) -> Void)
    /// <p>Gets a list of labeling jobs.</p>
    func listLabelingJobs(input: ListLabelingJobsInput, completion: @escaping (SdkResult<ListLabelingJobsOutput, ListLabelingJobsOutputError>) -> Void)
    /// <p>Gets a list of labeling jobs assigned to a specified work team.</p>
    func listLabelingJobsForWorkteam(input: ListLabelingJobsForWorkteamInput, completion: @escaping (SdkResult<ListLabelingJobsForWorkteamOutput, ListLabelingJobsForWorkteamOutputError>) -> Void)
    /// <p>Lists model bias jobs definitions that satisfy various filters.</p>
    func listModelBiasJobDefinitions(input: ListModelBiasJobDefinitionsInput, completion: @escaping (SdkResult<ListModelBiasJobDefinitionsOutput, ListModelBiasJobDefinitionsOutputError>) -> Void)
    /// <p>Lists model explainability job definitions that satisfy various filters.</p>
    func listModelExplainabilityJobDefinitions(input: ListModelExplainabilityJobDefinitionsInput, completion: @escaping (SdkResult<ListModelExplainabilityJobDefinitionsOutput, ListModelExplainabilityJobDefinitionsOutputError>) -> Void)
    /// <p>Gets a list of the model groups in your AWS account.</p>
    func listModelPackageGroups(input: ListModelPackageGroupsInput, completion: @escaping (SdkResult<ListModelPackageGroupsOutput, ListModelPackageGroupsOutputError>) -> Void)
    /// <p>Lists the model packages that have been created.</p>
    func listModelPackages(input: ListModelPackagesInput, completion: @escaping (SdkResult<ListModelPackagesOutput, ListModelPackagesOutputError>) -> Void)
    /// <p>Gets a list of model quality monitoring job definitions in your account.</p>
    func listModelQualityJobDefinitions(input: ListModelQualityJobDefinitionsInput, completion: @escaping (SdkResult<ListModelQualityJobDefinitionsOutput, ListModelQualityJobDefinitionsOutputError>) -> Void)
    ...
    func listMonitoringExecutions(input: ListMonitoringExecutionsInput, completion: @escaping (SdkResult<ListMonitoringExecutionsOutput, ListMonitoringExecutionsOutputError>) -> Void)
    /// <p>Returns list of all monitoring schedules.</p>
    func listMonitoringSchedules(input: ListMonitoringSchedulesInput, completion: @escaping (SdkResult<ListMonitoringSchedulesOutput, ListMonitoringSchedulesOutputError>) -> Void)
    /// <p>Lists notebook instance lifestyle configurations created with the <a>CreateNotebookInstanceLifecycleConfig</a> API.</p>
    func listNotebookInstanceLifecycleConfigs(input: ListNotebookInstanceLifecycleConfigsInput, completion: @escaping (SdkResult<ListNotebookInstanceLifecycleConfigsOutput, ListNotebookInstanceLifecycleConfigsOutputError>) -> Void)
    /// <p>Returns a list of the Amazon SageMaker notebook instances in the requester's account in an AWS
    ///             Region. </p>
    func listNotebookInstances(input: ListNotebookInstancesInput, completion: @escaping (SdkResult<ListNotebookInstancesOutput, ListNotebookInstancesOutputError>) -> Void)
    ...
    func listPipelineExecutionSteps(input: ListPipelineExecutionStepsInput, completion: @escaping (SdkResult<ListPipelineExecutionStepsOutput, ListPipelineExecutionStepsOutputError>) -> Void)
    /// <p>Gets a list of parameters for a pipeline execution.</p>
    func listPipelineParametersForExecution(input: ListPipelineParametersForExecutionInput, completion: @escaping (SdkResult<ListPipelineParametersForExecutionOutput, ListPipelineParametersForExecutionOutputError>) -> Void)
    ...
    func listProcessingJobs(input: ListProcessingJobsInput, completion: @escaping (SdkResult<ListProcessingJobsOutput, ListProcessingJobsOutputError>) -> Void)
    ...
    func listSubscribedWorkteams(input: ListSubscribedWorkteamsInput, completion: @escaping (SdkResult<ListSubscribedWorkteamsOutput, ListSubscribedWorkteamsOutputError>) -> Void)
    ...
    ///             </p>
    ///         </note>
    func listTrainingJobs(input: ListTrainingJobsInput, completion: @escaping (SdkResult<ListTrainingJobsOutput, ListTrainingJobsOutputError>) -> Void)
    ...
    func listTrainingJobsForHyperParameterTuningJob(input: ListTrainingJobsForHyperParameterTuningJobInput, completion: @escaping (SdkResult<ListTrainingJobsForHyperParameterTuningJobOutput, ListTrainingJobsForHyperParameterTuningJobOutputError>) -> Void)
    /// <p>Lists transform jobs.</p>
    func listTransformJobs(input: ListTransformJobsInput, completion: @escaping (SdkResult<ListTransformJobsOutput, ListTransformJobsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func listTrialComponents(input: ListTrialComponentsInput, completion: @escaping (SdkResult<ListTrialComponentsOutput, ListTrialComponentsOutputError>) -> Void)
    ...
    ///       creation time.</p>
    func listTrials(input: ListTrialsInput, completion: @escaping (SdkResult<ListTrialsOutput, ListTrialsOutputError>) -> Void)
    ...
    func listWorkforces(input: ListWorkforcesInput, completion: @escaping (SdkResult<ListWorkforcesOutput, ListWorkforcesOutputError>) -> Void)
    ...
    ///             parameter.</p>
    func listWorkteams(input: ListWorkteamsInput, completion: @escaping (SdkResult<ListWorkteamsOutput, ListWorkteamsOutputError>) -> Void)
    ...
    func putModelPackageGroupPolicy(input: PutModelPackageGroupPolicyInput, completion: @escaping (SdkResult<PutModelPackageGroupPolicyOutput, PutModelPackageGroupPolicyOutputError>) -> Void)
    /// <p>Register devices.</p>
    func registerDevices(input: RegisterDevicesInput, completion: @escaping (SdkResult<RegisterDevicesOutput, RegisterDevicesOutputError>) -> Void)
    /// <p>Renders the UI template so that you can preview the worker's experience. </p>
    func renderUiTemplate(input: RenderUiTemplateInput, completion: @escaping (SdkResult<RenderUiTemplateOutput, RenderUiTemplateOutputError>) -> Void)
    ...
    ///          </note>
    func startMonitoringSchedule(input: StartMonitoringScheduleInput, completion: @escaping (SdkResult<StartMonitoringScheduleOutput, StartMonitoringScheduleOutputError>) -> Void)
    ...
    func startNotebookInstance(input: StartNotebookInstanceInput, completion: @escaping (SdkResult<StartNotebookInstanceOutput, StartNotebookInstanceOutputError>) -> Void)
    ...
    func stopAutoMLJob(input: StopAutoMLJobInput, completion: @escaping (SdkResult<StopAutoMLJobOutput, StopAutoMLJobOutputError>) -> Void)
    ...
    ///         </p>
    func stopCompilationJob(input: StopCompilationJobInput, completion: @escaping (SdkResult<StopCompilationJobOutput, StopCompilationJobOutputError>) -> Void)
    /// <p>Request to stop an edge packaging job.</p>
    func stopEdgePackagingJob(input: StopEdgePackagingJobInput, completion: @escaping (SdkResult<StopEdgePackagingJobOutput, StopEdgePackagingJobOutputError>) -> Void)
    ...
    func stopHyperParameterTuningJob(input: StopHyperParameterTuningJobInput, completion: @escaping (SdkResult<StopHyperParameterTuningJobOutput, StopHyperParameterTuningJobOutputError>) -> Void)
    ...
    func stopLabelingJob(input: StopLabelingJobInput, completion: @escaping (SdkResult<StopLabelingJobOutput, StopLabelingJobOutputError>) -> Void)
    /// <p>Stops a previously started monitoring schedule.</p>
    func stopMonitoringSchedule(input: StopMonitoringScheduleInput, completion: @escaping (SdkResult<StopMonitoringScheduleOutput, StopMonitoringScheduleOutputError>) -> Void)
    ...
    ///         </p>
    func stopNotebookInstance(input: StopNotebookInstanceInput, completion: @escaping (SdkResult<StopNotebookInstanceOutput, StopNotebookInstanceOutputError>) -> Void)
    ...
    func stopProcessingJob(input: StopProcessingJobInput, completion: @escaping (SdkResult<StopProcessingJobOutput, StopProcessingJobOutputError>) -> Void)
    ...
    ///                 <code>Stopped</code>.</p>
    func stopTrainingJob(input: StopTrainingJobInput, completion: @escaping (SdkResult<StopTrainingJobOutput, StopTrainingJobOutputError>) -> Void)
    ...
    func stopTransformJob(input: StopTransformJobInput, completion: @escaping (SdkResult<StopTransformJobOutput, StopTransformJobOutputError>) -> Void)
    /// <p>Updates an action.</p>
    func updateAction(input: UpdateActionInput, completion: @escaping (SdkResult<UpdateActionOutput, UpdateActionOutputError>) -> Void)
    /// <p>Updates the properties of an AppImageConfig.</p>
    func updateAppImageConfig(input: UpdateAppImageConfigInput, completion: @escaping (SdkResult<UpdateAppImageConfigOutput, UpdateAppImageConfigOutputError>) -> Void)
    /// <p>Updates an artifact.</p>
    func updateArtifact(input: UpdateArtifactInput, completion: @escaping (SdkResult<UpdateArtifactOutput, UpdateArtifactOutputError>) -> Void)
    /// <p>Updates the specified Git repository with the specified values.</p>
    func updateCodeRepository(input: UpdateCodeRepositoryInput, completion: @escaping (SdkResult<UpdateCodeRepositoryOutput, UpdateCodeRepositoryOutputError>) -> Void)
    /// <p>Updates a context.</p>
    func updateContext(input: UpdateContextInput, completion: @escaping (SdkResult<UpdateContextOutput, UpdateContextOutputError>) -> Void)
    /// <p>Updates a fleet of devices.</p>
    func updateDeviceFleet(input: UpdateDeviceFleetInput, completion: @escaping (SdkResult<UpdateDeviceFleetOutput, UpdateDeviceFleetOutputError>) -> Void)
    /// <p>Updates one or more devices in a fleet.</p>
    func updateDevices(input: UpdateDevicesInput, completion: @escaping (SdkResult<UpdateDevicesOutput, UpdateDevicesOutputError>) -> Void)
    ...
    func updateEndpointWeightsAndCapacities(input: UpdateEndpointWeightsAndCapacitiesInput, completion: @escaping (SdkResult<UpdateEndpointWeightsAndCapacitiesOutput, UpdateEndpointWeightsAndCapacitiesOutputError>) -> Void)
    /// <p>Adds, updates, or removes the description of an experiment. Updates the display name of an
    ///       experiment.</p>
    func updateExperiment(input: UpdateExperimentInput, completion: @escaping (SdkResult<UpdateExperimentOutput, UpdateExperimentOutputError>) -> Void)
    /// <p>Updates the properties of a SageMaker image. To change the image's tags, use the
    ///         <a>AddTags</a> and <a>DeleteTags</a> APIs.</p>
    func updateImage(input: UpdateImageInput, completion: @escaping (SdkResult<UpdateImageOutput, UpdateImageOutputError>) -> Void)
    /// <p>Updates a versioned model.</p>
    func updateModelPackage(input: UpdateModelPackageInput, completion: @escaping (SdkResult<UpdateModelPackageOutput, UpdateModelPackageOutputError>) -> Void)
    /// <p>Updates a previously created schedule.</p>
    func updateMonitoringSchedule(input: UpdateMonitoringScheduleInput, completion: @escaping (SdkResult<UpdateMonitoringScheduleOutput, UpdateMonitoringScheduleOutputError>) -> Void)
    ...
    func updateNotebookInstance(input: UpdateNotebookInstanceInput, completion: @escaping (SdkResult<UpdateNotebookInstanceOutput, UpdateNotebookInstanceOutputError>) -> Void)
    /// <p>Updates a notebook instance lifecycle configuration created with the <a>CreateNotebookInstanceLifecycleConfig</a> API.</p>
    func updateNotebookInstanceLifecycleConfig(input: UpdateNotebookInstanceLifecycleConfigInput, completion: @escaping (SdkResult<UpdateNotebookInstanceLifecycleConfigOutput, UpdateNotebookInstanceLifecycleConfigOutputError>) -> Void)
    ...
    func updatePipelineExecution(input: UpdatePipelineExecutionInput, completion: @escaping (SdkResult<UpdatePipelineExecutionOutput, UpdatePipelineExecutionOutputError>) -> Void)
    /// <p>Update a model training job to request a new Debugger profiling configuration.</p>
    func updateTrainingJob(input: UpdateTrainingJobInput, completion: @escaping (SdkResult<UpdateTrainingJobOutput, UpdateTrainingJobOutputError>) -> Void)
    /// <p>Updates the display name of a trial.</p>
    func updateTrial(input: UpdateTrialInput, completion: @escaping (SdkResult<UpdateTrialOutput, UpdateTrialOutputError>) -> Void)
    /// <p>Updates one or more properties of a trial component.</p>
    func updateTrialComponent(input: UpdateTrialComponentInput, completion: @escaping (SdkResult<UpdateTrialComponentOutput, UpdateTrialComponentOutputError>) -> Void)
    ...
    ///         </important>
    func updateWorkforce(input: UpdateWorkforceInput, completion: @escaping (SdkResult<UpdateWorkforceOutput, UpdateWorkforceOutputError>) -> Void)
    /// <p>Updates an existing work team with new member definitions or description.</p>
    func updateWorkteam(input: UpdateWorkteamInput, completion: @escaping (SdkResult<UpdateWorkteamOutput, UpdateWorkteamOutputError>) -> Void)
}
