...
struct ListHyperParameterTuningJobsInputBody: Equatable {
...
extension ListHyperParameterTuningJobsInputBody: Decodable {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let sortByDecoded = try containerValues.decodeIfPresent(HyperParameterTuningJobSortByOptions.self, forKey: .sortBy)
        ...
        let statusEqualsDecoded = try containerValues.decodeIfPresent(HyperParameterTuningJobStatus.self, forKey: .statusEquals)
