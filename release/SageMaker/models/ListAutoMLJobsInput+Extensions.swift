...
public struct ListAutoMLJobsInputHeadersMiddleware: Middleware {
    public let id: String = "ListAutoMLJobsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: SerializeStepInput<ListAutoMLJobsInput>,
                  next: H) -> Swift.Result<OperationOutput<ListAutoMLJobsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<ListAutoMLJobsOutputResponse>
...
extension ListAutoMLJobsInput: Encodable, Reflection {
