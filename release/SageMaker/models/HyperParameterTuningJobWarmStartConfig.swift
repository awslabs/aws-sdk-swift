...
///                 job.</p>
///         </note>
public struct HyperParameterTuningJobWarmStartConfig: Equatable {
    ...
    public init (
        parentHyperParameterTuningJobs: [ParentHyperParameterTuningJob]? = nil,
        warmStartType: HyperParameterTuningJobWarmStartType? = nil
    )
    {
