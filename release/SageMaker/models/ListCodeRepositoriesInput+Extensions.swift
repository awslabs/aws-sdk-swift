...
public struct ListCodeRepositoriesInputHeadersMiddleware: Middleware {
    public let id: String = "ListCodeRepositoriesInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: SerializeStepInput<ListCodeRepositoriesInput>,
                  next: H) -> Swift.Result<OperationOutput<ListCodeRepositoriesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<ListCodeRepositoriesOutputResponse>
