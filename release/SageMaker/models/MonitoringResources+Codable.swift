...
extension MonitoringResources: Codable, Reflection {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let clusterConfigDecoded = try containerValues.decodeIfPresent(MonitoringClusterConfig.self, forKey: .clusterConfig)
