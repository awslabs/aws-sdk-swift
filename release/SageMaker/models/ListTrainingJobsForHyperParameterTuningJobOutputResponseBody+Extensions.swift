...
struct ListTrainingJobsForHyperParameterTuningJobOutputResponseBody: Equatable {
    public let trainingJobSummaries: [HyperParameterTrainingJobSummary]?
    public let nextToken: String?
}

extension ListTrainingJobsForHyperParameterTuningJobOutputResponseBody: Decodable {
