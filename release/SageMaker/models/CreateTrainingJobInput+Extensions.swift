...
public struct CreateTrainingJobInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<CreateTrainingJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<CreateTrainingJobOutputResponse>
...
public struct CreateTrainingJobInputBodyMiddleware: Middleware {
    public let id: String = "CreateTrainingJobInputBodyMiddleware"
