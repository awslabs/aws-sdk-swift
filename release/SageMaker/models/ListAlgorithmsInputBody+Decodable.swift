...
struct ListAlgorithmsInputBody: Equatable {
...
extension ListAlgorithmsInputBody: Decodable {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let sortByDecoded = try containerValues.decodeIfPresent(AlgorithmSortBy.self, forKey: .sortBy)
