...
extension TrainingJob: CustomDebugStringConvertible {
    public var debugDescription: String {
        "TrainingJob(algorithmSpecification: \(String(describing: algorithmSpecification)), autoMLJobArn: \(String(describing: autoMLJobArn)), billableTimeInSeconds: \(String(describing: billableTimeInSeconds)), checkpointConfig: \(String(describing: checkpointConfig)), creationTime: \(String(describing: creationTime)), debugHookConfig: \(String(describing: debugHookConfig)), debugRuleConfigurations: \(String(describing: debugRuleConfigurations)), debugRuleEvaluationStatuses: \(String(describing: debugRuleEvaluationStatuses)), enableInterContainerTrafficEncryption: \(String(describing: enableInterContainerTrafficEncryption)), enableManagedSpotTraining: \(String(describing: enableManagedSpotTraining)), enableNetworkIsolation: \(String(describing: enableNetworkIsolation)), environment: \(String(describing: environment)), experimentConfig: \(String(describing: experimentConfig)), failureReason: \(String(describing: failureReason)), finalMetricDataList: \(String(describing: finalMetricDataList)), hyperParameters: \(String(describing: hyperParameters)), inputDataConfig: \(String(describing: inputDataConfig)), labelingJobArn: \(String(describing: labelingJobArn)), lastModifiedTime: \(String(describing: lastModifiedTime)), modelArtifacts: \(String(describing: modelArtifacts)), outputDataConfig: \(String(describing: outputDataConfig)), resourceConfig: \(String(describing: resourceConfig)), retryStrategy: \(String(describing: retryStrategy)), roleArn: \(String(describing: roleArn)), secondaryStatus: \(String(describing: secondaryStatus)), secondaryStatusTransitions: \(String(describing: secondaryStatusTransitions)), stoppingCondition: \(String(describing: stoppingCondition)), tags: \(String(describing: tags)), tensorBoardOutputConfig: \(String(describing: tensorBoardOutputConfig)), trainingEndTime: \(String(describing: trainingEndTime)), trainingJobArn: \(String(describing: trainingJobArn)), trainingJobName: \(String(describing: trainingJobName)), trainingJobStatus: \(String(describing: trainingJobStatus)), trainingStartTime: \(String(describing: trainingStartTime)), trainingTimeInSeconds: \(String(describing: trainingTimeInSeconds)), tuningJobArn: \(String(describing: tuningJobArn)), vpcConfig: \(String(describing: vpcConfig)))"}
}
