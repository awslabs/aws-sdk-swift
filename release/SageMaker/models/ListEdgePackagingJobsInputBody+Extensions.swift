...
struct ListEdgePackagingJobsInputBody: Equatable {
...
extension ListEdgePackagingJobsInputBody: Decodable {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let modelNameContainsDecoded = try containerValues.decodeIfPresent(String.self, forKey: .modelNameContains)
        modelNameContains = modelNameContainsDecoded
        let statusEqualsDecoded = try containerValues.decodeIfPresent(EdgePackagingJobStatus.self, forKey: .statusEquals)
        statusEquals = statusEqualsDecoded
        let sortByDecoded = try containerValues.decodeIfPresent(ListEdgePackagingJobsSortBy.self, forKey: .sortBy)
