...
struct ListModelPackageGroupsInputBody: Equatable {
...
extension ListModelPackageGroupsInputBody: Decodable {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let sortByDecoded = try containerValues.decodeIfPresent(ModelPackageGroupSortBy.self, forKey: .sortBy)
