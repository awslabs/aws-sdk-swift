...
extension AssociateTrialComponentInput: CustomDebugStringConvertible {
    public var debugDescription: String {
        "AssociateTrialComponentInput(trialComponentName: \(String(describing: trialComponentName)), trialName: \(String(describing: trialName)))"}
}
