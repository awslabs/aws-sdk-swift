...
public struct DescribeTransformJobOutputResponse: Equatable {
...
extension DescribeTransformJobOutputResponse: CustomDebugStringConvertible {
    public var debugDescription: String {
        "DescribeTransformJobOutputResponse(autoMLJobArn: \(String(describing: autoMLJobArn)), batchStrategy: \(String(describing: batchStrategy)), creationTime: \(String(describing: creationTime)), dataProcessing: \(String(describing: dataProcessing)), environment: \(String(describing: environment)), experimentConfig: \(String(describing: experimentConfig)), failureReason: \(String(describing: failureReason)), labelingJobArn: \(String(describing: labelingJobArn)), maxConcurrentTransforms: \(String(describing: maxConcurrentTransforms)), maxPayloadInMB: \(String(describing: maxPayloadInMB)), modelClientConfig: \(String(describing: modelClientConfig)), modelName: \(String(describing: modelName)), transformEndTime: \(String(describing: transformEndTime)), transformInput: \(String(describing: transformInput)), transformJobArn: \(String(describing: transformJobArn)), transformJobName: \(String(describing: transformJobName)), transformJobStatus: \(String(describing: transformJobStatus)), transformOutput: \(String(describing: transformOutput)), transformResources: \(String(describing: transformResources)), transformStartTime: \(String(describing: transformStartTime)))"}
}
