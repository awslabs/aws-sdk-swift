...
public struct DescribeWorkforceOutputResponse: Equatable {
...
extension DescribeWorkforceOutputResponse: CustomDebugStringConvertible {
    public var debugDescription: String {
        "DescribeWorkforceOutputResponse(workforce: \(String(describing: workforce)))"}
}
