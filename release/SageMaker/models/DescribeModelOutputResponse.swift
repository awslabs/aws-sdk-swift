...
extension DescribeModelOutputResponse: CustomDebugStringConvertible {
    public var debugDescription: String {
        "DescribeModelOutputResponse(containers: \(String(describing: containers)), creationTime: \(String(describing: creationTime)), enableNetworkIsolation: \(String(describing: enableNetworkIsolation)), executionRoleArn: \(String(describing: executionRoleArn)), inferenceExecutionConfig: \(String(describing: inferenceExecutionConfig)), modelArn: \(String(describing: modelArn)), modelName: \(String(describing: modelName)), primaryContainer: \(String(describing: primaryContainer)), vpcConfig: \(String(describing: vpcConfig)))"}
}
