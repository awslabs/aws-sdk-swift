...
extension AlgorithmValidationSpecification: Codable, Reflection {
    ...
    public init (from decoder: Decoder) throws {
        ...
        let validationProfilesContainer = try containerValues.decodeIfPresent([AlgorithmValidationProfile?].self, forKey: .validationProfiles)
        var validationProfilesDecoded0:[AlgorithmValidationProfile]? = nil
        if let validationProfilesContainer = validationProfilesContainer {
            validationProfilesDecoded0 = [AlgorithmValidationProfile]()
