...
extension DescribeDomainOutputResponse: CustomDebugStringConvertible {
    public var debugDescription: String {
        "DescribeDomainOutputResponse(appNetworkAccessType: \(String(describing: appNetworkAccessType)), authMode: \(String(describing: authMode)), creationTime: \(String(describing: creationTime)), defaultUserSettings: \(String(describing: defaultUserSettings)), domainArn: \(String(describing: domainArn)), domainId: \(String(describing: domainId)), domainName: \(String(describing: domainName)), failureReason: \(String(describing: failureReason)), homeEfsFileSystemId: \(String(describing: homeEfsFileSystemId)), homeEfsFileSystemKmsKeyId: \(String(describing: homeEfsFileSystemKmsKeyId)), kmsKeyId: \(String(describing: kmsKeyId)), lastModifiedTime: \(String(describing: lastModifiedTime)), singleSignOnManagedApplicationInstanceId: \(String(describing: singleSignOnManagedApplicationInstanceId)), status: \(String(describing: status)), subnetIds: \(String(describing: subnetIds)), url: \(String(describing: url)), vpcId: \(String(describing: vpcId)))"}
}
