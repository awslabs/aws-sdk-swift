...
public struct ListCompilationJobsInputHeadersMiddleware: Middleware {
    public let id: String = "ListCompilationJobsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: SerializeStepInput<ListCompilationJobsInput>,
                  next: H) -> Swift.Result<OperationOutput<ListCompilationJobsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<ListCompilationJobsOutputResponse>
...
public struct ListCompilationJobsInputBodyMiddleware: Middleware {
    public let id: String = "ListCompilationJobsInputBodyMiddleware"
...
extension ListCompilationJobsInput: Encodable, Reflection {
