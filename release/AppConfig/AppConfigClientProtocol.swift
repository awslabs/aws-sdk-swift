...
public protocol AppConfigClientProtocol {
    ...
    func createConfigurationProfile(input: CreateConfigurationProfileInput, completion: @escaping (SdkResult<CreateConfigurationProfileOutput, CreateConfigurationProfileOutputError>) -> Void)
    ...
    func createDeploymentStrategy(input: CreateDeploymentStrategyInput, completion: @escaping (SdkResult<CreateDeploymentStrategyOutput, CreateDeploymentStrategyOutputError>) -> Void)
    ...
    func createHostedConfigurationVersion(input: CreateHostedConfigurationVersionInput, completion: @escaping (SdkResult<CreateHostedConfigurationVersionOutput, CreateHostedConfigurationVersionOutputError>) -> Void)
    ...
    func deleteConfigurationProfile(input: DeleteConfigurationProfileInput, completion: @escaping (SdkResult<DeleteConfigurationProfileOutput, DeleteConfigurationProfileOutputError>) -> Void)
    /// <p>Delete a deployment strategy. Deleting a deployment strategy does not delete a
    ///          configuration from a host.</p>
    func deleteDeploymentStrategy(input: DeleteDeploymentStrategyInput, completion: @escaping (SdkResult<DeleteDeploymentStrategyOutput, DeleteDeploymentStrategyOutputError>) -> Void)
    ...
    func deleteHostedConfigurationVersion(input: DeleteHostedConfigurationVersionInput, completion: @escaping (SdkResult<DeleteHostedConfigurationVersionOutput, DeleteHostedConfigurationVersionOutputError>) -> Void)
    ...
    ///          </important>
    func getConfiguration(input: GetConfigurationInput, completion: @escaping (SdkResult<GetConfigurationOutput, GetConfigurationOutputError>) -> Void)
    /// <p>Retrieve information about a configuration profile.</p>
    func getConfigurationProfile(input: GetConfigurationProfileInput, completion: @escaping (SdkResult<GetConfigurationProfileOutput, GetConfigurationProfileOutputError>) -> Void)
    ...
    func getDeploymentStrategy(input: GetDeploymentStrategyInput, completion: @escaping (SdkResult<GetDeploymentStrategyOutput, GetDeploymentStrategyOutputError>) -> Void)
    ...
    func getHostedConfigurationVersion(input: GetHostedConfigurationVersionInput, completion: @escaping (SdkResult<GetHostedConfigurationVersionOutput, GetHostedConfigurationVersionOutputError>) -> Void)
    ...
    func listConfigurationProfiles(input: ListConfigurationProfilesInput, completion: @escaping (SdkResult<ListConfigurationProfilesOutput, ListConfigurationProfilesOutputError>) -> Void)
    ...
    func listDeploymentStrategies(input: ListDeploymentStrategiesInput, completion: @escaping (SdkResult<ListDeploymentStrategiesOutput, ListDeploymentStrategiesOutputError>) -> Void)
    ...
    ///          version.</p>
    func listHostedConfigurationVersions(input: ListHostedConfigurationVersionsInput, completion: @escaping (SdkResult<ListHostedConfigurationVersionsOutput, ListHostedConfigurationVersionsOutputError>) -> Void)
    ...
    func stopDeployment(input: StopDeploymentInput, completion: @escaping (SdkResult<StopDeploymentOutput, StopDeploymentOutputError>) -> Void)
    ...
    func updateConfigurationProfile(input: UpdateConfigurationProfileInput, completion: @escaping (SdkResult<UpdateConfigurationProfileOutput, UpdateConfigurationProfileOutputError>) -> Void)
    /// <p>Updates a deployment strategy.</p>
    func updateDeploymentStrategy(input: UpdateDeploymentStrategyInput, completion: @escaping (SdkResult<UpdateDeploymentStrategyOutput, UpdateDeploymentStrategyOutputError>) -> Void)
    ...
    func validateConfiguration(input: ValidateConfigurationInput, completion: @escaping (SdkResult<ValidateConfigurationOutput, ValidateConfigurationOutputError>) -> Void)
}
