...
public protocol AppConfigClientProtocol {
    ...
    func createConfigurationProfile(input: CreateConfigurationProfileInput, completion: @escaping (SdkResult<CreateConfigurationProfileOutputResponse, CreateConfigurationProfileOutputError>) -> Void)
    ...
    func createDeploymentStrategy(input: CreateDeploymentStrategyInput, completion: @escaping (SdkResult<CreateDeploymentStrategyOutputResponse, CreateDeploymentStrategyOutputError>) -> Void)
    ...
    func createHostedConfigurationVersion(input: CreateHostedConfigurationVersionInput, completion: @escaping (SdkResult<CreateHostedConfigurationVersionOutputResponse, CreateHostedConfigurationVersionOutputError>) -> Void)
    ...
    func deleteConfigurationProfile(input: DeleteConfigurationProfileInput, completion: @escaping (SdkResult<DeleteConfigurationProfileOutputResponse, DeleteConfigurationProfileOutputError>) -> Void)
    /// <p>Delete a deployment strategy. Deleting a deployment strategy does not delete a
    ///          configuration from a host.</p>
    func deleteDeploymentStrategy(input: DeleteDeploymentStrategyInput, completion: @escaping (SdkResult<DeleteDeploymentStrategyOutputResponse, DeleteDeploymentStrategyOutputError>) -> Void)
    /// <p>Delete an environment. Deleting an environment does not delete a configuration from a
    ///          host.</p>
    func deleteEnvironment(input: DeleteEnvironmentInput, completion: @escaping (SdkResult<DeleteEnvironmentOutputResponse, DeleteEnvironmentOutputError>) -> Void)
    /// <p>Delete a version of a configuration from the AppConfig configuration store.</p>
    func deleteHostedConfigurationVersion(input: DeleteHostedConfigurationVersionInput, completion: @escaping (SdkResult<DeleteHostedConfigurationVersionOutputResponse, DeleteHostedConfigurationVersionOutputError>) -> Void)
    ...
    ///          </important>
    func getConfiguration(input: GetConfigurationInput, completion: @escaping (SdkResult<GetConfigurationOutputResponse, GetConfigurationOutputError>) -> Void)
    /// <p>Retrieve information about a configuration profile.</p>
    func getConfigurationProfile(input: GetConfigurationProfileInput, completion: @escaping (SdkResult<GetConfigurationProfileOutputResponse, GetConfigurationProfileOutputError>) -> Void)
    ...
    func getDeploymentStrategy(input: GetDeploymentStrategyInput, completion: @escaping (SdkResult<GetDeploymentStrategyOutputResponse, GetDeploymentStrategyOutputError>) -> Void)
    ...
    func getEnvironment(input: GetEnvironmentInput, completion: @escaping (SdkResult<GetEnvironmentOutputResponse, GetEnvironmentOutputError>) -> Void)
    /// <p>Get information about a specific configuration version.</p>
    func getHostedConfigurationVersion(input: GetHostedConfigurationVersionInput, completion: @escaping (SdkResult<GetHostedConfigurationVersionOutputResponse, GetHostedConfigurationVersionOutputError>) -> Void)
    ...
    func listConfigurationProfiles(input: ListConfigurationProfilesInput, completion: @escaping (SdkResult<ListConfigurationProfilesOutputResponse, ListConfigurationProfilesOutputError>) -> Void)
    ...
    func listDeploymentStrategies(input: ListDeploymentStrategiesInput, completion: @escaping (SdkResult<ListDeploymentStrategiesOutputResponse, ListDeploymentStrategiesOutputError>) -> Void)
    /// <p>List the environments for an application.</p>
    func listEnvironments(input: ListEnvironmentsInput, completion: @escaping (SdkResult<ListEnvironmentsOutputResponse, ListEnvironmentsOutputError>) -> Void)
    /// <p>View a list of configurations stored in the AppConfig configuration store by
    ///          version.</p>
    func listHostedConfigurationVersions(input: ListHostedConfigurationVersionsInput, completion: @escaping (SdkResult<ListHostedConfigurationVersionsOutputResponse, ListHostedConfigurationVersionsOutputError>) -> Void)
    ...
    func updateConfigurationProfile(input: UpdateConfigurationProfileInput, completion: @escaping (SdkResult<UpdateConfigurationProfileOutputResponse, UpdateConfigurationProfileOutputError>) -> Void)
    /// <p>Updates a deployment strategy.</p>
    func updateDeploymentStrategy(input: UpdateDeploymentStrategyInput, completion: @escaping (SdkResult<UpdateDeploymentStrategyOutputResponse, UpdateDeploymentStrategyOutputError>) -> Void)
    ...
    func validateConfiguration(input: ValidateConfigurationInput, completion: @escaping (SdkResult<ValidateConfigurationOutputResponse, ValidateConfigurationOutputError>) -> Void)
}
