...
public class AppConfigClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try AppConfigClientConfiguration(region: unwrappedRegion)
    ...
    public class AppConfigClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("AppConfigClient")
...
public struct AppConfigClientLogHandlerFactory: SDKLogHandlerFactory {
