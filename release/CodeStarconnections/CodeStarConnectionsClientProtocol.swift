...
public protocol CodeStarConnectionsClientProtocol {
    ...
    ///          </note>
    func createHost(input: CreateHostInput, completion: @escaping (SdkResult<CreateHostOutput, CreateHostOutputError>) -> Void)
    ...
    ///          </note>
    func deleteHost(input: DeleteHostInput, completion: @escaping (SdkResult<DeleteHostOutput, DeleteHostOutputError>) -> Void)
    ...
    func getHost(input: GetHostInput, completion: @escaping (SdkResult<GetHostOutput, GetHostOutputError>) -> Void)
    ...
    func listHosts(input: ListHostsInput, completion: @escaping (SdkResult<ListHostsOutput, ListHostsOutputError>) -> Void)
    ...
    func updateHost(input: UpdateHostInput, completion: @escaping (SdkResult<UpdateHostOutput, UpdateHostOutputError>) -> Void)
}
