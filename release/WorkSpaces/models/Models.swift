...
extension WorkSpacesClientTypes.AccountModification: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.AccountModification: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AccountModification(dedicatedTenancyManagementCidrRange: \(Swift.String(describing: dedicatedTenancyManagementCidrRange)), dedicatedTenancySupport: \(Swift.String(describing: dedicatedTenancySupport)), errorCode: \(Swift.String(describing: errorCode)), errorMessage: \(Swift.String(describing: errorMessage)), modificationState: \(Swift.String(describing: modificationState)), startTime: \(Swift.String(describing: startTime)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct AccountModification: Swift.Equatable {
        ...
        public let dedicatedTenancyManagementCidrRange: Swift.String?
        /// <p>The status of BYOL (whether BYOL is being enabled or disabled).</p>
        public let dedicatedTenancySupport: WorkSpacesClientTypes.DedicatedTenancySupportResultEnum?
        ...
        public let modificationState: WorkSpacesClientTypes.DedicatedTenancyModificationStateEnum?
...
public struct AssociateConnectionAliasInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateConnectionAliasInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<AssociateConnectionAliasInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<AssociateConnectionAliasOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<AssociateConnectionAliasInput>
    public typealias MOutput = ClientRuntime.OperationOutput<AssociateConnectionAliasOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AssociateConnectionAliasOutputError>
}

extension AssociateConnectionAliasInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssociateConnectionAliasInput(aliasId: \(Swift.String(describing: aliasId)), resourceId: \(Swift.String(describing: resourceId)))"}
}

extension AssociateConnectionAliasInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct AssociateConnectionAliasInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateConnectionAliasInputHeadersMiddleware"
...
public struct AssociateConnectionAliasInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateConnectionAliasInputQueryItemMiddleware"
...
public struct AssociateConnectionAliasInput: Swift.Equatable {
    ...
    public let aliasId: Swift.String?
...
extension AssociateConnectionAliasOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssociateConnectionAliasOutputResponse(connectionIdentifier: \(Swift.String(describing: connectionIdentifier)))"}
}
...
public struct AssociateConnectionAliasOutputResponse: Swift.Equatable {
    ...
    public let connectionIdentifier: Swift.String?
...
public struct AssociateIpGroupsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateIpGroupsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<AssociateIpGroupsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<AssociateIpGroupsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<AssociateIpGroupsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<AssociateIpGroupsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AssociateIpGroupsOutputError>
}

extension AssociateIpGroupsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssociateIpGroupsInput(directoryId: \(Swift.String(describing: directoryId)), groupIds: \(Swift.String(describing: groupIds)))"}
}

extension AssociateIpGroupsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct AssociateIpGroupsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateIpGroupsInputHeadersMiddleware"
...
public struct AssociateIpGroupsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateIpGroupsInputQueryItemMiddleware"
...
public struct AssociateIpGroupsInput: Swift.Equatable {
    ...
    public let groupIds: [Swift.String]?
...
extension AssociateIpGroupsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct AssociateIpGroupsOutputResponseBody: Swift.Equatable {
}

extension AssociateIpGroupsOutputResponseBody: Swift.Decodable {
...
public struct AuthorizeIpRulesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AuthorizeIpRulesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<AuthorizeIpRulesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<AuthorizeIpRulesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<AuthorizeIpRulesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<AuthorizeIpRulesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AuthorizeIpRulesOutputError>
}

extension AuthorizeIpRulesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AuthorizeIpRulesInput(groupId: \(Swift.String(describing: groupId)), userRules: \(Swift.String(describing: userRules)))"}
}

extension AuthorizeIpRulesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct AuthorizeIpRulesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AuthorizeIpRulesInputHeadersMiddleware"
...
public struct AuthorizeIpRulesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AuthorizeIpRulesInputQueryItemMiddleware"
...
public struct AuthorizeIpRulesInput: Swift.Equatable {
    ...
    public let userRules: [WorkSpacesClientTypes.IpRuleItem]?
...
extension AuthorizeIpRulesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct AuthorizeIpRulesOutputResponseBody: Swift.Equatable {
}

extension AuthorizeIpRulesOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension WorkSpacesClientTypes.ClientProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.ClientProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ClientProperties(reconnectEnabled: \(Swift.String(describing: reconnectEnabled)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct ClientProperties: Swift.Equatable {
        ...
        ///          credentials. </p>
        public let reconnectEnabled: WorkSpacesClientTypes.ReconnectEnum?
...
extension WorkSpacesClientTypes.ClientPropertiesResult: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.ClientPropertiesResult: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ClientPropertiesResult(clientProperties: \(Swift.String(describing: clientProperties)), resourceId: \(Swift.String(describing: resourceId)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct ClientPropertiesResult: Swift.Equatable {
        /// <p>Information about the Amazon WorkSpaces client.</p>
        public let clientProperties: WorkSpacesClientTypes.ClientProperties?
...
extension WorkSpacesClientTypes.ComputeType: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
    }
...
extension WorkSpacesClientTypes.ComputeType: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ComputeType(name: \(Swift.String(describing: name)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct ComputeType: Swift.Equatable {
        ...
        public let name: WorkSpacesClientTypes.Compute?
...
extension WorkSpacesClientTypes.ConnectionAlias: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case aliasId = "AliasId"
...
extension WorkSpacesClientTypes.ConnectionAlias: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConnectionAlias(aliasId: \(Swift.String(describing: aliasId)), associations: \(Swift.String(describing: associations)), connectionString: \(Swift.String(describing: connectionString)), ownerAccountId: \(Swift.String(describing: ownerAccountId)), state: \(Swift.String(describing: state)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct ConnectionAlias: Swift.Equatable {
        ...
        public let associations: [WorkSpacesClientTypes.ConnectionAliasAssociation]?
        ...
        public let connectionString: Swift.String?
        ...
        public let state: WorkSpacesClientTypes.ConnectionAliasState?
...
extension WorkSpacesClientTypes.ConnectionAliasAssociation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.ConnectionAliasAssociation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConnectionAliasAssociation(associatedAccountId: \(Swift.String(describing: associatedAccountId)), associationStatus: \(Swift.String(describing: associationStatus)), connectionIdentifier: \(Swift.String(describing: connectionIdentifier)), resourceId: \(Swift.String(describing: resourceId)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct ConnectionAliasAssociation: Swift.Equatable {
        ...
        public let associatedAccountId: Swift.String?
        /// <p>The association status of the connection alias.</p>
        public let associationStatus: WorkSpacesClientTypes.AssociationStatus?
        /// <p>The identifier of the connection alias association. You use the connection identifier in the DNS TXT record when
        ///          you're configuring your DNS routing policies.</p>
        public let connectionIdentifier: Swift.String?
...
extension WorkSpacesClientTypes.ConnectionAliasPermission: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.ConnectionAliasPermission: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConnectionAliasPermission(allowAssociation: \(Swift.String(describing: allowAssociation)), sharedAccountId: \(Swift.String(describing: sharedAccountId)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct ConnectionAliasPermission: Swift.Equatable {
        ...
        public let allowAssociation: Swift.Bool?
...
public struct CopyWorkspaceImageInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CopyWorkspaceImageInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CopyWorkspaceImageInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CopyWorkspaceImageOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CopyWorkspaceImageInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CopyWorkspaceImageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CopyWorkspaceImageOutputError>
}

extension CopyWorkspaceImageInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CopyWorkspaceImageInput(description: \(Swift.String(describing: description)), name: \(Swift.String(describing: name)), sourceImageId: \(Swift.String(describing: sourceImageId)), sourceRegion: \(Swift.String(describing: sourceRegion)), tags: \(Swift.String(describing: tags)))"}
}

extension CopyWorkspaceImageInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CopyWorkspaceImageInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CopyWorkspaceImageInputHeadersMiddleware"
...
public struct CopyWorkspaceImageInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CopyWorkspaceImageInputQueryItemMiddleware"
...
public struct CopyWorkspaceImageInput: Swift.Equatable {
    ...
    public let sourceImageId: Swift.String?
    /// <p>The identifier of the source Region.</p>
    public let sourceRegion: Swift.String?
    /// <p>The tags for the image.</p>
    public let tags: [WorkSpacesClientTypes.Tag]?
...
extension CopyWorkspaceImageOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CopyWorkspaceImageOutputResponse(imageId: \(Swift.String(describing: imageId)))"}
}
...
public struct CreateConnectionAliasInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConnectionAliasInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateConnectionAliasInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateConnectionAliasOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateConnectionAliasInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateConnectionAliasOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateConnectionAliasOutputError>
}

extension CreateConnectionAliasInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateConnectionAliasInput(connectionString: \(Swift.String(describing: connectionString)), tags: \(Swift.String(describing: tags)))"}
}

extension CreateConnectionAliasInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case connectionString = "ConnectionString"
        case tags = "Tags"
    }
...
public struct CreateConnectionAliasInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConnectionAliasInputHeadersMiddleware"
...
public struct CreateConnectionAliasInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateConnectionAliasInputQueryItemMiddleware"
...
extension CreateConnectionAliasOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateConnectionAliasOutputResponse(aliasId: \(Swift.String(describing: aliasId)))"}
}
...
public struct CreateIpGroupInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateIpGroupInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateIpGroupInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateIpGroupOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateIpGroupInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateIpGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateIpGroupOutputError>
}

extension CreateIpGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateIpGroupInput(groupDesc: \(Swift.String(describing: groupDesc)), groupName: \(Swift.String(describing: groupName)), tags: \(Swift.String(describing: tags)), userRules: \(Swift.String(describing: userRules)))"}
}

extension CreateIpGroupInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateIpGroupInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateIpGroupInputHeadersMiddleware"
...
public struct CreateIpGroupInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateIpGroupInputQueryItemMiddleware"
...
public struct CreateIpGroupInput: Swift.Equatable {
    ...
    public let groupDesc: Swift.String?
...
extension CreateIpGroupOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateIpGroupOutputResponse(groupId: \(Swift.String(describing: groupId)))"}
}
...
extension CreateTagsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateTagsInput(resourceId: \(Swift.String(describing: resourceId)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct CreateWorkspaceBundleInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateWorkspaceBundleInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateWorkspaceBundleInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateWorkspaceBundleOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateWorkspaceBundleInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateWorkspaceBundleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateWorkspaceBundleOutputError>
}

extension CreateWorkspaceBundleInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateWorkspaceBundleInput(bundleDescription: \(Swift.String(describing: bundleDescription)), bundleName: \(Swift.String(describing: bundleName)), computeType: \(Swift.String(describing: computeType)), imageId: \(Swift.String(describing: imageId)), rootStorage: \(Swift.String(describing: rootStorage)), tags: \(Swift.String(describing: tags)), userStorage: \(Swift.String(describing: userStorage)))"}
}

extension CreateWorkspaceBundleInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateWorkspaceBundleInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateWorkspaceBundleInputHeadersMiddleware"
...
public struct CreateWorkspaceBundleInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateWorkspaceBundleInputQueryItemMiddleware"
...
public struct CreateWorkspaceBundleInput: Swift.Equatable {
    ...
    public let bundleDescription: Swift.String?
    /// <p>The name of the bundle.</p>
    public let bundleName: Swift.String?
    /// <p>Describes the compute type of the bundle.</p>
    public let computeType: WorkSpacesClientTypes.ComputeType?
    /// <p>The identifier of the image that is used to create the bundle.</p>
    public let imageId: Swift.String?
    /// <p>Describes the root volume for a WorkSpace bundle.</p>
    public let rootStorage: WorkSpacesClientTypes.RootStorage?
    ...
    public let userStorage: WorkSpacesClientTypes.UserStorage?
...
extension CreateWorkspaceBundleOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateWorkspaceBundleOutputResponse(workspaceBundle: \(Swift.String(describing: workspaceBundle)))"}
}
...
public struct CreateWorkspaceBundleOutputResponse: Swift.Equatable {
    ...
    public let workspaceBundle: WorkSpacesClientTypes.WorkspaceBundle?
...
public struct CreateWorkspacesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateWorkspacesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateWorkspacesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateWorkspacesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateWorkspacesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateWorkspacesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateWorkspacesOutputError>
}

extension CreateWorkspacesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateWorkspacesInput(workspaces: \(Swift.String(describing: workspaces)))"}
}

extension CreateWorkspacesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateWorkspacesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateWorkspacesInputHeadersMiddleware"
...
public struct CreateWorkspacesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateWorkspacesInputQueryItemMiddleware"
...
public struct CreateWorkspacesInput: Swift.Equatable {
    ...
    public let workspaces: [WorkSpacesClientTypes.WorkspaceRequest]?
...
extension CreateWorkspacesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateWorkspacesOutputResponse(failedRequests: \(Swift.String(describing: failedRequests)), pendingRequests: \(Swift.String(describing: pendingRequests)))"}
}
...
public struct CreateWorkspacesOutputResponse: Swift.Equatable {
    ...
    public let failedRequests: [WorkSpacesClientTypes.FailedCreateWorkspaceRequest]?
    ...
    ///          can be incomplete.</p>
    public let pendingRequests: [WorkSpacesClientTypes.Workspace]?
...
extension WorkSpacesClientTypes.DefaultWorkspaceCreationProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.DefaultWorkspaceCreationProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DefaultWorkspaceCreationProperties(customSecurityGroupId: \(Swift.String(describing: customSecurityGroupId)), defaultOu: \(Swift.String(describing: defaultOu)), enableInternetAccess: \(Swift.String(describing: enableInternetAccess)), enableMaintenanceMode: \(Swift.String(describing: enableMaintenanceMode)), enableWorkDocs: \(Swift.String(describing: enableWorkDocs)), userEnabledAsLocalAdministrator: \(Swift.String(describing: userEnabledAsLocalAdministrator)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct DefaultWorkspaceCreationProperties: Swift.Equatable {
        ...
        public let customSecurityGroupId: Swift.String?
        /// <p>The organizational unit (OU) in the directory for the WorkSpace machine accounts.</p>
        public let defaultOu: Swift.String?
        ...
        public let enableInternetAccess: Swift.Bool?
        ...
        ///             Maintenance</a>.</p>
        public let enableMaintenanceMode: Swift.Bool?
        /// <p>Specifies whether the directory is enabled for Amazon WorkDocs.</p>
        public let enableWorkDocs: Swift.Bool?
        /// <p>Specifies whether WorkSpace users are local administrators on their WorkSpaces.</p>
        public let userEnabledAsLocalAdministrator: Swift.Bool?
...
public struct DeleteConnectionAliasInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConnectionAliasInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteConnectionAliasInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteConnectionAliasOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteConnectionAliasInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteConnectionAliasOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteConnectionAliasOutputError>
}

extension DeleteConnectionAliasInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteConnectionAliasInput(aliasId: \(Swift.String(describing: aliasId)))"}
}

extension DeleteConnectionAliasInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case aliasId = "AliasId"
    }
...
public struct DeleteConnectionAliasInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConnectionAliasInputHeadersMiddleware"
...
public struct DeleteConnectionAliasInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteConnectionAliasInputQueryItemMiddleware"
...
extension DeleteConnectionAliasOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteConnectionAliasOutputResponseBody: Swift.Equatable {
}

extension DeleteConnectionAliasOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct DeleteIpGroupInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteIpGroupInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteIpGroupInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteIpGroupOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteIpGroupInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteIpGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteIpGroupOutputError>
}

extension DeleteIpGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteIpGroupInput(groupId: \(Swift.String(describing: groupId)))"}
}

extension DeleteIpGroupInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case groupId = "GroupId"
    }
...
public struct DeleteIpGroupInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteIpGroupInputHeadersMiddleware"
...
public struct DeleteIpGroupInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteIpGroupInputQueryItemMiddleware"
...
extension DeleteIpGroupOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteIpGroupOutputResponseBody: Swift.Equatable {
}

extension DeleteIpGroupOutputResponseBody: Swift.Decodable {
...
extension DeleteTagsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteTagsInput(resourceId: \(Swift.String(describing: resourceId)), tagKeys: \(Swift.String(describing: tagKeys)))"}
}
...
public struct DeleteWorkspaceBundleInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteWorkspaceBundleInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteWorkspaceBundleInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteWorkspaceBundleOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteWorkspaceBundleInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteWorkspaceBundleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteWorkspaceBundleOutputError>
}

extension DeleteWorkspaceBundleInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteWorkspaceBundleInput(bundleId: \(Swift.String(describing: bundleId)))"}
}

extension DeleteWorkspaceBundleInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DeleteWorkspaceBundleInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteWorkspaceBundleInputHeadersMiddleware"
...
public struct DeleteWorkspaceBundleInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteWorkspaceBundleInputQueryItemMiddleware"
...
extension DeleteWorkspaceBundleOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteWorkspaceBundleOutputResponseBody: Swift.Equatable {
}

extension DeleteWorkspaceBundleOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct DeleteWorkspaceImageInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteWorkspaceImageInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteWorkspaceImageInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteWorkspaceImageOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteWorkspaceImageInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteWorkspaceImageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteWorkspaceImageOutputError>
}

extension DeleteWorkspaceImageInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteWorkspaceImageInput(imageId: \(Swift.String(describing: imageId)))"}
}

extension DeleteWorkspaceImageInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case imageId = "ImageId"
    }
...
public struct DeleteWorkspaceImageInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteWorkspaceImageInputHeadersMiddleware"
...
public struct DeleteWorkspaceImageInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteWorkspaceImageInputQueryItemMiddleware"
...
extension DeleteWorkspaceImageOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeleteWorkspaceImageOutputResponseBody: Swift.Equatable {
}

extension DeleteWorkspaceImageOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct DeregisterWorkspaceDirectoryInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeregisterWorkspaceDirectoryInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeregisterWorkspaceDirectoryInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeregisterWorkspaceDirectoryOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeregisterWorkspaceDirectoryInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeregisterWorkspaceDirectoryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeregisterWorkspaceDirectoryOutputError>
}

extension DeregisterWorkspaceDirectoryInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeregisterWorkspaceDirectoryInput(directoryId: \(Swift.String(describing: directoryId)))"}
}

extension DeregisterWorkspaceDirectoryInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case directoryId = "DirectoryId"
    }
...
public struct DeregisterWorkspaceDirectoryInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeregisterWorkspaceDirectoryInputHeadersMiddleware"
...
public struct DeregisterWorkspaceDirectoryInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeregisterWorkspaceDirectoryInputQueryItemMiddleware"
...
extension DeregisterWorkspaceDirectoryOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeregisterWorkspaceDirectoryOutputResponseBody: Swift.Equatable {
}

extension DeregisterWorkspaceDirectoryOutputResponseBody: Swift.Decodable {
...
public struct DescribeAccountModificationsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAccountModificationsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeAccountModificationsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeAccountModificationsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeAccountModificationsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeAccountModificationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeAccountModificationsOutputError>
}

extension DescribeAccountModificationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAccountModificationsInput(nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeAccountModificationsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DescribeAccountModificationsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAccountModificationsInputHeadersMiddleware"
...
public struct DescribeAccountModificationsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAccountModificationsInputQueryItemMiddleware"
...
extension DescribeAccountModificationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAccountModificationsOutputResponse(accountModifications: \(Swift.String(describing: accountModifications)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeAccountModificationsOutputResponse: Swift.Equatable {
    ...
    public let accountModifications: [WorkSpacesClientTypes.AccountModification]?
...
extension DescribeAccountOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAccountOutputResponse(dedicatedTenancyManagementCidrRange: \(Swift.String(describing: dedicatedTenancyManagementCidrRange)), dedicatedTenancySupport: \(Swift.String(describing: dedicatedTenancySupport)))"}
}
...
public struct DescribeClientPropertiesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeClientPropertiesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeClientPropertiesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeClientPropertiesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeClientPropertiesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeClientPropertiesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeClientPropertiesOutputError>
}

extension DescribeClientPropertiesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeClientPropertiesInput(resourceIds: \(Swift.String(describing: resourceIds)))"}
}

extension DescribeClientPropertiesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DescribeClientPropertiesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeClientPropertiesInputHeadersMiddleware"
...
public struct DescribeClientPropertiesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeClientPropertiesInputQueryItemMiddleware"
...
extension DescribeClientPropertiesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeClientPropertiesOutputResponse(clientPropertiesList: \(Swift.String(describing: clientPropertiesList)))"}
}
...
public struct DescribeClientPropertiesOutputResponse: Swift.Equatable {
    ...
    public let clientPropertiesList: [WorkSpacesClientTypes.ClientPropertiesResult]?
...
public struct DescribeConnectionAliasPermissionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConnectionAliasPermissionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeConnectionAliasPermissionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeConnectionAliasPermissionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeConnectionAliasPermissionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeConnectionAliasPermissionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeConnectionAliasPermissionsOutputError>
}

extension DescribeConnectionAliasPermissionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeConnectionAliasPermissionsInput(aliasId: \(Swift.String(describing: aliasId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeConnectionAliasPermissionsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case aliasId = "AliasId"
...
public struct DescribeConnectionAliasPermissionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConnectionAliasPermissionsInputHeadersMiddleware"
...
public struct DescribeConnectionAliasPermissionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConnectionAliasPermissionsInputQueryItemMiddleware"
...
extension DescribeConnectionAliasPermissionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeConnectionAliasPermissionsOutputResponse(aliasId: \(Swift.String(describing: aliasId)), connectionAliasPermissions: \(Swift.String(describing: connectionAliasPermissions)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeConnectionAliasPermissionsOutputResponse: Swift.Equatable {
    ...
    public let connectionAliasPermissions: [WorkSpacesClientTypes.ConnectionAliasPermission]?
...
public struct DescribeConnectionAliasesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConnectionAliasesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeConnectionAliasesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeConnectionAliasesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeConnectionAliasesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeConnectionAliasesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeConnectionAliasesOutputError>
}

extension DescribeConnectionAliasesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeConnectionAliasesInput(aliasIds: \(Swift.String(describing: aliasIds)), limit: \(Swift.String(describing: limit)), nextToken: \(Swift.String(describing: nextToken)), resourceId: \(Swift.String(describing: resourceId)))"}
}

extension DescribeConnectionAliasesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DescribeConnectionAliasesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConnectionAliasesInputHeadersMiddleware"
...
public struct DescribeConnectionAliasesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeConnectionAliasesInputQueryItemMiddleware"
...
public struct DescribeConnectionAliasesInput: Swift.Equatable {
    ...
    public let aliasIds: [Swift.String]?
...
extension DescribeConnectionAliasesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeConnectionAliasesOutputResponse(connectionAliases: \(Swift.String(describing: connectionAliases)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeConnectionAliasesOutputResponse: Swift.Equatable {
    ...
    public let connectionAliases: [WorkSpacesClientTypes.ConnectionAlias]?
    /// <p>The token to use to retrieve the next page of results. This value is null when there are no more results to return. </p>
    public let nextToken: Swift.String?
...
public struct DescribeIpGroupsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeIpGroupsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeIpGroupsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeIpGroupsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeIpGroupsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeIpGroupsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeIpGroupsOutputError>
}

extension DescribeIpGroupsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeIpGroupsInput(groupIds: \(Swift.String(describing: groupIds)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeIpGroupsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case groupIds = "GroupIds"
        case maxResults = "MaxResults"
        case nextToken = "NextToken"
...
public struct DescribeIpGroupsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeIpGroupsInputHeadersMiddleware"
...
public struct DescribeIpGroupsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeIpGroupsInputQueryItemMiddleware"
...
extension DescribeIpGroupsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeIpGroupsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), result: \(Swift.String(describing: result)))"}
}
...
public struct DescribeIpGroupsOutputResponse: Swift.Equatable {
    ...
    public let result: [WorkSpacesClientTypes.WorkspacesIpGroup]?
...
extension DescribeTagsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeTagsInput(resourceId: \(Swift.String(describing: resourceId)))"}
}
...
extension DescribeTagsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeTagsOutputResponse(tagList: \(Swift.String(describing: tagList)))"}
}
...
public struct DescribeTagsOutputResponse: Swift.Equatable {
    /// <p>The tags.</p>
    public let tagList: [WorkSpacesClientTypes.Tag]?
...
public struct DescribeWorkspaceBundlesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceBundlesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeWorkspaceBundlesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeWorkspaceBundlesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeWorkspaceBundlesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeWorkspaceBundlesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeWorkspaceBundlesOutputError>
}

extension DescribeWorkspaceBundlesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceBundlesInput(bundleIds: \(Swift.String(describing: bundleIds)), nextToken: \(Swift.String(describing: nextToken)), owner: \(Swift.String(describing: owner)))"}
}

extension DescribeWorkspaceBundlesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DescribeWorkspaceBundlesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceBundlesInputHeadersMiddleware"
...
public struct DescribeWorkspaceBundlesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceBundlesInputQueryItemMiddleware"
...
extension DescribeWorkspaceBundlesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceBundlesOutputResponse(bundles: \(Swift.String(describing: bundles)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeWorkspaceBundlesOutputResponse: Swift.Equatable {
    ...
    public let bundles: [WorkSpacesClientTypes.WorkspaceBundle]?
...
public struct DescribeWorkspaceDirectoriesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceDirectoriesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeWorkspaceDirectoriesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeWorkspaceDirectoriesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeWorkspaceDirectoriesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeWorkspaceDirectoriesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeWorkspaceDirectoriesOutputError>
}

extension DescribeWorkspaceDirectoriesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceDirectoriesInput(directoryIds: \(Swift.String(describing: directoryIds)), limit: \(Swift.String(describing: limit)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeWorkspaceDirectoriesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DescribeWorkspaceDirectoriesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceDirectoriesInputHeadersMiddleware"
...
public struct DescribeWorkspaceDirectoriesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceDirectoriesInputQueryItemMiddleware"
...
extension DescribeWorkspaceDirectoriesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceDirectoriesOutputResponse(directories: \(Swift.String(describing: directories)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeWorkspaceDirectoriesOutputResponse: Swift.Equatable {
    ...
    public let directories: [WorkSpacesClientTypes.WorkspaceDirectory]?
    /// <p>The token to use to retrieve the next page of results. This value is null when there are no more results to return. </p>
    public let nextToken: Swift.String?
...
public struct DescribeWorkspaceImagePermissionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceImagePermissionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeWorkspaceImagePermissionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeWorkspaceImagePermissionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeWorkspaceImagePermissionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeWorkspaceImagePermissionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeWorkspaceImagePermissionsOutputError>
}

extension DescribeWorkspaceImagePermissionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceImagePermissionsInput(imageId: \(Swift.String(describing: imageId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeWorkspaceImagePermissionsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case imageId = "ImageId"
        case maxResults = "MaxResults"
        case nextToken = "NextToken"
...
public struct DescribeWorkspaceImagePermissionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceImagePermissionsInputHeadersMiddleware"
...
public struct DescribeWorkspaceImagePermissionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceImagePermissionsInputQueryItemMiddleware"
...
extension DescribeWorkspaceImagePermissionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceImagePermissionsOutputResponse(imageId: \(Swift.String(describing: imageId)), imagePermissions: \(Swift.String(describing: imagePermissions)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeWorkspaceImagePermissionsOutputResponse: Swift.Equatable {
    ...
    public let imagePermissions: [WorkSpacesClientTypes.ImagePermission]?
    /// <p>The token to use to retrieve the next page of results. This value is null when there are no more results to return. </p>
    public let nextToken: Swift.String?
...
public struct DescribeWorkspaceImagesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceImagesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeWorkspaceImagesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeWorkspaceImagesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeWorkspaceImagesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeWorkspaceImagesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeWorkspaceImagesOutputError>
}

extension DescribeWorkspaceImagesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceImagesInput(imageIds: \(Swift.String(describing: imageIds)), imageType: \(Swift.String(describing: imageType)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeWorkspaceImagesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DescribeWorkspaceImagesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceImagesInputHeadersMiddleware"
...
public struct DescribeWorkspaceImagesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceImagesInputQueryItemMiddleware"
...
public struct DescribeWorkspaceImagesInput: Swift.Equatable {
    /// <p>The identifier of the image.</p>
    public let imageIds: [Swift.String]?
    /// <p>The type (owned or shared) of the image.</p>
    public let imageType: WorkSpacesClientTypes.ImageType?
    /// <p>The maximum number of items to return.</p>
    public let maxResults: Swift.Int?
    /// <p>If you received a <code>NextToken</code> from a previous call that was paginated,
    ///          provide this token to receive the next set of results.</p>
...
extension DescribeWorkspaceImagesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceImagesOutputResponse(images: \(Swift.String(describing: images)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct DescribeWorkspaceImagesOutputResponse: Swift.Equatable {
    ...
    public let images: [WorkSpacesClientTypes.WorkspaceImage]?
    /// <p>The token to use to retrieve the next page of results. This value is null when there are no more results to return. </p>
    public let nextToken: Swift.String?
...
public struct DescribeWorkspaceSnapshotsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceSnapshotsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeWorkspaceSnapshotsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeWorkspaceSnapshotsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeWorkspaceSnapshotsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeWorkspaceSnapshotsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeWorkspaceSnapshotsOutputError>
}

extension DescribeWorkspaceSnapshotsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceSnapshotsInput(workspaceId: \(Swift.String(describing: workspaceId)))"}
}

extension DescribeWorkspaceSnapshotsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DescribeWorkspaceSnapshotsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceSnapshotsInputHeadersMiddleware"
...
public struct DescribeWorkspaceSnapshotsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspaceSnapshotsInputQueryItemMiddleware"
...
extension DescribeWorkspaceSnapshotsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspaceSnapshotsOutputResponse(rebuildSnapshots: \(Swift.String(describing: rebuildSnapshots)), restoreSnapshots: \(Swift.String(describing: restoreSnapshots)))"}
}
...
public struct DescribeWorkspaceSnapshotsOutputResponse: Swift.Equatable {
    ...
    ///          the user volume.</p>
    public let rebuildSnapshots: [WorkSpacesClientTypes.Snapshot]?
    ...
    public let restoreSnapshots: [WorkSpacesClientTypes.Snapshot]?
...
public struct DescribeWorkspacesConnectionStatusInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspacesConnectionStatusInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeWorkspacesConnectionStatusInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeWorkspacesConnectionStatusOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeWorkspacesConnectionStatusInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeWorkspacesConnectionStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeWorkspacesConnectionStatusOutputError>
}

extension DescribeWorkspacesConnectionStatusInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspacesConnectionStatusInput(nextToken: \(Swift.String(describing: nextToken)), workspaceIds: \(Swift.String(describing: workspaceIds)))"}
}

extension DescribeWorkspacesConnectionStatusInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case nextToken = "NextToken"
...
public struct DescribeWorkspacesConnectionStatusInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspacesConnectionStatusInputHeadersMiddleware"
...
public struct DescribeWorkspacesConnectionStatusInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspacesConnectionStatusInputQueryItemMiddleware"
...
public struct DescribeWorkspacesConnectionStatusInput: Swift.Equatable {
    ...
    public let workspaceIds: [Swift.String]?
...
extension DescribeWorkspacesConnectionStatusOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspacesConnectionStatusOutputResponse(nextToken: \(Swift.String(describing: nextToken)), workspacesConnectionStatus: \(Swift.String(describing: workspacesConnectionStatus)))"}
}
...
public struct DescribeWorkspacesConnectionStatusOutputResponse: Swift.Equatable {
    ...
    public let workspacesConnectionStatus: [WorkSpacesClientTypes.WorkspaceConnectionStatus]?
...
public struct DescribeWorkspacesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspacesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeWorkspacesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeWorkspacesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeWorkspacesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeWorkspacesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeWorkspacesOutputError>
}

extension DescribeWorkspacesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspacesInput(bundleId: \(Swift.String(describing: bundleId)), directoryId: \(Swift.String(describing: directoryId)), limit: \(Swift.String(describing: limit)), nextToken: \(Swift.String(describing: nextToken)), userName: \(Swift.String(describing: userName)), workspaceIds: \(Swift.String(describing: workspaceIds)))"}
}

extension DescribeWorkspacesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bundleId = "BundleId"
        case directoryId = "DirectoryId"
        case limit = "Limit"
...
public struct DescribeWorkspacesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspacesInputHeadersMiddleware"
...
public struct DescribeWorkspacesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeWorkspacesInputQueryItemMiddleware"
...
extension DescribeWorkspacesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeWorkspacesOutputResponse(nextToken: \(Swift.String(describing: nextToken)), workspaces: \(Swift.String(describing: workspaces)))"}
}
...
public struct DescribeWorkspacesOutputResponse: Swift.Equatable {
    ...
    public let workspaces: [WorkSpacesClientTypes.Workspace]?
...
public struct DisassociateConnectionAliasInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateConnectionAliasInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DisassociateConnectionAliasInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DisassociateConnectionAliasOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DisassociateConnectionAliasInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DisassociateConnectionAliasOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisassociateConnectionAliasOutputError>
}

extension DisassociateConnectionAliasInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DisassociateConnectionAliasInput(aliasId: \(Swift.String(describing: aliasId)))"}
}

extension DisassociateConnectionAliasInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case aliasId = "AliasId"
    }
...
public struct DisassociateConnectionAliasInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateConnectionAliasInputHeadersMiddleware"
...
public struct DisassociateConnectionAliasInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateConnectionAliasInputQueryItemMiddleware"
...
extension DisassociateConnectionAliasOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DisassociateConnectionAliasOutputResponseBody: Swift.Equatable {
}

extension DisassociateConnectionAliasOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct DisassociateIpGroupsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateIpGroupsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DisassociateIpGroupsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DisassociateIpGroupsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DisassociateIpGroupsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DisassociateIpGroupsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisassociateIpGroupsOutputError>
}

extension DisassociateIpGroupsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DisassociateIpGroupsInput(directoryId: \(Swift.String(describing: directoryId)), groupIds: \(Swift.String(describing: groupIds)))"}
}

extension DisassociateIpGroupsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case directoryId = "DirectoryId"
        case groupIds = "GroupIds"
    }
...
public struct DisassociateIpGroupsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateIpGroupsInputHeadersMiddleware"
...
public struct DisassociateIpGroupsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateIpGroupsInputQueryItemMiddleware"
...
extension DisassociateIpGroupsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DisassociateIpGroupsOutputResponseBody: Swift.Equatable {
}

extension DisassociateIpGroupsOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension WorkSpacesClientTypes.FailedCreateWorkspaceRequest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case errorCode = "ErrorCode"
        case errorMessage = "ErrorMessage"
...
extension WorkSpacesClientTypes.FailedCreateWorkspaceRequest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "FailedCreateWorkspaceRequest(errorCode: \(Swift.String(describing: errorCode)), errorMessage: \(Swift.String(describing: errorMessage)), workspaceRequest: \(Swift.String(describing: workspaceRequest)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct FailedCreateWorkspaceRequest: Swift.Equatable {
        ...
        public let workspaceRequest: WorkSpacesClientTypes.WorkspaceRequest?
...
extension WorkSpacesClientTypes.FailedWorkspaceChangeRequest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case errorCode = "ErrorCode"
        case errorMessage = "ErrorMessage"
        case workspaceId = "WorkspaceId"
...
extension WorkSpacesClientTypes.FailedWorkspaceChangeRequest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "FailedWorkspaceChangeRequest(errorCode: \(Swift.String(describing: errorCode)), errorMessage: \(Swift.String(describing: errorMessage)), workspaceId: \(Swift.String(describing: workspaceId)))"}
}
...
extension WorkSpacesClientTypes.ImagePermission: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case sharedAccountId = "SharedAccountId"
    }
...
extension WorkSpacesClientTypes.ImagePermission: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ImagePermission(sharedAccountId: \(Swift.String(describing: sharedAccountId)))"}
}
...
public struct ImportWorkspaceImageInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ImportWorkspaceImageInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ImportWorkspaceImageInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ImportWorkspaceImageOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ImportWorkspaceImageInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ImportWorkspaceImageOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ImportWorkspaceImageOutputError>
}

extension ImportWorkspaceImageInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ImportWorkspaceImageInput(applications: \(Swift.String(describing: applications)), ec2ImageId: \(Swift.String(describing: ec2ImageId)), imageDescription: \(Swift.String(describing: imageDescription)), imageName: \(Swift.String(describing: imageName)), ingestionProcess: \(Swift.String(describing: ingestionProcess)), tags: \(Swift.String(describing: tags)))"}
}

extension ImportWorkspaceImageInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ImportWorkspaceImageInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ImportWorkspaceImageInputHeadersMiddleware"
...
public struct ImportWorkspaceImageInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ImportWorkspaceImageInputQueryItemMiddleware"
...
public struct ImportWorkspaceImageInput: Swift.Equatable {
    ...
    ///          </note>
    public let applications: [WorkSpacesClientTypes.Application]?
    ...
    public let ingestionProcess: WorkSpacesClientTypes.WorkspaceImageIngestionProcess?
    /// <p>The tags. Each WorkSpaces resource can have a maximum of 50 tags.</p>
    public let tags: [WorkSpacesClientTypes.Tag]?
...
extension ImportWorkspaceImageOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ImportWorkspaceImageOutputResponse(imageId: \(Swift.String(describing: imageId)))"}
}
...
extension InvalidParameterValuesException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidParameterValuesException(message: \(Swift.String(describing: message)))"}
}

extension InvalidParameterValuesException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct InvalidParameterValuesException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension WorkSpacesClientTypes.IpRuleItem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case ipRule
        case ruleDesc
    }
...
extension WorkSpacesClientTypes.IpRuleItem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "IpRuleItem(ipRule: \(Swift.String(describing: ipRule)), ruleDesc: \(Swift.String(describing: ruleDesc)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct IpRuleItem: Swift.Equatable {
        ...
        public let ipRule: Swift.String?
        /// <p>The description.</p>
        public let ruleDesc: Swift.String?
...
public struct ListAvailableManagementCidrRangesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableManagementCidrRangesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListAvailableManagementCidrRangesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListAvailableManagementCidrRangesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListAvailableManagementCidrRangesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListAvailableManagementCidrRangesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAvailableManagementCidrRangesOutputError>
}

extension ListAvailableManagementCidrRangesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAvailableManagementCidrRangesInput(managementCidrRangeConstraint: \(Swift.String(describing: managementCidrRangeConstraint)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListAvailableManagementCidrRangesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ListAvailableManagementCidrRangesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableManagementCidrRangesInputHeadersMiddleware"
...
public struct ListAvailableManagementCidrRangesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAvailableManagementCidrRangesInputQueryItemMiddleware"
...
public struct ListAvailableManagementCidrRangesInput: Swift.Equatable {
    ...
    public let managementCidrRangeConstraint: Swift.String?
    /// <p>The maximum number of items to return.</p>
    public let maxResults: Swift.Int?
    /// <p>If you received a <code>NextToken</code> from a previous call that was paginated,
    ///          provide this token to receive the next set of results.</p>
...
extension ListAvailableManagementCidrRangesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAvailableManagementCidrRangesOutputResponse(managementCidrRanges: \(Swift.String(describing: managementCidrRanges)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct ListAvailableManagementCidrRangesOutputResponse: Swift.Equatable {
    ...
    public let managementCidrRanges: [Swift.String]?
    /// <p>The token to use to retrieve the next page of results. This value is null when there are no more results to return. </p>
    public let nextToken: Swift.String?
...
public struct MigrateWorkspaceInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MigrateWorkspaceInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<MigrateWorkspaceInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<MigrateWorkspaceOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<MigrateWorkspaceInput>
    public typealias MOutput = ClientRuntime.OperationOutput<MigrateWorkspaceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<MigrateWorkspaceOutputError>
}

extension MigrateWorkspaceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MigrateWorkspaceInput(bundleId: \(Swift.String(describing: bundleId)), sourceWorkspaceId: \(Swift.String(describing: sourceWorkspaceId)))"}
}

extension MigrateWorkspaceInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bundleId = "BundleId"
...
public struct MigrateWorkspaceInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MigrateWorkspaceInputHeadersMiddleware"
...
public struct MigrateWorkspaceInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "MigrateWorkspaceInputQueryItemMiddleware"
...
public struct MigrateWorkspaceInput: Swift.Equatable {
    ...
    public let sourceWorkspaceId: Swift.String?
...
extension MigrateWorkspaceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MigrateWorkspaceOutputResponse(sourceWorkspaceId: \(Swift.String(describing: sourceWorkspaceId)), targetWorkspaceId: \(Swift.String(describing: targetWorkspaceId)))"}
}
...
public struct MigrateWorkspaceOutputResponse: Swift.Equatable {
    ...
    public let targetWorkspaceId: Swift.String?
...
extension WorkSpacesClientTypes.ModificationState: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.ModificationState: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModificationState(resource: \(Swift.String(describing: resource)), state: \(Swift.String(describing: state)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct ModificationState: Swift.Equatable {
        /// <p>The resource.</p>
        public let resource: WorkSpacesClientTypes.ModificationResourceEnum?
        /// <p>The modification state.</p>
        public let state: WorkSpacesClientTypes.ModificationStateEnum?
...
public struct ModifyAccountInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyAccountInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ModifyAccountInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ModifyAccountOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ModifyAccountInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ModifyAccountOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ModifyAccountOutputError>
}

extension ModifyAccountInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModifyAccountInput(dedicatedTenancyManagementCidrRange: \(Swift.String(describing: dedicatedTenancyManagementCidrRange)), dedicatedTenancySupport: \(Swift.String(describing: dedicatedTenancySupport)))"}
}

extension ModifyAccountInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case dedicatedTenancyManagementCidrRange = "DedicatedTenancyManagementCidrRange"
        case dedicatedTenancySupport = "DedicatedTenancySupport"
    }
...
public struct ModifyAccountInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyAccountInputHeadersMiddleware"
...
public struct ModifyAccountInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyAccountInputQueryItemMiddleware"
...
public struct ModifyAccountInput: Swift.Equatable {
    ...
    public let dedicatedTenancySupport: WorkSpacesClientTypes.DedicatedTenancySupportEnum?
...
extension ModifyAccountOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct ModifyAccountOutputResponseBody: Swift.Equatable {
}

extension ModifyAccountOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct ModifyClientPropertiesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyClientPropertiesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ModifyClientPropertiesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ModifyClientPropertiesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ModifyClientPropertiesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ModifyClientPropertiesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ModifyClientPropertiesOutputError>
}

extension ModifyClientPropertiesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModifyClientPropertiesInput(clientProperties: \(Swift.String(describing: clientProperties)), resourceId: \(Swift.String(describing: resourceId)))"}
}

extension ModifyClientPropertiesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case clientProperties = "ClientProperties"
        case resourceId = "ResourceId"
    }
...
public struct ModifyClientPropertiesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyClientPropertiesInputHeadersMiddleware"
...
public struct ModifyClientPropertiesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyClientPropertiesInputQueryItemMiddleware"
...
extension ModifyClientPropertiesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct ModifyClientPropertiesOutputResponseBody: Swift.Equatable {
}

extension ModifyClientPropertiesOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct ModifySelfservicePermissionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifySelfservicePermissionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ModifySelfservicePermissionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ModifySelfservicePermissionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ModifySelfservicePermissionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ModifySelfservicePermissionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ModifySelfservicePermissionsOutputError>
}

extension ModifySelfservicePermissionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModifySelfservicePermissionsInput(resourceId: \(Swift.String(describing: resourceId)), selfservicePermissions: \(Swift.String(describing: selfservicePermissions)))"}
}

extension ModifySelfservicePermissionsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case resourceId = "ResourceId"
...
public struct ModifySelfservicePermissionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifySelfservicePermissionsInputHeadersMiddleware"
...
public struct ModifySelfservicePermissionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifySelfservicePermissionsInputQueryItemMiddleware"
...
public struct ModifySelfservicePermissionsInput: Swift.Equatable {
    ...
    public let selfservicePermissions: WorkSpacesClientTypes.SelfservicePermissions?
...
extension ModifySelfservicePermissionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct ModifySelfservicePermissionsOutputResponseBody: Swift.Equatable {
}

extension ModifySelfservicePermissionsOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct ModifyWorkspaceAccessPropertiesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspaceAccessPropertiesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ModifyWorkspaceAccessPropertiesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ModifyWorkspaceAccessPropertiesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ModifyWorkspaceAccessPropertiesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ModifyWorkspaceAccessPropertiesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ModifyWorkspaceAccessPropertiesOutputError>
}

extension ModifyWorkspaceAccessPropertiesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModifyWorkspaceAccessPropertiesInput(resourceId: \(Swift.String(describing: resourceId)), workspaceAccessProperties: \(Swift.String(describing: workspaceAccessProperties)))"}
}

extension ModifyWorkspaceAccessPropertiesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case resourceId = "ResourceId"
...
public struct ModifyWorkspaceAccessPropertiesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspaceAccessPropertiesInputHeadersMiddleware"
...
public struct ModifyWorkspaceAccessPropertiesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspaceAccessPropertiesInputQueryItemMiddleware"
...
public struct ModifyWorkspaceAccessPropertiesInput: Swift.Equatable {
    ...
    public let workspaceAccessProperties: WorkSpacesClientTypes.WorkspaceAccessProperties?
...
extension ModifyWorkspaceAccessPropertiesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct ModifyWorkspaceAccessPropertiesOutputResponseBody: Swift.Equatable {
}

extension ModifyWorkspaceAccessPropertiesOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct ModifyWorkspaceCreationPropertiesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspaceCreationPropertiesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ModifyWorkspaceCreationPropertiesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ModifyWorkspaceCreationPropertiesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ModifyWorkspaceCreationPropertiesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ModifyWorkspaceCreationPropertiesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ModifyWorkspaceCreationPropertiesOutputError>
}

extension ModifyWorkspaceCreationPropertiesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModifyWorkspaceCreationPropertiesInput(resourceId: \(Swift.String(describing: resourceId)), workspaceCreationProperties: \(Swift.String(describing: workspaceCreationProperties)))"}
}

extension ModifyWorkspaceCreationPropertiesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case resourceId = "ResourceId"
...
public struct ModifyWorkspaceCreationPropertiesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspaceCreationPropertiesInputHeadersMiddleware"
...
public struct ModifyWorkspaceCreationPropertiesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspaceCreationPropertiesInputQueryItemMiddleware"
...
public struct ModifyWorkspaceCreationPropertiesInput: Swift.Equatable {
    ...
    public let workspaceCreationProperties: WorkSpacesClientTypes.WorkspaceCreationProperties?
...
extension ModifyWorkspaceCreationPropertiesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct ModifyWorkspaceCreationPropertiesOutputResponseBody: Swift.Equatable {
}

extension ModifyWorkspaceCreationPropertiesOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct ModifyWorkspacePropertiesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspacePropertiesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ModifyWorkspacePropertiesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ModifyWorkspacePropertiesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ModifyWorkspacePropertiesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ModifyWorkspacePropertiesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ModifyWorkspacePropertiesOutputError>
}

extension ModifyWorkspacePropertiesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModifyWorkspacePropertiesInput(workspaceId: \(Swift.String(describing: workspaceId)), workspaceProperties: \(Swift.String(describing: workspaceProperties)))"}
}

extension ModifyWorkspacePropertiesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case workspaceId = "WorkspaceId"
...
public struct ModifyWorkspacePropertiesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspacePropertiesInputHeadersMiddleware"
...
public struct ModifyWorkspacePropertiesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspacePropertiesInputQueryItemMiddleware"
...
public struct ModifyWorkspacePropertiesInput: Swift.Equatable {
    ...
    public let workspaceProperties: WorkSpacesClientTypes.WorkspaceProperties?
...
extension ModifyWorkspacePropertiesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct ModifyWorkspacePropertiesOutputResponseBody: Swift.Equatable {
}

extension ModifyWorkspacePropertiesOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct ModifyWorkspaceStateInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspaceStateInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ModifyWorkspaceStateInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ModifyWorkspaceStateOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ModifyWorkspaceStateInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ModifyWorkspaceStateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ModifyWorkspaceStateOutputError>
}

extension ModifyWorkspaceStateInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModifyWorkspaceStateInput(workspaceId: \(Swift.String(describing: workspaceId)), workspaceState: \(Swift.String(describing: workspaceState)))"}
}

extension ModifyWorkspaceStateInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case workspaceId = "WorkspaceId"
...
public struct ModifyWorkspaceStateInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspaceStateInputHeadersMiddleware"
...
public struct ModifyWorkspaceStateInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyWorkspaceStateInputQueryItemMiddleware"
...
public struct ModifyWorkspaceStateInput: Swift.Equatable {
    ...
    public let workspaceState: WorkSpacesClientTypes.TargetWorkspaceState?
...
extension ModifyWorkspaceStateOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct ModifyWorkspaceStateOutputResponseBody: Swift.Equatable {
}

extension ModifyWorkspaceStateOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension WorkSpacesClientTypes.OperatingSystem: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case type = "Type"
    }
...
extension WorkSpacesClientTypes.OperatingSystem: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "OperatingSystem(type: \(Swift.String(describing: type)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct OperatingSystem: Swift.Equatable {
        ...
        public let type: WorkSpacesClientTypes.OperatingSystemType?
...
extension OperationNotSupportedException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct OperationNotSupportedException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension WorkSpacesClientTypes.RebootRequest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case workspaceId = "WorkspaceId"
    }
...
extension WorkSpacesClientTypes.RebootRequest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RebootRequest(workspaceId: \(Swift.String(describing: workspaceId)))"}
}
...
public struct RebootWorkspacesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebootWorkspacesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<RebootWorkspacesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<RebootWorkspacesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<RebootWorkspacesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<RebootWorkspacesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RebootWorkspacesOutputError>
}

extension RebootWorkspacesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RebootWorkspacesInput(rebootWorkspaceRequests: \(Swift.String(describing: rebootWorkspaceRequests)))"}
}

extension RebootWorkspacesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct RebootWorkspacesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebootWorkspacesInputHeadersMiddleware"
...
public struct RebootWorkspacesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebootWorkspacesInputQueryItemMiddleware"
...
public struct RebootWorkspacesInput: Swift.Equatable {
    ...
    public let rebootWorkspaceRequests: [WorkSpacesClientTypes.RebootRequest]?
...
extension RebootWorkspacesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RebootWorkspacesOutputResponse(failedRequests: \(Swift.String(describing: failedRequests)))"}
}
...
public struct RebootWorkspacesOutputResponse: Swift.Equatable {
    ...
    public let failedRequests: [WorkSpacesClientTypes.FailedWorkspaceChangeRequest]?
...
extension WorkSpacesClientTypes.RebuildRequest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case workspaceId = "WorkspaceId"
    }
...
extension WorkSpacesClientTypes.RebuildRequest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RebuildRequest(workspaceId: \(Swift.String(describing: workspaceId)))"}
}
...
public struct RebuildWorkspacesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebuildWorkspacesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<RebuildWorkspacesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<RebuildWorkspacesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<RebuildWorkspacesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<RebuildWorkspacesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RebuildWorkspacesOutputError>
}

extension RebuildWorkspacesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RebuildWorkspacesInput(rebuildWorkspaceRequests: \(Swift.String(describing: rebuildWorkspaceRequests)))"}
}

extension RebuildWorkspacesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct RebuildWorkspacesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebuildWorkspacesInputHeadersMiddleware"
...
public struct RebuildWorkspacesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RebuildWorkspacesInputQueryItemMiddleware"
...
public struct RebuildWorkspacesInput: Swift.Equatable {
    ...
    public let rebuildWorkspaceRequests: [WorkSpacesClientTypes.RebuildRequest]?
...
extension RebuildWorkspacesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RebuildWorkspacesOutputResponse(failedRequests: \(Swift.String(describing: failedRequests)))"}
}
...
public struct RegisterWorkspaceDirectoryInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterWorkspaceDirectoryInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<RegisterWorkspaceDirectoryInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<RegisterWorkspaceDirectoryOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<RegisterWorkspaceDirectoryInput>
    public typealias MOutput = ClientRuntime.OperationOutput<RegisterWorkspaceDirectoryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RegisterWorkspaceDirectoryOutputError>
}

extension RegisterWorkspaceDirectoryInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RegisterWorkspaceDirectoryInput(directoryId: \(Swift.String(describing: directoryId)), enableSelfService: \(Swift.String(describing: enableSelfService)), enableWorkDocs: \(Swift.String(describing: enableWorkDocs)), subnetIds: \(Swift.String(describing: subnetIds)), tags: \(Swift.String(describing: tags)), tenancy: \(Swift.String(describing: tenancy)))"}
}

extension RegisterWorkspaceDirectoryInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case directoryId = "DirectoryId"
...
public struct RegisterWorkspaceDirectoryInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterWorkspaceDirectoryInputHeadersMiddleware"
...
public struct RegisterWorkspaceDirectoryInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RegisterWorkspaceDirectoryInputQueryItemMiddleware"
...
public struct RegisterWorkspaceDirectoryInput: Swift.Equatable {
    ...
    public let enableSelfService: Swift.Bool?
    ...
    public let tenancy: WorkSpacesClientTypes.Tenancy?
...
extension RegisterWorkspaceDirectoryOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct RegisterWorkspaceDirectoryOutputResponseBody: Swift.Equatable {
}

extension RegisterWorkspaceDirectoryOutputResponseBody: Swift.Decodable {
...
extension ResourceAssociatedException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct ResourceAssociatedException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension ResourceCreationFailedException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceCreationFailedException(message: \(Swift.String(describing: message)))"}
}

extension ResourceCreationFailedException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct ResourceCreationFailedException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension ResourceNotFoundException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceNotFoundException(resourceId: \(Swift.String(describing: resourceId)), message: \(Swift.String(describing: message)))"}
}
...
extension ResourceUnavailableException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceUnavailableException(resourceId: \(Swift.String(describing: resourceId)), message: \(Swift.String(describing: message)))"}
}
...
public struct RestoreWorkspaceInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RestoreWorkspaceInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<RestoreWorkspaceInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<RestoreWorkspaceOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<RestoreWorkspaceInput>
    public typealias MOutput = ClientRuntime.OperationOutput<RestoreWorkspaceOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RestoreWorkspaceOutputError>
}

extension RestoreWorkspaceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RestoreWorkspaceInput(workspaceId: \(Swift.String(describing: workspaceId)))"}
}

extension RestoreWorkspaceInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case workspaceId = "WorkspaceId"
    }
...
public struct RestoreWorkspaceInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RestoreWorkspaceInputHeadersMiddleware"
...
public struct RestoreWorkspaceInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RestoreWorkspaceInputQueryItemMiddleware"
...
extension RestoreWorkspaceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct RestoreWorkspaceOutputResponseBody: Swift.Equatable {
}

extension RestoreWorkspaceOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct RevokeIpRulesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RevokeIpRulesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<RevokeIpRulesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<RevokeIpRulesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<RevokeIpRulesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<RevokeIpRulesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RevokeIpRulesOutputError>
}

extension RevokeIpRulesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RevokeIpRulesInput(groupId: \(Swift.String(describing: groupId)), userRules: \(Swift.String(describing: userRules)))"}
}

extension RevokeIpRulesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case groupId = "GroupId"
        case userRules = "UserRules"
    }
...
public struct RevokeIpRulesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RevokeIpRulesInputHeadersMiddleware"
...
public struct RevokeIpRulesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RevokeIpRulesInputQueryItemMiddleware"
...
public struct RevokeIpRulesInput: Swift.Equatable {
    ...
    public let userRules: [Swift.String]?
...
extension RevokeIpRulesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct RevokeIpRulesOutputResponseBody: Swift.Equatable {
}

extension RevokeIpRulesOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension WorkSpacesClientTypes.RootStorage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.RootStorage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RootStorage(capacity: \(Swift.String(describing: capacity)))"}
}
...
extension WorkSpacesClientTypes.SelfservicePermissions: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.SelfservicePermissions: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SelfservicePermissions(changeComputeType: \(Swift.String(describing: changeComputeType)), increaseVolumeSize: \(Swift.String(describing: increaseVolumeSize)), rebuildWorkspace: \(Swift.String(describing: rebuildWorkspace)), restartWorkspace: \(Swift.String(describing: restartWorkspace)), switchRunningMode: \(Swift.String(describing: switchRunningMode)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct SelfservicePermissions: Swift.Equatable {
        ...
        public let changeComputeType: WorkSpacesClientTypes.ReconnectEnum?
        /// <p>Specifies whether users can increase the volume size of the drives on their
        ///          WorkSpace.</p>
        public let increaseVolumeSize: WorkSpacesClientTypes.ReconnectEnum?
        /// <p>Specifies whether users can rebuild the operating system of a WorkSpace to its original
        ///          state.</p>
        public let rebuildWorkspace: WorkSpacesClientTypes.ReconnectEnum?
        /// <p>Specifies whether users can restart their WorkSpace.</p>
        public let restartWorkspace: WorkSpacesClientTypes.ReconnectEnum?
        /// <p>Specifies whether users can switch the running mode of their WorkSpace.</p>
        public let switchRunningMode: WorkSpacesClientTypes.ReconnectEnum?
...
extension WorkSpacesClientTypes.Snapshot: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.Snapshot: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Snapshot(snapshotTime: \(Swift.String(describing: snapshotTime)))"}
}
...
extension WorkSpacesClientTypes.StartRequest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case workspaceId = "WorkspaceId"
    }
...
extension WorkSpacesClientTypes.StartRequest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartRequest(workspaceId: \(Swift.String(describing: workspaceId)))"}
}
...
public struct StartWorkspacesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartWorkspacesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartWorkspacesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartWorkspacesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartWorkspacesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartWorkspacesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartWorkspacesOutputError>
}

extension StartWorkspacesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartWorkspacesInput(startWorkspaceRequests: \(Swift.String(describing: startWorkspaceRequests)))"}
}

extension StartWorkspacesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct StartWorkspacesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartWorkspacesInputHeadersMiddleware"
...
public struct StartWorkspacesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartWorkspacesInputQueryItemMiddleware"
...
public struct StartWorkspacesInput: Swift.Equatable {
    ...
    public let startWorkspaceRequests: [WorkSpacesClientTypes.StartRequest]?
...
extension StartWorkspacesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartWorkspacesOutputResponse(failedRequests: \(Swift.String(describing: failedRequests)))"}
}
...
extension WorkSpacesClientTypes.StopRequest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case workspaceId = "WorkspaceId"
    }
...
extension WorkSpacesClientTypes.StopRequest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopRequest(workspaceId: \(Swift.String(describing: workspaceId)))"}
}
...
public struct StopWorkspacesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopWorkspacesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StopWorkspacesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StopWorkspacesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StopWorkspacesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StopWorkspacesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopWorkspacesOutputError>
}

extension StopWorkspacesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopWorkspacesInput(stopWorkspaceRequests: \(Swift.String(describing: stopWorkspaceRequests)))"}
}

extension StopWorkspacesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct StopWorkspacesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopWorkspacesInputHeadersMiddleware"
...
public struct StopWorkspacesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopWorkspacesInputQueryItemMiddleware"
...
public struct StopWorkspacesInput: Swift.Equatable {
    ...
    public let stopWorkspaceRequests: [WorkSpacesClientTypes.StopRequest]?
...
extension StopWorkspacesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopWorkspacesOutputResponse(failedRequests: \(Swift.String(describing: failedRequests)))"}
}
...
extension WorkSpacesClientTypes.Tag: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case key = "Key"
        case value = "Value"
    }
...
extension WorkSpacesClientTypes.Tag: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension WorkSpacesClientTypes.TerminateRequest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case workspaceId = "WorkspaceId"
    }
...
extension WorkSpacesClientTypes.TerminateRequest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TerminateRequest(workspaceId: \(Swift.String(describing: workspaceId)))"}
}
...
public struct TerminateWorkspacesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateWorkspacesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<TerminateWorkspacesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<TerminateWorkspacesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<TerminateWorkspacesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<TerminateWorkspacesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<TerminateWorkspacesOutputError>
}

extension TerminateWorkspacesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TerminateWorkspacesInput(terminateWorkspaceRequests: \(Swift.String(describing: terminateWorkspaceRequests)))"}
}

extension TerminateWorkspacesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct TerminateWorkspacesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateWorkspacesInputHeadersMiddleware"
...
public struct TerminateWorkspacesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "TerminateWorkspacesInputQueryItemMiddleware"
...
public struct TerminateWorkspacesInput: Swift.Equatable {
    ...
    public let terminateWorkspaceRequests: [WorkSpacesClientTypes.TerminateRequest]?
...
extension TerminateWorkspacesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TerminateWorkspacesOutputResponse(failedRequests: \(Swift.String(describing: failedRequests)))"}
}
...
extension UnsupportedNetworkConfigurationException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UnsupportedNetworkConfigurationException(message: \(Swift.String(describing: message)))"}
}

extension UnsupportedNetworkConfigurationException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
///             Configure a VPC for Amazon WorkSpaces</a>.</p>
public struct UnsupportedNetworkConfigurationException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension UnsupportedWorkspaceConfigurationException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UnsupportedWorkspaceConfigurationException(message: \(Swift.String(describing: message)))"}
}

extension UnsupportedWorkspaceConfigurationException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct UnsupportedWorkspaceConfigurationException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
public struct UpdateConnectionAliasPermissionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateConnectionAliasPermissionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateConnectionAliasPermissionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateConnectionAliasPermissionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateConnectionAliasPermissionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateConnectionAliasPermissionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateConnectionAliasPermissionOutputError>
}

extension UpdateConnectionAliasPermissionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateConnectionAliasPermissionInput(aliasId: \(Swift.String(describing: aliasId)), connectionAliasPermission: \(Swift.String(describing: connectionAliasPermission)))"}
}

extension UpdateConnectionAliasPermissionInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case aliasId = "AliasId"
...
public struct UpdateConnectionAliasPermissionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateConnectionAliasPermissionInputHeadersMiddleware"
...
public struct UpdateConnectionAliasPermissionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateConnectionAliasPermissionInputQueryItemMiddleware"
...
public struct UpdateConnectionAliasPermissionInput: Swift.Equatable {
    ...
    public let connectionAliasPermission: WorkSpacesClientTypes.ConnectionAliasPermission?
...
extension UpdateConnectionAliasPermissionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct UpdateConnectionAliasPermissionOutputResponseBody: Swift.Equatable {
}

extension UpdateConnectionAliasPermissionOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct UpdateRulesOfIpGroupInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRulesOfIpGroupInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateRulesOfIpGroupInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateRulesOfIpGroupOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateRulesOfIpGroupInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRulesOfIpGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRulesOfIpGroupOutputError>
}

extension UpdateRulesOfIpGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRulesOfIpGroupInput(groupId: \(Swift.String(describing: groupId)), userRules: \(Swift.String(describing: userRules)))"}
}

extension UpdateRulesOfIpGroupInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case groupId = "GroupId"
        case userRules = "UserRules"
    }
...
public struct UpdateRulesOfIpGroupInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRulesOfIpGroupInputHeadersMiddleware"
...
public struct UpdateRulesOfIpGroupInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRulesOfIpGroupInputQueryItemMiddleware"
...
extension UpdateRulesOfIpGroupOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct UpdateRulesOfIpGroupOutputResponseBody: Swift.Equatable {
}

extension UpdateRulesOfIpGroupOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct UpdateWorkspaceBundleInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceBundleInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateWorkspaceBundleInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateWorkspaceBundleOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateWorkspaceBundleInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateWorkspaceBundleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateWorkspaceBundleOutputError>
}

extension UpdateWorkspaceBundleInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateWorkspaceBundleInput(bundleId: \(Swift.String(describing: bundleId)), imageId: \(Swift.String(describing: imageId)))"}
}

extension UpdateWorkspaceBundleInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bundleId = "BundleId"
        case imageId = "ImageId"
    }
...
public struct UpdateWorkspaceBundleInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceBundleInputHeadersMiddleware"
...
public struct UpdateWorkspaceBundleInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceBundleInputQueryItemMiddleware"
...
extension UpdateWorkspaceBundleOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct UpdateWorkspaceBundleOutputResponseBody: Swift.Equatable {
}

extension UpdateWorkspaceBundleOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct UpdateWorkspaceImagePermissionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceImagePermissionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateWorkspaceImagePermissionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateWorkspaceImagePermissionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateWorkspaceImagePermissionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateWorkspaceImagePermissionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateWorkspaceImagePermissionOutputError>
}

extension UpdateWorkspaceImagePermissionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateWorkspaceImagePermissionInput(allowCopyImage: \(Swift.String(describing: allowCopyImage)), imageId: \(Swift.String(describing: imageId)), sharedAccountId: \(Swift.String(describing: sharedAccountId)))"}
}

extension UpdateWorkspaceImagePermissionInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct UpdateWorkspaceImagePermissionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceImagePermissionInputHeadersMiddleware"
...
public struct UpdateWorkspaceImagePermissionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateWorkspaceImagePermissionInputQueryItemMiddleware"
...
public struct UpdateWorkspaceImagePermissionInput: Swift.Equatable {
    ...
    ///       has been shared.</p>
    public let allowCopyImage: Swift.Bool?
    /// <p>The identifier of the image.</p>
    public let imageId: Swift.String?
...
extension UpdateWorkspaceImagePermissionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct UpdateWorkspaceImagePermissionOutputResponseBody: Swift.Equatable {
}

extension UpdateWorkspaceImagePermissionOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension WorkSpacesClientTypes.UserStorage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case capacity = "Capacity"
    }
...
extension WorkSpacesClientTypes.UserStorage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UserStorage(capacity: \(Swift.String(describing: capacity)))"}
}
...
extension WorkSpacesClientTypes.Workspace: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bundleId = "BundleId"
...
extension WorkSpacesClientTypes.Workspace: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Workspace(bundleId: \(Swift.String(describing: bundleId)), computerName: \(Swift.String(describing: computerName)), directoryId: \(Swift.String(describing: directoryId)), errorCode: \(Swift.String(describing: errorCode)), errorMessage: \(Swift.String(describing: errorMessage)), ipAddress: \(Swift.String(describing: ipAddress)), modificationStates: \(Swift.String(describing: modificationStates)), rootVolumeEncryptionEnabled: \(Swift.String(describing: rootVolumeEncryptionEnabled)), state: \(Swift.String(describing: state)), subnetId: \(Swift.String(describing: subnetId)), userName: \(Swift.String(describing: userName)), userVolumeEncryptionEnabled: \(Swift.String(describing: userVolumeEncryptionEnabled)), volumeEncryptionKey: \(Swift.String(describing: volumeEncryptionKey)), workspaceId: \(Swift.String(describing: workspaceId)), workspaceProperties: \(Swift.String(describing: workspaceProperties)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct Workspace: Swift.Equatable {
        ...
        public let modificationStates: [WorkSpacesClientTypes.ModificationState]?
        /// <p>Indicates whether the data stored on the root volume is encrypted.</p>
        public let rootVolumeEncryptionEnabled: Swift.Bool?
        ...
        ///          </note>
        public let state: WorkSpacesClientTypes.WorkspaceState?
        /// <p>The identifier of the subnet for the WorkSpace.</p>
        public let subnetId: Swift.String?
        /// <p>The user for the WorkSpace.</p>
        public let userName: Swift.String?
        /// <p>Indicates whether the data stored on the user volume is encrypted.</p>
        public let userVolumeEncryptionEnabled: Swift.Bool?
        ...
        public let volumeEncryptionKey: Swift.String?
        /// <p>The identifier of the WorkSpace.</p>
        public let workspaceId: Swift.String?
        /// <p>The properties of the WorkSpace.</p>
        public let workspaceProperties: WorkSpacesClientTypes.WorkspaceProperties?
...
extension WorkSpacesClientTypes.WorkspaceAccessProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.WorkspaceAccessProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspaceAccessProperties(deviceTypeAndroid: \(Swift.String(describing: deviceTypeAndroid)), deviceTypeChromeOs: \(Swift.String(describing: deviceTypeChromeOs)), deviceTypeIos: \(Swift.String(describing: deviceTypeIos)), deviceTypeLinux: \(Swift.String(describing: deviceTypeLinux)), deviceTypeOsx: \(Swift.String(describing: deviceTypeOsx)), deviceTypeWeb: \(Swift.String(describing: deviceTypeWeb)), deviceTypeWindows: \(Swift.String(describing: deviceTypeWindows)), deviceTypeZeroClient: \(Swift.String(describing: deviceTypeZeroClient)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct WorkspaceAccessProperties: Swift.Equatable {
        ...
        public let deviceTypeAndroid: WorkSpacesClientTypes.AccessPropertyValue?
        /// <p>Indicates whether users can use Chromebooks to access their WorkSpaces.</p>
        public let deviceTypeChromeOs: WorkSpacesClientTypes.AccessPropertyValue?
        /// <p>Indicates whether users can use iOS devices to access their WorkSpaces.</p>
        public let deviceTypeIos: WorkSpacesClientTypes.AccessPropertyValue?
        /// <p>Indicates whether users can use Linux clients to access their WorkSpaces.</p>
        public let deviceTypeLinux: WorkSpacesClientTypes.AccessPropertyValue?
        ...
        public let deviceTypeOsx: WorkSpacesClientTypes.AccessPropertyValue?
        /// <p>Indicates whether users can access their WorkSpaces through a web browser.</p>
        public let deviceTypeWeb: WorkSpacesClientTypes.AccessPropertyValue?
        /// <p>Indicates whether users can use Windows clients to access their WorkSpaces. To restrict
        ///          WorkSpaces access to trusted devices (also known as managed devices) with valid
        ///          certificates, specify a value of <code>TRUST</code>. For more information, see <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/trusted-devices.html">Restrict
        ///             WorkSpaces Access to Trusted Devices</a>. </p>
        public let deviceTypeWindows: WorkSpacesClientTypes.AccessPropertyValue?
        /// <p>Indicates whether users can use zero client devices to access their WorkSpaces.</p>
        public let deviceTypeZeroClient: WorkSpacesClientTypes.AccessPropertyValue?
...
extension WorkSpacesClientTypes.WorkspaceBundle: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bundleId = "BundleId"
        case computeType = "ComputeType"
...
extension WorkSpacesClientTypes.WorkspaceBundle: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspaceBundle(bundleId: \(Swift.String(describing: bundleId)), computeType: \(Swift.String(describing: computeType)), creationTime: \(Swift.String(describing: creationTime)), description: \(Swift.String(describing: description)), imageId: \(Swift.String(describing: imageId)), lastUpdatedTime: \(Swift.String(describing: lastUpdatedTime)), name: \(Swift.String(describing: name)), owner: \(Swift.String(describing: owner)), rootStorage: \(Swift.String(describing: rootStorage)), userStorage: \(Swift.String(describing: userStorage)))"}
}
...
extension WorkSpacesClientTypes.WorkspaceConnectionStatus: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.WorkspaceConnectionStatus: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspaceConnectionStatus(connectionState: \(Swift.String(describing: connectionState)), connectionStateCheckTimestamp: \(Swift.String(describing: connectionStateCheckTimestamp)), lastKnownUserConnectionTimestamp: \(Swift.String(describing: lastKnownUserConnectionTimestamp)), workspaceId: \(Swift.String(describing: workspaceId)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct WorkspaceConnectionStatus: Swift.Equatable {
        ...
        ///          is stopped.</p>
        public let connectionState: WorkSpacesClientTypes.ConnectionState?
        /// <p>The timestamp of the connection status check.</p>
        public let connectionStateCheckTimestamp: ClientRuntime.Date?
        /// <p>The timestamp of the last known user connection.</p>
        public let lastKnownUserConnectionTimestamp: ClientRuntime.Date?
        /// <p>The identifier of the WorkSpace.</p>
        public let workspaceId: Swift.String?
...
extension WorkSpacesClientTypes.WorkspaceCreationProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case customSecurityGroupId = "CustomSecurityGroupId"
        case defaultOu = "DefaultOu"
        case enableInternetAccess = "EnableInternetAccess"
...
extension WorkSpacesClientTypes.WorkspaceCreationProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspaceCreationProperties(customSecurityGroupId: \(Swift.String(describing: customSecurityGroupId)), defaultOu: \(Swift.String(describing: defaultOu)), enableInternetAccess: \(Swift.String(describing: enableInternetAccess)), enableMaintenanceMode: \(Swift.String(describing: enableMaintenanceMode)), enableWorkDocs: \(Swift.String(describing: enableWorkDocs)), userEnabledAsLocalAdministrator: \(Swift.String(describing: userEnabledAsLocalAdministrator)))"}
}
...
extension WorkSpacesClientTypes.WorkspaceDirectory: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case alias = "Alias"
...
extension WorkSpacesClientTypes.WorkspaceDirectory: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspaceDirectory(alias: \(Swift.String(describing: alias)), customerUserName: \(Swift.String(describing: customerUserName)), directoryId: \(Swift.String(describing: directoryId)), directoryName: \(Swift.String(describing: directoryName)), directoryType: \(Swift.String(describing: directoryType)), dnsIpAddresses: \(Swift.String(describing: dnsIpAddresses)), iamRoleId: \(Swift.String(describing: iamRoleId)), registrationCode: \(Swift.String(describing: registrationCode)), selfservicePermissions: \(Swift.String(describing: selfservicePermissions)), state: \(Swift.String(describing: state)), subnetIds: \(Swift.String(describing: subnetIds)), tenancy: \(Swift.String(describing: tenancy)), workspaceAccessProperties: \(Swift.String(describing: workspaceAccessProperties)), workspaceCreationProperties: \(Swift.String(describing: workspaceCreationProperties)), workspaceSecurityGroupId: \(Swift.String(describing: workspaceSecurityGroupId)), ipGroupIds: \(Swift.String(describing: ipGroupIds)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct WorkspaceDirectory: Swift.Equatable {
        ...
        public let directoryType: WorkSpacesClientTypes.WorkspaceDirectoryType?
        /// <p>The IP addresses of the DNS servers for the directory.</p>
        public let dnsIpAddresses: [Swift.String]?
        ...
        public let iamRoleId: Swift.String?
        /// <p>The identifiers of the IP access control groups associated with the directory.</p>
        public let ipGroupIds: [Swift.String]?
        ...
        public let state: WorkSpacesClientTypes.WorkspaceDirectoryState?
        ...
        public let workspaceCreationProperties: WorkSpacesClientTypes.DefaultWorkspaceCreationProperties?
        /// <p>The identifier of the security group that is assigned to new WorkSpaces.</p>
        public let workspaceSecurityGroupId: Swift.String?
...
extension WorkSpacesClientTypes.WorkspaceImage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.WorkspaceImage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspaceImage(created: \(Swift.String(describing: created)), description: \(Swift.String(describing: description)), errorCode: \(Swift.String(describing: errorCode)), errorMessage: \(Swift.String(describing: errorMessage)), imageId: \(Swift.String(describing: imageId)), name: \(Swift.String(describing: name)), operatingSystem: \(Swift.String(describing: operatingSystem)), ownerAccountId: \(Swift.String(describing: ownerAccountId)), requiredTenancy: \(Swift.String(describing: requiredTenancy)), state: \(Swift.String(describing: state)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct WorkspaceImage: Swift.Equatable {
        ...
        public let name: Swift.String?
        /// <p>The operating system that the image is running. </p>
        public let operatingSystem: WorkSpacesClientTypes.OperatingSystem?
        ...
        ///             Desktop Images</a>.</p>
        public let requiredTenancy: WorkSpacesClientTypes.WorkspaceImageRequiredTenancy?
        /// <p>The status of the image.</p>
        public let state: WorkSpacesClientTypes.WorkspaceImageState?
...
extension WorkSpacesClientTypes.WorkspaceProperties: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension WorkSpacesClientTypes.WorkspaceProperties: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspaceProperties(computeTypeName: \(Swift.String(describing: computeTypeName)), rootVolumeSizeGib: \(Swift.String(describing: rootVolumeSizeGib)), runningMode: \(Swift.String(describing: runningMode)), runningModeAutoStopTimeoutInMinutes: \(Swift.String(describing: runningModeAutoStopTimeoutInMinutes)), userVolumeSizeGib: \(Swift.String(describing: userVolumeSizeGib)))"}
}
...
extension WorkSpacesClientTypes {
    ...
    public struct WorkspaceProperties: Swift.Equatable {
        ...
        ///          Bundles</a>.</p>
        public let computeTypeName: WorkSpacesClientTypes.Compute?
        ...
        public let rootVolumeSizeGib: Swift.Int?
...
extension WorkSpacesClientTypes.WorkspaceRequest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bundleId = "BundleId"
        case directoryId = "DirectoryId"
        case rootVolumeEncryptionEnabled = "RootVolumeEncryptionEnabled"
...
extension WorkSpacesClientTypes.WorkspaceRequest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspaceRequest(bundleId: \(Swift.String(describing: bundleId)), directoryId: \(Swift.String(describing: directoryId)), rootVolumeEncryptionEnabled: \(Swift.String(describing: rootVolumeEncryptionEnabled)), tags: \(Swift.String(describing: tags)), userName: \(Swift.String(describing: userName)), userVolumeEncryptionEnabled: \(Swift.String(describing: userVolumeEncryptionEnabled)), volumeEncryptionKey: \(Swift.String(describing: volumeEncryptionKey)), workspaceProperties: \(Swift.String(describing: workspaceProperties)))"}
}
...
extension WorkspacesDefaultRoleNotFoundException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspacesDefaultRoleNotFoundException(message: \(Swift.String(describing: message)))"}
}

extension WorkspacesDefaultRoleNotFoundException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct WorkspacesDefaultRoleNotFoundException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension WorkSpacesClientTypes.WorkspacesIpGroup: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case groupDesc
        case groupId
        case groupName
...
extension WorkSpacesClientTypes.WorkspacesIpGroup: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "WorkspacesIpGroup(groupDesc: \(Swift.String(describing: groupDesc)), groupId: \(Swift.String(describing: groupId)), groupName: \(Swift.String(describing: groupName)), userRules: \(Swift.String(describing: userRules)))"}
}
