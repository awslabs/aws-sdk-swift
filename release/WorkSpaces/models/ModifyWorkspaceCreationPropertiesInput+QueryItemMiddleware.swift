...
public struct ModifyWorkspaceCreationPropertiesInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<ModifyWorkspaceCreationPropertiesOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<ModifyWorkspaceCreationPropertiesOutput>
