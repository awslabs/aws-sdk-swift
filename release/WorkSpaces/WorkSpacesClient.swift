...
public class WorkSpacesClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try WorkSpacesClientConfiguration(region: unwrappedRegion)
    ...
    public class WorkSpacesClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("WorkSpacesClient")
