...
public protocol WorkSpacesClientProtocol {
    ...
    ///          </note>
    func associateConnectionAlias(input: AssociateConnectionAliasInput, completion: @escaping (SdkResult<AssociateConnectionAliasOutput, AssociateConnectionAliasOutputError>) -> Void)
    /// <p>Associates the specified IP access control group with the specified directory.</p>
    func associateIpGroups(input: AssociateIpGroupsInput, completion: @escaping (SdkResult<AssociateIpGroupsOutput, AssociateIpGroupsOutputError>) -> Void)
    ...
    func authorizeIpRules(input: AuthorizeIpRulesInput, completion: @escaping (SdkResult<AuthorizeIpRulesOutput, AuthorizeIpRulesOutputError>) -> Void)
    ...
    ///          </important>
    func copyWorkspaceImage(input: CopyWorkspaceImageInput, completion: @escaping (SdkResult<CopyWorkspaceImageOutput, CopyWorkspaceImageOutputError>) -> Void)
    ...
    ///          Cross-Region Redirection for Amazon WorkSpaces</a>.</p>
    func createConnectionAlias(input: CreateConnectionAliasInput, completion: @escaping (SdkResult<CreateConnectionAliasOutput, CreateConnectionAliasOutputError>) -> Void)
    ...
    func createIpGroup(input: CreateIpGroupInput, completion: @escaping (SdkResult<CreateIpGroupOutput, CreateIpGroupOutputError>) -> Void)
    ...
    func createWorkspaceBundle(input: CreateWorkspaceBundleInput, completion: @escaping (SdkResult<CreateWorkspaceBundleOutput, CreateWorkspaceBundleOutputError>) -> Void)
    /// <p>Creates one or more WorkSpaces.</p>
    ///          <p>This operation is asynchronous and returns before the WorkSpaces are created.</p>
    func createWorkspaces(input: CreateWorkspacesInput, completion: @escaping (SdkResult<CreateWorkspacesOutput, CreateWorkspacesOutputError>) -> Void)
    ...
    ///          </note>
    func deleteConnectionAlias(input: DeleteConnectionAliasInput, completion: @escaping (SdkResult<DeleteConnectionAliasOutput, DeleteConnectionAliasOutputError>) -> Void)
    ...
    func deleteIpGroup(input: DeleteIpGroupInput, completion: @escaping (SdkResult<DeleteIpGroupOutput, DeleteIpGroupOutputError>) -> Void)
    ...
    func deleteWorkspaceBundle(input: DeleteWorkspaceBundleInput, completion: @escaping (SdkResult<DeleteWorkspaceBundleOutput, DeleteWorkspaceBundleOutputError>) -> Void)
    ...
    ///          other accounts. </p>
    func deleteWorkspaceImage(input: DeleteWorkspaceImageInput, completion: @escaping (SdkResult<DeleteWorkspaceImageOutput, DeleteWorkspaceImageOutputError>) -> Void)
    ...
    ///             WorkSpaces again.</p>
    ///          </note>
    func deregisterWorkspaceDirectory(input: DeregisterWorkspaceDirectoryInput, completion: @escaping (SdkResult<DeregisterWorkspaceDirectoryOutput, DeregisterWorkspaceDirectoryOutputError>) -> Void)
    /// <p>Retrieves a list that describes the configuration of Bring Your Own License (BYOL) for
    ///          the specified account.</p>
    func describeAccount(input: DescribeAccountInput, completion: @escaping (SdkResult<DescribeAccountOutput, DescribeAccountOutputError>) -> Void)
    ...
    func describeAccountModifications(input: DescribeAccountModificationsInput, completion: @escaping (SdkResult<DescribeAccountModificationsOutput, DescribeAccountModificationsOutputError>) -> Void)
    /// <p>Retrieves a list that describes one or more specified Amazon WorkSpaces clients.</p>
    func describeClientProperties(input: DescribeClientPropertiesInput, completion: @escaping (SdkResult<DescribeClientPropertiesOutput, DescribeClientPropertiesOutputError>) -> Void)
    /// <p>Retrieves a list that describes the connection aliases used for cross-Region redirection. For more information, see
    ///          <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/cross-region-redirection.html">
    ///          Cross-Region Redirection for Amazon WorkSpaces</a>.</p>
    func describeConnectionAliases(input: DescribeConnectionAliasesInput, completion: @escaping (SdkResult<DescribeConnectionAliasesOutput, DescribeConnectionAliasesOutputError>) -> Void)
    ...
    ///             Cross-Region Redirection for Amazon WorkSpaces</a>.</p>
    func describeConnectionAliasPermissions(input: DescribeConnectionAliasPermissionsInput, completion: @escaping (SdkResult<DescribeConnectionAliasPermissionsOutput, DescribeConnectionAliasPermissionsOutputError>) -> Void)
    /// <p>Describes one or more of your IP access control groups.</p>
    func describeIpGroups(input: DescribeIpGroupsInput, completion: @escaping (SdkResult<DescribeIpGroupsOutput, DescribeIpGroupsOutputError>) -> Void)
    ...
    func describeWorkspaceBundles(input: DescribeWorkspaceBundlesInput, completion: @escaping (SdkResult<DescribeWorkspaceBundlesOutput, DescribeWorkspaceBundlesOutputError>) -> Void)
    /// <p>Describes the available directories that are registered with
    ///          Amazon WorkSpaces.</p>
    func describeWorkspaceDirectories(input: DescribeWorkspaceDirectoriesInput, completion: @escaping (SdkResult<DescribeWorkspaceDirectoriesOutput, DescribeWorkspaceDirectoriesOutputError>) -> Void)
    /// <p>Describes the permissions that the owner of an image has granted to other
    ///          AWS accounts for an image.</p>
    func describeWorkspaceImagePermissions(input: DescribeWorkspaceImagePermissionsInput, completion: @escaping (SdkResult<DescribeWorkspaceImagePermissionsOutput, DescribeWorkspaceImagePermissionsOutputError>) -> Void)
    ...
    func describeWorkspaceImages(input: DescribeWorkspaceImagesInput, completion: @escaping (SdkResult<DescribeWorkspaceImagesOutput, DescribeWorkspaceImagesOutputError>) -> Void)
    ...
    func describeWorkspaces(input: DescribeWorkspacesInput, completion: @escaping (SdkResult<DescribeWorkspacesOutput, DescribeWorkspacesOutputError>) -> Void)
    /// <p>Describes the connection status of the specified WorkSpaces.</p>
    func describeWorkspacesConnectionStatus(input: DescribeWorkspacesConnectionStatusInput, completion: @escaping (SdkResult<DescribeWorkspacesConnectionStatusOutput, DescribeWorkspacesConnectionStatusOutputError>) -> Void)
    /// <p>Describes the snapshots for the specified WorkSpace.</p>
    func describeWorkspaceSnapshots(input: DescribeWorkspaceSnapshotsInput, completion: @escaping (SdkResult<DescribeWorkspaceSnapshotsOutput, DescribeWorkspaceSnapshotsOutputError>) -> Void)
    ...
    ///             DescribeConnectionAliases</a> to make sure that the current state of the connection alias is <code>CREATED</code>.</p>
    ///          </note>
    func disassociateConnectionAlias(input: DisassociateConnectionAliasInput, completion: @escaping (SdkResult<DisassociateConnectionAliasOutput, DisassociateConnectionAliasOutputError>) -> Void)
    /// <p>Disassociates the specified IP access control group from the specified directory.</p>
    func disassociateIpGroups(input: DisassociateIpGroupsInput, completion: @escaping (SdkResult<DisassociateIpGroupsOutput, DisassociateIpGroupsOutputError>) -> Void)
    ...
    func importWorkspaceImage(input: ImportWorkspaceImageInput, completion: @escaping (SdkResult<ImportWorkspaceImageOutput, ImportWorkspaceImageOutputError>) -> Void)
    ...
    func listAvailableManagementCidrRanges(input: ListAvailableManagementCidrRangesInput, completion: @escaping (SdkResult<ListAvailableManagementCidrRangesOutput, ListAvailableManagementCidrRangesOutputError>) -> Void)
    ...
    func migrateWorkspace(input: MigrateWorkspaceInput, completion: @escaping (SdkResult<MigrateWorkspaceOutput, MigrateWorkspaceOutputError>) -> Void)
    /// <p>Modifies the configuration of Bring Your Own License (BYOL) for the specified
    ///          account.</p>
    func modifyAccount(input: ModifyAccountInput, completion: @escaping (SdkResult<ModifyAccountOutput, ModifyAccountOutputError>) -> Void)
    /// <p>Modifies the properties of the specified Amazon WorkSpaces clients.</p>
    func modifyClientProperties(input: ModifyClientPropertiesInput, completion: @escaping (SdkResult<ModifyClientPropertiesOutput, ModifyClientPropertiesOutputError>) -> Void)
    ...
    func modifySelfservicePermissions(input: ModifySelfservicePermissionsInput, completion: @escaping (SdkResult<ModifySelfservicePermissionsOutput, ModifySelfservicePermissionsOutputError>) -> Void)
    ...
    func modifyWorkspaceAccessProperties(input: ModifyWorkspaceAccessPropertiesInput, completion: @escaping (SdkResult<ModifyWorkspaceAccessPropertiesOutput, ModifyWorkspaceAccessPropertiesOutputError>) -> Void)
    /// <p>Modify the default properties used to create WorkSpaces.</p>
    func modifyWorkspaceCreationProperties(input: ModifyWorkspaceCreationPropertiesInput, completion: @escaping (SdkResult<ModifyWorkspaceCreationPropertiesOutput, ModifyWorkspaceCreationPropertiesOutputError>) -> Void)
    ...
    ///       </p>
    func modifyWorkspaceProperties(input: ModifyWorkspacePropertiesInput, completion: @escaping (SdkResult<ModifyWorkspacePropertiesOutput, ModifyWorkspacePropertiesOutputError>) -> Void)
    ...
    ///          state.</p>
    func modifyWorkspaceState(input: ModifyWorkspaceStateInput, completion: @escaping (SdkResult<ModifyWorkspaceStateOutput, ModifyWorkspaceStateOutputError>) -> Void)
    ...
    func rebootWorkspaces(input: RebootWorkspacesInput, completion: @escaping (SdkResult<RebootWorkspacesOutput, RebootWorkspacesOutputError>) -> Void)
    ...
    ///          rebuilt.</p>
    func rebuildWorkspaces(input: RebuildWorkspacesInput, completion: @escaping (SdkResult<RebuildWorkspacesOutput, RebuildWorkspacesOutputError>) -> Void)
    ...
    func registerWorkspaceDirectory(input: RegisterWorkspaceDirectoryInput, completion: @escaping (SdkResult<RegisterWorkspaceDirectoryOutput, RegisterWorkspaceDirectoryOutputError>) -> Void)
    ...
    ///          restored.</p>
    func restoreWorkspace(input: RestoreWorkspaceInput, completion: @escaping (SdkResult<RestoreWorkspaceOutput, RestoreWorkspaceOutputError>) -> Void)
    /// <p>Removes one or more rules from the specified IP access control group.</p>
    func revokeIpRules(input: RevokeIpRulesInput, completion: @escaping (SdkResult<RevokeIpRulesOutput, RevokeIpRulesOutputError>) -> Void)
    ...
    func startWorkspaces(input: StartWorkspacesInput, completion: @escaping (SdkResult<StartWorkspacesOutput, StartWorkspacesOutputError>) -> Void)
    ...
    ///             <code>ERROR</code>.</p>
    func stopWorkspaces(input: StopWorkspacesInput, completion: @escaping (SdkResult<StopWorkspacesOutput, StopWorkspacesOutputError>) -> Void)
    ...
    ///             WorkSpaces again.</p>
    ///          </note>
    func terminateWorkspaces(input: TerminateWorkspacesInput, completion: @escaping (SdkResult<TerminateWorkspacesOutput, TerminateWorkspacesOutputError>) -> Void)
    ...
    ///             </ul>
    ///          </note>
    func updateConnectionAliasPermission(input: UpdateConnectionAliasPermissionInput, completion: @escaping (SdkResult<UpdateConnectionAliasPermissionOutput, UpdateConnectionAliasPermissionOutputError>) -> Void)
    /// <p>Replaces the current rules of the specified IP access control group with the specified
    ///          rules.</p>
    func updateRulesOfIpGroup(input: UpdateRulesOfIpGroupInput, completion: @escaping (SdkResult<UpdateRulesOfIpGroupOutput, UpdateRulesOfIpGroupOutputError>) -> Void)
    ...
    ///          </important>
    func updateWorkspaceBundle(input: UpdateWorkspaceBundleInput, completion: @escaping (SdkResult<UpdateWorkspaceBundleOutput, UpdateWorkspaceBundleOutputError>) -> Void)
    ...
    ///             </ul>
    ///          </note>
    func updateWorkspaceImagePermission(input: UpdateWorkspaceImagePermissionInput, completion: @escaping (SdkResult<UpdateWorkspaceImagePermissionOutput, UpdateWorkspaceImagePermissionOutputError>) -> Void)
}
