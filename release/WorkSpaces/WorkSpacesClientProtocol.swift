...
public protocol WorkSpacesClientProtocol {
    ...
    ///          </note>
    func associateConnectionAlias(input: AssociateConnectionAliasInput, completion: @escaping (SdkResult<AssociateConnectionAliasOutputResponse, AssociateConnectionAliasOutputError>) -> Void)
    /// <p>Associates the specified IP access control group with the specified directory.</p>
    func associateIpGroups(input: AssociateIpGroupsInput, completion: @escaping (SdkResult<AssociateIpGroupsOutputResponse, AssociateIpGroupsOutputError>) -> Void)
    ...
    func authorizeIpRules(input: AuthorizeIpRulesInput, completion: @escaping (SdkResult<AuthorizeIpRulesOutputResponse, AuthorizeIpRulesOutputError>) -> Void)
    ...
    ///          </important>
    func copyWorkspaceImage(input: CopyWorkspaceImageInput, completion: @escaping (SdkResult<CopyWorkspaceImageOutputResponse, CopyWorkspaceImageOutputError>) -> Void)
    ...
    ///          Cross-Region Redirection for Amazon WorkSpaces</a>.</p>
    func createConnectionAlias(input: CreateConnectionAliasInput, completion: @escaping (SdkResult<CreateConnectionAliasOutputResponse, CreateConnectionAliasOutputError>) -> Void)
    ...
    func createIpGroup(input: CreateIpGroupInput, completion: @escaping (SdkResult<CreateIpGroupOutputResponse, CreateIpGroupOutputError>) -> Void)
    ...
    func createWorkspaceBundle(input: CreateWorkspaceBundleInput, completion: @escaping (SdkResult<CreateWorkspaceBundleOutputResponse, CreateWorkspaceBundleOutputError>) -> Void)
    /// <p>Creates one or more WorkSpaces.</p>
    ///          <p>This operation is asynchronous and returns before the WorkSpaces are created.</p>
    func createWorkspaces(input: CreateWorkspacesInput, completion: @escaping (SdkResult<CreateWorkspacesOutputResponse, CreateWorkspacesOutputError>) -> Void)
    ...
    ///          </note>
    func deleteConnectionAlias(input: DeleteConnectionAliasInput, completion: @escaping (SdkResult<DeleteConnectionAliasOutputResponse, DeleteConnectionAliasOutputError>) -> Void)
    ...
    func deleteIpGroup(input: DeleteIpGroupInput, completion: @escaping (SdkResult<DeleteIpGroupOutputResponse, DeleteIpGroupOutputError>) -> Void)
    ...
    func deleteWorkspaceBundle(input: DeleteWorkspaceBundleInput, completion: @escaping (SdkResult<DeleteWorkspaceBundleOutputResponse, DeleteWorkspaceBundleOutputError>) -> Void)
    ...
    ///          other accounts. </p>
    func deleteWorkspaceImage(input: DeleteWorkspaceImageInput, completion: @escaping (SdkResult<DeleteWorkspaceImageOutputResponse, DeleteWorkspaceImageOutputError>) -> Void)
    ...
    ///             WorkSpaces again.</p>
    ///          </note>
    func deregisterWorkspaceDirectory(input: DeregisterWorkspaceDirectoryInput, completion: @escaping (SdkResult<DeregisterWorkspaceDirectoryOutputResponse, DeregisterWorkspaceDirectoryOutputError>) -> Void)
    /// <p>Retrieves a list that describes the configuration of Bring Your Own License (BYOL) for
    ///          the specified account.</p>
    func describeAccount(input: DescribeAccountInput, completion: @escaping (SdkResult<DescribeAccountOutputResponse, DescribeAccountOutputError>) -> Void)
    ...
    func describeAccountModifications(input: DescribeAccountModificationsInput, completion: @escaping (SdkResult<DescribeAccountModificationsOutputResponse, DescribeAccountModificationsOutputError>) -> Void)
    /// <p>Retrieves a list that describes one or more specified Amazon WorkSpaces clients.</p>
    func describeClientProperties(input: DescribeClientPropertiesInput, completion: @escaping (SdkResult<DescribeClientPropertiesOutputResponse, DescribeClientPropertiesOutputError>) -> Void)
    /// <p>Retrieves a list that describes the connection aliases used for cross-Region redirection. For more information, see
    ///          <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/cross-region-redirection.html">
    ///          Cross-Region Redirection for Amazon WorkSpaces</a>.</p>
    func describeConnectionAliases(input: DescribeConnectionAliasesInput, completion: @escaping (SdkResult<DescribeConnectionAliasesOutputResponse, DescribeConnectionAliasesOutputError>) -> Void)
    ...
    ///             Cross-Region Redirection for Amazon WorkSpaces</a>.</p>
    func describeConnectionAliasPermissions(input: DescribeConnectionAliasPermissionsInput, completion: @escaping (SdkResult<DescribeConnectionAliasPermissionsOutputResponse, DescribeConnectionAliasPermissionsOutputError>) -> Void)
    /// <p>Describes one or more of your IP access control groups.</p>
    func describeIpGroups(input: DescribeIpGroupsInput, completion: @escaping (SdkResult<DescribeIpGroupsOutputResponse, DescribeIpGroupsOutputError>) -> Void)
    ...
    func describeWorkspaceBundles(input: DescribeWorkspaceBundlesInput, completion: @escaping (SdkResult<DescribeWorkspaceBundlesOutputResponse, DescribeWorkspaceBundlesOutputError>) -> Void)
    /// <p>Describes the available directories that are registered with
    ///          Amazon WorkSpaces.</p>
    func describeWorkspaceDirectories(input: DescribeWorkspaceDirectoriesInput, completion: @escaping (SdkResult<DescribeWorkspaceDirectoriesOutputResponse, DescribeWorkspaceDirectoriesOutputError>) -> Void)
    /// <p>Describes the permissions that the owner of an image has granted to other
    ///          AWS accounts for an image.</p>
    func describeWorkspaceImagePermissions(input: DescribeWorkspaceImagePermissionsInput, completion: @escaping (SdkResult<DescribeWorkspaceImagePermissionsOutputResponse, DescribeWorkspaceImagePermissionsOutputError>) -> Void)
    ...
    func describeWorkspaceImages(input: DescribeWorkspaceImagesInput, completion: @escaping (SdkResult<DescribeWorkspaceImagesOutputResponse, DescribeWorkspaceImagesOutputError>) -> Void)
    ...
    func describeWorkspaces(input: DescribeWorkspacesInput, completion: @escaping (SdkResult<DescribeWorkspacesOutputResponse, DescribeWorkspacesOutputError>) -> Void)
    /// <p>Describes the connection status of the specified WorkSpaces.</p>
    func describeWorkspacesConnectionStatus(input: DescribeWorkspacesConnectionStatusInput, completion: @escaping (SdkResult<DescribeWorkspacesConnectionStatusOutputResponse, DescribeWorkspacesConnectionStatusOutputError>) -> Void)
    /// <p>Describes the snapshots for the specified WorkSpace.</p>
    func describeWorkspaceSnapshots(input: DescribeWorkspaceSnapshotsInput, completion: @escaping (SdkResult<DescribeWorkspaceSnapshotsOutputResponse, DescribeWorkspaceSnapshotsOutputError>) -> Void)
    ...
    ///             DescribeConnectionAliases</a> to make sure that the current state of the connection alias is <code>CREATED</code>.</p>
    ///          </note>
    func disassociateConnectionAlias(input: DisassociateConnectionAliasInput, completion: @escaping (SdkResult<DisassociateConnectionAliasOutputResponse, DisassociateConnectionAliasOutputError>) -> Void)
    /// <p>Disassociates the specified IP access control group from the specified directory.</p>
    func disassociateIpGroups(input: DisassociateIpGroupsInput, completion: @escaping (SdkResult<DisassociateIpGroupsOutputResponse, DisassociateIpGroupsOutputError>) -> Void)
    ...
    func importWorkspaceImage(input: ImportWorkspaceImageInput, completion: @escaping (SdkResult<ImportWorkspaceImageOutputResponse, ImportWorkspaceImageOutputError>) -> Void)
    ...
    func listAvailableManagementCidrRanges(input: ListAvailableManagementCidrRangesInput, completion: @escaping (SdkResult<ListAvailableManagementCidrRangesOutputResponse, ListAvailableManagementCidrRangesOutputError>) -> Void)
    ...
    func migrateWorkspace(input: MigrateWorkspaceInput, completion: @escaping (SdkResult<MigrateWorkspaceOutputResponse, MigrateWorkspaceOutputError>) -> Void)
    /// <p>Modifies the configuration of Bring Your Own License (BYOL) for the specified
    ///          account.</p>
    func modifyAccount(input: ModifyAccountInput, completion: @escaping (SdkResult<ModifyAccountOutputResponse, ModifyAccountOutputError>) -> Void)
    /// <p>Modifies the properties of the specified Amazon WorkSpaces clients.</p>
    func modifyClientProperties(input: ModifyClientPropertiesInput, completion: @escaping (SdkResult<ModifyClientPropertiesOutputResponse, ModifyClientPropertiesOutputError>) -> Void)
    ...
    func modifySelfservicePermissions(input: ModifySelfservicePermissionsInput, completion: @escaping (SdkResult<ModifySelfservicePermissionsOutputResponse, ModifySelfservicePermissionsOutputError>) -> Void)
    ...
    func modifyWorkspaceAccessProperties(input: ModifyWorkspaceAccessPropertiesInput, completion: @escaping (SdkResult<ModifyWorkspaceAccessPropertiesOutputResponse, ModifyWorkspaceAccessPropertiesOutputError>) -> Void)
    /// <p>Modify the default properties used to create WorkSpaces.</p>
    func modifyWorkspaceCreationProperties(input: ModifyWorkspaceCreationPropertiesInput, completion: @escaping (SdkResult<ModifyWorkspaceCreationPropertiesOutputResponse, ModifyWorkspaceCreationPropertiesOutputError>) -> Void)
    ...
    ///       </p>
    func modifyWorkspaceProperties(input: ModifyWorkspacePropertiesInput, completion: @escaping (SdkResult<ModifyWorkspacePropertiesOutputResponse, ModifyWorkspacePropertiesOutputError>) -> Void)
    ...
    ///          state.</p>
    func modifyWorkspaceState(input: ModifyWorkspaceStateInput, completion: @escaping (SdkResult<ModifyWorkspaceStateOutputResponse, ModifyWorkspaceStateOutputError>) -> Void)
    ...
    func rebootWorkspaces(input: RebootWorkspacesInput, completion: @escaping (SdkResult<RebootWorkspacesOutputResponse, RebootWorkspacesOutputError>) -> Void)
    ...
    ///          rebuilt.</p>
    func rebuildWorkspaces(input: RebuildWorkspacesInput, completion: @escaping (SdkResult<RebuildWorkspacesOutputResponse, RebuildWorkspacesOutputError>) -> Void)
    ...
    func registerWorkspaceDirectory(input: RegisterWorkspaceDirectoryInput, completion: @escaping (SdkResult<RegisterWorkspaceDirectoryOutputResponse, RegisterWorkspaceDirectoryOutputError>) -> Void)
    ...
    ///          restored.</p>
    func restoreWorkspace(input: RestoreWorkspaceInput, completion: @escaping (SdkResult<RestoreWorkspaceOutputResponse, RestoreWorkspaceOutputError>) -> Void)
    /// <p>Removes one or more rules from the specified IP access control group.</p>
    func revokeIpRules(input: RevokeIpRulesInput, completion: @escaping (SdkResult<RevokeIpRulesOutputResponse, RevokeIpRulesOutputError>) -> Void)
    ...
    func startWorkspaces(input: StartWorkspacesInput, completion: @escaping (SdkResult<StartWorkspacesOutputResponse, StartWorkspacesOutputError>) -> Void)
    ...
    ///             <code>ERROR</code>.</p>
    func stopWorkspaces(input: StopWorkspacesInput, completion: @escaping (SdkResult<StopWorkspacesOutputResponse, StopWorkspacesOutputError>) -> Void)
    ...
    ///             WorkSpaces again.</p>
    ///          </note>
    func terminateWorkspaces(input: TerminateWorkspacesInput, completion: @escaping (SdkResult<TerminateWorkspacesOutputResponse, TerminateWorkspacesOutputError>) -> Void)
    ...
    ///             </ul>
    ///          </note>
    func updateConnectionAliasPermission(input: UpdateConnectionAliasPermissionInput, completion: @escaping (SdkResult<UpdateConnectionAliasPermissionOutputResponse, UpdateConnectionAliasPermissionOutputError>) -> Void)
    /// <p>Replaces the current rules of the specified IP access control group with the specified
    ///          rules.</p>
    func updateRulesOfIpGroup(input: UpdateRulesOfIpGroupInput, completion: @escaping (SdkResult<UpdateRulesOfIpGroupOutputResponse, UpdateRulesOfIpGroupOutputError>) -> Void)
    ...
    ///          </important>
    func updateWorkspaceBundle(input: UpdateWorkspaceBundleInput, completion: @escaping (SdkResult<UpdateWorkspaceBundleOutputResponse, UpdateWorkspaceBundleOutputError>) -> Void)
    ...
    ///             </ul>
    ///          </note>
    func updateWorkspaceImagePermission(input: UpdateWorkspaceImagePermissionInput, completion: @escaping (SdkResult<UpdateWorkspaceImagePermissionOutputResponse, UpdateWorkspaceImagePermissionOutputError>) -> Void)
}
