...
extension CloudTrailClientTypes {
    ...
    ///          that are important to you. For more information about advanced event selectors, see <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.html">Logging data events for trails in the AWS
...
extension CloudTrailClientTypes {
    ...
    public struct AdvancedFieldSelector: Swift.Equatable {
        ...
        ///
        ///                      eventName
        ///                    - Can use any operator. You can use it to ﬁlter in
        ///             or ﬁlter out any data event logged to CloudTrail, such as PutBucket. You can have multiple values
        ...
        ///                or AWS::S3ObjectLambda::AccessPoint. You can have only one
        ...
        ///                   StartsWith operator, and include only the bucket ARN as the matching
        ///                value.
...
///          see <a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_integrate_services.html">Enabling Trusted Access with Other AWS Services
///          and <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/creating-an-organizational-trail-prepare.html">Prepare For Creating a Trail For Your Organization.
...
public struct CreateTrailInput: Swift.Equatable {
    ...
    /// This member is required.
    public let name: Swift.String?
    /// Specifies the name of the Amazon S3 bucket designated for publishing log files. See <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/create_trail_naming_policy.html">Amazon S3 Bucket Naming Requirements.
    /// This member is required.
    ...
    ///          for log file delivery. For more information, see <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-find-log-files.html">Finding Your CloudTrail Log Files. The maximum length is 200 characters.
...
public struct CreateTrailOutputResponse: Swift.Equatable {
    ...
    public let s3BucketName: Swift.String?
    /// Specifies the Amazon S3 key prefix that comes after the name of the bucket you have designated
    ///          for log file delivery. For more information, see <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-find-log-files.html">Finding Your CloudTrail Log Files.
    public let s3KeyPrefix: Swift.String?
...
extension CloudTrailClientTypes {
    ...
    public struct EventSelector: Swift.Equatable {
        ...
        ///          data events.
        ///          For more information, see <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/logging-management-and-data-events-with-cloudtrail.html#logging-data-events">Data Events and <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/WhatIsCloudTrail-Limits.html">Limits in AWS CloudTrail
        ...
        ///
        ///          For more information, see <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/logging-management-and-data-events-with-cloudtrail.html#logging-management-events">Management Events in the AWS CloudTrail User Guide.
        ///
        ...
        ///          CloudTrail pricing, see <a href="http://aws.amazon.com/cloudtrail/pricing/">AWS CloudTrail Pricing.
...
public struct GetTrailStatusOutputResponse: Swift.Equatable {
    ...
    ///          notification. For more information about Amazon SNS errors, see the <a href="https://docs.aws.amazon.com/sns/latest/dg/welcome.html">Amazon SNS Developer Guide.
    ///
...
///          <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/creating-an-organizational-trail-prepare.html">Prepare For Creating a Trail For Your Organization.
...
public struct PutEventSelectorsInput: Swift.Equatable {
    ...
    ///          You can use either EventSelectors or AdvancedEventSelectors in a PutEventSelectors request, but not both.
    ///          If you apply EventSelectors to a trail, any existing AdvancedEventSelectors are overwritten.
    public let eventSelectors: [CloudTrailClientTypes.EventSelector]?
    /// Specifies the name of the trail or trail ARN. If you specify a trail name, the
    ///          string must meet the following requirements:
    ///
...
extension CloudTrailClientTypes {
    ...
    public struct Resource: Swift.Equatable {
        ...
        ///          To learn more about how to look up and filter events by the resource types supported for a service, see <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/view-cloudtrail-events-console.html#filtering-cloudtrail-events">Filtering CloudTrail Events.
...
extension CloudTrailClientTypes {
    ...
    public struct Trail: Swift.Equatable {
        ...
        ///          characters.
        public let name: Swift.String?
        /// Name of the Amazon S3 bucket into which CloudTrail delivers your trail files. See <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/create_trail_naming_policy.html">Amazon S3 Bucket Naming Requirements.
        public let s3BucketName: Swift.String?
        /// Specifies the Amazon S3 key prefix that comes after the name of the bucket you have designated
        ///          for log file delivery. For more information, see <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-find-log-files.html">Finding Your CloudTrail Log Files.The maximum length is 200 characters.
        public let s3KeyPrefix: Swift.String?
