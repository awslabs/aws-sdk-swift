...
public protocol SsmContactsClientProtocol {
    ...
    func acceptPage(input: AcceptPageInput, completion: @escaping (SdkResult<AcceptPageOutputResponse, AcceptPageOutputError>) -> Void)
    ...
    func activateContactChannel(input: ActivateContactChannelInput, completion: @escaping (SdkResult<ActivateContactChannelOutputResponse, ActivateContactChannelOutputError>) -> Void)
    ...
    func createContactChannel(input: CreateContactChannelInput, completion: @escaping (SdkResult<CreateContactChannelOutputResponse, CreateContactChannelOutputError>) -> Void)
    /// <p>To no longer receive Incident Manager engagements to a contact channel, you can deactivate
    ///          the channel.</p>
    func deactivateContactChannel(input: DeactivateContactChannelInput, completion: @escaping (SdkResult<DeactivateContactChannelOutputResponse, DeactivateContactChannelOutputError>) -> Void)
    ...
    func deleteContactChannel(input: DeleteContactChannelInput, completion: @escaping (SdkResult<DeleteContactChannelOutputResponse, DeleteContactChannelOutputError>) -> Void)
    ...
    func describeEngagement(input: DescribeEngagementInput, completion: @escaping (SdkResult<DescribeEngagementOutputResponse, DescribeEngagementOutputError>) -> Void)
    /// <p>Lists details of the engagement to a contact channel.</p>
    func describePage(input: DescribePageInput, completion: @escaping (SdkResult<DescribePageOutputResponse, DescribePageOutputError>) -> Void)
    ...
    func getContactChannel(input: GetContactChannelInput, completion: @escaping (SdkResult<GetContactChannelOutputResponse, GetContactChannelOutputError>) -> Void)
    /// <p>Retrieves the resource policies attached to the specified contact or escalation
    ///          plan.</p>
    func getContactPolicy(input: GetContactPolicyInput, completion: @escaping (SdkResult<GetContactPolicyOutputResponse, GetContactPolicyOutputError>) -> Void)
    /// <p>Lists all contact channels for the specified contact.</p>
    func listContactChannels(input: ListContactChannelsInput, completion: @escaping (SdkResult<ListContactChannelsOutputResponse, ListContactChannelsOutputError>) -> Void)
    ...
    func listEngagements(input: ListEngagementsInput, completion: @escaping (SdkResult<ListEngagementsOutputResponse, ListEngagementsOutputError>) -> Void)
    /// <p>Lists all of the engagements to contact channels that have been acknowledged. </p>
    func listPageReceipts(input: ListPageReceiptsInput, completion: @escaping (SdkResult<ListPageReceiptsOutputResponse, ListPageReceiptsOutputError>) -> Void)
    /// <p>Lists the engagements to a contact's contact channels.</p>
    func listPagesByContact(input: ListPagesByContactInput, completion: @escaping (SdkResult<ListPagesByContactOutputResponse, ListPagesByContactOutputError>) -> Void)
    /// <p>Lists the engagements to contact channels that occurred by engaging a contact.</p>
    func listPagesByEngagement(input: ListPagesByEngagementInput, completion: @escaping (SdkResult<ListPagesByEngagementOutputResponse, ListPagesByEngagementOutputError>) -> Void)
    ...
    func putContactPolicy(input: PutContactPolicyInput, completion: @escaping (SdkResult<PutContactPolicyOutputResponse, PutContactPolicyOutputError>) -> Void)
    ...
    func sendActivationCode(input: SendActivationCodeInput, completion: @escaping (SdkResult<SendActivationCodeOutputResponse, SendActivationCodeOutputError>) -> Void)
    /// <p>Starts an engagement to a contact or escalation plan. The engagement engages each
    ///          contact specified in the incident.</p>
    func startEngagement(input: StartEngagementInput, completion: @escaping (SdkResult<StartEngagementOutputResponse, StartEngagementOutputError>) -> Void)
    ...
    func stopEngagement(input: StopEngagementInput, completion: @escaping (SdkResult<StopEngagementOutputResponse, StopEngagementOutputError>) -> Void)
    ...
    func updateContactChannel(input: UpdateContactChannelInput, completion: @escaping (SdkResult<UpdateContactChannelOutputResponse, UpdateContactChannelOutputError>) -> Void)
}
