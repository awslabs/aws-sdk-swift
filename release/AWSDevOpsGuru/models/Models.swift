...
extension DevOpsGuruClientTypes.AnomalousLogGroup: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let numberOfLogLinesScannedDecoded = try containerValues.decode(Swift.Int.self, forKey: .numberOfLogLinesScanned)
...
extension DevOpsGuruClientTypes.LogAnomalyClass: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let numberOfLogLinesOccurrencesDecoded = try containerValues.decode(Swift.Int.self, forKey: .numberOfLogLinesOccurrences)
