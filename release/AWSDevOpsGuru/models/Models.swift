...
extension DevOpsGuruClientTypes {
    ...
    public struct AccountHealth: Swift.Equatable {
        ...
        var insight: DevOpsGuruClientTypes.AccountInsightHealth?
...
extension DevOpsGuruClientTypes {
    ...
    public struct AccountInsightHealth: Swift.Equatable {
        ...
        var openProactiveInsights: Swift.Int
        /// An integer that specifies the number of open reactive insights in your Amazon Web Services account.
        var openReactiveInsights: Swift.Int
...
public struct AddNotificationChannelInput: Swift.Equatable {
    ...
    /// This member is required.
    var config: DevOpsGuruClientTypes.NotificationChannelConfig?
...
extension DevOpsGuruClientTypes {
    ...
    public struct AnomalyReportedTimeRange: Swift.Equatable {
        ...
        var closeTime: ClientRuntime.Date?
        /// The time when an anomaly is opened.
        /// This member is required.
        var openTime: ClientRuntime.Date?
...
extension DevOpsGuruClientTypes {
    ...
    public struct AnomalySourceDetails: Swift.Equatable {
        ...
        var cloudWatchMetrics: [DevOpsGuruClientTypes.CloudWatchMetricsDetail]?
        ...
        var performanceInsightsMetrics: [DevOpsGuruClientTypes.PerformanceInsightsMetricsDetail]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct CloudFormationHealth: Swift.Equatable {
        ...
        var insight: DevOpsGuruClientTypes.InsightHealth?
...
extension DevOpsGuruClientTypes {
    ...
    public struct CloudWatchMetricsDataSummary: Swift.Equatable {
        ...
        var statusCode: DevOpsGuruClientTypes.CloudWatchMetricDataStatusCode?
        /// This is a list of Amazon CloudWatch metric values at given timestamp.
        var timestampMetricValuePairList: [DevOpsGuruClientTypes.TimestampMetricValuePair]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct CloudWatchMetricsDetail: Swift.Equatable {
        ...
        var dimensions: [DevOpsGuruClientTypes.CloudWatchMetricsDimension]?
        /// This object returns anomaly metric data.
        var metricDataSummary: DevOpsGuruClientTypes.CloudWatchMetricsDataSummary?
        ...
        var stat: DevOpsGuruClientTypes.CloudWatchMetricsStat?
...
extension DevOpsGuruClientTypes {
    ...
    public struct CostEstimationResourceCollectionFilter: Swift.Equatable {
        ...
        var cloudFormation: DevOpsGuruClientTypes.CloudFormationCostEstimationResourceCollectionFilter?
        ...
        var tags: [DevOpsGuruClientTypes.TagCostEstimationResourceCollectionFilter]?
...
public struct DescribeAccountOverviewInput: Swift.Equatable {
    ...
    /// This member is required.
    var fromTime: ClientRuntime.Date?
    /// The end of the time range passed in. The start time granularity is at the day level. The floor of the start time is used. Returned information occurred before this day. If this is not specified, then the current day is used.
    var toTime: ClientRuntime.Date?
...
public struct DescribeAccountOverviewOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var meanTimeToRecoverInMilliseconds: Swift.Int?
    ...
    /// This member is required.
    var proactiveInsights: Swift.Int
    ...
    /// This member is required.
    var reactiveInsights: Swift.Int
...
public struct DescribeAnomalyOutputResponse: Swift.Equatable {
    ...
    var proactiveAnomaly: DevOpsGuruClientTypes.ProactiveAnomaly?
    /// A ReactiveAnomaly object that represents the requested anomaly.
    var reactiveAnomaly: DevOpsGuruClientTypes.ReactiveAnomaly?
...
public struct DescribeFeedbackOutputResponse: Swift.Equatable {
    ...
    var insightFeedback: DevOpsGuruClientTypes.InsightFeedback?
...
public struct DescribeInsightOutputResponse: Swift.Equatable {
    ...
    var proactiveInsight: DevOpsGuruClientTypes.ProactiveInsight?
    /// A ReactiveInsight object that represents the requested insight.
    var reactiveInsight: DevOpsGuruClientTypes.ReactiveInsight?
...
public struct DescribeOrganizationResourceCollectionHealthInput: Swift.Equatable {
    ...
    /// This member is required.
    var organizationResourceCollectionType: DevOpsGuruClientTypes.OrganizationResourceCollectionType?
    /// The ID of the organizational unit.
    var organizationalUnitIds: [Swift.String]?
...
public struct DescribeOrganizationResourceCollectionHealthOutputResponse: Swift.Equatable {
    ...
    var account: [DevOpsGuruClientTypes.AccountHealth]?
    /// The returned CloudFormationHealthOverview object that contains an InsightHealthOverview object with the requested system health information.
    var cloudFormation: [DevOpsGuruClientTypes.CloudFormationHealth]?
    ...
    var service: [DevOpsGuruClientTypes.ServiceHealth]?
...
public struct DescribeResourceCollectionHealthInput: Swift.Equatable {
    ...
    /// An Amazon Web Services resource collection type. This type specifies how analyzed Amazon Web Services resources are defined. The two types of Amazon Web Services resource collections supported are Amazon Web Services CloudFormation stacks and Amazon Web Services resources that contain the same Amazon Web Services tag. DevOps Guru can be configured to analyze the Amazon Web Services resources that are defined in the stacks or that are tagged using the same tag key. You can specify up to 500 Amazon Web Services CloudFormation stacks.
    /// This member is required.
    var resourceCollectionType: DevOpsGuruClientTypes.ResourceCollectionType?
...
public struct DescribeResourceCollectionHealthOutputResponse: Swift.Equatable {
    ...
    ///
    /// Together these are known as key-value pairs. The string used for a key in a tag that you use to define your resource coverage must begin with the prefix Devops-guru-. The tag key might be Devops-guru-deployment-application or Devops-guru-rds-application. While keys are case-sensitive, the case of key characters don't matter to DevOps Guru. For example, DevOps Guru works with a key named devops-guru-rds and a key named DevOps-Guru-RDS. Possible key/value pairs in your application might be Devops-Guru-production-application/RDS or Devops-Guru-production-application/containers.
    var tags: [DevOpsGuruClientTypes.TagHealth]?
...
public struct DescribeServiceIntegrationOutputResponse: Swift.Equatable {
    ...
    var serviceIntegration: DevOpsGuruClientTypes.ServiceIntegrationConfig?
...
extension DevOpsGuruClientTypes {
    ...
    public struct Event: Swift.Equatable {
        ...
        var dataSource: DevOpsGuruClientTypes.EventDataSource?
        /// The class of the event. The class specifies what the event is related to, such as an infrastructure change, a deployment, or a schema change.
        var eventClass: DevOpsGuruClientTypes.EventClass?
        ...
        var resourceCollection: DevOpsGuruClientTypes.ResourceCollection?
        /// An EventResource object that contains information about the resource that emitted the event.
        var resources: [DevOpsGuruClientTypes.EventResource]?
...
public struct GetCostEstimationOutputResponse: Swift.Equatable {
    ...
    var costs: [DevOpsGuruClientTypes.ServiceResourceCost]?
    /// The pagination token to use to retrieve the next page of results for this operation. If there are no more pages, this value is null.
    var nextToken: Swift.String?
    /// The collection of the Amazon Web Services resources used to create your monthly DevOps Guru cost estimate.
    var resourceCollection: DevOpsGuruClientTypes.CostEstimationResourceCollectionFilter?
    ...
    var status: DevOpsGuruClientTypes.CostEstimationStatus?
    /// The start and end time of the cost estimation.
    var timeRange: DevOpsGuruClientTypes.CostEstimationTimeRange?
...
public struct GetResourceCollectionOutputResponse: Swift.Equatable {
    ...
    var resourceCollection: DevOpsGuruClientTypes.ResourceCollectionFilter?
...
extension DevOpsGuruClientTypes {
    ...
    public struct InsightFeedback: Swift.Equatable {
        ...
        var feedback: DevOpsGuruClientTypes.InsightFeedbackOption?
...
public struct ListAnomaliesForInsightInput: Swift.Equatable {
    ...
    var startTimeRange: DevOpsGuruClientTypes.StartTimeRange?
...
public struct ListAnomaliesForInsightOutputResponse: Swift.Equatable {
    ...
    var proactiveAnomalies: [DevOpsGuruClientTypes.ProactiveAnomalySummary]?
    /// An array of ReactiveAnomalySummary objects that represent the requested anomalies
    var reactiveAnomalies: [DevOpsGuruClientTypes.ReactiveAnomalySummary]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ListEventsFilters: Swift.Equatable {
        ...
        var eventTimeRange: DevOpsGuruClientTypes.EventTimeRange?
...
public struct ListEventsInput: Swift.Equatable {
    ...
    /// This member is required.
    var filters: DevOpsGuruClientTypes.ListEventsFilters?
    /// The maximum number of results to return with a single call. To retrieve the remaining results, make another call with the returned nextToken value.
    var maxResults: Swift.Int?
    /// The pagination token to use to retrieve the next page of results for this operation. If this value is null, it retrieves the first page.
    var nextToken: Swift.String?
...
public struct ListEventsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var events: [DevOpsGuruClientTypes.Event]?
    /// The pagination token to use to retrieve the next page of results for this operation. If there are no more pages, this value is null.
    var nextToken: Swift.String?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ListInsightsAnyStatusFilter: Swift.Equatable {
        ...
        /// This member is required.
        var type: DevOpsGuruClientTypes.InsightType?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ListInsightsClosedStatusFilter: Swift.Equatable {
        ...
        /// This member is required.
        var endTimeRange: DevOpsGuruClientTypes.EndTimeRange?
        /// Use to filter for either REACTIVE or PROACTIVE insights.
        /// This member is required.
        var type: DevOpsGuruClientTypes.InsightType?
...
public struct ListInsightsInput: Swift.Equatable {
    ...
    /// This member is required.
    var statusFilter: DevOpsGuruClientTypes.ListInsightsStatusFilter?
...
public struct ListInsightsOutputResponse: Swift.Equatable {
    ...
    var proactiveInsights: [DevOpsGuruClientTypes.ProactiveInsightSummary]?
    /// The returned list of reactive insights.
    var reactiveInsights: [DevOpsGuruClientTypes.ReactiveInsightSummary]?
...
public struct ListNotificationChannelsOutputResponse: Swift.Equatable {
    ...
    var channels: [DevOpsGuruClientTypes.NotificationChannel]?
    /// The pagination token to use to retrieve the next page of results for this operation. If there are no more pages, this value is null.
    var nextToken: Swift.String?
...
public struct ListOrganizationInsightsOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// An integer that specifies the number of open proactive insights in your Amazon Web Services account.
    var proactiveInsights: [DevOpsGuruClientTypes.ProactiveOrganizationInsightSummary]?
    /// An integer that specifies the number of open reactive insights in your Amazon Web Services account.
    var reactiveInsights: [DevOpsGuruClientTypes.ReactiveOrganizationInsightSummary]?
...
public struct ListRecommendationsInput: Swift.Equatable {
    ...
    var locale: DevOpsGuruClientTypes.Locale?
    /// The pagination token to use to retrieve the next page of results for this operation. If this value is null, it retrieves the first page.
    var nextToken: Swift.String?
...
public struct ListRecommendationsOutputResponse: Swift.Equatable {
    ...
    var recommendations: [DevOpsGuruClientTypes.Recommendation]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct NotificationChannelConfig: Swift.Equatable {
        ...
        /// This member is required.
        var sns: DevOpsGuruClientTypes.SnsChannelConfig?
...
extension DevOpsGuruClientTypes {
    ...
    public struct OpsCenterIntegration: Swift.Equatable {
        ...
        var optInStatus: DevOpsGuruClientTypes.OptInStatus?
...
extension DevOpsGuruClientTypes {
    ...
    public struct PerformanceInsightsMetricQuery: Swift.Equatable {
        ...
        var groupBy: DevOpsGuruClientTypes.PerformanceInsightsMetricDimensionGroup?
...
extension DevOpsGuruClientTypes {
    ...
    public struct PerformanceInsightsMetricsDetail: Swift.Equatable {
        ...
        var metricDisplayName: Swift.String?
        ...
        var metricQuery: DevOpsGuruClientTypes.PerformanceInsightsMetricQuery?
        ...
        var referenceData: [DevOpsGuruClientTypes.PerformanceInsightsReferenceData]?
        /// The metric statistics during the anomalous period detected by DevOps Guru;
        var statsAtAnomaly: [DevOpsGuruClientTypes.PerformanceInsightsStat]?
        ...
        var statsAtBaseline: [DevOpsGuruClientTypes.PerformanceInsightsStat]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct PerformanceInsightsReferenceComparisonValues: Swift.Equatable {
        ...
        var referenceMetric: DevOpsGuruClientTypes.PerformanceInsightsReferenceMetric?
        ...
        var referenceScalar: DevOpsGuruClientTypes.PerformanceInsightsReferenceScalar?
...
extension DevOpsGuruClientTypes {
    ...
    public struct PerformanceInsightsReferenceData: Swift.Equatable {
        ...
        var comparisonValues: DevOpsGuruClientTypes.PerformanceInsightsReferenceComparisonValues?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ProactiveAnomaly: Swift.Equatable {
        ...
        var anomalyReportedTimeRange: DevOpsGuruClientTypes.AnomalyReportedTimeRange?
        /// A time range that specifies when the observed unusual behavior in an anomaly started and ended. This is different from AnomalyReportedTimeRange, which specifies the time range when DevOps Guru opens and then closes an anomaly.
        var anomalyTimeRange: DevOpsGuruClientTypes.AnomalyTimeRange?
        /// The ID of the insight that contains this anomaly. An insight is composed of related anomalies.
        var associatedInsightId: Swift.String?
        /// The ID of a proactive anomaly.
        var id: Swift.String?
        /// A threshold that was exceeded by behavior in analyzed resources. Exceeding this threshold is related to the anomalous behavior that generated this anomaly.
        var limit: Swift.Double?
        /// The time range during which anomalous behavior in a proactive anomaly or an insight is expected to occur.
        var predictionTimeRange: DevOpsGuruClientTypes.PredictionTimeRange?
        /// A collection of Amazon Web Services resources supported by DevOps Guru. The two types of Amazon Web Services resource collections supported are Amazon Web Services CloudFormation stacks and Amazon Web Services resources that contain the same Amazon Web Services tag. DevOps Guru can be configured to analyze the Amazon Web Services resources that are defined in the stacks or that are tagged using the same tag key. You can specify up to 500 Amazon Web Services CloudFormation stacks.
        var resourceCollection: DevOpsGuruClientTypes.ResourceCollection?
        ...
        var severity: DevOpsGuruClientTypes.AnomalySeverity?
        /// Details about the source of the analyzed operational data that triggered the anomaly. The one supported source is Amazon CloudWatch metrics.
        var sourceDetails: DevOpsGuruClientTypes.AnomalySourceDetails?
        /// The status of a proactive anomaly.
        var status: DevOpsGuruClientTypes.AnomalyStatus?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ProactiveInsight: Swift.Equatable {
        ...
        var id: Swift.String?
        /// A time ranged that specifies when the observed behavior in an insight started and ended.
        var insightTimeRange: DevOpsGuruClientTypes.InsightTimeRange?
        ...
        var severity: DevOpsGuruClientTypes.InsightSeverity?
        ...
        var ssmOpsItemId: Swift.String?
        /// The status of the proactive insight.
        var status: DevOpsGuruClientTypes.InsightStatus?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ProactiveInsightSummary: Swift.Equatable {
        ...
        var associatedResourceArns: [Swift.String]?
        /// The ID of the proactive insight.
        var id: Swift.String?
        /// A time ranged that specifies when the observed behavior in an insight started and ended.
        var insightTimeRange: DevOpsGuruClientTypes.InsightTimeRange?
        ...
        var serviceCollection: DevOpsGuruClientTypes.ServiceCollection?
        /// The severity of the insight. For more information, see [Understanding insight severities](https://docs.aws.amazon.com/devops-guru/latest/userguide/working-with-insights.html#understanding-insights-severities) in the Amazon DevOps Guru User Guide.
        var severity: DevOpsGuruClientTypes.InsightSeverity?
        /// The status of the proactive insight.
        var status: DevOpsGuruClientTypes.InsightStatus?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ReactiveAnomaly: Swift.Equatable {
        ...
        var type: DevOpsGuruClientTypes.AnomalyType?
...
extension DevOpsGuruClientTypes {
    ...
    public struct Recommendation: Swift.Equatable {
        ...
        var relatedAnomalies: [DevOpsGuruClientTypes.RecommendationRelatedAnomaly]?
        /// Events that are related to the problem. Use these events to learn more about what's happening and to help address the issue.
        var relatedEvents: [DevOpsGuruClientTypes.RecommendationRelatedEvent]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct RecommendationRelatedAnomaly: Swift.Equatable {
        ...
        var resources: [DevOpsGuruClientTypes.RecommendationRelatedAnomalyResource]?
        /// Information about where the anomalous behavior related the recommendation was found. For example, details in Amazon CloudWatch metrics.
        var sourceDetails: [DevOpsGuruClientTypes.RecommendationRelatedAnomalySourceDetail]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct RecommendationRelatedAnomalySourceDetail: Swift.Equatable {
        ...
        var cloudWatchMetrics: [DevOpsGuruClientTypes.RecommendationRelatedCloudWatchMetricsSourceDetail]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct RecommendationRelatedEvent: Swift.Equatable {
        ...
        var resources: [DevOpsGuruClientTypes.RecommendationRelatedEventResource]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ResourceCollection: Swift.Equatable {
        ...
        var cloudFormation: DevOpsGuruClientTypes.CloudFormationCollection?
        /// The Amazon Web Services tags that are used by resources in the resource collection. Tags help you identify and organize your Amazon Web Services resources. Many Amazon Web Services services support tagging, so you can assign the same tag to resources from different services to indicate that the resources are related. For example, you can assign the same tag to an Amazon DynamoDB table resource that you assign to an Lambda function. For more information about using tags, see the [Tagging best practices](https://d1.awsstatic.com/whitepapers/aws-tagging-best-practices.pdf) whitepaper. Each Amazon Web Services tag has two parts.
        ///
        /// * A tag key (for example, CostCenter, Environment, Project, or Secret). Tag keys are case-sensitive.
        ///
        ...
        ///
        /// Together these are known as key-value pairs. The string used for a key in a tag that you use to define your resource coverage must begin with the prefix Devops-guru-. The tag key might be Devops-guru-deployment-application or Devops-guru-rds-application. While keys are case-sensitive, the case of key characters don't matter to DevOps Guru. For example, DevOps Guru works with a key named devops-guru-rds and a key named DevOps-Guru-RDS. Possible key/value pairs in your application might be Devops-Guru-production-application/RDS or Devops-Guru-production-application/containers.
        var tags: [DevOpsGuruClientTypes.TagCollection]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ResourceCollectionFilter: Swift.Equatable {
        /// Information about Amazon Web Services CloudFormation stacks. You can use up to 500 stacks to specify which Amazon Web Services resources in your account to analyze. For more information, see [Stacks](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacks.html) in the Amazon Web Services CloudFormation User Guide.
        var cloudFormation: DevOpsGuruClientTypes.CloudFormationCollectionFilter?
        ...
        ///
        /// Together these are known as key-value pairs. The string used for a key in a tag that you use to define your resource coverage must begin with the prefix Devops-guru-. The tag key might be Devops-guru-deployment-application or Devops-guru-rds-application. While keys are case-sensitive, the case of key characters don't matter to DevOps Guru. For example, DevOps Guru works with a key named devops-guru-rds and a key named DevOps-Guru-RDS. Possible key/value pairs in your application might be Devops-Guru-production-application/RDS or Devops-Guru-production-application/containers.
        var tags: [DevOpsGuruClientTypes.TagCollectionFilter]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct SearchInsightsFilters: Swift.Equatable {
        ...
        var severities: [DevOpsGuruClientTypes.InsightSeverity]?
        /// An array of status values used to search for insights.
        var statuses: [DevOpsGuruClientTypes.InsightStatus]?
...
public struct SearchInsightsInput: Swift.Equatable {
    ...
    var filters: DevOpsGuruClientTypes.SearchInsightsFilters?
    /// The maximum number of results to return with a single call. To retrieve the remaining results, make another call with the returned nextToken value.
    var maxResults: Swift.Int?
    /// The pagination token to use to retrieve the next page of results for this operation. If this value is null, it retrieves the first page.
    var nextToken: Swift.String?
...
public struct SearchOrganizationInsightsInput: Swift.Equatable {
    ...
    var filters: DevOpsGuruClientTypes.SearchOrganizationInsightsFilters?
    /// The maximum number of results to return with a single call. To retrieve the remaining results, make another call with the returned nextToken value.
    var maxResults: Swift.Int?
    /// The pagination token to use to retrieve the next page of results for this operation. If this value is null, it retrieves the first page.
    var nextToken: Swift.String?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ServiceCollection: Swift.Equatable {
        ...
        var serviceNames: [DevOpsGuruClientTypes.ServiceName]?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ServiceHealth: Swift.Equatable {
        ...
        var insight: DevOpsGuruClientTypes.ServiceInsightHealth?
        /// The name of the Amazon Web Services service.
        var serviceName: DevOpsGuruClientTypes.ServiceName?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ServiceIntegrationConfig: Swift.Equatable {
        /// Information about whether DevOps Guru is configured to create an OpsItem in Amazon Web Services Systems Manager OpsCenter for each created insight.
        var opsCenter: DevOpsGuruClientTypes.OpsCenterIntegration?
...
extension DevOpsGuruClientTypes {
    ...
    public struct ServiceResourceCost: Swift.Equatable {
        ...
        var state: DevOpsGuruClientTypes.CostEstimationServiceResourceState?
        /// The type of the Amazon Web Services resource.
        var type: Swift.String?
...
extension DevOpsGuruClientTypes {
    ...
    public struct TagCollection: Swift.Equatable {
        ...
        /// This member is required.
        var appBoundaryKey: Swift.String?
...
extension DevOpsGuruClientTypes {
    ...
    public struct UpdateResourceCollectionFilter: Swift.Equatable {
        ...
        var cloudFormation: DevOpsGuruClientTypes.UpdateCloudFormationCollectionFilter?
        ...
        ///
        /// Together these are known as key-value pairs. The string used for a key in a tag that you use to define your resource coverage must begin with the prefix Devops-guru-. The tag key might be Devops-guru-deployment-application or Devops-guru-rds-application. While keys are case-sensitive, the case of key characters don't matter to DevOps Guru. For example, DevOps Guru works with a key named devops-guru-rds and a key named DevOps-Guru-RDS. Possible key/value pairs in your application might be Devops-Guru-production-application/RDS or Devops-Guru-production-application/containers.
        var tags: [DevOpsGuruClientTypes.UpdateTagCollectionFilter]?
...
public struct UpdateResourceCollectionInput: Swift.Equatable {
    ...
    /// This member is required.
    var action: DevOpsGuruClientTypes.UpdateResourceCollectionAction?
    /// Contains information used to update a collection of Amazon Web Services resources.
    /// This member is required.
    var resourceCollection: DevOpsGuruClientTypes.UpdateResourceCollectionFilter?
...
extension DevOpsGuruClientTypes {
    ...
    public struct UpdateServiceIntegrationConfig: Swift.Equatable {
        /// Information about whether DevOps Guru is configured to create an OpsItem in Amazon Web Services Systems Manager OpsCenter for each created insight.
        var opsCenter: DevOpsGuruClientTypes.OpsCenterIntegrationConfig?
...
public struct UpdateServiceIntegrationInput: Swift.Equatable {
    ...
    /// This member is required.
    var serviceIntegration: DevOpsGuruClientTypes.UpdateServiceIntegrationConfig?
