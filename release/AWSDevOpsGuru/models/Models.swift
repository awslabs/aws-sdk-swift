...
extension DevOpsGuruClientTypes.AccountHealth: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DevOpsGuruClientTypes.AccountHealth: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AccountHealth(accountId: \(Swift.String(describing: accountId)), insight: \(Swift.String(describing: insight)))"}
}
...
extension DevOpsGuruClientTypes.AccountInsightHealth: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DevOpsGuruClientTypes.AccountInsightHealth: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AccountInsightHealth(openProactiveInsights: \(Swift.String(describing: openProactiveInsights)), openReactiveInsights: \(Swift.String(describing: openReactiveInsights)))"}
}
...
public struct AddNotificationChannelInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AddNotificationChannelInputURLHostMiddleware"
...
extension DevOpsGuruClientTypes.AnomalyResource: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case type = "Type"
    }
...
extension DevOpsGuruClientTypes.AnomalyResource: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AnomalyResource(name: \(Swift.String(describing: name)), type: \(Swift.String(describing: type)))"}
}
...
extension DevOpsGuruClientTypes.AnomalySourceDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AnomalySourceDetails(cloudWatchMetrics: \(Swift.String(describing: cloudWatchMetrics)), performanceInsightsMetrics: \(Swift.String(describing: performanceInsightsMetrics)))"}
}
...
extension DevOpsGuruClientTypes.CloudWatchMetricsDataSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DevOpsGuruClientTypes.CloudWatchMetricsDataSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CloudWatchMetricsDataSummary(statusCode: \(Swift.String(describing: statusCode)), timestampMetricValuePairList: \(Swift.String(describing: timestampMetricValuePairList)))"}
}
...
extension DevOpsGuruClientTypes.CloudWatchMetricsDetail: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CloudWatchMetricsDetail(dimensions: \(Swift.String(describing: dimensions)), metricDataSummary: \(Swift.String(describing: metricDataSummary)), metricName: \(Swift.String(describing: metricName)), namespace: \(Swift.String(describing: namespace)), period: \(Swift.String(describing: period)), stat: \(Swift.String(describing: stat)), unit: \(Swift.String(describing: unit)))"}
}
...
extension DevOpsGuruClientTypes.CostEstimationResourceCollectionFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CostEstimationResourceCollectionFilter(cloudFormation: \(Swift.String(describing: cloudFormation)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct DescribeAccountHealthInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAccountHealthInputURLHostMiddleware"
...
public struct DescribeAccountOverviewInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAccountOverviewInputURLHostMiddleware"
...
extension DescribeAnomalyInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAnomalyInput(accountId: \(Swift.String(describing: accountId)), id: \(Swift.String(describing: id)))"}
}
...
public struct DescribeAnomalyInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAnomalyInputURLHostMiddleware"
...
public struct DescribeFeedbackInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeFeedbackInputURLHostMiddleware"
...
extension DescribeInsightInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeInsightInput(accountId: \(Swift.String(describing: accountId)), id: \(Swift.String(describing: id)))"}
}
...
public struct DescribeInsightInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeInsightInputURLHostMiddleware"
...
public struct DescribeOrganizationHealthInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationHealthInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeOrganizationHealthInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeOrganizationHealthOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeOrganizationHealthInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeOrganizationHealthOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeOrganizationHealthOutputError>
}

extension DescribeOrganizationHealthInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeOrganizationHealthInput(accountIds: \(Swift.String(describing: accountIds)), organizationalUnitIds: \(Swift.String(describing: organizationalUnitIds)))"}
}

extension DescribeOrganizationHealthInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DescribeOrganizationHealthInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationHealthInputHeadersMiddleware"
...
public struct DescribeOrganizationHealthInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationHealthInputQueryItemMiddleware"
...
public struct DescribeOrganizationHealthInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationHealthInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeOrganizationHealthInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeOrganizationHealthOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeOrganizationHealthOutputError>
}

public struct DescribeOrganizationHealthInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationHealthInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/organization/health"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeOrganizationHealthOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeOrganizationHealthOutputResponse(metricsAnalyzed: \(Swift.String(describing: metricsAnalyzed)), openProactiveInsights: \(Swift.String(describing: openProactiveInsights)), openReactiveInsights: \(Swift.String(describing: openReactiveInsights)), resourceHours: \(Swift.String(describing: resourceHours)))"}
}
...
public struct DescribeOrganizationOverviewInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationOverviewInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeOrganizationOverviewInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeOrganizationOverviewOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeOrganizationOverviewInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeOrganizationOverviewOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeOrganizationOverviewOutputError>
}

extension DescribeOrganizationOverviewInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeOrganizationOverviewInput(accountIds: \(Swift.String(describing: accountIds)), fromTime: \(Swift.String(describing: fromTime)), organizationalUnitIds: \(Swift.String(describing: organizationalUnitIds)), toTime: \(Swift.String(describing: toTime)))"}
}

extension DescribeOrganizationOverviewInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountIds = "AccountIds"
        case fromTime = "FromTime"
        case organizationalUnitIds = "OrganizationalUnitIds"
...
public struct DescribeOrganizationOverviewInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationOverviewInputHeadersMiddleware"
...
public struct DescribeOrganizationOverviewInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationOverviewInputQueryItemMiddleware"
...
public struct DescribeOrganizationOverviewInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationOverviewInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeOrganizationOverviewInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeOrganizationOverviewOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeOrganizationOverviewOutputError>
}

public struct DescribeOrganizationOverviewInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationOverviewInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/organization/overview"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DescribeOrganizationOverviewOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeOrganizationOverviewOutputResponse(proactiveInsights: \(Swift.String(describing: proactiveInsights)), reactiveInsights: \(Swift.String(describing: reactiveInsights)))"}
}
...
public struct DescribeOrganizationResourceCollectionHealthInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationResourceCollectionHealthInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeOrganizationResourceCollectionHealthInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeOrganizationResourceCollectionHealthOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeOrganizationResourceCollectionHealthInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeOrganizationResourceCollectionHealthOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeOrganizationResourceCollectionHealthOutputError>
}

extension DescribeOrganizationResourceCollectionHealthInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeOrganizationResourceCollectionHealthInput(accountIds: \(Swift.String(describing: accountIds)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), organizationResourceCollectionType: \(Swift.String(describing: organizationResourceCollectionType)), organizationalUnitIds: \(Swift.String(describing: organizationalUnitIds)))"}
}

extension DescribeOrganizationResourceCollectionHealthInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountIds = "AccountIds"
...
public struct DescribeOrganizationResourceCollectionHealthInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationResourceCollectionHealthInputHeadersMiddleware"
...
public struct DescribeOrganizationResourceCollectionHealthInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationResourceCollectionHealthInputQueryItemMiddleware"
...
public struct DescribeOrganizationResourceCollectionHealthInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationResourceCollectionHealthInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeOrganizationResourceCollectionHealthInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeOrganizationResourceCollectionHealthOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeOrganizationResourceCollectionHealthOutputError>
}

public struct DescribeOrganizationResourceCollectionHealthInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOrganizationResourceCollectionHealthInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/organization/health/resource-collection"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct DescribeOrganizationResourceCollectionHealthInputBody: Swift.Equatable {
    public let organizationResourceCollectionType: DevOpsGuruClientTypes.OrganizationResourceCollectionType?
    public let accountIds: [Swift.String]?
    public let organizationalUnitIds: [Swift.String]?
...
extension DescribeOrganizationResourceCollectionHealthOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeOrganizationResourceCollectionHealthOutputResponse(account: \(Swift.String(describing: account)), cloudFormation: \(Swift.String(describing: cloudFormation)), nextToken: \(Swift.String(describing: nextToken)), service: \(Swift.String(describing: service)))"}
}
...
struct DescribeOrganizationResourceCollectionHealthOutputResponseBody: Swift.Equatable {
    ...
    public let account: [DevOpsGuruClientTypes.AccountHealth]?
    public let nextToken: Swift.String?
}
...
public struct DescribeResourceCollectionHealthInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeResourceCollectionHealthInputURLHostMiddleware"
...
extension DescribeResourceCollectionHealthOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeResourceCollectionHealthOutputResponse(cloudFormation: \(Swift.String(describing: cloudFormation)), nextToken: \(Swift.String(describing: nextToken)), service: \(Swift.String(describing: service)), tags: \(Swift.String(describing: tags)))"}
}
...
struct DescribeResourceCollectionHealthOutputResponseBody: Swift.Equatable {
    ...
    public let service: [DevOpsGuruClientTypes.ServiceHealth]?
    public let nextToken: Swift.String?
    public let tags: [DevOpsGuruClientTypes.TagHealth]?
}
...
public struct DescribeServiceIntegrationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeServiceIntegrationInputURLHostMiddleware"
...
public struct GetCostEstimationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetCostEstimationInputURLHostMiddleware"
...
public struct GetResourceCollectionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetResourceCollectionInputURLHostMiddleware"
...
extension ListAnomaliesForInsightInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAnomaliesForInsightInput(accountId: \(Swift.String(describing: accountId)), insightId: \(Swift.String(describing: insightId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), startTimeRange: \(Swift.String(describing: startTimeRange)))"}
}
...
public struct ListAnomaliesForInsightInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAnomaliesForInsightInputURLHostMiddleware"
...
extension ListEventsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListEventsInput(accountId: \(Swift.String(describing: accountId)), filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct ListEventsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListEventsInputURLHostMiddleware"
...
public struct ListInsightsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListInsightsInputURLHostMiddleware"
...
public struct ListNotificationChannelsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListNotificationChannelsInputURLHostMiddleware"
...
public struct ListOrganizationInsightsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListOrganizationInsightsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListOrganizationInsightsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListOrganizationInsightsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListOrganizationInsightsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListOrganizationInsightsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListOrganizationInsightsOutputError>
}

extension ListOrganizationInsightsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListOrganizationInsightsInput(accountIds: \(Swift.String(describing: accountIds)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), organizationalUnitIds: \(Swift.String(describing: organizationalUnitIds)), statusFilter: \(Swift.String(describing: statusFilter)))"}
}

extension ListOrganizationInsightsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountIds = "AccountIds"
        case maxResults = "MaxResults"
        case nextToken = "NextToken"
...
public struct ListOrganizationInsightsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListOrganizationInsightsInputHeadersMiddleware"
...
public struct ListOrganizationInsightsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListOrganizationInsightsInputQueryItemMiddleware"
...
public struct ListOrganizationInsightsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListOrganizationInsightsInputURLHostMiddleware"
    ...
    public typealias MInput = ListOrganizationInsightsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListOrganizationInsightsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListOrganizationInsightsOutputError>
}

public struct ListOrganizationInsightsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListOrganizationInsightsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/organization/insights"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListOrganizationInsightsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListOrganizationInsightsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), proactiveInsights: \(Swift.String(describing: proactiveInsights)), reactiveInsights: \(Swift.String(describing: reactiveInsights)))"}
}
...
struct ListOrganizationInsightsOutputResponseBody: Swift.Equatable {
    public let proactiveInsights: [DevOpsGuruClientTypes.ProactiveOrganizationInsightSummary]?
    public let reactiveInsights: [DevOpsGuruClientTypes.ReactiveOrganizationInsightSummary]?
    public let nextToken: Swift.String?
}
...
extension ListRecommendationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListRecommendationsInput(accountId: \(Swift.String(describing: accountId)), insightId: \(Swift.String(describing: insightId)), locale: \(Swift.String(describing: locale)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
extension DevOpsGuruClientTypes.PerformanceInsightsMetricDimensionGroup: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case dimensions = "Dimensions"
        case group = "Group"
        case limit = "Limit"
...
extension DevOpsGuruClientTypes.PerformanceInsightsMetricDimensionGroup: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PerformanceInsightsMetricDimensionGroup(dimensions: \(Swift.String(describing: dimensions)), group: \(Swift.String(describing: group)), limit: \(Swift.String(describing: limit)))"}
}
...
extension DevOpsGuruClientTypes.PerformanceInsightsMetricQuery: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filter = "Filter"
...
extension DevOpsGuruClientTypes.PerformanceInsightsMetricQuery: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PerformanceInsightsMetricQuery(filter: \(Swift.String(describing: filter)), groupBy: \(Swift.String(describing: groupBy)), metric: \(Swift.String(describing: metric)))"}
}
...
extension DevOpsGuruClientTypes.PerformanceInsightsMetricsDetail: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DevOpsGuruClientTypes.PerformanceInsightsMetricsDetail: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PerformanceInsightsMetricsDetail(metricDisplayName: \(Swift.String(describing: metricDisplayName)), metricQuery: \(Swift.String(describing: metricQuery)), referenceData: \(Swift.String(describing: referenceData)), statsAtAnomaly: \(Swift.String(describing: statsAtAnomaly)), statsAtBaseline: \(Swift.String(describing: statsAtBaseline)), unit: \(Swift.String(describing: unit)))"}
}
...
extension DevOpsGuruClientTypes.PerformanceInsightsReferenceComparisonValues: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DevOpsGuruClientTypes.PerformanceInsightsReferenceComparisonValues: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PerformanceInsightsReferenceComparisonValues(referenceMetric: \(Swift.String(describing: referenceMetric)), referenceScalar: \(Swift.String(describing: referenceScalar)))"}
}
...
extension DevOpsGuruClientTypes.PerformanceInsightsReferenceData: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DevOpsGuruClientTypes.PerformanceInsightsReferenceData: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PerformanceInsightsReferenceData(comparisonValues: \(Swift.String(describing: comparisonValues)), name: \(Swift.String(describing: name)))"}
}
...
extension DevOpsGuruClientTypes.PerformanceInsightsReferenceMetric: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case metricQuery = "MetricQuery"
    }
...
extension DevOpsGuruClientTypes.PerformanceInsightsReferenceMetric: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PerformanceInsightsReferenceMetric(metricQuery: \(Swift.String(describing: metricQuery)))"}
}
...
extension DevOpsGuruClientTypes.PerformanceInsightsReferenceScalar: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case value = "Value"
    }
...
extension DevOpsGuruClientTypes.PerformanceInsightsReferenceScalar: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PerformanceInsightsReferenceScalar(value: \(Swift.String(describing: value)))"}
}
...
extension DevOpsGuruClientTypes.PerformanceInsightsStat: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case type = "Type"
        case value = "Value"
    }
...
extension DevOpsGuruClientTypes.PerformanceInsightsStat: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PerformanceInsightsStat(type: \(Swift.String(describing: type)), value: \(Swift.String(describing: value)))"}
}
...
extension DevOpsGuruClientTypes.ProactiveInsightSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ProactiveInsightSummary(associatedResourceArns: \(Swift.String(describing: associatedResourceArns)), id: \(Swift.String(describing: id)), insightTimeRange: \(Swift.String(describing: insightTimeRange)), name: \(Swift.String(describing: name)), predictionTimeRange: \(Swift.String(describing: predictionTimeRange)), resourceCollection: \(Swift.String(describing: resourceCollection)), serviceCollection: \(Swift.String(describing: serviceCollection)), severity: \(Swift.String(describing: severity)), status: \(Swift.String(describing: status)))"}
}
...
extension DevOpsGuruClientTypes.ProactiveOrganizationInsightSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountId = "AccountId"
        case id = "Id"
        case insightTimeRange = "InsightTimeRange"
...
extension DevOpsGuruClientTypes.ProactiveOrganizationInsightSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ProactiveOrganizationInsightSummary(accountId: \(Swift.String(describing: accountId)), id: \(Swift.String(describing: id)), insightTimeRange: \(Swift.String(describing: insightTimeRange)), name: \(Swift.String(describing: name)), organizationalUnitId: \(Swift.String(describing: organizationalUnitId)), predictionTimeRange: \(Swift.String(describing: predictionTimeRange)), resourceCollection: \(Swift.String(describing: resourceCollection)), serviceCollection: \(Swift.String(describing: serviceCollection)), severity: \(Swift.String(describing: severity)), status: \(Swift.String(describing: status)))"}
}
...
extension DevOpsGuruClientTypes.ReactiveAnomaly: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ReactiveAnomaly(anomalyReportedTimeRange: \(Swift.String(describing: anomalyReportedTimeRange)), anomalyResources: \(Swift.String(describing: anomalyResources)), anomalyTimeRange: \(Swift.String(describing: anomalyTimeRange)), associatedInsightId: \(Swift.String(describing: associatedInsightId)), causalAnomalyId: \(Swift.String(describing: causalAnomalyId)), description: \(Swift.String(describing: description)), id: \(Swift.String(describing: id)), name: \(Swift.String(describing: name)), resourceCollection: \(Swift.String(describing: resourceCollection)), severity: \(Swift.String(describing: severity)), sourceDetails: \(Swift.String(describing: sourceDetails)), status: \(Swift.String(describing: status)), type: \(Swift.String(describing: type)))"}
}
...
extension DevOpsGuruClientTypes.ReactiveAnomalySummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ReactiveAnomalySummary(anomalyReportedTimeRange: \(Swift.String(describing: anomalyReportedTimeRange)), anomalyResources: \(Swift.String(describing: anomalyResources)), anomalyTimeRange: \(Swift.String(describing: anomalyTimeRange)), associatedInsightId: \(Swift.String(describing: associatedInsightId)), causalAnomalyId: \(Swift.String(describing: causalAnomalyId)), description: \(Swift.String(describing: description)), id: \(Swift.String(describing: id)), name: \(Swift.String(describing: name)), resourceCollection: \(Swift.String(describing: resourceCollection)), severity: \(Swift.String(describing: severity)), sourceDetails: \(Swift.String(describing: sourceDetails)), status: \(Swift.String(describing: status)), type: \(Swift.String(describing: type)))"}
}
...
extension DevOpsGuruClientTypes.ReactiveInsightSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ReactiveInsightSummary(associatedResourceArns: \(Swift.String(describing: associatedResourceArns)), id: \(Swift.String(describing: id)), insightTimeRange: \(Swift.String(describing: insightTimeRange)), name: \(Swift.String(describing: name)), resourceCollection: \(Swift.String(describing: resourceCollection)), serviceCollection: \(Swift.String(describing: serviceCollection)), severity: \(Swift.String(describing: severity)), status: \(Swift.String(describing: status)))"}
}
...
extension DevOpsGuruClientTypes.ReactiveOrganizationInsightSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountId = "AccountId"
        case id = "Id"
        case insightTimeRange = "InsightTimeRange"
...
extension DevOpsGuruClientTypes.ReactiveOrganizationInsightSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ReactiveOrganizationInsightSummary(accountId: \(Swift.String(describing: accountId)), id: \(Swift.String(describing: id)), insightTimeRange: \(Swift.String(describing: insightTimeRange)), name: \(Swift.String(describing: name)), organizationalUnitId: \(Swift.String(describing: organizationalUnitId)), resourceCollection: \(Swift.String(describing: resourceCollection)), serviceCollection: \(Swift.String(describing: serviceCollection)), severity: \(Swift.String(describing: severity)), status: \(Swift.String(describing: status)))"}
}
...
extension DevOpsGuruClientTypes.RecommendationRelatedAnomaly: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RecommendationRelatedAnomaly(anomalyId: \(Swift.String(describing: anomalyId)), resources: \(Swift.String(describing: resources)), sourceDetails: \(Swift.String(describing: sourceDetails)))"}
}
...
extension DevOpsGuruClientTypes.ResourceCollection: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceCollection(cloudFormation: \(Swift.String(describing: cloudFormation)), tags: \(Swift.String(describing: tags)))"}
}
...
extension DevOpsGuruClientTypes.ResourceCollectionFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceCollectionFilter(cloudFormation: \(Swift.String(describing: cloudFormation)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct SearchInsightsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchInsightsInputURLHostMiddleware"
...
extension DevOpsGuruClientTypes.SearchOrganizationInsightsFilters: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case resourceCollection = "ResourceCollection"
        case serviceCollection = "ServiceCollection"
        case severities = "Severities"
...
extension DevOpsGuruClientTypes.SearchOrganizationInsightsFilters: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SearchOrganizationInsightsFilters(resourceCollection: \(Swift.String(describing: resourceCollection)), serviceCollection: \(Swift.String(describing: serviceCollection)), severities: \(Swift.String(describing: severities)), statuses: \(Swift.String(describing: statuses)))"}
}
...
public struct SearchOrganizationInsightsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchOrganizationInsightsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<SearchOrganizationInsightsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<SearchOrganizationInsightsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<SearchOrganizationInsightsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<SearchOrganizationInsightsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SearchOrganizationInsightsOutputError>
}

extension SearchOrganizationInsightsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SearchOrganizationInsightsInput(accountIds: \(Swift.String(describing: accountIds)), filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), startTimeRange: \(Swift.String(describing: startTimeRange)), type: \(Swift.String(describing: type)))"}
}

extension SearchOrganizationInsightsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accountIds = "AccountIds"
        case filters = "Filters"
        case maxResults = "MaxResults"
...
public struct SearchOrganizationInsightsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchOrganizationInsightsInputHeadersMiddleware"
...
public struct SearchOrganizationInsightsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchOrganizationInsightsInputQueryItemMiddleware"
...
public struct SearchOrganizationInsightsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchOrganizationInsightsInputURLHostMiddleware"
    ...
    public typealias MInput = SearchOrganizationInsightsInput
    public typealias MOutput = ClientRuntime.OperationOutput<SearchOrganizationInsightsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<SearchOrganizationInsightsOutputError>
}

public struct SearchOrganizationInsightsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "SearchOrganizationInsightsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/organization/insights/search"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct SearchOrganizationInsightsInputBody: Swift.Equatable {
    public let accountIds: [Swift.String]?
    public let startTimeRange: DevOpsGuruClientTypes.StartTimeRange?
    public let filters: DevOpsGuruClientTypes.SearchOrganizationInsightsFilters?
    public let maxResults: Swift.Int?
    public let nextToken: Swift.String?
    public let type: DevOpsGuruClientTypes.InsightType?
}
...
extension SearchOrganizationInsightsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SearchOrganizationInsightsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), proactiveInsights: \(Swift.String(describing: proactiveInsights)), reactiveInsights: \(Swift.String(describing: reactiveInsights)))"}
}
...
public struct StartCostEstimationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartCostEstimationInputURLHostMiddleware"
...
extension DevOpsGuruClientTypes.TagCollection: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DevOpsGuruClientTypes.TagCollection: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TagCollection(appBoundaryKey: \(Swift.String(describing: appBoundaryKey)), tagValues: \(Swift.String(describing: tagValues)))"}
}
...
extension DevOpsGuruClientTypes.TagCollectionFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case appBoundaryKey = "AppBoundaryKey"
        case tagValues = "TagValues"
    }
...
extension DevOpsGuruClientTypes.TagCollectionFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TagCollectionFilter(appBoundaryKey: \(Swift.String(describing: appBoundaryKey)), tagValues: \(Swift.String(describing: tagValues)))"}
}
...
extension DevOpsGuruClientTypes.TagCostEstimationResourceCollectionFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case appBoundaryKey = "AppBoundaryKey"
        case tagValues = "TagValues"
    }
...
extension DevOpsGuruClientTypes.TagCostEstimationResourceCollectionFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TagCostEstimationResourceCollectionFilter(appBoundaryKey: \(Swift.String(describing: appBoundaryKey)), tagValues: \(Swift.String(describing: tagValues)))"}
}
...
extension DevOpsGuruClientTypes.TagHealth: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case appBoundaryKey = "AppBoundaryKey"
        case insight = "Insight"
...
extension DevOpsGuruClientTypes.TagHealth: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TagHealth(appBoundaryKey: \(Swift.String(describing: appBoundaryKey)), insight: \(Swift.String(describing: insight)), tagValue: \(Swift.String(describing: tagValue)))"}
}
...
extension DevOpsGuruClientTypes.TimestampMetricValuePair: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension DevOpsGuruClientTypes.TimestampMetricValuePair: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TimestampMetricValuePair(metricValue: \(Swift.String(describing: metricValue)), timestamp: \(Swift.String(describing: timestamp)))"}
}
...
extension DevOpsGuruClientTypes.UpdateResourceCollectionFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateResourceCollectionFilter(cloudFormation: \(Swift.String(describing: cloudFormation)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct UpdateResourceCollectionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateResourceCollectionInputURLHostMiddleware"
...
public struct UpdateServiceIntegrationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateServiceIntegrationInputURLHostMiddleware"
...
extension DevOpsGuruClientTypes.UpdateTagCollectionFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case appBoundaryKey = "AppBoundaryKey"
        case tagValues = "TagValues"
    }
...
extension DevOpsGuruClientTypes.UpdateTagCollectionFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateTagCollectionFilter(appBoundaryKey: \(Swift.String(describing: appBoundaryKey)), tagValues: \(Swift.String(describing: tagValues)))"}
}
