...
public extension DevOpsGuruClient {
    ...
    {
        typealias describeOrganizationHealthContinuation = CheckedContinuation<DescribeOrganizationHealthOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeOrganizationHealthContinuation) in
            describeOrganizationHealth(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeOrganizationOverviewContinuation = CheckedContinuation<DescribeOrganizationOverviewOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeOrganizationOverviewContinuation) in
            describeOrganizationOverview(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeOrganizationResourceCollectionHealthContinuation = CheckedContinuation<DescribeOrganizationResourceCollectionHealthOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeOrganizationResourceCollectionHealthContinuation) in
            describeOrganizationResourceCollectionHealth(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listOrganizationInsightsContinuation = CheckedContinuation<ListOrganizationInsightsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listOrganizationInsightsContinuation) in
            listOrganizationInsights(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias searchOrganizationInsightsContinuation = CheckedContinuation<SearchOrganizationInsightsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: searchOrganizationInsightsContinuation) in
            searchOrganizationInsights(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
