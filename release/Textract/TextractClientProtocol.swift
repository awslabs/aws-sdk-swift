...
public protocol TextractClientProtocol {
    ...
    func analyzeDocument(input: AnalyzeDocumentInput, completion: @escaping (SdkResult<AnalyzeDocumentOutput, AnalyzeDocumentOutputError>) -> Void)
    ...
    func detectDocumentText(input: DetectDocumentTextInput, completion: @escaping (SdkResult<DetectDocumentTextOutput, DetectDocumentTextOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/textract/latest/dg/how-it-works-analyzing.html">Document Text Analysis</a>.</p>
    func getDocumentAnalysis(input: GetDocumentAnalysisInput, completion: @escaping (SdkResult<GetDocumentAnalysisOutput, GetDocumentAnalysisOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/textract/latest/dg/how-it-works-detecting.html">Document Text Detection</a>.</p>
    func getDocumentTextDetection(input: GetDocumentTextDetectionInput, completion: @escaping (SdkResult<GetDocumentTextDetectionOutput, GetDocumentTextDetectionOutputError>) -> Void)
    ...
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/textract/latest/dg/how-it-works-analyzing.html">Document Text Analysis</a>.</p>
    func startDocumentAnalysis(input: StartDocumentAnalysisInput, completion: @escaping (SdkResult<StartDocumentAnalysisOutput, StartDocumentAnalysisOutputError>) -> Void)
    ...
    ///             <code>StartDocumentTextDetection</code>.</p>
    ///          <p>For more information, see <a href="https://docs.aws.amazon.com/textract/latest/dg/how-it-works-detecting.html">Document Text Detection</a>.</p>
    func startDocumentTextDetection(input: StartDocumentTextDetectionInput, completion: @escaping (SdkResult<StartDocumentTextDetectionOutput, StartDocumentTextDetectionOutputError>) -> Void)
}
