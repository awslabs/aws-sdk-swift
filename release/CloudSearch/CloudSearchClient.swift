...
public class CloudSearchClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try CloudSearchClientConfiguration(region: unwrappedRegion)
    ...
    public class CloudSearchClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("CloudSearchClient")
