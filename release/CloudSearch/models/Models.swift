...
extension CloudSearchClientTypes {
    ...
    public struct AccessPoliciesStatus: Swift.Equatable {
        ...
        public let status: CloudSearchClientTypes.OptionStatus?
...
extension CloudSearchClientTypes {
    ...
    public struct AnalysisOptions: Swift.Equatable {
        ...
        public let algorithmicStemming: CloudSearchClientTypes.AlgorithmicStemming?
        ...
        public let japaneseTokenizationDictionary: Swift.String?
        ...
        public let stemmingDictionary: Swift.String?
        ...
        public let stopwords: Swift.String?
...
extension CloudSearchClientTypes {
    ...
    public struct AnalysisScheme: Swift.Equatable {
        /// <p>Synonyms, stopwords, and stemming options for an analysis scheme. Includes tokenization dictionary for Japanese.</p>
        public let analysisOptions: CloudSearchClientTypes.AnalysisOptions?
        ...
        public let analysisSchemeLanguage: CloudSearchClientTypes.AnalysisSchemeLanguage?
        /// <p>Names must begin with a letter and can contain the following characters:
        ///       a-z (lowercase), 0-9, and _ (underscore).</p>
        public let analysisSchemeName: Swift.String?
...
extension CloudSearchClientTypes {
    ...
    public struct AnalysisSchemeStatus: Swift.Equatable {
        /// <p>Configuration information for an analysis scheme. Each analysis scheme has a unique name and specifies the language of the text to be processed. The following options can be configured for an analysis scheme: <code>Synonyms</code>, <code>Stopwords</code>, <code>StemmingDictionary</code>, <code>JapaneseTokenizationDictionary</code> and <code>AlgorithmicStemming</code>.</p>
        public let options: CloudSearchClientTypes.AnalysisScheme?
        /// <p>The status of domain configuration option.</p>
        public let status: CloudSearchClientTypes.OptionStatus?
...
extension BaseException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            ...
            let output: ErrorResponseContainer<BaseExceptionBody> = try responseDecoder.decode(responseBody: data)
...
extension CloudSearchClientTypes {
    ...
    public struct DateArrayOptions: Swift.Equatable {
        ...
        public let facetEnabled: Swift.Bool?
        /// <p>Whether the contents of the field can be returned in the search results.</p>
        public let returnEnabled: Swift.Bool?
        /// <p>Whether the contents of the field are searchable.</p>
        public let searchEnabled: Swift.Bool?
...
extension CloudSearchClientTypes {
    ...
    public struct DateOptions: Swift.Equatable {
        ...
        public let sortEnabled: Swift.Bool?
        ...
        ///     </p>
        public let sourceField: Swift.String?
...
public struct DefineAnalysisSchemeInput: Swift.Equatable {
    /// <p>Configuration information for an analysis scheme. Each analysis scheme has a unique name and specifies the language of the text to be processed. The following options can be configured for an analysis scheme: <code>Synonyms</code>, <code>Stopwords</code>, <code>StemmingDictionary</code>, <code>JapaneseTokenizationDictionary</code> and <code>AlgorithmicStemming</code>.</p>
    public let analysisScheme: CloudSearchClientTypes.AnalysisScheme?
    /// <p>A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).</p>
    public let domainName: Swift.String?
...
public struct DefineExpressionInput: Swift.Equatable {
    ...
    public let expression: CloudSearchClientTypes.Expression?
...
public struct DefineIndexFieldInput: Swift.Equatable {
    ...
    public let indexField: CloudSearchClientTypes.IndexField?
...
public struct DefineSuggesterInput: Swift.Equatable {
    ...
    public let suggester: CloudSearchClientTypes.Suggester?
...
public struct DeleteExpressionInput: Swift.Equatable {
    ...
    public let expressionName: Swift.String?
...
public struct DeleteSuggesterInput: Swift.Equatable {
    ...
    public let suggesterName: Swift.String?
...
public struct DescribeAnalysisSchemesInput: Swift.Equatable {
    ...
    public let analysisSchemeNames: [Swift.String]?
    /// <p>Whether to display the deployed configuration (<code>true</code>) or include any pending changes (<code>false</code>). Defaults to <code>false</code>.</p>
    public let deployed: Swift.Bool?
...
public struct DescribeExpressionsInput: Swift.Equatable {
    ...
    public let expressionNames: [Swift.String]?
...
public struct DescribeSuggestersInput: Swift.Equatable {
    ...
    public let suggesterNames: [Swift.String]?
...
extension DisabledOperationException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
            let output: ErrorResponseContainer<DisabledOperationExceptionBody> = try responseDecoder.decode(responseBody: data)
            self.code = output.error.code
            self.message = output.error.message
        } else {
            self.code = nil
...
extension CloudSearchClientTypes {
    ...
    public struct DocumentSuggesterOptions: Swift.Equatable {
        ...
        public let fuzzyMatching: CloudSearchClientTypes.SuggesterFuzzyMatching?
        ...
        public let sortExpression: Swift.String?
...
extension CloudSearchClientTypes {
    ...
    public struct DomainEndpointOptions: Swift.Equatable {
        ...
        public let tLSSecurityPolicy: CloudSearchClientTypes.TLSSecurityPolicy?
...
extension CloudSearchClientTypes {
    ...
    public struct DomainEndpointOptionsStatus: Swift.Equatable {
        ...
        public let options: CloudSearchClientTypes.DomainEndpointOptions?
...
extension CloudSearchClientTypes {
    ...
    public struct DomainStatus: Swift.Equatable {
        ...
        public let docService: CloudSearchClientTypes.ServiceEndpoint?
        /// <p>An internally generated unique identifier for a domain.</p>
        public let domainId: Swift.String?
        /// <p>A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).</p>
        public let domainName: Swift.String?
        public let limits: CloudSearchClientTypes.Limits?
...
extension CloudSearchClientTypes {
    ...
    public struct DoubleArrayOptions: Swift.Equatable {
        /// A value to use for the field if the field isn't specified for a document.
        public let defaultValue: Swift.Double?
        /// <p>Whether facet information can be returned for the field.</p>
        public let facetEnabled: Swift.Bool?
        /// <p>Whether the contents of the field can be returned in the search results.</p>
        public let returnEnabled: Swift.Bool?
...
extension CloudSearchClientTypes {
    ...
    public struct Expression: Swift.Equatable {
        ...
        public let expressionValue: Swift.String?
...
extension CloudSearchClientTypes {
    ...
    public struct ExpressionStatus: Swift.Equatable {
        ...
        public let options: CloudSearchClientTypes.Expression?
        /// <p>The status of domain configuration option.</p>
        public let status: CloudSearchClientTypes.OptionStatus?
...
extension CloudSearchClientTypes {
    ...
    public struct IndexField: Swift.Equatable {
        /// <p>Options for a field that contains an array of dates.  Present if <code>IndexFieldType</code> specifies the field is of type <code>date-array</code>. All options are enabled by default.</p>
        public let dateArrayOptions: CloudSearchClientTypes.DateArrayOptions?
        /// <p>Options for a date field. Dates and times are specified in UTC (Coordinated Universal Time) according to IETF RFC3339: yyyy-mm-ddT00:00:00Z.  Present if <code>IndexFieldType</code> specifies the field is of type <code>date</code>. All options are enabled by default.</p>
        public let dateOptions: CloudSearchClientTypes.DateOptions?
        /// <p>Options for a field that contains an array of double-precision 64-bit floating point values.  Present if <code>IndexFieldType</code> specifies the field is of type <code>double-array</code>.  All options are enabled by default.</p>
        public let doubleArrayOptions: CloudSearchClientTypes.DoubleArrayOptions?
        /// <p>Options for a double-precision 64-bit floating point field.  Present if <code>IndexFieldType</code> specifies the field is of type <code>double</code>. All options are enabled by default.</p>
        public let doubleOptions: CloudSearchClientTypes.DoubleOptions?
        /// <p>A string that represents the name of an index field. CloudSearch supports regular index fields as well as dynamic fields.
        ///       A dynamic field's name defines a pattern that begins or ends with a wildcard.
        ///       Any document fields that don't map to a regular index field but do match a	
        ///       dynamic field's pattern are configured with the dynamic field's indexing options.
        ...
        public let indexFieldType: CloudSearchClientTypes.IndexFieldType?
        ...
        public let intArrayOptions: CloudSearchClientTypes.IntArrayOptions?
        ...
        public let intOptions: CloudSearchClientTypes.IntOptions?
        ...
        public let latLonOptions: CloudSearchClientTypes.LatLonOptions?
        ...
        public let literalArrayOptions: CloudSearchClientTypes.LiteralArrayOptions?
        ...
        public let literalOptions: CloudSearchClientTypes.LiteralOptions?
        ...
        public let textArrayOptions: CloudSearchClientTypes.TextArrayOptions?
        ...
        public let textOptions: CloudSearchClientTypes.TextOptions?
...
extension CloudSearchClientTypes {
    ...
    public struct IndexFieldStatus: Swift.Equatable {
        /// <p>Configuration information for a field in the index, including its name, type, and options. The supported options depend on the <code><a>IndexFieldType</a></code>.</p>
        public let options: CloudSearchClientTypes.IndexField?
        /// <p>The status of domain configuration option.</p>
        public let status: CloudSearchClientTypes.OptionStatus?
...
extension InternalException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
            let output: ErrorResponseContainer<InternalExceptionBody> = try responseDecoder.decode(responseBody: data)
            self.code = output.error.code
            self.message = output.error.message
        } else {
            self.code = nil
...
extension InvalidTypeException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
            let output: ErrorResponseContainer<InvalidTypeExceptionBody> = try responseDecoder.decode(responseBody: data)
            self.code = output.error.code
            self.message = output.error.message
        } else {
            self.code = nil
...
extension CloudSearchClientTypes {
    public struct Limits: Swift.Equatable {
        public let maximumPartitionCount: Swift.Int
        public let maximumReplicationCount: Swift.Int
...
extension CloudSearchClientTypes {
    ...
    public struct OptionStatus: Swift.Equatable {
        ...
        ///   </ul>
        public let state: CloudSearchClientTypes.OptionState?
...
extension CloudSearchClientTypes {
    ...
    public struct ScalingParameters: Swift.Equatable {
        ...
        public let desiredInstanceType: CloudSearchClientTypes.PartitionInstanceType?
        ...
        public let desiredPartitionCount: Swift.Int
        /// <p>The number of replicas you want to preconfigure for each index partition.</p>
        public let desiredReplicationCount: Swift.Int
...
extension CloudSearchClientTypes {
    ...
    public struct ScalingParametersStatus: Swift.Equatable {
        /// <p>The desired instance type and desired number of replicas of each index partition.</p>
        public let options: CloudSearchClientTypes.ScalingParameters?
        /// <p>The status of domain configuration option.</p>
        public let status: CloudSearchClientTypes.OptionStatus?
...
extension CloudSearchClientTypes {
    ...
    public struct Suggester: Swift.Equatable {
        /// <p>Options for a search suggester.</p>
        public let documentSuggesterOptions: CloudSearchClientTypes.DocumentSuggesterOptions?
        /// <p>Names must begin with a letter and can contain the following characters:
        ///       a-z (lowercase), 0-9, and _ (underscore).</p>
        public let suggesterName: Swift.String?
...
extension CloudSearchClientTypes {
    ...
    public struct SuggesterStatus: Swift.Equatable {
        /// <p>Configuration information for a search suggester. Each suggester has a unique name and specifies the text field you want to use for suggestions. The following options can be configured for a suggester: <code>FuzzyMatching</code>, <code>SortExpression</code>. </p>
        public let options: CloudSearchClientTypes.Suggester?
        /// <p>The status of domain configuration option.</p>
        public let status: CloudSearchClientTypes.OptionStatus?
...
extension CloudSearchClientTypes {
    ...
    public struct TextArrayOptions: Swift.Equatable {
        ...
        public let analysisScheme: Swift.String?
        /// A value to use for the field if the field isn't specified for a document.
        public let defaultValue: Swift.String?
        /// <p>Whether highlights can be returned for the field.</p>
        public let highlightEnabled: Swift.Bool?
        /// <p>Whether the contents of the field can be returned in the search results.</p>
        public let returnEnabled: Swift.Bool?
        /// <p>A list of source fields to map to the field. </p>
        public let sourceFields: Swift.String?
...
public struct UpdateDomainEndpointOptionsInput: Swift.Equatable {
    ...
    public let domainEndpointOptions: CloudSearchClientTypes.DomainEndpointOptions?
    /// <p>A string that represents the name of a domain.</p>
    public let domainName: Swift.String?
...
public struct UpdateScalingParametersInput: Swift.Equatable {
    ...
    public let domainName: Swift.String?
    /// <p>The desired instance type and desired number of replicas of each index partition.</p>
    public let scalingParameters: CloudSearchClientTypes.ScalingParameters?
