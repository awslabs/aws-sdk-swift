...
extension SsoOidcClient: SsoOidcClientProtocol {
    ...
    public func registerClient(input: RegisterClientInput, completion: @escaping (SdkResult<RegisterClientOutput, RegisterClientOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "awsssooidc")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RegisterClientInput, RegisterClientOutput, RegisterClientOutputError>(id: "registerClient")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RegisterClientInput, RegisterClientOutput, RegisterClientOutputError>(contentType: "application/json"))
    ...
    public func startDeviceAuthorization(input: StartDeviceAuthorizationInput, completion: @escaping (SdkResult<StartDeviceAuthorizationOutput, StartDeviceAuthorizationOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "awsssooidc")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartDeviceAuthorizationInput, StartDeviceAuthorizationOutput, StartDeviceAuthorizationOutputError>(id: "startDeviceAuthorization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartDeviceAuthorizationInput, StartDeviceAuthorizationOutput, StartDeviceAuthorizationOutputError>(contentType: "application/json"))
