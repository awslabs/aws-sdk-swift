...
public protocol SsoOidcClientProtocol {
    ...
    func registerClient(input: RegisterClientInput, completion: @escaping (SdkResult<RegisterClientOutput, RegisterClientOutputError>) -> Void)
    /// <p>Initiates device authorization by requesting a pair of verification codes from the authorization service.</p>
    func startDeviceAuthorization(input: StartDeviceAuthorizationInput, completion: @escaping (SdkResult<StartDeviceAuthorizationOutput, StartDeviceAuthorizationOutputError>) -> Void)
}
