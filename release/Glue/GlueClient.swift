...
public class GlueClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try GlueClientConfiguration(region: unwrappedRegion)
    ...
    public class GlueClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("GlueClient")
