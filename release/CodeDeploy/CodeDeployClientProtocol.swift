...
public protocol CodeDeployClientProtocol {
    ...
    func addTagsToOnPremisesInstances(input: AddTagsToOnPremisesInstancesInput, completion: @escaping (SdkResult<AddTagsToOnPremisesInstancesOutput, AddTagsToOnPremisesInstancesOutputError>) -> Void)
    ...
    func batchGetApplicationRevisions(input: BatchGetApplicationRevisionsInput, completion: @escaping (SdkResult<BatchGetApplicationRevisionsOutput, BatchGetApplicationRevisionsOutputError>) -> Void)
    /// <p>Gets information about one or more applications. The maximum number of applications
    ///             that can be returned is 100.</p>
    func batchGetApplications(input: BatchGetApplicationsInput, completion: @escaping (SdkResult<BatchGetApplicationsOutput, BatchGetApplicationsOutputError>) -> Void)
    /// <p>Gets information about one or more deployment groups.</p>
    func batchGetDeploymentGroups(input: BatchGetDeploymentGroupsInput, completion: @escaping (SdkResult<BatchGetDeploymentGroupsOutput, BatchGetDeploymentGroupsOutputError>) -> Void)
    /// <note>
    ...
    func batchGetDeploymentInstances(input: BatchGetDeploymentInstancesInput, completion: @escaping (SdkResult<BatchGetDeploymentInstancesOutput, BatchGetDeploymentInstancesOutputError>) -> Void)
    /// <p>Gets information about one or more deployments. The maximum number of deployments that
    ///             can be returned is 25.</p>
    func batchGetDeployments(input: BatchGetDeploymentsInput, completion: @escaping (SdkResult<BatchGetDeploymentsOutput, BatchGetDeploymentsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func batchGetDeploymentTargets(input: BatchGetDeploymentTargetsInput, completion: @escaping (SdkResult<BatchGetDeploymentTargetsOutput, BatchGetDeploymentTargetsOutputError>) -> Void)
    ...
    func batchGetOnPremisesInstances(input: BatchGetOnPremisesInstancesInput, completion: @escaping (SdkResult<BatchGetOnPremisesInstancesOutput, BatchGetOnPremisesInstancesOutputError>) -> Void)
    ...
    func continueDeployment(input: ContinueDeploymentInput, completion: @escaping (SdkResult<ContinueDeploymentOutput, ContinueDeploymentOutputError>) -> Void)
    ...
    func createDeploymentConfig(input: CreateDeploymentConfigInput, completion: @escaping (SdkResult<CreateDeploymentConfigOutput, CreateDeploymentConfigOutputError>) -> Void)
    /// <p>Creates a deployment group to which application revisions are deployed.</p>
    func createDeploymentGroup(input: CreateDeploymentGroupInput, completion: @escaping (SdkResult<CreateDeploymentGroupOutput, CreateDeploymentGroupOutputError>) -> Void)
    ...
    ///         </note>
    func deleteDeploymentConfig(input: DeleteDeploymentConfigInput, completion: @escaping (SdkResult<DeleteDeploymentConfigOutput, DeleteDeploymentConfigOutputError>) -> Void)
    /// <p>Deletes a deployment group.</p>
    func deleteDeploymentGroup(input: DeleteDeploymentGroupInput, completion: @escaping (SdkResult<DeleteDeploymentGroupOutput, DeleteDeploymentGroupOutputError>) -> Void)
    /// <p>Deletes a GitHub account connection.</p>
    func deleteGitHubAccountToken(input: DeleteGitHubAccountTokenInput, completion: @escaping (SdkResult<DeleteGitHubAccountTokenOutput, DeleteGitHubAccountTokenOutputError>) -> Void)
    /// <p>Deletes resources linked to an external ID.</p>
    func deleteResourcesByExternalId(input: DeleteResourcesByExternalIdInput, completion: @escaping (SdkResult<DeleteResourcesByExternalIdOutput, DeleteResourcesByExternalIdOutputError>) -> Void)
    /// <p>Deregisters an on-premises instance.</p>
    func deregisterOnPremisesInstance(input: DeregisterOnPremisesInstanceInput, completion: @escaping (SdkResult<DeregisterOnPremisesInstanceOutput, DeregisterOnPremisesInstanceOutputError>) -> Void)
    ...
    func getApplicationRevision(input: GetApplicationRevisionInput, completion: @escaping (SdkResult<GetApplicationRevisionOutput, GetApplicationRevisionOutputError>) -> Void)
    ...
    func getDeploymentConfig(input: GetDeploymentConfigInput, completion: @escaping (SdkResult<GetDeploymentConfigOutput, GetDeploymentConfigOutputError>) -> Void)
    /// <p>Gets information about a deployment group.</p>
    func getDeploymentGroup(input: GetDeploymentGroupInput, completion: @escaping (SdkResult<GetDeploymentGroupOutput, GetDeploymentGroupOutputError>) -> Void)
    /// <p>Gets information about an instance as part of a deployment.</p>
    @available(*, deprecated, message: "This operation is deprecated, use GetDeploymentTarget instead.")
    func getDeploymentInstance(input: GetDeploymentInstanceInput, completion: @escaping (SdkResult<GetDeploymentInstanceOutput, GetDeploymentInstanceOutputError>) -> Void)
    /// <p> Returns information about a deployment target. </p>
    func getDeploymentTarget(input: GetDeploymentTargetInput, completion: @escaping (SdkResult<GetDeploymentTargetOutput, GetDeploymentTargetOutputError>) -> Void)
    /// <p> Gets information about an on-premises instance. </p>
    func getOnPremisesInstance(input: GetOnPremisesInstanceInput, completion: @escaping (SdkResult<GetOnPremisesInstanceOutput, GetOnPremisesInstanceOutputError>) -> Void)
    /// <p>Lists information about revisions for an application.</p>
    func listApplicationRevisions(input: ListApplicationRevisionsInput, completion: @escaping (SdkResult<ListApplicationRevisionsOutput, ListApplicationRevisionsOutputError>) -> Void)
    ...
    func listDeploymentConfigs(input: ListDeploymentConfigsInput, completion: @escaping (SdkResult<ListDeploymentConfigsOutput, ListDeploymentConfigsOutputError>) -> Void)
    /// <p>Lists the deployment groups for an application registered with the IAM user or AWS
    ///             account.</p>
    func listDeploymentGroups(input: ListDeploymentGroupsInput, completion: @escaping (SdkResult<ListDeploymentGroupsOutput, ListDeploymentGroupsOutputError>) -> Void)
    /// <note>
    ...
    func listDeploymentInstances(input: ListDeploymentInstancesInput, completion: @escaping (SdkResult<ListDeploymentInstancesOutput, ListDeploymentInstancesOutputError>) -> Void)
    ...
    func listDeploymentTargets(input: ListDeploymentTargetsInput, completion: @escaping (SdkResult<ListDeploymentTargetsOutput, ListDeploymentTargetsOutputError>) -> Void)
    /// <p>Lists the names of stored connections to GitHub accounts.</p>
    func listGitHubAccountTokenNames(input: ListGitHubAccountTokenNamesInput, completion: @escaping (SdkResult<ListGitHubAccountTokenNamesOutput, ListGitHubAccountTokenNamesOutputError>) -> Void)
    ...
    func listOnPremisesInstances(input: ListOnPremisesInstancesInput, completion: @escaping (SdkResult<ListOnPremisesInstancesOutput, ListOnPremisesInstancesOutputError>) -> Void)
    ...
    func putLifecycleEventHookExecutionStatus(input: PutLifecycleEventHookExecutionStatusInput, completion: @escaping (SdkResult<PutLifecycleEventHookExecutionStatusOutput, PutLifecycleEventHookExecutionStatusOutputError>) -> Void)
    /// <p>Registers with AWS CodeDeploy a revision for the specified application.</p>
    func registerApplicationRevision(input: RegisterApplicationRevisionInput, completion: @escaping (SdkResult<RegisterApplicationRevisionOutput, RegisterApplicationRevisionOutputError>) -> Void)
    ...
    ///         </note>
    func registerOnPremisesInstance(input: RegisterOnPremisesInstanceInput, completion: @escaping (SdkResult<RegisterOnPremisesInstanceOutput, RegisterOnPremisesInstanceOutputError>) -> Void)
    /// <p>Removes one or more tags from one or more on-premises instances.</p>
    func removeTagsFromOnPremisesInstances(input: RemoveTagsFromOnPremisesInstancesInput, completion: @escaping (SdkResult<RemoveTagsFromOnPremisesInstancesOutput, RemoveTagsFromOnPremisesInstancesOutputError>) -> Void)
    ...
    func skipWaitTimeForInstanceTermination(input: SkipWaitTimeForInstanceTerminationInput, completion: @escaping (SdkResult<SkipWaitTimeForInstanceTerminationOutput, SkipWaitTimeForInstanceTerminationOutputError>) -> Void)
    ...
    func updateDeploymentGroup(input: UpdateDeploymentGroupInput, completion: @escaping (SdkResult<UpdateDeploymentGroupOutput, UpdateDeploymentGroupOutputError>) -> Void)
}
