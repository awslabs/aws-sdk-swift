...
public struct PutLifecycleEventHookExecutionStatusInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<PutLifecycleEventHookExecutionStatusOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<PutLifecycleEventHookExecutionStatusOutput>
