...
public class CodeDeployClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try CodeDeployClientConfiguration(region: unwrappedRegion)
    ...
    public class CodeDeployClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("CodeDeployClient")
...
public struct CodeDeployClientLogHandlerFactory: SDKLogHandlerFactory {
