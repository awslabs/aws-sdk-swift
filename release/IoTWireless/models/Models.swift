...
extension IotWirelessClientTypes {
    ...
    public struct AbpV1_0_x: Swift.Equatable {
        ...
        public let devAddr: Swift.String?
        /// <p>Session keys for ABP v1.0.x</p>
        public let sessionKeys: IotWirelessClientTypes.SessionKeysAbpV1_0_x?
...
extension IotWirelessClientTypes {
    ...
    public struct AbpV1_1: Swift.Equatable {
        ...
        public let sessionKeys: IotWirelessClientTypes.SessionKeysAbpV1_1?
...
extension IotWirelessClientTypes {
    ...
    public struct CertificateList: Swift.Equatable {
        ...
        public let signingAlg: IotWirelessClientTypes.SigningAlg?
...
public struct DisassociateAwsAccountFromPartnerAccountInput: Swift.Equatable {
    ...
    public let partnerAccountId: Swift.String?
    /// <p>The partner type.</p>
    public let partnerType: IotWirelessClientTypes.PartnerType?
...
public struct GetWirelessDeviceInput: Swift.Equatable {
    ...
    public let identifierType: IotWirelessClientTypes.WirelessDeviceIdType?
...
public struct GetWirelessGatewayInput: Swift.Equatable {
    ...
    public let identifier: Swift.String?
    /// <p>The type of identifier used in <code>identifier</code>.</p>
    public let identifierType: IotWirelessClientTypes.WirelessGatewayIdType?
...
public struct ListWirelessGatewayTaskDefinitionsInput: Swift.Equatable {
    ...
    public let taskDefinitionType: IotWirelessClientTypes.WirelessGatewayTaskDefinitionType?
...
extension IotWirelessClientTypes {
    ...
    public struct LoRaWANDevice: Swift.Equatable {
        ...
        public let abpV1_0_x: IotWirelessClientTypes.AbpV1_0_x?
        /// <p>ABP device object for create APIs for v1.1</p>
        public let abpV1_1: IotWirelessClientTypes.AbpV1_1?
        /// <p>The DevEUI value.</p>
        public let devEui: Swift.String?
        /// <p>The ID of the device profile for the new wireless device.</p>
        public let deviceProfileId: Swift.String?
        /// <p>OTAA device object for create APIs for v1.0.x</p>
        public let otaaV1_0_x: IotWirelessClientTypes.OtaaV1_0_x?
        /// <p>OTAA device object for v1.1 for create APIs</p>
        public let otaaV1_1: IotWirelessClientTypes.OtaaV1_1?
        /// <p>The ID of the service profile.</p>
        public let serviceProfileId: Swift.String?
...
extension IotWirelessClientTypes {
    ...
    public struct LoRaWANDeviceMetadata: Swift.Equatable {
        ...
        public let dataRate: Swift.Int?
        /// <p>The DevEUI value.</p>
        public let devEui: Swift.String?
        /// <p>The FPort value.</p>
        public let fPort: Swift.Int?
        ...
        public let gateways: [IotWirelessClientTypes.LoRaWANGatewayMetadata]?
...
extension IotWirelessClientTypes {
    ...
    public struct LoRaWANDeviceProfile: Swift.Equatable {
        ...
        public let classBTimeout: Swift.Int?
        /// <p>The ClassCTimeout value.</p>
        public let classCTimeout: Swift.Int?
        /// <p>The list of values that make up the FactoryPresetFreqs value.</p>
        public let factoryPresetFreqsList: [Swift.Int]?
        /// <p>The MAC version (such as OTAA 1.1 or OTAA 1.0.3) to use with this device profile.</p>
        public let macVersion: Swift.String?
        /// <p>The MaxDutyCycle value.</p>
        public let maxDutyCycle: Swift.Int?
        /// <p>The MaxEIRP value.</p>
        public let maxEirp: Swift.Int?
        /// <p>The PingSlotDR value.</p>
        public let pingSlotDr: Swift.Int?
        /// <p>The PingSlotFreq value.</p>
        public let pingSlotFreq: Swift.Int?
        /// <p>The PingSlotPeriod value.</p>
        public let pingSlotPeriod: Swift.Int?
        /// <p>The version of regional parameters.</p>
        public let regParamsRevision: Swift.String?
        /// <p>The frequency band (RFRegion) value.</p>
        public let rfRegion: Swift.String?
        /// <p>The RXDataRate2 value.</p>
        public let rxDataRate2: Swift.Int?
        /// <p>The RXDelay1 value.</p>
        public let rxDelay1: Swift.Int?
        /// <p>The RXDROffset1 value.</p>
        public let rxDrOffset1: Swift.Int?
        /// <p>The RXFreq2 value.</p>
        public let rxFreq2: Swift.Int?
        /// <p>The Supports32BitFCnt value.</p>
        public let supports32BitFCnt: Swift.Bool
        /// <p>The SupportsClassB value.</p>
        public let supportsClassB: Swift.Bool
        /// <p>The SupportsClassC value.</p>
        public let supportsClassC: Swift.Bool
        /// <p>The SupportsJoin value.</p>
        public let supportsJoin: Swift.Bool?
...
extension IotWirelessClientTypes {
    ...
    public struct LoRaWANGateway: Swift.Equatable {
        ...
        public let gatewayEui: Swift.String?
...
extension IotWirelessClientTypes {
    ...
    public struct LoRaWANGatewayCurrentVersion: Swift.Equatable {
        ...
        public let currentVersion: IotWirelessClientTypes.LoRaWANGatewayVersion?
...
extension IotWirelessClientTypes {
    ...
    public struct LoRaWANGatewayVersion: Swift.Equatable {
        ...
        public let station: Swift.String?
...
extension IotWirelessClientTypes {
    ...
    public struct LoRaWANGetServiceProfileInfo: Swift.Equatable {
        ...
        public let addGwMetadata: Swift.Bool
        /// <p>The ChannelMask value.</p>
        public let channelMask: Swift.String?
        /// <p>The DevStatusReqFreq value.</p>
        public let devStatusReqFreq: Swift.Int?
        /// <p>The DLBucketSize value.</p>
        public let dlBucketSize: Swift.Int?
        /// <p>The DLRate value.</p>
        public let dlRate: Swift.Int?
        /// <p>The DLRatePolicy value.</p>
        public let dlRatePolicy: Swift.String?
        /// <p>The DRMax value.</p>
        public let drMax: Swift.Int
        /// <p>The DRMin value.</p>
        public let drMin: Swift.Int
        /// <p>The HRAllowed value that describes whether handover roaming is allowed.</p>
        public let hrAllowed: Swift.Bool
        /// <p>The MinGwDiversity value.</p>
        public let minGwDiversity: Swift.Int?
        /// <p>The NwkGeoLoc value.</p>
        public let nwkGeoLoc: Swift.Bool
        /// <p>The PRAllowed value that describes whether passive roaming is allowed.</p>
        public let prAllowed: Swift.Bool
        /// <p>The RAAllowed value that describes whether roaming activation is allowed.</p>
        public let raAllowed: Swift.Bool
        /// <p>The ReportDevStatusBattery value.</p>
        public let reportDevStatusBattery: Swift.Bool
        /// <p>The ReportDevStatusMargin value.</p>
        public let reportDevStatusMargin: Swift.Bool
        /// <p>The TargetPER value.</p>
        public let targetPer: Swift.Int
        /// <p>The ULBucketSize value.</p>
        public let ulBucketSize: Swift.Int?
        /// <p>The ULRate value.</p>
        public let ulRate: Swift.Int?
        /// <p>The ULRatePolicy value.</p>
        public let ulRatePolicy: Swift.String?
...
extension IotWirelessClientTypes {
    ...
    public struct LoRaWANUpdateGatewayTaskCreate: Swift.Equatable {
        ...
        public let sigKeyCrc: Swift.Int?
        /// <p>The signature used to verify the update firmware.</p>
        public let updateSignature: Swift.String?
        /// <p>The firmware version to update the gateway to.</p>
        public let updateVersion: IotWirelessClientTypes.LoRaWANGatewayVersion?
...
extension IotWirelessClientTypes {
    ...
    public struct OtaaV1_0_x: Swift.Equatable {
        ...
        public let appEui: Swift.String?
...
extension IotWirelessClientTypes {
    ...
    public struct OtaaV1_1: Swift.Equatable {
        ...
        public let joinEui: Swift.String?
        /// <p>The NwkKey value.</p>
        public let nwkKey: Swift.String?
...
extension IotWirelessClientTypes {
    ...
    public struct SessionKeysAbpV1_0_x: Swift.Equatable {
        ...
        public let appSKey: Swift.String?
        /// <p>The NwkSKey value.</p>
        public let nwkSKey: Swift.String?
...
extension IotWirelessClientTypes {
    ...
    public struct SessionKeysAbpV1_1: Swift.Equatable {
        ...
        public let fNwkSIntKey: Swift.String?
        /// <p>The NwkSEncKey value.</p>
        public let nwkSEncKey: Swift.String?
        /// <p>The SNwkSIntKey value.</p>
        public let sNwkSIntKey: Swift.String?
...
extension IotWirelessClientTypes {
    ...
    public struct SidewalkAccountInfo: Swift.Equatable {
        ...
        public let appServerPrivateKey: Swift.String?
...
extension IotWirelessClientTypes.SidewalkDevice: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SidewalkDevice(deviceCertificates: \(Swift.String(describing: deviceCertificates)), sidewalkId: \(Swift.String(describing: sidewalkId)), sidewalkManufacturingSn: \(Swift.String(describing: sidewalkManufacturingSn)))"}
}
...
extension IotWirelessClientTypes {
    ...
    public struct SidewalkDevice: Swift.Equatable {
        ...
        public let deviceCertificates: [IotWirelessClientTypes.CertificateList]?
        /// <p>The sidewalk device identification.</p>
        public let sidewalkId: Swift.String?
        /// <p>The Sidewalk manufacturing series number.</p>
        public let sidewalkManufacturingSn: Swift.String?
...
extension IotWirelessClientTypes {
    ...
    public struct SidewalkDeviceMetadata: Swift.Equatable {
        /// <p>Sidewalk device battery level.</p>
        public let batteryLevel: IotWirelessClientTypes.BatteryLevel?
        /// <p>Device state defines the device status of sidewalk device.</p>
        public let deviceState: IotWirelessClientTypes.DeviceState?
        /// <p>Sidewalk device status notification.</p>
        public let event: IotWirelessClientTypes.Event?
        /// <p>The RSSI value.</p>
...
extension IotWirelessClientTypes {
    ...
    public struct SidewalkSendDataToDevice: Swift.Equatable {
        /// <p>Sidewalk device message type.</p>
        public let messageType: IotWirelessClientTypes.MessageType?
        /// <p>The sequence number.</p>
        public let seq: Swift.Int?
...
extension IotWirelessClientTypes {
    ...
    public struct UpdateWirelessGatewayTaskCreate: Swift.Equatable {
        ...
        public let loRaWAN: IotWirelessClientTypes.LoRaWANUpdateGatewayTaskCreate?
        /// <p>The IAM role used to read data from the S3 bucket.</p>
        public let updateDataRole: Swift.String?
        /// <p>The link to the S3 bucket.</p>
        public let updateDataSource: Swift.String?
...
extension IotWirelessClientTypes {
    ...
    public struct UpdateWirelessGatewayTaskEntry: Swift.Equatable {
        ...
        public let id: Swift.String?
        /// <p>The properties that relate to the LoRaWAN wireless gateway.</p>
        public let loRaWAN: IotWirelessClientTypes.LoRaWANUpdateGatewayTaskEntry?
...
extension IotWirelessClientTypes {
    ...
    public struct WirelessDeviceEventLogOption: Swift.Equatable {
        /// <p>The event for a log message, if the log message is tied to a wireless device.</p>
        public let event: IotWirelessClientTypes.WirelessDeviceEvent?
        /// <p>The log level for a log message.</p>
        public let logLevel: IotWirelessClientTypes.LogLevel?
...
extension IotWirelessClientTypes {
    ...
    public struct WirelessDeviceLogOption: Swift.Equatable {
        ...
        public let events: [IotWirelessClientTypes.WirelessDeviceEventLogOption]?
        /// <p>The log level for a log message.</p>
        public let logLevel: IotWirelessClientTypes.LogLevel?
        /// <p>The wireless device type.</p>
        public let type: IotWirelessClientTypes.WirelessDeviceType?
...
extension IotWirelessClientTypes {
    ...
    public struct WirelessDeviceStatistics: Swift.Equatable {
        ...
        public let loRaWAN: IotWirelessClientTypes.LoRaWANListDevice?
        /// <p>The name of the resource.</p>
        public let name: Swift.String?
        /// <p>The Sidewalk account credentials.</p>
        public let sidewalk: IotWirelessClientTypes.SidewalkListDevice?
        /// <p>The wireless device type.</p>
        public let type: IotWirelessClientTypes.WirelessDeviceType?
...
extension IotWirelessClientTypes {
    ...
    public struct WirelessGatewayEventLogOption: Swift.Equatable {
        /// <p>The event for a log message, if the log message is tied to a wireless gateway.</p>
        public let event: IotWirelessClientTypes.WirelessGatewayEvent?
        /// <p>The log level for a log message.</p>
        public let logLevel: IotWirelessClientTypes.LogLevel?
...
extension IotWirelessClientTypes {
    ...
    public struct WirelessGatewayLogOption: Swift.Equatable {
        ...
        public let events: [IotWirelessClientTypes.WirelessGatewayEventLogOption]?
        /// <p>The log level for a log message.</p>
        public let logLevel: IotWirelessClientTypes.LogLevel?
        /// <p>The wireless gateway type.</p>
        public let type: IotWirelessClientTypes.WirelessGatewayType?
...
extension IotWirelessClientTypes {
    ...
    public struct WirelessMetadata: Swift.Equatable {
        /// <p>LoRaWAN device info.</p>
        public let loRaWAN: IotWirelessClientTypes.LoRaWANSendDataToDevice?
        /// <p>The Sidewalk account credentials.</p>
        public let sidewalk: IotWirelessClientTypes.SidewalkSendDataToDevice?
