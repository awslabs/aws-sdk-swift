...
public protocol PricingClientProtocol {
    ...
    func getAttributeValues(input: GetAttributeValuesInput, completion: @escaping (SdkResult<GetAttributeValuesOutput, GetAttributeValuesOutputError>) -> Void)
    /// <p>Returns a list of all products that match the filter criteria.</p>
    func getProducts(input: GetProductsInput, completion: @escaping (SdkResult<GetProductsOutput, GetProductsOutputError>) -> Void)
}
