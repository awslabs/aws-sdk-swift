...
extension PricingClient: PricingClientProtocol {
    ...
    public func describeServices(input: DescribeServicesInput, completion: @escaping (SdkResult<DescribeServicesOutput, DescribeServicesOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeServicesInput, DescribeServicesOutput, DescribeServicesOutputError>(xAmzTarget: "AWSPriceListService.DescribeServices"))
    ...
    public func getAttributeValues(input: GetAttributeValuesInput, completion: @escaping (SdkResult<GetAttributeValuesOutput, GetAttributeValuesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "pricing")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAttributeValuesInput, GetAttributeValuesOutput, GetAttributeValuesOutputError>(id: "getAttributeValues")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAttributeValuesInput, GetAttributeValuesOutput, GetAttributeValuesOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetAttributeValuesInput, GetAttributeValuesOutput, GetAttributeValuesOutputError>(xAmzTarget: "AWSPriceListService.GetAttributeValues"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }

    /// <p>Returns a list of all products that match the filter criteria.</p>
    public func getProducts(input: GetProductsInput, completion: @escaping (SdkResult<GetProductsOutput, GetProductsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "pricing")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetProductsInput, GetProductsOutput, GetProductsOutputError>(id: "getProducts")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetProductsInput, GetProductsOutput, GetProductsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetProductsInput, GetProductsOutput, GetProductsOutputError>(xAmzTarget: "AWSPriceListService.GetProducts"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
