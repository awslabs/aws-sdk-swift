...
extension MqClientTypes {
    ...
    public struct BrokerEngineType: Swift.Equatable {
        ...
        var engineType: MqClientTypes.EngineType?
        /// The list of engine versions.
        var engineVersions: [MqClientTypes.EngineVersion]?
...
extension MqClientTypes {
    ...
    public struct BrokerInstanceOption: Swift.Equatable {
        ...
        var availabilityZones: [MqClientTypes.AvailabilityZone]?
        /// The broker's engine type.
        var engineType: MqClientTypes.EngineType?
        /// The broker's instance type.
        var hostInstanceType: Swift.String?
        /// The broker's storage type.
        var storageType: MqClientTypes.BrokerStorageType?
        /// The list of supported deployment modes.
        var supportedDeploymentModes: [MqClientTypes.DeploymentMode]?
        /// The list of supported engine versions.
        var supportedEngineVersions: [Swift.String]?
...
extension MqClientTypes {
    ...
    public struct BrokerSummary: Swift.Equatable {
        ...
        var brokerArn: Swift.String?
        /// The unique ID that Amazon MQ generates for the broker.
        var brokerId: Swift.String?
        ...
        var brokerName: Swift.String?
        /// The broker's status.
        var brokerState: MqClientTypes.BrokerState?
        /// The time when the broker was created.
        var created: ClientRuntime.Date?
        /// The broker's deployment mode.
        /// This member is required.
        var deploymentMode: MqClientTypes.DeploymentMode?
...
extension MqClientTypes {
    ...
    public struct Configuration: Swift.Equatable {
        ...
        /// This member is required.
        var authenticationStrategy: MqClientTypes.AuthenticationStrategy?
        ...
        /// This member is required.
        var latestRevision: MqClientTypes.ConfigurationRevision?
...
extension MqClientTypes {
    ...
    public struct Configurations: Swift.Equatable {
        ...
        var current: MqClientTypes.ConfigurationId?
        /// The history of configurations applied to the broker.
        var history: [MqClientTypes.ConfigurationId]?
        /// The broker's pending configuration.
        var pending: MqClientTypes.ConfigurationId?
...
public struct CreateBrokerInput: Swift.Equatable {
    ...
    var configuration: MqClientTypes.ConfigurationId?
    /// The unique ID that the requester receives for the created broker. Amazon MQ passes your ID with the API action. Note: We recommend using a Universally Unique Identifier (UUID) for the creatorRequestId. You may omit the creatorRequestId if your application doesn't require idempotency.
    var creatorRequestId: Swift.String?
    /// Required. The broker's deployment mode.
    /// This member is required.
    var deploymentMode: MqClientTypes.DeploymentMode?
    /// Encryption options for the broker. Does not apply to RabbitMQ brokers.
    var encryptionOptions: MqClientTypes.EncryptionOptions?
    /// Required. The type of broker engine. Currently, Amazon MQ supports ACTIVEMQ and RABBITMQ.
    /// This member is required.
    var engineType: MqClientTypes.EngineType?
    /// Required. The broker engine's version. For a list of supported engine versions, see [Supported engines](https://docs.aws.amazon.com//amazon-mq/latest/developer-guide/broker-engine.html).
    ...
    var ldapServerMetadata: MqClientTypes.LdapServerMetadataInput?
    /// Enables Amazon CloudWatch logging for brokers.
    var logs: MqClientTypes.Logs?
    /// The parameters that determine the WeeklyStartTime.
    var maintenanceWindowStartTime: MqClientTypes.WeeklyStartTime?
...
public struct CreateUserInput: Swift.Equatable {
    ...
    var consoleAccess: Swift.Bool?
    /// The list of groups (20 maximum) to which the ActiveMQ user belongs. This value can contain only alphanumeric characters, dashes, periods, underscores, and tildes (- . _ ~). This value must be 2-100 characters long.
    var groups: [Swift.String]?
...
public struct DescribeBrokerEngineTypesOutputResponse: Swift.Equatable {
    ...
    var brokerEngineTypes: [MqClientTypes.BrokerEngineType]?
...
public struct DescribeBrokerInstanceOptionsOutputResponse: Swift.Equatable {
    ...
    var brokerInstanceOptions: [MqClientTypes.BrokerInstanceOption]?
...
public struct DescribeBrokerOutputResponse: Swift.Equatable {
    ...
    var brokerInstances: [MqClientTypes.BrokerInstance]?
    ...
    var configurations: MqClientTypes.Configurations?
    /// The time when the broker was created.
    var created: ClientRuntime.Date?
    /// The broker's deployment mode.
    var deploymentMode: MqClientTypes.DeploymentMode?
    ...
    var ldapServerMetadata: MqClientTypes.LdapServerMetadataOutput?
    /// The list of information about logs currently enabled and pending to be deployed for the specified broker.
    var logs: MqClientTypes.LogsSummary?
    /// The parameters that determine the WeeklyStartTime.
    var maintenanceWindowStartTime: MqClientTypes.WeeklyStartTime?
    /// The authentication strategy that will be applied when the broker is rebooted. The default is SIMPLE.
    var pendingAuthenticationStrategy: MqClientTypes.AuthenticationStrategy?
    ...
    var pendingEngineVersion: Swift.String?
    ...
    var pendingHostInstanceType: Swift.String?
    /// The metadata of the LDAP server that will be used to authenticate and authorize connections to the broker after it is rebooted.
    var pendingLdapServerMetadata: MqClientTypes.LdapServerMetadataOutput?
    /// The list of pending security groups to authorize connections to brokers.
    var pendingSecurityGroups: [Swift.String]?
    ...
    var users: [MqClientTypes.UserSummary]?
...
public struct DescribeConfigurationRevisionInput: Swift.Equatable {
    ...
    /// This member is required.
    var configurationRevision: Swift.String?
...
public struct DescribeUserOutputResponse: Swift.Equatable {
    ...
    var pending: MqClientTypes.UserPendingChanges?
...
extension MqClientTypes {
    ...
    public struct LdapServerMetadataInput: Swift.Equatable {
        ...
        /// This member is required.
        var hosts: [Swift.String]?
        /// The distinguished name of the node in the directory information tree (DIT) to search for roles or groups. For example, ou=group, ou=corp, dc=corp, dc=example, dc=com.
        /// This member is required.
        var roleBase: Swift.String?
        ...
        /// This member is required.
        var roleSearchMatching: Swift.String?
        /// The directory search scope for the role. If set to true, scope is to search the entire subtree.
        var roleSearchSubtree: Swift.Bool?
        /// Service account password. A service account is an account in your LDAP server that has access to initiate a connection. For example, cn=admin,dc=corp, dc=example, dc=com.
        /// This member is required.
        var serviceAccountPassword: Swift.String?
        /// Service account username. A service account is an account in your LDAP server that has access to initiate a connection. For example, cn=admin,dc=corp, dc=example, dc=com.
        /// This member is required.
        var serviceAccountUsername: Swift.String?
        /// Select a particular subtree of the directory information tree (DIT) to search for user entries. The subtree is specified by a DN, which specifies the base node of the subtree. For example, by setting this option to ou=Users,ou=corp, dc=corp, dc=example, dc=com, the search for user entries is restricted to the subtree beneath ou=Users, ou=corp, dc=corp, dc=example, dc=com.
        /// This member is required.
        var userBase: Swift.String?
        /// Specifies the name of the LDAP attribute for the user group membership.
        var userRoleName: Swift.String?
        /// The LDAP search filter used to find users within the userBase. The client's username is substituted into the {0} placeholder in the search filter. For example, if this option is set to (uid={0}) and the received username is janedoe, the search filter becomes (uid=janedoe) after string substitution. It will result in matching an entry like uid=janedoe, ou=Users,ou=corp, dc=corp, dc=example, dc=com.
        /// This member is required.
        var userSearchMatching: Swift.String?
        /// The directory search scope for the user. If set to true, scope is to search the entire subtree.
        var userSearchSubtree: Swift.Bool?
...
public struct ListBrokersOutputResponse: Swift.Equatable {
    ...
    var brokerSummaries: [MqClientTypes.BrokerSummary]?
    /// The token that specifies the next page of results Amazon MQ should return. To request the first page, leave nextToken empty.
    var nextToken: Swift.String?
...
public struct ListConfigurationRevisionsOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// The list of all revisions for the specified configuration.
    var revisions: [MqClientTypes.ConfigurationRevision]?
...
public struct ListConfigurationsOutputResponse: Swift.Equatable {
    /// The list of all revisions for the specified configuration.
    var configurations: [MqClientTypes.Configuration]?
...
extension MqClientTypes {
    ...
    public struct Logs: Swift.Equatable {
        ...
        var audit: Swift.Bool?
        /// Enables general logging.
        var general: Swift.Bool?
...
extension MqClientTypes {
    ...
    public struct LogsSummary: Swift.Equatable {
        ...
        var auditLogGroup: Swift.String?
        /// Enables general logging.
        /// This member is required.
        var general: Swift.Bool?
        /// The location of the CloudWatch Logs log group where general logs are sent.
        /// This member is required.
        var generalLogGroup: Swift.String?
        /// The list of information about logs pending to be deployed for the specified broker.
        var pending: MqClientTypes.PendingLogs?
...
extension MqClientTypes {
    ...
    public struct SanitizationWarning: Swift.Equatable {
        ...
        var elementName: Swift.String?
        /// Required. The reason for which the XML elements or attributes were sanitized.
        /// This member is required.
        var reason: MqClientTypes.SanitizationWarningReason?
...
public struct UpdateConfigurationOutputResponse: Swift.Equatable {
    ...
    var warnings: [MqClientTypes.SanitizationWarning]?
...
extension MqClientTypes {
    ...
    public struct UserPendingChanges: Swift.Equatable {
        ...
        /// This member is required.
        var pendingChange: MqClientTypes.ChangeType?
...
extension MqClientTypes {
    ...
    public struct WeeklyStartTime: Swift.Equatable {
        ...
        /// This member is required.
        var dayOfWeek: MqClientTypes.DayOfWeek?
        /// Required. The time, in 24-hour format.
        /// This member is required.
        var timeOfDay: Swift.String?
