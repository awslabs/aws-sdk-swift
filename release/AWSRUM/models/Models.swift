...
extension RumClientTypes {
    ...
    public struct AppMonitor: Swift.Equatable {
        ...
        var appMonitorConfiguration: RumClientTypes.AppMonitorConfiguration?
        /// The date and time that this app monitor was created.
        var created: Swift.String?
        /// A structure that contains information about whether this app monitor stores a copy of the telemetry data that RUM collects using CloudWatch Logs.
        var dataStorage: RumClientTypes.DataStorage?
        ...
        var state: RumClientTypes.StateEnum?
...
extension RumClientTypes {
    ...
    public struct AppMonitorConfiguration: Swift.Equatable {
        ...
        var telemetries: [RumClientTypes.Telemetry]?
...
extension RumClientTypes {
    ...
    public struct DataStorage: Swift.Equatable {
        /// A structure that contains the information about whether the app monitor stores copies of the data that RUM collects in CloudWatch Logs. If it does, this structure also contains the name of the log group.
        var cwLog: RumClientTypes.CwLog?
...
public struct GetAppMonitorDataInput: Swift.Equatable {
    ...
    var filters: [RumClientTypes.QueryFilter]?
    ...
    /// This member is required.
    var timeRange: RumClientTypes.TimeRange?
...
public struct GetAppMonitorOutputResponse: Swift.Equatable {
    ...
    var appMonitor: RumClientTypes.AppMonitor?
...
public struct ListAppMonitorsOutputResponse: Swift.Equatable {
    ...
    var appMonitorSummaries: [RumClientTypes.AppMonitorSummary]?
    /// A token that you can use in a subsequent operation to retrieve the next set of results.
    var nextToken: Swift.String?
...
public struct PutRumEventsInput: Swift.Equatable {
    ...
    /// This member is required.
    var appMonitorDetails: RumClientTypes.AppMonitorDetails?
    /// A unique identifier for this batch of RUM event data.
    /// This member is required.
    var batchId: Swift.String?
    /// The ID of the app monitor that is sending this data.
    /// This member is required.
    var id: Swift.String?
    /// An array of structures that contain the telemetry event data.
    /// This member is required.
    var rumEvents: [RumClientTypes.RumEvent]?
    /// A structure that contains information about the user session that this batch of events was collected from.
    /// This member is required.
    var userDetails: RumClientTypes.UserDetails?
