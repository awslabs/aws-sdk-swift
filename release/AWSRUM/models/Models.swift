...
extension RumClientTypes.AppMonitor: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension RumClientTypes.AppMonitor: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AppMonitor(appMonitorConfiguration: \(Swift.String(describing: appMonitorConfiguration)), created: \(Swift.String(describing: created)), dataStorage: \(Swift.String(describing: dataStorage)), domain: \(Swift.String(describing: domain)), id: \(Swift.String(describing: id)), lastModified: \(Swift.String(describing: lastModified)), name: \(Swift.String(describing: name)), state: \(Swift.String(describing: state)), tags: \(Swift.String(describing: tags)))"}
}
...
extension RumClientTypes.AppMonitorConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension RumClientTypes.AppMonitorConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AppMonitorConfiguration(allowCookies: \(Swift.String(describing: allowCookies)), enableXRay: \(Swift.String(describing: enableXRay)), excludedPages: \(Swift.String(describing: excludedPages)), favoritePages: \(Swift.String(describing: favoritePages)), guestRoleArn: \(Swift.String(describing: guestRoleArn)), identityPoolId: \(Swift.String(describing: identityPoolId)), includedPages: \(Swift.String(describing: includedPages)), sessionSampleRate: \(Swift.String(describing: sessionSampleRate)), telemetries: \(Swift.String(describing: telemetries)))"}
}
...
extension RumClientTypes.AppMonitorDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case id
        case name
        case version
...
extension RumClientTypes.AppMonitorDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AppMonitorDetails(id: \(Swift.String(describing: id)), name: \(Swift.String(describing: name)), version: \(Swift.String(describing: version)))"}
}
...
extension RumClientTypes.AppMonitorSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case created = "Created"
        case id = "Id"
        case lastModified = "LastModified"
...
extension RumClientTypes.AppMonitorSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AppMonitorSummary(created: \(Swift.String(describing: created)), id: \(Swift.String(describing: id)), lastModified: \(Swift.String(describing: lastModified)), name: \(Swift.String(describing: name)), state: \(Swift.String(describing: state)))"}
}
...
extension ConflictException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConflictException(message: \(Swift.String(describing: message)), resourceName: \(Swift.String(describing: resourceName)), resourceType: \(Swift.String(describing: resourceType)))"}
}
...
public struct CreateAppMonitorInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAppMonitorInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateAppMonitorInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateAppMonitorOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateAppMonitorInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateAppMonitorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateAppMonitorOutputError>
}

extension CreateAppMonitorInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAppMonitorInput(appMonitorConfiguration: \(Swift.String(describing: appMonitorConfiguration)), cwLogEnabled: \(Swift.String(describing: cwLogEnabled)), domain: \(Swift.String(describing: domain)), name: \(Swift.String(describing: name)), tags: \(Swift.String(describing: tags)))"}
}

extension CreateAppMonitorInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case appMonitorConfiguration = "AppMonitorConfiguration"
...
public struct CreateAppMonitorInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAppMonitorInputHeadersMiddleware"
...
public struct CreateAppMonitorInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAppMonitorInputQueryItemMiddleware"
...
public struct CreateAppMonitorInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAppMonitorInputURLHostMiddleware"
    ...
    public typealias MInput = CreateAppMonitorInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateAppMonitorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateAppMonitorOutputError>
}

public struct CreateAppMonitorInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateAppMonitorInputURLPathMiddleware"
...
struct CreateAppMonitorInputBody: Swift.Equatable {
    ...
    public let appMonitorConfiguration: RumClientTypes.AppMonitorConfiguration?
    public let cwLogEnabled: Swift.Bool?
}
...
extension CreateAppMonitorOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAppMonitorOutputResponse(id: \(Swift.String(describing: id)))"}
}
...
extension RumClientTypes.CwLog: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cwLogEnabled = "CwLogEnabled"
...
extension RumClientTypes.CwLog: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CwLog(cwLogEnabled: \(Swift.String(describing: cwLogEnabled)), cwLogGroup: \(Swift.String(describing: cwLogGroup)))"}
}
...
extension RumClientTypes.DataStorage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case cwLog = "CwLog"
    }
...
extension RumClientTypes.DataStorage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DataStorage(cwLog: \(Swift.String(describing: cwLog)))"}
}
...
extension DeleteAppMonitorInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteAppMonitorInput(name: \(Swift.String(describing: name)))"}
}

extension DeleteAppMonitorInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeleteAppMonitorInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAppMonitorInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteAppMonitorInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteAppMonitorOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteAppMonitorInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteAppMonitorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteAppMonitorOutputError>
}

public struct DeleteAppMonitorInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAppMonitorInputQueryItemMiddleware"
...
public struct DeleteAppMonitorInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAppMonitorInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteAppMonitorInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteAppMonitorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteAppMonitorOutputError>
}

public struct DeleteAppMonitorInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteAppMonitorInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/appmonitor/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension DeleteAppMonitorOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteAppMonitorOutputResponse()"}
}
...
struct DeleteAppMonitorOutputResponseBody: Swift.Equatable {
}

extension DeleteAppMonitorOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

public struct GetAppMonitorDataInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAppMonitorDataInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAppMonitorDataInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAppMonitorDataOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAppMonitorDataInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAppMonitorDataOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAppMonitorDataOutputError>
}

extension GetAppMonitorDataInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAppMonitorDataInput(filters: \(Swift.String(describing: filters)), maxResults: \(Swift.String(describing: maxResults)), name: \(Swift.String(describing: name)), nextToken: \(Swift.String(describing: nextToken)), timeRange: \(Swift.String(describing: timeRange)))"}
}

extension GetAppMonitorDataInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct GetAppMonitorDataInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAppMonitorDataInputHeadersMiddleware"
...
public struct GetAppMonitorDataInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAppMonitorDataInputQueryItemMiddleware"
...
public struct GetAppMonitorDataInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAppMonitorDataInputURLHostMiddleware"
    ...
    public typealias MInput = GetAppMonitorDataInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAppMonitorDataOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAppMonitorDataOutputError>
}

public struct GetAppMonitorDataInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAppMonitorDataInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/appmonitor/\(name.urlPercentEncoding())/data"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct GetAppMonitorDataInputBody: Swift.Equatable {
    public let timeRange: RumClientTypes.TimeRange?
    public let filters: [RumClientTypes.QueryFilter]?
...
extension GetAppMonitorDataOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAppMonitorDataOutputResponse(events: \(Swift.String(describing: events)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
extension GetAppMonitorInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAppMonitorInput(name: \(Swift.String(describing: name)))"}
}

extension GetAppMonitorInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetAppMonitorInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAppMonitorInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetAppMonitorInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetAppMonitorOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetAppMonitorInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetAppMonitorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAppMonitorOutputError>
}

public struct GetAppMonitorInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAppMonitorInputQueryItemMiddleware"
...
public struct GetAppMonitorInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAppMonitorInputURLHostMiddleware"
    ...
    public typealias MInput = GetAppMonitorInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetAppMonitorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetAppMonitorOutputError>
}

public struct GetAppMonitorInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetAppMonitorInputURLPathMiddleware"
...
extension GetAppMonitorOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetAppMonitorOutputResponse(appMonitor: \(Swift.String(describing: appMonitor)))"}
}
...
struct GetAppMonitorOutputResponseBody: Swift.Equatable {
    public let appMonitor: RumClientTypes.AppMonitor?
}
...
extension ListAppMonitorsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAppMonitorsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListAppMonitorsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListAppMonitorsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAppMonitorsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListAppMonitorsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListAppMonitorsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListAppMonitorsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListAppMonitorsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAppMonitorsOutputError>
}

public struct ListAppMonitorsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAppMonitorsInputQueryItemMiddleware"
...
public struct ListAppMonitorsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAppMonitorsInputURLHostMiddleware"
    ...
    public typealias MInput = ListAppMonitorsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListAppMonitorsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListAppMonitorsOutputError>
}

public struct ListAppMonitorsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListAppMonitorsInputURLPathMiddleware"
...
extension ListAppMonitorsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAppMonitorsOutputResponse(appMonitorSummaries: \(Swift.String(describing: appMonitorSummaries)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListAppMonitorsOutputResponseBody: Swift.Equatable {
    public let nextToken: Swift.String?
    public let appMonitorSummaries: [RumClientTypes.AppMonitorSummary]?
}
...
public struct PutRumEventsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRumEventsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<PutRumEventsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<PutRumEventsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<PutRumEventsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<PutRumEventsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutRumEventsOutputError>
}

extension PutRumEventsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutRumEventsInput(appMonitorDetails: \(Swift.String(describing: appMonitorDetails)), batchId: \(Swift.String(describing: batchId)), id: \(Swift.String(describing: id)), rumEvents: \(Swift.String(describing: rumEvents)), userDetails: \(Swift.String(describing: userDetails)))"}
}

extension PutRumEventsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct PutRumEventsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRumEventsInputHeadersMiddleware"
...
public struct PutRumEventsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRumEventsInputQueryItemMiddleware"
...
public struct PutRumEventsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRumEventsInputURLHostMiddleware"
    ...
    public typealias MInput = PutRumEventsInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutRumEventsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutRumEventsOutputError>
}

public struct PutRumEventsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRumEventsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/appmonitors/\(id.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct PutRumEventsInputBody: Swift.Equatable {
    ...
    public let appMonitorDetails: RumClientTypes.AppMonitorDetails?
    public let userDetails: RumClientTypes.UserDetails?
    public let rumEvents: [RumClientTypes.RumEvent]?
}
...
extension PutRumEventsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutRumEventsOutputResponse()"}
}
...
struct PutRumEventsOutputResponseBody: Swift.Equatable {
}

extension PutRumEventsOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension RumClientTypes.QueryFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case values = "Values"
    }
...
extension RumClientTypes.QueryFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "QueryFilter(name: \(Swift.String(describing: name)), values: \(Swift.String(describing: values)))"}
}
...
extension RumClientTypes.RumEvent: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case details
        case id
        case metadata
...
extension RumClientTypes.RumEvent: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RumEvent(details: \(Swift.String(describing: details)), id: \(Swift.String(describing: id)), metadata: \(Swift.String(describing: metadata)), timestamp: \(Swift.String(describing: timestamp)), type: \(Swift.String(describing: type)))"}
}
...
extension RumClientTypes.TimeRange: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case after = "After"
        case before = "Before"
    }
...
extension RumClientTypes.TimeRange: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "TimeRange(after: \(Swift.String(describing: after)), before: \(Swift.String(describing: before)))"}
}
...
public struct UpdateAppMonitorInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateAppMonitorInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateAppMonitorInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateAppMonitorOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateAppMonitorInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateAppMonitorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateAppMonitorOutputError>
}

extension UpdateAppMonitorInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateAppMonitorInput(appMonitorConfiguration: \(Swift.String(describing: appMonitorConfiguration)), cwLogEnabled: \(Swift.String(describing: cwLogEnabled)), domain: \(Swift.String(describing: domain)), name: \(Swift.String(describing: name)))"}
}

extension UpdateAppMonitorInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case appMonitorConfiguration = "AppMonitorConfiguration"
        case cwLogEnabled = "CwLogEnabled"
        case domain = "Domain"
...
public struct UpdateAppMonitorInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateAppMonitorInputHeadersMiddleware"
...
public struct UpdateAppMonitorInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateAppMonitorInputQueryItemMiddleware"
...
public struct UpdateAppMonitorInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateAppMonitorInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateAppMonitorInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateAppMonitorOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateAppMonitorOutputError>
}

public struct UpdateAppMonitorInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateAppMonitorInputURLPathMiddleware"
...
extension UpdateAppMonitorOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateAppMonitorOutputResponse()"}
}
...
struct UpdateAppMonitorOutputResponseBody: Swift.Equatable {
}

extension UpdateAppMonitorOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension RumClientTypes.UserDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case sessionId
        case userId
    }
...
extension RumClientTypes.UserDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UserDetails(sessionId: \(Swift.String(describing: sessionId)), userId: \(Swift.String(describing: userId)))"}
}
