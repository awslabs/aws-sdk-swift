...
public protocol OutpostsClientProtocol {
    ...
    func createOutpost(input: CreateOutpostInput, completion: @escaping (SdkResult<CreateOutpostOutputResponse, CreateOutpostOutputError>) -> Void)
    /// <p>Deletes the Outpost.</p>
    func deleteOutpost(input: DeleteOutpostInput, completion: @escaping (SdkResult<DeleteOutpostOutputResponse, DeleteOutpostOutputError>) -> Void)
    ...
    func getOutpost(input: GetOutpostInput, completion: @escaping (SdkResult<GetOutpostOutputResponse, GetOutpostOutputError>) -> Void)
    /// <p>Lists the instance types for the specified Outpost.</p>
    func getOutpostInstanceTypes(input: GetOutpostInstanceTypesInput, completion: @escaping (SdkResult<GetOutpostInstanceTypesOutputResponse, GetOutpostInstanceTypesOutputError>) -> Void)
    /// <p>List the Outposts for your AWS account.</p>
    func listOutposts(input: ListOutpostsInput, completion: @escaping (SdkResult<ListOutpostsOutputResponse, ListOutpostsOutputError>) -> Void)
    /// <p>Lists the sites for the specified AWS account.</p>
    func listSites(input: ListSitesInput, completion: @escaping (SdkResult<ListSitesOutputResponse, ListSitesOutputError>) -> Void)
