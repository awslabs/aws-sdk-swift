...
public class SchemasClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try SchemasClientConfiguration(region: unwrappedRegion)
    ...
    public class SchemasClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("SchemasClient")
