...
public struct DeleteConnectionInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/@connections/\(connectionId.urlPercentEncoding())"
...
public struct PostToConnectionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostToConnectionInputURLHostMiddleware"
    ...
    public typealias MInput = PostToConnectionInput
    public typealias MOutput = ClientRuntime.OperationOutput<PostToConnectionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PostToConnectionOutputError>
}

public struct PostToConnectionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PostToConnectionInputURLPathMiddleware"
