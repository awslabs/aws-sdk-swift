...
public protocol ConnectParticipantClientProtocol {
    ...
    func completeAttachmentUpload(input: CompleteAttachmentUploadInput, completion: @escaping (SdkResult<CompleteAttachmentUploadOutputResponse, CompleteAttachmentUploadOutputError>) -> Void)
    ...
    ///                     authentication</a>.</p>
    ///         </note>
    func createParticipantConnection(input: CreateParticipantConnectionInput, completion: @escaping (SdkResult<CreateParticipantConnectionOutputResponse, CreateParticipantConnectionOutputError>) -> Void)
    /// <p>Disconnects a participant. Note that ConnectionToken is used for invoking this API
    ///             instead of ParticipantToken.</p>
    ///         <p>The Amazon Connect Participant Service APIs do not use <a href="https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html">Signature Version 4
    ///                 authentication</a>.</p>
    func disconnectParticipant(input: DisconnectParticipantInput, completion: @escaping (SdkResult<DisconnectParticipantOutputResponse, DisconnectParticipantOutputError>) -> Void)
    ...
    func getAttachment(input: GetAttachmentInput, completion: @escaping (SdkResult<GetAttachmentOutputResponse, GetAttachmentOutputError>) -> Void)
    ...
    ///         <p>The Amazon Connect Participant Service APIs do not use <a href="https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html">Signature Version 4
    ///                 authentication</a>.</p>
    func getTranscript(input: GetTranscriptInput, completion: @escaping (SdkResult<GetTranscriptOutputResponse, GetTranscriptOutputError>) -> Void)
    /// <p>Sends an event. Note that ConnectionToken is used for invoking this API instead of
    ///             ParticipantToken.</p>
    ///         <p>The Amazon Connect Participant Service APIs do not use <a href="https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html">Signature Version 4
    ///                 authentication</a>.</p>
    func sendEvent(input: SendEventInput, completion: @escaping (SdkResult<SendEventOutputResponse, SendEventOutputError>) -> Void)
    ...
    ///             S3.</p>
    func startAttachmentUpload(input: StartAttachmentUploadInput, completion: @escaping (SdkResult<StartAttachmentUploadOutputResponse, StartAttachmentUploadOutputError>) -> Void)
}
