...
public struct AssociateRepositoryInput: Swift.Equatable {
    ...
    var kMSKeyDetails: CodeGuruReviewerClientTypes.KMSKeyDetails?
    /// The repository to associate.
    /// This member is required.
    var repository: CodeGuruReviewerClientTypes.Repository?
...
public struct AssociateRepositoryOutputResponse: Swift.Equatable {
    ...
    var repositoryAssociation: CodeGuruReviewerClientTypes.RepositoryAssociation?
    /// An array of key-value pairs used to tag an associated repository. A tag is a custom attribute label with two parts:
    ///
    /// * A tag key (for example, CostCenter, Environment, Project, or Secret). Tag keys are case sensitive.
    ///
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct BranchDiffSourceCodeType: Swift.Equatable {
        ...
        /// This member is required.
        var destinationBranchName: Swift.String?
        /// The source branch for a diff in an associated repository.
        /// This member is required.
        var sourceBranchName: Swift.String?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct CodeArtifacts: Swift.Equatable {
        ...
        var buildArtifactsObjectKey: Swift.String?
        /// The S3 object key for a source code .zip file. This is required for all code reviews.
        /// This member is required.
        var sourceCodeArtifactsObjectKey: Swift.String?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct CodeReview: Swift.Equatable {
        ...
        var analysisTypes: [CodeGuruReviewerClientTypes.AnalysisType]?
        ...
        var associationArn: Swift.String?
        ...
        var state: CodeGuruReviewerClientTypes.JobState?
        /// The reason for the state of the code review.
        var stateReason: Swift.String?
        /// The type of code review.
        var type: CodeGuruReviewerClientTypes.ModelType?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct CodeReviewSummary: Swift.Equatable {
        ...
        var lastUpdatedTimeStamp: ClientRuntime.Date?
        /// The statistics from the code review.
        var metricsSummary: CodeGuruReviewerClientTypes.MetricsSummary?
        /// The name of the code review.
        var name: Swift.String?
        /// The owner of the repository. For an Amazon Web Services CodeCommit repository, this is the Amazon Web Services account ID of the account that owns the repository. For a GitHub, GitHub Enterprise Server, or Bitbucket repository, this is the username for the account that owns the repository. For an S3 repository, it can be the username or Amazon Web Services account ID.
        var owner: Swift.String?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct CodeReviewType: Swift.Equatable {
        ...
        /// This member is required.
        var repositoryAnalysis: CodeGuruReviewerClientTypes.RepositoryAnalysis?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct CommitDiffSourceCodeType: Swift.Equatable {
        ...
        var destinationCommit: Swift.String?
        /// The SHA of the merge base of a commit.
        var mergeBaseCommit: Swift.String?
        /// The SHA of the source commit used to generate a commit diff. This field is required for a pull request code review.
        var sourceCommit: Swift.String?
...
public struct CreateCodeReviewInput: Swift.Equatable {
    ...
    /// This member is required.
    var repositoryAssociationArn: Swift.String?
    ...
    /// This member is required.
    var type: CodeGuruReviewerClientTypes.CodeReviewType?
...
public struct CreateCodeReviewOutputResponse: Swift.Equatable {
    /// Information about a code review. A code review belongs to the associated repository that contains the reviewed code.
    var codeReview: CodeGuruReviewerClientTypes.CodeReview?
...
public struct DescribeRecommendationFeedbackOutputResponse: Swift.Equatable {
    ...
    var recommendationFeedback: CodeGuruReviewerClientTypes.RecommendationFeedback?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct KMSKeyDetails: Swift.Equatable {
        /// The encryption option for a repository association. It is either owned by Amazon Web Services Key Management Service (KMS) (AWS_OWNED_CMK) or customer managed (CUSTOMER_MANAGED_CMK).
        var encryptionOption: CodeGuruReviewerClientTypes.EncryptionOption?
        /// The ID of the Amazon Web Services KMS key that is associated with a respository association.
...
public struct ListCodeReviewsInput: Swift.Equatable {
    ...
    var providerTypes: [CodeGuruReviewerClientTypes.ProviderType]?
    ...
    ///
    /// * Deleting: The code review is being deleted.
    var states: [CodeGuruReviewerClientTypes.JobState]?
...
public struct ListCodeReviewsOutputResponse: Swift.Equatable {
    ...
    var codeReviewSummaries: [CodeGuruReviewerClientTypes.CodeReviewSummary]?
    /// Pagination token.
    var nextToken: Swift.String?
...
public struct ListRecommendationFeedbackOutputResponse: Swift.Equatable {
    ...
    var recommendationFeedbackSummaries: [CodeGuruReviewerClientTypes.RecommendationFeedbackSummary]?
...
public struct ListRecommendationsOutputResponse: Swift.Equatable {
    ...
    var recommendationSummaries: [CodeGuruReviewerClientTypes.RecommendationSummary]?
...
public struct ListRepositoryAssociationsInput: Swift.Equatable {
    ...
    var states: [CodeGuruReviewerClientTypes.RepositoryAssociationState]?
...
public struct ListRepositoryAssociationsOutputResponse: Swift.Equatable {
    ...
    var repositoryAssociationSummaries: [CodeGuruReviewerClientTypes.RepositoryAssociationSummary]?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct Metrics: Swift.Equatable {
        ...
        var meteredLinesOfCodeCount: Swift.Int?
...
public struct PutRecommendationFeedbackInput: Swift.Equatable {
    ...
    /// This member is required.
    var reactions: [CodeGuruReviewerClientTypes.Reaction]?
    /// The recommendation ID that can be used to track the provided recommendations and then to collect the feedback.
    /// This member is required.
    var recommendationId: Swift.String?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct RecommendationSummary: Swift.Equatable {
        ...
        var endLine: Swift.Int?
        /// Name of the file on which a recommendation is provided.
        var filePath: Swift.String?
        /// The type of a recommendation.
        var recommendationCategory: CodeGuruReviewerClientTypes.RecommendationCategory?
        /// The recommendation ID that can be used to track the provided recommendations. Later on it can be used to collect the feedback.
        var recommendationId: Swift.String?
        /// Metadata about a rule. Rule metadata includes an ID, a name, a list of tags, and a short and long description. CodeGuru Reviewer uses rules to analyze code. A rule's recommendation is included in analysis results if code is detected that violates the rule.
        var ruleMetadata: CodeGuruReviewerClientTypes.RuleMetadata?
        /// The severity of the issue in the code that generated this recommendation.
        var severity: CodeGuruReviewerClientTypes.Severity?
        /// Start line from where the recommendation is applicable in the source commit or source branch.
        var startLine: Swift.Int?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct Repository: Swift.Equatable {
        ...
        var bitbucket: CodeGuruReviewerClientTypes.ThirdPartySourceRepository?
        /// Information about an Amazon Web Services CodeCommit repository.
        var codeCommit: CodeGuruReviewerClientTypes.CodeCommitRepository?
        /// Information about a GitHub Enterprise Server repository.
        var gitHubEnterpriseServer: CodeGuruReviewerClientTypes.ThirdPartySourceRepository?
        /// Information about a repository in an S3 bucket.
        var s3Bucket: CodeGuruReviewerClientTypes.S3Repository?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct RepositoryAnalysis: Swift.Equatable {
        ...
        var repositoryHead: CodeGuruReviewerClientTypes.RepositoryHeadSourceCodeType?
        /// Specifies the source code that is analyzed in a code review.
        var sourceCodeType: CodeGuruReviewerClientTypes.SourceCodeType?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct RepositoryAssociation: Swift.Equatable {
        ...
        var associationId: Swift.String?
        ...
        var s3RepositoryDetails: CodeGuruReviewerClientTypes.S3RepositoryDetails?
        ...
        ///
        /// * Disassociated: CodeGuru Reviewer successfully disassociated the repository. You can create a new association with this repository if you want to review source code in it later. You can control access to code reviews created in an associated repository with tags after it has been disassociated. For more information, see [Using tags to control access to associated repositories](https://docs.aws.amazon.com/codeguru/latest/reviewer-ug/auth-and-access-control-using-tags.html) in the Amazon CodeGuru Reviewer User Guide.
        var state: CodeGuruReviewerClientTypes.RepositoryAssociationState?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct RequestMetadata: Swift.Equatable {
        ...
        var eventInfo: CodeGuruReviewerClientTypes.EventInfo?
        ...
        var vendorName: CodeGuruReviewerClientTypes.VendorName?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct RuleMetadata: Swift.Equatable {
        ...
        var longDescription: Swift.String?
        /// The ID of the rule.
        var ruleId: Swift.String?
        /// The name of the rule.
        var ruleName: Swift.String?
        /// Tags that are associated with the rule.
        var ruleTags: [Swift.String]?
        /// A short description of the rule.
        var shortDescription: Swift.String?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct S3BucketRepository: Swift.Equatable {
        ...
        var details: CodeGuruReviewerClientTypes.S3RepositoryDetails?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct S3RepositoryDetails: Swift.Equatable {
        ...
        var codeArtifacts: CodeGuruReviewerClientTypes.CodeArtifacts?
...
extension CodeGuruReviewerClientTypes {
    ...
    public struct SourceCodeType: Swift.Equatable {
        ...
        var branchDiff: CodeGuruReviewerClientTypes.BranchDiffSourceCodeType?
        ...
        var commitDiff: CodeGuruReviewerClientTypes.CommitDiffSourceCodeType?
        /// A [SourceCodeType](https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_SourceCodeType) that specifies the tip of a branch in an associated repository.
        var repositoryHead: CodeGuruReviewerClientTypes.RepositoryHeadSourceCodeType?
        ...
        var requestMetadata: CodeGuruReviewerClientTypes.RequestMetadata?
        ...
        var s3BucketRepository: CodeGuruReviewerClientTypes.S3BucketRepository?
