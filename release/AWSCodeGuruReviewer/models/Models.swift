...
public struct AssociateRepositoryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateRepositoryInputURLHostMiddleware"
    ...
    public typealias MInput = AssociateRepositoryInput
    public typealias MOutput = ClientRuntime.OperationOutput<AssociateRepositoryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AssociateRepositoryOutputError>
}

public struct AssociateRepositoryInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AssociateRepositoryInputURLPathMiddleware"
...
extension CodeGuruReviewerClientTypes.BranchDiffSourceCodeType: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CodeGuruReviewerClientTypes.BranchDiffSourceCodeType: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BranchDiffSourceCodeType(destinationBranchName: \(Swift.String(describing: destinationBranchName)), sourceBranchName: \(Swift.String(describing: sourceBranchName)))"}
}
...
extension CodeGuruReviewerClientTypes.CodeArtifacts: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CodeGuruReviewerClientTypes.CodeArtifacts: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CodeArtifacts(buildArtifactsObjectKey: \(Swift.String(describing: buildArtifactsObjectKey)), sourceCodeArtifactsObjectKey: \(Swift.String(describing: sourceCodeArtifactsObjectKey)))"}
}
...
extension CodeGuruReviewerClientTypes.CodeReviewType: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CodeReviewType(analysisTypes: \(Swift.String(describing: analysisTypes)), repositoryAnalysis: \(Swift.String(describing: repositoryAnalysis)))"}
}
...
extension CodeGuruReviewerClientTypes.CommitDiffSourceCodeType: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CommitDiffSourceCodeType(destinationCommit: \(Swift.String(describing: destinationCommit)), mergeBaseCommit: \(Swift.String(describing: mergeBaseCommit)), sourceCommit: \(Swift.String(describing: sourceCommit)))"}
}
...
public struct CreateCodeReviewInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateCodeReviewInputURLHostMiddleware"
    ...
    public typealias MInput = CreateCodeReviewInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateCodeReviewOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateCodeReviewOutputError>
}

public struct CreateCodeReviewInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateCodeReviewInputURLPathMiddleware"
...
public struct DescribeCodeReviewInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeCodeReviewInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeCodeReviewInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeCodeReviewOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeCodeReviewOutputError>
}

public struct DescribeCodeReviewInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeCodeReviewInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let codeReviewArn = input.codeReviewArn else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("codeReviewArn is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/codereviews/\(codeReviewArn.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeRecommendationFeedbackInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRecommendationFeedbackInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeRecommendationFeedbackInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeRecommendationFeedbackOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeRecommendationFeedbackOutputError>
}

public struct DescribeRecommendationFeedbackInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRecommendationFeedbackInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/feedback/\(codeReviewArn.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeRepositoryAssociationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRepositoryAssociationInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeRepositoryAssociationInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeRepositoryAssociationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeRepositoryAssociationOutputError>
}

public struct DescribeRepositoryAssociationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRepositoryAssociationInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let associationArn = input.associationArn else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("associationArn is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/associations/\(associationArn.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DisassociateRepositoryInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateRepositoryInputURLHostMiddleware"
    ...
    public typealias MInput = DisassociateRepositoryInput
    public typealias MOutput = ClientRuntime.OperationOutput<DisassociateRepositoryOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DisassociateRepositoryOutputError>
}

public struct DisassociateRepositoryInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DisassociateRepositoryInputURLPathMiddleware"
...
extension CodeGuruReviewerClientTypes.EventInfo: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
        case state = "State"
    }
...
extension CodeGuruReviewerClientTypes.EventInfo: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EventInfo(name: \(Swift.String(describing: name)), state: \(Swift.String(describing: state)))"}
}
...
public struct ListCodeReviewsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListCodeReviewsInputURLHostMiddleware"
    ...
    public typealias MInput = ListCodeReviewsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListCodeReviewsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListCodeReviewsOutputError>
}

public struct ListCodeReviewsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListCodeReviewsInputURLPathMiddleware"
...
public struct ListRecommendationFeedbackInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecommendationFeedbackInputURLHostMiddleware"
    ...
    public typealias MInput = ListRecommendationFeedbackInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListRecommendationFeedbackOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRecommendationFeedbackOutputError>
}

public struct ListRecommendationFeedbackInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecommendationFeedbackInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/feedback/\(codeReviewArn.urlPercentEncoding())/RecommendationFeedback"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListRecommendationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecommendationsInputURLHostMiddleware"
...
public struct ListRecommendationsInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/codereviews/\(codeReviewArn.urlPercentEncoding())/Recommendations"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListRepositoryAssociationsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRepositoryAssociationsInputURLHostMiddleware"
    ...
    public typealias MInput = ListRepositoryAssociationsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListRepositoryAssociationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRepositoryAssociationsOutputError>
}

public struct ListRepositoryAssociationsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRepositoryAssociationsInputURLPathMiddleware"
...
public struct PutRecommendationFeedbackInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRecommendationFeedbackInputURLHostMiddleware"
    ...
    public typealias MInput = PutRecommendationFeedbackInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutRecommendationFeedbackOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutRecommendationFeedbackOutputError>
}

public struct PutRecommendationFeedbackInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRecommendationFeedbackInputURLPathMiddleware"
...
extension CodeGuruReviewerClientTypes.RecommendationSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RecommendationSummary(description: \(Swift.String(describing: description)), endLine: \(Swift.String(describing: endLine)), filePath: \(Swift.String(describing: filePath)), recommendationCategory: \(Swift.String(describing: recommendationCategory)), recommendationId: \(Swift.String(describing: recommendationId)), ruleMetadata: \(Swift.String(describing: ruleMetadata)), severity: \(Swift.String(describing: severity)), startLine: \(Swift.String(describing: startLine)))"}
}
...
extension CodeGuruReviewerClientTypes.Repository: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Repository(bitbucket: \(Swift.String(describing: bitbucket)), codeCommit: \(Swift.String(describing: codeCommit)), gitHubEnterpriseServer: \(Swift.String(describing: gitHubEnterpriseServer)), s3Bucket: \(Swift.String(describing: s3Bucket)))"}
}
...
extension CodeGuruReviewerClientTypes.RepositoryAnalysis: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RepositoryAnalysis(repositoryHead: \(Swift.String(describing: repositoryHead)), sourceCodeType: \(Swift.String(describing: sourceCodeType)))"}
}
...
extension CodeGuruReviewerClientTypes.RequestMetadata: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CodeGuruReviewerClientTypes.RequestMetadata: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RequestMetadata(eventInfo: \(Swift.String(describing: eventInfo)), requestId: \(Swift.String(describing: requestId)), requester: \(Swift.String(describing: requester)), vendorName: \(Swift.String(describing: vendorName)))"}
}
...
extension CodeGuruReviewerClientTypes.RuleMetadata: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CodeGuruReviewerClientTypes.RuleMetadata: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RuleMetadata(longDescription: \(Swift.String(describing: longDescription)), ruleId: \(Swift.String(describing: ruleId)), ruleName: \(Swift.String(describing: ruleName)), ruleTags: \(Swift.String(describing: ruleTags)), shortDescription: \(Swift.String(describing: shortDescription)))"}
}
...
extension CodeGuruReviewerClientTypes.S3BucketRepository: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CodeGuruReviewerClientTypes.S3BucketRepository: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3BucketRepository(details: \(Swift.String(describing: details)), name: \(Swift.String(describing: name)))"}
}
...
extension CodeGuruReviewerClientTypes.S3Repository: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CodeGuruReviewerClientTypes.S3Repository: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3Repository(bucketName: \(Swift.String(describing: bucketName)), name: \(Swift.String(describing: name)))"}
}
...
extension CodeGuruReviewerClientTypes.S3RepositoryDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case bucketName = "BucketName"
...
extension CodeGuruReviewerClientTypes.S3RepositoryDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3RepositoryDetails(bucketName: \(Swift.String(describing: bucketName)), codeArtifacts: \(Swift.String(describing: codeArtifacts)))"}
}
...
extension CodeGuruReviewerClientTypes.SourceCodeType: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SourceCodeType(branchDiff: \(Swift.String(describing: branchDiff)), commitDiff: \(Swift.String(describing: commitDiff)), repositoryHead: \(Swift.String(describing: repositoryHead)), requestMetadata: \(Swift.String(describing: requestMetadata)), s3BucketRepository: \(Swift.String(describing: s3BucketRepository)))"}
}
