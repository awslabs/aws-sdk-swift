...
public protocol AppStreamClientProtocol {
    ...
    func associateApplicationFleet(input: AssociateApplicationFleetInput, completion: @escaping (ClientRuntime.SdkResult<AssociateApplicationFleetOutputResponse, AssociateApplicationFleetOutputError>) -> Void)
    ...
    func createAppBlock(input: CreateAppBlockInput, completion: @escaping (ClientRuntime.SdkResult<CreateAppBlockOutputResponse, CreateAppBlockOutputError>) -> Void)
    ...
    func deleteAppBlock(input: DeleteAppBlockInput, completion: @escaping (ClientRuntime.SdkResult<DeleteAppBlockOutputResponse, DeleteAppBlockOutputError>) -> Void)
    ...
    func describeAppBlocks(input: DescribeAppBlocksInput, completion: @escaping (ClientRuntime.SdkResult<DescribeAppBlocksOutputResponse, DescribeAppBlocksOutputError>) -> Void)
    /// Retrieves a list that describes one or more application fleet associations. Either ApplicationArn or FleetName must be specified.
    func describeApplicationFleetAssociations(input: DescribeApplicationFleetAssociationsInput, completion: @escaping (ClientRuntime.SdkResult<DescribeApplicationFleetAssociationsOutputResponse, DescribeApplicationFleetAssociationsOutputError>) -> Void)
    ...
    func disassociateApplicationFleet(input: DisassociateApplicationFleetInput, completion: @escaping (ClientRuntime.SdkResult<DisassociateApplicationFleetOutputResponse, DisassociateApplicationFleetOutputError>) -> Void)
