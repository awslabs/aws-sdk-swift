...
extension AppStreamClientTypes {
    ...
    public struct AccessEndpoint: Swift.Equatable {
        ...
        var endpointType: AppStreamClientTypes.AccessEndpointType?
        /// The identifier (ID) of the VPC in which the interface endpoint is used.
        var vpceId: Swift.String?
...
extension AppStreamClientTypes {
    ...
    public struct AppBlock: Swift.Equatable {
        ...
        /// This member is required.
        var setupScriptDetails: AppStreamClientTypes.ScriptDetails?
        /// The source S3 location of the app block.
        var sourceS3Location: AppStreamClientTypes.S3Location?
...
extension AppStreamClientTypes {
    ...
    public struct Application: Swift.Equatable {
        ...
        var iconS3Location: AppStreamClientTypes.S3Location?
        /// The URL for the application icon. This URL might be time-limited.
        var iconURL: Swift.String?
        /// The instance families for the application.
        var instanceFamilies: [Swift.String]?
        /// The arguments that are passed to the application at launch.
        var launchParameters: Swift.String?
        /// The path to the application executable in the instance.
        var launchPath: Swift.String?
        /// Additional attributes that describe the application.
        var metadata: [Swift.String:Swift.String]?
        /// The name of the application.
        var name: Swift.String?
        /// The platforms on which the application can run.
        var platforms: [AppStreamClientTypes.PlatformType]?
...
extension AppStreamClientTypes {
    ...
    public struct ApplicationFleetAssociation: Swift.Equatable {
        ...
        /// This member is required.
        var applicationArn: Swift.String?
        /// The name of the fleet associated with the application.
        /// This member is required.
        var fleetName: Swift.String?
...
extension AppStreamClientTypes {
    ...
    public struct ApplicationSettings: Swift.Equatable {
        ...
        var settingsGroup: Swift.String?
...
public struct AssociateApplicationFleetOutputResponse: Swift.Equatable {
    ...
    var applicationFleetAssociation: AppStreamClientTypes.ApplicationFleetAssociation?
...
public struct BatchAssociateUserStackInput: Swift.Equatable {
    ...
    /// This member is required.
    var userStackAssociations: [AppStreamClientTypes.UserStackAssociation]?
...
public struct BatchAssociateUserStackOutputResponse: Swift.Equatable {
    ...
    var errors: [AppStreamClientTypes.UserStackAssociationError]?
...
extension AppStreamClientTypes {
    ...
    public struct ComputeCapacity: Swift.Equatable {
        ...
        /// This member is required.
        var desiredInstances: Swift.Int?
...
extension AppStreamClientTypes {
    ...
    public struct ComputeCapacityStatus: Swift.Equatable {
        ...
        /// The desired number of streaming instances.
        /// This member is required.
        var desired: Swift.Int?
        /// The number of instances in use for streaming.
        var inUse: Swift.Int?
        /// The total number of simultaneous streaming instances that are running.
        var running: Swift.Int?
...
public struct CopyImageInput: Swift.Equatable {
    ...
    var destinationImageDescription: Swift.String?
    /// The name that the image will have when it is copied to the destination.
    /// This member is required.
    var destinationImageName: Swift.String?
    /// The destination region to which the image will be copied. This parameter is required, even if you are copying an image within the same region.
    /// This member is required.
    var destinationRegion: Swift.String?
    /// The name of the image to copy.
    /// This member is required.
    var sourceImageName: Swift.String?
...
public struct CreateAppBlockOutputResponse: Swift.Equatable {
    /// The app block.
    var appBlock: AppStreamClientTypes.AppBlock?
...
public struct CreateApplicationOutputResponse: Swift.Equatable {
    /// Describes an application in the application catalog.
    var application: AppStreamClientTypes.Application?
...
public struct CreateDirectoryConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var directoryName: Swift.String?
    /// The distinguished names of the organizational units for computer accounts.
    /// This member is required.
    var organizationalUnitDistinguishedNames: [Swift.String]?
    /// The credentials for the service account used by the fleet or image builder to connect to the directory.
    var serviceAccountCredentials: AppStreamClientTypes.ServiceAccountCredentials?
...
public struct CreateDirectoryConfigOutputResponse: Swift.Equatable {
    ...
    var directoryConfig: AppStreamClientTypes.DirectoryConfig?
...
public struct CreateFleetInput: Swift.Equatable {
    ...
    var computeCapacity: AppStreamClientTypes.ComputeCapacity?
    ...
    var disconnectTimeoutInSeconds: Swift.Int?
    /// The fleet name to display.
    var displayName: Swift.String?
    /// The name of the directory and organizational unit (OU) to use to join the fleet to a Microsoft Active Directory domain. This is not allowed for Elastic fleets.
    var domainJoinInfo: AppStreamClientTypes.DomainJoinInfo?
    /// Enables or disables default internet access for the fleet.
    var enableDefaultInternetAccess: Swift.Bool?
    /// The fleet type. ALWAYS_ON Provides users with instant-on access to their apps. You are charged for all running instances in your fleet, even if no users are streaming apps. ON_DEMAND Provide users with access to applications after they connect, which takes one to two minutes. You are charged for instance streaming when users are connected and a small hourly fee for instances that are not streaming apps.
    var fleetType: AppStreamClientTypes.FleetType?
    ...
    var idleDisconnectTimeoutInSeconds: Swift.Int?
    /// The ARN of the public, private, or shared image to use.
    var imageArn: Swift.String?
    ...
    var streamView: AppStreamClientTypes.StreamView?
    ...
    var usbDeviceFilterStrings: [Swift.String]?
    /// The VPC configuration for the fleet. This is required for Elastic fleets, but not required for other fleet types. Elastic fleets require that you specify at least two subnets in different availability zones.
    var vpcConfig: AppStreamClientTypes.VpcConfig?
...
public struct CreateFleetOutputResponse: Swift.Equatable {
    ...
    var fleet: AppStreamClientTypes.Fleet?
...
public struct CreateImageBuilderInput: Swift.Equatable {
    ...
    var accessEndpoints: [AppStreamClientTypes.AccessEndpoint]?
    /// The version of the AppStream 2.0 agent to use for this image builder. To use the latest version of the AppStream 2.0 agent, specify [LATEST].
    var appstreamAgentVersion: Swift.String?
    /// The description to display.
    var description: Swift.String?
...
public struct CreateImageBuilderOutputResponse: Swift.Equatable {
    ...
    var imageBuilder: AppStreamClientTypes.ImageBuilder?
...
public struct CreateImageBuilderStreamingURLOutputResponse: Swift.Equatable {
    ...
    var expires: ClientRuntime.Date?
    /// The URL to start the AppStream 2.0 streaming session.
    var streamingURL: Swift.String?
...
public struct CreateStackInput: Swift.Equatable {
    ...
    var applicationSettings: AppStreamClientTypes.ApplicationSettings?
    /// The description to display.
    var description: Swift.String?
    /// The stack name to display.
    var displayName: Swift.String?
    /// The domains where AppStream 2.0 streaming sessions can be embedded in an iframe. You must approve the domains that you want to host embedded AppStream 2.0 streaming sessions.
    var embedHostDomains: [Swift.String]?
    /// The URL that users are redirected to after they click the Send Feedback link. If no URL is specified, no Send Feedback link is displayed.
    var feedbackURL: Swift.String?
    /// The name of the stack.
    /// This member is required.
    var name: Swift.String?
    /// The URL that users are redirected to after their streaming session ends.
    var redirectURL: Swift.String?
    /// The storage connectors to enable.
    var storageConnectors: [AppStreamClientTypes.StorageConnector]?
    ...
    var userSettings: [AppStreamClientTypes.UserSetting]?
...
public struct CreateStackOutputResponse: Swift.Equatable {
    ...
    var stack: AppStreamClientTypes.Stack?
...
public struct CreateStreamingURLInput: Swift.Equatable {
    ...
    var applicationId: Swift.String?
    /// The name of the fleet.
    /// This member is required.
    var fleetName: Swift.String?
    ...
    var sessionContext: Swift.String?
    /// The name of the stack.
    /// This member is required.
    var stackName: Swift.String?
...
public struct CreateUpdatedImageInput: Swift.Equatable {
    ...
    var dryRun: Swift.Bool
    /// The name of the image to update.
    /// This member is required.
    var existingImageName: Swift.String?
    /// The description to display for the new image.
    var newImageDescription: Swift.String?
    /// The name to display for the new image.
    var newImageDisplayName: Swift.String?
    /// The name of the new image. The name must be unique within the AWS account and Region.
    /// This member is required.
    var newImageName: Swift.String?
    ...
    var newImageTags: [Swift.String:Swift.String]?
...
public struct CreateUpdatedImageOutputResponse: Swift.Equatable {
    ...
    var canUpdateImage: Swift.Bool
    /// Describes an image.
    var image: AppStreamClientTypes.Image?
...
public struct CreateUsageReportSubscriptionOutputResponse: Swift.Equatable {
    ...
    var schedule: AppStreamClientTypes.UsageReportSchedule?
...
public struct CreateUserInput: Swift.Equatable {
    ...
    /// This member is required.
    var authenticationType: AppStreamClientTypes.AuthenticationType?
    ...
    var messageAction: AppStreamClientTypes.MessageAction?
...
public struct DeleteImagePermissionsInput: Swift.Equatable {
    ...
    /// This member is required.
    var sharedAccountId: Swift.String?
...
public struct DescribeAppBlocksOutputResponse: Swift.Equatable {
    ...
    var appBlocks: [AppStreamClientTypes.AppBlock]?
    /// The pagination token used to retrieve the next page of results for this operation.
    var nextToken: Swift.String?
...
public struct DescribeApplicationFleetAssociationsOutputResponse: Swift.Equatable {
    ...
    var applicationFleetAssociations: [AppStreamClientTypes.ApplicationFleetAssociation]?
    /// The pagination token used to retrieve the next page of results for this operation.
    var nextToken: Swift.String?
...
public struct DescribeApplicationsOutputResponse: Swift.Equatable {
    ...
    var applications: [AppStreamClientTypes.Application]?
    /// The pagination token used to retrieve the next page of results for this operation.
    var nextToken: Swift.String?
...
public struct DescribeDirectoryConfigsInput: Swift.Equatable {
    /// The directory names.
    var directoryNames: [Swift.String]?
    /// The maximum size of each page of results.
    var maxResults: Swift.Int?
...
public struct DescribeDirectoryConfigsOutputResponse: Swift.Equatable {
    ...
    var directoryConfigs: [AppStreamClientTypes.DirectoryConfig]?
...
public struct DescribeFleetsOutputResponse: Swift.Equatable {
    ...
    var fleets: [AppStreamClientTypes.Fleet]?
    /// The pagination token to use to retrieve the next page of results for this operation. If there are no more pages, this value is null.
    var nextToken: Swift.String?
...
public struct DescribeImageBuildersOutputResponse: Swift.Equatable {
    ...
    var imageBuilders: [AppStreamClientTypes.ImageBuilder]?
    /// The pagination token to use to retrieve the next page of results for this operation. If there are no more pages, this value is null.
    var nextToken: Swift.String?
...
public struct DescribeImagePermissionsInput: Swift.Equatable {
    ...
    var sharedAwsAccountIds: [Swift.String]?
...
public struct DescribeImagePermissionsOutputResponse: Swift.Equatable {
    ...
    var sharedImagePermissionsList: [AppStreamClientTypes.SharedImagePermissions]?
...
public struct DescribeImagesInput: Swift.Equatable {
    ...
    var type: AppStreamClientTypes.VisibilityType?
...
public struct DescribeImagesOutputResponse: Swift.Equatable {
    ...
    var images: [AppStreamClientTypes.Image]?
    /// The pagination token to use to retrieve the next page of results for this operation. If there are no more pages, this value is null.
    var nextToken: Swift.String?
...
public struct DescribeSessionsOutputResponse: Swift.Equatable {
    ...
    var sessions: [AppStreamClientTypes.Session]?
...
public struct DescribeStacksOutputResponse: Swift.Equatable {
    ...
    var stacks: [AppStreamClientTypes.Stack]?
...
public struct DescribeUsageReportSubscriptionsOutputResponse: Swift.Equatable {
    ...
    var usageReportSubscriptions: [AppStreamClientTypes.UsageReportSubscription]?
...
public struct DescribeUsersOutputResponse: Swift.Equatable {
    ...
    var users: [AppStreamClientTypes.User]?
...
extension AppStreamClientTypes {
    ...
    public struct DomainJoinInfo: Swift.Equatable {
        ...
        var organizationalUnitDistinguishedName: Swift.String?
...
extension AppStreamClientTypes {
    ...
    public struct Fleet: Swift.Equatable {
        ...
        /// This member is required.
        var computeCapacityStatus: AppStreamClientTypes.ComputeCapacityStatus?
        ...
        var enableDefaultInternetAccess: Swift.Bool?
        /// The fleet errors.
        var fleetErrors: [AppStreamClientTypes.FleetError]?
        /// The fleet type. ALWAYS_ON Provides users with instant-on access to their apps. You are charged for all running instances in your fleet, even if no users are streaming apps. ON_DEMAND Provide users with access to applications after they connect, which takes one to two minutes. You are charged for instance streaming when users are connected and a small hourly fee for instances that are not streaming apps.
        var fleetType: AppStreamClientTypes.FleetType?
        ...
        /// This member is required.
        var state: AppStreamClientTypes.FleetState?
        /// The AppStream 2.0 view that is displayed to your users when they stream from the fleet. When APP is specified, only the windows of applications opened by users display. When DESKTOP is specified, the standard desktop that is provided by the operating system displays. The default value is APP.
        var streamView: AppStreamClientTypes.StreamView?
...
extension AppStreamClientTypes {
    ...
    public struct FleetError: Swift.Equatable {
        /// The error code.
        var errorCode: AppStreamClientTypes.FleetErrorCode?
        /// The error message.
...
extension AppStreamClientTypes {
    ...
    public struct Image: Swift.Equatable {
        ...
        var imageBuilderName: Swift.String?
        /// Indicates whether an image builder can be launched from this image.
        var imageBuilderSupported: Swift.Bool
        /// Describes the errors that are returned when a new image can't be created.
        var imageErrors: [AppStreamClientTypes.ResourceError]?
        /// The permissions to provide to the destination AWS account for the specified image.
        var imagePermissions: AppStreamClientTypes.ImagePermissions?
        /// The name of the image.
        /// This member is required.
        var name: Swift.String?
        ...
        var publicBaseImageReleasedDate: ClientRuntime.Date?
        /// The image starts in the PENDING state. If image creation succeeds, the state is AVAILABLE. If image creation fails, the state is FAILED.
        var state: AppStreamClientTypes.ImageState?
        /// The reason why the last state change occurred.
        var stateChangeReason: AppStreamClientTypes.ImageStateChangeReason?
        /// Indicates whether the image is public or private.
        var visibility: AppStreamClientTypes.VisibilityType?
...
extension AppStreamClientTypes {
    ...
    public struct ImageBuilder: Swift.Equatable {
        ...
        var imageBuilderErrors: [AppStreamClientTypes.ResourceError]?
        ...
        var networkAccessConfiguration: AppStreamClientTypes.NetworkAccessConfiguration?
        /// The operating system platform of the image builder.
        var platform: AppStreamClientTypes.PlatformType?
        /// The state of the image builder.
        var state: AppStreamClientTypes.ImageBuilderState?
        /// The reason why the last state change occurred.
        var stateChangeReason: AppStreamClientTypes.ImageBuilderStateChangeReason?
...
extension AppStreamClientTypes {
    ...
    public struct ImageBuilderStateChangeReason: Swift.Equatable {
        ...
        var code: AppStreamClientTypes.ImageBuilderStateChangeReasonCode?
...
extension AppStreamClientTypes {
    ...
    public struct ImagePermissions: Swift.Equatable {
        ...
        var allowFleet: Swift.Bool?
        /// Indicates whether the image can be used for an image builder.
        var allowImageBuilder: Swift.Bool?
...
extension AppStreamClientTypes {
    ...
    public struct ImageStateChangeReason: Swift.Equatable {
        /// The state change reason code.
        var code: AppStreamClientTypes.ImageStateChangeReasonCode?
        /// The state change reason message.
        var message: Swift.String?
...
extension AppStreamClientTypes {
    ...
    public struct LastReportGenerationExecutionError: Swift.Equatable {
        ...
        var errorCode: AppStreamClientTypes.UsageReportExecutionErrorCode?
...
extension AppStreamClientTypes {
    ...
    public struct NetworkAccessConfiguration: Swift.Equatable {
        ...
        var eniId: Swift.String?
        /// The private IP address of the elastic network interface that is attached to instances in your VPC.
        var eniPrivateIpAddress: Swift.String?
...
extension AppStreamClientTypes {
    ...
    public struct ResourceError: Swift.Equatable {
        ...
        var errorTimestamp: ClientRuntime.Date?
...
extension AppStreamClientTypes {
    ...
    public struct S3Location: Swift.Equatable {
        ...
        /// This member is required.
        var s3Bucket: Swift.String?
        /// The S3 key of the S3 object.
        /// This member is required.
        var s3Key: Swift.String?
...
extension AppStreamClientTypes {
    ...
    public struct ScriptDetails: Swift.Equatable {
        ...
        var executableParameters: Swift.String?
        /// The run path for the script.
        /// This member is required.
        var executablePath: Swift.String?
        /// The S3 object location for the script.
        /// This member is required.
        var scriptS3Location: AppStreamClientTypes.S3Location?
        /// The run timeout, in seconds, for the script.
        /// This member is required.
        var timeoutInSeconds: Swift.Int?
...
extension AppStreamClientTypes {
    ...
    public struct ServiceAccountCredentials: Swift.Equatable {
        ...
        /// This member is required.
        var accountName: Swift.String?
        /// The password for the account.
        /// This member is required.
        var accountPassword: Swift.String?
...
extension AppStreamClientTypes {
    ...
    public struct Session: Swift.Equatable {
        ...
        var connectionState: AppStreamClientTypes.SessionConnectionState?
        ...
        var maxExpirationTime: ClientRuntime.Date?
        ...
        /// This member is required.
        var state: AppStreamClientTypes.SessionState?
...
extension AppStreamClientTypes {
    ...
    public struct Stack: Swift.Equatable {
        ...
        var applicationSettings: AppStreamClientTypes.ApplicationSettingsResponse?
        ...
        var stackErrors: [AppStreamClientTypes.StackError]?
        /// The storage connectors to enable.
        var storageConnectors: [AppStreamClientTypes.StorageConnector]?
        /// The actions that are enabled or disabled for users during their streaming sessions. By default these actions are enabled.
        var userSettings: [AppStreamClientTypes.UserSetting]?
...
extension AppStreamClientTypes {
    ...
    public struct StackError: Swift.Equatable {
        /// The error code.
        var errorCode: AppStreamClientTypes.StackErrorCode?
        /// The error message.
        var errorMessage: Swift.String?
...
extension AppStreamClientTypes {
    ...
    public struct StorageConnector: Swift.Equatable {
        ...
        /// This member is required.
        var connectorType: AppStreamClientTypes.StorageConnectorType?
        /// The names of the domains for the account.
        var domains: [Swift.String]?
...
public struct UpdateApplicationInput: Swift.Equatable {
    ...
    var attributesToDelete: [AppStreamClientTypes.ApplicationAttribute]?
    /// The description of the application.
    var description: Swift.String?
    /// The display name of the application. This name is visible to users in the application catalog.
    var displayName: Swift.String?
...
public struct UpdateFleetInput: Swift.Equatable {
    ...
    var attributesToDelete: [AppStreamClientTypes.FleetAttribute]?
    /// The desired capacity for the fleet. This is not allowed for Elastic fleets.
    var computeCapacity: AppStreamClientTypes.ComputeCapacity?
    /// Deletes the VPC association for the specified fleet.
    @available(*, deprecated)
    var deleteVpcConfig: Swift.Bool
    /// The description to display.
    var description: Swift.String?
    /// The amount of time that a streaming session remains active after users disconnect. If users try to reconnect to the streaming session after a disconnection or network interruption within this time interval, they are connected to their previous session. Otherwise, they are connected to a new session with a new streaming instance. Specify a value between 60 and 360000.
    var disconnectTimeoutInSeconds: Swift.Int?
...
public struct UpdateStackInput: Swift.Equatable {
    ...
    var attributesToDelete: [AppStreamClientTypes.StackAttribute]?
    /// Deletes the storage connectors currently enabled for the stack.
    @available(*, deprecated)
    var deleteStorageConnectors: Swift.Bool
    /// The description to display.
    var description: Swift.String?
    /// The stack name to display.
    var displayName: Swift.String?
...
extension AppStreamClientTypes {
    ...
    public struct UsageReportSubscription: Swift.Equatable {
        ...
        var lastGeneratedReportDate: ClientRuntime.Date?
        /// The Amazon S3 bucket where generated reports are stored. If you enabled on-instance session scripts and Amazon S3 logging for your session script configuration, AppStream 2.0 created an S3 bucket to store the script output. The bucket is unique to your account and Region. When you enable usage reporting in this case, AppStream 2.0 uses the same bucket to store your usage reports. If you haven't already enabled on-instance session scripts, when you enable usage reports, AppStream 2.0 creates a new S3 bucket.
        var s3BucketName: Swift.String?
        /// The schedule for generating usage reports.
        var schedule: AppStreamClientTypes.UsageReportSchedule?
        /// The errors that were returned if usage reports couldn't be generated.
        var subscriptionErrors: [AppStreamClientTypes.LastReportGenerationExecutionError]?
...
extension AppStreamClientTypes {
    ...
    public struct UserSetting: Swift.Equatable {
        ...
        /// This member is required.
        var action: AppStreamClientTypes.Action?
        /// Indicates whether the action is enabled or disabled.
        /// This member is required.
        var permission: AppStreamClientTypes.Permission?
...
extension AppStreamClientTypes {
    ...
    public struct UserStackAssociation: Swift.Equatable {
        ...
        var sendEmailNotification: Swift.Bool
        /// The name of the stack that is associated with the user.
        /// This member is required.
        var stackName: Swift.String?
        /// The email address of the user who is associated with the stack. Users' email addresses are case-sensitive.
...
extension AppStreamClientTypes {
    ...
    public struct UserStackAssociationError: Swift.Equatable {
        ...
        var errorCode: AppStreamClientTypes.UserStackAssociationErrorCode?
        /// The error message for the error that is returned when a user can’t be associated with or disassociated from a stack.
        var errorMessage: Swift.String?
        /// Information about the user and associated stack.
        var userStackAssociation: AppStreamClientTypes.UserStackAssociation?
