...
extension AppStreamClientTypes.AppBlock: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
...
extension AppStreamClientTypes.AppBlock: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AppBlock(arn: \(Swift.String(describing: arn)), createdTime: \(Swift.String(describing: createdTime)), description: \(Swift.String(describing: description)), displayName: \(Swift.String(describing: displayName)), name: \(Swift.String(describing: name)), setupScriptDetails: \(Swift.String(describing: setupScriptDetails)), sourceS3Location: \(Swift.String(describing: sourceS3Location)))"}
}
...
extension AppStreamClientTypes.Application: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Application(appBlockArn: \(Swift.String(describing: appBlockArn)), arn: \(Swift.String(describing: arn)), createdTime: \(Swift.String(describing: createdTime)), description: \(Swift.String(describing: description)), displayName: \(Swift.String(describing: displayName)), enabled: \(Swift.String(describing: enabled)), iconS3Location: \(Swift.String(describing: iconS3Location)), iconURL: \(Swift.String(describing: iconURL)), instanceFamilies: \(Swift.String(describing: instanceFamilies)), launchParameters: \(Swift.String(describing: launchParameters)), launchPath: \(Swift.String(describing: launchPath)), metadata: \(Swift.String(describing: metadata)), name: \(Swift.String(describing: name)), platforms: \(Swift.String(describing: platforms)), workingDirectory: \(Swift.String(describing: workingDirectory)))"}
}
...
extension AppStreamClientTypes.ApplicationFleetAssociation: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension AppStreamClientTypes.ApplicationFleetAssociation: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ApplicationFleetAssociation(applicationArn: \(Swift.String(describing: applicationArn)), fleetName: \(Swift.String(describing: fleetName)))"}
}
...
extension AssociateApplicationFleetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssociateApplicationFleetInput(applicationArn: \(Swift.String(describing: applicationArn)), fleetName: \(Swift.String(describing: fleetName)))"}
}

extension AssociateApplicationFleetInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case applicationArn = "ApplicationArn"
        case fleetName = "FleetName"
    }
...
extension AssociateApplicationFleetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssociateApplicationFleetOutputResponse(applicationFleetAssociation: \(Swift.String(describing: applicationFleetAssociation)))"}
}
...
struct AssociateApplicationFleetOutputResponseBody: Swift.Equatable {
    public let applicationFleetAssociation: AppStreamClientTypes.ApplicationFleetAssociation?
}
...
extension CreateAppBlockInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAppBlockInput(description: \(Swift.String(describing: description)), displayName: \(Swift.String(describing: displayName)), name: \(Swift.String(describing: name)), setupScriptDetails: \(Swift.String(describing: setupScriptDetails)), sourceS3Location: \(Swift.String(describing: sourceS3Location)), tags: \(Swift.String(describing: tags)))"}
}

extension CreateAppBlockInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case description = "Description"
        case displayName = "DisplayName"
        case name = "Name"
...
struct CreateAppBlockInputBody: Swift.Equatable {
    ...
    public let sourceS3Location: AppStreamClientTypes.S3Location?
    public let setupScriptDetails: AppStreamClientTypes.ScriptDetails?
...
extension CreateAppBlockOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAppBlockOutputResponse(appBlock: \(Swift.String(describing: appBlock)))"}
}
...
struct CreateAppBlockOutputResponseBody: Swift.Equatable {
    public let appBlock: AppStreamClientTypes.AppBlock?
}
...
extension CreateApplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateApplicationInput(appBlockArn: \(Swift.String(describing: appBlockArn)), description: \(Swift.String(describing: description)), displayName: \(Swift.String(describing: displayName)), iconS3Location: \(Swift.String(describing: iconS3Location)), instanceFamilies: \(Swift.String(describing: instanceFamilies)), launchParameters: \(Swift.String(describing: launchParameters)), launchPath: \(Swift.String(describing: launchPath)), name: \(Swift.String(describing: name)), platforms: \(Swift.String(describing: platforms)), tags: \(Swift.String(describing: tags)), workingDirectory: \(Swift.String(describing: workingDirectory)))"}
}
...
struct CreateApplicationInputBody: Swift.Equatable {
    ...
    public let displayName: Swift.String?
    public let description: Swift.String?
    public let iconS3Location: AppStreamClientTypes.S3Location?
    public let launchPath: Swift.String?
    public let workingDirectory: Swift.String?
    public let launchParameters: Swift.String?
    public let platforms: [AppStreamClientTypes.PlatformType]?
    public let instanceFamilies: [Swift.String]?
    public let appBlockArn: Swift.String?
    public let tags: [Swift.String:Swift.String]?
}
...
struct CreateApplicationOutputResponseBody: Swift.Equatable {
    public let application: AppStreamClientTypes.Application?
}
...
struct CreateFleetInputBody: Swift.Equatable {
    ...
    public let maxConcurrentSessions: Swift.Int?
    public let usbDeviceFilterStrings: [Swift.String]?
}
...
extension DeleteAppBlockInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteAppBlockInput(name: \(Swift.String(describing: name)))"}
}

extension DeleteAppBlockInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "Name"
    }
...
extension DeleteAppBlockOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteAppBlockOutputResponse()"}
}
...
struct DeleteAppBlockOutputResponseBody: Swift.Equatable {
}

extension DeleteAppBlockOutputResponseBody: Swift.Decodable {
...
extension DeleteApplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteApplicationInput(name: \(Swift.String(describing: name)))"}
}
...
extension DescribeAppBlocksInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAppBlocksInput(arns: \(Swift.String(describing: arns)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeAppBlocksInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arns = "Arns"
...
extension DescribeAppBlocksOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAppBlocksOutputResponse(appBlocks: \(Swift.String(describing: appBlocks)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct DescribeAppBlocksOutputResponseBody: Swift.Equatable {
    public let appBlocks: [AppStreamClientTypes.AppBlock]?
    public let nextToken: Swift.String?
}
...
extension DescribeApplicationFleetAssociationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeApplicationFleetAssociationsInput(applicationArn: \(Swift.String(describing: applicationArn)), fleetName: \(Swift.String(describing: fleetName)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeApplicationFleetAssociationsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case applicationArn = "ApplicationArn"
        case fleetName = "FleetName"
        case maxResults = "MaxResults"
...
extension DescribeApplicationFleetAssociationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeApplicationFleetAssociationsOutputResponse(applicationFleetAssociations: \(Swift.String(describing: applicationFleetAssociations)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct DescribeApplicationFleetAssociationsOutputResponseBody: Swift.Equatable {
    public let applicationFleetAssociations: [AppStreamClientTypes.ApplicationFleetAssociation]?
    public let nextToken: Swift.String?
}
...
extension DescribeApplicationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeApplicationsInput(arns: \(Swift.String(describing: arns)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeApplicationsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arns = "Arns"
        case maxResults = "MaxResults"
        case nextToken = "NextToken"
...
extension DescribeApplicationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeApplicationsOutputResponse(applications: \(Swift.String(describing: applications)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
extension DisassociateApplicationFleetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DisassociateApplicationFleetInput(applicationArn: \(Swift.String(describing: applicationArn)), fleetName: \(Swift.String(describing: fleetName)))"}
}

extension DisassociateApplicationFleetInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case applicationArn = "ApplicationArn"
        case fleetName = "FleetName"
    }
...
extension DisassociateApplicationFleetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DisassociateApplicationFleetOutputResponse()"}
}
...
struct DisassociateApplicationFleetOutputResponseBody: Swift.Equatable {
}

extension DisassociateApplicationFleetOutputResponseBody: Swift.Decodable {
...
extension AppStreamClientTypes.S3Location: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension AppStreamClientTypes.S3Location: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "S3Location(s3Bucket: \(Swift.String(describing: s3Bucket)), s3Key: \(Swift.String(describing: s3Key)))"}
}
...
extension AppStreamClientTypes.ScriptDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension AppStreamClientTypes.ScriptDetails: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ScriptDetails(executableParameters: \(Swift.String(describing: executableParameters)), executablePath: \(Swift.String(describing: executablePath)), scriptS3Location: \(Swift.String(describing: scriptS3Location)), timeoutInSeconds: \(Swift.String(describing: timeoutInSeconds)))"}
}
...
extension UpdateApplicationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateApplicationInput(appBlockArn: \(Swift.String(describing: appBlockArn)), attributesToDelete: \(Swift.String(describing: attributesToDelete)), description: \(Swift.String(describing: description)), displayName: \(Swift.String(describing: displayName)), iconS3Location: \(Swift.String(describing: iconS3Location)), launchParameters: \(Swift.String(describing: launchParameters)), launchPath: \(Swift.String(describing: launchPath)), name: \(Swift.String(describing: name)), workingDirectory: \(Swift.String(describing: workingDirectory)))"}
}
...
struct UpdateApplicationInputBody: Swift.Equatable {
    ...
    public let launchParameters: Swift.String?
    public let appBlockArn: Swift.String?
    public let attributesToDelete: [AppStreamClientTypes.ApplicationAttribute]?
}
