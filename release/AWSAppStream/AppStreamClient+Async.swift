...
public extension AppStreamClient {
    ...
    {
        typealias associateApplicationFleetContinuation = CheckedContinuation<AssociateApplicationFleetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: associateApplicationFleetContinuation) in
            associateApplicationFleet(input: input) { result in
                switch result {
    ...
    {
        typealias createAppBlockContinuation = CheckedContinuation<CreateAppBlockOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createAppBlockContinuation) in
            createAppBlock(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteAppBlockContinuation = CheckedContinuation<DeleteAppBlockOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteAppBlockContinuation) in
            deleteAppBlock(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeAppBlocksContinuation = CheckedContinuation<DescribeAppBlocksOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAppBlocksContinuation) in
            describeAppBlocks(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeApplicationFleetAssociationsContinuation = CheckedContinuation<DescribeApplicationFleetAssociationsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeApplicationFleetAssociationsContinuation) in
            describeApplicationFleetAssociations(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias disassociateApplicationFleetContinuation = CheckedContinuation<DisassociateApplicationFleetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: disassociateApplicationFleetContinuation) in
            disassociateApplicationFleet(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
