...
extension ElasticLoadBalancingClientTypes {
    ...
    public struct AccessLog: Swift.Equatable {
        ...
        var s3BucketPrefix: Swift.String?
...
public struct AddTagsInput: Swift.Equatable {
    ...
    /// The tags.
    /// This member is required.
    var tags: [ElasticLoadBalancingClientTypes.Tag]?
...
public struct ConfigureHealthCheckInput: Swift.Equatable {
    ...
    /// This member is required.
    var healthCheck: ElasticLoadBalancingClientTypes.HealthCheck?
    /// The name of the load balancer.
    /// This member is required.
    var loadBalancerName: Swift.String?
...
public struct CreateLBCookieStickinessPolicyInput: Swift.Equatable {
    ...
    var cookieExpirationPeriod: Swift.Int?
    /// The name of the load balancer.
    /// This member is required.
    var loadBalancerName: Swift.String?
    /// The name of the policy being created. Policy names must consist of alphanumeric characters and dashes (-). This name must be unique within the set of policies for this load balancer.
...
public struct CreateLoadBalancerInput: Swift.Equatable {
    ...
    /// This member is required.
    var listeners: [ElasticLoadBalancingClientTypes.Listener]?
...
public struct CreateLoadBalancerPolicyInput: Swift.Equatable {
    ...
    var policyAttributes: [ElasticLoadBalancingClientTypes.PolicyAttribute]?
    /// The name of the load balancer policy to be created. This name must be unique within the set of policies for this load balancer.
    /// This member is required.
    var policyName: Swift.String?
    /// The name of the base policy type. To get the list of policy types, use [DescribeLoadBalancerPolicyTypes].
    /// This member is required.
    var policyTypeName: Swift.String?
...
public struct DeleteLoadBalancerListenersInput: Swift.Equatable {
    ...
    /// This member is required.
    var loadBalancerPorts: [Swift.Int]?
...
public struct DeregisterInstancesFromLoadBalancerInput: Swift.Equatable {
    ...
    /// This member is required.
    var instances: [ElasticLoadBalancingClientTypes.Instance]?
    /// The name of the load balancer.
    /// This member is required.
    var loadBalancerName: Swift.String?
...
public struct DescribeAccountLimitsOutputResponse: Swift.Equatable {
    ...
    var limits: [ElasticLoadBalancingClientTypes.Limit]?
...
public struct DescribeInstanceHealthOutputResponse: Swift.Equatable {
    ...
    var instanceStates: [ElasticLoadBalancingClientTypes.InstanceState]?
...
public struct DescribeLoadBalancerAttributesOutputResponse: Swift.Equatable {
    ...
    var loadBalancerAttributes: ElasticLoadBalancingClientTypes.LoadBalancerAttributes?
...
public struct DescribeLoadBalancerPoliciesOutputResponse: Swift.Equatable {
    ...
    var policyDescriptions: [ElasticLoadBalancingClientTypes.PolicyDescription]?
...
public struct DescribeLoadBalancerPolicyTypesInput: Swift.Equatable {
    ...
    var policyTypeNames: [Swift.String]?
...
public struct DescribeLoadBalancerPolicyTypesOutputResponse: Swift.Equatable {
    ...
    var policyTypeDescriptions: [ElasticLoadBalancingClientTypes.PolicyTypeDescription]?
...
public struct DescribeLoadBalancersOutputResponse: Swift.Equatable {
    ...
    var loadBalancerDescriptions: [ElasticLoadBalancingClientTypes.LoadBalancerDescription]?
    /// The marker to use when requesting the next set of results. If there are no additional results, the string is empty.
    var nextMarker: Swift.String?
...
public struct DescribeTagsOutputResponse: Swift.Equatable {
    ...
    var tagDescriptions: [ElasticLoadBalancingClientTypes.TagDescription]?
...
extension ElasticLoadBalancingClientTypes {
    ...
    public struct Listener: Swift.Equatable {
        ...
        var instanceProtocol: Swift.String?
        /// The port on which the load balancer is listening. On EC2-VPC, you can specify any port from the range 1-65535. On EC2-Classic, you can specify any port from the following list: 25, 80, 443, 465, 587, 1024-65535.
        /// This member is required.
        var loadBalancerPort: Swift.Int
        /// The Amazon Resource Name (ARN) of the server certificate.
        var sSLCertificateId: Swift.String?
...
extension ElasticLoadBalancingClientTypes {
    ...
    public struct ListenerDescription: Swift.Equatable {
        /// The listener.
        var listener: ElasticLoadBalancingClientTypes.Listener?
...
extension ElasticLoadBalancingClientTypes {
    ...
    public struct LoadBalancerAttributes: Swift.Equatable {
        ...
        var accessLog: ElasticLoadBalancingClientTypes.AccessLog?
        /// Any additional attributes.
        var additionalAttributes: [ElasticLoadBalancingClientTypes.AdditionalAttribute]?
        ...
        var connectionDraining: ElasticLoadBalancingClientTypes.ConnectionDraining?
        ...
        var connectionSettings: ElasticLoadBalancingClientTypes.ConnectionSettings?
        ...
        var crossZoneLoadBalancing: ElasticLoadBalancingClientTypes.CrossZoneLoadBalancing?
...
extension ElasticLoadBalancingClientTypes {
    ...
    public struct LoadBalancerDescription: Swift.Equatable {
        ...
        var backendServerDescriptions: [ElasticLoadBalancingClientTypes.BackendServerDescription]?
        ...
        var canonicalHostedZoneName: Swift.String?
        /// The ID of the Amazon Route 53 hosted zone for the load balancer.
        var canonicalHostedZoneNameID: Swift.String?
        ...
        var listenerDescriptions: [ElasticLoadBalancingClientTypes.ListenerDescription]?
        /// The name of the load balancer.
        var loadBalancerName: Swift.String?
        /// The policies defined for the load balancer.
        var policies: ElasticLoadBalancingClientTypes.Policies?
        ...
        var sourceSecurityGroup: ElasticLoadBalancingClientTypes.SourceSecurityGroup?
...
extension ElasticLoadBalancingClientTypes {
    ...
    public struct Policies: Swift.Equatable {
        ...
        var appCookieStickinessPolicies: [ElasticLoadBalancingClientTypes.AppCookieStickinessPolicy]?
        /// The stickiness policies created using [CreateLBCookieStickinessPolicy].
        var lBCookieStickinessPolicies: [ElasticLoadBalancingClientTypes.LBCookieStickinessPolicy]?
        /// The policies other than the stickiness policies.
        var otherPolicies: [Swift.String]?
...
extension ElasticLoadBalancingClientTypes {
    ...
    public struct PolicyAttributeTypeDescription: Swift.Equatable {
        ...
        var attributeType: Swift.String?
...
extension ElasticLoadBalancingClientTypes {
    ...
    public struct PolicyDescription: Swift.Equatable {
        /// The policy attributes.
        var policyAttributeDescriptions: [ElasticLoadBalancingClientTypes.PolicyAttributeDescription]?
        /// The name of the policy.
        var policyName: Swift.String?
...
extension ElasticLoadBalancingClientTypes {
    ...
    public struct PolicyTypeDescription: Swift.Equatable {
        ...
        var policyAttributeTypeDescriptions: [ElasticLoadBalancingClientTypes.PolicyAttributeTypeDescription]?
        /// The name of the policy type.
        var policyTypeName: Swift.String?
...
public struct RemoveTagsInput: Swift.Equatable {
    ...
    /// This member is required.
    var tags: [ElasticLoadBalancingClientTypes.TagKeyOnly]?
