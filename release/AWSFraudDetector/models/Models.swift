...
public struct BatchCreateVariableInput: Swift.Equatable {
    ...
    var tags: [FraudDetectorClientTypes.Tag]?
    /// The list of variables for the batch create variable request.
    /// This member is required.
    var variableEntries: [FraudDetectorClientTypes.VariableEntry]?
...
public struct BatchCreateVariableOutputResponse: Swift.Equatable {
    ...
    var errors: [FraudDetectorClientTypes.BatchCreateVariableError]?
...
public struct BatchGetVariableOutputResponse: Swift.Equatable {
    ...
    var errors: [FraudDetectorClientTypes.BatchGetVariableError]?
    /// The returned variables.
    var variables: [FraudDetectorClientTypes.Variable]?
...
extension FraudDetectorClientTypes {
    ...
    public struct BatchImport: Swift.Equatable {
        ...
        var completionTime: Swift.String?
        /// The name of the event type.
        var eventTypeName: Swift.String?
        /// The number of records that failed to import.
        var failedRecordsCount: Swift.Int?
        ...
        var outputPath: Swift.String?
        /// The number of records processed by batch import job.
        var processedRecordsCount: Swift.Int?
        /// Timestamp of when the batch import job started.
        var startTime: Swift.String?
        /// The status of the batch import job.
        var status: FraudDetectorClientTypes.AsyncJobStatus?
        /// The total number of records in the batch import job.
        var totalRecordsCount: Swift.Int?
...
extension FraudDetectorClientTypes {
    ...
    public struct BatchPrediction: Swift.Equatable {
        ...
        var detectorName: Swift.String?
        /// The detector version.
        var detectorVersion: Swift.String?
        /// The name of the event type.
        var eventTypeName: Swift.String?
        ...
        var lastHeartbeatTime: Swift.String?
        /// The Amazon S3 location of your output file.
        var outputPath: Swift.String?
...
public struct CreateDetectorVersionInput: Swift.Equatable {
    ...
    /// This member is required.
    var detectorId: Swift.String?
    /// The Amazon Sagemaker model endpoints to include in the detector version.
    var externalModelEndpoints: [Swift.String]?
    /// The model versions to include in the detector version.
    var modelVersions: [FraudDetectorClientTypes.ModelVersion]?
    ...
    var ruleExecutionMode: FraudDetectorClientTypes.RuleExecutionMode?
    /// The rules to include in the detector version.
    /// This member is required.
    var rules: [FraudDetectorClientTypes.Rule]?
    /// A collection of key and value pairs.
    var tags: [FraudDetectorClientTypes.Tag]?
...
public struct CreateDetectorVersionOutputResponse: Swift.Equatable {
    ...
    var detectorVersionId: Swift.String?
    /// The status of the detector version.
    var status: FraudDetectorClientTypes.DetectorVersionStatus?
...
public struct CreateModelInput: Swift.Equatable {
    ...
    /// The model type.
    /// This member is required.
    var modelType: FraudDetectorClientTypes.ModelTypeEnum?
    /// A collection of key and value pairs.
    var tags: [FraudDetectorClientTypes.Tag]?
...
public struct CreateModelVersionInput: Swift.Equatable {
    ...
    var externalEventsDetail: FraudDetectorClientTypes.ExternalEventsDetail?
    /// Details of the ingested events data used for model version training. Required if trainingDataSource is INGESTED_EVENTS.
    var ingestedEventsDetail: FraudDetectorClientTypes.IngestedEventsDetail?
    /// The model ID.
    /// This member is required.
    var modelId: Swift.String?
    /// The model type.
    ...
    /// This member is required.
    var trainingDataSchema: FraudDetectorClientTypes.TrainingDataSchema?
    /// The training data source location in Amazon S3.
    /// This member is required.
    var trainingDataSource: FraudDetectorClientTypes.TrainingDataSourceEnum?
...
public struct CreateModelVersionOutputResponse: Swift.Equatable {
    ...
    var modelVersionNumber: Swift.String?
...
public struct CreateRuleInput: Swift.Equatable {
    ...
    /// This member is required.
    var language: FraudDetectorClientTypes.Language?
    /// The outcome or outcomes returned when the rule expression matches.
    /// This member is required.
    var outcomes: [Swift.String]?
    /// The rule ID.
    /// This member is required.
...
public struct CreateRuleOutputResponse: Swift.Equatable {
    /// The created rule.
    var rule: FraudDetectorClientTypes.Rule?
...
public struct CreateVariableInput: Swift.Equatable {
    ...
    /// This member is required.
    var dataSource: FraudDetectorClientTypes.DataSource?
    /// The data type.
    /// This member is required.
    var dataType: FraudDetectorClientTypes.DataType?
...
extension FraudDetectorClientTypes {
    ...
    public struct DataValidationMetrics: Swift.Equatable {
        ...
        var fieldLevelMessages: [FraudDetectorClientTypes.FieldValidationMessage]?
        /// The file-specific model training validation messages.
        var fileLevelMessages: [FraudDetectorClientTypes.FileValidationMessage]?
...
public struct DeleteEventInput: Swift.Equatable {
    ...
    var deleteAuditHistory: Swift.Bool?
...
public struct DeleteEventsByEventTypeOutputResponse: Swift.Equatable {
    ...
    var eventsDeletionStatus: Swift.String?
...
public struct DeleteExternalModelInput: Swift.Equatable {
    ...
    /// This member is required.
    var modelEndpoint: Swift.String?
...
public struct DescribeDetectorOutputResponse: Swift.Equatable {
    ...
    var detectorVersionSummaries: [FraudDetectorClientTypes.DetectorVersionSummary]?
...
public struct DescribeModelVersionsOutputResponse: Swift.Equatable {
    ...
    var modelVersionDetails: [FraudDetectorClientTypes.ModelVersionDetail]?
    /// The next token.
    var nextToken: Swift.String?
...
extension FraudDetectorClientTypes {
    ...
    public struct Detector: Swift.Equatable {
        ...
        var lastUpdatedTime: Swift.String?
...
extension FraudDetectorClientTypes {
    ...
    public struct Event: Swift.Equatable {
        ...
        var currentLabel: Swift.String?
        /// The event entities.
        var entities: [FraudDetectorClientTypes.Entity]?
        /// The event ID.
        var eventId: Swift.String?
        /// The timestamp that defines when the event under evaluation occurred. The timestamp must be specified using ISO 8601 standard in UTC.
        var eventTimestamp: Swift.String?
        /// The event type.
        var eventTypeName: Swift.String?
        /// Names of the event type's variables you defined in Amazon Fraud Detector to represent data elements and their corresponding values for the event you are sending for evaluation.
        var eventVariables: [Swift.String:Swift.String]?
        /// The timestamp associated with the label to update. The timestamp must be specified using ISO 8601 standard in UTC.
        var labelTimestamp: Swift.String?
...
extension FraudDetectorClientTypes {
    ...
    public struct EventType: Swift.Equatable {
        ...
        var eventIngestion: FraudDetectorClientTypes.EventIngestion?
        /// The event type event variables.
        var eventVariables: [Swift.String]?
        /// Data about the stored events.
        var ingestedEventStatistics: FraudDetectorClientTypes.IngestedEventStatistics?
...
extension FraudDetectorClientTypes {
    ...
    public struct ExternalModel: Swift.Equatable {
        ...
        var inputConfiguration: FraudDetectorClientTypes.ModelInputConfiguration?
        /// The role used to invoke the model.
        var invokeModelEndpointRoleArn: Swift.String?
        /// Timestamp of when the model was last updated.
        var lastUpdatedTime: Swift.String?
        /// The Amazon SageMaker model endpoints.
        var modelEndpoint: Swift.String?
        /// The Amazon Fraud Detector status for the external model endpoint
        var modelEndpointStatus: FraudDetectorClientTypes.ModelEndpointStatus?
        /// The source of the model.
        var modelSource: FraudDetectorClientTypes.ModelSource?
        /// The output configuration.
        var outputConfiguration: FraudDetectorClientTypes.ModelOutputConfiguration?
...
extension FraudDetectorClientTypes {
    ...
    public struct ExternalModelOutputs: Swift.Equatable {
        /// The Amazon SageMaker model.
        var externalModel: FraudDetectorClientTypes.ExternalModelSummary?
        /// The fraud prediction scores from Amazon SageMaker model.
        var outputs: [Swift.String:Swift.String]?
...
public struct GetBatchImportJobsOutputResponse: Swift.Equatable {
    ...
    var batchImports: [FraudDetectorClientTypes.BatchImport]?
...
public struct GetBatchPredictionJobsOutputResponse: Swift.Equatable {
    ...
    var batchPredictions: [FraudDetectorClientTypes.BatchPrediction]?
...
public struct GetDeleteEventsByEventTypeStatusOutputResponse: Swift.Equatable {
    ...
    var eventTypeName: Swift.String?
    /// The deletion status.
    var eventsDeletionStatus: FraudDetectorClientTypes.AsyncJobStatus?
...
public struct GetDetectorsOutputResponse: Swift.Equatable {
    /// The detectors.
    var detectors: [FraudDetectorClientTypes.Detector]?
    /// The next page token.
    var nextToken: Swift.String?
...
public struct GetEntityTypesOutputResponse: Swift.Equatable {
    ...
    var entityTypes: [FraudDetectorClientTypes.EntityType]?
    /// The next page token.
    var nextToken: Swift.String?
...
public struct GetEventOutputResponse: Swift.Equatable {
    ...
    var event: FraudDetectorClientTypes.Event?
...
public struct GetEventPredictionInput: Swift.Equatable {
    ...
    var externalModelEndpointDataBlobs: [Swift.String:FraudDetectorClientTypes.ModelEndpointDataBlob]?
...
public struct GetEventPredictionOutputResponse: Swift.Equatable {
    ...
    var externalModelOutputs: [FraudDetectorClientTypes.ExternalModelOutputs]?
    /// The model scores. Amazon Fraud Detector generates model scores between 0 and 1000, where 0 is low fraud risk and 1000 is high fraud risk. Model scores are directly related to the false positive rate (FPR). For example, a score of 600 corresponds to an estimated 10% false positive rate whereas a score of 900 corresponds to an estimated 2% false positive rate.
    var modelScores: [FraudDetectorClientTypes.ModelScores]?
    /// The results from the rules.
    var ruleResults: [FraudDetectorClientTypes.RuleResult]?
...
public struct GetEventTypesOutputResponse: Swift.Equatable {
    ...
    var eventTypes: [FraudDetectorClientTypes.EventType]?
    /// The next page token.
    var nextToken: Swift.String?
...
public struct GetExternalModelsOutputResponse: Swift.Equatable {
    ...
    var externalModels: [FraudDetectorClientTypes.ExternalModel]?
...
public struct GetKMSEncryptionKeyOutputResponse: Swift.Equatable {
    ...
    var kmsKey: FraudDetectorClientTypes.KMSKey?
...
public struct GetLabelsOutputResponse: Swift.Equatable {
    /// An array of labels.
    var labels: [FraudDetectorClientTypes.Label]?
    /// The next page token.
    var nextToken: Swift.String?
...
public struct GetModelsOutputResponse: Swift.Equatable {
    /// The array of models.
    var models: [FraudDetectorClientTypes.Model]?
    /// The next page token to be used in subsequent requests.
    var nextToken: Swift.String?
...
public struct GetOutcomesOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// The outcomes.
    var outcomes: [FraudDetectorClientTypes.Outcome]?
...
public struct GetRulesOutputResponse: Swift.Equatable {
    ...
    var ruleDetails: [FraudDetectorClientTypes.RuleDetail]?
...
extension FraudDetectorClientTypes {
    ...
    public struct IngestedEventStatistics: Swift.Equatable {
        ...
        var eventDataSizeInBytes: Swift.Int?
        /// Timestamp of when the stored event was last updated.
        var lastUpdatedTime: Swift.String?
        /// The oldest stored event.
        var leastRecentEvent: Swift.String?
        /// The newest stored event.
        var mostRecentEvent: Swift.String?
        /// The number of stored events.
        var numberOfEvents: Swift.Int?
...
extension FraudDetectorClientTypes {
    ...
    public struct IngestedEventsDetail: Swift.Equatable {
        ...
        /// This member is required.
        var ingestedEventsTimeWindow: FraudDetectorClientTypes.IngestedEventsTimeWindow?
...
extension FraudDetectorClientTypes {
    ...
    public struct KMSKey: Swift.Equatable {
        ...
        var kmsEncryptionKeyArn: Swift.String?
...
extension FraudDetectorClientTypes {
    ...
    public struct LabelSchema: Swift.Equatable {
        ...
        /// This member is required.
        var labelMapper: [Swift.String:[Swift.String]]?
        /// The action to take for unlabeled events.
        var unlabeledEventsTreatment: FraudDetectorClientTypes.UnlabeledEventsTreatment?
...
extension FraudDetectorClientTypes {
    ...
    public struct LogOddsMetric: Swift.Equatable {
        ...
        /// This member is required.
        var variableImportance: Swift.Float?
        /// The name of the variable.
        /// This member is required.
        var variableName: Swift.String?
...
extension FraudDetectorClientTypes {
    ...
    public struct ModelEndpointDataBlob: Swift.Equatable {
        ...
        var byteBuffer: ClientRuntime.Data?
...
extension FraudDetectorClientTypes {
    ...
    public struct ModelInputConfiguration: Swift.Equatable {
        ...
        var csvInputTemplate: Swift.String?
        /// The event type name.
        var eventTypeName: Swift.String?
        /// The format of the model input configuration. The format differs depending on if it is passed through to SageMaker or constructed by Amazon Fraud Detector.
        var format: FraudDetectorClientTypes.ModelInputDataFormat?
        /// Template for constructing the JSON input-data sent to SageMaker. At event-evaluation, the placeholders for variable names in the template will be replaced with the variable values before being sent to SageMaker.
        var jsonInputTemplate: Swift.String?
        /// The event variables.
        /// This member is required.
        var useEventVariables: Swift.Bool?
...
extension FraudDetectorClientTypes {
    ...
    public struct ModelOutputConfiguration: Swift.Equatable {
        ...
        var csvIndexToVariableMap: [Swift.String:Swift.String]?
        /// The format of the model output configuration.
        /// This member is required.
        var format: FraudDetectorClientTypes.ModelOutputDataFormat?
        /// A map of JSON keys in response from SageMaker to the Amazon Fraud Detector variables.
        var jsonKeyToVariableMap: [Swift.String:Swift.String]?
...
extension FraudDetectorClientTypes {
    ...
    public struct ModelScores: Swift.Equatable {
        /// The model version.
        var modelVersion: FraudDetectorClientTypes.ModelVersion?
        /// The model's fraud prediction scores.
        var scores: [Swift.String:Swift.Float]?
...
extension FraudDetectorClientTypes {
    ...
    public struct ModelVersionDetail: Swift.Equatable {
        ...
        var trainingResult: FraudDetectorClientTypes.TrainingResult?
...
public struct SendEventInput: Swift.Equatable {
    ...
    var assignedLabel: Swift.String?
...
extension FraudDetectorClientTypes {
    ...
    public struct TrainingDataSchema: Swift.Equatable {
        /// The label schema.
        /// This member is required.
        var labelSchema: FraudDetectorClientTypes.LabelSchema?
        /// The training data schema variables.
        /// This member is required.
        var modelVariables: [Swift.String]?
...
extension FraudDetectorClientTypes {
    ...
    public struct TrainingMetrics: Swift.Equatable {
        ...
        var metricDataPoints: [FraudDetectorClientTypes.MetricDataPoint]?
...
extension FraudDetectorClientTypes {
    ...
    public struct TrainingResult: Swift.Equatable {
        ...
        var dataValidationMetrics: FraudDetectorClientTypes.DataValidationMetrics?
        /// The training metric details.
        var trainingMetrics: FraudDetectorClientTypes.TrainingMetrics?
        /// The variable importance metrics.
        var variableImportanceMetrics: FraudDetectorClientTypes.VariableImportanceMetrics?
...
public struct UpdateModelVersionInput: Swift.Equatable {
    ...
    /// This member is required.
    var majorVersionNumber: Swift.String?
    /// The model ID.
    /// This member is required.
    var modelId: Swift.String?
    /// The model type.
...
public struct UpdateModelVersionStatusInput: Swift.Equatable {
    ...
    /// The model version status.
    /// This member is required.
    var status: FraudDetectorClientTypes.ModelVersionStatus?
...
extension FraudDetectorClientTypes {
    ...
    public struct VariableImportanceMetrics: Swift.Equatable {
        ...
        var logOddsMetrics: [FraudDetectorClientTypes.LogOddsMetric]?
