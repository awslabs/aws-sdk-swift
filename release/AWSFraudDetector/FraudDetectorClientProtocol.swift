...
public protocol FraudDetectorClientProtocol {
    ...
    func cancelBatchImportJob(input: CancelBatchImportJobInput, completion: @escaping (ClientRuntime.SdkResult<CancelBatchImportJobOutputResponse, CancelBatchImportJobOutputError>) -> Void)
    ...
    func createBatchImportJob(input: CreateBatchImportJobInput, completion: @escaping (ClientRuntime.SdkResult<CreateBatchImportJobOutputResponse, CreateBatchImportJobOutputError>) -> Void)
    ...
    func deleteBatchImportJob(input: DeleteBatchImportJobInput, completion: @escaping (ClientRuntime.SdkResult<DeleteBatchImportJobOutputResponse, DeleteBatchImportJobOutputError>) -> Void)
    ...
    func deleteEventsByEventType(input: DeleteEventsByEventTypeInput, completion: @escaping (ClientRuntime.SdkResult<DeleteEventsByEventTypeOutputResponse, DeleteEventsByEventTypeOutputError>) -> Void)
    ...
    func getBatchImportJobs(input: GetBatchImportJobsInput, completion: @escaping (ClientRuntime.SdkResult<GetBatchImportJobsOutputResponse, GetBatchImportJobsOutputError>) -> Void)
    ...
    func getDeleteEventsByEventTypeStatus(input: GetDeleteEventsByEventTypeStatusInput, completion: @escaping (ClientRuntime.SdkResult<GetDeleteEventsByEventTypeStatusOutputResponse, GetDeleteEventsByEventTypeStatusOutputError>) -> Void)
    ...
    func getEvent(input: GetEventInput, completion: @escaping (ClientRuntime.SdkResult<GetEventOutputResponse, GetEventOutputError>) -> Void)
    ...
    func updateEventLabel(input: UpdateEventLabelInput, completion: @escaping (ClientRuntime.SdkResult<UpdateEventLabelOutputResponse, UpdateEventLabelOutputError>) -> Void)
