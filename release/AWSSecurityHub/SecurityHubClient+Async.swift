...
public extension SecurityHubClient {
    ...
    {
        typealias createFindingAggregatorContinuation = CheckedContinuation<CreateFindingAggregatorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createFindingAggregatorContinuation) in
            createFindingAggregator(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteFindingAggregatorContinuation = CheckedContinuation<DeleteFindingAggregatorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteFindingAggregatorContinuation) in
            deleteFindingAggregator(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getFindingAggregatorContinuation = CheckedContinuation<GetFindingAggregatorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getFindingAggregatorContinuation) in
            getFindingAggregator(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listFindingAggregatorsContinuation = CheckedContinuation<ListFindingAggregatorsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listFindingAggregatorsContinuation) in
            listFindingAggregators(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateFindingAggregatorContinuation = CheckedContinuation<UpdateFindingAggregatorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateFindingAggregatorContinuation) in
            updateFindingAggregator(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
