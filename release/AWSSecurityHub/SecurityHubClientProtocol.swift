...
public protocol SecurityHubClientProtocol {
    ...
    func createFindingAggregator(input: CreateFindingAggregatorInput, completion: @escaping (ClientRuntime.SdkResult<CreateFindingAggregatorOutputResponse, CreateFindingAggregatorOutputError>) -> Void)
    ...
    func deleteFindingAggregator(input: DeleteFindingAggregatorInput, completion: @escaping (ClientRuntime.SdkResult<DeleteFindingAggregatorOutputResponse, DeleteFindingAggregatorOutputError>) -> Void)
    ...
    func getFindingAggregator(input: GetFindingAggregatorInput, completion: @escaping (ClientRuntime.SdkResult<GetFindingAggregatorOutputResponse, GetFindingAggregatorOutputError>) -> Void)
    ...
    func listFindingAggregators(input: ListFindingAggregatorsInput, completion: @escaping (ClientRuntime.SdkResult<ListFindingAggregatorsOutputResponse, ListFindingAggregatorsOutputError>) -> Void)
    ...
    func updateFindingAggregator(input: UpdateFindingAggregatorInput, completion: @escaping (ClientRuntime.SdkResult<UpdateFindingAggregatorOutputResponse, UpdateFindingAggregatorOutputError>) -> Void)
