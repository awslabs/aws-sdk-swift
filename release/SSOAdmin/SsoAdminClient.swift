...
public class SsoAdminClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try SsoAdminClientConfiguration(region: unwrappedRegion)
    ...
    public class SsoAdminClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("SsoAdminClient")
...
public struct SsoAdminClientLogHandlerFactory: SDKLogHandlerFactory {
