...
public struct DisassociateGlobalReplicationGroupInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DisassociateGlobalReplicationGroupOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DisassociateGlobalReplicationGroupOutput>
