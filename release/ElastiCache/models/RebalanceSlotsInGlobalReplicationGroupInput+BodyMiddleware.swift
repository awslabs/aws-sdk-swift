...
public struct RebalanceSlotsInGlobalReplicationGroupInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<RebalanceSlotsInGlobalReplicationGroupOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<RebalanceSlotsInGlobalReplicationGroupOutput>
