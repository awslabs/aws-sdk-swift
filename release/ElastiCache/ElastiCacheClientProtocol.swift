...
public protocol ElastiCacheClientProtocol {
    ...
    ///          </note>
    func authorizeCacheSecurityGroupIngress(input: AuthorizeCacheSecurityGroupIngressInput, completion: @escaping (SdkResult<AuthorizeCacheSecurityGroupIngressOutputResponse, AuthorizeCacheSecurityGroupIngressOutputError>) -> Void)
    ...
    func batchApplyUpdateAction(input: BatchApplyUpdateActionInput, completion: @escaping (SdkResult<BatchApplyUpdateActionOutputResponse, BatchApplyUpdateActionOutputError>) -> Void)
    ...
    func batchStopUpdateAction(input: BatchStopUpdateActionInput, completion: @escaping (SdkResult<BatchStopUpdateActionOutputResponse, BatchStopUpdateActionOutputError>) -> Void)
    /// <p>Complete the migration of data.</p>
    func completeMigration(input: CompleteMigrationInput, completion: @escaping (SdkResult<CompleteMigrationOutputResponse, CompleteMigrationOutputError>) -> Void)
    ...
    func createCacheCluster(input: CreateCacheClusterInput, completion: @escaping (SdkResult<CreateCacheClusterOutputResponse, CreateCacheClusterOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createCacheParameterGroup(input: CreateCacheParameterGroupInput, completion: @escaping (SdkResult<CreateCacheParameterGroupOutputResponse, CreateCacheParameterGroupOutputError>) -> Void)
    ...
    func createCacheSecurityGroup(input: CreateCacheSecurityGroupInput, completion: @escaping (SdkResult<CreateCacheSecurityGroupOutputResponse, CreateCacheSecurityGroupOutputError>) -> Void)
    ...
    func createCacheSubnetGroup(input: CreateCacheSubnetGroupInput, completion: @escaping (SdkResult<CreateCacheSubnetGroupOutputResponse, CreateCacheSubnetGroupOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createGlobalReplicationGroup(input: CreateGlobalReplicationGroupInput, completion: @escaping (SdkResult<CreateGlobalReplicationGroupOutputResponse, CreateGlobalReplicationGroupOutputError>) -> Void)
    ...
    ///             <p>This operation is valid for Redis only.</p>
    ///          </note>
    func createReplicationGroup(input: CreateReplicationGroupInput, completion: @escaping (SdkResult<CreateReplicationGroupOutputResponse, CreateReplicationGroupOutputError>) -> Void)
    ...
    ///          </p>
    func createUserGroup(input: CreateUserGroupInput, completion: @escaping (SdkResult<CreateUserGroupOutputResponse, CreateUserGroupOutputError>) -> Void)
    /// <p>Decreases the number of node groups in a Global datastore</p>
    func decreaseNodeGroupsInGlobalReplicationGroup(input: DecreaseNodeGroupsInGlobalReplicationGroupInput, completion: @escaping (SdkResult<DecreaseNodeGroupsInGlobalReplicationGroupOutputResponse, DecreaseNodeGroupsInGlobalReplicationGroupOutputError>) -> Void)
    ...
    func decreaseReplicaCount(input: DecreaseReplicaCountInput, completion: @escaping (SdkResult<DecreaseReplicaCountOutputResponse, DecreaseReplicaCountOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func deleteCacheCluster(input: DeleteCacheClusterInput, completion: @escaping (SdkResult<DeleteCacheClusterOutputResponse, DeleteCacheClusterOutputError>) -> Void)
    ...
    func deleteCacheParameterGroup(input: DeleteCacheParameterGroupInput, completion: @escaping (SdkResult<DeleteCacheParameterGroupOutputResponse, DeleteCacheParameterGroupOutputError>) -> Void)
    /// <p>Deletes a cache security group.</p>
    ///         <note>
    ///             <p>You cannot delete a cache security group if it is associated with any clusters.</p>
    ///          </note>
    func deleteCacheSecurityGroup(input: DeleteCacheSecurityGroupInput, completion: @escaping (SdkResult<DeleteCacheSecurityGroupOutputResponse, DeleteCacheSecurityGroupOutputError>) -> Void)
    ...
    ///          </note>
    func deleteCacheSubnetGroup(input: DeleteCacheSubnetGroupInput, completion: @escaping (SdkResult<DeleteCacheSubnetGroupOutputResponse, DeleteCacheSubnetGroupOutputError>) -> Void)
    ...
    func deleteGlobalReplicationGroup(input: DeleteGlobalReplicationGroupInput, completion: @escaping (SdkResult<DeleteGlobalReplicationGroupOutputResponse, DeleteGlobalReplicationGroupOutputError>) -> Void)
    ...
    ///             <p>This operation is valid for Redis only.</p>
    ///          </note>
    func deleteReplicationGroup(input: DeleteReplicationGroupInput, completion: @escaping (SdkResult<DeleteReplicationGroupOutputResponse, DeleteReplicationGroupOutputError>) -> Void)
    ...
    func deleteUserGroup(input: DeleteUserGroupInput, completion: @escaping (SdkResult<DeleteUserGroupOutputResponse, DeleteUserGroupOutputError>) -> Void)
    ...
    func describeCacheClusters(input: DescribeCacheClustersInput, completion: @escaping (SdkResult<DescribeCacheClustersOutputResponse, DescribeCacheClustersOutputError>) -> Void)
    /// <p>Returns a list of the available cache
    ///             engines and their versions.</p>
    func describeCacheEngineVersions(input: DescribeCacheEngineVersionsInput, completion: @escaping (SdkResult<DescribeCacheEngineVersionsOutputResponse, DescribeCacheEngineVersionsOutputError>) -> Void)
    ...
    func describeCacheParameterGroups(input: DescribeCacheParameterGroupsInput, completion: @escaping (SdkResult<DescribeCacheParameterGroupsOutputResponse, DescribeCacheParameterGroupsOutputError>) -> Void)
    /// <p>Returns the detailed parameter list for a
    ///             particular cache parameter group.</p>
    func describeCacheParameters(input: DescribeCacheParametersInput, completion: @escaping (SdkResult<DescribeCacheParametersOutputResponse, DescribeCacheParametersOutputError>) -> Void)
    ...
    ///         </p>
    func describeCacheSecurityGroups(input: DescribeCacheSecurityGroupsInput, completion: @escaping (SdkResult<DescribeCacheSecurityGroupsOutputResponse, DescribeCacheSecurityGroupsOutputError>) -> Void)
    ...
    ///         </p>
    func describeCacheSubnetGroups(input: DescribeCacheSubnetGroupsInput, completion: @escaping (SdkResult<DescribeCacheSubnetGroupsOutputResponse, DescribeCacheSubnetGroupsOutputError>) -> Void)
    /// <p>Returns the default engine and
    ///             system parameter information for the specified cache engine.</p>
    func describeEngineDefaultParameters(input: DescribeEngineDefaultParametersInput, completion: @escaping (SdkResult<DescribeEngineDefaultParametersOutputResponse, DescribeEngineDefaultParametersOutputError>) -> Void)
    ...
    func describeGlobalReplicationGroups(input: DescribeGlobalReplicationGroupsInput, completion: @escaping (SdkResult<DescribeGlobalReplicationGroupsOutputResponse, DescribeGlobalReplicationGroupsOutputError>) -> Void)
    ...
    ///             <p>This operation is valid for Redis only.</p>
    ///          </note>
    func describeReplicationGroups(input: DescribeReplicationGroupsInput, completion: @escaping (SdkResult<DescribeReplicationGroupsOutputResponse, DescribeReplicationGroupsOutputError>) -> Void)
    /// <p>Returns information about reserved cache
    ///             nodes for this account, or about a specified reserved cache node.</p>
    func describeReservedCacheNodes(input: DescribeReservedCacheNodesInput, completion: @escaping (SdkResult<DescribeReservedCacheNodesOutputResponse, DescribeReservedCacheNodesOutputError>) -> Void)
    /// <p>Lists available reserved cache
    ///             node offerings.</p>
    func describeReservedCacheNodesOfferings(input: DescribeReservedCacheNodesOfferingsInput, completion: @escaping (SdkResult<DescribeReservedCacheNodesOfferingsOutputResponse, DescribeReservedCacheNodesOfferingsOutputError>) -> Void)
    /// <p>Returns details of the service updates</p>
    func describeServiceUpdates(input: DescribeServiceUpdatesInput, completion: @escaping (SdkResult<DescribeServiceUpdatesOutputResponse, DescribeServiceUpdatesOutputError>) -> Void)
    ...
    func describeUpdateActions(input: DescribeUpdateActionsInput, completion: @escaping (SdkResult<DescribeUpdateActionsOutputResponse, DescribeUpdateActionsOutputError>) -> Void)
    /// <p>Returns a list of user groups.</p>
    func describeUserGroups(input: DescribeUserGroupsInput, completion: @escaping (SdkResult<DescribeUserGroupsOutputResponse, DescribeUserGroupsOutputError>) -> Void)
    ...
    func disassociateGlobalReplicationGroup(input: DisassociateGlobalReplicationGroupInput, completion: @escaping (SdkResult<DisassociateGlobalReplicationGroupOutputResponse, DisassociateGlobalReplicationGroupOutputError>) -> Void)
    ...
    func failoverGlobalReplicationGroup(input: FailoverGlobalReplicationGroupInput, completion: @escaping (SdkResult<FailoverGlobalReplicationGroupOutputResponse, FailoverGlobalReplicationGroupOutputError>) -> Void)
    /// <p>Increase the number of node groups in the Global datastore</p>
    func increaseNodeGroupsInGlobalReplicationGroup(input: IncreaseNodeGroupsInGlobalReplicationGroupInput, completion: @escaping (SdkResult<IncreaseNodeGroupsInGlobalReplicationGroupOutputResponse, IncreaseNodeGroupsInGlobalReplicationGroupOutputError>) -> Void)
    /// <p>Dynamically increases the number of replicas in a Redis (cluster mode disabled) replication group or the number of
    ///             replica nodes in one or more node groups (shards) of a Redis (cluster mode enabled) replication group. This operation
    ///             is performed with no cluster down time.</p>
    func increaseReplicaCount(input: IncreaseReplicaCountInput, completion: @escaping (SdkResult<IncreaseReplicaCountOutputResponse, IncreaseReplicaCountOutputError>) -> Void)
    ...
    func listAllowedNodeTypeModifications(input: ListAllowedNodeTypeModificationsInput, completion: @escaping (SdkResult<ListAllowedNodeTypeModificationsOutputResponse, ListAllowedNodeTypeModificationsOutputError>) -> Void)
    ...
    func modifyCacheCluster(input: ModifyCacheClusterInput, completion: @escaping (SdkResult<ModifyCacheClusterOutputResponse, ModifyCacheClusterOutputError>) -> Void)
    ...
    func modifyCacheParameterGroup(input: ModifyCacheParameterGroupInput, completion: @escaping (SdkResult<ModifyCacheParameterGroupOutputResponse, ModifyCacheParameterGroupOutputError>) -> Void)
    /// <p>Modifies an existing cache subnet group.</p>
    func modifyCacheSubnetGroup(input: ModifyCacheSubnetGroupInput, completion: @escaping (SdkResult<ModifyCacheSubnetGroupOutputResponse, ModifyCacheSubnetGroupOutputError>) -> Void)
    /// <p>Modifies the settings for a Global datastore.</p>
    func modifyGlobalReplicationGroup(input: ModifyGlobalReplicationGroupInput, completion: @escaping (SdkResult<ModifyGlobalReplicationGroupOutputResponse, ModifyGlobalReplicationGroupOutputError>) -> Void)
    ...
    ///             <p>This operation is valid for Redis only.</p>
    ///          </note>
    func modifyReplicationGroup(input: ModifyReplicationGroupInput, completion: @escaping (SdkResult<ModifyReplicationGroupOutputResponse, ModifyReplicationGroupOutputError>) -> Void)
    ...
    func modifyReplicationGroupShardConfiguration(input: ModifyReplicationGroupShardConfigurationInput, completion: @escaping (SdkResult<ModifyReplicationGroupShardConfigurationOutputResponse, ModifyReplicationGroupShardConfigurationOutputError>) -> Void)
    /// <p>Changes user password(s) and/or access string.</p>
    func modifyUser(input: ModifyUserInput, completion: @escaping (SdkResult<ModifyUserOutputResponse, ModifyUserOutputError>) -> Void)
    /// <p>Changes the list of users that belong to the user group.</p>
    func modifyUserGroup(input: ModifyUserGroupInput, completion: @escaping (SdkResult<ModifyUserGroupOutputResponse, ModifyUserGroupOutputError>) -> Void)
    ...
    func purchaseReservedCacheNodesOffering(input: PurchaseReservedCacheNodesOfferingInput, completion: @escaping (SdkResult<PurchaseReservedCacheNodesOfferingOutputResponse, PurchaseReservedCacheNodesOfferingOutputError>) -> Void)
    /// <p>Redistribute slots to ensure uniform distribution across existing shards in the cluster.</p>
    func rebalanceSlotsInGlobalReplicationGroup(input: RebalanceSlotsInGlobalReplicationGroupInput, completion: @escaping (SdkResult<RebalanceSlotsInGlobalReplicationGroupOutputResponse, RebalanceSlotsInGlobalReplicationGroupOutputError>) -> Void)
    ...
    func rebootCacheCluster(input: RebootCacheClusterInput, completion: @escaping (SdkResult<RebootCacheClusterOutputResponse, RebootCacheClusterOutputError>) -> Void)
    ...
    func resetCacheParameterGroup(input: ResetCacheParameterGroupInput, completion: @escaping (SdkResult<ResetCacheParameterGroupOutputResponse, ResetCacheParameterGroupOutputError>) -> Void)
    ...
    func revokeCacheSecurityGroupIngress(input: RevokeCacheSecurityGroupIngressInput, completion: @escaping (SdkResult<RevokeCacheSecurityGroupIngressOutputResponse, RevokeCacheSecurityGroupIngressOutputError>) -> Void)
    /// <p>Start the migration of data.</p>
    func startMigration(input: StartMigrationInput, completion: @escaping (SdkResult<StartMigrationOutputResponse, StartMigrationOutputError>) -> Void)
    ...
    func testFailover(input: TestFailoverInput, completion: @escaping (SdkResult<TestFailoverOutputResponse, TestFailoverOutputError>) -> Void)
}
