...
public class CloudWatchLogsClient {
    ...
    public class CloudWatchLogsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("CloudWatchLogsClient")
...
public struct CloudWatchLogsClientLogHandlerFactory: SDKLogHandlerFactory {
