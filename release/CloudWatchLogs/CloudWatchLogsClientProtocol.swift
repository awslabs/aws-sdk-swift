...
public protocol CloudWatchLogsClientProtocol {
    ...
    func associateKmsKey(input: AssociateKmsKeyInput, completion: @escaping (SdkResult<AssociateKmsKeyOutput, AssociateKmsKeyOutputError>) -> Void)
    /// <p>Cancels the specified export task.</p>
    ///          <p>The task must be in the <code>PENDING</code> or <code>RUNNING</code> state.</p>
    func cancelExportTask(input: CancelExportTaskInput, completion: @escaping (SdkResult<CancelExportTaskOutput, CancelExportTaskOutputError>) -> Void)
    ...
    func createExportTask(input: CreateExportTaskInput, completion: @escaping (SdkResult<CreateExportTaskOutput, CreateExportTaskOutputError>) -> Void)
    ...
    ///           Keys</a>.</p>
    ///          </important>
    func createLogGroup(input: CreateLogGroupInput, completion: @escaping (SdkResult<CreateLogGroupOutput, CreateLogGroupOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createLogStream(input: CreateLogStreamInput, completion: @escaping (SdkResult<CreateLogStreamOutput, CreateLogStreamOutputError>) -> Void)
    ...
    func deleteLogGroup(input: DeleteLogGroupInput, completion: @escaping (SdkResult<DeleteLogGroupOutput, DeleteLogGroupOutputError>) -> Void)
    /// <p>Deletes the specified log stream and permanently deletes all the archived log events associated
    ///       with the log stream.</p>
    func deleteLogStream(input: DeleteLogStreamInput, completion: @escaping (SdkResult<DeleteLogStreamOutput, DeleteLogStreamOutputError>) -> Void)
    /// <p>Deletes the specified metric filter.</p>
    func deleteMetricFilter(input: DeleteMetricFilterInput, completion: @escaping (SdkResult<DeleteMetricFilterOutput, DeleteMetricFilterOutputError>) -> Void)
    ...
    ///       this operation.</p>
    func deleteQueryDefinition(input: DeleteQueryDefinitionInput, completion: @escaping (SdkResult<DeleteQueryDefinitionOutput, DeleteQueryDefinitionOutputError>) -> Void)
    ...
    func deleteRetentionPolicy(input: DeleteRetentionPolicyInput, completion: @escaping (SdkResult<DeleteRetentionPolicyOutput, DeleteRetentionPolicyOutputError>) -> Void)
    /// <p>Deletes the specified subscription filter.</p>
    func deleteSubscriptionFilter(input: DeleteSubscriptionFilterInput, completion: @escaping (SdkResult<DeleteSubscriptionFilterOutput, DeleteSubscriptionFilterOutputError>) -> Void)
    /// <p>Lists all your destinations. The results are ASCII-sorted by destination name.</p>
    func describeDestinations(input: DescribeDestinationsInput, completion: @escaping (SdkResult<DescribeDestinationsOutput, DescribeDestinationsOutputError>) -> Void)
    ...
    func describeExportTasks(input: DescribeExportTasksInput, completion: @escaping (SdkResult<DescribeExportTasksOutput, DescribeExportTasksOutputError>) -> Void)
    ...
    func describeLogGroups(input: DescribeLogGroupsInput, completion: @escaping (SdkResult<DescribeLogGroupsOutput, DescribeLogGroupsOutputError>) -> Void)
    ...
    func describeLogStreams(input: DescribeLogStreamsInput, completion: @escaping (SdkResult<DescribeLogStreamsOutput, DescribeLogStreamsOutputError>) -> Void)
    ...
    func describeMetricFilters(input: DescribeMetricFiltersInput, completion: @escaping (SdkResult<DescribeMetricFiltersOutput, DescribeMetricFiltersOutputError>) -> Void)
    ...
    func describeQueries(input: DescribeQueriesInput, completion: @escaping (SdkResult<DescribeQueriesOutput, DescribeQueriesOutputError>) -> Void)
    ...
    func describeQueryDefinitions(input: DescribeQueryDefinitionsInput, completion: @escaping (SdkResult<DescribeQueryDefinitionsOutput, DescribeQueryDefinitionsOutputError>) -> Void)
    /// <p>Lists the resource policies in this account.</p>
    func describeResourcePolicies(input: DescribeResourcePoliciesInput, completion: @escaping (SdkResult<DescribeResourcePoliciesOutput, DescribeResourcePoliciesOutputError>) -> Void)
    ...
    func describeSubscriptionFilters(input: DescribeSubscriptionFiltersInput, completion: @escaping (SdkResult<DescribeSubscriptionFiltersOutput, DescribeSubscriptionFiltersOutputError>) -> Void)
    ...
    func disassociateKmsKey(input: DisassociateKmsKeyInput, completion: @escaping (SdkResult<DisassociateKmsKeyOutput, DisassociateKmsKeyOutputError>) -> Void)
    ...
    func filterLogEvents(input: FilterLogEventsInput, completion: @escaping (SdkResult<FilterLogEventsOutput, FilterLogEventsOutputError>) -> Void)
    ...
    func getLogEvents(input: GetLogEventsInput, completion: @escaping (SdkResult<GetLogEventsOutput, GetLogEventsOutputError>) -> Void)
    ...
    func getLogGroupFields(input: GetLogGroupFieldsInput, completion: @escaping (SdkResult<GetLogGroupFieldsOutput, GetLogGroupFieldsOutputError>) -> Void)
    ...
    func getLogRecord(input: GetLogRecordInput, completion: @escaping (SdkResult<GetLogRecordOutput, GetLogRecordOutputError>) -> Void)
    ...
    func getQueryResults(input: GetQueryResultsInput, completion: @escaping (SdkResult<GetQueryResultsOutput, GetQueryResultsOutputError>) -> Void)
    /// <p>Lists the tags for the specified log group.</p>
    func listTagsLogGroup(input: ListTagsLogGroupInput, completion: @escaping (SdkResult<ListTagsLogGroupOutput, ListTagsLogGroupOutputError>) -> Void)
    ...
    func putDestination(input: PutDestinationInput, completion: @escaping (SdkResult<PutDestinationOutput, PutDestinationOutputError>) -> Void)
    ...
    func putDestinationPolicy(input: PutDestinationPolicyInput, completion: @escaping (SdkResult<PutDestinationPolicyOutput, PutDestinationPolicyOutputError>) -> Void)
    ...
    func putLogEvents(input: PutLogEventsInput, completion: @escaping (SdkResult<PutLogEventsOutput, PutLogEventsOutputError>) -> Void)
    ...
    ///       </p>
    ///          </important>
    func putMetricFilter(input: PutMetricFilterInput, completion: @escaping (SdkResult<PutMetricFilterOutput, PutMetricFilterOutputError>) -> Void)
    ...
    ///     this operation.</p>
    func putQueryDefinition(input: PutQueryDefinitionInput, completion: @escaping (SdkResult<PutQueryDefinitionOutput, PutQueryDefinitionOutputError>) -> Void)
    ...
    ///       group.</p>
    func putRetentionPolicy(input: PutRetentionPolicyInput, completion: @escaping (SdkResult<PutRetentionPolicyOutput, PutRetentionPolicyOutputError>) -> Void)
    ...
    ///       <code>iam:PassRole</code> permission.</p>
    func putSubscriptionFilter(input: PutSubscriptionFilterInput, completion: @escaping (SdkResult<PutSubscriptionFilterOutput, PutSubscriptionFilterOutputError>) -> Void)
    ...
    func startQuery(input: StartQueryInput, completion: @escaping (SdkResult<StartQueryOutput, StartQueryOutputError>) -> Void)
    ...
    func stopQuery(input: StopQueryInput, completion: @escaping (SdkResult<StopQueryOutput, StopQueryOutputError>) -> Void)
    ...
    func tagLogGroup(input: TagLogGroupInput, completion: @escaping (SdkResult<TagLogGroupOutput, TagLogGroupOutputError>) -> Void)
    ...
    func testMetricFilter(input: TestMetricFilterInput, completion: @escaping (SdkResult<TestMetricFilterOutput, TestMetricFilterOutputError>) -> Void)
    ...
    func untagLogGroup(input: UntagLogGroupInput, completion: @escaping (SdkResult<UntagLogGroupOutput, UntagLogGroupOutputError>) -> Void)
}
