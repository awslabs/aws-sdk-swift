...
public protocol CloudWatchLogsClientProtocol {
    ...
    func associateKmsKey(input: AssociateKmsKeyInput, completion: @escaping (SdkResult<AssociateKmsKeyOutputResponse, AssociateKmsKeyOutputError>) -> Void)
    /// <p>Cancels the specified export task.</p>
    ///          <p>The task must be in the <code>PENDING</code> or <code>RUNNING</code> state.</p>
    func cancelExportTask(input: CancelExportTaskInput, completion: @escaping (SdkResult<CancelExportTaskOutputResponse, CancelExportTaskOutputError>) -> Void)
    ...
    func createExportTask(input: CreateExportTaskInput, completion: @escaping (SdkResult<CreateExportTaskOutputResponse, CreateExportTaskOutputError>) -> Void)
    ...
    ///           Keys</a>.</p>
    ///          </important>
    func createLogGroup(input: CreateLogGroupInput, completion: @escaping (SdkResult<CreateLogGroupOutputResponse, CreateLogGroupOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createLogStream(input: CreateLogStreamInput, completion: @escaping (SdkResult<CreateLogStreamOutputResponse, CreateLogStreamOutputError>) -> Void)
    ...
    func deleteLogGroup(input: DeleteLogGroupInput, completion: @escaping (SdkResult<DeleteLogGroupOutputResponse, DeleteLogGroupOutputError>) -> Void)
    /// <p>Deletes the specified log stream and permanently deletes all the archived log events associated
    ///       with the log stream.</p>
    func deleteLogStream(input: DeleteLogStreamInput, completion: @escaping (SdkResult<DeleteLogStreamOutputResponse, DeleteLogStreamOutputError>) -> Void)
    /// <p>Deletes the specified metric filter.</p>
    func deleteMetricFilter(input: DeleteMetricFilterInput, completion: @escaping (SdkResult<DeleteMetricFilterOutputResponse, DeleteMetricFilterOutputError>) -> Void)
    ...
    ///       this operation.</p>
    func deleteQueryDefinition(input: DeleteQueryDefinitionInput, completion: @escaping (SdkResult<DeleteQueryDefinitionOutputResponse, DeleteQueryDefinitionOutputError>) -> Void)
    ...
    func deleteSubscriptionFilter(input: DeleteSubscriptionFilterInput, completion: @escaping (SdkResult<DeleteSubscriptionFilterOutputResponse, DeleteSubscriptionFilterOutputError>) -> Void)
    /// <p>Lists all your destinations. The results are ASCII-sorted by destination name.</p>
    func describeDestinations(input: DescribeDestinationsInput, completion: @escaping (SdkResult<DescribeDestinationsOutputResponse, DescribeDestinationsOutputError>) -> Void)
    ...
    func describeLogGroups(input: DescribeLogGroupsInput, completion: @escaping (SdkResult<DescribeLogGroupsOutputResponse, DescribeLogGroupsOutputError>) -> Void)
    ...
    func describeLogStreams(input: DescribeLogStreamsInput, completion: @escaping (SdkResult<DescribeLogStreamsOutputResponse, DescribeLogStreamsOutputError>) -> Void)
    ...
    func describeMetricFilters(input: DescribeMetricFiltersInput, completion: @escaping (SdkResult<DescribeMetricFiltersOutputResponse, DescribeMetricFiltersOutputError>) -> Void)
    ...
    func describeQueries(input: DescribeQueriesInput, completion: @escaping (SdkResult<DescribeQueriesOutputResponse, DescribeQueriesOutputError>) -> Void)
    ...
    func describeQueryDefinitions(input: DescribeQueryDefinitionsInput, completion: @escaping (SdkResult<DescribeQueryDefinitionsOutputResponse, DescribeQueryDefinitionsOutputError>) -> Void)
    /// <p>Lists the resource policies in this account.</p>
    func describeResourcePolicies(input: DescribeResourcePoliciesInput, completion: @escaping (SdkResult<DescribeResourcePoliciesOutputResponse, DescribeResourcePoliciesOutputError>) -> Void)
    ...
    func describeSubscriptionFilters(input: DescribeSubscriptionFiltersInput, completion: @escaping (SdkResult<DescribeSubscriptionFiltersOutputResponse, DescribeSubscriptionFiltersOutputError>) -> Void)
    ...
    func disassociateKmsKey(input: DisassociateKmsKeyInput, completion: @escaping (SdkResult<DisassociateKmsKeyOutputResponse, DisassociateKmsKeyOutputError>) -> Void)
    ...
    func filterLogEvents(input: FilterLogEventsInput, completion: @escaping (SdkResult<FilterLogEventsOutputResponse, FilterLogEventsOutputError>) -> Void)
    ...
    func getLogEvents(input: GetLogEventsInput, completion: @escaping (SdkResult<GetLogEventsOutputResponse, GetLogEventsOutputError>) -> Void)
    ...
    func getLogGroupFields(input: GetLogGroupFieldsInput, completion: @escaping (SdkResult<GetLogGroupFieldsOutputResponse, GetLogGroupFieldsOutputError>) -> Void)
    ...
    func getLogRecord(input: GetLogRecordInput, completion: @escaping (SdkResult<GetLogRecordOutputResponse, GetLogRecordOutputError>) -> Void)
    ...
    func listTagsLogGroup(input: ListTagsLogGroupInput, completion: @escaping (SdkResult<ListTagsLogGroupOutputResponse, ListTagsLogGroupOutputError>) -> Void)
    ...
    func putDestination(input: PutDestinationInput, completion: @escaping (SdkResult<PutDestinationOutputResponse, PutDestinationOutputError>) -> Void)
    ...
    func putDestinationPolicy(input: PutDestinationPolicyInput, completion: @escaping (SdkResult<PutDestinationPolicyOutputResponse, PutDestinationPolicyOutputError>) -> Void)
    ...
    func putLogEvents(input: PutLogEventsInput, completion: @escaping (SdkResult<PutLogEventsOutputResponse, PutLogEventsOutputError>) -> Void)
    ...
    ///       </p>
    ///          </important>
    func putMetricFilter(input: PutMetricFilterInput, completion: @escaping (SdkResult<PutMetricFilterOutputResponse, PutMetricFilterOutputError>) -> Void)
    ...
    ///     this operation.</p>
    func putQueryDefinition(input: PutQueryDefinitionInput, completion: @escaping (SdkResult<PutQueryDefinitionOutputResponse, PutQueryDefinitionOutputError>) -> Void)
    ...
    ///       <code>iam:PassRole</code> permission.</p>
    func putSubscriptionFilter(input: PutSubscriptionFilterInput, completion: @escaping (SdkResult<PutSubscriptionFilterOutputResponse, PutSubscriptionFilterOutputError>) -> Void)
    ...
    func startQuery(input: StartQueryInput, completion: @escaping (SdkResult<StartQueryOutputResponse, StartQueryOutputError>) -> Void)
    ...
    func stopQuery(input: StopQueryInput, completion: @escaping (SdkResult<StopQueryOutputResponse, StopQueryOutputError>) -> Void)
    ...
    func tagLogGroup(input: TagLogGroupInput, completion: @escaping (SdkResult<TagLogGroupOutputResponse, TagLogGroupOutputError>) -> Void)
    ...
    func testMetricFilter(input: TestMetricFilterInput, completion: @escaping (SdkResult<TestMetricFilterOutputResponse, TestMetricFilterOutputError>) -> Void)
    ...
    func untagLogGroup(input: UntagLogGroupInput, completion: @escaping (SdkResult<UntagLogGroupOutputResponse, UntagLogGroupOutputError>) -> Void)
}
