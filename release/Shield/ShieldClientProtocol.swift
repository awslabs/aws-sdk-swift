...
public protocol ShieldClientProtocol {
    ...
    func associateDRTLogBucket(input: AssociateDRTLogBucketInput, completion: @escaping (SdkResult<AssociateDRTLogBucketOutput, AssociateDRTLogBucketOutputError>) -> Void)
    ...
    func associateDRTRole(input: AssociateDRTRoleInput, completion: @escaping (SdkResult<AssociateDRTRoleOutput, AssociateDRTRoleOutputError>) -> Void)
    ...
    func associateHealthCheck(input: AssociateHealthCheckInput, completion: @escaping (SdkResult<AssociateHealthCheckOutput, AssociateHealthCheckOutputError>) -> Void)
    ...
    ///          </note>
    func associateProactiveEngagementDetails(input: AssociateProactiveEngagementDetailsInput, completion: @escaping (SdkResult<AssociateProactiveEngagementDetailsOutput, AssociateProactiveEngagementDetailsOutputError>) -> Void)
    ...
    func createProtection(input: CreateProtectionInput, completion: @escaping (SdkResult<CreateProtectionOutput, CreateProtectionOutputError>) -> Void)
    ...
    func createProtectionGroup(input: CreateProtectionGroupInput, completion: @escaping (SdkResult<CreateProtectionGroupOutput, CreateProtectionGroupOutputError>) -> Void)
    ...
    func createSubscription(input: CreateSubscriptionInput, completion: @escaping (SdkResult<CreateSubscriptionOutput, CreateSubscriptionOutputError>) -> Void)
    /// <p>Deletes an AWS Shield Advanced <a>Protection</a>.</p>
    func deleteProtection(input: DeleteProtectionInput, completion: @escaping (SdkResult<DeleteProtectionOutput, DeleteProtectionOutputError>) -> Void)
    /// <p>Removes the specified protection group.</p>
    func deleteProtectionGroup(input: DeleteProtectionGroupInput, completion: @escaping (SdkResult<DeleteProtectionGroupOutput, DeleteProtectionGroupOutputError>) -> Void)
    ...
    func deleteSubscription(input: DeleteSubscriptionInput, completion: @escaping (SdkResult<DeleteSubscriptionOutput, DeleteSubscriptionOutputError>) -> Void)
    /// <p>Describes the details of a DDoS attack. </p>
    func describeAttack(input: DescribeAttackInput, completion: @escaping (SdkResult<DescribeAttackOutput, DescribeAttackOutputError>) -> Void)
    ...
    func describeAttackStatistics(input: DescribeAttackStatisticsInput, completion: @escaping (SdkResult<DescribeAttackStatisticsOutput, DescribeAttackStatisticsOutputError>) -> Void)
    ...
    func describeDRTAccess(input: DescribeDRTAccessInput, completion: @escaping (SdkResult<DescribeDRTAccessOutput, DescribeDRTAccessOutputError>) -> Void)
    ...
    func describeEmergencyContactSettings(input: DescribeEmergencyContactSettingsInput, completion: @escaping (SdkResult<DescribeEmergencyContactSettingsOutput, DescribeEmergencyContactSettingsOutputError>) -> Void)
    /// <p>Lists the details of a <a>Protection</a> object.</p>
    func describeProtection(input: DescribeProtectionInput, completion: @escaping (SdkResult<DescribeProtectionOutput, DescribeProtectionOutputError>) -> Void)
    /// <p>Returns the specification for the specified protection group.</p>
    func describeProtectionGroup(input: DescribeProtectionGroupInput, completion: @escaping (SdkResult<DescribeProtectionGroupOutput, DescribeProtectionGroupOutputError>) -> Void)
    /// <p>Provides details about the AWS Shield Advanced subscription for an account.</p>
    func describeSubscription(input: DescribeSubscriptionInput, completion: @escaping (SdkResult<DescribeSubscriptionOutput, DescribeSubscriptionOutputError>) -> Void)
    ...
    func disableProactiveEngagement(input: DisableProactiveEngagementInput, completion: @escaping (SdkResult<DisableProactiveEngagementOutput, DisableProactiveEngagementOutputError>) -> Void)
    ...
    func disassociateDRTLogBucket(input: DisassociateDRTLogBucketInput, completion: @escaping (SdkResult<DisassociateDRTLogBucketOutput, DisassociateDRTLogBucketOutputError>) -> Void)
    ...
    func disassociateDRTRole(input: DisassociateDRTRoleInput, completion: @escaping (SdkResult<DisassociateDRTRoleOutput, DisassociateDRTRoleOutputError>) -> Void)
    ...
    func disassociateHealthCheck(input: DisassociateHealthCheckInput, completion: @escaping (SdkResult<DisassociateHealthCheckOutput, DisassociateHealthCheckOutputError>) -> Void)
    ...
    func enableProactiveEngagement(input: EnableProactiveEngagementInput, completion: @escaping (SdkResult<EnableProactiveEngagementOutput, EnableProactiveEngagementOutputError>) -> Void)
    /// <p>Returns the <code>SubscriptionState</code>, either <code>Active</code> or <code>Inactive</code>.</p>
    func getSubscriptionState(input: GetSubscriptionStateInput, completion: @escaping (SdkResult<GetSubscriptionStateOutput, GetSubscriptionStateOutputError>) -> Void)
    /// <p>Returns all ongoing DDoS attacks or all DDoS attacks during a specified time
    ///          period.</p>
    func listAttacks(input: ListAttacksInput, completion: @escaping (SdkResult<ListAttacksOutput, ListAttacksOutputError>) -> Void)
    /// <p>Retrieves the <a>ProtectionGroup</a> objects for the account.</p>
    func listProtectionGroups(input: ListProtectionGroupsInput, completion: @escaping (SdkResult<ListProtectionGroupsOutput, ListProtectionGroupsOutputError>) -> Void)
    /// <p>Lists all <a>Protection</a> objects for the account.</p>
    func listProtections(input: ListProtectionsInput, completion: @escaping (SdkResult<ListProtectionsOutput, ListProtectionsOutputError>) -> Void)
    /// <p>Retrieves the resources that are included in the protection group. </p>
    func listResourcesInProtectionGroup(input: ListResourcesInProtectionGroupInput, completion: @escaping (SdkResult<ListResourcesInProtectionGroupOutput, ListResourcesInProtectionGroupOutputError>) -> Void)
    ...
    func updateEmergencyContactSettings(input: UpdateEmergencyContactSettingsInput, completion: @escaping (SdkResult<UpdateEmergencyContactSettingsOutput, UpdateEmergencyContactSettingsOutputError>) -> Void)
    ...
    func updateProtectionGroup(input: UpdateProtectionGroupInput, completion: @escaping (SdkResult<UpdateProtectionGroupOutput, UpdateProtectionGroupOutputError>) -> Void)
    ...
    func updateSubscription(input: UpdateSubscriptionInput, completion: @escaping (SdkResult<UpdateSubscriptionOutput, UpdateSubscriptionOutputError>) -> Void)
}
