...
public protocol MediaTailorClientProtocol {
    ...
    func createPrefetchSchedule(input: CreatePrefetchScheduleInput, completion: @escaping (ClientRuntime.SdkResult<CreatePrefetchScheduleOutputResponse, CreatePrefetchScheduleOutputError>) -> Void)
    /// Creates a program.
    ...
    func deletePrefetchSchedule(input: DeletePrefetchScheduleInput, completion: @escaping (ClientRuntime.SdkResult<DeletePrefetchScheduleOutputResponse, DeletePrefetchScheduleOutputError>) -> Void)
    ...
    func getPrefetchSchedule(input: GetPrefetchScheduleInput, completion: @escaping (ClientRuntime.SdkResult<GetPrefetchScheduleOutputResponse, GetPrefetchScheduleOutputError>) -> Void)
    ...
    func listPrefetchSchedules(input: ListPrefetchSchedulesInput, completion: @escaping (ClientRuntime.SdkResult<ListPrefetchSchedulesOutputResponse, ListPrefetchSchedulesOutputError>) -> Void)
