...
extension MediaTailorClientTypes {
    ...
    public struct AccessConfiguration: Swift.Equatable {
        ...
        var accessType: MediaTailorClientTypes.AccessType?
        /// AWS Secrets Manager access token configuration parameters.
        var secretsManagerAccessTokenConfiguration: MediaTailorClientTypes.SecretsManagerAccessTokenConfiguration?
...
extension MediaTailorClientTypes {
    ...
    public struct AdBreak: Swift.Equatable {
        ...
        var messageType: MediaTailorClientTypes.MessageType?
        /// How long (in milliseconds) after the beginning of the program that an ad starts. This value must fall within 100ms of a segment boundary, otherwise the ad break will be skipped.
        var offsetMillis: Swift.Int?
        /// Ad break slate configuration.
        var slate: MediaTailorClientTypes.SlateSource?
        /// This defines the SCTE-35 splice_insert() message inserted around the ad. For information about using splice_insert(), see the SCTE-35 specficiaiton, section 9.7.3.1.
        var spliceInsertMessage: MediaTailorClientTypes.SpliceInsertMessage?
...
extension MediaTailorClientTypes {
    ...
    public struct Alert: Swift.Equatable {
        ...
        var alertCode: Swift.String?
        /// If an alert is generated for a resource, an explanation of the reason for the alert.
        /// This member is required.
        var alertMessage: Swift.String?
        /// The timestamp when the alert was last modified.
        /// This member is required.
        var lastModifiedTime: ClientRuntime.Date?
        /// The Amazon Resource Names (ARNs) related to this alert.
        /// This member is required.
        var relatedResourceArns: [Swift.String]?
...
extension MediaTailorClientTypes {
    ...
    public struct AvailMatchingCriteria: Swift.Equatable {
        ...
        /// This member is required.
        var `operator`: MediaTailorClientTypes.Operator?
        ...
        /// This member is required.
        var dynamicVariable: Swift.String?
...
extension MediaTailorClientTypes {
    ...
    public struct AvailSuppression: Swift.Equatable {
        ...
        var mode: MediaTailorClientTypes.Mode?
...
extension MediaTailorClientTypes {
    ...
    public struct CdnConfiguration: Swift.Equatable {
        ...
        var adSegmentUrlPrefix: Swift.String?
        /// A content delivery network (CDN) to cache content segments, so that content requests don’t always have to go to the origin server. First, create a rule in your CDN for the content segment origin server. Then specify the rule's name in this ContentSegmentUrlPrefix. When AWS Elemental MediaTailor serves a manifest, it reports your CDN as the source for content segments.
        var contentSegmentUrlPrefix: Swift.String?
...
extension MediaTailorClientTypes {
    ...
    public struct Channel: Swift.Equatable {
        ...
        var fillerSlate: MediaTailorClientTypes.SlateSource?
        /// The timestamp of when the channel was last modified.
        var lastModifiedTime: ClientRuntime.Date?
        /// The channel's output properties.
        /// This member is required.
        var outputs: [MediaTailorClientTypes.ResponseOutputItem]?
...
public struct ConfigureLogsForPlaybackConfigurationInput: Swift.Equatable {
    ...
    /// This member is required.
    var percentEnabled: Swift.Int?
    /// The name of the playback configuration.
    /// This member is required.
    var playbackConfigurationName: Swift.String?
...
public struct CreateChannelInput: Swift.Equatable {
    ...
    /// The channel's output properties.
    /// This member is required.
    var outputs: [MediaTailorClientTypes.RequestOutputItem]?
    ...
    /// This member is required.
    var playbackMode: MediaTailorClientTypes.PlaybackMode?
    /// The tags to assign to the channel.
    var tags: [Swift.String:Swift.String]?
...
public struct CreateChannelOutputResponse: Swift.Equatable {
    ...
    var channelState: MediaTailorClientTypes.ChannelState?
    /// The timestamp of when the channel was created.
    var creationTime: ClientRuntime.Date?
...
public struct CreatePrefetchScheduleInput: Swift.Equatable {
    ...
    /// This member is required.
    var consumption: MediaTailorClientTypes.PrefetchConsumption?
    ...
    /// This member is required.
    var retrieval: MediaTailorClientTypes.PrefetchRetrieval?
...
public struct CreateProgramInput: Swift.Equatable {
    ...
    var adBreaks: [MediaTailorClientTypes.AdBreak]?
    /// The identifier for the channel you are working on.
    /// This member is required.
    var channelName: Swift.String?
    /// The identifier for the program you are working on.
    /// This member is required.
    var programName: Swift.String?
    /// The schedule configuration settings.
    /// This member is required.
    var scheduleConfiguration: MediaTailorClientTypes.ScheduleConfiguration?
    /// The name of the source location.
    /// This member is required.
    var sourceLocationName: Swift.String?
    /// The name that's used to refer to a VOD source.
    /// This member is required.
    var vodSourceName: Swift.String?
...
public struct CreateSourceLocationInput: Swift.Equatable {
    ...
    var accessConfiguration: MediaTailorClientTypes.AccessConfiguration?
    /// The optional configuration for the server that serves segments.
    var defaultSegmentDeliveryConfiguration: MediaTailorClientTypes.DefaultSegmentDeliveryConfiguration?
    /// The source's HTTP package configurations.
    /// This member is required.
    var httpConfiguration: MediaTailorClientTypes.HttpConfiguration?
...
public struct CreateVodSourceInput: Swift.Equatable {
    ...
    /// This member is required.
    var httpPackageConfigurations: [MediaTailorClientTypes.HttpPackageConfiguration]?
    /// The identifier for the source location you are working on.
    /// This member is required.
    var sourceLocationName: Swift.String?
...
public struct GetChannelScheduleInput: Swift.Equatable {
    ...
    var durationMinutes: Swift.String?
...
public struct GetChannelScheduleOutputResponse: Swift.Equatable {
    ...
    var items: [MediaTailorClientTypes.ScheduleEntry]?
    /// Pagination token from the GET list request. Use the token to fetch the next page of results.
    var nextToken: Swift.String?
...
public struct GetPlaybackConfigurationOutputResponse: Swift.Equatable {
    ...
    var adDecisionServerUrl: Swift.String?
    /// The configuration for avail suppression, also known as ad suppression. For more information about ad suppression, see [Ad Suppression](https://docs.aws.amazon.com/mediatailor/latest/ug/ad-behavior.html).
    var availSuppression: MediaTailorClientTypes.AvailSuppression?
    /// The configuration for bumpers. Bumpers are short audio or video clips that play at the start or before the end of an ad break. To learn more about bumpers, see [Bumpers](https://docs.aws.amazon.com/mediatailor/latest/ug/bumpers.html).
    var bumper: MediaTailorClientTypes.Bumper?
    /// The configuration for using a content delivery network (CDN), like Amazon CloudFront, for content and ad segment management.
    var cdnConfiguration: MediaTailorClientTypes.CdnConfiguration?
    ...
    var configurationAliases: [Swift.String:[Swift.String:Swift.String]]?
    /// The configuration for DASH content.
    var dashConfiguration: MediaTailorClientTypes.DashConfiguration?
    /// The configuration for HLS content.
    var hlsConfiguration: MediaTailorClientTypes.HlsConfiguration?
    /// The configuration for pre-roll ad insertion.
    var livePreRollConfiguration: MediaTailorClientTypes.LivePreRollConfiguration?
    /// The Amazon CloudWatch log settings for a playback configuration.
    var logConfiguration: MediaTailorClientTypes.LogConfiguration?
    /// The configuration for manifest processing rules. Manifest processing rules enable customization of the personalized manifests created by MediaTailor.
    var manifestProcessingRules: MediaTailorClientTypes.ManifestProcessingRules?
    /// The identifier for the playback configuration.
    var name: Swift.String?
    /// Defines the maximum duration of underfilled ad time (in seconds) allowed in an ad break. If the duration of underfilled ad time exceeds the personalization threshold, then the personalization of the ad break is abandoned and the underlying content is shown. This feature applies to ad replacement in live and VOD streams, rather than ad insertion, because it relies on an underlying content stream. For more information about ad break behavior, including ad replacement and insertion, see [Ad Behavior in AWS Elemental MediaTailor](https://docs.aws.amazon.com/mediatailor/latest/ug/ad-behavior.html).
    var personalizationThresholdSeconds: Swift.Int?
    /// The Amazon Resource Name (ARN) for the playback configuration.
    var playbackConfigurationArn: Swift.String?
    /// The URL that the player accesses to get a manifest from AWS Elemental MediaTailor. This session will use server-side reporting.
    var playbackEndpointPrefix: Swift.String?
    /// The URL that the player uses to initialize a session that uses client-side reporting.
    var sessionInitializationEndpointPrefix: Swift.String?
    /// The URL for a high-quality video asset to transcode and use to fill in time that's not used by ads. AWS Elemental MediaTailor shows the slate to fill in gaps in media content. Configuring the slate is optional for non-VPAID playback configurations. For VPAID, the slate is required because MediaTailor provides it in the slots designated for dynamic ad content. The slate must be a high-quality asset that contains both audio and video.
    var slateAdUrl: Swift.String?
    /// The tags assigned to the playback configuration.
    var tags: [Swift.String:Swift.String]?
    /// The name that is used to associate this playback configuration with a custom transcode profile. This overrides the dynamic transcoding defaults of MediaTailor. Use this only if you have already set up custom profiles with the help of AWS Support.
    var transcodeProfileName: Swift.String?
    /// The URL prefix for the parent manifest for the stream, minus the asset ID. The maximum length is 512 characters.
    var videoContentSourceUrl: Swift.String?
...
extension MediaTailorClientTypes {
    ...
    public struct HttpPackageConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var sourceGroup: Swift.String?
        /// The streaming protocol for this package configuration. Supported values are HLS and DASH.
        /// This member is required.
        var type: MediaTailorClientTypes.ModelType?
...
public struct ListAlertsOutputResponse: Swift.Equatable {
    ...
    var items: [MediaTailorClientTypes.Alert]?
...
public struct ListChannelsOutputResponse: Swift.Equatable {
    ...
    var items: [MediaTailorClientTypes.Channel]?
...
public struct ListPlaybackConfigurationsOutputResponse: Swift.Equatable {
    ...
    var items: [MediaTailorClientTypes.PlaybackConfiguration]?
    /// Pagination token returned by the GET list request when results exceed the maximum allowed. Use the token to fetch the next page of results.
    var nextToken: Swift.String?
...
public struct ListPrefetchSchedulesOutputResponse: Swift.Equatable {
    ...
    var items: [MediaTailorClientTypes.PrefetchSchedule]?
...
public struct ListSourceLocationsOutputResponse: Swift.Equatable {
    ...
    var items: [MediaTailorClientTypes.SourceLocation]?
    /// Pagination token from the list request. Use the token to fetch the next page of results.
    var nextToken: Swift.String?
...
public struct ListVodSourcesOutputResponse: Swift.Equatable {
    ...
    var items: [MediaTailorClientTypes.VodSource]?
    /// Pagination token from the list request. Use the token to fetch the next page of results.
    var nextToken: Swift.String?
...
extension MediaTailorClientTypes {
    ...
    public struct LivePreRollConfiguration: Swift.Equatable {
        ...
        var maxDurationSeconds: Swift.Int?
...
extension MediaTailorClientTypes {
    ...
    public struct ManifestProcessingRules: Swift.Equatable {
        /// For HLS, when set to true, MediaTailor passes through EXT-X-CUE-IN, EXT-X-CUE-OUT, and EXT-X-SPLICEPOINT-SCTE35 ad markers from the origin manifest to the MediaTailor personalized manifest. No logic is applied to these ad markers. For example, if EXT-X-CUE-OUT has a value of 60, but no ads are filled for that ad break, MediaTailor will not set the value to 0.
        var adMarkerPassthrough: MediaTailorClientTypes.AdMarkerPassthrough?
...
extension MediaTailorClientTypes {
    ...
    public struct PrefetchConsumption: Swift.Equatable {
        ...
        var availMatchingCriteria: [MediaTailorClientTypes.AvailMatchingCriteria]?
...
extension MediaTailorClientTypes {
    ...
    public struct PrefetchRetrieval: Swift.Equatable {
        ...
        var dynamicVariables: [Swift.String:Swift.String]?
...
public struct PutPlaybackConfigurationInput: Swift.Equatable {
    ...
    var configurationAliases: [Swift.String:[Swift.String:Swift.String]]?
    /// The configuration for DASH content.
    var dashConfiguration: MediaTailorClientTypes.DashConfigurationForPut?
    /// The configuration for pre-roll ad insertion.
    var livePreRollConfiguration: MediaTailorClientTypes.LivePreRollConfiguration?
    /// The configuration for manifest processing rules. Manifest processing rules enable customization of the personalized manifests created by MediaTailor.
    var manifestProcessingRules: MediaTailorClientTypes.ManifestProcessingRules?
...
extension MediaTailorClientTypes {
    ...
    public struct RequestOutputItem: Swift.Equatable {
        /// DASH manifest configuration parameters.
        var dashPlaylistSettings: MediaTailorClientTypes.DashPlaylistSettings?
        /// HLS playlist configuration parameters.
        var hlsPlaylistSettings: MediaTailorClientTypes.HlsPlaylistSettings?
...
extension MediaTailorClientTypes {
    ...
    public struct ScheduleAdBreak: Swift.Equatable {
        ...
        var approximateDurationSeconds: Swift.Int?
        /// The approximate time that the ad will start playing.
        var approximateStartTime: ClientRuntime.Date?
...
extension MediaTailorClientTypes {
    ...
    public struct ScheduleConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var transition: MediaTailorClientTypes.Transition?
...
extension MediaTailorClientTypes {
    ...
    public struct ScheduleEntry: Swift.Equatable {
        ...
        var programName: Swift.String?
        /// The schedule's ad break properties.
        var scheduleAdBreaks: [MediaTailorClientTypes.ScheduleAdBreak]?
        /// The type of schedule entry. Valid values: PROGRAM or FILLER_SLATE.
        var scheduleEntryType: MediaTailorClientTypes.ScheduleEntryType?
        /// The name of the source location.
        /// This member is required.
        var sourceLocationName: Swift.String?
        /// The name of the VOD source.
...
extension MediaTailorClientTypes {
    ...
    public struct SecretsManagerAccessTokenConfiguration: Swift.Equatable {
        ...
        var secretStringKey: Swift.String?
...
extension MediaTailorClientTypes {
    ...
    public struct SpliceInsertMessage: Swift.Equatable {
        ...
        var availNum: Swift.Int?
        /// This is written to splice_insert.avails_expected, as defined in section 9.7.3.1 of the SCTE-35 specification. The default value is 0. Values must be between 0 and 256, inclusive.
        var availsExpected: Swift.Int?
        /// This is written to splice_insert.splice_event_id, as defined in section 9.7.3.1 of the SCTE-35 specification. The default value is 1.
        var spliceEventId: Swift.Int?
        /// This is written to splice_insert.unique_program_id, as defined in section 9.7.3.1 of the SCTE-35 specification. The default value is 0. Values must be between 0 and 256, inclusive.
        var uniqueProgramId: Swift.Int?
...
extension MediaTailorClientTypes {
    ...
    public struct Transition: Swift.Equatable {
        ...
        /// This member is required.
        var relativePosition: MediaTailorClientTypes.RelativePosition?
        /// The name of the program that this program will be inserted next to, as defined by RelativePosition.
        var relativeProgram: Swift.String?
        /// The date and time that the program is scheduled to start, in epoch milliseconds.
        var scheduledStartTimeMillis: Swift.Int?
