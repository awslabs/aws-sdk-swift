...
extension MediaTailorClientTypes.AvailMatchingCriteria: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaTailorClientTypes.AvailMatchingCriteria: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AvailMatchingCriteria(dynamicVariable: \(Swift.String(describing: dynamicVariable)), operator: \(Swift.String(describing: `operator`)))"}
}
...
public struct CreatePrefetchScheduleInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePrefetchScheduleInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreatePrefetchScheduleInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreatePrefetchScheduleOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreatePrefetchScheduleInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreatePrefetchScheduleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreatePrefetchScheduleOutputError>
}

extension CreatePrefetchScheduleInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreatePrefetchScheduleInput(consumption: \(Swift.String(describing: consumption)), name: \(Swift.String(describing: name)), playbackConfigurationName: \(Swift.String(describing: playbackConfigurationName)), retrieval: \(Swift.String(describing: retrieval)), streamId: \(Swift.String(describing: streamId)))"}
}

extension CreatePrefetchScheduleInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreatePrefetchScheduleInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePrefetchScheduleInputHeadersMiddleware"
...
public struct CreatePrefetchScheduleInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePrefetchScheduleInputQueryItemMiddleware"
...
public struct CreatePrefetchScheduleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePrefetchScheduleInputURLHostMiddleware"
    ...
    public typealias MInput = CreatePrefetchScheduleInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreatePrefetchScheduleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreatePrefetchScheduleOutputError>
}

public struct CreatePrefetchScheduleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePrefetchScheduleInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let playbackConfigurationName = input.playbackConfigurationName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("playbackConfigurationName is nil and needs a value for the path of this operation"))))
        }
        ...
        var urlPath = "/prefetchSchedule/\(playbackConfigurationName.urlPercentEncoding())/\(name.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct CreatePrefetchScheduleInputBody: Swift.Equatable {
    public let consumption: MediaTailorClientTypes.PrefetchConsumption?
    public let retrieval: MediaTailorClientTypes.PrefetchRetrieval?
...
extension CreatePrefetchScheduleOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreatePrefetchScheduleOutputResponse(arn: \(Swift.String(describing: arn)), consumption: \(Swift.String(describing: consumption)), name: \(Swift.String(describing: name)), playbackConfigurationName: \(Swift.String(describing: playbackConfigurationName)), retrieval: \(Swift.String(describing: retrieval)), streamId: \(Swift.String(describing: streamId)))"}
}
...
extension DeletePrefetchScheduleInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeletePrefetchScheduleInput(name: \(Swift.String(describing: name)), playbackConfigurationName: \(Swift.String(describing: playbackConfigurationName)))"}
}

extension DeletePrefetchScheduleInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeletePrefetchScheduleInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePrefetchScheduleInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeletePrefetchScheduleInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeletePrefetchScheduleOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeletePrefetchScheduleInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeletePrefetchScheduleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeletePrefetchScheduleOutputError>
}

public struct DeletePrefetchScheduleInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePrefetchScheduleInputQueryItemMiddleware"
...
public struct DeletePrefetchScheduleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePrefetchScheduleInputURLHostMiddleware"
    ...
    public typealias MInput = DeletePrefetchScheduleInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeletePrefetchScheduleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeletePrefetchScheduleOutputError>
}

public struct DeletePrefetchScheduleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePrefetchScheduleInputURLPathMiddleware"
...
extension DeletePrefetchScheduleOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeletePrefetchScheduleOutputResponse()"}
}
...
struct DeletePrefetchScheduleOutputResponseBody: Swift.Equatable {
}

extension DeletePrefetchScheduleOutputResponseBody: Swift.Decodable {
...
extension GetPrefetchScheduleInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetPrefetchScheduleInput(name: \(Swift.String(describing: name)), playbackConfigurationName: \(Swift.String(describing: playbackConfigurationName)))"}
}

extension GetPrefetchScheduleInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetPrefetchScheduleInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPrefetchScheduleInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetPrefetchScheduleInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetPrefetchScheduleOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetPrefetchScheduleInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetPrefetchScheduleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetPrefetchScheduleOutputError>
}

public struct GetPrefetchScheduleInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPrefetchScheduleInputQueryItemMiddleware"
...
public struct GetPrefetchScheduleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPrefetchScheduleInputURLHostMiddleware"
    ...
    public typealias MInput = GetPrefetchScheduleInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetPrefetchScheduleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetPrefetchScheduleOutputError>
}

public struct GetPrefetchScheduleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetPrefetchScheduleInputURLPathMiddleware"
...
extension GetPrefetchScheduleOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetPrefetchScheduleOutputResponse(arn: \(Swift.String(describing: arn)), consumption: \(Swift.String(describing: consumption)), name: \(Swift.String(describing: name)), playbackConfigurationName: \(Swift.String(describing: playbackConfigurationName)), retrieval: \(Swift.String(describing: retrieval)), streamId: \(Swift.String(describing: streamId)))"}
}
...
public struct ListPrefetchSchedulesInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPrefetchSchedulesInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListPrefetchSchedulesInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListPrefetchSchedulesOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListPrefetchSchedulesInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListPrefetchSchedulesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListPrefetchSchedulesOutputError>
}

extension ListPrefetchSchedulesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPrefetchSchedulesInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), playbackConfigurationName: \(Swift.String(describing: playbackConfigurationName)), streamId: \(Swift.String(describing: streamId)))"}
}

extension ListPrefetchSchedulesInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ListPrefetchSchedulesInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPrefetchSchedulesInputHeadersMiddleware"
...
public struct ListPrefetchSchedulesInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPrefetchSchedulesInputQueryItemMiddleware"
...
public struct ListPrefetchSchedulesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPrefetchSchedulesInputURLHostMiddleware"
    ...
    public typealias MInput = ListPrefetchSchedulesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListPrefetchSchedulesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListPrefetchSchedulesOutputError>
}

public struct ListPrefetchSchedulesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPrefetchSchedulesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/prefetchSchedule/\(playbackConfigurationName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ListPrefetchSchedulesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPrefetchSchedulesOutputResponse(items: \(Swift.String(describing: items)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListPrefetchSchedulesOutputResponseBody: Swift.Equatable {
    public let items: [MediaTailorClientTypes.PrefetchSchedule]?
    public let nextToken: Swift.String?
}
...
extension MediaTailorClientTypes.PrefetchConsumption: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaTailorClientTypes.PrefetchConsumption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PrefetchConsumption(availMatchingCriteria: \(Swift.String(describing: availMatchingCriteria)), endTime: \(Swift.String(describing: endTime)), startTime: \(Swift.String(describing: startTime)))"}
}
...
extension MediaTailorClientTypes.PrefetchRetrieval: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaTailorClientTypes.PrefetchRetrieval: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PrefetchRetrieval(dynamicVariables: \(Swift.String(describing: dynamicVariables)), endTime: \(Swift.String(describing: endTime)), startTime: \(Swift.String(describing: startTime)))"}
}
...
extension MediaTailorClientTypes.PrefetchSchedule: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "Arn"
        case consumption = "Consumption"
        case name = "Name"
...
extension MediaTailorClientTypes.PrefetchSchedule: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PrefetchSchedule(arn: \(Swift.String(describing: arn)), consumption: \(Swift.String(describing: consumption)), name: \(Swift.String(describing: name)), playbackConfigurationName: \(Swift.String(describing: playbackConfigurationName)), retrieval: \(Swift.String(describing: retrieval)), streamId: \(Swift.String(describing: streamId)))"}
}
