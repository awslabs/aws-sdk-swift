...
extension TranscribeClient: TranscribeClientProtocol {
    ...
    public func createCallAnalyticsCategory(input: CreateCallAnalyticsCategoryInput, completion: @escaping (ClientRuntime.SdkResult<CreateCallAnalyticsCategoryOutputResponse, CreateCallAnalyticsCategoryOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<CreateCallAnalyticsCategoryInput, CreateCallAnalyticsCategoryOutputResponse, CreateCallAnalyticsCategoryOutputError>(id: "createCallAnalyticsCategory")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: CreateCallAnalyticsCategoryInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: CreateCallAnalyticsCategoryInputQueryItemMiddleware())
        ...
        operation.serializeStep.intercept(position: .before, middleware: CreateCallAnalyticsCategoryInputBodyMiddleware())
    ...
    public func deleteCallAnalyticsCategory(input: DeleteCallAnalyticsCategoryInput, completion: @escaping (ClientRuntime.SdkResult<DeleteCallAnalyticsCategoryOutputResponse, DeleteCallAnalyticsCategoryOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "transcribe")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteCallAnalyticsCategoryInput, DeleteCallAnalyticsCategoryOutputResponse, DeleteCallAnalyticsCategoryOutputError>(id: "deleteCallAnalyticsCategory")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteCallAnalyticsCategoryInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteCallAnalyticsCategoryInputQueryItemMiddleware())
    ...
    public func deleteCallAnalyticsJob(input: DeleteCallAnalyticsJobInput, completion: @escaping (ClientRuntime.SdkResult<DeleteCallAnalyticsJobOutputResponse, DeleteCallAnalyticsJobOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "transcribe")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteCallAnalyticsJobInput, DeleteCallAnalyticsJobOutputResponse, DeleteCallAnalyticsJobOutputError>(id: "deleteCallAnalyticsJob")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteCallAnalyticsJobInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteCallAnalyticsJobInputQueryItemMiddleware())
    ...
    public func getCallAnalyticsCategory(input: GetCallAnalyticsCategoryInput, completion: @escaping (ClientRuntime.SdkResult<GetCallAnalyticsCategoryOutputResponse, GetCallAnalyticsCategoryOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "transcribe")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCallAnalyticsCategoryInput, GetCallAnalyticsCategoryOutputResponse, GetCallAnalyticsCategoryOutputError>(id: "getCallAnalyticsCategory")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetCallAnalyticsCategoryInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetCallAnalyticsCategoryInputQueryItemMiddleware())
    ...
    public func getCallAnalyticsJob(input: GetCallAnalyticsJobInput, completion: @escaping (ClientRuntime.SdkResult<GetCallAnalyticsJobOutputResponse, GetCallAnalyticsJobOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "transcribe")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCallAnalyticsJobInput, GetCallAnalyticsJobOutputResponse, GetCallAnalyticsJobOutputError>(id: "getCallAnalyticsJob")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetCallAnalyticsJobInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetCallAnalyticsJobInputQueryItemMiddleware())
    ...
    public func listCallAnalyticsCategories(input: ListCallAnalyticsCategoriesInput, completion: @escaping (ClientRuntime.SdkResult<ListCallAnalyticsCategoriesOutputResponse, ListCallAnalyticsCategoriesOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "transcribe")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListCallAnalyticsCategoriesInput, ListCallAnalyticsCategoriesOutputResponse, ListCallAnalyticsCategoriesOutputError>(id: "listCallAnalyticsCategories")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListCallAnalyticsCategoriesInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListCallAnalyticsCategoriesInputQueryItemMiddleware())
    ...
    public func listCallAnalyticsJobs(input: ListCallAnalyticsJobsInput, completion: @escaping (ClientRuntime.SdkResult<ListCallAnalyticsJobsOutputResponse, ListCallAnalyticsJobsOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "transcribe")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListCallAnalyticsJobsInput, ListCallAnalyticsJobsOutputResponse, ListCallAnalyticsJobsOutputError>(id: "listCallAnalyticsJobs")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListCallAnalyticsJobsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListCallAnalyticsJobsInputQueryItemMiddleware())
    ...
    public func startCallAnalyticsJob(input: StartCallAnalyticsJobInput, completion: @escaping (ClientRuntime.SdkResult<StartCallAnalyticsJobOutputResponse, StartCallAnalyticsJobOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "transcribe")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartCallAnalyticsJobInput, StartCallAnalyticsJobOutputResponse, StartCallAnalyticsJobOutputError>(id: "startCallAnalyticsJob")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: StartCallAnalyticsJobInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: StartCallAnalyticsJobInputQueryItemMiddleware())
        ...
        operation.serializeStep.intercept(position: .before, middleware: StartCallAnalyticsJobInputBodyMiddleware())
        operation.deserializeStep.intercept(position: .before, middleware: ClientRuntime.LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: AWSClientRuntime.RetryerMiddleware(retryer: config.retryer))
        let sigv4Config = AWSClientRuntime.SigV4Config(unsignedBody: false)
    ...
    public func updateCallAnalyticsCategory(input: UpdateCallAnalyticsCategoryInput, completion: @escaping (ClientRuntime.SdkResult<UpdateCallAnalyticsCategoryOutputResponse, UpdateCallAnalyticsCategoryOutputError>) -> Void)
    {
        ...
        let context = ClientRuntime.HttpContextBuilder()
                      ...
                      .withSigningName(value: "transcribe")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateCallAnalyticsCategoryInput, UpdateCallAnalyticsCategoryOutputResponse, UpdateCallAnalyticsCategoryOutputError>(id: "updateCallAnalyticsCategory")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: UpdateCallAnalyticsCategoryInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: UpdateCallAnalyticsCategoryInputQueryItemMiddleware())
        ...
        operation.serializeStep.intercept(position: .before, middleware: UpdateCallAnalyticsCategoryInputBodyMiddleware())
        operation.deserializeStep.intercept(position: .before, middleware: ClientRuntime.LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: AWSClientRuntime.EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: AWSClientRuntime.RetryerMiddleware(retryer: config.retryer))
        let sigv4Config = AWSClientRuntime.SigV4Config(unsignedBody: false)
