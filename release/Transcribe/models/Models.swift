...
extension TranscribeClientTypes {
    ...
    public struct CallAnalyticsJob: Swift.Equatable {
        ...
        public let callAnalyticsJobName: Swift.String?
        /// The status of the analytics job.
        public let callAnalyticsJobStatus: TranscribeClientTypes.CallAnalyticsJobStatus?
...
extension TranscribeClientTypes {
    ...
    public struct ChannelDefinition: Swift.Equatable {
        ...
        public let participantRole: TranscribeClientTypes.ParticipantRole?
...
public struct CreateMedicalVocabularyInput: Swift.Equatable {
    ...
    ///
    ///         For more information about Amazon S3 object names, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#object-keys">Object Keys in the Amazon S3 Developer Guide.
...
public struct CreateVocabularyFilterInput: Swift.Equatable {
    ...
    ///             defined for custom vocabularies. For a list of character sets, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/how-vocabulary.html#charsets">Character Sets for Custom Vocabularies.
...
public struct CreateVocabularyInput: Swift.Equatable {
    ...
    ///
    ///
    ///         For more information about S3 object names, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#object-keys">Object Keys in the Amazon S3 Developer Guide.
...
extension TranscribeClientTypes {
    ...
    public struct InterruptionFilter: Swift.Equatable {
        ...
        public let absoluteTimeRange: TranscribeClientTypes.AbsoluteTimeRange?
        /// Set to TRUE to look for a time period where there was no interruption.
        public let negate: Swift.Bool?
        ...
        public let relativeTimeRange: TranscribeClientTypes.RelativeTimeRange?
...
extension TranscribeClientTypes {
    ...
    public struct Media: Swift.Equatable {
        ...
        public let redactedMediaFileUri: Swift.String?
...
extension TranscribeClientTypes {
    ...
    public struct MedicalTranscriptionJob: Swift.Equatable {
        ...
        ///             job. If the value is PHI, you've configured the job to identify personal
...
extension TranscribeClientTypes {
    ...
    public struct RelativeTimeRange: Swift.Equatable {
        ...
        public let endPercentage: Swift.Int?
        ...
        ///             through the call. For a call that lasts 100,000 milliseconds, this example range would
        ///             apply from the 10,000 millisecond mark to the 50,000 millisecond mark.
        public let startPercentage: Swift.Int?
...
extension TranscribeClientTypes {
    ...
    public struct SentimentFilter: Swift.Equatable {
        ...
        /// This member is required.
        public let sentiments: [TranscribeClientTypes.SentimentValue]?
...
extension TranscribeClientTypes {
    ...
    public struct Settings: Swift.Equatable {
        ...
        ///                 tag to mark the word in the transcription output that matches the
        ///             vocabulary filter. When you set the filter method to tag, the words
        ///             matching your vocabulary filter are not masked or removed.
        public let vocabularyFilterMethod: TranscribeClientTypes.VocabularyFilterMethod?
...
public struct StartMedicalTranscriptionJobInput: Swift.Equatable {
    ...
    ///             Amazon Transcribe Medical to put files in the bucket. For more information, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/security_iam_id-based-policy-examples.html#auth-role-iam-user">Permissions Required for IAM User Roles.
...
public struct StartTranscriptionJobInput: Swift.Equatable {
    ...
    ///             to put files in the bucket. For more information, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/security_iam_id-based-policy-examples.html#auth-role-iam-user">Permissions Required for IAM User Roles.
    ///         You can specify an Amazon Web Services Key Management Service (KMS) key to encrypt the
    ///             output of your transcription using the OutputEncryptionKMSKeyId parameter.
...
extension TranscribeClientTypes {
    ...
    public struct TranscriptFilter: Swift.Equatable {
        ...
        /// This member is required.
        public let transcriptFilterType: TranscribeClientTypes.TranscriptFilterType?
...
extension TranscribeClientTypes {
    ...
    public struct TranscriptionJob: Swift.Equatable {
        ...
        ///
        ///                   Invalid file size: file size too large - The size of your audio
        ///                     file is larger than Amazon Transcribe can process. For more information, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/limits-guidelines.html#limits">Limits in the Amazon Transcribe Developer Guide.
        ///
        ///
        ///
        ///                   Invalid number of channels: number of channels too large - Your
        ///                     audio contains more channels than Amazon Transcribe is configured to process. To request
        ///                     additional channels, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html#limits-amazon-transcribe">Amazon Transcribe Limits in the Amazon Web Services
        ///                         General Reference.
        ///
        ///
        public let failureReason: Swift.String?
