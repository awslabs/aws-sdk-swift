...
public struct GetDomainDeliverabilityCampaignInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetDomainDeliverabilityCampaignOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetDomainDeliverabilityCampaignOutput>
