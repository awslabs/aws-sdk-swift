...
public class PinpointEmailClient {
    ...
    public class PinpointEmailClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("PinpointEmailClient")
...
public struct PinpointEmailClientLogHandlerFactory: SDKLogHandlerFactory {
