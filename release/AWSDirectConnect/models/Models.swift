...
public struct AcceptDirectConnectGatewayAssociationProposalInput: Swift.Equatable {
    ...
    var associatedGatewayOwnerAccount: Swift.String?
    /// The ID of the Direct Connect gateway.
    /// This member is required.
    var directConnectGatewayId: Swift.String?
    ...
    var overrideAllowedPrefixesToDirectConnectGateway: [DirectConnectClientTypes.RouteFilterPrefix]?
    /// The ID of the request proposal.
    /// This member is required.
    var proposalId: Swift.String?
...
public struct AcceptDirectConnectGatewayAssociationProposalOutputResponse: Swift.Equatable {
    ...
    var directConnectGatewayAssociation: DirectConnectClientTypes.DirectConnectGatewayAssociation?
...
public struct AllocateConnectionOnInterconnectOutputResponse: Swift.Equatable {
    ...
    var awsDevice: Swift.String?
    /// The Direct Connect endpoint that terminates the physical connection.
    var awsDeviceV2: Swift.String?
    /// The Direct Connect endpoint that terminates the logical connection. This device might be different than the device that terminates the physical connection.
    var awsLogicalDeviceId: Swift.String?
    ...
    var connectionState: DirectConnectClientTypes.ConnectionState?
    /// The MAC Security (MACsec) connection encryption mode. The valid values are no_encrypt, should_encrypt, and must_encrypt.
    var encryptionMode: Swift.String?
    /// Indicates whether the connection supports a secondary BGP peer in the same address family (IPv4/IPv6).
    var hasLogicalRedundancy: DirectConnectClientTypes.HasLogicalRedundancy?
    /// Indicates whether jumbo frames (9001 MTU) are supported.
    var jumboFrameCapable: Swift.Bool?
    /// The ID of the LAG.
    var lagId: Swift.String?
    /// The time of the most recent call to [DescribeLoa] for this connection.
    var loaIssueTime: ClientRuntime.Date?
    /// The location of the connection.
    var location: Swift.String?
    /// Indicates whether the connection supports MAC Security (MACsec).
    var macSecCapable: Swift.Bool?
    /// The MAC Security (MACsec) security keys associated with the connection.
    var macSecKeys: [DirectConnectClientTypes.MacSecKey]?
    /// The ID of the Amazon Web Services account that owns the connection.
    var ownerAccount: Swift.String?
    /// The name of the Direct Connect service provider associated with the connection.
    var partnerName: Swift.String?
...
public struct AllocatePrivateVirtualInterfaceInput: Swift.Equatable {
    ...
    /// This member is required.
    var newPrivateVirtualInterfaceAllocation: DirectConnectClientTypes.NewPrivateVirtualInterfaceAllocation?
...
public struct AllocatePrivateVirtualInterfaceOutputResponse: Swift.Equatable {
    ...
    var addressFamily: DirectConnectClientTypes.AddressFamily?
    /// The IP address assigned to the Amazon interface.
    var amazonAddress: Swift.String?
    /// The autonomous system number (ASN) for the Amazon side of the connection.
    var amazonSideAsn: Swift.Int?
    /// The autonomous system (AS) number for Border Gateway Protocol (BGP) configuration. The valid values are 1-2147483647.
    var asn: Swift.Int
    /// The authentication key for BGP configuration. This string has a minimum length of 6 characters and and a maximun lenth of 80 characters.
    var authKey: Swift.String?
    /// The Direct Connect endpoint that terminates the physical connection.
    var awsDeviceV2: Swift.String?
    /// The Direct Connect endpoint that terminates the logical connection. This device might be different than the device that terminates the physical connection.
    var awsLogicalDeviceId: Swift.String?
    /// The BGP peers configured on this virtual interface.
    var bgpPeers: [DirectConnectClientTypes.BGPPeer]?
    /// The ID of the connection.
    var connectionId: Swift.String?
    /// The IP address assigned to the customer interface.
    var customerAddress: Swift.String?
    /// The customer router configuration.
    var customerRouterConfig: Swift.String?
    /// The ID of the Direct Connect gateway.
    var directConnectGatewayId: Swift.String?
    /// Indicates whether jumbo frames (9001 MTU) are supported.
    var jumboFrameCapable: Swift.Bool?
    ...
    var routeFilterPrefixes: [DirectConnectClientTypes.RouteFilterPrefix]?
    /// Indicates whether SiteLink is enabled.
    var siteLinkEnabled: Swift.Bool?
    /// The tags associated with the virtual interface.
    var tags: [DirectConnectClientTypes.Tag]?
    /// The ID of the virtual private gateway. Applies only to private virtual interfaces.
    var virtualGatewayId: Swift.String?
    /// The ID of the virtual interface.
    var virtualInterfaceId: Swift.String?
    /// The name of the virtual interface assigned by the customer network. The name has a maximum of 100 characters. The following are valid characters: a-z, 0-9 and a hyphen (-).
    var virtualInterfaceName: Swift.String?
    ...
    var virtualInterfaceState: DirectConnectClientTypes.VirtualInterfaceState?
    /// The type of virtual interface. The possible values are private and public.
    var virtualInterfaceType: Swift.String?
    /// The ID of the VLAN.
    var vlan: Swift.Int
...
public struct AllocatePublicVirtualInterfaceInput: Swift.Equatable {
    ...
    /// This member is required.
    var newPublicVirtualInterfaceAllocation: DirectConnectClientTypes.NewPublicVirtualInterfaceAllocation?
...
public struct AllocateTransitVirtualInterfaceInput: Swift.Equatable {
    ...
    /// This member is required.
    var newTransitVirtualInterfaceAllocation: DirectConnectClientTypes.NewTransitVirtualInterfaceAllocation?
...
public struct AllocateTransitVirtualInterfaceOutputResponse: Swift.Equatable {
    /// Information about a virtual interface.
    var virtualInterface: DirectConnectClientTypes.VirtualInterface?
...
public struct AssociateHostedConnectionInput: Swift.Equatable {
    ...
    /// This member is required.
    var parentConnectionId: Swift.String?
...
extension DirectConnectClientTypes {
    ...
    public struct AssociatedGateway: Swift.Equatable {
        ...
        var type: DirectConnectClientTypes.GatewayType?
...
extension DirectConnectClientTypes {
    ...
    public struct BGPPeer: Swift.Equatable {
        ...
        var bgpPeerState: DirectConnectClientTypes.BGPPeerState?
        ...
        var bgpStatus: DirectConnectClientTypes.BGPStatus?
        /// The IP address assigned to the customer interface.
        var customerAddress: Swift.String?
...
extension ConfirmCustomerAgreementInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case agreementName
    }
...
public struct ConfirmCustomerAgreementInput: Swift.Equatable {
    ...
    var agreementName: Swift.String?
...
public struct CreateBGPPeerInput: Swift.Equatable {
    ...
    var newBGPPeer: DirectConnectClientTypes.NewBGPPeer?
    /// The ID of the virtual interface.
    var virtualInterfaceId: Swift.String?
...
public struct CreateDirectConnectGatewayAssociationInput: Swift.Equatable {
    ...
    var addAllowedPrefixesToDirectConnectGateway: [DirectConnectClientTypes.RouteFilterPrefix]?
    /// The ID of the Direct Connect gateway.
    /// This member is required.
    var directConnectGatewayId: Swift.String?
...
public struct CreateDirectConnectGatewayAssociationProposalInput: Swift.Equatable {
    ...
    /// This member is required.
    var directConnectGatewayOwnerAccount: Swift.String?
    /// The ID of the virtual private gateway or transit gateway.
    /// This member is required.
    var gatewayId: Swift.String?
    /// The Amazon VPC prefixes to no longer advertise to the Direct Connect gateway.
    var removeAllowedPrefixesToDirectConnectGateway: [DirectConnectClientTypes.RouteFilterPrefix]?
...
public struct CreateDirectConnectGatewayAssociationProposalOutputResponse: Swift.Equatable {
    ...
    var directConnectGatewayAssociationProposal: DirectConnectClientTypes.DirectConnectGatewayAssociationProposal?
...
public struct CreateDirectConnectGatewayInput: Swift.Equatable {
    ...
    /// This member is required.
    var directConnectGatewayName: Swift.String?
...
public struct CreateDirectConnectGatewayOutputResponse: Swift.Equatable {
    ...
    var directConnectGateway: DirectConnectClientTypes.DirectConnectGateway?
...
public struct CreateInterconnectInput: Swift.Equatable {
    ...
    /// This member is required.
    var interconnectName: Swift.String?
    /// The ID of the LAG.
    var lagId: Swift.String?
...
public struct CreateInterconnectOutputResponse: Swift.Equatable {
    ...
    var interconnectState: DirectConnectClientTypes.InterconnectState?
    /// Indicates whether jumbo frames (9001 MTU) are supported.
    var jumboFrameCapable: Swift.Bool?
    /// The ID of the LAG.
    var lagId: Swift.String?
...
public struct CreateLagInput: Swift.Equatable {
    ...
    var childConnectionTags: [DirectConnectClientTypes.Tag]?
    /// The ID of an existing dedicated connection to migrate to the LAG.
    var connectionId: Swift.String?
    /// The bandwidth of the individual physical dedicated connections bundled by the LAG. The possible values are 1Gbps and 10Gbps.
    /// This member is required.
    var connectionsBandwidth: Swift.String?
    /// The name of the LAG.
    /// This member is required.
    var lagName: Swift.String?
    /// The location for the LAG.
    /// This member is required.
    var location: Swift.String?
    /// The number of physical dedicated connections initially provisioned and bundled by the LAG.
    /// This member is required.
    var numberOfConnections: Swift.Int
...
public struct CreateLagOutputResponse: Swift.Equatable {
    ...
    var allowsHostedConnections: Swift.Bool
    ...
    var connections: [DirectConnectClientTypes.Connection]?
    ...
    var lagState: DirectConnectClientTypes.LagState?
...
public struct CreatePrivateVirtualInterfaceInput: Swift.Equatable {
    ...
    /// Information about the private virtual interface.
    /// This member is required.
    var newPrivateVirtualInterface: DirectConnectClientTypes.NewPrivateVirtualInterface?
...
public struct CreatePublicVirtualInterfaceInput: Swift.Equatable {
    ...
    /// Information about the public virtual interface.
    /// This member is required.
    var newPublicVirtualInterface: DirectConnectClientTypes.NewPublicVirtualInterface?
...
public struct CreateTransitVirtualInterfaceInput: Swift.Equatable {
    ...
    /// Information about the transit virtual interface.
    /// This member is required.
    var newTransitVirtualInterface: DirectConnectClientTypes.NewTransitVirtualInterface?
...
extension DirectConnectClientTypes.CustomerAgreement: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case agreementName
        case status
    }
...
public struct DescribeConnectionLoaInput: Swift.Equatable {
    ...
    var loaContentType: DirectConnectClientTypes.LoaContentType?
...
public struct DescribeConnectionLoaOutputResponse: Swift.Equatable {
    ...
    var loa: DirectConnectClientTypes.Loa?
...
public struct DescribeCustomerMetadataOutputResponse: Swift.Equatable {
    ...
    var agreements: [DirectConnectClientTypes.CustomerAgreement]?
    ...
    var nniPartnerType: DirectConnectClientTypes.NniPartnerType?
...
public struct DescribeDirectConnectGatewayAssociationProposalsInput: Swift.Equatable {
    /// The ID of the associated gateway.
    var associatedGatewayId: Swift.String?
    /// The ID of the Direct Connect gateway.
    var directConnectGatewayId: Swift.String?
...
public struct DescribeDirectConnectGatewayAssociationProposalsOutputResponse: Swift.Equatable {
    ...
    var directConnectGatewayAssociationProposals: [DirectConnectClientTypes.DirectConnectGatewayAssociationProposal]?
...
public struct DescribeDirectConnectGatewayAssociationsOutputResponse: Swift.Equatable {
    ...
    var directConnectGatewayAssociations: [DirectConnectClientTypes.DirectConnectGatewayAssociation]?
...
public struct DescribeDirectConnectGatewayAttachmentsOutputResponse: Swift.Equatable {
    /// The attachments.
    var directConnectGatewayAttachments: [DirectConnectClientTypes.DirectConnectGatewayAttachment]?
    /// The token to retrieve the next page.
    var nextToken: Swift.String?
...
public struct DescribeDirectConnectGatewaysOutputResponse: Swift.Equatable {
    ...
    var directConnectGateways: [DirectConnectClientTypes.DirectConnectGateway]?
    /// The token to retrieve the next page.
    var nextToken: Swift.String?
...
public struct DescribeInterconnectsOutputResponse: Swift.Equatable {
    /// The interconnects.
    var interconnects: [DirectConnectClientTypes.Interconnect]?
...
public struct DescribeLagsOutputResponse: Swift.Equatable {
    /// The LAGs.
    var lags: [DirectConnectClientTypes.Lag]?
...
public struct DescribeLoaOutputResponse: Swift.Equatable {
    ...
    var loaContent: ClientRuntime.Data?
    /// The standard media type for the LOA-CFA document. The only supported value is application/pdf.
    var loaContentType: DirectConnectClientTypes.LoaContentType?
...
public struct DescribeLocationsOutputResponse: Swift.Equatable {
    /// The locations.
    var locations: [DirectConnectClientTypes.Location]?
...
extension DescribeRouterConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DescribeRouterConfigurationInput: Swift.Equatable {
    ...
    var routerTypeIdentifier: Swift.String?
    /// The ID of the virtual interface.
    /// This member is required.
    var virtualInterfaceId: Swift.String?
...
public struct DescribeRouterConfigurationOutputResponse: Swift.Equatable {
    ...
    var router: DirectConnectClientTypes.RouterType?
...
public struct DescribeTagsOutputResponse: Swift.Equatable {
    ...
    var resourceTags: [DirectConnectClientTypes.ResourceTag]?
...
public struct DescribeVirtualGatewaysOutputResponse: Swift.Equatable {
    ...
    var virtualGateways: [DirectConnectClientTypes.VirtualGateway]?
...
public struct DescribeVirtualInterfacesOutputResponse: Swift.Equatable {
    ...
    var virtualInterfaces: [DirectConnectClientTypes.VirtualInterface]?
...
extension DirectConnectClientTypes {
    ...
    public struct DirectConnectGateway: Swift.Equatable {
        ...
        var directConnectGatewayState: DirectConnectClientTypes.DirectConnectGatewayState?
        /// The ID of the Amazon Web Services account that owns the Direct Connect gateway.
        var ownerAccount: Swift.String?
        /// The error message if the state of an object failed to advance.
        var stateChangeError: Swift.String?
...
extension DirectConnectClientTypes {
    ...
    public struct DirectConnectGatewayAssociation: Swift.Equatable {
        /// The Amazon VPC prefixes to advertise to the Direct Connect gateway.
        var allowedPrefixesToDirectConnectGateway: [DirectConnectClientTypes.RouteFilterPrefix]?
        /// Information about the associated gateway.
        var associatedGateway: DirectConnectClientTypes.AssociatedGateway?
        /// The ID of the Direct Connect gateway association.
        var associationId: Swift.String?
        ...
        var associationState: DirectConnectClientTypes.DirectConnectGatewayAssociationState?
        /// The ID of the Direct Connect gateway.
        var directConnectGatewayId: Swift.String?
        ...
        var virtualGatewayOwnerAccount: Swift.String?
        /// The Amazon Web Services Region where the virtual private gateway is located.
        @available(*, deprecated)
        var virtualGatewayRegion: Swift.String?
...
extension DirectConnectClientTypes {
    ...
    public struct DirectConnectGatewayAssociationProposal: Swift.Equatable {
        ...
        var existingAllowedPrefixesToDirectConnectGateway: [DirectConnectClientTypes.RouteFilterPrefix]?
        ...
        var proposalState: DirectConnectClientTypes.DirectConnectGatewayAssociationProposalState?
        /// The Amazon VPC prefixes to advertise to the Direct Connect gateway.
        var requestedAllowedPrefixesToDirectConnectGateway: [DirectConnectClientTypes.RouteFilterPrefix]?
...
extension DirectConnectClientTypes {
    ...
    public struct DirectConnectGatewayAttachment: Swift.Equatable {
        ...
        var attachmentState: DirectConnectClientTypes.DirectConnectGatewayAttachmentState?
        /// The type of attachment.
        var attachmentType: DirectConnectClientTypes.DirectConnectGatewayAttachmentType?
        /// The ID of the Direct Connect gateway.
        var directConnectGatewayId: Swift.String?
        /// The error message if the state of an object failed to advance.
        var stateChangeError: Swift.String?
        ...
        var virtualInterfaceId: Swift.String?
        /// The ID of the Amazon Web Services account that owns the virtual interface.
        var virtualInterfaceOwnerAccount: Swift.String?
        /// The Amazon Web Services Region where the virtual interface is located.
        var virtualInterfaceRegion: Swift.String?
...
public struct ListVirtualInterfaceTestHistoryOutputResponse: Swift.Equatable {
    ...
    var virtualInterfaceTestHistory: [DirectConnectClientTypes.VirtualInterfaceTestHistory]?
...
extension DirectConnectClientTypes {
    ...
    public struct Location: Swift.Equatable {
        ...
        var availableMacSecPortSpeeds: [Swift.String]?
        /// The available port speeds for the location.
        var availablePortSpeeds: [Swift.String]?
        /// The name of the service provider for the location.
        var availableProviders: [Swift.String]?
        /// The code for the location.
        var locationCode: Swift.String?
        /// The name of the location. This includes the name of the colocation partner and the physical site of the building.
        var locationName: Swift.String?
...
extension DirectConnectClientTypes.RouterType: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case platform
        case routerTypeIdentifier
        case software
...
extension DirectConnectClientTypes {
    ...
    public struct RouterType: Swift.Equatable {
        ...
        var vendor: Swift.String?
        /// The template for the virtual interface's router.
        var xsltTemplateName: Swift.String?
        /// The MAC Security (MACsec) template for the virtual interface's router.
        var xsltTemplateNameForMacSec: Swift.String?
...
public struct StartBgpFailoverTestInput: Swift.Equatable {
    ...
    var testDurationInMinutes: Swift.Int?
...
public struct StartBgpFailoverTestOutputResponse: Swift.Equatable {
    ...
    var virtualInterfaceTest: DirectConnectClientTypes.VirtualInterfaceTestHistory?
...
extension UpdateDirectConnectGatewayInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case directConnectGatewayId
...
public struct UpdateDirectConnectGatewayInput: Swift.Equatable {
    ...
    /// This member is required.
    var newDirectConnectGatewayName: Swift.String?
...
extension DirectConnectClientTypes {
    ...
    public struct VirtualGateway: Swift.Equatable {
        ...
        var virtualGatewayState: Swift.String?
