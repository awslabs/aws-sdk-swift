...
public extension DirectConnectClient {
    ...
    {
        typealias confirmCustomerAgreementContinuation = CheckedContinuation<ConfirmCustomerAgreementOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: confirmCustomerAgreementContinuation) in
            confirmCustomerAgreement(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeCustomerMetadataContinuation = CheckedContinuation<DescribeCustomerMetadataOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeCustomerMetadataContinuation) in
            describeCustomerMetadata(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeRouterConfigurationContinuation = CheckedContinuation<DescribeRouterConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeRouterConfigurationContinuation) in
            describeRouterConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateDirectConnectGatewayContinuation = CheckedContinuation<UpdateDirectConnectGatewayOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateDirectConnectGatewayContinuation) in
            updateDirectConnectGateway(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
