...
public class DirectConnectClient {
    ...
    let config: DirectConnectClientConfigurationProtocol
    let serviceName = "Direct Connect"
    let encoder: ClientRuntime.RequestEncoder
    let decoder: ClientRuntime.ResponseDecoder

    public init(config: DirectConnectClientConfigurationProtocol) {
    ...
    public class DirectConnectClientConfiguration: DirectConnectClientConfigurationProtocol {
        ...
        public convenience init(
            ...
            let runtimeConfig = try ClientRuntime.DefaultSDKRuntimeConfiguration("DirectConnectClient")
            try self.init(
