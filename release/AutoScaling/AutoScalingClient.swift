...
public class AutoScalingClient {
    ...
    public class AutoScalingClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("AutoScalingClient")
...
public struct AutoScalingClientLogHandlerFactory: SDKLogHandlerFactory {
