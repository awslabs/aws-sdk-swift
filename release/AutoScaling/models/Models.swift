...
extension ActiveInstanceRefreshNotFoundFault: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
            let output: ErrorResponseContainer<ActiveInstanceRefreshNotFoundFaultBody> = try responseDecoder.decode(responseBody: data)
...
///             not found. </p>
public struct ActiveInstanceRefreshNotFoundFault: ClientRuntime.ServiceError, Swift.Equatable {
...
extension AutoScalingClientTypes {
    ...
    public struct Activity: Swift.Equatable {
        ...
        ///                 <code>Deleted</code>.</p>
        public let autoScalingGroupState: Swift.String?
        ...
        public let statusCode: AutoScalingClientTypes.ScalingActivityStatusCode?
...
extension AutoScalingClientTypes {
    ...
    public struct AdjustmentType: Swift.Equatable {
        ...
        public let adjustmentType: Swift.String?
...
extension AlreadyExistsFault: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
            let output: ErrorResponseContainer<AlreadyExistsFaultBody> = try responseDecoder.decode(responseBody: data)
            self.message = output.error.message
        } else {
            self.message = nil
        }
...
public struct AlreadyExistsFault: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension AutoScalingClientTypes {
    ...
    public struct AutoScalingGroup: Swift.Equatable {
        ...
        public let launchTemplate: AutoScalingClientTypes.LaunchTemplateSpecification?
        ...
        public let predictedCapacity: Swift.Int?
        ...
        public let serviceLinkedRoleARN: Swift.String?
        /// <p>The current state of the group when the <a>DeleteAutoScalingGroup</a>
        ///             operation is in progress.</p>
        public let status: Swift.String?
        /// <p>The suspended processes associated with the group.</p>
        public let suspendedProcesses: [AutoScalingClientTypes.SuspendedProcess]?
        ...
        public let terminationPolicies: [Swift.String]?
        /// <p>One or more subnet IDs, if applicable, separated by commas.</p>
        public let vPCZoneIdentifier: Swift.String?
        ...
        public let warmPoolSize: Swift.Int?
...
extension AutoScalingClientTypes {
    ...
    public struct AutoScalingInstanceDetails: Swift.Equatable {
        ...
        ///             in.</p>
        public let protectedFromScaleIn: Swift.Bool?
        ...
        public let weightedCapacity: Swift.String?
...
public struct BatchPutScheduledUpdateGroupActionInput: Swift.Equatable {
    ...
    public let scheduledUpdateGroupActions: [AutoScalingClientTypes.ScheduledUpdateGroupActionRequest]?
...
extension AutoScalingClientTypes {
    ...
    public struct BlockDeviceMapping: Swift.Equatable {
        ...
        ///             both.</p>
        public let ebs: AutoScalingClientTypes.Ebs?
        ...
        public let noDevice: Swift.Bool?
...
public struct CompleteLifecycleActionInput: Swift.Equatable {
    ...
    public let lifecycleActionResult: Swift.String?
    ...
    public let lifecycleActionToken: Swift.String?
    /// <p>The name of the lifecycle hook.</p>
    public let lifecycleHookName: Swift.String?
...
public struct CreateAutoScalingGroupInput: Swift.Equatable {
    ...
    public let lifecycleHookSpecificationList: [AutoScalingClientTypes.LifecycleHookSpecification]?
    ...
    public let tags: [AutoScalingClientTypes.Tag]?
...
public struct CreateLaunchConfigurationInput: Swift.Equatable {
    ...
    public let blockDeviceMappings: [AutoScalingClientTypes.BlockDeviceMapping]?
    ...
    public let classicLinkVPCId: Swift.String?
    ...
    ///             parameter.</p>
    public let classicLinkVPCSecurityGroups: [Swift.String]?
    ...
    ///                 <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    ///         </important>
    public let instanceMonitoring: AutoScalingClientTypes.InstanceMonitoring?
    ...
    ///                 <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    public let metadataOptions: AutoScalingClientTypes.InstanceMetadataOptions?
    ...
    ///         </p>
    public let placementTenancy: Swift.String?
    ...
    ///         </note>
    public let spotPrice: Swift.String?
...
extension AutoScalingClientTypes {
    ...
    public struct CustomizedMetricSpecification: Swift.Equatable {
        ...
        public let dimensions: [AutoScalingClientTypes.MetricDimension]?
        /// <p>The name of the metric.</p>
        public let metricName: Swift.String?
        /// <p>The namespace of the metric.</p>
        public let namespace: Swift.String?
        /// <p>The statistic of the metric.</p>
        public let statistic: AutoScalingClientTypes.MetricStatistic?
...
public struct DescribeAutoScalingGroupsInput: Swift.Equatable {
    ...
    public let autoScalingGroupNames: [Swift.String]?
...
public struct DescribeInstanceRefreshesInput: Swift.Equatable {
    ...
    public let instanceRefreshIds: [Swift.String]?
    /// <p>The maximum number of items to return with this call. The default value is
    ///                 <code>50</code> and the maximum value is <code>100</code>.</p>
    public let maxRecords: Swift.Int?
    /// <p>The token for the next set of items to return. (You received this token from a
...
public struct DescribeLaunchConfigurationsInput: Swift.Equatable {
    ...
    ///             are described.</p>
    ///         <p>Array Members: Maximum number of 50 items.</p>
    public let launchConfigurationNames: [Swift.String]?
    /// <p>The maximum number of items to return with this call. The default value is
    ///                 <code>50</code> and the maximum value is <code>100</code>.</p>
    public let maxRecords: Swift.Int?
    /// <p>The token for the next set of items to return. (You received this token from a
...
public struct DescribeLifecycleHooksInput: Swift.Equatable {
    ...
    public let lifecycleHookNames: [Swift.String]?
...
public struct DescribePoliciesInput: Swift.Equatable {
    ...
    public let policyTypes: [Swift.String]?
...
public struct DescribeTagsInput: Swift.Equatable {
    ...
    public let filters: [AutoScalingClientTypes.Filter]?
    /// <p>The maximum number of items to return with this call. The default value is
    ///                 <code>50</code> and the maximum value is <code>100</code>.</p>
    public let maxRecords: Swift.Int?
    /// <p>The token for the next set of items to return. (You received this token from a
...
public struct DetachInstancesInput: Swift.Equatable {
    ...
    public let shouldDecrementDesiredCapacity: Swift.Bool?
...
extension AutoScalingClientTypes {
    ...
    public struct Ebs: Swift.Equatable {
        ...
        public let throughput: Swift.Int?
...
public struct EnableMetricsCollectionInput: Swift.Equatable {
    ...
    ///                 <code>1Minute</code>.</p>
    public let granularity: Swift.String?
...
public struct ExecutePolicyInput: Swift.Equatable {
    ...
    ///             otherwise.</p>
    public let breachThreshold: Swift.Double?
    ...
    public let honorCooldown: Swift.Bool?
    ...
    ///         <p>Required if the policy type is <code>StepScaling</code> and not supported
    ///             otherwise.</p>
    public let metricValue: Swift.Double?
...
extension AutoScalingClientTypes {
    ...
    public struct Instance: Swift.Equatable {
        ...
        ///                 lifecycle</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>. </p>
        public let lifecycleState: AutoScalingClientTypes.LifecycleState?
        /// <p>Indicates whether the instance is protected from termination by Amazon EC2 Auto Scaling when scaling
        ///             in.</p>
        public let protectedFromScaleIn: Swift.Bool?
        /// <p>The number of capacity units contributed by the instance based on its instance
...
extension AutoScalingClientTypes {
    ...
    public struct InstanceMetadataOptions: Swift.Equatable {
        ...
        ///         </note>
        public let httpEndpoint: AutoScalingClientTypes.InstanceMetadataEndpointState?
        /// <p>The desired HTTP PUT response hop limit for instance metadata requests. The larger the
        ///             number, the further instance metadata requests can travel.</p>
        ///         <p>Default: 1</p>
        public let httpPutResponseHopLimit: Swift.Int?
        ...
        ///             available.</p>
        public let httpTokens: AutoScalingClientTypes.InstanceMetadataHttpTokensState?
...
extension AutoScalingClientTypes.InstanceRefresh: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InstanceRefresh(autoScalingGroupName: \(Swift.String(describing: autoScalingGroupName)), endTime: \(Swift.String(describing: endTime)), instanceRefreshId: \(Swift.String(describing: instanceRefreshId)), instancesToUpdate: \(Swift.String(describing: instancesToUpdate)), percentageComplete: \(Swift.String(describing: percentageComplete)), progressDetails: \(Swift.String(describing: progressDetails)), startTime: \(Swift.String(describing: startTime)), status: \(Swift.String(describing: status)), statusReason: \(Swift.String(describing: statusReason)))"}
}
...
extension AutoScalingClientTypes {
    ...
    public struct InstanceRefresh: Swift.Equatable {
        ...
        ///             complete.</p>
        public let instancesToUpdate: Swift.Int?
        ...
        public let percentageComplete: Swift.Int?
        /// <p>Additional progress details for an Auto Scaling group that has a warm pool.</p>
        public let progressDetails: AutoScalingClientTypes.InstanceRefreshProgressDetails?
        ...
        ///             </li>
        ///          </ul>
        public let status: AutoScalingClientTypes.InstanceRefreshStatus?
...
extension InstanceRefreshInProgressFault: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
            let output: ErrorResponseContainer<InstanceRefreshInProgressFaultBody> = try responseDecoder.decode(responseBody: data)
            self.message = output.error.message
        } else {
            self.message = nil
        }
...
public struct InstanceRefreshInProgressFault: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension AutoScalingClientTypes {
    ...
    public struct InstanceRefreshProgressDetails: Swift.Equatable {
        ...
        ///             group.</p>
        public let livePoolProgress: AutoScalingClientTypes.InstanceRefreshLivePoolProgress?
        /// <p>Indicates the progress of an instance refresh on instances that are in the warm
        ///             pool.</p>
        public let warmPoolProgress: AutoScalingClientTypes.InstanceRefreshWarmPoolProgress?
...
extension AutoScalingClientTypes {
    ...
    public struct InstancesDistribution: Swift.Equatable {
        ...
        public let onDemandAllocationStrategy: Swift.String?
        ...
        public let onDemandBaseCapacity: Swift.Int?
        ...
        public let onDemandPercentageAboveBaseCapacity: Swift.Int?
        ...
        public let spotAllocationStrategy: Swift.String?
        ...
        public let spotInstancePools: Swift.Int?
        ...
        public let spotMaxPrice: Swift.String?
...
extension AutoScalingClientTypes {
    ...
    public struct LaunchConfiguration: Swift.Equatable {
        ...
        public let launchConfigurationARN: Swift.String?
        /// <p>The name of the launch configuration.</p>
        public let launchConfigurationName: Swift.String?
        /// <p>The metadata options for the instances. For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-launch-config.html#launch-configurations-imds">Configuring the Instance Metadata Options</a> in the
        ///                 <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
...
extension AutoScalingClientTypes {
    ...
    public struct LaunchTemplate: Swift.Equatable {
        ...
        public let launchTemplateSpecification: AutoScalingClientTypes.LaunchTemplateSpecification?
        ...
        public let overrides: [AutoScalingClientTypes.LaunchTemplateOverrides]?
...
extension AutoScalingClientTypes {
    ...
    public struct LifecycleHook: Swift.Equatable {
        ...
        ///                 <code>ABANDON</code>.</p>
        public let defaultResult: Swift.String?
        ...
        ///             smaller.</p>
        public let globalTimeout: Swift.Int?
        ...
        public let heartbeatTimeout: Swift.Int?
        /// <p>The name of the lifecycle hook.</p>
        public let lifecycleHookName: Swift.String?
        ...
        public let notificationTargetARN: Swift.String?
...
extension AutoScalingClientTypes {
    ...
    public struct LoadBalancerTargetGroupState: Swift.Equatable {
        ...
        public let loadBalancerTargetGroupARN: Swift.String?
...
extension AutoScalingClientTypes {
    ...
    public struct LoadForecast: Swift.Equatable {
        ...
        public let metricSpecification: AutoScalingClientTypes.PredictiveScalingMetricSpecification?
        /// <p>The time stamps for the data points, in UTC format.</p>
        public let timestamps: [ClientRuntime.Date]?
        /// <p>The values of the data points.</p>
        public let values: [Swift.Double]?
...
extension AutoScalingClientTypes {
    ...
    public struct MixedInstancesPolicy: Swift.Equatable {
        ...
        public let instancesDistribution: AutoScalingClientTypes.InstancesDistribution?
        ...
        public let launchTemplate: AutoScalingClientTypes.LaunchTemplate?
...
extension AutoScalingClientTypes {
    ...
    public struct PredefinedMetricSpecification: Swift.Equatable {
        ...
        ///             </li>
        ///          </ul>
        public let predefinedMetricType: AutoScalingClientTypes.MetricType?
...
extension AutoScalingClientTypes {
    ...
    public struct PredictiveScalingConfiguration: Swift.Equatable {
        ...
        ///             </li>
        ///          </ul>
        public let maxCapacityBreachBehavior: AutoScalingClientTypes.PredictiveScalingMaxCapacityBreachBehavior?
        ...
        public let maxCapacityBuffer: Swift.Int?
        ...
        public let metricSpecifications: [AutoScalingClientTypes.PredictiveScalingMetricSpecification]?
        /// <p>The predictive scaling mode. Defaults to <code>ForecastOnly</code> if not
        ///             specified.</p>
        public let mode: AutoScalingClientTypes.PredictiveScalingMode?
        ...
        public let schedulingBufferTime: Swift.Int?
...
extension AutoScalingClientTypes {
    ...
    public struct PredictiveScalingMetricSpecification: Swift.Equatable {
        ...
        public let predefinedLoadMetricSpecification: AutoScalingClientTypes.PredictiveScalingPredefinedLoadMetric?
        ...
        public let predefinedMetricPairSpecification: AutoScalingClientTypes.PredictiveScalingPredefinedMetricPair?
        /// <p>The scaling metric specification.</p>
        public let predefinedScalingMetricSpecification: AutoScalingClientTypes.PredictiveScalingPredefinedScalingMetric?
...
extension AutoScalingClientTypes {
    ...
    public struct PredictiveScalingPredefinedLoadMetric: Swift.Equatable {
        /// <p>The metric type.</p>
        public let predefinedMetricType: AutoScalingClientTypes.PredefinedLoadMetricType?
...
extension AutoScalingClientTypes {
    ...
    public struct PredictiveScalingPredefinedMetricPair: Swift.Equatable {
        ...
        public let predefinedMetricType: AutoScalingClientTypes.PredefinedMetricPairType?
        /// <p>A label that uniquely identifies a specific Application Load Balancer target
        ///             group from which to determine the request count served by your Auto Scaling group. You can't specify a resource label
        ///             unless the target group is attached to the Auto Scaling group.</p>
        ///         <p>You create the resource label by appending the final portion of the load balancer ARN
...
extension AutoScalingClientTypes {
    ...
    public struct PredictiveScalingPredefinedScalingMetric: Swift.Equatable {
        /// <p>The metric type.</p>
        public let predefinedMetricType: AutoScalingClientTypes.PredefinedScalingMetricType?
        /// <p>A label that uniquely identifies a specific Application Load Balancer target
        ///             group from which to determine the request count served by your Auto Scaling group. You can't specify a resource label
        ///             unless the target group is attached to the Auto Scaling group.</p>
        ///         <p>You create the resource label by appending the final portion of the load balancer ARN
...
public struct PutNotificationConfigurationInput: Swift.Equatable {
    ...
    public let notificationTypes: [Swift.String]?
    /// <p>The Amazon Resource Name (ARN) of the Amazon Simple Notification Service (Amazon SNS)
    ///             topic.</p>
    public let topicARN: Swift.String?
...
public struct PutScalingPolicyInput: Swift.Equatable {
    ...
    public let metricAggregationType: Swift.String?
    ...
    public let minAdjustmentStep: Swift.Int?
    /// <p>The name of the policy.</p>
    public let policyName: Swift.String?
    ...
    ///             </li>
    ///          </ul>
    public let policyType: Swift.String?
    ...
    public let predictiveScalingConfiguration: AutoScalingClientTypes.PredictiveScalingConfiguration?
    ...
    ///             policy type.) </p>
    public let stepAdjustments: [AutoScalingClientTypes.StepAdjustment]?
    ...
    public let targetTrackingConfiguration: AutoScalingClientTypes.TargetTrackingConfiguration?
...
public struct PutWarmPoolInput: Swift.Equatable {
    ...
    public let maxGroupPreparedCapacity: Swift.Int?
    ...
    public let poolState: AutoScalingClientTypes.WarmPoolState?
...
extension AutoScalingClientTypes.RefreshPreferences: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RefreshPreferences(checkpointDelay: \(Swift.String(describing: checkpointDelay)), checkpointPercentages: \(Swift.String(describing: checkpointPercentages)), instanceWarmup: \(Swift.String(describing: instanceWarmup)), minHealthyPercentage: \(Swift.String(describing: minHealthyPercentage)))"}
}
...
extension AutoScalingClientTypes {
    ...
    public struct RefreshPreferences: Swift.Equatable {
        ...
        public let checkpointDelay: Swift.Int?
        ...
        ///             <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
        public let checkpointPercentages: [Swift.Int]?
        ...
        ///             group.</p>
        public let instanceWarmup: Swift.Int?
        ...
        ///         </p>
        public let minHealthyPercentage: Swift.Int?
...
extension ResourceContentionFault: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
            let output: ErrorResponseContainer<ResourceContentionFaultBody> = try responseDecoder.decode(responseBody: data)
            self.message = output.error.message
        } else {
            self.message = nil
        }
...
public struct ResourceContentionFault: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension ResourceInUseFault: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
            let output: ErrorResponseContainer<ResourceInUseFaultBody> = try responseDecoder.decode(responseBody: data)
            self.message = output.error.message
        } else {
            self.message = nil
        }
...
public struct ResourceInUseFault: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
public struct ResumeProcessesInput: Swift.Equatable {
    ...
    public let scalingProcesses: [Swift.String]?
...
extension ScalingActivityInProgressFault: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
            let output: ErrorResponseContainer<ScalingActivityInProgressFaultBody> = try responseDecoder.decode(responseBody: data)
            self.message = output.error.message
        } else {
            self.message = nil
        }
...
///             progress.</p>
public struct ScalingActivityInProgressFault: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
extension ServiceLinkedRoleFailure: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
            let output: ErrorResponseContainer<ServiceLinkedRoleFailureBody> = try responseDecoder.decode(responseBody: data)
            self.message = output.error.message
        } else {
            self.message = nil
        }
...
public struct ServiceLinkedRoleFailure: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
...
public struct SetInstanceHealthInput: Swift.Equatable {
    ...
    ///             Reference</i>.</p>
    public let shouldRespectGracePeriod: Swift.Bool?
...
extension StartInstanceRefreshInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartInstanceRefreshInput(autoScalingGroupName: \(Swift.String(describing: autoScalingGroupName)), preferences: \(Swift.String(describing: preferences)), strategy: \(Swift.String(describing: strategy)))"}
}
...
public struct StartInstanceRefreshInput: Swift.Equatable {
    ...
    ///             Reference</i>.</p>
    public let preferences: AutoScalingClientTypes.RefreshPreferences?
    ...
    public let strategy: AutoScalingClientTypes.RefreshStrategy?
...
extension AutoScalingClientTypes {
    ...
    public struct SuspendedProcess: Swift.Equatable {
        ...
        public let suspensionReason: Swift.String?
...
extension AutoScalingClientTypes {
    ...
    public struct Tag: Swift.Equatable {
        ...
        ///             group.</p>
        public let propagateAtLaunch: Swift.Bool?
        /// <p>The name of the Auto Scaling group.</p>
...
extension AutoScalingClientTypes {
    ...
    public struct TargetTrackingConfiguration: Swift.Equatable {
        ...
        ///             metric.</p>
        public let customizedMetricSpecification: AutoScalingClientTypes.CustomizedMetricSpecification?
        ...
        ///             metric.</p>
        public let predefinedMetricSpecification: AutoScalingClientTypes.PredefinedMetricSpecification?
...
extension UpdateAutoScalingGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateAutoScalingGroupInput(autoScalingGroupName: \(Swift.String(describing: autoScalingGroupName)), availabilityZones: \(Swift.String(describing: availabilityZones)), capacityRebalance: \(Swift.String(describing: capacityRebalance)), defaultCooldown: \(Swift.String(describing: defaultCooldown)), desiredCapacity: \(Swift.String(describing: desiredCapacity)), healthCheckGracePeriod: \(Swift.String(describing: healthCheckGracePeriod)), healthCheckType: \(Swift.String(describing: healthCheckType)), launchConfigurationName: \(Swift.String(describing: launchConfigurationName)), launchTemplate: \(Swift.String(describing: launchTemplate)), maxInstanceLifetime: \(Swift.String(describing: maxInstanceLifetime)), maxSize: \(Swift.String(describing: maxSize)), minSize: \(Swift.String(describing: minSize)), mixedInstancesPolicy: \(Swift.String(describing: mixedInstancesPolicy)), newInstancesProtectedFromScaleIn: \(Swift.String(describing: newInstancesProtectedFromScaleIn)), placementGroup: \(Swift.String(describing: placementGroup)), serviceLinkedRoleARN: \(Swift.String(describing: serviceLinkedRoleARN)), terminationPolicies: \(Swift.String(describing: terminationPolicies)), vPCZoneIdentifier: \(Swift.String(describing: vPCZoneIdentifier)))"}
}
...
extension AutoScalingClientTypes {
    ...
    public struct WarmPoolConfiguration: Swift.Equatable {
        ...
        public let status: AutoScalingClientTypes.WarmPoolStatus?
