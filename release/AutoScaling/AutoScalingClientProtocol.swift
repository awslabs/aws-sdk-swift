...
public protocol AutoScalingClientProtocol {
    ...
    func attachInstances(input: AttachInstancesInput, completion: @escaping (SdkResult<AttachInstancesOutputResponse, AttachInstancesOutputError>) -> Void)
    /// <note>
    ...
    func attachLoadBalancers(input: AttachLoadBalancersInput, completion: @escaping (SdkResult<AttachLoadBalancersOutputResponse, AttachLoadBalancersOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-load-balancer.html">Elastic Load Balancing and
    ///                 Amazon EC2 Auto Scaling</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>. </p>
    func attachLoadBalancerTargetGroups(input: AttachLoadBalancerTargetGroupsInput, completion: @escaping (SdkResult<AttachLoadBalancerTargetGroupsOutputResponse, AttachLoadBalancerTargetGroupsOutputError>) -> Void)
    /// <p>Deletes one or more scheduled actions for the specified Auto Scaling group.</p>
    func batchDeleteScheduledAction(input: BatchDeleteScheduledActionInput, completion: @escaping (SdkResult<BatchDeleteScheduledActionOutputResponse, BatchDeleteScheduledActionOutputError>) -> Void)
    /// <p>Creates or updates one or more scheduled scaling actions for an Auto Scaling group.</p>
    func batchPutScheduledUpdateGroupAction(input: BatchPutScheduledUpdateGroupActionInput, completion: @escaping (SdkResult<BatchPutScheduledUpdateGroupActionOutputResponse, BatchPutScheduledUpdateGroupActionOutputError>) -> Void)
    ...
    func cancelInstanceRefresh(input: CancelInstanceRefreshInput, completion: @escaping (SdkResult<CancelInstanceRefreshOutputResponse, CancelInstanceRefreshOutputError>) -> Void)
    ...
    func completeLifecycleAction(input: CompleteLifecycleActionInput, completion: @escaping (SdkResult<CompleteLifecycleActionOutputResponse, CompleteLifecycleActionOutputError>) -> Void)
    /// <p>
    ...
    func createAutoScalingGroup(input: CreateAutoScalingGroupInput, completion: @escaping (SdkResult<CreateAutoScalingGroupOutputResponse, CreateAutoScalingGroupOutputError>) -> Void)
    ...
    func createLaunchConfiguration(input: CreateLaunchConfigurationInput, completion: @escaping (SdkResult<CreateLaunchConfigurationOutputResponse, CreateLaunchConfigurationOutputError>) -> Void)
    ...
    func createOrUpdateTags(input: CreateOrUpdateTagsInput, completion: @escaping (SdkResult<CreateOrUpdateTagsOutputResponse, CreateOrUpdateTagsOutputError>) -> Void)
    ...
    func deleteAutoScalingGroup(input: DeleteAutoScalingGroupInput, completion: @escaping (SdkResult<DeleteAutoScalingGroupOutputResponse, DeleteAutoScalingGroupOutputError>) -> Void)
    ...
    func deleteLaunchConfiguration(input: DeleteLaunchConfigurationInput, completion: @escaping (SdkResult<DeleteLaunchConfigurationOutputResponse, DeleteLaunchConfigurationOutputError>) -> Void)
    ...
    ///             instances).</p>
    func deleteLifecycleHook(input: DeleteLifecycleHookInput, completion: @escaping (SdkResult<DeleteLifecycleHookOutputResponse, DeleteLifecycleHookOutputError>) -> Void)
    /// <p>Deletes the specified notification.</p>
    func deleteNotificationConfiguration(input: DeleteNotificationConfigurationInput, completion: @escaping (SdkResult<DeleteNotificationConfigurationOutputResponse, DeleteNotificationConfigurationOutputError>) -> Void)
    ...
    ///                 Amazon EC2 Auto Scaling</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    func deleteWarmPool(input: DeleteWarmPoolInput, completion: @escaping (SdkResult<DeleteWarmPoolOutputResponse, DeleteWarmPoolOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeAdjustmentTypes(input: DescribeAdjustmentTypesInput, completion: @escaping (SdkResult<DescribeAdjustmentTypesOutputResponse, DescribeAdjustmentTypesOutputError>) -> Void)
    ...
    func describeAutoScalingGroups(input: DescribeAutoScalingGroupsInput, completion: @escaping (SdkResult<DescribeAutoScalingGroupsOutputResponse, DescribeAutoScalingGroupsOutputError>) -> Void)
    /// <p>Gets information about the Auto Scaling instances in the account and Region.</p>
    func describeAutoScalingInstances(input: DescribeAutoScalingInstancesInput, completion: @escaping (SdkResult<DescribeAutoScalingInstancesOutputResponse, DescribeAutoScalingInstancesOutputError>) -> Void)
    /// <p>Describes the notification types that are supported by Amazon EC2 Auto Scaling.</p>
    func describeAutoScalingNotificationTypes(input: DescribeAutoScalingNotificationTypesInput, completion: @escaping (SdkResult<DescribeAutoScalingNotificationTypesOutputResponse, DescribeAutoScalingNotificationTypesOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeInstanceRefreshes(input: DescribeInstanceRefreshesInput, completion: @escaping (SdkResult<DescribeInstanceRefreshesOutputResponse, DescribeInstanceRefreshesOutputError>) -> Void)
    /// <p>Gets information about the launch configurations in the account and Region.</p>
    func describeLaunchConfigurations(input: DescribeLaunchConfigurationsInput, completion: @escaping (SdkResult<DescribeLaunchConfigurationsOutputResponse, DescribeLaunchConfigurationsOutputError>) -> Void)
    /// <p>Gets information about the lifecycle hooks for the specified Auto Scaling group.</p>
    func describeLifecycleHooks(input: DescribeLifecycleHooksInput, completion: @escaping (SdkResult<DescribeLifecycleHooksOutputResponse, DescribeLifecycleHooksOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeLifecycleHookTypes(input: DescribeLifecycleHookTypesInput, completion: @escaping (SdkResult<DescribeLifecycleHookTypesOutputResponse, DescribeLifecycleHookTypesOutputError>) -> Void)
    ...
    ///             information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-load-balancer.html">Elastic Load Balancing and
    ///                 Amazon EC2 Auto Scaling</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>. </p>
    func describeLoadBalancerTargetGroups(input: DescribeLoadBalancerTargetGroupsInput, completion: @escaping (SdkResult<DescribeLoadBalancerTargetGroupsOutputResponse, DescribeLoadBalancerTargetGroupsOutputError>) -> Void)
    ...
    func describeMetricCollectionTypes(input: DescribeMetricCollectionTypesInput, completion: @escaping (SdkResult<DescribeMetricCollectionTypesOutputResponse, DescribeMetricCollectionTypesOutputError>) -> Void)
    /// <p>Gets information about the Amazon SNS notifications that are configured for one or more
    ///             Auto Scaling groups.</p>
    func describeNotificationConfigurations(input: DescribeNotificationConfigurationsInput, completion: @escaping (SdkResult<DescribeNotificationConfigurationsOutputResponse, DescribeNotificationConfigurationsOutputError>) -> Void)
    /// <p>Gets information about the scaling policies in the account and Region.</p>
    func describePolicies(input: DescribePoliciesInput, completion: @escaping (SdkResult<DescribePoliciesOutputResponse, DescribePoliciesOutputError>) -> Void)
    ...
    func describeScalingProcessTypes(input: DescribeScalingProcessTypesInput, completion: @escaping (SdkResult<DescribeScalingProcessTypesOutputResponse, DescribeScalingProcessTypesOutputError>) -> Void)
    ...
    func describeTerminationPolicyTypes(input: DescribeTerminationPolicyTypesInput, completion: @escaping (SdkResult<DescribeTerminationPolicyTypesOutputResponse, DescribeTerminationPolicyTypesOutputError>) -> Void)
    /// <p>Gets information about a warm pool and its instances.</p>
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-warm-pools.html">Warm pools for
    ///             Amazon EC2 Auto Scaling</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    func describeWarmPool(input: DescribeWarmPoolInput, completion: @escaping (SdkResult<DescribeWarmPoolOutputResponse, DescribeWarmPoolOutputError>) -> Void)
    ...
    ///                 your Auto Scaling group</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    func detachInstances(input: DetachInstancesInput, completion: @escaping (SdkResult<DetachInstancesOutputResponse, DetachInstancesOutputError>) -> Void)
    ...
    func detachLoadBalancers(input: DetachLoadBalancersInput, completion: @escaping (SdkResult<DetachLoadBalancersOutputResponse, DetachLoadBalancersOutputError>) -> Void)
    /// <p>Detaches one or more target groups from the specified Auto Scaling group.</p>
    func detachLoadBalancerTargetGroups(input: DetachLoadBalancerTargetGroupsInput, completion: @escaping (SdkResult<DetachLoadBalancerTargetGroupsOutputResponse, DetachLoadBalancerTargetGroupsOutputError>) -> Void)
    /// <p>Disables group metrics for the specified Auto Scaling group.</p>
    func disableMetricsCollection(input: DisableMetricsCollectionInput, completion: @escaping (SdkResult<DisableMetricsCollectionOutputResponse, DisableMetricsCollectionOutputError>) -> Void)
    ...
    ///                 <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    func enableMetricsCollection(input: EnableMetricsCollectionInput, completion: @escaping (SdkResult<EnableMetricsCollectionOutputResponse, EnableMetricsCollectionOutputError>) -> Void)
    ...
    ///             <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    func enterStandby(input: EnterStandbyInput, completion: @escaping (SdkResult<EnterStandbyOutputResponse, EnterStandbyOutputError>) -> Void)
    /// <p>Executes the specified policy. This can be useful for testing the design of your
    ///             scaling policy.</p>
    func executePolicy(input: ExecutePolicyInput, completion: @escaping (SdkResult<ExecutePolicyOutputResponse, ExecutePolicyOutputError>) -> Void)
    ...
    ///                 instances from your Auto Scaling group</a> in the
    ///             <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    func exitStandby(input: ExitStandbyInput, completion: @escaping (SdkResult<ExitStandbyOutputResponse, ExitStandbyOutputError>) -> Void)
    ...
    func getPredictiveScalingForecast(input: GetPredictiveScalingForecastInput, completion: @escaping (SdkResult<GetPredictiveScalingForecastOutputResponse, GetPredictiveScalingForecastOutputError>) -> Void)
    ...
    func putLifecycleHook(input: PutLifecycleHookInput, completion: @escaping (SdkResult<PutLifecycleHookOutputResponse, PutLifecycleHookOutputError>) -> Void)
    ...
    ///             fails.</p>
    func putNotificationConfiguration(input: PutNotificationConfigurationInput, completion: @escaping (SdkResult<PutNotificationConfigurationOutputResponse, PutNotificationConfigurationOutputError>) -> Void)
    ...
    func putScheduledUpdateGroupAction(input: PutScheduledUpdateGroupActionInput, completion: @escaping (SdkResult<PutScheduledUpdateGroupActionOutputResponse, PutScheduledUpdateGroupActionOutputError>) -> Void)
    ...
    func putWarmPool(input: PutWarmPoolInput, completion: @escaping (SdkResult<PutWarmPoolOutputResponse, PutWarmPoolOutputError>) -> Void)
    ...
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/autoscaling/ec2/userguide/lifecycle-hooks.html">Amazon EC2 Auto Scaling lifecycle
    ///                 hooks</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    func recordLifecycleActionHeartbeat(input: RecordLifecycleActionHeartbeatInput, completion: @escaping (SdkResult<RecordLifecycleActionHeartbeatOutputResponse, RecordLifecycleActionHeartbeatOutputError>) -> Void)
    ...
    func resumeProcesses(input: ResumeProcessesInput, completion: @escaping (SdkResult<ResumeProcessesOutputResponse, ResumeProcessesOutputError>) -> Void)
    ...
    ///                 <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    func setDesiredCapacity(input: SetDesiredCapacityInput, completion: @escaping (SdkResult<SetDesiredCapacityOutputResponse, SetDesiredCapacityOutputError>) -> Void)
    ...
    ///                 instances</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>
    func setInstanceHealth(input: SetInstanceHealthInput, completion: @escaping (SdkResult<SetInstanceHealthOutputResponse, SetInstanceHealthOutputError>) -> Void)
    ...
    ///             fails.</p>
    func setInstanceProtection(input: SetInstanceProtectionInput, completion: @escaping (SdkResult<SetInstanceProtectionOutputResponse, SetInstanceProtectionOutputError>) -> Void)
    ...
    ///             API. </p>
    func startInstanceRefresh(input: StartInstanceRefreshInput, completion: @escaping (SdkResult<StartInstanceRefreshOutputResponse, StartInstanceRefreshOutputError>) -> Void)
    ...
    func suspendProcesses(input: SuspendProcessesInput, completion: @escaping (SdkResult<SuspendProcessesOutputResponse, SuspendProcessesOutputError>) -> Void)
    ...
    func terminateInstanceInAutoScalingGroup(input: TerminateInstanceInAutoScalingGroupInput, completion: @escaping (SdkResult<TerminateInstanceInAutoScalingGroupOutputResponse, TerminateInstanceInAutoScalingGroupOutputError>) -> Void)
    /// <p>
    ...
    ///             API.</p>
    func updateAutoScalingGroup(input: UpdateAutoScalingGroupInput, completion: @escaping (SdkResult<UpdateAutoScalingGroupOutputResponse, UpdateAutoScalingGroupOutputError>) -> Void)
}
