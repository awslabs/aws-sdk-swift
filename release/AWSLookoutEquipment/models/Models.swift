...
public struct CreateDatasetInput: Swift.Equatable {
    ...
    /// This member is required.
    var datasetSchema: LookoutEquipmentClientTypes.DatasetSchema?
    /// Provides the identifier of the KMS key used to encrypt dataset data by Amazon Lookout for Equipment.
    var serverSideKmsKeyId: Swift.String?
    /// Any tags associated with the ingested data described in the dataset.
    var tags: [LookoutEquipmentClientTypes.Tag]?
...
public struct CreateDatasetOutputResponse: Swift.Equatable {
    ...
    var status: LookoutEquipmentClientTypes.DatasetStatus?
...
public struct CreateInferenceSchedulerInput: Swift.Equatable {
    ...
    var dataDelayOffsetInMinutes: Swift.Int?
    /// Specifies configuration information for the input data for the inference scheduler, including delimiter, format, and dataset location.
    /// This member is required.
    var dataInputConfiguration: LookoutEquipmentClientTypes.InferenceInputConfiguration?
    /// Specifies configuration information for the output results for the inference scheduler, including the S3 location for the output.
    /// This member is required.
    var dataOutputConfiguration: LookoutEquipmentClientTypes.InferenceOutputConfiguration?
    /// How often data is uploaded to the source S3 bucket for the input data. The value chosen is the length of time between data uploads. For instance, if you select 5 minutes, Amazon Lookout for Equipment will upload the real-time data to the source bucket once every 5 minutes. This frequency also determines how often Amazon Lookout for Equipment starts a scheduled inference on your data. In this example, it starts once every 5 minutes.
    /// This member is required.
    var dataUploadFrequency: LookoutEquipmentClientTypes.DataUploadFrequency?
    /// The name of the inference scheduler being created.
    /// This member is required.
    var inferenceSchedulerName: Swift.String?
...
public struct CreateInferenceSchedulerOutputResponse: Swift.Equatable {
    ...
    var inferenceSchedulerArn: Swift.String?
    /// The name of inference scheduler being created.
    var inferenceSchedulerName: Swift.String?
    /// Indicates the status of the CreateInferenceScheduler operation.
    var status: LookoutEquipmentClientTypes.InferenceSchedulerStatus?
...
public struct CreateModelInput: Swift.Equatable {
    ...
    var dataPreProcessingConfiguration: LookoutEquipmentClientTypes.DataPreProcessingConfiguration?
...
public struct CreateModelOutputResponse: Swift.Equatable {
    ...
    var modelArn: Swift.String?
    /// Indicates the status of the CreateModel operation.
    var status: LookoutEquipmentClientTypes.ModelStatus?
...
extension LookoutEquipmentClientTypes {
    ...
    public struct DataIngestionJobSummary: Swift.Equatable {
        ...
        var ingestionInputConfiguration: LookoutEquipmentClientTypes.IngestionInputConfiguration?
        /// Indicates the job ID of the data ingestion job.
        var jobId: Swift.String?
        /// Indicates the status of the data ingestion job.
        var status: LookoutEquipmentClientTypes.IngestionJobStatus?
...
extension LookoutEquipmentClientTypes {
    ...
    public struct DataPreProcessingConfiguration: Swift.Equatable {
        ...
        var targetSamplingRate: LookoutEquipmentClientTypes.TargetSamplingRate?
...
extension LookoutEquipmentClientTypes {
    ...
    public struct DatasetSchema: Swift.Equatable {
        ///
        var inlineDataSchema: Swift.String?
...
public struct DescribeModelOutputResponse: Swift.Equatable {
    ...
    var trainingExecutionEndTime: ClientRuntime.Date?
    /// Indicates the time at which the training of the ML model began.
    var trainingExecutionStartTime: ClientRuntime.Date?
...
extension LookoutEquipmentClientTypes {
    ...
    public struct InferenceExecutionSummary: Swift.Equatable {
        ///
        var customerResultObject: LookoutEquipmentClientTypes.S3Object?
        /// Indicates the time reference in the dataset at which the inference execution stopped.
        var dataEndTime: ClientRuntime.Date?
        /// Specifies configuration information for the input data for the inference scheduler, including delimiter, format, and dataset location.
        var dataInputConfiguration: LookoutEquipmentClientTypes.InferenceInputConfiguration?
        ...
        var dataStartTime: ClientRuntime.Date?
        ...
        var scheduledStartTime: ClientRuntime.Date?
        /// Indicates the status of the inference execution.
        var status: LookoutEquipmentClientTypes.InferenceExecutionStatus?
...
extension LookoutEquipmentClientTypes {
    ...
    public struct InferenceInputConfiguration: Swift.Equatable {
        ...
        var inferenceInputNameConfiguration: LookoutEquipmentClientTypes.InferenceInputNameConfiguration?
        /// Indicates the difference between your time zone and Greenwich Mean Time (GMT).
        var inputTimeZoneOffset: Swift.String?
        /// Specifies configuration information for the input data for the inference, including S3 location of input data..
        var s3InputConfiguration: LookoutEquipmentClientTypes.InferenceS3InputConfiguration?
...
extension LookoutEquipmentClientTypes {
    ...
    public struct InferenceInputNameConfiguration: Swift.Equatable {
        ...
        var componentTimestampDelimiter: Swift.String?
...
extension LookoutEquipmentClientTypes {
    ...
    public struct InferenceOutputConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var s3OutputConfiguration: LookoutEquipmentClientTypes.InferenceS3OutputConfiguration?
...
extension LookoutEquipmentClientTypes {
    ...
    public struct IngestionInputConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var s3InputConfiguration: LookoutEquipmentClientTypes.IngestionS3InputConfiguration?
...
extension LookoutEquipmentClientTypes {
    ...
    public struct LabelsInputConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var s3InputConfiguration: LookoutEquipmentClientTypes.LabelsS3InputConfiguration?
...
public struct ListDataIngestionJobsOutputResponse: Swift.Equatable {
    ...
    var dataIngestionJobSummaries: [LookoutEquipmentClientTypes.DataIngestionJobSummary]?
    /// An opaque pagination token indicating where to continue the listing of data ingestion jobs.
    var nextToken: Swift.String?
...
public struct ListDatasetsInput: Swift.Equatable {
    ...
    var datasetNameBeginsWith: Swift.String?
...
public struct ListDatasetsOutputResponse: Swift.Equatable {
    ...
    var datasetSummaries: [LookoutEquipmentClientTypes.DatasetSummary]?
    /// An opaque pagination token indicating where to continue the listing of datasets.
    var nextToken: Swift.String?
...
public struct ListInferenceExecutionsInput: Swift.Equatable {
    ...
    var dataEndTimeBefore: ClientRuntime.Date?
    /// The time reference in the inferenced dataset after which Amazon Lookout for Equipment started the inference execution.
    var dataStartTimeAfter: ClientRuntime.Date?
...
public struct ListInferenceExecutionsOutputResponse: Swift.Equatable {
    ...
    var inferenceExecutionSummaries: [LookoutEquipmentClientTypes.InferenceExecutionSummary]?
    /// An opaque pagination token indicating where to continue the listing of inference executions.
    var nextToken: Swift.String?
...
public struct ListInferenceSchedulersInput: Swift.Equatable {
    ...
    var inferenceSchedulerNameBeginsWith: Swift.String?
...
public struct ListInferenceSchedulersOutputResponse: Swift.Equatable {
    ...
    var inferenceSchedulerSummaries: [LookoutEquipmentClientTypes.InferenceSchedulerSummary]?
    /// An opaque pagination token indicating where to continue the listing of inference schedulers.
    var nextToken: Swift.String?
...
public struct ListModelsInput: Swift.Equatable {
    ...
    var modelNameBeginsWith: Swift.String?
...
public struct ListModelsOutputResponse: Swift.Equatable {
    ...
    var modelSummaries: [LookoutEquipmentClientTypes.ModelSummary]?
    /// An opaque pagination token indicating where to continue the listing of ML models.
    var nextToken: Swift.String?
