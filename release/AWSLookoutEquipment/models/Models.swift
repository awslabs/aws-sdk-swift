...
extension LookoutEquipmentClientTypes.CountPercent: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        count = countDecoded
        let percentageDecoded = try containerValues.decode(Swift.Float.self, forKey: .percentage)
...
extension LookoutEquipmentClientTypes.SensorStatisticsSummary: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let dataExistsDecoded = try containerValues.decode(Swift.Bool.self, forKey: .dataExists)
