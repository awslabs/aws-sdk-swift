...
public struct CancelResourceRequestInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelResourceRequestInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CancelResourceRequestInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CancelResourceRequestOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CancelResourceRequestInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CancelResourceRequestOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelResourceRequestOutputError>
}

extension CancelResourceRequestInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CancelResourceRequestInput(requestToken: \(Swift.String(describing: requestToken)))"}
}

extension CancelResourceRequestInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CancelResourceRequestInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelResourceRequestInputHeadersMiddleware"
...
public struct CancelResourceRequestInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelResourceRequestInputQueryItemMiddleware"
...
public struct CancelResourceRequestInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelResourceRequestInputURLHostMiddleware"
    ...
    public typealias MInput = CancelResourceRequestInput
    public typealias MOutput = ClientRuntime.OperationOutput<CancelResourceRequestOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelResourceRequestOutputError>
}

public struct CancelResourceRequestInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelResourceRequestInputURLPathMiddleware"
...
extension CancelResourceRequestOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CancelResourceRequestOutputResponse(progressEvent: \(Swift.String(describing: progressEvent)))"}
}
...
public struct CancelResourceRequestOutputResponse: Swift.Equatable {
    ...
    ///         <a href="https://docs.aws.amazon.com/cloudcontrolapi/latest/userguide/resource-operations-manage-requests.html">Managing resource operation requests in the
...
struct CancelResourceRequestOutputResponseBody: Swift.Equatable {
    public let progressEvent: CloudControlClientTypes.ProgressEvent?
}
...
extension ClientTokenConflictException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ClientTokenConflictException(message: \(Swift.String(describing: message)))"}
}
...
extension ConcurrentOperationException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConcurrentOperationException(message: \(Swift.String(describing: message)))"}
}
...
extension CreateResourceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateResourceInput(clientToken: \(Swift.String(describing: clientToken)), desiredState: \(Swift.String(describing: desiredState)), roleArn: \(Swift.String(describing: roleArn)), typeName: \(Swift.String(describing: typeName)), typeVersionId: \(Swift.String(describing: typeVersionId)))"}
}
...
public struct CreateResourceInput: Swift.Equatable {
    ...
    ///          For more information, see <a href="https://docs.aws.amazon.com/cloudcontrolapi/latest/userguide/resource-operations.html#resource-operations-idempotency">Ensuring resource operation requests are unique in the Amazon Web Services Cloud Control API User Guide.
    ...
    ///
    ///
    ///          For more information, see <a href="https://docs.aws.amazon.com/cloudcontrolapi/latest/userguide/resource-operations-create.html#resource-operations-create-desiredstate">Composing the desired state of the resource in the Amazon Web Services Cloud Control API User
    ///         Guide.
    ...
    ///                <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/resource-type-schema.html#schema-properties-handlers">handlers
    ///              section of the <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/resource-type-schema.html">resource type definition schema.
    ///          If you do not specify a role, Cloud Control API uses a temporary session created using your Amazon Web Services user credentials.
    ///          For more information, see <a href="https://docs.aws.amazon.com/cloudcontrolapi/latest/userguide/resource-operations.html#resource-operations-permissions">Specifying credentials in the Amazon Web Services Cloud Control API User Guide.
...
struct CreateResourceInputBody: Swift.Equatable {
    ...
    public let typeVersionId: Swift.String?
    public let roleArn: Swift.String?
    public let clientToken: Swift.String?
    public let desiredState: Swift.String?
}
...
extension CreateResourceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateResourceOutputResponse(progressEvent: \(Swift.String(describing: progressEvent)))"}
}
...
extension DeleteResourceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteResourceInput(clientToken: \(Swift.String(describing: clientToken)), identifier: \(Swift.String(describing: identifier)), roleArn: \(Swift.String(describing: roleArn)), typeName: \(Swift.String(describing: typeName)), typeVersionId: \(Swift.String(describing: typeVersionId)))"}
}
...
public struct DeleteResourceInput: Swift.Equatable {
    ...
    ///          For more information, see <a href="https://docs.aws.amazon.com/cloudcontrolapi/latest/userguide/resource-identifier.html">Identifying resources in the Amazon Web Services Cloud Control API User Guide.
    /// This member is required.
...
extension DeleteResourceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteResourceOutputResponse(progressEvent: \(Swift.String(describing: progressEvent)))"}
}
...
extension GeneralServiceException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GeneralServiceException(message: \(Swift.String(describing: message)))"}
}
...
public struct GetResourceInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetResourceInputBodyMiddleware"
...
extension GetResourceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetResourceInput(identifier: \(Swift.String(describing: identifier)), roleArn: \(Swift.String(describing: roleArn)), typeName: \(Swift.String(describing: typeName)), typeVersionId: \(Swift.String(describing: typeVersionId)))"}
}

extension GetResourceInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case identifier = "Identifier"
        case roleArn = "RoleArn"
        case typeName = "TypeName"
...
public struct GetResourceInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetResourceInputURLHostMiddleware"
...
extension GetResourceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetResourceOutputResponse(resourceDescription: \(Swift.String(describing: resourceDescription)), typeName: \(Swift.String(describing: typeName)))"}
}
...
struct GetResourceOutputResponseBody: Swift.Equatable {
    public let typeName: Swift.String?
    public let resourceDescription: CloudControlClientTypes.ResourceDescription?
}
...
public struct GetResourceRequestStatusInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetResourceRequestStatusInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetResourceRequestStatusInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetResourceRequestStatusOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetResourceRequestStatusInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetResourceRequestStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetResourceRequestStatusOutputError>
}

extension GetResourceRequestStatusInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetResourceRequestStatusInput(requestToken: \(Swift.String(describing: requestToken)))"}
}

extension GetResourceRequestStatusInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case requestToken = "RequestToken"
    }
...
public struct GetResourceRequestStatusInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetResourceRequestStatusInputHeadersMiddleware"
...
public struct GetResourceRequestStatusInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetResourceRequestStatusInputQueryItemMiddleware"
...
public struct GetResourceRequestStatusInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetResourceRequestStatusInputURLHostMiddleware"
    ...
    public typealias MInput = GetResourceRequestStatusInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetResourceRequestStatusOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetResourceRequestStatusOutputError>
}

public struct GetResourceRequestStatusInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetResourceRequestStatusInputURLPathMiddleware"
...
extension GetResourceRequestStatusOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetResourceRequestStatusOutputResponse(progressEvent: \(Swift.String(describing: progressEvent)))"}
}
...
extension HandlerFailureException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "HandlerFailureException(message: \(Swift.String(describing: message)))"}
}
...
extension HandlerInternalFailureException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "HandlerInternalFailureException(message: \(Swift.String(describing: message)))"}
}
...
public struct ListResourceRequestsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListResourceRequestsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListResourceRequestsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListResourceRequestsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListResourceRequestsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListResourceRequestsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListResourceRequestsOutputError>
}

extension ListResourceRequestsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListResourceRequestsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), resourceRequestStatusFilter: \(Swift.String(describing: resourceRequestStatusFilter)))"}
}

extension ListResourceRequestsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ListResourceRequestsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListResourceRequestsInputHeadersMiddleware"
...
public struct ListResourceRequestsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListResourceRequestsInputQueryItemMiddleware"
...
public struct ListResourceRequestsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListResourceRequestsInputURLHostMiddleware"
    ...
    public typealias MInput = ListResourceRequestsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListResourceRequestsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListResourceRequestsOutputError>
}

public struct ListResourceRequestsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListResourceRequestsInputURLPathMiddleware"
...
struct ListResourceRequestsInputBody: Swift.Equatable {
    ...
    public let resourceRequestStatusFilter: CloudControlClientTypes.ResourceRequestStatusFilter?
}
...
extension ListResourceRequestsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListResourceRequestsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), resourceRequestStatusSummaries: \(Swift.String(describing: resourceRequestStatusSummaries)))"}
}
...
struct ListResourceRequestsOutputResponseBody: Swift.Equatable {
    public let resourceRequestStatusSummaries: [CloudControlClientTypes.ProgressEvent]?
    public let nextToken: Swift.String?
}
...
extension ListResourcesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListResourcesInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), resourceModel: \(Swift.String(describing: resourceModel)), roleArn: \(Swift.String(describing: roleArn)), typeName: \(Swift.String(describing: typeName)), typeVersionId: \(Swift.String(describing: typeVersionId)))"}
}
...
extension ListResourcesOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListResourcesOutputResponse(nextToken: \(Swift.String(describing: nextToken)), resourceDescriptions: \(Swift.String(describing: resourceDescriptions)), typeName: \(Swift.String(describing: typeName)))"}
}
...
struct ListResourcesOutputResponseBody: Swift.Equatable {
    public let typeName: Swift.String?
    public let resourceDescriptions: [CloudControlClientTypes.ResourceDescription]?
    public let nextToken: Swift.String?
}
...
extension NetworkFailureException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "NetworkFailureException(message: \(Swift.String(describing: message)))"}
}
...
extension NotStabilizedException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "NotStabilizedException(message: \(Swift.String(describing: message)))"}
}
...
extension NotUpdatableException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "NotUpdatableException(message: \(Swift.String(describing: message)))"}
}
...
extension PrivateTypeException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PrivateTypeException(message: \(Swift.String(describing: message)))"}
}
...
extension CloudControlClientTypes.ProgressEvent: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CloudControlClientTypes {
    ...
    public struct ProgressEvent: Swift.Equatable {
        ...
        ///          For error code definitions, see <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/resource-type-test-contract-errors.html">Handler error codes in the CloudFormation Command
        ...
        ///          Use the RequestToken with <a href="https://docs.aws.amazon.com/cloudcontrolapi/latest/APIReference/API_GetResourceRequestStatus.html">GetResourceRequestStatus to return the current status of a resource operation
        ///       request.
        public var requestToken: Swift.String?
...
extension RequestTokenNotFoundException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RequestTokenNotFoundException(message: \(Swift.String(describing: message)))"}
}
...
extension CloudControlClientTypes.ResourceDescription: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case identifier = "Identifier"
...
extension CloudControlClientTypes.ResourceDescription: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceDescription(identifier: \(Swift.String(describing: identifier)), properties: \(Swift.String(describing: properties)))"}
}
...
extension CloudControlClientTypes.ResourceRequestStatusFilter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CloudControlClientTypes.ResourceRequestStatusFilter: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceRequestStatusFilter(operationStatuses: \(Swift.String(describing: operationStatuses)), operations: \(Swift.String(describing: operations)))"}
}
...
extension ServiceInternalErrorException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ServiceInternalErrorException(message: \(Swift.String(describing: message)))"}
}
...
extension ServiceLimitExceededException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ServiceLimitExceededException(message: \(Swift.String(describing: message)))"}
}
...
extension UnsupportedActionException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UnsupportedActionException(message: \(Swift.String(describing: message)))"}
}
...
extension UpdateResourceInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateResourceInput(clientToken: \(Swift.String(describing: clientToken)), identifier: \(Swift.String(describing: identifier)), patchDocument: \(Swift.String(describing: patchDocument)), roleArn: \(Swift.String(describing: roleArn)), typeName: \(Swift.String(describing: typeName)), typeVersionId: \(Swift.String(describing: typeVersionId)))"}
}
...
public struct UpdateResourceInput: Swift.Equatable {
    ...
    ///       the updates to apply to the current resource properties. For details, see <a href="https://docs.aws.amazon.com/cloudcontrolapi/latest/userguide/resource-operations-update.html#resource-operations-update-patch">Composing the patch document in the Amazon Web Services Cloud Control API User
    ///       Guide.
    /// This member is required.
...
struct UpdateResourceInputBody: Swift.Equatable {
    ...
    public let clientToken: Swift.String?
    public let identifier: Swift.String?
    public let patchDocument: Swift.String?
}
...
extension UpdateResourceOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateResourceOutputResponse(progressEvent: \(Swift.String(describing: progressEvent)))"}
}
...
public struct UpdateResourceOutputResponse: Swift.Equatable {
    ...
    ///          Use the RequestToken of the ProgressEvent with <a href="https://docs.aws.amazon.com/cloudcontrolapi/latest/APIReference/API_GetResourceRequestStatus.html">GetResourceRequestStatus to return the current status of a resource operation
    ///       request.
    public var progressEvent: CloudControlClientTypes.ProgressEvent?
