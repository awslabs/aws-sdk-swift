...
public struct DescribeRecommendationExportJobsInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DescribeRecommendationExportJobsOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DescribeRecommendationExportJobsOutput>
