...
extension StsClient: StsClientProtocol {
    ...
    ///          produces. </p>
    public func assumeRole(input: AssumeRoleInput, completion: @escaping (SdkResult<AssumeRoleOutput, AssumeRoleOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<AssumeRoleInput, AssumeRoleOutput, AssumeRoleOutputError>(id: "assumeRole")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssumeRoleInput, AssumeRoleOutput, AssumeRoleOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///             </li>
    ///          </ul>
    public func assumeRoleWithSAML(input: AssumeRoleWithSAMLInput, completion: @escaping (SdkResult<AssumeRoleWithSAMLOutput, AssumeRoleWithSAMLOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AssumeRoleWithSAMLInput, AssumeRoleWithSAMLOutput, AssumeRoleWithSAMLOutputError>(id: "assumeRoleWithSAML")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssumeRoleWithSAMLInput, AssumeRoleWithSAMLOutput, AssumeRoleWithSAMLOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///             </li>
    ///          </ul>
    public func assumeRoleWithWebIdentity(input: AssumeRoleWithWebIdentityInput, completion: @escaping (SdkResult<AssumeRoleWithWebIdentityOutput, AssumeRoleWithWebIdentityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AssumeRoleWithWebIdentityInput, AssumeRoleWithWebIdentityOutput, AssumeRoleWithWebIdentityOutputError>(id: "assumeRoleWithWebIdentity")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssumeRoleWithWebIdentityInput, AssumeRoleWithWebIdentityOutput, AssumeRoleWithWebIdentityOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///             </li>
    ///          </ul>
    public func decodeAuthorizationMessage(input: DecodeAuthorizationMessageInput, completion: @escaping (SdkResult<DecodeAuthorizationMessageOutput, DecodeAuthorizationMessageOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DecodeAuthorizationMessageInput, DecodeAuthorizationMessageOutput, DecodeAuthorizationMessageOutputError>(id: "decodeAuthorizationMessage")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DecodeAuthorizationMessageInput, DecodeAuthorizationMessageOutput, DecodeAuthorizationMessageOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    public func getAccessKeyInfo(input: GetAccessKeyInfoInput, completion: @escaping (SdkResult<GetAccessKeyInfoOutput, GetAccessKeyInfoOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAccessKeyInfoInput, GetAccessKeyInfoOutput, GetAccessKeyInfoOutputError>(id: "getAccessKeyInfo")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAccessKeyInfoInput, GetAccessKeyInfoOutput, GetAccessKeyInfoOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///                     <i>IAM User Guide</i>.</p>
    ///         </note>
    public func getCallerIdentity(input: GetCallerIdentityInput, completion: @escaping (SdkResult<GetCallerIdentityOutput, GetCallerIdentityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCallerIdentityInput, GetCallerIdentityOutput, GetCallerIdentityOutputError>(id: "getCallerIdentity")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCallerIdentityInput, GetCallerIdentityOutput, GetCallerIdentityOutputError>(contentType: "application/x-www-form-urlencoded"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getFederationToken(input: GetFederationTokenInput, completion: @escaping (SdkResult<GetFederationTokenOutput, GetFederationTokenOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetFederationTokenInput, GetFederationTokenOutput, GetFederationTokenOutputError>(contentType: "application/x-www-form-urlencoded"))
    ...
    ///             <i>IAM User Guide</i>. </p>
    public func getSessionToken(input: GetSessionTokenInput, completion: @escaping (SdkResult<GetSessionTokenOutput, GetSessionTokenOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSessionTokenInput, GetSessionTokenOutput, GetSessionTokenOutputError>(id: "getSessionToken")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSessionTokenInput, GetSessionTokenOutput, GetSessionTokenOutputError>(contentType: "application/x-www-form-urlencoded"))
