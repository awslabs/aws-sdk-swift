...
public class StsClient {
    ...
    let config: StsClientConfiguration
    let serviceName = "STS"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: StsClientConfiguration) {
    ...
    public class StsClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "StsClient")
        }
        ...
        public static func `default`() throws -> StsClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try StsClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}

public struct StsClientLogHandlerFactory: SDKLogHandlerFactory {
...
extension StsClient: StsClientProtocol {
    ...
    ///          produces. </p>
    public func assumeRole(input: AssumeRoleInput, completion: @escaping (SdkResult<AssumeRoleOutputResponse, AssumeRoleOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      ...
                      .withHost(value: "sts.\(config.region).amazonaws.com")
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AssumeRoleInput, AssumeRoleOutputResponse, AssumeRoleOutputError>(id: "assumeRole")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: AssumeRoleInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: AssumeRoleInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssumeRoleInput, AssumeRoleOutputResponse, AssumeRoleOutputError>(contentType: "application/x-www-form-urlencoded"))
        operation.serializeStep.intercept(position: .before, middleware: AssumeRoleInputBodyMiddleware())
    ...
    ///             </li>
    ///          </ul>
    public func assumeRoleWithSAML(input: AssumeRoleWithSAMLInput, completion: @escaping (SdkResult<AssumeRoleWithSAMLOutputResponse, AssumeRoleWithSAMLOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AssumeRoleWithSAMLInput, AssumeRoleWithSAMLOutputResponse, AssumeRoleWithSAMLOutputError>(id: "assumeRoleWithSAML")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: AssumeRoleWithSAMLInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: AssumeRoleWithSAMLInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssumeRoleWithSAMLInput, AssumeRoleWithSAMLOutputResponse, AssumeRoleWithSAMLOutputError>(contentType: "application/x-www-form-urlencoded"))
        operation.serializeStep.intercept(position: .before, middleware: AssumeRoleWithSAMLInputBodyMiddleware())
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func assumeRoleWithWebIdentity(input: AssumeRoleWithWebIdentityInput, completion: @escaping (SdkResult<AssumeRoleWithWebIdentityOutputResponse, AssumeRoleWithWebIdentityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AssumeRoleWithWebIdentityInput, AssumeRoleWithWebIdentityOutputResponse, AssumeRoleWithWebIdentityOutputError>(id: "assumeRoleWithWebIdentity")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: AssumeRoleWithWebIdentityInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: AssumeRoleWithWebIdentityInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssumeRoleWithWebIdentityInput, AssumeRoleWithWebIdentityOutputResponse, AssumeRoleWithWebIdentityOutputError>(contentType: "application/x-www-form-urlencoded"))
        operation.serializeStep.intercept(position: .before, middleware: AssumeRoleWithWebIdentityInputBodyMiddleware())
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func decodeAuthorizationMessage(input: DecodeAuthorizationMessageInput, completion: @escaping (SdkResult<DecodeAuthorizationMessageOutputResponse, DecodeAuthorizationMessageOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DecodeAuthorizationMessageInput, DecodeAuthorizationMessageOutputResponse, DecodeAuthorizationMessageOutputError>(id: "decodeAuthorizationMessage")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DecodeAuthorizationMessageInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DecodeAuthorizationMessageInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DecodeAuthorizationMessageInput, DecodeAuthorizationMessageOutputResponse, DecodeAuthorizationMessageOutputError>(contentType: "application/x-www-form-urlencoded"))
        operation.serializeStep.intercept(position: .before, middleware: DecodeAuthorizationMessageInputBodyMiddleware())
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getAccessKeyInfo(input: GetAccessKeyInfoInput, completion: @escaping (SdkResult<GetAccessKeyInfoOutputResponse, GetAccessKeyInfoOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAccessKeyInfoInput, GetAccessKeyInfoOutputResponse, GetAccessKeyInfoOutputError>(id: "getAccessKeyInfo")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetAccessKeyInfoInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetAccessKeyInfoInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAccessKeyInfoInput, GetAccessKeyInfoOutputResponse, GetAccessKeyInfoOutputError>(contentType: "application/x-www-form-urlencoded"))
        operation.serializeStep.intercept(position: .before, middleware: GetAccessKeyInfoInputBodyMiddleware())
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///                     <i>IAM User Guide</i>.</p>
    ///         </note>
    public func getCallerIdentity(input: GetCallerIdentityInput, completion: @escaping (SdkResult<GetCallerIdentityOutputResponse, GetCallerIdentityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetCallerIdentityInput, GetCallerIdentityOutputResponse, GetCallerIdentityOutputError>(id: "getCallerIdentity")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetCallerIdentityInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetCallerIdentityInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetCallerIdentityInput, GetCallerIdentityOutputResponse, GetCallerIdentityOutputError>(contentType: "application/x-www-form-urlencoded"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getFederationToken(input: GetFederationTokenInput, completion: @escaping (SdkResult<GetFederationTokenOutputResponse, GetFederationTokenOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetFederationTokenInput, GetFederationTokenOutputResponse, GetFederationTokenOutputError>(contentType: "application/x-www-form-urlencoded"))
        operation.serializeStep.intercept(position: .before, middleware: GetFederationTokenInputBodyMiddleware())
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             <i>IAM User Guide</i>. </p>
    public func getSessionToken(input: GetSessionTokenInput, completion: @escaping (SdkResult<GetSessionTokenOutputResponse, GetSessionTokenOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "sts")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSessionTokenInput, GetSessionTokenOutputResponse, GetSessionTokenOutputError>(id: "getSessionToken")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetSessionTokenInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetSessionTokenInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSessionTokenInput, GetSessionTokenOutputResponse, GetSessionTokenOutputError>(contentType: "application/x-www-form-urlencoded"))
        operation.serializeStep.intercept(position: .before, middleware: GetSessionTokenInputBodyMiddleware())
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
