...
public protocol StsClientProtocol {
    ...
    ///          produces. </p>
    func assumeRole(input: AssumeRoleInput, completion: @escaping (SdkResult<AssumeRoleOutput, AssumeRoleOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func assumeRoleWithSAML(input: AssumeRoleWithSAMLInput, completion: @escaping (SdkResult<AssumeRoleWithSAMLOutput, AssumeRoleWithSAMLOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func assumeRoleWithWebIdentity(input: AssumeRoleWithWebIdentityInput, completion: @escaping (SdkResult<AssumeRoleWithWebIdentityOutput, AssumeRoleWithWebIdentityOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func decodeAuthorizationMessage(input: DecodeAuthorizationMessageInput, completion: @escaping (SdkResult<DecodeAuthorizationMessageOutput, DecodeAuthorizationMessageOutputError>) -> Void)
    ...
    func getAccessKeyInfo(input: GetAccessKeyInfoInput, completion: @escaping (SdkResult<GetAccessKeyInfoOutput, GetAccessKeyInfoOutputError>) -> Void)
    ...
    ///                     <i>IAM User Guide</i>.</p>
    ///         </note>
    func getCallerIdentity(input: GetCallerIdentityInput, completion: @escaping (SdkResult<GetCallerIdentityOutput, GetCallerIdentityOutputError>) -> Void)
    ...
    func getFederationToken(input: GetFederationTokenInput, completion: @escaping (SdkResult<GetFederationTokenOutput, GetFederationTokenOutputError>) -> Void)
    ...
    ///             <i>IAM User Guide</i>. </p>
    func getSessionToken(input: GetSessionTokenInput, completion: @escaping (SdkResult<GetSessionTokenOutput, GetSessionTokenOutputError>) -> Void)
}
