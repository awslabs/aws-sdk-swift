...
public protocol StsClientProtocol {
    ...
    ///          produces. </p>
    func assumeRole(input: AssumeRoleInput, completion: @escaping (SdkResult<AssumeRoleOutputResponse, AssumeRoleOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func assumeRoleWithSAML(input: AssumeRoleWithSAMLInput, completion: @escaping (SdkResult<AssumeRoleWithSAMLOutputResponse, AssumeRoleWithSAMLOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func assumeRoleWithWebIdentity(input: AssumeRoleWithWebIdentityInput, completion: @escaping (SdkResult<AssumeRoleWithWebIdentityOutputResponse, AssumeRoleWithWebIdentityOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func decodeAuthorizationMessage(input: DecodeAuthorizationMessageInput, completion: @escaping (SdkResult<DecodeAuthorizationMessageOutputResponse, DecodeAuthorizationMessageOutputError>) -> Void)
    ...
    func getAccessKeyInfo(input: GetAccessKeyInfoInput, completion: @escaping (SdkResult<GetAccessKeyInfoOutputResponse, GetAccessKeyInfoOutputError>) -> Void)
    ...
    ///                     <i>IAM User Guide</i>.</p>
    ///         </note>
    func getCallerIdentity(input: GetCallerIdentityInput, completion: @escaping (SdkResult<GetCallerIdentityOutputResponse, GetCallerIdentityOutputError>) -> Void)
    ...
    ///             <i>IAM User Guide</i>. </p>
    func getSessionToken(input: GetSessionTokenInput, completion: @escaping (SdkResult<GetSessionTokenOutputResponse, GetSessionTokenOutputError>) -> Void)
}
