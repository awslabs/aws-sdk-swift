...
public extension StsClient {
    ...
    ///          produces. </p>
    func assumeRole(input: AssumeRoleInput) async throws -> AssumeRoleOutputResponse
    {
        typealias assumeRoleContinuation = CheckedContinuation<AssumeRoleOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: assumeRoleContinuation) in
            assumeRole(input: input) { result in
                switch result {
    ...
    ///             </li>
    ///          </ul>
    func assumeRoleWithSAML(input: AssumeRoleWithSAMLInput) async throws -> AssumeRoleWithSAMLOutputResponse
    {
        typealias assumeRoleWithSAMLContinuation = CheckedContinuation<AssumeRoleWithSAMLOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: assumeRoleWithSAMLContinuation) in
            assumeRoleWithSAML(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </li>
    ///          </ul>
    func assumeRoleWithWebIdentity(input: AssumeRoleWithWebIdentityInput) async throws -> AssumeRoleWithWebIdentityOutputResponse
    {
        typealias assumeRoleWithWebIdentityContinuation = CheckedContinuation<AssumeRoleWithWebIdentityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: assumeRoleWithWebIdentityContinuation) in
            assumeRoleWithWebIdentity(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             </li>
    ///          </ul>
    func decodeAuthorizationMessage(input: DecodeAuthorizationMessageInput) async throws -> DecodeAuthorizationMessageOutputResponse
    {
        typealias decodeAuthorizationMessageContinuation = CheckedContinuation<DecodeAuthorizationMessageOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: decodeAuthorizationMessageContinuation) in
            decodeAuthorizationMessage(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getAccessKeyInfo(input: GetAccessKeyInfoInput) async throws -> GetAccessKeyInfoOutputResponse
    {
        typealias getAccessKeyInfoContinuation = CheckedContinuation<GetAccessKeyInfoOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getAccessKeyInfoContinuation) in
            getAccessKeyInfo(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///                     <i>IAM User Guide</i>.</p>
    ///         </note>
    func getCallerIdentity(input: GetCallerIdentityInput) async throws -> GetCallerIdentityOutputResponse
    {
        typealias getCallerIdentityContinuation = CheckedContinuation<GetCallerIdentityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getCallerIdentityContinuation) in
            getCallerIdentity(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///             <i>IAM User Guide</i>. </p>
    func getSessionToken(input: GetSessionTokenInput) async throws -> GetSessionTokenOutputResponse
    {
        typealias getSessionTokenContinuation = CheckedContinuation<GetSessionTokenOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getSessionTokenContinuation) in
            getSessionToken(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
