...
public class SesV2Client {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try SesV2ClientConfiguration(region: unwrappedRegion)
    ...
    public class SesV2ClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("SesV2Client")
...
public struct SesV2ClientLogHandlerFactory: SDKLogHandlerFactory {
