...
public protocol AppIntegrationsClientProtocol {
    ...
    ///       control plane.</p>
    func createEventIntegration(input: CreateEventIntegrationInput, completion: @escaping (SdkResult<CreateEventIntegrationOutputResponse, CreateEventIntegrationOutputError>) -> Void)
    /// <p>The Amazon AppIntegrations APIs are in preview release and are subject to change.</p>
    ...
    func deleteEventIntegration(input: DeleteEventIntegrationInput, completion: @escaping (SdkResult<DeleteEventIntegrationOutputResponse, DeleteEventIntegrationOutputError>) -> Void)
    /// <p>The Amazon AppIntegrations APIs are in preview release and are subject to change.</p>
    ///          <p>Return information about the event integration.</p>
    func getEventIntegration(input: GetEventIntegrationInput, completion: @escaping (SdkResult<GetEventIntegrationOutputResponse, GetEventIntegrationOutputError>) -> Void)
    /// <p>The Amazon AppIntegrations APIs are in preview release and are subject to change.</p>
    ///          <p>Returns a paginated list of event integration associations in the account. </p>
    func listEventIntegrationAssociations(input: ListEventIntegrationAssociationsInput, completion: @escaping (SdkResult<ListEventIntegrationAssociationsOutputResponse, ListEventIntegrationAssociationsOutputError>) -> Void)
    /// <p>The Amazon AppIntegrations APIs are in preview release and are subject to change.</p>
    ///          <p>Returns a paginated list of event integrations in the account.</p>
    func listEventIntegrations(input: ListEventIntegrationsInput, completion: @escaping (SdkResult<ListEventIntegrationsOutputResponse, ListEventIntegrationsOutputError>) -> Void)
    /// <p>The Amazon AppIntegrations APIs are in preview release and are subject to change.</p>
    ...
    func updateEventIntegration(input: UpdateEventIntegrationInput, completion: @escaping (SdkResult<UpdateEventIntegrationOutputResponse, UpdateEventIntegrationOutputError>) -> Void)
}
