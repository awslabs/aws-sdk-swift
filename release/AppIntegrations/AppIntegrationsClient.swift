...
extension AppIntegrationsClient: AppIntegrationsClientProtocol {
    ...
    ///       control plane.</p>
    public func createEventIntegration(input: CreateEventIntegrationInput, completion: @escaping (SdkResult<CreateEventIntegrationOutput, CreateEventIntegrationOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<CreateEventIntegrationInput, CreateEventIntegrationOutput, CreateEventIntegrationOutputError>(id: "createEventIntegration")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateEventIntegrationOutput>, SdkError<CreateEventIntegrationOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateEventIntegrationInput, CreateEventIntegrationOutput, CreateEventIntegrationOutputError>(contentType: "application/json"))
    ...
    public func deleteEventIntegration(input: DeleteEventIntegrationInput, completion: @escaping (SdkResult<DeleteEventIntegrationOutput, DeleteEventIntegrationOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "app-integrations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteEventIntegrationInput, DeleteEventIntegrationOutput, DeleteEventIntegrationOutputError>(id: "deleteEventIntegration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteEventIntegrationInput, DeleteEventIntegrationOutput, DeleteEventIntegrationOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getEventIntegration(input: GetEventIntegrationInput, completion: @escaping (SdkResult<GetEventIntegrationOutput, GetEventIntegrationOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "app-integrations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetEventIntegrationInput, GetEventIntegrationOutput, GetEventIntegrationOutputError>(id: "getEventIntegration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetEventIntegrationInput, GetEventIntegrationOutput, GetEventIntegrationOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listEventIntegrationAssociations(input: ListEventIntegrationAssociationsInput, completion: @escaping (SdkResult<ListEventIntegrationAssociationsOutput, ListEventIntegrationAssociationsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "app-integrations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListEventIntegrationAssociationsInput, ListEventIntegrationAssociationsOutput, ListEventIntegrationAssociationsOutputError>(id: "listEventIntegrationAssociations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListEventIntegrationAssociationsInput, ListEventIntegrationAssociationsOutput, ListEventIntegrationAssociationsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listEventIntegrations(input: ListEventIntegrationsInput, completion: @escaping (SdkResult<ListEventIntegrationsOutput, ListEventIntegrationsOutputError>) -> Void)
    {
        let urlPath = "/eventIntegrations"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "app-integrations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListEventIntegrationsInput, ListEventIntegrationsOutput, ListEventIntegrationsOutputError>(id: "listEventIntegrations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListEventIntegrationsInput, ListEventIntegrationsOutput, ListEventIntegrationsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func updateEventIntegration(input: UpdateEventIntegrationInput, completion: @escaping (SdkResult<UpdateEventIntegrationOutput, UpdateEventIntegrationOutputError>) -> Void)
    {
        guard let name = input.name else {
            completion(.failure(.client(ClientError.serializationFailed("uri component name unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "app-integrations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateEventIntegrationInput, UpdateEventIntegrationOutput, UpdateEventIntegrationOutputError>(id: "updateEventIntegration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateEventIntegrationInput, UpdateEventIntegrationOutput, UpdateEventIntegrationOutputError>(contentType: "application/json"))
