...
private let servicePartitions = [
    ...
    AWSClientRuntime.Partition(
        ...
        endpoints: [
            "rds.us-gov-east-1": AWSClientRuntime.ServiceEndpointMetadata(
                hostName: "rds.us-gov-east-1.amazonaws.com",
                credentialScope: AWSClientRuntime.CredentialScope(region: "us-gov-east-1")
            ),
            "rds.us-gov-west-1": AWSClientRuntime.ServiceEndpointMetadata(
