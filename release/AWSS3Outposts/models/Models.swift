...
public struct CreateEndpointInput: Swift.Equatable {
    ...
    var accessType: S3OutpostsClientTypes.EndpointAccessType?
...
extension S3OutpostsClientTypes {
    ...
    public struct Endpoint: Swift.Equatable {
        ...
        var networkInterfaces: [S3OutpostsClientTypes.NetworkInterface]?
        /// The ID of the AWS Outposts.
        var outpostsId: Swift.String?
        /// The ID of the security group used for the endpoint.
        var securityGroupId: Swift.String?
        /// The status of the endpoint.
        var status: S3OutpostsClientTypes.EndpointStatus?
...
public struct ListEndpointsOutputResponse: Swift.Equatable {
    ...
    var endpoints: [S3OutpostsClientTypes.Endpoint]?
