...
extension CreateEndpointInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateEndpointInput(accessType: \(Swift.String(describing: accessType)), customerOwnedIpv4Pool: \(Swift.String(describing: customerOwnedIpv4Pool)), outpostId: \(Swift.String(describing: outpostId)), securityGroupId: \(Swift.String(describing: securityGroupId)), subnetId: \(Swift.String(describing: subnetId)))"}
}
...
public struct CreateEndpointInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateEndpointInputURLHostMiddleware"
    ...
    public typealias MInput = CreateEndpointInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateEndpointOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateEndpointOutputError>
}

public struct CreateEndpointInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateEndpointInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/S3Outposts/CreateEndpoint"
...
struct CreateEndpointInputBody: Swift.Equatable {
    ...
    public let accessType: S3OutpostsClientTypes.EndpointAccessType?
...
public struct DeleteEndpointInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/S3Outposts/DeleteEndpoint"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension S3OutpostsClientTypes.Endpoint: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Endpoint(accessType: \(Swift.String(describing: accessType)), cidrBlock: \(Swift.String(describing: cidrBlock)), creationTime: \(Swift.String(describing: creationTime)), customerOwnedIpv4Pool: \(Swift.String(describing: customerOwnedIpv4Pool)), endpointArn: \(Swift.String(describing: endpointArn)), networkInterfaces: \(Swift.String(describing: networkInterfaces)), outpostsId: \(Swift.String(describing: outpostsId)), securityGroupId: \(Swift.String(describing: securityGroupId)), status: \(Swift.String(describing: status)), subnetId: \(Swift.String(describing: subnetId)), vpcId: \(Swift.String(describing: vpcId)))"}
}
...
public struct ListEndpointsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListEndpointsInputURLHostMiddleware"
    ...
    public typealias MInput = ListEndpointsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListEndpointsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListEndpointsOutputError>
}

public struct ListEndpointsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListEndpointsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/S3Outposts/ListEndpoints"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
