...
public protocol CloudFrontClientProtocol {
    ...
    func createResponseHeadersPolicy(input: CreateResponseHeadersPolicyInput, completion: @escaping (ClientRuntime.SdkResult<CreateResponseHeadersPolicyOutputResponse, CreateResponseHeadersPolicyOutputError>) -> Void)
    ...
    func deleteResponseHeadersPolicy(input: DeleteResponseHeadersPolicyInput, completion: @escaping (ClientRuntime.SdkResult<DeleteResponseHeadersPolicyOutputResponse, DeleteResponseHeadersPolicyOutputError>) -> Void)
    ...
    func getResponseHeadersPolicy(input: GetResponseHeadersPolicyInput, completion: @escaping (ClientRuntime.SdkResult<GetResponseHeadersPolicyOutputResponse, GetResponseHeadersPolicyOutputError>) -> Void)
    ...
    func getResponseHeadersPolicyConfig(input: GetResponseHeadersPolicyConfigInput, completion: @escaping (ClientRuntime.SdkResult<GetResponseHeadersPolicyConfigOutputResponse, GetResponseHeadersPolicyConfigOutputError>) -> Void)
    ...
    func listDistributionsByResponseHeadersPolicyId(input: ListDistributionsByResponseHeadersPolicyIdInput, completion: @escaping (ClientRuntime.SdkResult<ListDistributionsByResponseHeadersPolicyIdOutputResponse, ListDistributionsByResponseHeadersPolicyIdOutputError>) -> Void)
    ...
    func listResponseHeadersPolicies(input: ListResponseHeadersPoliciesInput, completion: @escaping (ClientRuntime.SdkResult<ListResponseHeadersPoliciesOutputResponse, ListResponseHeadersPoliciesOutputError>) -> Void)
    ...
    func updateResponseHeadersPolicy(input: UpdateResponseHeadersPolicyInput, completion: @escaping (ClientRuntime.SdkResult<UpdateResponseHeadersPolicyOutputResponse, UpdateResponseHeadersPolicyOutputError>) -> Void)
