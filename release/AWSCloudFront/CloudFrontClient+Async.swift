...
public extension CloudFrontClient {
    ...
    {
        typealias associateAliasContinuation = CheckedContinuation<AssociateAliasOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: associateAliasContinuation) in
            associateAlias(input: input) { result in
                switch result {
    ...
    {
        typealias createResponseHeadersPolicyContinuation = CheckedContinuation<CreateResponseHeadersPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createResponseHeadersPolicyContinuation) in
            createResponseHeadersPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteResponseHeadersPolicyContinuation = CheckedContinuation<DeleteResponseHeadersPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteResponseHeadersPolicyContinuation) in
            deleteResponseHeadersPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getResponseHeadersPolicyContinuation = CheckedContinuation<GetResponseHeadersPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getResponseHeadersPolicyContinuation) in
            getResponseHeadersPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getResponseHeadersPolicyConfigContinuation = CheckedContinuation<GetResponseHeadersPolicyConfigOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getResponseHeadersPolicyConfigContinuation) in
            getResponseHeadersPolicyConfig(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listConflictingAliasesContinuation = CheckedContinuation<ListConflictingAliasesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listConflictingAliasesContinuation) in
            listConflictingAliases(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listDistributionsByResponseHeadersPolicyIdContinuation = CheckedContinuation<ListDistributionsByResponseHeadersPolicyIdOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listDistributionsByResponseHeadersPolicyIdContinuation) in
            listDistributionsByResponseHeadersPolicyId(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listResponseHeadersPoliciesContinuation = CheckedContinuation<ListResponseHeadersPoliciesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listResponseHeadersPoliciesContinuation) in
            listResponseHeadersPolicies(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateResponseHeadersPolicyContinuation = CheckedContinuation<UpdateResponseHeadersPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateResponseHeadersPolicyContinuation) in
            updateResponseHeadersPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
