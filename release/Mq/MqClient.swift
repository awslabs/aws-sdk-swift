...
extension MqClient: MqClientProtocol {
    ...
    public func createBroker(input: CreateBrokerInput, completion: @escaping (SdkResult<CreateBrokerOutput, CreateBrokerOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<CreateBrokerInput, CreateBrokerOutput, CreateBrokerOutputError>(id: "createBroker")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateBrokerOutput>, SdkError<CreateBrokerOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateBrokerInput, CreateBrokerOutput, CreateBrokerOutputError>(contentType: "application/json"))
    ...
    public func deleteBroker(input: DeleteBrokerInput, completion: @escaping (SdkResult<DeleteBrokerOutput, DeleteBrokerOutputError>) -> Void)
    {
        guard let brokerId = input.brokerId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component brokerId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mq")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBrokerInput, DeleteBrokerOutput, DeleteBrokerOutputError>(id: "deleteBroker")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBrokerInput, DeleteBrokerOutput, DeleteBrokerOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeBroker(input: DescribeBrokerInput, completion: @escaping (SdkResult<DescribeBrokerOutput, DescribeBrokerOutputError>) -> Void)
    {
        guard let brokerId = input.brokerId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component brokerId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mq")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeBrokerInput, DescribeBrokerOutput, DescribeBrokerOutputError>(id: "describeBroker")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeBrokerInput, DescribeBrokerOutput, DescribeBrokerOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeBrokerEngineTypes(input: DescribeBrokerEngineTypesInput, completion: @escaping (SdkResult<DescribeBrokerEngineTypesOutput, DescribeBrokerEngineTypesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mq")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeBrokerEngineTypesInput, DescribeBrokerEngineTypesOutput, DescribeBrokerEngineTypesOutputError>(id: "describeBrokerEngineTypes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeBrokerEngineTypesInput, DescribeBrokerEngineTypesOutput, DescribeBrokerEngineTypesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeBrokerInstanceOptions(input: DescribeBrokerInstanceOptionsInput, completion: @escaping (SdkResult<DescribeBrokerInstanceOptionsOutput, DescribeBrokerInstanceOptionsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mq")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeBrokerInstanceOptionsInput, DescribeBrokerInstanceOptionsOutput, DescribeBrokerInstanceOptionsOutputError>(id: "describeBrokerInstanceOptions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeBrokerInstanceOptionsInput, DescribeBrokerInstanceOptionsOutput, DescribeBrokerInstanceOptionsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listBrokers(input: ListBrokersInput, completion: @escaping (SdkResult<ListBrokersOutput, ListBrokersOutputError>) -> Void)
    {
        let urlPath = "/v1/brokers"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "mq")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBrokersInput, ListBrokersOutput, ListBrokersOutputError>(id: "listBrokers")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBrokersInput, ListBrokersOutput, ListBrokersOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func updateBroker(input: UpdateBrokerInput, completion: @escaping (SdkResult<UpdateBrokerOutput, UpdateBrokerOutputError>) -> Void)
    {
        guard let brokerId = input.brokerId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component brokerId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "mq")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateBrokerInput, UpdateBrokerOutput, UpdateBrokerOutputError>(id: "updateBroker")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateBrokerInput, UpdateBrokerOutput, UpdateBrokerOutputError>(contentType: "application/json"))
