...
public struct CreateUserInput: Swift.Equatable {
    ...
    public init (
        brokerId: Swift.String? = nil,
        consoleAccess: Swift.Bool = false,
...
extension CreateUserInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let consoleAccessDecoded = try containerValues.decode(Swift.Bool.self, forKey: .consoleAccess)
...
extension MqClientTypes.EncryptionOptions: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let useAwsOwnedKeyDecoded = try containerValues.decode(Swift.Bool.self, forKey: .useAwsOwnedKey)
...
extension MqClientTypes.LdapServerMetadataInput: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let roleSearchSubtreeDecoded = try containerValues.decode(Swift.Bool.self, forKey: .roleSearchSubtree)
        ...
        let userSearchSubtreeDecoded = try containerValues.decode(Swift.Bool.self, forKey: .userSearchSubtree)
...
extension MqClientTypes.Logs: Swift.Codable, ClientRuntime.Reflection {
    ...
    public init (from decoder: Swift.Decoder) throws {
        let containerValues = try decoder.container(keyedBy: CodingKeys.self)
        let auditDecoded = try containerValues.decode(Swift.Bool.self, forKey: .audit)
        audit = auditDecoded
        let generalDecoded = try containerValues.decode(Swift.Bool.self, forKey: .general)
...
extension UpdateBrokerInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateBrokerInput(authenticationStrategy: \(Swift.String(describing: authenticationStrategy)), autoMinorVersionUpgrade: \(Swift.String(describing: autoMinorVersionUpgrade)), brokerId: \(Swift.String(describing: brokerId)), configuration: \(Swift.String(describing: configuration)), engineVersion: \(Swift.String(describing: engineVersion)), hostInstanceType: \(Swift.String(describing: hostInstanceType)), ldapServerMetadata: \(Swift.String(describing: ldapServerMetadata)), logs: \(Swift.String(describing: logs)), securityGroups: \(Swift.String(describing: securityGroups)))"}
}
