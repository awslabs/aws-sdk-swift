...
extension WafClient: WafClientProtocol {
    ...
    public func createByteMatchSet(input: CreateByteMatchSetInput, completion: @escaping (SdkResult<CreateByteMatchSetOutput, CreateByteMatchSetOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateByteMatchSetInput, CreateByteMatchSetOutput, CreateByteMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.CreateByteMatchSet"))
    ...
    public func createGeoMatchSet(input: CreateGeoMatchSetInput, completion: @escaping (SdkResult<CreateGeoMatchSetOutput, CreateGeoMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateGeoMatchSetInput, CreateGeoMatchSetOutput, CreateGeoMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.CreateGeoMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createIPSet(input: CreateIPSetInput, completion: @escaping (SdkResult<CreateIPSetOutput, CreateIPSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateIPSetInput, CreateIPSetOutput, CreateIPSetOutputError>(xAmzTarget: "AWSWAF_20150824.CreateIPSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createRateBasedRule(input: CreateRateBasedRuleInput, completion: @escaping (SdkResult<CreateRateBasedRuleOutput, CreateRateBasedRuleOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateRateBasedRuleInput, CreateRateBasedRuleOutput, CreateRateBasedRuleOutputError>(xAmzTarget: "AWSWAF_20150824.CreateRateBasedRule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createRegexMatchSet(input: CreateRegexMatchSetInput, completion: @escaping (SdkResult<CreateRegexMatchSetOutput, CreateRegexMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateRegexMatchSetInput, CreateRegexMatchSetOutput, CreateRegexMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.CreateRegexMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createRegexPatternSet(input: CreateRegexPatternSetInput, completion: @escaping (SdkResult<CreateRegexPatternSetOutput, CreateRegexPatternSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateRegexPatternSetInput, CreateRegexPatternSetOutput, CreateRegexPatternSetOutputError>(xAmzTarget: "AWSWAF_20150824.CreateRegexPatternSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createRule(input: CreateRuleInput, completion: @escaping (SdkResult<CreateRuleOutput, CreateRuleOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateRuleInput, CreateRuleOutput, CreateRuleOutputError>(xAmzTarget: "AWSWAF_20150824.CreateRule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createRuleGroup(input: CreateRuleGroupInput, completion: @escaping (SdkResult<CreateRuleGroupOutput, CreateRuleGroupOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateRuleGroupInput, CreateRuleGroupOutput, CreateRuleGroupOutputError>(xAmzTarget: "AWSWAF_20150824.CreateRuleGroup"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createSizeConstraintSet(input: CreateSizeConstraintSetInput, completion: @escaping (SdkResult<CreateSizeConstraintSetOutput, CreateSizeConstraintSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateSizeConstraintSetInput, CreateSizeConstraintSetOutput, CreateSizeConstraintSetOutputError>(xAmzTarget: "AWSWAF_20150824.CreateSizeConstraintSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createSqlInjectionMatchSet(input: CreateSqlInjectionMatchSetInput, completion: @escaping (SdkResult<CreateSqlInjectionMatchSetOutput, CreateSqlInjectionMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateSqlInjectionMatchSetInput, CreateSqlInjectionMatchSetOutput, CreateSqlInjectionMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.CreateSqlInjectionMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createWebACL(input: CreateWebACLInput, completion: @escaping (SdkResult<CreateWebACLOutput, CreateWebACLOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateWebACLInput, CreateWebACLOutput, CreateWebACLOutputError>(xAmzTarget: "AWSWAF_20150824.CreateWebACL"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createWebACLMigrationStack(input: CreateWebACLMigrationStackInput, completion: @escaping (SdkResult<CreateWebACLMigrationStackOutput, CreateWebACLMigrationStackOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateWebACLMigrationStackInput, CreateWebACLMigrationStackOutput, CreateWebACLMigrationStackOutputError>(xAmzTarget: "AWSWAF_20150824.CreateWebACLMigrationStack"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createXssMatchSet(input: CreateXssMatchSetInput, completion: @escaping (SdkResult<CreateXssMatchSetOutput, CreateXssMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateXssMatchSetInput, CreateXssMatchSetOutput, CreateXssMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.CreateXssMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteByteMatchSet(input: DeleteByteMatchSetInput, completion: @escaping (SdkResult<DeleteByteMatchSetOutput, DeleteByteMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteByteMatchSetInput, DeleteByteMatchSetOutput, DeleteByteMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteByteMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteGeoMatchSet(input: DeleteGeoMatchSetInput, completion: @escaping (SdkResult<DeleteGeoMatchSetOutput, DeleteGeoMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteGeoMatchSetInput, DeleteGeoMatchSetOutput, DeleteGeoMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteGeoMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteIPSet(input: DeleteIPSetInput, completion: @escaping (SdkResult<DeleteIPSetOutput, DeleteIPSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteIPSetInput, DeleteIPSetOutput, DeleteIPSetOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteIPSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteLoggingConfiguration(input: DeleteLoggingConfigurationInput, completion: @escaping (SdkResult<DeleteLoggingConfigurationOutput, DeleteLoggingConfigurationOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteLoggingConfigurationInput, DeleteLoggingConfigurationOutput, DeleteLoggingConfigurationOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteLoggingConfiguration"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deletePermissionPolicy(input: DeletePermissionPolicyInput, completion: @escaping (SdkResult<DeletePermissionPolicyOutput, DeletePermissionPolicyOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeletePermissionPolicyInput, DeletePermissionPolicyOutput, DeletePermissionPolicyOutputError>(xAmzTarget: "AWSWAF_20150824.DeletePermissionPolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteRateBasedRule(input: DeleteRateBasedRuleInput, completion: @escaping (SdkResult<DeleteRateBasedRuleOutput, DeleteRateBasedRuleOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteRateBasedRuleInput, DeleteRateBasedRuleOutput, DeleteRateBasedRuleOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteRateBasedRule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteRegexMatchSet(input: DeleteRegexMatchSetInput, completion: @escaping (SdkResult<DeleteRegexMatchSetOutput, DeleteRegexMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteRegexMatchSetInput, DeleteRegexMatchSetOutput, DeleteRegexMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteRegexMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteRegexPatternSet(input: DeleteRegexPatternSetInput, completion: @escaping (SdkResult<DeleteRegexPatternSetOutput, DeleteRegexPatternSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteRegexPatternSetInput, DeleteRegexPatternSetOutput, DeleteRegexPatternSetOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteRegexPatternSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteRule(input: DeleteRuleInput, completion: @escaping (SdkResult<DeleteRuleOutput, DeleteRuleOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteRuleInput, DeleteRuleOutput, DeleteRuleOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteRule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteRuleGroup(input: DeleteRuleGroupInput, completion: @escaping (SdkResult<DeleteRuleGroupOutput, DeleteRuleGroupOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteRuleGroupInput, DeleteRuleGroupOutput, DeleteRuleGroupOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteRuleGroup"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteSizeConstraintSet(input: DeleteSizeConstraintSetInput, completion: @escaping (SdkResult<DeleteSizeConstraintSetOutput, DeleteSizeConstraintSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteSizeConstraintSetInput, DeleteSizeConstraintSetOutput, DeleteSizeConstraintSetOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteSizeConstraintSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteSqlInjectionMatchSet(input: DeleteSqlInjectionMatchSetInput, completion: @escaping (SdkResult<DeleteSqlInjectionMatchSetOutput, DeleteSqlInjectionMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteSqlInjectionMatchSetInput, DeleteSqlInjectionMatchSetOutput, DeleteSqlInjectionMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteSqlInjectionMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteWebACL(input: DeleteWebACLInput, completion: @escaping (SdkResult<DeleteWebACLOutput, DeleteWebACLOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteWebACLInput, DeleteWebACLOutput, DeleteWebACLOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteWebACL"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteXssMatchSet(input: DeleteXssMatchSetInput, completion: @escaping (SdkResult<DeleteXssMatchSetOutput, DeleteXssMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteXssMatchSetInput, DeleteXssMatchSetOutput, DeleteXssMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.DeleteXssMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getByteMatchSet(input: GetByteMatchSetInput, completion: @escaping (SdkResult<GetByteMatchSetOutput, GetByteMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetByteMatchSetInput, GetByteMatchSetOutput, GetByteMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.GetByteMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getChangeToken(input: GetChangeTokenInput, completion: @escaping (SdkResult<GetChangeTokenOutput, GetChangeTokenOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetChangeTokenInput, GetChangeTokenOutput, GetChangeTokenOutputError>(xAmzTarget: "AWSWAF_20150824.GetChangeToken"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getChangeTokenStatus(input: GetChangeTokenStatusInput, completion: @escaping (SdkResult<GetChangeTokenStatusOutput, GetChangeTokenStatusOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetChangeTokenStatusInput, GetChangeTokenStatusOutput, GetChangeTokenStatusOutputError>(xAmzTarget: "AWSWAF_20150824.GetChangeTokenStatus"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getGeoMatchSet(input: GetGeoMatchSetInput, completion: @escaping (SdkResult<GetGeoMatchSetOutput, GetGeoMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetGeoMatchSetInput, GetGeoMatchSetOutput, GetGeoMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.GetGeoMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getIPSet(input: GetIPSetInput, completion: @escaping (SdkResult<GetIPSetOutput, GetIPSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetIPSetInput, GetIPSetOutput, GetIPSetOutputError>(xAmzTarget: "AWSWAF_20150824.GetIPSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getLoggingConfiguration(input: GetLoggingConfigurationInput, completion: @escaping (SdkResult<GetLoggingConfigurationOutput, GetLoggingConfigurationOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetLoggingConfigurationInput, GetLoggingConfigurationOutput, GetLoggingConfigurationOutputError>(xAmzTarget: "AWSWAF_20150824.GetLoggingConfiguration"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getPermissionPolicy(input: GetPermissionPolicyInput, completion: @escaping (SdkResult<GetPermissionPolicyOutput, GetPermissionPolicyOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetPermissionPolicyInput, GetPermissionPolicyOutput, GetPermissionPolicyOutputError>(xAmzTarget: "AWSWAF_20150824.GetPermissionPolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getRateBasedRule(input: GetRateBasedRuleInput, completion: @escaping (SdkResult<GetRateBasedRuleOutput, GetRateBasedRuleOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetRateBasedRuleInput, GetRateBasedRuleOutput, GetRateBasedRuleOutputError>(xAmzTarget: "AWSWAF_20150824.GetRateBasedRule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getRateBasedRuleManagedKeys(input: GetRateBasedRuleManagedKeysInput, completion: @escaping (SdkResult<GetRateBasedRuleManagedKeysOutput, GetRateBasedRuleManagedKeysOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetRateBasedRuleManagedKeysInput, GetRateBasedRuleManagedKeysOutput, GetRateBasedRuleManagedKeysOutputError>(xAmzTarget: "AWSWAF_20150824.GetRateBasedRuleManagedKeys"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getRegexMatchSet(input: GetRegexMatchSetInput, completion: @escaping (SdkResult<GetRegexMatchSetOutput, GetRegexMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetRegexMatchSetInput, GetRegexMatchSetOutput, GetRegexMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.GetRegexMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getRegexPatternSet(input: GetRegexPatternSetInput, completion: @escaping (SdkResult<GetRegexPatternSetOutput, GetRegexPatternSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetRegexPatternSetInput, GetRegexPatternSetOutput, GetRegexPatternSetOutputError>(xAmzTarget: "AWSWAF_20150824.GetRegexPatternSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getRule(input: GetRuleInput, completion: @escaping (SdkResult<GetRuleOutput, GetRuleOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetRuleInput, GetRuleOutput, GetRuleOutputError>(xAmzTarget: "AWSWAF_20150824.GetRule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getRuleGroup(input: GetRuleGroupInput, completion: @escaping (SdkResult<GetRuleGroupOutput, GetRuleGroupOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetRuleGroupInput, GetRuleGroupOutput, GetRuleGroupOutputError>(xAmzTarget: "AWSWAF_20150824.GetRuleGroup"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getSampledRequests(input: GetSampledRequestsInput, completion: @escaping (SdkResult<GetSampledRequestsOutput, GetSampledRequestsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetSampledRequestsInput, GetSampledRequestsOutput, GetSampledRequestsOutputError>(xAmzTarget: "AWSWAF_20150824.GetSampledRequests"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getSizeConstraintSet(input: GetSizeConstraintSetInput, completion: @escaping (SdkResult<GetSizeConstraintSetOutput, GetSizeConstraintSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetSizeConstraintSetInput, GetSizeConstraintSetOutput, GetSizeConstraintSetOutputError>(xAmzTarget: "AWSWAF_20150824.GetSizeConstraintSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getSqlInjectionMatchSet(input: GetSqlInjectionMatchSetInput, completion: @escaping (SdkResult<GetSqlInjectionMatchSetOutput, GetSqlInjectionMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetSqlInjectionMatchSetInput, GetSqlInjectionMatchSetOutput, GetSqlInjectionMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.GetSqlInjectionMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getWebACL(input: GetWebACLInput, completion: @escaping (SdkResult<GetWebACLOutput, GetWebACLOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetWebACLInput, GetWebACLOutput, GetWebACLOutputError>(xAmzTarget: "AWSWAF_20150824.GetWebACL"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getXssMatchSet(input: GetXssMatchSetInput, completion: @escaping (SdkResult<GetXssMatchSetOutput, GetXssMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetXssMatchSetInput, GetXssMatchSetOutput, GetXssMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.GetXssMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listActivatedRulesInRuleGroup(input: ListActivatedRulesInRuleGroupInput, completion: @escaping (SdkResult<ListActivatedRulesInRuleGroupOutput, ListActivatedRulesInRuleGroupOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListActivatedRulesInRuleGroupInput, ListActivatedRulesInRuleGroupOutput, ListActivatedRulesInRuleGroupOutputError>(xAmzTarget: "AWSWAF_20150824.ListActivatedRulesInRuleGroup"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listByteMatchSets(input: ListByteMatchSetsInput, completion: @escaping (SdkResult<ListByteMatchSetsOutput, ListByteMatchSetsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListByteMatchSetsInput, ListByteMatchSetsOutput, ListByteMatchSetsOutputError>(xAmzTarget: "AWSWAF_20150824.ListByteMatchSets"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listGeoMatchSets(input: ListGeoMatchSetsInput, completion: @escaping (SdkResult<ListGeoMatchSetsOutput, ListGeoMatchSetsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListGeoMatchSetsInput, ListGeoMatchSetsOutput, ListGeoMatchSetsOutputError>(xAmzTarget: "AWSWAF_20150824.ListGeoMatchSets"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listIPSets(input: ListIPSetsInput, completion: @escaping (SdkResult<ListIPSetsOutput, ListIPSetsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListIPSetsInput, ListIPSetsOutput, ListIPSetsOutputError>(xAmzTarget: "AWSWAF_20150824.ListIPSets"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listLoggingConfigurations(input: ListLoggingConfigurationsInput, completion: @escaping (SdkResult<ListLoggingConfigurationsOutput, ListLoggingConfigurationsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListLoggingConfigurationsInput, ListLoggingConfigurationsOutput, ListLoggingConfigurationsOutputError>(xAmzTarget: "AWSWAF_20150824.ListLoggingConfigurations"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listRateBasedRules(input: ListRateBasedRulesInput, completion: @escaping (SdkResult<ListRateBasedRulesOutput, ListRateBasedRulesOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListRateBasedRulesInput, ListRateBasedRulesOutput, ListRateBasedRulesOutputError>(xAmzTarget: "AWSWAF_20150824.ListRateBasedRules"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listRegexMatchSets(input: ListRegexMatchSetsInput, completion: @escaping (SdkResult<ListRegexMatchSetsOutput, ListRegexMatchSetsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListRegexMatchSetsInput, ListRegexMatchSetsOutput, ListRegexMatchSetsOutputError>(xAmzTarget: "AWSWAF_20150824.ListRegexMatchSets"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listRegexPatternSets(input: ListRegexPatternSetsInput, completion: @escaping (SdkResult<ListRegexPatternSetsOutput, ListRegexPatternSetsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListRegexPatternSetsInput, ListRegexPatternSetsOutput, ListRegexPatternSetsOutputError>(xAmzTarget: "AWSWAF_20150824.ListRegexPatternSets"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listRuleGroups(input: ListRuleGroupsInput, completion: @escaping (SdkResult<ListRuleGroupsOutput, ListRuleGroupsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListRuleGroupsInput, ListRuleGroupsOutput, ListRuleGroupsOutputError>(xAmzTarget: "AWSWAF_20150824.ListRuleGroups"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listRules(input: ListRulesInput, completion: @escaping (SdkResult<ListRulesOutput, ListRulesOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListRulesInput, ListRulesOutput, ListRulesOutputError>(xAmzTarget: "AWSWAF_20150824.ListRules"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listSizeConstraintSets(input: ListSizeConstraintSetsInput, completion: @escaping (SdkResult<ListSizeConstraintSetsOutput, ListSizeConstraintSetsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListSizeConstraintSetsInput, ListSizeConstraintSetsOutput, ListSizeConstraintSetsOutputError>(xAmzTarget: "AWSWAF_20150824.ListSizeConstraintSets"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listSqlInjectionMatchSets(input: ListSqlInjectionMatchSetsInput, completion: @escaping (SdkResult<ListSqlInjectionMatchSetsOutput, ListSqlInjectionMatchSetsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListSqlInjectionMatchSetsInput, ListSqlInjectionMatchSetsOutput, ListSqlInjectionMatchSetsOutputError>(xAmzTarget: "AWSWAF_20150824.ListSqlInjectionMatchSets"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listSubscribedRuleGroups(input: ListSubscribedRuleGroupsInput, completion: @escaping (SdkResult<ListSubscribedRuleGroupsOutput, ListSubscribedRuleGroupsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListSubscribedRuleGroupsInput, ListSubscribedRuleGroupsOutput, ListSubscribedRuleGroupsOutputError>(xAmzTarget: "AWSWAF_20150824.ListSubscribedRuleGroups"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTagsForResource(input: ListTagsForResourceInput, completion: @escaping (SdkResult<ListTagsForResourceOutput, ListTagsForResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput, ListTagsForResourceOutputError>(xAmzTarget: "AWSWAF_20150824.ListTagsForResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listWebACLs(input: ListWebACLsInput, completion: @escaping (SdkResult<ListWebACLsOutput, ListWebACLsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListWebACLsInput, ListWebACLsOutput, ListWebACLsOutputError>(xAmzTarget: "AWSWAF_20150824.ListWebACLs"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listXssMatchSets(input: ListXssMatchSetsInput, completion: @escaping (SdkResult<ListXssMatchSetsOutput, ListXssMatchSetsOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListXssMatchSetsInput, ListXssMatchSetsOutput, ListXssMatchSetsOutputError>(xAmzTarget: "AWSWAF_20150824.ListXssMatchSets"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func putLoggingConfiguration(input: PutLoggingConfigurationInput, completion: @escaping (SdkResult<PutLoggingConfigurationOutput, PutLoggingConfigurationOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<PutLoggingConfigurationInput, PutLoggingConfigurationOutput, PutLoggingConfigurationOutputError>(xAmzTarget: "AWSWAF_20150824.PutLoggingConfiguration"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func putPermissionPolicy(input: PutPermissionPolicyInput, completion: @escaping (SdkResult<PutPermissionPolicyOutput, PutPermissionPolicyOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<PutPermissionPolicyInput, PutPermissionPolicyOutput, PutPermissionPolicyOutputError>(xAmzTarget: "AWSWAF_20150824.PutPermissionPolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func tagResource(input: TagResourceInput, completion: @escaping (SdkResult<TagResourceOutput, TagResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<TagResourceInput, TagResourceOutput, TagResourceOutputError>(xAmzTarget: "AWSWAF_20150824.TagResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func untagResource(input: UntagResourceInput, completion: @escaping (SdkResult<UntagResourceOutput, UntagResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UntagResourceInput, UntagResourceOutput, UntagResourceOutputError>(xAmzTarget: "AWSWAF_20150824.UntagResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateByteMatchSet(input: UpdateByteMatchSetInput, completion: @escaping (SdkResult<UpdateByteMatchSetOutput, UpdateByteMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateByteMatchSetInput, UpdateByteMatchSetOutput, UpdateByteMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateByteMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateGeoMatchSet(input: UpdateGeoMatchSetInput, completion: @escaping (SdkResult<UpdateGeoMatchSetOutput, UpdateGeoMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateGeoMatchSetInput, UpdateGeoMatchSetOutput, UpdateGeoMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateGeoMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateIPSet(input: UpdateIPSetInput, completion: @escaping (SdkResult<UpdateIPSetOutput, UpdateIPSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateIPSetInput, UpdateIPSetOutput, UpdateIPSetOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateIPSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateRateBasedRule(input: UpdateRateBasedRuleInput, completion: @escaping (SdkResult<UpdateRateBasedRuleOutput, UpdateRateBasedRuleOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateRateBasedRuleInput, UpdateRateBasedRuleOutput, UpdateRateBasedRuleOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateRateBasedRule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateRegexMatchSet(input: UpdateRegexMatchSetInput, completion: @escaping (SdkResult<UpdateRegexMatchSetOutput, UpdateRegexMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateRegexMatchSetInput, UpdateRegexMatchSetOutput, UpdateRegexMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateRegexMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateRegexPatternSet(input: UpdateRegexPatternSetInput, completion: @escaping (SdkResult<UpdateRegexPatternSetOutput, UpdateRegexPatternSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateRegexPatternSetInput, UpdateRegexPatternSetOutput, UpdateRegexPatternSetOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateRegexPatternSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateRule(input: UpdateRuleInput, completion: @escaping (SdkResult<UpdateRuleOutput, UpdateRuleOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateRuleInput, UpdateRuleOutput, UpdateRuleOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateRule"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateRuleGroup(input: UpdateRuleGroupInput, completion: @escaping (SdkResult<UpdateRuleGroupOutput, UpdateRuleGroupOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateRuleGroupInput, UpdateRuleGroupOutput, UpdateRuleGroupOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateRuleGroup"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateSizeConstraintSet(input: UpdateSizeConstraintSetInput, completion: @escaping (SdkResult<UpdateSizeConstraintSetOutput, UpdateSizeConstraintSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateSizeConstraintSetInput, UpdateSizeConstraintSetOutput, UpdateSizeConstraintSetOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateSizeConstraintSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateSqlInjectionMatchSet(input: UpdateSqlInjectionMatchSetInput, completion: @escaping (SdkResult<UpdateSqlInjectionMatchSetOutput, UpdateSqlInjectionMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateSqlInjectionMatchSetInput, UpdateSqlInjectionMatchSetOutput, UpdateSqlInjectionMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateSqlInjectionMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateWebACL(input: UpdateWebACLInput, completion: @escaping (SdkResult<UpdateWebACLOutput, UpdateWebACLOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateWebACLInput, UpdateWebACLOutput, UpdateWebACLOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateWebACL"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateXssMatchSet(input: UpdateXssMatchSetInput, completion: @escaping (SdkResult<UpdateXssMatchSetOutput, UpdateXssMatchSetOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateXssMatchSetInput, UpdateXssMatchSetOutput, UpdateXssMatchSetOutputError>(xAmzTarget: "AWSWAF_20150824.UpdateXssMatchSet"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
