...
public protocol CloudWatchClientProtocol {
    ...
    /// 			</p>
    ///          </note>
    func deleteAlarms(input: DeleteAlarmsInput, completion: @escaping (SdkResult<DeleteAlarmsOutput, DeleteAlarmsOutputError>) -> Void)
    ...
    /// 			deleted.</p>
    func deleteDashboards(input: DeleteDashboardsInput, completion: @escaping (SdkResult<DeleteDashboardsOutput, DeleteDashboardsOutputError>) -> Void)
    ...
    /// 			not be available.</p>
    func deleteInsightRules(input: DeleteInsightRulesInput, completion: @escaping (SdkResult<DeleteInsightRulesOutput, DeleteInsightRulesOutputError>) -> Void)
    /// <p>Permanently deletes the metric stream that you specify.</p>
    func deleteMetricStream(input: DeleteMetricStreamInput, completion: @escaping (SdkResult<DeleteMetricStreamOutput, DeleteMetricStreamOutputError>) -> Void)
    ...
    func describeAlarmHistory(input: DescribeAlarmHistoryInput, completion: @escaping (SdkResult<DescribeAlarmHistoryOutput, DescribeAlarmHistoryOutputError>) -> Void)
    ...
    func describeAlarms(input: DescribeAlarmsInput, completion: @escaping (SdkResult<DescribeAlarmsOutput, DescribeAlarmsOutputError>) -> Void)
    ...
    func describeAlarmsForMetric(input: DescribeAlarmsForMetricInput, completion: @escaping (SdkResult<DescribeAlarmsForMetricOutput, DescribeAlarmsForMetricOutputError>) -> Void)
    ...
    func describeAnomalyDetectors(input: DescribeAnomalyDetectorsInput, completion: @escaping (SdkResult<DescribeAnomalyDetectorsOutput, DescribeAnomalyDetectorsOutputError>) -> Void)
    ...
    func describeInsightRules(input: DescribeInsightRulesInput, completion: @escaping (SdkResult<DescribeInsightRulesOutput, DescribeInsightRulesOutputError>) -> Void)
    ...
    func disableAlarmActions(input: DisableAlarmActionsInput, completion: @escaping (SdkResult<DisableAlarmActionsOutput, DisableAlarmActionsOutputError>) -> Void)
    /// <p>Disables the specified Contributor Insights rules. When rules are disabled, they do not analyze log groups and do
    /// 		not incur costs.</p>
    func disableInsightRules(input: DisableInsightRulesInput, completion: @escaping (SdkResult<DisableInsightRulesOutput, DisableInsightRulesOutputError>) -> Void)
    /// <p>Enables the actions for the specified alarms.</p>
    func enableAlarmActions(input: EnableAlarmActionsInput, completion: @escaping (SdkResult<EnableAlarmActionsOutput, EnableAlarmActionsOutputError>) -> Void)
    /// <p>Enables the specified Contributor Insights rules. When rules are enabled, they immediately begin analyzing log data.</p>
    func enableInsightRules(input: EnableInsightRulesInput, completion: @escaping (SdkResult<EnableInsightRulesOutput, EnableInsightRulesOutputError>) -> Void)
    ...
    /// 			the copy.</p>
    func getDashboard(input: GetDashboardInput, completion: @escaping (SdkResult<GetDashboardOutput, GetDashboardOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func getInsightRuleReport(input: GetInsightRuleReportInput, completion: @escaping (SdkResult<GetInsightRuleReportOutput, GetInsightRuleReportOutputError>) -> Void)
    ...
    func getMetricData(input: GetMetricDataInput, completion: @escaping (SdkResult<GetMetricDataOutput, GetMetricDataOutputError>) -> Void)
    ...
    func getMetricStatistics(input: GetMetricStatisticsInput, completion: @escaping (SdkResult<GetMetricStatisticsOutput, GetMetricStatisticsOutputError>) -> Void)
    /// <p>Returns information about the metric stream that you specify.</p>
    func getMetricStream(input: GetMetricStreamInput, completion: @escaping (SdkResult<GetMetricStreamOutput, GetMetricStreamOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func getMetricWidgetImage(input: GetMetricWidgetImageInput, completion: @escaping (SdkResult<GetMetricWidgetImageOutput, GetMetricWidgetImageOutputError>) -> Void)
    ...
    /// 		<a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_GetMetricData.html">GetMetricData</a> or
    /// 		<a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_GetMetricStatistics.html">GetMetricStatistics</a>.</p>
    func listMetrics(input: ListMetricsInput, completion: @escaping (SdkResult<ListMetricsOutput, ListMetricsOutputError>) -> Void)
    /// <p>Returns a list of metric streams in this account.</p>
    func listMetricStreams(input: ListMetricStreamsInput, completion: @escaping (SdkResult<ListMetricStreamsOutput, ListMetricStreamsOutputError>) -> Void)
    ...
    func putAnomalyDetector(input: PutAnomalyDetectorInput, completion: @escaping (SdkResult<PutAnomalyDetectorOutput, PutAnomalyDetectorOutputError>) -> Void)
    ...
    func putCompositeAlarm(input: PutCompositeAlarmInput, completion: @escaping (SdkResult<PutCompositeAlarmOutput, PutCompositeAlarmOutputError>) -> Void)
    ...
    /// 		dashboard.</p>
    func putDashboard(input: PutDashboardInput, completion: @escaping (SdkResult<PutDashboardOutput, PutDashboardOutputError>) -> Void)
    ...
    func putInsightRule(input: PutInsightRuleInput, completion: @escaping (SdkResult<PutInsightRuleOutput, PutInsightRuleOutputError>) -> Void)
    ...
    func putMetricAlarm(input: PutMetricAlarmInput, completion: @escaping (SdkResult<PutMetricAlarmOutput, PutMetricAlarmOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func putMetricData(input: PutMetricDataInput, completion: @escaping (SdkResult<PutMetricDataOutput, PutMetricDataOutputError>) -> Void)
    ...
    func putMetricStream(input: PutMetricStreamInput, completion: @escaping (SdkResult<PutMetricStreamOutput, PutMetricStreamOutputError>) -> Void)
    ...
    func setAlarmState(input: SetAlarmStateInput, completion: @escaping (SdkResult<SetAlarmStateOutput, SetAlarmStateOutputError>) -> Void)
    /// <p>Starts the streaming of metrics for one or more of your metric streams.</p>
    func startMetricStreams(input: StartMetricStreamsInput, completion: @escaping (SdkResult<StartMetricStreamsOutput, StartMetricStreamsOutputError>) -> Void)
    /// <p>Stops the streaming of metrics for one or more of your metric streams.</p>
    func stopMetricStreams(input: StopMetricStreamsInput, completion: @escaping (SdkResult<StopMetricStreamsOutput, StopMetricStreamsOutputError>) -> Void)
