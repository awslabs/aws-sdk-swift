...
public protocol CloudWatchClientProtocol {
    ...
    /// 			</p>
    ///          </note>
    func deleteAlarms(input: DeleteAlarmsInput, completion: @escaping (SdkResult<DeleteAlarmsOutputResponse, DeleteAlarmsOutputError>) -> Void)
    /// <p>Deletes the specified anomaly detection model from your account.</p>
    func deleteAnomalyDetector(input: DeleteAnomalyDetectorInput, completion: @escaping (SdkResult<DeleteAnomalyDetectorOutputResponse, DeleteAnomalyDetectorOutputError>) -> Void)
    ...
    /// 			deleted.</p>
    func deleteDashboards(input: DeleteDashboardsInput, completion: @escaping (SdkResult<DeleteDashboardsOutputResponse, DeleteDashboardsOutputError>) -> Void)
    ...
    /// 			not be available.</p>
    func deleteInsightRules(input: DeleteInsightRulesInput, completion: @escaping (SdkResult<DeleteInsightRulesOutputResponse, DeleteInsightRulesOutputError>) -> Void)
    /// <p>Permanently deletes the metric stream that you specify.</p>
    func deleteMetricStream(input: DeleteMetricStreamInput, completion: @escaping (SdkResult<DeleteMetricStreamOutputResponse, DeleteMetricStreamOutputError>) -> Void)
    ...
    func describeAlarmHistory(input: DescribeAlarmHistoryInput, completion: @escaping (SdkResult<DescribeAlarmHistoryOutputResponse, DescribeAlarmHistoryOutputError>) -> Void)
    ...
    func describeAlarms(input: DescribeAlarmsInput, completion: @escaping (SdkResult<DescribeAlarmsOutputResponse, DescribeAlarmsOutputError>) -> Void)
    ...
    func describeAlarmsForMetric(input: DescribeAlarmsForMetricInput, completion: @escaping (SdkResult<DescribeAlarmsForMetricOutputResponse, DescribeAlarmsForMetricOutputError>) -> Void)
    ...
    func describeAnomalyDetectors(input: DescribeAnomalyDetectorsInput, completion: @escaping (SdkResult<DescribeAnomalyDetectorsOutputResponse, DescribeAnomalyDetectorsOutputError>) -> Void)
    ...
    func describeInsightRules(input: DescribeInsightRulesInput, completion: @escaping (SdkResult<DescribeInsightRulesOutputResponse, DescribeInsightRulesOutputError>) -> Void)
    ...
    func disableAlarmActions(input: DisableAlarmActionsInput, completion: @escaping (SdkResult<DisableAlarmActionsOutputResponse, DisableAlarmActionsOutputError>) -> Void)
    /// <p>Disables the specified Contributor Insights rules. When rules are disabled, they do not analyze log groups and do
    /// 		not incur costs.</p>
    func disableInsightRules(input: DisableInsightRulesInput, completion: @escaping (SdkResult<DisableInsightRulesOutputResponse, DisableInsightRulesOutputError>) -> Void)
    /// <p>Enables the actions for the specified alarms.</p>
    func enableAlarmActions(input: EnableAlarmActionsInput, completion: @escaping (SdkResult<EnableAlarmActionsOutputResponse, EnableAlarmActionsOutputError>) -> Void)
    /// <p>Enables the specified Contributor Insights rules. When rules are enabled, they immediately begin analyzing log data.</p>
    func enableInsightRules(input: EnableInsightRulesInput, completion: @escaping (SdkResult<EnableInsightRulesOutputResponse, EnableInsightRulesOutputError>) -> Void)
    ...
    /// 			the copy.</p>
    func getDashboard(input: GetDashboardInput, completion: @escaping (SdkResult<GetDashboardOutputResponse, GetDashboardOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func getInsightRuleReport(input: GetInsightRuleReportInput, completion: @escaping (SdkResult<GetInsightRuleReportOutputResponse, GetInsightRuleReportOutputError>) -> Void)
    ...
    func getMetricStatistics(input: GetMetricStatisticsInput, completion: @escaping (SdkResult<GetMetricStatisticsOutputResponse, GetMetricStatisticsOutputError>) -> Void)
    /// <p>Returns information about the metric stream that you specify.</p>
    func getMetricStream(input: GetMetricStreamInput, completion: @escaping (SdkResult<GetMetricStreamOutputResponse, GetMetricStreamOutputError>) -> Void)
    ...
    /// 			         </li>
    ///          </ul>
    func getMetricWidgetImage(input: GetMetricWidgetImageInput, completion: @escaping (SdkResult<GetMetricWidgetImageOutputResponse, GetMetricWidgetImageOutputError>) -> Void)
    ...
    /// 		<a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_GetMetricData.html">GetMetricData</a> or
    /// 		<a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_GetMetricStatistics.html">GetMetricStatistics</a>.</p>
    func listMetrics(input: ListMetricsInput, completion: @escaping (SdkResult<ListMetricsOutputResponse, ListMetricsOutputError>) -> Void)
    /// <p>Returns a list of metric streams in this account.</p>
    func listMetricStreams(input: ListMetricStreamsInput, completion: @escaping (SdkResult<ListMetricStreamsOutputResponse, ListMetricStreamsOutputError>) -> Void)
    ...
    func putAnomalyDetector(input: PutAnomalyDetectorInput, completion: @escaping (SdkResult<PutAnomalyDetectorOutputResponse, PutAnomalyDetectorOutputError>) -> Void)
    ...
    func putCompositeAlarm(input: PutCompositeAlarmInput, completion: @escaping (SdkResult<PutCompositeAlarmOutputResponse, PutCompositeAlarmOutputError>) -> Void)
    ...
    /// 		dashboard.</p>
    func putDashboard(input: PutDashboardInput, completion: @escaping (SdkResult<PutDashboardOutputResponse, PutDashboardOutputError>) -> Void)
    ...
    func putInsightRule(input: PutInsightRuleInput, completion: @escaping (SdkResult<PutInsightRuleOutputResponse, PutInsightRuleOutputError>) -> Void)
    ...
    func putMetricAlarm(input: PutMetricAlarmInput, completion: @escaping (SdkResult<PutMetricAlarmOutputResponse, PutMetricAlarmOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func putMetricData(input: PutMetricDataInput, completion: @escaping (SdkResult<PutMetricDataOutputResponse, PutMetricDataOutputError>) -> Void)
    ...
    func putMetricStream(input: PutMetricStreamInput, completion: @escaping (SdkResult<PutMetricStreamOutputResponse, PutMetricStreamOutputError>) -> Void)
    ...
    func setAlarmState(input: SetAlarmStateInput, completion: @escaping (SdkResult<SetAlarmStateOutputResponse, SetAlarmStateOutputError>) -> Void)
    /// <p>Starts the streaming of metrics for one or more of your metric streams.</p>
    func startMetricStreams(input: StartMetricStreamsInput, completion: @escaping (SdkResult<StartMetricStreamsOutputResponse, StartMetricStreamsOutputError>) -> Void)
    /// <p>Stops the streaming of metrics for one or more of your metric streams.</p>
    func stopMetricStreams(input: StopMetricStreamsInput, completion: @escaping (SdkResult<StopMetricStreamsOutputResponse, StopMetricStreamsOutputError>) -> Void)
