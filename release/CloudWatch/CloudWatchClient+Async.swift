...
public extension CloudWatchClient {
    ...
    /// 			
    ///
    func deleteAlarms(input: DeleteAlarmsInput) async throws -> DeleteAlarmsOutputResponse
    {
        typealias deleteAlarmsContinuation = CheckedContinuation<DeleteAlarmsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteAlarmsContinuation) in
            deleteAlarms(input: input) { result in
                switch result {
    ...
    /// 			deleted.
    func deleteDashboards(input: DeleteDashboardsInput) async throws -> DeleteDashboardsOutputResponse
    {
        typealias deleteDashboardsContinuation = CheckedContinuation<DeleteDashboardsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteDashboardsContinuation) in
            deleteDashboards(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			not be available.
    func deleteInsightRules(input: DeleteInsightRulesInput) async throws -> DeleteInsightRulesOutputResponse
    {
        typealias deleteInsightRulesContinuation = CheckedContinuation<DeleteInsightRulesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteInsightRulesContinuation) in
            deleteInsightRules(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func deleteMetricStream(input: DeleteMetricStreamInput) async throws -> DeleteMetricStreamOutputResponse
    {
        typealias deleteMetricStreamContinuation = CheckedContinuation<DeleteMetricStreamOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteMetricStreamContinuation) in
            deleteMetricStream(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeAlarmHistory(input: DescribeAlarmHistoryInput) async throws -> DescribeAlarmHistoryOutputResponse
    {
        typealias describeAlarmHistoryContinuation = CheckedContinuation<DescribeAlarmHistoryOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAlarmHistoryContinuation) in
            describeAlarmHistory(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeAlarms(input: DescribeAlarmsInput) async throws -> DescribeAlarmsOutputResponse
    {
        typealias describeAlarmsContinuation = CheckedContinuation<DescribeAlarmsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAlarmsContinuation) in
            describeAlarms(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeAlarmsForMetric(input: DescribeAlarmsForMetricInput) async throws -> DescribeAlarmsForMetricOutputResponse
    {
        typealias describeAlarmsForMetricContinuation = CheckedContinuation<DescribeAlarmsForMetricOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAlarmsForMetricContinuation) in
            describeAlarmsForMetric(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeAnomalyDetectors(input: DescribeAnomalyDetectorsInput) async throws -> DescribeAnomalyDetectorsOutputResponse
    {
        typealias describeAnomalyDetectorsContinuation = CheckedContinuation<DescribeAnomalyDetectorsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAnomalyDetectorsContinuation) in
            describeAnomalyDetectors(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeInsightRules(input: DescribeInsightRulesInput) async throws -> DescribeInsightRulesOutputResponse
    {
        typealias describeInsightRulesContinuation = CheckedContinuation<DescribeInsightRulesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeInsightRulesContinuation) in
            describeInsightRules(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func disableAlarmActions(input: DisableAlarmActionsInput) async throws -> DisableAlarmActionsOutputResponse
    {
        typealias disableAlarmActionsContinuation = CheckedContinuation<DisableAlarmActionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: disableAlarmActionsContinuation) in
            disableAlarmActions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 		not incur costs.
    func disableInsightRules(input: DisableInsightRulesInput) async throws -> DisableInsightRulesOutputResponse
    {
        typealias disableInsightRulesContinuation = CheckedContinuation<DisableInsightRulesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: disableInsightRulesContinuation) in
            disableInsightRules(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func enableAlarmActions(input: EnableAlarmActionsInput) async throws -> EnableAlarmActionsOutputResponse
    {
        typealias enableAlarmActionsContinuation = CheckedContinuation<EnableAlarmActionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: enableAlarmActionsContinuation) in
            enableAlarmActions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func enableInsightRules(input: EnableInsightRulesInput) async throws -> EnableInsightRulesOutputResponse
    {
        typealias enableInsightRulesContinuation = CheckedContinuation<EnableInsightRulesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: enableInsightRulesContinuation) in
            enableInsightRules(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			the copy.
    func getDashboard(input: GetDashboardInput) async throws -> GetDashboardOutputResponse
    {
        typealias getDashboardContinuation = CheckedContinuation<GetDashboardOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getDashboardContinuation) in
            getDashboard(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			
    ///
    func getInsightRuleReport(input: GetInsightRuleReportInput) async throws -> GetInsightRuleReportOutputResponse
    {
        typealias getInsightRuleReportContinuation = CheckedContinuation<GetInsightRuleReportOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getInsightRuleReportContinuation) in
            getInsightRuleReport(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getMetricStatistics(input: GetMetricStatisticsInput) async throws -> GetMetricStatisticsOutputResponse
    {
        typealias getMetricStatisticsContinuation = CheckedContinuation<GetMetricStatisticsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getMetricStatisticsContinuation) in
            getMetricStatistics(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func getMetricStream(input: GetMetricStreamInput) async throws -> GetMetricStreamOutputResponse
    {
        typealias getMetricStreamContinuation = CheckedContinuation<GetMetricStreamOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getMetricStreamContinuation) in
            getMetricStream(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 			
    ///
    func getMetricWidgetImage(input: GetMetricWidgetImageInput) async throws -> GetMetricWidgetImageOutputResponse
    {
        typealias getMetricWidgetImageContinuation = CheckedContinuation<GetMetricWidgetImageOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getMetricWidgetImageContinuation) in
            getMetricWidgetImage(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func listMetricStreams(input: ListMetricStreamsInput) async throws -> ListMetricStreamsOutputResponse
    {
        typealias listMetricStreamsContinuation = CheckedContinuation<ListMetricStreamsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listMetricStreamsContinuation) in
            listMetricStreams(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 		<a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_GetMetricData.html">GetMetricData or
    /// 		<a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_GetMetricStatistics.html">GetMetricStatistics.
    func listMetrics(input: ListMetricsInput) async throws -> ListMetricsOutputResponse
    {
        typealias listMetricsContinuation = CheckedContinuation<ListMetricsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listMetricsContinuation) in
            listMetrics(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func putAnomalyDetector(input: PutAnomalyDetectorInput) async throws -> PutAnomalyDetectorOutputResponse
    {
        typealias putAnomalyDetectorContinuation = CheckedContinuation<PutAnomalyDetectorOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putAnomalyDetectorContinuation) in
            putAnomalyDetector(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func putCompositeAlarm(input: PutCompositeAlarmInput) async throws -> PutCompositeAlarmOutputResponse
    {
        typealias putCompositeAlarmContinuation = CheckedContinuation<PutCompositeAlarmOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putCompositeAlarmContinuation) in
            putCompositeAlarm(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    /// 		dashboard.
    func putDashboard(input: PutDashboardInput) async throws -> PutDashboardOutputResponse
    {
        typealias putDashboardContinuation = CheckedContinuation<PutDashboardOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putDashboardContinuation) in
            putDashboard(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func putInsightRule(input: PutInsightRuleInput) async throws -> PutInsightRuleOutputResponse
    {
        typealias putInsightRuleContinuation = CheckedContinuation<PutInsightRuleOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putInsightRuleContinuation) in
            putInsightRule(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///
    ///
    func putMetricAlarm(input: PutMetricAlarmInput) async throws -> PutMetricAlarmOutputResponse
    {
        typealias putMetricAlarmContinuation = CheckedContinuation<PutMetricAlarmOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putMetricAlarmContinuation) in
            putMetricAlarm(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///
    ///
    func putMetricData(input: PutMetricDataInput) async throws -> PutMetricDataOutputResponse
    {
        typealias putMetricDataContinuation = CheckedContinuation<PutMetricDataOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putMetricDataContinuation) in
            putMetricData(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func putMetricStream(input: PutMetricStreamInput) async throws -> PutMetricStreamOutputResponse
    {
        typealias putMetricStreamContinuation = CheckedContinuation<PutMetricStreamOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putMetricStreamContinuation) in
            putMetricStream(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func setAlarmState(input: SetAlarmStateInput) async throws -> SetAlarmStateOutputResponse
    {
        typealias setAlarmStateContinuation = CheckedContinuation<SetAlarmStateOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: setAlarmStateContinuation) in
            setAlarmState(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func startMetricStreams(input: StartMetricStreamsInput) async throws -> StartMetricStreamsOutputResponse
    {
        typealias startMetricStreamsContinuation = CheckedContinuation<StartMetricStreamsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: startMetricStreamsContinuation) in
            startMetricStreams(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func stopMetricStreams(input: StopMetricStreamsInput) async throws -> StopMetricStreamsOutputResponse
    {
        typealias stopMetricStreamsContinuation = CheckedContinuation<StopMetricStreamsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: stopMetricStreamsContinuation) in
            stopMetricStreams(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
