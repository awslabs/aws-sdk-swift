...
public class KinesisVideoMediaClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try KinesisVideoMediaClientConfiguration(region: unwrappedRegion)
    ...
    public class KinesisVideoMediaClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("KinesisVideoMediaClient")
