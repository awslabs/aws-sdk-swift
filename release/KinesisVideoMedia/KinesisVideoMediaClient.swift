...
extension KinesisVideoMediaClient: KinesisVideoMediaClientProtocol {
    ...
    ///          </note>
    public func getMedia(input: GetMediaInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetMediaOutput, GetMediaOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<GetMediaInput, GetMediaOutput, GetMediaOutputError>(id: "getMedia")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetMediaInput, GetMediaOutput, GetMediaOutputError>(contentType: "application/json"))
