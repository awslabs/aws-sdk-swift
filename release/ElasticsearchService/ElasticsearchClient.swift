...
public class ElasticsearchClient {
    ...
    let config: ElasticsearchClientConfiguration
    let serviceName = "Elasticsearch"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: ElasticsearchClientConfiguration) {
    ...
    public class ElasticsearchClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "ElasticsearchClient")
        }
        ...
        public static func `default`() throws -> ElasticsearchClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try ElasticsearchClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}

public struct ElasticsearchClientLogHandlerFactory: SDKLogHandlerFactory {
