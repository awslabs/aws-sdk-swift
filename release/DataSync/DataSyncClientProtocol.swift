...
public protocol DataSyncClientProtocol {
    ...
    ///       task execution.</p>
    func cancelTaskExecution(input: CancelTaskExecutionInput, completion: @escaping (SdkResult<CancelTaskExecutionOutput, CancelTaskExecutionOutputError>) -> Void)
    ...
    ///          <p></p>
    func createAgent(input: CreateAgentInput, completion: @escaping (SdkResult<CreateAgentOutput, CreateAgentOutputError>) -> Void)
    /// <p>Creates an endpoint for an Amazon EFS file system.</p>
    func createLocationEfs(input: CreateLocationEfsInput, completion: @escaping (SdkResult<CreateLocationEfsOutput, CreateLocationEfsOutputError>) -> Void)
    /// <p>Creates an endpoint for an Amazon FSx for Windows File Server file system.</p>
    func createLocationFsxWindows(input: CreateLocationFsxWindowsInput, completion: @escaping (SdkResult<CreateLocationFsxWindowsOutput, CreateLocationFsxWindowsOutputError>) -> Void)
    /// <p>Defines a file system on a Network File System (NFS) server that can be read from or
    ///       written to.</p>
    func createLocationNfs(input: CreateLocationNfsInput, completion: @escaping (SdkResult<CreateLocationNfsOutput, CreateLocationNfsOutputError>) -> Void)
    ...
    func createLocationObjectStorage(input: CreateLocationObjectStorageInput, completion: @escaping (SdkResult<CreateLocationObjectStorageOutput, CreateLocationObjectStorageOutputError>) -> Void)
    ...
    func createLocationS3(input: CreateLocationS3Input, completion: @escaping (SdkResult<CreateLocationS3Output, CreateLocationS3OutputError>) -> Void)
    /// <p>Defines a file system on a Server Message Block (SMB) server that can be read from or
    ///       written to.</p>
    func createLocationSmb(input: CreateLocationSmbInput, completion: @escaping (SdkResult<CreateLocationSmbOutput, CreateLocationSmbOutputError>) -> Void)
    /// <p>Creates a task.</p>
    ...
    ///     </p>
    ///          </important>
    func createTask(input: CreateTaskInput, completion: @escaping (SdkResult<CreateTaskOutput, CreateTaskOutputError>) -> Void)
    ...
    ///       environment.</p>
    func deleteAgent(input: DeleteAgentInput, completion: @escaping (SdkResult<DeleteAgentOutput, DeleteAgentOutputError>) -> Void)
    /// <p>Deletes the configuration of a location used by AWS DataSync. </p>
    func deleteLocation(input: DeleteLocationInput, completion: @escaping (SdkResult<DeleteLocationOutput, DeleteLocationOutputError>) -> Void)
    /// <p>Deletes a task.</p>
    func deleteTask(input: DeleteTaskInput, completion: @escaping (SdkResult<DeleteTaskOutput, DeleteTaskOutputError>) -> Void)
    ...
    func describeAgent(input: DescribeAgentInput, completion: @escaping (SdkResult<DescribeAgentOutput, DescribeAgentOutputError>) -> Void)
    /// <p>Returns metadata, such as the path information about an Amazon EFS location.</p>
    func describeLocationEfs(input: DescribeLocationEfsInput, completion: @escaping (SdkResult<DescribeLocationEfsOutput, DescribeLocationEfsOutputError>) -> Void)
    /// <p>Returns metadata, such as the path information about an Amazon FSx for Windows File Server
    ///       location.</p>
    func describeLocationFsxWindows(input: DescribeLocationFsxWindowsInput, completion: @escaping (SdkResult<DescribeLocationFsxWindowsOutput, DescribeLocationFsxWindowsOutputError>) -> Void)
    /// <p>Returns metadata, such as the path information, about an NFS location.</p>
    func describeLocationNfs(input: DescribeLocationNfsInput, completion: @escaping (SdkResult<DescribeLocationNfsOutput, DescribeLocationNfsOutputError>) -> Void)
    /// <p>Returns metadata about a self-managed object storage server location. For more information
    ///       about self-managed object storage locations, see <a href="https://docs.aws.amazon.com/datasync/latest/userguide/create-object-location.html">Creating a location for object storage</a>.</p>
    func describeLocationObjectStorage(input: DescribeLocationObjectStorageInput, completion: @escaping (SdkResult<DescribeLocationObjectStorageOutput, DescribeLocationObjectStorageOutputError>) -> Void)
    /// <p>Returns metadata, such as bucket name, about an Amazon S3 bucket location.</p>
    func describeLocationS3(input: DescribeLocationS3Input, completion: @escaping (SdkResult<DescribeLocationS3Output, DescribeLocationS3OutputError>) -> Void)
    /// <p>Returns metadata, such as the path and user information about an SMB location.</p>
    func describeLocationSmb(input: DescribeLocationSmbInput, completion: @escaping (SdkResult<DescribeLocationSmbOutput, DescribeLocationSmbOutputError>) -> Void)
    /// <p>Returns metadata about a task.</p>
    func describeTask(input: DescribeTaskInput, completion: @escaping (SdkResult<DescribeTaskOutput, DescribeTaskOutputError>) -> Void)
    /// <p>Returns detailed metadata about a task that is being executed.</p>
    func describeTaskExecution(input: DescribeTaskExecutionInput, completion: @escaping (SdkResult<DescribeTaskExecutionOutput, DescribeTaskExecutionOutputError>) -> Void)
    ...
    func listAgents(input: ListAgentsInput, completion: @escaping (SdkResult<ListAgentsOutput, ListAgentsOutputError>) -> Void)
    ...
    func listLocations(input: ListLocationsInput, completion: @escaping (SdkResult<ListLocationsOutput, ListLocationsOutputError>) -> Void)
    ...
    func listTaskExecutions(input: ListTaskExecutionsInput, completion: @escaping (SdkResult<ListTaskExecutionsOutput, ListTaskExecutionsOutputError>) -> Void)
    /// <p>Returns a list of all the tasks.</p>
    func listTasks(input: ListTasksInput, completion: @escaping (SdkResult<ListTasksOutput, ListTasksOutputError>) -> Void)
    ...
    func startTaskExecution(input: StartTaskExecutionInput, completion: @escaping (SdkResult<StartTaskExecutionOutput, StartTaskExecutionOutputError>) -> Void)
    ...
    func updateAgent(input: UpdateAgentInput, completion: @escaping (SdkResult<UpdateAgentOutput, UpdateAgentOutputError>) -> Void)
    ...
    func updateLocationNfs(input: UpdateLocationNfsInput, completion: @escaping (SdkResult<UpdateLocationNfsOutput, UpdateLocationNfsOutputError>) -> Void)
    ...
    func updateLocationObjectStorage(input: UpdateLocationObjectStorageInput, completion: @escaping (SdkResult<UpdateLocationObjectStorageOutput, UpdateLocationObjectStorageOutputError>) -> Void)
    ...
    func updateLocationSmb(input: UpdateLocationSmbInput, completion: @escaping (SdkResult<UpdateLocationSmbOutput, UpdateLocationSmbOutputError>) -> Void)
    /// <p>Updates the metadata associated with a task.</p>
    func updateTask(input: UpdateTaskInput, completion: @escaping (SdkResult<UpdateTaskOutput, UpdateTaskOutputError>) -> Void)
    ...
    ///                </code>.</p>
    ///          </note>
    func updateTaskExecution(input: UpdateTaskExecutionInput, completion: @escaping (SdkResult<UpdateTaskExecutionOutput, UpdateTaskExecutionOutputError>) -> Void)
}
