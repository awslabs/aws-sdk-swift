...
extension SesClientTypes {
    ...
    ///             email.
    ///         For information about adding a header using a receipt rule, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-action-add-header.html">Amazon SES
    ///                 Developer Guide.
...
extension SesClientTypes {
    ...
    public struct BounceAction: Swift.Equatable {
        ...
        /// The SMTP reply code, as defined by <a href="https://tools.ietf.org/html/rfc5321">RFC 5321.
        /// This member is required.
        public let smtpReplyCode: Swift.String?
        /// The SMTP enhanced status code, as defined by <a href="https://tools.ietf.org/html/rfc3463">RFC 3463.
        ...
        ///             Amazon SNS topics, see the <a href="https://docs.aws.amazon.com/sns/latest/dg/CreateTopic.html">Amazon SNS Developer Guide.
...
extension SesClientTypes {
    ...
    public struct BulkEmailDestination: Swift.Equatable {
        ...
        ///                 Punycode, as described in <a href="https://tools.ietf.org/html/rfc3492.html">RFC3492.
        ///
        /// This member is required.
...
///             receipt rule sets to receive email with Amazon SES. For more information, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-concepts.html">Amazon SES Developer Guide.
...
extension SesClientTypes {
    ...
    ///             Amazon CloudWatch.
    ///         For information about publishing email sending events to Amazon CloudWatch, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/monitor-sending-activity.html">Amazon SES Developer Guide.
...
extension SesClientTypes {
    ...
    ///             send using Amazon SES. For more information about using configuration sets, see <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/using-configuration-sets.html">Using Amazon SES Configuration Sets in the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/">Amazon SES Developer Guide.
...
public struct CreateCustomVerificationEmailTemplateInput: Swift.Equatable {
    ...
    ///             information, see <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/custom-verification-emails.html#custom-verification-emails-faq">Custom Verification Email Frequently Asked Questions in the Amazon SES
    ///                 Developer Guide.
    /// This member is required.
...
///             when you receive email with Amazon SES. For more information, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-concepts.html">Amazon SES Developer Guide.
...
/// Represents a request to create an email template. For more information, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-personalized-email-api.html">Amazon SES Developer
///                 Guide.
...
///             sets to receive email with Amazon SES. For more information, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-concepts.html">Amazon SES Developer Guide.
...
///             For more information about Easy DKIM, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Amazon SES Developer Guide.
...
extension SesClientTypes {
    ...
    public struct IdentityDkimAttributes: Swift.Equatable {
        ...
        ///         For more information about creating DNS records using DKIM tokens, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Amazon SES Developer
        ///                 Guide.
...
extension SesClientTypes {
    ...
    ///                 Guide.
    ///         For information about using AWS Lambda actions in receipt rules, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-action-lambda.html">Amazon SES Developer
    ///                 Guide.
    public struct LambdaAction: Swift.Equatable {
        ...
        ///             For more information about AWS Lambda, see the <a href="https://docs.aws.amazon.com/lambda/latest/dg/welcome.html">AWS Lambda Developer Guide.
        /// This member is required.
        public let functionArn: Swift.String?
        ...
        ///             information about AWS Lambda invocation types, see the <a href="https://docs.aws.amazon.com/lambda/latest/dg/API_Invoke.html">AWS Lambda Developer Guide.
        ///
...
///             account.
///         For more information about custom verification email templates, see <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/custom-verification-emails.html">Using Custom
...
///             authorize other senders to use your identities. For information, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization.html">Amazon SES Developer Guide.
...
extension SesClientTypes {
    ...
    public struct MessageDsn: Swift.Equatable {
        /// When the message was received by the reporting mail transfer agent (MTA), in <a href="https://www.ietf.org/rfc/rfc0822.txt">RFC 822 date-time format.
        ...
        ///                 <a href="https://tools.ietf.org/html/rfc3464">RFC 3464
...
extension SesClientTypes {
    ...
    ///             sending events. For information about using configuration sets, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/monitor-sending-activity.html">Amazon SES Developer Guide.
...
extension SesClientTypes {
    ...
    public struct RawMessage: Swift.Equatable {
        ...
        ///
        ///         For more information, go to the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-email-raw.html">Amazon SES Developer
        ///             Guide.
        /// This member is required.
...
extension SesClientTypes {
    ...
    public struct ReceiptIpFilter: Swift.Equatable {
        ...
        ///             more information about CIDR notation, see <a href="https://tools.ietf.org/html/rfc2317">RFC 2317.
        /// This member is required.
...
extension SesClientTypes {
    ...
    public struct RecipientDsnFields: Swift.Equatable {
        ...
        ///             attempt to deliver the message to the recipient address. This is required by <a href="https://tools.ietf.org/html/rfc3464">RFC 3464.
        /// This member is required.
        ...
        ///                 <a href="https://tools.ietf.org/html/rfc3463">RFC 3463 for the correct
        ...
        ///                     822;, as described in <a href="https://tools.ietf.org/html/rfc3798">RFC 3798.
        ///
        public let finalRecipient: Swift.String?
        /// The time the final delivery attempt was made, in <a href="https://www.ietf.org/rfc/rfc0822.txt">RFC 822 date-time format.
        ...
        ///             specified in <a href="https://tools.ietf.org/html/rfc3464">RFC 3464
        ...
        /// The status code that indicates what went wrong. This is required by <a href="https://tools.ietf.org/html/rfc3464">RFC 3464.
        /// This member is required.
...
extension SesClientTypes {
    ...
    ///
    ///         For information about specifying Amazon S3 actions in receipt rules, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-action-s3.html">Amazon SES Developer Guide.
    public struct S3Action: Swift.Equatable {
        ...
        ///
        ///
        ///         For more information about key policies, see the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html">AWS KMS Developer Guide. If
        ...
        ///                     <a href="http://aws.amazon.com/sdk-for-java/">AWS SDK for Java and <a href="http://aws.amazon.com/sdk-for-ruby/">AWS SDK for Ruby only. For more
        ///                 information about client-side encryption using AWS KMS master keys, see the <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingClientSideEncryption.html">Amazon S3 Developer Guide.
        ///
...
extension SesClientTypes {
    ...
    public struct SNSAction: Swift.Equatable {
        ...
        ///             information about Amazon SNS topics, see the <a href="https://docs.aws.amazon.com/sns/latest/dg/CreateTopic.html">Amazon SNS Developer Guide.
        /// This member is required.
        public let topicArn: Swift.String?
...
extension SesClientTypes {
    ...
    public struct SNSDestination: Swift.Equatable {
        ...
        ///             more information about Amazon SNS topics, see the <a href="https://docs.aws.amazon.com/sns/latest/dg/CreateTopic.html">Amazon SNS Developer Guide.
        /// This member is required.
        public let topicARN: Swift.String?
...
public struct SendBulkTemplatedEmailInput: Swift.Equatable {
    ...
    ///             parameter. For more information about sending authorization, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization.html">Amazon SES Developer Guide.
    ///
    ///             Amazon SES does not support the SMTPUTF8 extension, as described in <a href="https://tools.ietf.org/html/rfc6531">RFC6531. For this reason, the
    ...
    ///                     characters. If the domain part of an address (the
    ///                 part after the @ sign) contains non-ASCII characters, they must be encoded using
    ///                 Punycode, as described in <a href="https://tools.ietf.org/html/rfc3492.html">RFC3492. The sender name (also known as the friendly
    ///                     name) may contain non-ASCII characters. These characters must be
    ///                 encoded using MIME encoded-word syntax, as described in <a href="https://tools.ietf.org/html/rfc2047">RFC 2047. MIME encoded-word
...
///             the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-email-raw.html">Amazon SES Developer Guide.
public struct SendRawEmailInput: Swift.Equatable {
    ...
    ///                     SendRawEmail in this guide, or see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization-delegate-sender-tasks-email.html">Amazon SES Developer Guide.
    ///
    ...
    ///                     content. For more information, see <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-email-raw.html">Sending Raw Email in the Amazon SES Developer
    ///                     Guide.
    ///
    ///
...
///             more information about setting up Easy DKIM, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Amazon SES Developer Guide.
...
public struct SetIdentityMailFromDomainInput: Swift.Equatable {
    ...
    ///             more information, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/mail-from.html">Amazon SES Developer Guide), and
...
///             use receipt rule sets to receive email with Amazon SES. For more information, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-concepts.html">Amazon SES Developer Guide.
...
extension SesClientTypes {
    ...
    ///         For information about setting a stop action in a receipt rule, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-action-stop.html">Amazon SES Developer
    ///                 Guide.
...
extension SesClientTypes {
    ...
    ///             procedure.
    ///         For information using a receipt rule to call Amazon WorkMail, see the <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-action-workmail.html">Amazon SES Developer
    ///                 Guide.
