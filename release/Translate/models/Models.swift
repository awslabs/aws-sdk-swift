...
public struct DescribeTextTranslationJobInput: Swift.Equatable {
    /// The identifier that Amazon Translate generated for the job. The StartTextTranslationJob operation returns this identifier in its
    ///       response.
    /// This member is required.
...
/// The confidence that Amazon Comprehend accurately detected the source language is low. If a
///       low confidence level is acceptable for your application, you can use the language in the
///       exception to call Amazon Translate again. For more information, see the <a href="https://docs.aws.amazon.com/comprehend/latest/dg/API_DetectDominantLanguage.html">DetectDominantLanguage operation in the Amazon Comprehend Developer
///         Guide.
...
/// The value of the parameter is invalid. Review the value of the parameter you are using to
...
public struct TranslateTextInput: Swift.Equatable {
    ...
    ///         auto, Amazon Translate will call <a href="https://docs.aws.amazon.com/comprehend/latest/dg/comprehend-general.html">Amazon
