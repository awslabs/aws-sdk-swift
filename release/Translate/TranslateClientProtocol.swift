...
public protocol TranslateClientProtocol {
    ...
    func createParallelData(input: CreateParallelDataInput, completion: @escaping (SdkResult<CreateParallelDataOutput, CreateParallelDataOutputError>) -> Void)
    /// <p>Deletes a parallel data resource in Amazon Translate.</p>
    func deleteParallelData(input: DeleteParallelDataInput, completion: @escaping (SdkResult<DeleteParallelDataOutput, DeleteParallelDataOutputError>) -> Void)
    /// <p>A synchronous action that deletes a custom terminology.</p>
    func deleteTerminology(input: DeleteTerminologyInput, completion: @escaping (SdkResult<DeleteTerminologyOutput, DeleteTerminologyOutputError>) -> Void)
    ...
    func describeTextTranslationJob(input: DescribeTextTranslationJobInput, completion: @escaping (SdkResult<DescribeTextTranslationJobOutput, DescribeTextTranslationJobOutputError>) -> Void)
    /// <p>Provides information about a parallel data resource.</p>
    func getParallelData(input: GetParallelDataInput, completion: @escaping (SdkResult<GetParallelDataOutput, GetParallelDataOutputError>) -> Void)
    /// <p>Retrieves a custom terminology.</p>
    func getTerminology(input: GetTerminologyInput, completion: @escaping (SdkResult<GetTerminologyOutput, GetTerminologyOutputError>) -> Void)
    ...
    func importTerminology(input: ImportTerminologyInput, completion: @escaping (SdkResult<ImportTerminologyOutput, ImportTerminologyOutputError>) -> Void)
    /// <p>Provides a list of your parallel data resources in Amazon Translate.</p>
    func listParallelData(input: ListParallelDataInput, completion: @escaping (SdkResult<ListParallelDataOutput, ListParallelDataOutputError>) -> Void)
    /// <p>Provides a list of custom terminologies associated with your account.</p>
    func listTerminologies(input: ListTerminologiesInput, completion: @escaping (SdkResult<ListTerminologiesOutput, ListTerminologiesOutputError>) -> Void)
    /// <p>Gets a list of the batch translation jobs that you have submitted.</p>
    func listTextTranslationJobs(input: ListTextTranslationJobsInput, completion: @escaping (SdkResult<ListTextTranslationJobsOutput, ListTextTranslationJobsOutputError>) -> Void)
    ...
    ///          </note>
    func startTextTranslationJob(input: StartTextTranslationJobInput, completion: @escaping (SdkResult<StartTextTranslationJobOutput, StartTextTranslationJobOutputError>) -> Void)
    ...
    func stopTextTranslationJob(input: StopTextTranslationJobInput, completion: @escaping (SdkResult<StopTextTranslationJobOutput, StopTextTranslationJobOutputError>) -> Void)
    /// <p>Translates input text from the source language to the target language. For a list of
    ///       available languages and language codes, see <a>what-is-languages</a>.</p>
    func translateText(input: TranslateTextInput, completion: @escaping (SdkResult<TranslateTextOutput, TranslateTextOutputError>) -> Void)
    /// <p>Updates a previously created parallel data resource by importing a new input file from
    ///       Amazon S3.</p>
    func updateParallelData(input: UpdateParallelDataInput, completion: @escaping (SdkResult<UpdateParallelDataOutput, UpdateParallelDataOutputError>) -> Void)
}
