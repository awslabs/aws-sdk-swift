...
public struct CreateFHIRDatastoreInput: Swift.Equatable {
    ...
    var datastoreTypeVersion: HealthLakeClientTypes.FHIRVersion?
    /// Optional parameter to preload data upon creation of the Data Store. Currently, the only supported preloaded data is synthetic data generated from Synthea.
    var preloadDataConfig: HealthLakeClientTypes.PreloadDataConfig?
    /// The server-side encryption key configuration for a customer provided encryption key specified for creating a Data Store.
    var sseConfiguration: HealthLakeClientTypes.SseConfiguration?
    /// Resource tags that are applied to a Data Store when it is created.
    var tags: [HealthLakeClientTypes.Tag]?
...
public struct CreateFHIRDatastoreOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var datastoreEndpoint: Swift.String?
    /// The AWS-generated Data Store id. This id is in the output from the initial Data Store creation call.
    /// This member is required.
    var datastoreId: Swift.String?
    /// The status of the FHIR Data Store. Possible statuses are ‘CREATING’, ‘ACTIVE’, ‘DELETING’, ‘DELETED’.
    /// This member is required.
    var datastoreStatus: HealthLakeClientTypes.DatastoreStatus?
...
extension HealthLakeClientTypes {
    ...
    public struct DatastoreFilter: Swift.Equatable {
        ...
        var createdAfter: ClientRuntime.Date?
        /// A filter that allows the user to set cutoff dates for records. All Data Stores created before the specified date will be included in the results.
        var createdBefore: ClientRuntime.Date?
...
public struct DescribeFHIRDatastoreOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var datastoreProperties: HealthLakeClientTypes.DatastoreProperties?
...
public struct DescribeFHIRExportJobOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var exportJobProperties: HealthLakeClientTypes.ExportJobProperties?
...
public struct DescribeFHIRImportJobOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var importJobProperties: HealthLakeClientTypes.ImportJobProperties?
...
extension HealthLakeClientTypes {
    ...
    public struct ExportJobProperties: Swift.Equatable {
        ...
        /// This member is required.
        var jobStatus: HealthLakeClientTypes.JobStatus?
        /// An explanation of any errors that may have occurred during the export job.
        var message: Swift.String?
        /// The output data configuration that was supplied when the export job was created.
        /// This member is required.
        var outputDataConfig: HealthLakeClientTypes.OutputDataConfig?
...
extension HealthLakeClientTypes {
    ...
    public struct ImportJobProperties: Swift.Equatable {
        ...
        /// This member is required.
        var inputDataConfig: HealthLakeClientTypes.InputDataConfig?
        ...
        var jobName: Swift.String?
        /// The output data configuration that was supplied when the export job was created.
        var jobOutputDataConfig: HealthLakeClientTypes.OutputDataConfig?
...
extension HealthLakeClientTypes {
    ...
    public struct KmsEncryptionConfig: Swift.Equatable {
        ...
        /// This member is required.
        var cmkType: HealthLakeClientTypes.CmkType?
...
public struct ListFHIRDatastoresInput: Swift.Equatable {
    ...
    var filter: HealthLakeClientTypes.DatastoreFilter?
...
public struct ListFHIRDatastoresOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var datastorePropertiesList: [HealthLakeClientTypes.DatastoreProperties]?
...
public struct ListFHIRExportJobsInput: Swift.Equatable {
    ...
    var submittedAfter: ClientRuntime.Date?
    /// This parameter limits the response to FHIR export jobs submitted before a user specified date.
    var submittedBefore: ClientRuntime.Date?
...
public struct ListFHIRExportJobsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var exportJobPropertiesList: [HealthLakeClientTypes.ExportJobProperties]?
    /// A pagination token used to identify the next page of results to return for a ListFHIRExportJobs query.
    var nextToken: Swift.String?
...
public struct ListFHIRImportJobsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var importJobPropertiesList: [HealthLakeClientTypes.ImportJobProperties]?
    /// A pagination token used to identify the next page of results to return for a ListFHIRImportJobs query.
    var nextToken: Swift.String?
...
extension HealthLakeClientTypes {
    ...
    public struct PreloadDataConfig: Swift.Equatable {
        ...
        /// This member is required.
        var preloadDataType: HealthLakeClientTypes.PreloadDataType?
...
extension HealthLakeClientTypes {
    ...
    public struct SseConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var kmsEncryptionConfig: HealthLakeClientTypes.KmsEncryptionConfig?
