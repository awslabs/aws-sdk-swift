...
public protocol WorkMailMessageFlowClientProtocol {
    ...
    func getRawMessageContent(input: GetRawMessageContentInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetRawMessageContentOutput, GetRawMessageContentOutputError>) -> Void)
    ...
    ///     </p>
    ///          </note>
    func putRawMessageContent(input: PutRawMessageContentInput, completion: @escaping (SdkResult<PutRawMessageContentOutput, PutRawMessageContentOutputError>) -> Void)
}
