...
extension WorkMailMessageFlowClient: WorkMailMessageFlowClientProtocol {
    ...
    public func getRawMessageContent(input: GetRawMessageContentInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetRawMessageContentOutputResponse, GetRawMessageContentOutputError>) -> Void)
    {
