...
extension VoiceIdClientTypes {
    ...
    public struct AuthenticationConfiguration: Swift.Equatable {
        ...
        var acceptanceThreshold: Swift.Int?
...
extension VoiceIdClientTypes {
    ...
    public struct AuthenticationResult: Swift.Equatable {
        ...
        var audioAggregationEndedAt: ClientRuntime.Date?
        /// A timestamp indicating when audio aggregation started for this authentication result.
        var audioAggregationStartedAt: ClientRuntime.Date?
        ...
        var authenticationResultId: Swift.String?
        /// The AuthenticationConfiguration used to generate this authentication result.
        var configuration: VoiceIdClientTypes.AuthenticationConfiguration?
        ...
        var customerSpeakerId: Swift.String?
        /// The authentication decision produced by Voice ID, processed against the current session state and streamed audio of the speaker.
        var decision: VoiceIdClientTypes.AuthenticationDecision?
        /// The service-generated identifier for the speaker whose authentication result is produced.
        var generatedSpeakerId: Swift.String?
...
public struct CreateDomainInput: Swift.Equatable {
    ...
    /// This member is required.
    var serverSideEncryptionConfiguration: VoiceIdClientTypes.ServerSideEncryptionConfiguration?
    /// A list of tags you want added to the domain.
    var tags: [VoiceIdClientTypes.Tag]?
...
public struct CreateDomainOutputResponse: Swift.Equatable {
    ...
    var domain: VoiceIdClientTypes.Domain?
...
public struct DescribeFraudsterOutputResponse: Swift.Equatable {
    ...
    var fraudster: VoiceIdClientTypes.Fraudster?
...
public struct DescribeFraudsterRegistrationJobOutputResponse: Swift.Equatable {
    ...
    var job: VoiceIdClientTypes.FraudsterRegistrationJob?
...
public struct DescribeSpeakerEnrollmentJobOutputResponse: Swift.Equatable {
    ...
    var job: VoiceIdClientTypes.SpeakerEnrollmentJob?
...
public struct DescribeSpeakerOutputResponse: Swift.Equatable {
    ...
    var speaker: VoiceIdClientTypes.Speaker?
...
extension VoiceIdClientTypes {
    ...
    public struct Domain: Swift.Equatable {
        ...
        var domainStatus: VoiceIdClientTypes.DomainStatus?
...
extension VoiceIdClientTypes {
    ...
    public struct EnrollmentConfig: Swift.Equatable {
        ...
        var existingEnrollmentAction: VoiceIdClientTypes.ExistingEnrollmentAction?
        /// The fraud detection configuration to use for the speaker enrollment job.
        var fraudDetectionConfig: VoiceIdClientTypes.EnrollmentJobFraudDetectionConfig?
...
extension VoiceIdClientTypes {
    ...
    public struct EnrollmentJobFraudDetectionConfig: Swift.Equatable {
        ...
        var fraudDetectionAction: VoiceIdClientTypes.FraudDetectionAction?
        /// Threshold value for determining whether the speaker is a high risk to be fraudulent. If the detected risk score calculated by Voice ID is greater than or equal to the threshold, the speaker is considered a fraudster.
        var riskThreshold: Swift.Int?
...
public struct EvaluateSessionInput: Swift.Equatable {
    ...
    /// This member is required.
    var sessionNameOrId: Swift.String?
...
public struct EvaluateSessionOutputResponse: Swift.Equatable {
    ...
    var authenticationResult: VoiceIdClientTypes.AuthenticationResult?
    /// The identifier of the domain containing the session.
    var domainId: Swift.String?
    /// Details resulting from the fraud detection process, such as fraud detection decision and risk score.
    var fraudDetectionResult: VoiceIdClientTypes.FraudDetectionResult?
    /// The service-generated identifier of the session.
    var sessionId: Swift.String?
    /// The client-provided name of the session.
    var sessionName: Swift.String?
    ...
    var streamingStatus: VoiceIdClientTypes.StreamingStatus?
...
extension VoiceIdClientTypes {
    ...
    public struct FraudDetectionResult: Swift.Equatable {
        ...
        var configuration: VoiceIdClientTypes.FraudDetectionConfiguration?
        /// The fraud detection decision produced by Voice ID, processed against the current session state and streamed audio of the speaker.
        var decision: VoiceIdClientTypes.FraudDetectionDecision?
        /// The unique identifier for this fraud detection result. Given there can be multiple fraud detections for a given session, this field helps in identifying if the returned result is from previous streaming activity or a new result. Note that in the absence of any new streaming activity or risk threshold changes, Voice ID always returns cached Fraud Detection result for this API.
        var fraudDetectionResultId: Swift.String?
        ...
        var reasons: [VoiceIdClientTypes.FraudDetectionReason]?
        /// Details about each risk analyzed for this speaker.
        var riskDetails: VoiceIdClientTypes.FraudRiskDetails?
...
extension VoiceIdClientTypes {
    ...
    public struct FraudRiskDetails: Swift.Equatable {
        ...
        /// This member is required.
        var knownFraudsterRisk: VoiceIdClientTypes.KnownFraudsterRisk?
...
extension VoiceIdClientTypes {
    ...
    public struct Fraudster: Swift.Equatable {
        ...
        var generatedFraudsterId: Swift.String?
...
extension VoiceIdClientTypes {
    ...
    public struct FraudsterRegistrationJob: Swift.Equatable {
        ...
        var failureDetails: VoiceIdClientTypes.FailureDetails?
        ...
        var inputDataConfig: VoiceIdClientTypes.InputDataConfig?
        /// The service-generated identifier for the fraudster registration job.
        var jobId: Swift.String?
        /// The client-provied name for the fraudster registration job.
        var jobName: Swift.String?
        /// Shows the completed percentage of registration requests listed in the input file.
        var jobProgress: VoiceIdClientTypes.JobProgress?
        /// The current status of the fraudster registration job.
        var jobStatus: VoiceIdClientTypes.FraudsterRegistrationJobStatus?
        /// The output data config containing the S3 location where you want Voice ID to write your job output file; you must also include a KMS Key ID in order to encrypt the file.
        var outputDataConfig: VoiceIdClientTypes.OutputDataConfig?
        /// The registration config containing details such as the action to take when a duplicate fraudster is detected, and the similarity threshold to use for detecting a duplicate fraudster.
        var registrationConfig: VoiceIdClientTypes.RegistrationConfig?
...
public struct ListDomainsOutputResponse: Swift.Equatable {
    ...
    var domainSummaries: [VoiceIdClientTypes.DomainSummary]?
    /// If NextToken is returned, there are more results available. The value of NextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours.
    var nextToken: Swift.String?
...
public struct ListFraudsterRegistrationJobsOutputResponse: Swift.Equatable {
    ...
    var jobSummaries: [VoiceIdClientTypes.FraudsterRegistrationJobSummary]?
    /// If NextToken is returned, there are more results available. The value of NextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours.
    var nextToken: Swift.String?
...
public struct ListSpeakerEnrollmentJobsInput: Swift.Equatable {
    ...
    var jobStatus: VoiceIdClientTypes.SpeakerEnrollmentJobStatus?
    /// The maximum number of results that are returned per call. You can use NextToken to obtain further pages of results. The default is 100; the maximum allowed page size is also 100.
    var maxResults: Swift.Int?
    /// If NextToken is returned, there are more results available. The value of NextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours.
    var nextToken: Swift.String?
...
public struct ListSpeakerEnrollmentJobsOutputResponse: Swift.Equatable {
    ...
    var jobSummaries: [VoiceIdClientTypes.SpeakerEnrollmentJobSummary]?
    /// If NextToken is returned, there are more results available. The value of NextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours.
    var nextToken: Swift.String?
...
public struct ListSpeakersOutputResponse: Swift.Equatable {
    ...
    var speakerSummaries: [VoiceIdClientTypes.SpeakerSummary]?
...
extension VoiceIdClientTypes {
    ...
    public struct RegistrationConfig: Swift.Equatable {
        ...
        var duplicateRegistrationAction: VoiceIdClientTypes.DuplicateRegistrationAction?
        /// The minimum similarity score between the new and old fraudsters in order to consider the new fraudster a duplicate.
        var fraudsterSimilarityThreshold: Swift.Int?
...
extension VoiceIdClientTypes {
    ...
    public struct Speaker: Swift.Equatable {
        ...
        var status: VoiceIdClientTypes.SpeakerStatus?
...
extension VoiceIdClientTypes {
    ...
    public struct SpeakerEnrollmentJob: Swift.Equatable {
        ...
        var enrollmentConfig: VoiceIdClientTypes.EnrollmentConfig?
        /// Contains details that are populated when an entire batch job fails. In cases of individual registration job failures, the batch job as a whole doesn't fail; it is completed with a JobStatus of COMPLETED_WITH_ERRORS. You can use the job output file to identify the individual registration requests that failed.
        var failureDetails: VoiceIdClientTypes.FailureDetails?
