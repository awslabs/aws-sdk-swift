...
/// to access the nested member `[VoiceIdClientTypes.DomainSummary]`
/// - Returns: `[VoiceIdClientTypes.DomainSummary]`
extension PaginatorSequence where Input == ListDomainsInput, Output == ListDomainsOutputResponse {
    public func domainSummaries() async throws -> [VoiceIdClientTypes.DomainSummary] {
        return try await self.asyncCompactMap { item in item.domainSummaries }
    }
}
