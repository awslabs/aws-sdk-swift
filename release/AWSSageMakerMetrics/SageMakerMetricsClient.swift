...
public class SageMakerMetricsClient {
    ...
    public class SageMakerMetricsClientConfiguration: SageMakerMetricsClientConfigurationProtocol {
        ...
        public convenience init(
            ...
            let runtimeConfig = try ClientRuntime.DefaultSDKRuntimeConfiguration("SageMakerMetricsClient")
            try self.init(
...
extension SageMakerMetricsClient: SageMakerMetricsClientProtocol {
    ...
    public func batchPutMetrics(input: BatchPutMetricsInput) async throws -> BatchPutMetricsOutputResponse
    {
        ...
        guard let region = config.region else {
            throw SdkError<BatchPutMetricsOutputError>.client(ClientError.unknownError(("Missing required parameter: Region")))
        }
