...
public class TimestreamWriteClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try TimestreamWriteClientConfiguration(region: unwrappedRegion)
    ...
    public class TimestreamWriteClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("TimestreamWriteClient")
