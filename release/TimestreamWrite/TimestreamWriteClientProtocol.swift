...
public protocol TimestreamWriteClientProtocol {
    ...
    func describeDatabase(input: DescribeDatabaseInput, completion: @escaping (SdkResult<DescribeDatabaseOutput, DescribeDatabaseOutputError>) -> Void)
    ...
    ///         </p>
    func writeRecords(input: WriteRecordsInput, completion: @escaping (SdkResult<WriteRecordsOutput, WriteRecordsOutputError>) -> Void)
}
