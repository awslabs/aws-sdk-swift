...
extension BadRequestException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BadRequestException(details: \(Swift.String(describing: details)), message: \(Swift.String(describing: message)), reason: \(Swift.String(describing: reason)))"}
}
...
struct BadRequestExceptionBody: Swift.Equatable {
    ...
    public let reason: AppConfigClientTypes.BadRequestReason?
    public let details: AppConfigClientTypes.BadRequestDetails?
}
...
extension AppConfigClientTypes.ConfigurationProfileSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConfigurationProfileSummary(applicationId: \(Swift.String(describing: applicationId)), id: \(Swift.String(describing: id)), locationUri: \(Swift.String(describing: locationUri)), name: \(Swift.String(describing: name)), type: \(Swift.String(describing: type)), validatorTypes: \(Swift.String(describing: validatorTypes)))"}
}
...
extension AppConfigClientTypes.InvalidConfigurationDetail: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidConfigurationDetail(constraint: \(Swift.String(describing: constraint)), location: \(Swift.String(describing: location)), reason: \(Swift.String(describing: reason)), type: \(Swift.String(describing: type)))"}
}
...
extension ListConfigurationProfilesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListConfigurationProfilesInput(applicationId: \(Swift.String(describing: applicationId)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), type: \(Swift.String(describing: type)))"}
}
