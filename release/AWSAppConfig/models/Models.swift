...
extension AppConfigClientTypes.BadRequestDetails: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension AppConfigClientTypes {
    ...
    public struct ConfigurationProfileSummary: Swift.Equatable {
        ...
        var validatorTypes: [AppConfigClientTypes.ValidatorType]?
...
public struct CreateConfigurationProfileInput: Swift.Equatable {
    ...
    var retrievalRoleArn: Swift.String?
    ...
    var validators: [AppConfigClientTypes.Validator]?
...
public struct CreateDeploymentStrategyInput: Swift.Equatable {
    ...
    /// This member is required.
    var deploymentDurationInMinutes: Swift.Int
    /// A description of the deployment strategy.
    var description: Swift.String?
    /// The amount of time AppConfig monitors for alarms before considering the deployment to be complete and no longer eligible for automatic roll back.
    var finalBakeTimeInMinutes: Swift.Int
    /// The percentage of targets to receive a deployed configuration during each interval.
    /// This member is required.
    var growthFactor: Swift.Float
    ...
    var growthType: AppConfigClientTypes.GrowthType?
    /// A name for the deployment strategy.
    /// This member is required.
    var name: Swift.String?
    /// Save the deployment strategy to a Systems Manager (SSM) document.
    /// This member is required.
    var replicateTo: AppConfigClientTypes.ReplicateTo?
...
public struct CreateEnvironmentInput: Swift.Equatable {
    ...
    var monitors: [AppConfigClientTypes.Monitor]?
...
public struct CreateEnvironmentOutputResponse: Swift.Equatable {
    ...
    var state: AppConfigClientTypes.EnvironmentState?
...
public struct CreateHostedConfigurationVersionInput: Swift.Equatable {
    ...
    /// The configuration profile ID.
    /// This member is required.
    var configurationProfileId: Swift.String?
    /// The content of the configuration or the configuration data.
    /// This member is required.
    var content: ClientRuntime.Data?
    ...
    var latestVersionNumber: Swift.Int
...
public struct DeleteDeploymentStrategyInput: Swift.Equatable {
    ...
    /// This member is required.
    var deploymentStrategyId: Swift.String?
...
public struct DeleteEnvironmentInput: Swift.Equatable {
    ...
    /// This member is required.
    var environmentId: Swift.String?
...
extension AppConfigClientTypes {
    ...
    public struct DeploymentEvent: Swift.Equatable {
        ...
        var eventType: AppConfigClientTypes.DeploymentEventType?
        /// The date and time the event occurred.
        var occurredAt: ClientRuntime.Date?
        ...
        var triggeredBy: AppConfigClientTypes.TriggeredBy?
...
extension AppConfigClientTypes {
    ...
    public struct DeploymentSummary: Swift.Equatable {
        ...
        var configurationName: Swift.String?
        /// The version of the configuration.
        var configurationVersion: Swift.String?
        /// Total amount of time the deployment lasted.
        var deploymentDurationInMinutes: Swift.Int
        /// The sequence number of the deployment.
        var deploymentNumber: Swift.Int
        ...
        var percentageComplete: Swift.Float
        /// Time the deployment started.
        var startedAt: ClientRuntime.Date?
        /// The state of the deployment.
        var state: AppConfigClientTypes.DeploymentState?
...
public struct GetConfigurationInput: Swift.Equatable {
    ...
    var clientConfigurationVersion: Swift.String?
    ...
    /// This member is required.
    var configuration: Swift.String?
    /// The environment to get. Specify either the environment name or the environment ID.
    /// This member is required.
    var environment: Swift.String?
...
public struct GetDeploymentOutputResponse: Swift.Equatable {
    ...
    var configurationLocationUri: Swift.String?
    /// The name of the configuration.
    var configurationName: Swift.String?
    ...
    var eventLog: [AppConfigClientTypes.DeploymentEvent]?
    /// The amount of time that AppConfig monitored for alarms before considering the deployment to be complete and no longer eligible for automatic rollback.
    var finalBakeTimeInMinutes: Swift.Int
    /// The percentage of targets to receive a deployed configuration during each interval.
    var growthFactor: Swift.Float
...
extension AppConfigClientTypes.InvalidConfigurationDetail: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ListApplicationsOutputResponse: Swift.Equatable {
    ...
    var items: [AppConfigClientTypes.Application]?
...
public struct ListConfigurationProfilesOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [AppConfigClientTypes.ConfigurationProfileSummary]?
    /// The token for the next set of items to return. Use this token to get the next set of results.
    var nextToken: Swift.String?
...
public struct ListDeploymentStrategiesOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [AppConfigClientTypes.DeploymentStrategy]?
    /// The token for the next set of items to return. Use this token to get the next set of results.
    var nextToken: Swift.String?
...
public struct ListDeploymentsOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [AppConfigClientTypes.DeploymentSummary]?
    /// The token for the next set of items to return. Use this token to get the next set of results.
    var nextToken: Swift.String?
...
public struct ListEnvironmentsOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [AppConfigClientTypes.Environment]?
    /// The token for the next set of items to return. Use this token to get the next set of results.
    var nextToken: Swift.String?
...
public struct ListHostedConfigurationVersionsOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [AppConfigClientTypes.HostedConfigurationVersionSummary]?
    /// The token for the next set of items to return. Use this token to get the next set of results.
    var nextToken: Swift.String?
...
extension AppConfigClientTypes {
    ...
    public struct Validator: Swift.Equatable {
        ...
        /// This member is required.
        var type: AppConfigClientTypes.ValidatorType?
