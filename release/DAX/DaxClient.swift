...
public class DaxClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try DaxClientConfiguration(region: unwrappedRegion)
    ...
    public class DaxClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("DaxClient")
...
public struct DaxClientLogHandlerFactory: SDKLogHandlerFactory {
