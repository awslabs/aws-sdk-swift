...
public protocol DaxClientProtocol {
    ...
    func createParameterGroup(input: CreateParameterGroupInput, completion: @escaping (SdkResult<CreateParameterGroupOutput, CreateParameterGroupOutputError>) -> Void)
    /// <p>Creates a new subnet group.</p>
    func createSubnetGroup(input: CreateSubnetGroupInput, completion: @escaping (SdkResult<CreateSubnetGroupOutput, CreateSubnetGroupOutputError>) -> Void)
    ...
    ///          </note>
    func decreaseReplicationFactor(input: DecreaseReplicationFactorInput, completion: @escaping (SdkResult<DecreaseReplicationFactorOutput, DecreaseReplicationFactorOutputError>) -> Void)
    ...
    func deleteParameterGroup(input: DeleteParameterGroupInput, completion: @escaping (SdkResult<DeleteParameterGroupOutput, DeleteParameterGroupOutputError>) -> Void)
    /// <p>Deletes a subnet group.</p>
    ///         <note>
    ///             <p>You cannot delete a subnet group if it is associated with any DAX
    ///                 clusters.</p>
    ///         </note>
    func deleteSubnetGroup(input: DeleteSubnetGroupInput, completion: @escaping (SdkResult<DeleteSubnetGroupOutput, DeleteSubnetGroupOutputError>) -> Void)
    ...
    ///             software.</p>
    func describeDefaultParameters(input: DescribeDefaultParametersInput, completion: @escaping (SdkResult<DescribeDefaultParametersOutput, DescribeDefaultParametersOutputError>) -> Void)
    ...
    func describeParameterGroups(input: DescribeParameterGroupsInput, completion: @escaping (SdkResult<DescribeParameterGroupsOutput, DescribeParameterGroupsOutputError>) -> Void)
    /// <p>Returns the detailed parameter list for a particular parameter group.</p>
    func describeParameters(input: DescribeParametersInput, completion: @escaping (SdkResult<DescribeParametersOutput, DescribeParametersOutputError>) -> Void)
    ...
    func describeSubnetGroups(input: DescribeSubnetGroupsInput, completion: @escaping (SdkResult<DescribeSubnetGroupsOutput, DescribeSubnetGroupsOutputError>) -> Void)
    /// <p>Adds one or more nodes to a DAX cluster.</p>
    func increaseReplicationFactor(input: IncreaseReplicationFactorInput, completion: @escaping (SdkResult<IncreaseReplicationFactorOutput, IncreaseReplicationFactorOutputError>) -> Void)
    ...
    ///         </note>
    func rebootNode(input: RebootNodeInput, completion: @escaping (SdkResult<RebootNodeOutput, RebootNodeOutputError>) -> Void)
    ...
    ///             values.</p>
    func updateCluster(input: UpdateClusterInput, completion: @escaping (SdkResult<UpdateClusterOutput, UpdateClusterOutputError>) -> Void)
    /// <p>Modifies the parameters of a parameter group. You can modify up to 20
    ///             parameters in a single request by submitting a list parameter name and value
    ///             pairs.</p>
    func updateParameterGroup(input: UpdateParameterGroupInput, completion: @escaping (SdkResult<UpdateParameterGroupOutput, UpdateParameterGroupOutputError>) -> Void)
    /// <p>Modifies an existing subnet group.</p>
    func updateSubnetGroup(input: UpdateSubnetGroupInput, completion: @escaping (SdkResult<UpdateSubnetGroupOutput, UpdateSubnetGroupOutputError>) -> Void)
}
