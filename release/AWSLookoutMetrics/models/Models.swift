...
extension LookoutMetricsClientTypes {
    ...
    public struct Action: Swift.Equatable {
        ...
        var lambdaConfiguration: LookoutMetricsClientTypes.LambdaConfiguration?
        /// A configuration for an Amazon SNS channel.
        var sNSConfiguration: LookoutMetricsClientTypes.SNSConfiguration?
...
public struct ActivateAnomalyDetectorInput: Swift.Equatable {
    ...
    /// This member is required.
    var anomalyDetectorArn: Swift.String?
...
extension LookoutMetricsClientTypes {
    ...
    public struct Alert: Swift.Equatable {
        ...
        var action: LookoutMetricsClientTypes.Action?
        /// The ARN of the alert.
        var alertArn: Swift.String?
        /// A description of the alert.
        var alertDescription: Swift.String?
        /// The name of the alert.
        var alertName: Swift.String?
        /// The minimum severity for an anomaly to trigger the alert.
        var alertSensitivityThreshold: Swift.Int
        /// The status of the alert.
        var alertStatus: LookoutMetricsClientTypes.AlertStatus?
        /// The type of the alert.
        var alertType: LookoutMetricsClientTypes.AlertType?
...
extension LookoutMetricsClientTypes {
    ...
    public struct AnomalyDetectorConfig: Swift.Equatable {
        ...
        var anomalyDetectorFrequency: LookoutMetricsClientTypes.Frequency?
...
extension LookoutMetricsClientTypes {
    ...
    public struct AnomalyDetectorSummary: Swift.Equatable {
        ...
        var anomalyDetectorDescription: Swift.String?
        /// The name of the detector.
        var anomalyDetectorName: Swift.String?
        /// The time at which the detector was created.
        var creationTime: ClientRuntime.Date?
        /// The time at which the detector was last modified.
        var lastModificationTime: ClientRuntime.Date?
        /// The status of detector.
        var status: LookoutMetricsClientTypes.AnomalyDetectorStatus?
...
extension LookoutMetricsClientTypes {
    ...
    public struct AnomalyGroup: Swift.Equatable {
        ...
        var anomalyGroupId: Swift.String?
        /// The severity score of the group.
        var anomalyGroupScore: Swift.Double?
        /// The end time for the group.
        var endTime: Swift.String?
        /// A list of measures affected by the anomaly.
        var metricLevelImpactList: [LookoutMetricsClientTypes.MetricLevelImpact]?
        /// The name of the primary affected measure for the group.
        var primaryMetricName: Swift.String?
...
extension LookoutMetricsClientTypes {
    ...
    public struct AnomalyGroupStatistics: Swift.Equatable {
        ...
        var evaluationStartDate: Swift.String?
        /// Statistics for individual metrics within the group.
        var itemizedMetricStatsList: [LookoutMetricsClientTypes.ItemizedMetricStats]?
...
extension LookoutMetricsClientTypes {
    ...
    public struct ContributionMatrix: Swift.Equatable {
        ...
        var dimensionContributionList: [LookoutMetricsClientTypes.DimensionContribution]?
...
public struct CreateAnomalyDetectorInput: Swift.Equatable {
    ...
    /// This member is required.
    var anomalyDetectorConfig: LookoutMetricsClientTypes.AnomalyDetectorConfig?
    /// A description of the detector.
    var anomalyDetectorDescription: Swift.String?
    /// The name of the detector.
    /// This member is required.
...
public struct CreateMetricSetInput: Swift.Equatable {
    ...
    var dimensionList: [Swift.String]?
    /// A list of metrics that the dataset will contain.
    /// This member is required.
    var metricList: [LookoutMetricsClientTypes.Metric]?
    /// A description of the dataset you are creating.
    var metricSetDescription: Swift.String?
    /// The frequency with which the source data will be analyzed for anomalies.
    var metricSetFrequency: LookoutMetricsClientTypes.Frequency?
    /// The name of the dataset.
    /// This member is required.
    var metricSetName: Swift.String?
    /// Contains information about how the source data should be interpreted.
    /// This member is required.
    var metricSource: LookoutMetricsClientTypes.MetricSource?
    ...
    var timestampColumn: LookoutMetricsClientTypes.TimestampColumn?
...
extension LookoutMetricsClientTypes {
    ...
    public struct CsvFormatDescriptor: Swift.Equatable {
        ...
        var containsHeader: Swift.Bool?
        /// The character used to delimit the source CSV file.
        var delimiter: Swift.String?
        /// The level of compression of the source CSV file.
        var fileCompression: LookoutMetricsClientTypes.CSVFileCompression?
        /// A list of the source CSV file's headers, if any.
        var headerList: [Swift.String]?
        /// The character used as a quote character.
        var quoteSymbol: Swift.String?
...
public struct DescribeAlertOutputResponse: Swift.Equatable {
    ...
    var alert: LookoutMetricsClientTypes.Alert?
...
public struct DescribeAnomalyDetectionExecutionsOutputResponse: Swift.Equatable {
    ...
    var executionList: [LookoutMetricsClientTypes.ExecutionStatus]?
...
public struct DescribeAnomalyDetectorOutputResponse: Swift.Equatable {
    ...
    var anomalyDetectorConfig: LookoutMetricsClientTypes.AnomalyDetectorConfigSummary?
    /// A description of the detector.
    var anomalyDetectorDescription: Swift.String?
    /// The name of the detector.
    var anomalyDetectorName: Swift.String?
...
extension LookoutMetricsClientTypes {
    ...
    public struct DimensionContribution: Swift.Equatable {
        ...
        var dimensionValueContributionList: [LookoutMetricsClientTypes.DimensionValueContribution]?
...
extension LookoutMetricsClientTypes {
    ...
    public struct DimensionValueContribution: Swift.Equatable {
        ...
        var contributionScore: Swift.Double?
        /// The value of the dimension.
        var dimensionValue: Swift.String?
...
extension LookoutMetricsClientTypes {
    ...
    public struct ExecutionStatus: Swift.Equatable {
        ...
        var failureReason: Swift.String?
        /// The run's status.
        var status: LookoutMetricsClientTypes.AnomalyDetectionTaskStatus?
        /// The run's timestamp.
        var timestamp: Swift.String?
...
extension LookoutMetricsClientTypes {
    ...
    public struct FileFormatDescriptor: Swift.Equatable {
        /// Contains information about how a source CSV data file should be analyzed.
        var csvFormatDescriptor: LookoutMetricsClientTypes.CsvFormatDescriptor?
        /// Contains information about how a source JSON data file should be analyzed.
        var jsonFormatDescriptor: LookoutMetricsClientTypes.JsonFormatDescriptor?
...
public struct GetAnomalyGroupOutputResponse: Swift.Equatable {
    ...
    var anomalyGroup: LookoutMetricsClientTypes.AnomalyGroup?
...
public struct GetFeedbackInput: Swift.Equatable {
    ...
    /// This member is required.
    var anomalyGroupTimeSeriesFeedback: LookoutMetricsClientTypes.AnomalyGroupTimeSeries?
...
public struct GetFeedbackOutputResponse: Swift.Equatable {
    /// Feedback for an anomalous metric.
    var anomalyGroupTimeSeriesFeedback: [LookoutMetricsClientTypes.TimeSeriesFeedback]?
    /// The pagination token that's included if more results are available.
    var nextToken: Swift.String?
...
public struct GetSampleDataInput: Swift.Equatable {
    ...
    var s3SourceConfig: LookoutMetricsClientTypes.SampleDataS3SourceConfig?
...
public struct GetSampleDataOutputResponse: Swift.Equatable {
    ...
    var headerValues: [Swift.String]?
    /// A list of records.
    var sampleRows: [[Swift.String]]?
...
extension LookoutMetricsClientTypes {
    ...
    public struct JsonFormatDescriptor: Swift.Equatable {
        ...
        var charset: Swift.String?
        /// The level of compression of the source CSV file.
        var fileCompression: LookoutMetricsClientTypes.JsonFileCompression?
...
public struct ListAlertsOutputResponse: Swift.Equatable {
    /// Contains information about an alert.
    var alertSummaryList: [LookoutMetricsClientTypes.AlertSummary]?
...
public struct ListAnomalyDetectorsOutputResponse: Swift.Equatable {
    ...
    var anomalyDetectorSummaryList: [LookoutMetricsClientTypes.AnomalyDetectorSummary]?
...
public struct ListAnomalyGroupSummariesInput: Swift.Equatable {
    ...
    /// This member is required.
    var sensitivityThreshold: Swift.Int
...
public struct ListAnomalyGroupSummariesOutputResponse: Swift.Equatable {
    ...
    var anomalyGroupStatistics: LookoutMetricsClientTypes.AnomalyGroupStatistics?
    /// A list of anomaly group summaries.
    var anomalyGroupSummaryList: [LookoutMetricsClientTypes.AnomalyGroupSummary]?
    /// The pagination token that's included if more results are available.
    var nextToken: Swift.String?
...
public struct ListAnomalyGroupTimeSeriesOutputResponse: Swift.Equatable {
    ...
    var timeSeriesList: [LookoutMetricsClientTypes.TimeSeries]?
    /// Timestamps for the anomalous metrics.
    var timestampList: [Swift.String]?
...
public struct ListMetricSetsOutputResponse: Swift.Equatable {
    ...
    var metricSetSummaryList: [LookoutMetricsClientTypes.MetricSetSummary]?
...
extension LookoutMetricsClientTypes {
    ...
    public struct Metric: Swift.Equatable {
        ...
        /// This member is required.
        var aggregationFunction: LookoutMetricsClientTypes.AggregationFunction?
...
extension LookoutMetricsClientTypes {
    ...
    public struct MetricLevelImpact: Swift.Equatable {
        ...
        var contributionMatrix: LookoutMetricsClientTypes.ContributionMatrix?
        /// The name of the measure.
        var metricName: Swift.String?
        /// The number of anomalous metrics for the measure.
        var numTimeSeries: Swift.Int
...
extension LookoutMetricsClientTypes {
    ...
    public struct MetricSource: Swift.Equatable {
        ...
        var appFlowConfig: LookoutMetricsClientTypes.AppFlowConfig?
        /// An object containing information about the Amazon CloudWatch monitoring configuration.
        var cloudWatchConfig: LookoutMetricsClientTypes.CloudWatchConfig?
        /// An object containing information about the Amazon Relational Database Service (RDS) configuration.
        var rDSSourceConfig: LookoutMetricsClientTypes.RDSSourceConfig?
        /// An object containing information about the Amazon Redshift database configuration.
        var redshiftSourceConfig: LookoutMetricsClientTypes.RedshiftSourceConfig?
        /// Contains information about the configuration of the S3 bucket that contains source files.
        var s3SourceConfig: LookoutMetricsClientTypes.S3SourceConfig?
...
public struct PutFeedbackInput: Swift.Equatable {
    ...
    /// Feedback for an anomalous metric.
    /// This member is required.
    var anomalyGroupTimeSeriesFeedback: LookoutMetricsClientTypes.AnomalyGroupTimeSeriesFeedback?
...
extension LookoutMetricsClientTypes {
    ...
    public struct RDSSourceConfig: Swift.Equatable {
        ...
        /// This member is required.
        var vpcConfiguration: LookoutMetricsClientTypes.VpcConfiguration?
...
extension LookoutMetricsClientTypes {
    ...
    public struct S3SourceConfig: Swift.Equatable {
        /// Contains information about a source file's formatting.
        var fileFormatDescriptor: LookoutMetricsClientTypes.FileFormatDescriptor?
        /// A list of paths to the historical data files.
        var historicalDataPathList: [Swift.String]?
        /// The ARN of an IAM role that has read and write access permissions to the source S3 bucket.
        /// This member is required.
        var roleArn: Swift.String?
        /// A list of templated paths to the source files.
        var templatedPathList: [Swift.String]?
...
extension LookoutMetricsClientTypes {
    ...
    public struct TimeSeries: Swift.Equatable {
        ...
        /// This member is required.
        var dimensionList: [LookoutMetricsClientTypes.DimensionNameValue]?
        /// The values for the metric.
        /// This member is required.
        var metricValueList: [Swift.Double]?
        /// The ID of the metric.
        /// This member is required.
        var timeSeriesId: Swift.String?
...
extension LookoutMetricsClientTypes {
    ...
    public struct VpcConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var securityGroupIdList: [Swift.String]?
        /// An array of strings containing the Amazon VPC subnet IDs (e.g., subnet-0bb1c79de3EXAMPLE.
        /// This member is required.
        var subnetIdList: [Swift.String]?
