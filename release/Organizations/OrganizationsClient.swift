...
extension OrganizationsClient: OrganizationsClientProtocol {
    ...
    public func acceptHandshake(input: AcceptHandshakeInput, completion: @escaping (SdkResult<AcceptHandshakeOutput, AcceptHandshakeOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<AcceptHandshakeInput, AcceptHandshakeOutput, AcceptHandshakeOutputError>(id: "acceptHandshake")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AcceptHandshakeInput, AcceptHandshakeOutput, AcceptHandshakeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AcceptHandshakeInput, AcceptHandshakeOutput, AcceptHandshakeOutputError>(xAmzTarget: "AWSOrganizationsV20161128.AcceptHandshake"))
    ...
    public func attachPolicy(input: AttachPolicyInput, completion: @escaping (SdkResult<AttachPolicyOutput, AttachPolicyOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AttachPolicyInput, AttachPolicyOutput, AttachPolicyOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<AttachPolicyInput, AttachPolicyOutput, AttachPolicyOutputError>(xAmzTarget: "AWSOrganizationsV20161128.AttachPolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             for only 30 days. After that, it's deleted.</p>
    public func cancelHandshake(input: CancelHandshakeInput, completion: @escaping (SdkResult<CancelHandshakeOutput, CancelHandshakeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CancelHandshakeInput, CancelHandshakeOutput, CancelHandshakeOutputError>(id: "cancelHandshake")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CancelHandshakeInput, CancelHandshakeOutput, CancelHandshakeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CancelHandshakeInput, CancelHandshakeOutput, CancelHandshakeOutputError>(xAmzTarget: "AWSOrganizationsV20161128.CancelHandshake"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createAccount(input: CreateAccountInput, completion: @escaping (SdkResult<CreateAccountOutput, CreateAccountOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateAccountInput, CreateAccountOutput, CreateAccountOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateAccountInput, CreateAccountOutput, CreateAccountOutputError>(xAmzTarget: "AWSOrganizationsV20161128.CreateAccount"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///                     Access to Your Billing Information and Tools</a>.</p>
    ///         </note>
    public func createGovCloudAccount(input: CreateGovCloudAccountInput, completion: @escaping (SdkResult<CreateGovCloudAccountOutput, CreateGovCloudAccountOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateGovCloudAccountInput, CreateGovCloudAccountOutput, CreateGovCloudAccountOutputError>(id: "createGovCloudAccount")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateGovCloudAccountInput, CreateGovCloudAccountOutput, CreateGovCloudAccountOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateGovCloudAccountInput, CreateGovCloudAccountOutput, CreateGovCloudAccountOutputError>(xAmzTarget: "AWSOrganizationsV20161128.CreateGovCloudAccount"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func createOrganization(input: CreateOrganizationInput, completion: @escaping (SdkResult<CreateOrganizationOutput, CreateOrganizationOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateOrganizationInput, CreateOrganizationOutput, CreateOrganizationOutputError>(xAmzTarget: "AWSOrganizationsV20161128.CreateOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///                 <code>organizations:TagResource</code> permission.</p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func createOrganizationalUnit(input: CreateOrganizationalUnitInput, completion: @escaping (SdkResult<CreateOrganizationalUnitOutput, CreateOrganizationalUnitOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateOrganizationalUnitInput, CreateOrganizationalUnitOutput, CreateOrganizationalUnitOutputError>(id: "createOrganizationalUnit")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateOrganizationalUnitInput, CreateOrganizationalUnitOutput, CreateOrganizationalUnitOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateOrganizationalUnitInput, CreateOrganizationalUnitOutput, CreateOrganizationalUnitOutputError>(xAmzTarget: "AWSOrganizationsV20161128.CreateOrganizationalUnit"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///                 <code>organizations:TagResource</code> permission.</p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func createPolicy(input: CreatePolicyInput, completion: @escaping (SdkResult<CreatePolicyOutput, CreatePolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreatePolicyInput, CreatePolicyOutput, CreatePolicyOutputError>(id: "createPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreatePolicyInput, CreatePolicyOutput, CreatePolicyOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreatePolicyInput, CreatePolicyOutput, CreatePolicyOutputError>(xAmzTarget: "AWSOrganizationsV20161128.CreatePolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             for only 30 days. After that, it's deleted.</p>
    public func declineHandshake(input: DeclineHandshakeInput, completion: @escaping (SdkResult<DeclineHandshakeOutput, DeclineHandshakeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeclineHandshakeInput, DeclineHandshakeOutput, DeclineHandshakeOutputError>(id: "declineHandshake")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeclineHandshakeInput, DeclineHandshakeOutput, DeclineHandshakeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeclineHandshakeInput, DeclineHandshakeOutput, DeclineHandshakeOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DeclineHandshake"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteOrganization(input: DeleteOrganizationInput, completion: @escaping (SdkResult<DeleteOrganizationOutput, DeleteOrganizationOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteOrganizationInput, DeleteOrganizationOutput, DeleteOrganizationOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DeleteOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func deleteOrganizationalUnit(input: DeleteOrganizationalUnitInput, completion: @escaping (SdkResult<DeleteOrganizationalUnitOutput, DeleteOrganizationalUnitOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteOrganizationalUnitInput, DeleteOrganizationalUnitOutput, DeleteOrganizationalUnitOutputError>(id: "deleteOrganizationalUnit")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteOrganizationalUnitInput, DeleteOrganizationalUnitOutput, DeleteOrganizationalUnitOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteOrganizationalUnitInput, DeleteOrganizationalUnitOutput, DeleteOrganizationalUnitOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DeleteOrganizationalUnit"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deletePolicy(input: DeletePolicyInput, completion: @escaping (SdkResult<DeletePolicyOutput, DeletePolicyOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeletePolicyInput, DeletePolicyOutput, DeletePolicyOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DeletePolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func deregisterDelegatedAdministrator(input: DeregisterDelegatedAdministratorInput, completion: @escaping (SdkResult<DeregisterDelegatedAdministratorOutput, DeregisterDelegatedAdministratorOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeregisterDelegatedAdministratorInput, DeregisterDelegatedAdministratorOutput, DeregisterDelegatedAdministratorOutputError>(id: "deregisterDelegatedAdministrator")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeregisterDelegatedAdministratorInput, DeregisterDelegatedAdministratorOutput, DeregisterDelegatedAdministratorOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeregisterDelegatedAdministratorInput, DeregisterDelegatedAdministratorOutput, DeregisterDelegatedAdministratorOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DeregisterDelegatedAdministrator"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeAccount(input: DescribeAccountInput, completion: @escaping (SdkResult<DescribeAccountOutput, DescribeAccountOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeAccountInput, DescribeAccountOutput, DescribeAccountOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DescribeAccount"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func describeCreateAccountStatus(input: DescribeCreateAccountStatusInput, completion: @escaping (SdkResult<DescribeCreateAccountStatusOutput, DescribeCreateAccountStatusOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeCreateAccountStatusInput, DescribeCreateAccountStatusOutput, DescribeCreateAccountStatusOutputError>(id: "describeCreateAccountStatus")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeCreateAccountStatusInput, DescribeCreateAccountStatusOutput, DescribeCreateAccountStatusOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeCreateAccountStatusInput, DescribeCreateAccountStatusOutput, DescribeCreateAccountStatusOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DescribeCreateAccountStatus"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func describeEffectivePolicy(input: DescribeEffectivePolicyInput, completion: @escaping (SdkResult<DescribeEffectivePolicyOutput, DescribeEffectivePolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeEffectivePolicyInput, DescribeEffectivePolicyOutput, DescribeEffectivePolicyOutputError>(id: "describeEffectivePolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeEffectivePolicyInput, DescribeEffectivePolicyOutput, DescribeEffectivePolicyOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeEffectivePolicyInput, DescribeEffectivePolicyOutput, DescribeEffectivePolicyOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DescribeEffectivePolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeHandshake(input: DescribeHandshakeInput, completion: @escaping (SdkResult<DescribeHandshakeOutput, DescribeHandshakeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeHandshakeInput, DescribeHandshakeOutput, DescribeHandshakeOutputError>(id: "describeHandshake")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeHandshakeInput, DescribeHandshakeOutput, DescribeHandshakeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeHandshakeInput, DescribeHandshakeOutput, DescribeHandshakeOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DescribeHandshake"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func describeOrganization(input: DescribeOrganizationInput, completion: @escaping (SdkResult<DescribeOrganizationOutput, DescribeOrganizationOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeOrganizationInput, DescribeOrganizationOutput, DescribeOrganizationOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DescribeOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func describeOrganizationalUnit(input: DescribeOrganizationalUnitInput, completion: @escaping (SdkResult<DescribeOrganizationalUnitOutput, DescribeOrganizationalUnitOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeOrganizationalUnitInput, DescribeOrganizationalUnitOutput, DescribeOrganizationalUnitOutputError>(id: "describeOrganizationalUnit")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeOrganizationalUnitInput, DescribeOrganizationalUnitOutput, DescribeOrganizationalUnitOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeOrganizationalUnitInput, DescribeOrganizationalUnitOutput, DescribeOrganizationalUnitOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DescribeOrganizationalUnit"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func describePolicy(input: DescribePolicyInput, completion: @escaping (SdkResult<DescribePolicyOutput, DescribePolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribePolicyInput, DescribePolicyOutput, DescribePolicyOutputError>(id: "describePolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribePolicyInput, DescribePolicyOutput, DescribePolicyOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribePolicyInput, DescribePolicyOutput, DescribePolicyOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DescribePolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func detachPolicy(input: DetachPolicyInput, completion: @escaping (SdkResult<DetachPolicyOutput, DetachPolicyOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DetachPolicyInput, DetachPolicyOutput, DetachPolicyOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DetachPolicyInput, DetachPolicyOutput, DetachPolicyOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DetachPolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func disableAWSServiceAccess(input: DisableAWSServiceAccessInput, completion: @escaping (SdkResult<DisableAWSServiceAccessOutput, DisableAWSServiceAccessOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DisableAWSServiceAccessInput, DisableAWSServiceAccessOutput, DisableAWSServiceAccessOutputError>(id: "disableAWSServiceAccess")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DisableAWSServiceAccessInput, DisableAWSServiceAccessOutput, DisableAWSServiceAccessOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DisableAWSServiceAccessInput, DisableAWSServiceAccessOutput, DisableAWSServiceAccessOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DisableAWSServiceAccess"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func disablePolicyType(input: DisablePolicyTypeInput, completion: @escaping (SdkResult<DisablePolicyTypeOutput, DisablePolicyTypeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DisablePolicyTypeInput, DisablePolicyTypeOutput, DisablePolicyTypeOutputError>(id: "disablePolicyType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DisablePolicyTypeInput, DisablePolicyTypeOutput, DisablePolicyTypeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DisablePolicyTypeInput, DisablePolicyTypeOutput, DisablePolicyTypeOutputError>(xAmzTarget: "AWSOrganizationsV20161128.DisablePolicyType"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///                 features</a>.</p>
    public func enableAWSServiceAccess(input: EnableAWSServiceAccessInput, completion: @escaping (SdkResult<EnableAWSServiceAccessOutput, EnableAWSServiceAccessOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<EnableAWSServiceAccessInput, EnableAWSServiceAccessOutput, EnableAWSServiceAccessOutputError>(id: "enableAWSServiceAccess")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<EnableAWSServiceAccessInput, EnableAWSServiceAccessOutput, EnableAWSServiceAccessOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<EnableAWSServiceAccessInput, EnableAWSServiceAccessOutput, EnableAWSServiceAccessOutputError>(xAmzTarget: "AWSOrganizationsV20161128.EnableAWSServiceAccess"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func enableAllFeatures(input: EnableAllFeaturesInput, completion: @escaping (SdkResult<EnableAllFeaturesOutput, EnableAllFeaturesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<EnableAllFeaturesInput, EnableAllFeaturesOutput, EnableAllFeaturesOutputError>(id: "enableAllFeatures")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<EnableAllFeaturesInput, EnableAllFeaturesOutput, EnableAllFeaturesOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<EnableAllFeaturesInput, EnableAllFeaturesOutput, EnableAllFeaturesOutputError>(xAmzTarget: "AWSOrganizationsV20161128.EnableAllFeatures"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func enablePolicyType(input: EnablePolicyTypeInput, completion: @escaping (SdkResult<EnablePolicyTypeOutput, EnablePolicyTypeOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<EnablePolicyTypeInput, EnablePolicyTypeOutput, EnablePolicyTypeOutputError>(id: "enablePolicyType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<EnablePolicyTypeInput, EnablePolicyTypeOutput, EnablePolicyTypeOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<EnablePolicyTypeInput, EnablePolicyTypeOutput, EnablePolicyTypeOutputError>(xAmzTarget: "AWSOrganizationsV20161128.EnablePolicyType"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///                 <code>organizations:TagResource</code> permission.</p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func inviteAccountToOrganization(input: InviteAccountToOrganizationInput, completion: @escaping (SdkResult<InviteAccountToOrganizationOutput, InviteAccountToOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<InviteAccountToOrganizationInput, InviteAccountToOrganizationOutput, InviteAccountToOrganizationOutputError>(id: "inviteAccountToOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<InviteAccountToOrganizationInput, InviteAccountToOrganizationOutput, InviteAccountToOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<InviteAccountToOrganizationInput, InviteAccountToOrganizationOutput, InviteAccountToOrganizationOutputError>(xAmzTarget: "AWSOrganizationsV20161128.InviteAccountToOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </important>
    public func leaveOrganization(input: LeaveOrganizationInput, completion: @escaping (SdkResult<LeaveOrganizationOutput, LeaveOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<LeaveOrganizationInput, LeaveOrganizationOutput, LeaveOrganizationOutputError>(id: "leaveOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<LeaveOrganizationInput, LeaveOrganizationOutput, LeaveOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<LeaveOrganizationInput, LeaveOrganizationOutput, LeaveOrganizationOutputError>(xAmzTarget: "AWSOrganizationsV20161128.LeaveOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func listAWSServiceAccessForOrganization(input: ListAWSServiceAccessForOrganizationInput, completion: @escaping (SdkResult<ListAWSServiceAccessForOrganizationOutput, ListAWSServiceAccessForOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAWSServiceAccessForOrganizationInput, ListAWSServiceAccessForOrganizationOutput, ListAWSServiceAccessForOrganizationOutputError>(id: "listAWSServiceAccessForOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAWSServiceAccessForOrganizationInput, ListAWSServiceAccessForOrganizationOutput, ListAWSServiceAccessForOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListAWSServiceAccessForOrganizationInput, ListAWSServiceAccessForOrganizationOutput, ListAWSServiceAccessForOrganizationOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListAWSServiceAccessForOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listAccounts(input: ListAccountsInput, completion: @escaping (SdkResult<ListAccountsOutput, ListAccountsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAccountsInput, ListAccountsOutput, ListAccountsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListAccountsInput, ListAccountsOutput, ListAccountsOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListAccounts"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func listAccountsForParent(input: ListAccountsForParentInput, completion: @escaping (SdkResult<ListAccountsForParentOutput, ListAccountsForParentOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAccountsForParentInput, ListAccountsForParentOutput, ListAccountsForParentOutputError>(id: "listAccountsForParent")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAccountsForParentInput, ListAccountsForParentOutput, ListAccountsForParentOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListAccountsForParentInput, ListAccountsForParentOutput, ListAccountsForParentOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListAccountsForParent"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func listChildren(input: ListChildrenInput, completion: @escaping (SdkResult<ListChildrenOutput, ListChildrenOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListChildrenInput, ListChildrenOutput, ListChildrenOutputError>(id: "listChildren")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListChildrenInput, ListChildrenOutput, ListChildrenOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListChildrenInput, ListChildrenOutput, ListChildrenOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListChildren"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func listCreateAccountStatus(input: ListCreateAccountStatusInput, completion: @escaping (SdkResult<ListCreateAccountStatusOutput, ListCreateAccountStatusOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListCreateAccountStatusInput, ListCreateAccountStatusOutput, ListCreateAccountStatusOutputError>(id: "listCreateAccountStatus")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListCreateAccountStatusInput, ListCreateAccountStatusOutput, ListCreateAccountStatusOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListCreateAccountStatusInput, ListCreateAccountStatusOutput, ListCreateAccountStatusOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListCreateAccountStatus"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func listDelegatedAdministrators(input: ListDelegatedAdministratorsInput, completion: @escaping (SdkResult<ListDelegatedAdministratorsOutput, ListDelegatedAdministratorsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListDelegatedAdministratorsInput, ListDelegatedAdministratorsOutput, ListDelegatedAdministratorsOutputError>(id: "listDelegatedAdministrators")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListDelegatedAdministratorsInput, ListDelegatedAdministratorsOutput, ListDelegatedAdministratorsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListDelegatedAdministratorsInput, ListDelegatedAdministratorsOutput, ListDelegatedAdministratorsOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListDelegatedAdministrators"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func listDelegatedServicesForAccount(input: ListDelegatedServicesForAccountInput, completion: @escaping (SdkResult<ListDelegatedServicesForAccountOutput, ListDelegatedServicesForAccountOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListDelegatedServicesForAccountInput, ListDelegatedServicesForAccountOutput, ListDelegatedServicesForAccountOutputError>(id: "listDelegatedServicesForAccount")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListDelegatedServicesForAccountInput, ListDelegatedServicesForAccountOutput, ListDelegatedServicesForAccountOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListDelegatedServicesForAccountInput, ListDelegatedServicesForAccountOutput, ListDelegatedServicesForAccountOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListDelegatedServicesForAccount"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </note>
    ///         <p>This operation can be called from any account in the organization.</p>
    public func listHandshakesForAccount(input: ListHandshakesForAccountInput, completion: @escaping (SdkResult<ListHandshakesForAccountOutput, ListHandshakesForAccountOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListHandshakesForAccountInput, ListHandshakesForAccountOutput, ListHandshakesForAccountOutputError>(id: "listHandshakesForAccount")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListHandshakesForAccountInput, ListHandshakesForAccountOutput, ListHandshakesForAccountOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListHandshakesForAccountInput, ListHandshakesForAccountOutput, ListHandshakesForAccountOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListHandshakesForAccount"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func listHandshakesForOrganization(input: ListHandshakesForOrganizationInput, completion: @escaping (SdkResult<ListHandshakesForOrganizationOutput, ListHandshakesForOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListHandshakesForOrganizationInput, ListHandshakesForOrganizationOutput, ListHandshakesForOrganizationOutputError>(id: "listHandshakesForOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListHandshakesForOrganizationInput, ListHandshakesForOrganizationOutput, ListHandshakesForOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListHandshakesForOrganizationInput, ListHandshakesForOrganizationOutput, ListHandshakesForOrganizationOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListHandshakesForOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func listOrganizationalUnitsForParent(input: ListOrganizationalUnitsForParentInput, completion: @escaping (SdkResult<ListOrganizationalUnitsForParentOutput, ListOrganizationalUnitsForParentOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListOrganizationalUnitsForParentInput, ListOrganizationalUnitsForParentOutput, ListOrganizationalUnitsForParentOutputError>(id: "listOrganizationalUnitsForParent")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListOrganizationalUnitsForParentInput, ListOrganizationalUnitsForParentOutput, ListOrganizationalUnitsForParentOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListOrganizationalUnitsForParentInput, ListOrganizationalUnitsForParentOutput, ListOrganizationalUnitsForParentOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListOrganizationalUnitsForParent"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         </note>
    public func listParents(input: ListParentsInput, completion: @escaping (SdkResult<ListParentsOutput, ListParentsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListParentsInput, ListParentsOutput, ListParentsOutputError>(id: "listParents")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListParentsInput, ListParentsOutput, ListParentsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListParentsInput, ListParentsOutput, ListParentsOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListParents"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listPolicies(input: ListPoliciesInput, completion: @escaping (SdkResult<ListPoliciesOutput, ListPoliciesOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListPoliciesInput, ListPoliciesOutput, ListPoliciesOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListPolicies"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func listPoliciesForTarget(input: ListPoliciesForTargetInput, completion: @escaping (SdkResult<ListPoliciesForTargetOutput, ListPoliciesForTargetOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListPoliciesForTargetInput, ListPoliciesForTargetOutput, ListPoliciesForTargetOutputError>(id: "listPoliciesForTarget")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListPoliciesForTargetInput, ListPoliciesForTargetOutput, ListPoliciesForTargetOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListPoliciesForTargetInput, ListPoliciesForTargetOutput, ListPoliciesForTargetOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListPoliciesForTarget"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         </note>
    public func listRoots(input: ListRootsInput, completion: @escaping (SdkResult<ListRootsOutput, ListRootsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListRootsInput, ListRootsOutput, ListRootsOutputError>(id: "listRoots")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListRootsInput, ListRootsOutput, ListRootsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListRootsInput, ListRootsOutput, ListRootsOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListRoots"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listTagsForResource(input: ListTagsForResourceInput, completion: @escaping (SdkResult<ListTagsForResourceOutput, ListTagsForResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTagsForResourceInput, ListTagsForResourceOutput, ListTagsForResourceOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListTagsForResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    public func listTargetsForPolicy(input: ListTargetsForPolicyInput, completion: @escaping (SdkResult<ListTargetsForPolicyOutput, ListTargetsForPolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListTargetsForPolicyInput, ListTargetsForPolicyOutput, ListTargetsForPolicyOutputError>(id: "listTargetsForPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListTargetsForPolicyInput, ListTargetsForPolicyOutput, ListTargetsForPolicyOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListTargetsForPolicyInput, ListTargetsForPolicyOutput, ListTargetsForPolicyOutputError>(xAmzTarget: "AWSOrganizationsV20161128.ListTargetsForPolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func moveAccount(input: MoveAccountInput, completion: @escaping (SdkResult<MoveAccountOutput, MoveAccountOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<MoveAccountInput, MoveAccountOutput, MoveAccountOutputError>(id: "moveAccount")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<MoveAccountInput, MoveAccountOutput, MoveAccountOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<MoveAccountInput, MoveAccountOutput, MoveAccountOutputError>(xAmzTarget: "AWSOrganizationsV20161128.MoveAccount"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///          </p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func registerDelegatedAdministrator(input: RegisterDelegatedAdministratorInput, completion: @escaping (SdkResult<RegisterDelegatedAdministratorOutput, RegisterDelegatedAdministratorOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RegisterDelegatedAdministratorInput, RegisterDelegatedAdministratorOutput, RegisterDelegatedAdministratorOutputError>(id: "registerDelegatedAdministrator")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RegisterDelegatedAdministratorInput, RegisterDelegatedAdministratorOutput, RegisterDelegatedAdministratorOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RegisterDelegatedAdministratorInput, RegisterDelegatedAdministratorOutput, RegisterDelegatedAdministratorOutputError>(xAmzTarget: "AWSOrganizationsV20161128.RegisterDelegatedAdministrator"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             </ul>
    ///         </important>
    public func removeAccountFromOrganization(input: RemoveAccountFromOrganizationInput, completion: @escaping (SdkResult<RemoveAccountFromOrganizationOutput, RemoveAccountFromOrganizationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RemoveAccountFromOrganizationInput, RemoveAccountFromOrganizationOutput, RemoveAccountFromOrganizationOutputError>(id: "removeAccountFromOrganization")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RemoveAccountFromOrganizationInput, RemoveAccountFromOrganizationOutput, RemoveAccountFromOrganizationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RemoveAccountFromOrganizationInput, RemoveAccountFromOrganizationOutput, RemoveAccountFromOrganizationOutputError>(xAmzTarget: "AWSOrganizationsV20161128.RemoveAccountFromOrganization"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func tagResource(input: TagResourceInput, completion: @escaping (SdkResult<TagResourceOutput, TagResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<TagResourceInput, TagResourceOutput, TagResourceOutputError>(xAmzTarget: "AWSOrganizationsV20161128.TagResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func untagResource(input: UntagResourceInput, completion: @escaping (SdkResult<UntagResourceOutput, UntagResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UntagResourceInput, UntagResourceOutput, UntagResourceOutputError>(xAmzTarget: "AWSOrganizationsV20161128.UntagResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             attached.</p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func updateOrganizationalUnit(input: UpdateOrganizationalUnitInput, completion: @escaping (SdkResult<UpdateOrganizationalUnitOutput, UpdateOrganizationalUnitOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateOrganizationalUnitInput, UpdateOrganizationalUnitOutput, UpdateOrganizationalUnitOutputError>(id: "updateOrganizationalUnit")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateOrganizationalUnitInput, UpdateOrganizationalUnitOutput, UpdateOrganizationalUnitOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateOrganizationalUnitInput, UpdateOrganizationalUnitOutput, UpdateOrganizationalUnitOutputError>(xAmzTarget: "AWSOrganizationsV20161128.UpdateOrganizationalUnit"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    ///             type.</p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    public func updatePolicy(input: UpdatePolicyInput, completion: @escaping (SdkResult<UpdatePolicyOutput, UpdatePolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "organizations")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdatePolicyInput, UpdatePolicyOutput, UpdatePolicyOutputError>(id: "updatePolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdatePolicyInput, UpdatePolicyOutput, UpdatePolicyOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdatePolicyInput, UpdatePolicyOutput, UpdatePolicyOutputError>(xAmzTarget: "AWSOrganizationsV20161128.UpdatePolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
