...
public class OrganizationsClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try OrganizationsClientConfiguration(region: unwrappedRegion)
    ...
    public class OrganizationsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("OrganizationsClient")
...
public struct OrganizationsClientLogHandlerFactory: SDKLogHandlerFactory {
