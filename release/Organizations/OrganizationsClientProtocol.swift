...
public protocol OrganizationsClientProtocol {
    ...
    func acceptHandshake(input: AcceptHandshakeInput, completion: @escaping (SdkResult<AcceptHandshakeOutputResponse, AcceptHandshakeOutputError>) -> Void)
    ...
    ///             for only 30 days. After that, it's deleted.</p>
    func cancelHandshake(input: CancelHandshakeInput, completion: @escaping (SdkResult<CancelHandshakeOutputResponse, CancelHandshakeOutputError>) -> Void)
    ...
    ///                     Access to Your Billing Information and Tools</a>.</p>
    ///         </note>
    func createGovCloudAccount(input: CreateGovCloudAccountInput, completion: @escaping (SdkResult<CreateGovCloudAccountOutputResponse, CreateGovCloudAccountOutputError>) -> Void)
    ...
    ///                 <code>organizations:TagResource</code> permission.</p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    func createOrganizationalUnit(input: CreateOrganizationalUnitInput, completion: @escaping (SdkResult<CreateOrganizationalUnitOutputResponse, CreateOrganizationalUnitOutputError>) -> Void)
    ...
    ///             for only 30 days. After that, it's deleted.</p>
    func declineHandshake(input: DeclineHandshakeInput, completion: @escaping (SdkResult<DeclineHandshakeOutputResponse, DeclineHandshakeOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's management account.</p>
    func deleteOrganizationalUnit(input: DeleteOrganizationalUnitInput, completion: @escaping (SdkResult<DeleteOrganizationalUnitOutputResponse, DeleteOrganizationalUnitOutputError>) -> Void)
    ...
    ///          </p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    func deregisterDelegatedAdministrator(input: DeregisterDelegatedAdministratorInput, completion: @escaping (SdkResult<DeregisterDelegatedAdministratorOutputResponse, DeregisterDelegatedAdministratorOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func describeCreateAccountStatus(input: DescribeCreateAccountStatusInput, completion: @escaping (SdkResult<DescribeCreateAccountStatusOutputResponse, DescribeCreateAccountStatusOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func describeEffectivePolicy(input: DescribeEffectivePolicyInput, completion: @escaping (SdkResult<DescribeEffectivePolicyOutputResponse, DescribeEffectivePolicyOutputError>) -> Void)
    ...
    func describeHandshake(input: DescribeHandshakeInput, completion: @escaping (SdkResult<DescribeHandshakeOutputResponse, DescribeHandshakeOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func describeOrganizationalUnit(input: DescribeOrganizationalUnitInput, completion: @escaping (SdkResult<DescribeOrganizationalUnitOutputResponse, DescribeOrganizationalUnitOutputError>) -> Void)
    /// <p>Retrieves information about a policy.</p>
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func describePolicy(input: DescribePolicyInput, completion: @escaping (SdkResult<DescribePolicyOutputResponse, DescribePolicyOutputError>) -> Void)
    ...
    ///          </p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    func disableAWSServiceAccess(input: DisableAWSServiceAccessInput, completion: @escaping (SdkResult<DisableAWSServiceAccessOutputResponse, DisableAWSServiceAccessOutputError>) -> Void)
    ...
    func disablePolicyType(input: DisablePolicyTypeInput, completion: @escaping (SdkResult<DisablePolicyTypeOutputResponse, DisablePolicyTypeOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's management account.</p>
    func enableAllFeatures(input: EnableAllFeaturesInput, completion: @escaping (SdkResult<EnableAllFeaturesOutputResponse, EnableAllFeaturesOutputError>) -> Void)
    ...
    ///                 features</a>.</p>
    func enableAWSServiceAccess(input: EnableAWSServiceAccessInput, completion: @escaping (SdkResult<EnableAWSServiceAccessOutputResponse, EnableAWSServiceAccessOutputError>) -> Void)
    ...
    func enablePolicyType(input: EnablePolicyTypeInput, completion: @escaping (SdkResult<EnablePolicyTypeOutputResponse, EnablePolicyTypeOutputError>) -> Void)
    ...
    ///                 <code>organizations:TagResource</code> permission.</p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    func inviteAccountToOrganization(input: InviteAccountToOrganizationInput, completion: @escaping (SdkResult<InviteAccountToOrganizationOutputResponse, InviteAccountToOrganizationOutputError>) -> Void)
    ...
    ///             </ul>
    ///         </important>
    func leaveOrganization(input: LeaveOrganizationInput, completion: @escaping (SdkResult<LeaveOrganizationOutputResponse, LeaveOrganizationOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func listAccountsForParent(input: ListAccountsForParentInput, completion: @escaping (SdkResult<ListAccountsForParentOutputResponse, ListAccountsForParentOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func listAWSServiceAccessForOrganization(input: ListAWSServiceAccessForOrganizationInput, completion: @escaping (SdkResult<ListAWSServiceAccessForOrganizationOutputResponse, ListAWSServiceAccessForOrganizationOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func listChildren(input: ListChildrenInput, completion: @escaping (SdkResult<ListChildrenOutputResponse, ListChildrenOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func listCreateAccountStatus(input: ListCreateAccountStatusInput, completion: @escaping (SdkResult<ListCreateAccountStatusOutputResponse, ListCreateAccountStatusOutputError>) -> Void)
    /// <p>Lists the AWS accounts that are designated as delegated administrators in this
    ///             organization.</p>
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func listDelegatedAdministrators(input: ListDelegatedAdministratorsInput, completion: @escaping (SdkResult<ListDelegatedAdministratorsOutputResponse, ListDelegatedAdministratorsOutputError>) -> Void)
    /// <p>List the AWS services for which the specified account is a delegated
    ///             administrator.</p>
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func listDelegatedServicesForAccount(input: ListDelegatedServicesForAccountInput, completion: @escaping (SdkResult<ListDelegatedServicesForAccountOutputResponse, ListDelegatedServicesForAccountOutputError>) -> Void)
    ...
    ///          </note>
    ///         <p>This operation can be called from any account in the organization.</p>
    func listHandshakesForAccount(input: ListHandshakesForAccountInput, completion: @escaping (SdkResult<ListHandshakesForAccountOutputResponse, ListHandshakesForAccountOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func listHandshakesForOrganization(input: ListHandshakesForOrganizationInput, completion: @escaping (SdkResult<ListHandshakesForOrganizationOutputResponse, ListHandshakesForOrganizationOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func listOrganizationalUnitsForParent(input: ListOrganizationalUnitsForParentInput, completion: @escaping (SdkResult<ListOrganizationalUnitsForParentOutputResponse, ListOrganizationalUnitsForParentOutputError>) -> Void)
    ...
    ///         </note>
    func listParents(input: ListParentsInput, completion: @escaping (SdkResult<ListParentsOutputResponse, ListParentsOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's
    /// management account or by a member account that is a delegated administrator for an AWS service.</p>
    func listPoliciesForTarget(input: ListPoliciesForTargetInput, completion: @escaping (SdkResult<ListPoliciesForTargetOutputResponse, ListPoliciesForTargetOutputError>) -> Void)
    ...
    ///         </note>
    func listRoots(input: ListRootsInput, completion: @escaping (SdkResult<ListRootsOutputResponse, ListRootsOutputError>) -> Void)
    ...
    ///         <p>This operation can be called only from the organization's management account.</p>
    func moveAccount(input: MoveAccountInput, completion: @escaping (SdkResult<MoveAccountOutputResponse, MoveAccountOutputError>) -> Void)
    ...
    ///          </p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    func registerDelegatedAdministrator(input: RegisterDelegatedAdministratorInput, completion: @escaping (SdkResult<RegisterDelegatedAdministratorOutputResponse, RegisterDelegatedAdministratorOutputError>) -> Void)
    ...
    ///             </ul>
    ///         </important>
    func removeAccountFromOrganization(input: RemoveAccountFromOrganizationInput, completion: @escaping (SdkResult<RemoveAccountFromOrganizationOutputResponse, RemoveAccountFromOrganizationOutputError>) -> Void)
    ...
    ///             attached.</p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    func updateOrganizationalUnit(input: UpdateOrganizationalUnitInput, completion: @escaping (SdkResult<UpdateOrganizationalUnitOutputResponse, UpdateOrganizationalUnitOutputError>) -> Void)
    ...
    ///             type.</p>
    ///         <p>This operation can be called only from the organization's management account.</p>
    func updatePolicy(input: UpdatePolicyInput, completion: @escaping (SdkResult<UpdatePolicyOutputResponse, UpdatePolicyOutputError>) -> Void)
}
