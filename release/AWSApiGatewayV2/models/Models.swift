...
extension ApiGatewayV2ClientTypes.AccessLogSettings: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApiGatewayV2ClientTypes {
    ...
    public struct AccessLogSettings: Swift.Equatable {
        ...
        var destinationArn: Swift.String?
...
extension ApiGatewayV2ClientTypes.Api: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApiGatewayV2ClientTypes {
    ...
    public struct Api: Swift.Equatable {
        ...
        var apiEndpoint: Swift.String?
        /// Specifies whether an API is managed by API Gateway. You can't update or delete a managed API by using API Gateway. A managed API can be deleted only through the tooling or service that created it.
        var apiGatewayManaged: Swift.Bool?
        /// The API ID.
        var apiId: Swift.String?
        /// An API key selection expression. Supported only for WebSocket APIs. See [API Key Selection Expressions](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-websocket-api-selection-expressions.html#apigateway-websocket-api-apikey-selection-expressions).
        var apiKeySelectionExpression: Swift.String?
        /// A CORS configuration. Supported only for HTTP APIs.
        var corsConfiguration: ApiGatewayV2ClientTypes.Cors?
        /// The timestamp when the API was created.
        var createdDate: ClientRuntime.Date?
        /// The description of the API.
        var description: Swift.String?
        /// Specifies whether clients can invoke your API by using the default execute-api endpoint. By default, clients can invoke your API with the default https://{api_id}.execute-api.{region}.amazonaws.com endpoint. To require that clients use a custom domain name to invoke your API, disable the default endpoint.
        var disableExecuteApiEndpoint: Swift.Bool?
        /// Avoid validating models when creating a deployment. Supported only for WebSocket APIs.
        var disableSchemaValidation: Swift.Bool?
        /// The validation information during API import. This may include particular properties of your OpenAPI definition which are ignored during import. Supported only for HTTP APIs.
        var importInfo: [Swift.String]?
        /// The name of the API.
        /// This member is required.
        var name: Swift.String?
        /// The API protocol.
        /// This member is required.
        var protocolType: ApiGatewayV2ClientTypes.ProtocolType?
        /// The route selection expression for the API. For HTTP APIs, the routeSelectionExpression must be ${request.method} ${request.path}. If not provided, this will be the default for HTTP APIs. This property is required for WebSocket APIs.
        /// This member is required.
        var routeSelectionExpression: Swift.String?
...
extension ApiGatewayV2ClientTypes.ApiMapping: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case apiId = "apiId"
...
extension ApiGatewayV2ClientTypes {
    ...
    public struct ApiMapping: Swift.Equatable {
        ...
        var apiMappingId: Swift.String?
        /// The API mapping key.
        var apiMappingKey: Swift.String?
        /// The API stage.
        /// This member is required.
        var stage: Swift.String?
...
extension ApiGatewayV2ClientTypes.Authorizer: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApiGatewayV2ClientTypes {
    ...
    public struct Authorizer: Swift.Equatable {
        ...
        var authorizerCredentialsArn: Swift.String?
        /// The authorizer identifier.
        var authorizerId: Swift.String?
        /// Specifies the format of the payload sent to an HTTP API Lambda authorizer. Required for HTTP API Lambda authorizers. Supported values are 1.0 and 2.0. To learn more, see [Working with AWS Lambda authorizers for HTTP APIs](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-lambda-authorizer.html).
        var authorizerPayloadFormatVersion: Swift.String?
        /// The time to live (TTL) for cached authorizer results, in seconds. If it equals 0, authorization caching is disabled. If it is greater than 0, API Gateway caches authorizer responses. The maximum value is 3600, or 1 hour. Supported only for HTTP API Lambda authorizers.
        var authorizerResultTtlInSeconds: Swift.Int?
        /// The authorizer type. Specify REQUEST for a Lambda function using incoming request parameters. Specify JWT to use JSON Web Tokens (supported only for HTTP APIs).
        var authorizerType: ApiGatewayV2ClientTypes.AuthorizerType?
        ...
        var authorizerUri: Swift.String?
        ...
        var enableSimpleResponses: Swift.Bool?
        ...
        var identitySource: [Swift.String]?
        /// The validation expression does not apply to the REQUEST authorizer.
        var identityValidationExpression: Swift.String?
        /// Represents the configuration of a JWT authorizer. Required for the JWT authorizer type. Supported only for HTTP APIs.
        var jwtConfiguration: ApiGatewayV2ClientTypes.JWTConfiguration?
...
extension ApiGatewayV2ClientTypes.Cors: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApiGatewayV2ClientTypes {
    ...
    public struct Cors: Swift.Equatable {
        ...
        var allowCredentials: Swift.Bool?
        /// Represents a collection of allowed headers. Supported only for HTTP APIs.
        var allowHeaders: [Swift.String]?
        /// Represents a collection of allowed HTTP methods. Supported only for HTTP APIs.
        var allowMethods: [Swift.String]?
        /// Represents a collection of allowed origins. Supported only for HTTP APIs.
        var allowOrigins: [Swift.String]?
        /// Represents a collection of exposed headers. Supported only for HTTP APIs.
        var exposeHeaders: [Swift.String]?
        /// The number of seconds that the browser should cache preflight request results. Supported only for HTTP APIs.
        var maxAge: Swift.Int?
...
extension CreateApiInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case apiKeySelectionExpression = "apiKeySelectionExpression"
        case corsConfiguration = "corsConfiguration"
...
public struct CreateApiInput: Swift.Equatable {
    ...
    var credentialsArn: Swift.String?
    /// The description of the API.
    var description: Swift.String?
    /// Specifies whether clients can invoke your API by using the default execute-api endpoint. By default, clients can invoke your API with the default https://{api_id}.execute-api.{region}.amazonaws.com endpoint. To require that clients use a custom domain name to invoke your API, disable the default endpoint.
    var disableExecuteApiEndpoint: Swift.Bool?
...
extension CreateApiMappingInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case apiId = "apiId"
        case apiMappingKey = "apiMappingKey"
        case stage = "stage"
...
public struct CreateDeploymentOutputResponse: Swift.Equatable {
    ...
    var autoDeployed: Swift.Bool?
    /// The date and time when the Deployment resource was created.
    var createdDate: ClientRuntime.Date?
    /// The identifier for the deployment.
    var deploymentId: Swift.String?
    /// The status of the deployment: PENDING, FAILED, or SUCCEEDED.
    var deploymentStatus: ApiGatewayV2ClientTypes.DeploymentStatus?
    /// May contain additional feedback on the status of an API deployment.
    var deploymentStatusMessage: Swift.String?
...
extension CreateDomainNameInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateDomainNameInput: Swift.Equatable {
    ...
    var domainNameConfigurations: [ApiGatewayV2ClientTypes.DomainNameConfiguration]?
    /// The mutual TLS authentication configuration for a custom domain name.
    var mutualTlsAuthentication: ApiGatewayV2ClientTypes.MutualTlsAuthenticationInput?
...
public struct CreateDomainNameOutputResponse: Swift.Equatable {
    ...
    var apiMappingSelectionExpression: Swift.String?
    /// The name of the DomainName resource.
    var domainName: Swift.String?
    /// The domain name configurations.
    var domainNameConfigurations: [ApiGatewayV2ClientTypes.DomainNameConfiguration]?
    /// The mutual TLS authentication configuration for a custom domain name.
    var mutualTlsAuthentication: ApiGatewayV2ClientTypes.MutualTlsAuthentication?
    /// The collection of tags associated with a domain name.
    var tags: [Swift.String:Swift.String]?
...
extension CreateIntegrationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateIntegrationInput: Swift.Equatable {
    ...
    var connectionType: ApiGatewayV2ClientTypes.ConnectionType?
    ...
    var contentHandlingStrategy: ApiGatewayV2ClientTypes.ContentHandlingStrategy?
    /// Specifies the credentials required for the integration, if any. For AWS integrations, three options are available. To specify an IAM Role for API Gateway to assume, use the role's Amazon Resource Name (ARN). To require that the caller's identity be passed through from the request, specify the string arn:aws:iam::*:user/*. To use resource-based permissions on supported AWS services, specify null.
    var credentialsArn: Swift.String?
    /// The description of the integration.
    var description: Swift.String?
    /// Specifies the integration's HTTP method type.
    var integrationMethod: Swift.String?
    ...
    var integrationSubtype: Swift.String?
    ...
    /// This member is required.
    var integrationType: ApiGatewayV2ClientTypes.IntegrationType?
    ...
    var integrationUri: Swift.String?
    ...
    var passthroughBehavior: ApiGatewayV2ClientTypes.PassthroughBehavior?
    /// Specifies the format of the payload sent to an integration. Required for HTTP APIs.
    var payloadFormatVersion: Swift.String?
    ...
    var requestParameters: [Swift.String:Swift.String]?
    /// Represents a map of Velocity templates that are applied on the request payload based on the value of the Content-Type header sent by the client. The content type value is the key in this map, and the template (as a String) is the value. Supported only for WebSocket APIs.
    var requestTemplates: [Swift.String:Swift.String]?
    /// Supported only for HTTP APIs. You use response parameters to transform the HTTP response from a backend integration before returning the response to clients. Specify a key-value map from a selection key to response parameters. The selection key must be a valid HTTP status code within the range of 200-599. Response parameters are a key-value map. The key must match pattern <action>:<header>.<location> or overwrite.statuscode. The action can be append, overwrite or remove. The value can be a static value, or map to response data, stage variables, or context variables that are evaluated at runtime. To learn more, see [Transforming API requests and responses](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-parameter-mapping.html).
    var responseParameters: [Swift.String:[Swift.String:Swift.String]]?
    /// The template selection expression for the integration.
    var templateSelectionExpression: Swift.String?
    /// Custom timeout between 50 and 29,000 milliseconds for WebSocket APIs and between 50 and 30,000 milliseconds for HTTP APIs. The default timeout is 29 seconds for WebSocket APIs and 30 seconds for HTTP APIs.
    var timeoutInMillis: Swift.Int?
    /// The TLS configuration for a private integration. If you specify a TLS configuration, private integration traffic uses the HTTPS protocol. Supported only for HTTP APIs.
    var tlsConfig: ApiGatewayV2ClientTypes.TlsConfigInput?
...
public struct CreateIntegrationOutputResponse: Swift.Equatable {
    ...
    var integrationId: Swift.String?
    /// Specifies the integration's HTTP method type.
    var integrationMethod: Swift.String?
    ...
    var integrationResponseSelectionExpression: Swift.String?
    /// Supported only for HTTP API AWS_PROXY integrations. Specifies the AWS service action to invoke. To learn more, see [Integration subtype reference](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-develop-integrations-aws-services-reference.html).
    var integrationSubtype: Swift.String?
    ...
    var timeoutInMillis: Swift.Int?
    /// The TLS configuration for a private integration. If you specify a TLS configuration, private integration traffic uses the HTTPS protocol. Supported only for HTTP APIs.
    var tlsConfig: ApiGatewayV2ClientTypes.TlsConfig?
...
extension CreateIntegrationResponseInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case contentHandlingStrategy = "contentHandlingStrategy"
...
public struct CreateIntegrationResponseInput: Swift.Equatable {
    ...
    /// This member is required.
    var integrationResponseKey: Swift.String?
    ...
    var responseParameters: [Swift.String:Swift.String]?
    /// The collection of response templates for the integration response as a string-to-string map of key-value pairs. Response templates are represented as a key/value map, with a content-type as the key and a template as the value.
    var responseTemplates: [Swift.String:Swift.String]?
...
public struct CreateIntegrationResponseOutputResponse: Swift.Equatable {
    ...
    var integrationResponseId: Swift.String?
    /// The integration response key.
    var integrationResponseKey: Swift.String?
    /// A key-value map specifying response parameters that are passed to the method response from the backend. The key is a method response header parameter name and the mapped value is an integration response header value, a static value enclosed within a pair of single quotes, or a JSON expression from the integration response body. The mapping key must match the pattern of method.response.header.{name}, where name is a valid and unique header name. The mapped non-static value must match the pattern of integration.response.header.{name} or integration.response.body.{JSON-expression}, where name is a valid and unique response header name and JSON-expression is a valid JSON expression without the $ prefix.
    var responseParameters: [Swift.String:Swift.String]?
...
public struct CreateRouteInput: Swift.Equatable {
    ...
    var apiKeyRequired: Swift.Bool?
    /// The authorization scopes supported by this route.
    var authorizationScopes: [Swift.String]?
    /// The authorization type for the route. For WebSocket APIs, valid values are NONE for open access, AWS_IAM for using AWS IAM permissions, and CUSTOM for using a Lambda authorizer For HTTP APIs, valid values are NONE for open access, JWT for using JSON Web Tokens, AWS_IAM for using AWS IAM permissions, and CUSTOM for using a Lambda authorizer.
    var authorizationType: ApiGatewayV2ClientTypes.AuthorizationType?
    /// The identifier of the Authorizer resource to be associated with this route. The authorizer identifier is generated by API Gateway when you created the authorizer.
    var authorizerId: Swift.String?
    /// The model selection expression for the route. Supported only for WebSocket APIs.
    var modelSelectionExpression: Swift.String?
    /// The operation name for the route.
    var operationName: Swift.String?
    /// The request models for the route. Supported only for WebSocket APIs.
    var requestModels: [Swift.String:Swift.String]?
    /// The request parameters for the route. Supported only for WebSocket APIs.
    var requestParameters: [Swift.String:ApiGatewayV2ClientTypes.ParameterConstraints]?
    /// The route key for the route.
    /// This member is required.
    var routeKey: Swift.String?
    /// The route response selection expression for the route. Supported only for WebSocket APIs.
    var routeResponseSelectionExpression: Swift.String?
...
extension CreateRouteResponseInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case modelSelectionExpression = "modelSelectionExpression"
...
public struct CreateRouteResponseInput: Swift.Equatable {
    ...
    var responseModels: [Swift.String:Swift.String]?
    /// The route response parameters.
    var responseParameters: [Swift.String:ApiGatewayV2ClientTypes.ParameterConstraints]?
    /// The route ID.
    /// This member is required.
    var routeId: Swift.String?
    /// The route response key.
    /// This member is required.
    var routeResponseKey: Swift.String?
...
public struct CreateRouteResponseOutputResponse: Swift.Equatable {
    ...
    var routeResponseId: Swift.String?
...
extension CreateStageInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreateStageInput: Swift.Equatable {
    ...
    var accessLogSettings: ApiGatewayV2ClientTypes.AccessLogSettings?
    /// The API identifier.
    /// This member is required.
    var apiId: Swift.String?
    /// Specifies whether updates to an API automatically trigger a new deployment. The default value is false.
    var autoDeploy: Swift.Bool?
    /// The identifier of a client certificate for a Stage. Supported only for WebSocket APIs.
    var clientCertificateId: Swift.String?
    /// The default route settings for the stage.
    var defaultRouteSettings: ApiGatewayV2ClientTypes.RouteSettings?
    /// The deployment identifier of the API stage.
    var deploymentId: Swift.String?
    /// The description for the API stage.
    var description: Swift.String?
    /// Route settings for the stage, by routeKey.
    var routeSettings: [Swift.String:ApiGatewayV2ClientTypes.RouteSettings]?
    /// The name of the stage.
    /// This member is required.
    var stageName: Swift.String?
    /// A map that defines the stage variables for a Stage. Variable names can have alphanumeric and underscore characters, and the values must match [A-Za-z0-9-._~:/?#&=,]+.
    var stageVariables: [Swift.String:Swift.String]?
    /// The collection of tags. Each tag element is associated with a given resource.
    var tags: [Swift.String:Swift.String]?
...
public struct CreateStageOutputResponse: Swift.Equatable {
    ...
    var lastDeploymentStatusMessage: Swift.String?
    /// The timestamp when the stage was last updated.
    var lastUpdatedDate: ClientRuntime.Date?
    /// Route settings for the stage, by routeKey.
    var routeSettings: [Swift.String:ApiGatewayV2ClientTypes.RouteSettings]?
    /// The name of the stage.
    var stageName: Swift.String?
...
extension CreateVpcLinkInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "name"
...
public struct CreateVpcLinkOutputResponse: Swift.Equatable {
    ...
    var vpcLinkId: Swift.String?
    /// The status of the VPC link.
    var vpcLinkStatus: ApiGatewayV2ClientTypes.VpcLinkStatus?
    /// A message summarizing the cause of the status of the VPC link.
    var vpcLinkStatusMessage: Swift.String?
    /// The version of the VPC link.
    var vpcLinkVersion: ApiGatewayV2ClientTypes.VpcLinkVersion?
...
public struct DeleteRouteRequestParameterInput: Swift.Equatable {
    ...
    /// This member is required.
    var requestParameterKey: Swift.String?
    /// The route ID.
    /// This member is required.
    var routeId: Swift.String?
...
extension ApiGatewayV2ClientTypes.Deployment: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case autoDeployed = "autoDeployed"
        case createdDate = "createdDate"
        case deploymentId = "deploymentId"
...
extension ApiGatewayV2ClientTypes.DomainName: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case apiMappingSelectionExpression = "apiMappingSelectionExpression"
        case domainName = "domainName"
        case domainNameConfigurations = "domainNameConfigurations"
...
extension ApiGatewayV2ClientTypes.DomainNameConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApiGatewayV2ClientTypes {
    ...
    public struct DomainNameConfiguration: Swift.Equatable {
        ...
        var apiGatewayDomainName: Swift.String?
        /// An AWS-managed certificate that will be used by the edge-optimized endpoint for this domain name. AWS Certificate Manager is the only supported source.
        var certificateArn: Swift.String?
        /// The user-friendly name of the certificate that will be used by the edge-optimized endpoint for this domain name.
        var certificateName: Swift.String?
        /// The timestamp when the certificate that was used by edge-optimized endpoint for this domain name was uploaded.
        var certificateUploadDate: ClientRuntime.Date?
        /// The status of the domain name migration. The valid values are AVAILABLE, UPDATING, PENDING_CERTIFICATE_REIMPORT, and PENDING_OWNERSHIP_VERIFICATION. If the status is UPDATING, the domain cannot be modified further until the existing operation is complete. If it is AVAILABLE, the domain can be updated.
        var domainNameStatus: ApiGatewayV2ClientTypes.DomainNameStatus?
        /// An optional text message containing detailed information about status of the domain name migration.
        var domainNameStatusMessage: Swift.String?
        /// The endpoint type.
        var endpointType: ApiGatewayV2ClientTypes.EndpointType?
        /// The Amazon Route 53 Hosted Zone ID of the endpoint.
        var hostedZoneId: Swift.String?
        /// The ARN of the public certificate issued by ACM to validate ownership of your custom domain. Only required when configuring mutual TLS and using an ACM imported or private CA certificate ARN as the regionalCertificateArn
        var ownershipVerificationCertificateArn: Swift.String?
        /// The Transport Layer Security (TLS) version of the security policy for this domain name. The valid values are TLS_1_0 and TLS_1_2.
        var securityPolicy: ApiGatewayV2ClientTypes.SecurityPolicy?
...
public struct ExportApiInput: Swift.Equatable {
    ...
    var exportVersion: Swift.String?
    ...
    var includeExtensions: Swift.Bool?
    /// The output type of the exported definition file. Valid values are JSON and YAML.
    /// This member is required.
    var outputType: Swift.String?
    /// The version of the API specification to use. OAS30, for OpenAPI 3.0, is the only supported value.
    /// This member is required.
    var specification: Swift.String?
...
public struct GetApiMappingsOutputResponse: Swift.Equatable {
    ...
    var items: [ApiGatewayV2ClientTypes.ApiMapping]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetApisOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [ApiGatewayV2ClientTypes.Api]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetAuthorizersOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [ApiGatewayV2ClientTypes.Authorizer]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetDeploymentsOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [ApiGatewayV2ClientTypes.Deployment]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetDomainNamesOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [ApiGatewayV2ClientTypes.DomainName]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetIntegrationResponsesOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [ApiGatewayV2ClientTypes.IntegrationResponse]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetIntegrationsOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [ApiGatewayV2ClientTypes.Integration]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetModelsOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [ApiGatewayV2ClientTypes.Model]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetRouteResponsesOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [ApiGatewayV2ClientTypes.RouteResponse]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetRoutesOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [ApiGatewayV2ClientTypes.Route]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetStagesOutputResponse: Swift.Equatable {
    /// The elements from this collection.
    var items: [ApiGatewayV2ClientTypes.Stage]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
public struct GetVpcLinksOutputResponse: Swift.Equatable {
    ...
    var items: [ApiGatewayV2ClientTypes.VpcLink]?
    /// The next page of elements from this collection. Not valid for the last element of the collection.
    var nextToken: Swift.String?
...
extension ImportApiInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case body = "body"
    }
...
extension ApiGatewayV2ClientTypes.Integration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case apiGatewayManaged = "apiGatewayManaged"
        case connectionId = "connectionId"
        case connectionType = "connectionType"
...
extension ApiGatewayV2ClientTypes.IntegrationResponse: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case contentHandlingStrategy = "contentHandlingStrategy"
        case integrationResponseId = "integrationResponseId"
        case integrationResponseKey = "integrationResponseKey"
...
extension ApiGatewayV2ClientTypes.JWTConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApiGatewayV2ClientTypes.Model: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case contentType = "contentType"
        case description = "description"
        case modelId = "modelId"
...
extension ApiGatewayV2ClientTypes.MutualTlsAuthentication: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApiGatewayV2ClientTypes {
    public struct MutualTlsAuthentication: Swift.Equatable {
        ...
        var truststoreUri: Swift.String?
        /// The version of the S3 object that contains your truststore. To specify a version, you must have versioning enabled for the S3 bucket.
        var truststoreVersion: Swift.String?
        /// A list of warnings that API Gateway returns while processing your truststore. Invalid certificates produce warnings. Mutual TLS is still enabled, but some clients might not be able to access your API. To resolve warnings, upload a new truststore to S3, and then update you domain name to use the new version.
        var truststoreWarnings: [Swift.String]?
...
extension ApiGatewayV2ClientTypes.MutualTlsAuthenticationInput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case truststoreUri = "truststoreUri"
        case truststoreVersion = "truststoreVersion"
    }
...
extension ApiGatewayV2ClientTypes.ParameterConstraints: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ReimportApiInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case body = "body"
    }
...
extension ApiGatewayV2ClientTypes.Route: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case apiGatewayManaged = "apiGatewayManaged"
        case apiKeyRequired = "apiKeyRequired"
        case authorizationScopes = "authorizationScopes"
...
extension ApiGatewayV2ClientTypes.RouteResponse: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case modelSelectionExpression = "modelSelectionExpression"
        case responseModels = "responseModels"
        case responseParameters = "responseParameters"
...
extension ApiGatewayV2ClientTypes.RouteSettings: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApiGatewayV2ClientTypes {
    ...
    public struct RouteSettings: Swift.Equatable {
        ...
        var dataTraceEnabled: Swift.Bool?
        /// Specifies whether detailed metrics are enabled.
        var detailedMetricsEnabled: Swift.Bool?
        /// Specifies the logging level for this route: INFO, ERROR, or OFF. This property affects the log entries pushed to Amazon CloudWatch Logs. Supported only for WebSocket APIs.
        var loggingLevel: ApiGatewayV2ClientTypes.LoggingLevel?
        /// Specifies the throttling burst limit.
        var throttlingBurstLimit: Swift.Int?
        /// Specifies the throttling rate limit.
        var throttlingRateLimit: Swift.Double?
...
extension ApiGatewayV2ClientTypes.Stage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accessLogSettings = "accessLogSettings"
        case apiGatewayManaged = "apiGatewayManaged"
        case autoDeploy = "autoDeploy"
...
extension ApiGatewayV2ClientTypes.TlsConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ApiGatewayV2ClientTypes {
    ...
    public struct TlsConfig: Swift.Equatable {
        ...
        var serverNameToVerify: Swift.String?
...
extension ApiGatewayV2ClientTypes.TlsConfigInput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case serverNameToVerify = "serverNameToVerify"
    }
...
extension UpdateApiInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case apiKeySelectionExpression = "apiKeySelectionExpression"
        case corsConfiguration = "corsConfiguration"
        case credentialsArn = "credentialsArn"
...
extension UpdateApiMappingInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case apiId = "apiId"
        case apiMappingKey = "apiMappingKey"
        case stage = "stage"
...
extension UpdateDeploymentInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case description = "description"
    }
...
extension UpdateDomainNameInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case domainNameConfigurations = "domainNameConfigurations"
        case mutualTlsAuthentication = "mutualTlsAuthentication"
    }
...
extension UpdateIntegrationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case connectionId = "connectionId"
        case connectionType = "connectionType"
        case contentHandlingStrategy = "contentHandlingStrategy"
...
extension UpdateIntegrationResponseInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case contentHandlingStrategy = "contentHandlingStrategy"
        case integrationResponseKey = "integrationResponseKey"
        case responseParameters = "responseParameters"
...
extension UpdateRouteResponseInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case modelSelectionExpression = "modelSelectionExpression"
        case responseModels = "responseModels"
        case responseParameters = "responseParameters"
...
extension UpdateStageInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case accessLogSettings = "accessLogSettings"
        case autoDeploy = "autoDeploy"
        case clientCertificateId = "clientCertificateId"
...
extension UpdateVpcLinkInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case name = "name"
    }
...
extension ApiGatewayV2ClientTypes.VpcLink: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case createdDate = "createdDate"
        case name = "name"
        case securityGroupIds = "securityGroupIds"
