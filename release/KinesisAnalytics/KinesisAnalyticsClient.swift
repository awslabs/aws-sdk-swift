...
public class KinesisAnalyticsClient {
    ...
    let config: KinesisAnalyticsClientConfiguration
    let serviceName = "Kinesis Analytics"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: KinesisAnalyticsClientConfiguration) {
    ...
    public class KinesisAnalyticsClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "KinesisAnalyticsClient")
        }
        ...
        public static func `default`() throws -> KinesisAnalyticsClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try KinesisAnalyticsClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
