...
extension SfnClientTypes {
    ...
    public struct ActivityScheduledEventDetails: Swift.Equatable {
        ...
        var heartbeatInSeconds: Swift.Int
        /// The JSON data input to the activity task. Length constraints apply to the payload size, and are expressed as bytes in UTF-8 encoding.
        var input: Swift.String?
        /// Contains details about the input for an execution history event.
        var inputDetails: SfnClientTypes.HistoryEventExecutionDataDetails?
...
extension SfnClientTypes {
    ...
    public struct ActivitySucceededEventDetails: Swift.Equatable {
        ...
        var outputDetails: SfnClientTypes.HistoryEventExecutionDataDetails?
...
extension SfnClientTypes {
    ...
    public struct BillingDetails: Swift.Equatable {
        ...
        var billedDurationInMilliseconds: Swift.Int
        /// Billed memory consumption of your workflow, in MB.
        var billedMemoryUsedInMB: Swift.Int
...
public struct CreateStateMachineInput: Swift.Equatable {
    ...
    var loggingConfiguration: SfnClientTypes.LoggingConfiguration?
    ...
    var tracingConfiguration: SfnClientTypes.TracingConfiguration?
    /// Determines whether a Standard or Express state machine is created. The default is STANDARD. You cannot update the type of a state machine once it has been created.
    var type: SfnClientTypes.StateMachineType?
...
public struct CreateStateMachineOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var stateMachineArn: Swift.String?
...
public struct DescribeExecutionOutputResponse: Swift.Equatable {
    ...
    var input: Swift.String?
    /// Provides details about execution input or output.
    var inputDetails: SfnClientTypes.CloudWatchEventsExecutionDataDetails?
    ...
    var output: Swift.String?
    /// Provides details about execution input or output.
    var outputDetails: SfnClientTypes.CloudWatchEventsExecutionDataDetails?
    ...
    /// This member is required.
    var status: SfnClientTypes.ExecutionStatus?
...
public struct DescribeStateMachineOutputResponse: Swift.Equatable {
    ...
    var status: SfnClientTypes.StateMachineStatus?
    /// Selects whether AWS X-Ray tracing is enabled.
    var tracingConfiguration: SfnClientTypes.TracingConfiguration?
...
public struct GetExecutionHistoryInput: Swift.Equatable {
    ...
    var includeExecutionData: Swift.Bool?
...
public struct GetExecutionHistoryOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var events: [SfnClientTypes.HistoryEvent]?
    /// If nextToken is returned, there are more results available. The value of nextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours. Using an expired pagination token will return an HTTP 400 InvalidToken error.
    var nextToken: Swift.String?
...
extension SfnClientTypes {
    ...
    public struct HistoryEvent: Swift.Equatable {
        /// Contains details about an activity that failed during an execution.
        var activityFailedEventDetails: SfnClientTypes.ActivityFailedEventDetails?
        /// Contains details about an activity schedule event that failed during an execution.
        var activityScheduleFailedEventDetails: SfnClientTypes.ActivityScheduleFailedEventDetails?
        /// Contains details about an activity scheduled during an execution.
        var activityScheduledEventDetails: SfnClientTypes.ActivityScheduledEventDetails?
        /// Contains details about the start of an activity during an execution.
        var activityStartedEventDetails: SfnClientTypes.ActivityStartedEventDetails?
        /// Contains details about an activity that successfully terminated during an execution.
        var activitySucceededEventDetails: SfnClientTypes.ActivitySucceededEventDetails?
        /// Contains details about an activity timeout that occurred during an execution.
        var activityTimedOutEventDetails: SfnClientTypes.ActivityTimedOutEventDetails?
        /// Contains details about an abort of an execution.
        var executionAbortedEventDetails: SfnClientTypes.ExecutionAbortedEventDetails?
        /// Contains details about an execution failure event.
        var executionFailedEventDetails: SfnClientTypes.ExecutionFailedEventDetails?
        /// Contains details about the start of the execution.
        var executionStartedEventDetails: SfnClientTypes.ExecutionStartedEventDetails?
        /// Contains details about the successful termination of the execution.
        var executionSucceededEventDetails: SfnClientTypes.ExecutionSucceededEventDetails?
        /// Contains details about the execution timeout that occurred during the execution.
        var executionTimedOutEventDetails: SfnClientTypes.ExecutionTimedOutEventDetails?
        /// The id of the event. Events are numbered sequentially, starting at one.
        /// This member is required.
        var id: Swift.Int
        /// Contains details about a lambda function that failed during an execution.
        var lambdaFunctionFailedEventDetails: SfnClientTypes.LambdaFunctionFailedEventDetails?
        /// Contains details about a failed lambda function schedule event that occurred during an execution.
        var lambdaFunctionScheduleFailedEventDetails: SfnClientTypes.LambdaFunctionScheduleFailedEventDetails?
        /// Contains details about a lambda function scheduled during an execution.
        var lambdaFunctionScheduledEventDetails: SfnClientTypes.LambdaFunctionScheduledEventDetails?
        /// Contains details about a lambda function that failed to start during an execution.
        var lambdaFunctionStartFailedEventDetails: SfnClientTypes.LambdaFunctionStartFailedEventDetails?
        /// Contains details about a lambda function that terminated successfully during an execution.
        var lambdaFunctionSucceededEventDetails: SfnClientTypes.LambdaFunctionSucceededEventDetails?
        /// Contains details about a lambda function timeout that occurred during an execution.
        var lambdaFunctionTimedOutEventDetails: SfnClientTypes.LambdaFunctionTimedOutEventDetails?
        /// Contains details about an iteration of a Map state that was aborted.
        var mapIterationAbortedEventDetails: SfnClientTypes.MapIterationEventDetails?
        /// Contains details about an iteration of a Map state that failed.
        var mapIterationFailedEventDetails: SfnClientTypes.MapIterationEventDetails?
        /// Contains details about an iteration of a Map state that was started.
        var mapIterationStartedEventDetails: SfnClientTypes.MapIterationEventDetails?
        /// Contains details about an iteration of a Map state that succeeded.
        var mapIterationSucceededEventDetails: SfnClientTypes.MapIterationEventDetails?
        /// Contains details about Map state that was started.
        var mapStateStartedEventDetails: SfnClientTypes.MapStateStartedEventDetails?
        /// The id of the previous event.
        var previousEventId: Swift.Int
        /// Contains details about a state entered during an execution.
        var stateEnteredEventDetails: SfnClientTypes.StateEnteredEventDetails?
        /// Contains details about an exit from a state during an execution.
        var stateExitedEventDetails: SfnClientTypes.StateExitedEventDetails?
        /// Contains details about the failure of a task.
        var taskFailedEventDetails: SfnClientTypes.TaskFailedEventDetails?
        /// Contains details about a task that was scheduled.
        var taskScheduledEventDetails: SfnClientTypes.TaskScheduledEventDetails?
        /// Contains details about a task that failed to start.
        var taskStartFailedEventDetails: SfnClientTypes.TaskStartFailedEventDetails?
        /// Contains details about a task that was started.
        var taskStartedEventDetails: SfnClientTypes.TaskStartedEventDetails?
        /// Contains details about a task that where the submit failed.
        var taskSubmitFailedEventDetails: SfnClientTypes.TaskSubmitFailedEventDetails?
        /// Contains details about a submitted task.
        var taskSubmittedEventDetails: SfnClientTypes.TaskSubmittedEventDetails?
        /// Contains details about a task that succeeded.
        var taskSucceededEventDetails: SfnClientTypes.TaskSucceededEventDetails?
        /// Contains details about a task that timed out.
        var taskTimedOutEventDetails: SfnClientTypes.TaskTimedOutEventDetails?
        /// The date and time the event occurred.
        /// This member is required.
        var timestamp: ClientRuntime.Date?
        /// The type of the event.
        /// This member is required.
        var type: SfnClientTypes.HistoryEventType?
...
public struct ListActivitiesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var activities: [SfnClientTypes.ActivityListItem]?
    /// If nextToken is returned, there are more results available. The value of nextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours. Using an expired pagination token will return an HTTP 400 InvalidToken error.
    var nextToken: Swift.String?
...
public struct ListExecutionsInput: Swift.Equatable {
    ...
    var statusFilter: SfnClientTypes.ExecutionStatus?
...
public struct ListExecutionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var executions: [SfnClientTypes.ExecutionListItem]?
    /// If nextToken is returned, there are more results available. The value of nextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours. Using an expired pagination token will return an HTTP 400 InvalidToken error.
    var nextToken: Swift.String?
...
public struct ListStateMachinesOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// This member is required.
    var stateMachines: [SfnClientTypes.StateMachineListItem]?
...
extension SfnClientTypes {
    ...
    public struct LogDestination: Swift.Equatable {
        ...
        var cloudWatchLogsLogGroup: SfnClientTypes.CloudWatchLogsLogGroup?
...
extension SfnClientTypes {
    ...
    public struct LoggingConfiguration: Swift.Equatable {
        ...
        var destinations: [SfnClientTypes.LogDestination]?
        /// Determines whether execution data is included in your log. When set to false, data is excluded.
        var includeExecutionData: Swift.Bool
        /// Defines which category of execution history events are logged.
        var level: SfnClientTypes.LogLevel?
...
public struct StartSyncExecutionOutputResponse: Swift.Equatable {
    ...
    var billingDetails: SfnClientTypes.BillingDetails?
    /// A more detailed explanation of the cause of the failure.
    var cause: Swift.String?
    /// The error code of the failure.
    var error: Swift.String?
    ...
    /// The current status of the execution.
    /// This member is required.
    var status: SfnClientTypes.SyncExecutionStatus?
    /// If the execution has already ended, the date the execution stopped.
    /// This member is required.
    var stopDate: ClientRuntime.Date?
    /// The AWS X-Ray trace header that was passed to the execution.
