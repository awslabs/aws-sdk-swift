...
public struct CreateEnvironmentInput: Swift.Equatable {
    ...
    var airflowConfigurationOptions: [Swift.String:Swift.String]?
    ...
    var airflowVersion: Swift.String?
    ...
    var environmentClass: Swift.String?
    ...
    /// This member is required.
    var networkConfiguration: MwaaClientTypes.NetworkConfiguration?
    ...
    var pluginsS3ObjectVersion: Swift.String?
    ...
    var pluginsS3Path: Swift.String?
    ...
    var requirementsS3ObjectVersion: Swift.String?
    ...
    var requirementsS3Path: Swift.String?
    /// The number of Apache Airflow schedulers to run in your environment.
    var schedulers: Swift.Int?
    ...
    /// This member is required.
    var sourceBucketArn: Swift.String?
    ...
    var webserverAccessMode: MwaaClientTypes.WebserverAccessMode?
    ...
    var weeklyMaintenanceWindowStart: Swift.String?
...
extension MwaaClientTypes {
    ...
    public struct Environment: Swift.Equatable {
        ...
        var lastUpdate: MwaaClientTypes.LastUpdate?
        /// The Apache Airflow logs being sent to CloudWatch Logs: DagProcessingLogs, SchedulerLogs, TaskLogs, WebserverLogs, WorkerLogs.
        var loggingConfiguration: MwaaClientTypes.LoggingConfiguration?
        ...
        var status: MwaaClientTypes.EnvironmentStatus?
...
public struct GetEnvironmentOutputResponse: Swift.Equatable {
    ...
    var environment: MwaaClientTypes.Environment?
...
extension MwaaClientTypes {
    ...
    public struct LoggingConfiguration: Swift.Equatable {
        ...
        var dagProcessingLogs: MwaaClientTypes.ModuleLoggingConfiguration?
        /// Defines the type of logs to send for the Apache Airflow log type (e.g. DagProcessingLogs). Valid values: CloudWatchLogGroupArn, Enabled, LogLevel.
        var schedulerLogs: MwaaClientTypes.ModuleLoggingConfiguration?
        /// Defines the type of logs to send for the Apache Airflow log type (e.g. DagProcessingLogs). Valid values: CloudWatchLogGroupArn, Enabled, LogLevel.
        var taskLogs: MwaaClientTypes.ModuleLoggingConfiguration?
        /// Defines the type of logs to send for the Apache Airflow log type (e.g. DagProcessingLogs). Valid values: CloudWatchLogGroupArn, Enabled, LogLevel.
        var webserverLogs: MwaaClientTypes.ModuleLoggingConfiguration?
        /// Defines the type of logs to send for the Apache Airflow log type (e.g. DagProcessingLogs). Valid values: CloudWatchLogGroupArn, Enabled, LogLevel.
        var workerLogs: MwaaClientTypes.ModuleLoggingConfiguration?
...
extension MwaaClientTypes {
    ...
    public struct LoggingConfigurationInput: Swift.Equatable {
        /// Defines the type of logs to send for the Apache Airflow log type (e.g. DagProcessingLogs). Valid values: CloudWatchLogGroupArn, Enabled, LogLevel.
        var dagProcessingLogs: MwaaClientTypes.ModuleLoggingConfigurationInput?
        /// Defines the type of logs to send for the Apache Airflow log type (e.g. DagProcessingLogs). Valid values: CloudWatchLogGroupArn, Enabled, LogLevel.
        var schedulerLogs: MwaaClientTypes.ModuleLoggingConfigurationInput?
        /// Defines the type of logs to send for the Apache Airflow log type (e.g. DagProcessingLogs). Valid values: CloudWatchLogGroupArn, Enabled, LogLevel.
        var taskLogs: MwaaClientTypes.ModuleLoggingConfigurationInput?
        /// Defines the type of logs to send for the Apache Airflow log type (e.g. DagProcessingLogs). Valid values: CloudWatchLogGroupArn, Enabled, LogLevel.
        var webserverLogs: MwaaClientTypes.ModuleLoggingConfigurationInput?
        /// Defines the type of logs to send for the Apache Airflow log type (e.g. DagProcessingLogs). Valid values: CloudWatchLogGroupArn, Enabled, LogLevel.
        var workerLogs: MwaaClientTypes.ModuleLoggingConfigurationInput?
...
extension MwaaClientTypes {
    ...
    public struct MetricDatum: Swift.Equatable {
        /// Internal only API.
        var dimensions: [MwaaClientTypes.Dimension]?
        /// Internal only API.
        /// This member is required.
        var metricName: Swift.String?
        /// Internal only API.
        var statisticValues: MwaaClientTypes.StatisticSet?
        /// Internal only API.
        /// This member is required.
        var timestamp: ClientRuntime.Date?
        /// Unit
        var unit: MwaaClientTypes.Unit?
        /// Internal only API.
...
extension MwaaClientTypes {
    ...
    public struct ModuleLoggingConfiguration: Swift.Equatable {
        ...
        var logLevel: MwaaClientTypes.LoggingLevel?
...
public struct PublishMetricsInput: Swift.Equatable {
    ...
    /// This member is required.
    var metricData: [MwaaClientTypes.MetricDatum]?
...
public struct UpdateEnvironmentInput: Swift.Equatable {
    ...
    var name: Swift.String?
    /// The VPC networking components used to secure and enable network traffic between the AWS resources for your environment. To learn more, see [About networking on Amazon MWAA](https://docs.aws.amazon.com/mwaa/latest/userguide/networking-about.html).
    var networkConfiguration: MwaaClientTypes.UpdateNetworkConfigurationInput?
    /// The version of the plugins.zip file on your Amazon S3 bucket. A version must be specified each time a plugins.zip file is updated. To learn more, see [How S3 Versioning works](https://docs.aws.amazon.com/AmazonS3/latest/userguide/versioning-workflows.html).
    var pluginsS3ObjectVersion: Swift.String?
    /// The relative path to the plugins.zip file on your Amazon S3 bucket. For example, plugins.zip. If specified, then the plugins.zip version is required. To learn more, see [Installing custom plugins](https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import-plugins.html).
    var pluginsS3Path: Swift.String?
