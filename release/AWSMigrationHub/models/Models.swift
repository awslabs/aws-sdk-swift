...
extension MigrationHubClientTypes {
    ...
    public struct ApplicationState: Swift.Equatable {
        ...
        var applicationStatus: MigrationHubClientTypes.ApplicationStatus?
        /// The timestamp when the application status was last updated.
        var lastUpdatedTime: ClientRuntime.Date?
...
public struct AssociateCreatedArtifactInput: Swift.Equatable {
    ...
    var createdArtifact: MigrationHubClientTypes.CreatedArtifact?
    /// Optional boolean flag to indicate whether any effect should take place. Used to test if the caller has permission to make the call.
    var dryRun: Swift.Bool
    /// Unique identifier that references the migration task. Do not store personal data in this field.
    /// This member is required.
    var migrationTaskName: Swift.String?
    /// The name of the ProgressUpdateStream.
    /// This member is required.
    var progressUpdateStream: Swift.String?
...
public struct AssociateDiscoveredResourceInput: Swift.Equatable {
    ...
    /// This member is required.
    var discoveredResource: MigrationHubClientTypes.DiscoveredResource?
    /// Optional boolean flag to indicate whether any effect should take place. Used to test if the caller has permission to make the call.
    var dryRun: Swift.Bool
...
public struct CreateProgressUpdateStreamInput: Swift.Equatable {
    ...
    /// This member is required.
    var progressUpdateStreamName: Swift.String?
...
public struct DescribeMigrationTaskOutputResponse: Swift.Equatable {
    ...
    var migrationTask: MigrationHubClientTypes.MigrationTask?
...
public struct DisassociateCreatedArtifactInput: Swift.Equatable {
    /// An ARN of the AWS resource related to the migration (e.g., AMI, EC2 instance, RDS instance, etc.)
    /// This member is required.
    var createdArtifactName: Swift.String?
    /// Optional boolean flag to indicate whether any effect should take place. Used to test if the caller has permission to make the call.
    var dryRun: Swift.Bool
...
public struct DisassociateDiscoveredResourceInput: Swift.Equatable {
    ...
    /// This member is required.
    var configurationId: Swift.String?
    /// Optional boolean flag to indicate whether any effect should take place. Used to test if the caller has permission to make the call.
    var dryRun: Swift.Bool
    /// The identifier given to the MigrationTask. Do not store personal data in this field.
    /// This member is required.
...
public struct ListApplicationStatesInput: Swift.Equatable {
    ...
    var applicationIds: [Swift.String]?
...
public struct ListApplicationStatesOutputResponse: Swift.Equatable {
    ...
    var applicationStateList: [MigrationHubClientTypes.ApplicationState]?
    /// If a NextToken was returned by a previous call, there are more results available. To retrieve the next page of results, make the call again using the returned token in NextToken.
    var nextToken: Swift.String?
...
public struct ListCreatedArtifactsOutputResponse: Swift.Equatable {
    ...
    var createdArtifactList: [MigrationHubClientTypes.CreatedArtifact]?
...
public struct ListDiscoveredResourcesOutputResponse: Swift.Equatable {
    ...
    var discoveredResourceList: [MigrationHubClientTypes.DiscoveredResource]?
...
public struct ListMigrationTasksOutputResponse: Swift.Equatable {
    ...
    var migrationTaskSummaryList: [MigrationHubClientTypes.MigrationTaskSummary]?
...
public struct ListProgressUpdateStreamsOutputResponse: Swift.Equatable {
    ...
    var progressUpdateStreamSummaryList: [MigrationHubClientTypes.ProgressUpdateStreamSummary]?
...
extension MigrationHubClientTypes {
    ...
    public struct MigrationTask: Swift.Equatable {
        ...
        var resourceAttributeList: [MigrationHubClientTypes.ResourceAttribute]?
        /// Task object encapsulating task information.
        var task: MigrationHubClientTypes.Task?
        /// The timestamp when the task was gathered.
        var updateDateTime: ClientRuntime.Date?
...
extension MigrationHubClientTypes {
    ...
    public struct MigrationTaskSummary: Swift.Equatable {
        ...
        var progressPercent: Swift.Int?
        /// An AWS resource used for access control. It should uniquely identify the migration tool as it is used for all updates made by the tool.
        var progressUpdateStream: Swift.String?
        /// Status of the task.
        var status: MigrationHubClientTypes.Status?
...
public struct NotifyApplicationStateInput: Swift.Equatable {
    ...
    /// Status of the application - Not Started, In-Progress, Complete.
    /// This member is required.
    var status: MigrationHubClientTypes.ApplicationStatus?
...
public struct NotifyMigrationTaskStateInput: Swift.Equatable {
    ...
    /// This member is required.
    var nextUpdateSeconds: Swift.Int
    /// The name of the ProgressUpdateStream.
    /// This member is required.
    var progressUpdateStream: Swift.String?
...
extension MigrationHubClientTypes {
    ...
    public struct ResourceAttribute: Swift.Equatable {
        /// Type of resource.
        /// This member is required.
        var type: MigrationHubClientTypes.ResourceAttributeType?
